  ...
  implements Handler.Callback, View.OnClickListener
{
  ...
  public WeakReference<amsq> a;
  private boolean jdField_a_of_type_Boolean;
  private int jdField_b_of_type_Int = -1;
  WeakReference<Context> jdField_b_of_type_JavaLangRefWeakReference;
  
  public amtb(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    this.jdField_a_of_type_Amta = new amta((Context)this.jdField_b_of_type_JavaLangRefWeakReference.get(), this);
    ...
    if (anca.jdField_a_of_type_Int > 0)
    {
      jdField_a_of_type_Int = anca.jdField_a_of_type_Int * 1000;
  ...
  private BaseChatPie a()
  {
    ...
    if (localObject2 != null)
    {
      ...
      {
        localObject2 = (amhd)((AppInterface)localObject2).getManager(153);
        localObject1 = localChatFragment;
        if (localObject2 != null)
        {
          localObject2 = ((amhd)localObject2).a();
          localObject1 = localChatFragment;
          if (localObject2 != null) {
  ...
  private void g()
  {
    ...
    if ((localBaseChatPie != null) && (this.jdField_a_of_type_Amta != null) && (localBaseChatPie.a().a() == this.jdField_a_of_type_Amta) && (this.jdField_a_of_type_Amta.jdField_a_of_type_AndroidWidgetRelativeLayout.isShown()))
    {
      this.jdField_a_of_type_Amta.a();
      this.jdField_a_of_type_Bkgm.removeMessages(20);
      this.jdField_a_of_type_Bkgm.sendEmptyMessageDelayed(20, 1000L);
    }
  }
  ...
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramamsq);
  }
  
  public void a(Activity paramActivity)
  {
    this.jdField_a_of_type_Amta = new amta(paramActivity, this);
  }
  ...
  public void b()
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (((aimj)localObject).a() == this.jdField_a_of_type_Amta))
      {
        ((aimj)localObject).a();
        if (QLog.isColorLevel()) {
  ...
  public void c()
  {
    ...
    for (localObject1 = null;; localObject1 = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
    {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = anni.a(2131700943);
      }
      localMessage.obj = (anni.a(2131700939) + (String)localObject2);
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Amta != null)
    {
      ...
      this.jdField_a_of_type_Amta.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_JavaLangString);
      this.jdField_a_of_type_Amta.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      this.jdField_a_of_type_Amta.c.setVisibility(8);
    }
    label251:
    while (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam == null)
    {
      ...
      if (this.jdField_a_of_type_Amta != null)
      {
        if ((this.jdField_a_of_type_Amta.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent() instanceof ViewGroup)) {
          ((ViewGroup)this.jdField_a_of_type_Amta.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent()).removeView(this.jdField_a_of_type_Amta.jdField_a_of_type_AndroidWidgetRelativeLayout);
        }
        ((aimj)localObject1).a(this.jdField_a_of_type_Amta, new Object[0]);
      }
      if (!QLog.isColorLevel()) {
        break;
      }
    ...
    for (Object localObject1 = null;; localObject1 = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
    {
      Object localObject2 = localObject1;
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = anni.a(2131700942);
      }
      localObject1 = anni.a(2131700944) + (String)localObject2;
      this.jdField_a_of_type_Amta.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject1);
      this.jdField_a_of_type_Amta.jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject1);
      break;
    }
  }
  ...
  public void e()
  {
    this.jdField_a_of_type_Bkgm.removeMessages(25);
  ...
  {
    this.jdField_a_of_type_Bkgm.removeMessages(25);
    this.jdField_a_of_type_Bkgm.sendEmptyMessageDelayed(25, jdField_a_of_type_Int);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
                ...
                do
                {
                  do
                  {
                    do
                    {
                      ...
                      paramMessage.ar();
                      return false;
                      if ((this.jdField_a_of_type_Amta != null) && ((paramMessage.obj instanceof String)))
                      {
                    ...
                    if (paramMessage != null)
                    {
                      ...
                      if ((localObject3 != null) && (this.jdField_a_of_type_Amta != null))
                      {
                        if ((this.jdField_a_of_type_Amta.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent() instanceof ViewGroup)) {
                          ((ViewGroup)this.jdField_a_of_type_Amta.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent()).removeView(this.jdField_a_of_type_Amta.jdField_a_of_type_AndroidWidgetRelativeLayout);
                        }
                        if (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
                        {
                          ...
                          if (TextUtils.isEmpty(paramMessage)) {
                            localObject1 = anni.a(2131700945);
                          }
                          paramMessage = anni.a(2131700940) + (String)localObject1;
                          this.jdField_a_of_type_Amta.jdField_a_of_type_AndroidWidgetTextView.setText(paramMessage);
                          this.jdField_a_of_type_Amta.jdField_b_of_type_AndroidWidgetTextView.setText(paramMessage);
                        }
                        this.jdField_a_of_type_Amta.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                        this.jdField_a_of_type_Amta.c.setVisibility(8);
                        ((aimj)localObject3).a(this.jdField_a_of_type_Amta, new Object[0]);
                        if (QLog.isColorLevel()) {
                          QLog.d("cmgame_process.CmGameUIManager", 2, "showGameTips");
                        }
                      }
                    }
                    Object localObject3 = ampj.a();
                    MqqHandler localMqqHandler;
                    Message localMessage;
                    ...
                    for (paramMessage = (Message)localObject2;; paramMessage = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
                    {
                      localObject1 = paramMessage;
                      if (TextUtils.isEmpty(paramMessage)) {
                        localObject1 = anni.a(2131700936);
                      }
                      localMessage.obj = (anni.a(2131700938) + (String)localObject1);
                      localMqqHandler.sendMessage(localMessage);
                      ...
                      {
                        paramMessage = (amsq)this.jdField_a_of_type_JavaLangRefWeakReference.get();
                        if (paramMessage != null) {
                          paramMessage.a();
                        }
                      }
                    ...
                    for (paramMessage = "";; paramMessage = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
                    {
                      ...
                      amoz.a(this.jdField_b_of_type_Int);
                    ...
                    if (localObject2 != null)
                    {
                      ...
                      if (localObject2 != null)
                      {
                        if ((this.jdField_a_of_type_Amta == null) || (this.jdField_a_of_type_Amta != ((aimj)localObject2).a())) {
                          break label964;
                        }
                        ((aimj)localObject2).a();
                        if (QLog.isColorLevel()) {
                    ...
                    for (;;)
                    {
                      ...
                      {
                        localObject2 = (amsq)this.jdField_a_of_type_JavaLangRefWeakReference.get();
                        if ((paramMessage.obj instanceof String)) {
                          localObject1 = (String)paramMessage.obj;
                        }
                        if (localObject2 != null) {
                          ((amsq)localObject2).d((String)localObject1);
                        }
                      }
                      paramMessage = ampj.a();
                      ...
                      VipUtils.a(paramMessage, "cmshow", "Apollo", "shutdown_game", 0, 0, new String[] { Integer.toString(this.jdField_b_of_type_Int), Integer.toString(ampj.b()), Integer.toString(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.commFlag & 0x1) });
                      return false;
                      if (QLog.isColorLevel()) {
                    ...
                    if ((paramMessage.obj instanceof String))
                    {
                      ...
                      if (this.jdField_a_of_type_Amta != null)
                      {
                        this.jdField_a_of_type_Amta.c.setVisibility(8);
                        this.jdField_a_of_type_Amta.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                        this.jdField_a_of_type_Amta.jdField_a_of_type_AndroidWidgetTextView.setText((String)paramMessage.obj);
                      }
                    }
                    paramMessage = ampj.a();
              ...
              this.jdField_a_of_type_Bkgm.sendEmptyMessageDelayed(24, 500L);
              return false;
              paramMessage = a();
            } while (paramMessage == null);
            paramMessage.ar();
        ...
        if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Amta != null))
        {
          localObject1 = (String)paramMessage.obj;
          localObject2 = new SpannableString((String)localObject1 + anni.a(2131700941));
          ((SpannableString)localObject2).setSpan(new ForegroundColorSpan(-16776961), 0, ((String)localObject1).length(), 17);
          this.jdField_a_of_type_Amta.jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
          g();
        }
      } while (!QLog.isColorLevel());
      ...
      paramMessage = a();
    } while ((paramMessage == null) || (this.jdField_a_of_type_Amta == null) || (paramMessage.a().a() != this.jdField_a_of_type_Amta) || (!this.jdField_a_of_type_Amta.jdField_a_of_type_AndroidWidgetRelativeLayout.isShown()));
    label733:
  ...
  public void onClick(View paramView)
  {
    ...
    for (Object localObject = "";; localObject = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
    {
      ...
      this.jdField_a_of_type_Bkgm.sendEmptyMessageDelayed(18, 300L);
