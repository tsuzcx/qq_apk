...
public class odz
{
  ...
  private static odz jdField_a_of_type_Odz;
  ...
  public static odz a()
  {
    if (jdField_a_of_type_Odz == null) {}
    try
    {
      if (jdField_a_of_type_Odz == null) {
        jdField_a_of_type_Odz = new odz();
      }
      return jdField_a_of_type_Odz;
    }
    finally {}
  }
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      Collections.sort(localArrayList, new oea(this));
