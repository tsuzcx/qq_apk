  ...
  implements akjl
{
  ...
  private akju jdField_a_of_type_Akju;
  volatile akjw jdField_a_of_type_Akjw = null;
  private akjx jdField_a_of_type_Akjx;
  private aksz jdField_a_of_type_Aksz = new aksz();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = akjt.class.getSimpleName();
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Akjx != null) {
      this.jdField_a_of_type_Akjx.b(this.jdField_a_of_type_AndroidWidgetRelativeLayout);
    }
    this.jdField_a_of_type_Akju = null;
    f();
    this.h = -1;
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.jdField_a_of_type_Akju != null)
    {
      this.jdField_a_of_type_Akju.a(paramInt1, paramInt2, paramInt3, paramInt4);
      return;
    }
    QLog.i(jdField_a_of_type_JavaLangString, 1, "setRecogRes failed.");
  }
  
  public void a(akju paramakju)
  {
    if (paramakju != null)
    {
      this.jdField_a_of_type_Akju = paramakju;
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
        this.jdField_a_of_type_Akju.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout);
      }
      this.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Akju.b();
      if (!this.jdField_a_of_type_Akju.c()) {
        break label75;
      }
    }
    label75:
    for (int k = 1;; k = 2)
    {
      ...
      this.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_Akju.a();
      return;
    }
  }
  
  public void a(aksz paramaksz, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    this.jdField_a_of_type_Aksz = paramaksz;
    int k = 1;
    ...
    int m;
    boolean bool;
    if ((this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_d_of_type_Int == 0) && (this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_c_of_type_Int > 0))
    {
      f();
      if (k != 0)
      {
      ...
      paramaksz = ARLocalGestureCircleRecog.a(paramInt1, paramInt2, paramInt3, paramInt4, new PointF(this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_a_of_type_Akta.b, this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_a_of_type_Akta.c));
      m = (int)(this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_a_of_type_Akta.jdField_a_of_type_Float / paramInt2 * paramInt3);
      int n = (int)paramaksz.x;
      int i1 = (int)paramaksz.y;
      if (this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_a_of_type_Akta.jdField_a_of_type_Boolean)
      {
        k = 1;
        a(m, n, i1, k);
        b(1);
        akkz.a().a(6);
        this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.g = 0;
      }
    }
    else
    {
      if (this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_c_of_type_Int <= this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_d_of_type_Int) {
        break label547;
      }
      m = 0;
      if (this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktc.jdField_d_of_type_Int != 1) {
        break label478;
      }
      if (this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_d_of_type_Int != 0) {
        break label457;
      }
      k = 0;
      m = 1;
    ...
    for (;;)
    {
      ...
      if (m != 0)
      {
        ...
        paramaksz = new int[this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_c_of_type_Int - k];
        int[] arrayOfInt1 = new int[this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_c_of_type_Int - k];
        int[] arrayOfInt2 = new int[this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_c_of_type_Int - k];
        paramInt2 = k;
        for (;;)
        {
          if (paramInt2 < this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_c_of_type_Int)
          {
            PointF localPointF = ARLocalGestureCircleRecog.a(paramInt1, paramInt1, paramInt3, paramInt4, this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_a_of_type_ArrayOfAndroidGraphicsPointF[paramInt2]);
            paramaksz[(paramInt2 - k)] = ((int)localPointF.x);
            arrayOfInt1[(paramInt2 - k)] = ((int)localPointF.y);
            arrayOfInt2[(paramInt2 - k)] = this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_a_of_type_ArrayOfInt[paramInt2];
            paramInt2 += 1;
            continue;
            k = -1;
            break;
            label457:
            k = this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_d_of_type_Int;
            m = 1;
            bool = false;
            break label291;
            label478:
            if (this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_c_of_type_Int >= 1) {
              m = 1;
            }
            if (this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_d_of_type_Int < 1)
            {
              bool = true;
              k = 0;
              break label291;
        ...
        a(paramaksz, arrayOfInt1, arrayOfInt2, bool);
      }
    }
    for (;;)
    {
      label547:
      if ((this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_a_of_type_Int == -1) && (this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_b_of_type_Int != -1) && (this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_c_of_type_Int > 0))
      {
        ...
        if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
          ((akwn)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(new ARTransferDoorLogicManager.2(this), 1000L);
        }
      }
      QLog.i(jdField_a_of_type_JavaLangString, 1, "zoomOutWorldCupSparks curent state " + this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_a_of_type_Int);
      if ((this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_a_of_type_Int == 0) && (this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.jdField_b_of_type_Int != 0))
      {
        c(5);
        b(2);
        ThreadManager.getSubThreadHandler().post(new ARTransferDoorLogicManager.3(this));
        if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
          ((akwn)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(new ARTransferDoorLogicManager.4(this), 1500L);
        }
      }
      return;
      label779:
      ...
      if (this.jdField_c_of_type_Boolean)
      {
        ...
        paramaksz = new ARTransferDoorLogicManager.1(this, paramInt1, paramInt2, paramInt3, paramInt4);
        QLog.i(jdField_a_of_type_JavaLangString, 1, "DrawCircle. resume. mDrawCirclePuase = " + this.jdField_c_of_type_Boolean + ", genIdx = " + this.jdField_a_of_type_Aksz.jdField_a_of_type_Aktb.g);
        if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null) && (!this.jdField_c_of_type_Boolean)) {
          ((akwn)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(paramaksz, this.j);
        }
      }
    }
  }
  ...
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramakwn);
  }
  ...
  public void a(AppInterface paramAppInterface, ScanTorchActivity paramScanTorchActivity, RelativeLayout paramRelativeLayout)
  {
    ...
    this.jdField_a_of_type_Akjk = new akjk(paramScanTorchActivity);
    this.jdField_a_of_type_Akjk.a(this);
    if ((this.jdField_a_of_type_Akju != null) && (paramRelativeLayout != null))
    {
      QLog.d(jdField_a_of_type_JavaLangString, 2, "init " + paramRelativeLayout.getChildCount());
      this.jdField_a_of_type_Akju.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout);
      this.jdField_a_of_type_Akjx = new akjx(paramScanTorchActivity);
      return;
    }
  ...
  public void a(ArCloudConfigInfo paramArCloudConfigInfo)
  {
    ...
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((akwn)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(4096L, localArCloudConfigInfo);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      if ((this.jdField_a_of_type_Akju != null) && (this.jdField_a_of_type_Int == 1)) {
        if (this.jdField_a_of_type_Akju.b())
        {
          c(6);
          this.jdField_a_of_type_Akju.a();
          this.h = -1;
        }
      }
      for (;;)
      {
        ...
        this.h = 0;
        continue;
        if ((this.jdField_a_of_type_Akju != null) && (this.jdField_a_of_type_Int == 2))
        {
          c(2);
          this.h = 0;
        }
        else if (this.jdField_a_of_type_Akju == null)
        {
          c(2);
          this.h = 0;
        }
    ...
    if ((this.jdField_a_of_type_Akju != null) && (this.jdField_a_of_type_Akju.b()) && (this.jdField_a_of_type_Int == 1)) {
      c(1);
    }
    for (;;)
    {
  ...
  public void a(int[] paramArrayOfInt1, int[] paramArrayOfInt2, int[] paramArrayOfInt3, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Akju != null) && (this.jdField_a_of_type_Akju.a()))
    {
      this.jdField_a_of_type_Akju.a(paramArrayOfInt1, paramArrayOfInt2, paramArrayOfInt3, paramBoolean);
      return;
    }
  ...
  {
    if (this.jdField_a_of_type_Akju != null) {
      return this.jdField_a_of_type_Akju.a();
    }
    return 0;
  }
  ...
  public void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Akju != null)
    {
      this.jdField_a_of_type_Akju.a(paramInt);
      return;
    }
    String str = jdField_a_of_type_JavaLangString;
    if ("switchGameStatus " + paramInt + "|" + this.jdField_a_of_type_Akju != null) {}
    for (;;)
    {
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((akwn)this.jdField_a_of_type_JavaLangRefWeakReference.get()).d(1);
    }
  }
  ...
  public void h()
  {
    ...
    this.jdField_a_of_type_Akjw = null;
    if (this.jdField_a_of_type_MqqOsMqqHandler != null) {
      this.jdField_a_of_type_MqqOsMqqHandler.removeCallbacksAndMessages(null);
    }
    this.jdField_a_of_type_Akjx = null;
