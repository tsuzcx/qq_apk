...
public class bfsj
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong)
  {
    ...
    if (i == 0) {
      bfrh.a(paramQQAppInterface, paramLong, 106);
    }
    return i;
  }
  ...
  {
    MessageRecord localMessageRecord = bbzh.a(-2017);
    agjf.a().a(localMessageRecord.uniseq, paramLong3, paramInt5);
    ...
    localMessageRecord.msgUid = bbzj.a(paramInt1);
    localMessageRecord.msg = bgnr.a(null);
  ...
  public static Bitmap a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      Object localObject = bgmo.a(paramString, i);
      try
      {
        paramString = bgmo.a(paramString, (BitmapFactory.Options)localObject);
        if (paramString == null)
        {
          localObject = null;
          return localObject;
  ...
  public static bety a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, String paramString3, long paramLong2, int paramInt)
  {
    ...
    paramQQAppInterface = new bety(paramString1);
  ...
  public static bety a(QQAppInterface paramQQAppInterface, MessageForTroopFile paramMessageForTroopFile)
  {
    Object localObject = null;
    ...
    paramQQAppInterface = new bety((bety)localObject);
    if (TextUtils.isEmpty(paramQQAppInterface.g)) {
  ...
  public static bety a(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
  ...
  public static TroopFileData a(obj_msg.ObjMsg paramObjMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localTroopFileData.dspFileName = atvo.a(localTroopFileData.dspFileName);
  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    atwt.a(paramQQAppInterface, paramContext, Long.parseLong(paramChatMessage.frienduin), paramChatMessage.uuid, paramChatMessage.url, paramChatMessage.fileName, paramChatMessage.fileSize, paramChatMessage.bisID);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, List<besl> paramList)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        besl localbesl = (besl)localIterator.next();
        localObject1 = (List)((Map)localObject2).get(Long.valueOf(paramLong));
        paramList = (List<besl>)localObject1;
        if (localObject1 == null)
        {
          paramList = new ArrayList();
          ((Map)localObject2).put(Long.valueOf(paramLong), paramList);
        }
        localObject1 = atwt.a(paramQQAppInterface, paramLong, localbesl);
        if ((localObject1 == null) || (((bety)localObject1).e == null)) {
          break;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, boolean paramBoolean, long paramLong1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, long paramLong2, long paramLong3, String paramString6, String paramString7, int paramInt2)
  {
    ...
    if (l1 < 1L)
    {
      ...
      l2 = 0L;
      i = nlw.a();
      if ((i >= anhk.c.length) || (i < 0)) {
        break label503;
      }
    }
    label482:
    label503:
    for (String str = anhk.c[i];; str = "NONE")
    {
      ...
      for (i = 0;; i = 1)
      {
        bcst.b(paramQQAppInterface, "P_CliOper", "BizTechReport", "", "troop_troopfile", paramString1, 0, i, paramString3, paramString4, paramLong1 + "KB/s", localHashMap.toString());
        if (QLog.isColorLevel()) {
  ...
  public static boolean a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    //   4: iload_2
    //   5: iload_3
    //   6: invokestatic 939	bfsj:a	(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    //   9: astore 6
    //   11: aload 6
    //   13: ifnonnull +10 -> 23
    //   16: iload 5
    ...
    //   20: iload 4
    //   22: ireturn
    //   23: new 941	java/io/File
    //   26: dup
    //   27: aload_1
    //   28: invokespecial 942	java/io/File:<init>	(Ljava/lang/String;)V
    //   31: astore_0
    //   32: aload_0
    //   33: invokevirtual 945	java/io/File:exists	()Z
    //   36: ifeq +8 -> 44
    //   39: aload_0
    //   40: invokevirtual 948	java/io/File:delete	()Z
    //   43: pop
    //   44: aload_0
    //   45: invokevirtual 951	java/io/File:createNewFile	()Z
    //   48: pop
    //   49: new 953	java/io/BufferedOutputStream
    //   52: dup
    //   53: new 955	java/io/FileOutputStream
    //   56: dup
    //   57: aload_0
    //   58: invokespecial 958	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   61: invokespecial 961	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   64: astore_1
    //   65: aload_1
    //   66: astore_0
    //   67: aload 6
    //   69: getstatic 967	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   72: bipush 100
    //   74: aload_1
    //   75: invokevirtual 971	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   78: pop
    //   79: aload_1
    //   80: astore_0
    //   81: aload 6
    ...
    //   94: ifnull -74 -> 20
    //   97: aload_1
    //   98: invokevirtual 974	java/io/BufferedOutputStream:flush	()V
    //   101: aload_1
    //   102: invokevirtual 977	java/io/BufferedOutputStream:close	()V
    //   105: iconst_1
    //   106: ireturn
    //   107: astore_0
    //   108: iload 5
    ...
    //   135: aload_0
    //   136: invokevirtual 982	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   145: invokestatic 984	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   148: iconst_1
    //   149: ireturn
    //   150: astore_1
    //   151: aload_1
    //   152: invokevirtual 985	java/io/IOException:printStackTrace	()V
    //   155: goto -106 -> 49
    //   158: astore_0
    ...
    //   182: aload_0
    //   183: invokevirtual 982	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   192: invokestatic 984	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   195: goto -94 -> 101
    //   198: astore 6
    //   200: aconst_null
    //   201: astore_1
    ...
    //   229: aload 6
    //   231: invokevirtual 986	java/io/FileNotFoundException:toString	()Ljava/lang/String;
    ...
    //   240: invokestatic 984	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   243: iload 5
    //   245: istore 4
    //   247: aload_1
    //   248: ifnull -228 -> 20
    //   251: aload_1
    //   252: invokevirtual 974	java/io/BufferedOutputStream:flush	()V
    //   255: aload_1
    //   256: invokevirtual 977	java/io/BufferedOutputStream:close	()V
    //   259: iconst_0
    //   260: ireturn
    //   261: astore_0
    //   262: iload 5
    ...
    //   289: aload_0
    //   290: invokevirtual 982	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   299: invokestatic 984	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   302: iconst_0
    //   303: ireturn
    //   304: astore_0
    ...
    //   328: aload_0
    //   329: invokevirtual 982	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   338: invokestatic 984	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   341: goto -86 -> 255
    //   344: astore_1
    //   345: aconst_null
    //   346: astore_0
    ...
    //   348: ifnull +11 -> 359
    //   351: aload_0
    //   352: invokevirtual 974	java/io/BufferedOutputStream:flush	()V
    //   355: aload_0
    //   356: invokevirtual 977	java/io/BufferedOutputStream:close	()V
    //   359: aload_1
    //   360: athrow
    //   361: astore 6
    ...
    //   386: aload 6
    //   388: invokevirtual 982	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   397: invokestatic 984	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   400: goto -45 -> 355
    //   403: astore_0
    ...
    //   427: aload_0
    //   428: invokevirtual 982	java/io/IOException:toString	()Ljava/lang/String;
    ...
    //   437: invokestatic 984	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   440: goto -81 -> 359
    //   443: astore_1
    //   444: goto -97 -> 347
    //   447: astore 6
