  ...
  extends ahag
{
  ...
  private bgqo jdField_a_of_type_Bgqo;
  ...
  private Drawable a(String paramString)
  {
    ...
    localGradientDrawable.setCornerRadius(bajq.b(20.0F));
  ...
  private String a()
  {
    if (this.jdField_a_of_type_Bgqo == null) {
      return "";
    }
    if (this.jdField_a_of_type_Bgqo.d != 1) {
      return this.jdField_a_of_type_Bgqo.h;
    }
    return a(this.jdField_a_of_type_Bgqo.e, this.jdField_a_of_type_Bgqo.f);
  }
  ...
  public View a()
  {
    ...
    this.b = ((TextView)localView.findViewById(2131312513));
    this.c = ((TextView)localView.findViewById(2131312246));
    return localView;
  }
  ...
  {
    super.a(paramahac);
    ThreadManagerV2.getUIHandlerV2().post(new QbossADBannerCountDownManager.1(this, paramahac));
  }
