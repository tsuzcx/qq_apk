  ...
  implements IExcitingTransferSendListener
{
  ...
  public atkg(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, atkj paramatkj, atkm paramatkm)
  {
    ...
    this.jdField_a_of_type_Atkm = paramatkm;
  ...
  private ExcitingTransferEngine.ExcitingSendInfo a()
  {
    ...
    localExcitingSendInfo.mFileEntry.strLocalFilePath = this.jdField_a_of_type_Atkj.a();
    localExcitingSendInfo.mFileEntry.strFileName = this.jdField_a_of_type_Atkj.b();
    localExcitingSendInfo.mFileEntry.uFileSize = this.jdField_a_of_type_Atkj.a();
    localExcitingSendInfo.mFileEntry.buf10MMd5 = this.jdField_a_of_type_Atkj.b();
    localExcitingSendInfo.mFileEntry.bufMd5 = this.jdField_a_of_type_Atkj.a();
    localExcitingSendInfo.mFileEntry.bufSha = this.jdField_a_of_type_Atkj.d();
    localExcitingSendInfo.mFileEntry.bufSha3 = this.jdField_a_of_type_Atkj.c();
    ...
    Object localObject = this.jdField_a_of_type_Atkm.a();
    int i;
    ...
    localObject = this.jdField_a_of_type_Atkm.b();
    if (localObject != null)
    {
      i = ((List)localObject).size();
      if (i > 0)
    ...
    localExcitingSendInfo.mBusInfo.bufBusinessExt = this.jdField_a_of_type_Atkm.a();
    ...
    localExcitingSendInfo.mReqInfo.bSupportHttps = this.jdField_a_of_type_Atkm.b();
    localExcitingSendInfo.mReqInfo.strSSLCName = this.jdField_a_of_type_Atkm.a();
  ...
  public void a(long paramLong1, long paramLong2, long paramLong3)
  {
    if (this.jdField_a_of_type_Atkn != null) {
      this.jdField_a_of_type_Atkn.a(paramLong1, paramLong2, paramLong3);
    }
  }
  ...
  public void a(ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    if (this.jdField_a_of_type_Atkn != null) {
      this.jdField_a_of_type_Atkn.a(0, paramExcitingTransferUploadResultRp);
    }
  }
  ...
  public void b(int paramInt, ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    if (this.jdField_a_of_type_Atkn != null) {
      this.jdField_a_of_type_Atkn.a(paramInt, paramExcitingTransferUploadResultRp);
    }
  }
  ...
  public void onExcitingSendResult(boolean paramBoolean, int paramInt, ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    if (paramExcitingTransferUploadResultRp != null)
    {
      ...
      if (paramBoolean) {
        this.jdField_c_of_type_Long = this.jdField_a_of_type_Atkj.a();
      }
      this.jdField_b_of_type_Long = 0L;
      if (paramExcitingTransferUploadResultRp != null)
      {
        ...
        if (this.jdField_a_of_type_Atkj.a() - paramExcitingTransferUploadResultRp.m_u64StartSize <= 0L) {
          break label312;
        }
      }
    }
    ...
    label306:
    label312:
    for (long l = this.jdField_a_of_type_Atkj.a() - paramExcitingTransferUploadResultRp.m_u64StartSize;; l = 0L)
    {
  ...
  public void onExcitingSendStart()
  {
    ...
    this.jdField_a_of_type_Atkn.az_();
  }
  ...
  public void onExcitingSubSenderResult(int paramInt, ExcitingTransferUploaderRp paramExcitingTransferUploaderRp)
  {
    ...
    for (String str = paramExcitingTransferUploaderRp.toString();; str = "")
    {
      QLog.i("ExcitingTransfer.BaseUploader<FileAssistant>", 1, str);
      if (this.jdField_a_of_type_Atkn != null) {
        this.jdField_a_of_type_Atkn.a(paramInt, paramExcitingTransferUploaderRp);
      }
      return;
    }
  }
