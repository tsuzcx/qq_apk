...
{
  public atkg(QfileBaseCloudFileTabView paramQfileBaseCloudFileTabView) {}
  
  public void onClick(View paramView)
  {
    atkr localatkr = (atkr)paramView.getTag();
    Object localObject2 = (WeiYunFileInfo)localatkr.a;
    ...
    if (localObject1 != null) {
      if (localatkr.c == 1)
      {
        ...
        aumg.a((FileManagerEntity)localObject1).a(false, this.a.a, new atkh(this, (FileManagerEntity)localObject1));
      }
    }
    for (;;)
    {
      ...
      if (localatkr.c == 3)
      {
        ...
        aumg.a((FileManagerEntity)localObject1).a(false, this.a.a, new atki(this, (FileManagerEntity)localObject1));
        continue;
      }
      if (localatkr.c == 0)
      {
        ...
        ((auni)localObject2).b = "file_viewer_in";
        ((auni)localObject2).jdField_a_of_type_Int = 73;
        ((auni)localObject2).c = auog.a(((FileManagerEntity)localObject1).fileName);
        ((auni)localObject2).jdField_a_of_type_Long = ((FileManagerEntity)localObject1).fileSize;
        aunh.a(QfileBaseCloudFileTabView.g(this.a).getCurrentAccountUin(), (auni)localObject2);
      ...
      else if (localatkr.c == 2)
      {
        this.a.a.a().ab();
        QfileBaseCloudFileTabView.h(this.a).a().a(((FileManagerEntity)localObject1).nSessionId);
        continue;
        this.a.a.a().aa();
        localObject1 = new atkj(this, (WeiYunFileInfo)localObject2);
        if ((((WeiYunFileInfo)localObject2).jdField_a_of_type_Long > atyt.a()) && (aunj.a())) {
          aunj.a(false, this.a.a, (aumz)localObject1);
        } else {
          ((aumz)localObject1).a();
        }
      }
