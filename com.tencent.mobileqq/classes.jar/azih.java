  ...
  implements Manager
{
  ...
  private azik jdField_a_of_type_Azik = new azii(this);
  ...
  private ArrayList<WeakReference<azij>> jdField_a_of_type_JavaUtilArrayList;
  private List<Integer> jdField_a_of_type_JavaUtilList;
  
  public azih(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface.registObserver(this.jdField_a_of_type_Azik);
  ...
  private Pair<Boolean, List<Integer>> a(List<Integer> paramList)
  {
    ...
    List localList = ((arfp)aran.a().a(652)).a.a(false);
    if (localList.size() <= 0)
    {
      localArrayList.addAll(paramList);
      return new Pair(Boolean.valueOf(false), localArrayList);
    ...
    if (paramList.hasNext())
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if (localInteger.intValue() != localazku.a) {
          break label208;
        }
  ...
  private void a()
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        Object localObject1 = bhjc.a(BaseApplication.getContext(), "smart_selected_list" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
  ...
  /* Error */
  private void a(azij paramazij)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 42	azih:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   71: return
    //   72: aload_0
    //   73: getfield 42	azih:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
  ...
  private void b()
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = (azij)((WeakReference)localObject2).get();
          ((azij)localObject2).a(this.jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusFriendsPermissionItem, a());
          if (QLog.isColorLevel()) {
  ...
  private boolean c(List<Integer> paramList)
  {
    if (paramList.size() == 0)
    {
      bhjc.a(BaseApplication.getContext(), "smart_selected_list" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
      return true;
    }
    ...
    bhjc.a(BaseApplication.getContext(), "smart_selected_list" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), localStringBuilder.toString());
    return true;
  }
  
  /* Error */
  @android.support.annotation.Nullable
  public OnlineStatusFriendsPermissionItem a(long paramLong, boolean paramBoolean, azij paramazij)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   36: iconst_3
    //   37: aload_0
    //   38: getfield 22	azih:jdField_a_of_type_Int	I
    ...
    //   61: aload_0
    //   62: getfield 52	azih:jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusFriendsPermissionItem	Lcom/tencent/mobileqq/onlinestatus/OnlineStatusFriendsPermissionItem;
    //   65: ifnull +14 -> 79
    //   68: aload_0
    //   69: getfield 52	azih:jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusFriendsPermissionItem	Lcom/tencent/mobileqq/onlinestatus/OnlineStatusFriendsPermissionItem;
    //   72: astore 4
    //   74: aload_0
    //   75: monitorexit
    //   76: aload 4
    ...
    //   106: aload_0
    //   107: aload 4
    //   109: invokespecial 294	azih:a	(Lazij;)V
    //   112: iload_3
    //   113: ifeq +9 -> 122
    //   116: aload_0
    //   117: lload_1
    //   118: iconst_0
    //   119: invokevirtual 297	azih:a	(JZ)V
    //   122: aconst_null
    //   123: astore 4
    //   125: goto -51 -> 74
    //   128: astore 4
  ...
  {
    azil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramLong, paramBoolean, false);
  }
  ...
  public boolean a()
  {
    return !TextUtils.isEmpty(bhjc.a(BaseApplication.getContext(), "smart_selected_list" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()));
  }
  
  public boolean a(OnlineStatusPermissionChecker.OnlineStatusPermissionItem paramOnlineStatusPermissionItem, azij paramazij)
  {
    ...
    do
    {
      ...
      {
        return false;
        paramazij = a(40001L, false, paramazij);
        if (paramazij != null) {
          break;
        }
      ...
      return false;
      if (paramazij.allHasPermission != paramOnlineStatusPermissionItem.isAllHasPermission())
      {
        if (QLog.isColorLevel()) {
          QLog.d("OnlineStatusPermissionManager", 2, new Object[] { " hasPermissionChange entity.allHasPermission=", Boolean.valueOf(paramazij.allHasPermission), " item.isAllHasPermission=", paramOnlineStatusPermissionItem.getPermissionUins() });
        }
        return true;
      }
      if (paramazij.permissionUins.size() != paramOnlineStatusPermissionItem.getPermissionUins().size())
      {
        if (QLog.isColorLevel()) {
          QLog.d("OnlineStatusPermissionManager", 2, new Object[] { " hasPermissionChange entity.size=", Integer.valueOf(paramazij.permissionUins.size()), " item.size=", Integer.valueOf(paramOnlineStatusPermissionItem.getPermissionUins().size()) });
        }
        return true;
      }
    } while (paramazij.permissionUins.containsAll(paramOnlineStatusPermissionItem.getPermissionUins()));
    if (QLog.isColorLevel()) {
  ...
  public boolean a(ArrayList<azib> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        azib localazib = (azib)paramArrayList.next();
        Iterator localIterator = localList.iterator();
        ...
        } while (localazib.a != localInteger.intValue());
      }
      for (int i = 1; i == 0; i = 0)
      {
        return true;
