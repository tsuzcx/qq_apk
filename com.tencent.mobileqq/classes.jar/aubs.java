...
public class aubs
{
  ...
  private Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new aubt(this);
  ...
  public aubs(View paramView)
  {
    if (paramView != null)
    {
      this.jdField_a_of_type_AndroidViewView = paramView;
      this.jdField_a_of_type_Int = azvv.a(this.jdField_a_of_type_AndroidViewView.getContext(), 15.0F);
