...
public class wng
  extends wfm<wnh>
{
  static final String a = weg.a("StorySvc.msgtab_node_watched");
  public long b;
  public String b;
  public int c;
  public int d;
  ...
  public wfh a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new wnh(localRspMsgTabNodeWatched);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ykq.d("Q.qqstory.msgTab:ReqMsgTabNodeWatched", "" + paramArrayOfByte);
    }
    return null;
  }
