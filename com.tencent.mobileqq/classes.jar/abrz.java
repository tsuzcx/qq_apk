...
public class abrz
{
  private static abrz jdField_a_of_type_Abrz;
  ...
  static
  {
    jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool = new RecyclablePool(absa.class, 4);
    jdField_b_of_type_ComTencentCommonsdkPoolRecyclablePool = new RecyclablePool(absb.class, 4);
  ...
  {
    if (jdField_a_of_type_Abrz == null) {}
    try
    {
      if (jdField_a_of_type_Abrz == null) {
        jdField_a_of_type_Abrz = new abrz();
      }
      return jdField_a_of_type_Abrz;
    }
    finally {}
  }
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        try
        {
          ...
          if (localObject1 == null)
          {
            ...
            for (;;)
            {
              ...
              {
                localObject8 = (absa)localArrayList.get(i);
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            localObject2 = null;
            continue;
            if ((localObject2 instanceof absa))
            {
              localArrayList.add((absa)localObject2);
              localHashSet2.add(Integer.valueOf(((absa)localObject2).hashCode()));
            }
            for (;;)
            {
              i += 1;
              break;
              if ((localObject2 instanceof absb))
              {
                j = ((absb)localObject2).jdField_a_of_type_Int;
                if (localHashSet2.contains(Integer.valueOf(j))) {
                  localHashMap.put(Integer.valueOf(j), (absb)localObject2);
                } else {
                  ((absb)localObject2).recycle();
                }
              }
              else
              {
                ...
                bhnt.a("queueTask poll invalid object");
              }
            }
            a();
            continue;
            ...
            {
              ((absa)localObject8).jdField_d_of_type_Long = l3;
              ((absa)localObject8).jdField_g_of_type_Long = ((absb)localHashMap.get(Integer.valueOf(localObject8.hashCode()))).jdField_a_of_type_Long;
              localHashMap.remove(Integer.valueOf(localObject8.hashCode()));
            }
            l2 = ((absa)localObject8).jdField_d_of_type_Long - l3;
            if (l2 <= 0L)
            {
              if (HardCoderJNI.hcDebug) {
                Log.d("HardCoder.HCPerfManager", "InLoop STOP:" + i + "/" + localArrayList.size() + " task:" + ((absa)localObject8).a(l3));
              }
              localArrayList.remove(localObject8);
              localHashSet2.remove(Integer.valueOf(localObject8.hashCode()));
              ((absa)localObject8).recycle();
              j = i - 1;
            ...
            {
              l2 = Math.min(l1, l2);
              l1 = ((absa)localObject8).jdField_b_of_type_Long - l3;
              if (l1 > 0L)
              {
                if (HardCoderJNI.hcDebug) {
                  Log.d("HardCoder.HCPerfManager", "InLoop WAIT:" + i + "/" + localArrayList.size() + " task:" + ((absa)localObject8).a(l3));
                }
                l1 = Math.min(l2, l1);
                j = i;
                localObject9 = localObject2;
              ...
              {
                if (HardCoderJNI.hcDebug) {
                  Log.d("HardCoder.HCPerfManager", "InLoop  RUN:" + i + "/" + localArrayList.size() + " task:" + ((absa)localObject8).a(l3));
                }
                localObject7 = localObject2;
                if (((absa)localObject8).jdField_c_of_type_Int > 0) {
                  if ((localObject2 != null) && (localObject2.jdField_c_of_type_Int <= ((absa)localObject8).jdField_c_of_type_Int))
                  {
                    localObject7 = localObject2;
                    if (localObject2.jdField_c_of_type_Int == ((absa)localObject8).jdField_c_of_type_Int)
                    {
                      localObject7 = localObject2;
                      if (localObject2.jdField_d_of_type_Long >= ((absa)localObject8).jdField_d_of_type_Long) {}
                    }
                  }
                  else
                  {
                ...
                if (((absa)localObject8).jdField_d_of_type_Int > 0) {
                  if ((localObject3 != null) && (localObject3.jdField_d_of_type_Int <= ((absa)localObject8).jdField_d_of_type_Int))
                  {
                    localObject2 = localObject3;
                    if (localObject3.jdField_d_of_type_Int == ((absa)localObject8).jdField_d_of_type_Int)
                    {
                      localObject2 = localObject3;
                      if (localObject3.jdField_d_of_type_Long >= ((absa)localObject8).jdField_d_of_type_Long) {}
                    }
                  }
                  else
                  {
                ...
                if (((absa)localObject8).jdField_e_of_type_Int > 0)
                {
          ...
          for (localObject7 = "null";; localObject7 = localObject3.a(l3))
          {
            ...
            break;
            localObject7 = ((absa)localObject4).a(l3);
            break label1091;
            localObject7 = localObject2.a(l3);
            break label1116;
            localObject7 = ((absa)localObject5).a(l3);
            break label1157;
          }
          l2 = 0L;
          j = 0;
          ...
          if (i > 0)
          {
            ...
            {
              localObject9 = (absa)((Iterator)localObject7).next();
              Log.i("HardCoder.HCPerfManager", "!cancelBindCore task:" + ((absa)localObject9).a(l3));
              if ((((absa)localObject9).jdField_d_of_type_Long <= l3) || (HardCoderJNI.checkEnv))
              {
                if (((absa)localObject9).jdField_e_of_type_Int == 0)
                {
                  if (!HardCoderJNI.checkEnv) {
                    break label1799;
                  }
                  bhnt.a("bindTid:" + ((absa)localObject9).jdField_e_of_type_Int);
                }
                localObject6[i] = ((absa)localObject9).jdField_e_of_type_Int;
                i += 1;
              }
              else
              {
          ...
          for (;;)
          {
            ...
            for (;;)
            {
              ...
              localObject7 = (absa)((Iterator)localObject6).next();
              Log.i("HardCoder.HCPerfManager", "requestBindCore task:" + ((absa)localObject7).a(l3));
              if (((absa)localObject7).jdField_d_of_type_Long <= l3)
              {
                if (!HardCoderJNI.checkEnv) {
                  break;
                }
                bhnt.a("stopTime:" + (((absa)localObject7).jdField_d_of_type_Long - l3));
              }
              if (((absa)localObject7).jdField_e_of_type_Int == 0)
              {
                if (!HardCoderJNI.checkEnv) {
                  break label2380;
                }
                bhnt.a("bindTid:" + ((absa)localObject7).jdField_e_of_type_Int);
              }
              localObject9[m] = ((absa)localObject7).jdField_e_of_type_Int;
              m += 1;
              k = ((absa)localObject7).jdField_f_of_type_Int;
              l2 = ((absa)localObject7).jdField_a_of_type_Long;
              j = ((absa)localObject7).jdField_g_of_type_Int;
              i = Math.min((int)(((absa)localObject7).jdField_d_of_type_Long - l3), i);
            }
            a();
          }
          a();
        ...
        if (localObject3 == null)
        {
          if (localObject5 != null)
          {
            Log.i("HardCoder.HCPerfManager", "!cancelHighIOFreq task:" + ((absa)localObject5).a(l3));
            if ((!jdField_a_of_type_Boolean) && (HardCoderJNI.checkEnv)) {
              HardCoderJNI.cancelHighIOFreq(((absa)localObject5).jdField_g_of_type_Int, SystemClock.elapsedRealtimeNanos());
            }
          }
          if (localObject3 == null) {
            break label3670;
      ...
      for (;;)
      {
        ...
        if (localObject2 == null)
        {
          if (localObject4 != null)
          {
            Log.i("HardCoder.HCPerfManager", "!cancelCpuHighFreq task:" + ((absa)localObject4).a(l3));
            if ((!jdField_a_of_type_Boolean) && (HardCoderJNI.checkEnv)) {
              HardCoderJNI.cancelCpuHighFreq(((absa)localObject4).jdField_g_of_type_Int, SystemClock.elapsedRealtimeNanos());
            }
          }
          if (localObject2 == null) {
            break label3652;
        ...
        for (;;)
        {
          ...
          for (boolean bool = true;; bool = false)
          {
            ...
            if (localObject5 == null) {}
            for (localObject5 = "null";; localObject5 = ((absa)localObject5).a(l3))
            {
            ...
            if (localObject4 == null) {}
            for (localObject4 = "null";; localObject4 = ((absa)localObject4).a(l3))
            {
          ...
          if (localObject2 == localObject2)
          {
            ...
            localObject4 = (absa)localArrayList.get(k);
            if (HardCoderJNI.hcDebug) {
              Log.d("HardCoder.HCPerfManager", "CheckTask:" + k + "/" + localArrayList.size() + " task:" + ((absa)localObject4).a(l3));
            }
            if ((((absa)localObject4).jdField_c_of_type_Int <= 0) && (((absa)localObject4).jdField_d_of_type_Int <= 0) && (((absa)localObject4).jdField_e_of_type_Int <= 0)) {
              break label3225;
            }
            bool = true;
            bhnt.a(bool);
            if ((((absa)localObject4).jdField_a_of_type_Long <= 0L) && (((absa)localObject4).jdField_f_of_type_Int <= 0)) {
              break label3231;
            }
            bool = true;
            bhnt.a(bool);
            localObject5 = "taskInintTime:" + (((absa)localObject4).jdField_c_of_type_Long - l3);
            if (((absa)localObject4).jdField_c_of_type_Long > l3) {
              break label3237;
            }
            bool = true;
            bhnt.a((String)localObject5, bool);
            localObject5 = "taskStopTime:" + (((absa)localObject4).jdField_d_of_type_Long - l3);
            if (((absa)localObject4).jdField_d_of_type_Long < l3) {
              break label3243;
            }
            bool = true;
            bhnt.a((String)localObject5, bool);
            ...
            label3052:
            bhnt.a((String)localObject5, bool);
            if (((absa)localObject4).jdField_b_of_type_Long <= l3) {
              break label3279;
            }
            ...
            bool = true;
            bhnt.a(bool);
            localObject5 = "next:" + l1 + " start:" + (((absa)localObject4).jdField_b_of_type_Long - l3);
            if (l1 > ((absa)localObject4).jdField_b_of_type_Long - l3) {
              break label3273;
            }
            bool = true;
            label3175:
          ...
          do
          {
            ...
            bool = false;
            break label3175;
            localObject5 = "nextWake:" + l1 + " stop:" + (((absa)localObject4).jdField_d_of_type_Long - l3);
            if (l1 > ((absa)localObject4).jdField_d_of_type_Long - l3) {
              break label3600;
            }
            bool = true;
            bhnt.a((String)localObject5, bool);
            ...
            bool = true;
            bhnt.a((String)localObject5, bool);
            localObject5 = "reqTimeStamp:" + j + " stop:" + (((absa)localObject4).jdField_d_of_type_Long - l3);
            if (j > ((absa)localObject4).jdField_d_of_type_Long - l3) {
              break label3612;
            }
            bool = true;
            bhnt.a((String)localObject5, bool);
            localObject5 = "reqCpu:" + i + " task:" + ((absa)localObject4).jdField_c_of_type_Int;
            if (i > ((absa)localObject4).jdField_c_of_type_Int) {
              break label3618;
            }
            bool = true;
            bhnt.a((String)localObject5, bool);
            localObject5 = "reqIO:" + m + " task:" + ((absa)localObject4).jdField_d_of_type_Int;
            if (m > ((absa)localObject4).jdField_d_of_type_Int) {
              break label3624;
            }
            bool = true;
            bhnt.a((String)localObject5, bool);
          } while (((absa)localObject4).jdField_e_of_type_Int <= 0);
          label3444:
          bhnt.a(localHashSet1.contains(localObject4));
          label3554:
  ...
  {
    absa localabsa = (absa)jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool.obtain(absa.class);
    localabsa.jdField_a_of_type_Int = paramInt1;
    localabsa.jdField_c_of_type_Int = paramInt2;
    localabsa.jdField_d_of_type_Int = paramInt3;
    localabsa.jdField_e_of_type_Int = paramInt4;
    localabsa.jdField_b_of_type_Int = paramInt5;
    localabsa.jdField_f_of_type_Int = paramInt6;
    localabsa.jdField_a_of_type_Long = paramLong;
    localabsa.jdField_g_of_type_Int = paramInt7;
    localabsa.jdField_c_of_type_Long = System.currentTimeMillis();
    localabsa.jdField_b_of_type_Long = (localabsa.jdField_c_of_type_Long + paramInt1);
    localabsa.jdField_d_of_type_Long = (localabsa.jdField_c_of_type_Long + paramInt1 + paramInt5);
    localabsa.jdField_a_of_type_JavaLangString = paramString;
    localabsa.jdField_e_of_type_Long = localabsa.jdField_b_of_type_Long;
    localabsa.jdField_f_of_type_Long = localabsa.jdField_c_of_type_Long;
    if ((paramInt1 < 0) || (paramInt2 < 0) || (paramInt3 < 0) || (paramInt4 < 0) || (paramInt5 <= 0) || ((paramInt2 == 0) && (paramInt3 == 0) && (paramInt4 == 0)))
    {
      Log.e("HardCoder.HCPerfManager", "ErrorParam task:" + localabsa.a(localabsa.jdField_c_of_type_Long));
      return 0;
    }
    boolean bool = this.jdField_a_of_type_JavaUtilConcurrentLinkedBlockingQueue.offer(localabsa);
    if (HardCoderJNI.hcDebug) {
      Log.d("HardCoder.HCPerfManager", "OutCallAddTask ret:" + bool + " task:" + localabsa.a(localabsa.jdField_c_of_type_Long));
    }
    if (bool) {
      return localabsa.hashCode();
    }
    return 0;
  }
  ...
  {
    absb localabsb = (absb)jdField_b_of_type_ComTencentCommonsdkPoolRecyclablePool.obtain(absb.class);
    localabsb.jdField_a_of_type_Long = System.currentTimeMillis();
    localabsb.jdField_a_of_type_Int = paramInt;
    if (paramInt != 0) {}
    for (boolean bool = this.jdField_a_of_type_JavaUtilConcurrentLinkedBlockingQueue.offer(localabsb);; bool = false)
    {
      if (HardCoderJNI.hcDebug) {
