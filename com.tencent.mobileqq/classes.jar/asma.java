...
public class asma
{
  public static View a(Context paramContext, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    case 5: 
    case 7: 
      return LayoutInflater.from(paramContext).inflate(2131559122, paramViewGroup, false);
    }
  ...
  public static aslv a(Context paramContext, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    default: 
      return null;
    case 5: 
      return new asmc(paramContext, localView, paramViewGroup);
    case 7: 
      return new asmb(paramContext, localView, paramViewGroup);
    }
    return new aslw(paramContext, localView, paramViewGroup);
  }
}
