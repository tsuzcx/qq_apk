...
{
  public aqut(ColorNoteSmallScreenService paramColorNoteSmallScreenService) {}
    ...
    for (;;)
    {
      ...
      if (QLog.isDevelopLevel())
      {
        ...
        if ((paramContext != null) && (paramContext.size() != 0))
        {
          ...
          if (aqsd.a(paramContext)) {
            ColorNoteSmallScreenService.a(this.a).a();
          }
          if (QLog.isColorLevel())
          {
            aqsd.a("ColorNoteSmallScreenService", "[onReceive->FromType_UpdateData]\n[visibleColorNotes]: " + this.a.jdField_a_of_type_Int + "\n" + aqsd.b(paramContext));
            break label728;
            paramContext = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a();
            if ((!aqrl.a()) && (((paramContext.size() == 1) && (aqsd.b((ColorNote)paramContext.get(0)))) || (paramContext.size() == 0)))
            {
              this.a.f();
              break label728;
              ...
              aqsd.a("ColorNoteSmallScreenService", "[onReceive->FromType_CustomNightMode]\n[setCustomNightMode]: " + bool);
              break label728;
              label549:
