...
public class aqut
{
  private static aqut jdField_a_of_type_Aqut;
  ...
  {
    if (jdField_a_of_type_Aqut == null) {
      jdField_a_of_type_Aqut = new aqut();
    }
    return jdField_a_of_type_Aqut;
  }
  
  public static URLDrawable a(String paramString, int paramInt1, int paramInt2)
  {
    URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
    localURLDrawableOptions.mLoadingDrawable = new amym(-10065297, 100, 100);
    localURLDrawableOptions.mFailedDrawable = new amym(-10065297, 100, 100);
  ...
  public static URLDrawable a(String paramString1, String paramString2, long paramLong, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt3, QQLiveDrawable.OnStateListener paramOnStateListener, URLDrawable paramURLDrawable)
  {
    ...
    localQQLiveDrawableParams.mCoverLoadingDrawable = new amym(-10065297, 100, 100);
    ...
    for (paramString1.mLoadingDrawable = paramURLDrawable;; paramString1.mLoadingDrawable = new amym(-10065297, 100, 100))
    {
      paramString1.mRequestWidth = paramInt1;
      paramString1.mRequestHeight = paramInt2;
      return URLDrawable.getDrawable(adoi.a(paramLong), paramString1);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Aquu != null) {
      this.jdField_a_of_type_Aquu.a(paramBoolean);
    }
  }
  ...
  public boolean a()
  {
    ...
    if ((localAppRuntime != null) && ((localAppRuntime instanceof QQAppInterface))) {
      return MediaPlayerManager.a((QQAppInterface)localAppRuntime).c();
    }
    return false;
  }
}
