...
public class lit
{
  ...
  public static liu a(byte[] paramArrayOfByte)
  {
    ...
    localObject = new liu(j, k);
    System.arraycopy(paramArrayOfByte, 9, ((liu)localObject).a, 0, j);
    System.arraycopy(paramArrayOfByte, j + 9, ((liu)localObject).b, 0, k);
    return localObject;
  }
