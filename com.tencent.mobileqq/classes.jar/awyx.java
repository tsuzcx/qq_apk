  ...
  extends xop
{
  ...
  private static ConcurrentHashMap<String, bbwn> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private static final String[] jdField_a_of_type_ArrayOfJavaLangString = { "GroupCare", "FriendClone", "groupnick", "profilelogic", "Face", "RoamWrap", "FontBubbleRecommend", "QCUniBusinessLogin", "ProfileMusicBox", "QcHomePageLogic", "QcUniBusinessUserInfo" };
  
  public static void a(bbwn parambbwn)
  {
    jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(parambbwn.a(), parambbwn);
  }
  
  public static void b(bbwn parambbwn)
  {
    jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(parambbwn.a());
  }
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    else
    {
      ...
      if (jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(paramToServiceMsg.getServiceCmd()))
      {
        paramToServiceMsg = ((bbwn)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramToServiceMsg.getServiceCmd())).a(paramToServiceMsg, paramFromServiceMsg, localUniPacket);
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    } while (!jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(paramToServiceMsg.getServiceCmd()));
    Object localObject = (bbwn)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramToServiceMsg.getServiceCmd());
    int i = jdField_a_of_type_Int;
    jdField_a_of_type_Int = i + 1;
    ((bbwn)localObject).a(paramToServiceMsg, paramUniPacket, i);
    return true;
  }
