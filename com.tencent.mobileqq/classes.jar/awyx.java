  ...
  extends xom
{
  ...
  {
    if ((akjc.a.equals(paramToServiceMsg.getServiceCmd())) || (akjc.b.equals(paramToServiceMsg.getServiceCmd())))
    {
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (akjc.a.equals(paramToServiceMsg.getServiceCmd()))
    {
    ...
    {
      return true;
      if (akjc.b.equals(paramToServiceMsg.getServiceCmd()))
      {
