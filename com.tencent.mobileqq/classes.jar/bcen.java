...
public class bcen
  extends bceg<Bundle, Void, HashMap<String, Object>>
{
  protected Handler a;
  public bceo a;
  
  public bcen(String paramString1, String paramString2, bceo parambceo)
  {
    super(paramString1, paramString2);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_Bceo = parambceo;
  }
  ...
  public bcej a(String paramString1, String paramString2, Bundle paramBundle)
  {
  ...
  public void a()
  {
    this.jdField_a_of_type_Bceo = null;
  }
  ...
  public HashMap<String, Object> b(Bundle... paramVarArgs)
  {
    ...
    try
    {
      ...
      j = bcfa.a(bbtm.a().a(), (String)localObject).a("Common_HttpRetryCount");
      bcds.c("OpenConfig_agent", "config 1:Common_HttpRetryCount            config_value:" + j + "   appid:" + (String)localObject + "     url:" + str2);
      if (j == 0)
      {
        j = 3;
        bcds.c("OpenConfig_agent", "config 1:Common_HttpRetryCount            result_value:" + j + "   appid:" + (String)localObject + "     url:" + str2);
    ...
    catch (Exception localException)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          try
          {
            localbcej = a(this.jdField_a_of_type_JavaLangString, this.b, paramVarArgs[0]);
            l2 = l1;
            l4 = l1;
            str1 = localbcej.jdField_a_of_type_JavaLangString;
            l2 = l1;
            l4 = l1;
            ...
            l2 = l1;
            l4 = l1;
            ((JSONObject)localObject).put("content", localbcej.jdField_a_of_type_JavaIoInputStream);
          }
          catch (ConnectTimeoutException localConnectTimeoutException)
          {
            ...
            l2 = l1;
            l4 = l1;
            localJSONObject1.put("httpdatamodified", localbcej.jdField_a_of_type_Int);
            continue;
          }
          ...
          catch (HttpBaseUtil.HttpStatusException paramVarArgs)
          {
            ...
            try
            {
              ...
              bcfk.a().a(str2, l3, l2, 0L, i, bbtm.a().a(), "1000002", null);
              return localHashMap;
            }
          ...
          catch (Exception paramVarArgs)
          {
            ...
            {
              i = Integer.parseInt(paramVarArgs.getMessage().replace("http status code error:", ""));
              bcfk.a().a(str2, l3, l4, 0L, i, bbtm.a().a(), "1000002", null);
              return localHashMap;
            }
            catch (Exception paramVarArgs)
            {
          ...
          l2 = l1;
          l4 = l1;
          bcds.a("HttpCgiAsyncTask", "response.isModified= " + localbcej.jdField_a_of_type_Int);
          l2 = l1;
          l4 = l1;
          if (localbcej.jdField_a_of_type_Int == 0)
          {
            if (!bool) {
              continue;
            }
            ...
            l2 = l1;
            l4 = l1;
            localJSONObject2.put("httpdatamodified", localbcej.jdField_a_of_type_Int);
            l2 = l1;
            l4 = l1;
          ...
          l2 = l1;
          l4 = l1;
          l1 = localbcej.jdField_a_of_type_Long;
          l2 = l1;
          l4 = l1;
          l5 = localbcej.b;
          l2 = l5;
          l4 = l3;
          bcds.c("ReportManager", str2 + " | " + l4 + " | " + l1 + " | " + l2 + " | " + i);
          l3 = 0L;
          try
          {
          ...
          bcfk.a().a(str2, l4, l1, l2, i, l3, "1000002", null);
          return localHashMap;
          if (!bool) {
            continue;
          }
