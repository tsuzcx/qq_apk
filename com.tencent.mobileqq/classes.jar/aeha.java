...
{
  aeha(aegu paramaegu, AIOShortVideoData paramAIOShortVideoData, File paramFile, int paramInt, aeja paramaeja) {}
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        paramAdapterView = this.jdField_a_of_type_Aegu.jdField_a_of_type_Aeie.a();
        ...
        axqw.b(null, "dc00898", "", "", "0X8009EF9", "0X8009EF9", paramInt, 0, "", "", "", "");
        return;
        int i = 1;
        if (this.jdField_a_of_type_Aegu.jdField_a_of_type_Aejd.asBinder().pingBinder())
        {
          paramAdapterView = this.jdField_a_of_type_Aegu.jdField_a_of_type_Aejd.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData.jdField_f_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData.jdField_f_of_type_Int, this.jdField_a_of_type_Aegu.jdField_g_of_type_Int);
          if (paramAdapterView != null)
          {
            paramAdapterView.putExtra("NeedReportForwardShortVideo", true);
            if (this.jdField_a_of_type_Aegu.jdField_a_of_type_Aeie.a() != null)
            {
              paramView = this.jdField_a_of_type_Aegu.jdField_a_of_type_Aeie.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
            ...
            aqbc.a(aegu.G(this.jdField_a_of_type_Aegu), paramAdapterView);
          }
        }
        paramInt = i;
        if (this.jdField_a_of_type_Aegu.jdField_c_of_type_Boolean)
        {
          ...
          paramAdapterView = bgyf.a();
          paramAdapterView.a = this.jdField_a_of_type_Aegu.jdField_b_of_type_JavaLangString;
          bgxy.c(aegu.H(this.jdField_a_of_type_Aegu), paramAdapterView, this.jdField_a_of_type_JavaIoFile.getAbsolutePath(), 10001);
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData.j == 5002)
          {
            ...
            bcpw.a(aegu.I(this.jdField_a_of_type_Aegu), 1, ajyc.a(2131700041), 0).a();
            return;
          }
          if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData.jdField_b_of_type_Int == 1)
          {
            aegu.a(this.jdField_a_of_type_Aegu, this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaIoFile);
          }
          else if ((this.jdField_a_of_type_JavaIoFile != null) && (this.jdField_a_of_type_JavaIoFile.exists()) && (this.jdField_a_of_type_JavaIoFile.length() == this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData.h))
          {
            ...
            ThreadManager.getFileThreadHandler().post(new ShortVideoUtils.VideoFileSaveRunnable(this.jdField_a_of_type_JavaIoFile.getAbsolutePath(), this.jdField_a_of_type_Aegu.jdField_a_of_type_MqqOsMqqHandler, paramAdapterView, false));
          }
          else if (!AppNetConnInfo.isNetSupport())
          {
            this.jdField_a_of_type_Aegu.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(10001);
          }
          else if ((!AppNetConnInfo.isWifiConn()) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData.h > 29360128L))
          {
            this.jdField_a_of_type_Aegu.a(3, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData, this.jdField_a_of_type_Aeja);
          }
          else
          {
            aegu.a(this.jdField_a_of_type_Aegu, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData, this.jdField_a_of_type_Aeja);
            this.jdField_a_of_type_Aeja.jdField_a_of_type_Aejb.a = true;
            this.jdField_a_of_type_Aegu.u();
            continue;
            axqw.b(null, "P_CliOper", "dwop_via", "", "0X8009BE4", "0X8009BE4", this.jdField_a_of_type_Aegu.k, 0, "", "", "", "");
            paramView = this.jdField_a_of_type_Aegu.d;
            paramAdapterView = paramView;
            if (TextUtils.isEmpty(paramView)) {
              paramAdapterView = this.jdField_a_of_type_Aegu.jdField_c_of_type_JavaLangString;
            }
            aegu.a(aegu.J(this.jdField_a_of_type_Aegu), this.jdField_a_of_type_Aegu.jdField_g_of_type_Int, this.jdField_a_of_type_Aegu.jdField_c_of_type_JavaLangString, paramAdapterView, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData.jdField_g_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData.i, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData.jdField_g_of_type_Int, false);
            paramInt = 6;
            continue;
            i = 3;
            paramInt = i;
            if (this.jdField_a_of_type_Aegu.jdField_a_of_type_Aejd.asBinder().pingBinder())
            {
              ...
              if (paramAdapterView != null)
              {
                bgpd.a(paramAdapterView).a(aegu.K(this.jdField_a_of_type_Aegu), BaseApplicationImpl.getApplication().getRuntime().getAccount());
                bgpr.a(null, 3, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData.jdField_g_of_type_Int);
                ...
                aegu.L(this.jdField_a_of_type_Aegu).startActivity(paramAdapterView);
                ...
                else
                {
                  ...
                  if (this.jdField_a_of_type_Aegu.jdField_a_of_type_Aejd.asBinder().pingBinder())
                  {
                    this.jdField_a_of_type_Aegu.jdField_a_of_type_Aejd.c(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData.jdField_f_of_type_Long);
                    bcpw.a(aegu.M(this.jdField_a_of_type_Aegu), aegu.N(this.jdField_a_of_type_Aegu).getString(2131692829), 0).a();
                    paramInt = i;
                  }
                }
              }
    ...
    axqw.b(null, "dc00898", "", "", "0X8009EF8", "0X8009EF8", paramInt, 0, "", "", "", "");
  }
}
