...
public class anxt
{
  ...
  public static HashMap<String, anxt> a(int paramInt, JSONObject paramJSONObject)
  {
    ...
    if (paramJSONObject.has("animation_sets"))
    {
      ...
      for (;;)
      {
        ...
        if (localObject1 != null)
        {
          ...
          for (localObject1 = anxv.a((JSONObject)localObject1);; localObject1 = anxu.a((JSONObject)localObject1))
          {
            if (localObject1 == null) {
              break label226;
            }
            ((anxt)localObject1).jdField_a_of_type_Int = paramInt;
            paramJSONObject.put(((anxt)localObject1).jdField_a_of_type_JavaLangString, localObject1);
            break;
          }
        }
      }
    ...
    if ((localObject1 != null) && (((HashMap)localObject1).size() > 0)) {
      anwm.a().a.put(Integer.valueOf(paramInt), localObject1);
    }
    return localObject1;
  }
