...
public class adpm
{
  ...
  public static void a(Activity paramActivity, String paramString)
  {
    ...
    if (behc.a.containsKey("PublicAccountJs")) {
    ...
    localIntent.putExtra("leftViewText", paramActivity.getString(2131695684));
    localIntent.putExtra("assignBackText", paramActivity.getString(2131695684));
