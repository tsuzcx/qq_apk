...
public class ajlv
  extends aocj
{
  public ajlv(SystemMsgListView paramSystemMsgListView) {}
  
  protected void a(String paramString)
  {
    if (this.a.jdField_a_of_type_Ajjg.a())
    {
      paramString = SystemMsgListView.a(this.a).getResources().getString(2131718517);
    ...
    for (;;)
    {
      ...
      if (!paramBoolean)
      {
        ...
        for (;;)
        {
          ...
          return;
          paramString3 = SystemMsgListView.a(this.a).getResources().getString(2131717877);
        }
      }
      paramString1 = SystemMsgListView.a(this.a).getResources().getString(2131692412);
      ...
      try
      {
        this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(antf.M, 0, l2, localStructMsg.toByteArray());
        ...
        if (ajma.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(localStructMsg.req_uin.get()), localStructMsg, false))
        {
        ...
        AutoRemarkActivity.a(this.a.jdField_a_of_type_Ajjg.getActivity(), 0, String.valueOf(localStructMsg.req_uin.get()), l1, paramString3);
        return;
      }
      catch (Exception paramString1)
      {
