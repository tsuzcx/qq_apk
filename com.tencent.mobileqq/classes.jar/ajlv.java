...
public class ajlv
  extends ajiy
{
  public ajlv(QQAppInterface paramQQAppInterface, Context paramContext, Entity paramEntity)
  {
  ...
  public View a(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, View.OnClickListener paramOnClickListener)
  {
    ...
    if ((paramView == null) || (!(paramView.getTag() instanceof ajlw)))
    {
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558991, paramViewGroup, false);
      paramOnClickListener = new ajlw();
      paramOnClickListener.d = ((ImageView)paramViewGroup.findViewById(2131368381));
      paramOnClickListener.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)paramViewGroup.findViewById(2131378659));
      paramOnClickListener.c = ((SingleLineTextView)paramViewGroup.findViewById(2131380060));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131369564));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton = ((Button)paramViewGroup.findViewById(2131376596));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131376606));
      paramViewGroup.setTag(paramOnClickListener);
      a(paramViewGroup.findViewById(2131368381));
    ...
    default: 
      ...
      if (paramView == null) {
        paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131718976);
      }
      break;
    case 1: 
    case 2: 
    ...
    case 8: 
      for (;;)
      {
        if ((paramInt2 == 0) || (paramInt2 == 6))
        {
          ...
          paramOnClickListener.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setTextColor(a(this.jdField_a_of_type_AndroidContentContext, 2131167033));
          ...
          paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131700717));
          paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(anvx.a(2131700720));
          label509:
          if (AppSetting.c)
          {
          ...
          paramOnClickListener = (ajlw)paramView.getTag();
          paramViewGroup = paramView;
          break;
          paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131718967);
          continue;
          paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131718969);
          continue;
          paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131718973);
          continue;
          paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131718978);
          continue;
          paramView = "";
          continue;
    ...
    for (;;)
    {
      ...
      paramOnClickListener.c.setVisibility(8);
      break label385;
      if (((anvk)localObject).a(localPhoneContact.unifiedCode, true))
      {
        paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131700719));
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(anvx.a(2131700721));
        break label509;
      }
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setText(anvx.a(2131689550));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setTag(localPhoneContact);
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setContentDescription(anvx.a(2131689550));
