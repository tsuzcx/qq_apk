...
public class qqh
  extends Handler
{
  public qqh(VideoFeedsPlayManager paramVideoFeedsPlayManager, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void dispatchMessage(Message paramMessage)
  {
    ...
    {
      return;
      if (!(paramMessage.obj instanceof qql)) {
        break;
      }
    } while (!VideoFeedsPlayManager.a(this.a, (qql)paramMessage.obj));
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    qql localqql = VideoFeedsPlayManager.b(this.a);
    long l1;
    boolean bool;
    if ((paramMessage != null) && (paramMessage.c()) && ((localqql.jdField_a_of_type_Qjs == null) || (!localqql.jdField_a_of_type_Qjs.a(localqql))) && (!paramMessage.h()))
    {
      l1 = paramMessage.a();
      long l2 = paramMessage.b();
      if (localqql.jdField_a_of_type_Qjs != null) {
        localqql.jdField_a_of_type_Qjs.a(localqql, l1, l2);
      }
      if (l1 < l2 - 300L) {
        break label495;
      }
      ...
      if ((!VideoFeedsPlayManager.f(this.a)) && (VideoFeedsPlayManager.a(this.a) != null))
      {
        ...
        if ((localqql.jdField_a_of_type_Qjs != null) && (!VideoFeedsPlayManager.g(this.a)))
        {
          if ((!VideoFeedsPlayManager.h(this.a)) && (!VideoFeedsPlayManager.i(this.a))) {
            break label489;
          }
          bool = true;
          localqql.jdField_a_of_type_Qjs.a(VideoFeedsPlayManager.b(this.a), i, bool);
        }
      }
    }
    for (;;)
    {
      ...
      if ((l1 <= 500L) && (l1 >= 0L) && (VideoFeedsPlayManager.j(this.a)))
      {
        ...
        paramMessage.o();
        if ((VideoFeedsPlayManager.b(this.a).jdField_a_of_type_ComTencentBizPubaccountVideoInfo.c) && (oaq.a(VideoFeedsPlayManager.b(this.a).jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a)))
        {
        ...
        else if (VideoFeedsPlayManager.a(this.a) != null)
        {
          ...
          while (paramMessage.hasNext()) {
            ((qqn)paramMessage.next()).a(VideoFeedsPlayManager.b(this.a), VideoFeedsPlayManager.b(this.a));
          }
        }
      }
    }
