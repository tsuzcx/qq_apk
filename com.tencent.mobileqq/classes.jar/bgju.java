...
public class bgju
  extends aahn
{
  public bgju(TroopFileTransferManager paramTroopFileTransferManager) {}
  ...
  public void a(boolean paramBoolean, int paramInt1, String paramString, int paramInt2, int paramInt3, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      paramString = (bfif)this.a.a().b.get(paramString);
    } while ((paramString == null) || (paramInt1 != 0));
    aagu.a(this.a.a, this.a.e, paramString.a, paramString.b, TroopFileTransferManager.a(this.a));
