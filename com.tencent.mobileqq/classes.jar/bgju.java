...
public class bgju
{
  ...
  {
    long l = 0L;
    paramContext = paramContext.getSharedPreferences(String.valueOf(anhk.G), 0);
  ...
  public static String a(Context paramContext, String paramString)
  {
    ...
    SharedPreferences localSharedPreferences = paramContext.getSharedPreferences(String.valueOf(anhk.G), 0);
  ...
  public static String a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (localList.size() > 0)
    {
      ...
      if (i < localList.size())
      {
        ...
        for (str2 = bglf.a(paramQQAppInterface, str3, true);; str2 = bglf.b(paramQQAppInterface, str3, true))
        {
