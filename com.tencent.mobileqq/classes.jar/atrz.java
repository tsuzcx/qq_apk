...
public class atrz
{
  ...
  private HashMap<Integer, atsg> jdField_a_of_type_JavaUtilHashMap;
  private boolean jdField_a_of_type_Boolean;
  
  public atrz(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Atse = new atse(this);
  ...
  private static String a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 2)
    {
      ...
      bdll.b(null, "dc00898", "", "", "0X800B00E", "0X800B00E", 0, 0, "", "", "", "");
    }
    for (;;)
    {
  ...
  {
    bdll.b(null, "dc00898", "", "", "0X800B00D", "0X800B00D", 0, 0, "", "", "", "");
  }
  
  public String a(Context paramContext)
  {
    String str2 = ((atsh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(317)).a().jdField_a_of_type_JavaLangString;
    String str1 = str2;
    if (TextUtils.isEmpty(str2)) {
      str1 = paramContext.getString(2131697543);
    }
    return str1;
  }
  ...
  public void a(Context paramContext, String paramString)
  {
    ...
    if (aure.a().a() == null)
    {
      ...
      paramString.putString("_filename_from_dlg", paramContext.getString(2131694093));
    ...
    paramString.putString("DOWNLOAD_BIG_BROTHER_SOURCE", "biz_src_jc_file");
    paramString.putBundle("_user_data", (Bundle)localObject);
    aure.a().a("https://a.app.qq.com/o/myapp-down?g_f=1116518", paramString);
  }
  
  public void a(String paramString, atsg paramatsg)
  {
    a();
    ThreadManagerV2.excute(new QFileAppStorePromoteManager.2(this, paramString, paramatsg), 128, null, true);
  }
  ...
  public boolean a(Context paramContext, String paramString, atsf paramatsf)
  {
    if (((atsh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(317)).a().jdField_a_of_type_Boolean)
    {
      String str1 = paramContext.getString(2131697549);
      paramString = String.format(paramContext.getString(2131697546), new Object[] { paramString });
      String str2 = paramContext.getString(2131697547);
      String str3 = paramContext.getString(2131697548);
      atsa localatsa = new atsa(this, paramatsf);
      paramatsf = new atsb(this, paramatsf);
      bhlq.a(paramContext, 0, str1, paramString, str2, str3, paramContext.getString(2131690580), localatsa, paramatsf).show();
      bdll.b(null, "dc00898", "", "", "0X800AE3F", "0X800AE3F", 0, 0, "", "", "", "");
      return true;
    }
    return false;
  }
  ...
  {
    if (aure.a().a("https://a.app.qq.com/o/myapp-down?g_f=1116518"))
    {
      QQToast.a(paramContext, 0, 2131697545, 0).a();
      return;
    }
    String str = paramContext.getString(2131697544);
    bhlq.a((Activity)paramContext, str, 2131690580, 2131694098, new atsc(this, paramContext, paramString), new atsd(this)).show();
  }
  
  public boolean b()
  {
    return ((atsh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(317)).a().jdField_a_of_type_Boolean;
  }
}
