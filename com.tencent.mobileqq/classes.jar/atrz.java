...
public class atrz
{
  ...
  {
    boolean bool = true;
    if ((this.jdField_a_of_type_Atru == null) || (this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferOneSlotComplete == null))
    {
    ...
    HashMap localHashMap = this.jdField_a_of_type_Atru.a();
    ...
    String str2 = a();
    if (this.jdField_a_of_type_Atru.jdField_b_of_type_Long == 0L) {}
    for (;;)
    {
      localStatisticCollector.collectPerformance(str1, str2, bool, 0L, 0L, localHashMap, "");
      this.jdField_a_of_type_Atru = null;
  ...
  public void a(int paramInt, long paramLong1, String paramString, long paramLong2, long paramLong3)
  {
    ...
    this.jdField_a_of_type_Atru.jdField_a_of_type_Long = paramInt;
    this.jdField_a_of_type_Atru.jdField_b_of_type_Long = paramLong1;
    this.jdField_a_of_type_Atru.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Atru.d = paramLong2;
    this.jdField_a_of_type_Atru.c = paramLong3;
    this.jdField_a_of_type_Atru.jdField_a_of_type_Int = 0;
    this.jdField_a_of_type_Atru.jdField_b_of_type_Int = 1;
  }
