      ...
      do
      {
        do
        {
          do
          {
            ...
            new axyn().a((AIOPictureData)localObject, paramInt2, paramString);
            return i;
          ...
          new axyo().a((AIOVideoData)localObject, paramInt2, paramString);
          return i;
        ...
        new axyj().a((AIOFilePictureData)localObject, paramInt2, paramString);
        return i;
