...
public class bjkp
{
  ...
  private bjko jdField_a_of_type_Bjko = new bjkq(this);
  ...
  public float a(int paramInt)
  {
    ...
    if ((this.b) && (this.jdField_a_of_type_Bjkn != null) && (this.jdField_a_of_type_Bjkn.jdField_a_of_type_Boolean) && (paramInt >= this.jdField_a_of_type_Int)) {
      return this.jdField_a_of_type_Bjkn.a(paramInt - this.jdField_a_of_type_Int);
    }
    return -1.0F;
  }
