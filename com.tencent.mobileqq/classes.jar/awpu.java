...
public class awpu
{
  ...
  private static final Comparator<awpx> jdField_a_of_type_JavaUtilComparator = new awpv();
  private static final Comparator<MostUsedSearch> b = new awpw();
  ...
  public static ArrayList<awpx> a(ArrayList<awpx> paramArrayList)
  {
    ...
    {
      awpx localawpx = (awpx)paramArrayList.next();
      int i = localawpx.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem.identifyType * 100 + localawpx.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem.businessType;
      HashMap localHashMap;
      if (((HashMap)localObject).containsKey(Integer.valueOf(i)))
      {
        localHashMap = (HashMap)((HashMap)localObject).get(Integer.valueOf(i));
        if (localHashMap.containsKey(localawpx.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem.identify)) {
          QLog.d("MostUsedCahce", 2, "more high level exsit " + localawpx.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem.identify);
        } else {
          localHashMap.put(localawpx.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem.identify, localawpx);
        }
      }
      else
      {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if ((localObject != null) && (((HashMap)localObject).values() != null) && (((HashMap)localObject).values().size() > 0))
        {
          ...
          while (((Iterator)localObject).hasNext()) {
            localArrayList.add((awpx)((Iterator)localObject).next());
          }
        }
      }
    }
  ...
  public ArrayList<awpx> a(QQAppInterface paramQQAppInterface, String paramString)
  {
      ...
      try
      {
        ...
        if (k != 0)
        {
          ...
          if (j < localMostUsedSearch.items.size())
          {
            ...
            {
              awpx localawpx = new awpx(this);
              localawpx.jdField_a_of_type_Boolean = false;
              localawpx.jdField_a_of_type_ComTencentMobileqqSearchMostusedMostUsedSearchItem = new MostUsedSearchItem(localMostUsedSearchItem);
              localawpx.jdField_a_of_type_Int = k;
              paramQQAppInterface.add(localawpx);
            }
            else
            {
  ...
  public void a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 44	awpu:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   4: invokeinterface 75 1 0
    //   9: aload_0
    //   10: getfield 39	awpu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   13: ifnull +10 -> 23
    //   16: aload_0
    //   17: getfield 39	awpu:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   20: invokevirtual 232	java/util/ArrayList:clear	()V
    //   23: aload_0
    //   24: getfield 44	awpu:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   27: invokeinterface 100 1 0
    //   32: getstatic 22	awpu:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   35: astore_1
    //   36: aload_1
    //   37: monitorenter
    //   38: aload_0
    //   39: iconst_0
    //   40: putfield 271	awpu:jdField_a_of_type_Boolean	Z
    //   43: aload_1
    //   44: monitorexit
    //   45: ldc 102
    //   47: iconst_2
    ...
    //   55: astore_1
    //   56: aload_0
    //   57: getfield 44	awpu:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
