  ...
  implements Handler.Callback
{
  ...
  private bbsz jdField_a_of_type_Bbsz;
  private int b;
  private int c;
  
  public bbsy(int paramInt1, int paramInt2)
  {
  ...
  private boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bbsz != null) {
        this.jdField_a_of_type_Bbsz.a(this.jdField_a_of_type_Bbsz, bool2, i * j, this.c);
      }
      this.c += 1;
      return true;
      label179:
  ...
  public void a(bbsz parambbsz)
  {
    this.jdField_a_of_type_Bbsz = parambbsz;
  }
