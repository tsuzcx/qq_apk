...
public class srd
  implements pwf
{
  public srd(FastWebActivity paramFastWebActivity) {}
  ...
  public void onLoadUserInfoSucceed(String paramString, ReadInJoyUserInfo paramReadInJoyUserInfo)
  {
    ...
    for (;;)
    {
      paramString = pay.a(localFastWebActivity, localArticleInfo, i, paramString);
      try
      {
        paramString.put("live_circle_from_page", 1);
        swy.a(this.a.a, "0X800B17D", paramString.toString());
        if ((FastWebActivity.a(this.a) != null) && (FastWebActivity.a(this.a) != null))
        {
          svu.a(this.a.a, FastWebActivity.a(this.a).c, paramReadInJoyUserInfo);
