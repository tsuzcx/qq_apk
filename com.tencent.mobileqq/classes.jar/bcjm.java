  ...
  extends bcgx
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (((Iterator)localObject2).hasNext())
    {
      ...
      if (!"live".equals(localbcgw.a)) {
        break label255;
      }
      paramBundle = (bcif)localbcgw;
    }
    label247:
    label255:
    for (;;)
    {
      ...
      if (paramView != null)
      {
        paramContext = (bcjn)paramView.getTag();
        localObject2 = null;
        ...
        paramView = new bcjn();
        paramView.jdField_a_of_type_Bcif = paramBundle;
        paramView.jdField_a_of_type_ComTencentBizNowNowVideoLayout = paramContext;
      }
      for (;;)
      {
        ((View)localObject1).setTag(paramView);
        paramView = ((View)localObject1).findViewById(2131377869);
        if (paramView != null) {
        ...
        paramContext = (NowVideoLayout)((View)localObject2).findViewById(2131377869);
        paramContext.a();
