  ...
  implements afal
{
  ...
  public afar(BaseChatPie paramBaseChatPie)
  {
  ...
  private awbv a(awbv paramawbv)
  {
    ...
    //   0	214	0	this	afar
    //   0	214	1	paramawbv	awbv
    //   75	47	2	i	int
    //   73	10	3	j	int
    //   54	56	4	localawbv1	awbv
    //   125	47	4	localException	Exception
    //   177	35	4	localObject	Object
    //   50	58	5	localawbv2	awbv
  ...
  public static FileManagerEntity a(bbpe parambbpe)
  {
    ...
    if (arof.a(parambbpe.jdField_b_of_type_JavaLangString))
    {
      ...
      localFileManagerEntity.nFileType = arni.a(parambbpe.g);
    ...
    for (;;)
    {
      ...
      localFileManagerEntity.strTroopFilePath = parambbpe.e;
      ...
      QLog.i("MultiFavoriteHelper", 1, "=_= create new Entity[" + localFileManagerEntity.nSessionId + "] fileName[" + parambbpe.g + "] by troop size(" + localFileManagerEntity.imgHeight + ":" + localFileManagerEntity.imgWidth + ")");
      ...
      for (int i = Integer.parseInt((String)localObject); (i == 1) || (i == 2) || (i == 3); i = -1)
      {
        ...
        for (;;)
        {
          ...
          if (i == 1)
          {
            ...
            label148:
            ((FileManagerEntity)localObject).peerNick = arni.a(paramQQAppInterface, ((FileManagerEntity)localObject).peerUin, null, ((FileManagerEntity)localObject).peerType);
  ...
  public static String a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      if (paramChatMessage.isMultiMsg)
      {
        ...
        if (!nav.a(paramChatMessage))
        {
          ...
          if (TextUtils.isEmpty(str2)) {
            str1 = aukx.a().a(paramChatMessage.senderuin, paramChatMessage.msgseq, paramQQAppInterface);
          }
        }
      }
      if (str1 != null)
      ...
      {
        paramQQAppInterface = aule.a(paramChatMessage.senderuin);
      }
  ...
  private ArrayList<ChatMessage> a(MessageForStructing paramMessageForStructing, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    //   100: aload_0
    //   101: aload 7
    //   103: invokespecial 457	afar:a	(Lawbv;)Lawbv;
    ...
    //   348: goto -279 -> 69
    //   351: aload 7
    //   353: invokevirtual 492	com/tencent/mobileqq/data/ChatMessage:deepCopyByReflect	()Lawbv;
  ...
  private void a(aelz paramaelz, ChatMessage paramChatMessage)
  {
    if ((paramChatMessage == null) || (paramaelz == null)) {}
    for (;;)
    {
      return;
      ...
      biri.a().a = false;
      paramaelz.a.a(paramChatMessage, paramaelz).a(2131366015, this.jdField_a_of_type_AndroidContentContext, paramChatMessage);
      if (biri.a().a) {
        biri.a().a = false;
      }
      while (ajsx.a().c())
  ...
  private void a(List<ChatMessage> paramList)
  {
    ...
    {
      return;
      aeyb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramList, 4);
      aukx.a().b(paramList);
      if (QLog.isColorLevel()) {
    ...
    aukx.a().jdField_a_of_type_Int = 6;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agnz)) {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = aukx.a().a();
    }
  ...
  private void a(List<ChatMessage> paramList, List<String> paramList1)
  {
    ...
    for (;;)
    {
      ...
      while (paramList.hasNext())
      {
        String str = abot.c((ChatMessage)paramList.next());
  ...
  private boolean a(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return false;
        } while (!aule.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage));
        if (!(paramChatMessage instanceof MessageForStructing)) {
          break;
        }
      } while (((MessageForStructing)paramChatMessage).structingMsg.mMsgServiceID != 35);
      return true;
    } while (((paramChatMessage instanceof MessageForArkApp)) || (((paramChatMessage instanceof MessageForPic)) && (agwq.a((MessageForPic)paramChatMessage))));
    return true;
  }
  ...
  public void a(BaseChatPie paramBaseChatPie, aelz paramaelz, MessageForStructing paramMessageForStructing)
  {
    if (QLog.isColorLevel()) {
      QLog.d("MultiFavoriteHelper", 2, "onClickMultiFavoriteBtn");
    }
    int i = aukx.a().c();
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009C5B", "0X8009C5B", 0, i, "", "", "", "");
    if (paramMessageForStructing == null)
    {
      paramMessageForStructing = aukx.a().a();
      if (paramMessageForStructing.size() == 1)
      {
        localArrayList = aule.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ArrayList)paramMessageForStructing);
        if ((localArrayList != null) && (localArrayList.size() > 0))
        {
          paramMessageForStructing = (ChatMessage)localArrayList.get(0);
          a(paramaelz, paramMessageForStructing);
          paramBaseChatPie.a(false, null, false);
        }
      }
    }
    while (!birl.a(paramMessageForStructing))
    {
      for (;;)
      {
      ...
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131698770, 0).b(paramBaseChatPie.a());
      return;
    }
    paramaelz = new ArrayList();
    paramaelz.add(paramMessageForStructing);
    for (;;)
    {
      biri.a().a = true;
      if (!a(paramaelz, aukx.a().a()))
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694199, 0).b(paramBaseChatPie.a());
        return;
      }
      i = a(paramaelz);
      paramMessageForStructing = paramaelz;
      if (i > 0)
      {
        if (paramaelz.size() == i)
        {
          QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694592, 0).b(paramBaseChatPie.a());
          paramBaseChatPie.a(false, null, false);
          return;
        }
        ...
        {
          birl.b(paramMessageForStructing);
          a(this.jdField_a_of_type_AndroidContentContext.getString(2131693509), this.jdField_a_of_type_AndroidContentContext.getString(2131694593), new afas(this, paramaelz, paramBaseChatPie));
          return;
        }
      ...
      return;
      label423:
      paramaelz = paramMessageForStructing;
    }
  }
  ...
  public void a(BaseChatPie paramBaseChatPie, LinearLayout paramLinearLayout, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetImageView == null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setId(2131364218);
        if (AppSetting.c) {
          this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(alpo.a(2131707378));
        }
      }
      ...
      localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839182);
  ...
  public void a(String paramString1, String paramString2, DialogInterface.OnClickListener paramOnClickListener)
  {
    try
    {
      bdcd.a(this.jdField_a_of_type_AndroidAppActivity, 230, null, paramString1, "", paramString2, new afat(this, paramOnClickListener), null).show();
      return;
    }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) {
      localObject1 = bdbt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      if ((paramArrayList != null) && (paramArrayList.size() == 1) && (birl.a((ChatMessage)paramArrayList.get(0))))
      {
        localObject1 = (MessageForStructing)paramArrayList.get(0);
        localObject2 = null;
        label87:
        paramArrayList = biqt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForStructing)localObject1, (List)localObject2, paramMap);
        ...
        paramArrayList = this.jdField_a_of_type_AndroidContentContext.getString(paramArrayList.getIntExtra("nReasonInt", 2131692402));
      ...
      {
        localObject1 = acex.a((Context)localObject2, (String)localObject1, paramArrayList, paramMap, bool);
        if (localObject1 == null) {
          break;
        }
        MessageForStructing localMessageForStructing = aukx.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_b_of_type_JavaLangString, (AbsStructMsg)localObject1);
      ...
      label399:
      biqv.a(this.jdField_a_of_type_AndroidContentContext, paramMap, bool, null, false);
      return;
      label412:
