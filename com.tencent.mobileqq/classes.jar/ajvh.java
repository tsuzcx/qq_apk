...
public class ajvh
  extends aofu
{
  public ajvh(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment) {}
  ...
  protected void onGetTroopFeeMemberList(boolean paramBoolean, List<cmd0x406.GroupFeeMember> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localajvr.a = (localGroupFeeMember.uint64_uin.get() + "");
      localajvr.b = localGroupFeeMember.string_nick_name.get();
      if (this.a.jdField_a_of_type_Ajwh != null) {
        this.a.jdField_a_of_type_Ajwh.a(localajvr);
      }
  ...
  {
    if (!bhbx.a(String.valueOf(paramLong1), this.a.jdField_c_of_type_JavaLangString)) {}
    do
    {
      return;
      if (QLog.isColorLevel())
  ...
  protected void onOIDB0X899_1_Ret(boolean paramBoolean, long paramLong1, int paramInt1, List<oidb_0x899.memberlist> paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo != null) && (this.a.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.isHomeworkTroop()))
    {
      ...
      this.a.g = TroopUtils.getTroopAdministrator(this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo, paramList, false);
      paramList = this.a;
