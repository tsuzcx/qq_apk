  ...
  extends WtloginObserver
{
  ...
  final bdxl jdField_a_of_type_Bdxl;
  final String jdField_a_of_type_JavaLangString;
  
  bdxk(Intent paramIntent, String paramString, bdxl parambdxl)
  {
  ...
  public void OnRegGetSMSVerifyLoginAccountWithLhSig(int paramInt, long paramLong, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfByte1 = BaseApplicationImpl.getContext().getString(2131717515);
        ...
        if (QLog.isDevelopLevel()) {
          bdxm.a("LHLoginMng -- OnRegGetSMSVerifyLoginAccountWithLhSig", localIntent);
        }
        if (this.jdField_a_of_type_Bdxl != null) {
          this.jdField_a_of_type_Bdxl.a(localIntent, bool, this.jdField_a_of_type_JavaLangString, paramArrayOfByte4, paramArrayOfByte1);
        }
