  ...
  extends aypg
{
  ...
  public ayou(ayvx paramayvx, aywc paramaywc)
  {
    super(paramayvx, paramaywc);
    this.jdField_a_of_type_Int = paramaywc.jdField_c_of_type_Int;
    this.jdField_a_of_type_Ayqo.jdField_c_of_type_Int = paramaywc.jdField_c_of_type_Int;
    this.jdField_b_of_type_JavaLangString = paramaywc.jdField_a_of_type_JavaLangString;
    this.jdField_d_of_type_ArrayOfByte = paramaywc.jdField_a_of_type_ArrayOfByte;
  }
  ...
  protected final long a(long paramLong)
  {
    ...
    for (paramLong = Math.min(paramLong, this.jdField_a_of_type_Bgbd.a(BaseApplication.getContext(), this.jdField_q_of_type_Long, this.s, -1));; paramLong = Math.min(paramLong, 14600L)) {
  ...
  protected ayyp a()
  {
    ...
    localayyy.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
    localayyy.jdField_a_of_type_Boolean = this.jdField_a_of_type_Aywc.jdField_k_of_type_Boolean;
    ...
    localayyp.jdField_a_of_type_JavaLangString = "bdh_common_up";
    ...
    localayyp.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
    localayyp.jdField_a_of_type_ArrayOfByte = this.jdField_d_of_type_ArrayOfByte;
    return localayyp;
  }
  ...
  {
    if (paramLong1 != 0L) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.countFlow(true, 1, this.jdField_a_of_type_Aywc.jdField_b_of_type_Int, this.jdField_a_of_type_Aywc.jdField_a_of_type_Int, paramLong1);
    }
    if (paramLong2 != 0L) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.countFlow(true, 1, this.jdField_a_of_type_Aywc.jdField_b_of_type_Int, this.jdField_a_of_type_Aywc.jdField_a_of_type_Int, paramLong2);
    }
    if (paramLong3 != 0L) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.countFlow(true, 0, this.jdField_a_of_type_Aywc.jdField_b_of_type_Int, this.jdField_a_of_type_Aywc.jdField_a_of_type_Int, paramLong3);
    }
    if (paramLong4 != 0L) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.countFlow(true, 0, this.jdField_a_of_type_Aywc.jdField_b_of_type_Int, this.jdField_a_of_type_Aywc.jdField_a_of_type_Int, paramLong4);
    }
  }
  ...
  public final void a(ayyp paramayyp, ayze paramayze)
  {
    if (paramayze != null)
    {
      ...
      {
        paramayyp = (ayzf)paramayze.jdField_a_of_type_JavaUtilList.get(i);
        if (QLog.isColorLevel()) {
          b("procUrl", paramayyp.toString());
        }
        a(this.jdField_a_of_type_Aypd, paramayyp);
        if (QLog.isColorLevel()) {
          QLog.d("BDHCommonUploadProcessor", 2, "onBusiProtoResp()------response.result = " + paramayyp.jdField_c_of_type_Int);
        }
        if (paramayyp.jdField_c_of_type_Int == 0)
        {
          ...
          this.jdField_a_of_type_Ayqo.jdField_l_of_type_JavaLangString = paramayyp.jdField_b_of_type_JavaLangString;
          this.jdField_a_of_type_Ayqo.jdField_m_of_type_JavaLangString = paramayyp.e;
          this.jdField_a_of_type_Ayqo.n = paramayyp.jdField_c_of_type_JavaLangString;
          this.jdField_a_of_type_Ayqo.o = paramayyp.jdField_d_of_type_JavaLangString;
          this.jdField_a_of_type_Ayqo.i = ("http://" + paramayyp.jdField_b_of_type_JavaLangString + paramayyp.e);
          this.jdField_a_of_type_Ayqo.jdField_j_of_type_JavaLangString = ("http://" + paramayyp.jdField_b_of_type_JavaLangString + paramayyp.jdField_c_of_type_JavaLangString);
          this.jdField_a_of_type_Ayqo.k = ("http://" + paramayyp.jdField_b_of_type_JavaLangString + paramayyp.jdField_d_of_type_JavaLangString);
          this.jdField_a_of_type_Ayqo.g = paramayyp.f;
          if (paramayyp.jdField_a_of_type_Boolean)
          {
            this.jdField_a_of_type_Ayqo.a();
            e();
            if (QLog.isColorLevel()) {
              QLog.d("BDHCommonUploadProcessor", 2, "onBusiProtoResp()---- file is Exsit! " + this.jdField_a_of_type_Aywc.i);
            }
            label374:
            this.jdField_a_of_type_Long = paramayyp.jdField_a_of_type_Long;
            this.jdField_a_of_type_Ayqo.d = this.jdField_a_of_type_Long;
            if (QLog.isColorLevel()) {
              QLog.d("BDHCommonUploadProcessor", 2, "mFileID->" + this.jdField_a_of_type_Long + " groupUin->" + this.jdField_a_of_type_Aywc.jdField_c_of_type_JavaLangString);
            }
          }
        }
        for (;;)
        {
          i += 1;
          break;
          if ((this.jdField_a_of_type_Int == 9) && (paramayyp.f != null)) {
            this.jdField_a_of_type_TencentImCsCmd0x388Cmd0x388$ExpRoamExtendInfo.bytes_resid.set(ByteStringMicro.copyFrom(paramayyp.f.getBytes()));
          }
          if ((this.jdField_a_of_type_Int == 20) && (paramayyp.f != null)) {
            this.jdField_a_of_type_ComTencentMobileqqHighwayProtocolBdh_extinfo$UploadPicExtInfo.bytes_file_resid.set(ByteStringMicro.copyFrom(paramayyp.f.getBytes()));
          }
          this.jdField_m_of_type_JavaLangString = paramayyp.jdField_a_of_type_JavaLangString;
          this.s = paramayyp.jdField_b_of_type_Int;
          this.r = paramayyp.jdField_b_of_type_Long;
          aP_();
          break label374;
          d();
        }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      axrn.a(BaseApplication.getContext()).a(null, this.jdField_b_of_type_JavaLangString, true, l, this.jdField_q_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    for (;;)
    {
      l();
      ...
      axrn.a(BaseApplication.getContext()).a(null, this.jdField_b_of_type_JavaLangString, false, l, this.jdField_q_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
  ...
  byte[] a()
  {
    ...
    ((cmd0x346.ExtensionReq)localObject).uint32_ptt_time.set(this.jdField_a_of_type_Aywc.jdField_j_of_type_Int);
    i = ayyb.a();
  ...
  public final void aP_()
  {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("BDHCommonUploadProcessor", 2, "<BDH_LOG> Transaction submit RetCode:" + i + " T_ID:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.getTransationId() + " UniSeq:" + this.jdField_a_of_type_Aywc.jdField_a_of_type_Long + " MD5:" + this.jdField_c_of_type_JavaLangString + " uuid:" + this.jdField_l_of_type_JavaLangString + " Path:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.filePath + " Cmd:" + 3);
      }
      if (i != 0)
      {
      ...
      if (this.jdField_a_of_type_Int == 20) {
        ...
        this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Aywc.i, (int)this.r, this.jdField_a_of_type_ArrayOfByte, localayov, a(), false);
      } else if (this.jdField_a_of_type_Int == 40) {
        this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Aywc.i, (int)this.r, this.jdField_a_of_type_ArrayOfByte, localayov, this.jdField_a_of_type_Aywc.jdField_a_of_type_ArrayOfByte, true);
  ...
  public final void aR_()
  {
    ...
    if (36 == this.jdField_a_of_type_Int)
    {
      ...
      this.jdField_a_of_type_Ayqo.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Aywc.i;
      aP_();
    }
    for (;;)
    {
  ...
  public final int c()
  {
    ...
    if ((this.jdField_a_of_type_Int != 54) && (l >= ayxe.a()))
    {
  ...
  final void d()
  {
    ...
    if (this.jdField_a_of_type_Aywc.jdField_a_of_type_Auoq != null)
    {
      ...
      if ((this.jdField_a_of_type_Int == 20) && (aypb.a(120509L).equals(this.jdField_a_of_type_JavaUtilHashMap.get("param_reason")))) {
        localauor.jdField_b_of_type_Int = 120509;
      }
      if (this.jdField_a_of_type_Int == 9)
      {
        str = (String)this.jdField_a_of_type_JavaUtilHashMap.get("param_reason");
        if (!aypb.a(400010L).equals(str)) {
          break label208;
        }
        localauor.jdField_b_of_type_Int = 400010;
      }
    }
    for (;;)
    {
      ...
      return;
      label208:
      if (aypb.a(400011L).equals(str)) {
        localauor.jdField_b_of_type_Int = 400011;
      }
    }
  }
  ...
  final void e()
  {
    ...
    if (this.jdField_a_of_type_Aywc.jdField_a_of_type_Auoq != null)
    {
      ...
      if (this.jdField_a_of_type_Int == 20) {
        localauor.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Ayqo.g;
      }
      this.jdField_a_of_type_Aywc.jdField_a_of_type_Auoq.b(localauor);
    }
