...
class qpu
  implements syq
{
  qpu(qph paramqph, View paramView, qpy paramqpy, VideoView paramVideoView) {}
  ...
  public boolean a()
  {
    ...
    if (localView2 != null)
    {
      ...
      if (localView3 != null)
      {
        ...
        if ((!this.jdField_a_of_type_Qpy.a()) || (i + j - k < -localView1.getHeight() * 0.3D) || (m - n - i1 < -localView1.getHeight() * 0.3D)) {
          break label159;
        }
      }
    }
