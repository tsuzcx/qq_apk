...
public class qom
{
  ...
  public static boolean a(String paramString)
  {
    ...
    try
    {
      ...
      bool1 = tez.a(((JSONObject)localObject).optString("min_version", null), ((JSONObject)localObject).optString("max_version", null), ((JSONObject)localObject).optString("min_android_build", null), ((JSONObject)localObject).optString("max_android_build", null));
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    try
    {
      boolean bool2 = nme.a(paramString1, paramString2);
      bool1 = bool2;
    }
    catch (Throwable localThrowable)
    {
