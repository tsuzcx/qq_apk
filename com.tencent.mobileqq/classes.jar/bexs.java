...
{
  public bexs(AuthorityActivity paramAuthorityActivity, boolean paramBoolean) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (!this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Bfmm.jdField_a_of_type_JavaLangString.equals(str)) {
      return;
    }
      ...
      if (paramBoolean)
      {
        ...
        for (;;)
        {
          try
          {
            ...
            if (!this.jdField_a_of_type_Boolean) {
              localObject1 = bfnl.b((byte[])localObject2, this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Bfmm);
            }
          ...
          catch (Exception paramBundle)
          {
            ...
            ((Message)localObject1).obj = this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.getResources().getString(2131695054);
            ...
            QLog.d("AuthorityActivity", 1, "rec | cmd: " + str + " | uin : *" + bfdz.a(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Bfmm.jdField_a_of_type_JavaLangString) + " | ret : success | code : " + paramInt, paramBundle);
          ...
          try
          {
            ...
            bfdq.a().a((Bundle)localObject1, AuthorityActivity.e, this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_JavaLangString, false);
            ...
            bfdq.a().a(paramBundle, AuthorityActivity.e, this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_JavaLangString, false);
            bfix.a().a("agent_query_authority", this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.f, l1, l2, 0, Long.parseLong(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Bfmm.jdField_a_of_type_JavaLangString), "1000069", "ret: " + i);
            bfja.a().a(0, "LOGIN_GETAUTHLIST_AGENT", this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Bfmm.jdField_a_of_type_JavaLangString, AuthorityActivity.e, null, Long.valueOf(SystemClock.elapsedRealtime()), i, 1, null);
            bfdq.a().a(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Bfmm.jdField_a_of_type_JavaLangString, "", AuthorityActivity.e, "1", "2", "0", false);
          ...
          {
            bfhg.c("AuthorityActivity", "-->report exception cmd: agent_query_authority", paramBundle);
          }
        }
        QLog.d("AuthorityActivity", 1, "rec | cmd: " + str + " | uin : *" + bfdz.a(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Bfmm.jdField_a_of_type_JavaLangString) + " | ret : success | code : " + paramInt);
      }
      for (;;)
      {
        this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.g = SystemClock.elapsedRealtime();
        bfhg.c("Authority_TimeCost", "<TimeStamp> query authority cost : " + (this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.g - this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.f));
        return;
        paramBundle = "1";
        break;
        QLog.d("AuthorityActivity", 1, "rec | cmd: " + str + " | uin : *" + bfdz.a(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Bfmm.jdField_a_of_type_JavaLangString) + " | ret : failed | code : " + paramInt);
        ...
        paramBundle.obj = this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.getResources().getString(2131695054);
        ...
        AuthorityActivity.a(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity, "KEY_GET_AUTH_API_LIST_REQUEST", this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.c, false);
        paramBundle = this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.getResources().getString(2131695054);
        try
        {
          bfix.a().a("agent_query_authority", this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.f, 0L, 0L, paramInt, Long.parseLong(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Bfmm.jdField_a_of_type_JavaLangString), "1000069", paramBundle);
          bfja.a().a(1, "LOGIN_GETAUTHLIST_AGENT", this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Bfmm.jdField_a_of_type_JavaLangString, AuthorityActivity.e, null, Long.valueOf(SystemClock.elapsedRealtime()), paramInt, 1, paramBundle);
          bfdq.a().a(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Bfmm.jdField_a_of_type_JavaLangString, "", AuthorityActivity.e, "1", "2", "" + paramInt, false);
          bfdq.a().a(this.jdField_a_of_type_ComTencentOpenAgentAuthorityActivity.jdField_a_of_type_Bfmm.jdField_a_of_type_JavaLangString, "", AuthorityActivity.e, "1", "6", "" + paramInt, false);
        }
        catch (Exception paramBundle) {}
      }
    }
