...
public class audr
{
  private static int jdField_a_of_type_Int = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131299080) - (int)bhdz.a(BaseApplicationImpl.getContext(), 5.0F);
