  ...
  implements blib
{
  ...
  private bntx jdField_a_of_type_Bntx;
  ...
  public bntw(QQAppInterface paramQQAppInterface, View paramView)
  {
    super(paramView);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    if (this.jdField_b_of_type_AndroidGraphicsDrawableDrawable == null) {
      this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838344);
    }
  }
  ...
  private void f()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem != null)) {
      bntp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 122, String.valueOf(this.jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem.iAdId.get()), this.jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem.traceinfo.get());
    }
  }
  
  private void g()
  {
    bntp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, 4004);
    if ((this.jdField_a_of_type_AndroidViewView != null) && ((this.jdField_a_of_type_AndroidViewView instanceof ARMapHongBaoListView)))
    {
      ((ARMapHongBaoListView)this.jdField_a_of_type_AndroidViewView).setPendantHolder(null);
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem != null)) {
      bntp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 102, String.valueOf(this.jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem.iAdId.get()), this.jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem.traceinfo.get());
    }
  }
  ...
  {
    float f = -agej.a(20.0F, this.jdField_a_of_type_AndroidViewView.getResources());
  ...
  public void a()
  {
    try
    {
      ...
      j = agej.a(160.0F, this.jdField_a_of_type_AndroidViewView.getResources());
      a(i - j - 0, 0, j, agej.a(c, this.jdField_a_of_type_AndroidViewView.getResources()), this.jdField_a_of_type_AndroidViewView);
      this.jdField_a_of_type_AndroidGraphicsRect = new Rect(this.f + j - agej.a(23.0F, this.jdField_a_of_type_AndroidViewView.getResources()), this.g + agej.a(22.0F, this.jdField_a_of_type_AndroidViewView.getResources()), this.f + j - agej.a(8.0F, this.jdField_a_of_type_AndroidViewView.getResources()), this.g + agej.a(37.0F, this.jdField_a_of_type_AndroidViewView.getResources()));
      this.jdField_b_of_type_AndroidGraphicsRect = new Rect(this.f + j - agej.a(23.0F, this.jdField_a_of_type_AndroidViewView.getResources()), this.g, j + this.f, this.g + agej.a(37.0F, this.jdField_a_of_type_AndroidViewView.getResources()));
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  public void a(TianShuAccess.AdItem paramAdItem)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = beyq.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
      ...
      this.jdField_a_of_type_Bntx = new bntx(this, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidViewView, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    ...
    bntp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 101, String.valueOf(this.jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem.iAdId.get()), this.jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem.traceinfo.get());
    return;
