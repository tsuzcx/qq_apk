...
public class avxe
  extends QIPCModule
{
  private static volatile avxe jdField_a_of_type_Avxe;
  ...
  private bevo jdField_a_of_type_Bevo;
  ...
  private avxe(String paramString)
  {
    super(paramString);
  }
  
  public static avxe a()
  {
    if (jdField_a_of_type_Avxe == null) {}
    try
    {
      if (jdField_a_of_type_Avxe == null) {
        jdField_a_of_type_Avxe = new avxe("IdentificationIpcServer_Model");
      }
      return jdField_a_of_type_Avxe;
    }
    finally {}
  }
  ...
  {
    return new avxh(this, paramFile, paramEIPCResult, paramQQAppInterface, paramInt2, paramInt3, paramInt1);
  }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    bdll.b((QQAppInterface)localObject2, "dc00898", "", "", "0X80097EB", "0X80097EB", 0, 0, i + "", "" + k, j + "", "");
  ...
  private void a(Bundle paramBundle, int paramInt)
  {
    ...
    awgo.a(paramBundle, str3, str4, i, AppSetting.a(), str2, str1, l, new avxg(this, localFaceDetectForThirdPartyManager, paramInt, paramBundle));
  }
  
  private void a(QQAppInterface paramQQAppInterface)
  {
    borg localborg = borg.a();
    avxj localavxj = new avxj(this);
    if (paramQQAppInterface.isLogin())
    {
      localborg.a(borf.b, localavxj, false);
      return;
    }
    localborg.a(borf.b, localavxj);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    avws.a().a(paramQQAppInterface, BaseApplicationImpl.getContext(), i, str, paramBundle, new avxf(this, paramInt));
  }
  ...
  private void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    paramString2 = new avxi(this, paramString2, paramString3, paramString1, paramInt);
    if (this.jdField_a_of_type_Bevo == null)
    {
      paramQQAppInterface = new bhuw(paramQQAppInterface, 4);
      paramQQAppInterface.a();
      this.jdField_a_of_type_Bevo = new bevo(paramQQAppInterface, false);
    }
    paramQQAppInterface = new beum();
    paramQQAppInterface.jdField_a_of_type_Beuq = paramString2;
    ...
    paramQQAppInterface.d = 0;
    this.jdField_a_of_type_Bevo.a(paramQQAppInterface);
  }
      ...
      if (((List)localObject2).size() > 0)
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if (((ShortVideoResourceManager.SVConfigItem)localObject1).name.startsWith("new_qq_android_native_short_new_other_"))
          {
            ...
            QLog.d("qqidentification_server", 1, new Object[] { "no res,start download, localpath is", localObject2, " version is : ", Integer.valueOf(i), " app so bits is : ", Integer.valueOf(avxc.b()) });
