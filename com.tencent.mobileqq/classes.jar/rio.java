  ...
  implements tbx
{
  ...
  public rio(ComponentHeaderTopicRecommend paramComponentHeaderTopicRecommend, String paramString, int paramInt)
  {
  ...
  {
    paramView = pjj.k + bhcu.encodeToString(this.jdField_a_of_type_JavaLangString.getBytes(), 0);
