  ...
  extends ProxyWebViewClientExtension
{
  ...
  public bhlq(bhll parambhll, TouchWebView paramTouchWebView)
  {
  ...
  private void a(Object paramObject1, Object paramObject2, Object paramObject3, Object paramObject4)
  {
    ...
    if (localWebViewPluginEngine != null)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.i("WebCoreDump", 2, "Take web core dump for " + nmj.b(this.jdField_a_of_type_ComTencentBizUiTouchWebView.getUrl(), new String[0]));
      }
    }
  ...
  {
    this.jdField_a_of_type_Bhll.onMiscCallBack(paramString, paramBundle);
    return null;
  }
