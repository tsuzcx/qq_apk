...
public class xzd
  extends alrl
{
  public xzd(QRDisplayActivity paramQRDisplayActivity) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong1, String paramString1, String paramString2, long paramLong2)
  {
    ...
    Object localObject = this.a.jdField_a_of_type_Alri.a(this.a.jdField_c_of_type_JavaLangString, true);
    ...
    localObject = ybk.a(paramString2, -1);
    if (localObject != null)
    {
      ((TextView)this.a.findViewById(2131372997)).setText(paramString2);
      ...
      this.a.jdField_a_of_type_Gs = ((gs)localObject);
      this.a.f();
      return;
    }
    this.a.g();
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    if (paramBoolean1)
    {
      paramString = ((alri)this.a.app.a(6)).a(paramString, true);
      ...
      if (this.a.jdField_a_of_type_Gs == null) {
        this.a.jdField_a_of_type_Gs = this.a.a(this.a.jdField_c_of_type_JavaLangString, this.a.jdField_c_of_type_Int, -1);
      }
      if (this.a.jdField_a_of_type_Gs != null) {
        this.a.f();
      }
