  ...
  extends aesj
{
  ...
  public azec(QQAppInterface paramQQAppInterface, Context paramContext, XListView paramXListView, aesm paramaesm, String paramString, boolean paramBoolean, TextView paramTextView, View paramView)
  {
  ...
  protected aese a()
  {
    return new azeb(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true);
  }
  ...
  {
    ((ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(this.jdField_a_of_type_Long, this.jdField_a_of_type_Int, 25);
  }
