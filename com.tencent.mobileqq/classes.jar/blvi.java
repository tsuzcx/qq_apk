...
{
  blvk jdField_a_of_type_Blvk = new blvk();
  private volatile boolean jdField_a_of_type_Boolean = true;
  
  public blvi()
  {
    this.jdField_a_of_type_Blvk.a();
  }
  ...
  {
    return bgln.b(BaseApplication.getContext());
  }
  ...
  {
    boolean bool = this.jdField_a_of_type_Blvk.a(paramString);
  ...
  public void registerNetworkStateObserver(UploadConfiguration.NetworkStateObserver paramNetworkStateObserver)
  {
    ...
    cooperation.qzone.util.NetworkState.addListener(new blvj(this, paramNetworkStateObserver));
  }
}
