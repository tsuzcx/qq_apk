...
public class blpc
{
  ...
  public blpc(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.b = paramInt1;
    this.c = paramInt2;
    this.d = paramInt3;
  ...
  public void a(Canvas paramCanvas, Paint paramPaint, blox paramblox)
  {
    ...
    paramPaint.setColor(paramblox.b);
    paramPaint.setStrokeWidth(paramblox.e);
    paramCanvas.drawLine(this.b, this.d, this.c, this.d, paramPaint);
    paramblox = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (paramblox.hasNext())
    {
      Point localPoint = (Point)paramblox.next();
