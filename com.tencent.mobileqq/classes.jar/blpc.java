  ...
  extends blng
{
  ...
  public blpc(int paramInt)
  {
    super(null);
    this.jdField_a_of_type_Blpg = new blpd(this);
    this.d = paramInt;
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo = ((QIMMusicConfigManager)blmf.a(2)).b(paramInt);
  }
  ...
  public int a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        bool = bdcs.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath());
        if (bool) {
          continue;
        }
      }
  ...
  public int a(Activity paramActivity, int paramInt)
  {
    ...
    MusicProviderView localMusicProviderView2 = (MusicProviderView)paramActivity.findViewById(2131363949);
    MusicProviderView localMusicProviderView1 = localMusicProviderView2;
    if (localMusicProviderView2 == null)
    {
      ((QIMProviderContainerView)paramActivity.findViewById(2131372365)).a(104);
      localMusicProviderView1 = (MusicProviderView)paramActivity.findViewById(2131363949);
      localMusicProviderView1.g();
    }
    paramActivity = ((blpo)blmf.a().c(8)).a();
  ...
  public int b()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          if (!bdcs.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath()))
          {
            if (QLog.isColorLevel()) {
            ...
            QimMusicDownloader.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.mUrl, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath(), this.jdField_a_of_type_Blpg);
            a();
            i = 2;
            continue;
          }
