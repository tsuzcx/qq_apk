  ...
  implements TencentLocationListener
{
  ...
  atpz(atpw paramatpw, boolean paramBoolean, Runnable paramRunnable, MqqHandler paramMqqHandler, LocationRoom paramLocationRoom)
  {
  ...
  public void onLocationChanged(TencentLocation paramTencentLocation, int paramInt, String paramString)
  {
    if (paramInt == 0)
    {
      ...
      atpw.a(this.jdField_a_of_type_Atpw, paramTencentLocation);
    }
    ...
    if (paramInt != 0)
    {
      ...
      atso.a(this.jdField_a_of_type_Atpw.app, paramTencentLocation.a(), paramTencentLocation.a(), 1);
    }
    for (;;)
    {
      if ((paramInt == 0) || (HwNetworkUtil.isNetworkAvailable(BaseApplicationImpl.getContext()))) {
        azsk.a().a("requestSoso", new Object[] { Integer.valueOf(-1), Boolean.valueOf(false), "LocationHandler", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0) });
      }
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      {
        this.c = false;
        this.jdField_a_of_type_Atpw.a(atpw.a(this.jdField_a_of_type_Atpw).a(), atpw.a(this.jdField_a_of_type_Atpw).a());
      }
      atpw.a(this.jdField_a_of_type_Atpw, true);
    }
  }
