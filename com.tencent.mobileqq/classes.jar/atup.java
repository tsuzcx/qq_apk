...
{
  public atup(CustomCoverFragment paramCustomCoverFragment) {}
  
  public void onClick(View paramView)
  {
    int i = 1;
    if (paramView.getId() == 2131302901) {
      if (CustomCoverFragment.a(this.a) != null)
      {
        ...
        paramView = (ajrm)CustomCoverFragment.a(this.a).a(13);
        if (!CustomCoverFragment.b(this.a)) {
          break label158;
        }
        i = 1;
        paramView.h(i);
        CustomCoverFragment.a(this.a).a(0, this.a.getString(2131633291), 0, CustomCoverFragment.a(this.a));
    ...
    for (int j = ((Integer)localObject).intValue();; j = 0)
    {
      if ((paramView instanceof Button))
      {
        if (CustomCoverFragment.c(this.a))
        {
          bbmy.a(this.a.getActivity(), 0, 2131625055, 0).a();
          return;
        }
      ...
      for (i = 2;; i = 0)
      {
        ...
        abju.a(this.a.getActivity(), paramView, PublicFragmentActivity.class, CoverDetailFragment.class, 2001);
        return;
      }
    }
  }
