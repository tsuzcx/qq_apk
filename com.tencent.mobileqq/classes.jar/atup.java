...
public class atup
{
  ...
  private atvf jdField_a_of_type_Atvf;
  public QQAppInterface a;
  
  public atup(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(String paramString1, int paramInt1, String paramString2, long paramLong, int paramInt2, String paramString3, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramString1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(l, antf.v, 0);
  ...
  public long a(String paramString, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    EntityManager localEntityManager = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createEntityManager();
    if (QLog.isColorLevel()) {
      QLog.d("FileManagerDataCenter<FileAssistant>", 2, "strUin[" + aunj.e(paramString) + "], peeryType[" + String.valueOf(paramInt) + "], uniseq[" + String.valueOf(paramLong2) + "]");
    }
  ...
  public long a(String paramString1, String paramString2, boolean paramBoolean1, String paramString3, long paramLong1, boolean paramBoolean2, int paramInt1, String paramString4, long paramLong2, long paramLong3, String paramString5, int paramInt2, long paramLong4, long paramLong5, long paramLong6, long paramLong7, int paramInt3)
  {
    ...
    {
      paramString5 = beyo.a(paramString3, paramLong1, 0, paramBoolean2);
    }
    ...
    if (paramBoolean1)
    {
      ...
      localMessageRecord.shmsgseq = bcsa.a(paramLong2, paramInt1);
      paramLong1 = paramLong5;
      if (paramLong5 == 0L) {
        paramLong1 = bcsa.a(bcsa.a());
      }
      localMessageRecord.msgUid = paramLong1;
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(((MessageForFile)localMessageRecord).fileName)) {
        ((MessageForFile)localMessageRecord).fileName = aunj.a(paramString3);
      }
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localMessageRecord, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
  ...
  public atvf a()
  {
    ...
    for (;;)
    {
      atvf localatvf = this.jdField_a_of_type_Atvf;
      this.jdField_a_of_type_Atvf = null;
      return localatvf;
      QLog.d("FileManagerDataCenter<FileAssistant>", 1, "getTmpController " + this.jdField_a_of_type_Atvf.getClass().getName());
    }
  }
  ...
  public FileManagerEntity a(long paramLong)
  {
    ...
    atzd localatzd = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    if (localatzd == null)
    {
      QLog.e("FileManagerDataCenter<FileAssistant>", 1, "QueryFileEntityBySessionId get FileManagerProxy null! nSessionId[" + paramLong + "]");
      return null;
    }
    FileManagerEntity localFileManagerEntity = localatzd.a(paramLong);
    if (localFileManagerEntity != null)
    {
      localatzd.a(localFileManagerEntity);
  ...
  public FileManagerEntity a(long paramLong1, long paramLong2, String paramString, int paramInt)
  {
    ...
    if (localFileManagerEntity != null)
    {
      QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityBySessionid for queryall, FileManagerEntity exist, sessionId[" + String.valueOf(localFileManagerEntity.nSessionId) + "], uniseq[" + String.valueOf(localFileManagerEntity.uniseq) + "], strUin[" + aunj.e(localFileManagerEntity.peerUin) + "], peerType[" + String.valueOf(localFileManagerEntity.peerType) + "]");
      return localFileManagerEntity;
    }
    ...
    QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityBySessionid, new a FileManagerEntity, sessionId[" + String.valueOf(localFileManagerEntity.nSessionId) + "], uniseq[" + String.valueOf(paramLong2) + "], strUin[" + aunj.e(paramString) + "], peerType[" + String.valueOf(paramInt) + "]");
    return localFileManagerEntity;
  }
  ...
  public FileManagerEntity a(long paramLong, String paramString, int paramInt)
  {
    ...
    if (paramLong <= 0L)
    {
      QLog.e("FileManagerDataCenter<FileAssistant>", 1, "QueryFileEntityByUniseq uniseq[" + paramLong + "] is error, strUin[" + aunj.e(paramString) + "], peerType[" + paramInt + "]");
      return null;
    }
    atzd localatzd = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    if (localatzd == null)
    {
      QLog.e("FileManagerDataCenter<FileAssistant>", 1, "QueryFileEntityByUniseq get FileManagerProxy null! strUin[" + aunj.e(paramString) + "], uniseq[" + paramLong + "], peerType[" + paramInt + "]");
      return null;
    }
    FileManagerEntity localFileManagerEntity = localatzd.a(paramLong, paramString, paramInt);
    if (localFileManagerEntity != null)
    {
      aunb.a(localFileManagerEntity);
      return localFileManagerEntity;
    }
    return localatzd.b(paramLong, paramString, paramInt);
  }
  ...
  public FileManagerEntity a(String paramString, long paramLong)
  {
    ...
    FileManagerEntity localFileManagerEntity1 = ((atzd)localObject).a(paramString, paramLong);
    if (localFileManagerEntity1 != null) {
  ...
  public void a(atvf paramatvf)
  {
    QLog.d("FileManagerDataCenter<FileAssistant>", 1, "regTmpController" + paramatvf.getClass().getName());
  ...
  public void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 15	atup:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: invokevirtual 251	com/tencent/mobileqq/app/QQAppInterface:a	()Latzd;
    //   9: astore_2
    //   10: aload_2
    //   11: ifnonnull +69 -> 80
    //   14: ldc 71
    ...
    //   60: invokestatic 286	aunj:e	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   102: aload_1
    //   103: invokestatic 655	aunj:a	(Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;)Ljava/lang/String;
    ...
    //   115: aload_2
    //   116: aload_1
    //   117: invokevirtual 657	atzd:b	(Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;)V
    //   120: aload_0
    //   121: getfield 15	atup:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   124: invokevirtual 619	com/tencent/mobileqq/app/QQAppInterface:a	()Latur;
    //   127: iconst_1
    //   128: iconst_3
    //   129: aconst_null
    //   130: invokevirtual 624	atur:a	(ZILjava/lang/Object;)V
    //   133: goto -56 -> 77
    //   136: astore_1
    //   137: aload_0
    //   138: monitorexit
  ...
  public void a(boolean paramBoolean1, int paramInt, String paramString1, String paramString2, boolean paramBoolean2, String paramString3, long paramLong)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(localFileManagerEntity);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
    aunj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFileManagerEntity.nSessionId, "actFileOf2Of", 0L, "", "", localFileManagerEntity.peerUin, localFileManagerEntity.Uuid, paramInt, paramString1, 0L, 0L, 0L, "", "", 0, paramString1, null);
  }
  ...
  public boolean a(long paramLong, int paramInt)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("FileManagerDataCenter<FileAssistant>", 2, "strUin[" + aunj.e(((FileManagerEntity)localObject2).peerUin) + "], peeryType[" + String.valueOf(((FileManagerEntity)localObject2).peerType) + "], uniseq[" + String.valueOf(((FileManagerEntity)localObject2).uniseq) + "]");
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("FileManagerDataCenter<FileAssistant>", 2, "SetRead: strUin[" + aunj.e(paramString) + "], peeryType[" + paramInt + "], uniseq[" + paramLong + "]");
    }
  ...
  public FileManagerEntity b(long paramLong, String paramString, int paramInt)
  {
    ...
    if (paramLong > 0L)
    {
      FileManagerEntity localFileManagerEntity = ((atzd)localObject).a(paramLong, paramString, paramInt);
      if (localFileManagerEntity != null)
      {
        QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityByUniseq for memory, FileManagerEntity exist, sessionId[" + String.valueOf(localFileManagerEntity.nSessionId) + "], uniseq[" + String.valueOf(localFileManagerEntity.uniseq) + "], strUin[" + aunj.e(localFileManagerEntity.peerUin) + "], peerType[" + String.valueOf(localFileManagerEntity.peerType) + "]");
        return localFileManagerEntity;
      }
      localObject = ((atzd)localObject).b(paramLong, paramString, paramInt);
      if (localObject != null)
      {
        QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityByUniseq for db, FileManagerEntity exist, sessionId[" + String.valueOf(((FileManagerEntity)localObject).nSessionId) + "], uniseq[" + String.valueOf(((FileManagerEntity)localObject).uniseq) + "], strUin[" + aunj.e(((FileManagerEntity)localObject).peerUin) + "], peerType[" + String.valueOf(((FileManagerEntity)localObject).peerType) + "]");
        return localObject;
      }
    }
    ...
    QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityByUniseq, new a FileManagerEntity, sessionId[" + String.valueOf(((FileManagerEntity)localObject).nSessionId) + "], uniseq[" + String.valueOf(paramLong) + "], strUin[" + aunj.e(paramString) + "], peerType[" + String.valueOf(paramInt) + "]");
    return localObject;
  }
  ...
  public void b(FileManagerEntity paramFileManagerEntity)
  {
    for (;;)
    {
      ...
      try
      {
        localatzd = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        if (localatzd == null)
        {
          QLog.e("FileManagerDataCenter<FileAssistant>", 1, "insertToFMListAddOrReplaceDB get FileManagerProxy null! nSessionId[" + paramFileManagerEntity.nSessionId + "], uniseq[" + paramFileManagerEntity.uniseq + "], peerUin[" + aunj.e(paramFileManagerEntity.peerUin) + "]");
          return;
        }
        ...
        {
          localatzd.b(paramFileManagerEntity);
          continue;
        }
        localatzd.c(paramFileManagerEntity);
      }
      finally {}
      localatzd.e(paramFileManagerEntity);
    }
  }
