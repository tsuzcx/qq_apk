  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    if ((localObject instanceof MessageForFoldMsgGrayTips))
    {
      ...
      paramView = (adqb)actj.a(paramView);
      ...
      if ((localObject instanceof ViewGroup.MarginLayoutParams))
      {
        ...
        if (((ViewGroup.MarginLayoutParams)localObject).rightMargin != actj.a(10.0F, this.a.jdField_a_of_type_AndroidContentContext.getResources())) {
          ((ViewGroup.MarginLayoutParams)localObject).rightMargin = actj.a(10.0F, this.a.jdField_a_of_type_AndroidContentContext.getResources());
        }
      }
      paramView.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      paramView.a.requestLayout();
      axqy.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80064BD", "0X80064BD", 0, 0, "", "", "", "");
    }
  }
}
