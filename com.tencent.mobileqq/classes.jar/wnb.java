  ...
  implements DialogInterface.OnDismissListener, View.OnClickListener
{
  ...
  private wmm jdField_a_of_type_Wmm;
  ...
  public wnb(Activity paramActivity)
  {
  ...
  private void c()
  {
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364788));
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131363531));
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText = ((CommentEditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131377110));
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.setOnInputBackListener(new wnc(this));
    this.jdField_b_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131363570));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363610));
    ...
    this.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidContentSharedPreferences.getInt("GroupSoftKeyboardHeight", actj.a(250.0F, getContext().getResources()));
    QLog.d("CommentInputPopupWindow", 1, "mEmojiPanel initView() step1 :" + this.jdField_a_of_type_Int);
    if (this.jdField_a_of_type_Int == 0)
    {
      this.jdField_a_of_type_Int = axlk.a(250.0F);
      QLog.d("CommentInputPopupWindow", 1, "mEmojiPanel initView() step2 :" + this.jdField_a_of_type_Int);
    }
    this.jdField_a_of_type_ComTencentBizSubscribeCommentEmoView = ((EmoView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365563));
    ...
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131363297);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new wnd(this));
  ...
  private void f()
  {
    this.jdField_a_of_type_Wot = new wot(this.jdField_a_of_type_AndroidViewView);
    this.jdField_a_of_type_Wot.a(new wne(this));
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.setOnEditorActionListener(new wnf(this));
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.addTextChangedListener(new wng(this));
  }
  ...
  public void a(wmm paramwmm)
  {
    this.jdField_a_of_type_Wmm = paramwmm;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131363610: 
      do
      {
        ...
        return;
      } while (this.jdField_a_of_type_Wmm == null);
  ...
  public void onDismiss(DialogInterface paramDialogInterface)
  {
    ...
    this.jdField_a_of_type_Wot = null;
    this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetImageButton.setVisibility(0);
    this.jdField_b_of_type_Boolean = false;
    if (this.jdField_a_of_type_Wnh != null) {
      this.jdField_a_of_type_Wnh.a();
    }
  }
}
