...
public class avco
{
  ...
  public static avco a()
  {
    if ((jdField_a_of_type_Avco == null) || (jdField_a_of_type_Avco.jdField_a_of_type_Boolean)) {
      jdField_a_of_type_Avco = b();
    }
    return jdField_a_of_type_Avco;
  }
  
  public static boolean a()
  {
    avco localavco = a();
    return (localavco != null) && (localavco.b == 1);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          localObject = new avco();
          ((avco)localObject).jdField_a_of_type_Int = k;
          ((avco)localObject).b = i;
          ((avco)localObject).c = n;
          if ((str == null) || (str.isEmpty())) {
            bool = true;
          }
          ((avco)localObject).jdField_a_of_type_Boolean = bool;
          return localObject;
        }
