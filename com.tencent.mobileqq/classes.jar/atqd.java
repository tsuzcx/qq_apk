  ...
  extends atpj
{
  ...
  public int a()
  {
    ...
    if (this.jdField_g_of_type_JavaLangString != null)
    {
      ...
      atpg.b("PIC_TAG_ERROR", "PicUploadInfo.getProtocolType", "localPath == null");
    }
  ...
  public boolean a()
  {
    ...
    if (this.i)
    {
      if ((this.a == null) || (TextUtils.isEmpty(this.a.rawMd5)) || (!bace.b(this.a.thumbPath)))
      {
        StringBuilder localStringBuilder = new StringBuilder().append("qzone md5 invalid, md5:");
        if (this.a != null) {}
        for (localObject = this.a.rawMd5;; localObject = "")
        {
    ...
    if (!bace.b(this.jdField_g_of_type_JavaLangString))
    {
    ...
    Object localObject = agja.a(this.jdField_g_of_type_JavaLangString);
    if (localObject != null)
    {
      if (this.jdField_g_of_type_Int == 1)
      {
        localObject = ((agja)localObject).a();
        if (localObject != null) {
  ...
  String b()
  {
    ...
    {
      atpg.b("PIC_TAG_ERROR", "PicUploadInfo.getUrlString", "protocol == null");
      return null;
    }
    if ("chatthumb".equals(this.jdField_e_of_type_JavaLangString)) {}
    for (;;)
    {
      URL localURL = axwd.a(this, i1, null);
      if (localURL == null) {
        break;
      }
