  ...
  extends atqb
{
  ...
  public atqd(QQAppInterface paramQQAppInterface, Context paramContext, WeiYunFileInfo paramWeiYunFileInfo)
  {
  ...
  public Intent a()
  {
    ...
    do
    {
      do
      {
        ...
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerauxDataWeiYunFileInfo.a);
        localObject1 = localObject2;
        if (localObject2 != null) {
          break;
        }
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerauxDataWeiYunFileInfo.a);
        localObject1 = localObject2;
        if (localObject2 != null) {
          break;
        }
        localObject1 = atvo.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerauxDataWeiYunFileInfo);
        break;
