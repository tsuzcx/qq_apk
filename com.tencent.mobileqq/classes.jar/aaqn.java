...
public class aaqn
  extends aaqp
{
  public aaqn(GdtVideoCeilingView paramGdtVideoCeilingView, Context paramContext, Activity paramActivity, Intent paramIntent, AppInterface paramAppInterface)
  {
  ...
  public void onPageFinished(WebView paramWebView, String paramString)
  {
    ...
    aanp.b("GdtVideoCeilingView", "onPageFinished:" + paramString);
  }
  
  public void onPageStarted(WebView paramWebView, String paramString, Bitmap paramBitmap)
  {
    super.onPageStarted(paramWebView, paramString, paramBitmap);
    aanp.b("GdtVideoCeilingView", "onPageStarted:" + paramString);
  }
  
  public void onReceivedTitle(WebView paramWebView, String paramString)
  {
    super.onReceivedTitle(paramWebView, paramString);
    aanp.b("GdtVideoCeilingView", "onReceivedTitle: " + paramString);
    GdtVideoCeilingView.a(this.a).setWebBarTitle(paramString);
  }
  
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    aanp.b("GdtVideoCeilingView", "shouldOverrideUrlLoading:" + paramString);
    ...
    for (;;)
    {
      ...
      for (paramString = ((Uri)localObject).getScheme(); myl.a().a(paramWebView.getUrl(), paramString).booleanValue(); paramString = null)
      {
        ...
        {
          aanp.d("GdtVideoCeilingView", paramWebView.toString());
          return true;
        }
      }
    }
