...
public class bkhg
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bkhh(this);
  protected Handler a;
  ...
  public bkhg(QQBrowserActivity paramQQBrowserActivity)
  {
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.b() != null)
        {
          ...
          if (paramView != null)
          {
            Object localObject = paramView.getTag(2131375091);
            if ((localObject == null) || (!((Boolean)localObject).booleanValue())) {
              break label119;
            }
            i = 1;
            paramView.setTag(2131375088, Boolean.TRUE);
            if (i != 0)
            {
  ...
  {
    View localView = this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.findViewById(2131364785);
    if (localView == null) {
      return;
    }
    if (!paramBoolean)
