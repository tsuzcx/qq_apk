...
public class amrb
  implements amop, amov, amqs, Handler.Callback, View.OnTouchListener, ARNativeBridge.ARWorldCupCallback
{
  public volatile int a;
  volatile long jdField_a_of_type_Long = -1L;
  private amoo jdField_a_of_type_Amoo = new amoo(this, 1);
  private amoq jdField_a_of_type_Amoq;
  private amot jdField_a_of_type_Amot;
  ...
  private anov jdField_a_of_type_Anov = new amrc(this);
  public bhoe a;
  ...
  public amrb(amqu paramamqu, amrd paramamrd)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge = ((ARNativeBridge)paramamqu.a(0));
    this.jdField_a_of_type_Amou = ((amou)paramamqu.a(8));
    boolean bool = amrv.a();
    int j;
    long l;
    if (this.jdField_a_of_type_Boolean)
    {
      paramamqu = this.jdField_a_of_type_AndroidContentContext;
      if (bool)
      {
        j = 5;
        this.jdField_a_of_type_Anor = new anor(paramamqu, j);
      }
    }
    else
    {
      ...
      this.jdField_c_of_type_Boolean = amrv.jdField_a_of_type_Boolean;
    ...
    label304:
    for (paramamqu = amvp.a().a((Activity)this.jdField_a_of_type_AndroidContentContext);; paramamqu = null)
    {
      this.jdField_a_of_type_Amvt = paramamqu;
      if (this.jdField_a_of_type_Amvt != null)
      {
        this.jdField_a_of_type_Amoo.a();
        this.jdField_a_of_type_Amvt.a(this.jdField_a_of_type_AndroidContentContext);
        amol.jdField_a_of_type_Int = 9;
      }
  ...
  private void a(int paramInt)
  {
    ...
    case 6: 
      do
      {
        ...
        return;
        this.jdField_a_of_type_Amqu.a(new ARTransferPromotionRenderable.11(this));
  ...
  private void a(int paramInt1, String paramString, boolean paramBoolean1, int paramInt2, boolean paramBoolean2)
  {
    ...
    for (int j = k;; j = 0)
    {
      if ((localFile.exists()) || (j != 0))
      {
        ...
        this.jdField_a_of_type_Amoo.a(paramString, 123456L, paramBoolean1, paramInt2, paramBoolean2);
      }
      return;
    }
  }
  ...
  private void a(float[] arg1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3, float[] paramArrayOfFloat4, float[] paramArrayOfFloat5)
  {
    ...
    if (this.jdField_e_of_type_Boolean)
    {
      ...
      if (j >= 1)
      {
        ...
        this.jdField_a_of_type_Amou.b(true);
        ??? = this.jdField_a_of_type_Amou;
        this.jdField_a_of_type_Amou.getClass();
        ???.c(6);
  ...
  {
    if (this.jdField_a_of_type_Amvt == null) {}
    while ((!this.jdField_a_of_type_Amvt.a()) || (this.jdField_a_of_type_Amqu.a() == null)) {
      return false;
    }
    paramArrayOfFloat = new float[4];
    float[] arrayOfFloat = new float[3];
    int j = this.jdField_a_of_type_Amqu.a().a();
    FloatBuffer localFloatBuffer = this.jdField_a_of_type_Amvt.a(j, paramArrayOfFloat, arrayOfFloat);
    if ((j == -1) || (localFloatBuffer == null))
    {
      a(-1.0F, -1.0F, -1.0F);
      return false;
    }
    this.jdField_a_of_type_Amqu.a().a(j);
    this.jdField_a_of_type_Amqu.a().a(localFloatBuffer, this.jdField_a_of_type_Amvt.a());
  ...
  private void i()
  {
    if (this.jdField_a_of_type_Amvt != null)
    {
      ...
      anbk.a().e();
      this.jdField_a_of_type_Amvt.a(this.jdField_f_of_type_Int, this.jdField_g_of_type_Int);
      this.jdField_a_of_type_Amvt.c();
    }
  }
  
  private void j()
  {
    if ((this.jdField_a_of_type_Bhoe != null) && (!this.jdField_a_of_type_Bhoe.hasMessages(1105))) {
      this.jdField_a_of_type_Bhoe.sendEmptyMessageDelayed(1105, 200L);
    }
  ...
  private void k()
  {
    ...
    {
      this.jdField_a_of_type_Bhoe.removeMessages(1105);
      this.jdField_a_of_type_Amou.a(false, "");
    }
  ...
  public String a()
  {
    return this.jdField_a_of_type_Amrd.jdField_a_of_type_JavaLangString;
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Amou.f();
    this.jdField_a_of_type_Amou.a(false, "");
    azmj.b(null, "CliOper", "", "", "0X80098C8", "0X80098C8", 0, 0, this.jdField_a_of_type_Amrd.jdField_a_of_type_JavaLangString, "0", "0", "");
  ...
  {
    a((float[])paramamra.a("TARGET_SIZE"), (float[])paramamra.a("POSE"), (float[])paramamra.a("CAMERA_MATRIX"), (float[])paramamra.a("CAMERA_POSITION"), paramamra.a);
  }
  ...
  public int b()
  {
    return this.jdField_a_of_type_Amrd.jdField_a_of_type_Int;
  }
  
  public String b()
  {
    return this.jdField_a_of_type_Amrd.c;
  }
  ...
  public int c()
  {
    return this.jdField_a_of_type_Amrd.jdField_b_of_type_Int;
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Amou.a(this);
    if (!this.jdField_a_of_type_Amrd.jdField_a_of_type_JavaLangBoolean.booleanValue()) {
      this.jdField_a_of_type_Amou.e();
    }
    if ((this.jdField_a_of_type_Anor != null) && (this.jdField_a_of_type_Boolean)) {
      QLog.d("ARTransferPromotionRenderable", 2, String.format("setNativeState start sensor result=%s", new Object[] { Boolean.valueOf(this.jdField_a_of_type_Anor.a(this.jdField_a_of_type_Anov)) }));
    }
  }
  
  public boolean c()
  {
    return !this.jdField_a_of_type_Amrd.jdField_a_of_type_JavaLangBoolean.booleanValue();
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Bhoe != null) {
      this.jdField_a_of_type_Bhoe.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    }
    ...
    if (this.jdField_a_of_type_Amqu != null) {
      this.jdField_a_of_type_Amqu.a(local7);
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if ((this.jdField_a_of_type_Amoo != null) && (this.jdField_a_of_type_Amoo.a()) && (this.jdField_a_of_type_Amow != null))
    {
      long l = this.jdField_a_of_type_Amoo.a();
      paramMessage = this.jdField_a_of_type_Amow.a(l);
    ...
    for (;;)
    {
      ...
      return false;
      label98:
      this.jdField_a_of_type_Amou.a(true, paramMessage.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    if (this.jdField_b_of_type_Int == 4)
    {
      ...
      if ((this.jdField_a_of_type_Amqu != null) && (this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge != null)) {
        this.jdField_a_of_type_Amqu.a(new ARTransferPromotionRenderable.17(this, paramView));
      }
