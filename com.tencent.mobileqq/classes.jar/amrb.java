...
public class amrb
  extends BaseAdapter
{
  private amrc jdField_a_of_type_Amrc;
  ...
  public amrb(Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, amrc paramamrc)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562131, this.jdField_a_of_type_ComTencentWidgetXListView, false);
      paramView = new amrd();
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131369114));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131380154));
      paramView.b = ((TextView)localView.findViewById(2131380155));
      ...
      if (localObject != null)
      {
        ...
        label134:
        localView.setContentDescription(anzj.a(2131713825) + a(((SignatureManager.TopicInfo)localObject).topicStr) + anzj.a(2131713824));
      }
      if (!ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null)) {
        break label262;
      }
      localView.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839394));
    }
    for (;;)
    {
      EventCollector.getInstance().onListGetView(paramInt, localView, paramViewGroup, getItemId(paramInt));
      return localView;
      localObject = (amrd)paramView.getTag();
      localView = paramView;
      ...
      break label134;
      label262:
      localView.setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839393));
    }
  }
}
