  ...
  implements Manager
{
  ...
  public amrb(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b()
  {
    ...
    for (int i = ((ArrayList)localObject2).size();; i = 0)
    {
      ...
      while (i < ((ArrayList)localObject2).size())
      {
        ...
        if (ContactUtils.isNeedDiscussionNameOrCompareName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localDiscussionInfo))
        {
          Map localMap = a(localDiscussionInfo.uin);
          if (ContactUtils.setDiscussionNameAndCompareName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localDiscussionInfo.uin, localDiscussionInfo, localMap, false)) {
  ...
  public void a(DiscussionInfo paramDiscussionInfo)
  {
    ...
    Object localObject2 = (RecentUser)((ProxyManager)localObject1).a().findRecentUserByUin(paramDiscussionInfo.uin, 3000);
    if (((RecentUser)localObject2).getStatus() == 1001)
    {
      ((RecentUser)localObject2).displayName = paramDiscussionInfo.discussionName;
      ((ProxyManager)localObject1).a().saveRecentUser((BaseRecentUser)localObject2);
    }
    c();
  }
  ...
  public void a(DiscussionMemberInfo paramDiscussionMemberInfo)
  {
    if (paramDiscussionMemberInfo != null)
    {
      ...
      if ((localDiscussionInfo != null) && (ContactUtils.setDiscussionNameAndCompareName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDiscussionMemberInfo.discussionUin, localDiscussionInfo, localMap, false))) {
  ...
  public void a(String paramString, DiscussionInfo paramDiscussionInfo, long paramLong1, Map<String, DiscussionMemberInfo> paramMap, long paramLong2)
  {
    ...
    //   33: aload 5
    //   35: invokeinterface 247 1 0
    //   40: invokevirtual 121	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   43: ldc_w 465
    //   46: invokevirtual 118	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   49: lload 6
    //   51: invokevirtual 468	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    ...
    //   60: aload_0
    //   61: getfield 40	amrb:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   64: aload_1
    //   65: aload 5
    //   67: invokevirtual 388	com/tencent/commonsdk/cache/QQLruCache:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   70: checkcast 246	java/util/Map
    //   73: astore 9
    //   75: aload 9
    //   77: ifnull +57 -> 134
    ...
    //   86: ldc 88
    //   88: iconst_2
    //   89: new 111	java/lang/StringBuilder
    //   92: dup
    //   93: invokespecial 112	java/lang/StringBuilder:<init>	()V
    //   96: ldc_w 470
    //   99: invokevirtual 118	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   102: aload 9
    //   104: invokeinterface 247 1 0
    //   109: invokevirtual 121	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   112: ldc_w 472
    //   115: invokevirtual 118	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   118: aload 5
    //   120: invokeinterface 247 1 0
    //   125: invokevirtual 121	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    ...
    //   141: astore 10
    //   143: aload_0
    //   144: getfield 77	amrb:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   147: invokevirtual 161	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   150: astore 9
    //   152: aload 9
    //   154: invokevirtual 166	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   157: aload 5
    //   159: invokeinterface 473 1 0
    //   164: invokeinterface 283 1 0
    //   169: astore 11
    //   171: aload 11
    //   173: invokeinterface 215 1 0
    //   178: ifeq +140 -> 318
    //   181: aload 11
    //   183: invokeinterface 219 1 0
    //   188: checkcast 285	java/util/Map$Entry
    //   191: invokeinterface 288 1 0
    //   196: checkcast 320	com/tencent/mobileqq/data/DiscussionMemberInfo
    //   199: astore 12
    //   201: new 111	java/lang/StringBuilder
    //   204: dup
    //   205: invokespecial 112	java/lang/StringBuilder:<init>	()V
    //   208: aload 12
    //   210: getfield 408	com/tencent/mobileqq/data/DiscussionMemberInfo:discussionUin	Ljava/lang/String;
    //   213: invokevirtual 118	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   216: ldc_w 475
    //   219: invokevirtual 118	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   222: aload 12
    //   224: getfield 384	com/tencent/mobileqq/data/DiscussionMemberInfo:memberUin	Ljava/lang/String;
    //   227: invokevirtual 118	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   230: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   233: astore 12
    //   235: invokestatic 86	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   238: ifeq +30 -> 268
    //   241: ldc 88
    //   243: iconst_2
    //   244: new 111	java/lang/StringBuilder
    //   247: dup
    //   248: invokespecial 112	java/lang/StringBuilder:<init>	()V
    //   251: ldc_w 477
    ...
    //   262: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   265: invokestatic 94	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   268: aload 10
    //   270: aload 12
    //   272: invokevirtual 480	java/util/HashSet:contains	(Ljava/lang/Object;)Z
    //   275: ifne -104 -> 171
    //   278: aload 10
    //   280: aload 12
    //   282: invokevirtual 481	java/util/HashSet:add	(Ljava/lang/Object;)Z
    //   285: pop
    //   286: aload_0
    //   287: aload_2
    //   288: invokevirtual 171	amrb:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   291: pop
    //   292: goto -121 -> 171
    //   295: astore_1
    ...
    //   305: ldc_w 483
    //   308: aload_1
    //   309: invokestatic 486	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   312: aload 9
    //   314: invokevirtual 177	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   317: return
    //   318: aload_0
    //   319: getfield 63	amrb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   322: invokevirtual 490	com/tencent/mobileqq/app/QQAppInterface:getWritableDatabase	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   325: ifnull +77 -> 402
    //   328: aload_0
    //   329: getfield 63	amrb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   332: invokevirtual 490	com/tencent/mobileqq/app/QQAppInterface:getWritableDatabase	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   335: new 320	com/tencent/mobileqq/data/DiscussionMemberInfo
    //   338: dup
    //   339: invokespecial 491	com/tencent/mobileqq/data/DiscussionMemberInfo:<init>	()V
    //   342: invokevirtual 494	com/tencent/mobileqq/data/DiscussionMemberInfo:getTableName	()Ljava/lang/String;
    //   345: ldc_w 496
    //   348: iconst_2
    //   349: anewarray 224	java/lang/String
    //   352: dup
    //   353: iconst_0
    //   354: aload_1
    //   355: aastore
    ...
    //   357: iconst_1
    //   358: lload 6
    //   360: invokestatic 305	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   363: aastore
    //   364: invokevirtual 502	com/tencent/mobileqq/app/SQLiteDatabase:delete	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   367: istore 8
    ...
    //   391: iload 8
    //   393: invokevirtual 121	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   396: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   399: invokestatic 94	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   402: aload_0
    //   403: getfield 63	amrb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   406: aload_1
    //   407: aload_2
    //   408: aload 5
    //   410: iconst_0
    //   411: invokestatic 151	com/tencent/mobileqq/utils/ContactUtils:setDiscussionNameAndCompareName	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Lcom/tencent/mobileqq/data/DiscussionInfo;Ljava/util/Map;Z)Z
    //   414: pop
    //   415: aload_2
    //   416: lload_3
    //   417: putfield 507	com/tencent/mobileqq/data/DiscussionInfo:infoSeq	J
    //   420: aload_0
    //   421: aload_2
    //   422: invokevirtual 508	amrb:a	(Lcom/tencent/mobileqq/data/DiscussionInfo;)V
    //   425: aload 9
    //   427: invokevirtual 174	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   430: aload 9
    //   432: invokevirtual 177	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   435: return
    //   436: astore_1
    //   437: aload 9
    //   439: invokevirtual 177	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   442: aload_1
    //   443: athrow
  ...
  public void a(String paramString, Set<String> paramSet)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramSet)
      {
        ...
        if (ContactUtils.setDiscussionNameAndCompareName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramSet, localMap, false)) {
  ...
  {
    bjun.a("queryDiscs_" + paramList.size());
    if (QLog.isColorLevel()) {
  ...
  {
    ArrayList localArrayList = new ArrayList();
    paramString = this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.query(DiscussionMemberInfo.class, false, "discussionUin=?", new String[] { paramString }, null, null, "memberUin", String.valueOf(5));
    if (paramString != null)
    {
  ...
  public void b(String paramString1, String paramString2)
  {
    ...
    //   42: aload_1
    //   43: invokestatic 366	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   46: ifeq +4 -> 50
    //   49: return
    //   50: aload_0
    //   51: getfield 77	amrb:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   54: invokevirtual 161	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   57: astore_3
    //   58: aload_3
    //   59: invokevirtual 166	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   62: aload_0
    //   63: getfield 77	amrb:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   66: ldc_w 320
    //   69: iconst_0
    //   70: ldc_w 630
    //   73: iconst_1
    //   74: anewarray 224	java/lang/String
    //   77: dup
    //   78: iconst_0
    //   79: aload_1
    //   80: aastore
    ...
    //   83: ldc_w 377
    //   86: aconst_null
    //   87: invokevirtual 102	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   90: checkcast 58	java/util/ArrayList
    //   93: astore 4
    //   95: aload 4
    //   97: ifnull +174 -> 271
    //   100: aload 4
    //   102: invokevirtual 106	java/util/ArrayList:size	()I
    //   105: ifle +166 -> 271
    //   108: aload 4
    //   110: invokevirtual 240	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   113: astore 4
    //   115: aload 4
    //   117: invokeinterface 215 1 0
    //   122: ifeq +149 -> 271
    //   125: aload 4
    //   127: invokeinterface 219 1 0
    //   132: checkcast 320	com/tencent/mobileqq/data/DiscussionMemberInfo
    //   135: getfield 408	com/tencent/mobileqq/data/DiscussionMemberInfo:discussionUin	Ljava/lang/String;
    //   138: astore 5
    //   140: aload_0
    //   141: aload 5
    //   143: invokevirtual 327	amrb:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/DiscussionInfo;
    //   146: astore 6
    //   148: aload_0
    //   149: aload 5
    //   151: invokevirtual 147	amrb:a	(Ljava/lang/String;)Ljava/util/Map;
    //   154: astore 7
    //   156: aload 7
    //   158: ifnull +45 -> 203
    //   161: aload 7
    //   163: aload_1
    //   164: invokeinterface 318 2 0
    //   169: checkcast 320	com/tencent/mobileqq/data/DiscussionMemberInfo
    //   172: astore 8
    //   174: aload 8
    //   176: ifnull +27 -> 203
    //   179: aload 8
    //   181: aload_2
    //   182: putfield 333	com/tencent/mobileqq/data/DiscussionMemberInfo:inteRemark	Ljava/lang/String;
    //   185: aload 8
    //   187: ldc2_w 348
    //   190: putfield 344	com/tencent/mobileqq/data/DiscussionMemberInfo:inteRemarkSource	J
    //   193: aload_0
    //   194: getfield 77	amrb:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   197: aload 8
    //   199: invokevirtual 548	com/tencent/mobileqq/persistence/EntityManager:update	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   202: pop
    //   203: aload 6
    //   205: ifnull -90 -> 115
    //   208: aload 6
    //   210: aload 6
    //   212: getfield 633	com/tencent/mobileqq/data/DiscussionInfo:DiscussionFlag	J
    //   215: ldc2_w 634
    //   218: lor
    //   219: putfield 633	com/tencent/mobileqq/data/DiscussionInfo:DiscussionFlag	J
    //   222: aload_0
    //   223: getfield 63	amrb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   226: aload 5
    //   228: aload 6
    //   230: aload 7
    //   232: iconst_0
    //   233: invokestatic 151	com/tencent/mobileqq/utils/ContactUtils:setDiscussionNameAndCompareName	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Lcom/tencent/mobileqq/data/DiscussionInfo;Ljava/util/Map;Z)Z
    //   236: ifeq -121 -> 115
    //   239: aload_0
    //   240: aload 6
    //   242: invokevirtual 171	amrb:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   245: pop
    //   246: goto -131 -> 115
    //   249: astore_1
    ...
    //   259: ldc_w 637
    //   262: aload_1
    //   263: invokestatic 640	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   266: aload_3
    //   267: invokevirtual 177	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   270: return
    //   271: aload_3
    //   272: invokevirtual 174	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   275: aload_3
    //   276: invokevirtual 177	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   279: return
    //   280: astore_1
    //   281: aload_3
    //   282: invokevirtual 177	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   285: aload_1
    //   286: athrow
    // Local variable table:
    //   start	length	slot	name	signature
