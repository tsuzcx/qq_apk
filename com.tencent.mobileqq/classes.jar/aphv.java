  ...
  implements azum
{
  ...
  private aphv(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, aphw paramaphw, aphx paramaphx)
  {
    super(paramQQAppInterface, paramLong1, paramLong2, 1, paramaphw, paramaphx);
  }
  
  public static azum a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, aphw paramaphw, aphx paramaphx)
  {
    if (paramaphw == null) {
    ...
    return null;
    return new aphv(paramQQAppInterface, paramLong1, paramLong2, paramaphw, paramaphx);
  }
  ...
  protected void a(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    if (this.jdField_a_of_type_Azun != null) {
      this.jdField_a_of_type_Azun.a(paramLong1);
    }
  }
  ...
  protected void a(ExcitingTransferUploadBizInfo paramExcitingTransferUploadBizInfo)
  {
    ...
    if ((this.jdField_a_of_type_Aphu instanceof aphw))
    {
      aphw localaphw = (aphw)this.jdField_a_of_type_Aphu;
      paramExcitingTransferUploadBizInfo.groupCode = localaphw.jdField_a_of_type_Long;
      paramExcitingTransferUploadBizInfo.bufUuid = localaphw.jdField_a_of_type_ArrayOfByte;
      paramExcitingTransferUploadBizInfo.bufUploadKey = localaphw.b;
      return;
    }
  ...
  protected void b(int paramInt, ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    for (String str = paramExcitingTransferUploadResultRp.m_strFileUrl;; str = "")
    {
      ...
      b(paramExcitingTransferUploadResultRp);
      if (this.jdField_a_of_type_Azun != null) {
        this.jdField_a_of_type_Azun.a(true, this.c, paramInt, "", "");
      }
      return;
    }
  }
