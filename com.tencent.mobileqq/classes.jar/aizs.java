...
{
  public aizs(Context paramContext)
  {
  ...
  private ReportHeader a(String paramString)
  {
    ...
    paramString = new String(bdbi.decode(paramString.getBytes(), 0));
    try
    {
  ...
  private String a(ReportHeader paramReportHeader)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        paramReportHeader = new String(bdbi.encode(localJSONObject.toString().getBytes(), 0));
  ...
  private String a(ReportItem paramReportItem)
  {
    ...
    try
    {
      ...
      paramReportItem = new String(bdbi.encode(localJSONObject.toString().getBytes(), 0));
  ...
  public void a(java.util.List<Long> paramList)
  {
    ...
    //   26: astore 5
    //   28: aload_0
    //   29: invokevirtual 371	aizs:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   32: astore 7
    //   34: aload 7
    //   36: astore 5
    //   38: aload 7
  ...
  public void b(java.util.List<ReportItem> paramList)
  {
    ...
    //   24: return
    //   25: aload_0
    //   26: invokevirtual 371	aizs:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore 5
    //   31: aload 5
    //   33: astore_3
    //   34: aload 5
    ...
    //   157: aload_0
    //   158: aload 7
    //   160: invokespecial 425	aizs:a	(LVACDReport/ReportItem;)Ljava/lang/String;
  ...
  public void c(java.util.List<ReportHeader> paramList)
  {
    ...
    //   152: aload_0
    //   153: aload 7
    //   155: invokespecial 448	aizs:a	(LVACDReport/ReportHeader;)Ljava/lang/String;
