  ...
  extends QIPCModule
{
  ...
  public aizs(String paramString)
  {
    super(paramString);
  }
  ...
  public static void a()
  {
    ...
    if (!a)
    {
      QIPCClientHelper.getInstance().register(localaizs);
      a = true;
    }
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    try
    {
      ...
      {
        ajac.a(paramBundle.getInt("gameId"));
      }
    ...
    else if ("action_set_sso_rule".equals(paramString))
    {
      ...
      ajco localajco = ajac.a();
      if (localajco != null) {
        localajco.a(paramString.gameId, paramBundle);
      }
    }
    else
    {
      ...
      if (bool)
      {
        try
        {
          ...
          if (l >= 0L)
          {
            ...
            axrn.a(BaseApplicationImpl.getApplication()).a(null, "cmgame_ipc_start_receive", true, l, 0L, paramBundle, "", false);
          }
          ajac.a(paramString);
        }
        catch (Exception paramString)
      ...
      else if ("action_check_game_data".equals(paramString))
      {
        ...
        paramString = ajac.a(paramString.gameId);
        if (paramString != null) {
