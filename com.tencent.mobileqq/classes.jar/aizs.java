...
public class aizs
  extends andd
{
  public aizs(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment) {}
  ...
  protected void onGetTroopFeeMemberList(boolean paramBoolean, List<cmd0x406.GroupFeeMember> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localajac.a = (localGroupFeeMember.uint64_uin.get() + "");
      localajac.b = localGroupFeeMember.string_nick_name.get();
      if (this.a.jdField_a_of_type_Ajas != null) {
        this.a.jdField_a_of_type_Ajas.a(localajac);
      }
  ...
  {
    if (!bftf.a(String.valueOf(paramLong1), this.a.jdField_c_of_type_JavaLangString)) {}
    do
    {
      return;
      if (QLog.isColorLevel())
