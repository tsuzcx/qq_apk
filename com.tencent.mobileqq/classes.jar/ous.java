...
{
  public ous(AppActivity paramAppActivity, String paramString, QQAppInterface paramQQAppInterface, ScannerParams paramScannerParams, View paramView, QrHandleResultCallBack paramQrHandleResultCallBack) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if ((paramBoolean) && (paramBundle != null))
    {
      ...
      for (;;)
      {
        ...
        ((QQCustomDialog)localObject1).setTitle(2131430010);
        ((QQCustomDialog)localObject1).setMessage(paramBundle);
        localObject4 = new out(this);
        ((QQCustomDialog)localObject1).setPositiveButton(2131433016, new ouu(this, paramBundle));
        ((QQCustomDialog)localObject1).setNegativeButton(2131433015, (DialogInterface.OnClickListener)localObject4);
