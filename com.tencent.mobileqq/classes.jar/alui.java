...
public class alui
{
  ...
  private aluj jdField_a_of_type_Aluj;
  ...
  public alui(aluc paramaluc, float paramFloat1, float paramFloat2, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.jdField_a_of_type_Aluc = paramaluc;
    Object localObject = this.jdField_a_of_type_Aluc.getContext();
    ...
    this.d = paramInt3;
    paramaluc = a(((Context)localObject).getResources(), 2130849162, (int)this.jdField_a_of_type_Float, (int)this.jdField_b_of_type_Float);
    localObject = a(((Context)localObject).getResources(), 2130849164, (int)this.jdField_a_of_type_Float, (int)this.jdField_b_of_type_Float);
    ...
    if (paramaluc != null) {
      localCanvas.drawBitmap(paramaluc, (this.jdField_a_of_type_Float - paramaluc.getWidth()) / 2.0F, (this.jdField_b_of_type_Float - paramaluc.getHeight()) / 2.0F, this.jdField_a_of_type_AndroidGraphicsPaint);
    }
  ...
  public void a()
  {
    this.jdField_a_of_type_Aluj = null;
  ...
  {
    this.jdField_a_of_type_Aluj = paramaluj;
  }
  ...
  public void a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Aluc.invalidate();
      if (this.jdField_a_of_type_Aluj == null) {
        break;
      }
      this.jdField_a_of_type_Aluj.a(this.e, this.f);
      return;
      label148:
      if (this.f - f1 < this.g)
      {
