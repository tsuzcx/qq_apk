...
public class ajmg
  extends amgf
{
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ajmh(this);
  public LinkedHashMap<String, List<ajmf>> a;
  private boolean jdField_a_of_type_Boolean;
  public int[] a;
  public String[] a;
  
  public ajmg(PublicAccountFragment paramPublicAccountFragment)
  {
  ...
  public ajmg(PublicAccountFragment paramPublicAccountFragment, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
    super(paramContext, paramQQAppInterface, paramXListView, paramBoolean);
    this.jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
    this.jdField_a_of_type_ArrayOfInt = new int[0];
    this.jdField_a_of_type_ArrayOfJavaLangString = new String[0];
    this.jdField_a_of_type_AndroidGraphicsBitmap = bheg.a(true);
  }
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    if ((ThemeUtil.isNowThemeDefaultCache) || (ThemeUtil.isNowThemeIsNight(PublicAccountFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityContactsPublicaccountPublicAccountFragment), false, null))) {
      paramView.setBackgroundResource(2130850257);
    }
    for (;;)
    {
      paramView.setPadding(i, 0, 0, 0);
      paramView.setText(this.jdField_a_of_type_ArrayOfJavaLangString[paramInt]);
      paramView.setTextColor(PublicAccountFragment.f(this.jdField_a_of_type_ComTencentMobileqqActivityContactsPublicaccountPublicAccountFragment).getResources().getColorStateList(2131167110));
      return;
  ...
  public void b()
  {
    ...
    do
    {
      ...
      {
        ajmf localajmf = (ajmf)((Iterator)localObject2).next();
        if ((localajmf.jdField_a_of_type_JavaLangString == null) || (localajmf.jdField_a_of_type_JavaLangString.length() == 0))
        {
          localObject1 = "#";
        ...
        for (localObject1 = ((String)localObject1).toUpperCase();; localObject1 = "#")
        {
          ...
          ((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localObject1)).add(localajmf);
          break;
          localObject1 = localajmf.jdField_a_of_type_JavaLangString.substring(0, 1);
          break label92;
        }
      }
  ...
  public Object getItem(int paramInt)
  {
    ...
    i = -(i + 1) - 1;
    return (ajmf)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = PublicAccountFragment.d(this.jdField_a_of_type_ComTencentMobileqqActivityContactsPublicaccountPublicAccountFragment).getLayoutInflater().inflate(2131559664, paramViewGroup, false);
      paramView = new ajmi();
      paramView.jdField_c_of_type_Int = 115;
      paramView.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131368381));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131364215));
      paramView.d = ((TextView)localView.findViewById(2131378659));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131373322));
      paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131373305));
      paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131373332));
      paramView.e = ((TextView)localView.findViewById(2131378661));
      paramView.f = ((TextView)localView.findViewById(2131379987));
      paramView.jdField_a_of_type_AndroidViewView = localView.findViewById(2131373319);
      paramView.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131364187));
    ...
    for (;;)
    {
      ...
      {
        i = -(i + 1) - 1;
        localObject = (ajmf)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
        paramView.jdField_a_of_type_Ajmf = ((ajmf)localObject);
        paramView.jdField_a_of_type_JavaLangString = String.valueOf(((ajmf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.uin);
        paramView.jdField_a_of_type_AndroidViewView.setVisibility(0);
        paramView.f.setVisibility(8);
        paramView.d.setVisibility(0);
        paramView.d.setText(((ajmf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name);
        if (((ajmf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.certifiedGrade > 0L)
        {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqActivityContactsPublicaccountPublicAccountFragment.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_ComTencentMobileqqActivityContactsPublicaccountPublicAccountFragment.getResources().getDrawable(2130841803);
          ...
          label431:
          paramView.e.setText(((ajmf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.summary);
          ...
          boolean bool = false;
          if (((ajmf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.extendType == 2) {
            bool = nwu.a(PublicAccountFragment.c(this.jdField_a_of_type_ComTencentMobileqqActivityContactsPublicaccountPublicAccountFragment), ((ajmf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin(), 1024);
          }
          if (!bool) {
            break label746;
          }
          paramView.jdField_a_of_type_AndroidWidgetImageView.setTag(-1, ((ajmf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin());
          paramView.jdField_a_of_type_AndroidWidgetImageView.setTag(-2, ((ajmf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name);
      ...
      for (;;)
      {
        ...
        return localView;
        localObject = (ajmi)paramView.getTag();
        localView = paramView;
        ...
        break label560;
        paramView.jdField_a_of_type_Ajmf = null;
        ...
        if (AppSetting.c) {
          paramView.f.setContentDescription(String.format(PublicAccountFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityContactsPublicaccountPublicAccountFragment).getString(2131691767), new Object[] { ((String)localObject).toLowerCase() }));
        }
      }
    }
  }
