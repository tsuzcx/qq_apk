...
{
  public biwg(ConfigClearableEditText paramConfigClearableEditText, View paramView)
  {
    super(paramView);
  }
  ...
  {
    if (paramInt == 0) {
      paramAccessibilityEvent.setContentDescription(anzj.a(2131701335));
    }
  }
  ...
  public void onPopulateNodeForVirtualView(int paramInt, AccessibilityNodeInfoCompat paramAccessibilityNodeInfoCompat)
  {
    if (paramInt == 0)
    {
      paramAccessibilityNodeInfoCompat.setContentDescription(anzj.a(2131701336));
