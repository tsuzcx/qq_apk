  ...
  implements Manager
{
  public int a;
  protected akhp a;
  private akuo jdField_a_of_type_Akuo = new akfe(this, 3, true, true, 60000L, false, false, "TroopNotifyAndRecommendView");
  ...
  {
    paramQQAppInterface = paramQQAppInterface.a().b(ajsd.Y, 4001);
    int j;
  ...
  private void a(long paramLong, oidb_0x935.RspBody paramRspBody)
  {
    ...
    if ((this.jdField_b_of_type_Int == paramRspBody.cur_pos.get() - 1) || (paramRspBody.cur_pos.get() == 1))
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        for (j = localRgroupInfo.int32_uin_privilege.get();; j = -1)
        {
          ...
          this.jdField_a_of_type_Aukp.b(localNotificationRecommendTroopItem);
    ...
    this.jdField_a_of_type_Akhp.notifyUI(29, true, this.jdField_b_of_type_JavaUtilList);
  }
  ...
  public static void a(AppInterface paramAppInterface, int paramInt, String paramString, BusinessObserver paramBusinessObserver)
  {
    ...
    try
    {
      ...
      localObject1 = new NewIntent(paramAppInterface.getApplication(), mxe.class);
  ...
  private void e()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(ajsd.W, 9000, b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      Object localObject = (akfb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(33);
      MessageRecord localMessageRecord = a();
      if ((localMessageRecord != null) && (!((akfb)localObject).a(ajsd.W, 9000, localMessageRecord.time))) {
        ((akfb)localObject).a(ajsd.W, 9000, ajya.a(2131691088), localMessageRecord.time, localMessageRecord.time);
      }
  ...
  public MessageRecord a()
  {
    try
    {
      List localList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(ajsd.Y, 4001);
  ...
  public String a()
  {
    try
    {
      Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(ajsd.Y, 4001);
  ...
  public List<RecommendTroopItem> a()
  {
    ...
    {
      localList = this.jdField_a_of_type_Aukp.a(NotificationRecommendTroopItem.class, false, null, new String[0], null, null, null, null);
  ...
  public void a(int paramInt, oidb_0x935.GPS paramGPS, BusinessObserver paramBusinessObserver)
  {
    ...
    for (long l1 = ((Long)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt)).longValue();; l1 = 0L)
    {
      ...
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), mxe.class);
  ...
  {
    a(2, paramGPS, new akfd(this, paramLong));
  }
  ...
  public void a(List<group_activity.GroupAct> paramList)
  {
    ...
    {
      localObject3 = this.jdField_a_of_type_Aukp.a(RecTroopBusinessItem.class, false, null, null, null, null, "timeStamp desc", null);
      if ((localObject3 != null) && (((List)localObject3).size() != 0))
      {
        ...
        if (paramList != null)
        {
          localObject1 = axas.a(-1040);
          ((MessageRecord)localObject1).extStr = paramList.id;
          ((MessageRecord)localObject1).init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), ajsd.Y, "0", paramList.title, l, -1040, 4001, 0L);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          localObject1 = (RecommendTroopInfo)this.jdField_a_of_type_Aukp.a(RecommendTroopInfo.class, String.valueOf(((SearchGroup.GroupInfo)localObject4).dwGroupCode.get()));
          if (localObject1 != null) {
            break label1335;
          }
          ...
          this.jdField_a_of_type_Aukp.b((auko)localObject1);
          localObject4 = axas.a(-1039);
          String str = ((RecommendTroopInfo)localObject1).name;
          ((MessageRecord)localObject4).extStr = ((RecommendTroopInfo)localObject1).uin;
          ((MessageRecord)localObject4).init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), ajsd.Y, "0", str, l, -1039, 4001, 0L);
      ...
      paramList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(ajsd.Y, 4001);
      if ((paramList != null) && (paramList.size() > 0))
      {
        ...
        while (k >= 0)
        {
          ...
          if (((MessageRecord)localObject2).msgtype == -1039)
          {
            ...
            {
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(((MessageRecord)localObject2).frienduin, ((MessageRecord)localObject2).istroop, ((MessageRecord)localObject2).uniseq);
              localObject2 = (RecommendTroopInfo)this.jdField_a_of_type_Aukp.a(RecommendTroopInfo.class, ((MessageRecord)localObject2).extStr);
              i = j;
  ...
  {
    if (this.jdField_a_of_type_Aukp != null) {
      this.jdField_a_of_type_Aukp.a(NotificationRecommendTroopItem.class);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(-1039);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(-1040);
    this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putInt("unread_recommend_troop_count", 0).commit();
