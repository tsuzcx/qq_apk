  ...
  extends bhrq
{
  ...
  {
    bcci localbcci = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a());
    int i = paramInt;
    if ((localbcci instanceof bcdc)) {
      i = ((bcdc)localbcci).switchRequestCode(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, (byte)paramInt);
    }
    return i;
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, boolean paramBoolean, String paramString4)
  {
    ...
    String str1 = ((Activity)localObject2).getString(2131718273);
    String str3 = ((Activity)localObject2).getString(2131718274);
    paramString4 = "";
    Object localObject1 = "";
    ...
    for (;;)
    {
      try
      {
        ...
        paramString3.put("pf", a(bgxr.a(), str2));
