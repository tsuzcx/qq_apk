  ...
  implements apgz
{
  ...
  private apha jdField_a_of_type_Apha;
  ...
  private final String jdField_a_of_type_JavaLangString = anzj.a(2131699676);
  ...
  public aphb(View paramView)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_ComTencentMobileqqArARRecordARVideoRecordButtonView = ((ARVideoRecordButtonView)paramView.findViewById(2131370479));
    this.c = paramView.findViewById(2131364202);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131362881);
    this.jdField_a_of_type_Boolean = apgs.a();
    if (this.jdField_a_of_type_Boolean) {
      this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    }
    this.c.setOnClickListener(null);
    this.c.setOnTouchListener(new aphc(this));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362883));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362882));
  ...
  {
    this.jdField_a_of_type_Apha = paramapha;
  }
