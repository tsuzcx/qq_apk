...
public class bkqp
  implements aqoa, PageGestureProxy
{
  ...
  private void a()
  {
    if (this.jdField_a_of_type_Aqqs == null)
    {
      ...
      this.jdField_a_of_type_Aqns.a(new bkqs(this));
  ...
  {
    this.jdField_a_of_type_Aqnr = new aqnr(paramActivity, false, true);
    this.jdField_a_of_type_Aqnr.a(paramActivity);
    this.jdField_a_of_type_Aqnr.a(this);
    this.jdField_a_of_type_Aqnr.a(new bkqq(this, paramActivity));
    this.jdField_a_of_type_Aqnr.a(new bkqr(this, paramActivity));
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = new QQCustomDialog((Context)localObject, 2131755829);
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setContentView(2131559043);
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setCanceledOnTouchOutside(false);
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setTitle(((Activity)localObject).getString(2131690884));
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(((Activity)localObject).getString(2131690883), new bkqt(this, (Activity)localObject));
    for (;;)
    {
  ...
  public ColorNote getColorNote()
  {
    ...
    if (this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo != null)
    {
      ...
      if (this.jdField_a_of_type_JavaLangString != null) {
        localObject1 = this.jdField_a_of_type_JavaLangString.getBytes();
      }
      localObject1 = new aqoi().a(16842752).a(localMiniAppInfo.appId + "." + localMiniAppInfo.verType).b(localMiniAppInfo.name).a((byte[])localObject1).c(localMiniAppInfo.desc).d(localMiniAppInfo.iconUrl).a();
    }
    return localObject1;
  }
  ...
  public void onPageWebViewInit()
  {
    if (this.jdField_a_of_type_MqqUtilWeakReference != null)
    {
      ...
      if (localActivity != null) {
        this.jdField_a_of_type_Aqry = new aqry(localActivity);
      }
    }
    a();
  }
  ...
  public void onProcessTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    Object localObject;
    boolean bool1;
    if ((this.jdField_a_of_type_Aqns != null) && (this.jdField_a_of_type_Aqns.b()) && (this.jdField_a_of_type_Aqry != null) && (this.jdField_a_of_type_ComTencentMobileqqColornoteSwipebackPostTable != null))
    {
      d = this.jdField_a_of_type_Aqry.a(paramMotionEvent);
      this.jdField_a_of_type_Aqns.a();
      localObject = this.jdField_a_of_type_Aqoa.getColorNote();
      if (localObject == null) {
        break label323;
      }
      bool1 = this.jdField_a_of_type_Aqns.a(((ColorNote)localObject).getServiceType(), ((ColorNote)localObject).getSubType());
      if (this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo == null) {
        break label383;
      }
    }
    ...
    for (boolean bool2 = this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo.isLimitedAccessApp();; bool2 = false)
    {
      if ((d > 0.0D) && (!bool1) && (!bool2) && (this.jdField_a_of_type_MqqUtilWeakReference != null))
      {
        ...
        localObject = (Activity)this.jdField_a_of_type_MqqUtilWeakReference.get();
        if ((this.jdField_a_of_type_Aqns.a()) && (localObject != null)) {
          if (this.jdField_a_of_type_Aqry.a(paramMotionEvent, (Context)localObject))
          {
  ...
  public boolean onViewReleasedAndNeedScrollOriginPosition(MotionEvent paramMotionEvent)
  {
    ...
    for (boolean bool1 = this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo.isLimitedAccessApp();; bool1 = false)
    {
      ...
      {
        bool1 = this.jdField_a_of_type_Aqns.a(localColorNote.getServiceType(), localColorNote.getSubType());
        this.b = true;
        if (this.jdField_a_of_type_MqqUtilWeakReference == null) {
          break label222;
        }
        ...
        label85:
        if ((this.jdField_a_of_type_Aqry == null) || (!this.jdField_a_of_type_Aqry.a(paramMotionEvent, localActivity)) || (bool1) || (localColorNote == null)) {
          break label278;
        }
        ...
        this.jdField_a_of_type_Aqns.a(paramMotionEvent);
