...
public class bckh
{
  public static Intent a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    paramString1.putExtra("custom_title_name", paramActivity.getString(2131698167));
  ...
  {
    return bduw.a(Environment.getExternalStorageDirectory().getAbsolutePath() + "/tencent/MobileQQ/.troop/pic_effects/" + paramInt + ".mp4");
  }
  ...
  public static String a(String paramString)
  {
    ...
    localStringBuffer.append(aljq.cu).append(paramString + "_NEW").append(File.separator);
  ...
  public static String a(String paramString, int paramInt)
  {
    StringBuffer localStringBuffer = new StringBuffer();
    if (paramInt == 1) {
      localStringBuffer.append(aljq.cu).append(paramString + "_V").append(File.separator);
    }
    for (;;)
    {
      return localStringBuffer.toString();
      localStringBuffer.append(aljq.cu).append(paramString + "_HD").append(File.separator);
    }
  }
  ...
  public static String a(String paramString, int paramInt, boolean paramBoolean)
  {
    StringBuffer localStringBuffer = new StringBuffer();
    if (paramBoolean) {
      localStringBuffer.append(aljq.cu).append(File.separator).append(paramString).append("_NEW.zip");
    }
    for (;;)
    {
      return localStringBuffer.toString();
      if (paramInt == 1) {
        localStringBuffer.append(aljq.cu).append(File.separator).append(paramString).append("_V.zip");
      } else {
        localStringBuffer.append(aljq.cu).append(File.separator).append(paramString).append("_HD.zip");
      }
    }
  }
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer();
    localStringBuffer.append(aljq.cu).append(paramString + "_NEW").append(File.separator).append("info.json");
    paramString = bdcs.a(new File(localStringBuffer.toString()));
    if (paramString == null) {
      return null;
    }
    try
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      azmj.b(paramQQAppInterface, "P_CliOper", "Grp_flower", "", "mber", "exp", 0, 0, paramString1, i + "", "", "");
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramQQAppInterface != null)
        {
          ...
          String str2 = localbckj.a("troop_gift");
          localObject = str2;
          if (!TextUtils.isEmpty(str2))
          {
            localObject = new bckk();
            ((bckk)localObject).a = paramString1;
            ((bckk)localObject).c = paramString4;
            ((bckk)localObject).b = paramString2;
            ((bckk)localObject).e = paramString3;
            localObject = localbckj.a(str2, (bckk)localObject);
          }
        }
      ...
      catch (UnsupportedEncodingException localUnsupportedEncodingException)
      {
        ...
        if (paramQQAppInterface != null)
        {
          ...
          if (paramActivity != null)
          {
            ...
            i = 0;
            azmj.b(paramQQAppInterface, "P_CliOper", "Grp_flower", "", "mber", "send_page", 0, 0, paramString1, i + "", "", "");
          }
        }
      }
      if (!QLog.isColorLevel()) {
