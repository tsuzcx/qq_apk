  ...
  implements Animatable
{
  ...
  Property<bknr, Float> jdField_a_of_type_AndroidUtilProperty = new bkns(this, Float.class, "backScale");
  private String jdField_a_of_type_JavaLangString;
  private boolean jdField_a_of_type_Boolean;
  private float jdField_b_of_type_Float;
  private int jdField_b_of_type_Int = 0;
  Property<bknr, Integer> jdField_b_of_type_AndroidUtilProperty = new bknt(this, Integer.class, "backAlpha");
    ...
    for (;;)
    {
      ...
      try
      {
        if ("1/4".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841058);
        }
        if ("1/2".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841057);
        }
        if ("1x".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841059);
        }
        ...
        {
          paramString = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841062);
          return paramString;
        }
      }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bknu(this));
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bknv(this));
