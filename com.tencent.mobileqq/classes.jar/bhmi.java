...
public class bhmi
  extends bhmb
  implements avie, bhlp, IVideoOuterStatusListener
{
  private IVideoInnerStatusListener a;
  private ImageView b;
  
  bhmi(Context paramContext)
  {
    super(paramContext);
  ...
  private void f()
  {
    View localView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374266);
  ...
  public void a(Context paramContext)
  {
    ...
    this.b = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131374263));
    this.b.setContentDescription(amtj.a(2131703760));
    a(new View[] { this.b });
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver.a(2, new bhmj(this));
    }
  }
