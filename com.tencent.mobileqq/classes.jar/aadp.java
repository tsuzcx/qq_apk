...
public class aadp
{
  ...
  public aadp(Activity paramActivity)
  {
  ...
  public bccw a()
  {
    ...
    {
      localActivity = a();
      if (!(localActivity instanceof bccw)) {
        break label45;
      }
    }
    label45:
    for (this.d = new WeakReference((bccw)localActivity);; this.d = new WeakReference(a())) {
  ...
  public WebViewFragment a()
  {
    ...
    {
      localActivity = a();
      if (!(localActivity instanceof bccs)) {
        break label50;
      }
    }
    label50:
    for (this.e = new WeakReference(((bccs)localActivity).b());; this.e = new WeakReference(null)) {
