...
{
  public static final aadr a;
  private final Map<String, aads> a;
  
  static
  {
    jdField_a_of_type_Aadr = new aadr(null);
  }
  
  public aadp()
  {
    this.jdField_a_of_type_JavaUtilMap = MapsKt.mapOf(TuplesKt.to("showShareMenu", new aads(this)));
  }
  ...
  public boolean handleJsRequest(@Nullable JsBridgeListener paramJsBridgeListener, @Nullable String paramString1, @Nullable String paramString2, @Nullable String paramString3, @NotNull String... paramVarArgs)
  {
    ...
    if ((localObject == null) || (((CharSequence)localObject).length() == 0))
    {
      ...
      localObject = (aads)this.jdField_a_of_type_JavaUtilMap.get(paramString3);
      if (localObject == null) {
        break label129;
      }
    ...
    {
      ((aads)localObject).a(paramJsBridgeListener);
      return true;
      i = 0;
      break;
      i = 0;
