...
public class lts
{
  public static void a()
  {
    ...
    axrn.a(BaseApplicationImpl.getApplication()).a(null, "actAVRPPtuSoFail", true, 0L, 0L, null, "", true);
  }
  ...
  public static void a(int paramInt)
  {
    ...
    axrn.a(BaseApplicationImpl.getApplication()).a(null, "actAVRPDetectInvalidExp", true, 0L, 0L, localHashMap, "", true);
  }
  ...
  public static void a(int paramInt1, int paramInt2)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      axrn.a(BaseApplicationImpl.getApplication()).a(null, "actResDownResult", bool, 0L, 0L, localHashMap, "", true);
      return;
    }
  }
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, float paramFloat, int paramInt4, int paramInt5)
  {
    ...
    axrn.a(BaseApplicationImpl.getApplication()).a(null, "actAVEmojiHit", true, 0L, 0L, localHashMap, "", true);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      i = ((lui)paramQQAppInterface.getManager(254)).a();
      if (i > 0)
      {
        paramQQAppInterface = new HashMap();
        paramQQAppInterface.put("configVersion", String.valueOf(i));
        axrn.a(BaseApplicationImpl.getApplication()).a(null, "actConfigExistStatus", true, 0L, 0L, paramQQAppInterface, "", true);
      }
  ...
  public static void a(String paramString)
  {
    ...
    if (bool)
    {
      ...
      axrn.a(BaseApplicationImpl.getApplication()).a(null, "actIllegalAVRPRequest", true, 0L, 0L, localHashMap, "", true);
    }
  }
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    axrn.a(BaseApplicationImpl.getApplication()).a(null, "actAVConfigReqResult", paramBoolean, 0L, 0L, null, "", true);
  }
  ...
  public static void a(boolean paramBoolean, String paramString)
  {
    ...
    axrn.a(BaseApplicationImpl.getApplication()).a(null, "actAVRPBtnGrayOrNot", paramBoolean, 0L, 0L, localHashMap, "", true);
  }
  ...
  public static void a(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    axrn.a(BaseApplicationImpl.getApplication()).a(null, "actAVSendRPResult", paramBoolean, 0L, 0L, localHashMap, "", true);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      int i = ((lui)paramQQAppInterface.getManager(254)).a();
      boolean bool;
      if (i > 0)
      {
        ...
        if (bool)
        {
          paramQQAppInterface = new HashMap();
          paramQQAppInterface.put("configVersion", String.valueOf(i));
          axrn.a(BaseApplicationImpl.getApplication()).a(null, "actResExistStatus", true, 0L, 0L, paramQQAppInterface, "", true);
        }
      }
      while (QLog.isColorLevel())
      {
  ...
  public static void b(boolean paramBoolean, String paramString)
  {
    ...
    axrn.a(BaseApplicationImpl.getApplication()).a(null, "actAVClickRPBtnResult", paramBoolean, 0L, 0L, localHashMap, "", true);
  }
  ...
  public static void b(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    localHashMap.put("errorCode1", paramString1);
    localHashMap.put("errorCode2", paramString2);
    axrn.a(BaseApplicationImpl.getApplication()).a(null, "actAVGrabRPResult", paramBoolean, 0L, 0L, localHashMap, "", true);
  }
}
