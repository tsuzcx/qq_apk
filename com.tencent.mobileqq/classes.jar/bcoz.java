  ...
  implements Handler.Callback
{
  ...
  private bcpa jdField_a_of_type_Bcpa;
  ...
  public bcoz(Context paramContext, ListView paramListView, bcpc parambcpc)
  {
    this.jdField_a_of_type_ComTencentWidgetListView = paramListView;
    this.jdField_a_of_type_Bcpc = parambcpc;
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(paramContext, new bcpb());
  ...
  private void a(int paramInt1, int paramInt2, View paramView, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      {
        if (this.jdField_a_of_type_Bcpa != null) {
          this.jdField_a_of_type_Bcpa.a(true);
        }
  ...
  private void b(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bcpa != null) {
        this.jdField_a_of_type_Bcpa.a(paramView);
      }
  ...
  public void a(bcpa parambcpa)
  {
    this.jdField_a_of_type_Bcpa = parambcpa;
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    {
      bool2 = this.jdField_a_of_type_Bcpc.a(paramMotionEvent);
      return bool2;
    }
    ...
    for (;;)
    {
      ...
      return this.jdField_a_of_type_Bcpc.a(paramMotionEvent);
      ...
      this.g = -1;
      break label80;
      if (((k == 1) || (k == 3)) && (this.jdField_a_of_type_Bcpa != null)) {
        this.jdField_a_of_type_Bcpa.a(false);
      }
    }
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Bcpa = null;
  }
  ...
  public boolean b(MotionEvent paramMotionEvent)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      bool2 = this.jdField_a_of_type_Bcpc.b(paramMotionEvent);
      return bool2;
    }
    a(paramMotionEvent);
    ...
    case 2: 
      for (;;)
      {
        if ((k == 0) && (this.jdField_c_of_type_Boolean))
        {
          ...
          return this.jdField_a_of_type_Bcpc.b(paramMotionEvent);
