...
public class atud
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    atue.a(paramQQAppInterface, 0, paramString, false);
    a(paramQQAppInterface, 0, paramString, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, List<im_msg_body.Elem> paramList, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, msg_comm.Msg paramMsg, boolean paramBoolean, bbpd parambbpd)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if (parambbpd != null) {}
      for (paramQQAppInterface = parambbpd.a;; paramQQAppInterface = paramMsg.msg_head.to_uin.get() + "") {
        break;
      }
      if (QLog.isColorLevel()) {
        paramStringBuilder.append("elemType:LbsShareMsg;\n");
      }
      paramList = (MessageForLocationShare)azaf.a(-2076);
      paramList.msgtype = -2076;
      paramList.msg = BaseApplicationImpl.context.getString(2131720291);
  ...
  {
    atue.a(paramQQAppInterface, 1, paramString, false);
