...
{
  public begj(AbsPublishActivity paramAbsPublishActivity) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      ...
      if ("key_audio_delete_action".equals(paramContext))
      {
        this.a.a(0);
        this.a.a = null;
        bfqu.a(this.a.o, this.a.p, "del_record", this.a.q, this.a.b, "", "");
        return;
      }
    } while (!"key_audio_play_action".equals(paramContext));
    bfqu.a(this.a.o, this.a.p, "preview_record", this.a.q, this.a.b, "", "");
  }
}
