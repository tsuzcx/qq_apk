  ...
  extends amck
{
  public void a()
  {
    ...
    if (i > 10)
    {
      ...
      {
        bool1 = SettingCloneUtil.readValue(BaseApplicationImpl.sApplication, null, BaseApplicationImpl.sApplication.getString(2131695444), "qqsetting_screenshot_key", false);
        boolean bool2 = bdds.a(BaseApplication.getContext());
        if ((bool1) && (bool2))
        {
    ...
    for (;;)
    {
      ...
      while (QLog.isColorLevel())
      {
        ...
        if ((!bdqi.g) && (Build.VERSION.SDK_INT < 11)) {
          bdqf.a().a(BaseActivity2.topActivity.getWindow());
        }
      }
    }
  }
