  ...
  extends DynamicTextItem
{
  ...
  bosa jdField_b_of_type_Bosa;
  private String jdField_b_of_type_JavaLangString = "05/09";
  bosa jdField_c_of_type_Bosa;
  ...
  static
  {
    ...
    jdField_b_of_type_Int = afur.a(18.0F, localResources);
    d = afur.a(6.0F, localResources);
    int n = bppm.a();
    jdField_c_of_type_Int = localResources.getDisplayMetrics().widthPixels - bpic.a - n * 2;
  }
  
  public bort(int paramInt, List<String> paramList, Typeface paramTypeface)
  {
    ...
    if (paramTypeface == null)
    {
      ...
      this.k = afur.a(41.0F, BaseApplicationImpl.getContext().getResources());
      ...
      this.g = afur.a(34.0F, BaseApplicationImpl.getContext().getResources());
      this.h = afur.a(45.0F, BaseApplicationImpl.getContext().getResources());
      this.l = afur.a(4.0F, BaseApplicationImpl.getContext().getResources());
      this.m = afur.a(3.0F, BaseApplicationImpl.getContext().getResources());
      this.jdField_c_of_type_Bosa = new bosa(0);
      this.jdField_c_of_type_Bosa.a(new borl(-1, this.l, this.m));
      ...
      this.j = afur.a(19.0F, BaseApplicationImpl.getContext().getResources());
      ...
      this.jdField_b_of_type_JavaLangString = bosk.a();
      localTextPaint.setAntiAlias(true);
      localTextPaint.setTextSkewX(-0.15F);
      localTextPaint.setStyle(Paint.Style.FILL_AND_STROKE);
      this.i = afur.a(23.0F, BaseApplicationImpl.getContext().getResources());
      localTextPaint.setTextSize(this.i);
      localTextPaint.setColor(-1);
      this.jdField_b_of_type_Bosa = new bosa(0);
      this.jdField_b_of_type_Bosa.a(new borl(-16777216, this.l, this.m));
      this.jdField_b_of_type_Bosa.a(this.jdField_b_of_type_JavaLangString, jdField_c_of_type_Int, this.i, localTextPaint);
      if (paramList != null) {
        break label541;
      }
    }
  ...
  public int a(MotionEvent paramMotionEvent, float paramFloat1, float paramFloat2, @Nullable bpif parambpif, bppo parambppo)
  {
    float f1 = paramMotionEvent.getX();
    float f2 = paramMotionEvent.getY();
    if (parambpif != null) {
      return parambppo.a(parambpif, f1, f2);
    }
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new boru(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    this.f = afur.a(18.0F, BaseApplicationImpl.getContext().getResources());
    if (paramInt == 0)
    {
      paramString = " " + paramString;
      this.jdField_a_of_type_Bosa = new bosa(0);
      this.jdField_a_of_type_Bosa.a(new borl(-16777216, this.l, this.m));
      this.jdField_a_of_type_Bosa.a(paramString, jdField_c_of_type_Int, this.k, this.jdField_b_of_type_AndroidTextTextPaint);
      this.jdField_a_of_type_Float = Math.max(this.jdField_a_of_type_Bosa.a(), this.jdField_b_of_type_Bosa.a());
      this.jdField_a_of_type_Float = Math.max(this.jdField_c_of_type_Bosa.a(), this.jdField_a_of_type_Float);
      this.jdField_b_of_type_Float = (this.jdField_a_of_type_Bosa.b() + this.g + this.jdField_b_of_type_Bosa.b() + this.h + this.jdField_c_of_type_Bosa.b());
      return;
    }
  ...
  {
    this.e = 0;
    this.jdField_a_of_type_Bosa.a(paramCanvas, 0, this.e);
    this.e = ((int)(this.e + this.jdField_a_of_type_Bosa.b()));
    this.e += this.g;
    this.jdField_b_of_type_Bosa.a(paramCanvas, 0, this.e);
    this.e = ((int)(this.e + this.jdField_b_of_type_Bosa.b()));
    this.e += this.h;
    this.jdField_c_of_type_Bosa.a(paramCanvas, 0, this.e);
    if (super.b(1))
    {
      this.jdField_b_of_type_AndroidGraphicsRectF.set(this.jdField_c_of_type_Bosa.a(2, this.jdField_c_of_type_Bosa.a()));
    ...
    this.e = ((int)(this.e + this.jdField_c_of_type_Bosa.b()));
    if (super.b(0))
    {
      this.jdField_b_of_type_AndroidGraphicsRectF.left = 0.0F;
      this.jdField_a_of_type_AndroidGraphicsRectF.top = 0.0F;
      this.jdField_a_of_type_AndroidGraphicsRectF.right = this.jdField_a_of_type_Bosa.a();
      this.jdField_a_of_type_AndroidGraphicsRectF.bottom = this.jdField_a_of_type_Bosa.b();
