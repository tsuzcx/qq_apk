  ...
  extends afwy
{
  ...
  public aiqe(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    this.jdField_a_of_type_Aiqh = new aiqh(this, null);
  ...
  public void a(aiqg paramaiqg)
  {
    this.jdField_a_of_type_Aiqg = paramaiqg;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    View localView = ((afxi)localObject).a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Aiqh);
    if (localView != null) {
