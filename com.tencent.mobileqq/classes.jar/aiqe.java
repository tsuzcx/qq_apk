...
public class aiqe
{
  ...
  public static final Point a(Activity paramActivity, int paramInt)
  {
    ...
    for (int i = localDisplayMetrics.widthPixels;; i = localDisplayMetrics.heightPixels) {
      ...
      {
      default: 
        paramInt = i - aepi.a(65.0F, paramActivity.getResources());
  ...
  public static String a()
  {
    ...
    if (bdep.a())
    {
      localStringBuilder.append(alof.cU).append("tmp/").append(System.currentTimeMillis()).append("_photo.tmp");
  ...
  {
    if (paramInt == 0) {
      return paramContext.getString(2131719807);
    }
    if (paramInt == 1) {
      return paramContext.getString(2131696563);
    }
    if (paramInt == 2) {
      return paramContext.getString(2131696562);
    }
    if (paramInt == 3) {
      return paramContext.getString(2131696564);
    }
    if (paramInt == 5) {
      return paramContext.getString(2131696561);
    }
    if (paramInt == 100) {
      return paramContext.getString(2131696545);
    }
    if (paramInt == 101) {
      return paramContext.getString(2131696546);
    }
    if (paramInt == 102) {
      return paramContext.getString(2131696543);
    }
    if (paramInt == 103) {
      return paramContext.getString(2131696547);
    }
    if (paramInt == 1793) {
      return paramContext.getString(2131693619);
    }
    return paramContext.getString(2131696560);
  }
  
  public static String a(List<ainn> paramList, TroopInfo paramTroopInfo)
  {
    String str = ainn.a;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localTroopClipPic.type == 1) {
        ...
        paramList.add(ainn.a(localTroopClipPic, paramTroopInfo.mTroopVerifyingPics));
      }
    }
    if (com.tencent.TMG.utils.QLog.isColorLevel()) {
  ...
  public static URL a(String paramString)
  {
    ...
    do
    {
      ...
      try
      {
        paramString = bauz.a(paramString);
        return paramString;
      }
  ...
  public static void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    URL localURL = a(bckq.b(bckq.a(str, paramString2, 1)));
    if (localURL != null)
    {
      paramInt = a(paramString1, baqn.d(localURL.toString()));
      if (com.tencent.TMG.utils.QLog.isColorLevel()) {
        com.tencent.TMG.utils.QLog.d("TroopPhotoUtil", 0, "cacheFileFromLocal origin photo,result:" + paramInt);
      }
    }
    paramString2 = a(bckq.a(bckq.a(str, paramString2, 1)));
    if (paramString2 != null)
    {
      paramInt = b(paramString1, baqn.d(paramString2.toString()));
      if (com.tencent.TMG.utils.QLog.isColorLevel()) {
  ...
  public static final void a(Rect paramRect, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if ((paramString.length == 4) && (awni.a(paramString[0])) && (awni.a(paramString[1])) && (awni.a(paramString[2])) && (awni.a(paramString[3])))
      {
  ...
  public static int b(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      BitmapFactory.Options localOptions = bdhj.a(((File)localObject).getPath(), 100);
      try
      {
        localObject = bdhj.a(((File)localObject).getPath(), localOptions);
      ...
      try
      {
        int i = bcpx.a(paramString1);
        paramString1 = (String)localObject;
        if (i != 0) {
          paramString1 = bdhj.b((Bitmap)localObject, i);
        }
        if (paramString1 != null)
        {
          bdhj.a(paramString1, paramString2);
          return 0;
        }
      }
