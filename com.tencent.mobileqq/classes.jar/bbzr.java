...
{
  private static Comparator<bbzg> jdField_a_of_type_JavaUtilComparator = new bbzu();
  private static final ThreadPoolExecutor jdField_a_of_type_JavaUtilConcurrentThreadPoolExecutor = new ThreadPoolExecutor(0, 3, 5L, TimeUnit.SECONDS, new LinkedBlockingQueue(128), new bbzs());
  private static Comparator<bbzg> jdField_b_of_type_JavaUtilComparator = new bbzv();
  private final int jdField_a_of_type_Int = 300;
  private bbzw jdField_a_of_type_Bbzw;
  private String jdField_a_of_type_JavaLangString;
  private List<? extends bbzg> jdField_a_of_type_JavaUtilList;
  private ExecutorService jdField_a_of_type_JavaUtilConcurrentExecutorService;
  boolean jdField_a_of_type_Boolean = false;
  private String jdField_b_of_type_JavaLangString;
  private List<Future<List<bbzg>>> jdField_b_of_type_JavaUtilList;
  private List<bbzg> c;
  
  public bbzr(String paramString1, String paramString2, List<? extends bbzg> paramList, bbzw parambbzw)
  {
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_b_of_type_JavaLangString = paramString2;
    this.jdField_a_of_type_JavaUtilList = paramList;
    this.jdField_a_of_type_Bbzw = parambbzw;
    this.jdField_a_of_type_JavaUtilConcurrentExecutorService = Executors.newFixedThreadPool(20);
    this.jdField_b_of_type_JavaUtilList = new ArrayList();
    this.c = new ArrayList();
  }
  
  private void a(List<bbzg> paramList, String paramString)
  {
    ...
    for (int i = 20;; i = paramList.size())
    {
      ...
      while (j < i)
      {
        bbzf localbbzf = (bbzf)paramList.get(j);
        if (QLog.isColorLevel()) {
          QLog.d("SearchTask", 2, "printSearchResultData " + paramString + "matchDegree : " + localbbzf.c() + " message time : " + localbbzf.Y);
        }
        j += 1;
      }
    }
      ...
      for (;;)
      {
        try
        {
          ...
          if ((i >= this.jdField_b_of_type_JavaUtilList.size()) || (isCancelled()))
          {
            ...
            break label91;
            label178:
            paramVarArgs = this.jdField_a_of_type_JavaUtilConcurrentExecutorService.submit(new bbzt(this, n, j));
        ...
        catch (InterruptedException paramVarArgs)
        {
          ...
          return null;
          if (((bbzg)this.c.get(j)).c() >= localbbzg.c()) {
            continue;
          }
          this.c.set(j, localbbzg);
          continue;
        }
        ...
        {
          localbbzg = (bbzg)localIterator.next();
          if (!isCancelled())
          {
            j = this.c.indexOf(localbbzg);
            if (-1 != j) {
              continue;
            }
            this.c.add(localbbzg);
          }
        }
      }
    }
  ...
  protected void a(Void paramVoid)
  {
    ...
    while (this.jdField_a_of_type_Bbzw == null) {
      return;
    }
    int i = 1;
    ...
    this.jdField_a_of_type_Bbzw.a(i, this.c);
    this.jdField_a_of_type_JavaUtilConcurrentExecutorService.shutdown();
  }
  
  protected void a(List<bbzg> paramList)
  {
