  ...
  implements Manager, uqm
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = uqn.a("StorySvc.video_config_get");
    jdField_b_of_type_JavaLangString = uqn.a("StorySvc.video_config_set");
    jdField_c_of_type_JavaLangString = uqn.a("StorySvc.video_get_user_mask_list");
    jdField_d_of_type_JavaLangString = uqn.a("StorySvc.video_set_user_mask");
    jdField_e_of_type_JavaLangString = uqn.a("StorySvc.video_get_user_mask_states");
    jdField_f_of_type_JavaLangString = uqn.a("StorySvc.video_show_video_list");
  }
  
  public ulu(AppInterface paramAppInterface)
  {
  ...
  public QQStoryUserInfo a(String paramString)
  {
    ...
    do
    {
      ...
      localQQStoryUserInfo = (QQStoryUserInfo)this.jdField_a_of_type_Awgf.a(QQStoryUserInfo.class, paramString);
      localObject = localQQStoryUserInfo;
    } while (localQQStoryUserInfo == null);
  ...
  public List<QQStoryUserInfo> a(boolean paramBoolean)
  {
    ...
    {
      Bosses.get().postJob(new ulv(this, "QQStoryManager", paramBoolean));
      return localList;
  ...
  public void a()
  {
    ...
    b(bdne.h(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin()));
    this.jdField_a_of_type_Uul = new uul(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
  }
  ...
  public List<QQStoryUserInfo> b(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      localList = this.jdField_a_of_type_Awgf.a(QQStoryUserInfo.class, true, (String)localObject, new String[] { "1" }, null, null, null, null);
      if (!paramBoolean) {
        break label122;
      }
      this.jdField_b_of_type_JavaUtilList = new ArrayList();
