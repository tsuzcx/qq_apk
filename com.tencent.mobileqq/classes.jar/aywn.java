  ...
  extends ayog
{
  ...
  public aywn(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  private File a(String paramString, DownloadParams paramDownloadParams)
  {
    if ((paramDownloadParams.url != null) && (!TextUtils.isEmpty(paramDownloadParams.url.getFile())))
    {
      ...
      {
        str1 = str1;
        str1 = ajsf.aW + paramString + str1 + File.separator + str2;
      ...
      paramDownloadParams = new bbwg(paramDownloadParams, paramString);
      paramDownloadParams.e = anvs.b;
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        paramURLDrawableHandler = anqu.a(3, paramOutputStream);
      ...
      for (;;)
      {
        try
        {
          ...
          {
            return localObject2;
            paramURLDrawableHandler = anqu.a(4, paramOutputStream);
            break label195;
          }
          if (!bool1) {
            continue;
          ...
          paramOutputStream = anqu.b(3, paramOutputStream);
        }
        ...
        localObject2 = new bbwg(paramURLDrawableHandler, (File)localObject1);
        ((bbwg)localObject2).e = anvs.b;
        if (bbwi.a((bbwg)localObject2, null) != 0) {
          break;
        }
        if (((paramDownloadParams.mExtraInfo instanceof aoau)) && (("FAVORITE_PANEL_THUMB".equals(str)) || ("FAVORITE_PANEL_THUMB_NEW".equals(str)))) {
          a((aoau)paramDownloadParams.mExtraInfo);
        }
        if (QLog.isColorLevel()) {
          QLog.i("VasExtensionDownloader", 2, "download sucessful " + paramURLDrawableHandler + " to path " + paramOutputStream);
        }
        return localObject1;
        paramOutputStream = anqu.b(17, paramOutputStream);
        continue;
        if (!((Boolean)localObject1).booleanValue()) {
          paramOutputStream = anqu.b(4, paramOutputStream);
        } else {
          paramOutputStream = anqu.b(18, paramOutputStream);
        }
      }
      if (("FAVOROTE_PANEL_DYNAMIC".equals(str)) || ("BUSINESS_CAMERA_EMO_PANEL_DYNAMIC".equals(str)))
      {
        ...
        if ((paramDownloadParams.mExtraInfo instanceof aoau))
        {
          localObject1 = ((aoau)paramDownloadParams.mExtraInfo).e;
        ...
        {
          break label256;
          if ((paramDownloadParams.mExtraInfo instanceof anxq))
          {
            localObject1 = ((anxq)paramDownloadParams.mExtraInfo).e;
            paramURLDrawableHandler = (URLDrawableHandler)localObject1;
            if (QLog.isColorLevel())
            {
              QLog.i("VasExtensionDownloader", 2, String.format("File path %s is not exits, now need download %s", new Object[] { paramOutputStream, localObject1 }));
      ...
      if (("FAVORITE_PANEL_THUMB".equals(str)) || ("FAVORITE_PANEL_THUMB_NEW".equals(str)))
      {
        ...
        localObject2 = ((aoau)paramDownloadParams.mExtraInfo).e;
      ...
      for (paramURLDrawableHandler = (URLDrawableHandler)localObject2;; paramURLDrawableHandler = null)
      {
        ...
        if ("BUSINESS_CAMERA_EMO_PANEL_THUMB".equals(str))
        {
          ...
          localObject2 = ((anxq)paramDownloadParams.mExtraInfo).e;
          paramURLDrawableHandler = (URLDrawableHandler)localObject2;
          localObject1 = paramOutputStream;
          if (QLog.isColorLevel())
          {
        ...
        for (paramURLDrawableHandler = (URLDrawableHandler)localObject2;; paramURLDrawableHandler = null)
        {
          ...
          if ("REDPACKET_SEND_PIC".equals(str))
          {
            ...
            catch (Throwable paramOutputStream)
            {
              ...
              paramOutputStream = (ajzf)paramOutputStream.getManager(131);
            }
          ...
          if (("COMMERCIAL_DRAINAGE".equals(str)) || ("IP_SITE_IMAGE".equals(str)))
          {
            ...
            for (int i = 22;; i = 23)
            {
              paramDownloadParams = anqu.a(i, paramURLDrawableHandler, MD5.toMD5(paramDownloadParams.url.getFile()));
              if (QLog.isColorLevel()) {
            ...
            paramOutputStream = new bbwg(paramOutputStream, paramDownloadParams);
            paramOutputStream.e = anvs.b;
            if (bbwi.a(paramOutputStream, null) != 0) {
              break;
            }
            return paramDownloadParams;
          }
  ...
  public void a(aoau paramaoau)
  {
    if (paramaoau == null) {
      return;
    }
    ThreadManager.post(new VasExtensionDownloader.1(this, paramaoau), 5, null, false);
  }
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    //   242: astore_3
    //   243: aload_3
    //   244: invokestatic 444	anqu:b	(Ljava/lang/String;)Z
    //   247: ifeq +52 -> 299
    ...
    //   331: aload_3
    //   332: invokestatic 457	anqu:b	(Ljava/lang/String;)[B
    //   335: astore_1
    //   336: aload_1
    //   337: ifnull +92 -> 429
    //   340: aconst_null
    ...
    //   765: invokespecial 525	aywo:<init>	(Laywn;Ljava/io/File;ZF)V
    //   768: astore_1
    //   769: aload_1
    //   770: areturn
    //   771: astore_1
    ...
    //   874: invokestatic 550	bbdr:a	(Landroid/graphics/BitmapFactory$Options;II)I
    ...
    //   976: invokevirtual 560	aywn:a	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   979: areturn
    //   980: aload 6
    ...
    //   1595: aload_0
    //   1596: aload_2
    //   1597: invokespecial 595	aywn:a	(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   1600: areturn
    //   1601: astore_1
    //   1602: ldc 181
    //   1604: iconst_1
    ...
    //   1679: aload_2
    //   1680: iconst_1
    //   1681: invokespecial 18	aywn:a	(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
    //   1684: areturn
    //   1685: ldc_w 386
    //   1688: aload_3
    ...
    //   1726: aload_2
    //   1727: aload_0
    //   1728: getfield 13	aywn:a	Lcom/tencent/common/app/BaseApplicationImpl;
    ...
    //   1761: aload_2
    //   1762: invokestatic 624	bawu:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   1765: areturn
    //   1766: aload 6
    //   1768: areturn
  ...
  public JobQueue getQueue(URL paramURL)
  {
    try
    {
      ...
      paramURL = (anvs)((QQAppInterface)BaseApplicationImpl.getApplication().getAppRuntime(paramURL)).getManager(43);
      if (paramURL != null) {
        return paramURL.a;
      }
    }
