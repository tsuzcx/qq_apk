  ...
  implements BadcaseReportUtils.ReportItemData
{
  ...
  {
    if (paramBoolean) {}
    for (BadcaseReportUtils.ENABLE_REPORT = awll.h();; BadcaseReportUtils.ENABLE_REPORT = false)
    {
      BadcaseReportUtils.sTotalReportNumber = awll.c();
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(Bitmap paramBitmap, String paramString, int paramInt)
  {
    ...
    //   26: iload_3
    //   27: ireturn
    //   28: new 189	java/io/File
    //   31: dup
    //   32: aload_1
    //   33: invokespecial 192	java/io/File:<init>	(Ljava/lang/String;)V
    //   36: astore_1
    //   37: aload_1
    //   38: invokevirtual 195	java/io/File:exists	()Z
    //   41: ifeq +8 -> 49
    //   44: aload_1
    //   45: invokevirtual 198	java/io/File:delete	()Z
    //   48: pop
    //   49: aload_1
    //   50: invokevirtual 201	java/io/File:createNewFile	()Z
    //   53: pop
    //   54: new 203	java/io/FileOutputStream
    //   57: dup
    //   58: aload_1
    //   59: invokespecial 206	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   62: astore_1
    //   63: aload_1
    //   64: astore 5
    //   66: aload 7
    //   68: astore 6
    //   70: new 208	java/io/BufferedOutputStream
    //   73: dup
    //   74: aload_1
    //   75: sipush 20480
    //   78: invokespecial 211	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   81: astore 7
    //   83: aload_0
    //   84: getstatic 217	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   87: iload_2
    //   88: aload 7
    //   90: invokevirtual 223	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   93: istore_3
    //   94: iload_3
    //   95: istore 4
    //   97: aload 7
    //   99: ifnull +13 -> 112
    //   102: aload 7
    //   104: invokevirtual 228	java/io/OutputStream:flush	()V
    //   107: aload 7
    //   109: invokevirtual 231	java/io/OutputStream:close	()V
    //   112: iload 4
    //   114: istore_3
    //   115: aload_1
    //   116: ifnull -90 -> 26
    //   119: aload_1
    //   120: invokevirtual 232	java/io/FileOutputStream:close	()V
    //   123: iload 4
    //   125: ireturn
    //   126: astore_0
    //   127: iload 4
    ...
    //   142: astore 6
    //   144: aload_0
    //   145: invokevirtual 235	java/io/FileNotFoundException:printStackTrace	()V
    //   148: aload 7
    //   150: ifnull +13 -> 163
    //   153: aload 7
    //   155: invokevirtual 228	java/io/OutputStream:flush	()V
    //   158: aload 7
    //   160: invokevirtual 231	java/io/OutputStream:close	()V
    //   163: iload 4
    //   165: istore_3
    //   166: aload_1
    //   167: ifnull -141 -> 26
    //   170: aload_1
    //   171: invokevirtual 232	java/io/FileOutputStream:close	()V
    //   174: iconst_0
    //   175: ireturn
    //   176: astore_0
    //   177: iconst_0
    ...
    //   184: ifnull +13 -> 197
    //   187: aload 6
    //   189: invokevirtual 228	java/io/OutputStream:flush	()V
    //   192: aload 6
    //   194: invokevirtual 231	java/io/OutputStream:close	()V
    //   197: aload_1
    //   198: ifnull +7 -> 205
    //   201: aload_1
    //   202: invokevirtual 232	java/io/FileOutputStream:close	()V
    //   205: aload_0
    //   206: athrow
    //   207: astore_0
    //   208: iconst_0
  ...
  private static void b(BadcaseReportUtils.BadDataFrame paramBadDataFrame, String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    File localFile = new File(paramBadDataFrame.zipPath);
    ...
    try
    {
      ...
      localObject = localHttpURLConnection;
      localStringBuilder.append(paramBadDataFrame.problemType);
      localObject = localHttpURLConnection;
      localStringBuilder.append("\r\n");
      localObject = localHttpURLConnection;
      localStringBuilder.append("--").append(paramString1).append("\r\n");
      ...
      localObject = localHttpURLConnection;
      localStringBuilder.append(BadcaseReportUtils.BadDataItem.getErrMsg(paramBadDataFrame.problemType));
      localObject = localHttpURLConnection;
      localStringBuilder.append("\r\n");
      localObject = localHttpURLConnection;
      localStringBuilder.append("--").append(paramString1).append("\r\n");
  ...
  {
    Object localObject = new StringBuilder(ajed.aU);
