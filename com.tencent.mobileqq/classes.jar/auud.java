...
public class auud
{
  public static Drawable a(Resources paramResources, int paramInt)
  {
    ...
    if (paramInt == 0) {
      localDrawable = bcpx.a(paramResources, paramResources.getColor(2131166168));
    }
    while (paramInt != 1) {
      return localDrawable;
    }
    return bcpx.a(paramResources, paramResources.getColor(2131166166));
  }
  ...
  public static String a(int paramInt)
  {
    ...
    default: 
      return aluj.c;
    case 2: 
      return alud.a(2131705992);
    case 4: 
      return alud.a(2131705990);
    case 5: 
      return alud.a(2131705991);
    }
    return alud.a(2131705993);
  }
  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if (!bool)
    {
      ...
      if ((localObject1 != null) && (((alto)localObject1).b(paramString2))) {
        i = 1;
      }
    }
    for (;;)
  ...
  public static void a(ayzr paramayzr, long paramLong, String paramString, int paramInt)
  {
    boolean bool;
    switch (paramInt)
    {
    ...
    {
      if (bool) {
        paramayzr.a(0, paramString, paramLong, 1);
      }
      if (QLog.isColorLevel()) {
        auwz.a("PttShow", new Object[] { "addLocalMaxMsgSeq", String.format("needUpdateLocal:%b\tfrom:%d\t msgSeq:%d", new Object[] { Boolean.valueOf(bool), Integer.valueOf(paramInt), Long.valueOf(paramLong) }) });
      }
      return;
      long l = paramayzr.a(0, paramString);
      if (1L + l == paramLong)
      {
        bool = true;
      }
      else
      {
        ...
        auwz.a("PttShow", new Object[] { "addLocalMaxMsgSeq", String.format("not continuous seq local:%d\tmsgseq:%d\tfrom:%d", new Object[] { Long.valueOf(l), Long.valueOf(paramLong), Integer.valueOf(paramInt) }) });
        bool = false;
        continue;
        bool = true;
      }
  ...
  public static void a(HotChatInfo paramHotChatInfo, QQAppInterface paramQQAppInterface, Activity paramActivity, int paramInt)
  {
    ...
    localIntent.putExtra("url", bhsz.a(bhsz.a(bhsz.a(bhsz.a(bhsz.a("http://nearby.qq.com/hot_chat/member_list.html?_wv=3&_bid=2581", "_wv", "3"), "_bid", "2581"), "gc", paramHotChatInfo.troopUin), "rid", paramHotChatInfo.uuid), "from", String.valueOf(0)));
    ...
    if (paramInt == 0) {
      alxn.a(paramQQAppInterface, "0X800638B");
    }
    while (paramInt != 1) {
      return;
    }
    alxn.a(paramQQAppInterface, "0X800638C");
  }
