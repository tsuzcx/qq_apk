...
import cooperation.qzone.webviewplugin.QzoneWidgetAIJsPlugin.1;
import cooperation.qzone.webviewplugin.QzoneWidgetAIJsPlugin.2;
import cooperation.qzone.webviewplugin.QzoneWidgetAIJsPlugin.3;
  ...
  extends bgix
{
  ...
  {
    BitmapFactory.Options localOptions = bcdo.a();
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          localObject1 = bglz.a((Bitmap)localObject2, bglz.a(m + 8, j + 8), k - 4, n - 4, 1);
          if (localObject1 != null)
          {
            paramJSONObject = bglz.a((Bitmap)localObject1, paramJSONObject, k, n, 1);
            if (paramJSONObject == null)
            {
    ...
    ThreadManager.executeOnSubThread(new QzoneWidgetAIJsPlugin.2(this, i, bglz.a("QzoneShowShare" + a() + ".png", paramJSONObject, this.a.mRuntime.a()), str));
  }
  ...
  private void a(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      ThreadManager.executeOnSubThread(new QzoneWidgetAIJsPlugin.3(this, paramVarArgs[0]));
  ...
  public boolean a(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ThreadManager.executeOnSubThread(new QzoneWidgetAIJsPlugin.1(this, paramJsBridgeListener));
        return true;
      }
        ...
        if ("WidgetAIInfoUpdate".equalsIgnoreCase(paramString3))
        {
          ...
          try
          {
            if (paramVarArgs.length > 0)
            {
              ...
              bgbz.a().a().a(Boolean.valueOf(bool1));
              return true;
            }
          }
          catch (Exception paramJsBridgeListener)
    ...
    if ("SetQuickCommentState".equalsIgnoreCase(paramString3)) {
      try
      {
        bgbz.a().a().b(Boolean.valueOf(true));
        return true;
      }
      catch (Exception paramJsBridgeListener)
      {
