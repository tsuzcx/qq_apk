...
public class bqhy
{
  ...
  public static String a(List<bqhy> paramList)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    paramList = paramList.iterator();
    while (paramList.hasNext()) {
      localStringBuilder.append(((bqhy)paramList.next()).a()).append(";");
    }
    return localStringBuilder.toString();
  }
  
  public static List<bqhy> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      break;
      label56:
      bqhy localbqhy = new bqhy();
      localbqhy.a(localCharSequence);
      localArrayList.add(localbqhy);
    }
  }
