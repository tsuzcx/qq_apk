...
public class axkf
{
  ...
  private final String jdField_a_of_type_JavaLangString = axkf.class.getSimpleName();
  private final List<axki> jdField_a_of_type_JavaUtilList = new CopyOnWriteArrayList();
  ...
  private axki a(NowQQLiveHomepageProto.RcmdAnchor paramRcmdAnchor)
  {
    boolean bool2 = true;
    axki localaxki = new axki();
    localaxki.j = paramRcmdAnchor.string_head_img_url.get();
    localaxki.jdField_b_of_type_JavaLangString = paramRcmdAnchor.string_room_img_url.get();
    localaxki.jdField_b_of_type_Int = paramRcmdAnchor.hall_room_id.get();
    localaxki.jdField_c_of_type_JavaLangString = paramRcmdAnchor.string_name.get();
    localaxki.jdField_c_of_type_Int = paramRcmdAnchor.uint32_watch_count.get();
    localaxki.jdField_d_of_type_JavaLangString = paramRcmdAnchor.string_location.get();
    localaxki.jdField_f_of_type_JavaLangString = paramRcmdAnchor.string_id.get();
    localaxki.jdField_a_of_type_Long = paramRcmdAnchor.imsdk_tiny_id.get();
    localaxki.m = paramRcmdAnchor.rtmp_url.get();
    boolean bool1;
    ...
    for (;;)
    {
      localaxki.jdField_b_of_type_Boolean = bool1;
      if (paramRcmdAnchor.video_preview.get() == 1)
      {
        bool1 = bool2;
        localaxki.jdField_c_of_type_Boolean = bool1;
        localaxki.jdField_d_of_type_Int = paramRcmdAnchor.microphone_flag.get();
        localaxki.jdField_g_of_type_JavaLangString = paramRcmdAnchor.icon_url.get();
        localaxki.jdField_a_of_type_JavaUtilList = paramRcmdAnchor.rich_title.elements.get();
        localaxki.i = paramRcmdAnchor.string_description.get();
        localaxki.h = paramRcmdAnchor.award_pendant_url.get();
        if (paramRcmdAnchor.extra_info.has())
        {
          ...
          if ((localUserExtraInfo.medal_info_list.has()) && (localUserExtraInfo.medal_info_list.get() != null) && (localUserExtraInfo.medal_info_list.size() > 0)) {
            localaxki.a(localUserExtraInfo.medal_info_list.get());
          }
        }
        localaxki.jdField_e_of_type_Int = paramRcmdAnchor.user_tag.color.get();
      }
      try
      {
        if (!TextUtils.isEmpty(paramRcmdAnchor.user_tag.change_color.get())) {
          localaxki.jdField_f_of_type_Int = Integer.parseInt(paramRcmdAnchor.user_tag.change_color.get(), 16);
        }
        localaxki.k = paramRcmdAnchor.user_tag.pic_url.get();
        localaxki.l = paramRcmdAnchor.user_tag.wording.get();
        localaxki.jdField_e_of_type_JavaLangString = paramRcmdAnchor.string_jump_url.get();
        localaxki.jdField_g_of_type_Int = paramRcmdAnchor.user_tag.type.get();
        localaxki.n = paramRcmdAnchor.advertising_sign.get();
        return localaxki;
        bool1 = false;
        continue;
        bool1 = false;
    ...
    for (;;)
    {
      ...
      case 0: 
        ...
        else
        {
          ...
          ((axki)localObject).jdField_a_of_type_JavaLangString = localRecommendItem.string_key.get();
          i = this.jdField_b_of_type_Int;
          this.jdField_b_of_type_Int = (i + 1);
          ((axki)localObject).jdField_a_of_type_Int = i;
          ((axki)localObject).o = localRcmdAnchor.union_channel_sign.get();
      ...
      case 5: 
        ...
        else
        {
          ...
          ((axki)localObject).jdField_a_of_type_Int = i;
          ((axki)localObject).o = localRcmdAnchor.union_channel_sign.get();
          QLog.d(this.jdField_a_of_type_JavaLangString, 2, "NewRcmdDataMgr, parseData()  Double----anchor_union_channel_sign = " + ((axki)localObject).o);
          this.jdField_a_of_type_JavaUtilList.add(localObject);
          continue;
  ...
  public void a(int paramInt, axkh paramaxkh, boolean paramBoolean)
  {
    ...
    localRecommendPageReq.device_id.set(biaq.c());
    localRecommendPageReq.qimei.set(UserAction.getQIMEI());
    axjq.a().a(1718, 100, localRecommendPageReq.toByteArray(), new axkg(this, paramInt, paramaxkh));
  }
  
  public void a(axkh paramaxkh)
  {
