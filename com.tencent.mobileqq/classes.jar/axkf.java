...
public class axkf
  extends axkc
{
  public axkf(QQPlayerService paramQQPlayerService) {}
  ...
  public void a(axjy paramaxjy)
  {
    ...
    try
    {
      ...
      QQPlayerService.a(this.a).register(paramaxjy);
      return;
    }
    finally {}
  }
  ...
  public void b(axjy paramaxjy)
  {
    if (QLog.isColorLevel()) {
      QLog.d("QQPlayerService", 2, "AIDL : unRegisterCallback");
    }
    if ((paramaxjy != null) && (QQPlayerService.a(this.a) != null)) {
      QQPlayerService.a(this.a).unregister(paramaxjy);
    }
  }
