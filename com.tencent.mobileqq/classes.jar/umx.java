...
public class umx
  extends Handler
{
  public umx(PressToChangeVoicePanel paramPressToChangeVoicePanel, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    else
    {
      ...
      Object localObject2 = (ListenChangeVoicePanel)this.a.f.findViewById(2131366408);
      ...
      paramMessage = (ViewGroup)((ListenChangeVoicePanel)localObject2).findViewById(2131369385);
      if (VersionUtils.e())
      {
        ...
        localAnimatorSet.addListener(new umy(this, paramMessage));
