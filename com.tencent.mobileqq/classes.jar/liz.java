  ...
  extends liq
{
  ...
  public liz(lgi paramlgi, boolean paramBoolean)
  {
    super(paramlgi, paramBoolean);
  ...
  protected void a(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    lbj.c("ARZimuTask_SpitZimuItemTask", "onDraw width = " + paramInt1);
    float f = -this.jdField_a_of_type_AndroidGraphicsPaint.getFontMetrics().ascent;
    String str2 = this.jdField_a_of_type_Lgi.a.toString();
    String str1 = str2;
    if (str2.length() > 10) {
    ...
    int j = str1.length();
    str1 = str1 + str2;
    lbj.c("ARZimuTask_SpitZimuItemTask", "onDraw showText = " + str1);
    ...
    while (paramInt2 < paramInt1)
    {
      ...
      liw.a(this.jdField_a_of_type_AndroidGraphicsPaint, this.jdField_a_of_type_AndroidTextTextPaint);
    ...
    lbj.c("ARZimuTask_SpitZimuItemTask", "onDraw offsetX = " + i);
  }
  
  public void a(Typeface paramTypeface, int paramInt, mos parammos)
  {
    super.a(paramTypeface, paramInt, parammos);
