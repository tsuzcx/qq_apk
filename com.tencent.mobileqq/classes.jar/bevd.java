...
public class bevd
{
  ...
  private static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, bevo parambevo, int paramInt)
  {
    paramActivity = new FreeWifiHelper.5(paramActivity, paramString1, paramString2, paramString3, paramString4, new bevh(paramInt, paramActivity, parambevo), new bevi(parambevo, paramInt), new bevj(parambevo, paramInt), paramInt);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = bevt.a(localBaseApplication, str);
        if (QLog.isColorLevel()) {
      ...
      return;
      long l = bevt.c(localBaseApplication, str);
    ...
    Object localObject = new ambh(paramQQAppInterface);
    ambi localambi = new ambi(paramQQAppInterface);
    localambi.a(new bevf(paramQQAppInterface, localambi));
    paramQQAppInterface.addObserver(localambi);
    ((ambh)localObject).a(2);
    bevt.c(localBaseApplication, str, System.currentTimeMillis());
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, ConfigurationService.Config paramConfig)
  {
    ...
    int j = bdiv.a(paramQQAppInterface.getApp(), "wifi_connect_config_version", str);
    if (QLog.isColorLevel()) {
    ...
    if (i != j)
    {
      bdiv.a(paramQQAppInterface.getApp(), "wifi_connect_config_version", str, i);
      paramConfig = aova.b(paramConfig, j, paramInt);
      if (!TextUtils.isEmpty(paramConfig))
      {
        ...
        try
        {
          ...
          {
            e = bool;
            bdiv.a(paramQQAppInterface.getApp(), paramQQAppInterface.c(), c, d, e);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    try
    {
      if (((d) || (e)) && (Conversation.b > 0L))
      {
        ...
        long l2 = bevt.a((Context)localObject, str);
        long l3 = bevt.b((Context)localObject, str) * 60 * 60 * 1000L;
        if (QLog.isColorLevel()) {
        ...
        bevt.a((Context)localObject, str, l1);
        ambh localambh = new ambh(paramQQAppInterface);
        ambi localambi = new ambi(paramQQAppInterface);
        localambi.a(new beve((Context)localObject, str, paramQQAppInterface, localambi));
        paramQQAppInterface.addObserver(localambi);
        localambh.a(1);
      }
    }
  ...
  public static boolean a(Activity paramActivity, int paramInt, bevo parambevo)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        str1 = paramActivity.getString(2131692800);
        str2 = paramActivity.getString(2131692803);
        i = 1;
      }
      while (i != 0)
      {
        String str5 = paramActivity.getString(2131692806);
        String str4 = bevt.a(paramActivity);
        String str3 = str4;
        if (TextUtils.isEmpty(str4)) {
          str3 = paramActivity.getString(2131692799);
        }
        QLog.i("WifiSdk", 2, "shouldOverrideDialog btn1Text: " + str3);
        a(paramActivity, str5, str1, str3, str2, parambevo, paramInt);
        return false;
        ...
        {
          str1 = paramActivity.getString(2131692801);
          str2 = paramActivity.getString(2131692804);
          i = 1;
        }
        else if (paramInt == 5)
        {
          str1 = paramActivity.getString(2131692755);
          str2 = paramActivity.getString(2131692805);
          i = 1;
        }
        else
  ...
  public static boolean a(Context paramContext)
  {
    ...
    try
    {
      ...
      if (!TMSDKWifiManager.init(paramContext.getApplicationContext(), new TMSDKCustomConfig().setCustomToast(new bevn()).setCustomInstaller(new bevm()).setCustomThreadPool(new bevl()).setCustomReporter(new bevk()))) {
        bool = true;
      }
      b = bool;
      WifiSDKUIApi.init(new bevq(), new bevr());
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      str = paramQQAppInterface.getCurrentAccountUin();
      localBaseApplication = paramQQAppInterface.getApp();
      long l = bevt.b(localBaseApplication, str);
      if ((l == -1L) || (System.currentTimeMillis() - l >= 86400000L)) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    ambh localambh = new ambh(paramQQAppInterface);
    ambi localambi = new ambi(paramQQAppInterface);
    localambi.a(new bevg(paramQQAppInterface, localambi));
    paramQQAppInterface.addObserver(localambi);
    localambh.a(3);
    bevt.b(localBaseApplication, str, System.currentTimeMillis());
  }
  ...
  public static void c(Context paramContext, int paramInt)
  {
    ...
    bevs localbevs = bevs.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
    if (QLog.isColorLevel()) {
      QLog.i("WifiSdk", 2, "dialog click, jumpType: " + localbevs.jdField_a_of_type_Int + " jumpUrl: " + localbevs.jdField_a_of_type_JavaLangString);
    }
    if (WifiSDKUIApi.isWiFiManagerExist())
    {
      if (localbevs.jdField_a_of_type_Int == 4)
      {
    ...
    switch (localbevs.jdField_a_of_type_Int)
    {
    case 4: 
    default: 
      a(paramContext, paramInt);
      ...
      return;
    case 1: 
      a(paramContext, localbevs.jdField_a_of_type_JavaLangString);
