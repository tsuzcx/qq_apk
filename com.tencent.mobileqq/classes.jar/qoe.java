...
public abstract class qoe
{
  ...
  oxe jdField_a_of_type_Oxe = new qof(this);
  ...
  private void a(Bundle paramBundle, qxn paramqxn, int paramInt)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("video_bit_rate", Long.valueOf(paramqxn.b()).toString());
      ((JSONObject)localObject).put("video_capacity", Long.valueOf(paramqxn.a()).toString());
      ...
      nrt.a(null, "", "0X80093D4", "0X80093D4", 0, 0, "", "", "", ((JSONObject)localObject).toString(), false);
      return;
    }
  ...
  public void a(boolean paramBoolean, Context paramContext, Bundle paramBundle, qxn paramqxn, qog paramqog)
  {
    String str1 = paramqxn.a();
    String str2 = paramqxn.b();
    String str3 = paramqxn.c();
    String str4 = paramqxn.d();
    String str5 = paramqxn.e();
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Qog = paramqog;
    if (paramBundle == null) {}
