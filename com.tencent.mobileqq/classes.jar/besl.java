...
public final class besl
{
  ...
  public besl(cmd0x383.ApplyGetFileListRspBody.FileInfo paramFileInfo)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public besl(group_file_common.FolderInfo paramFolderInfo)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public besl(oidb_0x6d8.GetFileListRspBody.Item paramItem)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  {
    String str = bgsu.b(paramContext, paramLong);
    paramContext = str;
    int i1;
    int i2;
    if (str != null)
    ...
    for (;;)
    {
      ...
      try
      {
        if (this.n == null)
        {
          ...
          if (i1 != 0)
          {
            this.n = bglf.a(paramQQAppInterface, b(), paramLong + "", 1, 0);
            if (this.n.length() <= 10)
            {
              i1 = i5;
              break label307;
  ...
  public String a()
  {
    return bfsj.a(this.jdField_a_of_type_Long);
  }
  
  public String a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    return bglf.a(paramQQAppInterface, b(), paramLong + "", 1, 0);
  }
  ...
  public void a(besl parambesl)
  {
    if (parambesl != null)
    {
      if ((parambesl.jdField_e_of_type_Int != 8) && (parambesl.jdField_e_of_type_Int != 9)) {
        break label45;
      }
      if (parambesl.jdField_b_of_type_JavaLangString != null) {
        this.jdField_a_of_type_JavaUtilMap.put(parambesl.jdField_b_of_type_JavaLangString, parambesl);
      }
    }
    label45:
    while (((parambesl.jdField_e_of_type_Int != 11) && (parambesl.jdField_e_of_type_Int != 10) && (parambesl.jdField_e_of_type_Int != 12)) || (parambesl.jdField_b_of_type_JavaLangString == null)) {
      return;
    }
    this.jdField_a_of_type_JavaUtilMap.remove(parambesl.jdField_b_of_type_JavaLangString);
  }
  
  public void a(bety parambety, QQAppInterface paramQQAppInterface)
  {
    this.jdField_i_of_type_JavaLangString = parambety.jdField_b_of_type_JavaLangString;
    this.j = parambety.jdField_c_of_type_JavaLangString;
    this.k = parambety.jdField_d_of_type_JavaLangString;
    this.jdField_e_of_type_Int = parambety.jdField_b_of_type_Int;
    this.jdField_h_of_type_JavaLangString = parambety.jdField_a_of_type_JavaLangString;
    this.jdField_d_of_type_Long = parambety.jdField_d_of_type_Long;
    this.jdField_f_of_type_Int = parambety.jdField_c_of_type_Int;
    this.jdField_c_of_type_Boolean = parambety.jdField_a_of_type_Boolean;
    if (this.jdField_b_of_type_Int == 0)
    {
      this.jdField_b_of_type_Int = parambety.jdField_d_of_type_Int;
      this.l = a(BaseApplicationImpl.getApplication(), this.jdField_b_of_type_Int * 1000L);
    }
    if (this.jdField_b_of_type_JavaLangString == null) {
      this.jdField_b_of_type_JavaLangString = parambety.jdField_e_of_type_JavaLangString;
    }
    if (this.jdField_f_of_type_JavaLangString == null) {
      this.jdField_f_of_type_JavaLangString = parambety.jdField_i_of_type_JavaLangString;
    }
    if (this.jdField_a_of_type_Long == 0L) {
      this.jdField_a_of_type_Long = parambety.jdField_c_of_type_Long;
    }
    if (this.jdField_c_of_type_JavaLangString == null) {
      this.jdField_c_of_type_JavaLangString = parambety.jdField_g_of_type_JavaLangString;
    }
    if ((this.jdField_a_of_type_Int == 0) || (besm.a(parambety.jdField_b_of_type_Int))) {
      this.jdField_a_of_type_Int = parambety.jdField_h_of_type_Int;
    }
    if ((this.jdField_b_of_type_Long == 0L) && (besm.a(parambety.jdField_b_of_type_Int))) {}
    try
    {
      this.jdField_b_of_type_Long = Long.parseLong(paramQQAppInterface.getCurrentAccountUin());
      return;
    }
    catch (NumberFormatException parambety)
    {
  ...
  {
    return (bfsj.a(paramQQAppInterface, paramLong)) && (this.jdField_d_of_type_Boolean);
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    ...
    boolean bool2 = bfsj.a(paramQQAppInterface, paramLong);
  ...
  public void b(besl parambesl)
  {
    ...
    this.jdField_b_of_type_Boolean = false;
    this.jdField_b_of_type_JavaLangString = parambesl.jdField_b_of_type_JavaLangString;
    this.jdField_f_of_type_JavaLangString = parambesl.jdField_f_of_type_JavaLangString;
    this.jdField_c_of_type_JavaLangString = parambesl.jdField_c_of_type_JavaLangString;
    this.jdField_a_of_type_Int = parambesl.jdField_a_of_type_Int;
    this.jdField_b_of_type_Long = parambesl.jdField_b_of_type_Long;
    this.jdField_c_of_type_Long = parambesl.jdField_c_of_type_Long;
    this.jdField_a_of_type_Long = parambesl.jdField_a_of_type_Long;
    this.jdField_b_of_type_Int = parambesl.jdField_b_of_type_Int;
    this.jdField_c_of_type_Int = parambesl.jdField_c_of_type_Int;
    this.jdField_i_of_type_Int = parambesl.jdField_i_of_type_Int;
    this.jdField_d_of_type_Int = parambesl.jdField_d_of_type_Int;
    this.jdField_e_of_type_JavaLangString = parambesl.jdField_e_of_type_JavaLangString;
    this.jdField_h_of_type_Int = parambesl.jdField_h_of_type_Int;
    this.jdField_d_of_type_JavaLangString = parambesl.jdField_d_of_type_JavaLangString;
    this.jdField_d_of_type_Boolean = parambesl.jdField_d_of_type_Boolean;
    this.l = parambesl.l;
    this.m = parambesl.m;
  }
  ...
  {
    return (bfsj.a(paramQQAppInterface, paramLong)) && (!this.jdField_d_of_type_Boolean) && (!paramBoolean) && (!besm.a(this.jdField_e_of_type_Int)) && (!besm.b(this.jdField_e_of_type_Int));
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject == null) || (!(paramObject instanceof besl))) {
      return false;
    }
