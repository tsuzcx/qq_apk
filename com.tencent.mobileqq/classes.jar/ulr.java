...
public class ulr
{
  ...
  public static int a(View paramView)
  {
    ...
    do
    {
      ...
      j = vms.d(paramView.getContext()) / 2;
    } while (i <= 0);
    int i = Math.min(Math.abs(j - arrayOfInt[1]), Math.abs(j - (arrayOfInt[1] + i)));
    urk.b("Q.qqstory.home.StoryListUtils", "getDistanceToCenterY=" + i);
    return i;
  }
  
  public static Bitmap a(Drawable paramDrawable, int paramInt1, int paramInt2, Map<String, Bitmap> paramMap, uld paramuld)
  {
    ...
    for (Bitmap localBitmap = (Bitmap)paramMap.get("w=" + paramInt1 + "h=" + paramInt2);; localBitmap = null)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            ulq.b("Q.qqstory.home.StoryListUtils", new Object[] { "drawable2Bitmap need create width=", Integer.valueOf(paramInt1), ",height=", Integer.valueOf(paramInt2) });
          ...
          urk.a("Q.qqstory.home.StoryListUtils", "drawable2Bitmap:width=%d,height=%d,cost time=%d", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(System.currentTimeMillis() - l));
          paramDrawable = (Drawable)localObject;
          if (paramuld == null) {
            break;
          }
          return paramuld.a((Bitmap)localObject);
        }
        catch (OutOfMemoryError paramDrawable)
        {
          label347:
          urk.e("Q.qqstory.home.StoryListUtils", "drawable2Bitmap out off memory width=" + paramInt1 + ",height=" + paramInt2);
          return null;
        }
      }
  ...
  public static String a(int paramInt, boolean paramBoolean)
  {
    ...
    default: 
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = ajjy.a(2131648661);
      }
      break;
    }
    do
    {
      return localObject2;
      localObject1 = ajjy.a(2131648662);
      break;
      localObject1 = ajjy.a(2131648660);
      break;
      localObject1 = ajjy.a(2131648689);
      break;
      localObject1 = ajjy.a(2131648653);
      break;
      localObject1 = ajjy.a(2131648650);
      break;
      localObject1 = ajjy.a(2131648686);
      break;
      localObject1 = ajjy.a(2131648664);
      break;
      localObject1 = ajjy.a(2131648654);
      break;
      localObject1 = ajjy.a(2131648675);
      break;
      localObject1 = ajjy.a(2131648676);
      break;
      localObject1 = ajjy.a(2131648691);
      break;
      localObject1 = ajjy.a(2131648671);
      break;
      localObject1 = ajjy.a(2131648690);
      break;
      localObject1 = ajjy.a(2131648684);
      break;
      localObject1 = ajjy.a(2131648669);
      break;
      localObject1 = ajjy.a(2131648668);
      break;
      localObject1 = ajjy.a(2131648658);
      break;
      localObject1 = ajjy.a(2131648685);
      break;
      localObject1 = ajjy.a(2131648649);
      break;
      localObject1 = ajjy.a(2131648655);
      break;
      localObject1 = ajjy.a(2131648663);
      break;
      localObject1 = ajjy.a(2131648672);
      break;
      localObject1 = ajjy.a(2131648683);
      break;
      localObject1 = ajjy.a(2131648667);
      break;
      localObject1 = ajjy.a(2131648680);
      break;
      localObject1 = ajjy.a(2131648651);
      break;
      localObject2 = localObject1;
    } while (!paramBoolean);
    return ajjy.a(2131648673) + (String)localObject1;
  }
  ...
  {
    Object localObject = ((sga)paramQQAppInterface.getManager(181)).a(false);
  ...
  public static void a(ArrayList<String> paramArrayList)
  {
    ...
    urk.b("Q.qqstory.home.StoryListUtils", "reportShieldFriendStory:" + paramArrayList.size());
    umb localumb = new umb();
    localumb.a = paramArrayList;
    sgi.a().dispatch(localumb);
  }
  ...
  public static int b(View paramView)
  {
    ...
    urk.b("Q.qqstory.home.StoryListUtils", "getDistanceToTop=" + i);
    return i;
  }
  ...
  public static String b(long paramLong)
  {
    ...
    if (m == i3) {
      return String.format(Locale.getDefault(), ajjy.a(2131648670), new Object[] { Integer.valueOf(n), Integer.valueOf(i1) });
    }
    localCalendar.setTimeInMillis(paramLong);
    localCalendar.add(6, 1);
    if (localCalendar.get(6) == i3) {
      return String.format(Locale.getDefault(), ajjy.a(2131648659), new Object[] { Integer.valueOf(n), Integer.valueOf(i1) });
    }
    if (i != i2) {
  ...
  public static int c(View paramView)
  {
    ...
    do
    {
      ...
      paramView.getLocationOnScreen(arrayOfInt);
      i = paramView.getHeight();
      j = vms.d(paramView.getContext());
    } while (i <= 0);
    int i = Math.min(Math.abs(j - arrayOfInt[1]), Math.abs(j - (arrayOfInt[1] + i)));
    urk.b("Q.qqstory.home.StoryListUtils", "getDistanceToBottom=" + i);
    return i;
  }
}
