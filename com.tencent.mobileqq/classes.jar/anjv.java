  ...
  implements Comparator<DiscussionMemberInfo>
{
  ...
  public anjv(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
  ...
  public int a(DiscussionMemberInfo paramDiscussionMemberInfo1, DiscussionMemberInfo paramDiscussionMemberInfo2)
  {
    ...
    do
    {
      do
      {
        ...
        paramDiscussionMemberInfo1 = bglf.a(paramDiscussionMemberInfo1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        paramDiscussionMemberInfo2 = bglf.a(paramDiscussionMemberInfo2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      if ((bgsp.b(paramDiscussionMemberInfo1.charAt(0))) && (bgsp.b(paramDiscussionMemberInfo2.charAt(0)))) {
        return paramDiscussionMemberInfo1.charAt(0) - paramDiscussionMemberInfo2.charAt(0);
      }
