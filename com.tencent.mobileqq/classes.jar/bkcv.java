  ...
  extends RemoteCommand
{
  ...
  public bkcv(QQAppInterface paramQQAppInterface)
  {
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramBundle)
      {
        ...
        azqs.b(this.a, "P_CliOper", "BizTechReport", "", "troop_member_card_plugin", "plugin_cmd_exp", 0, 0, paramBundle.getClass().getName(), null, null, null);
        return null;
      }
      ...
      bdgg.a().a(this.a, paramBundle, this.a.getCurrentAccountUin(), this.a.getApp());
      paramBundle = localBundle;
      continue;
      ...
      localObject1 = (alto)this.a.getManager(51);
      localObject2 = ((alto)localObject1).b(paramBundle);
      if ((localObject2 == null) || (!((Friends)localObject2).isFriend())) {
        break label1375;
      }
      paramBundle = ((alto)localObject1).a(paramBundle);
    ...
    for (long l1 = ayzl.a();; l1 = 0L)
    {
      ...
      if (bdeu.b(paramBundle)) {
        azqs.b(this.a, "dc00898", "", "", "0X8007FDF", "0X8007FDF", 0, 0, "", "", "", "");
      }
      ...
      break;
      paramBundle = paramBundle.getString("troopUin");
      ((amdu)this.a.a(20)).l(paramBundle);
      paramBundle = localBundle;
      break;
      paramBundle = paramBundle.getString("troopUin");
      ((amdu)this.a.a(20)).k(paramBundle);
      paramBundle = localBundle;
      break;
      localObject1 = paramBundle.getString("uin");
      paramBundle = "";
      localObject1 = ausj.a(this.a, (String)localObject1, false);
      if (localObject1 != null)
      {
        if (((autj)localObject1).a == 1L) {
          paramBundle = this.a.getApp().getString(2131693712);
        }
        for (;;)
        {
          i = ((autj)localObject1).c;
          localBundle.putString("bind_name", paramBundle);
          localBundle.putInt("bind_icon", i);
          paramBundle = localBundle;
          break;
          if (((autj)localObject1).a == 2L) {
            paramBundle = this.a.getApp().getString(2131693710);
          } else if (((autj)localObject1).a == 3L) {
            paramBundle = this.a.getApp().getString(2131693711);
          }
        }
      }
      label1375:
