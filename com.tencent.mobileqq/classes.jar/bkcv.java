...
public class bkcv
{
  private static bkcv jdField_a_of_type_Bkcv;
  ...
  private Downloader.DownloadListener jdField_a_of_type_ComTencentComponentNetworkDownloaderDownloader$DownloadListener = new bkcw(this);
  private final MultiHashMap<String, bkcx> jdField_a_of_type_CooperationQzoneUtilMultiHashMap = new MultiHashMap();
  ...
  private bjby a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 88	bkcv:jdField_a_of_type_Bjby	Lbjby;
    //   6: ifnull +12 -> 18
    //   9: aload_0
    //   10: getfield 88	bkcv:jdField_a_of_type_Bjby	Lbjby;
    //   13: astore_1
    //   14: aload_0
    //   15: monitorexit
    //   16: aload_1
    //   17: areturn
    //   18: aload_0
    //   19: invokestatic 92	bjby:a	()Lbjby;
    //   22: putfield 88	bkcv:jdField_a_of_type_Bjby	Lbjby;
    //   25: aload_0
    //   26: getfield 88	bkcv:jdField_a_of_type_Bjby	Lbjby;
    //   29: astore_1
    //   30: goto -16 -> 14
    //   33: astore_1
    //   34: aload_0
  ...
  public static bkcv a()
  {
    if (jdField_a_of_type_Bkcv == null) {}
    try
    {
      if (jdField_a_of_type_Bkcv == null) {
        jdField_a_of_type_Bkcv = new bkcv();
      }
      return jdField_a_of_type_Bkcv;
    }
    finally {}
  }
  
  private bkcx a(String paramString1, int paramInt, String paramString2, bkcy parambkcy)
  {
    return bkcx.a(paramString1, paramInt, paramString2, new WeakReference(parambkcy));
  }
  
  private Collection<bkcx> a(String paramString, boolean paramBoolean)
  {
    return a(paramString, paramBoolean, null);
  }
  
  private Collection<bkcx> a(String paramString, boolean paramBoolean, Collection<bkcx> paramCollection)
  {
  ...
  private void a(bkcx parambkcx)
  {
    if (URLUtil.isNetworkUrl(parambkcx.b))
    {
      String str = c(parambkcx.b);
      a().a(parambkcx.b, str, true, this.jdField_a_of_type_ComTencentComponentNetworkDownloaderDownloader$DownloadListener);
    }
  }
  ...
  private boolean a(String paramString, bkcx parambkcx)
  {
    for (;;)
    {
      synchronized (this.jdField_a_of_type_CooperationQzoneUtilMultiHashMap)
      {
        ...
        this.jdField_a_of_type_CooperationQzoneUtilMultiHashMap.add(paramString, parambkcx);
        if (i == 0)
        {
          bool = true;
          return bool;
  ...
  private static File b(String paramString)
  {
    ...
    for (paramString = b + bkcm.a(paramString);; paramString = b + bkcm.b(paramString)) {
  ...
  private static File b(String paramString1, String paramString2)
  {
    ...
    for (paramString1 = b + bkcm.a(paramString1) + File.separator + paramString2 + ".png";; paramString1 = b + bkcm.b(paramString1) + File.separator + paramString2 + ".png") {
  ...
  private static String c(String paramString)
  {
    ...
    if (jdField_a_of_type_JavaUtilArrayList.contains(paramString)) {}
    for (paramString = bkcm.a(paramString) + ".zip";; paramString = bkcm.b(paramString) + ".zip") {
  ...
  private static void c(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      a(localFile);
      bjps.b(new File(paramString), localFile);
    }
  }
  ...
  /* Error */
  public Bitmap a(String paramString1, int paramInt, String paramString2, bkcy parambkcy)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 7
    ...
    //   12: areturn
    //   13: aload_0
    //   14: getfield 84	bkcv:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    ...
    //   58: aload_1
    //   59: aload_3
    //   60: invokestatic 116	bkcv:b	(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    //   63: astore 8
    //   65: aload 5
    //   67: astore 6
    //   69: aload 8
    //   71: invokestatic 237	bkcv:c	(Ljava/io/File;)Z
    //   74: ifeq +167 -> 241
    //   77: aload_0
    //   78: monitorenter
    //   79: aload 5
    //   81: astore 6
    //   83: aload_0
    //   84: getfield 84	bkcv:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    ...
    //   147: aconst_null
    //   148: invokestatic 300	bkcm:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   151: astore 7
    //   153: aload 7
    //   155: astore 5
    //   157: aload_0
    ...
    //   165: ifnull +76 -> 241
    //   168: aload_0
    //   169: getfield 84	bkcv:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    ...
    //   244: aload_3
    //   245: aload 4
    //   247: invokespecial 100	bkcv:a	(Ljava/lang/String;ILjava/lang/String;Lbkcy;)Lbkcx;
    //   250: astore_3
    //   251: aload 6
    //   253: astore 7
    //   255: aload_0
    //   256: aload_1
    //   257: aload_3
    //   258: invokespecial 186	bkcv:a	(Ljava/lang/String;Lbkcx;)Z
    //   261: ifeq -251 -> 10
    //   264: aload_0
    //   265: aload_3
    //   266: invokespecial 151	bkcv:a	(Lbkcx;)V
    //   269: aload 6
    //   271: areturn
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public Drawable a(String paramString1, int paramInt, String paramString2, bkcy parambkcy)
  {
    return a(paramString1, paramInt, paramString2, false, parambkcy);
  }
  
  public Drawable a(String paramString1, int paramInt, String paramString2, boolean paramBoolean, bkcy parambkcy)
  {
    ...
    paramString1 = b(paramString1, paramInt, paramString2, parambkcy);
    if (paramString1 != null)
    {
      paramString1.setDensity(320);
      paramString1 = new BitmapDrawable(paramString1);
      paramString1.setTargetDensity((int)bdkf.c());
      return paramString1;
    }
    if (parambkcy != null) {
      try
  ...
  public String a(String paramString, bkcy parambkcy)
  {
    ...
    parambkcy = a(paramString, 999, str, parambkcy);
    if (a(paramString, parambkcy)) {
      a(parambkcy);
    }
    return null;
  }
  ...
  {
    if (jdField_a_of_type_JavaUtilArrayList.contains(paramString)) {
      paramString = b + bkcm.a(paramString) + File.separator;
    }
    try
    {
      for (;;)
      {
        ...
        return true;
        paramString = b + bkcm.b(paramString) + File.separator;
      }
      return false;
    }
  ...
  public Bitmap b(String paramString1, int paramInt, String paramString2, bkcy parambkcy)
  {
    Object localObject;
    ...
    QzoneHandlerThreadFactory.getHandlerThread("BackGround_HandlerThread").postDelayed(new ZipResDownloadManager.2(this, paramString1, paramString2, parambkcy, paramInt), 400L);
    return localBitmap;
  }
}
