  ...
  implements bhmo
{
  ...
  public void a(String paramString)
  {
    ...
    boolean bool1 = bake.a(bake.a(paramString, "isNew"));
    boolean bool2 = bake.a(bake.a(paramString, "isInsert"));
    bake.a(paramString, "title");
    bake.a(bake.a(paramString, "startDate")).longValue();
    bake.a(bake.a(paramString, "endDate")).longValue();
    if (bool1)
    {
      paramString = "0";
      if (!bool2) {
    ...
    for (String str = "0";; str = "1")
    {
      ...
      bcst.b(null, "CliOper", "", "", "Time_reminder", "Updata_clock", 0, 0, str, paramString, "", "");
      return;
      paramString = "1";
      break;
    }
  ...
  {
    long l = bake.a(bake.a(paramString, "currentDate")).longValue();
    bake.a(this.jdField_a_of_type_AndroidAppActivity, l * 1000L, new baki(this), paramJsBridgeListener);
  }
  ...
  public void b(String paramString)
  {
    ...
    catch (Exception localException1)
    {
      do
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "startTime : " + bakj.a(1000L * l2) + " endTime : " + bakj.a(1000L * l3));
        }
        i = bake.a(this.jdField_a_of_type_AndroidAppActivity, (String)localObject2, 1000L * l2, 1000L * l3, str1, str2, paramString);
      ...
      bcst.b(null, "CliOper", "", "", "Time_reminder", "Rec_ckl_add", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (("calendar".equals(paramString2)) && ("remindDelete".equals(paramString3)))
    {
      ...
      bcst.b(null, "CliOper", "", "", "Time_reminder", "Delete_clock", 0, 0, "", "", "", "");
      return true;
    }
    if (("calendar".equals(paramString2)) && ("remindMsgReport".equals(paramString3)))
    {
      ...
      bcst.b(null, "CliOper", "", "", "Time_reminder", "Obj_clock", 0, 0, bake.a(paramVarArgs[0], "entranceType"), bake.a(paramVarArgs[0], "role"), "", "");
      return true;
    }
    if (("calendar".equals(paramString2)) && ("remindAioReport".equals(paramString3)))
    {
      ...
      bcst.b(null, "CliOper", "", "", "Time_reminder", "Clock_card_clk", 0, 0, "", "", "", "");
      return true;
    }
    return false;
  }
