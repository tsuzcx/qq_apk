...
public class avgi
  implements agma
{
  private static final String jdField_a_of_type_JavaLangString = avgi.class.getSimpleName();
  private int jdField_a_of_type_Int;
  public long a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new avgj(this);
  private avgl jdField_a_of_type_Avgl;
  private avgm jdField_a_of_type_Avgm;
  ...
  public avgi(BaseChatPie paramBaseChatPie)
  {
  ...
  private avgm a()
  {
    if (this.jdField_a_of_type_Avgm == null)
    {
      ...
      if ((localManager instanceof avgm)) {
        this.jdField_a_of_type_Avgm = ((avgm)localManager);
      }
    }
    return this.jdField_a_of_type_Avgm;
  }
  
  private boolean a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aicl))) {
      return c();
    }
    return b();
  }
  ...
  private void b(int paramInt)
  {
    ...
    try
    {
      ...
      avgh localavgh = (avgh)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(150);
      if (localavgh != null) {
        localavgh.a(paramInt, l);
      }
      return;
    }
  ...
  private boolean b()
  {
    try
    {
      ...
      if (localavgg != null)
      {
        boolean bool = localavgg.jdField_a_of_type_Boolean;
        return bool;
      }
    }
    catch (Exception localException)
  ...
  private boolean c()
  {
    try
    {
      ...
      if (localavgg != null)
      {
        boolean bool = localavgg.jdField_b_of_type_Boolean;
        return bool;
      }
    }
    catch (Exception localException)
  ...
  public void a(int paramInt)
  {
    ...
    case 7: 
      do
      {
        ...
        if (this.jdField_a_of_type_Avgl == null) {
          this.jdField_a_of_type_Avgl = new avgk(this, null);
        }
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Avgl);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Avgl);
    }
    if (this.jdField_a_of_type_AndroidOsHandler != null)
    {
