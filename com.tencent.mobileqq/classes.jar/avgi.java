...
public class avgi
{
  ...
  public static Drawable a(Context paramContext)
  {
    ...
    return paramContext.getResources().getDrawable(2130845223);
  }
  ...
  public static void a(Context paramContext, SingleLineTextView paramSingleLineTextView, String paramString)
  {
    ...
    do
    {
      ...
      if ((!(localAppRuntime instanceof QQAppInterface)) || (!azgu.b((QQAppInterface)localAppRuntime, paramString))) {
        break;
      }
  ...
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    return ((localAppRuntime instanceof QQAppInterface)) && (azgu.b((QQAppInterface)localAppRuntime, paramString));
  }
}
