...
public class awsc
{
  ...
  public awsc(String paramString)
  {
    this(paramString, 1);
  }
  
  public awsc(String paramString, int paramInt)
  {
    this.c = paramString;
    a(paramInt);
  }
  ...
  private byte[] a(String paramString)
  {
    ...
    //   86: iconst_0
    //   87: ifeq +11 -> 98
    //   90: new 116	java/lang/NullPointerException
    //   93: dup
    //   94: invokespecial 117	java/lang/NullPointerException:<init>	()V
    //   97: athrow
    //   98: aload 5
    //   100: areturn
    ...
    //   104: dup
    //   105: aload 5
    //   107: invokespecial 122	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   110: astore 5
    //   112: aload 5
    //   114: invokevirtual 127	java/io/InputStream:available	()I
    //   117: istore_3
    //   118: iload_3
    //   119: newarray byte
    //   121: astore_1
    //   122: aload 5
    //   124: aload_1
    //   125: invokevirtual 131	java/io/InputStream:read	([B)I
    //   128: istore_2
    //   129: iload_2
    //   130: iload_3
    ...
    //   144: iload_2
    //   145: invokevirtual 134	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   148: ldc 136
    //   150: invokevirtual 50	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   153: iload_3
    //   154: invokevirtual 134	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    ...
    //   178: iload_2
    //   179: invokevirtual 134	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   182: invokevirtual 53	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   185: invokestatic 101	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   188: aload 5
    //   190: ifnull +8 -> 198
    //   193: aload 5
    //   195: invokevirtual 141	java/io/InputStream:close	()V
    //   198: aload_1
    //   199: areturn
    //   200: astore_1
    //   201: aconst_null
    ...
    //   208: ifnull -110 -> 98
    //   211: aload_1
    //   212: invokevirtual 141	java/io/InputStream:close	()V
    //   215: aconst_null
    //   216: areturn
    //   217: astore_1
    //   218: aconst_null
    ...
    //   232: ifnull -134 -> 98
    //   235: aload 6
    //   237: invokevirtual 141	java/io/InputStream:close	()V
    //   240: aload_1
    //   241: areturn
    //   242: astore 5
    //   244: aload_1
  ...
  public awrw a(String paramString1, String paramString2)
  {
    awrw localawrw = new awrw();
    localawrw.b = a(this.c + a + File.separator + paramString1);
    localawrw.a = a(this.c + a + File.separator + paramString2);
    return localawrw;
  }
