...
public final class bgtq
{
  private static Intent a(Activity paramActivity, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        if (paramIntent.getBooleanExtra("is_from_qreader_shortcut", false)) {
          ...
          {
            bgwf.e("QRJumpAction", localNumberFormatException.toString());
          }
        } else {
          i = -1;
        }
    ...
    paramActivity.putExtras(paramIntent);
    return paramActivity;
    paramIntent.putExtra("url", bgwh.b(a(paramIntent.getStringExtra("url"))));
    paramIntent.putExtra("item_type", 2);
    paramActivity = new Intent(paramActivity, ReaderContentPageActivity.class);
  ...
  public static Intent a(Activity paramActivity, Intent paramIntent, String paramString)
  {
    ...
    {
      bgwf.e("QRJumpAction", "jumpAction args error");
      return new Intent();
    }
  ...
  public static void a(Context paramContext, Intent paramIntent, String paramString, bgln parambgln)
  {
    if ((paramContext == null) || (paramIntent == null) || (TextUtils.isEmpty(paramString)))
    {
      bgwf.a("QRJumpAction", "jumpToPlugin args error");
      return;
    }
    String str = BaseApplicationImpl.getApplication().getRuntime().getAccount();
    bglq localbglq = new bglq(1);
    localbglq.b = "qqreaderplugin.apk";
    localbglq.d = ajya.a(2131711208);
    localbglq.jdField_a_of_type_JavaLangString = str;
    localbglq.e = paramString;
    localbglq.jdField_a_of_type_JavaLangClass = QRPluginProxyActivity.a(paramString);
    paramIntent.putExtra("userQqResources", 2);
    localbglq.jdField_a_of_type_AndroidContentIntent = paramIntent;
    paramIntent = bggx.a(1);
    if (paramIntent != null)
    {
      paramIntent.a();
      localbglq.jdField_a_of_type_Aqyd = paramIntent.jdField_a_of_type_Aqyd;
    }
    try
    {
      bglh.a(paramContext, localbglq, parambgln);
      return;
    }
    catch (Exception paramContext)
    {
      bgwf.a("QRJumpAction", "[jumpToPlugin] error!", paramContext);
    }
  }
}
