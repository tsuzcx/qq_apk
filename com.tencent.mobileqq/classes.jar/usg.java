...
{
  usg(AppInterface paramAppInterface, List paramList, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, int paramInt2, int paramInt3, String paramString6, String paramString7, String paramString8) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, android.os.Bundle paramBundle)
  {
    ...
    //   124: lstore 5
    //   126: aload_0
    //   127: getfield 22	usg:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    ...
    //   136: checkcast 134	use
    //   139: invokevirtual 136	use:a	()V
    ...
    //   325: athrow
    //   326: aload_0
    //   327: getfield 22	usg:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    ...
    //   347: astore 9
    //   349: aload_0
    //   350: getfield 24	usg:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   365: aload 9
    //   367: aload_0
    //   368: getfield 24	usg:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   371: iconst_0
    ...
    //   400: aload 9
    //   402: aload_0
    //   403: getfield 24	usg:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   406: iload_1
    ...
    //   430: dup
    //   431: aload_0
    //   432: getfield 26	usg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   435: aload_0
    //   436: getfield 28	usg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   439: aload_0
    //   440: getfield 30	usg:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   443: aload_0
    //   444: getfield 32	usg:d	Ljava/lang/String;
    //   447: aload_0
    //   448: getfield 34	usg:e	Ljava/lang/String;
    //   451: aload_0
    //   452: getfield 36	usg:jdField_a_of_type_Int	I
    //   455: aload_0
    //   456: getfield 38	usg:jdField_b_of_type_Int	I
    //   459: aload_0
    //   460: getfield 40	usg:jdField_c_of_type_Int	I
    //   463: aload_0
    //   464: getfield 42	usg:f	Ljava/lang/String;
    //   467: aload_0
    //   468: getfield 44	usg:g	Ljava/lang/String;
    //   471: aload_0
    //   472: getfield 46	usg:h	Ljava/lang/String;
    //   475: aload 9
    ...
    //   483: invokevirtual 164	use:a	(Lcom/tencent/biz/pubaccount/util/PAReportInfo;)V
    //   486: return
    //   487: astore_3
    //   488: goto -199 -> 289
    //   491: astore_3
