...
{
  public aeii(LoginVerifyCodeActivity2 paramLoginVerifyCodeActivity2) {}
  ...
  public void onGetStViaSMSVerifyLogin(String paramString, long paramLong1, int paramInt1, long paramLong2, int paramInt2, byte[] paramArrayOfByte, ErrMsg paramErrMsg)
  {
    ...
    for (;;)
    {
      ...
      paramArrayOfByte.putByteArray("connect_data", bjhh.a(LoginVerifyCodeActivity2.a(this.a)));
      paramArrayOfByte.putLong("dwSrcAppid", 1600001540L);
      paramArrayOfByte.putLong("dwDstAppid", 1600001540L);
      LoginVerifyCodeActivity2.a(this.a).ssoGetTicketNoPasswd(paramString, 4096, this.a.a, paramArrayOfByte);
      return;
      this.a.c();
