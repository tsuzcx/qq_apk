...
public class tqo
  implements Runnable
{
  public tqo(RegisterVerifyCodeActivity paramRegisterVerifyCodeActivity, Bundle paramBundle) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      } while ((!bool1) || (TextUtils.isEmpty(str1)) || (RegisterVerifyCodeActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterVerifyCodeActivity, "7.6.3", (String)localObject) < 0));
      ...
      {
        tqp localtqp = new tqp(this, str1);
        int i = str1.indexOf(str2);
        ((SpannableString)localObject).setSpan(localtqp, i, str2.length() + i, 33);
      }
