...
public class airr
{
  ...
  public static int a(@NonNull String paramString)
  {
    try
    {
      ...
      {
        jdField_a_of_type_Int = bhsi.b(paramString);
  ...
  @Nullable
  public static airt a(String paramString)
  {
    return (airt)bhld.a("StickerBubbleGifCache_" + paramString);
  }
  
  public static airw a(int paramInt1, String paramString, int paramInt2, int[] paramArrayOfInt)
  {
    ...
    {
      return new airw(paramArrayOfInt, paramString, bool, new airn(d1, d2), new airm(0.0D, 200.0D), 49);
      d1 = -jdField_a_of_type_JavaUtilRandom.nextInt(8000) + 4000;
      break;
    }
  }
  
  public static airw a(@NonNull Point paramPoint, @NonNull String paramString, int paramInt)
  {
    ...
    {
      return new airw(paramPoint, paramString, bool, new airn(d1, d2), new airm(0.0D, 200.0D), 85);
  ...
  public static Drawable a(@NonNull String paramString)
  {
    try
    {
      if (((!paramString.equals(jdField_a_of_type_JavaLangString)) || (jdField_a_of_type_AndroidGraphicsDrawableDrawable == null)) && (a(paramString) > 0)) {
        jdField_a_of_type_AndroidGraphicsDrawableDrawable = airq.a(a(paramString));
      }
  ...
  {
    int i = agej.a(8.0F, paramContext.getResources());
  ...
  public static void a(@NonNull airp paramairp, @NonNull String paramString)
  {
    try
    {
      jdField_a_of_type_Int = paramairp.jdField_a_of_type_Int;
      jdField_a_of_type_AndroidGraphicsDrawableDrawable = airq.a(jdField_a_of_type_Int);
      bhsi.b(paramairp.jdField_a_of_type_Int, paramString);
      jdField_a_of_type_JavaLangString = paramString;
      return;
    }
    finally
  ...
  public static void a(String paramString, BitmapDrawable[] paramArrayOfBitmapDrawable, int paramInt)
  {
    if (a())
    {
      ...
      if (bhld.a(str) == null) {
        bhld.a(str, new airt(paramString, paramArrayOfBitmapDrawable, paramInt));
      }
    }
  }
  ...
  public static int[] a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      paramQQAppInterface = ahnt.a(paramQQAppInterface, 7);
  ...
  public static airw b(@NonNull Point paramPoint, @NonNull String paramString, int paramInt)
  {
    boolean bool = a(paramInt);
    double d1;
    if (bool)
    ...
    for (double d2 = -1000 - jdField_a_of_type_JavaUtilRandom.nextInt(500);; d2 = -2000 - jdField_a_of_type_JavaUtilRandom.nextInt(1000))
    {
      return new airw(paramPoint, paramString, bool, new airn(d1, d2), new airm(0.0D, 200.0D), 81);
      d1 = -jdField_a_of_type_JavaUtilRandom.nextInt(6000) + 3000;
      break;
    }
  }
  ...
  public static void b(Object paramObject, View paramView)
  {
    ...
    if (jdField_a_of_type_AndroidViewAnimationAnimation == null)
    {
      ...
      jdField_a_of_type_AndroidViewAnimationAnimation.setAnimationListener(new airs());
    }
    if (QLog.isColorLevel()) {
