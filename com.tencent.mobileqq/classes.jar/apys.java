  ...
  implements apyw
{
  ...
  public String a(String paramString)
  {
    ...
    Object localObject2 = ((anyw)localQQAppInterface.getManager(51)).b((String)localObject1);
    ...
    if (((Card)localObject2).shGender == 0) {
      paramString = BaseActivity.sTopActivity.getString(2131693473);
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        paramString = BaseActivity.sTopActivity.getString(2131692060);
        break;
