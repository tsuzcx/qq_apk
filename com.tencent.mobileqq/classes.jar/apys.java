...
public class apys
{
  ...
  static
  {
    jdField_a_of_type_Agpe = new apyt();
  ...
  public static void a(AppInterface paramAppInterface, String paramString, agpe paramagpe, boolean paramBoolean)
  {
    int i = badq.a(paramAppInterface.getApplication());
    if (((i == 1) || (i == 4)) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      PreloadManager.a().a(paramAppInterface, paramagpe);
    }
  }
