  ...
  extends IArkDelegateNet
{
  public void download(String paramString, boolean paramBoolean1, boolean paramBoolean2, HashMap<String, String> paramHashMap, File paramFile, IArkDelegateNetCallback paramIArkDelegateNetCallback)
  {
    ...
    for (paramFile = paramFile.getAbsolutePath();; paramFile = "")
    {
      ...
      aoxw.a().a("callDownload", (Bundle)localObject, new aoyn(this, paramString, paramIArkDelegateNetCallback));
      return;
      str = "";
      break;
      paramHashMap = "";
    ...
    label175:
    Object localObject = ((bgog)BaseApplicationImpl.getApplication().getRuntime().getManager(47)).a(1);
    paramFile = new bgoe(paramString, new File(paramFile));
    ...
    ((bgoj)localObject).a(paramFile, new aoyo(this, paramString, paramIArkDelegateNetCallback), paramHashMap);
  }
  ...
  public void sendAppMsg(String paramString1, String paramString2, int paramInt1, int paramInt2, IArkDelegateNetCallback paramIArkDelegateNetCallback)
  {
    ...
    if (1 != BaseApplicationImpl.sProcessId)
    {
      ...
      aoxw.a().a("callSendAppMsg", (Bundle)localObject, new aoyl(this, paramString1, paramString2, paramIArkDelegateNetCallback, paramInt2));
      return;
    }
    ...
    ((aovv)localObject).a(paramString1, paramString2, paramInt1, paramInt2, new aoym(this, paramIArkDelegateNetCallback));
  }
}
