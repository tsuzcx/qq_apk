...
public class awet
{
  private static volatile awet jdField_a_of_type_Awet;
  private long jdField_a_of_type_Long;
  private awex jdField_a_of_type_Awex;
  ...
  private WeakReference<awew> jdField_a_of_type_MqqUtilWeakReference;
  ...
  private int a(Context paramContext, float paramFloat)
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      awen.a(paramContext, 4, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin());
      return i;
    }
    this.jdField_b_of_type_MqqUtilWeakReference = new WeakReference(localFloatingScreenManager.setFloatingVideoListener(new aweu(this), 2));
    localFloatingScreenManager.setWindowClickListener(2, new awev(this, paramContext));
    return 0;
  }
  
  public static awet a()
  {
    if (jdField_a_of_type_Awet == null) {}
    try
    {
      if (jdField_a_of_type_Awet == null) {
        jdField_a_of_type_Awet = new awet();
      }
      return jdField_a_of_type_Awet;
    }
    finally {}
  }
  ...
  public int a(Context paramContext, @Nonnull WatchTogetherFloatingData paramWatchTogetherFloatingData)
  {
    ...
    {
      QQToast.a(BaseApplicationImpl.getContext(), 2131693965, 0).a();
    ...
    this.jdField_a_of_type_Bios = new bios(localIntent, paramContext);
    this.jdField_a_of_type_Bios.a();
    awen.a(true, paramWatchTogetherFloatingData.getCurUin(), paramWatchTogetherFloatingData.getCurType(), true);
  ...
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramawew);
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null)) {
        ((awew)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(paramInt2);
      }
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Bios.e();
      this.jdField_a_of_type_Bios.c();
      this.jdField_a_of_type_Bios = null;
    }
    ...
    awen.a(false, paramString, paramInt, paramBoolean);
    if (this.jdField_a_of_type_Awex != null)
    {
      axby.a().a(this.jdField_a_of_type_Awex);
      this.jdField_a_of_type_Awex = null;
    }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    awew localawew = (awew)this.jdField_a_of_type_MqqUtilWeakReference.get();
    if (paramBoolean) {}
    for (int i = 1;; i = 2)
    {
      localawew.b(i);
  ...
  public boolean a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingView == null) || (this.jdField_a_of_type_Bios == null)) {}
    TouchWebView localTouchWebView;
    do
    {
      return false;
      localTouchWebView = this.jdField_a_of_type_Bios.a;
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      bdll.b(null, "dc00899", "Grp_AIO", "", "video_tab", "clk_refresh_error", 0, 0, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin(), "", "", "");
      return;
      if (QLog.isColorLevel()) {
      ...
      if (paramInt == 1)
      {
        ...
        if (this.jdField_a_of_type_Awex == null)
        {
          this.jdField_a_of_type_Awex = new awex(this.jdField_b_of_type_MqqUtilWeakReference);
          axby.a().a(1, this.jdField_a_of_type_Awex);
          return;
        }
        this.jdField_a_of_type_Awex.a(this.jdField_b_of_type_MqqUtilWeakReference);
        return;
      }
    } while (paramInt != 2);
    bdll.b(null, "dc00899", "Grp_AIO", "", "video_tab", "clk_refresh_error", 0, 0, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin(), "", "", "");
  ...
  public void b(awew paramawew)
  {
    if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() == paramawew)) {
