public class boai
{
  ...
  {
    // Byte code:
    //   0: invokestatic 18	java/lang/System:currentTimeMillis	()J
    //   3: lstore 9
    //   5: fload_2
    //   6: fconst_0
    //   7: fcmpg
    ...
    //   56: iconst_0
    //   57: fload_2
    //   58: invokestatic 28	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   61: aastore
    //   62: dup
    //   63: iconst_1
    //   64: fload_3
    //   65: invokestatic 28	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   68: aastore
    //   69: invokestatic 34	xvv:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   72: ldc 35
    //   74: istore 5
    //   76: iload 5
    //   78: ireturn
    //   79: new 37	java/io/File
    //   82: dup
    //   83: aload_0
    //   84: invokespecial 41	java/io/File:<init>	(Ljava/lang/String;)V
    //   87: astore 18
    //   89: aload 18
    //   91: invokevirtual 44	java/io/File:length	()J
    //   94: l2i
    //   95: istore 6
    //   97: aload 18
    //   99: invokevirtual 48	java/io/File:exists	()Z
    //   102: ifeq +8 -> 110
    //   105: iload 6
    //   107: ifgt +39 -> 146
    //   110: ldc 20
    ...
    //   119: iconst_0
    //   120: fload_2
    //   121: invokestatic 28	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   124: aastore
    //   125: dup
    //   126: iconst_1
    //   127: fload_3
    //   128: invokestatic 28	java/lang/Float:valueOf	(F)Ljava/lang/Float;
    //   131: aastore
    //   132: dup
    //   133: iconst_2
    //   134: iload 6
    //   136: invokestatic 55	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   139: aastore
    //   140: invokestatic 34	xvv:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   143: ldc 56
    //   145: ireturn
    //   146: aload_0
    //   147: aconst_null
    //   148: iconst_0
    //   149: invokestatic 61	com/tencent/mobileqq/shortvideo/util/AudioEncoder:a	(Ljava/lang/String;Ljava/lang/String;I)Lbbwq;
    //   152: astore_0
    //   153: fload_3
    //   154: fstore 4
    //   156: fload_3
    ...
    //   170: f2i
    //   171: aload_0
    //   172: getfield 67	bbwq:b	I
    //   175: invokestatic 69	boai:a	(II)I
    //   178: istore 5
    //   180: iload 6
    //   182: i2f
    //   183: fload 4
    ...
    //   186: f2i
    //   187: aload_0
    //   188: getfield 67	bbwq:b	I
    //   191: invokestatic 69	boai:a	(II)I
    //   194: istore 6
    //   196: ldc 20
    //   198: new 71	java/lang/StringBuilder
    //   201: dup
    ...
    //   210: iload 5
    //   212: invokevirtual 83	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   215: ldc 85
    //   217: invokevirtual 80	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   220: iload 6
    //   222: invokevirtual 83	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   225: invokevirtual 89	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   228: invokestatic 92	xvv:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   231: iload 6
    //   233: iload 5
    //   235: isub
    //   236: istore 6
    ...
    //   266: aload_0
    //   267: astore 11
    //   269: new 37	java/io/File
    //   272: dup
    //   273: aload_1
    //   274: invokespecial 41	java/io/File:<init>	(Ljava/lang/String;)V
    //   277: astore_1
    //   278: aload 17
    //   280: astore 12
    //   282: aload_0
    //   283: astore 11
    //   285: aload_1
    //   286: invokevirtual 48	java/io/File:exists	()Z
    //   289: ifeq +15 -> 304
    //   292: aload 17
    //   294: astore 12
    //   296: aload_0
    //   297: astore 11
    //   299: aload_1
    //   300: invokevirtual 95	java/io/File:delete	()Z
    //   303: pop
    //   304: aload 17
    //   306: astore 12
    //   308: aload_0
    //   309: astore 11
    //   311: aload_1
    //   312: invokevirtual 99	java/io/File:getParentFile	()Ljava/io/File;
    //   315: invokevirtual 48	java/io/File:exists	()Z
    //   318: ifne +18 -> 336
    //   321: aload 17
    //   323: astore 12
    //   325: aload_0
    //   326: astore 11
    //   328: aload_1
    //   329: invokevirtual 99	java/io/File:getParentFile	()Ljava/io/File;
    //   332: invokevirtual 102	java/io/File:mkdirs	()Z
    //   335: pop
    //   336: aload 17
    //   338: astore 12
    //   340: aload_0
    //   341: astore 11
    //   343: aload_1
    //   344: invokevirtual 105	java/io/File:createNewFile	()Z
    //   347: pop
    //   348: aload 17
    //   350: astore 12
    //   352: aload_0
    //   353: astore 11
    //   355: new 107	java/io/FileOutputStream
    //   358: dup
    //   359: aload_1
    //   360: invokespecial 110	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   363: astore_0
    //   364: new 112	java/io/FileInputStream
    //   367: dup
    //   368: aload 18
    //   370: invokespecial 113	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   373: astore_1
    //   374: aload_1
    //   375: ifnull +76 -> 451
    //   378: aload_0
    ...
    //   392: aload_1
    //   393: lload 7
    //   395: invokevirtual 117	java/io/FileInputStream:skip	(J)J
    //   398: pop2
    //   399: goto +377 -> 776
    //   402: aload_1
    //   403: aload 19
    //   405: iconst_0
    //   406: sipush 20480
    //   409: invokevirtual 121	java/io/FileInputStream:read	([BII)I
    //   412: istore 5
    //   414: iload 5
    //   416: iconst_m1
    ...
    //   442: lsub
    //   443: l2i
    //   444: invokevirtual 125	java/io/FileOutputStream:write	([BII)V
    //   447: aload_0
    //   448: invokevirtual 128	java/io/FileOutputStream:flush	()V
    //   451: aload_1
    //   452: ifnull +7 -> 459
    //   455: aload_1
    //   456: invokevirtual 131	java/io/FileInputStream:close	()V
    //   459: aload_0
    //   460: ifnull +7 -> 467
    //   463: aload_0
    //   464: invokevirtual 132	java/io/FileOutputStream:close	()V
    //   467: ldc 20
    //   469: new 71	java/lang/StringBuilder
    //   472: dup
    //   473: invokespecial 74	java/lang/StringBuilder:<init>	()V
    //   476: ldc 134
    //   478: invokevirtual 80	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   481: invokestatic 18	java/lang/System:currentTimeMillis	()J
    //   484: lload 9
    //   486: lsub
    //   487: invokevirtual 137	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   490: invokevirtual 89	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   493: invokestatic 92	xvv:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   496: iconst_0
    //   497: ireturn
    //   498: aload_0
    //   499: aload 19
    //   501: iconst_0
    //   502: iload 5
    //   504: invokevirtual 125	java/io/FileOutputStream:write	([BII)V
    //   507: lload 7
    //   509: iload 5
    //   511: i2l
    //   512: ladd
    ...
    //   518: astore_1
    //   519: aload_1
    //   520: invokevirtual 140	java/io/IOException:printStackTrace	()V
    //   523: goto -64 -> 459
    //   526: astore_0
    //   527: aload_0
    //   528: invokevirtual 140	java/io/IOException:printStackTrace	()V
    //   531: goto -64 -> 467
    //   534: astore 11
    //   536: aconst_null
    //   537: astore_0
    ...
    //   540: astore_1
    //   541: aload 11
    //   543: invokevirtual 140	java/io/IOException:printStackTrace	()V
    //   546: ldc 141
    //   548: istore 5
    //   550: aload_0
    //   551: ifnull +7 -> 558
    //   554: aload_0
    //   555: invokevirtual 131	java/io/FileInputStream:close	()V
    //   558: aload_1
    //   559: ifnull -483 -> 76
    //   562: aload_1
    //   563: invokevirtual 132	java/io/FileOutputStream:close	()V
    //   566: ldc 141
    //   568: ireturn
    //   569: astore_0
    //   570: aload_0
    //   571: invokevirtual 140	java/io/IOException:printStackTrace	()V
    //   574: ldc 141
    //   576: ireturn
    //   577: astore_0
    //   578: aload_0
    //   579: invokevirtual 140	java/io/IOException:printStackTrace	()V
    //   582: goto -24 -> 558
    //   585: astore_1
    //   586: aload 16
    //   588: astore_0
    ...
    //   596: ldc 20
    //   598: ldc 143
    //   600: invokestatic 145	xvv:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   603: aload_0
    //   604: astore 12
    //   606: aload 13
    //   608: astore 11
    //   610: aload_1
    //   611: invokevirtual 146	java/lang/Throwable:printStackTrace	()V
    //   614: ldc 141
    //   616: istore 5
    //   618: aload 13
    //   620: ifnull +8 -> 628
    //   623: aload 13
    //   625: invokevirtual 131	java/io/FileInputStream:close	()V
    //   628: aload_0
    //   629: ifnull -553 -> 76
    //   632: aload_0
    //   633: invokevirtual 132	java/io/FileOutputStream:close	()V
    //   636: ldc 141
    //   638: ireturn
    //   639: astore_0
    //   640: aload_0
    //   641: invokevirtual 140	java/io/IOException:printStackTrace	()V
    //   644: ldc 141
    //   646: ireturn
    //   647: astore_1
    //   648: aload_1
    //   649: invokevirtual 140	java/io/IOException:printStackTrace	()V
    //   652: goto -24 -> 628
    //   655: astore_0
    //   656: aload 12
    //   658: astore_1
    ...
    //   661: ifnull +8 -> 669
    //   664: aload 11
    //   666: invokevirtual 131	java/io/FileInputStream:close	()V
    //   669: aload_1
    //   670: ifnull +7 -> 677
    //   673: aload_1
    //   674: invokevirtual 132	java/io/FileOutputStream:close	()V
    //   677: aload_0
    //   678: athrow
    //   679: astore 11
    //   681: aload 11
    //   683: invokevirtual 140	java/io/IOException:printStackTrace	()V
    //   686: goto -17 -> 669
    //   689: astore_1
    //   690: aload_1
    //   691: invokevirtual 140	java/io/IOException:printStackTrace	()V
    //   694: goto -17 -> 677
    //   697: astore 11
    //   699: aload_0
    //   700: astore_1
