...
public class bdoq
{
  private bdor jdField_a_of_type_Bdor = new bdor();
  private WadlJsBridge jdField_a_of_type_ComTencentOpenWadlWadlJsBridge = new WadlJsBridge(null, null, this.jdField_a_of_type_Bdor);
  
  public void a()
  {
    this.jdField_a_of_type_ComTencentOpenWadlWadlJsBridge.doOnDestroy();
    this.jdField_a_of_type_Bdor = null;
  }
  
  public void a(bdos parambdos)
  {
    this.jdField_a_of_type_Bdor.a(parambdos);
  }
  ...
  public boolean a(String paramString1, String paramString2, int paramInt, ArrayList<WadlResult> paramArrayList)
  {
    ...
    if ((paramString1.equals(localWadlParams.a)) && (paramString2.equals(localWadlParams.b)) && (paramInt == localWadlParams.f) && (!TextUtils.isEmpty(localWadlResult.b)) && (apvb.a(localWadlResult.b))) {
      bool1 = false;
    }
    for (;;)
    {
