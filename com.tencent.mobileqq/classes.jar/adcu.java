...
public class adcu
  implements adcp
{
  private static adcu jdField_a_of_type_Adcu;
  adco jdField_a_of_type_Adco;
  ...
  private adcu()
  {
    ...
    for (this.jdField_a_of_type_Adco = new adcq();; this.jdField_a_of_type_Adco = new adcs())
    {
      this.jdField_a_of_type_Adco.a(this);
      return;
      if (QLog.isColorLevel()) {
  ...
  public static adcu a()
  {
    if (jdField_a_of_type_Adcu == null) {}
    try
    {
      if (jdField_a_of_type_Adcu == null) {
        jdField_a_of_type_Adcu = new adcu();
      }
      return jdField_a_of_type_Adcu;
    }
    finally {}
  }
  ...
  private Map<String, APIQuotaItem> a(String paramString1, int paramInt, String paramString2)
  {
    ...
    try
    {
      ...
      if (i != 0) {
        this.jdField_a_of_type_Adco.a(paramString1, paramInt, paramString2);
      }
      return localObject;
    }
    finally {}
  ...
  public void a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    this.jdField_a_of_type_Adco.a(paramString1, paramInt, paramString2, paramString3);
  }
