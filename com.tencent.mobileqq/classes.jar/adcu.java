...
public class adcu
  implements DialogInterface.OnDismissListener, AdapterView.OnItemClickListener, bfun
{
  ...
  public adcu(Activity paramActivity, WebView paramWebView)
  {
  ...
  public void a(int paramInt, String paramString, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        ...
        wim.a(2, 2131691309);
        if ((this.h) && (!TextUtils.isEmpty(this.jdField_a_of_type_Xmt.p))) {
      ...
      for (;;)
      {
        ...
        if (paramInt == 11)
        {
          ...
          try
          {
            ...
            if (i != 0)
            {
              ...
              localObject1 = bdhv.b(paramString + 200 + (String)localObject3 + "jubao@article@123");
              ...
              noo.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1008, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
            }
          }
        ...
        else
        {
          if (paramInt == 2)
          {
            ...
            for (;;)
            {
              this.jdField_a_of_type_Xmt.g = bool1;
          ...
          if (paramInt == 4)
          {
            ...
            try
            {
              ...
              axqw.b(null, "P_CliOper", "VIPCOMIC", "", "0X800619F", "0X800619F", 1000, 0, nax.b(str2, new String[0]), null, null, null);
              axqw.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_48", "browser_share", 0, 1, 0, "", "", "", "");
              if ((str3 == null) || ("".equals(str3))) {
                continue;
              }
              noo.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1006, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
            }
          ...
          else if (paramInt != 5)
          {
            if (paramInt == 3)
            {
              ...
              sgj.a(1002, (String)localObject1, this.jdField_b_of_type_Int);
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Xmt.p)) {
                this.jdField_a_of_type_Xmt.a((String)localObject4, 2, false);
              }
              for (;;)
              {
            ...
            if (paramInt == 6)
            {
              if (this.jdField_a_of_type_Xmt.a((String)localObject4)) {
                this.jdField_a_of_type_Xmt.a((String)localObject4, 9, false);
              }
              if ((str3 != null) && (!"".equals(str3))) {
                noo.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1007, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
              }
            }
            else if ((paramInt == 9) || (paramInt == 10))
            {
              ...
              if (paramInt == 9)
              {
                sgj.a(1003, (String)localObject1, this.jdField_b_of_type_Int);
              ...
              for (;;)
              {
                ...
                break;
                sgj.a(1004, (String)localObject1, this.jdField_b_of_type_Int);
                break label1289;
              ...
              {
                if (!TextUtils.isEmpty(this.jdField_a_of_type_Xmt.p)) {
                  this.jdField_a_of_type_Xmt.a((String)localObject4, 3, true);
                }
                for (;;)
                {
                  ...
                  noo.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1003, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
                  break;
              ...
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Xmt.p)) {
                this.jdField_a_of_type_Xmt.a((String)localObject4, 4, true);
              }
              for (;;)
              {
            ...
            {
              this.jdField_a_of_type_Xmt.a((String)localObject4, 5, true);
            }
            else if (paramInt == 15)
            {
              if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment == null) {
              ...
              a().a(j, new adcv(this));
              axqw.b(null, "P_CliOper", "Grp_open", "", "third_app", "add_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 16)
            {
              ...
              this.jdField_a_of_type_AndroidAppActivity.startActivity(paramString);
              axqw.b(null, "P_CliOper", "Grp_open", "", "third_app", "detail_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 17)
            {
              paramString = "";
              ...
              paramBundle.putExtra("hide_more_button", true);
              this.jdField_a_of_type_AndroidAppActivity.startActivity(paramBundle);
              axqw.b(null, "P_CliOper", "Grp_open", "", "third_app", "share_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 7)
            {
              b();
            ...
            else if ((paramInt == 19) || (paramInt == 20))
            {
              ...
              for (i = 6;; i = 7)
              {
                ...
                this.jdField_a_of_type_Xmt.a((String)localObject4, i, false);
                break;
              }
              this.jdField_a_of_type_Xmt.a((String)localObject4, i, true);
            }
            else
            {
              if (paramInt == 12)
              {
                if (!TextUtils.isEmpty(this.jdField_a_of_type_Xmt.p)) {
                  this.jdField_a_of_type_Xmt.a((String)localObject4, 8, false);
                }
                for (;;)
                {
                  ...
                  noo.a(null, "", "0X800787A", "0X800787A", 0, 0, (String)localObject1, paramBundle, "", "");
                  sgj.a(1005, paramBundle, this.jdField_b_of_type_Int);
                  break;
                  this.jdField_a_of_type_Xmt.a((String)localObject4, 8, false);
                }
              }
              ...
              else if (paramInt == 35)
              {
                ...
                if (this.jdField_b_of_type_JavaUtilArrayList != null)
                {
                  ...
                  do
                  {
                    ...
                    paramString = (nnu)((Iterator)localObject2).next();
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_Adcw.jdField_a_of_type_Long = Long.parseLong(str, 10);
      ...
      catch (NumberFormatException localNumberFormatException2)
      {
        try
        {
          this.jdField_a_of_type_Adcw.jdField_b_of_type_Long = Long.parseLong(str, 10);
        ...
        catch (NumberFormatException localNumberFormatException2)
        {
          try
          {
            for (;;)
            {
              this.jdField_a_of_type_Adcw.c = Long.parseLong(str, 10);
              ...
              try
              {
                this.jdField_a_of_type_Adcw.d = Long.parseLong(paramString, 10);
                return;
              }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      sgj.a(1001, paramString3, this.jdField_b_of_type_Int);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Xmt.p)) {
  ...
  public void a(xmt paramxmt)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Long = this.jdField_a_of_type_Adcw.jdField_a_of_type_Long;
      a();
      c();
  ...
  public List<bbje>[] a()
  {
    ...
    for (Object localObject1 = BaseApplicationImpl.getApplication().getRuntime();; localObject1 = null)
    {
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (!sfn.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:qq")) && ((this.jdField_a_of_type_Long & 0x8) == 0L))
      {
        ...
        ((bbje)localObject2).jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getString(2131696695);
        ((bbje)localObject2).jdField_b_of_type_Int = 2130838754;
        ((bbje)localObject2).jdField_b_of_type_Boolean = true;
        ((bbje)localObject2).c = 2;
      ...
      {
        localObject2 = new bbje();
        ((bbje)localObject2).jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getString(2131696708);
        ((bbje)localObject2).jdField_b_of_type_Int = 2130838755;
        ((bbje)localObject2).jdField_b_of_type_Boolean = true;
        ((bbje)localObject2).c = 3;
        ((bbje)localObject2).jdField_b_of_type_JavaLangString = "";
        localArrayList.add(localObject2);
      }
      if (((this.jdField_a_of_type_Long & 0x8000000) != 0L) && (bhvh.a()) && (!sfn.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:kandian")) && (localObject1 != null))
      {
        ...
        {
          localObject2 = new bbje();
          ((bbje)localObject2).jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getString(2131696709);
          ((bbje)localObject2).jdField_b_of_type_Int = 2130838753;
          ((bbje)localObject2).jdField_b_of_type_Boolean = true;
          ((bbje)localObject2).c = 13;
          ((bbje)localObject2).jdField_b_of_type_JavaLangString = "";
          localArrayList.add(localObject2);
        }
      }
      ...
      {
        localObject2 = new bbje();
        ((bbje)localObject2).jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getString(2131696715);
        ((bbje)localObject2).jdField_b_of_type_Int = 2130838758;
        ((bbje)localObject2).c = 9;
        ((bbje)localObject2).jdField_b_of_type_JavaLangString = "";
        localArrayList.add(localObject2);
      }
      ...
      {
        localObject2 = new bbje();
        ((bbje)localObject2).jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getString(2131696698);
        ((bbje)localObject2).jdField_b_of_type_Int = 2130838752;
        ((bbje)localObject2).c = 10;
        ((bbje)localObject2).jdField_b_of_type_JavaLangString = "";
        localArrayList.add(localObject2);
      }
      ...
      {
        localObject2 = new bbje();
        ((bbje)localObject2).jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getString(2131696712);
        ((bbje)localObject2).jdField_b_of_type_Boolean = true;
        ((bbje)localObject2).jdField_b_of_type_Int = 2130838757;
        ((bbje)localObject2).c = 12;
        ((bbje)localObject2).jdField_b_of_type_JavaLangString = "";
        localArrayList.add(localObject2);
      }
      ...
      {
        localObject2 = new bbje();
        ((bbje)localObject2).jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getString(2131696691);
        ((bbje)localObject2).jdField_b_of_type_Int = 2130842130;
        ((bbje)localObject2).c = 5;
        ((bbje)localObject2).jdField_b_of_type_JavaLangString = "";
        localArrayList.add(localObject2);
      }
      ...
      {
        localObject2 = new bbje();
        ((bbje)localObject2).jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getString(2131696692);
        ((bbje)localObject2).jdField_b_of_type_Boolean = true;
        ((bbje)localObject2).jdField_b_of_type_Int = 2130842126;
        ((bbje)localObject2).c = 4;
        ((bbje)localObject2).jdField_b_of_type_JavaLangString = "";
        localArrayList.add(localObject2);
      }
      ...
      if ((!sfn.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:qiDian")) && ((this.jdField_a_of_type_Long & 0x10) == 0L)) {
        bdto.a(this.jdField_a_of_type_AndroidAppActivity, localArrayList);
      }
      ...
      {
        localObject2 = new bbje();
        ((bbje)localObject2).jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getString(2131696706);
        ((bbje)localObject2).jdField_b_of_type_Boolean = true;
        ((bbje)localObject2).jdField_b_of_type_Int = 2130843595;
        ((bbje)localObject2).c = 20;
        ((bbje)localObject2).jdField_b_of_type_JavaLangString = "";
        localArrayList.add(localObject2);
      }
      ...
      if ((this.jdField_e_of_type_Boolean) && (this.jdField_b_of_type_JavaUtilArrayList != null))
      {
        ...
        {
          localObject3 = (nnu)localIterator.next();
          localbbje = new bbje();
          ...
          case 1: 
            ...
            for (localbbje.jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getString(2131695545);; localbbje.jdField_a_of_type_JavaLangString = ((nnu)localObject3).jdField_a_of_type_JavaLangString)
            {
              ...
              ((ArrayList)localObject2).add(localbbje);
              break;
            }
          case 2: 
            localObject3 = new bbje();
            ((bbje)localObject3).jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getString(2131695606);
            ((bbje)localObject3).jdField_b_of_type_Int = 2130842124;
            ((bbje)localObject3).jdField_b_of_type_Boolean = true;
            ((bbje)localObject3).c = 31;
      ...
      if ((this.jdField_f_of_type_Boolean) && (this.jdField_b_of_type_JavaUtilArrayList != null))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          case 3: 
            localObject3 = new bbje();
            ((bbje)localObject3).jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getString(2131696696);
            ((bbje)localObject3).jdField_b_of_type_Int = 2130842133;
            ((bbje)localObject3).jdField_b_of_type_Boolean = true;
            ((bbje)localObject3).c = 35;
            ((bbje)localObject3).jdField_b_of_type_JavaLangString = "";
            ((ArrayList)localObject2).add(localObject3);
          }
        }
  ...
  public void b()
  {
    ...
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new bfur(ajyc.a(2131702408), TypedValue.applyDimension(1, 15.0F, ajwe.a)));
    localArrayList.add(new bfur(ajyc.a(2131702412), TypedValue.applyDimension(1, 16.0F, ajwe.a)));
    localArrayList.add(new bfur("", TypedValue.applyDimension(1, 17.0F, ajwe.a)));
    localArrayList.add(new bfur("", TypedValue.applyDimension(1, 17.0F, ajwe.a)));
    localArrayList.add(new bfur(ajyc.a(2131702411), TypedValue.applyDimension(1, 18.0F, ajwe.a)));
