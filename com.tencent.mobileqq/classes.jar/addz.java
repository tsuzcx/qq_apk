...
{
  public addz(DiscussionInfoCardActivity paramDiscussionInfoCardActivity) {}
  
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    if (AppSetting.c)
    {
      localObject = this.a.getString(2131691668);
    ...
    if (paramBoolean)
    {
      ...
      if (i != ((DiscussionMemberInfo)localObject).flag)
      {
        ...
        bftc.a("Grp_Dis_set", "Dis_info", (String)localObject, 0, 0, new String[] { DiscussionInfoCardActivity.a(this.a), bftc.a(this.a.app, this.a.a) });
      }
      ...
      localObject = "1";
      label244:
      bcef.b(localQQAppInterface, "CliOper", "", "", "0X800629B", "0X800629B", 0, 0, (String)localObject, "", "", "");
      localQQAppInterface = this.a.app;
      if (!paramBoolean) {
        break label381;
      }
    ...
    {
      bcef.b(localQQAppInterface, "CliOper", "", "", "0X8006679", "0X8006679", 0, 0, (String)localObject, "", "", "");
      bcef.b(this.a.app, "CliOper", "", "", "0X8006668", "0X8006668", 0, 0, "", "", "", "");
