...
public class bkfn
{
  ...
  private static Map<String, bkfo> b;
  ...
  public static List<bkfo> a()
  {
    ...
    if ((localObject != null) && (!((Map)localObject).isEmpty()))
    {
      ...
      {
        bkfo localbkfo = (bkfo)((Iterator)localObject).next();
        if (localbkfo.jdField_a_of_type_Int >= 0) {
          localArrayList.add(localbkfo);
        }
      }
  ...
  public static Map<String, bkfo> a()
  {
    if (b == null) {
      a();
    }
      ...
      try
      {
        ...
        if (localJSONObject1 != null)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if ((localJSONObject2 == null) || (!bgyb.a(localJSONObject2, str))) {
              break label247;
            }
            localObject = new bkfo();
            ((bkfo)localObject).jdField_a_of_type_JavaLangString = localJSONObject2.optString("tabKey");
            if ((TextUtils.isEmpty(((bkfo)localObject).jdField_a_of_type_JavaLangString)) && (jdField_a_of_type_JavaUtilMap.containsKey(str))) {
              ((bkfo)localObject).jdField_a_of_type_JavaLangString = ((String)jdField_a_of_type_JavaUtilMap.get(str));
            }
            ((bkfo)localObject).jdField_a_of_type_Int = localJSONObject2.optInt("sequence");
            ((bkfo)localObject).b = localJSONObject2.optString("tabName");
            ((bkfo)localObject).c = localJSONObject2.optString("tabUrl");
            ((bkfo)localObject).d = localJSONObject2.optString("tabIcon");
    ...
    if ((localObject1 != null) && (!((Map)localObject1).isEmpty()))
    {
      ...
      if ((localObject2 != null) && (localObject2.length > 0))
      {
        ...
        while (((Iterator)localObject1).hasNext()) {
          if (!((List)localObject2).contains(((bkfo)((Iterator)localObject1).next()).d)) {
            return false;
          }
        }
        return true;
