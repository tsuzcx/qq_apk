  ...
  extends avlz
{
  ...
  private static ConcurrentHashMap<String, SoftReference<ArrayList<avmc>>> c = new ConcurrentHashMap();
  private ajjr jdField_a_of_type_Ajjr = new avmk(this);
  private akeu jdField_a_of_type_Akeu;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private String jdField_a_of_type_JavaLangString;
  private Comparator<FTSEntity> jdField_a_of_type_JavaUtilComparator = new avmi(this);
  ...
  public avmg(QQAppInterface paramQQAppInterface)
  {
  ...
  private int a(String paramString, int paramInt)
  {
    if (this.jdField_a_of_type_Akeu == null) {
      this.jdField_a_of_type_Akeu = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
    }
    int i = 0;
    if (!this.jdField_a_of_type_Akeu.a(paramString, paramInt)) {
      i = 10;
    }
    if (paramInt == 3000) {
      return i + 2;
  ...
  private ArrayList<avml> a(ArrayList<FTSEntity> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if ((localFTSMessage != null) && (localFTSMessage.msgExts != null))
      {
        ...
        String str = akbm.a((String)localObject2, i);
        if (!((HashMap)localObject1).containsKey(str))
        {
          avml localavml = new avml();
          localavml.jdField_a_of_type_JavaUtilList = new ArrayList();
          localavml.jdField_a_of_type_JavaUtilList.add(localFTSMessage);
          localavml.jdField_a_of_type_Int = localFTSMessage.mSearchScene;
          localavml.b = localFTSMessage.mProximity;
          localavml.c = a((String)localObject2, i);
          localavml.jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time;
          localavml.jdField_a_of_type_JavaUtilHashSet = new HashSet();
          localavml.jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(localFTSMessage.mOId));
          localavml.d = localFTSMessage.searchStrategy;
          localavml.e = localFTSMessage.senderNum;
          localavml.f = localFTSMessage.friendNum;
          localavml.g = localFTSMessage.friendIndex;
          ((HashMap)localObject1).put(str, localavml);
        }
        else
        {
          localObject2 = (avml)((HashMap)localObject1).get(str);
          if (((avml)localObject2).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(localFTSMessage.mOId)))
          {
            if (localFTSMessage.mSearchScene == ((avml)localObject2).jdField_a_of_type_Int)
            {
              if (localFTSMessage.mProximity < ((avml)localObject2).b) {
                ((avml)localObject2).b = localFTSMessage.mProximity;
              }
              if (((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time > ((avml)localObject2).jdField_a_of_type_Long) {
                ((avml)localObject2).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time;
              }
              if (localFTSMessage.senderNum > ((avml)localObject2).e) {
                ((avml)localObject2).e = localFTSMessage.senderNum;
              }
              if (localFTSMessage.friendNum > ((avml)localObject2).f) {
                ((avml)localObject2).f = localFTSMessage.friendNum;
              }
              if (localFTSMessage.friendIndex > ((avml)localObject2).g) {
                ((avml)localObject2).g = localFTSMessage.friendIndex;
              }
            }
            for (;;)
            {
              if (localFTSMessage.mSearchScene < ((avml)localObject2).jdField_a_of_type_Int) {
                ((avml)localObject2).jdField_a_of_type_Int = localFTSMessage.mSearchScene;
              }
              if (localFTSMessage.searchStrategy < ((avml)localObject2).d) {
                ((avml)localObject2).d = localFTSMessage.searchStrategy;
              }
              ((avml)localObject2).jdField_a_of_type_JavaUtilList.add(localFTSMessage);
              break;
              if (localFTSMessage.mSearchScene < ((avml)localObject2).jdField_a_of_type_Int)
              {
                ((avml)localObject2).b = localFTSMessage.mProximity;
    ...
    Collections.sort(paramArrayList, new avmj(this));
    return paramArrayList;
  }
  
  private List<avmc> a(String paramString1, String paramString2, String paramString3, boolean paramBoolean1, ArrayList<FTSEntity> paramArrayList, boolean paramBoolean2)
  {
    Object localObject1 = new HashMap();
    paramArrayList = paramArrayList.iterator();
    int i = 0;
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if ((localObject2 != null) && (((FTSMessage)localObject2).msgExts != null))
      {
        ...
        localObject4 = akbm.a((String)localObject3, j);
        if (!((HashMap)localObject1).containsKey(localObject4))
        {
          localObject5 = new avml();
          ((avml)localObject5).jdField_a_of_type_JavaUtilList = new ArrayList();
          ((avml)localObject5).jdField_a_of_type_JavaUtilList.add(localObject2);
          ((avml)localObject5).b = ((FTSMessage)localObject2).mProximity;
          ((avml)localObject5).c = a((String)localObject3, j);
          ((avml)localObject5).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time;
          ((avml)localObject5).jdField_a_of_type_JavaUtilHashSet = new HashSet();
          ((avml)localObject5).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(((FTSMessage)localObject2).mOId));
          ((avml)localObject5).d = ((FTSMessage)localObject2).searchStrategy;
          ((HashMap)localObject1).put(localObject4, localObject5);
        }
        else
        {
          localObject3 = (avml)((HashMap)localObject1).get(localObject4);
          if (!((avml)localObject3).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(((FTSMessage)localObject2).mOId)))
          {
            i = 1;
          }
          else
          {
            if (((FTSMessage)localObject2).mProximity < ((avml)localObject3).b) {
              ((avml)localObject3).b = ((FTSMessage)localObject2).mProximity;
            }
            if (((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time > ((avml)localObject3).jdField_a_of_type_Long) {
              ((avml)localObject3).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time;
            }
            if (((FTSMessage)localObject2).searchStrategy < ((avml)localObject3).d) {
              ((avml)localObject3).d = ((FTSMessage)localObject2).searchStrategy;
            }
            ((avml)localObject3).jdField_a_of_type_JavaUtilList.add(localObject2);
          }
        }
      }
    }
    ...
    Collections.sort(paramArrayList, new avmh(this));
    localObject1 = bakq.a(paramString2);
    ...
    if (paramArrayList != null)
    {
      ...
      {
        localObject4 = (avml)((Iterator)localObject3).next();
        if (a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(((FTSMessage)((avml)localObject4).jdField_a_of_type_JavaUtilList.get(0)).uin), ((FTSMessage)((avml)localObject4).jdField_a_of_type_JavaUtilList.get(0)).istroop))
        {
          ...
          {
            paramArrayList = new avmn((QQAppInterface)localObject5, paramArrayList, paramString2, (ArrayList)localObject1, ((avml)localObject4).jdField_a_of_type_JavaUtilList, paramString3, null);
            paramArrayList.jdField_a_of_type_Int = ((avml)localObject4).d;
            paramArrayList.b = ((avml)localObject4).e;
            paramArrayList.c = ((avml)localObject4).f;
            paramArrayList.d = ((avml)localObject4).g;
            ((List)localObject2).add(paramArrayList);
            i = avis.a("fts_native_chathistory_maxnum", 3);
  ...
  private List<avmb> a(String paramString, ArrayList<FTSEntity> paramArrayList)
  {
    ArrayList localArrayList = bakq.a(paramString);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      paramArrayList.add(new avmm(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, localArrayList, (FTSEntity)localObject2));
    }
    return paramArrayList;
  }
  ...
  public List<avmc> a(avvn paramavvn)
  {
    if (paramavvn == null) {
      return null;
    }
    ...
    for (boolean bool = paramavvn.jdField_a_of_type_AndroidOsBundle.getBoolean("fts_search_is_limited", true);; bool = true)
    {
      if (bakq.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1) {
        return b(paramavvn, bool);
      }
      return a(paramavvn, bool);
    }
  }
  
  public List<avmc> a(avvn arg1, boolean paramBoolean)
  {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          if (localObject1 != null)
          {
            ...
            awrn.a(BaseApplication.getContext()).a(null, "SearchMessageStatistic_FTS", true, (l7 - l5) / 1000000L, 0L, (HashMap)localObject5, null);
            l8 = System.nanoTime();
            if (QLog.isColorLevel()) {
              if (??? == null) {
                break label1500;
          ...
          for (int i1 = ???.size();; i1 = 0)
          {
            ...
            if (n == 0)
            {
              ...
              awrn.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l1, 0L, ???, null);
            }
            ??? = (avvn)localObject1;
            if (n == 0) {
              if (localObject1 != null)
            ...
            awrn.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l2, 0L, (HashMap)localObject5, null);
            return localObject4;
  ...
  public List<avmc> a(String paramString, boolean paramBoolean)
  {
    if (!badq.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
      return null;
    }
    ??? = (ajjq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(81);
    Object localObject2 = new ArrayList();
    ((ArrayList)localObject2).add(paramString);
    ((ajjq)???).a((ArrayList)localObject2);
    ...
    awrn.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l2, 0L, (HashMap)localObject2, null);
    return paramString;
    label654:
    ...
    if (localArrayList == null)
    {
      ...
      awrn.a(BaseApplication.getContext()).a(null, "SearchMessageStatistic_FTS", true, (l3 - l6) / 1000000L, 0L, paramString, null);
      l4 = System.nanoTime();
      if (QLog.isColorLevel()) {
        if (localArrayList == null) {
          break label1267;
    ...
    for (int n = localArrayList.size();; n = 0)
    {
      ...
      ((HashMap)localObject2).put("groupSortCost", String.valueOf(l1));
      awrn.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l2, 0L, paramString, null);
      return ???;
  ...
  public void a(avvn paramavvn, avva<avmc> paramavva)
  {
    bakr.e = System.nanoTime();
    bakr.f = 0L;
    ThreadManager.post(new FTSMessageSearchEngine.1(this, paramavvn, paramavva), 8, null, true);
  }
  ...
  public List<avmb> b(avvn paramavvn)
  {
    if (QLog.isColorLevel()) {
      QLog.d("FTSMessageSearchEngine", 2, "========== search message use FTSMessageSearchEngine");
    }
    ...
    Object localObject = paramavvn.jdField_a_of_type_JavaLangString;
    if (paramavvn.jdField_a_of_type_AndroidOsBundle == null) {
      return new ArrayList();
    }
    long l3 = paramavvn.jdField_a_of_type_AndroidOsBundle.getLong("uin");
    int i = paramavvn.jdField_a_of_type_AndroidOsBundle.getInt("uinType");
    paramavvn = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((String)localObject, FTSMessage.class, false, false, l3, i);
    l3 = System.nanoTime();
    localObject = a((String)localObject, paramavvn);
    long l4 = System.nanoTime();
    if (paramavvn != null) {}
    for (i = paramavvn.size();; i = 0)
    {
  ...
  public List<avmc> b(avvn arg1, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
      QLog.d("FTSMessageSearchEngine", 2, "========== search message use FTSMessageSearchEngine");
    }
    ...
    Object localObject4 = bakq.a(str);
    ...
    for (int i2 = 0;; i2 = 1)
    {
      ...
      awrn.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, 0L, 0L, localHashMap, null);
      return localObject3;
      i1 = ???.size();
      break label362;
    }
    ...
    long l1 = System.nanoTime();
    localObject4 = bakq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject4);
    ...
    if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
    {
      ...
      while (((Iterator)localObject5).hasNext())
      {
        localObject6 = (baks)((Iterator)localObject5).next();
        if ((((baks)localObject6).jdField_a_of_type_Int != 0) && (((baks)localObject6).jdField_a_of_type_Int != 1004)) {
          break label2300;
        }
        j += 1;
      }
    ...
    for (;;)
    {
      ...
      if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
      {
        ...
        {
          localObject5 = ((baks)((ArrayList)localObject4).get(i5)).jdField_a_of_type_JavaLangString;
          int i9 = ((baks)((ArrayList)localObject4).get(i5)).jdField_a_of_type_Int;
          localObject6 = ((baks)((ArrayList)localObject4).get(i5)).jdField_a_of_type_AndroidUtilPair;
          int i6 = m;
          ...
          {
            i = k;
            if (bakq.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1)
            {
      ...
      for (m = i;; m = i)
      {
        ...
        for (;;)
        {
          ...
          l3 += l4;
          localObject3 = bakq.a(localHashMap);
          localObject5 = ((ArrayList)localObject5).iterator();
          while (((Iterator)localObject5).hasNext())
          {
            localObject6 = (avml)((Iterator)localObject5).next();
            localObject7 = (FTSMessage)((avml)localObject6).jdField_a_of_type_JavaUtilList.get(0);
            ...
            {
              localObject7 = new avmn(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localHashMap, localHashMap, (ArrayList)localObject3, ((avml)localObject6).jdField_a_of_type_JavaUtilList, null, null);
              ((avmn)localObject7).jdField_a_of_type_Int = ((avml)localObject6).d;
              ((avmn)localObject7).b = ((avml)localObject6).e;
              ((avmn)localObject7).c = ((avml)localObject6).f;
              ((avmn)localObject7).d = ((avml)localObject6).g;
          ...
          awrn.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l3, 0L, ???, null);
  ...
  public void b(avvn paramavvn, avva<avmb> paramavva)
  {
    ThreadManager.post(new FTSMessageSearchEngine.2(this, paramavvn, paramavva), 8, null, true);
  }
  
  public void f()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Ajjr);
  }
  
  public void g()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Ajjr);
  }
}
