class aejc
  extends mmn
{
  aejc(aejb paramaejb, boolean paramBoolean)
  {
    super(paramBoolean);
  }
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, android.os.Bundle paramBundle)
  {
    ...
    //   5: ifnonnull +11 -> 16
    //   8: aload_0
    //   9: getfield 10	aejc:a	Laejb;
    //   12: invokevirtual 25	aejb:bs	()V
    //   15: return
    ...
    //   40: astore 12
    //   42: aload_0
    //   43: getfield 10	aejc:a	Laejb;
    //   46: getfield 46	aejb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   49: bipush 52
    ...
    //   61: ifnull +532 -> 593
    //   64: aload_0
    //   65: getfield 10	aejc:a	Laejb;
    //   68: getfield 46	aejb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   71: invokevirtual 58	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Latmq;
    //   74: invokevirtual 64	atmq:createEntityManager	()Latmp;
    //   77: astore 15
    //   79: aconst_null
    //   80: astore_2
    ...
    //   92: lstore 4
    //   94: aload 15
    //   96: invokevirtual 77	atmp:a	()Latmr;
    //   99: astore_3
    //   100: aload_3
    //   101: astore_2
    //   102: lload 4
    ...
    //   242: aload 13
    //   244: aload_0
    //   245: getfield 10	aejc:a	Laejb;
    //   248: getfield 114	aejb:jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo	Lcom/tencent/mobileqq/activity/aio/SessionInfo;
    ...
    //   325: aload_3
    //   326: aload_0
    //   327: getfield 10	aejc:a	Laejb;
    //   330: getfield 114	aejb:jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo	Lcom/tencent/mobileqq/activity/aio/SessionInfo;
    ...
    //   517: aload 15
    //   519: aload_3
    //   520: invokevirtual 186	atmp:b	(Latmo;)V
    //   523: lload 10
    //   525: lstore 6
    //   527: lload 10
    //   529: lstore 8
    //   531: aload 13
    //   533: aload_0
    //   534: getfield 10	aejc:a	Laejb;
    //   537: getfield 114	aejb:jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo	Lcom/tencent/mobileqq/activity/aio/SessionInfo;
    ...
    //   564: ifnull +7 -> 571
    //   567: aload_2
    //   568: invokevirtual 191	atmr:b	()V
    //   571: aload 13
    //   573: aload_0
    //   574: getfield 10	aejc:a	Laejb;
    //   577: getfield 114	aejb:jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo	Lcom/tencent/mobileqq/activity/aio/SessionInfo;
    ...
    //   588: aload 15
    //   590: invokevirtual 195	atmp:a	()V
    //   593: aload 14
    ...
    //   626: invokevirtual 204	aejb:a	(JJ)V
    //   629: return
    //   630: astore_2
    //   631: aload_0
    //   632: getfield 10	aejc:a	Laejb;
    //   635: invokevirtual 25	aejb:bs	()V
    //   638: return
    //   639: lload 10
    //   641: lstore 6
    //   643: lload 10
    ...
    //   647: aload 15
    //   649: aload_3
    //   650: invokevirtual 207	atmp:a	(Latmo;)Z
    //   653: pop
    //   654: goto -131 -> 523
    //   657: astore 12
    //   659: aload_2
    ...
    //   669: ifnull +7 -> 676
    //   672: aload_3
    //   673: invokevirtual 191	atmr:b	()V
    //   676: aload 13
    //   678: aload_0
    //   679: getfield 10	aejc:a	Laejb;
    //   682: getfield 114	aejb:jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo	Lcom/tencent/mobileqq/activity/aio/SessionInfo;
    ...
    //   703: aload 13
    //   705: aload_0
    //   706: getfield 10	aejc:a	Laejb;
    //   709: getfield 114	aejb:jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo	Lcom/tencent/mobileqq/activity/aio/SessionInfo;
    ...
    //   741: lstore 8
    //   743: aload_2
    //   744: invokevirtual 215	atmr:c	()V
    //   747: aload_2
    //   748: ifnull +7 -> 755
    //   751: aload_2
    //   752: invokevirtual 191	atmr:b	()V
    //   755: aload 13
    //   757: aload_0
    //   758: getfield 10	aejc:a	Laejb;
    //   761: getfield 114	aejb:jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo	Lcom/tencent/mobileqq/activity/aio/SessionInfo;
    ...
    //   772: goto -184 -> 588
    //   775: aload_0
    //   776: getfield 10	aejc:a	Laejb;
    //   779: invokevirtual 25	aejb:bs	()V
    //   782: aload_0
    //   783: getfield 10	aejc:a	Laejb;
    //   786: ldc 216
    //   788: invokevirtual 220	aejb:e	(I)V
    //   791: return
    //   792: astore_2
    //   793: aconst_null
    //   794: astore_3
