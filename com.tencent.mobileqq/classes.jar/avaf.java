  ...
  extends avae
{
  ...
  public avaf(Reader paramReader, int paramInt)
  {
  ...
  public final avac a()
  {
    ...
    for (;;)
    {
      ...
      return new avac(new String(this.jdField_a_of_type_ArrayOfChar, 0, k), n, k + n, this.jdField_a_of_type_JavaLangString);
      label700:
      m = i1;
    }
  }
