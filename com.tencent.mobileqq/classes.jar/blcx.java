  ...
  implements View.OnClickListener
{
  ...
  public blcx(Activity paramActivity)
  {
    super(paramActivity);
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_ArrayOfInt = new int[] { 2131380478, 2131380479, 2131380480, 2131380481 };
    this.jdField_b_of_type_ArrayOfInt = new int[] { 2131380483, 2131380484, 2131380485, 2131380486, 2131380487, 2131380488, 2131380489, 2131380490 };
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
  }
  
  private void d()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131699164));
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidAppActivity.getSystemService("layout_inflater")).inflate(2131560129, null);
    setContentView(this.jdField_a_of_type_AndroidViewView);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131380482));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131380474));
    this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131380476);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380491));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131380473));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380477));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131380475));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380494));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380493));
    ...
    setOnDismissListener(new blcy(this));
    setTouchable(true);
    setFocusable(true);
  ...
  protected void a(IBinder paramIBinder)
  {
    ...
    this.jdField_c_of_type_AndroidViewView.setOnKeyListener(new blcz(this));
  ...
  public void a(View paramView, bldb parambldb)
  {
    this.jdField_a_of_type_Bldb = parambldb;
    a(paramView.getWindowToken());
    parambldb = new int[2];
    paramView.getLocationOnScreen(parambldb);
    int j;
    int i;
    int n;
    if (!this.jdField_c_of_type_Boolean)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("KandianPopupWindow", 2, "x = " + parambldb[0] + ", y = " + parambldb[1]);
      }
      if (QLog.isColorLevel()) {
      ...
      i = parambldb[1];
      i = (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298782);
      n = this.jdField_b_of_type_Int - parambldb[0] - paramView.getWidth() / 2 + i;
      if (QLog.isColorLevel()) {
      ...
      if (j - (k + m) > this.jdField_c_of_type_Int) {
        if (n > this.jdField_b_of_type_Int * 0.1D)
        {
          ...
          j = parambldb[1] + paramView.getHeight() / 2 + AIOUtils.dp2px(9.5F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    ...
    for (;;)
    {
      pkh.jdField_a_of_type_Boolean = true;
      return;
      ...
      for (;;)
      {
        ...
        j = parambldb[1] + paramView.getHeight() / 2 - AIOUtils.dp2px(9.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()) - this.jdField_c_of_type_Int;
        showAtLocation(paramView, 0, i, j);
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      showAtLocation(paramView, 0, parambldb[0] + paramView.getWidth() / 2 - AIOUtils.dp2px(10.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()) - (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298783), parambldb[1] + paramView.getHeight() / 2 - this.jdField_c_of_type_Int / 2);
    }
  }
  
  public void a(blda paramblda)
  {
  ...
  public boolean a(int paramInt, ArrayList<DislikeInfo> paramArrayList)
  {
    ...
    while ((paramArrayList == null) || (paramArrayList.size() == 0))
    {
      ...
      this.jdField_b_of_type_Int = ((int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298783));
    ...
    this.jdField_b_of_type_Int = ((int)(this.d - this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298782) * 2.0F));
    setWidth(this.jdField_b_of_type_Int);
  ...
  public void b()
  {
    ...
    if (this.jdField_b_of_type_AndroidViewView != null) {
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130843101);
    }
    if (this.jdField_c_of_type_AndroidWidgetImageView != null)
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130843111);
      if (RelativeLayout.LayoutParams.class.isInstance(this.jdField_c_of_type_AndroidWidgetImageView.getLayoutParams()))
      {
        ...
        localLayoutParams.addRule(3, 2131380475);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Bldb != null) {
          this.jdField_a_of_type_Bldb.a(paramView, this.jdField_a_of_type_Int, this.jdField_b_of_type_JavaUtilArrayList, null);
        }
        dismiss();
        continue;
        if (this.jdField_a_of_type_Blda != null) {
          this.jdField_a_of_type_Blda.a();
        }
        dismiss();
        continue;
        i += 1;
        ...
        label281:
        if (this.jdField_a_of_type_Boolean) {
          this.jdField_a_of_type_AndroidWidgetTextView.setText(String.format(this.jdField_a_of_type_AndroidAppActivity.getString(2131699165), new Object[] { Integer.valueOf(this.jdField_b_of_type_JavaUtilArrayList.size()) }));
        }
