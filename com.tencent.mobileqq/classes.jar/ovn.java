  ...
  implements View.OnTouchListener
{
  ...
  public ovn(TribeVideoPlugin paramTribeVideoPlugin, String paramString)
  {
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    {
      return false;
      Object localObject1 = ovo.a((ovo)TribeVideoPlugin.a(paramView).get(this.jdField_a_of_type_JavaLangString));
      if ((localObject1 != null) && (ovm.a((ovm)localObject1) == 2))
      {
        ...
        if ((Math.abs(TribeVideoPlugin.a(paramView).y - TribeVideoPlugin.b(paramView).y) < 8) && (Math.abs(TribeVideoPlugin.a(paramView).x - TribeVideoPlugin.b(paramView).x) < 8))
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            Object localObject2 = ovo.a((ovo)TribeVideoPlugin.a(paramView).get(str));
            SeekBar localSeekBar = ovm.a(ovo.a((ovo)TribeVideoPlugin.a(paramView).get(str)));
