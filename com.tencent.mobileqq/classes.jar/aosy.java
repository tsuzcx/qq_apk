...
{
  aosy(String paramString1, String paramString2, aops paramaops) {}
  ...
  public void onGetAppPathByNameTimeout(int paramInt, String paramString, ArkAppMgr.AppPathInfo paramAppPathInfo, Object paramObject)
  {
    if ((paramInt == 0) && (paramAppPathInfo != null) && (paramAppPathInfo.path != null))
    {
      ...
      if (paramString != null)
      {
        ...
        if (bool)
        {
          this.jdField_a_of_type_Aops.a(true);
      ...
      this.jdField_a_of_type_Aops.a(false);
    ...
    this.jdField_a_of_type_Aops.a(false);
    aovl.a(aorg.a(), this.jdField_a_of_type_JavaLangString, "ArkCheckShareUrlLegality", paramInt, 0, 0L, 0L, 0L, "", "");
