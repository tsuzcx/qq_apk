  ...
  extends BaseAdapter
{
  ...
  private ArrayList<bmrd> jdField_a_of_type_JavaUtilArrayList = new ArrayList(10);
  ...
  public bmrc(Context paramContext, int paramInt)
  {
  ...
  private View a()
  {
    ...
    for (;;)
    {
      ...
      ((URLImageView)localObject1).setId(2131368236);
      ...
      localObject3 = new bmrd();
      ((bmrd)localObject3).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localObject1);
      ((bmrd)localObject3).jdField_a_of_type_AndroidViewView = localFrameLayout;
      ((bmrd)localObject3).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject2);
      ((bmrd)localObject3).jdField_a_of_type_Boolean = this.jdField_a_of_type_Boolean;
  ...
  public void a()
  {
    ...
    {
      localbmrd = (bmrd)localIterator.next();
      if (localbmrd.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem == null) {
        break label116;
      }
      if (localTransitionCategoryItem == null) {
        break label111;
      }
      bool2 = TextUtils.equals(localTransitionCategoryItem.a, localbmrd.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem.a);
      bool1 = bool2;
      if (!bool2)
      {
        if (((localTransitionCategoryItem != null) && (!localTransitionCategoryItem.c())) || (!localbmrd.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem.c())) {
          break label105;
        }
        bool1 = true;
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      if ((paramView.getTag() == null) || (!(paramView.getTag() instanceof bmrd)))
      {
        if (QLog.isColorLevel()) {
      ...
      bmrd localbmrd = (bmrd)paramView.getTag();
      TextView localTextView = localbmrd.jdField_a_of_type_AndroidWidgetTextView;
      URLImageView localURLImageView = localbmrd.jdField_a_of_type_ComTencentImageURLImageView;
      ...
      localbmrd.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem = localTransitionCategoryItem;
      Object localObject = bnub.a().a();
      if (localObject != null) {}
      for (boolean bool1 = TextUtils.equals(((QIMFilterCategoryItem)localObject).a, localTransitionCategoryItem.a);; bool1 = false) {
        for (;;)
        {
          ...
          try
          {
            ...
            paramView.setContentDescription(localTransitionCategoryItem.b + amtj.a(2131714081));
          }
