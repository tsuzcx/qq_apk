...
public class altl
{
  ...
  public static altl a()
  {
    if (jdField_a_of_type_Altl == null) {}
    try
    {
      if (jdField_a_of_type_Altl == null) {
        jdField_a_of_type_Altl = new altl();
      }
      return jdField_a_of_type_Altl;
    }
    finally {}
  }
  ...
  public static void a(FragmentActivity paramFragmentActivity, Intent paramIntent)
  {
    ...
    try
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ApolloFragmentManager", 2, "[notifyViewChange] " + localApolloWebViewFragment.getCurrentUrl() + " " + localApolloWebViewFragment.a());
      }
      paramIntent = paramFragmentActivity.getSupportFragmentManager();
      if (!localApolloWebViewFragment.isAdded()) {
        paramIntent.beginTransaction().add(2131367431, localApolloWebViewFragment).commitAllowingStateLoss();
      }
      paramIntent.beginTransaction().show(localApolloWebViewFragment).setCustomAnimations(2130772050, 2130772051).commit();
  ...
  {
    // Byte code:
    //   0: getstatic 25	altl:b	Ljava/util/Stack;
    //   3: invokevirtual 265	java/util/Stack:empty	()Z
    //   6: ifeq +34 -> 40
    //   9: aconst_null
    //   10: astore_3
    //   11: aload_3
    //   12: ifnull +41 -> 53
    //   15: getstatic 23	altl:jdField_a_of_type_JavaUtilStack	Ljava/util/Stack;
    //   18: aload_3
    //   19: invokevirtual 253	java/util/Stack:push	(Ljava/lang/Object;)Ljava/lang/Object;
    //   22: pop
    //   23: aload_1
    //   24: ifnull +11 -> 35
    //   27: aload_3
    ...
    //   32: invokevirtual 257	com/tencent/mobileqq/apollo/game/ApolloFragment:b	(Landroid/os/Bundle;)V
    //   35: aload_0
    //   36: invokevirtual 259	altl:b	()V
    //   39: return
    //   40: getstatic 25	altl:b	Ljava/util/Stack;
    //   43: invokevirtual 245	java/util/Stack:pop	()Ljava/lang/Object;
    ...
    //   83: aload_2
    //   84: invokevirtual 270	java/lang/Class:newInstance	()Ljava/lang/Object;
    //   87: checkcast 247	com/tencent/mobileqq/apollo/game/ApolloFragment
    //   90: astore_2
    //   91: aload_1
    //   92: ldc 66
    //   94: getstatic 32	altl:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    //   104: aload_2
    //   105: aload_3
    //   106: invokevirtual 271	com/tencent/mobileqq/apollo/game/ApolloFragment:setArguments	(Landroid/os/Bundle;)V
    //   109: getstatic 23	altl:jdField_a_of_type_JavaUtilStack	Ljava/util/Stack;
    //   112: aload_2
    //   113: invokevirtual 253	java/util/Stack:push	(Ljava/lang/Object;)Ljava/lang/Object;
    //   116: pop
    //   117: aload_0
    //   118: getfield 41	altl:jdField_a_of_type_AndroidSupportV4AppFragmentActivity	Landroid/support/v4/app/FragmentActivity;
    ...
    //   136: invokevirtual 257	com/tencent/mobileqq/apollo/game/ApolloFragment:b	(Landroid/os/Bundle;)V
    //   139: aload_2
    //   140: aload_1
    //   141: invokevirtual 91	android/content/Intent:getExtras	()Landroid/os/Bundle;
    //   144: invokevirtual 272	com/tencent/mobileqq/apollo/game/ApolloFragment:c	(Landroid/os/Bundle;)V
    //   147: aload_0
    //   148: getfield 41	altl:jdField_a_of_type_AndroidSupportV4AppFragmentActivity	Landroid/support/v4/app/FragmentActivity;
    //   151: aload_3
    ...
    //   176: invokestatic 197	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   179: goto -24 -> 155
  ...
  public void b()
  {
    try
    {
      if ((this.jdField_a_of_type_AndroidSupportV4AppFragmentManager != null) && (!jdField_a_of_type_JavaUtilStack.isEmpty()))
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("ApolloFragmentManager", 2, "[notifyViewChange] " + localApolloFragment.getCurrentUrl() + " " + localApolloFragment.a());
          }
          ...
          this.jdField_a_of_type_AndroidSupportV4AppFragmentManager.beginTransaction().show(localApolloFragment).setCustomAnimations(2130772050, 2130772051).commit();
