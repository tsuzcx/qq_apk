...
public abstract class altl
{
  ...
  protected abstract void addBusinessObserver(ToServiceMsg paramToServiceMsg, alkr paramalkr, boolean paramBoolean);
  ...
  public ToServiceMsg makeOIDBPkg(String paramString, int paramInt1, int paramInt2, byte[] paramArrayOfByte, long paramLong, alkr paramalkr, boolean paramBoolean)
  {
    ...
    addBusinessObserver(paramString, paramalkr, paramBoolean);
    return paramString;
  }
}
