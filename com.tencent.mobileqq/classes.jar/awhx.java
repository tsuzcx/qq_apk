  ...
  implements View.OnClickListener
{
  ...
  public awhx(int paramInt, boolean paramBoolean)
  {
    super(paramInt);
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Xni = new awhy(this);
    this.jdField_c_of_type_Boolean = paramBoolean;
  }
  
  public static void a(Context paramContext, URLImageView paramURLImageView, String paramString1, String paramString2, awid paramawid)
  {
    ...
    for (;;)
    {
      ...
      {
        paramURLImageView = new awib(paramURLImageView, paramContext, paramawid);
  ...
  private void a(HotWordSearchEntryDataModel.GIFInfo paramGIFInfo)
  {
    ...
    awia localawia = new awia(this, paramGIFInfo);
    this.jdField_a_of_type_AndroidViewView.post(new HotWordSearchEntryModel.4(this, paramGIFInfo, localawia));
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    {
      localObject = bbex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString1);
      if (localObject != null)
      {
        ((bbeg)localObject).c();
  ...
  public View a(Context paramContext, QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    for (paramViewGroup = ((BaseActivity)paramContext).getAppRuntime();; paramViewGroup = null)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370437));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373044));
      ...
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131365276);
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131365277);
      ...
      for (;;)
      {
        this.jdField_a_of_type_ComTencentBizWidgetsHotWordTipsContainer.setOnTipsClickListener(this.jdField_a_of_type_Xni);
  ...
  public void a(awod paramawod)
  {
    ...
    if (ThemeUtil.isInNightMode(BaseApplicationImpl.getApplication().getRuntime()))
    {
      ...
      if (!TextUtils.isEmpty(paramawod.b)) {
        localObject = paramawod.b;
      }
      if (!ThemeUtil.isInNightMode(BaseApplicationImpl.getApplication().getRuntime())) {
        break label208;
      }
      ...
      if (TextUtils.isEmpty(paramawod.jdField_a_of_type_JavaLangString)) {
        break label217;
      }
      this.jdField_a_of_type_AndroidWidgetTextView.setText(paramawod.jdField_a_of_type_JavaLangString);
      label116:
      if (TextUtils.isEmpty(paramawod.c)) {
        break label233;
      }
      this.jdField_b_of_type_AndroidWidgetTextView.setText(paramawod.c);
      label137:
      if ((paramawod.jdField_a_of_type_Int != 1) || (TextUtils.isEmpty(paramawod.e))) {
        break label245;
      }
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(new awhz(this, paramawod));
      return;
      ...
      break label87;
      label217:
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131705634));
      break label116;
      label233:
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      break label137;
  ...
  {
    Object localObject = (HotWordSearchEntryDataModel)paramawpp;
    ...
    if (((HotWordSearchEntryDataModel)localObject).jdField_a_of_type_Awod == null) {
    ...
    for (;;)
    {
      ...
      paramawpp = (Boolean)SearchEntryFragment.a.get(Integer.valueOf(1));
      ...
      while (i < j - 1)
      {
        paramawpp.append(((HotWordSearchEntryDataModel.HotSearchItem)((HotWordSearchEntryDataModel)localObject).jdField_a_of_type_JavaUtilList.get(i)).title).append("::");
        i += 1;
      }
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      a(((HotWordSearchEntryDataModel)localObject).jdField_a_of_type_Awod);
    }
    paramawpp.append(((HotWordSearchEntryDataModel.HotSearchItem)((HotWordSearchEntryDataModel)localObject).jdField_a_of_type_JavaUtilList.get(j - 1)).title);
    label300:
    awwa.a("hot_list", "exp_hot_list", new String[] { paramawpp.toString(), String.valueOf(this.jdField_a_of_type_Int) });
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("experiment_id", awsq.b);
      ...
      {
        i = 21;
        awsq.a(null, localReportModelDC02528.ver2(awsq.a(i)).ver4(paramawpp.toString()).ver7(((JSONObject)localObject).toString()).session_id(localQQAppInterface.getCurrentAccountUin() + this.jdField_a_of_type_Long));
        awsq.a(localQQAppInterface, 0, SearchEntryFragment.a(this.jdField_a_of_type_Int), "0X8009D27", 0, 0, null, null);
        return;
      }
    }
  ...
  public void onClick(View paramView)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel != null) && (this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel.jdField_a_of_type_Awod != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel.jdField_a_of_type_Awod.e))) {
      a(this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel.jdField_a_of_type_Awod.e, "");
    }
    for (;;)
    {
      ...
      try
      {
        ...
        awwa.a("hot_list", "clk_qq_index", new String[] { "", String.valueOf(this.jdField_a_of_type_Int) });
        ReportModelDC02528 localReportModelDC02528 = new ReportModelDC02528().module("hot_list").action("clk_qq_index");
        if (this.jdField_a_of_type_Int == 3)
        {
          i = 21;
          awsq.a(null, localReportModelDC02528.ver2(awsq.a(i)).ver7(paramView.toString()).session_id(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + this.jdField_a_of_type_Long));
          awsq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, SearchEntryFragment.a(this.jdField_a_of_type_Int), "0X8009D28", 0, 0, null, null);
          return;
