...
public class bapk
  ...
  implements Manager
{
  private antq jdField_a_of_type_Antq = new bapm(this);
  private anvi jdField_a_of_type_Anvi = new bapl(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public bapk(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Anvi);
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Antq);
  }
  
  public static int a(QQAppInterface paramQQAppInterface)
  {
    bapk localbapk = (bapk)paramQQAppInterface.getManager(QQManagerFactory.RECENT_CALL_FACADE);
    if (localbapk != null) {}
    for (int i = localbapk.a();; i = 0)
    {
  ...
  public static bapn a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, QQMessageFacade.Message paramMessage)
  {
    return new bapn(paramQQAppInterface, paramString, paramInt1, paramInt2, paramMessage, null);
  }
  ...
  private QCallRecent a(MessageForVideo paramMessageForVideo)
  {
    ...
    localQCallRecent.lastCallMsg = bhfj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), paramMessageForVideo.text);
    ...
    catch (Exception paramMessageForVideo)
    {
      for (;;)
      {
        ...
        else
        {
          ...
          if (QLog.isColorLevel())
          {
            QLog.d("QCallFacade", 2, "getMessageToCallRecord java.lang.NumberFormatException: Invalid int: " + arrayOfString[1] + " msg byte " + bhbx.a(str));
            paramMessageForVideo = (MessageForVideo)localObject;
          }
        }
      }
  ...
  private void a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a().a();
    }
  }
  ...
  private void a(QCallRecent paramQCallRecent, String paramString)
  {
    ...
    if ((acnh.d(paramQCallRecent.type)) && (paramQCallRecent.state == 5))
    {
      a(1);
      return;
    }
  ...
  public int a()
  {
    ...
    do
    {
      ...
      localObject1 = ((aoxz)localObject1).getRecentList(false);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      {
        localObject2 = (antp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.DISCUSSION_MANAGER);
        DiscussionMemberInfo localDiscussionMemberInfo = ((antp)localObject2).a(localRecentUser.uin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
        ...
        localObject2 = ((antp)localObject2).a(localRecentUser.uin);
      ...
      if ((localRecentUser.getType() != 0) || ((!FriendsStatusUtil.a(localRecentUser.uin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (!agij.a(localRecentUser.uin, localRecentUser.getType(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))))
      {
        localObject2 = (almg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TEMP_MSG_BOX);
        if ((!((almg)localObject2).b(localRecentUser.uin, localRecentUser.getType())) && (!((almg)localObject2).a(localRecentUser.uin, localRecentUser.getType()))) {
  ...
  public int a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    while ((paramMessageRecord.msgtype != -2026) && (!acnh.d(paramInt))) {
      return i;
    }
    return 1;
  }
  ...
  public String a(String paramString, boolean paramBoolean)
  {
    ...
    for (j = k;; j = k)
    {
      ...
      if ((j == 1) || (i == 1)) {
        if (paramBoolean) {
          if (paramString != null) {
            ((StringBuilder)localObject1).append(paramString).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131695329));
          }
        }
      }
      for (;;)
      {
        ...
        {
          ((StringBuilder)localObject1).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131695697));
        }
        else
        {
          ((StringBuilder)localObject1).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131695119));
          continue;
          ((StringBuilder)localObject1).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131695286, new Object[] { "" + i, "" + j }));
        }
      }
      break label238;
      break label192;
    ...
    if (localIterator.hasNext())
    {
      ...
      for (;;)
      {
        ...
        if (localQCallRecord.time > l1)
        {
          ...
          localObject = bcsa.a(-2016);
          ((MessageRecord)localObject).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131695380);
      ...
      for (((MessageRecord)localObject).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131695381);; ((MessageRecord)localObject).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131695379))
      {
  ...
  public void a(long paramLong1, long paramLong2, boolean paramBoolean1, long paramLong3, boolean paramBoolean2)
  {
    ...
    while ((((antp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.DISCUSSION_MANAGER)).a(String.valueOf(paramLong1)) == null) || (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(String.valueOf(paramLong2)))) {
      return;
    }
  ...
  public void a(MessageForVideo paramMessageForVideo)
  {
    ...
    {
      bdla.b(localQQAppInterface, "CliOper", "", "", "0X8004067", "0X8004067", 0, 0, paramMessageForVideo, "", "", "");
    ...
    for (paramMessageForVideo = "1";; paramMessageForVideo = "0")
    {
      bdla.b(localQQAppInterface, "CliOper", "", "", "Msg_tab", "Call_history_count", 0, 0, paramMessageForVideo, "", "", "");
      break;
    }
  }
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4)
  {
    ...
    do
    {
      ...
      } while ((localanvk != null) && (!localanvk.b(paramString1)));
    } while ((paramString1 == null) || ((paramInt1 == 3000) && (((antp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.DISCUSSION_MANAGER)).a(paramString1) == null)));
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, long paramLong, String paramString2)
  {
    ...
    localbapo.a((QCallRecord)localObject);
    localObject = localbapo.a(paramString1, paramInt1);
    ...
    localbapo.d((QCallRecent)localObject);
  ...
  {
    int k = 0;
    Object localObject2 = (awyz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CONTACT_MANAGER);
    ...
    for (;;)
    {
      ...
      return;
      localObject2 = ((awyz)localObject2).c(paramString);
      break;
      label154:
      i = 0;
      break label59;
      ...
      break label79;
      label164:
      localObject1 = ((anvk)localObject1).e(((PhoneContact)localObject2).uin);
      break label91;
      label179:
      j = 0;
      break label106;
