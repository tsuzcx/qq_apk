...
{
  aqqg(aqqa paramaqqa, String paramString1, JSONObject paramJSONObject, String paramString2) {}
  ...
  public void onClick(View paramView)
  {
    ...
    paramView.setClass(aqqa.a(this.jdField_a_of_type_Aqqa), ForwardRecentActivity.class);
    ...
    paramView.putExtra("scale", aqqa.a(this.jdField_a_of_type_Aqqa).getResources().getDisplayMetrics().scaledDensity);
