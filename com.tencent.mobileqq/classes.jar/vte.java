...
public class vte
{
  ...
  public vte(WSTabLayout paramWSTabLayout, @NonNull View paramView)
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131381582));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131381573));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new vtf(this, paramWSTabLayout));
  }
