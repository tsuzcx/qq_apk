...
public final class rzs
  implements Runnable
{
  public rzs(QQAppInterface paramQQAppInterface, Emoticon paramEmoticon, Context paramContext, SessionInfo paramSessionInfo, EmojiStickerManager.StickerInfo paramStickerInfo) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      localObject1 = new rzt(this, (MessageForMarketFace)localObject2, (EmoticonPackage)localObject1);
