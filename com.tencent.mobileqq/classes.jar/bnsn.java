...
public class bnsn
{
  public static int a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    if (ShortVideoTrimmer.a(paramContext, 0, 0))
    {
      ...
      {
        i = j;
        if (((bdev)localObject).jdField_a_of_type_Boolean)
        {
          ...
          localObject = new bnso(paramString2, (int)(((bdev)localObject).b * 1024L), (int)((bdev)localObject).jdField_a_of_type_Long);
          if ((!new bdfk().a(localFile, (bdfl)localObject, true)) || (((bnso)localObject).a != null)) {
            break label339;
          }
          if (QLog.isColorLevel()) {
  ...
  public static String a(String paramString)
  {
    ...
    //   1: astore 5
    //   3: aload_0
    //   4: invokestatic 293	bnsn:b	(Ljava/lang/String;)Ljava/lang/String;
    //   7: astore 6
  ...
  private static JSONObject a(AppRuntime paramAppRuntime, String paramString, Bundle paramBundle1, Bundle paramBundle2)
  {
    try
    {
      paramString = nnp.a(paramAppRuntime.getApplication().getApplicationContext(), paramString, paramBundle1, paramBundle2);
  ...
  public static JSONObject a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (localObject = ((TicketManager)localObject).getSkey(paramAppRuntime.getAccount());; localObject = null)
    {
      ...
      localBundle.putString("bkn", String.valueOf(bguq.b((String)localObject)));
  ...
  public static String b(String paramString)
  {
    ...
    for (;;)
    {
      return bigv.a(((StringBuilder)localObject).toString());
  ...
  private static JSONObject b(AppRuntime paramAppRuntime, String paramString, Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    try
    {
      String str = nnr.a(paramAppRuntime.getApplication().getApplicationContext(), paramString, "GET", paramBundle1, paramBundle2);
