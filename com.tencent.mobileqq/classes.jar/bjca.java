  ...
  extends AdProxy.AbsInterstitialAdView
{
  ...
  public void destroy()
  {
    this.jdField_a_of_type_Abmj = null;
  ...
  public void onClose(Activity paramActivity, int paramInt, Intent paramIntent)
  {
    try
    {
      if ((this.jdField_a_of_type_Abmj != null) && (paramActivity != null)) {
        this.jdField_a_of_type_Abmj.a(paramActivity, paramInt, paramIntent);
      }
      return;
    }
  ...
  public boolean show(Activity paramActivity)
  {
    if ((this.jdField_a_of_type_Abmj != null) && (paramActivity != null))
    {
      ...
      {
        localObject = bjds.a((IMiniAppContext)localObject, this.jdField_a_of_type_Long, this.jdField_b_of_type_JavaLangString);
        this.jdField_a_of_type_Abmj.a((JSONObject)localObject);
        boolean bool = this.jdField_a_of_type_Abmj.a(paramActivity);
