...
public class bmti
{
  ...
  private static bmti jdField_a_of_type_Bmti;
  ...
  public static bmti a()
  {
    if (jdField_a_of_type_Bmti == null) {}
    try
    {
      if (jdField_a_of_type_Bmti == null) {
        jdField_a_of_type_Bmti = new bmti();
      }
      return jdField_a_of_type_Bmti;
    }
    finally {}
  }
  ...
  public void a(bmtn parambmtn)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      parambmtn.a(this.jdField_a_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("vip_tar_engine.jar", new bmtj(this, parambmtn));
  }
  ...
  public void b(bmtn parambmtn)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      parambmtn.a(this.jdField_b_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("libTar.so", new bmtk(this, parambmtn));
  }
}
