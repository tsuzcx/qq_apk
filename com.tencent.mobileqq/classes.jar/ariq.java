...
public class ariq
  implements Manager
{
  private arit jdField_a_of_type_Arit;
  ...
  public ariq(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    return new aris(this, paramBaseChatPie, paramShort);
  }
  ...
  private void a(SessionInfo paramSessionInfo, short paramShort, String paramString, int paramInt, BaseChatPie paramBaseChatPie)
  {
    if (!a(a(paramShort)))
    {
      paramSessionInfo = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getString(2131654278), new Object[] { paramString, paramString });
      paramSessionInfo = babr.a(paramBaseChatPie.a, 230, ajjy.a(2131649029), paramSessionInfo, 2131654276, 2131654277, a(paramBaseChatPie, paramShort), a(paramBaseChatPie, paramShort));
      paramSessionInfo.setOnCancelListener(new arir(this, paramBaseChatPie));
      paramSessionInfo.setCanceledOnTouchOutside(false);
      paramSessionInfo.show();
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009977", "0X8009977", a(paramShort), a(paramShort), "", "", "", "");
    }
  ...
  public void a(SessionInfo paramSessionInfo, BaseChatPie paramBaseChatPie)
  {
    ...
    default: 
      return;
    case 1000: 
      a(paramSessionInfo, (short)-23308, ajjy.a(2131649028), i, paramBaseChatPie);
      return;
    case 1006: 
      a(paramSessionInfo, (short)-23310, ajjy.a(2131649026), i, paramBaseChatPie);
      return;
    case 1001: 
    case 1003: 
      a(paramSessionInfo, (short)-23312, ajjy.a(2131649025), i, paramBaseChatPie);
      return;
    case 10002: 
      a(paramSessionInfo, (short)-23311, ajjy.a(2131649027), i, paramBaseChatPie);
      return;
    }
  ...
  public void a(SessionInfo paramSessionInfo, String paramString, int paramInt, short paramShort)
  {
    ...
    if (paramInt == 1000)
    {
      paramString = babh.o(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSessionInfo.c);
      String str = babh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSessionInfo.c, true);
      if (QLog.isColorLevel()) {
        QLog.d("TempMsgManager", 2, "getTroopNickName:" + paramString + " new From:" + str);
      }
      paramString = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getString(2131654283), new Object[] { str });
      localObject = new aqax(paramSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString, paramSessionInfo.jdField_a_of_type_Int, -5023, 655381, awao.a());
      ...
      ((aqax)localObject).a(5, str.length() + 5, localBundle);
      ...
      ((aqax)localObject).a(paramString.length() - 5, paramString.length() - 1, paramSessionInfo);
    ...
    for (;;)
    {
      ...
      return;
      paramString = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getString(2131654282), new Object[] { paramString });
      paramSessionInfo = new aqax(paramSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString, paramSessionInfo.jdField_a_of_type_Int, -5023, 655381, awao.a());
  ...
  public void a(short paramShort, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      ((ajfi)localObject).a(paramShort, paramBoolean1);
      return;
      this.jdField_a_of_type_JavaUtilMap.put(localObject, Boolean.valueOf(paramBoolean1));
      break;
    }
  ...
  public boolean a(String paramString, SessionInfo paramSessionInfo)
  {
    try
    {
      if ((this.jdField_a_of_type_Atmp.a(TempMsgInfo.class, paramString + paramSessionInfo.jdField_a_of_type_JavaLangString) instanceof TempMsgInfo)) {
        return false;
      }
      if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_Atmp.a(new TempMsgInfo(paramString + paramSessionInfo.jdField_a_of_type_JavaLangString, System.currentTimeMillis()));
      return true;
    }
    finally {}
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Arit = null;
