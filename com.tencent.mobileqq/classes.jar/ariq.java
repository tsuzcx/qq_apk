...
public class ariq
{
  ...
  private static NativeMonitorConfig a(SharedPreferences paramSharedPreferences, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramSharedPreferences)) {
      try
      {
        ...
        return (NativeMonitorConfig)avnn.a(paramSharedPreferences, NativeMonitorConfig.class);
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, ConfigurationService.Config paramConfig)
  {
    ...
    int i = bgsg.aF(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int k = bgsg.aG(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int m = AppSetting.a();
    if (QLog.isColorLevel()) {
    ...
    if (k != m)
    {
      bgsg.Y(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), m);
      i = 0;
    }
    String str;
    if (j != i)
    {
      str = arcj.b(paramConfig, i, paramInt);
    ...
    for (;;)
    {
      try
      {
        ...
        paramConfig = (NativeMonitorConfig)avnn.a(paramConfig, NativeMonitorConfig.class);
        if (paramConfig == null)
        {
          a(new NativeMonitorConfig());
          bgsg.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, "");
          bgsg.s(paramQQAppInterface.getApp(), 0);
      ...
      catch (JSONException paramConfig)
      {
        ...
        a(paramConfig);
        bgsg.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, str);
        bgsg.s(paramQQAppInterface.getApp(), paramConfig.soHook);
        continue;
      }
      a(new NativeMonitorConfig());
      bgsg.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, "");
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (localNativeMonitorConfig != null)
      {
        ...
        anvz.a(jdField_a_of_type_ComTencentMobileqqDataNativemonitorNativeMonitorConfig.getTmChance());
      }
  ...
  public static void b()
  {
    ...
    //   51: new 432	arir
    //   54: dup
    //   55: invokespecial 433	arir:<init>	()V
