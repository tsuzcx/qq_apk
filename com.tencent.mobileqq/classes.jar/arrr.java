...
public class arrr
  extends arrj
{
  private static final String b = arrw.b + "shortvideo" + File.separator;
  ...
  public arrr(MsgBackupResEntity paramMsgBackupResEntity)
  {
  ...
  public arpi a()
  {
    ...
    localarpi.jdField_a_of_type_JavaLangString = str1;
    if ((!bool1) && (!bool2)) {}
