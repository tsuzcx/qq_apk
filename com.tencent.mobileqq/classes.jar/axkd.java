...
public class axkd
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajni.jdField_a_of_type_JavaLangString + "/capture_qsvf" + File.separator;
    jdField_b_of_type_JavaLangString = jdField_a_of_type_JavaLangString + "capture_res" + File.separator;
    f = ajni.jdField_a_of_type_JavaLangString + "/qav" + File.separator + "beauty" + File.separator;
  ...
  public static final axkd a()
  {
    return axke.a();
  }
  
  private static axkk a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localaxkk = new axkk(i, str1, str2);
        try
        {
    ...
    try
    {
      ...
      if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.jdField_a_of_type_JavaLangString)))
      {
        ...
        if (!((File)localObject).exists())
        {
          ...
          ((baps)localObject).jdField_a_of_type_Bapx = new axkh();
          ...
          ((baps)localObject).jdField_c_of_type_JavaLangString = (f + "skin_color.zip");
  ...
  private boolean b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Axkf != null) {
        this.jdField_a_of_type_Axkf.a();
      }
      return true;
      label335:
      i += 1;
  ...
  public void a()
  {
    this.jdField_a_of_type_Axkf = null;
  }
  ...
  public void a(axkf paramaxkf)
  {
    this.jdField_a_of_type_Axkf = paramaxkf;
  }
  
  public void a(axkj paramaxkj)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Axkj = paramaxkj;
      ...
      paramaxkj = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
      while (paramaxkj.hasNext())
      {
        Object localObject1 = (FilterCategory)paramaxkj.next();
              ...
              if (localFilterDesc.predownload == 1)
              {
                ...
                if (!TextUtils.isEmpty(localFilterDesc.iconurl))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((baps)localObject3).jdField_a_of_type_Bapx = new axki(this);
                ...
                if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject2)))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((baps)localObject2).jdField_a_of_type_Bapx = new axkg(this);
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Axkj == null));
    this.jdField_a_of_type_Axkj.a(false);
  }
