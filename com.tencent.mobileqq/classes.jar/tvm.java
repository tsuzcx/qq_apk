  ...
  implements bkzu
{
  ...
  public tvm(BridgeModule paramBridgeModule)
  {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          if (((JSONArray)localObject2).length() > 0)
          {
            ...
            ((bkzi)localObject1).c(((JSONArray)localObject2).getString(j));
            j += 1;
            continue;
          }
        }
        ...
        if (!TextUtils.isEmpty(paramJSONObject)) {
          ((bkzi)localObject1).d(paramJSONObject);
        }
        ((bkzi)localObject1).a(new tvn(this, paramString));
        ((bkzi)localObject1).a(new tvo(this, paramString));
        ((bkzi)localObject1).setOnCancelListener(new tvp(this, paramString));
