...
public final class altd
  implements Runnable
{
  public altd(int paramInt, QQAppInterface paramQQAppInterface) {}
  ...
  public void run()
  {
    ...
    HtmlOffline.b("354", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, new alte(this));
  }
}
