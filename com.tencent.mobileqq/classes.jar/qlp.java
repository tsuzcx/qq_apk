...
public abstract interface qlp
{
  ...
  public abstract pyy a();
  
  public abstract void a(int paramInt1, int paramInt2, Intent paramIntent);
  
  public abstract void a(VideoInfo paramVideoInfo, int paramInt1, int paramInt2);
  
  public abstract void a(VideoFeedsRecyclerView paramVideoFeedsRecyclerView, qkw paramqkw, View paramView);
  
  public abstract void a(qln paramqln);
  
  public abstract boolean a(int paramInt, KeyEvent paramKeyEvent);
  
  public abstract boolean a(qla paramqla);
  
  public abstract boolean a(qln paramqln);
