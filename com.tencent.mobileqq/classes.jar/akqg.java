...
{
  public akqg(HealthBusinessPlugin paramHealthBusinessPlugin, akqw paramakqw, IVideoViewBase paramIVideoViewBase, FrameLayout paramFrameLayout) {}
  
  public void onClick(View paramView)
  {
    if (!this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.d)
    {
      this.jdField_a_of_type_Akqw.c.setImageResource(2130839781);
      ((View)this.jdField_a_of_type_ComTencentQqliveMediaplayerViewIVideoViewBase).setOnTouchListener(new akqh(this));
      this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.mRuntime.a().findViewById(2131363261).setVisibility(8);
    ...
    this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.mRuntime.a().findViewById(2131363261).setVisibility(0);
    if (((ViewGroup)this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.mRuntime.a().findViewById(16908290).getParent().getParent()).getChildAt(1) != null) {
    ...
    this.jdField_a_of_type_Akqw.c.setImageResource(2130839780);
