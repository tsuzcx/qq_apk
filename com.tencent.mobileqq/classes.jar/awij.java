  ...
  extends awhb
{
  ...
  static awij jdField_a_of_type_Awij;
  ...
  public int a;
  alqk jdField_a_of_type_Alqk = alqk.a();
  public Camera a;
  awil jdField_a_of_type_Awil = new awil(this);
  awim jdField_a_of_type_Awim;
  boolean jdField_a_of_type_Boolean;
  private byte[] jdField_a_of_type_ArrayOfByte;
  int[] jdField_a_of_type_ArrayOfInt;
  int jdField_b_of_type_Int;
  awim jdField_b_of_type_Awim;
  ...
  static
  {
    if (!awij.class.desiredAssertionStatus()) {}
  ...
  public static awij a()
  {
    if (jdField_a_of_type_Awij == null) {}
    try
    {
      if (jdField_a_of_type_Awij == null) {
        jdField_a_of_type_Awij = new awij();
      }
      return jdField_a_of_type_Awij;
    }
    finally {}
  }
  
  private awim a(List<Camera.Size> paramList, int paramInt1, int paramInt2)
  {
    int j = -1;
    ...
    for (;;)
    {
      ...
      if (i > 0)
      {
        localawim.jdField_b_of_type_Int = paramInt2;
        localawim.jdField_a_of_type_Int = i;
        if (localawim.jdField_a_of_type_Int / 4 == localawim.jdField_b_of_type_Int / 3)
        {
          if (QLog.isColorLevel()) {
  ...
  private awim a(List<Camera.Size> paramList, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if ((localSize != null) && (localSize.width >= paramInt1) && (localSize.height >= paramInt2) && (localSize.width / localSize.height >= d1))
        {
          ...
          if (l2 < l1)
          {
            localawim.jdField_a_of_type_Int = localSize.width;
            localawim.jdField_b_of_type_Int = localSize.height;
            l1 = l2;
          }
        }
        for (;;)
        {
          break;
          if ((l2 == l1) && (localSize.width < localawim.jdField_a_of_type_Int))
          {
            localawim.jdField_a_of_type_Int = localSize.width;
            localawim.jdField_b_of_type_Int = localSize.height;
          }
    ...
    if (((localawim.jdField_a_of_type_Int <= 0) || (localawim.jdField_b_of_type_Int <= 0)) && (paramList != null) && (!paramList.isEmpty()))
    {
      localIterator = paramList.iterator();
      l1 = 0L;
      if (localIterator.hasNext())
    ...
    if (QLog.isColorLevel()) {
      QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSize[self-adaption] cSize.width=" + localawim.jdField_a_of_type_Int + "  cSize.height=" + localawim.jdField_b_of_type_Int);
    }
    if ((localawim.jdField_a_of_type_Int > 0) && (localawim.jdField_b_of_type_Int > 0)) {
      return localawim;
    }
    if ((paramList != null) && (!paramList.isEmpty()) && (paramList.get(0) != null))
    {
      localawim.jdField_a_of_type_Int = ((Camera.Size)paramList.get(0)).width;
      localawim.jdField_b_of_type_Int = ((Camera.Size)paramList.get(0)).height;
      return localawim;
    }
    return null;
  }
  
  private awim a(List<Camera.Size> paramList, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (((List)localObject1).size() == 0)
      {
        ...
        if (paramList.hasNext())
        {
          localObject3 = (awim)paramList.next();
          if (localObject3 == null) {
            break label885;
          }
          paramInt1 = Math.max(((awim)localObject3).jdField_a_of_type_Int, ((awim)localObject3).jdField_b_of_type_Int);
          paramInt2 = Math.min(((awim)localObject3).jdField_a_of_type_Int, ((awim)localObject3).jdField_b_of_type_Int);
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          if (localObject1 != null)
          {
            ...
            for (;;)
            {
              ...
              QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getHighVersionPreviewSizeV2 secend: width=" + ((awim)((List)localObject1).get(paramInt1)).jdField_a_of_type_Int + " height=" + ((awim)((List)localObject1).get(paramInt1)).jdField_b_of_type_Int + " w/h=" + ((awim)((List)localObject1).get(paramInt1)).jdField_a_of_type_Int / ((awim)((List)localObject1).get(paramInt1)).jdField_b_of_type_Int);
              paramInt1 += 1;
            }
            f2 = 10000.0F;
          }
        ...
        if (((List)localObject1).size() == 0)
        {
          ...
          while (paramList.hasNext())
          {
            ...
            {
              paramInt1 = Math.max(((awim)localObject2).jdField_a_of_type_Int, ((awim)localObject2).jdField_b_of_type_Int);
              paramInt2 = Math.min(((awim)localObject2).jdField_a_of_type_Int, ((awim)localObject2).jdField_b_of_type_Int);
          ...
          if ((QLog.isColorLevel()) && (localObject1 != null))
          {
            ...
            {
              QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getHighVersionPreviewSizeV2 third: width=" + ((awim)((List)localObject1).get(paramInt1)).jdField_a_of_type_Int + " height=" + ((awim)((List)localObject1).get(paramInt1)).jdField_b_of_type_Int + " w/h=" + ((awim)((List)localObject1).get(paramInt1)).jdField_a_of_type_Int / ((awim)((List)localObject1).get(paramInt1)).jdField_b_of_type_Int);
              paramInt1 += 1;
            }
          }
        }
        if (((List)localObject1).size() > 0)
        {
          ...
          if ((localObject1 == null) || (((awim)localObject1).jdField_a_of_type_Int * ((awim)localObject1).jdField_b_of_type_Int <= paramList.jdField_a_of_type_Int * paramList.jdField_b_of_type_Int)) {
            break label882;
          }
  ...
  private int c()
  {
    ...
    float f = i * 1.0F / 8.0F;
    int j = (int)(this.jdField_a_of_type_Awim.jdField_b_of_type_Int * this.jdField_a_of_type_Awim.jdField_a_of_type_Int * f);
    if (QLog.isColorLevel()) {
      ...
      try
      {
        for (;;)
        {
          ...
          if (befo.c())
          {
            ...
            bhcs.a(jdField_b_of_type_JavaLangString, 1, "【Real Old openCamera】:" + this.jdField_a_of_type_Int);
            bhcs.a(jdField_b_of_type_JavaLangString, 1, "【Real Old openCamera】:currentCount= " + j);
          }
          for (this.jdField_a_of_type_AndroidHardwareCamera = Camera.open(this.jdField_a_of_type_Int);; this.jdField_a_of_type_AndroidHardwareCamera = Camera.open())
          {
            ...
            if (awih.a().a(this.jdField_a_of_type_AndroidHardwareCamera)) {
              break label323;
            }
            if (QLog.isColorLevel()) {
          ...
          try
          {
            ...
            i = 3;
            break label83;
            this.jdField_a_of_type_Awil = new awil(this);
  ...
  public awim a(int paramInt)
  {
    Object localObject2 = awih.a().a();
    int i;
    ...
    if (((List)localObject1).size() > 0)
    {
      ...
      for (paramInt = 2147483647; ((Iterator)localObject1).hasNext(); paramInt = i)
      {
        ...
        if (((Camera.Size)localObject2).width < paramInt)
        {
          ...
          localawim.jdField_b_of_type_Int = ((Camera.Size)localObject2).height;
          localawim.jdField_a_of_type_Int = ((Camera.Size)localObject2).width;
        }
      }
    }
  ...
  public awim a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    Object localObject2 = awih.a().a();
    ...
    label400:
    int i = awha.jdField_c_of_type_Int;
    int j = awha.d;
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (paramInt2 > 0)
      {
        localawim.jdField_b_of_type_Int = j;
        localawim.jdField_a_of_type_Int = paramInt2;
        if ((awii.a()) && (a((ArrayList)localObject3, i, j))) {
          localawim.jdField_a_of_type_Int = i;
        }
        return localawim;
      }
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        if ((localObject5 != null) && (a(paramInt1, paramInt3, paramInt4, ((Camera.Size)localObject5).width, ((Camera.Size)localObject5).height)))
        {
          ...
          if (l2 < l1)
          {
            localawim.jdField_a_of_type_Int = ((Camera.Size)localObject5).width;
            localawim.jdField_b_of_type_Int = ((Camera.Size)localObject5).height;
            l1 = l2;
          }
        }
        for (;;)
        {
          break;
          if ((l2 == l1) && (((Camera.Size)localObject5).width < localawim.jdField_a_of_type_Int))
          {
            localawim.jdField_a_of_type_Int = ((Camera.Size)localObject5).width;
            localawim.jdField_b_of_type_Int = ((Camera.Size)localObject5).height;
          }
      ...
      for (;;)
      {
        ...
        if (paramInt1 > 0)
        {
          localawim.jdField_b_of_type_Int = i;
          localawim.jdField_a_of_type_Int = paramInt1;
          return localawim;
        }
        if ((localawim.jdField_a_of_type_Int <= 0) || (localawim.jdField_b_of_type_Int <= 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if (localObject4 != null)
            {
              ...
              if (l2 < l1)
              {
                localawim.jdField_a_of_type_Int = ((Camera.Size)localObject4).width;
                localawim.jdField_b_of_type_Int = ((Camera.Size)localObject4).height;
                l1 = l2;
              }
            }
            for (;;)
            {
              break;
              if ((l2 == l1) && (((Camera.Size)localObject4).width < localawim.jdField_a_of_type_Int))
              {
                localawim.jdField_a_of_type_Int = ((Camera.Size)localObject4).width;
                localawim.jdField_b_of_type_Int = ((Camera.Size)localObject4).height;
              }
        ...
        if ((localawim.jdField_a_of_type_Int <= 0) || (localawim.jdField_b_of_type_Int <= 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if ((localObject3 != null) && (a(320, paramInt3, paramInt4, ((Camera.Size)localObject3).width, ((Camera.Size)localObject3).height)))
            {
              ...
              if (l2 < l1)
              {
                localawim.jdField_a_of_type_Int = ((Camera.Size)localObject3).width;
                localawim.jdField_b_of_type_Int = ((Camera.Size)localObject3).height;
                l1 = l2;
              }
            }
            for (;;)
            {
              break;
              if ((l2 == l1) && (((Camera.Size)localObject3).width < localawim.jdField_a_of_type_Int))
              {
                localawim.jdField_a_of_type_Int = ((Camera.Size)localObject3).width;
                localawim.jdField_b_of_type_Int = ((Camera.Size)localObject3).height;
              }
        ...
        if ((localawim.jdField_a_of_type_Int <= 0) || (localawim.jdField_b_of_type_Int <= 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            {
              break;
              if ((l2 == l1) && (((Camera.Size)localObject2).width < localawim.jdField_a_of_type_Int))
              {
                localawim.jdField_a_of_type_Int = ((Camera.Size)localObject2).width;
                localawim.jdField_b_of_type_Int = ((Camera.Size)localObject2).height;
              }
        ...
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getFullVideoPreviewSize[self-adaption] cSize.width=" + localawim.jdField_a_of_type_Int + "  cSize.height=" + localawim.jdField_b_of_type_Int);
        }
        if ((localawim.jdField_a_of_type_Int > 0) && (localawim.jdField_b_of_type_Int > 0)) {
          return localawim;
        }
  ...
  public awim a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    if ((!jdField_c_of_type_Boolean) && (this.jdField_a_of_type_AndroidHardwareCamera == null)) {
      throw new AssertionError();
    }
    if ((!jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Awim == null)) {
      throw new AssertionError();
    }
    if (a() == null) {
      return null;
    ...
    awim localawim = new awim();
    Object localObject1 = awih.a().b();
    if ((localObject1 == null) || (((List)localObject1).isEmpty())) {
      return null;
    }
    Object localObject2 = new awim();
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localSize != null)
      {
        ...
        if (localSize.width >= paramInt1)
        {
          ...
          {
            f2 = Math.abs(f4 - f3);
            ((awim)localObject2).jdField_a_of_type_Int = localSize.width;
            ((awim)localObject2).jdField_b_of_type_Int = localSize.height;
          }
        }
        f1 = f2;
      }
    }
    if ((localArrayList.isEmpty()) && (((awim)localObject2).jdField_a_of_type_Int >= paramInt1))
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "getPictureSize: width=" + ((awim)localObject2).jdField_a_of_type_Int + " height=" + ((awim)localObject2).jdField_b_of_type_Int + " w/h=" + ((awim)localObject2).jdField_a_of_type_Int / ((awim)localObject2).jdField_b_of_type_Int);
      }
      return localObject2;
    }
    if ((localArrayList.isEmpty()) && (((List)localObject1).size() > 0))
    {
      localawim.jdField_a_of_type_Int = ((Camera.Size)((List)localObject1).get(0)).width;
      localawim.jdField_b_of_type_Int = ((Camera.Size)((List)localObject1).get(0)).height;
      return localawim;
    }
    ...
    if (paramInt5 == -1)
    {
      ...
      {
        localObject2 = (Camera.Size)((Iterator)localObject1).next();
        if (localawim.jdField_a_of_type_Int < ((Camera.Size)localObject2).width)
        {
          localawim.jdField_a_of_type_Int = ((Camera.Size)localObject2).width;
          localawim.jdField_b_of_type_Int = ((Camera.Size)localObject2).height;
        }
    ...
    while (localawim.jdField_a_of_type_Int == 0)
    {
      return null;
      localawim = a(paramInt3, paramInt4, paramInt5, localArrayList);
    }
    return localawim;
  }
  
  public awim a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    int j = 0;
    if (QLog.isColorLevel()) {
      QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeV2: dstwidth=" + paramInt1 + "  dstheight=" + paramInt2);
    }
    Object localObject = awih.a().a();
    ...
    awim localawim = a((List)localObject, paramInt1, paramInt2);
    if (localawim != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeGuaranteeOK: DEFAULT resolution os OK.");
      }
      localObject = localawim;
      if (paramBoolean)
      {
        ahji.a(2, paramInt1, paramInt2, localawim.jdField_a_of_type_Int, localawim.jdField_b_of_type_Int);
        localObject = localawim;
      }
    }
    do
    {
      ...
      {
        return localObject;
        localawim = a((List)localObject, 960, 720);
        if (localawim == null) {
          break;
        }
        if (QLog.isColorLevel()) {
      ...
      ahji.a(3, paramInt1, paramInt2, localawim.jdField_a_of_type_Int, localawim.jdField_b_of_type_Int);
      return localawim;
      localawim = a((List)localObject, paramInt1, paramInt2, paramInt3, paramInt4);
      localObject = localawim;
    } while (!paramBoolean);
    if (localawim == null)
    {
    ...
    label379:
    for (paramInt4 = j;; paramInt4 = localawim.jdField_b_of_type_Int)
    {
      ahji.a(4, paramInt1, paramInt2, paramInt3, paramInt4);
      return localawim;
      paramInt3 = localawim.jdField_a_of_type_Int;
      break;
    }
  }
  
  public awim a(int paramInt1, int paramInt2, int paramInt3, List<Camera.Size> paramList)
  {
  ...
  @TargetApi(17)
  public void a(File paramFile, Rect paramRect, ahns paramahns, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    if (this.jdField_a_of_type_AndroidHardwareCamera == null) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_AndroidHardwareCamera.takePicture(null, null, null, new awik(this, paramInt1, l, paramFile, paramRect, paramahns, paramBoolean, paramInt2));
          return;
        }
  ...
  public boolean a(awim paramawim)
  {
    ...
    try
    {
      localParameters.setPreviewSize(paramawim.jdField_a_of_type_Int, paramawim.jdField_b_of_type_Int);
      this.jdField_a_of_type_Awim = paramawim;
      boolean bool = a(localParameters);
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] setParamsPreviewSize, result = " + bool + ",size.width = " + paramawim.jdField_a_of_type_Int + ",size.height = " + paramawim.jdField_b_of_type_Int);
      }
      return bool;
    }
    catch (Exception paramawim)
    {
      paramawim.printStackTrace();
    }
    return false;
  }
  
  public boolean a(awja paramawja)
  {
    Camera.Parameters localParameters = a();
    if (localParameters == null)
    {
    ...
    localParameters.setPreviewFormat(paramawja.jdField_a_of_type_Int);
    localParameters.setPreviewSize(paramawja.jdField_a_of_type_Awim.jdField_a_of_type_Int, paramawja.jdField_a_of_type_Awim.jdField_b_of_type_Int);
    localParameters.setPreviewFpsRange(paramawja.jdField_b_of_type_Int, paramawja.jdField_c_of_type_Int);
    if (paramawja.jdField_a_of_type_Boolean) {
      localParameters.setPictureSize(paramawja.jdField_b_of_type_Awim.jdField_a_of_type_Int, paramawja.jdField_b_of_type_Awim.jdField_b_of_type_Int);
    }
    boolean bool = a(localParameters);
    if (bool)
    {
      this.jdField_b_of_type_Int = paramawja.jdField_a_of_type_Int;
      this.jdField_a_of_type_Awim = paramawja.jdField_a_of_type_Awim;
      this.jdField_a_of_type_ArrayOfInt = new int[] { paramawja.jdField_b_of_type_Int, paramawja.jdField_c_of_type_Int };
      this.jdField_b_of_type_Awim = paramawja.jdField_b_of_type_Awim;
    }
    return bool;
  }
  ...
  public awim[] a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    awim localawim1 = a(paramInt1, paramInt2, paramInt3, paramInt4, true);
    if (localawim1 != null)
    {
      arrayOfawim[0] = localawim1;
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee way2 preview=" + localawim1.jdField_a_of_type_Int + " " + localawim1.jdField_b_of_type_Int);
      }
      awim localawim2 = a(localawim1.jdField_a_of_type_Int, localawim1.jdField_b_of_type_Int, paramInt3, paramInt4, 1);
      arrayOfawim[1] = localawim2;
      if (localawim2 != null)
      {
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee way2 picture=" + localawim2.jdField_a_of_type_Int + " " + localawim2.jdField_b_of_type_Int);
        }
        ahji.a(true, localawim1.jdField_a_of_type_Int, localawim1.jdField_b_of_type_Int, localawim2.jdField_a_of_type_Int, localawim2.jdField_b_of_type_Int);
      }
    }
    else
    {
    ...
    ahji.a(true, localawim1.jdField_a_of_type_Int, localawim1.jdField_b_of_type_Int, -1, -1);
    return arrayOfawim;
  }
  ...
  public awim b(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
    ...
    awim localawim = a((List)localObject, paramInt1, paramInt2, 2600, 1500, (int)f1, 1000);
    if (localawim != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeGuaranteeOK: DEFAULT resolution os OK.");
    ...
    do
    {
      ...
      localawim = a((List)localObject, paramInt1, paramInt2, 2600, 1500, (int)f1, 700);
      if (localawim == null) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    label444:
    label453:
    for (paramInt4 = 0;; paramInt4 = ((awim)localObject).jdField_b_of_type_Int)
    {
      ahji.a(4, paramInt1, paramInt2, paramInt3, paramInt4);
      return localObject;
      paramInt3 = ((awim)localObject).jdField_a_of_type_Int;
      break;
    }
  }
  ...
  public void b()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Awim = null;
  ...
  public boolean b()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 347	awij:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   4: ifnonnull +5 -> 9
    //   7: iconst_0
    //   8: ireturn
    //   9: aload_0
    //   10: getfield 528	awij:jdField_a_of_type_Boolean	Z
    //   13: ifne +5 -> 18
    //   16: iconst_1
    //   17: ireturn
    //   18: aload_0
    //   19: iconst_0
    //   20: putfield 528	awij:jdField_a_of_type_Boolean	Z
    //   23: aload_0
    //   24: invokespecial 594	awij:h	()Z
    //   27: istore_1
    //   28: iload_1
    //   29: ifeq +10 -> 39
    //   32: aload_0
    //   33: getfield 347	awij:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   36: invokevirtual 597	android/hardware/Camera:cancelAutoFocus	()V
    //   39: aload_0
    //   40: getfield 347	awij:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   43: invokevirtual 749	android/hardware/Camera:stopPreview	()V
    //   46: aload_0
    //   47: getfield 347	awij:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   50: aconst_null
    //   51: invokevirtual 620	android/hardware/Camera:setPreviewCallback	(Landroid/hardware/Camera$PreviewCallback;)V
    //   54: aload_0
    //   55: getfield 347	awij:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   58: aconst_null
    //   59: invokevirtual 616	android/hardware/Camera:setPreviewDisplay	(Landroid/view/SurfaceHolder;)V
    //   62: iconst_1
    //   63: ireturn
    //   64: astore_2
    //   65: iconst_0
  ...
  public boolean b(awim paramawim)
  {
    ...
    do
    {
      ...
      try
      {
        localParameters.setPictureSize(paramawim.jdField_a_of_type_Int, paramawim.jdField_b_of_type_Int);
        this.jdField_b_of_type_Awim = paramawim;
        boolean bool = a(localParameters);
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "setRawPictureSize w " + paramawim.jdField_a_of_type_Int + ", h " + paramawim.jdField_b_of_type_Int + ", success=" + bool);
        }
        return bool;
      }
      catch (Exception paramawim)
    ...
    QLog.i(jdField_b_of_type_JavaLangString, 2, "setParamsPictureSize", paramawim);
    return false;
  }
  ...
  public awim[] b(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (QLog.isColorLevel()) {
    ...
    awim[] arrayOfawim = new awim[2];
    awim localawim1 = b(paramInt1, paramInt2, paramInt3, paramInt4, true);
    if (localawim1 != null)
    {
      arrayOfawim[0] = localawim1;
      if (QLog.isColorLevel()) {
  ...
  public awim c(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    int j = 0;
    if (QLog.isColorLevel()) {
    ...
    awim localawim = a((List)localObject, awha.jdField_c_of_type_Int, awha.d);
    if (localawim != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeGuaranteeOK: DEFAULT resolution os OK.");
      ...
      if (paramBoolean)
      {
        ahji.a(2, awha.jdField_c_of_type_Int, awha.d, localawim.jdField_a_of_type_Int, localawim.jdField_b_of_type_Int);
        localObject = localawim;
      }
    }
    do
    {
      do
      {
        ...
        localawim = a((List)localObject, awha.jdField_a_of_type_ArrayOfInt[1], awha.b[1]);
        if (localawim == null) {
          break;
        }
        if (QLog.isColorLevel()) {
      ...
      ahji.a(3, awha.jdField_c_of_type_Int, awha.d, localawim.jdField_a_of_type_Int, localawim.jdField_b_of_type_Int);
      return localawim;
      localawim = a((List)localObject, paramInt1, paramInt2, paramInt3, paramInt4);
      localObject = localawim;
    } while (!paramBoolean);
    ...
    label413:
    for (paramInt2 = j;; paramInt2 = localawim.jdField_b_of_type_Int)
    {
      ahji.a(4, awha.jdField_c_of_type_Int, awha.d, paramInt1, paramInt2);
      return localawim;
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_Int == 1)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.i(jdField_b_of_type_JavaLangString, 2, "setDisplayOrientation degrees=" + i + " blackPhone=" + bool1 + " camera=" + ahhj.jdField_a_of_type_Int + " rom_black=" + bool2);
          }
          return true;
          i = 0;
          break;
  ...
  public awim[] c(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (QLog.isColorLevel()) {
      QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee wanted size=" + awha.jdField_c_of_type_Int + " " + awha.d + " cliped=" + paramInt1 + " " + paramInt2);
    }
    if (0 != 0)
    {
      paramInt1 = awha.jdField_c_of_type_Int;
      paramInt1 = awha.d;
      throw new NullPointerException();
    }
    awim[] arrayOfawim = new awim[2];
    awim localawim2 = c(paramInt1, paramInt2, paramInt3, paramInt4, true);
    if (localawim2 != null)
    {
      arrayOfawim[0] = localawim2;
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee way2 preview=" + localawim2.jdField_a_of_type_Int + " " + localawim2.jdField_b_of_type_Int);
      }
      awim localawim1 = a(localawim2.jdField_a_of_type_Int, localawim2.jdField_b_of_type_Int, paramInt3, paramInt4, 1);
      arrayOfawim[1] = localawim1;
      if (localawim1 != null)
      {
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee way2 picture=" + localawim1.jdField_a_of_type_Int + " " + localawim1.jdField_b_of_type_Int);
        }
        ahji.a(true, localawim2.jdField_a_of_type_Int, localawim2.jdField_b_of_type_Int, localawim1.jdField_a_of_type_Int, localawim1.jdField_b_of_type_Int);
        return arrayOfawim;
      }
      ahji.a(true, localawim2.jdField_a_of_type_Int, localawim2.jdField_b_of_type_Int, -1, -1);
    }
    return arrayOfawim;
  }
