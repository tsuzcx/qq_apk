  ...
  extends aktf
{
  ...
  akvj(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  protected void b()
  {
    ...
    {
      bdmc.a(localNewPhotoListActivity).a(null, "sendAlbumRecent", true, 0L, 0L, null, "");
      if (this.mPhotoCommonData.selectedPhotoList != null)
      {
        akrx.a(localNewPhotoListActivity.getIntent(), this.mPhotoCommonData.selectedPhotoList.size());
        akrx.a(localNewPhotoListActivity.getIntent(), this.mPhotoCommonData.selectedPhotoList.size(), this.mPhotoCommonData.currentQualityType);
      }
    ...
    for (ArrayList localArrayList = new ArrayList(0);; localArrayList = this.mPhotoCommonData.selectedPhotoList)
    {
      ...
      bhkd.anim(localNewPhotoListActivity, false, false);
      return;
      ...
      {
        bdmc.a(localNewPhotoListActivity).a(null, "sendAlbumRecent", false, 0L, 0L, null, "");
        break;
      }
      bdmc.a(localNewPhotoListActivity).a(null, "sendAlbumOther", true, 0L, 0L, null, "");
      break;
    }
  }
  ...
  public void initData(Intent paramIntent)
  {
    ...
    localObject = bobx.a(((NewPhotoListActivity)localObject).getApplicationContext(), this.mPhotoCommonData.myUin, "pref_select_album");
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      localObject = bobx.a((String)localObject);
      if ((localObject != null) && (!((List)localObject).isEmpty())) {
        this.mPhotoCommonData.albumId = ((String)((List)localObject).get(0));
      }
    }
    this.jdField_a_of_type_Akte.isRecodeLastAlbumPath = false;
  ...
  public void postInitUI()
  {
    ...
    {
      return;
      View localView = localNewPhotoListActivity.findViewById(2131369042);
      if (localView != null) {
        localView.setContentDescription(localNewPhotoListActivity.getString(2131719404));
      }
