  ...
  extends bgmd
{
  ...
  private bgly jdField_a_of_type_Bgly;
  ...
  public bglw(BaseChatPie paramBaseChatPie, AppShortcutBarScrollView paramAppShortcutBarScrollView, agvc paramagvc)
  {
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bglx(this);
    ...
    this.c = ((LinearLayout)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131372255));
    this.jdField_a_of_type_Agwg = ((agwg)paramagvc);
    this.jdField_a_of_type_Long = this.jdField_a_of_type_Agwg.b();
  }
  
  private void a(bgkn parambgkn, View paramView)
  {
    boolean bool1 = true;
    paramView.setTag(parambgkn);
    ...
    Object localObject = (TextView)paramView.findViewById(2131377581);
    ((TextView)localObject).setText(parambgkn.a());
    label98:
    String str;
    if (bool2)
    {
      ((TextView)localObject).setTextColor(Color.parseColor("#ffffff"));
      localObject = (LinearLayout)paramView.findViewById(2131377578);
      if (!bool2) {
        break label221;
      }
      ...
      localObject = (TextView)paramView.findViewById(2131377580);
      if ((parambgkn.b() == 0) && (!parambgkn.a())) {
        break label244;
      }
      ((TextView)localObject).setVisibility(0);
      ((TextView)localObject).setText("");
      ((TextView)localObject).setBackgroundResource(0);
      ((TextView)localObject).setCompoundDrawablesWithIntrinsicBounds(2130837961, 0, 0, 0);
      label152:
      paramView = (URLImageView)paramView.findViewById(2131377579);
      if (!bool2) {
        break label253;
      }
    ...
    for (;;)
    {
      bgqr.a((Context)localObject, paramView, str, 19.0F, bool1);
      return;
  ...
  private void e()
  {
    bgkn localbgkn = bgkn.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext.getResources().getString(2131695547), "https://sola.gtimg.cn/aoi/sola/20200528211216_3ydkcWft2I.png");
    View localView = View.inflate(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, 2131561640, null);
    a(localbgkn, localView);
  ...
  public void a(ArrayList<bgkm> paramArrayList, boolean paramBoolean)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (this.jdField_b_of_type_AndroidWidgetLinearLayout != null)
        {
          ...
          {
            long l2 = 0L;
            this.jdField_a_of_type_Bgly = new bgly();
            ...
            while (paramArrayList.hasNext())
            {
              ...
              if ((localObject != null) && ((localObject instanceof bgkn))) {
                localObject = (bgkn)localObject;
              }
              try
              {
                View localView = View.inflate(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, 2131561640, null);
                a((bgkn)localObject, localView);
                this.jdField_b_of_type_AndroidWidgetLinearLayout.addView(localView);
                localView.setId((int)((bgkn)localObject).c());
                this.jdField_a_of_type_Bgly.jdField_b_of_type_Int = localView.getWidth();
                k = j;
                if (j != 0)
                {
                  LinearLayout.LayoutParams localLayoutParams = (LinearLayout.LayoutParams)localView.getLayoutParams();
                  localLayoutParams.setMargins(agej.a(14.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().getResources()), 0, 0, 0);
                  localView.setLayoutParams(localLayoutParams);
                  k = 0;
                }
                bool = true;
                long l1 = l2;
                if (((bgkn)localObject).a())
                {
                  l1 = l2;
                  if (this.c.getChildCount() == 0)
                  {
                    this.jdField_a_of_type_Bgly.jdField_a_of_type_Boolean = true;
                    l1 = l2;
                    if (((bgkn)localObject).d() > l2)
                    {
                      l2 = ((bgkn)localObject).d();
                      l1 = l2;
                      if (i > this.jdField_a_of_type_Bgly.jdField_a_of_type_Int)
                      {
                        this.jdField_a_of_type_Bgly.jdField_a_of_type_Int = i;
                        this.jdField_a_of_type_Bgly.jdField_a_of_type_Long = ((bgkn)localObject).c();
                        l1 = l2;
                      }
                    }
                  }
                ...
                if (i == 4) {
                  this.jdField_a_of_type_Bgly.jdField_b_of_type_Long = ((bgkn)localObject).c();
                }
                i += 1;
                j = k;
                l2 = l1;
          ...
          try
          {
            ...
            if (bool)
            {
              ...
              if (!this.jdField_b_of_type_Boolean)
              {
                ...
                bdll.b(null, "dc00898", "", "", "0X800ACFF", "0X800ACFF", 0, 0, "", paramArrayList, String.valueOf(((TroopInfo)localObject).dwGroupClassExt), "");
              }
      ...
      this.jdField_a_of_type_Boolean = false;
    } while (this.jdField_a_of_type_Agwg == null);
    this.jdField_a_of_type_Agwg.h();
  }
  ...
  public void d()
  {
    ...
    if (i < this.jdField_b_of_type_AndroidWidgetLinearLayout.getChildCount())
    {
      ...
      if ((localObject != null) && (((View)localObject).getLocalVisibleRect(localRect)))
      {
        ...
        if ((localObject instanceof bgkn))
        {
          localObject = (bgkn)localObject;
          if (localObject != null)
          {
            l = ((bgkn)localObject).c();
    ...
    for (int j = 1;; j = 0)
    {
      if (j == 0)
      {
        ...
        bdll.b(null, "dc00898", "", "", "0X800AAD3", "0X800AAD3", 0, 0, String.valueOf(l), str, String.valueOf(localTroopInfo.dwGroupClassExt), "");
      }
      i += 1;
      break label88;
      break;
