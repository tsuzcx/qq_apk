  ...
  extends bnjo
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bnjs.class.getSimpleName();
  }
  
  public bnjs(PeakAppInterface paramPeakAppInterface)
  {
  ...
  public static String a(android.content.Context paramContext, Bitmap paramBitmap)
  {
    ...
    //   3: dup
    //   4: getstatic 34	bmwj:b	Ljava/lang/String;
    ...
    //   159: dup
    //   160: aload 9
    //   162: invokestatic 93	com/tencent/mobileqq/utils/FileUtils:createFile	(Ljava/lang/String;)Ljava/io/File;
    //   165: invokespecial 96	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   168: invokespecial 99	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   171: astore 6
    //   173: aload 6
    //   175: astore 7
    //   177: aload_1
    //   178: getstatic 105	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   181: bipush 100
    //   183: aload 6
    //   185: invokevirtual 109	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   188: pop
    //   189: aload 6
    //   191: ifnull +8 -> 199
    //   194: aload 6
    //   196: invokevirtual 112	java/io/BufferedOutputStream:close	()V
    //   199: aload_1
    //   200: invokevirtual 115	android/graphics/Bitmap:isRecycled	()Z
    //   203: ifne +7 -> 210
    //   206: aload_1
    //   207: invokevirtual 118	android/graphics/Bitmap:recycle	()V
    //   210: aload_0
    //   211: aload 9
    //   213: aload 10
    //   215: iload_3
    //   216: iload_2
    //   217: invokestatic 123	bheg:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;II)V
    //   220: iconst_0
    //   221: istore 5
    //   223: iload_3
    //   224: istore 4
    ...
    //   240: astore_1
    //   241: aload_1
    //   242: invokevirtual 126	java/io/File:length	()J
    //   245: ldc2_w 127
    //   248: lcmp
    //   249: ifle +344 -> 593
    //   252: iload_2
    ...
    //   281: bipush 100
    //   283: iload 4
    //   285: invokestatic 136	java/lang/Math:max	(II)I
    //   288: bipush 100
    //   290: iload_3
    //   291: invokestatic 136	java/lang/Math:max	(II)I
    //   294: invokestatic 123	bheg:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;II)V
    //   297: iload_2
    //   298: iconst_1
    //   299: iadd
    //   300: istore_2
    //   301: goto -70 -> 231
    //   304: astore 6
    //   306: getstatic 16	bnjs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   321: aload 6
    //   323: invokevirtual 139	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   332: invokestatic 145	bnrh:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   335: goto -136 -> 199
    //   338: astore 8
    //   340: aconst_null
    //   341: astore 6
    //   343: aload 6
    //   345: astore 7
    //   347: getstatic 16	bnjs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   362: aload 8
    //   364: invokevirtual 139	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   373: invokestatic 145	bnrh:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   376: aload 6
    //   378: ifnull +8 -> 386
    //   381: aload 6
    //   383: invokevirtual 112	java/io/BufferedOutputStream:close	()V
    //   386: aload_1
    //   387: invokevirtual 115	android/graphics/Bitmap:isRecycled	()Z
    //   390: ifne -180 -> 210
    //   393: aload_1
    //   394: invokevirtual 118	android/graphics/Bitmap:recycle	()V
    //   397: goto -187 -> 210
    //   400: astore 6
    //   402: getstatic 16	bnjs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   417: aload 6
    //   419: invokevirtual 139	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   428: invokestatic 145	bnrh:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   431: goto -45 -> 386
    //   434: astore 7
    //   436: aload 8
    //   438: astore 6
    ...
    //   444: aload 6
    //   446: astore 7
    //   448: getstatic 16	bnjs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   463: aload 8
    //   465: invokevirtual 146	java/lang/OutOfMemoryError:toString	()Ljava/lang/String;
    ...
    //   474: invokestatic 145	bnrh:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   477: aload 6
    //   479: ifnull +8 -> 487
    //   482: aload 6
    //   484: invokevirtual 112	java/io/BufferedOutputStream:close	()V
    //   487: aload_1
    //   488: invokevirtual 115	android/graphics/Bitmap:isRecycled	()Z
    //   491: ifne -281 -> 210
    //   494: aload_1
    //   495: invokevirtual 118	android/graphics/Bitmap:recycle	()V
    //   498: goto -288 -> 210
    //   501: astore 6
    //   503: getstatic 16	bnjs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   518: aload 6
    //   520: invokevirtual 139	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   529: invokestatic 145	bnrh:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   532: goto -45 -> 487
    //   535: astore_0
    //   536: aload 7
    //   538: ifnull +8 -> 546
    //   541: aload 7
    //   543: invokevirtual 112	java/io/BufferedOutputStream:close	()V
    //   546: aload_1
    //   547: invokevirtual 115	android/graphics/Bitmap:isRecycled	()Z
    //   550: ifne +7 -> 557
    //   553: aload_1
    //   554: invokevirtual 118	android/graphics/Bitmap:recycle	()V
    //   557: aload_0
    //   558: athrow
    //   559: astore 6
    //   561: getstatic 16	bnjs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   576: aload 6
    //   578: invokevirtual 139	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   587: invokestatic 145	bnrh:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   590: goto -44 -> 546
    //   593: aload_1
    //   594: invokevirtual 126	java/io/File:length	()J
    //   597: ldc2_w 127
    //   600: lcmp
    //   601: ifle +6 -> 607
    //   604: ldc 74
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      if ((localObject != null) && (((GetBulkImageClassifyRsp)localObject).MiltiRsps != null))
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          paramObject.add(new bnwc(localSmartFilterRspItem.PituLabel, localSmartFilterRspItem.DisplayLabels));
        }
        bnuz.a().a(paramObject, paramToServiceMsg.hashCode());
      }
      paramToServiceMsg = bnqm.a();
    ...
    for (long l1 = ((Long)this.jdField_a_of_type_JavaUtilMap.get("CameraModuleSvc.GetBulkImageClassify")).longValue();; l1 = 0L)
    {
      ...
      {
        bnuz.a().a(-6, paramToServiceMsg.hashCode());
        break;
      }
      bnuz.a().a(-1, paramToServiceMsg.hashCode());
      break;
    }
  }
  ...
  private void b(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      localbnqm.a(i, String.valueOf(l2 - l1), "CameraModuleSvc.GetFontData", paramObject.Code);
      return;
    }
  }
    ...
    for (int i = paramObject.ValidStatus;; i = -2)
    {
      ...
      if ((paramFromServiceMsg != null) && (paramObject != null))
      {
        ...
        if (this.jdField_a_of_type_JavaUtilMap.containsKey("CameraModuleSvc.GetImgValidStatus"))
        {
          ...
          localbnqm.a(j, String.valueOf(l2 - l1), "CameraModuleSvc.GetImgValidStatus", paramObject.Code);
        }
      }
      else
      {
  ...
  private void d(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      localbnqm.a(i, String.valueOf(l2 - l1), "CameraModuleSvc.GetOnlineUserNum", paramObject.Code);
      return;
    }
  }
        ...
        try
        {
          ...
          if ((paramFromServiceMsg != null) && (localGetRecommandTextByEmotionRsp != null))
          {
            ...
            if (this.jdField_a_of_type_JavaUtilMap.containsKey("CameraModuleSvc.GetRecommandTextByEmotion"))
            {
              ...
              localbnqm.a(i, String.valueOf(l2 - l1), "CameraModuleSvc.GetRecommandTextByEmotion", localGetRecommandTextByEmotionRsp.Code);
            }
          }
          else
          {
            notifyUI(1, bool, new bnme(localArrayList, str, paramObject));
            return;
          }
        }
  ...
  private void f(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      {
        localbnqm.a(i, String.valueOf(l2 - l1), "CameraModuleSvc.GetTextValidStatus", paramObject.Code);
  ...
  public void a(ArrayList<SmartFilterReqItem> paramArrayList, bnvd parambnvd)
  {
    if (!NetworkUtil.isNetworkAvailable()) {
      LogUtils.w("111", "[reqRecommandTextByEmotion] no network....");
    }
    ...
    do
    {
      ...
      localToServiceMsg = new ToServiceMsg("CameraModuleSvc", this.mApp.getCurrentAccountUin(), "CameraModuleSvc.GetBulkImageClassify");
      localToServiceMsg.extraData.putSerializable("AI_FILTER_REQ_PICS", paramArrayList);
      send(localToServiceMsg);
    } while (parambnvd == null);
    parambnvd.a(localToServiceMsg.hashCode());
  }
  ...
  public void b(String paramString)
  {
    ...
    FaceChangeUtils.cropFace(paramString, new bnjt(this, localToServiceMsg));
  }
