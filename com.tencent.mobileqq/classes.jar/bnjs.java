...
public class bnjs
{
  ...
  {
    return bmxr.d + File.separator + paramString;
  }
  ...
  public static boolean a(Activity paramActivity, Bitmap paramBitmap, int paramInt, String paramString)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      if (paramActivity != null) {
        bool1 = bnko.a(paramActivity, new bnju(paramBitmap, paramInt, paramString, paramActivity), 1);
      }
    }
    if (bool1) {
  ...
  public static boolean a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      bool1 = bool2;
      if (paramActivity != null) {
        bool1 = bnko.a(paramActivity, new bnjt(paramString1, paramString2, paramActivity), 1);
      }
    }
    if (bool1) {
  ...
  public static boolean a(Activity paramActivity, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      bool1 = bool2;
      if (paramActivity != null) {
        bool1 = bnko.a(paramActivity, new bnjv(paramString1, paramString2, paramString3, paramActivity), 1);
      }
    }
    if (bool1) {
  ...
  private static boolean b(Bitmap paramBitmap, int paramInt, String paramString)
  {
    ...
    //   14: getstatic 23	bmxr:d	Ljava/lang/String;
    ...
    //   33: invokespecial 87	java/io/File:<init>	(Ljava/lang/String;)V
    //   36: astore 6
    //   38: aload 6
    //   40: invokevirtual 91	java/io/File:exists	()Z
    //   43: ifne +7 -> 50
    //   46: aload_0
    //   47: ifnonnull +5 -> 52
    //   50: iconst_0
    //   51: ireturn
    //   52: aload 6
    //   54: invokevirtual 94	java/io/File:createNewFile	()Z
    //   57: istore_3
    //   58: iload_3
    //   59: ifne +18 -> 77
    //   62: iconst_0
    //   63: ifeq -13 -> 50
    //   66: new 96	java/lang/NullPointerException
    //   69: dup
    //   70: invokespecial 97	java/lang/NullPointerException:<init>	()V
    //   73: athrow
    //   74: astore_0
    //   75: iconst_0
    //   76: ireturn
    //   77: new 99	java/io/BufferedOutputStream
    //   80: dup
    //   81: new 101	java/io/FileOutputStream
    //   84: dup
    //   85: aload 6
    //   87: invokespecial 104	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   90: invokespecial 107	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   93: astore 5
    //   95: aload 5
    //   97: astore_2
    //   98: aload_0
    //   99: getstatic 113	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   102: iload_1
    //   103: aload 5
    //   105: invokevirtual 119	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   108: pop
    //   109: aload 5
    //   111: astore_2
    //   112: new 121	android/content/Intent
    //   115: dup
    //   116: ldc 123
    //   118: aload 6
    //   120: invokestatic 129	android/net/Uri:fromFile	(Ljava/io/File;)Landroid/net/Uri;
    //   123: invokespecial 132	android/content/Intent:<init>	(Ljava/lang/String;Landroid/net/Uri;)V
    //   126: astore_0
    //   127: aload 5
    //   129: astore_2
    //   130: invokestatic 138	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   133: aload_0
    //   134: invokevirtual 144	com/tencent/qphone/base/util/BaseApplication:sendBroadcast	(Landroid/content/Intent;)V
    //   137: iload 4
    //   139: istore_3
    //   140: aload 5
    //   142: ifnull +11 -> 153
    //   145: aload 5
    //   147: invokevirtual 147	java/io/BufferedOutputStream:close	()V
    //   150: iload 4
    //   152: istore_3
    //   153: iload_3
    //   154: ireturn
    ...
    //   164: ldc 151
    //   166: aload 6
    //   168: invokestatic 157	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   171: aload_0
    //   172: ifnull +7 -> 179
    //   175: aload_0
    //   176: invokevirtual 147	java/io/BufferedOutputStream:close	()V
    //   179: iconst_0
    //   180: istore_3
    //   181: goto -28 -> 153
    //   184: astore_0
    ...
    //   194: ifnull +7 -> 201
    //   197: aload_2
    //   198: invokevirtual 147	java/io/BufferedOutputStream:close	()V
    //   201: aload_0
    //   202: athrow
    //   203: astore_0
    //   204: iload 4
  ...
  private static boolean b(String paramString1, String paramString2)
  {
    try
    {
      ...
      paramString2 = new File(bmxr.d + File.separator + paramString2);
      bnjl.a(paramString1, paramString2);
