  ...
  implements DialogInterface.OnDismissListener, AdapterView.OnItemClickListener, bemt
{
  ...
  public int a;
  public long a;
  private acsd jdField_a_of_type_Acsd;
  public Activity a;
  ...
  public acsb(Activity paramActivity, WebView paramWebView)
  {
  ...
  public void a(int paramInt, String paramString, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        ...
        vvp.a(2, 2131625733);
        if ((this.h) && (!TextUtils.isEmpty(this.jdField_a_of_type_Xdt.p))) {
      ...
      for (;;)
      {
        ...
        if (paramInt == 11)
        {
          ...
          try
          {
            ...
            if (i != 0)
            {
              ...
              localObject1 = bcdu.b(paramString + 200 + (String)localObject3 + "jubao@article@123");
              ...
              ndn.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1008, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
            }
          }
        ...
        else
        {
          if (paramInt == 2)
          {
            ...
            for (;;)
            {
              this.jdField_a_of_type_Xdt.g = bool1;
          ...
          if (paramInt == 4)
          {
            ...
            try
            {
              ...
              awqx.b(null, "P_CliOper", "VIPCOMIC", "", "0X800619F", "0X800619F", 1000, 0, mpw.b(str2, new String[0]), null, null, null);
              awqx.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_48", "browser_share", 0, 1, 0, "", "", "", "");
              if ((str3 == null) || ("".equals(str3))) {
                continue;
              }
              ndn.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1006, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
            }
          ...
          else if (paramInt != 5)
          {
            if (paramInt == 3)
            {
              ...
              rtr.a(1002, (String)localObject1, this.jdField_b_of_type_Int);
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Xdt.p)) {
                this.jdField_a_of_type_Xdt.a((String)localObject4, 2, false);
              }
              for (;;)
              {
            ...
            if (paramInt == 6)
            {
              if (this.jdField_a_of_type_Xdt.a((String)localObject4)) {
                this.jdField_a_of_type_Xdt.a((String)localObject4, 9, false);
              }
              if ((str3 != null) && (!"".equals(str3))) {
                ndn.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1007, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
              }
            }
            else if ((paramInt == 9) || (paramInt == 10))
            {
              ...
              if (paramInt == 9)
              {
                rtr.a(1003, (String)localObject1, this.jdField_b_of_type_Int);
              ...
              for (;;)
              {
                ...
                break;
                rtr.a(1004, (String)localObject1, this.jdField_b_of_type_Int);
                break label1289;
              ...
              {
                if (!TextUtils.isEmpty(this.jdField_a_of_type_Xdt.p)) {
                  this.jdField_a_of_type_Xdt.a((String)localObject4, 3, true);
                }
                for (;;)
                {
                  ...
                  ndn.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1003, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
                  break;
              ...
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Xdt.p)) {
                this.jdField_a_of_type_Xdt.a((String)localObject4, 4, true);
              }
              for (;;)
              {
            ...
            {
              this.jdField_a_of_type_Xdt.a((String)localObject4, 5, true);
            }
            else if (paramInt == 15)
            {
              if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment == null) {
              ...
              a().a(j, new acsc(this));
              awqx.b(null, "P_CliOper", "Grp_open", "", "third_app", "add_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 16)
            {
              ...
              this.jdField_a_of_type_AndroidAppActivity.startActivity(paramString);
              awqx.b(null, "P_CliOper", "Grp_open", "", "third_app", "detail_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 17)
            {
              paramString = "";
              ...
              paramBundle.putExtra("hide_more_button", true);
              this.jdField_a_of_type_AndroidAppActivity.startActivity(paramBundle);
              awqx.b(null, "P_CliOper", "Grp_open", "", "third_app", "share_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 7)
            {
              b();
            ...
            else if ((paramInt == 19) || (paramInt == 20))
            {
              ...
              for (i = 6;; i = 7)
              {
                ...
                this.jdField_a_of_type_Xdt.a((String)localObject4, i, false);
                break;
              }
              this.jdField_a_of_type_Xdt.a((String)localObject4, i, true);
            }
            else
            {
              if (paramInt == 12)
              {
                if (!TextUtils.isEmpty(this.jdField_a_of_type_Xdt.p)) {
                  this.jdField_a_of_type_Xdt.a((String)localObject4, 8, false);
                }
                for (;;)
                {
                  ...
                  ndn.a(null, "", "0X800787A", "0X800787A", 0, 0, (String)localObject1, paramBundle, "", "");
                  rtr.a(1005, paramBundle, this.jdField_b_of_type_Int);
                  break;
                  this.jdField_a_of_type_Xdt.a((String)localObject4, 8, false);
                }
              }
              ...
              else if (paramInt == 35)
              {
                ...
                if (this.jdField_b_of_type_JavaUtilArrayList != null)
                {
                  ...
                  do
                  {
                    ...
                    paramString = (nct)((Iterator)localObject2).next();
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Acsd = new acsd();
      ...
      try
      {
        this.jdField_a_of_type_Acsd.jdField_a_of_type_Long = Long.parseLong(str, 10);
      ...
      catch (NumberFormatException localNumberFormatException2)
      {
        try
        {
          this.jdField_a_of_type_Acsd.jdField_b_of_type_Long = Long.parseLong(str, 10);
        ...
        catch (NumberFormatException localNumberFormatException2)
        {
          try
          {
            for (;;)
            {
              this.jdField_a_of_type_Acsd.c = Long.parseLong(str, 10);
              ...
              try
              {
                this.jdField_a_of_type_Acsd.d = Long.parseLong(paramString, 10);
                return;
              }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      rtr.a(1001, paramString3, this.jdField_b_of_type_Int);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Xdt.p)) {
  ...
  public void a(xdt paramxdt)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Long = this.jdField_a_of_type_Acsd.jdField_a_of_type_Long;
      a();
      c();
  ...
  public List<bahx>[] a()
  {
    ...
    for (Object localObject1 = BaseApplicationImpl.getApplication().getRuntime();; localObject1 = null)
    {
      ...
      if ((!rsv.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:qiDian")) && ((this.jdField_a_of_type_Long & 0x10) == 0L)) {
        bcpn.a(this.jdField_a_of_type_AndroidAppActivity, localArrayList);
      }
      ...
      if ((this.jdField_e_of_type_Boolean) && (this.jdField_b_of_type_JavaUtilArrayList != null))
      {
        ...
        {
          localObject3 = (nct)localIterator.next();
          localbahx = new bahx();
          ...
          case 1: 
            ...
            for (localbahx.jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getString(2131629864);; localbahx.jdField_a_of_type_JavaLangString = ((nct)localObject3).jdField_a_of_type_JavaLangString)
            {
              ...
              ((ArrayList)localObject2).add(localbahx);
              break;
            }
          case 2: 
  ...
  public void b()
  {
    Object localObject = this.jdField_a_of_type_AndroidAppActivity.getLayoutInflater().inflate(2131493482, null);
    ...
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new bemx(ajjy.a(2131636624), TypedValue.applyDimension(1, 15.0F, ajia.a)));
    localArrayList.add(new bemx(ajjy.a(2131636628), TypedValue.applyDimension(1, 16.0F, ajia.a)));
    localArrayList.add(new bemx("", TypedValue.applyDimension(1, 17.0F, ajia.a)));
    localArrayList.add(new bemx("", TypedValue.applyDimension(1, 17.0F, ajia.a)));
    localArrayList.add(new bemx(ajjy.a(2131636627), TypedValue.applyDimension(1, 18.0F, ajia.a)));
    ...
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131625538));
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131625539));
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131625540));
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131625541));
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131625542));
