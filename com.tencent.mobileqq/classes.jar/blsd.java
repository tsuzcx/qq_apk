  ...
  implements blsc
{
  ...
  public blsd(Context paramContext, GestureDetector.OnGestureListener paramOnGestureListener, Handler paramHandler)
  {
    if (paramHandler != null) {}
    for (this.jdField_a_of_type_AndroidOsHandler = new blse(this, paramHandler);; this.jdField_a_of_type_AndroidOsHandler = new blse(this))
    {
