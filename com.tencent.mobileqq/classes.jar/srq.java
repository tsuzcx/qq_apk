...
public class srq
{
  ...
  private srq(JSONObject paramJSONObject)
  {
    int k;
    try
    {
  ...
  public static srq a(@Nullable String paramString)
  {
    try
    {
    ...
    {
      urk.a("StoryVideoItem.PollLayout", "fromJson()", paramString);
      return null;
    }
  ...
  public static srq a(JSONObject paramJSONObject)
  {
    try
    {
      paramJSONObject = new srq(paramJSONObject);
      return paramJSONObject;
    }
    catch (IllegalArgumentException paramJSONObject)
    {
      urk.a("StoryVideoItem.PollLayout", "fromJson()", paramJSONObject);
    }
    return null;
  }
