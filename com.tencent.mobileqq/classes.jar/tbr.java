...
public class tbr
{
  ...
  private static BaseData a(int paramInt, tbw paramtbw)
  {
    paramtbw = paramtbw.b(paramInt);
    try
    {
      if (!TextUtils.isEmpty(paramtbw))
      {
        paramtbw = new JSONObject(paramtbw);
        if (tbd.a(paramtbw))
        {
          if (!qph.a().a()) {
            return null;
          }
          return tbd.a(paramtbw);
        }
        paramtbw = a(paramtbw);
        return paramtbw;
      }
    }
    catch (Exception paramtbw)
    {
      QLog.d(jdField_a_of_type_JavaLangString, 1, "parseProteusData error!  msg=" + paramtbw);
    }
    return null;
  }
  
  public static BaseData a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, tbw paramtbw, SparseArray<Float> paramSparseArray)
  {
    Object localObject2 = "";
    Object localObject3 = "";
    Object localObject1 = "";
    ...
    if (i1 != 1)
    {
      ...
      case 2: 
        for (;;)
        {
          ...
          if (i1 < i2)
          {
            String str = paramtbw.a(i1);
            if (str.equals("src"))
            {
              localObject1 = paramtbw.b(i1);
              localObject5 = localObject3;
    ...
    label404:
    return tba.a(paramArticleInfo, paramFastWebArticleInfo, (String)localObject2, (String)localObject3, (String)localObject1, paramSparseArray);
  }
  
  public static BaseData a(tbw paramtbw)
  {
  ...
  private static BaseData a(tbw paramtbw, SparseArray<Float> paramSparseArray)
  {
    ...
    if (i1 != 1)
    {
      ...
      case 4: 
        for (;;)
        {
          ...
          localObject1 = localObject2;
          break;
          localObject2 = paramtbw.b();
          if (!((String)localObject2).equals(i)) {
            throw new IllegalArgumentException(anni.a(2131704421));
          }
          ...
          localXmlSerializer.text(paramtbw.a());
          localObject2 = localObject1;
        }
      }
      if (i.equals(paramtbw.b())) {
    ...
    else
    {
      ...
      return tba.a(localStringWriter.toString(), (String)localObject1, paramSparseArray);
    }
  ...
  private static ProteusBookData a(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      Object localObject = teh.a("native_article", true);
      if (localObject != null) {}
      for (localObject = ((teh)localObject).getTemplateBean(paramJSONObject);; localObject = null)
      {
  ...
  public static List<BaseData> a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, SparseArray<Float> paramSparseArray)
  {
    ...
    tbv localtbv = new tbv(null);
    tbw localtbw = new tbw(Xml.newPullParser(), localtbv);
    localtbw.a(new StringReader((String)localObject));
    int i1 = localtbw.c();
    while (i1 != 1)
    {
      switch (i1)
      ...
      for (;;)
      {
        if (localtbw.c() != 2)
        {
          i1 = localtbw.d();
          break;
          localObject = localtbw.b();
          if ((((String)localObject).equals(b)) || (((String)localObject).equals(c)))
          {
            a(paramArticleInfo, paramFastWebArticleInfo, localtbw, localArrayList, localtbv, paramSparseArray);
          }
          else if (((String)localObject).equals(i))
          {
            localArrayList.add(a(localtbw, paramSparseArray));
          }
          else
          {
            if (((String)localObject).equals(d))
            {
              a(localtbw, localtbv, localArrayList, paramSparseArray);
              if (2 != localtbw.c()) {
                continue;
              }
              i1 = localtbw.c();
            ...
            {
              localtbw.d();
              c(paramArticleInfo, paramFastWebArticleInfo, localtbw, localArrayList, localtbv, paramSparseArray);
            }
            else if (((String)localObject).equals(g))
            {
              localObject = a(paramArticleInfo, paramFastWebArticleInfo, localtbw, paramSparseArray);
              if (localObject != null) {
            ...
            {
              localArrayList.add(b(paramArticleInfo, paramFastWebArticleInfo, localtbw, paramSparseArray));
            }
            else if (((String)localObject).equals(j))
            {
              localObject = a(localtbw);
              if (localObject != null) {
                localArrayList.add(localObject);
              }
            }
            ...
            {
              b(paramArticleInfo, paramFastWebArticleInfo, localtbw, localArrayList, localtbv, paramSparseArray);
            }
            else
            {
              throw new IllegalArgumentException(anni.a(2131704420) + (String)localObject);
              a(localtbw, localtbv, localArrayList, paramSparseArray);
              if (2 == localtbw.c())
              {
                i1 = localtbw.c();
  ...
  private static void a(SpannableString paramSpannableString, SparseArray<Object> paramSparseArray)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject1 instanceof ArrayList))
      {
        ...
        {
          Object localObject2 = ((tbu)((ArrayList)localObject1).get(i2)).a();
          if ((localObject2 instanceof tbt)) {
            ((tbt)localObject2).a(paramSpannableString.toString());
          }
      ...
      {
        localObject1 = ((tbu)localObject1).a();
        if ((localObject1 instanceof tbt)) {
          ((tbt)localObject1).a(paramSpannableString.toString());
        }
  ...
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, tbw paramtbw, List<BaseData> paramList, tbv paramtbv, SparseArray<Float> paramSparseArray)
  {
    int i1 = paramtbw.c();
    int i3 = paramtbw.a();
    for (;;)
      ...
      case 3: 
        do
        {
          ...
          do
          {
            i1 = paramtbw.d();
            break;
            localObject = paramtbw.b();
            if (a((String)localObject))
            {
              a(paramtbw, paramtbv, paramList, paramSparseArray);
              i1 = i2;
              break;
            }
            if (((String)localObject).equals(g))
            {
              localObject = a(paramArticleInfo, paramFastWebArticleInfo, paramtbw, paramSparseArray);
              i1 = i2;
              if (localObject == null) {
                break;
              }
            ...
            {
              paramList.add(b(paramArticleInfo, paramFastWebArticleInfo, paramtbw, paramSparseArray));
              i1 = i2;
              break;
            }
            if (((String)localObject).equals(i))
            {
              paramList.add(a(paramtbw, paramSparseArray));
              i1 = i2;
              break;
            }
            if ((((String)localObject).equals(l)) || (((String)localObject).equals(n)))
            {
              b(paramArticleInfo, paramFastWebArticleInfo, paramtbw, paramList, paramtbv, paramSparseArray);
              i1 = i2;
              break;
            }
            if (((String)localObject).equals(o))
            {
              paramtbw.d();
              c(paramArticleInfo, paramFastWebArticleInfo, paramtbw, paramList, paramtbv, paramSparseArray);
              i1 = i2;
              break;
            }
          } while ((((String)localObject).equals(b)) || (((String)localObject).equals(c)));
          return;
        } while (((!paramtbw.b().equals(b)) && (!paramtbw.b().equals(c))) || (i3 != paramtbw.a()));
        return;
      }
      a(paramtbw, paramtbv, paramList, paramSparseArray);
      i1 = i2;
  ...
  public static void a(tbw paramtbw, tbv paramtbv, List<BaseData> paramList, SparseArray<Float> paramSparseArray)
  {
    int i4 = paramtbv.a();
    int i5 = paramtbv.b();
    ...
    for (;;)
    {
      ...
      if (!a(paramtbw.b()))
      {
        do
        {
          paramtbw = localSpannableStringBuilder.toString();
          if (!TextUtils.isEmpty(paramtbw.replaceAll(" ", "").trim())) {
            paramList.add(tba.a(paramtbw, localSpannableStringBuilder, i4, i5, paramSparseArray));
          }
          return;
          SpannableString localSpannableString = new SpannableString(paramtbw.a().replaceAll(" +", " ").replaceAll("\t+", " "));
          a(localSpannableString, paramtbv.b);
  ...
  public static BaseData b(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, tbw paramtbw, SparseArray<Float> paramSparseArray)
  {
    int i7 = paramtbw.c();
    Object localObject5 = "";
    Object localObject3 = "";
    ...
    if (i7 != 1)
    {
      ...
      case 2: 
        for (;;)
        {
          ...
          if (i4 < i7)
          {
            String str = paramtbw.a(i4);
            if (str.equals("vid"))
            {
              localObject10 = paramtbw.b(i4);
            ...
            for (;;)
            {
              ...
              if (str.equals("width"))
              {
                i6 = Integer.valueOf(paramtbw.b(i4)).intValue();
                i5 = i2;
                localObject6 = localObject4;
                localObject7 = localObject2;
                localObject8 = localObject5;
              ...
              {
                i5 = Integer.valueOf(paramtbw.b(i4)).intValue();
                i6 = i1;
                localObject6 = localObject4;
                localObject7 = localObject2;
                localObject8 = localObject5;
              ...
              else
              {
                ...
                {
                  i3 = Integer.valueOf(paramtbw.b(i4)).intValue();
                  i5 = i2;
                  i6 = i1;
                  localObject6 = localObject4;
                  localObject7 = localObject2;
      ...
      if (!h.equals(paramtbw.b())) {}
    }
    else
    {
      return tba.a(paramArticleInfo, paramFastWebArticleInfo, (String)localObject3, (String)localObject5, i2, i3, (String)localObject1, (String)localObject2, (String)localObject4, i1, paramSparseArray);
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i2 < arrayOfString.length)
        {
          ...
          localArrayList.add(tbu.a(3, new Object[0]));
        }
      }
      ...
      {
        localArrayList.add(tbu.a(5, new Object[0]));
        break label399;
        label172:
        if ((q.equals(paramString)) || (r.equals(paramString)))
        {
          ...
          while (i1 != -1)
          {
            ...
            for (paramString = tbu.a(2, new Object[] { Integer.valueOf(i1) });; paramString = tbu.a(1, new Object[] { Integer.valueOf(i1) }))
            {
  ...
  public static void b(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, tbw paramtbw, List<BaseData> paramList, tbv paramtbv, SparseArray<Float> paramSparseArray)
  {
    int i1 = paramtbw.c();
    int i3 = paramtbw.a();
    for (;;)
    {
      ...
      case 3: 
        ...
        do
        {
          ...
          a(paramArticleInfo, paramFastWebArticleInfo, paramtbw, paramList, paramtbv, paramSparseArray);
        } while (i3 != paramtbw.a());
        return;
  ...
  public static void c(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, tbw paramtbw, List<BaseData> paramList, tbv paramtbv, SparseArray<Float> paramSparseArray)
  {
    int i1 = paramtbw.c();
    switch (i1)
    {
