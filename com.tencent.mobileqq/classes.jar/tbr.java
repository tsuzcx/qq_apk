  ...
  extends tby<tbu>
{
  ...
  private tev jdField_a_of_type_Tev = new tbs(this);
  protected boolean a;
  ...
  {
    tmn localtmn = new tmn(1, paramInt1, paramInt2);
    syo.a().a(localtmn, new tbt(this));
  }
  ...
  {
    ved.b("AddressDataProvider", "requestAddress.");
    if (this.jdField_a_of_type_Boolean)
    {
      ved.d("AddressDataProvider", "is request address ing....");
      return;
    }
  ...
  public boolean a(tbu paramtbu)
  {
    return (paramtbu != null) && (!TextUtils.isEmpty(paramtbu.a)) && (!ajya.a(2131699880).equals(paramtbu.a));
  }
