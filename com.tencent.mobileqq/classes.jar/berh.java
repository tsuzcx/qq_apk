  ...
  extends beru
{
  ...
  public berh(beyb parambeyb, beyg parambeyg)
  {
    super(parambeyb, parambeyg);
    this.jdField_a_of_type_Int = parambeyg.jdField_c_of_type_Int;
    this.jdField_a_of_type_Bete.jdField_c_of_type_Int = parambeyg.jdField_c_of_type_Int;
    this.jdField_b_of_type_JavaLangString = parambeyg.jdField_a_of_type_JavaLangString;
    this.jdField_a_of_type_ArrayOfByte = parambeyg.jdField_a_of_type_ArrayOfByte;
  }
  ...
  protected final long a(long paramLong)
  {
    ...
    for (paramLong = Math.min(paramLong, this.jdField_a_of_type_Bluw.a(BaseApplication.getContext(), this.jdField_q_of_type_Long, this.s, -1));; paramLong = Math.min(paramLong, 14600L)) {
  ...
  protected bfau a()
  {
    ...
    localbfbd.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
    ...
    localbfau.jdField_a_of_type_JavaLangString = "bdh_common_up";
    ...
    localbfau.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
    localbfau.jdField_a_of_type_ArrayOfByte = this.jdField_a_of_type_ArrayOfByte;
    return localbfau;
  }
  ...
  {
    if (paramLong1 != 0L) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.countFlow(true, 1, this.jdField_a_of_type_Beyg.jdField_b_of_type_Int, this.jdField_a_of_type_Beyg.jdField_a_of_type_Int, paramLong1);
    }
    if (paramLong2 != 0L) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.countFlow(true, 1, this.jdField_a_of_type_Beyg.jdField_b_of_type_Int, this.jdField_a_of_type_Beyg.jdField_a_of_type_Int, paramLong2);
    }
    if (paramLong3 != 0L) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.countFlow(true, 0, this.jdField_a_of_type_Beyg.jdField_b_of_type_Int, this.jdField_a_of_type_Beyg.jdField_a_of_type_Int, paramLong3);
    }
    if (paramLong4 != 0L) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.countFlow(true, 0, this.jdField_a_of_type_Beyg.jdField_b_of_type_Int, this.jdField_a_of_type_Beyg.jdField_a_of_type_Int, paramLong4);
    }
  }
  ...
  public final void a(bfau parambfau, bfbj parambfbj)
  {
    if (parambfbj != null)
    {
      ...
      {
        parambfau = (bfbk)parambfbj.jdField_a_of_type_JavaUtilList.get(i);
        if (QLog.isColorLevel()) {
          b("procUrl", parambfau.toString());
        }
        a(this.jdField_a_of_type_Berr, parambfau);
        if (QLog.isColorLevel()) {
          QLog.d("BDHCommonUploadProcessor", 2, "onBusiProtoResp()------response.result = " + parambfau.jdField_c_of_type_Int);
        }
        if (parambfau.jdField_c_of_type_Int == 0)
        {
          ...
          this.jdField_a_of_type_Bete.jdField_l_of_type_JavaLangString = parambfau.jdField_b_of_type_JavaLangString;
          this.jdField_a_of_type_Bete.jdField_m_of_type_JavaLangString = parambfau.e;
          this.jdField_a_of_type_Bete.n = parambfau.jdField_c_of_type_JavaLangString;
          this.jdField_a_of_type_Bete.o = parambfau.jdField_d_of_type_JavaLangString;
          this.jdField_a_of_type_Bete.i = ("http://" + parambfau.jdField_b_of_type_JavaLangString + parambfau.e);
          this.jdField_a_of_type_Bete.jdField_j_of_type_JavaLangString = ("http://" + parambfau.jdField_b_of_type_JavaLangString + parambfau.jdField_c_of_type_JavaLangString);
          this.jdField_a_of_type_Bete.k = ("http://" + parambfau.jdField_b_of_type_JavaLangString + parambfau.jdField_d_of_type_JavaLangString);
          this.jdField_a_of_type_Bete.g = parambfau.f;
          if (parambfau.jdField_a_of_type_Boolean)
          {
            this.jdField_a_of_type_Bete.a();
            e();
            if (QLog.isColorLevel()) {
              QLog.d("BDHCommonUploadProcessor", 2, "onBusiProtoResp()---- file is Exsit! " + this.jdField_a_of_type_Beyg.i);
            }
            label374:
            this.jdField_a_of_type_Long = parambfau.jdField_a_of_type_Long;
            this.jdField_a_of_type_Bete.d = this.jdField_a_of_type_Long;
            if (QLog.isColorLevel()) {
              QLog.d("BDHCommonUploadProcessor", 2, "mFileID->" + this.jdField_a_of_type_Long + " groupUin->" + this.jdField_a_of_type_Beyg.jdField_c_of_type_JavaLangString);
            }
          }
        }
        for (;;)
        {
          i += 1;
          break;
          if ((this.jdField_a_of_type_Int == 9) && (parambfau.f != null)) {
            this.jdField_a_of_type_TencentImCsCmd0x388Cmd0x388$ExpRoamExtendInfo.bytes_resid.set(ByteStringMicro.copyFrom(parambfau.f.getBytes()));
          }
          if ((this.jdField_a_of_type_Int == 20) && (parambfau.f != null)) {
            this.jdField_a_of_type_ComTencentMobileqqHighwayProtocolBdh_extinfo$UploadPicExtInfo.bytes_file_resid.set(ByteStringMicro.copyFrom(parambfau.f.getBytes()));
          }
          this.jdField_m_of_type_JavaLangString = parambfau.jdField_a_of_type_JavaLangString;
          this.s = parambfau.jdField_b_of_type_Int;
          this.r = parambfau.jdField_b_of_type_Long;
          aL_();
          break label374;
          d();
        }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      bdmc.a(BaseApplication.getContext()).a(null, this.jdField_b_of_type_JavaLangString, true, l, this.jdField_q_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    for (;;)
    {
      m();
      ...
      bdmc.a(BaseApplication.getContext()).a(null, this.jdField_b_of_type_JavaLangString, false, l, this.jdField_q_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
  ...
  byte[] a()
  {
    ...
    ((cmd0x346.ExtensionReq)localObject).uint32_ptt_time.set(this.jdField_a_of_type_Beyg.j);
    i = bfae.a();
  ...
  public final void aL_()
  {
    ...
    beri localberi = new beri(this, SystemClock.uptimeMillis());
    if (this.jdField_a_of_type_Int == 9) {
      this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Beyg.i, (int)this.r, bhvd.a(this.jdField_a_of_type_JavaLangString), this.jdField_b_of_type_ArrayOfByte, localberi, this.jdField_a_of_type_TencentImCsCmd0x388Cmd0x388$ExpRoamExtendInfo.toByteArray());
    }
    for (;;)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("BDHCommonUploadProcessor", 2, "<BDH_LOG> Transaction submit RetCode:" + i + " T_ID:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.getTransationId() + " UniSeq:" + this.jdField_a_of_type_Beyg.jdField_a_of_type_Long + " MD5:" + this.jdField_c_of_type_JavaLangString + " uuid:" + this.jdField_l_of_type_JavaLangString + " Path:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.filePath + " Cmd:" + 3);
      }
      if (i != 0)
      {
      ...
      if (this.jdField_a_of_type_Int == 20) {
        this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Beyg.i, (int)this.r, bhvd.a(this.jdField_a_of_type_JavaLangString), this.jdField_b_of_type_ArrayOfByte, localberi, this.jdField_a_of_type_ComTencentMobileqqHighwayProtocolBdh_extinfo$UploadPicExtInfo.toByteArray());
      } else if (this.jdField_a_of_type_Int == 36) {
        this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Beyg.i, (int)this.r, this.jdField_b_of_type_ArrayOfByte, localberi, a(), false);
      } else if (this.jdField_a_of_type_Int == 40) {
        this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Int, this.jdField_a_of_type_Beyg.i, (int)this.r, this.jdField_b_of_type_ArrayOfByte, localberi, this.jdField_a_of_type_Beyg.jdField_a_of_type_ArrayOfByte, true);
  ...
  public final void aN_()
  {
    ...
    if (36 == this.jdField_a_of_type_Int)
    {
      ...
      this.jdField_a_of_type_Bete.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Beyg.i;
      aL_();
    }
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Bete.k = ((String)this.jdField_a_of_type_Beyg.jdField_b_of_type_JavaLangObject);
        aL_();
      }
      else
      {
  ...
  public final int c()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Beyg.i))
    {
      ...
      bhmq.a(this.jdField_a_of_type_Beyg.i, (BitmapFactory.Options)localObject);
      this.jdField_q_of_type_Int = ((BitmapFactory.Options)localObject).outHeight;
      this.jdField_d_of_type_Int = ((BitmapFactory.Options)localObject).outWidth;
    }
    Object localObject = this.jdField_a_of_type_Beyg.i;
    ...
    if ((this.jdField_a_of_type_Int != 54) && (l >= bezh.a()))
    {
  ...
  final void d()
  {
    ...
    d(1005);
    if (QLog.isColorLevel()) {
      QLog.d("BDHCommonUploadProcessor", 2, "uploadCustomEmoticon resultError ---- errCode: " + this.jdField_k_of_type_Int + ", errDesc:" + this.jdField_j_of_type_JavaLangString);
    }
    azrh localazrh;
    String str;
    if (this.jdField_a_of_type_Beyg.jdField_a_of_type_Azrg != null)
    {
      ...
      if ((this.jdField_a_of_type_Int == 20) && (berp.a(120509L).equals(this.jdField_a_of_type_JavaUtilHashMap.get("param_reason")))) {
        localazrh.jdField_b_of_type_Int = 120509;
      }
      if (this.jdField_a_of_type_Int == 9)
      {
        str = (String)this.jdField_a_of_type_JavaUtilHashMap.get("param_reason");
        if (!berp.a(400010L).equals(str)) {
          break label208;
        }
        localazrh.jdField_b_of_type_Int = 400010;
      }
    }
    for (;;)
    {
      ...
      return;
      label208:
      if (berp.a(400011L).equals(str)) {
        localazrh.jdField_b_of_type_Int = 400011;
      }
    }
  }
  ...
  final void e()
  {
    ...
    if (this.jdField_a_of_type_Beyg.jdField_a_of_type_Azrg != null)
    {
      ...
      if (this.jdField_a_of_type_Int == 20) {
        localazrh.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Bete.g;
      }
      this.jdField_a_of_type_Beyg.jdField_a_of_type_Azrg.b(localazrh);
    }
