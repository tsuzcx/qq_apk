...
public class berh
{
  ...
  private berh(Class<?> paramClass)
  {
    this.jdField_a_of_type_JavaLangObject = paramClass;
    this.jdField_a_of_type_Boolean = true;
  }
  
  private berh(Object paramObject)
  {
    this.jdField_a_of_type_JavaLangObject = paramObject;
    this.jdField_a_of_type_Boolean = false;
  }
  
  public static berh a(Class<?> paramClass)
  {
    return new berh(paramClass);
  }
  
  public static berh a(Object paramObject)
  {
    return new berh(paramObject);
  }
  
  public static berh a(String paramString)
  {
    return a(a(paramString));
  }
  
  public static berh a(String paramString, ClassLoader paramClassLoader)
  {
    return a(a(paramString, paramClassLoader));
  }
  
  private static berh a(Constructor<?> paramConstructor, Object... paramVarArgs)
  {
    try
    {
  ...
  private boolean a(Class<?>[] paramArrayOfClass1, Class<?>[] paramArrayOfClass2)
  {
    if (paramArrayOfClass1.length == paramArrayOfClass2.length)
    {
      ...
      {
        if (paramArrayOfClass2[i] == beri.class) {}
  ...
  private static Class<?>[] a(Object... paramVarArgs)
  {
    ...
    if (i < paramVarArgs.length)
    {
      ...
      if (localObject == null) {}
      for (localObject = beri.class;; localObject = localObject.getClass())
      {
  ...
  /* Error */
  public berh a(Object... paramVarArgs)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokestatic 203	berh:a	([Ljava/lang/Object;)[Ljava/lang/Class;
    //   4: astore 5
    //   6: aload_0
    //   7: invokevirtual 166	berh:a	()Ljava/lang/Class;
    //   10: astore 4
    //   12: aload 5
    ...
    //   21: iadd
    //   22: istore_2
    //   23: getstatic 28	berh:c	Landroid/util/SparseArray;
    //   26: iload_2
    //   27: invokevirtual 122	android/util/SparseArray:get	(I)Ljava/lang/Object;
    //   30: ifnull +22 -> 52
    //   33: getstatic 28	berh:c	Landroid/util/SparseArray;
    //   36: iload_2
    ...
    //   45: aload 4
    //   47: aload_1
    //   48: invokestatic 210	berh:a	(Ljava/lang/reflect/Constructor;[Ljava/lang/Object;)Lberh;
    //   51: areturn
    //   52: aload 4
    //   54: aload 5
    //   56: invokevirtual 214	java/lang/Class:getDeclaredConstructor	([Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    //   59: invokestatic 177	berh:a	(Ljava/lang/reflect/AccessibleObject;)Ljava/lang/reflect/AccessibleObject;
    //   62: checkcast 62	java/lang/reflect/Constructor
    //   65: astore 4
    //   67: getstatic 28	berh:c	Landroid/util/SparseArray;
    //   70: iload_2
    //   71: aload 4
    ...
    //   79: astore 4
    //   81: aload_0
    //   82: invokevirtual 166	berh:a	()Ljava/lang/Class;
    ...
    //   113: aload 5
    //   115: invokespecial 224	berh:a	([Ljava/lang/Class;[Ljava/lang/Class;)Z
    //   118: ifeq +16 -> 134
    //   121: aload 7
    //   123: invokestatic 177	berh:a	(Ljava/lang/reflect/AccessibleObject;)Ljava/lang/reflect/AccessibleObject;
    //   126: checkcast 62	java/lang/reflect/Constructor
    //   129: aload_1
    //   130: invokestatic 210	berh:a	(Ljava/lang/reflect/Constructor;[Ljava/lang/Object;)Lberh;
    //   133: areturn
    //   134: iload_2
    //   135: iconst_1
    //   136: iadd
  ...
  public berh b(String paramString)
  {
    try
    {
  ...
  {
    if ((paramObject instanceof berh)) {
      return this.jdField_a_of_type_JavaLangObject.equals(((berh)paramObject).a());
    }
    return false;
  }
