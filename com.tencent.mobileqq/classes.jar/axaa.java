  ...
  implements Handler.Callback, Manager
{
  ...
  private blhq jdField_a_of_type_Blhq = new blhq(ThreadManagerV2.getSubThreadLooper(), this);
  ...
  public axaa(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    localbdlg.e = paramString4;
    localbdlg.d = paramString5;
    localbdlg.f = paramString1;
    localbdlg.i = paramString2;
    bdlf.a(paramString3, localbdlg);
    bdlf.a(paramQQAppInterface, localbdlg);
  }
  ...
  private boolean a(SubMsgType0x27.PushPlatform paramPushPlatform, Bundle paramBundle, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (ajwm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(295);
      if (localObject != null)
      {
        bool2 = ((ajwm)localObject).b();
        bool1 = bool2;
        if (bool2)
        {
          bool1 = bool2;
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Blhq.sendEmptyMessageDelayed(1, 30000L);
  }
  ...
  public void a(long paramLong, String arg3, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, String paramString5, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        boolean bool = bhrl.a(paramString2);
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundPause) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundStop) || (bool))
        {
          ...
          synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
          {
            ...
            if (bool)
            {
              ??? = (axac)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(72);
              if (SettingCloneUtil.readValue(paramString2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString2.getString(2131693438), "qqsetting_lock_screen_whenexit_key", true))
              {
                if (QLog.isColorLevel()) {
  ...
  public void a(Context paramContext, Intent paramIntent)
  {
    ...
    if (j == 1041)
    {
      localIntent = agej.a(new Intent(paramContext, SplashActivity.class), null);
  ...
  public void a(SubMsgType0x27.MsgBody paramMsgBody, short paramShort, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramMsgBody = new String(axse.a(paramMsgBody), "UTF-8");
        localObject1 = null;
      ...
      catch (Exception paramMsgBody)
      {
        try
        {
          ...
          this.jdField_a_of_type_Blhq.removeMessages(1);
          localObject4 = new bdlg();
          ((bdlg)localObject4).e = "0X800923D";
          ((bdlg)localObject4).d = "收到Push协议";
          ((bdlg)localObject4).f = (((SubMsgType0x27.ClientReport)localObject3).uint32_service_id.get() + "");
          ((bdlg)localObject4).i = ((SubMsgType0x27.ClientReport)localObject3).str_content_id.get();
          bdlf.a(paramMsgBody, (bdlg)localObject4);
          bdlf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (bdlg)localObject4);
          l = bcrg.a();
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqActivityRecentDataRecentItemNoticeData == null)
          {
            ...
            a(paramLong, str, paramMsgBody, (String)localObject2, i, j, ((bdlg)localObject4).f, ((bdlg)localObject4).i, (Bundle)localObject1);
            return;
