  ...
  implements apio
{
  ...
  public static apio a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.mobileqq.ar.aidl.IArRemoteCallback");
    if ((localIInterface != null) && ((localIInterface instanceof apio))) {
      return (apio)localIInterface;
    }
    return new apiq(paramIBinder);
  }
