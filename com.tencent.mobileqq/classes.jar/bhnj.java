  ...
  extends DynamicTextItem
{
  ...
  bhnq jdField_b_of_type_Bhnq;
  private String jdField_b_of_type_JavaLangString = "05/09";
  bhnq jdField_c_of_type_Bhnq;
  ...
  static
  {
    ...
    jdField_b_of_type_Int = aciy.a(18.0F, localResources);
    d = aciy.a(6.0F, localResources);
    int n = biqy.a();
    jdField_c_of_type_Int = localResources.getDisplayMetrics().widthPixels - bijo.a - n * 2;
  }
  
  public bhnj(int paramInt, List<String> paramList, Typeface paramTypeface)
  {
    ...
    if (paramTypeface == null)
    {
      ...
      this.k = aciy.a(41.0F, BaseApplicationImpl.getContext().getResources());
      ...
      this.g = aciy.a(34.0F, BaseApplicationImpl.getContext().getResources());
      this.h = aciy.a(45.0F, BaseApplicationImpl.getContext().getResources());
      this.l = aciy.a(4.0F, BaseApplicationImpl.getContext().getResources());
      this.m = aciy.a(3.0F, BaseApplicationImpl.getContext().getResources());
      this.jdField_c_of_type_Bhnq = new bhnq(0);
      this.jdField_c_of_type_Bhnq.a(new bhnb(-1, this.l, this.m));
      ...
      this.j = aciy.a(19.0F, BaseApplicationImpl.getContext().getResources());
      ...
      this.jdField_b_of_type_JavaLangString = bhoa.a();
      localTextPaint.setAntiAlias(true);
      localTextPaint.setTextSkewX(-0.15F);
      localTextPaint.setStyle(Paint.Style.FILL_AND_STROKE);
      this.i = aciy.a(23.0F, BaseApplicationImpl.getContext().getResources());
      localTextPaint.setTextSize(this.i);
      localTextPaint.setColor(-1);
      this.jdField_b_of_type_Bhnq = new bhnq(0);
      this.jdField_b_of_type_Bhnq.a(new bhnb(-16777216, this.l, this.m));
      this.jdField_b_of_type_Bhnq.a(this.jdField_b_of_type_JavaLangString, jdField_c_of_type_Int, this.i, localTextPaint);
      if (paramList != null) {
        break label541;
      }
    }
  ...
  public int a(MotionEvent paramMotionEvent, float paramFloat1, float paramFloat2, @Nullable bijr parambijr, bira parambira)
  {
    float f1 = paramMotionEvent.getX();
    float f2 = paramMotionEvent.getY();
    if (parambijr != null) {
      return parambira.a(parambijr, f1, f2);
    }
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new bhnk(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    this.f = aciy.a(18.0F, BaseApplicationImpl.getContext().getResources());
    if (paramInt == 0)
    {
      paramString = " " + paramString;
      this.jdField_a_of_type_Bhnq = new bhnq(0);
      this.jdField_a_of_type_Bhnq.a(new bhnb(-16777216, this.l, this.m));
      this.jdField_a_of_type_Bhnq.a(paramString, jdField_c_of_type_Int, this.k, this.jdField_b_of_type_AndroidTextTextPaint);
      this.jdField_a_of_type_Float = Math.max(this.jdField_a_of_type_Bhnq.a(), this.jdField_b_of_type_Bhnq.a());
      this.jdField_a_of_type_Float = Math.max(this.jdField_c_of_type_Bhnq.a(), this.jdField_a_of_type_Float);
      this.jdField_b_of_type_Float = (this.jdField_a_of_type_Bhnq.b() + this.g + this.jdField_b_of_type_Bhnq.b() + this.h + this.jdField_c_of_type_Bhnq.b());
      return;
    }
  ...
  {
    this.e = 0;
    this.jdField_a_of_type_Bhnq.a(paramCanvas, 0, this.e);
    this.e = ((int)(this.e + this.jdField_a_of_type_Bhnq.b()));
    this.e += this.g;
    this.jdField_b_of_type_Bhnq.a(paramCanvas, 0, this.e);
    this.e = ((int)(this.e + this.jdField_b_of_type_Bhnq.b()));
    this.e += this.h;
    this.jdField_c_of_type_Bhnq.a(paramCanvas, 0, this.e);
    if (super.b(1))
    {
      this.jdField_b_of_type_AndroidGraphicsRectF.set(this.jdField_c_of_type_Bhnq.a(2, this.jdField_c_of_type_Bhnq.a()));
    ...
    this.e = ((int)(this.e + this.jdField_c_of_type_Bhnq.b()));
    if (super.b(0))
    {
      this.jdField_b_of_type_AndroidGraphicsRectF.left = 0.0F;
      this.jdField_a_of_type_AndroidGraphicsRectF.top = 0.0F;
      this.jdField_a_of_type_AndroidGraphicsRectF.right = this.jdField_a_of_type_Bhnq.a();
      this.jdField_a_of_type_AndroidGraphicsRectF.bottom = this.jdField_a_of_type_Bhnq.b();
