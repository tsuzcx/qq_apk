  ...
  implements aniz
{
  ...
  public adol(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new adom(this);
  ...
  {
    int i = apug.a(apvd.a(paramMessageForDeviceSingleStruct.strMediaFileName));
    Object localObject2 = apug.a(paramMessageForDeviceSingleStruct);
    ...
    if (i == 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if ((localObject3 instanceof MessageForDeviceSingleStruct))
        {
          ...
          if (apug.a(apvd.a(((MessageForDeviceSingleStruct)localObject3).strMediaFileName)) == 0) {
            ((ArrayList)localObject1).add(String.valueOf(apug.a((MessageForDeviceSingleStruct)localObject3).nSessionId));
          }
        }
      }
  ...
  {
    paramLinearLayout.setPadding(0, actj.a(11.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, 0);
    paramLinearLayout = (adoo)paramactn;
    paramactn = paramView;
    if (paramView == null)
    {
      paramactn = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558732, null);
      paramLinearLayout.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramactn.findViewById(2131376246));
      paramLinearLayout.c = ((TextView)paramactn.findViewById(2131376245));
      paramLinearLayout.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramactn.findViewById(2131376236));
      paramLinearLayout.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramactn.findViewById(2131379007));
      paramLinearLayout.d = ((TextView)paramactn.findViewById(2131376231));
      paramLinearLayout.e = ((TextView)paramactn.findViewById(2131376233));
    }
    ...
    for (paramMessageRecord = (MessageForDeviceSingleStruct)paramMessageRecord;; paramMessageRecord = null)
    {
      ...
      if ((paramMessageRecord.strTitle != null) && (!TextUtils.isEmpty(paramMessageRecord.strTitle)))
      {
        ...
        paramLinearLayout.c.setText(bbkp.a(this.jdField_a_of_type_AndroidContentContext, l * 1000L));
        ...
        if (bbdx.b(paramMessageRecord.strCoverPath)) {
          break label550;
        }
        ((yer)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(49)).a().a(paramMessageRecord, paramactn, this);
      }
      for (;;)
      {
        if ((!bbdx.b(paramMessageRecord.strMediaPath)) && (bbfj.h(bcyb.a().a())))
        {
          paramView = (yer)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(49);
          ((yah)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(paramMessageRecord.senderuin));
          paramView.a().a(paramMessageRecord);
        }
        paramactn.setTag(paramLinearLayout);
        paramactn.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        paramactn.setOnTouchListener(paramacxj);
        paramactn.setOnLongClickListener(paramacxj);
        return paramactn;
        ...
        break label342;
        label550:
        if ((!TextUtils.isEmpty(paramMessageRecord.faceRect)) && (!bbdx.b(paramMessageRecord.strMediaPath)))
        {
          paramView = (yer)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(49);
          if (((yah)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(paramMessageRecord.senderuin)).isAdmin == 1) {
            paramView.a().a(paramMessageRecord);
          }
        }
      }
  ...
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    for (;;)
    {
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800465F", "0X800465F", 0, 0, "" + paramInt, "", "", "");
      return;
  ...
  {
    adoo localadoo = (adoo)actj.a(paramView);
    if (localadoo == null) {
    ...
    do
    {
      do
      {
        return;
        paramView = null;
        if ((localadoo.jdField_a_of_type_ComTencentMobileqqDataChatMessage instanceof MessageForDeviceSingleStruct)) {
          paramView = (MessageForDeviceSingleStruct)localadoo.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
        }
  ...
  protected void a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct, adoo paramadoo)
  {
    if ((paramMessageForDeviceSingleStruct.nDataType == 1) && (bbdx.b(paramMessageForDeviceSingleStruct.strMediaPath))) {}
    for (;;)
    {
      int k;
      int j;
      ...
      try
      {
        k = ((WindowManager)bcyb.a().a().getSystemService("window")).getDefaultDisplay().getWidth() - 156;
        j = (int)(this.jdField_a_of_type_Float * 150.0F);
        i = k;
        if (k <= 0) {
          i = j;
        }
        paramMessageForDeviceSingleStruct = ayqb.a(paramMessageForDeviceSingleStruct.strMediaPath, i, j, paramMessageForDeviceSingleStruct.strCoverMD5);
        if (paramMessageForDeviceSingleStruct != null)
        {
          ...
          paramadoo.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramMessageForDeviceSingleStruct);
        }
        return;
      }
      catch (Exception paramMessageForDeviceSingleStruct)
      {
        paramadoo.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130837908);
        return;
      }
      if (bbdx.b(paramMessageForDeviceSingleStruct.strCoverPath)) {
        try
        {
          k = ((WindowManager)bcyb.a().a().getSystemService("window")).getDefaultDisplay().getWidth() - 156;
          j = (int)(this.jdField_a_of_type_Float * 150.0F);
          ...
          paramMessageForDeviceSingleStruct = ayqb.a(paramMessageForDeviceSingleStruct.strCoverPath, i, j, paramMessageForDeviceSingleStruct.strCoverMD5);
          if (paramMessageForDeviceSingleStruct != null)
          {
            paramMessageForDeviceSingleStruct = URLDrawable.getDrawable(paramMessageForDeviceSingleStruct);
            paramadoo.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramMessageForDeviceSingleStruct);
  ...
  {
    paramView = new bbmf();
    paramView.a(2131364984, this.jdField_a_of_type_AndroidContentContext.getString(2131690708), 2130838601);
    int i = 0;
    ...
    if ((i != 0) && (asua.a().a())) {
      paramView.a(2131370536, this.jdField_a_of_type_AndroidContentContext.getString(2131694468), 2130838614);
    }
    return paramView.a();
  }
}
