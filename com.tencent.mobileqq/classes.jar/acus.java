  ...
  implements acup
{
  ...
  private acur jdField_a_of_type_Acur;
  private int jdField_b_of_type_Int;
  private long jdField_b_of_type_Long = -2147483648L;
  
  public acus(acur paramacur)
  {
    this.jdField_a_of_type_Acur = paramacur;
  }
  ...
  {
    String str2 = "";
    if (this.jdField_a_of_type_Acur != null) {}
    for (Activity localActivity = this.jdField_a_of_type_Acur.a();; localActivity = null)
    {
      String str1 = str2;
  ...
  private void a(GdtAd paramGdtAd)
  {
    ...
    localacrd.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(2);
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localacrd);
  }
  ...
  private void b(GdtAd paramGdtAd)
  {
    ...
    acrd localacrd = new acrd();
    localacrd.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(1);
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localacrd);
  }
  ...
  private void c(GdtAd paramGdtAd)
  {
    ...
    acrd localacrd = new acrd();
    localacrd.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(5);
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localacrd);
  }
  ...
  private void d(GdtAd paramGdtAd)
  {
    ...
    acrd localacrd = new acrd();
    localacrd.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(6);
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localacrd);
  }
  ...
  private void f(GdtAd paramGdtAd)
  {
    ...
    acrd localacrd = new acrd();
    localacrd.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(3);
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localacrd.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localacrd);
  }
