  ...
  implements Manager
{
  ...
  public acus(QQAppInterface paramQQAppInterface)
  {
  ...
  private MessageRecord a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    int i = b(paramInt2);
    MessageRecord localMessageRecord = axaq.a(i);
    List localList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramString1, paramInt1);
    if ((localList != null) && (localList.size() > 0)) {}
    for (long l = 1L + ((MessageRecord)localList.get(localList.size() - 1)).time;; l = awzw.a())
    {
  ...
  private void a()
  {
    ...
    localObject1 = localaukn.a(BeancurdMsg.class, new BeancurdMsg().getTableName(), false, null, null, null, null, null, null);
    ...
    for (;;)
    {
      ...
      if (localObject1 != null)
      {
        ...
        {
          localaukn.b((BeancurdMsg)((Iterator)localObject1).next());
          continue;
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    if (!akau.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, false)) {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", str, str, 0, 0, "", Integer.toString(paramInt2), "", "");
      return;
      str = "0x8009431";
      continue;
      str = "0x8009432";
