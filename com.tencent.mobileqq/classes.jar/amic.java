...
public class amic
  implements amin, RecyclerView.ItemAnimator.ItemAnimatorFinishedListener, View.OnClickListener
{
  private static int jdField_a_of_type_Int = 2131167148;
  private static int jdField_b_of_type_Int = 2131167134;
  private static int c = 2130839000;
  ...
  public amic(Context paramContext, amin paramamin)
  {
  ...
  {
    e();
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558809, null);
    this.jdField_a_of_type_ComTencentMobileqqColornoteListColorNoteListLayout = ((ColorNoteListLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364390));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364394));
    this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView = ((BounceScrollView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363400));
    ...
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131364393));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new amid(this));
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(new amie(this));
    localObject = new amif(this);
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener((View.OnTouchListener)localObject);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131363400).setOnTouchListener((View.OnTouchListener)localObject);
  ...
  private void d()
  {
    ...
    {
      localViewPropertyAnimator.translationX(f).setDuration(180L).setListener(new amik(this)).start();
      return;
    }
  }
  ...
  private void e()
  {
    ...
    {
      jdField_a_of_type_Int = 2131165291;
      jdField_b_of_type_Int = 2131165275;
      c = 2130839001;
      return;
    }
    jdField_a_of_type_Int = 2131167148;
    jdField_b_of_type_Int = 2131167134;
    c = 2130839000;
  }
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    c();
    this.jdField_a_of_type_Amhx = new amhx();
    this.jdField_a_of_type_Amhx.a(this);
    this.jdField_a_of_type_Amhx.a(paramBoolean);
    List localList = ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a().a().a();
    this.jdField_a_of_type_Amhx.a(localList);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Amhx);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setVisibility(4);
    this.jdField_a_of_type_Amhx.a(new amig(this));
    Object localObject;
    if (localList.size() > 0)
    {
      localObject = (ColorNote)localList.get(0);
      if (amhi.b((ColorNote)localObject)) {
        axqw.b(null, "dc00898", "", "", "0X800A8AA", "0X800A8AA", amgn.b(amhi.a(((ColorNote)localObject).getServiceType())), 0, "", "", "", "");
      }
    }
    ...
    this.jdField_a_of_type_AndroidViewView.animate().alpha(0.9F).setDuration(200L).setListener(new amij(this, paramBoolean)).start();
    ...
    for (paramInt2 = i;; paramInt2 = i)
    {
      ...
      paramInt1 = i;
      break;
      axqw.b(null, "dc00898", "", "", "0X800A6CD", "0X800A6CD", 0, 0, localList.size() + "", amgn.a(paramInt1) + "", "", "");
      return;
      label519:
      i = paramInt1;
      paramInt1 = paramInt2;
  ...
  {
    if (this.jdField_a_of_type_Amhx.getItemCount() == 0) {
      d();
    }
  }
