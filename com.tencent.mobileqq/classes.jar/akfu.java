...
public class akfu
{
  ...
  public static void a(LaunchParam paramLaunchParam, int paramInt, OnUpdateListener paramOnUpdateListener)
  {
    ...
    localBundle.putParcelable("receiver", akbm.a(new ComIPCUtils.2(null, paramOnUpdateListener)));
    QIPCClientHelper.getInstance().callServer("QWalletIPCModule", "ComIPCUtils", localBundle, null);
  }
  ...
  public static void a(LoadParam paramLoadParam, LoadParam.LoadItem paramLoadItem, bbzg parambbzg)
  {
    Bundle localBundle = new Bundle();
    localBundle.putInt("oper_type", 17);
    ...
    localBundle.putSerializable("load_param", paramLoadParam);
    localBundle.putSerializable("load_item", paramLoadItem);
    QIPCClientHelper.getInstance().callServer("QWalletIPCModule", "ComIPCUtils", localBundle, new akfv(parambbzg));
  }
  ...
  public static void a(String paramString, ajyk paramajyk)
  {
    ...
    localBundle.putInt("code", paramajyk.hashCode());
    localBundle.putParcelable("receiver", akbm.a(new ComIPCUtils.3(null, paramajyk, paramString)));
    QIPCClientHelper.getInstance().callServer("QWalletIPCModule", "ComIPCUtils", localBundle, null);
  }
