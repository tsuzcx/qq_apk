  ...
  implements ViewTreeObserver.OnGlobalLayoutListener
{
  ...
  private final List<avwk> jdField_a_of_type_JavaUtilList = new LinkedList();
  private boolean jdField_a_of_type_Boolean;
  private int b = 200;
  
  public avwj(View paramView)
  {
    this(paramView, false);
  }
  
  public avwj(View paramView, boolean paramBoolean)
  {
  ...
  private void a()
  {
    ...
    {
      avwk localavwk = (avwk)localIterator.next();
      if (localavwk != null) {
        localavwk.onSoftKeyboardClosed();
      }
    }
  }
  ...
  private void a(int paramInt)
  {
    ...
    while (localIterator.hasNext())
    {
      avwk localavwk = (avwk)localIterator.next();
      if (localavwk != null) {
        localavwk.onSoftKeyboardOpened(paramInt);
      }
    }
  }
  
  public void a(avwk paramavwk)
  {
    this.jdField_a_of_type_JavaUtilList.add(paramavwk);
  }
  
  public void b(avwk paramavwk)
  {
    this.jdField_a_of_type_JavaUtilList.remove(paramavwk);
  }
