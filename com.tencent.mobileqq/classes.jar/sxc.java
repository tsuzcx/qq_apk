...
public class sxc
{
  ...
  private static String a(ArticleCenter.GetUrlByVidResponse paramGetUrlByVidResponse)
  {
    ...
    for (;;)
    {
      ...
      label363:
      localObject1 = paramGetUrlByVidResponse;
      olh.a(null, null, "0X8009824", "0X8009824", 0, 0, "", "", "", "", false);
      return paramGetUrlByVidResponse;
      localObject1 = localException2;
      olh.a(null, null, "0X8009825", "0X8009825", 0, 0, "", "", "", "", false);
      return null;
    }
    label422:
    return null;
  ...
  public static sxc a(String paramString, ArticleCenter.VideoInfo paramVideoInfo)
  {
    sxc localsxc = new sxc();
    boolean bool;
    if (paramVideoInfo != null)
    {
      localsxc.jdField_b_of_type_JavaLangString = paramString;
      if (paramVideoInfo.url.get() == null) {
        break label111;
      }
      paramString = paramVideoInfo.url.get().toStringUtf8();
      localsxc.jdField_a_of_type_JavaLangString = paramString;
      if (paramVideoInfo.encode_type.get() != 1) {
        break label117;
      }
      bool = true;
      label56:
      localsxc.jdField_a_of_type_Boolean = bool;
    ...
    {
      localsxc.jdField_c_of_type_JavaLangString = paramString;
      localsxc.jdField_b_of_type_Int = paramVideoInfo.width.get();
      localsxc.jdField_c_of_type_Int = paramVideoInfo.height.get();
      return localsxc;
      paramString = "";
      break;
      bool = false;
  ...
  static boolean a(ArticleCenter.GetUrlByVidResponse paramGetUrlByVidResponse, sxc paramsxc)
  {
    boolean bool2 = false;
    paramsxc.jdField_a_of_type_JavaLangString = qxl.b(paramGetUrlByVidResponse.url);
    paramsxc.jdField_d_of_type_Int = paramGetUrlByVidResponse.ret_info.ret_code.get();
    paramsxc.jdField_a_of_type_Int = paramGetUrlByVidResponse.video_type.get();
    if (paramGetUrlByVidResponse.encode_type.get() == 1) {}
    for (boolean bool1 = true;; bool1 = false)
    {
      paramsxc.jdField_a_of_type_Boolean = bool1;
      paramsxc.jdField_b_of_type_Int = paramGetUrlByVidResponse.width.get();
      paramsxc.jdField_c_of_type_Int = paramGetUrlByVidResponse.height.get();
      paramsxc.jdField_c_of_type_JavaLangString = qxl.b(paramGetUrlByVidResponse.rate);
      paramsxc.jdField_a_of_type_Long = paramGetUrlByVidResponse.file_size.get();
      if (paramsxc.jdField_a_of_type_Boolean) {
        paramsxc.e = a(paramGetUrlByVidResponse);
      }
      Object localObject = qxl.b(paramGetUrlByVidResponse.json_video_detail);
      bool1 = bool2;
      ...
      try
      {
        ...
        if (paramsxc.jdField_a_of_type_Boolean) {
          paramsxc.jdField_b_of_type_Boolean = localJSONObject.optBoolean("isH265HWCodec", true);
        }
        paramsxc.jdField_d_of_type_JavaLangString = localJSONObject.optString("reportInfo", "");
        bool1 = bool2;
        if (QLog.isColorLevel())
        {
      ...
      while (paramGetUrlByVidResponse.hasNext())
      {
        ...
        localObject = a(paramsxc.jdField_b_of_type_JavaLangString, (ArticleCenter.VideoInfo)localObject);
        paramsxc.jdField_a_of_type_JavaUtilArrayList.add(localObject);
      }
    }
    return bool1;
  }
