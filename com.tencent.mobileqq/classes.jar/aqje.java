...
public class aqje
  extends ajxj
{
  public aqje(QQSettingChatOperationFragment paramQQSettingChatOperationFragment) {}
  ...
  protected void onSetGeneralSettingsC2CRoaming(boolean paramBoolean, Map<String, Integer> paramMap)
  {
    ...
    if (paramBoolean)
    {
      bcql.a(paramMap.getApplicationContext(), 2, 2131695347, 0).b(this.a.getActivity().getTitleBarHeight());
      return;
    }
    ...
    for (paramBoolean = bool;; paramBoolean = false)
    {
      ...
      bcql.a(paramMap.getApplicationContext(), 2131695345, 0).b(paramMap.getTitleBarHeight());
      return;
    }
  }
