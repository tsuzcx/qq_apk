  ...
  extends WebViewClient
{
  ...
  WebResourceResponse a(WebView paramWebView, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      try
      {
        if (ahhx.a(paramString1))
        {
          WebResourceResponse localWebResourceResponse = ahhx.a(paramString1);
  ...
  public void onPageStarted(WebView paramWebView, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramWebView = new Bundle();
          paramWebView.putStringArrayList("recognised-text", bcfr.a());
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    for (;;)
    {
      acsz.b(this.b.jdField_a_of_type_AndroidContentIntent, str);
      paramString = bcgq.b(str);
      if ((this.b.jdField_a_of_type_Bccx == null) || (!this.b.jdField_a_of_type_Bccx.c(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, str))) {
        break label298;
      }
      ...
      break;
      label261:
      QLog.d("WebLog_WebViewWrapper", 2, "shouldOverrideUrlLoading:" + nau.b(str, new String[0]));
    }
    label298:
    ...
    try
    {
      ...
      if ((this.b.jdField_a_of_type_Bccx != null) && (this.b.jdField_a_of_type_Bccx.b(paramWebView, str))) {
        return true;
      }
      ...
      {
        boolean bool = this.b.jdField_a_of_type_Bccx.a(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, str);
        if (bool) {
          return true;
        }
      }
