...
{
  apqp(apqo paramapqo, Rect paramRect, long paramLong, Object paramObject, MiniCodeDetector paramMiniCodeDetector, boolean[] paramArrayOfBoolean, Bitmap paramBitmap) {}
  
  public void onDetectReady(int paramInt)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqMinicodeRecogMiniCodeDetector != null) && (apqo.a(this.jdField_a_of_type_Apqo) != null)) {
  ...
  public void onDetectResult(List<apqk> arg1, long paramLong)
  {
    int i = 0;
    label55:
    boolean bool;
    ...
    if (i < ???.size())
    {
      if (((apqk)???.get(i)).jdField_a_of_type_Int != 2) {
        break label217;
      }
      ??? = (apqk)???.get(i);
