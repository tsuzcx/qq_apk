...
class apqp
  implements alef
{
  apqp(apqh paramapqh, int paramInt1, int paramInt2, int paramInt3, String paramString1, int paramInt4, boolean paramBoolean, String paramString2, String paramString3, String paramString4, Bundle paramBundle, MessengerService paramMessengerService) {}
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      localBundle.putBoolean("apollo_is_super_yellow", aknx.c());
