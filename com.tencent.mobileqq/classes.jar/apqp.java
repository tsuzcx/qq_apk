  ...
  extends apqn
{
  ...
  public apqp(Activity paramActivity)
  {
    super(paramActivity);
  }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)BaseApplicationImpl.getContext().getSystemService("layout_inflater")).inflate(2131560502, this.jdField_a_of_type_AndroidViewViewGroup, false);
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370594));
      ...
      this.f = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362523));
  ...
  public void d(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843497);
  ...
  public void e(String paramString)
  {
    ...
    this.g.setText(apue.a(paramString, false, this.g.getMeasuredWidth(), this.g.getPaint(), 2));
  }
