...
public final class alhe
{
  ...
  static
  {
    jdField_a_of_type_Alhf = new alhf(null);
  }
  
  public alhe(int paramInt1, @NotNull String paramString1, @NotNull String paramString2, @NotNull String paramString3, int paramInt2, int paramInt3)
  {
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof alhe))
      {
        paramObject = (alhe)paramObject;
