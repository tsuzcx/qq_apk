...
{
  public abwb(AccountManageActivity paramAccountManageActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      paramView.setContentDescription(this.a.getString(2131691159));
      return;
    ...
    paramView.setContentDescription(this.a.getString(2131691171));
    return;
    AccountManageActivity.a(this.a).a();
    ((RotateSwitchImageView)paramView).b();
