...
public class qlf
{
  ...
  private static ArrayList<qli> jdField_a_of_type_JavaUtilArrayList;
  private static AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private static JSONObject jdField_a_of_type_OrgJsonJSONObject;
  private static qlj jdField_a_of_type_Qlj;
  ...
  private static ArrayList<qli> a()
  {
    ...
    try
    {
      ...
      while (i < localJSONArray.length())
      {
        ...
        localqli.jdField_a_of_type_JavaLangString = ((JSONObject)localObject).getString("vid");
        localqli.jdField_a_of_type_Long = ((JSONObject)localObject).getLong("bitrate");
        localqli.jdField_b_of_type_Long = ((JSONObject)localObject).getLong("timeout_ms");
        localqli.jdField_a_of_type_Float = Float.valueOf(((JSONObject)localObject).getString("hevc_level")).floatValue();
        localqli.jdField_a_of_type_Int = ((JSONObject)localObject).getInt("max_hashdiff");
        localqli.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).optString("tag");
        ...
        while (j < ((JSONArray)localObject).length())
        {
          ...
          localqlq.jdField_a_of_type_Int = localJSONObject.getInt("index");
          localqlq.jdField_a_of_type_Long = localJSONObject.getLong("serverHash");
          localqli.jdField_a_of_type_JavaUtilArrayList.add(localqlq);
          j += 1;
        }
        localArrayList.add(localqli);
        i += 1;
      }
  ...
  {
    String str1 = (String)bhvh.a("kandian_video_extract_frame", "");
    if (QLog.isColorLevel()) {
    ...
    String str2 = (String)bhvh.a("kandian_video_extract_frame_local_result", "");
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!localException1.equals(str2))
        {
          ...
          bhvh.a("kandian_video_extract_frame_local_result", jdField_b_of_type_OrgJsonJSONObject.toString());
        }
  ...
  public static void b()
  {
    ...
    if ((jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (!jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true)) && (jdField_a_of_type_Qlj != null))
    {
      jdField_a_of_type_Qlj.b();
      jdField_a_of_type_Qlj = null;
    }
  }
  
  private static void b(Context paramContext, qli paramqli, int paramInt, String paramString, HashMap<Integer, qlq> paramHashMap)
  {
    ...
    try
    {
      ...
      localJSONObject.put("subversion", "8.2.8");
      if (jdField_a_of_type_OrgJsonJSONObject == null) {
        break label632;
      }
      localObject = jdField_a_of_type_OrgJsonJSONObject.optString("version");
      localJSONObject.put("server_version", localObject);
      localJSONObject.put("video_tag", paramqli.jdField_b_of_type_JavaLangString);
      localJSONObject.put("video_vid", paramqli.jdField_a_of_type_JavaLangString);
      localJSONObject.put("video_bitrate", paramqli.jdField_a_of_type_Long);
      localJSONObject.put("video_width", paramqli.jdField_b_of_type_Int);
      localJSONObject.put("video_height", paramqli.c);
      ...
      if (bool1)
      {
        ...
        {
          localObject = (qlq)paramString.next();
          if (((qlq)localObject).jdField_b_of_type_Int > paramqli.jdField_a_of_type_Int) {
            bool1 = false;
          }
          i += ((qlq)localObject).jdField_b_of_type_Int;
          k = j;
          if (j > ((qlq)localObject).jdField_b_of_type_Int) {
            k = ((qlq)localObject).jdField_b_of_type_Int;
          }
          if (paramInt >= ((qlq)localObject).jdField_b_of_type_Int) {
            break label645;
          }
          paramInt = ((qlq)localObject).jdField_b_of_type_Int;
          break label625;
        }
      ...
      paramqli = new JSONArray();
      paramString = paramHashMap.values().iterator();
      while (paramString.hasNext())
      {
        paramHashMap = (qlq)paramString.next();
        ...
        paramqli.put(localObject);
        continue;
        localHashMap.put("param_content", localJSONObject.toString());
      }
    }
    catch (Exception paramqli) {}
    for (;;)
    {
      localHashMap.put("param_device", qla.a(false));
      if (QLog.isColorLevel()) {
        QLog.d("VideoExtractFrame", 2, "灯塔数据上报 reportMap = " + localHashMap.toString());
      }
      paramqli = (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime();
      if (paramqli != null) {
        axrl.a(paramContext).a(paramqli.c(), "actKandianVideoExtractFrame", true, -1L, 0L, localHashMap, null);
      }
      return;
      localJSONObject.put("detail_list", paramqli);
    }
    label645:
    for (;;)
    {
  ...
  private static void b(qli paramqli, String paramString, HashMap<Integer, qlq> paramHashMap, long paramLong)
  {
    if (QLog.isColorLevel()) {
      QLog.d("VideoExtractFrame", 2, "innerDoExtractFrame start() videoInfo.tag = " + paramqli.jdField_b_of_type_JavaLangString);
    }
    jdField_a_of_type_Long = System.currentTimeMillis();
    jdField_a_of_type_Qlj = new qlj(BaseApplication.getContext(), paramString, paramHashMap, paramLong);
    jdField_a_of_type_Qlj.a(new qlh(paramqli));
    jdField_a_of_type_Qlj.a();
  }
  ...
  private static void c()
  {
    try
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        if (((qli)((Iterator)localObject).next()).jdField_a_of_type_Float > f) {
      ...
      localObject = (qli)jdField_a_of_type_JavaUtilArrayList.get(i);
      HashMap localHashMap = new HashMap();
      Iterator localIterator = ((qli)localObject).jdField_a_of_type_JavaUtilArrayList.iterator();
      while (localIterator.hasNext())
      {
        qlq localqlq = (qlq)localIterator.next();
        localHashMap.put(Integer.valueOf(localqlq.jdField_a_of_type_Int), localqlq);
      }
      onx.a().a(((qli)localObject).jdField_a_of_type_JavaLangString, "PubAccountArticleCenter.GetUrlByVid", new qlg((qli)localObject, localHashMap));
      return;
    }
    catch (Exception localException) {}
  }
