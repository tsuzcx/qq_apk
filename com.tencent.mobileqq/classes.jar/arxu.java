  ...
  implements Manager
{
  ...
  public arxu(NearbyAppInterface paramNearbyAppInterface)
  {
  ...
  public static void a(String paramString, long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    if (!axql.c())
    {
      axqc.a(paramString, "DatingManager.maplng", Long.valueOf(paramLong1));
      axqc.a(paramString, "DatingManager.maplat", Long.valueOf(paramLong2));
      axqc.a(paramString, "DatingManager.timestamp", Long.valueOf(paramLong3));
      return;
    }
