  ...
  extends RemoteCommand
{
  ...
  private void a(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity)
  {
    ...
    paramFileManagerEntity.putExtra("forward_text", anzj.a(2131708591) + aunj.d(localFileManagerEntity.fileName) + anzj.a(2131708603) + auog.a(localFileManagerEntity.fileSize) + "。");
    paramFileManagerEntity.putExtra("k_favorites", aunj.c(localFileManagerEntity));
    if ((!auog.b(localFileManagerEntity.getFilePath())) && ((localFileManagerEntity.getCloudType() == 6) || (localFileManagerEntity.getCloudType() == 7)) && (localFileManagerEntity.nFileType == 0)) {
      paramFileManagerEntity.putExtra("forward_type", 0);
    }
    ...
    if (aumg.a(localFileManagerEntity).a(false))
    {
      aumw.a(paramActivity, 2131692326, 2131692331, new bmox(this, paramActivity, paramFileManagerEntity));
      return;
    }
    auxu.a(paramActivity, paramFileManagerEntity, 103);
  }
  ...
  private void a(String paramString)
  {
    ...
    try
    {
      ...
      if (i > 0)
      {
        ...
        {
          a(localQQAppInterface, localActivity, aunj.a(new FileInfo(paramString)));
          return;
        }
        bmqw.a("QRRemoteCommond", "No Activity to use to forward file");
        return;
      }
    }
    catch (FileNotFoundException paramString)
    {
      bmqw.a("QRRemoteCommond", "file not found", paramString);
    }
  }
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    Object localObject1 = (aody)a().getManager(56);
    ...
    for (paramBundle = paramBundle.getString("uin"); localObject1 != null; paramBundle = null)
    {
      for (;;)
      {
        if (((aody)localObject1).b(paramBundle) != null) {
        ...
        ((Bundle)localObject2).putInt("qq_vip_level", bmoy.a(a(), null));
        return localObject2;
        ((Bundle)localObject2).putShort("qq_vip_info", bmoy.a(a(), null));
        return localObject2;
        if (a() == null) {
          break;
        }
        paramBundle = paramBundle.getString("publicaccount_uin");
        ((Bundle)localObject2).putBoolean("publicaccount_is_follow", tzq.a(a(), paramBundle));
        return localObject2;
        if (a() == null) {
          break;
        }
        localObject1 = paramBundle.getString("publicaccount_uin");
        Object localObject3 = (aody)a().getManager(56);
        paramBundle = paramOnInvokeFinishLinstener;
        if (localObject3 != null) {
          paramBundle = ((aody)localObject3).b((String)localObject1);
        }
        if (paramBundle != null)
        {
        ...
        case 2: 
          for (;;)
          {
            ...
            bmud.a(a(), a().getApplication().getApplicationContext(), paramBundle, null);
            continue;
        ...
        if (paramOnInvokeFinishLinstener != null)
        {
          paramOnInvokeFinishLinstener = (bbav)paramOnInvokeFinishLinstener.getManager(36);
          if (paramOnInvokeFinishLinstener != null)
          {
            paramBundle = paramOnInvokeFinishLinstener.a(paramBundle.getString("path"));
            if (paramBundle != null) {
              ((Bundle)localObject2).putParcelable("redTouchInfo", bbaz.a(paramBundle));
            }
          }
        }
        for (;;)
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (localObject2 != null) {
          paramBundle.add(bbaz.a((BusinessInfoCheckUpdate.AppInfo)localObject2));
        }
      }
