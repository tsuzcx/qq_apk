  ...
  extends WebViewClient
{
  ...
  public void onPageStarted(WebView paramWebView, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramWebView = new Bundle();
          paramWebView.putStringArrayList("recognised-text", bejb.a());
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    for (;;)
    {
      aeoy.b(this.b.jdField_a_of_type_AndroidContentIntent, str);
      paramString = beka.b(str);
      if ((this.b.jdField_a_of_type_Begh == null) || (!this.b.jdField_a_of_type_Begh.c(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, str))) {
        break label298;
      }
    ...
    try
    {
      ...
      if ((this.b.jdField_a_of_type_Begh != null) && (this.b.jdField_a_of_type_Begh.b(paramWebView, str))) {
        return true;
      }
      ...
      {
        boolean bool = this.b.jdField_a_of_type_Begh.a(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, str);
        if (bool) {
          return true;
        }
      }
