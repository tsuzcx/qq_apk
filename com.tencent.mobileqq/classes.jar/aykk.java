  ...
  implements GetChars, Spannable, CharSequence, Cloneable
{
  ...
  public int a;
  private awje jdField_a_of_type_Awje;
  ...
  static
  {
    jdField_c_of_type_JavaLangString = ajya.a(2131711151);
    jdField_b_of_type_ArrayOfJavaLangObject = new Object[0];
    jdField_a_of_type_AndroidTextSpannable$Factory = new aykl();
    try
    {
  ...
  public aykk(CharSequence paramCharSequence, int paramInt)
  {
    this(paramCharSequence, paramInt, 32);
  }
  
  public aykk(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
    this(paramCharSequence, 0, paramCharSequence.length(), paramInt1, paramInt2, -1);
  }
  
  public aykk(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3) {}
  
  protected aykk(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    for (paramInt4 = 1;; paramInt4 = 0)
    {
      ...
      if (paramInt4 != 0)
      {
        localObject2 = (aykr[])getSpans(paramInt1, paramInt2, aykr.class);
        if (localObject2 != null)
        {
          ...
          if (paramInt4 < paramInt5)
          {
            ...
            if (((aykr)localObject3).jdField_c_of_type_Int == 1) {
              ((aykr)localObject3).jdField_a_of_type_Int &= 0x7FFFFFFF;
            }
            for (;;)
            {
              paramInt4 += 1;
              break;
              if (((aykr)localObject3).jdField_c_of_type_Int == 2) {
                ((aykt)localObject3).jdField_b_of_type_Boolean = false;
              }
            }
          }
        }
      ...
      if (((paramInt3 & 0x8) == 8) && (this.e != null)) {
        if ((jdField_a_of_type_JavaLangString.length() > 3) && (jdField_a_of_type_JavaLangString.charAt(jdField_a_of_type_JavaLangString.length() - 3) == '0') && (jdField_a_of_type_JavaLangString.charAt(jdField_a_of_type_JavaLangString.length() - 2) == '1'))
        {
          ...
          localObject3 = axrn.a(BaseApplication.getContext());
      ...
      {
        ((axrn)localObject3).a(null, "qq_url_length_report", bool, 0L, 0L, (HashMap)localObject2, null);
        if (this.e.length() < 1000) {
          a();
        }
      ...
      axrn.a(BaseApplication.getContext()).a(null, "qqTextData", false, 0L, 0L, (HashMap)localObject2, null);
      return;
    }
  }
  
  public aykk(CharSequence paramCharSequence, int paramInt1, int paramInt2, MessageRecord paramMessageRecord)
  {
    this(paramCharSequence, 0, paramCharSequence.length(), paramInt1, paramInt2, -1);
  ...
  private int a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, StringBuilder paramStringBuilder)
  {
    ...
    if (k < paramInt2)
    {
      ...
      if ((paramInt3 & 0x4) == 4)
      {
        ...
        if (m >= ayjy.jdField_a_of_type_Int) {
          break label252;
        }
        if (!jdField_a_of_type_Boolean) {
          break label230;
        ...
        a(new aykr(i, paramInt4, 1), k, k + 2, 33);
        i = k + 1;
        k = j + 1;
        paramInt1 += 1;
        j = i;
    ...
    for (;;)
    {
      ...
      if ((m >= 255) && (k + 4 < i5))
      {
        ...
        {
          bool2 = true;
          a(new aykt(arrayOfChar, paramInt4, bool1, bool2), k, k + 5, 33);
          i = 2;
          if (i >= 5) {
            break label504;
          }
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    localbfpc.a(String.format(paramContext.getString(2131694752), new Object[] { paramString }));
    localbfpc.a(2131691317, 1);
    localbfpc.a(2131689692, 1);
    localbfpc.c(2131690596);
    localbfpc.a(new aykq(bfnv.a(new aykp(paramContext, paramString, localbfpc)).a(1000L)));
    localbfpc.show();
  }
  ...
  public static void a(Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    ...
    if (paramInt == 0)
    {
      localbfpc.a(String.format(paramContext.getString(2131694751), new Object[] { paramString1 }));
      localbfpc.a(2131691644, 1);
      localbfpc.a(2131691307, 1);
      localbfpc.a(2131689685, 1);
      localbfpc.a(2131689648, 1);
      localbfpc.a(2131693695, 1);
    }
    for (;;)
    {
      localbfpc.c(2131690596);
      localbfpc.a(new aykm(paramInt, paramString1, paramContext, paramString2, localbfpc));
      localbfpc.show();
      return;
      if (paramInt == 1)
      {
        localbfpc.a(String.format(paramContext.getString(2131694752), new Object[] { paramString1 }));
        localbfpc.a(2131691644, 1);
        localbfpc.a(2131691307, 1);
        localbfpc.a(2131689685, 1);
      }
      ...
      {
        localbfpc.a(String.format(paramContext.getString(2131694068), new Object[] { paramString1 }));
        localbfpc.a(2131719271, 1);
        localbfpc.a(2131691307, 1);
      }
      else if (paramInt == 3)
      {
  ...
  public static boolean a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (i < paramString.length())
      {
        ...
        if (ayjy.jdField_a_of_type_AndroidUtilSparseIntArray.get(j, -1) < 0) {
          break label43;
        }
      }
      label43:
  ...
  private static void c(String paramString1, String paramString2)
  {
    try
    {
      axqy.b((QQAppInterface)BaseApplicationImpl.getApplication().getAppRuntime(jdField_a_of_type_JavaLangString), "dc00898", "", "", paramString1, paramString2, 0, 0, "", "", "", "");
      return;
    }
  ...
  private static void d(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      {
        axqy.b(localQQAppInterface1, "P_CliOper", "Grp_join", "", "send", "Clk_url", 0, 0, jdField_b_of_type_JavaLangString, "" + paramString1, "" + paramString2, "");
        return;
      }
    }
    catch (ClassCastException localClassCastException)
    {
      ...
      axqy.b(localQQAppInterface2, "P_CliOper", "Grp_join", "", "send", "Clk_item", 0, 0, jdField_b_of_type_JavaLangString, "" + paramString1, "" + paramString1, "");
      return;
    }
    catch (AccountNotMatchException paramString1) {}
  }
  ...
  public aykk a(String paramString, boolean paramBoolean, int... paramVarArgs)
  {
    aykk localaykk = new aykk("", 0);
    localaykk.jdField_d_of_type_Int = this.jdField_d_of_type_Int;
    localaykk.jdField_c_of_type_Int = this.jdField_c_of_type_Int;
    localaykk.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
    localaykk.jdField_b_of_type_Int = this.jdField_b_of_type_Int;
    localaykk.jdField_a_of_type_ArrayOfInt = new int[this.jdField_a_of_type_ArrayOfInt.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfInt, 0, localaykk.jdField_a_of_type_ArrayOfInt, 0, this.jdField_a_of_type_ArrayOfInt.length);
    localaykk.jdField_a_of_type_ArrayOfJavaLangObject = new Object[this.jdField_a_of_type_ArrayOfJavaLangObject.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfJavaLangObject, 0, localaykk.jdField_a_of_type_ArrayOfJavaLangObject, 0, this.jdField_a_of_type_ArrayOfJavaLangObject.length);
    int i = 0;
    int j = 0;
    ...
    if (paramBoolean)
    {
      ...
      int k = 0;
      while (k < localaykk.jdField_a_of_type_ArrayOfJavaLangObject.length)
      {
      ...
      if (i != 0) {
        localaykk.a(0, paramString.length(), i, j, localStringBuilder);
      }
      localaykk.jdField_d_of_type_JavaLangString = (paramString + this.jdField_d_of_type_JavaLangString);
      localaykk.e = localStringBuilder.toString();
    ...
    {
      if (i != 0) {
        localaykk.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
      }
      return localaykk;
      localStringBuilder = new StringBuilder().append(paramString).append(this.e);
      if (i != 0) {
        localaykk.a(this.e.length(), this.e.length() + paramString.length(), i, j, localStringBuilder);
      }
  ...
  public String a()
  {
    ...
    if (j < this.jdField_b_of_type_Int)
    {
      ...
      if ((localObject instanceof aykr))
      {
        ...
        switch (((aykr)localObject).jdField_c_of_type_Int)
        {
        default: 
          i = k;
        }
      ...
      for (;;)
      {
        ...
        continue;
        localObject = ayjy.jdField_a_of_type_ArrayOfJavaLangString[(localObject.jdField_a_of_type_Int & 0x7FFFFFFF)];
        localStringBuffer.replace(i + k, n + k, (String)localObject);
        i = k + (((String)localObject).length() - (n - i));
      }
    }
  ...
  protected void a()
  {
    Object localObject = ayky.a(this.e);
    if ((localObject != null) && (((List)localObject).size() > 0))
    {
      localObject = ((List)localObject).iterator();
      while (((Iterator)localObject).hasNext())
      {
        ayjz localayjz = (ayjz)((Iterator)localObject).next();
        a(new ayks(this, localayjz.jdField_a_of_type_JavaLangString), localayjz.jdField_a_of_type_Int, localayjz.jdField_b_of_type_Int, 33);
      }
    }
  }
  ...
  public void a(Context paramContext, String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    if (paramInt == 2)
    {
      ...
      localObject3 = (ajxl)((QQAppInterface)localObject1).getManager(51);
      if (paramInt != 0) {
        break label367;
      }
      if (bbfj.a()) {
      ...
      localbfpc.a(String.format(paramContext.getString(2131694752), new Object[] { paramString }));
      localbfpc.a(2131691307, 1);
      localbfpc.a(2131692324, 1);
      localbfpc.a(2131691644, 1);
      localbfpc.a(2131689685, 1);
      axqy.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800A923", "0X800A923", awje.a((QQAppInterface)localObject1, paramMessageRecord.istroop, paramMessageRecord.frienduin), 0, "", "", "", "");
    }
    for (;;)
    {
      localbfpc.c(2131690596);
      localbfpc.a(new aykn(this, paramContext, paramString, (QQAppInterface)localObject1, i, paramMessageRecord, paramInt, localbfpc));
      localbfpc.a(new ayko(this, (QQAppInterface)localObject1, i));
      localbfpc.show();
      return;
      i = 4;
      break;
      label328:
      if (this.jdField_a_of_type_Awje == null) {
        this.jdField_a_of_type_Awje = new awje(this.f);
      }
      this.jdField_a_of_type_Awje.a((QQAppInterface)localObject1, paramContext, paramString, (ChatMessage)paramMessageRecord);
      return;
      label367:
      if (paramInt == 1)
      {
        ...
        localbfpc.a(2131691644, 1);
        localbfpc.a(2131689685, 1);
        if ((!paramMessageRecord.isSend()) && (((ajxl)localObject3).b(paramMessageRecord.senderuin)))
        {
          localObject3 = (ajti)((QQAppInterface)localObject1).a(2);
          if (localObject3 != null) {
            ((ajti)localObject3).a(jdField_a_of_type_JavaLangString, paramMessageRecord.senderuin, 1, 0L, (byte)1, 0L, 0L, null, "", 0L, 10004, null, (byte)0);
          }
          localbfpc.a(2131689695, 1);
        }
        axqy.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800A923", "0X800A923", awje.a((QQAppInterface)localObject1, paramMessageRecord.istroop, paramMessageRecord.frienduin), 0, "", "", "", "");
      }
      else if (paramInt == 2)
      {
        localbfpc.a(String.format(paramContext.getString(2131694068), new Object[] { paramString }));
        localbfpc.a(2131691307, 1);
        localbfpc.a(2131692324, 1);
        localbfpc.a(2131719271, 1);
        axqy.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800A924", "0X800A924", awje.a((QQAppInterface)localObject1, paramMessageRecord.istroop, paramMessageRecord.frienduin), 0, "", "", "", "");
      }
      else if (paramInt == 3)
      {
        localbfpc.a(String.format(paramContext.getString(2131694752), new Object[] { paramString }));
  ...
  protected void a(View paramView, String paramString)
  {
    ...
    try
    {
      ...
      if ((localObject1 instanceof QQAppInterface)) {
        adfy.a(paramView.getContext(), (QQAppInterface)localObject1, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, 5, paramString);
      }
      localObject2 = null;
      ...
      if (ayfx.a((String)localObject1))
      {
        ...
        if (bbfj.d(BaseApplication.getContext()))
        {
          ...
          axqy.b(null, "CliOper", "", "", "0X80061B1", "0X80061B1", 0, 0, "", "", "", "");
          return;
        }
      }
    }
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        continue;
        bcql.a((Context)localObject2, ((Context)localObject2).getResources().getString(2131692321), 0).b(((Context)localObject2).getResources().getDimensionPixelSize(2131298865));
        continue;
        asow.a(paramView.getContext(), localThrowable, true, true, true, false, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, this.f);
      }
    }
    for (;;)
    {
      try
      {
        ...
        if (paramView.istroop == 1)
        {
          ...
          axqy.b(null, "CliOper", "", str1, "0X80061B1", "0X80061B1", i, 0, "", "", paramView, paramString);
  ...
  {
    aykk localaykk = (aykk)super.clone();
    localaykk.jdField_a_of_type_ArrayOfInt = new int[this.jdField_a_of_type_ArrayOfInt.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfInt, 0, localaykk.jdField_a_of_type_ArrayOfInt, 0, this.jdField_a_of_type_ArrayOfInt.length);
    localaykk.jdField_a_of_type_ArrayOfJavaLangObject = new Object[this.jdField_a_of_type_ArrayOfJavaLangObject.length];
    System.arraycopy(this.jdField_a_of_type_ArrayOfJavaLangObject, 0, localaykk.jdField_a_of_type_ArrayOfJavaLangObject, 0, this.jdField_a_of_type_ArrayOfJavaLangObject.length);
  ...
  {
    if ((paramObject instanceof aykk)) {
      return this.jdField_d_of_type_JavaLangString.equals(((aykk)paramObject).jdField_d_of_type_JavaLangString);
    }
    return false;
  }
  ...
  public CharSequence subSequence(int paramInt1, int paramInt2)
  {
    ...
    label73:
    return new aykk(this.e, paramInt1, paramInt2, this.jdField_a_of_type_Int, this.jdField_d_of_type_Int, this.jdField_c_of_type_Int);
  }
