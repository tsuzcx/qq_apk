  ...
  implements afaf
{
  ...
  public agme(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt, BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin = paramString;
  ...
  public FrameLayout a(LinearLayout paramLinearLayout)
  {
    ...
    this.jdField_a_of_type_Ahcz = new ahcz();
    this.jdField_a_of_type_Ahcz.jdField_a_of_type_ComTencentMobileqqDataChatMessage = this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg;
    this.jdField_a_of_type_Ahcz.jdField_a_of_type_AndroidWidgetRelativeLayout = this.jdField_a_of_type_Ahcp.b(this.jdField_a_of_type_Ahcz, this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_Ahcz.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg);
    Object localObject1 = paramLinearLayout.findViewById(2131374650);
    ...
    if (localObject1 == null)
    {
      ...
      this.jdField_a_of_type_Ahcz.jdField_a_of_type_AndroidWidgetRelativeLayout = this.jdField_a_of_type_Ahcp.b(this.jdField_a_of_type_Ahcz, this.jdField_a_of_type_AndroidContentContext);
      this.jdField_a_of_type_Ahcz.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg);
      ((FrameLayout)localObject2).addView(this.jdField_a_of_type_Ahcz.jdField_a_of_type_AndroidWidgetRelativeLayout, a(i, j, k, m));
      View localView = paramLinearLayout.findViewById(2131374679);
      localObject1 = localObject2;
      if (this.jdField_a_of_type_Ahcz.b != null)
      {
    ...
    for (;;)
    {
      ...
      return localObject1;
      label305:
      ((FrameLayout)localObject2).addView(this.jdField_a_of_type_Ahcz.b, (ViewGroup.LayoutParams)localObject1);
      break;
      ...
      if ((localObject1 instanceof FrameLayout))
      {
        ...
        this.jdField_a_of_type_Ahcz.jdField_a_of_type_AndroidWidgetRelativeLayout = this.jdField_a_of_type_Ahcp.b(this.jdField_a_of_type_Ahcz, this.jdField_a_of_type_AndroidContentContext);
        this.jdField_a_of_type_Ahcz.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg);
        ((FrameLayout)localObject1).addView(this.jdField_a_of_type_Ahcz.jdField_a_of_type_AndroidWidgetRelativeLayout, a(i, j, k, m));
        localObject2 = new RelativeLayout.LayoutParams(i, j);
        paramLinearLayout = paramLinearLayout.findViewById(2131374679);
        if (paramLinearLayout != null) {
          paramLinearLayout.setLayoutParams((ViewGroup.LayoutParams)localObject2);
        } else {
          ((FrameLayout)localObject1).addView(this.jdField_a_of_type_Ahcz.b, (ViewGroup.LayoutParams)localObject2);
        }
      }
      else
      {
  ...
  public void a(RedPackGrapInfo paramRedPackGrapInfo)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.frienduin = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin;
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin.equals(paramRedPackGrapInfo.lUin + "")) {
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.issend = 1;
    }
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.istroop = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType;
    ...
    this.jdField_a_of_type_Int = ahdf.a(paramRedPackGrapInfo.iMsgType);
  ...
  {
    int i = ahdf.a(paramMessageForQQWalletMsg.messageType);
    paramMessageForQQWalletMsg = ahdf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Ahcz, paramMessageForQQWalletMsg.mQQWalletRedPacketMsg.elem, i, this);
    if ((paramMessageForQQWalletMsg instanceof ahdc)) {
      ((ahdc)paramMessageForQQWalletMsg).a(new FaceDecoder(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
    }
    try
    {
  ...
  public boolean a(FrameLayout paramFrameLayout, RedPackGrapInfo paramRedPackGrapInfo, ajxv paramajxv)
  {
    if (paramFrameLayout == null) {
      return false;
    }
    this.jdField_a_of_type_Ahcp.a(paramajxv);
    paramFrameLayout = (RelativeLayout)paramFrameLayout.findViewById(2131374650);
    if (paramFrameLayout == null) {
      return false;
    }
    ...
    if (this.jdField_a_of_type_AndroidContentContext != null) {
      this.jdField_a_of_type_AndroidContentContext.getString(2131716277);
    }
    return this.jdField_a_of_type_Ahcp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie, paramFrameLayout, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_Int, paramRedPackGrapInfo.iSkinId, "");
  }
