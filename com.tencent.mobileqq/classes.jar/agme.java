...
{
  static String jdField_a_of_type_JavaLangString = bbkb.f(BaseApplication.getContext());
  ...
  private void g()
  {
    ...
    {
      localMessageForShortVideo = this.jdField_a_of_type_Agra.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
      i2 = this.jdField_a_of_type_Agra.jdField_a_of_type_Int;
    }
    for (;;)
    {
  ...
  public View a(Context paramContext, Handler paramHandler, agra paramagra, aejb paramaejb)
  {
    ...
    this.jdField_a_of_type_Long = paramagra.jdField_d_of_type_Long;
    ...
    catch (Exception paramContext)
    {
      ...
      axrn.a(BaseApplication.getContext()).a(null, "previewVideoViewCreateSuc", false, 0L, 0L, paramHandler, null);
  ...
  public void a(String paramString, long paramLong)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOutputMute(this.jdField_a_of_type_Agra.jdField_e_of_type_Boolean);
  ...
  public void f()
  {
    if ((!this.jdField_f_of_type_Boolean) || (this.jdField_a_of_type_Agra == null) || (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null)) {}
    Object localObject;
    do
    {
      return;
      localObject = this.jdField_a_of_type_Agra.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      str1 = null;
      if (!bbkk.a(this.jdField_g_of_type_JavaLangString)) {
        str1 = ayxg.a(this.jdField_g_of_type_JavaLangString);
      }
      i3 = i2;
      if (this.jdField_a_of_type_Agra.jdField_a_of_type_ArrayOfJavaLangString == null) {
        break label1349;
      }
      i3 = i2;
      if (this.jdField_a_of_type_Agra.jdField_a_of_type_ArrayOfJavaLangString.length <= 0) {
        break label1349;
      }
      i1 = 0;
      for (;;)
      {
        i3 = i2;
        if (i1 >= this.jdField_a_of_type_Agra.jdField_a_of_type_ArrayOfJavaLangString.length) {
          break;
        }
        String str2 = ayxg.a(this.jdField_a_of_type_Agra.jdField_a_of_type_ArrayOfJavaLangString[i1]);
    ...
    localHashMap.put("HttpDomain", this.jdField_a_of_type_Agra.jdField_c_of_type_JavaLangString);
    localStringBuffer1.append(" HttpDomain" + this.jdField_a_of_type_Agra.jdField_c_of_type_JavaLangString);
    ...
    for (str1 = "1";; str1 = "0")
    {
      ...
      axrn.a(BaseApplication.getContext()).a(null, "actStreamingVideoPlay", bool, this.jdField_g_of_type_Long, this.jdField_b_of_type_Long, localHashMap, "");
  ...
  public void onCompletion(TVK_IMediaPlayer paramTVK_IMediaPlayer)
  {
    ...
    if ((bfnz.b()) && (this.jdField_b_of_type_AndroidContentContext != null))
    {
  ...
  public void onSurfaceCreated(SurfaceHolder paramSurfaceHolder)
  {
    ...
    if (this.jdField_a_of_type_Agra != null)
    {
      ...
      if (this.jdField_a_of_type_Agra.jdField_a_of_type_JavaLangString != null) {
        a(this.jdField_a_of_type_Agra.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Agra.jdField_e_of_type_Long);
      }
    }
    label63:
    while (this.jdField_a_of_type_Agra.jdField_b_of_type_Boolean) {
      return;
    }
    ...
    label149:
    for (String str = "";; str = this.jdField_a_of_type_Agra.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.md5)
    {
      a(this.jdField_a_of_type_Agra.a(), paramSurfaceHolder, this.jdField_a_of_type_Agra.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_Agra.jdField_e_of_type_Long, str, this.jdField_b_of_type_AndroidContentContext);
      return;
      paramSurfaceHolder = String.valueOf(this.jdField_a_of_type_Agra.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.videoFileTime);
      break;
    }
  }
