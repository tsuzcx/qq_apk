  ...
  implements amhz
{
  ...
  {
    amia localamia = this.jdField_a_of_type_Amhl.a();
    if (localamia != null) {
      localamia.b(paramList);
    }
  }
  
  public void a()
  {
    Object localObject = this.jdField_a_of_type_Amhl.a();
    if (localObject != null)
    {
      localObject = ((amia)localObject).a();
      if (localObject != null) {
  ...
  public void a(amhl paramamhl)
  {
    ...
    paramamhl = this.jdField_a_of_type_Amhl.a();
    if (paramamhl != null) {
      paramamhl.a(this);
    }
  ...
  {
    amhy localamhy = this.jdField_a_of_type_Amhl.a();
    if (localamhy != null)
    {
      localamhy.a(paramList);
      localamhy.b(paramList);
    }
  }
