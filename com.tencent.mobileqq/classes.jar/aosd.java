...
public class aosd
{
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AddMessageHelper", 2, "-----addDatingSafetyGrayTipsMessage  frienduin:" + paramString1 + " istroop：" + paramInt + " msg:" + bhjx.a(paramString2));
    }
    long l = bcrg.a();
    MessageForGrayTips localMessageForGrayTips = (MessageForGrayTips)bcry.a(-1028);
    ...
    if (!aoci.a(paramQQAppInterface, localMessageForGrayTips)) {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("AddMessageHelper", 2, "-----addGrayTipsMessage  frienduin:" + paramString1 + " istroop：" + paramInt + " msg:" + bhjx.a(paramString2));
    }
    if ((paramBoolean1) && (adak.e(paramInt)) && (QLog.isColorLevel())) {
    ...
    for (int i = -5001;; i = -5000)
    {
      ...
      MessageForNewGrayTips localMessageForNewGrayTips = (MessageForNewGrayTips)bcry.a(i);
      ...
      if ((!paramBoolean2) || (!aoci.a(paramQQAppInterface, localMessageForNewGrayTips, false))) {
