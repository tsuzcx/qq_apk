  ...
  implements bcww
{
  ...
  protected bbjq a;
  protected bcqf a;
  bdvm jdField_a_of_type_Bdvm = new bauo(this);
  protected bfpc a;
  protected bfpm a;
  ...
  public baui(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData)
  {
    this(paramBaseActivity, paramTroopInfoData, null);
  }
  
  public baui(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, baur parambaur)
  {
    this.jdField_a_of_type_Int = -1;
    this.jdField_b_of_type_Int = -1;
    this.jdField_a_of_type_Akil = new baun(this);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData = paramTroopInfoData;
    if (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.addObserver(this.jdField_a_of_type_Bdvm);
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.addObserver(this.jdField_a_of_type_Akil);
    }
    WXShareHelper.a().a(this);
    this.jdField_a_of_type_Baur = parambaur;
  }
  ...
  public static Bitmap a(String paramString, Resources paramResources, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    Object localObject = wij.a(paramString, -1);
    ...
    catch (OutOfMemoryError paramString)
    {
      ...
      if (paramBoolean)
      {
        ...
        paramResources = baxi.a(paramResources, 2130839395);
  ...
  public static String a(String paramString, Context paramContext)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = paramContext.getString(2131719524);
    }
    return str;
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, int paramInt)
  {
    try
    {
      localAbsShareMsg = new axum(StructMsgForGeneralShare.class).c(132).a(paramBundle.getString("summary")).e(paramBundle.getString("targetUrl")).a(1105290942L).a();
      ...
      for (localAbsShareMsg.mSourceName = "NOW";; localAbsShareMsg.mSourceName = "")
      {
        ...
        ((axuq)localObject).a(paramBundle.getString("imageUrl"), paramBundle.getString("title"), str);
        localAbsShareMsg.addItem((axup)localObject);
        ...
        aqbe.a(paramActivity, paramBundle, paramInt);
        return;
  ...
  public static void a(Activity paramActivity, MessageForQQStory paramMessageForQQStory, int paramInt)
  {
    try
    {
      AbsShareMsg localAbsShareMsg = new axum(StructMsgForGeneralShare.class).c(80).a(paramMessageForQQStory.brief).e("").a();
      ...
      try
      {
        ...
        aqbe.a(paramActivity, (Intent)localObject, paramInt);
        if (QLog.isColorLevel())
        {
  ...
  public static List<bbjs>[] a(Context paramContext, boolean paramBoolean)
  {
    ...
    localArrayList.add(localObject);
    localObject = new bbjs();
    ((bbjs)localObject).jdField_a_of_type_JavaLangString = paramContext.getString(2131696699);
    ((bbjs)localObject).jdField_b_of_type_Int = 2130838752;
    ((bbjs)localObject).c = 10;
    ((bbjs)localObject).jdField_b_of_type_JavaLangString = "";
    localArrayList.add(localObject);
    localObject = new ArrayList();
    bbjs localbbjs = new bbjs();
    localbbjs.jdField_a_of_type_JavaLangString = paramContext.getString(2131696688);
    ...
    {
      localbbjs = new bbjs();
      localbbjs.jdField_a_of_type_JavaLangString = paramContext.getString(2131717202);
      localbbjs.jdField_b_of_type_Int = 2130841940;
      localbbjs.jdField_b_of_type_Boolean = true;
      localbbjs.c = 23;
      localbbjs.jdField_b_of_type_JavaLangString = "";
      ((ArrayList)localObject).add(localbbjs);
  ...
  public static void b(Activity paramActivity, Bundle paramBundle, int paramInt)
  {
    try
    {
      Object localObject = new axum(StructMsgForGeneralShare.class);
      if ("action_mqq".equals(paramBundle.getString("jump_action")))
      {
        localObject = ((axum)localObject).c(129).a(paramBundle.getString("summary")).a(1104763709L).a();
      ...
      for (;;)
      {
        ...
        String str = paramBundle.getString("summary");
        localaxuq.a(paramBundle.getString("imageUrl"), paramBundle.getString("title"), str);
        ...
        aqbe.a(paramActivity, paramBundle, paramInt);
        return;
        localObject = ((axum)localObject).c(129).a(paramBundle.getString("summary")).e(paramBundle.getString("targetUrl")).a(1104763709L).a();
        ((AbsShareMsg)localObject).mMsgBrief = paramBundle.getString("summary");
        ((AbsShareMsg)localObject).mContentSummary = paramBundle.getString("summary");
        ((AbsShareMsg)localObject).mContentTitle = paramBundle.getString("title");
        ((AbsShareMsg)localObject).mSourceAction = "";
  ...
  private void h()
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        axqy.b(localQQAppInterface, "CliOper", "", "", "Grp", (String)localObject, 0, 0, str, "", "", "");
        bool = bbfj.d(BaseApplication.getContext());
        ...
        if (this.jdField_a_of_type_Baur != null) {
          this.jdField_a_of_type_Baur.a(this.jdField_a_of_type_Int, false);
        }
        this.jdField_a_of_type_Int = -1;
        this.jdField_b_of_type_Int = -1;
    ...
    {
      ((bdvn)localQQAppInterface.a(85)).b(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
      return;
    }
    Object localObject = (akhp)localQQAppInterface.a(20);
    ...
    default: 
      return;
    case 0: 
      this.jdField_c_of_type_JavaLangString = bahv.a("", this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, 0);
      l();
      return;
    case 3: 
      i();
  ...
  private void i()
  {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject3)) {
        localObject1 = ajya.a(2131715797) + bbcz.e(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
      }
  ...
  private void j()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopName == null)
    {
      ...
      str1 = ajya.a(2131715793) + bbcz.e(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
    }
    label337:
    for (;;)
    {
  ...
  private void k()
  {
    ...
    if (bool)
    {
      ...
      localObject1 = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131719517), new Object[] { localObject2 }) + "(" + this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin + ")" + a();
      ...
      ((Bundle)localObject3).putString("desc", ajya.a(2131715796) + bbcz.e(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin));
    }
    for (;;)
    {
      ...
      bgzl.a(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (Bundle)localObject3, null, 145);
      if (QLog.isColorLevel()) {
      ...
      this.jdField_b_of_type_Int = -1;
      return;
      localObject1 = bahv.a("", this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, 0) + "100";
      break;
      label539:
  ...
  private void l()
  {
    ...
    for (localObject3 = (String)localObject1 + "(" + ((TroopInfo)localObject3).wMemberNum + ")";; localObject3 = localObject1)
    {
      ...
      AbsShareMsg localAbsShareMsg = new axum(StructMsgForGeneralShare.class).c(15).a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131718656) + (String)localObject3).a("web", a(), (String)localObject1, (String)localObject1, (String)localObject1).a();
      ...
      for (;;)
      {
        ...
        localaxyo.b(1);
        localaxyo.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131696484));
        axuq localaxuq = axuz.a(2);
        String str = this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.mRichFingerMemo;
        if (TextUtils.isEmpty(str))
        {
          localObject2 = ajya.a(2131715795) + bbcz.e(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
          label423:
          localaxuq.a((String)localObject1, (String)localObject3, (String)localObject2, 1);
          localAbsShareMsg.addItem(localaxyo);
        ...
        for (int i = 21;; i = 3)
        {
          aqbe.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (Intent)localObject2, i);
          if ((this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity instanceof TroopCreateLogicActivity)) {
  ...
  private void m()
  {
    ...
    str1 = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131693692), new Object[] { str1, a() });
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131691311), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
      if (this.jdField_a_of_type_Baur != null) {
        this.jdField_a_of_type_Baur.a(this.jdField_a_of_type_Int, true);
      }
      this.jdField_a_of_type_Int = -1;
      this.jdField_b_of_type_Int = -1;
      return;
  ...
  public void a()
  {
    try
    {
      if ((this.jdField_a_of_type_Bcqf == null) && (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null))
      {
  ...
  public void a(baus parambaus)
  {
    ThreadManager.post(new TroopShareUtility.10(this, parambaus), 8, null, false);
  }
  ...
  public void a(BaseResp paramBaseResp)
  {
    ...
    if (this.jdField_a_of_type_Baur != null)
    {
      localbaur = this.jdField_a_of_type_Baur;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      case -1: 
      default: 
        bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131719487), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
    }
    bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131719506), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
  }
  ...
  public void a(TroopInfoData paramTroopInfoData)
  {
    ...
    axqy.b((QQAppInterface)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppRuntime(), "CliOper", "", "", "Grp", "Clk_share_grplink", 0, 0, "", "", "", "");
    this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData = paramTroopInfoData;
    d();
  }
  ...
  protected void b(boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        str1 = "0";
        localaxrc = new axrc(null).a("P_CliOper").b("Grp_set").c("Grp_data").d((String)localObject);
    ...
    {
      localaxrc.a(new String[] { str2, localObject, str1 }).a();
      return;
  ...
  protected void d()
  {
    ...
    for (int i = 5;; i = 4)
    {
      ...
      while (j <= i)
      {
        ((List)localObject).add(bfpm.a(j));
        j += 1;
      }
    }
    if ((this.jdField_a_of_type_Bfpm == null) && (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null)) {
      this.jdField_a_of_type_Bfpm = new bfpm(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
    }
    if (this.jdField_a_of_type_Bfpm != null) {
      this.jdField_a_of_type_Bfpm.a((List)localObject);
    }
    if (this.jdField_a_of_type_Bfpc == null)
    {
      localObject = new bauj(this);
      if (this.jdField_a_of_type_Bbjq == null)
      {
        ...
        this.jdField_a_of_type_Bbjq.a(a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.isMember));
        this.jdField_a_of_type_Bbjq.a(new bauk(this));
        this.jdField_a_of_type_Bbjq.a((AdapterView.OnItemClickListener)localObject);
      }
    }
    try
    {
  ...
  protected void e()
  {
    this.jdField_b_of_type_Bfpc = ((bfpc)bfpp.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, null));
    this.jdField_b_of_type_Bfpc.b(2131720611);
    this.jdField_b_of_type_Bfpc.b(2131720612);
    this.jdField_b_of_type_Bfpc.c(2131690596);
    this.jdField_b_of_type_Bfpc.setOnDismissListener(new baul(this));
    this.jdField_b_of_type_Bfpc.a(new baum(this));
    String str;
    switch (this.jdField_a_of_type_Int)
    {
    default: 
      str = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131720609);
    }
    for (;;)
    {
      ...
      return;
      str = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131690791), new Object[] { this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131720610) });
      continue;
      str = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131690791), new Object[] { this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131720613) });
      continue;
      str = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131690791), new Object[] { this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131719513) });
      continue;
      str = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131690791), new Object[] { this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131719516) });
    }
  }
  
  public void f()
  {
    this.jdField_a_of_type_Baur = null;
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.removeObserver(this.jdField_a_of_type_Bdvm);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.removeObserver(this.jdField_a_of_type_Akil);
  ...
  public void g()
  {
    ...
    localIntent.putExtra("title", ajya.a(2131715792));
    int i;
