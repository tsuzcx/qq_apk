...
public class sco
{
  ...
  public static void a(ProteusItemData paramProteusItemData)
  {
    ...
    do
    {
      ...
      str3 = pxa.a().a("native_article", str1);
      if ((!TextUtils.isEmpty(str1)) && (!TextUtils.isEmpty(str2)) && (!TextUtils.isEmpty((CharSequence)localObject)) && (!TextUtils.isEmpty(str3)))
      {
        ...
        paramProteusItemData.a = new PTSItemData.Builder().withAppName(str1).withItemID(str2).withJsonData((String)localObject).withFrameTreeJson(str3).build();
      }
      if ((QLog.isDebugVersion()) || (QLog.isColorLevel())) {
        QLog.i("FastWebPtsLiteDataUtil", 2, "[processProteusItemData] finished, appName = " + str1 + ", itemId = " + str2 + ", jsonData = " + (String)localObject);
      }
