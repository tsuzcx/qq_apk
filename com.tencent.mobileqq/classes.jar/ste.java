...
public class ste
{
  ...
  public static ste a(List<ste> paramList, long paramLong)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (paramLong == localste.jdField_a_of_type_Long) {
        return localste;
      }
    }
    return null;
  ...
  public void a(@NonNull JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        this.jdField_a_of_type_ComTencentBizQqstoryModelItemStoryVideoItem = ((sqd)sqg.a(5)).a(this.jdField_a_of_type_JavaLangString);
      }
      return;
    }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      return true;
      if (!(paramObject instanceof ste)) {
        return false;
      }
      paramObject = (ste)paramObject;
