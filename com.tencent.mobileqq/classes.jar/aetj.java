...
{
  public aetj(NearbyProfileEditPanel paramNearbyProfileEditPanel) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (int i = ((cmd0xac5.MasterState)((cmd0xac5.NearbyNowData)this.a.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.nearbyNowData.get()).master_state.get()).uint32_state.get();; i = 0)
    {
      ...
      for (i = 1; (this.a.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null) && (bool3) && (i != 0); i = 0)
      {
        ...
        paramView.setPositiveButton("保存并重审", new aetk(this, paramView));
        paramView.setNegativeButton("取消", new aetl(this, paramView));
        paramView.show();
        return;
      }
      if ((this.a.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null) && (this.a.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.godFlag) && (bool1))
      {
        ...
        paramView.setPositiveButton("完成编辑", new aetm(this, paramView));
        paramView.setNegativeButton("放弃编辑", new aetn(this, paramView));
        paramView.show();
        return;
      }
      if ((bool1) && (bool2))
      {
        ...
        paramView.setPositiveButton("发布资料", new aeto(this, paramView));
        paramView.setNegativeButton("返回修改", new aetp(this, paramView));
        paramView.show();
