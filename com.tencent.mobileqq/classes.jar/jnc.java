...
{
  private jnc(AVServiceForQQ paramAVServiceForQQ) {}
  ...
  public void a(long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      ...
      new Handler(Looper.getMainLooper()).post(new jne(this, i));
    }
  }
  ...
  public void a(boolean paramBoolean, Notification paramNotification)
  {
    ...
    for (;;)
    {
      ...
      {
        this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().post(new jnd(this));
        return;
      }
    }
