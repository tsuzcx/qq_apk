...
public class bdxd
{
  ...
  public static bdxd a(bdxd parambdxd)
  {
    if (parambdxd == null)
    {
    ...
    localbdxd.jdField_a_of_type_JavaLangString = parambdxd.jdField_a_of_type_JavaLangString;
    localbdxd.jdField_a_of_type_Int = parambdxd.jdField_a_of_type_Int;
    localbdxd.jdField_b_of_type_JavaLangString = parambdxd.jdField_b_of_type_JavaLangString;
    localbdxd.jdField_c_of_type_JavaLangString = parambdxd.jdField_c_of_type_JavaLangString;
    ArrayList localArrayList = new ArrayList();
    if (parambdxd.jdField_a_of_type_JavaUtilArrayList != null) {
      localArrayList.addAll(parambdxd.jdField_a_of_type_JavaUtilArrayList);
    }
    localbdxd.jdField_a_of_type_JavaUtilArrayList = localArrayList;
    localArrayList = new ArrayList();
    if (parambdxd.jdField_b_of_type_JavaUtilArrayList != null) {
      localArrayList.addAll(parambdxd.jdField_b_of_type_JavaUtilArrayList);
    }
    localbdxd.jdField_b_of_type_JavaUtilArrayList = localArrayList;
    localArrayList = new ArrayList();
    if (parambdxd.jdField_c_of_type_JavaUtilArrayList != null) {
      localArrayList.addAll(parambdxd.jdField_c_of_type_JavaUtilArrayList);
    }
    localbdxd.jdField_c_of_type_JavaUtilArrayList = localArrayList;
    localbdxd.jdField_a_of_type_JavaLangObject = parambdxd.jdField_a_of_type_JavaLangObject;
    localbdxd.jdField_b_of_type_Int = parambdxd.jdField_b_of_type_Int;
    localbdxd.jdField_a_of_type_Boolean = parambdxd.jdField_a_of_type_Boolean;
    localbdxd.jdField_b_of_type_Boolean = parambdxd.jdField_b_of_type_Boolean;
    localbdxd.jdField_c_of_type_Boolean = parambdxd.jdField_c_of_type_Boolean;
    localbdxd.d = parambdxd.d;
    return localbdxd;
  }
