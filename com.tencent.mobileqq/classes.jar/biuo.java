...
public class biuo
{
  protected static biuo a;
  public static final String a;
  public int a;
  protected long a;
  public bium a;
  public volatile ArrayList<biup> a;
  protected Random a;
  public boolean a;
  protected volatile ArrayList<biup> b = new ArrayList();
  
  static
  {
    jdField_a_of_type_JavaLangString = biuo.class.getName();
  }
  ...
  public biuo()
  {
    ...
    this.jdField_a_of_type_Bium = new bium();
    this.jdField_a_of_type_JavaUtilRandom = new Random();
  }
  
  public static biuo a()
  {
    try
    {
      if (jdField_a_of_type_Biuo == null) {
        jdField_a_of_type_Biuo = new biuo();
      }
      biuo localbiuo = jdField_a_of_type_Biuo;
      return localbiuo;
    }
    finally {}
  }
  ...
  protected int a(int paramInt)
  {
    if (paramInt == 0)
    {
      i = biug.a(biip.a().a(), null).a("Common_CGIReportFrequencySuccess");
      bisy.c("OpenConfig_agent", "config 4:Common_CGIReportFrequencySuccess     config_value:" + i);
      paramInt = i;
      if (i == 0) {
        paramInt = 10;
      }
      bisy.c("OpenConfig_agent", "config 4:Common_CGIReportFrequencySuccess     result_value:" + paramInt);
      return paramInt;
    }
    int i = biug.a(biip.a().a(), null).a("Common_CGIReportFrequencyFailed");
    bisy.c("OpenConfig_agent", "config 4:Common_CGIReportFrequencyFailed     config_value:" + i);
    paramInt = i;
    if (i == 0) {
      paramInt = 100;
    }
    bisy.c("OpenConfig_agent", "config 4:Common_CGIReportFrequencyFailed     result_value:" + paramInt);
    return paramInt;
  }
  ...
  protected Bundle a(String paramString)
  {
    ...
    //   2: ldc 111
    //   4: ldc 113
    //   6: invokestatic 115	bisy:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   9: aload_0
    //   10: aload_0
    //   11: getfield 47	biuo:jdField_a_of_type_Bium	Lbium;
    //   14: aload_1
    //   15: invokevirtual 118	bium:a	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   18: putfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   21: aload_0
    //   22: getfield 47	biuo:jdField_a_of_type_Bium	Lbium;
    //   25: aload_1
    //   26: invokevirtual 121	bium:b	(Ljava/lang/String;)Z
    //   29: pop
    //   30: aload_0
    //   31: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   34: invokevirtual 125	java/util/ArrayList:size	()I
    //   37: ifgt +16 -> 53
    //   40: ldc 111
    //   42: ldc 127
    //   44: invokestatic 115	bisy:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   47: aconst_null
    //   48: astore_1
    //   49: aload_0
    //   50: monitorexit
    ...
    //   53: aload_0
    //   54: aload_0
    //   55: getfield 47	biuo:jdField_a_of_type_Bium	Lbium;
    //   58: aload_1
    //   59: invokevirtual 129	bium:b	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   62: putfield 42	biuo:b	Ljava/util/ArrayList;
    //   65: aload_0
    //   66: getfield 47	biuo:jdField_a_of_type_Bium	Lbium;
    //   69: aload_1
    //   70: invokevirtual 131	bium:a	(Ljava/lang/String;)Z
    //   73: pop
    ...
    //   91: aload 4
    //   93: ldc 141
    //   95: getstatic 144	biul:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   111: aload 4
    //   113: ldc 153
    //   115: getstatic 155	biul:b	Ljava/lang/String;
    ...
    //   132: iload_2
    //   133: aload_0
    //   134: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   164: aload_0
    //   165: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   168: iload_2
    //   169: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   172: checkcast 167	biup
    //   175: getfield 168	biup:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   202: aload_0
    //   203: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   206: iload_2
    //   207: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   210: checkcast 167	biup
    //   213: getfield 171	biup:b	Ljava/lang/String;
    ...
    //   240: aload_0
    //   241: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   244: iload_2
    //   245: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   248: checkcast 167	biup
    //   251: getfield 175	biup:c	Ljava/lang/String;
    ...
    //   278: aload_0
    //   279: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   282: iload_2
    //   283: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   286: checkcast 167	biup
    //   289: getfield 180	biup:d	Ljava/lang/String;
    ...
    //   316: aload_0
    //   317: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   320: iload_2
    //   321: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   324: checkcast 167	biup
    //   327: getfield 185	biup:e	Ljava/lang/String;
    ...
    //   354: aload_0
    //   355: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   358: iload_2
    //   359: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   362: checkcast 167	biup
    //   365: getfield 190	biup:f	Ljava/lang/String;
    ...
    //   392: aload_0
    //   393: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   396: iload_2
    //   397: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   400: checkcast 167	biup
    //   403: getfield 195	biup:g	Ljava/lang/String;
    ...
    //   430: aload_0
    //   431: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   434: iload_2
    //   435: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   438: checkcast 167	biup
    //   441: getfield 200	biup:j	Ljava/lang/String;
    ...
    //   468: aload_0
    //   469: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   472: iload_2
    //   473: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   476: checkcast 167	biup
    //   479: getfield 205	biup:h	Ljava/lang/String;
    ...
    //   492: invokestatic 209	biuf:h	()Ljava/lang/String;
    ...
    //   503: aload_0
    //   504: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   507: iload_2
    //   508: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   511: checkcast 167	biup
    //   514: getfield 214	biup:i	Ljava/lang/String;
    ...
    //   553: goto -421 -> 132
    //   556: aload_0
    //   557: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   560: invokevirtual 125	java/util/ArrayList:size	()I
    //   563: istore_2
    //   564: iload_2
    //   565: aload_0
    //   566: getfield 42	biuo:b	Ljava/util/ArrayList;
    //   569: invokevirtual 125	java/util/ArrayList:size	()I
    //   572: aload_0
    //   573: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   576: invokevirtual 125	java/util/ArrayList:size	()I
    //   579: iadd
    //   580: if_icmpge +441 -> 1021
    //   583: iload_2
    //   584: aload_0
    //   585: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   614: aload_0
    //   615: getfield 42	biuo:b	Ljava/util/ArrayList;
    //   618: iload_3
    //   619: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   622: checkcast 167	biup
    //   625: getfield 168	biup:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   652: aload_0
    //   653: getfield 42	biuo:b	Ljava/util/ArrayList;
    //   656: iload_3
    //   657: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   660: checkcast 167	biup
    //   663: getfield 171	biup:b	Ljava/lang/String;
    ...
    //   690: aload_0
    //   691: getfield 42	biuo:b	Ljava/util/ArrayList;
    //   694: iload_3
    //   695: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   698: checkcast 167	biup
    //   701: getfield 175	biup:c	Ljava/lang/String;
    ...
    //   728: aload_0
    //   729: getfield 42	biuo:b	Ljava/util/ArrayList;
    //   732: iload_3
    //   733: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   736: checkcast 167	biup
    //   739: getfield 180	biup:d	Ljava/lang/String;
    ...
    //   766: aload_0
    //   767: getfield 42	biuo:b	Ljava/util/ArrayList;
    //   770: iload_3
    //   771: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   774: checkcast 167	biup
    //   777: getfield 185	biup:e	Ljava/lang/String;
    ...
    //   804: aload_0
    //   805: getfield 42	biuo:b	Ljava/util/ArrayList;
    //   808: iload_3
    //   809: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   812: checkcast 167	biup
    //   815: getfield 190	biup:f	Ljava/lang/String;
    ...
    //   842: aload_0
    //   843: getfield 42	biuo:b	Ljava/util/ArrayList;
    //   846: iload_3
    //   847: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   850: checkcast 167	biup
    //   853: getfield 195	biup:g	Ljava/lang/String;
    ...
    //   880: aload_0
    //   881: getfield 42	biuo:b	Ljava/util/ArrayList;
    //   884: iload_3
    //   885: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   888: checkcast 167	biup
    //   891: getfield 200	biup:j	Ljava/lang/String;
    ...
    //   918: aload_0
    //   919: getfield 42	biuo:b	Ljava/util/ArrayList;
    //   922: iload_3
    //   923: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   926: checkcast 167	biup
    //   929: getfield 205	biup:h	Ljava/lang/String;
    ...
    //   942: invokestatic 209	biuf:h	()Ljava/lang/String;
    ...
    //   953: aload_0
    //   954: getfield 40	biuo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   957: iload_3
    //   958: invokevirtual 165	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   961: checkcast 167	biup
    //   964: getfield 214	biup:i	Ljava/lang/String;
    ...
    //   1003: goto -439 -> 564
    //   1006: astore_1
    //   1007: getstatic 25	biuo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   1010: ldc 218
    //   1012: aload_1
    //   1013: invokestatic 221	bisy:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   1016: aconst_null
    //   1017: astore_1
    //   1018: goto -969 -> 49
    //   1021: ldc 111
    //   1023: ldc 223
    //   1025: invokestatic 115	bisy:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   1028: aload 4
    //   1030: astore_1
    //   1031: goto -982 -> 49
    //   1034: astore_1
  ...
  {
    bisy.b("cgi_report_debug", "ReportManager doUpload start");
  ...
  protected boolean a()
  {
    long l2 = biug.a(biip.a().a(), null).a("Common_CGIReportTimeinterval");
    bisy.c("OpenConfig_agent", "config 5:Common_CGIReportTimeinterval     config_value:" + l2);
    long l1 = l2;
    if (l2 == 0L) {
      l1 = 1200L;
    }
    bisy.c("OpenConfig_agent", "config 5:Common_CGIReportTimeinterval     result_value:" + l1);
    l2 = System.currentTimeMillis() / 1000L;
    if ((this.jdField_a_of_type_Long == 0L) || (l1 + this.jdField_a_of_type_Long <= l2))
    {
      this.jdField_a_of_type_Long = l2;
      bisy.b("cgi_report_debug", "ReportManager availableForTime = ture");
      return true;
    }
    bisy.b("cgi_report_debug", "ReportManager availableForTime = false");
    return false;
  }
  ...
  protected boolean a(int paramInt)
  {
    ...
    {
      bisy.b("cgi_report_debug", "ReportManager availableForFrequency = ture");
      return true;
    }
    bisy.b("cgi_report_debug", "ReportManager availableForFrequency = false");
    return false;
  }
  
  protected boolean a(String paramString)
  {
    int j = biug.a(biip.a().a(), null).a("Common_CGIReportMaxcount");
    bisy.c("OpenConfig_agent", "config 6:Common_CGIReportMaxcount     config_value:" + j);
    int i = j;
    if (j == 0) {
      i = 20;
    }
    bisy.c("OpenConfig_agent", "config 6:Common_CGIReportMaxcount     result_value:" + i);
    if (this.jdField_a_of_type_Bium.a(paramString) >= i)
    {
      bisy.b("cgi_report_debug", "ReportManager availableForCount = ture");
      return true;
    }
    bisy.b("cgi_report_debug", "ReportManager availableForCount = false");
    return false;
  }
  ...
  protected void b(String paramString1, long paramLong1, long paramLong2, long paramLong3, int paramInt, long paramLong4, String paramString2, String paramString3)
  {
    ...
    bisy.b("cgi_report_debug", "ReportManager updateDB url=" + paramString1 + ",resultCode=" + paramInt + ",timeCost=" + paramLong1 + ",reqSize=" + paramLong2 + ",rspSize=" + paramLong3);
    ...
    {
      String str = a();
      this.jdField_a_of_type_Bium.a(str, i + "", paramString1, paramInt + "", paramLong1 + "", paramLong2 + "", paramLong3 + "", paramLong4 + "", paramString3, paramString2);
      return;
      if (i > 100) {
        i = 100;
      }
