...
public class biuo
{
  ...
  public biuo(biup parambiup, ClassLoader paramClassLoader)
  {
    this.jdField_a_of_type_JavaLangClassLoader = paramClassLoader;
    this.jdField_a_of_type_ComTencentMobileqqWerewolvesWerewolvesHostInterface = new WerewolvesHostInterface(parambiup);
    a(parambiup.a.a);
  }
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaLangClass = bitx.a(this.jdField_a_of_type_JavaLangClassLoader, "com.tencent.mobileqq.werewolves.PluginRuntime");
    this.jdField_b_of_type_JavaLangClass = bitx.a(this.jdField_a_of_type_JavaLangClassLoader, "com.tencent.mobileqq.werewolves.PluginInterface");
    try
    {
      if (this.jdField_a_of_type_JavaLangObject == null) {
        this.jdField_a_of_type_JavaLangObject = bitx.a(this.jdField_a_of_type_JavaLangClass, "getRuntime", null).invoke(null, null);
      }
      bitx.a(this.jdField_a_of_type_JavaLangClass, "initFromHost", new Class[] { Object.class, Context.class }).invoke(this.jdField_a_of_type_JavaLangObject, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWerewolvesWerewolvesHostInterface, paramContext });
      this.jdField_b_of_type_JavaLangObject = bitx.a(this.jdField_a_of_type_JavaLangClass, "getPlulginInterface", null).invoke(this.jdField_a_of_type_JavaLangObject, null);
    }
    ...
    {
      this.jdField_a_of_type_JavaLangReflectMethod = bitx.a(this.jdField_b_of_type_JavaLangClass, "onReceive", new Class[] { Integer.TYPE, String.class, [B.class });
      this.c = bitx.a(this.jdField_b_of_type_JavaLangClass, "attachGameUI", new Class[] { ViewGroup.class, Context.class });
      this.d = bitx.a(this.jdField_b_of_type_JavaLangClass, "onDestroy", new Class[0]);
      this.f = bitx.a(this.jdField_b_of_type_JavaLangClass, "isReady", new Class[0]);
      this.g = bitx.a(this.jdField_b_of_type_JavaLangClass, "isPlaying", new Class[0]);
      this.h = bitx.a(this.jdField_b_of_type_JavaLangClass, "isDead", new Class[0]);
      this.i = bitx.a(this.jdField_b_of_type_JavaLangClass, "canSpeak", new Class[0]);
      this.j = bitx.a(this.jdField_b_of_type_JavaLangClass, "onFaceDownloaded", new Class[] { String.class, Bitmap.class });
      this.o = bitx.a(this.jdField_b_of_type_JavaLangClass, "getQuickWords", new Class[0]);
      this.m = bitx.a(this.jdField_b_of_type_JavaLangClass, "stopGame", new Class[0]);
      this.k = bitx.a(this.jdField_b_of_type_JavaLangClass, "startGame", new Class[] { Integer.TYPE });
      this.l = bitx.a(this.jdField_b_of_type_JavaLangClass, "startGameWithType", new Class[] { Integer.TYPE });
      this.n = bitx.a(this.jdField_b_of_type_JavaLangClass, "getRoomNick", new Class[] { String.class });
      this.p = bitx.a(this.jdField_b_of_type_JavaLangClass, "onUserSpeakingStateChanged", new Class[] { String.class, Boolean.TYPE });
      this.q = bitx.a(this.jdField_b_of_type_JavaLangClass, "getAIOColors", new Class[0]);
      this.r = bitx.a(this.jdField_b_of_type_JavaLangClass, "getAIODrawables", new Class[] { Context.class });
      this.e = bitx.a(this.jdField_b_of_type_JavaLangClass, "dettachGameUI", new Class[0]);
      this.s = bitx.a(this.jdField_b_of_type_JavaLangClass, "onUserLeftAIO", new Class[0]);
      this.t = bitx.a(this.jdField_b_of_type_JavaLangClass, "onUserEnterAIO", new Class[0]);
      this.u = bitx.a(this.jdField_b_of_type_JavaLangClass, "onSpeakBtnPressed", new Class[] { Boolean.TYPE });
      this.v = bitx.a(this.jdField_b_of_type_JavaLangClass, "startGameForGold", new Class[0]);
      this.x = bitx.a(this.jdField_b_of_type_JavaLangClass, "getCurZoneId", new Class[0]);
      this.w = bitx.a(this.jdField_b_of_type_JavaLangClass, "getCurRoomNumber", new Class[0]);
      this.jdField_b_of_type_JavaLangReflectMethod = bitx.a(this.jdField_b_of_type_JavaLangClass, "notify", new Class[] { Integer.TYPE, Object.class });
      this.y = bitx.a(this.jdField_b_of_type_JavaLangClass, "onPhoneStateChange", new Class[] { Integer.TYPE });
      this.jdField_a_of_type_Boolean = true;
    }
  }
  
  public void a(ViewGroup paramViewGroup, abdi paramabdi)
  {
    try
    {
      this.c.invoke(this.jdField_b_of_type_JavaLangObject, new Object[] { paramViewGroup, paramabdi });
      return;
    }
