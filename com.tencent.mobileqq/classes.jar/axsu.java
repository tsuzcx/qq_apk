  ...
  extends ImageSpan
{
  ...
  public axsu(Context paramContext, int paramInt1, String paramString, int paramInt2, Drawable.Callback paramCallback)
  {
  ...
  public axsu(Context paramContext, int paramInt, String paramString, Drawable.Callback paramCallback)
  {
      ...
      for (;;)
      {
        try
        {
          ...
          if (this.jdField_a_of_type_MqqUtilWeakReference != null)
          {
            ...
            this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new axsv(this));
            if (QLog.isColorLevel())
            {
