  ...
  implements HookMethodCallback
{
  ...
  public axsu(axsp paramaxsp, String paramString)
  {
  ...
  public void a(String paramString, Object[] paramArrayOfObject)
  {
    ...
    {
      return;
      str3 = axsp.a().toString();
      if (QLog.isColorLevel()) {
        axsp.a(this.jdField_b_of_type_Axsp, "onGPSScan: " + str3);
      }
    ...
    if ("requestLocationUpdates".equals(paramString)) {
      if (paramArrayOfObject.length == 5) {
        if ((paramArrayOfObject[2] instanceof Criteria))
        {
          ...
          axsk.a().a(paramString);
        }
      }
    }
    for (;;)
    {
      paramString = this.jdField_a_of_type_Axte.a(str3);
      if ((paramString != null) && (paramString.size() > 0))
      {
        axsp.a(this.jdField_b_of_type_Axsp, 6, 0, 0, "GPS request update is too frequently(" + this.jdField_a_of_type_Int + " in " + this.jdField_a_of_type_Long / 60L / 1000L + " seconds", axte.a(paramString));
        this.jdField_a_of_type_Axte.a();
      }
      paramString = this.jdField_b_of_type_Axte.a(str3);
      if ((paramString == null) || (paramString.size() <= 0)) {
        break;
      }
      axsp.a(this.jdField_b_of_type_Axsp, 6, 0, 0, "Wifi scan is too frequently(" + this.jdField_b_of_type_Int + " in " + this.jdField_b_of_type_Long / 60L / 1000L + " seconds", axte.a(paramString));
      this.jdField_b_of_type_Axte.a();
      return;
      if ((paramArrayOfObject[0] instanceof String))
      {
        axsp.a(this.jdField_b_of_type_Axsp, new String[] { str4, "0", "|", "1", "|", "{", paramArrayOfObject[0].toString(), "#", paramArrayOfObject[1].toString(), "#", paramArrayOfObject[2].toString(), "}", "|", str3 });
        break label321;
      }
      axsp.a(this.jdField_b_of_type_Axsp, new String[] { str4, "0", "|", "-1", "|", "{}", "|", str3 });
      break label321;
      ...
      if ((paramArrayOfObject[2] instanceof Criteria))
      {
        axsp.a(this.jdField_b_of_type_Axsp, new String[] { str4, "0", "|", "2", "|", "{", paramArrayOfObject[0].toString(), "#", paramArrayOfObject[1].toString(), "#", "[", this.jdField_a_of_type_AndroidLocationLocationManager.getBestProvider((Criteria)paramArrayOfObject[2], true), ",", String.valueOf(((Criteria)paramArrayOfObject[2]).getAccuracy()), ",", String.valueOf(((Criteria)paramArrayOfObject[2]).getPowerRequirement()), "]", "}", "|", str3 });
        break label321;
      }
      if ((paramArrayOfObject[0] instanceof String))
      {
        axsp.a(this.jdField_b_of_type_Axsp, new String[] { str4, "0", "|", "3", "|", "{", paramArrayOfObject[0].toString(), "#", paramArrayOfObject[1].toString(), "#", paramArrayOfObject[2].toString(), "}", "|", str3 });
        break label321;
      }
      axsp.a(this.jdField_b_of_type_Axsp, new String[] { str4, "0", "|", "-1", "|", "{}", "|", str3 });
      break label321;
      ...
      {
        if ((paramArrayOfObject[0] instanceof String)) {
          axsp.a(this.jdField_b_of_type_Axsp, new String[] { str4, "1", "|", "0", "|", "{", paramArrayOfObject[0].toString(), "}", "|", str3 });
        }
        for (;;)
        {
          paramString = new Bundle();
          ...
          if ((paramArrayOfObject[0] instanceof Criteria)) {
            axsp.a(this.jdField_b_of_type_Axsp, new String[] { str4, "1", "|", "1", "|", "{", "[", this.jdField_a_of_type_AndroidLocationLocationManager.getBestProvider((Criteria)paramArrayOfObject[0], true), ",", String.valueOf(((Criteria)paramArrayOfObject[0]).getAccuracy()), ",", String.valueOf(((Criteria)paramArrayOfObject[0]).getPowerRequirement()), "]", "}", "|", str3 });
          } else {
            axsp.a(this.jdField_b_of_type_Axsp, new String[] { str4, "1", "|", "-1", "|", "{}", "|", str3 });
          }
        }
        label1437:
        a(paramString);
      ...
      else if ("requestSoso".equals(paramString))
      {
        ...
        {
          paramString = "none";
          localaxsp = this.jdField_b_of_type_Axsp;
        ...
        {
          axsp.a(localaxsp, new String[] { str4, "2", "|", "0", "|", "{", str5, "#", str6, "#", paramString, "#", str1, "#", str2, "#", paramArrayOfObject[5].toString(), "}", "|", str3 });
  ...
  {
    super.e();
    if ((this.jdField_a_of_type_Boolean) && (axsp.a())) {}
    label518:
    for (;;)
    {
      String str;
      ...
      synchronized (this.jdField_a_of_type_JavaUtilMap)
      {
        ...
        axsp.b(this.jdField_b_of_type_Axsp, new String[] { "fg30SdkCount", "|", String.valueOf(i) });
        if (axsp.b(this.jdField_b_of_type_Axsp)) {
          axsp.b(this.jdField_b_of_type_Axsp, new String[] { "fg30SysCount", "|", String.valueOf(j) });
        }
        ...
        if (localIterator1.hasNext())
        {
          ...
          axsp.b(this.jdField_b_of_type_Axsp, new String[] { "fg30SdkDetail", "|", str, "|", ((StringBuilder)localObject3).toString() });
        }
      }
      ...
      while (localIterator2.hasNext())
      {
        ...
        axsp.b(this.jdField_b_of_type_Axsp, new String[] { "fg30SysDetail", "|", str, "|", ((StringBuilder)localObject2).toString() });
      }
  ...
  public void f()
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilMap)
      {
        ...
        axsp.b(this.jdField_b_of_type_Axsp, new String[] { "bg5SdkCount", "|", String.valueOf(i) });
        if (axsp.b(this.jdField_b_of_type_Axsp)) {
          axsp.b(this.jdField_b_of_type_Axsp, new String[] { "bg5SysCount", "|", String.valueOf(j) });
        }
        ...
        if (localIterator1.hasNext())
        {
          ...
          axsp.b(this.jdField_b_of_type_Axsp, new String[] { "bg5SdkDetail", "|", str, "|", ((StringBuilder)localObject3).toString() });
        }
      }
      ...
      while (localIterator2.hasNext())
      {
        ...
        axsp.b(this.jdField_b_of_type_Axsp, new String[] { "bg5SysDetail", "|", str, "|", ((StringBuilder)localObject2).toString() });
      }
      this.jdField_c_of_type_JavaUtilMap.clear();
      this.jdField_d_of_type_JavaUtilMap.clear();
      return;
