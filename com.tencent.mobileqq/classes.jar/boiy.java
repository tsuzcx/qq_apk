  ...
  implements afpx
{
  ...
  public int a()
  {
    int i = -1;
    if (a()) {
      i = this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioPlayer.c();
    }
    return i;
  }
  ...
  protected void a(int paramInt, MusicItemInfo paramMusicItemInfo)
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (paramMusicItemInfo.hasNext()) {
        ((boiz)paramMusicItemInfo.next()).a(paramInt, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo);
      }
    }
  }
  ...
  public void a(List<boiz> paramList)
  {
  ...
  protected void b(int paramInt, MusicItemInfo paramMusicItemInfo)
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      paramMusicItemInfo = this.jdField_a_of_type_JavaUtilList.iterator();
      while (paramMusicItemInfo.hasNext()) {
        ((boiz)paramMusicItemInfo.next()).c(paramInt, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo);
      }
    }
  }
  ...
  protected void b(MusicItemInfo paramMusicItemInfo)
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      paramMusicItemInfo = this.jdField_a_of_type_JavaUtilList.iterator();
      while (paramMusicItemInfo.hasNext()) {
        ((boiz)paramMusicItemInfo.next()).b(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo);
      }
    }
  }
  ...
  protected void c(int paramInt, MusicItemInfo paramMusicItemInfo)
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      paramMusicItemInfo = this.jdField_a_of_type_JavaUtilList.iterator();
      while (paramMusicItemInfo.hasNext()) {
        ((boiz)paramMusicItemInfo.next()).d(paramInt, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo);
      }
    }
  }
  ...
  protected void d(int paramInt, MusicItemInfo paramMusicItemInfo)
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      paramMusicItemInfo = this.jdField_a_of_type_JavaUtilList.iterator();
      while (paramMusicItemInfo.hasNext()) {
        ((boiz)paramMusicItemInfo.next()).b(paramInt, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo);
      }
    }
  }
