  ...
  extends pqj
{
  ...
  public poz(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qfo paramqfo, Handler paramHandler)
  {
  ...
  protected ToServiceMsg a(qfu paramqfu)
  {
    ...
    if (paramqfu.jdField_a_of_type_Boolean) {
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_all_channel_list.set(1);
    }
    if (paramqfu.jdField_b_of_type_Boolean) {
    ...
    for (;;)
    {
      ...
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_important.set(paramqfu.jdField_b_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_id.set(paramqfu.jdField_c_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_cover.set(paramqfu.jdField_d_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_seq.set(paramqfu.jdField_e_of_type_Int);
      localObject = qfq.a("OidbSvc.0x69f", 1695, 0, ((oidb_cmd0x69f.ReqBody)localObject).toByteArray());
      ((ToServiceMsg)localObject).getAttributes().put(c, Integer.valueOf(paramqfu.jdField_a_of_type_Int));
      ((ToServiceMsg)localObject).getAttributes().put("debug", Boolean.valueOf(paramqfu.l));
      return localObject;
  ...
  public void a(int paramInt1, int paramInt2, List<Integer> paramList, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    ((oidb_cmd0x908.ReqBody)localObject).uint64_uin.set(Long.valueOf(ozs.a()).longValue());
    ...
    for (;;)
    {
      ...
      localObject = qfq.a("OidbSvc.0x908", 2312, 0, ((oidb_cmd0x908.ReqBody)localObject).toByteArray());
  ...
  public void a(boolean paramBoolean, int paramInt, List<Integer> paramList)
  {
    ...
    localReqBody.uint64_uin.set(Long.valueOf(ozs.a()).longValue());
    if (paramBoolean)
    {
      ...
      a(qfq.a("OidbSvc.0x8f5", 2293, 0, localReqBody.toByteArray()));
      if (QLog.isColorLevel()) {
        if (paramList != null) {
          break label151;
        }
  ...
  public void b(List<Integer> paramList)
  {
    ...
    localObject = qfq.a("OidbSvc.0x69e", 1694, 0, ((oidb_cmd0x69e.ReqBody)localObject).toByteArray());
  ...
  {
    Object localObject = new qfu();
    ((qfu)localObject).jdField_a_of_type_Int = 4;
    ((qfu)localObject).jdField_a_of_type_Boolean = true;
    ((qfu)localObject).jdField_b_of_type_Boolean = true;
    ((qfu)localObject).jdField_c_of_type_Boolean = false;
    ((qfu)localObject).jdField_d_of_type_Boolean = true;
    ((qfu)localObject).j = true;
    ((qfu)localObject).k = true;
    ((qfu)localObject).jdField_e_of_type_Boolean = false;
    ((qfu)localObject).f = false;
    ((qfu)localObject).g = false;
    ((qfu)localObject).h = false;
    ((qfu)localObject).jdField_b_of_type_Int = 1;
    ((qfu)localObject).l = paramBoolean;
    localObject = a((qfu)localObject);
  ...
  protected void c(List<qvr> paramList)
  {
    if (paramList == null) {
      return;
    }
    ...
    while (paramList.hasNext())
    {
      Iterator localIterator = ((qvr)paramList.next()).a.iterator();
  ...
  protected void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0) {
      if (i == 1)
      {
        ...
        {
          paramObject = qfn.a(localRspBody.rpt_channel_list.get());
  ...
  public List<ChannelInfo> e()
  {
    ...
    Collections.sort((List)localObject1, new ppa(this));
  ...
  {
    if (qfq.a(paramFromServiceMsg, paramObject, new oidb_cmd0x69e.RspBody()) == 0) {}
  ...
  public List<Integer> g()
  {
    ...
    Collections.sort((List)localObject1, new ppb(this));
    localObject2 = new ArrayList(((ArrayList)localObject1).size());
    localObject1 = ((ArrayList)localObject1).iterator();
    while (((Iterator)localObject1).hasNext()) {
  ...
  {
    int i = qfq.a(paramFromServiceMsg, paramObject, new oidb_cmd0x8f5.RspBody());
    if (QLog.isColorLevel()) {
  ...
  public void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = qfq.a(paramFromServiceMsg, paramObject, (MessageMicro)localObject);
    boolean bool1;
    if (k == 0)
    {
