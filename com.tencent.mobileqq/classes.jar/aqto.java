...
public class aqto
  extends birb
{
  private aqto(CountrySelectActivity paramCountrySelectActivity) {}
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    if ((localObject instanceof aqtp)) {
      paramView.setText(((aqtp)localObject).jdField_a_of_type_JavaLangString);
    }
  ...
  {
    if ((this.a.jdField_a_of_type_JavaUtilList.get(paramInt) instanceof aqtp)) {
      return 0;
    }
    return 1;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ((TextView)paramView).setText(((aqtp)getItem(paramInt)).jdField_a_of_type_JavaLangString);
      for (;;)
      {
        ...
        if (paramView == null)
        {
          ...
          paramView = new aqtq(null);
          paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131365269));
          paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131364606));
          localView.findViewById(2131365268).setVisibility(8);
          localView.setTag(paramView);
          localView.setOnClickListener(this.a);
        }
        paramView = (aqtq)localView.getTag();
        ...
        for (;;)
        {
          ...
          localView.setContentDescription(localBaseAddress.name + anvx.a(2131702100));
          paramView = localView;
          break;
