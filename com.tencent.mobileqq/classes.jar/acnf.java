...
public class acnf
  extends akil
{
  public acnf(TroopTransferActivity paramTroopTransferActivity) {}
  ...
  {
    if ((!bbbr.a(String.valueOf(paramLong), this.a.jdField_a_of_type_JavaLangString)) || (!bbbr.a(paramString1, this.a.app.getCurrentAccountUin()))) {
      return;
    }
    ...
    if (paramBoolean)
    {
      ...
      paramString1.putExtra("fin_tip_msg", this.a.getString(2131720455));
    ...
    if ((paramInt == 1) || (paramInt == 2) || (paramInt == 6) || (paramInt == 8) || (paramInt == 9) || (paramInt == 10) || (paramInt == 11)) {
      paramString1 = this.a.getString(2131720441);
    }
    for (;;)
    {
      if (this.a.jdField_a_of_type_Bcqi == null) {
      ...
      this.a.jdField_a_of_type_Bcqi.a(2, paramString1, 1500);
      return;
      if ((paramInt == 3) || (paramInt == 4) || (paramInt == 7) || (paramInt == 16) || (paramInt == 19))
      {
        paramString1 = this.a.getString(2131720443);
      }
      else if ((paramInt == 5) || (paramInt == 17) || (paramInt == 18))
      {
        paramString1 = this.a.getString(2131720442);
      }
      else
      {
        if (paramInt == 12)
        {
          ...
          paramString1 = bbdj.a(this.a, 230);
          paramString1.setTitle(this.a.getString(2131696516));
          paramString1.setMessage(this.a.getString(2131696517));
          paramString1.setNegativeButton(this.a.getString(2131696462), new acng(this, paramString1));
          paramString1.setPositiveButton(this.a.getString(2131719551), new acnh(this, paramString1));
          paramString1.show();
          return;
        }
        paramString1 = this.a.getString(2131720442);
