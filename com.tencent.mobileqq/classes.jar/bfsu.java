...
public class bfsu
{
  ...
  public static int a;
  private static bfsz jdField_a_of_type_Bfsz;
  ...
  private static final String c = amtj.a(2131713739);
  
  static
  {
    jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(false);
    jdField_a_of_type_Bfsz = new bfsz();
  ...
  public static String a(Context paramContext, Uri paramUri, String paramString1, String paramString2)
  {
    ...
    //   28: aload_2
    //   29: aload_3
    //   30: invokestatic 149	bfsu:a	(Landroid/content/Context;Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
  ...
  public static void a(Context paramContext, bfsx parambfsx, afce paramafce)
  {
    jdField_a_of_type_Bfsz.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    jdField_a_of_type_Bfsz.jdField_a_of_type_Afce = paramafce;
    parambfsx.a(paramafce);
    parambfsx.a(new bfsw());
  }
  ...
  {
    if ((paramSessionInfo.curType != 1) && (paramSessionInfo.curType != 3000) && (paramSessionInfo.curType != 0) && (!abwz.e(paramSessionInfo.curType)))
    {
    ...
    paramViewGroup.setOnDragListener(new bfsv(localImageView, localColorDrawable1, paramViewGroup, localColorDrawable2, paramContext, paramQQAppInterface, paramSessionInfo));
  }
  ...
  private static bfsy b(Context paramContext, aezf paramaezf)
  {
    long l = 0L;
    Object localObject1;
    if ((paramaezf instanceof aglf))
    {
      localObject1 = ataw.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramaezf.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
      l = FileUtils.getFileSizes((String)localObject1);
      paramaezf = paramaezf.jdField_a_of_type_AndroidViewView;
    }
    for (;;)
    {
      label76:
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1))
      {
        ...
        if ((paramaezf instanceof aglh))
        {
          localObject1 = ataw.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramaezf.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
          l = FileUtils.getFileSizes((String)localObject1);
          paramaezf = ((aglh)paramaezf).a;
          continue;
        }
        if ((paramaezf instanceof afxv))
        {
          localObject2 = (MessageForPic)paramaezf.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject3 = ((MessageForPic)localObject2).getBiggestFilePath();
          String str = aszt.a((String)localObject3);
          int i = bkkh.a((String)localObject3);
          localObject1 = ".jpg";
          if (i == 1001) {
            localObject1 = ".png";
          }
          for (;;)
          {
            ...
            if ((!FileUtils.copyFile(((MessageForPic)localObject2).getBiggestFilePath(), (String)localObject1)) || (TextUtils.isEmpty(str))) {
              break label76;
            }
            l = ((MessageForPic)localObject2).size;
            paramaezf = ((afxv)paramaezf).a;
            break;
            if (i == 1005) {
              localObject1 = ".bmp";
            } else if (i == 2000) {
        ...
        if ((paramaezf instanceof agnu))
        {
          localObject2 = (MessageForShortVideo)paramaezf.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          ...
          paramaezf = ((agnu)paramaezf).a;
          continue;
        }
        if ((paramaezf instanceof agok))
        {
          localObject2 = (MessageForShortVideo)paramaezf.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject1 = ShortVideoUtils.getShortVideoSavePath((MessageForShortVideo)localObject2, "mp4");
          l = ((MessageForShortVideo)localObject2).videoFileSize;
          paramaezf = ((agok)paramaezf).a;
        }
      }
      else
      {
        ...
        return new bfsy((File)localObject2, paramaezf, ClipData.newUri(paramContext.getContentResolver(), "uri", (Uri)localObject1));
      }
      paramaezf = null;
      localObject1 = null;
    }
  ...
  private static boolean b(DragEvent paramDragEvent, ImageView paramImageView, ColorDrawable paramColorDrawable1, ViewGroup paramViewGroup, ColorDrawable paramColorDrawable2, Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    paramImageView = new ReportProgressDialog(paramContext, 2131755826);
    paramImageView.setCancelable(true);
    paramImageView.setContentView(2131559574);
    ((TextView)paramImageView.findViewById(2131372546)).setText(amtj.a(2131713738));
