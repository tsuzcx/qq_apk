...
class bfsu
  extends niu
{
  bfsu(bfst parambfst, bfss parambfss) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if ((paramInt != 0) || (paramArrayOfByte == null) || (this.jdField_a_of_type_Bfss == null))
    {
      if (QLog.isColorLevel()) {
        QLog.i(".troop.send_gift", 2, "send_oidb_0x6b6. onResult error=" + paramInt + " data=" + paramArrayOfByte + " callback=" + this.jdField_a_of_type_Bfss);
      }
    ...
    try
    {
      ...
      if (localRspBody.msg_send_flower.has())
      {
        ...
        this.jdField_a_of_type_Bfss.a(paramArrayOfByte.uint32_product_id.get());
        return;
      }
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    ...
    if (localRspBody.msg_throw_flower.has())
    {
      ...
      this.jdField_a_of_type_Bfss.b(paramArrayOfByte.uint32_product_id.get());
      return;
    }
