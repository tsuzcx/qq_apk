  ...
  extends BaseAdapter
{
  ...
  public boolean a;
  public Object b;
  protected List<ajhk> b;
  
  static
  {
    jdField_b_of_type_JavaLangString = ajhl.class.getSimpleName();
  }
  
  public ajgb(Context paramContext, bjmp parambjmp, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  protected ChatHistorySearchData a(ChatHistorySearchData paramChatHistorySearchData, ArrayList<ajhk> paramArrayList)
  {
    ...
    do
    {
      do
      {
        ...
        while (i < paramChatHistorySearchData.mSearchData1.size())
        {
          ...
          if (a(localMessageRecord)) {
            paramArrayList.add(new ajhk(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord));
          }
          i += 1;
        }
      ...
      return paramChatHistorySearchData;
      paramChatHistorySearchData = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().queryMsgListByID(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, paramChatHistorySearchData.mSearchData2);
      paramArrayList = paramChatHistorySearchData;
  ...
  public void a(List<ajhk> paramList, int paramInt)
  {
    if (paramInt == 1) {
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
    ...
    {
      return false;
      str = ContactUtils.getNicknameInSession(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramMessageRecord.isSend(), paramMessageRecord.senderuin).toLowerCase(Locale.US);
      paramMessageRecord = ajhk.a(paramMessageRecord.msg).toLowerCase(Locale.US);
    } while ((!str.contains(ajhk.jdField_a_of_type_JavaLangString)) && (!paramMessageRecord.contains(ajhk.jdField_a_of_type_JavaLangString)));
    return true;
  }
  
  public ChatHistorySearchData b(ChatHistorySearchData paramChatHistorySearchData, ArrayList<ajhk> paramArrayList)
  {
    int i = 0;
    for (;;)
    {
