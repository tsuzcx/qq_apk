  ...
  implements View.OnClickListener
{
  ...
  public agnr(PhotoListActivity paramPhotoListActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_a_of_type_Agnt.a(this.jdField_a_of_type_Int);
        ...
        {
          bcql.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity, "最多只能选择1张图片", 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.o);
      ...
      bcql.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity, PhotoListActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity, (LocalMediaInfo)localObject2), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.o);
      if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.S) {}
      for (i = 0;; i = 1)
      {
        vei.a("pic_choose_toast", "exp_tooMuch", i, 0, new String[] { "0" });
        this.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.l == 9501) && (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.getIntent().getBooleanExtra("PhotoConst.IS_SEND_FILESIZE_LIMIT", false)) && (i != 1))
      {
        ...
        while (paramView.hasNext()) {
          l += bbdx.a((String)paramView.next());
        }
        if (l + bbdx.a(((LocalMediaInfo)localObject2).path) > 52428800L)
        {
          bcql.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity, "选择图片总大小不能超过50M", 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.o);
          this.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
          return;
        }
      }
      ...
      {
        if ((bbbx.a((LocalMediaInfo)localObject2) == 1) && (((LocalMediaInfo)localObject2).mDuration > this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_c_of_type_Long))
        {
          bcql.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity, ajya.a(2131708077) + this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_c_of_type_Long / 1000L / 60L + ajya.a(2131708089), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.o);
          return;
        }
        l = 0L;
        paramView = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_c_of_type_JavaUtilArrayList.iterator();
        ...
        if (l + bbdx.a(((LocalMediaInfo)localObject2).path) > PhotoListActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity) * 1024L * 1024L)
        {
          localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity;
          localObject2 = new StringBuilder().append(ajya.a(2131708083));
          ...
          {
            bcql.a((Context)localObject1, paramView + ajya.a(2131708112), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.o);
            this.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
            return;
          }
        }
      }
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.getIntent().getBooleanExtra("PhotoConst.IS_SEND_GIF_SIZE_LIMIT", false)) && (PhotoListActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity, (LocalMediaInfo)localObject2)) && (bbdx.a(((LocalMediaInfo)localObject2).path) > 3145728L))
      {
        bcql.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity, ajya.a(2131708120), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.o);
        this.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
        return;
      }
    } while ((PhotoListActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity)) && (!bkpv.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity, (LocalMediaInfo)localObject2)));
    if (i == 1)
    {
      i = 2;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localObject1 = agmm.a(((LocalMediaInfo)localObject2).mMimeType);
      ...
      if (bbbx.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity, PhotoListActivity.a(), (LocalMediaInfo)localObject2, PhotoListActivity.d(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity))) {
        break label970;
      }
    ...
    {
      bcql.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.getResources().getString(2131719567), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.getResources().getDimensionPixelSize(2131298865));
      ((LocalMediaInfo)localObject2).selectStatus = 2;
    ...
    agqd.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.getIntent(), "param_totalSelNum");
    ...
    Object localObject1 = (LinkedHashMap)bbbx.b.get(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_b_of_type_JavaLangString);
    paramView = (View)localObject1;
    if (localObject1 == null)
    {
      paramView = new LinkedHashMap();
      bbbx.b.put(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_b_of_type_JavaLangString, paramView);
    }
    ...
    label1469:
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_a_of_type_Agnx != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_a_of_type_Agnx.a(bool, (LocalMediaInfo)localObject2);
    }
    ...
    for (;;)
    {
      ...
      agqd.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.getIntent(), "param_cancelSelNum");
      paramView = (HashMap)bbbx.b.get(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_b_of_type_JavaLangString);
      if (paramView != null) {
      ...
      break label1469;
      label2056:
      if (new File(((LocalMediaInfo)localObject2).path).length() > ayxe.a())
      {
        bcql.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.getResources().getString(2131695113), 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.o);
