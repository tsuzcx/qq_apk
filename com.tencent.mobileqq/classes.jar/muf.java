...
public class muf
{
  ...
  {
    int i = actn.a(paramFloat, paramContext.getResources());
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            {
              return localObject2;
              Object localObject3 = ((ajxn)paramQQAppInterface.getManager(51)).b(paramString);
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      if ((k > 0) || (j > 0) || (i > 0))
      {
        paramString = str;
        if (k > 0) {
          paramString = str + k + ajyc.a(2131715863);
        }
        str = paramString;
        if (j > 0) {
          str = paramString + j + ajyc.a(2131715862);
        }
        paramString = str;
        if (i > 0) {
          paramString = str + i + ajyc.a(2131715861);
        }
        return paramString;
        if (arrayOfString.length == 2)
        {
  ...
  public static void a()
  {
    ...
    bbjn.a(BaseApplicationImpl.getApplication().getSharedPreferences("UITools", 4).edit().putBoolean("has_show_svip_dialog", false));
  }
  ...
  public static void a(int paramInt)
  {
    ...
    for (;;)
    {
      bbjn.a(BaseApplicationImpl.getApplication().getSharedPreferences("UITools", 4).edit().putInt(str, 0));
      return;
  ...
  public static void a(Activity paramActivity)
  {
    ...
    Intent localIntent;
    if (lzj.a(paramActivity, "miui.intent.action.APP_PERM_EDITOR"))
    {
    ...
    for (;;)
    {
      ...
      if (!bool1)
      {
        i = j;
        bool2 = bool1;
        if (lzj.a(paramActivity, "com.meizu.safe.security.SHOW_APPSEC"))
        {
      ...
      if (!bool2)
      {
        j = i;
        bool1 = bool2;
        if (lzj.a(paramActivity, "huawei.intent.action.NOTIFICATIONMANAGER"))
        {
          i = 3;
      ...
      if ((!bool2) && (lzj.a(paramActivity, "android.settings.action.MANAGE_OVERLAY_PERMISSION")))
      {
        i = 5;
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      paramContext = bbjn.a(paramContext);
  ...
  public static void a(View paramView, String paramString, int paramInt)
  {
    if (jdField_a_of_type_Boolean)
    {
      ...
      if (paramInt == 2) {
        str = paramString.replace(paramView.getResources().getString(2131695679), ajyc.a(2131715864));
      }
      if (QLog.isColorLevel()) {
  ...
  {
    return (lzj.a(paramActivity, "miui.intent.action.APP_PERM_EDITOR")) || (lzj.a(paramActivity, "com.meizu.safe.security.SHOW_APPSEC")) || (lzj.a(paramActivity, "huawei.intent.action.NOTIFICATIONMANAGER")) || (lzj.a(paramActivity, "android.settings.action.MANAGE_OVERLAY_PERMISSION"));
  }
