...
public class ajuv
{
  private static volatile ajuv jdField_a_of_type_Ajuv;
  private List<ajuw> jdField_a_of_type_JavaUtilList;
  ...
  public static ajuv a()
  {
    ...
    {
      if (jdField_a_of_type_Ajuv == null) {
        jdField_a_of_type_Ajuv = new ajuv();
      }
  ...
  public void a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      this.jdField_a_of_type_JavaUtilList = ajuw.a(paramString);
    }
  ...
  public boolean a(String paramString, WebViewFragment paramWebViewFragment)
  {
    ...
    do
    {
      do
      {
        ...
        localajuw = (ajuw)((Iterator)localObject1).next();
      } while (TextUtils.isEmpty(localajuw.jdField_b_of_type_JavaLangString));
      if (localajuw.jdField_a_of_type_JavaUtilRegexPattern == null) {
        localajuw.jdField_a_of_type_JavaUtilRegexPattern = Pattern.compile(localajuw.jdField_b_of_type_JavaLangString);
      }
    } while (!localajuw.jdField_a_of_type_JavaUtilRegexPattern.matcher(paramString).matches());
    Object localObject1 = "";
    Object localObject2 = paramWebViewFragment.mStatistics;
    paramWebViewFragment = (WebViewFragment)localObject1;
    if (localObject2 != null)
    {
      localObject2 = ((bgxd)localObject2).jdField_a_of_type_JavaUtilList;
      paramWebViewFragment = (WebViewFragment)localObject1;
      if (localObject2 != null)
      {
        paramWebViewFragment = (WebViewFragment)localObject1;
    ...
    boolean bool;
    if (TextUtils.isEmpty(localajuw.jdField_a_of_type_JavaLangString)) {
      bool = true;
    }
    while (bool)
    {
      if (localajuw.jdField_a_of_type_Boolean) {
        VACDReportUtil.a("originURL=" + paramWebViewFragment + "|interceptURL=" + paramString, "qqwallet", "InterceptOpenOtherApp", null, null, 0, null);
      }
      if (!localajuw.jdField_b_of_type_Boolean) {
        break;
      }
      if (!TextUtils.isEmpty(localajuw.c))
      {
        if (TextUtils.isEmpty(localajuw.d)) {
          localajuw.d = a(localajuw.c, "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDsE3WI7sDFUi6QWV/oK8qozDvS\nTlxmu1a3NSFxeOrjlVEVtOx8yIMVFYIixq/Fv1XgUlyvL7bGJbaLLKaqlYruGd2z\nNbaIz90Zm4H0pMFHx4vCYhsRP1HXbVMo2ZDiHEDbnSm/99uzFPPiXqLi8jE9t4if\n0GuYdSZfe5o+SIKT5QIDAQAB");
        }
        paramWebViewFragment = localajuw.d;
        if (QLog.isColorLevel()) {
      ...
      try
      {
        for (;;)
        {
          ...
          return true;
          if (localajuw.jdField_b_of_type_JavaUtilRegexPattern == null) {
            localajuw.jdField_b_of_type_JavaUtilRegexPattern = Pattern.compile(localajuw.jdField_a_of_type_JavaLangString);
          }
          bool = localajuw.jdField_b_of_type_JavaUtilRegexPattern.matcher(paramWebViewFragment).matches();
          break;
          label515:
          paramWebViewFragment = paramWebViewFragment + "?j=";
        }
