...
public class yst
{
  ...
  public yst(bjxd parambjxd, Context paramContext)
  {
  ...
  public void a(ysv paramysv)
  {
    ...
    this.jdField_a_of_type_Bjxd.setOnClickListener(new ysu(this));
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (int i = 3;; i = 4)
    {
      ...
      if ((!this.jdField_a_of_type_Bjxd.b(i)) || (this.jdField_a_of_type_Ysv == null)) {
        break;
      }
      this.jdField_a_of_type_Ysv.a();
      return;
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Ysv != null) {
        bool = this.jdField_a_of_type_Ysv.a(paramBoolean);
      }
    } while (!bool);
