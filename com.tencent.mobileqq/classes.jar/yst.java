...
public class yst
  extends zsv<oidb_0x791.RedDotInfo>
  implements View.OnClickListener
{
  ...
  public yst(Context paramContext)
  {
    super(paramContext);
  }
  ...
  public View a(int paramInt, yqw paramyqw, ViewGroup paramViewGroup)
  {
    ...
    {
      paramyqw.a(2131378898).setVisibility(8);
      paramyqw.a().setLayoutParams(new AbsListView.LayoutParams(-1, 0));
      return paramyqw.a();
    }
    paramInt = zps.a(paramyqw.a().getContext(), 52.0F);
    paramyqw.a(2131378898).setVisibility(0);
    paramyqw.a().setLayoutParams(new AbsListView.LayoutParams(-1, paramInt));
    paramyqw.a().setVisibility(0);
    ImageView localImageView = (ImageView)paramyqw.a(2131368212);
    ...
    for (;;)
    {
      ...
      localImageView.setImageDrawable(localDrawable);
      TextView localTextView = (TextView)paramyqw.a(2131365046);
      StringBuilder localStringBuilder = new StringBuilder();
      if (this.jdField_a_of_type_Int > 99) {}
      for (paramViewGroup = "99+";; paramViewGroup = Integer.valueOf(this.jdField_a_of_type_Int))
      {
        localTextView.setText(paramViewGroup + anzj.a(2131705532));
  ...
  {
    paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561783, paramViewGroup, false);
    paramViewGroup.findViewById(2131378898).setOnClickListener(this);
  ...
  public void a(ImageView paramImageView)
  {
    ...
    QQStoryContext.a();
    nkm.a(QQStoryContext.a(), new ysu(this, paramImageView), localReqStoryMessageList.toByteArray(), wnu.a("StorySvc.get_710_message_list"));
  }
  ...
  protected void c()
  {
    ...
    {
      a(((nlb)localQQAppInterface.getManager(70)).a(52));
      return;
    }
    yuk.e("Q.qqstory.home.MessageNotifySegment", "Get the QQAppInterface is null,we dont know the red point state");
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (int i = 1;; i = 2)
    {
      yup.a("play_video", "clk_grey", i, 0, new String[] { "", "", "", "" });
