  ...
  implements Manager
{
  ...
  public bcod(AppInterface paramAppInterface)
  {
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, oidb_0x6b6.SendFlowerReq paramSendFlowerReq, oidb_0x6b6.ThrowFlowerReq paramThrowFlowerReq, long paramLong, bcoc parambcoc)
  {
    if (parambcoc == null)
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6b6. callback=" + parambcoc);
      }
      label37:
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          if ((paramInt3 >= 4) && (System.currentTimeMillis() - auzw.jdField_a_of_type_Long < 600000L))
          {
            paramString2 = new oidb_0x6b6.GPSInfo();
            paramString2.int32_gps_type.set(1, true);
            paramString2.int64_longitude.set(auzw.jdField_a_of_type_ArrayOfLong[0], true);
            paramString2.int64_latitude.set(auzw.jdField_a_of_type_ArrayOfLong[1], true);
          ...
          mzy.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcoe(this, parambcoc), localReqBody.toByteArray(), paramString1 + "_" + paramInt2, paramInt1, paramInt2, paramString2, paramLong);
          return;
          if (paramInt2 != 11) {
            continue;
          }
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, oidb_0x6c3.GetStockReq paramGetStockReq, oidb_0x6c3.GetExtraDataReq paramGetExtraDataReq, long paramLong, bcoc parambcoc)
  {
    if (parambcoc == null)
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6c3. troopUin is null. callback=" + parambcoc);
      }
      return;
    }
    ...
    for (paramGetStockReq = paramGetStockReq.getSkey(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());; paramGetStockReq = "")
    {
      ...
      mzy.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcog(this, parambcoc), localReqBody.toByteArray(), paramString1 + "_" + paramInt4, paramInt1, paramInt4, paramGetStockReq, paramLong);
      return;
    }
  }
  
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, long paramLong, bcoc parambcoc)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (parambcoc == null))
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6c2. troopUin=" + paramString1 + " giftBagID=" + paramString2 + " callback=" + parambcoc);
      }
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          mzy.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcoi(this, parambcoc, paramString1, paramString2), localReqBody.toByteArray(), "OidbSvc.0x6c2_" + paramInt3, 1730, paramInt3, (Bundle)localObject, paramLong);
          return;
        }
      }
  ...
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, bcoc parambcoc)
  {
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      mzy.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcoj(this, parambcoc), paramString1.toByteArray(), "OidbSvc.0x962_" + paramInt3, 2402, 1, paramString2, 500L);
      return;
    }
  ...
  private void b(bcoc parambcoc)
  {
    ...
    mzy.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcof(this, parambcoc), localReqBody.toByteArray(), "OidbSvc.0xcd1_0", 3281, 0, null, 0L);
  }
  
  private void b(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, long paramLong, bcoc parambcoc)
  {
    if ((TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString3)) || (parambcoc == null))
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6b5. troopUin=" + paramString2 + " giftBagID=" + paramString3 + " callback=" + parambcoc);
      }
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        paramInt2 = 1;
        mzy.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcoh(this, parambcoc, paramString2, paramString3), localReqBody.toByteArray(), paramString1 + "_" + paramInt2, paramInt1, paramInt2, (Bundle)localObject, paramLong);
        return;
      }
      catch (NumberFormatException paramString1) {}
      if (!QLog.isColorLevel()) {
  ...
  public TroopGiftBagInfo a(String paramString1, String paramString2, bcoc parambcoc)
  {
    ...
    TroopGiftBagInfo localTroopGiftBagInfo = (TroopGiftBagInfo)this.jdField_a_of_type_Awgf.a(TroopGiftBagInfo.class, paramString2);
    ...
    a(paramString1, paramString2, 0, 0, 1000L, parambcoc);
    return null;
  }
  ...
  public void a(int paramInt, bcoc parambcoc)
  {
    if (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
      return;
    }
    ...
    mzy.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcol(this, parambcoc), localReqBody.toByteArray(), "OidbSvc.0x9e9_0", 2537, 0);
  }
  
  public void a(bcoc parambcoc)
  {
    if (QLog.isColorLevel()) {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, int paramInt6, int paramInt7, bcoc parambcoc)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramInt3, paramString2, paramInt4, 0, null, localThrowFlowerReq, 0L, parambcoc);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, long paramLong, int paramInt6, int paramInt7, int paramInt8, int paramInt9, bcoc parambcoc, int paramInt10)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramInt3, paramString2, paramInt4, paramInt9, localSendFlowerReq, null, 0L, parambcoc);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, int paramInt5, bcoc parambcoc)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, null, localGetExtraDataReq, 0L, parambcoc);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, bcoc parambcoc)
  {
    a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, false, false, parambcoc);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2, bcoc parambcoc)
  {
    if (QLog.isColorLevel()) {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, localGetStockReq, null, 0L, parambcoc);
      return;
    }
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, long paramLong, bcoc parambcoc)
  {
    if (QLog.isColorLevel()) {
      QLog.e(".troop.send_gift .troop.send_gift", 2, "grabGift. troopUin:" + paramString2 + " bagID:" + paramString3);
    }
    b(paramString1, paramInt1, paramInt2, paramString2, paramString3, paramLong, parambcoc);
  }
  
  public void a(String paramString, bcoc parambcoc)
  {
    try
    {
      ...
      mzy.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcom(this, parambcoc), paramString.toByteArray(), "OidbSvc.0xa48_1", 2632, 1, new Bundle(), 6000L);
      return;
    }
    catch (Exception paramString)
    {
      parambcoc.a(-1, "troop uin error");
    }
  }
  
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, long paramLong, bcoc parambcoc)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramString2, paramInt1, paramInt2, 0, paramLong, parambcoc);
  }
  
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, bcoc parambcoc)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "reportInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, paramInt2, paramInt1, 3, parambcoc);
  }
  
  public void a(String paramString1, String paramString2, int paramInt, bcoc parambcoc)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "chechInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, 0, paramInt, 1, parambcoc);
  }
  
  public void a(yvj paramyvj, int paramInt, String paramString, long paramLong, bcoc parambcoc)
  {
    if ((paramyvj == null) || (parambcoc == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localReqBody.product_id.set(paramyvj.jdField_a_of_type_Int, true);
      localReqBody.amount.set(paramyvj.f, true);
      ...
      try
      {
        ...
        mzy.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bcok(this, parambcoc, paramyvj), localReqBody.toByteArray(), "OidbSvc.0xdad_" + paramInt, 3501, paramInt, paramString, 0L);
        return;
      }
      catch (NumberFormatException paramyvj) {}
    } while (!QLog.isColorLevel());
  ...
  {
    if ((this.jdField_a_of_type_Awgf == null) || (paramawge == null)) {}
    do
    {
      do
      {
  ...
  public void b(String paramString1, String paramString2, int paramInt, bcoc parambcoc)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "startInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, 0, paramInt, 2, parambcoc);
  }
