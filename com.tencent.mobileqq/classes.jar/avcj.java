...
{
  private final avck jdField_a_of_type_Avck = new avck();
  private avcl jdField_a_of_type_Avcl;
  private final bfob jdField_a_of_type_Bfob;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private boolean jdField_a_of_type_Boolean;
  private final avck jdField_b_of_type_Avck = new avck();
  private boolean jdField_b_of_type_Boolean;
  private final avck c = new avck();
  
  public avcj(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Bfob = new bfob(ThreadManager.getSubThreadLooper(), this);
    a(new PTTPreDownloadStrategy(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Bfob));
  }
  ...
  public static int a(QQAppInterface paramQQAppInterface, MessageForPtt paramMessageForPtt)
  {
    ...
    {
      return 2005;
      if ((paramMessageForPtt.url.startsWith(ajsd.aV)) && (bbdx.a(paramMessageForPtt.getLocalFilePath()))) {
        return 2003;
      }
  ...
  public static avcj a(QQAppInterface paramQQAppInterface)
  {
    return (avcj)paramQQAppInterface.getManager(127);
  }
  
  private avck a(MessageForPtt paramMessageForPtt)
  {
    avck localavck = null;
    if (paramMessageForPtt.istroop == 0) {
      localavck = this.jdField_a_of_type_Avck;
    }
    do
    {
      return localavck;
      if (paramMessageForPtt.istroop == 1) {
        return this.jdField_b_of_type_Avck;
      }
    } while (paramMessageForPtt.istroop != 3000);
    return this.c;
  }
  
  private void a(avck paramavck)
  {
    if (QLog.isColorLevel()) {
      QLog.d("PTTPreDownloader", 2, "cancelCache");
    }
    int i = 0;
    if (i < paramavck.jdField_a_of_type_JavaUtilArrayList.size())
    {
      MessageForPtt localMessageForPtt = (MessageForPtt)paramavck.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (this.jdField_a_of_type_Avcl.b(localMessageForPtt)) {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    {
      a(this.jdField_a_of_type_Avck);
      a(this.jdField_b_of_type_Avck);
      a(this.c);
    }
  }
  ...
  private void a(boolean paramBoolean, int paramInt, MessageForPtt paramMessageForPtt)
  {
    ...
    if ((paramMessageForPtt.extFlag > 0L) && ((paramMessageForPtt.extFlag & 1L) > 0L))
    {
      ...
      this.jdField_a_of_type_Avcl.b(paramMessageForPtt);
    }
    label129:
    while (((paramMessageForPtt.extFlag & 0x2) != 0L) || (!this.jdField_a_of_type_Avcl.a(paramMessageForPtt, 3)))
    {
  ...
  private boolean a(avck paramavck)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      if ((paramavck.jdField_a_of_type_Int < 3) && (paramavck.jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        MessageForPtt localMessageForPtt = (MessageForPtt)paramavck.jdField_a_of_type_JavaUtilArrayList.get(0);
        if (this.jdField_a_of_type_Avcl.a(localMessageForPtt))
        {
          long l;
          ...
          try
          {
            ...
            label113:
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localMessageForPtt.frienduin, localMessageForPtt.istroop, localMessageForPtt.uniseq, localMessageForPtt.msgData);
            paramavck.jdField_a_of_type_JavaUtilArrayList.remove(0);
            for (bool = false;; bool = true)
            {
              ...
              break label102;
              paramavck.jdField_a_of_type_Int += 1;
              paramavck.jdField_a_of_type_JavaUtilArrayList.remove(0);
            }
          }
    ...
    do
    {
      for (;;)
      {
        ...
        if (!((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(60)).b(paramMessageForPtt.frienduin))
        {
          ...
          if ((i == 0) || (i == -1))
          {
            localavck = a(paramMessageForPtt);
            if (localavck != null)
            {
              if (!this.jdField_b_of_type_Boolean) {
                break;
              ...
              long l;
              if ((localavck.jdField_a_of_type_Int < 3) && (this.jdField_a_of_type_Avcl.a(paramMessageForPtt))) {
                if (!g(paramMessageForPtt)) {
                  if (this.jdField_a_of_type_Avcl.b(paramMessageForPtt))
                  {
                    if (paramMessageForPtt.extFlag != -1L) {
                      break label290;
                    }
              ...
              for (;;)
              {
                ...
                axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "changevoice", "0X8006F7D", 0, 0, "" + paramMessageForPtt.istroop, "", "", "");
                return true;
                l = (0x3 ^ 0xFFFFFFFF) & paramMessageForPtt.extFlag;
                break;
                localavck.jdField_a_of_type_Int += 1;
                continue;
                i = localavck.jdField_a_of_type_JavaUtilArrayList.size();
                localavck.getClass();
                if (i + 1 < 99) {
                  localavck.jdField_a_of_type_JavaUtilArrayList.add(paramMessageForPtt);
                }
              }
            }
          }
  ...
  private boolean f(MessageForPtt paramMessageForPtt)
  {
    ...
    if (this.jdField_a_of_type_Avcl.a(paramMessageForPtt, 1)) {
      if (paramMessageForPtt.extFlag != -1L) {
        break label113;
      }
    }
  ...
  private boolean g(MessageForPtt paramMessageForPtt)
  {
    ...
    else
    {
      ...
      localaywc.jdField_c_of_type_JavaLangString = paramMessageForPtt.frienduin;
      localaywc.jdField_a_of_type_Int = paramMessageForPtt.istroop;
      localaywc.jdField_b_of_type_Int = 2;
      localaywc.jdField_a_of_type_Long = paramMessageForPtt.uniseq;
      localaywc.jdField_a_of_type_Boolean = false;
      localaywc.e = paramMessageForPtt.urlAtServer;
      localaywc.h = paramMessageForPtt.getLocalFilePath();
    ...
    for (;;)
    {
      localaywc.jdField_b_of_type_Boolean = bool1;
      localaywc.f = paramMessageForPtt.md5;
      localaywc.jdField_c_of_type_Long = paramMessageForPtt.groupFileID;
      localaywc.jdField_g_of_type_JavaLangString = paramMessageForPtt.groupFileKeyStr;
      localaywc.d = paramMessageForPtt.subVersion;
      localaywc.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = paramMessageForPtt;
      localaywc.jdField_g_of_type_Int = 1;
      localaywc.jdField_a_of_type_JavaLangObject = new aywh(6, 0);
      try
      {
        bool1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localaywc);
        if (QLog.isDevelopLevel()) {
  ...
  public void a(avcl paramavcl)
  {
    this.jdField_a_of_type_Avcl = paramavcl;
  }
  
  public void a(boolean paramBoolean, int paramInt, aywh paramaywh, MessageForPtt paramMessageForPtt)
  {
    paramaywh = this.jdField_a_of_type_Bfob;
    if (paramBoolean) {}
    for (int i = 1;; i = 0)
    {
      paramaywh.obtainMessage(2, i, paramInt, paramMessageForPtt).sendToTarget();
      return;
    }
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean2)
    {
      localObject = this.jdField_a_of_type_Bfob;
      if (paramBoolean1) {}
      for (;;)
      {
        localObject = ((bfob)localObject).obtainMessage(3, i, 0);
        this.jdField_a_of_type_Bfob.sendMessageDelayed((Message)localObject, 30000L);
        return;
        i = 0;
      }
    }
    this.jdField_a_of_type_Bfob.removeMessages(3);
    Object localObject = this.jdField_a_of_type_Bfob;
    if (paramBoolean1) {}
    for (i = j;; i = 0)
    {
      ((bfob)localObject).obtainMessage(3, i, 0).sendToTarget();
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Bfob.obtainMessage(0, paramMessageForPtt).sendToTarget();
    return true;
  }
  ...
  public boolean b(MessageForPtt paramMessageForPtt)
  {
    ...
    {
      paramMessageForPtt.extFlag = l;
      this.jdField_a_of_type_Bfob.obtainMessage(4, paramMessageForPtt).sendToTarget();
      return true;
      l = 0x2 | paramMessageForPtt.extFlag;
    }
  }
