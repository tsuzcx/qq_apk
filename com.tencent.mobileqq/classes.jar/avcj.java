  ...
  implements avcf
{
  ...
  public avcj(VideoData paramVideoData, QQAppInterface paramQQAppInterface)
  {
  ...
  public int a()
  {
    try
    {
      int i = Integer.parseInt("8.3.5".replace(".", ""));
      return i;
    }
  ...
  public void a(int paramInt, avch paramavch)
  {
    ...
    mzy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new avck(this, paramavch), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
  }
  
  public void a(Comments.Comment paramComment, avcg paramavcg)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ...
    if (a(localReqBody))
    {
      ...
      mzy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new avcm(this, paramavcg, paramComment), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
    }
    paramavcg.a(paramComment, -1);
  }
  
  public void a(Comments.Comment paramComment, avci paramavci)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      mzy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new avcl(this, paramavci, paramComment), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
