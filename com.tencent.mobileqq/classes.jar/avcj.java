  ...
  implements agvc, Handler.Callback
{
  ...
  final azrg jdField_a_of_type_Azrg = new avck(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anzj.a(2131718001);
  }
  
  public avcj(BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new avcn(this);
  ...
  public static bhpc a(Activity paramActivity, bhpc parambhpc, BaseChatPie paramBaseChatPie, long paramLong, int paramInt, String paramString)
  {
    ...
    String str = ((QQAppInterface)localObject).getApplication().getString(2131717997);
    if (paramString != null) {}
    for (paramString = str + paramString;; paramString = str)
    {
      str = ((QQAppInterface)localObject).getApplication().getString(2131718003);
      localObject = ((QQAppInterface)localObject).getApplication().getString(2131717998);
      avcl localavcl = new avcl(paramLong, paramInt, paramActivity);
      avcm localavcm = new avcm(paramLong, paramInt, paramActivity, paramBaseChatPie);
      paramBaseChatPie = parambhpc;
      if (parambhpc == null) {
        paramBaseChatPie = bhlq.a(paramActivity, 232, null, str, paramString, (String)localObject, localavcl, localavcm);
      }
      paramBaseChatPie.setNegativeButton(paramString, localavcm);
      paramBaseChatPie.setPositiveButton((String)localObject, localavcl);
      try
      {
        paramBaseChatPie.show();
        return paramBaseChatPie;
      }
      catch (Throwable parambhpc)
      {
      ...
      QLog.e("SDK_SHARE.ForwardShareByServerHelper", 2, "qbShowShareResultDialog: failed. ", parambhpc);
      return paramBaseChatPie;
    }
  }
  ...
  private AbsStructMsg a()
  {
    ...
    return bdow.a(localIntent.getByteArrayExtra("stuctmsg_bytes"));
  }
  ...
  public static String a(Context paramContext, String paramString)
  {
    try
    {
      ...
      paramContext = bhml.a(paramString.digest());
  ...
  public static oidb_cmd0xb77.ReqBody a(Bundle paramBundle, String paramString1, String paramString2, oidb_cmd0xb77.ImageInfo paramImageInfo, long paramLong)
  {
    ...
    if (i == 0)
    {
      ...
      {
        paramBundle = str1;
        if (str1.contains(anzj.a(2131703705))) {
          paramBundle = str1.replace(anzj.a(2131703732), "");
        }
  ...
  public static void a(long paramLong, int paramInt, Activity paramActivity)
  {
    ...
    noe.a((QQAppInterface)localObject1, "", "choose", paramLong, paramInt, "stay");
    bjqh.a().a(((QQAppInterface)localObject1).getAccount(), "", String.valueOf(paramLong), "1000", "52", "0", false);
  ...
  public static void a(long paramLong, int paramInt, Activity paramActivity, BaseChatPie paramBaseChatPie)
  {
    ...
    noe.a(localQQAppInterface, "", "choose", paramLong, paramInt, "back");
    bjqh.a().a(localQQAppInterface.getAccount(), "", String.valueOf(paramLong), "1000", "51", "0", false);
    noe.a(paramActivity, 0, "", "");
  ...
  private void a(Bundle paramBundle)
  {
    ...
    {
      this.jdField_a_of_type_Bhpc = a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bhpc, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, paramBundle.mSourceAppid, paramBundle.mMsgServiceID, str);
      return;
    }
  }
  ...
  public static void a(Bundle paramBundle, int paramInt, long paramLong, boolean paramBoolean)
  {
    if ((paramBundle != null) && (paramBundle.getBoolean("forward_mini_program_ark_from_sdk", false))) {
      bdll.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00898", "", "", "0X8009F7C", "0X8009F7C", 0, 0, "1", "", "", "");
    }
    if (paramBundle != null) {}
    for (;;)
    {
      ...
      try
      {
        ...
        {
        default: 
          bjvq.a().a(0, "SHARE_TO_QQ", ((QQAppInterface)localObject).getCurrentAccountUin(), String.valueOf(paramLong), String.valueOf(i), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
          if (paramInt != 1) {
            break label348;
          }
          str1 = "1";
      ...
      {
        localObject = "0";
        localbjqh.a(str4, "", str5, "10", "12", (String)localObject, str1, str3, str2, false);
        if (paramBoolean) {
  ...
  private void a(Bundle paramBundle, String paramString1, String paramString2)
  {
    ...
    nkm.a(paramString2, new avcq(this, paramBundle), paramString1.toByteArray(), "OidbSvc.0xb77_9", 2935, 9, localBundle, 0L);
  }
  
  private void a(azrg paramazrg, AbsStructMsg paramAbsStructMsg)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    Object localObject = new WeakReference(paramazrg);
    ...
    paramazrg = this.jdField_a_of_type_AndroidOsBundle.getString("uin");
    ...
    localObject = (azrg)((WeakReference)localObject).get();
    ...
    AbsShareMsg.sendSdkShareMessageByServer(localQQAppInterface, (AbsShareMsg)paramAbsStructMsg, paramazrg, i, str, (azrg)localObject);
  }
  ...
  public static boolean a()
  {
    arft localarft = arfu.a();
    if (localarft != null) {}
    for (boolean bool = localarft.a();; bool = false)
    {
  ...
  private void b(int paramInt, String paramString1, String paramString2)
  {
    ...
    if ((localBundle != null) && (localBundle.getBoolean("forward_mini_program_ark_from_sdk", false))) {
      bdll.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00898", "", "", "0X8009F7C", "0X8009F7C", 0, 0, "2", String.valueOf(paramInt), "", "");
    }
  ...
  private static void b(Bundle paramBundle, int paramInt, long paramLong)
  {
    ...
    int i = paramBundle.getInt("uintype");
    bdll.b(null, "dc00898", "", "", "0X800B2DB", "0X800B2DB", 0, 0, String.valueOf(paramLong), ForwardUtils.c(paramInt), ForwardUtils.a(i), str);
  }
  ...
  private void c(String paramString)
  {
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        nlj.a().jdField_a_of_type_Boolean = true;
        aean.b(localQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, localSessionInfo, paramString);
        return;
      }
  ...
  private void e()
  {
    ...
    if (this.jdField_a_of_type_AndroidOsBundle != null)
    {
      ...
      {
        localObject = bdow.a(this.jdField_a_of_type_AndroidOsBundle);
    ...
    {
      this.jdField_a_of_type_Bhpc = a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bhpc, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, ((AbsShareMsg)localObject).mSourceAppid, ((AbsShareMsg)localObject).mMsgServiceID, str);
  ...
  private void f()
  {
    ...
    {
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new avcp(this);
  ...
  protected void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    paramString1 = new avco(this, paramInt, paramString2);
    this.jdField_b_of_type_Bhpc.setPositiveButton(2131694098, paramString1);
    ...
    for (boolean bool = ((Bundle)localObject).getBoolean("share_send_msg_by_server", false);; bool = false)
    {
      ...
      if (bool)
      {
        ...
        if ((localObject instanceof AbsShareMsg))
        {
          ...
          bdll.b(null, "dc00898", "", "", "0X8009C93", "0X8009C93", 0, 0, String.valueOf(this.jdField_a_of_type_AndroidOsBundle.getLong("req_share_id")), str1, str2, paramIntent);
          d();
          a(this.jdField_a_of_type_Azrg, (AbsStructMsg)localObject);
        }
      }
      do
      {
      ...
      localObject = auzl.a((String)localObject);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    bdll.b(null, "dc00898", "", "", "0X8009CF9", "0X8009CF9", 0, 0, "", "", "", "");
