  ...
  implements View.OnTouchListener
{
  ...
  public static final int[] c = { 2130844250, 2130844253 };
  public static final int[] d = { 2131377730, 2131377731 };
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 2131363649, 2131363650 };
    jdField_b_of_type_ArrayOfInt = new int[] { 2130844249, 2130844252 };
  }
  
  public xrz(xsc paramxsc, View paramView, int paramInt)
  {
  ...
  public void a(CharSequence paramCharSequence)
  {
    ...
    for (CharSequence localCharSequence = this.jdField_a_of_type_AndroidWidgetTextView.getHint();; localCharSequence = paramCharSequence)
    {
      ...
      if (this.jdField_b_of_type_AndroidWidgetTextView.getVisibility() == 0)
      {
        ...
        k = xsm.a(this.jdField_a_of_type_AndroidWidgetTextView.getContext(), 72.5F);
      ...
      for (;;)
      {
        ...
        break;
        label201:
        k = xsm.a(this.jdField_a_of_type_AndroidWidgetTextView.getContext(), 84.0F);
      ...
      if ((n <= k) || (i == arrayOfFloat1.length - 1))
      {
        ...
        wxe.a("Q.qqstory.widget.PollWidgetUtils", "text size = %s", Float.valueOf(arrayOfFloat1[i]));
      }
      for (;;)
      {
        paramCharSequence = xrr.a(this.jdField_a_of_type_AndroidWidgetTextView, 2);
        this.jdField_a_of_type_AndroidWidgetTextView.setText(paramCharSequence);
  ...
  public void a(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130844197);
      return;
    }
  ...
  {
    if ((a()) || (this.jdField_a_of_type_Xrw == null) || (!this.jdField_a_of_type_Xsc.a())) {
