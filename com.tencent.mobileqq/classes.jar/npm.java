...
public class npm
{
  ...
  {
    return (paramAdvertisementInfo != null) && (paramAdvertisementInfo.mPhoneComponetId != 0) && (npi.e(paramAdvertisementInfo));
  }
  
  public static boolean a(AdData paramAdData)
  {
    return (paramAdData != null) && (paramAdData.m != 0) && (npi.e(paramAdData));
  }
  ...
  public static void b(Context paramContext, String paramString, AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    nbe.a(new nmv().a(paramContext).a(nbe.w).b(nbe.af).a(paramAdvertisementInfo).e(a(2, 1, paramString, paramAdvertisementInfo)).a());
  }
}
