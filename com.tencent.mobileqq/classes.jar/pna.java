...
class pna
{
  ...
  public pna(List<oidb_cmd0x80a.AttributeList> paramList)
  {
    Object localObject;
    if (localObject != null) {
  ...
  public pna a(int paramInt, String paramString1, String paramString2)
  {
  ...
  public pna a(int paramInt, String paramString, boolean paramBoolean)
  {
    return a(paramInt, paramString, pno.a(paramBoolean, "1", "0"));
  }
  
  public pna a(oidb_cmd0x80a.AttributeList paramAttributeList)
  {
