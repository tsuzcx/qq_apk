  ...
  extends apuf
{
  ...
  public static List<apuf> a(int[] paramArrayOfInt)
  {
    ...
    while (i < paramArrayOfInt.length)
    {
      ...
      localapzf.jdField_a_of_type_Int = paramArrayOfInt[i];
      localapzf.jdField_c_of_type_Int = 1;
      localArrayList.add(localapzf);
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j < m)
        {
          ...
          if ((n < 0) || (n >= bamd.jdField_a_of_type_Int)) {
            break label218;
          }
          int k = i + 1;
          paramAppRuntime[i] = n;
  ...
  {
    return banh.a(this.jdField_a_of_type_Int, false);
  }
  
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo)
  {
    if (this.d == 1) {
      azqs.b(null, "CliOper", "", "", "0X8005507", "0X8005507", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      int i = paramEditText.getSelectionStart();
      int j = paramEditText.getSelectionEnd();
      paramEditText.getEditableText().replace(i, j, banh.c(this.jdField_a_of_type_Int));
      paramEditText.requestFocus();
      return;
      if (this.d == 2) {
        azqs.b(null, "CliOper", "", "", "0X8005508", "0X8005508", 0, 0, "", "", "", "");
      }
    }
  }
  ...
  {
    return banh.a(this.jdField_a_of_type_Int, true);
  }
}
