...
public class absw
  extends BaseAdapter
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new absx(this);
  List<ProfileLabelInfo> jdField_a_of_type_JavaUtilList;
  
  public absw(List<ProfileLabelInfo> paramList)
  {
    Object localObject;
  ...
  private void a(ProfileLabelInfo paramProfileLabelInfo)
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Auzp.a().keySet().iterator();
    ...
    {
      break;
      if ((localObject != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Auzp.a(localObject)))
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Auzp.c(localObject, this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.jdField_a_of_type_Auzp.a(localObject));
        return;
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityProfileLabelEditorActivity.getLayoutInflater().inflate(2131562488, null);
      ...
      paramViewGroup = new absv();
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376836));
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (absv)paramView.getTag();
    }
  }
}
