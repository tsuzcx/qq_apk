...
public class bbdu
{
  ...
  public static bbdo a(Spannable paramSpannable, int paramInt)
  {
    if ((paramInt < 0) || (paramInt >= paramSpannable.length())) {
      return null;
    }
    bbdo[] arrayOfbbdo = (bbdo[])paramSpannable.getSpans(paramInt, paramInt, bbdo.class);
    int i = 0;
    while (i < arrayOfbbdo.length)
    {
      int j = paramSpannable.getSpanStart(arrayOfbbdo[i]);
      int k = paramSpannable.getSpanEnd(arrayOfbbdo[i]);
      if ((paramInt >= j) && (paramInt < k)) {
        return arrayOfbbdo[i];
      }
      i += 1;
    }
    return null;
  ...
  public static List<Pair<Integer, String>> a(Editable paramEditable)
  {
    ...
    if (i < paramEditable.length())
    {
      Object localObject2 = (bbdo[])paramEditable.getSpans(i, i, bbdo.class);
      ...
      localObject1 = ((bbdo)localObject2).a();
  ...
  public static void a(ETTextView paramETTextView, CharSequence paramCharSequence, int paramInt)
  {
    ...
    for (paramETTextView = paramETTextView.getText();; paramETTextView = paramCharSequence)
    {
      ...
      paramETTextView = (bbdo[])paramETTextView.getSpans(0, paramETTextView.length(), bbdo.class);
      paramInt = 0;
  ...
  public static List<Pair<Integer, Integer>> b(Editable paramEditable)
  {
    ...
    if (i < paramEditable.length())
    {
      arrayOfbbdo = (bbdo[])paramEditable.getSpans(i, i, bbdo.class);
      if ((arrayOfbbdo == null) || (arrayOfbbdo.length <= 0)) {
        break label184;
      }
      if (arrayOfbbdo.length > 1)
      {
        int k = arrayOfbbdo.length;
        j = 0;
        localObject1 = null;
        label66:
        if (j < k)
        {
          bbdo localbbdo = arrayOfbbdo[j];
          if (localbbdo == localObject2) {
            break label194;
          }
          localObject1 = localbbdo;
        }
      }
    }
    label184:
    ...
    for (;;)
    {
      ...
      if (localObject1 == null) {
        localObject1 = arrayOfbbdo[(arrayOfbbdo.length - 1)];
      }
      for (;;)
      {
        label110:
        ...
        {
          localObject2 = ((bbdo)localObject1).a();
