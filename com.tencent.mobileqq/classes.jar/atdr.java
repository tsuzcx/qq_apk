...
public class atdr
{
  ...
  public atdr(atdm paramatdm, Bundle paramBundle, int paramInt1, atgs paramatgs, long paramLong, int paramInt2)
  {
    this.jdField_a_of_type_AndroidOsBundle = paramBundle;
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_a_of_type_Atgs = paramatgs;
    this.jdField_a_of_type_Long = paramLong;
    this.jdField_a_of_type_JavaLangString = paramatgs.a();
    this.b = paramInt2;
