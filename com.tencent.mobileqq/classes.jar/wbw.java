  ...
  extends Dialog
{
  ...
  public wbw(Context paramContext)
  {
    super(paramContext, 2131755013);
    View localView = LayoutInflater.from(paramContext).inflate(2131561308, null);
    localView.setOnTouchListener(new wbx(this));
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryViewAnimationPoint.setRadius(vzl.a(paramContext, 25.0F));
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryViewAnimationPoint.setOnAnimationListener(new wby(this, paramContext));
  }
