...
public abstract class bdwi
  implements bdto, bdts
{
  ...
  private static bdwk<bdts> listeners = new bdwk();
  private static bdwk<WeakReference<bdts>> weakListeners = new bdwk();
  ...
  protected void _onCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      bdhb.a(paramQQAppInterface, paramString2, false);
      return;
    }
  ...
  public void download(QQAppInterface paramQQAppInterface, int paramInt, bdts parambdts, boolean paramBoolean)
  {
    download(paramQQAppInterface, getScid(paramInt), parambdts, paramBoolean);
  }
  ...
  public void download(QQAppInterface paramQQAppInterface, long paramLong, String paramString, bdts parambdts, boolean paramBoolean)
  {
    if (FlatBuffersParser.c())
    {
      ...
      if (parambdts != null) {
        parambdts.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10086, 0);
      }
    }
    do
    {
    ...
    } while (parambdts == null);
    parambdts.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10087, 0);
    return;
    ...
    for (;;)
    {
      if (parambdts != null)
      {
        ...
        weakListeners.a((String)localObject, new WeakReference(parambdts));
      }
      for (;;)
      {
        QLog.e("BaseUpdateCallback", 1, "download: " + paramLong + "_" + paramString + ", " + parambdts);
        ...
        parambdts.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10088, 0);
        return;
        listeners.a((String)localObject, parambdts);
      }
    }
  }
  ...
  public void download(QQAppInterface paramQQAppInterface, String paramString, bdts parambdts, boolean paramBoolean)
  {
    download(paramQQAppInterface, getBID(), paramString, parambdts, paramBoolean);
  }
  ...
  public final void onCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    for (localObject1 = listeners.b((String)localObject2);; localObject1 = listeners.a((String)localObject2))
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        ((bdts)((Iterator)localObject1).next()).onCompleted(paramQQAppInterface, paramLong, paramString1, paramString2, paramString3, paramInt1, paramInt2);
      }
    ...
    for (localObject1 = weakListeners.b((String)localObject2);; localObject1 = weakListeners.a((String)localObject2))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (bdts)((WeakReference)((Iterator)localObject1).next()).get();
        if (localObject2 != null) {
          ((bdts)localObject2).onCompleted(paramQQAppInterface, paramLong, paramString1, paramString2, paramString3, paramInt1, paramInt2);
        }
      }
    }
  }
  ...
  public final void onProgress(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, long paramLong3)
  {
    ...
    for (boolean bool = false;; bool = ((VasQuickUpdateEngine.TagItemInfo)localObject1).bPreConfig)
    {
      ...
      while (((Iterator)localObject2).hasNext()) {
        ((bdts)((Iterator)localObject2).next()).onProgress(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, paramLong3);
      }
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      localObject2 = (bdts)((WeakReference)((Iterator)localObject1).next()).get();
      if (localObject2 != null) {
        ((bdts)localObject2).onProgress(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, paramLong3);
      }
    }
  }
  
  public void removeListener(long paramLong, String paramString, bdts parambdts)
  {
    paramString = getKey(paramLong, paramString, "");
    listeners.a(paramString, parambdts, false);
    weakListeners.a(paramString, parambdts, true);
  }
}
