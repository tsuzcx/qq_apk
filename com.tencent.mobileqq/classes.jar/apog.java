...
public class apog
{
  public static void a(NearbyAppInterface paramNearbyAppInterface)
  {
    ...
    asfc.a(paramNearbyAppInterface.getAccount(), "nearby_enter_time", Long.valueOf(0L));
    if ((ajnd)paramNearbyAppInterface.a(3) != null)
    {
      oidb_0x91f.ReqBody localReqBody = new oidb_0x91f.ReqBody();
      localReqBody.uint32_state.set(0);
      mmj.a(paramNearbyAppInterface, new apoh(paramNearbyAppInterface), localReqBody.toByteArray(), "OidbSvc.0x91f", 2335, 5, null, 0L);
    }
    asfc.a(paramNearbyAppInterface.getAccount(), false);
    asfc.a(paramNearbyAppInterface.getAccount(), "nearby_people_disclaimer_ok_5.8.0", Boolean.valueOf(false));
  ...
  public static void b(NearbyAppInterface paramNearbyAppInterface)
  {
    ...
    {
      localFile.delete();
      asfl.a("Q.nearby", "clearNearbyCache", new Object[0]);
    }
    asfc.a(paramNearbyAppInterface.getAccount(), "history_valid", Boolean.valueOf(false));
  }
}
