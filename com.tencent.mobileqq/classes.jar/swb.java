...
public class swb
{
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    {
      String str = bjkp.a(paramString1 + System.currentTimeMillis());
      StringBuilder localStringBuilder = new StringBuilder(a());
  ...
  public static boolean a(swc paramswc)
  {
    if (paramswc == null) {}
    long l;
    do
    {
      do
      {
        ...
        {
          return false;
          if (a(paramswc.a, paramswc.jdField_b_of_type_Int))
          {
            if (QLog.isColorLevel()) {
          ...
          if ((paramswc.d >= a()) && (paramswc.d <= b())) {
            break;
          }
        } while (!QLog.isColorLevel());
        QLog.d("VideoConvertUtils", 2, "needCompress(): false! fileSize not match, size=" + paramswc.d);
        return false;
        if (a()) {
          break;
        }
      ...
      return false;
      l = a(paramswc.a, paramswc.jdField_b_of_type_Int);
      if ((l > 0L) && (paramswc.jdField_b_of_type_Long > 3L * l))
      {
        if (QLog.isColorLevel()) {
          QLog.d("VideoConvertUtils", 2, "needCompress(): true! sourceBitRate:" + paramswc.jdField_b_of_type_Long + ", targetBitRate:" + l);
        }
        return true;
      }
    } while (!QLog.isColorLevel());
    QLog.d("VideoConvertUtils", 2, "needCompress(): false, bitrate not match, sourceBitRate:" + paramswc.jdField_b_of_type_Long + ", targetBitRate:" + l);
    return false;
  }
