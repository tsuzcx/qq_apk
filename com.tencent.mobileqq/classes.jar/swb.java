...
public class swb
{
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  ((ProteusBannerBigPicItemData)localObject2).S = paramJSONObject.optString("store_name");
                  ((ProteusBannerBigPicItemData)localObject2).T = paramJSONObject.optString("store_addr");
                  ((ProteusBannerBigPicItemData)localObject2).U = paramJSONObject.optString("store_url");
                  ((ProteusBannerBigPicItemData)localObject2).W = paramJSONObject.optString("store_long");
                  ((ProteusBannerBigPicItemData)localObject2).V = paramJSONObject.optString("store_lat");
                  ((ProteusBannerBigPicItemData)localObject2).X = paramJSONObject.optString("dist_desc");
                  ((ProteusBannerBigPicItemData)localObject2).Y = paramJSONObject.optString("corporate_image_name");
                  ((ProteusBannerBigPicItemData)localObject2).Z = paramJSONObject.optString("distance_limit");
                  localObject1 = localObject2;
                } while (TextUtils.isEmpty(((ProteusBannerBigPicItemData)localObject2).S));
                localObject1 = localObject2;
              } while (TextUtils.isEmpty(((ProteusBannerBigPicItemData)localObject2).T));
              localObject1 = localObject2;
            } while (TextUtils.isEmpty(((ProteusBannerBigPicItemData)localObject2).U));
            localObject1 = localObject2;
          } while (TextUtils.isEmpty(((ProteusBannerBigPicItemData)localObject2).W));
          localObject1 = localObject2;
        } while (TextUtils.isEmpty(((ProteusBannerBigPicItemData)localObject2).V));
        localObject1 = localObject2;
  ...
  public static Map<String, String> a(Context paramContext)
  {
    ...
    HashMap localHashMap = new HashMap();
    Object localObject1 = syz.a("native_article", true);
    if (localObject1 == null) {
      return localHashMap;
    }
    localObject1 = ((syz)localObject1).getTemplate("ReadInjoy_article_text_cell");
    if (localObject1 == null) {
      return localHashMap;
    }
  ...
  public static void a(ArticleInfo paramArticleInfo, ProteusItemData paramProteusItemData, int paramInt, SparseArray<Float> paramSparseArray)
  {
    ...
    for (;;)
    {
      ...
      float f1 = svu.b(paramSparseArray);
      continue;
      f1 = svu.c(paramSparseArray);
      continue;
      label164:
      float f2 = -1000.0F;
      f1 = f2;
  ...
  public static void a(ArticleInfo paramArticleInfo, tcn paramtcn)
  {
    if (paramArticleInfo == null) {
      return;
    }
    QLog.d("FastWebRequestUtil", 2, "deleteFeeds.");
    ThreadManager.excute(new FastWebRequestUtil.6(paramArticleInfo, paramtcn), 128, null, true);
  }
  ...
  private static void a(String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean, String paramString5, String paramString6, String paramString7, int paramInt1, long paramLong, swg paramswg, int paramInt2)
  {
    ThreadManager.executeOnNetWorkThread(new FastWebRequestUtil.4(paramString1, paramString2, paramString3, paramString4, paramString6, paramString7, paramBoolean, paramInt1, paramLong, paramString5, paramInt2, paramswg));
  }
  
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean, String paramString5, String paramString6, String paramString7, swf paramswf, int paramInt1, int paramInt2, long paramLong)
  {
    paramswf = new swe(paramString1, paramswf);
    a(paramString1, paramString2, paramString3, new swc(paramswf), paramInt2);
    a(paramString1, paramString2, paramString3, paramString4, paramBoolean, paramString5, paramString6, paramString7, paramInt1, paramLong, new swd(paramswf), paramInt2);
  }
  
  private static void a(String paramString1, String paramString2, String paramString3, swg paramswg, int paramInt)
  {
    ThreadManager.executeOnNetWorkThread(new FastWebRequestUtil.3(paramString1, paramString2, paramInt, paramswg));
  }
  ...
  private static void a(JSONObject paramJSONObject)
  {
    ...
    {
      localObject1 = new swa((String)localObject1, ssq.a(paramJSONObject));
      a(paramJSONObject, (swa)localObject1);
      localObject2 = ((swa)localObject1).b;
      ...
      if ((((swa)localObject1).b()) && (!TextUtils.isEmpty(((swa)localObject1).c)))
      {
        paramJSONObject.put("text", ((swa)localObject1).e);
    ...
    return;
    label165:
    if ((((swa)localObject1).a()) && (!TextUtils.isEmpty((CharSequence)localObject2)))
    {
      localObject2 = bhyo.a().b((String)localObject2);
      if (localObject2 == null)
      {
        paramJSONObject.put("text", ((swa)localObject1).f);
        paramJSONObject.put("label_ug_progress_progress", 0);
        return;
      }
      if (((DownloadInfo)localObject2).a() == 4)
      {
        paramJSONObject.put("text", ((swa)localObject1).g);
        paramJSONObject.put("label_ug_progress_progress", 100);
        return;
      }
      if ((((DownloadInfo)localObject2).a() == 20) || (((DownloadInfo)localObject2).a() == 1) || (((DownloadInfo)localObject2).a() == 2))
      {
        paramJSONObject.put("text", ((swa)localObject1).h + ((DownloadInfo)localObject2).f + "%");
        paramJSONObject.put("label_ug_progress_progress", ((DownloadInfo)localObject2).f);
        return;
      }
      paramJSONObject.put("text", ((swa)localObject1).j);
      paramJSONObject.put("label_ug_progress_progress", ((DownloadInfo)localObject2).f);
      return;
    }
    paramJSONObject.put("text", "");
  ...
  private static void a(JSONObject paramJSONObject, swa paramswa)
  {
    str2 = "";
    str1 = str2;
    ...
    oix.a(oix.a(paramswa.jdField_a_of_type_JavaLangString, str1, "1"));
  }
  
  private static String b(Map<String, String> paramMap, JSONObject paramJSONObject)
  {
    twp.a("REPORT_LINK", "requestAdData start");
    try
    {
      ...
      paramMap = ((QQAppInterface)pay.a()).getAccount();
      if (QLog.isColorLevel()) {
  ...
  private static List<BaseData> b(String paramString1, int paramInt, String paramString2)
  {
    ...
    try
    {
      ...
      if (i < localJSONArray.length())
      {
        ...
        Object localObject2 = syz.a("native_article", true);
        if (localObject2 != null) {}
        for (localObject2 = ((syz)localObject2).getTemplateBean(localJSONObject);; localObject2 = null)
        {
          if (localObject2 != null)
          {
  ...
  {
    paramString5 = (QQAppInterface)pay.a();
    ...
    for (paramString1 = "";; paramString1 = rtb.a(paramString6))
    {
      paramString5.put("token", paramString1);
      paramString5.put("cookie", obb.a());
      ...
      try
      {
        ...
        paramString5.put("noExposeList", nwz.a().a());
        return paramString5;
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject1 != null)
        {
          ...
          localJSONObject.put("carrier", absm.a(BaseApplicationImpl.getContext()));
          ...
          if (localObject1 != null)
          {
            ...
            localObject2 = "";
            localJSONObject.put("muid", localObject2);
            localJSONObject.put("bytes_wx_ver", tvv.a(BaseApplication.getContext()));
            if (QLog.isColorLevel()) {
  ...
  public static void b(ArticleInfo paramArticleInfo, tcn paramtcn)
  {
    if (paramArticleInfo == null) {
      return;
    }
    QLog.d("FastWebRequestUtil", 2, "shieldFeedSource");
    ThreadManager.excute(new FastWebRequestUtil.7(paramArticleInfo, paramtcn), 128, null, true);
  }
  ...
  private static void b(List<BaseData> paramList)
  {
    ...
    nwz.a().a("RIJAdRefreshSceneNativeArticle", localHashSet);
  }
  ...
  private static boolean b(String paramString1, String paramString2, List<BaseData> paramList, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        obb.a(((JSONObject)localObject).optString("cookie"));
        ...
        if (j < localJSONArray.length())
        {
          ...
          if (((JSONObject)localObject).isNull("ad_pos_type"))
          {
            ...
            localObject = a(two.a((JSONObject)localObject, paramJSONObject), 1, false, str, i, k);
            twr.a((AdData)localObject);
            if (localObject != null)
            {
          ...
          else
          {
            ...
            {
              ((JSONObject)localObject).put("rowkey", paramString2);
              localObject = a(two.a((JSONObject)localObject, paramJSONObject), 1, true, str, -1, k);
              twr.a((AdData)localObject);
              if (localObject == null) {
                break label439;
              }
    ...
    {
      ((JSONObject)localObject).put("rowkey", paramString2);
      localObject = a(two.a((JSONObject)localObject, paramJSONObject), 2, false, str, -1, k);
      if (localObject != null)
      {
