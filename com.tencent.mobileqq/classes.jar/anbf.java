...
public class anbf
{
  ...
  public void a()
  {
    this.jdField_a_of_type_JavaLangString = (amxa.a() + "ar_cloud_img/");
  ...
  public void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, ARRecognition paramARRecognition, anbg paramanbg)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_ARCloudPretreatmentManagert", 2, "[ScanStarFace]pretreatFaceRecogInfo,  FaceScanModelsLoader.hasFaceModelInit =  " + amxs.b);
    }
    if (!amxs.b)
    {
    ...
    localanbi.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    ...
    if (ancc.a != null)
    {
      if (ancc.a.hasMessages(4))
      {
        if (QLog.isColorLevel()) {
          QLog.d("AREngine_ARCloudPretreatmentManagert", 2, "[DEBUG_SCAN_yt_face] pretreatFaceRecogInfo, remove pending task");
        }
        ancc.a.removeMessages(4);
      }
      paramArrayOfByte = Message.obtain(ancc.a, new ARCloudPretreatmentManager.1(this, paramARRecognition, localFaceCluster, paramArrayOfByte, paramInt1, paramInt2));
      paramArrayOfByte.what = 4;
      if (ancc.a != null) {
        ancc.a.sendMessage(paramArrayOfByte);
      }
    }
    for (;;)
    {
      ...
      {
        localanbi.jdField_a_of_type_ArrayOfComTencentYTFaceModelFaceStatus = paramARRecognition;
        azqs.b(null, "dc00898", "", "", "0X800834C", "0X800834C", 0, 0, "", "", "", "");
      }
      paramanbg.a(localanbi);
      return;
      if (QLog.isColorLevel()) {
  ...
  public void a(byte[] paramArrayOfByte, ARRecognition paramARRecognition, anbg paramanbg)
  {
    paramArrayOfByte = new anbs();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramanbg.a(paramArrayOfByte);
  }
  
  public void a(byte[] paramArrayOfByte, ArrayList<ARRecognition> paramArrayList, anbg paramanbg, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramArrayOfByte.hasNext())
    {
      ...
      if (l3 == 1L) {
        a(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramanbg);
      }
      for (;;)
      {
        break;
        if (l3 == 2L)
        {
          b(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramanbg);
        }
        else if (l3 == 4L)
        {
          l1 = System.currentTimeMillis();
          a(this.jdField_a_of_type_ArrayOfByte, j, i, paramArrayList, paramanbg);
          l1 = System.currentTimeMillis() - l1;
        }
        else if (l3 == 64L)
        {
          d(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramanbg);
        }
        else if (l3 == 128L)
        {
          c(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramanbg);
        }
        else if (l3 == 2048L)
        {
          e(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramanbg);
        }
      }
    }
    paramArrayList = new YuvImage(this.jdField_a_of_type_ArrayOfByte, paramInt3, j, i, null);
    paramArrayOfByte = a();
    paramArrayOfByte = new anbh(this.jdField_a_of_type_JavaLangString, paramArrayOfByte, this.jdField_a_of_type_ArrayOfByte);
    ...
    anbz localanbz = anbz.a();
    localanbz.c = l1;
    localanbz.b = l2;
    l1 = paramArrayOfByte.jdField_a_of_type_ArrayOfByte.length / 8192;
    paramanbg.a(jdField_a_of_type_Int, paramArrayList, l1);
  }
  ...
  public void b(byte[] paramArrayOfByte, ARRecognition paramARRecognition, anbg paramanbg)
  {
    paramArrayOfByte = new anbj();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramanbg.a(paramArrayOfByte);
  }
  
  public void c(byte[] paramArrayOfByte, ARRecognition paramARRecognition, anbg paramanbg)
  {
    paramArrayOfByte = new anbj();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramanbg.b(paramArrayOfByte);
  }
  
  public void d(byte[] paramArrayOfByte, ARRecognition paramARRecognition, anbg paramanbg)
  {
    paramArrayOfByte = new anbk();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramanbg.a(paramArrayOfByte);
  }
  
  public void e(byte[] paramArrayOfByte, ARRecognition paramARRecognition, anbg paramanbg)
  {
    paramArrayOfByte = new anbl();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramanbg.a(paramArrayOfByte);
  }
}
