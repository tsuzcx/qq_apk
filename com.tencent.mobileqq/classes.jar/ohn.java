...
public class ohn
{
  private static String a(String paramString1, String paramString2)
  {
    ...
    paramString1 = ohm.a(paramString1, ohm.a(paramString2), false);
  ...
  public static void a(Context paramContext, int paramInt, String paramString)
  {
    ...
    try
    {
      bool = ohm.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
      localIntent.putExtra("req_qgg_title", bool);
      localIntent.putExtra("req_qgg_hide_tab", false);
      localIntent.putExtra("big_brother_source_key", ugf.b("3046055438"));
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localIntent.putExtra("leftViewText", paramContext.getString(2131690599));
  ...
  private static void a(QQAppInterface paramQQAppInterface, int paramInt, Context paramContext, String paramString1, boolean paramBoolean, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      localObject = ((ohh)localObject).a(paramInt);
      if (localObject == null)
      {
        a(paramContext, "3046055438", paramString1, true);
        return;
      }
      str = ohq.a(((ohi)localObject).b, paramString3);
      if ((!StringUtil.isEmpty(str)) && ((str.startsWith("http")) || (str.startsWith("https")) || (MiniAppLauncher.isMiniAppUrl(str)))) {
        break;
      }
    } while (((ohi)localObject).a != 1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    try
    {
      if (bfwk.a(paramQQAppInterface.getMessageFacade().getAIOList("3046055438", 1008)))
      {
        str1 = str4;
        str2 = str4;
        ...
        str1 = "1";
        ohq.a(paramQQAppInterface, "gouwu.aio.click", str1, NetConnInfoCenter.getServerTimeMillis() + "", paramContext);
        if (i <= 0) {
          break label249;
        }
      }
      for (str1 = "1";; str1 = "0")
      {
        ohq.b(paramQQAppInterface, "gouwu_aio_click", str1, NetConnInfoCenter.getServerTimeMillis() + "", paramContext);
        return;
        str1 = str4;
        str2 = str4;
        ...
        if (localMessageRecord == null)
        {
          str1 = str4;
          str2 = str4;
          a(paramContext, "3046055438", paramContext.getResources().getString(2131691722), true);
          paramContext = "";
          break;
        }
        str1 = str4;
        str2 = str4;
        str4 = ohm.a(localMessageRecord);
        str1 = str4;
        str2 = str4;
        b(paramQQAppInterface, paramContext, localMessageRecord, ohl.b(paramQQAppInterface, ohm.b(localMessageRecord)), "", ohm.c(localMessageRecord));
        paramContext = str4;
        break;
        str1 = "0";
        break label70;
    ...
    catch (Throwable localThrowable)
    {
      ...
      {
        paramContext = "1";
        ohq.a(paramQQAppInterface, "gouwu.aio.click", paramContext, NetConnInfoCenter.getServerTimeMillis() + "", str1);
        if (i <= 0) {
          break label371;
        }
      }
      ...
      {
        ohq.b(paramQQAppInterface, "gouwu_aio_click", paramContext, NetConnInfoCenter.getServerTimeMillis() + "", str1);
        return;
        paramContext = "0";
        break;
      }
    ...
    ohq.a(paramQQAppInterface, "gouwu.aio.click", paramContext, NetConnInfoCenter.getServerTimeMillis() + "", str3);
    if (i > 0) {}
    for (paramContext = "1";; paramContext = "0")
    {
      ohq.b(paramQQAppInterface, "gouwu_aio_click", paramContext, NetConnInfoCenter.getServerTimeMillis() + "", str3);
      throw localObject;
      label468:
      paramContext = "0";
      break;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt, String paramString1, boolean paramBoolean, String paramString2, String paramString3)
  {
    ...
    if (paramInt == 0) {
      if ((!StringUtil.isEmpty(str)) && (!StringUtil.isEmpty(ohm.a())))
      {
        paramQQAppInterface = new HashMap();
        paramQQAppInterface.put("prompt_id", str);
        paramQQAppInterface = ohm.a(paramString1, paramQQAppInterface, false);
      }
    }
    for (;;)
    {
      ...
      try
      {
        ...
        paramString3.putExtra("big_brother_source_key", ugf.b("3046055438"));
  ...
  {
    ohm.a(paramMessageRecord.uniseq, paramInt + 1);
    ...
    paramMessageRecord.putExtra("uinname", paramContext.getResources().getString(2131691722));
    paramMessageRecord.putExtra("leftViewText", paramContext.getString(2131690599));
    paramMessageRecord.putExtra("jump_minusonescreen_view", true);
    paramContext.startActivity(paramMessageRecord);
    ohq.a(paramQQAppInterface, "gouwu.fyp.show", "", NetConnInfoCenter.getServerTimeMillis() + "", "");
    ohq.b(paramQQAppInterface, "gouwu_fyp_show", "", NetConnInfoCenter.getServerTimeMillis() + "", "");
  }
  ...
  {
    int i = ohm.a(paramMessageRecord.uniseq);
    if (i >= ohm.a(paramQQAppInterface, paramString1))
    {
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext, MessageRecord paramMessageRecord, String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        int i = ohm.b(paramMessageRecord);
      ...
      catch (Exception paramMessageRecord)
      {
        try
        {
          paramMessageRecord = ohm.c(paramMessageRecord);
          ...
          a(paramQQAppInterface, paramInt, paramContext, paramContext.getResources().getString(2131691722), bool, paramMessageRecord, paramString2);
          return;
        }
        catch (Exception paramMessageRecord)
        {
  ...
  {
    paramString1 = ohl.a(paramQQAppInterface, paramString1, "redirectScheme");
    ...
    try
    {
      paramString1 = ohq.a(URLDecoder.decode(paramString1, "UTF-8"), paramString2);
      str = ohl.a(paramString1);
      if (QLog.isColorLevel()) {
      ...
      if ((paramString1.startsWith("http")) || (paramString1.startsWith("https")))
      {
        ...
        paramQQAppInterface.putExtra("big_brother_source_key", ugf.b("3046055438"));
    ...
    try
    {
      i = Integer.parseInt(ohl.a(paramString1, "tabId"));
