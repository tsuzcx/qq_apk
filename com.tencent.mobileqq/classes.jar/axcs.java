  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          paramFromServiceMsg = bgxt.a(paramFromServiceMsg.getWupBuffer(), new int[1]);
          if (paramFromServiceMsg != null)
          {
            if ((getAppRuntime() != null) && (getAppRuntime().getApplication() != null))
            {
              ...
              {
                paramIntent = null;
                bhby.a(localMobileQQ, bool, paramIntent);
              }
            }
            else
            {
              ...
              notifyObserver(null, 1004, true, paramIntent, atzq.class);
              return;
            }
          ...
          notifyObserver(null, 1004, false, new Bundle(), atzq.class);
          return;
        }
      }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    bgxt localbgxt = new bgxt(l, (Map)localObject);
    localObject = localbgxt.encode();
    paramIntent = (Intent)localObject;
    if (localObject == null)
    {
      QLog.e("NotifyQZoneServer", 1, "onSend request encode result is null.cmd=" + localbgxt.uniKey());
