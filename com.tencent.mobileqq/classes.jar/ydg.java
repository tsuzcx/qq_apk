...
public class ydg
{
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfInt = new int[] { 2130839579, 2130839589, 2130839586, 2130839580, 2130839581, 2130839576, 2130839582, 2130839585, 2130839584, 2130839587, 2130839588, 2130837868, 2130837869, 2130837870, 2130837872, 2130837876, 2130837878, 2130837879, 2130837880, 2130837883, 2130837890, 2130837900, 2130837901, 2130839595, 2130839599, 2130839591, 2130839592, 2130839597, 2130839594, 2130839600, 2130839558, 2130839561, 2130839562, 2130839563, 2130839564, 2130839565, 2130839566, 2130839567, 2130839568, 2130839569, 2130839570, 2130839571, 2130839572, 2130839574, 2130839575 };
  ...
  private static void c()
  {
    if (jdField_c_of_type_JavaUtilHashMap == null)
    {
      ...
      int j = 0;
      while (j < bjwo.e.length)
      {
        jdField_c_of_type_JavaUtilHashMap.put(bjwo.e[j], Integer.valueOf(j));
        j += 1;
      }
    }
  }
