...
public class ocr
{
  private static final Map<String, ocr> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  public static ocr a(String paramString)
  {
    if (paramString == null) {
      return null;
    }
    return (ocr)jdField_a_of_type_JavaUtilMap.get(paramString);
  }
  
  private static ocr a(String paramString, boolean paramBoolean)
  {
    ocr localocr2 = a(paramString);
  ...
  public static void a(String paramString, ocr paramocr)
  {
    if ((paramString == null) || (paramocr == null)) {
      return;
    }
    jdField_a_of_type_JavaUtilMap.put(paramString, paramocr);
  }
  ...
  public void b()
  {
    ...
    aciy.a("", "", new IllegalArgumentException());
  }
