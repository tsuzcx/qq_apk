...
{
  bmdb jdField_a_of_type_Bmdb;
  
  public bmdd(bmda parambmda, bmdb parambmdb)
  {
    this.jdField_a_of_type_Bmdb = parambmdb;
  }
  
  public void onDownloadCanceled(String paramString)
  {
    paramString = Message.obtain(this.jdField_a_of_type_Bmda.a, 2);
    paramString.obj = this.jdField_a_of_type_Bmdb;
    paramString.sendToTarget();
  }
  
  public void onDownloadFailed(String paramString, DownloadResult paramDownloadResult)
  {
    paramString = Message.obtain(this.jdField_a_of_type_Bmda.a, 3);
    paramString.obj = this.jdField_a_of_type_Bmdb;
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramDownloadResult != null)
        {
          ...
          this.jdField_a_of_type_Bmdb.jdField_a_of_type_Int = paramDownloadResult.retCode;
        }
      }
  ...
  public void onDownloadProgress(String paramString, long paramLong, float paramFloat)
  {
    ...
    if (this.jdField_a_of_type_Bmdb != null) {
      this.jdField_a_of_type_Bmdb.jdField_a_of_type_Float = i;
    }
    paramString = Message.obtain(this.jdField_a_of_type_Bmda.a, 5);
    paramString.obj = this.jdField_a_of_type_Bmdb;
    paramString.sendToTarget();
  }
  ...
  public void onDownloadSucceed(String paramString, DownloadResult paramDownloadResult)
  {
    ...
    paramString = Message.obtain(this.jdField_a_of_type_Bmda.a, 4);
    paramString.obj = this.jdField_a_of_type_Bmdb;
    paramString.sendToTarget();
  }
}
