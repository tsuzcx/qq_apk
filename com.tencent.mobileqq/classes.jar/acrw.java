...
public class acrw
{
  public static int a(Context paramContext, AdAppBtnData paramAdAppBtnData)
  {
    ...
    do
    {
      ...
      paramContext = bisa.a().b(paramAdAppBtnData);
  ...
  public static int a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      {
        return -1;
        paramContext = bisa.a().b(paramString2);
  ...
  {
    anvf.a("scheme", paramString1, paramString2, "4", "gdtAppAd", paramContext.getClass().getName());
  }
  ...
  public static void a(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject5 = biqd.a(str);
        localObject4 = (String)((HashMap)localObject5).get("appid");
        localObject1 = localObject4;
        localObject3 = str;
        if (TextUtils.isEmpty((CharSequence)localObject4))
        {
          localObject1 = (String)((HashMap)localObject5).get(bivp.b);
          localObject3 = str;
        }
        str = biqd.g() + File.separator + "qapp_center_detail.htm";
        ...
        if ("1".equals((String)biqd.a(paramBundle.getString("schemaUrl")).get("auto_download")))
        {
          localObject3 = localObject1;
      ...
      continue;
      label456:
      localObject2 = biqd.m() + File.separator + "qapp_center_detail.htm";
      continue;
      label487:
  ...
  public static void a(GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    {
      ((acqz)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(110)).a(BaseApplicationImpl.getContext(), paramGdtBaseAdItem);
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    {
      localTMAssistantDownloadTaskInfo2 = bisa.a().a(localDownloadInfo.d);
      ...
      {
        localTMAssistantDownloadTaskInfo1 = bisa.a().a(localDownloadInfo);
        localObject = paramContext;
      }
    }
    for (;;)
    {
      ...
      localObject = paramContext;
      break;
      localTMAssistantDownloadTaskInfo2 = bisa.a().a(localDownloadInfo);
      paramContext = (Context)localObject;
      if (localTMAssistantDownloadTaskInfo2 != null)
      {
        paramContext = (Context)localObject;
      ...
      if (TextUtils.isEmpty(paramContext))
      {
        localTMAssistantDownloadTaskInfo1 = bisa.a().a(localDownloadInfo.d);
        localObject = paramContext;
      }
    }
  }
  ...
  public static boolean b(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    try
    {
      ...
      bool2 = true;
      bool1 = bool3;
      acrm.a(138, paramGdtBaseAdItem.d, paramGdtBaseAdItem.e);
      bool1 = bool3;
      a(paramContext, paramGdtBaseAdItem.b, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString);
      bool1 = bool3;
      acqy.a("GdtAppOpenUtil", "launchAPPMain report " + paramGdtBaseAdItem.toString());
      bool1 = bool2;
      return bool1;
    }
    catch (Exception paramContext)
    {
      acqy.d("GdtAppOpenUtil", "launchApp failed", paramContext);
    }
    return bool1;
  }
  ...
  private static boolean c(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    if (a(paramContext, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString, paramGdtBaseAdItem.c))
    {
      ...
      try
      {
        ...
        bool2 = true;
        bool1 = bool3;
        acrm.a(137, paramGdtBaseAdItem.d, paramGdtBaseAdItem.e);
        bool1 = bool3;
        a(paramContext, paramGdtBaseAdItem.b, paramGdtBaseAdItem.jdField_a_of_type_JavaLangString);
        bool1 = bool3;
        acqy.a("GdtAppOpenUtil", "launchAPPDeepLink report " + paramGdtBaseAdItem.toString());
        bool1 = bool2;
        return bool1;
      }
      catch (Exception paramContext)
      {
        acqy.d("GdtAppOpenUtil", "launchAPPDeepLink failed", paramContext);
        return bool1;
      }
    }
    acqy.a("GdtAppOpenUtil", "launchAPPDeepLink isDLURISupported false");
    return false;
  }
}
