  ...
  implements DialogInterface.OnDismissListener, View.OnClickListener
{
  ...
  private zfa jdField_a_of_type_Zfa;
  ...
  public umb(Activity paramActivity)
  {
    super(paramActivity, 2131755410);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2131560001, null);
    b();
    setCancelable(true);
  ...
  private ulh a()
  {
    if (this.jdField_a_of_type_Ulh == null) {
      this.jdField_a_of_type_Ulh = new ulh();
    }
    return this.jdField_a_of_type_Ulh;
  }
  ...
  private void c()
  {
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131365174));
    ...
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.setOnInputBackListener(new umc(this));
    ...
    this.jdField_c_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131363858));
    this.jdField_c_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    this.d = ((ImageButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131363840));
    ...
    uya.b("CommentInputPopupWindow", 1, "mEmojiPanel initView() step1 :" + this.jdField_a_of_type_Int);
    if (this.jdField_a_of_type_Int == 0)
    {
      this.jdField_a_of_type_Int = ScreenUtil.dip2px(250.0F);
      uya.b("CommentInputPopupWindow", 1, "mEmojiPanel initView() step2 :" + this.jdField_a_of_type_Int);
    }
    ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_AndroidViewView.findViewById(2131365955);
    ...
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new umd(this));
  ...
  private void e()
  {
    ...
    uya.b("CommentInputPopupWindow", 1, "mEmojiPanel onGetKeyBoardHeight() :" + this.jdField_a_of_type_Int);
  }
  
  private void f()
  {
    this.jdField_a_of_type_Zhd = new zhd(this.jdField_a_of_type_AndroidViewView);
    this.jdField_a_of_type_Zhd.a(new ume(this));
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.setOnFocusChangeListener(new umf(this));
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.setOnEditorActionListener(new umg(this));
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.addTextChangedListener(new umh(this));
  }
  ...
  public void a(zfa paramzfa)
  {
    this.jdField_a_of_type_Zfa = paramzfa;
  }
  ...
  {
    uya.b("CommentInputPopupWindow", 1, "onClick:" + paramView.getId());
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.length() > this.jdField_c_of_type_Int) {
        QQToast.a(getContext(), amtj.a(2131701329) + this.jdField_c_of_type_Int + amtj.a(2131701330), 0).a();
      }
      ...
      a(0, 8);
      continue;
      uya.b("CommentInputPopupWindow", 1, "btn_emotion");
      b(false);
      a(0, 8);
      continue;
      uya.b("CommentInputPopupWindow", 1, "text_input");
      a(true);
      a(8, 0);
      continue;
      if (this.jdField_a_of_type_Zfa != null)
      {
        this.jdField_a_of_type_Zfa.a();
        continue;
        uya.b("CommentInputPopupWindow", 1, "btn_keyboard");
        a(true);
        a(8, 0);
      }
    }
