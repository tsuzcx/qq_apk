  ...
  implements Animatable
{
  ...
  Property<bknw, Integer> jdField_a_of_type_AndroidUtilProperty = new bknx(this, Integer.class, "bfIndex");
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<bkoc> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  Property<bknw, Integer> jdField_b_of_type_AndroidUtilProperty = new bkny(this, Integer.class, "textAlpha");
  ...
  Property<bknw, Float> jdField_c_of_type_AndroidUtilProperty = new bknz(this, Float.class, "textPos");
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bkoa(this));
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bkob(this));
  ...
  private void b(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put("1/2", paramContext.getResources().getDrawable(2130841063));
    this.jdField_a_of_type_JavaUtilMap.put("1/4", paramContext.getResources().getDrawable(2130841064));
    this.jdField_a_of_type_JavaUtilMap.put("1x", paramContext.getResources().getDrawable(2130841065));
    this.jdField_a_of_type_JavaUtilMap.put("2x", paramContext.getResources().getDrawable(2130841066));
    this.jdField_a_of_type_JavaUtilMap.put("4x", paramContext.getResources().getDrawable(2130841067));
    this.jdField_a_of_type_JavaUtilMap.put(PickerContainer.jdField_a_of_type_JavaLangString, paramContext.getResources().getDrawable(2130841090));
    this.jdField_b_of_type_JavaUtilMap.put("1/2", paramContext.getResources().getDrawable(2130841107));
    this.jdField_b_of_type_JavaUtilMap.put("1/4", paramContext.getResources().getDrawable(2130841108));
    this.jdField_b_of_type_JavaUtilMap.put("1x", paramContext.getResources().getDrawable(2130841109));
    this.jdField_b_of_type_JavaUtilMap.put("2x", paramContext.getResources().getDrawable(2130841110));
    this.jdField_b_of_type_JavaUtilMap.put("4x", paramContext.getResources().getDrawable(2130841111));
    this.jdField_b_of_type_JavaUtilMap.put(PickerContainer.jdField_a_of_type_JavaLangString, paramContext.getResources().getDrawable(2130841112));
  }
  ...
  private void c(int paramInt)
  {
    ...
    do
    {
      ...
      localbkoc = (bkoc)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localbkoc == null);
    localbkoc.a(this.jdField_c_of_type_Int, this.jdField_a_of_type_Int, this.jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable.getNumberOfFrames());
  }
  ...
  public boolean a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, bkoc parambkoc)
  {
    b();
    a(paramContext);
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambkoc);
    b(paramContext);
