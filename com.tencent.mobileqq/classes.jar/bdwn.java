...
public class bdwn
{
  ...
  public static bdwn a(String paramString1, String paramString2, String paramString3)
  {
    bdwn localbdwn = new bdwn();
    localbdwn.jdField_a_of_type_JavaLangString = "2";
    localbdwn.g = paramString3.substring(0, paramString3.lastIndexOf("/") + 1);
    localbdwn.h = paramString3.substring(paramString3.lastIndexOf("/") + 1);
    localbdwn.b = paramString1;
    localbdwn.c = paramString2;
    localbdwn.jdField_a_of_type_Long = System.currentTimeMillis();
    QLog.i("NowDownloadTaskInfo", 4, localbdwn.toString());
    return localbdwn;
  }
