...
{
  public admk(ChatActivityFacade.3 param3) {}
  ...
  public void a(VSBaseRequest paramVSBaseRequest, boolean paramBoolean, long paramLong, String paramString, FeedCloudRead.StGetC2CFeedRsp paramStGetC2CFeedRsp)
  {
    if (paramBoolean) {
      if (paramStGetC2CFeedRsp != null)
      {
        ...
        admh.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramStGetC2CFeedRsp, this.a.jdField_a_of_type_Boolean);
        if ((paramStGetC2CFeedRsp.attchInfo != null) && (!StringUtil.isEmpty(paramStGetC2CFeedRsp.attchInfo.get()))) {
          admh.c(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramStGetC2CFeedRsp.attchInfo.get());
        }
      }
    }
    for (;;)
