...
public class arxa
  extends arum
{
  private URLDrawableDownListener.Adapter jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new arxb(this);
  ...
  public arxa(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  private void G()
  {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        ...
        aeif.a(this.jdField_a_of_type_AndroidAppActivity, (Intent)localObject, str);
      }
    }
  ...
  private boolean a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (;;)
    {
      ...
      {
        azqj localazqj = (azqj)paramAbsStructMsg.get(j);
  ...
  private View b()
  {
    ...
    for (;;)
    {
      ...
      if (j != 0)
      {
        ...
        ((ImageView)localObject2).setImageResource(2130839708);
        LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(bdkf.a(8.0F), bdkf.a(14.0F));
        localLayoutParams.setMargins(bdkf.a(7.0F), 0, 0, 0);
        ...
        ((View)localObject2).setBackgroundResource(2130839718);
        localFrameLayout.addView((View)localObject2, new FrameLayout.LayoutParams(-1, bdkf.a(33.0F), 16));
        ((View)localObject2).setOnClickListener(new arxc(this));
        ((View)localObject2).setContentDescription(alpo.a(2131705146));
      }
      ...
      if ((localObject1 != null) && ((this.jdField_a_of_type_Bdfq instanceof arwl))) {
        ((arwl)this.jdField_a_of_type_Bdfq).a((String)localObject1);
      }
  ...
  private void b(bdfq parambdfq)
  {
    int k = 1;
    parambdfq.setBodyLayoutNoMargin();
    Object localObject1 = new URLImageView(this.jdField_a_of_type_AndroidAppActivity);
    Object localObject2 = new LinearLayout.LayoutParams(-1, aekt.a(152.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
    ...
    {
      ((LinearLayout.LayoutParams)localObject2).leftMargin = aekt.a(24.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      ((LinearLayout.LayoutParams)localObject2).rightMargin = aekt.a(24.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    }
    ...
    Object localObject3 = akdo.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, "cover");
    Drawable localDrawable = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130849786);
    if (!TextUtils.isEmpty((CharSequence)localObject3))
    {
      localObject3 = URLDrawable.getDrawable((String)localObject3, (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131296779), aekt.a(165.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), localDrawable, localDrawable, true);
    ...
    for (;;)
    {
      ...
      localObject1 = akdo.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, "title");
      ...
      ((TextView)localObject2).setPadding(aekt.a(24.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), aekt.a(8.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), aekt.a(24.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), aekt.a(20.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
      parambdfq.addView((View)localObject2);
      return;
      ((URLImageView)localObject1).setScaleType(ImageView.ScaleType.CENTER_INSIDE);
  ...
  private void e()
  {
    int j = 1;
    if (c() != 0) {}
    for (Object localObject1 = this.jdField_a_of_type_Bdfq.getInputValue();; localObject1 = "")
    {
      ...
      {
        localObject2 = aekt.a(new Intent(this.jdField_a_of_type_AndroidAppActivity, SplashActivity.class), new int[] { 2 });
        ...
        {
          localObject3 = azqu.a(((Intent)localObject2).getExtras());
          Object localObject5;
          Object localObject6;
          ...
          while (((Iterator)localObject4).hasNext())
          {
            ...
            aeyf.a().a((SessionInfo)localObject6, (String)localObject1, k);
            bdir.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((ResultRecord)localObject5).a, ((SessionInfo)localObject6).b, ((ResultRecord)localObject5).a(), (AbsStructMsg)localObject3, null);
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          else if (arwv.a((Intent)localObject2))
          {
            localObject3 = ForwardUtils.a((Intent)localObject2, ((ResultRecord)localObject3).a, ((ResultRecord)localObject3).a(), ((ResultRecord)localObject3).c);
            ForwardUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (SessionInfo)localObject3, (Intent)localObject2);
          }
      ...
      for (;;)
      {
        ...
        default: 
          ...
          if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("k_struct_forward", false))
          {
            ...
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005456", "0X8005456", 0, 0, (String)localObject4, (String)localObject2, (String)localObject3, "" + j);
          }
        ...
        for (;;)
        {
          ...
          {
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", this.jdField_a_of_type_AndroidOsBundle.getString("uin"), "Music_gene", "Music_gene_send", 0, 1, 0, "", "", "", "");
          }
        }
        v();
        return;
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("isWebCompShare", false))
    {
      ...
      localBundle.putString("intext_1", "" + bfdw.a(this.jdField_d_of_type_Int));
      localBundle.putString("intext_2", "" + bfdw.a(paramBundle.getInt("uintype"), paramBundle.getString("uin")));
      localBundle.putString("intext_3", "1");
      bfdq.a().a(localBundle, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
    }
  ...
  public void a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (;;)
    {
      ...
      if ((paramAbsStructMsg != null) && (paramAbsStructMsg.size() != 0))
      {
        ...
        } while (!(localObject1 instanceof aztc));
        for (paramAbsStructMsg = (aztc)localObject1;; paramAbsStructMsg = null)
        {
          if (paramAbsStructMsg == null) {
            break label466;
          }
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            paramAbsStructMsg = (azvd)localObject2;
          }
          for (;;)
          {
            break label102;
            ...
            if (j < localStringBuilder.length())
            {
              ...
              if ('ÿ' == localStringBuilder.charAt(j))
              {
                ...
                if (j + 3 < localStringBuilder.length())
                {
                  ...
                  arrayOfInt = apih.a((char[])localObject1);
                  localObject2 = baig.c;
                  if (localaube == null) {
                    break label454;
                  }
            ...
            for (localObject1 = localaube.a(Integer.toString(arrayOfInt[0]), Integer.toString(arrayOfInt[1]));; localObject1 = null)
            {
              if (localObject1 != null) {}
  ...
  public boolean a()
  {
    ...
    Object localObject = azqu.a(this.jdField_a_of_type_AndroidOsBundle.getByteArray("stuctmsg_bytes"));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((Bundle)localObject).putString("intext_1", "" + bfdw.a(this.jdField_d_of_type_Int));
        ((Bundle)localObject).putString("intext_3", "1");
        bfdq.a().a((Bundle)localObject, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
        return true;
  ...
  protected boolean a(bdfq parambdfq)
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject instanceof StructMsgForAudioShare)) {
        localLayoutParams.setMargins(0, aekt.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, aekt.a(10.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
      }
      ...
      parambdfq.addView(((AbsStructMsg)localObject).getPreDialogView(this.jdField_a_of_type_AndroidAppActivity, null), localLayoutParams);
      if (!bool) {
        a(((AbsStructMsg)localObject).getSourceName(), parambdfq);
      }
    }
    return true;
  }
  ...
  protected int d()
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (biqt.a(str).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null))) {}
    for (int j = 0;; j = -1)
    {
      if (j == 0) {
  ...
  protected void d()
  {
    ...
    if (this.jdField_a_of_type_AndroidOsBundle.getInt("uintype") == 1)
    {
      ...
      if (((bcjl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a((String)localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()))
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131697832, 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298914));
        return;
      }
    }
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("isWebCompShare", false))
    ...
    for (Object localObject1 = this.jdField_a_of_type_Bdfq.getInputValue();; localObject1 = "")
    {
      ...
      if (((Boolean)localObject2).booleanValue())
      {
        ...
        if (((Boolean)localObject3).booleanValue())
        {
          ...
          aeyf.a().a((SessionInfo)localObject4, (String)localObject1, j);
          bdir.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidOsBundle.getString("uin"), ((SessionInfo)localObject4).b, this.jdField_a_of_type_AndroidOsBundle.getInt("uintype"), (AbsStructMsg)localObject3, null);
          if (!TextUtils.isEmpty((CharSequence)localObject1)) {
            nav.a().a = true;
          }
          localObject1 = new Intent();
  ...
  {
    super.r();
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007C3A", "0X8007C3A", 0, 0, "1", "", "", "");
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("k_struct_forward", false)) {
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005457", "0X8005457", 0, 0, "", "", "android", "");
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl.startsWith("http://article.mp.qq.com")) || (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl.startsWith("http://post.mp.qq.com")))
    {
