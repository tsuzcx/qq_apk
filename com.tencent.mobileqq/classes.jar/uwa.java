  ...
  implements IEventReceiver, tck
{
  ...
  public ArrayList<uxp> a;
  private HashMap<String, String> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  public Map<String, String> a;
  private AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private ssm<String, FeedItem> jdField_a_of_type_Ssm = new ssm(300);
  public teu a;
  private ujo jdField_a_of_type_Ujo = new ujo("feeItem");
  private uvl jdField_a_of_type_Uvl = new uvl();
  public uvw a;
  private uwd jdField_a_of_type_Uwd;
  private uwe jdField_a_of_type_Uwe;
  public boolean a;
  public int b;
  private ConcurrentHashMap<String, tef> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  public uvw b;
  ...
  {
    paramString = tcz.a(QQStoryContext.a().a().createEntityManager(), FeedEntry.class, FeedEntry.class.getSimpleName(), FeedEntry.queryFeedId(), new String[] { paramString });
  ...
  private static FeedItem a(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    Object localObject2 = localuwa.a(paramString1, paramString2);
    veg.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "find true feedId:%s", localObject2);
    Object localObject1 = localObject2;
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
      localObject1 = VideoListFeedItem.makeFakeFeedId(paramString1, paramString2);
      veg.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "make fake feedId:%s", localObject1);
    }
    localObject2 = localuwa.a((String)localObject1);
    ...
    {
      localuwa.a(paramString1);
      veg.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "save fake item %s", paramString1.feedId);
  ...
  public static ShareGroupFeedItem a(String paramString1, String paramString2)
  {
    ...
    {
      vxs.a("feed type wrong for shareGroupItem:%s", new Object[] { paramString1 });
      return null;
    }
  ...
  private void a(tlz paramtlz)
  {
    veg.a("Q.qqstory.home.data.FeedManager", "request feed item list from net, %s", paramtlz.b);
    syr.a().a(paramtlz, new uwc(this));
  }
  ...
  {
    tjq.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    twg.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
  }
  
  public FeedItem a(FeedItem paramFeedItem)
  {
    veg.a("Q.qqstory.home.data.FeedManager", "save feed item %s", paramFeedItem.feedId);
    paramFeedItem = (FeedItem)this.jdField_a_of_type_Ssm.a(paramFeedItem.feedId, paramFeedItem);
  ...
  public FeedItem a(String paramString)
  {
    ...
    {
      veg.e("Q.qqstory.home.data.FeedManager", "feedId is null,you cant queryFeedItem:" + vyg.a(3));
      localObject = null;
    }
    do
    {
      return localObject;
      localFeedItem = (FeedItem)this.jdField_a_of_type_Ssm.a(paramString);
    ...
    {
      veg.e("Q.qqstory.home.data.FeedManager", "这种类型目前还不支持：" + ((FeedEntry)localObject).type);
      return null;
    }
    localFeedItem.covertFromEntry((FeedEntry)localObject);
    return (FeedItem)this.jdField_a_of_type_Ssm.a(paramString, localFeedItem);
  }
  ...
  {
    veg.a("Q.qqstory.home.data.FeedManager", "query my feedId unionId:%s, date:%s %s", paramString1, paramString2, this.jdField_a_of_type_JavaUtilHashMap);
  ...
  public List<String> a()
  {
    ...
    Object localObject = tcz.a(QQStoryContext.a().a().createEntityManager(), FeedIdListEntry.class, FeedIdListEntry.class.getSimpleName(), null, null);
    if (localObject == null) {
  ...
  {
    return ((tcz)tdc.a(5)).a(paramString, 0, paramList, paramBoolean);
  }
  ...
  public List<FeedItem> a(List<FeedItem> paramList)
  {
    ...
    try
    {
      ...
      while (paramList.hasNext())
      {
        ...
        localFeedItem = (FeedItem)this.jdField_a_of_type_Ssm.a(localFeedItem.feedId, localFeedItem);
        localaukn.b(localFeedItem.covertToEntry());
  ...
  public tef a(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    tef localtef = (tef)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (this.jdField_a_of_type_Uwe == null)
    {
      this.jdField_a_of_type_Uwe = new uwe(this);
      ste.a().registerSubscriber(this.jdField_a_of_type_Uwe);
    }
    new tjq(Collections.singletonList(paramString), true).a();
    veg.a("Q.qqstory.home.data.FeedManager", "request feed feature : %s", paramString);
    return localtef;
  }
  
  public uvl a()
  {
    return this.jdField_a_of_type_Uvl;
  }
  
  public void a()
  {
    this.jdField_a_of_type_Uwd = new uwd(this);
    ste.a().registerSubscriber(this.jdField_a_of_type_Uwd);
  }
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Ssm.a(paramString);
  }
  
  public void a(String paramString1, String paramString2, String paramString3)
  {
    this.jdField_a_of_type_JavaUtilHashMap.put(paramString1 + paramString2, paramString3);
    veg.a("Q.qqstory.home.data.FeedManager", "save my feedId %s", this.jdField_a_of_type_JavaUtilHashMap);
  }
  
  public void a(List<uvs> paramList)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      uvs localuvs = (uvs)paramList.next();
      this.jdField_a_of_type_JavaUtilHashMap.put(localuvs.b + localuvs.c, localuvs.a);
    }
  }
  ...
  public void a(List<String> paramList, boolean paramBoolean)
  {
    ...
    try
    {
      localaukn.a(FeedIdListEntry.class);
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        ...
        localaukn.b(localFeedIdListEntry);
      }
    }
    finally
    {
  ...
  public boolean a(String paramString)
  {
    ...
    return localaukn.a(localFeedIdListEntry, "feedId=?", new String[] { paramString });
  }
  
  public boolean a(String paramString1, String paramString2)
  {
    ArrayList localArrayList = new ArrayList();
    List localList = tcz.a(QQStoryContext.a().a().createEntityManager(), FeedIdListEntry.class, FeedIdListEntry.class.getSimpleName(), null, null);
    if (localList == null) {
      return false;
    }
    int i = 0;
  ...
  {
    veg.a("Q.qqstory.home.position", "disableAutoRefresh mIsFirstTimeUse:%b, fromOldLeba:%b, hasRedPoint:%b, mLastViewTime:%d", Boolean.valueOf(this.jdField_b_of_type_Boolean), Boolean.valueOf(paramBoolean1), Boolean.valueOf(paramBoolean2), Long.valueOf(this.jdField_a_of_type_Long));
    if ((!this.jdField_b_of_type_Boolean) && (paramBoolean1) && (!paramBoolean2) && (this.jdField_a_of_type_Long > 0L))
    {
      ...
      long l2 = ((Long)((tcv)tdc.a(10)).b("key_disable_auto_refresh_time", Long.valueOf(60000L))).longValue();
      veg.a("Q.qqstory.home.position", "disableAutoRefresh duration:%d, severConfigTime:%d", Long.valueOf(l1), Long.valueOf(l2));
      if (l1 < l2)
      {
  ...
  public FeedItem b(String paramString)
  {
    ...
    return (FeedItem)this.jdField_a_of_type_Ssm.a(paramString);
  }
  
  public List<String> b()
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject = tcz.a(QQStoryContext.a().a().createEntityManager(), TroopAssistantFeedIdListEntry.class, TroopAssistantFeedIdListEntry.class.getSimpleName(), null, null);
    if (localObject == null) {
      return localArrayList;
    }
    localObject = ((List)localObject).iterator();
  ...
  public List<uxp> b(List<String> paramList)
  {
    ArrayList localArrayList = new ArrayList(paramList.size());
    ...
    while (localIterator.hasNext())
    {
      ...
      Object localObject = (FeedItem)this.jdField_a_of_type_Ssm.a(str);
      ...
      if (localObject == null)
      {
        ...
        if (localObject != null)
        {
          ...
          else
          {
            ...
            this.jdField_a_of_type_Ssm.a(str, paramList);
          }
        }
      }
      else
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Uwe != null) {
      ste.a().unRegisterSubscriber(this.jdField_a_of_type_Uwe);
    }
    if (this.jdField_a_of_type_Uwd != null) {
      ste.a().unRegisterSubscriber(this.jdField_a_of_type_Uwd);
    }
  ...
  public void b(@NonNull List<String> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (a((String)localObject1) == null)
      {
        ...
        {
          veg.a("Q.qqstory.home.data.FeedManager", "request feed item list, ignore same request %s", localObject1);
        }
        else
        {
          jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localObject1, Long.valueOf(System.currentTimeMillis()));
          localObject2 = new uvs((String)localObject1, 0, "", "");
  ...
  public void b(List<String> paramList, boolean paramBoolean)
  {
    ...
    try
    {
      localaukn.a(TroopAssistantFeedIdListEntry.class);
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        String str = (String)paramList.next();
        ...
        localaukn.b(localTroopAssistantFeedIdListEntry);
      }
    }
    finally
    {
  ...
  public FeedItem c(String paramString)
  {
    ...
    if (localFeedItem == null)
    {
      veg.e("Q.qqstory.home.data.FeedManager", "这种类型目前还不支持：" + paramString.type);
      return null;
    }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject = tcz.a(QQStoryContext.a().a().createEntityManager(), MemoriesFeedIdListEntry.class, MemoriesFeedIdListEntry.class.getSimpleName(), null, null);
    if (localObject == null) {
      return localArrayList;
    }
    localObject = ((List)localObject).iterator();
  ...
  public void c()
  {
    ...
    long l = ((Long)((tcv)tdc.a(10)).b("key_disable_auto_refresh_time", Long.valueOf(60000L))).longValue();
  ...
  public void c(List<String> paramList, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      while (paramList.hasNext())
      {
        ...
        localaukn.b(localMemoriesFeedIdListEntry);
      }
    }
    finally
    {
