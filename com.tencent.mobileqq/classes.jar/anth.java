  ...
  extends WebViewPlugin
{
  ...
  private final BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new anti(this);
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  private EIPCResultCallback jdField_a_of_type_EipcEIPCResultCallback = new antj(this);
  ...
  private void a(Bundle paramBundle)
  {
    ...
    if (paramBundle.isSuccess())
    {
      ...
      localazxr.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne = paramBundle;
      localazxr.jdField_a_of_type_ComTencentMobileqqDataCard = new Card();
      localazxr.jdField_a_of_type_ComTencentMobileqqDataCard.uin = antf.aC;
      FriendProfileCardActivity.a(this.mRuntime.a(), localazxr, antf.aC, 0, paramBundle.h);
    }
  }
  
  private void a(String paramString, Bundle paramBundle)
  {
    antn.a().a(paramString, paramBundle, this.jdField_a_of_type_EipcEIPCResultCallback);
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (paramString3.equals("reportFriend"))
    {
      ...
      if (paramJsBridgeListener.isSuccess())
      {
        ...
        aber.a((BaseActivity)this.mRuntime.a(), antf.aC, null, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), 21001, paramJsBridgeListener);
      }
      return true;
    }
