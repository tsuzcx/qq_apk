...
public class qdq
  extends QIPCModule
{
  private static volatile qdq a;
  
  private qdq(String paramString)
  {
    super(paramString);
  }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    if (qct.a(paramBundle, (String)localObject))
    {
      QLog.i("ReadInJoyIPCModule", 1, "[jumpToNativeChannel], jump to recommend channel, using floating window.");
      return;
    }
    if (uks.a(paramBundle, (String)localObject, i))
    {
      QLog.i("ReadInJoyIPCModule", 1, "[jumpToNativeChannel], jump to mini game channel");
      return;
    }
    if (bool) {}
    for (localObject = "1"; qcq.a((String)localObject, i); localObject = "0")
    {
      osg.a(paramBundle, i, str, k, 4);
      return;
    }
    localObject = osg.b(paramBundle, 0, i);
  ...
  {
    ReadInJoyUserInfoModule.a(paramBundle.getLong("uin"), new qds(this, paramInt));
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        if (qcq.a(Uri.parse(str).getQueryParameter("ispush"), paramInt)) {
          try
          {
            if (str.contains("v_url_base64")) {}
            for (paramString = bheh.c(Uri.parse(str).getQueryParameter("v_url_base64")); BaseActivity.sTopActivity == null; paramString = URLDecoder.decode(Uri.parse(str).getQueryParameter("v_url"), "utf-8"))
            {
              paramBundle = BaseApplicationImpl.getContext();
              tto.a(paramBundle, null, paramString, null);
              return null;
            }
          }
      ...
      paramBundle = new owx();
      UiApiPlugin.a(paramString, paramBundle, paramString.getStringExtra("arg_callback"), new qdr(this, paramInt, paramBundle));
      return null;
    ...
    paramString = new Bundle();
    paramString.putInt("action_get_app_type", uvs.c());
    callbackResult(paramInt, EIPCResult.createResult(0, paramString));
    return null;
  }
}
