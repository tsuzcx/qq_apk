...
public class ahnd
  implements bhtv
{
  public ahnd(SystemMsgListView paramSystemMsgListView) {}
  ...
  public void onScroll(AbsListView paramAbsListView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (SystemMsgListView.a(this.a).b() == 23)
    {
      if (paramInt1 >= 1)
      {
        paramAbsListView = (ahln)SystemMsgListView.a(this.a).getItem(paramInt1 - 1);
        if ((paramAbsListView instanceof ahlj)) {
          ((ahlj)paramAbsListView).c();
        }
      }
      if (paramInt1 + paramInt2 < paramInt3)
      {
        paramAbsListView = (ahln)SystemMsgListView.a(this.a).getItem(paramInt1 + paramInt2);
        if ((paramAbsListView instanceof ahlj)) {
          ((ahlj)paramAbsListView).c();
        }
      }
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    for (paramInt = i;; paramInt = paramAbsListView.getTop())
    {
      ...
      {
        paramAbsListView = new ahob(j, k, paramInt);
