...
public class ahnd
  implements Runnable
{
  public ahnd(QQFilterRenderManager paramQQFilterRenderManager, byte[] paramArrayOfByte, int paramInt1, int paramInt2, IFaceDetectCallBack paramIFaceDetectCallBack) {}
