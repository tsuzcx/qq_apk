...
public class nxu
{
  ...
  public nxu(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (this.jdField_a_of_type_Nxx != null) {
      this.jdField_a_of_type_Nxx.a(paramArrayList);
    }
  }
  ...
  private void a(List<Long> paramList)
  {
    ...
    ((NewIntent)localObject).setObserver(new nxw(this));
  ...
  {
    if (this.jdField_a_of_type_Nxx != null) {
      this.jdField_a_of_type_Nxx.a();
    }
  }
  
  public void a()
  {
    this.jdField_a_of_type_Nxx = null;
    this.jdField_a_of_type_Boolean = true;
  }
  
  public boolean a(String paramString, nxx paramnxx)
  {
    return a(paramString, paramnxx, false);
  }
  
  public boolean a(String paramString, nxx paramnxx, boolean paramBoolean)
  {
    this.jdField_a_of_type_Nxx = paramnxx;
    paramnxx = new oidb_0x8cf.ReqBody();
    try
    {
      paramnxx.opt_uint64_groupcode.set(Long.parseLong(paramString));
      paramnxx.opt_uint32_need_mobile_sysapps.set(1);
      paramString = new oidb_sso.OIDBSSOPkg();
      paramString.uint32_command.set(2255);
      paramString.uint32_service_type.set(6);
      paramString.bytes_bodybuffer.set(ByteStringMicro.copyFrom(paramnxx.toByteArray()));
      paramnxx = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), nta.class);
      paramnxx.putExtra("cmd", "OidbSvc.0x8cf_6");
      paramnxx.putExtra("data", paramString.toByteArray());
      paramnxx.setObserver(new nxv(this, paramBoolean));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet(paramnxx);
      return true;
    }
    catch (NumberFormatException paramnxx)
    {
