...
public class wkr
{
  protected static wir<String, wks> a = new wir(200);
  ...
  public static File a(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    while ((zmw.a(paramString)) && (a(paramString, paramInt) != null))
    {
  ...
  {
    return win.h + a(paramString, false, 0L) + "/" + b(paramString, paramInt, paramBoolean1, paramBoolean2);
  }
  ...
  public static String a(String paramString, long paramLong, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (zmw.a(paramString)) {}
    for (String str = win.h;; str = win.i) {
  ...
  public static void a(StoryVideoItem paramStoryVideoItem, String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        localwte.a(paramStoryVideoItem.mVid, paramStoryVideoItem);
        return;
  ...
  {
    wks localwks = new wks();
    localwks.a = paramString2;
    a.a(paramString1, localwks);
  }
  ...
  {
    paramString = (wks)a.a(paramString);
    if (paramString != null) {
