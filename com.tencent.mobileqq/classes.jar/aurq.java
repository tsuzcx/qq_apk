...
class aurq
  implements boae<WeiyunPB.LibInfoListGetMsgRsp>
{
  aurq(aurp paramaurp, String paramString) {}
  ...
  public void a(int paramInt, String paramString, WeiyunPB.LibInfoListGetMsgRsp paramLibInfoListGetMsgRsp)
  {
    ...
    aurp.a(this.jdField_a_of_type_Aurp).a().a(false, 31, new Object[] { Integer.valueOf(paramInt), paramString, this.jdField_a_of_type_JavaLangString });
  }
  ...
  public void a(WeiyunPB.LibInfoListGetMsgRsp paramLibInfoListGetMsgRsp)
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localWeiYunFileInfo.jdField_b_of_type_JavaLangString = bocc.a(((WeiyunPB.FileItem)localObject2).pdir_key.get());
      ...
      localWeiYunFileInfo.i = bocc.a(((WeiyunPB.FileItem)localObject2).file_md5.get());
      localWeiYunFileInfo.j = bocc.a(((WeiyunPB.FileItem)localObject2).file_sha.get());
      if (!aurp.a(this.jdField_a_of_type_Aurp).containsKey(localWeiYunFileInfo.jdField_a_of_type_JavaLangString))
      {
        aurp.a(this.jdField_a_of_type_Aurp).put(localWeiYunFileInfo.jdField_a_of_type_JavaLangString, localWeiYunFileInfo);
        localArrayList.add(localWeiYunFileInfo);
      }
    }
    localObject1 = aurp.a(this.jdField_a_of_type_Aurp).a();
    Object localObject2 = this.jdField_a_of_type_JavaLangString;
    if (paramLibInfoListGetMsgRsp.finish_flag.get() == 1) {}
    for (boolean bool = true;; bool = false)
    {
      ((atur)localObject1).a(true, 31, new Object[] { localObject2, Boolean.valueOf(bool), Integer.valueOf(paramLibInfoListGetMsgRsp.FileItem_items.size()), paramLibInfoListGetMsgRsp.server_version.get(), localArrayList, Integer.valueOf(aurp.a(this.jdField_a_of_type_Aurp)) });
      return;
    }
  }
}
