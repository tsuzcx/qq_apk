...
public class awfq
{
  ...
  public awfq(PresendPicMgr paramPresendPicMgr, CompressInfo paramCompressInfo, int paramInt1, int paramInt2)
  {
  ...
  public void a()
  {
    awen.a("PresendPicMgr", "PresendReq.compressAndUploadPic", "call start,current PresendReq is " + this);
    long l = System.nanoTime();
    if (this.jdField_a_of_type_Boolean)
    {
      awen.a("PresendPicMgr", "compressAndUploadPic ", "PresendStatus: srcPah:" + this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.c + ",destPath:" + this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_e_of_type_JavaLangString + ",uuid:" + this.jdField_a_of_type_JavaLangString + " ,canceled:true, peakCompress:false, peakUpload:false");
      return;
    }
    awga.a(this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo);
    awen.a("PresendPicMgr", "compressAndUploadPic ", "PresendStatus: srcPah:" + this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.c + ",destPath:" + this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_e_of_type_JavaLangString + ",uuid:" + this.jdField_a_of_type_JavaLangString + ",canceled:false,peakCompress:true,peakUpload:false");
    l = (System.nanoTime() - l) / 1000000L;
    awen.a("PresendPicMgr", "PresendReq.compressAndUploadPic", "Process peak,[#]compress, cost= " + l);
    b();
    awen.a("PresendPicMgr", "PresendReq.compressAndUploadPic", "call end,current PresendReq is " + this);
  }
  ...
  public void a(int paramInt)
  {
    for (;;)
    {
      try
      {
        awen.a("PresendPicMgr", "PresendReq.cancel", "current PresendReq is " + this);
        this.jdField_a_of_type_Boolean = true;
        boolean bool = this.jdField_b_of_type_Boolean;
        if (bool) {
          try
          {
            awen.a("PresendPicMgr", "PresendReq.cancel", "call cancelUpload");
        ...
        awen.a("PresendPicMgr", "PresendReq.cancel", "mIsUpload is false,no need to call cancelUpload");
      }
      finally {}
    }
  }
  ...
  public void b()
  {
    try
    {
      awen.a("PresendPicMgr", "PresendReq.uploadPic", "current PresendReq is " + this);
      if (this.jdField_a_of_type_Boolean) {
        awen.a("PresendPicMgr", "uploadPic ", "PresendStatus: srcPah:" + this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.c + ",destPath:" + this.jdField_a_of_type_ComTencentMobileqqPicCompressInfo.jdField_e_of_type_JavaLangString + ",uuid:" + this.jdField_a_of_type_JavaLangString + " ,canceled:true, peakCompress:true, peakUpload:false");
      }
      for (;;)
      {
        return;
        ...
        {
          awen.b("PresendPicMgr", "PresendReq.uploadPic", "mCompressInfo.destPath == null! ");
          continue;
        }
        try
        {
          ...
          awen.a("PresendPicMgr", "PresendReq.uploadPic", "call end");
        }
        catch (RemoteException localRemoteException)
        {
          for (;;)
