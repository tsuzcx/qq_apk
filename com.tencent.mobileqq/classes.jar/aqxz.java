  ...
  extends aqya
{
  ...
  public aqxz(QQAppInterface paramQQAppInterface, auld paramauld, HashMap<String, ArrayList<MessageRecord>> paramHashMap, aukq paramaukq)
  {
    ...
    if (this.b == null)
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if (i < ((ArrayList)localObject).size())
        {
          ...
          if ((localMessageRecord2 == null) || (!arni.a(localMessageRecord2))) {
            break label165;
          }
  ...
  public void a(String paramString, List<MessageRecord> paramList, MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    {
      paramList = alpo.a(2131707395) + paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFileName");
