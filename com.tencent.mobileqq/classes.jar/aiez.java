...
public class aiez
  extends RecyclerView.Adapter<aifb>
{
  public ArrayList<LocalMediaInfo> a;
  public WeakReference<PhotoListPanel> a;
  boolean a;
  
  public aiez(PhotoListPanel paramPhotoListPanel)
  {
  ...
  public int a(String paramString)
  {
    ...
    return bhkd.getMediaType(paramString);
  }
  
  public aifb a(ViewGroup paramViewGroup, int paramInt)
  {
    return new aifb(this, LayoutInflater.from(paramViewGroup.getContext()).inflate(2131561403, paramViewGroup, false));
  }
  ...
  public void a(aifb paramaifb, int paramInt)
  {
    paramaifb.itemView.setOnClickListener(new aifa(this, paramInt));
    paramaifb.jdField_a_of_type_Aiew.a(paramInt);
    paramaifb.jdField_a_of_type_Aiew.a(paramaifb.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox);
    Object localObject1 = a(paramInt);
    Object localObject2 = paramaifb.jdField_a_of_type_ComTencentImageURLImageView;
    Object localObject4 = new ascz(((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).i, ((LocalMediaInfo)localObject1).thumbWidth, ((LocalMediaInfo)localObject1).thumbHeight);
    ascz localascz = new ascz(((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).j, ((LocalMediaInfo)localObject1).thumbWidth, ((LocalMediaInfo)localObject1).thumbHeight);
    Object localObject3 = bhkd.generateAlbumThumbURL((LocalMediaInfo)localObject1, "FLOW_THUMB");
    URLDrawable localURLDrawable = paramaifb.jdField_a_of_type_ComTencentImageURLDrawable;
    ...
    if ((localObject3 != null) && ((localURLDrawable == null) || (!localURLDrawable.getURL().equals(localObject3))))
    {
      ...
      localURLDrawableOptions.mFailedDrawable = localascz;
      ...
      paramaifb.jdField_a_of_type_ComTencentImageURLDrawable = ((URLDrawable)localObject4);
      if (localURLDrawable != null) {
        localURLDrawable.cancelDownload(true);
      }
    }
    localObject2 = paramaifb.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox;
    localObject3 = paramaifb.b;
    ...
    if (((LocalMediaInfo)localObject1).mChecked)
    {
      ...
      localObject3 = paramaifb.jdField_a_of_type_AndroidWidgetImageView;
      i = getItemViewType(paramInt);
      if (i != 0) {
        break label647;
      }
      ((ImageView)localObject3).setVisibility(4);
      paramaifb.jdField_a_of_type_AndroidWidgetTextView.setVisibility(4);
      label394:
      if ((!bhjx.b(((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a)) || (paramInt != 0)) {
        break label714;
      }
      localObject3 = (antk)((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(53);
      if (((antk)localObject3).a(1))
      {
        ((antk)localObject3).a();
        ((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).c = paramaifb.jdField_a_of_type_AndroidViewView;
      ...
      paramaifb.jdField_a_of_type_AndroidViewView.setVisibility(0);
      antk.a(((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidAppActivity, paramaifb.jdField_a_of_type_AndroidViewView);
    }
    for (;;)
    {
      if (AppSetting.c)
      {
        ...
        paramaifb.itemView.setContentDescription((CharSequence)localObject3);
        localObject1 = PhotoUtils.a(i, (LocalMediaInfo)localObject1, paramInt, ((NumberCheckBox)localObject2).isChecked());
        paramaifb.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setContentDescription((CharSequence)localObject1);
      }
      EventCollector.getInstance().onRecyclerBindViewHolder(paramaifb, paramInt, getItemId(paramInt));
      return;
      label593:
      localURLDrawableOptions.mLoadingDrawable = ((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Ascz;
      localURLDrawableOptions.mFailedDrawable = ((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_Ascz;
      break;
      ...
      {
        ((ImageView)localObject3).setVisibility(0);
        localObject3 = paramaifb.jdField_a_of_type_AndroidWidgetTextView;
      ...
      break label394;
      label703:
      paramaifb.jdField_a_of_type_AndroidViewView.setVisibility(4);
      continue;
      label714:
      paramaifb.jdField_a_of_type_AndroidViewView.setVisibility(4);
    }
  ...
  public void a(List<LocalMediaInfo> paramList)
  {
    ...
    {
      String.format(((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131717501), new Object[] { Integer.valueOf(((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_JavaUtilLinkedList.size()) });
      return;
    }
    ((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131717496);
  }
  ...
  {
    return bhkd.getMediaType(a(paramInt));
  }
}
