  ...
  extends mxk
{
  ...
  public vcq(vcp paramvcp, ImageView paramImageView)
  {
    this.b = new WeakReference(paramvcp);
  ...
  public qqstory_struct.ErrorInfo a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    vcp localvcp = (vcp)this.b.get();
    paramBundle = (ImageView)this.c.get();
    if ((localvcp == null) || (paramBundle == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
          ...
          try
          {
            ...
            if ((((qqstory_710_message.RspStoryMessageList)localObject).errinfo.error_code.has()) && (((qqstory_710_message.RspStoryMessageList)localObject).errinfo.error_code.get() == 0) && (((qqstory_710_message.RspStoryMessageList)localObject).message_num.get() > 0) && (!((qqstory_710_message.RspStoryMessageList)localObject).message_list.get().isEmpty()))
            {
              ...
              for (;;)
              {
                ...
                {
                  localObject = new uuu((qqstory_710_message.StoryMessage)paramArrayOfByte.next());
                  if (((uuu)localObject).d)
                  {
                    paramArrayOfByte = ((uuu)localObject).a;
                    if (QLog.isColorLevel()) {
                    ...
                    tsu.a(paramBundle, tsu.b(paramArrayOfByte), true, (int)bbdh.a(vcp.b(localvcp), 33.0F));
                    return null;
                  }
                }
              }
      ...
      paramArrayOfByte = bbdr.b();
      QQStoryContext.a();
      paramArrayOfByte = baxt.a(QQStoryContext.a(), 1, Long.toString(vcp.a(localvcp)), 3, paramArrayOfByte, paramArrayOfByte);
