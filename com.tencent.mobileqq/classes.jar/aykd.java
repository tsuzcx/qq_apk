  ...
  extends ayju
{
  ...
  public aykd(String paramString, long paramLong, List<String> paramList, UnifySearchCommon.ResultItem paramResultItem, int paramInt)
  {
  ...
  public void a(String paramString)
  {
    try
    {
      ...
      this.a = new ayjq((QQAppInterface)localObject, this.c, paramString, this.g);
