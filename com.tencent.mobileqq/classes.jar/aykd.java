  ...
  extends BaseAdapter
{
  ...
  private aykf jdField_a_of_type_Aykf;
  private List<aylv> jdField_a_of_type_JavaUtilList = new ArrayList();
  
  public void a(aykf paramaykf)
  {
    this.jdField_a_of_type_Aykf = paramaykf;
  }
  
  public void a(List<aylv> paramList)
  {
  ...
  {
    int j = 0;
    TextView localTextView = (TextView)LayoutInflater.from(paramViewGroup.getContext()).inflate(2131561279, paramViewGroup, false);
    aylv localaylv = (aylv)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    Object localObject2 = localaylv.a;
    ...
    localSpannableStringBuilder.append("：").append(localaylv.c);
    ...
    localTextView.setOnClickListener(new ayke(this, paramViewGroup));
