  ...
  implements View.OnClickListener
{
  ...
  public smr(FriendProfileCardActivity paramFriendProfileCardActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      case 17: 
        for (;;)
        {
          ...
          if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqProfileViewProfileHeaderView.b)) {
            paramView.putExtra("extra_default", 2130842919);
          }
      ...
      case 5: 
        this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.w();
        ThreadManager.post(new sms(this), 8, null, true);
      ...
      case 8: 
        ...
        return;
      case 23: 
        localObject1 = paramView.findViewById(2131371147);
        localObject2 = paramView.getParent();
        paramView = (View)localObject1;
        if ((localObject2 instanceof View)) {
          paramView = ((View)localObject2).findViewById(2131371147);
        }
        i = 1;
        if (paramView != null) {
      ...
      case 83: 
        try
        {
          ...
          ((VideoActionSheet)localObject1).a(2131438327);
          ((VideoActionSheet)localObject1).b(2131433811);
          j = 0;
          paramView[0] = 1;
          i = j;
            ...
            if (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentAvAppPstnSessionInfo.c != null)
            {
              ...
              if (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqQcallPstnManager.a() == 1)
              {
                ...
                if (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqQcallPstnManager.a().jdField_b_of_type_Int == 1)
                {
                  ...
                  ((VideoActionSheet)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getResources().getString(2131438325), this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getResources().getDrawable(2130840353), 0);
          ...
          for (;;)
          {
            ...
            paramView[1] = 4;
            paramView[(i + 1)] = 2;
            ((VideoActionSheet)localObject1).b(2131433808);
            ((VideoActionSheet)localObject1).c(2131432998);
            ((VideoActionSheet)localObject1).a(new smt(this));
            ((VideoActionSheet)localObject1).a(new smu(this, paramView, (VideoActionSheet)localObject1));
            ...
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqQcallPstnCardInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqQcallPstnManager.b() == 1) && (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqQcallPstnCardInfo.pstn_c2c_try_status == 0))
            {
              ...
              ((VideoActionSheet)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getResources().getString(2131438325), this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getResources().getDrawable(2130840352), 0);
            ...
            else
            {
              ...
              ((VideoActionSheet)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getResources().getString(2131438325), this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getResources().getDrawable(2130840351), 0);
          ...
          while (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.o == 2)
          {
            ...
            {
              this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.j = true;
              if (paramView.b(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqProfileProfileCardInfo.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_k_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_a_of_type_ComTencentMobileqqProfileProfileCardInfo.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString))
              {
          ...
          if ((((DataTag)localObject1).jdField_a_of_type_JavaLangObject instanceof String))
          {
            ...
            for (;;)
            {
              ...
              localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getString(2131437473);
              localObject1 = ActionSheet.a(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity);
              ((ActionSheet)localObject1).a(2131437472, 1);
              ((ActionSheet)localObject1).a((CharSequence)localObject2, 1);
              ((ActionSheet)localObject1).a(2131432998, 1);
              ((ActionSheet)localObject1).a(new smv(this, paramView, (ActionSheet)localObject1));
              try
              {
            ...
            if (this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.jdField_h_of_type_Int == 1)
            {
              ...
              paramView.putExtra("selfSet_leftViewText", this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getString(2131437754));
              this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.startActivity(paramView);
              return;
            }
            paramView = null;
            ...
            localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.getResources().getString(2131429983);
            localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.app.getCurrentAccountUin();
            String str = ContactUtils.j(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.app, (String)localObject2);
            paramView.putExtra("title", (String)localObject1);
            paramView.putExtra("uin", (String)localObject2);
            paramView.putExtra("nick", str);
