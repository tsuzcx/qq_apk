...
public class vzw
{
  ...
  public static vzx a(Object paramObject)
  {
    int k = 1;
    String str1 = "1";
    String str3 = "";
    ...
    for (int i = 2;; i = 1)
    {
      ...
      j = 1;
      if (bbkk.a(paramObject))
      {
        paramObject = "weishi://camera?logsour=3006";
        i = k;
        label105:
        localvzx = new vzx();
        localvzx.jdField_a_of_type_JavaLangString = str1;
        localvzx.jdField_b_of_type_JavaLangString = str3;
        localvzx.jdField_c_of_type_JavaLangString = str2;
        localvzx.jdField_a_of_type_Int = i;
        localvzx.e = str4;
        localvzx.f = paramObject;
        localvzx.g = ((String)localObject);
        localvzx.jdField_b_of_type_Int = j;
        if (i == 2)
        {
          localvzx.jdField_d_of_type_JavaLangString = "DOV";
          return localvzx;
          str1 = "11";
          str3 = ((QIMFilterCategoryItem)localObject).jdField_b_of_type_JavaLangString;
          paramObject = ((QIMFilterCategoryItem)localObject).h;
        ...
        for (i = 2;; i = 1)
        {
          ...
          if ((paramObject instanceof QIMBeautyItem))
          {
            ...
            for (i = 2;; i = 1)
            {
              ...
              break;
              localvzx.jdField_d_of_type_JavaLangString = ajya.a(2131716913);
              return localvzx;
              break label105;
            }
          }
  ...
  public static wbz a(Context paramContext, Object paramObject)
  {
    vzx localvzx = a(paramObject);
    if (localvzx == null) {
      return null;
    }
    String str1 = localvzx.jdField_a_of_type_JavaLangString;
    String str2 = localvzx.jdField_b_of_type_JavaLangString;
    String str3 = localvzx.f;
    int j = localvzx.jdField_a_of_type_Int;
    String str4 = localvzx.e;
    int k = localvzx.jdField_b_of_type_Int;
    int i;
    int m;
    ...
    for (;;)
    {
      ...
      if (j == 2)
      {
        if (bbfr.a(paramContext, "com.tencent.qim"))
        {
          axqy.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 1, str4, "dov", "", "");
          bbfr.a(paramContext, "com.tencent.qim", null);
        }
        for (;;)
        {
          return null;
          ...
          break label117;
          axqy.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 0, str4, "dov", "", "");
          tti.a(paramContext);
        }
      }
      label174:
      ...
      {
        axqy.b(null, "dc00898", "", "", "weishi_share_shoot", (String)localObject, k, 0, "", "", "", "");
        axqy.b(null, "dc00899", "grp_story", "", "weishi_share", localvzx.g, 0, 0, str1, str2, "", "");
        if (!a(paramContext)) {
          break;
        }
        axqy.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 1, str4, "weishi", "", "");
        axqy.b(null, "dc00899", "grp_story", "", "weishi_share", "clk_ws", 0, 1, str1, str2, "", "");
      ...
      axqy.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 0, str4, "weishi", "", "");
      localObject = localvzx.jdField_c_of_type_JavaLangString;
      axqy.b(null, "dc00899", "grp_story", "", "weishi_share", "clk_ws", 0, 2, str1, str2, "", "");
      paramContext = new wbz(paramContext, 2131755995, paramObject);
  ...
  {
    if (!vym.b(paramContext))
    {
      bcql.a(paramContext, ajya.a(2131716915), 0).a();
      return;
    }
    bkzo.a().a();
    ...
    {
      ved.d("WeishiGuideUtils", "get null info");
      return;
    }
  ...
  public static void a(Object paramObject)
  {
    ...
    axqy.b(null, "dc00898", "", "", "weishi_share_shoot", "story_entry_exp", j, 0, "", "", "", "");
  }
  
  public static boolean a(Context paramContext)
  {
    return bbfr.a(paramContext, "com.tencent.weishi");
  }
}
