...
class vdk
  implements zxa<QQHeadUrl.QQHeadUrlRsp>
{
  vdk(vde paramvde, String paramString, Bundle paramBundle) {}
  ...
  public void a(boolean paramBoolean, long paramLong, String paramString, QQHeadUrl.QQHeadUrlRsp paramQQHeadUrlRsp)
  {
    ...
    if ((paramBoolean) && (paramLong == 0L) && (paramQQHeadUrlRsp != null))
    {
      ...
      if ((TextUtils.isEmpty((CharSequence)localObject)) || (this.jdField_a_of_type_Vde.a == null)) {
        break label294;
      }
    }
    label294:
    for (;;)
    {
      try
      {
        paramQQHeadUrlRsp = ((FriendListHandler)this.jdField_a_of_type_Vde.a.a(1)).a().a((String)localObject, (byte)localRspHeadInfo.faceFlag.get(), (byte)paramQQHeadUrlRsp.dstUsrType.get(), 0);
      ...
      catch (Exception paramQQHeadUrlRsp)
      {
        try
        {
          bltb.a(String.valueOf(this.jdField_a_of_type_Vde.a.getAccount()), this.jdField_a_of_type_Vde.a(), this.jdField_a_of_type_AndroidOsBundle, null, -1);
      ...
      if (vde.a(this.jdField_a_of_type_Vde)) {}
