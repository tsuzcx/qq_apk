    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          {
            return;
            if (aeht.a(((StructMsgForImageShare)paramView).mMsgActionData))
            {
              this.a.b((StructMsgForImageShare)paramView, "5");
              return;
            }
          } while (!aeht.b(((StructMsgForImageShare)paramView).mMsgActionData));
          aeht.a(this.a, (StructMsgForImageShare)paramView);
          localObject2 = aeht.b(((StructMsgForImageShare)paramView).mMsgActionData);
        ...
        nol.a(null, "", "0X800712E", "0X800712E", 0, 0, (String)localObject1, paramView, "", "");
        nol.a("0X800712E", "", (String)localObject1, paramView, "", "");
        return;
