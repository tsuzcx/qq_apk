...
public class bmtl
{
  ...
  private static bmtk a(Cursor paramCursor)
  {
    bmtk localbmtk = new bmtk();
    localbmtk.jdField_a_of_type_Long = paramCursor.getLong(0);
    localbmtk.jdField_a_of_type_JavaLangString = paramCursor.getString(1);
    localbmtk.jdField_b_of_type_JavaLangString = paramCursor.getString(2);
    localbmtk.jdField_c_of_type_JavaLangString = paramCursor.getString(3);
    localbmtk.jdField_d_of_type_JavaLangString = paramCursor.getString(4);
    localbmtk.jdField_e_of_type_JavaLangString = paramCursor.getString(5);
    localbmtk.jdField_b_of_type_Long = paramCursor.getLong(6);
    localbmtk.f = paramCursor.getString(7);
    localbmtk.jdField_c_of_type_Long = paramCursor.getLong(8);
    localbmtk.g = paramCursor.getString(9);
    localbmtk.jdField_a_of_type_Int = paramCursor.getInt(10);
    localbmtk.jdField_b_of_type_Int = paramCursor.getInt(11);
    localbmtk.h = paramCursor.getString(12);
    localbmtk.jdField_d_of_type_Long = paramCursor.getLong(13);
    localbmtk.jdField_e_of_type_Long = paramCursor.getLong(14);
    localbmtk.i = paramCursor.getString(15);
    localbmtk.j = paramCursor.getString(16);
    localbmtk.k = paramCursor.getString(17);
    localbmtk.l = paramCursor.getString(18);
    return localbmtk;
  }
  
  /* Error */
  public static java.util.ArrayList<bmtk> a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    ...
    //   53: aload_3
    //   54: ldc 36
    //   56: getstatic 145	bmtm:a	[Ljava/lang/String;
    //   59: aload 4
    ...
    //   93: aload_2
    //   94: aload_0
    //   95: invokestatic 161	bmtl:a	(Landroid/database/Cursor;)Lbmtk;
