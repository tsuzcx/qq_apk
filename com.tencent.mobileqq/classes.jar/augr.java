  ...
  extends aufz
{
  ...
  private aocj jdField_a_of_type_Aocj = new augw(this);
  bhqw jdField_a_of_type_Bhqw;
  ...
  public augr(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, List<auei> paramList, int paramInt)
  {
  ...
  private void a(long paramLong)
  {
    ...
    paramLong = localanvu.a().a(localFileManagerEntity.uniseq, localFileManagerEntity.peerDin, localFileManagerEntity.strDataLineMPFileID, localFileManagerEntity.fileName, localFileManagerEntity.fileSize, paramLong, this.jdField_c_of_type_Int);
    if (paramLong == -1L)
    {
      if (QLog.isColorLevel()) {
  ...
  private void g(int paramInt)
  {
    ...
    p();
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileFailedView = new MPFileFailedView(this.jdField_a_of_type_Auef.getActivity(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileFailedView.b();
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileFailedView.a(this.jdField_a_of_type_Auef.a(), new augt(this), paramInt, this.jdField_c_of_type_Int);
    this.jdField_a_of_type_Auef.a().setVisibility(0);
    this.jdField_a_of_type_Auef.a().removeAllViews();
    this.jdField_a_of_type_Auef.a().addView(this.jdField_a_of_type_AndroidViewView);
  ...
  public auey a()
  {
    if (this.jdField_a_of_type_Auey == null) {
      this.jdField_a_of_type_Auey = new augx(this);
    }
  ...
  protected void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new augz(this);
      ...
      localIntentFilter.addAction(bmka.d);
      localIntentFilter.addAction(bmka.g);
    ...
    this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetEventHandler = new augs(this);
  ...
  public void a(byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (this.d >= 3)
      {
        this.jdField_a_of_type_Bhqw = new bhqw(this.jdField_a_of_type_AndroidAppActivity, 2131755824);
        this.jdField_a_of_type_Bhqw.setContentView(2131559010);
        this.jdField_a_of_type_Bhqw.setTitle(2131693785);
        this.jdField_a_of_type_Bhqw.a(2131693784);
        this.jdField_a_of_type_Bhqw.a(0, 0, null);
        this.jdField_a_of_type_Bhqw.a(2131693359, new augv(this));
      ...
      if (this.jdField_a_of_type_Auef != null) {
        this.jdField_a_of_type_Auef.a(false);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView == null) {
        o();
      }
  ...
  {
    q();
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView = new MPFileVerifyPwdView(this.jdField_a_of_type_Auef.getActivity(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView.a(this.jdField_a_of_type_Auef.a(), new augu(this));
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView.b();
    this.jdField_a_of_type_Auef.a().setVisibility(0);
    this.jdField_a_of_type_Auef.a().removeAllViews();
    this.jdField_a_of_type_Auef.a().addView(this.jdField_b_of_type_AndroidViewView);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, -1);
  ...
  public void p()
  {
    if (this.jdField_b_of_type_AndroidViewView != null)
    {
      ...
      this.jdField_a_of_type_Auef.a().removeView(this.jdField_b_of_type_AndroidViewView);
    }
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView != null)
    {
  ...
  protected void q()
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      this.jdField_a_of_type_Auef.a().removeView(this.jdField_a_of_type_AndroidViewView);
    }
  ...
  public void r()
  {
    ...
    Object localObject = (InputMethodManager)this.jdField_a_of_type_Auef.a().getContext().getSystemService("input_method");
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView != null) && (bool))
    {
      ...
      ((InputMethodManager)localObject).hideSoftInputFromWindow(this.jdField_a_of_type_Auef.a().getWindowToken(), 0);
    }
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView != null) {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityMPFileVerifyPwdView.c();
    }
  ...
  protected void u()
  {
    ...
    if (!this.jdField_a_of_type_Boolean) {
      if (localanvu.a().a())
      {
        this.jdField_c_of_type_Long = localanvu.a().a(1);
    ...
    do
    {
      ...
      {
        return;
        this.jdField_c_of_type_Long = localanvu.a().a(2);
        break;
        QLog.d("MPcFileModel<FileAssistant>", 2, "CLOUD_TYPE_DATALINEMPFILE doDownload,mEntity.uniseq:" + localFileManagerEntity.uniseq + ",mEntity.peerDin:" + localFileManagerEntity.peerDin + ",mEntity.strDataLineMPFileID:" + localFileManagerEntity.strDataLineMPFileID + " ,mEntity.fileName:" + localFileManagerEntity.fileName + ",mEntity.fileSize:" + localFileManagerEntity.fileSize);
        this.jdField_a_of_type_Long = NetConnInfoCenter.getServerTimeMillis();
        this.jdField_b_of_type_Boolean = true;
        l = localanvu.a().a(localFileManagerEntity.uniseq, localFileManagerEntity.peerDin, localFileManagerEntity.strDataLineMPFileID, localFileManagerEntity.fileName, localFileManagerEntity.fileSize);
        if (l != -1L) {
          break label298;
        }
        if (QLog.isColorLevel()) {
        ...
        auna.a(2131693372);
      } while (this.jdField_a_of_type_Augp == null);
      this.jdField_a_of_type_Augp.g();
      return;
      localFileManagerEntity.uniseq = l;
      localFileManagerEntity.status = 2;
    } while (this.jdField_a_of_type_Augp == null);
    this.jdField_a_of_type_Augp.d();
  }
  ...
  protected void v()
  {
    ...
    anvu localanvu = (anvu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8);
    FileManagerEntity localFileManagerEntity = this.jdField_a_of_type_Auei.a();
    localanvu.a().a(localFileManagerEntity.strDataLineMPFileID);
