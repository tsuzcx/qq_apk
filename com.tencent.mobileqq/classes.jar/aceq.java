...
public class aceq
  extends lpr
{
  private aceq(BaseChatPie paramBaseChatPie) {}
  ...
  protected void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    if (this.a.jdField_a_of_type_Apgd != null) {
      this.a.jdField_a_of_type_Apgd.d();
    }
  ...
  protected void a(long paramLong1, int paramInt1, long paramLong2, int paramInt2)
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == paramInt1) && (Long.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString).longValue() == paramLong1))
    {
      ...
      str1 = this.a.jdField_a_of_type_AndroidContentContext.getString(2131696102);
      if (paramLong2 != 2L) {
        break label234;
      }
      str1 = this.a.jdField_a_of_type_AndroidContentContext.getString(2131696103);
    }
    label233:
    label234:
    String str2;
    ...
    do
    {
      do
      {
        ...
        if ((paramLong2 == 41L) || (paramLong2 == 40L)) {
          str1 = this.a.jdField_a_of_type_AndroidContentContext.getString(2131696107);
        }
        for (;;)
        {
          bdcd.a(this.a.jdField_a_of_type_AndroidContentContext, 230, null, str1, 2131695892, 2131721323, new acer(this), null).show();
          return;
          if (paramLong2 != 35L) {
            break;
          }
          str1 = this.a.jdField_a_of_type_AndroidContentContext.getString(2131696104);
          break;
          if (paramLong2 == 42L) {
            str1 = this.a.jdField_a_of_type_AndroidContentContext.getString(2131696105);
          } else if (paramLong2 == 43L) {
            str1 = this.a.jdField_a_of_type_AndroidContentContext.getString(2131696106);
          }
        }
        if (paramLong2 == 3L)
        {
          QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.a.jdField_a_of_type_AndroidContentContext.getString(2131696064), 1).b(this.a.a());
          return;
        }
        if (paramLong2 == 4L)
        {
          QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.a.jdField_a_of_type_AndroidContentContext.getString(2131696061), 1).b(this.a.a());
          return;
        }
        if (paramLong2 == 8L)
        {
          QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.a.jdField_a_of_type_AndroidContentContext.getString(2131696060), 1).b(this.a.a());
          return;
        }
      } while (paramLong2 != 7L);
  ...
  protected void a(long paramLong1, int paramInt, long paramLong2, String paramString)
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == paramInt) && (Long.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString).longValue() == paramLong1)) {
      bdcd.a(this.a.jdField_a_of_type_AndroidContentContext, 230, null, paramString, 2131695892, 2131721323, new aces(this), null).show();
    }
  }
  ...
  protected void a(String paramString1, String paramString2)
  {
    ...
    TextView localTextView = (TextView)this.a.jdField_a_of_type_ComTencentMobileqqActivityAioTipsVideoStatusTipsBar.a(new Object[0]).findViewById(2131377656);
    ...
    if (localTextView != null)
    {
      ...
      {
        i = mww.b(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
        long l = Long.valueOf(paramString1).longValue();
        l = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(i, l);
        String.format(this.a.jdField_a_of_type_AndroidContentContext.getString(2131690006), new Object[] { Long.valueOf(l) });
    ...
    if (i == 2) {
      str = this.a.jdField_a_of_type_AndroidContentContext.getString(2131696413);
    }
    for (;;)
    {
      i = this.a.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166909);
      this.a.jdField_a_of_type_ComTencentMobileqqActivityAioTipsVideoStatusTipsBar.a(null, str, i, paramString1, 0);
      break;
      if (i == 1) {
        str = this.a.jdField_a_of_type_AndroidContentContext.getString(2131695842);
      }
    }
  }
