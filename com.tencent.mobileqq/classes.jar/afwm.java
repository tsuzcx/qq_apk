...
{
  public long a;
  private afwo jdField_a_of_type_Afwo;
  ...
  public afwm(AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  {
    if (this.jdField_a_of_type_Afwo != null)
    {
      this.b = this.jdField_a_of_type_Afwo.a(this.jdField_a_of_type_AndroidGraphicsPoint, this.c, paramFloat);
      a(this.b);
    }
  }
  ...
  private void d()
  {
    this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new afwn(this);
  }
  ...
  public void a()
  {
    ...
    do
    {
      ...
      {
        return;
        if ((this.jdField_a_of_type_Afwo == null) && (this.jdField_a_of_type_AndroidViewView != null)) {
          break;
        }
      ...
      this.jdField_a_of_type_Afwo.a(this.jdField_a_of_type_AndroidAnimationValueAnimator);
      this.jdField_a_of_type_AndroidGraphicsPoint = this.jdField_a_of_type_Afwo.a(this.c);
  ...
  public void a(afwo paramafwo)
  {
    this.jdField_a_of_type_Afwo = paramafwo;
  }
