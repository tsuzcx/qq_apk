  ...
  extends ayfn
{
  ...
  public void a(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    try
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131720151).equals(str))
      {
      ...
      bcql.a(this.a.getActivity(), str, 0).a();
      QLog.i(ayed.i, 2, " onGetUserAuth  isSuccess = " + paramBoolean + " tips =" + str);
      return;
    }
    catch (Exception paramArrayOfObject)
    {
      QLog.e(ayed.i, 2, " onGetUserAuth  exception = " + paramArrayOfObject.toString());
    }
  }
  ...
  public void b(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    try
    {
      QLog.i(ayed.i, 2, " onSetUserAuth  isSuccess = " + paramBoolean);
      Object localObject = (DocsGrayTipsInfo)paramArrayOfObject[0];
      String str = (String)paramArrayOfObject[1];
      long l = ((Long)paramArrayOfObject[2]).longValue();
      if (paramBoolean)
    ...
    {
      QLog.e(ayed.i, 1, " onSetUserAuth  exception  = " + paramArrayOfObject.toString());
    }
  }
}
