...
public final class tvy
{
  ...
  private final String a(AdvertisementInfo paramAdvertisementInfo, Context paramContext)
  {
    ...
    int i = twr.a(paramAdvertisementInfo);
    if (i == 2)
    {
      ...
      if (!tqa.a(paramAdvertisementInfo)) {
        break label178;
      }
      if (i != 2) {
        break label172;
    ...
    for (;;)
    {
      ...
      continue;
      label178:
      if (oau.a(paramContext, paramAdvertisementInfo))
      {
        if (i == 2) {
  ...
  private final void b(sdc paramsdc)
  {
    if (paramsdc != null)
    {
      paramsdc = paramsdc.a();
    ...
    for (paramsdc = paramsdc.a(); (paramsdc == null) || (paramsdc.getVisibility() == 8); paramsdc = null) {
      return;
    }
    a(0, 1, (View)paramsdc, 200, 0);
  }
  
  public final void a(@Nullable sdc paramsdc)
  {
    if (paramsdc != null)
    {
      Object localObject = paramsdc.a();
      if (localObject != null)
      {
        localObject = ((sdy)localObject).a();
        if (localObject != null) {
  ...
  public final void a(@Nullable sdg paramsdg)
  {
    int j = -1;
    Object localObject;
    try localtry;
    ...
    {
      paramsdg = paramsdg.a;
      localObject = paramsdg;
      if (!(paramsdg instanceof AdvertisementInfo)) {
        localObject = null;
      }
      paramsdg = (AdvertisementInfo)localObject;
      if (paramsdg != null)
      {
        localObject = new StringBuilder().append("secondStateTime = ");
        localtry = paramsdg.adExperimentData.a();
        if (localtry == null) {
          break label143;
        }
      }
    ...
    for (int i = localtry.a();; i = -1)
    {
      ...
      twp.a("AdVideo185UIStateUtil", i + ' ' + "button_flag = " + paramsdg.mShowAdButton);
      return;
      paramsdg = null;
      break;
    }
  ...
  public final void a(@Nullable sdg paramsdg, @Nullable ReadInJoyAdVideoGuide paramReadInJoyAdVideoGuide)
  {
    Object localObject;
    if (paramsdg != null)
    {
      localObject = paramsdg.a;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        b(paramsdg, paramReadInJoyAdVideoGuide);
        if (paramReadInJoyAdVideoGuide != null) {
          paramReadInJoyAdVideoGuide.setAppInfo(localAdvertisementInfo.mAdProductType, str1, (String)localObject, str4, twr.d(localAdvertisementInfo), localAdvertisementInfo);
        }
        if (paramReadInJoyAdVideoGuide != null) {
      ...
      {
        QLog.e("RecommendADVideoFeedsManager", 1, "showGuideView, e=" + paramsdg.getMessage());
        return;
      }
      localObject = null;
      break;
  ...
  public final void a(@Nullable sdg paramsdg, @Nullable ReadInJoyVideoAdHighLightBar paramReadInJoyVideoAdHighLightBar)
  {
    if (paramsdg != null) {}
    for (paramsdg = paramsdg.a;; paramsdg = null)
    {
      sdg localsdg = paramsdg;
      if (!(paramsdg instanceof AdvertisementInfo)) {
        localsdg = null;
      }
      paramsdg = (AdvertisementInfo)localsdg;
      if ((paramsdg != null) && (paramReadInJoyVideoAdHighLightBar != null)) {
        paramReadInJoyVideoAdHighLightBar.setText(a(paramsdg, paramReadInJoyVideoAdHighLightBar.getContext()));
      }
      return;
    }
  }
  
  public final void a(@Nullable sdg paramsdg, @Nullable sdc paramsdc, @Nullable rti paramrti)
  {
    if (paramsdg != null) {}
    Object localObject2;
    AdvertisementInfo localAdvertisementInfo;
    for (Object localObject1 = paramsdg.a;; localObject1 = null)
    {
    ...
    if (paramsdc != null)
    {
      localObject1 = paramsdc.a();
      if (localObject1 != null)
      {
        localObject1 = ((sdy)localObject1).a();
        if (paramsdc == null) {
          break label229;
        }
        localObject2 = paramsdc.a();
        if (localObject2 == null) {
          break label229;
        }
        localObject2 = ((sdy)localObject2).a();
        Object localObject3 = localAdvertisementInfo.adExperimentData;
        if (localObject3 == null) {
          break label235;
        }
        localObject3 = ((trw)localObject3).a();
        if (localObject3 == null) {
          break label235;
        }
        i = ((try)localObject3).a();
    ...
    label247:
    label253:
    for (long l2 = paramsdc.a();; l2 = -1L)
    {
      if (l1 > 0L) {
        break label261;
      }
      twb.b((View)localObject1);
      twb.b((View)localObject2);
      return;
      localObject1 = null;
      break;
      localObject2 = null;
    ...
    for (;;)
    {
      twp.a("AdVideo185UIStateUtil", "inSecondArea = " + bool2 + "   inThirdArea = " + bool1);
      if (bool2)
      {
        if (localObject1 == null) {
          break;
        ...
        if ((((ReadInJoyVideoAdHighLightBar)localObject1).getTag() == null) || ((Intrinsics.areEqual(((ReadInJoyVideoAdHighLightBar)localObject1).getTag(), localAdvertisementInfo) ^ true)))
        {
          ...
          ((ReadInJoyVideoAdHighLightBar)localObject1).setOnClickListener((View.OnClickListener)new tvz((ReadInJoyVideoAdHighLightBar)localObject1, localAdvertisementInfo, paramrti, paramsdg));
        }
      ...
      if (bool1)
      {
        ...
        if ((((ReadInJoyAdVideoGuide)localObject2).getTag() == null) || ((Intrinsics.areEqual(((ReadInJoyAdVideoGuide)localObject2).getTag(), localAdvertisementInfo) ^ true)))
        {
          ...
          ((ReadInJoyAdVideoGuide)localObject2).setAdGuideClickListener((tzl)new twa((ReadInJoyAdVideoGuide)localObject2, localAdvertisementInfo, paramrti, paramsdg));
        }
  ...
  public final void b(@Nullable sdg paramsdg, @Nullable ReadInJoyAdVideoGuide paramReadInJoyAdVideoGuide)
  {
    if (paramsdg != null) {}
    for (paramsdg = paramsdg.a;; paramsdg = null)
    {
      ...
      paramsdg = (AdvertisementInfo)localsdg;
      if ((paramsdg != null) && (paramReadInJoyAdVideoGuide != null)) {
        paramReadInJoyAdVideoGuide.setBtnInfo(a(paramsdg, paramReadInJoyAdVideoGuide.getContext()));
      }
      return;
    }
  }
