...
{
  public vnn(AIOGalleryScene paramAIOGalleryScene, ActionSheet paramActionSheet, AIOShortVideoData paramAIOShortVideoData, File paramFile, int paramInt) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    if (paramView.equals(((Resources)localObject).getString(2131435871))) {
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentWidgetActionSheet.dismiss();
      return;
      if (paramView.equals(((Resources)localObject).getString(2131437383)))
      {
      ...
      else if (paramView.equals(((Resources)localObject).getString(2131435882)))
      {
      ...
      else if (paramView.equals(((Resources)localObject).getString(2131435877)))
      {
      ...
      else if (paramView.equals(((Resources)localObject).getString(2131435878)))
      {
      ...
      else if (paramView.equals(((Resources)localObject).getString(2131435875)))
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryScene.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoIAIOImageProvider.asBinder().pingBinder())
        {
          paramView = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryScene.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoIAIOImageProvider.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData.g, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOShortVideoData.f, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryScene.g);
      ...
      else if (paramView.equals(AIOGalleryScene.X(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryScene).getResources().getString(2131435883)))
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryScene.t();
      }
      else if (paramView.equals(AIOGalleryScene.Y(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryScene).getString(2131435895)))
      {
        paramView = null;
