...
public class alov
{
  ...
  public static String a(long paramLong1, long paramLong2, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (new File(paramString).exists())
      {
        ...
        int i = QZoneVideoCompressor.trimByFFmpeg(new String[] { "-y", "-i", paramString, "-ss", a(paramLong1), "-t", a(paramLong2), "-c", "copy", str });
        if (i == 0) {
          break label182;
        }
  ...
  public static String a(long paramLong1, String paramString, long paramLong2)
  {
    ...
    //   34: l2i
    //   35: istore 6
    //   37: new 119	java/io/BufferedWriter
    //   40: dup
    //   41: new 121	java/io/OutputStreamWriter
    //   44: dup
    //   45: new 123	java/io/FileOutputStream
    //   48: dup
    //   49: aload 10
    //   51: invokespecial 124	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   54: invokespecial 127	java/io/OutputStreamWriter:<init>	(Ljava/io/OutputStream;)V
    //   57: invokespecial 130	java/io/BufferedWriter:<init>	(Ljava/io/Writer;)V
    //   60: astore 8
    //   62: iconst_0
    //   63: istore 5
    //   65: iload 5
    ...
    //   98: invokevirtual 135	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   112: invokevirtual 140	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   115: aload 8
    //   117: astore 7
    //   119: aload 8
    //   121: invokevirtual 143	java/io/BufferedWriter:newLine	()V
    //   124: iload 5
    //   126: iconst_1
    //   127: iadd
    //   128: istore 5
    ...
    //   135: astore 7
    //   137: aload 8
    //   139: invokevirtual 146	java/io/BufferedWriter:flush	()V
    //   142: aload 8
    //   144: ifnull +8 -> 152
    //   147: aload 8
    //   149: invokevirtual 149	java/io/BufferedWriter:close	()V
    //   152: bipush 12
    ...
    //   200: bipush 8
    //   202: lload_0
    //   203: invokestatic 85	alov:a	(J)Ljava/lang/String;
    //   206: aastore
    //   207: dup
    //   208: bipush 9
    //   210: ldc 89
    ...
    //   219: dup
    //   220: bipush 11
    //   222: getstatic 33	alov:a	Ljava/lang/String;
    //   225: aastore
    //   226: invokestatic 97	cooperation/qzone/video/QZoneVideoCompressor:trimByFFmpeg	([Ljava/lang/String;)I
    //   229: istore 5
    ...
    //   269: invokestatic 166	cooperation/qzone/util/QZLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   272: iload 5
    //   274: ifeq +131 -> 405
    //   277: ldc 99
    //   279: iconst_2
    ...
    //   298: iload 5
    //   300: invokevirtual 104	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   303: invokevirtual 32	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   306: aastore
    //   307: invokestatic 110	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   310: aconst_null
    //   311: areturn
    //   312: astore_2
    //   313: ldc 99
    ...
    //   321: invokestatic 171	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   324: goto -172 -> 152
    //   327: astore 9
    //   329: aconst_null
    //   330: astore_2
    ...
    //   343: invokestatic 171	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   346: aload_2
    //   347: ifnull -195 -> 152
    //   350: aload_2
    //   351: invokevirtual 149	java/io/BufferedWriter:close	()V
    //   354: goto -202 -> 152
    //   357: astore_2
    //   358: ldc 99
    //   360: iconst_2
    ...
    //   366: invokestatic 171	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   369: goto -217 -> 152
    //   372: astore_2
    //   373: aconst_null
    //   374: astore 7
    ...
    //   378: ifnull +8 -> 386
    //   381: aload 7
    //   383: invokevirtual 149	java/io/BufferedWriter:close	()V
    //   386: aload_2
    //   387: athrow
    //   388: astore 7
    //   390: ldc 99
    ...
    //   399: invokestatic 171	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   402: goto -16 -> 386
    //   405: getstatic 33	alov:a	Ljava/lang/String;
    //   408: areturn
    //   409: astore_2
    //   410: goto -34 -> 376
    //   413: astore 9
  ...
  public static String a(String paramString)
  {
    ...
    if ((!TextUtils.isEmpty(paramString)) && (new File(paramString).exists()))
    {
      ...
      int i = QZoneVideoCompressor.trimByFFmpeg(new String[] { "-y", "-i", paramString, "-an", "-c", "copy", str });
      if (i != 0) {
  ...
  public static String a(String paramString1, String paramString2, long paramLong)
  {
    if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)))
    {
      ...
      int i = QZoneVideoCompressor.trimByFFmpeg(arrayOfString);
      if (i != 0)
      {
  ...
  public static String a(List<String> paramList)
  {
    ...
    //   1: ifnull +423 -> 424
    //   4: aload_0
    //   5: invokeinterface 240 1 0
    //   10: iconst_1
    //   11: if_icmpne +16 -> 27
    //   14: aload_0
    //   15: iconst_0
    //   16: invokeinterface 244 2 0
    ...
    //   54: astore 4
    //   56: new 119	java/io/BufferedWriter
    //   59: dup
    //   60: new 121	java/io/OutputStreamWriter
    //   63: dup
    //   64: new 123	java/io/FileOutputStream
    //   67: dup
    //   68: aload 4
    //   70: invokespecial 124	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   73: invokespecial 127	java/io/OutputStreamWriter:<init>	(Ljava/io/OutputStream;)V
    //   76: invokespecial 130	java/io/BufferedWriter:<init>	(Ljava/io/Writer;)V
    //   79: astore_3
    //   80: aload_3
    //   81: astore_2
    //   82: aload_0
    ...
    //   137: invokevirtual 135	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   151: invokevirtual 140	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   154: aload_3
    //   155: astore_2
    //   156: aload_3
    //   157: invokevirtual 143	java/io/BufferedWriter:newLine	()V
    //   160: goto -71 -> 89
    //   163: astore_2
    //   164: aload_3
    //   165: astore_0
    ...
    //   178: invokestatic 171	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   181: aload_0
    //   182: ifnull +7 -> 189
    //   185: aload_0
    //   186: invokevirtual 149	java/io/BufferedWriter:close	()V
    ...
    //   208: invokestatic 178	java/util/UUID:randomUUID	()Ljava/util/UUID;
    //   211: invokevirtual 262	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   214: ldc_w 264
    ...
    //   280: aload_0
    //   281: aastore
    //   282: invokestatic 97	cooperation/qzone/video/QZoneVideoCompressor:trimByFFmpeg	([Ljava/lang/String;)I
    //   285: istore_1
    //   286: new 23	java/io/File
    //   289: dup
    //   290: aload 4
    //   292: invokespecial 66	java/io/File:<init>	(Ljava/lang/String;)V
    //   295: invokevirtual 160	java/io/File:delete	()Z
    //   298: ifeq +12 -> 310
    //   301: ldc 99
    //   303: ldc_w 266
    //   306: invokestatic 271	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   309: pop
    //   310: iload_1
    //   311: ifeq -286 -> 25
    //   314: ldc 99
    ...
    //   336: iload_1
    //   337: invokevirtual 104	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   340: invokevirtual 32	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   343: aastore
    //   344: invokestatic 110	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   347: aconst_null
    //   348: areturn
    //   349: aload_3
    //   350: astore_2
    //   351: aload_3
    //   352: invokevirtual 146	java/io/BufferedWriter:flush	()V
    //   355: aload_3
    //   356: ifnull -167 -> 189
    //   359: aload_3
    //   360: invokevirtual 149	java/io/BufferedWriter:close	()V
    //   363: goto -174 -> 189
    //   366: astore_0
    //   367: ldc 99
    //   369: iconst_2
    ...
    //   375: invokestatic 171	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   378: goto -189 -> 189
    //   381: astore_0
    //   382: ldc 99
    //   384: iconst_2
    ...
    //   390: invokestatic 171	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   393: goto -204 -> 189
    //   396: astore_0
    //   397: aconst_null
    //   398: astore_2
    ...
    //   400: ifnull +7 -> 407
    //   403: aload_2
    //   404: invokevirtual 149	java/io/BufferedWriter:close	()V
    //   407: aload_0
    //   408: athrow
    //   409: astore_2
    //   410: ldc 99
    ...
    //   418: invokestatic 171	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   421: goto -14 -> 407
    //   424: aconst_null
    //   425: areturn
    //   426: astore_0
  ...
  public static String b(String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      if (new File(paramString).exists())
      {
        ...
        int i = QZoneVideoCompressor.trimByFFmpeg(new String[] { "-y", "-i", paramString, "-vn", "-c", "copy", "-map", "0:a:0", str });
        if (i == 0) {
          return str;
        }
  ...
  public static String c(String paramString)
  {
    if ((paramString != null) && (new File(paramString).exists()))
    {
      ...
      int i = QZoneVideoCompressor.trimByFFmpeg(new String[] { "-y", "-i", paramString, "-c:a", "aac", str });
      if (i != 0)
      {
