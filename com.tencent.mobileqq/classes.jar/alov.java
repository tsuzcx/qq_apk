  ...
  implements Manager
{
  ...
  axvo jdField_a_of_type_Axvo = null;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  protected ArrayList<atxp> a;
  public ConcurrentHashMap<String, BusinessCard> a;
  protected ConcurrentHashMap<String, BusinessCard> b;
  
  public alov(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramBusinessCard != null)
    {
      ...
      if (str != null)
      {
        ...
        if (str.length() != 0)
        {
          ...
          this.jdField_a_of_type_Atmp.b(paramBusinessCard);
          bool1 = bool2;
  ...
  {
    if (paramBusinessCard != null) {
      this.jdField_a_of_type_Atmp.a(paramBusinessCard);
    }
  }
  ...
  {
    List localList = this.jdField_a_of_type_Atmp.a(BusinessCard.class);
  ...
  public void a(ArrayList<atxp> paramArrayList)
  {
  ...
  public void a(List<BusinessCard> paramList, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (paramBoolean) {
        this.jdField_a_of_type_Atmp.a(BusinessCard.class.getSimpleName());
      }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Atmp.a(BusinessCard.class);
  }
  ...
  public BusinessCard d(String paramString)
  {
    ...
    BusinessCard localBusinessCard2 = (BusinessCard)this.jdField_a_of_type_Atmp.a(BusinessCard.class, paramString);
