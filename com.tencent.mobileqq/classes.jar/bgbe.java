  ...
  extends BusinessHandler
{
  ...
  private ConcurrentHashMap<Long, bgcg> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  public AtomicLong a;
  
  public bgbe(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong = new AtomicLong(0L);
    this.jdField_a_of_type_Bgbg = ((bgbg)paramQQAppInterface.getManager(QQManagerFactory.TROOP_SHORTCUTBAR_MANAGER));
  }
    ...
    if (j == 0)
    {
      ...
      if (localRspBody.app.has())
      {
        ...
        while (paramObject.hasNext()) {
          paramFromServiceMsg.add(bgbb.a((cmd0xe82.App)paramObject.next()));
        }
      }
      paramFromServiceMsg = new bgbf(l1, k, m, n, i1, l2, paramFromServiceMsg);
      paramObject = (bgbg)this.app.getManager(QQManagerFactory.TROOP_SHORTCUTBAR_MANAGER);
      if (i == 1) {}
      for (bool = true;; bool = false)
      {
        ...
        {
          paramToServiceMsg.append(((bgbb)paramFromServiceMsg.a().get(i)).b()).append("|");
          i += 1;
        }
      }
      if (QLog.isColorLevel()) {
  ...
  {
    bgbf localbgbf = this.jdField_a_of_type_Bgbg.a(Long.valueOf(paramLong));
    if (localbgbf == null) {
      if (QLog.isColorLevel()) {
    ...
    {
      return true;
      if ((localbgbf.a().size() <= 0) || (System.currentTimeMillis() <= localbgbf.b())) {
        break;
      }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0)
    {
      ((bgbg)this.app.getManager(QQManagerFactory.TROOP_SHORTCUTBAR_MANAGER)).a(l, i, bool);
      if (QLog.isColorLevel()) {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Long.valueOf(l))) && (((bgcg)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(l))).a(paramFromServiceMsg, paramObject))) {
  ...
  public void a(long paramLong, int paramInt, Object paramObject)
  {
    ...
    ((cmd0xe82.ClientInfo)localObject).version.set("8.4.10");
  ...
  public void a(long paramLong, int paramInt, boolean paramBoolean)
  {
    ...
    if (((bgbg)this.app.getManager(QQManagerFactory.TROOP_SHORTCUTBAR_MANAGER)).a(Long.valueOf(paramLong)) == null) {
      return;
    }
