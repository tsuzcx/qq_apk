...
public class bqmz
  implements bqjo
{
  public bqmz(DoodleLayout paramDoodleLayout) {}
  
  public void a(int paramInt)
  {
    if (this.a.jdField_a_of_type_Bqnc != null) {
      this.a.jdField_a_of_type_Bqnc.a(1, paramInt);
    }
  }
  ...
  public boolean a(bqjl parambqjl)
  {
    boolean bool = false;
    ...
    this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleEditView.a.a(parambqjl);
    parambqjl.k = true;
    SegmentKeeper localSegmentKeeper = parambqjl.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper;
    ...
    if ((parambqjl.h == 1) || (parambqjl.h == 3)) {
      parambqjl.jdField_a_of_type_AndroidGraphicsDrawableDrawable.setCallback(this.a.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleEditView);
    }
