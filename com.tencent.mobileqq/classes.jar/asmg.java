...
public class asmg
  extends bdul
{
  public asmg(QQGamePubAccountFragment paramQQGamePubAccountFragment) {}
  ...
  protected void onGetGameCenterPubAccountFeeds(boolean paramBoolean, Object paramObject)
  {
    ...
    if ((paramBoolean) && (paramObject != null))
    {
      ...
      {
        asnk.a = localJSONObject.optInt("video_count");
        asnk.b = localJSONObject.optInt("video_time") * 1000;
        asnk.c = localJSONObject.optInt("layer_duration") * 1000;
      ...
      if (paramBoolean) {
        ...
        {
          aahi.a(akwd.a(), "769", "205353", str1, "76901", "1", "160", new String[] { localObject1, "", "20" });
    ...
    for (;;)
    {
      ...
      if (paramObject.size() == 0) {
        if (localObject2 == null)
        {
          ...
          label495:
          QQGamePubAccountFragment.a(this.a).a(false, false);
          QQGamePubAccountFragment.c(this.a).put(Long.valueOf(l), asnl.b);
          aahi.a(akwd.a(), "769", "205353", str1, "76901", "1", "160", new String[] { localObject1, "", "20" });
        }
      }
      for (;;)
      {
        ...
        this.a.a(false);
        break label495;
        QQGamePubAccountFragment.c(this.a).put(Long.valueOf(l), asnl.a);
        QQGamePubAccountFragment.a(this.a).a(false, false);
      }
      if (paramObject != null)
      {
        ...
        aahi.a(akwd.a(), "769", "205353", (String)localObject1, "76901", "1", "160", new String[] { paramObject, "", "20" });
      ...
      if (this.a.getActivity() != null) {
        QQToast.a(this.a.getActivity(), alud.a(2131710695), 0).a();
      }
    }
  }
}
