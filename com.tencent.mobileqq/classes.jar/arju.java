...
public class arju
{
  ...
  public static arju a(araj[] paramArrayOfaraj)
  {
    arju localarju = new arju();
    if ((paramArrayOfaraj != null) && (paramArrayOfaraj.length > 0))
    {
      ...
      while (i < j)
      {
        ...
        if ((localObject == null) || (((araj)localObject).jdField_a_of_type_JavaLangString == null))
        {
          i += 1;
        }
        else
          ...
          for (;;)
          {
            try
            {
              ...
              if (localJSONObject.has("announcementUrl")) {
                localarju.jdField_a_of_type_JavaLangString = localJSONObject.optString("announcementUrl");
              }
              if (localJSONObject.has("autoApprovalUrl")) {
                localarju.b = localJSONObject.optString("autoApprovalUrl");
              }
              ...
              bool = true;
              localarju.jdField_a_of_type_Boolean = bool;
            }
            ...
            bool = false;
            continue;
            localarju.jdField_a_of_type_Boolean = false;
          }
        }
      }
    }
    if (TextUtils.isEmpty(localarju.jdField_a_of_type_JavaLangString)) {
      localarju.jdField_a_of_type_JavaLangString = "https://web.qun.qq.com/mannounce/index.html?_wv=1031&_bid=148#gc=$GCODE$&role=$ROLE$&actionIcon=1&from=troop_profile";
    }
    if (TextUtils.isEmpty(localarju.b)) {
      localarju.b = "https://qun.qq.com/qqweb/m/qun/qun_robot/auto-approval.html?_wv=1027&gc=$GCODE$&page=groupSetting";
    }
    return localarju;
  }
