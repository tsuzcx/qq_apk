...
public class arju
  implements arem, Manager
{
  QQAppInterface a;
  
  public arju(QQAppInterface paramQQAppInterface)
  {
    this.a = paramQQAppInterface;
  }
  
  public static Bundle a(IVPluginInfo paramIVPluginInfo, arei paramarei)
  {
    int m = 0;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject2 = (ajxn)((AppRuntime)localObject1).getManager(51);
        localObject3 = ((ajxn)localObject2).e(str2);
        ...
        localObject3 = ((ajxn)localObject2).b(str2);
        if (localObject3 == null) {
          break label452;
        }
      ...
      localBundle.putString("payToken", paramarei.a().c);
