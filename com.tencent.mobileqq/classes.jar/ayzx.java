...
{
  public static final ayzy a = new ayzy(null);
  
  public ayzx(@NotNull QQAppInterface paramQQAppInterface)
  {
  ...
  private final void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    Object localObject1 = (amsw)paramFromServiceMsg;
    paramFromServiceMsg = ((amsw)localObject1).c(paramToServiceMsg);
    boolean bool3 = bool1;
    int j = k;
    boolean bool2;
    int i;
    ...
    for (;;)
    {
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        bool2 = bool1;
        i = k;
        ((amsw)localObject1).a(paramFromServiceMsg);
        bool2 = bool1;
        i = k;
        bool3 = bool1;
        j = k;
  ...
  private final void a(oidb_0x5eb.UdcUinData paramUdcUinData, Card paramCard)
  {
    ...
    if (paramUdcUinData.uint32_profile_sex_visible.has())
    {
      ...
      localazbd.a(41611, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_age_visible.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(41610, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_birthday_visible.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(41607, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_constellation_visible.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(41609, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_profession_visible.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(41618, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_college_visible.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(41619, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_location_visible.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(41614, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_hometown_visible.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(41613, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_email_visible.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(41622, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_personal_note_visible.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(41623, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_company_visible.has())
    {
      ...
      localazbd.a(40272, i, paramCard, paramUdcUinData);
    }
  }
  ...
  private final void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    Object localObject2 = (amsw)paramFromServiceMsg;
    paramFromServiceMsg = ((amsw)localObject2).c((String)localObject1);
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      if (bool1)
      {
        ...
        for (;;)
        {
          ...
          bool2 = bool1;
          i = j;
          ((azbd)localObject3).a(k, m, paramFromServiceMsg, (QQAppInterface)localObject4);
        }
        bool2 = bool1;
        i = j;
        ((amsw)localObject2).a(paramFromServiceMsg);
        i = j;
        break;
      }
      bool1 = bool2;
  ...
  private final void b(oidb_0x5eb.UdcUinData paramUdcUinData, Card paramCard)
  {
    ...
    if (paramUdcUinData.uint32_req_medalwall_flag.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(42075, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_personality_label_switch.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(42128, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_life_achievement_switch.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(42367, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_interest_switch.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(40313, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_music_switch.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(40314, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_present_switch.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(42289, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_miniapp_switch.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(42323, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_musicbox_switch.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(42340, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_sticky_note_switch.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(42356, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_qqcircle_switch.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(42361, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_weishi_switch.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(42377, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_extend_friend_card_shown.has())
    {
      ...
      localQQAppInterface = this.app;
      Intrinsics.checkExpressionValueIsNotNull(localQQAppInterface, "app");
      localazbd.a(42172, i, paramCard, localQQAppInterface);
    }
    if (paramUdcUinData.uint32_profile_anonymous_answer_switch.has())
    {
      localazbd = azbc.a;
      i = paramUdcUinData.uint32_profile_anonymous_answer_switch.get();
      paramUdcUinData = this.app;
      Intrinsics.checkExpressionValueIsNotNull(paramUdcUinData, "app");
      localazbd.a(42425, i, paramCard, paramUdcUinData);
    }
  }
  ...
  public boolean msgCmdFilter(@Nullable String paramString)
  {
