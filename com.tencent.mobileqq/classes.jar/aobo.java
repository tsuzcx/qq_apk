...
{
  aobo(Context paramContext, QQAppInterface paramQQAppInterface, Emoticon paramEmoticon, anvs paramanvs, SessionInfo paramSessionInfo, EmojiStickerManager.StickerInfo paramStickerInfo) {}
  ...
  public void a(EmoticonPackage paramEmoticonPackage)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Anvs.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, Boolean.valueOf(false))) {
        break label170;
      }
    ...
    return;
    label170:
    Object localObject = asdh.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, 0);
    if ((localObject != null) && (((ascp)localObject).a))
    {
      if (asdy.a())
      {
    ...
    do
    {
      ...
      return;
      int j = ascj.a(asdh.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, 0));
      int i = 0;
      ...
      if ((localObject != null) && (!((ascp)localObject).c))
      {
        aaod.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon);
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X800579D", 0, 0, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, "", "", "");
        return;
      }
      localObject = ((FragmentActivity)this.jdField_a_of_type_AndroidContentContext).getChatFragment();
    } while (localObject == null);
    ((ChatFragment)localObject).a().a().a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, new aobp(this, paramEmoticonPackage));
    return;
    label483:
