  ...
  implements SurfaceTexture.OnFrameAvailableListener, GLSurfaceView.Renderer
{
  ...
  aobi jdField_a_of_type_Aobi;
  aobn jdField_a_of_type_Aobn = new aobn();
  private hh jdField_a_of_type_Hh = new hh();
  ...
  private aobp[] jdField_a_of_type_ArrayOfAobp = new aobp[300];
  ...
  public aobo(aobd paramaobd)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Aobd = paramaobd;
    this.jdField_a_of_type_Aobi = paramaobd.a();
  }
  
  public int a()
  {
    return this.jdField_a_of_type_Aobn.a();
  }
  ...
  protected void a()
  {
    ...
    try
    {
      ...
      localObject = BitmapFactory.decodeResource(BaseApplicationImpl.getApplication().getResources(), 2130844773, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
    ...
    try
    {
      localObject = new BitmapFactory.Options();
      ((BitmapFactory.Options)localObject).inPreferredConfig = Bitmap.Config.ARGB_8888;
      localObject = BitmapFactory.decodeResource(this.jdField_a_of_type_Aobd.a().getResources(), 2130844774, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
        GLUtils.texImage2D(3553, 0, (Bitmap)localObject, 0);
        ((Bitmap)localObject).recycle();
  ...
  {
    this.u = 1;
    this.jdField_a_of_type_Aobi.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_Aobi.c = 0L;
    this.jdField_a_of_type_Aobi.jdField_b_of_type_Long = 0L;
  ...
  public void a(FloatBuffer paramFloatBuffer, Size paramSize)
  {
    ...
    if ((this.jdField_a_of_type_AndroidUtilSize == null) && (this.jdField_a_of_type_Aobn != null))
    {
      this.jdField_a_of_type_AndroidUtilSize = paramSize;
      this.jdField_a_of_type_Aobn.a(paramSize.getHeight(), paramSize.getWidth(), aolz.jdField_a_of_type_Int, aolz.jdField_b_of_type_Int);
    }
  }
  ...
  public void c()
  {
    ...
    if (i4 < 300)
    {
      localaobp2 = this.jdField_a_of_type_ArrayOfAobp[i4];
      if ((localaobp2 != null) && (!localaobp2.jdField_a_of_type_Boolean))
      {
        if (this.jdField_a_of_type_JavaUtilRandom.nextFloat() > 0.7F - localaobp2.jdField_b_of_type_Float * 0.35F - Math.abs(localaobp2.jdField_a_of_type_Float * 0.3F - 0.15F)) {
          localaobp2.jdField_a_of_type_Boolean = true;
        }
      }
      else
      {
        if (localaobp2 != null)
        {
          localaobp1 = localaobp2;
          i3 = i2;
          if (!localaobp2.jdField_a_of_type_Boolean) {
            break label370;
          }
        }
        if (i2 <= i7) {
    ...
    for (;;)
    {
      ...
      float f4 = localaobp2.jdField_b_of_type_Float;
      localaobp2.jdField_b_of_type_Float = (f3 * 0.3F + 0.2F * localaobp2.jdField_b_of_type_Float + f2 + f4);
      if (localaobp2.jdField_b_of_type_Float <= 1.0D) {
        break label184;
      }
      localaobp2.jdField_a_of_type_Boolean = true;
      break label184;
      ...
      if (localaobp2 == null)
      {
        localaobp1 = new aobp(this);
        this.jdField_a_of_type_ArrayOfAobp[i4] = localaobp1;
      }
      f3 = this.jdField_a_of_type_JavaUtilRandom.nextFloat();
      if (f3 < 0.4D) {
        localaobp1.jdField_a_of_type_Float = (f3 * 2.35F + 0.02F);
      }
      for (;;)
      {
        localaobp1.jdField_b_of_type_Float = (this.jdField_a_of_type_JavaUtilRandom.nextFloat() * 0.05F + f1);
        localaobp1.jdField_a_of_type_Boolean = false;
        i3 = i2 + 1;
        label370:
        if ((localaobp1 == null) || (localaobp1.jdField_a_of_type_Boolean) || (localaobp1.jdField_b_of_type_Float >= 1.0D)) {
          break label542;
        }
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2)] = (this.jdField_a_of_type_ArrayOfAobp[i4].jdField_a_of_type_Float * i5);
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2 + 1)] = (this.jdField_a_of_type_ArrayOfAobp[i4].jdField_b_of_type_Float * i6);
        i1 += 1;
        i2 = i3;
        break;
        if (f3 > 0.6F) {
          localaobp1.jdField_a_of_type_Float = ((1.0F - f3) * 2.35F + 0.02F);
        }
      }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        a(this.jdField_a_of_type_ArrayOfFloat, this.jdField_a_of_type_Hh.a(), this.jdField_a_of_type_Hh.d(), this.jdField_a_of_type_Hh.b(), paramGL10, this.jdField_a_of_type_Hh.b(), this.jdField_a_of_type_Hh.c());
        a(0, this.jdField_a_of_type_Hh.a());
        d();
        e();
        f();
      ...
      if (this.jdField_a_of_type_Aobi.jdField_a_of_type_Long == 0L) {
        break;
      }
      while (this.jdField_a_of_type_Aobi.c > this.jdField_a_of_type_Aobi.jdField_b_of_type_Long)
      {
        paramGL10 = this.jdField_a_of_type_Aobi;
      ...
      continue;
      label318:
      if ((this.jdField_a_of_type_Aobn != null) && (this.u == 2)) {
        this.jdField_a_of_type_Aobn.a(this.jdField_a_of_type_JavaNioFloatBuffer);
      }
    }
  }
