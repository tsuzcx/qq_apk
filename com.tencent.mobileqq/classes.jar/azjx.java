  ...
  extends azjt
{
  ...
  String b()
  {
    ...
    {
      localObject = new azkn();
      ((azkn)localObject).jdField_b_of_type_Int = this.jdField_b_of_type_Int;
      ((azkn)localObject).d = this.d;
      ((azkn)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
      ((azkn)localObject).f = this.f;
      localObject = URLDrawableHelper.getURL((azkn)localObject, n, null);
      if (localObject == null) {
        break label129;
      }
