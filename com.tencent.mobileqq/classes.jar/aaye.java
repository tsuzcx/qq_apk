  ...
  extends blqv
{
  ...
  private void a(View paramView)
  {
    if ((paramView instanceof ProteusItemView))
    {
      ...
      localValueAnimator.addUpdateListener(new aayg(this, paramView));
      localValueAnimator.start();
    }
    do
    {
      return;
      paramView = paramView.findViewById(2131376925);
    } while (paramView == null);
    ValueAnimator localValueAnimator = ValueAnimator.ofInt(new int[] { -paramView.getHeight(), 0 });
    localValueAnimator.setDuration(500L);
    localValueAnimator.addUpdateListener(new aayh(this, paramView));
    localValueAnimator.start();
  }
  ...
  protected View a(View paramView, int paramInt)
  {
    ...
    paramView.getViewTreeObserver().addOnPreDrawListener(new aayf(this, paramView));
    return paramView;
  }
