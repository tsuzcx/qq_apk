  ...
  implements BaseConstants.NetType
{
  ...
  private static avcl[] jdField_a_of_type_ArrayOfAvcl = new avcl[4];
  
  static
  {
    jdField_a_of_type_ArrayOfAvcl[1] = new avcl();
    jdField_a_of_type_ArrayOfAvcl[2] = new avcl();
    jdField_a_of_type_ArrayOfAvcl[3] = new avcl();
  }
  
  public static avcl a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    a(paramQQAppInterface, false);
    return jdField_a_of_type_ArrayOfAvcl[paramInt];
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, int paramInt, avcl paramavcl)
  {
    ...
    try
    {
      a(((String)localObject).substring(((String)localObject).indexOf(':') + 1), paramavcl);
      return paramQQAppInterface;
    }
    catch (Exception paramavcl) {}
    return paramQQAppInterface;
  }
  ...
  public static void a()
  {
    ...
    jdField_a_of_type_ArrayOfAvcl = new avcl[4];
    jdField_a_of_type_ArrayOfAvcl[1] = new avcl();
    jdField_a_of_type_ArrayOfAvcl[2] = new avcl();
    jdField_a_of_type_ArrayOfAvcl[3] = new avcl();
  }
  
  public static void a(QQAppInterface paramQQAppInterface, avcl paramavcl, int paramInt)
  {
    ...
    ((StringBuilder)localObject).append(paramavcl.jdField_a_of_type_Int);
    int i = 0;
    while (i <= 5)
    {
      ((StringBuilder)localObject).append('#').append(i).append('_').append(paramavcl.jdField_a_of_type_ArrayOfInt[i]);
      i += 1;
    }
    paramQQAppInterface = paramQQAppInterface.getCurrentAccountUin();
    paramavcl = BaseApplicationImpl.sApplication.getSharedPreferences("RecordParams_" + paramQQAppInterface, 0);
    localObject = ((StringBuilder)localObject).toString();
    paramavcl.edit().putString("PTTPreDownloadParams_" + paramInt, (String)localObject).commit();
    if (QLog.isDevelopLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((arrayOfString != null) && (arrayOfString.length >= 2))
        {
          ...
          if ((j >= 1) && (j < jdField_a_of_type_ArrayOfAvcl.length))
          {
            avcl localavcl = jdField_a_of_type_ArrayOfAvcl[j];
            a(arrayOfString[1], localavcl);
          }
        }
      }
  ...
  private static void a(String paramString, avcl paramavcl)
  {
    ...
    {
      return;
      paramavcl.jdField_a_of_type_Int = Integer.parseInt(paramString[0]);
      int i = 1;
      for (;;)
      {
        ...
        paramavcl.jdField_a_of_type_ArrayOfInt[j] = k;
        i += 1;
      }
    }
  }
