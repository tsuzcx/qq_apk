...
public class bfqw
{
  private static bfqw jdField_a_of_type_Bfqw;
  ...
  public static bfqw a()
  {
    try
    {
      if (jdField_a_of_type_Bfqw == null) {
        jdField_a_of_type_Bfqw = new bfqw();
      }
      bfqw localbfqw = jdField_a_of_type_Bfqw;
      return localbfqw;
    }
    finally {}
  }
  ...
  public void a(String paramString, int paramInt, SSOAccountObserver paramSSOAccountObserver, boolean paramBoolean)
  {
    ...
    Object localObject2;
    Object localObject1;
    if ((!bfnz.a(paramString)) && (!paramBoolean))
    {
      ...
      default: 
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          {
            bfbi.a(null, 2, "delegateGetTicketNoPasswd fake SSOAccountObserver success.");
