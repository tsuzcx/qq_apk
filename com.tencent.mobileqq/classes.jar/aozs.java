  ...
  implements Handler.Callback
{
  ...
  public aozs(aozl paramaozl, ViewGroup paramViewGroup)
  {
    this.jdField_a_of_type_Aozl = paramaozl;
    this.jdField_a_of_type_AndroidViewView = paramaozl.a().getLayoutInflater().inflate(2131494912, paramViewGroup, false);
    int i = View.MeasureSpec.makeMeasureSpec(0, 0);
    this.jdField_a_of_type_AndroidViewView.measure(i, i);
    TextView localTextView1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131307701);
    TextView localTextView2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131307699);
    paramViewGroup = (AsyncImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131307700);
    String str = paramaozl.a();
    i = paramaozl.a();
    localTextView1.setText(apck.a(str, true, localTextView1.getMeasuredWidth(), localTextView1.getPaint(), 1));
    localTextView2.setText(apdh.a(paramaozl.a()));
    paramViewGroup.setImageResource(apck.b(str));
    if ((i == 5) || (i == 0))
    {
      paramaozl = paramaozl.b();
      if (apdh.b(paramaozl))
      {
        if (i != 5) {
          break label234;
        }
        paramViewGroup.setApkIconAsyncImage(paramaozl);
      }
    }
    for (;;)
    {
      ...
      this.b = new beez(ThreadManagerV2.getFileThreadLooper(), this, false);
      return;
      label234:
      paramViewGroup.setAsyncImage(paramaozl);
    }
  }
  ...
  private Bitmap a(Bitmap paramBitmap, int paramInt, String paramString)
  {
    ...
    localAsyncImageView = (AsyncImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131307691);
    localAsyncImageView.setImageBitmap(paramBitmap);
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131307703);
    BaseApplicationImpl localBaseApplicationImpl = BaseApplicationImpl.sApplication;
    if (TextUtils.isEmpty(paramString))
    {
      paramBitmap = new StringBuilder().append(BaseApplicationImpl.sApplication.getString(2131632494)).append(":");
      paramString = BaseApplicationImpl.sApplication;
      if (paramInt == 1) {
        paramInt = 2131632492;
      }
    }
    for (paramBitmap = paramString.getString(paramInt);; paramBitmap = BaseApplicationImpl.sApplication.getString(2131632495) + ":" + paramString)
    {
      localTextView.setText(localBaseApplicationImpl.getString(2131632485, new Object[] { paramBitmap }));
      try
      {
  ...
  private static String a(Bitmap paramBitmap)
  {
    ...
    try
    {
      paramBitmap = vvp.a(BaseApplicationImpl.sApplication, str, paramBitmap);
      return paramBitmap;
    }
  ...
  private void a(int paramInt, Bitmap paramBitmap, String paramString)
  {
    ...
    {
      aozn.a(1, 2131631057, true);
      return;
    }
    if (paramString == null)
    {
      if (paramInt == 47) {}
      for (paramInt = 2131651443;; paramInt = 2131631056)
      {
        aozn.a(1, paramInt, true);
        return;
      }
    }
    Object localObject2;
    ...
    case 2: 
      ...
      aphp.a((Activity)localObject1, paramBitmap, 1, -1);
      return;
    case 3: 
      paramBitmap = bfpy.a();
      ...
      bfpr.a((Activity)localObject1, paramBitmap, paramString, ((BaseActivity)localObject1).getString(2131626640), ((BaseActivity)localObject1).getString(2131632485, new Object[] { "" }), 2);
      return;
    case 9: 
    case 10: 
    ...
    aozn.a(2, ((BaseActivity)localObject1).getString(2131651444, new Object[] { paramString }), true);
  }
  ...
  private static String b(Bitmap paramBitmap)
  {
    ...
    //   9: ifnull +365 -> 374
    //   12: aload_0
    //   13: invokevirtual 418	android/graphics/Bitmap:isRecycled	()Z
    //   16: ifne +358 -> 374
    //   19: new 420	java/io/File
    //   22: dup
    //   23: getstatic 425	ajed:ba	Ljava/lang/String;
    //   26: invokespecial 426	java/io/File:<init>	(Ljava/lang/String;)V
    //   29: astore_3
    //   30: aload_3
    //   31: invokevirtual 429	java/io/File:mkdirs	()Z
    //   34: pop
    //   35: aload_3
    //   36: invokevirtual 432	java/io/File:canWrite	()Z
    //   39: ifeq +335 -> 374
    //   42: invokestatic 232	java/lang/System:currentTimeMillis	()J
    //   45: invokestatic 436	java/lang/Long:toString	(J)Ljava/lang/String;
    //   48: astore_3
    //   49: new 420	java/io/File
    //   52: dup
    //   53: new 165	java/lang/StringBuilder
    //   56: dup
    //   57: invokespecial 166	java/lang/StringBuilder:<init>	()V
    //   60: getstatic 425	ajed:ba	Ljava/lang/String;
    ...
    //   72: invokestatic 232	java/lang/System:currentTimeMillis	()J
    //   75: invokevirtual 235	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   78: ldc_w 440
    //   81: invokevirtual 175	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   84: invokevirtual 181	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   87: invokespecial 426	java/io/File:<init>	(Ljava/lang/String;)V
    //   90: astore 5
    //   92: aload 5
    //   94: invokevirtual 443	java/io/File:exists	()Z
    //   97: ifeq +68 -> 165
    //   100: iload_1
    //   101: ldc_w 444
    //   104: if_icmpge +61 -> 165
    //   107: new 420	java/io/File
    //   110: dup
    //   111: new 165	java/lang/StringBuilder
    //   114: dup
    //   115: invokespecial 166	java/lang/StringBuilder:<init>	()V
    //   118: getstatic 425	ajed:ba	Ljava/lang/String;
    //   121: invokevirtual 175	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   124: ldc_w 438
    //   127: invokevirtual 175	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   130: aload_3
    //   131: invokevirtual 175	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   134: ldc_w 446
    //   137: invokevirtual 175	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   140: iload_1
    //   141: invokevirtual 449	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   144: ldc_w 451
    //   147: invokevirtual 175	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   150: invokevirtual 181	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   153: invokespecial 426	java/io/File:<init>	(Ljava/lang/String;)V
    //   156: astore 5
    //   158: iload_1
    //   159: iconst_1
    //   160: iadd
    //   161: istore_1
    //   162: goto -70 -> 92
    //   165: new 453	java/io/BufferedOutputStream
    //   168: dup
    //   169: new 455	java/io/FileOutputStream
    //   172: dup
    //   173: aload 5
    //   175: invokespecial 458	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   178: invokespecial 461	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   181: astore_3
    //   182: aload_3
    //   183: astore 4
    //   185: aload_0
    //   186: getstatic 467	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   189: bipush 100
    //   191: aload_3
    //   192: invokevirtual 471	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   195: istore_2
    //   196: aload_3
    //   197: ifnull +172 -> 369
    //   200: aload_3
    //   201: invokevirtual 474	java/io/BufferedOutputStream:close	()V
    //   204: aconst_null
    //   205: astore_0
    //   206: iload_2
    //   207: ifne +120 -> 327
    //   210: aload 5
    //   212: invokevirtual 443	java/io/File:exists	()Z
    //   215: ifeq +112 -> 327
    //   218: aload 5
    //   220: invokevirtual 477	java/io/File:delete	()Z
    //   223: pop
    //   224: aload_0
    //   225: areturn
    //   226: astore_0
    ...
    //   242: ldc_w 479
    //   245: aload_3
    //   246: invokestatic 247	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   249: ldc 249
    //   251: astore_3
    //   252: aload_0
    //   253: ifnull +109 -> 362
    //   256: aload_0
    //   257: invokevirtual 474	java/io/BufferedOutputStream:close	()V
    //   260: iconst_0
    //   261: istore_2
    //   262: aload_3
    //   263: astore_0
    ...
    //   284: ldc_w 479
    //   287: aload_0
    //   288: invokestatic 222	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   291: aload_3
    //   292: ifnull +63 -> 355
    //   295: aload_3
    //   296: invokevirtual 474	java/io/BufferedOutputStream:close	()V
    //   299: aconst_null
    //   300: astore_0
    //   301: iconst_0
    //   302: istore_2
    ...
    //   317: ifnull +8 -> 325
    //   320: aload 4
    //   322: invokevirtual 474	java/io/BufferedOutputStream:close	()V
    //   325: aload_0
    //   326: athrow
    //   327: aload 5
    //   329: invokevirtual 482	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   332: areturn
    //   333: astore_3
    //   334: goto -9 -> 325
    //   337: astore_0
    ...
    //   90	238	5	localFile	java.io.File
  ...
  {
    boolean bool = true;
    if ((paramInt != 47) && (!badq.d(this.jdField_a_of_type_Aozl.a())))
    {
    ...
    if (this.jdField_a_of_type_Bbms == null)
    {
      this.jdField_a_of_type_Bbms = new bbms(this.jdField_a_of_type_Aozl.a());
  ...
  public boolean a(Bitmap paramBitmap, int paramInt, String paramString)
  {
    ...
    if (paramBitmap == null)
    {
      aozn.a(1, BaseApplicationImpl.sApplication.getResources().getString(2131632479, new Object[] { Integer.valueOf(-2) }), true);
      return false;
    }
    this.jdField_a_of_type_Aozl.a(paramBitmap);
  ...
  public List<bahx>[] a(Context paramContext)
  {
    ...
    localArrayList.add(localbahx);
    localbahx = new bahx();
    localbahx.a = paramContext.getString(2131627205);
