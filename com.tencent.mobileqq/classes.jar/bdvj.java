...
public class bdvj
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    if (TextUtils.isEmpty(str2)) {
      str1 = bdto.a(paramQQAppInterface, paramChatMessage.senderuin);
    }
  ...
  public static void a(axau paramaxau, msg_comm.Msg paramMsg, MessageRecord paramMessageRecord)
  {
    if ((paramaxau != null) && (paramaxau.a == 1024) && (paramMsg.msg_body.rich_text.has()) && (paramMsg.msg_body.rich_text.elems.has()))
    {
      paramaxau = paramMsg.msg_body.rich_text.elems.get().iterator();
      while (paramaxau.hasNext())
      {
        paramMsg = (im_msg_body.Elem)paramaxau.next();
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, long paramLong)
  {
    ...
    {
      i = paramString4.indexOf(paramQQAppInterface.getApp().getString(2131698237));
      if (i != -1) {}
    }
    else
    {
    ...
    paramString4 = new aquz(paramString1, paramQQAppInterface.getCurrentAccountUin(), paramString4, paramInt, -5023, 1245186, awzw.a());
  ...
  public static void a(QQAppInterface paramQQAppInterface, Crm.CrmCCNotify paramCrmCCNotify, msg_comm.Msg paramMsg, axau paramaxau)
  {
    long l = paramMsg.msg_head.from_uin.get();
    if (paramaxau == null) {}
    for (int i = 0;; i = paramaxau.a)
    {
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        axqw.b(paramQQAppInterface, "dc00899", "Qidian", paramString1, str2, "1", 1, 0, str1, "0", String.valueOf(paramInt3), paramString2);
        return;
        if (paramInt2 == -2000)
        {
          str1 = "2";
  ...
  {
    long l = awzw.a();
    paramString1 = new aquz(paramString1, paramQQAppInterface.getCurrentAccountUin(), paramString2, paramInt, -5020, 1245187, l);
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<MessageRecord> paramList, msg_comm.Msg paramMsg, axau paramaxau, Crm.CrmCCNotify paramCrmCCNotify)
  {
    int i = 0;
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<MessageRecord> paramList, im_msg_body.NotOnlineFile paramNotOnlineFile, msg_comm.Msg paramMsg, axau paramaxau)
  {
    ...
    try
    {
      ...
      a(paramQQAppInterface, (Crm.CrmCCNotify)localObject, paramMsg, paramaxau);
      return;
    }
