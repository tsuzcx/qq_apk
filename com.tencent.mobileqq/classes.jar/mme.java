...
public class mme
  implements Handler.Callback, ViewTreeObserver.OnGlobalLayoutListener, anyb
{
  ...
  private mmk jdField_a_of_type_Mmk;
  public boolean a;
  ...
  private mme(Activity paramActivity)
  {
  ...
  public static mme a(Activity paramActivity)
  {
    return new mme(paramActivity);
  }
  ...
  private void a(int paramInt, long paramLong)
  {
    if (this.d != paramInt)
    {
      ...
      if (this.jdField_a_of_type_Mmk != null) {
        this.jdField_a_of_type_Mmk.a(this.d, paramLong);
      }
    }
  }
  ...
  private void g()
  {
    ...
    if ((localObject instanceof ayks))
    {
      localayks = (ayks)localObject;
      localObject = null;
    }
    for (;;)
    {
      if (localayks != null) {
        localObject = lkx.a(localayks);
      }
      this.jdField_a_of_type_AndroidWidgetEditText.setText("");
      if ((this.jdField_a_of_type_Mmk != null) && (!TextUtils.isEmpty((CharSequence)localObject))) {
        this.jdField_a_of_type_Mmk.a((String)localObject);
      }
      return;
      localObject = localObject.toString();
      if (ayla.a((String)localObject)) {
        localayks = new ayks((CharSequence)localObject, 3, 16);
      }
    }
  }
  ...
  private void h()
  {
    ...
    if (this.jdField_a_of_type_Bfnk.hasMessages(2)) {
      if (QLog.isColorLevel()) {
    ...
    if (c())
    {
      ...
      localMessage.arg1 = 0;
      localMessage.arg2 = 0;
      this.jdField_a_of_type_Bfnk.sendMessageDelayed(localMessage, 100L);
      return;
    }
    i();
  }
  ...
  private void j()
  {
    ...
    {
      if (this.jdField_a_of_type_Mmk != null) {
        this.jdField_a_of_type_Mmk.a(j, i, this.d, l);
      }
      return;
      i = 2;
      break;
  ...
  public mme a(ViewGroup paramViewGroup)
  {
    this.jdField_a_of_type_AndroidViewViewGroup = paramViewGroup;
    return this;
  }
  
  public mme a(EditText paramEditText)
  {
    this.jdField_a_of_type_AndroidWidgetEditText = paramEditText;
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusable(true);
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusableInTouchMode(true);
    this.jdField_a_of_type_AndroidWidgetEditText.requestFocus();
    this.jdField_a_of_type_AndroidWidgetEditText.setEditableFactory(ayks.a(16));
    this.jdField_a_of_type_AndroidWidgetEditText.setOnClickListener(new mmf(this));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new mmg(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setOnKeyListener(new mmh(this));
    return this;
  }
  
  public mme a(ImageView paramImageView)
  {
    this.jdField_a_of_type_AndroidWidgetImageView = paramImageView;
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130841654);
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new mmi(this));
    return this;
  }
  
  public mme a(VideoChatRoomListView paramVideoChatRoomListView)
  {
    this.jdField_a_of_type_ComTencentAvUiChatroomVideoChatRoomListView = paramVideoChatRoomListView;
    this.jdField_a_of_type_ComTencentAvUiChatroomVideoChatRoomListView.setOnDispatchTouchEventResponseListener(new mmj(this));
    return this;
  }
  
  public mme a(mmk parammmk)
  {
    this.jdField_a_of_type_Mmk = parammmk;
    return this;
  }
  ...
  public void a(anyc paramanyc)
  {
    if ((paramanyc instanceof aocp)) {
      ((aocp)paramanyc).a(null, this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidWidgetEditText, null);
    }
  }
