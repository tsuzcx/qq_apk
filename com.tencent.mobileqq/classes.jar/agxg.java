  ...
  extends BitmapDrawable
{
  ...
  public agxg(Resources paramResources, Bitmap paramBitmap)
  {
    super(paramResources, paramBitmap);
  }
  
  public static agxg[] a(int paramInt, Resources paramResources, Bitmap paramBitmap)
  {
    if ((paramBitmap != null) && (paramResources != null))
    {
      agxg[] arrayOfagxg2 = new agxg[paramInt];
      e = paramBitmap.getWidth() / 2;
      d = paramBitmap.getHeight() / 2;
      int i = 0;
      for (;;)
      {
        arrayOfagxg1 = arrayOfagxg2;
        if (i >= paramInt) {
          break;
        }
        arrayOfagxg2[i] = new agxg(paramResources, paramBitmap);
        i += 1;
      }
    }
    agxg[] arrayOfagxg1 = null;
    return arrayOfagxg1;
  }
