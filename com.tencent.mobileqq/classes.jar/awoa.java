  ...
  implements Handler.Callback
{
  ...
  public static awoa a()
  {
    ...
    localawoa.a(0);
    awpm.b(0, localawoa, jdField_b_of_type_ArrayOfInt).step();
    ...
    jdField_a_of_type_Boolean = false;
    awpm.b(12, localawoa, null).step();
    if (BaseApplicationImpl.sProcessId == 2)
    {
      awpm.b(10, localawoa, null).step();
      awpm.b(39, localawoa, null).step();
      ThreadManager.post(awpm.b(0, localawoa, l), 10, null, false);
      awpm.b(0, localawoa, k).step();
    }
    label384:
    for (;;)
    {
      ...
      {
        awpm.b(0, localawoa, r).step();
      }
      else if ((BaseApplicationImpl.sProcessId == 5) || (BaseApplicationImpl.sProcessId == 7))
      {
        awpm.b(10, localawoa, null).step();
        awpm.b(7, localawoa, null).step();
        awpm.b(0, localawoa, jdField_i_of_type_ArrayOfInt).step();
        awpm.b(11, localawoa, null).step();
        awpm.b(46, localawoa, null).step();
      }
      ...
      else if (!BaseApplicationImpl.processName.endsWith(":qqfav"))
      {
        ...
        {
          ThreadManager.excute(awpm.b(0, localawoa, jdField_a_of_type_ArrayOfInt), 16, null, false);
        }
        else
        {
          ...
          for (;;)
          {
            ...
            awpm.b(37, localawoa, null).step();
            break;
            awpm.b(0, localawoa, jdField_j_of_type_ArrayOfInt).step();
          }
        }
      }
    }
  ...
  {
    int i2 = 0;
    if ((!jdField_h_of_type_Boolean) && (BaseApplicationImpl.sProcessId == 1)) {}
    for (;;)
    {
      try
      {
        ...
        if (!str1.isEmpty())
        {
          ...
          if (arrayOfString.length > 0)
          {
            ...
            if (i1 < i3)
            {
              ...
              ajws.jdField_a_of_type_JavaUtilSet.add(Integer.valueOf(Integer.parseInt(str2)));
              i1 += 1;
              continue;
            }
          }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ThreadManager.getSubThreadHandler().postAtFrontOfQueue(awpm.b(9, this, null));
      if (jdField_a_of_type_Int == 1) {
        ThreadManager.getSubThreadHandler().post(awpm.b(21, this, null));
      }
    }
    ...
    if (paramBoolean)
    {
      ...
      if ((BaseApplicationImpl.sShowTime <= 0L) || (!badq.g(BaseApplicationImpl.sApplication))) {
        break label314;
      }
    }
    label314:
  ...
  private void a(int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt)
  {
    ...
    paramArrayOfInt1 = awpm.b(0, this, paramArrayOfInt1);
    if (paramArrayOfInt2 != null)
    {
      this.jdField_f_of_type_Int = 2;
      this.jdField_g_of_type_Int = paramInt;
      paramArrayOfInt1.setResultListener(this.jdField_b_of_type_AndroidOsHandler, 10);
      paramArrayOfInt2 = awpm.b(0, this, paramArrayOfInt2);
  ...
  private void b(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {
      localTextView.setText(2131627940);
    }
    for (;;)
    {
      ...
      return;
      localTextView.setText(ajjy.a(2131648558));
    }
  }
  ...
  {
    this.jdField_a_of_type_Awob = paramawob;
  }
  ...
  public void a(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission == null) {
        this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission = ((CheckPermission)awpm.b(3, this, null));
      }
    ...
    if (this.jdField_e_of_type_Int == 2)
    {
      if (1 == BaseApplicationImpl.sProcessId) {
        ThreadManager.getFileThreadHandler().postDelayed(awpm.b(13, this, null), 1000L);
      }
      a(11, 1, 5L);
      a(3);
    }
    ...
    for (paramObject = (AppActivity)paramObject;; paramObject = null)
    {
      ...
      if (paramObject == null)
      {
        ...
        if (this.jdField_e_of_type_Int == 1)
        {
          ...
          {
            paramObject = o;
            awpm.b(0, this, paramObject).step();
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramIntent = (SetSplash)awpm.b(2, this, null);
          paramIntent.step();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      for (;;)
      {
        return true;
        a(4, 0, 300L);
        bool1 = awpm.b(12, this, null).step();
        ...
        if (this.jdField_a_of_type_MqqAppAppActivity != null)
        {
          ...
          if (this.jdField_a_of_type_MqqAppAppActivity != null)
          {
            baii.a(this.jdField_a_of_type_MqqAppAppActivity, "com.tencent.mobileqq.activity.MainActivity");
            baii.a(this.jdField_a_of_type_MqqAppAppActivity, SplashActivity.class.getName());
            return true;
            ...
            this.jdField_a_of_type_Awob.a(this);
            if (this.jdField_a_of_type_Long > 0L) {
      ...
      awpm.b(28, this, null).step();
      return true;
    } while (this.jdField_a_of_type_Awob.jdField_a_of_type_Boolean);
    this.jdField_a_of_type_Awob.a();
