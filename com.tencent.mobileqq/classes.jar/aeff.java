  ...
  extends BaseBubbleBuilder
{
  ...
  public aeff(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new aefg(this);
    this.b = paramContext;
  ...
  private RelativeLayout a(Context paramContext)
  {
    ...
    localQQWalletTransferBubbleView.setId(2131379262);
    ...
    ((ImageView)localObject1).setId(2131379258);
    localQQWalletTransferBubbleView.addView((View)localObject1);
    localObject1 = new LinearLayout(paramContext);
    localObject2 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject2).addRule(0, 2131379258);
    ...
    ((TextView)localObject2).setId(2131379261);
    ...
    ((TextView)localObject2).setId(2131379260);
    ((LinearLayout)localObject1).addView((View)localObject2);
    localQQWalletTransferBubbleView.addView((View)localObject1);
    ...
    ((RelativeLayout.LayoutParams)localObject1).addRule(3, 2131379262);
    localQQWalletTransferBubbleView.setLayoutParams((ViewGroup.LayoutParams)localObject1);
    localQQWalletTransferBubbleView.setBackgroundResource(2130846324);
    localQQWalletTransferBubbleView.setId(2131379257);
  ...
  {
    boolean bool2 = true;
    paramView = (aefh)paramacun;
    if (paramView.a == null) {
      paramView.a = a(this.b);
    }
    if ((paramChatMessage instanceof MessageForVIPDonate)) {}
    for (paramacun = (MessageForVIPDonate)paramChatMessage;; paramacun = null)
    {
      if (paramacun == null)
      {
      ...
      paramacun.parse();
      paramacun = paramacun.donateMsg;
      if (paramacun == null)
      {
        QLog.e("VIPDonateMsgItemBuilder", 1, "donateMsg empty");
        return null;
      }
      paramBaseChatItemLayout = (TextView)paramView.a.findViewById(2131379261);
      paramBaseChatItemLayout.setText(paramacun.title);
      paramBaseChatItemLayout.setTextColor(-1);
      paramBaseChatItemLayout = (TextView)paramView.a.findViewById(2131379260);
      paramBaseChatItemLayout.setText(paramacun.subTitle);
      paramBaseChatItemLayout.setTextColor(-1);
      ((TextView)paramView.a.findViewById(2131379259)).setText(paramacun.footer);
      ((ImageView)paramView.a.findViewById(2131379258)).setImageResource(2130849669);
      paramBaseChatItemLayout = (QQWalletTransferBubbleView)paramView.a.findViewById(2131379257);
      QQWalletTransferBubbleView localQQWalletTransferBubbleView = (QQWalletTransferBubbleView)paramView.a.findViewById(2131379262);
      int m = Color.rgb(255, 170, 57);
      if (!paramChatMessage.isSend())
      {
        bool1 = true;
        localQQWalletTransferBubbleView.setBubbleBackground(2130846323, m, bool1);
      ...
      {
        paramBaseChatItemLayout.setBubbleBackground(2130846324, m, bool1);
        if (jdField_e_of_type_Boolean) {
          paramView.a.setContentDescription(paramacun.subTitle + paramacun.title);
        }
        paramView.a.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        paramView.a.setOnLongClickListener(paramacxn);
        paramView.a.setOnTouchListener(paramacxn);
        return paramView.a;
        bool1 = false;
        break;
      }
  ...
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    default: 
      ...
      return;
    case 2131364985: 
      aaod.b(this.b, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
      return;
    }
  ...
  public bblt[] a(View paramView)
  {
    ...
    aaod.a(localbblr, this.b, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
