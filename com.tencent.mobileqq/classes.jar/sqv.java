...
{
  public sqv(GesturePWDCreateActivity paramGesturePWDCreateActivity) {}
  ...
  public void a(List paramList)
  {
    ...
    do
    {
      ...
      if ((paramList != null) && (paramList.size() >= 3))
      {
        ...
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(2131436025);
        this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new sqw(this), 500L);
      ...
      QQToast.a(this.a, 1, this.a.getString(2131436028), 0).b(this.a.getTitleBarHeight());
      this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new sqx(this), 500L);
      return;
      ...
      QQToast.a(this.a, 2, this.a.getString(2131436026), 0).b(this.a.getTitleBarHeight());
      this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new sqy(this), 300L);
    } while (!QLog.isColorLevel());
    QLog.d("Q.gesturelock.creat", 2, "gesture lock create success...");
    return;
    this.a.jdField_a_of_type_ComTencentMobileqqGesturelockLockPatternView.setDisplayMode(LockPatternView.DisplayMode.Wrong);
    this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new sqz(this), 500L);
    QQToast.a(this.a, 1, this.a.getString(2131436027), 0).b(this.a.getTitleBarHeight());
  }
