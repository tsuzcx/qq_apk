...
public class altn
  extends QIPCModule
{
  private static volatile altn a;
  
  public altn(String paramString)
  {
    super(paramString);
  }
  
  public static altn a()
  {
    if (a == null) {}
    try
    {
      if (a == null) {
        a = new altn("FriendQIPCModule");
      }
      return a;
    }
    finally {}
  ...
  private void a(QQAppInterface paramQQAppInterface, Bundle paramBundle)
  {
    ...
    paramBundle = (alto)paramQQAppInterface.getManager(51);
    if (j == 1) {
      if (bool)
      {
        paramBundle.e(str);
        ...
        akey.a(str, "1", paramQQAppInterface);
      }
    }
    do
    {
  ...
  private EIPCResult c(QQAppInterface paramQQAppInterface, Bundle paramBundle)
  {
    ...
    paramBundle = ((alto)paramQQAppInterface.getManager(51)).a(str1);
    Bundle localBundle = new Bundle();
    ...
    paramBundle = bdnf.a(localSharedPreferences, str2, null);
    ...
    if (paramQQAppInterface.add(str1))
    {
      ...
      bdnf.a(paramBundle, str2, paramQQAppInterface.toArray());
      paramBundle.commit();
    }
    for (;;)
    {
  ...
  {
    paramBundle = paramBundle.getString("KEY_UIN");
    ExtensionInfo localExtensionInfo = ((alto)paramQQAppInterface.getManager(51)).a(paramBundle, false);
    if (localExtensionInfo != null) {}
    for (int i = localExtensionInfo.friendRingId;; i = 0)
    {
      paramQQAppInterface = aobk.a(paramQQAppInterface).a(i, paramBundle, 0);
  ...
  private EIPCResult e(QQAppInterface paramQQAppInterface, Bundle paramBundle)
  {
    ...
    if ((paramBundle != null) && (!paramBundle.isEmpty())) {
      ((amdc)paramQQAppInterface.a(26)).notifyUI(5, true, paramBundle);
    }
