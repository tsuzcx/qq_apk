      ...
      for (int j = Integer.parseInt(paramObject);; j = 0)
      {
        ...
        for (float f = Float.parseFloat(paramObject);; f = 0.0F)
        {
          ...
          for (int k = Integer.parseInt(paramObject);; k = 0)
          {
            ...
            {
            default: 
              paramObject = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438203);
              localObject1 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438203);
              if (QLog.isColorLevel()) {
                QLog.d("Q.aio.BaseChatPie", 2, "unknown action auth errcode");
              }
              paramObject = DialogUtil.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 0, paramObject, (String)localObject1, this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131436714), (String)localObject2, (DialogInterface.OnClickListener)localObject3, new rqh(this));
            ...
            case 31004: 
              label575:
              paramObject = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438189);
              localObject4 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438190);
            ...
            for (;;)
            {
              localObject2 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438192);
              localObject3 = new rqe(this, m);
              ...
              break label575;
              localObject2 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438195);
              paramObject = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438190);
              localObject1 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438192);
              if (bool)
              {
                localObject2 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438196);
                paramObject = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438191);
                localObject1 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438193);
              }
              if (localApolloActionData != null) {
              ...
              for (;;)
              {
                localObject3 = new rqf(this, m, bool);
                ...
                if (TextUtils.isEmpty(paramObject)) {
                  paramObject = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438199);
                }
                for (;;)
                {
                  localObject1 = (String)((Map)localObject1).get("url");
                  localObject1 = (String)localObject1 + "&actionid=" + m;
                  localObject4 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438200);
                  localObject2 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438200);
                  localObject3 = new rqg(this, (String)localObject1, m);
                  ...
                  paramObject = localObject4;
                  break label575;
                  QQToast.a(this.a.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131438180), 0).b(this.a.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131558448));
                  if (!QLog.isColorLevel()) {
                    break;
                  }
