...
public class rqd
{
  private static Map<String, rqe> a = new ConcurrentHashMap();
  ...
  public static String a(String paramString)
  {
    ...
    try
    {
      localObject = (rqe)a.get(paramString);
      localJSONObject.put("app", "QQ");
      localJSONObject.put("appVersion", "8.3.0");
      localJSONObject.put("businessID", ((rqe)localObject).b);
      localJSONObject.put("os", "android");
      localObject = new JSONObject();
      paramString = rqg.a(paramString, false);
      if (paramString != null)
      {
  ...
  public static rqg a(String paramString)
  {
    if (a.containsKey(paramString))
    {
      paramString = (rqe)a.get(paramString);
      if ((paramString != null) && (paramString.jdField_a_of_type_Rqf != null)) {
        return paramString.jdField_a_of_type_Rqf.a();
      }
    }
    return null;
  }
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    {
      return;
      localrqe = (rqe)a.get(paramString1);
    } while (localrqe == null);
    paramString1 = rqg.a(paramString1, true);
    ...
    for (;;)
    {
      try
      {
        ...
        localrqe.jdField_a_of_type_Rqf.a(localArrayList);
      }
      ...
      localrqe.jdField_a_of_type_Rqf.a(paramString1, (JSONObject)localObject, true);
      i += 1;
      continue;
      label282:
      int i = 0;
  ...
  public static void a(rqe paramrqe)
  {
    if ((paramrqe.jdField_a_of_type_JavaLangString == null) || (paramrqe.b == null)) {
      return;
    }
    a.put(paramrqe.jdField_a_of_type_JavaLangString, paramrqe);
  }
}
