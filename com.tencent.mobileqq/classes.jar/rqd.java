...
public class rqd
{
  ...
  public static rqd a(articlesummary.RecommendFollowInfos paramRecommendFollowInfos)
  {
    boolean bool = true;
    rqd localrqd = new rqd();
    ...
    for (;;)
    {
      localrqd.jdField_a_of_type_Boolean = bool;
      if (paramRecommendFollowInfos.bytes_account_next_cookie.has()) {
        localrqd.jdField_a_of_type_ArrayOfByte = paramRecommendFollowInfos.bytes_account_next_cookie.get().toByteArray();
      }
      localrqd.jdField_a_of_type_Int = paramRecommendFollowInfos.uint32_card_style.get();
      localrqd.jdField_a_of_type_JavaLangString = paramRecommendFollowInfos.bytes_card_title.get().toStringUtf8();
      localrqd.jdField_b_of_type_JavaLangString = paramRecommendFollowInfos.bytes_jump_url.get().toStringUtf8();
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        localrqd.jdField_a_of_type_JavaUtilList.add(localRecommendFollowInfo);
        if ((localrqd.jdField_a_of_type_Int == 2) && (!TextUtils.isEmpty(localRecommendFollowInfo.className)))
        {
    ...
    if (!((HashMap)localObject2).isEmpty())
    {
      ...
      while (paramRecommendFollowInfos.hasNext())
      {
        ...
        {
          localObject3 = new rpg();
          ((rpg)localObject3).jdField_a_of_type_JavaLangString = ((String)((Map.Entry)localObject1).getKey());
          ((rpg)localObject3).jdField_a_of_type_JavaUtilList = ((List)localObject2);
          localrqd.jdField_b_of_type_JavaUtilList.add(localObject3);
        }
      }
    }
    return localrqd;
  ...
  public static rqd a(oidb_0xc2f.GetFollowUserRecommendListRsp paramGetFollowUserRecommendListRsp)
  {
    rqd localrqd = new rqd();
    localrqd.jdField_b_of_type_JavaLangString = paramGetFollowUserRecommendListRsp.bytes_jump_url.get().toStringUtf8();
