...
public class rfc
  extends rbp
{
  public rfc(Context paramContext, FaceDecoder paramFaceDecoder, szd paramszd)
  {
  ...
  public rbp a()
  {
    ...
    return f(this.jdField_a_of_type_Szd, this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceDecoder).q().g().l().n();
  }
