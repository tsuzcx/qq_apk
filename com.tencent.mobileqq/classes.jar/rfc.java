...
public class rfc
{
  public static void a(List<String> paramList, int paramInt, @Nullable rff paramrff)
  {
    ...
    nkm.a(ozs.a(), new rfe(paramrff, paramInt), paramList.toByteArray(), "OidbSvc.0xe2a", 3626, 2);
  }
  
  public static void a(boolean paramBoolean, List<UgcVideo> paramList, @Nullable rfg paramrfg)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      nkm.a(ozs.a(), new rfd(paramrfg), paramList.toByteArray(), "OidbSvc.0xe2a", 3626, 1, null, 120000L);
      return;
    }
  }
}
