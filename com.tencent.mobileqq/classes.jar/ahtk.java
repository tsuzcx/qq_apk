...
public class ahtk
  extends abfq
  implements ahsc, DialogInterface.OnCancelListener, bkhe
{
  long jdField_a_of_type_Long;
  public ahtj a;
  ahts jdField_a_of_type_Ahts;
  ...
  public ahtk(Activity paramActivity, abfp paramabfp, ahul paramahul, String paramString)
  {
  ...
  private int a(File paramFile1, AIOFilePicData paramAIOFilePicData, File paramFile2)
  {
    ...
    bgmo.a(this.jdField_a_of_type_AndroidAppActivity, paramAIOFilePicData.getAbsolutePath());
    label173:
    return 20;
  }
  ...
  private int a(File paramFile1, AIOImageData paramAIOImageData, File paramFile2)
  {
    ...
    if (paramFile1 != null)
    {
      ...
      bgmo.a(this.jdField_a_of_type_AndroidAppActivity, paramAIOImageData.getAbsolutePath());
    }
    return 20;
  }
  ...
  public int a()
  {
    ...
    AIORichMediaData localAIORichMediaData = ((ahui)this.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
  ...
  {
    this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter = new ahua(this.jdField_a_of_type_AndroidAppActivity, paramInt, this.jdField_a_of_type_Ahtj, this.jdField_a_of_type_Ahul, this.jdField_a_of_type_ComTencentWidgetGestureSelectGridView);
    this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter.a(this.jdField_a_of_type_Ahtj);
  ...
  void a(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Bgpa.setOnDismissListener(new ahtn(this));
    Object localObject;
    switch (paramInt1)
    {
    case 2: 
    default: 
      ...
      return;
    case 1: 
      this.jdField_a_of_type_Bgpa.setTitle(String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131689878), new Object[] { Integer.valueOf(paramInt2) }));
      this.jdField_a_of_type_Bgpa.setPositiveButton(2131694081, new bgmc());
      this.jdField_a_of_type_Bgpa.show();
      return;
    case 0: 
      this.jdField_a_of_type_Bgpa.setTitle(2131689847);
      localObject = new ahto(this, paramInt2);
      this.jdField_a_of_type_Bgpa.setNegativeButton(2131690582, (DialogInterface.OnClickListener)localObject);
      this.jdField_a_of_type_Bgpa.setPositiveButton(2131717875, (DialogInterface.OnClickListener)localObject);
      this.jdField_a_of_type_Bgpa.show();
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    if (paramInt2 == 22)
    {
      localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131717593);
      str = this.jdField_a_of_type_AndroidAppActivity.getString(2131717592);
    }
    for (;;)
    {
      this.jdField_a_of_type_Bgpa = bglp.a(this.jdField_a_of_type_AndroidAppActivity, 230, (String)localObject, str, null, null);
      this.jdField_a_of_type_Bgpa.setTitle((String)localObject);
      ...
      if (paramInt2 == 24)
      {
        localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131717597);
        str = this.jdField_a_of_type_AndroidAppActivity.getString(2131717596);
      }
      else if (paramInt2 == 23)
      {
        localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131717595);
        str = this.jdField_a_of_type_AndroidAppActivity.getString(2131717594);
      }
      else
      {
        localObject = null;
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    do
    {
      ...
      if (this.jdField_c_of_type_AndroidWidgetTextView != null) {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(2131689930);
      }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, String arg6)
  {
    ...
    {
      return;
      localObject4 = this.jdField_a_of_type_Ahtj;
      if (paramInt3 != 1) {
        break;
      }
      localObject1 = ???;
      i = ((ahtj)localObject4).a(paramLong, paramInt1, paramInt2, (String)localObject1, true);
      if (paramInt2 != 1) {
        break label240;
      }
      ...
      if ((i >= j) && (i <= k + j - 1))
      {
        ...
        ((ahua)this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter).a(i, (View)localObject1);
      }
      if ((paramInt2 != 2) || (this.jdField_a_of_type_Ahts == null)) {
        break label313;
      }
      localObject1 = this.jdField_a_of_type_Ahts;
    } while ((((ahts)localObject1).jdField_a_of_type_Ahui == null) || (((ahts)localObject1).jdField_a_of_type_Ahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long != paramLong) || (((ahts)localObject1).jdField_a_of_type_Ahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int != paramInt1));
    Object localObject4 = (AIOImageData)((ahts)localObject1).jdField_a_of_type_Ahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
    if (paramInt3 == 1) {}
    for (;;)
    {
      ((AIOImageData)localObject4).jdField_b_of_type_JavaLangString = ???;
      ((ahts)localObject1).jdField_a_of_type_Ahui.jdField_a_of_type_Boolean = false;
      synchronized (((ahts)localObject1).jdField_a_of_type_Ahui)
      {
        ((ahts)localObject1).jdField_a_of_type_Ahui.notifyAll();
        return;
      }
      ...
      ((ahua)this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter).a(i, (View)localObject3);
      break label109;
      label313:
      break;
      ??? = "I:E";
  ...
  {
    if (paramString.equalsIgnoreCase(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131689930)))
    {
  ...
  void a(Integer... paramVarArgs)
  {
    ...
    this.jdField_a_of_type_Ahts = new ahts(this, this.jdField_a_of_type_JavaUtilArrayList);
    this.jdField_a_of_type_Ahts.execute(paramVarArgs);
  }
  ...
  boolean a(ahui paramahui, boolean paramBoolean1, boolean paramBoolean2)
  {
    int i = a();
    if (paramBoolean2)
    {
    ...
    if ((j == 2) && (paramBoolean1) && (this.jdField_a_of_type_JavaUtilArrayList.size() >= 20))
    {
      ...
      if (l - this.jdField_a_of_type_Long >= 700L)
      {
        ...
        QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 1, anni.a(2131698905) + 20 + anni.a(2131698900), 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298998));
      }
      for (;;)
      {
        ...
        return false;
        label175:
        QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 1, anni.a(2131698895) + 20 + anni.a(2131698899), 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298998));
      }
    }
    if ((AIOFilePicData.class.isInstance(paramahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) && (paramahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(20) == null) && (paramahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(18) == null) && (paramahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(16) == null))
    {
      if (QLog.isColorLevel()) {
  ...
  boolean a(View paramView, abgb paramabgb)
  {
    ...
    if (localObject != null)
    {
      paramView = ((ahuc)localObject).jdField_a_of_type_AndroidWidgetImageView;
      localObject = ((ahuc)localObject).jdField_b_of_type_AndroidWidgetImageView;
      switch (paramabgb.b())
      {
      default: 
  ...
  void b(int paramInt1, int paramInt2)
  {
    ...
    default: 
      return;
    case 20: 
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 2, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131689876) + anhk.bg, 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298998));
      return;
    case 21: 
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 1, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131689875) + anhk.bg, 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298998));
      return;
    case 22: 
    case 23: 
    case 24: 
  ...
  public void e()
  {
    if (this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131718222);
    }
  }
  ...
  public void j()
  {
    ...
    this.jdField_a_of_type_Ahtj = null;
    ahsa.a().b(this);
  }
  ...
  protected void k()
  {
    ...
    for (;;)
    {
      ...
      {
        if (((((ahui)this.jdField_a_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOImageData)) && (((AIOImageData)((ahui)this.jdField_a_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).e == null)) {
          j = 1;
        }
      }
      else
      {
        ...
        localbkho.a(new ahtl(this, localbkho));
        localbkho.show();
  ...
  protected void l()
  {
    ...
    do
    {
      ...
      localahui = (ahui)((Iterator)localObject).next();
      if (!AIOImageData.class.isInstance(localahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) {
        break;
      }
    } while (((AIOImageData)localahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).a(2) != null);
    label213:
    for (int i = 0;; i = 1)
    {
      if (i != 0) {
      ...
      for (;;)
      {
        ...
        boolean bool = SettingCloneUtil.readValue((Context)localObject, null, ((Context)localObject).getString(2131694401), "qqsetting_auto_receive_pic_key", true);
        i = bgnt.b((Context)localObject);
        if (i == -1) {
  ...
  public void m()
  {
    ...
    if (this.jdField_a_of_type_Ahtj != null)
    {
      j = this.jdField_a_of_type_Ahtj.f();
      k = this.jdField_a_of_type_Ahtj.e();
      i = this.jdField_a_of_type_Ahtj.d();
      if (QLog.isColorLevel()) {
      ...
      {
        i = this.jdField_a_of_type_Ahtj.b();
        j = this.jdField_a_of_type_Ahtj.e();
        k = this.jdField_a_of_type_Ahtj.d();
  ...
  protected void o()
  {
    ...
    {
      if ((this.jdField_a_of_type_JavaUtilArrayList.get(i) != null) && (((ahui)this.jdField_a_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData != null)) {
        arrayOfLong[i] = ((ahui)this.jdField_a_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long;
      }
      i += 1;
    }
    if (this.jdField_a_of_type_Ahul.asBinder().pingBinder())
    {
      this.jdField_a_of_type_Ahul.a(arrayOfLong);
  ...
  {
    this.jdField_a_of_type_AndroidAppDialog = null;
    paramDialogInterface = this.jdField_a_of_type_Ahts;
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    if (paramInt == 0)
    {
      ...
      if (((paramInt >= i - 28) || (paramInt == i)) && (this.jdField_d_of_type_Int != i))
      {
        ...
        ((ahua)this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter).a(true);
  ...
  void r()
  {
    ...
    if (bgnt.b(BaseApplication.getContext()) == 1)
    {
      ...
      do
      {
        ...
        localahui = (ahui)((Iterator)localObject).next();
      } while ((!AIOImageData.class.isInstance(localahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) || (localahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(2) != null));
    }
    for (int k = 0;; k = 1)
    {
      if (k != 0)
  ...
  void s()
  {
    ...
    {
      Object localObject = (ahui)localIterator.next();
    ...
    ahth.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString, localArrayList1, localArrayList2, localArrayList3, 2, null, null);
  }
  ...
  void u()
  {
    ...
    ahth.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString, this.jdField_b_of_type_Int, (List)this.jdField_a_of_type_JavaUtilArrayList.clone(), this.jdField_c_of_type_Boolean, this.jdField_b_of_type_JavaLangString);
  }
  ...
  void v()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.get(0) != null))
    {
      ...
      if (AIOImageData.class.isInstance(((ahui)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
      {
        ...
        if (this.jdField_a_of_type_JavaUtilArrayList.size() > 1) {
          ((Bundle)localObject1).putString("forward_text", this.jdField_a_of_type_JavaUtilArrayList.size() + anni.a(2131698897));
        }
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (AIOImageData.class.isInstance(localahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) {
            ((ArrayList)localObject2).add(((AIOImageData)localahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_JavaLangString);
          } else if (AIOFilePicData.class.isInstance(localahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) {
            if (((AIOFilePicData)localahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).a(20) != null) {
              ((ArrayList)localObject2).add(((AIOFilePicData)localahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_d_of_type_JavaLangString);
            } else if (((AIOFilePicData)localahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).a(18) != null) {
              ((ArrayList)localObject2).add(((AIOFilePicData)localahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_c_of_type_JavaLangString);
            } else if (((AIOFilePicData)localahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).a(16) != null) {
              ((ArrayList)localObject2).add(((AIOFilePicData)localahui.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_JavaLangString);
            }
          }
        }
    ...
    while (!QLog.isColorLevel())
    {
      ...
      ((Bundle)localObject1).putBoolean("forward_urldrawable", true);
      if (this.jdField_a_of_type_JavaUtilArrayList.size() > 1) {
        ((Bundle)localObject1).putString("forward_text", this.jdField_a_of_type_JavaUtilArrayList.size() + anni.a(2131698898));
      }
      ((Bundle)localObject1).putBoolean("sendMultiple", true);
      localObject2 = new ArrayList();
      localObject3 = this.jdField_a_of_type_JavaUtilArrayList.iterator();
  ...
  void w()
  {
    ((ahua)this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter).jdField_a_of_type_Boolean = this.jdField_b_of_type_Boolean;
    int i;
    if (this.jdField_b_of_type_Boolean)
    {
