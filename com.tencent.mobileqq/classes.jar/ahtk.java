  ...
  implements View.OnClickListener
{
  ...
  public ahtk(bmcv parambmcv, bmcu parambmcu)
  {
  ...
  private void l()
  {
    ...
    this.jdField_d_of_type_AndroidWidgetButton.setText(2131699369);
  ...
  public View a()
  {
    ...
    ((TextView)localView.findViewById(2131363907)).setOnClickListener(this);
    ...
    this.jdField_d_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131373201));
    this.jdField_c_of_type_Int = 0;
    this.jdField_d_of_type_AndroidWidgetButton.setEnabled(false);
    this.jdField_d_of_type_AndroidWidgetButton.setText(2131699369);
    this.jdField_d_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_d_of_type_Int = 0;
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131366515));
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131365970));
    int i = aekt.a(this.e, a().getResources());
    this.jdField_a_of_type_Belg = new belg();
    this.jdField_a_of_type_Belg.a(aekt.a(this.e + this.f, a().getResources()));
    this.jdField_a_of_type_Belg.a(i);
    this.jdField_a_of_type_Belg.b(1);
    if (Build.VERSION.SDK_INT > 15) {
      this.jdField_d_of_type_AndroidWidgetRelativeLayout.setBackground(this.jdField_a_of_type_Belg);
    }
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131376944));
      this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131375518));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131365973));
      this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_c_of_type_JavaLangString);
      return localView;
      this.jdField_d_of_type_AndroidWidgetRelativeLayout.setBackgroundDrawable(this.jdField_a_of_type_Belg);
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    super.a(paramBundle);
    this.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Bmcv.a().getIntent().getStringExtra("key_face_unlock_code");
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (this.jdField_c_of_type_Int == 0)
      {
        ...
        this.jdField_d_of_type_AndroidWidgetButton.setText(2131699372);
