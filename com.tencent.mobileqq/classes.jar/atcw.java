...
public class atcw
  implements atcu
{
  private static volatile atcw jdField_a_of_type_Atcw;
  ...
  private atcw(BaseActivity paramBaseActivity)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramBaseActivity);
  }
  
  public static final atcw a(BaseActivity paramBaseActivity)
  {
    if (jdField_a_of_type_Atcw == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Atcw == null) {
        jdField_a_of_type_Atcw = new atcw(paramBaseActivity);
      }
      return jdField_a_of_type_Atcw;
    }
  }
  ...
  public static final void b()
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Atcw != null)
      {
        if (jdField_a_of_type_Atcw.a()) {
          jdField_a_of_type_Atcw.c();
        }
        ExtendFriendVoiceView localExtendFriendVoiceView = jdField_a_of_type_Atcw.a();
  ...
  public void a(String paramString)
  {
    ...
    {
      if (this.jdField_a_of_type_Atcs == null) {
        this.jdField_a_of_type_Atcs = new atcs(this, localBaseActivity);
      }
      if (!TextUtils.isEmpty(paramString))
      {
        this.jdField_a_of_type_Atcs.a(paramString);
