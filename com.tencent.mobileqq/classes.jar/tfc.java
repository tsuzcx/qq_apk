...
public class tfc
  extends AsyncTask<tfe, tfg, tff>
{
  public final stz a;
  
  public tfc(stz paramstz)
  {
    if (paramstz == null) {
  ...
  public static String a(String paramString)
  {
    ...
    //   57: ldc 50
    //   59: ldc 52
    //   61: invokestatic 57	veg:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   64: aload_3
    //   65: astore_0
    //   66: aload_2
    //   67: ifnull +9 -> 76
    ...
    //   85: invokestatic 67	tfc:a	([B)Ljava/lang/String;
    //   88: astore 4
    //   90: aload 4
    //   92: astore_3
    //   93: aload_3
  ...
  {
    veg.b("FileDownloadTask", paramString);
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    veg.b("FileDownloadTask", "expectedMd5 = " + paramString2);
    veg.b("FileDownloadTask", "file Md5    = " + paramString1);
  ...
  protected tff a(tfe... paramVarArgs)
  {
    ...
    if (a(paramVarArgs.b, paramVarArgs.c))
    {
      ...
      return new tff(paramVarArgs, 0, "has local file already");
    }
    this.a.a(new tfd(this, paramVarArgs));
    ...
    if ((i == 0) && (!a(paramVarArgs.b, paramVarArgs.c)))
    {
      ...
      try
      {
        vyi.d(paramVarArgs.b);
        return new tff(paramVarArgs, -1, "file md5 mismatch");
      }
    ...
    return new tff(paramVarArgs, i, "error=" + i);
  }
}
