...
public class bial
{
  ...
  private biar jdField_a_of_type_Biar;
  ...
  public bial(int paramInt, float paramFloat)
  {
    a();
  ...
  private void a(View paramView, boolean paramBoolean)
  {
    ...
    } while (this.jdField_a_of_type_Biaq == null);
    TraceCompat.beginSection("onPagerChanged");
    this.jdField_a_of_type_Biaq.a(localViewHolder);
  ...
  private void b()
  {
    ...
    {
      this.jdField_a_of_type_Biaq.S_();
      if (QLog.isColorLevel()) {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_Biar = new biar(this, null);
    this.jdField_a_of_type_Biao = new biao(this, null);
    this.jdField_a_of_type_Biap = new biap(this, null);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnScrollListener(this.jdField_a_of_type_Biar);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.setOnFlingListener(this.jdField_a_of_type_Biar);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnLayoutChangeListener(this.jdField_a_of_type_Biao);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnLayoutChangeListener(this.jdField_a_of_type_Biap);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.getAdapter().registerAdapterDataObserver(new biam(this));
  }
  
  private void f()
  {
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.removeOnScrollListener(this.jdField_a_of_type_Biar);
  ...
  {
    return new bian(this, this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.getContext(), paramLinearLayoutManager);
  }
