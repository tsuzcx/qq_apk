  ...
  extends bahj
{
  ...
  public void a(TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    if ((paramTeamWorkFileImportInfo != null) && ((paramTeamWorkFileImportInfo.a()) || ((paramTeamWorkFileImportInfo.b()) && (paramTeamWorkFileImportInfo.g == 0))))
    {
      ...
      if (paramTeamWorkFileImportInfo.b()) {
        azqs.b(null, "dc00898", "", "", "0X800A627", "0X800A627", 1, 0, "", "", "", "");
      }
    ...
    for (;;)
    {
      if ((paramTeamWorkFileImportInfo != null) && (paramTeamWorkFileImportInfo.c())) {
        bajr.a(null, "0X800ABAD");
      }
      return;
      label136:
      QQToast.a(localQQAppInterface.getApp(), 1, 2131720801, 0).a();
    }
  }
  ...
  public void a(String paramString, TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    if ((paramTeamWorkFileImportInfo != null) && (paramTeamWorkFileImportInfo.c()))
    {
      if (paramTeamWorkFileImportInfo.l == 2)
      {
        ...
        bajr.a(null, "0X800ABA7");
        if ((!bool) && (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Arul != null)) {
          this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Arul.a(1, paramString, bool);
        }
        if ((armw.a(this.a)) && (bool)) {
          armw.a(this.a, true);
        }
        if (!bool)
        {
          if (((paramTeamWorkFileImportInfo.jdField_a_of_type_Int != 1) && (paramTeamWorkFileImportInfo.jdField_a_of_type_Int != 0) && (paramTeamWorkFileImportInfo.jdField_a_of_type_Int != 3000)) || (paramTeamWorkFileImportInfo.jdField_a_of_type_JavaLangString == this.a.jdField_a_of_type_Arki.j())) {
            break label452;
          }
          i = 1;
          label147:
    ...
    else
    {
      ...
      i = 1;
      label249:
      if ((i == 0) || (!paramTeamWorkFileImportInfo.b()) || (paramTeamWorkFileImportInfo.g != 0) || (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer == null) || (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Arun == null)) {
        break label462;
      }
      long l = bajr.a(paramTeamWorkFileImportInfo.k + "-" + paramTeamWorkFileImportInfo.d);
      if (l > 0L) {
        azqs.b(null, "dc00898", "", "", "0X800A62E", "0X800A62E", 0, 0, "", "", String.valueOf(l), "");
      }
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.e();
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Arun.a(paramString, paramTeamWorkFileImportInfo, true, this.a.jdField_a_of_type_Arki.j());
  ...
  public void a(String paramString1, String paramString2, TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    {
      localQQAppInterface = (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime();
      aoxx localaoxx = aoyb.a();
      ThreadManager.getFileThreadHandler().post(new SimpleFilePresenter.1.2(this, localaoxx, paramTeamWorkFileImportInfo, paramString2, localQQAppInterface, paramString1));
    }
  ...
  public void b(TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    {
      String str = this.a.jdField_a_of_type_AndroidAppActivity.getString(2131698784);
      if (paramTeamWorkFileImportInfo.b()) {
        str = alud.a(2131714556);
      }
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.h(str);
      bajr.a(null, "0X800A21E");
    }
  }
  ...
  public void c(TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    if ((paramTeamWorkFileImportInfo != null) && (paramTeamWorkFileImportInfo.b())) {
      if (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer != null)
      {
        ...
        armw.a(this.a, true, paramTeamWorkFileImportInfo.jdField_a_of_type_Int);
      }
    }
    ...
    if (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Arul == null)
    {
      bajr.a(null, "0X800ABA4");
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.b(paramTeamWorkFileImportInfo);
      return;
    }
    this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Arul.a();
  }
}
