...
public class awhy
  implements awhx
{
  static INetEngine.IBreakDownFix jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$IBreakDownFix = new awib();
  private static File jdField_a_of_type_JavaIoFile;
  private static Comparator<File> jdField_a_of_type_JavaUtilComparator = new awhz();
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private INetEngine.INetEngineListener jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$INetEngineListener = new awia(this);
  private INetEngine jdField_a_of_type_ComTencentMobileqqTransfileINetEngine;
  private ConcurrentHashMap<String, List<awic>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private ConcurrentHashMap<String, HttpNetReq> b;
  
  public awhy(QQAppInterface paramQQAppInterface)
  {
  ...
  public static String a(String paramString)
  {
    ...
    {
      jdField_a_of_type_JavaIoFile = new File(awer.a);
    ...
    return new File(awer.a, MD5Utils.toMD5(paramString)).getAbsolutePath();
  }
  ...
  private void a(MusicInfo paramMusicInfo)
  {
          ...
          if (paramMusicInfo.b.size() > 0)
          {
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              if (!TextUtils.isEmpty(str)) {
                ((List)localObject1).add(new awic(paramMusicInfo.a, str));
              }
            }
          }
        }
    ...
    for (;;)
    {
      ...
      {
        localObject2 = (awic)localIterator.next();
        if (((awic)localObject2).a == 1)
        {
          bool = true;
          break label583;
        }
      ...
      for (;;)
      {
        ...
        break;
        if ((((awic)localObject2).a == 0) && (localObject1 == null))
        {
          localObject1 = localObject2;
          break label595;
        }
        do
        {
          ...
          ((HttpNetReq)localObject2).mCallback = this.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$INetEngineListener;
          ((HttpNetReq)localObject2).mReqUrl = ((awic)localObject1).b;
          ((HttpNetReq)localObject2).mHttpMethod = 0;
          ((HttpNetReq)localObject2).mOutPath = ((awic)localObject1).d;
          ((HttpNetReq)localObject2).mPrioty = 1;
          ((HttpNetReq)localObject2).setUserData(new Object[] { paramMusicInfo, localObject1 });
          ((HttpNetReq)localObject2).mBreakDownFix = jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$IBreakDownFix;
          this.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine.sendReq((NetReq)localObject2);
          ((awic)localObject1).a = 1;
          break;
          break label595;
          bool = false;
          localObject1 = localObject2;
  ...
  {
    int i = bizo.a(BaseApplicationImpl.getContext());
    boolean bool;
    if (paramInt == 0) {
      bool = true;
    }
  ...
  public static void b()
  {
    ...
    Object localObject1 = new File(awer.a);
  ...
  private boolean b(int paramInt)
  {
    ...
    File localFile1 = new File(awer.a);
    Object localObject;
    int i;
  ...
  public void a(String paramString)
  {
    ...
    //   20: return
    //   21: aload_0
    //   22: getfield 59	awhy:b	Ljava/util/concurrent/ConcurrentHashMap;
    //   25: aload_1
    //   26: invokevirtual 370	java/util/concurrent/ConcurrentHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   29: checkcast 356	com/tencent/mobileqq/transfile/NetReq
    //   32: astore_2
    //   33: aload_2
    //   34: ifnull +13 -> 47
    //   37: aload_0
    //   38: getfield 52	awhy:jdField_a_of_type_ComTencentMobileqqTransfileINetEngine	Lcom/tencent/mobileqq/transfile/INetEngine;
    //   41: aload_2
    //   42: invokeinterface 359 2 0
    //   47: aload_0
    //   48: getfield 57	awhy:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   51: aload_1
    //   52: invokevirtual 370	java/util/concurrent/ConcurrentHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   55: pop
    //   56: invokestatic 172	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   59: ifeq -41 -> 18
    //   62: ldc 83
    //   64: iconst_2
