...
public class aizl
{
  ...
  public aizl(int paramInt)
  {
    this(paramInt, 0, "", "");
  }
  
  public aizl(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    do
    {
      return;
      this.d = paramInt;
      if (this.jdField_a_of_type_Aizm != null) {
        this.jdField_a_of_type_Aizm.a(paramInt);
      }
    ...
    paramString = b();
    awrn.a(BaseApplicationImpl.getContext()).a(paramString, "cmshow_game_rsc_error", true, -1L, -1L, localHashMap, "", true);
  }
  ...
  public static boolean a(int paramInt)
  {
    try
    {
      ...
      CmGameInitParams localCmGameInitParams = ((aipj)localObject).a();
  ...
  private String c()
  {
    ...
    if (this.c == 0) {
      localStringBuilder.append(aiys.s).append(this.jdField_b_of_type_Int);
    }
    do
    {
      for (;;)
      {
        ...
        localStringBuilder.append(aiys.s).append(this.jdField_b_of_type_Int).append("/").append(this.jdField_b_of_type_JavaLangString);
      }
    } while ((this.c != 3) && (this.c != 4));
    return beff.a();
  }
    ...
    for (;;)
    {
      try
      {
        if (!a(this.jdField_b_of_type_Int, this.c))
        {
          ...
          this.jdField_a_of_type_Aizm.a(0);
          return false;
        }
      ...
      if (((this.c == 0) || (this.c == 1)) && (!new ajav(c() + "/checkList.sig", localThrowable.getAbsolutePath()).a(0)))
      {
        a("checkList.sig", 3);
        return false;
      }
      this.jdField_a_of_type_OrgJsonJSONObject = new JSONObject(bace.b(localThrowable));
  ...
  {
    this.jdField_a_of_type_Aizm = paramaizm;
  }
  ...
  public boolean a(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 33	aizl:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   4: invokevirtual 362	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   7: ifeq +41 -> 48
    //   10: aload_0
    //   11: getfield 292	aizl:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   14: ifnull +34 -> 48
    //   17: aload_2
    ...
    //   28: ifne +20 -> 48
    //   31: aload_0
    //   32: getfield 35	aizl:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   35: ifnull +13 -> 48
    //   38: aload_0
    //   39: getfield 35	aizl:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   85: aload_2
    //   86: iconst_1
    //   87: invokespecial 264	aizl:a	(Ljava/lang/String;I)V
    //   90: iconst_0
    //   91: ifeq -43 -> 48
    ...
    //   117: astore_3
    //   118: aload_0
    //   119: getfield 292	aizl:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   122: aload_2
    ...
    //   186: aload_2
    //   187: iconst_4
    //   188: invokespecial 264	aizl:a	(Ljava/lang/String;I)V
    //   191: aload 4
    //   193: ifnull -145 -> 48
    //   196: aload 4
  ...
  public void b()
  {
    ...
    String str = b();
    awrn.a(BaseApplicationImpl.getContext()).a(str, "cmshow_game_rsc_avg_cost", true, -1L, -1L, (HashMap)localObject, "", true);
  }
