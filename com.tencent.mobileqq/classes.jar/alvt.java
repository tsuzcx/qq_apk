...
{
  static ArrayList<alwc> jdField_a_of_type_JavaUtilArrayList;
  ...
  public alvt(QQAppInterface paramQQAppInterface)
  {
  ...
  public static alwe a(byte[] paramArrayOfByte)
  {
    alwe localalwe = new alwe();
    ...
    localalwe.jdField_a_of_type_Int = lfx.a(lfx.a(arrayOfByte1, 2));
    System.arraycopy(paramArrayOfByte, 2, arrayOfByte3, 0, 8);
    localalwe.jdField_a_of_type_Long = lfx.b(arrayOfByte3, 8);
    localalwe.jdField_b_of_type_Int = lfx.a(paramArrayOfByte[10]);
    int j = localalwe.jdField_b_of_type_Int + 11;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localalwe.jdField_b_of_type_Long = lfx.a(lfx.a(arrayOfByte2, 4));
    j += 4;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localalwe.jdField_c_of_type_Long = lfx.a(lfx.a(arrayOfByte2, 4));
    j += 4;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte3, 0, 8);
    localalwe.jdField_d_of_type_Long = lfx.b(arrayOfByte3, 8);
    j += 8;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localalwe.jdField_c_of_type_Int = lfx.a(arrayOfByte2, 4);
    j += 4;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte1, 0, 2);
    localalwe.jdField_d_of_type_Int = lfx.a(lfx.a(arrayOfByte1, 2));
    j += 2;
    localalwe.jdField_e_of_type_Int = lfx.a(paramArrayOfByte[j]);
    j += 1;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localalwe.jdField_e_of_type_Long = lfx.a(arrayOfByte2, 4);
    j += localalwe.jdField_e_of_type_Int;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte1, 0, 2);
    localalwe.jdField_f_of_type_Int = lfx.a(lfx.a(arrayOfByte1, 2));
    j = j + 2 + localalwe.jdField_f_of_type_Int * 8;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte2, 0, 4);
    localalwe.jdField_f_of_type_Long = lfx.a(lfx.a(arrayOfByte2, 4));
    j += 4;
    System.arraycopy(paramArrayOfByte, j, arrayOfByte1, 0, 2);
    localalwe.jdField_g_of_type_Int = lfx.a(lfx.a(arrayOfByte1, 2));
    j += 2;
    if ((localalwe.jdField_g_of_type_Int >= 16) && (localalwe.jdField_g_of_type_Int + j <= i))
    {
      System.arraycopy(paramArrayOfByte, j + 9, arrayOfByte1, 0, 2);
      i = lfx.a(lfx.a(arrayOfByte1, 2)) + 11;
      if (localalwe.jdField_d_of_type_Int != 3) {
        break label414;
      }
    }
    for (;;)
    {
      i = localalwe.jdField_g_of_type_Int;
      return localalwe;
      label414:
      localalwe.h = lfx.a(paramArrayOfByte[(j + i)]);
      i += 1;
      if (i + 4 <= localalwe.jdField_g_of_type_Int)
      {
        System.arraycopy(paramArrayOfByte, j + i, arrayOfByte2, 0, 4);
        localalwe.jdField_g_of_type_Long = lfx.a(lfx.a(arrayOfByte2, 4));
      }
    }
  }
  ...
  private void j(byte[] paramArrayOfByte)
  {
    ...
    if ((j == 1) && (i == 2))
    {
      new bilo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(new alwa(this, paramArrayOfByte));
      return;
    }
    new maf((Context)localObject).a(new alwb(this, paramArrayOfByte));
  }
  ...
  public void a(int paramInt1, String paramString, int paramInt2, long[] paramArrayOfLong, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    ...
    catch (Exception localException)
    {
      ...
      paramInt3 = 23;
      lpp locallpp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(l1);
      if ((locallpp == null) || (locallpp.jdField_a_of_type_Int <= 0) || (paramInt2 != 0)) {
        break label228;
      }
      this.jdField_a_of_type_ComTencentAvGaudioAVNotifyCenter.a(5, 1, l1, null, locallpp.jdField_a_of_type_Int);
    ...
    label292:
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().d(paramString) != 14)
    {
    ...
    for (;;)
    {
      ...
      if ((i == 2) && (paramInt1 == 1) && (((bclr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(164)).a(paramString) == 1)) {
  ...
  void a(long paramLong, int paramInt, byte paramByte)
  {
    ...
    lek.d("QQGAudioMsgHandler", String.format("queryRoomMemberNum| discussId=%d, dataType= %d, wReserve=%s", new Object[] { Long.valueOf(paramLong), Integer.valueOf(paramInt), Byte.valueOf(paramByte) }));
  ...
  public void a(byte[] paramArrayOfByte, msg_comm.Msg paramMsg)
  {
    ...
    do
    {
      ...
      i = lfx.a(lfx.a((byte[])localObject, 2));
      if (i != 141) {
        break label625;
      }
      alwe localalwe = a(paramArrayOfByte);
      i = localalwe.jdField_d_of_type_Int;
      l1 = localalwe.jdField_d_of_type_Long;
      l2 = localalwe.jdField_e_of_type_Long;
      j = localalwe.jdField_c_of_type_Int;
      l3 = localalwe.jdField_f_of_type_Long;
      l4 = localalwe.jdField_g_of_type_Long;
      str = Long.toString(l2);
      localObject = Long.toString(l1);
      if (QLog.isColorLevel()) {
        QLog.d("QQGAudioMsgHandler", 2, "GAudioOfflineMsg relationShip[" + i + "], groupUin[" + str + "], inviteUin[" + l1 + "], subCmd0x8DMsg[" + localalwe + "]");
      }
      if (1 == i)
      {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      jdField_a_of_type_JavaUtilArrayList.add(new alwc(paramMsg, Long.valueOf(paramArrayOfByte).longValue(), l2));
      ...
      return;
      label470:
      paramMsg = (awwg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(38);
      ...
      ((bclr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(164)).a(l2);
  ...
  void b(long paramLong)
  {
    ...
    ((almt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).a(paramLong);
  ...
  public void b(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    long l1 = lfx.b((byte[])localObject, j);
    if (QLog.isColorLevel()) {
    ...
    if (paramInt != 0)
    {
      if ((jdField_a_of_type_JavaUtilArrayList != null) && (!jdField_a_of_type_JavaUtilArrayList.isEmpty()))
      {
        ...
        {
          paramArrayOfByte = (alwc)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    ...
    do
    {
      do
      {
        do
        {
          ...
          while (paramInt < jdField_a_of_type_JavaUtilArrayList.size())
          {
            localObject = (alwc)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
            if ((localObject != null) && (((alwc)localObject).jdField_a_of_type_Long == l1) && (((alwc)localObject).jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true))) {
              paramArrayOfByte.add(localObject);
            }
            paramInt += 1;
          }
          Collections.sort(paramArrayOfByte, new alwd());
          paramInt = 0;
          while (paramInt < paramArrayOfByte.size() - 1)
          {
            if (QLog.isColorLevel()) {
              QLog.d("QQGAudioMsgHandler", 2, "onRecvMultiVideoC2SACK_0x31-retCode->list =" + ((alwc)paramArrayOfByte.get(paramInt)).jdField_b_of_type_Long);
            }
            localObject = (alwc)paramArrayOfByte.get(paramInt);
            arrayOfByte1 = new byte[8];
            arrayOfByte2 = ((im_msg_body.MsgBody)((alwc)localObject).jdField_a_of_type_MsfMsgcommMsg_comm$Msg.msg_body.get()).msg_content.get().toByteArray();
            System.arraycopy(arrayOfByte2, (arrayOfByte2[10] & 0xFF) + 19, arrayOfByte1, 0, 8);
            l2 = lfx.b(arrayOfByte1, 8);
            VideoMsgTools.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, 6, true, Long.toString(l1), Long.toString(l2), false, null, false, new Object[] { ((alwc)localObject).jdField_a_of_type_MsfMsgcommMsg_comm$Msg });
            paramInt += 1;
          }
        } while (paramArrayOfByte.size() <= 0);
        paramArrayOfByte = ((im_msg_body.MsgBody)((alwc)paramArrayOfByte.get(paramArrayOfByte.size() - 1)).jdField_a_of_type_MsfMsgcommMsg_comm$Msg.msg_body.get()).msg_content.get().toByteArray();
      } while (this.jdField_a_of_type_ArrayOfByte == null);
  ...
  {
    lek.d("QQGAudioMsgHandler", "onRecvAppTipMsgData.");
    if (!a()) {}
    byte[] arrayOfByte1;
    Object localObject3;
    byte[] arrayOfByte2;
    ...
    for (;;)
    {
      ...
      l1 = lfx.b((byte[])localObject3, 4);
      j += 4;
      continue;
      j += 2;
      System.arraycopy(paramArrayOfByte, j, localObject3, 0, 4);
      i = lfx.a((byte[])localObject3, 4);
      if (i == 0)
      {
        b(l1);
        ...
        for (;;)
        {
          ...
          localObject2[i1] = lfx.b(arrayOfByte2, 8);
          i1 += 1;
          m += 8;
        }
        System.arraycopy(paramArrayOfByte, j, arrayOfByte1, 0, 2);
  ...
  {
    lek.d("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31.");
    if (this.jdField_a_of_type_ComTencentAvGaudioAVNotifyCenter == null) {
      return;
    }
    Object localObject1 = null;
    ...
    for (;;)
    {
      ...
      int i = lfx.a(arrayOfByte2, 4);
      if (i != 0)
      {
        localObject1 = new byte[2];
        System.arraycopy(paramArrayOfByte, paramArrayOfByte.length - 2, localObject1, 0, 2);
        lek.d("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31| retCode wR0=" + localObject1[0] + " wR1=" + localObject1[1]);
        if (localObject1[0] == 3)
        {
          b(paramArrayOfByte, i);
          return;
        }
        lek.e("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31|wrong retCode.");
        return;
      }
      localObject2 = new byte[2];
      System.arraycopy(paramArrayOfByte, paramArrayOfByte.length - 2, localObject2, 0, 2);
      lek.d("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31| relation type wR0=" + localObject2[0] + " wR1=" + localObject2[1]);
      int j;
      long l1;
      int k;
      if (localObject2[0] == 1)
      ...
      else
      {
        ...
        case 9: 
          for (;;)
          {
            ...
            lek.e("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31|wrong relation type.");
            j = 2;
            break;
            i += 2;
            System.arraycopy(paramArrayOfByte, i, arrayOfByte2, 0, 4);
            i += 4;
            l1 = lfx.b(arrayOfByte2, 4);
            continue;
            i += 6;
            continue;
            System.arraycopy(paramArrayOfByte, i, arrayOfByte1, 0, 2);
  ...
  {
    lek.d("QQGAudioMsgHandler", "onRecvMultiVideoS2C_0x95.");
    if (!a()) {}
    int i;
    label974:
    do
        ...
        while (j < n)
        {
          ...
          if (k < i1)
          {
            ...
            for (;;)
            {
              k += 1;
              break;
              l = lfx.a(localByteBuffer.getInt());
              continue;
              i = localByteBuffer.getInt();
              continue;
              localByteBuffer.getInt();
          ...
          mtz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l), new alvu(this, l, i));
          j += 1;
        }
      }
  ...
  void f(byte[] paramArrayOfByte)
  {
    ...
    long l1 = lfx.b((byte[])localObject, 8);
    int j = i + 8;
    localObject = new byte[4];
    System.arraycopy(paramArrayOfByte, j, localObject, 0, 4);
    i = lfx.a((byte[])localObject, 4);
    j += 4;
    localObject = new byte[2];
    ...
    if (k == 2)
    {
      ...
      l2 = lfx.a((byte[])localObject, 4);
      if (QLog.isColorLevel()) {
        QLog.d("QQGAudioMsgHandler", 2, "onRecvMuitiInvite discussId is" + l2 + "InviteUin:" + l1);
      }
      ((almt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).b(l2);
      if (this.jdField_a_of_type_ComTencentAvGaudioAVNotifyCenter != null) {
        this.jdField_a_of_type_ComTencentAvGaudioAVNotifyCenter.a(7, 2, l2, new long[] { l1 }, 1L);
      }
      paramArrayOfByte = Long.toString(l2);
      localObject = Long.toString(l1);
      ((awwg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(38)).a(0, l2, (String)localObject, "");
    ...
    while ((k == 1) && (i == 2))
    {
      new bilo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(new alvv(this));
      return;
      if ((k == 1) && (i == 10))
      {
        localObject = new byte[4];
    ...
    new maf(BaseApplication.getContext()).a(new alvw(this));
  }
  ...
  void g(byte[] paramArrayOfByte)
  {
    ...
    long l1 = lfx.b(arrayOfByte, 8);
    i += 8;
    arrayOfByte = new byte[4];
    System.arraycopy(paramArrayOfByte, i, arrayOfByte, 0, 4);
    int j = lfx.a(arrayOfByte, 4);
    arrayOfByte = new byte[4];
    System.arraycopy(paramArrayOfByte, i + 4, arrayOfByte, 0, 4);
    long l2 = lfx.b(arrayOfByte, 4);
    mtz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l2), new alvx(this, l2, j, l1));
  }
  ...
  void h(byte[] paramArrayOfByte)
  {
    ...
    ((almt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).b(l);
