...
public class sum
{
  protected static ssm<String, sun> a = new ssm(200);
  ...
  public static File a(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    while ((vws.a(paramString)) && (a(paramString, paramInt) != null))
    {
  ...
  {
    return ssi.h + a(paramString, false, 0L) + "/" + b(paramString, paramInt, paramBoolean1, paramBoolean2);
  }
  ...
  public static String a(String paramString, long paramLong, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (vws.a(paramString)) {}
    for (String str = ssi.h;; str = ssi.i) {
  ...
  public static void a(StoryVideoItem paramStoryVideoItem, String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        localtcz.a(paramStoryVideoItem.mVid, paramStoryVideoItem);
        return;
  ...
  {
    sun localsun = new sun();
    localsun.a = paramString2;
    a.a(paramString1, localsun);
  }
  ...
  {
    paramString = (sun)a.a(paramString);
    if (paramString != null) {
