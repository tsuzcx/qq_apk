...
public class anvl
{
  ...
  {
    anvl localanvl = a();
    BackgroundProbeManager.1 local1 = new BackgroundProbeManager.1(localanvl);
    BackgroundProbeManager.2 local2 = new BackgroundProbeManager.2(localanvl);
    boolean bool = localanvl.a();
    if (QLog.isColorLevel()) {
      QLog.i("BackgroundProbeManager", 2, "onRunningBackground: invoked.  probeEnabled: " + bool);
    }
    if (bool) {
      bbmp.a(local1, 180000L);
    }
    bbmp.a(local2, 181000L);
  }
  ...
  public static void a(Intent paramIntent)
  {
    ...
    for (int i = 1;; i = 0)
    {
      if ((c) && (b()) && (!jdField_b_of_type_Boolean) && (i != 0) && (paramIntent.getComponent() == null))
      {
        ...
        azpo.a(localBackgroundException, "intent: " + paramIntent.toString());
  ...
  private void b()
  {
    ...
    {
      azpo.a(new BackgroundException("startProbeService failed"));
    }
  }
