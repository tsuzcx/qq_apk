  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  ...
  amyk jdField_a_of_type_Amyk;
  public View a;
  anvo jdField_a_of_type_Anvo;
  ...
  public anvl(@NonNull BaseActivity paramBaseActivity, @NonNull ArrayList<QIMNotifyAddFriend> paramArrayList)
  {
    ...
    this.jdField_a_of_type_Amyk = ((amyk)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppInterface().getManager(257));
    ...
    {
      paramArrayList = b();
      bcef.b(null, "dc00898", "", "", "0X8008A9E", "0X8008A9E", 0, 0, "", "", "", "");
      ...
      {
        paramArrayList = (ImageView)paramArrayList.findViewById(2131373893);
    ...
    for (;;)
    {
      ...
      return;
      paramArrayList = a();
      bcef.b(null, "dc00898", "", "", "0X8008AA1", "0X8008AA1", 0, 0, "", "", "", "");
  ...
  private View a()
  {
    ...
    View localView = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131560840, null, false);
    localView.findViewById(2131369668).setOnClickListener(this);
    localView.findViewById(2131364615).setOnClickListener(this);
    TextView localTextView = (TextView)localView.findViewById(2131371743);
    String str = this.jdField_a_of_type_ComTencentMobileqqFlashchatFlashChatManager.c();
    if (!TextUtils.isEmpty(str)) {
      localTextView.setText(str);
    }
    this.jdField_a_of_type_ComTencentWidgetListView = ((XListView)localView.findViewById(2131370009));
    this.jdField_a_of_type_ComTencentWidgetListView.setSelector(new ColorDrawable(0));
    this.jdField_a_of_type_Anvo = new anvo(this, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
    this.jdField_a_of_type_Anvo.a(localList);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Anvo);
    ((Button)localView.findViewById(2131364983)).setOnClickListener(this);
    return localView;
  }
  ...
  private View b()
  {
    ...
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131560872, null, false);
    localRelativeLayout.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView = localRelativeLayout;
    Object localObject2 = localRelativeLayout.findViewById(2131365570);
    ...
    ((PressDarkImageView)localObject3).setId(2131364615);
    ((PressDarkImageView)localObject3).setImageResource(2130846452);
    Object localObject4 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject4).addRule(3, 2131365570);
    ...
    localObject3 = (TextView)((View)localObject2).findViewById(2131365588);
    ...
    localObject4 = (ImageView)((View)localObject2).findViewById(2131366260);
    Object localObject5 = (TextView)((View)localObject2).findViewById(2131371777);
    localObject3 = (TextView)((View)localObject2).findViewById(2131364905);
    ((View)localObject2).findViewById(2131364983).setOnClickListener(this);
    Object localObject6 = (TextView)((View)localObject2).findViewById(2131376047);
    ((TextView)localObject6).setTag(Long.valueOf(((QIMNotifyAddFriend)localObject1).uin));
    Object localObject7 = this.jdField_a_of_type_Amyk.a(((QIMNotifyAddFriend)localObject1).uin, ((QIMNotifyAddFriend)localObject1).qqUin);
    label410:
    int i;
    int j;
    int k;
    if (TextUtils.isEmpty((CharSequence)localObject7))
    {
      ...
      if (i > 0)
      {
        localObject2 = (LinearLayout)((View)localObject2).findViewById(2131377803);
        ...
        localObject6 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130839595);
    ...
    for (;;)
    {
      ...
      ((ImageView)localObject3).setOnClickListener(new anvm(this, ((QIMNotifyAddFriend.VideoInfo)((QIMNotifyAddFriend)localObject1).videoInfos.get(0)).videoVid));
    ...
    for (;;)
    {
      ...
      if (i < ((List)localObject1).size())
      {
        ...
        Drawable localDrawable = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130839595);
      ...
      for (;;)
      {
        ...
        ((URLImageView)localObject5).setOnClickListener(new anvn(this, (ArrayList)localObject3, (QIMNotifyAddFriend.VideoInfo)localObject4));
  ...
  public void a()
  {
    Button localButton = (Button)getWindow().findViewById(2131364983);
  ...
  {
    boolean bool = false;
    if (this.jdField_a_of_type_Anvo != null)
    {
      this.jdField_a_of_type_JavaUtilList.addAll(0, paramList);
      this.b.addAll(paramList);
      this.jdField_a_of_type_Anvo.a(this.jdField_a_of_type_JavaUtilList);
      a();
      bool = true;
    }
    return bool;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      dismiss();
      ((FriendListHandler)((QQAppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null)).getBusinessHandler(1)).addBatchQIMFriends(this.b);
      this.jdField_a_of_type_ComTencentMobileqqFlashchatFlashChatManager.a(getContext(), null);
      this.jdField_a_of_type_Amyk.a(this.b);
      if (this.jdField_a_of_type_Int == 1)
      {
        bcef.b(null, "dc00898", "", "", "0X8008A9F", "0X8008A9F", 0, 0, "", "", "", "");
      }
      else if (this.jdField_a_of_type_Int == 2)
      {
        bcef.b(null, "dc00898", "", "", "0X8008AA2", "0X8008AA2", 0, 0, "", "", "", "");
        continue;
        if (this.jdField_a_of_type_Int == 1) {
          bcef.b(null, "dc00898", "", "", "0X8008AA0", "0X8008AA0", 0, 0, "", "", "", "");
        }
        for (;;)
        {
          dismiss();
          ...
          if (this.jdField_a_of_type_Int == 2) {
            bcef.b(null, "dc00898", "", "", "0X8008AA3", "0X8008AA3", 0, 0, "", "", "", "");
          }
        }
        dismiss();
      }
