...
public class abru
{
  public static void a(Activity paramActivity)
  {
    ...
    while (ljj.b(BaseApplicationImpl.getContext())) {
      return;
    }
    if (!bgjw.a())
    {
    ...
    Object localObject = anhk.ba + "shortvideo/" + System.currentTimeMillis() + ".mp4";
      ...
      do
      {
        ...
        if ((localMessageRecord instanceof MessageForDevShortVideo))
        {
          ...
          if (!paramSession.bSend) {
            ...
            {
              Object localObject3 = new abrt();
              ((abrt)localObject3).a = paramSession.strFilePathSrc;
              ((abrt)localObject3).a();
              ((MessageForDevShortVideo)localObject2).md5 = ((abrt)localObject3).jdField_c_of_type_JavaLangString;
              ((MessageForDevShortVideo)localObject2).videoFileTime = ((int)(((abrt)localObject3).jdField_b_of_type_Long / 1000L));
              ((MessageForDevShortVideo)localObject2).thumbWidth = ((abrt)localObject3).jdField_b_of_type_Int;
              ((MessageForDevShortVideo)localObject2).thumbHeight = ((abrt)localObject3).jdField_c_of_type_Int;
              ((MessageForDevShortVideo)localObject2).thumbMD5 = ((abrt)localObject3).e;
              if (!paramBoolean) {
                break label282;
              }
              ...
              bgmg.b(paramSession.strFilePathSrc, (String)localObject3);
            }
          }
          for (;;)
          {
