...
{
  private static bngr jdField_a_of_type_Bngr;
  ...
  public bngr()
  {
    ...
    localbcuo.a();
    this.b = (localbcuo.d * 1000);
    this.jdField_a_of_type_Int = localbcuo.c;
    this.jdField_a_of_type_JavaLangString = localbcuo.jdField_a_of_type_JavaLangString;
  }
  
  public static bngr a()
  {
    if (jdField_a_of_type_Bngr == null) {}
    try
    {
      if (jdField_a_of_type_Bngr == null) {
        jdField_a_of_type_Bngr = new bngr();
      }
      return jdField_a_of_type_Bngr;
    }
    finally {}
  }
  ...
  public void a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      ??? = new bngs(this.jdField_a_of_type_JavaLangString, (ArrayList)localObject2, null);
      localObject2 = new QzoneCommonIntent(BaseApplicationImpl.getContext(), arxx.class);
      ((QzoneCommonIntent)localObject2).setRequest((bmsy)???);
