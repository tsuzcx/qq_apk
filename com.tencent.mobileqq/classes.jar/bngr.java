...
public class bngr
{
  private static Intent a(bnge parambnge, boolean paramBoolean, Context paramContext)
  {
    if ((parambnge != null) && (parambnge.jdField_a_of_type_Boolean)) {
  ...
  public static void a(Activity paramActivity, axmn paramaxmn, bmcn parambmcn, Bundle paramBundle, int paramInt)
  {
    a(paramActivity, paramaxmn, parambmcn, paramBundle, paramInt, null);
  }
  
  public static void a(Activity paramActivity, axmn paramaxmn, bmcn parambmcn, Bundle paramBundle1, int paramInt, Bundle paramBundle2)
  {
    if ((paramActivity == null) || (paramActivity.isFinishing()) || (parambmcn == null)) {}
    bmco localbmco;
    do
    {
      return;
      localbmco = parambmcn.a();
      if (localbmco != null) {
        break;
      }
    ...
    return;
    boolean bool = localbmco.a();
    int i = parambmcn.jdField_c_of_type_Int;
    int j = localbmco.c();
    int k = parambmcn.b();
    int m = localbmco.a();
    String str = localbmco.b();
    Intent localIntent = EditPicActivity.a(paramActivity, paramaxmn.jdField_a_of_type_JavaLangString, true, localbmco.jdField_c_of_type_Boolean, true, bool, true, localbmco.d(), localbmco.b(), localbmco.c(), i, k, j, false, null);
    ...
    localIntent.putExtra("shareto_web_mode", localbmco.jdField_a_of_type_Int);
    ...
    localIntent.putExtra("camera_mode", localbmco.jdField_b_of_type_Int);
    localIntent.putExtra("state", paramBundle1);
    bnaw.a(parambmcn.jdField_a_of_type_Int, "", "0X8007818", null);
    paramBundle1 = localbmco.a();
    parambmcn = localIntent;
    if (paramBundle1 != null)
    {
      ...
      parambmcn = aekt.a(localIntent, null);
    }
    parambmcn.putExtra("edit_video_way", paramInt);
    parambmcn.putExtra("sub_business_id", localbmco.d());
    paramBundle1 = SplashActivity.class.getName();
    paramBundle2 = localbmco.a();
    ...
    for (;;)
    {
      bnbe.a("finish");
      bnbe.a(parambmcn);
      parambmcn.putExtra("PhotoConst.PHOTO_SELECT_ACTIVITY_CLASS_NAME", paramBundle1);
      if (paramaxmn.jdField_a_of_type_Int == 1) {
        parambmcn.putExtra("editpic_cameratype", 1);
      }
      for (;;)
      {
        paramActivity.startActivityForResult(parambmcn, 1012);
        bnaw.a("", "0X80075C1", "", "", "", "");
        return;
        if (paramaxmn.jdField_a_of_type_Int == 0) {
          parambmcn.putExtra("editpic_cameratype", 2);
        }
      }
    }
  }
  
  public static void a(Activity paramActivity, CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo, bmcn parambmcn, Bundle paramBundle, int paramInt)
  {
    a(paramActivity, paramVideoCaptureResult, paramLocalMediaInfo, parambmcn, paramBundle, paramInt, null);
  }
  
  public static void a(Activity paramActivity, CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo, bmcn parambmcn, Bundle paramBundle1, int paramInt, @Nullable Bundle paramBundle2)
  {
    if ((paramActivity == null) || (paramActivity.isFinishing()) || (parambmcn == null)) {}
    bmcr localbmcr;
    do
    ...
    {
      if ((!localbmcr.jdField_c_of_type_Boolean) || (!azfz.o())) {
        break label1412;
      }
      l2 = l1 | 0x10;
      label95:
      ...
      l1 = l2;
      if (parambmcn.jdField_a_of_type_Int != 10013)
      {
        l1 = l2;
        if (parambmcn.jdField_a_of_type_Int != 10012) {
          l1 = l2 | 0x0 | 0x0;
        }
      }
      l2 = l1;
    ...
    for (Object localObject1 = new Bundle();; localObject1 = paramBundle2)
    {
      ...
      for (;;)
      {
        ...
        ((Bundle)localObject1).putInt("qq_sub_business_id", localbmcr.b());
        ((Bundle)localObject1).putInt("entrance_type", parambmcn.jdField_b_of_type_Int);
        bool1 = localbmcr.i();
        ...
        int k = parambmcn.jdField_c_of_type_Int;
        int m = localbmcr.c();
        wtb.b(m);
        localObject2 = ((blpo)blmf.a().c(8)).a();
        if (localObject2 != null)
        {
          l2 = l1;
        ...
        int i;
        int j;
        if (parambmcn.jdField_a_of_type_Int == 10002)
        {
          l1 = l2;
          if (localbmcr.g()) {
            l1 = l2 | 0x20000;
        ...
        l2 = l1;
        if (localbmcr.jdField_c_of_type_Int == 5) {
        ...
        ((EditVideoParams)localObject1).jdField_b_of_type_Int = localbmcr.jdField_c_of_type_Int;
        ((EditVideoParams)localObject1).f = paramActivity.getIntent().getIntExtra("VIDEO_STORY_FROM_TYPE", bkwm.a.a());
        ((EditVideoParams)localObject1).a.putBoolean("enable_hw_encode", true);
        if (localbmcr.jdField_c_of_type_Int == 2) {
          ((EditVideoParams)localObject1).e = 1;
        }
        if (QLog.isColorLevel()) {
          QLog.d("JumpUtil", 2, "EditVideoParams params:" + ((EditVideoParams)localObject1).toString());
        }
        ((EditVideoParams)localObject1).a.putInt("type", localbmcr.jdField_a_of_type_Int);
        ((EditVideoParams)localObject1).a.putInt("WebSceneType", localbmcr.jdField_b_of_type_Int);
        ((EditVideoParams)localObject1).a.putString("failedUrl", localbmcr.jdField_c_of_type_JavaLangString);
        ((EditVideoParams)localObject1).a.putString("succUrl", localbmcr.jdField_b_of_type_JavaLangString);
        ...
        for (;;)
        {
          ...
          paramVideoCaptureResult.putExtra("VIDEO_STORY_JUMP_TO_TYPE", bkwm.b(paramActivity.getIntent()));
          paramVideoCaptureResult.putExtra("VIDEO_STORY_FROM_TYPE", bkwm.a(paramActivity.getIntent()));
          ...
          if ((parambmcn.jdField_a_of_type_Int != 10000) && (parambmcn.jdField_a_of_type_Int != 10007) && (parambmcn.jdField_a_of_type_Int != 10004)) {
            break label1655;
          }
          l1 &= 0xFFFFFFDF;
          break label418;
          ...
          if ((paramBundle2 != null) && (paramBundle2.getBoolean("from_qzone_slideshow")))
          {
            ...
            paramVideoCaptureResult.putExtra("qqstory_slide_show_scene", xir.a().b());
            paramVideoCaptureResult.putExtra("qqstory_slide_show_entrance", xir.a().a());
            break label1230;
          }
        ...
        paramActivity.startActivityForResult(paramVideoCaptureResult, parambmcn.jdField_a_of_type_Int);
  ...
  public static void a(Activity paramActivity, CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo, bmcn parambmcn, Bundle paramBundle, int paramInt, bnge parambnge)
  {
    if ((paramActivity == null) || (paramActivity.isFinishing()) || (parambmcn == null)) {}
    bmcr localbmcr;
    do
    ...
    for (l2 = l1 & 0xDFFFFFFF & 0xFFFFFFF7 & 0xFFFFFEFF & 0xFFFFFFBF & 0xFFFFFFDF;; l2 = l1)
    {
      ...
      localBundle.putInt("qq_sub_business_id", localbmcr.b());
      localBundle.putInt("entrance_type", parambmcn.jdField_b_of_type_Int);
      boolean bool = localbmcr.i();
      paramVideoCaptureResult = new EditTakeVideoSource(paramVideoCaptureResult.videoMp4FilePath, paramVideoCaptureResult.audioDataFilePath, paramLocalMediaInfo);
      int i = parambmcn.jdField_c_of_type_Int;
      int j = localbmcr.c();
      wtb.b(j);
      paramLocalMediaInfo = ((blpo)blmf.a().c(8)).a();
      ...
      paramLocalMediaInfo = a(parambnge, bool, paramActivity);
      if (paramLocalMediaInfo.getComponent().getClassName().equals(EditWebVideoActivity.class.getName()))
      {
        paramLocalMediaInfo.putExtra("videoId", localbmcr.a());
        l2 = l1;
      }
      for (;;)
      {
        ...
        paramLocalMediaInfo.putExtra("edit_video_call_back", localbmcr.jdField_a_of_type_JavaLangString);
        paramVideoCaptureResult.a.putInt("type", localbmcr.jdField_a_of_type_Int);
        paramVideoCaptureResult.a.putInt("WebSceneType", localbmcr.jdField_b_of_type_Int);
        paramVideoCaptureResult.a.putString("failedUrl", localbmcr.jdField_c_of_type_JavaLangString);
        paramVideoCaptureResult.a.putString("succUrl", localbmcr.jdField_b_of_type_JavaLangString);
        l1 = paramActivity.getIntent().getLongExtra("troop_uin", 0L);
        if (l1 != 0L) {
          paramVideoCaptureResult.a.putLong("troop_uin", l1);
        }
        xnz.a(paramLocalMediaInfo, paramActivity.getIntent().getExtras(), paramActivity);
        ...
        SegmentKeeper.adjustTime(0L);
        paramActivity.startActivityForResult(paramLocalMediaInfo, parambmcn.jdField_a_of_type_Int);
        paramActivity.overridePendingTransition(0, 0);
        return;
        l2 = l1;
        if (paramLocalMediaInfo.getComponent().getClassName().equals(EditWebDanceMachineVideoActivity.class.getName()))
        {
          localBundle.putString("dance_machine_score_rate", parambnge.jdField_a_of_type_JavaLangString);
          localBundle.putInt("dance_machine_score", parambnge.jdField_a_of_type_Int);
          localBundle.putString("dance_machine_ptv_category", parambnge.jdField_b_of_type_JavaLangString);
          localBundle.putString("dance_machine_ptv_id", parambnge.jdField_c_of_type_JavaLangString);
          localBundle.putString("web_share_url", parambnge.g);
          localBundle.putString("over_percent", parambnge.f);
          localBundle.putBoolean("shook_head_count", parambnge.jdField_b_of_type_Boolean);
          localBundle.putInt("shook_head_count_value", parambnge.jdField_b_of_type_Int);
          localBundle.putBoolean("random_fortune", parambnge.jdField_c_of_type_Boolean);
          localBundle.putBoolean("fools_day", parambnge.d);
          l1 &= 0xFBFFFFFF;
          if ((!parambnge.jdField_b_of_type_Boolean) && (!parambnge.jdField_c_of_type_Boolean))
          {
            l2 = l1;
            if (!parambnge.d) {}
          }
  ...
  public static void a(Activity paramActivity, boolean paramBoolean, bmcu parambmcu)
  {
    parambmcu = new Intent(paramActivity, SplashActivity.class);
    parambmcu.putExtra("fragment_id", 1);
    if (paramBoolean)
    {
      parambmcu.putExtra("main_tab_id", 6);
      parambmcu.putExtra("open_now_tab_fragment", true);
      parambmcu.putExtra("extra_from_share", true);
      parambmcu.setFlags(335544320);
      paramActivity.startActivity(parambmcu);
      paramActivity.overridePendingTransition(2130771981, 2130771983);
      return;
    }
    parambmcu.putExtra("main_tab_id", 1);
    parambmcu.setFlags(335544320);
    paramActivity.startActivity(parambmcu);
  }
