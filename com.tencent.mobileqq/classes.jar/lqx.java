...
public class lqx
  extends kvw
{
  public lqx(AVActivity paramAVActivity) {}
  ...
  protected void a()
  {
    ...
    if (this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)
    {
      ...
      {
        this.a.jdField_e_of_type_Int = this.a.jdField_a_of_type_ComTencentAvVideoController.a().x;
        this.a.m = this.a.jdField_a_of_type_ComTencentAvVideoController.a().o;
      }
  ...
  protected void a(long paramLong)
  {
    ...
    kvq localkvq = this.a.jdField_a_of_type_ComTencentAvVideoController.a();
    kyj.a(31);
    String str1 = localkvq.jdField_d_of_type_JavaLangString;
    ...
    {
      bool1 = true;
      QLog.w(str2, 1, bool1 + "], peerUin[" + str1 + "], mShutCamera[" + this.a.f + "], SessionType[" + localkvq.jdField_d_of_type_Int + "], seq[" + paramLong + "]");
      if (this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI != null) {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI != null)
      {
        ...
        if ((2 == localkvq.jdField_d_of_type_Int) || (this.a.g)) {
  ...
  protected void a(long paramLong, int paramInt, String paramString)
  {
    ...
    if ((paramString != null) && (!mjg.a(paramString, this.a.c))) {
      return;
    }
    if ((paramInt == 49) && (this.a.jdField_a_of_type_ComTencentAvVideoController != null) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().A) && (this.a.jdField_a_of_type_Lxz != null)) {
      this.a.jdField_a_of_type_Lxz.c();
    }
    if ((this.a.jdField_a_of_type_Lrn != null) && (this.a.jdField_a_of_type_Lrn.a())) {
    ...
    krx.c(this.a.jdField_b_of_type_JavaLangString, "DataReport onClose: ");
    kyf.a(this.a.jdField_b_of_type_JavaLangString, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    ...
    mba.a(this.a.jdField_a_of_type_ComTencentAvVideoController.a());
    awqp.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    ...
    kxl.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramString);
    kxl.a(2, paramString);
    kxl.a(2);
  ...
  {
    if (this.a.jdField_a_of_type_Lwq != null) {
      this.a.jdField_a_of_type_Lwq.a(paramLong1, paramLong2, paramLong3);
    }
  }
  ...
  {
    if (this.a.jdField_a_of_type_Lwq != null) {
      this.a.jdField_a_of_type_Lwq.a(paramLong1, paramLong2, paramString);
    }
  }
  ...
  protected void a(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          krx.d(this.a.jdField_b_of_type_JavaLangString, "onDestroyUI, peerUin[" + paramString + "], isQuit[" + paramBoolean + "], mPeerUin[" + this.a.c + "], mIsDoubleVideoMeeting[" + this.a.g + "], mSessionType[" + this.a.jdField_b_of_type_Int + "], mSessionId[" + this.a.jdField_a_of_type_JavaLangString + "], mRelationId[" + this.a.jdField_d_of_type_JavaLangString + "], seq[" + l + "], \nsession[" + localkvq + "]");
          ...
          if ((this.a.c != null) && (paramString != null) && (this.a.c.equals(paramString)))
          {
            ...
            krx.d(this.a.jdField_b_of_type_JavaLangString, "onDestroyUI exit 1");
            this.a.finish();
            this.a.b(true);
            if (paramBoolean) {
              break label349;
          ...
          {
            paramString = baig.a(this.a.getApplicationContext()).edit();
            paramString.putInt("video_position", this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI.g());
            paramString.commit();
            mga.a(this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI.g());
            return;
    ...
    this.a.jdField_e_of_type_Boolean = paramBoolean;
    krx.d(this.a.jdField_b_of_type_JavaLangString, "onDestroyUI exit 2");
    this.a.b(l);
    this.a.h = true;
    this.a.finish();
    this.a.b(true);
    ...
    do
    {
      ...
      if ((localFile != null) && (localFile.exists()) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().g != 4) && (this.a.jdField_b_of_type_Int == 1) && (this.a.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent() != null))
      {
        ...
        if (this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView == null) {
          this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView = bavz.a((Activity)this.a.jdField_a_of_type_JavaLangRefWeakReference.get(), (RelativeLayout)this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent(), false);
        }
        if (!bavz.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getApplicationContext(), this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView, str, i, this.a.jdField_a_of_type_Bawf, paramInt, false)) {}
      }
  ...
  protected void b(long paramLong, String paramString, boolean paramBoolean)
  {
    ...
    if (paramString.equals(this.a.c)) {
      miu.a().a(paramLong, "DEVICE_SPEAKERPHONE");
    }
    if ((this.a.jdField_a_of_type_Lxz != null) && (this.a.jdField_a_of_type_Lxz.d() != 1)) {
  ...
  {
    krx.d(this.a.jdField_b_of_type_JavaLangString, "onFinish peerUin = " + paramString + " # isQuit :" + paramBoolean + "|" + this.a.jdField_b_of_type_Int + "|" + this.a.c);
    if ((this.a.jdField_b_of_type_Int == 1) || (this.a.jdField_b_of_type_Int == 2)) {
      if ((this.a.c != null) && (paramString != null) && (this.a.c.equals(paramString)))
      {
        this.a.jdField_e_of_type_Boolean = paramBoolean;
  ...
  protected void c()
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_Lwq != null) {
        this.a.jdField_a_of_type_Lwq.c();
      }
      if (this.a.jdField_a_of_type_Max != null) {
        this.a.jdField_a_of_type_Max.b();
      }
      boolean bool5;
      if ((this.a.jdField_a_of_type_ComTencentAvVideoController != null) && (this.a.jdField_a_of_type_Lxz != null) && (this.a.jdField_a_of_type_ComTencentAvCameraCameraUtils != null))
      {
        bool1 = localkvq.s;
        boolean bool2 = this.a.jdField_a_of_type_ComTencentAvCameraCameraUtils.b(l);
        boolean bool3 = localkvq.k;
        boolean bool4 = localkvq.A;
        bool5 = localkvq.B;
        ...
        if ((bool1) || (!bool3))
        {
          ...
          if (!bool1)
          {
            mct.a("0X8008ACB");
            if (this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
              lqb.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131630366);
            }
          }
        }
      }
  ...
  protected void c(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      break;
      label318:
      if ((bool) && (this.a.jdField_a_of_type_Lru != null)) {
        this.a.jdField_a_of_type_Lru.a("self", String.valueOf(3));
      }
    }
  }
