  ...
  implements InputFilter
{
  ...
  public alva(ExtendEditText paramExtendEditText, int paramInt)
  {
  ...
  {
    aluz localaluz = ExtendEditText.a(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewExtendEditText);
    if (localaluz == null)
    {
