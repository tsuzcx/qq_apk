...
public class anxv
{
  ...
  {
    if (paramInt == 2052) {
      return anvx.a(2131693458);
    }
    if (paramInt == 1033) {
      return anvx.a(2131693457);
    }
    return "";
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      str = apah.a(paramContext, "key_local_cache", "0");
      a("initializeAppLocale, localeIdStr:" + str);
      if (!"0".equals(str)) {
        break label182;
      }
      jdField_a_of_type_Int = 2052;
      apah.a(paramContext, "key_local_cache", String.valueOf(jdField_a_of_type_Int));
      str = apah.a(paramContext, "key_local_last", "0");
      if (!"0".equals(str)) {
        break label200;
      }
    ...
    {
      b = bool1;
      apah.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
  ...
  public static void a(Context paramContext, int paramInt)
  {
    ...
    apah.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
    apah.a(paramContext, "key_local_cache", String.valueOf(paramInt));
