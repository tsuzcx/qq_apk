  ...
  extends WebViewPlugin
{
  ...
  private static long a(bcdp parambcdp)
  {
    if (parambcdp == null) {
      return 0L;
    }
    try
    {
      long l = parambcdp.a().getIntent().getLongExtra("preAct_time", 0L);
      return l;
    }
    catch (Exception parambcdp)
    {
      QLog.w("QzoneWebViewOfflinePlugin", 2, "can not get click time", parambcdp);
    }
    return 0L;
  }
  ...
  private Object a(String paramString)
  {
    ...
    for (AppInterface localAppInterface = this.mRuntime.a();; localAppInterface = null)
    {
      ...
      return bhsl.a(localAppInterface, localCustomWebView, paramString, (String)localObject);
      localObject = null;
      break;
      localObject = null;
      break label27;
  ...
  private void a(bchg parambchg, String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (parambchg == null) {
      return;
    }
    QLog.i("QzoneWebViewOfflinePlugin", 1, "state is " + parambchg);
    for (;;)
    {
      ...
      try
      {
        ...
        switch (parambchg.jdField_a_of_type_Int)
        {
        case 1: 
          if (!TextUtils.isEmpty(parambchg.jdField_b_of_type_JavaLangString)) {
            localJSONObject.put("url", parambchg.jdField_b_of_type_JavaLangString);
          }
          localJSONObject.put("code", parambchg.jdField_c_of_type_Int);
          if (!TextUtils.isEmpty(parambchg.f)) {
            localJSONObject.put("msg", parambchg.f);
          }
          localJSONObject.put("dataIsBase64", parambchg.jdField_a_of_type_Boolean);
          if (TextUtils.isEmpty(parambchg.d)) {
            break label392;
          }
          if (!parambchg.jdField_a_of_type_Boolean) {
            break label383;
          }
          str = bbco.encodeToString(parambchg.d.getBytes(), 0);
          localJSONObject.put("data", str);
          if (parambchg.jdField_b_of_type_Int > 0) {
            localJSONObject.put("httpStatusCode", parambchg.jdField_b_of_type_Int);
          }
          if (!TextUtils.isEmpty(parambchg.jdField_c_of_type_JavaLangString)) {
            localJSONObject.put("header", new JSONObject(parambchg.jdField_c_of_type_JavaLangString));
          }
          if (parambchg.jdField_a_of_type_JavaLangObject != null) {
            localJSONObject.put("userinfo", parambchg.jdField_a_of_type_JavaLangObject);
          }
          callJs(paramString, new String[] { localJSONObject.toString() });
          long l1 = System.currentTimeMillis();
          long l2 = parambchg.jdField_a_of_type_Long;
          QLog.i("QzoneWebViewOfflinePlugin", 1, "wnscgi@ status=" + parambchg.jdField_a_of_type_Int + ",total cost " + (l1 - l2) + " ms");
          return;
        }
      }
      catch (Exception parambchg)
      {
        parambchg.printStackTrace();
        return;
      }
  ...
  private void a(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.mRuntime != null) {}
        for (paramVarArgs = this.mRuntime.a(); QzoneZipCacheHelper.checkAndDownLoadFileIfNeeded(paramVarArgs, str1, str2, str3, i, new xmh(this, str2, str3, str4)); paramVarArgs = null)
        {
  ...
  private static void b(String paramString, long paramLong, bcdp parambcdp)
  {
    int i;
    long l;
    try
    ...
    label205:
    String str1;
    if ((!TextUtils.isEmpty(paramString)) && (parambcdp != null) && ((8589934594L == paramLong) || (8589934593L == paramLong)) && (paramString.equals(QzoneConfig.getInstance().getConfig("H5Url", "GameBar", "https://h5.qzone.qq.com/h5plus/homeV2/index/alpha?_proxy=1&_wv=3&via=qqnavigation.2017"))))
    {
      l = a(parambcdp);
      if (l <= 0L)
      {
      ...
      if (QzoneOfflineCacheHelper.getSmallGameLastCacheTime(parambcdp.a().getLongAccountUin()) <= 0L) {
        break label367;
      }
      i = 1;
    ...
    for (;;)
    {
      ...
      axqn.a(localBaseApplication).reportTimeKVEvent(str1, localProperties, (int)l);
      if (8589934594L == paramLong) {}
      for (paramString = ajya.a(2131712630);; paramString = ajya.a(2131712631))
      {
        QLog.i("QzoneWebViewOfflinePlugin", 2, paramString + l + "ms,mta key=" + str1);
        if (8589934594L != paramLong) {
          break;
        }
        QzoneOfflineCacheHelper.updataSmallGameLastCacheFinishTime(parambcdp.a().getLongAccountUin(), System.currentTimeMillis());
        return;
      }
      while (i == 0)
      {
  ...
  private void c(String... paramVarArgs)
  {
    ...
    bchf localbchf = new bchf();
    Object localObject2;
    try
    {
      localObject2 = new JSONObject(paramVarArgs[0]);
      localbchf.f = ((JSONObject)localObject2).optString("callback");
      localbchf.jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("url");
      if (TextUtils.isEmpty(localbchf.jdField_a_of_type_JavaLangString)) {
    ...
    catch (Exception localException)
    {
      ...
      paramVarArgs = new bchg();
      paramVarArgs.jdField_b_of_type_JavaLangString = localbchf.jdField_a_of_type_JavaLangString;
      paramVarArgs.jdField_a_of_type_Int = 3;
      paramVarArgs.jdField_c_of_type_Int = 101;
      paramVarArgs.f = localException.getMessage();
      paramVarArgs.e = localbchf.f;
      a(paramVarArgs, localbchf.f);
      return;
    }
    if (!a(a(), localbchf.jdField_a_of_type_JavaLangString))
    {
      localObject1 = a(a());
      localObject2 = a(localbchf.jdField_a_of_type_JavaLangString);
      throw new Exception("not support for cross-domain request!!! current host=" + (String)localObject1 + ",req host=" + (String)localObject2);
    }
    localbchf.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("method");
    if ((!"GET".equalsIgnoreCase(localbchf.jdField_b_of_type_JavaLangString)) && (!"POST".equalsIgnoreCase(localbchf.jdField_b_of_type_JavaLangString))) {
      throw new Exception("no such method support!!!");
    }
    Object localObject1 = ((JSONObject)localObject2).opt("body");
    if ((localObject1 instanceof JSONObject)) {
      localbchf.e = "application/x-www-form-urlencoded";
    }
    for (localbchf.d = a((JSONObject)localObject1);; localbchf.d = localObject1.toString())
    {
    ...
    {
      localbchf.jdField_c_of_type_JavaLangString = ((String)localObject1);
      localbchf.jdField_a_of_type_Boolean = ((JSONObject)localObject2).optBoolean("dataNeedBase64", false);
      localbchf.jdField_a_of_type_Int = ((int)(((JSONObject)localObject2).optDouble("timeout", 0.0D) * 1000.0D));
      localbchf.jdField_a_of_type_JavaLangObject = ((JSONObject)localObject2).opt("userinfo");
      if (this.jdField_b_of_type_AndroidOsHandler == null) {
        this.jdField_b_of_type_AndroidOsHandler = new xmi(this, Looper.getMainLooper());
      }
      if (bche.a().a(localbchf, this.jdField_b_of_type_AndroidOsHandler)) {
        break;
      }
      paramVarArgs = new bchg();
      paramVarArgs.jdField_b_of_type_JavaLangString = localbchf.jdField_a_of_type_JavaLangString;
  ...
  protected void a(bchg parambchg)
  {
    a(parambchg, parambchg.e);
  }
  ...
  public Object handleEvent(String paramString, long paramLong)
  {
    if (paramLong == 8L)
    {
      if (this.mRuntime != null)
      {
        bhsl.a = new WeakReference(this.mRuntime.a());
        bhsl.b = new WeakReference(this.mRuntime.a());
      }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      if ((paramJsBridgeListener.has("proxyUrl")) && (paramJsBridgeListener.has("isCheckCache")))
      {
        ...
        if ((bool) && (!TextUtils.isEmpty(bchs.d(this.jdField_a_of_type_JavaLangString))))
        {
        ...
        if (this.jdField_a_of_type_AndroidOsHandler == null) {
          this.jdField_a_of_type_AndroidOsHandler = new xmg(this, Looper.getMainLooper());
        }
