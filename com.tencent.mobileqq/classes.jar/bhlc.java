...
public final class bhlc
{
  ...
  @NonNull
  public static final bhlc d;
  @NonNull
  public static final bhlc e;
  @NonNull
  public static final bhlc f;
  ...
  static
  {
    ...
    c(jdField_a_of_type_Bhlc);
    d(jdField_a_of_type_Bhlc);
    jdField_b_of_type_Bhlc = new bhlc();
    b(jdField_b_of_type_Bhlc);
    d(jdField_b_of_type_Bhlc);
    jdField_c_of_type_Bhlc = new bhlc();
    a(jdField_c_of_type_Bhlc);
    d(jdField_c_of_type_Bhlc);
    d = new bhlc();
    c(d);
    e(d);
    e = new bhlc();
  ...
  private static void a(bhlc parambhlc)
  {
    parambhlc.jdField_b_of_type_ArrayOfFloat[1] = 0.26F;
    parambhlc.jdField_b_of_type_ArrayOfFloat[2] = 0.45F;
  }
  ...
  private static void b(bhlc parambhlc)
  {
    parambhlc.jdField_b_of_type_ArrayOfFloat[0] = 0.3F;
    parambhlc.jdField_b_of_type_ArrayOfFloat[1] = 0.5F;
    parambhlc.jdField_b_of_type_ArrayOfFloat[2] = 0.7F;
  }
  
  private static void c(bhlc parambhlc)
  {
    parambhlc.jdField_b_of_type_ArrayOfFloat[0] = 0.55F;
    parambhlc.jdField_b_of_type_ArrayOfFloat[1] = 0.74F;
  }
  
  private static void d(bhlc parambhlc)
  {
    parambhlc.jdField_a_of_type_ArrayOfFloat[0] = 0.35F;
    parambhlc.jdField_a_of_type_ArrayOfFloat[1] = 1.0F;
  }
  
  private static void e(bhlc parambhlc)
  {
    parambhlc.jdField_a_of_type_ArrayOfFloat[1] = 0.3F;
    parambhlc.jdField_a_of_type_ArrayOfFloat[2] = 0.4F;
  }
