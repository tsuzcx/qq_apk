...
{
  private WeakReference<mmx> jdField_a_of_type_JavaLangRefWeakReference;
  
  public mmv(EffectFilterTextPager paramEffectFilterTextPager, mmx parammmx)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parammmx);
  }
  ...
  public void onPageSelected(int paramInt)
  {
    ...
    if ((EffectFilterTextPager.a(this.jdField_a_of_type_ComTencentAvUiFunchatFilterEffectFilterTextPager) != paramInt) && (this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null))
    {
      ...
      if (localFilterItem != null) {
        ((mmx)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(l, paramInt, localFilterItem.getId());
      }
