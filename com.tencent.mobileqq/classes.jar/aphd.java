  ...
  implements aztj
{
  ...
  public aphd(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, aphc paramaphc)
  {
    super(paramQQAppInterface, paramLong1, paramLong2, paramInt, paramaphc);
  }
  
  public static aztj a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, String paramString, aphc paramaphc)
  {
    if (paramaphc == null)
    {
    ...
    paramQQAppInterface = new aphd(paramQQAppInterface, paramLong1, paramLong2, 1, paramaphc);
  ...
  protected void a(int paramInt, ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (this.jdField_a_of_type_Aztk != null)
    {
      ...
      this.jdField_a_of_type_Aztk.a(true, a(), paramInt, "", "", localBundle);
    }
  }
  ...
  protected void a(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    if (this.jdField_a_of_type_Aztk != null) {
      this.jdField_a_of_type_Aztk.a(paramLong2, this.jdField_a_of_type_Aphc.a());
    }
  }
  ...
  protected void a(ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (this.jdField_a_of_type_Aztk != null) {
      this.jdField_a_of_type_Aztk.a(paramExcitingTransferDownloadCompletedInfo.m_strFileSavePath);
    }
  }
