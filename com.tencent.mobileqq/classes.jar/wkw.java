  ...
  implements wnr
{
  ...
  public void a(CertifiedAccountRead.StGetFeedDetailRsp paramStGetFeedDetailRsp, boolean paramBoolean, long paramLong, String paramString)
  {
    ...
    {
      QLog.e(wku.jdField_a_of_type_JavaLangString, 1, "onFeedResponse rsp is null");
      return;
    }
    CertifiedAccountMeta.StFeed localStFeed = (CertifiedAccountMeta.StFeed)paramStGetFeedDetailRsp.feed.get();
    QLog.d(wku.jdField_a_of_type_JavaLangString, 1, "onFeedResponse hideLoadingView!");
    this.a.d();
    boolean bool = wku.a(this.a, paramLong, localStFeed);
    String str = wku.jdField_a_of_type_JavaLangString;
    ...
    wku.a(this.a, paramStGetFeedDetailRsp.share);
    wku.a(this.a, paramStGetFeedDetailRsp.detailUrl.get());
    wku.b(this.a, paramStGetFeedDetailRsp.share);
    this.a.a(localStFeed);
    QLog.i(wku.jdField_a_of_type_JavaLangString, 1, "isFinish:" + paramStGetFeedDetailRsp.isFinish.get() + " | recommend feeds size:" + paramStGetFeedDetailRsp.vecRcmdFeed.get().size());
    this.a.a(paramStGetFeedDetailRsp, paramBoolean);
    if (!paramBoolean) {
      xhb.a(this.a.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.poster.id.get(), "auth_" + wux.a(this.a.a()), "exp", 0, 0, new String[] { "", "", localStFeed.id.get(), localStFeed.title.get() });
    }
    this.a.d(true);
  }
}
