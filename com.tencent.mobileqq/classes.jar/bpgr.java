...
{
  public bpgr(AEEditorImageEditFragment paramAEEditorImageEditFragment, boolean paramBoolean) {}
  
  public void onClick(View paramView)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      bozz.a().a("ae_editor_tool_bar_red_dot_frame", true, 0);
      View localView = AEEditorImageEditFragment.a(this.jdField_a_of_type_DovComQqImAeeditorModuleEditAEEditorImageEditFragment).findViewById(2131376739);
      if (localView != null) {
