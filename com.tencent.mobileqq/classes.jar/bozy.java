  ...
  implements View.OnClickListener
{
  ...
  public bozy(@NonNull bpep parambpep)
  {
    super(parambpep);
  ...
  public void a()
  {
    ...
    d();
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)a(2131377119));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131377114));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131377115));
    this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)a(2131367493));
    ...
    this.jdField_a_of_type_AndroidWidgetSeekBar.setOnSeekBarChangeListener(new bozz(this));
  }
  
  public void a(@NonNull bpsf parambpsf)
  {
    if (this.e == -1) {
      if (this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_Boolean)
      {
        parambpsf.a.jdField_b_of_type_Int = ((int)this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a());
        parambpsf.a.d = this.jdField_a_of_type_Boolean;
        if (QLog.isColorLevel()) {
  ...
  {
    boolean bool = false;
    if (this.jdField_a_of_type_Bpep.jdField_a_of_type_Int == 21)
    {
      NativeGifImage.QZONE_DELAY = this.c;
      if (this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable != null) {
        this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a(NativeGifImage.QZONE_DELAY);
      }
      this.e = this.c;
  ...
  public void a_(int paramInt, Object paramObject)
  {
    ...
    if (this.e == -1)
    {
      ...
      paramInt = (int)this.jdField_a_of_type_Bpep.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a();
      this.e = paramInt;
      this.c = paramInt;
    }
