...
public class amsn
{
  public static int a(String paramString)
  {
    try
    {
      int i = amsp.a("arfeature", "v8.0.0", amsp.b("arfeature", "v8.0.0", "arfeature"), paramString);
      return i;
    }
    finally
    {
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        amsp.a("arfeature", "v8.0.0", "arfeature", paramString2);
        try
        {
          amsl.a(paramString1, amsp.a("arfeature", "v8.0.0", amsp.b("arfeature", "v8.0.0", "arfeature")));
          paramString2 = amsp.a("arfeature", "v8.0.0", amsp.b("arfeature", "v8.0.0", "arfeature")) + File.separator + "md5_config.xml";
        ...
        catch (IOException paramString2)
        {
          ...
          String str;
          i = -6;
          bdcs.a(amsp.a("arfeature", "v8.0.0", amsp.b("arfeature", "v8.0.0", "arfeature")), false);
      ...
      try
      {
        ...
        {
          paramString1 = amsp.a("arfeature", "v8.0.0", amsp.b("arfeature", "v8.0.0", "arfeature")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".so";
          amsp.a("arfeature", "v8.0.0", "libARFeature", (String)((Map.Entry)localObject).getValue());
        }
  ...
  {
    return new File(amsp.a("arfeature", "v8.0.0", amsp.b("arfeature", "v8.0.0", "arfeature")) + File.separator + "libARFeature" + ".so").exists();
  }
}
