...
public final class bhcs
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, avli paramavli)
  {
    if ((paramContext == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      paramQQAppInterface.a(-1, new bhct(paramavli));
      return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, boolean paramBoolean, ProfileActivity.AllInOne paramAllInOne)
  {
    ...
    if (paramAllInOne != null)
    {
      ...
      if ((i == 1) || (i == 0))
      {
        ...
        localbbbq = (bbbq)paramQQAppInterface.getManager(QQManagerFactory.MGR_RED_TOUCH);
        localbbbq.b("100005.100006");
        ...
        i2 = 1;
        label204:
        if (!((gb)paramQQAppInterface.getManager(QQManagerFactory.CHAT_FONT_MANAGER)).jdField_a_of_type_Boolean) {
          break label498;
        }
    ...
    for (;;)
    {
      ...
      if (paramAllInOne == null)
      {
        ...
        localIntent.putExtra("url", bhnp.a(paramContext, "pendant", ""));
      ...
      for (i = 40202;; i = 40201)
      {
        ...
        bdla.b(paramQQAppInterface, "CliOper", "", "", "PendantMarket", "OtherEntrance", 0, 0, "", "", "", "");
        return;
  ...
  {
    ((VasExtensionHandler)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.VAS_EXTENSION_HANDLER)).a(new String[] { paramString }, new int[] { 27235 });
  }
  ...
  public static String c(long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      return asdi.a("VIP_avatar", localStringBuilder.toString());
      localStringBuilder.append("aio_50.png");
      continue;
      localStringBuilder.append("aio_file.zip");
      continue;
