  ...
  extends FilterData.FilterPageItem
{
  ...
  public aobs(SpeedFilterData paramSpeedFilterData, @NonNull Context paramContext, ViewGroup paramViewGroup)
  {
    super(paramContext, paramViewGroup);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131371998));
  }
  ...
  private void a(ImageView paramImageView, char paramChar, boolean paramBoolean)
  {
    ...
    case '0': 
      if (paramBoolean)
      {
        paramImageView.setImageResource(2130843726);
        return;
      }
      paramImageView.setImageResource(2130843727);
      return;
    case '1': 
      paramImageView.setImageResource(2130843728);
      return;
    case '2': 
      paramImageView.setImageResource(2130843729);
      return;
    case '3': 
      paramImageView.setImageResource(2130843730);
      return;
    case '4': 
      paramImageView.setImageResource(2130843731);
      return;
    case '5': 
      paramImageView.setImageResource(2130843732);
      return;
    case '6': 
      paramImageView.setImageResource(2130843733);
      return;
    case '7': 
      paramImageView.setImageResource(2130843734);
      return;
    case '8': 
      paramImageView.setImageResource(2130843735);
      return;
    }
    paramImageView.setImageResource(2130843736);
  }
  
  protected View a(@NonNull Context paramContext, ViewGroup paramViewGroup)
  {
    return LayoutInflater.from(paramContext).inflate(2130970837, paramViewGroup, false);
  }
