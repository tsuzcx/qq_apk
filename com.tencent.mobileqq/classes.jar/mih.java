...
@TargetApi(18)
public class mih
  implements Handler.Callback, View.OnClickListener, mnk, mnn, mnt
{
  ...
  public mih(AVActivity paramAVActivity, RelativeLayout paramRelativeLayout1, VideoController paramVideoController, VideoAppInterface paramVideoAppInterface, RelativeLayout paramRelativeLayout2, VideoControlUI paramVideoControlUI)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentAvUiDoubleVideoCtrlUI == null)
      {
        ...
        this.jdField_a_of_type_Mnl = mnl.a();
        this.jdField_a_of_type_Long = (this.jdField_a_of_type_Mnl.h * 60 * 1000L);
  ...
  private void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      if (paramLong >= 0L)
      {
        ...
        maf.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131695126);
        mno.a("0X8008AB0");
      }
      else if (paramLong < 0L)
      {
        a(3, true);
        maf.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131695101);
  ...
  public static void a(VideoController paramVideoController)
  {
    ...
    paramVideoController.a(8, "SUPPORT_TRUE");
    paramVideoController.a(8, "SUPPORT_TRUE_7.3.5#" + mnl.a().h);
    paramVideoController.a(8, "SUPPORT_TRUE_7.3.5#" + mnl.a().h);
  }
  
  private void a(VideoAppInterface paramVideoAppInterface)
  {
    LayoutInflater.from((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).inflate(2131559791, this.jdField_a_of_type_AndroidWidgetRelativeLayout);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131380770));
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376260));
    this.jdField_e_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376259));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378539));
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376245));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376242);
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376241);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376240);
    ...
    this.jdField_a_of_type_Int = afur.a(51.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    this.jdField_b_of_type_JavaLangString = ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getString(2131695114);
    this.jdField_c_of_type_JavaLangString = ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getString(2131695110);
    this.jdField_a_of_type_ComTencentAvUiFunchatRecordQavRecordButtonView = ((QavRecordButtonView)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131376232));
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131376248));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131376247));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    if (AudioHelper.a(0) == 1)
    {
  ...
  private void b(long paramLong)
  {
    ...
    this.jdField_a_of_type_ComTencentAvVideoController.a().B = false;
    maf.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131695102);
    this.jdField_a_of_type_ComTencentAvVideoController.F();
    n();
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new Object[] { Integer.valueOf(163) });
  ...
  private void h(int paramInt)
  {
    ...
    do
    {
      ...
      for (paramInt = 2131695116;; paramInt = 2131695115)
      {
  ...
  private void r()
  {
    ...
    afur.a(7.5F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    afur.a(64.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    b(2131297813);
    b(2131297810);
    b(2131297810);
    b(2131297812);
    ...
    if (this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener == null) {
      this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new mii(this);
    }
    if (this.jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener == null) {
      this.jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new mij(this);
    }
  ...
  private void u()
  {
    ...
    {
      localAVActivity.jdField_a_of_type_Mbx.c(2);
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController.a().B)
    {
      ...
      bcst.b(null, "CliOper", "", "", "0X800863B", "0X800863B", 0, 0, String.valueOf(l), "", "", "");
      bctj.a(BaseApplicationImpl.getContext()).a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), "av_record_click_end", true, l, 0L, null, "", false);
      return;
    }
    ...
    if (!f())
    {
      if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
        maf.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695096);
      }
      j = 0;
    ...
    for (;;)
    {
      if (j != 0)
      {
        ...
        {
          localObject = (lgp)localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3);
          if (((FaceItem)((lgp)localObject).a() != null) && (((lgp)localObject).a()) && (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)) {
            maf.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695106);
          }
        }
        mno.a("0X800863A");
        ...
        for (;;)
        {
          ...
          if (!this.jdField_a_of_type_ComTencentAvVideoController.a().A)
          {
            ...
            for (j = 2131695104;; j = 2131695103)
            {
              if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface == null) {
                break label1192;
              }
              maf.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, j);
              j = 0;
              break;
              mno.a("0X8008AB5");
            }
          ...
          {
            if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
              maf.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695109);
            }
            j = 0;
          ...
          if ((this.jdField_a_of_type_ComTencentAvVideoController.a().C) && (this.jdField_a_of_type_ComTencentAvVideoController.a().u < 735))
          {
            ...
            maf.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695107);
            j = 0;
            break;
          }
          if (!e())
          {
            ...
            if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
              maf.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695105);
            }
            j = 0;
            break;
          }
          ...
          {
            localObject = (lgp)localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3);
            FaceItem localFaceItem = (FaceItem)((lgp)localObject).a();
            if (localFaceItem != null)
            {
              boolean bool1 = ((lgp)localObject).a();
              ...
              label801:
              for (j = 2131695129;; j = 2131695128)
              {
                maf.a((VideoAppInterface)localObject, 1022, j);
                j = 0;
          ...
          {
            localObject = (lip)localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
            if (localObject != null)
            {
              localObject = (ZimuItem)((lip)localObject).a();
              if (localObject != null)
              {
                ...
                for (j = 1;; j = 0)
                {
                  ...
                  maf.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695130);
                  j = 0;
          ...
          label931:
          if ((localAVActivity.jdField_a_of_type_Mmj != null) && (localAVActivity.jdField_a_of_type_Mmj.a()))
          {
            j = 0;
            maf.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695127);
            break;
          }
          if (mnb.a() < 31457280L)
          {
            if (localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
              maf.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695121);
            }
            j = 0;
          ...
          if ((mpu.a()) && (mpu.a(localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface).c()))
          {
          ...
          {
            localObject = (lhp)localAVActivity.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2);
            if ((localObject != null) && (((lhp)localObject).a() != null))
            {
  ...
  private void w()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentAvUiVideoNetStateBar.d(b() + b(2131297772));
      return;
    }
    this.jdField_a_of_type_ComTencentAvUiVideoNetStateBar.d(b(2131297772));
  }
  ...
  int a()
  {
    ...
    {
      if (bool) {
        j = bqcd.b((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get());
      }
    }
    else {
      return j;
  ...
  public long a()
  {
    try
    {
      ...
      for (l = this.jdField_g_of_type_Long;; l = mnb.a(this.jdField_a_of_type_JavaIoFile))
      {
        if (QLog.isColorLevel()) {
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      mnb.a(paramString, (Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        ...
        j = mnp.a(paramString2, this.jdField_a_of_type_Mnl.h);
    ...
    case 1: 
      ...
      for (;;)
      {
        ...
        {
          paramString1 = (lhp)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2);
    ...
    case 8: 
      ...
      {
        a(4, false);
        maf.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695100);
      }
      for (;;)
      {
        m();
        return;
        a(9, false);
        maf.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695099);
      }
    case 4: 
      a(3);
      return;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    Object localObject;
    int j;
    if ((this.jdField_c_of_type_AndroidWidgetRelativeLayout.getVisibility() == 0) && (!b()) && (!bqcd.b()))
    {
    ...
    for (;;)
    {
      localObject = (RedPacketGameView)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).findViewById(2131373447);
      if (localObject != null) {
  ...
  {
    if ((jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Mnr != null) && (paramInt1 == 100)) {
  ...
  public int[] a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      {
        j = mio.b(paramInt1);
        this.jdField_d_of_type_JavaLangString = mnb.a();
        ...
        paramInt2 = this.jdField_a_of_type_Mnl.f;
        if (paramInt1 > paramInt2)
        {
          ...
          if (j % 2 == 1)
          {
            ...
            batj localbatj = new batj(this.jdField_d_of_type_JavaLangString, paramInt1, paramInt2, 5120000, 1, false, 0);
  ...
  public void b(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      mno.a(this.jdField_a_of_type_Mnl.r, this.jdField_a_of_type_Mnl.s, paramInt, b());
      return;
      if (paramInt == 2)
      {
        b(b());
  ...
  public void b(int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout$LayoutParams.setMargins(b(2131297813), 0, 0, 0);
  ...
  public void d()
  {
    ...
    if ((this.jdField_c_of_type_Int == 90) || (this.jdField_c_of_type_Int == 270))
    {
      ...
      this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams.leftMargin = afur.a(15.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
      if (this.jdField_d_of_type_AndroidWidgetRelativeLayout != null) {
        this.jdField_d_of_type_AndroidWidgetRelativeLayout.setLayoutParams(this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams);
      }
  ...
  public void f(int paramInt)
  {
    ...
    case 180: 
      ...
      localLayoutParams.setMargins(afur.a(10.0F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()), 0, 0, 0);
      localLayoutParams.addRule(2, 0);
      localLayoutParams.addRule(1, 2131376232);
      localLayoutParams.addRule(6, 2131376232);
    ...
    localLayoutParams.setMargins(afur.a(-12.5F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()), 0, 0, afur.a(32.5F, ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    localLayoutParams.addRule(2, 2131376232);
  ...
  public void g(int paramInt)
  {
    ...
    default: 
      return;
    case 0: 
      FaceItem localFaceItem = (FaceItem)((lgp)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3)).a();
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      for (;;)
      {
        mno.a("0X8008AC8");
        return;
        maf.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695112);
      }
      maf.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695111);
      mno.a("0X8008AC9");
      return;
  ...
  public boolean h()
  {
    ...
    {
      localObject = (lgp)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3);
      FaceItem localFaceItem = (FaceItem)((lgp)localObject).a();
      if (localFaceItem != null)
      {
        bool4 = ((lgp)localObject).a();
    ...
    for (boolean bool5 = true;; bool5 = false)
    {
      ...
      {
        localObject = (lip)((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
        if (localObject != null)
        {
          localObject = (ZimuItem)((lip)localObject).a();
          if (localObject != null) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (l > this.jdField_a_of_type_Long)
      {
        ...
        bcst.b(null, "CliOper", "", "", "0X800863C", "0X800863C", 0, 0, String.valueOf(l), "", "", "");
        bctj.a(BaseApplicationImpl.getContext()).a("", "av_record_timeout", true, l, 0L, null, "", false);
        return true;
      }
      ...
      if (!((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).i)
      {
        ...
        continue;
        if (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
          maf.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1022, 2131695113);
        }
      }
    }
  }
  ...
  public boolean i()
  {
    ...
    {
      if (this.jdField_a_of_type_Mnl.r <= this.jdField_a_of_type_Mnl.jdField_d_of_type_Int) {
        break label111;
      }
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Mnl.jdField_a_of_type_Int != 1) {
      ...
      return true;
      label111:
      if ((this.jdField_a_of_type_Mnl.r == this.jdField_a_of_type_Mnl.jdField_d_of_type_Int) && (this.jdField_a_of_type_Mnl.s >= this.jdField_a_of_type_Mnl.jdField_e_of_type_Int)) {
        this.jdField_b_of_type_Int = 2;
      } else if (this.jdField_a_of_type_Mnl.r > this.jdField_a_of_type_Mnl.jdField_b_of_type_Int) {
        this.jdField_b_of_type_Int = 1;
      } else if ((this.jdField_a_of_type_Mnl.r == this.jdField_a_of_type_Mnl.jdField_b_of_type_Int) && (this.jdField_a_of_type_Mnl.s >= this.jdField_a_of_type_Mnl.jdField_c_of_type_Int)) {
        this.jdField_b_of_type_Int = 1;
      } else {
  ...
  public void l()
  {
    ...
    b(true);
    if (((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface != null) {
      maf.a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1023, 2131695132);
    }
    this.jdField_a_of_type_ComTencentAvVideoController.a().C = false;
    n();
    ((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new Object[] { Integer.valueOf(163) });
    long l = (System.currentTimeMillis() - this.jdField_c_of_type_Long) / 1000L;
    bcst.b(null, "CliOper", "", "", "0X800863E", "0X800863E", 0, 0, "", String.valueOf(l), "", "");
    bctj.a(BaseApplicationImpl.getContext()).a(((AVActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), "av_record_cancel", true, l, 0L, null, "", false);
    c(1);
  }
