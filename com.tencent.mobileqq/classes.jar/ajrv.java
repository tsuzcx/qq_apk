  ...
  extends BaseAdapter
{
  ...
  private ajrw jdField_a_of_type_Ajrw;
  private Resources jdField_a_of_type_AndroidContentResResources;
  private LayoutInflater jdField_a_of_type_AndroidViewLayoutInflater;
  private List jdField_a_of_type_JavaUtilList;
  
  public ajrv(Context paramContext, List paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_Ajrw == null) {
      this.jdField_a_of_type_Ajrw = new ajrw(paramViewGroup.getContext());
    }
    if (paramView == null)
    {
    ...
    if (paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.jdField_b_of_type_Boolean)
    {
      ...
      localObject = this.jdField_a_of_type_Ajrw.a((Drawable)localObject, paramInt, i);
      if (!paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.jdField_b_of_type_Boolean) {
        break label421;
      }
      Drawable localDrawable = ajrw.a(this.jdField_a_of_type_Ajrw, (Drawable)localObject);
      localObject = this.jdField_a_of_type_Ajrw.a((Drawable)localObject, localDrawable);
    ...
    for (;;)
    {
      ...
      break label294;
      label421:
      localObject = ajrw.b(this.jdField_a_of_type_Ajrw, (Drawable)localObject);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
    }
    label444:
