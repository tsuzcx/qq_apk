  ...
  extends AsyncTask<Integer, Void, Bitmap>
{
  ...
  private WeakReference<ajru> jdField_a_of_type_JavaLangRefWeakReference;
  
  public ajrv(ajru paramajru, int paramInt)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramajru);
  ...
  protected Bitmap a(Integer... paramVarArgs)
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: getfield 21	ajrv:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   66: aload_3
    //   67: getfield 66	ajru:a	Ljava/lang/String;
  ...
  protected void a(Bitmap paramBitmap)
  {
    ...
    ajru localajru = (ajru)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((localajru != null) && (paramBitmap != null) && (!paramBitmap.isRecycled())) {
      localajru.a(paramBitmap, this.jdField_a_of_type_Int);
    }
  }
}
