...
public class xkk
{
  ...
  public static final String a(String paramString)
  {
    ...
    File localFile = new File(ulg.f);
    if ((!localFile.exists()) || (!localFile.isDirectory())) {
      localFile.mkdirs();
    }
    paramString = ulg.f + bhqh.a(paramString) + "." + xrg.c(paramString);
  ...
  public static void a(BaseActivity paramBaseActivity, int paramInt)
  {
    ...
    localIntent.putExtra("url", String.format("https://ti.qq.com/music/index.html?_wv=5&_bid=2831&device_id=%s&client_ip=%s&bustype=%s", new Object[] { bdgk.a(), "", Integer.valueOf(paramInt) }));
