  ...
  implements aenz, View.OnClickListener
{
  ...
  public aenh(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, String paramString)
  {
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131494720, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramVarArgs.findViewById(2131311489));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramVarArgs.findViewById(2131302061));
    ArrayList localArrayList = new ArrayList();
    localArrayList.add((ImageView)paramVarArgs.findViewById(2131297400));
    localArrayList.add((ImageView)paramVarArgs.findViewById(2131297402));
    localArrayList.add((ImageView)paramVarArgs.findViewById(2131297404));
  ...
  public void a(aeob paramaeob)
  {
    ...
    localTroopManager.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), new aeni(this, localTroopManager, paramaeob));
  }
  
  public void a(TroopManager paramTroopManager, aeob paramaeob, TroopMemberInfo paramTroopMemberInfo)
  {
    ...
    } while ((!paramaeob.a(this, new Object[0])) || (this.jdField_a_of_type_AndroidViewView == null));
    if (this.jdField_a_of_type_TencentImOidbCmd0xb36Oidb_cmd0xb36$ToastInfo.type.has())
    {
      ...
      paramaeob = URLDrawable.URLDrawableOptions.obtain();
      paramaeob.mRequestWidth = vct.a(this.jdField_a_of_type_AndroidAppActivity, 32.0F);
      paramaeob.mRequestHeight = paramaeob.mRequestWidth;
      paramTroopManager = URLDrawable.getDrawable(paramTroopManager, paramaeob);
    ...
    {
      paramaeob = (ImageView)paramTroopManager.next();
      if (paramaeob != null)
      {
        paramaeob.setVisibility(8);
        continue;
        ImageView localImageView = (ImageView)paramTroopMemberInfo.get(i);
        localImageView.setVisibility(0);
        paramTroopManager = bacm.b();
        paramaeob = azwp.a(tfy.a(), 1, String.valueOf(localList.get(i)), 3, paramTroopManager, paramTroopManager);
        if (paramaeob == null) {}
        for (;;)
        {
    ...
    {
      paramaeob = ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).c(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      azzx.a("Grp_edu", "Grp_chain", "ChainBanner_Show", 0, 0, new String[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramTroopManager, "", String.valueOf(paramaeob.dwGroupClassExt) });
      return;
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (paramView = "1";; paramView = "2")
    {
      ...
      azzx.a("Grp_edu", "Grp_chain", "ChainBanner_Clk", 0, 0, new String[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramView, "", String.valueOf(localTroopInfo.dwGroupClassExt) });
      return;
    }
  }
}
