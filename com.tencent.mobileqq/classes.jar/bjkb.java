...
public class bjkb
{
  public static Bitmap a(String paramString1, float paramFloat1, float paramFloat2, Bitmap paramBitmap, String paramString2, String paramString3)
  {
    ...
    localObject = baxi.a(paramString1, (BitmapFactory.Options)localObject);
    if (localObject == null) {
      return localObject;
    }
    ...
    j = (int)(i * 0.19F + 0.5F);
    paramString1 = baui.a(paramString1, localResources, j, 0, false);
    ...
    paramBitmap.setColor(-10765379);
    paramString1 = ajya.a(2131702168);
    paramFloat2 = paramBitmap.measureText(paramString1);
