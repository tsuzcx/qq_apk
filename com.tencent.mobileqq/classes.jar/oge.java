  ...
  extends BusinessHandler
{
  ...
  public oge(AppInterface paramAppInterface)
  {
      ...
      for (;;)
      {
        ...
        if ((localException1 instanceof MessageForStructing))
        {
          ...
          if ((localObject instanceof StructMsgForGeneralShare))
          {
            ...
            {
              localObject = (bcgw)((StructMsgForGeneralShare)localObject).mStructMsgItemLists.get(0);
              if (localObject != null) {
                l1 = 0L;
              }
            }
        ...
        try
        {
          long l2 = Long.parseLong(((bcgw)localObject).s);
          l1 = l2;
        }
  ...
  private Set<Long> a()
  {
    ...
    {
      return localHashSet;
      str = ajvu.a(this.app.getCurrentAccountUin(), "risk_ids", "");
      if (QLog.isColorLevel()) {
        QLog.i("Ecshop_EcshopAdHandler", 2, "---getRiskAids---" + str);
      }
    } while (StringUtil.isEmpty(str));
    return (Set)new Gson().fromJson(str, new ogf(this).getType());
  }
  
  /* Error */
  public static ogh a(ogh paramogh, MessageRecord paramMessageRecord)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnonnull +5 -> 6
    ...
    //   81: putfield 226	ogh:jdField_a_of_type_Long	J
    //   84: aload_0
    //   85: aload_3
    //   86: putfield 229	ogh:k	Ljava/lang/String;
    //   89: aload_0
    //   90: aload 6
    //   92: putfield 231	ogh:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   95: aload_0
    //   96: aload 5
    //   98: putfield 234	ogh:l	Ljava/lang/String;
    //   101: aload_0
    //   102: aload_2
    //   103: putfield 236	ogh:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   106: aload_0
    //   107: iconst_0
    //   108: putfield 239	ogh:jdField_g_of_type_Int	I
    //   111: aload_0
    //   112: areturn
    //   113: astore_3
  ...
  private void a(long paramLong)
  {
    ...
    ajvu.a(this.app.getCurrentAccountUin(), "risk_ids", (String)localObject);
  }
  ...
  public static void a(AppInterface paramAppInterface, ChatMessage paramChatMessage, View paramView)
  {
    try
    {
      ...
      if (!((ofx)paramAppInterface.getManager(88)).a(paramChatMessage.senderuin)) {
        return;
      }
      paramChatMessage = ofx.a(paramChatMessage);
      if (paramChatMessage != null)
      {
        paramView.setTag(2131380829, new GdtAd(paramChatMessage));
        paramView.setTag(2131380828, new ogg(paramAppInterface));
        return;
      }
    }
  ...
  private void a(ArrayList<ogu> paramArrayList)
  {
    ...
    do
    {
      ...
      } while ((localObject == null) || (((ChatFragment)localObject).a == null) || (((ChatFragment)localObject).a.mAIORootView == null) || (((ChatFragment)localObject).a.mAIORootView.findViewById(2131364407) == null));
      localObject = (CustomTabView)((ChatFragment)localObject).a.mAIORootView.findViewById(2131364407).findViewWithTag("echopCustomTabView");
      if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    localogh.jdField_a_of_type_Int = paramInt;
    a(localogh, paramMessageRecord);
    a(localogh, null);
  }
  ...
  public void a(List<Long> paramList, List<Integer> paramList1, boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      String str2 = ajvu.a(this.app.getCurrentAccountUin(), "risk_ad_del_time", str1);
      if (QLog.isColorLevel()) {
      ...
      if (!str1.equals(str2))
      {
        ...
        ajvu.a(this.app.getCurrentAccountUin(), "risk_ids");
      }
  ...
  public void a(ogh paramogh, String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.i("Ecshop_EcshopAdHandler", 2, "do ad report info:" + paramogh.toString());
    }
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      localQQAdReport.type.set(paramogh.jdField_a_of_type_Int);
      localObject2 = localQQAdReport.view_id;
      if (paramogh.jdField_a_of_type_JavaLangString != null) {
        break label627;
      }
      localObject1 = "";
      label84:
      ...
      if (paramogh.jdField_b_of_type_JavaLangString != null) {
        break label635;
      }
      localObject1 = "";
      label107:
      ...
      if (paramogh.jdField_c_of_type_JavaLangString != null) {
        break label643;
      }
      localObject1 = "";
      label146:
      ...
      if (paramogh.jdField_d_of_type_JavaLangString != null) {
        break label651;
      }
      localObject1 = "";
      label169:
      ...
      if (paramogh.jdField_e_of_type_JavaLangString != null) {
        break label659;
      }
      localObject1 = "";
      label192:
      ...
      if (paramogh.jdField_f_of_type_JavaLangString != null) {
        break label667;
      }
      localObject1 = "";
      label215:
      ...
      if (paramogh.jdField_g_of_type_JavaLangString != null) {
        break label675;
      }
      localObject1 = "";
      label238:
      ((PBStringField)localObject2).set((String)localObject1);
      localQQAdReport.feeds_index.set(paramogh.jdField_b_of_type_Int);
      localQQAdReport.is_impression.set(paramogh.jdField_a_of_type_Boolean);
      localQQAdReport.is_installed.set(paramogh.jdField_b_of_type_Boolean);
      ...
      localQQAdReport.stay_time.set(paramogh.jdField_c_of_type_Int);
      localQQAdReport.net_type.set(HttpUtil.getNetWorkType());
      localQQAdReport.client_id.set(paramogh.jdField_d_of_type_Int);
      localQQAdReport.action_id.set(paramogh.jdField_e_of_type_Int);
      localQQAdReport.msg_floor.set(paramogh.jdField_f_of_type_Int);
      localQQAdReport.puin.set(paramogh.jdField_a_of_type_Long);
      localQQAdReport.ad_puin.set(paramogh.jdField_b_of_type_Long);
      localQQAdReport.version.set("8.4.8");
    ...
    label714:
    label722:
    for (Object localObject1 = "";; localObject1 = paramogh.l)
    {
      ((PBStringField)localObject2).set((String)localObject1);
      localQQAdReport.get_back.set(false);
      localQQAdReport.source.set(paramogh.jdField_g_of_type_Int);
      paramogh = new ToServiceMsg("mobileqq.service", this.app.getCurrentUin(), paramString);
      paramogh.putWupBuffer(localQQAdReport.toByteArray());
      super.sendPbReq(paramogh);
      return;
      ampk.a(paramString, new int[] { 139 });
      break;
      label627:
      localObject1 = paramogh.jdField_a_of_type_JavaLangString;
      break label84;
      label635:
      localObject1 = paramogh.jdField_b_of_type_JavaLangString;
      break label107;
      localObject1 = paramogh.jdField_c_of_type_JavaLangString;
      break label146;
      localObject1 = paramogh.jdField_d_of_type_JavaLangString;
      break label169;
      localObject1 = paramogh.jdField_e_of_type_JavaLangString;
      break label192;
      localObject1 = paramogh.jdField_f_of_type_JavaLangString;
      break label215;
      localObject1 = paramogh.jdField_g_of_type_JavaLangString;
      break label238;
      localObject1 = paramogh.h;
      break label297;
      localObject1 = biaq.c();
      break label329;
      localObject1 = paramogh.i;
      break label352;
      localObject1 = paramogh.j;
      break label375;
      localObject1 = paramogh.k;
      break label527;
    }
  }
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          else if ((localChatFragment != null) && (localChatFragment.a != null))
          {
            ...
            if ((localObject2 != null) && (!((List)localObject2).isEmpty()))
            {
              ...
              if (this.app != null) {
                ajvu.a(this.app.getCurrentAccountUin(), "risk_ad_del_time", aeuy.a(NetConnInfoCenter.getServerTimeMillis(), "yyyyMMdd"));
              }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (QLog.isColorLevel())
        {
          QLog.i("Ecshop_EcshopAdHandler", 2, "rsp:" + bfra.a(paramToServiceMsg));
          return;
        }
      }
