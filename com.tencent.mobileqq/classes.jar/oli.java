...
public class oli
{
  private static oli jdField_a_of_type_Oli;
  private final int jdField_a_of_type_Int = 8;
  private final long jdField_a_of_type_Long = 86400000L;
  private final String jdField_a_of_type_JavaLangString = oli.class.getSimpleName();
  private ArrayList<olm> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private HashMap<String, oll> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private ArrayList<oll> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private ArrayList<olm> a(QQAppInterface paramQQAppInterface)
  {
    paramQQAppInterface = new ArrayList();
    Iterator localIterator = this.jdField_b_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      oll localoll = (oll)localIterator.next();
      paramQQAppInterface.add(new olm(this, localoll.jdField_a_of_type_JavaLangString, localoll.jdField_b_of_type_JavaLangString, localoll.jdField_a_of_type_Boolean));
    }
  ...
  public static oli a()
  {
    if (jdField_a_of_type_Oli == null) {}
    try
    {
      jdField_a_of_type_Oli = new oli();
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_Oli.jdField_a_of_type_JavaLangString, 2, "newInstance!");
      }
      return jdField_a_of_type_Oli;
    }
    finally {}
  }
  
  private void a(QQAppInterface paramQQAppInterface, olk paramolk)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      paramolk.a(new ArrayList(), null, true);
      return;
    }
  ...
  private void b(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        try
        {
          paramQQAppInterface = uuc.a(paramQQAppInterface);
          if (paramQQAppInterface != null)
          {
            ...
            while (i < paramQQAppInterface.length())
            {
              ...
              localObject = new olm(this, ((JSONObject)localObject).optString("uin"), ((JSONObject)localObject).optString("name"), ((JSONObject)localObject).optBoolean("isPA", true));
  ...
  private void b(QQAppInterface paramQQAppInterface, olk paramolk)
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_a_of_type_JavaLangString, 2, "sendGetPublicAccountSearchRecommendRequest->begin!");
    }
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication().getApplicationContext(), oln.class);
    ...
    localGetRecommendPubAccountRequest.version.set(uuc.a());
    ...
    localNewIntent.setObserver(new olj(this, localNewIntent, paramQQAppInterface, paramolk));
      ...
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        try
        {
          ...
          if (paramQQAppInterface != null)
          {
            ...
            {
              Object localObject = (JSONObject)paramQQAppInterface.get(i);
              localObject = new oll(this, ((JSONObject)localObject).optString("uin"), ((JSONObject)localObject).optString("name"), ((JSONObject)localObject).optLong("time"), ((JSONObject)localObject).optBoolean("isPA", true));
              this.jdField_b_of_type_JavaUtilArrayList.add(localObject);
              this.jdField_a_of_type_JavaUtilHashMap.put(((oll)localObject).jdField_a_of_type_JavaLangString, localObject);
              i += 1;
            }
          }
          return;
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      paramString1 = (oll)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
    ...
    for (;;)
    {
      ...
      {
        paramString1 = (oll)paramQQAppInterface.next();
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, paramString1.toString());
      }
      break;
      paramString2 = new oll(this, paramString1, paramString2, l, paramBoolean);
      ...
      if (i > 8)
      {
        paramString1 = (oll)this.jdField_b_of_type_JavaUtilArrayList.get(i - 1);
        this.jdField_b_of_type_JavaUtilArrayList.remove(paramString1);
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, olk paramolk)
  {
    if (QLog.isColorLevel()) {
