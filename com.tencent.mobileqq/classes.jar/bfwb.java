...
public class bfwb
{
  private static volatile bfwb a;
  protected List<bbzf> a;
  protected List<bfwd> b;
  ...
  public static bfwb a()
  {
    if (jdField_a_of_type_Bfwb == null) {}
    try
    {
      if (jdField_a_of_type_Bfwb == null) {
        jdField_a_of_type_Bfwb = new bfwb();
      }
      return jdField_a_of_type_Bfwb;
    }
    finally {}
  }
  ...
  public static ArrayList<Long> a(List<? extends bbzg> paramList)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        Object localObject = (bbzg)paramList.get(i);
        if ((localObject instanceof bbxz))
        {
          localObject = (bbxz)localObject;
          try
          {
            if ((((bbxz)localObject).a() == 0) || (((bbxz)localObject).a() == 3)) {
              break label116;
            }
            localArrayList.add(Long.valueOf(Long.parseLong(((bbxz)localObject).d())));
          }
  ...
  public final bbxz a(String paramString)
  {
    ...
    while (i < j)
    {
      bbzf localbbzf = (bbzf)this.jdField_a_of_type_JavaUtilList.get(i);
      if (((localbbzf instanceof bbxz)) && (paramString.equals(localbbzf.d()))) {
        return (bbxz)localbbzf;
      }
      i += 1;
    }
    return null;
  ...
  public String a(String paramString1, String paramString2)
  {
    ...
    if (this.b == null)
    {
      ...
      localObject = (bfwd)this.b.get(j);
      if (!((bfwd)localObject).a.equals(paramString2)) {
        break label143;
      }
    }
    label143:
    label152:
    for (Object localObject = bfwd.a(paramString1, (bfwd)localObject);; localObject = null)
    {
  ...
  public List<bbzf> a(Context paramContext, QQAppInterface paramQQAppInterface, int paramInt)
  {
    long l1 = System.currentTimeMillis();
    ArrayList localArrayList1 = new ArrayList();
    ExecutorService localExecutorService = Executors.newFixedThreadPool(1);
    ArrayList localArrayList2 = new ArrayList();
    localArrayList2.add(localExecutorService.submit(new bfwc(this, paramContext, paramQQAppInterface, bbzf.E, paramInt)));
    paramInt = 0;
    try
    {
  ...
  @SuppressLint({"UseSparseArrays"})
  public List<bbzf> a(Context paramContext, QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    ...
    if (localanyw != null)
    {
      ...
      if (localObject != null)
      {
        ...
        while (localIterator1.hasNext())
        {
          ...
          localObject = localanyw.a(String.valueOf(localGroups.group_id));
          if (localObject != null)
          {
            ...
            label176:
            for (localObject = paramContext.getResources().getString(2131719084);; localObject = localGroups.group_name)
            {
              localArrayList.add(new bbxz(paramContext, paramQQAppInterface, localFriends, (String)localObject, 0L, paramLong));
              break label105;
              break;
            }
          }
    ...
    if (paramBoolean)
    {
      ...
      localArrayList.add(new bbxz(paramContext, paramQQAppInterface, (Friends)localObject, paramContext.getResources().getString(2131719084), 0L, paramLong));
    }
  ...
  public List<bfwd> a(Context paramContext, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    long l1 = System.currentTimeMillis();
    ArrayList localArrayList = new ArrayList();
    anyw localanyw = (anyw)paramQQAppInterface.getManager(51);
    if (localanyw != null)
    {
      Object localObject1 = localanyw.b();
      if (localObject1 != null)
      {
        localObject1 = ((List)localObject1).iterator();
        while (((Iterator)localObject1).hasNext())
        {
          Object localObject2 = localanyw.a(String.valueOf(((Groups)((Iterator)localObject1).next()).group_id));
          if (localObject2 != null)
          {
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              localArrayList.add(new bfwd(paramContext, localFriends.uin, localFriends.name, localFriends.remark));
            }
          }
        }
      }
    ...
    if (paramBoolean) {
      localArrayList.add(new bfwd(paramContext, paramQQAppInterface.getCurrentAccountUin(), paramQQAppInterface.getCurrentNickname(), null));
    }
    long l2 = System.currentTimeMillis();
    if (QLog.isColorLevel()) {
