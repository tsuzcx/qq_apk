...
public class uls
{
  ...
  public static void a()
  {
    ...
    ukq.a("VideoAdStrategy", "setAdStrategyFromAladin: strategy = " + jdField_a_of_type_Int + " adFirstTime = " + jdField_b_of_type_Int + " adIntervalTime = " + c + " adPreReq = " + d + " adProtectGap = " + e + " adFirstPos = " + f + " adIntervalPos = " + g + " adProtectInterval = " + h);
  }
  
  public static boolean a()
  {
    if (QLog.isColorLevel()) {
      ukq.a("VideoAdStrategyManager", "judge isNotVVStrategy : adStrategy = " + jdField_a_of_type_Int);
    }
  ...
  {
    if (QLog.isColorLevel()) {
      ukq.a("VideoAdStrategyManager", "judge isNotMixStrategy : adStrategy = " + jdField_a_of_type_Int);
    }
  ...
  {
    if (QLog.isColorLevel()) {
      ukq.a("VideoAdStrategyManager", "judge isNotTimeStrategy : adStrategy = " + jdField_a_of_type_Int);
    }
