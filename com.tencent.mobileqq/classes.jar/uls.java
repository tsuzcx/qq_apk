...
public class uls
  implements View.OnClickListener, bfos, bftp, umt
{
  ...
  public uls(QQStoryShareGroupProfileActivity paramQQStoryShareGroupProfileActivity)
  {
  ...
  private void a(View paramView, String paramString)
  {
    ...
    if ((localArrayList1.size() > 0) && (localArrayList2.size() > 0))
    {
      ...
      tvc.a(this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardQQStoryShareGroupProfileActivity, ((OpenPlayerBuilder)localObject).a(), paramView);
    }
    vei.a("share_story", "clk_video_card", 0, 0, new String[] { this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardQQStoryShareGroupProfileActivity.b, paramString });
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardQQStoryShareGroupProfileActivity.jdField_a_of_type_Ulx != null) {
      this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardQQStoryShareGroupProfileActivity.jdField_a_of_type_Ulx.a(paramString);
    }
  }
  ...
  public void a(String paramString1, int paramInt, View paramView, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      ArrayList localArrayList1 = new ArrayList();
      ArrayList localArrayList2 = localtcm.a(str, localArrayList1);
      if ((localArrayList2 != null) && (localArrayList2.size() != 0))
      {
        paramInt = localArrayList2.indexOf(paramString1);
        paramString1 = localtcm.a(str);
  ...
  public void a(String paramString1, long paramLong, StoryVideoItem paramStoryVideoItem, int paramInt, String paramString2, List<String> paramList)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardQQStoryShareGroupProfileActivity.jdField_a_of_type_Tpb == null) {
      this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardQQStoryShareGroupProfileActivity.jdField_a_of_type_Tpb = tpb.a(this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardQQStoryShareGroupProfileActivity);
    }
    this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardQQStoryShareGroupProfileActivity.jdField_a_of_type_Tpb.a(ajya.a(2131711049) + ssf.a + ajya.a(2131711021)).a(tqe.a(this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardQQStoryShareGroupProfileActivity.jdField_a_of_type_ComTencentBizQqstoryShareGroupModelShareGroupItem, paramStoryVideoItem, paramString1, paramLong, paramInt)).a(new ult(this)).b();
    vei.a("share_story", "share_day", 0, 0, new String[] { this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardQQStoryShareGroupProfileActivity.jdField_a_of_type_ComTencentBizQqstoryShareGroupModelShareGroupItem.getReportUserType() });
  }
  ...
  public void c()
  {
    ...
    while (this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardQQStoryShareGroupProfileActivity.jdField_a_of_type_Ulx == null) {
      return;
    }
    this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardQQStoryShareGroupProfileActivity.jdField_a_of_type_Ulx.a(this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardQQStoryShareGroupProfileActivity.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardViewShareGroupsListView.a.a());
  }
  ...
  {
    this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardQQStoryShareGroupProfileActivity.jdField_a_of_type_Vzj.a(paramAbsListView, paramInt1, paramInt2, paramInt3);
  }
