...
public class auos
  extends QIPCModule
{
  private static volatile auos a;
  public static volatile boolean a;
  
  private auos(String paramString)
  {
    super(paramString);
  }
  ...
  {
    if (jdField_a_of_type_Auos == null) {}
    try
    {
      if (jdField_a_of_type_Auos == null) {
        jdField_a_of_type_Auos = new auos("FlutterSubQIPCModule");
      }
      return jdField_a_of_type_Auos;
    }
    finally {}
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("ACTION_INSTALL_RESULT".equals(paramString))
    {
      ...
      auoy.a().a(bool1, paramString, bool2, bool3);
    }
    for (;;)
    {
      return null;
