...
public class bgcg
{
  ...
  private void a(oidb_0xea3.RspBody paramRspBody)
  {
    ...
    bgbe localbgbe = (bgbe)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_SHORTCUTBAR_HANDLE);
    if (localbgbe == null) {
      return;
    }
    ...
    localbgbe.notifyUI(4, true, new Object[] { Long.valueOf(this.jdField_a_of_type_Long), this.jdField_a_of_type_JavaUtilList, this.jdField_b_of_type_JavaUtilList });
    b();
  }
  ...
  public void a()
  {
    ...
    localObject = localbgbe.makeOIDBPkg("OidbSvcTcp.0xea3", 3747, 1, ((oidb_0xea3.ReqBody)localObject).toByteArray(), 30000L);
    ((ToServiceMsg)localObject).extraData.putLong("sendSeq", this.jdField_b_of_type_Long);
    localbgbe.sendPbReq((ToServiceMsg)localObject);
  }
  
  public boolean a(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if ((bgbe)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_SHORTCUTBAR_HANDLE) == null) {
      return true;
    }
    oidb_0xea3.RspBody localRspBody = new oidb_0xea3.RspBody();
    int i = bgbe.parseOIDBPkg(paramFromServiceMsg, paramObject, localRspBody);
    boolean bool;
    if (i == 0)
    {
