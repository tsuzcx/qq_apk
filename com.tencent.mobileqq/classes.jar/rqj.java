...
public class rqj
{
  private static QQHashMap<String, rpr> jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap = new QQHashMap(2019, 10, 10000);
  public static String a;
  private static Map<String, rqk> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public static rpr a(String paramString)
  {
    try
    {
      paramString = (rpr)jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.get(paramString);
      return paramString;
    }
    finally
    {
  ...
  public static rqk a(String paramString)
  {
    rqk localrqk = (rqk)jdField_a_of_type_JavaUtilMap.get(paramString);
    if (localrqk != null) {
      return localrqk;
    }
    localrqk = new rqk();
    ...
    if (str == null)
    {
      ...
      localrqk.a = false;
      jdField_a_of_type_JavaUtilMap.put(paramString, localrqk);
      return localrqk;
    }
    str = str + paramString;
  ...
  public static void a(String paramString, rpr paramrpr)
  {
    try
    {
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(paramString, paramrpr);
      return;
    }
    finally
    {
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    {
      return false;
      paramString3 = a("8.3.0");
      paramString3.add(Integer.valueOf(Integer.parseInt("4480")));
  ...
  {
    String str = bhvy.a("default_feeds_proteus_offline_bid");
    bbdx.a(mzh.a(str) + str);
  }
}
