...
{
  public rqj(Context paramContext, List<? extends Map<String, ?>> paramList, int paramInt, String[] paramArrayOfString, int[] paramArrayOfInt)
  {
  ...
  public void setViewImage(ImageView paramImageView, String paramString)
  {
    ...
    if (paramImageView.getId() == 2131368138) {}
    try
    {
      Object localObject = this.a.getResources().getDrawable(2130840264);
      URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
      localURLDrawableOptions.mLoadingDrawable = ((Drawable)localObject);
      localURLDrawableOptions.mFailedDrawable = ((Drawable)localObject);
      localObject = URLDrawable.getDrawable(paramString, localURLDrawableOptions);
      ((URLDrawable)localObject).setTag(bgey.a(140, 140));
