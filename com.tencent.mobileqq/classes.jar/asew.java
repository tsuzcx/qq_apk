  ...
  implements Handler.Callback, Manager
{
  ...
  public asew(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (int i = 1;; i = 0)
        {
          ...
          localObject = bdiw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp());
          if (localObject != null)
          {
  ...
  private void b()
  {
    ...
    localObject2 = ajyc.a(2131714982);
    str4 = "登录TIM";
    str2 = ajyc.a(2131714981);
    ...
    bbcv.a(BaseActivity.sTopActivity, 230, str5, str6, (String)localObject3, (String)localObject1, new asex(this), new asey(this)).show();
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80085D9", "0X80085D9", 0, 0, "", "", "", "");
  }
  ...
  {
    if (!bbfd.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim", "775E696D09856872FDD8AB4F3F06B1E0"))
    {
      bcpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131720243, 0).a();
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "jumpTimLogin tim not install ");
      }
      return;
    }
    String str = bbfd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim");
    int i = anbl.a().b();
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        localbcpq = new bcpq(BaseActivity.sTopActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getDimensionPixelOffset(2131298865));
        localbcpq.a(ajyc.a(2131714980));
        localbcpq.show();
        ...
        localWtloginHelper.SetListener(new asez(this, localbcpq, localWtloginHelper, paramBundle));
        paramBundle = util.getPkgSigFromApkName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim");
        i = localWtloginHelper.GetA1WithA1(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), 16L, 16L, "com.tencent.tim".getBytes(), 1L, 16L, 16L, "8.2.8".getBytes(), paramBundle, new WUserSigInfo(), new WFastLoginInfo());
      }
      if (i == -1001) {
        break;
      }
      ...
      if ((localbcpq != null) && (localbcpq.isShowing())) {
        localbcpq.dismiss();
      }
      bcpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131720242, 0).a();
      return;
    } while (j >= i);
    bcpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131720244, 0).a();
  }
