  ...
  extends bdom
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    {
      if (!((bdol)((Iterator)localObject1).next() instanceof bdqi)) {
        break label944;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      if ((paramView != null) && ((paramView instanceof LinearLayout)))
      {
        ...
        paramView = (bdol)this.jdField_a_of_type_JavaUtilArrayList.get(j);
      ...
      for (;;)
      {
        ...
        if ("button".equals(localObject2))
        {
          ...
          if (i == 0)
          {
            ...
            if (m < n)
            {
              localObject2 = (bdol)this.jdField_a_of_type_JavaUtilArrayList.get(m);
              ((bdol)localObject2).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
              str = ((bdol)localObject2).jdField_a_of_type_JavaLangString;
            ...
            ((bdol)localObject2).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
            localObject2 = ((bdol)localObject2).a(paramContext, null, paramBundle);
            j = 0;
            if (m == 0)
            {
              j = 2131378076;
            ...
            for (;;)
            {
              ...
              if ("button".equals(str))
              {
                ...
                for (;;)
                {
                  ...
                  return paramView;
                  j = agej.a(5.0F, localResources);
                  break;
                  label888:
                  k = agej.a(5.0F, localResources);
                  m = i;
                  n = j;
                  j = k;
                  k = n;
