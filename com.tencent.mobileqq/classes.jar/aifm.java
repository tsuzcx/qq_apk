  ...
  implements bfrd
{
  ...
  public aifm(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, View.OnClickListener paramOnClickListener)
  {
    super(paramContext, paramQQAppInterface, paramExpandableListView);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new aifn(this);
    this.jdField_c_of_type_AndroidViewView$OnClickListener = new aifo(this);
  ...
  private void a(ailx paramailx, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return;
      str = ajyc.a(2131715287);
      i = this.jdField_b_of_type_JavaUtilList.size();
      break;
      str = ajyc.a(2131715291);
      i = this.jdField_c_of_type_JavaUtilList.size();
      break;
      str = ajyc.a(2131715288);
      i = this.d.size();
      break;
      str = ajyc.a(2131715289);
      i = this.e.size();
      break;
      str = ajyc.a(2131715290);
      i = this.f.size();
      break;
      str = ajyc.a(2131715292);
      i = this.g.size();
      break;
      label356:
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = (aifp)paramView.getTag();
      paramViewGroup = paramView;
      paramView = (View)localObject;
      localaigc = a(paramInt1, paramInt2);
      if ((localaigc == null) || (localaigc.jdField_a_of_type_Aukm == null)) {
        break label573;
      }
      if (!(localaigc.jdField_a_of_type_Aukm instanceof TroopInfo)) {
        break label363;
      }
      localTroopInfo = (TroopInfo)localaigc.jdField_a_of_type_Aukm;
      ...
      paramView.jdField_a_of_type_Int = localaigc.jdField_a_of_type_Int;
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        for (;;)
        {
          ...
          paramViewGroup = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562415, this.jdField_a_of_type_ComTencentWidgetExpandableListView, false);
          paramView = new aifp(this);
          ...
          paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131377853));
          paramView.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131362792));
        ...
        if ((localaigc.jdField_a_of_type_Aukm instanceof DiscussionInfo))
        {
          localObject = (DiscussionInfo)localaigc.jdField_a_of_type_Aukm;
          paramView.jdField_a_of_type_JavaLangString = ((DiscussionInfo)localObject).uin;
          paramView.jdField_c_of_type_Int = 101;
          paramView.jdField_a_of_type_AndroidWidgetTextView.setText(bbcl.a(this.jdField_a_of_type_AndroidContentContext, (DiscussionInfo)localObject));
          if (!((DiscussionInfo)localObject).hasRenamed())
          {
            paramView.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
            paramView.jdField_b_of_type_AndroidWidgetTextView.setText(String.format("(%d)", new Object[] { Integer.valueOf(this.jdField_a_of_type_Ajvk.a(((DiscussionInfo)localObject).uin)) }));
          }
          paramViewGroup.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
          a(paramView, null);
      ...
      QLog.d("TroopDiscussionMemSelectAdapter", 2, "getChildView data:" + localaigc.jdField_a_of_type_Aukm + " groupPosition:" + paramInt1 + " childPosition:" + paramInt2);
      return paramViewGroup;
    }
    label573:
