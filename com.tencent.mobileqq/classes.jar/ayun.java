...
public class ayun
{
  public static void a(Context paramContext, String paramString, List<Object> paramList)
  {
    ...
    bhmi.a(paramString + "v5.8.nbr", new Object[] { paramList });
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (a(paramQQAppInterface))
    {
      ...
      if (i <= Math.abs(l3 - l1) / 1000L)
      {
        ...
        localObject = paramQQAppInterface.b(antf.H, 1001).iterator();
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong)
  {
    ...
    MessageForNearbyRecommenderTips localMessageForNearbyRecommenderTips = (MessageForNearbyRecommenderTips)bcry.a(-4011);
    long l = bcrg.a();
    localMessageForNearbyRecommenderTips.init(paramQQAppInterface.getCurrentAccountUin(), antf.as, antf.as, "", l, -4011, 1001, l);
    localMessageForNearbyRecommenderTips.isread = true;
    adak.a(localMessageForNearbyRecommenderTips, false);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyRecommenderUtils", 2, "-----addGrayTipsMessage  frienduin:" + paramString1 + " istroop：" + paramInt + " msg:" + bhjx.a(paramString3));
    }
    long l = bcrg.a();
    MessageForGrayTips localMessageForGrayTips = (MessageForGrayTips)bcry.a(-5007);
    ...
    if ((!paramBoolean1) || (!aoci.a(paramQQAppInterface, localMessageForGrayTips, false))) {
  ...
  {
    paramQQAppInterface = paramQQAppInterface.a().b(antf.H, 1001);
