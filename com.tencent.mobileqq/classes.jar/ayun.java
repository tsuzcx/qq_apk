...
public class ayun
  extends aypg
{
  akat jdField_a_of_type_Akat = new ayup(this);
  ...
  public ayun(ayoz paramayoz, aywc paramaywc)
  {
  ...
  private void g()
  {
    try
    {
      if (SessionInfo.getInstance(this.jdField_a_of_type_Aywc.b).getHttpconn_sig_session() != null)
      {
        int i = SessionInfo.getInstance(this.jdField_a_of_type_Aywc.b).getHttpconn_sig_session().length;
        this.jdField_d_of_type_ArrayOfByte = new byte[i];
        System.arraycopy(SessionInfo.getInstance(this.jdField_a_of_type_Aywc.b).getHttpconn_sig_session(), 0, this.jdField_d_of_type_ArrayOfByte, 0, i);
      }
      if (this.jdField_d_of_type_ArrayOfByte == null) {
        HwServlet.getConfig(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_Aywc.b);
      }
      return;
    }
    finally {}
  ...
  private void h()
  {
    ...
    MessageForScribble localMessageForScribble = (MessageForScribble)this.jdField_a_of_type_Aywc.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
    if (localMessageForScribble != null)
    {
      ...
      this.c.a();
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(localMessageForScribble, this.jdField_a_of_type_Akat);
  ...
  {
    if (paramLong1 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 1, this.jdField_a_of_type_Ayqo.b, this.jdField_a_of_type_Aywc.jdField_a_of_type_Int, paramLong1);
    }
    if (paramLong2 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 1, this.jdField_a_of_type_Ayqo.b, this.jdField_a_of_type_Aywc.jdField_a_of_type_Int, paramLong2);
    }
    if (paramLong3 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 0, this.jdField_a_of_type_Ayqo.b, this.jdField_a_of_type_Aywc.jdField_a_of_type_Int, paramLong3);
    }
    if (paramLong4 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 0, this.jdField_a_of_type_Ayqo.b, this.jdField_a_of_type_Aywc.jdField_a_of_type_Int, paramLong4);
    }
  }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      axrn.a(BaseApplication.getContext()).a(null, "scribble_upload", true, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    for (;;)
    {
      l();
      ...
      break;
      label156:
      str = bbmx.a(this.jdField_d_of_type_ArrayOfByte);
      break label105;
      label168:
      ...
      axrn.a(BaseApplication.getContext()).a(null, "scribble_upload", false, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
  ...
  public void aP_()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("ScribblePicUploadProcessor", 2, "<BDH_LOG> Transaction submit RetCode:" + i + " T_ID:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.getTransationId() + " UniSeq:" + this.jdField_a_of_type_Aywc.jdField_a_of_type_Long + " MD51:" + (String)localObject + " MD52:" + str + " uuid:" + this.jdField_l_of_type_JavaLangString + " Path:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.filePath + " Cmd:" + this.jdField_a_of_type_Ayqo.jdField_c_of_type_Int);
    }
    if (i != 0)
    {
  ...
  void d()
  {
    super.d();
    d(1005);
    Object localObject = (MessageForScribble)this.jdField_a_of_type_Aywc.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
    if (localObject != null) {
    ...
    if (this.jdField_a_of_type_Aywc.jdField_a_of_type_Auoq != null)
    {
      ...
      ((auor)localObject).jdField_a_of_type_Int = -1;
      ((auor)localObject).b = this.jdField_j_of_type_Int;
      ((auor)localObject).jdField_a_of_type_JavaLangString = this.jdField_j_of_type_JavaLangString;
  ...
  void e()
  {
    ...
    {
      localObject = new auor();
      ((auor)localObject).jdField_a_of_type_Int = 0;
      this.jdField_a_of_type_Aywc.jdField_a_of_type_Auoq.b((auor)localObject);
    }
  }
