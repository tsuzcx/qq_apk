...
public class uxv
{
  ...
  static ArrayList<uyf> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  static boolean jdField_a_of_type_Boolean;
  private static int b;
  private Activity jdField_a_of_type_AndroidAppActivity;
  protected bljm a;
  
  public uxv(Activity paramActivity, ArrayList<uyf> paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    this.jdField_a_of_type_Bljm = new uxw(this);
  ...
  static int a()
  {
    ...
    int j = (jdField_a_of_type_Int - agej.a(110.0F, jdField_a_of_type_AndroidContentContext.getResources())) / 3;
    if (i % 2 == 0) {
      return i / 2 * j;
    }
    return (i + 1) / 2 * j;
  ...
  private ArrayList<uyf> a(ArrayList<uyf> paramArrayList)
  {
  ...
  private void a(RelativeLayout paramRelativeLayout)
  {
    ...
    int i = agej.a(2.0F, jdField_a_of_type_AndroidContentContext.getResources());
    int j = (b - i) / 2;
    paramRelativeLayout = (GridView)paramRelativeLayout.findViewById(2131376333);
    ...
    paramRelativeLayout.setOnItemClickListener(this.jdField_a_of_type_Bljm);
    if (Build.VERSION.SDK_INT >= 9) {
      paramRelativeLayout.setOverScrollMode(2);
    }
    paramRelativeLayout.setAdapter(new uxx(this));
  }
  ...
  public View a(Activity paramActivity, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView != null) && ((paramView instanceof RelativeLayout)))
    {
      ...
      if ((localObject != null) && ((localObject instanceof uxz)))
      {
    ...
    paramActivity = (RelativeLayout)LayoutInflater.from(paramActivity).inflate(2131559596, paramViewGroup, false);
    paramView = paramActivity.getLayoutParams();
    paramView.height = jdField_a_of_type_Int;
    paramActivity.setLayoutParams(paramView);
    paramView = new uxz();
    paramView.jdField_a_of_type_ComTencentWidgetGridView = ((GridView)paramActivity.findViewById(2131376333));
    paramView.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAlphaMaskView = ((VideoFeedsAlphaMaskView)paramActivity.findViewById(2131370645));
    paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramActivity.findViewById(2131376319));
    ...
    if ((jdField_a_of_type_JavaUtilArrayList == null) && (jdField_a_of_type_Boolean))
    {
      ...
      int i = agej.a(66.0F, jdField_a_of_type_AndroidContentContext.getResources());
