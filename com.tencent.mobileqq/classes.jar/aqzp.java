  ...
  implements aqzv
{
  ...
  aqzt jdField_a_of_type_Aqzt = null;
  String jdField_a_of_type_JavaLangString;
  String b;
  final String c = "DiscFileUploader<FileAssistant>";
  
  /* Error */
  public long a(baqw parambaqw, aqzs paramaqzs)
  {
    // Byte code:
    //   0: new 30	java/io/ByteArrayInputStream
    //   3: dup
    //   4: aload_1
    //   5: getfield 35	baqw:a	[B
    ...
    //   39: aload_2
    //   40: ldc2_w 54
    //   43: putfield 59	aqzs:jdField_a_of_type_Long	J
    //   46: aload_2
    //   47: ldc 61
    //   49: putfield 62	aqzs:c	Ljava/lang/String;
    //   52: aload_0
    //   53: aload_2
    //   54: invokevirtual 65	aqzp:a	(Laqzs;)V
    //   57: aload_1
    ...
    //   109: lstore 4
    //   111: aload_2
    //   112: getfield 78	aqzs:h	J
    //   115: lconst_0
    //   116: lcmp
    //   117: ifne +9 -> 126
    //   120: aload_2
    //   121: lload 4
    //   123: putfield 78	aqzs:h	J
    //   126: aload_2
    //   127: lload 4
    //   129: aload_2
    //   130: getfield 78	aqzs:h	J
    //   133: lsub
    //   134: putfield 81	aqzs:i	J
    //   137: aload_1
    ...
    //   154: aload_2
    //   155: lconst_0
    //   156: putfield 59	aqzs:jdField_a_of_type_Long	J
    //   159: aload_2
    //   160: aload_2
    //   161: getfield 84	aqzs:e	J
    //   164: lconst_1
    //   165: ladd
    //   166: putfield 87	aqzs:f	J
    //   169: aload_0
    //   170: aload_2
    //   171: invokevirtual 89	aqzp:b	(Laqzs;)V
    //   174: aload_1
    ...
    //   188: aload_2
    //   189: ldc2_w 54
    //   192: putfield 59	aqzs:jdField_a_of_type_Long	J
    //   195: aload_2
    //   196: ldc 91
    //   198: putfield 62	aqzs:c	Ljava/lang/String;
    //   201: aload_0
    //   202: aload_2
    //   203: invokevirtual 65	aqzp:a	(Laqzs;)V
    //   206: aload_1
    ...
    //   0	265	0	this	aqzp
    //   0	265	1	parambaqw	baqw
    //   0	265	2	paramaqzs	aqzs
    //   82	70	3	i	int
    //   99	48	4	l	long
  ...
  {
    this.jdField_a_of_type_Aqzt.a(paramLong1, paramLong2);
  }
  
  public void a(aqzs paramaqzs)
  {
    QLog.i("DiscFileUploader<FileAssistant>", 1, "=_= ^! [Upload Step] Send Error!:" + paramaqzs.c);
    paramaqzs.c();
    this.jdField_a_of_type_Aqzt.a(null, 0);
  }
  
  public void a(String paramString1, String paramString2, long paramLong, aqzt paramaqzt)
  {
  ...
  public void a(boolean paramBoolean, aqzs paramaqzs) {}
  
  public byte[] a(byte[] paramArrayOfByte, long paramLong, aqzs paramaqzs)
  {
    if ((this.jdField_a_of_type_JavaLangString == null) || (this.b == null) || (this.jdField_a_of_type_JavaLangString.length() == 0) || (this.b.length() == 0))
    {
      ...
      paramaqzs.jdField_a_of_type_Long = 9005L;
      a(paramaqzs);
      return null;
    }
    ...
    catch (IOException paramArrayOfByte)
    {
      ...
      paramaqzs.jdField_a_of_type_Long = 9003L;
      paramaqzs.c = arni.a();
      a(paramaqzs);
      try
      {
