...
public class alcy
{
  ...
  alcy(QQAppInterface paramQQAppInterface)
  {
  ...
  public static String a()
  {
    ...
    Iterator localIterator = ((ambf)localObject1).a.iterator();
    while (localIterator.hasNext())
    {
      Object localObject2 = (ambp)localIterator.next();
      if (localObject2 != null)
      {
        ambo localambo = ((ambp)localObject2).jdField_a_of_type_Ambo;
        if (localambo != null)
        {
          localObject2 = ((ambp)localObject2).jdField_a_of_type_Ambr;
          if ((localObject2 != null) && (a(localambo)))
          {
            localObject2 = b((ambr)localObject2);
            if (localObject2 != null)
            {
              ArkAppCenter.c("ArkApp.Dict.Update", String.format("getEffectDictIdentifier, use condition dict, dict-id=%s, condition=%s", new Object[] { localObject2, localambo.toString() }));
              return localObject2;
            }
          }
        }
    ...
    localObject1 = b((ambr)localObject1);
  ...
  {
    return alcv.a(paramString) + "/WordData";
  }
  ...
  private static Map<String, aldi> a(ambr paramambr)
  {
    if (paramambr == null) {
      return new HashMap();
    }
    Object localObject = paramambr.jdField_b_of_type_JavaUtilArrayList;
    if (localObject == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "getDictInfoFromConfig, 'word_dict_list' field not found");
      return new HashMap();
    }
    paramambr = new HashMap();
    localObject = ((ArrayList)localObject).iterator();
    while (((Iterator)localObject).hasNext())
    {
      aldi localaldi = (aldi)((Iterator)localObject).next();
      if (localaldi != null) {
        paramambr.put(localaldi.a, localaldi);
      }
    }
    return paramambr;
  }
  
  private void a(ambr paramambr1, ambr paramambr2, aldk paramaldk)
  {
    if (paramambr2 == null)
    {
    ...
    for (;;)
    {
      ...
      Object localObject = a(paramambr2);
      ...
      paramambr2 = b(paramambr1);
      paramambr1 = a(paramambr1);
      aldm localaldm = new aldm(null);
      localaldm.jdField_a_of_type_Int = ((Map)localObject).size();
      localaldm.jdField_a_of_type_Boolean = true;
      localObject = ((Map)localObject).values().iterator();
      while (((Iterator)localObject).hasNext())
      {
        aldi localaldi = (aldi)((Iterator)localObject).next();
        a(str2, paramambr2, (aldi)paramambr1.get(localaldi.a), localaldi, new alda(this, localaldm, localaldi, str2, paramaldk, str1));
      }
    }
  }
  
  private void a(String paramString, aldi paramaldi, aldk paramaldk)
  {
    a(paramaldi.a, paramaldi.jdField_b_of_type_JavaLangString, new aldf(this, paramaldi, paramString, paramaldk));
  }
  
  private void a(String paramString1, String paramString2, aldi paramaldi1, aldi paramaldi2, aldk paramaldk)
  {
    boolean bool = false;
    if (!a(paramString2, paramaldi1)) {
      paramaldi1 = null;
    }
    for (;;)
    {
      if (paramaldi1 == null)
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, local not exists, full update, name=%s", new Object[] { paramaldi2.a }));
        a(paramString1, paramaldi2, new aldb(this, paramaldi2, paramaldk));
        return;
      }
      if (paramaldi1.d.equals(paramaldi2.d))
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, file not change, copy from origin, name=%s", new Object[] { paramaldi2.a }));
        paramString2 = b(paramString2, paramaldi1.a);
        paramString1 = String.format("%s/%s", new Object[] { paramString1, paramaldi2.a });
        if (bace.d(paramString2, paramString1)) {
          break label281;
        }
      ...
      for (;;)
      {
        paramaldk.a(bool);
        return;
        if ((paramaldi2.b()) && (paramaldi1.d.equals(paramaldi2.g)))
        {
          ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, incremental update, name=%s", new Object[] { paramaldi2.a }));
          b(paramString1, paramString2, paramaldi1, paramaldi2, new aldc(this, paramaldi2, paramaldk, paramString1));
          return;
        }
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, full update, name=%s", new Object[] { paramaldi2.a }));
        a(paramString1, paramaldi2, new alde(this, paramaldk));
        return;
        label281:
        bool = true;
      }
  ...
  private void a(String paramString1, String paramString2, aldj paramaldj)
  {
    aldl localaldl = new aldl(null);
    ...
    axxj localaxxj = (axxj)localQQAppInterface.getManager(193);
    localaldl.jdField_a_of_type_JavaLangRefWeakReference = new java.lang.ref.WeakReference(localaxxj);
    paramaldj = new ArkAiDictUpdateMgr.8(this, paramString2, localaldl, paramaldj);
    if (localQQAppInterface == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "downloadDictFile, qq app interface is null, return");
      return;
    }
    localaldl.jdField_a_of_type_Boolean = localaxxj.a();
    if (localaldl.jdField_a_of_type_Boolean)
    {
      localaxxj.a(10022, "prd", paramString1, 0, paramString2, "", 1, 0, false, new axxk(localQQAppInterface, paramString1, paramaldj, 10000L));
      return;
    }
    paramaldj.run();
  ...
  private static boolean a(ambo paramambo)
  {
    if (paramambo == null) {}
    for (;;)
    {
      return false;
      paramambo = paramambo.a;
      String[] arrayOfString = paramambo.split("-");
      if (arrayOfString.length == 2) {
        ...
        {
          ArkAppCenter.c("ArkApp.Dict.Update", String.format(Locale.CHINA, "isDictConditionEffect, invalid date, date=%s", new Object[] { paramambo }));
        }
      }
    }
    return false;
  ...
  private boolean a(ambr paramambr)
  {
    if (paramambr == null)
    {
    ...
    String str = b(paramambr);
    paramambr = a(paramambr);
    if (paramambr == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "checkLocalDictIntegrity, local dict list is empty");
      return true;
    }
    Iterator localIterator = paramambr.values().iterator();
    do
    {
      if (!localIterator.hasNext()) {
        break;
      }
    } while (a(str, (aldi)localIterator.next()));
    for (int i = 1;; i = 0)
    {
      if (i == 0)
      {
      ...
      ArkAppCenter.c("ArkApp.Dict.Update", String.format(Locale.CHINA, "checkLocalDictIntegrity, %d of %d files need update", new Object[] { Integer.valueOf(i), Integer.valueOf(paramambr.size()) }));
      return false;
    }
  }
  
  private static boolean a(String paramString, aldi paramaldi)
  {
    if (paramaldi == null) {}
    while (!b(b(paramString, paramaldi.a), paramaldi.d)) {
      return false;
    }
    return true;
  }
  ...
  private static String b(ambr paramambr)
  {
    if (paramambr == null) {}
    String str;
    do
    {
      return null;
      str = paramambr.c;
      paramambr = paramambr.jdField_b_of_type_JavaLangString;
    } while ((TextUtils.isEmpty(str)) || (TextUtils.isEmpty(paramambr)));
    return String.format("%s-%s", new Object[] { str, paramambr });
  }
  ...
  private static Map<String, ambr> b(ambf paramambf)
  {
    ...
    Object localObject1 = b(paramambf);
    if (localObject1 != null) {
      localHashMap.put(localObject1, paramambf);
    }
    paramambf = paramambf.a.iterator();
    while (paramambf.hasNext())
    {
      Object localObject2 = (ambp)paramambf.next();
      if (localObject2 != null)
      {
        localObject1 = ((ambp)localObject2).jdField_a_of_type_Ambo;
        localObject2 = ((ambp)localObject2).jdField_a_of_type_Ambr;
        if ((localObject1 != null) && (localObject2 != null))
        {
          localObject1 = b((ambr)localObject2);
          if (localObject1 != null) {
  ...
  private void b(String paramString1, String paramString2, aldi paramaldi1, aldi paramaldi2, aldk paramaldk)
  {
    a(paramaldi2.a, paramaldi2.e, new aldg(this, paramaldi2, paramString2, paramaldi1, paramString1, paramaldk));
  }
  
  private static boolean b(ambr paramambr)
  {
    if (paramambr == null) {
      return false;
    }
    paramambr = paramambr.e;
    if ((TextUtils.isEmpty(paramambr)) || (paramambr.equalsIgnoreCase("wifi")))
    {
      if ((AppNetConnInfo.isNetSupport()) && (AppNetConnInfo.isWifiConn()))
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("getNetType, invalid dict info, netType=%s", new Object[] { paramambr }));
        return true;
      }
  ...
  private static boolean b(String paramString1, String paramString2)
  {
    ...
    //   80: invokestatic 521	alcy:a	([B)Ljava/lang/String;
    //   83: aload_1
  ...
  private static ambf c()
  {
    ...
    try
    {
      localObject = (ambf)amaf.a(localObject, ambf.class);
      return localObject;
    }
  ...
  private static void c(ambf paramambf)
  {
    if (paramambf == null)
    {
  ...
  private static ambf d()
  {
    amat localamat = amay.b(170).a();
    if (localamat == null)
    {
  ...
  private static void d(ambf paramambf)
  {
    if (paramambf == null) {
