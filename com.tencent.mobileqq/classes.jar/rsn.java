...
public class rsn
{
  ...
  public rsn(BaseApplicationImpl paramBaseApplicationImpl, int paramInt)
  {
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl = paramBaseApplicationImpl;
    this.jdField_a_of_type_Int = obz.c();
  ...
  {
    return new rso(paramURLDrawableHandler, this);
  }
  ...
  public void a(int paramInt, DownloadParams paramDownloadParams)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        switch (rtr.a((QQAppInterface)localObject2, (String)localObject1))
        {
        }
      ...
      paramDownloadParams = axwx.a().a(this.jdField_c_of_type_JavaLangString, 1009);
      if (paramDownloadParams != null)
      {
      ...
      for (;;)
      {
        ...
        awrn.a(BaseApplication.getContext()).a(null, paramDownloadParams, this.jdField_a_of_type_Boolean, this.jdField_b_of_type_Long, this.jdField_c_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "", true);
        return;
        j = 1;
        break;
        j = 2;
