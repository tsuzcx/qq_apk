...
{
  private static final String jdField_a_of_type_JavaLangString = bprg.class.getSimpleName();
  ...
  private bpri jdField_a_of_type_Bpri;
  ...
  public bprg(int paramInt1, int paramInt2)
  {
  ...
  private void d()
  {
    this.jdField_a_of_type_Bpri = new bpri();
    this.jdField_a_of_type_Bpri.a();
    if (this.jdField_b_of_type_Boolean) {
      Log.d(jdField_a_of_type_JavaLangString, "textureID=" + this.jdField_a_of_type_Bpri.a());
    }
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Bpri.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bpri = null;
  ...
  {
    this.jdField_a_of_type_Bpri.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Bpri.a("before updateTexImage");
