...
public class aini
{
  ...
  public static int a(MessageRecord paramMessageRecord)
  {
    ...
    if (((paramMessageRecord instanceof MessageForText)) || ((paramMessageRecord instanceof MessageForLongMsg))) {
      if (bdol.c(paramMessageRecord.msg)) {
        i = 12;
      }
    }
    do
    {
      ...
      return 11;
    } while (aoho.a(paramMessageRecord));
    return 7;
  }
      ...
      do
      {
        do
        {
          ...
          if (paramMessageRecord.msgtype == -2005) {
            return atvo.a(paramQQAppInterface, paramMessageRecord);
          }
          if (!bgjz.a(paramMessageRecord.msgtype)) {
            break;
          }
  ...
  private static int b(MessageRecord paramMessageRecord)
  {
    ...
    {
      if (atvo.a(((MessageForFile)paramMessageRecord).fileName) != 0) {}
    }
    else {
      do
      {
    ...
    while ((!(paramMessageRecord instanceof MessageForTroopFile)) || (atvo.a(((MessageForTroopFile)paramMessageRecord).fileName) != 0)) {
      return 5;
    }
    return 2;
  }
