  ...
  implements TextWatcher, View.OnClickListener, View.OnTouchListener
{
  ...
  public wzz(CountryActivity paramCountryActivity, Context paramContext)
  {
    super(paramContext);
    ...
    this.jdField_a_of_type_Wzy = new wzy(paramCountryActivity, null);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Wzy);
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Wzy.a(paramString);
    if (this.jdField_a_of_type_Wzy.getCount() == 0) {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
      this.jdField_a_of_type_Wzy.notifyDataSetChanged();
      return;
