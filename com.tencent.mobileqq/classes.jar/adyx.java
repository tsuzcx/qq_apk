  ...
  extends RecyclerView.Adapter
{
  ...
  public adyx(HotPicPageView paramHotPicPageView, int paramInt)
  {
  ...
  public void a(adzh paramadzh, int paramInt)
  {
    ...
    Object localObject1;
    if ((paramadzh instanceof HotPicPageView.MyVideoViewHolder))
    {
      localMyVideoViewHolder = (HotPicPageView.MyVideoViewHolder)paramadzh;
    ...
    for (;;)
    {
      ...
      ViewGroup.MarginLayoutParams localMarginLayoutParams1 = (ViewGroup.MarginLayoutParams)paramadzh.d.getLayoutParams();
      ...
      for (;;)
      {
        ...
        if (localObject1 != null)
        {
          ...
          {
            paramadzh = this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqHotpicHotPicTagInfo.position + "_" + paramInt;
            if (!this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqHotpicHotPicMainPanel.jdField_a_of_type_JavaUtilSet.contains(paramadzh)) {
              break label1037;
            }
          }
        }
        ...
        while (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqHotpicHotPicMainPanel.jdField_a_of_type_AndroidSupportV4ViewViewPager == null)
        {
          ...
          if (((HotVideoData)localObject2).url.isEmpty())
          {
            ...
            ((HotVideoData)localObject2).GetPreviewURLAsync(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, "0", new adyy(this, (HotVideoData)localObject2, localMyVideoViewHolder, (URLDrawable)localObject1));
            break label564;
          }
          j = 1;
          i = j;
          ...
          break label696;
          paramadzh.d.setImageDrawable((Drawable)localObject1);
          break label717;
        }
        label976:
        label988:
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqHotpicHotPicMainPanel.jdField_a_of_type_AndroidSupportV4ViewViewPager.getCurrentItem() == this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqHotpicHotPicTagInfo.position)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqHotpicHotPicMainPanel.jdField_a_of_type_JavaUtilSet.add(paramadzh);
          return;
        }
        label1025:
        label1037:
