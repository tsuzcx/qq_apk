...
{
  public aflv(ActivateFriendActivity paramActivateFriendActivity) {}
  ...
  public void onGetAllowActivateFriend(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      aohd.a(this.a.app, false, true, false, true);
      this.a.a();
    }
  ...
  public void onSetAllowActivateFriend(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    label161:
    QQToast.a(this.a, 1, this.a.getResources().getString(2131718593), 0).b(this.a.getTitleBarHeight());
  }
}
