  ...
  implements aobg
{
  ...
  public aobp(String paramString)
  {
    ...
    try
    {
      ...
      this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = paramString.getDrawable(2130843143);
      return;
    }
  ...
  private void a()
  {
    ...
    try
    {
      ...
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = localResources.getDrawable(2130846204);
      this.d = localResources.getDrawable(2130846205);
  ...
  public static void a(URLDrawable paramURLDrawable)
  {
    ...
    if (paramURLDrawable != null)
    {
      ...
      if ((localObject != null) && ((localObject instanceof GifDrawable)))
      {
        ...
        if ((localObject == null) || (!(localObject instanceof aodb))) {
          break label72;
        }
        ((aodb)localObject).b();
        ((aodb)localObject).a();
    ...
    do
    {
      ...
      {
        return;
      } while ((localObject == null) || (!(localObject instanceof aodc)));
      ((aodc)localObject).b();
      ((aodc)localObject).a();
      paramURLDrawable.invalidateSelf();
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    if (paramEmoticon == null)
    {
      bbrx.a("emotionType", "emotionActionSend", "1", "", "", "", "", "", "", "");
    ...
    if (paramEmoticon.isNewSoundEmoticon()) {
      askf.a(paramQQAppInterface, "0X800A932", paramSessionInfo.jdField_a_of_type_Int, paramEmoticon.epId);
    }
  ...
  private void a(QQAppInterface paramQQAppInterface, URL paramURL, EmoticonPackage paramEmoticonPackage, boolean paramBoolean, URLDrawable paramURLDrawable)
  {
    if (paramQQAppInterface != null)
    {
      ...
      if ((paramEmoticonPackage == null) && (!paramBoolean) && (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) && (!(paramURLDrawable.getCurrDrawable() instanceof ApngDrawable)))
      {
        ...
        paramQQAppInterface.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, new aobq(this, paramURL));
      }
    }
  }
  ...
  public static void b(URLDrawable paramURLDrawable)
  {
    if (paramURLDrawable != null)
    {
      ...
      if ((paramURLDrawable != null) && ((paramURLDrawable instanceof GifDrawable)))
      {
        ...
        if ((paramURLDrawable == null) || (!(paramURLDrawable instanceof aodb))) {
          break label61;
        }
        ((aodb)paramURLDrawable).b();
        if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        return;
      } while ((paramURLDrawable == null) || (!(paramURLDrawable instanceof aodc)));
      ((aodc)paramURLDrawable).b();
    } while (!QLog.isColorLevel());
    QLog.d("PicEmoticonInfo", 2, "soundgif stopSoundDrawablePlay stop");
  }
  ...
  {
    aanz.a(paramQQAppInterface, paramContext, paramSessionInfo, paramEmoticon, paramStickerInfo);
    paramSessionInfo = "";
    int m = -1;
    ...
    axqy.b(paramQQAppInterface, "CliOper", "", "", "ep_mall", "0X80057A9", 0, 0, paramEmoticon.epId, "", paramContext, paramEmoticon.eId);
  }
  ...
  private static void d(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    ...
    axqy.b(paramQQAppInterface, "CliOper", "", "", "MbFasong", "MbIDDianji", 0, 0, paramEmoticon.epId, "", "", "");
    ((askf)paramQQAppInterface.getManager(14)).a(paramEmoticon.epId, -1, new aobt(paramContext, paramQQAppInterface, paramEmoticon, localanvx, paramSessionInfo, paramStickerInfo));
  }
  ...
  private static void e(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    ...
    axqy.b(paramQQAppInterface, "CliOper", "", "", "ep_mall", "0X800579D", 0, 0, paramEmoticon.epId, "", "", "");
    localObject = (anvx)paramQQAppInterface.getManager(43);
    ((askf)paramQQAppInterface.getManager(14)).a(paramEmoticon.epId, 0, new aobv(paramContext, paramQQAppInterface, paramEmoticon, (anvx)localObject, paramSessionInfo));
    c(paramQQAppInterface, paramContext, paramSessionInfo, paramEmoticon, paramStickerInfo);
  }
  ...
  public URLDrawable a()
  {
    ...
    {
      return localObject1;
      String str = anzr.q.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      localObject1 = localObject4;
      if (str == null) {
        continue;
      }
  ...
  public URLDrawable a(String paramString, boolean paramBoolean1, boolean paramBoolean2, adus paramadus)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null) {}
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramadus != null)
        {
          localObject1 = paramadus.e.getDrawable();
          paramadus = BaseApplicationImpl.getApplication().waitAppRuntime(null);
          if ((paramadus instanceof QQAppInterface))
          {
            paramadus = (QQAppInterface)paramadus;
            ...
            if (paramadus != null)
            {
              localObject1 = (askf)paramadus.getManager(14);
              if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null)
              {
                localObject1 = ((askf)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, 0);
      ...
      catch (MalformedURLException paramString)
      {
        for (;;)
        {
          ...
          continue;
          a(paramadus, paramString, (EmoticonPackage)localObject1, paramBoolean1, (URLDrawable)localObject2);
          continue;
          paramBoolean1 = false;
          continue;
  ...
  public URLDrawable a(String paramString, boolean paramBoolean1, boolean paramBoolean2, adus paramadus, int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null) {}
    for (;;)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo, boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      ...
      {
        return;
        paramEditText = (anvx)paramQQAppInterface.getManager(43);
        if ((this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.jobType != 2) || (!paramBoolean) || ((!(paramContext instanceof SplashActivity)) && (!(paramContext instanceof ChatActivity))) || (!asea.a())) {
          break label226;
        }
      ...
      return;
      paramInt = asdj.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, 0);
      if (QLog.isColorLevel()) {
        QLog.d("PicEmoticonInfo", 2, "forward,【maxInt:】" + paramInt);
      }
      paramInt = ascl.a(paramInt);
      ((askf)paramQQAppInterface.getManager(14)).a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, new aobr(this, paramQQAppInterface, paramInt, paramContext, paramSessionInfo));
      return;
      ...
      for (;;)
      {
        aanz.a(paramQQAppInterface, paramContext, paramSessionInfo, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, paramInt);
        return;
        if (QLog.isColorLevel()) {
  ...
  public boolean d()
  {
    ...
    Object localObject = anzr.s.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      {
        localObject = anzr.o.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
        if (localObject == null) {
          break label165;
        }
        localObject = new File((String)localObject);
  ...
  public boolean e()
  {
    ...
    {
      localObject = anzr.p.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      label52:
      if (localObject == null) {
        break label112;
      }
    ...
    {
      return bool;
      localObject = anzr.q.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      break label52;
      label112:
      break;
      label114:
