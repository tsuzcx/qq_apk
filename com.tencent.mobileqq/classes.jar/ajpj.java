...
{
  ajpj(ajpg paramajpg, String paramString, int paramInt) {}
  ...
  public void onClick(View paramView)
  {
    if ((!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_JavaLangString != null))
    {
      ...
      Intent localIntent = new Intent(this.jdField_a_of_type_Ajpg.a.getActivity(), QQBrowserActivity.class);
      localIntent.putExtra("big_brother_source_key", "biz_src_zf_lmx");
      VasWebviewUtil.openQQBrowserActivity(this.jdField_a_of_type_Ajpg.a.getActivity(), paramView, -1L, localIntent, false, -1);
      return;
    }
