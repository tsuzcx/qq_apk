  ...
  extends ajtd
{
  ...
  public static final String b = ajyc.a(2131705557);
  public static final String c = ajyc.a(2131705556);
  private volatile boolean a;
  
  static
  {
    jdField_a_of_type_JavaLangString = ajyc.a(2131705548);
  }
  
  public ajyi(QQAppInterface paramQQAppInterface)
  {
  ...
  public static LBS.LBSInfo a(boolean paramBoolean)
  {
    ...
    SosoInterface.a(3600000L, ajyi.class.getSimpleName());
  ...
  private void a(Common.WifiPOIInfo paramWifiPOIInfo, boolean paramBoolean, int paramInt)
  {
    ...
    int j = 0;
    if (QLog.isColorLevel()) {
      atbp.a("HotChatHandler", new Object[] { "createHotChat", Boolean.valueOf(paramBoolean), Integer.valueOf(paramInt), paramWifiPOIInfo });
    }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    notifyUI(1032, false, new Object[] { paramToServiceMsg.troopUin, ajyc.a(2131705560), paramToServiceMsg.name });
  }
  
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    String str = ajyc.a(2131705553);
    ...
    catch (InvalidProtocolBufferMicroException paramToServiceMsg)
    {
      ...
      if (i == 0)
      {
        ...
        try
        {
          ...
          long l1 = bbbd.a(paramFromServiceMsg.uint32_group_code.get());
          long l2 = bbbd.a(paramFromServiceMsg.uint32_group_uin.get());
          ...
          notifyUI(1032, true, new Object[] { ajyc.a(2131705543), localHotChatInfo.troopCode, localHotChatInfo.troopUin, localHotChatInfo.name, Boolean.valueOf(bool) });
          return;
        }
      ...
      case 1289: 
      default: 
        paramToServiceMsg = ajyc.a(2131705562);
      }
    }
    for (;;)
    {
      ...
      return;
      paramToServiceMsg = ajyc.a(2131705555);
      continue;
      paramToServiceMsg = ajyc.a(2131705549);
      continue;
      paramToServiceMsg = ajyc.a(2131705558);
      continue;
      paramToServiceMsg = ajyc.a(2131705559);
      continue;
      paramToServiceMsg = ajyc.a(2131705550);
      continue;
      paramToServiceMsg = ajyc.a(2131705545);
    }
  }
    ...
    for (;;)
    {
      ...
      if (paramFromServiceMsg != null)
      {
        ...
        if (QLog.isDevelopLevel()) {
          atbp.a("PttShow", new Object[] { "handleQuickJoinHotChat", paramObject });
        }
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   180: astore_3
    //   181: aload_0
    //   182: getfield 423	ajyi:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   185: bipush 60
    ...
    //   427: aload_1
    //   428: aastore
    //   429: invokevirtual 419	ajyi:notifyUI	(IZLjava/lang/Object;)V
    ...
    //   535: aconst_null
    //   536: aastore
    //   537: invokevirtual 419	ajyi:notifyUI	(IZLjava/lang/Object;)V
    //   540: aconst_null
    //   541: astore_1
    //   542: aload 7
    //   544: astore_2
    ...
    catch (InvalidProtocolBufferMicroException paramObject)
    {
      for (;;)
      {
        try
        {
          ...
          akoj.a(this.app, String.valueOf(str2), str4 + BaseApplicationImpl.getContext().getString(2131693321), 1, false, true);
  ...
  private void l(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      akoj.a(this.app, String.valueOf(str3), str4 + BaseApplicationImpl.getContext().getString(2131693321), 1, false, true);
  ...
  {
    a(0);
    if (bbjn.h(this.app.getApplication(), getCurrentAccountUin())) {
      a(2);
    }
    if (bbjn.g(this.app.getApplication(), getCurrentAccountUin())) {
      ((bcic)this.app.a(107)).a(new ajyj(this));
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      atbp.a("HotChatHandler", new Object[] { "getMyHotChatList()", Boolean.valueOf(this.jdField_a_of_type_Boolean) });
    }
  ...
  {
    if (QLog.isColorLevel()) {
      atbp.a("HotChatHandler", new Object[] { "exitHotChat", paramHotChatInfo, paramHotChatStateWrapper });
    }
    ...
    ((oidb_0x89b.ExitPublicGroupReqBody)localObject).uint64_visitor_uin.set(ajsz.a(this.app.getCurrentAccountUin()));
    oidb_0x89b.ReqBody localReqBody = new oidb_0x89b.ReqBody();
    localReqBody.uint64_group_code.set(ajsz.a(paramHotChatInfo.troopUin));
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   52: aload 6
    //   54: aastore
    //   55: invokevirtual 419	ajyi:notifyUI	(IZLjava/lang/Object;)V
    //   58: return
    ...
    //   251: aload 6
    //   253: aastore
    //   254: invokevirtual 419	ajyi:notifyUI	(IZLjava/lang/Object;)V
    //   257: return
    //   258: aload_0
    //   259: sipush 1058
    //   262: iconst_0
    ...
    //   274: aload 6
    //   276: aastore
    //   277: invokevirtual 419	ajyi:notifyUI	(IZLjava/lang/Object;)V
    //   280: return
    //   281: aload_0
    //   282: sipush 1058
    //   285: iconst_1
    ...
    //   297: aload 6
    //   299: aastore
    //   300: invokevirtual 419	ajyi:notifyUI	(IZLjava/lang/Object;)V
    //   303: return
    //   304: astore_1
    //   305: aload_0
    //   306: sipush 1058
    ...
    //   321: aload 6
    //   323: aastore
    //   324: invokevirtual 419	ajyi:notifyUI	(IZLjava/lang/Object;)V
  ...
  public void a(Common.WifiPOIInfo paramWifiPOIInfo, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      if (paramWifiPOIInfo.uint32_group_uin.has()) {
        str = String.valueOf(bbbd.a(paramWifiPOIInfo.uint32_group_uin.get()));
      }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   143: istore 4
    //   145: aload_0
    //   146: getfield 423	ajyi:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   149: bipush 60
    ...
    //   209: aastore
    //   210: invokevirtual 419	ajyi:notifyUI	(IZLjava/lang/Object;)V
    ...
    //   344: aastore
    //   345: invokevirtual 419	ajyi:notifyUI	(IZLjava/lang/Object;)V
    //   348: iconst_0
    //   349: istore 4
    //   351: goto -138 -> 213
    //   354: astore_1
  ...
  {
    akoj.a(this.app, String.valueOf(paramString1), paramString3 + BaseApplicationImpl.getContext().getString(2131693321), 1, false, true);
