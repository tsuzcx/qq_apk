...
{
  public airi(ShortVideoUploadProcessor paramShortVideoUploadProcessor) {}
  ...
  public void onResponse(HwResponse paramHwResponse)
  {
    ...
    try
    {
      ...
      LogTag.a(String.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_a_of_type_Long), "svrcomp_r", "sendAckToBDHServer success!  MD5:" + HexUtil.bytes2HexStr((byte[])localObject3) + " mSendClicked : " + this.a.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get());
      this.a.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.f = HexUtil.bytes2HexStr((byte[])localObject3);
      this.a.jdField_c_of_type_JavaLangString = this.a.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.f;
    ...
    for (;;)
    {
      ...
      label893:
      localObject2 = this.a.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg;
      localObject3 = this.a.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg;
      ...
      ((FileMsg)localObject2).jdField_a_of_type_Long = l;
      this.a.d(1007);
      this.a.b(false);
