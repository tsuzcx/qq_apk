  ...
  implements Manager
{
  ...
  akhp jdField_a_of_type_Akhp;
  @NonNull
  SparseArray<Integer> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray(10);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  final Object jdField_a_of_type_JavaLangObject = new Object();
  String jdField_a_of_type_JavaLangString;
  ThreadLocal<SimpleDateFormat> jdField_a_of_type_JavaLangThreadLocal = new baja(this);
  protected Map<String, JSONObject> a;
  protected boolean a;
  protected final int b;
  protected SparseArray<baiw> b;
  String b;
  protected String c;
  
  public baiz(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Akhp = ((akhp)paramQQAppInterface.a(20));
    a();
    ...
    while (i < j)
    {
      ...
      baiw localbaiw = new baiw();
      localbaiw.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getString("appinfo_date_" + k, "");
      localbaiw.jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getInt("KEY_APP_LIST_TIME_STAMP_" + k, 0);
      this.jdField_b_of_type_AndroidUtilSparseArray.put(k, localbaiw);
      i += 1;
    }
    f();
    d();
    ...
    this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getString("appinfo_all_app_string", ajya.a(2131715198));
  }
  ...
  private void f()
  {
    ...
    {
      Object localObject3 = localaukp.a(TroopAIOAppInfo.class);
      ...
      if (((ListIterator)localObject1).hasNext())
      {
        ...
        baiw localbaiw = (baiw)this.jdField_b_of_type_AndroidUtilSparseArray.get(((TroopAIOAppInfo)localObject3).groupType);
        vxp.a(localbaiw);
        localbaiw.a(((TroopAIOAppInfo)localObject3).appid, (TroopAIOAppInfo)localObject3);
      }
    }
    localaukp.a();
  }
  ...
  {
    baiw localbaiw = (baiw)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
    if (localbaiw != null) {}
    ...
    return localbaiw.jdField_b_of_type_Int;
  }
  
  public TroopAIOAppInfo a(int paramInt1, int paramInt2)
  {
    Object localObject1 = (baiw)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt2, null);
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        localObject1 = (TroopAIOAppInfo)((baiw)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt1));
        if (localObject1 != null)
        {
  ...
  public List<TroopAIOAppInfo> a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Akhp.a(1, paramInt, null, paramBoolean);
    }
    ArrayList localArrayList = new ArrayList();
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      Object localObject2 = (baiw)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
      vxp.a(localObject2);
      localObject2 = ((baiw)localObject2).a().iterator();
  ...
  public void a()
  {
    bajc[] arrayOfbajc = bajc.jdField_a_of_type_ArrayOfBajc;
    int j = arrayOfbajc.length;
    int i = 0;
    while (i < j)
    {
      bajc localbajc = arrayOfbajc[i];
      Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getString("KEY_APP_CONFIG_PREFIX-" + localbajc.jdField_a_of_type_JavaLangString, null);
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        localObject = localbajc.a((String)localObject);
        this.jdField_a_of_type_JavaUtilMap.put(localbajc.jdField_a_of_type_JavaLangString, localObject);
      }
      i += 1;
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    baiw localbaiw = (baiw)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt, null);
    if (localbaiw != null) {}
    for (boolean bool = true;; bool = false)
    {
      vxp.a(bool);
      if (localbaiw != null) {
        localbaiw.jdField_a_of_type_JavaLangString = ((String)localObject);
      }
  ...
  {
    baiw localbaiw = (baiw)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt2);
    boolean bool;
    if (localbaiw != null)
    {
      bool = true;
    ...
    do
    {
      ...
      bool = false;
      break;
      TroopAIOAppInfo localTroopAIOAppInfo = (TroopAIOAppInfo)localbaiw.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Integer.valueOf(paramInt1));
      if (localTroopAIOAppInfo != null)
      {
        vxp.a(localbaiw.a(localTroopAIOAppInfo));
  ...
  public void a(int paramInt, boolean paramBoolean, String paramString)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
      {
        ...
        b();
        ??? = new axrc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("add_page").d("Clk_app").a(new String[] { paramString }).a(new String[] { String.valueOf(paramInt) });
        if (paramBoolean)
        {
          paramString = "0";
          ((axrc)???).a(new String[] { paramString }).a();
          return;
        }
      }
      paramString = "1";
  ...
  public void a(ArrayList<Integer> paramArrayList)
  {
    ...
    baiw localbaiw = (baiw)this.jdField_b_of_type_AndroidUtilSparseArray.get(0, null);
    if (localbaiw != null) {}
    for (boolean bool = true;; bool = false)
    {
      vxp.a(bool);
      ...
      } while (localbaiw.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(localInteger));
      QLog.w(".troop.troop_app", 1, "TroopAppMgr:sortTroopAppList error, there is no appid in hashtable");
      return;
    }
    this.jdField_a_of_type_Akhp.a(a(0), paramArrayList);
  }
  ...
  public void a(ArrayList<TroopAIOAppInfo> paramArrayList, int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        localbaiw.a(localTroopAIOAppInfo.appid, localTroopAIOAppInfo);
      }
    }
    label104:
  ...
  public void a(ArrayList<Integer> paramArrayList1, ArrayList<Integer> paramArrayList2)
  {
    ...
    do
    {
      ...
      {
        this.jdField_a_of_type_Akhp.a(a(0), paramArrayList1, paramArrayList2);
        return;
      }
    } while (!QLog.isColorLevel());
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    {
      bajc localbajc = arrayOfbajc[i];
      JSONObject localJSONObject = localbajc.a(paramJSONObject.optJSONObject(localbajc.jdField_a_of_type_JavaLangString));
      if (localJSONObject != null) {
        a(localbajc.jdField_a_of_type_JavaLangString, localJSONObject);
      }
      i += 1;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean) {
          localbaiw.jdField_a_of_type_Int |= 0x2;
        } else {
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean) {
          localbaiw.jdField_a_of_type_Int |= 0x1;
        } else {
  ...
  public boolean a(int paramInt)
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 44	baiz:jdField_b_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   8: iload_1
    //   9: aconst_null
    //   10: invokevirtual 283	android/util/SparseArray:get	(ILjava/lang/Object;)Ljava/lang/Object;
    //   13: checkcast 71	baiw
    //   16: astore 4
    //   18: aload 4
    //   20: ifnull +20 -> 40
    //   23: iconst_1
    ...
    //   42: goto -17 -> 25
    //   45: aload 4
    //   47: getfield 478	baiw:jdField_a_of_type_Int	I
    //   50: istore_1
    //   51: iload_1
    //   52: iconst_1
    //   53: iand
  ...
  public boolean a(aukp paramaukp, auko paramauko)
  {
    ...
    do
    {
      ...
      bool1 = bool2;
    } while (paramauko.getStatus() != 1002);
  ...
  public boolean a(TroopAIOAppInfo paramTroopAIOAppInfo)
  {
    ...
    Object localObject = (baiw)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramTroopAIOAppInfo.groupType);
    boolean bool1;
    if (localObject != null)
    {
      bool1 = true;
    ...
    do
    {
      ...
      bool1 = false;
      break;
      localObject = (TroopAIOAppInfo)((baiw)localObject).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i));
    } while (localObject == null);
    vxp.a(paramTroopAIOAppInfo.hashVal);
    vxp.a(((TroopAIOAppInfo)localObject).hashVal);
  ...
  public boolean a(List<Integer> paramList, int paramInt)
  {
    ...
    {
      vxp.a(bool1);
      if ((localbaiw != null) && (paramList != null)) {
        break label59;
      }
      return false;
      bool1 = false;
    ...
    new ArrayList();
    Object localObject;
    if (paramList.size() != localbaiw.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size())
    {
      bool1 = bool2;
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool1)
        {
          localbaiw.a(paramList, paramInt);
          b(localbaiw.a(), paramInt);
        }
        return bool1;
      }
      finally {}
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          int k = arrayOfInt[i];
          Object localObject3 = (baiw)this.jdField_b_of_type_AndroidUtilSparseArray.get(k);
          vxp.a(localObject3);
          localObject3 = (TroopAIOAppInfo)((baiw)localObject3).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
          if (localObject3 != null)
          {
        ...
        {
          if (bool) {
            ThreadManager.post(new TroopAppMgr.5(this, localArrayList, localaukp), 8, null, false);
          }
          if (QLog.isColorLevel()) {
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    localbaiw.jdField_b_of_type_Int = paramInt1;
  ...
  {
    int i = paramTroopAIOAppInfo.appid;
    baiw localbaiw = (baiw)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramTroopAIOAppInfo.groupType);
    if (localbaiw != null) {}
    for (boolean bool = true;; bool = false)
    {
      vxp.a(bool);
    ...
    if ((TroopAIOAppInfo)localbaiw.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i)) != null) {
      return true;
    }
    localbaiw.a(paramTroopAIOAppInfo.appid, paramTroopAIOAppInfo);
    return false;
  }
  ...
  public void c()
  {
    ...
    try
    {
      ...
      mxf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new bajb(this), localReqBody.toByteArray(), "OidbSvc.0xa1e", 2590, 0);
      return;
    }
    finally {}
  }
  ...
  public void onDestroy()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      while (i < j)
      {
        int k = arrayOfInt[i];
        a(false, k);
        baiw localbaiw = (baiw)this.jdField_b_of_type_AndroidUtilSparseArray.get(k);
        vxp.a(localbaiw);
        localbaiw.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
        localbaiw.a();
        localbaiw.jdField_b_of_type_Int = 0;
        i += 1;
      }
      return;
    }
