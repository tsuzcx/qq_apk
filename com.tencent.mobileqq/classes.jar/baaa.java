  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject1 = paramView.getTag(2131377133);
    if ((localObject1 != null) && ((localObject1 instanceof baac)))
    {
      localObject7 = (baac)localObject1;
    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          l1 = l2;
          if (((baac)localObject7).a.getDrawable() != null)
          {
            l1 = l2;
            if ((((baac)localObject7).a.getDrawable() instanceof URLDrawable))
            {
              localObject3 = (URLDrawable)((baac)localObject7).a.getDrawable();
              l1 = l2;
          ...
          paramView = (String)paramView.getTag(2131377139);
        } while (TextUtils.isEmpty(paramView));
        String str = bhsz.a(bhsz.a(paramView, "progress", String.valueOf(l1)), "msgId", (String)localObject1);
