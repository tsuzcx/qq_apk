...
public class balo
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new balt(this);
  ...
  public balo()
  {
    ...
    this.jdField_a_of_type_Int = aekt.a(4.0F, ((Context)localObject).getResources());
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561322, null));
    ...
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367509));
    int i = 0;
  ...
  void b()
  {
    ...
    int i = aekt.a(1.0F, ((Context)localObject2).getResources());
    this.d.setPadding(i, i, i, i);
    this.d.setBackgroundResource(2130844661);
    ...
    try
    {
      ...
      ((ScaleAnimation)localObject1).setAnimationListener(new balp(this));
  ...
  void e()
  {
    int j = this.jdField_a_of_type_AndroidWidgetImageView.getWidth() - aekt.a(5.0F, BaseApplicationImpl.getContext().getResources());
    ...
    localObject2 = new balr(this, localAnimatorSet);
