  ...
  extends bdby
{
  ...
  public void a()
  {
    try
    {
      ...
      aiws.a().a();
      aioe.a(this.a).clear();
      aing.a().callbackFromRequest(aioe.a(this.a), 0, "cs.audioRoom_exit.local", localJSONObject.toString());
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    try
    {
      ...
      aing.a().callbackFromRequest(aioe.a(this.a), paramInt, "cs.audioRoom_init.local", paramString.toString());
      return;
    }
  ...
  public void a(int paramInt, String[] paramArrayOfString)
  {
    ...
    try
    {
      ...
      localJSONObject1.put("lState", aioe.a(this.a));
      localJSONObject1.put("eventId", paramInt);
      localArrayList = new ArrayList();
      localJSONArray1 = new JSONArray();
      localJSONArray2 = new JSONArray();
      aing.a();
      localaipx = aing.a(aioe.a(this.a));
      if (localaipx != null) {
        break label488;
      }
      return;
    ...
    {
      localObject = localaipx.b(paramArrayOfString[i]);
    ...
    else
    {
      if (localJSONArray1.length() > 0)
      {
        ...
        aing.a().callbackFromRequest(aioe.a(this.a), 0, "cs.audioRoom_update_userinfo.local", ((JSONObject)localObject).toString());
      }
      if (localArrayList.size() > 0)
      {
        localJSONObject1.put("identifierList", localJSONArray2.toString());
        if (localaipx != null) {
          localaipx.a(1, null, localArrayList, 8, aioe.a(this.a), false, localJSONObject1.toString(), "");
        }
      }
    ...
    for (;;)
    {
      if (i < aioe.a(this.a).size())
      {
        if (((String)aioe.a(this.a).get(i)).equals(paramArrayOfString[paramInt])) {
          i = 1;
        }
      }
      else
      {
        for (;;)
        {
          if (i == 0)
          {
            aioe.a(this.a).add(paramArrayOfString[paramInt]);
            break label510;
            if (aioe.a(this.a))
            {
              paramArrayOfString = (CmGameAppInterface)aing.a();
              aioe.a(this.a, (String[])aioe.a(this.a).toArray(new String[aioe.a(this.a).size()]), paramArrayOfString.getCurrentAccountUin());
              return;
              i = 0;
            }
            else
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    try
    {
      ...
      aing.a().callbackFromRequest(aioe.a(this.a), paramInt, "cs.audioRoom_set_mic.local", localJSONObject.toString());
      return;
    }
    catch (Exception localException)
    {
  ...
  public void b(boolean paramBoolean, int paramInt)
  {
    try
    {
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("res", paramInt);
      aing.a().callbackFromRequest(aioe.a(this.a), paramInt, "cs.audioRoom_set_speaker.local", localJSONObject.toString());
      return;
    }
    catch (Exception localException)
    {
  ...
  public void c(int paramInt, String paramString)
  {
    try
    {
      ...
      aing.a().callbackFromRequest(aioe.a(this.a), 0, "cs.audioRoom_disconnect.local", paramString.toString());
      return;
    }
    catch (Exception paramString)
    {
