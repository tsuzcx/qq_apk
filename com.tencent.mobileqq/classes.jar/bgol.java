...
public class bgol
{
  ...
  @Deprecated
  public bgol(String paramString1, String paramString2)
  {
    this.jdField_a_of_type_JavaLangString = paramString2;
    this.b = paramString1;
    if (!ampk.a().containsKey(paramString2)) {
      ampk.a(paramString2, new int[] { 13 });
    }
  }
  
  public bgol(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    this(paramString1, paramString2);
    this.jdField_a_of_type_JavaLangString = paramString2;
    this.b = paramString1;
    ampk.a(paramString2, a(paramString2, 13));
    this.c = paramString3;
    this.d = paramString4;
  }
  ...
  private int[] a(String paramString, int paramInt)
  {
    ...
    {
      localObject = (int[])ampk.a().get(paramString);
  ...
  public void a(String paramString, JceStruct paramJceStruct1, JceStruct paramJceStruct2, BusinessObserver paramBusinessObserver, boolean paramBoolean)
  {
    ...
    paramBusinessObserver = ((anaj)localQQAppInterface.getBusinessHandler(13)).createToServiceMsg(this.jdField_a_of_type_JavaLangString, paramBusinessObserver, paramBoolean);
