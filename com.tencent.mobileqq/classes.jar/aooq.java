  ...
  implements Manager, BusinessObserver
{
  ...
  public aooq(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    List localList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createEntityManager().query(LbsReportInfo.class);
  ...
  public static void a(SosoInterface.SosoLocation paramSosoLocation, String paramString)
  {
    ...
    for (;;)
    {
      ...
      ((aooq)paramSosoLocation.getManager(126)).a(localIntent);
      return;
      i = 0;
    }
    label231:
