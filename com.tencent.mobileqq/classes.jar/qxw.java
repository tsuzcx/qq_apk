  ...
  extends npt
{
  ...
  private qxw(qxu paramqxu) {}
  
  private void a()
  {
    qxu.a(this.jdField_a_of_type_Qxu).j();
  }
  ...
  protected void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    qxu.a(this.jdField_a_of_type_Qxu).set(false);
    if (!paramBoolean) {
      a();
    }
    for (;;)
    {
      qxu.a(this.jdField_a_of_type_Qxu);
      ArrayList localArrayList;
      do
      {
        return;
        qxu.a(this.jdField_a_of_type_Qxu, paramBundle.getString("VALUE_COOKIE", null));
        localArrayList = paramBundle.getParcelableArrayList("VIDEO_RECOMMEND_LIST");
      } while ((localArrayList == null) || (localArrayList.size() == 0));
      int i = qxu.a(this.jdField_a_of_type_Qxu).size();
      Object localObject2 = localArrayList.iterator();
      while (((Iterator)localObject2).hasNext())
      {
        VideoInfo localVideoInfo = (VideoInfo)((Iterator)localObject2).next();
        if (qxu.a(this.jdField_a_of_type_Qxu).contains(localVideoInfo.jdField_a_of_type_JavaLangString)) {
          ((Iterator)localObject2).remove();
        }
        if (localVideoInfo.jdField_c_of_type_Boolean) {
          qoi.b(localVideoInfo);
        }
        qxu.a(this.jdField_a_of_type_Qxu).add(localVideoInfo.jdField_a_of_type_JavaLangString);
      }
      qxu.a(this.jdField_a_of_type_Qxu).addAll(localArrayList);
      localObject2 = (VideoInfo)paramBundle.getParcelable("VALUE_REQUEST_VIDEO_DETAIL_INFO");
      paramBundle = localObject1;
      if (qxu.a(this.jdField_a_of_type_Qxu).size() > 0) {
        paramBundle = (VideoInfo)qxu.a(this.jdField_a_of_type_Qxu).get(0);
      }
      if ((!this.jdField_a_of_type_Boolean) && (paramBundle != null) && (localObject2 != null))
      {
        ...
        qxu.a(this.jdField_a_of_type_Qxu).a(0);
      }
      qxu.a(this.jdField_a_of_type_Qxu).a(i, localArrayList.size());
    }
  }
}
