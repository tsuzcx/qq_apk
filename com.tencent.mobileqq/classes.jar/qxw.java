  ...
  implements View.OnClickListener
{
  ...
  public qxw(qxv paramqxv, View paramView, BaseData paramBaseData)
  {
  ...
  {
    return LayoutInflater.from(paramContext).inflate(2131494343, (ViewGroup)this.jdField_a_of_type_AndroidViewView, false);
  }
  
  private void a(String paramString, qxh paramqxh, ArticleInfo paramArticleInfo)
  {
    long l1 = paramArticleInfo.mArticleID;
    long l2 = paramqxh.jdField_a_of_type_Long;
    ndn.a(null, "CliOper", "", obz.a(), paramString, paramString, 0, 0, String.valueOf(l1), String.valueOf(l2), paramArticleInfo.innerUniqueID, "", false);
  }
  ...
  public SpannableStringBuilder a(String paramString)
  {
    ...
    for (;;)
    {
      if (i < paramString.length()) {
        if (!baip.c(paramString.charAt(i))) {
          break label144;
        }
      }
      label144:
      for (d += 1.0D; d >= 11.0D; d += 0.5D)
      {
        ...
        if (i < paramString.length() - 1) {
          str = paramString.substring(0, i + 1) + obb.jdField_a_of_type_JavaLangString;
        }
  ...
  public void a(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    if (i < this.jdField_a_of_type_ComTencentWidgetHorizontalLabelLayout.getChildCount())
    {
      ...
      if (i < j)
      {
        ...
        qxh localqxh = (qxh)paramBaseData1.jdField_a_of_type_JavaUtilList.get(i);
        localView.setTag(localqxh);
        ((TextView)localView.findViewById(2131309016)).setText(a(localqxh.jdField_a_of_type_JavaLangString));
        if ((!paramBoolean) && (!paramBaseData1.jdField_a_of_type_Boolean))
        {
          a("0X800919F", localqxh, paramBaseData2.b);
  ...
  {
    qxh localqxh = (qxh)paramView.getTag();
    if (localqxh != null)
    {
      obz.a(paramView.getContext(), localqxh.b);
      a("0X80091A0", localqxh, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b);
    }
  }
}
