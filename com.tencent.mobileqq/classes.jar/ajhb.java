  ...
  extends ajgd
{
  ...
  ajbd jdField_a_of_type_Ajbd;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ajhf(this);
  ...
  public ajhb(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new ajhc(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131368234)).setOnClickListener(new ajhd(this));
    Button localButton = (Button)findViewById(2131363774);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new ajhe(this));
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Ajbd = new ajbd(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Bjmp, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ajbd);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new ajhg(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new ajhh(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new ajhi(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemLongClickListener(new ajhj(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Ajbd.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Ajbd.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
  }
  
  public void a(List<TroopLinkElement> paramList)
  {
    this.jdField_a_of_type_Ajbd.a(paramList);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.jdField_c_of_type_AndroidWidgetTextView.setText(amtj.a(2131705249));
        ...
        {
          this.jdField_a_of_type_Ajbd.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_d_of_type_Boolean, 0);
          this.jdField_a_of_type_Ajbd.notifyDataSetChanged();
        }
        if (this.jdField_a_of_type_Ajbd.getCount() == 0) {
          a(4, null);
        }
        for (;;)
        {
      ...
      this.jdField_a_of_type_Ajbd.a(this.jdField_a_of_type_JavaUtilList, this.jdField_d_of_type_Boolean);
      if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_Ajbd.getCount() < 20))
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(amtj.a(2131705250));
        this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131373010).setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
      }
    ...
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Ajbd.a((List)localObject, this.jdField_d_of_type_Boolean);
    this.jdField_a_of_type_Ajbd.notifyDataSetChanged();
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ajbd);
    this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
    this.jdField_a_of_type_JavaUtilList.clear();
