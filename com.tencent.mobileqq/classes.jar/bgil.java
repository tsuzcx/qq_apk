  ...
  extends bgix
{
  ...
  private void a(bbac parambbac, String[] paramArrayOfString)
  {
    try
    {
      ...
      parambbac.putInt("key_personal_album_enter_model", 0);
      parambbac.putBoolean("key_pass_result_by_bundle", true);
      parambbac.putString("key_accept_album_anonymity", paramArrayOfString.optString("acceptType"));
      parambbac.putString("key_deny_delect_tips", paramArrayOfString.optString("denyTips"));
      parambbac.putBoolean("key_can_new_album", false);
      parambbac.putString("key_from_type", paramArrayOfString.optString("fromType"));
      paramArrayOfString = bfpy.a();
      ...
      parambbac.putBoolean("key_need_change_to_jpg", false);
      bfpr.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), paramArrayOfString, parambbac, bfpr.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, 7));
      return;
    }
