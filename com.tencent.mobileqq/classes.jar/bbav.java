  ...
  implements Manager
{
  ...
  public bbav(AppInterface paramAppInterface)
  {
  ...
  private BusinessInfoCheckUpdate.TimeRspBody a(BusinessInfoCheckUpdate.TimeRspBody paramTimeRspBody1, BusinessInfoCheckUpdate.TimeRspBody paramTimeRspBody2)
  {
  ...
  public static String a(BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    StringBuilder localStringBuilder = agej.a().append(paramAppInfo.path.get()).append(":");
  ...
  {
    if (paramInt == 6) {
      bmzn.a().a(paramAppInfo, 102);
    }
    while (paramInt != 1) {
      return;
    }
    bmzn.a().a(paramAppInfo, 101);
  }
  ...
  private void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      setChanged();
      if (i != 0) {
        aogf.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface);
      }
      return;
      ...
      try
      {
        ...
        if ((localTimeRspBody != null) && (localTimeRspBody.rptMsgAppInfo.has()))
        {
          ...
          if (i < localTimeRspBody.rptMsgAppInfo.size())
          {
            ...
            localObject = (bcuy)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(12);
            if (localObject != null) {
              ((bcuy)localObject).a(paramString);
            }
          }
        }
        a(localTimeRspBody);
  ...
  private boolean a(int paramInt, List<BusinessInfoCheckUpdate.AppSetting> paramList, BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    if (((paramInt == 0) || (paramInt == 1)) && (paramAppInfo.exposure_max.get() <= 0)) {
      return true;
    }
    paramInt = 0;
    for (;;)
  ...
  private void b(BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    for (int i = 1;; i = 2)
    {
      bdll.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00899", "Grp_tribe", "", "dynamic", "Clk_tribe", 0, 0, i + "", "", "", "");
      ...
      a(qfq.a("OidbSvc.0xd40_0", 3392, 0, paramAppInfo.toByteArray()));
      return;
    }
  }
  ...
  private void b(byte[] paramArrayOfByte)
  {
    ...
    for (QQAppInterface localQQAppInterface = (QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface;; localQQAppInterface = null)
    {
      ...
      catch (Exception paramArrayOfByte)
      {
        ...
        ((aogf)localQQAppInterface.a(87)).a(true, true);
        return;
  ...
  private void c()
  {
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        try
        {
          byte[] arrayOfByte = bhmi.a(localFile);
          if (arrayOfByte != null) {
            break;
          }
  ...
  public int a(vtg paramvtg, boolean paramBoolean)
  {
    int n = 0;
    ...
    if (paramvtg != null)
    {
      ...
      if ((paramvtg == null) && (this.jdField_b_of_type_Long <= 0L) && (!paramBoolean)) {
        break label201;
      }
      j = 1;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((j != 0) && (k > 0))
        {
          ...
          a((long[])localObject2, "QQCircleRedCircle", new bbaw(this, paramvtg, m));
          return m;
        }
        if (paramvtg == null) {
          break label375;
      ...
      catch (Exception paramvtg)
      {
        paramvtg.printStackTrace();
        QLog.e("RedPointLog.RedTouchManager", 1, "getPassiveRedNumQQCircle", paramvtg);
        return m;
      }
    }
    label375:
  ...
  public BusinessInfoCheckUpdate.RedTypeInfo a(int paramInt)
  {
    ...
    for (;;)
    {
      i += 1;
      break label69;
      if (!a(paramInt, localList2, localAppInfo))
      {
  ...
  public BusinessInfoCheckUpdate.RedTypeInfo a(QQAppInterface paramQQAppInterface, boolean paramBoolean, Map<Long, LebaPluginInfo> paramMap)
  {
    ...
    for (;;)
    {
      ...
      else if (!aoaz.a(paramQQAppInterface, localAppInfo.uiAppId.get(), paramBoolean, paramMap))
      {
    ...
    if (paramArrayOfByte != null) {
      try
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          if ((a(localNumRedBusiInfo)) && (bbaz.a(localNumRedBusiInfo))) {
  ...
  public void a(long[] paramArrayOfLong, String paramString, bbap parambbap)
  {
    ((bbaq)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(65)).a(paramArrayOfLong, paramString, parambbap);
  }
  ...
  public boolean a(BusinessInfoCheckUpdate.TimeRspBody paramTimeRspBody)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	bbav:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   4: invokevirtual 228	com/tencent/common/app/AppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   7: astore 5
    //   9: aload_0
    //   10: getfield 35	bbav:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   13: astore 4
    //   15: aload 4
    //   17: monitorenter
    //   18: aload_1
    //   19: invokevirtual 1193	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody:toByteArray	()[B
    //   22: astore 6
    //   24: aload 4
    //   26: monitorexit
    //   27: getstatic 30	bbav:jdField_b_of_type_JavaLangObject	Ljava/lang/Object;
    //   30: astore 4
    //   32: aload 4
    //   34: monitorenter
    //   35: getstatic 25	bbav:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   38: invokevirtual 1196	java/util/concurrent/atomic/AtomicInteger:incrementAndGet	()I
    //   41: istore_2
    //   42: new 810	java/io/File
    //   45: dup
    //   46: aload_0
    //   47: getfield 37	bbav:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   50: invokevirtual 813	com/tencent/common/app/AppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   53: invokevirtual 819	mqq/app/MobileQQ:getFilesDir	()Ljava/io/File;
    ...
    //   77: invokespecial 824	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   80: invokevirtual 1199	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   83: aload 6
    //   85: iconst_0
    //   86: invokestatic 1202	bhmi:a	(Ljava/lang/String;[BZ)Z
    //   89: istore_3
    //   90: iload_3
    //   91: ifeq +89 -> 180
    //   94: getstatic 1205	bcuy:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   97: aload 5
    //   99: iconst_0
    //   100: invokestatic 1210	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   103: invokevirtual 1213	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   106: pop
    //   107: aload 4
    //   109: monitorexit
    //   110: aload_0
    //   111: getfield 35	bbav:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   114: astore 4
    //   116: aload 4
    //   118: monitorenter
    //   119: iload_3
    //   120: ifeq +18 -> 138
    //   123: iload_2
    //   124: getstatic 25	bbav:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   127: invokevirtual 1214	java/util/concurrent/atomic/AtomicInteger:get	()I
    //   130: if_icmpne +8 -> 138
    //   133: aload_0
    //   134: aload_1
    //   135: invokespecial 1216	bbav:b	(Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;)V
    //   138: aload 4
    //   140: monitorexit
    //   141: iload_3
    //   142: ireturn
    ...
    //   147: ldc_w 1218
    //   150: aload_1
    //   151: invokestatic 445	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   154: aload 4
    //   156: monitorexit
    //   157: iconst_0
    //   158: ireturn
    ...
    //   168: iconst_1
    //   169: ldc_w 1220
    //   172: invokestatic 170	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   175: aload 4
    //   177: monitorexit
    //   178: iconst_0
    //   179: ireturn
    ...
    //   182: iconst_1
    //   183: ldc_w 1222
    //   186: invokestatic 170	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   189: goto -82 -> 107
    //   192: astore_1
    //   193: aload 4
    //   195: monitorexit
  ...
  public boolean b(int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 35	bbav:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   4: astore_3
    //   5: aload_3
    //   6: monitorenter
    //   7: iload_1
    ...
    //   14: ireturn
    //   15: aload_0
    //   16: invokevirtual 82	bbav:a	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;
    //   19: astore 4
    //   21: aload 4
    //   23: ifnonnull +7 -> 30
    //   26: aload_3
    ...
    //   85: if_icmpne -31 -> 54
    //   88: aload 5
    //   90: getfield 1273	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedInfo:flag	Lcom/tencent/mobileqq/pb/PBBoolField;
    //   93: invokevirtual 679	com/tencent/mobileqq/pb/PBBoolField:get	()Z
    //   96: istore_2
    //   97: aload_3
    //   98: monitorexit
    //   99: iload_2
