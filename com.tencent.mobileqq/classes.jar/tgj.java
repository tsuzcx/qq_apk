  ...
  extends XBaseAdapter
{
  ...
  public tgj(QQLSActivity paramQQLSActivity) {}
  ...
  private View b(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView != null)
    {
      ...
      if (!(paramViewGroup instanceof tgn)) {}
    }
    for (paramViewGroup = (tgn)paramViewGroup;; paramViewGroup = null)
    {
      ...
      {
        paramView = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getLayoutInflater().inflate(2130970369, null);
        localObject = new tgn();
        ((tgn)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370281));
        ((tgn)localObject).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView = ((DragTextView)paramView.findViewById(2131370285));
        ((tgn)localObject).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setOnModeChangeListener(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout);
        ((tgn)localObject).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setDragViewType(0);
        paramView.setTag(localObject);
      }
      ((tgn)localObject).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setTag(Integer.valueOf(paramInt));
      ((tgn)localObject).jdField_a_of_type_AndroidWidgetTextView.setText(localRecentBaseData.b);
      ((tgn)localObject).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(0);
      CustomWidgetUtil.a(((tgn)localObject).jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView, 3, 1, 0);
      return paramView;
    }
  }
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      ...
      if ((paramView.getTag() instanceof tgk)) {}
    }
    else
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getLayoutInflater().inflate(2130970370, null);
      paramView = new tgk();
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131370281));
      paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131370282));
      paramView.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView = ((DragTextView)((View)localObject1).findViewById(2131370285));
    ...
    tgk localtgk = (tgk)((View)localObject1).getTag();
    localtgk.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setTag(Integer.valueOf(paramInt));
    int i = 0;
    ...
    for (;;)
    {
      ...
      if ((((RecentBaseData)localObject3).a() == 0) || (((RecentBaseData)localObject3).a() == 3000) || (((RecentBaseData)localObject3).a() == 8)) {
        if (j > 0)
        {
          ...
          if ((paramView == null) || (paramView.size() <= 0))
          {
            ...
            localtgk.jdField_a_of_type_AndroidWidgetTextView.setText(((RecentBaseData)localObject3).b);
            localtgk.jdField_b_of_type_AndroidWidgetTextView.setText(((RecentBaseData)localObject3).jdField_c_of_type_JavaLangString);
            ...
            localtgk.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(4);
            if ((((RecentBaseData)localObject3).a().equals(AppConstants.ad)) || (((RecentBaseData)localObject3).a().equals(AppConstants.ac))) {
              localtgk.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(8);
            }
            ...
            localtgk.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout = paramView;
            if ((paramViewGroup instanceof MessageForPtt))
            {
              ...
              ((TextView)((View)localObject1).findViewById(2131370297)).setText(paramView);
              localObject3 = (ViewGroup.MarginLayoutParams)localtgk.jdField_a_of_type_ComTencentMobileqqActivityAioItemBreathAnimationLayout.getLayoutParams();
              if (paramView.equals("")) {
                break label1563;
              }
              ...
              if (j == -1)
              {
                this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.a(localtgk, (MessageForPtt)localObject2, false, true);
                i = 2001;
              }
              if (QLog.isColorLevel()) {
                QLog.d("PTTItem->getBubbleView", 2, "fileStatus = " + i + " url " + ((MessageForPtt)localObject2).url + " uniseq " + ((MessageForPtt)localObject2).uniseq);
              }
              this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.a(localtgk, (MessageForPtt)localObject2, i, this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.a((ChatMessage)localObject2));
              ...
              if ((QQLSActivity.b()) && (localtgk.jdField_a_of_type_JavaLangStringBuilder == null)) {
                localtgk.jdField_a_of_type_JavaLangStringBuilder = new StringBuilder();
              }
              localtgk.jdField_b_of_type_Int = paramInt;
              localtgk.jdField_c_of_type_Int = paramInt;
              if (QQLSActivity.b())
              {
                localtgk.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.setContentDescription(null);
                if (!TextUtils.isEmpty(localtgk.jdField_a_of_type_JavaLangStringBuilder)) {
                  localtgk.jdField_a_of_type_JavaLangStringBuilder.replace(0, localtgk.jdField_a_of_type_JavaLangStringBuilder.length(), "");
                }
      ...
      try
      {
        ...
        localtgk.jdField_a_of_type_JavaLangStringBuilder.append(paramView).append(" ");
        localtgk.jdField_a_of_type_ComTencentMobileqqDataChatMessage = ((ChatMessage)paramViewGroup);
        ...
        if ((((RecentBaseData)localObject3).a() == 1001) || (((RecentBaseData)localObject3).a() == 1010) || (((RecentBaseData)localObject3).a() == 10002))
        {
          ...
          {
            ((RecentBaseData)localObject3).b = BaseApplicationImpl.getApplication().getString(2131437959);
            this.jdField_a_of_type_JavaLangCharSequence = BaseApplicationImpl.getApplication().getString(2131437960);
          ...
          {
            ((RecentBaseData)localObject3).b = BaseApplicationImpl.getApplication().getString(2131437961);
            this.jdField_a_of_type_JavaLangCharSequence = BaseApplicationImpl.getApplication().getString(2131437962);
        ...
        break label398;
        label1536:
        localtgk.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(0);
        CustomWidgetUtil.a(localtgk.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView, 3, j + i, 0);
        break label464;
        label1563:
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      ...
      if ((paramView.getTag() instanceof tgm)) {}
    }
    else
    {
      paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getLayoutInflater().inflate(2130970368, null);
      paramView = new tgm();
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131370281));
      paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131370299));
      paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131370282));
      paramView.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView = ((DragTextView)paramViewGroup.findViewById(2131370285));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131370298));
      paramViewGroup.setTag(paramView);
      paramView.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setOnModeChangeListener(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout);
      paramView.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setDragViewType(0);
    }
    RecentBaseData localRecentBaseData = (RecentBaseData)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    tgm localtgm = (tgm)paramViewGroup.getTag();
    localtgm.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setTag(Integer.valueOf(paramInt));
    paramInt = 0;
    int j = 0;
    ...
    if (paramInt != 0)
    {
      ...
      localtgm.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      ...
      localtgm.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-4210755);
      if (QLog.isColorLevel()) {
        QLog.d("QQLSActivity", 2, "recentList misscallMsg size = 0");
      }
      label425:
      localtgm.jdField_c_of_type_AndroidWidgetTextView.setText(localRecentBaseData.jdField_c_of_type_JavaLangString);
    }
    label490:
    label503:
    Object localObject;
    for (;;)
    {
      ...
      localtgm.jdField_a_of_type_AndroidWidgetTextView.setText(localRecentBaseData.b);
      localtgm.jdField_b_of_type_AndroidWidgetTextView.setText(new QQText(this.jdField_a_of_type_JavaLangCharSequence, 5, 16, localRecentBaseData.a()));
      localtgm.jdField_c_of_type_AndroidWidgetTextView.setText(localRecentBaseData.jdField_c_of_type_JavaLangString);
      ...
      localtgm.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(4);
      label716:
      ...
      localtgm.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(8);
      ...
      this.jdField_a_of_type_JavaLangCharSequence = ((MessageRecord)paramView.get(paramView.size() - 1)).msg;
      localtgm.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-570319);
      break label425;
      label1019:
      localtgm.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
    ...
    if ((localRecentBaseData.a() == 1001) || (localRecentBaseData.a() == 1010) || (localRecentBaseData.a() == 10002))
    {
      if (localRecentBaseData.a().equals(AppConstants.ad))
      {
        localRecentBaseData.b = BaseApplicationImpl.getApplication().getString(2131437959);
        this.jdField_a_of_type_JavaLangCharSequence = BaseApplicationImpl.getApplication().getString(2131437960);
        paramView = DeviceProfileManager.a().a(DeviceProfileManager.DpcNames.OneyWayDateMsgNotifyCfg.name());
        if (paramView.length() > 0)
        {
      ...
      for (;;)
      {
        ...
        if (localRecentBaseData.a().equals(AppConstants.ac))
        {
          localRecentBaseData.b = BaseApplicationImpl.getApplication().getString(2131437961);
          this.jdField_a_of_type_JavaLangCharSequence = BaseApplicationImpl.getApplication().getString(2131437962);
          paramView = DeviceProfileManager.a().a(DeviceProfileManager.DpcNames.OneyWayLBSFriendMsgNotifyCfg.name());
          if (paramView.length() > 0)
          {
        ...
        else
        {
          ...
          if (localMessage.msgtype == -2053)
          {
            ...
            this.jdField_a_of_type_JavaLangCharSequence = (this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getString(2131437845) + (String)localObject + paramView.msg);
          }
          else
          {
    ...
    for (paramView = PublicAccountConfigUtil.a(QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity), BaseApplicationImpl.getContext()) + ":";; paramView = "")
    {
      ...
      break label503;
      label1809:
      localtgm.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.setVisibility(0);
      CustomWidgetUtil.a(localtgm.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView, 3, j + i, 0);
      break label716;
      label1836:
      break label640;
      label1839:
