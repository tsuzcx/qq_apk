...
public class agwb
{
  ...
  public static void a(LaunchParam paramLaunchParam, int paramInt, OnUpdateListener paramOnUpdateListener)
  {
    ...
    localBundle.putParcelable("receiver", agph.a(new ComIPCUtils.1(null, paramOnUpdateListener)));
    QIPCClientHelper.getInstance().callServer("QWalletIPCModule", "ComIPCUtils", localBundle, null);
  }
  ...
  public static void a(String paramString, agmu paramagmu)
  {
    if (paramagmu == null) {
      return;
    }
    ...
    localBundle.putInt("code", paramagmu.hashCode());
    localBundle.putParcelable("receiver", agph.a(new ComIPCUtils.2(null, paramagmu, paramString)));
    QIPCClientHelper.getInstance().callServer("QWalletIPCModule", "ComIPCUtils", localBundle, null);
  }
  ...
  public static void b(String paramString, agmu paramagmu)
  {
    if (paramagmu == null) {
      return;
    }
