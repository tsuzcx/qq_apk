...
public class adnf
  extends amrc
{
  private adnf(JoinDiscussionActivity paramJoinDiscussionActivity) {}
  ...
  protected void onDecodeFlyTicket(boolean paramBoolean, String paramString)
  {
    if (paramBoolean)
    {
      ...
      this.a.jdField_a_of_type_Amqx.c(this.a.jdField_a_of_type_JavaLangString);
      return;
    }
    this.a.a(0, -161);
  }
  ...
  protected void onGetDiscussionInfoByFlyTicket(boolean paramBoolean, int paramInt, RespGetDiscussInfo paramRespGetDiscussInfo)
  {
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        if (((Iterator)localObject3).hasNext())
        {
          ...
          for (;;)
          {
            ...
            {
              localObject2 = ((amsw)this.a.app.getManager(51)).b(((DiscussionMemberInfo)localObject1).memberUin);
      ...
      if (TextUtils.isEmpty(this.a.e)) {
        ((FriendListHandler)this.a.app.getBusinessHandler(1)).getFriendInfo(this.a.jdField_a_of_type_Long + "", false);
      }
      return;
    }
    this.a.a(0, paramInt);
  ...
  protected void onJoinDiscussionByFlyTicket(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      bcef.b(this.a.app, "CliOper", "", this.a.app.getCurrentAccountUin(), "discuss", "discuss_QR_join", 0, 0, "", "", "", "");
      this.a.stopTitleProgress();
    ...
    {
      if (paramInt != 0) {
        QQToast.a(this.a, amtj.a(2131705005), 0).b(this.a.getTitleBarHeight());
      }
