...
public class bkcl
{
  ...
  private HashMap<Integer, List<bkcn>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  
  public bkcl(bkcc parambkcc, bkbr parambkbr)
  {
    this.jdField_a_of_type_Bkcc = parambkcc;
    this.jdField_a_of_type_Bkbr = parambkbr;
    this.jdField_a_of_type_Bkcc.a(new bkcm(this));
  }
  
  private bkcn a(byte[] paramArrayOfByte)
  {
    int j = -1;
    boolean bool = true;
    int i;
    ...
    for (;;)
    {
      ...
      if ((i == 0) || (i == QSecFramework.a().a()))
      {
        ...
        for (;;)
        {
          if ((TextUtils.isEmpty(paramArrayOfByte)) || (paramArrayOfByte.equalsIgnoreCase(bkab.c())))
          {
            paramArrayOfByte = new bkcn(null);
  ...
  private void a(bkcn parambkcn)
  {
    if (parambkcn.jdField_a_of_type_Int == 0)
    {
      c(parambkcn);
      return;
    }
  ...
  private void b(bkcn parambkcn)
  {
    int i = this.jdField_a_of_type_Bkcc.a(parambkcn.jdField_a_of_type_Int, parambkcn.b, parambkcn.c, new Object[] { parambkcn.jdField_a_of_type_ArrayOfByte }, null);
    if (((i == 17) || (i == 7) || (i == 4)) && (parambkcn.jdField_a_of_type_Boolean)) {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_Int < 50)
        {
          List localList = (List)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(parambkcn.jdField_a_of_type_Int));
          Object localObject1 = localList;
          if (localList == null)
          {
            localObject1 = new LinkedList();
            this.jdField_a_of_type_JavaUtilHashMap.put(Integer.valueOf(parambkcn.jdField_a_of_type_Int), localObject1);
          }
          ((List)localObject1).add(parambkcn);
  ...
  private void c(bkcn parambkcn)
  {
    ...
    do
    {
      ...
      {
        return;
        this.jdField_a_of_type_Bkbr.a(true);
        return;
        try
        {
          parambkcn = (QQAppInterface)BaseApplicationImpl.sMobileQQ.waitAppRuntime(null);
          if (parambkcn != null)
          {
            ((bkda)parambkcn.getManager(194)).b(0);
            return;
          }
        }
        catch (Exception parambkcn)
        {
          return;
        }
      }
      parambkcn = parambkcn.jdField_a_of_type_ArrayOfByte;
    } while (!bkbc.a().a(parambkcn));
    bkbc.a().a();
  }
