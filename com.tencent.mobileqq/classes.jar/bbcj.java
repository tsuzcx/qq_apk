...
public class bbcj
{
  private static final String jdField_a_of_type_JavaLangString = bbcj.class.getSimpleName();
  ...
  private void b()
  {
    ...
    Collections.sort((List)localObject1, new bbck(this));
    label176:
  ...
  public int a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    catch (Throwable localThrowable)
    {
      ...
      if (((anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).b(paramString))
      {
        b(paramString);
        return 1;
      }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 251	bbcj:jdField_a_of_type_Boolean	Z
    //   6: istore 6
    //   8: iload 6
    //   10: ifne +199 -> 209
    //   13: aload_1
    //   14: ifnull +15 -> 29
    //   17: aload_0
    //   18: new 244	java/lang/ref/WeakReference
    //   21: dup
    //   22: aload_1
    //   23: invokespecial 254	java/lang/ref/WeakReference:<init>	(Ljava/lang/Object;)V
    //   26: putfield 229	bbcj:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    //   29: aload_0
    //   30: invokevirtual 71	bbcj:a	()Landroid/content/SharedPreferences;
    //   33: astore_1
    //   34: aload_1
    //   35: ifnonnull +64 -> 99
    //   38: aconst_null
    ...
    //   41: ifnull +187 -> 228
    //   44: aload_1
    //   45: invokevirtual 178	java/lang/String:length	()I
    //   48: ifle +180 -> 228
    //   51: aload_1
    //   52: ldc 136
    ...
    //   84: ifnull +189 -> 273
    //   87: aload 11
    //   89: invokevirtual 178	java/lang/String:length	()I
    //   92: iconst_3
    //   93: if_icmpge +21 -> 114
    //   96: goto +177 -> 273
    //   99: aload_1
    ...
    //   125: ifle +148 -> 273
    //   128: aload 11
    //   130: invokevirtual 178	java/lang/String:length	()I
    //   133: istore 5
    //   135: iload 4
    //   137: iload 5
    //   139: iconst_1
    ...
    //   170: ifnull +103 -> 273
    //   173: aload 9
    //   175: invokevirtual 178	java/lang/String:length	()I
    //   178: ifle +95 -> 273
    //   181: aload_0
    //   182: getfield 41	bbcj:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   185: aload 9
    //   187: lload 7
    //   189: invokestatic 191	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   192: invokevirtual 283	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   195: pop
    //   196: goto +77 -> 273
    //   199: astore_1
    //   200: aload_1
    //   201: invokevirtual 117	java/lang/Throwable:printStackTrace	()V
    //   204: aload_0
    //   205: iconst_1
    //   206: putfield 251	bbcj:jdField_a_of_type_Boolean	Z
    //   209: aload_0
    //   210: monitorexit
    //   211: return
    //   212: astore 9
    //   214: aload 9
    //   216: invokevirtual 117	java/lang/Throwable:printStackTrace	()V
    //   219: lconst_0
    //   220: lstore 7
    //   222: aconst_null
    //   223: astore 9
    //   225: goto -57 -> 168
    //   228: invokestatic 62	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   231: ifeq -27 -> 204
    //   234: getstatic 24	bbcj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   237: iconst_2
    //   238: ldc_w 285
    //   241: iconst_2
    ...
    //   250: iconst_1
    //   251: aload_0
    //   252: getfield 41	bbcj:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   255: invokevirtual 286	java/util/concurrent/ConcurrentHashMap:toString	()Ljava/lang/String;
    //   258: aastore
    //   259: invokestatic 176	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   262: invokestatic 68	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   265: goto -61 -> 204
    //   268: astore_1
    //   269: aload_0
    //   270: monitorexit
