...
public class atcg
{
  ...
  public static ArrayList<atce> a()
  {
    int i = 0;
    ArrayList localArrayList = new ArrayList();
    Object localObject1 = BaseApplicationImpl.getApplication().getRuntime();
    Object localObject2 = (String)asfc.a(((AppRuntime)localObject1).getAccount(), "key_nearby_publish_menu", "");
    if (!TextUtils.isEmpty((String)asfc.a(((AppRuntime)localObject1).getAccount(), "cike_guide_content", ""))) {}
      ...
      for (;;)
      {
        try
        {
          ...
          if (i < ((JSONArray)localObject1).length())
          {
            ...
            atce localatce2 = new atce();
            localatce2.jdField_a_of_type_Int = ((JSONObject)localObject2).optInt("id");
            if ((!bool) && (localatce2.jdField_a_of_type_Int != 1) && (localatce2.jdField_a_of_type_Int != 2)) {
              break label337;
            }
            localatce2.jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("icon");
            localatce2.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("title");
            localatce2.c = ((JSONObject)localObject2).optString("subTitle");
            localatce2.d = ((JSONObject)localObject2).optString("jumpUrl");
            localArrayList.add(localatce2);
          }
        }
        catch (Exception localException)
        {
          ...
          {
            atce localatce1 = new atce();
            localatce1.jdField_a_of_type_Int = 1;
            localatce1.jdField_b_of_type_Int = 2130840895;
            localatce1.jdField_b_of_type_JavaLangString = ajjy.a(2131641588);
            localArrayList.add(localatce1);
            localatce1 = new atce();
            localatce1.jdField_a_of_type_Int = 2;
            localatce1.jdField_b_of_type_Int = 2130840894;
            localatce1.jdField_b_of_type_JavaLangString = ajjy.a(2131641589);
            localArrayList.add(localatce1);
          }
  ...
  public static void a(Context paramContext, atce paramatce, String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyPublishMenuHelper", 2, "handleMenuItemClick：id=" + paramatce.jdField_a_of_type_Int);
    }
    switch (paramatce.jdField_a_of_type_Int)
    {
    default: 
      a(paramContext, paramatce.d);
      return;
    case 1: 
      a(paramContext);
      return;
  ...
  {
    ascn localascn = ascn.a(paramContext, BaseApplicationImpl.getApplication().getRuntime().getAccount(), 0);
    if (localascn != null)
    {
      if (ascn.a(paramContext))
      {
        a(paramContext, localascn.d);
        return;
      }
      localascn.f = a(paramString1, paramString2);
      paramContext = new atbx(paramContext);
      paramContext.a(localascn);
      paramContext.show();
      return;
    }
  ...
  {
    new awrb(null).a("dc00899").b("grp_lbs").c(paramString1).d(paramString2).a();
  }
  ...
  protected static void b(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      {
        bbmy.a(paramContext, 2131653216, 0).a();
        if (QLog.isColorLevel()) {
      ...
      {
        String str = ajed.aU + "photo/" + System.currentTimeMillis() + ".jpg";
        ...
        for (localObject1 = (AppActivity)paramContext;; localObject2 = null)
        {
          ...
          if ((Build.VERSION.SDK_INT >= 23) && (((AppActivity)localObject1).checkSelfPermission("android.permission.CAMERA") != 0))
          {
            ...
            ((AppActivity)localObject1).requestPermissions(new atch(paramContext, str, (AppActivity)localObject1, localIntent), 1, new String[] { "android.permission.CAMERA" });
          }
          for (int i = 1;; i = 0) {
            for (;;)
            {
              ...
              catch (Exception localException)
              {
                ...
                bbmy.a(paramContext, 2131625032, 0).a();
                return;
              }
            }
          }
  ...
  {
    bbms localbbms = new bbms(paramContext, paramContext.getResources().getDimensionPixelSize(2131167766));
    localbbms.c(2131628457);
    ThreadManager.post(new NearbyPublishMenuHelper.2(localbbms, paramString2, paramContext, paramString1), 5, null, true);
  }
  ...
  public static void b(String paramString1, String paramString2)
  {
    ...
    //   63: aload_0
    //   64: invokevirtual 558	com/tencent/common/app/BaseApplicationImpl:deleteFile	(Ljava/lang/String;)Z
    //   67: pop
    //   68: iconst_0
    //   69: ifeq +11 -> 80
    ...
    //   107: aload_0
    //   108: iconst_0
    //   109: invokevirtual 562	com/tencent/common/app/BaseApplicationImpl:openFileOutput	(Ljava/lang/String;I)Ljava/io/FileOutputStream;
    //   112: astore_0
    //   113: aload_0
    //   114: astore 5
    //   116: aload_0
    ...
    //   119: aload_0
    //   120: aload_1
    //   121: invokevirtual 566	java/lang/String:getBytes	()[B
    //   124: invokevirtual 571	java/io/FileOutputStream:write	([B)V
    //   127: aload_0
    //   128: astore 5
    //   130: aload_0
    //   131: astore 4
    //   133: aload_0
    //   134: invokevirtual 574	java/io/FileOutputStream:flush	()V
    //   137: aload_0
    //   138: astore 5
    //   140: aload_0
    //   141: astore 4
    ...
    //   172: aload_1
    //   173: invokevirtual 577	java/lang/String:length	()I
    ...
    //   186: ifnull -106 -> 80
    //   189: aload_0
    //   190: invokevirtual 578	java/io/FileOutputStream:close	()V
    //   193: goto -113 -> 80
    //   196: astore_0
    //   197: goto -117 -> 80
    //   200: astore_0
    ...
    //   236: ifnull -156 -> 80
    //   239: aload 5
    //   241: invokevirtual 578	java/io/FileOutputStream:close	()V
    //   244: goto -164 -> 80
    //   247: astore_0
    //   248: goto -168 -> 80
    //   251: astore_0
    ...
    //   254: ifnull +8 -> 262
    //   257: aload 4
    //   259: invokevirtual 578	java/io/FileOutputStream:close	()V
    //   262: aload_0
    //   263: athrow
    //   264: astore_0
    //   265: ldc 2
