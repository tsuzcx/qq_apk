...
public class ajus
  extends anyu
{
  private ajus(FriendFragment paramFriendFragment) {}
    ...
    if ((paramBoolean) && (this.a.isResumed())) {
      try
      {
        ...
        if ((paramArrayOfObject != null) && (paramArrayOfObject.length > 0))
        {
          ...
          {
            QQToast.a(this.a.getActivity(), 2, anzj.a(2131703762), 0).a();
            return;
          }
          QQToast.a(this.a.getActivity(), 2, anzj.a(2131703763), 0).a();
          return;
        }
      }
