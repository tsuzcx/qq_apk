...
public class ajus
  extends ajum
{
  public ajus(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(int paramInt, short paramShort, MsgType0x210SubMsgType0x13 paramMsgType0x210SubMsgType0x13)
  {
    ...
    do
    {
      ...
      {
        localawyv = new awyv(Long.valueOf(paramMsgType0x210SubMsgType0x13.uint32_size), Long.valueOf(paramMsgType0x210SubMsgType0x13.uint64_sessionid));
        this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramMsgType0x210SubMsgType0x13.uint64_sessionid), localawyv);
      }
      for (;;)
      {
        ...
        localawyv = (awyv)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramMsgType0x210SubMsgType0x13.uint64_sessionid));
      }
      localawyv.a((int)paramMsgType0x210SubMsgType0x13.uint32_index, (String)localObject);
    } while (!localawyv.a());
    ...
    ((DataLineMsgRecord)localObject).msg = localawyv.a();
    ...
    a(8, true, new Object[] { Integer.valueOf(paramInt), localawyv.a(), Long.valueOf(((DataLineMsgRecord)localObject).sessionid) });
  }
  ...
  public void a(msf.msgcomm.msg_comm.Msg paramMsg)
  {
    ...
    //   0: aload_0
    //   1: aload_1
    //   2: invokespecial 204	ajum:a	(Lmsf/msgcomm/msg_comm$Msg;)V
    ...
    //   158: aload_3
    //   159: iconst_1
    //   160: invokevirtual 274	ajus:a	(Lcom/tencent/mobileqq/data/DataLineMsgRecord;I)Z
    //   163: ifeq +78 -> 241
    ...
    //   238: goto -196 -> 42
    //   241: aload_0
    //   242: getfield 171	ajus:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   245: bipush 10
    //   247: invokevirtual 292	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   250: checkcast 294	akfl
    //   253: astore_1
    //   254: aload_1
    //   255: ifnull +16 -> 271
    //   258: aload_1
    //   259: invokevirtual 296	akfl:d	()I
    //   262: iconst_1
    //   263: if_icmpeq +8 -> 271
    //   266: aload_1
    //   267: iconst_1
    //   268: invokevirtual 299	akfl:e	(I)V
    //   271: aload_2
    ...
    //   298: l2i
    //   299: invokevirtual 317	ajus:a	(II)Z
    //   302: ifne -82 -> 220
    //   305: aload_0
    //   306: aload_2
    ...
    //   321: l2i
    //   322: invokevirtual 325	ajus:b	(II)Z
    //   325: ifeq -105 -> 220
    //   328: aload_0
    //   329: aload_3
    ...
    //   344: invokespecial 327	ajus:a	(ISLIMMsgBodyPack/MsgType0x210SubMsgType0x13;)V
    //   347: return
    //   348: aload_2
    ...
    //   375: l2i
    //   376: invokevirtual 317	ajus:a	(II)Z
    //   379: ifne -159 -> 220
    //   382: aload_0
    //   383: aload_2
    ...
    //   398: l2i
    //   399: invokevirtual 325	ajus:b	(II)Z
    //   402: ifeq -182 -> 220
    //   405: aload_0
    //   406: getfield 350	ajus:jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper	Lcom/tencent/litetransfersdk/ProtocolHelper;
    //   409: aload_2
    ...
    //   504: astore_1
    //   505: aload_0
    //   506: getfield 383	ajus:jdField_a_of_type_ComTencentLitetransfersdkLiteTransferWrapper	Lcom/tencent/litetransfersdk/LiteTransferWrapper;
    //   509: aload_1
    ...
    //   544: l2i
    //   545: invokevirtual 317	ajus:a	(II)Z
    //   548: ifne -328 -> 220
    //   551: aload_0
    //   552: aload_2
    ...
    //   567: l2i
    //   568: invokevirtual 325	ajus:b	(II)Z
    //   571: ifeq -351 -> 220
    //   574: aload_0
    //   575: getfield 350	ajus:jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper	Lcom/tencent/litetransfersdk/ProtocolHelper;
    //   578: aload_2
    ...
    //   687: astore_1
    //   688: aload_0
    //   689: getfield 383	ajus:jdField_a_of_type_ComTencentLitetransfersdkLiteTransferWrapper	Lcom/tencent/litetransfersdk/LiteTransferWrapper;
    //   692: aload_1
    ...
    //   724: l2i
    //   725: invokevirtual 317	ajus:a	(II)Z
    //   728: ifne -508 -> 220
    //   731: aload_0
    //   732: aload_2
    ...
    //   747: l2i
    //   748: invokevirtual 325	ajus:b	(II)Z
    //   751: ifeq -531 -> 220
    //   754: aload_0
    //   755: getfield 350	ajus:jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper	Lcom/tencent/litetransfersdk/ProtocolHelper;
    //   758: aload_2
    ...
    //   787: astore_1
    //   788: aload_0
    //   789: getfield 383	ajus:jdField_a_of_type_ComTencentLitetransfersdkLiteTransferWrapper	Lcom/tencent/litetransfersdk/LiteTransferWrapper;
    //   792: aload_1
