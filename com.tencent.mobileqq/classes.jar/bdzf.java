  ...
  implements Animation.AnimationListener
{
  ...
  protected static final int m = (int)BaseApplicationImpl.getApplication().getResources().getDimension(2131297518);
  protected float a;
  protected Handler a;
  ...
  public bdzf()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bdzg(this);
  }
  ...
  private void a(TextView paramTextView, int paramInt)
  {
    ...
    if (paramInt == e)
    {
      paramTextView.setText(2131697074);
      paramTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130842385, 0);
    ...
    bfwr.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (QQMessageFacade.Message)localObject, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, localMsgSummary, ((QQMessageFacade.Message)localObject).nickName, false, false);
