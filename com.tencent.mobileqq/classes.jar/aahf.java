  ...
  extends ntf
{
  ...
  public abstract void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, int paramInt3, ByteStringMicro paramByteStringMicro, List<bfif> paramList, Bundle paramBundle);
  ...
  protected void b(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    while (((Iterator)localObject2).hasNext()) {
      ((List)localObject1).add(new bfif((oidb_0x6d8.GetFileListRspBody.Item)((Iterator)localObject2).next()));
    }
