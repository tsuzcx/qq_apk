...
public class zlt
{
  public static Intent a(Intent paramIntent, Bundle paramBundle, Activity paramActivity)
  {
    ...
    {
      paramIntent.putExtra("qq_camera_scheme", bqcc.a(paramBundle.getString("widgetinfo")));
      ...
      bnzb.b("StoryIntentUtils", "passStoryRecordExtrasToIntent---takeSameName=" + (String)localObject);
    ...
    for (;;)
    {
      ...
      if ((paramActivity instanceof QIMCameraCaptureActivity))
      {
        ...
        if ((localObject != null) && (((ViewGroup)localObject).findViewById(2131380622) != null))
        {
          localObject = (LinkerSummaryView)((ViewGroup)localObject).findViewById(2131380622);
          if ((localObject == null) || (((LinkerSummaryView)localObject).jdField_a_of_type_Bpqt == null)) {
            break;
          }
          paramIntent.putExtra("share_url_target_url", ((LinkerSummaryView)localObject).jdField_a_of_type_Bpqt.jdField_a_of_type_JavaLangString);
          paramIntent.putExtra("share_url_name", ((LinkerSummaryView)localObject).jdField_a_of_type_Bpqt.b);
          paramIntent.putExtra("share_url_text", ((LinkerSummaryView)localObject).jdField_a_of_type_Bpqt.c);
          paramIntent.putExtra("share_url_thumb_url", ((LinkerSummaryView)localObject).jdField_a_of_type_Bpqt.d);
