  ...
  extends odq
{
  ...
  public rsc(VideoFeedsRecommendFragment paramVideoFeedsRecommendFragment, boolean paramBoolean)
  {
  ...
  private void a()
  {
    rnu localrnu = VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment);
  ...
  private void a(Bundle paramBundle, int paramInt, VideoInfo paramVideoInfo1, VideoInfo paramVideoInfo2)
  {
    if ((paramVideoInfo1 != null) && (!this.jdField_a_of_type_Boolean) && (paramVideoInfo2 != null))
    {
      ...
      if ((paramInt == 1) && (VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment) != null)) {
        VideoFeedsPlayActivity.a(anzj.a(2131714929) + paramVideoInfo1.b());
      }
  ...
  private void a(VideoInfo paramVideoInfo1, VideoInfo paramVideoInfo2, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      paramVideoInfo2.jdField_b_of_type_Long = ucc.a.a(paramVideoInfo2.jdField_b_of_type_Long, paramVideoInfo1.jdField_b_of_type_Long);
      ...
      paramVideoInfo2.jdField_b_of_type_Int = ucc.a.a(paramVideoInfo2.jdField_b_of_type_Int, paramVideoInfo1.jdField_b_of_type_Int);
      paramVideoInfo2.jdField_c_of_type_Int = ucc.a.a(paramVideoInfo2.jdField_c_of_type_Int, paramVideoInfo1.jdField_c_of_type_Int);
      paramVideoInfo2.jdField_d_of_type_Int = ucc.a.a(paramVideoInfo2.jdField_d_of_type_Int, paramVideoInfo1.jdField_d_of_type_Int);
      paramVideoInfo2.q = ucc.a.a(paramVideoInfo2.q, paramVideoInfo1.q);
      paramVideoInfo2.jdField_r_of_type_Int = ucc.a.a(paramVideoInfo2.jdField_r_of_type_Int, paramVideoInfo1.jdField_r_of_type_Int);
      paramVideoInfo2.jdField_i_of_type_JavaLangString = paramVideoInfo1.jdField_i_of_type_JavaLangString;
      paramVideoInfo2.k = ucc.a.a(paramVideoInfo2.k, paramVideoInfo1.k);
      paramVideoInfo2.j = ucc.a.a(paramVideoInfo2.j, paramVideoInfo1.j);
      paramVideoInfo2.g = ucc.a.a(paramVideoInfo2.g, paramVideoInfo1.g);
      ...
      paramVideoInfo2.jdField_f_of_type_JavaLangString = ucc.a.a(paramVideoInfo2.jdField_f_of_type_JavaLangString, paramVideoInfo1.jdField_f_of_type_JavaLangString);
      paramVideoInfo2.jdField_d_of_type_JavaLangString = ucc.a.a(paramVideoInfo2.jdField_d_of_type_JavaLangString, paramVideoInfo1.jdField_d_of_type_JavaLangString);
      paramVideoInfo2.jdField_c_of_type_JavaLangString = ucc.a.a(paramVideoInfo2.jdField_c_of_type_JavaLangString, paramVideoInfo1.jdField_c_of_type_JavaLangString);
      paramVideoInfo2.jdField_p_of_type_JavaLangString = ucc.a.a(paramVideoInfo2.jdField_p_of_type_JavaLangString, paramVideoInfo1.jdField_p_of_type_JavaLangString);
      paramVideoInfo2.o = ucc.a.a(paramVideoInfo2.o, paramVideoInfo1.o);
      paramVideoInfo2.jdField_r_of_type_JavaLangString = ucc.a.a(paramVideoInfo2.jdField_r_of_type_JavaLangString, paramVideoInfo1.jdField_r_of_type_JavaLangString);
      paramVideoInfo2.h = ucc.a.a(paramVideoInfo2.h, paramVideoInfo1.h);
      if (!paramVideoInfo2.jdField_b_of_type_Boolean) {
        paramVideoInfo2.n = paramVideoInfo1.n;
      }
      paramVideoInfo2.jdField_b_of_type_JavaLangString = ucc.a.a(paramVideoInfo1.jdField_b_of_type_JavaLangString, paramVideoInfo2.jdField_b_of_type_JavaLangString);
      paramVideoInfo2.x = ucc.a.a(paramVideoInfo1.x, paramVideoInfo2.x);
      paramVideoInfo2.y = ucc.a.a(paramVideoInfo1.y, paramVideoInfo2.y);
      if (VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment) != null) {
    ...
    if (localIterator.hasNext())
    {
      ...
      for (;;)
      {
        ...
        if ((localVideoInfo.jdField_b_of_type_Boolean) && (TextUtils.isEmpty(localVideoInfo.k))) {
          localVideoInfo.k = bhlg.b(VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment), localVideoInfo.j, true);
        }
  ...
  private void b(Bundle paramBundle)
  {
    ...
    for (VideoInfo localVideoInfo1 = (VideoInfo)VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment).get(0);; localVideoInfo1 = null)
    {
      ...
      if ((trd.jdField_a_of_type_Int != 1) && (VideoFeedsRecommendFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsRecommendFragment) != null)) {
  ...
  {
    VideoFeedsPlayActivity.a(anzj.a(2131714993) + "isSuccess = " + paramBoolean);
