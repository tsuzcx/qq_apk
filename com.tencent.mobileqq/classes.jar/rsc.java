...
public final class rsc
  implements Runnable
{
  public rsc(QQAppInterface paramQQAppInterface, Emoticon paramEmoticon, Context paramContext, SessionInfo paramSessionInfo, EmojiStickerManager.StickerInfo paramStickerInfo) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      localObject1 = new rsd(this, (MessageForMarketFace)localObject2, (EmoticonPackage)localObject1);
