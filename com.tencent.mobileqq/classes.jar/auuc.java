...
public class auuc
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 101, 2130844992 };
    jdField_b_of_type_ArrayOfInt = new int[] { 102, 2130844995 };
    jdField_c_of_type_ArrayOfInt = new int[] { 103, 2130844991 };
    jdField_d_of_type_ArrayOfInt = new int[] { 104, 2130844998 };
  }
  
  public auuc(int paramInt)
  {
