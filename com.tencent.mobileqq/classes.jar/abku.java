  ...
  extends abib
{
  ...
  private ArrayList<abic> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private ConcurrentHashMap<Long, abid> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(20);
  
  public abku(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(MessageForDeviceFile paramMessageForDeviceFile)
  {
    ...
    {
      Object localObject = (abic)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((abic)localObject).a();
      localObject = ((abic)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((arug)localObject).a(localView, paramMessageForDeviceFile);
      }
      for (;;)
      {
        i += 1;
  ...
  {
    paramLong = (abid)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramLong);
    if (paramLong == null) {
      return null;
    }
  ...
  public MessageForDeviceFile a(String paramString, MessageForDeviceFile paramMessageForDeviceFile)
  {
    ...
    MessageForDeviceFile localMessageForDeviceFile = (MessageForDeviceFile)bcsa.a(paramMessageForDeviceFile);
    if ("device_groupchat".equals(paramMessageForDeviceFile.extStr))
    {
      ...
      localMessageForDeviceFile.srcFileName = auea.a(localMessageForDeviceFile.filePath);
      localMessageForDeviceFile.fileSize = auea.a(localMessageForDeviceFile.filePath);
      localMessageForDeviceFile.msgStatus = 2;
      localMessageForDeviceFile.nFileStatus = 1;
      localMessageForDeviceFile.progress = 0.0F;
      ((aocy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER)).a(localMessageForDeviceFile);
      ...
      paramString = bheg.a(BaseApplication.getContext(), Uri.parse(localMessageForDeviceFile.filePath));
      bheg.a(BaseApplication.getContext(), localMessageForDeviceFile.filePath, paramString, 160, 160);
      ahzx.a(((abgm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(Long.parseLong(localMessageForDeviceFile.frienduin), localMessageForDeviceFile.filePath, paramString), localMessageForDeviceFile);
    ...
    localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691527);
    if (paramString.compareTo(abkw.d) == 0)
    {
      localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691528);
      label363:
      ((aocy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER)).a(localMessageForDeviceFile);
      paramMessageForDeviceFile = (abgm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER);
    ...
    for (;;)
    {
      localMessageForDeviceFile.fileSize = auea.a(str1);
      if (!NetworkUtil.isNetSupport(BaseApplication.getContext()))
      {
        localMessageForDeviceFile.nFileStatus = 6;
        localMessageForDeviceFile.msgStatus = 1;
      ...
      break;
      if (paramString.compareTo(abkw.c) != 0) {
        break label363;
      }
      localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691526);
      ...
      break label363;
      label549:
      if (paramString.compareTo(abkw.f) == 0)
      {
  ...
  public void a(long paramLong1, String paramString, int paramInt, long paramLong2)
  {
    ...
    {
      paramString = new abid(this, paramString, paramInt, paramLong2);
  ...
  public void a(View paramView, arug paramarug)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      abic localabic = (abic)localIterator.next();
      if (localabic.a() == paramView)
      {
        localabic.b = new WeakReference(paramarug);
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(new abic(this, paramView, paramarug));
  }
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localObject1 = (abgm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER);
      localMessageForDeviceFile = a(Long.valueOf(paramSession.uSessionID));
    } while (localMessageForDeviceFile == null);
    Object localObject2 = ((abgm)localObject1).a(Long.parseLong(localMessageForDeviceFile.frienduin));
    int i = 0;
    long l = 0L;
    ...
    if (paramSession.actionInfo.strServiceName.compareTo(abkw.d) == 0)
    {
    ...
    for (int j = 0;; j = 1)
    {
      absy.a((AppRuntime)localObject2, l, "Net_SendMsg_Pic", 0, j, i);
      if ((paramSession.actionInfo.strServiceName.compareTo(abkw.c) == 0) && (paramSession.bSend) && (paramBoolean))
      {
        ...
        ((abgm)localObject1).a(Long.parseLong(localMessageForDeviceFile.frienduin), str, String.valueOf(((Session)localObject2).uSessionID), paramSession.strFileNameSrc, paramSession.emFileType, localBundle);
        localObject1 = (MessageForDeviceFile)bcsa.a(-4500);
        ((MessageForDeviceFile)localObject1).strServiceName = abkw.c;
        ...
        ((MessageForDeviceFile)localObject1).time = bcrg.a();
        ...
        ((MessageForDeviceFile)localObject1).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691526);
  ...
  public void a(String paramString, long paramLong, boolean paramBoolean)
  {
    ...
    DeviceInfo localDeviceInfo = ((abgm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(Long.parseLong(localMessageForDeviceFile.frienduin));
    ...
    for (int i = localDeviceInfo.productId;; i = 0)
    {
      ...
      if (paramBoolean)
      {
        ...
        label77:
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691253);
        if (paramString.compareTo(abkw.d) != 0) {
          break label252;
        }
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691257);
      }
      for (;;)
      {
        if (QLog.isDevelopLevel()) {
        ...
        if (paramString.compareTo(abkw.c) == 0)
        {
          ...
          if (!paramBoolean)
          {
            ...
            if (localMessageForDeviceFile.isSend())
            {
              ...
              if (auea.a(localMessageForDeviceFile.filePath) == 0) {
                absy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 2, i);
              } else {
                absy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 2, i);
              }
            }
            else
            {
              ...
              for (;;)
              {
                absy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendPrint", 2, j, i);
                break;
          ...
          {
            if (auea.a(localMessageForDeviceFile.filePath) == 0) {
              absy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 1, i);
            } else {
              absy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 1, i);
            }
          }
          else
          {
            absy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendPrint", 1, 0, i);
          }
        }
      }
    }
  ...
  {
    MessageForStructing localMessageForStructing = bcsa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 9501, 100L, paramAbsStructMsg);
    ...
    ((abgm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(Long.parseLong(paramString), paramAbsStructMsg);
  }
  ...
  public void a(String paramString1, String paramString2, List<String> paramList, Bundle paramBundle)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      MessageForDeviceFile localMessageForDeviceFile = (MessageForDeviceFile)bcsa.a(-4500);
      ...
      localMessageForDeviceFile.srcFileName = auea.a((String)localObject1);
      localMessageForDeviceFile.fileSize = auea.a((String)localObject1);
      ...
      if (paramString1.compareTo(abkw.d) == 0)
      {
        localMessageForDeviceFile.nFileMsgType = 2;
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691528);
      }
      int i;
      if (paramString1.compareTo(abkw.c) == 0)
      {
        int i3 = 1;
        int i2 = 1;
        int i1 = 1;
      ...
      if ((localObject2 != null) && (((abgm)localObject2).a(paramString2))) {
        if (paramString1.compareTo(abkw.d) == 0)
        {
          String str = bheg.a(BaseApplication.getContext(), Uri.parse((String)localObject1));
          bheg.a(BaseApplication.getContext(), (String)localObject1, str, 160, 160);
          localMessageForDeviceFile.uSessionID = ((abgm)localObject2).a(Long.parseLong(paramString2), (String)localObject1, str);
        }
      }
      for (;;)
      {
        ...
        localArrayList.add(localMessageForDeviceFile);
        break;
        if (paramString1.compareTo(abkw.f) == 0)
        {
          localMessageForDeviceFile.uSessionID = ((abgm)localObject2).a(Long.parseLong(paramString2), (String)localObject1, 0);
        }
        else
        {
          if (paramString1.compareTo(abkw.c) == 0)
          {
            localObject2 = ((abgm)localObject2).a(Long.parseLong(paramString2));
            i = 0;
            if (localObject2 != null) {
              i = ((DeviceInfo)localObject2).productId;
            }
            ...
            absy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 0, i);
          }
          for (;;)
          {
            ...
            break label528;
            label725:
            absy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 0, i);
          }
          localObject1 = ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEFILE_HANDLER)).a((String)localObject1, paramString1, null, Long.parseLong(paramString2));
          if (localObject1 == null) {
            break;
  ...
  public void a(String paramString, List<String> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      MessageForDeviceFile localMessageForDeviceFile = (MessageForDeviceFile)bcsa.a(-4500);
      localMessageForDeviceFile.strServiceName = abkw.d;
      localMessageForDeviceFile.msgtype = -4500;
      localMessageForDeviceFile.istroop = 9501;
      localMessageForDeviceFile.filePath = str;
      localMessageForDeviceFile.srcFileName = auea.a(str);
      localMessageForDeviceFile.fileSize = auea.a(str);
      localMessageForDeviceFile.issend = 1;
      localMessageForDeviceFile.isread = true;
      localMessageForDeviceFile.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
      localMessageForDeviceFile.senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
      ...
      localMessageForDeviceFile.time = bcrg.a();
      localMessageForDeviceFile.progress = 0.0F;
      localMessageForDeviceFile.msg = (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131694215) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691528));
      localMessageForDeviceFile.nFileMsgType = 2;
      ...
      str = bheg.a(BaseApplication.getContext(), Uri.parse(localMessageForDeviceFile.filePath));
      bheg.a(BaseApplication.getContext(), localMessageForDeviceFile.filePath, str, 160, 160);
      int i = ((abgm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(Long.parseLong(localMessageForDeviceFile.frienduin), localMessageForDeviceFile.filePath, str);
      localMessageForDeviceFile.uSessionID = i;
      a(localMessageForDeviceFile.uSessionID, localMessageForDeviceFile.frienduin, localMessageForDeviceFile.istroop, localMessageForDeviceFile.uniseq);
      ahzx.a(i, localMessageForDeviceFile);
    }
  }
  ...
  public boolean a(String paramString, List<FileInfo> paramList)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        {
          localMessageForDeviceFile.strServiceName = abkw.b;
          continue;
          label514:
          if (localMessageForDeviceFile.strServiceName.compareTo(abkw.f) == 0)
          {
            localMessageForDeviceFile.uSessionID = localabgm.a(Long.parseLong(paramString), ((FileInfo)localObject).c(), 0);
          }
          else
          {
    ...
    if ((localabgm != null) && (localabgm.a(l1, 9))) {}
    for (int i = 1;; i = 0)
    {
      ArrayList localArrayList = new ArrayList();
      paramList = paramList.iterator();
      for (;;)
      {
        ...
        localMessageForDeviceFile = (MessageForDeviceFile)bcsa.a(-4500);
        ...
        localMessageForDeviceFile.srcFileName = auea.a(((FileInfo)localObject).c());
        localMessageForDeviceFile.fileSize = auea.a(((FileInfo)localObject).c());
        localMessageForDeviceFile.issend = 1;
        localMessageForDeviceFile.isread = true;
        localMessageForDeviceFile.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
        localMessageForDeviceFile.senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
        ...
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691527);
        localMessageForDeviceFile.nFileMsgType = 1;
        if (localMessageForDeviceFile.strServiceName.compareTo(abkw.d) == 0)
        {
          localMessageForDeviceFile.nFileMsgType = 2;
          localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691528);
        }
        ((aocy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER)).a(localMessageForDeviceFile);
        if ((localabgm == null) || (!localabgm.a(paramString))) {
          break label603;
        }
        if (localMessageForDeviceFile.strServiceName.compareTo(abkw.d) != 0) {
          break label514;
        }
        localMessageForDeviceFile.uSessionID = localabgm.a(Long.parseLong(paramString), ((FileInfo)localObject).c(), null);
        if (!NetworkUtil.isNetSupport(BaseApplication.getContext()))
        {
          localMessageForDeviceFile.nFileStatus = 6;
          localMessageForDeviceFile.msgStatus = 1;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    Object localObject = ((abgm)localObject).a(Long.parseLong(paramBundle.frienduin));
    long l = 0L;
    int i;
    if (localObject != null)
    {
    ...
    {
      int j;
      if (paramBundle.strServiceName.compareTo(abkw.d) == 0)
      {
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
        if (m == 0)
        {
          j = 0;
          absy.a((AppRuntime)localObject, l, "Net_SendMsg_Pic", 0, j, i);
        }
      }
      else
      {
