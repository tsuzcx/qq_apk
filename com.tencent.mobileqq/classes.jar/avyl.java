...
public class avyl
  implements agvc
{
  private static final String jdField_a_of_type_JavaLangString = avyl.class.getSimpleName();
  private int jdField_a_of_type_Int;
  public long a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new avym(this);
  ...
  public avyl(BaseChatPie paramBaseChatPie)
  {
  ...
  private avyp a()
  {
    if (this.jdField_a_of_type_Avyp == null)
    {
      ...
      if ((localManager instanceof avyp)) {
        this.jdField_a_of_type_Avyp = ((avyp)localManager);
      }
    }
    return this.jdField_a_of_type_Avyp;
  }
  
  private boolean a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aimd))) {
      return c();
    }
    return b();
  }
  ...
  private void b(int paramInt)
  {
    ...
    try
    {
      ...
      avyk localavyk = (avyk)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(150);
      if (localavyk != null) {
        localavyk.a(paramInt, l);
      }
      return;
    }
  ...
  private boolean b()
  {
    try
    {
      ...
      if (localavyj != null)
      {
        boolean bool = localavyj.jdField_a_of_type_Boolean;
        return bool;
      }
    }
    catch (Exception localException)
  ...
  private boolean c()
  {
    try
    {
      ...
      if (localavyj != null)
      {
        boolean bool = localavyj.jdField_b_of_type_Boolean;
        return bool;
      }
    }
    catch (Exception localException)
  ...
  public void a(int paramInt)
  {
    ...
    case 7: 
      do
      {
        ...
        if (this.jdField_a_of_type_Avyo == null) {
          this.jdField_a_of_type_Avyo = new avyn(this, null);
        }
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Avyo);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Avyo);
    }
    if (this.jdField_a_of_type_AndroidOsHandler != null)
    {
