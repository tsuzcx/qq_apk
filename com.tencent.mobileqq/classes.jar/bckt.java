...
class bckt
  extends QIPCModule
{
  bckt(bcks parambcks, String paramString)
  {
    super(paramString);
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("CMD_GET_NICK_NAME_BY_UIN".equals(paramString))
    {
      ...
      paramString.putString("VALUE_USER_NICK_NAME", bglf.b(localQQAppInterface, paramBundle.getString("VALUE_USER_UIN_TO_GET_NICK_NAME"), true));
    ...
    if ("CMD_UPDATE_MSG_FOR_VIDEO_REDBAG_STAT".equals(paramString))
    {
      ...
      if (paramBundle != null)
      {
        bckg.a(localQQAppInterface).a(paramString, paramInt, paramBundle);
    ...
    {
      bnpu.a().a(bnpt.c, null, false);
      bnzb.b("VideoPlayIPCServer", "launchForResult requestAEKitDownload : AEKIT_ADDITIONAL_PACKAGE");
      return EIPCResult.createSuccessResult(new Bundle());
    }
    ...
    {
      paramInt = bnpu.a().a(bnpt.c);
      bnzb.b("VideoPlayIPCServer", "query additional_package");
      paramString = new Bundle();
