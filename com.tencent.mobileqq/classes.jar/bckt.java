  ...
  implements Manager
{
  ...
  public bckt(QQAppInterface paramQQAppInterface)
  {
  ...
  private MessageForTroopReward a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, int paramInt3)
  {
    ...
    localMessageForTroopReward.msgUid = ayvy.a(paramInt1);
    localMessageForTroopReward.msg = bdec.a(null);
    ...
    localMessageForTroopReward.time = ayvc.a();
  ...
  {
    aboq localaboq = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(0).a();
    Lock localLock = localaboq.a(paramString, paramInt);
    localLock.lock();
    try
    {
      paramString = localaboq.a().get(a(paramString, paramInt));
      if (paramString != null)
      {
