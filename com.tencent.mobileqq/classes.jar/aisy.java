...
{
  public aisy(ClassificationSearchActivity paramClassificationSearchActivity) {}
    ...
    if ((paramInt == 3) || ((paramKeyEvent != null) && (paramKeyEvent.getKeyCode() == 66)))
    {
      ...
      if (!TextUtils.isEmpty(paramTextView)) {
        if ((this.a.f == ClassificationSearchActivity.jdField_a_of_type_Int) && (!TextUtils.isEmpty(paramTextView.trim())))
        {
          ...
          olh.a(null, "dc00899", "Pb_account_lifeservice", "", "0X80067C4", "0X80067C4", 0, 0, "", "", paramTextView, "", true);
      ...
      for (;;)
      {
        ...
        {
          olh.a(null, "", "0X800742D", "0X800742D", 0, 0, paramTextView, "", "", "");
          ClassificationSearchActivity.a(this.a, paramTextView);
        }
        else
        {
          ...
          if (this.a.f == ClassificationSearchActivity.jdField_a_of_type_Int)
          {
            ...
            if ((!TextUtils.isEmpty(paramTextView.trim())) && (!TextUtils.equals(paramTextView, anvx.a(2131701423))) && (!TextUtils.equals(paramTextView, anvx.a(2131701438))))
            {
              this.a.a(paramTextView);
              olh.a(null, "dc00899", "Pb_account_lifeservice", "", "0X80067C4", "0X80067C4", 0, 0, "", "", paramTextView, "", true);
              ClassificationSearchActivity.a(this.a, paramTextView);
