...
public class ssb
{
  ...
  private static long a(String paramString)
  {
    ...
    catch (Exception localException)
    {
      ...
      bdmc.a(BaseApplicationImpl.getApplication()).a(null, "actKandianFastWebCost", false, 0L, 0L, localHashMap, null);
    }
    return -1L;
  }
  ...
  public static Map<String, String> a(Context paramContext)
  {
    ...
    HashMap localHashMap = new HashMap();
    Object localObject1 = suz.a("native_article", true);
    if (localObject1 == null) {
      return localHashMap;
    }
    localObject1 = ((suz)localObject1).getTemplate("ReadInjoy_article_text_cell");
    if (localObject1 == null) {
      return localHashMap;
    }
    ...
    try
    {
      ...
      int m = bdep.a(paramContext);
      int n = bdep.b(paramContext);
  ...
  public static void a(ArticleInfo paramArticleInfo, ProteusItemData paramProteusItemData, int paramInt, SparseArray<Float> paramSparseArray)
  {
    ...
    for (;;)
    {
      ...
      float f1 = srw.b(paramSparseArray);
      continue;
      f1 = srw.c(paramSparseArray);
      continue;
      label164:
      float f2 = -1000.0F;
      f1 = f2;
  ...
  public static void a(ArticleInfo paramArticleInfo, syn paramsyn)
  {
    if (paramArticleInfo == null) {
      return;
    }
    QLog.d("FastWebRequestUtil", 2, "deleteFeeds.");
    ThreadManager.excute(new FastWebRequestUtil.6(paramArticleInfo, paramsyn), 128, null, true);
  }
  ...
  public static void a(String paramString, FastWebArticleInfo paramFastWebArticleInfo)
  {
    ...
    try
    {
      ...
      nnr.a(localBundle);
      paramString = new String(nnr.a(BaseApplicationImpl.getContext(), "https://c.mp.qq.com/review/img-txt-comment/list?source=1", "POST", paramString, localBundle));
    }
  ...
  private static void a(String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean, String paramString5, String paramString6, String paramString7, int paramInt1, long paramLong, ssg paramssg, int paramInt2)
  {
    ThreadManager.executeOnNetWorkThread(new FastWebRequestUtil.4(paramString1, paramString2, paramString3, paramString4, paramString6, paramString7, paramBoolean, paramInt1, paramLong, paramString5, paramInt2, paramssg));
  }
  
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean, String paramString5, String paramString6, String paramString7, ssf paramssf, int paramInt1, int paramInt2, long paramLong)
  {
    paramssf = new sse(paramString1, paramssf);
    a(paramString1, paramString2, paramString3, new ssc(paramssf), paramInt2);
    a(paramString1, paramString2, paramString3, paramString4, paramBoolean, paramString5, paramString6, paramString7, paramInt1, paramLong, new ssd(paramssf), paramInt2);
  }
  
  private static void a(String paramString1, String paramString2, String paramString3, ssg paramssg, int paramInt)
  {
    ThreadManager.executeOnNetWorkThread(new FastWebRequestUtil.3(paramString1, paramString2, paramInt, paramssg));
  }
  
  private static String b(Map<String, String> paramMap, JSONObject paramJSONObject)
  {
    tpx.a("REPORT_LINK", "requestAdData start");
    try
    {
      ...
      paramMap = ((QQAppInterface)ozs.a()).getAccount();
      if (QLog.isColorLevel()) {
      ...
      paramMap = nnr.a(BaseApplicationImpl.getContext(), paramJSONObject, "GET", null, paramMap);
      if (paramMap == null)
      {
  ...
  private static List<BaseData> b(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < localJSONArray.length())
        {
          ...
          try
          {
            ...
            else
            {
              ...
              localObject2 = ((suz)localObject2).getTemplateBean(localJSONObject);
              if (localObject2 != null)
              {
        ...
        localObject4 = bjsz.a().b((String)localObject4);
      }
  ...
  {
    paramString5 = (QQAppInterface)ozs.a();
    ...
    for (paramString1 = "";; paramString1 = rlz.a(paramString6))
    {
      paramString5.put("token", paramString1);
      paramString5.put("cookie", nzq.a());
  ...
  private static JSONObject b(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject1 = new acwc();
        ((acwc)localObject1).jdField_a_of_type_JavaLangString = "ce2d9f";
        ...
        if (localObject1 != null)
        {
          ...
          localJSONObject.put("carrier", acwe.a(BaseApplicationImpl.getContext()));
          ...
          if (localObject1 != null)
          {
            ...
            localObject2 = "";
            localJSONObject.put("muid", localObject2);
            localJSONObject.put("bytes_wx_ver", tpb.a(BaseApplication.getContext()));
            if (QLog.isColorLevel()) {
  ...
  public static void b(ArticleInfo paramArticleInfo, syn paramsyn)
  {
    if (paramArticleInfo == null) {
      return;
    }
    QLog.d("FastWebRequestUtil", 2, "shieldFeedSource");
    ThreadManager.excute(new FastWebRequestUtil.7(paramArticleInfo, paramsyn), 128, null, true);
  }
  ...
  private static boolean b(String paramString1, String paramString2, List<BaseData> paramList, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        nzq.a(((JSONObject)localObject).optString("cookie"));
        ...
        if (j < localJSONArray.length())
        {
          ...
          if (((JSONObject)localObject).isNull("ad_pos_type"))
          {
            ...
            localObject = a(tpw.a((JSONObject)localObject, paramJSONObject), 1, false, str, i, k);
            tqa.a((AdData)localObject);
            if (localObject != null)
            {
          ...
          else
          {
            ...
            {
              ((JSONObject)localObject).put("rowkey", paramString2);
              localObject = a(tpw.a((JSONObject)localObject, paramJSONObject), 1, true, str, -1, k);
              tqa.a((AdData)localObject);
              if (localObject == null) {
                break label439;
              }
    ...
    {
      ((JSONObject)localObject).put("rowkey", paramString2);
      localObject = a(tpw.a((JSONObject)localObject, paramJSONObject), 2, false, str, -1, k);
      if (localObject != null)
      {
