...
public class aoqz
  extends anua
{
  public aoqz(HiddenChatFragment paramHiddenChatFragment) {}
  ...
  public void a(int paramInt1, int paramInt2, Map<String, Integer> paramMap, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt2 != 0)
      {
        ...
        continue;
        if (paramInt1 == 0) {
          bhsi.j(this.a.getActivity(), HiddenChatFragment.a(this.a).getCurrentAccountUin());
        }
        return;
      }
    }
