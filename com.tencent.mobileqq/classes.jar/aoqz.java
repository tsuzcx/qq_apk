...
{
  public aoqz(QfileBaseCloudFileTabView paramQfileBaseCloudFileTabView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    this.a.f();
    if (this.a.jdField_a_of_type_Aopw.getGroupCount() > 0) {
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetQfilePinnedHeaderExpandableListView.a(this.a.jdField_a_of_type_Aopw.getGroupCount() - 1);
    }
