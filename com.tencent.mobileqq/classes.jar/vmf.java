  ...
  implements View.OnTouchListener
{
  ...
  public static final int[] c = { 2130843755, 2130843758 };
  public static final int[] d = { 2131311341, 2131311342 };
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 2131298053, 2131298054 };
    jdField_b_of_type_ArrayOfInt = new int[] { 2130843754, 2130843757 };
  }
  
  public vmf(vmi paramvmi, View paramView, int paramInt)
  {
  ...
  public void a(CharSequence paramCharSequence)
  {
    ...
    for (CharSequence localCharSequence = this.jdField_a_of_type_AndroidWidgetTextView.getHint();; localCharSequence = paramCharSequence)
    {
      ...
      if (this.jdField_b_of_type_AndroidWidgetTextView.getVisibility() == 0)
      {
        ...
        k = vms.a(this.jdField_a_of_type_AndroidWidgetTextView.getContext(), 72.5F);
      ...
      for (;;)
      {
        ...
        break;
        label201:
        k = vms.a(this.jdField_a_of_type_AndroidWidgetTextView.getContext(), 84.0F);
      ...
      if ((n <= k) || (i == arrayOfFloat1.length - 1))
      {
        ...
        urk.a("Q.qqstory.widget.PollWidgetUtils", "text size = %s", Float.valueOf(arrayOfFloat1[i]));
      }
      for (;;)
      {
        paramCharSequence = vlx.a(this.jdField_a_of_type_AndroidWidgetTextView, 2);
        this.jdField_a_of_type_AndroidWidgetTextView.setText(paramCharSequence);
  ...
  public void a(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130843700);
      return;
    }
  ...
  {
    if ((a()) || (this.jdField_a_of_type_Vmc == null) || (!this.jdField_a_of_type_Vmi.a())) {
