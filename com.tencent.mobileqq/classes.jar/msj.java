  ...
  extends ajfb
{
  ...
  public msj(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(String paramString1, long paramLong, String paramString2, msk parammsk)
  {
    ...
    parammsk = new ilive_get_record_info_svr.GetRoomStateReq();
    parammsk.source.set(paramString1);
    parammsk.roomid.set((int)paramLong);
    ...
    paramString1.busi_buf.set(ByteStringMicro.copyFrom(((ilive_get_record_info_svr.GetRoomStateReq)parammsk.get()).toByteArray()));
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, long paramLong, String paramString3)
  {
    if (this.jdField_a_of_type_Msk != null) {
      this.jdField_a_of_type_Msk.a(paramBoolean, paramString2, paramString1, paramLong, paramString3);
    }
  }
