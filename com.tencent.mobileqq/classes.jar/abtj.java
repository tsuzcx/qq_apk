...
{
  public abtj(SubAccountBindActivity paramSubAccountBindActivity) {}
  
  public void onClick(View paramView)
  {
    Object localObject = paramView.findViewById(2131298618);
    ...
    do
    {
      do
      {
        ...
        if (((axat)localObject).a(paramView.getUin()))
        {
      ...
      localObject = ((axat)localObject).a(paramView.getUin());
      this.a.a(2131653964);
      if (TextUtils.isEmpty((CharSequence)localObject))
      {
        localObject = new abtk(this, paramView);
        this.a.getAppRuntime().getSubAccountKey(this.a.app.getAccount(), paramView.getUin(), (SubAccountObserver)localObject);
        return;
      }
      localaxar = (axar)this.a.app.getManager(28);
    } while (localaxar == null);
    localaxar.a(paramView.getUin(), (String)localObject, this.a.b);
  }
}
