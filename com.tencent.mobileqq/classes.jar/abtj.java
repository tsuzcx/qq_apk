...
public class abtj
  extends ailz
{
  public LinkedHashMap<String, List<abti>> a;
  public int[] a;
  public String[] a;
  
  public abtj(PublicAccountListActivity paramPublicAccountListActivity)
  {
  ...
  private void b()
  {
    ...
    for (;;)
    {
      ...
      {
        abti localabti = (abti)((Iterator)localObject2).next();
        if (!PublicAccountListActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityPublicAccountListActivity, localabti))
        {
          if ((localabti.jdField_a_of_type_JavaLangString == null) || (localabti.jdField_a_of_type_JavaLangString.length() == 0))
          {
            localObject1 = "#";
          ...
          for (localObject1 = ((String)localObject1).toUpperCase();; localObject1 = "#")
          {
            ...
            ((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localObject1)).add(localabti);
            break;
            localObject1 = localabti.jdField_a_of_type_JavaLangString.substring(0, 1);
            break label89;
          }
        }
      }
  ...
  public Object getItem(int paramInt)
  {
    ...
    i = -(i + 1) - 1;
    return (abti)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityPublicAccountListActivity.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559439, paramViewGroup, false);
      paramViewGroup = new abtk();
      ...
      i = -(i + 1) - 1;
      localObject = (abti)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
      paramViewGroup.jdField_a_of_type_Abti = ((abti)localObject);
      paramViewGroup.jdField_a_of_type_JavaLangString = String.valueOf(((abti)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.uin);
      paramViewGroup.jdField_a_of_type_AndroidViewView.setVisibility(0);
      paramViewGroup.f.setVisibility(8);
      paramViewGroup.d.setVisibility(0);
      paramViewGroup.d.setText(((abti)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name);
      if (((abti)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.certifiedGrade <= 0L) {
        break label650;
      }
      ...
      label379:
      paramViewGroup.e.setText(((abti)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.summary);
      ...
      if (((abti)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.extendType != 2) {
        break label796;
      }
    }
    label650:
    label796:
    for (boolean bool = naz.a(this.jdField_a_of_type_ComTencentMobileqqActivityPublicAccountListActivity.app, ((abti)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin(), 1024);; bool = false)
    {
      if (bool)
      {
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setTag(-1, ((abti)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin());
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setTag(-2, ((abti)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name);
      ...
      {
        return paramView;
        paramViewGroup = (abtk)paramView.getTag();
        break;
        ...
        break label504;
        paramViewGroup.jdField_a_of_type_Abti = null;
      ...
      paramViewGroup.f.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivityPublicAccountListActivity.getString(2131691898), new Object[] { ((String)localObject).toLowerCase() }));
      return paramView;
    }
  }
}
