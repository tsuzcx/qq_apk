...
public class wgt
{
  ...
  public wgt(Activity paramActivity, wgu paramwgu)
  {
  ...
  public static void a(Activity paramActivity, Intent paramIntent)
  {
    ...
    uqn.a(paramActivity, i, paramIntent);
  }
  ...
  public static void c(Activity paramActivity, Intent paramIntent)
  {
    ...
    {
      wxe.e("Q.qqstory.home.QQStoryHomeJumpHelper", "handleOpenTagAction parm error");
      return;
    }
    vmj.a(paramActivity, str, paramIntent);
  }
  
  public static void d(Activity paramActivity, Intent paramIntent)
  {
    paramIntent = (String)((uvt)uwa.a(10)).b("mainHallConfig", "");
    if (!TextUtils.isEmpty(paramIntent)) {}
    for (;;)
    {
      try
      {
        ...
        wxe.d("Q.qqstory.home.QQStoryHomeJumpHelper", "square config not ready , use default config instead");
        return;
      }
      catch (Exception paramIntent)
      {
        wxe.d("Q.qqstory.home.QQStoryHomeJumpHelper", "analyze config error , error :%s", new Object[] { paramIntent.getMessage() });
      }
      paramIntent = "";
    }
  ...
  private void e(Intent paramIntent)
  {
    ...
    bdhk.a(QQStoryContext.a(), this.jdField_a_of_type_AndroidAppActivity, paramIntent, str);
  }
  ...
  private void h(Intent paramIntent)
  {
    ...
    uqn.a(this.jdField_a_of_type_AndroidAppActivity, 23, str);
  }
  ...
  {
    wxe.b("Q.qqstory.home.QQStoryHomeJumpHelper", "handleAction=" + paramInt);
    switch (paramInt)
    {
    case 3: 
    default: 
    ...
    case 1: 
      ...
      this.jdField_a_of_type_Wgu.a(false, true, 16, null);
      return true;
    case 2: 
      a(paramIntent);
      return true;
  ...
  protected void c(Intent paramIntent)
  {
    ...
    if (paramIntent == null)
    {
      wxe.e("Q.qqstory.home.QQStoryHomeJumpHelper", "handle open play list error , no play info !");
      return;
    }
    vod.a(this.jdField_a_of_type_AndroidAppActivity, paramIntent, 31, null);
  }
