  ...
  extends vqm
{
  ...
  private List<vxd> jdField_a_of_type_JavaUtilList;
  
  public wgt(@NonNull qqstory_service.RspMsgListHeadNode paramRspMsgListHeadNode)
  {
  ...
  private static List<vxd> a(List<qqstory_service.MsgTabNodeInfo> paramList)
  {
