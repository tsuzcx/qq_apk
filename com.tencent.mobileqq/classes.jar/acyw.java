...
public class acyw
{
  ...
  private boolean a()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 43	acyw:jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog	Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   8: ifnull +25 -> 33
    //   11: aload_0
    //   12: getfield 43	acyw:jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog	Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   15: invokevirtual 51	com/tencent/mobileqq/utils/QQCustomDialog:isShowing	()Z
    //   18: ifeq +15 -> 33
    //   21: aload_0
    //   22: getfield 43	acyw:jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog	Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   25: invokevirtual 54	com/tencent/mobileqq/utils/QQCustomDialog:dismiss	()V
    //   28: aload_0
    //   29: aconst_null
    //   30: putfield 43	acyw:jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog	Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   33: invokestatic 150	acyw:a	()Landroid/app/Activity;
    //   36: astore_3
    //   37: aload_3
    //   38: ifnonnull +25 -> 63
    //   41: iload_2
    ...
    //   74: putfield 43	acyw:jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog	Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   77: aload_0
    //   78: getfield 43	acyw:jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog	Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   81: ldc 160
    //   83: invokevirtual 163	com/tencent/mobileqq/utils/QQCustomDialog:setContentView	(I)V
    //   86: aload_0
    //   87: getfield 43	acyw:jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog	Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   90: aconst_null
    ...
    //   94: pop
    //   95: aload_0
    //   96: getfield 43	acyw:jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog	Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   99: ldc 168
    //   101: new 170	acyy
    //   104: dup
    //   105: aload_0
    //   106: invokespecial 172	acyy:<init>	(Lacyw;)V
    ...
    //   112: pop
    //   113: aload_0
    //   114: getfield 43	acyw:jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog	Lcom/tencent/mobileqq/utils/QQCustomDialog;
    //   117: iconst_0
  ...
  private void b()
  {
    try
    {
      ...
      {
        this.jdField_a_of_type_Bisl = new bisl(a(), BaseApplicationImpl.getApplication().getResources().getDimensionPixelSize(2131299080));
        this.jdField_a_of_type_Bisl.a(anvx.a(2131706017));
        this.jdField_a_of_type_Bisl.c(false);
        this.jdField_a_of_type_Bisl.setOnDismissListener(new aczb(this));
      }
