  ...
  implements acyt
{
  ...
  private acyv jdField_a_of_type_Acyv;
  private int jdField_b_of_type_Int;
  private long jdField_b_of_type_Long = -2147483648L;
  
  public acyw(acyv paramacyv)
  {
    this.jdField_a_of_type_Acyv = paramacyv;
  }
  ...
  {
    String str2 = "";
    if (this.jdField_a_of_type_Acyv != null) {}
    for (Activity localActivity = this.jdField_a_of_type_Acyv.a();; localActivity = null)
    {
      String str1 = str2;
  ...
  private void a(GdtAd paramGdtAd)
  {
    ...
    localacvh.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(2);
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localacvh);
  }
  ...
  private void b(GdtAd paramGdtAd)
  {
    ...
    acvh localacvh = new acvh();
    localacvh.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(1);
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localacvh);
  }
  ...
  private void c(GdtAd paramGdtAd)
  {
    ...
    acvh localacvh = new acvh();
    localacvh.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(5);
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localacvh);
  }
  ...
  private void d(GdtAd paramGdtAd)
  {
    ...
    acvh localacvh = new acvh();
    localacvh.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(6);
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localacvh);
  }
  ...
  private void f(GdtAd paramGdtAd)
  {
    ...
    acvh localacvh = new acvh();
    localacvh.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(3);
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localacvh.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localacvh);
  }
