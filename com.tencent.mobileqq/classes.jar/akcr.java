  ...
  implements axaw
{
  ...
  public akcr(QQAppInterface paramQQAppInterface)
  {
    this.a = paramQQAppInterface;
  }
  
  private boolean a(axbt paramaxbt, String paramString)
  {
    if (paramaxbt == null) {}
    while (paramaxbt.a(paramString) == -1) {
      return false;
    }
    return true;
  }
  ...
  public ReqItem a(int paramInt)
  {
    ...
    if ((j - i > paramInt) || (j < i))
    {
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).client_ver.set("8.2.8");
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).mem.set((int)bbct.d() / 1048576);
      ...
      Object localObject4 = bbjo.a((SharedPreferences)localObject1, "key_web_plugin_list" + this.a.getCurrentAccountUin(), null);
      if ((localObject4 != null) && (!((Set)localObject4).isEmpty()))
      {
        localObject3 = (axbt)this.a.getManager(12);
    ...
    if (paramRespItem != null)
    {
      ...
      if (i == 2) {
        try
        {
          ...
          {
            i = (int)bbmj.a((byte[])localObject1, 0);
            paramRespItem = new byte[i - 4];
            bbmj.a(paramRespItem, 0, (byte[])localObject1, 4, i - 4);
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        do
        {
          ...
          bbjo.a(paramRespItem, "key_web_plugin_list" + this.a.getCurrentAccountUin(), (Object[])localObject2);
