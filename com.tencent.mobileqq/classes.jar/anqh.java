...
public class anqh
{
  ...
  private static anqj jdField_a_of_type_Anqj;
  ...
  public static void a(int paramInt, anqj paramanqj)
  {
    try
    {
      c();
      jdField_a_of_type_Anqj = paramanqj;
  ...
  {
    if (jdField_a_of_type_Anqj != null) {
      jdField_a_of_type_Anqj.a(paramInt);
    }
  }
              ...
              if (localannc != null)
              {
                ...
                for (;;)
                {
                  synchronized (jdField_a_of_type_JavaLangObject)
                  {
                    ...
                    {
                      b(1);
                      localannc.b((String)((Pair)localObject5).first, 0L, new anqi(str3, str2, str4, str1));
  ...
  private static boolean b(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString3)) && (!TextUtils.isEmpty(paramString4))) {
      try
      {
        ...
        {
          String str = bhpp.a(paramString2);
          if ((!TextUtils.isEmpty(str)) && (str.equals(paramString3)))
          {
            bdhb.a(paramString2.getAbsolutePath(), paramString1, false);
            paramString2 = new File(paramString1 + "libarkDebuggerJSImpl.so");
            if ((paramString2 == null) || (!paramString2.exists())) {
              break label406;
            }
            if (bdhb.d(paramString1 + "libarkDebuggerJSImpl.so", paramString4 + "libarkDebuggerJSImpl.so")) {
            ...
            for (i = 0;; i = 1)
            {
              ...
              if (!bdhb.d(paramString1 + "libjsc_ark.so", paramString4 + "libjsc_ark.so")) {
                break;
              }
  ...
  {
    Object localObject1 = aolx.b(186).a();
    ...
    {
      return;
      localObject1 = ((aolt)localObject1).a();
      if (localObject1 == null)
      {
        ArkAppCenter.c("JSDebuggerSoLoader", String.format("updateJSDebuggerConfig, aiKeywordConfig is null", new Object[0]));
        return;
      }
      localObject1 = ((aomk)localObject1).d;
    } while (localObject1 == null);
    jdField_a_of_type_JavaUtilMap.clear();
    localObject1 = ((ArrayList)localObject1).iterator();
    while (((Iterator)localObject1).hasNext())
    {
      Object localObject2 = (aomn)((Iterator)localObject1).next();
      if (localObject2 != null)
      {
        String str1 = ((aomn)localObject2).jdField_a_of_type_JavaLangString;
        String str2 = ((aomn)localObject2).b;
        localObject2 = ((aomn)localObject2).c;
