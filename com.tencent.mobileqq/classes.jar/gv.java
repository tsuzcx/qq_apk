...
{
  private static gr a(hf paramhf, int paramInt1, int paramInt2, int paramInt3)
  {
    paramhf = paramhf.a();
    if (paramhf == null) {
    ...
    gr localgr = new gr(paramInt1, paramInt3);
    paramInt1 = 0;
    while (paramInt1 < m)
    {
      i = 0;
      ...
      while (i < k)
      {
        if (paramhf.a(i, paramInt1) == 1) {
          localgr.a(paramInt3, paramInt2, n, n);
        }
        i += 1;
        paramInt3 += n;
      }
  ...
  public gr a(String paramString, int paramInt1, int paramInt2, Map<EncodeHintType, ?> paramMap)
  {
    ...
    for (;;)
    {
      return a(hb.a(paramString, (ErrorCorrectionLevel)localObject1, paramMap), paramInt1, paramInt2, i);
      i = 4;
      localObject1 = localObject2;
    }
  }
