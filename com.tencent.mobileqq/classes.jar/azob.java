...
{
  private static azob jdField_a_of_type_Azob;
  ...
  private static String[] jdField_c_of_type_ArrayOfJavaLangString = { azob.class.getName() };
  private int jdField_a_of_type_Int = -1;
  private long jdField_a_of_type_Long;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  private azog jdField_a_of_type_Azog;
  private azoh jdField_a_of_type_Azoh;
  private List<azoc> jdField_a_of_type_JavaUtilList;
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { "CPU", alpo.a(2131701446), alpo.a(2131701445), alpo.a(2131701449), "WakeLock", "WIFI", "GPS" };
    jdField_a_of_type_JavaUtilSet = new BatteryStatsImpl.1();
  }
  
  public static azob a()
  {
    if (jdField_a_of_type_Azob != null) {
      return jdField_a_of_type_Azob;
    }
    try
    {
      if (jdField_a_of_type_Azob == null) {
        jdField_a_of_type_Azob = new azob();
      }
      azob localazob = jdField_a_of_type_Azob;
      return localazob;
    }
    finally {}
  }
  ...
  private final void a(long paramLong1, long paramLong2)
  {
    ...
    //   1: lload_3
    //   2: ldc2_w 194
    //   5: invokestatic 198	azny:a	(JJJ)Ljava/util/List;
    //   8: astore 19
    //   10: aload 19
    //   12: ifnonnull +12 -> 24
    //   15: ldc 200
    ...
    //   552: invokestatic 364	azmz:a	(Landroid/content/Context;)Lazmz;
    //   555: aconst_null
    //   556: ldc_w 366
    //   559: iconst_1
    //   560: lconst_0
    ...
    //   562: aload 24
    //   564: aconst_null
    //   565: invokevirtual 369	azmz:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;)V
    //   568: return
    //   569: iload 7
    //   571: istore 18
    //   573: iload 6
    ...
    //   3198: iconst_2
    //   3199: isub
    //   3200: invokespecial 500	azob:a	([Ljava/lang/String;II)Ljava/lang/String;
    //   3203: astore 29
    //   3205: iload 7
    //   3207: istore 16
    //   3209: iload 6
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Azoh != null) {
      this.jdField_a_of_type_Azoh.a(paramString);
    }
  }
  ...
  private void a(String... paramVarArgs)
  {
    if ((this.jdField_a_of_type_Int == 1) && (b())) {
      azny.a(new Object[] { Long.valueOf(System.currentTimeMillis()), paramVarArgs });
    }
  }
  ...
  public void a()
  {
    if (b())
    {
      ...
      if ((BaseApplicationImpl.sProcessId == 4) || (BaseApplicationImpl.sProcessId == 1) || (!aywn.a(BaseApplicationImpl.sProcessId, BaseApplicationImpl.processName))) {
        break label146;
      }
    }
    for (;;)
  ...
  void a(int paramInt, String... paramVarArgs)
  {
    ...
    {
      azny.b(new Object[] { localObject, Integer.valueOf(paramInt), Long.valueOf(l), paramVarArgs });
      return;
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (localIterator.hasNext()) {
          ((azoc)localIterator.next()).a(paramBundle);
        }
        if (!QLog.isColorLevel()) {}
      }
  ...
  {
    if (this.jdField_a_of_type_Azog != null) {
      this.jdField_a_of_type_Azog.a(paramString, paramArrayOfObject);
    }
  }
  ...
  public void c()
  {
    ...
    do
    {
      ...
      if (localObject != null)
      {
        localObject = (bavv)((QQAppInterface)localObject).getManager(233);
        if (localObject != null) {
          ((bavv)localObject).c();
        }
      }
      ...
      if (a() == 1)
      {
        ...
        while (((Iterator)localObject).hasNext()) {
          ((azoc)((Iterator)localObject).next()).b();
        }
  ...
  public void d()
  {
    ...
    if (a() == 1)
    {
      localObject = this.jdField_a_of_type_JavaUtilList.iterator();
      while (((Iterator)localObject).hasNext()) {
        ((azoc)((Iterator)localObject).next()).c();
      }
        ...
        for (;;)
        {
          ...
          catch (Exception localException5)
          {
            try
            {
              ...
              bool2 = new File(bduw.a(Environment.getExternalStorageDirectory().getPath() + "/tencent/AutoTestFlag_01")).exists();
              if (!bool2) {
                continue;
              }
              bool1 = false;
              ...
              this.jdField_a_of_type_JavaUtilList.add(new azoe(this, paramMessage[1]));
              this.jdField_a_of_type_JavaUtilList.add(new azoi(this, paramMessage[3]));
              this.jdField_a_of_type_JavaUtilList.add(new azod(this, paramMessage[4]));
              this.jdField_a_of_type_JavaUtilList.add(new azok(this, paramMessage[5]));
              this.jdField_a_of_type_JavaUtilList.add(new azon(this, paramMessage[6]));
              this.jdField_a_of_type_Azog = new azog(this, paramMessage[7]);
              this.jdField_a_of_type_JavaUtilList.add(this.jdField_a_of_type_Azog);
              if (!b()) {
                continue;
              }
              this.jdField_a_of_type_JavaUtilList.add(new azoj(this, paramMessage[2]));
              azny.a(BaseApplicationImpl.sApplication.getQQProcessName(), this.jdField_a_of_type_Long);
              paramMessage = this.jdField_a_of_type_JavaUtilList.iterator();
              if (!paramMessage.hasNext()) {
                continue;
              }
              localObject4 = (azoc)paramMessage.next();
              ((azoc)localObject4).a();
          ...
          if ((paramMessage.length >= 3) && (paramMessage[2].equals("1")))
          {
            ...
            if (Math.abs(System.currentTimeMillis() - l1) > 86400000L)
            {
              ...
              if (this.jdField_a_of_type_Long != 0L)
              {
                ...
                {
                  localObject5 = azny.a(l1, l2, 10, 3000L);
              ...
              azmz.a(BaseApplication.getContext()).a(null, "batteryFileRpt", true, 0L, 0L, null, null);
              paramMessage.edit().putLong("battery_report_timestamp", l2).commit();
            }
          }
          for (;;)
          {
            azny.a(this.jdField_a_of_type_Long - 172800000L);
            this.e = true;
            break;
