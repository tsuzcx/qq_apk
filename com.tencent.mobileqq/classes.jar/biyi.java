...
public class biyi
{
  ...
  public static String a()
  {
    do
    {
      try
      {
        String str3 = QQDeviceInfo.getMAC("f5cc92");
        str2 = str3;
        String str4;
        String str1 = str2;
      }
  ...
  public static java.util.List<String> a(File paramFile)
  {
    ...
    //   2: aconst_null
    //   3: astore 4
    //   5: new 142	java/util/ArrayList
    //   8: dup
    //   9: invokespecial 143	java/util/ArrayList:<init>	()V
    //   12: astore 6
    //   14: new 145	java/io/FileInputStream
    //   17: dup
    //   18: aload_0
    //   19: invokespecial 148	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   22: astore_0
    //   23: new 150	java/io/InputStreamReader
    //   26: dup
    //   27: aload_0
    //   28: invokespecial 153	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   31: astore_1
    //   32: new 155	java/io/BufferedReader
    //   35: dup
    //   36: aload_1
    //   37: invokespecial 158	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   40: astore 4
    //   42: aload 4
    ...
    //   97: aload_0
    //   98: invokevirtual 96	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   107: invokestatic 103	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   110: aload_2
    //   111: ifnull +7 -> 118
    //   114: aload_2
    //   115: invokevirtual 171	java/io/FileInputStream:close	()V
    //   118: aload_3
    //   119: ifnull +7 -> 126
    //   122: aload_3
    //   123: invokevirtual 172	java/io/InputStreamReader:close	()V
    //   126: aload_1
    //   127: ifnull +7 -> 134
    //   130: aload_1
    ...
    //   138: ifnull +7 -> 145
    //   141: aload_0
    //   142: invokevirtual 171	java/io/FileInputStream:close	()V
    //   145: aload_1
    //   146: ifnull +7 -> 153
    //   149: aload_1
    //   150: invokevirtual 172	java/io/InputStreamReader:close	()V
    //   153: aload 4
    //   155: ifnull -21 -> 134
    //   158: aload 4
    ...
    //   166: astore_0
    //   167: aload_0
    //   168: invokevirtual 176	java/lang/Throwable:printStackTrace	()V
    //   171: aload 6
    //   173: areturn
    //   174: astore_0
    //   175: aload_0
    //   176: invokevirtual 176	java/lang/Throwable:printStackTrace	()V
    //   179: aload 6
    //   181: areturn
    //   182: astore_0
    //   183: aconst_null
    ...
    //   188: ifnull +7 -> 195
    //   191: aload_2
    //   192: invokevirtual 171	java/io/FileInputStream:close	()V
    //   195: aload_3
    //   196: ifnull +7 -> 203
    //   199: aload_3
    //   200: invokevirtual 172	java/io/InputStreamReader:close	()V
    //   203: aload_1
    //   204: ifnull +7 -> 211
    //   207: aload_1
    ...
    //   213: astore_1
    //   214: aload_1
    //   215: invokevirtual 176	java/lang/Throwable:printStackTrace	()V
    //   218: goto -7 -> 211
    //   221: astore 4
    //   223: aconst_null
    //   224: astore_1
  ...
  public static byte[] a(File paramFile)
  {
    ...
    //   0: aconst_null
    //   1: astore 6
    //   3: new 191	java/io/BufferedInputStream
    //   6: dup
    //   7: new 145	java/io/FileInputStream
    //   10: dup
    //   11: aload_0
    //   12: invokespecial 148	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   15: invokespecial 192	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   18: astore_2
    //   19: new 194	java/io/ByteArrayOutputStream
    //   22: dup
    //   23: invokespecial 195	java/io/ByteArrayOutputStream:<init>	()V
    //   26: astore_0
    //   27: aload_0
    //   28: astore 4
    //   30: aload_2
    ...
    //   44: aload_2
    //   45: aload 5
    //   47: invokevirtual 199	java/io/BufferedInputStream:read	([B)I
    //   50: istore_1
    //   51: iload_1
    //   52: iconst_m1
    //   53: if_icmpeq +90 -> 143
    ...
    //   64: iconst_0
    //   65: iload_1
    //   66: invokevirtual 203	java/io/ByteArrayOutputStream:write	([BII)V
    //   69: goto -30 -> 39
    //   72: astore 5
    //   74: aload_0
    //   75: astore 4
    //   77: aload_2
    //   78: astore_3
    //   79: invokestatic 79	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   82: ifeq +37 -> 119
    //   85: aload_0
    //   86: astore 4
    //   88: aload_2
    ...
    //   105: aload 5
    //   107: invokevirtual 96	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   116: invokestatic 103	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   119: aload_0
    //   120: ifnull +7 -> 127
    //   123: aload_0
    //   124: invokevirtual 206	java/io/ByteArrayOutputStream:close	()V
    //   127: aload 6
    //   129: astore_0
    //   130: aload_2
    //   131: ifnull +10 -> 141
    //   134: aload_2
    //   135: invokevirtual 207	java/io/BufferedInputStream:close	()V
    //   138: aload 6
    //   140: astore_0
    //   141: aload_0
    //   142: areturn
    ...
    //   147: astore_3
    //   148: aload_0
    //   149: invokevirtual 211	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   152: astore 5
    //   154: aload 5
    //   156: astore_3
    //   157: aload_0
    //   158: ifnull +7 -> 165
    //   161: aload_0
    //   162: invokevirtual 206	java/io/ByteArrayOutputStream:close	()V
    //   165: aload_3
    //   166: astore_0
    //   167: aload_2
    //   168: ifnull -27 -> 141
    //   171: aload_2
    //   172: invokevirtual 207	java/io/BufferedInputStream:close	()V
    //   175: aload_3
    //   176: areturn
    //   177: astore_0
    //   178: aload_0
    //   179: invokevirtual 212	java/io/IOException:printStackTrace	()V
    //   182: aload_3
    //   183: areturn
    //   184: astore_0
    //   185: aload_0
    //   186: invokevirtual 212	java/io/IOException:printStackTrace	()V
    //   189: goto -24 -> 165
    //   192: astore_0
    //   193: aload_0
    ...
    //   200: astore_0
    //   201: aload_0
    //   202: invokevirtual 212	java/io/IOException:printStackTrace	()V
    //   205: aconst_null
    //   206: areturn
    //   207: astore_0
    //   208: aconst_null
    ...
    //   224: ifnull +7 -> 231
    //   227: aload_2
    //   228: invokevirtual 207	java/io/BufferedInputStream:close	()V
    //   231: aload_0
    //   232: athrow
    //   233: astore_3
    //   234: aload_3
    //   235: invokevirtual 212	java/io/IOException:printStackTrace	()V
    //   238: goto -15 -> 223
    //   241: astore_2
    //   242: aload_2
    //   243: invokevirtual 212	java/io/IOException:printStackTrace	()V
    //   246: goto -15 -> 231
    //   249: astore_0
    //   250: aconst_null
    //   251: astore 4
  ...
  public static String b(String paramString)
  {
    ...
    try
    {
      paramString = biyk.a(bixn.a(paramString, 0), biyk.a());
      if (paramString != null)
      {
  ...
  private static String d(String paramString)
  {
    ...
    //   13: aload_0
    //   14: aastore
    //   15: invokestatic 313	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   18: invokespecial 238	java/io/File:<init>	(Ljava/lang/String;)V
    //   21: invokestatic 342	biyi:a	(Ljava/io/File;)Ljava/util/List;
    //   24: astore_0
    //   25: aload_0
    //   26: ifnull +87 -> 113
    //   29: aload_0
    //   30: invokeinterface 345 1 0
    //   35: iconst_1
    //   36: if_icmpne +77 -> 113
    //   39: aload_0
    //   40: iconst_0
    //   41: invokeinterface 348 2 0
    ...
    //   56: ifne +8 -> 64
    //   59: aload_1
    //   60: invokevirtual 351	java/lang/String:trim	()Ljava/lang/String;
    //   63: astore_0
    //   64: aload_0
    //   65: areturn
    //   66: astore_2
    ...
    //   70: aload_1
    //   71: astore_0
    //   72: invokestatic 79	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   75: ifeq -11 -> 64
    //   78: ldc 81
    //   80: iconst_2
    //   81: new 83	java/lang/StringBuilder
    //   84: dup
    ...
    //   94: aload_2
    //   95: invokevirtual 96	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   104: invokestatic 103	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   107: aload_1
    //   108: areturn
    //   109: astore_2
    //   110: goto -40 -> 70
