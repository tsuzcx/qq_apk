...
public class sex
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new sfa(this, Looper.getMainLooper());
  ...
  public sex(Activity paramActivity, AppRuntime paramAppRuntime, View paramView, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131380266));
  }
  ...
  public void a(VideoInfo paramVideoInfo)
  {
    ...
    do
    {
      ...
      i = bkwm.E(this.jdField_a_of_type_MqqAppAppRuntime);
    } while (i >= 3);
    bkwm.A(this.jdField_a_of_type_MqqAppAppRuntime, i + 1);
    ...
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131380271);
    if (!TextUtils.isEmpty(paramVideoInfo.g)) {
      localTextView.setText(amtj.a(2131715176));
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new sey(this));
      this.jdField_b_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new sez(this));
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new VideofeedsUserGuideController.4(this), 300L);
      return;
      localTextView.setText(amtj.a(2131715175));
    }
  }
