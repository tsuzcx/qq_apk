...
public class bgkr
{
  ...
  public static void a(bbac parambbac, String... paramVarArgs)
  {
    ...
    if ((parambbac.a() == null) || (parambbac.a() == null)) {
      return;
    }
    LocalMultiProcConfig.putInt4Uin("key_personalize_prefix_19", 0, Long.valueOf(parambbac.a().getCurrentAccountUin()).longValue());
  ...
  public static void b(bbac parambbac, String... paramVarArgs)
  {
    ...
    if ((!TextUtils.isEmpty(localObject2)) && (parambbac.a() != null))
    {
  ...
  public static void c(bbac parambbac, String... paramVarArgs)
  {
    if (QLog.isColorLevel()) {
    ...
    if (parambbac != null) {
      parambbac.callJs("window.QzAvatarDressJSInterface.onReceive({type:\"idlist\",data:\"" + paramVarArgs + "\"});");
    }
  }
}
