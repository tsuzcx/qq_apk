...
class bgkr
  extends nte
{
  bgkr(bgko parambgko, bgkn parambgkn) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    if ((paramInt != 0) || (paramArrayOfByte == null) || (this.jdField_a_of_type_Bgkn == null))
    {
      if (QLog.isColorLevel()) {
        QLog.i(".troop.send_gift", 2, "send_oidb_0x6c3. onResult error=" + paramInt + " data=" + paramArrayOfByte + " callback=" + this.jdField_a_of_type_Bgkn);
      }
      ...
      if (((paramInt == 0) || (paramInt == 2) || (paramInt == 7)) && (((oidb_0x6c3.RspBody)localObject1).msg_get_stock.has()))
      {
        ...
        if (paramArrayOfByte.msg_stock.has())
        {
          ...
          if (((oidb_0x6c3.StockInfo)localObject1).msg_stock.has())
          {
            ...
            while (paramInt < ((List)localObject1).size())
            {
              ...
              bgky localbgky = new bgky();
              localbgky.jdField_a_of_type_Int = ((oidb_0x6c3.StockItem)localObject2).int32_productid.get();
              localbgky.b = ((oidb_0x6c3.StockItem)localObject2).int32_amount.get();
              localbgky.c = ((oidb_0x6c3.StockItem)localObject2).int32_free_limit_chance.get();
              paramBundle.add(localbgky);
              paramInt += 1;
            }
          }
        }
        this.jdField_a_of_type_Bgkn.a(paramArrayOfByte.int32_count.get(), paramArrayOfByte.int32_give_count.get(), paramArrayOfByte.bytes_give_info.get().toStringUtf8(), paramBundle);
        ...
        if (paramArrayOfByte.msg_imgshow_config.has())
        {
          ...
          while (paramInt < j)
          {
            ...
            localObject2 = new bgla();
            ((bgla)localObject2).jdField_a_of_type_Int = ((oidb_0x6c3.ImgShowItem)localObject1).uint32_price.get();
            ((bgla)localObject2).jdField_a_of_type_JavaLangString = ((oidb_0x6c3.ImgShowItem)localObject1).bytes_wording.get().toStringUtf8();
            ((bgla)localObject2).b = ((oidb_0x6c3.ImgShowItem)localObject1).bytes_cut_wording.get().toStringUtf8();
            paramBundle.put(((oidb_0x6c3.ImgShowItem)localObject1).uint32_productid.get(), localObject2);
            paramInt += 1;
          }
        }
        this.jdField_a_of_type_Bgkn.a(paramBundle);
        return;
      }
    }
    ...
    if (((paramInt == 1) || (paramInt == 3) || (paramInt == 4) || (paramInt == 5) || (paramInt == 6) || (paramInt == 8) || (paramInt == 9) || (paramInt == 10)) && (((oidb_0x6c3.RspBody)localObject1).msg_extra_data.has()))
    {
      ...
      paramBundle = aail.a(((oidb_0x6c3.RspBody)localObject1).exclusive_gift_list.get());
      paramInt = ((oidb_0x6c3.RspBody)localObject1).msg_extra_data.int32_version_seq.get();
      this.jdField_a_of_type_Bgkn.a(paramArrayOfByte.bytes_shop_config.get().toStringUtf8(), paramInt);
      this.jdField_a_of_type_Bgkn.a(paramArrayOfByte.bytes_shop_config.get().toStringUtf8(), paramInt, paramBundle);
      return;
    }
    ...
    this.jdField_a_of_type_Bgkn.a(paramInt, paramArrayOfByte);
  }
}
