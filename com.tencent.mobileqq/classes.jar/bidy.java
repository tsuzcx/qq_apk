...
{
  private bidv jdField_a_of_type_Bidv = new bidv(a());
  private EntityManager jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = this.jdField_a_of_type_Bidv.createEntityManager();
  ...
  {
    if (this.jdField_a_of_type_Bidv == null) {
      this.jdField_a_of_type_Bidv = new bidv(a());
    }
    if (this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager == null) {
      this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = this.jdField_a_of_type_Bidv.createEntityManager();
    }
