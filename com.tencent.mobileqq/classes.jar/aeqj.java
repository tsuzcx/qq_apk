...
{
  public aeqj(NearbyProfileDisplayPanel paramNearbyProfileDisplayPanel) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (paramBundle = "关注成功";; paramBundle = "已取消关注")
    {
      ...
      {
        paramBundle = (Button)NearbyProfileDisplayPanel.b(this.a).getChildAt(1).findViewById(2131365229);
        paramBundle.setTextColor(this.a.a.getResources().getColor(2131494229));
        paramBundle.setBackgroundDrawable(this.a.a.getResources().getDrawable(2130842753));
      }
      if (NearbyProfileDisplayPanel.a(this.a))
      {
        paramBundle = (Button)NearbyProfileDisplayPanel.b(this.a).getChildAt(1).findViewById(2131365229);
