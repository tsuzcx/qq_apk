...
public class blpl
{
  private static blpl jdField_a_of_type_Blpl;
  private Pattern jdField_a_of_type_JavaUtilRegexPattern = Pattern.compile("(\\d+)\\.(\\d+).(\\d+)_(\\d+)");
  
  public static blpl a()
  {
    if (jdField_a_of_type_Blpl == null) {}
    try
    {
      if (jdField_a_of_type_Blpl == null) {
        jdField_a_of_type_Blpl = new blpl();
      }
      return jdField_a_of_type_Blpl;
    }
    finally {}
  }
