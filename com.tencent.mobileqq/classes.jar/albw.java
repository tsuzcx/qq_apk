...
public class albw
{
  ...
  public boolean a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    do
    {
      ...
      localakwc = akwt.a(paramQQAppInterface);
    } while (localakwc == null);
    localakwc.a("", this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.content);
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.msg_type == 10) || (this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.msg_type == 7)) {
      akji.a(101, String.valueOf(this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.tianshuAdId), this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.tianshuTraceInfo);
    }
