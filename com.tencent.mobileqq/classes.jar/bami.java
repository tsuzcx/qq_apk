...
public class bami
  implements Manager
{
  private static bamm jdField_a_of_type_Bamm = new bamm(null);
  public static final String a;
  public static AtomicBoolean a;
  public Handler a;
  private anfx jdField_a_of_type_Anfx = new bamk(this);
  public bamp a;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private VasQuickUpdateManager.CallBacker jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new baml(this);
  private Vector<Integer> jdField_a_of_type_JavaUtilVector = new Vector();
  public ConcurrentHashMap<Integer, bamo> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = ajed.aU + ".CorlorNick/";
    jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  }
  
  public bami(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Bamp = new bamp(this);
  }
  
  public static int a(List<bbha> paramList, Paint paramPaint, Rect paramRect)
  {
    ...
    {
      bbha localbbha = (bbha)paramList.next();
      switch (localbbha.c)
      {
      }
      for (;;)
      {
        break;
        int j = (int)Math.ceil(paramPaint.measureText(localbbha.jdField_a_of_type_JavaLangString));
        paramPaint.getTextBounds(localbbha.jdField_a_of_type_JavaLangString, 0, localbbha.jdField_a_of_type_JavaLangString.length(), localRect);
        paramRect.bottom = Math.max(paramRect.bottom, localRect.height());
        i += j;
        continue;
        i += ((axkk)localbbha.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
        paramRect.bottom = Math.max(paramRect.bottom, ((axkk)localbbha.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().height());
      }
    }
    paramRect.left = 0;
    paramRect.right = i;
  ...
  public static bami a(QQAppInterface paramQQAppInterface)
  {
    return ((baov)paramQQAppInterface.getManager(235)).a;
  }
  
  private bamo a(File paramFile, int paramInt)
  {
    int i = 0;
    paramFile = bace.a(paramFile, -1);
    try
    {
      paramFile = new JSONObject(paramFile);
      bamo localbamo = new bamo();
      paramFile = paramFile.optJSONArray("baseInfo");
      if ((paramFile != null) && (paramFile.length() > 0))
      {
        Object localObject = paramFile.getJSONObject(0);
        localbamo.jdField_a_of_type_Int = ((JSONObject)localObject).optInt("type");
        if (localbamo.jdField_a_of_type_Int == 5)
        {
          ...
          localbamo.jdField_a_of_type_AndroidGraphicsBitmap = bacm.a((String)localObject, null);
          return localbamo;
        }
        localbamo.b = ((JSONObject)localObject).optInt("orientation");
        paramFile = ((JSONObject)localObject).optJSONArray("colors");
        if ((paramFile != null) && (paramFile.length() > 0))
        {
          localbamo.jdField_a_of_type_ArrayOfInt = new int[paramFile.length()];
          paramInt = 0;
          while (paramInt < paramFile.length())
          {
            String str = paramFile.getString(paramInt);
            localbamo.jdField_a_of_type_ArrayOfInt[paramInt] = Color.parseColor(str);
            paramInt += 1;
          }
        }
        if ((localbamo.jdField_a_of_type_Int != 1) && (localbamo.jdField_a_of_type_Int != 2))
        {
          paramFile = localbamo;
          if (localbamo.jdField_a_of_type_Int != 3) {
            return paramFile;
          }
        }
        ...
        localbamo.jdField_a_of_type_ArrayOfFloat = new float[((JSONArray)localObject).length()];
        paramInt = i;
        for (;;)
        {
          paramFile = localbamo;
          ...
          if (TextUtils.isDigitsOnly(paramFile))
          {
            ...
            localbamo.jdField_a_of_type_ArrayOfFloat[paramInt] = (i / 100.0F);
          }
          paramInt += 1;
        }
      }
  ...
  public static CharSequence a(MessageRecord paramMessageRecord, MsgSummary paramMsgSummary)
  {
    ...
    {
      if (!TextUtils.isEmpty(paramMsgSummary.strPrefix)) {
        localSpannableString = new axjq(paramMsgSummary.strPrefix, 16).a();
      }
      ...
      paramMsgSummary.strContent = new axkd((CharSequence)localObject, 5, 16);
  ...
  public static CharSequence a(String paramString, MessageRecord paramMessageRecord, int paramInt1, int paramInt2)
  {
    ...
    {
      str = paramMessageRecord.getExtInfoFromExtStr(awav.i);
      ...
      str = azei.a(localMessageForReplyText.mSourceMsgInfo.mSourceMsgSenderUin, str);
    }
    label71:
    for (;;)
    {
      return a(paramString, str, paramInt1, paramMessageRecord, paramInt2);
      return new axkd(paramString, paramInt2, paramInt1, paramMessageRecord);
    }
  }
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      ...
      if ((paramString2 != null) && (paramString2.size() > 0))
      {
        ...
        while (i < paramString2.size())
        {
          ...
          {
            bamn localbamn = new bamn(null);
            localbamn.jdField_a_of_type_Int = localAtTroopMemberInfo.startPos;
            ...
            {
              localbamn.b = j;
              localbamn.jdField_a_of_type_AndroidTextSpannableString = new axjq(paramString1.subSequence(localbamn.jdField_a_of_type_Int, localbamn.b), paramInt1).a();
              ((ArrayList)localObject).add(localbamn);
              break;
        ...
        {
          paramString2 = (bamn[])((ArrayList)localObject).toArray(new bamn[((ArrayList)localObject).size()]);
          Arrays.sort(paramString2, jdField_a_of_type_Bamm);
          localObject = new SpannableStringBuilder();
          ...
          if (i < m)
          {
            ...
            if (localAtTroopMemberInfo.jdField_a_of_type_Int >= j) {
              ((SpannableStringBuilder)localObject).append(new axkd(paramString1.subSequence(j, localAtTroopMemberInfo.b), paramInt2, paramInt1, paramMessageRecord));
            }
            for (;;)
            {
          ...
          if (j < paramString1.length()) {
            ((SpannableStringBuilder)localObject).append(new axkd(paramString1.subSequence(j, paramString1.length()), paramInt2, paramInt1, paramMessageRecord));
          }
          return localObject;
        }
      }
    }
    return new axkd(paramString1, paramInt2, paramInt1, paramMessageRecord);
  }
  
  public static String a(bamb parambamb)
  {
    int j = 0;
    char[] arrayOfChar = new char[7];
    arrayOfChar[0] = '<';
    arrayOfChar[1] = '%';
    arrayOfChar[2] = ((char)(parambamb.b >>> 24 & 0xFF));
    arrayOfChar[3] = ((char)(parambamb.b >>> 16 & 0xFF));
    arrayOfChar[4] = ((char)(parambamb.b >>> 8 & 0xFF));
    arrayOfChar[5] = ((char)(parambamb.b & 0xFF));
    arrayOfChar[6] = '>';
    int i = j;
  ...
  public static List<bbha> a(int paramInt1, String paramString, Paint paramPaint, bbhb parambbhb, int paramInt2)
  {
    Object localObject = new ArrayList();
    ArrayList localArrayList = new ArrayList();
    ColorClearableEditText.a((List)localObject, parambbhb, new axjq(paramString, paramInt2).a());
    int i = (int)Math.ceil(paramPaint.measureText("..."));
    paramString = ((ArrayList)localObject).iterator();
    paramInt2 = 0;
    if (paramString.hasNext())
    {
      parambbhb = (bbha)paramString.next();
      switch (parambbhb.c)
      {
      }
      for (;;)
      {
        break;
        localObject = axbo.a(paramInt1 - paramInt2, parambbhb.jdField_a_of_type_JavaLangString, paramPaint);
        int j;
        if (((String)localObject).equals(parambbhb.jdField_a_of_type_JavaLangString))
        {
          j = (int)Math.ceil(paramPaint.measureText(parambbhb.jdField_a_of_type_JavaLangString));
          localArrayList.add(parambbhb);
          paramInt2 += j;
        }
        else
        {
          parambbhb.jdField_a_of_type_JavaLangString = ((String)localObject);
          localArrayList.add(parambbhb);
          return localArrayList;
          j = ((axkk)parambbhb.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
          if (j > paramInt1 - paramInt2 - i)
          {
            localArrayList.add(new bbha(1, parambbhb.jdField_a_of_type_Int, parambbhb.b, "...", null));
            return localArrayList;
          }
          localArrayList.add(parambbhb);
          paramInt2 += j;
  ...
  public static void a(anlr paramanlr, QQAppInterface paramQQAppInterface, EditText paramEditText)
  {
    if (paramanlr.a == null)
    {
      bapm.a("emotionType", "emotionActionSend", "1", "", "", "", "", "", "", "");
    ...
    try
    {
      ...
      ((arnz)paramQQAppInterface.getManager(14)).a(String.valueOf(j), new bamj(j, i, paramEditText));
      return;
    }
    catch (NumberFormatException paramanlr)
    {
      bapm.a("emotionType", "emotionActionSend", "4", "", "", "", "", "", "", "");
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              return;
              paramSpannable = (banb[])paramSpannable.getSpans(0, paramSpannable.length(), banb.class);
    ...
    if ((paramDraftTextInfo != null) && (!TextUtils.isEmpty(paramDraftTextInfo.mAtInfoStr)) && (!TextUtils.isEmpty(paramString1)))
    {
      ...
      if (paramDraftTextInfo != null)
      {
        ...
        while (paramDraftTextInfo.hasNext())
        {
          ...
          {
            SpannableString localSpannableString = azef.a(paramQQAppInterface, paramBaseActivity, paramString2, Long.toString(localAtTroopMemberInfo.uin), paramString1.substring(localAtTroopMemberInfo.startPos + 1, localAtTroopMemberInfo.startPos + localAtTroopMemberInfo.textLen), false, paramXEditTextEx, true);
            if (localSpannableString != null) {
  ...
  public Shader a(int paramInt1, List<bbha> paramList, float paramFloat1, float paramFloat2, Rect paramRect, Paint paramPaint, int paramInt2, int paramInt3)
  {
    bamo localbamo = a(paramInt1);
    if (localbamo != null) {}
    float f1;
    float f2;
    label90:
    ...
    Object localObject3;
    bbha localbbha;
    switch (localbamo.jdField_a_of_type_Int)
    {
    default: 
      return null;
    case 1: 
      ...
      {
        return new LinearGradient(f1, f2, paramFloat1, paramFloat2, localbamo.jdField_a_of_type_ArrayOfInt, localbamo.jdField_a_of_type_ArrayOfFloat, Shader.TileMode.CLAMP);
    ...
    case 2: 
      ...
      {
        localbbha = (bbha)paramList.get(paramInt2);
        switch (localbbha.c)
        {
        default: 
          paramInt2 += 1;
        ...
        case 1: 
          ...
          paramPaint.getTextBounds(localbbha.jdField_a_of_type_JavaLangString, 0, localbbha.jdField_a_of_type_JavaLangString.length(), (Rect)localObject3);
    ...
    {
      paramInt3 = 0;
      if (paramInt3 < localbbha.jdField_a_of_type_JavaLangString.length())
      {
        float f5 = paramPaint.measureText(localbbha.jdField_a_of_type_JavaLangString, paramInt3, paramInt3 + 1);
        if (localbamo.b == 1)
        {
        ...
        {
          paramRect.setShader(new LinearGradient(paramFloat2, f1, f2, f3, localbamo.jdField_a_of_type_ArrayOfInt, localbamo.jdField_a_of_type_ArrayOfFloat, Shader.TileMode.CLAMP));
      ...
      break label324;
      paramFloat1 += ((axkk)localbbha.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
      break label324;
      return new BitmapShader((Bitmap)localObject1, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
      return new RadialGradient(paramRect.width() / 2 + paramFloat1, paramRect.height() / 2 + paramFloat2, paramRect.width() / 2, localbamo.jdField_a_of_type_ArrayOfInt, localbamo.jdField_a_of_type_ArrayOfFloat, Shader.TileMode.CLAMP);
      ...
      {
        localObject3 = (bbha)paramList.get(paramInt2);
        switch (((bbha)localObject3).c)
        {
        }
        for (;;)
        {
          ...
          break;
          int i = 0;
          while (i < ((bbha)localObject3).jdField_a_of_type_JavaLangString.length())
          {
            paramFloat2 = paramPaint.measureText(((bbha)localObject3).jdField_a_of_type_JavaLangString, i, i + 1);
            ((Paint)localObject2).setColor(localbamo.jdField_a_of_type_ArrayOfInt[(paramInt1 % localbamo.jdField_a_of_type_ArrayOfInt.length)]);
          ...
          continue;
          paramFloat1 += ((axkk)((bbha)localObject3).jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
        }
      }
      return new BitmapShader(paramRect, Shader.TileMode.REPEAT, Shader.TileMode.REPEAT);
      if (localbamo.jdField_a_of_type_AndroidGraphicsBitmap == null) {
        break;
      }
      paramList = Bitmap.createBitmap(paramInt2, paramInt3, Bitmap.Config.ARGB_8888);
      localObject1 = new Canvas(paramList);
      paramInt1 = localbamo.jdField_a_of_type_AndroidGraphicsBitmap.getWidth();
      localObject2 = new Rect();
      localObject3 = new Rect(0, 0, paramInt1, localbamo.jdField_a_of_type_AndroidGraphicsBitmap.getHeight());
      for (paramFloat1 = 0.0F; paramFloat1 < paramRect.width(); paramFloat1 += paramInt1)
      {
        ...
        ((Canvas)localObject1).drawBitmap(localbamo.jdField_a_of_type_AndroidGraphicsBitmap, (Rect)localObject3, (Rect)localObject2, paramPaint);
      }
  ...
  public bamo a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Integer.valueOf(paramInt))) {
      return (bamo)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
    }
    a(paramInt);
    return null;
  }
