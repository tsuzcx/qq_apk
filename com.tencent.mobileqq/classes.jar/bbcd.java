...
public class bbcd
  extends bbcp
{
  private bbcd(SignatureHistoryFragment paramSignatureHistoryFragment) {}
  ...
  protected void a(boolean paramBoolean, List<byte[]> paramList, List<Integer> paramList1)
  {
    ...
    SignatureHistoryFragment.a(this.a).setText(2131718137);
    SignatureHistoryFragment.b(this.a, false);
