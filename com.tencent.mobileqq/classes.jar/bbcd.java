...
public class bbcd
  implements Handler.Callback, aqzu, Manager
{
  public static final String a;
  private float jdField_a_of_type_Float = 7.0F;
  public int a;
  anyu jdField_a_of_type_Anyu = new bbce(this);
  private aojs jdField_a_of_type_Aojs = new bbcf(this);
  private blha jdField_a_of_type_Blha = new blha(ThreadManager.getFileThreadLooper(), this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private final Object jdField_a_of_type_JavaLangObject = new Object();
  private WeakReference<bbch> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  private WeakReference<bbcc> jdField_b_of_type_JavaLangRefWeakReference;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anzj.a(2131704592);
  }
  
  public bbcd(QQAppInterface paramQQAppInterface)
  {
  ...
  private Object[] a(boolean paramBoolean, String paramString)
  {
    ...
    if (!paramBoolean) {
      localObject2 = bhsi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), "breaking_ice_config");
    }
    bool6 = bool7;
    i1 = i2;
    n = i3;
  ...
  private void g()
  {
    ...
    Object localObject1 = bhmi.a(String.format("%s_%s", new Object[] { "break_ice_map", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bhmi.a(String.format("%s_%s", new Object[] { "entered_c2c", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bhmi.a(String.format("%s_%s", new Object[] { "entered_troop", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bhmi.a(String.format("%s_%s", new Object[] { "entered_match_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bhmi.a(String.format("%s_%s", new Object[] { "entered_qcircle_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
  ...
  private void h()
  {
    ...
    bhmi.a(String.format("%s_%s", new Object[] { "break_ice_map", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localConcurrentHashMap);
  }
    ...
    if (localTroopInfo.wMemberNum < this.jdField_b_of_type_Int)
    {
      ...
      if ((localObject2 == null) || (((List)localObject2).size() <= 1))
      {
        ...
        for (i = 0;; i = ((List)localObject2).size())
        {
          ...
          ((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).o(paramString);
          return;
        }
      }
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if ((TextUtils.isEmpty(str2)) || (str2.equals(str1)) || (((anyw)localObject1).b(str2))) {
          break label318;
        }
        i += 1;
      }
  ...
  public void a(bbcc parambbcc)
  {
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(parambbcc);
  }
  
  public void a(bbch parambbch)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambbch);
  }
  
  public void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString, aqzt paramaqzt)
  {
    if ((paramaqzt != null) && ("breaking_ice_config".equals(paramString)))
    {
      if (!this.jdField_b_of_type_Boolean) {
        g();
      }
      paramQQAppInterface = a(true, paramaqzt.jdField_a_of_type_JavaLangString);
      ...
      if ((bool1 != this.jdField_c_of_type_Boolean) || (bool2 != this.jdField_d_of_type_Boolean))
      {
        ...
        if (a(this.jdField_c_of_type_Boolean, this.jdField_d_of_type_Boolean, paramQQAppInterface))
        {
          ...
          if (this.jdField_a_of_type_Blha.hasMessages(1)) {
            this.jdField_a_of_type_Blha.removeMessages(1);
          }
          this.jdField_a_of_type_Blha.sendEmptyMessage(1);
        }
      }
      if (QLog.isColorLevel())
      {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = ((anyw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      ...
      for (;;)
      {
        ...
        paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aito.class);
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      return;
      Object localObject = ((anyw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString);
      boolean bool;
      int i;
      if ((localObject != null) && (((Friends)localObject).isFriend()))
      {
        ...
        {
          localObject = (bbch)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localObject != null) {
            ((bbch)localObject).a(paramString, false);
          }
        }
        if (this.jdField_a_of_type_Blha.hasMessages(1)) {
          this.jdField_a_of_type_Blha.removeMessages(1);
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("IceBreak.HotPic", 2, blhk.a(paramArrayOfByte));
        return;
        ...
        while (i < paramArrayOfByte.size())
        {
          ...
          localaitc.a(localImgInfo.bytes_img_word.get().toStringUtf8());
          ...
          ((List)localObject).add(localaitc);
          i += 1;
        }
  ...
  public void b()
  {
    ...
    bhmi.a(String.format("%s_%s", new Object[] { "entered_c2c", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  
  public void b(bbch parambbch)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() == parambbch)) {
  ...
  public void c()
  {
    ...
    bhmi.a(String.format("%s_%s", new Object[] { "entered_troop", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public void d()
  {
    ...
    bhmi.a(String.format("%s_%s", new Object[] { "entered_match_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public void e()
  {
    ...
    bhmi.a(String.format("%s_%s", new Object[] { "entered_qcircle_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public boolean e(String paramString)
  {
    ...
    if (localObject != null)
    {
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        bbch localbbch = (bbch)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localbbch != null) {
          localbbch.b(paramString, false);
        }
      }
      if (this.jdField_a_of_type_Blha.hasMessages(1)) {
        this.jdField_a_of_type_Blha.removeMessages(1);
  ...
  public boolean f(String paramString)
  {
    ...
    if (bool2)
    {
      paramString = ((anyw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString);
  ...
  public void j(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (((asvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(264)).e()) {
            break;
          }
      ...
      localbbch = (bbch)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localbbch == null);
    localbbch.a(paramString, false);
  }
  ...
  {
    if (!aiti.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b()) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if ((localTroopMemberInfo == null) || (localTroopMemberInfo.last_active_time == localTroopMemberInfo.join_time))
      {
        ...
        this.jdField_d_of_type_JavaLangString = paramString;
        ((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(Long.valueOf(paramString).longValue(), Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue(), true);
        return;
      }
