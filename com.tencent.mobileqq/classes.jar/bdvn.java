...
public class bdvn
{
  private static final Interpolator jdField_a_of_type_AndroidViewAnimationInterpolator = new bdvo();
  ...
  private final bdvp jdField_a_of_type_Bdvp;
  ...
  private bdvn(Context paramContext, ViewGroup paramViewGroup, bdvp parambdvp)
  {
    ...
    this.jdField_a_of_type_Bdvp = parambdvp;
  ...
  private int a(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    {
      paramInt1 = a(paramInt1, paramInt3, this.jdField_a_of_type_Bdvp.a(paramView));
      paramInt2 = a(paramInt2, paramInt4, this.jdField_a_of_type_Bdvp.b(paramView));
      float f3 = paramInt1;
  ...
  public static bdvn a(ViewGroup paramViewGroup, float paramFloat, bdvp parambdvp)
  {
    paramViewGroup = a(paramViewGroup, parambdvp);
    paramViewGroup.jdField_b_of_type_Int = ((int)(paramViewGroup.jdField_b_of_type_Int * (1.0F / paramFloat)));
    return paramViewGroup;
  }
  
  public static bdvn a(ViewGroup paramViewGroup, bdvp parambdvp)
  {
    return new bdvn(paramViewGroup.getContext(), paramViewGroup, parambdvp);
  }
  
  private void a(float paramFloat1, float paramFloat2)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Bdvp.a(this.jdField_a_of_type_AndroidViewView, paramFloat1, paramFloat2);
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt3 != 0)
    {
      paramInt1 = this.jdField_a_of_type_Bdvp.a(this.jdField_a_of_type_AndroidViewView, paramInt1, paramInt3);
    ...
    for (;;)
    {
      if (paramInt4 != 0)
      {
        paramInt2 = this.jdField_a_of_type_Bdvp.b(this.jdField_a_of_type_AndroidViewView, paramInt2, paramInt4);
        this.jdField_a_of_type_AndroidViewView.offsetTopAndBottom(paramInt2 - j);
      }
      for (;;)
      {
        if ((paramInt3 != 0) || (paramInt4 != 0)) {
          this.jdField_a_of_type_Bdvp.a(this.jdField_a_of_type_AndroidViewView, paramInt1, paramInt2, paramInt1 - i, paramInt2 - j);
        }
        return;
      }
    }
  ...
  private boolean a(float paramFloat1, float paramFloat2, int paramInt1, int paramInt2)
  {
    ...
    {
      return false;
      if ((paramFloat1 < paramFloat2 * 0.5F) && (this.jdField_a_of_type_Bdvp.a(paramInt2)))
      {
  ...
  private boolean a(View paramView, float paramFloat1, float paramFloat2)
  {
    ...
    do
    {
      ...
      do
      {
        return bool;
        int i;
        if (this.jdField_a_of_type_Bdvp.a(paramView) > 0)
        {
          i = 1;
          if (this.jdField_a_of_type_Bdvp.b(paramView) <= 0) {
            break label80;
          }
        }
        for (j = 1;; j = 0)
  ...
  private void b(float paramFloat1, float paramFloat2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        ...
        this.jdField_a_of_type_Bdvp.b(i, paramInt);
      }
      return;
      j = 0;
    }
  ...
  public View a(int paramInt1, int paramInt2)
  {
    ...
    while (i >= 0)
    {
      View localView = this.jdField_a_of_type_AndroidViewViewGroup.getChildAt(this.jdField_a_of_type_Bdvp.a(i));
      ...
      do
      {
        do
        {
          do
          {
            ...
            this.jdField_a_of_type_Bdvp.a(j & this.f, i);
            return;
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    this.jdField_a_of_type_Bdvp.a(paramView, paramInt);
    b(1);
  }
    ...
    while (this.jdField_a_of_type_Int == 1)
    {
      ...
      if ((this.f & j) != 0)
      {
        ...
        if (this.jdField_a_of_type_Int == 0)
        {
          ...
          if ((this.f & i) != 0) {
            this.jdField_a_of_type_Bdvp.a(i & this.f, j);
          }
        }
            ...
            if ((this.jdField_a_of_type_ArrayOfFloat != null) && (this.jdField_b_of_type_ArrayOfFloat != null))
            {
              ...
              while (i < k)
              {
                ...
                else
                {
                  ...
                  int i1 = (int)f3;
                  i1 = this.jdField_a_of_type_Bdvp.a(localView, i1 + n, (int)f3);
                  int i2 = localView.getTop();
                  int i3 = (int)f4;
                  i3 = this.jdField_a_of_type_Bdvp.b(localView, i3 + i2, (int)f4);
                  int i4 = this.jdField_a_of_type_Bdvp.a(localView);
                  int i5 = this.jdField_a_of_type_Bdvp.b(localView);
  ...
  boolean a(View paramView, int paramInt)
  {
    ...
    if ((paramView != null) && (this.jdField_a_of_type_Bdvp.a(paramView, paramInt)))
    {
      this.jdField_c_of_type_Int = paramInt;
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Int == 2)
    {
      ...
      if ((k != 0) || (m != 0)) {
        this.jdField_a_of_type_Bdvp.a(this.jdField_a_of_type_AndroidViewView, i, j, k, m);
      }
  ...
  public void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Int != paramInt)
    {
      ...
      this.jdField_a_of_type_Bdvp.a(paramInt);
      if (this.jdField_a_of_type_Int == 0) {
