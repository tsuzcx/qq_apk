  ...
  implements bhmp
{
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    this.a.jdField_a_of_type_ComTencentAvVideoController.a().B = paramInt2;
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (mwk.a(this.a) != null) {
      mwk.a(this.a).a(paramString);
    }
  }
  ...
  public void a(int paramInt, String[] paramArrayOfString, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentAvVideoController != null)
      {
        ...
        mwk.a(this.a, paramArrayOfString);
        mwk.a(this.a, paramString2, paramString1);
        if (paramArrayOfString != null)
        {
          ...
          while (paramInt < paramArrayOfString.length)
          {
            if (paramArrayOfString[paramInt].equals("DEVICE_WIREDHEADSET")) {
              mtq.k(this.a.jdField_a_of_type_ComTencentAvVideoController);
            }
            paramInt += 1;
          }
        }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    this.a.jdField_a_of_type_ComTencentAvVideoController.a().B = paramInt;
    if (QLog.isColorLevel()) {
  ...
  public void a(long paramLong, String[] paramArrayOfString, String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      do
      {
        ...
        paramString2 = "";
        String[] arrayOfString = ((lid)localObject).a;
        if (((lid)localObject).c != 3)
        {
          paramString2 = ((lid)localObject).q;
          ((lid)localObject).b("onDeviceListUpdate", paramString1);
        }
        ((lid)localObject).a = paramArrayOfString;
        ((lid)localObject).r = paramString3;
        mwk.a(this.a, paramArrayOfString);
        mwk.a(this.a, paramString2, paramString1);
        if (mwk.a(this.a) != null) {
          mwk.a(this.a).notifyDataSetChanged();
        }
        this.a.a();
      ...
      } while (mwk.a(this.a) == null);
      mwk.a(this.a).a(null, new mwq(paramArrayOfString));
    } while (this.a.jdField_a_of_type_ComTencentSharpJniTraeAudioSession == null);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      } while (((i == 1) || (i == 2)) && ((!this.a.jdField_a_of_type_ComTencentAvVideoController.e()) || (!this.a.jdField_a_of_type_ComTencentAvVideoController.a().k()) || (this.a.jdField_b_of_type_MqqUtilWeakReference == null)));
