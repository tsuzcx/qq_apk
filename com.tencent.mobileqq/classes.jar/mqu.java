...
public abstract class mqu
  extends mqr
{
  public mqu(Context paramContext, WeakReference<ZimuView> paramWeakReference, int paramInt1, int paramInt2, float paramFloat)
  {
  ...
  {
    return (int)(a(this.jdField_a_of_type_Ljf.a.length()) * paramLong / 1000L);
  }
