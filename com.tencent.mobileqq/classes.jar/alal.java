...
public class alal
  implements akxz, akyf, alac, Handler.Callback, View.OnTouchListener, ARNativeBridge.ARWorldCupCallback
{
  public volatile int a;
  volatile long jdField_a_of_type_Long = -1L;
  private akxy jdField_a_of_type_Akxy = new akxy(this, 1);
  ...
  private alfd jdField_a_of_type_Alfd;
  private alxs jdField_a_of_type_Alxs;
  private alxw jdField_a_of_type_Alxw = new alam(this);
  ...
  public alal(alae paramalae, alan paramalan)
  {
    this.jdField_a_of_type_Int = 0;
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Alae = paramalae;
    this.jdField_a_of_type_Alan = paramalan;
    this.jdField_a_of_type_AndroidContentContext = this.jdField_a_of_type_Alae.a();
    this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge = ((ARNativeBridge)paramalae.a(0));
    this.jdField_a_of_type_Akye = ((akye)paramalae.a(8));
    boolean bool = albf.a();
    int j;
    long l;
    if (this.jdField_a_of_type_Boolean)
    {
      paramalae = this.jdField_a_of_type_AndroidContentContext;
      if (bool)
      {
        j = 5;
        this.jdField_a_of_type_Alxs = new alxs(paramalae, j);
      }
    }
    else
    {
      ...
      this.jdField_c_of_type_Boolean = albf.jdField_a_of_type_Boolean;
    ...
    label304:
    for (paramalae = alez.a().a((Activity)this.jdField_a_of_type_AndroidContentContext);; paramalae = null)
    {
      this.jdField_a_of_type_Alfd = paramalae;
      if (this.jdField_a_of_type_Alfd != null)
      {
        this.jdField_a_of_type_Akxy.a();
        this.jdField_a_of_type_Alfd.a(this.jdField_a_of_type_AndroidContentContext);
        akxv.jdField_a_of_type_Int = 9;
      }
  ...
  private void a(int paramInt)
  {
    ...
    case 6: 
      do
      {
        ...
        return;
        this.jdField_a_of_type_Alae.a(new ARTransferPromotionRenderable.11(this));
  ...
  private void a(int paramInt1, String paramString, boolean paramBoolean1, int paramInt2, boolean paramBoolean2)
  {
    ...
    for (int j = k;; j = 0)
    {
      if ((localFile.exists()) || (j != 0))
      {
        ...
        this.jdField_a_of_type_Akxy.a(paramString, 123456L, paramBoolean1, paramInt2, paramBoolean2);
      }
      return;
    }
  }
  ...
  private void a(float[] arg1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3, float[] paramArrayOfFloat4, float[] paramArrayOfFloat5)
  {
    ...
    if (this.jdField_e_of_type_Boolean)
    {
      ...
      if (j >= 1)
      {
        ...
        this.jdField_a_of_type_Akye.b(true);
        ??? = this.jdField_a_of_type_Akye;
        this.jdField_a_of_type_Akye.getClass();
        ???.c(6);
  ...
  {
    if (this.jdField_a_of_type_Alfd == null) {}
    while ((!this.jdField_a_of_type_Alfd.a()) || (this.jdField_a_of_type_Alae.a() == null)) {
      return false;
    }
    paramArrayOfFloat = new float[4];
    float[] arrayOfFloat = new float[3];
    int j = this.jdField_a_of_type_Alae.a().a();
    FloatBuffer localFloatBuffer = this.jdField_a_of_type_Alfd.a(j, paramArrayOfFloat, arrayOfFloat);
    if ((j == -1) || (localFloatBuffer == null))
    {
      a(-1.0F, -1.0F, -1.0F);
      return false;
    }
    this.jdField_a_of_type_Alae.a().a(j);
    this.jdField_a_of_type_Alae.a().a(localFloatBuffer, this.jdField_a_of_type_Alfd.a());
  ...
  private void i()
  {
    if (this.jdField_a_of_type_Alfd != null)
    {
      ...
      alku.a().e();
      this.jdField_a_of_type_Alfd.a(this.jdField_f_of_type_Int, this.jdField_g_of_type_Int);
      this.jdField_a_of_type_Alfd.c();
    }
  }
  
  private void j()
  {
    if ((this.jdField_a_of_type_Bfnk != null) && (!this.jdField_a_of_type_Bfnk.hasMessages(1105))) {
      this.jdField_a_of_type_Bfnk.sendEmptyMessageDelayed(1105, 200L);
    }
  ...
  private void k()
  {
    ...
    {
      this.jdField_a_of_type_Bfnk.removeMessages(1105);
      this.jdField_a_of_type_Akye.a(false, "");
    }
  ...
  public String a()
  {
    return this.jdField_a_of_type_Alan.jdField_a_of_type_JavaLangString;
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Akye.f();
    this.jdField_a_of_type_Akye.a(false, "");
    axqy.b(null, "CliOper", "", "", "0X80098C8", "0X80098C8", 0, 0, this.jdField_a_of_type_Alan.jdField_a_of_type_JavaLangString, "0", "0", "");
  ...
  {
    a((float[])paramalak.a("TARGET_SIZE"), (float[])paramalak.a("POSE"), (float[])paramalak.a("CAMERA_MATRIX"), (float[])paramalak.a("CAMERA_POSITION"), paramalak.a);
  }
  ...
  public int b()
  {
    return this.jdField_a_of_type_Alan.jdField_a_of_type_Int;
  }
  
  public String b()
  {
    return this.jdField_a_of_type_Alan.c;
  }
  ...
  public int c()
  {
    return this.jdField_a_of_type_Alan.jdField_b_of_type_Int;
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Akye.a(this);
    if (!this.jdField_a_of_type_Alan.jdField_a_of_type_JavaLangBoolean.booleanValue()) {
      this.jdField_a_of_type_Akye.e();
    }
    if ((this.jdField_a_of_type_Alxs != null) && (this.jdField_a_of_type_Boolean)) {
      QLog.d("ARTransferPromotionRenderable", 2, String.format("setNativeState start sensor result=%s", new Object[] { Boolean.valueOf(this.jdField_a_of_type_Alxs.a(this.jdField_a_of_type_Alxw)) }));
    }
  }
  
  public boolean c()
  {
    return !this.jdField_a_of_type_Alan.jdField_a_of_type_JavaLangBoolean.booleanValue();
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Alae != null) {
      this.jdField_a_of_type_Alae.a(local7);
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if ((this.jdField_a_of_type_Akxy != null) && (this.jdField_a_of_type_Akxy.a()) && (this.jdField_a_of_type_Akyg != null))
    {
      long l = this.jdField_a_of_type_Akxy.a();
      paramMessage = this.jdField_a_of_type_Akyg.a(l);
    ...
    for (;;)
    {
      ...
      return false;
      label98:
      this.jdField_a_of_type_Akye.a(true, paramMessage.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    if (this.jdField_b_of_type_Int == 4)
    {
      ...
      if ((this.jdField_a_of_type_Alae != null) && (this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge != null)) {
        this.jdField_a_of_type_Alae.a(new ARTransferPromotionRenderable.17(this, paramView));
      }
