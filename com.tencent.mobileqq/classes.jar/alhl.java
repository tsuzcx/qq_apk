  ...
  extends IArkDelegateNet
{
  public void download(String paramString, boolean paramBoolean1, boolean paramBoolean2, HashMap<String, String> paramHashMap, File paramFile, IArkDelegateNetCallback paramIArkDelegateNetCallback)
  {
    ...
    for (paramFile = paramFile.getAbsolutePath();; paramFile = "")
    {
      ...
      algw.a().a("callDownload", (Bundle)localObject, new alho(this, paramString, paramIArkDelegateNetCallback));
      return;
      str = "";
      break;
      paramHashMap = "";
    ...
    label175:
    Object localObject = ((bato)BaseApplicationImpl.getApplication().getRuntime().getManager(47)).a(1);
    paramFile = new batm(paramString, new File(paramFile));
    ...
    ((batr)localObject).a(paramFile, new alhp(this, paramString, paramIArkDelegateNetCallback), paramHashMap);
  }
  ...
  public void sendAppMsg(String paramString1, String paramString2, int paramInt1, int paramInt2, IArkDelegateNetCallback paramIArkDelegateNetCallback)
  {
    ...
    if (1 != BaseApplicationImpl.sProcessId)
    {
      ...
      algw.a().a("callSendAppMsg", (Bundle)localObject, new alhm(this, paramString1, paramString2, paramIArkDelegateNetCallback, paramInt2));
      return;
    }
    ...
    ((alez)localObject).a(paramString1, paramString2, paramInt1, paramInt2, new alhn(this, paramIArkDelegateNetCallback));
  }
}
