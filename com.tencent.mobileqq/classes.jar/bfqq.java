...
public class bfqq
{
  private static arfn<bfqq, Void> jdField_a_of_type_Arfn = new bfqr();
  private final byte jdField_a_of_type_Byte = 2;
  private FileObserver jdField_a_of_type_AndroidOsFileObserver;
  private Handler jdField_a_of_type_AndroidOsHandler = new bfqs(this, ThreadManager.getSubThreadLooper());
  private volatile boolean jdField_a_of_type_Boolean;
  private final byte jdField_b_of_type_Byte = 1;
  private volatile boolean jdField_b_of_type_Boolean;
  
  public static bfqq a()
  {
    return (bfqq)jdField_a_of_type_Arfn.b(null);
  }
  ...
  private void a(int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    do
    {
      ...
      {
        if (paramInt2 >= 1) {
          awrn.a(BaseApplication.getContext()).a((String)localObject, "qzoneRecovery", paramBoolean, 0L, 0L, null, "");
        }
    ...
    {
      localawrn.a((String)localObject, "qzoneOdexCheck", paramBoolean, 0L, 0L, localHashMap, "");
      return;
      j = 0;
      break;
      i = 0;
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        ...
        localFile1 = new File(localFile1, "qzone_plugin_" + bfpk.a());
        QLog.i("QZoneStartupMonitor", 1, "copy from " + localFile2.getPath() + " to " + localFile1.getPath());
        bace.a(localFile2, localFile1);
      }
      return;
      label280:
  ...
  private void d()
  {
    if (!QzonePluginProxyActivity.a())
    {
      ...
      do
      {
        ...
        localObject2 = (bfcz)((QQAppInterface)localObject1).getManager(27);
        QLog.i("QZoneStartupMonitor", 1, "reInstallQzone cancelInstall:qzone_plugin.apk");
        ((bfcz)localObject2).cancelInstall("qzone_plugin.apk");
      } while (((bfcz)localObject2).isPlugininstalled("qzone_plugin.apk"));
      ...
      a((File)localObject2);
      bfpr.a((QQAppInterface)localObject1, "reInstallQzone");
      return;
    }
  ...
  public void b()
  {
    ...
    //   2: aload_0
    //   3: monitorenter
    //   4: invokestatic 410	common/config/service/QzoneConfig:getInstance	()Lcommon/config/service/QzoneConfig;
    //   7: ldc_w 412
    //   10: ldc_w 414
    //   13: iconst_1
    //   14: invokevirtual 418	common/config/service/QzoneConfig:getConfig	(Ljava/lang/String;Ljava/lang/String;I)I
    //   17: iconst_1
    //   18: if_icmpne +19 -> 37
    //   21: iload_1
    //   22: ifne +20 -> 42
    ...
    //   39: goto -18 -> 21
    //   42: aload_0
    //   43: getfield 422	bfqq:jdField_a_of_type_AndroidOsFileObserver	Landroid/os/FileObserver;
    //   46: ifnonnull -12 -> 34
    ...
    //   81: aload_2
    //   82: invokevirtual 352	java/io/File:getPath	()Ljava/lang/String;
    ...
    //   99: aload_0
    //   100: aload_2
    //   101: invokevirtual 352	java/io/File:getPath	()Ljava/lang/String;
    //   104: sipush 768
    //   107: invokespecial 429	bfqt:<init>	(Lbfqq;Ljava/lang/String;I)V
    //   110: putfield 422	bfqq:jdField_a_of_type_AndroidOsFileObserver	Landroid/os/FileObserver;
    //   113: aload_0
    //   114: getfield 422	bfqq:jdField_a_of_type_AndroidOsFileObserver	Landroid/os/FileObserver;
    //   117: invokevirtual 434	android/os/FileObserver:startWatching	()V
    //   120: goto -86 -> 34
    //   123: astore_2
    //   124: aload_0
    //   125: monitorexit
