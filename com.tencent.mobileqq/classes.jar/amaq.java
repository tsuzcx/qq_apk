...
public final class amaq
{
  ...
  static
  {
    jdField_a_of_type_Amar = new amar(null);
  }
  
  public amaq(int paramInt1, @NotNull String paramString1, @NotNull String paramString2, @NotNull String paramString3, int paramInt2, int paramInt3)
  {
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof amaq))
      {
        paramObject = (amaq)paramObject;
