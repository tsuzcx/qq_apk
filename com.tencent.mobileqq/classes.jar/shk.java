...
public final class shk
  implements Runnable
{
  public shk(String paramString1, Activity paramActivity, String paramString2, String paramString3, QQAppInterface paramQQAppInterface) {}
  ...
  public void run()
  {
    ...
    this.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new shl(this, str));
  }
}
