...
public final class shk
  implements ISuperPlayer.OnCaptureImageListener, ISuperPlayer.OnCompletionListener, ISuperPlayer.OnErrorListener, ISuperPlayer.OnInfoListener, ISuperPlayer.OnSeekCompleteListener, ISuperPlayer.OnVideoPreparedListener, sgx
{
  private float jdField_a_of_type_Float;
  private final ISuperPlayer jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer;
  private sgw jdField_a_of_type_Sgw;
  private shf jdField_a_of_type_Shf;
  
  public shk(@Nullable ISuperPlayer paramISuperPlayer)
  {
  ...
  public shf a()
  {
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null) {
        return (shf)new sho((ISPlayerVideoView)localObject);
      }
    }
    return null;
  }
  ...
  public void a(@NotNull Context paramContext, @NotNull shi paramshi, long paramLong, @NotNull SuperPlayerOption paramSuperPlayerOption)
  {
    ...
    ISuperPlayer localISuperPlayer = this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer;
    if (localISuperPlayer != null) {
      localISuperPlayer.openMediaPlayer(paramContext.getApplicationContext(), shj.a(paramshi), paramLong, paramSuperPlayerOption);
    }
  }
  
  public void a(@Nullable sgw paramsgw)
  {
    this.jdField_a_of_type_Sgw = paramsgw;
    paramsgw = this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer;
    if (paramsgw != null) {
      paramsgw.setOnVideoPreparedListener((ISuperPlayer.OnVideoPreparedListener)this);
    }
    paramsgw = this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer;
    if (paramsgw != null) {
      paramsgw.setOnCompletionListener((ISuperPlayer.OnCompletionListener)this);
    }
    paramsgw = this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer;
    if (paramsgw != null) {
      paramsgw.setOnErrorListener((ISuperPlayer.OnErrorListener)this);
    }
    paramsgw = this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer;
    if (paramsgw != null) {
      paramsgw.setOnInfoListener((ISuperPlayer.OnInfoListener)this);
    }
    paramsgw = this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer;
    if (paramsgw != null) {
      paramsgw.setOnCaptureImageListener((ISuperPlayer.OnCaptureImageListener)this);
    }
    paramsgw = this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer;
    if (paramsgw != null) {
      paramsgw.setOnSeekCompleteListener((ISuperPlayer.OnSeekCompleteListener)this);
    }
  }
  
  public void a(@Nullable shf paramshf)
  {
    this.jdField_a_of_type_Shf = paramshf;
    ISuperPlayer localISuperPlayer = this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer;
    if (localISuperPlayer != null) {
      if (paramshf == null) {
        break label47;
    ...
    label47:
    for (paramshf = paramshf.a();; paramshf = null)
    {
      shf localshf = paramshf;
      if (!(paramshf instanceof ISPlayerVideoView)) {
        localshf = null;
      }
      localISuperPlayer.updatePlayerVideoView((ISPlayerVideoView)localshf);
      return;
    }
  }
  ...
  public void c()
  {
    ...
    localObject = this.jdField_a_of_type_Shf;
    if (localObject != null)
    {
      ISuperPlayer localISuperPlayer = this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer;
      if (localISuperPlayer != null)
      {
        View localView = ((shf)localObject).a();
  ...
  {
    paramISuperPlayer = this.jdField_a_of_type_Sgw;
    if (paramISuperPlayer != null) {
      paramISuperPlayer.a((sgx)this, paramInt1, paramInt2);
    }
  }
  ...
  public void onCaptureImageSucceed(@Nullable ISuperPlayer paramISuperPlayer, int paramInt1, int paramInt2, int paramInt3, @Nullable Bitmap paramBitmap)
  {
    paramISuperPlayer = this.jdField_a_of_type_Sgw;
    if (paramISuperPlayer != null) {
      paramISuperPlayer.a((sgx)this, paramInt1, paramInt2, paramInt3, paramBitmap);
    }
  }
  ...
  {
    paramISuperPlayer = this.jdField_a_of_type_Sgw;
    return (paramISuperPlayer != null) && (paramISuperPlayer.a((sgx)this, paramInt1, paramInt2, paramInt3, paramString) == true);
  }
  ...
  public boolean onInfo(@Nullable ISuperPlayer paramISuperPlayer, int paramInt, long paramLong1, long paramLong2, @Nullable Object paramObject)
  {
    ...
    for (paramISuperPlayer = Long.valueOf(paramLong1);; paramISuperPlayer = paramObject)
    {
      ...
      if (paramInt == 207)
      {
        ...
        paramObject = this.jdField_a_of_type_Sgw;
        if (paramObject != null) {
      ...
      paramObject = this.jdField_a_of_type_Sgw;
      if ((paramObject != null) && (paramObject.a((sgx)this, i, paramISuperPlayer) == true)) {}
