  ...
  implements shc
{
  ...
  bchv jdField_a_of_type_Bchv = null;
  bcpq jdField_a_of_type_Bcpq;
  public CustomWebView a;
  public String a;
  private HashMap<String, Integer> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private List<shp> jdField_a_of_type_JavaUtilList;
  public oof a;
  private pci jdField_a_of_type_Pci;
  private sgy jdField_a_of_type_Sgy;
  private shs jdField_a_of_type_Shs;
  public wxu a;
  private String jdField_b_of_type_JavaLangString;
  private List<shp> jdField_b_of_type_JavaUtilList;
  private String c;
  
  public shk(pci parampci, wxu paramwxu)
  {
    this.jdField_a_of_type_Pci = parampci;
    this.jdField_a_of_type_Bcdb = parampci.mRuntime;
    this.jdField_a_of_type_Wxu = paramwxu;
    this.jdField_a_of_type_AndroidAppActivity = a();
    this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = this.jdField_a_of_type_Bcdb.a();
    parampci = this.jdField_a_of_type_Bcdb.a(this.jdField_a_of_type_Bcdb.a());
    if ((parampci != null) && ((parampci instanceof bchv))) {
      this.jdField_a_of_type_Bchv = ((bchv)parampci);
    }
    parampci = this.jdField_a_of_type_Bcdb.a(this.jdField_a_of_type_Bcdb.a());
    if ((parampci != null) && ((parampci instanceof bchj))) {
      this.jdField_a_of_type_Bchj = ((bchj)parampci);
    }
  ...
  private List<shp> a()
  {
    ...
    localArrayList.add(new shp("kandian", 1, false));
    localArrayList.add(new shp("qq_friend", 2, false));
    localArrayList.add(new shp("qzone", 3, false));
    localArrayList.add(new shp("we_chat", 4, false));
    localArrayList.add(new shp("we_chat_circle", 5, false));
    localArrayList.add(new shp("we_bo", 6, false));
    localArrayList.add(new shp("qq_browser", 7, false));
    localArrayList.add(new shp("sys_browser", 8, false));
    return localArrayList;
  }
  
  private List<shp> a(JSONArray paramJSONArray)
  {
    ArrayList localArrayList = new ArrayList();
        ...
        if (i < j)
        {
          ...
          if ((localObject1 instanceof String))
          {
            ...
            if (localObject2 != null) {
              localArrayList.add(new shp((String)localObject1, ((Integer)localObject2).intValue(), false));
            }
          }
          else if ((localObject1 instanceof JSONObject))
          {
            ...
            if ((!TextUtils.isEmpty((CharSequence)localObject2)) && (this.jdField_a_of_type_JavaUtilHashMap.get(localObject2) != null))
            {
              ...
              {
                bool = true;
                localArrayList.add(new shp((String)localObject2, m, bool));
              }
            }
          }
        }
  ...
  private shp a(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    shp localshp;
    while (localIterator.hasNext())
    {
      localshp = (shp)localIterator.next();
      if (localshp.a == paramInt) {
        return localshp;
      }
    }
  ...
  private List<Integer>[] a()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localArrayList1.add(Integer.valueOf(((shp)((Iterator)localObject).next()).a));
    }
    ArrayList localArrayList2 = new ArrayList();
    localObject = this.jdField_b_of_type_JavaUtilList.iterator();
    while (((Iterator)localObject).hasNext()) {
      localArrayList2.add(Integer.valueOf(((shp)((Iterator)localObject).next()).a));
    }
    if (localArrayList2.contains(Integer.valueOf(28)))
    {
      if (this.jdField_a_of_type_Shs != null) {
        break label152;
      }
      localObject = null;
      if (!ayec.a((String)localObject)) {
        break label163;
      }
      ayec.a(0, 3);
    }
    for (;;)
    {
      ...
      label152:
      localObject = this.jdField_a_of_type_Shs.c;
      break;
      label163:
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new shp("screen_shot", 9, false));
    localArrayList.add(new shp("set_font", 10, false));
    localArrayList.add(new shp("add_favourite", 12, false));
    localArrayList.add(new shp("export_tencent_docs", 28, false));
    localArrayList.add(new shp("send_pc", 13, false));
    localArrayList.add(new shp("copy_link", 14, false));
    localArrayList.add(new shp("report", 20, false));
    return localArrayList;
  }
  ...
  private void d()
  {
    String str1 = this.jdField_a_of_type_Shs.a;
    String str2 = this.jdField_a_of_type_Shs.jdField_b_of_type_JavaLangString;
    String str3 = this.jdField_a_of_type_Shs.d;
    String str4 = this.jdField_a_of_type_Bcdb.a().f;
    String str5 = this.jdField_a_of_type_Shs.f;
    bgpd.a(0, str1, this.jdField_a_of_type_Shs.c, str5, str2, str3, null, null, false, -1L).a("lCategory", 8L).c(str4).a(this.jdField_a_of_type_Bcdb.a(), str4);
  }
  
  private void e()
  {
    Object localObject1 = Pattern.compile("(http|https)://.*.mp.qq.com.*").matcher(this.jdField_a_of_type_Shs.c);
    int i = 0;
    ...
    try
    {
      localObject1 = URLEncoder.encode(this.jdField_a_of_type_Shs.c, "UTF-8");
      str2 = this.jdField_a_of_type_Bcdb.a().f;
      if (i != 0)
      {
        String str3 = String.valueOf(NetConnInfoCenter.getServerTime());
        String str1 = bdhv.b((String)localObject1 + 200 + str3 + "jubao@article@123");
        localObject3 = str1;
        if (str1 != null)
        {
          localObject3 = str1;
        ...
        str1 = this.jdField_a_of_type_Bcdb.a().j;
  ...
  Activity a()
  {
    for (Activity localActivity = this.jdField_a_of_type_Bcdb.a(); (localActivity != null) && ((localActivity instanceof BasePluginActivity)); localActivity = ((BasePluginActivity)localActivity).getOutActivity()) {}
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Oof != null) {
      WxShareHelperFromReadInjoy.a().b(this.jdField_a_of_type_Oof);
    }
  }
  
  public void a(int paramInt, float paramFloat)
  {
    this.jdField_a_of_type_Bcdb.a().getSettings().setTextZoom(bcet.a[paramInt]);
    this.jdField_a_of_type_Wxu.a(paramInt);
  }
  ...
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Sgy == null) {
      this.jdField_a_of_type_Sgy = new sgy(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bcdb.a(), null, new shq(this));
    }
    this.jdField_a_of_type_Sgy.a.a("biu出去让更多好友看到");
    this.jdField_a_of_type_Sgy.a.a(new shl(this));
    for (;;)
    {
      try
      {
        ...
        if (localJSONArray1 == null)
        {
          ...
          if (localJSONArray2 == null)
          {
            ...
            this.jdField_a_of_type_Shs = new shs(null);
            this.jdField_a_of_type_Shs.c = paramString.optString("share_url");
            this.jdField_a_of_type_Shs.jdField_b_of_type_JavaLangString = paramString.optString("desc");
            this.jdField_a_of_type_Shs.a = paramString.optString("title");
            this.jdField_a_of_type_Shs.d = paramString.optString("image_url");
            this.jdField_a_of_type_Shs.e = paramString.optString("puin");
            this.jdField_a_of_type_Shs.f = paramString.optString("nick_name");
            if (TextUtils.isEmpty(this.jdField_a_of_type_Shs.f)) {
              this.jdField_a_of_type_Shs.f = paramString.optString("sourceName");
            }
  ...
  void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    catch (Exception paramString2)
    {
      do
      {
        paramString2 = this.jdField_a_of_type_Bcdb.a();
  ...
  void a(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    {
      paramString1.putString("struct_url", this.jdField_a_of_type_Bchv.b());
      paramString1.putBoolean("from_web", true);
    }
    if (this.jdField_a_of_type_Bchj != null) {
      i = this.jdField_a_of_type_Bchj.a(this.jdField_a_of_type_Pci, (byte)2, true);
    }
    bgyu.a(this.jdField_a_of_type_Bcdb.a(), this.jdField_a_of_type_AndroidAppActivity, paramString1, null, i);
  }
  ...
  public void a(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localIntent.putExtra("brief_key", BaseApplicationImpl.getContext().getString(2131696697, new Object[] { paramString5 }));
      ...
      if (paramJSONObject.has("serviceID"))
      {
        ...
        if ((paramInt == 116) || (paramInt == 123)) {
          localIntent.putExtra("compatible_text", amns.a);
        }
      }
      ...
      paramJSONObject = this.jdField_a_of_type_Bcdb.a();
      if (paramJSONObject != null)
      {
        b();
        localIntent.putExtra("struct_share_key_source_name", Long.toString(l));
        xmt.a(paramJSONObject, this.jdField_a_of_type_AndroidAppActivity, paramJSONObject.getAccount(), l, 3000L, new shm(this, localIntent));
      }
      return;
    ...
    for (;;)
    {
      ...
      {
        paramString2 = this.jdField_a_of_type_Bcdb.a().getEntityManagerFactory(this.jdField_a_of_type_Bcdb.a().getAccount()).createEntityManager();
      ...
      for (paramString2 = paramString5.name;; paramString2 = null)
      {
        ...
        for (;;)
        {
          if (paramString2.equalsIgnoreCase(this.jdField_a_of_type_AndroidAppActivity.getString(2131699643)))
          {
            boolean bool = paramString2.equalsIgnoreCase(this.jdField_a_of_type_AndroidAppActivity.getString(2131699643));
            if (bool)
            {
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_Pci.startActivityForResult(localIntent, (byte)1);
            return;
            if (paramJSONObject.has("sourceName")) {
            ...
            {
              localIntent.putExtra("app_name", this.jdField_a_of_type_AndroidAppActivity.getString(2131696713));
            }
          }
          paramString2 = paramString3;
        }
