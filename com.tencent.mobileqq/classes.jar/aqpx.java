  ...
  extends aqqt
{
  ...
  aqpx(aqpv paramaqpv, MessageRecord paramMessageRecord)
  {
    super(paramaqpv);
  ...
  void a(String paramString, int paramInt, aqqr paramaqqr)
  {
    ...
    aqnm localaqnm = aqpv.a(this.jdField_a_of_type_Aqpv).a().a();
    if (QLog.isColorLevel()) {
      QLog.i("FileMultiMsgManager<FileAssistant>", 1, "start forwardOfflineFileToX[" + this.jdField_a_of_type_JavaLangString + "]");
    }
    localaqnm.a(paramString, paramInt, this.b, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, 3, new aqpy(this, paramString, paramaqqr));
  }
}
