  ...
  implements Manager
{
  ...
  private CopyOnWriteArrayList<amyo> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public amyx(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_JavaUtilList = new CopyOnWriteArrayList();
    QLog.i("cmgame_process.CmGameManager", 1, "[CmGameManager] created.");
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel = new ApolloCmdChannel(amwn.a());
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new amyz();
  ...
  public amro a()
  {
    ...
    //   16: areturn
    //   17: aload_0
    //   18: getfield 379	amyx:jdField_a_of_type_Amro	Lamro;
    //   21: ifnonnull +29 -> 50
    //   24: aload_0
    //   25: new 381	amro
    //   28: dup
    //   29: invokespecial 382	amro:<init>	()V
    //   32: putfield 379	amyx:jdField_a_of_type_Amro	Lamro;
    ...
    //   50: aload_0
    //   51: getfield 379	amyx:jdField_a_of_type_Amro	Lamro;
    //   54: astore_2
    //   55: goto -42 -> 13
    //   58: astore_2
    //   59: aload_0
  ...
  public amyo a()
  {
    ...
    {
      amyo localamyo = (amyo)localIterator.next();
      if ((localamyo != null) && (!amwn.a(localamyo.a())) && (!amwn.b(localamyo.a()))) {
        return localamyo;
      }
    }
    return null;
  ...
  public amyo a(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext())
    {
      amyo localamyo = (amyo)localIterator.next();
      if ((localamyo != null) && (paramInt == localamyo.a())) {
        return localamyo;
      }
    }
    return null;
  ...
  public amyo a(int paramInt1, int paramInt2)
  {
    if (paramInt1 <= 0) {}
    for (;;)
    {
      ...
      amyo localamyo = new amyo(paramInt1);
      localamyo.d = paramInt2;
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(0, localamyo);
  ...
  /* Error */
  public amyo a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 47	amyx:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   28: checkcast 390	amyo
    //   31: astore 5
    //   33: aload 5
    //   35: ifnull -24 -> 11
    //   38: aload 5
    //   40: invokevirtual 423	amyo:a	()Lcom/tencent/mobileqq/apollo/ApolloSurfaceView;
    //   43: astore 7
    //   45: aload 7
    //   47: ifnull -36 -> 11
    //   50: aload 7
  ...
  public List<amza> a()
  {
    ...
    Collections.sort(localArrayList, new amyy(this));
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      amza localamza = (amza)localIterator.next();
      if (localamza != null) {
        if (localamza.jdField_a_of_type_JavaLangRefWeakReference == null)
        {
          localArrayList.add(localamza);
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 1 gameTask:" + localamza.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
        else
        {
          if (localamza.jdField_a_of_type_JavaLangRefWeakReference.get() == null) {
            localArrayList.add(localamza);
          }
          QLog.e("cmgame_process.CmGameManager", 1, "checkValidGameTask remove invalid 2 gameTask:" + localamza.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
        }
      }
    }
  ...
  public void a(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        localamza = (amza)localIterator.next();
        if ((localamza != null) && (localamza.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localamza.jdField_a_of_type_Int = 1;
          localamza.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityCreate foundTask" + localamza);
        }
      }
      for (;;)
      {
        ...
        localamza = new amza();
        localamza.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        localamza.jdField_a_of_type_JavaLangString = paramActivity.getClass().getSimpleName();
        localamza.jdField_a_of_type_Int = 1;
        localamza.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
        this.jdField_a_of_type_JavaUtilList.add(localamza);
        return;
        localamza = null;
      }
    }
  ...
  /* Error */
  public amyo b(int paramInt1, int paramInt2)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   36: iload_1
    //   37: aload_3
    //   38: invokevirtual 392	amyo:a	()I
    //   41: if_icmpne -30 -> 11
    //   44: iload_2
    //   45: aload_3
    //   46: getfield 406	amyo:d	I
    //   49: if_icmpne -38 -> 11
    //   52: aload_0
    //   53: getfield 47	amyx:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   56: aload_3
    ...
    //   89: aload_0
    //   90: getfield 47	amyx:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
  ...
  public void b(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localamza != null) && (localamza.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId == paramStartCheckParam.gameId))
        {
          localamza.jdField_a_of_type_Int = 2;
          localamza.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
          localamza.jdField_a_of_type_Long = System.currentTimeMillis();
          QLog.d("cmgame_process.CmGameManager", 1, "onGameActivityResume foundTask" + localamza);
        }
      }
      for (paramActivity = localamza; (paramActivity == null) && (paramStartCheckParam != null); paramActivity = null)
      {
  ...
  public void c(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    if ((paramStartCheckParam != null) && (paramActivity != null))
    {
      ...
      while (localIterator.hasNext())
      {
        paramActivity = (amza)localIterator.next();
  ...
  public void onDestroy()
  {
    ...
    try
    {
      ...
      amsz.a();
      if (this.jdField_a_of_type_Amro != null) {
        this.jdField_a_of_type_Amro.a();
      }
      this.c = false;
      return;
    }
