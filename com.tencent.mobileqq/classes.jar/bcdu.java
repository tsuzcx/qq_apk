...
public class bcdu
{
  ...
  static
  {
    jdField_a_of_type_JavaUtilComparator = new bcdw();
    jdField_b_of_type_JavaUtilComparator = new bcdv();
  ...
  {
    return bach.a(a(paramString));
  }
  
  public static String a(byte[] paramArrayOfByte)
  {
    return bach.a(a(paramArrayOfByte));
  }
  ...
  public static String b(String paramString)
  {
    try
    {
      paramString = bach.a(a(paramString.getBytes("UTF-8")));
      return paramString;
    }
  ...
  public static String d(String paramString)
  {
    ...
    paramString = new bcdu().b(paramString);
