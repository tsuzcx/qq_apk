...
public class bcdu
{
  ...
  public bcdu(AppInterface paramAppInterface, bccx parambccx, Intent paramIntent, Context paramContext, boolean paramBoolean)
  {
  ...
  public bcdu(AppInterface paramAppInterface, bccx parambccx, Intent paramIntent, TouchWebView paramTouchWebView)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_Bccx = parambccx;
    this.jdField_a_of_type_AndroidContentIntent = paramIntent;
  ...
  {
    bcdv localbcdv = new bcdv(this);
    paramTouchWebView.setWebChromeClient(localbcdv);
    this.jdField_a_of_type_Nkb = localbcdv;
  }
  ...
  public TouchWebView a(TouchWebView paramTouchWebView, AppInterface paramAppInterface, Intent paramIntent)
  {
    ...
    String str1 = a(this.jdField_a_of_type_Bccx);
    boolean bool;
    ...
    for (;;)
    {
      localWebSettings.setUserAgentString(bcgq.a((String)localObject, str1, bool));
      ...
      try
      {
        ...
        if (paramTouchWebView.getX5WebViewExtension() != null)
        {
          paramTouchWebView.getX5WebViewExtension().setWebViewClientExtension(new bcdy(this, paramTouchWebView, this.jdField_a_of_type_Bccx));
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("WebLog_WebViewWrapper", 2, new Object[] { "sReportPerformance:", Boolean.valueOf(bcfo.x), " cost:", Long.valueOf(bcgp.jdField_a_of_type_Long) });
          }
          ...
          paramAppInterface.put("coreInit", String.valueOf(bcgp.jdField_a_of_type_Long));
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {}
    for (Object localObject = new bcdw(this);; localObject = new bcdx(this))
    {
