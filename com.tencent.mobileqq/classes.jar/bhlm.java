...
public class bhlm
  implements bhlg, bhlj
{
  private float jdField_a_of_type_Float = 0.0F;
  private int jdField_a_of_type_Int = 0;
  private Context jdField_a_of_type_AndroidContentContext;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private bhlg jdField_a_of_type_Bhlg;
  ...
  public bhlm(Context paramContext)
  {
    ...
    this.jdField_b_of_type_JavaLangObject = bhlo.a();
    this.jdField_c_of_type_JavaLangObject = bhlp.a(paramContext);
    bhlp.a(this.jdField_b_of_type_JavaLangObject, this.jdField_c_of_type_JavaLangObject);
    bhlp.d(bhlf.a(this), this.jdField_c_of_type_JavaLangObject);
    bhlp.e(bhlf.a(this), this.jdField_c_of_type_JavaLangObject);
  }
  
  private void a(int paramInt, Object paramObject)
  {
    bhiw.a(paramObject, "setVisibility", false, bhiw.a(new Class[] { Integer.TYPE }), new Object[] { Integer.valueOf(paramInt) });
  }
  ...
  private void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        bhlo.a(paramInt, this.jdField_b_of_type_JavaLangObject);
        bhlp.a(this.jdField_b_of_type_JavaLangObject, this.jdField_c_of_type_JavaLangObject);
      }
      return;
      paramInt = 0;
    ...
    for (;;)
    {
      ...
      for (i1 = i2;; i1 = i4)
      {
        ...
        if (i6 == 6)
        {
          if (i4 == 1)
          {
            bhlo.e(13, this.jdField_b_of_type_JavaLangObject);
            if ((i5 > 0) && (i5 <= 1920) && (i7 > 0) && (i7 <= 1920)) {
              bhlo.a(i5, i7, this.jdField_b_of_type_JavaLangObject);
            }
            if ((i1 != -1) && (i3 != -1) && (i1 <= i3))
            {
              bhlo.b(i1, this.jdField_b_of_type_JavaLangObject);
              bhlo.c(i3, this.jdField_b_of_type_JavaLangObject);
            }
            if (!str1.equalsIgnoreCase("low")) {
              break label1719;
            }
            bhlo.g(16000, this.jdField_b_of_type_JavaLangObject);
          }
        }
        else
        {
          ...
          bool1 = true;
          bhlo.d(bool1, this.jdField_b_of_type_JavaLangObject);
          ...
          if (paramBundle.keySet().contains("devicePosition"))
          {
            ...
            bhlo.c(bool1, this.jdField_b_of_type_JavaLangObject);
          }
          ...
          if (!str2.equalsIgnoreCase(this.jdField_c_of_type_JavaLangString))
          {
            ...
            bhlp.b(90, this.jdField_c_of_type_JavaLangObject);
          }
          ...
          if (!str3.equalsIgnoreCase(this.jdField_f_of_type_JavaLangString))
          {
            ...
            bhlp.c(0, this.jdField_b_of_type_JavaLangObject);
          }
          ...
          if (localObject1 != null) {
            bhlo.a((Bitmap)localObject1, this.jdField_b_of_type_JavaLangObject);
          }
          boolean bool3 = paramBundle.getBoolean("backgroundMute", this.jdField_j_of_type_Boolean);
          if (!bool3) {
            break label1823;
          }
          bhlo.d(3, this.jdField_b_of_type_JavaLangObject);
          boolean bool4 = paramBundle.getBoolean("zoom", this.l);
          bhlo.a(bool4, this.jdField_b_of_type_JavaLangObject);
          ...
          bhlo.a((Bitmap)localObject2, f1, f2, f3, this.jdField_b_of_type_JavaLangObject);
          label740:
          boolean bool5 = paramBundle.getBoolean("enableAGC", this.q);
          bhlo.e(bool5, this.jdField_b_of_type_JavaLangObject);
          boolean bool6 = paramBundle.getBoolean("enableANS", this.r);
          bhlo.f(bool6, this.jdField_b_of_type_JavaLangObject);
          boolean bool7 = paramBundle.getBoolean("enableEarMonitor", this.s);
          bhlo.g(bool7, this.jdField_b_of_type_JavaLangObject);
          ...
          bhlo.h(0, this.jdField_b_of_type_JavaLangObject);
          label837:
          ...
          bool2 = true;
          label858:
          bhlo.b(bool2, this.jdField_b_of_type_JavaLangObject);
          i2 = 0;
          ...
          if ((paramBoolean) || (bool9 != this.jdField_i_of_type_Boolean))
          {
            ...
            bool2 = true;
            label1207:
            bhlp.a(bool2, this.jdField_c_of_type_JavaLangObject);
          }
        ...
        {
          if (bool1 != this.p) {
            bhlp.b(bool1, this.jdField_c_of_type_JavaLangObject);
          }
          this.p = bool1;
          ...
          if (i1 != this.jdField_g_of_type_Int) {
            bhlp.a(0, i1, i2, 2, this.jdField_c_of_type_JavaLangObject);
          }
          ...
          if (i1 != this.jdField_i_of_type_Int) {
            bhlp.d(i1, this.jdField_c_of_type_JavaLangObject);
          }
          this.jdField_i_of_type_Int = i1;
          bool1 = paramBundle.getBoolean("debug", this.o);
          if ((paramBoolean) || (bool1 != this.o)) {
            bhlp.d(bool1, this.jdField_c_of_type_JavaLangObject);
          }
          this.o = bool1;
          return;
          bhlp.a(1, false, false, this.jdField_c_of_type_JavaLangObject);
          bhlo.f(5, this.jdField_b_of_type_JavaLangObject);
          break;
          bhlp.a(2, true, false, this.jdField_c_of_type_JavaLangObject);
          bhlo.f(5, this.jdField_b_of_type_JavaLangObject);
          break;
          bhlp.a(3, true, false, this.jdField_c_of_type_JavaLangObject);
          bhlo.f(5, this.jdField_b_of_type_JavaLangObject);
          break;
          bhlp.a(4, true, false, this.jdField_c_of_type_JavaLangObject);
          break;
          bhlp.a(5, true, false, this.jdField_c_of_type_JavaLangObject);
          break;
          bhlp.a(6, false, false, this.jdField_c_of_type_JavaLangObject);
          break;
          if (i4 != 2) {
            break label290;
          }
          bhlo.e(0, this.jdField_b_of_type_JavaLangObject);
          break label290;
          label1719:
          if (!str1.equalsIgnoreCase("high")) {
            break label385;
          }
          bhlo.g(48000, this.jdField_b_of_type_JavaLangObject);
          break label385;
          label1742:
          bool1 = false;
          break label406;
          ...
          a(this.jdField_a_of_type_Int, str2);
          bhlp.b(0, this.jdField_c_of_type_JavaLangObject);
          break label538;
          label1779:
          if (str3.equalsIgnoreCase("enable"))
          {
            bhlp.c(1, this.jdField_b_of_type_JavaLangObject);
            break label581;
          }
          if (!str3.equalsIgnoreCase("disable")) {
            break label581;
          }
          bhlp.c(2, this.jdField_b_of_type_JavaLangObject);
          break label581;
          label1823:
          bhlo.d(1, this.jdField_b_of_type_JavaLangObject);
          break label641;
          label1834:
          if ((!bhlp.d(this.jdField_c_of_type_JavaLangObject)) || (!paramBundle.keySet().contains("watermarkImage"))) {
            break label740;
          }
          bhlo.a((Bitmap)localObject2, f1, f2, f3, this.jdField_b_of_type_JavaLangObject);
          break label740;
          ...
          bhlo.h(1, this.jdField_b_of_type_JavaLangObject);
          break label837;
          label1898:
          bool2 = false;
          break label858;
  ...
  {
    bhiw.a(paramObject, "disableLog", false, bhiw.a(new Class[] { Boolean.TYPE }), new Object[] { paramBoolean });
  }
  ...
  private void a(boolean paramBoolean)
  {
    if ((!this.jdField_b_of_type_Boolean) && (paramBoolean))
    {
      ...
      bhlp.b(this.jdField_a_of_type_JavaLangObject, this.jdField_c_of_type_JavaLangObject);
  ...
  {
    if (paramBoolean) {
      bhlp.f(this.jdField_c_of_type_JavaLangObject);
    }
  }
  
  private void c()
  {
    bhlp.c(true, this.jdField_c_of_type_JavaLangObject);
    this.jdField_b_of_type_Boolean = false;
  }
  
  private void d()
  {
    bhlp.g(this.jdField_c_of_type_JavaLangObject);
  }
  
  public int a(String paramString)
  {
    return bhlp.a(paramString, this.jdField_c_of_type_JavaLangObject);
  }
  ...
  public bhkw a(Bundle paramBundle)
  {
    ...
    if (!this.jdField_a_of_type_Boolean) {
      return new bhkw(-3, "uninited livePusher");
    }
    a(paramBundle, false);
    String str = paramBundle.getString("pushUrl", this.jdField_a_of_type_JavaLangString);
    if ((str != null) && (!str.isEmpty()) && (this.jdField_a_of_type_JavaLangString != null) && (!this.jdField_a_of_type_JavaLangString.equalsIgnoreCase(str)) && (bhlp.d(this.jdField_c_of_type_JavaLangObject)))
    {
      QMLog.d("TXLivePusherJSAdapter", "updateLivePusher: stopPusher");
      c();
      d();
      bhlp.a(this.jdField_c_of_type_JavaLangObject);
    }
    this.jdField_a_of_type_JavaLangString = str;
    bhlp.a(this.jdField_a_of_type_JavaLangString, this.jdField_c_of_type_JavaLangObject);
    this.jdField_f_of_type_Boolean = paramBundle.getBoolean("autopush", this.jdField_f_of_type_Boolean);
    if ((this.jdField_f_of_type_Boolean) && (this.jdField_a_of_type_JavaLangString != null) && (!this.jdField_a_of_type_JavaLangString.isEmpty()) && (!bhlp.d(this.jdField_c_of_type_JavaLangObject)))
    {
  ...
  public bhkw a(String paramString, JSONObject paramJSONObject)
  {
    ...
    if (paramString.equalsIgnoreCase("start")) {
      if ((this.jdField_a_of_type_JavaLangString != null) && (!this.jdField_a_of_type_JavaLangString.isEmpty()) && (!bhlp.d(this.jdField_c_of_type_JavaLangObject)))
      {
        a(this.jdField_h_of_type_Boolean);
        b(this.jdField_i_of_type_Boolean);
        bhlp.a(this.jdField_a_of_type_JavaLangString, this.jdField_c_of_type_JavaLangObject);
    ...
    for (;;)
    {
      ...
      {
        if ((this.jdField_k_of_type_Boolean) && (bhlp.d(this.jdField_c_of_type_JavaLangObject))) {
          bhlp.a(false, this.jdField_c_of_type_JavaLangObject);
        }
        bhlp.c(this.jdField_c_of_type_JavaLangObject);
      ...
      {
        bhlp.b(this.jdField_c_of_type_JavaLangObject);
        if (this.jdField_e_of_type_Boolean) {
          a("resumeBGM", null);
        }
      }
      ...
      {
        if (bhlp.d(this.jdField_c_of_type_JavaLangObject))
        {
      ...
      else
      {
        if (paramString.equalsIgnoreCase("switchCamera"))
        {
          ...
          {
            this.jdField_c_of_type_Boolean = bool1;
            bhlo.c(this.jdField_c_of_type_Boolean, this.jdField_b_of_type_JavaLangObject);
            bhlp.d(this.jdField_c_of_type_JavaLangObject);
            break;
          }
        }
        if (paramString.equalsIgnoreCase("toggleTorch"))
        {
          if (bhlp.d(this.jdField_c_of_type_JavaLangObject))
          {
            ...
            {
              boolean bool2 = bhlp.a(bool1, this.jdField_c_of_type_JavaLangObject);
              if (!bool2) {
                break label537;
              }
              label500:
            ...
            {
              return new bhkw(i1, paramString);
              bool1 = false;
              break;
        ...
        if (paramString.equalsIgnoreCase("playBGM"))
        {
          ...
          if ((paramString != null) && (paramString.length() > 0)) {
            bhlp.b(paramString, this.jdField_c_of_type_JavaLangObject);
          } else {
            return new bhkw(-2, "fail");
          }
        }
        ...
        else
        {
          ...
          if ((this.jdField_d_of_type_Boolean) && (paramJSONObject != null))
          {
            ...
            if (i1 > 0) {
              bhlp.a(i1, this.jdField_c_of_type_JavaLangObject);
            }
          }
        }
      }
    ...
    {
      bhlp.a((float)d1, this.jdField_c_of_type_JavaLangObject);
      break;
      ...
      for (paramString = paramJSONObject.optString("msg");; paramString = null)
      {
        if (paramString != null)
        {
          bool1 = bhlp.a(paramString.getBytes(), this.jdField_c_of_type_JavaLangObject);
          if (bool1)
          {
            i1 = i2;
            if (!bool1) {
  ...
  {
    this.jdField_d_of_type_Boolean = true;
    if ((this.n) && (this.jdField_a_of_type_Bhlj != null)) {
      this.jdField_a_of_type_Bhlj.a();
    }
  }
  ...
  public void a(int paramInt)
  {
    this.jdField_d_of_type_Boolean = false;
    if ((this.n) && (this.jdField_a_of_type_Bhlj != null)) {
      this.jdField_a_of_type_Bhlj.a(paramInt);
    }
  }
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      if ((this.m) && (this.jdField_a_of_type_Bhlg != null)) {
        this.jdField_a_of_type_Bhlg.a(paramInt, paramBundle);
      }
      ...
      if ((paramInt == 1003) && (this.jdField_k_of_type_Boolean)) {
        bhlp.a(this.jdField_k_of_type_Boolean, this.jdField_c_of_type_JavaLangObject);
      }
    }
  }
  ...
  {
    if ((this.n) && (this.jdField_a_of_type_Bhlj != null)) {
      this.jdField_a_of_type_Bhlj.a(paramLong1, paramLong2);
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    if (this.jdField_a_of_type_Bhlg != null) {
      this.jdField_a_of_type_Bhlg.a(paramBundle);
    }
    if (QMLog.isColorLevel())
    {
  ...
  public void a(bhlj parambhlj)
  {
    this.jdField_a_of_type_Bhlj = parambhlj;
  }
  
  public void a(boolean paramBoolean, bhlh parambhlh)
  {
    if ((this.jdField_c_of_type_JavaLangObject != null) && (bhlp.d(this.jdField_c_of_type_JavaLangObject))) {
      bhlp.c(bhlf.a(new bhln(this, parambhlh, paramBoolean)), this.jdField_c_of_type_JavaLangObject);
    }
  }
  
  public void b()
  {
    bhlp.e(this.jdField_c_of_type_JavaLangObject);
  }
}
