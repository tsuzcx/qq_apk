  ...
  extends aoxs
{
  ...
  public axai(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public static MessageRecord a(@NonNull QQAppInterface paramQQAppInterface, @NonNull byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        long l8 = bcrx.a(localMessageHandler, (msg_comm.Msg)localObject1, String.valueOf(l4), String.valueOf(l3));
        paramArrayOfByte = new ArrayList();
        if (((!bcsc.c(i1)) && (i1 != 208) && (i1 != 529)) || (!((msg_comm.MsgHead)localObject2).c2c_cmd.has())) {
          break label803;
        }
        l2 = a(paramQQAppInterface.getLongAccountUin(), l3, l4);
        a(paramQQAppInterface, (msg_comm.Msg)localObject1, localbffl, (msg_comm.MsgHead)localObject2, i1, localMessageHandler, paramArrayOfByte);
        l1 = l2;
        if (i1 != 208) {
          break label841;
        }
        new bcsr().a(localMessageHandler, (msg_comm.Msg)localObject1, paramArrayOfByte, null);
        l1 = l2;
        int m = 0;
        int i2 = bcrx.a((msg_comm.Msg)localObject1);
        ...
        ((MessageRecord)localObject2).vipBubbleID = aocy.a((int)l8, i2);
        ...
        ((MessageRecord)localObject2).msgBackupMsgRandom = bcsc.b(l7);
        m += 1;
        continue;
        label579:
        ...
        a(paramQQAppInterface, (msg_comm.Msg)localObject1, localMessageHandler, paramArrayOfByte, localbffl);
        continue;
        label617:
        l1 = l2;
        ...
        a(paramQQAppInterface, (msg_comm.Msg)localObject1, localbffl, localMessageHandler, paramArrayOfByte);
      }
  ...
  public static msg_comm.MsgHead a(MessageRecord paramMessageRecord, long paramLong)
  {
    ...
    Object localObject = acnh.c(paramMessageRecord);
    for (;;)
    {
      try
      {
  ...
  public static im_msg_body.MsgBody a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    ...
    if ((paramMessageRecord.msgtype == -1000) || (paramMessageRecord.msgtype == -10000) || (paramMessageRecord.msgtype == -7014)) {
      if (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("sens_msg_source_msg_info"))) {
        paramQQAppInterface = bcrx.a(paramMessageRecord);
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          return paramQQAppInterface;
          paramQQAppInterface = bcrx.a((MessageForText)paramMessageRecord);
          break;
          if (paramMessageRecord.msgtype == -1049)
          {
            paramQQAppInterface = bcrx.a((MessageForReplyText)paramMessageRecord);
            break;
          }
          ...
          {
            paramQQAppInterface = bcrx.a((MessageForQQStoryComment)paramMessageRecord);
            break;
          }
          if (paramMessageRecord.msgtype == -2000)
          {
            paramQQAppInterface = bcrx.a((MessageForPic)paramMessageRecord);
            break;
          }
          if (paramMessageRecord.msgtype == -5008)
          {
            paramQQAppInterface = bcrx.a((MessageForArkApp)paramMessageRecord, true);
            break;
          }
          if (paramMessageRecord.msgtype == -5016)
          {
            paramQQAppInterface = bcrx.c((MessageForArkBabyqReply)paramMessageRecord, true);
            break;
          }
          if (paramMessageRecord.msgtype == -5017)
          {
            paramQQAppInterface = bcrx.b((MessageForArkApp)paramMessageRecord, true);
            break;
          }
          if (paramMessageRecord.msgtype == -5013)
          {
            paramQQAppInterface = bcrx.c((MessageForArkFlashChat)paramMessageRecord);
            break;
          }
          if (paramMessageRecord.msgtype == -5014)
          {
            paramQQAppInterface = bcrx.d((MessageForHiBoom)paramMessageRecord);
            break;
          }
          if (paramMessageRecord.msgtype != -2011) {
            break label388;
          }
          localObject2 = bcrx.a((MessageForStructing)paramMessageRecord);
        ...
        {
          paramQQAppInterface = bcrx.a((MessageForMixedMsg)paramMessageRecord);
          break;
        }
        if (paramMessageRecord.msgtype == -1051)
        {
          paramQQAppInterface = bcrx.a((MessageForLongTextMsg)paramMessageRecord, false);
          break;
        }
        ...
        {
          paramQQAppInterface = bcrx.a((MessageForMarketFace)paramMessageRecord);
          break;
        }
  ...
  private static void a(QQAppInterface paramQQAppInterface, msg_comm.Msg paramMsg, bffl parambffl, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
  ...
  private static void a(QQAppInterface paramQQAppInterface, msg_comm.Msg paramMsg, bffl parambffl, msg_comm.MsgHead paramMsgHead, int paramInt, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
  ...
  private static void a(QQAppInterface paramQQAppInterface, msg_comm.Msg paramMsg, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList, bffl parambffl)
  {
    ...
    if (paramQQAppInterface.rich_text.has())
    {
      ...
      if (localRichText.elems.has())
      {
        ...
        if (paramQQAppInterface != null)
        {
          ...
          {
            parambffl = (im_msg_body.Elem)paramQQAppInterface.next();
            if (parambffl.anon_group_msg.has())
            {
              parambffl = (im_msg_body.AnonymousGroupMsg)parambffl.anon_group_msg.get();
              int i = parambffl.uint32_flags.get();
              paramQQAppInterface = parambffl.str_anon_id.get().toByteArray();
              byte[] arrayOfByte = parambffl.str_anon_nick.get().toByteArray();
              int j = parambffl.uint32_head_portrait.get();
              int k = parambffl.uint32_expire_time.get();
              String str = parambffl.str_rank_color.get().toStringUtf8();
              if (paramQQAppInterface != null) {}
              for (;;)
              {
                try
                {
                  ...
                  parambffl = "";
                  localMessageRecord.saveExtInfoToExtStr("anonymous", nty.a(i, paramQQAppInterface, parambffl, j, k, str));
                ...
                continue;
                label304:
                parambffl = new String(arrayOfByte);
              }
              if (QLog.isColorLevel()) {
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    catch (Throwable paramQQAppInterface)
    {
      for (;;)
      {
        ...
        bdjw.a(paramQQAppInterface, "MsgBackup_msgproxy,mr = " + paramMessageRecord.getClass().getSimpleName());
        paramQQAppInterface = null;
      }
  ...
  public MsgBackupMsgEntity a(@NonNull MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      {
        axcw.a("transBackupEntity error,mr = %s ", paramMessageRecord.toString(), new Object[0]);
        return null;
      }
    }
    catch (Throwable localThrowable)
    {
      ...
      {
        QLog.e("MsgBackup_msgproxy", 1, "transToBackupEntity,getMsgBody error mr = " + paramMessageRecord.getClass().getSimpleName());
        bdjw.a(localThrowable, "MsgBackup_msgproxy,mr = " + paramMessageRecord.getClass().getSimpleName());
        localObject2 = null;
      }
      localMsg.msg_head.set(localMsgHead);
      ...
      ((MsgBackupMsgEntity)localObject2).chatType = axcw.b(paramMessageRecord.istroop);
      ((MsgBackupMsgEntity)localObject2).msgType = axcw.a(paramMessageRecord.msgtype);
    ...
    if (paramMessageRecord.istroop == 3000)
    {
      ...
      paramMessageRecord = awzx.a(i);
      if (paramMessageRecord != null) {
        break label402;
      }
      paramMessageRecord = localMsg.toByteArray();
      awzx.a(paramMessageRecord);
    }
    label363:
    ...
    {
      return localObject2;
      i = bcsc.b(paramMessageRecord.msgUid);
