...
public class ayfp
{
  private ayfb jdField_a_of_type_Ayfb;
  ...
  public ayfp(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    a();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Ayfb);
  }
  
  private AbsStructMsg a(Context paramContext, String paramString)
  {
    String str3 = apue.a(paramString);
    String str1 = apvb.a(paramString);
    if (ayfv.jdField_a_of_type_JavaLangString.indexOf(str1) < 0)
    {
      QLog.e("TeamWorkSender", 1, paramString + " is not docs support file");
      return null;
    }
    if (".doc|.docx".contains(str1)) {
      paramString = ajyc.a(2131714791);
    }
    for (str1 = "https://pub.idqqimg.com/pc/misc/files/20180403/29c998e16c094b10a96b3e0d1589c2f6.png";; str1 = "https://pub.idqqimg.com/pc/misc/files/20180403/da40f07bd79e4796b712b44023911be0.png")
    {
      ...
      localIntent.putExtra("app_name", ajyc.a(2131714810));
      localIntent.putExtra("brief_key", paramContext.getString(2131696697, new Object[] { str2 }));
      return axuy.a(localIntent.getExtras());
      paramString = ajyc.a(2131714787);
    }
  }
  ...
  private TeamWorkFileImportInfo a(String paramString)
  {
    ...
    localTeamWorkFileImportInfo.jdField_b_of_type_JavaLangString = apue.a(paramString);
    localTeamWorkFileImportInfo.jdField_e_of_type_Int = apue.a(paramString);
    localTeamWorkFileImportInfo.jdField_b_of_type_Boolean = false;
    localTeamWorkFileImportInfo.jdField_d_of_type_Int = 4;
    localTeamWorkFileImportInfo.jdField_d_of_type_Long = apue.a(paramString);
  ...
  private String a(int paramInt)
  {
    ...
    case -104: 
    default: 
      return ajyc.a(2131714765);
    case -102: 
    case -101: 
    case -100: 
      return ajyc.a(2131714755);
    case -103: 
      return ajyc.a(2131714785);
    case -116: 
    case -106: 
      return ajyc.a(2131714783);
    case -107: 
      return ajyc.a(2131714747);
    case -108: 
      return ajyc.a(2131714799);
    case -110: 
      return ajyc.a(2131714786);
    case -111: 
      return ajyc.a(2131714768);
    case -115: 
    case -113: 
    case -112: 
      return ajyc.a(2131714752);
    }
    return ajyc.a(2131714808);
  }
  
  private void a()
  {
    this.jdField_a_of_type_Ayfb = new ayfq(this);
  }
  ...
  private void a(AbsStructMsg paramAbsStructMsg, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, String paramString, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForStructing = axaq.a(localQQAppInterface, str2, paramString, str1, paramInt, l, paramAbsStructMsg);
      ...
      paramAbsStructMsg = (ayeo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(120);
  ...
  {
    paramString2 = apue.a(paramString1);
  ...
  public boolean a(MessageForStructing paramMessageForStructing, SessionInfo paramSessionInfo)
  {
    ...
    ayeo localayeo = (ayeo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(120);
    if (!TextUtils.isEmpty(localayeo.a(paramSessionInfo))) {
      localayeo.a(paramSessionInfo);
    }
    if (!localayeo.a(paramSessionInfo)) {
      localayeo.a(paramSessionInfo);
    }
