  ...
  implements View.OnClickListener
{
  ...
  public ayfp(Context paramContext, ExtendGridView paramExtendGridView)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Int = 9;
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqTroopActivityExtendGridView = paramExtendGridView;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130846730);
    this.jdField_a_of_type_JavaLangCharSequence = BaseApplication.getContext().getText(2131630821);
    this.jdField_b_of_type_JavaLangCharSequence = BaseApplication.getContext().getResources().getText(2131652478);
  ...
  {
    int i = (int)bacc.a(paramContext, 60.0F);
    int j = (int)bacc.a(paramContext, 5.0F);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131494146, null);
      localayfq = new ayfq();
      localayfq.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131312889));
      localayfq.b = ((ImageView)localView.findViewById(2131302355));
      localayfq.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131309767));
      localView.setTag(localayfq);
      ...
      localayfq.jdField_a_of_type_ComTencentImageURLImageView.setScaleType(ImageView.ScaleType.FIT_XY);
      localayfq.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130841895);
      localayfq.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_a_of_type_JavaLangCharSequence);
      localayfq.b.setVisibility(8);
    }
    label245:
    String str;
    label260:
    do
    {
      ...
      return localView;
      localayfq = (ayfq)paramView.getTag();
      localView = paramView;
      break;
      paramView.width = i;
      paramView.height = i;
    ...
    if (i < 0)
    {
      ...
      label306:
      i = Math.min(100, i);
      localayfq.jdField_a_of_type_ComTencentImageURLImageView.setAdjustViewBounds(false);
    ...
    for (;;)
    {
      ...
      localayfq.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(paramView);
      localayfq.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_b_of_type_JavaLangCharSequence);
      localayfq.b.setVisibility(0);
      localayfq.b.setTag(Integer.valueOf(paramInt));
      localayfq.b.setOnClickListener(this);
      localayfq.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
      break;
      j = i;
      break label288;
      label469:
