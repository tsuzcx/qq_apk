...
public class apdc
{
  private static apdc jdField_a_of_type_Apdc;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver;
  public QQAppInterface a;
  private List<apdj> jdField_a_of_type_JavaUtilList = new ArrayList();
  private Map<String, apdh> jdField_a_of_type_JavaUtilMap = new HashMap();
  private boolean jdField_a_of_type_Boolean = false;
  private Map<String, apwm> jdField_b_of_type_JavaUtilMap = new HashMap();
  ...
  private int a(String paramString)
  {
    ...
    {
      apdh localapdh = (apdh)this.jdField_a_of_type_JavaUtilMap.remove(paramString);
      if (localapdh != null)
      {
        apwm localapwm = a(paramString);
        if ((localapdh.jdField_a_of_type_Apwj != null) && (localapwm != null)) {
          localapdh.jdField_a_of_type_Apwj.a(localapwm);
        }
      }
  ...
  private int a(String paramString, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      catch (UnsupportedEncodingException localUnsupportedEncodingException)
      {
        ...
        int k = localUnsupportedEncodingException.jdField_a_of_type_Apwj.f();
      ...
      if ((localObject2 == null) && (paramBundle.containsKey("big_brother_source_key")))
      {
        ...
        if ((localObject2 != null) && ((localObject2 == null) || (((apdh)localObject2).jdField_a_of_type_Apwj != null))) {
          break label201;
        }
    ...
    localUnsupportedEncodingException.jdField_a_of_type_Apwj.a(paramString);
    localUnsupportedEncodingException.jdField_a_of_type_Apwj.a(paramString, false);
    return 0;
    d(paramString);
    return 0;
    a(paramString);
  ...
  private int a(String paramString1, String paramString2, long paramLong, String paramString3, Bundle paramBundle, int paramInt, boolean paramBoolean)
  {
    ...
    long l = a();
    apwj localapwj = new apwj(l, paramString1, paramBundle);
    ...
    if (1 == localapwj.g())
    {
      ...
      paramInt = apdk.a().a(localapwj, (Bundle)localObject, l, paramInt);
      a(paramString1, new apdh(this, null, localapwj.g(), localapwj, l, paramInt));
      if (!paramBoolean) {
        break label435;
      }
    ...
    for (;;)
    {
      ...
      {
        localapwj.a(true);
        apdk.a().b(paramInt, (Bundle)localObject);
      }
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        if (1 == localapwj.g()) {
          axrm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "Start_download_2-0_3-0");
        } else if (2 == localapwj.g()) {
          axrm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "Start_download_2-0_3-1");
        }
      }
    }
  }
  ...
  public static apdc a()
  {
    try
    {
      if (jdField_a_of_type_Apdc == null)
      {
        QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] UniformDownloadMgr.getInstance.create");
        jdField_a_of_type_Apdc = new apdc();
      }
      apdc localapdc = jdField_a_of_type_Apdc;
      return localapdc;
    }
    finally {}
  }
  
  private apdh a(String paramString)
  {
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      paramString = (apdh)this.jdField_a_of_type_JavaUtilMap.get(paramString);
      return paramString;
    }
  }
  
  private apdi a(String paramString)
  {
    if (paramString == null)
    {
  ...
  private apdj a(String paramString)
  {
    if (paramString == null)
    {
    ...
    return new apdj(arrayOfString[0], Integer.parseInt(arrayOfString[1]));
  }
  
  private apwm a(String paramString)
  {
    if (paramString == null) {
      paramString = null;
    }
    for (;;)
    {
      ...
      try
      {
        paramString = (apwm)this.jdField_b_of_type_JavaUtilMap.get(paramString);
      }
      finally {}
    }
  }
  
  private String a(apdi paramapdi)
  {
    if (paramapdi == null)
    {
    ...
    return String.valueOf(paramapdi.jdField_a_of_type_Int) + "^" + paramapdi.jdField_a_of_type_JavaLangString + "^" + String.valueOf(paramapdi.jdField_a_of_type_Long) + "^" + String.valueOf(paramapdi.jdField_a_of_type_Boolean) + "^" + paramapdi.b;
  }
  
  private String a(apdj paramapdj)
  {
    if (paramapdj == null)
    {
    ...
    return String.valueOf(paramapdj.jdField_a_of_type_JavaLangString) + "^" + String.valueOf(paramapdj.jdField_a_of_type_Int);
  }
  
  private void a(String paramString, apwm paramapwm)
  {
    if ((paramString != null) && (paramapwm != null)) {}
    try
    {
      this.jdField_b_of_type_JavaUtilMap.put(paramString, paramapwm);
      return;
    }
    finally
    {
  ...
  private boolean a(String paramString, apdh paramapdh)
  {
    if ((paramString == null) || (paramapdh == null))
    {
    ...
    this.jdField_a_of_type_JavaUtilMap.put(paramString, paramapdh);
  ...
  {
    int i = 0;
    if ((bbfj.d(BaseApplication.getContext())) && (!apug.a())) {}
    for (int m = 2;; m = 1)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilMap)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          int n = j;
          k = i;
          if (localapdh.jdField_a_of_type_Apwj != null)
          {
            n = j;
            k = i;
            if (localapdh.jdField_a_of_type_Apwj.b())
            {
              i += 1;
              n = j;
              k = i;
              if (paramString != null)
              {
                n = j;
                k = i;
                if (paramString.equalsIgnoreCase(localapdh.jdField_a_of_type_JavaLangString))
                {
          ...
          ((List)localObject2).add(localapdh);
          j = n;
          i = k;
        }
      }
      ...
      for (;;)
      {
        if (j < m)
        {
          ...
          if (((Iterator)???).hasNext())
          {
            localObject2 = (apdh)((Iterator)???).next();
            k = j;
            if (((apdh)localObject2).jdField_a_of_type_Apwj == null) {
              break label526;
            }
            k = j;
            if (!((apdh)localObject2).jdField_a_of_type_Apwj.a()) {
              break label526;
            }
            if (j < m)
            {
              QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] >>> Happy. start a download task, url:[" + ((apdh)localObject2).jdField_a_of_type_JavaLangString + "]");
              j += 1;
              ((apdh)localObject2).jdField_a_of_type_Apwj.a();
              k = j;
              if (paramString == null) {
                break label526;
              }
              k = j;
              if (!paramString.equalsIgnoreCase(((apdh)localObject2).jdField_a_of_type_JavaLangString)) {
                break label526;
              }
  ...
  private int b(String paramString, Bundle paramBundle)
  {
    ...
    if (-1 == c(paramString))
    {
      apwe.a(paramString, new apdg(this));
      apdk.a().a(i, (Bundle)paramBundle.clone());
      b(null);
    }
    return 0;
  }
  
  private apwm b(String paramString)
  {
    try
    {
      paramString = (apwm)this.jdField_b_of_type_JavaUtilMap.remove(paramString);
      return paramString;
    }
    finally
    {
  ...
  {
    apdh localapdh = a(paramString);
    if (localapdh != null)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        if (localapdh.jdField_a_of_type_Int != 1) {
          break label71;
        }
        axrm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "Stop_download_2-2_3-0");
      }
      for (;;)
      {
        if (localapdh.jdField_a_of_type_Apwj != null) {
          localapdh.jdField_a_of_type_Apwj.b();
        }
        b(null);
        return 0;
        label71:
        axrm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "Stop_download_2-2_3-1");
      }
    }
  ...
  private int d(String paramString)
  {
    ...
    if (localapdh != null)
    {
      if (localapdh.jdField_a_of_type_Apwj != null)
      {
        paramString = a(paramString);
        if (paramString != null) {
          localapdh.jdField_a_of_type_Apwj.a(paramString, false);
        }
        localapdh.jdField_a_of_type_Apwj.c();
      }
      b(null);
      return 0;
    }
  ...
  private int e(String paramString)
  {
    ...
    {
      if (localapdh.jdField_a_of_type_Apwj != null) {
        localapdh.jdField_a_of_type_Apwj.d();
      }
      return 0;
    }
  ...
  private void g(String paramString, Bundle paramBundle)
  {
    ...
    axtp.a().addDownloadURL(paramString);
    HashMap localHashMap = new HashMap();
    localHashMap.put("url", paramString);
    localHashMap.put("NetworkType", bbfj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()) + "");
    if (bdhj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {}
    Object localObject2;
    ...
    for (;;)
    {
      try
      {
        ...
        axrn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), "UniformDownloadEvent_NO_SOURCE", true, 0L, 0L, localHashMap, "");
        ...
        axqy.b(null, "dc00898", "", "", "0X800A003", "0X800A003", 0, 0, paramBundle, (String)localObject1, (String)localObject2, paramString);
      }
      ...
      axrn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), "UniformDownloadEvent", true, 0L, 0L, localHashMap, "");
      paramBundle = (String)localHashMap.get("isForeground");
      localObject1 = (String)localHashMap.get("isAPK");
      localObject2 = paramString.toString();
      localStringBuilder = new StringBuilder().append((String)localHashMap.get("Stack"));
      ...
      paramString = (String)localHashMap.get("Stack1");
      axqy.b(null, "dc00898", "", "", "0X800A002", "0X800A002", 0, 0, paramBundle, (String)localObject1, (String)localObject2, paramString);
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if ((??? != null) && (((Map)???).size() > 0))
        {
          ...
          if (localIterator.hasNext())
          {
            apdj localapdj = a((String)((Map.Entry)localIterator.next()).getKey());
            if (localapdj == null) {
              break label207;
            }
            QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] initSucDownloadInfo, pkgName:[" + localapdj.jdField_a_of_type_JavaLangString + "]] nId:[" + localapdj.jdField_a_of_type_Int + "] ");
            synchronized (this.jdField_a_of_type_JavaUtilList)
            {
              this.jdField_a_of_type_JavaUtilList.add(localapdj);
            }
          }
        }
        return;
  ...
  public List<apdj> a(String paramString, boolean paramBoolean)
  {
    if (paramString == null) {
      return null;
    }
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      {
        localapdj = (apdj)localIterator.next();
        if ((localapdj != null) && (paramString.equalsIgnoreCase("package:" + localapdj.jdField_a_of_type_JavaLangString))) {
          localArrayList.add(localapdj);
        }
      }
    }
    if ((localArrayList.size() > 0) && (paramBoolean))
    {
      ...
      try
      {
        ...
        {
          localapdj = (apdj)localIterator.next();
          this.jdField_a_of_type_JavaUtilList.remove(localapdj);
          paramString.remove(a(localapdj));
          continue;
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((Map)localObject1).size() > 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] getDownloadingRbResmeInfo, url:[" + str + "]] nId:[" + ((apdi)localObject2).jdField_a_of_type_Int + "] w:[" + ((apdi)localObject2).jdField_a_of_type_Boolean + "]");
  ...
  public void a(apdj paramapdj)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramapdj);
      QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] saveSucDownloadInfo. pkgName:" + paramapdj.jdField_a_of_type_JavaLangString + " notificationId:" + paramapdj.jdField_a_of_type_Int + " size:" + this.jdField_a_of_type_JavaUtilList.size());
      try
      {
        ??? = BaseApplication.getContext().getSharedPreferences("download_suc_info", 0).edit();
        ((SharedPreferences.Editor)???).putString(a(paramapdj), "-");
        ((SharedPreferences.Editor)???).commit();
        return;
      }
      catch (Exception paramapdj)
      {
        paramapdj.printStackTrace();
        return;
      }
    }
  }
  ...
  {
    apwm localapwm = b(paramString);
    if (!TextUtils.isEmpty(paramString))
    {
      paramString = a(paramString);
      if ((paramString != null) && (paramString.jdField_a_of_type_Apwj != null) && (localapwm != null)) {
        paramString.jdField_a_of_type_Apwj.a(localapwm);
      }
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if (localIterator.hasNext())
        {
          localObject = (apdj)localIterator.next();
          if ((localObject == null) || (!paramString.equalsIgnoreCase(((apdj)localObject).jdField_a_of_type_JavaLangString)) || (paramInt != ((apdj)localObject).jdField_a_of_type_Int)) {
            continue;
          }
          if (localObject != null)
          {
          ...
          try
          {
            ...
            ((SharedPreferences.Editor)localObject).remove(a(new apdj(paramString, paramInt)));
  ...
  public void a(String paramString, Bundle paramBundle, apwm paramapwm)
  {
    apwm localapwm = a(paramString);
    a(paramString, paramapwm);
    ThreadManager.getSubThreadHandler().post(new UniformDownloadMgr.9(this, paramBundle, paramString, localapwm));
  }
  
  public void a(String paramString1, String paramString2)
  {
    apwe.a(paramString1, new apde(this, paramString1, paramString2));
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong, Bundle paramBundle, int paramInt, boolean paramBoolean)
  {
    try
    {
      ...
      apdi localapdi = new apdi(this);
      localapdi.jdField_a_of_type_Int = paramInt;
      localapdi.jdField_a_of_type_JavaLangString = paramString2;
      if (!TextUtils.isEmpty(paramString3)) {}
      for (localapdi.b = paramString3;; localapdi.b = paramString2)
      {
        localapdi.jdField_a_of_type_Long = paramLong;
        localapdi.jdField_a_of_type_Boolean = paramBoolean;
        localapdi.jdField_a_of_type_AndroidOsBundle = paramBundle;
        localEditor.putString(paramString1, a(localapdi));
        localEditor.commit();
        return;
      }
      return;
  ...
  public void c()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      if (this.jdField_a_of_type_JavaUtilMap.size() > 0)
      {
        ...
        {
          apdh localapdh = (apdh)((Map.Entry)localIterator.next()).getValue();
          if ((localapdh.jdField_a_of_type_Apwj != null) && (localapdh.jdField_a_of_type_Apwj.b())) {
            QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] >>>onQQProcessExit. stop download:url:" + localapdh.jdField_a_of_type_JavaLangString);
          }
          Bundle localBundle = new Bundle();
          localBundle.putString("_notify_param_Url", localapdh.jdField_a_of_type_JavaLangString);
          apdk.a().c(localapdh.b, localBundle);
          QLog.i("UniformDownloadMgr<FileAssistant>", 1, "[UniformDL] >>>onQQProcessExit. cancel notification:" + localapdh.b);
        }
      }
    }
    e();
