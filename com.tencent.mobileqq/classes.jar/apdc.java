  ...
  implements Manager
{
  ...
  private ConcurrentHashMap<String, apde> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private long jdField_b_of_type_Long = -1L;
  private ConcurrentHashMap<String, String> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap;
  
  public apdc(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          ((StringBuilder)localObject1).append(((apde)localEntry.getValue()).jdField_a_of_type_Int);
          ((StringBuilder)localObject1).append(",type=");
          ((StringBuilder)localObject1).append(((apde)localEntry.getValue()).b);
          ((StringBuilder)localObject1).append(",isRequest=");
          ((StringBuilder)localObject1).append(((apde)localEntry.getValue()).jdField_a_of_type_Boolean);
          ((StringBuilder)localObject1).append(",saveTime=");
          ((StringBuilder)localObject1).append(((apde)localEntry.getValue()).jdField_a_of_type_Long);
      ...
      {
        localObject1 = (apde)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
        if (localObject1 != null)
        {
          int k = ((apde)localObject1).jdField_a_of_type_Int;
          int m = ((apde)localObject1).b;
          if (((m == 0) && (k != j)) || ((m != i) && (!((apde)localObject1).jdField_a_of_type_Boolean)))
          {
            ((apde)localObject1).jdField_a_of_type_Boolean = true;
            if (QLog.isColorLevel())
            {
          ...
          if ((k == j) && (m == i) && (((apde)localObject1).jdField_a_of_type_Boolean))
          {
            if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    Object localObject = bhsi.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      localObject = ((String)localObject).split("\\|");
      if ((localObject != null) && (localObject.length == 2))
      {
        this.jdField_a_of_type_Long = aqfy.a(localObject[0]);
        this.jdField_b_of_type_Long = aqfy.a(localObject[1]);
        if (QLog.isColorLevel()) {
  ...
  public void a(apdd paramapdd)
  {
    ...
    if ((a()) && (paramapdd != null))
    {
      ...
      localStringBuilder.append(" uin=").append(bhsr.e(paramapdd.jdField_a_of_type_JavaLangString));
      localStringBuilder.append(" sysId=").append(paramapdd.jdField_b_of_type_Long);
      localStringBuilder.append(" headType=").append(paramapdd.c);
      localStringBuilder.append(" qq18Switch=").append(paramapdd.jdField_a_of_type_Long);
      if ((!TextUtils.isEmpty(paramapdd.jdField_a_of_type_JavaLangString)) && (paramapdd.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (paramapdd.jdField_a_of_type_Long != -1L)) {
        a(paramapdd.jdField_a_of_type_Long);
      }
      localFriendListHandler = (FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(1);
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(1, paramapdd.jdField_a_of_type_JavaLangString, 0);
      if ((localObject == null) || (!((Boolean)((Pair)localObject).first).booleanValue())) {
        break label221;
      }
      localFriendListHandler.c(paramapdd.jdField_a_of_type_JavaLangString);
      localFriendListHandler.notifyUI(3, true, paramapdd.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      if ((localObject != null) && (((Pair)localObject).second != null))
      {
        ...
        if (((paramapdd.jdField_a_of_type_Long == 1L) && (paramapdd.c != -1L) && (paramapdd.c != l2)) || ((paramapdd.jdField_b_of_type_Long != -1L) && (paramapdd.jdField_b_of_type_Long != l1) && (l2 == 0L)))
        {
          localStringBuilder.append(" fetch userHead");
          localFriendListHandler.c(paramapdd.jdField_a_of_type_JavaLangString);
          localFriendListHandler.notifyUI(3, true, paramapdd.jdField_a_of_type_JavaLangString);
  ...
  public void a(String paramString)
  {
    ...
    {
      apde localapde = (apde)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if ((localapde != null) && (localapde.jdField_a_of_type_Boolean))
      {
        QLog.d("ClassicHeadActivityManager", 2, " QQ 18 handle handleGetHeadError uin=" + paramString + ",HeadID=" + localapde.jdField_a_of_type_Int + ",Type=" + localapde.b + ",IsRequest=" + localapde.jdField_a_of_type_Boolean);
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString);
      }
    }
  }
      ...
      do
      {
        do
        {
          ...
          do
          {
            ...
            {
              return;
              localObject = new apde(paramString, paramInt1, paramInt2);
              if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(paramString)) {
                break;
              }
            ...
            return;
            localapde = (apde)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
          } while (localapde == null);
          i = localapde.jdField_a_of_type_Int;
          j = localapde.b;
