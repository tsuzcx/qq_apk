...
public class apdc
{
  ...
  public static apdd a(int paramInt1, int paramInt2, apde paramapde, boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (i > j)
      {
        i3 = i;
        n = j;
        switch (paramapde.jdField_a_of_type_Int)
        {
        default: 
          paramapde = new apdd();
          paramapde.jdField_a_of_type_Int = paramInt1;
          paramapde.b = paramInt2;
          return paramapde;
        }
      }
      break;
  ...
  public static apdd a(int paramInt1, int paramInt2, String paramString)
  {
    int i = g;
    int j = h;
    apdd localapdd = new apdd();
    float f1;
    if (bace.b(paramString))
    {
      ...
      localapdd.jdField_a_of_type_Int = localOptions.outWidth;
      localapdd.b = localOptions.outHeight;
      paramString = localapdd;
  ...
  public static apdd a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    int i;
    if (paramInt1 > paramInt2) {
      i = paramInt2;
    ...
    {
      apde localapde = a(i, j);
      i = a(paramInt1, paramInt2, jdField_a_of_type_Int);
      return a(paramInt1 * i, i * paramInt2, localapde, false);
      i = paramInt1;
    }
  }
  
  public static apdd a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (bace.b(paramFileManagerEntity.strMiddleThumPath))
    {
      ...
      localapdd.jdField_a_of_type_Int = localOptions.outWidth;
      localapdd.b = localOptions.outHeight;
      paramFileManagerEntity = localapdd;
  ...
  private static apde a(int paramInt1, int paramInt2)
  {
    int i = 0;
    int j = 1;
    ...
    for (;;)
    {
      apde localapde = new apde();
      localapde.jdField_a_of_type_Int = paramInt2;
      localapde.b = paramInt1;
      return localapde;
      paramInt1 = 2;
      paramInt2 = 2;
      continue;
  ...
  public static String a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (!TextUtils.isEmpty(paramFileManagerEntity.strFileMd5)) {
      paramFileManagerEntity = becz.a(paramFileManagerEntity.strFileMd5);
    }
    for (;;)
    {
      ...
      {
        paramFileManagerEntity = becz.a(paramFileManagerEntity.Uuid);
      }
      else if (apdh.b(paramFileManagerEntity.getFilePath()))
      {
        localObject = apck.d(paramFileManagerEntity.getFilePath());
        if ((localObject != null) && (localObject.length > 0)) {
          paramFileManagerEntity = bach.a((byte[])localObject).toUpperCase();
        } else {
          paramFileManagerEntity = becz.a(paramFileManagerEntity.fileName);
        }
      }
      else
      {
  ...
  public static String a(String paramString)
  {
    ...
    {
      return null;
      String str1 = bach.a(apck.d(paramString));
      a();
      str1 = apbo.a().d() + a(5, str1);
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          {
            if (!bace.b(str2)) {
              atra.a(paramString, str2, true, "", 1);
            }
            if ((!bace.b(str2)) || (bace.b(new File(str2), new File(str1)) != true)) {
              break;
            }
            return str1;
          }
  ...
  private static String a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        atra.a(paramString1, str, true, "", paramInt);
        if (bace.b(str)) {
          break label220;
        }
      ...
      continue;
      label220:
      if (!bace.b(new File(str), new File(paramString2)))
      {
        bace.a(str, true);
  ...
  public static URL a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject1)) {
      localObject2 = bach.a(apck.d(paramFileManagerEntity.getFilePath())).toUpperCase();
    }
    localObject1 = apbo.a().d() + a(5, becz.a((String)localObject2));
    if ((bace.b(str)) && (!apdh.b(paramFileManagerEntity.strMiddleThumPath)) && (bace.b(new File(str), new File((String)localObject1)) == true)) {
  ...
  {
    File localFile = new File(apbo.a().d());
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
  }
  ...
  private static void a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    paramString = a(paramString, apbo.a().d() + a(5, str), 1);
    if (paramString == null) {
  ...
  public static boolean a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    while ((paramFileManagerEntity.cloudType == 1) && (apck.a(paramFileManagerEntity))) {
      return true;
    }
    return false;
  }
