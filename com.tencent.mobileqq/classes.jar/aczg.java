  ...
  extends acyo
{
  ...
  public aczg(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  private BaseChatItemLayout a(long paramLong)
  {
    ...
    if (paramLong == 0L)
    {
      ...
      while (k < this.jdField_a_of_type_ComTencentWidgetListView.getChildCount())
      {
        ...
        {
          localObject2 = (acun)actn.a((View)localObject1);
          if ((((acun)localObject2).jdField_a_of_type_Int != 0) && (((acun)localObject2).jdField_a_of_type_AndroidViewView.getTop() + ((View)localObject1).getTop() + BaseChatItemLayout.jdField_g_of_type_Int > 0)) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if (((localObject2 instanceof BaseChatItemLayout)) && (((acun)actn.a((View)localObject2)).jdField_a_of_type_Int != 0)) {
  ...
  int a(int paramInt, acun paramacun)
  {
    int k;
    int m;
    int n;
    if (paramacun.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend())
    {
      k = paramacun.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.j + BaseChatItemLayout.o;
      m = paramacun.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.i - BaseChatItemLayout.n;
      if (paramInt > k) {
        break label135;
      }
    ...
    {
      return n;
      k = paramacun.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.i + BaseChatItemLayout.n;
      m = paramacun.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.j - BaseChatItemLayout.j;
      break;
      d1 = Math.random();
  ...
  public long a()
  {
    ...
    case 3: 
      ...
      if (this.jdField_b_of_type_Int == 1)
      {
        ...
        {
          localacun = (acun)actn.a(localBaseChatItemLayout);
          if (localacun != null)
          {
            this.jdField_b_of_type_Int = 2;
            this.jdField_a_of_type_Long = 0L;
            this.jdField_b_of_type_Long = localacun.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq;
            this.jdField_d_of_type_Long = 0L;
            this.jdField_e_of_type_Int = 0;
            k = localacun.jdField_a_of_type_AndroidViewView.getTop();
            ...
            this.jdField_g_of_type_Int = a((localacun.jdField_a_of_type_AndroidViewView.getLeft() + localacun.jdField_a_of_type_AndroidViewView.getRight()) / 2, localacun);
            this.h = 0;
      ...
      if (localBaseChatItemLayout != null)
      {
        ...
        if (localacun != null)
        {
          ...
          this.jdField_e_of_type_Int = (a(this.i, localacun) - this.i);
  ...
  public boolean a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      while ((this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner == null) || (this.jdField_a_of_type_AndroidViewView == null))
      {
        ...
        return false;
        k = actn.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
        ...
        {
          acun localacun = (acun)actn.a(actn.a(this.jdField_a_of_type_ComTencentWidgetListView, k));
          if (localacun != null)
          {
            k = localacun.jdField_a_of_type_AndroidViewView.getTop();
            k = localacun.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            if (k != 0)
            {
              this.h += k;
              this.j += k;
          ...
          else
          {
            ...
            return false;
            k = actn.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            int m = actn.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            ...
            {
              localacun = (acun)actn.a(actn.a(this.jdField_a_of_type_ComTencentWidgetListView, k));
              if (localacun != null)
              {
                k = localacun.jdField_a_of_type_AndroidViewView.getTop();
                k = localacun.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            ...
            {
              localacun = (acun)actn.a(actn.a(this.jdField_a_of_type_ComTencentWidgetListView, m));
              if (localacun != null)
              {
                k = localacun.jdField_a_of_type_AndroidViewView.getTop();
                k = localacun.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
