...
public class rnq
{
  ...
  public static Pair<String, Bitmap> a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        int n = actj.a(0.5F, localResources);
        int i = actj.a(90.0F, localResources);
        ...
        if (k >= paramInt)
        {
          ...
          localCanvas.drawBitmap(BitmapFactory.decodeResource(localResources, 2130841218), actj.a(13.0F, localResources), actj.a(25.0F, localResources) + paramInt, localPaint);
          localPaint.setColor(-16777216);
          localPaint.setTextSize(actj.a(2, 18, localResources));
          localCanvas.drawText("QQ看点", actj.a(60.0F, localResources), actj.a(42.0F, localResources) + paramInt, localPaint);
          localPaint.setColor(Color.parseColor("#777777"));
          localPaint.setTextSize(actj.a(2, 14, localResources));
          localCanvas.drawText(localResources.getString(2131695593), actj.a(60.0F, localResources), actj.a(61.0F, localResources) + paramInt, localPaint);
          ...
          str = (String)naj.a((HashMap)localObject).get("url");
          ...
          axrn.a(BaseApplication.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "actReadInJoyShortenUrl", true, 0L, 0L, (HashMap)localObject, "");
      ...
      catch (Exception paramString1)
      {
        try
        {
          ...
          paramString1 = baui.a(paramString2, localResources, actj.a(80.0F, localResources), 0, false);
          paramString2 = paramString1;
          if (paramString1 == null)
          {
            if (QLog.isColorLevel()) {
            ...
            paramString2 = BitmapFactory.decodeResource(localResources, 2130841224);
          }
          localCanvas.drawBitmap(paramString2, j - actj.a(5.0F, localResources) - paramString2.getWidth(), actj.a(5.0F, localResources) + paramInt, localPaint);
      ...
      if (TextUtils.isEmpty(str))
      {
        ...
        axrn.a(BaseApplication.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "actReadInJoyShortenUrl", false, 0L, 0L, (HashMap)localObject, "");
        paramString1 = null;
      }
  ...
  public static String a(Bitmap paramBitmap, String paramString)
  {
    ...
    //   3: dup
    //   4: getstatic 346	ajsd:cy	Ljava/lang/String;
    //   7: invokestatic 350	bbvj:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   57: getstatic 346	ajsd:cy	Ljava/lang/String;
    ...
    //   80: invokestatic 350	bbvj:a	(Ljava/lang/String;)Ljava/lang/String;
    //   83: astore 4
