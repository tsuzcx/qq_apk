  ...
  extends BaseJsPlugin
{
  ...
  private boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    MiniAppController.navigateBackMiniApp(paramString2, paramString1, localLaunchParam, new bkyz(this, paramString2));
    return true;
  }
  ...
  public void navigateBackMiniProgram(RequestEvent paramRequestEvent)
  {
    ...
    if (jdField_a_of_type_Int == 1)
    {
      ...
      if (localObject2 != null) {
        a((com.tencent.mobileqq.mini.apkg.MiniAppInfo)localObject2, str, (String)localObject1, new bkyx(this, paramRequestEvent));
      }
    }
  }
      ...
      for (;;)
      {
          ...
          if ((this.mMiniAppContext.getMiniAppInfo() != null) && (((String)localObject2).equals(this.mMiniAppContext.getMiniAppInfo().appId)))
          {
            ...
            if (localObject3 != null)
            {
              ...
              if (localEntryModel != null) {
                ((com.tencent.mobileqq.mini.sdk.LaunchParam)localObject5).entryModel = bkyr.a(localEntryModel);
              }
        ...
        for (;;)
        {
          ...
          if (localMiniAppInfo.isAppStoreMiniApp())
          {
            ...
            localLaunchParam.entryModel = bkyr.b(localEntryModel);
          ...
          for (localObject1 = ((JSONObject)localObject1).toString();; localObject1 = "")
          {
            ...
            MiniAppController.startAppByAppid(this.mMiniAppContext.getAttachedActivity(), (String)localObject4, (String)localObject5, str1, localLaunchParam, new bkyy(this, paramRequestEvent));
            paramRequestEvent.ok();
            return;
            localObject3 = "";
            break;
