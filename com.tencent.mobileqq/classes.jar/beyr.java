...
{
  public beyr(TroopBarPublishActivity paramTroopBarPublishActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramBoolean)
    {
      ...
      paramBundle = "0";
      bgip.a("pub_page", "fail", paramBundle, "4", TroopBarPublishActivity.b(this.a), "");
      ...
      if (!TextUtils.isEmpty(bgip.a(this.a.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText))) {
      ...
      if (this.a.h) {
        if (!TextUtils.isEmpty(bgip.a(this.a.jdField_a_of_type_ComTencentMobileqqTribeViewTEditText)))
        {
    ...
    {
      bdla.b(null, "P_CliOper", "Grp_tribe", "", "pub_page", "suc", paramInt, 0, paramBundle, this.a.jdField_b_of_type_JavaLangString, localStringBuffer.toString(), "");
      this.a.e = true;
      ...
      for (;;)
      {
        bhij.a(this.a.app, "share_suc", paramBundle);
        if ((this.a.jdField_a_of_type_Beuo != null) && (!TroopBarPublishActivity.a(this.a).equals("###...^_^###"))) {
          bdla.b(null, "dc00899", "Grp_tribe", "", "pub_page", "sus_prefixpub", 0, 0, this.a.q, "", "", "");
        }
