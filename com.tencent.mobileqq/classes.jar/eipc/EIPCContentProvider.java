  ...
  extends AppContentProvider
{
  ...
  public static final IBinder queryBinder(android.content.Context paramContext)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 43	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   4: getstatic 27	eipc/EIPCContentProvider:CONTENT_URI	Landroid/net/Uri;
    //   7: aconst_null
    //   8: aconst_null
    //   9: iconst_1
    //   10: anewarray 45	java/lang/String
    //   13: dup
    //   14: iconst_0
    //   15: ldc 11
    //   17: aastore
    //   18: aconst_null
    //   19: invokevirtual 51	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   22: astore_1
    //   23: aload_1
    //   24: astore_0
    //   25: aload_1
    ...
    //   34: aload_2
    //   35: ldc 59
    //   37: invokevirtual 65	java/lang/Class:getClassLoader	()Ljava/lang/ClassLoader;
    //   40: invokevirtual 71	android/os/Bundle:setClassLoader	(Ljava/lang/ClassLoader;)V
    //   43: aload_1
    //   44: astore_0
    //   45: aload_2
    //   46: ldc 73
    //   48: invokevirtual 77	android/os/Bundle:getParcelable	(Ljava/lang/String;)Landroid/os/Parcelable;
    //   51: checkcast 59	eipc/EIPCBinderCursor$BinderParcelable
    //   54: getfield 81	eipc/EIPCBinderCursor$BinderParcelable:mBinder	Landroid/os/IBinder;
    //   57: astore_2
    //   58: aload_1
    //   59: ifnull +9 -> 68
    //   62: aload_1
    ...
    //   74: ldc 88
    //   76: aload_0
    //   77: invokestatic 94	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   80: aload_2
    //   81: areturn
    //   82: astore_2
    //   83: aconst_null
    ...
    //   90: ldc 88
    //   92: aload_2
    //   93: invokestatic 94	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   96: aload_1
    //   97: ifnull +59 -> 156
    //   100: aload_1
    ...
    //   112: ldc 88
    //   114: aload_0
    //   115: invokestatic 94	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   118: aconst_null
    //   119: areturn
    //   120: astore_1
    //   121: aconst_null
    ...
    //   139: ldc 88
    //   141: aload_0
    //   142: invokestatic 94	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   145: goto -12 -> 133
    //   148: astore_1
    //   149: goto -26 -> 123
    //   152: astore_2
