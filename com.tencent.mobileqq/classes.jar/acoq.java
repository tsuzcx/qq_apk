...
{
  private acnt jdField_a_of_type_Acnt;
  private acoe jdField_a_of_type_Acoe;
  private acok jdField_a_of_type_Acok;
  private acol jdField_a_of_type_Acol;
  private acom jdField_a_of_type_Acom;
  ...
  public acoq(acow paramacow, View paramView, acoe paramacoe)
  {
    acqy.a("GdtMvElementsController", "GdtMvElementsController: ");
  ...
  private ImageView a(int paramInt)
  {
    ...
    if (2 == paramInt) {
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130838493));
    }
    do
    {
      ...
      if (1 == paramInt)
      {
        localImageView.setImageDrawable(this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130838487));
        return localImageView;
      }
    } while (3 != paramInt);
    localImageView.setImageDrawable(this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130838488));
    return localImageView;
  }
  ...
  private URLDrawable a(String paramString)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = localResources.getDrawable(2130845481);
    localURLDrawableOptions.mFailedDrawable = localResources.getDrawable(2130845481);
    paramString = URLDrawable.getDrawable(paramString, localURLDrawableOptions);
    int i = acsj.a(140, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    paramString.setTag(bgey.b(i, i, acsj.a(21, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext))));
  ...
  private void a(double paramDouble, LinearLayout paramLinearLayout)
  {
    ...
    for (;;)
    {
      ...
      if (paramDouble < 8.0D)
      {
        ...
        k = 4;
        i = 1;
        m = afur.a(15.0F, this.jdField_a_of_type_AndroidViewView.getResources());
      ...
      label133:
      for (localLayoutParams.leftMargin = 0;; localLayoutParams.leftMargin = afur.a(3.0F, this.jdField_a_of_type_AndroidViewView.getResources()))
      {
  ...
  {
    Object localObject1 = this.jdField_a_of_type_Acoe.a();
  ...
  private void a(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean)
        {
          j = acsj.e(this.jdField_a_of_type_AndroidContentContext);
          localLayoutParams.height = acsj.a(paramInt, i, j);
          this.jdField_b_of_type_AndroidViewView.setBackground(acsj.a(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165666), 8, 80));
          this.jdField_b_of_type_AndroidViewView.setVisibility(0);
          this.jdField_b_of_type_AndroidViewView.setLayoutParams(localLayoutParams);
          acqy.b("GdtMvElementsController", "initDesMaskPositions " + paramInt + "|" + paramBoolean);
          return;
        }
        int j = acsj.f(this.jdField_a_of_type_AndroidContentContext);
        continue;
      ...
      {
        this.jdField_b_of_type_AndroidViewView.setVisibility(8);
        acqy.d("GdtMvElementsController", "initDesMaskPositions error! ", localThrowable);
        return;
      }
      return;
      label184:
  ...
  private void a(String paramString)
  {
    ...
    if (this.jdField_c_of_type_AndroidWidgetTextView != null)
    {
      ...
      {
        acqy.a("GdtMvElementsController", "updateScoreAndStar " + paramString);
        if (this.jdField_a_of_type_AndroidWidgetLinearLayout != null) {
          this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
        }
        this.jdField_c_of_type_AndroidWidgetTextView.setText(paramString);
        this.jdField_c_of_type_AndroidWidgetTextView.setTextSize(14.0F);
        this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165547));
        float f = 0.0F;
        ...
        acqy.a("GdtMvElementsController", "updateScoreAndStar " + this.jdField_b_of_type_AndroidWidgetTextView.getWidth() + " mw " + f);
  ...
  private String b()
  {
    ...
    if (localObject != null)
    {
      ...
      if (!((qq_ad_get.QQAdGetRsp.AdInfo)localObject).display_info.button_info.get().isEmpty())
      {
        ...
        acqy.b("GdtMvElementsController", "getContentStrByStyle pushName " + str2);
        ...
        {
          str1 = str2;
          if (nxw.a(this.jdField_a_of_type_AndroidContentContext, (String)localObject))
          {
  ...
  private void i()
  {
    ...
    localLayoutParams.width = acsj.a(140, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.height = localLayoutParams.width;
    localLayoutParams.topMargin = acsj.a(1054, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acsj.a(30, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetTextView.getLayoutParams();
    localLayoutParams.topMargin = acsj.a(1063, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acsj.a(196, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidWidgetTextView.getLayoutParams();
    localLayoutParams.topMargin = acsj.a(1111, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acsj.a(196, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidWidgetLinearLayout.getLayoutParams();
    localLayoutParams.topMargin = acsj.a(1160, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acsj.a(196, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    ...
    localLayoutParams.height = acsj.a(80, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.topMargin = acsj.a(1224, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acsj.a(30, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    ...
    localLayoutParams.height = acsj.a(129, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.topMargin = acsj.a(1199, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acsj.a(5, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = localLayoutParams.leftMargin;
    acqy.a("GdtMvElementsController", "inti585Vpositions() urlBtnLp2.topMargin = " + localLayoutParams.topMargin + ", urlBtnLp2.height = " + localLayoutParams.height);
    ((RelativeLayout.LayoutParams)this.jdField_c_of_type_AndroidViewView.getLayoutParams()).height = acsj.a(315, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
  }
  ...
  private void j()
  {
    ...
    localLayoutParams.width = acsj.a(140, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.height = localLayoutParams.width;
    localLayoutParams.topMargin = acsj.a(580, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acsj.a(30, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetTextView.getLayoutParams();
    localLayoutParams.topMargin = acsj.a(589, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acsj.a(196, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidWidgetTextView.getLayoutParams();
    localLayoutParams.topMargin = acsj.a(637, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acsj.a(196, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidWidgetLinearLayout.getLayoutParams();
    localLayoutParams.topMargin = acsj.a(685, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acsj.a(196, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.getLayoutParams();
    localLayoutParams.height = acsj.a(80, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.topMargin = acsj.a(611, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acsj.a(1034, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = acsj.a(30, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetButton.getLayoutParams();
    localLayoutParams.height = acsj.a(129, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.topMargin = acsj.a(586, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acsj.a(1009, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = acsj.a(5, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    ((RelativeLayout.LayoutParams)this.jdField_c_of_type_AndroidViewView.getLayoutParams()).height = acsj.a(200, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
  }
  
  private void k()
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
      ((RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams()).topMargin = acsj.a(742, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    }
    ...
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setHeight(acsj.a(80, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext)));
    localLayoutParams.topMargin = acsj.a(1224, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acsj.a(30, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = localLayoutParams.leftMargin;
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetButton.getLayoutParams();
    this.jdField_a_of_type_AndroidWidgetButton.setHeight(acsj.a(129, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext)));
    localLayoutParams.topMargin = acsj.a(1199, 1334, acsj.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acsj.a(5, 750, acsj.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = localLayoutParams.leftMargin;
  }
  ...
  private void l()
  {
    ...
    for (;;)
    {
      ...
      return;
      label111:
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845481);
      if (this.jdField_b_of_type_AndroidWidgetImageView != null) {
        this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130845481);
      }
    }
  }
  ...
  {
    GdtMotiveVideoPageData localGdtMotiveVideoPageData = this.jdField_a_of_type_Acoe.a();
    qq_ad_get.QQAdGetRsp.AdInfo localAdInfo = this.jdField_a_of_type_Acoe.a();
    Activity localActivity = this.jdField_a_of_type_Acow.a().a();
    if (localActivity != null)
    {
      acqy.b("GdtMvElementsController", "doHandleClick");
  ...
  private void n()
  {
    int i = this.jdField_a_of_type_Acoe.a().exp_info.video_volume.get();
    acqy.a("GdtMvElementsController", "[initData] videoVolume = " + i);
    acow localacow = this.jdField_a_of_type_Acow;
    if (i == 0) {}
    for (boolean bool = true;; bool = false)
    {
      localacow.jdField_a_of_type_Boolean = bool;
      return;
    }
  }
  ...
  {
    Object localObject = this.jdField_a_of_type_Acoe.a();
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131362204);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362089));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362091));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362109));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362111));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362029));
    this.e = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362032));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362101));
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight = ((GdtMvButtonHighLight)this.jdField_a_of_type_AndroidViewView.findViewById(2131362118));
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView = ((GdtMvAppBtnView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362123));
    this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView = ((GdtMvAppBtnView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362122));
    if (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight != null)
    {
      this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setOnClickListener(this);
      this.jdField_a_of_type_Acnt.a(this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight);
    }
    if (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView != null)
    {
      ...
      this.jdField_a_of_type_Acnt.a(this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView);
    }
    if (this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView != null)
    {
      ...
      this.jdField_a_of_type_Acnt.a(this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView);
    }
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131362119));
    if (this.jdField_a_of_type_AndroidWidgetButton != null) {
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(4);
    }
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131362103));
    ...
    {
      this.jdField_a_of_type_Acnt.a(this.jdField_c_of_type_AndroidViewView);
      this.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
      this.jdField_c_of_type_AndroidViewView.setOnHoverListener(this);
    }
    this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131367386);
    if (this.jdField_d_of_type_AndroidViewView != null)
    {
      this.jdField_a_of_type_Acnt.a(this.jdField_d_of_type_AndroidViewView);
      this.jdField_d_of_type_AndroidViewView.setOnClickListener(this);
    }
    if ((((GdtMotiveVideoPageData)localObject).vSize != 585) && (((GdtMotiveVideoPageData)localObject).screenOrientation == 1)) {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363571));
    }
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131362087));
    h();
    n();
    l();
    localObject = b();
    ...
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvDownloadBtnManager = new GdtMvDownloadBtnManager(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Acoe.a(), (String)localObject, this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView, this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView);
  ...
  {
    GdtMotiveVideoPageData localGdtMotiveVideoPageData = this.jdField_a_of_type_Acoe.a();
    acqy.b("GdtMvElementsController", "adjustViewsPosition " + paramInt + " style " + localGdtMotiveVideoPageData.style);
    if (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight != null) {
    ...
    if (localGdtMotiveVideoPageData.screenOrientation == 1)
    {
      ...
      {
        this.jdField_a_of_type_Acol = new acol(this.jdField_a_of_type_AndroidContentContext);
        this.jdField_a_of_type_Acol.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight, this.jdField_b_of_type_AndroidWidgetRelativeLayout, this.jdField_c_of_type_AndroidViewView);
      }
      this.jdField_a_of_type_Acol.a(paramInt);
      return;
    }
    if (this.jdField_a_of_type_Acok == null)
    {
      this.jdField_a_of_type_Acok = new acok(this.jdField_a_of_type_AndroidContentContext);
      this.jdField_a_of_type_Acok.a(this.jdField_b_of_type_AndroidViewView, this.jdField_b_of_type_AndroidWidgetRelativeLayout, this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight, this.jdField_a_of_type_AndroidWidgetImageView, this.jdField_a_of_type_AndroidWidgetTextView, this.jdField_b_of_type_AndroidWidgetTextView, this.jdField_b_of_type_AndroidWidgetLinearLayout, this.jdField_c_of_type_AndroidViewView);
    }
    this.jdField_a_of_type_Acok.a(paramInt);
  }
  ...
  public void a(int paramInt, String paramString)
  {
    GdtMotiveVideoPageData localGdtMotiveVideoPageData = this.jdField_a_of_type_Acoe.a();
    qq_ad_get.QQAdGetRsp.AdInfo localAdInfo = this.jdField_a_of_type_Acoe.a();
    long l = this.jdField_a_of_type_Acow.a();
    String str2 = "";
    String str1;
    switch (paramInt)
    {
    ...
    for (;;)
    {
      ...
      return;
      acqy.a("GdtMvElementsController", "[click ad btn] " + localAdInfo);
      Activity localActivity = this.jdField_a_of_type_Acow.a().a();
      str1 = str2;
      if (localAdInfo != null)
      {
        ...
        if (localActivity != null)
        {
          ...
          paramString = this.jdField_a_of_type_Acnt.a(str1, l, this.jdField_a_of_type_Acow.a(), this.jdField_a_of_type_Acow.b(), paramString);
          localAdInfo.report_info.click_url.set(paramString);
          GdtHandler.a(a(localAdInfo, localGdtMotiveVideoPageData, localActivity));
          continue;
          acqy.a("GdtMvElementsController", "[click ad download btn] ");
          str1 = str2;
          if (localAdInfo != null)
          {
            str1 = localAdInfo.report_info.click_url.get();
            ...
            if ((localAdInfo.exp_info.reward_video_download_type.get() == 1) && (localAdInfo.product_type.get() == 12) && (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvDownloadBtnManager != null))
            {
              ...
              if (nxw.a(this.jdField_a_of_type_AndroidContentContext, paramString)) {
                m();
              } else {
  ...
  public void b()
  {
    Drawable localDrawable = this.jdField_a_of_type_AndroidViewView.getResources().getDrawable(2130840225);
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setBackgroundDrawable(localDrawable);
    int i = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167171);
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setTextColor(i);
  }
  
  public void c()
  {
    acqy.b("GdtMvElementsController", "enableMvBtnUrlStyleDefault");
    if (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight != null)
    {
      this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setBackgroundDrawable(this.jdField_a_of_type_AndroidViewView.getResources().getDrawable(2130840214));
      this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167279));
    }
  }
  ...
  public void e()
  {
    ...
    if (this.jdField_a_of_type_Acom != null)
    {
      this.jdField_a_of_type_Acom.b();
      this.jdField_a_of_type_Acom = null;
    }
    if (this.jdField_a_of_type_Acol != null)
    {
      this.jdField_a_of_type_Acol.b();
      this.jdField_a_of_type_Acol = null;
    }
    if (this.jdField_a_of_type_Acok != null)
    {
      this.jdField_a_of_type_Acok.b();
      this.jdField_a_of_type_Acok = null;
    }
    ...
    if (this.jdField_a_of_type_Acnt != null) {
      this.jdField_a_of_type_Acnt.a();
    }
  }
  ...
  public void g()
  {
    acqy.a("GdtMvElementsController", "onResume: ");
    d();
    f();
  }
  ...
  public boolean onHover(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    {
      return false;
      acqy.d("GdtMvElementsController", "onHover " + paramMotionEvent.getAction());
