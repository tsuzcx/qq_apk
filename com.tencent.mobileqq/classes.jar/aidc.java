  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    paramView = (ajex)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22);
    int i;
    label100:
    label120:
    awrb localawrb;
    ...
    if (bool)
    {
      ...
      awqx.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_contactlist", paramView, 0, 0, ((TroopInfo)localObject).troopuin, "", "", "");
      localawrb = new awrb(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_set").c("Grp_contactlist");
      if (!bool) {
        break label249;
      }
