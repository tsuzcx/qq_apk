  ...
  implements adci
{
  private static void a(QQAppInterface paramQQAppInterface, long paramLong, MsgType0x210 paramMsgType0x210)
  {
    ...
    try
    {
      ...
      if (((submsgtype0xdf.MsgBody)localObject).msg_game_state.has())
      {
        ...
        l = bhjx.a(((apollo_game_status.STCMGameMessage.STMsgComm)localObject).uint32_session_id.get());
        paramQQAppInterface = (amst)paramQQAppInterface.getManager(211);
        if (paramLong != l) {
          break label194;
        }
        ...
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          ...
          {
            l = bhjx.a(((Integer)((Iterator)localObject).next()).intValue());
            if (l != paramLong) {
  ...
  {
    a(paramadan.a(), paramLong, paramMsgType0x210);
    return null;
  }
}
