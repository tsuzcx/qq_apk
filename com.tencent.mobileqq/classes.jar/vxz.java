...
{
  public vxz(FriendChatPie paramFriendChatPie) {}
  ...
  public void a(boolean paramBoolean, PBRepeatMessageField paramPBRepeatMessageField)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 2, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131436936), 0).a();
        if (this.a.n) {
          this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.setResult(-1);
        }
        this.a.A();
        return;
        QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131436937), 0).a();
        return;
      }
    }
  }
