  ...
  implements View.OnClickListener
{
  ...
  public bgqn(Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
    this.jdField_b_of_type_Float = 45.5F;
    this.jdField_c_of_type_Float = 39.0F;
    this.jdField_c_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bgqp(this);
  ...
  public void a(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetEditText != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new bgqq(this, paramInt));
    }
  }
  
  void a(Context paramContext)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout = ((MyLinearLayout)View.inflate(paramContext, 2131559026, null));
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout.findViewById(2131369920).setOnClickListener(this);
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout.setDispatchKeyEventListener(new bgqr(this));
  }
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    LinearLayout localLinearLayout = (LinearLayout)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout.findViewById(2131369917);
    localLinearLayout.removeAllViews();
    int i = 0;
    while (i < paramArrayList.size())
    {
      View localView = View.inflate(getContext(), 2131559027, null);
      localView.setTag(Integer.valueOf(i));
      localView.setClickable(true);
      localView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      ((TextView)localView.findViewById(2131369916)).setText((CharSequence)paramArrayList.get(i));
  ...
  public void onClick(View paramView)
  {
    if (paramView.getId() == 2131368662) {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletWidgetMyLinearLayout != null)
      {
        ...
        a();
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130847288);
        this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130847288));
    ...
    for (;;)
    {
      ...
      if ((localObject != null) && ((localObject instanceof Integer)) && (((Integer)localObject).intValue() == 2130847888))
      {
      ...
      else
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130847888);
        this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130847888));
        this.jdField_a_of_type_AndroidOsHandler.postDelayed(new QQCustomDialogWtihInputAndChoose.6(this), 200L);
        continue;
        if (paramView.getId() == 2131369920)
        {
          a();
        }
        else
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131368662));
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new bgqo(this));
    Context localContext = (Context)this.jdField_a_of_type_JavaLangRefSoftReference.get();
    if (localContext == null) {
      return;
    }
    acdz.a(localContext, this.jdField_a_of_type_AndroidWidgetEditText);
    a(localContext);
  }
  ...
  {
    TextView localTextView = (TextView)findViewById(2131365452);
  ...
  public bgpa setNegativeButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new bgqs(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public bgpa setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.rBtn.setOnClickListener(new bgqt(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
