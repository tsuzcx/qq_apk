...
{
  public int a;
  private final ajsd jdField_a_of_type_Ajsd = new ajsd();
  ...
  private ArrayList<aukm> jdField_a_of_type_JavaUtilArrayList;
  ...
  private AccountObserver jdField_a_of_type_MqqObserverAccountObserver = new ajxo(this);
  ...
  private ConcurrentHashMap<String, aukm> jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(16);
  public boolean c;
  public int d;
  private ConcurrentHashMap<String, aukm> jdField_d_of_type_JavaUtilConcurrentConcurrentHashMap = new QQConcurrentHashMap(1011, 0, 400);
  private boolean jdField_d_of_type_Boolean;
  public int e;
  private ConcurrentHashMap<String, aukm> jdField_e_of_type_JavaUtilConcurrentConcurrentHashMap = new QQConcurrentHashMap(1012, 0, 400);
  private volatile boolean jdField_e_of_type_Boolean;
  public int f;
  private ConcurrentHashMap<String, Integer> jdField_f_of_type_JavaUtilConcurrentConcurrentHashMap;
  private boolean jdField_f_of_type_Boolean;
  public int g;
  private ConcurrentHashMap<String, ArrayList<aukm>> jdField_g_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(4);
  ...
  public ajxn(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Int = 3;
    this.jdField_b_of_type_Int = 30;
    this.jdField_c_of_type_Int = 7;
  ...
  private ConcurrentHashMap<String, ArrayList<aukm>> a(boolean paramBoolean)
  {
    label561:
    label564:
    label567:
  ...
  private void a(long paramLong, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    for (paramString1 = "1";; paramString1 = "0")
    {
      ...
      localHashMap.put("param_WalSwitch", String.valueOf(akfv.a));
      axrl.a(BaseApplicationImpl.getContext()).a(null, "actFriendSqliteOpt", true, paramLong, 0L, localHashMap, null, false);
      return;
      str = "0";
      break;
    }
  ...
  private void a(Friends[] paramArrayOfFriends)
  {
    ...
    aaod.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, BaseApplication.getContext(), localArrayList);
  }
  ...
  private void i()
  {
    amgc localamgc = amgc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    boolean bool = localamgc.a();
    if (QLog.isColorLevel()) {
      QLog.d("Q.contacttab.", 2, new Object[] { "doResetRingIdOfExtensionInfo: invoked. ", " hasResetGrayUserRingId: ", Boolean.valueOf(bool) });
    }
    if (!bool)
    {
      localamgc.a(this.jdField_d_of_type_JavaUtilConcurrentConcurrentHashMap);
      localamgc.a();
    }
  }
  ...
  private void j()
  {
    ??? = (ArrayList)this.jdField_a_of_type_Aukn.a(NoC2CExtensionInfo.class);
    if (??? != null)
    {
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)this.jdField_a_of_type_Aukn.a(Groups.class, false, "group_id>=?", new String[] { "0" }, null, null, "seqid asc", null));
    Object localObject;
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
  ...
  public ajsd a()
  {
    if (!this.jdField_a_of_type_Ajsd.a) {
      ThreadManager.excute(new FriendsManager.6(this), 16, null, true);
    }
    return this.jdField_a_of_type_Ajsd;
  }
  
  public aukp a()
  {
    return this.jdField_a_of_type_Aukn.a();
  }
  ...
  public Card a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_AndroidSupportV4UtilMQLruCache)
      {
        ...
        if (??? == null)
        {
          ??? = (Card)this.jdField_a_of_type_Aukn.a(Card.class, paramString);
      ...
      {
        this.jdField_b_of_type_AndroidSupportV4UtilMQLruCache.put(paramString, ???);
        this.jdField_a_of_type_Aukn.a((aukm)???);
        if (l1 != 0L) {
  ...
  {
    return (ContactCard)this.jdField_a_of_type_Aukn.a(ContactCard.class, paramString);
  }
  ...
  public ExtensionInfo a(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localExtensionInfo = (ExtensionInfo)this.jdField_a_of_type_Aukn.a(ExtensionInfo.class, paramString);
      ??? = localExtensionInfo;
      if (localExtensionInfo == null) {
        break;
      }
  ...
  public Groups a(String paramString)
  {
    ...
    do
    {
      ...
      localGroups = (Groups)this.jdField_a_of_type_Aukn.a(Groups.class, paramString);
      localObject = localGroups;
    } while (localGroups == null);
    this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, localGroups);
    this.jdField_a_of_type_JavaUtilArrayList = ajuj.a(this.jdField_a_of_type_JavaUtilArrayList, localGroups);
    return localGroups;
  }
  ...
  public KplCard a(String paramString)
  {
    ...
    for (;;)
    {
      paramString = (KplCard)this.jdField_a_of_type_Aukn.a(KplCard.class, paramString);
      if (l1 != 0L) {
        a(SystemClock.uptimeMillis() - l1, false, "query", "Card");
      }
      if (paramString != null) {
  ...
  public NoC2CExtensionInfo a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (localNoC2CExtensionInfo == null)
    {
      ...
      if (paramBoolean)
      {
        ...
        if (!this.jdField_e_of_type_Boolean)
        {
          paramString = (NoC2CExtensionInfo)this.jdField_a_of_type_Aukn.a(NoC2CExtensionInfo.class, "type=? and uin=?", new String[] { String.valueOf(paramInt), paramString });
          ??? = paramString;
          if (paramString != null) {
            synchronized (this.jdField_e_of_type_JavaUtilConcurrentConcurrentHashMap)
            {
  ...
  public ArrayList<aukm> a(int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
  ...
  public ArrayList<aukm> a(String paramString)
  {
  ...
  public ConcurrentHashMap<String, ArrayList<aukm>> a()
  {
    return a(false);
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((ArrayList)localObject1).add(localFriends);
        int i2 = bbcl.a(localFriends.detalStatusFlag, localFriends.iTermType);
        if ((i2 == 0) || (i2 == 6)) {
          continue;
        }
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (localObject4 != null) {
            Collections.sort((List)localObject4, ajuj.a);
          }
        }
      }
  ...
  public void a(int paramInt)
  {
    ...
    //   33: aload_0
    //   34: iload_1
    //   35: invokevirtual 833	ajxn:a	(I)Ljava/util/ArrayList;
    //   38: astore 5
    //   40: aconst_null
    //   41: astore_3
    //   42: aload_0
    //   43: getfield 162	ajxn:jdField_a_of_type_Aukn	Laukn;
    //   46: invokevirtual 594	aukn:a	()Laukp;
    //   49: astore 4
    //   51: aload 4
    //   53: astore_3
    //   54: aload_3
    //   55: invokevirtual 836	aukp:a	()V
    //   58: aload 5
    ...
    //   96: aload_0
    //   97: aload 7
    //   99: invokevirtual 839	ajxn:a	(Lcom/tencent/mobileqq/data/Friends;)Z
    //   102: pop
    ...
    //   175: ifnull +7 -> 182
    //   178: aload_3
    //   179: invokevirtual 853	aukp:b	()V
    //   182: aload_0
    //   183: invokevirtual 514	ajxn:a	()V
    //   186: return
    ...
    //   210: invokevirtual 856	ajxn:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Groups;
    //   213: astore 4
    //   215: aload 4
    //   217: ifnull +26 -> 243
    //   220: aload 4
    ...
    //   236: aload_0
    //   237: aload 4
    //   239: invokevirtual 859	ajxn:a	(Laukm;)Z
    //   242: pop
    //   243: aload_0
    ...
    //   264: invokevirtual 856	ajxn:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Groups;
    //   267: astore 4
    //   269: aload_0
    //   270: getfield 437	ajxn:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   273: ifnull +31 -> 304
    //   276: aload_0
    //   277: getfield 437	ajxn:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   303: pop
    //   304: aload_0
    //   305: getfield 278	ajxn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   348: aload_0
    //   349: aload 5
    //   351: putfield 278	ajxn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   354: aload_0
    //   355: getfield 162	ajxn:jdField_a_of_type_Aukn	Laukn;
    //   358: aload 4
    //   360: invokevirtual 867	aukn:b	(Laukm;)Z
    //   363: pop
    //   364: aload_3
    //   365: invokevirtual 869	aukp:c	()V
    //   368: aload_3
    //   369: ifnull -187 -> 182
    //   372: aload_3
    //   373: invokevirtual 853	aukp:b	()V
    //   376: goto -194 -> 182
    //   379: iload_2
    //   380: iconst_1
    //   381: iadd
    ...
    //   391: ifnull +7 -> 398
    //   394: aload_3
    //   395: invokevirtual 853	aukp:b	()V
    //   398: aload 4
    //   400: athrow
    //   401: astore 4
    //   403: goto -13 -> 390
  ...
  public void a(long paramLong)
  {
    ...
    do
    {
      ...
      i1 = bbcl.a(localFriends.detalStatusFlag, localFriends.iTermType);
    } while ((i1 != 0) && (i1 != 6));
  ...
  public void a(Groups paramGroups)
  {
    ...
    {
      this.jdField_a_of_type_Aukn.a(paramGroups);
    ...
    for (;;)
    {
      ...
      {
        if (i2 == 0) {
          this.jdField_a_of_type_JavaUtilArrayList = ajuj.a(this.jdField_a_of_type_JavaUtilArrayList, paramGroups);
        }
        a();
        return;
        this.jdField_a_of_type_Aukn.a(paramGroups);
  ...
  public void a(NearbyPeopleCard paramNearbyPeopleCard)
  {
    ...
    //   55: astore 4
    //   57: aload_0
    //   58: getfield 82	ajxn:jdField_a_of_type_AndroidSupportV4UtilMQLruCache	Landroid/support/v4/util/MQLruCache;
    //   61: aload_1
          ...
          try
          {
            do
            {
              for (;;)
              {
                ...
                asyh.a(localSharedPreferences, this);
                return;
  ...
  public void a(String paramString, GetOnlineInfoResp paramGetOnlineInfoResp)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          bboy.a().a(paramString);
          localCustomOnlineStatusMsg.mergeFrom(paramGetOnlineInfoResp.strCustomOnlineStatusDesc.getBytes());
          localFriends.customOnlineStatusType = bbpa.b(localCustomOnlineStatusMsg);
          localFriends.customOnlineStatus = bbpa.a(localCustomOnlineStatusMsg);
          localFriends.customModel = bbpa.b(localCustomOnlineStatusMsg);
  ...
  {
    NearbyPeopleCard localNearbyPeopleCard2 = (NearbyPeopleCard)this.jdField_a_of_type_Aukn.a(NearbyPeopleCard.class, "uin=?", new String[] { paramString1 });
  ...
  {
    byte b1 = 1;
    if ((nbc.a(paramByte1)) && (!bdto.b(paramByte1))) {
      return;
    }
    paramString1 = d(paramString1);
  ...
  public void a(@NonNull ArrayList<Friends> paramArrayList, int paramInt)
  {
    ...
    Object localObject1 = this.jdField_a_of_type_Aukn.a();
    try
    {
      ((aukp)localObject1).a();
      if (paramInt == 0)
  ...
  {
    bfwd.a("queryFriends_" + paramList.size());
    if (paramList.size() > 0)
    {
      ...
      paramList = this.jdField_a_of_type_Aukn.a(Friends.class, true, ((StringBuilder)localObject).toString(), (String[])paramList.toArray(new String[paramList.size()]), null, null, null, null);
      if (paramList != null)
      {
        ...
        while (paramList.hasNext())
        {
          ...
          bdto.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Friends)localObject);
        }
      }
    }
    bfwd.a();
  ...
  public void a(List<SpecialCareInfo> paramList, long paramLong, boolean paramBoolean)
  {
    ...
    for (int i1 = paramList.size();; i1 = 0)
    {
      ...
      Object localObject = this.jdField_a_of_type_Aukn.a();
      try
      {
        ((aukp)localObject).a();
        i2 = i3;
        while (i2 < i1)
        {
          a((aukm)paramList.get(i2));
          i2 += 1;
        }
        if (paramBoolean)
        {
          paramList = ((SpecialCareInfo)SpecialCareInfo.class.newInstance()).getTableName();
          i1 = this.jdField_a_of_type_Aukn.a(paramList, "dateTime<" + paramLong, null);
          if (QLog.isColorLevel()) {
  ...
  public void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    //   12: astore 6
    //   14: aload_0
    //   15: getfield 162	ajxn:jdField_a_of_type_Aukn	Laukn;
    //   18: invokevirtual 594	aukn:a	()Laukp;
    //   21: astore 7
    //   23: aload 7
    //   25: astore 6
    //   27: aload 6
    //   29: invokevirtual 836	aukp:a	()V
    ...
    //   79: invokevirtual 856	ajxn:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Groups;
    //   82: astore 8
    //   84: iload_3
    //   85: istore 4
    ...
    //   169: istore 4
    //   171: aload 8
    //   173: getfield 1239	com/tencent/mobileqq/data/Groups:seqid	B
    //   176: aload_2
    //   177: iload 5
    //   179: baload
    //   180: if_icmpne +9 -> 189
    ...
    //   195: iload 5
    //   197: baload
    //   198: putfield 1239	com/tencent/mobileqq/data/Groups:seqid	B
    //   201: iconst_1
    //   202: istore_3
    //   203: iconst_1
    //   204: istore 4
    //   206: aload_0
    //   207: aload 8
    //   209: invokevirtual 859	ajxn:a	(Laukm;)Z
    //   212: pop
    //   213: iload_3
    //   214: istore 4
    //   216: goto +171 -> 387
    ...
    //   249: aload_2
    //   250: invokevirtual 1244	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   263: ifnull +118 -> 381
    //   266: aload_1
    //   267: invokevirtual 853	aukp:b	()V
    //   270: iload_3
    //   271: istore 4
    //   273: iload 4
    //   275: ifeq +7 -> 282
    //   278: aload_0
    //   279: invokevirtual 1246	ajxn:d	()V
    //   282: return
    //   283: iload_3
    //   284: istore 4
    ...
    //   308: istore 4
    //   310: aload 6
    //   312: invokevirtual 869	aukp:c	()V
    //   315: iload_3
    //   316: istore 4
    //   318: aload 6
    //   320: ifnull -47 -> 273
    //   323: aload 6
    //   325: invokevirtual 853	aukp:b	()V
    //   328: iload_3
    //   329: istore 4
    //   331: goto -58 -> 273
    //   334: astore_1
    ...
    //   340: ifnull +8 -> 348
    //   343: aload 6
    //   345: invokevirtual 853	aukp:b	()V
    //   348: aload_1
    //   349: athrow
    //   350: astore_1
    //   351: goto -13 -> 338
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((localFriends.datetime < paramLong) && (localFriends.isFriend()))
        {
          ...
          this.jdField_a_of_type_Aukn.b(localFriends);
          if (l1 != 0L)
          {
  ...
  public void a(Groups[] paramArrayOfGroups)
  {
    ...
    //   77: astore 5
    //   79: aload_0
    //   80: getfield 162	ajxn:jdField_a_of_type_Aukn	Laukn;
    //   83: invokevirtual 594	aukn:a	()Laukp;
    //   86: astore_3
    //   87: aload_3
    //   88: invokevirtual 836	aukp:a	()V
    //   91: iconst_0
    //   92: istore_2
    //   93: iload_2
    //   94: aload_1
    ...
    //   144: iload_2
    //   145: aaload
    //   146: invokevirtual 859	ajxn:a	(Laukm;)Z
    //   149: pop
    //   150: iload_2
    //   151: iconst_1
    //   152: iadd
    ...
    //   163: aload 4
    //   165: getstatic 810	ajuj:a	Ljava/util/Comparator;
    //   168: invokestatic 816	java/util/Collections:sort	(Ljava/util/List;Ljava/util/Comparator;)V
    //   171: aload_0
    //   172: getfield 437	ajxn:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   175: ifnull +114 -> 289
    //   178: aload_0
    //   179: getfield 437	ajxn:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   226: ifne -35 -> 191
    //   229: aload_0
    //   230: getfield 162	ajxn:jdField_a_of_type_Aukn	Laukn;
    //   233: aload 6
    //   235: invokeinterface 237 1 0
    //   240: checkcast 281	aukm
    //   243: invokevirtual 867	aukn:b	(Laukm;)Z
    //   246: pop
    //   247: goto -56 -> 191
    //   250: astore_1
    ...
    //   268: aload_3
    //   269: invokevirtual 853	aukp:b	()V
    //   272: aload_0
    //   273: aload 4
    //   275: putfield 278	ajxn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   278: aload_0
    //   279: aload 5
    //   281: putfield 437	ajxn:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   284: aload_0
    //   285: invokevirtual 514	ajxn:a	()V
    //   288: return
    //   289: aload_3
    //   290: invokevirtual 869	aukp:c	()V
    //   293: aload_3
    //   294: invokevirtual 853	aukp:b	()V
    //   297: goto -25 -> 272
    //   300: astore_1
    //   301: aload_3
    //   302: invokevirtual 853	aukp:b	()V
    //   305: aload_1
    //   306: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public boolean a()
  {
    boolean bool = b();
    h();
    this.jdField_f_of_type_Boolean = bbjn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 0);
    this.jdField_g_of_type_Boolean = bbjn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1);
    a(bbjn.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()));
    g("buildFriends");
    return bool;
  }
  ...
  protected boolean a(aukm paramaukm)
  {
    ...
    QLog.d("Q.contacttab.friend", 2, "updateEntity em closed e=" + paramaukm.getTableName());
    return false;
  }
  ...
  public boolean a(Friends paramFriends)
  {
    ...
    if (this.jdField_a_of_type_Aukn.a()) {
      ...
      {
        this.jdField_a_of_type_Aukn.a(paramFriends);
    ...
    while (!QLog.isColorLevel())
    {
      ...
      return this.jdField_a_of_type_Aukn.a(paramFriends);
    }
  ...
  public boolean a(String paramString)
  {
    if (this.jdField_i_of_type_JavaUtilConcurrentConcurrentHashMap == null)
    {
      ...
      Object localObject = this.jdField_a_of_type_Aukn.a(Groups.class, false, "group_id=?", new String[] { "-1002" }, null, null, null, null);
      if (localObject != null)
      {
  ...
  public boolean a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    //   56: aload_0
    //   57: getfield 162	ajxn:jdField_a_of_type_Aukn	Laukn;
    //   60: invokevirtual 594	aukn:a	()Laukp;
    //   63: astore 11
    //   65: aload 11
    //   67: astore 12
    //   69: aload 11
    //   71: invokevirtual 836	aukp:a	()V
    //   74: aload 11
    //   76: astore 12
    //   78: aload_0
    //   79: aload_1
    //   80: invokevirtual 709	ajxn:d	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Friends;
    //   83: astore 10
    //   85: aload 11
    //   87: astore 12
    ...
    //   144: aload_0
    //   145: aload_1
    //   146: invokevirtual 1316	ajxn:a	(Ljava/lang/String;)Z
    //   149: ifeq +12 -> 161
    //   152: aload 11
    //   154: astore 12
    //   156: aload_0
    //   157: aload_1
    //   158: invokevirtual 1318	ajxn:c	(Ljava/lang/String;)V
    //   161: aload 11
    //   163: astore 12
    //   165: aload 10
    ...
    //   240: aload 10
    //   242: ldc_w 1319
    //   245: invokestatic 1323	ajyc:a	(I)Ljava/lang/String;
    //   248: putfield 1164	com/tencent/mobileqq/data/Friends:recommReason	Ljava/lang/String;
    //   251: aload 11
    //   253: astore 12
    //   255: aload_0
    //   256: aload_0
    //   257: getfield 337	ajxn:t	I
    //   260: iconst_1
    //   261: iadd
    //   262: putfield 337	ajxn:t	I
    //   265: aload 11
    //   267: astore 12
    //   269: aload_0
    //   270: aload 10
    //   272: getfield 404	com/tencent/mobileqq/data/Friends:uin	Ljava/lang/String;
    //   275: invokevirtual 1325	ajxn:b	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Card;
    //   278: astore 13
    //   280: aload 13
    //   282: ifnull +43 -> 325
    //   285: aload 11
    ...
    //   304: aload 10
    //   306: iload 4
    //   308: putfield 1081	com/tencent/mobileqq/data/Friends:gender	B
    //   311: aload 11
    //   313: astore 12
    //   315: aload 10
    //   317: aload 13
    //   319: getfield 1327	com/tencent/mobileqq/data/Card:age	B
    //   322: putfield 1084	com/tencent/mobileqq/data/Friends:age	I
    //   325: aload 11
    //   327: astore 12
    //   329: aload_0
    //   330: aload 10
    //   332: invokevirtual 859	ajxn:a	(Laukm;)Z
    //   335: pop
    //   336: aload 11
    //   338: astore 12
    //   340: aload_0
    ...
    //   345: invokevirtual 856	ajxn:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Groups;
    //   348: astore 10
    //   350: aload 10
    //   352: ifnull +33 -> 385
    //   355: aload 11
    ...
    //   373: astore 12
    //   375: aload_0
    //   376: getfield 162	ajxn:jdField_a_of_type_Aukn	Laukn;
    //   379: aload 10
    //   381: invokevirtual 884	aukn:a	(Laukm;)Z
    //   384: pop
    //   385: iload 8
    //   387: ifne +61 -> 448
    //   390: iload 6
    ...
    //   411: invokevirtual 856	ajxn:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Groups;
    //   414: astore 10
    //   416: aload 10
    //   418: ifnull +30 -> 448
    //   421: aload 11
    ...
    //   441: aload_0
    //   442: aload 10
    //   444: invokevirtual 859	ajxn:a	(Laukm;)Z
    //   447: pop
    //   448: aload 11
    //   450: astore 12
    //   452: aload 11
    //   454: invokevirtual 869	aukp:c	()V
    //   457: iload 5
    //   459: istore 6
    //   461: iload 8
    //   463: istore 9
    ...
    //   467: ifnull +16 -> 483
    //   470: aload 11
    //   472: invokevirtual 853	aukp:b	()V
    //   475: iload 8
    //   477: istore 9
    //   479: iload 5
    //   481: istore 6
    //   483: aload_0
    //   484: invokevirtual 514	ajxn:a	()V
    //   487: iload_3
    //   488: ifeq +16 -> 504
    //   491: iload 6
    //   493: ifeq +11 -> 504
    //   496: aload_0
    //   497: getfield 144	ajxn:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   500: aload_1
    //   501: invokestatic 1332	aeya:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)V
    //   504: iload 9
    //   506: ireturn
    //   507: aload 11
    //   509: astore 12
    ...
    //   608: ifnull -125 -> 483
    //   611: aload 11
    //   613: invokevirtual 853	aukp:b	()V
    //   616: iload_2
    //   617: istore 6
    //   619: iload 8
    //   621: istore 9
    ...
    //   632: ifnull +8 -> 640
    //   635: aload 12
    //   637: invokevirtual 853	aukp:b	()V
    //   640: aload_1
    //   641: athrow
    //   642: astore_1
    //   643: goto -13 -> 630
    ...
    //   63	549	11	localaukp1	aukp
    //   67	569	12	localaukp2	aukp
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    if (this.q == -1)
    {
      ...
      ((ajtk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).p();
      paramBoolean = bool1;
    }
    for (;;)
    {
  ...
  {
    ContactCard localContactCard2 = (ContactCard)this.jdField_a_of_type_Aukn.a(ContactCard.class, paramString);
    ...
    if (localContactCard2 == null)
    {
      ...
      this.jdField_a_of_type_Aukn.a(localContactCard1);
    }
  ...
  public Friends b(String paramString)
  {
    ...
    do
    {
      ...
      localFriends = (Friends)this.jdField_a_of_type_Aukn.a(Friends.class, paramString);
      if (localFriends != null) {
    ...
    if (localFriends == null) {}
    for (paramString = "null";; paramString = bbjw.e(localFriends.uin))
    {
  ...
  public List<SpecialCareInfo> b()
  {
    List localList = a();
    if (localList != null) {
      Collections.sort(localList, new ajxp(this));
    }
    return localList;
  }
  ...
  public void b()
  {
    ...
    label394:
    label397:
    for (??? = this.jdField_a_of_type_Aukn.a(ExtensionInfo.class, true, ((StringBuilder)???).toString(), (String[])((List)localObject3).toArray(new String[((List)localObject3).size()]), null, null, null, null);; localObject2 = null)
    {
      for (;;)
      {
        localObject3 = ???;
        ...
        try
        {
          localObject3 = (ArrayList)this.jdField_a_of_type_Aukn.a(ExtensionInfo.class);
          if (localObject3 != null)
          {
  ...
  public boolean b()
  {
    ...
    localObject2 = (ArrayList)this.jdField_a_of_type_Aukn.a(Friends.class, false, "groupid>=?", new String[] { "0" }, null, null, null, null);
    int i1;
    ConcurrentHashMap localConcurrentHashMap;
    ...
    if (localObject2 != null)
    {
      ...
      bdto.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFriends);
      if ((localFriends.mCompareSpell == null) || (localFriends.mCompareSpell.length() == 0))
      {
        ajuj.a(localFriends);
        localArrayList.add(localFriends);
  ...
  public void c()
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
      Object localObject1 = (ArrayList)this.jdField_a_of_type_Aukn.a(SpecialCareInfo.class, false, "globalSwitch!=?", new String[] { "0" }, null, null, null, null);
      if (localObject1 != null) {
        synchronized (this.jdField_h_of_type_JavaUtilConcurrentConcurrentHashMap)
        {
  ...
  public void c(List<SpecialCareInfo> paramList)
  {
    ...
    //   41: aload_1
    //   42: iconst_0
    //   43: invokeinterface 1196 2 0
    //   48: checkcast 758	com/tencent/mobileqq/data/SpecialCareInfo
    //   51: invokevirtual 1469	ajxn:a	(Lcom/tencent/mobileqq/data/SpecialCareInfo;)V
    //   54: return
    //   55: aload_0
    //   56: getfield 85	ajxn:jdField_h_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   59: ifnull +73 -> 132
    //   62: aload_0
    //   63: getfield 85	ajxn:jdField_h_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   66: astore_2
    //   67: aload_2
    //   68: monitorenter
    //   69: aload_1
    //   70: invokeinterface 1187 1 0
    //   75: astore_3
    //   76: aload_3
    ...
    //   104: ifne -28 -> 76
    //   107: aload_0
    //   108: getfield 85	ajxn:jdField_h_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   111: aload 4
    ...
    //   131: monitorexit
    //   132: aload_0
    //   133: getfield 162	ajxn:jdField_a_of_type_Aukn	Laukn;
    //   136: invokevirtual 594	aukn:a	()Laukp;
    //   139: astore_2
    //   140: aload_2
    //   141: invokevirtual 836	aukp:a	()V
    //   144: aload_1
    //   145: invokeinterface 1187 1 0
    //   150: astore_1
    //   151: aload_1
    ...
    //   180: aload_0
    //   181: aload_3
    //   182: invokevirtual 859	ajxn:a	(Laukm;)Z
    //   185: pop
    ...
    //   259: invokestatic 209	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   262: aload_2
    //   263: invokevirtual 853	aukp:b	()V
    //   266: return
    //   267: aload_2
    //   268: invokevirtual 869	aukp:c	()V
    //   271: aload_2
    //   272: invokevirtual 853	aukp:b	()V
    //   275: return
    //   276: astore_1
    //   277: aload_2
    //   278: invokevirtual 853	aukp:b	()V
    //   281: aload_1
    //   282: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject4 == null)
        {
          localObject1 = localaukp;
          localObject2 = localaukp;
          localObject3 = (Friends)this.jdField_a_of_type_Aukn.a(Friends.class, paramString);
        }
        if (localObject3 != null)
        {
          localObject1 = localaukp;
          ...
          localObject1 = localaukp;
          localObject2 = localaukp;
          this.jdField_a_of_type_Aukn.b((aukm)localObject3);
        }
        localObject1 = localaukp;
        localObject2 = localaukp;
        localaukp.c();
      ...
      a();
      if (aijb.a(paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
        aijb.b(paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      if (aijb.b(paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
        aijb.c(paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      e(paramString);
      paramString = a(paramString);
      if (paramString != null)
  ...
  public void d(List<String> paramList)
  {
    ...
    //   21: astore_3
    //   22: aload_0
    //   23: getfield 162	ajxn:jdField_a_of_type_Aukn	Laukn;
    //   26: invokevirtual 594	aukn:a	()Laukp;
    //   29: astore_2
    //   30: aload_2
    //   31: invokevirtual 836	aukp:a	()V
    //   34: aload_1
    //   35: invokeinterface 1187 1 0
    //   40: astore_1
    //   41: aload_1
    ...
    //   59: astore 4
    //   61: aload_0
    //   62: getfield 59	ajxn:jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   65: aload 4
    ...
    //   101: aload_0
    //   102: aload 5
    //   104: invokevirtual 839	ajxn:a	(Lcom/tencent/mobileqq/data/Friends;)Z
    //   107: pop
    //   108: aload_0
    //   109: aload_0
    //   110: getfield 337	ajxn:t	I
    //   113: iconst_1
    //   114: isub
    //   115: putfield 337	ajxn:t	I
    //   118: goto -77 -> 41
    //   121: astore_1
    //   122: aload_1
    //   123: invokevirtual 1219	java/lang/Exception:printStackTrace	()V
    //   126: aload_2
    //   127: invokevirtual 853	aukp:b	()V
    //   130: aload_0
    //   131: invokevirtual 514	ajxn:a	()V
    //   134: aload_0
    //   135: getfield 144	ajxn:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   138: aload_3
    //   139: invokestatic 1519	aeya:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/util/List;)V
    //   142: return
    //   143: aload_2
    //   144: invokevirtual 869	aukp:c	()V
    //   147: aload_2
    //   148: invokevirtual 853	aukp:b	()V
    //   151: goto -21 -> 130
    //   154: astore_1
    //   155: aload_2
    //   156: invokevirtual 853	aukp:b	()V
    //   159: aload_1
    //   160: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public Friends e(String paramString)
  {
    ...
    do
    {
      ...
      if (localObject2 == null)
      {
        localObject2 = (Friends)this.jdField_a_of_type_Aukn.a(Friends.class, paramString);
        localObject1 = localObject2;
        if (QLog.isColorLevel())
        {
  ...
  public void e()
  {
    for (;;)
    {
      try
      {
        ...
        try
        {
          ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Aukn.a(NearbyPeopleCard.class, false, "lastUpdateNickTime>?", new String[] { "0" }, null, null, "_id desc", String.valueOf(100));
          if (!QLog.isColorLevel()) {
            break label215;
          }
        ...
        {
          this.jdField_a_of_type_Aukn.a(NearbyPeopleCard.class.getSimpleName());
          Object localObject1 = null;
          continue;
  ...
  public void e(String paramString)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_h_of_type_JavaUtilConcurrentConcurrentHashMap)
      {
        ...
        paramString = (SpecialCareInfo)this.jdField_a_of_type_Aukn.a(SpecialCareInfo.class, paramString);
        if (paramString != null)
        {
          if (!axrl.a(10)) {
            break label142;
  ...
  public void e(List<String> paramList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localFriends.gathtertype == 0) {
          localFriends.recommReason = ajyc.a(2131704933);
        }
        if (localFriends.gathtertype != 1) {
          localArrayList.add(localObject);
        }
      ...
      catch (Exception paramList)
      {
        ...
        localaukp.b();
        a();
        aeya.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList);
        return;
  ...
  public void f()
  {
    ...
    if (this.jdField_c_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((this.jdField_b_of_type_JavaUtilArrayList != null) && (this.jdField_b_of_type_JavaUtilArrayList.contains(str))) {
          ...
          aeya.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str);
        }
      }
    }
    if (this.jdField_b_of_type_JavaUtilArrayList != null)
    {
      ...
      {
        str = (String)localIterator.next();
        aeya.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str);
      }
    }
  ...
  public void f(String paramString)
  {
    ...
    RecentUser localRecentUser = localaktg.b(paramString, 0);
