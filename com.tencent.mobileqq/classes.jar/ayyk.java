  ...
  extends zhu
{
  ...
  private long a(String paramString)
  {
    ...
    {
      long l = beat.a((QQAppInterface)localAppRuntime, "name_plate_config_version", 0L);
  ...
  private boolean b(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    String str3 = paramToServiceMsg.extraData.getString(amfs.a);
    Object localObject = paramToServiceMsg.extraData.getString(amfs.c);
    long l1 = paramToServiceMsg.extraData.getLong(amfs.l);
    boolean bool3 = bduj.a();
    boolean bool1 = false;
    boolean bool2 = false;
    ...
    String str4 = beaa.a(0, BaseApplicationImpl.getContext());
    localObject = beaa.a(1, BaseApplicationImpl.getContext());
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        localPrivExtV2Req.pullPayRuleCfgTime = beat.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "last_pull_pay_rule", 0L);
        ...
        paramToServiceMsg.extraData.putBoolean(amfs.h, bool1);
        paramToServiceMsg.extraData.putBoolean(amfs.i, bool2);
        ...
        try
        {
          localPrivExtV2Req.sImsi1 = bhsp.b("a4bd32");
        }
    ...
    {
      if (bool1) {
        paramToServiceMsg.extraData.putString(amfs.j, localPrivExtV2Req.sImsi1);
      }
      if (bool2) {
        paramToServiceMsg.extraData.putString(amfs.k, localPrivExtV2Req.sImsi2);
      }
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    do
    {
      ...
      if ("ClubInfoSvc.guanjiaReport".equals(paramToServiceMsg.getServiceCmd()))
      {
        ...
        localObject = paramToServiceMsg.extraData.getString(amfs.a);
        ...
        localGuanjiaReportReq.sPhoneNum = paramToServiceMsg.extraData.getString(amfs.d);
        localGuanjiaReportReq.bKingCard = paramToServiceMsg.extraData.getBoolean(amfs.e);
        localGuanjiaReportReq.iCardType = paramToServiceMsg.extraData.getInt(amfs.f);
        localGuanjiaReportReq.iCardStatus = paramToServiceMsg.extraData.getInt(amfs.g);
      ...
      ((GetCustomOnlineStatusReq)localObject).lUin = paramToServiceMsg.extraData.getLong(amfs.m);
