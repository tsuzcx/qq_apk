...
public class acfv
  extends ajxj
{
  public acfv(TroopAssistantActivity paramTroopAssistantActivity) {}
  ...
  protected void onSetGenralSettingsTroopFilter(boolean paramBoolean, Map<String, Integer> paramMap)
  {
    ...
    do
    {
      return;
      int i;
      if (("batch_setting".equals(this.a.b)) && (this.a.jdField_a_of_type_JavaUtilList != null) && (this.a.jdField_a_of_type_JavaUtilList.size() > 0) && (this.a.jdField_a_of_type_Bbjl != null))
      {
        i = 0;
        for (;;)
        {
          ...
          if (((Boolean)this.a.jdField_a_of_type_Bbjl.c.get(paramMap)).booleanValue()) {
            break;
          }
          i += 1;
        }
        bcql.a(this.a.app.getApp(), 2, ajya.a(2131715215), 0).b(this.a.getTitleBarHeight());
    ...
    if (paramBoolean)
    {
      bcql.a(this.a.app.getApp(), 2, this.a.getString(2131720550), 0).b(this.a.getTitleBarHeight());
      return;
    }
