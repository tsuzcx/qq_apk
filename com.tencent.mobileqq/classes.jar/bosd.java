...
public class bosd
{
  public static bose a;
  public static String a;
  public static boolean a;
  public static bose b;
  public static String b;
  public static boolean b;
  public static bose c;
  public static boolean c;
  public static bose d;
  public static bose e = new bose();
  public static bose f = new bose(3);
  public static bose g = new bose(5);
  public static bose h = new bose();
  ...
  static
  {
    ...
    jdField_a_of_type_Bose = new bose();
    jdField_b_of_type_Bose = new bose();
    jdField_c_of_type_Bose = new bose();
    d = new bose();
  ...
  {
    if (jdField_a_of_type_Bose.a())
    {
      QLog.d(jdField_a_of_type_JavaLangString, 1, String.format("CameraStartCost, activityCost=%d, refreshCost=%d, cameraCost=%d, cost=%d", new Object[] { Long.valueOf(jdField_a_of_type_Bose.jdField_a_of_type_ArrayOfLong[1] - jdField_a_of_type_Bose.jdField_a_of_type_ArrayOfLong[0]), Long.valueOf(jdField_a_of_type_Bose.jdField_a_of_type_ArrayOfLong[2] - jdField_a_of_type_Bose.jdField_a_of_type_ArrayOfLong[1]), Long.valueOf(jdField_a_of_type_Bose.jdField_a_of_type_ArrayOfLong[3] - jdField_a_of_type_Bose.jdField_a_of_type_ArrayOfLong[2]), Long.valueOf(jdField_a_of_type_Bose.jdField_a_of_type_ArrayOfLong[3] - jdField_a_of_type_Bose.jdField_a_of_type_ArrayOfLong[0]) }));
      jdField_a_of_type_Bose.c();
    }
  }
  ...
  public static boolean a()
  {
    if (!PreferenceManager.getDefaultSharedPreferences(BaseApplicationImpl.getApplication()).getBoolean(jdField_b_of_type_JavaLangString, false)) {
      return bgmg.a(alkn.jdField_a_of_type_JavaLangString + "/Tencent/AutoTestFlag_03");
    }
    return true;
  }
