  ...
  extends BaseAdapter
{
  ...
  private List<mmi> jdField_a_of_type_JavaUtilList = new ArrayList();
  private int b;
  
  public mma(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Int = actj.a(14.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  }
  ...
  private BitmapDrawable a(String paramString)
  {
    ...
    if (0 == 0)
    {
      ...
      if ((((lga)localObject).d != 1) && (((lga)localObject).d != 2)) {
        break label71;
      }
    }
    label71:
    ...
    paramString = VideoController.a().a(String.valueOf(paramString), String.valueOf(((lga)localObject).g), ((lga)localObject).E, true, true);
  ...
  private View a(LayoutInflater paramLayoutInflater, int paramInt1, View paramView, ViewGroup paramViewGroup, int paramInt2)
  {
    ...
    paramViewGroup = (TextView)localView.findViewById(2131377032);
    paramView.setVisibility(0);
    paramView.setBackgroundDrawable(a(paramLayoutInflater.a()));
    paramViewGroup.setPadding(actj.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actj.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actj.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actj.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    paramViewGroup.setText(paramLayoutInflater.a());
    paramViewGroup.setTextColor(-1);
    paramViewGroup.setSpannableFactory(aykk.a);
    return localView;
  }
  
  public mmi a(int paramInt)
  {
    return (mmi)this.jdField_a_of_type_JavaUtilList.get(paramInt);
  }
  
  public void a(List<mmi> paramList, boolean paramBoolean)
  {
    if (paramBoolean) {
      mmi.a(this.jdField_a_of_type_JavaUtilList);
    }
    this.jdField_a_of_type_JavaUtilList.addAll(paramList);
    notifyDataSetChanged();
  }
  
  public void a(mmi parammmi)
  {
    this.jdField_a_of_type_JavaUtilList.add(parammmi);
    notifyDataSetChanged();
  }
