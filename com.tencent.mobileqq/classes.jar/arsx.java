  ...
  extends arrh
{
  ...
  protected void a(int paramInt, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (paramBoolean1 = true;; paramBoolean1 = false)
    {
      if (QLog.isColorLevel()) {
        QLog.i("LyricsController", 2, "onLyricModuleSwitchChange, newUserClosed:" + paramBoolean1 + " type:" + paramInt + " uin:" + paramString + " mFloatParams:" + this.a.jdField_a_of_type_Arsq);
      }
      if ((this.a.jdField_a_of_type_Arsq.a(paramInt, paramString)) && (this.a.jdField_a_of_type_Arsq.jdField_b_of_type_Boolean != paramBoolean1))
      {
        this.a.jdField_a_of_type_Arsq.jdField_b_of_type_Boolean = paramBoolean1;
        arss.a(this.a);
        if ((!TextUtils.isEmpty(this.a.jdField_b_of_type_JavaLangString)) && (!paramBoolean1) && (paramBoolean2))
        {
          arss.a(this.a, this.a.jdField_b_of_type_JavaLangString);
          if (this.a.jdField_a_of_type_JavaLangBoolean != null) {
            arss.a(this.a, this.a.jdField_b_of_type_JavaLangString, this.a.c, this.a.jdField_a_of_type_JavaLangBoolean.booleanValue());
          }
          arss.a(this.a, this.a.jdField_b_of_type_JavaLangString, this.a.i);
        }
      }
      if (paramBoolean2) {
  ...
  protected void a(ListenTogetherSession paramListenTogetherSession)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.a.jdField_a_of_type_Arsq.a = ((String)localObject1);
      arss.a(this.a);
      return;
    }
  }
  ...
  protected void a(ISong paramISong)
  {
    ...
    arss.a(this.a, paramISong.a());
    this.a.jdField_a_of_type_Arsq.a = paramISong.d();
    arss.a(this.a);
  }
  ...
  protected void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      arss.b(this.a, paramString, paramInt);
      aylx.a().a();
      return;
      if (paramInt == 3)
      {
  ...
  {
    arss.a(this.a, paramString, paramInt1, paramInt2);
  }
  ...
  protected void a(boolean paramBoolean, ListenTogetherSession paramListenTogetherSession)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.a.jdField_a_of_type_Arsq.a = paramListenTogetherSession;
      this.a.a(i, str);
      return;
    }
    this.a.b(i, str);
