...
{
  public afot(BaseMomentItemBuilder paramBaseMomentItemBuilder, BaseMomentItemBuilder.MomentViewHolder paramMomentViewHolder, String[] paramArrayOfString, String paramString, ActionSheet paramActionSheet) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      ((NearbyMomentManager)this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardMomentBaseMomentItemBuilder.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(262)).a(paramView, this.jdField_a_of_type_ArrayOfJavaLangString[paramInt], this.jdField_a_of_type_JavaLangString, new afou(this, paramView));
    }
  }
}
