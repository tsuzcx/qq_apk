...
public class avwf
{
  ...
  public static int a()
  {
    int i = BaseApplicationImpl.sApplication.getResources().getColor(2131101185);
    if (ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, "")) {
      i = BaseApplicationImpl.sApplication.getResources().getColor(2131101187);
    }
    return i;
  }
  ...
  private static long a(String paramString, babc parambabc, boolean paramBoolean)
  {
    paramString = a(parambabc, paramString);
    return a(paramString[0], paramString[1], parambabc.jdField_a_of_type_JavaUtilList.size(), false, paramBoolean);
  }
    ...
    do
    {
      for (;;)
      {
        ...
        if (l != -9223372036854775808L) {
          return avin.r + l + paramLong;
        }
        if (paramBoolean1)
        {
          babc localbabc = ChnToSpell.a(paramString2, 1);
          if (!paramString2.equals(localbabc.jdField_a_of_type_JavaLangString)) {}
          while (i != 0)
          {
            l = a(paramString1, localbabc, paramBoolean3);
            if (l == -9223372036854775808L) {
              break label123;
            }
            return avin.s + l + paramLong;
            i = 0;
          }
        }
      }
  ...
  public static long a(String paramString1, String paramString2, babc parambabc1, babc parambabc2, long paramLong)
  {
    if ((TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString1))) {}
    long l;
    label116:
    do
    {
      for (;;)
      {
        ...
        if ((parambabc1 != null) && (parambabc2 != null))
        {
          if (!paramString2.equals(parambabc1.jdField_a_of_type_JavaLangString)) {}
          for (int i = 1; i != 0; i = 0)
          {
            l = a(paramString1, parambabc1, false);
            if (l == -9223372036854775808L) {
              break label116;
            }
            return avin.s + l + paramLong;
      ...
      l = a(paramString1, parambabc2, false);
    } while (l == -9223372036854775808L);
    return avin.s + l + paramLong;
  }
  ...
  {
    Drawable localDrawable = BaseApplicationImpl.sApplication.getResources().getDrawable(2130839769);
  ...
  public static Drawable a(azwg paramazwg, avok paramavok)
  {
    return a(paramazwg, paramavok.b(), paramavok.c());
  }
  
  public static Drawable a(azwg paramazwg, String paramString, int paramInt)
  {
    if (paramInt == 103) {}
    for (int i = 1;; i = paramInt)
    {
      Bitmap localBitmap = paramazwg.a(i, paramString);
      if (localBitmap != null)
      {
        if (paramInt == 103) {
      ...
      if (!paramazwg.a()) {
        paramazwg.a(paramString, i, true, (byte)1);
      }
      if (paramInt == 1) {
        return bacm.b();
      }
      ...
      if (paramInt == 11) {
        return new BitmapDrawable(bacm.b());
      }
      if (paramInt == 102) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130843326);
      }
      if (paramInt == 106) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130845945);
      }
      if (paramInt == 105)
      {
        paramazwg = rsp.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext(), 1);
        if ((paramazwg != null) && (paramazwg.a() != null)) {
          return paramazwg.a();
        }
        return rsp.a(BaseApplicationImpl.sApplication, 1);
      }
      if (String.valueOf(9999L).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130839777);
      }
      if (String.valueOf(9994L).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130839784);
      }
      if (String.valueOf(9992L).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130839782);
      }
      if (ajed.aA.equals(paramString)) {
        return rol.a();
      }
      if (String.valueOf(9980L).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130839783);
      }
      if (String.valueOf(9973L).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130843844);
      }
      if (paramInt == 9889987) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130841934);
      }
      if (paramInt == 108)
      {
        paramazwg = BaseApplicationImpl.sApplication.getRuntime();
        if (paramazwg != null) {
          return ((aeqd)paramazwg.getManager(138)).a();
        }
      }
      else
      {
        if (String.valueOf(ajed.D).equals(paramString)) {
          return BaseApplicationImpl.sApplication.getResources().getDrawable(2130839774);
        }
        if (paramInt == 110)
        {
          paramazwg = rsp.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), BaseApplicationImpl.sApplication, 2);
          if ((paramazwg != null) && (paramazwg.a() != null)) {
            return paramazwg.a().getConstantState().newDrawable();
          }
          return rsp.a(BaseApplicationImpl.sApplication, 2).getConstantState().newDrawable();
        }
        if (paramInt == 111)
        {
          paramazwg = rsp.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), BaseApplicationImpl.sApplication, 3);
          if ((paramazwg != null) && (paramazwg.a() != null)) {
            return paramazwg.a().getConstantState().newDrawable();
          }
          return rsp.a(BaseApplicationImpl.sApplication, 3).getConstantState().newDrawable();
        }
      }
      return bacm.b();
    }
  ...
  public static avwd a(String paramString1, babd parambabd1, String paramString2, babd parambabd2, long paramLong)
  {
    if ((TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString1)) || (paramString2.contains(paramString1))) {
      return null;
    }
    if ((parambabd1 == null) || (parambabd2 == null)) {
      return null;
    }
    if (avwl.a(paramString1) == 0) {
      return null;
    }
    ...
    avwd localavwd = new avwd();
    String str2 = parambabd1.jdField_b_of_type_JavaLangString;
    String str4 = parambabd1.jdField_c_of_type_JavaLangString;
    parambabd1 = parambabd1.jdField_d_of_type_JavaLangString;
    String str3 = parambabd2.jdField_b_of_type_JavaLangString;
    String str5 = parambabd2.jdField_c_of_type_JavaLangString;
    paramString1 = parambabd2.jdField_d_of_type_JavaLangString;
    int i5 = avwl.a(paramString2);
    int i1 = 0;
    ...
    case 0: 
      for (;;)
      {
        localavwd.jdField_d_of_type_Int = m;
        localavwd.jdField_a_of_type_Boolean = true;
        localavwd.jdField_a_of_type_JavaLangString = str1;
        localavwd.jdField_b_of_type_JavaLangString = str2;
        localavwd.jdField_c_of_type_JavaLangString = paramString2;
        localavwd.jdField_d_of_type_JavaLangString = str3;
        k = j;
        if (paramString2.length() < j) {
          k = 0;
        }
        localavwd.jdField_a_of_type_Int = k;
        j = i;
        if (paramString2.length() - localavwd.jdField_a_of_type_Int < i) {
          j = paramString2.length() - localavwd.jdField_a_of_type_Int;
        }
        localavwd.jdField_b_of_type_Int = j;
        localavwd.jdField_c_of_type_Int = ((100 - m << 8) + (n << 4) + i4);
        return localavwd;
    ...
    case 1: 
      if (str3.contains(str2))
      {
        ...
        if (avwl.a(paramString2.charAt(i)))
        {
          if (str1.length() + i > paramString2.length()) {
            break label1021;
          }
          m = ((Integer)parambabd2.jdField_b_of_type_JavaUtilList.get(i)).intValue();
          if (str1.length() + i + 1 < parambabd2.jdField_b_of_type_JavaUtilList.size())
          {
            j = ((Integer)parambabd2.jdField_b_of_type_JavaUtilList.get(str1.length() + i + 1)).intValue();
            label518:
    ...
    for (;;)
    {
      ...
      {
        m = str1.length();
        n = ((Integer)parambabd2.jdField_b_of_type_JavaUtilList.get(j)).intValue();
        if (j + m + 1 < parambabd2.jdField_b_of_type_JavaUtilList.size())
        {
          i = ((Integer)parambabd2.jdField_b_of_type_JavaUtilList.get(str1.length() + j + 1)).intValue();
          label700:
          parambabd2 = str3.substring(n, i);
      ...
      for (;;)
      {
        ...
        if (str5.contains(str4))
        {
          ...
          {
            m = str1.length();
            n = ((Integer)parambabd2.jdField_b_of_type_JavaUtilList.get(i)).intValue();
            if (i + m + 1 < parambabd2.jdField_b_of_type_JavaUtilList.size())
            {
              j = ((Integer)parambabd2.jdField_b_of_type_JavaUtilList.get(str1.length() + i + 1)).intValue();
              label891:
              parambabd2 = str3.substring(n, j);
  ...
  public static avwh a(CharSequence paramCharSequence, String paramString, boolean paramBoolean)
  {
    ...
    if ((TextUtils.isEmpty(paramCharSequence)) || (TextUtils.isEmpty(paramString))) {
      return new avwh(paramCharSequence);
    }
    ...
    label293:
    return new avwh(paramCharSequence);
    return new avwh(paramCharSequence, i, j);
  }
  ...
  public static CharSequence a(TextView paramTextView, float paramFloat, int paramInt, CharSequence paramCharSequence, List<String> paramList, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    float f1 = a(paramTextView, ajjy.a(2131647882));
    ...
    do
    {
      do
      {
        ...
        for (;;)
        {
          ...
          avwh localavwh = a(paramCharSequence, (String)localObject, paramBoolean1);
          localObject = localavwh.jdField_a_of_type_JavaLangCharSequence;
          m = j;
          n = i;
          ...
          if (i == -1)
          {
            ...
            if (j == 0)
            {
              ...
              n = i;
              paramCharSequence = (CharSequence)localObject;
              if (localavwh.jdField_a_of_type_Int != -1)
              {
                m = j;
                n = i;
                paramCharSequence = (CharSequence)localObject;
                if (localavwh.jdField_b_of_type_Int > 0)
                {
                  n = localavwh.jdField_a_of_type_Int;
                  m = localavwh.jdField_b_of_type_Int;
                  paramCharSequence = (CharSequence)localObject;
                }
              }
            }
  ...
  public static CharSequence a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      jdField_a_of_type_AndroidGraphicsPaint = ((TextView)LayoutInflater.from(paramQQAppInterface.getApp()).inflate(2131496779, null).findViewById(2131311534)).getPaint();
      if (jdField_c_of_type_Int == 0) {
        jdField_c_of_type_Int = paramQQAppInterface.getApp().getResources().getDimensionPixelOffset(2131167095);
      }
    }
    String str = paramString1.toLowerCase();
  ...
  public static CharSequence a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, avwd paramavwd)
  {
    if (paramavwd == null) {
      return new SpannableStringBuilder(paramString1);
    }
    ...
    int k = paramavwd.jdField_a_of_type_Int;
    int m = paramavwd.jdField_b_of_type_Int;
    if ((k < 0) || (k > paramString1.length()) || (!paramString1.equalsIgnoreCase(paramavwd.jdField_c_of_type_JavaLangString)) || (paramavwd.jdField_d_of_type_Int > 1)) {
      return new SpannableStringBuilder(paramString1);
    }
    float f1 = jdField_a_of_type_AndroidGraphicsPaint.measureText(paramString1);
    ...
    if ((f1 >= jdField_c_of_type_Int) && (k >= 0))
    {
      ...
      paramavwd = new float[paramString2.length()];
      jdField_a_of_type_AndroidGraphicsPaint.getTextWidths(paramString2, paramavwd);
      i = paramavwd.length - 1;
      f1 = 0.0F;
      j = 0;
      if (i >= 0)
      {
  ...
  public static void a()
  {
    ...
    {
      if (i != 0) {
        awqx.b(null, "CliOper", "", "", "0X8005ECF", "0X8005ECF", i, 0, "", "", "", "");
      }
      return;
      j = 0;
      break;
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, String paramString1, String paramString2, int paramInt4)
  {
    ...
    default: 
      ...
      if (paramBoolean)
      {
        ...
        if (paramInt4 == 12)
        {
          ...
          label190:
          awrn.a(com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext()).a(null, "NetGroupSearchItemClick", true, 0L, 0L, localHashMap, null);
          paramString1 = "";
          switch (paramInt1)
          {
          }
    ...
    for (;;)
    {
      awqx.b(null, "CliOper", "", "", paramString1, paramString1, 0, 0, String.valueOf(paramInt3), "", "", "");
      return;
      i = 70;
      break;
      i = 80;
      ...
      for (;;)
      {
        awrn.a(com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext()).a(null, "NetModelSearchItemClick", true, 0L, 0L, localHashMap, null);
        break;
        localHashMap.put("isFolder", "0");
      }
      if (paramInt3 == 0)
    ...
    case 44: 
      do
      {
        do
        {
          ...
          return;
          axal.a(localQQAppInterface, paramContext, String.valueOf(9992L));
      ...
      awqx.b(localQQAppInterface, "CliOper", "", "", "0X8006477", "0X8006477", paramInt2, 0, "", "", "", "");
      return;
    }
    ConfessMsgListFragment.a(paramContext, 2);
  }
  
  public static void a(Intent paramIntent, aphp paramaphp)
  {
    int j = 1006;
    boolean bool2 = false;
    String str1;
    ...
    int m;
    boolean bool1;
    if ((paramIntent != null) && (paramaphp != null))
    {
      ...
      bool1 = true;
      if ((!(paramaphp instanceof apmn)) || (!paramIntent.hasExtra("contactSearchResultPhoneContactMobileCode")) || (k == 1006)) {
        break label395;
      }
  ...
  public static void a(View paramView, avoj paramavoj)
  {
    Activity localActivity = (Activity)paramView.getContext();
    Intent localIntent = new Intent();
    localIntent.putExtra("contactSearchResultUin", paramavoj.b());
    localIntent.putExtra("contactSearchResultUinType", paramavoj.d());
    localIntent.putExtra("contactSearchResultName", paramavoj.c());
    localIntent.putExtra("contactSearchResultNick", paramavoj.d());
    if (((paramavoj instanceof avmv)) || ((paramavoj instanceof avni)) || ((paramavoj instanceof avnd))) {
      paramView = paramavoj.b();
    }
    for (;;)
    {
      String str;
      ...
      {
        localIntent.putExtra("contactSearchResultPhoneContactOriginBinder", ((avnf)paramavoj).a.originBinder);
        avnf localavnf = (avnf)paramavoj;
        str = localavnf.a.mobileCode;
        if (!TextUtils.isEmpty(str)) {
          break label282;
        }
        str = localavnf.a.mobileNo;
      }
      label282:
      for (;;)
      {
        localIntent.putExtra("contactSearchResultPhoneContactMobileCode", str);
        localIntent.putExtra("contactSearchResultPhoneContactNationCode", ((avnf)paramavoj).a.nationCode);
        localIntent.putExtra("contactSearchResultPhoneContactAbility", ((avnf)paramavoj).a.ability);
        ...
        {
          paramView = ((avmx)paramavoj).e();
          break;
        }
        if ((paramavoj instanceof avne))
        {
          paramView = ((avne)paramavoj).jdField_a_of_type_JavaLangString;
          break;
        }
        if (!(paramavoj instanceof avng)) {
          break label285;
        }
        paramView = ((avng)paramavoj).e();
        break;
      }
      label285:
      paramView = "";
  ...
  public static void a(avoj paramavoj, View paramView)
  {
    ThreadManager.postImmediately(new SearchUtils.2(paramView, paramavoj), null, true);
  }
  
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, List<String> paramList, String paramString3, Rect paramRect, avwg paramavwg)
  {
    ThreadManager.post(new SearchUtils.3(paramString1, paramString2, paramList, paramString3, paramRect, paramAppInterface, paramavwg), 8, null, true);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        paramQQAppInterface = bade.a(paramQQAppInterface, paramActivity, paramString);
        if (paramQQAppInterface != null)
        {
  ...
  public static void a(String paramString)
  {
    ...
    for (int i = arrayOfString.length;; i = 0)
    {
      if (i > 1)
      {
        ...
        awqx.b(null, "CliOper", "", "", "0X8005E0F", "0X8005E0F", 0, 0, "" + i, "", "", "");
      }
      return;
    }
  }
  ...
  public static void a(String paramString, int paramInt1, int paramInt2, int paramInt3, View paramView)
  {
    ...
    if (bool)
    {
      int i = avwe.a(paramInt1);
      if (QLog.isColorLevel()) {
        QLog.d("searchUtils", 2, "moduleIndex:" + i + " searchKey:" + paramString);
      }
      awqx.b(null, "CliOper", "", "", "0X8005E10", "0X8005E10", paramInt1, 0, String.valueOf(i), String.valueOf(paramInt3), String.valueOf(paramInt2), "");
      ...
      awrn.a(com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext()).a(null, "GroupSearchItemClick", true, 0L, 0L, a(paramView), null);
      return;
    }
    awqx.b(null, "CliOper", "", "", "0X8005E11", "0X8005E11", paramInt1, 0, "", String.valueOf(paramInt3), String.valueOf(paramInt2), "");
    paramView = new HashMap();
    paramView.put("moduleType", Integer.toString(paramInt1));
    paramView.put("moduleChildType", Integer.toString(paramInt2));
    paramView.put("itemLinePosition", Integer.toString(paramInt3));
    paramView.put("keyword", paramString);
    awrn.a(com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext()).a(null, "ModelSearchItemClick", true, 0L, 0L, paramView, null);
  }
  
  public static void a(String paramString, int paramInt1, int paramInt2, View paramView)
  {
    boolean bool = a(paramView.getContext());
    int i = ((Integer)paramView.getTag(2131313374)).intValue() + 1;
    if (QLog.isColorLevel()) {
      QLog.d("searchUtils", 2, "moduleType:" + paramInt1 + " itemLinePosition:" + i);
    }
    if (bool)
    {
      int j = avwe.a(paramInt1);
      if (QLog.isColorLevel()) {
        QLog.d("searchUtils", 2, "moduleIndex:" + j + " searchKey:" + paramString);
      }
      awqx.b(null, "CliOper", "", "", "0X8005E10", "0X8005E10", paramInt1, 0, String.valueOf(j), String.valueOf(i), String.valueOf(paramInt2), "");
      paramView = new HashMap();
      paramView.put("moduleType", Integer.toString(paramInt1));
    ...
    awqx.b(null, "CliOper", "", "", "0X8005E11", "0X8005E11", paramInt1, 0, "", String.valueOf(i), String.valueOf(paramInt2), "");
    paramView = new HashMap();
    paramView.put("moduleType", Integer.toString(paramInt1));
    paramView.put("moduleChildType", Integer.toString(paramInt2));
    paramView.put("itemLinePosition", Integer.toString(i));
  ...
  public static void a(String paramString, int paramInt, View paramView, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      awqx.b(null, "CliOper", "", "", "0X8005E12", "0X8005E12", 40, 0, "3", "", "", "");
    }
    do
    {
      return;
      ...
      awqx.b(null, "CliOper", "", "", "0X8005E12", "0X8005E12", paramInt, 0, "1", "", "", "");
    } while (!UniteSearchActivity.jdField_b_of_type_Boolean);
    if (UniteSearchActivity.e == -1)
    {
      awqx.b(null, "CliOper", "", "", "0X8007E2E", "0X8007E2E", 2, 0, "", "" + UniteSearchActivity.jdField_b_of_type_Int, UniteSearchActivity.jdField_a_of_type_JavaLangString, "");
      return;
    }
    awqx.b(null, "CliOper", "", "", "0X8007E2E", "0X8007E2E", 1, 0, "", "" + UniteSearchActivity.jdField_b_of_type_Int, UniteSearchActivity.jdField_a_of_type_JavaLangString, "");
    return;
    if (QLog.isColorLevel()) {
      QLog.d("searchUtils", 2, "moduleType:" + paramInt + " -2 searchKey:" + "");
    }
    awqx.b(null, "CliOper", "", "", "0X8005E12", "0X8005E12", paramInt, 0, "2", "", "", "");
  }
  
  public static void a(String paramString1, String paramString2, int paramInt1, int paramInt2, String... paramVarArgs)
  {
    new awrb(null).a("dc00899").b("Grp_all_search").c(paramString1).d(paramString2).a(paramInt1).b(paramInt2).a(paramVarArgs).a();
  }
  ...
  {
    new awrb(null).a("dc00899").b(paramString1).c(paramString2).d(paramString3).a(paramInt1).b(paramInt2).a(paramVarArgs).a();
  }
  ...
  public static boolean a(avon paramavon)
  {
    return ((paramavon instanceof avmv)) || ((paramavon instanceof avmz)) || ((paramavon instanceof avnd)) || ((paramavon instanceof avni));
  }
  ...
  public static int[] a(babc parambabc, String paramString)
  {
    ...
    tmp11_7[1] = 0;
    tmp11_7;
    int j = parambabc.jdField_a_of_type_JavaLangString.indexOf(paramString);
    if (j < 0) {
      return arrayOfInt;
    }
    int i = 0;
    int k;
    if (i < parambabc.jdField_a_of_type_JavaUtilList.size())
    {
      if (j == ((Integer)parambabc.jdField_a_of_type_JavaUtilList.get(i)).intValue())
      {
        arrayOfInt[0] = i;
        k = i + 1;
        for (;;)
        {
          if ((k >= parambabc.jdField_a_of_type_JavaUtilList.size()) || (j + paramString.length() <= ((Integer)parambabc.jdField_a_of_type_JavaUtilList.get(k)).intValue()))
          {
            arrayOfInt[1] = (k - i);
            return arrayOfInt;
          }
      ...
      k = parambabc.jdField_a_of_type_JavaLangString.indexOf(paramString, ((Integer)parambabc.jdField_a_of_type_JavaUtilList.get(i)).intValue());
      if (k < 0) {
        return arrayOfInt;
      }
      j = i - 1;
    ...
    do
    {
      for (;;)
      {
        ...
        if (paramBoolean)
        {
          ...
          if (!paramString2.equals(((babc)localObject).jdField_a_of_type_JavaLangString)) {}
          for (int i = 1; i != 0; i = 0)
          {
            localObject = a((babc)localObject, paramString1);
  ...
  public static int b()
  {
    int i = BaseApplicationImpl.sApplication.getResources().getColor(2131101184);
    if (ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, "")) {
      i = BaseApplicationImpl.sApplication.getResources().getColor(2131101186);
    }
    return i;
  }
      ...
      while (i < paramString1.length)
      {
        ...
        if (!paramString1[i].equalsIgnoreCase(paramString2[i]))
        {
          ...
          if (arrayOfString1 != null)
          {
            ...
            {
              f1 = f2;
              if (avwl.a(arrayOfString1[0], arrayOfString2[0]))
              {
                f1 = f2;
                if (arrayOfString1.length > 1)
                {
                  f2 += f3;
                  f1 = f2;
                  if (avwl.b(arrayOfString1[1], arrayOfString2[1])) {
                    f1 = f2 + f3;
                  }
                }
              }
  ...
  {
    ((avqe)paramQQAppInterface.getManager(318)).a(paramString1, paramString2, paramString3, paramInt);
  }
  ...
  public static CharSequence c(String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt = 8;; paramInt = k + 1)
      {
        ...
        ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131101334)), 0, ((String)localObject1).length(), 17);
        while (paramInt >= 0)
        {
