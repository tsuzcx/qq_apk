  ...
  implements bapx
{
  ...
  static bapw jdField_a_of_type_Bapw = new avwg();
  private bapv jdField_a_of_type_Bapv;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private List<avwh> jdField_a_of_type_JavaUtilList = new Vector();
  Set<String> jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
  
  public avwf(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(String paramString1, String paramString2, Object paramObject, int paramInt1, boolean paramBoolean, int paramInt2, String paramString3)
  {
    ...
    localbaps.c = paramString3;
    localbaps.e = 1;
    localbaps.a(new Object[] { paramString2, paramObject, Integer.valueOf(paramInt1), Boolean.valueOf(paramBoolean), Integer.valueOf(paramInt2) });
  ...
  public void a(avwh paramavwh)
  {
    if (paramavwh == null) {}
    while (this.jdField_a_of_type_JavaUtilList.contains(paramavwh)) {
      return;
    }
    this.jdField_a_of_type_JavaUtilList.add(paramavwh);
  }
    ...
    for (String str1 = ".mp4";; str2 = "")
    {
      if (!a(paramString2, str1))
      {
        ...
        if ((paramObject != null) && ((paramObject instanceof String[])))
        {
          ...
          if ((paramObject != null) && ("shuayishua_anim".equals(paramObject)))
          {
            ...
            if ((bdcs.a((String)localObject)) && (bdcs.a(str3)) && (bdcs.a(str4)) && (bdcs.a(str5))) {}
          }
        }
        try
        {
          ...
          bdcs.a(a() + paramString2, str1, false);
          if (QLog.isColorLevel()) {
        ...
        try
        {
          ...
          bdcs.a(a() + paramString2, paramString1, false);
          if (QLog.isColorLevel()) {
      ...
      if (paramBoolean2)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            avxz.b("OlympicResources", new Object[] { "download, checkLimit == false, url=", paramString1 });
            return true;
          }
      ...
      ((baps)localObject).c = (a() + paramString2 + localException);
      ((baps)localObject).e = 1;
      ((baps)localObject).a(new Object[] { paramString2, paramObject, Integer.valueOf(0), Boolean.valueOf(paramBoolean1), Integer.valueOf(paramInt) });
      ((baps)localObject).jdField_a_of_type_Bapw = jdField_a_of_type_Bapw;
      this.jdField_a_of_type_Bapv.a((baqv)localObject);
      return true;
    }
  }
  
  public void b(avwh paramavwh)
  {
    if (paramavwh == null) {
      return;
    }
    this.jdField_a_of_type_JavaUtilList.remove(paramavwh);
  }
  ...
  public void onResp(baqw parambaqw)
  {
    ...
    if (parambaqw.jdField_a_of_type_Int == 0)
    {
      ...
      localObject2 = new File(localbaps.c);
      ...
      localObject1 = awiz.a(((File)localObject2).getAbsolutePath());
    ...
    for (;;)
    {
      ...
      if ((j == 1) || (j == 2))
      {
        if (j == 1)
        {
          ...
          localHashMap.put("url", avxz.a(localbaps.jdField_a_of_type_JavaLangString));
          localHashMap.put("err_desc", str1);
          str2 = "0";
          localObject3 = str2;
          if (parambaqw.jdField_a_of_type_JavaUtilHashMap != null)
          {
            localObject3 = str2;
            if (parambaqw.jdField_a_of_type_JavaUtilHashMap.containsKey("netresp_param_reason")) {
              localObject3 = (String)parambaqw.jdField_a_of_type_JavaUtilHashMap.get("netresp_param_reason");
            }
          }
          ...
          azmz.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), (String)localObject2, true, 0L, l, localHashMap, "", false);
          avxz.b("OlympicResources", new Object[] { "onResp report Download, reportKey=", localObject2, ", errcode=", Integer.valueOf(i), ", url=", localbaps.jdField_a_of_type_JavaLangString });
        }
      }
      else
      {
        ...
        label499:
        if (QLog.isColorLevel()) {
          QLog.i("OlympicResources", 2, "onResp.url=" + localbaps.jdField_a_of_type_JavaLangString + ", result=" + parambaqw.jdField_a_of_type_Int + ", errCode=" + i + ",md5 = " + (String)localObject1);
        }
        j = 0;
        for (;;)
        {
          ...
          {
            localObject4 = (avwh)this.jdField_a_of_type_JavaUtilList.get(j);
            if (localObject4 != null) {
              ((avwh)localObject4).a(localbaps.jdField_a_of_type_JavaLangString, (String)localObject1, localObject2, i, (String)localObject3);
            }
            j += 1;
            continue;
            bool1 = false;
            ...
            if (QLog.isColorLevel()) {
              QLog.i("OlympicResources", 2, "onResp.retry.url=" + localbaps.jdField_a_of_type_JavaLangString + ",md5=" + (String)localObject4 + ", result=" + parambaqw.jdField_a_of_type_Int + ", errCode=" + i + ",retryCount=" + k);
            }
            a(localbaps.jdField_a_of_type_JavaLangString, (String)localObject4, localObject5, k + 1, bool2, j, localbaps.c);
          }
        }
      }
      label807:
      ...
      while (bool1)
      {
        for (;;)
        {
          ...
          try
          {
            ...
            azmz.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), (String)localObject2, false, 0L, 0L, localHashMap, "", false);
          }
        ...
        ((File)localObject2).delete();
        azmz.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "olympic_down_null", bool1, 0L, 0L, null, "", false);
        localObject3 = null;
        localObject2 = null;
        localObject1 = null;
        break label499;
      }
      QLog.i("OlympicResources", 1, "onResp.url=" + localbaps.jdField_a_of_type_JavaLangString + ", result=" + parambaqw.jdField_a_of_type_Int + ", errCode=" + i + ",md5 = " + (String)localObject1 + ", errDesc=" + str1);
      return;
      label1015:
      localObject1 = null;
      l = 0L;
  ...
  public void onUpdateProgeress(baqv parambaqv, long paramLong1, long paramLong2)
  {
    ...
    if ((parambaqv == null) || (!(parambaqv instanceof baps))) {
      return;
    }
    String str = ((baps)parambaqv).jdField_a_of_type_JavaLangString;
    parambaqv = parambaqv.a();
    if ((parambaqv != null) && ((parambaqv instanceof Object[])))
    {
      localObject = (Object[])parambaqv;
      parambaqv = (String)localObject[0];
      localObject = localObject[1];
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.i("OlympicResources", 2, "onUpdateProgeress.url=" + str + ", md5=" + parambaqv + ", userData=" + localObject + ",curOffset=" + paramLong1 + ",totalLen=" + paramLong2);
      }
      int i = 0;
      while (i < this.jdField_a_of_type_JavaUtilList.size())
      {
        avwh localavwh = (avwh)this.jdField_a_of_type_JavaUtilList.get(i);
        if (localavwh != null) {
          localavwh.a(str, parambaqv, localObject, paramLong1, paramLong2);
        }
        i += 1;
      }
      break;
