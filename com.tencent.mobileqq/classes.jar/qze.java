  ...
  extends qxr
{
  ...
  public qze(qzd paramqzd, View paramView, BaseData paramBaseData)
  {
  ...
  {
    ViewFactory.findClickableViewListener(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer.getVirtualView(), new qzf(this, paramProteusItemData, paramContext));
  }
  ...
  private void a(View paramView, BaseData paramBaseData)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramView.setOnLongClickListener(new qzh(this, paramView, localProteusItemData));
          return;
        }
      }
  ...
  public void a(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (localTemplateBean != null) {
        qzd.a(this.jdField_a_of_type_Qzd, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer);
      }
      try
      {
        localTemplateBean.getViewBean().bindData(paramBaseData1.b, localTemplateBean.getViewDataBinding());
        oag.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer.getVirtualView(), paramBaseData1.a.getViewBean());
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData = paramBaseData1;
        label85:
        a(qzd.a(this.jdField_a_of_type_Qzd), paramBaseData1);
