...
{
  public vtu(QRJumpActivity paramQRJumpActivity, String paramString1, String paramString2, Activity paramActivity, String paramString3) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (((JSONObject)localObject2).getInt("r") == 0) {
          localvsn = new vsn(((JSONObject)localObject2).getString("d"));
        }
        boolean bool;
        Bundle localBundle;
        paramBundle = null;
        ...
        try
        {
          if (((JSONObject)localObject2).has("wpa"))
          {
            ...
            if (localObject1 != null) {
              vsr.a(this.jdField_a_of_type_ComTencentBizQrcodeActivityQRJumpActivity.app, this.jdField_a_of_type_AndroidAppActivity, paramBundle, this.c, (Bundle)localObject1);
            }
