  ...
  extends avhb
{
  protected void a(boolean paramBoolean, long paramLong, ArrayList<Long> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      if ((paramLong == axnl.a(this.a)) && (axnl.d(this.a) != null)) {
        if (paramArrayList != null) {
          synchronized (axnl.a(this.a))
          {
            axnl.a(this.a).put(Long.valueOf(paramLong), (ArrayList)paramArrayList.clone());
          }
        }
      }
      synchronized (axnl.d(this.a))
      {
        localObject2 = (WeakReference)axnl.d(this.a).get(Long.valueOf(paramLong));
        if (localObject2 != null)
        {
          ??? = (axno)((WeakReference)localObject2).get();
          if (??? != null)
          {
            if (paramBoolean) {
              break;
            }
            axnl.a(this.a, paramLong, (axno)???);
          }
        }
        return;
        label200:
    ...
    ((axno)???).a(paramLong, paramArrayList);
  }
  ...
  protected void a(boolean paramBoolean, HashMap<Long, IntimateInfo> paramHashMap, Object arg3)
  {
    ...
    for (paramHashMap = paramHashMap.size() + paramHashMap.toString();; paramHashMap = "null")
    {
      ...
      synchronized (axnl.e(this.a))
      {
        ...
        axnl.e(this.a).remove(localObject2);
      }
    }
    label387:
    label393:
    ...
    {
      label297:
      if ((l2 == axnl.a(this.a)) && (axnl.f(this.a) != null)) {}
      synchronized (axnl.f(this.a))
      {
        ??? = (WeakReference)axnl.f(this.a).get(Long.valueOf(l2));
        if (??? != null)
        {
          ??? = (axnm)((WeakReference)???).get();
          if (??? != null) {
            axnl.a(this.a, l2, paramHashMap, ???);
          }
        }
        return;
      }
