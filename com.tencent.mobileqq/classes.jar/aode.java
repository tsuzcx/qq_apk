...
public abstract class aode
{
  ...
  protected abstract void addBusinessObserver(ToServiceMsg paramToServiceMsg, anui paramanui, boolean paramBoolean);
  ...
  public ToServiceMsg makeOIDBPkg(String paramString, int paramInt1, int paramInt2, byte[] paramArrayOfByte, long paramLong, anui paramanui, boolean paramBoolean)
  {
    ...
    addBusinessObserver(paramString, paramanui, paramBoolean);
    return paramString;
  }
}
