...
public class aqkl
{
  public static final String a = anni.a(2131713950);
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          String[] arrayOfString = bgng.a(localObject2[i], "=");
          ...
          localObject2 = new String(bgku.decode(arrayOfString[1], 0));
          localObject1 = localObject2;
          if (!((String)localObject2).contains("&gc=")) {
            localObject1 = String.format("%s&gc=%s", new Object[] { localObject2, axeg.a(paramString2) });
          }
          paramString2 = bgku.encodeToString(((String)localObject1).getBytes(), 2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString1, int paramInt2, String paramString2, String paramString3)
  {
    for (;;)
    {
      ...
      localStringBuilder.append("&").append("quin").append("=").append(axeg.a(paramString1));
      localStringBuilder.append("&").append("topicId").append("=").append(paramInt2);
      localStringBuilder.append("&").append("sUin").append("=").append(axeg.a(paramString2));
      localStringBuilder.append("&").append("rUin").append("=").append(axeg.a(paramString3));
      ...
      return;
      localObject = ((aqji)localObject).o;
      continue;
      str = "aio_card_insert";
    }
  }
          ...
          for (;;)
          {
            ...
            catch (InvalidProtocolBufferMicroException paramStringBuilder)
            {
              try
              {
                ...
                paramList = (MessageForTroopConfess)bbzh.a(-2067);
  ...
  public static Object[] a(String paramString)
  {
    ...
    for (Object localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();; localObject1 = null)
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (localObject2 != null) {
          if (bgjw.a(str, ((TroopInfo)localObject2).troopowneruin))
          {
            i = 2;
        ...
        for (;;)
        {
          ...
          if (paramString != null)
          {
            ...
            for (;;)
            {
              ...
              if (bgjw.d(((TroopMemberInfo)localObject1).memberuin)) {
  ...
  {
    boolean bool2 = false;
    paramMessageRecord = bfre.a(paramMessageRecord);
    boolean bool1 = bool2;
