...
public class biow
{
  public void a(boolean paramBoolean, String paramString1, String paramString2, List<bikw> paramList, long paramLong, bior parambior, String paramString3, Activity paramActivity, biyc parambiyc, Bundle paramBundle)
  {
    ...
    if ((localAppRuntime == null) || (paramBundle == null) || (parambiyc == null))
    {
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        paramList = (bikw)paramString1.next();
    ...
    if (Build.VERSION.RELEASE == null)
    {
      ...
      paramBundle.qqv.set(biip.a().d());
      paramBundle.app_type.set(1);
      paramBundle.pf.set(bipr.a((Bundle)localObject, "pf", "openmobile_android"));
      paramBundle.sdkp.set(bipr.a((Bundle)localObject, "sdkp", "android"));
      paramBundle.sdkv.set(bipr.a((Bundle)localObject, "sdkv", "1.5.9"));
    ...
    for (paramString1 = paramString1.toString();; paramString1 = "")
    {
      ...
      break;
      paramList = biyz.a(paramActivity, paramString3);
    ...
    paramBundle.skey.set(parambiyc.b);
    if (paramBoolean) {
    ...
    for (;;)
    {
      ...
      paramActivity = new NewIntent(BaseApplicationImpl.getApplication(), biqf.class);
      paramActivity.setWithouLogin(true);
      paramActivity.putExtra("uin", parambiyc.a);
      localObject = bipr.a(localAppRuntime, parambiyc, paramBundle.login_sig, "QQConnectLogin.auth", "QQConnectLogin.auth_emp");
      paramBoolean = "QQConnectLogin.auth_emp".equals(localObject);
      paramList = paramBundle.toByteArray();
      paramString1 = paramList;
      if (paramBoolean) {
        paramString1 = biyz.a(paramList, parambiyc);
      }
      paramActivity.putExtra("data", paramString1);
      paramActivity.putExtra("cmd", (String)localObject);
      paramLong = System.currentTimeMillis();
      QLog.d("SDK_LOGIN.ProxyAuthManager", 1, new Object[] { "cmd=" + (String)localObject, ", uin=*" + bipr.a(parambiyc.a), ", reqState=", paramString3 });
      paramActivity.setObserver(new biox(this, paramLong, parambiyc, parambior, paramBoolean, paramString3, (String)localObject, paramString2));
