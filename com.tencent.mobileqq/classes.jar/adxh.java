...
public class adxh
  extends ImageSpan
{
  public adxh(ChatSettingForTroop paramChatSettingForTroop, Drawable paramDrawable, int paramInt)
  {
  ...
  {
    paramCanvas.save();
    paramCanvas.translate(bclx.a(9.0F), 0.0F);
  ...
  {
    return getDrawable().getBounds().right + bclx.a(9.0F);
  }
}
