...
public final class amvt
  extends amvw
{
  public amvt(QIMMusicConfigManager paramQIMMusicConfigManager)
  {
  ...
  amvu a()
  {
    return new amvu(this.jdField_a_of_type_DovComQqImCaptureMusicQIMMusicConfigManager);
  }
  ...
  public void a(NetResp paramNetResp)
  {
    if (paramNetResp.c == 200)
    {
      ...
      {
        amvu localamvu = a();
        localamvu.jdField_a_of_type_JavaLangString = new String(paramNetResp.a);
        localamvu.a();
        this.jdField_a_of_type_DovComQqImCaptureMusicQIMMusicConfigManager.a(0, true, localamvu.jdField_a_of_type_JavaLangString);
        return;
      }
      a(false);
  ...
  public void run()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QIMMusicConfigManager", 2, "QQMusic songlistlist api request, req url=" + localHttpNetReq.jdField_a_of_type_JavaLangString);
    }
