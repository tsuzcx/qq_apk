...
public class avqz
  implements Manager
{
  avrb jdField_a_of_type_Avrb = new avra(this);
  awbw jdField_a_of_type_Awbw;
  public QQAppInterface a;
  public OcrConfig a;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  
  public avqz(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Avrb);
  ...
  public static boolean a(String paramString, int paramInt)
  {
    ...
    {
      boolean bool2;
      if (avtm.a().jdField_a_of_type_Int == 1)
      {
        bool2 = true;
        label68:
        if (QLog.isColorLevel()) {
          QLog.d("Q.ocr", 2, "isSupportOcr, uin:" + paramString + "form:" + paramInt + ",isSupport:" + bool1 + ",dpcSwitch:" + bool2 + ",sdcard:" + avsv.a);
        }
        if ((!bool1) || (!bool2) || (!avsv.a)) {
          break label218;
        }
      }
      label218:
  ...
  public avsl a(List<OCRTextSearchInfo.SougouSearchInfo> paramList)
  {
    avsl localavsl = new avsl();
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      localavsl.jdField_a_of_type_JavaUtilList = new ArrayList();
      avsj localavsj = new avsj();
      localavsj.jdField_a_of_type_Int = 2049;
      localavsj.jdField_a_of_type_JavaLangString = alpo.a(2131708197);
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        OCRTextSearchInfo.SougouSearchInfo localSougouSearchInfo = (OCRTextSearchInfo.SougouSearchInfo)paramList.next();
        avsk localavsk = new avsk();
        localavsk.jdField_a_of_type_JavaLangObject = localSougouSearchInfo;
        localavsj.jdField_a_of_type_JavaUtilList.add(localavsk);
      }
      localavsl.jdField_a_of_type_JavaUtilList.add(localavsj);
    }
    return localavsl;
  }
  ...
  {
    if (!bdee.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
      ((avqx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(113)).notifyUI(3, false, new Object[] { Integer.valueOf(-2), paramString1, null });
    }
    ...
    ((avqx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(113)).a(paramString1, str, paramLong);
  }
  ...
  public void a(boolean paramBoolean, OcrConfig paramOcrConfig)
  {
    ...
    //   45: ifeq +31 -> 76
    //   48: aload_0
    //   49: getfield 26	avqz:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   52: astore_3
    //   53: aload_3
    //   54: monitorenter
    //   55: aload_0
    //   56: aload_2
    //   57: putfield 284	avqz:jdField_a_of_type_ComTencentMobileqqOcrDataOcrConfig	Lcom/tencent/mobileqq/ocr/data/OcrConfig;
    //   60: aload_0
    //   61: getfield 28	avqz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   64: invokevirtual 64	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   67: aload_0
    //   68: getfield 284	avqz:jdField_a_of_type_ComTencentMobileqqOcrDataOcrConfig	Lcom/tencent/mobileqq/ocr/data/OcrConfig;
    //   71: invokestatic 299	avqz:a	(Ljava/lang/String;Lcom/tencent/mobileqq/ocr/data/OcrConfig;)V
    //   74: aload_3
    //   75: monitorexit
    ...
    //   80: aload_0
    //   81: iload_1
    //   82: invokespecial 346	com/tencent/mobileqq/ocr/OCRManager$3:<init>	(Lavqz;Z)V
    //   85: bipush 8
    //   87: aconst_null
    //   88: iconst_0
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Avrb);
