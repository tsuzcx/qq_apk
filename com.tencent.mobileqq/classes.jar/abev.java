...
public class abev
{
  ...
  {
    if ((bctj.b) && (paramContext.getSharedPreferences("pref_safemode_not_exit", 4).getBoolean("key_not_exit_enable", false))) {}
    ...
    bctj.a(paramContext).a("", "exitSafeModeCrash", true, 0L, 0L, null, null);
    return;
    ...
    if (paramInt > 0)
    {
      ...
      if ((a()) && (paramInt > 3)) {
        bctj.a(paramContext).a("", "exitSafeModeStart_" + jdField_a_of_type_Int, true, 0L, 0L, null, null);
      }
    }
    aqlh.a().a();
  }
  ...
  public static void a(Context paramContext, Object paramObject)
  {
    if ((paramObject != null) && (paramObject.toString().contains("Activity")) && (jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true)))
    {
      ...
      if ((i > 3) && (a())) {
        bctj.a(paramContext).a("", "enterSafeModeStart_" + jdField_a_of_type_Int, true, 0L, 0L, null, null);
      }
      aqlh.a().a = true;
      aqlh.a().b = true;
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        if ((i == 3) && (a())) {
          bctj.a(paramContext).a("", "enterSafeModeCrash", true, 0L, 0L, null, null);
        }
        aqlh.a().a(false);
