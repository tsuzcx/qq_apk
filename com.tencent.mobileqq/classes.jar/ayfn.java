...
public class ayfn
  implements bcpo
{
  public ayfn(RobotChatPanelLayout paramRobotChatPanelLayout, long paramLong, int paramInt, String paramString, bcro parambcro) {}
  ...
  public void a(int paramInt, cmd0x934.RspBody paramRspBody)
  {
    ...
    {
      this.jdField_a_of_type_Bcro.a(bool1, this.jdField_a_of_type_JavaLangString);
      if (!QLog.isColorLevel()) {
        break;
      }
