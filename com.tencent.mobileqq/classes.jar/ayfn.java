  ...
  extends aydq
{
  ...
  public ayfn(BaseActivity paramBaseActivity, Bundle paramBundle)
  {
  ...
  protected void a(Bundle paramBundle)
  {
    ...
    for (paramBundle = "0";; paramBundle = "1")
    {
      ...
      azho.a("two_comment", "exp", this.d, this.h, "", "");
      return;
    }
  }
  ...
  protected void a(String paramString)
  {
    ...
    try
    {
      ...
      paramString = new NewIntent(this.jdField_a_of_type_AndroidContentContext, mmi.class);
      ...
      paramString.setObserver(new ayfo(this));
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppRuntime().startServlet(paramString);
      return;
    }
    catch (Exception paramString)
    {
      bbmy.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, 2131630856, 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
  ...
  public void dismiss()
  {
    ...
    {
      azho.a("two_comment", "un", this.d, str, "", "");
