...
public class pqc
{
    ...
    for (;;)
    {
      try
      {
        ...
        if (bnrf.a(paramInt))
        {
          ...
          localObject1 = (String)bnrf.a("DAILY_CHILD_FEEDS_REQUEST_CONFIG" + paramInt, "");
          ...
          if (bnrf.y()) {
            localJSONArray.put(bnrf.a());
          }
          localJSONArray.put(bnrf.b());
          return localJSONArray.toString();
        }
        Object localObject1 = ReadInJoyMMapKvStorage.getInstance().getValeForKey("KANDIAN_DAILY_SETTING_CONFIG");
        Object localObject3 = (String)bnrf.a("KANDIAN_DAILY_LCAOL_SETTING_CONFIG", "");
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          break label198;
        }
  ...
  public static pqc a(JSONObject paramJSONObject)
  {
    int j = 0;
    pqc localpqc = new pqc();
    if (paramJSONObject != null)
    {
      localpqc.jdField_a_of_type_JavaLangString = paramJSONObject.optString("key");
      localpqc.jdField_b_of_type_JavaLangString = paramJSONObject.optString("name");
      localpqc.d = paramJSONObject.optString("value");
      localpqc.c = paramJSONObject.optString("id");
      ...
      if (localObject != null)
      {
        ...
        while (i < ((JSONArray)localObject).length())
        {
          ...
          localpqc.jdField_b_of_type_JavaUtilList.add(str);
          i += 1;
        }
      }
      ...
      if (paramJSONObject != null)
      {
        ...
        while (i < paramJSONObject.length())
        {
          ...
          localpqc.jdField_a_of_type_JavaUtilList.add(localObject);
          i += 1;
        }
      }
    }
