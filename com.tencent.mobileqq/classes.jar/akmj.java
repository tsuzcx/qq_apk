...
public class akmj
  extends PhotoListLogicBase<NewPhotoListActivity, akmq>
  implements PhotoListLogic.IadapterCallback, PhotoListLogic.IcheckBoxCallback, PhotoListLogic.IitemClickCallback, zaf
{
  public akmi a;
  
  public akmj(NewPhotoListActivity paramNewPhotoListActivity)
  {
    super(paramNewPhotoListActivity);
    this.mPhotoListData = new akmi();
    this.a = ((akmi)this.mPhotoListData);
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 >= 0) && (paramInt1 < localArrayList.size()) && (paramInt2 >= 0) && (paramInt2 < localArrayList.size()))
    {
      ...
      yzz.a().b(localArrayList, this.mPhotoCommonData.allMediaInfoHashMap);
    }
  ...
  protected void a(Intent paramIntent, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    while (i1 < paramArrayList.size())
    {
      ...
      {
        int n;
        if (((akmq)this.mOtherCommonData).a(this.mPhotoCommonData, (String)localObject2) == 1)
        {
          localObject2 = ((akmq)this.mOtherCommonData).a(this.mPhotoCommonData, (String)localObject2);
          n = j;
          m = i;
    ...
    for (i = 1;; i = 0)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        localObject1 = ((NewPhotoListActivity)this.mActivity).getResources().getString(2131718496);
        ...
        if (bixr.a(this.mActivity, 4, new akml(this, paramIntent))) {
          bhdj.a(this.mActivity, 232, null, (String)localObject1, new akmm(this, paramIntent), new akmn(this)).show();
        }
        if (QLog.isColorLevel()) {
  ...
  public void a(SlideItemInfo paramSlideItemInfo)
  {
    ...
    for (;;)
    {
      if ((i >= 0) && (i < ((List)localObject2).size()))
      {
        ...
        aklj.a(((NewPhotoListActivity)this.mActivity).getIntent(), "param_cancelSelNum");
  ...
  boolean a(LocalMediaInfo paramLocalMediaInfo, CheckBox paramCheckBox)
  {
    ...
    return (!((akmq)this.mOtherCommonData).a()) || (bpij.a(this.mActivity, paramLocalMediaInfo));
  }
  ...
  protected void b()
  {
    ...
    {
      aklj.a(((NewPhotoListActivity)this.mActivity).getIntent(), this.mPhotoCommonData.selectedPhotoList.size());
      aklj.a(((NewPhotoListActivity)this.mActivity).getIntent(), this.mPhotoCommonData.selectedPhotoList.size(), this.mPhotoCommonData.currentQualityType);
    }
    Intent localIntent = ((NewPhotoListActivity)this.mActivity).getIntent();
  ...
  public Intent caseNoSingModeImage(View paramView, int paramInt)
  {
    ...
    paramView.putExtra("PhotoConst.editPathMap", akkq.a(this.a.jdField_c_of_type_JavaUtilHashMap));
  ...
  public void doOnDestroy()
  {
    if (this.mPhotoCommonData.isShowQzoneAlbum) {
      BaseApplicationImpl.getApplication().getRuntime().unRegistObserver(((NewPhotoListActivity)this.mActivity).jdField_a_of_type_Akmf);
    }
    if (((akmq)this.mOtherCommonData).a()) {
      yzz.a().f();
    }
  ...
  public void doOnResume()
  {
    ...
    } while (!((akmq)this.mOtherCommonData).a());
    yzz.a().c();
    yzz.a().a(this.a.jdField_a_of_type_Zad);
  }
  ...
  protected void e(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    aklj.a(((NewPhotoListActivity)this.mActivity).getIntent(), "param_totalSelNum");
  ...
  public void enterAlbumListFragment(Intent paramIntent)
  {
    ...
    paramIntent.putExtra("PhotoConst.PHOTO_INFOS", ((akmq)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap);
  ...
  public void enterPhotoPreviewActivity(boolean paramBoolean, Intent paramIntent)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if ((localArrayList != null) && (localArrayList.size() > 0)) {
        bdla.b(null, "CliOper", "", this.mPhotoCommonData.myUin, "0X8004072", "0X8004072", 0, localArrayList.size(), 0, "", "", "", "");
      }
      if ((((akmq)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap == null) || (((akmq)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap.size() <= 0)) {
        break label355;
      }
      paramIntent.putExtra("PhotoConst.PHOTO_INFOS", ((akmq)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap);
  ...
  void f()
  {
    Object localObject = yzz.a().a();
    if (this.a.k) {
      yzz.a().b((List)localObject);
    }
    ...
    if (this.mPhotoCommonData.selectedPhotoList.size() > 0) {
      yzz.a().a(this.mPhotoCommonData.selectedPhotoList, this.mPhotoCommonData.allMediaInfoHashMap, false);
    }
  }
  ...
  public String getExceedMaxSelectNumStr(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (paramLocalMediaInfo != null)
    {
      ...
      if ((((akmq)this.mOtherCommonData).a()) && (!this.a.isSupportVideoCheckbox)) {
        return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694633, new Object[] { Integer.valueOf(i) });
      }
      if ((this.a.isSupportVideoCheckbox) && (paramLocalMediaInfo != null) && ("video".equals(paramLocalMediaInfo[0])))
      {
        if (((akmq)this.mOtherCommonData).a()) {
          return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694634, new Object[] { Integer.valueOf(i) });
        }
        return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694632, new Object[] { Integer.valueOf(i) });
      }
    }
    return str;
  }
  ...
  public void handleVideoCapture(Intent paramIntent)
  {
    ...
    localVideoCompositeHelper.composite((PublishVideoEntry)localObject, str, false, true, new akmp(this, l, str, (PublishVideoEntry)localObject, paramIntent));
  }
  ...
  public void handleVideoEncodeSucceed(Message paramMessage)
  {
    ...
    if ((paramMessage.obj instanceof String))
    {
      ...
      QQToast.a(this.mActivity, String.format(((NewPhotoListActivity)this.mActivity).getResources().getString(2131694632), new Object[] { Integer.valueOf(PhotoCommonBaseData.getInstance().maxSelectNum) }), 0).a();
    }
    for (;;)
    {
  ...
  public void initData(Intent paramIntent)
  {
    ...
    akkq.a(this.mActivity, paramIntent, false, this.a.jdField_c_of_type_JavaUtilHashMap);
    ...
    ((akmq)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap = ((HashMap)paramIntent.getSerializableExtra("PhotoConst.PHOTO_INFOS"));
    ...
    try
    {
      ...
      if (this.mPhotoCommonData.isShowQzoneAlbum)
      {
        ...
        BaseApplicationImpl.getApplication().getRuntime().registObserver(((NewPhotoListActivity)this.mActivity).jdField_a_of_type_Akmf);
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (yzz.a().a().isEmpty())
      {
        ...
        if ((paramView != null) && (((NewPhotoListActivity)this.mActivity).mGridView.getHeight() - paramView.getY() < ((NewPhotoListActivity)this.mActivity).mImageHeight)) {
          ((NewPhotoListActivity)this.mActivity).mGridView.smoothScrollBy(yzz.jdField_a_of_type_Int, 500);
        }
      }
      ...
      if (i < this.mPhotoCommonData.selectedPhotoList.size())
      {
        ...
        for (;;)
        {
          ...
          if (!new File(str).exists()) {
            if ((str.startsWith("http")) && (((akmq)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap != null))
            {
              j = i;
              if (((akmq)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap.containsKey(str)) {}
            }
            else
            {
  ...
  public void onSendBtnClick(View paramView)
  {
    ...
    if (((NewPhotoListActivity)this.mActivity).getIntent().getBooleanExtra("PhotoConst.IS_SEND_FILESIZE_LIMIT", false))
    {
      ...
      if (auea.a())
      {
        audn.a(this.mActivity, 2131692476, 2131692481, new akmo(this));
        return;
      }
    }
    b();
  ...
  public void postInitUI()
  {
    ...
    int i;
    if ((this.a.isSingleMode) || (this.mPhotoCommonData.showMediaType == 2) || (((akmq)this.mOtherCommonData).a()))
    {
      i = 8;
  ...
  {
    if (akkq.a(paramLocalMediaInfo.path, this.a.jdField_c_of_type_JavaUtilHashMap))
    {
      if (Build.VERSION.SDK_INT >= 21) {
        paramHolder.mPhotoFlagView.setImageDrawable(((NewPhotoListActivity)this.mActivity).getDrawable(2130839417));
      }
      for (;;)
      {
        paramHolder.mPhotoFlagView.setVisibility(0);
        return;
        paramHolder.mPhotoFlagView.setImageResource(2130839417);
      }
    }
  ...
  {
    if (paramList != null) {
      akkq.a(paramList, paramInt, null, this.a.jdField_c_of_type_JavaUtilHashMap);
    }
  ...
  public void updateButton()
  {
    ...
    if (localArrayList.size() > 0)
    {
      ...
      if ((localArrayList.size() != 1) || ((((akmq)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap != null) && (((akmq)this.mOtherCommonData).jdField_a_of_type_JavaUtilHashMap.size() > 0)) || (((akmq)this.mOtherCommonData).a(this.mPhotoCommonData, (String)localArrayList.get(0)) != 0)) {
        break label367;
      }
