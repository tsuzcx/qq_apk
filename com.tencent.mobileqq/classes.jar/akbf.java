...
public class akbf
  extends bgzm
{
  public akbf(AvatarPendantActivity paramAvatarPendantActivity) {}
  ...
  protected void handlePendantAuth(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_Bgwg != null) {
        this.a.jdField_a_of_type_Bgwg.c = -1;
      }
      bcst.b(this.a.app, "CliOper", "", "", "0X8005FD4", "0X8005FD4", 0, 0, "", "", "", "");
      if ((this.a.jdField_a_of_type_Ambe != null) && (this.a.jdField_a_of_type_JavaUtilList != null))
      {
        paramObject = ((AvatarPendantManager)this.a.app.getManager(46)).a();
        this.a.jdField_a_of_type_Ambe.a(paramObject, this.a.jdField_a_of_type_JavaUtilList);
      }
    } while ((this.a.jdField_a_of_type_Bgwf == null) || (!this.a.jdField_a_of_type_Bgwf.jdField_a_of_type_Boolean));
    localObject = bgyg.a("linkPendantSet");
    paramObject = localObject;
    if (localObject != null) {
      paramObject = ((String)localObject).replace("[id]", String.valueOf(this.a.jdField_a_of_type_Bgwf.jdField_a_of_type_Int));
    }
    ...
    bcst.b(this.a.app, "CliOper", "", "", "0X8006517", "0X8006517", 0, 0, "", "", "", "");
    return;
    this.a.jdField_a_of_type_AndroidWidgetButton.setText(2131717818);
    ...
    {
      bcst.b((QQAppInterface)localObject, "CliOper", "", "", "0X8005FD6", "0X8005FD6", 0, 0, paramObject, "", "", "");
      if (!this.a.d) {
        break;
      }
      this.a.d = false;
