...
public class aktv
{
  ...
  public static Map<String, aods> a;
  ...
  {
    bcef.b(null, "dc00898", "", "", "0X80072C1", "0X80072C1", 0, 0, "", "", "", "");
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      paramString3 = ((aods)localEntry.getValue()).a();
    ...
    for (;;)
    {
      ...
      localHashMap.put("is_dynamic", VideoEnvironment.configParam.mIsDynamic + "");
      ...
      StatisticCollector.getInstance(BaseApplication.getContext()).collectPerformance(null, "dynamic_adjustment_on_destroy", true, paramString1.jdField_a_of_type_ArrayOfLong[((int)(paramString1.jdField_a_of_type_ArrayOfLong.length * 0.5F))], 0L, localHashMap, null);
      a(localHashMap, "DynamicAdjustment", "dynamic_adjustment_on_destroy");
      return;
    }
  }
  
  public static void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, aodt paramaodt)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("camera_type", paramString1);
    ...
    localHashMap.put("is_dynamic", VideoEnvironment.configParam.mIsDynamic + "");
    if ((paramaodt == null) || (paramaodt.jdField_a_of_type_ArrayOfLong == null) || (paramaodt.jdField_a_of_type_ArrayOfLong.length == 0)) {
      return;
    }
    localHashMap.put("cost_time", paramaodt.jdField_a_of_type_ArrayOfLong[((int)(paramaodt.jdField_a_of_type_ArrayOfLong.length * 0.5F))] + "");
    StatisticCollector.getInstance(BaseApplication.getContext()).collectPerformance(null, "dynamic_adjustment_on_triggering", true, paramaodt.jdField_a_of_type_ArrayOfLong[((int)(paramaodt.jdField_a_of_type_ArrayOfLong.length * 0.5F))], 0L, localHashMap, null);
  ...
  private static void a(String paramString1, String paramString2, HashMap<String, String> paramHashMap)
  {
    ...
    for (paramString1 = new HashMap();; paramString1 = paramHashMap)
    {
      ...
      paramString1.put("DEVICE_TYPE_NAME", apjt.a().a());
  ...
  public static void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (String str = "0"; (!StringUtil.isEmpty(paramString1)) || (!apju.a()); str = "1")
    {
      bcef.b(null, "dc00898", "", "", "0X80072C3", "0X80072C3", 0, 0, str, paramString1, "", "");
      if (paramBoolean) {
        bcef.b(null, "dc00898", "", "", "0X80083B0", "0X80083B0", 0, 0, str, paramString1, "", "");
      }
      if (!StringUtil.isEmpty(paramString2)) {
        bcef.b(null, "dc00898", "", "", "0X80083B6", "0X80083B6", 0, 0, paramString1, "", paramString2, "");
      }
      return;
    }
    bcef.b(null, "dc00898", "", "", "0X80072C2", "0X80072C2", 0, 0, str, "", "", "");
  }
  ...
  public static void a(String paramString1, boolean paramBoolean, String paramString2, long paramLong)
  {
    ...
    for (paramString1 = "beauty";; paramString1 = "nBeauty")
    {
      ...
      paramString2 = (aods)jdField_a_of_type_JavaUtilMap.get(localObject);
      paramString1 = paramString2;
      if (paramString2 == null)
      {
        paramString1 = new aods(2147483647);
  ...
  public static void l()
  {
    ...
    while (localIterator.hasNext()) {
      ((aods)((Map.Entry)localIterator.next()).getValue()).a();
    }
    jdField_a_of_type_JavaLangString = "";
  }
}
