  ...
  extends WebViewPlugin
{
  ...
  private Boolean a(String paramString)
  {
    ...
    befn localbefn = befm.a(this.jdField_b_of_type_JavaLangString);
    if ((localbefn != null) && (!TextUtils.isEmpty(localbefn.jdField_b_of_type_JavaLangString)))
    {
      this.mRuntime.a().loadDataWithBaseURL(paramString, localbefn.jdField_b_of_type_JavaLangString, "text/html", "utf-8", paramString);
  ...
  private void a(boolean paramBoolean)
  {
    ...
    {
      beey localbeey = ((WebViewFragment)localObject).a;
      if (!paramBoolean) {}
    ...
    {
      ((beey)localObject).d = paramBoolean;
      return;
    }
  }
  ...
  {
    if (!bjxj.o(this.jdField_a_of_type_ComTencentCommonAppAppInterface)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        if (paramLong == 32L)
        {
          ...
          if ((!bjxj.p(this.jdField_a_of_type_ComTencentCommonAppAppInterface)) && (!this.jdField_a_of_type_Boolean)) {
            return a(paramString).booleanValue();
          }
          return this.jdField_a_of_type_Boolean;
        }
      } while ((paramLong != 8589934593L) || (!bjxj.p(this.jdField_a_of_type_ComTencentCommonAppAppInterface)));
  ...
  public void onCreate()
  {
    ...
    if (this.mRuntime != null)
    {
      ...
      this.jdField_b_of_type_Boolean = bjxj.o(this.jdField_a_of_type_ComTencentCommonAppAppInterface);
    }
    if (this.jdField_a_of_type_Red == null) {
