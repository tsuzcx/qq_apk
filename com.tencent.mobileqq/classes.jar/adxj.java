...
{
  public adxj(AuthDevVerifyCodeActivity paramAuthDevVerifyCodeActivity) {}
  ...
  public void onAskDevLockSms(WUserSigInfo paramWUserSigInfo, DevlockInfo paramDevlockInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    paramWUserSigInfo = this.a.getString(2131715879);
  ...
  public void onCheckDevLockSms(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    if (paramInt == 0)
    {
      ...
      asvf.a().a(null, this.a.app.getCurrentAccountUin(), 9);
      this.a.setResult(-1);
      this.a.finish();
      ...
      asvf.a().a(paramErrMsg, this.a, paramWUserSigInfo, true);
      return;
    }
    if ((paramErrMsg != null) && (!TextUtils.isEmpty(paramErrMsg.getMessage())))
    {
