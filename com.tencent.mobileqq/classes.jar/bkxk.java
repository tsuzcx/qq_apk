  ...
  implements GLSurfaceView.Renderer
{
  ...
  private int b;
  private int c = biho.jdField_a_of_type_Int;
  private int d;
  private int e;
  ...
  public Bitmap a(Bitmap paramBitmap, long paramLong)
  {
    ...
    if (localQQFilterRenderManager != null)
    {
      ...
      this.jdField_a_of_type_Blab = new blab(localQQFilterRenderManager.getBusinessOperation().getCurrentAVFilterIdList(), localMusicItemInfo, this.d, this.e, null);
      this.jdField_a_of_type_Blab.a(true);
      if ((this.jdField_a_of_type_Blab == null) || (localObject == null)) {
        break label210;
      }
    }
    for (;;)
    {
      try
      {
        paramBitmap = vzo.a(paramBitmap, 1.0F, -1.0F);
        ((GPUBaseFilter)localObject).init();
        this.jdField_a_of_type_Blab.a(this.d, this.e);
      ...
      try
      {
        ...
        localObject = vzo.a(paramBitmap, 1.0F, -1.0F);
  ...
  public Bitmap a(Bitmap paramBitmap, GPUBaseFilter paramGPUBaseFilter)
  {
    ...
    if ((this.jdField_a_of_type_Blab != null) && (this.jdField_a_of_type_Blab.jdField_a_of_type_Boolean)) {}
    for (int i = 30;; i = 2)
    {
      int j = 0;
      while (j < i)
  ...
  public Bitmap a(Bitmap paramBitmap, List<FilterDesc> paramList, bkxk parambkxk)
  {
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter = parambkxk.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter;
    this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = parambkxk.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager;
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null) && (this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter != null) && (paramList != null))
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
      int i = 5;
      if (parambkxk.jdField_a_of_type_Boolean)
      {
        parambkxk.jdField_a_of_type_Boolean = false;
        i = 20;
      }
      int j = 0;
      while (j < i)
      ...
      return vzo.a(paramBitmap, 1.0F, -1.0F);
    }
    return null;
  }
  ...
  {
    GPUBaseFilter localGPUBaseFilter = bkxj.a(0);
    this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = biho.a();
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null) && (localGPUBaseFilter != null) && (paramList != null))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.getBusinessOperation().setFilterEffectList(paramList);
      return vzo.a(a(paramBitmap, localGPUBaseFilter), 1.0F, -1.0F);
    }
    return null;
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null)
    {
      ...
      this.c = biho.jdField_a_of_type_Int;
    }
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 17) {
      this.jdField_a_of_type_Avyw = new avyw(EGL14.EGL_NO_CONTEXT, 1);
    }
    d(paramInt1, paramInt2);
  }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter = bkxj.a(0);
    this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = biho.b();
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    for (Object localObject = this.jdField_a_of_type_AndroidGraphicsBitmap;; localObject = paramGL10)
    {
      ...
      if (this.jdField_a_of_type_Blab != null) {
        this.b = this.jdField_a_of_type_Blab.a(this.d, this.e, this.b, this.jdField_a_of_type_Long);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null)
      {
