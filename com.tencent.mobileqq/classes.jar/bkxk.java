  ...
  implements KingCardProxy
{
  ...
  public ImageView getCapsuleButtonMoreView(Context paramContext)
  {
    ...
    for (Object localObject = MiniAppGlobal.KINGCARD_GUIDE_TEXT;; localObject = paramContext.getResources().getString(2131693693))
    {
      ...
      ((DiniFlyAnimationView)localObject).setContentDescription(anzj.a(2131700265));
