  ...
  implements Manager
{
  ...
  public rmu(AppInterface paramAppInterface)
  {
  ...
  public static RefreshData b(Context paramContext, int paramInt)
  {
    ...
    {
      localObject = (rmu)((AppRuntime)localObject).getManager(QQManagerFactory.READ_INJOY_REFRESH_MANAGER);
      if (localObject != null) {
        return ((rmu)localObject).a(paramContext, paramInt);
      }
    }
    return null;
  }
  ...
  private void b(int paramInt1, String paramString, long paramLong, int paramInt2)
  {
    ...
    rns.a(this.jdField_a_of_type_JavaLangString, paramLong);
    paramInt1 = 0;
    while (paramInt1 < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ((rmw)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt1)).a(this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long);
      paramInt1 += 1;
    }
  }
  ...
  public RefreshData a(Context paramContext, int paramInt)
  {
    ...
    paramContext = bhhr.a(paramContext, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramInt);
  ...
  public void a(rmw paramrmw)
  {
    ...
    {
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(paramrmw)) {
        this.jdField_a_of_type_JavaUtilArrayList.add(paramrmw);
      }
      return;
    }
  }
  ...
  public boolean a(RefreshData paramRefreshData, int paramInt1, int paramInt2)
  {
    ...
    String str = rns.a((String)localObject);
    if (rns.a((String)localObject)) {
      return true;
    }
    ...
    localObject = new bhyo(paramRefreshData.url, localFile);
    ((bhyo)localObject).jdField_b_of_type_Int = paramInt1;
    ((bhyo)localObject).d = 60L;
    ((bhyo)localObject).m = true;
    this.jdField_a_of_type_Bhyt.a((bhyo)localObject, new rmv(this, str, paramRefreshData, paramInt2), localBundle);
    return false;
  }
  
  public void b(rmw paramrmw)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramrmw);
      return;
    }
  }
