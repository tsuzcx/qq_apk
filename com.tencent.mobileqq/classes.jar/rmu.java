...
public class rmu
{
  ...
  private static long a(String paramString)
  {
    ...
    catch (Exception localException)
    {
      ...
      axrl.a(BaseApplicationImpl.getApplication()).a(null, "actKandianFastWebCost", false, 0L, 0L, localHashMap, null);
    }
    return -1L;
  }
  ...
  public static Map<String, String> a(Context paramContext)
  {
    ...
    HashMap localHashMap = new HashMap();
    Object localObject1 = rpu.a("native_article", true);
    if (localObject1 == null) {
      return localHashMap;
    }
    localObject1 = ((rpu)localObject1).getTemplate("ReadInjoy_article_text_cell");
    if (localObject1 == null) {
      return localHashMap;
    }
    ...
    try
    {
      ...
      int m = axli.a(paramContext);
      int n = axli.b(paramContext);
  ...
  public static void a(ArticleInfo paramArticleInfo, ProteusItemData paramProteusItemData, int paramInt, SparseArray<Float> paramSparseArray)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        return;
        float f1 = rmq.b(paramSparseArray);
        continue;
        f1 = rmq.c(paramSparseArray);
        continue;
        float f2 = -1000.0F;
        f1 = f2;
        switch (paramInt)
  ...
  public static void a(ArticleInfo paramArticleInfo, rss paramrss)
  {
    if (paramArticleInfo == null) {
      return;
    }
    QLog.d("FastWebRequestUtil", 2, "deleteFeeds.");
    ThreadManager.excute(new FastWebRequestUtil.6(paramArticleInfo, paramrss), 128, null, true);
  }
  ...
  public static void a(String paramString, FastWebArticleInfo paramFastWebArticleInfo)
  {
    ...
    try
    {
      ...
      nam.a(localBundle);
      paramString = new String(nam.a(BaseApplicationImpl.getContext(), "https://c.mp.qq.com/review/img-txt-comment/list?source=1", "POST", paramString, localBundle));
    }
  ...
  private static void a(String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean, String paramString5, String paramString6, String paramString7, int paramInt, rmz paramrmz)
  {
    ThreadManager.executeOnNetWorkThread(new FastWebRequestUtil.4(paramString1, paramString2, paramString3, paramString4, paramString6, paramString7, paramBoolean, paramInt, paramString5, paramrmz));
  }
  
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean, String paramString5, String paramString6, String paramString7, rmy paramrmy, int paramInt)
  {
    paramrmy = new rmx(paramString1, paramrmy);
    a(paramString1, paramString2, paramString3, new rmv(paramrmy));
    a(paramString1, paramString2, paramString3, paramString4, paramBoolean, paramString5, paramString6, paramString7, paramInt, new rmw(paramrmy));
  }
  
  private static void a(String paramString1, String paramString2, String paramString3, rmz paramrmz)
  {
    ThreadManager.executeOnNetWorkThread(new FastWebRequestUtil.3(paramString3, paramString1, paramString2, paramrmz));
  }
  ...
  private static String b(Map<String, String> paramMap, JSONObject paramJSONObject)
  {
    try
    {
      ...
      paramMap = ((QQAppInterface)onk.a()).getAccount();
      if (QLog.isColorLevel()) {
      ...
      paramMap = nam.a(BaseApplicationImpl.getContext(), paramJSONObject, "GET", null, paramMap);
      if (paramMap == null)
      {
      ...
      try
      {
        ...
        if (i < localJSONArray.length())
        {
          ...
          try
          {
            ...
            if (localObject1 != null)
            {
              localObject1 = ((rpu)localObject1).getTemplateBean(localJSONObject);
              if (localObject1 != null)
              {
  ...
  private static Map<String, String> b(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (str == null) {}
    for (paramString1 = "";; paramString1 = qke.a(str))
    {
      ((Map)localObject).put("token", paramString1);
      ((Map)localObject).put("cookie", nmf.a());
  ...
  private static JSONObject b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject1 = new yyt();
        ((yyt)localObject1).jdField_a_of_type_JavaLangString = "ce2d9f";
        ...
        if (localObject1 != null)
        {
          ...
          localJSONObject.put("carrier", yyv.a(BaseApplicationImpl.getContext()));
          ...
          if (localObject1 != null)
          {
            ...
            localObject2 = "";
            localJSONObject.put("muid", localObject2);
            localJSONObject.put("bytes_wx_ver", oai.a(BaseApplication.getContext()));
            if (QLog.isColorLevel()) {
  ...
  public static void b(ArticleInfo paramArticleInfo, rss paramrss)
  {
    if (paramArticleInfo == null) {
      return;
    }
    QLog.d("FastWebRequestUtil", 2, "shieldFeedSource");
    ThreadManager.excute(new FastWebRequestUtil.7(paramArticleInfo, paramrss), 128, null, true);
  }
  ...
  private static boolean b(String paramString1, String paramString2, List<BaseData> paramList, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        nmf.a(((JSONObject)localObject1).optString("cookie"));
        ...
        if (((JSONObject)localObject2).isNull("ad_pos_type"))
        {
          ...
          localObject2 = a(oas.a((JSONObject)localObject2, paramJSONObject), 1, false, str, j);
          oau.a((AdData)localObject2);
          if (localObject2 != null)
          {
        ...
        else
        {
          ...
          {
            ((JSONObject)localObject2).put("rowkey", paramString2);
            localObject2 = a(oas.a((JSONObject)localObject2, paramJSONObject), 1, true, str, -1);
            oau.a((AdData)localObject2);
            if (localObject2 == null) {
              break label322;
            }
      ...
      {
        ((JSONObject)localObject2).put("rowkey", paramString2);
        localObject2 = a(oas.a((JSONObject)localObject2, paramJSONObject), 2, false, str, -1);
        if (localObject2 != null)
        {
