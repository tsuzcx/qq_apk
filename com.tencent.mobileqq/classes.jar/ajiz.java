...
class ajiz
  extends blfn
{
  ajiz(ajiy paramajiy, int paramInt1, int paramInt2, int[] paramArrayOfInt1, int paramInt3, int[] paramArrayOfInt2, int[] paramArrayOfInt3, int[] paramArrayOfInt4)
  {
  ...
  {
    this.a.a(paramInt, paramArrayOfblfm);
  }
}
