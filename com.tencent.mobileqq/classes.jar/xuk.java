  ...
  implements xtg
{
  ...
  public String a;
  xth jdField_a_of_type_Xth;
  xti jdField_a_of_type_Xti;
  public xtj a;
  public xtk a;
  public xtl a;
  ...
  public xuk(Context paramContext, String paramString)
  {
    ...
    yuk.d(this.jdField_a_of_type_JavaLangString, "TVK info, sdk:%s", new Object[] { TVK_SDKMgr.getSdkVersion() });
  }
  
  public static TVK_PlayerVideoInfo a(String paramString1, String paramString2, String paramString3)
  {
    return xts.a(paramString1, paramString2, paramString3);
  }
  ...
  private void a(TVK_PlayerVideoInfo paramTVK_PlayerVideoInfo)
  {
    ...
    {
      paramTVK_PlayerVideoInfo.setConfigMap("ff_probesize", String.valueOf(bnrf.b()));
      paramTVK_PlayerVideoInfo.setConfigMap("is_ff_probelist_switch", String.valueOf(bnrf.q()));
      paramTVK_PlayerVideoInfo.setConfigMap("is_download_async_io", String.valueOf(bnrf.r()));
      paramTVK_PlayerVideoInfo.setConfigMap("httpbuffertime_for_playpreload", String.valueOf(bnrf.f()));
      paramTVK_PlayerVideoInfo.setConfigMap("dynamic_buffer_switch", String.valueOf(bnrf.g()));
      paramTVK_PlayerVideoInfo.setConfigMap("dynamic_buffer_config_json", String.valueOf(bnrf.c()));
    }
  }
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnCompletionListener(new xum(this));
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnErrorListener(new xun(this));
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnInfoListener(new xuo(this));
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoPreparedListener(new xup(this));
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnDownloadCallback(new xuq(this));
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoOutputFrameListener(new xur(this));
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnSeekCompleteListener(new xus(this));
  }
  ...
  public void a()
  {
    yuk.d(this.jdField_a_of_type_JavaLangString, "stopPlayback, %s", new Object[] { this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer });
    if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null)
    {
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Xtt.jdField_a_of_type_JavaLangString != null) {
      yuk.a(this.jdField_a_of_type_JavaLangString, "%s", this.jdField_a_of_type_Xtt);
    }
    this.jdField_a_of_type_Xtt.a();
    this.jdField_a_of_type_Xtt.jdField_a_of_type_JavaLangString = paramString1;
    Object localObject1 = this.jdField_a_of_type_Xtt;
    if (paramString3 == null) {}
    Object localObject2;
    for (boolean bool = true;; bool = false)
    {
      ((xtt)localObject1).jdField_a_of_type_Boolean = bool;
      if ((paramString2 != null) && (paramString3 != null))
      {
        this.jdField_c_of_type_Int = xlo.a(new xlu(paramString1, paramString3, paramString2, "TVKsetVideoPath"));
        yuk.d(this.jdField_a_of_type_JavaLangString, "setVideoPath, vid=%s, cache=%d", new Object[] { paramString1, Integer.valueOf(this.jdField_c_of_type_Int) });
      }
      localObject1 = (wjt)wth.a(28);
      this.jdField_b_of_type_JavaLangString = paramString1;
      localObject2 = wkq.a(paramString1, 0);
      this.jdField_c_of_type_JavaLangString = paramString2;
      this.d = paramString3;
      if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null) {
        f();
      }
      paramString3 = xiz.a(paramInt2);
      ...
      if (!wkr.a((File)localObject2)) {
        break;
      }
      paramString3.jdField_a_of_type_Long = SystemClock.uptimeMillis();
      paramString3.jdField_a_of_type_Int = 1;
      yuk.d(this.jdField_a_of_type_JavaLangString, "TVK_IMediaPlayer.openMediaPlayerByUrl, 4, vid=%s", new Object[] { paramString1 });
    ...
    {
      paramString4 = (wjn)wth.a(4);
      localObject2 = paramString4.b();
      if (localObject2 != null)
      {
        this.d = blhn.a(this.d, "authkey", (String)localObject2);
        paramString3.jdField_a_of_type_Long = SystemClock.uptimeMillis();
        paramString3 = ((wjt)localObject1).a(this.d.replace("https://", "http://"));
        yuk.d(this.jdField_a_of_type_JavaLangString, "TVK_IMediaPlayer.openMediaPlayerByUrl, 3, vid=%s, urls=%s", new Object[] { paramString1, Arrays.toString(paramString3) });
      ...
      Bosses.get().postJob(new xul(this, this.jdField_a_of_type_JavaLangString, paramString4, paramString3, (wjt)localObject1, paramString1, paramString2));
      return;
    }
    paramString3.jdField_a_of_type_Long = SystemClock.uptimeMillis();
    xlo.a();
    paramString3 = ((wjt)localObject1).a(this.d.replace("https://", "http://"));
    yuk.d(this.jdField_a_of_type_JavaLangString, "TVK_IMediaPlayer.openMediaPlayerByUrl, 2, vid=%s, urls=%s", new Object[] { paramString1, Arrays.toString(paramString3) });
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.openMediaPlayerByUrl(this.jdField_a_of_type_AndroidContentContext, paramString3, 0L, 0L, paramString2, null);
    this.jdField_b_of_type_Int = 1;
  }
  
  public void a(xth paramxth)
  {
    this.jdField_a_of_type_Xth = paramxth;
  }
  
  public void a(xti paramxti)
  {
    this.jdField_a_of_type_Xti = paramxti;
  }
  
  public void a(xtj paramxtj)
  {
    this.jdField_a_of_type_Xtj = paramxtj;
  }
  
  public void a(xtk paramxtk)
  {
    this.jdField_a_of_type_Xtk = paramxtk;
  }
  
  public void a(xtl paramxtl)
  {
    this.jdField_a_of_type_Xtl = paramxtl;
  }
  ...
  public void b()
  {
    yuk.d(this.jdField_a_of_type_JavaLangString, "start, %s", new Object[] { this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer });
    if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null) {
  ...
  public void c()
  {
    yuk.d(this.jdField_a_of_type_JavaLangString, "pause, %s", new Object[] { this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer });
    if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null) {
  ...
  public void d()
  {
    yuk.d(this.jdField_a_of_type_JavaLangString, "restart, %s", new Object[] { this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer });
    if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null)
    {
