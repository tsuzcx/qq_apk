  ...
  implements bdku
{
  ...
  public static bdku a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.qqmini.sdk.ipc.IAppMainService");
    if ((localIInterface != null) && ((localIInterface instanceof bdku))) {
      return (bdku)localIInterface;
    }
    return new bdkw(paramIBinder);
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    case 5: 
      ...
      {
        a((String)localObject2, str, (Bundle)localObject1, bdla.a(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      }
    }
