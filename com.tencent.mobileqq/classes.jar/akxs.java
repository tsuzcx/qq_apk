  ...
  implements Manager
{
  ...
  public akxs(QQAppInterface paramQQAppInterface) {}
  ...
  private QWalletPubAdReport.TerminalInfor a(Context paramContext)
  {
    ...
    localTerminalInfor.qq_version.set("8.4.5");
  ...
  private void a(acoh paramacoh)
  {
    ...
    } while (paramacoh.a().jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp.ret.get() == 0);
    QLog.i("QWalletGdtAdManager", 2, "reqAds onResponse ret fail,loader.getSession().response.ret.get " + paramacoh.a().jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp.ret.get());
  }
  
  private void a(Context paramContext, String paramString, int paramInt, acoi paramacoi)
  {
    acoj localacoj = new acoj();
    localacoj.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet = a(BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin(), paramString, paramInt);
    new acoh(localacoj, new WeakReference(paramacoi)).a(new WeakReference(paramContext));
    if (QLog.isColorLevel()) {
  ...
  private void a(BaseActivity paramBaseActivity)
  {
    ...
    bmrq.a(localQQAppInterface, "tenpay.com", new akxu(this, paramBaseActivity, localQQAppInterface, NetConnInfoCenter.getServerTimeMillis()));
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    bdll.b(localQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", paramString1, 0, 0, paramString2, paramString3, paramString4, paramString5);
  }
  ...
  public static void a(im_msg_body.GeneralFlags paramGeneralFlags, MessageForStructing paramMessageForStructing)
  {
    if ((paramGeneralFlags != null) && (paramGeneralFlags.bytes_pb_reserve.has())) {
      try
      {
        ...
        while (((Iterator)localObject).hasNext()) {
          if (((bdol)((Iterator)localObject).next() instanceof bdsb))
          {
    ...
    Object localObject = bdov.a(0);
    ((bdom)localObject).a(new bdqq());
    ((bdom)localObject).a = paramMessageForStructing.structingMsg;
    paramGeneralFlags.add(localObject);
    localObject = bdov.a(31);
    ((bdom)localObject).a = paramMessageForStructing.structingMsg;
    paramGeneralFlags.add(localObject);
  ...
  {
    paramBaseChatPie = new akxt(this, NetConnInfoCenter.getServerTimeMillis(), paramBaseChatPie);
    this.jdField_a_of_type_Acoi = paramBaseChatPie;
  ...
  public void a()
  {
    Iterator localIterator = bdsb.b.iterator();
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Acoi = null;
    paramContext = bdsb.b.iterator();
  ...
  public void a(Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bmrq.a(localQQAppInterface, "tenpay.com", new akxw(this, paramInt, paramContext, localQQAppInterface, l));
        return;
      }
  ...
  public void a(BaseActivity paramBaseActivity, BaseChatPie paramBaseChatPie)
  {
    ...
    {
      localObject = (alao)paramBaseActivity.app.getManager(245);
      i1 = ((alao)localObject).a("common", 1, new String[] { "pub_ad_control", "gdt_day_freq" });
      n = ((alao)localObject).a("common", 4, new String[] { "pub_ad_control", "gdt_week_freq" });
    }
    int i2 = 0;
    int i5 = 0;
    int i4 = 0;
  ...
  public void a(List<ChatMessage> paramList)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("QWalletGdtAdManager", 2, "list,time:" + bhsw.b(localChatMessage.time * 1000L) + ",isShowQWalletPubAd:" + localChatMessage.isShowQWalletPubAd);
      }
      i -= 1;
      break label22;
      break;
  ...
  public boolean a()
  {
    ...
    if (((alao)localQQAppInterface.getManager(245)).a("common", 0, new String[] { "pub_ad_control", "gdt_switch" }) == 0) {}
