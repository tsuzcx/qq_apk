  ...
  implements akwv
{
  ...
  public akxs(akxr paramakxr, akwy paramakwy, akxx paramakxx, akxy paramakxy)
  {
    this.jdField_a_of_type_Akxr = paramakxr;
    this.jdField_a_of_type_Akwy = paramakwy;
    this.jdField_a_of_type_Akxx = paramakxx;
    this.jdField_a_of_type_Akxy = paramakxy;
  }
  
  private boolean a(int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Akxr == null) {}
    while (this.jdField_a_of_type_Akxy.a(paramInt1, paramInt2) == null) {
      return false;
    }
    return true;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    try
    {
      ...
      localObject = this.jdField_a_of_type_Akxy.a(100);
      if (localObject == null)
      {
        QLog.w("CmShow_SpriteDrawerInfoBridge", 1, "actionScript == null.");
        return;
      }
      ((akxp)localObject).a(localStringBuilder.toString());
      this.jdField_a_of_type_Akwy.a(paramInt2);
      return;
    }
  ...
  public void a(akxr paramakxr, int paramInt, akxj paramakxj, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.d("CmShow_SpriteDrawerInfoBridge", 2, "[initSprite]");
    }
    alda.a(paramakxr.a());
    alda.a(paramakxr.a(), 300);
    if ((this.jdField_a_of_type_Akxx == null) || (paramakxr == null) || (!paramakxr.a())) {
      if (paramakxr != null) {
        alda.a(paramakxr.a(), 300, 160, new Object[] { "glview is not ready" });
      }
    }
    do
    {
      ...
      if (paramakxr.jdField_e_of_type_Int == 1) {
        ThreadManager.getUIHandler().post(new CmShowSpriteDrawerInfoBridge.5(this, paramakxr));
      }
    } while (paramakxr == null);
    alda.a(paramakxr.a(), 300, 200, new Object[] { "script no exit" });
    return;
    Bundle localBundle = new Bundle();
    IPCSpriteContext localIPCSpriteContext = paramakxr.a();
    if (paramBundle != null)
    {
      ...
      if (!TextUtils.isEmpty(paramakxr.jdField_b_of_type_JavaLangString)) {
        this.jdField_a_of_type_JavaUtilHashMap.put(paramakxr.jdField_b_of_type_JavaLangString, Integer.valueOf(localIPCSpriteContext.d));
      }
      if (!TextUtils.isEmpty(paramakxr.jdField_a_of_type_JavaLangString)) {
        this.jdField_a_of_type_JavaUtilHashMap.put(paramakxr.jdField_a_of_type_JavaLangString, Integer.valueOf(localIPCSpriteContext.jdField_e_of_type_Int));
      }
    }
    localBundle.putParcelable("IPCSpriteContext", localIPCSpriteContext);
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_render_view_get_initavatar_js", localBundle, new akxv(this, paramakxj, paramInt, paramakxr));
  }
  
  public void a(akxr paramakxr, CmShowRenderView.PlayActionConfig paramPlayActionConfig)
  {
    int i = 1;
    if ((paramakxr == null) || (paramPlayActionConfig == null)) {
      return;
    }
    long l = System.currentTimeMillis();
    Object localObject1 = akxe.a(paramPlayActionConfig);
    if (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      ...
      if ((!TextUtils.isEmpty(paramakxr.jdField_b_of_type_JavaLangString)) && (!paramakxr.jdField_b_of_type_JavaLangString.equals(paramPlayActionConfig.jdField_a_of_type_JavaLangString)))
      {
        ((SpriteTaskParam)localObject2).jdField_b_of_type_JavaLangString = paramakxr.jdField_b_of_type_JavaLangString;
        ((SpriteTaskParam)localObject2).jdField_a_of_type_JavaLangString = paramakxr.jdField_a_of_type_JavaLangString;
      ...
      for (;;)
      {
        ...
        ((SpriteTaskParam)localObject2).jdField_a_of_type_Akwv = this;
        ...
        return;
        ((SpriteTaskParam)localObject2).jdField_b_of_type_JavaLangString = paramakxr.jdField_a_of_type_JavaLangString;
        ((SpriteTaskParam)localObject2).jdField_a_of_type_JavaLangString = paramakxr.jdField_b_of_type_JavaLangString;
        break;
        label222:
        i = 0;
      }
    ...
    Object localObject2 = paramakxr.a();
    if ((!TextUtils.isEmpty(paramakxr.jdField_b_of_type_JavaLangString)) && (!paramakxr.jdField_b_of_type_JavaLangString.equals(paramPlayActionConfig.jdField_a_of_type_JavaLangString)))
    {
    ...
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_render_view_play_action", (Bundle)localObject1, new akxt(this, l, paramPlayActionConfig));
  }
  
  public void a(akxr paramakxr, String paramString1, String paramString2)
  {
    if (QLog.isColorLevel()) {
      QLog.d("CmShow_SpriteDrawerInfoBridge", 2, "[initSprite]");
    }
    ...
    } while (paramakxr.jdField_e_of_type_Int != 1);
    ThreadManager.getUIHandler().post(new CmShowSpriteDrawerInfoBridge.3(this, paramakxr));
    return;
    Bundle localBundle = new Bundle();
    IPCSpriteContext localIPCSpriteContext = paramakxr.a();
    ...
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_render_view_get_initavatar_js", localBundle, new akxu(this, paramakxr));
  }
  ...
  public void a(String paramString)
  {
    try
    {
      ...
      ((akxp)localObject).a(paramString.toString());
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == 1)
        {
          ...
          localObject2 = this.jdField_a_of_type_Akxy.a(100);
          if (localObject2 == null)
          {
            QLog.w("CmShow_SpriteDrawerInfoBridge", 1, "actionScript == null.");
            return;
          }
          ((akxp)localObject2).a(((StringBuilder)localObject1).toString());
          akxe.a(paramString, paramInt);
          return;
        }
      }
      catch (Throwable paramString)
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("text", akwt.a(bdbi.encodeToString(paramString2.getBytes("utf-8"), 0)));
        localJSONObject.put("direction", paramInt1);
        paramString1 = "";
        if (paramInt2 != 1) {
          break label408;
        }
        Object localObject = akwm.a(paramString2, 1);
        if (QLog.isColorLevel()) {
        ...
        if (TextUtils.isEmpty(paramString1))
        {
          ...
          localObject = akwm.a(paramString2, 0, 1);
        }
        ...
        if (paramInt2 == 1)
        {
          localObject = akwm.a(paramString2, 2);
          if (QLog.isColorLevel()) {
          ...
          if (localObject != null)
          {
            ...
            localObject = paramString1;
            if (TextUtils.isEmpty(paramString1)) {
              localObject = akwm.a(paramString2, 0, 2);
            }
            ...
            paramString2 = this.jdField_a_of_type_Akxy.a(100);
  ...
  public void a(List<String> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((akxp)localObject).a(paramList.toString());
      return;
      label172:
      if (paramBoolean) {
        i = 1;
  ...
  {
    if ((paramSpriteTaskParam == null) || (this.jdField_a_of_type_Akxx == null) || (this.jdField_a_of_type_Akxr == null) || (!this.jdField_a_of_type_Akxr.a())) {
      return;
    }
    Object localObject1 = this.jdField_a_of_type_Akxx;
    akxx.a(paramSpriteTaskParam);
    localObject1 = "";
    ...
    Object localObject3 = this.jdField_a_of_type_Akxy.a(paramSpriteTaskParam.jdField_c_of_type_Int);
    Object localObject2 = localObject3;
    if (localObject3 == null)
    {
      QLog.i("CmShow_SpriteDrawerInfoBridge", 1, "playAction CmShow_ get sdk basic script");
      localObject3 = this.jdField_a_of_type_Akxy.a(100);
    ...
    {
      albu.a((QQAppInterface)localObject1, paramSpriteTaskParam, bool, paramSpriteTaskParam.jdField_b_of_type_Boolean);
      return;
    }
  }
}
