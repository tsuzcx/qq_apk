...
public class bdoy
{
  ...
  {
    bdot.a("WadlJsBridgeCall", 2, "dispatch wadlParams:" + paramWadlParams);
    ...
    case 2: 
    case 12: 
      bicp.a().a(paramWadlParams);
      return;
    case 3: 
    case 10: 
      bicp.a().a(paramWadlParams.d, paramWadlParams.jdField_a_of_type_JavaLangString);
      return;
    case 4: 
      bicp.a().b(paramWadlParams.d, paramWadlParams.jdField_a_of_type_JavaLangString);
      return;
    }
  ...
  {
    bdot.b("WadlJsBridgeCall", "doDownloadAction params:" + paramString1 + ",fromWeb:" + paramBoolean + ",from:" + paramInt + ",weburl:" + paramString2);
    ...
    try
    {
      ...
      {
        yoa.c(paramString2, "DELAY_LIST");
        yoa.a(paramString2, paramString1, "DELAY_APPID_DETAIL_");
        ynw.a();
        return 0;
      }
      if (!localWadlParams.jdField_b_of_type_Boolean)
      {
        yoa.b(paramString2, "DELAY_LIST");
        yoa.d(paramString2, "DELAY_APPID_DETAIL_");
      }
      if (localWadlParams.jdField_b_of_type_Boolean)
      {
        if (a(localWadlParams.g))
        {
          bdot.b("WadlJsBridgeCall", "##@Operation for wadlParams.resName:" + localWadlParams.g + " is not returned! The opertion of action: " + paramInt + " is ignored!");
          return 1;
        }
        a(localWadlParams.g);
      }
      ...
      {
        yoa.a(null, "558", "202982", paramString2, "55801", "4", "430");
        bdot.b("WadlJsBridgeCall", "invalid url:" + localWadlParams);
        return -1;
        if (a(paramString2))
        {
          bdot.b("WadlJsBridgeCall", "##@Operation for appid:" + paramString2 + " is not returned! The opertion of action: " + paramInt + " is ignored!");
          return 1;
        }
        a(paramString2);
      }
    ...
    {
      bdot.a("WadlJsBridgeCall", "doDownloadAction:", paramString1);
      return -1;
    }
    return 0;
  }
  ...
  public void a()
  {
    ...
    {
      bdot.a("WadlJsBridgeCall", "getQueryAllTask()>>>", localException);
    }
  }
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      bicp.a().c(paramInt, paramString1);
      return;
    }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      bdot.a("WadlJsBridgeCall", "getQueryDownloadAction(String,String)>>>", paramString1);
    }
  }
  
  public void a(String paramString, boolean paramBoolean, int paramInt)
  {
    bdot.b("WadlJsBridgeCall", "startDownload delay task" + paramString + " ," + paramBoolean + "," + paramInt + ",isWiFi=" + AppNetConnInfo.isWifiConn());
    if (1 == paramInt) {
  ...
  public void d(String paramString)
  {
    ...
    {
      bdot.a("WadlJsBridgeCall", "query getQueryDownloadAction>>>", paramString);
    }
  }
  ...
  public void e(String paramString)
  {
    ...
    {
      bdot.a("WadlJsBridgeCall", "query getQueryDownloadActionByVia>>>", paramString);
    }
  }
}
