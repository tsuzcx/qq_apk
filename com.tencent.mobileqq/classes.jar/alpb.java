...
public final class alpb
{
  ...
  public static int a(Activity paramActivity, QQAppInterface paramQQAppInterface, RecentUser paramRecentUser, String paramString, boolean paramBoolean, int paramInt, RecentBaseData paramRecentBaseData, Bundle paramBundle, Intent[] paramArrayOfIntent)
  {
    ...
    for (paramInt = 2;; paramInt = 0)
    {
      ...
      {
        paramString = (abur)paramQQAppInterface.a(51);
      ...
      if (paramRecentUser.getType() == 10005)
      {
        ...
        avxx.a().a(paramActivity, paramQQAppInterface, paramRecentUser.uin, paramRecentUser.getType());
        i = j;
        break;
      }
      ...
      if (paramRecentUser.getType() == 8114)
      {
        ...
        bdll.b(paramQQAppInterface, "dc00898", "", "", "0X8009F4C", "0X8009F4C", 0, 0, "", "", "", "");
        i = j;
        break;
      }
  ...
  public static int a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2, boolean paramBoolean, Bundle paramBundle, Intent[] paramArrayOfIntent)
  {
    ...
    {
      if ((paramInt != 1024) && (!nok.c(paramQQAppInterface, paramString1))) {
        break label289;
      }
      bhsq.a(null, "Recent_clk_enterchat_cmr");
      bdll.b(paramQQAppInterface, "CliOper", "", "", "Biz_card", "Biz_card_talk", 0, 0, paramString1, "0", "", "");
      bhsq.a("Recent_clk_enterchat_cmr", null);
      i = 0;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        do
        {
          do
          {
            ...
            bhsq.a(null, "Recent_clk_enterchat_troop");
          } while (a(paramQQAppInterface, paramString1, 0, paramBundle));
          i = 1;
          bhsq.a("Recent_clk_enterchat_troop", null);
          break;
          if (paramInt != 1008) {
            break label255;
          }
          bhsq.a(null, "Recent_clk_enterchat_pub");
        } while (a(paramContext, paramQQAppInterface, paramString1, 0, paramBundle));
        paramBoolean = false;
        bhsq.a("Recent_clk_enterchat_pub", null);
        i = 0;
        break;
        label255:
        if (paramInt != 9501) {
  ...
  private static Intent a(Context paramContext, Bundle paramBundle, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      if (jdField_a_of_type_Long != 0L)
      {
        ...
        paramContext = agej.a(paramIntent, new int[] { 1 });
      }
    }
  }
  ...
  {
    oidb_0x791.RedDotInfo localRedDotInfo = ((nlb)paramQQAppInterface.getManager(70)).a(46, false);
    ...
    for (;;)
    {
      try
      {
        ...
        nku.a(paramQQAppInterface, localRedDotInfo, 0, true);
      }
      ...
      paramRecentUser = anzj.a(2131712098);
      if (i > 0) {
        continue;
      }
      ...
      ((Intent)localObject).putExtra("title", paramQQAppInterface.getApp().getString(2131718668));
  ...
  private static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, RecentUser paramRecentUser, RecentBaseData paramRecentBaseData)
  {
    ...
    bdws.a(paramQQAppInterface, paramActivity, paramRecentBaseData);
    paramQQAppInterface.a().c(paramRecentUser.uin, paramRecentUser.getType());
    if (antf.x.equals(paramRecentUser.uin)) {}
    for (paramActivity = null;; paramActivity = paramRecentUser.uin)
    {
      bdll.b(paramQQAppInterface, "CliOper", "", paramActivity, "Bind_account", "Clk_bind_account", 0, 0, "", "", "", "");
      bdll.b(paramQQAppInterface, "CliOper", "", "", "0X800713E", "0X800713E", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      while (!((Iterator)localObject).hasNext())
      {
        ...
        localnwo = nwo.a();
        localObject = localnwo.a(paramString);
        if (localObject != null)
        {
          a(paramContext, paramQQAppInterface, paramString, paramInt, (nwf)localObject);
          return;
        }
        if (QLog.isColorLevel()) {
      ...
      localnwf = nwy.a(paramQQAppInterface, (MessageRecord)((Iterator)localObject).next(), true);
    } while (localnwf == null);
    localnwo.a(localnwf);
    a(paramContext, paramQQAppInterface, paramString, paramInt, localnwf);
  }
  
  private static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, int paramInt, nwf paramnwf)
  {
    ...
    ThreadManager.post(new RecentUtil.7(paramQQAppInterface, paramString, paramInt, paramnwf), 5, null, false);
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, int paramInt, String paramString3, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        l = jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time;
        break;
        localIntent = agej.a(new Intent(paramContext, SplashActivity.class), new int[] { 1 });
        continue;
      }
      paramContext.startActivity(localIntent);
      return;
  ...
  {
    avme.b(paramActivity);
    paramQQAppInterface.a().a("2747277822", 1008, false);
    b(paramQQAppInterface, "2747277822", 1008);
    int i;
    if (avld.a())
    {
      paramActivity = (avld)paramQQAppInterface.getManager(358);
      if (paramActivity.jdField_a_of_type_Boolean)
      {
    ...
    for (;;)
    {
      ...
      {
        avlf.a(paramQQAppInterface, "1", "145", "920", "92003", "206346", paramActivity, i + "", "0", "20", "0", "", "");
        return;
      }
      label139:
      i = -1;
  ...
  private static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, RecentBaseData paramRecentBaseData)
  {
    ...
    localIntent.setFlags(67108864);
    bdll.b(paramQQAppInterface, "P_CliOper", "Shop_lifeservice", "", "Msglist", "Clk_ShopHelper", 0, 0, "", "", "", "");
    ...
    if (localoek != null)
    {
      localList = localoek.a();
      if (localList != null) {
        break label283;
      }
      i = 0;
      if (i == 0) {
        bdll.b(paramQQAppInterface, "P_CliOper", "Shop_lifeservice", "", "Shop_noMsglist", "Clk_ShopHelper", 0, 0, "", "", "", "");
      }
      j = localoek.a(paramQQAppInterface);
      if (j <= 0) {
        break label347;
      }
      j = 1;
    ...
    for (;;)
    {
      bdll.b(paramQQAppInterface, "dc00899", "Pb_account_lifeservice", "1", "0X80064CB", "0X80064CB", 0, 0, "" + j, "" + i, "", "");
      boolean bool;
      if (j != 0)
      {
        bool = true;
        ...
        i = -1;
        label245:
        localoek.a(localIntent, paramActivity, i);
        if (!TextUtils.isEmpty(str)) {
          localoek.b(paramQQAppInterface);
        }
        if (!TextUtils.isEmpty(str)) {
          break label308;
        }
  ...
  private static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, RecentUser paramRecentUser)
  {
    ...
    int i = bdzi.a().a(paramQQAppInterface);
    String str2;
    if (i > 0)
    {
      str2 = "0";
      str1 = "0";
      paramQQAppInterface.a().d(antf.W, 9000, -i);
      if (ajqx.a())
      {
        ajqx.a(false);
        ajqx.a();
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramActivity.startActivity(localIntent);
      bdll.b(paramQQAppInterface, "P_CliOper", "Grp_contacts", "", "notice", "Clk_notice", 0, 0, "", str1, str2, "");
      return;
      i = aoga.b(paramQQAppInterface);
      if (i > 0)
      {
        str1 = "0";
        str2 = "1";
  ...
  {
    tzq.a(paramQQAppInterface, paramActivity, paramRecentUser, paramInt, paramRecentBaseData);
    uae.a(null, "SERVICE_FOLDER_COST");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, RecentUser paramRecentUser)
  {
    ...
    for (;;)
    {
      bdll.b(paramQQAppInterface, "CliOper", "", "", "0X800419C", "0X800419C", 0, 0, "", "", "", "");
      bdll.b(paramQQAppInterface, "CliOper", "", "", "0X80041A0", "0X80041A0", 0, 0, "", "", "", "");
      return;
      if ((paramRecentUser.getType() == 7200) || (paramRecentUser.getType() == 1008))
      {
        bdll.b(paramQQAppInterface, "CliOper", "", "", "0X80041A1", "0X80041A1", 0, 0, "", "", "", "");
      ...
      {
        bdll.b(paramQQAppInterface, "CliOper", "", "", "0X800419F", "0X800419F", 0, 0, "", "", "", "");
      }
      else if (((paramRecentUser.getType() == 1001) || (paramRecentUser.getType() == 10002)) && (antf.H.equals(paramRecentUser.uin)))
      {
        bdll.b(paramQQAppInterface, "CliOper", "", "", "0X80041A2", "0X80041A2", 0, 0, "", "", "", "");
        bdll.b(paramQQAppInterface, "CliOper", "", "", "0X80050FD", "0X80050FD", 0, 0, "", "", "", "");
        bdll.b(paramQQAppInterface, "dc00899", "grp_lbs", "", "msg_box", "drag_msg", 0, 0, "", "", "", "");
      }
      else if ((paramRecentUser.getType() == 1010) && (antf.ab.equals(paramRecentUser.uin)))
      {
        bdll.b(paramQQAppInterface, "CliOper", "", "", "0X80050FF", "0X80050FF", 0, 0, "", "", "", "");
      }
      else if ((paramRecentUser.getType() == 1009) && (antf.w.equals(paramRecentUser.uin)))
      {
        bdll.b(paramQQAppInterface, "CliOper", "", "", "0X80041A4", "0X80041A4", 0, 0, "", "", "", "");
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, RecentUser paramRecentUser, int paramInt)
  {
    ...
    if (adak.b(paramRecentUser.uin, paramRecentUser.getType())) {
      if ((antf.ab.equals(paramRecentUser.uin)) || (antf.H.equals(paramRecentUser.uin)))
      {
    ...
    for (;;)
    {
      ...
      return;
      if ((1032 != paramRecentUser.getType()) || (!antf.aM.equals(paramRecentUser.uin))) {
        break;
      }
      paramQQAppInterface.a().b();
      aqyt.b(paramQQAppInterface, false);
      aqyt.a(paramQQAppInterface, false);
      break;
  ...
  private static void a(QQAppInterface paramQQAppInterface, RecentUser paramRecentUser, String paramString, int paramInt, RecentBaseData paramRecentBaseData)
  {
    ...
    {
      alol.a(paramQQAppInterface, paramRecentUser.uin, paramRecentBaseData.mUnreadFlag, paramRecentBaseData.getUnreadNum(), 1, paramString);
      if ((paramRecentUser.getType() == 7220) || (antf.aA.equalsIgnoreCase(paramRecentBaseData.getRecentUserUin())) || (antf.aP.equalsIgnoreCase(paramRecentBaseData.getRecentUserUin())) || ("2290230341".equalsIgnoreCase(paramRecentBaseData.getRecentUserUin()))) {
        alol.a.add(new aloq(paramRecentUser.uin, paramString, System.currentTimeMillis()));
      }
    }
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, RecentUser paramRecentUser, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (antf.D.equals(paramRecentUser.uin))
      {
        ((ajka)paramQQAppInterface.getManager(34)).f();
        return;
      }
      if (String.valueOf(9980L).equals(paramRecentUser.uin))
      {
        paramQQAppInterface.a().a().c();
        bdzi.a().a(paramQQAppInterface, 0);
        ((aoga)paramQQAppInterface.getManager(22)).b();
        return;
      }
  ...
  private static void a(QQAppInterface paramQQAppInterface, RecentUser paramRecentUser, boolean paramBoolean, int paramInt)
  {
    ...
    aean.a(paramQQAppInterface, localSessionInfo);
    ...
    for (;;)
    {
      ...
      if (paramBoolean1)
      {
        ...
        if (((SessionInfo)localObject).jdField_a_of_type_Int == 1006) {
          ((SessionInfo)localObject).f = bhlg.e(paramQQAppInterface, ((SessionInfo)localObject).jdField_a_of_type_JavaLangString);
        }
        aean.a(paramQQAppInterface, (SessionInfo)localObject);
      }
      if ((7000 == paramRecentUser.getType()) && (antf.x.equals(paramRecentUser.uin))) {
        bdwt.c(paramQQAppInterface);
      }
      paramQQAppInterface.a().a(paramRecentUser.uin, paramRecentUser.getType(), true, paramBoolean2);
      if (paramRecentUser.getType() == 1) {
        axug.a(paramQQAppInterface, paramRecentUser.uin);
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      bdll.b(paramQQAppInterface, "CliOper", "", "", paramString, paramString, 0, 0, "", "", "", "");
      return;
      label58:
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString, MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    {
      localObject = agkq.a(paramMessageRecord);
      if (localObject != null) {
    ...
    {
      ocd.a(paramQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_sys_3", "msg_aio", 0, 0, paramString, (String)localObject, String.valueOf(paramInt), "", false);
    ...
    {
      bdll.b(paramQQAppInterface, "dc00899", "Pb_account_lifeservice", "", "0X8007055", "0X8007055", 0, 0, "", "", "", tug.a(paramInt));
      return;
  ...
  public static void a(List<tua> paramList)
  {
  ...
  {
    boolean bool = false;
    if (((paramRecentUser.uin != null) && (paramRecentUser.uin.length() == 4)) || (antf.J.equals(paramRecentUser.uin)) || (TextUtils.equals(paramRecentUser.uin, antf.az)) || (TextUtils.equals(paramRecentUser.uin, antf.aP)) || (TextUtils.equals(paramRecentUser.uin, antf.aV)) || (TextUtils.equals(paramRecentUser.uin, antf.aQ)) || (TextUtils.equals(paramRecentUser.uin, antf.aR)) || (TextUtils.equals(paramRecentUser.uin, "2290230341")) || (TextUtils.equals(paramRecentUser.uin, "2747277822")) || (TextUtils.equals(paramRecentUser.uin, "3046055438")) || (TextUtils.equals(paramRecentUser.uin, antf.aW)) || (TextUtils.equals(paramRecentUser.uin, antf.aX)) || (TextUtils.equals(paramRecentUser.uin, ayvd.jdField_a_of_type_JavaLangString)) || (arhp.a().a(paramRecentUser.uin))) {}
    try
    {
  ...
  {
    Object localObject = ((aody)paramQQAppInterface.getManager(56)).c(String.valueOf(paramString));
    String str = null;
    paramInt = 0;
    if (localObject != null)
    {
    ...
    if (paramInt == 2)
    {
      bdll.b(paramQQAppInterface, "CliOper", "", "", "Biz_card", "Biz_card_talk", 0, 0, paramString, "0", "", "");
      paramIntent.putExtra("chat_subType", 1);
      paramIntent.setClass(paramContext, ChatActivity.class);
      return false;
    }
    localObject = paramQQAppInterface.a().a(paramString, 1008);
    paramInt = 0;
    if (localObject != null) {
      paramInt = paramQQAppInterface.a().a(paramString, ((MessageRecord)localObject).istroop);
    }
    a(paramQQAppInterface, paramString, (MessageRecord)localObject, paramInt);
    if ((ahnc.a(paramString)) && (ammh.a(paramContext, paramQQAppInterface))) {
      return true;
    }
    if ((bign.a(paramString)) && (bign.a(paramContext, paramQQAppInterface, str, 161))) {
      return true;
    }
  ...
  {
    achd.a(paramQQAppInterface, "Usr_AIO_Open", 2, 0, 0);
  ...
  {
    return arhp.a().a(paramRecentUser.uin, paramActivity, 1043, paramQQAppInterface);
  }
  ...
  {
    if (antf.H.equals(paramRecentUser.uin)) {
      c(paramQQAppInterface, paramActivity, paramRecentUser);
    }
    do
    {
      return true;
      if (antf.ab.equals(paramRecentUser.uin))
      {
        b(paramQQAppInterface, paramActivity, paramRecentUser);
        return true;
      }
      if (antf.ah.equals(paramRecentUser.uin))
      {
        k(paramQQAppInterface, paramActivity);
        return true;
      }
      if (antf.ai.equals(paramRecentUser.uin))
      {
        MsgBoxListActivity.a(paramActivity, 1010, antf.ab);
        return true;
      }
      if (antf.w.equals(paramRecentUser.uin))
      {
        MsgBoxListActivity.a(paramActivity, 1009, paramRecentUser.uin);
        return true;
      }
      if (antf.E.equals(paramRecentUser.uin))
      {
      ...
      if (antf.C.equals(paramRecentUser.uin))
      {
        h(paramQQAppInterface, paramActivity);
        return true;
      }
      if (antf.aK.equals(paramRecentUser.uin))
      {
        g(paramQQAppInterface, paramActivity);
        return true;
      }
      if (antf.J.equals(paramRecentUser.uin))
      {
      ...
      if (antf.ac.equals(paramRecentUser.uin))
      {
        f(paramQQAppInterface, paramActivity);
        return true;
      }
      if (TextUtils.equals(antf.az, paramRecentUser.uin))
      {
        b(paramQQAppInterface, paramActivity, paramRecentUser, paramRecentBaseData);
        return true;
      }
      if (antf.au.equals(paramRecentUser.uin))
      {
        e(paramQQAppInterface, paramActivity);
        return true;
      }
    } while (antf.U.equals(paramRecentUser.uin));
    if (antf.W.equals(paramRecentUser.uin))
    {
      a(paramQQAppInterface, paramActivity, paramRecentUser);
      return true;
    }
    if (antf.z.equals(paramRecentUser.uin))
    {
      d(paramQQAppInterface, paramActivity);
      return true;
    }
    if (antf.A.equals(paramRecentUser.uin))
    {
      c(paramQQAppInterface, paramActivity);
      return true;
    }
    if (antf.ad.equals(paramRecentUser.uin))
    {
      a(paramActivity, paramInt);
      return true;
    }
    if (antf.ae.equals(paramRecentUser.uin))
    {
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, Intent paramIntent)
  {
    ...
    {
      bdll.b(paramQQAppInterface, "CliOper", "", "", "Update_tips", "Upd_tips_appear", 0, -1, "", "", "", "");
      return false;
    }
    if (QLog.isColorLevel()) {
    ...
    if (Looper.myLooper() == Looper.getMainLooper()) {
      QQToast.a(BaseApplicationImpl.getContext(), 1, anzj.a(2131712103), 0).a();
    }
    return true;
  }
  ...
  {
    if (avld.a()) {
      ((avld)paramQQAppInterface.getManager(358)).a(0);
    }
  }
  ...
  private static void b(QQAppInterface paramQQAppInterface, Activity paramActivity, RecentUser paramRecentUser)
  {
    ...
    bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8004947", "0X8004947", 0, 0, "", "", "", "");
    bdll.b(paramQQAppInterface, "CliOper", "", "", "0X80050F6", "0X80050F6", 0, 0, "", "", "", "");
  }
  ...
  private static void b(QQAppInterface paramQQAppInterface, Activity paramActivity, RecentUser paramRecentUser, int paramInt, RecentBaseData paramRecentBaseData)
  {
    ...
    if (localObject != null)
    {
      ...
      ozs.a(paramQQAppInterface, localMessageRecord);
      str4 = ozs.a.b;
      str5 = ozs.a.jdField_a_of_type_JavaLangString;
      str6 = ozs.a.c;
    ...
    for (String str3 = String.valueOf(i);; str3 = "")
    {
      ...
      for (;;)
      {
        ...
        if (paramInt != 1)
        {
          ...
          localObject = "1";
          ocd.a(null, "CliOper", "", paramRecentUser, "0X80066F4", "0X80066F4", 0, 0, String.valueOf(i + 1), str6, str4, ozs.a(str5, str3, (String)localObject, str2, bool2), false);
          ocd.a("0X80066F4", paramRecentUser, String.valueOf(i + 1), "", str4, ozs.a(str5, str3));
          ozs.a(21, str6, str4, str5, paramRecentUser, -1);
        }
        if (paramRecentBaseData == null) {
          continue;
        }
        ...
        paramRecentUser = new StringBuilder().append("enter kandianMergeBox, brief : ").append(ozs.d(paramRecentUser)).append(",isUnRead : ");
        ...
        paramInt = 9;
        oix.a(paramQQAppInterface, paramActivity, paramInt, 0);
        uae.a(null, "KANDIAN_FEEDS_STAGE_1_COST");
        uae.a(null, "KANDIAN_FEEDS_COST");
        uae.a(null, "KANDIAN_NEW_FEEDS_ACTIVITY_MANAGER");
        return;
        i = -1;
        break;
        j = 0;
  ...
  private static void b(QQAppInterface paramQQAppInterface, Activity paramActivity, RecentUser paramRecentUser, RecentBaseData paramRecentBaseData)
  {
    ...
    {
      localObject = tzq.a(paramRecentUser.structingMsg.mMsgActionData);
      if (localObject == null) {}
    }
    for (;;)
    {
      ...
      try
      {
        ...
        if (l != -1L) {
          bdll.b(null, "CliOper", "", "", "0X80066F5", "0X80066F5", 0, 0, String.valueOf(i + 1), "", String.valueOf(l), "");
        }
        tzq.a(paramQQAppInterface, paramRecentUser, 1);
        label264:
        paramQQAppInterface = "";
      ...
      try
      {
        ...
        ocd.a(null, "CliOper", "", "", "0X80066F4", "0X80066F4", 0, 0, String.valueOf(i + 1), "", paramQQAppInterface, ozs.c(paramRecentUser), false);
        ocd.a("0X80066F4", "", String.valueOf(i + 1), "", paramQQAppInterface, ozs.c(paramRecentUser));
      }
      ...
      {
        l = -1L;
        oix.a(paramActivity, localArrayList, l, 5);
        return;
        l = -1L;
        continue;
        bdll.b(null, "CliOper", "", "", "0X80066F6", "0X80066F6", 0, 0, String.valueOf(i + 1), "", "", "");
      }
      else
      {
        label519:
  ...
  private static void b(QQAppInterface paramQQAppInterface, RecentUser paramRecentUser)
  {
    ...
    {
      localbgiw = (bgiw)paramQQAppInterface.getManager(363);
      if (paramRecentUser.uin == null) {
        break label416;
      }
    }
    label416:
    for (long l = localbgiw.a(paramRecentUser.uin);; l = 0L)
    {
      if (l != 0L) {
      ...
      {
        bdll.b(paramQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Clk_hongbaoSign", 0, 0, paramRecentUser.uin, "", "", "");
        bdll.b(paramQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Clk_sfsign", 0, 0, paramRecentUser.uin, "", "", "");
        paramQQAppInterface = ".troop.special_msg.special_attention";
      }
      for (;;)
      {
        if ((!TextUtils.isEmpty(paramQQAppInterface)) && (QLog.isColorLevel())) {
          QLog.d(alpb.class.getSimpleName() + paramQQAppInterface, 2, "onRecentUserClick, r.uin:" + paramRecentUser.uin);
        }
        return;
        bdll.b(paramQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Clk_sfsign", 0, 0, paramRecentUser.uin, "", "", "");
        break;
        ...
        {
          bdll.b(paramQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Clk_atsign", 0, 0, paramRecentUser.uin, "", "", "");
        ...
        else
        {
          if (paramRecentUser.msgType == 22)
          {
            ...
            {
              bdll.b(paramQQAppInterface, "P_CliOper", (String)localObject, "", "Msglist", "Clk_replySign", 0, 0, paramRecentUser.uin, "" + i, "", "");
              paramQQAppInterface = "";
              break;
            }
          }
          if (paramRecentUser.msgType == 16) {
            bdll.b(null, "dc00898", "", paramRecentUser.uin, "qq_vip", "0X800A907", 0, 1, 0, "", "", "", "");
          }
          paramQQAppInterface = "";
        }
      }
  ...
  private static void b(QQAppInterface paramQQAppInterface, RecentUser paramRecentUser, int paramInt)
  {
    ...
    if ((paramRecentUser.getType() == 9000) && (antf.W.equals(paramRecentUser.uin)))
    {
      paramQQAppInterface.a().a().c();
      bdzi.a().a(paramQQAppInterface, 0);
      ((aoga)paramQQAppInterface.getManager(22)).b();
    }
    if ((paramRecentUser.getType() == 7210) && (antf.ac.equals(paramRecentUser.uin)))
    {
      twk.a().e(paramQQAppInterface);
      twk.a().d(paramQQAppInterface);
      paramQQAppInterface.a(true, 0);
    }
    if ((paramRecentUser.getType() == 7230) && (antf.aB.equals(paramRecentUser.uin)))
    {
      tug localtug = tug.a();
      int i = localtug.b();
      int j = localtug.a(paramQQAppInterface);
      long l = localtug.a();
      if (paramInt != -1) {
        bdll.b(paramQQAppInterface, "dc01160", "Pb_account_lifeservice", "", "0X80067EB", "0X80067EB", 0, 0, "" + j, "" + i, String.valueOf(paramInt + 1), "" + l);
      }
      localtug.d(paramQQAppInterface);
      paramQQAppInterface.a(true, 0);
      if (QLog.isColorLevel()) {
    ...
    if (antf.ac.equals(paramRecentUser.uin))
    {
      bdll.b(paramQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X800572D", "0X800572D", 0, 0, "", "", "", "");
      bdll.b(paramQQAppInterface, "CliOper", "", "", "0X800623F", "0X800623F", 0, 0, "", "", "", "");
      tvz.c(paramQQAppInterface, false);
    }
    while (!antf.ae.equals(paramRecentUser.uin)) {
      return;
    }
    if (((oek)paramQQAppInterface.getManager(88)).a(paramQQAppInterface) > 0) {}
    for (paramRecentUser = "havereddot";; paramRecentUser = "noreddot")
    {
      bdll.b(paramQQAppInterface, "P_CliOper", "Shop_lifeservice", "", "Shop_DelMsglist", "Del_shopHelper", 0, 0, "", "", paramRecentUser, "");
      return;
    }
  }
  ...
  {
    if (TextUtils.equals(antf.aA, paramRecentUser.uin))
    {
    ...
    if (antf.aM.equals(paramRecentUser.uin))
    {
      ConfessMsgListFragment.a(paramActivity, 1);
      bdll.b(paramQQAppInterface, "dc00898", "", "", "0X8008F4C", "0X8008F4C", 0, 0, "", "", "", "");
      return true;
    }
    if (antf.aP.equals(paramRecentUser.uin))
    {
      ueg.a(paramActivity, "from_home_page", 1, true);
      return true;
    }
    if (antf.aV.equals(paramRecentUser.uin))
    {
      tzq.a(paramActivity, paramQQAppInterface);
      return true;
    }
    if (antf.aQ.equals(paramRecentUser.uin))
    {
    ...
    if (antf.aR.equals(paramRecentUser.uin))
    {
      a(paramQQAppInterface, paramActivity, paramRecentUser, paramInt);
      return true;
    }
    if ((antf.aX.equals(paramRecentUser.uin)) && (avmc.a()) && (bicz.b(paramActivity)))
    {
      bicz.a(paramActivity);
      paramQQAppInterface.a().a(antf.aX, 1008, false);
      return true;
    }
    if (("2747277822".equals(paramRecentUser.uin)) && (avmc.a()))
    {
    ...
    if (MiniGamePublicAccountHelper.shouldOpenWebFragment(paramRecentUser.uin))
    {
      ...
      paramQQAppInterface.a().a(antf.aW, 1008, false);
      return true;
    }
    if (TextUtils.equals("3046055438", paramRecentUser.uin))
    {
      oga.a(paramQQAppInterface, paramActivity);
      ogd.a(paramQQAppInterface, "qgg.push.click");
      ofz.a(paramQQAppInterface);
      return true;
    }
    if (ayvd.jdField_a_of_type_JavaLangString.equals(paramRecentUser.uin)) {
      return ayvf.a(paramActivity, paramRecentUser.uin, 1);
    }
    if (arhp.a().a(paramRecentUser.uin)) {
  ...
  {
    Object localObject = twk.a().a(paramQQAppInterface);
    if ((localObject != null) && (((List)localObject).size() > 0))
    {
      ...
      if (localObject != null)
      {
        ...
        if (localObject != null) {
          twk.a().a(paramQQAppInterface, ((QQMessageFacade.Message)localObject).time);
        }
      }
    }
  }
  ...
  private static void c(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    paramActivity.startActivity(localIntent);
    bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8006040", "0X8006040", 0, 0, "", "", "", "");
  }
  ...
  private static void c(QQAppInterface paramQQAppInterface, Activity paramActivity, RecentUser paramRecentUser)
  {
    ...
    bdll.b(paramQQAppInterface, "CliOper", "", "", "0X80050F5", "0X80050F5", 0, 0, "", "", "", "");
    bdll.b(paramQQAppInterface, "dc00899", "grp_lbs", "", "msg_box", "clk_friend", 0, 0, "", "", "", "");
    paramActivity = paramQQAppInterface.a().a(paramRecentUser.uin, 1001);
    if ((paramActivity != null) && (paramActivity.msgtype == -4011))
    {
      paramActivity = ayun.a(paramQQAppInterface);
      bdll.b(paramQQAppInterface, "CliOper", "", "", "0X80055FB", "0X80055FB", 0, 0, paramActivity[0], "", paramActivity[1], "");
    }
  }
  ...
  private static void c(QQAppInterface paramQQAppInterface, RecentUser paramRecentUser)
  {
    ...
    paramRecentUser = paramRecentUser.uin;
    if ((i != 1033) && (i != 1034)) {
      bdks.a(1, 1, i, paramQQAppInterface.a().a(paramRecentUser, i));
    }
  }
    ...
    if (localoek != null)
    {
      ...
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        ...
        if (localObject != null)
        {
          ...
          if (paramQQAppInterface != null) {
            localoek.a(paramQQAppInterface.time);
          }
        }
      }
    }
  ...
  private static void d(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    paramActivity.startActivity(localIntent);
    bdll.b(paramQQAppInterface, "CliOper", "", "", "0X800603B", "0X800603B", 0, 0, "", "", "", "");
  }
  ...
  private static void d(QQAppInterface paramQQAppInterface, RecentUser paramRecentUser)
  {
    if (paramRecentUser.getType() == 5000)
    {
      axan.a().a(paramQQAppInterface, true);
      f(paramQQAppInterface);
    }
    do
    {
      ...
      do
      {
        do
        {
          ...
          bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8004E99", "0X8004E99", 0, 0, "", "", "", "");
          localObject = paramQQAppInterface.a().b(antf.ad, 0);
          ...
          while (((Iterator)localObject).hasNext())
          {
            ...
            paramQQAppInterface.a().b(antf.ad, 0, localMessageRecord.uniseq);
          }
        } while (paramRecentUser.size() <= 0);
        aolc.a(paramQQAppInterface, (ArrayList)paramRecentUser);
        return;
        if (paramRecentUser.getType() == 9003)
        {
          ((ajan)paramQQAppInterface.getManager(138)).d();
          return;
        }
        if ((paramRecentUser.getType() == 7000) && (antf.x.equals(paramRecentUser.uin)))
        {
        ...
        localObject = avxx.a().b(paramRecentUser.uin);
      } while (localObject == null);
      avxx.a().a(paramQQAppInterface, paramRecentUser, (nwf)localObject, true);
      return;
  ...
  private static void e(QQAppInterface paramQQAppInterface)
  {
    ...
    Object localObject1 = localanzm.a();
    if ((localObject1 != null) && (((List)localObject1).size() > 0))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (localObject2 != null) {
          localanzm.a(((QQMessageFacade.Message)localObject2).time);
        }
      }
    }
  }
  ...
  private static void e(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    if (localajan != null)
    {
      localajan.a(paramActivity);
      localajan.b(false);
      bdll.b(paramQQAppInterface, "CliOper", "", "", "0X800618B", "0X800618B", 0, 0, "", "", "", "");
    }
  }
  ...
  private static void e(QQAppInterface paramQQAppInterface, RecentUser paramRecentUser)
  {
    ...
    for (;;)
    {
      bdll.b(paramQQAppInterface, "CliOper", "", "", "Msg_tab", "Delete_msg", 0, 0, i + "", "", "", "");
      return;
      if (!paramRecentUser.uin.equals(antf.G)) {
        break;
      }
      i = 7;
      continue;
  ...
  {
    List localList = axan.a().b(paramQQAppInterface);
    int i;
    int j;
    label16:
    Object localObject;
    ...
    for (;;)
    {
      ...
      if (localObject != null) {
        axan.a().a(paramQQAppInterface, ((QQMessageFacade.Message)localObject).time);
      }
    }
  }
  ...
  private static void f(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    tvz.c(paramQQAppInterface, false);
    twk localtwk = twk.a();
    if (localtwk.c(paramQQAppInterface)) {
      bdll.b(paramQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B70", "0X8005B70", 0, 0, paramQQAppInterface.getCurrentAccountUin(), "", "", "");
    }
    localtwk.e(paramQQAppInterface, false);
    localtwk.d(paramQQAppInterface, false);
    int i = twk.a().a(paramQQAppInterface);
    if (i > 0)
    {
      bdll.b(paramQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X800572B", "0X800572B", 0, 0, "", "", "", "");
      bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8006573", "0X8006573", 0, 0, "", "", "", "");
      if (i <= 0) {
        break label337;
      }
    }
    ...
    for (i = 1;; i = 0)
    {
      ...
      bdll.b(paramQQAppInterface, "CliOper", "", "", "0X800623E", "0X800623E", 0, 0, "", "", "", "");
      bdll.b(paramQQAppInterface, "P_CliOper", "Grp_tribe", "", "Msglist", "Clk_tribeHelper", 0, 0, "", "", "", "");
      if (bnrf.a(paramQQAppInterface)) {}
      for (paramQQAppInterface = oix.a(paramActivity, 0, 1);; paramQQAppInterface = oix.a(paramActivity, -1, 1))
      {
        ...
        paramActivity.startActivity(paramQQAppInterface);
        return;
        bdll.b(paramQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X800572C", "0X800572C", 0, 0, "", "", "", "");
        bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8006574", "0X8006574", 0, 0, "", "", "", "");
        break;
      }
    }
  }
  ...
  private static void g(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localoek != null)
    {
      ...
      for (;;)
      {
        ...
        if (localObject != null) {
          localoek.a(((QQMessageFacade.Message)localObject).time);
        }
      }
    }
  }
  ...
  private static void g(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    {
      localanzm.a(localHotChatItemData.mTroopUin, 1);
  ...
  private static void h(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    localIntent.setFlags(67108864);
    paramActivity.startActivity(localIntent);
    bdll.b(paramQQAppInterface, "P_CliOper", "Grp_msg", "", "Msglist", "Clk_help", 0, 0, "", "", "", "");
  }
  ...
  private static void i(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    bdll.b(paramQQAppInterface, "CliOper", "", "", "Add_frd", "Clk_Frd_offer", 22, 0, "", "", "", "");
  }
  
  private static void j(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    paramQQAppInterface.a().c(antf.E, 0);
  ...
  {
    MsgBoxListActivity.a(paramActivity, 1001, antf.H);
    bdll.b(paramQQAppInterface, "dc00899", "grp_lbs", "", "msg_box", "tip_single", 0, 0, "", "", "", "");
  }
}
