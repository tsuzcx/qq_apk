...
public class bdip
{
  ...
  public bdip()
  {
    this.jdField_a_of_type_MqqObserverSSOAccountObserver = new bdiq(this);
  }
  
  public void a()
  {
    this.jdField_a_of_type_Bdir = null;
  }
  
  public void a(bdir parambdir)
  {
  ...
  public void a(AppRuntime paramAppRuntime, long paramLong, String paramString)
  {
    ...
    {
      byte[] arrayOfByte = this.jdField_a_of_type_MqqManagerWtloginManager.getPkgSigFromApkName(bcyb.a().a(), paramString);
      this.jdField_a_of_type_Long = paramLong;
      paramAppRuntime.ssoGetA1WithA1(bcyb.a().a() + "", paramString.getBytes(), 16L, paramLong, 1L, "5.0".getBytes(), arrayOfByte, this.jdField_a_of_type_MqqObserverSSOAccountObserver);
    }
  }
  ...
  public byte[] a(android.content.Context paramContext, long paramLong1, long paramLong2)
  {
    ...
    //   379: aload 7
    //   381: invokestatic 204	bdii:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   384: aload_1
    //   385: ifnull -26 -> 359
    //   388: aload_1
