...
public class tzo
{
  ...
  static bgpa jdField_a_of_type_Bgpa;
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        Object localObject = ((anrs)localObject).b(paramString);
        if (localObject != null)
        {
  ...
  {
    Object localObject1 = albs.a().jdField_a_of_type_JavaUtilList;
    int j;
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      } else if ((localRecentUserBaseData.mUser.getType() == 1008) && (tue.b((QQAppInterface)pha.a(), localRecentUserBaseData.mUser.uin))) {
        ((Iterator)localObject2).remove();
      }
    }
    int i = 0;
  ...
  public static String a(ArticleInfo paramArticleInfo, pyb parampyb)
  {
    ...
    for (;;)
    {
      return bbzj.b(paramArticleInfo);
      label145:
      localObject1 = localObject2;
      ...
      parampyb = ReadInJoyUserInfoModule.a(Long.valueOf(paramArticleInfo.msgBoxBriefPreFix).longValue(), parampyb);
      if (parampyb == null)
      {
        localObject1 = ReadInJoyUserInfoModule.a() + ": ";
        break;
      }
      localObject1 = parampyb.nick + ": ";
      break;
        ...
        for (;;)
        {
          ...
          if (paramBaseArticleInfo.mTopicRecommendFeedsInfo != null)
          {
            ...
            if (paramBaseArticleInfo.mTopicRecommendFeedsInfo.a != null)
            {
              ...
              {
                localObject = ((rik)paramBaseArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).c;
                str1 = ((rik)paramBaseArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).jdField_a_of_type_JavaLangString;
              }
            }
          }
  ...
  public static String a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      localObject1 = bgsg.q(BaseApplicationImpl.getApplication(), str);
      if (localObject1 == null) {
        break label123;
      }
    }
    for (;;)
    {
      try
      {
        ...
        {
          paramString = nko.a(paramString, "_kdSkinID=" + localSkinData.id);
          if (bgsg.v(BaseApplicationImpl.getApplication(), str)) {
            localObject1 = nko.a(paramString, "_kdSkinVoice=1");
          }
        }
        else
        {
      ...
      return nko.a(paramString, "_kdSkinVoice=0");
      label123:
      Object localObject2 = null;
    }
  }
  ...
  {
    // Byte code:
    //   0: invokestatic 315	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   3: ifeq +29 -> 32
    //   6: ldc 211
    //   8: iconst_2
    ...
    //   16: ldc_w 415
    //   19: invokevirtual 229	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   22: aload_3
    //   23: invokevirtual 229	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   26: invokevirtual 247	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   29: invokestatic 218	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   32: ldc 2
    //   34: monitorenter
    //   35: aload_2
    //   36: ifnull +7 -> 43
    //   39: aload_2
    //   40: putstatic 417	tzo:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   43: ldc 2
    //   45: monitorexit
    //   46: new 419	mqq/app/NewIntent
    //   49: dup
    //   50: aload_1
    //   51: ldc_w 421
    //   54: invokespecial 424	mqq/app/NewIntent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   57: astore_1
    //   58: aload_1
    //   59: ldc_w 426
    //   62: ldc_w 428
    //   65: invokevirtual 432	mqq/app/NewIntent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   68: pop
    //   69: new 434	com/tencent/mobileqq/mp/mobileqq_mp$GetPublicAccountDetailInfoRequest
    //   72: dup
    //   73: invokespecial 435	com/tencent/mobileqq/mp/mobileqq_mp$GetPublicAccountDetailInfoRequest:<init>	()V
    //   76: astore_2
    //   77: aload_2
    //   78: getfield 439	com/tencent/mobileqq/mp/mobileqq_mp$GetPublicAccountDetailInfoRequest:seqno	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   81: iconst_0
    //   82: invokevirtual 445	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   85: aload_2
    //   86: getfield 448	com/tencent/mobileqq/mp/mobileqq_mp$GetPublicAccountDetailInfoRequest:version	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   89: iconst_1
    //   90: invokevirtual 445	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   93: aload_2
    //   94: getfield 452	com/tencent/mobileqq/mp/mobileqq_mp$GetPublicAccountDetailInfoRequest:versionInfo	Lcom/tencent/mobileqq/pb/PBStringField;
    //   97: ldc 208
    //   99: invokevirtual 456	com/tencent/mobileqq/pb/PBStringField:set	(Ljava/lang/String;)V
    //   102: aload_2
    //   103: getfield 458	com/tencent/mobileqq/mp/mobileqq_mp$GetPublicAccountDetailInfoRequest:uin	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   106: aload_3
    //   107: invokestatic 462	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   110: l2i
    //   111: invokevirtual 445	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   114: aload_1
    //   115: ldc_w 464
    //   118: aload_2
    //   119: invokevirtual 468	com/tencent/mobileqq/mp/mobileqq_mp$GetPublicAccountDetailInfoRequest:toByteArray	()[B
    //   122: invokevirtual 471	mqq/app/NewIntent:putExtra	(Ljava/lang/String;[B)Landroid/content/Intent;
    //   125: pop
    //   126: aload_1
    //   127: new 473	tzp
    //   130: dup
    //   131: aload_0
    //   132: invokespecial 476	tzp:<init>	(Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   135: invokevirtual 480	mqq/app/NewIntent:setObserver	(Lmqq/observer/BusinessObserver;)V
    //   138: aload_0
    //   139: aload_1
    //   140: invokevirtual 484	com/tencent/mobileqq/app/QQAppInterface:startServlet	(Lmqq/app/NewIntent;)V
    //   143: invokestatic 315	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   146: ifeq +12 -> 158
    //   149: ldc 211
    //   151: iconst_2
    //   152: ldc_w 486
    //   155: invokestatic 218	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   158: aload_1
    //   159: areturn
    //   160: astore_0
    //   161: ldc 2
  ...
  public static nyl a(AccountDetail paramAccountDetail)
  {
    nyl localnyl = a(paramAccountDetail, 0, 9);
    if (localnyl == null)
    {
  ...
  public static nyl a(AccountDetail paramAccountDetail, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      while (!((Iterator)localObject).hasNext())
      {
        do
        {
          ...
          localObject = (nyk)paramAccountDetail.next();
        } while (((nyk)localObject).jdField_a_of_type_Int != paramInt1);
        localObject = ((nyk)localObject).jdField_a_of_type_JavaUtilList.iterator();
      }
      localnyl = (nyl)((Iterator)localObject).next();
    } while (localnyl.c != paramInt2);
    return localnyl;
    return null;
  }
  ...
  public static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, ProfileParams paramProfileParams)
  {
    ...
    for (;;)
    {
      ...
      localObject = new tzq(paramActivity, paramQQAppInterface, paramProfileParams);
      localObject = bltb.a(paramQQAppInterface, paramProfileParams.a(), (anil)localObject);
      if (localObject != null)
      {
  ...
  {
    boolean bool = ((Boolean)bgsg.a(paramContext, paramQQAppInterface.getCurrentAccountUin(), "config_tim_team_is_web", Boolean.valueOf(false))).booleanValue();
    String str = (String)bgsg.a(paramContext, paramQQAppInterface.getCurrentAccountUin(), "config_tim_team_url", "https://m.q.qq.com/a/p/1109953074?s=pages%2Fnotification%2Findex%3FenterType%3DqqMiniHelper");
    if ((!bool) && (MiniAppLauncher.isMiniAppUrl(str))) {
      MiniAppLauncher.startMiniApp(paramContext, str, 1043, null);
    }
    for (;;)
    {
      paramQQAppInterface.a().a(anhk.aV, 1008, true, true);
      return;
  ...
  private static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, int paramInt, Intent paramIntent)
  {
    ...
    nmp.a(paramContext, paramIntent, paramString, false, -1, true, -1);
  }
  ...
  public static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    } while (!nki.a(paramActivity, paramString));
    a(paramIntent, paramActivity, paramString, paramInt2, paramInt3);
    return;
    nmp.a(paramActivity, paramIntent, paramString, false, 5, true, paramInt2);
  }
  ...
  private static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      String str = pgc.k + bgku.encodeToString(paramString.getBytes(), 0);
  ...
  public static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        break;
      case -6: 
        if (!nki.a(paramContext, paramString)) {
          break;
        }
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, anry paramanry)
  {
    a(paramAppInterface, paramContext, paramString, paramanry, true, 0);
  }
  
  @Deprecated
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, anry paramanry, int paramInt)
  {
    ...
    localQQAppInterface.addObserver(new aoqn(new tzz(paramanry, paramString, paramAppInterface, paramContext), localQQAppInterface));
    aoqs.a(localQQAppInterface, true, paramString, 0);
    if ((paramAppInterface instanceof QQAppInterface)) {
      paramAppInterface = (QQAppInterface)paramAppInterface;
    }
    for (;;)
    {
      oat.a(paramAppInterface, paramString, 0);
      return;
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, anry paramanry, boolean paramBoolean)
  {
    a(paramAppInterface, paramContext, paramString, paramanry, paramBoolean, 0);
  }
  
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, anry paramanry, boolean paramBoolean, int paramInt)
  {
    a(paramAppInterface, paramContext, paramString, paramanry, paramBoolean, paramInt, false);
  }
  
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, anry paramanry, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    if ((paramAppInterface == null) || (paramContext == null) || (TextUtils.isEmpty(paramString))) {
      return;
    }
    ...
    for (;;)
    {
      ...
      {
        paramanry = new aoqn(new tzv(paramanry, paramString, paramAppInterface, paramContext, paramInt, paramBoolean1));
        paramContext = new PublicAccountIntent(paramContext.getApplicationContext(), aoqp.class);
        paramContext.a(paramanry);
        ...
        return;
        localObject = (anrs)paramAppInterface.getManager(56);
        if (localObject != null)
        {
          localObject = ((anrs)localObject).a(paramString);
      ...
      {
        localObject = new NewIntent(paramContext.getApplicationContext(), oaz.class);
        ...
        try
        {
          ...
          ((NewIntent)localObject).setObserver(new tzw(paramanry, paramString, paramBoolean1, paramContext, paramAppInterface, paramInt));
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    new pyq(paramQQAppInterface, null, null, qnd.a(), null).a(localArrayList);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, RecentUser paramRecentUser, int paramInt, RecentBaseData paramRecentBaseData)
  {
    ...
    aaae.a(paramActivity, 9004, paramRecentUser);
    if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt, long paramLong, boolean paramBoolean)
  {
    ...
    localbkho.a(paramContext.getResources().getString(2131695396));
    localbkho.a(2131691320, 3);
    if (paramString.equals("2010741172")) {
      localbkho.b(2131694586);
    }
    localbkho.c(2131690582);
    localbkho.a(new tzu(paramQQAppInterface, paramString, paramInt, paramLong, paramBoolean, paramContext, localbkho));
    localbkho.show();
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, boolean paramBoolean, anry paramanry)
  {
    a(paramQQAppInterface, paramContext, paramString, paramBoolean, paramanry, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, boolean paramBoolean1, anry paramanry, boolean paramBoolean2)
  {
    if ((paramQQAppInterface == null) || (paramContext == null) || (TextUtils.isEmpty(paramString))) {
      return;
    }
    ...
    Object localObject3 = (anrs)paramQQAppInterface.getManager(56);
    Object localObject1 = localNewIntent;
    Object localObject2;
    if (localObject3 != null)
    {
      localObject2 = ((anrs)localObject3).a(paramString);
      ((anrs)localObject3).b(paramString);
      paramContext = (Context)localObject2;
      localObject1 = localNewIntent;
      if (localObject2 == null)
      {
        localObject3 = (anlf)paramQQAppInterface.getManager(69);
        paramContext = (Context)localObject2;
        localObject1 = localNewIntent;
        if (localObject3 != null)
        {
          localObject1 = ((anlf)localObject3).a(paramString);
          paramContext = (Context)localObject2;
        }
      }
    }
    ...
    if ((paramBoolean2) || (paramContext == null) || (a(paramContext.accountFlag) != -4))
    {
      ...
      if ((!paramBoolean2) && (paramContext != null) && (a(paramContext.accountFlag) == -4))
      {
        localNewIntent = new NewIntent(paramQQAppInterface.getApp().getApplicationContext(), oaz.class);
    ...
    else
    {
      for (;;)
      {
        try
        {
          ...
          paramContext = new tzx(paramanry, paramString, paramBoolean1, localBaseApplication, localObject1, paramQQAppInterface);
    ...
    for (;;)
    {
      paramContext = new aoqn(new tzy(localObject1, paramQQAppInterface, paramString, paramanry, paramBoolean1, localBaseApplication), paramQQAppInterface);
      ...
      aoqs.a(paramQQAppInterface, false, paramString, 0);
      return;
      localObject1 = paramContext;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    aoqq.a(paramQQAppInterface, paramChatMessage.senderuin, 0, 6, paramChatMessage.msgId, str);
  }
      ...
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (jdField_a_of_type_Int == 0)
        {
          ...
          if ((bool) && (paramBoolean))
          {
            ...
            if (??? != null)
            {
              localObject2 = (RecentUser)((aong)???).findRecentUser(anhk.ay, 1008);
              if (localObject2 != null)
              {
                ((aong)???).delRecentUser((BaseRecentUser)localObject2);
            ...
            ??? = (anrs)paramQQAppInterface.getManager(56);
            if (??? != null)
            {
              ((anrs)???).c(anhk.ay);
  ...
  public static int b(String paramString)
  {
    ...
    if (((RecentUserBaseData)localObject2).mUser.getType() == 1008)
    {
      ...
      if (!TextUtils.equals(((RecentUserBaseData)localObject2).mUser.uin, paramString))
      {
        if (!TextUtils.equals(((RecentUserBaseData)localObject2).mUser.uin, anhk.C)) {
          break label215;
        }
        k = i;
      }
  ...
  private static MessageForStructing b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localMessageForStructing.frienduin = anhk.az;
  ...
  private static MessageForStructing b(MessageForStructing paramMessageForStructing, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    MessageForStructing localMessageForStructing = (MessageForStructing)bbzh.a(paramMessageForStructing.msgtype);
  ...
  public static String b()
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = pha.h();
        localObject2 = bgln.d(BaseApplication.getContext());
        if (localObject1 == null) {
          continue;
        }
      }
      ...
      {
        return bgku.encodeToString((byte[])localObject2, 2);
      }
      label225:
      if (localObject2 == null) {}
    }
  ...
  public static String b(QQAppInterface paramQQAppInterface, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      if ((paramBaseArticleInfo.mFeedType == 4) || (paramBaseArticleInfo.mFeedType == 5))
      {
        ...
        {
          paramBaseArticleInfo = ReadInJoyUserInfoModule.a(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rha.a, null);
          if (paramBaseArticleInfo != null) {}
      ...
      {
        if (snh.f((ArticleInfo)paramBaseArticleInfo))
        {
          paramBaseArticleInfo = ReadInJoyUserInfoModule.a(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rha.a, null);
          if (paramBaseArticleInfo != null) {}
          for (paramBaseArticleInfo = paramBaseArticleInfo.nick;; paramBaseArticleInfo = ReadInJoyUserInfoModule.a())
        ...
        {
          paramQQAppInterface = new StringBuilder(anni.a(2131707528));
          ...
          {
            paramQQAppInterface.append(i + 1).append(".").append(((rfl)paramBaseArticleInfo.hotWordInfo.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaLangString).append("  ");
            i += 1;
          }
          continue;
        }
  ...
  private static void b(AppInterface paramAppInterface, Context paramContext, String paramString, int paramInt)
  {
    ...
    NewIntent localNewIntent = new NewIntent(paramContext, oaz.class);
    ...
    try
    {
      ...
      localNewIntent.setObserver(new uaa(paramContext, paramAppInterface, paramInt, paramString));
  ...
  {
    if (jdField_a_of_type_Bgpa != null)
    {
      jdField_a_of_type_Bgpa.dismiss();
      jdField_a_of_type_Bgpa = null;
    }
    paramQQAppInterface = new tzr(paramActivity, paramProfileParams, paramQQAppInterface);
    paramProfileParams = new tzs(paramActivity, paramProfileParams);
    jdField_a_of_type_Bgpa = bglp.a(paramActivity, 230);
    jdField_a_of_type_Bgpa.setMessage(2131694610);
    jdField_a_of_type_Bgpa.setTitle(2131691916);
    jdField_a_of_type_Bgpa.setNegativeButton(2131690582, paramQQAppInterface);
    jdField_a_of_type_Bgpa.setPositiveButton(2131717875, paramQQAppInterface);
    jdField_a_of_type_Bgpa.setOnCancelListener(paramProfileParams);
  ...
  public static void c(String paramString)
  {
    ...
    oat.a(null, "CliOper", "", "", "0X8009A7C", "0X8009A7C", 0, 0, paramString, "", "", "", false);
  }
