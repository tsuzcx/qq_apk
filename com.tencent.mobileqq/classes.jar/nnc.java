...
public class nnc
{
  ...
  protected static SparseIntArray a()
  {
    ...
    //   9: pop
    //   10: invokestatic 41	nnc:a	()Lorg/json/JSONObject;
    //   13: astore 4
    //   15: aload 4
    //   17: ifnonnull +5 -> 22
    //   20: aconst_null
  ...
  protected static JSONObject a()
  {
    try
    {
      ...
      Object localObject = noe.a(localInputStream);
      try
      {
  ...
  public static void a(AppInterface paramAppInterface, int paramInt1, String paramString1, int paramInt2, int paramInt3, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    if (a(paramInt1))
    {
      bdll.b(null, "P_CliOper", "AppBernoulliReport", "", paramInt1 + "", paramString1, paramInt2, paramInt3, paramString2, paramString3, paramString3, paramString4);
  ...
  protected static void a(JSONObject paramJSONObject, int paramInt, boolean paramBoolean)
  {
    ...
    //   5: iconst_1
    //   6: if_icmplt +18 -> 24
    //   9: getstatic 13	nnc:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   12: ifnull +12 -> 24
    //   15: getstatic 13	nnc:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   31: istore_3
    //   32: iload_3
    //   33: invokestatic 426	nnc:a	(I)I
    //   36: iconst_m1
    //   37: if_icmple +14 -> 51
    //   40: getstatic 13	nnc:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   43: iload_3
    //   44: invokestatic 426	nnc:a	(I)I
    ...
    //   100: iload_1
    //   101: iconst_1
    //   102: invokestatic 408	nnc:a	(Lorg/json/JSONObject;IZ)V
    //   105: iload_3
    //   106: iconst_1
    //   107: iadd
    //   108: istore_3
  ...
  protected static void a(JSONObject paramJSONObject, List<Integer> paramList, boolean paramBoolean)
  {
    ...
    //   14: ifne +4 -> 18
    //   17: return
    //   18: getstatic 13	nnc:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   21: ifnonnull +13 -> 34
    //   24: new 15	java/util/ArrayList
    //   27: dup
    //   28: invokespecial 38	java/util/ArrayList:<init>	()V
    //   31: putstatic 13	nnc:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   34: aload_0
    //   35: ldc 63
    ...
    //   94: aload_1
    //   95: iload_2
    //   96: invokestatic 418	nnc:a	(Lorg/json/JSONObject;Ljava/util/List;Z)V
    //   99: iload_3
    //   100: iconst_1
    //   101: iadd
    //   102: istore_3
    ...
    //   134: ifeq -117 -> 17
    //   137: iload_3
    //   138: invokestatic 357	nnc:a	(I)Z
    //   141: ifne -124 -> 17
    //   144: getstatic 13	nnc:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   147: iload_3
