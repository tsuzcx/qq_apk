...
public class bbjn
{
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(paramContext).getInt(paramString + "_" + "subscript_recommend_config_version" + "_" + "8.2.8.4440", 0);
  }
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(paramContext).getInt("readinjoy_crop_and_group_version_4440_" + paramString, 0);
  }
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(paramContext).getInt("readinjoy_remote_reset_config_version_4440_" + paramString, 0);
  }
  ...
  public static boolean b(Context paramContext, String paramString)
  {
    ...
    return !TextUtils.equals(PreferenceManager.getDefaultSharedPreferences(paramContext).getString(paramString, ""), "8.2.8");
  }
  ...
  public static int c(Context paramContext, int paramInt)
  {
    try
    {
      ...
      if (axnv.jdField_d_of_type_Boolean)
      {
        ...
        axnv.jdField_d_of_type_Long = System.currentTimeMillis();
        return 0;
      }
      return i;
    }
  ...
  {
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putString("config_app_version_" + paramString, "8.2.8");
    paramContext.commit();
  }
  ...
  {
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putInt(paramString + "_" + "subscript_recommend_config_version" + "_" + "8.2.8.4440", paramInt);
    paramContext.commit();
  }
  ...
  {
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putInt("readinjoy_crop_and_group_version_4440_" + paramString, paramInt);
    paramContext.commit();
  }
  ...
  {
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putInt("readinjoy_remote_reset_config_version_4440_" + paramString, paramInt);
    paramContext.commit();
  }
