  ...
  extends aafe
{
  ...
  private long a(String paramString)
  {
    ...
    {
      long l = bgov.a((QQAppInterface)localAppRuntime, "name_plate_config_version", 0L);
  ...
  private boolean b(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg = paramToServiceMsg.extraData.getString(aneg.a);
    ...
    localVAResourcesReq.lastVisitTime = bgff.a;
  ...
  private boolean c(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    String str3 = paramToServiceMsg.extraData.getString(aneg.a);
    Object localObject = paramToServiceMsg.extraData.getString(aneg.c);
    long l1 = paramToServiceMsg.extraData.getLong(aneg.m);
    boolean bool3 = bgga.a();
    boolean bool1 = false;
    boolean bool2 = false;
    ...
    String str4 = bgoa.a(0, BaseApplicationImpl.getContext());
    localObject = bgoa.a(1, BaseApplicationImpl.getContext());
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        localObject = paramToServiceMsg.extraData.getString(aneg.d);
        if ((!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).equals("vip_drawer")))
        {
          localPrivExtV2Req.trace_info = bkjx.a("drawer_trace_info");
        ...
        localPrivExtV2Req.pullPayRuleCfgTime = bgov.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "last_pull_pay_rule", 0L);
        ...
        paramToServiceMsg.extraData.putBoolean(aneg.i, bool1);
        paramToServiceMsg.extraData.putBoolean(aneg.j, bool2);
        ...
        try
        {
          localPrivExtV2Req.sImsi1 = bjms.b("a4bd32");
        }
    ...
    {
      if (bool1) {
        paramToServiceMsg.extraData.putString(aneg.k, localPrivExtV2Req.sImsi1);
      }
      if (bool2) {
        paramToServiceMsg.extraData.putString(aneg.l, localPrivExtV2Req.sImsi2);
      }
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      if (paramToServiceMsg.extraData.getInt(aneg.b) == 6) {
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    do
    {
      ...
      if ("ClubInfoSvc.guanjiaReport".equals(paramToServiceMsg.getServiceCmd()))
      {
        ...
        localObject = paramToServiceMsg.extraData.getString(aneg.a);
        ...
        localGuanjiaReportReq.sPhoneNum = paramToServiceMsg.extraData.getString(aneg.e);
        localGuanjiaReportReq.bKingCard = paramToServiceMsg.extraData.getBoolean(aneg.f);
        localGuanjiaReportReq.iCardType = paramToServiceMsg.extraData.getInt(aneg.g);
        localGuanjiaReportReq.iCardStatus = paramToServiceMsg.extraData.getInt(aneg.h);
      ...
      ((GetCustomOnlineStatusReq)localObject).lUin = paramToServiceMsg.extraData.getLong(aneg.n);
