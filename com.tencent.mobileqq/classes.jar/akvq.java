  ...
  implements Manager
{
  ...
  private ConcurrentHashMap<String, akvs> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private long jdField_b_of_type_Long = -1L;
  private ConcurrentHashMap<String, String> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap;
  
  public akvq(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          ((StringBuilder)localObject1).append(((akvs)localEntry.getValue()).jdField_a_of_type_Int);
          ((StringBuilder)localObject1).append(",type=");
          ((StringBuilder)localObject1).append(((akvs)localEntry.getValue()).b);
          ((StringBuilder)localObject1).append(",isRequest=");
          ((StringBuilder)localObject1).append(((akvs)localEntry.getValue()).jdField_a_of_type_Boolean);
          ((StringBuilder)localObject1).append(",saveTime=");
          ((StringBuilder)localObject1).append(((akvs)localEntry.getValue()).jdField_a_of_type_Long);
      ...
      {
        localObject1 = (akvs)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
        if (localObject1 != null)
        {
          int k = ((akvs)localObject1).jdField_a_of_type_Int;
          int m = ((akvs)localObject1).b;
          if (((m == 0) && (k != j)) || ((m != i) && (!((akvs)localObject1).jdField_a_of_type_Boolean)))
          {
            ((akvs)localObject1).jdField_a_of_type_Boolean = true;
            if (QLog.isColorLevel())
            {
          ...
          if ((k == j) && (m == i) && (((akvs)localObject1).jdField_a_of_type_Boolean))
          {
            if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    Object localObject = bbkb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      localObject = ((String)localObject).split("\\|");
      if ((localObject != null) && (localObject.length == 2))
      {
        this.jdField_a_of_type_Long = alwt.a(localObject[0]);
        this.jdField_b_of_type_Long = alwt.a(localObject[1]);
        if (QLog.isColorLevel()) {
  ...
  public void a(akvr paramakvr)
  {
    ...
    if ((a()) && (paramakvr != null))
    {
      ...
      localStringBuilder.append(" uin=").append(bbkk.e(paramakvr.jdField_a_of_type_JavaLangString));
      localStringBuilder.append(" sysId=").append(paramakvr.jdField_b_of_type_Long);
      localStringBuilder.append(" headType=").append(paramakvr.c);
      localStringBuilder.append(" qq18Switch=").append(paramakvr.jdField_a_of_type_Long);
      if ((!TextUtils.isEmpty(paramakvr.jdField_a_of_type_JavaLangString)) && (paramakvr.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (paramakvr.jdField_a_of_type_Long != -1L)) {
        a(paramakvr.jdField_a_of_type_Long);
      }
      localFriendListHandler = (FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(1);
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(1, paramakvr.jdField_a_of_type_JavaLangString, 0);
      if ((localObject == null) || (!((Boolean)((Pair)localObject).first).booleanValue())) {
        break label221;
      }
      localFriendListHandler.c(paramakvr.jdField_a_of_type_JavaLangString);
      localFriendListHandler.notifyUI(3, true, paramakvr.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      if ((localObject != null) && (((Pair)localObject).second != null))
      {
        ...
        if (((paramakvr.jdField_a_of_type_Long == 1L) && (paramakvr.c != -1L) && (paramakvr.c != l2)) || ((paramakvr.jdField_b_of_type_Long != -1L) && (paramakvr.jdField_b_of_type_Long != l1) && (l2 == 0L)))
        {
          localStringBuilder.append(" fetch userHead");
          localFriendListHandler.c(paramakvr.jdField_a_of_type_JavaLangString);
          localFriendListHandler.notifyUI(3, true, paramakvr.jdField_a_of_type_JavaLangString);
  ...
  public void a(String paramString)
  {
    ...
    {
      akvs localakvs = (akvs)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if ((localakvs != null) && (localakvs.jdField_a_of_type_Boolean))
      {
        QLog.d("ClassicHeadActivityManager", 2, " QQ 18 handle handleGetHeadError uin=" + paramString + ",HeadID=" + localakvs.jdField_a_of_type_Int + ",Type=" + localakvs.b + ",IsRequest=" + localakvs.jdField_a_of_type_Boolean);
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString);
      }
    }
  }
      ...
      do
      {
        do
        {
          ...
          do
          {
            ...
            {
              return;
              localObject = new akvs(paramString, paramInt1, paramInt2);
              if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(paramString)) {
                break;
              }
            ...
            return;
            localakvs = (akvs)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
          } while (localakvs == null);
          i = localakvs.jdField_a_of_type_Int;
          j = localakvs.b;
