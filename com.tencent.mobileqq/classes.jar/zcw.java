...
public class zcw
  implements Runnable
{
  public zcw(ApolloGameInvitation paramApolloGameInvitation) {}
  ...
  public void run()
  {
    ...
    try
    {
      if (new File(((StringBuilder)localObject1).toString()).exists()) {
        ...
        localObject1 = BitmapManager.b(BaseApplicationImpl.getApplication().getResources(), 2130838160);
      }
    }
    ...
    while (localException != null)
    {
      ...
      try
      {
        ...
        WXShareHelper.a().a(new zcx(this));
