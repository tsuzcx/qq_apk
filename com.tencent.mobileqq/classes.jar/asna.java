  ...
  extends asmv
{
  ...
  public asna(String paramString, int paramInt)
  {
  ...
  {
    return bbgk.a(((FileInfo)this.jdField_a_of_type_JavaUtilList.get(0)).d().toLowerCase(), this.jdField_a_of_type_JavaLangString);
  }
  ...
  public List<bayt> a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    while (paramContext.hasNext())
    {
      ...
      asna localasna = new asna(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
      localasna.a(this.jdField_a_of_type_AndroidOsBundle);
      ArrayList localArrayList = new ArrayList(1);
      localArrayList.add(localFileInfo);
      localasna.a(localArrayList);
      paramQQAppInterface.add(localasna);
    }
  ...
  protected void b(View paramView)
  {
    ...
    paramView = new asud(paramView, new asub(paramView.app, paramView, (FileManagerEntity)localObject, 10000));
    paramView.a(8);
    paramView.a();
  }
  ...
  protected void c(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        aszk.a(aszt.d(paramView.d()) + amtj.a(2131708735));
        aslg.b(paramView);
      }
      return;
      aslg.a(paramView);
      bcef.b(null, "dc00898", "", "", "0X800AA91", "0X800AA91", 2, 0, "0", "0", "", "");
    }
  }
  ...
  public CharSequence d()
  {
    ...
    if (i > 1)
    {
      localSpannableStringBuilder = new SpannableStringBuilder(i + amtj.a(2131703637) + "\"");
      localSpannableStringBuilder.append(bbgk.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString));
      localSpannableStringBuilder.append("\"").append(amtj.a(2131692179));
      this.b = localSpannableStringBuilder;
      return this.b;
    }
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder();
    localSpannableStringBuilder.append(bbgk.a(a((FileInfo)this.jdField_a_of_type_JavaUtilList.get(0)), this.jdField_a_of_type_JavaLangString));
    if (this.b == null) {
      this.b = localSpannableStringBuilder;
    }
    return this.b;
