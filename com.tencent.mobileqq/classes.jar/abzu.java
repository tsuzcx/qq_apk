...
public class abzu
  extends Handler
{
  public abzu(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        if ((TroopMemberListActivity.b(this.a)) && (TroopMemberListActivity.d(this.a)))
        {
          ...
          paramMessage.obj = this.a.jdField_a_of_type_Acao.a();
          TroopMemberListActivity.a(this.a, paramMessage);
        }
        return;
        this.a.k();
        ...
        {
          if (this.a.jdField_a_of_type_Acao.b != null) {
            this.a.jdField_a_of_type_Acao.b.clear();
          }
        ...
        bbmy.a(this.a, this.a.getString(2131625923), 0).b(this.a.jdField_a_of_type_AndroidViewView.getHeight());
        TroopMemberListActivity.a(this.a);
        return;
        if ((this.a.jdField_a_of_type_AndroidAppDialog != null) && (this.a.jdField_a_of_type_AndroidAppDialog.isShowing())) {
          this.a.jdField_a_of_type_AndroidAppDialog.dismiss();
        }
        bbmy.a(this.a, this.a.getString(2131625922), 0).b(this.a.jdField_a_of_type_AndroidViewView.getHeight());
        return;
      ...
      return;
    } while (this.a.jdField_a_of_type_Acao == null);
    this.a.jdField_a_of_type_Acao.a();
    return;
    ...
    for (this.a.n = "0"; this.a.jdField_a_of_type_Acao != null; this.a.n = "1")
    {
      label1133:
      this.a.jdField_a_of_type_Acao.a();
      return;
