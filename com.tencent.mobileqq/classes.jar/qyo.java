...
public class qyo
{
  ...
  public static void a(Context paramContext, pxk parampxk, ViewGroup.LayoutParams paramLayoutParams)
  {
    a(paramContext, parampxk, paramLayoutParams, null);
  }
  
  public static void a(Context paramContext, pxk parampxk, ViewGroup.LayoutParams paramLayoutParams, View paramView)
  {
    ...
    paramLayoutParams.height = paramContext.getResources().getDimensionPixelSize(2131298654);
    int i = parampxk.a();
    int j = parampxk.b();
  ...
  public static void a(pxk parampxk, RingAvatarView paramRingAvatarView, ImageView paramImageView)
  {
    if ((paramRingAvatarView == null) || (paramImageView == null) || (parampxk == null)) {}
    do
    {
      return;
      parampxk = parampxk.a();
  ...
  public static void a(rhs paramrhs, ReadInJoyYAFolderTextView paramReadInJoyYAFolderTextView, qva paramqva, SpannableStringBuilder paramSpannableStringBuilder)
  {
    ...
    if (pha.a(paramrhs))
    {
      List localList = paramrhs.jdField_a_of_type_Rgy.a;
      ...
      {
        paramrhs = paramSpannableStringBuilder.substring(1);
        localStringBuilder.append(paramrhs);
        ...
        paramrhs = bglf.b((QQAppInterface)pha.a(), String.valueOf(l), true);
        paramSpannableStringBuilder = "@" + paramrhs;
        paramrhs = paramSpannableStringBuilder;
      ...
      {
        localStringBuilder.append(paramrhs).append(paramSpannableStringBuilder);
        paramSpannableStringBuilder = new qxa();
        paramSpannableStringBuilder.jdField_a_of_type_Int = j;
        paramSpannableStringBuilder.b = (paramrhs.length() + j);
      ...
      label329:
      paramrhs = new SpannableStringBuilder(new bdnt(localStringBuilder, 7, 16));
      paramSpannableStringBuilder = ((List)localObject).iterator();
      while (paramSpannableStringBuilder.hasNext())
      {
        localObject = (qxa)paramSpannableStringBuilder.next();
        paramrhs.setSpan(new qvc(((qxa)localObject).jdField_a_of_type_Long, -3355444, paramqva), ((qxa)localObject).jdField_a_of_type_Int, ((qxa)localObject).b, 17);
      }
      localSpannableStringBuilder.append(paramrhs);
    }
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramrhs.jdField_a_of_type_JavaLangString)) {
        try
        {
          localSpannableStringBuilder.append(new bdnt(bbzj.b(paramrhs.jdField_a_of_type_JavaLangString), 7, 16));
        }
        catch (Exception paramrhs)
        {
          QLog.d("UtilsForComponent", 1, "parse bytes_comments failed ", paramrhs);
        }
      }
    }
  }
  ...
  public static Pair<Integer, Integer> b()
  {
    ...
    return new Pair(Integer.valueOf((localResources.getDisplayMetrics().widthPixels - afur.a(3.0F, localResources)) / 3), Integer.valueOf(localResources.getDimensionPixelSize(2131298660)));
  }
  ...
  {
    return (snh.a(paramArticleInfo) == 23) || (snh.b(paramArticleInfo) == 56);
  }
