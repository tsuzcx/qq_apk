...
public class agdp
{
  ...
  public agdp(Activity paramActivity)
  {
  ...
  private void b(String paramString)
  {
    ...
    {
      i = azyk.b(this.jdField_a_of_type_AndroidAppActivity);
      localIntent = new Intent();
      localIntent.setFlags(603979776);
      localIntent.putExtra("Business_Origin", 100);
      localIntent.putExtra("FROM_WHERE", "FROM_SDK_AVATAR_SET_IMAGE");
      PhotoUtils.a(localIntent, this.jdField_a_of_type_AndroidAppActivity, FriendProfileCardActivity.class.getName(), i, i, 1080, 1080, paramString, azyk.a(), 1035);
  ...
  private void g()
  {
    String str = this.jdField_a_of_type_AndroidAppActivity.getString(2131653579) + this.jdField_b_of_type_JavaLangString;
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          ((bafb)localObject1).setMessage(ajjy.a(2131647801));
          ((bafb)localObject1).setNegativeButton(2131625035, new agdq(this));
    ...
    zsb.a(this.jdField_a_of_type_AndroidAppActivity, 1, this.jdField_d_of_type_JavaLangString, (Bundle)localObject3).a("sdk_avatar_edit", null, new agdr(this, str));
  }
  ...
  private void h()
  {
    ...
    if (localOpenID == null)
    {
      ...
      try
      {
        ...
        localQQAppInterface.a().a(l, this.e, Long.valueOf(this.jdField_d_of_type_JavaLangString).longValue(), new agds(this));
        return;
      }
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Bafb.setTitle(ajjy.a(2131647803));
    Object localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131653579);
    String str = this.jdField_a_of_type_AndroidAppActivity.getString(2131653580);
    if (paramString != null) {}
    for (paramString = (String)localObject + paramString;; paramString = (String)localObject)
    {
      localObject = new agdt(this, (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
      this.jdField_a_of_type_Bafb.setPositiveButton(str, (DialogInterface.OnClickListener)localObject);
      this.jdField_a_of_type_Bafb.setNegativeButton(paramString, (DialogInterface.OnClickListener)localObject);
      this.jdField_a_of_type_Bafb.setOnKeyListener(new agdu(this));
      this.jdField_a_of_type_Bafb.show();
      return;
    }
  }
  ...
  protected void e()
  {
    ...
    this.jdField_b_of_type_Bafb = babr.a(this.jdField_a_of_type_AndroidAppActivity, 230);
    this.jdField_b_of_type_Bafb.setMessage(ajjy.a(2131647802));
    this.jdField_b_of_type_Bafb.setTitle(2131626648);
    agdv localagdv = new agdv(this);
    this.jdField_b_of_type_Bafb.setNegativeButton(2131625035, localagdv);
    this.jdField_b_of_type_Bafb.setPositiveButton(2131653589, localagdv);
    this.jdField_b_of_type_Bafb.show();
  }
