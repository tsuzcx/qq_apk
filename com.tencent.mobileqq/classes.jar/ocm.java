...
public class ocm
{
  private static MQLruCache<String, ocs> jdField_a_of_type_AndroidSupportV4UtilMQLruCache = new MQLruCache(120);
  private static volatile ocm jdField_a_of_type_Ocm;
  public Long a;
  ...
  private String a(ArticleCenter.GetUrlByVidResponse paramGetUrlByVidResponse)
  {
    ...
    for (;;)
    {
      ...
      return localObject1;
      localObject1 = paramGetUrlByVidResponse;
      ndn.a(null, null, "0X8009824", "0X8009824", 0, 0, "", "", "", "", false);
      return paramGetUrlByVidResponse;
      localObject1 = localException2;
      ndn.a(null, null, "0X8009825", "0X8009825", 0, 0, "", "", "", "", false);
      return null;
    }
    label482:
    return null;
  ...
  public static ocm a()
  {
    if (jdField_a_of_type_Ocm == null) {}
    try
    {
      if (jdField_a_of_type_Ocm == null) {
        jdField_a_of_type_Ocm = new ocm();
      }
      return jdField_a_of_type_Ocm;
    }
    finally {}
  }
  ...
  public static ocs a(String paramString)
  {
    ...
    {
      return paramString;
      localocs = (ocs)jdField_a_of_type_AndroidSupportV4UtilMQLruCache.get(paramString);
      if (localocs == null) {
        break;
      }
      paramString = localocs;
    } while (localocs.a(NetConnInfoCenter.getServerTime()));
    return null;
  }
  
  public static void a(ocs paramocs)
  {
    if ((TextUtils.isEmpty(paramocs.jdField_b_of_type_JavaLangString)) || (TextUtils.isEmpty(paramocs.jdField_a_of_type_JavaLangString))) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("Q.readinjoy.video.TAG", 2, "cache setCache vid : " + paramocs.jdField_b_of_type_JavaLangString + " url:" + paramocs.jdField_a_of_type_JavaLangString);
    }
    paramocs.jdField_a_of_type_Long = NetConnInfoCenter.getServerTime();
    jdField_a_of_type_AndroidSupportV4UtilMQLruCache.put(paramocs.jdField_b_of_type_JavaLangString, paramocs);
  }
  ...
  public static String[] a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          ArrayList localArrayList = axwx.a().a(str2, 1006);
  ...
  public void a(String paramString1, String paramString2, ocp paramocp)
  {
    ...
    do
    {
      ...
      if (TextUtils.isEmpty(paramString1))
      {
        ...
        obz.c(localAppRuntime.getApplication(), obz.a(), true, paramString2.a());
        return;
      }
      localObject1 = a(paramString1);
      if ((localObject1 == null) || (TextUtils.isEmpty(((ocs)localObject1).jdField_a_of_type_JavaLangString))) {
        break;
      }
      if (QLog.isColorLevel()) {
        QLog.d("Q.readinjoy.video.TAG", 2, "cache hit,  getUrlByVid vid : " + paramString1 + " url:" + ((ocs)localObject1).jdField_a_of_type_JavaLangString + ((ocs)localObject1).toString());
      }
    } while (paramocp == null);
    this.jdField_a_of_type_JavaLangLong = Long.valueOf(0L);
    paramocp.a((ocs)localObject1);
    return;
    long l = System.currentTimeMillis();
    Object localObject1 = new NewIntent(localAppRuntime.getApplication(), ndt.class);
    ...
    localGetUrlByVidRequest.mv.set(ByteStringMicro.copyFromUtf8("8.2.6,3,4370"));
    int i = bbth.a(null);
    localGetUrlByVidRequest.net_type.set(i);
    localGetUrlByVidRequest.video_type.set(0);
    localObject2 = pza.a(false);
    ...
    ((NewIntent)localObject1).setObserver(new ocn(this, (NewIntent)localObject1, l, paramString1, paramocp, paramString2, localAppRuntime));
    localAppRuntime.startServlet((NewIntent)localObject1);
  }
  
  public void a(String paramString, ocq paramocq)
  {
    AppRuntime localAppRuntime = obz.a();
    if ((localAppRuntime == null) || (localAppRuntime.getApplication() == null))
    {
      if (paramocq != null) {
        paramocq.a(paramString, "");
      }
      return;
    }
    long l = System.currentTimeMillis();
    NewIntent localNewIntent = new NewIntent(localAppRuntime.getApplication(), ndt.class);
    ...
    localGetVidByUrlRequest.mv.set(ByteStringMicro.copyFromUtf8("8.2.6,3,4370"));
    localNewIntent.putExtra("data", localGetVidByUrlRequest.toByteArray());
    localNewIntent.setObserver(new oco(this, l, localNewIntent, paramocq, paramString));
