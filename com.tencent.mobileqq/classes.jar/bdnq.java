  ...
  implements View.OnClickListener
{
  ...
  public bdnq(AbsShareMsg paramAbsShareMsg) {}
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject5 = new bdns(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, localQQAppInterface, paramView);
    ...
    if ("app".equals(localObject2)) {
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgActionData != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgActionData.startsWith("comic_plugin.apk")))
      {
        ...
        localObject3 = ahsj.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgActionData);
    ...
    for (;;)
    {
      blrb.a(null, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.uin, localContext, "3009", "2", "40059", localObject3[0], new String[] { localObject3[2], localObject3[4], localObject2 });
      localObject2 = "";
      label527:
      bjgx.a().a(localQQAppInterface.getAccount(), "", String.valueOf(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceAppid), "1000", "80", "0", false);
      label557:
      nwo.a(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.uin, "sourceclick", this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceAppid, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID, (String)localObject2);
      bdla.b(localQQAppInterface, "CliOper", "", "", "0X800567C", "0X800567C", 0, 0, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID + "", "", "", "");
      bdla.b(localQQAppInterface, "CliOper", "", "", "0X8004B5C", "0X8004B5C", 1, 0, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID + "", "", "", "");
      bdla.b(localQQAppInterface, "dc00898", "", "", "0X8007C39", "0X8007C39", 0, 0, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID + "", "", this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceName, "");
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.adverSign == 1) {
        bdla.b(localQQAppInterface, "P_CliOper", "Pb_account_lifeservice", this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.uin, "0X800631F", "0X800631F", 0, 0, "" + this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.msgId, "", "", "");
      }
      ...
      if (((localAbsShareMsg instanceof StructMsgForGeneralShare)) && (((StructMsgForGeneralShare)localAbsShareMsg).mIsPAVideoStructMsg))
      {
        ...
        {
          localObject2 = (bdnu)((Iterator)localObject5).next();
          if ((localObject2 instanceof bdrp))
          {
            Iterator localIterator = ((bdrp)localObject2).a.iterator();
            bdte localbdte;
            String str2;
            String str3;
            while (localIterator.hasNext())
            {
              ...
              if ((localObject2 instanceof bdte))
              {
                localbdte = (bdte)localObject2;
                if (localbdte.a())
                {
                  localObject2 = new suu(null, ((StructMsgForGeneralShare)localObject3).source_puin, localbdte.ae, localbdte.aj);
                  ((suu)localObject2).a("aio_app_id", Long.valueOf(((StructMsgForGeneralShare)localObject3).mSourceAppid));
                  str2 = ((suu)localObject2).a().a();
                  localObject2 = "";
                  if (((StructMsgForGeneralShare)localObject3).uinType != 1008) {
                    break label2181;
                  }
                  localObject2 = "1";
                  olh.a(null, "CliOper", "", "", "0X80065FE", "0X80065FE", 0, 0, (String)localObject2, Integer.toString(omx.a(localbdte.v, ((StructMsgForGeneralShare)localObject3).mSourceName)), "", str2, false);
            ...
            for (localObject2 = localbdte.aj;; localObject2 = "0")
            {
              olh.a(localQQAppInterface, str3, "0x8007410", "0x8007410", 0, 0, "1", "", (String)localObject2, str2, false);
              break label919;
              break label876;
              ...
              break;
              if (((bdns)localObject5).a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceUrl, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSource_A_ActionData))
              {
                localObject3 = "run";
                if (localAbsShareMsg.mSourceAppid == -1L) {}
                for (localObject2 = "";; localObject2 = String.valueOf(localAbsShareMsg.mSourceAppid))
                {
                  bdla.b(null, "dc00898", "", "", "0X800A86D", "0X800A86D", 0, 0, (String)localObject2, "", "", "");
                  localObject2 = localObject3;
                  break;
                }
              }
              if (((bdns)localObject5).a(((FragmentActivity)localContext).getActivity(), this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceAppid, localAbsShareMsg.mSourceName, localAbsShareMsg.mSourceActionData, localAbsShareMsg.mSource_A_ActionData))
              {
                localObject3 = "setup";
                if (localAbsShareMsg.mSourceAppid == -1L) {}
                for (localObject2 = "";; localObject2 = String.valueOf(localAbsShareMsg.mSourceAppid))
                {
                  bdla.b(null, "dc00898", "", "", "0X800A86E", "0X800A86E", 0, 0, (String)localObject2, "", "", "");
                  localObject2 = localObject3;
                  break;
                }
              }
              ((bdns)localObject5).a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceUrl);
              localObject2 = "setup";
              break label527;
              if ("web".equals(localObject2))
              {
                ...
                if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID == 114)
                {
                  ...
                  localObject3 = bhey.a(localQQAppInterface, localContext, (String)localObject2);
                  if (localObject3 == null) {
                    break label1634;
                  }
                  ((bheh)localObject3).a();
                  bdla.b(null, "P_CliOper", "Pb_account_lifeservice", "", "aio_msg_url", "aio_url_clickqq", 0, 1, 0, (String)localObject2, "", "", "");
                }
                for (;;)
                {
                  localObject2 = "setup";
                  ...
                  localObject3 = String.format("%s&gc=%s", new Object[] { localObject3, axqj.a(localAbsShareMsg.uin) });
                  localObject2 = localObject3;
                  if (!QLog.isColorLevel()) {
                    break label1440;
                  }
                  ...
                  break label1481;
                  label1661:
                  if ((!TextUtils.isEmpty((CharSequence)localObject2)) && (tto.b((String)localObject2))) {
                    tto.a(localContext, null, tto.b((String)localObject2), null);
                  } else {
                    ((bdns)localObject5).a((String)localObject2);
                  }
                }
              }
              if ("plugin".equals(localObject2))
              {
                ...
                {
                  this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData = aqwc.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData, localAbsShareMsg.uin);
                  boolean bool = aqwc.a(localQQAppInterface, localAbsShareMsg.uin, false);
                  ...
                  if ((bool) && (!TextUtils.isEmpty((CharSequence)localObject2)) && ((localContext instanceof FragmentActivity)))
                  {
                    ...
                    if (localObject5 != null)
                    {
                      ...
                      {
                        localObject3 = "https://ti.qq.com/honest-say/group.html?_bid=3104&_qStyle=1&_wv=9191&_nav_alpha=0&_nav_txtclr=FFFFFF&_nav_titleclr=FFFFFF&_nav_anim=true&_wwv=128&gc=$GCODE$&src_type=share&from=appstore_aio&adtag=qq_to_qq".replace("$GCODE$", axqj.a(localAbsShareMsg.uin));
                        if (QLog.isColorLevel()) {
                        ...
                        aqwc.a((TroopChatPie)localObject2);
                      }
                    }
                  }
                  if (!bool) {
                    QQToast.a(BaseApplicationImpl.getContext(), aqwc.a, 0).a();
                  }
                  if (QLog.isColorLevel()) {
                ...
                for (;;)
                {
                  ...
                  catch (Exception localException2)
                  {
                    for (;;)
                    {
                      ...
                      continue;
                      olh.a(null, "", "0X8007756", "0X8007756", 0, 0, "", this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl, "", "", false);
                    }
                  }
                  if (TextUtils.isEmpty((CharSequence)localObject2)) {
                    break label2118;
                  }
                  olh.a(null, "", "0X8007756", "0X8007756", 0, 0, (String)localObject2, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl, "", "", false);
                  localObject2 = "plugin";
                  break;
                  ((bdns)localObject5).c(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSource_A_ActionData);
                }
              }
              ((bdns)localObject5).a((String)localObject2, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceUrl, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSourceActionData, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mSource_A_ActionData);
              break label557;
      ...
      label2118:
      Object localObject4 = bhey.a(localQQAppInterface, localContext, localAbsShareMsg.mMsg_A_ActionData);
      label2181:
      label2232:
      if (localObject4 == null) {
        break;
      }
      localObject2 = ((bheh)localObject4).b("usertype");
      localObject4 = ((bheh)localObject4).b("unionid");
      ...
      ykv.a("share_uin_obj", "clk_tail", 0, i, new String[] { localObject4 });
      break;
      label2358:
      String str1 = "";
    }
