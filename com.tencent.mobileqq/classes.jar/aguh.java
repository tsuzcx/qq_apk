  ...
  extends ClickableSpan
{
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        j = ((antp)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.DISCUSSION_MANAGER)).a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin);
        i = 2;
      }
