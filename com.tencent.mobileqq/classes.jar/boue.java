  ...
  extends botu
{
  ...
  public boue(@NonNull bpik parambpik)
  {
    super(parambpik);
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)LayoutInflater.from(a()).inflate(2131562276, localRelativeLayout, false));
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, AIOUtils.dp2px(40.0F, a()));
    LinearLayout localLinearLayout = this.jdField_a_of_type_AndroidWidgetLinearLayout;
    if (this.jdField_a_of_type_Bpik.k)
    {
      i = 0;
  ...
  private void c()
  {
    if ((this.jdField_b_of_type_Long < 0L) && (this.jdField_a_of_type_Bpik.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer != null) && (this.jdField_a_of_type_Bpik.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer.a() != null))
    {
      this.jdField_b_of_type_Long = this.jdField_a_of_type_Bpik.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer.a().mDuration;
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer = this.jdField_a_of_type_Bpik.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer;
      ...
      this.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130847696);
    ...
    this.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130847695);
  ...
  {
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer != null) {
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer.aG_();
    }
    if (this.jdField_a_of_type_Boje != null) {
  ...
  public void a()
  {
    super.a();
    b();
    this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewRotationSeekBar = ((RotationSeekBar)a(2131365929));
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)a(2131365930));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131365931));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131365928));
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new bouf(this));
