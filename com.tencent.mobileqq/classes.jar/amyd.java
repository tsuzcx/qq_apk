  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      bool = false;
      paramIntent = (amxv)getAppRuntime().getManager(214);
      if (!bool) {
        break label505;
      }
    }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      while (!QLog.isColorLevel())
      {
        ...
        localObject1 = bakc.a(paramIntent.toByteArray());
        break;
        ...
        localObject1 = bakc.a(paramIntent.getStringExtra("key_report_content").getBytes());
        if (!QLog.isColorLevel()) {
          break label676;
        }
