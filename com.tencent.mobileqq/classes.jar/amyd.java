...
public class amyd
{
  ...
  public static int a(long paramLong, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    int i = -1;
    amyo localamyo = amwn.b(paramLong);
    if (localamyo != null) {
      i = localamyo.a();
    }
  ...
  private static boolean a(long paramLong, String paramString1, String paramString2, boolean paramBoolean, int paramInt)
  {
    if (paramString1.equals("cs.check_pubAccount_state.local")) {
      a(paramString1, paramString2, paramBoolean, new amye(paramLong), paramInt);
    }
    label199:
    do
    {
      ...
      do
      {
        do
        {
          ...
          {
            a(paramString1, paramString2, paramBoolean, new amyf(paramLong), paramInt);
            return false;
          }
          if (!paramString1.equals("cs.get_dress_path.local")) {
            break label199;
          }
          localObject2 = new amyg(paramLong, paramString1);
          try
          {
            amyo localamyo = amwn.b(paramLong);
            str = paramString2;
            if (localamyo != null)
            {
              ...
              {
                localJSONObject.put("gameId", localamyo.a());
        ...
        Object localObject1 = new amyh(paramLong);
  ...
  public static boolean a(long paramLong, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        amzc localamzc = amwn.a(paramLong);
        if (localamzc != null)
        {
          paramBoolean = localamzc.a(paramLong, paramBoolean, paramString1, paramString2);
          return paramBoolean;
        }
      }
