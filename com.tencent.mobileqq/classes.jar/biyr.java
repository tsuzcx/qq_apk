...
public class biyr
{
  private static final String a = bjdq.a("largeIntentTmp");
  ...
  public static android.content.Intent a(Context paramContext)
  {
    ...
    //   3: astore_1
    //   4: aload_0
    //   5: invokestatic 26	biyr:a	(Landroid/content/Context;)Ljava/io/File;
    //   8: astore_0
    //   9: aload_0
    ...
    //   206: aload_0
    //   207: aastore
    //   208: invokestatic 50	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   211: new 34	android/content/Intent
    //   214: dup
    //   215: invokespecial 37	android/content/Intent:<init>	()V
    //   218: astore_0
    //   219: aload_2
    //   220: ifnull +7 -> 227
    //   223: aload_2
    //   224: invokevirtual 98	android/os/Parcel:recycle	()V
    //   227: aload_0
    //   228: astore_2
    //   229: aload_1
    //   230: ifnull -180 -> 50
    //   233: aload_1
    //   234: invokevirtual 101	java/io/InputStream:close	()V
    //   237: aload_0
    //   238: areturn
    //   239: astore_1
    //   240: ldc 42
    ...
    //   254: aload_1
    //   255: aastore
    //   256: invokestatic 50	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   259: aload_0
    //   260: areturn
    //   261: astore_0
    //   262: aconst_null
    ...
    //   267: ifnull +7 -> 274
    //   270: aload_2
    //   271: invokevirtual 98	android/os/Parcel:recycle	()V
    //   274: aload_1
    //   275: ifnull +7 -> 282
    //   278: aload_1
    //   279: invokevirtual 101	java/io/InputStream:close	()V
    //   282: aload_0
    //   283: athrow
    //   284: astore_1
    //   285: ldc 42
    ...
    //   299: aload_1
    //   300: aastore
    //   301: invokestatic 50	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   304: goto -22 -> 282
    //   307: astore_3
    //   308: aconst_null
    //   309: astore_2
  ...
  public static void a(android.content.Intent paramIntent, Context paramContext)
  {
    ...
    //   23: astore 4
    //   25: aload_1
    //   26: invokestatic 26	biyr:a	(Landroid/content/Context;)Ljava/io/File;
    //   29: astore 5
    //   31: aconst_null
    //   32: astore_1
    //   33: aconst_null
