  ...
  implements afal
{
  ...
  public afcc(BaseChatPie paramBaseChatPie)
  {
  ...
  private boolean a(BaseChatPie paramBaseChatPie)
  {
    ...
    {
      boolean bool4 = bdal.b(localSessionInfo.jdField_a_of_type_JavaLangString);
      boolean bool5 = bcgx.b(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localSessionInfo.jdField_a_of_type_JavaLangString);
      bool2 = bool1;
      if (!bool4)
      {
        bool2 = bool1;
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130838255);
      if (QLog.isColorLevel()) {
      ...
      if (Math.abs(paramInt) >= 20) {
        ...
        else if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_Int == 0) && (!this.jdField_c_of_type_Boolean) && (!this.jdField_b_of_type_Boolean))
        {
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130837737);
