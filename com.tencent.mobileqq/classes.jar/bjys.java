  ...
  implements azhm
{
  ...
  bjys(String paramString, int paramInt1, int paramInt2)
  {
  ...
  public azhn a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localazhn.jdField_a_of_type_Float = (m / k);
        localazhn.jdField_a_of_type_Int = ((int)(this.jdField_a_of_type_Int * localazhn.jdField_a_of_type_Float * localazhn.jdField_a_of_type_Float + 0.5F));
        if (localazhn.jdField_a_of_type_Int <= i * 1024) {
          break label382;
        }
        localazhn.jdField_a_of_type_Int = (i * 1024);
        paramInt2 = paramInt1;
        ...
        if (QLog.isColorLevel()) {
          QLog.d("TroopHomeworkHelper", 2, "CompressTask, step: getEncodeConfig() config.setRotation = " + localazhn.jdField_b_of_type_Boolean);
        }
        return localazhn;
      }
      ...
      continue;
      label382:
      if (localazhn.jdField_a_of_type_Int < j * 1024)
      {
        localazhn.jdField_a_of_type_Int = (j * 1024);
        continue;
        paramInt2 = 0;
        paramInt1 = 0;
        j = 0;
