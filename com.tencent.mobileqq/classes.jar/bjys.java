  ...
  implements bjqx
{
  ...
  private String a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString)) {
      return bjxu.a(paramString, 200, 200, true);
    }
    return "";
  }
  ...
  private void a(String paramString, Bundle paramBundle, bjyw parambjyw)
  {
    Bundle localBundle;
    if ((paramBundle != null) && (parambjyw != null))
    {
    ...
    try
    {
      parambjyw.a(paramBundle, localBundle);
      if (paramString != null) {
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.callJs(paramString, new String[] { paramBundle.toString() });
      }
      return;
    }
    catch (Throwable parambjyw)
    {
      for (;;)
      {
        QLog.e("QzoneRecommedPhotoJsPlugin", 1, "onCallJsBridge.setData error", parambjyw);
      }
    }
  }
  ...
  private void a(String paramString1, String paramString2, Runnable paramRunnable, boolean paramBoolean)
  {
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bjze.class).post(paramRunnable);
      return;
    }
  ...
  private void b(String paramString)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bjze.class).post(new QzoneRecommedPhotoJsPlugin.2(this));
      }
      return;
    }
  ...
  private void c(String paramString)
  {
    try
    {
      ...
      bjdt.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), bjea.a(), localIntent, 0);
      return;
    }
    catch (Exception paramString)
    {
