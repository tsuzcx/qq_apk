...
{
  public xzj(TroopMemberListInnerFrame paramTroopMemberListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.a.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130971512, paramViewGroup, false);
      paramView = new xzk(this.a, null);
    ...
    paramViewGroup = (xzk)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
    ...
    paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131435980), new Object[] { paramView.toLowerCase() }));
    return localView;
  }
}
