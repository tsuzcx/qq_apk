...
public final class bfng
  implements Handler.Callback, bfmw, bicf, bidf, DownloadListener
{
  private static bfng jdField_a_of_type_Bfng;
  private int jdField_a_of_type_Int;
  private bfmv jdField_a_of_type_Bfmv;
  private bfnh jdField_a_of_type_Bfnh;
  ...
  private WeakReference<bfni> jdField_a_of_type_JavaLangRefWeakReference;
  private final ArrayList<bfnj> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  public boolean a;
  ...
  private int a(int paramInt1, int paramInt2)
  {
    ...
    String str;
    Bundle localBundle;
    if ((this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper != null) && (this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bfnl != null) && (this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bfnl.jdField_a_of_type_JavaLangString != null))
    {
      str = this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bfnl.jdField_a_of_type_JavaLangString;
      localBundle = new Bundle();
      localBundle.putString(bibw.b, "100686848");
      localBundle.putString(bibw.j, this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.strNewSoftwareURL);
      localBundle.putString(bibw.f, this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName());
      localBundle.putInt(bibw.k, paramInt1);
      if (paramInt1 == 12) {
        localBundle.putBoolean(bibw.o, true);
      }
      localBundle.putString(bibw.i, "ANDROIDQQ.QQUPDATE");
      localBundle.putString(bibw.l, str);
      if (paramInt2 == 0) {
        break label319;
      }
      localBundle.putString(bibw.m, "_100686848");
    ...
    {
      localBundle.putString(bibw.jdField_c_of_type_JavaLangString, "6633");
      localBundle.putInt(bibw.e, this.jdField_a_of_type_Int);
      localBundle.putBoolean(bibw.g, true);
      localBundle.putBoolean(bibw.h, true);
      localBundle.putInt(bibw.n, 1);
      localBundle.putInt(bibw.A, this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.bGray);
      bibs.a(BaseActivity.sTopActivity, localBundle, "biz_src_jc_update", this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail, i);
      return 0;
      str = "新版手Q";
      break;
      label319:
  ...
  public static bfng a()
  {
    if (jdField_a_of_type_Bfng == null) {
      jdField_a_of_type_Bfng = new bfng();
    }
    return jdField_a_of_type_Bfng;
  }
  ...
  public static String a()
  {
    ...
    if (localObject != null)
    {
      localObject = ((bfng)localObject).jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper;
      str1 = str2;
      if (localObject != null)
      {
        str1 = str2;
  ...
  {
    return bjnd.a(paramString, "nt", bfnf.a());
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo != null)) {
        if ((((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iUpgradeType > 0) && (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.bNewSwitch == 1))
        {
          ...
          if (ampt.a(paramQQAppInterface, ((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iNewTimeStamp)) {
            break label96;
          }
          bool1 = bool2;
        }
    ...
    for (;;)
    {
      bool2 = bool1;
      if (!bool1) {
        bool2 = ((avnt)paramQQAppInterface.getManager(244)).a();
      }
      return bool2;
      bool1 = false;
      break;
  ...
  private void b(int paramInt)
  {
    try
    {
      ampt localampt = (ampt)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getRuntime()).getBusinessHandler(4);
      ...
      localampt.a(str, paramInt, this.jdField_a_of_type_JavaLangString);
      return;
    }
    finally
    {
  ...
  {
    paramQQAppInterface = bfnm.a(paramQQAppInterface);
    boolean bool2;
    boolean bool1;
  ...
  private void c(int paramInt)
  {
    ...
    do
    {
      ...
      localbfni = (bfni)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localbfni == null);
    if (this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo != null) {
      localbfni.a(paramInt, this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper, this);
    }
  ...
  private void d(int paramInt)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      if (localIterator.hasNext()) {
        ((bfnj)localIterator.next()).a(paramInt, this);
      }
    }
  }
  ...
  private void g()
  {
    try
    {
      if (!a())
      {
        this.jdField_a_of_type_Bfnh = new bfnh(this);
        this.jdField_a_of_type_Bfnh.a();
      }
      return;
    }
    finally
  ...
  private void h()
  {
    try
    {
      if (a())
      {
        this.jdField_a_of_type_Bfnh.b();
        this.jdField_a_of_type_Bfnh = null;
      }
      return;
    }
    finally
  ...
  private void i()
  {
    ...
    bcef.b((QQAppInterface)localObject, "CliOper", "", "", "0X800716C", "0X800716C", 0, 0, "", "", "", "");
    int i = 0;
  ...
  private void k()
  {
    try
    {
      ...
      if (this.d)
      {
        bide.a().b(this);
        bide.a().a();
        if (this.jdField_a_of_type_Bfmv != null)
        {
          bibs.b(this.jdField_a_of_type_Bfmv);
          this.jdField_a_of_type_Bfmv = null;
        }
  ...
  public void a()
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo != null) && (this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo.jdField_c_of_type_Int == 1))
      {
        ...
        ampt.b(localQQAppInterface, false);
        d(false);
        return;
      }
    } while (this.b);
    b(ampt.a(localQQAppInterface, false));
  }
  ...
  public void a(bfnj parambfnj)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(parambfnj)) {
        this.jdField_a_of_type_JavaUtilArrayList.add(parambfnj);
      }
      return;
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    String str = ampt.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Bfmv == null)
        {
          ...
          this.jdField_a_of_type_Bfmv = new bfmv(paramString2, this);
          bibs.a(this.jdField_a_of_type_Bfmv);
      ...
      if (i != 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bfnl = null;
        c(-1);
      }
    }
  }
  ...
  boolean a()
  {
    return this.jdField_a_of_type_Bfnh != null;
  }
  ...
  {
    // Byte code:
    //   0: new 641	java/io/File
    //   3: dup
    //   4: aload_1
    //   5: invokespecial 644	java/io/File:<init>	(Ljava/lang/String;)V
    //   8: astore_1
    //   9: aload_1
    //   10: invokevirtual 647	java/io/File:exists	()Z
    //   13: ifeq +73 -> 86
    //   16: new 649	java/io/FileInputStream
    //   19: dup
    //   20: aload_1
    //   21: invokespecial 652	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   24: astore_3
    //   25: aload_3
    //   26: astore_1
    //   27: iconst_2
    ...
    //   34: aload_3
    //   35: aload 4
    //   37: invokevirtual 656	java/io/FileInputStream:read	([B)I
    //   40: pop
    //   41: aload 4
    //   43: iconst_0
    //   44: baload
    ...
    //   62: ifnull +7 -> 69
    //   65: aload_3
    //   66: invokevirtual 659	java/io/FileInputStream:close	()V
    //   69: iconst_0
    //   70: ireturn
    //   71: astore_1
    //   72: aload_1
    //   73: invokevirtual 662	java/io/IOException:printStackTrace	()V
    //   76: iconst_0
    //   77: ireturn
    //   78: aload_3
    //   79: ifnull +7 -> 86
    //   82: aload_3
    //   83: invokevirtual 659	java/io/FileInputStream:close	()V
    //   86: iconst_1
    //   87: ireturn
    //   88: astore_1
    //   89: aload_1
    //   90: invokevirtual 662	java/io/IOException:printStackTrace	()V
    //   93: goto -7 -> 86
    //   96: astore 4
    //   98: aconst_null
    //   99: astore_3
    ...
    //   106: ldc 210
    //   108: aload 4
    //   110: invokestatic 664	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   113: aload_3
    //   114: ifnull -28 -> 86
    //   117: aload_3
    //   118: invokevirtual 659	java/io/FileInputStream:close	()V
    //   121: goto -35 -> 86
    //   124: astore_1
    //   125: aload_1
    //   126: invokevirtual 662	java/io/IOException:printStackTrace	()V
    //   129: goto -43 -> 86
    //   132: astore_3
    //   133: aconst_null
    //   134: astore_1
    ...
    //   136: ifnull +7 -> 143
    //   139: aload_1
    //   140: invokevirtual 659	java/io/FileInputStream:close	()V
    //   143: aload_3
    //   144: athrow
    //   145: astore_1
    //   146: aload_1
    //   147: invokevirtual 662	java/io/IOException:printStackTrace	()V
    //   150: goto -7 -> 143
    //   153: astore_3
    //   154: goto -19 -> 135
    //   157: astore 4
  ...
  public boolean a(UpgradeInfo paramUpgradeInfo, bfni parambfni)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bfnl = ampt.a(paramUpgradeInfo);
    if ((parambfni == null) || (paramUpgradeInfo == null)) {
      return false;
    }
    ...
    j();
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambfni);
    if (QLog.isColorLevel()) {
      QLog.d("UpgradeController", 2, "handleUpgradeInfo packageName = " + this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName() + ", bGray = " + paramUpgradeInfo.bGray + ", versioncode = " + this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bfnl.jdField_a_of_type_Int);
    }
    paramUpgradeInfo = new ApkUpdateParam(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName(), paramUpgradeInfo.bGray, this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bfnl.jdField_a_of_type_Int);
    parambfni = new ArrayList();
    parambfni.add(paramUpgradeInfo);
    bide.a().b(parambfni);
    return true;
  }
  ...
  public void b(bfnj parambfnj)
  {
    ...
    {
      if (this.jdField_a_of_type_JavaUtilArrayList.contains(parambfnj)) {
        this.jdField_a_of_type_JavaUtilArrayList.remove(parambfnj);
      }
      return;
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    ampt.b(localQQAppInterface, paramBoolean);
    if (paramBoolean)
    {
      g();
      return;
  ...
  public void c()
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 324	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   5: ifeq +13 -> 18
    //   8: ldc_w 326
    //   11: iconst_2
    //   12: ldc_w 772
    //   15: invokestatic 340	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   18: aload_0
    //   19: getfield 243	bfng:b	Z
    //   22: ifeq +21 -> 43
    //   25: aload_0
    //   26: iconst_0
    //   27: putfield 243	bfng:b	Z
    //   30: aload_0
    //   31: invokevirtual 774	bfng:e	()V
    //   34: aload_0
    //   35: invokespecial 776	bfng:h	()V
    //   38: ldc 138
    //   40: invokestatic 778	bibs:a	(Ljava/lang/String;)V
    //   43: aload_0
    //   44: monitorexit
    //   45: return
    //   46: astore_1
  ...
  public void onDownloadFinish(DownloadInfo paramDownloadInfo)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
      ...
      {
        paramDownloadInfo = biby.a().a(paramDownloadInfo);
        localObject1 = localObject2;
    ...
    for (;;)
    {
      int k = aqmy.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl);
      ...
      for (i = 101;; i = 9527)
      {
        ...
        this.jdField_a_of_type_Bjng.sendEmptyMessage(0);
        return;
  ...
  public void onException(String paramString)
  {
    ...
    b(this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bfnl.jdField_a_of_type_Int);
  }
  ...
  public void onResult(ArrayList<ApkUpdateDetail> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      {
        if (this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bfnl.jdField_a_of_type_Int == paramArrayList.versioncode) {
