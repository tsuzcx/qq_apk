...
public class adbg
  extends Handler
{
  public adbg(ChatSettingForTroop paramChatSettingForTroop) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopColorNick))
      {
        ...
        localObject1 = new bczs(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopColorNick, 16).a();
        paramMessage.setRightText((CharSequence)localObject1);
        bgdk.a(this.a.app, paramMessage.a(), (Spannable)localObject1);
        return;
      }
      paramMessage.setRightText(this.a.getString(2131697043));
      bgdk.a(this.a.app, paramMessage.a(), new SpannableString(""));
      return;
    ...
    if (this.a.jdField_c_of_type_AndroidWidgetTextView != null) {
      this.a.jdField_c_of_type_AndroidWidgetTextView.setText(amtj.a(2131700901) + this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.wMemberNum + amtj.a(2131700907));
    }
    this.a.b(true);
    this.a.e();
    this.a.a(this.a.e);
    ...
    for (;;)
    {
      ...
      if ((localObject2 != null) && (((List)localObject2).size() > 0))
      {
        ...
        for (;;)
        {
          if (((Iterator)localObject2).hasNext())
          {
            ...
            continue;
            if ((this.a.jdField_a_of_type_Bfkb == null) || (TextUtils.isEmpty(this.a.jdField_a_of_type_Bfkb.a))) {
              break label1404;
            }
            if (amtj.a(2131700894).equals(this.a.jdField_a_of_type_Bfkb.a))
            {
              i = 0;
              break;
            }
            paramMessage = this.a.jdField_a_of_type_Bfkb.a;
            i = 1;
            break;
          }
        }
      ...
      {
        localObject2 = (FormSimpleItem)localView2.findViewById(2131369032);
        localSwitch = ((FormSwitchItem)localView1).a();
        localObject3 = (TextView)localView2.findViewById(2131368716);
        ((TextView)localObject3).setBackgroundResource(2130839477);
        localObject1 = "";
        paramMessage = "";
        Boolean localBoolean = (Boolean)this.a.jdField_a_of_type_Bfyq.c.get(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
        ...
        localView1.setBackgroundResource(2130839482);
      ...
      for (;;)
      {
        ...
        ((TextView)localObject3).setTextColor(this.a.getResources().getColor(2131167092));
        avnu.a().c(this.a.app, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
        return;
        label1045:
        localView1.setBackgroundResource(2130839485);
        localView1.getBackground().setAlpha(255);
        if (!localSwitch.isChecked())
        {
          localSwitch.setTag(Boolean.TRUE);
        ...
        default: 
          ...
          break;
        case 2: 
          localObject1 = this.a.getString(2131697116);
          paramMessage = this.a.getString(2131697118);
          break;
        case 3: 
          localObject1 = this.a.getString(2131692864);
          paramMessage = this.a.getString(2131697114);
          break;
        case 4: 
          localObject1 = this.a.getString(2131697120);
          paramMessage = this.a.getString(2131697122);
          break;
          label1204:
          localView2.setVisibility(0);
          localView1.setBackgroundResource(2130839485);
      ...
      {
        localObject1 = (TextView)paramMessage.findViewById(2131378707);
        ...
        paramMessage = (ProgressBar)paramMessage.findViewById(2131372965);
        if (paramMessage != null) {
      ...
      if (i == 0) {}
      for (paramMessage = null;; paramMessage = this.a.getResources().getDrawable(2130850321))
      {
