...
public class adbg
{
  ...
  public static ArrayList<adbg> a(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    try
    {
      paramString = new JSONArray(adbk.a(paramString));
      int i = 0;
      while (i < paramString.length())
      {
        adax.b("KingKongSubPatch", "Parsing sub patch " + i);
        adbg localadbg = new adbg();
        if (localadbg.a(paramString.getJSONObject(i)))
        {
          localadbg.a();
          localArrayList.add(localadbg);
          i += 1;
        }
        else
        {
          adax.a("KingKongSubPatch", "Parse sub patch failed, give up");
          return null;
        }
      }
    ...
    {
      adax.a("KingKongSubPatch", "Parse SubPatch List exception : " + paramString);
    }
    return null;
  }
  ...
  public void a()
  {
    ...
    while (i < this.c.size())
    {
      adax.b("KingKongSubPatch", "--> HookPoints : " + this.c.get(i));
      i += 1;
    }
    i = 0;
    int j;
    for (;;)
    {
      ...
      adax.b("KingKongSubPatch", "--> Parameters : " + ((Integer)this.jdField_a_of_type_JavaUtilArrayList.get(i)).toString());
      i += 1;
    }
    while (j < this.b.size())
    {
      adax.b("KingKongSubPatch", "--> FingerPrint : " + (String)this.b.get(j) + ", " + this.d.get(j));
      j += 1;
    }
  }
  ...
  public boolean a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        adax.a("KingKongSubPatch", "Fingerprint value count mismatch " + n + ", " + k);
        return false;
      }
      catch (JSONException paramJSONObject)
      {
        ...
        int k;
        int j;
        adax.a("KingKongSubPatch", "Parse SubPatch error : " + paramJSONObject);
        return false;
      }
