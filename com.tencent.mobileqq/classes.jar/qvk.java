...
public class qvk
{
  private static qvk jdField_a_of_type_Qvk;
  ...
  private Map<qtr, Boolean> jdField_a_of_type_JavaUtilMap = new WeakHashMap();
  private Timer jdField_a_of_type_JavaUtilTimer;
  private qvl jdField_a_of_type_Qvl;
  private qvm jdField_a_of_type_Qvm;
  private qvn jdField_a_of_type_Qvn;
  ...
  public static qvk a()
  {
    if (jdField_a_of_type_Qvk == null) {}
    try
    {
      if (jdField_a_of_type_Qvk == null) {
        jdField_a_of_type_Qvk = new qvk();
      }
      return jdField_a_of_type_Qvk;
    }
    finally {}
  }
  ...
  public void a(Activity paramActivity)
  {
    ...
    if (this.jdField_a_of_type_Qvn == null) {
      this.jdField_a_of_type_Qvn = new qvn(this, null);
    }
    ...
    this.l = true;
    BaseApplicationImpl.getApplication().getBaseContext().registerReceiver(this.jdField_a_of_type_Qvn, paramActivity);
    if (this.jdField_a_of_type_Qvl == null) {
      this.jdField_a_of_type_Qvl = new qvl(this);
    }
    ThreadManager.excute(new VideoVolumeControl.2(this), 16, null, true);
    if (this.jdField_a_of_type_Qvm == null) {
      this.jdField_a_of_type_Qvm = new qvm(this);
    }
  ...
  public void a(qtr paramqtr)
  {
    ...
    {
      paramqtr.b(b());
      if (!this.jdField_a_of_type_JavaUtilMap.containsKey(paramqtr)) {
        this.jdField_a_of_type_JavaUtilMap.put(paramqtr, Boolean.valueOf(true));
      }
      paramqtr.a(this.jdField_a_of_type_Qvm);
    }
    if (QLog.isColorLevel()) {
      QLog.d("Q.readinjoy.video.VideoVolumeControl", 2, "addVideoManager :" + paramqtr + " list:" + this.jdField_a_of_type_JavaUtilMap);
    }
  }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    //   2: aload_0
    //   3: iload_1
    //   4: putfield 149	qvk:k	Z
    //   7: aload_0
    //   8: getfield 75	qvk:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   11: ifnull +82 -> 93
    //   14: aload_0
    //   15: getfield 89	qvk:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   18: ifnull +75 -> 93
    ...
    //   63: aload_0
    //   64: getfield 75	qvk:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   67: aload_0
    //   68: getfield 89	qvk:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   71: invokevirtual 336	android/os/Handler:removeCallbacks	(Ljava/lang/Runnable;)V
    //   74: aload_0
    //   75: getfield 149	qvk:k	Z
    //   78: ifeq +18 -> 96
    //   81: aload_0
    //   82: getfield 75	qvk:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   85: aload_0
    //   86: getfield 89	qvk:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    ...
    //   95: return
    //   96: aload_0
    //   97: getfield 75	qvk:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   100: aload_0
    //   101: getfield 89	qvk:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   104: ldc2_w 175
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if ((paramInt == 1) || (paramInt == 0))
    {
      ...
      Object localObject;
      for (boolean bool1 = false; paramString.hasNext(); bool1 = ((qtr)localObject).b() | bool1)
      {
        localObject = (qtr)paramString.next();
        if (localObject == null) {
          break label455;
        }
        ((qtr)localObject).b(paramBoolean);
      }
    ...
    for (;;)
    {
      try
      {
        if (paramInt < this.jdField_a_of_type_JavaUtilArrayList.size())
        {
          ...
          ((ImageView)paramString.get()).setImageDrawable(((ImageView)paramString.get()).getResources().getDrawable(2130842483));
          ((ImageView)paramString.get()).setContentDescription(ajya.a(2131716463));
        }
      }
      ...
      return;
      label404:
      ((ImageView)paramString.get()).setImageDrawable(((ImageView)paramString.get()).getResources().getDrawable(2130842484));
      ((ImageView)paramString.get()).setContentDescription(ajya.a(2131716464));
      break label464;
      label449:
      paramInt = n;
      break label246;
  ...
  public void b(Activity paramActivity)
  {
    if (this.jdField_b_of_type_JavaLangString.equals(paramActivity.toString()))
    {
      ...
      if (!"".equals(this.jdField_b_of_type_JavaLangString))
      {
        BaseApplicationImpl.getApplication().getBaseContext().unregisterReceiver(this.jdField_a_of_type_Qvn);
        ThreadManager.excute(new VideoVolumeControl.4(this), 16, null, true);
      }
      this.jdField_a_of_type_Qvm = null;
      this.jdField_a_of_type_Qvn = null;
  ...
  public void b(qtr paramqtr)
  {
    if (paramqtr != null) {
      this.jdField_a_of_type_JavaUtilMap.remove(paramqtr);
    }
    if (QLog.isColorLevel()) {
      QLog.d("Q.readinjoy.video.VideoVolumeControl", 2, "removeVideoManager :" + paramqtr + " list:" + this.jdField_a_of_type_JavaUtilMap);
    }
  }
