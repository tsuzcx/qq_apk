...
public class aqiq
  implements agin, Handler.Callback, aqim
{
  ...
  private bioi jdField_a_of_type_Bioi = new aqir(this);
  ...
  public aqiq(BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mContext, new blff());
  ...
  private void a(float paramFloat1, float paramFloat2)
  {
    ...
    if ((f1 > this.jdField_a_of_type_Int) || (paramFloat2 > this.jdField_a_of_type_Int))
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getAdapter() instanceof blcj))
      {
        ListAdapter localListAdapter = ((blcj)this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getAdapter()).getWrappedAdapter();
        if ((localListAdapter instanceof afqz)) {
          ((afqz)localListAdapter).d();
        }
      }
  ...
  private void a(MotionEvent paramMotionEvent)
  {
    ...
    if (((localView instanceof BaseChatItemLayout)) && (a(((BaseChatItemLayout)localView).findViewById(2131364522), paramMotionEvent)))
    {
      this.jdField_a_of_type_AndroidViewView = localView;
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131364545);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(View paramView, int paramInt)
  {
    ...
    if (!this.jdField_e_of_type_Boolean) {
      if (paramInt >= i)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new aqis(this));
  ...
  private void b()
  {
    if (!b())
    {
      ...
      if (localObject != null)
      {
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app, "dc00898", "", "", "0X800A92F", "0X800A92F", a((ChatMessage)localObject), b((ChatMessage)localObject), "", "", "", "");
        ...
        if ((localObject instanceof MessageForStructing))
        {
          ...
          if ((((MessageForStructing)localObject).structingMsg != null) && (((MessageForStructing)localObject).structingMsg.mMsgServiceID == 81) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app != null)) {
            ykv.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app, this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mContext, (MessageForStructing)localObject, "reply");
          }
        }
      }
    }
  ...
  private void b(int paramInt)
  {
    ...
    if (paramInt >= a())
    {
      ...
      {
        bool = bgzw.b(BaseApplicationImpl.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app);
  ...
  private boolean b()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.sessionInfo.curType == 1) && (((bgkf)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app.getManager(QQManagerFactory.TROOP_GAG_MANAGER)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.sessionInfo.curFriendUin, true).jdField_a_of_type_Boolean))
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app.getApp(), 2131697134, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mContext.getResources().getDimensionPixelSize(2131299080));
      return true;
    }
    return false;
  }
  ...
  private boolean c()
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Aqit != null) && (aqit.a(this.jdField_a_of_type_Aqit, localChatMessage))) {
        return aqit.b(this.jdField_a_of_type_Aqit, localChatMessage);
      }
  ...
  private boolean c(MotionEvent paramMotionEvent)
  {
    ...
    for (int i = 1; i != 0; i = 0)
    {
      ...
      boolean bool = a(((BaseChatItemLayout)localView).findViewById(2131364522), paramMotionEvent);
      if (QLog.isColorLevel()) {
    ...
    if (this.f == 0)
    {
      ...
      if (this.f != 2)
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioMediaPlayerManager == null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app != null)) {
          this.jdField_a_of_type_ComTencentMobileqqActivityAioMediaPlayerManager = ((MediaPlayerManager)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app.getManager(QQManagerFactory.MGR_MEDIA_PLAYER));
        }
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      if (((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof agab)) || ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof TroopChatPie)) || ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof afzr))) {
        bool = true;
      }
      this.jdField_a_of_type_Boolean = bool;
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app != null) {
        this.jdField_a_of_type_Aqit = new aqit(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app, null);
      }
