...
{
  private static aqxb jdField_a_of_type_Aqxb;
  public static final String a;
  private static ConcurrentHashMap<Integer, ConcurrentHashMap<Integer, aqxd>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bbvj.a(ajsd.aW + ".hiboom_font/");
  ...
  private aqxd b(int paramInt1, int paramInt2, aqxc paramaqxc)
  {
    paramaqxc = new aqxd(paramInt1, paramaqxc);
    ((ConcurrentHashMap)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt2))).put(Integer.valueOf(paramInt1), paramaqxc);
    return paramaqxc;
  }
  
  public aqxd a(int paramInt1, int paramInt2, @Nonnull aqxc paramaqxc)
  {
    try
    {
      ...
      aqxd localaqxd2 = (aqxd)((ConcurrentHashMap)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt2))).get(Integer.valueOf(paramInt1));
      aqxd localaqxd1 = localaqxd2;
      if (localaqxd2 == null) {
        localaqxd1 = b(paramInt1, paramInt2, paramaqxc);
      }
      return localaqxd1;
    }
    finally {}
  ...
  public void a()
  {
    ...
    while (localIterator1.hasNext())
    {
      ...
      while (localIterator2.hasNext()) {
        ((aqxd)((Map.Entry)localIterator2.next()).getValue()).a(false);
      }
    }
  }
  ...
  public void c()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        i = bblj.a(bblj.a(), "libFounderColorFont_818.so");
        if (!QLog.isColorLevel()) {
          break label131;
        }
