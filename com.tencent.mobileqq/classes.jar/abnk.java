  ...
  extends ClickableSpan
{
  ...
  public abnk(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString, int paramInt4, MessageForNearbyMarketGrayTips paramMessageForNearbyMarketGrayTips)
  {
  ...
  public void a(String paramString)
  {
    ...
    if (localQQAppInterface != null)
    {
      ...
      if (((String)localObject).contains("sign=xxx"))
      {
        ...
        paramString = ((String)localObject).replace("sign=xxx", "sign=" + Utils.a(localQQAppInterface.a().m(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.frienduin)));
      }
    ...
    for (;;)
    {
      ...
      if (((String)localObject).equals("https://imgcache.qq.com/club/client/flower/release/html/index.html"))
      {
        ...
        localObject = Utils.a(localQQAppInterface.a().m(paramString));
      ...
      {
        paramString = ((String)localObject).replace("sign=xxx", "sign=" + Utils.a(localQQAppInterface.a().q(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.frienduin)));
        break;
      }
      paramString = (String)localObject;
  ...
  public void c(String paramString)
  {
    ...
    ThreadManager.post(new abno(this, localQQAppInterface), 2, null, false);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        {
          ThreadManager.post(new abnl(this), 5, null, true);
          return;
        }
        c(paramView);
        return;
      ...
      if (FaceScoreUtils.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips, "isFaceScoreSecondMember"))
      {
        paramView = "2";
        if (!FaceScoreUtils.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips, "isFaceScoreSpecialLike")) {
          break label343;
        }
      }
      for (String str = "2";; str = "1")
      {
        FaceScoreUtils.a("clk_hi", this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.frienduin, new String[] { paramView, "", "", str });
        if (this.e != 2147483647) {
          break label350;
        }
        ThreadManager.post(new abnm(this, localQQAppInterface), 5, null, true);
        return;
        paramView = "1";
        break;
      }
      ...
      if (TextUtils.isEmpty(paramView))
      {
        ThreadManager.post(new abnn(this), 5, null, true);
        return;
      }
      c(paramView);
    } while (!QLog.isColorLevel());
