...
public class anxd
  extends anvt<CustomEmotionData>
{
  protected anxd(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private void a(int paramInt, List<FavEmotionOcr.OcrInfo> paramList, ashc paramashc, List<CustomEmotionData> paramList1)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (j < paramList.size())
      {
        ...
        localObject = paramashc.a(paramList1, str);
        int i = k;
        if (localObject != null)
        {
          i = m;
          ...
          if (m != 0)
          {
            paramashc.b((CustomEmotionBase)localObject);
            i = 1;
          }
        }
        j += 1;
    ...
    do
    {
      ...
      if (i < paramList2.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localObject2 = new ashk((String)localObject1);
          if ((!((ashk)localObject2).a()) || (TextUtils.isEmpty(((ashk)localObject2).c)) || (TextUtils.isEmpty(((ashk)localObject2).d)))
          {
            if (QLog.isColorLevel()) {
      ...
      if (i < paramList1.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localashk1 = new ashk((String)localObject2);
          if ((!localashk1.a()) || (TextUtils.isEmpty(localashk1.c)) || (TextUtils.isEmpty(localashk1.d)))
          {
            if (QLog.isColorLevel()) {
            ...
            ((List)localObject1).add(localashk1);
          }
        }
      }
      ...
      {
        localashk1 = (ashk)localArrayList.get(i);
        int j = 0;
        while (j < ((List)localObject1).size())
        {
          ashk localashk2 = (ashk)((List)localObject1).get(j);
          if ((localashk1.c.equals(localashk2.c)) && (localashk2.c.equals("0")) && (localashk2.d.equals(localashk1.d)))
          {
            paramList1.remove(localashk2.a);
            ((StringBuilder)localObject2).append(localashk2.a).append(", ");
          }
          j += 1;
        }
        i += 1;
  ...
  public void a()
  {
    ...
    localPlatInfo.mqqver.set("8.4.5");
  ...
  public void a(CustomEmotionData paramCustomEmotionData, String paramString)
  {
    ...
    if ((this.app == null) || (this.app.getApp() == null))
    {
      ...
      notifyUI(3, false, this.mApp.getApplication().getString(2131691758));
      return;
    }
    if (!bhnv.a())
    {
      notifyUI(3, false, this.app.getApp().getString(2131693371));
      return;
    }
    try
    {
      ...
      ((FavEmotionOcr.ReqBody)localObject1).string_version.set("8.4.5");
  ...
  public void a(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bdmc.a(BaseApplication.getContext()).a(null, "favEmoModifyOcrsSuc", false, 0L, 0L, (HashMap)localObject, null);
        if ((i != 0) && (paramObject.bytes_bodybuffer.has()) && (paramObject.bytes_bodybuffer.get() != null))
        {
          ...
          if (i < paramFromServiceMsg.size())
          {
            ...
            {
              paramObject = ((ashc)this.app.getManager(149)).a();
              if (paramObject != null)
              {
            ...
            {
              notifyUI(3, false, this.mApp.getApplication().getString(2131691764));
              if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (i != 0)
        {
          ...
          bdmc.a(BaseApplication.getContext()).a(null, "favEmoGetOcrSuc", false, 0L, 0L, localHashMap, null);
          if ((i == 0) || (!paramObject.bytes_bodybuffer.has()) || (paramObject.bytes_bodybuffer.get() == null)) {
            break label384;
          }
          paramFromServiceMsg = new FavEmotionOcr.RspBody();
          ...
          if (paramFromServiceMsg.list_ocr_info.has())
          {
            ...
            paramObject = (ashc)this.app.getManager(149);
  ...
  public void a(Object paramObject, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((ashc)this.app.getManager(149)).c(localArrayList);
  ...
  public void a(List<CustomEmotionData> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localReqBody.string_version.set("8.4.5");
  ...
  public void b(List<String> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        ashk localashk = new ashk((String)paramList.next());
        if (!TextUtils.isEmpty(localashk.d)) {
          localArrayList.add(localashk.d);
        }
      }
      if (localArrayList.size() > 0) {
        ((asig)this.app.getManager(141)).a(localArrayList);
      }
    }
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      ...
      if (i == 1)
      {
        paramToServiceMsg = (ashd)this.mApp.getManager(72);
