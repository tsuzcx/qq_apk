...
public class atug
{
  ...
  public atug(String paramString)
  {
    this(paramString, 1);
  }
  
  public atug(String paramString, int paramInt)
  {
    this.c = paramString;
    a(paramInt);
  }
  ...
  public atua a(String paramString1, String paramString2)
  {
    atua localatua = new atua();
    localatua.b = a(this.c + a + File.separator + paramString1);
    localatua.a = a(this.c + a + File.separator + paramString2);
    return localatua;
  }
