...
public class atug
{
  ...
  public atug(QQAppInterface paramQQAppInterface, MessageForShortVideo paramMessageForShortVideo, long paramLong1, long paramLong2)
  {
    this.jdField_a_of_type_Int = badq.a(BaseApplication.getContext());
    this.jdField_a_of_type_Boolean = awer.a(paramQQAppInterface, paramMessageForShortVideo);
  ...
  public void a()
  {
    ...
    {
      awrn.a(BaseApplication.getContext()).a(null, "actVideoMessageTime", bool, 0L, 0L, (HashMap)localObject, "");
      return;
    }
  }
