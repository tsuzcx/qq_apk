  ...
  extends BusinessHandler
{
  ...
  abgp jdField_a_of_type_Abgp = null;
  private bmip jdField_a_of_type_Bmip;
  ...
  public abgm(QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      this.jdField_a_of_type_MqqOsMqqHandler = new MqqHandler(ThreadManager.getSubThreadLooper(), new abgn(this));
      label95:
      this.jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new abgo(this, ThreadManager.getSubThreadLooper());
      ...
      if (this.jdField_a_of_type_MqqOsMqqHandler != null)
      {
        ...
        this.jdField_a_of_type_Abgp = new abgp(this);
        ...
        BaseApplicationImpl.getContext().registerReceiver(this.jdField_a_of_type_Abgp, localIntentFilter);
  ...
  private abmo a()
  {
    ...
    try
    {
      ...
      {
        localObject = abmp.a((String)localObject);
        return localObject;
      }
    }
    catch (Throwable localThrowable)
  ...
  private void a(int paramInt, long paramLong, byte[] paramArrayOfByte, String paramString1, String paramString2)
  {
    ...
    if (this.jdField_a_of_type_Bmip != null) {
      this.jdField_a_of_type_Bmip.a(localBundle);
    }
  }
  ...
  private boolean b()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 230	abgm:jdField_a_of_type_Bmip	Lbmip;
    //   8: ifnonnull +81 -> 89
    //   11: aload_0
    //   12: ldc_w 370
    //   15: invokespecial 89	abgm:b	(Ljava/lang/String;)V
    //   18: invokestatic 376	java/lang/System:currentTimeMillis	()J
    //   21: lstore_2
    //   22: aload_0
    //   23: iconst_1
    //   24: putfield 378	abgm:jdField_a_of_type_Boolean	Z
    //   27: aload_0
    //   28: new 292	bmip
    //   31: dup
    //   32: aload_0
    //   33: getfield 311	abgm:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   36: invokespecial 379	bmip:<init>	(Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   39: putfield 230	abgm:jdField_a_of_type_Bmip	Lbmip;
    //   42: aload_0
    //   43: getfield 311	abgm:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   46: getstatic 382	com/tencent/mobileqq/app/BusinessHandlerFactory:DEVICEMSG_HANDLER	I
    //   49: invokevirtual 240	com/tencent/mobileqq/app/QQAppInterface:getBusinessHandler	(I)Lcom/tencent/mobileqq/app/BusinessHandler;
    //   52: pop
    //   53: invokestatic 376	java/lang/System:currentTimeMillis	()J
    //   56: lstore 4
    //   58: aload_0
    //   59: new 182	java/lang/StringBuilder
    //   62: dup
    //   63: invokespecial 183	java/lang/StringBuilder:<init>	()V
    //   66: ldc_w 384
    //   69: invokevirtual 200	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   72: lload 4
    //   74: lload_2
    //   75: lsub
    //   76: invokevirtual 387	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   79: invokevirtual 203	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   82: invokespecial 89	abgm:b	(Ljava/lang/String;)V
    //   85: aload_0
    //   86: monitorexit
    //   87: iload_1
    //   88: ireturn
  ...
  public int a(long paramLong, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Bmip == null);
      paramString = this.jdField_a_of_type_Bmip.a(localBundle);
  ...
  public int a(long paramLong1, String paramString1, long paramLong2, int paramInt, String paramString2)
  {
    ...
    do
    {
      ...
      paramString1 = this.jdField_a_of_type_Bmip.a(localBundle);
  ...
  public long a()
  {
    ...
    localBundle = this.jdField_a_of_type_Bmip.a(localBundle);
    if (localBundle != null) {}
  ...
  public DeviceInfo a(long paramLong)
  {
    ...
    localObject = this.jdField_a_of_type_Bmip.a((Bundle)localObject);
    if (localObject == null) {
      return new DeviceInfo();
    }
  ...
  public DeviceInfo a(String paramString, int paramInt)
  {
    ...
    paramString = this.jdField_a_of_type_Bmip.a((Bundle)localObject);
    if (paramString == null) {
      return null;
    }
    ...
    for (;;)
    {
      for (;;)
      {
        try
        {
          ...
          i = 0;
          absy.a(null, "QFind_BleState", i, 0, 0);
          if (QLog.isColorLevel()) {
        ...
        try
        {
          ...
          i = 1;
          absy.a(null, "QFind_GPSState", i, 0, 0);
          if (!QLog.isColorLevel()) {
            break;
          }
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (this.jdField_a_of_type_Bmip != null) {
            this.jdField_a_of_type_Bmip.a(paramBundle);
          }
        } while (paramInt == 2);
        if (paramInt == 6)
        {
          a(l, i, anvx.a(2131713655));
          return;
        }
      } while (paramInt == 7);
      if (paramInt == 8)
      {
        a(l, i, anvx.a(2131713654));
        return;
      }
    } while (paramInt != 9);
    a(l, i, anvx.a(2131713660));
  }
  ...
  public void a(long paramLong, AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Bmip != null) {
          this.jdField_a_of_type_Bmip.a(paramAbsStructMsg);
        }
        return;
        label418:
  ...
  public void a(Activity paramActivity, DeviceInfo paramDeviceInfo, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    {
      bjkv.a().a(anvx.a(2131713663));
      return;
    }
    paramDeviceInfo.displayName = absz.a(paramDeviceInfo);
    new absn(paramActivity).a(paramDeviceInfo, paramBundle, paramBoolean);
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      for (;;)
      {
        paramString = FileUtils.readFileContent(new File(str));
  ...
  {
    b("startPlugin flag:" + this.e + " ipc:" + this.jdField_a_of_type_Bmip);
    if (this.e != 1) {
      return;
    }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    ((Intent)localObject).putExtra("din", paramArrayOfByte.uint64_din.get());
    ((Intent)localObject).putExtra("uin", bfhl.a(paramArrayOfByte.uint32_uin.get()));
    BaseApplicationImpl.getApplication().sendBroadcast((Intent)localObject, "com.tencent.smartdevice.permission.broadcast");
  }
  ...
  public void b()
  {
    b("startPlugin force flag:" + this.e + " ipc:" + this.jdField_a_of_type_Bmip);
    if (b()) {
      b(false);
    }
  }
  ...
  {
    this.c = paramInt;
    SettingCloneUtil.writeValueForInt(BaseApplication.getContext(), this.app.getCurrentAccountUin(), null, "qqsetting_antilost_key", this.c);
    if (QLog.isColorLevel()) {
  ...
  public void b(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTransfileTransFileController.transferAsync(paramBundle);
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    //   5: dup
    //   6: invokespecial 183	java/lang/StringBuilder:<init>	()V
    //   9: ldc_w 1435
    //   12: invokevirtual 200	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   15: astore 4
    //   17: iload_1
    //   18: ifeq +41 -> 59
    //   21: ldc_w 1241
    ...
    //   26: aload 4
    //   28: aload_3
    //   29: invokevirtual 200	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   32: invokevirtual 203	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   35: invokespecial 89	abgm:b	(Ljava/lang/String;)V
    //   38: iconst_1
    //   39: aload_0
    //   40: getfield 53	abgm:jdField_a_of_type_Int	I
    //   43: if_icmpeq +13 -> 56
    //   46: aload_0
    //   47: getfield 55	abgm:jdField_b_of_type_Int	I
    //   50: istore_2
    //   51: iconst_1
    //   52: iload_2
    //   53: if_icmpne +13 -> 66
    ...
    //   70: aload_0
    //   71: iconst_0
    //   72: putfield 53	abgm:jdField_a_of_type_Int	I
    //   75: aload_0
    //   76: iconst_0
    //   77: putfield 55	abgm:jdField_b_of_type_Int	I
    //   80: aload_0
    //   81: getfield 53	abgm:jdField_a_of_type_Int	I
    //   84: ifeq +11 -> 95
    //   87: iconst_3
    //   88: aload_0
    //   89: getfield 53	abgm:jdField_a_of_type_Int	I
    //   92: if_icmpne -36 -> 56
    //   95: aload_0
    //   96: getfield 311	abgm:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   99: ifnull -43 -> 56
    //   102: aload_0
    //   103: getfield 311	abgm:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   106: invokevirtual 101	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   109: ifnull -53 -> 56
    //   112: aload_0
    //   113: ldc_w 1436
    //   116: aload_0
    //   117: getfield 311	abgm:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   126: aload_0
    //   127: invokevirtual 1438	abgm:a	()[B
    //   130: ldc_w 581
    //   133: ldc_w 581
    //   136: invokespecial 1440	abgm:a	(IJ[BLjava/lang/String;Ljava/lang/String;)V
    //   139: aload_0
    //   140: iconst_1
    //   141: putfield 53	abgm:jdField_a_of_type_Int	I
    //   144: goto -88 -> 56
    //   147: astore_3
    //   148: aload_0
    //   149: monitorexit
  ...
  public void d()
  {
    if ((this.jdField_a_of_type_Boolean) && (2 == this.jdField_a_of_type_Int))
    {
      ...
      if (this.jdField_a_of_type_Bmip != null) {
        this.jdField_a_of_type_Bmip.a((Bundle)localObject);
      }
    }
    this.jdField_a_of_type_Int = 0;
    this.jdField_b_of_type_Int = 0;
  ...
  public void onDestroy()
  {
    ...
    super.onDestroy();
    if (this.jdField_a_of_type_Abgp != null) {}
    try
    {
      if (BaseApplicationImpl.getContext() != null) {
        BaseApplicationImpl.getContext().unregisterReceiver(this.jdField_a_of_type_Abgp);
      }
      this.jdField_a_of_type_Abgp = null;
    }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqTransfileTransFileController != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTransfileTransFileController.destroy();
    ...
    if (this.jdField_a_of_type_Bmip != null)
    {
      this.jdField_a_of_type_Bmip.a();
      this.jdField_a_of_type_Bmip = null;
    }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bmip.a((Bundle)localObject1);
      return;
