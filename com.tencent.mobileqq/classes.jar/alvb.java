...
public class alvb
  implements aywc
{
  public alvb(PublicAccountHandler paramPublicAccountHandler) {}
  ...
  public ReqItem a(int paramInt)
  {
    ...
    if (bool)
    {
      ...
      ((CertifiedAccountRead.StGetFollowListReq)localObject1).seq.set(bdal.a(l1));
      ((CertifiedAccountRead.StGetFollowListReq)localObject1).count.set(bdal.a(1L));
      ...
      ((PROTOCAL.StQWebReq)localObject2).qua.set(bizf.a());
      ((PROTOCAL.StQWebReq)localObject2).deviceInfo.set(bize.a().c());
      ...
      localReqItem.vecParam = bdku.a((byte[])localObject1);
      return localReqItem;
    }
    ...
    localReqItem.vecParam = bdku.a(((mobileqq_mp.GetUserFollowListRequest)localObject1).toByteArray());
    return localReqItem;
  }
