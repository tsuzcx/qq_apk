...
public class szr
{
  private static QQHashMap<String, syz> jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap = new QQHashMap(2019, 10, 10000);
  public static String a;
  private static Map<String, szs> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public static syz a(String paramString)
  {
    try
    {
      paramString = (syz)jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.get(paramString);
      return paramString;
    }
    finally
    {
  ...
  public static szs a(String paramString)
  {
    szs localszs = (szs)jdField_a_of_type_JavaUtilMap.get(paramString);
    if (localszs != null) {
      return localszs;
    }
    localszs = new szs();
    String str = noe.a(paramString);
    if (str == null)
    {
      QLog.d("OfflineUtils", 2, "checkOffLineProteusConfig: offline root dir is null");
      localszs.a = false;
      jdField_a_of_type_JavaUtilMap.put(paramString, localszs);
      return localszs;
    }
    str = str + paramString;
  ...
  public static void a(String paramString, syz paramsyz)
  {
    try
    {
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(paramString, paramsyz);
      return;
    }
    finally
    {
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    {
      return false;
      paramString3 = a("8.4.8");
      paramString3.add(Integer.valueOf(Integer.parseInt("4810")));
  ...
  {
    String str = bkwm.a("default_feeds_proteus_offline_bid");
    FileUtils.deleteDirectory(noe.a(str) + str);
  }
}
