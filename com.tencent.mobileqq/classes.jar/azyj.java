  ...
  extends azut
{
  ...
  private RelativeLayout a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestWidth = aepi.a(70.0F, localResources);
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestHeight = aepi.a(70.0F, localResources);
      localObject1 = URLDrawable.getDrawable(paramString1, (URLDrawable.URLDrawableOptions)localObject1);
      localAnyScaleTypeImageView.setId(2131367921);
      localAnyScaleTypeImageView.setImageDrawable((Drawable)localObject1);
      paramString1 = new RelativeLayout.LayoutParams(aepi.a(70.0F, localResources), aepi.a(70.0F, localResources));
      paramString1.addRule(9);
      paramString1.addRule(10);
      localTextViewWrapLayout.addView(localAnyScaleTypeImageView, paramString1);
      i = aepi.a(10.0F, localResources);
      paramString1 = new TextView(paramContext);
      paramString1.setId(2131379043);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (((Bundle)localObject3).getBoolean("pre_dialog") == true)
    {
      ...
      {
        localObject4 = (azus)((Iterator)localObject5).next();
        if ((localObject4 instanceof azzv))
        {
          localObject4 = (azzv)localObject4;
          if (!((azzv)localObject4).a()) {
            break label164;
          }
          localObject2 = ((azzv)localObject4).S;
          localObject4 = ((azzv)localObject4).W;
    ...
    for (;;)
    {
      ...
      if ((localObject4 instanceof StructMsgItemTitle))
      {
        ...
        if (((Bundle)localObject3).getInt("accostType") == AbsStructMsg.SOURCE_ACCOUNT_TYPE_PA)
        {
          ...
          n = aepi.a(10.0F, (Resources)localObject5);
          int i1 = aepi.a(4.0F, (Resources)localObject5);
          int i2 = aepi.a(5.0F, (Resources)localObject5);
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject1 = ((azus)localObject4).a(paramContext, null, (Bundle)localObject3);
              localObject4 = ((View)localObject1).findViewById(2131368094);
              if ((localObject4 != null) && ((localObject4 instanceof AnyScaleTypeImageView))) {
                ((AnyScaleTypeImageView)localObject4).setTag(2131372447, Integer.valueOf(1));
              }
              k = i;
            ...
            else
            {
              if ("video".equals(str))
              {
                if ((localObject4 instanceof azzv))
                {
                  localObject1 = (azzv)localObject4;
                  if (this.jdField_a_of_type_Boolean) {
                    ((azzv)localObject1).c = false;
                  }
                  if (((azzv)localObject1).a()) {
                    if (!this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.hasFlag(4))
                    {
                      ...
                      {
                        localObject1 = (azus)this.jdField_a_of_type_JavaUtilArrayList.get(k);
                        if (!"title".equals(((azus)localObject1).jdField_a_of_type_JavaLangString)) {
                          break label859;
                        }
                ...
                for (;;)
                {
                  ...
                  localObject4 = ((azus)localObject4).a(paramContext, null, (Bundle)localObject3);
                  k = 1;
                ...
                for (k = (int)(i / 1.8F);; k = m)
                {
                  ...
                  for (;;)
                  {
                    ...
                    if ((j != 0) && (!TextUtils.isEmpty(paramBundle)) && ((localObject1 instanceof TitledImageView)))
                    {
                      ...
                      ((TitledImageView)localObject3).setTextSize(aepi.a(2, 18, (Resources)localObject5));
                      ((TitledImageView)localObject3).setTextBackground(paramContext.getResources().getColor(2131165256));
                      ((TitledImageView)localObject3).setTextPadding(aepi.a(10.0F, (Resources)localObject5));
                      ((TitledImageView)localObject3).settextBgRadius(aepi.a(12.0F, (Resources)localObject5));
                    }
                    if ((j != 0) && (!TextUtils.isEmpty(paramBundle)))
                    {
                      paramContext = ((View)localObject1).getTag(2131377133);
                      if ((paramContext != null) && ((paramContext instanceof baac))) {
                        ((baac)paramContext).a.setText(paramBundle);
                      }
                    }
                    ...
                    ((RelativeLayout)localObject2).setId(2131377130);
                    return localObject2;
