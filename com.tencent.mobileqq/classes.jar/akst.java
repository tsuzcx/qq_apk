    ...
    case 1: 
      ...
      if ((localObject2 != null) && (localObject2.length > 0) && (!this.a.jdField_c_of_type_Boolean))
      {
        ...
        try
        {
          ...
          localObject5 = new aksv();
          ((aksv)localObject5).jdField_a_of_type_Boolean = true;
          ((aksv)localObject5).jdField_b_of_type_Int = this.a.jdField_f_of_type_Int;
          localObject6 = this.a;
          ((akss)localObject6).jdField_f_of_type_Int += 1;
          ((aksv)localObject5).jdField_a_of_type_ComTencentYTFaceModelFaceStatus = localObject2[i];
          this.a.jdField_b_of_type_JavaUtilList.add(localObject5);
          localObject3[i] = localObject2[i].xys;
          if (!QLog.isColorLevel()) {
            break;
          }
          QLog.d("AREngine_ARLocalFaceRecog", 2, "MSG_DETECT_AND_RECOVER_FACE  add a tempFace ,faceInfo.faceID = " + ((aksv)localObject5).jdField_b_of_type_Int);
        }
        finally {}
    ...
    case 3: 
      ...
      synchronized (this.a.jdField_a_of_type_JavaLangObject)
      {
        ...
        do
        {
          ...
          localObject4 = (aksv)((Iterator)localObject3).next();
          if (!((aksv)localObject4).jdField_a_of_type_Boolean) {
            break label1243;
          }
          if ((QLog.isColorLevel()) && (akss.jdField_a_of_type_Boolean)) {
          ...
          l2 = SystemClock.uptimeMillis();
          i = this.a.jdField_a_of_type_ComTencentYTFaceClusterFaceCluster.trackSingleFace2((byte[])localObject2, this.a.jdField_a_of_type_Int, this.a.jdField_b_of_type_Int, ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus, this.a.jdField_c_of_type_Int);
          l2 = SystemClock.uptimeMillis() - l2;
          if ((QLog.isColorLevel()) && (akss.jdField_a_of_type_Boolean))
          {
          ...
          if (QLog.isColorLevel()) {
            QLog.i("AREngine_ARLocalFaceRecog", 2, "MSG_TRACK_FACE Lost realFace  faceInfo.lostCount = " + ((aksv)localObject4).jdField_c_of_type_Int);
          }
          ((aksv)localObject4).jdField_c_of_type_Int += 1;
        } while (((aksv)localObject4).jdField_c_of_type_Int <= 0);
        ((aksv)localObject4).jdField_a_of_type_Boolean = false;
        ((aksv)localObject4).jdField_c_of_type_Int = 0;
        localObject4 = this.a;
        ((akss)localObject4).d += 1;
      }
      ((aksv)localObject4).jdField_c_of_type_Int = 0;
      if ((QLog.isColorLevel()) && (akss.jdField_a_of_type_Boolean)) {
        QLog.d("AREngine_ARLocalFaceRecog", 2, "MSG_TRACK_FACE Track realFace success,update");
      }
      localObject5 = new aknz();
      ((aknz)localObject5).jdField_a_of_type_ArrayOfFloat = ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.xys;
      ((aknz)localObject5).jdField_a_of_type_JavaLangString = ((aksv)localObject4).jdField_a_of_type_JavaLangString;
      ((aknz)localObject5).jdField_a_of_type_AndroidGraphicsRect = new Rect(((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.x, ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.y, ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.x + ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.width, ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.y + ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.height);
      ((aknz)localObject5).jdField_a_of_type_AndroidGraphicsRectF = aknz.a(((aknz)localObject5).jdField_a_of_type_AndroidGraphicsRect, ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.xys);
      ((aknz)localObject5).jdField_a_of_type_Int = ((aksv)localObject4).jdField_b_of_type_Int;
      ((aknz)localObject5).jdField_c_of_type_JavaLangString = ((aksv)localObject4).jdField_b_of_type_JavaLangString;
      ((aknz)localObject5).jdField_b_of_type_JavaLangString = ((aksv)localObject4).jdField_c_of_type_JavaLangString;
      ((aknz)localObject5).g = ((aksv)localObject4).f;
      if (((aksv)localObject4).jdField_a_of_type_Int != 2) {}
      break;
    }
    for (boolean bool = true;; bool = false)
    {
      ((aknz)localObject5).jdField_b_of_type_Boolean = bool;
      if (((aknz)localObject5).jdField_b_of_type_Boolean)
      {
        ((aknz)localObject5).jdField_c_of_type_Boolean = this.a.a(((aknz)localObject5).jdField_b_of_type_JavaLangString);
        if (((aknz)localObject5).jdField_c_of_type_Boolean)
        {
          localObject6 = this.a.a(((aknz)localObject5).jdField_b_of_type_JavaLangString);
          if (localObject6 != null)
          {
            ((aknz)localObject5).h = ((ARScanStarFaceActInfo)localObject6).f;
            ((aknz)localObject5).f = ((ARScanStarFaceActInfo)localObject6).jdField_e_of_type_JavaLangString;
          }
        }
        ((aknz)localObject5).d = ((aksv)localObject4).jdField_e_of_type_JavaLangString;
        ((aknz)localObject5).jdField_e_of_type_JavaLangString = ((aksv)localObject4).d;
      }
      ((aknz)localObject5).jdField_a_of_type_Float = ((aksv)localObject4).jdField_a_of_type_Float;
      ...
      if (akss.jdField_a_of_type_AndroidOsHandler.hasMessages(1)) {
      ...
      akss.jdField_a_of_type_AndroidOsHandler.sendMessage((Message)localObject4);
      break label685;
      label1363:
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        if (((aksv)localObject4).jdField_a_of_type_Boolean)
        {
          ...
          {
            if ((QLog.isColorLevel()) && (akss.jdField_a_of_type_Boolean)) {
              QLog.d("AREngine_ARLocalFaceRecog", 2, "MSG_TRACK_FACE Track tmpFace success,update ,faceInfo.faceID = " + ((aksv)localObject4).jdField_b_of_type_Int);
            }
            localObject5 = new aknz();
            ((aknz)localObject5).jdField_a_of_type_ArrayOfFloat = ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.xys;
            ((aknz)localObject5).jdField_a_of_type_JavaLangString = ((aksv)localObject4).jdField_a_of_type_JavaLangString;
            ...
            ((aknz)localObject5).jdField_a_of_type_AndroidGraphicsRect = new Rect(((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.x, ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.y, ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.x + ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.width, ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.y + ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.height);
            ((aknz)localObject5).jdField_a_of_type_AndroidGraphicsRectF = aknz.a(((aknz)localObject5).jdField_a_of_type_AndroidGraphicsRect, ((aksv)localObject4).jdField_a_of_type_ComTencentYTFaceModelFaceStatus.xys);
            ((aknz)localObject5).jdField_e_of_type_Boolean = true;
            paramMessage.add(localObject5);
          }
        }
      ...
      l2 = System.currentTimeMillis();
      if ((!this.a.jdField_c_of_type_Boolean) && (this.a.jdField_a_of_type_Aksu != null))
      {
        ??? = new aksw();
        ((aksw)???).jdField_a_of_type_JavaUtilArrayList = paramMessage;
        ((aksw)???).jdField_a_of_type_Long = this.a.jdField_b_of_type_Long;
        this.a.jdField_a_of_type_Aksu.a((aksw)???);
