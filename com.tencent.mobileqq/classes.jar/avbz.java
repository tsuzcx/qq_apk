...
{
  public static int a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new avca(this);
  ...
  public avbz(BaseChatPie paramBaseChatPie)
  {
  ...
  private Friends a()
  {
    return ((ajjj)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
  }
  ...
  protected void a(String paramString)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setText(new axkd(paramString, 3, 12));
  ...
  public boolean a()
  {
    Friends localFriends = ((ajjj)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
    if (localFriends == null) {
      return false;
    }
    int i = babh.a(localFriends.detalStatusFlag, localFriends.iTermType);
    if (QLog.isColorLevel()) {
  ...
  protected void b()
  {
    RichStatus localRichStatus = ((avev)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(15)).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, false);
  ...
  public void b(String paramString)
  {
    ...
    do
    {
      ...
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        atlb.a().a(a(), this.jdField_a_of_type_AndroidWidgetTextView, false);
        return;
      }
      if (a())
      {
    ...
    atlb.a().a(a(), this.jdField_a_of_type_AndroidWidgetTextView, true);
  }
  ...
  public boolean b()
  {
    ...
    aqyp localaqyp = (aqyp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(32);
    int i = j;
    if (localaqyp != null)
    {
      i = j;
    ...
    return ((acyj)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(43)).c();
  }
