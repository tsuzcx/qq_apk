...
public class avbz
  extends avcc
  implements avcw, URLDrawable.DownloadListener
{
  public int a;
  ...
  public avbz(HotPicPageView paramHotPicPageView, View paramView, avdg paramavdg)
  {
    super(paramHotPicPageView, paramView, paramavdg);
    this.jdField_a_of_type_Int = -10;
    if (this.itemView != null) {
      this.itemView.setOnTouchListener(null);
    }
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131368098));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131368105));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131368104));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380804));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380810));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131380728));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372827));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380739));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131380805));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131364491);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131380598));
  }
  ...
  public void a()
  {
    ...
    if (localHotVideoMongoliaRelativeLayout != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avbz == this) {
        this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avbz = null;
      }
  ...
  public void b()
  {
    ...
    localValueAnimator.addUpdateListener(new avcb(this));
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.itemView.setContentDescription(anni.a(2131704398));
      continue;
      this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(0);
      a();
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      ...
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.itemView.setContentDescription(anni.a(2131704395));
      this.jdField_a_of_type_Boolean = false;
      continue;
      this.jdField_a_of_type_Boolean = false;
      if (paramInt == 1) {
      ...
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.itemView.setContentDescription(anni.a(2131704401));
      continue;
      if ((this.jdField_d_of_type_AndroidWidgetImageView.getVisibility() == 0) && ((this.jdField_a_of_type_Int == 1) || (this.jdField_a_of_type_Int == 2)))
      {
        ...
        ((AlphaAnimation)localObject).setAnimationListener(new avca(this));
      ...
      for (;;)
      {
        ...
        this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
        this.jdField_a_of_type_AndroidViewView.setVisibility(8);
        this.itemView.setContentDescription(anni.a(2131704397));
        break;
        this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
      ...
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.itemView.setContentDescription(anni.a(2131704399));
      b();
      continue;
      this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      ...
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.itemView.setContentDescription(anni.a(2131704400));
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Avdg != null) && ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Int == -11))) {
      this.jdField_a_of_type_Avdg.c(this, getPosition());
    }
    for (;;)
    {
  ...
  public void onFileDownloadFailed(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avdf.a();
  }
  ...
  public void onFileDownloadSucceed(long paramLong)
  {
    ...
    if ((localHotVideoData != null) && (localHotVideoData.picIndex == paramLong))
    {
      ...
      if (localHotVideoData.CheckIsNeedBlurBackground())
      {
        ...
        if ((Build.VERSION.SDK_INT >= 17) && (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.a()) && (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avcn != null)) {
          this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avcn.a(this, localHotVideoData);
        }
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avdf.a();
