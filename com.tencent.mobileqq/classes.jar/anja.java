  ...
  extends anii
{
  ...
  public anja(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(Map<Integer, Integer> paramMap)
  {
    ...
    SharedPreferences.Editor localEditor = afxa.a(this.a.getApplication().getApplicationContext(), this.a.getCurrentAccountUin(), 0).edit();
