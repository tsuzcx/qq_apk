  ...
  extends akhj
{
  ...
  akis(AlbumListFragment paramAlbumListFragment)
  {
  ...
  public void initData(Intent paramIntent)
  {
    ...
    {
      paramIntent = bnap.a(paramIntent.getActivity().getApplicationContext(), this.mPhotoCommonData.myUin, "pref_select_album");
      if (!TextUtils.isEmpty(paramIntent)) {
        break label173;
      }
    }
    label173:
    for (paramIntent = new ArrayList();; paramIntent = bnap.a(paramIntent))
    {
      this.a = paramIntent;
  ...
  public boolean onItemClick(QQAlbumInfo paramQQAlbumInfo, int paramInt, Intent paramIntent)
  {
    ...
    for (;;)
    {
      bnap.a(paramIntent.getActivity().getApplicationContext(), this.mPhotoCommonData.myUin, "pref_select_album", bnap.a(this.a.iterator()));
      return bool;
      label199:
