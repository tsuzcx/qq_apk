  ...
  implements TextWatcher, View.OnClickListener, View.OnTouchListener
{
  ...
  public akis(NewStyleCountryActivity paramNewStyleCountryActivity, Context paramContext)
  {
    super(paramContext);
    ...
    paramContext = (Button)findViewById(2131363845);
    paramContext.setVisibility(0);
    paramContext.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView = findViewById(2131376602);
    ...
    findViewById(2131377198).setVisibility(8);
    this.jdField_a_of_type_ComTencentWidgetListView = ((ListView)findViewById(2131377223));
    this.jdField_a_of_type_Akir = new akir(paramNewStyleCountryActivity, null);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Akir);
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Akir.a(paramString);
    if (this.jdField_a_of_type_Akir.getCount() == 0) {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
      this.jdField_a_of_type_Akir.notifyDataSetChanged();
      return;
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 208	acxo:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 208	acxo:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 208	acxo:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
