  ...
  extends Dialog
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    setContentView(2131495610);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131307523));
    ...
    ((RelativeLayout)findViewById(2131307522)).setOnClickListener(new voz(this));
    ...
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(new vpc(this));
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      break;
      label207:
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      if (this.jdField_a_of_type_AndroidWidgetTextView.getPaint().measureText(this.jdField_a_of_type_JavaLangString) > vms.a(getContext(), 280.0F)) {
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new vpa(this));
      break label160;
      label335:
      ...
      if (this.jdField_b_of_type_AndroidViewView$OnClickListener != null) {
        ...
        this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(new vpb(this));
      }
    }
  }
}
