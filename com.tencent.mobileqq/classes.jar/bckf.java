...
{
  public bckf(ConfigClearableEditText paramConfigClearableEditText, View paramView)
  {
    super(paramView);
  }
  ...
  {
    if (paramInt == 0) {
      paramAccessibilityEvent.setContentDescription(ajyc.a(2131702413));
    }
  }
  ...
  public void onPopulateNodeForVirtualView(int paramInt, AccessibilityNodeInfoCompat paramAccessibilityNodeInfoCompat)
  {
    if (paramInt == 0)
    {
      paramAccessibilityNodeInfoCompat.setContentDescription(ajyc.a(2131702414));
