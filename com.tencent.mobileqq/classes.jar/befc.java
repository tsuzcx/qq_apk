...
public class befc
{
  ...
  public befc(WebViewFragment paramWebViewFragment)
  {
  ...
  private boolean a()
  {
    return (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.a.getAccount().equals(this.jdField_d_of_type_JavaLangString));
  }
  ...
  private boolean a(String paramString)
  {
    ...
    awgf localawgf = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.a.getEntityManagerFactory(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.a.getAccount()).createEntityManager();
    paramString = (TroopInfo)localawgf.a(TroopInfo.class, paramString);
    localawgf.a();
    if (paramString != null)
    {
      ...
      if ((paramString.isTroopOwner(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.a.getAccount())) || (paramString.isAdmin())) {
        return true;
      }
    }
    return false;
  ...
  private void b(String paramString)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getActivity() != null)) {
      bdgm.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getActivity(), 230).setMessage(paramString).setPositiveButton(2131694125, new befd(this)).show();
    }
  }
        ...
        if (this.jdField_a_of_type_Int == 0)
        {
          ...
          if (this.jdField_a_of_type_Int == 0)
          {
            ...
            if (this.jdField_a_of_type_Int == 0)
            {
              ...
              lea.a(localJSONObject, "startListenAioShareMusic", null);
            }
          }
          else
          {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Int == 0)
        {
          ...
          lea.a(localJSONObject, "checkAioShareMusic", null);
          return;
        }
      }
      catch (JSONException paramIntent)
  ...
  public void b(Intent paramIntent)
  {
    ...
    if (this.jdField_a_of_type_Int == 0)
    {
      ...
      str3 = "";
      label75:
      azqs.b(null, "dc00899", str1, "", "music_tab", str2, 0, 0, str3, "", "", "");
    ...
    label176:
    label183:
    for (paramIntent = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131698896);; paramIntent = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131698870))
    {
      a(String.format(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131693981), new Object[] { paramIntent }));
      return;
      str1 = "Grp_AIO";
      break;
      str2 = "clk_share_grp";
    ...
    {
      a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131693975));
      return;
    }
    if (this.jdField_a_of_type_Int == 1)
    {
      ...
      {
        b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131693973));
        return;
      }
      if ((this.jdField_c_of_type_Int == 3) && (!bool) && (this.jdField_c_of_type_Boolean) && (!this.jdField_d_of_type_Boolean))
      {
        b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131693974));
        return;
      }
      if ((this.jdField_c_of_type_Int != 3) && (!bool) && (!this.jdField_d_of_type_Boolean))
      {
        b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131693972));
        return;
      }
      if ((this.jdField_c_of_type_Int != 3) && (!a()) && (!bool) && (this.jdField_d_of_type_Boolean))
      {
        ...
        {
          a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131693979));
          return;
        }
  ...
  public void b(JSONObject paramJSONObject)
  {
    for (;;)
    {
      ...
      a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131695088));
      continue;
      a(String.format(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131693981), new Object[] { str }));
      continue;
      a(str);
      continue;
      b(str);
