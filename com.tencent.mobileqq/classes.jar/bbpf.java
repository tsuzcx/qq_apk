...
public class bbpf
{
  public static List<arrl> a(long paramLong1, long paramLong2, aqsr paramaqsr, ConcurrentHashMap<Long, Set<DanmuItemBean>> paramConcurrentHashMap)
  {
    paramConcurrentHashMap = (Set)paramConcurrentHashMap.get(Long.valueOf(paramLong1));
    if (paramConcurrentHashMap != null) {
      return a(a(paramConcurrentHashMap, paramLong2), paramaqsr);
    }
    return null;
  }
  
  public static List<arrl> a(long paramLong, List<DanmuItemBean> paramList, aqsr paramaqsr, ConcurrentHashMap<Long, Set<DanmuItemBean>> paramConcurrentHashMap)
  {
    if ((paramList == null) || (paramList.isEmpty()) || (paramaqsr == null)) {
    ...
    {
      arrl localarrl = paramaqsr.a(new aqsw((DanmuItemBean)paramConcurrentHashMap.next()));
      if (localarrl != null)
      {
        localarrl.a(5000);
        localarrl.e(true);
        paramList.add(localarrl);
      }
    }
    return paramList;
  }
  
  public static List<arrl> a(long paramLong1, List<DanmuItemBean> paramList, aqsr paramaqsr, ConcurrentHashMap<Long, Set<DanmuItemBean>> paramConcurrentHashMap, long paramLong2)
  {
    ...
    return a(a(paramLong1, paramList, paramConcurrentHashMap, paramLong2), paramaqsr);
  }
  ...
  private static List<arrl> a(List<DanmuItemBean> paramList, aqsr paramaqsr)
  {
    if ((paramList != null) && (!paramList.isEmpty()) && (paramaqsr != null))
    {
      ArrayList localArrayList = new ArrayList();
      ...
      while (paramList.hasNext())
      {
        ...
        aqsw localaqsw = new aqsw((DanmuItemBean)localObject);
        arrl localarrl = paramaqsr.a(localaqsw);
        if (localarrl != null)
        {
          localarrl.b(((DanmuItemBean)localObject).c);
          if (!TextUtils.isEmpty(localaqsw.a))
          {
            localObject = BaseApplicationImpl.getApplication().getRuntime().getAccount();
            if ((!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).equals(localaqsw.a))) {
              localarrl.e(true);
            }
          }
          localArrayList.add(localarrl);
        }
      }
      return localArrayList;
    }
  ...
  public static boolean a(RichMediaBrowserInfo paramRichMediaBrowserInfo)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      localStringBuilder.append("shouldShowDanmakuBtn, paramsManager.isFromMultiMsg() = ").append(bbph.a().c());
      localStringBuilder.append(" , paramsManager.getmCurType() = ").append(bbph.a().a());
      localStringBuilder.append(" , paramsManager.getSourceEntrance() = ").append(bbph.a().c());
      localStringBuilder.append(" , paramsManager.isReplyMsgFromSameSession() = ").append(bbph.a().h());
      localStringBuilder.append(" , paramsManager.isMixedMsg = ").append(bbph.a().b);
      localStringBuilder.append(" , paramsManager.isReplySrcMsgExist = ").append(bbph.a().c);
