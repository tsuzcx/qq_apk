...
public class aybs
{
  ...
  private ayba a(aybg paramaybg, JSONObject paramJSONObject)
  {
    int n;
    Object localObject1;
    Object localObject3;
    ...
    Object localObject4;
    int i4;
    if ((paramaybg instanceof SpriteGLView))
    {
      n = 4;
      ...
      localObject3 = new aycm((SpriteGLView)paramaybg);
      ((ayba)localObject3).c(1.0F / n);
      localObject2 = localObject1;
      if (this.jdField_a_of_type_Aybz != null) {
        localObject2 = this.jdField_a_of_type_Aybz.a((aybf)localObject3, (String)localObject1);
      }
      ...
      localObject1 = this.jdField_a_of_type_Ayby.a((aybf)localObject3, this.jdField_a_of_type_JavaLangString, (String)localObject4);
      label205:
    ...
    for (;;)
    {
      ...
      try
      {
        localObject4 = bbef.a(this.jdField_a_of_type_JavaLangString + "/" + (String)localObject4, null);
        ...
        if (this.jdField_a_of_type_Aybz != null) {
          this.jdField_a_of_type_Aybz.a(k - i - i4, (String)localObject2, localPaint);
        }
        ...
        k = this.jdField_a_of_type_Aybz.a(m, i, i4, (String)localObject2, localPaint);
        i3 = k;
        if (k == 0) {
      ...
      try
      {
        ...
        f2 = f1;
        f1 = f3;
        if ((this.jdField_a_of_type_Aybz == null) || (!this.jdField_a_of_type_Aybz.a((Canvas)localObject5, (String)localObject2, f2, f4, f7, m, i2, localPaint))) {
        ...
        ((aybf)localObject3).a(paramaybg, (Bitmap)localObject4);
      }
      catch (OutOfMemoryError paramaybg)
      {
        if (!QLog.isColorLevel()) {
          continue;
        }
        QLog.e("SceneBuilder", 2, "buildLabel" + QLog.getStackTraceString(paramaybg));
        return localObject3;
      }
      return localObject3;
      n = 1;
      break;
      localObject3 = new aycz((SpriteNativeView)paramaybg);
      break label38;
      continue;
      label858:
  ...
  private ayba a(aybg paramaybg, JSONObject paramJSONObject, aybe paramaybe)
  {
    Object localObject1 = null;
    Object localObject3 = paramJSONObject.optString("type");
    if ("layer".equals(localObject3)) {
      if ((paramaybg instanceof SpriteGLView)) {
        localObject1 = new aycj((SpriteGLView)paramaybg);
      }
    }
    Object localObject6;
    label134:
    ...
    while (localObject1 == null)
    {
      localObject3 = null;
      return localObject3;
      localObject1 = new aycx((SpriteNativeView)paramaybg);
      continue;
      if ("image".equals(localObject3))
      {
        ...
        if ((paramaybg instanceof SpriteGLView))
        {
          localObject3 = (SpriteGLView)paramaybg;
          if (TextUtils.isEmpty((CharSequence)localObject6))
          {
            localObject3 = new aycm((SpriteGLView)localObject3);
            if (this.jdField_a_of_type_Ayby != null) {
              localObject1 = this.jdField_a_of_type_Ayby.a((aybf)localObject3, this.jdField_a_of_type_JavaLangString, (String)localObject4);
            }
            if (localObject1 != null) {
        ...
        for (;;)
        {
          for (;;)
          {
            ...
            try
            {
              ...
              ((aybf)localObject3).a(paramaybg, (Bitmap)localObject1);
              localObject1 = localObject3;
            }
          ...
          localObject3 = new aycg((SpriteGLView)localObject3, true, (String)localObject6);
          ((aycg)localObject3).a(new aybt(this, paramaybe, (String)localObject6));
          break label134;
          localObject3 = (SpriteNativeView)paramaybg;
          if (TextUtils.isEmpty((CharSequence)localObject6))
          {
            localObject3 = new aycz((SpriteNativeView)localObject3);
            break label134;
          }
          localObject3 = new aycw((SpriteNativeView)localObject3, (String)localObject6);
          ((aycw)localObject3).a(new aybu(this, paramaybe, (ayba)localObject3, (String)localObject6));
          break label134;
      ...
      if ("video".equals(localObject3))
      {
        if ((paramaybg instanceof SpriteGLView))
        {
          ...
          if (paramJSONObject.optBoolean("autoClose", false)) {
            ((VideoSprite)localObject2).a(this.jdField_a_of_type_Aycd);
          }
          ((VideoSprite)localObject2).a(paramJSONObject.optBoolean("isLooping", false));
        }
        else
        {
          localObject2 = (SpriteNativeView)paramaybg;
          localObject3 = this.jdField_a_of_type_JavaLangString + "/" + paramJSONObject.optString("path");
          localObject2 = new ayda((SpriteNativeView)localObject2, (String)localObject3);
          ((ayda)localObject2).a((String)localObject3, paramJSONObject.optBoolean("isLooping", false));
        }
      }
      else if ("label".equals(localObject3)) {
        localObject2 = a(paramaybg, paramJSONObject);
      }
    }
    ((ayba)localObject2).a(paramJSONObject.optString("name"));
    ((ayba)localObject2).a(paramJSONObject.optInt("tag"));
    ((ayba)localObject2).a((float)paramJSONObject.optDouble("x", 0.0D));
    ((ayba)localObject2).b((float)paramJSONObject.optDouble("y", 0.0D));
    ((ayba)localObject2).b((int)(paramJSONObject.optDouble("alpha", 1.0D) * 255.0D));
    ((ayba)localObject2).c(((ayba)localObject2).a() * (float)paramJSONObject.optDouble("scale", 1.0D));
    ((ayba)localObject2).d((float)paramJSONObject.optDouble("rotate", 0.0D));
    ((ayba)localObject2).e(((ayba)paramaybe).a());
    localObject3 = paramJSONObject.optJSONArray("actions");
    if (localObject3 != null) {
      ((ayba)localObject2).a(a((JSONArray)localObject3));
    }
    Object localObject5 = paramJSONObject.optJSONObject("frames");
    if (localObject5 != null)
    {
      localObject3 = new aybb();
      ((aybb)localObject3).jdField_a_of_type_Int = ((JSONObject)localObject5).optInt("fps");
      localObject5 = ((JSONObject)localObject5).optJSONArray("datas");
      j = ((JSONArray)localObject5).length();
      ((aybb)localObject3).jdField_a_of_type_ArrayOfAybc = new aybc[j];
      i = 0;
      while (i < j)
      {
        ((aybb)localObject3).jdField_a_of_type_ArrayOfAybc[i] = new aybc();
        localObject6 = ((JSONArray)localObject5).optJSONObject(i);
        localObject3.jdField_a_of_type_ArrayOfAybc[i].jdField_a_of_type_Float = ((JSONObject)localObject6).optInt("x");
        localObject3.jdField_a_of_type_ArrayOfAybc[i].b = ((JSONObject)localObject6).optInt("y");
        i += 1;
      }
      ((ayba)localObject2).a((aybb)localObject3);
    }
    localObject3 = paramJSONObject.optString("horizontal_align");
    if (localObject3 != null)
    {
      if (((String)localObject3).equals("left")) {
        ((ayba)localObject2).c(0);
      }
    }
    else
    {
      ...
      if (localObject3 != null)
      {
        ...
        ((ayba)localObject2).d(0);
      }
    }
    for (;;)
    {
      localObject3 = localObject2;
      if (!(localObject2 instanceof aybe)) {
        break;
      }
      localObject5 = (aybe)localObject2;
      ...
      for (;;)
      {
        ...
        localObject3 = a(paramaybg, paramJSONObject.getJSONObject(i), paramaybe);
        if (localObject3 != null) {
          ((aybe)localObject5).a((ayba)localObject3);
        }
        i += 1;
      }
      if (((String)localObject3).equals("right"))
      {
        ((ayba)localObject2).c(1);
        break label1028;
      }
      if (!((String)localObject3).equals("center")) {
        break label1028;
      }
      ((ayba)localObject2).c(2);
      break label1028;
      label1180:
      if (((String)localObject3).equals("bottom")) {
        ((ayba)localObject2).d(1);
      } else if (((String)localObject3).equals("center")) {
        ((ayba)localObject2).d(2);
      }
    }
  }
  
  private aybe a(aybg paramaybg, String paramString)
  {
    Object localObject1;
    if ((paramaybg instanceof SpriteGLView))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject2 = ((ViewGroup)paramaybg).getLayoutParams();
          ...
          ((ViewGroup)paramaybg).setLayoutParams((ViewGroup.LayoutParams)localObject2);
          ((ayba)localObject1).c(this.jdField_a_of_type_Float);
          if (this.jdField_a_of_type_Ayca != null) {
            this.jdField_a_of_type_Ayca.a(((ViewGroup.LayoutParams)localObject2).width, ((ViewGroup.LayoutParams)localObject2).height);
          }
        }
        ...
        if (paramString != null)
        {
          ...
          while (i < j)
          {
            localObject2 = a(paramaybg, paramString.getJSONObject(i), (aybe)localObject1);
            if (localObject2 != null) {
              ((aybe)localObject1).a((ayba)localObject2);
            }
            i += 1;
          }
          if (!QLog.isColorLevel()) {}
      ...
      catch (Exception paramaybg) {}
    }
    QLog.e("SceneBuilder", 2, "buildFromJson" + QLog.getStackTraceString(paramaybg));
    return localObject1;
  }
  
  private aybi a(JSONObject paramJSONObject)
  {
    Object localObject1 = null;
    ...
    if (((String)localObject2).equals("sequence")) {
      localObject1 = new aybr(a(paramJSONObject.optJSONArray("actions")));
    }
    label513:
    label516:
    for (;;)
    {
      if (localObject1 != null)
      {
        ((aybi)localObject1).jdField_a_of_type_Boolean = paramJSONObject.optBoolean("isRepeat");
        if (str != null)
        {
          if (!str.equals("linear")) {
            break label473;
          }
          ((aybi)localObject1).e = 0;
        }
        label102:
        if ((paramJSONObject.optBoolean("autoClose", false)) && (this.jdField_a_of_type_Aycd != null)) {
          ((aybi)localObject1).a(new aybv(this));
        }
      }
      return localObject1;
      if (((String)localObject2).equals("delay"))
      {
        localObject1 = new aybk(j);
      }
      else
      {
        if (((String)localObject2).equals("position"))
        {
          ...
          if ((this.jdField_a_of_type_Aybw == null) || (!"$POSITIONX$".equals(((JSONObject)localObject2).optString("x")))) {
            break label513;
          }
          aybh[] arrayOfaybh = this.jdField_a_of_type_Aybw.a(localJSONObject, (JSONObject)localObject2, this.jdField_a_of_type_Float);
          if ((arrayOfaybh == null) || (arrayOfaybh.length != 2)) {
            break label513;
          }
          localObject1 = new aybm(j, arrayOfaybh[0].jdField_a_of_type_Float, arrayOfaybh[0].b, arrayOfaybh[1].jdField_a_of_type_Float, arrayOfaybh[1].b);
        }
        for (int i = 1;; i = 0)
        {
          if (i != 0) {
          ...
          localObject1 = new aybm(j, (float)localJSONObject.optDouble("x"), (float)localJSONObject.optDouble("y"), (float)((JSONObject)localObject2).optDouble("x"), (float)((JSONObject)localObject2).optDouble("y"));
          break;
          if (((String)localObject2).equals("scale"))
          {
            localObject1 = new aybq(j, (float)paramJSONObject.optDouble("from", 1.0D), (float)paramJSONObject.optDouble("to", 1.0D));
            break;
          }
          if (((String)localObject2).equals("alpha"))
          {
            localObject1 = new aybo(j, (int)(paramJSONObject.optDouble("from", 1.0D) * 255.0D), (int)(paramJSONObject.optDouble("to", 1.0D) * 255.0D));
            break;
          }
          ...
          localObject1 = new aybp(j, paramJSONObject.optInt("from", 0), paramJSONObject.optInt("to", 0));
          break;
          label473:
          if (str.equals("easeIn"))
          {
            ((aybi)localObject1).e = 1;
            break label102;
          }
          if (!str.equals("easeOut")) {
            break label102;
          }
          ((aybi)localObject1).e = 2;
          break label102;
        }
      }
    }
  ...
  private aybi[] a(JSONArray paramJSONArray)
  {
    int j = paramJSONArray.length();
    aybi[] arrayOfaybi = new aybi[j];
    int i = 0;
    while (i < j)
    {
      arrayOfaybi[i] = a(paramJSONArray.optJSONObject(i));
      i += 1;
    }
    return arrayOfaybi;
  }
  ...
  public aybs a(aybx paramaybx)
  {
    this.jdField_a_of_type_Aybx = paramaybx;
    return this;
  }
  
  public aybs a(ayby paramayby)
  {
    this.jdField_a_of_type_Ayby = paramayby;
    return this;
  }
  
  public aybs a(aybz paramaybz)
  {
    this.jdField_a_of_type_Aybz = paramaybz;
    return this;
  }
  
  public aybs a(ayca paramayca)
  {
    this.jdField_a_of_type_Ayca = paramayca;
    return this;
  }
  
  public aybs a(aycd paramaycd)
  {
    this.jdField_a_of_type_Aycd = paramaycd;
    return this;
  }
  
  public aybs a(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    return this;
  }
  
  public void a(aybg paramaybg, aycb paramaycb)
  {
    ThreadManager.post(new SceneBuilder.1(this, paramaybg, paramaycb), 8, null, true);
  }
}
