  ...
  implements View.OnClickListener, aobv
{
  ...
  public aybs(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561310, null);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131373119));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378845));
    ...
    this.jdField_a_of_type_Aobu = new aobu(this.jdField_a_of_type_AndroidContentContext, ((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app);
    this.jdField_a_of_type_Aobu.a(this);
    this.jdField_a_of_type_Bbck = ((bbck)((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app.getManager(15));
    ...
    {
      paramContext = paramContext.getString("key_nearbyrecommender_title", this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131693936));
  ...
  public static void a(VipBaseInfo paramVipBaseInfo, ImageView paramImageView, SingleLineTextView paramSingleLineTextView)
  {
    ...
    paramSingleLineTextView.setTextColor(paramSingleLineTextView.getResources().getColorStateList(2131167047));
    ...
    if ((paramVipBaseInfo != null) && (paramVipBaseInfo.mOpenInfo != null))
    {
      ...
      paramSingleLineTextView.setTextColor(paramSingleLineTextView.getResources().getColorStateList(2131167121));
    }
    label84:
    do
    {
  ...
  {
    bico localbico = new bico(this.jdField_a_of_type_AndroidContentContext.getResources(), this.jdField_a_of_type_Bbck.a(paramInt, 200), false, false);
    if (this.c == 0) {
      this.c = ((int)(paramSingleLineTextView.a() * 1.1F + 0.5F));
    }
    localbico.setBounds(0, 0, this.c, this.c);
    paramSingleLineTextView.setCompoundDrawablesWithIntrinsicBounds(localbico, null);
  }
  ...
  {
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559487, null);
  ...
  public void a(RespEncounterInfo paramRespEncounterInfo, ImageView paramImageView)
  {
    ...
    try
    {
      if (paramRespEncounterInfo.tiny_id > 0L)
      {
        ...
        paramRespEncounterInfo = this.jdField_a_of_type_Aobu.a(32, str, 202);
        if (paramRespEncounterInfo == null)
        {
          if (!this.jdField_a_of_type_Aobu.a()) {
            this.jdField_a_of_type_Aobu.a(str, 202, true, false);
          }
          if (this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable == null) {
            this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = ((BitmapDrawable)bgmo.a());
          }
    ...
    if (paramRespEncounterInfo.lEctID > 0L)
    {
      ...
      paramRespEncounterInfo = this.jdField_a_of_type_Aobu.a(32, str, 200);
      if (paramRespEncounterInfo == null)
      {
        this.jdField_a_of_type_Aobu.a(str, 200, true, false);
        if (this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable == null) {
          this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = ((BitmapDrawable)bgmo.a());
        }
        paramImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable);
  ...
  public void a(View paramView, RespEncounterInfo paramRespEncounterInfo)
  {
    ...
    SingleLineTextView localSingleLineTextView1 = (SingleLineTextView)paramView.findViewById(2131378446);
    Object localObject4 = (ImageView)paramView.findViewById(2131363025);
    ImageView localImageView5 = (ImageView)paramView.findViewById(2131368516);
    Object localObject1 = (TextView)paramView.findViewById(2131378514);
    ImageView localImageView2 = (ImageView)paramView.findViewById(2131380992);
    SingleLineTextView localSingleLineTextView2 = (SingleLineTextView)paramView.findViewById(2131365282);
    Object localObject2 = (SingleLineTextView)paramView.findViewById(2131378715);
    Object localObject3 = paramView.findViewById(2131369262);
    TextView localTextView = (TextView)paramView.findViewById(2131371667);
    ImageView localImageView3 = (ImageView)paramView.findViewById(2131372368);
    ImageView localImageView4 = (ImageView)paramView.findViewById(2131364331);
    LinearLayout localLinearLayout = (LinearLayout)paramView.findViewById(2131377088);
    View localView = paramView.findViewById(2131369363);
    paramView = (SingleLineTextView)paramView.findViewById(2131368637);
    this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167047);
    label222:
    int i;
    if (!TextUtils.isEmpty(paramRespEncounterInfo.strNick))
    {
      ...
      localImageView5.setBackgroundResource(2130845884);
      localObject4 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845508);
      ((TextView)localObject1).setBackgroundDrawable(bfup.a(this.jdField_a_of_type_AndroidContentContext.getResources(), -17883, (Drawable)localObject4));
      ((TextView)localObject1).setText(anni.a(2131700513));
      label311:
    ...
    for (;;)
    {
      ...
      default: 
        ...
        if (paramRespEncounterInfo.constellation == 0)
        {
          ...
          {
          default: 
            localImageView4.setImageResource(2130845427);
            if (AppSetting.c) {
              localImageView4.setContentDescription(anni.a(2131700515));
            }
            label713:
            if (paramRespEncounterInfo.watch_color == 0)
            {
      ...
      for (;;)
      {
        ...
        localObject4 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845508);
        ((TextView)localObject1).setBackgroundDrawable(bfup.a(this.jdField_a_of_type_AndroidContentContext.getResources(), -17883, (Drawable)localObject4));
        ((TextView)localObject1).setText(anni.a(2131700516));
        break label311;
        label860:
        ...
        break label548;
        ((StringBuilder)localObject1).append(" ").append(bghy.a(paramRespEncounterInfo.constellation));
        break label581;
        label980:
        ((StringBuilder)localObject1).append(" ").append(bght.e[paramRespEncounterInfo.profession_id]);
        break label597;
        label1003:
        paramView.setVisibility(8);
        break label636;
        localImageView4.setImageResource(2130845429);
        break label696;
        localImageView4.setImageResource(2130845430);
        break label696;
        localImageView4.setImageResource(2130845431);
        break label696;
  ...
  public void a(List<RespEncounterInfo> paramList)
  {
    ...
    while (i < paramList.size())
    {
      ...
      if ((localView != null) && (localRespEncounterInfo != null)) {
        this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(localView, new LinearLayout.LayoutParams(-1, bggq.a(this.jdField_a_of_type_AndroidContentContext, 84.0F)));
      }
      i += 1;
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject1 = (anmw)((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app.getManager(51);
    if (localObject1 != null) {}
    for (boolean bool = ((anmw)localObject1).b(Long.toString(((RespEncounterInfo)localObject2).lEctID));; bool = false)
    {
      ...
      if (bool)
      {
        ...
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131693917);
        if (!"0".equals(String.valueOf(((RespEncounterInfo)localObject2).cSex))) {
          break label299;
        }
      }
      label299:
      for (localObject1 = String.format((String)localObject1, new Object[] { anni.a(2131700514) });; localObject1 = String.format((String)localObject1, new Object[] { anni.a(2131700512) }))
      {
        aybt.a(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app, Long.toString(((RespEncounterInfo)localObject2).lEctID), Long.toString(((RespEncounterInfo)localObject2).lEctID), (String)localObject1, 1001, true, true);
        ...
        localObject2 = aybt.a(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app);
        bcst.b(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app, "CliOper", "", "", "0X80055FC", "0X80055FC", 0, 0, localObject2[0], (String)localObject1, "", "");
