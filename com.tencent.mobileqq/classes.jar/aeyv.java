...
public class aeyv
  implements aeyu, Handler.Callback
{
  int jdField_a_of_type_Int = vpm.b(BaseApplicationImpl.getContext(), 50.0F);
  private actd jdField_a_of_type_Actd;
  private aeyt jdField_a_of_type_Aeyt;
  Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new aeyw(this);
  ...
  private ArrayList<aeyx> jdField_a_of_type_JavaUtilArrayList;
  public List<QQOperationViopTipTask> a;
  private Observer jdField_a_of_type_JavaUtilObserver;
  protected final MqqHandler a;
  int jdField_b_of_type_Int = vpm.b(BaseApplicationImpl.getContext(), 30.0F);
  Animation jdField_b_of_type_AndroidViewAnimationAnimation;
  ImageView jdField_b_of_type_AndroidWidgetImageView;
  RelativeLayout jdField_b_of_type_AndroidWidgetRelativeLayout;
  Animation c;
  
  public aeyv(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, actd paramactd, XPanelContainer paramXPanelContainer, List<QQOperationViopTipTask> paramList)
  {
    this.jdField_a_of_type_MqqOsMqqHandler = new bfnk(Looper.getMainLooper(), this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = paramSessionInfo;
    this.jdField_a_of_type_Actd = paramactd;
  ...
  private RelativeLayout a()
  {
    ...
    //   23: putfield 111	aeyv:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   26: aload_1
    //   27: astore_2
    //   28: new 113	java/io/File
    //   31: dup
    //   32: getstatic 119	nqn:h	Ljava/lang/String;
    ...
    //   74: getstatic 119	nqn:h	Ljava/lang/String;
    ...
    //   92: astore_2
    //   93: aload_0
    //   94: getfield 111	aeyv:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   97: aload_2
  ...
  private boolean a(aeyx paramaeyx)
  {
    boolean bool3 = false;
    Object localObject1 = a(paramaeyx.b());
    int i = -1;
    int[] arrayOfInt = paramaeyx.a();
    boolean bool1;
    if (arrayOfInt != null)
    {
      if (this.jdField_a_of_type_Aeyt != null) {
        i = this.jdField_a_of_type_Aeyt.b();
      }
      boolean bool2 = true;
      int j = 0;
    ...
    for (;;)
    {
      if ((bool1) && ((paramaeyx instanceof aeyt)) && (this.jdField_a_of_type_Aeyt != null) && (this.jdField_a_of_type_Aeyt.a() > ((aeyt)paramaeyx).a()))
      {
  ...
  {
    if (this.jdField_a_of_type_Aeyt != null) {
      return this.jdField_a_of_type_Aeyt.b();
    }
    return -1;
  }
  ...
  public aeyt a()
  {
    return this.jdField_a_of_type_Aeyt;
  }
  ...
  public void a()
  {
    if (Thread.currentThread() == Looper.getMainLooper().getThread())
    {
      if (this.jdField_a_of_type_Actd != null) {
        this.jdField_a_of_type_Actd.a(this.jdField_a_of_type_Aeyt);
      }
      this.jdField_a_of_type_Aeyt = null;
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((aeyx)localIterator.next()).a(paramInt, paramVarArgs);
      }
    }
  }
  
  public void a(aeyx paramaeyx)
  {
    if (paramaeyx == null) {}
    do
    {
    ...
    } while (this.jdField_a_of_type_JavaUtilArrayList.contains(paramaeyx));
    this.jdField_a_of_type_JavaUtilArrayList.add(paramaeyx);
  }
  ...
  public void a(View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setId(2131367587);
    }
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(paramOnClickListener);
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout == null) {
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentWidgetXPanelContainer.findViewById(2131364075));
    }
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131367587) == null) {
  ...
  public boolean a(aexz paramaexz, Object... paramVarArgs)
  {
    if (paramaexz != null)
    {
      if (a(paramaexz)) {
    ...
    {
      return false;
      paramVarArgs = paramaexz.a(paramVarArgs);
      if (paramVarArgs != null)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramVarArgs, paramVarArgs.selfuin);
        if (QLog.isColorLevel()) {
          QLog.d("TipsManager", 2, "showGrayTips() success: from " + a(paramaexz.b()));
        }
        return true;
      }
    } while (!QLog.isColorLevel());
    QLog.d("TipsManager", 2, "showGrayTips() failure: MessageRecord null, from " + a(paramaexz.b()));
    return false;
  }
  
  public boolean a(aeyt paramaeyt, Object... paramVarArgs)
  {
    if (actj.l) {}
    label136:
    do
    {
      ...
      if (Thread.currentThread() == Looper.getMainLooper().getThread())
      {
        paramVarArgs = paramaeyt.a(paramVarArgs);
        this.jdField_a_of_type_Actd.a(paramVarArgs, paramaeyt);
        this.jdField_a_of_type_Aeyt = paramaeyt;
      }
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TipsManager", 2, "showTipsBar() success: from " + a(paramaeyt.b()));
        }
        return true;
        paramVarArgs = new TipsManager.1(this, paramaeyt, paramVarArgs);
  ...
  public void c()
  {
    ...
    View localView1 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131377720);
    View localView2 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131377714);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        int k = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131298865);
        if (i == -1) {
        ...
        for (i = j + k;; i = j)
        {
          ...
          localLayoutParams.rightMargin = vpm.b(BaseApplicationImpl.getContext(), 40.0F);
  ...
  public void d()
  {
    ...
    try
    {
      if ((this.jdField_b_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131367587) != null))
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(null);
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
        this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131366495));
        this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131366496));
