...
public class awjy
{
  ...
  public static Drawable a(Context paramContext, String paramString)
  {
    ...
    if (paramString.equals("fivea")) {
      paramContext = paramContext.getResources().getDrawable(2130841538);
    }
    for (;;)
    {
      ...
      {
        paramContext = paramContext.getResources().getDrawable(2130841539);
      }
      else if (paramString.equals("qheart"))
      {
        paramContext = paramContext.getResources().getDrawable(2130841540);
      }
      else
      {
        paramContext = localObject1;
        if (!paramString.equals("")) {
          paramContext = new BitmapDrawable(apdh.a(awhq.a() + paramString + ".png"));
        }
      }
    }
  }
  
  public static autg a(autg paramautg)
  {
    if ((!c()) || (!b())) {}
    for (int i = 1; i == 0; i = 0) {
      return paramautg;
    }
    autg localautg = new autg();
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    baig.a(BaseApplicationImpl.getApplication().getSharedPreferences("GestureRecognitionUtils", 4).edit().putBoolean("shared_gesture_recognize_result", paramBoolean));
  }
