...
public class atae
{
  ...
  private ataj jdField_a_of_type_Ataj;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private HashMap<Integer, atal> jdField_a_of_type_JavaUtilHashMap;
  private boolean jdField_a_of_type_Boolean;
  
  public atae(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Ataj = new ataj(this);
  ...
  private static String a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 2)
    {
      ...
      bcst.b(null, "dc00898", "", "", "0X800B00E", "0X800B00E", 0, 0, "", "", "", "");
    }
    for (;;)
    {
  ...
  {
    bcst.b(null, "dc00898", "", "", "0X800B00D", "0X800B00D", 0, 0, "", "", "", "");
  }
  
  public String a(Context paramContext)
  {
    String str2 = ((atam)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(317)).a().jdField_a_of_type_JavaLangString;
    String str1 = str2;
    if (TextUtils.isEmpty(str2)) {
      str1 = paramContext.getString(2131697461);
    }
    return str1;
  }
  ...
  public void a(Context paramContext, String paramString)
  {
    ...
    if (atzj.a().a() == null)
    {
      ...
      paramString.putString("_filename_from_dlg", paramContext.getString(2131694076));
    ...
    paramString.putString("DOWNLOAD_BIG_BROTHER_SOURCE", "biz_src_jc_file");
    paramString.putBundle("_user_data", (Bundle)localObject);
    atzj.a().a("https://a.app.qq.com/o/myapp-down?g_f=1116518", paramString);
  }
  
  public void a(String paramString, atal paramatal)
  {
    a();
    ThreadManagerV2.excute(new QFileAppStorePromoteManager.2(this, paramString, paramatal), 128, null, true);
  }
  ...
  public boolean a(Context paramContext, String paramString, atak paramatak)
  {
    if (((atam)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(317)).a().jdField_a_of_type_Boolean)
    {
      String str1 = paramContext.getString(2131697467);
      paramString = String.format(paramContext.getString(2131697464), new Object[] { paramString });
      String str2 = paramContext.getString(2131697465);
      String str3 = paramContext.getString(2131697466);
      ataf localataf = new ataf(this, paramatak);
      paramatak = new atag(this, paramatak);
      bglp.a(paramContext, 0, str1, paramString, str2, str3, paramContext.getString(2131690582), localataf, paramatak).show();
      bcst.b(null, "dc00898", "", "", "0X800AE3F", "0X800AE3F", 0, 0, "", "", "", "");
      return true;
    }
    return false;
  }
  ...
  {
    if (atzj.a().a("https://a.app.qq.com/o/myapp-down?g_f=1116518"))
    {
      QQToast.a(paramContext, 0, 2131697463, 0).a();
      return;
    }
    String str = paramContext.getString(2131697462);
    bglp.a((Activity)paramContext, str, 2131690582, 2131694081, new atah(this, paramContext, paramString), new atai(this)).show();
  }
  
  public boolean b()
  {
    return ((atam)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(317)).a().jdField_a_of_type_Boolean;
  }
}
