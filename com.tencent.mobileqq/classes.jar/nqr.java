...
public class nqr
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, byte[] paramArrayOfByte, boolean paramBoolean2)
  {
      ...
      try
      {
        ...
        if (((account_detail_dynamic_list.AccountDetailDynamicListResponse)localObject).ret_info.has())
        {
          ...
          if (((account_detail_dynamic_list.AccountDetailDynamicListResponse)localObject).ret_info.ret_code.get() == 0)
          {
            ...
            localArrayList = nqq.a(paramQQAppInterface).a(l1);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          i = nqq.a(paramQQAppInterface).a(paramArrayOfByte, paramBoolean1, l1, l2, l3, localArrayList, paramBoolean2);
          break;
        }
        i = 5;
        break;
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, anry paramanry)
  {
    if (QLog.isColorLevel()) {
    ...
    ((account_detail_dynamic_list.AccountDetailDynamicListRequest)localObject).versionInfo.set("8.4.1,3,4680");
    ...
    if (paramLong2 == 0L)
    {
      ...
      localObject = ((anrs)localObject).a(String.valueOf(paramLong1));
      if (localObject == null) {
        break label350;
      }
      ...
      paramInt = 1;
      i = oat.a(paramQQAppInterface, String.valueOf(paramLong1), (AccountDetail)localObject);
    }
    for (;;)
    {
      ...
      {
        oat.a(null, str1, "0X80077FF", "0X80077FF", 0, 0, "1", str2, (String)localObject, String.valueOf(i), false);
        localNewIntent.setObserver(new nqs(paramQQAppInterface, bool, paramanry));
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, anry paramanry)
  {
    nqq.a(paramQQAppInterface).a(paramQQAppInterface, paramLong, paramanry);
    a(paramQQAppInterface, paramLong, 0L, 25, paramanry);
  }
  
  public static void b(QQAppInterface paramQQAppInterface, long paramLong, anry paramanry)
  {
    nqg localnqg = nqq.a(paramQQAppInterface).a(paramLong);
    if ((localnqg != null) && (localnqg.b > 0L))
    {
      if (a != localnqg.b) {
        a(paramQQAppInterface, paramLong, localnqg.b, 25, paramanry);
      }
      return;
    }
    a(paramQQAppInterface, paramLong, paramanry);
  }
}
