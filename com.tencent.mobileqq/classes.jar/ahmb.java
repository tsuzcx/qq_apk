...
public class ahmb
  implements Runnable
{
  public ahmb(EffectsCameraCaptureView paramEffectsCameraCaptureView, String paramString) {}
  ...
  public void run()
  {
    ...
    for (localObject1 = "paramsback";; localObject1 = "params")
    {
      ...
      for (;;)
      {
        ...
        EffectsCameraCaptureView.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewEffectsCameraCaptureView, new ahmc(this, (QQVideoMaterial)localObject1, localQQFilterRenderManager, (VideoFilterList)localObject2, (QQVideoMaterial)localObject1, bool2, k, j));
        return;
      }
    }
  }
