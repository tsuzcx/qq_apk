  ...
  implements Manager
{
  ...
  public String a;
  ArrayList<alxc> jdField_a_of_type_JavaUtilArrayList = new ArrayList(2);
  ...
  public alxa(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_Bead = new alxb(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Amrg = ((amrg)paramQQAppInterface.a(59));
    this.jdField_a_of_type_Amha = ((amha)paramQQAppInterface.a().a(2));
  ...
  private List<MessageRecord> a(String paramString1, String paramString2, String paramString3)
  {
    ...
    paramString1 = bdih.a(paramString2, paramString1, localSQLiteDatabase, paramString3, null);
    ...
    return ((awgn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createMessageRecordEntityManager()).a(paramString1.toString(), null, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  private boolean a(Calendar paramCalendar)
  {
    ...
    paramCalendar = this.jdField_a_of_type_Amha.a(this.jdField_a_of_type_JavaLangString, i, j + 1);
  ...
  private void b(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Boolean) {
      ...
      {
        localCalendar = this.jdField_a_of_type_Amha.b(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaUtilCalendar, null);
        ...
        do
        {
          do
          {
            do
            {
              ...
              localCalendar = this.jdField_a_of_type_Amha.a(this.jdField_a_of_type_JavaLangString, this.jdField_c_of_type_JavaUtilCalendar, null);
  ...
  private boolean b(Calendar paramCalendar)
  {
    ...
    if ((l > ((Long)localPair.first).longValue()) && (l <= ((Long)localPair.second).longValue()))
    {
      ...
      if (paramCalendar != null)
      {
        ...
        this.jdField_a_of_type_Amha.a(paramCalendar);
      }
      return true;
    }
    return false;
  ...
  public int a(String paramString, int paramInt, StringBuilder paramStringBuilder)
  {
    ...
    for (paramString = bdih.a(MessageRecord.getOldTableName(paramString, paramInt), MessageRecord.getTableName(paramString, paramInt), localSQLiteDatabase, "", localStringBuilder.toString(), ""); paramString == null; paramString = bdih.a(MessageRecord.getOldTableName(paramString, paramInt), MessageRecord.getTableName(paramString, paramInt), localSQLiteDatabase, localStringBuilder.toString()))
    {
      return 0;
  ...
  public int a(String paramString, long paramLong1, long paramLong2)
  {
    ...
    paramString = a(MessageRecord.getTableName(paramString, 0), null, "( msgtype " + abti.b() + " and isValid=1 and " + str + " ) " + "ORDER BY time asc , longMsgIndex asc", paramLong1, paramLong2);
    if (paramString == null) {
      return 0;
    }
  ...
  public amha a()
  {
    return this.jdField_a_of_type_Amha;
  }
  
  public Bundle a(Calendar paramCalendar)
  {
    List localList = this.jdField_a_of_type_Amha.a();
    int m;
    int n;
    int i1;
    int i;
    if (!localList.isEmpty())
    {
      ...
      paramCalendar = this.jdField_a_of_type_Amha.a(this.jdField_a_of_type_JavaLangString, m, n);
      i = 0;
      if (i >= localList.size()) {
        break label383;
      }
    ...
    for (;;)
    {
      if (i < localList.size())
      {
        ...
        str = this.jdField_a_of_type_Amha.a(str)[1];
        ...
        for (;;)
        {
          ...
          if ((paramCalendar.getSerState(j - 1) == 2) && (bdin.d(BaseApplication.getContext())))
          {
            paramCalendar = new Bundle();
  ...
  {
    return this.jdField_a_of_type_Amha.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilCalendar, paramInt);
  }
  ...
  public List<MessageRecord> a()
  {
    ...
    for (;;)
    {
      ...
      localObject2 = "( msgtype " + abti.b() + " and isValid=1 ) " + "ORDER BY time asc , longMsgIndex asc";
      ...
      try
      {
        ...
        if (localawhr != null)
        {
          localObject2 = localawhr.a((String)localObject1, (String)localObject2);
  ...
  {
    Object localObject = (awhr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
    if (localObject == null) {
    ...
    {
      return paramString3;
      this.jdField_a_of_type_Long = ((awhr)localObject).a(paramString1);
      if (this.jdField_a_of_type_Long <= paramLong2) {
        break label169;
      }
      paramString2 = "slowTable";
      paramString1 = ((awhr)localObject).a(paramString1, paramString3);
      if (paramString1 != null) {
        break;
      }
      i = 0;
    ...
    for (int k = 0;; k = paramString1.size())
    {
      ...
      localObject = ((awhr)localObject).a(paramString1, paramString3);
      label236:
      String str;
      if (localObject == null)
      {
  ...
  public void a(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    {
      ((alxc)this.jdField_a_of_type_JavaUtilArrayList.get(i)).b(paramInt1, paramInt2, paramObject);
      i += 1;
    }
  }
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            if (paramCalendar != null)
            {
              localRoamMessagePreloadInfo = this.jdField_a_of_type_Amha.a(this.jdField_a_of_type_JavaLangString, paramCalendar, 0);
              localObject = null;
              break;
            }
            if ((paramInt == 3) && (this.jdField_a_of_type_JavaUtilCalendar != null))
            {
              localRoamMessagePreloadInfo = this.jdField_a_of_type_Amha.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilCalendar, 2);
              localObject = null;
              break;
            }
            ...
            localRoamMessagePreloadInfo = this.jdField_a_of_type_Amha.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilCalendar, 1);
            localObject = null;
            break;
  ...
  public void a(alxc paramalxc)
  {
    ...
    while (localIterator.hasNext()) {
      ((alxc)localIterator.next()).a(paramalxc);
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(paramalxc);
  }
  
  void a(beae parambeae)
  {
    if ((parambeae.jdField_a_of_type_Int == 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().edit().putLong("cloudSearchCfgLastModify", parambeae.i).commit();
      if (200 == parambeae.f) {
    ...
    if (QLog.isColorLevel())
    {
      File localFile = new File(alwz.b);
      long l = 0L;
      if (localFile.exists()) {
        l = localFile.lastModified();
      }
      QLog.d("Q.roammsg.MessageRoamManager", 2, "onDone status=" + parambeae.a() + ",errCode=" + parambeae.jdField_a_of_type_Int + ",httpCode=" + parambeae.f + ",local lastModify=" + l + ",server lastModify=" + parambeae.i);
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList == null)
    {
      ...
      this.jdField_a_of_type_Amha.a(paramString);
  ...
  public void a(Calendar paramCalendar, RoamMessagePreloadInfo paramRoamMessagePreloadInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      RoamDate localRoamDate = this.jdField_a_of_type_Amha.a(this.jdField_a_of_type_JavaLangString, i, j);
      ...
      case 2: 
        ...
        this.jdField_a_of_type_Amrg.a(this.jdField_a_of_type_JavaLangString, paramCalendar, paramBoolean1, 8, false, paramBoolean2);
      ...
      case 3: 
        ...
        while ((bdin.d(BaseApplication.getContext())) && (paramRoamMessagePreloadInfo != null))
        {
          this.jdField_a_of_type_JavaUtilHashMap.clear();
          this.jdField_a_of_type_JavaUtilHashMap.put(this.jdField_a_of_type_JavaUtilCalendar, paramRoamMessagePreloadInfo);
  ...
  public void a(List<MessageRecord> paramList, String paramString, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Long = localawhr.a(paramString);
    ...
    if ((i >= j) || (((MessageRecord)paramList.get(i)).time > this.jdField_a_of_type_Long))
    {
      ...
      localawhr.a(paramString, paramList.subList(0, i));
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (paramBoolean)
      {
        ...
        {
          a(26, null);
          this.jdField_a_of_type_Amrg.a(this.jdField_a_of_type_JavaLangString, 0, 1, i, j + 1, k);
          return;
          paramBoolean = false;
          break;
          label100:
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Amrg.b(paramInt));
    r();
    return (this.jdField_a_of_type_Amrg.a == null) || (this.jdField_a_of_type_Amrg.a.size() == 0);
  }
  ...
  public BitSet b(Calendar paramCalendar1, Calendar paramCalendar2)
  {
    ...
    if (!localList.isEmpty())
    {
      ...
      if ((localCalendar.before(paramCalendar2)) || (localCalendar.equals(paramCalendar2)))
      {
        ...
        localCalendar.get(5);
        paramCalendar1 = this.jdField_a_of_type_Amha.a(this.jdField_a_of_type_JavaLangString, n, i1);
        int j = 0;
        int m = 0;
        while (j < localList.size())
        {
          ...
          if (((String)((Map.Entry)localList.get(j)).getKey()).equals(paramCalendar1))
          {
            ...
            {
              if (this.jdField_a_of_type_Amha.a(localRoamDate, k - 1))
              {
                localBitSet.set(i, true);
                if (QLog.isColorLevel()) {
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Amrg.a(paramInt));
  }
  ...
  public void b(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((localObject != null) && (!((List)localObject).isEmpty()) && (b(((MessageRecord)((List)localObject).get(((List)localObject).size() - 1)).time, (Calendar)localCalendar.clone())))
    {
      ...
      this.jdField_a_of_type_Amha.a(this.jdField_a_of_type_JavaLangString, localCalendar.getTimeInMillis() / 1000L, 2);
    }
  }
  
  public void b(alxc paramalxc)
  {
    this.jdField_a_of_type_JavaUtilArrayList.remove(paramalxc);
  }
  ...
  void b(beae parambeae)
  {
    ...
    if ((parambeae.a() == 3) && (parambeae.jdField_a_of_type_Int == 0))
    {
      ...
      localObject = new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getFilesDir(), parambeae.jdField_a_of_type_JavaLangString);
      if (((File)localObject).exists())
      {
        parambeae = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences("vip_message_roam_banner_file", 0);
        localEditor = parambeae.edit();
      }
    }
    for (;;)
    {
      ...
      try
      {
        localObject = new JSONArray(bdhb.a((File)localObject));
        i = 0;
        ...
        if (bool)
        {
          parambeae.edit().putLong("blue_banner_last_update_timestamp", NetConnInfoCenter.getServerTimeMillis()).commit();
          return;
        }
        if (!QLog.isColorLevel()) {
          break label481;
      ...
      catch (JSONException parambeae)
      {
        ...
        QLog.e("Q.roammsg.MessageRoamManager", 2, "JSONException,blue banner parse json error : " + parambeae.toString());
        return;
      }
      ...
      QLog.e("Q.roammsg.MessageRoamManager", 2, "Exception,blue banner parse json error : " + parambeae.toString());
      return;
      if (QLog.isColorLevel())
      {
        ...
        if (QLog.isColorLevel())
        {
          QLog.e("Q.roammsg.MessageRoamManager", 2, "blue banner download failed, task.status = " + parambeae.a() + " , task.errCode = " + parambeae.jdField_a_of_type_Int);
          return;
          label476:
          bool = false;
          continue;
  ...
  public void b(MessageRecord paramMessageRecord)
  {
    ...
    long l = paramMessageRecord.time;
    if (this.jdField_a_of_type_JavaLangString == null) {
      this.jdField_a_of_type_Amha.a(str);
    }
    Object localObject1 = Calendar.getInstance();
    ...
    if (this.jdField_a_of_type_JavaLangString != null)
    {
      ...
      {
        localObject1 = this.jdField_a_of_type_Amha;
        if (this.jdField_a_of_type_JavaLangString == null) {
          break label423;
        }
        paramMessageRecord = this.jdField_a_of_type_JavaLangString;
        label287:
        ((amha)localObject1).a(paramMessageRecord, l - 5L, 1);
        paramMessageRecord = this.jdField_a_of_type_Amha;
        if (this.jdField_a_of_type_JavaLangString != null) {
    ...
    for (;;)
    {
      ...
      {
        localObject2 = this.jdField_a_of_type_Amha;
        if (this.jdField_a_of_type_JavaLangString == null) {
          break label1076;
        }
        paramMessageRecord = this.jdField_a_of_type_JavaLangString;
        ((amha)localObject2).a(paramMessageRecord, l - 5L, 1);
        localObject2 = this.jdField_a_of_type_Amha;
        if (this.jdField_a_of_type_JavaLangString == null) {
          break label1082;
        }
        paramMessageRecord = this.jdField_a_of_type_JavaLangString;
        ((amha)localObject2).b(paramMessageRecord, l - 5L, 0);
        if (QLog.isColorLevel()) {
          QLog.d("Q.roammsg.MessageRoamManager", 2, "judgeClearRoamDateIndex: " + l);
        }
        if (this.jdField_a_of_type_JavaLangString != null) {
  ...
  public void b(Calendar paramCalendar, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramCalendar = this.jdField_a_of_type_Amha.a(this.jdField_a_of_type_JavaLangString, i, j);
    ...
    this.jdField_a_of_type_Amrg.a(this.jdField_a_of_type_JavaLangString, paramCalendar, false, 0, true, paramBoolean);
  }
  ...
  public void b(boolean paramBoolean)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext()) {
      ((alxc)localIterator.next()).a(paramBoolean, null);
    }
  }
      ...
      if ((localCalendar.before(paramCalendar2)) || (localCalendar.equals(paramCalendar2)))
      {
        ...
        while (j < localList.size())
        {
          ...
          if (((String)((Map.Entry)localList.get(j)).getKey()).equals(paramCalendar1))
          {
            ...
            if (k <= RoamDate.getDays(n, i1))
            {
              if ((i == 0) && (!this.jdField_a_of_type_Amha.a(localRoamDate, k - 1)))
              {
                c();
                a(18, null);
                if (QLog.isColorLevel()) {
  ...
  public void c()
  {
    Object localObject = this.jdField_a_of_type_Amha.a();
    if (localObject != null)
    {
      if (QLog.isColorLevel())
      {
  ...
  public void e()
  {
    ...
    for (;;)
    {
      ...
      str2 = "( msgtype " + abti.b() + " and isValid=1 and" + str2 + " ) " + "ORDER BY time asc , longMsgIndex asc";
    ...
    for (;;)
    {
      ...
      case 2: 
        ...
        if ((n == 2) && (bool))
        {
          ...
          paramCalendar.setTime(new Date(i - 1900, j - 1, k));
          QLog.d("Q.roammsg.MessageRoamManager", 1, "handleRoamDateQuery getRoamHistoryForSomeDay year = " + i + " month = " + j + " day = " + k + " call stack = " + Log.getStackTraceString(new Throwable()));
          this.jdField_a_of_type_Amrg.a(this.jdField_a_of_type_JavaLangString, paramCalendar, false, 8, false);
          return;
        }
        break;
      case 3: 
        ...
        while (paramCalendar.hasNext()) {
          ((alxc)paramCalendar.next()).a(true, null);
        }
        break;
      }
      if (QLog.isColorLevel()) {
      ...
      paramCalendar = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (paramCalendar.hasNext()) {
        ((alxc)paramCalendar.next()).a(false, null);
      }
    }
  }
  ...
  public void e(boolean paramBoolean)
  {
    ...
    {
      localObject = ((beag)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47)).a(1);
      if ((localObject != null) && (((beaj)localObject).a("http://imgcache.qq.com/club/mobile/messageroam/xiaoximanyou2.json") == null))
      {
        beae localbeae = new beae("http://imgcache.qq.com/club/mobile/messageroam/xiaoximanyou2.json", new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getFilesDir(), "http://imgcache.qq.com/club/mobile/messageroam/xiaoximanyou2.json"));
        localbeae.p = false;
        ((beaj)localObject).a(localbeae, this.jdField_a_of_type_Bead, null);
      }
    }
  }
  ...
  public void m()
  {
    ...
    for (;;)
    {
      ...
      for (int k = 0; localIterator.hasNext(); k = m)
      {
        ...
        RoamDate localRoamDate = this.jdField_a_of_type_Amha.a(this.jdField_a_of_type_JavaLangString, m, n);
        localObject = localRoamDate;
        if (localRoamDate == null) {
          localObject = new RoamDate(String.valueOf(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_Amha.a(m, n));
        }
        if (2 != ((RoamDate)localObject).getSerState(i1 - 1))
        {
          ((RoamDate)localObject).setLocState(i1 - 1, 3);
          this.jdField_a_of_type_Amha.a((RoamDate)localObject);
        }
        i = i1;
        j = n;
      }
  ...
  public void o()
  {
    ...
    Object localObject1 = new File(alwz.b);
    int i;
    Object localObject4;
    Object localObject2;
    Object localObject3;
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
        try
        {
          ...
          if (i < localJSONArray.length())
          {
            ...
            {
              if (QLog.isColorLevel()) {
                QLog.d("Q.roammsg.MessageRoamManager", 2, "curr ver: 8.3.5, config qqVer:" + (String)localObject1);
              }
            }
            else
            {
