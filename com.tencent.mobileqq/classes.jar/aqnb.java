...
class aqnb
{
  ...
  private ArrayList<aqnd> jdField_a_of_type_JavaUtilArrayList;
  
  public aqnb(String paramString)
  {
  ...
  public Object a(Map<String, Object> paramMap)
  {
    ...
    for (;;)
    {
      ...
      paramMap = ((aqnd)localIterator.next()).a(paramMap);
    }
  }
  
  public ArrayList<aqnd> a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if (i < localArrayList.size())
        {
          ...
          if (str1.charAt(0) == '.')
          {
            paramString.add(new aqne(str1.substring(1)));
          }
          else
          {
            String str2 = aqnf.a().b(str1);
            if (!TextUtils.isEmpty(str2)) {
              paramString.add(new aqne(str2));
            }
          }
        }
      }
      ...
      return paramString;
      String str1 = aqnf.a().a(str1);
      if (!TextUtils.isEmpty(str1)) {
        paramString.add(new aqnc(Integer.parseInt(str1)));
      } else {
        return null;
      }
      i += 1;
