...
{
  private static final String jdField_a_of_type_JavaLangString = ocf.class.getName();
  ...
  private ock jdField_a_of_type_Ock;
  ...
  public ocf(Activity paramActivity)
  {
  ...
  public ocf(Activity paramActivity, String paramString1, String paramString2, String paramString3)
  {
    this(paramActivity);
  ...
  public static ocf a(Activity paramActivity, String paramString1, String paramString2, String paramString3)
  {
    return new ocf(paramActivity, paramString1, paramString2, paramString3);
  }
  ...
  private void a()
  {
    for (;;)
    {
      try
      {
        ...
        localObject1 = naj.a(BaseApplicationImpl.getContext(), (String)localObject1, "GET", null, (Bundle)localObject4);
  ...
  private void a(Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_Zbr = new ocj(this, paramActivity.getApplicationContext(), paramActivity, null, localAppInterface);
    this.jdField_a_of_type_Zbr.a(this.jdField_a_of_type_ComTencentBizUiTouchWebView);
    new bcbu(this.jdField_a_of_type_Zbr).a(null, localAppInterface, null);
  }
  
  private void b()
  {
    View localView = getLayoutInflater().inflate(2131559796, null);
    ((RelativeLayout)localView.findViewById(2131371847)).setOnClickListener(new och(this));
    ...
    this.jdField_a_of_type_ComTencentMobileqqMiniUtilSoftKeyboardStateHelper.addSoftKeyboardStateListener(new oci(this, (RelativeLayout.LayoutParams)localObject));
  ...
  public void a(ock paramock)
  {
    this.jdField_a_of_type_Ock = paramock;
  }
  ...
  public void onDismiss(DialogInterface paramDialogInterface)
  {
    ...
    if (this.jdField_a_of_type_Zbr != null)
    {
      ...
      this.jdField_a_of_type_Zbr = null;
    }
    if (this.jdField_a_of_type_Ock != null) {
      this.jdField_a_of_type_Ock.a();
    }
  }
  ...
  public void show()
  {
    ...
    getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new ocg(this));
