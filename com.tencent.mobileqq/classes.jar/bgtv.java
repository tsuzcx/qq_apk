...
public class bgtv
{
  ...
  public static int a(bgtw parambgtw)
  {
    if ((parambgtw == bgtw.b) || (parambgtw == bgtw.c)) {}
    do
    {
      return 2130847053;
      if (parambgtw == bgtw.d) {
    ...
    } while ((parambgtw != bgtw.f) && (parambgtw != bgtw.g));
    return 2130847050;
  }
  ...
  {
    if (!paramBoolean) {}
    for (String str = aqxf.c().mAPngIconUrl;; str = aqxf.c().mAPngIconUrlNewGray)
    {
      if (paramBoolean) {
        paramLong = 0L;
      }
  ...
  {
    Object localObject = (anmw)paramAppRuntime.getManager(51);
    if (localObject != null)
    {
  ...
  public static String a(AppRuntime paramAppRuntime, String paramString, bgtw parambgtw, boolean paramBoolean)
  {
    ...
    if (paramAppRuntime != null)
    {
      ...
      {
        int i;
        if ((parambgtw == bgtw.f) || (parambgtw == bgtw.g))
        {
          i = paramAppRuntime.getServiceLevel(EVIPSPEC.E_SP_BIGCLUB);
          return a(parambgtw.a, i, paramAppRuntime.bigClubTemplateId, paramBoolean);
        }
        if ((parambgtw == bgtw.d) || (parambgtw == bgtw.e))
        {
          i = paramAppRuntime.getServiceLevel(EVIPSPEC.E_SP_SUPERVIP);
          return a(parambgtw.a, i, paramAppRuntime.superVipTemplateId, paramBoolean);
        }
        if ((parambgtw == bgtw.b) || (parambgtw == bgtw.c))
        {
          i = paramAppRuntime.getServiceLevel(EVIPSPEC.E_SP_QQVIP);
          return a(parambgtw.a, i, 0L, paramBoolean);
        }
      }
    }
    return a(0, 0, 0L, false);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString)
  {
    ...
    paramString = aqxf.c().getVipIconSettingsUrl(paramString);
  ...
  private static String b(asht paramasht)
  {
    int i = VipUtils.a(paramasht);
    i = (i & 0xF) << 8 | i >> 8;
    if ((i & 0xFF) == 3) {
      return a(i, paramasht.mBigVipLevel, paramasht.mTemplateId, false);
    }
    if ((i & 0xFF) == 2) {
      return a(i, paramasht.mVipLevel, paramasht.mTemplateId, false);
    }
    return null;
  }
  ...
  private static void e(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (int i = 9;; i = 0)
    {
      bcst.b(null, "dc00898", "", "", "qq_vip", paramString, i, 1, paramInt, "", "", "", "");
      return;
    }
  }
}
