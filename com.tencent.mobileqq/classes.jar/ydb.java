  ...
  implements View.OnClickListener
{
  ...
  arxd jdField_a_of_type_Arxd = new ydd(this);
  ...
  public ydb(Context paramContext, View paramView, yde paramyde)
  {
  ...
  private void e()
  {
    ((PatchedButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131367274)).setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new ydc(this);
  ...
  private void f()
  {
    yqp.b("Q.qqstory.detail.KeyboardAndEmojiManager", "on keyboard up. mIsForceChange = %s.", Boolean.valueOf(this.d));
    ...
    if (this.jdField_a_of_type_Yde != null) {
      this.jdField_a_of_type_Yde.b(this.d);
    }
    this.d = false;
  }
  ...
  private void g()
  {
    yqp.b("Q.qqstory.detail.KeyboardAndEmojiManager", "on keyboard down. mIsForceChange = %s.", Boolean.valueOf(this.d));
    ...
    {
      if (this.jdField_a_of_type_Yde != null) {
        this.jdField_a_of_type_Yde.c(bool);
      }
      this.c = false;
      this.d = false;
      return;
  ...
  {
    ((PatchedButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131367274)).setText(paramString);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      yqp.b("Q.qqstory.detail.KeyboardAndEmojiManager", "setKeyBoardState: %s." + paramBoolean);
      return;
      label79:
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (System.currentTimeMillis() - this.jdField_a_of_type_Long >= 500L)
      {
        ...
        if ((this.jdField_a_of_type_Yde == null) || (!this.jdField_a_of_type_Yde.b()))
        {
          this.c = true;
