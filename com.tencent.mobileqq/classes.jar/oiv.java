...
{
  public oiv(@NonNull EditVideoDoodle paramEditVideoDoodle)
  {
  ...
  public void a(@NonNull EditVideoDoodle paramEditVideoDoodle, @NonNull DoodleEmojiManager.DoodleEmojiDownloadEvent paramDoodleEmojiDownloadEvent)
  {
    ...
    oiy localoiy = paramEditVideoDoodle.jdField_a_of_type_Oiy;
    if (localoiy != null)
    {
      Object localObject = localoiy.a(paramDoodleEmojiDownloadEvent.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem.a);
      ...
      if (paramDoodleEmojiDownloadEvent.jdField_a_of_type_Int == 0)
      {
        if (paramDoodleEmojiDownloadEvent.jdField_a_of_type_Boolean)
        {
          ...
          localoiy.a((FacePackage)localObject);
          return;
        }
