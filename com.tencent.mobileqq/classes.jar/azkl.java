  ...
  extends azki
{
  ...
  public boolean a(LatLng paramLatLng, int paramInt, azkr paramazkr)
  {
    ...
    this.jdField_a_of_type_ComTencentLbssearchTencentSearch.geo2address(new Geo2AddressParam(paramLatLng).getPoi(true).setPoiOptions(new Geo2AddressParam.PoiOptions().setPolicy(1).setPageSize(azjb.d).setPageIndex(0)), new azkm(this, paramLatLng, paramazkr));
    return true;
  }
}
