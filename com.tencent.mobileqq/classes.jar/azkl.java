...
public class azkl
{
  ...
  private Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new azkm(this);
  ...
  public azkl(View paramView)
  {
    if (paramView != null)
    {
      this.jdField_a_of_type_AndroidViewView = paramView;
      this.jdField_a_of_type_Int = bggq.a(this.jdField_a_of_type_AndroidViewView.getContext(), 15.0F);
