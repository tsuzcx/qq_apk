...
{
  private static qwf jdField_a_of_type_Qwf;
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  private final ArrayList<qwo> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private int jdField_b_of_type_Int;
  private long jdField_b_of_type_Long = 600000L;
  private final ArrayList<qwp> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private qwf()
  {
    ...
    this.jdField_a_of_type_JavaUtilArrayList.add(new qwj());
    this.jdField_b_of_type_JavaUtilArrayList.add(new qwq());
    this.jdField_b_of_type_JavaUtilArrayList.add(new qwr(i));
    this.jdField_b_of_type_JavaUtilArrayList.add(new qwl(i));
    this.jdField_b_of_type_JavaUtilArrayList.add(new qwk(f1));
    this.jdField_b_of_type_JavaUtilArrayList.add(new qwm(f2));
    a();
  }
  
  public static qwf a()
  {
    if (jdField_a_of_type_Qwf == null) {}
    try
    {
      if (jdField_a_of_type_Qwf == null) {
        jdField_a_of_type_Qwf = new qwf();
      }
      return jdField_a_of_type_Qwf;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    {
      ((ConnectivityManager)BaseApplicationImpl.getApplication().getSystemService("connectivity")).registerNetworkCallback(new NetworkRequest.Builder().build(), new qwh(this, null));
      return;
    }
    BaseApplicationImpl.getApplication().registerReceiver(new qwi(this, null), new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
  }
  ...
  private long b()
  {
    ...
    {
      long l2 = ((qwo)localIterator.next()).a();
      l1 = l2;
      if (l2 > 0L) {
        l1 = l2;
      }
  ...
  private void b()
  {
    ...
    if (l > this.jdField_a_of_type_Long)
    {
      ...
      if (this.e > this.jdField_a_of_type_Long)
      {
        ...
        while (localIterator.hasNext()) {
          ((qwp)localIterator.next()).a(this.e);
        }
      }
      this.e = l;
    }
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (this.e > localqwp.jdField_a_of_type_Long) {
          localqwp.a(this.e);
        }
      }
      this.e = 0L;
  ...
  private void c()
  {
    ...
    {
      qwp localqwp = (qwp)localIterator.next();
      long l2 = Math.max(localqwp.jdField_a_of_type_Long, l1);
      l1 = l2;
      if (QLog.isColorLevel())
      {
        QLog.d("BandwidthPredictor", 2, "predict: predictor=" + localqwp + ", currentPrediction=" + localqwp.jdField_b_of_type_Long + ", prediction=" + localqwp.jdField_a_of_type_Long);
        l1 = l2;
      }
    }
  ...
  public final long[] a()
  {
    ...
    {
      arrayOfLong[i] = ((qwp)this.jdField_b_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_Long;
      i += 1;
    }
    return arrayOfLong;
  }
