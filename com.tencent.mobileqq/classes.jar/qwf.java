...
{
  public qwf(NativeShareView paramNativeShareView) {}
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        olh.a(null, "", "0X800A3BE", "0X800A3BE", 0, 0, "", "", "", paramAdapterView.toString(), false);
        return;
        paramInt = 6;
        uwi.a(NativeShareView.a(this.a));
        continue;
        uwi.a((Activity)NativeShareView.a(this.a));
        paramInt = 1;
        continue;
        uwi.a((BaseActivity)NativeShareView.a(this.a));
        paramInt = 2;
        continue;
        uwi.b((Activity)NativeShareView.a(this.a));
        paramInt = 3;
        continue;
        uwi.c((Activity)NativeShareView.a(this.a));
        paramInt = 4;
      }
