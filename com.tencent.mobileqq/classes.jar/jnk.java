...
{
  public jnk(QQServiceForAV paramQQServiceForAV) {}
  ...
  private void a(IBinder paramIBinder)
  {
    ...
    try
    {
      QQServiceForAV.jdField_a_of_type_AndroidOsIBinder.linkToDeath(new jnm(this), 0);
      return;
    }
  ...
  public Bundle a(int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, Bundle paramBundle, ResultReceiver paramResultReceiver)
  {
    ...
    case 4: 
      for (;;)
      {
        ...
        bool1 = false;
        break;
        new Handler(Looper.getMainLooper()).postDelayed(new jnn(this, paramBundle), 1L);
        continue;
        new Handler(Looper.getMainLooper()).postDelayed(new jno(this, paramBundle, paramResultReceiver), 1L);
        continue;
        if (paramBundle != null)
        {
      ...
      if (((ConditionSearchManager)localObject).a() == 1)
      {
        if (((ConditionSearchManager)localObject).a(((ConditionSearchManager)localObject).a(), true) == 0)
        {
          if (QQServiceForAV.a(this.a) == null) {
            QQServiceForAV.a(this.a, new jni(this, (ConditionSearchManager)localObject, paramIQQServiceLocationCallback));
          }
          for (;;)
          {
  ...
  {
    ProtoUtils.a((QQAppInterface)this.a.a(), new jnl(this, paramString, paramInt2), paramArrayOfByte, paramString, paramInt1, paramInt2);
  }
  ...
  public void b(IQQServiceLocationCallback paramIQQServiceLocationCallback)
  {
    ...
    do
    {
      do
      {
        ...
        if (QQServiceForAV.a(this.a) == null) {
          QQServiceForAV.a(this.a, new jnj());
        }
        QQServiceForAV.a(this.a).a(paramIQQServiceLocationCallback);
