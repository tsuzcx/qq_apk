...
public class aziz
  extends wlv
{
  public aziz(TroopFileTransferManager paramTroopFileTransferManager) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, group_file_common.FileInfo paramFileInfo)
  {
    if ((paramBoolean) && (paramFileInfo != null))
    {
      ...
      if (localObject != null)
      {
        ((ayoq)localObject).a = paramFileInfo.uint32_bus_id.get();
        ((ayoq)localObject).c = paramFileInfo.uint32_dead_time.get();
      }
      this.a.a().d((ayoq)localObject);
    }
  }
}
