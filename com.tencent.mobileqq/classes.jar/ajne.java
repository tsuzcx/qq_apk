...
public class ajne
{
  ...
  public static String a(String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      ...
      str2 = paramArrayOfString[ascj.a(paramArrayOfString.length)];
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          ((JSONObject)localObject).put("atlas", ajkk.a(paramInt + "/role", 1));
          ((JSONObject)localObject).put("json", ajkk.a(paramInt + "/role", 1));
          continue;
      ...
      localJSONObject2.put("atlas", ajkk.a(localInteger + "/dress", 2));
      localJSONObject2.put("json", ajkk.a(localInteger + "/dress", 2));
    }
    localJSONObject1.put("dressPath", localException1);
    return localJSONObject1;
  }
  
  public static void a(int paramInt1, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt2, String paramString3, ajnk paramajnk)
  {
    airz localairz = (airz)paramQQAppInterface.getManager(153);
    Object localObject = localairz.b(paramString1);
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (localObject.length > 0))
      {
        ...
        if (paramInt2 < j)
        {
          aiwn localaiwn = localObject[paramInt2];
          i = localaiwn.jdField_b_of_type_Int;
          int[] arrayOfInt = localaiwn.a();
          if ((ajkk.a(paramString1, localaiwn.jdField_a_of_type_Int, arrayOfInt, paramQQAppInterface, new ajni(paramajnk, paramInt1, paramQQAppInterface, paramString2, paramString3, localaiwn, arrayOfInt))) && (localaiwn.jdField_a_of_type_Int != 0))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloGameBasicEventUtil", 2, "valid role and dress RSC.");
            }
            if (paramajnk != null) {
              paramajnk.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, localaiwn.jdField_a_of_type_Int, arrayOfInt, 3);
            }
          }
        }
      }
      ...
      for (;;)
      {
        ...
        if (paramajnk != null)
        {
          ...
          {
            paramInt2 = 2;
            paramajnk.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, paramInt2, ajhw.a(paramInt2), 1);
          }
        }
        else
        {
          airz.a(paramQQAppInterface, paramString1, "apllo_game");
          paramQQAppInterface = (ajxn)paramQQAppInterface.getManager(51);
          if ((paramQQAppInterface == null) || (paramQQAppInterface.b(paramString1))) {
            continue;
          }
          paramQQAppInterface = localairz.b(paramString1);
        ...
        for (long l = paramQQAppInterface.apolloUpdateTime;; l = 0L)
        {
          ...
          paramajnk.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, 1, ajhw.a(1), 1);
          break label282;
        }
      }
    }
  ...
  public static void a(int paramInt, String paramString, Activity paramActivity)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localajrf = new ajrf();
        localObject1 = ajae.a(paramInt);
        if (localObject1 != null)
        {
          localObject1 = ((ajch)localObject1).a();
          if ((localObject1 != null) && (((CmGameStartChecker.StartCheckParam)localObject1).game != null))
          {
            localajrf.jdField_b_of_type_Int = ((CmGameStartChecker.StartCheckParam)localObject1).game.actionId;
            localajrf.jdField_b_of_type_JavaLangString = ((CmGameStartChecker.StartCheckParam)localObject1).game.name;
          }
        }
        if (localajrf.jdField_b_of_type_Int <= 0) {
          localajrf.jdField_b_of_type_Int = 439;
        }
        localajrf.jdField_a_of_type_Int = paramInt;
        localajrf.jdField_a_of_type_JavaLangString = ajyc.a(2131700359);
        localajrf.jdField_c_of_type_Int = i;
        ...
        ((JSONObject)localObject1).put("xyRootSrc", aiyg.a(paramInt));
        i = paramString.optInt("activityId");
        int j = paramString.optInt("reqCode");
        localObject2 = ajae.a(paramInt);
        if (localObject2 != null)
        {
          ((ajch)localObject2).jdField_b_of_type_Int = i;
          ((ajch)localObject2).jdField_c_of_type_Int = j;
        }
        localajrf.jdField_c_of_type_JavaLangString = ((JSONObject)localObject1).toString();
        if (localajrf.jdField_c_of_type_JavaLangString.length() >= 500)
        {
          QLog.w("cmgame.sendmsg", 1, "extendInfo is too long, len:" + localajrf.jdField_c_of_type_JavaLangString.length() + ",content:" + localajrf.jdField_c_of_type_JavaLangString);
          return;
        }
      }
      ...
      Object localObject1 = ajco.a();
      if ((localObject1 != null) && (((ajco)localObject1).a != null) && (0L != l)) {
        ((ajco)localObject1).a.roomId = l;
      }
      if (i == 0)
      {
        paramString.put("msgType", 4);
        ajbw.a("cs.send_game_msg.local", paramString.toString(), true, null, paramInt);
        return;
      }
    } while (1 != i);
    a(localajrf, paramActivity, 3);
  }
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject1 = (airz)paramQQAppInterface.getManager(153);
    Object localObject2 = airz.jdField_c_of_type_JavaLangString;
    localObject1 = airz.jdField_b_of_type_JavaLangString;
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        a(paramLong, paramQQAppInterface, paramString2, "", 1, paramString1, new ajnf());
        return;
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, String paramString3, ajnj paramajnj)
  {
    airz localairz = (airz)paramQQAppInterface.getManager(153);
    Object localObject = localairz.b(paramString1);
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (localObject.length > 0))
      {
        ...
        if (paramInt < j)
        {
          aiwn localaiwn = localObject[paramInt];
          i = localaiwn.jdField_b_of_type_Int;
          int[] arrayOfInt = localaiwn.a();
          if ((ajkk.a(paramString1, localaiwn.jdField_a_of_type_Int, arrayOfInt, paramQQAppInterface, new ajnh(paramajnj, paramLong, paramQQAppInterface, paramString2, paramString3, localaiwn, arrayOfInt))) && (localaiwn.jdField_a_of_type_Int != 0))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloGameBasicEventUtil", 2, "valid role and dress RSC.");
            }
            if (paramajnj != null) {
              paramajnj.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, localaiwn.jdField_a_of_type_Int, arrayOfInt, 3);
            }
          }
        }
      }
      ...
      for (;;)
      {
        ...
        if (paramajnj != null)
        {
          ...
          {
            paramInt = 2;
            paramajnj.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, paramInt, ajhw.a(paramInt), 1);
          }
        }
        else
        {
        ...
        for (paramLong = paramQQAppInterface.apolloUpdateTime;; paramLong = 0L)
        {
          ...
          paramajnj.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, 1, ajhw.a(1), 1);
          break label285;
        }
      }
    }
  ...
  public static void a(ajrf paramajrf, Activity paramActivity, int paramInt)
  {
    if (paramajrf == null)
    {
    ...
    localBundle.putInt("forward.apollo.gameid", paramajrf.jdField_a_of_type_Int);
    localBundle.putInt("forward.apollo.gameMode", paramajrf.jdField_c_of_type_Int);
    localBundle.putInt("forward_type", 34);
    if (QLog.isColorLevel()) {
      QLog.d("ApolloGameBasicEventUtil", 2, "[forwardGameMsg] gameId:" + paramajrf.jdField_a_of_type_Int + ";fromtype:" + paramInt);
    }
    if (paramInt == 2)
    {
      localIntent.putExtras(localBundle);
      aqbc.a(paramActivity, localIntent, 99999);
      return;
    }
    localBundle.putInt("forward.apollo.actionid", paramajrf.jdField_b_of_type_Int);
    localBundle.putLong("forward.apollo.roomid", paramajrf.jdField_a_of_type_Long);
    localBundle.putString("forward.apollo.gamename", paramajrf.jdField_b_of_type_JavaLangString);
    localBundle.putString("forward.apollo.actionname", paramajrf.jdField_a_of_type_JavaLangString);
    localBundle.putInt("forward.apollo.msgtype", paramajrf.d);
    localBundle.putString("forward.apollo.sharejson", paramajrf.jdField_c_of_type_JavaLangString);
    localIntent.putExtras(localBundle);
    aqbc.a(paramActivity, localIntent, 20180426);
  }
    ...
    if (localJSONObject1.has("param"))
    {
      ...
      if (localJSONObject2 != null)
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          paramString = bfng.a(paramString, str, localJSONObject2.getString(str));
        }
      }
    }
    for (;;)
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localajrf = new ajrf();
        ApolloGameData localApolloGameData = ((ajmw)localObject).a(k);
        paramString = ajyc.a(2131700341);
        if ((localApolloGameData != null) && (!TextUtils.isEmpty(localApolloGameData.name)))
        {
          ...
          localajrf.jdField_a_of_type_JavaLangString = paramString;
          localajrf.jdField_b_of_type_Int = i;
          localajrf.jdField_c_of_type_Int = j;
          localajrf.jdField_a_of_type_Long = l;
          localajrf.jdField_a_of_type_Int = k;
      ...
      localajrf.jdField_b_of_type_JavaLangString = ajyc.a(2131700360);
      int i = 0;
      continue;
      localajrf.d = 3;
      continue;
      ...
      ApolloGameUtil.a(paramQQAppInterface, localajrf, paramString.a());
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          QLog.i("ApolloGameBasicEventUtil", 1, "pass uin.");
          a(paramInt, paramQQAppInterface, paramString2, str, 1, paramString1, new ajng(i));
          return;
        }
      }
      catch (Exception paramQQAppInterface)
  ...
  public static boolean a(Context paramContext, String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 2)
      {
        ...
        String str = String.format("https://cmshow.qq.com/apollo/html/game-platform/buy-props.html?_wv=3&adtag=inside_game&gameId=%s&gameOrientation=%s&itemList=%s", new Object[] { Integer.valueOf(localajch.a()), Integer.valueOf(i), URLEncoder.encode(paramString.optString("itemList"), "UTF-8") });
        ...
        VipUtils.a(null, "cmshow", "Apollo", "open_webpage", 0, 0, new String[] { localajch.a().mGameName });
        if (QLog.isColorLevel())
        {
          ...
          VipUtils.a(null, "cmshow", "Apollo", "open_webpage", 1, 0, new String[] { localajch.a().mGameName });
        }
      }
      else
      {
  ...
  private static String b()
  {
    ...
    {
      if ((ajyc.a(2131700368).equals(str)) || (str.contains(ajyc.a(2131700353)))) {
        return a(b);
      }
      if ((ajyc.a(2131700366).equals(str)) || (str.contains(ajyc.a(2131700327)))) {
        return a(c);
      }
      if ((ajyc.a(2131700339).equals(str)) || (str.contains(ajyc.a(2131700333)))) {
  ...
  public static void b(long paramLong, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    paramString = b(airz.jdField_c_of_type_JavaLangString.getBytes(), paramString.getBytes());
    try
    {
    ...
    if (localJSONObject.has("param"))
    {
      ...
      if (localJSONObject != null)
      {
        ...
        for (;;)
        {
          ...
          paramString = bfng.a(paramString, str, localJSONObject.getString(str));
        }
      }
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      ((nri)paramQQAppInterface.a(88)).a(i, paramString, str1, str2, str3, l1, l2, l3, l4, bool);
      return;
    }
    catch (Exception paramQQAppInterface)
    {
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    int j = bbev.b(paramQQAppInterface.getApp());
    long l1 = 0L;
    label199:
    label204:
    label210:
