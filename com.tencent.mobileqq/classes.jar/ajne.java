...
{
  private ajnd jdField_a_of_type_Ajnd;
  ...
  public ajne(NewStyleCountryActivity paramNewStyleCountryActivity, Context paramContext)
  {
    super(paramContext);
    ...
    paramContext = (Button)findViewById(2131363774);
    paramContext.setVisibility(0);
    paramContext.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView = findViewById(2131376347);
    ...
    findViewById(2131376926).setVisibility(8);
    this.jdField_a_of_type_ComTencentWidgetListView = ((ListView)findViewById(2131376951));
    this.jdField_a_of_type_Ajnd = new ajnd(paramNewStyleCountryActivity, null);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Ajnd);
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Ajnd.a(paramString);
    if (this.jdField_a_of_type_Ajnd.getCount() == 0) {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
      this.jdField_a_of_type_Ajnd.notifyDataSetChanged();
      return;
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 208	achg:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 208	achg:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 208	achg:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
