  ...
  public void onReceive(Context arg1, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      if ("action_shop_set_read".equals(???))
      {
        ...
        synchronized (onq.a(this.a))
        {
          paramIntent = (EcShopData)onq.a(this.a).get(localObject);
          if (paramIntent == null) {
            continue;
          }
          ??? = null;
          ...
          if (??? != null)
          {
            alik.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, 1008);
          ...
          if (((String)localObject).equals(onq.g))
          {
            l = onq.a().getLong("ad_id", 0L);
            ((ook)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.EC_SHOP_REPORT_HANDLER)).a(134246438, null, null, null, null, l, false);
            ??? = onq.a().edit();
            ???.remove("ad_id");
        ...
        bdla.b(null, "dc00899", "Pb_account_lifeservice", (String)localObject, "0X80064D2", "0X80064D2", 0, 0, "" + i, "", "", "");
        return;
      }
      ...
      if ("action_folder_destroy".equals(???))
      {
        if (paramIntent.getLongExtra("stay_time", 0L) >= this.a.jdField_a_of_type_Long) {
          onq.a().edit().putLong("last_stay_folder", System.currentTimeMillis());
        }
        this.a.f = false;
        return;
      }
      ...
      {
        onq.a().edit().putBoolean("folder_tab_red", true).commit();
        return;
      }
      ...
      try
      {
        ...
        bool = ((aoan)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER)).a(Long.valueOf(l));
