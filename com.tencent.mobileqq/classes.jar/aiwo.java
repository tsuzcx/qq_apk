  ...
  extends BaseAdapter
{
  ...
  public aiwo(Context paramContext, View paramView, String paramString)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_JavaUtilList = aiwr.a().a(paramString);
  ...
  public void a()
  {
    ArrayList localArrayList = aiwr.a().a(this.jdField_a_of_type_JavaLangString);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130846226);
      paramView.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130839450);
      paramView.jdField_a_of_type_ComTencentMobileqqWidgetPresseffectPressEffectImageView.setImageResource(2130846225);
    }
    for (;;)
    {
      ...
      return localView;
      localObject = (aiwq)paramView.getTag();
      localView = paramView;
