  ...
  implements Manager
{
  ...
  public aovk(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    try
    {
      ...
      if ((((File)localObject).exists()) && (((File)localObject).isDirectory()))
      {
        ...
        {
          Collections.sort((List)localObject, new aovl(this));
          i = 10;
        }
      }
      else
  ...
  public int a()
  {
    return ((Integer)aush.a(this.a.getCurrentAccountUin(), "key_config_ver", Integer.valueOf(0))).intValue();
  }
  
  public Set<String> a()
  {
    return new HashSet(Arrays.asList(((String)aush.a(this.a.getCurrentAccountUin(), "key_expired_banner", "")).split("\\|")));
  }
  
  public void a(int paramInt)
  {
    aush.a(this.a.getCurrentAccountUin(), "key_config_ver", Integer.valueOf(paramInt));
  }
  
  /* Error */
  public void a(aovm paramaovm, int paramInt)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 7
    ...
    //   32: aload_0
    //   33: getfield 15	aovk:a	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   53: aload_0
    //   54: getfield 15	aovk:a	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   102: aload_0
    //   103: aload 9
    //   105: invokespecial 94	aovk:a	(Ljava/io/File;)V
    //   108: aload_0
    //   109: invokespecial 164	aovk:a	()V
    ...
    //   185: aload_1
    //   186: aload 5
    //   188: invokevirtual 187	aovm:a	(Ljava/io/DataOutputStream;)V
    //   191: aload 6
    //   193: ifnull +8 -> 201
    //   196: aload 6
    ...
    //   211: aload_1
    //   212: invokevirtual 193	aovm:d	()V
    //   215: aload_0
    //   216: iload_2
    //   217: invokevirtual 195	aovk:a	(I)V
    //   220: invokestatic 200	auru:c	()V
    //   223: iconst_0
    //   224: istore_2
    ...
    //   334: aload_0
    //   335: aload 9
    //   337: invokespecial 94	aovk:a	(Ljava/io/File;)V
    //   340: aload_0
    //   341: iconst_0
    //   342: invokevirtual 195	aovk:a	(I)V
    //   345: iconst_1
    //   346: istore_2
    //   347: goto -122 -> 225
    //   350: astore 5
    ...
    //   381: aload_0
    //   382: aload 9
    //   384: invokespecial 94	aovk:a	(Ljava/io/File;)V
    //   387: aload_0
    //   388: iconst_0
    //   389: invokevirtual 195	aovk:a	(I)V
    //   392: aload 5
    //   394: athrow
    //   395: aload_1
    //   396: invokevirtual 193	aovm:d	()V
    //   399: aload_0
    //   400: iload_2
    //   401: invokevirtual 195	aovk:a	(I)V
    //   404: invokestatic 200	auru:c	()V
    //   407: goto -15 -> 392
    //   410: iconst_0
    //   411: istore 4
    //   413: goto -165 -> 248
