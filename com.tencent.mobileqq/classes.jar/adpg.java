...
public class adpg
  extends akhz
{
  public LinkedHashMap<String, List<adpf>> a;
  public int[] a;
  public String[] a;
  
  public adpg(PublicAccountListActivity paramPublicAccountListActivity)
  {
  ...
  private void b()
  {
    ...
    for (;;)
    {
      ...
      {
        adpf localadpf = (adpf)((Iterator)localObject2).next();
        if (!PublicAccountListActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityPublicAccountListActivity, localadpf))
        {
          if ((localadpf.jdField_a_of_type_JavaLangString == null) || (localadpf.jdField_a_of_type_JavaLangString.length() == 0))
          {
            localObject1 = "#";
          ...
          for (localObject1 = ((String)localObject1).toUpperCase();; localObject1 = "#")
          {
            ...
            ((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localObject1)).add(localadpf);
            break;
            localObject1 = localadpf.jdField_a_of_type_JavaLangString.substring(0, 1);
            break label89;
          }
        }
      }
  ...
  public Object getItem(int paramInt)
  {
    ...
    i = -(i + 1) - 1;
    return (adpf)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityPublicAccountListActivity.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559490, paramViewGroup, false);
      paramViewGroup = new adph();
      ...
      i = -(i + 1) - 1;
      localObject = (adpf)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
      paramViewGroup.jdField_a_of_type_Adpf = ((adpf)localObject);
      paramViewGroup.jdField_a_of_type_JavaLangString = String.valueOf(((adpf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.uin);
      paramViewGroup.jdField_a_of_type_AndroidViewView.setVisibility(0);
      paramViewGroup.f.setVisibility(8);
      paramViewGroup.d.setVisibility(0);
      paramViewGroup.d.setText(((adpf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name);
      if (((adpf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.certifiedGrade <= 0L) {
        break label650;
      }
      ...
      label379:
      paramViewGroup.e.setText(((adpf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.summary);
      ...
      if (((adpf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.extendType != 2) {
        break label796;
      }
    }
    label650:
    label796:
    for (boolean bool = ndv.a(this.jdField_a_of_type_ComTencentMobileqqActivityPublicAccountListActivity.app, ((adpf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin(), 1024);; bool = false)
    {
      if (bool)
      {
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setTag(-1, ((adpf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin());
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setTag(-2, ((adpf)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name);
      ...
      {
        return paramView;
        paramViewGroup = (adph)paramView.getTag();
        break;
        ...
        break label504;
        paramViewGroup.jdField_a_of_type_Adpf = null;
      ...
      paramViewGroup.f.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivityPublicAccountListActivity.getString(2131691954), new Object[] { ((String)localObject).toLowerCase() }));
      return paramView;
    }
  }
}
