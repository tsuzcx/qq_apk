  ...
  implements bllv
{
  ...
  protected bllx(bllq parambllq)
  {
    super(parambllq);
    this.jdField_a_of_type_Boolean = bmby.a();
    this.jdField_a_of_type_Bllv = this;
    this.a = new ajqj();
    this.jdField_a_of_type_Ajqj = ((ajqj)this.a);
  }
  
  public static bllu a(bllq parambllq)
  {
    if ((jdField_a_of_type_Bllu == null) || (jdField_a_of_type_Bllu.jdField_a_of_type_MqqUtilWeakReference.get() != parambllq)) {}
    try
    {
      if ((jdField_a_of_type_Bllu == null) || (jdField_a_of_type_Bllu.jdField_a_of_type_MqqUtilWeakReference.get() != parambllq)) {
        jdField_a_of_type_Bllu = new bllx(parambllq);
      }
      return jdField_a_of_type_Bllu;
    }
    finally {}
  }
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = paramViewGroup.jdField_a_of_type_AndroidContentResResources.getDrawable(2130847578);
    ...
    localTextView.setTextColor(paramViewGroup.jdField_a_of_type_AndroidContentResResources.getColor(2131165351));
    return paramView;
  }
  
  protected blky a()
  {
    return new blkz((bllq)this.jdField_a_of_type_MqqUtilWeakReference.get());
  }
  ...
  {
    super.a(paramIntent);
    this.jdField_a_of_type_Ajqj.jdField_a_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.IS_FINISH_RESTART_INIT_ACTIVITY", false);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoCommonBaseData.isShowQzoneAlbum)
    {
      ...
      BaseApplicationImpl.getApplication().getRuntime().registObserver(this.jdField_a_of_type_Ajqj.jdField_a_of_type_Axkw);
  ...
  public boolean a(QQAlbumInfo paramQQAlbumInfo, int paramInt, Intent paramIntent)
  {
    ...
    if (paramQQAlbumInfo._id.equals("qzone_album"))
    {
      ...
      QZoneHelper.forwardToPersonalAlbumSelect(((bllq)this.jdField_a_of_type_MqqUtilWeakReference.get()).getActivity(), localUserInfo, (Bundle)localObject, 100016);
