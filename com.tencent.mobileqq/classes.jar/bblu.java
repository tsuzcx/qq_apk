  ...
  implements bbls
{
        ...
        try
        {
          ...
          if (str2 == null)
          {
            ...
            if (paramPtt.bytes_pb_reserve.has())
            {
              ...
              ((RichMsg.PttRec)localObject1).voiceLength.set(bftf.a(l1));
              ...
              paramMessageHandler = bbli.a(-2002);
              ...
              akgt.b((String)localObject2, paramMessageHandler);
  ...
  private void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, MessageRecord paramMessageRecord, List<im_msg_body.Elem> paramList)
  {
    ...
    boolean bool = ((bfdm)paramMessageHandler.app.getManager(203)).a(((msg_comm.MsgHead)paramMsg.msg_head.get()).from_uin.get());
  ...
  private void a(MessageRecord paramMessageRecord, im_msg_body.Elem paramElem)
  {
    ...
    try
    {
      ...
      if (((generalflags.ResvAttr)localObject).uint32_holiday_flag.has())
      {
        ...
        if (i == 1) {
          paramMessageRecord.saveExtInfoToExtStr(bbkv.c, String.valueOf(i));
        }
        if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      ((MessageForPtt)paramMessageRecord).waveformArray = bfxf.a(paramElem);
      if (QLog.isColorLevel())
      {
  ...
  {
    parambbkm = (im_msg_body.Ptt)((im_msg_body.RichText)((im_msg_body.MsgBody)paramMsg.msg_body.get()).rich_text.get()).ptt.get();
    Object localObject = parambbkm.bytes_file_name.get().toStringUtf8();
    if (((String)localObject).endsWith(".amr")) {}
    for (paramList = a(paramMessageHandler, paramMsg, paramList, parambbkm, (String)localObject, "");; paramList = null)
    {
      if (paramList == null) {}
      do
      {
        ...
        {
          return;
          parambbkm = ((im_msg_body.RichText)((im_msg_body.MsgBody)paramMsg.msg_body.get()).rich_text.get()).elems.get();
        ...
        return;
        if (QLog.isColorLevel()) {
          ((StringBuilder)localObject).append("elemsSize").append(parambbkm.size()).append("\n");
        }
        a(paramMsg, paramList, parambbkm, (StringBuilder)localObject);
        a(paramMessageHandler, paramMsg, paramList, parambbkm);
        apse.a(paramMsg, paramList, paramMessageHandler.app);
      } while (!QLog.isColorLevel());
      QLog.d("GrpDisPTTDecoder", 2, ((StringBuilder)localObject).toString());
      return;
    }
