  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context arg1, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      if ((i == 100) || (i < 0))
      {
        this.a.jdField_a_of_type_Lmj = lmj.a();
        int j = this.a.jdField_a_of_type_Int;
        this.a.jdField_a_of_type_Int = lmr.a(this.a.jdField_a_of_type_Lmj);
        boolean bool;
        if ((i == 100) && (this.a.jdField_a_of_type_Int != 11))
        {
          bool = true;
          if (QLog.isColorLevel()) {
            QLog.d("QavGPDownloadManager", 2, String.format("receive notify, lastStatus[%s], progress[%s], mStatusGameplay[%s], data[%s]", new Object[] { Integer.valueOf(j), Integer.valueOf(i), Integer.valueOf(this.a.jdField_a_of_type_Int), this.a.jdField_a_of_type_Lmj }));
          }
        ...
        synchronized (this.a.jdField_a_of_type_JavaUtilArrayList)
        {
          ...
          while (???.hasNext()) {
            ((lml)???.next()).a(bool, this.a.b(), this.a.jdField_a_of_type_Int);
          }
          bool = false;
        }
      }
