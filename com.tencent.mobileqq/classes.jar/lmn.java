  ...
  implements lrc
{
  ...
  public lmn(Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_AndroidHardwareCamera$AutoFocusCallback = new lmo(this);
  }
  ...
  private void a(Camera.Parameters paramParameters, boolean paramBoolean)
  {
    ...
    lrg locallrg = lrg.a();
    if ((locallrg != null) && (locallrg.g())) {}
    for (boolean bool = true;; bool = false)
    {
      lek.c("AndroidCamera", String.format("enableAutoFocus, isUserSelfFocusDev[%s], enable[%s]", new Object[] { Boolean.valueOf(bool), Boolean.valueOf(paramBoolean) }));
      if (!bool) {
        break;
      }
  ...
  public boolean c(long paramLong)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: getstatic 183	lmn:jdField_a_of_type_Boolean	Z
    //   5: istore_3
    //   6: iload_3
    //   7: ifeq +19 -> 26
    //   10: aload_0
    //   11: getfield 119	lmn:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   14: invokevirtual 133	android/hardware/Camera:getParameters	()Landroid/hardware/Camera$Parameters;
    //   17: astore 4
    //   19: aload_0
    //   20: aload 4
    //   22: iconst_0
    //   23: invokespecial 150	lmn:a	(Landroid/hardware/Camera$Parameters;Z)V
    //   26: aload_0
    //   27: lload_1
    //   28: invokespecial 185	llz:c	(J)Z
    //   31: istore_3
    //   32: aload_0
    //   33: monitorexit
    //   34: iload_3
