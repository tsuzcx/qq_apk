...
public class avcm
{
  public static View a(Context paramContext, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    case 5: 
    case 7: 
      return LayoutInflater.from(paramContext).inflate(2131559233, paramViewGroup, false);
    }
  ...
  public static View a(Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    localImageView.setId(2131363381);
    localImageView.setScaleType(ImageView.ScaleType.FIT_XY);
    return localImageView;
  }
  
  public static avch a(Context paramContext, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    default: 
      return null;
    case 5: 
      return new avco(paramContext, localView, paramViewGroup);
    case 7: 
      return new avcn(paramContext, localView, paramViewGroup);
    }
    return new avci(paramContext, localView, paramViewGroup);
  }
}
