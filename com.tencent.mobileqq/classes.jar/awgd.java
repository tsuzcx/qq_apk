...
public class awgd
{
  ...
  public static Drawable a(Context paramContext)
  {
    ...
    return paramContext.getResources().getDrawable(2130845313);
  }
  ...
  public static void a(Context paramContext, SingleLineTextView paramSingleLineTextView, String paramString)
  {
    ...
    do
    {
      ...
      if ((!(localAppRuntime instanceof QQAppInterface)) || (!bail.b((QQAppInterface)localAppRuntime, paramString))) {
        break;
      }
  ...
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    return ((localAppRuntime instanceof QQAppInterface)) && (bail.b((QQAppInterface)localAppRuntime, paramString));
  }
}
