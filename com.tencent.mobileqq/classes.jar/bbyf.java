...
public class bbyf
  extends bbxz
{
  public bbyf(Activity paramActivity, JSONObject paramJSONObject, auuy paramauuy)
  {
    super(paramActivity, paramJSONObject, paramauuy);
    this.d = vzl.a(paramActivity, 3.0F);
  }
  ...
  protected void a(JSONObject paramJSONObject, View paramView, TextView paramTextView, ImageView paramImageView)
  {
    if ((paramView != null) && (paramTextView != null))
    {
      ...
      int i = vzl.a(this.jdField_a_of_type_AndroidAppActivity, 300.0F);
      int j = (int)paramTextView.getPaint().measureText(paramTextView.getText().toString());
      int k = vzl.a(this.jdField_a_of_type_AndroidAppActivity, 23.0F);
      int m = vzl.a(this.jdField_a_of_type_AndroidAppActivity, 40.0F);
      paramView.setBackgroundDrawable(a(str, new bbyg(Math.min(j + k, i), m)));
    }
    for (;;)
    {
