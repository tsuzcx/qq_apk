...
public class aowr
{
  ...
  private aowr(Activity paramActivity, ArkAppView paramArkAppView)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_AndroidViewView.getViewTreeObserver().addOnGlobalLayoutListener(new aows(this));
    }
  ...
  {
    new aowr(paramActivity, paramArkAppView);
  }
}
