  ...
  implements ITSoLoader
{
  ...
  public bewu(InstalledEngine paramInstalledEngine)
  {
  ...
  public String getSoPath(String paramString)
  {
    ...
    {
      bewt.a().i("GameSoLoader", "[MiniEng] load so [" + paramString + "] from " + this.jdField_a_of_type_ComTencentQqminiSdkManagerInstalledEngine + ", isSoFileExits = " + bool);
      if (!bool)
      {
        ...
        if ((!TextUtils.isEmpty(localMiniAppProxy.getSoPath())) && (new File(localMiniAppProxy.getSoPath(), paramString).exists()))
        {
          ...
          bool = true;
          bewt.a().i("GameSoLoader", "[MiniEng] load so [" + paramString + "] from " + localMiniAppProxy.getSoPath() + ", isSoFileExits = " + bool);
        }
      }
      for (;;)
      {
