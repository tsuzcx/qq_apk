...
public class andi
{
  private static andi jdField_a_of_type_Andi;
  private static Object jdField_a_of_type_JavaLangObject = new Object();
  private static String jdField_a_of_type_JavaLangString;
  int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long = System.currentTimeMillis();
  private ArrayList<andj> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public static andi a(QQAppInterface paramQQAppInterface)
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if ((jdField_a_of_type_Andi == null) || (!jdField_a_of_type_Andi.a()) || (!paramQQAppInterface.getCurrentAccountUin().equals(jdField_a_of_type_JavaLangString)))
      {
        jdField_a_of_type_Andi = new andi();
        jdField_a_of_type_JavaLangString = paramQQAppInterface.getCurrentAccountUin();
        jdField_a_of_type_Andi.a(paramQQAppInterface);
      }
      paramQQAppInterface = jdField_a_of_type_Andi;
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((List)localObject1).size() > 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            paramQQAppInterface.b((aukm)localObject5);
            continue;
          }
        }
        Object localObject2;
      ...
      while (((Iterator)localObject4).hasNext())
      {
        ...
        else
        {
          ...
          do
          {
            ...
            localObject7 = (andj)((Iterator)localObject6).next();
          } while ((((andj)localObject7).b != ((QQOperationVoipTipsTaskExcuteRecord)localObject5).uinType) || (((andj)localObject7).jdField_a_of_type_Int != ((QQOperationVoipTipsTaskExcuteRecord)localObject5).tipType));
        }
      }
      for (int i = 1;; i = 0)
      {
        if (i == 0)
        {
          localObject6 = new andj();
          ((andj)localObject6).b = ((QQOperationVoipTipsTaskExcuteRecord)localObject5).uinType;
          ((andj)localObject6).jdField_a_of_type_Int = ((QQOperationVoipTipsTaskExcuteRecord)localObject5).tipType;
  ...
  {
    if (jdField_a_of_type_Andi == null) {
      return;
    }
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      jdField_a_of_type_Andi.a();
      jdField_a_of_type_Andi = null;
      return;
    }
  }
  ...
  public int a(String paramString, int paramInt, QQOperationViopTipTask paramQQOperationViopTipTask, QQAppInterface paramQQAppInterface, List<ChatMessage> paramList)
  {
    ...
    if (k >= 0)
    {
      ...
      {
        if ((!akpy.o(paramString.msgtype)) || (paramString.extraflag != 0)) {
          break label221;
        }
  ...
  public andk a(String paramString, int paramInt1, QQAppInterface paramQQAppInterface, List<ChatMessage> paramList, boolean paramBoolean, int paramInt2)
  {
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (paramBoolean)
        {
          ...
          paramList = (andl)paramQQAppInterface.next();
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localObject1 == null)
        {
          ...
          localObject1 = (andj)paramQQAppInterface.next();
          if ((((andj)localObject1).b != paramQQOperationVoipTipsTaskExcuteRecord.uinType) || (((andj)localObject1).jdField_a_of_type_Int != paramQQOperationVoipTipsTaskExcuteRecord.tipType)) {
            continue;
          }
          if (i == 0)
          {
            paramQQAppInterface = new andj();
          ...
          localaukn.b(paramQQOperationVoipTipsTaskExcuteRecord);
          localaukn.a();
          return;
        }
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, ArrayList<QQOperationViopTipTask> paramArrayList)
  {
    ...
    //   43: return
    //   44: aload_1
    //   45: invokevirtual 149	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lauko;
    //   48: invokevirtual 155	auko:createEntityManager	()Laukn;
    //   51: astore_3
    //   52: aload_3
    //   53: invokevirtual 468	aukn:a	()Laukp;
    //   56: astore_1
    //   57: aload_1
    //   58: invokevirtual 471	aukp:a	()V
    //   61: aload_3
    //   62: ldc 157
    //   64: invokevirtual 474	aukn:a	(Ljava/lang/Class;)Z
    //   67: pop
    //   68: aload_2
    ...
    //   95: invokevirtual 247	aukn:b	(Laukm;)V
    //   98: goto -24 -> 74
    //   101: astore_2
    //   102: aload_2
    //   103: invokevirtual 226	java/lang/Exception:printStackTrace	()V
    //   106: aload_1
    //   107: invokevirtual 476	aukp:b	()V
    //   110: aload_3
    //   111: invokevirtual 228	aukn:a	()V
    //   114: aload_0
    //   115: invokevirtual 312	andi:a	()V
    //   118: return
    ...
    //   154: aload_1
    //   155: invokevirtual 480	aukp:c	()V
    //   158: aload_1
    //   159: invokevirtual 476	aukp:b	()V
    //   162: goto -52 -> 110
    //   165: astore_2
    //   166: aload_1
    //   167: invokevirtual 476	aukp:b	()V
    //   170: aload_2
    //   171: athrow
  ...
  public void a(String paramString, int paramInt, ArrayList<andl> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ((ajuf)paramQQAppInterface.a(4)).a(paramString, paramInt, paramArrayList, false);
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((paramInt1 == localandj.b) && (paramInt2 == localandj.jdField_a_of_type_Int)) {
        return true;
      }
    }
    return false;
  ...
  public boolean a(String paramString, int paramInt1, int paramInt2, QQAppInterface paramQQAppInterface, List<ChatMessage> paramList, ArrayList<andl> paramArrayList, boolean paramBoolean, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      if ((TextUtils.isEmpty(((QQOperationViopTipTask)localObject3).keywordString)) && (((QQOperationViopTipTask)localObject3).frequencyTime == 0))
      {
        ...
        {
          if (paramQQAppInterface.hasNext()) {
            if (((andl)paramQQAppInterface.next()).jdField_a_of_type_Int == ((QQOperationViopTipTask)localObject3).taskid)
            {
              paramInt1 = 1;
              label632:
              if (paramInt1 == 0)
              {
                paramQQAppInterface = new andl();
        ...
        for (;;)
        {
          ...
          if ((TextUtils.isEmpty(localQQOperationViopTipTask.keywordString)) && (localQQOperationViopTipTask.frequencyTime == 0))
          {
            ...
            while (((Iterator)localObject2).hasNext()) {
              if (((andl)((Iterator)localObject2).next()).jdField_a_of_type_Int == localQQOperationViopTipTask.taskid)
              {
                paramInt2 = 1;
                label1325:
                if (paramInt2 == 0)
                {
                  localObject2 = new andl();
                  ((andl)localObject2).jdField_a_of_type_Int = localQQOperationViopTipTask.taskid;
                  ((andl)localObject2).b = i;
                  ((andl)localObject2).jdField_a_of_type_JavaUtilArrayList = ((ArrayList)localObject1);
