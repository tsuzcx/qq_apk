  ...
  implements Manager
{
  ...
  public akco(QQAppInterface paramQQAppInterface)
  {
  ...
  private void d()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("MobileUnityManager", 2, "tryShowBannerInner ve" + this.jdField_a_of_type_Akcp);
    }
    if (((akcp)localObject).c > 0L)
    {
      ((akcp)localObject).c -= 1L;
      a((akcp)localObject);
    }
    label68:
    akcn localakcn;
    ...
    do
    {
      ...
      {
        return;
        if ((localObject != null) && (((akcp)localObject).jdField_a_of_type_Int != -1))
        {
          localakcn = a();
          if (QLog.isColorLevel()) {
            QLog.d("MobileUnityManager", 2, "tryShowBannerInner bd " + localakcn);
          }
          if ((localakcn == null) || (localakcn.e <= 0) || (localakcn.jdField_a_of_type_Int <= 0) || (!localakcn.jdField_a_of_type_Boolean) || (((akcp)localObject).jdField_b_of_type_Long <= 0L)) {
            break;
          }
          int j = 0;
          long l1 = ((akcp)localObject).jdField_a_of_type_Long;
          long l2 = (localakcn.jdField_b_of_type_Int + 1) * 24 * 60 * 60 * 1000;
          long l3 = System.currentTimeMillis();
          int i;
          if (l3 - l1 > l2)
          {
            ((akcp)localObject).jdField_a_of_type_Long = l3;
            ((akcp)localObject).jdField_b_of_type_Long -= 1L;
            ((akcp)localObject).jdField_b_of_type_Int = (localakcn.jdField_a_of_type_Int - 1);
            a((akcp)localObject);
            i = 1;
          }
          for (;;)
          {
            ...
            {
              i = j;
              if (((akcp)localObject).jdField_b_of_type_Int > 0)
              {
                ((akcp)localObject).jdField_b_of_type_Long -= 1L;
                ((akcp)localObject).jdField_b_of_type_Int -= 1;
                a((akcp)localObject);
                i = 1;
              }
            }
  ...
  public akcn a()
  {
    if (this.jdField_a_of_type_Akcn != null) {
      return this.jdField_a_of_type_Akcn;
    }
    Object localObject = a();
    if (TextUtils.isEmpty((CharSequence)localObject))
    {
      this.jdField_a_of_type_Akcn = null;
      return null;
    }
    ...
    try
    {
      if (((File)localObject).exists()) {
        this.jdField_a_of_type_Akcn = akcn.a(bbdx.a((File)localObject));
      }
      localObject = this.jdField_a_of_type_Akcn;
      return localObject;
    }
  ...
  public akcp a()
  {
    if (this.jdField_a_of_type_Akcp != null) {
      return this.jdField_a_of_type_Akcp;
    }
    akcp localakcp = akcp.a(a().getString("mobileunityversion", ""));
    this.jdField_a_of_type_Akcp = localakcp;
    return localakcp;
  }
  ...
  {
    akgd localakgd = (akgd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(34);
    if (localakgd != null) {
      localakgd.a(paramInt1, paramInt2, paramString1, paramString2);
    }
  }
  
  public void a(int paramInt, String paramString, akcn paramakcn)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      } while (paramakcn == null);
      bbdx.a(str);
      bbdx.a(str, paramString);
      this.jdField_a_of_type_Akcn = paramakcn;
      if (QLog.isColorLevel()) {
        QLog.d("MobileUnityManager", 2, "saveBannerConfig date = " + this.jdField_a_of_type_Akcn);
      }
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005B71 ", "0X8005B71 ", 0, 0, "", "", "", "");
      paramString = a();
    } while (paramString == null);
    paramString.jdField_a_of_type_Long = 0L;
    paramString.jdField_a_of_type_Int = paramInt;
    paramString.jdField_b_of_type_Long = paramakcn.c;
    paramString.jdField_b_of_type_Int = paramakcn.jdField_a_of_type_Int;
    paramString.c = paramakcn.e;
    a(paramString);
    b();
  }
  
  public void a(akcp paramakcp)
  {
    if (paramakcp == null)
    {
      this.jdField_a_of_type_Akcp = null;
      a().edit().remove("mobileunityversion").commit();
      return;
    }
    this.jdField_a_of_type_Akcp = paramakcp;
    a().edit().putString("mobileunityversion", paramakcp.a()).commit();
  }
