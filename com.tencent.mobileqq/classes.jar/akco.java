...
public class akco
{
  ...
  public static ResourceInfo a(String paramString, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    String str = akbl.a(paramString, paramInt2);
  ...
  public static List<akcp> a(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (str.startsWith("url_last_use_time")) {
          localArrayList.add(new akcp(str.substring("url_last_use_time".length(), str.length()), ((Long)localEntry.getValue()).longValue(), paramInt));
        }
      }
    }
  ...
  public static void a(int paramInt, PreloadConfig paramPreloadConfig)
  {
    ...
    return;
    Object localObject = akbl.a(paramInt);
    ...
    if (l3 > 209715200L)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        akcp localakcp = (akcp)((Iterator)localObject).next();
        if ((localakcp != null) && (!TextUtils.isEmpty(localakcp.jdField_a_of_type_JavaLangString)) && (l1 - localakcp.jdField_a_of_type_Long > 2592000000L) && (!paramPreloadConfig.isUrlInConfig(localakcp.jdField_a_of_type_JavaLangString)))
        {
          ResourceInfo localResourceInfo = a(localakcp.jdField_a_of_type_JavaLangString, false, 0, localakcp.jdField_a_of_type_Int);
          if (localResourceInfo != null)
          {
            b(localakcp.jdField_a_of_type_JavaLangString, localakcp.jdField_a_of_type_Int);
            akgd.a(localResourceInfo.filePath);
            akgd.a(localResourceInfo.folderPath);
            akcn.a(localakcp.jdField_a_of_type_JavaLangString, 8, localakcp.jdField_a_of_type_Int);
          }
        }
      }
    }
