  ...
  public void a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_ArrayOfByte = this.jdField_a_of_type_Argw.jdField_b_of_type_ArrayOfByte;
      ...
      catch (Exception localException)
      {
        ...
        try
        {
          ...
          if (this.jdField_a_of_type_Argz != null) {
            this.jdField_a_of_type_Argz.a(arrayOfInt, this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
          }
      ...
      this.jdField_d_of_type_ArrayOfByte = this.jdField_a_of_type_Argw.jdField_a_of_type_ArrayOfByte;
