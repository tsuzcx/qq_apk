...
{
  sgs(akdo paramakdo, String paramString, boolean paramBoolean, Context paramContext, Object paramObject, QQAppInterface paramQQAppInterface) {}
      ...
      do
      {
        do
        {
          ...
          for (;;)
          {
            ...
            sgj.a(this.jdField_a_of_type_AndroidContentContext, 2131695568);
            return;
            paramBundle = (akdi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56);
            ...
            sdf.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBundle.a());
            sbc.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
            paramBundle = (nqq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88);
            if (paramBundle != null) {
