...
public class beza
{
  ...
  private static String jdField_b_of_type_JavaLangString = bfhk.b();
  ...
  public static void a()
  {
    if (!jdField_a_of_type_Boolean)
    {
      ...
      jdField_a_of_type_JavaLangString = beqy.a().a().appId;
      jdField_c_of_type_JavaLangString = a();
      bejn.a().postDelayed(jdField_a_of_type_JavaLangRunnable, 1000L);
    }
  }
  ...
  public static void a(float paramFloat1, float paramFloat2)
  {
    ...
    for (;;)
    {
      ...
      for (str2 = "dc04902";; str2 = "dc05389")
      {
        ...
        betc.a("MiniProgramLpReportDC04", "reportGameEnd " + str1);
