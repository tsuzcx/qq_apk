...
public class bflv
{
  ...
  private bfmg jdField_a_of_type_Bfmg = new bflx(this);
  private INetInfoHandler jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new bflw(this);
  private String jdField_a_of_type_JavaLangString = "#FDFDFD";
  private ArrayList<bfmf> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private ArrayList<bfmf> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public bflv(Activity paramActivity)
  {
  ...
  private String a(String paramString)
  {
    ...
    for (paramString = "&";; paramString = "?")
    {
      ...
      if (!((String)localObject).contains("&ChannelID=")) {
        paramString = (String)localObject + "&ChannelID=" + bfnm.a();
      }
      localObject = paramString;
      if (QRDebugEnvUrlUtils.isDebugEnv()) {
        localObject = QRDebugEnvUrlUtils.getTestUrl(paramString);
      }
      bfne.d("ReaderTabConfigDataHelper", " url=" + (String)localObject);
      return localObject;
    }
  }
  ...
  private void a(ArrayList<bfmf> paramArrayList)
  {
    ...
    while (i < j)
    {
      ...
      this.jdField_c_of_type_ArrayOfJavaLangString[i] = localbfmf.jdField_c_of_type_JavaLangString;
      int k = localbfmf.jdField_a_of_type_Int;
  ...
  private boolean a(ArrayList<bfmf> paramArrayList1, ArrayList<bfmf> paramArrayList2)
  {
    ...
    if (paramArrayList1.size() == paramArrayList2.size())
    {
      ...
      while (i < j)
      {
        if (!((bfmf)paramArrayList1.get(i)).equals(paramArrayList2.get(i))) {
          return false;
        }
        i += 1;
      }
  ...
  private boolean a(JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localObject1 = new bfmf(((JSONObject)localObject1).optInt("tabID", -1), ((JSONObject)localObject1).optString("tabName"), ((JSONObject)localObject1).optString("n_tabIcon"), ((JSONObject)localObject1).optString("h_tabIcon"), localArrayList, k);
      if (k != 0) {
        break label395;
      }
    ...
    {
      bfnc.c(paramJSONObject, paramBoolean);
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      return;
      bfne.c("ReaderTabConfigDataHelper", "tab url from local");
      a(4);
      this.jdField_a_of_type_JavaUtilArrayList.clear();
      bfmf localbfmf = new bfmf();
      localbfmf.jdField_a_of_type_Int = 100;
      localbfmf.jdField_a_of_type_JavaLangString = "书城";
      localbfmf.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_ELPT79nUxC.png";
      localbfmf.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_AXwBTwpLm8.png";
      ...
      localbfmf.jdField_a_of_type_JavaUtilArrayList = localArrayList;
      this.jdField_a_of_type_JavaUtilArrayList.add(localbfmf);
      localbfmf = new bfmf();
      localbfmf.jdField_a_of_type_Int = 101;
      localbfmf.jdField_a_of_type_JavaLangString = "分类";
      localbfmf.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_u3wddLskp6.png";
      localbfmf.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_xYKQeprMCg.png";
      localArrayList = new ArrayList(1);
      localArrayList.add(a("https://cdn.vip.qq.com/club/client/read/6/rel/category_index.html?configfrom=local&_bid=2036"));
      localbfmf.jdField_a_of_type_JavaUtilArrayList = localArrayList;
      this.jdField_a_of_type_JavaUtilArrayList.add(localbfmf);
      localbfmf = new bfmf();
      localbfmf.jdField_a_of_type_Int = 102;
      localbfmf.jdField_a_of_type_JavaLangString = "书架";
      localbfmf.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_G6VUELHdgC.png";
      localbfmf.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_f9xtLKYkBV.png";
      localArrayList = new ArrayList(2);
      ...
      this.jdField_a_of_type_JavaUtilArrayList.add(localbfmf);
      localbfmf = new bfmf();
      localbfmf.jdField_a_of_type_Int = 104;
      localbfmf.jdField_a_of_type_JavaLangString = "我的";
      localbfmf.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190604150617_XAeQPgB9Z8.png";
      localbfmf.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_wdBlMCyKuS.png";
      localArrayList = new ArrayList(1);
  ...
  private void f()
  {
    ...
    {
      bfne.a("ReaderTabConfigDataHelper", "getTabConfigDataFromDB," + localJSONException.getMessage());
    }
  }
  ...
  public String d()
  {
    ...
    return "&height=" + (azvv.b(this.jdField_a_of_type_AndroidContentContext, i) + 50);
  }
}
