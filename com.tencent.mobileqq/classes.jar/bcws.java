...
{
  public long a;
  private bcwu jdField_a_of_type_Bcwu;
  ...
  public bcws(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bcxa = new bcxa(paramQQAppInterface);
  }
  ...
  private void a(ChatMessage paramChatMessage, String paramString1, String paramString2, String paramString3, aqld paramaqld)
  {
    if ((!this.jdField_a_of_type_Bcxa.a()) && (QLog.isColorLevel()))
    {
    ...
    this.jdField_a_of_type_Bcxa.a(paramChatMessage);
    new Handler(ThreadManager.getSubThreadLooper()).postDelayed(new AIOMessageSpreadManager.2(this, paramChatMessage, paramString1, paramaqld, paramString2, paramString3), 1000L);
  }
  ...
  {
    boolean bool2 = false;
    int i = this.jdField_a_of_type_Bcxa.a();
    int j = aqle.a().a();
    boolean bool1;
    if (j == 0)
    {
  ...
  {
    this.jdField_a_of_type_Bcxa.a(paramaqlb);
  }
    ...
    do
    {
      ...
      catch (Exception localException1)
      {
        ...
        if (((String)localObject3).equalsIgnoreCase("keyword")) {
          bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009078", "0X8009078", 0, 0, "", "", "", "");
        }
        while ((localException1 instanceof MessageForFile))
        {
          ...
          if (paramChatMessage == null)
          {
            ...
            if (((String)localObject3).equalsIgnoreCase("precent")) {
              bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800907B", "0X800907B", 0, 0, "", "", "", "");
            } else if (((String)localObject3).equalsIgnoreCase("text_keyword")) {
              bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009072", "0X800907B", 0, 0, "", "", "", "");
            }
          }
          else
          {
            bcua.a(paramChatMessage, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 2);
            return;
          }
        }
      }
      if ((localException1 instanceof MessageForTroopFile))
      {
        ...
        localObject2 = bfby.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
        localObject3 = new TeamWorkFileImportInfo();
        ((TeamWorkFileImportInfo)localObject3).c = ((becp)localObject2).jdField_a_of_type_JavaLangString;
        ((TeamWorkFileImportInfo)localObject3).jdField_b_of_type_JavaLangString = ((becp)localObject2).g;
        ((TeamWorkFileImportInfo)localObject3).j = aszt.a(((becp)localObject2).g);
        ...
        ((TeamWorkFileImportInfo)localObject3).jdField_d_of_type_JavaLangString = ((becp)localObject2).jdField_e_of_type_JavaLangString;
        ((TeamWorkFileImportInfo)localObject3).jdField_b_of_type_Int = ((becp)localObject2).h;
        ...
        bcua.a((TeamWorkFileImportInfo)localObject3, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((TeamWorkFileImportInfo)localObject3).jdField_d_of_type_Int);
        return;
      }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      QLog.e("AIOMessageSpreadManager", 1, aszt.a());
      return;
    }
    if (QLog.isColorLevel()) {
