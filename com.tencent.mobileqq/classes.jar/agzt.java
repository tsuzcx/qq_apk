...
public class agzt
{
  ...
  public static RecentBaseData a(RecentUser paramRecentUser, QQAppInterface paramQQAppInterface, Context paramContext, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        {
          ahca.a(paramQQAppInterface.getApp(), false, paramRecentUser);
      ...
      continue;
      if (TextUtils.equals(paramRecentUser.uin, ajed.ay))
      {
        localObject1 = localObject3;
  ...
  public static void a(List<RecentUser> paramList, QQAppInterface paramQQAppInterface, Context paramContext, List<RecentBaseData> paramList1, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        beoj.a(((RecentUser)localObject2).uin);
        String str = ahay.a(((RecentUser)localObject2).uin, ((RecentUser)localObject2).getType());
        Object localObject1 = ahay.a().a(str);
        if (localObject1 == null)
        {
        ...
        else
        {
          ...
          {
            ahca.a(paramContext, false, paramList);
