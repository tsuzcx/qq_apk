  ...
  implements amvh, ARNativeBridge.ActionCallback
{
  ...
  private amwb jdField_a_of_type_Amwb;
  ...
  public amwa(amvj paramamvj, amwb paramamwb, GLSurfaceView paramGLSurfaceView)
  {
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Amvj = paramamvj;
    this.jdField_a_of_type_Amwb = paramamwb;
    ...
    this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge = ((ARNativeBridge)this.jdField_a_of_type_Amvj.a(0));
  }
  ...
  public void a(int paramInt)
  {
    ...
    case 2: 
      ...
      this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge.nativeCreateEngineBusiness(this.b, this.jdField_a_of_type_Amwb.b, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getAssets(), this.jdField_a_of_type_Amwb.c, this.d, this.e, 100);
    ...
    case 7: 
      ...
      return;
    case 9: 
      this.jdField_a_of_type_Amvj.a(new Interactive3DRenderable.1(this));
      return;
    case 8: 
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge.nativeOnDrawFrame(this.b, paramamvp.a, (float[])paramamvp.a("CAMERA_POSITION"));
  }
  ...
  public int b()
  {
    return this.jdField_a_of_type_Amwb.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo.d;
  }
  ...
  public String c()
  {
    return this.jdField_a_of_type_Amwb.jdField_a_of_type_JavaLangString;
  }
  ...
  public void callback(int paramInt1, String paramString1, int paramInt2, String paramString2)
  {
    ...
    do
    {
      ...
      case 57: 
      default: 
        this.jdField_a_of_type_Amvj.a(this, this.jdField_a_of_type_Amwb.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo, paramInt1, 0, paramString2);
        return;
      }
  ...
  public void d()
  {
    ...
    {
      String str = this.jdField_a_of_type_Amwb.c;
      ...
      this.jdField_a_of_type_Amsu = new amsu(1, this.jdField_a_of_type_ArrayOfJavaLangString);
      a(2);
      this.g = 0;
      this.f = 0;
    }
    if (this.jdField_a_of_type_Amvj != null) {
      this.jdField_a_of_type_Amvj.a(this, this.jdField_a_of_type_Amwb.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo, 100, 0, null);
    }
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Int == 9)
    {
      ...
      if (this.jdField_a_of_type_Amvj != null)
      {
        this.jdField_a_of_type_Amvj.a(this.jdField_a_of_type_Amwb.jdField_a_of_type_JavaLangString);
        QLog.d("AREngine_Interactive3DRenderable", 2, "onDestroy, remove hsRender here, " + this);
        this.jdField_a_of_type_Amvj.a(this, this.jdField_a_of_type_Amwb.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo, 101, 0, null);
      }
      if (this.jdField_a_of_type_Int == 9) {
        a(10);
      }
    ...
    if (this.g > 0)
    {
      ...
      azri.a(BaseApplicationImpl.getContext()).a(BaseActivity.sTopActivity.getCurrentAccountUin(), "binhai_fps", true, 0L, 0L, localHashMap, "", false);
    }
  }
}
