  ...
  implements INetEngine.INetEngineListener
{
  ...
  private List<azoc> jdField_a_of_type_JavaUtilList = new Vector();
  private Map<String, HttpNetReq> jdField_a_of_type_JavaUtilMap = Collections.synchronizedMap(new HashMap());
  private ConcurrentHashMap<String, azoi> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  public boolean a;
  
  static
  {
    jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$IBreakDownFix = new azog();
  }
  
  public azof(QQAppInterface paramQQAppInterface, azod paramazod)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Azod = paramazod;
  ...
  private boolean a(PrecoverResource paramPrecoverResource)
  {
    ...
    for (;;)
    {
      ...
      else if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramPrecoverResource.md5))
      {
        ...
        try
        {
          boolean bool = azoj.a(paramPrecoverResource.businessId, paramPrecoverResource.md5);
  ...
  {
    return (this.jdField_a_of_type_Azod != null) && (this.jdField_a_of_type_Azod.a(paramPrecoverResource));
  }
  
  public azoi a(String paramString)
  {
    return (azoi)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
  }
  
  public void a(azoc paramazoc)
  {
    if (paramazoc == null) {}
    while (this.jdField_a_of_type_JavaUtilList.contains(paramazoc)) {
      return;
    }
    this.jdField_a_of_type_JavaUtilList.add(paramazoc);
  }
  
  public void a(azoh paramazoh)
  {
    if (QLog.isColorLevel()) {
      QLog.d("PrecoverResDownloader", 2, "sendReqToNetEngine, task=" + paramazoh + ", mNetEngine=" + this.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine);
    }
    if ((paramazoh == null) || (paramazoh.a == null)) {
      return;
    }
    ...
    this.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine.sendReq(paramazoh.a);
  }
  ...
  public boolean a(PrecoverResource paramPrecoverResource, Object paramObject, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramPrecoverResource.md5, new azoi());
    ...
    for (((HttpNetReq)localObject1).mOutPath = paramPrecoverResource.thirdPartDownloadPath;; ((HttpNetReq)localObject1).mOutPath = azoj.a(paramPrecoverResource.businessId, paramPrecoverResource.md5))
    {
    ...
    int i;
    switch (this.jdField_a_of_type_Azod.a())
    {
    default: 
      i = 1;
    }
    for (;;)
    {
      paramObject = new azoh(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramPrecoverResource, (HttpNetReq)localObject1);
  ...
  public void b(azoc paramazoc)
  {
    if (paramazoc == null) {
      return;
    }
    this.jdField_a_of_type_JavaUtilList.remove(paramazoc);
  }
  ...
  public void onResp(NetResp paramNetResp)
  {
    ...
    if (paramNetResp.mResult == 0)
    {
      ...
      localObject3 = aznv.a(((File)localObject4).getAbsolutePath());
    ...
    for (;;)
    {
      ...
      if (i != 0)
      {
        ...
        if (!bool)
        {
          ...
          {
            this.jdField_a_of_type_Azod.a((PrecoverResource)localObject1);
            m = i;
            j = k;
          }
        }
      ...
      for (long l2 = l1;; l2 = -1L)
      {
        ...
        {
          localObject3 = (azoc)this.jdField_a_of_type_JavaUtilList.get(k);
          if (localObject3 != null) {
            ((azoc)localObject3).a(i, str1, (PrecoverResource)localObject1, localObject2);
          }
          k += 1;
        }
        i = 0;
      ...
      {
        ((azoe)localObject2).a((PrecoverResource)localObject1, i, str1, paramNetResp, l1);
        return;
        localObject2 = ((PrecoverResource)localObject1).md5;
        break;
        localObject2 = this.jdField_a_of_type_Azod.a();
        break label745;
      }
      label832:
  ...
  public void onUpdateProgeress(NetReq paramNetReq, long paramLong1, long paramLong2)
  {
    ...
    for (;;)
    {
      ...
      azoi localazoi = (azoi)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramNetReq.md5);
      Object localObject2 = localazoi;
      if (localazoi == null) {
        localObject2 = new azoi();
      }
      ((azoi)localObject2).a = paramLong2;
      ((azoi)localObject2).b = paramLong1;
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramNetReq.md5, localObject2);
      int i = 0;
      while (i < this.jdField_a_of_type_JavaUtilList.size())
      {
        localObject2 = (azoc)this.jdField_a_of_type_JavaUtilList.get(i);
        if (localObject2 != null) {
          ((azoc)localObject2).a(paramNetReq, localObject1, paramLong1, paramLong2);
        }
        i += 1;
      }
      break;
