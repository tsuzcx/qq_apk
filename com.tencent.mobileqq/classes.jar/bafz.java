...
public class bafz
{
  ...
  private bagd jdField_a_of_type_Bagd;
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((paramBoolean) && (this.jdField_a_of_type_Bagd != null)) {
          this.jdField_a_of_type_Bagd.a();
        }
        return;
        if (QLog.isColorLevel()) {
  ...
  public void a(MediaFormat paramMediaFormat)
  {
    ...
    if (this.jdField_a_of_type_Bagd != null) {
      this.jdField_a_of_type_Bagd.a(this.jdField_a_of_type_AndroidMediaMediaFormat);
    }
    return;
    label114:
    this.jdField_a_of_type_Bagq.a(0, paramMediaFormat);
  }
  
  public void a(bafx parambafx)
  {
    this.jdField_a_of_type_JavaLangString = parambafx.jdField_a_of_type_JavaLangString;
    Object localObject = MediaFormat.createVideoFormat("video/avc", parambafx.jdField_a_of_type_Int, parambafx.jdField_b_of_type_Int);
    ((MediaFormat)localObject).setInteger("color-format", 2130708361);
    ((MediaFormat)localObject).setInteger("bitrate", parambafx.c);
    ((MediaFormat)localObject).setInteger("frame-rate", parambafx.d);
    ((MediaFormat)localObject).setInteger("i-frame-interval", parambafx.e);
    if (parambafx.j != -1) {
      ((MediaFormat)localObject).setInteger("bitrate-mode", parambafx.j);
    }
    if (parambafx.k != -1)
    {
    ...
    if (parambafx.jdField_b_of_type_Boolean)
    {
      ((MediaFormat)localObject).setInteger("profile", 1);
      ((MediaFormat)localObject).setInteger("level", 512);
    }
    if (QLog.isColorLevel()) {
      QLog.d("HWVideoEncoder", 2, "start : encodeConfig = + " + parambafx.toString() + " ; format: " + localObject);
    }
    ...
    localObject = new File(parambafx.jdField_a_of_type_JavaLangString);
    if (!((File)localObject).exists()) {
      FileUtils.createFileIfNotExits(((File)localObject).getAbsolutePath());
    }
    if (parambafx.jdField_a_of_type_Bagq == null)
    {
      this.jdField_a_of_type_AndroidMediaMediaMuxer = new MediaMuxer(parambafx.jdField_a_of_type_JavaLangString, 0);
      this.jdField_a_of_type_AndroidMediaMediaMuxer.setOrientationHint(parambafx.g);
    }
    for (;;)
    {
      if (parambafx.jdField_a_of_type_Bagd != null) {
        this.jdField_a_of_type_Bagd = parambafx.jdField_a_of_type_Bagd;
      }
      this.jdField_a_of_type_Int = -1;
      this.jdField_a_of_type_Boolean = false;
      return;
      this.jdField_a_of_type_Bagq = parambafx.jdField_a_of_type_Bagq;
      this.jdField_a_of_type_Bagq.jdField_a_of_type_AndroidMediaMediaMuxer.setOrientationHint(parambafx.g);
    }
  }
  ...
  public void a(ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    if (this.jdField_a_of_type_Bagq == null)
    {
      ...
      if (this.jdField_a_of_type_Bagd != null)
      {
        ...
        this.jdField_a_of_type_Bagd.a(paramBufferInfo);
    ...
    this.jdField_a_of_type_Bagq.a(0, paramByteBuffer, paramBufferInfo);
  }
    ...
    catch (Exception localException1)
    {
      try
      {
        for (;;)
        {
          ...
          if ((this.jdField_a_of_type_Bagq != null) || (this.jdField_a_of_type_AndroidMediaMediaMuxer == null)) {
            break label237;
          }
          try
          {
      ...
      catch (Exception localException2)
      {
        ...
        } while (this.jdField_a_of_type_Bagq == null);
