...
public class afmb
  implements bkhw
{
  public afmb(TroopMemberListActivity paramTroopMemberListActivity) {}
        ...
        if (QLog.isColorLevel())
        {
          ...
          if (this.a.jdField_d_of_type_Int == 9) {
            ...
            case 0: 
              ...
              bcst.b(this.a.app, "P_CliOper", "Grp_pay", "", "un_pay_list", "Clk_del", 0, 0, this.a.jdField_b_of_type_JavaLangString, this.a.n, "", "");
              break;
            }
          } else {
            switch (i)
            ...
            case 1: 
              if (!TextUtils.isEmpty(this.a.jdField_a_of_type_JavaLangString))
              {
                ...
                bcst.b(this.a.app, "dc00899", "Grp_mber", "", "mber_list", "clk_Add", 0, 0, this.a.jdField_b_of_type_JavaLangString, "", "", "");
              }
              break;
            case 2: 
            ...
            case 3: 
              ...
              this.a.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.a.findViewById(2131368949));
              this.a.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
              this.a.jdField_d_of_type_AndroidWidgetTextView.setText(anni.a(2131714289));
              this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new afmc(this));
              if (this.a.jdField_a_of_type_Afnc != null) {
                this.a.jdField_a_of_type_Afnc.a();
              }
              paramView = this.a.n;
