...
public class bjds
{
  ...
  private bjdu jdField_a_of_type_Bjdu;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajed.aU + "pddata/prd/dov_capture_qsvf" + File.separator;
  ...
  public void a()
  {
    this.jdField_a_of_type_Bjdu = null;
  }
  ...
  public void a(bjdu parambjdu)
  {
    this.jdField_a_of_type_Bjdu = parambjdu;
  }
  
  public void a(bjdx parambjdx)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Bjdx = parambjdx;
      ...
      parambjdx = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
      while (parambjdx.hasNext())
      {
        Object localObject1 = (FilterCategory)parambjdx.next();
              ...
              if (localFilterDesc.predownload == 1)
              {
                ...
                if (!TextUtils.isEmpty(localFilterDesc.iconurl))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((axro)localObject3).jdField_a_of_type_Axrt = new bjdw(this);
                ...
                if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject2)))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((axro)localObject2).jdField_a_of_type_Axrt = new bjdv(this);
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Bjdx == null));
    this.jdField_a_of_type_Bjdx.a(false);
  }
