...
public class bjds
{
  ...
  public static JSONObject a(Context paramContext, long paramLong, String paramString)
  {
    int i = 0;
    JSONObject localJSONObject = new JSONObject();
    ...
    {
      QLog.e("MiniAdAntiSpamReportUtil", 1, "currentRuntimeLoader == null");
      return localJSONObject;
    }
    String str2 = paramContext.getJsVersion();
    Object localObject = paramContext.getGameEngine();
    if (localObject == null)
    {
      localObject = null;
      GameInfoManager localGameInfoManager = paramContext.getGameInfoManager();
      paramContext = "";
      if (localGameInfoManager != null)
      {
        int j = localGameInfoManager.getScene();
        String str1 = localGameInfoManager.getFromMiniAppId();
        paramContext = str1;
        i = j;
        if (TextUtils.isEmpty(str1))
        {
          paramContext = localGameInfoManager.getGroupIdFromReportData();
          i = j;
        }
      }
    }
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("lc", localObject);
        ...
        paramContext = "";
        localJSONObject.put("sc_sn", paramContext);
        localJSONObject.put("st", jdField_a_of_type_Long);
        localJSONObject.put("ud", b());
      ...
      return localJSONObject;
      localObject = ((TritonEngine)localObject).getStatisticsManager().getLastClicks();
      break;
    }
  }
