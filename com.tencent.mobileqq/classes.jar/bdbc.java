...
public class bdbc
{
  ...
  protected ColorStateList a(Context paramContext, int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 104	bdbc:c	()Z
    //   4: ifeq +13 -> 17
    //   7: aload_0
    //   8: getfield 18	bdbc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   36: aload_0
    //   37: getfield 18	bdbc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   50: invokespecial 138	bdbc:a	(Ljava/lang/String;)Ljava/lang/Object;
    //   53: astore_3
    //   54: aload_3
    //   55: ifnull +15 -> 70
    //   58: aload_3
    ...
    //   69: areturn
    //   70: aload_0
    //   71: invokespecial 142	bdbc:a	()Landroid/util/TypedValue;
    //   74: astore_3
    //   75: aload_1
    ...
    //   94: aload_0
    //   95: aload_3
    //   96: invokespecial 154	bdbc:a	(Landroid/util/TypedValue;)V
    //   99: aload 4
    //   101: ifnull +192 -> 293
    ...
    //   111: aload_0
    //   112: getfield 18	bdbc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   227: aload_0
    //   228: getfield 18	bdbc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   241: aload 5
    //   243: invokespecial 204	bdbc:a	(Ljava/lang/String;Landroid/content/res/ColorStateList;)V
    //   246: aload 5
    //   248: astore_1
    //   249: aload 4
    //   251: ifnull -225 -> 26
  ...
  protected Drawable a(Context paramContext, int paramInt)
  {
    ...
    //   97: aload_0
    //   98: aload 5
    //   100: invokespecial 154	bdbc:a	(Landroid/util/TypedValue;)V
    //   103: aload 6
    //   105: ifnull +197 -> 302
    ...
    //   119: aload_0
    //   120: getfield 18	bdbc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   236: aload_0
    //   237: getfield 18	bdbc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   250: aload 5
    //   252: invokespecial 248	bdbc:a	(Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
    //   255: aload 5
    //   257: astore_1
    //   258: aload 4
    //   260: ifnull -234 -> 26
  ...
  protected Drawable a(Context paramContext, int paramInt, String paramString)
  {
    ...
    //   73: areturn
    //   74: aload_0
    //   75: invokespecial 142	bdbc:a	()Landroid/util/TypedValue;
    //   78: astore 5
    //   80: aload_1
    ...
    //   101: aload_0
    //   102: aload 5
    //   104: invokespecial 154	bdbc:a	(Landroid/util/TypedValue;)V
    //   107: aload 6
    //   109: ifnull +187 -> 296
    ...
    //   123: aload_0
    //   124: getfield 18	bdbc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   230: aload_0
    //   231: getfield 18	bdbc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   244: aload 5
    //   246: invokespecial 248	bdbc:a	(Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
    //   249: aload 5
    //   251: astore_1
    //   252: aload 4
    //   254: ifnull -228 -> 26
  ...
  protected Drawable b(Context paramContext, int paramInt)
  {
    ...
    if (localObject2 != null)
    {
      ...
      if (new File((String)localObject1).exists())
      {
        ...
        bfpx.a((String)localObject1, (BitmapFactory.Options)localObject2, localbfpy);
        if (localbfpy.jdField_a_of_type_Int == 0)
        {
          paramContext = new aqwv(paramContext.getResources(), localbfpy.jdField_a_of_type_AndroidGraphicsBitmap);
          a(this.jdField_a_of_type_JavaLangString + paramInt, paramContext);
          return paramContext;
        }
        QLog.e("SkinDrawable", 1, (String)localObject1 + " decodeFail: " + localbfpy.jdField_a_of_type_Int);
      }
    }
    return paramContext.getResources().getDrawable(paramInt);
  }
