...
public final class apgs
{
  ...
  {
    zom.a(BaseApplicationImpl.getContext(), paramFile);
  }
  ...
  {
    bhsi.a(BaseApplicationImpl.getApplication().getSharedPreferences("ARRecordUtils_AR", 4).edit().putBoolean("ARVideoRecordPressKey12", paramBoolean));
  }
