  ...
  implements aysc
{
  ...
  apgu jdField_a_of_type_Apgu = null;
  apgx jdField_a_of_type_Apgx = null;
  ...
  public apgs(QQAppInterface paramQQAppInterface, apgu paramapgu, String paramString1, int paramInt, String paramString2, long paramLong, apgx paramapgx, boolean paramBoolean, String paramString3, String paramString4)
  {
    ...
    for (i = 443;; i = 80)
    {
      ...
      paramapgx = new ArrayList(1);
      paramapgx.add(paramString1);
      if ((!TextUtils.isEmpty(paramString4)) && (apvm.b(paramQQAppInterface)))
      {
        QLog.i("FileHttpUploder<FileAssistant><FileAssistant>", 1, "[Disc Download] upload support IPv6. domain[" + paramString4 + "]");
        paramapgx.add(0, paramString4 + ":" + i);
      }
      this.jdField_a_of_type_Apaq = new apaq(paramQQAppInterface, paramapgx, "/ftn_handler");
      if (this.jdField_b_of_type_Boolean) {
      ...
      this.jdField_a_of_type_Apgu = paramapgu;
  ...
  public void a(long paramLong)
  {
    ...
    localayrx.jdField_e_of_type_JavaLangString = this.jdField_d_of_type_JavaLangString;
    Object localObject = "";
    ...
    {
      localayrx.f = true;
      localayrx.g = apaq.a(this.jdField_b_of_type_JavaLangString);
      localayrx.jdField_b_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
    }
    try
    {
      ...
      localObject = this.jdField_a_of_type_Apgx.a((byte[])localObject, paramLong, this.jdField_a_of_type_Apgu);
      if (localObject != null)
      {
        localayrx.jdField_a_of_type_ArrayOfByte = ((byte[])localObject);
        this.jdField_a_of_type_Apgu.e = System.currentTimeMillis();
    ...
    catch (Exception localException)
    {
      ...
      this.jdField_a_of_type_Apgu.jdField_a_of_type_Long = 9360L;
      this.jdField_a_of_type_Apgu.jdField_c_of_type_JavaLangString = apug.a();
      this.jdField_a_of_type_Apgx.a(this.jdField_a_of_type_Apgu);
    }
  }
  ...
  byte[] a(long paramLong)
  {
    ...
    //   6: aload_0
    //   7: lconst_0
    //   8: putfield 51	apgs:jdField_b_of_type_Long	J
    //   11: aload_0
    //   12: getfield 49	apgs:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   15: ifnonnull +23 -> 38
    //   18: aload_0
    //   19: new 284	java/io/FileInputStream
    //   22: dup
    //   23: aload_0
    //   24: getfield 41	apgs:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   27: invokespecial 285	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   30: putfield 49	apgs:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   33: aload_0
    //   34: lconst_0
    //   35: putfield 73	apgs:jdField_c_of_type_Long	J
    //   38: lload_1
    //   39: lconst_0
    //   40: lcmp
    //   41: ifne +113 -> 154
    //   44: aload_0
    //   45: getfield 73	apgs:jdField_c_of_type_Long	J
    //   48: lconst_0
    //   49: lcmp
    //   50: ifeq +23 -> 73
    //   53: aload_0
    ...
    //   57: dup
    //   58: aload_0
    //   59: getfield 41	apgs:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   62: invokespecial 285	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   65: putfield 49	apgs:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   68: aload_0
    //   69: lconst_0
    //   70: putfield 73	apgs:jdField_c_of_type_Long	J
    //   73: aload_0
    //   74: lload_1
    //   75: putfield 73	apgs:jdField_c_of_type_Long	J
    //   78: aload_0
    //   79: getfield 43	apgs:jdField_a_of_type_Bgbd	Lbgbd;
    //   82: aload_0
    //   83: getfield 47	apgs:jdField_a_of_type_Long	J
    //   86: aload_0
    //   87: getfield 51	apgs:jdField_b_of_type_Long	J
    //   90: lload_1
    //   91: invokestatic 290	apgt:a	(Lbgbd;JJJ)I
    //   94: istore_3
    //   95: iload_3
    //   96: newarray byte
    //   98: astore 4
    //   100: aload_0
    //   101: getfield 49	apgs:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   104: aload 4
    //   106: iconst_0
    //   107: iload_3
    ...
    //   112: aload_0
    //   113: aload_0
    //   114: getfield 73	apgs:jdField_c_of_type_Long	J
    //   117: iload_3
    //   118: i2l
    //   119: ladd
    //   120: putfield 73	apgs:jdField_c_of_type_Long	J
    //   123: aload 4
    //   125: areturn
    //   126: astore 4
    //   128: aload_0
    //   129: aconst_null
    //   130: putfield 49	apgs:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   133: aload 4
    ...
    //   142: aload_0
    //   143: aconst_null
    //   144: putfield 49	apgs:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   147: aload 4
    ...
    //   154: lload_1
    //   155: aload_0
    //   156: getfield 73	apgs:jdField_c_of_type_Long	J
    //   159: lcmp
    //   160: ifle +29 -> 189
    //   163: aload_0
    //   164: getfield 49	apgs:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   167: lload_1
    //   168: aload_0
    //   169: getfield 73	apgs:jdField_c_of_type_Long	J
    //   172: lsub
    ...
    //   189: lload_1
    //   190: aload_0
    //   191: getfield 73	apgs:jdField_c_of_type_Long	J
    //   194: lcmp
    //   195: ifge -122 -> 73
    //   198: aload_0
    ...
    //   202: dup
    //   203: aload_0
    //   204: getfield 41	apgs:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   207: invokespecial 285	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   210: putfield 49	apgs:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   213: aload_0
    //   214: lconst_0
    //   215: putfield 73	apgs:jdField_c_of_type_Long	J
    //   218: aload_0
    //   219: getfield 49	apgs:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   222: lload_1
    ...
    //   232: aload_0
    //   233: aconst_null
    //   234: putfield 49	apgs:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   237: aload 4
  ...
  public void onResp(aysz paramaysz)
  {
    ...
    do
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.d("FileHttpUploder<FileAssistant>", 4, "logID[" + this.jdField_d_of_type_JavaLangString + "]onResp result:" + paramaysz.jdField_a_of_type_Int + " errCode:" + paramaysz.jdField_b_of_type_Int + " errDesc:" + paramaysz.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_Ayrx = null;
      this.jdField_a_of_type_Apgu.f = System.currentTimeMillis();
      ...
      if ((paramaysz.jdField_b_of_type_Int == 9364) && (this.jdField_b_of_type_Int < 3))
      {
        ...
        this.jdField_a_of_type_Bgbd.a();
        if (this.jdField_a_of_type_Apgx != null)
        {
          this.jdField_a_of_type_Apgu.jdField_a_of_type_Long = 9364L;
          this.jdField_a_of_type_Apgu.jdField_b_of_type_Int = this.jdField_b_of_type_Int;
          this.jdField_a_of_type_Apgu.f = System.currentTimeMillis();
          this.jdField_a_of_type_Apgx.a(true, this.jdField_a_of_type_Apgu);
        }
      ...
      this.jdField_a_of_type_Apgu.jdField_a_of_type_Long = paramaysz.jdField_a_of_type_Int;
      this.jdField_a_of_type_Apgu.jdField_c_of_type_JavaLangString = paramaysz.jdField_a_of_type_JavaLangString;
      this.jdField_a_of_type_Apgu.j = ((String)paramaysz.jdField_a_of_type_JavaUtilHashMap.get("param_rspHeader"));
      this.jdField_a_of_type_Apgu.g = ((String)paramaysz.jdField_a_of_type_JavaUtilHashMap.get("param_url"));
    ...
    QLog.e("FileHttpUploder<FileAssistant>", 1, "logID[" + this.jdField_d_of_type_JavaLangString + "]httpRetCode:" + i + "]onResp result:" + paramaysz.jdField_a_of_type_Int + " errCode:" + paramaysz.jdField_b_of_type_Int + " errDesc:" + paramaysz.jdField_a_of_type_JavaLangString);
    return;
    this.f = 0;
    ...
    for (long l = Long.parseLong(str);; l = 0L)
    {
      if (l != 0L)
      {
        this.jdField_a_of_type_Apgu.jdField_a_of_type_Long = -9527L;
        this.jdField_a_of_type_Apgu.jdField_c_of_type_JavaLangString = ("ResponCode[206]But UserCode[" + String.valueOf(l) + "]");
        this.jdField_a_of_type_Apgu.j = ((String)paramaysz.jdField_a_of_type_JavaUtilHashMap.get("param_rspHeader"));
        this.jdField_a_of_type_Apgx.a(this.jdField_a_of_type_Apgu);
        if (!QLog.isColorLevel()) {
          break;
      ...
      l = this.jdField_a_of_type_Apgx.a(paramaysz, this.jdField_a_of_type_Apgu);
      if (l == -1L)
      {
      ...
      {
        this.jdField_a_of_type_Apgu.jdField_a_of_type_Long = 0L;
        this.jdField_a_of_type_Apgu.f = (this.jdField_a_of_type_Apgu.e + 1L);
        this.jdField_a_of_type_Apgx.b(this.jdField_a_of_type_Apgu);
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      if (l < this.jdField_b_of_type_Long)
      {
        ...
        QLog.w("FileHttpUploder<FileAssistant>", 1, "nSessionId[" + this.jdField_d_of_type_JavaLangString + "]" + paramaysz);
        this.jdField_d_of_type_Int += 1;
        this.jdField_a_of_type_Apgu.jdField_a_of_type_Long = 9009L;
        this.jdField_a_of_type_Apgu.jdField_c_of_type_JavaLangString = paramaysz;
      ...
      this.jdField_a_of_type_Apgx.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_Long);
      a(l);
      return;
    }
  }
