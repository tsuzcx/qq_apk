...
public class apgs
  extends apgu
{
  private LinkedList<apgt> a = new LinkedList();
  private QQAppInterface b;
  private boolean d;
  
  public apgs(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(apgt paramapgt)
  {
    synchronized (this.a)
    {
      if (!this.a.contains(paramapgt)) {
        this.a.add(paramapgt);
      }
      return;
    }
  }
  ...
  public void b(apgt paramapgt)
  {
    synchronized (this.a)
    {
      this.a.remove(paramapgt);
      return;
    }
  }
