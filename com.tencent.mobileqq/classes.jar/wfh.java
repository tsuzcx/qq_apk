  ...
  implements View.OnClickListener
{
  ...
  appt jdField_a_of_type_Appt = new wfj(this);
  ...
  private wfk jdField_a_of_type_Wfk;
  ...
  public wfh(Context paramContext, View paramView, wfk paramwfk)
  {
  ...
  private void e()
  {
    ((PatchedButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131366996)).setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new wfi(this);
  ...
  private void f()
  {
    wsv.b("Q.qqstory.detail.KeyboardAndEmojiManager", "on keyboard up. mIsForceChange = %s.", Boolean.valueOf(this.d));
    ...
    if (this.jdField_a_of_type_Wfk != null) {
      this.jdField_a_of_type_Wfk.b(this.d);
    }
    this.d = false;
  }
  ...
  private void g()
  {
    wsv.b("Q.qqstory.detail.KeyboardAndEmojiManager", "on keyboard down. mIsForceChange = %s.", Boolean.valueOf(this.d));
    ...
    {
      if (this.jdField_a_of_type_Wfk != null) {
        this.jdField_a_of_type_Wfk.c(bool);
      }
      this.c = false;
      this.d = false;
      return;
  ...
  {
    ((PatchedButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131366996)).setText(paramString);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      wsv.b("Q.qqstory.detail.KeyboardAndEmojiManager", "setKeyBoardState: %s." + paramBoolean);
      return;
      label79:
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      } while ((this.jdField_a_of_type_Wfk != null) && (this.jdField_a_of_type_Wfk.b()));
      this.c = true;
      ...
      return;
    } while (this.jdField_a_of_type_Wfk == null);
    this.jdField_a_of_type_Wfk.d();
  }
}
