...
public class bhew
  extends bhcv
{
  private static volatile bhew jdField_a_of_type_Bhew;
  ...
  public static bhew a()
  {
    if (jdField_a_of_type_Bhew == null) {}
    try
    {
      if (jdField_a_of_type_Bhew == null) {
        jdField_a_of_type_Bhew = new bhew();
      }
      return jdField_a_of_type_Bhew;
    }
    finally {}
  }
  ...
  public boolean a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    synchronized (jdField_a_of_type_Bhew)
    {
      if (!this.jdField_a_of_type_Boolean) {
        a(paramContext);
      }
