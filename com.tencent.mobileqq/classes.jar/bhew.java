  ...
  extends QIMEffectCameraCaptureUnit
{
  ...
  public bhew(bhzc parambhzc, bhzb parambhzb)
  {
    super(parambhzc, parambhzb);
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bhex(this);
    this.jdField_a_of_type_Bhyu = new bhyu(10007, 7, 6);
  ...
  public static Bundle a(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, String paramString1, String paramString2, boolean paramBoolean6, boolean paramBoolean7, String paramString3, String paramString4, int paramInt2, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, bhev parambhev)
  {
    ...
    if (parambhev != null)
    {
      localBundle.putBoolean("arg_support_combo", parambhev.jdField_a_of_type_Boolean);
      localBundle.putBoolean("arg_unfold_combo", parambhev.jdField_b_of_type_Boolean);
      localBundle.putString("arg_combo_name", parambhev.jdField_c_of_type_JavaLangString);
      localBundle.putString("arg_combo_id", parambhev.jdField_d_of_type_JavaLangString);
      localBundle.putBoolean("arg_support_music", parambhev.jdField_c_of_type_Boolean);
      localBundle.putBoolean("arg_unfold_music", parambhev.jdField_d_of_type_Boolean);
      localBundle.putString("arg_music_name", parambhev.g);
      localBundle.putString("arg_music_id", parambhev.h);
    }
  ...
  public View a()
  {
    ...
    if ((this.B) && (!this.C))
    {
      ...
      this.f = this.jdField_a_of_type_Bhzc.a().getIntent().getIntExtra("videoId", 0);
      if (this.f == 0) {
        break label103;
      }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt1 == 10007) && (paramInt2 == -1) && (paramIntent != null))
    {
      ...
      {
        localActivity = this.jdField_a_of_type_Bhzc.a();
    ...
    for (paramInt1 = 15;; paramInt1 = 32)
    {
      ...
      bhez.a(localActivity, (SessionInfo)localObject, localPublishParam, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult, paramIntent, null);
  ...
  {
    super.a(paramBundle);
    this.g = this.jdField_a_of_type_Bhzc.a().getIntent().getIntExtra("type", 1);
    this.h = this.jdField_a_of_type_Bhzc.a().getIntent().getIntExtra("WebSceneType", ahhj.jdField_d_of_type_Int);
    paramBundle = new IntentFilter();
    paramBundle.addAction("tencent.video.q2v.startUploadPTV");
    this.jdField_a_of_type_Bhzc.a().registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, paramBundle);
  }
  
  public void a(auuy paramauuy)
  {
    super.a(paramauuy);
    bhyv localbhyv = new bhyx(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a()).a(3).a();
    localbhyv.jdField_a_of_type_Int = this.jdField_j_of_type_Int;
    localbhyv.jdField_a_of_type_JavaLangString = this.jdField_q_of_type_JavaLangString;
  ...
  public void a(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    Object localObject = new bhza().b(3).a();
    if (this.jdField_j_of_type_Int == jdField_d_of_type_Int)
    {
      ((bhyy)localObject).i = true;
      ((bhyy)localObject).jdField_a_of_type_JavaLangString = this.jdField_q_of_type_JavaLangString;
    }
    ((bhyy)localObject).jdField_a_of_type_Int = this.g;
    ((bhyy)localObject).jdField_b_of_type_Int = this.h;
    ((bhyy)localObject).jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Bhzc.a().getIntent().getStringExtra("succUrl");
    ((bhyy)localObject).jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Bhzc.a().getIntent().getStringExtra("failedUrl");
    this.jdField_a_of_type_Bhyu.a((bhyy)localObject);
    a(paramLocalMediaInfo);
    localObject = new bjdr();
    if (this.h == ahhj.jdField_b_of_type_Int)
    {
      PtvTemplateManager.PtvTemplateInfo localPtvTemplateInfo = ((bjin)bhfm.a(3)).a();
      ...
      {
        ((bjdr)localObject).jdField_a_of_type_Int = this.jdField_c_of_type_Int;
        ((bjdr)localObject).jdField_a_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
        ((bjdr)localObject).g = this.jdField_e_of_type_JavaLangString;
        ((bjdr)localObject).f = this.jdField_d_of_type_JavaLangString;
        ((bjdr)localObject).jdField_b_of_type_JavaLangString = (localPtvTemplateInfo.categoryId + "");
        ((bjdr)localObject).jdField_c_of_type_JavaLangString = localPtvTemplateInfo.id;
        ((bjdr)localObject).jdField_a_of_type_Boolean = true;
        if (localPtvTemplateInfo.kind != 8) {
          break label387;
        }
        bool1 = true;
        ((bjdr)localObject).jdField_b_of_type_Boolean = bool1;
        if (localPtvTemplateInfo.kind != 9) {
          break label392;
        }
        bool1 = true;
        label324:
        ((bjdr)localObject).jdField_c_of_type_Boolean = bool1;
    ...
    {
      ((bjdr)localObject).jdField_d_of_type_Boolean = bool1;
      ((bjdr)localObject).jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewEffectsCameraCaptureView.e();
      bjeg.a(this.jdField_a_of_type_Bhzc.a(), paramVideoCaptureResult, paramLocalMediaInfo, this.jdField_a_of_type_Bhyu, this.jdField_a_of_type_AndroidOsBundle, 5, (bjdr)localObject);
      return;
      bool1 = false;
      break;
      bool1 = false;
