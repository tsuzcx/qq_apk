  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    bbkj.a(null, "AIO_EmoticonPanel_TabClick");
    ...
    label220:
    Object localObject1;
    if ((paramAdapterView.size() > EmoticonMainPanel.e) && (((aoap)paramAdapterView.get(EmoticonMainPanel.e)).jdField_a_of_type_Int == 8))
    {
      bool = true;
      EmoticonMainPanel.g = bool;
      paramAdapterView = (aoap)paramAdapterView.get(paramInt);
      if (paramAdapterView.jdField_a_of_type_Int != 8) {
        break label413;
      }
      localObject2 = ajya.a(2131704087);
      paramAdapterView = (ImageView)paramView.findViewById(2131375040);
      bool = false;
      if (paramAdapterView != null)
      {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(paramAdapterView)) {
        axqy.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", paramAdapterView, 0, 0, paramView, "", (String)localObject1, "");
      }
      ...
      bbkj.a("AIO_EmoticonPanel_TabClick", null);
      ...
      if (paramAdapterView.jdField_a_of_type_Int == 9)
      {
        ...
        localObject2 = ajya.a(2131704076);
        localObject1 = "";
        paramView = "";
      }
      else if (paramAdapterView.jdField_a_of_type_Int == 4)
      {
        localObject2 = ajya.a(2131704049);
        axqy.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0x800a56e", "0x800a56e", 0, 0, "", "", "", "");
        this.a.l();
        localObject1 = "";
        paramView = "";
      ...
      else
      {
        ...
        localObject2 = ajya.a(2131704096);
        localObject1 = "";
        paramView = "";
      }
    }
    ...
    if (paramAdapterView.jdField_a_of_type_Int == 6)
    {
      ...
      if (((EmoticonPackage)localObject2).status == 2)
      {
        ...
        localObject4 = ajya.a(2131704056) + ((EmoticonPackage)localObject2).name + ajya.a(2131704073);
        if (((EmoticonPackage)localObject2).status == 2) {
          break label838;
        }
        localObject4 = (String)localObject4 + ajya.a(2131704099);
    ...
    for (;;)
    {
      ...
      {
        localObject2 = ajya.a(2131704097);
        paramAdapterView = (ImageView)paramView.findViewById(2131375040);
        if (paramAdapterView != null)
        {
          paramAdapterView.setVisibility(8);
        ...
        axqy.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A36D", "0X800A36D", 0, 0, "", "", "", "");
        localObject1 = "";
        paramView = "";
        paramAdapterView = "";
        break;
