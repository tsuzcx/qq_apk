...
public class anyp
{
  ...
  private void b(msg_svc.PbSendMsgResp paramPbSendMsgResp, String paramString, int paramInt1, int paramInt2)
  {
    if (paramInt2 == 16)
    {
      ...
      if (TextUtils.isEmpty(str)) {
        paramPbSendMsgResp = anvx.a(2131706101);
      }
      paramPbSendMsgResp = new avhz(paramString, this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getCurrentAccountUin(), paramPbSendMsgResp, paramInt1, -5020, 1376257, bcrg.a());
      ...
      avia.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, paramString);
    }
  }
  ...
  private void c(msg_svc.PbSendMsgResp paramPbSendMsgResp, String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      aonr.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, paramString, paramPbSendMsgResp.errmsg.get(), paramInt1, false, false);
      switch (paramInt2)
      {
      default: 
    ...
    {
      bdla.b(paramString, "dc00899", "grp_lbs", "", "c2c_tmp", "no_send", 0, 0, paramPbSendMsgResp, "" + paramInt2, "", "");
      return;
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, "CliOper", "", "", "0X80052A8", "0X80052A8", 0, 0, "", "", "", "");
      break;
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, "CliOper", "", "", "0X80052A9", "0X80052A9", 0, 0, "", "", "", "");
      break;
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app, "CliOper", "", "", "0X80052AA", "0X80052AA", 0, 0, "", "", "", "");
      break;
    }
  }
  ...
  public anyp a()
  {
    ...
    for (Object localObject = this.jdField_a_of_type_MsfMsgsvcMsg_svc$PbSendMsgResp.errmsg.get();; localObject = "")
    {
      ...
      if (this.jdField_c_of_type_Boolean)
      {
        ...
        ((anza)localObject).jdField_b_of_type_Int = 2900;
        ((anza)localObject).jdField_a_of_type_Long = this.f;
        ((anza)localObject).jdField_c_of_type_Int = (i + 1);
        ((anza)localObject).jdField_a_of_type_JavaLangString = MessageHandler.a(this.jdField_a_of_type_ComTencentQphoneBaseRemoteFromServiceMsg);
        ((anza)localObject).d = 1;
      ...
      if ((this.d == 1025) || (this.d == 1024))
      {
        ...
        ((bjyi)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getBusinessHandler(BusinessHandlerFactory.QIDIAN_HANDLER)).a(this.jdField_a_of_type_JavaLangString, this.f, l);
      }
