  ...
  implements ISkinEngineLog, SkinEngineHandler
{
  ...
  public abeu(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  public boolean onDecodeOOM(OutOfMemoryError paramOutOfMemoryError, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      bctj.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a(null, "report_resource_decode_OOM", false, 0L, 0L, paramOutOfMemoryError, "");
      if (BaseApplicationImpl.sImageCache != null) {
  ...
  public boolean onDecodeReturnNullBitmap(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      bctj.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a(null, "report_resource_decode_OOM", false, 0L, 0L, paramString, "");
