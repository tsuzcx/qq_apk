...
public class bppp
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alwf.jdField_a_of_type_JavaLangString + "/Tencent/qim/hum_recognition";
  ...
  private String a()
  {
    ...
    int i = a();
    String str1 = bppc.a("musicopi_12345683" + "a45a1b" + l);
  ...
  public bppp a(float paramFloat)
  {
    if (QLog.isColorLevel()) {
