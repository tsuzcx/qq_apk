...
class bbzb
  implements bbze
{
  bbzb(bbyy parambbyy, HotWordSearchEntryDataModel.GIFInfo paramGIFInfo) {}
  ...
  public void a()
  {
    ...
    aokg localaokg = new aokg(localQQAppInterface);
    if (!TextUtils.equals(str, this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$GIFInfo.hotSearchGifID))
    {
      ...
      localaokg.a(localQQAppInterface, "gif_sta_first", null, null, this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$GIFInfo.hotSearchGifID);
      return;
    }
    localSharedPreferences.edit().putInt("HotWordSearchEntryModel.psk_hot_search_try_time", i + 1).apply();
    localaokg.a(localQQAppInterface, "gif_sta_second", null, null, this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$GIFInfo.hotSearchGifID);
  }
  ...
  public void b()
  {
    ...
    aokg localaokg = new aokg(localQQAppInterface);
    if (i == 1) {
      localaokg.a(localQQAppInterface, "gif_suc_first", null, null, this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$GIFInfo.hotSearchGifID);
    }
    for (;;)
    {
      ...
      return;
      localaokg.a(localQQAppInterface, "gif_suc_second", null, null, this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$GIFInfo.hotSearchGifID);
    }
  }
}
