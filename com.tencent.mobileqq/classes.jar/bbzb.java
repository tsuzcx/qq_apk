...
public class bbzb
{
  ...
  public bbzb(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      bbze localbbze = new bbze(this, str, bool2, bool1);
      if (!TextUtils.isEmpty(str)) {
        ThreadManager.post(new SoLibraryChecker.4(this, paramJSONObject, str, localbbze), 8, null, false);
      }
      return;
      if ((i == 3) || (i == 2))
      {
  ...
  private void b()
  {
    ...
    nbv.a(this.jdField_a_of_type_JavaLangString, localQQAppInterface, new bbzc(this), false);
  }
  ...
  private void c()
  {
    ...
    long l = System.currentTimeMillis();
    if ((!nbv.a(BaseApplicationImpl.getContext(), str, new bbzd(this, l))) && (QLog.isColorLevel())) {
