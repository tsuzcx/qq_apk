...
public abstract class asxf
{
  public static final String a;
  public static final String b = avwn.jdField_a_of_type_JavaLangString + "file/";
  protected QQAppInterface a;
  
  static
  {
    jdField_a_of_type_JavaLangString = avwn.jdField_a_of_type_JavaLangString + "fileThumb/";
  }
  
  public asxf(QQAppInterface paramQQAppInterface)
  {
  ...
  protected MsgBackupResEntity a(MessageRecord paramMessageRecord, int paramInt, String paramString)
  {
    ...
    avwu.a(paramMessageRecord, localMsgBackupResEntity);
    localMsgBackupResEntity.extraDataStr = a(aszt.a((ChatMessage)paramMessageRecord), paramInt);
  ...
  protected boolean b(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    if (paramMessageRecord.isMultiMsg)
    {
      ...
      {
        if (QLog.isDebugVersion()) {
          QLog.i("FileMsgBackupHandler<QFile>", 1, "isResourceRelateToMsg: multi msg match res. fileId[" + str + "] " + ataw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord));
        }
        return true;
      }
      return false;
