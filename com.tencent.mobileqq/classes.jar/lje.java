...
public class lje
{
  ...
  static
  {
    ...
    jdField_a_of_type_Lji = new lji();
  }
  
  public lje(Context paramContext)
  {
    ...
    this.jdField_c_of_type_Boolean = mtd.f(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_d_of_type_Boolean = mtd.c();
    this.h = Build.VERSION.SDK_INT;
    this.jdField_a_of_type_JavaLangString = Build.MODEL;
    this.jdField_b_of_type_JavaLangString = Build.MANUFACTURER;
    jdField_a_of_type_Lji.jdField_b_of_type_Int = -1;
    jdField_a_of_type_Lji.jdField_c_of_type_Int = -1;
  ...
  {
    if (paramBoolean) {
      return 360 - lkw.a(this.jdField_a_of_type_AndroidContentContext, true, true, (byte)0, false) * 90;
    }
    return 360 - lkw.b(this.jdField_a_of_type_AndroidContentContext, true, true, (byte)0, false) * 90;
  }
  ...
  protected lji a(int paramInt, Camera paramCamera)
  {
    paramCamera = new lji();
    try
    {
  ...
  {
    int i1 = jdField_a_of_type_Lji.jdField_c_of_type_Int;
    jdField_a_of_type_Lji.jdField_c_of_type_Int = ((this.k + paramInt) % 360);
    if (i1 != jdField_a_of_type_Lji.jdField_c_of_type_Int) {
      QLog.w("AndroidCamera", 1, "setMobileRotation, rotation[" + i1 + "->" + jdField_a_of_type_Lji.jdField_c_of_type_Int + "], mCompenSateSendAngle[" + this.k + "]");
    }
  }
  
  public void a(int paramInt, ljf paramljf)
  {
    int i1 = 0;
    if (this.n != paramInt)
    {
    ...
    if (this.n == 0) {
      if ((this.jdField_a_of_type_Ljg != null) && (i1 == 0)) {}
    }
    for (this.jdField_a_of_type_Ljg = new ljr(this, paramljf);; this.jdField_a_of_type_Ljg = new ljs(this, paramljf))
    {
      do
      {
        if (QLog.isColorLevel()) {
        ...
        return;
      } while ((this.n != 1) || ((this.jdField_a_of_type_Ljg != null) && (i1 == 0)));
      if (this.jdField_a_of_type_Ljg != null) {
        this.jdField_a_of_type_Ljg.a();
      }
    }
  }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    {
      return;
      synchronized (jdField_a_of_type_Lji)
      {
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      lbj.c("AndroidCamera", "mFrontCameraAngle: " + this.l + ", mBackCameraAngle: " + this.m);
      return;
      this.m = (paramInt % 360);
    }
  }
  ...
  {
    lji locallji = a(paramInt, paramCamera);
    this.k = d();
    this.j = e();
    int i2 = f();
    int i3 = g();
    int i4;
    int i5;
    if (locallji.jdField_a_of_type_Int == 1)
    {
      i1 = (360 - (locallji.jdField_b_of_type_Int + locallji.jdField_c_of_type_Int) % 360) % 360;
    ...
    {
      QLog.w("AndroidCamera", 1, "setCameraDisplayOrientation, cameraId[" + paramInt + "], orientation[" + jdField_a_of_type_Lji.jdField_b_of_type_Int + "->" + locallji.jdField_b_of_type_Int + "], rotation[" + jdField_a_of_type_Lji.jdField_c_of_type_Int + "->" + locallji.jdField_c_of_type_Int + "], mCompenSateSendAngle[" + this.k + "], mCompenSateRecvAngle[" + this.j + "], mSupportLandscape[" + this.jdField_e_of_type_Boolean + "], previewAngleForFrontCamera[" + i4 + "], previewAngleForBackCamera[" + i5 + "], cameraImageOrientation[" + i2 + "], mobileRotation[" + i3 + "], result[" + i1 + "], cameraMode[" + this.n + "], seq[" + paramLong + "]");
      a(paramCamera, i1);
      jdField_a_of_type_Lji.jdField_a_of_type_Int = locallji.jdField_a_of_type_Int;
      jdField_a_of_type_Lji.jdField_b_of_type_Int = locallji.jdField_b_of_type_Int;
      return true;
      i1 = (locallji.jdField_b_of_type_Int - locallji.jdField_c_of_type_Int + 360) % 360;
      break;
    }
  }
  ...
  public boolean a(long paramLong, SurfaceTexture paramSurfaceTexture)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (jdField_a_of_type_Boolean)
        {
          ...
          lju.a(BaseApplicationImpl.getContext(), "openCamera");
          return bool1;
        }
      ...
      if (a(paramLong))
      {
        ...
        if (b(paramLong))
        {
          ...
          try
          {
            label414:
            if (this.jdField_a_of_type_Ljg != null) {
              this.jdField_a_of_type_Ljg.a(paramLong, paramSurfaceTexture);
            }
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (this.jdField_a_of_type_AndroidHardwareCamera != null)
      {
        ...
        break label596;
        label578:
        lju.b(BaseApplicationImpl.getContext(), "openCamera");
        break label154;
        bool1 = false;
        break label321;
      }
      ...
      try
      {
        ...
        if (this.g >= 1) {
          if (this.jdField_a_of_type_AndroidHardwareCamera == null)
          {
            ...
            if (bool1)
            {
              lju.a(BaseApplicationImpl.getContext(), "reopenCamera");
              return bool1;
            }
          }
          else
        ...
        case 1: 
          ...
          break label382;
          lju.b(BaseApplicationImpl.getContext(), "reopenCamera");
          continue;
          bool1 = false;
        }
      }
  ...
  protected int b()
  {
    ...
    {
      if (AudioHelper.f()) {
        QLog.w("AndroidCamera", 1, "getNumberOfCamera, hardcode[" + bhvi.a().a() + "]");
      }
      i1 = bhvi.a().a();
    }
    do
  ...
  {
    if (paramBoolean) {
      return lkw.a(this.jdField_a_of_type_AndroidContentContext, false, true, (byte)0, false) * 90;
    }
    return lkw.b(this.jdField_a_of_type_AndroidContentContext, false, true, (byte)0, false) * 90;
  }
  ...
  protected Camera b(long paramLong)
  {
    ...
    //   6: aload_0
    //   7: iconst_0
    //   8: putfield 340	lje:i	I
    //   11: aload_0
    //   12: getfield 54	lje:g	I
    //   15: ifne +11 -> 26
    //   18: aload_0
    //   19: aload_0
    //   20: invokevirtual 342	lje:b	()I
    //   23: putfield 54	lje:g	I
    //   26: aload_0
    //   27: getfield 54	lje:g	I
    //   30: ifle +240 -> 270
      ...
      try
      {
        if (this.g >= 1)
        {
          if (this.jdField_a_of_type_AndroidHardwareCamera == null)
          {
            ...
            if (bool1)
            {
              lju.a(BaseApplicationImpl.getContext(), "switchCamera");
              return bool1;
            }
          }
          else
          ...
          lju.b(BaseApplicationImpl.getContext(), "switchCamera");
          continue;
        }
        bool1 = false;
      }
  ...
  public boolean c(long paramLong)
  {
    try
    {
      ...
      lju.b(BaseApplicationImpl.getContext(), "closeCamera");
      return true;
    }
    finally {}
  }
  ...
  public int f()
  {
    if (jdField_a_of_type_Lji.jdField_b_of_type_Int == -1)
    {
      if (this.f == 1) {
        return 270;
      }
    ...
    return jdField_a_of_type_Lji.jdField_b_of_type_Int;
  }
  
  public int g()
  {
    if (jdField_a_of_type_Lji.jdField_c_of_type_Int == -1) {
      return 0;
    }
    return jdField_a_of_type_Lji.jdField_c_of_type_Int;
  }
