  ...
  implements zel
{
  ...
  protected zdw a;
  protected zec a;
  zel jdField_a_of_type_Zel = new zej(this);
  protected boolean a;
  private int b;
  ...
  public zed(Activity paramActivity, zec paramzec)
  {
  ...
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131560803, null));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131377884));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131364335));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131376288));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131366752));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131376054));
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131380144));
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131362434);
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131364145));
  ...
  private void n()
  {
    ...
    this.jdField_a_of_type_Int = ((bdkf.a() - this.jdField_d_of_type_Int * 2 - this.jdField_b_of_type_Int * 3) / 4);
  }
  ...
  private void o()
  {
    ...
    {
      if ((this.jdField_a_of_type_Zep == null) || (!this.jdField_a_of_type_Zep.jdField_b_of_type_Boolean)) {
        break label129;
      }
      this.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_d_of_type_AndroidWidgetTextView.setText("");
      ((ViewGroup.MarginLayoutParams)this.jdField_d_of_type_AndroidWidgetTextView.getLayoutParams()).setMargins(aekt.a(16.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, 0, 0);
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new zee(this));
    }
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new zef(this));
    }
  }
  ...
  private void q()
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new zeg(this));
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(new zeh(this));
      if (this.jdField_c_of_type_AndroidWidgetImageView != null) {
        this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(new zei(this));
      }
      return;
  ...
  protected abstract bhqp a();
  
  protected abstract bhte a();
  
  protected abstract AbstractImageAdapter a(Activity paramActivity, int paramInt);
  
  public void a()
  {
    this.jdField_a_of_type_Zep.a().a(this.jdField_a_of_type_Zel);
  }
  
  public void a(ViewGroup paramViewGroup)
  {
    this.jdField_a_of_type_Zdw = this.jdField_a_of_type_Zep.a();
    n();
    c(paramViewGroup);
  }
  ...
  public void f()
  {
    ...
    this.jdField_a_of_type_Zec = null;
  }
  ...
  public void k()
  {
    if ((this.jdField_a_of_type_AndroidAppActivity instanceof AIOGalleryActivity))
    {
      ...
      if ((ImmersiveUtils.isSupporImmersive() == 1) && (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null))
      {
        ...
        if ((this.jdField_a_of_type_Zep != null) && (this.jdField_a_of_type_Zep.jdField_a_of_type_AndroidViewViewGroup != null) && (Build.VERSION.SDK_INT >= 16)) {
          this.jdField_a_of_type_Zep.jdField_a_of_type_AndroidViewViewGroup.setSystemUiVisibility(0);
        }
      }
      if (((AIOGalleryActivity)this.jdField_a_of_type_AndroidAppActivity).mSystemBarComp != null)
      {
        i = this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131166957);
