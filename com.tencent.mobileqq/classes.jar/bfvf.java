...
public class bfvf
  extends bfwg<ArithmeticViewHolder, bfuo>
{
  ...
  public bfvf(XMediaEditor paramXMediaEditor, Context paramContext)
  {
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorUiArithmeticViewHolder = new ArithmeticViewHolder(this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorXMediaEditor, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561562, paramViewGroup, false));
  ...
  public void a(ArithmeticViewHolder paramArithmeticViewHolder, bfuo parambfuo, int paramInt)
  {
    paramArithmeticViewHolder.a(parambfuo, paramInt);
