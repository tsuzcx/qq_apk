...
public class bitt
  extends bitm<Bundle, Void, HashMap<String, Object>>
{
  protected Handler a;
  public bitu a;
  
  public bitt(String paramString1, String paramString2, bitu parambitu)
  {
    super(paramString1, paramString2);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_Bitu = parambitu;
  }
  ...
  public bitp a(String paramString1, String paramString2, Bundle paramBundle)
  {
  ...
  public void a()
  {
    this.jdField_a_of_type_Bitu = null;
  }
  ...
  public HashMap<String, Object> b(Bundle... paramVarArgs)
  {
    ...
    try
    {
      ...
      j = biug.a(biip.a().a(), (String)localObject).a("Common_HttpRetryCount");
      bisy.c("OpenConfig_agent", "config 1:Common_HttpRetryCount            config_value:" + j + "   appid:" + (String)localObject + "     url:" + str2);
      if (j == 0)
      {
        j = 3;
        bisy.c("OpenConfig_agent", "config 1:Common_HttpRetryCount            result_value:" + j + "   appid:" + (String)localObject + "     url:" + str2);
    ...
    catch (Exception localException)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          try
          {
            localbitp = a(this.jdField_a_of_type_JavaLangString, this.b, paramVarArgs[0]);
            l2 = l1;
            l4 = l1;
            str1 = localbitp.jdField_a_of_type_JavaLangString;
            l2 = l1;
            l4 = l1;
            ...
            l2 = l1;
            l4 = l1;
            ((JSONObject)localObject).put("content", localbitp.jdField_a_of_type_JavaIoInputStream);
          }
          catch (ConnectTimeoutException localConnectTimeoutException)
          {
            ...
            l2 = l1;
            l4 = l1;
            localJSONObject1.put("httpdatamodified", localbitp.jdField_a_of_type_Int);
            continue;
          }
          ...
          catch (HttpBaseUtil.HttpStatusException paramVarArgs)
          {
            ...
            try
            {
              ...
              biuo.a().a(str2, l3, l2, 0L, i, biip.a().a(), "1000002", null);
              return localHashMap;
            }
          ...
          catch (Exception paramVarArgs)
          {
            ...
            {
              i = Integer.parseInt(paramVarArgs.getMessage().replace("http status code error:", ""));
              biuo.a().a(str2, l3, l4, 0L, i, biip.a().a(), "1000002", null);
              return localHashMap;
            }
            catch (Exception paramVarArgs)
            {
          ...
          l2 = l1;
          l4 = l1;
          bisy.a("HttpCgiAsyncTask", "response.isModified= " + localbitp.jdField_a_of_type_Int);
          l2 = l1;
          l4 = l1;
          if (localbitp.jdField_a_of_type_Int == 0)
          {
            if (!bool) {
              continue;
            }
            ...
            l2 = l1;
            l4 = l1;
            localJSONObject2.put("httpdatamodified", localbitp.jdField_a_of_type_Int);
            l2 = l1;
            l4 = l1;
          ...
          l2 = l1;
          l4 = l1;
          l1 = localbitp.jdField_a_of_type_Long;
          l2 = l1;
          l4 = l1;
          l5 = localbitp.b;
          l2 = l5;
          l4 = l3;
          bisy.c("ReportManager", str2 + " | " + l4 + " | " + l1 + " | " + l2 + " | " + i);
          l3 = 0L;
          try
          {
          ...
          biuo.a().a(str2, l4, l1, l2, i, l3, "1000002", null);
          return localHashMap;
          if (!bool) {
            continue;
          }
