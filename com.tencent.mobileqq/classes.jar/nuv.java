...
public class nuv
  implements bepj
{
  public nuv(ReadInJoyCommentComponentFragment paramReadInJoyCommentComponentFragment) {}
  ...
  public View a(int paramInt)
  {
    ...
    if (paramInt == 3)
    {
      ...
      {
        this.a.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel = ((EmoticonMainPanel)View.inflate(ReadInJoyCommentComponentFragment.a(this.a), 2131493455, null));
    ...
    {
      this.a.jdField_a_of_type_ComTencentMobileqqHotpicPublicAccountHotPicPanel = ((PublicAccountHotPicPanel)View.inflate(ReadInJoyCommentComponentFragment.a(this.a), 2131493859, null));
