...
public class aife
  extends BaseAdapter
{
  public aife(SelectMemberFromFriendGroup paramSelectMemberFromFriendGroup) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramView.setOnClickListener(new aiff(this));
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (aifg)paramView.getTag();
      break;
      label224:
