  ...
  extends BaseAdapter
{
  ...
  public bhdb(BaseActivity paramBaseActivity)
  {
  ...
  public void a(bhbx parambhbx, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (paramMQMsg != localMQMsg)
        {
          ...
          if ((i == 0) && (this.jdField_a_of_type_Bhbx != null)) {
            this.jdField_a_of_type_Bhbx.d();
          }
        }
      }
  ...
  public boolean a()
  {
    ...
    if ((localMQMsg.msgBody.photolist == null) || (localMQMsg.msgBody.photolist.isEmpty()))
    {
      ...
      if ((bool) && (this.jdField_a_of_type_Bhbx != null)) {
        this.jdField_a_of_type_Bhbx.d();
      }
      return bool;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView.setMsgOnClickListener(this.jdField_a_of_type_Bhdn);
      paramView.setData(paramInt, (MQMsg)getItem(paramInt), this.b, this.jdField_a_of_type_Boolean);
      if ((paramInt != 0) || (this.jdField_a_of_type_Bhbx == null)) {
        break label214;
      }
      boolean bool = this.jdField_a_of_type_Bhbx.a(((MsgCardView)paramView).a(), (MQMsg)getItem(paramInt));
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Bhdc != null) {
        this.jdField_a_of_type_Bhdc.a(paramInt, paramView, paramViewGroup);
      }
      return paramView;
      ((MsgCardView)paramView).setMsgOnClickListener(this.jdField_a_of_type_Bhdn);
