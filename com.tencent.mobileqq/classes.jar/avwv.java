  ...
  implements bekg
{
  ...
  {
    SingTogetherSession localSingTogetherSession = (SingTogetherSession)beki.a(4, 2, String.valueOf(paramLong2));
    if (paramInt2 == 1) {
      if (paramLong1 != 0L) {
        break label111;
      }
    ...
    for (String str = "";; str = String.valueOf(paramLong1))
    {
      ...
      if (((paramInt2 == 5) || (paramInt2 == 2)) && (!TextUtils.isEmpty(paramString))) {
        avya.a(paramQQAppInterface, paramLong2, 0, paramString, paramInt2, paramLong4, paramLong5, 131087);
      }
      return;
    }
  }
    ...
    do
    {
      ...
      if (localSingChangePushInfo != null)
      {
        ...
        for (paramObject = localSingChangePushInfo.bytes_gray_tips.get().toStringUtf8();; paramObject = null)
        {
          ...
          long l4 = ((bejv)paramQQAppInterface.getManager(QQManagerFactory.TOGETHER_CONTROLLER_MANAGER)).a(4, 1, l2);
          if (QLog.isColorLevel()) {
        ...
        SingTogetherSession localSingTogetherSession = (SingTogetherSession)beki.a(4, 1, String.valueOf(l2));
        if (i == 1) {
          if (l3 != -1L) {
            break label542;
          }
        ...
        for (String str = "";; str = String.valueOf(l3))
        {
          ...
          avya.a(paramQQAppInterface, l2, 1, paramObject, i, paramLong1, paramLong2, 131087);
          return;
        }
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, SingTogetherSession paramSingTogetherSession, int paramInt, long paramLong1, String paramString, long paramLong2, long paramLong3, TroopTips0x857.SingChangePushInfo paramSingChangePushInfo)
  {
    ...
    bejv localbejv = (bejv)paramQQAppInterface.getManager(QQManagerFactory.TOGETHER_CONTROLLER_MANAGER);
    localbejv.a(4, paramSingTogetherSession.jdField_f_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, paramLong2);
    Object localObject = (SingTogetherSession)localbejv.a(paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_f_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString);
    if (localObject != null)
    {
      if ((paramInt == 1) || (paramInt == 3) || (paramInt == 4)) {
        ((SingTogetherSession)localObject).g = paramSingTogetherSession.g;
      }
    ...
    for (;;)
    {
      if (paramInt == 1)
      {
        beki.a(paramQQAppInterface, paramSingTogetherSession.jdField_e_of_type_JavaLangString, true, paramSingTogetherSession.jdField_f_of_type_Int, 16777216);
        label164:
        if (paramSingTogetherSession.jdField_f_of_type_Int != 2) {
          break label307;
        }
        localObject = ((anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).b(paramSingTogetherSession.jdField_e_of_type_JavaLangString);
      ...
      {
        return;
        localbejv.a(paramSingTogetherSession.jdField_e_of_type_Int, paramSingTogetherSession.jdField_f_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, paramSingTogetherSession);
        break;
        if (paramInt == 2)
        {
          paramSingTogetherSession.h = 3;
          paramSingTogetherSession.i = 3;
          beki.a(paramQQAppInterface, paramSingTogetherSession.jdField_e_of_type_JavaLangString, false, paramSingTogetherSession.jdField_f_of_type_Int, 16777216);
          break label164;
        }
      ...
      localObject = localbejv.a(4, paramSingTogetherSession.jdField_f_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, 1003);
      ((bekb)localObject).jdField_a_of_type_AndroidOsBundle.putInt("action_type", paramInt);
      ((bekb)localObject).jdField_a_of_type_AndroidOsBundle.putString("tips", paramString);
      ((bekb)localObject).jdField_a_of_type_AndroidOsBundle.putLong("seq", paramLong2);
      ((bekb)localObject).jdField_a_of_type_AndroidOsBundle.putLong("msgSeq", paramLong3);
      ((bekb)localObject).jdField_a_of_type_JavaLangObject = paramSingChangePushInfo;
      ...
      localbejv.a(4, paramSingTogetherSession.jdField_f_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, 1003);
      return;
      label454:
      paramSingTogetherSession = (SingTogetherSession)localObject;
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      label584:
      l4 = ((bejv)paramQQAppInterface.getManager(QQManagerFactory.TOGETHER_CONTROLLER_MANAGER)).a(4, 2, l2);
      if (l3 < l4)
      {
        if (QLog.isColorLevel()) {
          QLog.d("SingTogetherParser", 2, "handleSingTogetherGroupPush, skip pushinfo, old seq=" + l4);
  ...
  public void a(ToServiceMsg paramToServiceMsg, aio_media.RspLatestPlayingState paramRspLatestPlayingState)
  {
    ...
    label131:
    boolean bool2 = false;
    Object localObject3 = (bejv)this.a.getManager(QQManagerFactory.TOGETHER_CONTROLLER_MANAGER);
    paramToServiceMsg = (SingTogetherSession)((bejv)localObject3).a(4, j, (String)localObject2);
    Object localObject1 = paramToServiceMsg;
    if (paramToServiceMsg == null)
    {
      localObject1 = (SingTogetherSession)beki.a(4, j, (String)localObject2);
      ((bejv)localObject3).a(4, j, (String)localObject2, (bekh)localObject1);
    }
    boolean bool1;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          bool2 = true;
          bool1 = bool2;
          ((SingTogetherSession)localObject1).h = paramRspLatestPlayingState.enum_aio_state.get();
          bool1 = bool2;
          ((SingTogetherSession)localObject1).i = paramRspLatestPlayingState.enum_user_state.get();
          bool1 = bool2;
          ...
          bool1 = bool2;
          ((StringBuilder)localObject3).append(" status=").append(((SingTogetherSession)localObject1).h).append(" userState=").append(((SingTogetherSession)localObject1).i).append(" creator=").append(((SingTogetherSession)localObject1).jdField_f_of_type_JavaLangString).append(" timeStamp=").append(((SingTogetherSession)localObject1).jdField_c_of_type_Long);
          bool1 = bool2;
          ...
          bool1 = bool2;
          ((SingTogetherSession)localObject1).g = paramRspLatestPlayingState.uint32_joined_num.get();
          bool1 = bool2;
          ((StringBuilder)localObject3).append(" joinNum=").append(((SingTogetherSession)localObject1).g);
          bool1 = bool2;
          if (QLog.isColorLevel())
          {
            bool1 = bool2;
          ...
          {
            if (((SingTogetherSession)localObject1).jdField_f_of_type_Int != 2) {
              break label1055;
            }
  ...
  public void a(Object paramObject)
  {
    ...
    {
      return;
      paramObject = ((bejv)this.a.getManager(QQManagerFactory.TOGETHER_CONTROLLER_MANAGER)).a(4, 2, String.valueOf(paramObject));
    } while (!(paramObject instanceof SingTogetherSession));
    paramObject.h = 3;
    paramObject.i = 3;
    beki.a(this.a, paramObject.jdField_e_of_type_JavaLangString, false, paramObject.jdField_f_of_type_Int, 16777216);
    a(true, (SingTogetherSession)paramObject, 1007, "");
  }
  
  public void a(String paramString, int paramInt)
  {
    paramString = ((bejv)this.a.getManager(QQManagerFactory.TOGETHER_CONTROLLER_MANAGER)).a(4, 1, paramString);
    if ((paramString instanceof SingTogetherSession))
    {
      paramString.h = 3;
      paramString.i = 3;
      beki.a(this.a, paramString.jdField_e_of_type_JavaLangString, false, paramString.jdField_f_of_type_Int, 16777216);
  ...
  public void a(boolean paramBoolean, SingTogetherSession paramSingTogetherSession, int paramInt, String paramString)
  {
    ...
    bekb localbekb = localbejv.a(4, paramSingTogetherSession.jdField_f_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, paramInt);
    if ((paramBoolean) && (paramInt == 1003))
    {
      int i = localbekb.jdField_a_of_type_AndroidOsBundle.getInt("action_type");
      String str = localbekb.jdField_a_of_type_AndroidOsBundle.getString("tips");
      long l1 = localbekb.jdField_a_of_type_AndroidOsBundle.getLong("seq");
      long l2 = localbekb.jdField_a_of_type_AndroidOsBundle.getLong("msgSeq");
      localbejv.a(paramSingTogetherSession, i, str, l1, l2, localbekb.jdField_a_of_type_JavaLangObject);
      localbejv.b(paramSingTogetherSession, i, str, l1, l2, localbekb.jdField_a_of_type_JavaLangObject);
    }
    if (paramSingTogetherSession.h == 3) {
      beki.a(this.a, paramSingTogetherSession.jdField_e_of_type_JavaLangString, false, paramSingTogetherSession.jdField_f_of_type_Int, 16777216);
    }
    for (;;)
    {
      localbejv.a(paramBoolean, paramSingTogetherSession, paramInt, paramString);
      localbejv.b(4, paramSingTogetherSession.jdField_f_of_type_Int, paramSingTogetherSession.jdField_e_of_type_JavaLangString, paramInt);
      return;
      beki.a(this.a, paramSingTogetherSession.jdField_e_of_type_JavaLangString, true, paramSingTogetherSession.jdField_f_of_type_Int, 16777216);
    }
  }
}
