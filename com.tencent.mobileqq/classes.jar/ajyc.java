...
public class ajyc
{
  ...
  public ajyc(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
  ...
  public static String a(CharSequence paramCharSequence)
  {
    ...
    if (i < paramCharSequence.length())
    {
      ...
      {
        j = i;
        if (paramCharSequence.charAt(i + 1) < bdnh.jdField_a_of_type_Int)
        {
      ...
      for (;;)
      {
        ...
        break;
        j = i;
        if (bdnh.jdField_a_of_type_AndroidUtilSparseIntArray.get(m, -1) >= 0) {
          if ((m > 65535) && (k >= i + 2))
          {
            paramCharSequence.replace(i, i + 2, "\001\001");
            j = i;
  ...
  public SpannableString a(String paramString)
  {
    ...
    if (i > 20)
    {
      ...
      {
        i = j;
        if (bdnh.jdField_a_of_type_AndroidUtilSparseIntArray.get(k, -1) >= 0)
        {
          i = j;
          if (k <= 65535) {}
        }
  ...
  public CharSequence a(String paramString, int paramInt)
  {
    ...
    paramString = new bdnt(a(paramString), 3, 16);
  ...
  {
    return bgsu.a(1000L * paramLong, true, "yyyy-MM-dd");
  }
