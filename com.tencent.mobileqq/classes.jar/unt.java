...
{
  private static unt jdField_a_of_type_Unt;
  ...
  private unu jdField_a_of_type_Unu;
  ...
  public static unt a()
  {
    if (jdField_a_of_type_Unt == null) {}
    try
    {
      if (jdField_a_of_type_Unt == null) {
        jdField_a_of_type_Unt = new unt();
      }
      return jdField_a_of_type_Unt;
    }
    finally {}
  }
  ...
  public static void a(int paramInt)
  {
    ...
    {
      uya.b("WSFallKeyPicMonitor", "sendStartEvent");
  ...
  private void a(stSimpleMetaFeed paramstSimpleMetaFeed, int paramInt1, int paramInt2)
  {
    if (paramstSimpleMetaFeed != null)
    {
      uya.b("WSFallKeyPicMonitor", "recommendReportForDlOpenWeiShi");
      uvi.a(1, 115, 0, paramstSimpleMetaFeed, unq.a(1, paramInt1, paramInt2));
      return;
    }
    uya.b("WSFallKeyPicMonitor", "recommendReportForDlOpenWeiShi failure : feed == null");
  }
  
  public static void a(SimpleEventReceiver paramSimpleEventReceiver)
  {
    uya.b("WSFallKeyPicMonitor", "registerReceiver");
  ...
  public static void b(int paramInt)
  {
    if (jdField_c_of_type_Boolean)
    {
      uya.b("WSFallKeyPicMonitor", "sendFinishEvent");
      SimpleEventBus.getInstance().dispatchEvent(new WSPicMonitorEvent(paramInt, -1, ""));
    }
  }
  ...
  {
    uya.b("WSFallKeyPicMonitor", "unRegisterReceiver");
  ...
  private void c()
  {
    if (jdField_c_of_type_Boolean)
    {
      ...
      uya.b("WSFallKeyPicMonitor", "release");
      if (this.jdField_a_of_type_Unu != null) {
        this.jdField_a_of_type_Unu.removeMessages(1);
      }
  ...
  private void d()
  {
    uya.b("WSFallKeyPicMonitor", "startPreDownLoadWeiShi");
    WSDownloadParams localWSDownloadParams = a();
    unq.a((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), localWSDownloadParams);
  }
  
  private void e()
  {
    uya.b("WSFallKeyPicMonitor", "performSilentDownload");
    WSDownloadParams localWSDownloadParams = a();
    unq.a((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), localWSDownloadParams, true, 2);
    uvr.a(115, Integer.valueOf(4));
    a(this.jdField_a_of_type_UserGrowthStSimpleMetaFeed, this.jdField_c_of_type_Int, this.d);
  }
  
  public void a()
  {
    uya.b("WSFallKeyPicMonitor", "immediatelyPreload");
    if (this.jdField_a_of_type_Unu != null)
    {
      this.jdField_a_of_type_Unu.removeMessages(1);
      this.jdField_a_of_type_Unu.sendEmptyMessage(1);
    }
  }
  ...
  public void a(Activity paramActivity, int paramInt, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    uya.b("WSFallKeyPicMonitor", "init , linkType = " + paramInt + "; feed = " + paramstSimpleMetaFeed);
    ...
    for (paramInt = 300;; paramInt = 99)
    {
      ...
      this.jdField_a_of_type_Unu = new unu(this, this);
      this.jdField_a_of_type_Unu.sendEmptyMessageDelayed(1, 3000L);
      return;
    }
  }
  ...
  public void a(Context paramContext)
  {
    if (yqu.a(paramContext)) {
      uya.d("WSFallKeyPicMonitor", "本地已经安装微视app");
    }
  ...
  {
    int j = 1;
    uya.b("WSFallKeyPicMonitor", "onReceiveEvent");
    int i;
    if ((paramSimpleBaseEvent instanceof WSPicMonitorEvent))
    {
      ...
      {
      default: 
        uya.b("WSFallKeyPicMonitor", "type = " + paramSimpleBaseEvent.getType() + "; OperateType = " + paramSimpleBaseEvent.getOperateType() + ", content = " + paramSimpleBaseEvent.getContent());
      ...
      for (;;)
      {
        for (;;)
        {
          if ((i != 0) && (j != 0) && (this.jdField_a_of_type_Int <= 0))
          {
            ...
            a();
            uya.b("WSFallKeyPicMonitor", "非超时触发下载");
          }
          return;
          do
          {
