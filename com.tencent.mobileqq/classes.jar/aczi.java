...
public class aczi
{
  public static aczh a(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if (TextUtils.isEmpty(paramContext))
        {
          ...
          if (i < paramContext.length())
          {
            ...
            paramString.add(new aczh(localJSONObject));
            break label130;
          }
        }
        else
      ...
      catch (JSONException paramContext)
      {
        ...
        if (paramString.size() > 1) {
          Collections.sort(paramString, new aczj());
        }
        if (paramString.size() > 0) {
          return (aczh)paramString.get(0);
        }
        return null;
      }
      label125:
    ...
    for (;;)
    {
      try
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          ...
          ((JSONArray)localObject).put(new JSONObject(paramaczh.e()));
      ...
      {
        localObject = new aczh(((JSONArray)localObject).getJSONObject(0));
        if (localObject != null)
        {
          int j = ((aczh)localObject).a();
          int k = paramaczh.a();
          if (j >= k) {}
        }
        else
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(paramString))
        {
          ...
          localObject3 = new aczh((JSONObject)localObject2).a();
