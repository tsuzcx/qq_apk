  ...
  extends apvv
{
  ...
  public apwg(MessageRecord paramMessageRecord)
  {
  ...
  public int a(List<apvv> paramList)
  {
    ...
    {
      apvv localapvv = (apvv)localIterator.next();
      if ((localapvv instanceof apwg))
      {
        MessageRecord localMessageRecord = ((apwg)localapvv).jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
        if (localMessageRecord.uniseq == this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq) {
          if (((localMessageRecord instanceof MessageForPic)) && ((this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForPic)) && (((MessageForPic)localMessageRecord).md5 != null))
          {
            if (((MessageForPic)localMessageRecord).md5.equals(((MessageForPic)this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).md5)) {
              return paramList.indexOf(localapvv);
            }
          }
          else {
            return paramList.indexOf(localapvv);
  ...
  {
    apwd localapwd = new apwd(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
    paramContext = apvx.a(paramContext, localapwd);
    this.jdField_a_of_type_Boolean = localapwd.c;
    return paramContext;
  }
  ...
  public appw a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForMarketFace)) {
      return apvx.a((MessageForMarketFace)this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
    }
    return null;
  }
  ...
  public boolean a(apvv paramapvv)
  {
    ...
    if ((paramapvv instanceof apwg))
    {
      ...
      if (paramapvv != null)
      {
        ...
        {
          bool1 = bool2;
          if (paramapvv.shmsgseq == this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.shmsgseq)
          {
            bool1 = bool2;
            if (paramapvv.msgUid == this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.msgUid) {
              bool1 = true;
            }
          }
        }
  ...
  public apvv b(Bundle paramBundle)
  {
    if (paramBundle.containsKey("cur_msg_uniseq"))
    {
      ...
      if ((paramBundle instanceof QQAppInterface)) {
        return new apwg(((QQAppInterface)paramBundle).a().b(str, i, l));
      }
    }
    return null;
  }
