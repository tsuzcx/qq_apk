...
public class apwg
  extends apvx
{
  private static apwh jdField_a_of_type_Apwh;
  public static final ArrayList<WeakReference<apwg>> a;
  private static String e = "";
  protected SongInfo a;
  private WeakReference<apwg> jdField_a_of_type_JavaLangRefWeakReference;
  protected long b = 0L;
  protected String d;
  ...
  public apwg(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    jdField_a_of_type_Apwh = new apwh(this.jdField_a_of_type_JavaLangString);
  ...
  {
    QQPlayerService.c(jdField_a_of_type_Apwh);
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    if (paramString.equals("SetCallback"))
    {
      ...
      QQPlayerService.b(jdField_a_of_type_Apwh);
      QQPlayerService.a(null);
      return true;
    }
