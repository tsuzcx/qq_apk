...
public abstract class ahum
  extends Binder
  implements ahul, IBinder.DeathRecipient
{
  public ahuo a;
  ...
  public static ahul a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof ahul))) {
      return (ahul)localIInterface;
    }
    return new ahun(paramIBinder);
  }
  ...
  public void a(ahuo paramahuo)
  {
    try
    {
      paramahuo.asBinder().linkToDeath(this, 0);
      this.a = paramahuo;
      return;
    }
    catch (RemoteException paramahuo)
    {
      binderDied();
    }
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    case 5: 
      ...
      return true;
      paramParcel1.enforceInterface("com.tencent.mobileqq.activity.aio.photo.IAIOImageProvider");
      a(ahup.a(paramParcel1.readStrongBinder()));
      paramParcel2.writeNoException();
      return true;
      paramParcel1.enforceInterface("com.tencent.mobileqq.activity.aio.photo.IAIOImageProvider");
