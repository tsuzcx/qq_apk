...
public class zlp
{
  ...
  private ShareActionSheet.OnItemClickListener jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet$OnItemClickListener = new zlt(this);
  ...
  private zlm jdField_a_of_type_Zlm;
  ...
  public zlp(Activity paramActivity)
  {
  ...
  {
    if ((this.jdField_a_of_type_Zda != null) && (this.jdField_a_of_type_Zda.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo != null)) {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Zda.jdField_a_of_type_Int == 1) {
        return new SubScribePersonalSharedCardView(this.jdField_a_of_type_AndroidAppActivity);
      }
      if (this.jdField_a_of_type_Zda.jdField_a_of_type_Int == 3) {
        return new SubscribeVideoSharedCardView(this.jdField_a_of_type_AndroidAppActivity);
      }
    } while (this.jdField_a_of_type_Zda.jdField_a_of_type_Int != 4);
    return new SubscribeMultiPicSharedCardView(this.jdField_a_of_type_AndroidAppActivity);
  }
  ...
  private String a(android.content.Context paramContext, String paramString)
  {
    ...
    //   8: astore_3
    //   9: aload_3
    //   10: invokevirtual 148	java/io/File:exists	()Z
    //   13: ifne +7 -> 20
    //   16: aconst_null
    //   17: astore_2
    //   18: aload_2
    ...
    //   21: ldc 150
    //   23: aload_3
    //   24: invokestatic 156	android/support/v4/content/FileProvider:getUriForFile	(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;)Landroid/net/Uri;
    //   27: astore_3
    //   28: aload_1
    //   29: ldc 158
    //   31: aload_3
    //   32: iconst_1
    //   33: invokevirtual 164	android/content/Context:grantUriPermission	(Ljava/lang/String;Landroid/net/Uri;I)V
    //   36: aload_3
    //   37: ifnull -19 -> 18
    //   40: aload_3
    //   41: invokevirtual 167	android/net/Uri:toString	()Ljava/lang/String;
    //   44: areturn
    //   45: astore_1
    //   46: aconst_null
    //   47: astore_3
    //   48: ldc 169
    //   50: aload_1
    //   51: invokevirtual 172	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   54: invokestatic 178	xvv:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   57: aload_1
    //   58: invokevirtual 181	java/lang/Exception:printStackTrace	()V
    //   61: goto -25 -> 36
    //   64: astore_1
    //   65: goto -17 -> 48
  ...
  private String a(String paramString)
  {
    ...
    if ((this.jdField_a_of_type_Zda != null) && (this.jdField_a_of_type_Zda.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo != null) && (this.jdField_a_of_type_Zda.a() != null))
    {
      switch (this.jdField_a_of_type_Zda.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo.pageType)
      {
      case 7003: 
      ...
      case 7000: 
      case 7001: 
        localStringBuilder = new StringBuilder().append(paramString).append(((CertifiedAccountMeta.StFeed)this.jdField_a_of_type_Zda.a().get()).id.get());
        if (bool) {}
        for (paramString = Long.valueOf(System.currentTimeMillis());; paramString = "") {
          return paramString + ".png";
        }
      }
      StringBuilder localStringBuilder = new StringBuilder().append(paramString).append(bhzn.a(this.jdField_a_of_type_Zda.a().poster.id.get()));
      if (bool) {}
      for (paramString = Long.valueOf(System.currentTimeMillis());; paramString = "") {
        return paramString + ".png";
      }
  ...
  private void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_AndroidAppActivity != null)
    {
      ...
      if (this.jdField_a_of_type_Zlm == null) {
        this.jdField_a_of_type_Zlm = new zlm(this.jdField_a_of_type_AndroidAppActivity, "卡片生成中...");
      }
      if ((!this.jdField_a_of_type_Zlm.isShowing()) && (!this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
        this.jdField_a_of_type_Zlm.show();
      }
    }
    label64:
    while ((this.jdField_a_of_type_Zlm == null) || (!this.jdField_a_of_type_Zlm.isShowing()) || (this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
      return;
    }
    this.jdField_a_of_type_Zlm.dismiss();
  }
  ...
  {
    Object localObject2 = "";
    CertifiedAccountRead.StGetMainPageRsp localStGetMainPageRsp = zbc.a();
  ...
  private String c()
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_Zda.h())) {
      try
      {
        Object localObject = new StringBuilder("https://h5.qzone.qq.com/subscription/jump?_wv=3&_proxy=1&schema=");
        ((StringBuilder)localObject).append(URLEncoder.encode(zlv.a(this.jdField_a_of_type_Zda.a()), "UTF-8"));
    ...
    return this.jdField_a_of_type_Zda.h();
  }
  ...
  private boolean c()
  {
    return (WXShareHelper.getInstance().getApi() != null) && (WXShareHelper.getInstance().getApi().getWXAppSupportAPI() >= 654314752);
  }
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWxapiWXShareHelper$WXShareListener = new zlu(this);
  ...
  public void a(zda paramzda)
  {
    ...
    for (boolean bool = PermissionUtils.isStorePermissionEnable(this.jdField_a_of_type_AndroidAppActivity);; bool = true)
    {
      ...
      if ((paramzda == null) || (!NetworkUtil.isNetworkAvailable(this.jdField_a_of_type_AndroidAppActivity)))
      {
        QQToast.a(this.jdField_a_of_type_AndroidAppActivity, 1, 2131716373, 1).a();
