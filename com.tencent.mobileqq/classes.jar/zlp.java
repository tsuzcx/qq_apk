...
class zlp
  implements Runnable
{
  zlp(zlo paramzlo, TroopMemberInfo paramTroopMemberInfo) {}
  
  public void run()
  {
    Object localObject = (List)this.jdField_a_of_type_Zlo.jdField_a_of_type_ComTencentMobileqqAppTroopManager.b.remove(this.jdField_a_of_type_Zlo.jdField_a_of_type_JavaLangString + "_" + this.jdField_a_of_type_Zlo.b);
