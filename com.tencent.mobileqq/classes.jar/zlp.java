...
public class zlp
{
  public static int a(int paramInt)
  {
    ...
    if (localObject == null)
    {
      yqp.c("Q.qqstory.tag.RedPointUtils", "getStoryRedPointByAppId() error, app is null", new Throwable());
      return 0;
    }
    localObject = ((njg)((QQAppInterface)localObject).getManager(70)).a(paramInt);
    if (localObject == null)
    {
      yqp.a("Q.qqstory.tag.RedPointUtils", "getStoryRedPointByAppId(%d) info is null", Integer.valueOf(paramInt));
      return 0;
    }
    yqp.a("Q.qqstory.tag.RedPointUtils", "getStoryRedPointByAppId(%d) info is %s", Integer.valueOf(paramInt), zlb.a((MessageMicro)localObject));
  ...
  {
    return ((wsm)paramQQAppInterface.getManager(252)).a;
  }
