  ...
  implements Manager
{
  ...
  public ajyd(QQAppInterface paramQQAppInterface)
  {
  ...
  private HotChatItemData a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localObject2 == null)
    {
      ...
      if (localObject2 != null)
      {
        ...
        {
          ApolloGameData localApolloGameData = ((ajmu)paramQQAppInterface.getManager(155)).a(((HotChatInfo)localObject2).name);
  ...
  private void b(String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      paramString = ((aktf)localObject).b(paramString, paramInt);
    } while ((paramString == null) || (paramString.shouldShowInRecentList()));
    ((aktf)localObject).b(paramString);
  }
  ...
  private void d()
  {
    ...
    do
    {
      ...
      try
      {
        localaktf = localQQAppInterface.a().a();
        localObject2 = localaktf.a(false);
  ...
  private void d(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = ((ajmu)((QQAppInterface)localObject).getManager(155)).a(localHotChatItemData.mHotChatCode);
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentSharedPreferences != null)
      {
        localObject1 = bbkc.a(this.jdField_a_of_type_AndroidContentSharedPreferences, "hotchat_new_unread_list", null);
  ...
  private void f()
  {
    ...
    for (;;)
    {
      ...
      Collections.sort((List)localObject2, new ajye(this));
      Collections.sort((List)localObject1, new ajyf(this));
  ...
  private void g()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 45	ajyd:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   4: invokevirtual 254	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   7: ifne +4 -> 11
    //   10: return
    //   11: aload_0
    //   12: invokevirtual 326	ajyd:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   15: astore_3
    //   16: aload_3
    //   17: ifnull -7 -> 10
    //   20: aload_3
    ...
    //   29: astore 4
    //   31: aload_0
    //   32: getfield 45	ajyd:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   35: invokevirtual 254	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   38: istore_1
    //   39: aconst_null
    //   40: astore_2
    //   41: aload_3
    //   42: invokevirtual 472	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Laukq;
    //   45: invokevirtual 478	aukq:createEntityManager	()Laukp;
    //   48: astore_3
    //   49: aload_3
    //   50: astore_2
    //   51: iload_1
    ...
    //   56: iflt +107 -> 163
    //   59: aload_0
    //   60: getfield 45	ajyd:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   63: iload_1
    ...
    //   76: invokespecial 480	ajyd:d	(Ljava/lang/String;)V
    //   79: aload 4
    //   81: aload_3
    ...
    //   127: aload_0
    //   128: getfield 56	ajyd:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   131: aload_3
    //   132: getfield 119	com/tencent/mobileqq/data/HotChatItemData:mTroopUin	Ljava/lang/String;
    //   135: invokeinterface 487 2 0
    //   140: pop
    //   141: aload_0
    //   142: getfield 45	ajyd:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   145: iload_1
    //   146: invokevirtual 489	java/util/concurrent/CopyOnWriteArrayList:remove	(I)Ljava/lang/Object;
    //   149: pop
    //   150: aload_2
    //   151: aload_3
    //   152: invokevirtual 494	aukp:b	(Lauko;)Z
    //   155: pop
    //   156: iload_1
    //   157: iconst_1
    //   158: isub
    ...
    //   164: ifnull -154 -> 10
    //   167: aload_2
    //   168: invokevirtual 496	aukp:a	()V
    //   171: return
    //   172: astore_3
    //   173: ldc 25
    //   175: iconst_1
    ...
    //   185: ifnull -175 -> 10
    //   188: aload_2
    //   189: invokevirtual 496	aukp:a	()V
    //   192: return
    //   193: astore_3
    //   194: aconst_null
    //   195: astore_2
    ...
    //   197: ifnull +7 -> 204
    //   200: aload_2
    //   201: invokevirtual 496	aukp:a	()V
    //   204: aload_3
    //   205: athrow
    //   206: astore_3
    //   207: goto -11 -> 196
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    while ((!TextUtils.isEmpty(paramMessageRecord.frienduin)) && (anml.b((QQAppInterface)localObject, paramMessageRecord.frienduin))) {
      return;
    }
    for (;;)
    {
  ...
  public boolean a(long paramLong)
  {
    ...
    Object localObject3;
    int i;
    if (!((aktf)localObject1).a(ajsd.aK, 5001))
    {
    ...
    Object localObject2 = ((aktf)localObject1).a(ajsd.aK, 5001);
    ((RecentUser)localObject2).uin = ajsd.aK;
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        ((bbrd)localQQAppInterface.a(71)).a(localHotChatItemData.mGameId, "android.aio", false, 2, localHotChatItemData.mHotChatCode);
  ...
  public boolean b(String paramString)
  {
    ...
    //   3: istore 4
    //   5: aload_0
    //   6: invokevirtual 326	ajyd:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   9: astore 6
    //   11: aload 6
    //   13: ifnull +10 -> 23
    //   16: aload_1
    ...
    //   28: ireturn
    //   29: aload 6
    //   31: invokevirtual 472	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Laukq;
    //   34: invokevirtual 478	aukq:createEntityManager	()Laukp;
    //   37: astore 5
    //   39: aload_0
    //   40: getfield 56	ajyd:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   43: aload_1
    ...
    //   97: iload_2
    //   98: aload_0
    //   99: getfield 45	ajyd:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   102: invokevirtual 254	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   105: if_icmpge +36 -> 141
    //   108: aload_1
    //   109: aload_0
    //   110: getfield 45	ajyd:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   113: iload_2
    ...
    //   126: ifeq +195 -> 321
    //   129: aload_0
    //   130: getfield 45	ajyd:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   133: iload_2
    ...
    //   151: aload 5
    //   153: aload 7
    //   155: invokespecial 690	com/tencent/mobileqq/app/HotChatCenterManager$2:<init>	(Lajyd;Laukp;Lcom/tencent/mobileqq/data/HotChatItemData;)V
    //   158: bipush 8
    //   160: aconst_null
    //   161: iconst_0
    ...
    //   166: aload_1
    //   167: aload 6
    //   169: invokespecial 692	ajyd:a	(Ljava/lang/String;Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   172: iload 4
    //   174: istore_3
    //   175: aload_0
    //   176: getfield 45	ajyd:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   179: invokevirtual 254	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   182: ifne +39 -> 221
    //   185: iload 4
    //   187: istore_3
    //   188: aload_0
    //   189: getstatic 602	ajsd:aK	Ljava/lang/String;
    //   192: sipush 5001
    //   195: invokespecial 549	ajyd:b	(Ljava/lang/String;I)V
    //   198: iload 4
    //   200: istore_3
    //   201: aload_0
    //   202: invokevirtual 326	ajyd:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   205: ldc 173
    //   207: ldc 175
    //   209: ldc_w 694
    //   212: iconst_1
    ...
    //   223: ifnull +84 -> 307
    //   226: aload 5
    //   228: invokevirtual 496	aukp:a	()V
    //   231: iload 4
    //   233: ireturn
    //   234: astore_1
    //   235: aconst_null
    ...
    //   251: ifnull -225 -> 26
    //   254: aload_1
    //   255: invokevirtual 496	aukp:a	()V
    //   258: iload_3
    //   259: ireturn
    //   260: astore_1
    //   261: aconst_null
    ...
    //   266: ifnull +8 -> 274
    //   269: aload 5
    //   271: invokevirtual 496	aukp:a	()V
    //   274: aload_1
    //   275: athrow
    //   276: astore_1
    //   277: goto -13 -> 264
  ...
  public void c()
  {
    ...
    //   3: astore 4
    //   5: aload_0
    //   6: getfield 45	ajyd:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   50: aload_0
    //   51: invokevirtual 326	ajyd:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   54: astore_2
    //   55: aload_2
    //   56: ifnull -41 -> 15
    //   59: aload_2
    //   60: invokevirtual 472	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Laukq;
    //   63: invokevirtual 478	aukq:createEntityManager	()Laukp;
    //   66: astore_2
    //   67: aload_2
    //   68: ldc 114
    //   70: iconst_0
    ...
    //   75: ldc_w 700
    //   78: aconst_null
    //   79: invokevirtual 703	aukp:a	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   82: astore_1
    //   83: aload_1
    //   84: ifnull +276 -> 360
    //   87: aload_1
    ...
    //   124: astore 4
    //   126: aload_0
    //   127: getfield 45	ajyd:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   130: aload 4
    ...
    //   154: ifnull -139 -> 15
    //   157: aload_2
    //   158: invokevirtual 496	aukp:a	()V
    //   161: return
    //   162: aload_0
    //   163: invokespecial 683	ajyd:f	()V
    //   166: aload_0
    //   167: getfield 56	ajyd:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   198: astore_3
    //   199: aload_0
    //   200: getfield 56	ajyd:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   203: aload_3
    ...
    //   223: ifnull +7 -> 230
    //   226: aload_3
    //   227: invokevirtual 496	aukp:a	()V
    //   230: aload_2
    //   231: athrow
    //   232: aload_0
    //   233: invokespecial 707	ajyd:g	()V
    ...
    //   258: aload_0
    //   259: getfield 45	ajyd:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   274: aload_0
    //   275: getfield 45	ajyd:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   361: ifnull -346 -> 15
    //   364: aload_2
    //   365: invokevirtual 496	aukp:a	()V
    //   368: return
    //   369: astore_2
    //   370: aload_1
    //   371: astore_3
