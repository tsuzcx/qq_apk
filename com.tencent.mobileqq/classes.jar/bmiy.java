...
public class bmiy
{
  ...
  public static bmiz a(String paramString)
  {
    int i = 0;
    if (paramString == null) {}
    bmiz localbmiz;
    ...
    for (;;)
    {
      localbmiz.a = paramString.getString("k=");
      localbmiz.b = d(paramString.getString("u="));
      localObject = b(paramString.getString("n="));
      if (localObject != null)
      {
        localbmiz.c = URLDecoder.decode((String)localObject, "UTF-8");
        if (localbmiz.c != null) {}
      }
      for (localbmiz.c = localbmiz.b;; localbmiz.c = localbmiz.b)
      {
        localbmiz.d = paramString.getString("o=");
        localbmiz.e = paramString.getString("p=");
        localbmiz.f = paramString.getString("d=");
        if ((localbmiz.a == null) || (localbmiz.b == null) || (localbmiz.d == null)) {
          break;
        }
        return localbmiz;
      }
