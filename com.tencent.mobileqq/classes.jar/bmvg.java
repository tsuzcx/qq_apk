  ...
  extends DynamicTextItem
{
  ...
  public bmvg(int paramInt, List<String> paramList, Typeface paramTypeface, Bitmap paramBitmap)
  {
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    int j = (int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(amtj.a(2131700365));
    this.jdField_a_of_type_AndroidTextStaticLayout = bmwz.a(paramString, 0, paramString.length(), this.jdField_a_of_type_AndroidTextTextPaint, j, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, 3);
    ...
    xvv.b("BubbleTextItem", "set text " + paramString + " max " + j + " tw " + f1 + " th " + f2);
  }
