  ...
  extends QIPCModule
{
  ...
  private amyu jdField_a_of_type_Amyu = new amyu();
  ...
  public amwf(String paramString)
  {
    super(paramString);
  }
  
  public static amwf a()
  {
    return amwm.a();
  }
  ...
  public static void b()
  {
    ...
    {
      QIPCServerHelper.getInstance().register(localamwf);
  ...
  public int a()
  {
    if (this.jdField_a_of_type_Amyu != null) {
      return this.jdField_a_of_type_Amyu.a();
    }
  ...
  {
    if (this.jdField_a_of_type_Amyu != null) {
      return this.jdField_a_of_type_Amyu.a(paramInt);
    }
    return null;
  }
  ...
  public amyu a()
  {
    return this.jdField_a_of_type_Amyu;
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Amyu != null)
    {
      List localList = this.jdField_a_of_type_Amyu.a();
      if (localList != null)
      {
        int i = 0;
        while (i < localList.size())
        {
          amyt localamyt = (amyt)localList.get(i);
          if ((localamyt != null) && (!amwn.a(localamyt.a())) && (!amwn.a(localamyt.a())))
          {
            amwd.a(localamyt.a());
            QLog.i("cmgame_process.CmGameServerQIPCModule", 1, "closeAllGame gameId:" + localamyt.a());
          }
          i += 1;
        }
      }
  ...
  public void a(CmGameStartChecker.StartCheckParam paramStartCheckParam, long paramLong, CmGameInitParams paramCmGameInitParams)
  {
    ...
    this.c = true;
    if ((this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) && (amwn.a(BaseApplicationImpl.getContext())))
    {
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    for (int i = paramArrayList.size();; i = 0)
    {
      ...
      QIPCServerHelper.getInstance().callClient(LocalMultiProcConfig.PROCESS_NAME, "cm_game_client_module", "action_dress_changed", (Bundle)localObject, new amwl(this));
      return;
    }
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    try
    {
      if ("action_aduio_query_voice_status".equals(paramString))
      {
        ...
        paramBundle = (amme)((QQAppInterface)localObject1).getManager(QQManagerFactory.APOLLO_MANAGER);
        localObject1 = new Bundle();
        ((Bundle)localObject1).putBoolean("isOpen", paramBundle.a().a(paramString));
        ((Bundle)localObject1).putBoolean("display", amtm.b);
      ...
      {
        paramString = paramBundle.getString("key_game_friUin");
        ((amme)((QQAppInterface)localObject1).getManager(QQManagerFactory.APOLLO_MANAGER)).a().c(paramString, 318);
      }
    }
    ...
    if ("action_aduio_enter_room".equals(paramString))
    {
      ...
      paramBundle = ((amme)((QQAppInterface)localObject1).getManager(QQManagerFactory.APOLLO_MANAGER)).a();
      if ((bool) || ((amtm.jdField_a_of_type_Boolean) && (!paramBundle.b()))) {
    ...
    {
      paramString = paramBundle.getString("key_game_friUin");
      ((amme)((QQAppInterface)localObject1).getManager(QQManagerFactory.APOLLO_MANAGER)).a().a(paramString, 318);
    }
    ...
    else if ("action_loadyoutu".equals(paramString))
    {
      ...
      if ((paramString != null) && ((paramString instanceof QQAppInterface)))
      {
        ...
        break label2287;
        paramString = new oxd(paramString, BaseApplicationImpl.getContext());
        b = true;
        paramString.a(new amwg(this, paramInt));
        paramString.a();
        break label2285;
      }
    }
    else
    {
      ...
      if ("game_activity_lifecycle".equals(paramString))
      {
        ...
        if ((paramString != null) && ((paramString instanceof CmGameStartChecker.StartCheckParam)))
        {
          ...
          this.jdField_a_of_type_Amyu.a(paramInt, i, j, paramString);
          break label2285;
        }
      }
    ...
    while (paramString != null)
    {
      ...
      if ("action_update_game_push".equals(paramString))
      {
        ...
        paramString = (QQAppInterface)amwn.a();
        if (paramString == null) {
          return null;
        }
        paramBundle = (CmGamePushItem)paramBundle.getSerializable("CmGamePushItem");
        if (paramBundle != null) {
          ((amme)paramString.getManager(QQManagerFactory.APOLLO_MANAGER)).a().a(paramBundle);
        }
      }
      ...
      {
        if ((localObject1 instanceof QQAppInterface)) {
          anhm.a((QQAppInterface)localObject1);
        }
        paramString = new Bundle();
        paramString.putString("sApolloBaseScriptId", anka.H);
        paramString.putBoolean("sDisableCreateRenderThread", amme.q);
        paramString.putBoolean("sApolloEngineLockEnable", amme.r);
      ...
      else
      {
        ...
        if ("action_init_cmshow_data".equals(paramString))
        {
          ...
          if ((localObject1 instanceof QQAppInterface))
          {
            Object localObject3 = (amme)((QQAppInterface)localObject1).getManager(QQManagerFactory.APOLLO_MANAGER);
            localObject1 = (VasExtensionHandler)((QQAppInterface)localObject1).getBusinessHandler(BusinessHandlerFactory.VAS_EXTENSION_HANDLER);
            localObject2 = ((amme)localObject3).b(paramString);
            ApolloBaseInfo localApolloBaseInfo = ((amme)localObject3).b(paramBundle);
            ...
            if (!((List)localObject3).isEmpty())
            {
              ...
              ((VasExtensionHandler)localObject1).a(new amwh(this, (List)localObject3, paramString, paramBundle, paramInt));
              ((VasExtensionHandler)localObject1).a((String[])localObject2);
            }
            else
            {
              i = amme.a(ApolloUtil.a(), paramString, true);
              j = amme.a(ApolloUtil.a(), paramBundle, true);
              paramString = new Bundle();
        ...
        else if ("action_render_view_preload_res".equals(paramString))
        {
          ...
          else
          {
            ...
            {
              localObject1 = anck.a(ApolloUtil.a(), paramString[i]);
              localObject2 = new anff(3, paramString[i]);
              if (localObject1 != null) {
                ((anff)localObject2).c = ((ApolloActionData)localObject1).actionType;
              }
              paramBundle.add(localObject2);
              i += 1;
            }
            anex.a(ApolloUtil.a(), "", new amwj(this, paramInt), paramBundle, false);
          }
        }
        else if ("action_cmshow_tracereport".equals(paramString))
        {
          anjb.a(paramBundle.getString("action"), paramBundle.getBundle("bundle"));
        }
        else
        {
          ...
          if ("action_render_view_change_mode".equals(paramString))
          {
            ...
            paramString = (VasExtensionHandler)((QQAppInterface)localObject1).getBusinessHandler(BusinessHandlerFactory.VAS_EXTENSION_HANDLER);
            if (i == 2) {}
            for (i = 1;; i = 0)
            {
              paramString.a("cmshow_sdk", i, new amwk(this, paramInt));
              break;
            }
            paramString = null;
            continue;
