...
public final class bhky
{
  ...
  private final List<bhlc> jdField_b_of_type_JavaUtilList = new ArrayList();
  private int jdField_c_of_type_Int = -1;
  private final List<bhkz> jdField_c_of_type_JavaUtilList = new ArrayList();
  
  public bhky(@NonNull Bitmap paramBitmap)
  {
    if ((paramBitmap == null) || (paramBitmap.isRecycled())) {
      throw new IllegalArgumentException("Bitmap is not valid");
    }
    this.jdField_c_of_type_JavaUtilList.add(bhkw.a);
    this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
    this.jdField_a_of_type_JavaUtilList = null;
    this.jdField_b_of_type_JavaUtilList.add(bhlc.a);
    this.jdField_b_of_type_JavaUtilList.add(bhlc.b);
    this.jdField_b_of_type_JavaUtilList.add(bhlc.c);
    this.jdField_b_of_type_JavaUtilList.add(bhlc.d);
    this.jdField_b_of_type_JavaUtilList.add(bhlc.e);
    this.jdField_b_of_type_JavaUtilList.add(bhlc.f);
  }
  ...
  public bhkw a()
  {
    ...
    if (this.jdField_a_of_type_AndroidGraphicsBitmap != null)
    {
      ...
      {
        localObject = null;
        localObject = new bhkr(arrayOfInt, i, (bhkz[])localObject);
        if (localBitmap != this.jdField_a_of_type_AndroidGraphicsBitmap) {
          localBitmap.recycle();
        }
        localObject = ((bhkr)localObject).a();
        if (0 != 0) {
          throw new NullPointerException();
        }
      }
    ...
    for (;;)
    {
      localObject = new bhkw((List)localObject, this.jdField_b_of_type_JavaUtilList);
      ((bhkw)localObject).a();
      if (0 != 0) {
        throw new NullPointerException();
      }
      return localObject;
      localObject = (bhkz[])this.jdField_c_of_type_JavaUtilList.toArray(new bhkz[this.jdField_c_of_type_JavaUtilList.size()]);
      break;
