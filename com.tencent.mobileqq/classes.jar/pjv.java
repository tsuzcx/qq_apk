...
public class pjv
  implements Handler.Callback, bcty, Manager
{
  ...
  public pjv(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (bgsg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))
    {
