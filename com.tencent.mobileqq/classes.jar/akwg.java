...
public class akwg
{
  ...
  private HashMap<Integer, akwi> jdField_a_of_type_JavaUtilHashMap;
  
  public akwg(int paramInt)
  {
  ...
  private int a()
  {
    for (;;)
    {
      try
      {
        ...
        if ((localObject == null) || (((akyg)localObject).a() == null)) {
          break label105;
        }
        i = ((akyg)localObject).a().getMeasuredHeight();
        if (i == 0)
        {
          localObject = a();
          if (localObject != null)
          {
            localObject = (FrameLayout)((Activity)localObject).findViewById(2131367069);
            if (localObject != null)
            {
  ...
  private void a(long paramLong, int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      akwd.a().callbackFromRequest(paramLong, paramInt2, "sc.game_ad_banner_load.local", localJSONObject.toString());
      return;
    }
    catch (Throwable localThrowable)
    {
