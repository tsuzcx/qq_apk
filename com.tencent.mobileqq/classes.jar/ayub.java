...
{
  public ayub(aysx paramaysx, aymg paramaymg)
  {
  ...
  {
    return new ayuc(paramContext, 2130845617, 2);
  }
  ...
  private List<String> a(Card paramCard)
  {
    ...
    if (paramCard != null)
    {
      a(localArrayList, (aymg)this.b, localResources);
      b(localArrayList, (aymg)this.b, localResources);
      c(localArrayList, (aymg)this.b, localResources);
      d(localArrayList, (aymg)this.b, localResources);
      e(localArrayList, (aymg)this.b, localResources);
      f(localArrayList, (aymg)this.b, localResources);
      g(localArrayList, (aymg)this.b, localResources);
      h(localArrayList, (aymg)this.b, localResources);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(List<String> paramList, aymg paramaymg, Resources paramResources)
  {
    Object localObject = null;
    int i = ayue.a(paramaymg);
    String str;
    if (i == 0) {
      str = paramResources.getString(2131693568);
    }
    for (;;)
    {
      i = ayue.b(paramaymg);
      paramaymg = localObject;
      if (i > 0) {
        paramaymg = i + paramResources.getString(2131718743);
      }
      if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty(paramaymg))) {
        paramList.add(str + " " + paramaymg);
      }
      do
      {
        return;
        ...
        str = paramResources.getString(2131692108);
        break;
  ...
  private boolean a(Card paramCard, boolean paramBoolean)
  {
    ...
    {
      i = 1;
      paramBoolean = ProfileActivity.AllInOne.a(((aymg)this.b).jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne);
      if (((List)localObject).isEmpty()) {
        break label171;
      }
      j = 1;
      label58:
      if ((!aytq.a((aymg)this.b)) || (paramCard == null) || ((i == 0) && ((!paramBoolean) || (j == 0)))) {
        break label352;
      }
    }
    label171:
    ...
    {
      boolean bool3 = this.jdField_a_of_type_Bhha.a(12);
      if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_JavaLangObject == null)
      {
        this.jdField_a_of_type_JavaLangObject = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getLayoutInflater().inflate(2131561329, null);
        ((View)this.jdField_a_of_type_JavaLangObject).setOnClickListener(this);
        paramBoolean = true;
      }
      paramCard = (TextView)((View)this.jdField_a_of_type_JavaLangObject).findViewById(2131378367);
      ImageView localImageView = (ImageView)((View)this.jdField_a_of_type_JavaLangObject).findViewById(2131362968);
      if (paramCard != null)
      {
        if ((i == 0) || (j != 0)) {
          break label314;
        }
        paramCard.setText(2131698449);
        localObject = new aykg(81, null);
  ...
  private void b(List<String> paramList, aymg paramaymg, Resources paramResources)
  {
    Object localObject = null;
    String str = ayue.a(paramaymg);
    long l = ayue.a(paramaymg);
    paramaymg = localObject;
    if (l > 0L)
    {
      ...
      if (i > 0)
      {
        ...
        if (j > 0)
        {
          paramaymg = new StringBuilder();
          paramaymg.append(i);
          paramaymg.append(paramResources.getString(2131693843));
          paramaymg.append(j);
          paramaymg.append(paramResources.getString(2131691333));
          paramaymg = paramaymg.toString();
        }
      }
    }
    if ((!TextUtils.isEmpty(paramaymg)) && (!TextUtils.isEmpty(str))) {
      paramList.add(paramaymg + " " + str);
    }
    do
    {
      return;
  ...
  private void c(List<String> paramList, aymg paramaymg, Resources paramResources)
  {
    paramaymg = ayue.b(paramaymg);
    if (!TextUtils.isEmpty(paramaymg)) {
      paramList.add(paramaymg);
    }
  }
  
  private void d(List<String> paramList, aymg paramaymg, Resources paramResources)
  {
    String str = ayue.d(paramaymg);
    paramaymg = ayue.e(paramaymg);
    if ((!TextUtils.isEmpty(str)) || (!TextUtils.isEmpty(paramaymg)))
    {
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append(paramResources.getString(2131698448));
      if (!TextUtils.isEmpty(str)) {
        localStringBuilder.append(str);
      }
      if (!TextUtils.isEmpty(paramaymg)) {
        localStringBuilder.append(paramaymg);
      }
      paramList.add(localStringBuilder.toString());
    }
  }
  
  private void e(List<String> paramList, aymg paramaymg, Resources paramResources)
  {
    String str = ayue.g(paramaymg);
    paramaymg = ayue.h(paramaymg);
    if ((!TextUtils.isEmpty(str)) || (!TextUtils.isEmpty(paramaymg)))
    {
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append(paramResources.getString(2131698447));
      if (!TextUtils.isEmpty(str)) {
        localStringBuilder.append(str);
      }
      if (!TextUtils.isEmpty(paramaymg)) {
  ...
  private void f(List<String> paramList, aymg paramaymg, Resources paramResources)
  {
    paramaymg = ayue.i(paramaymg);
    if (!TextUtils.isEmpty(paramaymg)) {
      paramList.add(paramaymg);
    }
  }
  
  private void g(List<String> paramList, aymg paramaymg, Resources paramResources)
  {
    paramaymg = ayue.j(paramaymg);
    if (!TextUtils.isEmpty(paramaymg)) {
      paramList.add(paramaymg);
    }
  }
  
  private void h(List<String> paramList, aymg paramaymg, Resources paramResources)
  {
    paramaymg = ayue.k(paramaymg);
    if (!TextUtils.isEmpty(paramaymg)) {
      paramList.add(paramaymg);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        return;
        aytq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (aymg)this.b);
      }
    ...
    for (int i = j;; i = 3)
    {
      ayud.a((QQAppInterface)localObject, i);
      break;
      i = 0;
      break label130;
    }
