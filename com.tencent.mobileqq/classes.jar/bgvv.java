...
public final class bgvv
{
  ...
  public bgvv(@ColorInt int paramInt1, int paramInt2)
  {
  ...
  private void a()
  {
    ...
    {
      i = bgvp.a(-1, this.d, 4.5F);
      j = bgvp.a(-1, this.d, 3.0F);
      if ((i != -1) && (j != -1))
      {
        this.g = bgvp.b(-1, i);
        this.f = bgvp.b(-1, j);
    ...
    int m = bgvp.a(-16777216, this.d, 4.5F);
    int k = bgvp.a(-16777216, this.d, 3.0F);
    if ((m != -1) && (k != -1))
    {
      this.g = bgvp.b(-16777216, m);
      this.f = bgvp.b(-16777216, k);
      this.jdField_a_of_type_Boolean = true;
      return;
    }
    if (i != -1)
    ...
    label175:
    for (int i = bgvp.b(-1, j);; i = bgvp.b(-16777216, k))
    {
      this.f = i;
      this.jdField_a_of_type_Boolean = true;
      return;
  ...
  public float[] a()
  {
    ...
    bgvp.a(this.jdField_a_of_type_Int, this.b, this.c, this.jdField_a_of_type_ArrayOfFloat);
