  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_Akos != null) {
        this.a.jdField_a_of_type_Akos.a(2);
      }
      ...
      if (akwv.a(ahwl.jdField_a_of_type_Long, l))
      {
        ...
        {
          ((aklj)localObject2).a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 2);
        ...
        else
        {
          if (this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1)
          {
            ...
            {
              ((aklj)localObject2).b(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 2);
              if (!QLog.isColorLevel()) {
                continue;
              }
          ...
          if ((localObject3 != null) && ((((akli)localObject3).jdField_a_of_type_Boolean) || (((akli)localObject3).b) || (((akli)localObject3).c) || (((akli)localObject3).jdField_a_of_type_Long < l)))
          {
            ...
            ((aklj)localObject2).a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (akli)localObject3, l, 65536, (String)localObject1, localMessageForQQWalletMsg.mQQWalletRedPacketMsg.elem.skinId, localMessageForQQWalletMsg.fromHBList, null);
            if (QLog.isColorLevel()) {
          ...
          else
          {
            ...
            aevv.a(paramView.getContext(), (Intent)localObject2, PublicTransFragmentActivity.class, RedPacketVoiceFragment.class);
            if (QLog.isColorLevel()) {
