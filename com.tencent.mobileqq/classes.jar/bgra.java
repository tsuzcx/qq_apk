  ...
  extends bgqy
{
  ...
  public bgra(bgqv parambgqv, int paramInt)
  {
    super(parambgqv, paramInt);
    this.jdField_b_of_type_ComTencentMobileqqHighwayApiITransactionCallback = new bgrb(this);
  }
  
  public void a()
  {
    String str1 = this.jdField_a_of_type_Bgqv.jdField_b_of_type_JavaLangString;
    String str2 = this.jdField_a_of_type_Bgqv.jdField_a_of_type_JavaLangString;
  ...
  protected boolean b(String paramString)
  {
    ...
    if (localQQAppInterface != null)
    {
      ...
      arrayOfByte = apiu.a(paramString);
    ...
    do
    {
      ...
      localPttShortVideoFileInfo.uint32_file_time.set((int)this.jdField_a_of_type_Bgqv.jdField_a_of_type_Long);
