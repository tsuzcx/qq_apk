  ...
  implements Manager
{
  ...
  public long a;
  private ayhb jdField_a_of_type_Ayhb;
  private ayhh jdField_a_of_type_Ayhh;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private List<MessageRecord> jdField_a_of_type_JavaUtilList = new ArrayList();
  
  public ayhj(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Ayhh = new ayhh(paramQQAppInterface);
  }
  
  private void a(DataLineMsgRecord paramDataLineMsgRecord, String paramString1, String paramString2, String paramString3, anbt paramanbt)
  {
    if (!this.jdField_a_of_type_Ayhh.a())
    {
    ...
    this.jdField_a_of_type_Ayhh.a(paramDataLineMsgRecord);
    new Handler(ThreadManager.getSubThreadLooper()).postDelayed(new DataLineMessageSpreadManager.2(this, paramDataLineMsgRecord, paramString1, paramanbt, paramString2, paramString3), 1000L);
  }
  
  private boolean a(DataLineMsgRecord paramDataLineMsgRecord)
  {
    int i = this.jdField_a_of_type_Ayhh.a();
    int j = anbu.a().a();
    if (j == 0) {
      if (QLog.isColorLevel()) {
  ...
  {
    this.jdField_a_of_type_Ayhh.a(paramanbr);
  }
  ...
  public void a(DataLineMsgRecord paramDataLineMsgRecord, Context paramContext)
  {
    ...
    catch (Exception paramDataLineMsgRecord)
    {
      ...
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80098F8", "0X80098F8", 0, 0, "", "", "", "");
      ...
      ayee.a(paramDataLineMsgRecord, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 6, i);
    }
  }
  ...
  public void a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    {
      QLog.e("DataLineMessageSpreadManager", 1, apug.a());
      return;
    }
    if (QLog.isColorLevel()) {
