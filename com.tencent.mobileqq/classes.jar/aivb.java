  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.share.ForwardSdkShareProcessor", 2, "UrlExchangeStep|run,retry=" + aiva.a(this.a));
    }
    ...
    if ((!ForwardSdkShareProcessor.b(this.a.jdField_b_of_type_ComTencentMobileqqTransfileForwardSdkShareProcessor).get()) && (TextUtils.isEmpty(ForwardSdkShareProcessor.a(this.a.jdField_b_of_type_ComTencentMobileqqTransfileForwardSdkShareProcessor))))
    {
      ...
      aiva.b(this.a).set(((Bundle)localObject).getInt("retcode", -1));
      if (QLog.isColorLevel()) {
        QLog.d("Q.share.ForwardSdkShareProcessor", 2, "UrlExchangeStep|run,suc=" + bool + ",ret=" + aiva.b(this.a) + ",cost=" + l);
      }
      ...
      localBundle.putString("intext_2", "" + aiva.b(this.a));
    ...
    {
      if (!bool) {
        QLog.i("Q.share.ForwardSdkShareProcessor", 1, "UrlExchangeStep|ret=" + aiva.b(this.a) + ",cost=" + l + ",url=" + ForwardSdkShareProcessor.a(this.a.jdField_b_of_type_ComTencentMobileqqTransfileForwardSdkShareProcessor).toString());
      }
      ...
      localObject = "1";
      break label386;
      if ((aiva.b(this.a).get() == 100000) && (ForwardSdkShareProcessor.c(this.a.jdField_b_of_type_ComTencentMobileqqTransfileForwardSdkShareProcessor) < 2))
      {
    ...
    } while ((aiva.b(this.a).get() != -1) || (aiva.a(this.a).getAndIncrement() >= 2));
