...
public class begv
{
  private static begv jdField_a_of_type_Begv;
  private begp jdField_a_of_type_Begp = new begp();
  private begt jdField_a_of_type_Begt = new begt();
  
  public static begv a()
  {
    try
    {
      if (jdField_a_of_type_Begv == null) {
        jdField_a_of_type_Begv = new begv();
      }
      begv localbegv = jdField_a_of_type_Begv;
      return localbegv;
    }
    finally {}
  }
  ...
  public static final void a(TroopFileTransferManager.Item paramItem, int paramInt)
  {
    ...
    for (paramItem = paramItem.Id.toString();; paramItem = "")
    {
      ...
      befc.c("TroopFileThumbnailMgr", befc.a, "[" + paramItem + "] setGettingStatus. ");
      return;
      if (paramInt == 640)
      {
  ...
  private void b(long paramLong, TroopFileTransferManager.Item paramItem, int paramInt)
  {
      ...
      if (localVFSFile.exists())
      {
        ...
        if (paramItem.origLastModifyTime != 0L)
        {
          ...
          if (paramItem.origLastModifyTime != l)
          {
            ...
            {
              i = j;
              if (this.jdField_a_of_type_Begp.a(paramLong, paramItem, paramInt) == 0) {
                i = 1;
              }
            }
          }
        ...
        if (i == 0) {
          this.jdField_a_of_type_Begt.a(paramLong, paramItem, paramInt, null);
        }
        return;
      }
    }
    ...
    {
      this.jdField_a_of_type_Begt.a(paramLong, paramItem, paramInt, str);
      return;
    }
    this.jdField_a_of_type_Begp.a(paramLong, paramItem, paramInt);
  }
  ...
  public static final void b(TroopFileTransferManager.Item paramItem, int paramInt)
  {
    ...
    {
      paramItem = paramItem + "_" + paramInt;
      befc.c("TroopFileThumbnailMgr", befc.a, "[" + paramItem + "] setStopGetStatus. ");
      return;
      if (paramInt == 640)
      {
  ...
  public void a()
  {
    befc.c("TroopFileThumbnailMgr", befc.a, "init");
    this.jdField_a_of_type_Begt.a();
    this.jdField_a_of_type_Begp.a();
  }
  ...
  public void a(long paramLong, TroopFileTransferManager.Item paramItem, int paramInt)
  {
    ...
    bees.a(new TroopFileThumbnailMgr.2(this, paramItem, paramLong, paramInt), false);
    return;
    if (a(paramLong, paramItem, paramInt))
    {
      paramItem.StatusUpdateTimeMs = 0L;
      beel.b(paramLong, paramItem);
      return;
    }
    bees.a(new TroopFileThumbnailMgr.3(this, paramLong, paramItem, paramInt), false);
  }
  
  public void b()
  {
    befc.c("TroopFileThumbnailMgr", befc.a, "release");
    if (Build.VERSION.SDK_INT == 19)
    {
      this.jdField_a_of_type_Begt.b();
      this.jdField_a_of_type_Begp.b();
      return;
    }
    bees.a(new TroopFileThumbnailMgr.1(this), true);
  }
}
