...
public final class qxs
{
  ...
  public static final boolean a()
  {
    if (qzm.a())
    {
      ...
      for (boolean bool1 = true;; bool1 = false)
      {
        ...
        QLog.i("RIJRewardTaskConfig", 1, "isHighestRewardTaskAuthorityOn: " + bool1 + " ,isStudyMode=" + bool2);
        if ((!bool1) || (bool2)) {
          break;
        }
        return true;
  ...
  public final void a()
  {
    Integer localInteger1 = (Integer)bkwm.a("total_show_guide_times", Integer.valueOf(0));
    Integer localInteger2 = (Integer)bkwm.a("today_show_guide_times", Integer.valueOf(0));
    bkwm.a("total_show_guide_times", Integer.valueOf(localInteger1.intValue() + 1));
    bkwm.a("today_show_guide_times", Integer.valueOf(localInteger2.intValue() + 1));
    bkwm.a("last_show_guide_times_stamps", Long.valueOf(System.currentTimeMillis()));
  }
  ...
  public final boolean d()
  {
    ...
    Integer localInteger = (Integer)bkwm.a("total_show_guide_times", Integer.valueOf(0));
    ...
    localInteger = (Integer)bkwm.a("last_show_guide_times_stamps", Integer.valueOf(0));
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      Intrinsics.checkExpressionValueIsNotNull(localInteger, "lastShowGuideTime");
      if (l - localInteger.intValue() > TimeUnit.DAYS.toMillis(1L)) {
        bkwm.a("today_show_guide_times", Integer.valueOf(0));
      }
      localInteger = (Integer)bkwm.a("today_show_guide_times", Integer.valueOf(0));
