...
public class aklv
{
  private static aklv jdField_a_of_type_Aklv;
  ...
  private bhhe jdField_a_of_type_Bhhe = new aklw(this);
  bhhh jdField_a_of_type_Bhhh;
  bhhk jdField_a_of_type_Bhhk;
  private Map<String, List<aklz>> jdField_a_of_type_JavaUtilMap = Collections.synchronizedMap(new HashMap(6));
  
  public static aklv a()
  {
    if (jdField_a_of_type_Aklv == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Aklv == null) {
        jdField_a_of_type_Aklv = new aklv();
      }
      return jdField_a_of_type_Aklv;
    }
  }
  ...
  private Bitmap a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    //   228: astore 6
    //   230: aload_0
    //   231: getfield 36	aklv:jdField_a_of_type_AndroidSupportV4UtilMQLruCache	Landroid/support/v4/util/MQLruCache;
    //   234: ifnull -206 -> 28
    //   237: aload_2
    //   238: astore 6
    //   240: aload_2
    //   241: ifnull -213 -> 28
    //   244: aload_0
    //   245: getfield 36	aklv:jdField_a_of_type_AndroidSupportV4UtilMQLruCache	Landroid/support/v4/util/MQLruCache;
    //   248: aload_3
    //   249: aload_2
  ...
  {
    return akxc.a + paramAppInterface.getCurrentAccountUin() + "/preload/";
  }
  
  private void a(AppInterface paramAppInterface, String paramString1, String paramString2, List<aklz> paramList)
  {
    int j = 0;
    ...
    if ((!TextUtils.isEmpty(paramString2)) && (new File(paramString2).exists()))
    {
      ...
      paramAppInterface = (aklz)paramList.get(j);
  ...
  private void a(AppInterface paramAppInterface, String paramString, List<aklz> paramList)
  {
    ...
    paramAppInterface = QWalletPicHelper.getDrawableForWallet(PreloadManager.e(paramString), BaseApplicationImpl.getApplication().getApplicationContext().getResources().getDrawable(2130843467));
    int i = 0;
    if (i < paramList.size())
    {
      aklz localaklz = (aklz)paramList.get(i);
      if (localaklz == null) {}
      for (;;)
      {
        i += 1;
  ...
  {
    return akxc.c + paramAppInterface.getCurrentAccountUin() + "/preload/";
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bhhk != null) {
      this.jdField_a_of_type_Bhhk.a(true, null);
    }
  }
  
  public void a(AppInterface paramAppInterface, String paramString, aklz paramaklz)
  {
    a(paramAppInterface, paramString, ".png", paramaklz);
  }
  
  public void a(AppInterface paramAppInterface, String paramString1, String paramString2, aklz paramaklz)
  {
    ...
    do
    {
      ...
      ((List)this.jdField_a_of_type_JavaUtilMap.get(paramString2)).add(paramaklz);
    } while (!QLog.isColorLevel());
    ...
    ((List)this.jdField_a_of_type_JavaUtilMap.get(paramString2)).add(paramaklz);
    ((PreloadManager)paramAppInterface.getManager(151)).c(paramString2, new aklx(this, paramAppInterface));
  }
  ...
  public void b(AppInterface paramAppInterface, Set<String> paramSet)
  {
    ...
    if ((paramSet != null) && (!paramSet.isEmpty()))
    {
      ...
      {
        this.jdField_a_of_type_Bhhh = new bhhh(paramAppInterface);
    ...
    for (String str1 = str3;; str1 = str2)
    {
      ...
      ThreadManager.post(new PreloadImgManager.3(this, paramSet, str2, str3, paramAppInterface, localArrayList, str1, localHashMap, localBundle), 8, new akly(this, localArrayList, localHashMap, localBundle), true);
      return;
    }
  }
}
