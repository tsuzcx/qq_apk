  ...
  implements View.OnClickListener
{
  ...
  public bfam(QQComicTabBarView paramQQComicTabBarView, int paramInt, boolean paramBoolean, List<WebViewTabBarData> paramList)
  {
  ...
  void a(QQComicTabBarView paramQQComicTabBarView)
  {
    ...
    try
    {
      ...
      ((bfab)localObject).dispatchJsEvent("qbrowserTabClick", null, localJSONObject);
