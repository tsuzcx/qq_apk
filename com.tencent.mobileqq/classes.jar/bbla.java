...
public class bbla
{
  ...
  private boolean d(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    //   34: invokespecial 302	bbla:a	(Ljava/lang/String;)J
  ...
  private boolean i(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (;;)
    {
      ...
      for (int i = 1;; i = 2)
      {
        ...
        return true;
        localObject2 = bblk.a((String)localObject2);
        break;
      }
    }
  }
  ...
  private boolean l(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    avif.a("Video", "Send video message :selfUin = " + localSvcRequestSendVideoMsg.lUin + " toUin = " + localSvcRequestSendVideoMsg.lPeerUin + " buffer[2] = " + paramToServiceMsg);
    return true;
  }
  ...
  private boolean r(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg.iMsgId = bcgn.b(str);
    paramToServiceMsg.type = 1;
    paramToServiceMsg.iSendTime = 0;
    paramToServiceMsg.shPackNum = bcgn.b(str);
    paramToServiceMsg.shFlowLayer = bcgn.a(str);
    ...
    ((StreamData)localObject1).vData = bcgn.a(str, localShort.shortValue());
    boolean bool = bcgn.b(str);
    if (bool)
    {
      paramToServiceMsg.shPackNum = 0;
  ...
  private boolean s(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg.iMsgId = bcgn.b(str1);
    paramToServiceMsg.type = 1;
    paramToServiceMsg.iSendTime = 0;
    paramToServiceMsg.shPackNum = 0;
    paramToServiceMsg.shFlowLayer = bcgn.a(str1);
    if (QLog.isColorLevel()) {
