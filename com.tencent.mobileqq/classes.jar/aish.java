...
{
  public aish(HomeWorkTroopSelectorFragment paramHomeWorkTroopSelectorFragment) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (HomeWorkTroopSelectorFragment.a(this.a) != null)
    {
      ...
      while (i < j)
      {
        localObject = (aisn)HomeWorkTroopSelectorFragment.a(this.a).getItem(i);
        if ((((Boolean)((aisn)localObject).b).booleanValue()) && (!HomeWorkTroopSelectorFragment.a(this.a).equals(((TroopInfo)((aisn)localObject).a).troopuin)))
        {
          paramView.add(((TroopInfo)((aisn)localObject).a).troopname);
          localArrayList.add(((TroopInfo)((aisn)localObject).a).troopuin);
        }
        i += 1;
      }
    }
