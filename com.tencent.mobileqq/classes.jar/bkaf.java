...
{
  bkaf(bkae parambkae, String paramString) {}
  ...
  public void onDownloadCanceled(String paramString)
  {
    ...
    try
    {
      ...
      bkae.a(this.jdField_a_of_type_Bkae).callJs(this.jdField_a_of_type_JavaLangString, new String[] { localJSONObject.toString() });
      return;
    }
  ...
  public void onDownloadFailed(String paramString, DownloadResult paramDownloadResult)
  {
    ...
    for (;;)
    {
      ...
      bkae.b(this.jdField_a_of_type_Bkae).callJs(this.jdField_a_of_type_JavaLangString, new String[] { paramString.toString() });
      return;
      paramString.put("code", -1);
    }
  }
  ...
  public void onDownloadSucceed(String paramString, DownloadResult paramDownloadResult)
  {
    ...
    try
    {
      ...
      bkae.c(this.jdField_a_of_type_Bkae).callJs(this.jdField_a_of_type_JavaLangString, new String[] { paramString.toString() });
      return;
    }
    catch (Exception paramString)
    {
