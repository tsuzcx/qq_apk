...
public class avpy
{
  ...
  @RequiresApi(api=18)
  public static avpy a(int paramInt, Intent paramIntent, avqk paramavqk)
  {
    return new avqf(paramIntent, paramavqk);
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Avpj != null) {
      this.jdField_a_of_type_Avpj.a();
    }
