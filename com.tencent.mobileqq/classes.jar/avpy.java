  ...
  extends BaseAdapter
{
  ...
  public avpy(Context paramContext, Drawable paramDrawable, int paramInt1, int paramInt2, int paramInt3)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaUtilList = new ArrayList(2);
    this.jdField_a_of_type_Int = paramInt1;
    this.b = paramInt2;
    int i = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298686);
    this.d = paramInt1;
    this.c = (i + paramInt2);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramView == null)
      {
        paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561103, null);
        localavpz = new avpz();
        localavpz.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramViewGroup.findViewById(2131368053));
        localavpz.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131377938));
        paramViewGroup.setTag(localavpz);
      ...
      for (;;)
      {
        ...
        if (localInterestTagInfo != null)
        {
          ...
          if (localavpz != null)
          {
            ...
            localavpz.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130841095);
            if ((localInterestTagInfo.tagType == 10) || (localInterestTagInfo.tagType == 11) || (localInterestTagInfo.tagType == 9)) {
              localavpz.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130841096);
            }
            localavpz.jdField_a_of_type_AndroidWidgetTextView.setText(localInterestTagInfo.tagName);
            localObject = paramViewGroup;
          }
        }
        label203:
        return localObject;
        localavpz = (avpz)paramView.getTag();
    ...
    for (;;)
    {
      try
      {
        ...
        paramView = URLDrawable.getDrawable(bauz.a(paramView), (URLDrawable.URLDrawableOptions)localObject);
      }
      catch (Exception localException1)
      {
        for (;;)
        {
          try
          {
            if (this.e == 7)
            {
              paramView.setTag(bcyz.b(this.jdField_a_of_type_Int, this.b, (int)(10.0F * this.jdField_a_of_type_Float)));
              paramView.setDecodeHandler(bcyz.c);
            }
            paramView.setDownloadListener(new auue(this.jdField_a_of_type_AndroidContentContext, "actInterestTagPicDownload"));
          }
          ...
          try
          {
            ...
            localURLImageView = localavpz.jdField_a_of_type_ComTencentImageURLImageView;
