...
public final class qdn
{
  ...
  public final Bitmap a(@NotNull String paramString, int paramInt1, int paramInt2, @Nullable Bitmap paramBitmap)
  {
    ...
    return new qdo().a(paramString, paramInt1, paramInt2, Bitmap.Config.ARGB_8888, paramBitmap);
  }
  ...
  public final String a(@NotNull String paramString)
  {
    ...
    } while ((!qdk.a.g()) || (!bkwb.a((Context)BaseApplicationImpl.context)));
  ...
  public final String a(@NotNull String paramString1, @NotNull String paramString2)
  {
    ...
    Object localObject = bkyp.a(paramString1);
  ...
  public final void a(@NotNull tlw paramtlw, @NotNull String paramString)
  {
    Intrinsics.checkParameterIsNotNull(paramtlw, "imageRequest");
    Intrinsics.checkParameterIsNotNull(paramString, "originUrl");
    try
    {
      paramtlw.c = b(paramString);
      paramtlw.a = new URL(a(paramString));
      return;
    }
    catch (Exception paramtlw)
    {
      QLog.d(jdField_a_of_type_JavaLangString, 1, paramtlw.getMessage());
    }
  }
  ...
  public final String b(@NotNull String paramString1, @NotNull String paramString2)
  {
    ...
    return str;
    label129:
    paramString1 = bkyp.a(paramString1, "tp");
