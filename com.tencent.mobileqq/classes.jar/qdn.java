...
public class qdn
  implements qft
{
  private void a(Context paramContext, BaseArticleInfo paramBaseArticleInfo, snh paramsnh)
  {
    if ((paramBaseArticleInfo != null) && (paramBaseArticleInfo.mVideoDownloadBarInfo != null) && (paramBaseArticleInfo.mVideoDownloadBarInfo.get() != null))
    {
      ...
      if (localUrlJumpInfo != null) {
        ryx.a(paramContext, localUrlJumpInfo);
      }
    }
    while (paramsnh == null)
    {
      ...
      paramsnh.a(snh.a(paramBaseArticleInfo), paramBaseArticleInfo, false, false);
      return;
    }
    paramsnh.a(snh.a(paramBaseArticleInfo), paramBaseArticleInfo, false, false);
  }
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo, boolean paramBoolean, JSONObject paramJSONObject)
  {
    ...
    for (int i = paramBaseArticleInfo.mVideoColumnInfo.a;; i = -1)
    {
      ...
      for (int j = 0;; j = 1)
      {
        paramBaseArticleInfo = new skc(null, null, null, null).W(Integer.valueOf("1031").intValue()).h(paramBaseArticleInfo.getInnerUniqueID()).Z(j).p(paramJSONObject.optString("double_videocard_jump_page")).q(paramJSONObject.optString("double_videocard_jump_src")).r(paramBaseArticleInfo.mSubscribeName).f(paramBaseArticleInfo);
        if (i != -1) {
          paramBaseArticleInfo.Y(i);
        }
        paramBaseArticleInfo = paramBaseArticleInfo.a().a();
        oat.a(null, null, "0X8007625", "0X8007625", 0, 0, "", "", "", paramBaseArticleInfo, false);
        oat.a(null, null, "0X800A5A9", "0X800A5A9", 0, 0, "", "", "", paramBaseArticleInfo, false);
        return;
      }
    }
  }
    ...
    catch (Exception localException1)
    {
      for (;;)
      {
        try
        {
          ...
          localObject1 = new JSONObject();
          ((JSONObject)localObject1).put("cover_image_url_1", pha.a(paramBaseArticleInfo.mFirstPagePicUrl, bgtn.b(180.5F), bgtn.b(102.0F)));
          localJSONObject2.put("cover_image_1", localObject1);
          localJSONObject2.put("id_paly_wrapper_1", new JSONObject());
          localObject1 = new JSONObject();
          localObject2 = ryx.a(paramBaseArticleInfo.mVideoDuration * 1000);
          ...
          ((JSONObject)localObject2).put("article_title_1_textsize", pin.a());
          ...
          localObject1 = new JSONObject();
          localObject2 = ryx.d(paramBaseArticleInfo.mVideoCommentCount);
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ((JSONObject)localObject1).put("comment_num_1", (String)localObject2 + anni.a(2131702224));
          ...
          localJSONObject2.put("id_container_1", localObject1);
          localObject1 = new JSONObject();
          ((JSONObject)localObject1).put("cover_image_url_2", pha.a(localBaseArticleInfo.mFirstPagePicUrl, bgtn.b(180.5F), bgtn.b(102.0F)));
          localJSONObject2.put("cover_image_2", localObject1);
          localJSONObject2.put("id_play_wrapper_2", new JSONObject());
          localObject1 = new JSONObject();
          localObject2 = ryx.a(localBaseArticleInfo.mVideoDuration * 1000);
          if (localObject2 != null)
          {
            localObject2 = ((StringBuilder)localObject2).toString();
            if (!TextUtils.isEmpty((CharSequence)localObject2))
          ...
          if (!pmh.a().a(localBaseArticleInfo.mArticleID)) {
            continue;
          }
          localObject1 = "#999999";
          ((JSONObject)localObject2).put("article_title_2_color", localObject1);
          ((JSONObject)localObject2).put("article_title_2_textsize", pin.a());
          ...
          localObject1 = new JSONObject();
          localObject2 = ryx.d(localBaseArticleInfo.mVideoCommentCount);
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ((JSONObject)localObject1).put("comment_num_2", (String)localObject2 + anni.a(2131702225));
  ...
  public void a(int paramInt1, Container paramContainer, pxk parampxk, int paramInt2)
  {
    ...
    {
      return;
      a(paramContainer.findViewBaseByName("id_artilce_title_1"), parampxk.a());
    } while ((parampxk.a() == null) || (parampxk.a().mSubArtilceList == null) || (parampxk.a().mSubArtilceList.size() <= 0) || (parampxk.a().mSubArtilceList.get(0) == null));
    a(paramContainer.findViewBaseByName("id_artilce_title_2"), (BaseArticleInfo)parampxk.a().mSubArtilceList.get(0));
  }
  ...
  public boolean a(int paramInt, Container paramContainer, pxk parampxk, ViewBase paramViewBase)
  {
    ...
    paramViewBase.setOnClickListener(new qdo(this, parampxk, paramInt, paramContainer));
    return true;
  }
}
