...
public class qdn
{
  ...
  public static List<qdn> a(oidb_cmd0xbc9.DynamicBannerItem paramDynamicBannerItem)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (i < localJSONArray.length())
        {
          ...
          localqdn.a = localJSONArray.get(i).toString();
          localArrayList.add(localqdn);
          i += 1;
        }
        return localArrayList;
      }
      catch (Exception localException)
      {
        ...
        localObject = new qdn();
        ((qdn)localObject).a = paramDynamicBannerItem.bytes_dynamic_json.get().toStringUtf8();
