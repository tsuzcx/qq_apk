...
public class arpw
{
  ...
  private arpw(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList)
  {
  ...
  private arpw(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, long paramLong)
  {
  ...
  private arpw(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2)
  {
    this(paramQQAppInterface, paramList);
  ...
  public static arpw a(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, long paramLong)
  {
    return new arpw(paramQQAppInterface, paramList, paramLong);
  }
  
  public static arpw a(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2)
  {
    return new arpw(paramQQAppInterface, paramList, paramString1, paramString2, paramString3, paramString4, paramInt1, paramInt2);
  }
  ...
  public arpw a(String paramString)
  {
  ...
  public arpw a(String paramString, Uri paramUri)
  {
    this.jdField_a_of_type_AndroidContentContentValues.clear();
    this.jdField_a_of_type_AndroidContentContentValues.put("data1", paramString);
    a(paramUri);
  ...
  public arpw b(String paramString)
  {
    this.jdField_a_of_type_AndroidContentContentValues.clear();
    ...
    this.jdField_a_of_type_AndroidContentContentValues.put("data3", anvx.a(2131702006));
    a();
    return this;
  }
}
