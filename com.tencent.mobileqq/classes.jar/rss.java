  ...
  implements bahf
{
  ...
  baka jdField_a_of_type_Baka;
  private bakb jdField_a_of_type_Bakb = new rst(this);
  bbac jdField_a_of_type_Bbac;
  ...
  public rss(Activity paramActivity, String paramString, bbac parambbac)
  {
    this.jdField_a_of_type_Bbac = parambbac;
  ...
  private void j()
  {
    SpannableString localSpannableString = new SpannableString(this.jdField_a_of_type_AndroidAppActivity.getString(2131632809));
    babr.a(this.jdField_a_of_type_AndroidAppActivity, ajjy.a(2131643014), localSpannableString, 0, 2131654515, null, null, new rsu(this)).show();
  }
  ...
  public int a()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Bbac.a() != null) {
        this.jdField_a_of_type_Bbac.a().callJs(rsv.c, new String[] { localJSONObject.toString() });
      }
      awqx.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D29", "0X8005D29", 0, 0, "1", "", "", "");
      i();
      return 0;
    }
  ...
  {
    awqx.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D29", "0X8005D29", 0, -1, "1", "", "", "");
  }
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Bbac.a() != null) {
        this.jdField_a_of_type_Bbac.a().callJs(rsv.c, new String[] { paramString.toString() });
      }
      awqx.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D29", "0X8005D29", 0, -1, "1", "", "", "");
      return;
    }
    ...
    for (;;)
    {
      try
      {
        if (jdField_a_of_type_Double == this.jdField_b_of_type_Int)
        {
          ...
          paramString.put("msg", ajjy.a(2131642994));
          paramString.put("localId", d());
          if (this.jdField_a_of_type_Bbac.a() != null) {
            this.jdField_a_of_type_Bbac.a().callJs(rsv.g, new String[] { paramString.toString() });
          }
          awqx.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D2B", "0X8005D2B", 0, 0, "1", "", "", "");
          return;
        }
        if (this.jdField_a_of_type_JavaIoFile.exists())
        {
          paramString.put("retCode", 0);
          paramString.put("msg", ajjy.a(2131642960) + d());
          paramString.put("localId", d());
          awqx.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D2A", "0X8005D2A", 0, 0, "1", "", "", "");
          if (this.jdField_a_of_type_Bbac.a() == null) {
            break;
          }
          this.jdField_a_of_type_Bbac.a().callJs(rsv.d, new String[] { paramString.toString() });
          return;
        }
      }
      ...
      paramString.put("retCode", -1);
      paramString.put("msg", ajjy.a(2131643020));
      paramString.put("localId", d());
      awqx.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D2A", "0X8005D2A", 0, -1, "1", "", "", "");
    }
  }
  ...
  public void a(String paramString1, QQRecorder.RecorderParam paramRecorderParam, String paramString2)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Bbac.a() != null) {
        this.jdField_a_of_type_Bbac.a().callJs(rsv.c, new String[] { paramString1.toString() });
      }
      awqx.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D29", "0X8005D29", 0, -1, "1", "", "", "");
      return;
    }
  ...
  {
    return ajed.aU + "c2bPTT/" + paramString + ".amr";
  }
  ...
  public void b()
  {
    ...
    f = ajed.aU + "c2bPTT/" + axqf.a() + ".amr";
    baan.a(this.jdField_a_of_type_AndroidAppActivity, true);
  ...
  public void b(String paramString)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Baka == null) || (this.jdField_a_of_type_AndroidOsHandler == null) || ((this.jdField_a_of_type_Baka != null) && (this.jdField_a_of_type_Baka.a() != 3)))
      {
        this.jdField_a_of_type_AndroidOsHandler = new Handler();
        this.jdField_a_of_type_Baka = new baka(paramString, this.jdField_a_of_type_AndroidOsHandler);
      }
      this.jdField_a_of_type_Baka.a(this.jdField_a_of_type_AndroidAppActivity);
      this.jdField_a_of_type_Baka.b();
      this.jdField_a_of_type_Baka.a(this.jdField_a_of_type_Bakb);
      if (this.jdField_a_of_type_Baka.a() == 1)
      {
        this.jdField_a_of_type_Baka.c();
        return;
      }
    } while (this.jdField_a_of_type_Baka.a() != 3);
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Baka != null) && (this.jdField_a_of_type_Baka.a() == 2);
  }
  ...
  public void c()
  {
    ...
    d();
    baan.a(this.jdField_a_of_type_AndroidAppActivity, false);
  }
  ...
  public void e()
  {
    ...
    {
      localJSONObject.put("retCode", 0);
      localJSONObject.put("msg", ajjy.a(2131642963) + d() + ajjy.a(2131643031));
      localJSONObject.put("localId", d());
      if (this.jdField_a_of_type_Bbac.a() != null) {
        this.jdField_a_of_type_Bbac.a().callJs(rsv.f, new String[] { localJSONObject.toString() });
      }
      return;
    }
    catch (JSONException localJSONException)
