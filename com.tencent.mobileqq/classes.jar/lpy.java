...
public class lpy
  extends lhe
{
  public lpy(GaInviteActivity paramGaInviteActivity) {}
  ...
  protected void a(long paramLong, ArrayList<lfu> paramArrayList, int paramInt1, int paramInt2)
  {
    ...
    while (paramArrayList.hasNext()) {
      if (String.valueOf(((lfu)paramArrayList.next()).jdField_a_of_type_Long).equalsIgnoreCase(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getAccount())) {
        this.a.finish();
      }
    }
  }
