...
{
  private static bjmy jdField_a_of_type_Bjmy;
  ...
  public bjmy()
  {
    aywo localaywo = new aywo();
    localaywo.a();
    this.b = (localaywo.d * 1000);
    this.jdField_a_of_type_Int = localaywo.c;
    this.jdField_a_of_type_JavaLangString = localaywo.jdField_a_of_type_JavaLangString;
  }
  
  public static bjmy a()
  {
    if (jdField_a_of_type_Bjmy == null) {}
    try
    {
      if (jdField_a_of_type_Bjmy == null) {
        jdField_a_of_type_Bjmy = new bjmy();
      }
  ...
  public void a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      ??? = new bjmz(this.jdField_a_of_type_JavaLangString, (ArrayList)localObject2, null);
      localObject2 = new QzoneCommonIntent(BaseApplicationImpl.getContext(), apbf.class);
      ((QzoneCommonIntent)localObject2).setRequest((bizh)???);
