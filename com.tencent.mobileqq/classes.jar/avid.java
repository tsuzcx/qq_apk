  ...
  public void a(HotWordSearchEntryDataModel.HotSearchItem paramHotSearchItem)
  {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        paramHotSearchItem = avwc.a(localHotSearchItem.title, 5, "kandian_hotword");
      }
      for (;;)
      {
        ...
        avic.a(this.a, paramHotSearchItem, localHotSearchItem.title);
        avwf.a("hot_list", "clk_hot_list", new String[] { localHotSearchItem.title, String.valueOf(this.a.jdField_a_of_type_Int), String.valueOf(this.a.jdField_a_of_type_JavaUtilList.indexOf(localHotSearchItem) + 1) });
        paramHotSearchItem = new JSONObject();
        try
        {
          paramHotSearchItem.put("project", avsv.a());
          paramHotSearchItem.put("event_src", "client");
          paramHotSearchItem.put("experiment_id", avsv.b);
          ...
          {
            i = 21;
            avsv.a(null, localReportModelDC02528.ver2(avsv.a(i)).ver4(localHotSearchItem.title).ver7(paramHotSearchItem.toString()).session_id(((QQAppInterface)localObject).getCurrentAccountUin() + this.a.jdField_a_of_type_Long));
            avsv.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, SearchEntryFragment.a(this.a.jdField_a_of_type_Int), "0X8009D28", 0, 0, null, null);
            ((ajrt)((QQAppInterface)obz.a()).getManager(299)).a(localHotSearchItem.title);
            return;
            label382:
            paramHotSearchItem = avwc.c(this.a.jdField_a_of_type_Int);
            paramHotSearchItem = avwc.a(localHotSearchItem.title, 5, paramHotSearchItem);
          }
        }
