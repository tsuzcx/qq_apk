...
public class atbr
{
  ...
  private static String a(android.graphics.Bitmap paramBitmap)
  {
    ...
    //   6: dup
    //   7: getstatic 30	ajsf:cf	Ljava/lang/String;
    //   10: invokestatic 35	bbuv:a	(Ljava/lang/String;)Ljava/lang/String;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, ayvz paramayvz)
  {
    paramayvz.addFilter(new Class[] { ayst.class });
    paramQQAppInterface.a().a(paramayvz);
  ...
  {
    new axra(null).a("dc00899").b("grp_lbs").c(paramString1).d(paramString2).a(paramInt1).b(paramInt2).a(paramVarArgs).a();
  }
  ...
  public static boolean a(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, actn.a(150.0F, paramActivity.getResources()));
    new atyc(paramActivity).a(localImageView, localLayoutParams).b(ajyc.a(2131707391)).a(new atxw(ajyc.a(2131707393), new atbs(paramActivity, paramQQAppInterface))).show();
