  ...
  extends naa
{
  ...
  public wrf(wre paramwre, ImageView paramImageView)
  {
    this.b = new WeakReference(paramwre);
  ...
  public qqstory_struct.ErrorInfo a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    wre localwre = (wre)this.b.get();
    paramBundle = (ImageView)this.c.get();
    if ((localwre == null) || (paramBundle == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
          ...
          try
          {
            ...
            if ((((qqstory_710_message.RspStoryMessageList)localObject).errinfo.error_code.has()) && (((qqstory_710_message.RspStoryMessageList)localObject).errinfo.error_code.get() == 0) && (((qqstory_710_message.RspStoryMessageList)localObject).message_num.get() > 0) && (!((qqstory_710_message.RspStoryMessageList)localObject).message_list.get().isEmpty()))
            {
              ...
              for (;;)
              {
                ...
                {
                  localObject = new wjj((qqstory_710_message.StoryMessage)paramArrayOfByte.next());
                  if (((wjj)localObject).d)
                  {
                    paramArrayOfByte = ((wjj)localObject).a;
                    if (QLog.isColorLevel()) {
                    ...
                    vhj.a(paramBundle, vhj.b(paramArrayOfByte), true, (int)bdcq.a(wre.b(localwre), 33.0F));
                    return null;
                  }
                }
              }
      ...
      paramArrayOfByte = bdda.b();
      QQStoryContext.a();
      paramArrayOfByte = bcxb.a(QQStoryContext.a(), 1, Long.toString(wre.a(localwre)), 3, paramArrayOfByte, paramArrayOfByte);
