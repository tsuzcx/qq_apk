  ...
  extends Dialog
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = ajed.aU + "MsgPushNotify" + File.separator;
    ...
    jdField_g_of_type_JavaLangString = ajjy.a(2131641166);
    h = ajjy.a(2131641160);
    i = ajjy.a(2131641163);
  ...
  @TargetApi(14)
  public akdt(Context paramContext)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    if (paramString == null)
    {
      jdField_a_of_type_AndroidContentIntent = badh.a(paramQQAppInterface.getApp());
      return;
    }
    Object localObject;
    label143:
    ...
    } while ((!((String)localObject).equals("device")) || (!paramString.getAttributeValue(null, "id").equals(babp.d())));
    jdField_a_of_type_AndroidContentIntent = null;
    for (;;)
    {
      if (paramString.next() != 3)
  ...
  public static boolean a(File paramFile)
  {
    ...
    for (;;)
    {
      ...
      if (k < jdField_a_of_type_Int)
      {
        bace.d(String.format(jdField_c_of_type_JavaLangString + jdField_e_of_type_JavaLangString, new Object[] { Integer.valueOf(k) }));
        k += 1;
      }
      else
      {
        if (paramFile.exists())
        {
          bace.a(paramFile.getPath(), jdField_b_of_type_JavaLangString, false);
          return true;
        }
        return false;
        label151:
  ...
  private static boolean b(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      if ((jdField_a_of_type_Batm.a() == 2) || (jdField_a_of_type_Batm.a() == 3))
      {
        QLog.d(jdField_a_of_type_JavaLangString, 1, "res download duplicated, " + str);
        return false;
      }
      QLog.d(jdField_a_of_type_JavaLangString, 1, "res download task status error, cancel it, status: " + jdField_a_of_type_Batm.a());
      jdField_a_of_type_Batm.a(true);
    }
    jdField_a_of_type_Batm = new batm(jdField_f_of_type_JavaLangString, localFile);
    jdField_a_of_type_Batm.n = true;
    paramQQAppInterface = ((bato)paramQQAppInterface.getManager(47)).a(1);
    QLog.d(jdField_a_of_type_JavaLangString, 1, "start download ");
    paramQQAppInterface.a(jdField_a_of_type_Batm, new akdx(str), null);
    return false;
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2131493353);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131299572));
    ...
    try
    {
      ...
      localButton.setText(ajjy.a(2131641161));
      localButton.setOnClickListener(new akdu(this));
      localImageView.setOnClickListener(new akdv(this));
      localImageView.setOnTouchListener(new akdw(this, localImageView));
      return;
    }
