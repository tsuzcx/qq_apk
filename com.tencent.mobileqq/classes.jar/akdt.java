  ...
  extends akbr
{
  ...
  public ajwt a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new akdx(this);
  ...
  public akdt(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new akdu(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131368378)).setOnClickListener(new akdv(this));
    Button localButton = (Button)findViewById(2131363845);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new akdw(this));
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Ajwt = new ajwt(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Bkyc, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ajwt);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new akdy(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new akdz(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new akea(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemLongClickListener(new akeb(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Ajwt.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Ajwt.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.jdField_c_of_type_AndroidWidgetTextView.setText(anvx.a(2131714544));
        ...
        {
          this.jdField_a_of_type_Ajwt.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_d_of_type_Boolean, 0);
          this.jdField_a_of_type_Ajwt.notifyDataSetChanged();
        }
        if (this.jdField_a_of_type_Ajwt.getCount() == 0) {
          a(4, null);
        }
        for (;;)
        {
      ...
      this.jdField_a_of_type_Ajwt.a(this.jdField_a_of_type_JavaUtilList, this.jdField_d_of_type_Boolean);
      if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_Ajwt.getCount() < 20))
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(anvx.a(2131714546));
        this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131373220).setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
      }
    ...
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Ajwt.a((List)localObject, this.jdField_d_of_type_Boolean);
    this.jdField_a_of_type_Ajwt.notifyDataSetChanged();
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ajwt);
    this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
    this.jdField_a_of_type_JavaUtilList.clear();
