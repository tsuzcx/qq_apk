  ...
  extends BaseAdapter
{
  ...
  private ArrayList<bgod> jdField_a_of_type_JavaUtilArrayList = this.jdField_a_of_type_ComTencentMobileqqActivityPhoneNewStyleCountryActivity.jdField_a_of_type_JavaUtilArrayList;
  
  private akdt(NewStyleCountryActivity paramNewStyleCountryActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityPhoneNewStyleCountryActivity.a(paramView, (bgod)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt));
