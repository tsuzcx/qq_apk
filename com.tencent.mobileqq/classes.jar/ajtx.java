  ...
  extends QIPCModule
{
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("getPhoneBindState".equals(paramString))
    {
      ...
      {
        localBundle.putInt("selfBindState", ((askl)((QQAppInterface)paramString).getManager(11)).d());
    ...
    else
    {
      ...
      if ("set_nickname".equals(paramString))
      {
        ...
        if ((localAppRuntime instanceof QQAppInterface))
        {
          ...
          ((ajtk)((QQAppInterface)localAppRuntime).a(2)).notifyUI(94, true, paramString);
          return EIPCResult.createSuccessResult(localBundle);
        }
      }
      else if ("set_avatar".equals(paramString))
      {
        ...
        if ((localAppRuntime instanceof QQAppInterface))
        {
          ...
          paramString = bazo.a((QQAppInterface)localAppRuntime, paramString, paramBundle);
