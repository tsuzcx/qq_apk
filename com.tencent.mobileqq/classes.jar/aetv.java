...
public class aetv
{
  ...
  public void b()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 42	aetv:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   24: return
    //   25: aload_0
    //   26: getfield 37	aetv:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   29: invokeinterface 127 1 0
    //   34: aload_0
    //   35: getfield 42	aetv:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   38: iconst_1
    //   39: invokevirtual 131	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   42: new 133	java/io/File
    //   45: dup
    //   46: aload_0
    //   47: getfield 115	aetv:b	Ljava/lang/String;
    ...
    //   92: aload 5
    //   94: aload_0
    //   95: getfield 146	aetv:jdField_a_of_type_Int	I
    //   98: i2l
    ...
    //   107: lload_2
    //   108: aload_0
    //   109: getfield 146	aetv:jdField_a_of_type_Int	I
    //   112: i2l
    //   113: lsub
    //   114: l2i
    //   115: newarray byte
    ...
    //   144: astore 4
    //   146: aload_0
    //   147: getfield 95	aetv:jdField_a_of_type_ComWxVoiceVadWXVad	Lcom/wx/voice/vad/WXVad;
    //   150: aload 6
    //   152: aload 6
    //   154: arraylength
    //   155: i2l
    ...
    //   282: astore 4
    //   284: aload_0
    //   285: getfield 37	aetv:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   288: aload 7
    ...
    //   305: astore 4
    //   307: aload_0
    //   308: getfield 95	aetv:jdField_a_of_type_ComWxVoiceVadWXVad	Lcom/wx/voice/vad/WXVad;
    //   311: invokevirtual 218	com/wx/voice/vad/WXVad:Reset	()I
    //   314: pop
    //   315: aload 5
    //   317: astore 4
    //   319: aload_0
    //   320: getfield 42	aetv:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   323: iconst_0
    ...
    //   357: astore 4
    //   359: aload_0
    //   360: getfield 42	aetv:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   363: iconst_0
