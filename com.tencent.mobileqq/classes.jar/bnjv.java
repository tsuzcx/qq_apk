  ...
  extends GPUBaseFilter
{
  ...
  private bnjm jdField_a_of_type_Bnjm;
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Bnjm != null) || (this.b != null);
  }
  
  public void destroy()
  {
    if (this.jdField_a_of_type_Bnjm != null) {
      this.jdField_a_of_type_Bnjm.destroy();
    }
    if (this.b != null) {
      this.b.destroy();
    }
  ...
  public void drawTexture(int paramInt, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    ...
    if (this.jdField_a_of_type_Bnjm != null) {
      this.jdField_a_of_type_Bnjm.drawTexture(paramInt, paramArrayOfFloat1, paramArrayOfFloat2);
    }
  ...
  public void init()
  {
    if ((this.jdField_a_of_type_Bnjm != null) && (!this.jdField_a_of_type_Bnjm.isInitialized())) {
      this.jdField_a_of_type_Bnjm.init();
    }
  ...
  {
    if (this.jdField_a_of_type_Bnjm != null) {
      this.jdField_a_of_type_Bnjm.onOutputSizeChanged(paramInt1, paramInt2);
    }
    if (this.b != null) {
