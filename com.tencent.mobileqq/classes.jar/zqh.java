...
public class zqh
{
    ...
    try
    {
      if (jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser == null)
      {
        ...
        if (VSNetworkHelper.getInstance() != null) {
          VSNetworkHelper.getInstance().sendRequest(new SubscribePersonalDetailRequest(BaseApplicationImpl.getApplication().getRuntime().getAccount(), localStCommonExt), new zqi());
        }
      }
  ...
  public static void a(CertifiedAccountRead.StGetMainPageRsp paramStGetMainPageRsp)
  {
    ...
    } while (!zqn.a(localStUser.attr.get()));
