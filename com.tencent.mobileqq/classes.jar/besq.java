...
public class besq
  extends besk
{
  public besq(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  {
    String str = bhmq.a(paramContext, paramString, 0);
    ImageInfo localImageInfo = new ImageInfo();
    bhmq.a(4, paramContext, paramString, str, true, localImageInfo, 0);
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    for (paramDownloadParams = ((MessageForPic)paramDownloadParams.tag).path;; paramDownloadParams = null)
    {
      ...
      {
        besk.a(paramOutputStream, paramDownloadParams, paramURLDrawableHandler);
        return null;
