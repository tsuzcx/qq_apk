...
public class azdh
{
  private static volatile azdh jdField_a_of_type_Azdh;
  ...
  public static azdh a()
  {
    if (jdField_a_of_type_Azdh == null) {}
    try
    {
      if (jdField_a_of_type_Azdh == null) {
        jdField_a_of_type_Azdh = new azdh();
      }
      return jdField_a_of_type_Azdh;
    }
    finally {}
  }
  ...
  private void a(long paramLong1, long paramLong2, submsgtype0x122.MsgBody paramMsgBody)
  {
    ...
    try
    {
      ...
      paramMsgBody = aucg.a(paramMsgBody);
    }
    catch (UnsupportedEncodingException paramMsgBody)
    {
      do
      {
        ...
        localObject6 = "";
        localObject3 = "";
        localObject9 = ((auby)localObject9).a();
    ...
    if (paramMsgBody != null)
    {
      ...
      if (((auby)localObject9).a() != 6) {
        QLog.e("PushDialogHandler", 1, new Object[] { "error note type:", Integer.valueOf(((auby)localObject9).a()) });
      }
    }
    else
    {
    ...
    for (;;)
    {
      ...
      {
        localauby = (auby)localIterator.next();
        localObject9 = localauby.a();
        localObject15 = localauby.a();
        if (localauby.a() == 7)
        {
    ...
    for (;;)
    {
      ...
      {
        localObject10 = (auby)((Iterator)localObject12).next();
        localObject9 = ((auby)localObject10).a();
        if (((auby)localObject10).a() == 2)
        {
      ...
      {
        break label435;
        if ((((auby)localObject10).a() != 3) || (localObject9 == null)) {
          break label1073;
        }
        ...
        if (localauby.a() == 9)
        {
          ...
          if (localObject15 != null)
          {
            ...
            {
              localObject9 = (auby)((Iterator)localObject15).next();
              if (((auby)localObject9).a() == 10)
              {
                localObject9 = ((auby)localObject9).a();
              ...
              for (;;)
              {
                ...
                adxr.a((Intent)localObject9, PublicTransFragmentActivity.class, RiskHintDlgFragment.class);
                return;
              }
            }
          }
  ...
  public void a(submsgtype0x122.MsgBody paramMsgBody, MsgInfo paramMsgInfo, QQAppInterface paramQQAppInterface)
  {
    ...
    azdf.a().b(this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager, paramMsgBody);
  }
