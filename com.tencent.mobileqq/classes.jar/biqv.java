  ...
  extends biql
{
  ...
  private String jdField_d_of_type_JavaLangString = ajjy.a(2131649297);
  ...
  public biqv(Context paramContext, String paramString)
  {
  ...
  protected void b()
  {
    ...
    {
      this.jdField_d_of_type_JavaLangString = ajjy.a(2131649295);
      ...
      this.jdField_b_of_type_AndroidTextTextPaint.setShadowLayer(biql.g, 0.0F, 0.0F, 1711276032);
      if (Build.VERSION.SDK_INT >= 21)
      {
    ...
    for (;;)
    {
      ...
      for (this.jdField_d_of_type_Int = i1;; this.jdField_d_of_type_Int = i4)
      {
        ...
        this.jdField_e_of_type_Int = this.jdField_a_of_type_Bipz.a("T", 0L, 165L, 0, 255, new LinearInterpolator());
        this.h = this.jdField_a_of_type_Bipz.a("X", 0L, 330L, 0, this.t, new DecelerateInterpolator());
        this.i = this.jdField_a_of_type_Bipz.a("X", 330L, 340L, this.t, this.u, new AccelerateInterpolator());
        this.j = this.jdField_a_of_type_Bipz.a("X", 825L, 200L, 0, 100, new DecelerateInterpolator());
        this.k = this.jdField_a_of_type_Bipz.a("X", 825L, 355L, a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), new DecelerateInterpolator());
        ...
        if ((this.jdField_d_of_type_JavaLangString == null) || (this.jdField_d_of_type_JavaLangString.contains(ajjy.a(2131649299))) || (this.jdField_d_of_type_JavaLangString.contains(ajjy.a(2131649298))) || (this.jdField_d_of_type_JavaLangString.endsWith(ajjy.a(2131649293))) || (this.jdField_d_of_type_JavaLangString.endsWith(ajjy.a(2131649294)))) {
          break;
        }
        this.jdField_d_of_type_JavaLangString += ajjy.a(2131649296);
        break;
        label1272:
