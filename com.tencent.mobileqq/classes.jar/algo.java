...
public class algo
{
  ...
  public static algo a()
  {
    try
    {
      if (jdField_a_of_type_Algo == null) {
        jdField_a_of_type_Algo = new algo();
      }
      algo localalgo = jdField_a_of_type_Algo;
      return localalgo;
    }
    finally {}
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    {
      return;
      localaliw = (aliw)paramQQAppInterface.getManager(155);
      localObject1 = localaliw.a(paramSessionInfo);
    ...
    if (i >= 0)
    {
      ...
      ApolloGameData localApolloGameData = localaliw.a(((MessageForApollo)localObject1).gameId);
      if ((localApolloGameData == null) || (!alit.a("8.3.5", localApolloGameData.minVer, localApolloGameData.maxVer))) {
        break label262;
      }
    }
    label262:
        ...
        do
        {
          do
          {
            do
            {
              ...
              localObject1 = localaliw.a(((MessageForApollo)localObject1).gameId);
            } while ((localObject1 != null) && (alit.a("8.3.5", ((ApolloGameData)localObject1).minVer, ((ApolloGameData)localObject1).maxVer)));
            paramQQAppInterface = ((albf)paramQQAppInterface.getManager(249)).a();
