...
@TargetApi(14)
public class alaz
  implements alac, SurfaceTexture.OnFrameAvailableListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener
{
  private int jdField_a_of_type_Int;
  public long a;
  public alae a;
  albb jdField_a_of_type_Albb;
  private alkd jdField_a_of_type_Alkd;
  private alke jdField_a_of_type_Alke = new alba(this);
  private alkg jdField_a_of_type_Alkg;
  ...
  public alaz(alae paramalae, albb paramalbb)
  {
    this.jdField_a_of_type_ArrayOfFloat = new float[16];
    this.jdField_a_of_type_Alae = paramalae;
    this.jdField_a_of_type_Albb = paramalbb;
    this.jdField_a_of_type_JavaLangString = paramalbb.jdField_b_of_type_JavaLangString;
    this.jdField_c_of_type_Int = paramalbb.jdField_e_of_type_Int;
    this.jdField_a_of_type_Int = paramalbb.jdField_d_of_type_Int;
    this.jdField_a_of_type_Alkg = paramalbb.jdField_a_of_type_Alkg;
    paramalae = Build.MODEL.toLowerCase();
    if ((Build.MANUFACTURER.toLowerCase().contains("meizu")) && (paramalae.contains("m040"))) {
  ...
  private void g()
  {
    ...
    {
      this.jdField_a_of_type_Alkd = alkf.a(this.jdField_a_of_type_Alkg, 1);
      this.jdField_a_of_type_Alkd.a(albk.jdField_a_of_type_ArrayOfFloat, albk.jdField_a_of_type_ArrayOfShort);
      this.jdField_a_of_type_Alkd.a("uniform int uDisplayType;\n", null, "    if(uDisplayType == 1){\n        // 需要渲染成圆形\n        float x = vTextureCoord.x;\n        float y = vTextureCoord.y;\n        // 圆心(0.5, 0.5), 0.25=0.5*0.5\n        if(pow(abs(x-0.5), 2.0) + pow(abs(y-0.5), 2.0) >= 0.25) {\n            gl_FragColor[3] = 0.0;\n        }\n    }\n", this.jdField_a_of_type_Alke);
      this.jdField_a_of_type_Alkd.a(this.jdField_a_of_type_Albb.jdField_c_of_type_Int, this.jdField_a_of_type_Albb.jdField_a_of_type_Float, this.jdField_a_of_type_Albb.jdField_b_of_type_Float, this.jdField_a_of_type_Albb.jdField_c_of_type_Float);
    }
  }
  ...
  {
    a((float[])paramalak.a("TARGET_SIZE"), (float[])paramalak.a("POSE"), (float[])paramalak.a("CAMERA_MATRIX"), (float[])paramalak.a("CAMERA_POSITION"));
  }
  
  public void a(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3, float[] paramArrayOfFloat4)
  {
    if ((!this.jdField_e_of_type_Boolean) || (paramArrayOfFloat2 == null) || (paramArrayOfFloat3 == null) || (paramArrayOfFloat4 == null) || (this.jdField_a_of_type_Albb == null)) {
      return;
    }
    ...
    int j;
    alkg localalkg;
    if ((this.jdField_a_of_type_Albb != null) && (this.jdField_a_of_type_Albb.jdField_b_of_type_Int == 1)) {
      if (this.jdField_a_of_type_Alkd != null)
      {
        paramArrayOfFloat2 = this.jdField_a_of_type_Alkd;
        j = this.jdField_d_of_type_Int;
        localalkg = this.jdField_a_of_type_Alkg;
        ...
        paramArrayOfFloat2.a(new int[] { j }, localalkg, paramArrayOfFloat1, paramArrayOfFloat3);
      }
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Alkd != null)
      {
        paramArrayOfFloat3 = this.jdField_a_of_type_Alkd;
        j = this.jdField_d_of_type_Int;
        localalkg = this.jdField_a_of_type_Alkg;
        ...
        paramArrayOfFloat3.a(new int[] { j }, localalkg, paramArrayOfFloat1, paramArrayOfFloat2);
      }
    }
  }
  ...
  public float[] a(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
  {
    ...
    if (c() == 2)
    {
      if (this.jdField_a_of_type_Albb.jdField_a_of_type_Aldy != null)
      {
        Matrix.scaleM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Albb.jdField_a_of_type_Aldy.jdField_a_of_type_Float * paramArrayOfFloat1[0], this.jdField_a_of_type_Albb.jdField_a_of_type_Aldy.jdField_b_of_type_Float * paramArrayOfFloat1[1], 1.0F);
        Matrix.translateM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Albb.jdField_a_of_type_Aldy.jdField_c_of_type_Float, this.jdField_a_of_type_Albb.jdField_a_of_type_Aldy.d, this.jdField_a_of_type_Albb.jdField_a_of_type_Aldy.e);
      }
      return this.jdField_a_of_type_ArrayOfFloat;
    }
    if (this.jdField_a_of_type_Albb.jdField_c_of_type_Int == 1) {}
    for (;;)
    {
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Albb != null) {
      return this.jdField_a_of_type_Albb.jdField_a_of_type_Int;
    }
    return 2;
  }
  ...
  {
    if (this.jdField_a_of_type_Albb != null) {
      return this.jdField_a_of_type_Albb.jdField_b_of_type_Int;
    }
    return 0;
  }
  ...
  public String c()
  {
    return this.jdField_a_of_type_Albb.jdField_a_of_type_JavaLangString;
  }
  ...
  public void d()
  {
    ...
    //   43: aload_0
    //   44: getfield 376	alaz:jdField_b_of_type_Boolean	Z
    //   47: ifne +20 -> 67
    //   50: aload_0
    //   51: getfield 167	alaz:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   54: ifnull +13 -> 67
    //   57: aload_0
    //   58: getfield 167	alaz:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   89: aload_0
    //   90: getfield 376	alaz:jdField_b_of_type_Boolean	Z
    ...
    //   102: aload_0
    //   103: getfield 167	alaz:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   116: aload_0
    //   117: iconst_0
    //   118: putfield 385	alaz:h	Z
    //   121: aload_0
    //   122: iconst_0
    //   123: putfield 309	alaz:jdField_e_of_type_Boolean	Z
    //   126: new 387	java/io/FileInputStream
    //   129: dup
    //   130: new 153	java/io/File
    //   133: dup
    //   134: aload_0
    //   135: getfield 80	alaz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   154: astore_2
    //   155: aload_0
    //   156: getfield 167	alaz:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   159: aload 4
    ...
    //   166: aload_0
    //   167: iconst_1
    //   168: putfield 248	alaz:jdField_b_of_type_Int	I
    //   171: aload_3
    //   172: astore_2
    //   173: aload_0
    //   174: getfield 167	alaz:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   177: astore 4
    //   179: aload_3
    //   180: astore_2
    //   181: aload_0
    //   182: getfield 50	alaz:jdField_c_of_type_Int	I
    //   185: ifne +96 -> 281
    //   188: aload_3
    //   189: astore_2
    //   190: aload 4
    ...
    //   198: aload_0
    //   199: iconst_1
    //   200: putfield 400	alaz:g	Z
    //   203: aload_3
    //   204: astore_2
    //   205: aload_0
    //   206: getfield 167	alaz:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   209: invokevirtual 403	android/media/MediaPlayer:prepare	()V
    //   212: aload_3
    //   213: astore_2
    //   214: aload_0
    //   215: iconst_0
    //   216: putfield 405	alaz:f	Z
    //   219: aload_3
    //   220: astore_2
    //   221: aload_0
    //   222: getfield 167	alaz:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   225: invokevirtual 407	android/media/MediaPlayer:start	()V
    //   228: aload_3
    //   229: astore_2
    //   230: aload_0
    //   231: iconst_1
    //   232: putfield 376	alaz:jdField_b_of_type_Boolean	Z
    //   235: aload_3
    //   236: astore_2
    //   237: aload_0
    //   238: getfield 72	alaz:jdField_a_of_type_Alae	Lalae;
    //   241: ifnull +19 -> 260
    //   244: aload_3
    //   245: astore_2
    //   246: aload_0
    //   247: getfield 72	alaz:jdField_a_of_type_Alae	Lalae;
    //   250: iconst_0
    //   251: aload_0
    //   252: getfield 50	alaz:jdField_c_of_type_Int	I
    ...
    //   338: astore_2
    //   339: aload_0
    //   340: invokevirtual 420	alaz:f	()V
    //   343: aload_3
    //   344: ifnull -229 -> 115
    //   347: aload_3
    ...
    //   416: astore_2
    //   417: aload_0
    //   418: invokevirtual 420	alaz:f	()V
    //   421: aload_3
    //   422: ifnull -307 -> 115
    //   425: aload_3
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Alkd != null)
    {
      this.jdField_a_of_type_Alkd.b();
      this.jdField_a_of_type_Alkd = null;
    }
  ...
  public void onCompletion(MediaPlayer paramMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Alae != null) {
      this.jdField_a_of_type_Alae.b(2, this.jdField_c_of_type_Int - this.jdField_b_of_type_Int);
    }
  ...
  public boolean onError(MediaPlayer paramMediaPlayer, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Alae != null) {
      this.jdField_a_of_type_Alae.a(this.jdField_a_of_type_Albb.jdField_a_of_type_JavaLangString);
    }
    ...
    paramMediaPlayer.put("url", this.jdField_a_of_type_Albb.jdField_a_of_type_JavaLangString);
    axrn.a(BaseApplicationImpl.getContext()).a("", "immersed_ar_on_error", true, 0L, 0L, paramMediaPlayer, "", false);
    f();
    return false;
  }
  ...
  public void onFrameAvailable(SurfaceTexture paramSurfaceTexture)
  {
    ...
    this.jdField_a_of_type_Alae.a(this.jdField_a_of_type_JavaLangRunnable);
  }
