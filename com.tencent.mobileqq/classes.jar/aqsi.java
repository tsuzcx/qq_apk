...
public class aqsi
  ...
  implements aqsh
{
  private static volatile aqsi a;
  ...
  public void a(long paramLong1, long paramLong2, String paramString1, String paramString2, long paramLong3, SpannableString paramSpannableString)
  {
    ...
    for (;;)
    {
      paramSpannableString = (QQAppInterface)bofz.a();
  ...
  public void a(aqsb paramaqsb, boolean paramBoolean1, boolean paramBoolean2, int paramInt, ArrayList<DanmuItemBean> paramArrayList, List<Long> paramList)
  {
    ...
    localBundle.putLong("key_barrage_msg_seq", paramaqsb.jdField_a_of_type_Long);
    localBundle.putLong("key_barrage_grp_uin", paramaqsb.b);
    localBundle.putInt("key_barrage_topic_type", paramaqsb.jdField_a_of_type_Int);
    localBundle.putInt("key_barrage_interval_time", paramInt);
    localBundle.putBoolean("key_barrage_is_success", paramBoolean1);
    if (paramaqsb.c > 0L)
    {
      localBundle.putLong("key_barrage_req_time", paramaqsb.c);
      localBundle.putLong("key_barrage_net_req_time", paramaqsb.d);
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("qipc_action_get_barrage".equals(paramString))
    {
      ...
      localObject = aqsc.a().a(aqsc.a().a(l2, l1));
      if ((localObject != null) && (!((aqsd)localObject).jdField_a_of_type_Boolean))
      {
    ...
    label262:
    for (Object localObject = new aqsb(l2, l1, i, bool);; localObject = ((aqsd)localObject).jdField_a_of_type_Aqsb)
    {
      ((aqsb)localObject).c = paramBundle.getLong("key_barrage_req_time");
      ((aqsb)localObject).d = System.currentTimeMillis();
      ((aqsb)localObject).jdField_a_of_type_Boolean = bool;
      aqsc.a().a((aqsb)localObject, this);
