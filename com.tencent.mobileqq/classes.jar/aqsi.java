...
public class aqsi
  implements aqtj
{
  public aqsi(QQGamePubAccountFragment paramQQGamePubAccountFragment) {}
  ...
  public void a(int paramInt)
  {
    ...
    if (paramInt < QQGamePubAccountFragment.a(this.a).size())
    {
      ...
      for (;;)
      {
        ...
        yoa.a(ajac.a(), "769", "205017", this.a.a(paramInt), "76901", "1", "160", new String[] { aqsv.a((MessageRecord)QQGamePubAccountFragment.a(this.a).get(paramInt)), "" + paramInt, "8" });
        ((bbrd)QQGamePubAccountFragment.a(this.a).a(71)).a(2, ((MessageRecord)QQGamePubAccountFragment.a(this.a).get(0)).getExtInfoFromExtStr("pa_msgId"), "");
        return;
        this.a.b(false);
      }
    }
