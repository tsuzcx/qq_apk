  ...
  extends AbstractImageAdapter
{
  ...
  protected void a(View paramView, URLDrawable paramURLDrawable)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((paramURLDrawable.getStatus() == 1) && (ayog.b(str)))
      {
        paramURLDrawable = ayog.a(str);
        if ((paramURLDrawable != null) && (paramURLDrawable.exists())) {
          paramView.setTag(2131296389, Integer.valueOf(bbdr.d(paramURLDrawable.getAbsolutePath())));
        }
      }
      return;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      localxqf = (xqf)getItem(paramInt);
      paramView = localURLImageView;
    } while (localxqf == null);
    URLDrawable localURLDrawable = a(localxqf.a(), paramViewGroup);
    if (localURLDrawable == null) {
      localURLDrawable = (URLDrawable)localxqf.b();
    }
    for (;;)
    {
      ...
      {
        int i = localURLDrawable.getProgress();
        localURLImageView.setURLDrawableDownListener(new xqh(this, paramInt, paramViewGroup));
        a(paramInt, i / 100);
        return localURLImageView;
      }
      paramView = localURLImageView;
