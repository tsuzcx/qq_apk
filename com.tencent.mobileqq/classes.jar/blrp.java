  ...
  extends VasWebviewJsPlugin
{
  ...
  public int a;
  blro jdField_a_of_type_Blro = new blrq(this);
  public blrs a;
  public String a;
  ...
  private void b()
  {
    if (this.jdField_a_of_type_OrgJsonJSONObject != null) {
      blqp.jdField_a_of_type_Blqt.b(this.jdField_a_of_type_OrgJsonJSONObject);
    }
    if (QLog.isColorLevel()) {
      QLog.d("QQComicJsPlugin", 2, "setContainerInfo success on Resume extrasParams: " + blqp.jdField_a_of_type_Blqt.toString());
    }
  }
  
  private void b(JSONObject paramJSONObject)
  {
    blqp.a(paramJSONObject.optInt("useWebBundle"));
  }
  ...
  private void c(JSONObject paramJSONObject)
  {
    ...
    blss.a(str1, false, blss.b);
    for (;;)
    {
      a(localIntent.getExtras());
      blqp.a(paramJSONObject, localIntent, 100);
      return;
      label126:
      blss.a(str1, false, blss.e);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_1
    //   3: putstatic 121	blrp:f	Ljava/lang/String;
    //   6: getstatic 28	blrp:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   18: monitorexit
    //   19: return
    //   20: getstatic 28	blrp:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   23: iconst_1
    //   24: invokevirtual 316	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   27: new 318	cooperation/comic/jsp/QQComicJsPlugin$4
    //   30: dup
    //   31: aload_0
    //   32: invokespecial 319	cooperation/comic/jsp/QQComicJsPlugin$4:<init>	(Lblrp;)V
    //   35: iconst_5
    //   36: aconst_null
    //   37: iconst_1
  ...
  public void a(String paramString1, JSONObject paramJSONObject, String paramString2)
  {
    if (this.jdField_a_of_type_Blrs == null)
    {
      ...
      this.jdField_a_of_type_Blrs = blsg.a(this.mRuntime, this.jdField_a_of_type_Blro);
    }
    if (this.jdField_a_of_type_Blrs != null) {
      this.jdField_a_of_type_Blrs.a(paramString1, paramJSONObject);
    }
    do
    {
      return;
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      {
        paramJsBridgeListener = (String)blqp.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.get();
        paramString1 = new JSONObject();
        ...
        for (;;)
        {
          ...
          paramString1.put("message", anvx.a(2131709630));
    ...
    else
    {
      ...
      if ("setSwitchChannel".equals(paramString3))
      {
        ...
        if ((paramString3 != null) && (paramString3.length() > 0))
        {
          ...
          paramVarArgs.mSwiftTitleUI.setSubTab(new biev(m, k, paramString1, paramString2, paramJsBridgeListener));
          break label2202;
        }
      }
      else
      {
        ...
        else
        {
          ...
          if ("setTabRedPoint".equals(paramString3))
          {
            ...
            break label2202;
            label1074:
            paramVarArgs.mSwiftTitleUI.setSubTabRedHot(new biew(paramJsBridgeListener, j, paramString2));
            break label2202;
          }
          ...
          if ("openQQBrowser".equals(paramString3))
          {
            ...
            blqp.a(paramString1, paramString2, -1);
            break label2202;
          }
          ...
          if ("setTitleAndBottomBar".equals(paramString3))
          {
            ...
            paramJsBridgeListener = (biex)paramString1;
            bool1 = bool2;
            if (!bool3) {
              bool1 = true;
            }
          ...
          if ("getReporterInfo".equals(paramString3))
          {
            paramJsBridgeListener = new JSONObject();
            paramString1 = new JSONObject();
            paramString1.put("mod", blqp.jdField_a_of_type_JavaLangString);
            paramString1.put("land_page", blqp.c);
            paramString1.put("obj_ownerid", blqp.b);
            paramJsBridgeListener.put("data", paramString1);
    ...
    for (i = 1;; i = 2)
    {
      ...
      else if ("setContainerInfo".equals(paramString3))
      {
        ...
        blqp.jdField_a_of_type_Blqt.b(this.jdField_a_of_type_OrgJsonJSONObject);
        if (QLog.isColorLevel()) {
          QLog.d("QQComicJsPlugin", 2, "setContainerInfo success extrasParams: " + blqp.jdField_a_of_type_Blqt.toString());
        }
      }
      else if (blsg.a)
      {
