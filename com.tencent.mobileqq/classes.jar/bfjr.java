  ...
  extends Dialog
{
  ...
  public bfjr(Context paramContext)
  {
    super(paramContext, 2131690184);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    paramContext = LayoutInflater.from(paramContext).inflate(2131494868, null);
    ...
    localObject = (TextView)paramContext.findViewById(2131302804);
    if (localObject != null)
    {
      ((TextView)localObject).setVisibility(0);
      ((TextView)localObject).setText(2131625011);
    }
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131302847));
    try
    {
      if (this.jdField_a_of_type_AndroidWidgetTextView != null)
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131626768);
      }
      label140:
      paramContext = (FadeIconImageView)paramContext.findViewById(2131302816);
      if (paramContext != null)
      {
        paramContext.setVisibility(0);
        paramContext.setImageResource(2130839691);
      }
  ...
  public void onWindowFocusChanged(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableAnimatable = ((Animatable)this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839115));
