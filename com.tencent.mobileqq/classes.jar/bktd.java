  ...
  extends RemoteCommand
{
  ...
  private void a(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity)
  {
    ...
    paramFileManagerEntity.putExtra("forward_text", amtj.a(2131708823) + aszt.d(localFileManagerEntity.fileName) + amtj.a(2131708835) + FileUtil.filesizeToString(localFileManagerEntity.fileSize) + "。");
    paramFileManagerEntity.putExtra("k_favorites", aszt.c(localFileManagerEntity));
    if ((!FileUtil.fileExistsAndNotEmpty(localFileManagerEntity.getFilePath())) && ((localFileManagerEntity.getCloudType() == 6) || (localFileManagerEntity.getCloudType() == 7)) && (localFileManagerEntity.nFileType == 0)) {
      paramFileManagerEntity.putExtra("forward_type", 0);
    }
    ...
    {
      aszg.a(paramActivity, 2131692374, 2131692379, new bkte(this, paramActivity, paramFileManagerEntity));
      return;
    }
    atky.a(paramActivity, paramFileManagerEntity, 103);
  }
  ...
  private void a(String paramString)
  {
    ...
    try
    {
      ...
      if (i > 0)
      {
        ...
        {
          a(localQQAppInterface, localActivity, aszt.a(new FileInfo(paramString)));
          return;
        }
        bkvd.a("QRRemoteCommond", "No Activity to use to forward file");
        return;
      }
    }
    catch (FileNotFoundException paramString)
    {
      bkvd.a("QRRemoteCommond", "file not found", paramString);
    }
  }
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    Object localObject1 = (amxz)a().getManager(56);
    ...
    for (paramBundle = paramBundle.getString("uin"); localObject1 != null; paramBundle = null)
    {
      for (;;)
      {
        if (((amxz)localObject1).b(paramBundle) != null) {
        ...
        ((Bundle)localObject2).putInt("qq_vip_level", bktf.a(a(), null));
        return localObject2;
        ((Bundle)localObject2).putShort("qq_vip_info", bktf.a(a(), null));
        return localObject2;
        if (a() == null) {
          break;
        }
        paramBundle = paramBundle.getString("publicaccount_uin");
        ((Bundle)localObject2).putBoolean("publicaccount_is_follow", ugf.a(a(), paramBundle));
        return localObject2;
        if (a() == null) {
          break;
        }
        localObject1 = paramBundle.getString("publicaccount_uin");
        Object localObject3 = (amxz)a().getManager(56);
        paramBundle = paramOnInvokeFinishLinstener;
        if (localObject3 != null) {
          paramBundle = ((amxz)localObject3).b((String)localObject1);
        }
        if (paramBundle != null)
        {
        ...
        case 2: 
          for (;;)
          {
            ...
            ((WXShareHelper)localObject4).shareWebPageToWXFriend(String.valueOf(l), (String)localObject5, (Bitmap)localObject3, (String)localObject1, paramOnInvokeFinishLinstener);
          }
        }
        localObject4 = WXShareHelper.getInstance();
        ...
        for (paramBundle = paramOnInvokeFinishLinstener;; paramBundle = (Bundle)localObject1)
        {
          ...
          ((WXShareHelper)localObject4).shareWebPageToWXFriendCircle(String.valueOf(l), (String)localObject5, (Bitmap)localObject3, paramBundle, paramOnInvokeFinishLinstener);
          break;
        }
        if ((WXShareHelper.getInstance().isWXinstalled()) && (WXShareHelper.getInstance().isWXsupportApi())) {
        ...
        if (paramOnInvokeFinishLinstener != null)
        {
          paramOnInvokeFinishLinstener = (azvi)paramOnInvokeFinishLinstener.getManager(36);
          if (paramOnInvokeFinishLinstener != null)
          {
            paramBundle = paramOnInvokeFinishLinstener.a(paramBundle.getString("path"));
            if (paramBundle != null) {
              ((Bundle)localObject2).putParcelable("redTouchInfo", azvm.a(paramBundle));
            }
          }
        }
        for (;;)
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (localObject2 != null) {
          paramBundle.add(azvm.a((BusinessInfoCheckUpdate.AppInfo)localObject2));
        }
      }
