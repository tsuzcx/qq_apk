  ...
  extends bmug
{
  ...
  private HashMap<String, bmuf> b;
  
  public bhig(HashMap<String, View> paramHashMap, String paramString)
  {
  ...
  public View a(Context paramContext, String paramString)
  {
    if ("pf_name".equals(paramString))
    {
      ...
      yqp.b("DIYProfileTemplate.QVipProfileJsonInflaterFactory", "创建了昵称控件");
    ...
    if ("pf_avatar".equals(paramString))
    {
      ...
      yqp.b("DIYProfileTemplate.QVipProfileJsonInflaterFactory", "创建了头像控件");
      paramContext = LayoutInflater.from(paramContext).inflate(2131562056, null);
      this.jdField_a_of_type_AndroidViewView = paramContext.findViewById(2131374726);
    ...
    if ("pf_like".equals(paramString))
    {
      ...
      yqp.b("DIYProfileTemplate.QVipProfileJsonInflaterFactory", "创建了点赞控件");
  ...
  {
    if ("pf_name".equals(paramString)) {
      return new bhie(paramString, paramView, this.jdField_a_of_type_JavaLangString);
    }
    if ("pf_avatar".equals(paramString)) {
      return new bhic(paramString, paramView, this.b);
    }
    if ("pf_like".equals(paramString)) {
      return new bhid(paramString, paramView, this.jdField_a_of_type_JavaLangString);
    }
    if ("image_view".equals(paramString)) {
      return new bhii(paramString, paramView, this.jdField_a_of_type_JavaLangString);
    }
  ...
  public void a(bmuf parambmuf, JSONObject paramJSONObject)
  {
    ...
    if ((!TextUtils.isEmpty((CharSequence)localObject)) && (parambmuf != null)) {
      this.b.put(localObject, parambmuf);
    }
    if ("pf_avatar".equals(paramJSONObject.optString("type")))
    {
      localObject = paramJSONObject.optString("border", "");
      localObject = (bmuf)this.b.get(localObject);
      if (localObject != null) {
        this.jdField_a_of_type_JavaUtilHashMap.put("map_key_profile_diy_avatar_sticker", ((bmuf)localObject).a());
      }
    }
    super.a(parambmuf, paramJSONObject);
  }
}
