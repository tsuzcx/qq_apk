...
public class sdj
  extends slz<sdk>
{
  private static final String jdField_a_of_type_JavaLangString = skt.a("StorySvc.batch_get_poi_list");
  ...
  public sdk a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new sdk(localRspBatchGetPOIList);
    }
