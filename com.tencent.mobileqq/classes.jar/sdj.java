  ...
  implements sgw
{
  ...
  private rse jdField_a_of_type_Rse = new rse();
  private rsi jdField_a_of_type_Rsi;
  private sdk jdField_a_of_type_Sdk;
  @Nullable
  private sgx jdField_a_of_type_Sgx;
  @NotNull
  ...
  public sdj(Context paramContext)
  {
    this(paramContext, "");
  }
  
  public sdj(Context paramContext, String paramString)
  {
  ...
  {
    if ((this.jdField_a_of_type_Shf != null) && ((this.jdField_a_of_type_Shf.a() instanceof ISPlayerVideoView)))
    {
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_b_of_type_JavaLangString, 2, "seamlessAttachVideoView: ");
      }
      SPSeamlessHelper.get().attachVideoView(paramViewGroup, (ISPlayerVideoView)this.jdField_a_of_type_Shf.a(), new ViewGroup.LayoutParams(-1, -1));
  ...
  private SuperPlayerOption a(boolean paramBoolean)
  {
    ...
    TCodecManager.getInstance().getReusePolicy().eraseType = rse.a.a();
    if (QLog.isColorLevel()) {
  ...
  private void a(shi paramshi)
  {
    if (paramshi != null)
    {
      paramshi.c(this.jdField_d_of_type_Boolean);
      paramshi.b(this.jdField_e_of_type_Boolean);
      paramshi.a(bkwm.g());
    }
  }
  ...
  private shf b()
  {
    ...
    return this.jdField_a_of_type_Sgz.a(this.jdField_a_of_type_AndroidContentContext, VersionUtils.isIceScreamSandwich());
  }
  
  private void b(String paramString)
  {
    this.jdField_a_of_type_Sgz = shg.a.a();
    if (this.jdField_a_of_type_AndroidContentContext != null)
    {
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (!this.jdField_h_of_type_Boolean)
      {
        this.jdField_f_of_type_Boolean = sek.a().a();
        this.jdField_a_of_type_Sgx = this.jdField_a_of_type_Sgz.a(null);
      }
      this.jdField_a_of_type_Sgx.a(this);
  ...
  private void b(String paramString1, String paramString2, int paramInt1, long paramLong1, long paramLong2, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString3)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_b_of_type_JavaLangString, 2, "#VideoPlayerWrapper# playerStartByUrl, url:" + paramString2 + ", fileSize:" + paramLong2 + ", videoDuration:" + paramInt2 + "，mState:" + sdi.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()));
    }
    if (!s())
    {
      QLog.e(this.jdField_b_of_type_JavaLangString, 1, "not idle or complete state, should't reopen mediaplayer, vid:" + paramString1 + "，mState:" + sdi.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()) + " ,mIsSeamlessPlay:" + this.jdField_h_of_type_Boolean);
      return;
    }
    n();
    if (paramBoolean2)
    {
      paramString2 = sjo.a(paramString2);
      a(paramString2);
    }
    for (;;)
    {
      paramString1 = new shi(paramInt1, paramString1, paramString2);
      paramString1.a(paramBoolean3);
      paramString1.a(paramInt2 * 1000);
      paramString1.d(paramBoolean1);
      paramString1.b(paramString3);
      a(paramString1);
      if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_a_of_type_Sgx != null)) {
        this.jdField_a_of_type_Sgx.a(this.jdField_a_of_type_AndroidContentContext, paramString1, paramLong1, a(paramBoolean3));
      }
  ...
  public long a()
  {
    ...
    return this.jdField_a_of_type_Sgx.b();
  }
  ...
  public View a()
  {
    if (this.jdField_a_of_type_Shf != null) {
      return this.jdField_a_of_type_Shf.a();
    }
    return null;
  }
  ...
  public shf a()
  {
    return this.jdField_a_of_type_Shf;
  }
  
  public void a()
  {
    if (this.jdField_a_of_type_Shf != null) {
      this.jdField_a_of_type_Shf.a();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Sgx != null) {
      this.jdField_a_of_type_Sgx.a(paramFloat);
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Sgx != null) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 2) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 1) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 4) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 8))
    {
      ...
      this.jdField_a_of_type_Sgx.a(paramInt, 1);
  ...
  {
    if ((this.jdField_a_of_type_Sgx != null) && (paramInt1 > 0) && (paramInt2 > 0)) {
      this.jdField_a_of_type_Sgx.a(paramInt1, paramInt2, bkwm.g());
    }
  }
  ...
  public void a(ViewGroup paramViewGroup, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_Sgx != null) {}
    for (shf localshf = this.jdField_a_of_type_Sgx.a();; localshf = null)
    {
      int j;
      if ((paramBoolean1) && (this.jdField_h_of_type_Boolean) && (localshf != null))
      {
        j = 1;
        if (j == 0) {
          break label160;
        }
        this.jdField_a_of_type_Shf = localshf;
      }
      for (;;)
      {
        if ((paramViewGroup != null) && (this.jdField_a_of_type_Shf != null) && (this.jdField_a_of_type_Shf.a() != null))
        {
          if (j == 0) {
            break label168;
          }
      ...
      label168:
      paramViewGroup.addView(this.jdField_a_of_type_Shf.a(), new ViewGroup.LayoutParams(-1, -1));
      a(this.jdField_a_of_type_Shf);
      return;
    }
  }
  ...
  public void a(String paramString, int paramInt, long paramLong, boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_b_of_type_JavaLangString, 2, "#VideoPlayerWrapper# playerStart, vid:" + paramString + ", playType:" + paramInt + ", startPosition:" + paramLong + "，mState:" + sdi.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()));
    }
    if (!s())
    {
      QLog.e(this.jdField_b_of_type_JavaLangString, 1, "not idle or complete state, should't reopen mediaplayer, vid:" + paramString + "，mState:" + sdi.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()) + ", mSeamlessPlay:" + this.jdField_h_of_type_Boolean);
      return;
    }
    n();
    paramString = new shi(paramInt, paramString);
    paramString.a(paramBoolean);
    paramString.a("cache_video");
    a(paramString);
    if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_a_of_type_Sgx != null)) {
      this.jdField_a_of_type_Sgx.a(this.jdField_a_of_type_AndroidContentContext, paramString, paramLong, a(paramBoolean));
    }
    this.jdField_e_of_type_Long = 0L;
    this.jdField_d_of_type_Long = 0L;
  ...
  public void a(sdk paramsdk)
  {
    this.jdField_a_of_type_Sdk = paramsdk;
  }
  
  public void a(@NotNull sgx paramsgx)
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_b_of_type_JavaLangString, 2, "[IPlayer] onVideoPrepared(): stremDumpInfo=" + paramsgx.a());
    }
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(2);
    if (this.jdField_a_of_type_Sdk != null) {
      this.jdField_a_of_type_Sdk.a(this, this.jdField_a_of_type_JavaLangObject);
    }
    if (this.jdField_a_of_type_Sgx != null) {
      this.jdField_d_of_type_Long = this.jdField_a_of_type_Sgx.a();
    }
    if ((this.jdField_b_of_type_Long > 0L) && (this.jdField_d_of_type_Long > 0L)) {
      this.jdField_a_of_type_Int = ((int)((float)this.jdField_b_of_type_Long / 1024.0F * 8.0F / ((float)this.jdField_d_of_type_Long / 1000.0F)));
    }
    ThreadManager.post(new VideoPlayerWrapper.1(this, paramsgx), 5, null, false);
  }
  
  public void a(@NotNull sgx paramsgx, int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Sdk != null) {
      this.jdField_a_of_type_Sdk.a(this, false, paramInt2, paramInt1, null);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Sdk != null) {
      this.jdField_a_of_type_Sdk.a(this, true, 0, paramInt1, paramBitmap);
    }
  }
  
  public void a(shf paramshf)
  {
    if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Sgx.a(this.jdField_a_of_type_Shf);
    this.jdField_a_of_type_Sgx.a(this.jdField_d_of_type_Int);
  }
  ...
  public boolean a(String paramString)
  {
    ...
    this.jdField_a_of_type_Sgx = this.jdField_a_of_type_Sgz.a(paramString);
    if (this.jdField_a_of_type_Sgx != null)
    {
      this.i = false;
      this.jdField_a_of_type_Sgx.a(this);
  ...
  public boolean a(@NotNull sgx paramsgx, int paramInt1, int paramInt2, int paramInt3, @Nullable String paramString)
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(6);
    if (this.jdField_a_of_type_Sdk != null) {
      this.jdField_a_of_type_Sdk.a(this, paramInt2, paramInt3, paramInt1, paramString, null);
    }
    return false;
  }
  ...
  public boolean a(@NotNull sgx paramsgx, int paramInt, @Nullable Object paramObject)
  {
    ...
    {
      if (this.jdField_a_of_type_Sdk != null) {
        this.jdField_a_of_type_Sdk.a(this, paramInt, paramObject);
      }
      return false;
      if (QLog.isColorLevel()) {
      ...
      if (!this.jdField_c_of_type_Boolean)
      {
        ...
        {
          paramsgx = (TPPlayerMsg.TPMediaCodecInfo)paramObject;
          this.jdField_a_of_type_Rse.a(paramsgx);
        }
        bijk.c(new VideoPlayerWrapper.2(this));
        continue;
        if (this.jdField_a_of_type_Sdk != null) {
          this.jdField_a_of_type_Sdk.a(this, "");
        }
      }
    }
  }
  ...
  public long b()
  {
    ...
    if (this.jdField_a_of_type_Sgx != null) {
      return this.jdField_a_of_type_Sgx.a();
    }
    return -1L;
  }
  ...
  public View b()
  {
    ...
    View localView = this.jdField_a_of_type_Shf.a();
  ...
  public void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Sgx != null) {
      this.jdField_a_of_type_Sgx.a(paramInt);
    }
    if (QLog.isColorLevel()) {
  ...
  public void b(@NotNull sgx paramsgx)
  {
    if (QLog.isColorLevel()) {
    ...
    if (this.jdField_a_of_type_Sdk != null) {
      this.jdField_a_of_type_Sdk.b(this);
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Sgx != null) {
        ThreadManager.executeOnSubThread(new VideoPlayerWrapper.3(this, this.jdField_a_of_type_Sgx));
      }
      if ((paramBoolean) && (this.jdField_a_of_type_Shf != null) && (this.jdField_a_of_type_Shf.a() != null))
      {
        ViewParent localViewParent = this.jdField_a_of_type_Shf.a().getParent();
        if ((localViewParent instanceof ViewGroup)) {
          ((ViewGroup)localViewParent).removeView(this.jdField_a_of_type_Shf.a());
        }
      }
      this.jdField_a_of_type_Sdk = null;
      this.jdField_a_of_type_Shf = null;
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Sgx != null) {
      this.jdField_a_of_type_Sgx.a(paramBoolean);
    }
  }
  ...
  public void d()
  {
    ...
    do
    {
      ...
      if (!k())
      {
        QLog.e(this.jdField_b_of_type_JavaLangString, 1, "VideoPlayerWrapper: start failed, wrong state:" + sdi.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()) + ", just return;");
        return;
      }
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(3);
      this.jdField_a_of_type_Sgx.a();
    } while (!QLog.isColorLevel());
  ...
  public void d(boolean paramBoolean)
  {
    ...
    while ((this.jdField_a_of_type_Sgx == null) || (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() == 6) || (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() == 8)) {
      return;
    }
    this.jdField_a_of_type_Sgx.b(paramBoolean);
  }
  ...
  public void f()
  {
    ...
    {
      if (!k()) {
        QLog.e(this.jdField_b_of_type_JavaLangString, 1, "VideoPlayerWrapper: pause failed, wrong state:" + sdi.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()) + ", just return;");
      }
    }
    else {
      return;
  ...
  public int g()
  {
    if ((this.jdField_a_of_type_Sgx != null) && (this.jdField_b_of_type_Long != 0L)) {
  ...
  public void o()
  {
    ...
    this.i = true;
    if (this.jdField_a_of_type_Sgx != null) {
      this.jdField_a_of_type_Sgx.a(null);
    }
