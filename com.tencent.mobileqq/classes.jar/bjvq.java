  ...
  implements bjvs
{
  ...
  public bjvq(@NonNull bjxn parambjxn, int paramInt)
  {
    super(parambjxn);
    ...
    {
      tau.a().a("EditVideoDTextFace.mSrcFrom", this.jdField_a_of_type_JavaLangString);
      return;
    }
  }
  ...
  private void j()
  {
    ...
    bcql.a(a(), a().getString(2131698326), 0).a();
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_JavaUtilList = bjhi.a(0);
    if (TextUtils.isEmpty(this.b)) {
      this.b = ajya.a(2131703833);
    }
    bjhi.a(0, Collections.singletonList(this.b));
    this.jdField_a_of_type_Bjxn.a().a().postDelayed(new EditVideoDTextFace.1(this, localDynamicTextConfigManager), 1000L);
  }
      ...
      do
      {
        do
        {
          do
          {
            ...
            paramObject = (bjsu)a(bjsu.class);
          } while (paramObject == null);
          paramObject = paramObject.a();
        } while (paramObject == null);
        localbkba = paramObject.a();
      } while (localbkba == null);
      paramInt1 = 0;
      if (localbkba.a != null) {
  ...
  public void a(int paramInt, @NonNull bkld parambkld)
  {
    ...
    parambkld = ((bjsu)a(bjsu.class)).a().a();
    int i = parambkld.a.size();
    StringBuilder localStringBuilder = new StringBuilder();
    paramInt = 0;
    while (paramInt < i)
    {
      localStringBuilder.append(((bkbd)parambkld.a.get(paramInt)).a.c() + 1);
      if (paramInt < i - 1) {
        localStringBuilder.append(",");
      }
      paramInt += 1;
    }
    vei.a("video_edit_text", "pub_withText", 0, 0, new String[] { this.jdField_a_of_type_JavaLangString, localStringBuilder.toString(), String.valueOf(i), "" });
  }
  ...
  public void g()
  {
    ...
    {
      InputMethodManager localInputMethodManager = (InputMethodManager)this.jdField_a_of_type_Bjyv.getActivity().getSystemService("input_method");
      if ((localInputMethodManager != null) && (localInputMethodManager.isActive())) {
        localInputMethodManager.hideSoftInputFromWindow(this.jdField_a_of_type_Bjyv.a().getWindowToken(), 0);
      }
    }
    super.g();
    bjhi.a(0, this.jdField_a_of_type_JavaUtilList);
  }
  ...
  public void i()
  {
    if ((this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_a_of_type_AndroidViewView.getVisibility() == 8))
    {
      ...
      vei.a("video_edit_text", "exp_textWording", 0, 0, new String[] { this.jdField_a_of_type_JavaLangString, "", "", "" });
