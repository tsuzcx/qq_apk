  ...
  extends BitmapDrawable
{
  ...
  public agst(Resources paramResources, Bitmap paramBitmap)
  {
    super(paramResources, paramBitmap);
  }
  
  public static agst[] a(int paramInt, Resources paramResources, Bitmap paramBitmap)
  {
    if ((paramBitmap != null) && (paramResources != null))
    {
      agst[] arrayOfagst2 = new agst[paramInt];
      e = paramBitmap.getWidth() / 2;
      d = paramBitmap.getHeight() / 2;
      int i = 0;
      for (;;)
      {
        arrayOfagst1 = arrayOfagst2;
        if (i >= paramInt) {
          break;
        }
        arrayOfagst2[i] = new agst(paramResources, paramBitmap);
        i += 1;
      }
    }
    agst[] arrayOfagst1 = null;
    return arrayOfagst1;
  }
