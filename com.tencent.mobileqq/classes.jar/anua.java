...
public class anua
  extends ansq<CustomEmotionData>
{
  protected anua(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private void a(int paramInt, List<FavEmotionOcr.OcrInfo> paramList, asfk paramasfk, List<CustomEmotionData> paramList1)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (j < paramList.size())
      {
        ...
        Object localObject = localOcrInfo.pic_info;
        String str = ((FavEmotionOcr.PicInfo)localObject).string_pic_fileid.get();
        if ((paramInt == 3) && (QLog.isColorLevel())) {
          QLog.d("FavEmoRoamingHandler", 1, new Object[] { "handleOcrUpload words=", localOcrInfo.string_pic_ocr.get(), " md5=", ((FavEmotionOcr.PicInfo)localObject).string_pic_md5.get(), " self_decs=", localOcrInfo.string_self_desc.get(), " resid=" + str });
        }
        localObject = paramasfk.a(paramList1, str);
        int i = k;
        if (localObject != null)
        {
          i = m;
          if (localOcrInfo.string_pic_ocr.get() != null) {
            if (((CustomEmotionData)localObject).ocrWord != null)
            {
              i = m;
              if (((CustomEmotionData)localObject).ocrWord.equals(localOcrInfo.string_pic_ocr.get())) {}
            }
            else
            {
              m = 1;
              ((CustomEmotionData)localObject).ocrWord = localOcrInfo.string_pic_ocr.get();
              i = m;
              if (QLog.isColorLevel())
              {
                QLog.d("FavEmoRoamingHandler", 1, "handleOcrUpload old ocrWord=" + ((CustomEmotionData)localObject).ocrWord + " new ocrWord=" + localOcrInfo.string_pic_ocr.get());
                i = m;
              }
            }
          }
          ...
          if (localOcrInfo.string_self_desc.get() != null) {
            if (((CustomEmotionData)localObject).modifyWord != null)
            {
              m = i;
              if (((CustomEmotionData)localObject).modifyWord.equals(localOcrInfo.string_self_desc.get())) {}
            }
            else
            {
              i = 1;
              ((CustomEmotionData)localObject).modifyWord = localOcrInfo.string_self_desc.get();
              m = i;
              if (QLog.isColorLevel())
              {
                QLog.d("FavEmoRoamingHandler", 1, "handleOcrUpload old modifyWord=" + ((CustomEmotionData)localObject).modifyWord + " new modifyWord=" + localOcrInfo.string_self_desc.get());
                m = i;
              }
            }
          }
          ...
          if (m != 0)
          {
            paramasfk.b((CustomEmotionBase)localObject);
            i = 1;
          }
        }
        j += 1;
    ...
    do
    {
      ...
      if (i < paramList2.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localObject2 = new asfs((String)localObject1);
          if ((!((asfs)localObject2).a()) || (TextUtils.isEmpty(((asfs)localObject2).c)) || (TextUtils.isEmpty(((asfs)localObject2).d)))
          {
            if (QLog.isColorLevel()) {
      ...
      if (i < paramList1.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localasfs1 = new asfs((String)localObject2);
          if ((!localasfs1.a()) || (TextUtils.isEmpty(localasfs1.c)) || (TextUtils.isEmpty(localasfs1.d)))
          {
            if (QLog.isColorLevel()) {
            ...
            ((List)localObject1).add(localasfs1);
          }
        }
      }
      ...
      {
        localasfs1 = (asfs)localArrayList.get(i);
        int j = 0;
        while (j < ((List)localObject1).size())
        {
          asfs localasfs2 = (asfs)((List)localObject1).get(j);
          if ((localasfs1.c.equals(localasfs2.c)) && (localasfs2.c.equals("0")) && (localasfs2.d.equals(localasfs1.d)))
          {
            paramList1.remove(localasfs2.a);
            ((StringBuilder)localObject2).append(localasfs2.a).append(", ");
          }
          j += 1;
        }
        i += 1;
  ...
  public void a()
  {
    ...
    localPlatInfo.mqqver.set("8.4.10");
  ...
  public void a(CustomEmotionData paramCustomEmotionData, String paramString)
  {
    ...
    if ((this.app == null) || (this.app.getApp() == null))
    {
      ...
      notifyUI(3, false, this.mApp.getApplication().getString(2131691892));
      return;
    }
    if (!NetworkUtil.isNetworkAvailable())
    {
      notifyUI(3, false, this.app.getApp().getString(2131693647));
      return;
    }
    try
    {
      ...
      ((FavEmotionOcr.ReqBody)localObject1).string_version.set("8.4.10");
      ...
      try
      {
        ...
        if ((i != 0) && (paramObject.bytes_bodybuffer.has()) && (paramObject.bytes_bodybuffer.get() != null))
        {
          ...
          if (i < paramFromServiceMsg.size())
          {
            ...
            {
              paramObject = ((asfk)this.app.getManager(QQManagerFactory.FAVROAMING_DB_MANAGER)).a();
              if (paramObject != null)
              {
            ...
            {
              notifyUI(3, false, this.mApp.getApplication().getString(2131691898));
              if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (i != 0)
        {
          ...
          localHashMap.put("param_cmd_type", paramInt + "");
          localHashMap.put("param_version", Build.VERSION.SDK_INT + "");
          localHashMap.put("param_resultCode", paramObject.uint32_result.get() + "");
          ...
          if (paramFromServiceMsg.list_ocr_info.has())
          {
            ...
            paramObject = (asfk)this.app.getManager(QQManagerFactory.FAVROAMING_DB_MANAGER);
            a(paramInt, paramFromServiceMsg, paramObject, paramObject.a());
          }
        }
        else
        {
  ...
  public void a(Object paramObject, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((asfk)this.app.getManager(QQManagerFactory.FAVROAMING_DB_MANAGER)).c(localArrayList);
  ...
  public void a(List<CustomEmotionData> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localReqBody.string_version.set("8.4.10");
  ...
  public void b(List<String> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        asfs localasfs = new asfs((String)paramList.next());
        if (!TextUtils.isEmpty(localasfs.d)) {
          localArrayList.add(localasfs.d);
        }
      }
      if (localArrayList.size() > 0) {
        ((asgo)this.app.getManager(QQManagerFactory.MQQ_COMIC_MANAGER)).a(localArrayList);
      }
    }
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      ...
      if (i == 1)
      {
        paramToServiceMsg = (asfl)this.mApp.getManager(BusinessHandlerFactory.FAVEMO_ROAMING_HANDLER);
