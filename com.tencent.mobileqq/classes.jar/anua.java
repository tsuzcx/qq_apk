  ...
  implements anui
{
  ...
  private void j(int paramInt, boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    for (paramInt = ((Integer)paramArrayOfObject[0]).intValue(); (paramBoolean) && (paramArrayOfObject != null) && (paramArrayOfObject.length >= 4); paramInt = 2131695477)
    {
  ...
  private void l(int paramInt, boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    a((bftf)paramArrayOfObject[0], ((Integer)paramArrayOfObject[1]).intValue(), ((Integer)paramArrayOfObject[2]).intValue(), (String)paramArrayOfObject[3], (String)paramArrayOfObject[4], (Bundle)paramArrayOfObject[5]);
  }
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, ArrayList<bgps> paramArrayList, int paramInt4) {}
