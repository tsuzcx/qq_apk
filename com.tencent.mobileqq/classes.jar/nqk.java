  ...
  implements ampd<String>
{
  ...
  public static nqk a()
  {
    nqk localnqk = new nqk();
    localnqk.jdField_a_of_type_JavaLangString = sfh.jdField_d_of_type_JavaLangString;
    localnqk.jdField_b_of_type_JavaLangString = sfh.jdField_e_of_type_JavaLangString;
    localnqk.jdField_b_of_type_Boolean = sfh.jdField_a_of_type_Boolean;
    localnqk.jdField_c_of_type_Boolean = sfh.p;
    localnqk.jdField_a_of_type_Boolean = sfh.jdField_b_of_type_Boolean;
    localnqk.jdField_d_of_type_Boolean = sfh.jdField_e_of_type_Boolean;
    localnqk.jdField_e_of_type_Boolean = sfh.jdField_f_of_type_Boolean;
    localnqk.jdField_f_of_type_Boolean = sfh.jdField_g_of_type_Boolean;
    localnqk.jdField_g_of_type_Boolean = sfh.jdField_h_of_type_Boolean;
    localnqk.jdField_h_of_type_Boolean = sfh.jdField_i_of_type_Boolean;
    localnqk.jdField_i_of_type_Boolean = sfh.l;
    localnqk.j = sfh.j;
    localnqk.jdField_c_of_type_JavaLangString = sfh.jdField_f_of_type_JavaLangString;
    localnqk.jdField_a_of_type_Long = sfh.jdField_a_of_type_Long;
    localnqk.k = sfh.m;
    localnqk.jdField_a_of_type_Int = sfh.jdField_b_of_type_Int;
    localnqk.jdField_d_of_type_JavaLangString = sfh.jdField_i_of_type_JavaLangString;
    localnqk.l = sfh.n;
    localnqk.m = sfh.jdField_c_of_type_Boolean;
    localnqk.n = sfh.o;
    localnqk.jdField_a_of_type_JavaUtilArrayList = sfh.jdField_a_of_type_JavaUtilArrayList;
    localnqk.jdField_b_of_type_Int = sfh.jdField_c_of_type_Int;
    localnqk.jdField_c_of_type_Int = sfh.jdField_d_of_type_Int;
    localnqk.jdField_d_of_type_Int = sfh.jdField_e_of_type_Int;
    localnqk.o = sfh.k;
    Object localObject = sfh.jdField_g_of_type_JavaLangString;
    localnqk.jdField_e_of_type_JavaLangString = ((String)localObject);
    localnqk.jdField_f_of_type_JavaLangString = sfh.jdField_h_of_type_JavaLangString;
    try
    {
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if (((JSONObject)localObject).has("useNewLogic")) {
          b(localnqk, (JSONObject)localObject);
        }
        if (((JSONObject)localObject).has("releaseServiceMinMem")) {
          a(localnqk, (JSONObject)localObject);
        }
      }
      return localnqk;
    }
  ...
  private nqk a(nqk paramnqk, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString.has("service_folder_name")) {
          this.jdField_a_of_type_JavaLangString = paramnqk.jdField_a_of_type_JavaLangString;
        }
        if (paramString.has("service_folder_icon")) {
          this.jdField_b_of_type_JavaLangString = paramnqk.jdField_b_of_type_JavaLangString;
        }
        if (paramString.has("service_folder_redspots")) {
          this.jdField_a_of_type_Boolean = paramnqk.jdField_a_of_type_Boolean;
        }
        if (paramString.has("service_folder_delete")) {
          this.jdField_b_of_type_Boolean = paramnqk.jdField_b_of_type_Boolean;
        }
        if (paramString.has("ServiceFolder_RedClean_After_Enter")) {
          this.jdField_c_of_type_Boolean = paramnqk.jdField_c_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload")) {
          this.jdField_d_of_type_Boolean = paramnqk.jdField_d_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_wifi")) {
          this.jdField_e_of_type_Boolean = paramnqk.jdField_e_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_4G")) {
          this.jdField_f_of_type_Boolean = paramnqk.jdField_f_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_3G")) {
          this.jdField_g_of_type_Boolean = paramnqk.jdField_g_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_2G")) {
          this.jdField_h_of_type_Boolean = paramnqk.jdField_h_of_type_Boolean;
        }
        if (paramString.has("pub_account_bottom_bar")) {
          this.jdField_i_of_type_Boolean = paramnqk.jdField_i_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_image_preload")) {
          this.j = paramnqk.j;
        }
        if (paramString.has("kandian_feeds_fling_LToR_host")) {
          this.jdField_c_of_type_JavaLangString = paramnqk.jdField_c_of_type_JavaLangString;
        }
        if (paramString.has("kandian_ad_background_showtime")) {
          this.jdField_a_of_type_Long = paramnqk.jdField_a_of_type_Long;
        }
        ...
        {
          this.jdField_a_of_type_Int = paramnqk.jdField_a_of_type_Int;
          this.jdField_d_of_type_JavaLangString = paramnqk.jdField_d_of_type_JavaLangString;
        }
        ...
        if ((i1 != 0) && (paramString.has("host_white_list"))) {
          this.jdField_a_of_type_JavaUtilArrayList = paramnqk.jdField_a_of_type_JavaUtilArrayList;
        }
        if (paramString.has("album_predown_enable")) {
          this.jdField_b_of_type_Int = paramnqk.jdField_b_of_type_Int;
        }
        if (paramString.has("album_predown_photo_rule")) {
          this.jdField_c_of_type_Int = paramnqk.jdField_c_of_type_Int;
        }
        if (paramString.has("album_predown_slide_photocounts")) {
          this.jdField_d_of_type_Int = paramnqk.jdField_d_of_type_Int;
        }
        ...
        {
          this.jdField_e_of_type_JavaLangString = paramnqk.jdField_e_of_type_JavaLangString;
          this.p = paramnqk.p;
          this.jdField_e_of_type_Int = paramnqk.jdField_e_of_type_Int;
          this.jdField_f_of_type_Int = paramnqk.jdField_f_of_type_Int;
          this.jdField_g_of_type_Int = paramnqk.jdField_g_of_type_Int;
          this.jdField_h_of_type_Int = paramnqk.jdField_h_of_type_Int;
        }
        if (paramString.has("releaseServiceMinMem"))
        {
          this.jdField_f_of_type_JavaLangString = paramnqk.jdField_f_of_type_JavaLangString;
          this.jdField_i_of_type_Int = paramnqk.jdField_i_of_type_Int;
          return this;
        }
      }
      catch (JSONException paramnqk)
      {
        paramnqk.printStackTrace();
      }
    }
    return this;
  }
  
  public static nqk a(ampi[] paramArrayOfampi)
  {
    Object localObject1 = new nqk();
    ...
    if (paramArrayOfampi != null)
    {
      ...
      if (paramArrayOfampi.length > 0)
      {
        ...
        for (;;)
        {
          if (i1 >= paramArrayOfampi.length) {
            break label94;
          }
          str = paramArrayOfampi[i1].jdField_a_of_type_JavaLangString;
          try
          {
            localObject2 = ((nqk)localObject1).a((nqk)ampw.a(str, nqk.class), str);
  ...
  private static void a(nqk paramnqk, JSONObject paramJSONObject)
  {
    paramnqk.jdField_i_of_type_Int = paramJSONObject.optInt("releaseServiceMinMem", 80);
  }
  ...
  private static void b(nqk paramnqk, JSONObject paramJSONObject)
  {
    paramnqk.p = paramJSONObject.optBoolean("useNewLogic", false);
    paramnqk.jdField_e_of_type_Int = paramJSONObject.optInt("minTotalMem", 1024);
    paramnqk.jdField_f_of_type_Int = paramJSONObject.optInt("minAvailableMem", 100);
    paramnqk.jdField_g_of_type_Int = paramJSONObject.optInt("minCpuNum", 2);
    paramnqk.jdField_h_of_type_Int = paramJSONObject.optInt("minCpuFreq", 1000);
  }
  ...
  public void b()
  {
    sfh.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    sfh.jdField_e_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
    sfh.jdField_a_of_type_Boolean = this.jdField_b_of_type_Boolean;
    sfh.p = this.jdField_c_of_type_Boolean;
    sfh.jdField_b_of_type_Boolean = this.jdField_a_of_type_Boolean;
    sfh.jdField_e_of_type_Boolean = this.jdField_d_of_type_Boolean;
    sfh.jdField_f_of_type_Boolean = this.jdField_e_of_type_Boolean;
    sfh.jdField_g_of_type_Boolean = this.jdField_f_of_type_Boolean;
    sfh.jdField_h_of_type_Boolean = this.jdField_g_of_type_Boolean;
    sfh.jdField_i_of_type_Boolean = this.jdField_h_of_type_Boolean;
    sfh.l = this.jdField_i_of_type_Boolean;
    sfh.j = this.j;
    sfh.jdField_f_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
    sfh.jdField_a_of_type_Long = this.jdField_a_of_type_Long;
    sfh.m = this.k;
    sfh.jdField_b_of_type_Int = this.jdField_a_of_type_Int;
    sfh.jdField_i_of_type_JavaLangString = this.jdField_d_of_type_JavaLangString;
    sfh.n = this.l;
    sfh.jdField_c_of_type_Boolean = this.m;
    sfh.o = this.n;
    sfh.jdField_a_of_type_JavaUtilArrayList = this.jdField_a_of_type_JavaUtilArrayList;
    sfh.jdField_c_of_type_Int = this.jdField_b_of_type_Int;
    sfh.jdField_d_of_type_Int = this.jdField_c_of_type_Int;
    sfh.jdField_e_of_type_Int = this.jdField_d_of_type_Int;
    sfh.k = this.o;
    sfh.jdField_g_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
    sfh.jdField_h_of_type_JavaLangString = this.jdField_f_of_type_JavaLangString;
  }
  ...
  public void c()
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      sfh.b((QQAppInterface)localAppRuntime);
    }
  }
}
