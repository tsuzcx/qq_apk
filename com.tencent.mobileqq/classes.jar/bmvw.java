...
public class bmvw
{
  private static bmvw jdField_a_of_type_Bmvw;
  ...
  private Downloader.DownloadListener jdField_a_of_type_ComTencentComponentNetworkDownloaderDownloader$DownloadListener = new bmvx(this);
  private final MultiHashMap<String, bmvy> jdField_a_of_type_CooperationQzoneUtilMultiHashMap = new MultiHashMap();
  
  static
  {
    jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    jdField_a_of_type_JavaUtilArrayList.add("https://qzonestyle.gtimg.cn/qzone/phone/n/QQ-Qzone-Android/qzone_yellow_icon_v6.zip");
  ...
  private blum a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 88	bmvw:jdField_a_of_type_Blum	Lblum;
    //   6: ifnull +12 -> 18
    //   9: aload_0
    //   10: getfield 88	bmvw:jdField_a_of_type_Blum	Lblum;
    //   13: astore_1
    //   14: aload_0
    //   15: monitorexit
    //   16: aload_1
    //   17: areturn
    //   18: aload_0
    //   19: invokestatic 92	blum:a	()Lblum;
    //   22: putfield 88	bmvw:jdField_a_of_type_Blum	Lblum;
    //   25: aload_0
    //   26: getfield 88	bmvw:jdField_a_of_type_Blum	Lblum;
    //   29: astore_1
    //   30: goto -16 -> 14
    //   33: astore_1
    //   34: aload_0
  ...
  public static bmvw a()
  {
    if (jdField_a_of_type_Bmvw == null) {}
    try
    {
      if (jdField_a_of_type_Bmvw == null) {
        jdField_a_of_type_Bmvw = new bmvw();
      }
      return jdField_a_of_type_Bmvw;
    }
    finally {}
  }
  
  private bmvy a(String paramString1, int paramInt, String paramString2, bmvz parambmvz)
  {
    return bmvy.a(paramString1, paramInt, paramString2, new WeakReference(parambmvz));
  }
  
  private Collection<bmvy> a(String paramString, boolean paramBoolean)
  {
    return a(paramString, paramBoolean, null);
  }
  
  private Collection<bmvy> a(String paramString, boolean paramBoolean, Collection<bmvy> paramCollection)
  {
  ...
  private void a(bmvy parambmvy)
  {
    if (URLUtil.isNetworkUrl(parambmvy.b))
    {
      String str = c(parambmvy.b);
      a().a(parambmvy.b, str, true, this.jdField_a_of_type_ComTencentComponentNetworkDownloaderDownloader$DownloadListener);
    }
  }
  ...
  private boolean a(String paramString, bmvy parambmvy)
  {
    for (;;)
    {
      synchronized (this.jdField_a_of_type_CooperationQzoneUtilMultiHashMap)
      {
        ...
        this.jdField_a_of_type_CooperationQzoneUtilMultiHashMap.add(paramString, parambmvy);
        if (i == 0)
        {
          bool = true;
          return bool;
  ...
  private static File b(String paramString)
  {
    ...
    for (paramString = b + bmvn.a(paramString);; paramString = b + bmvn.b(paramString)) {
  ...
  private static File b(String paramString1, String paramString2)
  {
    ...
    for (paramString1 = b + bmvn.a(paramString1) + File.separator + paramString2 + ".png";; paramString1 = b + bmvn.b(paramString1) + File.separator + paramString2 + ".png") {
  ...
  private static String c(String paramString)
  {
    ...
    if (jdField_a_of_type_JavaUtilArrayList.contains(paramString)) {}
    for (paramString = bmvn.a(paramString) + ".zip";; paramString = bmvn.b(paramString) + ".zip") {
  ...
  private static void c(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      a(localFile);
      bmij.b(new File(paramString), localFile);
    }
  }
  ...
  /* Error */
  public Bitmap a(String paramString1, int paramInt, String paramString2, bmvz parambmvz)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 7
    ...
    //   12: areturn
    //   13: aload_0
    //   14: getfield 84	bmvw:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    ...
    //   58: aload_1
    //   59: aload_3
    //   60: invokestatic 116	bmvw:b	(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    //   63: astore 8
    //   65: aload 5
    //   67: astore 6
    //   69: aload 8
    //   71: invokestatic 237	bmvw:c	(Ljava/io/File;)Z
    //   74: ifeq +167 -> 241
    //   77: aload_0
    //   78: monitorenter
    //   79: aload 5
    //   81: astore 6
    //   83: aload_0
    //   84: getfield 84	bmvw:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    ...
    //   147: aconst_null
    //   148: invokestatic 300	bmvn:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   151: astore 7
    //   153: aload 7
    //   155: astore 5
    //   157: aload_0
    ...
    //   165: ifnull +76 -> 241
    //   168: aload_0
    //   169: getfield 84	bmvw:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    ...
    //   244: aload_3
    //   245: aload 4
    //   247: invokespecial 100	bmvw:a	(Ljava/lang/String;ILjava/lang/String;Lbmvz;)Lbmvy;
    //   250: astore_3
    //   251: aload 6
    //   253: astore 7
    //   255: aload_0
    //   256: aload_1
    //   257: aload_3
    //   258: invokespecial 186	bmvw:a	(Ljava/lang/String;Lbmvy;)Z
    //   261: ifeq -251 -> 10
    //   264: aload_0
    //   265: aload_3
    //   266: invokespecial 151	bmvw:a	(Lbmvy;)V
    //   269: aload 6
    //   271: areturn
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public Drawable a(String paramString1, int paramInt, String paramString2, bmvz parambmvz)
  {
    return a(paramString1, paramInt, paramString2, false, parambmvz);
  }
  
  public Drawable a(String paramString1, int paramInt, String paramString2, boolean paramBoolean, bmvz parambmvz)
  {
    ...
    paramString1 = b(paramString1, paramInt, paramString2, parambmvz);
    if (paramString1 != null)
    {
      paramString1.setDensity(320);
      paramString1 = new BitmapDrawable(paramString1);
      paramString1.setTargetDensity((int)bgtn.c());
      return paramString1;
    }
    if (parambmvz != null) {
      try
  ...
  public String a(String paramString, bmvz parambmvz)
  {
    ...
    parambmvz = a(paramString, 999, str, parambmvz);
    if (a(paramString, parambmvz)) {
      a(parambmvz);
    }
    return null;
  }
  ...
  {
    if (jdField_a_of_type_JavaUtilArrayList.contains(paramString)) {
      paramString = b + bmvn.a(paramString) + File.separator;
    }
    try
    {
      for (;;)
      {
        ...
        return true;
        paramString = b + bmvn.b(paramString) + File.separator;
      }
      return false;
    }
  ...
  public Bitmap b(String paramString1, int paramInt, String paramString2, bmvz parambmvz)
  {
    Object localObject;
    ...
    QzoneHandlerThreadFactory.getHandlerThread("BackGround_HandlerThread").postDelayed(new ZipResDownloadManager.2(this, paramString1, paramString2, parambmvz, paramInt), 400L);
    return localBitmap;
  }
}
