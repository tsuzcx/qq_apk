...
{
  final Runnable jdField_a_of_type_JavaLangRunnable = new anrc(this);
  ...
  public void a()
  {
    ...
    {
      ThreadManager.post(new anra(this, localRMVideoStateMgr), 8, null, false);
  ...
  public void a(AVCodec.AVCodecCallback paramAVCodecCallback, MessageStruct paramMessageStruct)
  {
    ...
    paramAVCodecCallback.jdField_a_of_type_Anqw = null;
    if (QLog.isColorLevel()) {
    ...
    paramAVCodecCallback.jdField_a_of_type_AndroidOsHandler.post(new anre(this));
    e();
  }
    ...
    for (;;)
    {
      ...
      if (paramVarArgs != null) {
        if ((paramVarArgs[0] instanceof Boolean))
        {
          ...
          ThreadManager.post(new anrf(this), 8, null, true);
        }
                    ...
                    case 3: 
                      ...
                      else
                      {
                        ...
                        if (((RMVideoStateMgr)localObject).jdField_a_of_type_AndroidOsHandler != null) {
                          ((RMVideoStateMgr)localObject).jdField_a_of_type_AndroidOsHandler.post(new anrg(this));
                        }
  ...
  void d()
  {
    ...
    localRMVideoStateMgr.jdField_a_of_type_AndroidOsHandler.postDelayed(new anrb(this), 50L);
  }
  ...
  void e()
  {
    ...
    if (b())
    {
      ...
      localRMVideoStateMgr.jdField_a_of_type_AndroidOsHandler.post(new anrd(this));
    }
  }
