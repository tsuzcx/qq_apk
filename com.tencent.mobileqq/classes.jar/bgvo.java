  ...
  extends WebViewClient
{
  ...
  public void onPageStarted(WebView paramWebView, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramWebView = new Bundle();
          paramWebView.putStringArrayList("recognised-text", bgxg.a());
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    for (;;)
    {
      aewt.b(this.b.jdField_a_of_type_AndroidContentIntent, str);
      paramString = bgyb.b(str);
      if ((this.b.jdField_a_of_type_Bguk == null) || (!this.b.jdField_a_of_type_Bguk.beforeWebViewEngineHandleOverrideUrl(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, str))) {
        break label298;
      }
      ...
      break;
      label261:
      QLog.d("WebLog_WebViewWrapper", 2, "shouldOverrideUrlLoading:" + npn.b(str, new String[0]));
    }
    label298:
    ...
    try
    {
      ...
      if ((this.b.jdField_a_of_type_Bguk != null) && (this.b.jdField_a_of_type_Bguk.shouldOverrideUrlLoading(paramWebView, str))) {
        return true;
      }
      ...
      {
        boolean bool = this.b.jdField_a_of_type_Bguk.afterWebViewEngineHandleOverrideUrl(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, str);
        if (bool) {
          return true;
        }
      }
