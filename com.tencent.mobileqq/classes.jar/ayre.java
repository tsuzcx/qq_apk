  ...
  implements SensorEventListener, Handler.Callback
{
  ...
  protected volatile ayqa a;
  private ayqn jdField_a_of_type_Ayqn;
  private ayqq jdField_a_of_type_Ayqq = new ayqq("step", ayqi.B);
  private ayrg jdField_a_of_type_Ayrg;
  protected String a;
  private double b;
  protected int b;
  protected long b;
  ...
  ayre(int paramInt)
  {
    ...
    this.jdField_a_of_type_Ayqa = new ayqa(40001);
    this.jdField_a_of_type_Ayqq.a(new ayrf(this));
    this.d = paramInt;
  ...
  private void e()
  {
    ...
    int i = c();
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_a_of_type_JavaLangString, 2, new Object[] { "[status][step] notifyCheckStatus notmoving:", Boolean.valueOf(bool), " status:", ayqi.a(i) });
    }
    if ((bool) || (i == 41042)) {
  ...
  public int a()
  {
    ...
    if ((this.jdField_a_of_type_Double > 0.0D) && (d1 > ayqi.y * ayqi.B))
    {
      if (QLog.isColorLevel()) {
    ...
    return this.jdField_a_of_type_Ayqa.jdField_a_of_type_Int;
  }
  ...
  protected void a()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Double > 0.0D)
      {
        ...
        this.jdField_a_of_type_Ayqq.a(d1);
  ...
  void a(Application paramApplication)
  {
    ...
    this.jdField_a_of_type_Ayqa.a("step");
  ...
  void a(ayrg paramayrg)
  {
    this.jdField_a_of_type_Ayrg = paramayrg;
  }
  ...
  public boolean a()
  {
    ...
    return (this.jdField_b_of_type_Int < ayqi.M) && (System.currentTimeMillis() - this.jdField_b_of_type_Long > 60000L) && (this.jdField_a_of_type_Int < ayqi.M) && (this.jdField_b_of_type_Long > 0L);
  }
  ...
  public int b()
  {
    ...
    } while ((this.jdField_a_of_type_Int < ayqi.M) && (this.jdField_b_of_type_Int < ayqi.M) && (this.jdField_c_of_type_Int < ayqi.M));
    return 0;
  }
  
  boolean b()
  {
    if ((this.jdField_a_of_type_Ayqa.jdField_a_of_type_Int == 41012) || (this.jdField_a_of_type_Ayqa.jdField_a_of_type_Int == 41013)) {
      if (this.jdField_c_of_type_Long <= 0L)
      {
        if (QLog.isColorLevel()) {
          QLog.d(this.jdField_a_of_type_JavaLangString, 2, "[status][step] recordStepStartTime. start step mStatus: " + this.jdField_a_of_type_Ayqa);
        }
    ...
    {
      return false;
      if ((this.jdField_a_of_type_Ayrg != null) && (this.jdField_a_of_type_Ayrg.a()))
      {
        long l = System.currentTimeMillis() - this.jdField_c_of_type_Long;
        if (l >= this.jdField_a_of_type_Ayrg.a())
        {
          if (QLog.isColorLevel()) {
          ...
          this.jdField_a_of_type_Ayrg.a(this.jdField_c_of_type_Long, l);
          return true;
          if (QLog.isColorLevel()) {
            QLog.d(this.jdField_a_of_type_JavaLangString, 2, "[status][step] recordStepStartTime. stop status: " + this.jdField_a_of_type_Ayqa);
          }
          this.jdField_c_of_type_Long = 0L;
        }
      }
  ...
  public int c()
  {
    ...
    {
      return j;
      if (this.jdField_a_of_type_Int < ayqi.M)
      {
        i = j;
        if (this.jdField_b_of_type_Int < ayqi.M) {}
      }
      else
      {
        i = j;
