...
public class awjx
  extends akiy
{
  public awjx(UniteSearchActivity paramUniteSearchActivity) {}
  
  private void a(awpo paramawpo)
  {
    if (paramawpo == null) {
      return;
    }
    ...
    for (;;)
    {
      ...
      String str = awti.a(i, paramawpo.c(), paramawpo.g, bool);
      if (QLog.isColorLevel()) {
  ...
  private void a(List<awoh> paramList)
  {
    if (paramList != null)
    {
      ...
      {
        paramList = (awoh)localIterator1.next();
        if ((paramList != null) && (paramList.a() != null) && (paramList.a().equals(xfo.c)))
        {
          ...
          if (paramList != null)
          {
            ...
            {
              paramList = (awoi)localIterator2.next();
              if ((paramList != null) && ((paramList instanceof awor)))
              {
                paramList = (awor)paramList;
            ...
            {
              axqy.b(localQQAppInterface, "dc00898", "", paramList, "auth_search", "exp", 0, 0, "", "", "", "");
              break label76;
              break;
            }
          }
  ...
  private void b(awpo paramawpo)
  {
    ...
    if (paramawpo.c())
    {
      awsq.a(this.a.app, this.a.jdField_a_of_type_Int, this.a.jdField_c_of_type_Int, "0X8009D2C", i, 0, paramawpo.g);
      return;
    }
    awsq.a(this.a.app, this.a.jdField_a_of_type_Int, this.a.jdField_c_of_type_Int, "0X8009D40", i, 0, paramawpo.g);
  }
  
  private void b(List<awoh> paramList)
  {
    if (paramList == null) {
      label4:
      return;
    ...
    for (;;)
    {
      ...
      Object localObject1 = (awoh)paramList.next();
      if ((((awoh)localObject1).a() == null) || (((awoh)localObject1).a().size() == 0)) {
        break;
      }
      Object localObject2 = ((awoh)localObject1).a().iterator();
      while (((Iterator)localObject2).hasNext())
      {
        awoi localawoi = (awoi)((Iterator)localObject2).next();
        if ((localawoi instanceof awoj)) {
          ((awoj)localawoi).b(this.a.jdField_a_of_type_Int);
        }
      }
      if (!(localObject1 instanceof awob)) {
        break;
      }
      localObject1 = ((awoh)localObject1).a().iterator();
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (awoi)((Iterator)localObject1).next();
        if ((localObject2 instanceof awpo))
        {
          int i = ((awpo)localObject2).f();
          if (!awtm.a().a(i))
          {
  ...
  public void a(String paramString, int paramInt, List<awky> paramList, List<UnifySearchAssociationWord.SuggestUrlItem> paramList1, UnifySearchAssociationWord.SuggestUrlItem paramSuggestUrlItem)
  {
    if (paramString.equals(this.a.f))
    {
      ...
      awsq.a(null, new ReportModelDC02528().module("all_result").action("exp_thinkword_list").ver1(this.a.a()).ver2(awsq.a(this.a.jdField_c_of_type_Int)).ver4(localStringBuilder.toString()).ver7("{experiment_id:" + awsq.b + "}"));
    }
  }
  ...
  public void a(String paramString1, boolean paramBoolean1, String paramString2, byte[] paramArrayOfByte, boolean paramBoolean2, List<awoc> paramList, List<awoh> paramList1)
  {
    for (;;)
    {
      ...
      {
        if ((paramList.size() > 0) && ((((awoc)paramList.get(0)).jdField_a_of_type_JavaLangString.equals(ajya.a(2131715913))) || ((((awoc)paramList.get(0)).jdField_a_of_type_JavaUtilList != null) && (((awoc)paramList.get(0)).jdField_a_of_type_JavaUtilList.size() == 0)))) {
          paramList.remove(0);
        }
        this.a.jdField_c_of_type_AndroidViewView.setVisibility(0);
        this.a.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
