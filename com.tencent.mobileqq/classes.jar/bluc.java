  ...
  implements Manager
{
  ...
  public bluc(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_JavaUtilHashSet = new HcePluginManager.1(this);
  }
  
  public static bluc a()
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if ((localAppRuntime instanceof QQAppInterface)) {
      return (bluc)((QQAppInterface)localAppRuntime).getManager(QQManagerFactory.HCE_PLUGIN_MANAGER);
    }
    return null;
  }
  ...
  public int a(byte[] paramArrayOfByte)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      byte[] arrayOfByte = bltz.a(str);
      if (QLog.isColorLevel()) {
        QLog.i("HcePluginManager", 2, "aidApdu: " + bltz.a(arrayOfByte) + " commandApdu" + bltz.a(paramArrayOfByte));
      }
  ...
  {
    this.jdField_a_of_type_Blud = null;
  }
}
