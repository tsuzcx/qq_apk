...
public class agyv
  extends agyw
{
  private static final Set<WeakReference<agyv>> jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
  private SessionInfo jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
  public WeakReference<MessageForArkApp> a;
  public boolean a;
  protected WeakReference<agyv> b = new WeakReference(this);
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            {
              return null;
              localObject = (agyv)((WeakReference)localObject).get();
            } while (localObject == null);
            localObject = ((agyv)localObject).jdField_a_of_type_JavaLangRefWeakReference;
          } while (localObject == null);
  ...
  public static void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      Object localObject2 = (agyv)((WeakReference)localObject2).get();
      ((agyv)localObject2).doOnEvent(paramInt);
      if (paramInt == 2) {
        b((agyv)localObject2);
      }
    }
  ...
  public static void a(agyv paramagyv)
  {
    if (paramagyv == null) {
      return;
    }
    synchronized (jdField_a_of_type_JavaUtilSet)
    {
      jdField_a_of_type_JavaUtilSet.remove(paramagyv.b);
      return;
    }
  }
  
  public static void b(agyv paramagyv)
  {
    WeakReference localWeakReference = paramagyv.jdField_a_of_type_JavaLangRefWeakReference;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((MessageForArkApp)localWeakReference.get()).arkContainer = null;
    }
    localWeakReference = paramagyv.f;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((RecommendCommonMessage)localWeakReference.get()).mOldAppInfo.mArkContainer = null;
    }
    localWeakReference = paramagyv.g;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((RecommendCommonMessage.ArkMsgAppInfo)localWeakReference.get()).mArkContainer = null;
    }
    paramagyv = paramagyv.jdField_e_of_type_JavaLangRefWeakReference;
    if ((paramagyv != null) && (paramagyv.get() != null)) {
      ((ArkBabyqCardInfo)paramagyv.get()).mArkBabyqContainer = null;
    }
  }
