  ...
  implements Manager
{
  ...
  private agyl jdField_a_of_type_Agyl;
  ...
  private List<agya> jdField_a_of_type_JavaUtilList;
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = ThreadManager.getFileThreadHandler();
  private volatile boolean jdField_a_of_type_Boolean;
  private final agyy jdField_b_of_type_Agyy = new agyw(this);
  private File jdField_b_of_type_JavaIoFile;
  private List<agxz> jdField_b_of_type_JavaUtilList = new CopyOnWriteArrayList();
  private boolean jdField_b_of_type_Boolean = true;
  private File c;
  private File d;
  
  public agyv(QQAppInterface paramQQAppInterface)
  {
    ...
    a(new agyu(paramQQAppInterface));
    this.jdField_a_of_type_Agyl = new agyl(paramQQAppInterface);
    a(this.jdField_a_of_type_Agyl);
    this.jdField_a_of_type_Agys = new agys(paramQQAppInterface);
    a(this.jdField_a_of_type_Agys);
  }
  ...
  public static agyv a(QQAppInterface paramQQAppInterface)
  {
    return (agyv)paramQQAppInterface.getManager(314);
  }
  ...
  public static File a(String paramString)
  {
    try
    {
      ...
      paramString = new File(agyo.jdField_a_of_type_JavaLangString + paramString);
      return paramString;
    }
  ...
  private List<agxz> a(List<agxz> paramList, StickerRecommendSortEntity paramStickerRecommendSortEntity)
  {
    int i2 = 0;
    int j;
    int m;
    ...
    if (paramStickerRecommendSortEntity != null)
    {
      try
      {
        ...
        arrayOfagxz[i] = ((agxz)paramList.get(i1));
        i += 1;
      }
      ...
      if (n < m)
      {
        ...
        arrayOfagxz[i] = ((agxz)paramList.get(j));
        i += 1;
        break label460;
      }
    }
    for (;;)
    {
      if (i1 < k)
      {
        ...
        if ((i < i3) && (j < i3))
        {
          arrayOfagxz[j] = ((agxz)paramList.get(i));
          i = j + 1;
          break label469;
        }
      }
      ...
      {
        paramList = Arrays.asList(arrayOfagxz);
        return paramList;
        return null;
      }
      i = j;
  ...
  private void a(String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    for (boolean bool = true;; bool = false) {
      for (;;)
      {
        ...
        ((baub)localObject).jdField_a_of_type_Baug = new agyx(this, paramString2, bool, paramString3);
        ((baub)localObject).jdField_a_of_type_JavaLangString = paramString1;
        ((baub)localObject).jdField_a_of_type_Int = 0;
        ((baub)localObject).jdField_c_of_type_JavaLangString = this.d.getAbsolutePath();
        ...
        try
        {
          ...
          ((QQAppInterface)paramString2).getNetEngine(0).a((bave)localObject);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void a(boolean paramBoolean, long paramLong)
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      azri.a(BaseApplication.getContext()).a(null, "StickerRecInitCost", paramBoolean, 0L, 0L, localHashMap, "");
      return;
    }
  }
  ...
  private void a(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (this.jdField_a_of_type_JavaUtilList != null))
    {
      ...
      {
        Object localObject = (agya)localIterator.next();
        if (((agya)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString))
        {
          localObject = ((agya)localObject).a(paramString);
          if ((localObject != null) && (!((List)localObject).isEmpty())) {
            localArrayList.addAll((Collection)localObject);
          }
        }
      }
      paramString = agyb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList);
      ...
      while (paramString.hasNext()) {
        ((agxz)paramString.next()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      if (QLog.isColorLevel()) {
  ...
  private void a(byte[] paramArrayOfByte)
  {
    try
    {
      ...
      else
      {
        ...
        localObject = bdne.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "words_version_key805_gray_one", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("StickerRecManager", 2, bhsw.a(paramArrayOfByte));
        return;
        if (QLog.isColorLevel()) {
  ...
  private void a(byte[] paramArrayOfByte, String paramString1, String paramString2, boolean paramBoolean, StickerRecommendSortEntity paramStickerRecommendSortEntity)
  {
    ...
    while (i < localList.size())
    {
      ...
      localagyp.f(localImgInfo.uint32_src_type.get());
      localagyp.f(localImgInfo.bytes_src_desc.get().toStringUtf8());
      localagyp.g(localImgInfo.bytes_web_url.get().toStringUtf8());
      localagyp.h("");
      localagyp.i(localImgInfo.bytes_pack_name.get().toStringUtf8());
      localagyp.g(localImgInfo.uint32_pack_id.get());
      paramArrayOfByte.add(localagyp);
      i += 1;
    }
    ...
    for (paramArrayOfByte = localRspBody.bytes_rsp_other.get().toStringUtf8();; paramArrayOfByte = "999")
    {
      if (paramBoolean)
      {
        this.jdField_b_of_type_Agyy.a(paramStickerRecommendSortEntity, paramString1, paramArrayOfByte);
        return;
      }
      if (this.jdField_a_of_type_Agyy != null)
      {
        this.jdField_a_of_type_Agyy.a(paramStickerRecommendSortEntity, paramString1, paramArrayOfByte);
        return;
        break;
      }
      return;
  ...
  public static boolean a(agxz paramagxz)
  {
    return paramagxz.a();
  }
  ...
  public static boolean b(agxz paramagxz)
  {
    return !a(paramagxz);
  }
  ...
  public static String d(String paramString)
  {
    ...
    {
      paramString = Utils.Crc64String(paramString);
      paramString = agyo.jdField_a_of_type_JavaLangString + paramString;
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  {
    Object localObject = new File(agyo.jdField_a_of_type_JavaLangString);
  ...
  private void i()
  {
    azri.a(BaseApplication.getContext()).a(null, "StickerRecEmptyImg", false, 0L, 0L, null, "");
  }
  ...
  {
    return banh.i(bdnn.c(banh.a(paramString)).toLowerCase());
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      try
      {
        if (bdhb.a(this.c.getAbsolutePath())) {
          break label116;
        }
    ...
    if (QLog.isColorLevel())
    {
      QLog.d("StickerRecManager", 2, bhsw.a(localException1));
    ...
    l2 = bdne.o(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    if ((!bdhb.a(this.jdField_b_of_type_JavaIoFile.getAbsolutePath())) || ((l2 != 0L) && (System.currentTimeMillis() - l2 >= 86400000L)))
    {
      bdne.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 0L);
      localObject1 = new HashSet();
      localObject2 = this.jdField_a_of_type_Aufn.b();
      localList = this.jdField_a_of_type_Aufn.jdField_a_of_type_JavaUtilList;
      ...
      {
        arso.c(this.jdField_b_of_type_JavaIoFile.getAbsolutePath());
    ...
    for (;;)
    {
      ...
      if (localObject1 != null) {
        this.jdField_a_of_type_ComTencentMobileqqDataCard = ((alto)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      }
  ...
  public void a(agya paramagya)
  {
    ...
    } while (this.jdField_a_of_type_JavaUtilList.contains(paramagya));
    this.jdField_a_of_type_JavaUtilList.add(paramagya);
  }
  
  public void a(agyy paramagyy)
  {
  ...
  protected void a(Context paramContext, String paramString)
  {
    try
    {
      this.jdField_b_of_type_Boolean = bdne.E(paramContext, paramString);
      return;
    }
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        QLog.d("StickerRecManager", 2, bhsw.a(paramIntent));
        continue;
      }
      finally {}
      label122:
      ...
      {
        ((amjx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285)).a(paramFromServiceMsg);
        continue;
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 65	agyv:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: astore 5
    //   8: aload 5
    //   10: ifnonnull +6 -> 16
    //   13: aload_0
    ...
    //   59: astore 7
    //   61: aload_0
    //   62: getfield 65	agyv:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   65: invokevirtual 91	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   68: invokestatic 1138	apao:a	(Landroid/content/Context;)Ljava/lang/String;
    //   71: astore 8
    ...
    //   275: dup
    //   276: aload_0
    //   277: getfield 65	agyv:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   312: pop
    //   313: aload_0
    //   314: getfield 65	agyv:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   317: aload 5
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataCard != null)
        {
          ...
          localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), agza.class);
  ...
  public void a(List<agzb> paramList, boolean paramBoolean, int paramInt, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      localObject2 = (agzb)localIterator.next();
      if (localObject2 != null)
      {
        str1 = ((agzb)localObject2).jdField_a_of_type_JavaLangString;
        localObject1 = ((agzb)localObject2).jdField_a_of_type_JavaUtilList;
        ...
        {
          localObject1 = (agxz)((Iterator)localObject5).next();
          if (((agxz)localObject1).b() != null)
          {
            String str2 = ((agxz)localObject1).c();
            if (!TextUtils.isEmpty(str2)) {
              ((StringBuilder)localObject4).append(str2);
            }
            ((StringBuilder)localObject4).append(((agxz)localObject1).b());
            ((StringBuilder)localObject4).append(";");
            if (((agxz)localObject1).a() != null)
            {
              ((StringBuilder)localObject3).append(((agxz)localObject1).a());
              ((StringBuilder)localObject3).append(";");
            }
            if (!((agxz)localObject1).b()) {
              break label599;
            }
            paramList = (List<agzb>)localObject1;
          }
        }
      }
    }
    ...
    for (;;)
    {
      ...
      localObject3 = new agyz();
      ((agyz)localObject3).l = "dc04577";
      ((agyz)localObject3).jdField_b_of_type_JavaLangString = str1;
      ((agyz)localObject3).k = ((agzb)localObject2).jdField_b_of_type_JavaLangString;
      ((agyz)localObject3).jdField_c_of_type_JavaLangString = String.valueOf(AppSetting.a());
      ((agyz)localObject3).jdField_a_of_type_JavaLangString = String.valueOf(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
      if (paramList != null)
      {
        ...
        ((agyz)localObject3).f = ((String)localObject1);
        ((agyz)localObject3).g = paramList.a();
      }
      ((agyz)localObject3).d = ((String)localObject4);
      ((agyz)localObject3).e = ((String)localObject5);
      if (paramBoolean)
      {
        if (paramInt != 0) {
          break label536;
        }
        ((agyz)localObject3).h = "c2c";
      }
      for (;;)
      {
        ((agyz)localObject3).j = paramString;
        ((agyz)localObject3).i = "android";
        paramList = ((agyz)localObject3).a();
        localObject1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), agza.class);
        ((NewIntent)localObject1).putExtra("key_cmd", "MQInference.CommonReport");
        ((NewIntent)localObject1).putExtra("key_body", bdpd.a(paramList.toString().getBytes()));
        if (QLog.isColorLevel())
        {
          ((agyz)localObject3).jdField_b_of_type_JavaLangString = c(((agyz)localObject3).jdField_b_of_type_JavaLangString);
          QLog.d("StickerRecManager", 2, "report content:" + ((agyz)localObject3).a().toString());
        }
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject1);
        break label22;
        break;
        if (paramInt == 1) {
          ((agyz)localObject3).h = "group";
        } else if (paramInt == 3000) {
          ((agyz)localObject3).h = "discuss";
        } else if (paramInt == 11000) {
          ((agyz)localObject3).h = "qzone";
        } else {
          ((agyz)localObject3).h = "other";
        }
      }
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    bdne.v(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramBoolean);
  }
  ...
  public boolean a(String paramString1, int paramInt, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      if (!bool)
      {
        ...
        if ((!paramBoolean2) || (this.jdField_a_of_type_Agyy == null)) {
          break label251;
        }
    ...
    catch (Exception paramString1)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("StickerRecManager", 2, bhsw.a(paramString1));
        }
      }
    }
    return true;
  ...
  public String b(String paramString)
  {
    ...
    return banh.i(bdnn.c(banh.a(paramString)));
  }
  ...
  public Collection<String> b()
  {
    ...
    Object localObject1 = ((apon)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(149)).a();
    if (localObject1 != null)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (("isUpdate".equals(((CustomEmotionData)localObject2).RomaingType)) || ("needDownload".equals(((CustomEmotionData)localObject2).RomaingType)) || ("overflow".equals(((CustomEmotionData)localObject2).RomaingType)) || ("overflow_downloaded".equals(((CustomEmotionData)localObject2).RomaingType))) {
          ...
          {
            localObject2 = localaufn.a(((CustomEmotionData)localObject2).emoPath, ((CustomEmotionData)localObject2).eId);
  ...
  public void b(List<agzb> paramList)
  {
    paramList = new ArrayList(paramList).iterator();
    while (paramList.hasNext())
    {
      Object localObject1 = (agzb)paramList.next();
      if (localObject1 != null)
      {
        Object localObject2 = ((agzb)localObject1).jdField_a_of_type_JavaLangString;
        StickerRecommendSortEntity localStickerRecommendSortEntity = (StickerRecommendSortEntity)this.jdField_a_of_type_Awgf.a(StickerRecommendSortEntity.class, "usrMessage=?", new String[] { localObject2 });
        Object localObject3;
        if (localStickerRecommendSortEntity != null)
        {
          localStickerRecommendSortEntity.convertToList();
          localObject1 = ((agzb)localObject1).jdField_a_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (agxz)((Iterator)localObject1).next();
            if (!((agxz)localObject2).a())
            {
              localObject2 = (agyp)localObject2;
              localObject3 = Integer.valueOf(((agyp)localObject2).d());
              if (((agyp)localObject2).b())
              {
          ...
          this.jdField_a_of_type_Awgf.a(localStickerRecommendSortEntity);
        }
        else
        {
          localStickerRecommendSortEntity = new StickerRecommendSortEntity((String)localObject2);
          localObject2 = ((agzb)localObject1).jdField_a_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject2).hasNext())
          {
            localObject3 = (agxz)((Iterator)localObject2).next();
            if (!((agxz)localObject3).a())
            {
              localObject3 = (agyp)localObject3;
              if (((agyp)localObject3).b()) {
                localStickerRecommendSortEntity.addClicked(Integer.valueOf(((agyp)localObject3).d()));
              } else {
                localStickerRecommendSortEntity.addExposed(Integer.valueOf(((agyp)localObject3).d()));
              }
            }
          }
          localObject1 = ((agzb)localObject1).jdField_b_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (agxz)((Iterator)localObject1).next();
            if (!((agxz)localObject2).a()) {
              localStickerRecommendSortEntity.addNoExpose(Integer.valueOf(((agyp)localObject2).d()));
            }
          }
          if ((localStickerRecommendSortEntity.noExposeList != null) && (localStickerRecommendSortEntity.noExposeList.size() == 0))
          {
          ...
          this.jdField_a_of_type_Awgf.b(localStickerRecommendSortEntity);
        }
      }
    }
  }
  ...
  public void g()
  {
    if (this.jdField_a_of_type_Agyl == null) {
      return;
    }
    this.jdField_a_of_type_Agyl.a();
  }
