  ...
  extends azqj
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new azrn(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      paramView = (azqj)this.jdField_a_of_type_JavaUtilList.get(j);
      ...
      localView = ((View)localObject).findViewById(2131377070);
      if (localView != null)
      {
        if ((LinearLayout)((View)localObject).findViewById(2131377071) != null) {
          break label231;
        }
    ...
    for (;;)
    {
      ...
      {
        paramView = paramView.a(paramContext, null, paramBundle);
        localObject = new LinearLayout.LayoutParams(-1, aekt.a(50.0F, paramContext.getResources()));
        ((TextView)paramView).setGravity(16);
        ((LinearLayout.LayoutParams)localObject).leftMargin = aekt.a(12.0F, paramContext.getResources());
        ((LinearLayout.LayoutParams)localObject).rightMargin = 0;
        ((LinearLayout.LayoutParams)localObject).topMargin = 0;
        ((LinearLayout.LayoutParams)localObject).bottomMargin = 0;
        this.jdField_a_of_type_AndroidViewViewGroup.addView(paramView, (ViewGroup.LayoutParams)localObject);
  ...
  public boolean a(azsa paramazsa)
  {
    ...
    while (i < k)
    {
      ...
      {
        if ("item".equals(localazsa.b)) {}
        for (Object localObject = localazsa.a("layout");; localObject = azqt.a(localazsa.b))
        {
          try
          {
            ...
            for (int j = Integer.parseInt((String)localObject);; j = 0)
            {
              ...
              bool1 = bool2;
              if (!((azqj)localObject).a(localazsa)) {
                break;
              }
              a((azqj)localObject);
              break label39;
