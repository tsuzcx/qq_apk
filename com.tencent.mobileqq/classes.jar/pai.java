  ...
  extends pbh
{
  ...
  private HashMap<String, pam<Parcelable>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private ConcurrentHashMap<String, pam<FastWebArticleInfo>> b = new ConcurrentHashMap();
  
  static
  {
    jdField_a_of_type_JavaLangString = pai.class.getSimpleName();
  }
  
  public pai(AppInterface paramAppInterface, aukn paramaukn, ExecutorService paramExecutorService, pou parampou, Handler paramHandler)
  {
  ...
  {
    int i = bcxh.a(null);
    Object localObject = bhvh.f(onk.a());
  ...
  private void b()
  {
    this.jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache = new paj(this, 2012, 30, 1);
  }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = pow.a(paramFromServiceMsg, paramObject, localRspBody);
    boolean bool1 = false;
    boolean bool2 = false;
    ...
    for (;;)
    {
      paramFromServiceMsg = (pal)a(Integer.valueOf(i));
      ...
      if (str != null)
      {
        ...
        this.b.put(str, new pam(this, paramToServiceMsg));
      }
      for (;;)
      {
        ...
        paramToServiceMsg.put("param_uin", onk.a());
        paramToServiceMsg.put("param_retCode", k + "");
        paramToServiceMsg.put("param_succ", String.valueOf(bool1));
        paramToServiceMsg.put("param_netType", bcxh.a(null) + "");
        axrl.a(BaseApplicationImpl.getApplication()).a(null, "actKandianFastWebCost", bool1, l, 0L, paramToServiceMsg, null);
        return;
        label518:
        if ((paramToServiceMsg != null) && (this.b.containsKey(str)))
        {
          paramFromServiceMsg = (pam)this.b.get(str);
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = pow.a(paramFromServiceMsg, paramObject, paramToServiceMsg);
    paramFromServiceMsg = new rna();
    boolean bool;
    ...
    for (;;)
    {
      paramToServiceMsg = (pak)a(Integer.valueOf(i));
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = pow.a(paramFromServiceMsg, paramObject, localRspBody);
    paramFromServiceMsg = (rss)a(Integer.valueOf(i));
    paramToServiceMsg = "";
  ...
  public int a(String paramString1, String paramString2, String paramString3, int paramInt, pal parampal)
  {
    for (;;)
    {
      Object localObject1;
      try
      {
        QLog.d("Q.readinjoy.fast_web", 2, "getArticleContent, rowkey : " + paramString2 + ", url : " + paramString1 + " callback: " + parampal + ", reqType : " + paramInt);
        if ((paramInt != 2) && (paramString2 != null))
        {
          localObject1 = (pam)this.b.get(paramString2);
          if (localObject1 != null)
          {
            if (!((pam)localObject1).a()) {
              continue;
            }
        ...
        ((oidb_cmd0xad6.Client)localObject2).bytes_version.set(ByteStringMicro.copyFromUtf8("8.2.8"));
        ...
        if (paramInt == 1)
        {
          ...
          paramString3 = pow.a("OidbSvc.0xad6", 2774, 0, ((oidb_cmd0xad6.ReqBody)localObject1).toByteArray());
          ...
          if (parampal != null)
          {
            parampal.a(true, ((pam)localObject1).jdField_a_of_type_Boolean, (FastWebArticleInfo)((pam)localObject1).a());
            noo.a(null, "CliOper", "", "", "0X8009C51", "0X8009C51", 0, 0, "", "", "", "", false);
          }
          QLog.d("Q.readinjoy.fast_web", 2, "hit cache, rowkey : " + paramString2 + ", url : " + paramString1 + " isUserWeb " + ((pam)localObject1).jdField_a_of_type_Boolean);
          return -1;
        }
        if (paramInt == 3)
        {
  ...
  {
    paramString = (pam)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
  ...
  {
    paramString = (pam)this.b.get(paramString);
    if (paramString != null) {
  ...
  {
    return rnm.a((List)this.jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache.get(paramString));
  }
  ...
  public void a(@NonNull ArticleInfo paramArticleInfo, int paramInt, rss paramrss)
  {
    ...
    for (;;)
    {
      ...
      localFeedParam.multi_level_info.set(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qcj.a());
      ...
      try
      {
        ...
        localObject = pow.a("OidbSvc.0xbd3", 3027, 0, localReqBody.toByteArray());
        int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  public void a(ArticleInfo paramArticleInfo, pak parampak, boolean paramBoolean)
  {
    Object localObject1 = new oidb_cmd0xb54.ReqBody();
    Object localObject2 = new oidb_cmd0xb54.Client();
    ((oidb_cmd0xb54.Client)localObject2).bytes_version.set(ByteStringMicro.copyFromUtf8("8.2.8"));
    ...
    if (bhvh.n(this.jdField_a_of_type_ComTencentCommonAppAppInterface) != 1) {
    ...
    Object localObject3 = (pam)this.b.get(paramArticleInfo.innerUniqueID);
    if (localObject3 != null)
    {
      localObject3 = (FastWebArticleInfo)((pam)localObject3).a();
    ...
    localObject1 = pow.a("OidbSvc.0xb54", 2900, 0, ((oidb_cmd0xb54.ReqBody)localObject1).toByteArray());
    int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  {
    pam localpam = (pam)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (localpam == null)
    {
      paramParcelable = new pam(this, paramParcelable);
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, paramParcelable);
      return;
    }
    localpam.a(paramParcelable);
  }
  
  public void a(String paramString1, String paramString2, String paramString3, int paramInt, pak parampak)
  {
    oidb_cmd0xad7.ReqBody localReqBody = new oidb_cmd0xad7.ReqBody();
    Object localObject = new oidb_cmd0xad7.Client();
    ((oidb_cmd0xad7.Client)localObject).bytes_version.set(ByteStringMicro.copyFromUtf8("8.2.8"));
    ...
    try
    {
      ...
      if (paramInt == 2)
      {
        ...
        paramString3 = pow.a("OidbSvc.0xad7", 2775, 0, localReqBody.toByteArray());
        int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int j = pow.a(paramFromServiceMsg, paramObject, (MessageMicro)localObject2);
    paramFromServiceMsg = (pak)b(Integer.valueOf(i));
    paramObject = (pam)this.b.get(localObject3);
    if (paramObject == null) {
      return;
    }
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        if (((oidb_cmd0xb54.RspBody)localObject2).bytes_proteus_json_data.has())
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject3))
          {
            ...
            rmq.a((String)localObject3, paramObject.jdField_a_of_type_AndroidUtilSparseArray);
          }
        }
        ...
        while (((Iterator)localObject4).hasNext())
        {
          ...
          if ((((oidb_cmd0xb54.RelatedSearchWord)localObject6).bytes_word.has()) && (((oidb_cmd0xb54.RelatedSearchWord)localObject6).str_jmp_url.has()))
          {
            ...
            {
              localObject6 = new rkd();
              ((rkd)localObject6).jdField_a_of_type_JavaLangString = ((String)localObject5);
              ((rkd)localObject6).b = str2;
              ((rkd)localObject6).jdField_a_of_type_Float = f;
              ((rkd)localObject6).c = str3;
              ((rkd)localObject6).jdField_a_of_type_Int = i;
