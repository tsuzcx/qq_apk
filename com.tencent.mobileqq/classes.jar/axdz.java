...
public class axdz
{
  ...
  public static Object a(SharedPreferences paramSharedPreferences, String paramString, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        ...
        axei.a("getValue", new Object[] { localThrowable });
      ...
      axei.a("getValue", new Object[] { paramSharedPreferences, paramString, paramObject, localObject1, paramObject.getClass() });
      return localObject1;
  ...
  public static Object a(String paramString1, String paramString2, int paramInt, String paramString3, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        axei.a("getValue", new Object[] { str1, str2, paramString3, paramObject, paramString1, paramObject.getClass() });
        return paramString1;
      }
      catch (Throwable paramString1)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            axei.a("getValue", new Object[] { paramString1 });
          }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          axei.a("setValue", new Object[] { paramSharedPreferences, paramString, paramObject, Boolean.valueOf(bool1), paramObject.getClass() });
          return bool1;
          if (paramObject.getClass() != Integer.class) {
            break label165;
          }
      ...
      catch (Throwable localThrowable)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            axei.a("setValue", new Object[] { localThrowable });
          }
          boolean bool1 = false;
          continue;
          label165:
  ...
  {
    return ((Boolean)a(paramString, BaseApplicationImpl.getApplication().getResources().getString(2131694383), Boolean.valueOf(false))).booleanValue();
  }
  ...
  public static boolean a(String paramString, long paramLong, int paramInt)
  {
    try
    {
      ...
      if (QLog.isColorLevel()) {
        axei.a("setVoteInfo", new Object[] { paramString, Long.valueOf(paramLong), Integer.valueOf(paramInt), Boolean.valueOf(bool) });
      }
      return bool;
    }
    catch (Throwable localThrowable)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          axei.a("setVoteInfo", new Object[] { localThrowable });
        }
        boolean bool = false;
      }
    }
  ...
  public static boolean a(String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        axei.a("contains", new Object[] { str, paramString1, paramString3 });
        return bool1;
      }
      catch (Throwable paramString2)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            axei.a("contains", new Object[] { paramString2 });
          }
          boolean bool1 = false;
        }
      }
  ...
  public static boolean a(String paramString1, String paramString2, int paramInt, String paramString3, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        axei.a("setValue", new Object[] { str, paramString3, paramObject, Boolean.valueOf(bool1), paramObject.getClass() });
        return bool1;
      }
      catch (Throwable paramString1)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            axei.a("setValue", new Object[] { paramString1 });
          }
          boolean bool1 = false;
        }
      }
  ...
  {
    return a(paramString, BaseApplicationImpl.getApplication().getResources().getString(2131694383), Boolean.valueOf(paramBoolean));
  }
  ...
  public static void b(String paramString)
  {
    try
    {
      ...
      if (QLog.isColorLevel()) {
        axei.a("preloadNearbyprocessStart", new Object[] { "key_preload_fail_count", Integer.valueOf(i) });
      }
      return;
    }
  ...
  public static boolean b(String paramString)
  {
    try
    {
      bool = ((Boolean)a(paramString, BaseApplicationImpl.getApplication().getResources().getString(2131694391), Boolean.valueOf(false))).booleanValue();
      if (QLog.isColorLevel()) {
        axei.a("getLocVisiblityForPeople", new Object[] { paramString, Boolean.valueOf(bool) });
      }
      return bool;
    }
    catch (Throwable localThrowable)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          axei.a("getLocVisiblityForPeople", new Object[] { localThrowable });
        }
        boolean bool = false;
      }
    }
  ...
  public static boolean b(String paramString, boolean paramBoolean)
  {
    try
    {
      String str = BaseApplicationImpl.getApplication().getResources().getString(2131694391);
    ...
    catch (Throwable localThrowable)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          axei.a("setVisibilityForPeople", new Object[] { localThrowable });
        }
        boolean bool = false;
      }
    }
    if (QLog.isColorLevel()) {
      axei.a("setVisibilityForPeople", new Object[] { paramString, Boolean.valueOf(paramBoolean), Boolean.valueOf(bool) });
    }
    return bool;
  }
  ...
  public static void c(String paramString)
  {
    try
    {
      ...
      if (QLog.isColorLevel()) {
        axei.a("preloadNearbyProcessSuc", new Object[] { "key_preload_unhit_count", Integer.valueOf(i) });
      }
      return;
    }
    catch (Throwable paramString)
  ...
  public static void d(String paramString)
  {
    try
    {
      ...
      if (QLog.isColorLevel()) {
        axei.a("enterNearbyProcess", new Object[0]);
      }
      return;
    }
    catch (Throwable paramString)
  ...
  public static void e(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (QLog.isColorLevel()) {
        axei.a("saveNearbyTabUrlParams", new Object[] { paramString });
      }
    }
  }
  ...
  public static boolean e(String paramString)
  {
    ...
    catch (Throwable paramString)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          axei.a("checkPreload", new Object[] { Integer.valueOf(i), Integer.valueOf(j) });
        }
        return bool1;
      }
      catch (Throwable paramString)
  ...
  public static void f(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (QLog.isColorLevel()) {
        axei.a("saveLiveTabWebViewUrlParam", new Object[] { paramString });
      }
    }
  }
  ...
  public static boolean f(String paramString)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        axei.a("isNeedNearbyShowGuide", new Object[] { Boolean.valueOf(bool1), Boolean.valueOf(bool2), Boolean.valueOf(bool3) });
      }
      return bool1;
    }
  }
