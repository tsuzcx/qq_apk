  ...
  implements Manager
{
  ...
  axez jdField_a_of_type_Axez;
  public QQAppInterface a;
  Runnable jdField_a_of_type_JavaLangRunnable = new ShortVideoPreDownloader.2(this);
  List<axeg> jdField_a_of_type_JavaUtilList = Collections.synchronizedList(new LinkedList());
  public Map<String, Integer> a;
  public PriorityBlockingQueue<axeg> a;
  public AtomicBoolean a;
  public AtomicInteger a;
  List<axeg> b;
  public PriorityBlockingQueue<axeg> b;
  public AtomicInteger b;
  List<axeg> c = Collections.synchronizedList(new LinkedList());
  List<axeg> d = Collections.synchronizedList(new LinkedList());
  ...
  public axdz(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Axez = new axea(this);
  }
  
  private String a(long paramLong, List<axeg> paramList)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      axeg localaxeg = (axeg)paramList.next();
      if ((localaxeg.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo != null) && (localaxeg.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.uniseq == paramLong))
      {
        this.jdField_a_of_type_JavaUtilList.remove(localaxeg);
        return localaxeg.jdField_a_of_type_JavaLangString;
      }
    }
    return null;
  }
  ...
  {
    int i = aunq.a(paramQQAppInterface, paramMessageForShortVideo.istroop, paramMessageForShortVideo.frienduin);
    if ((i == 0) || (i == 1))
    {
    ...
    if (i == 2)
    {
      ...
      if (localajvk != null)
      {
        paramQQAppInterface = localajvk.a(paramMessageForShortVideo.frienduin, paramQQAppInterface.getCurrentAccountUin());
  ...
  axeg a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      if (i > 0)
      {
        ...
        localaxeg1 = (axeg)this.jdField_a_of_type_JavaUtilList.get(i - 1);
      ...
      synchronized (this.jdField_b_of_type_JavaUtilList)
      {
        ...
        if (i > 0)
        {
          ...
          localaxeg1 = (axeg)this.jdField_b_of_type_JavaUtilList.get(i - 1);
    ...
    synchronized (this.c)
    {
      ...
      if (i > 0)
      {
        ...
        axeg localaxeg2 = (axeg)this.c.get(i - 1);
        this.c.remove(i - 1);
        return localaxeg2;
      }
    }
    synchronized (this.d)
    {
      ...
      if (i > 0)
      {
        ...
        axeg localaxeg3 = (axeg)this.d.get(i - 1);
        this.d.remove(i - 1);
        return localaxeg3;
      }
    }
  ...
  Collection<axeg> a(int paramInt)
  {
  ...
  public void a(axeg paramaxeg)
  {
    axdo.a(paramaxeg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    if (QLog.isColorLevel()) {
      QLog.d("ShortVideoPreDownloader", 2, "launchRequest:" + paramaxeg.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.busiType);
    }
  }
  ...
  public boolean a(MessageForShortVideo paramMessageForShortVideo)
  {
    ...
    for (;;)
    {
      ...
      if ((bbev.b(BaseApplication.getContext()) == 1) || (bool)) {}
  ...
  boolean a(MessageForShortVideo paramMessageForShortVideo, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject2 = (axeg)localIterator.next();
          if (((axeg)localObject2).jdField_a_of_type_Axdr.jdField_a_of_type_Long != paramMessageForShortVideo.uniseq) {
            break label294;
          }
          bool1 = true;
  ...
  void b(MessageForShortVideo paramMessageForShortVideo)
  {
    ...
    axeg localaxeg = axdo.a(2, paramMessageForShortVideo.busiType);
    axdr localaxdr = paramMessageForShortVideo.getDownloadInfo(localaxeg.b);
    localaxdr.i = ((String)localObject);
    ...
    label241:
    for (localaxdr.g = 2;; localaxdr.g = 1)
    {
      ...
      this.jdField_a_of_type_JavaUtilConcurrentPriorityBlockingQueue.add(localaxeg);
      return;
    ...
    label250:
    ThreadManager.post(new ShortVideoPreDownloader.3(this, localaxdr, paramMessageForShortVideo, localaxeg), 5, null, false);
  }
  ...
  void b(MessageForShortVideo paramMessageForShortVideo, int paramInt)
  {
    ...
    {
      return;
      localaxeg = axdo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForShortVideo, 2);
    } while (localaxeg == null);
    localObject = null;
    String str = "";
    int i = aunq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForShortVideo.istroop, paramMessageForShortVideo.frienduin);
    if (paramInt == 5)
    {
    ...
    for (;;)
    {
      if (localObject != null)
      {
        ...
        ((List)localObject).add(localaxeg);
        this.jdField_a_of_type_JavaUtilMap.put(localaxeg.jdField_a_of_type_Axdr.jdField_a_of_type_JavaLangString, Integer.valueOf(localaxeg.c));
      }
  ...
  public void c()
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
      aune.a("PIC_TAG_PRELOAD", "consume", "!mIsPreDownloaderOpen.get() failed");
    }
    axeg localaxeg;
    do
    {
    ...
    if (localaxeg.jdField_a_of_type_Axdr == null)
    {
      a("consumeShortVideo", "req.downinfo == null");
      return;
    }
    this.jdField_a_of_type_JavaUtilMap.remove(localaxeg.jdField_a_of_type_Axdr.jdField_a_of_type_JavaLangString);
    this.jdField_b_of_type_JavaUtilConcurrentPriorityBlockingQueue.add(localaxeg);
    localaxeg.d = localaxeg.c;
    localaxeg.c = 6;
    this.jdField_a_of_type_JavaUtilMap.put(localaxeg.jdField_a_of_type_Axdr.jdField_a_of_type_JavaLangString, Integer.valueOf(6));
    this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger.addAndGet(1);
    localaxeg.jdField_a_of_type_Axez = this.jdField_a_of_type_Axez;
    ThreadManager.post(new ShortVideoPreDownloader.4(this, localaxeg), 5, null, false);
  }
