  ...
  implements bdbc, bhtv
{
  ...
  public akhz(Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  {
    Bitmap localBitmap = this.jdField_a_of_type_Bdbb.b(paramInt1, paramString, paramInt2);
    if (localBitmap != null) {
      return localBitmap;
    }
  ...
  {
    return (paramakit != null) && (paramakit.a != null) && (paramakit.a.length() > 0);
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    if ((this.jdField_a_of_type_Int == 0) && (this.jdField_a_of_type_ComTencentWidgetXListView != null))
    {
      ...
      while (paramInt1 < paramInt2)
      {
        ...
        if ((paramString != null) && ((paramString instanceof akit)))
        {
          paramString = (akit)paramString;
          if (a(paramString))
          {
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentWidgetXListView != null)
      {
        ...
        while (paramInt < i)
        {
          paramAbsListView = (akit)this.jdField_a_of_type_ComTencentWidgetXListView.getChildAt(paramInt).getTag();
