  ...
  implements TextWatcher, View.OnClickListener
{
  ...
  public bkih(@NonNull Context paramContext, bjww parambjww)
  {
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetXEditText = ((XEditTextEx)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365750));
    ...
    this.jdField_a_of_type_Uqs = new uqs(getContext(), this.jdField_a_of_type_AndroidViewViewGroup, new bkii(this));
    this.jdField_a_of_type_Uqs.a(this.jdField_a_of_type_AndroidContentContext.getString(2131690575));
  }
  
  public void a(String paramString, boolean paramBoolean)
  {
    super.setOnShowListener(new bkij(this, paramBoolean));
    super.show();
    if (paramString != null)
    {
