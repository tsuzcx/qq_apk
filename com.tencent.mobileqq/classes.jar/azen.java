...
public class azen
{
  ...
  private azep jdField_a_of_type_Azep;
  private azeq jdField_a_of_type_Azeq = new azeq(this, null);
  private boolean jdField_a_of_type_Boolean;
  public final int b;
  private PointF jdField_b_of_type_AndroidGraphicsPointF = new PointF();
  private azeq jdField_b_of_type_Azeq = new azeq(this, null);
  ...
  private azeq a(int paramInt)
  {
    azeq localazeq = null;
    VideoEnvironment.a("GameplayEngine.GameEvent", String.format("id=%d,pointerId0=%d,pointerId1=%d", new Object[] { Integer.valueOf(paramInt), Integer.valueOf(this.jdField_a_of_type_Azeq.jdField_a_of_type_Int), Integer.valueOf(this.jdField_b_of_type_Azeq.jdField_a_of_type_Int) }), null);
    VideoEnvironment.a("GameplayEngine.GameEvent", String.format("id=%d,pressed0=%b,pressed1=%b", new Object[] { Integer.valueOf(paramInt), Boolean.valueOf(this.jdField_a_of_type_Azeq.jdField_a_of_type_Boolean), Boolean.valueOf(this.jdField_b_of_type_Azeq.jdField_a_of_type_Boolean) }), null);
    if (paramInt == this.jdField_a_of_type_Azeq.jdField_a_of_type_Int) {
      localazeq = this.jdField_a_of_type_Azeq;
    }
    do
    {
      return localazeq;
      if (paramInt == this.jdField_b_of_type_Azeq.jdField_a_of_type_Int) {
        return this.jdField_b_of_type_Azeq;
      }
      if (this.jdField_a_of_type_Azeq.jdField_a_of_type_Boolean) {
        return this.jdField_a_of_type_Azeq;
      }
    } while (!this.jdField_b_of_type_Azeq.jdField_a_of_type_Boolean);
    return this.jdField_b_of_type_Azeq;
  }
  ...
  private void a()
  {
    this.x = ((int)Math.sqrt(Math.pow(this.jdField_a_of_type_Azeq.jdField_a_of_type_Float - this.jdField_b_of_type_Azeq.jdField_a_of_type_Float, 2.0D) + Math.pow(this.jdField_a_of_type_Azeq.b - this.jdField_b_of_type_Azeq.b, 2.0D)) + 5);
  }
  ...
  private void a(long paramLong, int paramInt, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    if (this.jdField_a_of_type_Azep != null) {
      this.jdField_a_of_type_Azep.a(paramLong, paramInt, paramFloat1, paramFloat2, paramFloat3);
    }
  }
  ...
  private void a(long paramLong, int paramInt1, float paramFloat1, float paramFloat2, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Azep != null) {
      this.jdField_a_of_type_Azep.a(paramLong, paramInt1, paramFloat1, paramFloat2, paramInt2);
    }
  }
  ...
  {
    azeq localazeq = a(paramInt);
    if (localazeq == null) {}
    do
    {
      return false;
      float f2 = localazeq.jdField_a_of_type_Float;
      float f1 = localazeq.b;
  ...
  {
    if (this.jdField_a_of_type_Azep != null) {
      return this.jdField_a_of_type_Azep.a(paramLong, paramInt);
    }
    return false;
  }
  ...
  private void b()
  {
    this.jdField_a_of_type_Azeq.jdField_a_of_type_Boolean = false;
    this.jdField_b_of_type_Azeq.jdField_a_of_type_Boolean = false;
  ...
  void a(long paramLong1, int paramInt1, float paramFloat1, float paramFloat2, int paramInt2, long paramLong2)
  {
    ...
    if (paramInt2 == 0)
    {
      ...
      if (bool)
      {
        this.jdField_a_of_type_Azeq.jdField_a_of_type_Boolean = true;
        this.jdField_a_of_type_Azeq.jdField_a_of_type_Long = paramLong2;
        this.jdField_a_of_type_Azeq.jdField_a_of_type_Int = paramInt1;
        this.jdField_a_of_type_Azeq.jdField_a_of_type_Float = paramFloat1;
        this.jdField_a_of_type_Azeq.b = paramFloat2;
    ...
    do
    {
      ...
      if (bool)
      {
        this.jdField_b_of_type_Azeq.jdField_a_of_type_Boolean = true;
        this.jdField_b_of_type_Azeq.jdField_a_of_type_Long = paramLong2;
        this.jdField_b_of_type_Azeq.jdField_a_of_type_Int = paramInt1;
        this.jdField_b_of_type_Azeq.jdField_a_of_type_Float = paramFloat1;
        this.jdField_b_of_type_Azeq.b = paramFloat2;
        ...
        a();
        this.jdField_e_of_type_AndroidGraphicsPointF.set((this.jdField_a_of_type_Azeq.jdField_a_of_type_Float + this.jdField_b_of_type_Azeq.jdField_a_of_type_Float) / 2.0F, (this.jdField_a_of_type_Azeq.b + this.jdField_b_of_type_Azeq.b) / 2.0F);
      }
  ...
  void a(long paramLong1, int[] paramArrayOfInt, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, long paramLong2)
  {
    ...
    if (i2 < i4)
    {
      ...
      if ((!this.jdField_b_of_type_Azeq.jdField_a_of_type_Boolean) || ((i5 != this.jdField_a_of_type_Azeq.jdField_a_of_type_Int) && (i5 != this.jdField_b_of_type_Azeq.jdField_a_of_type_Int))) {
        break label1070;
      }
      if (this.jdField_a_of_type_Azeq.jdField_a_of_type_Int == this.jdField_b_of_type_Azeq.jdField_a_of_type_Int) {
        c();
      }
    }
    else
    ...
    if (a(paramLong1, 2))
    {
      if (this.jdField_a_of_type_Azeq.jdField_a_of_type_Int != i5) {
        break label776;
      }
      ...
      this.v = ((int)Math.sqrt(Math.pow(f2 - this.jdField_a_of_type_Azeq.jdField_a_of_type_Float, 2.0D) + Math.pow(f3 - this.jdField_a_of_type_Azeq.b, 2.0D)));
      ...
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        if (i5 != this.jdField_a_of_type_Azeq.jdField_a_of_type_Int) {
          break label844;
        }
        f1 = i1 / i6;
        label559:
    ...
    for (;;)
    {
      ...
      this.w = ((int)Math.sqrt(Math.pow(f2 - this.jdField_b_of_type_Azeq.jdField_a_of_type_Float, 2.0D) + Math.pow(f3 - this.jdField_b_of_type_Azeq.b, 2.0D)));
      break label197;
      label844:
      f1 = i7 / i8;
      break label559;
      ...
      if (this.jdField_e_of_type_Boolean)
      {
        ...
        if (a())
        {
          ...
          if (i5 == this.jdField_a_of_type_Azeq.jdField_a_of_type_Int)
          {
            ...
            if (a(paramLong1, 5))
            {
              i6 = (int)Math.sqrt(Math.pow(f2 - this.jdField_a_of_type_Azeq.jdField_a_of_type_Float, 2.0D) + Math.pow(f3 - this.jdField_a_of_type_Azeq.b, 2.0D));
              ...
              {
                i1 = i3;
                if (paramLong2 - this.jdField_a_of_type_Azeq.jdField_a_of_type_Long >= 200L)
                {
                  i1 = i3;
                  if (i6 >= 30)
                  {
  ...
  void b(long paramLong1, int paramInt1, float paramFloat1, float paramFloat2, int paramInt2, long paramLong2)
  {
    ...
    do
    {
      do
      {
        ...
        float f1;
        float f2;
        if (localazeq.jdField_a_of_type_Boolean)
        {
          f1 = paramFloat1 - localazeq.jdField_a_of_type_Float;
          f2 = paramFloat2 - localazeq.b;
          if (!this.jdField_b_of_type_Boolean) {
            break label114;
          }
          c();
        ...
        for (;;)
        {
          localazeq.jdField_a_of_type_Boolean = false;
          ...
          {
            if ((a(paramLong1, 1)) && (paramLong2 - localazeq.jdField_a_of_type_Long < 400L) && ((Math.abs(f1) > 50.0F) || (Math.abs(f2) > 50.0F)))
            {
              paramInt2 = 0;
            ...
            if ((a(paramLong1, 0)) && (a((int)f1, (int)f2)) && (paramLong2 - localazeq.jdField_a_of_type_Long < 200L))
            {
            ...
            else
            {
              ...
              if (a(paramLong1, 3))
              {
                ...
                {
                  paramInt2 = i1;
                  if (paramLong2 - localazeq.jdField_a_of_type_Long >= 200L)
                  {
                    a(paramLong1, 3, paramFloat1, paramFloat2, (float)(paramLong2 - localazeq.jdField_a_of_type_Long));
                    paramInt2 = 1;
                  }
                }
              }
      ...
      i1 = 0;
      localazeq = a(paramInt1);
    } while (localazeq == null);
    paramInt2 = i1;
    int i3;
    if (localazeq.jdField_a_of_type_Boolean)
    {
      i3 = (int)(paramFloat1 - localazeq.jdField_a_of_type_Float);
      i2 = (int)(paramFloat2 - localazeq.b);
      if ((!this.jdField_a_of_type_Boolean) || (!a(paramLong1, 1)) || (paramLong2 - localazeq.jdField_a_of_type_Long >= 400L) || ((Math.abs(i3) <= 50) && (Math.abs(i2) <= 50))) {
        break label646;
      }
      paramInt2 = 0;
      if (i3 <= 0) {
    ...
    for (;;)
    {
      ...
      break label550;
      label646:
      if ((this.jdField_a_of_type_Boolean) && (a(paramLong1, 0)) && (a(i3, i2)) && (paramLong2 - localazeq.jdField_a_of_type_Long < 200L))
      {
        a(paramLong1, 0, paramFloat1, paramFloat2, 0.0F);
        paramInt2 = 1;
      }
