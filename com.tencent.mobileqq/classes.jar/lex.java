  ...
  implements lev
{
  ...
  private final lfx jdField_a_of_type_Lfx;
  ...
  public lex(Context paramContext, lfx paramlfx)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Lfx = paramlfx;
  ...
  private void a(int paramInt, PendantItem paramPendantItem, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      b(paramInt);
      this.jdField_a_of_type_Lfx.a(paramPendantItem.getGestureType());
      return;
    }
  ...
  public int a(int paramInt, boolean paramBoolean1, lfl paramlfl, boolean paramBoolean2)
  {
    boolean bool = false;
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager == null) {
      return paramInt;
    ...
    if ((this.jdField_a_of_type_ComTencentAekitApiStandardFilterAESticker != null) || (this.jdField_b_of_type_Boolean))
    {
      ...
      lfw.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.hasAEDetectorInited());
    }
    for (;;)
    {
      paramBoolean1 = bool;
      ...
      paramlfl.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.getFaceAttr(), (float)this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.getWindowScale(), paramBoolean2);
      return i;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null) && (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.cameraInterFace == null)) {
        this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.cameraInterFace = kya.a();
      }
      return;
      label69:
  ...
  public void a(PendantItem paramPendantItem, VideoMaterial paramVideoMaterial)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((lfw.a(this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem, paramPendantItem)) && (this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial == paramVideoMaterial));
  ...
  {
    if (!lfw.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc, paramFilterDesc))
    {
  ...
  public void a(lfi paramlfi, lfl paramlfl)
  {
    String str2 = "";
    String str1 = "";
    if (this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem != null)
    ...
    {
      boolean bool2 = kya.a().b();
      if ((kyd.a(this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial)) && (!bool2)) {
        bool1 = false;
      }
      for (;;)
      {
        this.jdField_a_of_type_Lfx.a(paramlfi, paramlfl.jdField_a_of_type_Int, this.jdField_a_of_type_Boolean, bool1, str1, str2);
        return;
      }
    }
  }
  ...
  public boolean a(lfa paramlfa)
  {
    boolean bool = false;
    if (paramlfa != null) {}
    for (int i = paramlfa.a("BEAUTY_SKIN");; i = 0)
    {
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null)
    {
      ...
      krx.c("AEFilterOldWrapper", "mQQFilterRenderManager surfaceChange" + str);
    }
  }
