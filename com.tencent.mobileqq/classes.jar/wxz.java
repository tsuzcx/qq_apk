...
public class wxz
  implements Runnable
{
  public wxz(RedPacketRecordFragment paramRedPacketRecordFragment, int paramInt, String paramString) {}
  ...
  public void run()
  {
    ...
    String str2 = this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedPacketRecordFragment.getResources().getString(2131432324);
    String str1;
