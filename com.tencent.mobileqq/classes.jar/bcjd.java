...
public class bcjd
{
  ...
  public bcjd()
  {
    this.jdField_a_of_type_AndroidOsHandler = new bcje(this, Looper.getMainLooper());
  }
  ...
  public void a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    if (paramBoolean == true) {
      localTranslateAnimation.setAnimationListener(new bcjf(this));
    }
  ...
  public boolean a(String paramString)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561465, null);
      if (this.jdField_a_of_type_AndroidViewView != null)
      {
        TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362565);
