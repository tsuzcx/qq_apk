  ...
  extends bcgx
{
  ...
  public bcjd(Collection<bcgw> paramCollection)
  {
  ...
  {
    return AIOUtils.dp2px(5.0F, paramResources);
  }
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    int n = localResources.getDimensionPixelSize(2131298978);
    int i1 = localResources.getDimensionPixelSize(2131298979);
    ...
    for (int k = 6;; k = 10)
    {
      ...
      if ((paramView != null) && ((paramView instanceof LinearLayout)))
      {
        ...
        if (j < k)
        {
          localObject2 = (bcgw)((ArrayList)localObject1).get(j);
          ...
          localView = ((bcgw)localObject2).a(paramContext, paramView.getChildAt(j), paramBundle);
          if (localView != null) {}
        }
        else
        {
      ...
      for (int j = a(paramContext, k) + i;; j = i)
      {
        ...
        i = j;
        break;
        m = AIOUtils.dp2px(10.0F, localResources);
        LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, -2);
        if (j > 0) {
          localLayoutParams.topMargin = a(localResources, j, (bcgw)localObject2);
        }
        ...
        if (j < k)
        {
          ...
          localView = ((bcgw)localObject2).a(paramContext, null, paramBundle);
          if (localView == null) {
            break label197;
          }
          m = AIOUtils.dp2px(10.0F, localResources);
