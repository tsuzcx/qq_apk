  ...
  implements ozu
{
  ...
  {
    if ((!oox.c(paramInt)) || (paramList2 == null) || (paramList1 == null) || (paramList2.isEmpty())) {
      return null;
    }
    long l = a(paramList2);
    if (l < 1000L)
    ...
    bhvh.a(ntu.a(), Boolean.valueOf(true));
    ntu.a(true);
    this.jdField_a_of_type_Ozr.a(null);
    return paramList2;
  }
}
