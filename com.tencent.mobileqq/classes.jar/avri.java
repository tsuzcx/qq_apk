...
final class avri
  extends avrj
{
  private WeakReference<avrg> a;
  
  private avri(avrg paramavrg)
  {
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    if (((paramObject instanceof cmd0xcd4.InputNotifyRsp)) && (paramBoolean))
    {
      ...
      if ((j > 0) && (this.a.get() != null)) {
        ((avrg)this.a.get()).a = (j * 1000);
      }
    }
    return;
    label84:
    QLog.d(avrg.a(), 1, "send input status fail : " + paramObject);
  }
  ...
  protected void b(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      if ((!avrg.a((avrg)this.a.get())) && (paramBoolean2))
      {
        if (avrg.a((avrg)this.a.get()) != null) {
          avrg.a((avrg)this.a.get()).a(avrg.a((avrg)this.a.get()));
        }
        avrg.a((avrg)this.a.get()).input.addTextChangedListener(avrg.a((avrg)this.a.get()));
      }
      avrg.a((avrg)this.a.get(), paramBoolean2);
    }
  }
}
