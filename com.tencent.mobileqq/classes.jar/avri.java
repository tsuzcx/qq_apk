  ...
  implements ajhz, ajku
{
  ...
  MqqHandler jdField_a_of_type_MqqOsMqqHandler = new MqqHandler(Looper.getMainLooper(), new avrj(this));
  private boolean jdField_a_of_type_Boolean;
  
  public avri(Activity paramActivity)
  {
    super(paramActivity);
  ...
  public static boolean a()
  {
    ...
    return (localaqpu != null) && (localaqpu.f());
  }
  ...
  public void a(View paramView)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsPullrefreshContactRefreshHeader.setRefreshHeaderUpdateListener(new avrk(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsPullrefreshCommonRefreshLayout.setOnRefreshListener(this);
    this.jdField_a_of_type_ComTencentWidgetListView = ((ListView)paramView.findViewById(2131369731));
