...
public class wav
{
  public ArrayList<Long> a(List<String> paramList)
  {
    ...
    {
      l = awah.a((String)paramList.next()) + l;
  ...
  public ArrayList<Long> a(List<String> paramList, String paramString)
  {
    ...
    long l2 = awah.a(paramString);
    paramString = new ArrayList();
    Iterator localIterator = paramList.iterator();
    long l1 = 0L;
    while (localIterator.hasNext())
    {
      l1 = awah.a((String)localIterator.next()) + l1;
  ...
  public boolean a(List<String> paramList, String paramString, int paramInt1, int paramInt2, MediaFormat paramMediaFormat)
  {
    ...
    {
      localObject4 = new blck();
      try
      {
        i = blcj.a((String)paramList.get(0), (blck)localObject4);
      ...
      paramInt1 = j;
      if (AudioHelper.f()) {
        return blce.a(paramList, paramString, i);
      }
      ...
      localObject5 = new avza(paramString, paramInt1, paramInt2, axim.r, 1, false, i);
      ((avza)localObject5).b = true;
    }
    for (;;)
    {
      Object localObject3;
      try
      {
        ...
        localObject3 = new File(((avza)localObject5).a);
        if (!((File)localObject3).exists()) {
          bbdx.c(((File)localObject3).getAbsolutePath());
        }
        localObject3 = new MediaMuxer(((avza)localObject5).a, 0);
        ((MediaMuxer)localObject3).setOrientationHint(((avza)localObject5).g);
  ...
  public ArrayList<Long> b(List<String> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        localLinkedHashMap.put(localObject, Long.valueOf(awah.a((String)localObject)));
      }
    }
  ...
  public ArrayList<Long> b(List<String> paramList, String paramString)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        paramString.put(localObject, Long.valueOf(awah.a((String)localObject)));
      }
    }
    paramList = new ArrayList();
