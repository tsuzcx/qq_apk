...
public class ajpd
  implements awbo
{
  public ajpd(PublicAccountHandler paramPublicAccountHandler) {}
  ...
  public ReqItem a(int paramInt)
  {
    ...
    if (bool)
    {
      ...
      ((CertifiedAccountRead.StGetFollowListReq)localObject1).seq.set(azzz.a(l1));
      ((CertifiedAccountRead.StGetFollowListReq)localObject1).count.set(azzz.a(1L));
      ...
      ((PROTOCAL.StQWebReq)localObject2).qua.set(bfpk.a());
      ((PROTOCAL.StQWebReq)localObject2).deviceInfo.set(bfpj.a().c());
      ...
      localReqItem.vecParam = bakc.a((byte[])localObject1);
      return localReqItem;
    }
    ...
    localReqItem.vecParam = bakc.a(((mobileqq_mp.GetUserFollowListRequest)localObject1).toByteArray());
    return localReqItem;
  }
