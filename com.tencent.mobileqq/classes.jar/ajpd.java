...
public class ajpd
{
  ...
  public ajpd(Activity paramActivity)
  {
  ...
  private void b(String paramString)
  {
    ...
    {
      i = bfrj.b(this.jdField_a_of_type_AndroidAppActivity);
      localIntent = new Intent();
      localIntent.setFlags(603979776);
      localIntent.putExtra("Business_Origin", 100);
      localIntent.putExtra("FROM_WHERE", "FROM_SDK_AVATAR_SET_IMAGE");
      PhotoUtils.startPhotoEditForResult(localIntent, this.jdField_a_of_type_AndroidAppActivity, FriendProfileCardActivity.class.getName(), i, i, 1080, 1080, paramString, bfrj.a(), 1035);
  ...
  private void g()
  {
    String str = this.jdField_a_of_type_AndroidAppActivity.getString(2131718238) + this.jdField_b_of_type_JavaLangString;
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          Object localObject1 = bfur.a(this.jdField_a_of_type_AndroidAppActivity, 230);
          ((QQCustomDialog)localObject1).setMessage(amtj.a(2131712703));
          ((QQCustomDialog)localObject1).setNegativeButton(2131690620, new ajpe(this));
    ...
    acjz.a(this.jdField_a_of_type_AndroidAppActivity, 1, this.jdField_d_of_type_JavaLangString, (Bundle)localObject3).a("sdk_avatar_edit", null, new ajpf(this, str));
  }
  ...
  private void h()
  {
    ...
    if (localOpenID == null)
    {
      ...
      try
      {
        ...
        localQQAppInterface.getMsgHandler().a(l, this.e, Long.valueOf(this.jdField_d_of_type_JavaLangString).longValue(), new ajpg(this));
        return;
      }
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setTitle(amtj.a(2131712705));
    Object localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131718238);
    String str = this.jdField_a_of_type_AndroidAppActivity.getString(2131718239);
    if (paramString != null) {}
    for (paramString = (String)localObject + paramString;; paramString = (String)localObject)
    {
      localObject = new ajph(this, (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
      ...
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnKeyListener(new ajpi(this));
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.show();
      return;
    }
  }
  ...
  protected void a(String paramString1, String paramString2)
  {
    ...
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog = bfur.a(this.jdField_a_of_type_AndroidAppActivity, 230);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setMessage(paramString1);
    paramString1 = new ajpk(this);
  ...
  protected void e()
  {
    ...
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog = bfur.a(this.jdField_a_of_type_AndroidAppActivity, 230);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setMessage(amtj.a(2131712704));
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setTitle(2131691966);
    ajpj localajpj = new ajpj(this);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setNegativeButton(2131690620, localajpj);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton(2131718248, localajpj);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.show();
  }
