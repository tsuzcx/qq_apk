...
public class aonn
  extends acme
{
  public aonn(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(long paramLong, aonq paramaonq)
  {
    ArrayList localArrayList = paramaonq.jdField_a_of_type_JavaUtilArrayList;
    int i = 0;
    try
    {
      while (i < localArrayList.size())
      {
        ...
        if (-56 == ((MsgItem)localObject1).cType)
        {
          ...
          if (PushType.PUSH_TYPE_VOTE_INCR.value() == ((PushCardMsg)localObject2).ePushType)
          {
            ...
            {
              localObject2 = (anri)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.CARD_HANLDER);
              if (localObject2 != null) {
                ((anri)localObject2).a((PushVoteIncreaseInfo)localObject1, String.valueOf(paramLong), String.valueOf(paramaonq.jdField_a_of_type_Long));
              }
            }
          }
        }
    ...
    catch (Exception paramaonq)
    {
      paramaonq.printStackTrace();
    }
  }
  
  private void a(long paramLong, aonq paramaonq, SvcGetMsgInfo paramSvcGetMsgInfo, boolean paramBoolean)
  {
    ArrayList localArrayList1 = new ArrayList();
    ArrayList localArrayList2 = paramaonq.jdField_a_of_type_JavaUtilArrayList;
    String str2 = paramaonq.jdField_a_of_type_JavaLangString;
    int m = 0;
    int i = -1000;
    Object localObject3;
    String str1;
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        j = i;
        continue;
        if (paramaonq.jdField_a_of_type_Int != 201) {
          continue;
        }
        localObject2 = bhca.a((String)localObject3, str2);
        if (j != -2000) {
          continue;
        }
        i = -1032;
        ...
        l1 = l2;
        continue;
        if (paramaonq.jdField_a_of_type_Int != 6) {
          continue;
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.BaseMessageProcessor", 2, "----------handleAccostMsgItemResp accostMsg.eAccostType" + paramaonq.jdField_a_of_type_Int + "accostMsg.msgId: " + paramaonq.jdField_b_of_type_Long + " accostMsg.time" + paramaonq.c + " msgConten: " + bhbx.a((String)localObject3));
        }
        l2 = paramaonq.jdField_a_of_type_Long;
        if (paramaonq.jdField_a_of_type_Int != 1) {
          continue;
        }
        l1 = 9999L;
        i = j;
        localObject1 = localObject3;
        localObject3 = bcsa.a(i);
        ((MessageRecord)localObject3).init(paramLong, l1, paramaonq.jdField_a_of_type_Long, (String)localObject1, paramaonq.c, i, 1001, 0L);
        ((MessageRecord)localObject3).shmsgseq = paramaonq.jdField_b_of_type_Long;
      ...
      if (((MsgItem)localObject3).MsgContent != null)
      {
        localObject1 = new String(bcsc.a(((MsgItem)localObject3).MsgContent), "utf-8");
        break label954;
        ...
        i = -2002;
        continue;
        a(paramLong, paramBoolean, paramaonq);
        return;
        if (localArrayList1.size() <= 0) {
          continue;
        }
        boolean bool = anyv.a(localArrayList1);
        i = acnh.a(localArrayList1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        paramaonq = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade();
        if ((bool) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundStop)) {}
        for (paramBoolean = true;; paramBoolean = false)
        {
          paramaonq.addMessage(localArrayList1, String.valueOf(paramLong), paramBoolean);
  ...
  private void a(long paramLong1, ArrayList<AccostMsg> paramArrayList, ArrayList<aonp> paramArrayList1, ArrayList<SvcGetMsgInfo> paramArrayList2, long paramLong2, String paramString)
  {
    int i = 0;
    ...
    {
      Object localObject = new aonp();
      ((aonp)localObject).jdField_a_of_type_Long = localAccostMsg.lFromMID;
      ((aonp)localObject).jdField_b_of_type_Long = localAccostMsg.lToMID;
      ((aonp)localObject).c = localAccostMsg.uMsgID;
      ((aonp)localObject).jdField_a_of_type_Short = localAccostMsg.shMsgType;
      paramArrayList1.add(localObject);
      boolean bool = a(String.valueOf(paramLong1), String.valueOf(localAccostMsg.lFromMID));
      if (QLog.isColorLevel())
      {
        anyv.a("Q.msg.BaseMessageProcessor", paramString, localAccostMsg.uMsgID, String.valueOf(paramLong1), String.valueOf(localAccostMsg.lToMID));
      ...
      {
        a(paramLong1, new aonq(paramLong2, j, localAccostMsg.uMsgID, localAccostMsg.iMsgTime, localArrayList, ((RichMsg)localObject).sAction), localSvcGetMsgInfo, false);
        break;
      }
      return;
    }
  ...
  private void a(long paramLong, boolean paramBoolean, aonq paramaonq)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      int j = 0;
      while (j < paramaonq.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ((StringBuffer)localObject).append(new String(((MsgItem)paramaonq.jdField_a_of_type_JavaUtilArrayList.get(j)).MsgContent));
        if (j < paramaonq.jdField_a_of_type_JavaUtilArrayList.size() - 1) {
    ...
    localSystemMsg.auth = paramaonq.jdField_a_of_type_ArrayOfByte;
    localSystemMsg.lToMobile = paramaonq.e;
    localSystemMsg.strNickName = paramaonq.jdField_b_of_type_JavaLangString;
    if (QLog.isColorLevel()) {
      QLog.d("MessageHandler", 2, "addFriendRequestByOldVersion, addUin=" + paramaonq.d + ", msgUid=" + paramaonq.jdField_b_of_type_Long + ", msg=" + localSystemMsg.sMsg);
    }
    Object localObject = ((anvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).e(String.valueOf(l));
    label321:
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null)
      {
        localMessageRecord = bcsa.a(-1011);
        localMessageRecord.init(paramLong, 9998L, l, (String)localObject, 0L, -1011, 0, paramaonq.c);
        localMessageRecord.shmsgseq = 187L;
        localMessageRecord.msgUid = paramaonq.jdField_b_of_type_Long;
        if (paramBoolean) {
        ...
        if (anyv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, true)) {
          break label602;
        }
    ...
    for (;;)
    {
      ...
      {
        i = acnh.a(localArrayList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      label602:
      if (QLog.isColorLevel()) {
        QLog.d("MessageHandler", 2, "addFriendRequestByOldVersion, the message is remove by msgFilter, addUin=" + paramaonq.d + ", msgUid=" + localMessageRecord.msgUid + ", msg=" + localSystemMsg.sMsg);
      }
    }
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.getUin() == null)
    {
      ...
      if (QLog.isColorLevel()) {
        anyv.a("Q.msg.BaseMessageProcessor", (String)paramFromServiceMsg.getAttribute("_tag_LOGSTR"), paramObject.stMsg.uMsgID, paramToServiceMsg, String.valueOf(paramObject.stMsg.lFromMID));
      }
      if (!bool) {
    ...
    for (;;)
    {
      ...
      if ((paramObject.bResend != 1) || (!a(paramToServiceMsg, String.valueOf(paramObject.stMsg.lFromMID), paramObject.stMsg.uMsgID)))
      {
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg.VecMsg != null))
        {
          ...
          localObject = new aonq(paramObject.stMsg.lFromMID, paramObject.stMsg.eAccostType, paramObject.stMsg.uMsgID, paramObject.stMsg.iMsgTime, (ArrayList)localObject, paramFromServiceMsg.sAction);
          if (paramFromServiceMsg.stSender != null)
          {
            if (QLog.isColorLevel()) {
              QLog.d("Q.msg.BaseMessageProcessor", 2, "handlePushAccostMsg richMsg.stSender is null");
            }
            ((aonq)localObject).d = paramFromServiceMsg.stSender.lMobileUin;
            ((aonq)localObject).jdField_a_of_type_ArrayOfByte = paramFromServiceMsg.stSender.sig;
            ((aonq)localObject).jdField_b_of_type_JavaLangString = paramFromServiceMsg.stSender.nickname;
          }
          ((aonq)localObject).e = paramObject.stMsg.lFromMID;
          a(Long.valueOf(paramToServiceMsg).longValue(), (aonq)localObject, null, false);
          continue;
          paramFromServiceMsg = a(paramObject.stMsg.strMsg);
          if (paramFromServiceMsg != null)
          {
            paramFromServiceMsg = new aonq(paramObject.stMsg.lFromMID, paramFromServiceMsg.VecMsg);
  ...
  {
    paramString = bjht.a(paramString);
    ...
    {
      if (str != null) {
        bjme.a().a(String.valueOf(paramLong), str, paramString, "100", paramBoolean);
      }
      return;
    }
  }
  ...
  {
    paramString1 = ((anvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).e(paramString2);
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    a(false, false, false, 0L, new aono(this, paramArrayOfByte, paramInt));
  }
