...
public class wqu
{
  ...
  public wqu(qqstory_struct.QimVideoInfo paramQimVideoInfo)
  {
  ...
  public static wqu a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new wqu(localQimVideoInfo);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      yqp.c("QimVideoInfoItem", "Error: parse db bytes error.", paramArrayOfByte);
    }
    return null;
  }
