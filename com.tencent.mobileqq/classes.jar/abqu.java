...
public class abqu
  extends ajtq
{
  public abqu(PermisionPrivacyActivity paramPermisionPrivacyActivity) {}
  ...
  protected void onGetAllowStrangerInviteToGroupSwitch(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    if (!paramBoolean1)
    {
      ...
      Card localCard = ((ajxn)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
  ...
  protected void onGetCalReactiveDays(boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((paramBoolean1) && (!this.a.isFinishing()))
    {
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(ajyc.a(2131699425));
    }
    for (;;)
    {
      ...
      return;
      label106:
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(ajyc.a(2131699426));
    }
  }
  ...
  protected void onSetMedal(boolean paramBoolean)
  {
    ...
    Object localObject1 = ((ajxn)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
    ...
    for (;;)
    {
      axqw.b((QQAppInterface)localObject2, "dc00898", "", "", "0X80073A0", "0X80073A0", i, 0, "", "", "", "");
      return;
      label260:
      paramBoolean = false;
      break;
