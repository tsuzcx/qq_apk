  ...
  extends FilterOutputStream
{
  ...
  private static bdgv jdField_b_of_type_Bdgv;
  private static int c;
  protected int a;
  private bdgv jdField_a_of_type_Bdgv;
  private boolean jdField_a_of_type_Boolean;
  protected byte[] a;
  private final int jdField_b_of_type_Int = 4;
  
  private bdgv(OutputStream paramOutputStream)
  {
    this(paramOutputStream, 8192);
  }
  
  private bdgv(OutputStream paramOutputStream, int paramInt)
  {
  ...
  public static bdgv a(OutputStream paramOutputStream)
  {
    bdgv localbdgv = null;
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_b_of_type_Bdgv != null)
      {
        localbdgv = jdField_b_of_type_Bdgv;
        jdField_b_of_type_Bdgv = localbdgv.jdField_a_of_type_Bdgv;
        localbdgv.jdField_a_of_type_Bdgv = null;
        c -= 1;
      }
      if (localbdgv != null)
      {
        localbdgv.out = paramOutputStream;
        localbdgv.jdField_a_of_type_Boolean = true;
        return localbdgv;
      }
    }
    return new bdgv(paramOutputStream);
  }
  ...
  private void a()
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (c < 4)
      {
        this.jdField_a_of_type_Bdgv = jdField_b_of_type_Bdgv;
        jdField_b_of_type_Bdgv = this;
        c += 1;
      }
      return;
    }
