  ...
  extends LinearLayout
{
  ...
  public rhp(TabLayoutCompat paramTabLayoutCompat, Context paramContext)
  {
    super(paramContext);
  ...
  private void a(@Nullable TextView paramTextView, @Nullable ImageView paramImageView)
  {
    ...
    {
      localDrawable = this.jdField_a_of_type_Rho.a();
      if (this.jdField_a_of_type_Rho == null) {
        break label176;
      }
      localCharSequence1 = this.jdField_a_of_type_Rho.a();
      if (this.jdField_a_of_type_Rho == null) {
        break label182;
      }
      localCharSequence2 = this.jdField_a_of_type_Rho.b();
      label48:
  ...
  public void a(@Nullable rho paramrho)
  {
    if (paramrho != this.jdField_a_of_type_Rho)
    {
  ...
  public boolean performClick()
  {
    ...
    if (this.jdField_a_of_type_Rho != null)
    {
      ...
      rho localrho = TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat);
      if (TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat) == this.jdField_a_of_type_Rho) {
        i = 1;
      }
      this.jdField_a_of_type_Rho.a();
      if ((TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat) != null) && (i == 0)) {
        TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat).a(this.jdField_a_of_type_Rho, localrho, 1);
      }
      return true;
    }
    return bool;
