...
public class bjbz
  implements biyo
{
  private static bjbz jdField_a_of_type_Bjbz;
  private int jdField_a_of_type_Int = 2;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private SparseArray<bjcb> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray(1);
  private bjcc jdField_a_of_type_Bjcc;
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  private INetInfoHandler jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new bjca(this);
  ...
  private bjbz(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidUtilSparseArray.put(1, bjcb.a());
  ...
  public static bjbz a(AppInterface paramAppInterface)
  {
    try
    {
      if (jdField_a_of_type_Bjbz == null)
      {
        jdField_a_of_type_Bjbz = new bjbz(paramAppInterface);
        biyk.a(paramAppInterface).a(jdField_a_of_type_Bjbz);
      }
      paramAppInterface = jdField_a_of_type_Bjbz;
  ...
  public static void a()
  {
    try
    {
      if (jdField_a_of_type_Bjbz != null)
      {
        jdField_a_of_type_Bjbz.c();
        jdField_a_of_type_Bjbz = null;
      }
      biyk.a();
      return;
    }
  ...
  private void a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.usable) && (a(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.activityType)) && (this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.activityType == paramInt))
    {
      ...
      if ((this.jdField_a_of_type_Bjcc != null) && (bool))
      {
        ...
        this.jdField_a_of_type_Bjcc.a(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.name);
      }
    }
  }
  ...
  private void b()
  {
    bjcb localbjcb = (bjcb)this.jdField_a_of_type_AndroidUtilSparseArray.get(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.activityType);
    ...
    if ((localbjcb == null) || (!this.jdField_a_of_type_Boolean)) {}
    do
    {
      return;
      a("startLocationUsingActivity", String.format("mRequestStatus=%s", new Object[] { localbjcb.a() }), null);
    } while (localbjcb.jdField_a_of_type_Int != 3);
    a("startLocationUsingActivity", String.format("mRequestBeginTime=%s", new Object[] { "" + localbjcb.jdField_a_of_type_Long }), null);
    if (localbjcb.jdField_a_of_type_Long > 0L)
    {
      long l = System.currentTimeMillis() - localbjcb.jdField_a_of_type_Long;
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      localbjcb.c();
      localbjcb.b();
      localbjcb.jdField_a_of_type_Int = 1;
      localbjcb.jdField_a_of_type_Long = System.currentTimeMillis();
      biyk.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface).a(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.activityType);
      return;
    }
  }
  ...
  {
    bjcb localbjcb = (bjcb)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    if (localbjcb != null)
    {
      ...
      if (localbjcb.jdField_a_of_type_Int == 3) {
        break label98;
      }
      localbjcb.jdField_a_of_type_Boolean = paramBoolean;
      if (paramBoolean) {
        localbjcb.jdField_a_of_type_Int = 2;
      }
    }
    else
    {
    ...
    localbjcb.jdField_a_of_type_Int = 3;
    a(paramInt);
    return;
    label98:
    a("processLocationPermission", String.format("[Error]Status=%s", new Object[] { localbjcb.a() }), null);
    localbjcb.jdField_a_of_type_Boolean = paramBoolean;
    localbjcb.jdField_a_of_type_JavaUtilArrayList.clear();
    localbjcb.jdField_a_of_type_Bjcb.jdField_a_of_type_JavaUtilArrayList.clear();
    a(paramInt);
  }
  ...
  private void b(int paramInt, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    if (localbjcb != null)
    {
      ...
      if (localbjcb.jdField_a_of_type_Int != 3)
      {
        if (paramBoolean)
        {
          localbjcb.jdField_a_of_type_JavaUtilArrayList.addAll(paramArrayList);
    ...
    a("processLocationForTemplate", String.format("[Error]templateIds= %s,Status=%s", new Object[] { paramArrayList.toString(), localbjcb.a() }), null);
  }
  
  private boolean b(int paramInt)
  {
    bjcb localbjcb = (bjcb)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    if ((localbjcb.jdField_a_of_type_Boolean) && (localbjcb.a(this.jdField_a_of_type_DovComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id))) {}
