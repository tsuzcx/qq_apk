...
public class akvf
{
  ...
  public static android.graphics.drawable.Drawable a(Context paramContext, int paramInt1, int paramInt2, String paramString)
  {
    ...
    //   22: iload_1
    //   23: iload_2
    //   24: invokespecial 38	apkq:<init>	(IFII)V
    //   27: astore 5
    //   29: new 27	apkq
    //   32: dup
    //   33: ldc 29
    ...
    //   42: iload_1
    //   43: iload_2
    //   44: invokespecial 38	apkq:<init>	(IFII)V
    //   47: astore_0
    //   48: new 27	apkq
    //   51: dup
    //   52: aload_3
    ...
    //   60: iload_1
    //   61: iload_2
    //   62: invokespecial 38	apkq:<init>	(IFII)V
    //   65: astore 4
    //   67: new 27	apkq
    //   70: dup
    ...
    //   108: iload_1
    //   109: iload_2
    //   110: invokespecial 38	apkq:<init>	(IFII)V
    //   113: astore_3
    //   114: aload_3
    //   115: sipush 204
        ...
        if (paramInt1 >= 0)
        {
          ...
          for (;;)
          {
            ...
            if ((((MessageForApollo)localObject2).gameId == paramInt2) && (((MessageForApollo)localObject2).roomId == paramLong))
            {
              ...
              if (a()) {
                localaknt.a().a((MessageForApollo)localObject2);
              }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ApolloGameData paramApolloGameData, int paramInt)
  {
    ...
    if (!bdiv.a(paramContext, paramApolloGameData.gameAppPkgName))
    {
    ...
    ((aknx)paramQQAppInterface.getManager(153)).a().a(paramApolloGameData.gameId, paramApolloGameData.gameAppid, 0, paramSessionInfo.jdField_a_of_type_JavaLangString, paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localalnf.jdField_b_of_type_Int = i;
        localalnf.jdField_a_of_type_Int = paramInt;
        localalnf.jdField_a_of_type_Long = paramLong;
        localalnf.e = 1;
        localalnf.d = 3;
        a(paramQQAppInterface, paramString, localalnf);
        return;
        localalnf.jdField_b_of_type_JavaLangString = alud.a(2131702500);
        i = 0;
      }
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, alnf paramalnf)
  {
    if ((paramalnf == null) || (paramQQAppInterface == null))
    {
      QLog.e("CmGameTemp_CmGameSessionUtil", 1, "[sendGameMsg], errInfo->param is null.");
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("CmGameTemp_CmGameSessionUtil", 2, new Object[] { "[sendGameMsg], gameId:", Integer.valueOf(paramalnf.jdField_a_of_type_Int), ",roomId:", Long.valueOf(paramalnf.jdField_a_of_type_Long), ",extendInfo:", paramalnf.jdField_c_of_type_JavaLangString });
    }
    ApolloMessage localApolloMessage = new ApolloMessage();
    if (!TextUtils.isEmpty(paramalnf.jdField_a_of_type_JavaLangString)) {
      localApolloMessage.name = paramalnf.jdField_a_of_type_JavaLangString.getBytes();
    }
    if (0 == 0) {}
    for (;;)
    {
      try
      {
        ...
        ((JSONObject)localObject).put("gameId", paramalnf.jdField_a_of_type_Int);
        ((JSONObject)localObject).put("gameMode", paramalnf.jdField_c_of_type_Int);
        ((JSONObject)localObject).put("roomid", paramalnf.jdField_a_of_type_Long);
        if (paramalnf.jdField_a_of_type_Int == 1)
        {
          ((JSONObject)localObject).put("msgTyep", 2);
          ((JSONObject)localObject).put("gameName", paramalnf.jdField_b_of_type_JavaLangString);
          if (!TextUtils.isEmpty(paramalnf.jdField_c_of_type_JavaLangString)) {
            ((JSONObject)localObject).put("gameExtendJson", paramalnf.jdField_c_of_type_JavaLangString);
          }
          ((JSONObject)localObject).put("gameStatus", paramalnf.e);
          if (localObject != null) {
            localApolloMessage.extStr = ((JSONObject)localObject).toString();
          }
          localObject = ((aknx)paramQQAppInterface.getManager(153)).b(paramQQAppInterface.getCurrentAccountUin());
          localApolloMessage.sender_ts = bdeu.a(((ApolloBaseInfo)localObject).apolloServerTS);
          localApolloMessage.sender_status = ((ApolloBaseInfo)localObject).apolloStatus;
          localObject = ((aliw)paramQQAppInterface.getManager(155)).a(paramalnf.jdField_a_of_type_Int);
          if ((localObject == null) || (1 != ((ApolloGameData)localObject).hasOwnArk)) {
            break label511;
          }
          i = 297;
          localApolloMessage.flag = (i | 0x200);
          paramString = azaf.a(paramQQAppInterface, paramString, paramQQAppInterface.getCurrentAccountUin(), 1036, localApolloMessage);
          if (paramalnf.jdField_a_of_type_Int == 1)
          {
            paramString.msgType = 2;
            paramString.gameId = paramalnf.jdField_a_of_type_Int;
            paramString.mGameMode = paramalnf.jdField_c_of_type_Int;
            paramString.roomId = paramalnf.jdField_a_of_type_Long;
            paramString.mApolloMessage.id = paramalnf.jdField_b_of_type_Int;
            paramString.gameName = paramalnf.jdField_b_of_type_JavaLangString;
            paramString.gameExtendJson = paramalnf.jdField_c_of_type_JavaLangString;
            paramString.gameStatus = paramalnf.e;
            paramString.extendJson = ("{\"gameStatus\":" + paramalnf.e + "}");
        ...
        {
          ((JSONObject)localObject).put("msgTyep", paramalnf.d);
          continue;
        }
        paramString.msgType = paramalnf.d;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    ((aknx)paramQQAppInterface.getManager(153)).a().b(paramString1, paramString2);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, long paramLong, int paramInt)
  {
    ...
    ApolloGameData localApolloGameData = ((aliw)localObject2).a(paramInt);
    Object localObject1 = alud.a(2131702499);
    if ((localApolloGameData != null) && (!TextUtils.isEmpty(localApolloGameData.name)))
    {
      localObject2 = ((aliw)localObject2).a(localApolloGameData.actionId);
    ...
    for (;;)
    {
      int i = localApolloGameData.actionId;
      localalnf.jdField_b_of_type_JavaLangString = localApolloGameData.name;
      localalnf.jdField_a_of_type_JavaLangString = ((String)localObject1);
      localalnf.jdField_b_of_type_Int = i;
      localalnf.jdField_a_of_type_Int = paramInt;
      localalnf.jdField_a_of_type_Long = paramLong;
      localalnf.e = 0;
      ...
      if (!TextUtils.isEmpty(localalnf.jdField_a_of_type_JavaLangString)) {
        ((ApolloMessage)localObject2).name = localalnf.jdField_a_of_type_JavaLangString.getBytes();
      }
      localObject1 = null;
      if (0 == 0) {}
      for (;;)
      {
        try
        {
          ...
          ((JSONObject)localObject1).put("gameId", localalnf.jdField_a_of_type_Int);
          ((JSONObject)localObject1).put("gameMode", localalnf.jdField_c_of_type_Int);
          ((JSONObject)localObject1).put("roomid", localalnf.jdField_a_of_type_Long);
          if (localalnf.jdField_a_of_type_Int == 1)
          {
            ((JSONObject)localObject1).put("msgTyep", 2);
            ((JSONObject)localObject1).put("gameName", localalnf.jdField_b_of_type_JavaLangString);
            if (!TextUtils.isEmpty(localalnf.jdField_c_of_type_JavaLangString)) {
              ((JSONObject)localObject1).put("gameExtendJson", localalnf.jdField_c_of_type_JavaLangString);
            }
            ((JSONObject)localObject1).put("gameStatus", localalnf.e);
            if (localObject1 != null) {
              ((ApolloMessage)localObject2).extStr = ((JSONObject)localObject1).toString();
            }
            localObject1 = ((aknx)paramQQAppInterface.getManager(153)).b(paramQQAppInterface.getCurrentAccountUin());
            ((ApolloMessage)localObject2).sender_ts = bdeu.a(((ApolloBaseInfo)localObject1).apolloServerTS);
            ...
            localObject1 = azaf.a(paramQQAppInterface, paramString1, paramQQAppInterface.getCurrentAccountUin(), 1036, (ApolloMessage)localObject2);
            if (localalnf.jdField_a_of_type_Int != 1) {
              break label698;
            }
            ((MessageForApollo)localObject1).msgType = 2;
            ((MessageForApollo)localObject1).gameId = localalnf.jdField_a_of_type_Int;
            ((MessageForApollo)localObject1).mGameMode = localalnf.jdField_c_of_type_Int;
            ((MessageForApollo)localObject1).roomId = localalnf.jdField_a_of_type_Long;
            ((MessageForApollo)localObject1).mApolloMessage.id = localalnf.jdField_b_of_type_Int;
            ((MessageForApollo)localObject1).gameName = localalnf.jdField_b_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameExtendJson = localalnf.jdField_c_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameStatus = localalnf.e;
            ((MessageForApollo)localObject1).extendJson = ("{\"gameStatus\":" + localalnf.e + ",\"robotOpenId\":" + paramString2 + "}");
            ...
            jdField_a_of_type_Long = System.currentTimeMillis();
            return;
            localalnf.jdField_b_of_type_JavaLangString = alud.a(2131702501);
            i = 0;
            break;
          }
          ((JSONObject)localObject1).put("msgTyep", localalnf.d);
          continue;
          ((MessageForApollo)localObject1).msgType = localalnf.d;
        }
        catch (Throwable paramQQAppInterface)
        {
          QLog.d("CmGameTemp_CmGameSessionUtil", 2, paramQQAppInterface, new Object[0]);
  ...
  public static boolean a()
  {
    if ((BaseActivity.sTopActivity instanceof FragmentActivity))
    {
      ...
      if (localObject != null)
      {
        ...
        if (!(localObject instanceof agoe)) {}
      }
    }
    for (Object localObject = (agoe)localObject;; localObject = null) {
      return (localObject != null) && (((agoe)localObject).E());
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      acjm.b(paramQQAppInterface, localSessionInfo, (ArkAppMessage)localObject);
      return true;
    }
