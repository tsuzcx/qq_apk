...
public class aoex
{
  ...
  public aoex(String paramString)
  {
  ...
  public void a()
  {
    ...
    do
    {
      ...
      this.d = bdiv.a(this.e, "confess_config_sp").getString("key_frd_rec_confess_info", "");
  ...
  public void b()
  {
    try
    {
      ...
      bdiv.a(this.e, "confess_config_sp").edit().putString("key_frd_rec_confess_info", this.d).apply();
      label112:
      if (QLog.isColorLevel()) {
