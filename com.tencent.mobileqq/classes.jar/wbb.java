  ...
  implements umd
{
  ...
  public HashMap<String, WeakReference<wbd>> a;
  public List<HotSortVideoEntry> a;
  wbl a;
  protected boolean a;
  protected boolean b;
  
  public wbb(Context paramContext, boolean paramBoolean)
  {
    super(paramContext);
  ...
  private static void b(ImageView paramImageView, int paramInt, String paramString)
  {
    if (paramImageView == null) {
      wsv.e("Q.qqstory.shareGroup.ShareGroupsListAdapter", "update imageView error. imageView is null.");
    }
    do
    {
      return;
    ...
    xod.b(paramImageView, xoa.a(paramString), 80, 80, null, "StoryDiscoverHeadImage");
  }
  ...
  protected View a(int paramInt, ViewGroup paramViewGroup)
  {
    ...
    if (paramInt == 1)
    {
      localView = localLayoutInflater.inflate(2131561550, paramViewGroup, false);
      localView.setTag(new wbd(localView, this));
    }
    do
    {
      return localView;
      if (paramInt == 0)
      {
        paramViewGroup = localLayoutInflater.inflate(2131561485, paramViewGroup, false);
        paramViewGroup.setTag(new wbi(paramViewGroup, this));
        return paramViewGroup;
      }
      if (paramInt == 2)
      {
        paramViewGroup = localLayoutInflater.inflate(2131561549, paramViewGroup, false);
        paramViewGroup.setTag(new wbh(paramViewGroup, this));
        return paramViewGroup;
      }
    } while (paramInt != 7);
    paramViewGroup = localLayoutInflater.inflate(2131561546, paramViewGroup, false);
    paramViewGroup.setTag(new wbg(paramViewGroup, this));
    return paramViewGroup;
  }
  ...
  public void a(String paramString, List<wiu> paramList)
  {
    ...
    if ((paramList != null) && (paramList.get() != null))
    {
      ...
      ((wbd)paramList.get()).a.setData(localVideoCollectionItem);
    }
    label55:
    while (!QLog.isColorLevel()) {
      return;
  ...
  public void a(wbl paramwbl)
  {
    super.a(paramwbl, paramwbl);
