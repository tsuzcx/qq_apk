  ...
  implements bgrf, bgrh
{
  ...
  public WeakReference<akxu> a;
  public HashMap<MessageForPtt, MessageForQQWalletMsg> a;
  public Map<MessageForPtt, akxw> a;
  ...
  public static akxm a()
  {
    try
    {
      if (jdField_a_of_type_Akxm == null) {
        jdField_a_of_type_Akxm = new akxm();
      }
      akxm localakxm = jdField_a_of_type_Akxm;
      return localakxm;
    }
    finally {}
  }
  
  private akxv a(byte[] paramArrayOfByte)
  {
    boolean bool = true;
    akxv localakxv = new akxv();
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length == 0)) {
      return localakxv;
    }
    akxl.a().a();
    if (akxl.a().a(paramArrayOfByte, paramArrayOfByte.length) == 1) {}
    for (;;)
    {
      localakxv.jdField_a_of_type_Boolean = bool;
      localakxv.jdField_a_of_type_Float = akxl.a().a();
      localakxv.jdField_a_of_type_JavaLangString = a(localakxv.jdField_a_of_type_Float);
      akxl.a().b();
  ...
  private akxv a(byte[] paramArrayOfByte, MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
  ...
  private void a(int paramInt1, long paramLong, int paramInt2, MessageForQQWalletMsg paramMessageForQQWalletMsg, float paramFloat)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (akxl.a().a(localQQAppInterface)) {
        paramInt1 = 1;
      } else {
        paramInt1 = 0;
      }
  ...
  {
    akxu localakxu = (akxu)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((localakxu != null) && (!localakxu.c())) {
      localakxu.a(paramInt, paramString);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(MessageRecord paramMessageRecord, long paramLong, byte[] paramArrayOfByte, String paramString)
  {
    ...
    try
    {
      MessageForPtt localMessageForPtt = adrm.a(akww.a(), paramMessageRecord.getLocalFilePath(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, -2, paramMessageRecord.voiceType);
      if (localMessageForPtt != null)
      {
        this.jdField_a_of_type_JavaUtilMap.put(localMessageForPtt, new akxw(paramMessageRecord, paramLong, paramArrayOfByte, paramString));
        paramArrayOfByte = new QQRecorder.RecorderParam(bgrn.jdField_b_of_type_Int, 16000, 1);
        if (a(this.jdField_a_of_type_ArrayOfByte, this.jdField_a_of_type_JavaLangString, paramMessageRecord.getLocalFilePath(), paramArrayOfByte))
        {
          ...
          if ((paramString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (localMessageForPtt != null))
          {
            ...
            paramArrayOfByte = (akxu)this.jdField_a_of_type_JavaLangRefWeakReference.get();
  ...
  public static void a(String paramString, MessageForPtt paramMessageForPtt, bdtc parambdtc)
  {
    b(paramString, paramMessageForPtt);
    if (parambdtc != null)
    {
      if (!(parambdtc instanceof bdtl)) {
        break label38;
      }
      paramString = ((bdtl)parambdtc).a();
    ...
    do
    {
      ...
      {
        return;
      } while (!(parambdtc instanceof bdvf));
      paramString = ((bdvf)parambdtc).a(paramMessageForPtt);
    ...
    for (;;)
    {
      try
      {
        ...
        if (!((File)localObject).exists())
        {
          ...
          localmmz = new mmz(paramRecorderParam.jdField_a_of_type_Int, 16, 1);
          localmmz.a(new akxn(this));
          l = System.currentTimeMillis();
        }
        try
        {
          localmmz.a(paramString1, str);
          if (QLog.isColorLevel()) {
          ...
          azte.a(paramString2);
          paramRecorderParam = bgrn.a(paramRecorderParam.jdField_c_of_type_Int, paramRecorderParam.jdField_a_of_type_Int);
          azte.a(paramString2, paramRecorderParam, paramRecorderParam.length);
          ...
          azte.a(paramString2, ((azuf)localObject).jdField_a_of_type_ArrayOfByte, ((azuf)localObject).jdField_a_of_type_Int);
        }
  ...
  public int a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    paramString = (akxu)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (paramString != null) {
  ...
  public String a(float paramFloat)
  {
    ...
    if (localObject1 != null)
    {
      ...
      if (localObject1 != null)
      {
        localObject1 = ((akpd)localObject1).a("voice_pwd", new String[] { "scoreIdMap" });
        if (localObject1 == null) {}
      }
    }
    int i;
  ...
  public void a(akxt paramakxt)
  {
    Object localObject = akww.a();
    if ((localObject == null) || (paramakxt == null)) {}
    do
    {
      return;
      localObject = ((TicketManager)((QQAppInterface)localObject).getManager(2)).GetSkey(((QQAppInterface)localObject).getCurrentAccountUin(), 16L, new akxs(this, paramakxt));
    } while ((localObject == null) || (((Ticket)localObject)._sig == null) || (((Ticket)localObject)._sig.length == 0));
    paramakxt.a(new String(((Ticket)localObject)._sig));
  }
  
  public void a(akxu paramakxu)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramakxu);
  }
  ...
  public void a(SessionInfo paramSessionInfo, MessageForQQWalletMsg paramMessageForQQWalletMsg, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      i = ahxb.a(paramMessageForQQWalletMsg.messageType);
      str1 = paramString;
      if (TextUtils.isEmpty(paramString)) {
      ...
      localRecorderParam = new QQRecorder.RecorderParam(bgrn.jdField_b_of_type_Int, 16000, 1);
      if (!bgmg.a())
      {
        b(2131694003);
        c("no sdcard");
    ...
    boolean bool2 = true;
    long l1 = akms.a(localQQAppInterface.getCurrentAccountUin(), "voice_recognieze_in_phone", 0L);
    ...
    if ((!this.jdField_c_of_type_Boolean) && (!bool1)) {
      a(2, akms.a(localQQAppInterface.getCurrentAccountUin(), "voice_recognieze_in_phone_tips", BaseApplicationImpl.getContext().getResources().getString(2131694681)));
    }
    if (paramBoolean)
    {
    ...
    for (;;)
    {
      ...
      do
      {
        str1 = bdtd.a(localQQAppInterface.getCurrentAccountUin(), null, 2, null, false);
        ...
        paramSessionInfo = adrm.a(localQQAppInterface, paramString, paramSessionInfo, -2, localRecorderParam.jdField_c_of_type_Int);
  ...
  public void a(MessageRecord paramMessageRecord, anqd paramanqd, long paramLong, byte[] paramArrayOfByte, String paramString, bdtc parambdtc)
  {
    QQAppInterface localQQAppInterface;
    Object localObject1;
    Object localObject2;
    ...
    {
      localQQAppInterface = akww.a();
      localObject1 = (akxu)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      i = 0;
      if (localObject1 != null) {
        i = localObject1.hashCode();
      }
      if ((localQQAppInterface == null) || (paramMessageRecord == null) || (!(paramMessageRecord instanceof MessageForPtt)) || (localObject1 == null) || (((akxu)localObject1).c()) || (this.jdField_b_of_type_Boolean) || (i != this.jdField_a_of_type_Int)) {
        return;
      }
      ...
      if (i == 1)
      {
        paramMessageRecord = (akxu)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        ...
        localQQAppInterface.a().a((MessageRecord)localObject2, paramanqd);
        return;
      }
      if (i != 2) {
        break label307;
    ...
    for (;;)
    {
      a(new akxo(this, localQQAppInterface, (MessageForQQWalletMsg)localObject1, i, paramLong, paramArrayOfByte, paramString, (MessageForPtt)localObject2, parambdtc, paramanqd));
      return;
    ...
    if (i == 3)
    {
      ...
      {
        paramMessageRecord = (MessageForPtt)paramMessageRecord;
        localObject2 = (akxw)this.jdField_a_of_type_JavaUtilMap.get(paramMessageRecord);
        ...
        for (;;)
        {
          a(new akxq(this, localMessageForQQWalletMsg, localQQAppInterface, i, (akxw)localObject2, paramLong, paramArrayOfByte, paramString, (MessageForQQWalletMsg)localObject1, paramMessageRecord, parambdtc, paramanqd));
          return;
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    byte[] arrayOfByte = bgrn.a(paramRecorderParam.jdField_c_of_type_Int, paramRecorderParam.jdField_a_of_type_Int);
    azte.a(paramString);
    azte.a(paramString, arrayOfByte, arrayOfByte.length);
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam, double paramDouble)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      bool = ((akxv)localObject2).jdField_a_of_type_Boolean;
      if (bool) {
        b(((akxv)localObject2).jdField_a_of_type_JavaLangString, (MessageRecord)localObject1);
      }
      localObject2 = (akxu)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((localObject2 == null) || (((akxu)localObject2).c()) || (bool)) {
        break label679;
      }
      ((akxu)localObject2).a(false, "");
      break label679;
      localObject2 = (MessageForQQWalletMsg)this.jdField_a_of_type_JavaUtilHashMap.get(localObject1);
      ...
      j = ahxb.a(((MessageForQQWalletMsg)localObject2).messageType);
      if (j == 8) {
        if (((MessageForQQWalletMsg)localObject2).mQQWalletRedPacketMsg.elem.songFlag == 0) {
          if (this.jdField_d_of_type_Int == -1) {
            if (!akww.a(BaseApplicationImpl.getContext())) {
              break label682;
            }
          }
        }
  ...
  public void b(int paramInt)
  {
    ...
    localQQAppInterface.runOnUiThread(new VoiceRedPacketHelper.1(this, localBaseApplication, paramInt, localBaseApplication.getResources().getDimensionPixelSize(2131298998)));
  }
  
  public void b(azue paramazue, azuf paramazuf)
  {
    if (((paramazue instanceof WechatNsWrapper)) && (this.jdField_a_of_type_JavaIoByteArrayOutputStream != null) && (paramazuf != null) && (this.jdField_d_of_type_Boolean)) {
      this.jdField_a_of_type_JavaIoByteArrayOutputStream.write(paramazuf.jdField_a_of_type_ArrayOfByte, 0, paramazuf.jdField_a_of_type_Int);
    }
  }
