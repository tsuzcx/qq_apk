...
public class bftt
{
  public int a;
  public String a;
  public ConcurrentHashMap<String, bftu> a;
  public int b;
  ...
  public group_effect_commu.TGetMyEffectRsp0x2 a()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 0)
    {
      ...
      while (localIterator.hasNext()) {
        localArrayList.add(((bftu)((Map.Entry)localIterator.next()).getValue()).a());
      }
  ...
  public void a(group_effect_commu.TGetMyEffectRsp0x2 paramTGetMyEffectRsp0x2)
  {
    ...
    if ((paramTGetMyEffectRsp0x2.rpt_userconfig.has()) && (paramTGetMyEffectRsp0x2.rpt_userconfig.size() > 0))
    {
      ...
      while (i < paramTGetMyEffectRsp0x2.size())
      {
        ...
        bftu localbftu = new bftu();
        localbftu.a((group_effect_commu.TEffectDetail)localObject);
        if (QLog.isColorLevel()) {
          QLog.d("TroopEnterEffect.EffectInfo", 2, "mergeFromPB rpt_userconfig index = " + i + " detail = " + localbftu.toString());
        }
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localbftu.a + "", localbftu);
        i += 1;
      }
    }
    if (QLog.isColorLevel()) {
