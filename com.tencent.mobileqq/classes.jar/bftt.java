...
public class bftt
{
  ...
  private static avpj jdField_a_of_type_Avpj = new bftu();
  ...
  private static MediaPlayer a(Context paramContext, int paramInt)
  {
    ...
    //   22: astore_2
    //   23: aload_2
    //   24: invokestatic 57	bftt:a	(Landroid/media/MediaPlayer;)V
    //   27: aload_2
    //   28: aload_0
    ...
    for (;;)
    {
      ...
      if (paramInt1 != AppSetting.d)
      {
        ...
        if (jdField_a_of_type_AndroidMediaMediaPlayer != null)
        {
          ...
          jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new bfty(paramOnCompletionListener, paramHandler));
  ...
  public static void a(int paramInt, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new bftw());
      jdField_a_of_type_AndroidMediaMediaPlayer.start();
  ...
  public static void a(Uri paramUri, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   2: ldc 2
    //   4: monitorenter
    //   5: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   8: astore 4
    //   10: aload 4
    //   12: ifnull +13 -> 25
    //   15: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   18: invokevirtual 97	android/media/MediaPlayer:release	()V
    //   21: aconst_null
    //   22: putstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   25: aload_0
    ...
    //   45: putstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   48: iload_2
    //   49: ifeq +25 -> 74
    ...
    //   68: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   71: invokestatic 57	bftt:a	(Landroid/media/MediaPlayer;)V
    ...
    //   95: aload_0
    //   96: astore 4
    //   98: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   101: aload_0
    ...
    //   110: aload_0
    //   111: astore 4
    //   113: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   116: invokevirtual 80	android/media/MediaPlayer:prepare	()V
    //   119: aload_0
    //   120: astore_3
    //   121: aload_0
    //   122: astore 4
    //   124: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   127: new 302	bftz
    //   130: dup
    //   131: invokespecial 303	bftz:<init>	()V
    ...
    //   139: aload_0
    //   140: astore 4
    //   142: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   145: invokevirtual 147	android/media/MediaPlayer:start	()V
    //   148: aload_0
    //   149: astore_3
    //   150: aload_0
    //   151: astore 4
    //   153: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   156: iload_1
    ...
    //   172: astore 4
    //   174: aconst_null
    //   175: putstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   178: goto -153 -> 25
    //   181: astore_0
    //   182: aconst_null
    //   183: astore 4
    ...
    //   212: astore_0
    //   213: aconst_null
    //   214: putstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   217: aload_0
    //   218: athrow
    //   219: astore_0
    //   220: aload_3
    ...
    //   237: putstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   240: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   243: astore_0
    //   244: aload_0
    ...
    //   288: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   291: invokestatic 57	bftt:a	(Landroid/media/MediaPlayer;)V
    //   294: aconst_null
    //   295: astore_0
    //   296: goto -177 -> 119
    //   299: astore_0
  ...
  public static void a(java.lang.String paramString, boolean paramBoolean)
  {
    ...
    //   9: aload 5
    //   11: astore_3
    //   12: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   15: ifnull +60 -> 75
    //   18: aload 5
    //   20: astore_3
    //   21: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   60: aload_0
    //   61: athrow
    //   62: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   65: invokevirtual 97	android/media/MediaPlayer:release	()V
    //   68: aload 5
    //   70: astore_3
    //   71: aconst_null
    //   72: putstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   75: aload 5
    //   77: astore_3
    //   78: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   81: ifnonnull +16 -> 97
    //   84: aload 5
    //   86: astore_3
    ...
    //   94: putstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   97: aload 5
    //   99: astore_3
    //   100: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   117: astore_0
    //   118: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   121: aload_0
    ...
    //   128: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   131: invokestatic 57	bftt:a	(Landroid/media/MediaPlayer;)V
    //   134: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   137: invokevirtual 80	android/media/MediaPlayer:prepare	()V
    //   140: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   143: new 317	bftv
    //   146: dup
    //   147: invokespecial 318	bftv:<init>	()V
    ...
    //   159: getstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   162: iload_1
    ...
    //   188: astore_3
    //   189: aconst_null
    //   190: putstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   193: goto -118 -> 75
    //   196: astore_3
    //   197: aload 4
    //   199: astore_0
    ...
    //   253: astore_3
    //   254: aconst_null
    //   255: putstatic 113	bftt:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   258: aload 5
    //   260: astore_3
    //   261: aload_0
    //   262: athrow
  ...
  public static boolean a(Context paramContext, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        avpf.a().a(1, jdField_a_of_type_Avpj);
        if (QLog.isColorLevel()) {
  ...
  public static void b(int paramInt, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new bftx());
      jdField_a_of_type_AndroidMediaMediaPlayer.start();
      jdField_a_of_type_AndroidMediaMediaPlayer.setLooping(paramBoolean);
    }
  }
