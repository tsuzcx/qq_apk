  ...
  implements Manager
{
  ...
  public bftt(QQAppInterface paramQQAppInterface)
  {
  ...
  private MessageForTroopReward a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, int paramInt3)
  {
    ...
    localMessageForTroopReward.msgUid = bbzj.a(paramInt1);
    localMessageForTroopReward.msg = bgnr.a(null);
    ...
    localMessageForTroopReward.time = bbyp.a();
  ...
  {
    acwe localacwe = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(0).a();
    Lock localLock = localacwe.a(paramString, paramInt);
    localLock.lock();
    try
    {
      paramString = (List)localacwe.b().get(a(paramString, paramInt));
      if (paramString != null)
      {
