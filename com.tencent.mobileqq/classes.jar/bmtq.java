...
public class bmtq
  implements bmrf
{
  public bmtq(DoodleLayout paramDoodleLayout) {}
  
  public void a()
  {
    wxe.b("DoodleLayout", "deleteVote.");
    if (DoodleLayout.a(this.a) != null)
    {
      bmoy localbmoy = (bmoy)DoodleLayout.a(this.a).a(bmoy.class);
      if (localbmoy != null) {
        localbmoy.d();
      }
    }
  ...
  public boolean a(bmrg parambmrg)
  {
    if (this.a.a != null)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        wxj.a("video_shoot_new", "qa_edit", 1, 0, new String[0]);
        return true;
      }
    }
    return false;
