  ...
  extends aoaw
{
  ...
  public aoay(Activity paramActivity, String paramString1, String paramString2, long paramLong, String paramString3, int paramInt)
  {
  ...
  protected Intent a()
  {
    ...
    try
    {
      ...
      for (String str = "邀请你加入派对";; str = c() + "邀请你加入派对")
      {
        ...
        localIntent.putExtras(bgou.a("com.tencent.avgame", "invite", "1.0.0.1", str, apoh.a(), null, null));
        break;
      }
      return localIntent;
    }
  ...
  protected void b(ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem)
  {
    ...
    if (a() == 0) {
      bcst.b(null, "dc00898", "", "", "0X800B066", "0X800B066", a(), 0, "0", String.valueOf(this.jdField_a_of_type_Long), "", "");
    }
    Bundle localBundle;
    for (;;)
    {
      ...
      return;
      bcst.b(null, "dc00898", "", "", "0X800B065", "0X800B065", a(), 0, "0", String.valueOf(this.jdField_a_of_type_Long), "", "");
    }
    ...
    if (a() == 0)
    {
      bcst.b(null, "dc00898", "", "", "0X800B068", "0X800B068", a(), 0, "0", String.valueOf(this.jdField_a_of_type_Long), "", "");
      return;
    }
    bcst.b(null, "dc00898", "", "", "0X800B064", "0X800B064", a(), 0, "0", String.valueOf(this.jdField_a_of_type_Long), "", "");
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setItemClickListenerV2(new aoaz(this));
  ...
  {
    if (a() == 0) {
      bcst.b(null, "dc00898", "", "", "0X800B066", "0X800B066", a(), 0, "1", String.valueOf(this.jdField_a_of_type_Long), "", "");
    }
    Intent localIntent;
    for (;;)
    {
      ...
      QQToast.a(a(), 2131690386, 0).a();
      return;
      bcst.b(null, "dc00898", "", "", "0X800B065", "0X800B065", a(), 0, "1", String.valueOf(this.jdField_a_of_type_Long), "", "");
    }
    a().startActivityForResult(localIntent, -1);
    QLog.d("AVGameShareEntry", 1, "shareToQQ success");
    if (a() == 0)
    {
      bcst.b(null, "dc00898", "", "", "0X800B068", "0X800B068", a(), 0, "1", String.valueOf(this.jdField_a_of_type_Long), "", "");
      return;
    }
    bcst.b(null, "dc00898", "", "", "0X800B064", "0X800B064", a(), 0, "1", String.valueOf(this.jdField_a_of_type_Long), "", "");
  }
  ...
  protected void e()
  {
    ...
    if (a() == 0) {
      bcst.b(null, "dc00898", "", "", "0X800B066", "0X800B066", a(), 0, "2", String.valueOf(this.jdField_a_of_type_Long), "", "");
    }
    for (;;)
    {
      a();
      ...
      bcst.b(null, "dc00898", "", "", "0X800B068", "0X800B068", a(), 0, "2", String.valueOf(this.jdField_a_of_type_Long), "", "");
      return;
      bcst.b(null, "dc00898", "", "", "0X800B065", "0X800B065", a(), 0, "2", String.valueOf(this.jdField_a_of_type_Long), "", "");
    }
    bcst.b(null, "dc00898", "", "", "0X800B064", "0X800B064", a(), 0, "2", String.valueOf(this.jdField_a_of_type_Long), "", "");
  }
  ...
  protected void f(int paramInt)
  {
    ...
    if (paramInt == 9) {
      if (a() == 0) {
        bcst.b(null, "dc00898", "", "", "0X800B066", "0X800B066", a(), 0, "3", String.valueOf(this.jdField_a_of_type_Long), "", "");
      }
    }
    for (;;)
    {
      e(paramInt);
      return;
      bcst.b(null, "dc00898", "", "", "0X800B065", "0X800B065", a(), 0, "3", String.valueOf(this.jdField_a_of_type_Long), "", "");
      continue;
      if (paramInt == 10) {
        if (a() == 0) {
          bcst.b(null, "dc00898", "", "", "0X800B066", "0X800B066", a(), 0, "4", String.valueOf(this.jdField_a_of_type_Long), "", "");
        } else {
          bcst.b(null, "dc00898", "", "", "0X800B065", "0X800B065", a(), 0, "4", String.valueOf(this.jdField_a_of_type_Long), "", "");
        }
      }
    }
  }
