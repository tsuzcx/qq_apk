...
public abstract class bkwt
{
  bkwt(TraeAudioManager paramTraeAudioManager) {}
  ...
  public void a(Context paramContext, Intent paramIntent, bkwu parambkwu)
  {
    if ("android.bluetooth.adapter.action.STATE_CHANGED".equals(paramIntent.getAction()))
    {
      ...
      if (i == 10)
      {
        ...
        parambkwu.a("DEVICE_BLUETOOTHHEADSET", false);
      }
  ...
  public abstract boolean a(Context paramContext, bkwu parambkwu);
