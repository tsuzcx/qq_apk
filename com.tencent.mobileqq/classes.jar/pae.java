  ...
  implements View.OnTouchListener
{
  ...
  public pae(TribeVideoPlugin paramTribeVideoPlugin, String paramString)
  {
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    {
      return false;
      Object localObject1 = paf.a((paf)TribeVideoPlugin.a(paramView).get(this.jdField_a_of_type_JavaLangString));
      if ((localObject1 != null) && (pad.a((pad)localObject1) == 2))
      {
        ...
        if ((Math.abs(TribeVideoPlugin.a(paramView).y - TribeVideoPlugin.b(paramView).y) < 8) && (Math.abs(TribeVideoPlugin.a(paramView).x - TribeVideoPlugin.b(paramView).x) < 8))
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            Object localObject2 = paf.a((paf)TribeVideoPlugin.a(paramView).get(str));
            SeekBar localSeekBar = pad.a(paf.a((paf)TribeVideoPlugin.a(paramView).get(str)));
