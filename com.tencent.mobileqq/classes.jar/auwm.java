  ...
  implements bfyc, bgat
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new auwn(this, Looper.getMainLooper());
  ...
  public auwm(WebRecordApiPlugin paramWebRecordApiPlugin, AppInterface paramAppInterface, BaseActivity paramBaseActivity)
  {
  ...
  {
    String str1 = AppConstants.SDCARD_PATH + "webrecord/";
  ...
  private void e(String paramString)
  {
    ...
    {
      return;
      localObject = SharePreferenceUtils.get(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, "LAST_DELETE_TIME");
    ...
    for (;;)
    {
      if (paramInt1 != 0)
      {
        ...
        if ((new StatFs(Environment.getExternalStorageDirectory().getAbsolutePath()).getAvailableBlocks() > 1) && (localObject != null) && (localObject[1] > 2L))
        {
          ...
          e(AppConstants.SDCARD_PATH + "webrecord/");
          if (this.b == 0) {
          ...
          for (this.jdField_a_of_type_JavaLangString = a(2, true);; this.jdField_a_of_type_JavaLangString = a(25, true))
          {
            ...
            bftt.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, true);
            this.jdField_a_of_type_ComTencentMobileqqUtilsQQRecorder.b(this.jdField_a_of_type_JavaLangString);
            c(0);
            return;
            localObject = new QQRecorder.RecorderParam(bfyl.b, 16000, 1);
          }
        }
        this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin.callJs(WebRecordApiPlugin.b(this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin), new String[] { "{'code':-1,'recordID':'-1','msg':'" + this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131717958) + "'}" });
        return;
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin.callJs(WebRecordApiPlugin.b(this.jdField_a_of_type_ComTencentMobileqqJspWebRecordApiPlugin), new String[] { "{'code':-1,'recordID':'-1','msg':'" + this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131694120) + "'}" });
  }
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam, double paramDouble)
  {
    ...
    {
      azbu.b(paramString);
      SharePreferenceUtils.set(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_JavaLangString, Double.toString(this.jdField_a_of_type_Double));
  ...
  public void a(JSONArray paramJSONArray, String paramString1, String paramString2)
  {
    ...
    if (i < paramJSONArray.length())
    {
      ...
      String str = SharePreferenceUtils.get(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (String)localObject);
      long l;
  ...
  public void b(String paramString)
  {
    ...
    if ((((File)localObject).exists()) && (SharePreferenceUtils.get(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramString) != null))
    {
      double d = Double.valueOf(SharePreferenceUtils.get(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramString)).doubleValue();
      long l;
      if (((File)localObject).exists())
      {
        ...
        this.jdField_a_of_type_Bgas = new bgas(((AudioInfo)localObject).path, new Handler(), ((AudioInfo)localObject).getAudioType());
        this.jdField_a_of_type_Bgas.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
