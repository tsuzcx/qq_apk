...
public class nuq
{
  ...
  private static String a(String paramString1, String paramString2)
  {
    ...
    paramString1 = pqh.a().a(paramString2);
    return paramString1;
  }
  ...
  public static void a(Context paramContext, int paramInt)
  {
    ...
    nol.a(null, "CliOper", "", "", "0X8008C89", "0X8008C89", 0, 0, paramInt + "", "", "", ReadInJoyBaseDeliverActivity.a(), false);
  }
  
  public static void a(Context paramContext, int paramInt, Bundle paramBundle, boolean paramBoolean)
  {
    if (paramContext == null) {}
    while (pqc.a(paramContext)) {
      return;
    }
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo1, ArticleInfo paramArticleInfo2, boolean paramBoolean)
  {
    ...
    localIntent.putExtra("channel_name", ajya.a(2131713025));
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramContext.startActivity(localIntent);
      npu.a.put(ReadInJoyChannelActivity.class, npu.b());
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    ...
    //   145: iconst_0
    //   146: invokestatic 325	nol:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    //   149: aload_0
    //   150: ldc_w 491
    //   153: getstatic 495	omj:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   156: iconst_0
    //   157: iload_2
    //   158: aload_1
    //   159: invokestatic 350	nuq:a	(Landroid/content/Context;ILjava/lang/String;IILjava/util/Map;)V
    //   162: return
    //   163: astore 5
    //   165: aconst_null
    //   166: astore_1
  ...
  public static void a(Context paramContext, String paramString1, int paramInt, String paramString2, boolean paramBoolean)
  {
    ...
    localIntent.putExtra("big_brother_source_key", onh.f(paramInt));
    localIntent.putExtra("launch_app_time", System.currentTimeMillis());
    paramString1 = new nur(paramBoolean, paramString2, paramContext, paramString1);
    jdField_a_of_type_Int = amau.a().a(paramString1);
  ...
  public static void a(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    {
      boolean bool2 = bbfr.a(paramContext, (String)localObject);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 9)
      {
        ...
        onq.a(localIntent);
        QLog.d(nuq.class.getSimpleName(), 2, "start kandian activity, launch from lock screen");
      }
      else
      {
        localIntent.putExtra("from_search", false);
  ...
  public static Intent b(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    try
    {
      ...
      if (TextUtils.isEmpty(paramContext))
      {
        ...
        if (str2 != null) {
          localArticleInfo.mArticleContentUrl = new String(bbco.decode(str2, 0));
        }
        if (localObject != null) {
      ...
      for (;;)
      {
        try
        {
          ...
          if ("nativeArticleRecommend".equalsIgnoreCase(str10))
          {
            ...
            qoi.a((Activity)paramContext, (Bundle)localObject, i, str1, j, str3, k, m, n, str7, str13, paramHashMap, str9, str8, 0L, false, 0L, 0, null, null, null, null, null);
            return;
          }
        }
        catch (Exception paramContext)
  ...
  public static void c(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramContext)) {
          bhvy.a("DAILY_CHILD_FEEDS_REQUEST_CONFIG" + str1, paramContext);
        }
