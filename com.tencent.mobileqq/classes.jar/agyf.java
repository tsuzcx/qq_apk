  ...
  implements View.OnClickListener
{
  ...
  {
    if ((!agye.a(this.a)) || (this.a.a()) || (System.currentTimeMillis() - agye.a(this.a) < 600L)) {}
    ...
    do
    {
      do
      {
        do
        {
          for (;;)
          {
            ...
            return;
            agye.a(this.a, System.currentTimeMillis());
            localMessageForApollo = (MessageForApollo)((agzk)agej.a(paramView)).a;
            ...
            else
            {
              ...
              {
                QQToast.a(paramView.getContext(), anzj.a(2131699256), 0).a();
              }
              else
              {
                if (ApolloEngine.a()) {
      ...
      localamsx = (amsx)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
    } while (localamsx == null);
    int i;
    ...
    {
      label310:
      int k = localamsx.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
      ...
      for (int j = 0;; j = localMessageForApollo.playerList.size())
      {
        ...
        agye.a(this.a, localMessageForApollo);
        break;
