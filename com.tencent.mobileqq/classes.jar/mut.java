...
public class mut
{
  static volatile mut jdField_a_of_type_Mut;
  public int a;
  ...
  private mut(Context paramContext)
  {
    ...
    if (Looper.myLooper() != null) {
      this.jdField_a_of_type_Muv = new muv(this);
    }
  ...
  public static mut a(Context paramContext)
  {
    if (jdField_a_of_type_Mut == null) {}
    try
    {
      if (jdField_a_of_type_Mut == null) {
        jdField_a_of_type_Mut = new mut(paramContext);
      }
      return jdField_a_of_type_Mut;
    }
    finally {}
  }
  ...
  private String b()
  {
    ...
    {
      lbd.f("SignalStrengthReport", "getGateway e:" + localException);
    }
    return "";
  }
  ...
  private int g()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        ...
        if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)
        {
          ...
          {
            lbd.f("SignalStrengthReport", "getPingInterval config:" + (String)localObject);
    ...
    {
      lbd.f("SignalStrengthReport", "getPingInterval e:" + localException);
      i = j;
    }
    return i;
  }
  ...
  int a(SignalStrength paramSignalStrength)
  {
    ...
    for (;;)
    {
      ...
      {
        lbd.f("SignalStrengthReport", "getLevelPercentBySignalStrength reflect getLevel e:" + paramSignalStrength);
        return 0;
      }
    }
  }
  ...
  public void a()
  {
    ...
    {
      return;
      lbd.f("SignalStrengthReport", "report start");
    ...
    } while ((this.jdField_a_of_type_Muv == null) || (this.jdField_a_of_type_AndroidTelephonyTelephonyManager == null));
    this.jdField_a_of_type_AndroidTelephonyTelephonyManager.listen(this.jdField_a_of_type_Muv, 256);
  }
  ...
  int b(SignalStrength paramSignalStrength)
  {
    ...
    //   112: invokestatic 149	lbd:f	(Ljava/lang/String;Ljava/lang/String;)V
    //   115: iconst_m1
    //   116: istore_2
    //   117: goto -74 -> 43
    //   120: aload_1
    ...
    //   183: invokestatic 149	lbd:f	(Ljava/lang/String;Ljava/lang/String;)V
    //   186: iconst_m1
    //   187: ireturn
    //   188: iload_2
    //   189: ireturn
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Int = -1;
    if ((this.jdField_a_of_type_Muv != null) && (this.jdField_a_of_type_AndroidTelephonyTelephonyManager != null)) {
      this.jdField_a_of_type_AndroidTelephonyTelephonyManager.listen(this.jdField_a_of_type_Muv, 0);
    }
    ...
    this.jdField_a_of_type_JavaLangString = "";
    lbd.f("SignalStrengthReport", "report stop");
  }
  ...
  public int c()
  {
    ...
    {
      lbd.f("SignalStrengthReport", "getWifiLevelPercent e:" + localException);
      i = j;
    }
    return i;
  }
  ...
  public int d()
  {
    ...
    {
      lbd.f("SignalStrengthReport", "getWifiDbm e:" + localException);
    }
    return -1;
  }
}
