...
public class bdrt
{
  ...
  public bdrt(bdnv parambdnv, Context paramContext, int paramInt)
  {
    this.jdField_a_of_type_Bdnv = parambdnv;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Int = paramInt;
    this.b = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131296449);
  }
  
  private TextView a(bdsv parambdsv, View paramView)
  {
    ...
    if (paramView == null)
    {
      ...
      localTextView.setPadding(j, AIOUtils.dp2px(18.0F, localResources), j, i);
      paramView = localTextView;
      if (!TextUtils.isEmpty(parambdsv.b()))
      {
        localTextView.setText(parambdsv.b().trim());
        paramView = localTextView;
      }
    }
    do
    {
      ...
      paramView = localTextView;
    } while (TextUtils.isEmpty(parambdsv.b()));
    localTextView.setText(parambdsv.b().trim());
  ...
  private TextView a(String paramString, View paramView, boolean paramBoolean)
  {
    ...
    if (paramView == null)
    {
      ...
      if (paramBoolean) {
        localTextView.setBackgroundResource(2130841675);
      }
      int i = AIOUtils.dp2px(8.0F, localResources);
      int j = AIOUtils.dp2px(12.0F, localResources);
      localTextView.setPadding(j, 0, j, i);
      localTextView.setId(2131378266);
      paramView = localTextView;
  ...
  public static boolean a(bdnv parambdnv, int paramInt)
  {
    Object localObject = null;
    if (BaseApplicationImpl.sApplication != null) {
      localObject = (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime();
    }
    if ((localObject == null) || (TextUtils.isEmpty(parambdnv.ab)) || ((!uuc.a((QQAppInterface)localObject, parambdnv.ab)) && (!"2909288299".equals(parambdnv.ab)) && (!"3338705755".equals(parambdnv.ab)))) {}
    int j;
    label83:
    do
    {
      ...
      j = 0;
      paramInt = 0;
      if (i < parambdnv.a.size())
      {
        localObject = ((bdnu)parambdnv.a.get(i)).a;
        int m;
        int k;
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (!a(this.jdField_a_of_type_Bdnv, this.jdField_a_of_type_Int))
    {
      paramContext = this.jdField_a_of_type_Bdnv.a(paramContext, paramView, paramBundle);
      return paramContext;
    }
    ...
    if (paramView != null)
    {
      ...
      if ((paramView instanceof LinearLayout))
      {
        ...
        localFrameLayout = (FrameLayout)((LinearLayout)localObject1).findViewById(2131378248);
        if (localFrameLayout != null)
        {
          ...
          if (k < this.jdField_a_of_type_Bdnv.a.size())
          {
            localObject2 = (bdnu)this.jdField_a_of_type_Bdnv.a.get(k);
            str = ((bdnu)localObject2).a;
            if ("title".equals(str))
            {
    ...
    for (;;)
    {
      ...
      {
        localObject2 = a((bdnu)localObject2, localFrameLayout, paramBundle);
        m = 1;
        paramContext = paramView;
        paramView = (View)localObject2;
        j = i;
      ...
      else
      {
        if ("summary".equals(str))
        {
          ...
          if ((j != 0) && (!TextUtils.isEmpty(((bdsv)localObject2).b())))
          {
            if (((bdsv)localObject2).b().trim().length() <= 0)
            {
              localObject2 = paramContext;
              m = i;
              i = j;
            ...
            ((ArrayList)localObject3).add(a((bdsv)localObject2, ((LinearLayout)localObject1).findViewById(i + 2131378265)));
            localObject2 = paramContext;
            paramContext = paramView;
            m = i + 1;
            i = j;
            ...
            {
              paramBundle = (TextView)paramContext.findViewById(2131378263);
              if (!TextUtils.isEmpty(paramView)) {
                if (paramBundle == null)
                {
                  paramView = a(paramView, null, true);
                  paramView.setId(2131378263);
            ...
            for (;;)
            {
              ...
              paramContext = null;
              paramView = null;
              if (j < this.jdField_a_of_type_Bdnv.a.size())
              {
                localObject2 = (bdnu)this.jdField_a_of_type_Bdnv.a.get(j);
                localObject3 = ((bdnu)localObject2).a;
                ...
                for (;;)
                {
                  ...
                  {
                    localObject2 = a((bdnu)localObject2, null, paramBundle);
                  ...
                  else
                  {
                    ...
                    {
                      localObject2 = (bdsv)localObject2;
                      if ((i != 0) && (!TextUtils.isEmpty(((bdsv)localObject2).b())))
                      {
                        if (((bdsv)localObject2).b().trim().length() <= 0)
                        {
                          localObject2 = paramContext;
                        ...
                        localObject2 = a((bdsv)localObject2, null);
                        ((TextView)localObject2).setId(2131378265 + j);
                        ((LinearLayout)localObject1).addView((View)localObject2);
                      }
                    }
                    localObject2 = paramContext;
  ...
  public View a(bdnu parambdnu, View paramView, Bundle paramBundle)
  {
    Resources localResources = this.jdField_a_of_type_AndroidContentContext.getResources();
    if ((paramView != null) && ((paramView instanceof FrameLayout)))
    {
      paramView = (FrameLayout)paramView;
      parambdnu.a(this.jdField_a_of_type_AndroidContentContext, paramView.findViewById(2131368676), paramBundle);
      return paramView;
    }
    ...
    parambdnu = (ImageView)parambdnu.a(this.jdField_a_of_type_AndroidContentContext, null, paramBundle).findViewById(2131368676);
    paramBundle = new FrameLayout.LayoutParams(-1, this.b);
    if ((parambdnu != null) && ((parambdnu instanceof PAImageView))) {
      ((PAImageView)parambdnu).setUseRadiusRound(true, localResources.getDimensionPixelSize(2131296448));
    }
    paramView.addView(parambdnu, paramBundle);
    return paramView;
  }
}
