...
public class bbsl
{
  ...
  private static final bbsl jdField_a_of_type_Bbsl = new bbsl();
  ...
  {
    if ((!jdField_a_of_type_Bbsl.jdField_a_of_type_Boolean) && (jdField_a_of_type_Bbsl.jdField_b_of_type_Boolean) && (jdField_a_of_type_Bbsl.a())) {
      jdField_a_of_type_Bbsl.b();
    }
    return jdField_a_of_type_Bbsl;
  }
  ...
  {
    jdField_a_of_type_Bbsl.jdField_b_of_type_Boolean = false;
    jdField_a_of_type_Bbsl.jdField_a_of_type_Boolean = false;
  }
  ...
  {
    return (jdField_a_of_type_Bbsl.jdField_a_of_type_Boolean) && (paramDrawable != null) && (jdField_a_of_type_Bbsl.jdField_a_of_type_JavaLangClass != null) && (jdField_a_of_type_Bbsl.jdField_a_of_type_JavaLangClass.isAssignableFrom(paramDrawable.getClass()));
  }
  ...
  {
    return (jdField_a_of_type_Bbsl.jdField_a_of_type_Boolean) && (paramDrawable != null) && (jdField_a_of_type_Bbsl.jdField_b_of_type_JavaLangClass != null) && (jdField_a_of_type_Bbsl.jdField_b_of_type_JavaLangClass.isAssignableFrom(paramDrawable.getClass()));
  }
  
  public static boolean c(Drawable paramDrawable)
  {
    return (jdField_a_of_type_Bbsl.jdField_a_of_type_Boolean) && (paramDrawable != null) && (jdField_a_of_type_Bbsl.jdField_c_of_type_JavaLangClass != null) && (jdField_a_of_type_Bbsl.jdField_c_of_type_JavaLangClass.isAssignableFrom(paramDrawable.getClass()));
  }
  ...
  public Drawable a(String paramString)
  {
    if ((this.jdField_a_of_type_Boolean) && (new File(paramString).exists())) {
      try
      {
        ...
        bbsn.a("videodrawable-sucess", (int)(System.currentTimeMillis() - l));
        return paramString;
      }
      catch (Exception paramString)
      {
        bbsn.a(paramString);
        bbsn.a("videodrawable-error", paramString.getMessage());
      }
    }
    return null;
  }
  ...
  public Drawable a(String paramString, Handler paramHandler, boolean paramBoolean)
  {
    if ((this.jdField_a_of_type_Boolean) && (new File(paramString).exists())) {
      try
      {
        ...
        bbsn.a("autoetc-sucess", (int)(System.currentTimeMillis() - l));
        return paramString;
      }
      catch (Exception paramString)
      {
        bbsn.a(paramString);
        bbsn.a("autoetc-error", paramString.getMessage());
      }
    }
    return null;
  }
    ...
    for (;;)
    {
      try
      {
        ...
        catch (Exception paramString1)
        {
          bbsn.a(paramString1);
          a();
          bbsn.a("init-error", paramString1.getMessage());
        }
      }
      finally {}
      File localFile1;
      ...
      label298:
      this.jdField_a_of_type_DalvikSystemDexClassLoader = new DexClassLoader(localFile1.getAbsolutePath(), paramString2.getAbsolutePath(), paramString1.getAbsolutePath(), bbsl.class.getClassLoader());
      try
      {
        a("com.tencent.android.gldrawable.utils.Logger").getMethod("setLogger", new Class[] { Handler.Callback.class }).invoke(null, new Object[] { new bbsm(this) });
