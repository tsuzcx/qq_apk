...
{
  public adhi(AddRequestActivity paramAddRequestActivity) {}
  
  public void onClick(View paramView)
  {
    int j = 0;
    bdla.b(this.a.app, "CliOper", "", "", "Verification_msg", "Vfc_answ_clk", 0, 0, "", "", "", "");
    ...
    if (AddRequestActivity.a(this.a) == 3999)
    {
      ...
      boolean bool = ((anvk)localObject2).b(this.a.a);
      localObject1 = AIOUtils.setOpenAIOIntent(new Intent(this.a, SplashActivity.class), null);
      ((Intent)localObject1).putExtra("uin", this.a.a);
      ((Intent)localObject1).putExtra("add_friend_source_id", AddRequestActivity.a(this.a));
      if (!bool) {
        break label237;
      }
      localObject2 = ((anvk)localObject2).e(this.a.a);
      if (localObject2 != null)
      {
        ((Intent)localObject1).putExtra("cSpecialFlag", ((Friends)localObject2).cSpecialFlag);
        ((Intent)localObject1).putExtra("uinname", ContactUtils.getFriendName((Friends)localObject2));
      }
      label193:
      if (!bool) {
        break label270;
