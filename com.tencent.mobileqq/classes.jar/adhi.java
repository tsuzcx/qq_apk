  ...
  implements adif
{
  ...
  public adhi(BaseChatPie paramBaseChatPie)
  {
  ...
  public void a(int paramInt)
  {
    ...
    for (paramInt = i;; paramInt = 0)
    {
      ...
      ajeq localajeq = ajfh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localajeq != null) {
        localajeq.a(this.jdField_a_of_type_Long, this.b, ajfh.b(), ajfh.a());
      }
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aitx == null) {
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aitx = new aitx();
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aitx.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
      return;
    }
  }
    ...
    for (int i = Integer.parseInt((String)((Map)localObject1).get("textType"));; i = 0)
    {
      ...
      for (int j = Integer.parseInt(paramObject);; j = 0)
      {
        ...
        for (float f = Float.parseFloat(paramObject);; f = 0.0F)
        {
          ...
          {
            paramObject = (ajmu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
            Object localObject3 = (airx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
            ...
            default: 
              ...
              this.jdField_a_of_type_Bbgu = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, 0, paramObject, (CharSequence)localObject1, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131695351), (String)localObject3, (DialogInterface.OnClickListener)localObject2, new adhk(this));
            ...
            for (;;)
            {
              ...
              localObject2 = new adhj(this, (String)localObject1, m);
              ...
              paramObject = str2;
              break label567;
              bcql.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690063), 0).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298865));
              if (!QLog.isColorLevel()) {
                break;
              }
