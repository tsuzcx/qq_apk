...
public class bgzo
{
  private static asbr<bgzo, Void> jdField_a_of_type_Asbr = new bgzp();
  private final byte jdField_a_of_type_Byte = 2;
  private FileObserver jdField_a_of_type_AndroidOsFileObserver;
  private Handler jdField_a_of_type_AndroidOsHandler = new bgzq(this, ThreadManager.getSubThreadLooper());
  private volatile boolean jdField_a_of_type_Boolean;
  private final byte jdField_b_of_type_Byte = 1;
  private volatile boolean jdField_b_of_type_Boolean;
  
  public static bgzo a()
  {
    return (bgzo)jdField_a_of_type_Asbr.b(null);
  }
  ...
  private void a(int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    do
    {
      ...
      {
        if (paramInt2 >= 1) {
          axrn.a(BaseApplication.getContext()).a((String)localObject, "qzoneRecovery", paramBoolean, 0L, 0L, null, "");
        }
    ...
    {
      localaxrn.a((String)localObject, "qzoneOdexCheck", paramBoolean, 0L, 0L, localHashMap, "");
      return;
      j = 0;
      break;
      i = 0;
  ...
  private void c()
  {
    ...
    File localFile1 = new File(bhcq.n);
    boolean bool1;
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        ...
        localFile1 = new File(localFile1, "qzone_plugin_" + bgyi.a());
        QLog.i("QZoneStartupMonitor", 1, "copy from " + localFile2.getPath() + " to " + localFile1.getPath());
        bbdx.a(localFile2, localFile1);
      }
      return;
  ...
  private void d()
  {
    if (!QzonePluginProxyActivity.a())
    {
      ...
      do
      {
        ...
        localObject2 = (bglh)((QQAppInterface)localObject1).getManager(27);
        QLog.i("QZoneStartupMonitor", 1, "reInstallQzone cancelInstall:qzone_plugin.apk");
        ((bglh)localObject2).cancelInstall("qzone_plugin.apk");
      } while (((bglh)localObject2).isPlugininstalled("qzone_plugin.apk"));
      ...
      a((File)localObject2);
      bgyp.a((QQAppInterface)localObject1, "reInstallQzone");
      return;
    }
  ...
  public void b()
  {
    ...
    //   39: goto -18 -> 21
    //   42: aload_0
    //   43: getfield 421	bgzo:jdField_a_of_type_AndroidOsFileObserver	Landroid/os/FileObserver;
    //   46: ifnonnull -12 -> 34
    ...
    //   104: sipush 768
    //   107: invokespecial 428	bgzr:<init>	(Lbgzo;Ljava/lang/String;I)V
    //   110: putfield 421	bgzo:jdField_a_of_type_AndroidOsFileObserver	Landroid/os/FileObserver;
    //   113: aload_0
    //   114: getfield 421	bgzo:jdField_a_of_type_AndroidOsFileObserver	Landroid/os/FileObserver;
