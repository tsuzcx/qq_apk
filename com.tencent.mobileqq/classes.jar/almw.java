  ...
  implements xlw, xlx, xly, xlz
{
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("LoginActivity.GuideVideoHandler", 2, "MediaPlayer onCompletion has been called.   at " + paramxlu.b() + " mIsPause" + this.jdField_a_of_type_Boolean);
    }
    this.jdField_a_of_type_Int = paramxlu.b();
  ...
  {
    paramxlu = new StringBuilder(64);
    paramxlu.append("bgVideo error-- what=");
    paramxlu.append(paramInt1);
    paramxlu.append(" extra=");
    paramxlu.append(paramInt2);
    if (QLog.isColorLevel()) {
      QLog.d("LoginActivity.GuideVideoHandler", 2, paramxlu.toString());
    }
    a();
    paramxlu = Build.MODEL;
    if (paramxlu != null)
    {
      HashMap localHashMap = new HashMap();
      localHashMap.put("crashModel", paramxlu);
