...
public class awfx
{
  ...
  public static MessageRecord a(awge paramawge)
  {
    if (paramawge != null) {}
    try
    {
    ...
    catch (Exception paramawge)
    {
      if (QLog.isColorLevel()) {
        QLog.e("Cursor2EntityConvert", 2, "postRead exception = " + paramawge.getMessage());
      }
      return null;
    }
      ...
      for (l = paramCursor.getLong(paramCursor.getColumnIndex("_id"));; l = -1L)
      {
        try
        {
          if (paramClass.getName().equals(MessageRecord.class.getName()))
          {
            ...
            paramClass = azaf.a(i, arrayOfByte, j, str, k);
            ...
            if (!this.jdField_a_of_type_Boolean)
            {
              ...
              a(awhf.b(paramClass), paramCursor);
            }
