...
public class aolq
{
  ...
  public static aolq a(String paramString)
  {
    ...
    try
    {
      ...
      {
        bool1 = true;
        localaolq.jdField_a_of_type_Boolean = bool1;
        if (paramString.optInt("compressAndEncrypt", 0) != 1) {
          break label130;
        }
        bool1 = true;
        label56:
        localaolq.jdField_b_of_type_Boolean = bool1;
      ...
      {
        localaolq.d = bool1;
        localaolq.jdField_a_of_type_Long = paramString.optLong("locationSdkCallbackIntervalMillis", 2000L);
        localaolq.jdField_b_of_type_Long = paramString.optLong("locationBgTimeoutMillis", 60000L);
        return localaolq;
        bool1 = false;
        break;
        bool1 = false;
