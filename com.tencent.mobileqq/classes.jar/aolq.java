...
public class aolq
  extends aolh
{
  public aolq(QQAppInterface paramQQAppInterface, FriendListHandler paramFriendListHandler)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, Oidb_0x5d1.RspBody paramRspBody)
  {
    ...
    if ((i == 1) && (paramRspBody.msg_set_friend_id.has()))
    {
      ...
      if (j == 0)
      {
        paramRspBody = ((anvk)localObject2).e(String.valueOf(l1));
        paramToServiceMsg = (ToServiceMsg)localObject1;
        if (paramRspBody != null)
        {
          paramRspBody.setShieldFlag(true);
          ((anvk)localObject2).a(paramRspBody);
          paramToServiceMsg = this.a.getCurrentAccountUin();
          paramRspBody = anvx.a(2131704351);
          l2 = bcrg.a();
          localObject2 = bcsa.a(-2012);
          ...
          this.a.getMessageFacade().addMessage((MessageRecord)localObject2, paramToServiceMsg);
          paramToServiceMsg = (ToServiceMsg)localObject1;
        }
        if (j != 0) {
          break label331;
    ...
    do
    {
      ...
      if ((i == 2) && (paramRspBody.msg_clear_friend_id.has()))
      {
        ...
        if (j == 0)
        {
          paramToServiceMsg = ((anvk)localObject2).e(String.valueOf(l1));
          if (paramToServiceMsg != null)
          {
            paramToServiceMsg.setShieldFlag(false);
            ((anvk)localObject2).a(paramToServiceMsg);
            paramToServiceMsg = this.a.getCurrentAccountUin();
            paramRspBody = anvx.a(2131704354);
            l2 = bcrg.a();
            localObject1 = bcsa.a(-2012);
            ...
            this.a.getMessageFacade().addMessage((MessageRecord)localObject1, paramToServiceMsg);
          }
          paramToServiceMsg = "";
          if (j != 0) {
            break label633;
