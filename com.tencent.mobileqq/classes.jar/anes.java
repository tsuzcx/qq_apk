  ...
  extends BaseRecentUserCache<RecentUser, QQAppInterface>
{
  ...
  public anes(QQAppInterface paramQQAppInterface, DBDelayManager paramDBDelayManager)
  {
  ...
  private RecentUser a(RecentUser paramRecentUser)
  {
    ...
    if (paramRecentUser.getType() != 1)
    {
      ...
      if (paramRecentUser.getType() != 3000)
      {
        ...
        {
          if (bily.b((QQAppInterface)this.app, paramRecentUser.uin)) {
          ...
          azjc.a((QQAppInterface)this.app, ((RecentUser)localObject).uin, ((RecentUser)localObject).getType());
        }
      }
    }
    return localObject;
  ...
  {
    String str = akla.a(paramRecentUser.uin, paramRecentUser.getType());
  ...
  private void c(RecentUser paramRecentUser)
  {
    ...
    {
      boolean bool = afqy.a(paramRecentUser.uin, paramRecentUser.getType(), (QQAppInterface)this.app);
      if (QLog.isColorLevel()) {
  ...
  {
    if (anln.a((QQAppInterface)this.app, paramRecentUser.uin, paramRecentUser.getType()))
    {
  ...
  private void e()
  {
    ...
    synchronized (this.cacheMap)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((!bkwm.a((QQAppInterface)this.app)) && (localRecentUser.getType() == 7220))
        {
        ...
        if ((bkwm.a((QQAppInterface)this.app)) && (((localRecentUser.getType() == 1008) && (TextUtils.equals(localRecentUser.uin, AppConstants.NEW_KANDIAN_UIN))) || (localRecentUser.getType() == 7210)))
        {
          localIterator.remove();
          if (QLog.isColorLevel()) {
  ...
  {
    if ((paramRecentUser.getType() == 10007) && (atyf.a((QQAppInterface)this.app)) && (atyd.a()))
    {
      paramRecentUser = (atyd)((QQAppInterface)this.app).getManager(358);
  ...
  public bbks a(String paramString, int paramInt)
  {
    ...
    if (paramString != null)
    {
      ...
      } while (l - ((RecentUser)localObject).lastmsgtime <= bbko.b);
    }
  ...
  public void a(RecentUser paramRecentUser, boolean paramBoolean)
  {
    ...
    if ((paramRecentUser.isHiddenChat == 0) && (akmb.a((QQAppInterface)this.app))) {}
    try
    {
  ...
  protected boolean a(RecentUser paramRecentUser, boolean paramBoolean)
  {
    ...
    {
      if (bkwm.a((QQAppInterface)this.app)) {
        return false;
      }
    }
    else
    {
      ...
      {
        if (!bcvs.a((QQAppInterface)this.app)) {
          return false;
        }
      }
      else if ((TextUtils.equals(paramRecentUser.uin, AppConstants.KANDIAN_SUBSCRIBE_UIN)) || (TextUtils.equals(paramRecentUser.uin, AppConstants.KANDIAN_DAILY_UIN)))
      {
        if (!bkwm.b(paramRecentUser.uin)) {
          return false;
        }
      }
      else
      {
        ...
        else
        {
          ...
          if (paramRecentUser.getType() == 1)
          {
            if (bdvp.a((QQAppInterface)this.app, paramRecentUser.uin)) {
              return false;
            }
          }
          else if ((paramRecentUser.getType() == 9000) && (aiku.a((QQAppInterface)this.app))) {
            return false;
          }
        }
      }
  ...
  public void doOnConstructor()
  {
    ...
    Object localObject1;
    Object localObject2;
    if (ugf.b((QQAppInterface)this.app))
    {
