  ...
  implements HookMethodCallback
{
  public void afterHookedMethod(MethodHookParam paramMethodHookParam)
  {
    ...
    for (;;)
    {
      ...
      {
        bdal.a(localClassNotFoundException);
        Object localObject3 = localObject1;
        continue;
      }
      catch (NoSuchFieldException localNoSuchFieldException)
      {
        bdal.a(localNoSuchFieldException);
        Object localObject4 = localObject1;
        continue;
      }
      catch (IllegalArgumentException localIllegalArgumentException)
      {
        bdal.a(localIllegalArgumentException);
        Object localObject5 = localObject1;
        continue;
      }
      catch (IllegalAccessException localIllegalAccessException)
      {
        bdal.a(localIllegalAccessException);
      ...
      if (paramMethodHookParam.throwable.getCause() != null)
      {
        ...
        atbz.a(1, localObject2.getClass().getName(), paramMethodHookParam.throwable.getMessage(), 0);
        atbz.a(2, localObject2.getClass().getName(), null, 10000);
        atbz.a(3, localObject2.getClass().getName(), null, 60000);
