  ...
  implements Handler.Callback, Manager
{
  ...
  public bbxk(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bbxl = new bbxl(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  }
  
  private void a(bbxj parambbxj)
  {
    int i = this.jdField_a_of_type_Bbxl.a(parambbxj);
  ...
  private void b(bbxj parambbxj)
  {
    ThreadManager.post(new ScribbleDownloader.1(this, parambbxj), 5, null, false);
  }
  
  private void d()
  {
    if (this.jdField_a_of_type_Bbxl.a() < 2)
    {
      bbxj localbbxj = this.jdField_a_of_type_Bbxl.a();
      if (localbbxj == null)
      {
  ...
  {
    int i = this.jdField_a_of_type_Bbxl.a(paramMessageForScribble);
  ...
  public void a(MessageForScribble paramMessageForScribble)
  {
    ...
    if (a())
    {
      a(new bbxj(paramMessageForScribble, 200));
      return;
    }
  ...
  public void b(MessageForScribble paramMessageForScribble)
  {
    ...
    a(new bbxj(paramMessageForScribble, 201));
  }
