...
public class akxv
{
  ...
  public static int a(long paramLong, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    int i = -1;
    akyg localakyg = akwd.b(paramLong);
    if (localakyg != null) {
      i = localakyg.a();
    }
  ...
  private static boolean a(long paramLong, String paramString1, String paramString2, boolean paramBoolean, int paramInt)
  {
    if (paramString1.equals("cs.check_pubAccount_state.local")) {
      a(paramString1, paramString2, paramBoolean, new akxw(paramLong), paramInt);
    }
    label199:
    do
    {
      ...
      do
      {
        do
        {
          ...
          {
            a(paramString1, paramString2, paramBoolean, new akxx(paramLong), paramInt);
            return false;
          }
          if (!paramString1.equals("cs.get_dress_path.local")) {
            break label199;
          }
          localObject2 = new akxy(paramLong, paramString1);
          try
          {
            akyg localakyg = akwd.b(paramLong);
            str = paramString2;
            if (localakyg != null)
            {
              ...
              {
                localJSONObject.put("gameId", localakyg.a());
        ...
        Object localObject1 = new akxz(paramLong);
  ...
  public static boolean a(long paramLong, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localakyu != null)
        {
          paramBoolean = localakyu.a(paramLong, paramBoolean, paramString1, paramString2);
          return paramBoolean;
        }
      }
