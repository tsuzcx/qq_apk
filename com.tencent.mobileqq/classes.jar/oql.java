...
public class oql
{
  ...
  public oql(ExecutorService paramExecutorService, ReadInJoyUserInfoModule paramReadInJoyUserInfoModule, atmp paramatmp)
  {
  ...
  private void a(ReadInJoyUserInfo paramReadInJoyUserInfo)
  {
    ...
    if (paramReadInJoyUserInfo != null) {
      obz.a("saveReadInJoyUserInfoToDB", new ReadInJoyUserInfoRepository.1(this, paramReadInJoyUserInfo), this.jdField_a_of_type_JavaUtilConcurrentExecutorService);
    }
  }
  ...
  public List<ReadInJoyUserInfo> a(String paramString)
  {
    ...
    {
      return null;
      localList = this.jdField_a_of_type_Atmp.a(ReadInJoyUserInfo.class, true, "uin = ?", new String[] { paramString }, null, null, null, "1");
  ...
  public void a(int paramInt)
  {
    try
    {
      obz.a("loadReadInJoyUserInfoFromDB", new ReadInJoyUserInfoRepository.2(this, paramInt), this.jdField_a_of_type_JavaUtilConcurrentExecutorService);
      return;
    }
  ...
  public void a(String paramString, ReadInJoyUserInfo paramReadInJoyUserInfo)
  {
    ...
    if ((localObject != null) && (((ConcurrentHashMap)localObject).get(paramString) != null))
    {
      ...
      while (localIterator.hasNext())
      {
        oqi localoqi = (oqi)localIterator.next();
        if (localoqi != null)
        {
          localoqi.a(paramString, paramReadInJoyUserInfo);
          localArrayList.add(localoqi);
        }
      }
