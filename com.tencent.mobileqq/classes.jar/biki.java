  ...
  implements Manager
{
  ...
  biht jdField_a_of_type_Biht = new bikn(this, "param_WIFIColorRingDownloadFlow", "param_XGColorRingDownloadFlow");
  ...
  public biki(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bhmi.a(lbm.f(), new StringBuffer("config.json"), localInputStream);
      }
  ...
  public static VipFullScreenVideoView a(Activity paramActivity, RelativeLayout paramRelativeLayout, boolean paramBoolean)
  {
    ...
    {
      return null;
      localView = LayoutInflater.from(BaseApplicationImpl.getApplication()).inflate(2131563096, null);
    ...
    return (VipFullScreenVideoView)localView.findViewById(2131380732);
  }
  ...
  public static String a(AppRuntime paramAppRuntime, int paramInt1, int paramInt2, String paramString)
  {
    ...
    paramString = lbm.f() + paramInt1 + File.separator;
  ...
  public static void a(AppRuntime paramAppRuntime, int paramInt, Bundle paramBundle, VipFunCallAndRing.TSourceInfo paramTSourceInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        break;
        localObject1 = new File(lbm.f() + paramInt + File.separator);
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    ...
    } while (bhmi.a(paramString2));
    String str = b(paramAppRuntime, paramInt2, 8, null);
    paramString2 = new Bundle();
    paramString1 = new bihu(str, paramString1);
    ((bihw)paramAppRuntime.getManager(47)).a(1).a(paramString1, null, paramString2);
  }
  
  public static boolean a()
  {
    return new File(bikh.jdField_a_of_type_JavaLangString).exists();
  }
  
  public static boolean a(Context paramContext, VideoView paramVideoView, String paramString, int paramInt1, biko parambiko, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((paramContext.exists()) && (!paramVideoView.isPlaying()))
    {
      ...
      if (paramInt1 == 6)
      {
        paramVideoView.setOnTouchListener(new bikj());
        paramVideoView.setVideoPath(paramContext.getAbsolutePath());
        paramVideoView.requestFocus();
        paramVideoView.setVisibility(0);
        paramVideoView.setOnPreparedListener(new bikk(parambiko));
        paramVideoView.setOnCompletionListener(new bikl(paramVideoView));
        paramVideoView.setOnErrorListener(new bikm(paramInt2, parambiko, paramVideoView, paramBoolean));
        return true;
      }
      if (paramInt1 == 7)
      {
        paramContext = bhgm.a(paramString);
  ...
  public static boolean a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        biah.a("externalStorageType", paramString, i + "_t", l2 + "", bool + "", l2 + "", bool + "_p", "", "", "");
        return bool;
      }
      catch (Exception paramContext)
      {
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    for (int i = 0;; i = paramInt2)
    {
      ...
      if (bool)
      {
        ...
        localObject = new bihu(str1, (File)localObject);
        ((bihu)localObject).a(3);
        ((bihu)localObject).jdField_a_of_type_Int = 0;
        ((bihu)localObject).a(localBundle);
        this.jdField_a_of_type_Biht.onDone((bihu)localObject);
        return;
        label519:
        bool = false;
        break label298;
      ...
      if (i == 0)
      {
        label530:
        localObject = new bihu(str1, (File)localObject);
        ((bihu)localObject).jdField_a_of_type_Byte = 1;
        ((bihu)localObject).jdField_e_of_type_Long = 5242880L;
        ((bihu)localObject).jdField_e_of_type_JavaLangString = jdField_a_of_type_JavaLangString;
      ...
      {
        ((bihu)localObject).l = paramBoolean;
        if (7 != paramInt2) {
          ((bihu)localObject).b = true;
        }
        this.jdField_a_of_type_Bihw.a(1).a((bihu)localObject, this.jdField_a_of_type_Biht, localBundle);
        if (!QLog.isColorLevel()) {
          break;
        }
  ...
  public boolean a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, biia parambiia)
  {
    ...
    if (paramInt2 != 0)
    {
      bhxi localbhxi = (bhxi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(45);
      localbhxi.jdField_a_of_type_Biia = parambiia;
      localbhxi.a(paramInt2, 3, paramBoolean, paramInt3, "comering");
    }
    if (i == 6) {
