...
import cooperation.qzone.cache.CacheManager.2;
...
public class bftg
{
  ...
  private static bftk jdField_a_of_type_Bftk;
  private static Object jdField_a_of_type_JavaLangObject;
  private static String jdField_a_of_type_JavaLangString = "";
  private static final HashMap<String, bfti> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public static bfti a(String paramString, int paramInt1, int paramInt2)
  {
    boolean bool = true;
    ...
    for (;;)
    {
      ...
      {
        bfti localbfti2 = (bfti)jdField_a_of_type_JavaUtilHashMap.get(paramString);
        bfti localbfti1 = localbfti2;
        if (localbfti2 == null)
        {
          localbfti1 = new bfti(paramString, 1, paramInt1, paramInt2);
          localbfti1.a(a());
          jdField_a_of_type_JavaUtilHashMap.put(paramString, localbfti1);
        }
        return localbfti1;
      }
      bool = false;
  ...
  public static bftk a()
  {
    ...
    {
      if (jdField_a_of_type_Bftk == null) {
        jdField_a_of_type_Bftk = new bftk(new bfth());
      }
      return jdField_a_of_type_Bftk;
    }
  }
  ...
  {
    b(paramLong);
    ThreadManager.postImmediately(new CacheManager.2(), null, false);
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    apdh.c(Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "Android" + File.separator + "data" + File.separator + "com.qzone" + File.separator + "cache" + File.separator + "image_sr");
    ...
    apdh.c(Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "Android" + File.separator + "data" + File.separator + "com.tencent.mobileqq" + File.separator + "cache" + File.separator + "video_cache");
  ...
  private static void a(String paramString)
  {
    ...
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 221	java/io/File:<init>	(Ljava/lang/String;)V
    //   8: astore_0
    //   9: aload_0
    //   10: invokevirtual 233	java/io/File:exists	()Z
    //   13: ifeq +164 -> 177
    //   16: new 287	java/io/BufferedReader
    //   19: dup
    //   20: new 289	java/io/FileReader
    //   23: dup
    //   24: aload_0
    //   25: invokespecial 291	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   28: invokespecial 294	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   31: astore_1
    //   32: aload_1
    //   33: astore_0
    //   34: aload_1
    //   35: invokevirtual 297	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   38: astore_2
    //   39: aload_2
    //   40: ifnull +138 -> 178
    //   43: aload_1
    ...
    //   45: aload_2
    //   46: ldc_w 299
    //   49: invokevirtual 302	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   52: ifeq -20 -> 32
    //   55: aload_1
    //   56: astore_0
    //   57: aload_2
    //   58: ldc_w 304
    //   61: invokevirtual 308	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   64: astore_3
    //   65: aload_1
    //   66: astore_0
    //   67: aload_3
    ...
    //   81: aload_1
    //   82: astore_0
    //   83: new 193	java/io/File
    //   86: dup
    //   87: aload_2
    //   88: invokespecial 221	java/io/File:<init>	(Ljava/lang/String;)V
    //   91: invokevirtual 233	java/io/File:exists	()Z
    //   94: ifeq -62 -> 32
    //   97: aload_1
    //   98: astore_0
    //   99: getstatic 30	bftg:jdField_b_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   102: aload_3
    //   103: aload_2
    //   104: invokevirtual 110	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   107: pop
    //   108: aload_1
    //   109: astore_0
    //   110: invokestatic 311	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   113: ifeq -81 -> 32
    //   116: aload_1
    //   117: astore_0
    //   118: ldc 65
    ...
    //   148: invokevirtual 166	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   151: invokestatic 318	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   154: goto -122 -> 32
    //   157: astore_2
    //   158: aload_1
    //   159: astore_0
    ...
    //   163: ldc 34
    //   165: aload_2
    //   166: invokestatic 71	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   169: aload_1
    //   170: ifnull +7 -> 177
    //   173: aload_1
    //   174: invokevirtual 321	java/io/BufferedReader:close	()V
    //   177: return
    //   178: aload_1
    //   179: astore_0
    //   180: aload_1
    //   181: invokevirtual 321	java/io/BufferedReader:close	()V
    //   184: aload_1
    //   185: ifnull -8 -> 177
    //   188: aload_1
    //   189: invokevirtual 321	java/io/BufferedReader:close	()V
    //   192: return
    //   193: astore_0
    //   194: ldc 65
    //   196: iconst_1
    //   197: ldc 34
    //   199: aload_0
    //   200: invokestatic 71	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   203: return
    //   204: astore_0
    //   205: ldc 65
    //   207: iconst_1
    //   208: ldc 34
    //   210: aload_0
    //   211: invokestatic 71	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   214: return
    //   215: astore_1
    //   216: aconst_null
    //   217: astore_0
    ...
    //   219: ifnull +7 -> 226
    //   222: aload_0
    //   223: invokevirtual 321	java/io/BufferedReader:close	()V
    //   226: aload_1
    //   227: athrow
    //   228: astore_0
    //   229: ldc 65
    ...
    //   232: ldc 34
    //   234: aload_0
    //   235: invokestatic 71	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   238: goto -12 -> 226
    //   241: astore_1
    //   242: goto -24 -> 218
    //   245: astore_2
  ...
  {
    return ajed.ba + UUID.randomUUID().toString() + ".jpg";
  }
