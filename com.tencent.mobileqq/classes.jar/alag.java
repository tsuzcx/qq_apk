...
public class alag
  extends alia
  implements ajxi, View.OnClickListener, View.OnLongClickListener, avsz
{
  private static final alal jdField_a_of_type_Alal = new alal(null);
  private final int jdField_a_of_type_Int;
  alao jdField_a_of_type_Alao = null;
  ...
  private bdxn jdField_a_of_type_Bdxn;
  ...
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new alai(this);
  ...
  public alag(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, View.OnClickListener paramOnClickListener, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Int = ((int)bfvh.a(this.jdField_a_of_type_AndroidContentContext, 12.0F));
    this.jdField_b_of_type_Int = ((int)bfvh.a(this.jdField_a_of_type_AndroidContentContext, 9.0F));
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560428, paramViewGroup, false);
      paramViewGroup = new alan();
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368236));
      ...
      if (this.jdField_a_of_type_Alao == null) {
        this.jdField_a_of_type_Alao = new alao(this, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      ...
      a(paramViewGroup, this.jdField_a_of_type_Alao.a((TroopMemberInfo)localObject2));
      label234:
      if (paramViewGroup.jdField_a_of_type_AndroidViewView != null)
      {
        if (!bezm.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramViewGroup.jdField_a_of_type_JavaLangString)) {
          break label465;
        }
    ...
    for (;;)
    {
      if ((AppSetting.c) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription((String)localObject1 + amtj.a(2131712853));
      }
      return paramView;
    ...
    label502:
    paramView.setContentDescription((String)localObject1 + amtj.a(2131712830));
    return paramView;
  }
  
  private void a(List<alaj> paramList)
  {
    try
    {
      Collections.sort(paramList, jdField_a_of_type_Alal);
      return;
    }
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      if ((AppSetting.c) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription(localPhoneContact.name + amtj.a(2131712845));
      }
      return paramView;
      paramViewGroup = (alan)paramView.getTag();
      paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
    ...
    label377:
    paramView.setContentDescription(localPhoneContact.name + amtj.a(2131712859));
    return paramView;
  }
  
  private View c(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView == null) || ((paramView.getTag() instanceof alan)))
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559628, paramViewGroup, false);
      paramViewGroup = new alam();
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368236));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131366807));
      paramViewGroup.d = ((TextView)paramView.findViewById(2131378368));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131373111));
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131373094));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131373121));
      paramViewGroup.e = ((TextView)paramView.findViewById(2131378370));
      paramView.setTag(paramViewGroup);
      if (this.jdField_a_of_type_AndroidViewView$OnClickListener == null) {
        break label483;
      }
    ...
    for (;;)
    {
      ...
      paramViewGroup.d.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColorStateList(2131167012));
      if (PublicAccountInfo.isLooker(localPublicAccountInfo))
      {
        ...
        return paramView;
        paramViewGroup = (alam)paramView.getTag();
        paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      }
      else
      {
        ...
        if (localPublicAccountInfo.certifiedGrade > 0L)
        {
          ...
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130841793);
        }
        for (;;)
        {
  ...
  private void c()
  {
    ...
    for (;;)
    {
      Object localObject2 = ajxc.a(this, bool, 0, 0);
      Object localObject3 = ((HashMap)localObject2).get(ajxc.jdField_a_of_type_JavaLangString);
      Object localObject1 = null;
      if (localObject3 != null) {
        localObject1 = (ArrayList)localObject3;
      }
      localObject2 = ((HashMap)localObject2).get(ajxc.b);
      ...
      if (localObject1 != null)
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (localObject4 != null) {
            try
            {
              ...
              {
                localObject4 = ((amsw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(((PfaFriend)localObject4).uin);
                if ((localObject4 != null) && (((Friends)localObject4).isFriend()) && (!bily.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((Friends)localObject4).uin))) {
        ...
        if (!((ArrayList)localObject2).isEmpty())
        {
          ...
          ((Groups)localObject1).group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131692456);
      ...
      if (localObject3 != null)
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (localObject4 != null) {
            try
            {
              if ((((RecentUser)localObject4).getType() == 0) && (Long.parseLong(((RecentUser)localObject4).uin) >= 10000L) && (!((RecentUser)localObject4).uin.equals(localObject2)) && (!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.mUinsToHide.contains(((RecentUser)localObject4).uin)) && (!bftf.b(((RecentUser)localObject4).uin)) && ((!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.mFilterRobot) || (!bezm.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((RecentUser)localObject4).uin))))
              {
        ...
        if (!((ArrayList)localObject1).isEmpty())
        {
          ...
          ((Groups)localObject2).group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131717613);
  ...
  private void e()
  {
    ...
    if ((localArrayList != null) && (localArrayList.size() > 0))
    {
      ...
      localGroups.group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131697502);
  ...
  private void g()
  {
    ...
    ((Groups)localObject).group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131694378);
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Bdxn.a(this.jdField_b_of_type_JavaUtilArrayList, this.jdField_a_of_type_AndroidUtilSparseArray);
    ...
    for (;;)
    {
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        this.jdField_b_of_type_JavaUtilArrayList.add(localGroups);
        localObject2 = localamsw.a(String.valueOf(localGroups.group_id));
        if (localObject2 == null) {}
        for (localObject2 = new ArrayList();; localObject2 = new ArrayList((Collection)localObject2))
        {
          ...
          while (((Iterator)localObject5).hasNext()) {
            ((ArrayList)localObject4).add(new alaj((Friends)((Iterator)localObject5).next(), -1));
          }
          d();
          break;
        ...
        while (((Iterator)localObject4).hasNext()) {
          ((List)localObject2).add(((alaj)((Iterator)localObject4).next()).a);
        }
      ...
      for (;;)
      {
        ...
        while (i < ((List)localObject2).size())
        {
          ...
          if ((!((Friends)localObject5).uin.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.mUinsToHide.contains(((Friends)localObject5).uin)) && (!bftf.b(((Friends)localObject5).uin)) && (!bily.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((Friends)localObject5).uin)) && ((!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.mFilterRobot) || (!bezm.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((Friends)localObject5).uin)))) {
  ...
  {
    alak localalak = (alak)paramView.getTag();
    if (localalak == null)
    {
      localalak = new alak();
      paramView.findViewById(2131369232).setVisibility(0);
      localalak.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367758));
      paramView.setTag(localalak);
    }
    for (;;)
    {
      Groups localGroups = (Groups)getGroup(paramInt);
      localalak.jdField_a_of_type_AndroidWidgetTextView.setText(localGroups.group_name);
      if (this.jdField_b_of_type_ComTencentWidgetExpandableListView != null) {
        ((CheckBox)paramView.findViewById(2131369232)).setChecked(this.jdField_b_of_type_ComTencentWidgetExpandableListView.c(paramInt));
      }
      return;
    }
  }
  
  public void a(bdxn parambdxn)
  {
    this.jdField_a_of_type_Bdxn = parambdxn;
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.mEntrance == 33) {
      ajxc.a(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.app);
    }
    if (this.jdField_a_of_type_Alao != null)
    {
      this.jdField_a_of_type_Alao.a();
  ...
  public long getChildId(int paramInt1, int paramInt2)
  {
    ...
    return this.jdField_a_of_type_Bdxn.a(localRelationTroopEntity.troopInfo.troopuin).longValue();
  }
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      else if (a(paramInt1, paramInt2) == 2)
      {
        ...
        paramView = this.jdField_a_of_type_Bdxn.b(paramInt1, paramInt2, paramView, paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity, this.jdField_a_of_type_AndroidViewView$OnClickListener, localRelationTroopEntity);
      }
      else
      {
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      localObject = (alak)paramView.getTag();
      ...
      if (AppSetting.c)
      {
        ...
        paramViewGroup.setContentDescription(((Groups)localObject).group_name + amtj.a(2131712849));
      }
    }
    for (;;)
    {
      ...
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560427, paramViewGroup, false);
      paramView = new alak();
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131367758));
      paramViewGroup.setTag(paramView);
      paramViewGroup.setOnClickListener(this);
      break;
      label153:
      paramViewGroup.setContentDescription(((Groups)localObject).group_name + amtj.a(2131712840));
    }
  }
  ...
  {
    Object localObject = (alak)paramView.getTag();
    if (this.jdField_a_of_type_ComTencentWidgetExpandableListView.c(((alak)localObject).jdField_a_of_type_Int)) {
      this.jdField_a_of_type_ComTencentWidgetExpandableListView.b(((alak)localObject).jdField_a_of_type_Int);
    }
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_ComTencentWidgetExpandableListView.a(((alak)localObject).jdField_a_of_type_Int);
        localObject = (Groups)getGroup(((alak)localObject).jdField_a_of_type_Int);
        if (((Groups)localObject).group_id == 1003)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.mSubType == 0) {
            bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005442", "0X8005442", 1, 0, "", "", "", "");
          } else {
            bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005442", "0X8005442", 2, 0, "", "", "", "");
          }
        }
        else if (((Groups)localObject).group_id == 1002)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.mSubType == 0) {
            bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005444", "0X8005444", 1, 0, "", "", "", "");
          } else {
            bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005444", "0X8005444", 2, 0, "", "", "", "");
          }
        }
        else if (((Groups)localObject).group_id == 0)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.mSubType == 0) {
            bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005443", "0X8005443", 1, 0, "", "", "", "");
          } else {
            bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005443", "0X8005443", 2, 0, "", "", "", "");
          }
        }
        else if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.mSubType == 0) {
          bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005445", "0X8005445", 1, 0, "", "", "", "");
        } else {
          bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005445", "0X8005445", 2, 0, "", "", "", "");
        }
      }
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    localbgaz.a(0, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131692880));
    bfue.a(paramView, localbgaz, this.jdField_b_of_type_AndroidViewView$OnClickListener, new alah(this));
    return true;
  }
