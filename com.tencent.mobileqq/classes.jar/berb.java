...
public class berb
{
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (Exception localException1)
        {
          ...
          if ((this.jdField_a_of_type_AndroidViewView instanceof berc)) {
            ((berc)this.jdField_a_of_type_AndroidViewView).a(this.jdField_a_of_type_AndroidGraphicsCanvas);
          }
          ...
          if ((this.jdField_a_of_type_AndroidViewView instanceof berc)) {
            ((berc)this.jdField_a_of_type_AndroidViewView).a(paramCanvas);
          }
          if (QLog.isColorLevel())
          {
  ...
  public void b(Canvas paramCanvas)
  {
    ...
    label159:
    while (!(this.jdField_a_of_type_AndroidViewView instanceof berc))
    {
      return;
      QLog.e("MosaicEffect", 1, "onDraw: clipBound is empty " + this.jdField_a_of_type_AndroidGraphicsRect);
      return;
    }
    ((berc)this.jdField_a_of_type_AndroidViewView).b(this.jdField_a_of_type_AndroidGraphicsCanvas);
  }
}
