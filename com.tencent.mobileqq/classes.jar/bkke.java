...
{
  private static final String jdField_a_of_type_JavaLangString = bkke.class.getSimpleName();
  ...
  public bkke(int paramInt1, int paramInt2)
  {
  ...
  private void d()
  {
    this.jdField_a_of_type_Bkkg = new bkkg();
    this.jdField_a_of_type_Bkkg.a();
    if (this.jdField_b_of_type_Boolean) {
      Log.d(jdField_a_of_type_JavaLangString, "textureID=" + this.jdField_a_of_type_Bkkg.a());
    }
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Bkkg.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bkkg = null;
  ...
  {
    this.jdField_a_of_type_Bkkg.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Bkkg.a("before updateTexImage");
