...
public class axba
{
  ...
  public axba(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localExtensionInfo = localanmw.a(paramString, true);
        bool1 = localanmw.a(false);
      } while ((bool1) || (localExtensionInfo == null));
      i = axav.a(6, paramString, localExtensionInfo, bool1);
      j = axav.a(5, paramString, localExtensionInfo, bool1);
      l1 = localExtensionInfo.lastFriendshipTime;
      l2 = localExtensionInfo.lastChatTime;
      int k = axav.b();
      bool1 = axav.a(k, l2 * 1000L);
      bool2 = axav.a(k, l1 * 1000L);
    ...
    if (bgsu.c(l2) == 2131718632)
    {
      bool1 = true;
      label279:
      if (bgsu.c(l3) != 2131718632) {
        break label507;
      }
      bool2 = true;
      label292:
