...
public class bhgp
  implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, bhgl
{
  private int jdField_a_of_type_Int = 0;
  private MediaPlayer jdField_a_of_type_AndroidMediaMediaPlayer;
  private bhgm jdField_a_of_type_Bhgm;
  private bhgn jdField_a_of_type_Bhgn;
  private bhgo jdField_a_of_type_Bhgo;
  private int b;
  ...
  private void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Bhgn != null) {
      this.jdField_a_of_type_Bhgn.a(this.jdField_a_of_type_Int);
    }
  }
  ...
  public void a(bhgn parambhgn)
  {
    ...
    this.jdField_a_of_type_Bhgn = parambhgn;
  }
  ...
  public void a(bhgo parambhgo)
  {
    ...
    this.jdField_a_of_type_Bhgo = parambhgo;
  }
  ...
  public void onCompletion(MediaPlayer paramMediaPlayer)
  {
    ...
    b(0);
    if (this.jdField_a_of_type_Bhgm != null) {
      this.jdField_a_of_type_Bhgm.a(this);
    }
  }
  ...
  public void onPrepared(MediaPlayer paramMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Bhgo != null) {
      this.jdField_a_of_type_Bhgo.a(this);
    }
    a();
    if (this.b > 0) {
      a(this.b);
