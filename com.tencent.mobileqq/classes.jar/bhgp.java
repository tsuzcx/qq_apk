  ...
  extends bhgn
{
  ...
  public bhgp(FilterDesc paramFilterDesc)
  {
    super(paramFilterDesc);
    this.jdField_a_of_type_Float = -1.0F;
    this.jdField_a_of_type_Bhgr = new bhgr(this);
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc = paramFilterDesc;
  }
  
  public static int a(Context paramContext, List<FilterDesc> paramList, bhha parambhha, int paramInt)
  {
    boolean bool2 = true;
    boolean bool1 = true;
    if (paramInt == 0) {
  ...
  public static void a(Context paramContext, List<FilterDesc> paramList)
  {
    ...
    QQFilterRenderManager localQQFilterRenderManager = bhey.a(bhey.b);
    if ((localQQFilterRenderManager == null) && (bgyx.a() == null))
    {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((bgyx.a() == null) || (paramContext == null) || (paramContext.size() <= 0)) {
          break;
        }
  ...
  public static boolean a(bhhh parambhhh, int paramInt)
  {
    if (parambhhh != null)
    {
      bhhh localbhhh = bjac.a().a[paramInt];
      if ((parambhhh != null) && (localbhhh != null) && (parambhhh.b().equals(localbhhh.b()))) {}
      for (boolean bool = true;; bool = false)
      {
        if (QLog.isColorLevel()) {
          QLog.d("QCombo", 2, new Object[] { "isApplying :" + parambhhh + " ", Boolean.valueOf(bool) });
        }
        return bool;
      }
    }
  ...
  public static void b(List<FilterDesc> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      new bhgq(bool2, bool1, localArrayList, paramBoolean).execute(new Void[0]);
      return;
      if (localFilterDesc.id == 9)
      {
        localArrayList.clear();
  ...
  public int a()
  {
    ...
    String str = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc.getResFold(bjds.b);
    if ((!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc.resurl)) && (!TextUtils.isEmpty(str)) && (bizy.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc)))
    {
      b(2);
      return 2;
    }
  ...
  public int b()
  {
    ...
    bizy.a().a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc, this.jdField_a_of_type_Bhgr);
    a();
    return super.b();
  }
