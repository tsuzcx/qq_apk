...
{
  public nzk(EqqAccountDetailActivity paramEqqAccountDetailActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      ((FriendListHandler)EqqAccountDetailActivity.j(this.a).getBusinessHandler(BusinessHandlerFactory.FRIENDLIST_HANDLER)).getFriendGroupList(true, false);
      ...
      try
      {
        ...
        avzm.a("follow", (JSONObject)localObject, localArrayList, null);
        if (!paramBoolean) {
          break label559;
        }
        try
        {
          ...
          if (paramInt == 0)
          {
            ...
            bdla.b(EqqAccountDetailActivity.l(this.a), "CliOper", "", "", this.a.b, this.a.c, 0, 0, "", "", EqqAccountDetailActivity.m(this.a).getCurrentAccountUin(), EqqAccountDetailActivity.l(this.a));
            if (!QLog.isColorLevel()) {
              continue;
            }
