...
public class sbo
{
  private static final String jdField_a_of_type_JavaLangString = sbo.class.getSimpleName();
  ...
  public sbo(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_b_of_type_JavaLangString = pay.a();
  }
  ...
  public boolean a(VideoInfo.ECommerceEntranceInfo paramECommerceEntranceInfo)
  {
    ...
    try
    {
      boolean bool = bkwm.y(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (!bool) {
        bkwm.a(this.jdField_b_of_type_JavaLangString + paramECommerceEntranceInfo.g, Integer.valueOf(0));
      }
      if (bool) {}
      for (int i = ((Integer)bkwm.a(this.jdField_b_of_type_JavaLangString + paramECommerceEntranceInfo.g, Integer.valueOf(0))).intValue();; i = 0)
      {
