  ...
  extends GestureDetector
{
  ...
  Animator.AnimatorListener jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new apul(this);
  Context jdField_a_of_type_AndroidContentContext;
  Rect jdField_a_of_type_AndroidGraphicsRect;
  View jdField_a_of_type_AndroidViewView;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  apuo jdField_a_of_type_Apuo = new apuo(this, null);
  ...
  public apuk(Context paramContext, GestureDetector.SimpleOnGestureListener paramSimpleOnGestureListener, BaseChatPie paramBaseChatPie)
  {
    ...
    for (int i1 = 0;; i1 = ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      if (!(paramBaseChatPie instanceof agkt)) {
        break;
      }
  ...
  private String a(apud paramapud)
  {
    if (paramapud.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null)
    {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) {
      try
      {
        int i1 = Integer.parseInt(paramapud.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
        int i2 = Integer.parseInt(paramapud.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId);
        paramapud = apih.a(i2, i1);
        EmoticonPackage localEmoticonPackage = ((aube)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(String.valueOf(i2));
        char[] arrayOfChar = new char[5];
        arrayOfChar[0] = '\024';
        arrayOfChar[1] = paramapud[3];
        arrayOfChar[2] = paramapud[2];
        arrayOfChar[3] = paramapud[1];
        arrayOfChar[4] = paramapud[0];
        if ((localEmoticonPackage != null) && (localEmoticonPackage.isAPNG == 2)) {
          arrayOfChar[1] = 'ǿ';
        }
        paramapud = new StringBuilder(String.valueOf(arrayOfChar));
        EmojiStickerManager.a(paramapud);
        return paramapud.toString();
      }
  ...
  private void e()
  {
    ...
    bdcd.a(this.jdField_a_of_type_AndroidContentContext, 230).setTitle(alpo.a(2131714768)).setMessage(alpo.a(2131714761)).setPositiveButton(alpo.a(2131714767), new apun(this)).setNegativeButton("取消", new apum(this)).show();
    int i1;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
    {
  ...
  void a(float paramFloat1, float paramFloat2)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView != null))
    {
      ...
      localViewPropertyAnimator.setListener(this.jdField_a_of_type_Apuo);
  ...
  void a(View paramView, boolean paramBoolean)
  {
    ...
    if (paramView != null)
    {
      localansf = (ansf)paramView.getTag(2131363763);
      localObject = (ChatMessage)paramView.getTag(2131364214);
      bool = false;
      if (localObject != null) {
      ...
      if (localansf != null)
      {
        ...
        ((anty)localObject).b(paramBoolean);
      }
    }
    label77:
    ...
    {
      if (bool) {}
      for (i1 = 2130849365;; i1 = 2130849189)
      {
        ...
        localansf.a(paramView, (Drawable)localObject);
        return;
      }
    }
    if (bool) {}
    for (int i1 = 2130849366;; i1 = 2130849190)
    {
      localObject = ((Resources)localObject).getDrawable(i1);
      break label112;
      break;
  ...
  boolean a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout != null)
    {
      ...
      while (i1 >= 0)
      {
        ...
        if (((View)localObject).getId() == 2131373329)
        {
          ...
          double d1;
          if (((localObject instanceof aptm)) || ((localObject instanceof Emoticon)) || ((localObject instanceof apsw)))
          {
            this.s = 1;
          ...
          {
            return true;
            if ((!(localObject instanceof apur)) && (!(localObject instanceof apud))) {
              break;
            }
            this.s = 0;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
    {
      ...
      {
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131373364);
    ...
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131373363);
      if (localObject1 != null) {
        return ((View)localObject1).onTouchEvent(paramMotionEvent);
      }
    }
    ...
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131373366);
      if (localObject1 != null) {
        return ((View)localObject1).onTouchEvent(paramMotionEvent);
      }
    }
      ...
      if (a())
      {
        ...
        if ((b(paramMotionEvent.getRawX(), paramMotionEvent.getRawY())) || (!this.jdField_d_of_type_Boolean))
        {
          ...
          for (;;)
          {
            ...
            if ((this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getTag(2131373365) instanceof Integer)) {
              i1 = ((Integer)this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getTag(2131373365)).intValue();
            }
            ...
            {
              localObject1 = (apur)localObject1;
              if (((apur)localObject1).jdField_a_of_type_Int == 1)
              {
                this.t = 2;
                break label1625;
              }
              if (((apur)localObject1).jdField_a_of_type_Int != 2) {
                break label1625;
              }
              this.t = 3;
              break label1625;
            }
            if ((localObject1 instanceof apud))
            {
              this.t = 4;
              break label1625;
            }
            if (!(localObject1 instanceof apsw)) {
              break label1625;
            }
            this.t = 5;
            break label1625;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        Object localObject4;
        apsw localapsw;
        if ((paramMotionEvent instanceof aptm))
        {
          localObject1 = (aptm)paramMotionEvent;
          localObject2 = null;
          localObject4 = null;
          localObject3 = null;
          localapsw = null;
        ...
        for (;;)
        {
          ...
          label2644:
          View localView;
          if ((!EmojiStickerManager.f) && (bdcs.a() > 1.048576E+008F))
          {
            i1 = 1;
            paramMotionEvent = null;
            if ((localObject1 == null) || (((aptm)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon == null)) {
              break label3289;
            }
            if (i1 == 0) {
              break label3272;
            }
            paramMotionEvent = ((aptm)localObject1).a("fromAIO", true, false, null, (int)(this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getWidth() * this.jdField_b_of_type_Double), (int)(this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getHeight() * this.jdField_b_of_type_Double));
            ...
            if ((localView == null) || (localView.getId() != 2131364171)) {
              break label7552;
            }
            ...
            localObject6 = (ChatMessage)localView.getTag(2131364214);
          ...
          for (;;)
          {
            ...
            if (i2 != 0)
            {
              ...
              if ((paramMotionEvent instanceof apur))
              {
                localObject4 = (apur)paramMotionEvent;
                localObject2 = null;
                localObject3 = null;
                localapsw = null;
                localObject1 = null;
              ...
              if ((paramMotionEvent instanceof apud))
              {
                localObject2 = (apud)paramMotionEvent;
                localObject4 = null;
                localObject3 = null;
                localapsw = null;
                localObject1 = null;
              ...
              if (!(paramMotionEvent instanceof apsw)) {
                break label7724;
              }
              localapsw = (apsw)paramMotionEvent;
              localObject2 = null;
              localObject4 = null;
              localObject3 = null;
              localObject1 = null;
              ...
              break label2644;
              label3272:
              paramMotionEvent = ((aptm)localObject1).a(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
              break label2704;
              label3289:
              if (localObject4 != null)
              {
                paramMotionEvent = ((apur)localObject4).b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
                break label2704;
              }
              ...
              if (localObject2 != null)
              {
                paramMotionEvent = ((apud)localObject2).b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
                break label2704;
              }
              if (localapsw == null) {
                break label2704;
              }
              paramMotionEvent = localapsw.b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float, 0, 0);
              break label2704;
            ...
            for (;;)
            {
              if ((localObject6 != null) && (((ChatMessage)localObject6).extraflag != 32772) && (((ChatMessage)localObject6).extraflag != 32768) && (bool3) && (bool4) && (((ChatMessage)localObject6).msgtype != -2009) && (((ChatMessage)localObject6).msgtype != -2016) && (!(localObject6 instanceof MessageForLongMsg)) && (!(localObject6 instanceof MessageForLongTextMsg)) && (bool2) && (i5 != 0) && (i4 == 0) && (i3 == 0) && (i1 == 0))
              {
                ...
                if ((localObject1 != null) && (((aptm)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon != null))
                {
                  localObject5 = ((aptm)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId;
                  if (f2 - i16 + this.r <= i8) {
                    break label4509;
                  }
                ...
                for (;;)
                {
                  ...
                  if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (localObject5 != null))
                  {
                    ...
                    if (bool1)
                    {
                      ...
                      if (localObject1 != null)
                      {
                        ((aptm)localObject1).jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerInfo = ((EmojiStickerManager.StickerInfo)localObject6);
                        ((ChatMessage)localObject5).stickerHidden = false;
                        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a((appw)localObject1);
                      }
                      do
                      {
                        for (;;)
                        {
                          ...
                          if (localObject3 != null)
                          {
                            acex.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (Emoticon)localObject3, (EmojiStickerManager.StickerInfo)localObject6);
                          }
                          else
                          {
                            if (localObject4 != null)
                            {
                              if (((apur)localObject4).jdField_a_of_type_Int == 1) {}
                              for (paramMotionEvent = baiy.c(((apur)localObject4).jdField_b_of_type_Int);; paramMotionEvent = baiy.a(((apur)localObject4).jdField_b_of_type_Int))
                              {
                            ...
                            paramMotionEvent = a((apud)localObject2);
                            this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(paramMotionEvent, (EmojiStickerManager.StickerInfo)localObject6);
                          }
                        }
                      } while (localapsw == null);
                      ...
                      localObject5 = localapsw.e;
                      if (!TextUtils.isEmpty(localapsw.d)) {}
                      for (bool1 = true;; bool1 = false)
                      {
                        acex.a(paramMotionEvent, (Context)localObject2, (SessionInfo)localObject4, (String)localObject5, true, bool1, localapsw.d, (EmojiStickerManager.StickerInfo)localObject6);
                        break;
                      }
                      label5860:
                      ...
                      a(String.format(alpo.a(2131714770), new Object[] { Integer.valueOf(EmojiStickerManager.jdField_e_of_type_Int) }));
                        ...
                        if (i1 == 2)
                        {
                          ...
                          if ((localObject1 instanceof FragmentActivity))
                          {
                            ...
                            if (((FragmentActivity)localObject1).getChatFragment() != null)
                            {
                              ...
                              if ((((localObject1 instanceof agiu)) || ((localObject1 instanceof agld)) || ((localObject1 instanceof agkt))) && (EmojiStickerManager.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 0))
                              {
