  ...
  extends apvx
{
  ...
  private apul jdField_a_of_type_Apul = new apul(this, null);
  private apun jdField_a_of_type_Apun = new apun(this, null);
  private apuv jdField_a_of_type_Apuv = new apuv(this, null);
  private apux jdField_a_of_type_Apux = new apux(this, null);
  public apvn a;
  private HashMap<String, apum> jdField_a_of_type_JavaUtilHashMap = new ArkAppDeviceModule.1(this);
  
  public apuk(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    this.jdField_a_of_type_Apvn = new apvn(this.jdField_a_of_type_JavaLangString);
  }
  ...
  {
    if (this.jdField_a_of_type_Apvn != null) {
      this.jdField_a_of_type_Apvn.a();
    }
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    {
      apum localapum = (apum)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
      if (localapum != null) {
        return localapum.a(paramString, paramArrayOfVariantWrapper, paramVariantWrapper);
      }
    }
    return false;
  }
