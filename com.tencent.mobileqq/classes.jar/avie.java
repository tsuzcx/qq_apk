  ...
  public static String a(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        avhz localavhz = new avhz(new StringReader(paramString), paramString.length());
        paramString = null;
        try
        {
          localavhw = localavhz.a();
          if (localavhw != null) {
            continue;
          }
      ...
      if ((paramString != null) && (TextUtils.equals(paramString.b(), "double")) && ((!TextUtils.equals(localavhw.b(), "double")) || (paramString.b() < localavhw.a())) && (!TextUtils.isEmpty(paramString.a())))
      {
        localStringBuilder.append(paramString.a().charAt(paramString.a().length() - 1));
        localStringBuilder.append("*");
        localStringBuilder.append(' ');
      }
      if ((!TextUtils.isEmpty(localavhw.a())) && ((!TextUtils.equals(localavhw.b(), "double")) || (localavhw.a().length() != 1)))
      {
        localStringBuilder.append(localavhw.a());
        localStringBuilder.append(' ');
      }
      paramString = localavhw;
    }
    return null;
  }
