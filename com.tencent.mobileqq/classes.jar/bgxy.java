...
public class bgxy
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = ajyc.a(2131711909);
  }
  ...
  {
    Intent localIntent = new Intent();
    localIntent.putExtra("key_left_tab_title", paramContext.getString(2131717644));
    localIntent.putExtra("key_rihgt_tab_title", paramContext.getString(2131717725));
  ...
  @NonNull
  private static Intent a(bgyf parambgyf, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyf);
  ...
  private static Intent a(bgyf parambgyf, String paramString)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyf);
  ...
  public static SurfaceView a(Context paramContext, String paramString)
  {
    try
    {
      if (f())
      {
        bdid.a().a(jdField_b_of_type_JavaLangString, 1);
        return null;
      }
      try
      {
  ...
  {
    bbcv.a(paramActivity, 230).setMessage(2131718228).setPositiveButton(2131717755, new bgxz()).setNegativeButton(2131719536, paramOnClickListener).show();
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, bgyf parambgyf, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    Intent localIntent = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, int paramInt)
  {
    c(paramActivity, parambgyf, null, paramInt);
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, int paramInt, Bundle paramBundle)
  {
    Intent localIntent = new Intent();
    localIntent.putExtras(paramBundle);
    a(localIntent, parambgyf);
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, int paramInt, String paramString, long paramLong1, long paramLong2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyf);
    ...
    QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, localIntent, 0);
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2, int paramInt9, int paramInt10, boolean paramBoolean3)
  {
    a(paramActivity, parambgyf, paramInt1, paramString1, paramString2, paramString3, paramString4, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramString5, paramInt8, paramBundle, paramBoolean1, paramBoolean2, paramInt9, paramInt10, paramBoolean3, null);
  }
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, Bundle paramBundle1, boolean paramBoolean1, boolean paramBoolean2, int paramInt9, int paramInt10, boolean paramBoolean3, Bundle paramBundle2)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt2 = 1;; paramInt2 = 0)
      {
        ...
        QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, paramString1, paramInt1, null, true);
        return;
      }
    }
  }
  ...
  {
    a(paramActivity, parambgyf, paramInt1, paramString1, paramString2, paramString3, paramString4, paramInt2, paramBoolean1, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramString5, paramInt8, paramInt9, paramBoolean2, paramString6, paramBoolean3, null);
  }
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, boolean paramBoolean1, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, int paramInt9, boolean paramBoolean2, String paramString6, boolean paramBoolean3, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt7 = 1;; paramInt7 = 0)
      {
        ...
        QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, paramString1, paramInt1, null, paramBoolean2);
        return;
      }
    }
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, long paramLong, int paramInt)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyf);
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, Intent paramIntent)
  {
    a(paramActivity, parambgyf, paramIntent, -1);
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, Intent paramIntent, int paramInt)
  {
    a(paramIntent, parambgyf);
    if (paramInt >= 0) {
    ...
    for (;;)
    {
      ...
      QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, paramIntent, paramInt);
      return;
      paramIntent.putExtra("bNeedCallBack", false);
    }
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, Intent paramIntent, int paramInt, DialogInterface.OnDismissListener paramOnDismissListener)
  {
    QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, paramIntent, paramInt, paramOnDismissListener, true);
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, Intent paramIntent, int paramInt, boolean paramBoolean)
  {
    a(paramIntent, parambgyf);
    if (paramInt >= 0) {
      paramIntent.putExtra("bNeedCallBack", true);
    ...
    {
      QzonePluginProxyActivity.a(paramIntent, "com.qzone.misc.web.QZoneTranslucentActivity");
      QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, paramIntent, paramInt, null, paramBoolean);
      return;
      paramIntent.putExtra("bNeedCallBack", false);
    }
  }
  ...
  @Deprecated
  public static void a(Activity paramActivity, bgyf parambgyf, Intent paramIntent, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, ArrayList<String> paramArrayList, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      paramString2 = String.valueOf(axas.a());
      paramIntent.putExtra("key_upload_client_key", paramString2);
      paramString1.putExtra("key_upload_client_key", paramString2);
      QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, paramString1, paramInt2);
      return;
      i = 0;
      continue;
      i = 3;
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(parambgyf, "com.qzone.album.ui.activity.QZonePersonalAlbumSelectActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt)
  {
    paramBaseBusinessAlbumInfo = a(parambgyf, paramBaseBusinessAlbumInfo);
    QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, paramBaseBusinessAlbumInfo, paramInt);
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt, String paramString)
  {
    paramBaseBusinessAlbumInfo = a(parambgyf, paramBaseBusinessAlbumInfo);
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, CoverCacheData paramCoverCacheData, String paramString, int paramInt)
  {
    parambgyf = bgyc.a(parambgyf.jdField_a_of_type_JavaLangString, paramString, "usersummary", true);
    paramCoverCacheData = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramCoverCacheData);
    paramCoverCacheData.putExtra("url", parambgyf);
    if (bcde.a.containsKey("Qzone")) {
      paramCoverCacheData.putExtra("insertPluginsArray", new String[] { "Qzone" });
    }
    paramCoverCacheData.setData(Uri.parse(parambgyf));
    c(paramCoverCacheData);
    paramActivity.startActivityForResult(paramCoverCacheData, paramInt);
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, Long paramLong, int paramInt1, int paramInt2, int paramInt3, aqyb paramaqyb)
  {
    paramLong = a(paramActivity, paramLong, paramInt1);
    a(paramLong, parambgyf);
    a(paramLong, paramInt2);
    QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, paramLong, paramInt3, paramaqyb);
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    a(paramActivity, parambgyf, paramLong, paramInt1, paramBoolean, paramInt2, 5);
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2, int paramInt3)
  {
    ...
    QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, paramLong, paramInt2);
  }
  
  @Deprecated
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString, int paramInt)
  {
    if (TextUtils.isEmpty(paramString)) {
      return;
    }
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, int paramInt, Bundle paramBundle, String paramString2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyf);
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, int paramInt, String paramString2)
  {
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, long paramLong, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    Intent localIntent = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, localIntent, paramInt1);
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, long paramLong, String paramString2, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, long paramLong, String paramString2, int paramInt, String paramString3, boolean paramBoolean)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_OPEN_VIP");
    a(localIntent, parambgyf);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.module.vipcomponent.ui.DiamondYellowOpenActivity");
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, long paramLong, String paramString2, String paramString3, int paramInt)
  {
    Object localObject;
    if (paramActivity == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((Intent)localObject).putExtra("userId", parambgyf.jdField_a_of_type_JavaLangString);
        ((Intent)localObject).putExtra("userName", parambgyf.jdField_b_of_type_JavaLangString);
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, String paramString2, int paramInt)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyf);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.detail.ui.activity.QzoneDetailActivity");
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyf);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.detail.ui.activity.QzoneDetailActivity");
    ...
    QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, localIntent, paramInt2);
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3)
  {
    ...
    parambgyf = paramString1;
    if (!TextUtils.isEmpty(paramString3)) {
      parambgyf = paramString1 + "&source=" + paramString3;
    }
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "forwardToQunAlbumList:" + parambgyf);
    }
    paramString1.putExtra("url", parambgyf);
    if (bcde.a.containsKey("Qzone")) {
      paramString1.putExtra("insertPluginsArray", new String[] { "Qzone" });
    }
    paramString1.setData(Uri.parse(parambgyf));
    c(paramString1);
    paramActivity.startActivityForResult(paramString1, paramInt2);
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, String paramString2, String paramString3, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    parambgyf = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumPhotoList", "https://h5.qzone.qq.com/groupphoto/inqq/photo/{QUN_ID}/{ALBUM_ID}?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1).replace("{ALBUM_ID}", paramString2);
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    paramString1.putExtra("url", parambgyf);
    if (bcde.a.containsKey("Qzone")) {
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, Bundle paramBundle)
  {
    a(paramActivity, parambgyf, paramString1, paramString2, paramString3, paramString4, paramInt, paramBundle, true, false);
  }
  
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, String paramString2, String paramString3, String paramString4, long paramLong, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, String paramString2, ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<Long> paramArrayList, int paramInt, String paramString3, String paramString4)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_RESHIP_FROM_QUN_AIO_TO_QUN");
    a(localIntent, parambgyf);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, String paramString1, String paramString2, boolean paramBoolean, int paramInt)
  {
    parambgyf = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunFeed", "https://h5.qzone.qq.com/groupphoto/inqq/recent/{QUN_ID}/groupphoto?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1);
    ...
    paramString1.putExtra("source_name", BaseApplicationImpl.getContext().getString(2131717943));
    paramString1.setData(Uri.parse(parambgyf));
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, boolean paramBoolean, String paramString1, String paramString2, int paramInt1, String paramString3, String paramString4, long paramLong1, long paramLong2, int paramInt2)
  {
  ...
  public static void a(Activity paramActivity, bgyf parambgyf, boolean paramBoolean, String paramString1, String paramString2, int paramInt1, ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<Long> paramArrayList3, ArrayList<Long> paramArrayList4, int paramInt2)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_QUOTE_FROM_AIO");
    a(localIntent, parambgyf);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
  ...
  public static void a(Activity paramActivity, String paramString1, int paramInt1, int paramInt2, long paramLong, String paramString2, String paramString3, String paramString4, int paramInt3, int paramInt4)
  {
    ...
    a(paramString1, localbgyf);
    QzonePluginProxyActivity.a(paramString1, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
    QzonePluginProxyActivity.a(paramActivity, localbgyf.jdField_a_of_type_JavaLangString, paramString1, paramInt3);
  }
  ...
  {
    bgyf localbgyf = bgyf.a();
    localbgyf.jdField_a_of_type_JavaLangString = paramString2;
    ...
    b(paramActivity, localbgyf, paramString2, -1);
  }
  ...
  public static void a(Context paramContext, bgyf parambgyf)
  {
    parambgyf = QzoneConfig.getInstance().getConfig("H5Url", "QzonePictureSettingPage", "https://h5.qzone.qq.com/image/setting/imageSetting?_wv=3&_proxy=1&uin={uin}").replace("{uin}", String.valueOf(parambgyf.jdField_a_of_type_JavaLangString)).replace("{host_uin}", parambgyf.jdField_a_of_type_JavaLangString).replace("{UIN}", String.valueOf(parambgyf.jdField_a_of_type_JavaLangString)).replace("{HOST_UIN}", parambgyf.jdField_a_of_type_JavaLangString);
    if (!bfng.b(parambgyf).containsKey("_wv")) {
      bfng.a(parambgyf, "_wv", "5");
    }
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "jump qzone setting URL:" + parambgyf);
    }
    Intent localIntent = new Intent(BaseApplication.getContext(), QQBrowserActivity.class);
    a(localIntent);
    localIntent.putExtra("url", parambgyf);
    ...
    localIntent.setData(Uri.parse(parambgyf));
    localIntent.addFlags(268435456);
    c(localIntent);
    paramContext.startActivity(localIntent);
  }
  
  public static void a(Context paramContext, bgyf parambgyf, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    a(paramContext, parambgyf, paramString, paramInt1, paramInt2, paramInt3, null, null, false);
  }
  
  public static void a(Context paramContext, bgyf parambgyf, String paramString, int paramInt1, int paramInt2, int paramInt3, aqyb paramaqyb, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      QzonePluginProxyActivity.a(paramContext, parambgyf.jdField_a_of_type_JavaLangString, localIntent, paramInt2, paramaqyb);
      return;
      i = 0;
      break;
      label107:
  ...
  public static void a(Context paramContext, bgyf parambgyf, String paramString1, int paramInt1, int paramInt2, aqyb paramaqyb, String paramString2, boolean paramBoolean)
  {
    ...
    QzonePluginProxyActivity.a(paramContext, parambgyf.jdField_a_of_type_JavaLangString, paramString1, paramInt1, paramaqyb);
  }
  
  public static void a(Context paramContext, bgyf parambgyf, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyf);
    localIntent.putExtra("startup_sceneid", 4);
    ...
    try
    {
      ...
      for (paramString1 = paramBundle;; paramString1 = new Bundle())
      {
        ...
        QzonePluginProxyActivity.a(paramContext, parambgyf.jdField_a_of_type_JavaLangString, localIntent, paramInt, null, paramBoolean1);
        return;
      }
      return;
    }
  ...
  public static void a(Intent paramIntent, bgyf parambgyf)
  {
    paramIntent.putExtra("qzone_uin", parambgyf.jdField_a_of_type_JavaLangString);
    paramIntent.putExtra("nickname", parambgyf.jdField_b_of_type_JavaLangString);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, bgyf parambgyf, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2, boolean paramBoolean3, boolean paramBoolean4, String paramString3, boolean paramBoolean5, String paramString4, String paramString5, boolean paramBoolean6, boolean paramBoolean7, boolean paramBoolean8, boolean paramBoolean9, String paramString6, boolean paramBoolean10, boolean paramBoolean11, boolean paramBoolean12, int paramInt2, boolean paramBoolean13, Bundle paramBundle)
  {
    ...
    if (paramBoolean12)
    {
      ...
      if (paramBoolean2)
      {
        parambgyf = acxv.a(ajsf.bj);
        paramQQAppInterface.putBoolean("support_photo_merge", true);
        paramQQAppInterface.putString("qcamera_photo_filepath", parambgyf);
        ...
        paramQQAppInterface.putString("pic_confirm_text", ajyc.a(2131711913));
      }
    ...
    for (;;)
    {
      ...
      break;
      label387:
      bbcv.a(paramActivity, 230).setMessage(ajyc.a(2131711911)).setPositiveButton(2131694793, new bgyb()).show();
    }
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, PublishMoodInfo paramPublishMoodInfo, Intent paramIntent, int paramInt, boolean paramBoolean)
  {
    ...
    bgyu.a(paramQQAppInterface, paramActivity, localBundle, null, paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ServiceConnection paramServiceConnection)
  {
    ...
    localbgkz.jdField_e_of_type_JavaLangString = "com.qzone.publish.business.publishqueue.PublishQueueService";
  ...
  public static void a(QQAppInterface paramQQAppInterface, aqyb paramaqyb)
  {
    ThreadManager.post(new QZoneHelper.8(paramQQAppInterface, paramaqyb), 8, null, false);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, aqyb paramaqyb)
  {
    ...
    {
      axqw.b(paramQQAppInterface, "CliOper", "", "", "0X8005E9C", "0X8005E9C", 1, 0, "", "", "", "");
      axrt.a().a("actQZLoadHitRateRed", true);
    }
    for (;;)
    {
      ...
      try
      {
        ...
        ((Intent)localObject).putExtra("cpuNum", bbct.b());
      ...
      catch (Exception paramString)
      {
        ...
        paramString.jdField_a_of_type_Aqyb = paramaqyb;
        ...
        bgkq.c(paramQQAppInterface.getApp(), paramString);
      }
      if (!axnv.jdField_d_of_type_Boolean) {
        break label463;
      }
      if (QLog.isColorLevel()) {
        QLog.d("Perf", 2, "disable preload qzone process");
      }
      axnv.e = System.currentTimeMillis();
      return;
      if ("Leba".equals(paramString))
      {
        axqw.b(paramQQAppInterface, "CliOper", "", "", "0X8005E9C", "0X8005E9C", 1, 0, "", "", "", "");
        axrt.a().a("actQZLoadHitRateLeba", true);
      }
      else if ("FriendProfileCardActivity".equals(paramString))
      {
        axrt.a().a("actQZLoadHitRateProfile", true);
      }
    }
    QLog.d("QZoneHelper", 1, "preloadQzone is not allowed as crash frequently.");
    axrl.a(BaseApplicationImpl.getContext()).a(paramQQAppInterface.getCurrentAccountUin(), "actNoPreloadQzone", true, 0L, 0L, null, "");
    return;
    label443:
    label463:
    return;
  ...
  public static void a(WebViewPlugin paramWebViewPlugin, bcdb parambcdb, Activity paramActivity, String paramString1, String paramString2)
  {
    Intent localIntent = new Intent();
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
    localIntent.putExtra("startup_sceneid", 6);
    ...
    QzonePluginProxyActivity.a(paramActivity, paramString1, localIntent, a(paramWebViewPlugin, parambcdb, 1));
  }
  ...
  public static void a(BaseApplication paramBaseApplication, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        localIntent.putExtra("cpuNum", bbct.b());
    ...
    catch (Exception paramString2)
    {
      ...
      paramString2.jdField_a_of_type_JavaLangString = paramString1;
      paramString2.jdField_a_of_type_Aqyb = null;
      ...
      bgkq.c(paramBaseApplication, paramString2);
    }
  }
  ...
  public static void a(String paramString, Context paramContext)
  {
    ...
    ((Intent)localObject).putExtra("source_name", BaseApplicationImpl.getContext().getString(2131717943));
  ...
  public static void a(String paramString1, ArrayList<String> paramArrayList1, int paramInt1, LbsDataV2.PoiInfo paramPoiInfo, String paramString2, String paramString3, ArrayList<String> paramArrayList2, HashMap<String, String> paramHashMap1, HashMap<String, String> paramHashMap2, String paramString4, int paramInt2)
  {
    ...
    bhkl.a().a("cmd.publishMixMood", paramString2, false);
  }
  ...
  public static void a(String paramString1, ArrayList<String> paramArrayList1, int paramInt1, ArrayList<String> paramArrayList2, int paramInt2, int paramInt3, String paramString2, boolean paramBoolean1, boolean paramBoolean2, int paramInt4, String paramString3)
  {
    ...
    bhkl.a().a("cmd.publishMoodForAll", localBundle, false);
  }
  ...
  {
    bhmb.a(paramString1, paramInt1, paramString2, paramInt2);
  }
  ...
  public static void a(AppRuntime paramAppRuntime, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      bbbd.a(BaseApplicationImpl.getContext(), "com.tencent.mobileqq:picture");
      ...
      bbbd.a(BaseApplicationImpl.getContext(), "com.tencent.mobileqq:qzonevideo");
      bhbp.a((Context)localObject);
      if (!TextUtils.isEmpty(str))
      {
      ...
      {
        apvb.c((String)localObject + File.separator + "qz_predownload_config.xml");
        apvb.c((String)localObject + File.separator + "QZ_Per_Config.xml");
        apvb.c((String)localObject + File.separator + "QZONE_UNREAD.xml");
      }
      localObject = bbuv.a(Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "tencent" + File.separator + "MobileQQ" + File.separator + "trace");
      if (localObject != null) {
  ...
  public static void a(boolean paramBoolean, bgye parambgye)
  {
    if (!paramBoolean)
    {
      parambgye.a(false, true);
      return;
    }
    ThreadManager.postImmediately(new QZoneHelper.6(parambgye), null, true);
  }
  ...
  public static boolean a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    if (QzoneConfig.getInstance().getConfig("QZoneSetting", "aio2qzonedetail", 1) == 1)
    {
      ...
      QzonePluginProxyActivity.a(paramActivity, bgyf.a().jdField_a_of_type_JavaLangString, paramString2, 0);
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(Context paramContext, Intent paramIntent, boolean paramBoolean)
  {
    ...
    try
    {
      if ((axmt.a()) && (bhbh.c()))
      {
        if (((paramContext instanceof FragmentActivity)) && (!bhbh.a((FragmentActivity)paramContext, ((FragmentActivity)paramContext).app))) {
          return false;
        }
  ...
  {
    bbcv.a(paramActivity, 230).setMessage(2131718229).setPositiveButton(2131719536, paramOnClickListener).setNegativeButton(2131717755, new bgya()).show();
  }
  
  public static void b(Activity paramActivity, bgyf parambgyf, int paramInt)
  {
    parambgyf = QzoneConfig.getInstance().getConfig("H5Url", "QzoneSettingMainPage", "https://h5.qzone.qq.com/qzone/setting?_wv=3&_proxy=1&uin={uin}").replace("{uin}", String.valueOf(parambgyf.jdField_a_of_type_JavaLangString)).replace("{host_uin}", parambgyf.jdField_a_of_type_JavaLangString).replace("{UIN}", String.valueOf(parambgyf.jdField_a_of_type_JavaLangString)).replace("{HOST_UIN}", parambgyf.jdField_a_of_type_JavaLangString);
    if (!bfng.b(parambgyf).containsKey("_wv")) {
      bfng.a(parambgyf, "_wv", "5");
    }
    if (QLog.isColorLevel()) {
  ...
  public static void b(Activity paramActivity, bgyf parambgyf, Intent paramIntent)
  {
    a(paramIntent, parambgyf);
    QzonePluginProxyActivity.a(paramIntent, "com.qzone.misc.web.QZoneTranslucentActivity2");
    QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, paramIntent, 0);
  }
  
  public static void b(Activity paramActivity, bgyf parambgyf, Intent paramIntent, int paramInt)
  {
  ...
  public static void b(Activity paramActivity, bgyf parambgyf, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(parambgyf, "com.qzone.album.business.photolist.activity.QZonePersonalPhotoListActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void b(Activity paramActivity, bgyf parambgyf, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt)
  {
    paramBaseBusinessAlbumInfo = a(parambgyf, paramBaseBusinessAlbumInfo);
  ...
  public static void b(Activity paramActivity, bgyf parambgyf, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt, String paramString)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyf);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.album.business.photolist.activity.QZonePersonalPhotoListActivity");
  ...
  public static void b(Activity paramActivity, bgyf parambgyf, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    a(paramActivity, parambgyf, paramLong, paramInt1, paramBoolean, paramInt2, 12);
  }
  
  public static void b(Activity paramActivity, bgyf parambgyf, String paramString, int paramInt)
  {
    try
    {
      Intent localIntent = new Intent();
  ...
  public static void b(Activity paramActivity, bgyf parambgyf, String paramString1, long paramLong, String paramString2, int paramInt)
  {
  ...
  public static void b(Activity paramActivity, bgyf parambgyf, String paramString1, String paramString2, int paramInt)
  {
    parambgyf = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumDetail", "https://h5.qzone.qq.com/groupphoto/inqq/detail/{QQ_URL}?_wv=3&_proxy=1").replace("{QQ_URL}", URLEncoder.encode(paramString1));
    paramString1 = new Intent(BaseApplication.getContext(), QQBrowserDelegationActivity.class);
    paramString1.putExtra("url", parambgyf);
    paramString1.putExtra("fromQZone", true);
    paramString1.putExtra("injectrecommend", true);
  ...
  {
    if (!bbio.a(paramQQAppInterface.getApp(), new String[] { paramString1 })) {
      return;
    }
    a(paramIntent, paramQQAppInterface, paramString2, paramBitmap);
    Thread.sleep(1000L);
    bbio.a(paramQQAppInterface, paramIntent, paramString2, paramBitmap);
    Thread.sleep(1000L);
  }
  ...
  public static void b(WebViewPlugin paramWebViewPlugin, bcdb parambcdb, Activity paramActivity, String paramString1, String paramString2)
  {
    paramString2 = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, paramString1, paramString2, a(paramWebViewPlugin, parambcdb, 6));
  }
  ...
  public static void c(Activity paramActivity, bgyf parambgyf, int paramInt)
  {
    parambgyf = new SimpleDateFormat("yyyyMM", Locale.getDefault()).format(new Date());
    parambgyf = QzoneConfig.getInstance().getConfig("H5Url", "QzoneShuoshuoDailyCalendar", "https://h5.qzone.qq.com/v2/shuoshuo-daily/calendar/{date}?_wv=16777216").replace("{date}", parambgyf).replace("{DATE}", parambgyf);
    if (!bfng.b(parambgyf).containsKey("_wv")) {
      bfng.a(parambgyf, "_wv", "1027");
    }
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "jump qzone ShuoshuoDailyCalendar URL:" + parambgyf);
    }
    Intent localIntent = new Intent(BaseApplication.getContext(), QQBrowserActivity.class);
    a(localIntent);
    localIntent.putExtra("url", parambgyf);
  ...
  public static void c(Activity paramActivity, bgyf parambgyf, Intent paramIntent, int paramInt)
  {
    Intent localIntent = paramIntent;
    if (paramIntent == null) {
      localIntent = new Intent();
  ...
  public static void c(Activity paramActivity, bgyf parambgyf, Bundle paramBundle, int paramInt)
  {
    bhkl.a().a("cmd.cancelKillPictureProcess", null, false);
    Intent localIntent = a(parambgyf, "com.qzone.preview.QzonePictureViewer");
    localIntent.putExtras(paramBundle);
    localIntent.putExtra("fromQZone", false);
    QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, localIntent, paramInt, null, false);
  }
  
  public static void c(Activity paramActivity, bgyf parambgyf, String paramString, int paramInt)
  {
    ...
    localIntent.putExtra("key_title", ajyc.a(2131711908));
    localIntent.putExtra("key_desc", "");
    localIntent.putExtra("key_need_save_draft", false);
    QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void c(Activity paramActivity, bgyf parambgyf, String paramString1, String paramString2, int paramInt)
  {
    if (TextUtils.isEmpty(paramString1)) {
      return;
    }
    parambgyf = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumSelect", "https://h5.qzone.qq.com/groupphoto/inqq/album/{QUN_ID}/select?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1);
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    paramString1.putExtra("url", parambgyf);
    if (bcde.a.containsKey("Qzone")) {
  ...
  public static void c(Context paramContext, String paramString)
  {
    ...
    a((Activity)paramContext, bgyf.a(), localIntent);
  }
  ...
  private static void c(Bitmap paramBitmap, @NonNull QQAppInterface paramQQAppInterface, String paramString1, long paramLong, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      if (Build.VERSION.SDK_INT < 26)
      {
        ...
        bbio.a(paramQQAppInterface, b(paramQQAppInterface, paramString1, paramLong), paramString2, paramBitmap);
        Thread.sleep(1000L);
        if (bbjp.a(paramQQAppInterface.getApplication(), new String[] { paramString1 }))
        {
          bdid.a().a(2131691315);
          return;
        }
  ...
  public static void d(Activity paramActivity, bgyf parambgyf, Bundle paramBundle, int paramInt)
  {
    bhkl.a().a("cmd.cancelKillPictureProcess", null, false);
    Intent localIntent = a(parambgyf, "com.qzone.preview.QzonePictureViewer");
    localIntent.putExtras(paramBundle);
  ...
  public static void d(Activity paramActivity, bgyf parambgyf, String paramString, int paramInt)
  {
    parambgyf = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunPassiveFeed", "https://h5.qzone.qq.com/groupphoto/inqq/relatedme/{QUN_ID}/{UIN}?_wv=3&_proxy=1").replace("{QUN_ID}", paramString).replace("{UIN}", parambgyf.jdField_a_of_type_JavaLangString);
    paramString = new Intent(BaseApplication.getContext(), QQBrowserDelegationActivity.class);
    paramString.putExtra("url", parambgyf);
    ...
    paramString.putExtra("source_name", BaseApplicationImpl.getContext().getString(2131717943));
    paramString.setData(Uri.parse(parambgyf));
  ...
  public static void e(Activity paramActivity, bgyf parambgyf, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(parambgyf, "com.qzone.album.business.dlna.activity.DLNAActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, parambgyf.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  ...
  public static void f(Activity paramActivity, bgyf parambgyf, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = new Intent();
