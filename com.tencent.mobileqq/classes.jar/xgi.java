...
public abstract class xgi
  extends xhe
  implements behi, behj, behk, bejr, bejs, xgv
{
  ...
  public xgi(Activity paramActivity, xgm paramxgm)
  {
    this.jdField_a_of_type_Xgv = new xgj(this);
  ...
  protected RelativeLayout a()
  {
    return (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131495379, null);
  }
  ...
  protected xgh a(Context paramContext)
  {
    return new xha();
  }
  ...
  {
    if ((this.jdField_a_of_type_Xgu != null) && (this.jdField_a_of_type_Xgu.a())) {
      this.jdField_a_of_type_Xgu.b();
    }
    if ((this.jdField_a_of_type_Xgu != null) && (this.jdField_a_of_type_Xgu.b())) {
      this.jdField_a_of_type_Xgu.c();
    }
  ...
  public void a(ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      b((ViewGroup)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131309736));
      this.jdField_a_of_type_ComTencentWidgetGallery = ((Gallery)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131301286));
      this.d = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131297459);
      this.jdField_a_of_type_Xgh = a(this.jdField_a_of_type_AndroidAppActivity);
      if (this.jdField_a_of_type_Xgh != null) {
        this.jdField_a_of_type_Xgh.a(this.jdField_a_of_type_AndroidAppActivity, this, this.b);
      }
      this.jdField_a_of_type_Xgu = a();
      if (this.jdField_a_of_type_Xgu != null) {
        this.jdField_a_of_type_Xgu.a(this.jdField_a_of_type_AndroidAppActivity, this);
      }
      this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter = a(this.jdField_a_of_type_AndroidAppActivity);
      this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter.a(this.jdField_a_of_type_Xgm);
      if (this.jdField_a_of_type_Xgu != null)
      {
        this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter.a(this.jdField_a_of_type_Xgu);
        this.jdField_a_of_type_Xgu.a();
      }
      ...
      this.jdField_a_of_type_ComTencentWidgetGallery.setSpacing(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131165934));
      this.jdField_a_of_type_ComTencentWidgetGallery.setSelection(this.jdField_a_of_type_Xgm.b());
  ...
  public void a(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Xgh != null) && (a())) {
        this.jdField_a_of_type_Xgh.a(paramAdapterView, paramInt);
      }
      this.jdField_a_of_type_Xgm.a(paramInt);
      if ((!d()) && (this.jdField_a_of_type_Xgu != null) && (!this.jdField_a_of_type_Xgu.a())) {
        this.jdField_a_of_type_Xgu.a();
      }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localAlphaAnimation.setDuration(this.jdField_a_of_type_Xgz.a().a());
    ...
    localAlphaAnimation.setAnimationListener(new xgk(this));
  ...
  public void b(boolean paramBoolean)
  {
    if (b())
    {
      a(paramBoolean, this.jdField_a_of_type_Xgz.a().b());
      return;
    }
  ...
  public void b(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localScaleAnimation.setDuration(this.jdField_a_of_type_Xgz.a().a());
    AnimationSet localAnimationSet = new AnimationSet(true);
    localAnimationSet.setFillAfter(true);
    localAnimationSet.addAnimation(localAlphaAnimation);
    localAnimationSet.addAnimation(localScaleAnimation);
    localAnimationSet.setAnimationListener(new xgl(this));
    this.d.startAnimation(localAlphaAnimation);
  ...
  public boolean d()
  {
    return this.jdField_a_of_type_Xgz.a().a();
  }
  ...
  public boolean e()
  {
    ...
    if (c()) {
      b(false, this.jdField_a_of_type_Xgz.a().c());
    }
    for (;;)
    {
      ...
      break;
      this.jdField_a_of_type_Xgv.e();
    }
  }
  
  public void i()
  {
    this.jdField_a_of_type_Xgz.a().a(this.jdField_a_of_type_Xgv);
  }
  ...
  public void o()
  {
    if (this.jdField_a_of_type_Xgz.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Xgz.jdField_a_of_type_Boolean = false;
      return;
    }
    b(true, this.jdField_a_of_type_Xgz.jdField_a_of_type_Xgg.c());
  }
