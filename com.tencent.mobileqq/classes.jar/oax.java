...
public class oax
{
  ...
  {
    return (paramAdvertisementInfo != null) && (paramAdvertisementInfo.mPhoneComponetId != 0) && (oat.e(paramAdvertisementInfo));
  }
  
  public static boolean a(AdData paramAdData)
  {
    return (paramAdData != null) && (paramAdData.m != 0) && (oat.e(paramAdData));
  }
  ...
  public static void b(Context paramContext, String paramString, AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    nmf.a(new nyg().a(paramContext).a(nmf.w).b(nmf.af).a(paramAdvertisementInfo).e(a(2, 1, paramString, paramAdvertisementInfo)).a());
  }
}
