...
public class aaor
  extends Handler
{
  public aaor(TroopMemberApiService paramTroopMemberApiService) {}
  
  private void a(Bundle paramBundle)
  {
    Object localObject1 = (QQAppInterface)TroopMemberApiService.d(this.a);
    Object localObject3 = ((awmz)TroopMemberApiService.e(this.a).getManager(11)).a();
    String str1 = "";
    Object localObject2 = "";
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    {
      localObject5 = (anie)((QQAppInterface)localObject8).a(22);
      localObject6 = (anos)((QQAppInterface)localObject8).a(3);
      localObject1 = (anwd)((QQAppInterface)localObject8).a(20);
    }
          ...
          if (localObject1 != null)
          {
            ...
            if (paramMessage.obj != null)
            {
              ...
              if (localObject1 != null)
              {
                ...
                continue;
                this.a.jdField_a_of_type_Antb = new antb(((AppRuntime)localObject8).getAccount());
                continue;
                localObject1 = ((Bundle)localObject7).getString("gcode");
                localObject5 = String.valueOf(8000000);
                localObject6 = njo.a().a((String)localObject1, (String)localObject5);
                if ((!TextUtils.isEmpty((CharSequence)localObject6)) && (!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty((CharSequence)localObject5)))
                {
                  ...
                  if (QLog.isDevelopLevel())
                  {
                    ...
                    if (localObject1 != null)
                    {
                      ((anwd)localObject1).b((String)localObject5);
                      continue;
                      localObject5 = ((Bundle)localObject7).getString("troopUin");
                      localObject6 = ((Bundle)localObject7).getString("troopCode");
                      if (localObject1 != null) {
                        ((anwd)localObject1).a(true, (String)localObject5, (String)localObject6, 0);
                      }
                      if (QLog.isColorLevel())
                      {
                        ...
                        axek.a((QQAppInterface)localObject8, (String)localObject1, this.a.jdField_a_of_type_Bdzm);
                        continue;
                        ...
                        if ((localObject8 instanceof QQAppInterface))
                        {
                          ...
                          if (!axbo.a((AppInterface)localObject6, (String)localObject1))
                          {
                            l1 = bbyp.a();
                            localObject7 = ((QQAppInterface)localObject6).getCurrentAccountUin();
                            localObject5 = bcwd.a((byte[])localObject5, -1);
                            if (localObject5 != null)
                            {
                              ((AbsStructMsg)localObject5).mMsgServiceID = 98;
                              localObject8 = (MessageForStructing)bbzh.a(-2011);
                              ...
                              axbo.a((AppInterface)localObject6, (String)localObject1);
                              axbo.a((MessageRecord)localObject8, "isFaceScoreBubbleMsg", true);
                              axbo.a((MessageRecord)localObject8, "isFaceScoreSecondMember", true);
                              axbo.a.add(localObject1);
                              if (i == 1) {}
                              for (bool = true;; bool = false)
                              {
                                acwh.a((MessageRecord)localObject8, bool);
                              ...
                              localObject6 = (anno)((QQAppInterface)localObject8).a(35);
                              if (localObject6 != null)
                              {
                                localObject7 = new ArrayList();
                                ((List)localObject7).add(Long.valueOf(Long.parseLong((String)localObject5)));
                                ((anno)localObject6).a((QQAppInterface)localObject8, (String)localObject1, (List)localObject7, i);
                                continue;
                                ...
                                if (localObject1 != null)
                                {
                                  ((anwd)localObject1).a(l1, l2, l3, (String)localObject5, i, (String)localObject6, (String)localObject8, j);
                                  continue;
                                  localObject5 = ((Bundle)localObject7).getString("troopUin");
                                  if (localObject1 != null)
                                  {
                                    ((anwd)localObject1).n((String)localObject5);
                                    continue;
                                    localObject1 = ((Bundle)localObject7).getString("troopUin");
                                    bool = ((Bundle)localObject7).getBoolean("isChecked");
                                    if (localObject5 != null)
                                    {
                                      ((anie)localObject5).b((String)localObject1, bool);
                                      continue;
                                      localObject1 = ((Bundle)localObject7).getString("troopUin");
                                      bool = ((Bundle)localObject7).getBoolean("isChecked");
                                      if (localObject5 != null) {
                                        ((anie)localObject5).a((String)localObject1, bool);
                                      }
                                    }
                                  }
                                }
    ...
    case 122: 
      ...
      localObject5 = (anjx)((QQAppInterface)localObject8).a(8);
      if (localObject5 != null) {
        if (((anjx)localObject5).a((String)localObject1, 0).longValue() > 0L) {
          bool = true;
        }
      }
      break;
    ...
    for (;;)
    {
      ...
      localObject5 = ((Bundle)localObject7).getString("troopUin");
      if (localObject1 != null) {
        ((anwd)localObject1).j((String)localObject5);
      }
      if (!QLog.isDevelopLevel()) {
        break label728;
      }
      ...
      {
        ((anos)localObject6).a(((Bundle)localObject7).getString("areaName"), ((Bundle)localObject7).getInt("lat"), ((Bundle)localObject7).getInt("lon"), ((Bundle)localObject7).getInt("startIndex"), ((Bundle)localObject7).getInt("count"), ((Bundle)localObject7).getInt("iFilterId"));
        break label728;
      }
      if ("getNearbyTroops".equals(localObject1))
      {
        ((anos)localObject6).a(((Bundle)localObject7).getBoolean("isFirst"), ((Bundle)localObject7).getInt("lat"), ((Bundle)localObject7).getInt("lon"), ((Bundle)localObject7).getInt("sortType"), ((Bundle)localObject7).getString("strGroupArea"), ((Bundle)localObject7).getInt("iFilterId"));
        break label728;
      }
      if ("getAreaList".equals(localObject1))
      {
        ((anos)localObject6).a(((Bundle)localObject7).getInt("lat"), ((Bundle)localObject7).getInt("lon"), ((Bundle)localObject7).getInt("radius"), ((Bundle)localObject7).getBoolean("isClickable"));
        break label728;
      }
      if (!"getNewNearbyTroop".equals(localObject1)) {
        break label728;
      }
      ((anos)localObject6).a(((Bundle)localObject7).getInt("lat"), ((Bundle)localObject7).getInt("lon"));
      break label728;
      localObject5 = ((Bundle)localObject7).getString("troopUin");
      ...
      ((anwd)localObject1).notifyUI(144, true, new Object[] { localObject5, localObject6, Integer.valueOf(i) });
      break label728;
      localObject1 = new Bundle();
      ...
      {
        localObject6 = (baif)((AppRuntime)localObject8).getManager(36);
        if (localObject6 != null)
        {
          ...
          {
            localObject9 = ((baif)localObject6).a(localObject5[i]);
      ...
      localObject5 = (baif)((AppRuntime)localObject8).getManager(36);
      if (localObject5 == null) {
        break label728;
      }
      ((baif)localObject5).b((String)localObject1);
      break label728;
      localObject5 = ((Bundle)localObject7).getString("troopUin");
      ...
      ((anwd)localObject1).b((String)localObject5, (String)localObject6);
      break label728;
      localObject1 = new Bundle();
      ...
      {
        njo.a().a((String)localObject5, l1, i, (String)localObject6, j, "", (String)localObject7);
      ...
      ((anwd)localObject1).a(i, ((Bundle)localObject7).getString("openGroupId"), (String)localObject5, ((Bundle)localObject7).getString("url"), ((Bundle)localObject7).getInt("seq"));
      break label728;
      i = ((Bundle)localObject7).getInt("seq");
      if (this.a.jdField_a_of_type_Adeg == null) {
        this.a.jdField_a_of_type_Adeg = new adeg((AppRuntime)localObject8, this.a);
      }
      this.a.jdField_a_of_type_Adeg.a(118, (Bundle)localObject7, i);
      break label728;
      i = ((Bundle)localObject7).getInt("appid");
      localObject5 = ((Bundle)localObject7).getString("token");
      ((anwd)localObject1).a(i, ((Bundle)localObject7).getString("openId"), (String)localObject5, ((Bundle)localObject7).getInt("seq"));
      break label728;
      bool = ((Bundle)localObject7).getBoolean("isTroopAppListChanged");
      localObject1 = (bfql)((AppRuntime)localObject8).getManager(109);
      if (localObject1 == null) {
        break label728;
      }
      ((bfql)localObject1).a(bool);
      break label728;
      ...
      localObject5 = (bfql)((AppRuntime)localObject8).getManager(109);
      if (localObject5 == null) {
        break label728;
      }
      ((bfql)localObject5).a(bool, (String)localObject1);
      break label728;
      localObject5 = ((Bundle)localObject7).getString("troopUin");
      ...
      if (((String)localObject1).equals("g_homework"))
      {
        ...
        localObject1 = "";
        if (bfsj.a((QQAppInterface)localObject8, l1)) {
      ...
      bftt.a((QQAppInterface)localObject8, this.a, (String)localObject5, true);
      break label728;
      ...
      break label728;
      if (TroopMemberApiService.a((AppRuntime)localObject8, new aaos(this, (Bundle)localObject7))) {
        break label728;
      }
      this.a.a(16, (Bundle)localObject7);
      break label728;
      l1 = ((Bundle)localObject7).getLong("uiResId");
      localObject1 = ajvi.a().a(l1);
      if ((localObject1 != null) && (((arcs)localObject1).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo != null))
      {
        ((Bundle)localObject7).putString("packageName", ((arcs)localObject1).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.strPkgName);
        ((Bundle)localObject7).putString("imageUrl", ((arcs)localObject1).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.strResURL);
        ((Bundle)localObject7).putString("name", ((arcs)localObject1).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.strResName);
        if (((arcs)localObject1).jdField_a_of_type_Byte == 0)
        {
          bool = true;
          label3241:
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          localObject9 = (anwd)((QQAppInterface)localObject8).a(20);
          if (localObject9 != null) {
            ((anwd)localObject9).j((String)localObject5);
          }
          ...
          localObject1 = bfsj.a((QQAppInterface)localObject8, l1, null, (String)localObject1, (String)localObject5, l2, i);
          ...
          TroopMemberApiService.a(this.a, (QQAppInterface)localObject8, l1, HWTroopFileStatusInfo.parse((bety)localObject1), (Bundle)localObject5);
          break;
          if ((!(localObject8 instanceof QQAppInterface)) || (localObject7 == null)) {
            break;
          }
          if (this.a.jdField_a_of_type_Txn == null) {
            this.a.jdField_a_of_type_Txn = new txn(this.a, (QQAppInterface)localObject8);
          }
          if (((Bundle)localObject7).getBoolean("is_pic_or_voice"))
          {
            this.a.jdField_a_of_type_Txn.a((Bundle)localObject7);
            break;
          }
          this.a.jdField_a_of_type_Txn.c((Bundle)localObject7);
          break;
          if ((!(localObject8 instanceof QQAppInterface)) || (localObject7 == null)) {
            break;
          }
          ...
          if (((Bundle)localObject7).getBoolean("is_pic_or_voice"))
          {
            this.a.jdField_a_of_type_Txn.b((Bundle)localObject7);
            break;
          }
          this.a.jdField_a_of_type_Txn.d((Bundle)localObject7);
          break;
          if (this.a.jdField_a_of_type_Txn == null) {
            break;
          }
          this.a.jdField_a_of_type_Txn.a();
          break;
          ...
          if ((((bfql)localObject1).a(0)) && (!((bfql)localObject1).b(0)))
          {
            localObject6 = ((bfql)localObject1).a(false, 0);
            if ((localObject6 != null) && (!((List)localObject6).isEmpty()))
            {
              ...
              while (((Iterator)localObject6).hasNext())
              {
                ...
                {
                  QQToast.a(BaseApplication.getContext(), 2, 2131718679, 0).b(this.a.getResources().getDimensionPixelSize(2131298998));
                  return;
                }
              }
            }
            ...
            ((bfql)localObject1).a((ArrayList)localObject5, (ArrayList)localObject6);
            break;
          }
          this.a.jdField_a_of_type_Boolean = true;
          ((bfql)localObject1).a(true, 0);
          break;
          ...
          ((avlj)((QQAppInterface)localObject8).getManager(108)).a(this.a, l1, (String)localObject1, (String)localObject6, (String)localObject5, i);
          break;
          ...
          aviu.a((QQAppInterface)localObject8, (String)localObject1, (String)localObject5, (String)localObject6, "web", (String)localObject9, str2, (String)localObject7);
          break;
          localObject1 = ((Bundle)localObject7).getString("pluginPackageName");
          localObject5 = ((Bundle)localObject7).getString("appType");
          avil.a(((QQAppInterface)localObject8).getApp(), (String)localObject1, (String)localObject5).a();
          break;
          try
          {
        ...
        for (;;)
        {
          for (;;)
          {
            for (;;)
            {
              ...
              bfpj.a(this.a, (String)localObject2, (String)localObject5);
              break label728;
              localObject2 = ((Bundle)localObject7).getString("troopUin");
              ...
              bftt.jdField_a_of_type_Int = ((Bundle)localObject7).getInt("imageMaxWidthPixels", 1080);
              bftt.b = ((Bundle)localObject7).getInt("imageMaxHeightPixels", 1920);
              ((bftt)((AppRuntime)localObject8).getManager(152)).a((String)localObject2, i, (String)localObject5, (String)localObject6, j);
              break label728;
              ((anwd)localObject2).a(((Bundle)localObject7).getLong("troopUin"), ((Bundle)localObject7).getInt("flag"));
              break label728;
              ...
              localObject5 = ((bftt)((AppRuntime)localObject8).getManager(152)).a((String)localObject2, (String)localObject5);
              localObject2 = "";
              if (localObject5 != null) {
              ...
              ((TroopPluginManager)localObject5).a("troop_manage_plugin.apk", new aaou(this, (anwd)localObject2, (String)localObject6, i, (String)localObject7));
              break label728;
              ...
              break label728;
              ((anwd)localObject2).a(((Bundle)localObject7).getString("troopUin"), "", ((Bundle)localObject7).getInt("statOption"), ((Bundle)localObject7).getString("authKey"), null, null, null);
              break label728;
              ...
              localObject5 = ((bhhh)((AppRuntime)localObject8).getManager(47)).a(1);
              localObject6 = new File(axcc.jdField_a_of_type_JavaLangString + File.separator + "nearby_heart.mp4");
              if (!((File)localObject6).exists()) {
                ((File)localObject6).mkdirs();
              }
              for (;;)
              {
                ((bhhk)localObject5).a(new bhhf("https://pub.idqqimg.com/pc/misc/nearby/nearby_heart.gif", (File)localObject6), new aaov(this, (Bundle)localObject2), new Bundle());
                break;
              ...
              if ((localObject8 instanceof QQAppInterface))
              {
                localObject6 = (bfps)((AppRuntime)localObject8).getManager(224);
                if (localObject6 != null)
                {
                  localObject5 = ((bfps)localObject6).a();
                  localObject6 = ((bfps)localObject6).b();
              ...
              bool = bcls.a((QQAppInterface)localObject8, BaseApplicationImpl.getContext());
              if (!QLog.isColorLevel()) {
                break label728;
              }
              ...
              break label728;
              localObject2 = (sfz)((AppRuntime)localObject8).getManager(226);
              ((sfz)localObject2).a(this.a);
              ((sfz)localObject2).a(((Bundle)localObject7).getString("videoPath"), (Bundle)localObject7);
              break label728;
              i = ((Bundle)localObject7).getInt("subCmd");
              localObject2 = (bevb)((QQAppInterface)localObject8).getManager(231);
              switch (i)
              {
              }
              for (;;)
              {
                ...
                break;
                ((bevb)localObject2).a(((Bundle)localObject7).getInt("effectId"), ((Bundle)localObject7).getString("effectName"), ((Bundle)localObject7).getInt("svipLevel"), ((Bundle)localObject7).getInt("svipType"));
                continue;
                localObject5 = ((Bundle)localObject7).getStringArrayList("statusList");
                if (localObject5 != null) {
                  ((bevb)localObject2).a((ArrayList)localObject5);
                }
              }
              localObject2 = ((Bundle)localObject7).getString("troopUin");
              ...
              new alvu((Intent)localObject6).execute(new Void[0]);
              this.a.a(87, (Bundle)localObject7);
              break label728;
              ...
              ((avju)((AppRuntime)localObject8).getManager(306)).a((Bundle)localObject2);
              break label728;
              ((avju)((AppRuntime)localObject8).getManager(306)).a();
              break label728;
              ...
              if (bool)
              {
                VideoEnvironment.a("TroopMemberApiService", anni.a(2131714317), null);
                ShortVideoResourceManager.b((QQAppInterface)localObject8, new aaow(this, (AppRuntime)localObject8, (Bundle)localObject7));
                break label728;
              }
              ...
              ((avhx)((AppRuntime)localObject8).getManager(236)).a(this.a, (String)localObject2, ((QQAppInterface)localObject8).getCurrentAccountUin(), i, (String)localObject5, (String)localObject6, (String)localObject9, str2, (String)localObject7);
              break label728;
              ((Bundle)localObject7).getString("fromId");
              ((avhx)((AppRuntime)localObject8).getManager(236)).a(null, 10L);
              break label728;
              localObject2 = ((Bundle)localObject7).getString("uin");
              i = ((Bundle)localObject7).getInt("index");
              localObject2 = nuu.a().a((String)localObject2);
              if (localObject2 == null) {
                break label728;
              }
              localObject5 = (nuy)((AppRuntime)localObject8).getManager(238);
              if (localObject5 == null) {
                break label728;
              }
              ((nuy)localObject5).a((nuk)localObject2, i);
              break label728;
              ...
              localObject7 = (anno)((QQAppInterface)localObject8).a(35);
              if (localObject7 == null) {
                break label728;
              }
              ((anno)localObject7).a((String)localObject2, (String)localObject5, (String)localObject6);
              break label728;
              localObject2 = ((Bundle)localObject7).getString("troopCode");
              localObject5 = ((Bundle)localObject7).getString("uin");
              localObject6 = (anno)((QQAppInterface)localObject8).a(35);
              ...
              ((anno)localObject6).a((String)localObject2, (String)localObject5);
              break label728;
              localObject2 = ((Bundle)localObject7).getString("troopCode");
              localObject5 = (anno)((QQAppInterface)localObject8).a(35);
              if (localObject5 == null) {
                break label728;
              }
              ((anno)localObject5).a((String)localObject2);
              break label728;
              localObject2 = ((Bundle)localObject7).getString("troopCode");
              localObject5 = ((Bundle)localObject7).getString("uin");
              localObject6 = ((Bundle)localObject7).getString("nick");
              ...
              ((anno)localObject7).b((String)localObject2, (String)localObject5, (String)localObject6);
              break label728;
              localObject2 = ((Bundle)localObject7).getString("troopCode");
              localObject5 = ((Bundle)localObject7).getString("uin");
              localObject6 = (anno)((QQAppInterface)localObject8).a(35);
              ...
              ((anno)localObject6).b((String)localObject2, (String)localObject5);
              break label728;
              ((Bundle)localObject7).getString("troopCode");
              localObject2 = ((Bundle)localObject7).getString("rid");
              localObject5 = new aaoy(this, (Bundle)localObject7);
              this.a.jdField_a_of_type_Anoe = new anoe((QQAppInterface)localObject8, (anof)localObject5, (String)localObject2);
              this.a.jdField_a_of_type_Anoe.b(10000L);
              break label728;
              ...
              ((anno)localObject5).a((ArrayList)localObject2);
              break label728;
              localObject2 = ((Bundle)localObject7).getString("schoolName");
              i = ((Bundle)localObject7).getInt("isValid");
              localObject5 = (axeq)((QQAppInterface)localObject8).a(60);
              if (localObject5 == null) {
                break label728;
              }
              ((axeq)localObject5).a((String)localObject2, i);
              break label728;
              localObject2 = ((Bundle)localObject7).getStringArrayList("preloadList");
              localObject5 = (nxo)((AppRuntime)localObject8).getManager(248);
              if (localObject5 == null) {
                break label728;
              }
              ((nxo)localObject5).a((ArrayList)localObject2);
              break label728;
              localObject2 = (nxo)((AppRuntime)localObject8).getManager(248);
              if (localObject2 == null) {
                break label728;
              }
              ((nxo)localObject2).a();
              ...
              pmh.a().d(i, j);
              break label728;
              ((Bundle)localObject7).putInt("readinjoy_to_wx_config", bmqa.t((AppRuntime)localObject8));
              this.a.a(113, (Bundle)localObject7);
              break label728;
              if (this.a.jdField_a_of_type_Pzq == null) {
                this.a.jdField_a_of_type_Pzq = new pzq((AppRuntime)localObject8, this.a);
              }
              this.a.jdField_a_of_type_Pzq.b((Bundle)localObject7);
              break label728;
              ((wff)((QQAppInterface)localObject8).a(98)).c(((Bundle)localObject7).getInt("reqUserSetEnableAlbumScan"));
              break label728;
              if (this.a.jdField_a_of_type_Pzq == null) {
                this.a.jdField_a_of_type_Pzq = new pzq((AppRuntime)localObject8, this.a);
              }
              this.a.jdField_a_of_type_Pzq.c((Bundle)localObject7);
              break label728;
              if (this.a.jdField_a_of_type_Pzq == null) {
                this.a.jdField_a_of_type_Pzq = new pzq((AppRuntime)localObject8, this.a);
              }
              this.a.jdField_a_of_type_Pzq.d((Bundle)localObject7);
              break label728;
              if (this.a.jdField_a_of_type_Pzq == null) {
                this.a.jdField_a_of_type_Pzq = new pzq((AppRuntime)localObject8, this.a);
              }
              this.a.jdField_a_of_type_Pzq.a((Bundle)localObject7);
              break label728;
              ...
              if ((!TextUtils.isEmpty((CharSequence)localObject5)) && ("group".equals(localObject6)))
              {
                ...
                ((anwd)localObject2).a((String)localObject5, false, "TroopMemberApiService111", true, true, false, false);
                break label728;
              }
              if (QLog.isColorLevel()) {
              ...
              localObject2 = afur.a((Intent)localObject2, null);
              ...
              bddu.a(((Bundle)localObject7).getBundle("reportData"));
              break label728;
              if (QLog.isColorLevel()) {
              ...
              ((bdcs)((AppRuntime)localObject8).getManager(362)).a(BaseApplicationImpl.getContext());
              break label728;
              if (QLog.isColorLevel()) {
              ...
              if ((TextUtils.isEmpty((CharSequence)localObject2)) || (!String.valueOf(1104445552).equals(localObject5)) || (bfpj.a((QQAppInterface)localObject8, (String)localObject2) == 0)) {
                break label728;
              }
              bfpj.a((QQAppInterface)localObject8, (String)localObject2);
              break label728;
              ...
              localObject8 = (bhlt)((AppRuntime)localObject8).getManager(290);
              if (localObject8 != null)
              {
                ((bhlt)localObject8).a((String)localObject5, i, j, (String)localObject6, (String)localObject9, str2, (String)localObject7, new aaoz(this, k, (String)localObject2));
                break label728;
              }
              localObject5 = new Bundle();
              ...
              try
              {
                localObject2 = (bhlt)((AppRuntime)localObject8).getManager(290);
                if (localObject2 == null) {
                  break label8025;
                }
                ((bhlt)localObject2).a((Bundle)localObject7);
              }
            ...
            break label728;
            Object localObject3 = (bhlt)((AppRuntime)localObject8).getManager(290);
            ...
            if (localObject3 != null)
            {
              ((bhlt)localObject3).a((String)localObject5, (String)localObject6, (String)localObject8, new aaot(this, i, (String)localObject7));
              break label728;
            }
            ...
            for (localObject3 = BaseActivity.sTopActivity;; localObject4 = this.a.getApplicationContext())
            {
              for (;;)
              {
                ...
                try
                {
                  ...
                  localObject5 = ohp.a((Context)localObject3, i);
                  if (i == 16)
                  {
            ...
            label8436:
            localObject5 = (QQAppInterface)localObject8;
            if (bmqa.a((QQAppInterface)localObject5))
            {
              ohp.a((QQAppInterface)localObject5, (Context)localObject4, 2, 0);
              break label728;
            }
            ohp.a((Context)localObject4, null, -1L, 2);
            break label728;
            i = ((Bundle)localObject7).getInt("seq");
            localObject4 = (QQAppInterface)localObject8;
            localObject5 = ((anmw)((AppRuntime)localObject8).getManager(51)).b(((QQAppInterface)localObject4).c());
            if (localObject5 != null)
            {
              if (QLog.isColorLevel()) {
            ...
            localObject4 = bedn.a(this.a.getApplicationContext(), (QQAppInterface)localObject8, i, j, k);
            ...
            bedn.a((QQAppInterface)localObject8, (String)localObject4, i, j);
            break label728;
            i = ((Bundle)localObject7).getInt("deleteType");
            localObject4 = ((Bundle)localObject7).getString("uin");
            j = ((Bundle)localObject7).getInt("msgType");
            bedn.b((QQAppInterface)localObject8, (String)localObject4, i, j);
            break label728;
            bool = ((Bundle)localObject7).getBoolean("isSuccess");
            localObject4 = ((Bundle)localObject7).getString("pkgname");
            pmk.a().a(null, 101, bool, new String[] { localObject4 });
            break label728;
            localObject4 = oqz.a(2);
            if ((localObject4 == null) || (!(localObject4 instanceof omt))) {
              break label728;
            }
            ((omt)localObject4).a((Bundle)localObject7);
            break label728;
            oqj.a();
            break label728;
            ...
            break label728;
            localObject4 = ((Bundle)localObject7).getString("uin");
            aajj.c(BaseApplicationImpl.getContext(), (String)localObject4, null);
            break label728;
            ...
            try
            {
              ...
              if (this.a.jdField_a_of_type_Anjh == null)
              {
                this.a.jdField_a_of_type_Anjh = ((anjh)((AppRuntime)localObject8).getManager(59));
                this.a.jdField_a_of_type_Anjh.a(this);
              }
              ...
              ((Intent)localObject5).putExtra("param_location_param", this.a.jdField_a_of_type_Anjh.b((String[])localObject4));
          ...
          ((bfgp)((AppRuntime)localObject8).getManager(346)).a((String)localObject4, bool);
          break label728;
          ...
          for (;;)
          {
            bfqq.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), BaseApplicationImpl.getContext(), (BaseActivity)localObject4, (SessionInfo)localObject7, Long.parseLong(str1), (String)localObject6, 1, 0);
            break;
            localObject4 = this.a.getApplicationContext();
            break label9379;
            short s = ((Bundle)localObject7).getShort("tmpPushType");
            ((Bundle)localObject7).putBoolean("enable", ((awhm)((AppRuntime)localObject8).getManager(303)).a(s));
            ...
            ((awhm)((AppRuntime)localObject8).getManager(303)).a(s, bool, true);
