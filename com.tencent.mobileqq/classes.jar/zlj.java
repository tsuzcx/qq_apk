...
{
  private zlj(QQAppInterface paramQQAppInterface) {}
  ...
  public void onNetMobile2None()
  {
    ...
    if (localMqqHandler != null) {
      localMqqHandler.obtainMessage(10001, QQAppInterface.a(this.a).getString(2131433009)).sendToTarget();
    }
  ...
  public void onNetWifi2None()
  {
    ...
    localMqqHandler = this.a.getHandler(Conversation.class);
    if (localMqqHandler != null) {
      localMqqHandler.obtainMessage(10001, QQAppInterface.b(this.a).getString(2131433009)).sendToTarget();
    }
    localMqqHandler = this.a.getHandler(ChatHistoryForC2C.class);
    if (localMqqHandler != null) {
      localMqqHandler.obtainMessage(28, null).sendToTarget();
