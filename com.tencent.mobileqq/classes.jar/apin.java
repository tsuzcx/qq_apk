  ...
  extends aphp
{
  ...
  public apin(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  private String a(String paramString, long paramLong)
  {
    ...
    for (;;)
    {
      return this.jdField_a_of_type_AndroidContentContext.getString(2131626939) + paramString + "\n" + this.jdField_a_of_type_AndroidContentContext.getString(2131626956) + (String)localObject;
  ...
  {
    bafb localbafb = new bafb(this.jdField_a_of_type_AndroidAppActivity, 2131690181);
    ...
    localbafb.setNegativeButton(this.jdField_a_of_type_AndroidContentContext.getString(2131625011), new apio(this));
  ...
  protected String a(Uri paramUri)
  {
    ...
    if (this.jdField_a_of_type_Aqbr == null) {
      this.jdField_a_of_type_Aqbr = new aqbr(this.jdField_a_of_type_AndroidAppActivity, true, new apiq(this));
    }
    return this.jdField_a_of_type_Aqbr.a(paramUri);
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 102)
    {
      ...
      {
        bbmy.a(this.jdField_a_of_type_AndroidAppActivity, ajjy.a(2131638961), 2000).a();
    ...
    if ((localObject != null) && (((ArrayList)localObject).size() > 0))
    {
      ...
      aecw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, localArrayList, paramIntent);
    }
    this.jdField_a_of_type_AndroidAppActivity.finish();
  }
  ...
  protected void a(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      paramString2 = ((xrh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(paramString2));
      ...
      bgnd.a().a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), (Intent)localObject, "com.tencent.device.activities.LightPinterOptionActivity", 102, null, SmartDevicePluginProxyActivity.class);
      return;
    }
  ...
  protected boolean a(Uri paramUri)
  {
    ...
    if (TextUtils.isEmpty(str))
    {
      if (this.jdField_a_of_type_Aqbr != null)
      {
        paramUri = this.jdField_a_of_type_Aqbr;
        h = aqbr.jdField_a_of_type_JavaLangString;
      }
      f(e());
      return false;
    }
    ...
    if (this.jdField_a_of_type_Aqbr != null)
    {
      bool1 = this.jdField_a_of_type_Aqbr.jdField_a_of_type_Boolean;
      if (this.jdField_a_of_type_Aqbr == null) {
        break label143;
      }
      bool2 = this.jdField_a_of_type_Aqbr.b;
    }
    for (;;)
    {
      if ((!bool1) && (!bool2) && (l == 0L))
      {
        ...
        {
          f(this.jdField_a_of_type_AndroidContentContext.getString(2131626943));
          return false;
          bool1 = false;
          break;
          label143:
        ...
        f(this.jdField_a_of_type_AndroidContentContext.getString(2131626918));
        return false;
      }
    }
    ...
    {
      paramUri = new bafb(this.jdField_a_of_type_AndroidAppActivity, 2131690181);
      paramUri.setContentView(2131493345);
      paramUri.setTitle(this.jdField_a_of_type_AndroidContentContext.getString(2131654355));
      paramUri.setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131626920));
      paramUri.setCanceledOnTouchOutside(false);
      paramUri.setCancelable(false);
      paramUri.setNegativeButton(this.jdField_a_of_type_AndroidContentContext.getString(2131625011), new apip(this));
      paramUri.show();
      return false;
    }
  ...
  protected boolean c()
  {
    ...
    if (this.jdField_a_of_type_AndroidOsBundle.getInt("uintype") == 1008)
    {
      ...
      localIntent.putExtra("chat_subType", ncw.a(this.jdField_a_of_type_AndroidOsBundle.getString("uin"), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("sendMultiple", false))
      {
        this.jdField_a_of_type_AndroidOsBundle.putString("leftBackText", ajjy.a(2131638967));
