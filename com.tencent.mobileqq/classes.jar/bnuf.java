...
public class bnuf
{
  private static String jdField_a_of_type_JavaLangString = bnuf.class.getSimpleName();
  private double jdField_a_of_type_Double = 1.0D;
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private SurfaceTexture jdField_a_of_type_AndroidGraphicsSurfaceTexture;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private bnrf jdField_a_of_type_Bnrf = new bnrf();
  ...
  public bnuf(String paramString, List<List<List<PointF>>> paramList, List<List<float[]>> paramList1, double paramDouble)
  {
  ...
  public void a(bnug parambnug)
  {
    this.jdField_a_of_type_Long = System.currentTimeMillis();
    this.jdField_b_of_type_JavaLangString = (bndp.jdField_b_of_type_JavaLangString + File.separator + System.currentTimeMillis());
    try
    {
