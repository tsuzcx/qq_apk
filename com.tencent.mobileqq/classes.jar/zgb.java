  ...
  extends Drawable
{
  ...
  public zgb(int paramInt1, int paramInt2)
  {
    this(null, paramInt1, paramInt2);
  }
  
  public zgb(Bitmap paramBitmap, int paramInt1, int paramInt2)
  {
    ykq.c("Q.qqstory.record.StoryFaceDrawable", "StoryFaceDrawable.");
    this.jdField_a_of_type_Int = paramInt1;
    this.b = paramInt2;
    setBounds(0, 0, paramInt1, paramInt2);
    if (paramBitmap == null) {}
    for (this.jdField_a_of_type_AndroidGraphicsBitmap = bheg.a();; this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap)
    {
  ...
  {
    ykq.c("Q.qqstory.record.StoryFaceDrawable", "StoryFaceDrawable draw start.");
    paramCanvas.drawBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_a_of_type_AndroidGraphicsMatrix, null);
    ykq.c("Q.qqstory.record.StoryFaceDrawable", "StoryFaceDrawable draw end.");
  }
