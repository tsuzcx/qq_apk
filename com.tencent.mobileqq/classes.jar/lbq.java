  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      try
      {
        ...
        paramFromServiceMsg = yxo.a((PBField)localObject);
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg != JSONObject.NULL))
        {
          ...
          notifyObserver(paramIntent, 1, true, (Bundle)localObject, lbr.class);
          return;
        }
        notifyObserver(paramIntent, 1, false, null, lbr.class);
        return;
      }
