...
public class bmbw
{
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        bdkl.a(paramQQAppInterface, "sendtdbank|b_sng_qqvip_qqcomic|soDownload", "1|" + a + "|0", true);
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (bhto.a(a() + "libQGamePlayer.zip", a(), "libqgplayer_841.so")) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        long l2 = a;
        bdkl.a(paramQQAppInterface, "sendtdbank|b_sng_qqvip_qqcomic|soDownload", "2|" + (l1 - l2) + "|" + paramInt, true);
        return;
      }
      catch (Throwable paramQQAppInterface)
      {
