  ...
  extends ahzi
{
  ...
  public ahrc(PhoneContactTabView paramPhoneContactTabView, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      localView = ahrj.a(paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_AndroidViewLayoutInflater, 2131493296);
    }
    paramView = (ahrj)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      ...
      ahrj.a(this, paramView, paramViewGroup);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberPhoneContactTabView.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(paramView.jdField_a_of_type_JavaLangString))
      {
        ...
        if ((AppSetting.c) && (paramView.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
        {
          ...
          localView.setContentDescription(paramViewGroup.name + ajjy.a(2131642206));
        }
      }
      for (;;)
      {
        ...
        break;
        label265:
        localView.setContentDescription(paramViewGroup.name + ajjy.a(2131642204));
      }
    }
