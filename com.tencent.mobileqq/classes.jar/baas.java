...
public class baas
{
  ...
  public baas(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
  ...
  private bbwz a()
  {
    return ((bbww)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(47)).a(1);
  }
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    String str = mzh.b(this.jdField_a_of_type_JavaLangString);
    boolean bool2;
    ...
    for (;;)
    {
      baav localbaav = new baav(this, str, bool2, bool1);
      if (!TextUtils.isEmpty(str)) {
        ThreadManager.post(new SoLibraryChecker.4(this, paramJSONObject, str, localbaav), 8, null, false);
      }
      return;
      if ((i == 3) || (i == 2))
      {
  ...
  private boolean a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(mzh.b(str2)))
        {
          paramBoolean2 = false;
          continue;
        }
      ...
      else if (paramBoolean2)
      {
        ...
        if (((File)localObject).exists())
        {
          ...
          if (!paramBoolean2) {
            paramBoolean1 = bbdx.b(paramString, str2);
          }
        }
        else
        {
  ...
  private void b()
  {
    ...
    {
      mzb.a = bool;
      String str = mzb.a(this.jdField_a_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
        QLog.d("SoLibraryLoader", 2, "checkSoUpdate version = " + str);
      }
      if ((!new File(mzh.a(this.jdField_a_of_type_JavaLangString) + this.jdField_a_of_type_JavaLangString + "/" + this.b).exists()) && (!TextUtils.isEmpty(str)) && (!"0".equals(str))) {
        bbdx.a(mzh.a(this.jdField_a_of_type_JavaLangString) + this.jdField_a_of_type_JavaLangString);
      }
    ...
    mzb.a(this.jdField_a_of_type_JavaLangString, localQQAppInterface, new baat(this), false);
  }
  ...
  private void c()
  {
    ...
    long l = System.currentTimeMillis();
    if ((!mzb.a(BaseApplicationImpl.getContext(), str, new baau(this, l))) && (QLog.isColorLevel())) {
