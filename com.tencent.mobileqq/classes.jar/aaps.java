  ...
  extends WebViewClient
{
  ...
  private aaps(AbsBaseWebViewActivity paramAbsBaseWebViewActivity) {}
  ...
  protected WebResourceResponse a(WebView paramWebView, String paramString)
  {
    ...
    if (paramString.startsWith("mqqpa://resourceid/")) {
      localObject1 = uta.a(paramString);
    }
  ...
  public void onDetectedBlankScreen(String paramString, int paramInt)
  {
    ...
    this.b.jdField_a_of_type_Bihv.a(paramString, paramInt);
  }
  ...
  public void onPageFinished(WebView paramWebView, String paramString)
  {
    if ((!this.b.c) && (!this.b.isFinishing()))
    {
      ...
      if ((Build.VERSION.SDK_INT >= 19) && (!this.b.c) && (this.b.jdField_a_of_type_Ofz != null))
      {
        paramString = paramWebView.getTitle();
        this.b.jdField_a_of_type_Ofz.onReceivedTitle(paramWebView, paramString);
      }
      afoe.b(this.b.getIntent());
      return;
    }
  ...
  public void onReceivedSslError(WebView paramWebView, SslErrorHandler paramSslErrorHandler, SslError paramSslError)
  {
    if ((!this.b.c) && (!this.b.isFinishing()))
    {
      ...
      {
        QLog.e("WebLog_WebViewBase", 1, paramWebView + ", pageUrl=" + nwo.b(str, new String[0]));
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("WebLog_WebViewBase", 2, "shouldOverrideUrlLoading:" + nwo.b(paramString, new String[0]));
    }
    ...
    try
    {
      if (("http".equals(paramString)) || ("https".equals(paramString)))
      {
        ...
        if ((localObject != null) && (((WebView.HitTestResult)localObject).getType() == 0))
        {
          ...
          this.b.jdField_a_of_type_Bihv.e(str);
        }
      }
      ...
      else
      {
        ...
        if ((this.b.isResume()) && ((System.currentTimeMillis() - this.b.e < 1000L) || (this.b.jdField_a_of_type_Nro.a(paramWebView.getUrl(), str).booleanValue())))
        {
