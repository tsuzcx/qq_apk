  ...
  implements DialogInterface.OnClickListener, QQPermissionCallback
{
  ...
  private static final String[] jdField_b_of_type_ArrayOfJavaLangString = { ajjy.a(2131635981), "QQ使用电话权限确定本机号码和设备ID，以保证帐号登录的安全性。QQ不会拨打其他号码或终止通话。\n请在设置中开启电话权限或存储空间，以正常使用QQ功能。" };
  ...
  private void a(AppActivity paramAppActivity, int paramInt)
  {
    ...
    awqx.a(null, "dc00898", "", "", str1, str1, paramInt, 0, "", "", str2, "");
  }
  ...
  public void a()
  {
    ...
    abcr localabcr = new abcr(this);
    bafb localbafb = babr.a(this.jdField_a_of_type_MqqAppAppActivity, 230);
    String str1 = ajjy.a(2131644418);
    if (i > 1) {}
    for (i = 2131628395;; i = 2131628394)
    {
      String str2 = ajjy.a(i);
      localbafb.setTitle(str1);
      localbafb.setMessage(str2);
      localbafb.setNegativeButton(ajjy.a(2131628393), localabcr);
      localbafb.setPositiveButton(ajjy.a(2131628392), localabcr);
      localbafb.show();
      return;
    }
  }
  
  public void a(abcs paramabcs)
  {
    this.jdField_a_of_type_Abcs = paramabcs;
  }
  ...
  public boolean a(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (ajop.a(0)))
    {
      paramAppActivity = new abcq(this);
      ajop.a(this.jdField_a_of_type_MqqAppAppActivity, "", paramAppActivity, paramAppActivity).show();
      return false;
    }
  ...
  {
    if (this.jdField_a_of_type_Abcs != null) {
      this.jdField_a_of_type_Abcs.b();
    }
