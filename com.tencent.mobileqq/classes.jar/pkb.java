  ...
  extends ImageBase
{
  ...
  public pkb(VafContext paramVafContext)
  {
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_Pvb.a.a() == null) || (this.jdField_a_of_type_Pvb.a.a().mSocialFeedInfo == null) || (this.jdField_a_of_type_Pvb.a.a().mSocialFeedInfo.a == null))
    {
    ...
    int j = localResources.getDisplayMetrics().widthPixels - actn.a(24.0F, localResources);
    int k = (int)(j * 0.598F);
    float f1 = localResources.getDisplayMetrics().density;
    int i;
    float f2;
    ViewGroup.LayoutParams localLayoutParams;
    if (this.jdField_a_of_type_Pvb.a.a().mSocialFeedInfo.a.a.size() > 0)
    {
      i = ((qde)this.jdField_a_of_type_Pvb.a.a().mSocialFeedInfo.a.a.get(0)).a;
      int m = ((qde)this.jdField_a_of_type_Pvb.a.a().mSocialFeedInfo.a.a.get(0)).b;
      f2 = actn.a(i / 2, localResources);
      f1 = actn.a(m / 2, localResources);
      i = ((qde)this.jdField_a_of_type_Pvb.a.a().mSocialFeedInfo.a.a.get(0)).c;
    ...
    for (;;)
    {
      ...
      if ((f2 < j) && (f1 > k))
      {
        ...
        {
          f1 = k;
          f2 = actn.a(150.0F, localResources);
          this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131718585);
        }
        else
        {
          f2 *= k / f1;
      ...
      else if ((f2 > j) && (f1 < k))
      {
        ...
        {
          f2 = j;
          f1 = actn.a(150.0F, localResources);
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131718586);
          this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        }
        else
        {
