...
{
  public afgt(SubLoginActivity paramSubLoginActivity) {}
  ...
  public void onGetKeyBack(String paramString1, String paramString2, String paramString3)
  {
    ...
    else
    {
      ...
      this.a.e();
      this.a.b(this.a.getString(2131718313));
    ...
    for (;;)
    {
      ...
      if (!SubLoginActivity.a(this.a))
      {
        ...
        bddy.a(this.a.app, (byte)1, paramString2);
        bddy.a(this.a.app, paramString2, 7);
        bddx.b(this.a.app);
        bddx.a(this.a.app);
        this.a.setTitle("");
        bddx.a(this.a.app, this.a, paramString2);
        this.a.finish();
      }
  ...
  public void onLoginFailed(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(this.a.app.getCurrentAccountUin(), "actSBLogin", false, 0L, 0L, paramString2, "");
      ...
      try
      {
        ...
        {
          this.a.b(this.a.getString(2131693946));
          return;
      ...
      catch (Exception paramString1)
      {
        ...
        this.a.b(this.a.getResources().getString(2131717436), paramString4, null);
      }
    }
  }
  ...
  public void onLoginTimeout(String paramString1, String paramString2, String paramString3)
  {
    ...
    paramString1.put("fail_location", "subLogin");
    bctj.a(BaseApplication.getContext()).a(this.a.app.getCurrentAccountUin(), "actSBLogin", false, 0L, 0L, paramString1, "");
    if (!this.a.getActivity().isFinishing()) {}
    try
    {
      this.a.e();
