  ...
  extends aqbc
{
  ...
  public aqeh(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  {
    if (!this.i) {}
    for (this.jdField_a_of_type_JavaLangString = ajyc.a(2131704770);; this.jdField_a_of_type_JavaLangString = null)
    {
  ...
  protected void b()
  {
    this.jdField_a_of_type_Bbgg.setMessageWithEmo(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Float);
    TextView localTextView = this.jdField_a_of_type_Bbgg.getMessageTextView();
  ...
  public void v()
  {
    ...
    if (bool)
    {
      localObject1 = actn.a((Intent)localObject2, null);
    ...
    label288:
    bgpr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "User_BatchForwardSendBtnClick", 0, 0, localArrayList.size());
  }
}
