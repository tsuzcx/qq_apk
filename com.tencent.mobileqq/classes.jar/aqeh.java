...
public class aqeh
{
  ...
  private ArrayList<WeakReference<aqej>> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public aqeh(AppInterface paramAppInterface)
  {
  ...
  private boolean a()
  {
    ...
    {
      aqeg localaqeg = ((aqeq)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.DYNAMIC_AVATAR_MANAGER)).a();
      if (this.jdField_a_of_type_Int + 1 > localaqeg.b)
      {
          ...
          if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              if ((localWeakReference != null) && (localWeakReference.get() != null)) {
                ((aqej)localWeakReference.get()).a(paramString, false, false);
              }
            }
          }
        }
      ...
      synchronized (this.jdField_a_of_type_JavaUtilArrayList)
      {
        if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
        {
          ...
          while (localIterator.hasNext())
          {
            WeakReference localWeakReference = (WeakReference)localIterator.next();
            if ((localWeakReference != null) && (localWeakReference.get() != null)) {
              ((aqej)localWeakReference.get()).a(paramString, true, true);
            }
          }
        }
      }
  ...
  public final void a()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((localNetReq != null) && (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)) {
        this.jdField_a_of_type_ComTencentCommonAppAppInterface.getNetEngine(0).cancelReq(localNetReq);
      }
    }
  ...
  public void a(aqej paramaqej)
  {
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilArrayList)
      {
        ...
        {
          WeakReference localWeakReference = (WeakReference)localIterator.next();
          if ((localWeakReference == null) || (localWeakReference.get() == null) || (localWeakReference.get() != paramaqej)) {
            continue;
          }
          i = 1;
          if (i == 0) {
            this.jdField_a_of_type_JavaUtilArrayList.add(new WeakReference(paramaqej));
          }
          return;
        }
      }
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      localHttpNetReq.mCallback = new aqei(this);
