  ...
  implements Handler.Callback
{
  ...
  private awhf jdField_a_of_type_Awhf;
  private int b;
  private int c;
  
  public awhe(int paramInt1, int paramInt2)
  {
  ...
  private boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Awhf != null) {
        this.jdField_a_of_type_Awhf.a(this.jdField_a_of_type_Awhf, bool2, i * j, this.c);
      }
      this.c += 1;
      return true;
      label179:
  ...
  public void a(awhf paramawhf)
  {
    this.jdField_a_of_type_Awhf = paramawhf;
  }
