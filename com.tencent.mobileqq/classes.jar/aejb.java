...
class aejb
  implements Runnable
{
  aejb(aeja paramaeja, VideoFeedsUploader.UploadInfo paramUploadInfo, VideoFeedsUploader.UploadResult paramUploadResult) {}
  
  public void run()
  {
    NearbyMomentManager localNearbyMomentManager = (NearbyMomentManager)this.jdField_a_of_type_Aeja.a.a.getManager(262);
    ...
    for (;;)
    {
      if (VideoFeedsUploader.a(this.jdField_a_of_type_Aeja.a) != null) {
        VideoFeedsUploader.a(this.jdField_a_of_type_Aeja.a).a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowSendUploaderVideoFeedsUploader$UploadInfo, this.jdField_a_of_type_ComTencentMobileqqNearbyNowSendUploaderVideoFeedsUploader$UploadResult);
      }
      return;
