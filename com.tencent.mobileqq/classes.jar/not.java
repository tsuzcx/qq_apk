  ...
  extends anii
{
  ...
  public not(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(String paramString1, long paramLong, String paramString2, nou paramnou)
  {
    this.jdField_a_of_type_Nou = null;
    ...
    paramnou = new ilive_get_record_info_svr.GetRoomStateReq();
    paramnou.source.set(paramString1);
    paramnou.roomid.set((int)paramLong);
    ...
    paramString1.busi_buf.set(ByteStringMicro.copyFrom(((ilive_get_record_info_svr.GetRoomStateReq)paramnou.get()).toByteArray()));
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, long paramLong, String paramString3)
  {
    if (this.jdField_a_of_type_Nou != null) {
      this.jdField_a_of_type_Nou.a(paramBoolean, paramString2, paramString1, paramLong, paramString3);
    }
  }
