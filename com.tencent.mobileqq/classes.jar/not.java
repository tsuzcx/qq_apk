  ...
  implements pbx
{
  ...
  private nou jdField_a_of_type_Nou;
  
  public not(QQAppInterface paramQQAppInterface, String paramString, Context paramContext)
  {
    this(paramQQAppInterface, paramString, paramContext, null);
  }
  
  public not(QQAppInterface paramQQAppInterface, String paramString, Context paramContext, nou paramnou)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Nou = paramnou;
  ...
  public void a(int paramInt, PublicAccountInfo paramPublicAccountInfo)
  {
    ...
    while (this.jdField_a_of_type_Nou == null) {
      return;
    }
    this.jdField_a_of_type_Nou.a(false, this.jdField_a_of_type_JavaLangString);
  }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    if (paramBoolean)
    {
      ...
      paramInt = sgg.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
      ahpd.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, paramInt);
      ...
      if (this.jdField_a_of_type_Nou != null) {
        this.jdField_a_of_type_Nou.a(true, paramString);
      }
      return;
    }
    a(-1, null);
