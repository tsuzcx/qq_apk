  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  ...
  public View a;
  aoej jdField_a_of_type_Aoej;
  apbl jdField_a_of_type_Apbl;
  ...
  public apbi(@NonNull BaseActivity paramBaseActivity, @NonNull ArrayList<QIMNotifyAddFriend> paramArrayList)
  {
    ...
    this.jdField_a_of_type_Aoej = ((aoej)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppInterface().getManager(257));
    ...
    {
      paramArrayList = b();
      bdll.b(null, "dc00898", "", "", "0X8008A9E", "0X8008A9E", 0, 0, "", "", "", "");
      ...
      {
        paramArrayList = (ImageView)paramArrayList.findViewById(2131374150);
    ...
    for (;;)
    {
      ...
      return;
      paramArrayList = a();
      bdll.b(null, "dc00898", "", "", "0X8008AA1", "0X8008AA1", 0, 0, "", "", "", "");
  ...
  private View a()
  {
    ...
    View localView = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131560960, null, false);
    localView.findViewById(2131369678).setOnClickListener(this);
    localView.findViewById(2131364584).setOnClickListener(this);
    TextView localTextView = (TextView)localView.findViewById(2131371779);
    String str = this.jdField_a_of_type_ComTencentMobileqqFlashchatFlashChatManager.c();
    if (!TextUtils.isEmpty(str)) {
      localTextView.setText(str);
    }
    this.jdField_a_of_type_ComTencentWidgetListView = ((XListView)localView.findViewById(2131370012));
    this.jdField_a_of_type_ComTencentWidgetListView.setSelector(new ColorDrawable(0));
    this.jdField_a_of_type_Apbl = new apbl(this, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
    this.jdField_a_of_type_Apbl.a(localList);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Apbl);
    ((Button)localView.findViewById(2131364956)).setOnClickListener(this);
    return localView;
  }
  ...
  private View b()
  {
    ...
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131561002, null, false);
    localRelativeLayout.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView = localRelativeLayout;
    Object localObject2 = localRelativeLayout.findViewById(2131365537);
    ((View)localObject2).setOnClickListener(this);
    Object localObject3 = (RelativeLayout.LayoutParams)((View)localObject2).getLayoutParams();
    ((RelativeLayout.LayoutParams)localObject3).width = agej.a(286.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
    ...
    ((PressDarkImageView)localObject3).setId(2131364584);
    ((PressDarkImageView)localObject3).setImageResource(2130846544);
    Object localObject4 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject4).addRule(3, 2131365537);
    ((RelativeLayout.LayoutParams)localObject4).addRule(14);
    ((RelativeLayout.LayoutParams)localObject4).topMargin = agej.a(28.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
    ...
    localObject3 = (TextView)((View)localObject2).findViewById(2131365555);
    ...
    localObject4 = (ImageView)((View)localObject2).findViewById(2131366233);
    Object localObject5 = (TextView)((View)localObject2).findViewById(2131371813);
    localObject3 = (TextView)((View)localObject2).findViewById(2131364878);
    ((View)localObject2).findViewById(2131364956).setOnClickListener(this);
    Object localObject6 = (TextView)((View)localObject2).findViewById(2131376281);
    ((TextView)localObject6).setTag(Long.valueOf(((QIMNotifyAddFriend)localObject1).uin));
    Object localObject7 = this.jdField_a_of_type_Aoej.a(((QIMNotifyAddFriend)localObject1).uin, ((QIMNotifyAddFriend)localObject1).qqUin);
    label410:
    int i;
    int j;
    int k;
    if (TextUtils.isEmpty((CharSequence)localObject7))
    {
      ...
      ((ImageView)localObject4).setImageDrawable(aoot.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, String.valueOf(((QIMNotifyAddFriend)localObject1).uin), (byte)2));
      ...
      if (i > 0)
      {
        localObject2 = (LinearLayout)((View)localObject2).findViewById(2131378033);
        ((LinearLayout)localObject2).setVisibility(0);
        if (i != 1) {
          break label685;
        }
        localObject3 = new ImageView(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
        i = agej.a(128.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        j = agej.a(188.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        k = agej.a(4.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        ...
        localObject6 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130839560);
    ...
    for (;;)
    {
      ...
      ((ImageView)localObject3).setOnClickListener(new apbj(this, ((QIMNotifyAddFriend.VideoInfo)((QIMNotifyAddFriend)localObject1).videoInfos.get(0)).videoVid));
    ...
    for (;;)
    {
      ...
      if (i < ((List)localObject1).size())
      {
        ...
        j = agej.a(76.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        k = agej.a(122.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        int m = agej.a(4.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        ...
        Drawable localDrawable = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130839560);
      ...
      for (;;)
      {
        ...
        ((URLImageView)localObject5).setOnClickListener(new apbk(this, (ArrayList)localObject3, (QIMNotifyAddFriend.VideoInfo)localObject4));
  ...
  public void a()
  {
    Button localButton = (Button)getWindow().findViewById(2131364956);
  ...
  public boolean a(List<QIMNotifyAddFriend> paramList)
  {
    ...
    if (this.jdField_a_of_type_Apbl != null)
    {
      ...
      this.jdField_a_of_type_Apbl.a(this.jdField_a_of_type_JavaUtilList);
      a();
      bool = true;
    }
    return bool;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aoej.a(this.b);
      if (this.jdField_a_of_type_Int == 1)
      {
        bdll.b(null, "dc00898", "", "", "0X8008A9F", "0X8008A9F", 0, 0, "", "", "", "");
      }
      else if (this.jdField_a_of_type_Int == 2)
      {
        bdll.b(null, "dc00898", "", "", "0X8008AA2", "0X8008AA2", 0, 0, "", "", "", "");
        continue;
        if (this.jdField_a_of_type_Int == 1) {
          bdll.b(null, "dc00898", "", "", "0X8008AA0", "0X8008AA0", 0, 0, "", "", "", "");
        }
        for (;;)
        {
          dismiss();
          ...
          if (this.jdField_a_of_type_Int == 2) {
            bdll.b(null, "dc00898", "", "", "0X8008AA3", "0X8008AA3", 0, 0, "", "", "", "");
          }
        }
        dismiss();
      }
