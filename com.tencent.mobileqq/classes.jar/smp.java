...
public class smp
{
  ...
  public static String a(WSRedDotPushMsg paramWSRedDotPushMsg)
  {
    ...
    if (paramWSRedDotPushMsg != null)
    {
      ...
      bool = snf.a(paramWSRedDotPushMsg);
  ...
  {
    a("weishi_share_officialacc", "start_dl_ws_fin", paramInt, 0, sjy.a().d(), 0L, "", "");
  }
  ...
  public static void a(WSDownloadParams paramWSDownloadParams, int paramInt)
  {
    ...
    a("weishi_share_officialacc", "start_dl_ws", paramInt, 0, sjy.a().d(), 0L, "", paramWSDownloadParams.mTestId);
  }
  ...
  public static void a(WSRedDotPushMsg paramWSRedDotPushMsg)
  {
    ...
    for (;;)
    {
      ...
      long l1;
      long l2;
      if (vzw.a(BaseApplicationImpl.getApplication().getApplicationContext()))
      {
        l1 = 1L;
        l2 = j;
  ...
  {
    axqy.b(null, "dc00898", "", "", paramString1, paramString2, paramInt1, paramInt2, String.valueOf(paramLong1), String.valueOf(paramLong2), paramString3, paramString4);
  }
  ...
  public static void a(boolean paramBoolean, WSDownloadParams paramWSDownloadParams)
  {
    ...
    a(str, "dl_clk_officialdownloader", sjy.a().d(), 0, 0L, 0L, "", paramWSDownloadParams.mTestId);
  }
