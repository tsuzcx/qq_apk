...
public class wpt
{
  ...
  private static final wpt jdField_a_of_type_Wpt = new wpt();
  ...
  private final ConcurrentHashMap<String, ConcurrentHashMap<Integer, WeakReference<wpv>>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  private wpt()
  {
    ...
    {
      if (i != 0) {
        QIPCServerHelper.getInstance().register(new wpu(this, "SUBSCRIBE_IPC_MODULE"));
      }
      return;
      i = 0;
    }
  ...
  private void a(String paramString, wpv paramwpv)
  {
    ...
    localConcurrentHashMap1.put(Integer.valueOf(paramwpv.hashCode()), new WeakReference(paramwpv));
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, localConcurrentHashMap1);
    QLog.d("SimpleEventBus", 2, "registerReceiver event Name:" + paramString + ",key：[" + paramwpv.getClass().getSimpleName() + ":" + paramwpv.hashCode() + "], subscribers size:" + localConcurrentHashMap1.size());
  }
  ...
  private void b(String paramString, wpv paramwpv)
  {
    ...
    localConcurrentHashMap.remove(Integer.valueOf(paramwpv.hashCode()));
    if (localConcurrentHashMap.size() == 0) {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString);
    }
    QLog.d("SimpleEventBus", 2, "unRegisterReceiver event Name:" + paramString + ",key：[" + paramwpv.getClass().getSimpleName() + ":" + paramwpv.hashCode() + "], subscribers size:" + localConcurrentHashMap.size());
  }
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localWeakReference != null) && (localWeakReference.get() != null)) {
          ((wpv)localWeakReference.get()).a(paramSimpleBaseEvent);
        }
      }
    }
  }
  ...
  public void a(wpv paramwpv)
  {
    ...
    {
      return;
      Iterator localIterator = paramwpv.a().iterator();
      while (localIterator.hasNext()) {
        a(((Class)localIterator.next()).getName(), paramwpv);
      }
    }
  }
  
  public void b(wpv paramwpv)
  {
    if (paramwpv == null) {}
    for (;;)
    {
      ...
      Iterator localIterator = paramwpv.a().iterator();
      while (localIterator.hasNext()) {
        b(((Class)localIterator.next()).getName(), paramwpv);
      }
    }
  }
}
