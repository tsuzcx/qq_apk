  ...
  implements Handler.Callback
{
  ...
  public static bdho a()
  {
    ...
    localbdho.a(0);
    bdjy.b(0, localbdho, jdField_b_of_type_ArrayOfInt).step();
    ...
    try
    {
      ...
      jdField_a_of_type_Boolean = false;
      bdjy.b(13, localbdho, null).step();
      if (BaseApplicationImpl.sProcessId == 2)
      {
        bdjy.b(11, localbdho, null).step();
        bdjy.b(40, localbdho, null).step();
        ThreadManager.post(bdjy.b(0, localbdho, jdField_l_of_type_ArrayOfInt), 10, null, false);
        bdjy.b(0, localbdho, jdField_k_of_type_ArrayOfInt).step();
      }
      for (;;)
      {
        return null;
        ...
        {
          bdjy.b(0, localbdho, r).step();
        }
        else if ((BaseApplicationImpl.sProcessId == 5) || (BaseApplicationImpl.sProcessId == 7))
        {
          bdjy.b(11, localbdho, null).step();
          bdjy.b(8, localbdho, null).step();
          bdjy.b(0, localbdho, jdField_i_of_type_ArrayOfInt).step();
          bdjy.b(12, localbdho, null).step();
          bdjy.b(47, localbdho, null).step();
          if (BaseApplicationImpl.sProcessId == 7) {
            bdjy.b(49, localbdho, null).step();
          }
        }
        ...
        else if (!BaseApplicationImpl.processName.endsWith(":qqfav"))
        {
          ...
          {
            ThreadManager.excute(bdjy.b(0, localbdho, jdField_a_of_type_ArrayOfInt), 16, null, false);
          }
          else
          {
      ...
      if (BaseApplicationImpl.processName.endsWith(":troopbar"))
      {
        bdjy.b(12, localbdho, null).step();
        bdjy.b(11, localbdho, null).step();
        bdjy.b(14, localbdho, null).step();
      }
      for (;;)
      {
        if (BaseApplicationImpl.processName.endsWith(":troophomework")) {
          bdjy.b(38, localbdho, null).step();
        }
        if (!BaseApplicationImpl.processName.endsWith(":live")) {
          break;
        }
        bdjy.b(48, localbdho, null).step();
        break;
        bdjy.b(0, localbdho, jdField_j_of_type_ArrayOfInt).step();
      }
    }
        ...
        if (!str1.isEmpty())
        {
          ...
          if (arrayOfString.length > 0)
          {
            ...
            if (i1 < i3)
            {
              ...
              aolo.jdField_a_of_type_JavaUtilSet.add(Integer.valueOf(Integer.parseInt(str2)));
              i1 += 1;
              continue;
            }
          }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ThreadManager.getSubThreadHandler().postAtFrontOfQueue(bdjy.b(10, this, null));
      if (jdField_a_of_type_Int == 1) {
        ThreadManager.getSubThreadHandler().post(bdjy.b(22, this, null));
      }
    }
    ...
    if (paramBoolean)
    {
      ...
      if ((BaseApplicationImpl.sShowTime <= 0L) || (!bhnv.g(BaseApplicationImpl.sApplication))) {
        break label323;
      }
    }
    label323:
    for (BaseApplicationImpl.sShowTime = -l1;; BaseApplicationImpl.sShowTime = 0L)
    {
      ...
      if (this.jdField_a_of_type_Bdhp != null)
      {
  ...
  private void a(int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt)
  {
    ...
    paramArrayOfInt1 = bdjy.b(0, this, paramArrayOfInt1);
    if (paramArrayOfInt2 != null)
    {
      this.jdField_f_of_type_Int = 2;
      this.jdField_g_of_type_Int = paramInt;
      paramArrayOfInt1.setResultListener(this.jdField_b_of_type_AndroidOsHandler, 10);
      paramArrayOfInt2 = bdjy.b(0, this, paramArrayOfInt2);
  ...
  private void b(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {
      localTextView.setText(2131693063);
    }
    for (;;)
    {
      ...
      return;
      localTextView.setText(anzj.a(2131713152));
    }
  }
  ...
  public void a(bdhp parambdhp)
  {
    this.jdField_a_of_type_Bdhp = parambdhp;
  }
  ...
  public void a(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission == null) {
        this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission = ((CheckPermission)bdjy.b(3, this, null));
      }
    ...
    if (this.jdField_e_of_type_Int == 2)
    {
      if (1 == BaseApplicationImpl.sProcessId) {
        ThreadManager.getFileThreadHandler().postDelayed(bdjy.b(14, this, null), 1000L);
      }
      a(11, 1, 5L);
      a(3);
    }
    ...
    for (paramObject = (AppActivity)paramObject;; paramObject = null)
    {
      ...
      if (paramObject == null)
      {
        ...
        if (this.jdField_e_of_type_Int == 1)
        {
          ...
          {
            paramObject = o;
            bdjy.b(0, this, paramObject).step();
            abiz.f();
        ...
        for (;;)
        {
          ...
          if (this.jdField_e_of_type_Int == 2)
          {
            bdjy.b(0, this, jdField_m_of_type_ArrayOfInt).step();
            a(101);
          }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramIntent = (SetSplash)bdjy.b(2, this, null);
          paramIntent.step();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      for (;;)
      {
        return true;
        a(4, 0, 300L);
        bool1 = bdjy.b(13, this, null).step();
        ...
        if (this.jdField_a_of_type_MqqAppAppActivity != null)
        {
          ...
          if (this.jdField_a_of_type_MqqAppAppActivity != null)
          {
            bhsk.a(this.jdField_a_of_type_MqqAppAppActivity, "com.tencent.mobileqq.activity.MainActivity");
            bhsk.a(this.jdField_a_of_type_MqqAppAppActivity, SplashActivity.class.getName());
            return true;
            ...
            this.jdField_a_of_type_Bdhp.a(this);
            if (this.jdField_a_of_type_Long > 0L) {
      ...
      bdjy.b(29, this, null).step();
      return true;
    } while (this.jdField_a_of_type_Bdhp.jdField_a_of_type_Boolean);
    this.jdField_a_of_type_Bdhp.a();
