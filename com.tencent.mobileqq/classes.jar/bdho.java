...
public class bdho
{
  public static biau a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    bdia localbdia = (bdia)paramQQAppInterface.a(120);
    if ((paramContext == null) || (localbdia == null) || (paramTeamWorkFileImportInfo == null) || (paramTeamWorkFileImportInfo.jdField_a_of_type_Int != 1)) {
      return null;
    }
  ...
  public static biau a(QQAppInterface paramQQAppInterface, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, Context paramContext, String paramString)
  {
    paramQQAppInterface = (bdia)paramQQAppInterface.a(120);
  ...
  public static biau a(QQAppInterface paramQQAppInterface, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, Context paramContext, String paramString1, String paramString2, boolean paramBoolean)
  {
    bdia localbdia = (bdia)paramQQAppInterface.a(120);
    if ((localbdia == null) || (paramTeamWorkFileImportInfo == null) || (TextUtils.isEmpty(paramString2))) {}
    do
    {
      return null;
      paramTeamWorkFileImportInfo.jdField_e_of_type_Boolean = true;
      if (paramString2.equals(paramContext.getString(2131718486))) {}
      ...
      {
        localbdia.a(paramTeamWorkFileImportInfo, paramBoolean);
        if ((localbdia.a(paramTeamWorkFileImportInfo)) || (!TextUtils.isEmpty(localbdia.a(paramTeamWorkFileImportInfo))) || (!paramTeamWorkFileImportInfo.jdField_d_of_type_Boolean)) {
          break;
        }
        localbdia.a(paramTeamWorkFileImportInfo);
        a(paramContext, paramTeamWorkFileImportInfo, null);
        return null;
      }
      if ((localbdia.a(paramTeamWorkFileImportInfo)) && (paramTeamWorkFileImportInfo.jdField_d_of_type_Boolean))
      {
        a(paramContext, paramTeamWorkFileImportInfo, null);
        return null;
      }
      if ((!TextUtils.isEmpty(localbdia.a(paramTeamWorkFileImportInfo))) && (paramTeamWorkFileImportInfo.jdField_d_of_type_Boolean))
      {
        paramQQAppInterface = new Bundle();
        paramQQAppInterface.putString("url", localbdia.a(paramTeamWorkFileImportInfo));
  ...
  public static void a(Context paramContext, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, String paramString)
  {
    ...
    if (paramTeamWorkFileImportInfo != null) {
      if (paramTeamWorkFileImportInfo.jdField_d_of_type_Int == 1)
      {
        ...
        i = 0;
        j = i;
        if (bdjg.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramTeamWorkFileImportInfo.jdField_d_of_type_Int))) {
          paramString.putExtra("tdsourcetag", (String)bdjg.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramTeamWorkFileImportInfo.jdField_d_of_type_Int)));
        }
      }
    }
    for (int j = i;; j = 0)
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, bdhs parambdhs)
  {
    ...
    do
    {
      ...
      paramQQAppInterface = a(paramQQAppInterface, paramTeamWorkFileImportInfo, paramContext, paramString, paramContext.getString(2131718486), true);
    } while (parambdhs == null);
    parambdhs.a(paramQQAppInterface);
    return;
    ...
    if (paramTeamWorkFileImportInfo.d())
    {
      str3 = paramContext.getString(2131691693);
      str2 = paramContext.getString(2131691689);
    }
    for (String str1 = paramContext.getString(2131691691);; str1 = paramContext.getString(2131691690))
    {
      localbkho.a(2131691694);
      localbkho.b(str3);
      localbkho.a(str2, 5);
      localbkho.a(str1, 5);
      localbkho.c(2131690582);
      localbkho.a(new bdhp(paramTeamWorkFileImportInfo, localbkho, paramQQAppInterface, paramContext, paramString, parambdhs));
      localbkho.show();
      if (!paramTeamWorkFileImportInfo.d()) {
        break;
      }
      bdkv.a(paramQQAppInterface, "0X8009ED0");
      return;
      str3 = paramContext.getString(2131691692);
      str2 = paramContext.getString(2131691687);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, Context paramContext, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      return;
      String str1 = String.format(paramContext.getString(2131718516), new Object[] { paramString2 });
      int k = arag.a().a();
      int m = arag.a().b();
      int j = 1;
      int i;
      if (!bgnw.b(paramQQAppInterface.getApp(), "com.tencent.tim", "775E696D09856872FDD8AB4F3F06B1E0"))
      {
        paramString2 = String.format(paramContext.getString(2131718516), new Object[] { paramString2 });
      ...
      for (;;)
      {
        for (;;)
        {
          paramContext.putString("teamworkUrl", localbdia.a(paramTeamWorkFileImportInfo));
          ...
          ((awhq)paramQQAppInterface.getManager(242)).a(paramContext);
          return;
          String str2 = bgnw.a(paramQQAppInterface.getApp(), "com.tencent.tim");
          if (QLog.isColorLevel()) {
          ...
          try
          {
            ...
            paramString2 = paramContext.getString(2131718561);
            i = 0;
          }
      ...
      label399:
      paramQQAppInterface = bglp.a(paramContext, 0);
      paramQQAppInterface.setMessage(paramString2);
      paramQQAppInterface.setPositiveButton(paramContext.getString(2131691648), new bdhq(paramContext, paramString1));
      paramQQAppInterface.setNegativeButton(paramContext.getString(2131692947), new bdhr(paramQQAppInterface));
      try
      {
  ...
  public static void a(TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    for (;;)
    {
      ...
      for (localObject = (QQAppInterface)localObject;; localObject = null)
      {
        ...
        ((bdia)localObject).a(paramTeamWorkFileImportInfo);
        return;
      }
    }
  }
  ...
  public static void a(TeamWorkFileImportInfo paramTeamWorkFileImportInfo, String paramString)
  {
    ...
    do
    {
      ...
      bdia localbdia = (bdia)localQQAppInterface.a(120);
      if ((!localbdia.a(paramTeamWorkFileImportInfo)) && (TextUtils.isEmpty(localbdia.a(paramTeamWorkFileImportInfo))))
      {
      ...
      if (paramTeamWorkFileImportInfo.d())
      {
        ...
        localbdia.c(paramTeamWorkFileImportInfo);
        localbdia.e(paramTeamWorkFileImportInfo);
        paramTeamWorkFileImportInfo.g = 1;
        localbdia.a(paramTeamWorkFileImportInfo);
        return;
      }
    ...
    bdkv.a(localQQAppInterface, "0X8009ECF");
  }
  ...
  public static boolean a(TeamWorkFileImportInfo paramTeamWorkFileImportInfo, Context paramContext, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    {
      QQToast.a(paramContext, anni.a(2131713468), 1).b(BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131298998));
      return false;
    }
    if (paramInt == 9) {
    ...
    if (!TextUtils.isEmpty(localbdia.a(paramTeamWorkFileImportInfo))) {
      paramQQAppInterface = localbdia.a(paramTeamWorkFileImportInfo);
    }
    if (!localbdia.a(paramTeamWorkFileImportInfo)) {
      localbdia.a(paramTeamWorkFileImportInfo);
    }
  ...
  {
    return (!TextUtils.isEmpty(paramString)) && (arbt.a(Uri.parse(paramString).getHost()));
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      paramString1 = arph.a("ipc_cmd_convert_team_work_url_2_doc", "", -1, paramString1);
  ...
  private static boolean b(String paramString)
  {
    ...
    paramString = (String)bdjg.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (paramString == null) {
      return false;
    }
    aqtv localaqtv = (aqtv)aqlk.a().a(418);
    if (localaqtv == null) {
      return false;
    }
    paramString = (aqtw)localaqtv.a().get(paramString);
    if (paramString == null) {
      return false;
    }
