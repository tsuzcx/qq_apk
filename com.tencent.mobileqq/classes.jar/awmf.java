...
public class awmf
{
  ...
  private static void a(awlz paramawlz)
  {
    boolean bool = a(paramawlz.jdField_a_of_type_JavaLangCharSequence);
    if (((paramawlz.jdField_b_of_type_Boolean) && (paramawlz.jdField_a_of_type_JavaLangCharSequence.length() <= 5)) || (!bool))
    {
      paramawlz.jdField_c_of_type_Int = 0;
      return;
    }
    paramawlz.jdField_c_of_type_Int = 4;
  }
  
  public static void a(List<awlz> paramList, PersonalityLabel paramPersonalityLabel, float paramFloat)
  {
    ...
    Collections.sort(localArrayList, new awmg());
    ...
    awlz localawlz = new awlz();
    localawlz.jdField_a_of_type_JavaLangCharSequence = str;
    boolean bool = a(str);
    label398:
    int i4;
    label420:
    ...
    {
      localawlz.jdField_b_of_type_Int = ((PersonalityLabelInfo)localObject2).bgColor;
      localawlz.jdField_e_of_type_Int = 2;
      localawlz.jdField_a_of_type_Int = ((PersonalityLabelInfo)localObject2).fgColor;
      if (localawlz.jdField_e_of_type_Int != 2) {
        break label886;
      }
      i4 = 1;
      ...
      {
        localawlz.jdField_b_of_type_Boolean = true;
        localawlz.jdField_e_of_type_Boolean = true;
        i2 = n + 1;
      }
      i1 = i2;
      n = i;
      if (!localawlz.jdField_e_of_type_Boolean)
      {
        if ((i5 > 1) && (i < 2) && (i != i5 - 1) && (str.length() <= 6)) {
          break label892;
        }
        localawlz.jdField_b_of_type_Boolean = true;
        if (localawlz.jdField_b_of_type_Boolean) {
          break label905;
        }
        n = i + 1;
        i1 = i2;
    ...
    for (;;)
    {
      ...
      for (j = m + 1;; j = m)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            localawlz.jdField_a_of_type_Float = (m * paramFloat);
            localawlz.jdField_a_of_type_AndroidTextTextPaint.setTextSize(localawlz.jdField_a_of_type_Float);
            if (QLog.isColorLevel()) {
              QLog.i("TagUtil", 2, "getTags " + localawlz.jdField_a_of_type_JavaLangCharSequence + " sizeLevel:" + i + " size:" + localawlz.jdField_a_of_type_Float / paramFloat);
            }
            paramList.add(localawlz);
            m = j;
            j = i2;
            i = n;
            break label265;
            ...
            localawlz.d = true;
            localawlz.jdField_a_of_type_AndroidTextTextPaint.setFakeBoldText(true);
            break label398;
            label886:
            i4 = 0;
            break label420;
            label892:
            localawlz.jdField_b_of_type_Boolean = ((Random)localObject1).nextBoolean();
            break label544;
            label905:
            i1 = i2 + 1;
            n = i;
            ...
            if (n == 0)
            {
              paramPersonalityLabel = (awlz)paramList.get(0);
            ...
            if ((i == 0) && (i5 > 1))
            {
              ...
              if (j < paramList.size())
              {
                paramPersonalityLabel = (awlz)paramList.get(j);
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                j += 1;
                break label1033;
                localObject2 = new awlz();
                ((awlz)localObject2).jdField_a_of_type_JavaLangCharSequence = ((CharSequence)localObject1);
                ((awlz)localObject2).jdField_c_of_type_Boolean = true;
                ((awlz)localObject2).jdField_b_of_type_Boolean = false;
                ((awlz)localObject2).jdField_a_of_type_Float = paramPersonalityLabel.jdField_a_of_type_Float;
                ((awlz)localObject2).jdField_a_of_type_AndroidTextTextPaint.setTextSize(paramPersonalityLabel.jdField_a_of_type_Float);
