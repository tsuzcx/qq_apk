  ...
  extends WebViewPlugin
{
  ...
  qpc jdField_a_of_type_Qpc = null;
  ...
  private Boolean a(String paramString)
  {
    ...
    {
      onk.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, true, "shouldOfflineIntercept", 0, System.currentTimeMillis() - this.jdField_a_of_type_Long);
      return Boolean.valueOf(false);
    }
    bcfy localbcfy = bcfx.a(this.jdField_b_of_type_JavaLangString);
    if ((localbcfy != null) && (!TextUtils.isEmpty(localbcfy.jdField_b_of_type_JavaLangString)))
    {
      this.mRuntime.a().loadDataWithBaseURL(paramString, localbcfy.jdField_b_of_type_JavaLangString, "text/html", "utf-8", paramString);
      ...
      onk.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, true, "shouldOfflineIntercept", 1, System.currentTimeMillis() - this.jdField_a_of_type_Long);
  ...
  private String a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Qpc != null)
    {
      ...
      paramString = this.jdField_a_of_type_Qpc.a("CMD_GET_WEB_RENDER_DATA", (Bundle)localObject);
      localObject = str;
      if (paramString != null) {
  ...
  private void a(String paramString1, String paramString2, Map<String, Object> paramMap)
  {
    ...
    for (int i = 1;; i = 0)
    {
      onk.a(paramString1, true, paramString2, i, System.currentTimeMillis() - this.jdField_a_of_type_Long);
      return;
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  {
    if (!bhvh.n(this.jdField_a_of_type_ComTencentCommonAppAppInterface)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        if (paramLong == 32L)
        {
          ...
          if ((!bhvh.o(this.jdField_a_of_type_ComTencentCommonAppAppInterface)) && (!this.jdField_a_of_type_Boolean)) {
            return a(paramString).booleanValue();
          }
          return this.jdField_a_of_type_Boolean;
        }
      } while ((paramLong != 8589934593L) || (!bhvh.o(this.jdField_a_of_type_ComTencentCommonAppAppInterface)));
  ...
  public void onCreate()
  {
    ...
    if (this.mRuntime != null)
    {
      ...
      this.jdField_b_of_type_Boolean = bhvh.n(this.jdField_a_of_type_ComTencentCommonAppAppInterface);
    }
    if (this.jdField_a_of_type_Qpc == null) {
    ...
    if ((this.mRuntime != null) && (this.jdField_b_of_type_Boolean))
    {
      ...
      if ((localActivity instanceof FragmentActivity))
      {
        ...
        if (localObject != null)
        {
          ...
          {
            this.jdField_b_of_type_JavaLangString = mze.a((String)localObject, "_bid=" + str);
      ...
      onk.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, true, "REPORT_EVENT_CREATE", 0, System.currentTimeMillis() - this.jdField_a_of_type_Long);
    }
  }
