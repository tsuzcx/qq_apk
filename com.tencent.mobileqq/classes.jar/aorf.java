  ...
  extends aoqb
{
  ...
  {
    return apvd.a(paramWeiYunFileInfo.jdField_a_of_type_Long);
  }
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      try
      {
        localObject2 = new aorg(this);
        localObject1 = paramView;
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560449, paramViewGroup, false);
        localObject1 = paramView;
        ((aorg)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131374868));
        localObject1 = paramView;
        ((aorg)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this.b);
        localObject1 = paramView;
        ((aorg)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnLongClickListener(this.jdField_a_of_type_AndroidViewView$OnLongClickListener);
        localObject1 = paramView;
        ((aorg)localObject2).jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(localObject2);
        localObject1 = paramView;
        ((aorg)localObject2).jdField_a_of_type_ComTencentMobileqqWidgetCircleFileStateView = ((CircleFileStateView)paramView.findViewById(2131361889));
        localObject1 = paramView;
        ((aorg)localObject2).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131366225));
        localObject1 = paramView;
        ((aorg)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131366211));
        localObject1 = paramView;
        ((aorg)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setOnClickListener(this.b);
        localObject1 = paramView;
        ((aorg)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setTag(localObject2);
        localObject1 = paramView;
        ((aorg)localObject2).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366223));
        localObject1 = paramView;
        ((aorg)localObject2).jdField_a_of_type_AndroidWidgetTextView.setGravity(48);
        localObject1 = paramView;
        ((aorg)localObject2).jdField_a_of_type_AndroidWidgetTextView.setMaxLines(2);
        localObject1 = paramView;
        ((aorg)localObject2).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366209));
        localObject1 = paramView;
        ((aorg)localObject2).jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131368885));
        localObject1 = paramView;
        ((aorg)localObject2).jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setAsyncClipSize(actj.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actj.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
        localObject1 = paramView;
      ...
      try
      {
        i = apug.a(localWeiYunFileInfo.c);
        apug.a(paramViewGroup.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localWeiYunFileInfo.h, i);
        ...
        if ((apug.a(localWeiYunFileInfo.c) == 0) && (bbdx.b(localWeiYunFileInfo.h))) {
        ...
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692500);
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692476);
        localObject1 = apvw.b(localWeiYunFileInfo.b) + a((String)localObject2, (String)localObject1);
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(apel.a(localWeiYunFileInfo));
      localObject1 = (LinearLayout.LayoutParams)paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.getLayoutParams();
      ((LinearLayout.LayoutParams)localObject1).topMargin = actj.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      return paramView;
      localObject1 = paramView;
      paramViewGroup = (aorg)paramView.getTag();
      continue;
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetCircleFileStateView.setVisibility(0);
