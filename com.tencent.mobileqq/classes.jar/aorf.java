  ...
  extends AsyncTask<Void, Integer, Boolean>
{
  ...
  public aorf(QQAppInterface paramQQAppInterface)
  {
  ...
  protected Boolean a(Void... paramVarArgs)
  {
    for (;;)
    {
      try
      {
        ...
        aora.a((QQAppInterface)localObject);
        if ((!aora.jdField_a_of_type_Boolean) || (aora.jdField_c_of_type_Boolean) || (aora.jdField_a_of_type_AndroidContentIntent == null)) {
          return Boolean.valueOf(false);
        }
        if ((aora.b != 0) && (Build.VERSION.SDK_INT > aora.b)) {
          return Boolean.valueOf(false);
        }
        ...
        if (QQToast.a() == 0)
        {
          ...
          if (i != 0)
          {
            if (!aora.a((QQAppInterface)localObject)) {
              return Boolean.valueOf(false);
            }
            localObject = PreferenceManager.getDefaultSharedPreferences(((QQAppInterface)localObject).getApp());
            long l3 = System.currentTimeMillis();
            if (aora.a() == -1L) {
              aora.a(((SharedPreferences)localObject).getLong("push_open_notify_lasttime", l3));
            }
            long l1 = 0L;
            i = 0;
            ...
            if (n == 1)
            {
              l1 = aora.jdField_c_of_type_Int * aora.jdField_a_of_type_Long;
              i = aora.d;
              j = i;
              m = i1;
              l2 = l1;
              ...
              if (i1 >= i)
              {
                ...
                if (n == 1)
                {
                  l2 = aora.jdField_c_of_type_Int * aora.jdField_a_of_type_Long;
                  j = aora.d;
                  k = n;
                  m = i1;
                }
              ...
              else
              {
                if (QLog.isColorLevel()) {
                  QLog.d("PushOpenNotify", 2, new Object[] { "PopOpenMsgNotifation, stage:", Integer.valueOf(k), " stagecount:", Integer.valueOf(m), " count:", Integer.valueOf(i2), " countMax:", Integer.valueOf(j), " pushInteral:", Long.valueOf(l2), " timeDiff:", Long.valueOf(l3 - aora.a()) });
                }
                if ((l3 - aora.a() <= l2) && (i2 != 0)) {
                  break label754;
                }
                aora.a(l3);
            ...
            else
            {
              if (n == 2)
              {
                l1 = aora.e * aora.jdField_a_of_type_Long;
                i = aora.f;
                continue;
              }
              if (n != 3) {
              ...
              l1 = aora.g * aora.jdField_a_of_type_Long;
              i = 2147483647;
              continue;
            }
            if (n == 2)
            {
              l2 = aora.e * aora.jdField_a_of_type_Long;
              j = aora.f;
              m = i1;
              k = n;
              continue;
            ...
            l1 = aora.g;
            l2 = aora.jdField_a_of_type_Long;
            l2 = l1 * l2;
            j = 2147483647;
            m = i1;
            k = n;
