...
public class bobn
{
  ...
  private static bobm a(Cursor paramCursor)
  {
    bobm localbobm = new bobm();
    localbobm.jdField_a_of_type_Long = paramCursor.getLong(0);
    localbobm.jdField_a_of_type_JavaLangString = paramCursor.getString(1);
    localbobm.jdField_b_of_type_JavaLangString = paramCursor.getString(2);
    localbobm.jdField_c_of_type_JavaLangString = paramCursor.getString(3);
    localbobm.jdField_d_of_type_JavaLangString = paramCursor.getString(4);
    localbobm.jdField_e_of_type_JavaLangString = paramCursor.getString(5);
    localbobm.jdField_b_of_type_Long = paramCursor.getLong(6);
    localbobm.f = paramCursor.getString(7);
    localbobm.jdField_c_of_type_Long = paramCursor.getLong(8);
    localbobm.g = paramCursor.getString(9);
    localbobm.jdField_a_of_type_Int = paramCursor.getInt(10);
    localbobm.jdField_b_of_type_Int = paramCursor.getInt(11);
    localbobm.h = paramCursor.getString(12);
    localbobm.jdField_d_of_type_Long = paramCursor.getLong(13);
    localbobm.jdField_e_of_type_Long = paramCursor.getLong(14);
    localbobm.i = paramCursor.getString(15);
    localbobm.j = paramCursor.getString(16);
    localbobm.k = paramCursor.getString(17);
    localbobm.l = paramCursor.getString(18);
    return localbobm;
  }
  
  /* Error */
  public static java.util.ArrayList<bobm> a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    ...
    //   53: aload_3
    //   54: ldc 36
    //   56: getstatic 145	bobo:a	[Ljava/lang/String;
    //   59: aload 4
    ...
    //   93: aload_2
    //   94: aload_0
    //   95: invokestatic 161	bobn:a	(Landroid/database/Cursor;)Lbobm;
