...
public class asyy
{
  ...
  /* Error */
  private void a(File paramFile1, File paramFile2, asyx paramasyx)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 7
    ...
    //   25: iconst_1
    //   26: ldc 150
    //   28: invokestatic 54	asyy:a	(ILjava/lang/String;)V
    //   31: iconst_0
    //   32: ifeq +11 -> 43
    ...
    //   134: aload_0
    //   135: getfield 29	asyy:jdField_a_of_type_Boolean	Z
    //   138: ifne +62 -> 200
    //   141: aload 5
    //   143: aload 7
    //   145: iconst_0
  ...
  private void a(List<String> paramList, asyx paramasyx)
  {
    ...
    if (str2.contains("/.tmp/")) {
      localObject = b(str1) + aszt.a(str2);
    }
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ThreadManager.post(new FMSettings.4(this, str2, (File)localObject, j, paramasyx), 8, null, false);
          i += 1;
        }
      ...
      if (str2.contains("/.thumbnails/")) {
        localObject = c(str1) + aszt.a(str2);
      } else {
        localObject = a(str1) + aszt.a(str2);
      }
    }
  }
  ...
  private asze b()
  {
    return (asze)this.jdField_a_of_type_JavaUtilMap.get("sdCard");
  }
  ...
  private asze c()
  {
    ...
    return (asze)this.jdField_a_of_type_JavaUtilMap.get("externalSdCard");
  }
  ...
  private void c()
  {
    ...
    ThreadManager.post(new FMSettings.1(this, b(localasze.jdField_b_of_type_JavaLangString + localasze.c)), 8, null, false);
  }
  ...
  private asze d()
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject2 = (asze)this.jdField_a_of_type_JavaUtilMap.get(localObject2);
      ((asze)localObject2).a();
      if (((asze)localObject2).jdField_a_of_type_Boolean)
      {
        a(2, "getDefaultStorage[" + ((asze)localObject2).jdField_b_of_type_JavaLangString + "] + ext[" + ((asze)localObject2).c + "]");
        return localObject2;
      }
    }
    a(2, "getDefaultStorage nothing is default refresh!");
    Object localObject2 = (asze)this.jdField_a_of_type_JavaUtilMap.get("sdCard");
    localObject1 = localObject2;
    if (localObject2 == null)
    {
      localObject1 = new asze(this, null);
      ((asze)localObject1).jdField_a_of_type_Boolean = true;
      ((asze)localObject1).jdField_a_of_type_JavaLangString = "SD卡";
      ((asze)localObject1).jdField_b_of_type_JavaLangString = Environment.getExternalStorageDirectory().getPath();
      ((asze)localObject1).c = "";
    }
    ((asze)localObject1).a(BaseApplicationImpl.getContext());
    return localObject1;
  }
  ...
  public asze a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localObject = (asze)this.jdField_a_of_type_JavaUtilMap.get(localObject);
      if (localasze != localObject) {
        return localObject;
      }
    }
  ...
  public String a()
  {
    ...
    return a(localasze.jdField_b_of_type_JavaLangString + localasze.c);
  }
  ...
  public void a()
  {
    ...
    Map localMap = aszt.a(localBaseApplication);
    ...
    if (localIterator.hasNext())
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          localasze = new asze(this, null);
          localasze.jdField_a_of_type_Boolean = false;
          if (!str2.equalsIgnoreCase("sdCard")) {
            break label402;
          }
          localasze.jdField_a_of_type_JavaLangString = "SD卡";
          localasze.jdField_b_of_type_JavaLangString = ((String)localObject);
          localasze.c = "";
          a(1, "rootPath[" + localasze.jdField_b_of_type_JavaLangString + "],bDefault[" + localasze.jdField_a_of_type_Boolean + "]");
          localObject = new StatFs((String)localObject);
          localasze.jdField_a_of_type_Long = (((StatFs)localObject).getAvailableBlocks() * ((StatFs)localObject).getBlockSize());
          a(4, "defaultRootPath[" + str1 + "].equalsIgnoreCase(si.rootPath[" + localasze.jdField_b_of_type_JavaLangString + "])");
          if ((localMap.size() == 1) || (str1.equalsIgnoreCase(localasze.jdField_b_of_type_JavaLangString)))
          {
            a(4, "defaultRootPath.equalsIgnoreCase(si.rootPath) = true");
            localasze.jdField_a_of_type_Boolean = true;
            localasze.a(localBaseApplication);
          }
          localasze.a();
          this.jdField_a_of_type_JavaUtilMap.put(str2, localasze);
        }
        catch (Exception localException)
        {
          localException.printStackTrace();
        ...
        {
          localasze.jdField_a_of_type_JavaLangString = "外置SD卡";
          localBaseApplication.getExternalFilesDir(null);
          String str3 = BaseApplicationImpl.sApplication.getPackageName();
          localasze.jdField_b_of_type_JavaLangString = ((String)localObject);
          localasze.c = ("/Android/data/" + str3 + "/");
        }
      }
    }
  }
  
  public void a(long paramLong, List<String> arg3, Activity paramActivity, asyx paramasyx)
  {
    ...
    for (;;)
    {
      ...
      a(1, "showChoosePath, callback[" + paramasyx + "]");
      ??? = b();
      asze localasze = c();
      if (((asze)???).jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_JavaLangString = amtj.a(2131703788);
      }
      ...
      {
        label216:
        paramActivity.runOnUiThread(new FMSettings.5(this, paramActivity, ???, paramasyx));
        return;
        if ((localasze == null) || (!localasze.jdField_a_of_type_Boolean)) {
          break label216;
        }
        this.jdField_a_of_type_JavaLangString = amtj.a(2131703784);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    try
    {
      if (this.jdField_a_of_type_JavaUtilMap != null)
      {
        ...
        {
          ((asze)this.jdField_a_of_type_JavaUtilMap.get("sdCard")).a(BaseApplicationImpl.getContext());
          return;
        }
      }
    }
  ...
  public long b()
  {
    ...
    localObject = ((asze)localObject).jdField_b_of_type_JavaLangString;
    try
    {
      localObject = new StatFs((String)localObject);
      long l = ((StatFs)localObject).getAvailableBlocks();
