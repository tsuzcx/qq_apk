...
class aaqw
  implements Runnable
{
  aaqw(aaqv paramaaqv, ArrayList paramArrayList) {}
  
  public void run()
  {
    if (this.jdField_a_of_type_Aaqv.jdField_a_of_type_JavaLangRefWeakReference.get() == null) {
      ...
      if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() != 0))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (localObject != null)
          {
            ...
            ArkRecommendLogic.a(this.jdField_a_of_type_Aaqv.jdField_a_of_type_ComTencentMobileqqArkArkRecommendLogic, localArrayList, null, this.jdField_a_of_type_Aaqv.b, 2);
          }
        }
      }
    }
