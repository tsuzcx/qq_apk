...
public class twt
{
  ...
  public static Object a(GdtAd paramGdtAd)
  {
    ...
    return abrk.a((qq_ad_get.QQAdGetRsp.AdInfo)((qq_ad_get.QQAdGetRsp.PosAdInfo)paramGdtAd.getGdtAdLoader().a().a.pos_ads_info.get(0)).ads_info.get(0));
  }
  ...
  public qq_ad_get.QQAdGet a(long paramLong1, String paramString, long paramLong2, long paramLong3, int paramInt1, int paramInt2)
  {
    ...
    ((qq_ad_get.QQAdGet.PositionInfo.PositionExt.ShareInfo)localObject1).share_check.set(abks.a(paramLong2, paramLong3, paramInt2));
  ...
  public void a(Activity paramActivity, int paramInt1, String paramString1, int paramInt2, String paramString2, String paramString3)
  {
    try
    {
      paramString1 = (qq_ad_get.QQAdGetRsp.AdInfo)abrk.a(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(paramString1));
      GdtMotiveVideoPageData localGdtMotiveVideoPageData = abri.a(paramString1, abri.a(paramInt1));
  ...
  public void a(Activity paramActivity, String paramString, long paramLong1, long paramLong2, int paramInt1, int paramInt2, abla paramabla)
  {
    try
    {
      Object localObject = new aboq();
      ((aboq)localObject).jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet = a(Long.parseLong(alvx.a().getCurrentAccountUin()), paramString, paramLong1, paramLong2, paramInt1, paramInt2);
      ((aboq)localObject).jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params = a(true, paramActivity);
      localObject = new GdtMotiveVideoAd((aboq)localObject);
      ((GdtMotiveVideoAd)localObject).setListener(new WeakReference(paramabla));
