  ...
  extends BaseAdapter
{
  ...
  public alpd(alpc paramalpc, Context paramContext, int paramInt1, int paramInt2)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561154, null);
    ...
    for (;;)
    {
      ...
      {
        localCustomImgView.setImageDrawable(this.jdField_a_of_type_Alpc.a.a(localMessageRecord.istroop, localMessageRecord.senderuin));
