  ...
  extends axuw
{
  ...
  public axvm(QQAppInterface paramQQAppInterface, View paramView, StructMsgForGeneralShare paramStructMsgForGeneralShare)
  {
    ...
    if ((paramQQAppInterface != null) && ((paramQQAppInterface instanceof aebu)))
    {
      paramQQAppInterface = (aebu)paramQQAppInterface;
    ...
    {
      return;
      if ((paramQQAppInterface != null) && ((paramQQAppInterface instanceof aime)))
      {
        paramQQAppInterface = (aime)paramQQAppInterface;
  ...
  public boolean a(View paramView, String paramString)
  {
    ...
    {
      return false;
      paramView = paramView.findViewById(2131370684);
      if (paramView == null)
      {
        int i;
        ...
        for (paramView = ((axup)this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.mStructMsgItemLists.get(0)).h;; paramView = "")
        {
      ...
      paramView = (axxe)paramView.getTag();
    ...
    if ((paramView != null) && (paramView.size() > 0))
    {
      ...
      if ((!bool1) && (!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).equals(paramString)) && (!bool2))
      {
        ...
        {
          if (paramView != null) {
            asyx.a(paramView, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Activity)this.jdField_a_of_type_AndroidContentContext, 1);
          }
          return true;
        }
      }
      ...
      akbj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X8006390");
    }
    for (;;)
    {
      return true;
      label272:
      akbj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X80060B3");
      continue;
      label284:
      if (bool2) {
        if (!TextUtils.isEmpty((CharSequence)localObject)) {
          akbj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X8006391");
        } else {
          akbj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X80060B4");
        }
      }
    }
  }
  ...
  public boolean a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        bgyp.a((Activity)localContext, localException1, (BaseBusinessAlbumInfo)localObject3, -1, paramString);
        continue;
        long l = 0L;
        continue;
        ...
        bgyp.a((Activity)localContext, paramString, this.c, 0, 0, 0);
        continue;
        if (!bgyp.a((Activity)localContext, localException1, "biz_src_jc_aio")) {
          continue;
        }
        return true;
        ...
        return true;
        if ((!ayfx.a(paramString)) && (localStructMsgForGeneralShare.mSourceAppid != ayfx.jdField_a_of_type_Long)) {
          continue;
        }
        ...
        return true;
        if ((!(localContext instanceof BaseActivity)) || (!asjk.a((BaseActivity)localContext, (String)localObject2, localStructMsgForGeneralShare.message))) {
          continue;
        }
        return true;
        ...
        paramString = mzb.a(paramString, "platformId=qq_m");
        ...
        if ((TextUtils.isEmpty(str2)) || (!bbbr.b(localStructMsgForGeneralShare.uin))) {
          continue;
        }
        ...
        paramString = bbex.a(localNumberFormatException, localContext, Uri.parse("mqqapi://card/show_pslcard?" + naj.a(paramString)).toString());
        if (paramString == null) {
          continue;
        }
        paramString.c();
        ...
        if (!bhwf.a(this.jdField_a_of_type_AndroidContentContext, str2)) {
          continue;
        }
        return true;
        if ((TextUtils.isEmpty(str2)) || (!sgg.c(str2)) || (!rvx.b(str2))) {
          continue;
        }
        rvx.a(localContext, null, rvx.b(str2), null);
        return true;
        if ((this.jdField_a_of_type_ComTencentMobileqqDataChatMessage == null) || (this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend()) || (this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.istroop != 0) || (!bbbr.b(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.frienduin)) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.getExtInfoFromExtStr("guide_msg_cookie")))) {
          continue;
        }
        paramString = bbbr.a(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.getExtInfoFromExtStr("guide_msg_cookie"));
        if (paramString == null) {
          continue;
        }
        ...
        try
        {
          ...
          if (localStructMsgForGeneralShare.uinType == 0)
          {
            ...
            acsz.a((Intent)localObject4, localNumberFormatException, localStructMsgForGeneralShare.message);
            if ((sgg.a(localNumberFormatException, localStructMsgForGeneralShare.uin) != -1) || (str2.startsWith("http://browserApp.p.qq.com/")))
            {
              ...
              paramString.putBoolean("switch_msg_btn", sgg.a());
            ...
            bool = amom.a(localNumberFormatException, localStructMsgForGeneralShare.uin);
            ...
            {
              paramString = "https://ti.qq.com/honest-say/group.html?_bid=3104&_qStyle=1&_wv=9191&_nav_alpha=0&_nav_txtclr=FFFFFF&_nav_titleclr=FFFFFF&_nav_anim=true&_wwv=128&gc=$GCODE$&src_type=share&from=appstore_aio&adtag=qq_to_qq".replace("$GCODE$", atbp.a(localStructMsgForGeneralShare.uin));
              ...
              if ((localContext instanceof FragmentActivity))
              {
                ...
                if (localObject2 != null)
                {
                  ...
                  if ((paramString != null) && ((paramString instanceof TroopChatPie))) {
                    amom.a((TroopChatPie)paramString);
                  }
                }
              }
            }
            ...
            bcql.a(BaseApplicationImpl.getContext(), amom.jdField_a_of_type_JavaLangString, 0).a();
            return false;
          }
        }
        catch (InvalidProtocolBufferMicroException paramString)
        {
          ...
          ((Intent)localObject4).putExtra("big_brother_source_key", sgg.b(localStructMsgForGeneralShare.source_puin));
          continue;
        ...
        paramString = bail.a(localStructMsgForGeneralShare, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
        if (TextUtils.isEmpty(paramString)) {
          continue;
        }
        ((Intent)localObject4).removeExtra("url");
        ...
        catch (Exception localException2)
        {
          ...
          continue;
          axrn.a(BaseApplication.getContext()).a(localNumberFormatException, "sha_click", 1, "", "", String.valueOf(localStructMsgForGeneralShare.mSourceAppid));
        }
        if (TextUtils.isEmpty(localStructMsgForGeneralShare.mMsgActionData)) {
          continue;
        }
        i = 1;
        nol.a(null, "", "0X8007555", "0X8007555", 0, 0, paramString, "", "" + i, "");
        nol.a("0X8007555", "", paramString, "", "" + i, "");
        ...
        sgg.a(localStructMsgForGeneralShare.message, (Intent)localObject4, str2);
        if ((TextUtils.isEmpty(localStructMsgForGeneralShare.mContentTitle)) || (ahfq.a((String)localObject2)) || (TextUtils.isEmpty((CharSequence)localObject2)) || (((String)localObject2).startsWith("https://ti.qq.com/qqdaren/index?_wv=16777219&_wwv=128"))) {
          continue;
        }
        ((Intent)localObject4).putExtra("title", localStructMsgForGeneralShare.mContentTitle);
        acqv.a(localContext, (Intent)localObject4, str2);
        axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "aio_msg_url", "aio_url_clickqq", 0, 1, 0, str2, "", "", "");
        if (!bool) {
          continue;
        }
        axrn.a(BaseApplication.getContext()).a(localNumberFormatException, str1, "Game_center", "Clk_game_in", 0, 1, null, String.valueOf(localStructMsgForGeneralShare.mSourceAppid), null, null, null);
        continue;
        if (!QLog.isColorLevel()) {
          continue;
        }
        ...
        axqy.b(localNumberFormatException, "CliOper", "", "", "0X80052BB", "0X80052BB", 0, 0, "", "", "", "");
        continue;
        axqy.b(localNumberFormatException, "CliOper", "", "", "0X80052BC", "0X80052BC", 0, 0, "", "", "", "");
        continue;
        i = 2;
        continue;
        continue;
      ...
      axqy.b(null, "CliOper", "", (String)localObject3, "0X80061B0", "0X80061B0", i, 0, str1, (String)localObject4, (String)localObject1, str2);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.mMsgServiceID == 107)
      {
        ...
        {
          StructMsgForGeneralShare.receiptServer = new axvn(this, "receipt_msg");
      ...
      l = bbcc.a(localStructMsgForGeneralShare.mSourceAppid);
      ...
      if ((localContext instanceof FragmentActivity))
      {
        ...
        if (localObject3 != null)
        {
          ...
          {
            localObject4 = (aert)localObject3;
            ((aert)localObject4).z += 1;
            localObject3 = (aert)localObject3;
            ((aert)localObject3).x += 1;
          }
        }
      }
      if (!c(paramString)) {
      ...
      localObject1 = bgyw.a();
      ((bgyw)localObject1).jdField_a_of_type_JavaLangString = str1;
      ((bgyw)localObject1).b = localQQAppInterface.getCurrentNickname();
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        continue;
      }
      bgyp.a((Activity)localContext, (bgyw)localObject1, paramString, "mqqChat", -1);
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message.istroop == 1008)) {
        nnu.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.uin);
      }
      return false;
      i = 1;
    }
  ...
  public boolean c(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      paramString1 = bbex.a(localQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString1);
      if (paramString1 == null) {
        break;
      }
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message != null) && (bbbr.b(this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message.senderuin))) {
