...
{
  public lya(ReadInJoyDeliverVideoActivity paramReadInJoyDeliverVideoActivity) {}
  ...
  public void b(int paramInt1, long paramLong, String paramString1, int paramInt2, String paramString2)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      {
        ThreadManager.post(new lyb(this), 5, null, false);
      ...
      for (;;)
      {
        try
        {
          ...
          localJSONObject.put("ugcVideoDuration", ReadInJoyDeliverVideoActivity.b(this.a));
        ...
        ReadInJoyDeliverVideoActivity.a(this.a, 2, this.a.getString(2131438865));
        break;
    ...
    {
      ReadInJoyDeliverVideoActivity.b(this.a);
      ReadInJoyDeliverVideoActivity.b(this.a, 1, this.a.getString(2131438851));
      ReadInJoyDeliverVideoActivity.c(this.a, 1006);
      return;
    }
    ReadInJoyDeliverVideoActivity.b(this.a);
    ReadInJoyDeliverVideoActivity.c(this.a, 1, this.a.getString(2131438866));
    ReadInJoyDeliverVideoActivity.c(this.a, 1006);
  }
}
