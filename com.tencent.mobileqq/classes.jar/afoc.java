  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    TroopNotifyAndRecommendView.a(this.a, (structmsg.StructMsg)localafmr.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.get(), localafmr.c);
    ...
    label286:
    String str1;
    if ((this.a.jdField_a_of_type_Afna != null) && (localafmr.b < this.a.jdField_a_of_type_Afna.jdField_a_of_type_Int))
    {
      paramView = "1";
      ...
      TroopNotifyAndRecommendView.a(this.a, localafmr.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.req_uin.get(), (structmsg.StructMsg)localafmr.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.get());
    }
    for (;;)
    {
      ...
      if (localafmr.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.group_msg_type.get() == 2)
      {
        ...
        bbbb.a("Grp_contacts_news", "notice", "agree_invite", 0, 0, new String[] { str3, paramView, str1, "0" });
      }
      else
      {
        TroopNotifyAndRecommendView.a(this.a, 1, (structmsg.StructMsg)localafmr.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.get());
        ...
        {
          bbbb.a("Grp_contacts_news", "notice", "agree_ask", 0, 0, new String[] { str3, paramView, str1, "0" });
        }
        else if (localafmr.jdField_a_of_type_Int == 2)
        {
          ...
          continue;
          label715:
          TroopNotifyAndRecommendView.a(this.a, 0, (structmsg.StructMsg)localafmr.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.get());
          if (localafmr.jdField_a_of_type_Int == 1) {
            bbbb.a("Grp_contacts_news", "notice", "refuse_ask", 0, 0, new String[] { str3, paramView, str1, "0" });
          } else if (localafmr.jdField_a_of_type_Int == 2) {
            bbbb.a("Grp_contacts_news", "notice", "refuse_invite", 0, 0, new String[] { str3, paramView, str1, "0" });
          }
        }
      }
    }
