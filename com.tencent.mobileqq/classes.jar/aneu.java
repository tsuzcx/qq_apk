  ...
  implements aiwf
{
  ...
  public aneu(Context paramContext, View.OnClickListener paramOnClickListener)
  {
    ...
    paramContext = new RelativeLayout.LayoutParams(-1, agej.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131701039));
    this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablePadding(agej.a(8.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    paramOnClickListener = a(2130838521);
    ...
    paramContext = new RelativeLayout.LayoutParams(-2, agej.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    paramContext.addRule(15);
    paramContext.leftMargin = agej.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    ...
    localLayoutParams.rightMargin = agej.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    paramContext = new StateListDrawable();
    Drawable localDrawable1 = a(2130838628);
    Drawable localDrawable2 = a(2130838629);
    ...
    localObject = new RelativeLayout.LayoutParams(-1, agej.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anzj.a(2131701040));
    this.jdField_b_of_type_AndroidWidgetTextView.setCompoundDrawablePadding(agej.a(8.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    this.jdField_b_of_type_AndroidWidgetTextView.setCompoundDrawables(paramOnClickListener, null, null, null);
    paramOnClickListener = new RelativeLayout.LayoutParams(-2, agej.a(44.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources()));
    paramOnClickListener.addRule(15);
    paramOnClickListener.leftMargin = agej.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
    ...
    ((RelativeLayout.LayoutParams)localObject).rightMargin = agej.a(12.0F, ((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getResources());
