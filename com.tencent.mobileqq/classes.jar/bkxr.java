  ...
  extends RemoteCommand
{
  ...
  public bkxr(QQAppInterface paramQQAppInterface)
  {
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramBundle)
      {
        ...
        bcef.b(this.a, "P_CliOper", "BizTechReport", "", "troop_member_card_plugin", "plugin_cmd_exp", 0, 0, paramBundle.getClass().getName(), null, null, null);
        return null;
      }
      ...
      bfun.a().a(this.a, paramBundle, this.a.getCurrentAccountUin(), this.a.getApp());
      paramBundle = localBundle;
      continue;
      ...
      localObject1 = (amsw)this.a.getManager(51);
      localObject2 = ((amsw)localObject1).b(paramBundle);
      if ((localObject2 == null) || (!((Friends)localObject2).isFriend())) {
        break label1404;
      }
      paramBundle = ((amsw)localObject1).a(paramBundle);
    ...
    for (long l1 = bbko.a();; l1 = 0L)
    {
      ...
      paramBundle = (FriendListHandler)this.a.getBusinessHandler(1);
      ...
      break;
      paramBundle = paramBundle.getString("uin");
      ((FriendListHandler)this.a.getBusinessHandler(1)).delFriend(paramBundle, (byte)2);
      ...
      if (bftf.b(paramBundle)) {
        bcef.b(this.a, "dc00898", "", "", "0X8007FDF", "0X8007FDF", 0, 0, "", "", "", "");
      }
      ...
      break;
      paramBundle = paramBundle.getString("troopUin");
      ((anca)this.a.getBusinessHandler(20)).l(paramBundle);
      paramBundle = localBundle;
      break;
      paramBundle = paramBundle.getString("troopUin");
      ((anca)this.a.getBusinessHandler(20)).k(paramBundle);
      paramBundle = localBundle;
      break;
      localObject1 = paramBundle.getString("uin");
      paramBundle = "";
      localObject1 = awfp.a(this.a, (String)localObject1, false);
      if (localObject1 != null)
      {
        if (((awgq)localObject1).a == 1L) {
          paramBundle = this.a.getApp().getString(2131693134);
        }
        for (;;)
        {
          i = ((awgq)localObject1).c;
          localBundle.putString("bind_name", paramBundle);
          localBundle.putInt("bind_icon", i);
          paramBundle = localBundle;
          break;
          if (((awgq)localObject1).a == 2L) {
            paramBundle = this.a.getApp().getString(2131693132);
          } else if (((awgq)localObject1).a == 3L) {
            paramBundle = this.a.getApp().getString(2131693133);
          } else if (((awgq)localObject1).a == 26L) {
            paramBundle = this.a.getApp().getString(2131693135);
          }
        }
      }
      label1404:
