...
public class bntq
{
  ...
  public bntq(Conversation paramConversation)
  {
  ...
  private void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout = ((DragFrameLayout)this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a().findViewById(2131365049));
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a().getLayoutInflater().inflate(2131558644, this.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout, false);
    this.b = this.jdField_a_of_type_AndroidViewView.findViewById(2131378833);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131378828).setBackgroundColor(this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a().getColor(2131165492));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378829));
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener(new bntr(this));
    ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378830)).setOnClickListener(new bnts(this));
  }
  
  private void b()
  {
    bmrq.a(this.jdField_a_of_type_AndroidViewView);
  }
  ...
  public void a(TianShuAccess.AdItem paramAdItem)
  {
    ...
    for (;;)
    {
      ...
      if (((TianShuAccess.MapEntry)localObject2).key.get().equals("url"))
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bntt(this, (String)localObject1));
        PreloadManager.a().c(paramAdItem, new bntu(this));
      }
      else
      {
