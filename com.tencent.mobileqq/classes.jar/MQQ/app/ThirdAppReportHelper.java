...
public class ThirdAppReportHelper
{
  ...
  {
    IThirdAppOpenReport localIThirdAppOpenReport = sThirdAppReporter;
    if (localIThirdAppOpenReport != null) {
      localIThirdAppOpenReport.report(paramContext, paramIntent, paramInt);
    }
  ...
  public static void startActivityForResult(Activity paramActivity, Intent paramIntent, int paramInt, Bundle paramBundle)
  {
    IThirdAppOpenReport localIThirdAppOpenReport = sThirdAppReporter;
    if (localIThirdAppOpenReport != null) {
      localIThirdAppOpenReport.startActivityForResult(paramActivity, paramIntent, paramInt, paramBundle);
    }
