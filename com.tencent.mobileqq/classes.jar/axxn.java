  ...
  implements Handler.Callback
{
  ...
  private ArrayList<axxm> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public axxn(CameraCaptureView paramCameraCaptureView, long paramLong)
  {
    super(paramLong);
  ...
  private void c()
  {
    try
    {
      if ((this.jdField_a_of_type_Boolean) && (this.jdField_c_of_type_JavaLangString != null) && (this.jdField_f_of_type_Boolean) && (!this.jdField_c_of_type_Boolean))
      {
        ...
        this.jdField_a_of_type_Axnn.a(201, -1, localBundle);
  ...
  public void a()
  {
    ...
    try
    {
      ...
      Bundle localBundle = a();
      this.jdField_a_of_type_Axnn.a(208, -1, localBundle);
      if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_e_of_type_JavaLangString != null)
    {
      ...
      localazjw = new azjw();
      localazjw.jdField_a_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
      localazjw.jdField_b_of_type_JavaLangString = c();
      localazjw.jdField_a_of_type_Int = 0;
      localazjw.d = paramInt;
      localazjw.c = azib.n;
      if (azib.p != 2) {
        break label178;
      }
      localazjw.jdField_b_of_type_Int = 16;
      if (azib.o != 16) {
        break label188;
      }
      localazjw.e = 1;
    ...
    for (;;)
    {
      ...
      return;
      label178:
      localazjw.jdField_b_of_type_Int = 8;
      break;
      label188:
      localazjw.e = 2;
      break label101;
      label197:
      paramInt = AudioEncoder.a(localazjw);
      if (paramInt == 0) {
        break label256;
      }
      this.jdField_a_of_type_JavaUtilHashMap.put("param_audio_error", String.valueOf(paramInt));
  ...
  public void a(int paramInt, long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_Axnn.a(207, -1, localBundle);
    atlr.c();
    if (QLog.isColorLevel()) {
  ...
  public void a(axxm paramaxxm, boolean paramBoolean, MediaFormat paramMediaFormat)
  {
    int i = paramaxxm.a();
    long l = paramaxxm.a();
    String str = paramaxxm.a();
    if (QLog.isColorLevel()) {
      QLog.d("SegmentManager", 2, "onEncodeVideoSegment:" + paramaxxm);
    }
    int j = paramMediaFormat.getInteger("width");
    int k = paramMediaFormat.getInteger("height");
    paramaxxm = a();
    paramaxxm.putString("video_slice_path", str);
    paramaxxm.putInt("video_slice_index", i);
    paramaxxm.putInt("video_slice_width", j);
    paramaxxm.putInt("video_slice_height", k);
    paramaxxm.putLong("video_slice_timestamp", l);
    this.jdField_a_of_type_Axnn.a(200, -1, paramaxxm);
    if (i == 0) {
    ...
    if (paramBoolean)
    {
      ...
      paramaxxm = a();
      this.jdField_a_of_type_Axnn.a(204, -1, paramaxxm);
      c();
    }
  }
  ...
  public void b()
  {
    ...
    Bundle localBundle = a();
    this.jdField_a_of_type_Axnn.a(206, -1, localBundle);
    a();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    try
    {
      ...
      case 1: 
        ...
        this.jdField_a_of_type_Axxm = new axxm(d(), i);
        this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Axxm);
        if (QLog.isColorLevel()) {
          QLog.d("SegmentManager", 2, "Muxer_Start :" + this.jdField_a_of_type_Axxm);
        }
        this.jdField_a_of_type_AndroidMediaMediaMuxer = new MediaMuxer(this.jdField_a_of_type_Axxm.a(), 0);
    ...
    paramMessage = (axvl)paramMessage.obj;
    ...
    for (;;)
    {
      ...
      if (a(l, bool))
      {
        ...
        this.jdField_b_of_type_Long = 0L;
        this.jdField_a_of_type_AndroidMediaMediaMuxer.release();
        a(this.jdField_a_of_type_Axxm, false, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a());
        i = this.jdField_a_of_type_JavaUtilArrayList.size();
        this.jdField_a_of_type_Axxm = new axxm(d(), i);
        this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Axxm);
        this.jdField_a_of_type_AndroidMediaMediaMuxer = new MediaMuxer(this.jdField_a_of_type_Axxm.a(), 0);
      ...
      this.jdField_a_of_type_Axxm.a(paramMessage);
      ...
      return true;
      if (QLog.isColorLevel()) {
        QLog.d("SegmentManager", 2, "Muxer_Stop :" + this.jdField_a_of_type_Axxm);
      }
      this.jdField_a_of_type_AndroidMediaMediaMuxer.release();
      a(this.jdField_a_of_type_Axxm, true, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a());
      return true;
      return true;
      boolean bool = true;
      continue;
