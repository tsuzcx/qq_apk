...
{
  public adcb(ChatSettingForTroop paramChatSettingForTroop) {}
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      str = "msg_open";
      label116:
      bcef.b(localQQAppInterface, "dc00899", "Grp_msg", "", "Grp_data", str, 0, 0, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, "", "", "");
      if (!paramBoolean) {
        break label224;
      }
    }
    ...
    {
      bftc.a("Grp_msg", "grpData_admin", str, 0, 0, new String[] { this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, bftc.a(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData) });
      break;
      if (i == 1) {
        break;
      }
