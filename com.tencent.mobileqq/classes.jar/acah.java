...
public class acah
  implements Runnable
{
  public acah(ConfigServlet paramConfigServlet, ConfigurationService.Config paramConfig, QQAppInterface paramQQAppInterface) {}
  ...
  public void run()
  {
    ...
    int j = SharedPreUtils.A(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp());
    ...
    for (;;)
    {
      ...
      if ((m == 2598) || (m == 4448))
      {
        ...
        continue;
        if ((bool2) && (bool1)) {
          SharedPreUtils.t(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getBaseContext(), k);
        }
        for (;;)
        {
