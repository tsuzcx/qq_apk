...
public class akwv
{
  ...
  public static Bundle a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    for (;;)
    {
      ...
      {
        j = 5;
        localObject = bglf.q(paramQQAppInterface, paramQQAppInterface.getCurrentAccountUin());
        paramSessionInfo = (SessionInfo)localObject;
        i = j;
  ...
  public static String a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = ((anmw)paramQQAppInterface.getManager(51)).e(str);
  ...
  {
    paramString1 = a(paramString2, paramString1, paramInt1, paramString3, paramString4, paramString7, paramSessionInfo.b, paramInt2, paramInt3, paramInt4, paramString8, paramInt5, paramBundle, paramSessionInfo.jdField_a_of_type_JavaLangString);
  ...
  public static JSONObject a(QQAppInterface paramQQAppInterface, MessageForQQWalletMsg paramMessageForQQWalletMsg, QQWalletBaseMsgElem paramQQWalletBaseMsgElem, int paramInt1, SessionInfo paramSessionInfo, int paramInt2, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    for (;;)
    {
      paramQQWalletBaseMsgElem = a(paramString2, paramString1, paramInt2, paramString3, paramString4, paramString7, paramMessageForQQWalletMsg.senderuin, paramInt1, i, j, "", paramMessageForQQWalletMsg.fromHBList, null, paramSessionInfo.jdField_a_of_type_JavaLangString);
      try
      {
      ...
      catch (Exception paramSessionInfo)
      {
        try
        {
          do
          {
            ...
            paramSessionInfo.put("senderuin", acwh.c(paramMessageForQQWalletMsg));
            return paramSessionInfo;
            paramSessionInfo = paramSessionInfo;
          } while (!QLog.isDevelopLevel());
          paramSessionInfo.printStackTrace();
  ...
  public static boolean a(Context paramContext)
  {
    ...
    if (bggq.a(paramContext, 650.0F) < localDisplayMetrics.heightPixels) {}
