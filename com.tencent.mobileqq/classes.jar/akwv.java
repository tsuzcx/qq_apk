...
public class akwv
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, RecentBaseData paramRecentBaseData)
  {
    ...
    case 7230: 
      ...
      if ((paramRecentBaseData instanceof RecentItemPublicAccountChatMsgData))
      {
        ...
        if (advq.a(str2)) {
          aikw.a().a(paramQQAppInterface, 2);
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, AbsListView paramAbsListView, int paramInt)
  {
    ...
    do
    {
      ...
      } while (!(paramAbsListView.getAdapter() instanceof bfrr));
      localObject = (bfrr)paramAbsListView.getAdapter();
    } while (!(((bfrr)localObject).getWrappedAdapter() instanceof ahmx));
    b.clear();
    ahmx localahmx = (ahmx)((bfrr)localObject).getWrappedAdapter();
    ...
    if (i < k - 1)
    {
      paramAbsListView = localahmx.getItem(i);
      String str;
      if ((paramAbsListView instanceof RecentBaseData))
      {
        ...
        if (!a.containsKey(str))
        {
          ...
          aikw.a().a(paramQQAppInterface, 1);
        }
      ...
      do
      {
        for (;;)
        {
          i += 1;
          break;
          if ((!(localRecentBaseData instanceof RecentItemServiceAccountFolderData)) || (!advq.a(sbc.a().a()))) {
            break label186;
          }
          aikw.a().a(paramQQAppInterface, 1);
          break label186;
