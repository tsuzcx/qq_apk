...
public class akwv
  implements aklt, akwu
{
  public static float a;
  public static int a;
  public static int b;
  private long jdField_a_of_type_Long;
  public volatile aklr a;
  akls jdField_a_of_type_Akls;
  public akly a;
  private akme jdField_a_of_type_Akme = new akme(this);
  ...
  public akwv()
  {
    this.jdField_a_of_type_Akly = new akly();
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  }
  
  private aklr a(String paramString)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramString)) {
      return (aklr)this.jdField_a_of_type_JavaUtilMap.get(paramString);
    }
    return null;
  }
  ...
  private void b(GL10 paramGL10)
  {
    ...
    this.jdField_a_of_type_Akme.onDrawFrame(paramGL10);
    ...
    paramGL10 = this.jdField_a_of_type_Aklr;
    if ((paramGL10 != null) && (paramGL10.d()))
    {
      System.currentTimeMillis();
      GLES20.glEnable(2929);
      aklz localaklz = this.jdField_a_of_type_Akly.a(paramGL10.b(), paramGL10.c());
      if (localaklz != null) {
        paramGL10.a(localaklz);
      }
      GLES20.glDisable(2929);
      System.currentTimeMillis();
    }
  ...
  public int a()
  {
    return this.jdField_a_of_type_Akme.a();
  }
  
  public long a()
  {
    return this.jdField_a_of_type_Akly.jdField_a_of_type_Long;
  }
  
  public akly a()
  {
    return this.jdField_a_of_type_Akly;
  }
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Akme.b(paramInt);
  }
  ...
  public void a(int paramInt1, SurfaceTexture paramSurfaceTexture, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    this.jdField_a_of_type_Akme.a(paramInt1, paramSurfaceTexture);
    this.jdField_a_of_type_Akme.a(paramInt2, paramInt3, paramInt4, paramInt5);
  ...
  {
    this.jdField_a_of_type_Akly.a(paramArrayOfFloat);
  }
  
  public void a(long paramLong)
  {
    this.jdField_a_of_type_Akly.jdField_a_of_type_Long = paramLong;
  }
  
  public void a(aklr paramaklr, ArCloudConfigInfo paramArCloudConfigInfo, int paramInt1, int paramInt2, Object paramObject)
  {
    if ((paramArCloudConfigInfo != null) && (paramArCloudConfigInfo.a()) && (this.jdField_a_of_type_Akls != null)) {
      this.jdField_a_of_type_Akls.a(paramArCloudConfigInfo, paramInt1, paramInt2, paramObject);
    }
  }
  ...
  {
    this.jdField_a_of_type_Akly.a(paramaklw);
  }
  ...
  {
    if (this.jdField_a_of_type_Akls == null) {
      return;
    }
    this.jdField_a_of_type_Akls.a(paramArVideoResourceInfo, paramaklt);
  }
  ...
  {
    this.jdField_a_of_type_Akme.a(paramFloatBuffer, paramSize);
  }
  ...
  public boolean a(aklv paramaklv)
  {
    QLog.i("AREngine_UniformGLRenderManagerImpl", 1, "startModelRender. resourceInfo.key = " + paramaklv.jdField_a_of_type_JavaLangString + ", resourceInfo.arType = " + paramaklv.jdField_a_of_type_Int + ", resourceInfo.trackMode = " + paramaklv.jdField_b_of_type_Int);
    if (!this.e)
    {
      QLog.i("AREngine_UniformGLRenderManagerImpl", 1, "startModelRender. fail because of render not ready");
      return false;
    }
    aklr localaklr2 = a(paramaklv.jdField_a_of_type_JavaLangString);
    aklr localaklr1 = localaklr2;
    if (localaklr2 == null)
    {
      localaklr1 = aklx.a(this, paramaklv, this.jdField_a_of_type_AndroidOpenglGLSurfaceView);
      QLog.d("AREngine_UniformGLRenderManagerImpl", 1, "crate new render here 1" + localaklr1);
      this.jdField_a_of_type_JavaUtilMap.put(paramaklv.jdField_a_of_type_JavaLangString, localaklr1);
      QLog.d("AREngine_UniformGLRenderManagerImpl", 1, "crate new render here " + localaklr1);
    }
    if (localaklr1 == null)
    {
      ...
      paramaklv = this.jdField_a_of_type_Aklr;
      this.jdField_a_of_type_Aklr = null;
      this.jdField_a_of_type_AndroidOpenglGLSurfaceView.queueEvent(new UniformGLRenderManagerImpl.1(this, paramaklv));
      return false;
    }
    this.jdField_a_of_type_AndroidOpenglGLSurfaceView.queueEvent(new UniformGLRenderManagerImpl.2(this, localaklr1, paramaklv));
    return true;
  }
  ...
  public boolean a(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    if (this.jdField_a_of_type_Akme != null)
    {
      this.jdField_a_of_type_Akme.a(paramBoolean);
      this.jdField_a_of_type_Akme.a(paramFloat2);
      return true;
    }
    return false;
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext()) {
        ((aklr)localIterator.next()).f();
      }
      this.jdField_a_of_type_JavaUtilMap.clear();
      this.jdField_a_of_type_Aklr = null;
      this.jdField_a_of_type_Akme.g();
      this.jdField_a_of_type_Akly.a();
      this.e = false;
  ...
  {
    if ((this.jdField_a_of_type_Akls == null) || (this.jdField_a_of_type_Aklr == null))
    {
    ...
    default: 
      return;
    case 0: 
      this.jdField_a_of_type_Akls.a(this.jdField_a_of_type_Aklr.c(), paramInt2);
      return;
    case 1: 
      this.jdField_a_of_type_Akls.c(this.jdField_a_of_type_Aklr.c(), paramInt2);
      return;
    case 2: 
      this.jdField_a_of_type_Akls.b(this.jdField_a_of_type_Aklr.c(), paramInt2);
      return;
    }
    this.jdField_a_of_type_Akls.d(this.jdField_a_of_type_Aklr.c(), paramInt2);
  }
  
  public void b(long paramLong)
  {
    this.jdField_a_of_type_Akly.c = paramLong;
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Akls = null;
  }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    while (i != 0)
    {
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqArARRecordVideoRecordController.a(this.jdField_a_of_type_Auzd, i, j);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Akls != null) {
        this.jdField_a_of_type_Akls.a(null, 1001, 0, localBitmap);
      }
  ...
  public void onSurfaceChanged(GL10 paramGL10, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Akye != null) {
      this.jdField_a_of_type_Akye.a(paramGL10, paramInt1, paramInt2);
    }
    this.jdField_a_of_type_Akme.onSurfaceChanged(paramGL10, paramInt1, paramInt2);
    if (this.jdField_a_of_type_Akls != null) {
      this.jdField_a_of_type_Akls.a();
    }
    this.e = true;
  ...
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    ...
    akiq.a().a(paramGL10.glGetString(7937));
    this.jdField_a_of_type_Akme.onSurfaceCreated(paramGL10, paramEGLConfig);
    if (this.jdField_a_of_type_Akye != null) {
      this.jdField_a_of_type_Akye.a(paramGL10);
    }
    ...
    akpa.a(paramGL10.glGetString(7937), paramGL10.glGetString(7936), paramGL10.glGetString(7938), paramEGLConfig.toString());
  }
}
