...
{
  alma(RockDownloaderTask paramRockDownloaderTask) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (1 == paramInt)
    {
      ...
      if (localObject == null)
      {
        ...
        {
          this.a.getRockDownloadListener().onDownloadFail(this.a.getDownloadInfo(), ajjy.a(2131647701), 10003);
          this.a.getRockDownloadListener().onDownloadFinish(this.a.getDownloadInfo());
        }
        allz.a(this.a, "0x800A1E6");
      }
    }
    else
    {
