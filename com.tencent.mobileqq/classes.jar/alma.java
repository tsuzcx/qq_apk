...
public class alma
  extends bdul
{
  public alma(ApolloLinearLayout paramApolloLinearLayout) {}
  ...
  protected void onAuthResponse(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(str)) && ("actionPanel".equals(str)))
      {
        ...
        if (localObject != null)
        {
          ((ImageView)((View)localObject).findViewById(2131377934)).setVisibility(8);
          ...
          if (this.a.b.incrementAndGet() == this.a.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get())
          {
            ...
            this.a.b.set(0);
            this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.a.jdField_a_of_type_Bdul);
          }
          if (paramBoolean)
          {
            ...
            ((bdug)this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71)).a(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 128, "obtained action");
          }
          for (;;)
          {
            ...
            paramObject.put("title", alud.a(2131700843));
            if (TextUtils.isEmpty((String)paramObject.get("content"))) {
              paramObject.put("content", alud.a(2131700842));
            }
            paramObject.put("rightString", alud.a(2131700844));
