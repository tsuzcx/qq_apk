  ...
  extends bkhg
{
  ...
  public bkgw(Context paramContext, String paramString)
  {
  ...
  {
    a();
    this.z = this.jdField_a_of_type_Bkgu.a("alpha", 165L, 500, 0, 255, new LinearInterpolator());
    ...
    while (i2 < this.r)
    {
      this.jdField_a_of_type_ArrayOfInt[i2] = this.jdField_a_of_type_Bkgu.a("alpha", i1, 500, -40, 0, new LinearInterpolator());
      this.jdField_b_of_type_ArrayOfInt[i2] = this.jdField_a_of_type_Bkgu.a("frontFlip", i1, 500, 0, 100, new LinearInterpolator());
      this.jdField_c_of_type_ArrayOfInt[i2] = this.jdField_a_of_type_Bkgu.a("groundOldFlip", i1, 500, 255, 0, new LinearInterpolator());
      QLog.e("CalendarTimeStickerDrawable", 2, "groundOldFlip[i]: " + this.jdField_c_of_type_ArrayOfInt[i2]);
      i2 += 1;
      i1 += 500;
    }
    this.B = i1;
    this.A = this.jdField_a_of_type_Bkgu.a("alpha", 0L, this.B, 0, 100, new LinearInterpolator());
    ...
    for (;;)
    {
      ...
      this.C = this.jdField_a_of_type_Bkgu.a("X", 825L, 1000L, 0, 100, new DecelerateInterpolator());
      return;
