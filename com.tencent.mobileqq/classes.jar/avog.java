  ...
  implements avey
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anni.a(2131704493);
    jdField_b_of_type_JavaLangString = anni.a(2131704492);
    d = anni.a(2131704498);
    jdField_c_of_type_JavaLangString = anni.a(2131704501);
    e = anni.a(2131704497);
    f = anni.a(2131690083);
  }
      ...
      for (;;)
      {
        ...
        try
        {
          if (paramIntent.hasExtra("data"))
          {
            ...
            localJSONObject.put("errMsg", paramIntent.getString("errMsg", anni.a(2131704500)));
            localJSONObject.put("idKey", paramIntent.getString("idKey"));
            localJSONObject.put("allResults", localObject1);
          }
          for (;;)
          {
            bcst.b(null, "dc00898", "", "", "0X8009862", "0X8009862", 0, 0, this.jdField_c_of_type_Int + "", "", this.jdField_b_of_type_Int + "", paramInt + "");
            if (QLog.isColorLevel()) {
            ...
            else
            {
              ...
              localJSONObject.put("errMsg", anni.a(2131704499));
              localJSONObject.put("allResults", localObject1);
              paramInt = 299;
            }
          }
  ...
  private void a(avep paramavep)
  {
    paramavep = paramavep.a();
    if (paramavep != null) {
      paramavep.a(this);
    }
    QLog.d("IdentificationApiPlugin", 1, "doFaceVerify");
    if (((paramavep instanceof avfn)) || ("identify".equals(this.l)))
    {
      e();
      if (!(paramavep instanceof avfn)) {}
    }
    try
    {
      paramavep = new JSONObject();
      paramavep.put("ret", 219);
      paramavep.put("errMsg", f);
      a(paramavep);
      return;
    }
    catch (JSONException paramavep)
    {
      QLog.e("IdentificationApiPlugin", 1, new Object[] { "RET_CODE_AREA_NOT_SUPPORT error : ", paramavep.getMessage() });
    }
  }
  ...
  private void c()
  {
    if (("loginVerify".equals(this.l)) || ("changeSecureMobile".equals(this.l)))
    {
      aves.a(this.jdField_a_of_type_AndroidAppActivity, this.h, this.l, this.n, this.jdField_a_of_type_Long, this.jdField_b_of_type_Int, new avoi(this));
      return;
    }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      d();
      paramJsBridgeListener = avep.a();
      paramJsBridgeListener.a(i1, this.n, paramString3, new avoh(this, paramJsBridgeListener));
      return true;
    }
