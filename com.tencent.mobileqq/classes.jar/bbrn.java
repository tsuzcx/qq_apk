...
final class bbrn
  extends bbry
{
  bbrn(Context paramContext, String paramString, QQAppInterface paramQQAppInterface, ajvj paramajvj) {}
  ...
  public void a(SCGet3rdCloudCheck paramSCGet3rdCloudCheck)
  {
    ...
    if (paramSCGet3rdCloudCheck != null)
    {
      if (paramSCGet3rdCloudCheck.delayHour > 24) {
        bbsc.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, paramSCGet3rdCloudCheck.delayHour);
      }
      if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        ...
        bbrm.b(this.jdField_a_of_type_AndroidContentContext, 398677);
      }
    }
  }
}
