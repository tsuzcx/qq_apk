  ...
  implements bbls
{
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    if (paramMsg.appshare_info.has())
    {
      ...
      localObject1 = bftp.a((msg_comm.PluginInfo)localObject1);
      ...
      if (localObject2 == null)
      {
        ...
        paramMessageHandler.app.getMsgCache().a(((AppShareID)localObject1).strPkgName, (AppShareID)localObject1);
      }
    }
    label296:
    label1779:
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if ((paramMsg.msg_body.has()) && (((im_msg_body.MsgBody)paramMsg.msg_body.get()).rich_text.has()))
      {
        ...
        paramMsg = null;
        localObject1 = BaseApplication.getContext().getString(2131718247);
        ...
        for (;;)
        {
          ...
          for (localObject3 = str1;; localObject3 = null)
          {
            if (localObject3 != null)
            {
              ...
              localObject2 = TransfileUtile.makeTransFileProtocolData((String)localObject3, j, 1, false, (String)localObject3);
              if (QLog.isColorLevel()) {
                ...
                else if (((im_msg_body.Elem)localObject3).custom_face.has())
                {
                  ...
                  for (;;)
                  {
                    ...
                    do
                    {
                      ...
                      if ((!paramBoolean) && (bool1))
                      {
                        paramMessageHandler = (MessageForText)bbli.a(-1000);
                    ...
                    paramMessageHandler.d(String.valueOf(bftp.b(l1)));
                    paramMsg = bfti.a(localAppShareInfo.appshare_cookie.get().toByteArray());
                    if (QLog.isColorLevel()) {
                      QLog.d("AppShareInfoDecoder", 2, "<--decodeC2CMsgPkg_AppShared: content:" + (String)localObject1 + ",opType:" + paramMsg.b);
                    }
                    localObject2 = bfti.a((String)localObject1, (String)localObject2, l1, paramMsg.a);
                    if (QLog.isColorLevel()) {
                      QLog.d("AppShareInfoDecoder", 2, "<--decodeC2CMsgPkg_AppShared : content:" + (String)localObject1 + ",encodeMsg:" + (String)localObject2);
                    }
                    localObject1 = bbli.a(paramMsg.b);
  ...
  public void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, bbkm parambbkm)
  {
    ...
    a(paramMessageHandler, paramList, paramMsg, 0L, 0L, parambbkm.d);
  }
}
