  ...
  extends bblk
{
  ...
  public bblo(QQAppInterface paramQQAppInterface, int paramInt, String paramString, List<bblm> paramList)
  {
    ...
    if (bbup.a(this.jdField_b_of_type_Int))
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        for (m = 1;; m = 0)
        {
          ...
          localSpannableStringBuilder.append(bbup.a((String)this.jdField_b_of_type_JavaUtilList.get(j), (String)this.jdField_c_of_type_JavaUtilList.get(j), 6, false));
          i += 1;
      ...
      {
        this.jdField_c_of_type_JavaLangCharSequence = (this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.wMemberNum + anni.a(2131701351));
        return;
      }
    }
    this.jdField_a_of_type_JavaLangCharSequence = anni.a(2131701360);
    ...
    for (;;)
    {
      ...
      if ((!this.jdField_a_of_type_JavaUtilSet.isEmpty()) && (this.jdField_a_of_type_JavaUtilList != null))
      {
        ...
        for (m = 1;; m = 0)
        {
          ...
          ((SpannableStringBuilder)localObject).append(bbup.a((String)this.jdField_b_of_type_JavaUtilList.get(j), (String)this.jdField_c_of_type_JavaUtilList.get(j), 6, false));
          if (j > 0) {
