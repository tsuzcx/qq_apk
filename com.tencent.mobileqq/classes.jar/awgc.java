  ...
  implements baxl
{
  ...
  public awgc(Context paramContext, QQAppInterface paramQQAppInterface, RecyclerView paramRecyclerView, int paramInt)
  {
  ...
  private void a(awgf paramawgf, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    boolean bool = true;
    ...
    if (paramDrawable == null)
    {
      ...
      if (this.jdField_a_of_type_Ahnt != null) {
        paramDrawable = this.jdField_a_of_type_Ahnt.a(paramRecentBaseData);
      }
      ...
      int j = ((Integer)ahnt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentBaseData.a(), paramRecentBaseData.a()).first).intValue();
      int i = j;
      if (j == 103) {
        i = 1;
      }
      localRecentDynamicAvatarView = paramawgf.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView;
    ...
    for (;;)
    {
      paramawgf.jdField_a_of_type_AndroidWidgetTextView.setText(paramRecentBaseData.b());
      return;
      break;
      label176:
      bool = false;
      break label143;
      label182:
      paramawgf.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView.setImageDrawable(paramDrawable);
    }
  }
  
  private void b(awgf paramawgf, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    if ((paramawgf == null) || (paramRecentBaseData == null)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      a(paramawgf, paramRecentBaseData, localDrawable);
      return;
    }
  }
  ...
  {
    if ((paramViewHolder instanceof awgf))
    {
      RecentBaseData localRecentBaseData = a(paramInt);
      a((awgf)paramViewHolder, localRecentBaseData, null);
    }
  }
  ...
  {
    if ((paramInt == 0) && (this.jdField_a_of_type_Boolean)) {
      return new awge(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562359, paramViewGroup, false));
    }
    return new awgf(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561050, paramViewGroup, false), this.jdField_a_of_type_Awgd);
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String arg3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        if (!(paramBitmap instanceof awgf))
        {
          break label436;
          this.jdField_a_of_type_Long = l;
          break;
        }
        paramBitmap = (awgf)paramBitmap;
