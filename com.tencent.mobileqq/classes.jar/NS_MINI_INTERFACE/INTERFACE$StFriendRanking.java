  ...
  extends MessageMicro<StFriendRanking>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32, 42 }, new String[] { "gameInfo", "friendsNum", "rankingList", "hasmore", "animationPic" }, new Object[] { null, localInteger, null, localInteger, "" }, StFriendRanking.class);
  }
}
