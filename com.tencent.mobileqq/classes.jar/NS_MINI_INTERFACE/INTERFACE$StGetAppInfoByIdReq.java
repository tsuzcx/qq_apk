  ...
  extends MessageMicro<StGetAppInfoByIdReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32, 42, 50, 58 }, new String[] { "extInfo", "appid", "needVersionInfo", "checkDevRight", "firstPath", "envVersion", "fromAppid" }, new Object[] { null, "", localInteger, localInteger, "", "", "" }, StGetAppInfoByIdReq.class);
  }
}
