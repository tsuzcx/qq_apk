...
public class appa
  implements atcj
{
  public appa(NearbyHybridFragment paramNearbyHybridFragment) {}
  ...
  public boolean a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    try
    {
      ...
      if (this.a.jdField_a_of_type_Appb != null) {
        this.a.jdField_a_of_type_Appb.mWebview.callJs(str, new String[] { localJSONObject.toString() });
      }
      return false;
    }
