...
{
  public aazt(EditActivity paramEditActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.a.jdField_a_of_type_Int == 105)
    {
      ...
      do
      {
        bcql.a(this.a, this.a.getString(2131692053), 0).a();
        return;
        Object localObject;
        while (!((Iterator)localObject).hasNext())
        {
          do
          {
            ...
            {
              bcql.a(this.a, this.a.getString(2131692054), 0).a();
              return;
            }
            localObject = (answ)this.a.app.getManager(149);
            localansx = (ansx)this.a.app.getManager(103);
      ...
      localansx.a(localCustomEmotionData, paramView);
      return;
    }
