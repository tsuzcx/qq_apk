  ...
  implements owa
{
  ...
  private void a(ArticleInfo paramArticleInfo, int paramInt, String paramString1, String paramString2)
  {
    ...
    if (poi.a().a(paramArticleInfo, false, poi.jdField_a_of_type_Int)) {
      localHashMap.put("jump_src", Integer.valueOf(pol.a(paramArticleInfo)));
    }
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (localObject1 = ((Context)localObject1).getResources().getString(2131652653);; localObject1 = "")
    {
      ...
      if (paramBaseArticleInfo.jdField_a_of_type_Boolean)
      {
        ...
        if (paramInt < paramBaseArticleInfo.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          prj localprj = (prj)paramBaseArticleInfo.jdField_a_of_type_JavaUtilList.get(paramInt);
          ((JSONObject)localObject2).put("video_jump_url", localprj.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructUrlJumpInfo.jdField_a_of_type_JavaLangString);
          ((JSONObject)localObject2).put("video_cover_url", localprj.c);
          ((JSONObject)localObject2).put("video_title_text", localprj.jdField_b_of_type_JavaLangString);
          ((JSONObject)localObject2).put("rowkey", localprj.jdField_a_of_type_JavaLangString);
          String str1 = bgmq.b(localprj.jdField_a_of_type_Int);
          String str2 = bgmq.c(localprj.jdField_b_of_type_Int);
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (localprj.jdField_a_of_type_Int > 0)) {
      ...
      else
      {
        ...
        while (paramInt < paramBaseArticleInfo.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          localObject2 = (prj)paramBaseArticleInfo.jdField_a_of_type_JavaUtilList.get(paramInt);
          ((JSONObject)localObject1).put("video_jump_url", ((prj)localObject2).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructUrlJumpInfo.jdField_a_of_type_JavaLangString);
          ((JSONObject)localObject1).put("video_cover_url", ((prj)localObject2).c);
          ((JSONObject)localObject1).put("video_title_text", ((prj)localObject2).jdField_b_of_type_JavaLangString);
          ((JSONObject)localObject1).put("rowkey", ((prj)localObject2).jdField_a_of_type_JavaLangString);
          ((JSONObject)localObject1).put("video_duration_text", bgmq.c(((prj)localObject2).jdField_b_of_type_Int));
  ...
  public void a(int paramInt1, Container paramContainer, opw paramopw, int paramInt2)
  {
    ...
    {
      localObject = String.format(paramContainer.getContext().getResources().getString(2131652654), new Object[] { localObject });
      ...
      localObject = (pbz)localViewBase.findViewBaseByName("id_column_list");
      ((pbz)localObject).a(paramopw);
      ((pbz)localObject).a(new ova(this, localArticleInfo, paramContainer));
      ((pbz)localObject).a(new ovb(this, localArticleInfo, paramContainer));
      return;
    }
  }
  ...
  public boolean a(int paramInt, Container paramContainer, opw paramopw, ViewBase paramViewBase)
  {
    ...
    do
    {
      ...
      {
        paramViewBase.setOnClickListener(new ovc(this, paramopw, paramContainer));
        return true;
      }
    } while (!"multi_video_column_tail_click".equals(str));
    paramViewBase.setOnClickListener(new ovd(this, paramopw, paramContainer));
    return true;
  }
}
