  ...
  extends azut
{
  ...
  private TextViewWrapLayout a(Context paramContext)
  {
    ...
    if (!TextUtils.isEmpty(this.c)) {
      paramContext.setBackgroundResource(2130839254);
    }
    d(paramContext);
    return paramContext;
  }
  ...
  private void b(Context paramContext, ViewGroup paramViewGroup)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      int i = aepi.a(11.0F, paramContext);
      int j = aepi.a(14.0F, paramContext);
      paramViewGroup.setPadding(j, i, j, aepi.a(12.0F, paramContext));
    }
  }
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    {
      Object localObject11 = (azus)((Iterator)localObject10).next();
      if ((localObject11 instanceof azwv))
      {
        localObject11 = (azwv)localObject11;
        if (((azwv)localObject11).p == azwv.o) {
          ((azwv)localObject11).p = azwv.m;
        }
      }
    }
    if ((paramView != null) && ((paramView instanceof TextViewWrapLayout)))
    {
      ...
      localObject4 = (azus)((Iterator)localObject9).next();
      ((azus)localObject4).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
      localObject5 = ((azus)localObject4).jdField_a_of_type_JavaLangString;
      if ((("picture".equals(localObject5)) || ("vote".equals(localObject5)) || ("video".equals(localObject5))) && (localObject3 == null)) {
        localObject3 = ((azus)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131368094), paramBundle);
      }
    }
    for (;;)
    {
      ...
      if (("title".equals(localObject5)) && (localObject2 == null))
      {
        ...
        localObject2 = (TextView)((azus)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131379043), paramBundle);
      }
      else if (localObject1 == null)
      {
        if (("summary".equals(localObject5)) || ("timer".equals(localObject5)))
        {
          localObject1 = (TextView)((azus)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131379018), paramBundle);
        }
        else if ("checklist".equals(localObject5))
        {
          paramView = (LinearLayout)((azus)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131378699), paramBundle);
          continue;
          ...
          {
            localObject5 = (azus)((Iterator)localObject10).next();
            ((azus)localObject5).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
            localObject6 = ((azus)localObject5).jdField_a_of_type_JavaLangString;
            if ((("picture".equals(localObject6)) || ("vote".equals(localObject6)) || ("video".equals(localObject6))) && (localObject3 == null)) {
              localObject3 = ((azus)localObject5).a(paramContext, null, paramBundle);
            }
          }
          for (;;)
          {
            ...
            if (("title".equals(localObject6)) && (localObject2 == null))
            {
              ...
              localObject2 = (TextView)((azus)localObject5).a(paramContext, null, paramBundle);
            }
            else if (localObject1 == null)
            {
              if (("summary".equals(localObject6)) || ("timer".equals(localObject6)))
              {
                localObject1 = (TextView)((azus)localObject5).a(paramContext, null, paramBundle);
              }
              else if ("checklist".equals(localObject6))
              {
                paramView = (LinearLayout)((azus)localObject5).a(paramContext, null, paramBundle);
                continue;
                ...
                if ((this.k == 1) || (this.k == 3)) {
                  if (this.k == 1)
                  {
                    localObject2 = new RelativeLayout.LayoutParams(aepi.a(50.0F, (Resources)localObject9), aepi.a(50.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).topMargin = aepi.a(3.0F, (Resources)localObject9);
                    ...
                    ((RelativeLayout.LayoutParams)localObject10).topMargin = aepi.a(12.0F, (Resources)localObject9);
                    ...
                    ((RelativeLayout.LayoutParams)localObject10).leftMargin = aepi.a(10.0F, (Resources)localObject9);
                    ...
                    if (localObject6 != null)
                    {
                      ...
                      i = k;
                      if ((paramContext instanceof azzm))
                      {
                        paramContext = (azzm)paramContext;
                        i = k;
                        if (paramContext != null)
                        {
                          if (TextUtils.isEmpty(paramContext.b())) {
                    ...
                    if (!(paramContext instanceof baae)) {
                      break label1809;
                    }
                    paramContext = ((baae)paramContext).jdField_a_of_type_JavaUtilArrayList;
                ...
                for (;;)
                {
                  ...
                  for (;;)
                  {
                    ...
                    return localObject4;
                    localObject2 = new RelativeLayout.LayoutParams(aepi.a(115.0F, (Resources)localObject9), aepi.a(70.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).topMargin = aepi.a(3.0F, (Resources)localObject9);
                    break label819;
                    label1399:
                    ((RelativeLayout.LayoutParams)localObject10).topMargin = aepi.a(7.0F, (Resources)localObject9);
                    ((RelativeLayout.LayoutParams)localObject7).topMargin = 0;
                    break label881;
                    if (!this.jdField_a_of_type_Boolean)
                    {
                      if (localObject1 != null) {
                        ((TextView)localObject1).setLineSpacing(aepi.a(1.0F, (Resources)localObject9), 1.0F);
                      }
                      localObject2 = new RelativeLayout.LayoutParams(aepi.a(50.0F, (Resources)localObject9), aepi.a(50.0F, (Resources)localObject9));
                      ((RelativeLayout.LayoutParams)localObject2).topMargin = aepi.a(7.0F, (Resources)localObject9);
                      ((RelativeLayout.LayoutParams)localObject2).leftMargin = aepi.a(10.0F, (Resources)localObject9);
                      ((RelativeLayout.LayoutParams)localObject2).addRule(3, ((TextView)localObject5).getId());
                      ((RelativeLayout.LayoutParams)localObject2).addRule(11);
                      ((RelativeLayout.LayoutParams)localObject7).topMargin = aepi.a(5.0F, (Resources)localObject9);
                    ...
                    localObject2 = new RelativeLayout.LayoutParams(aepi.a(32.0F, (Resources)localObject9), aepi.a(32.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).leftMargin = aepi.a(6.0F, (Resources)localObject9);
                    ((RelativeLayout.LayoutParams)localObject2).addRule(11);
