...
public class azxl
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new azxm(this);
  protected Handler a;
  public azxi a;
  protected QQAppInterface a;
  Runnable jdField_a_of_type_JavaLangRunnable = new QzonePhotoGuideNotifyService.1(this);
  
  public azxl(QQAppInterface paramQQAppInterface, azxi paramazxi)
  {
    ...
    try
    {
      paramazxi = new IntentFilter("com.qzonex.localalbum.new_photo_notification_feedback_action");
      paramQQAppInterface.getApp().registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, paramazxi);
      return;
    }
