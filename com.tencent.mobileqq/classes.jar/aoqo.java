...
public class aoqo
  extends aoqf
{
  public aoqo(QQAppInterface paramQQAppInterface, FriendListHandler paramFriendListHandler)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, Oidb_0x5d1.RspBody paramRspBody)
  {
    ...
    if ((i == 1) && (paramRspBody.msg_set_friend_id.has()))
    {
      ...
      if (j == 0)
      {
        paramRspBody = ((anyw)localObject2).e(String.valueOf(l1));
        paramToServiceMsg = (ToServiceMsg)localObject1;
        if (paramRspBody != null)
        {
          paramRspBody.setShieldFlag(true);
          ((anyw)localObject2).a(paramRspBody);
          paramToServiceMsg = this.a.getCurrentAccountUin();
          paramRspBody = anzj.a(2131703770);
          l2 = bcrg.a();
          localObject2 = bcry.a(-2012);
    ...
    do
    {
      ...
      if ((i == 2) && (paramRspBody.msg_clear_friend_id.has()))
      {
        ...
        if (j == 0)
        {
          paramToServiceMsg = ((anyw)localObject2).e(String.valueOf(l1));
          if (paramToServiceMsg != null)
          {
            paramToServiceMsg.setShieldFlag(false);
            ((anyw)localObject2).a(paramToServiceMsg);
            paramToServiceMsg = this.a.getCurrentAccountUin();
            paramRspBody = anzj.a(2131703773);
            l2 = bcrg.a();
            localObject1 = bcry.a(-2012);
