...
public class aszu
{
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt1, int paramInt2, int paramInt3, atac paramatac)
  {
    ...
    try
    {
      ...
      new aslr(paramQQAppInterface).a(24624).b(10).a(new aszw(paramInt2, paramatac)).a(new aszv(paramatac, paramInt2)).a(localReadNearUserFeedsReq.toByteArray());
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt, atab paramatab)
  {
    ...
    new aslr(paramQQAppInterface).a(22528).b(5).a(new aszy(paramatab, paramString)).a(new aszx(paramatab, paramString)).a(localDelFeedReq.toByteArray());
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, atad paramatad)
  {
    new aslv(paramQQAppInterface).a(paramString, new aszz(paramatad), null);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, atae paramatae)
  {
    new aslv(paramQQAppInterface).b(paramString, new ataa(paramatae), null);
  }
}
