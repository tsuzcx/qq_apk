  ...
  extends ahlb
{
  ...
  public void a()
  {
    ...
    {
      if (localRMVideoStateMgr.jdField_a_of_type_Awky != null) {
        localRMVideoStateMgr.jdField_a_of_type_Awky.a(localRMVideoStateMgr);
      }
      if (localRMVideoStateMgr.jdField_a_of_type_Ahlj != null) {
        localRMVideoStateMgr.jdField_a_of_type_Ahlj.o();
      }
  ...
  public void a(AVCodec.AVCodecCallback paramAVCodecCallback, MessageStruct paramMessageStruct)
  {
    ...
    paramAVCodecCallback.jdField_a_of_type_Ahkv = null;
  ...
  {
    if ((paramObject instanceof awix)) {
      switch (paramInt)
      {
      }
    }
      ...
      if (paramVarArgs != null) {
        if ((paramVarArgs[0] instanceof Boolean))
        {
          ...
          if ((localObject != null) && (((String)localObject).endsWith(":story"))) {
            urp.b("take_video", "camera_initial", 0, 0, new String[0]);
          }
        ...
        else if ((paramVarArgs[0] instanceof String))
        {
          ...
          {
            this.d = true;
            RMVideoStateMgr.a().a(2002, ajjy.a(2131647676), false);
          }
          if (QLog.isColorLevel()) {
            QLog.d("RMVideoInitState", 2, "[@] EVENT_CREATE_CAMERA, error = " + paramVarArgs[0]);
          }
          if (1 == ahhk.a) {
            bghf.a(awha.a + "", "qzone_video_record", "2", null);
          }
          localObject = BaseApplicationImpl.sApplication.getQQProcessName();
          if ((localObject != null) && (((String)localObject).endsWith(":story")))
          {
            urp.b("take_video", "camera_initial", 0, -1, new String[0]);
            continue;
            if ((paramVarArgs != null) && ((paramVarArgs[0] instanceof String)))
            {
              ...
              {
                this.d = true;
                RMVideoStateMgr.a().a(2003, ajjy.a(2131647671), false);
              }
              if (QLog.isColorLevel()) {
              ...
              if (1 == ahhk.a)
              {
                bghf.a(awha.a + "", "qzone_video_record", "3", null);
                continue;
                if (!this.d)
                {
                  this.d = true;
                  RMVideoStateMgr.a().a(2002, ajjy.a(2131647669), false);
                }
                if (QLog.isColorLevel()) {
                ...
                if (1 == ahhk.a)
                {
                  bghf.a(awha.a + "", "qzone_video_record", "4", null);
                  continue;
                  if ((paramObject instanceof AudioCapture))
                  {
                    ...
                    case 3: 
                      ...
                      else
                      {
                        if (QLog.isColorLevel())
                        {
                          ...
                          QLog.d("RMVideoInitState", 2, "[@] EVENT_INIT [error]mAudioSampleRate=" + awje.q + " mAudioChannel=" + awje.o + " mAudioFormat=" + awje.p);
                        }
                        ...
                        while (1 == ahhk.a)
                        {
                          bghf.a(awha.a + "", "qzone_video_record", "5", null);
                          break;
                          if (QLog.isColorLevel()) {
                    ...
                    case 5: 
                      ...
                      for (;;)
                      {
                        ...
                        {
                          RMVideoStateMgr.a().b(0, ajjy.a(2131647672), false);
                          ((RMVideoStateMgr)localObject).h = true;
                        }
                        if (1 != ahhk.a) {
                          break;
                        }
                        bghf.a(awha.a + "", "qzone_video_record", "6", null);
                        break;
                        ((RMVideoStateMgr)localObject).c(false);
                      }
                    case 6: 
    ...
    for (;;)
    {
      if (!((RMVideoStateMgr)localObject).h)
      {
        RMVideoStateMgr.a().b(0, ajjy.a(2131647667), false);
        ((RMVideoStateMgr)localObject).h = true;
      }
      if (1 != ahhk.a) {
        break;
      }
      bghf.a(awha.a + "", "qzone_video_record", "7", null);
      break;
      ((RMVideoStateMgr)localObject).c(false);
    }
  }
