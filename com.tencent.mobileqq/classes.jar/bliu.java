...
{
  bliu(blis paramblis, Context paramContext, LinearLayoutManager paramLinearLayoutManager)
  {
    super(paramContext);
  }
  ...
  {
    return blis.a(this.jdField_a_of_type_Blis) / paramDisplayMetrics.densityDpi;
  }
  ...
  {
    paramView = blis.a(this.jdField_a_of_type_Blis, this.jdField_a_of_type_AndroidSupportV7WidgetLinearLayoutManager, paramView);
    int i = paramView[0];
    int j = paramView[1];
    ...
    bliy.a(blis.a(this.jdField_a_of_type_Blis));
  }
}
