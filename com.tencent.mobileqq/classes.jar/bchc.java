  ...
  implements Manager
{
  ...
  private static final String[] b = { "", alpo.a(2131713950), alpo.a(2131713946) };
  protected SparseArray<String[]> a;
  protected final QQAppInterface a;
  protected LinkedHashMap<String, bchd> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = ".troop.school_troop." + bchc.class.getSimpleName();
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { "", alpo.a(2131713947), alpo.a(2131713949) };
  }
  
  public bchc(QQAppInterface paramQQAppInterface)
  {
  ...
  public bchd a(SessionInfo paramSessionInfo, MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      str1 = l2 + "_" + i;
      localbchd = (bchd)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(str1);
      if (localbchd == null) {
        break;
      }
      paramSessionInfo = localbchd;
    ...
    bchd localbchd = new bchd();
    localbchd.jdField_a_of_type_Long = l2;
    localbchd.jdField_a_of_type_Int = i;
    localbchd.jdField_a_of_type_JavaLangString = paramSessionInfo.jdField_a_of_type_JavaLangString;
    localbchd.a(paramMessageRecord);
    ...
    while (i < k)
    {
      ...
      while (j < n)
      {
        ...
        if (i1 != -1)
        {
          localbchd.jdField_b_of_type_Int = m;
          localbchd.jdField_b_of_type_JavaLangString = str2;
          localbchd.c = i1;
          localbchd.d = (str2.length() + i1);
          this.jdField_a_of_type_JavaUtilLinkedHashMap.put(str1, localbchd);
          return localbchd;
        }
        j += 1;
      }
    ...
    localbchd.jdField_b_of_type_Int = -1;
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put(str1, localbchd);
    if (QLog.isColorLevel()) {
      QLog.i(jdField_a_of_type_JavaLangString, 2, "detectKeyword time cost: " + (System.currentTimeMillis() - l1) + ", result = " + localbchd.jdField_b_of_type_Int);
    }
    return localbchd;
  }
