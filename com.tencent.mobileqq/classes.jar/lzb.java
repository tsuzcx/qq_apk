...
public class lzb
{
  ...
  public static int a(Context paramContext, int paramInt)
  {
    ...
    //   191: aload_0
    //   192: iload_1
    //   193: invokestatic 167	lzb:b	(Landroid/content/Context;I)I
    //   196: istore_2
    //   197: iload_2
    //   198: istore_1
    //   199: aload 5
  ...
  public static void a(long paramLong, int paramInt, Context paramContext, boolean paramBoolean1, String paramString, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      if (AudioHelper.f()) {
        QLog.w("SmallScreenUtils", 1, "avideo actionOn isFloatWindowOpAllowed, isFloatWindowOpAllowed[" + c(paramContext) + "], isCalling[" + msm.d(paramContext) + "], isHome[" + a(paramContext) + "], isNeedStartDialog[" + paramBoolean1 + "], actionOnFrom[" + paramInt + "], seq[" + paramLong + "]");
      }
      if (a(paramContext, paramBoolean1, paramString, paramBoolean2)) {
        bcef.b(null, "CliOper", "", "", "0X80057D8", "0X80057D8", 0, 0, "", "", "", "");
      }
      return;
    }
  ...
  public static void a(Context paramContext, lez paramlez)
  {
    int i = paramlez.jdField_d_of_type_Int;
    int j = paramlez.F;
    int k = paramlez.jdField_g_of_type_Int;
    if (QLog.isColorLevel())
    {
    ...
    if (paramlez.jdField_a_of_type_Lfa.jdField_b_of_type_Int > 0) {
      if (paramlez.jdField_a_of_type_Lfb.a > 0L) {
        paramlez = "0X8005A49";
      }
    }
    for (;;)
    {
      if ((paramlez != null) && (c(paramContext))) {
        bcef.b(null, "CliOper", "", "", paramlez, paramlez, 0, 0, "", "", "", "");
      }
      return;
      if (paramlez.jdField_a_of_type_Lfa.jdField_b_of_type_Int == 5)
      {
        paramlez = "0X8005A48";
      }
      else
  ...
  public static void a(View paramView, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramView != null)
    {
      localObject = paramView.getTag(2131373223);
      if (localObject != null) {
        break label190;
      }
      bool = false;
      ...
      localObject = paramView.getTag(2131373224);
      if (localObject != null) {
        break label203;
      }
      bool = false;
    ...
    for (Object localObject = new AlphaAnimation(0.0F, 1.0F);; localObject = new AlphaAnimation(1.0F, 0.0F))
    {
      ...
      localAnimationSet.setAnimationListener(new lzc(paramView, paramBoolean1));
      paramView.startAnimation(localAnimationSet);
      paramView.setVisibility(0);
      paramView.setTag(2131373224, Boolean.valueOf(paramBoolean1));
      paramView.setTag(2131373223, Boolean.valueOf(paramBoolean2));
      return;
        ...
        if (paramVideoAppInterface.getApp() != null)
        {
          ...
          if (paramVideoAppInterface.a() != null)
          {
            ...
            if (paramVideoAppInterface.a().a() != null)
            {
              ...
              if ((((lez)localObject).jdField_d_of_type_Int == 3) || (((lez)localObject).jdField_d_of_type_Int == 4)) {
                str = String.valueOf(((lez)localObject).jdField_g_of_type_Long);
              }
              ...
              mtt.a((Intent)localObject, paramLong);
  ...
  public static boolean a(Context paramContext)
  {
    ...
    {
      lba.h("SmallScreenUtils", paramContext.getMessage());
      return bool2;
    }
    return bool3;
  }
  ...
  public static boolean e(Context paramContext)
  {
    ...
    do
    {
      ...
      bool2 = mqv.a(jdField_b_of_type_ArrayOfJavaLangString, paramContext.getClassName());
      bool1 = bool2;
      if (!QLog.isDevelopLevel()) {
        break;
      }
  ...
  public static boolean f()
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = bool2;
        if (locallzm.jdField_b_of_type_Int > 0) {
          bool1 = false;
        }
      }
    }
  ...
  public static boolean g()
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = bool2;
        if (locallzm.jdField_d_of_type_Int > 0) {
          bool1 = false;
        }
      }
    }
