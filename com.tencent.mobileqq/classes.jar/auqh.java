  ...
  implements Manager
{
  ...
  public auqh(AppInterface paramAppInterface)
  {
  ...
  public static String a(BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    StringBuilder localStringBuilder = aciy.a().append(paramAppInfo.path.get()).append(":");
  ...
  {
    if (paramInt == 6) {
      bfvl.a().a(paramAppInfo, 102);
    }
    while (paramInt != 1) {
      return;
    }
    bfvl.a().a(paramAppInfo, 101);
  }
  ...
  private void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      setChanged();
      if (i != 0) {
        ajqy.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface);
      }
      return;
      ...
      try
      {
        ...
        if ((localTimeRspBody != null) && (localTimeRspBody.rptMsgAppInfo.has()))
        {
          ...
          if (i < localTimeRspBody.rptMsgAppInfo.size())
          {
            ...
            localObject = (awcl)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(12);
            if (localObject != null) {
              ((awcl)localObject).a(paramString);
            }
          }
        }
        a(localTimeRspBody);
  ...
  private int b(String paramString, int paramInt)
  {
    ...
    //   1: istore 4
    //   3: aload_0
    //   4: getfield 34	auqh:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   7: astore 5
    //   9: aload 5
    //   11: monitorenter
    //   12: aload_1
    ...
    //   20: ireturn
    //   21: aload_0
    //   22: invokevirtual 70	auqh:a	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;
    //   25: astore 6
    //   27: iload 4
    //   29: istore_3
    //   30: aload 6
    ...
    //   37: istore_3
    //   38: aload 6
    //   40: getfield 76	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody:rptMsgNumRedInfo	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   43: invokevirtual 82	com/tencent/mobileqq/pb/PBRepeatMessageField:has	()Z
    //   46: ifeq +182 -> 228
    //   49: aload 6
    //   51: getfield 76	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody:rptMsgNumRedInfo	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   54: invokevirtual 86	com/tencent/mobileqq/pb/PBRepeatMessageField:get	()Ljava/util/List;
    //   57: astore 6
    //   59: aload 6
    //   61: ifnonnull +19 -> 80
    //   64: ldc 180
    //   66: invokestatic 44	auqh:a	(Ljava/lang/String;)V
    //   69: aload 5
    //   71: monitorexit
    //   72: iconst_0
    //   73: ireturn
    ...
    //   108: checkcast 105	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedInfo
    //   111: getfield 183	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedInfo:num_red_path	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   114: invokevirtual 86	com/tencent/mobileqq/pb/PBRepeatMessageField:get	()Ljava/util/List;
    //   117: astore 7
    //   119: aload 7
    //   121: ifnull -30 -> 91
    //   124: aload 7
    ...
    //   138: istore_3
    //   139: aload 7
    //   141: invokeinterface 99 1 0
    //   146: ifeq -55 -> 91
    //   149: aload 7
    //   151: invokeinterface 103 1 0
    //   156: checkcast 191	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedPath
    //   159: astore 8
    //   161: aload 8
    //   163: getfield 572	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedPath:str_path	Lcom/tencent/mobileqq/pb/PBStringField;
    //   166: invokevirtual 151	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   169: aload_1
    //   170: invokevirtual 527	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   173: ifeq -37 -> 136
    //   176: bipush 100
    //   178: iload_2
    //   179: if_icmpne +29 -> 208
    //   182: aload 8
    //   184: getfield 203	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedPath:uint32_msg_status	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   187: invokevirtual 114	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   190: ifeq +49 -> 239
    //   193: iconst_1
    //   194: aload 8
    //   196: getfield 203	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedPath:uint32_msg_status	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   199: invokevirtual 114	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   202: if_icmpne +31 -> 233
    //   205: goto +34 -> 239
    //   208: aload 8
    //   210: getfield 203	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedPath:uint32_msg_status	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   213: invokevirtual 114	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   216: iload_2
  ...
  private void b(BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    for (int i = 1;; i = 2)
    {
      awqx.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00899", "Grp_tribe", "", "dynamic", "Clk_tribe", 0, 0, i + "", "", "", "");
      ...
      a(pde.a("OidbSvc.0xd40_0", 3392, 0, paramAppInfo.toByteArray()));
      return;
    }
  }
  ...
  private void c()
  {
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        try
        {
          byte[] arrayOfByte = bace.a(localFile);
          if (arrayOfByte != null) {
            break;
          }
  ...
  private void d()
  {
    ...
    {
      ((ajqy)((QQAppInterface)localObject).a(87)).a(true, true);
      return;
    }
    ...
    for (;;)
    {
      ...
      if (999999 != localAppInfo.uiAppId.get())
      {
        ...
        if (localAppInfo.iNewFlag.get() == 1)
        {
          ...
          if (!ajlj.a(paramQQAppInterface, localAppInfo.uiAppId.get(), paramBoolean, paramMap))
          {
            localObject4 = localObject1;
            localObject1 = localObject2;
            localObject2 = localObject4;
          ...
          if (localRedTypeInfo.red_type.get() == 5)
          {
            ...
            {
              if (QLog.isDevelopLevel()) {
                QLog.e("RedPointManage", 4, "getRedTouchInfoForLeba, content=" + localObject1.red_content.get() + ", path=" + localAppInfo.path.get() + ",redTypeInfoContent=" + localRedTypeInfo.red_content.get());
              }
              localObject2 = localObject1.red_content;
              localObject5 = new StringBuilder();
              j = Integer.parseInt(localObject1.red_content.get());
          ...
          {
            localObject5 = localObject4;
            if (localObject4.red_priority.get() >= localRedTypeInfo.red_priority.get()) {}
          }
          else
          {
            localObject3 = localObject1;
            ...
            if (QLog.isColorLevel())
            {
              ...
              QLog.e("RedPointManage", 2, "getRedTouchInfoForLeba result != nullpathList = " + localStringBuilder.toString());
            }
            for (;;)
            {
              return localObject3;
              label758:
              QLog.e("RedPointManage", 2, "getRedTouchInfoForLeba result = null");
            }
          }
        }
      }
    ...
    if (paramArrayOfByte != null) {
      try
      {
        ...
        while (paramArrayOfByte.hasNext())
        {
          ...
          if ((a((Submsgtype0x89.NumRedBusiInfo)localObject)) && (auqk.a((Submsgtype0x89.NumRedBusiInfo)localObject))) {
  ...
  public void a(long[] paramArrayOfLong, String paramString, auqd paramauqd)
  {
    ((auqe)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(65)).a(paramArrayOfLong, paramString, paramauqd);
  }
  ...
  public boolean a(BusinessInfoCheckUpdate.TimeRspBody paramTimeRspBody)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 36	auqh:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   4: invokevirtual 130	com/tencent/common/app/AppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   7: astore 5
    //   9: aload_0
    //   10: getfield 34	auqh:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   13: astore 4
    //   15: aload 4
    //   17: monitorenter
    //   18: aload_1
    //   19: invokevirtual 1057	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody:toByteArray	()[B
    //   22: astore 6
    //   24: aload 4
    //   26: monitorexit
    //   27: getstatic 29	auqh:b	Ljava/lang/Object;
    //   30: astore 4
    //   32: aload 4
    //   34: monitorenter
    //   35: getstatic 24	auqh:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   38: invokevirtual 1060	java/util/concurrent/atomic/AtomicInteger:incrementAndGet	()I
    //   41: istore_2
    //   42: new 656	java/io/File
    //   45: dup
    //   46: aload_0
    //   47: getfield 36	auqh:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   50: invokevirtual 659	com/tencent/common/app/AppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   53: invokevirtual 665	mqq/app/MobileQQ:getFilesDir	()Ljava/io/File;
    //   56: new 153	java/lang/StringBuilder
    //   59: dup
    //   60: invokespecial 288	java/lang/StringBuilder:<init>	()V
    //   63: ldc_w 667
    ...
    //   74: invokevirtual 177	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   77: invokespecial 670	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   80: invokevirtual 1063	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   83: aload 6
    //   85: iconst_0
    //   86: invokestatic 1066	bace:a	(Ljava/lang/String;[BZ)Z
    //   89: istore_3
    //   90: iload_3
    //   91: ifeq +91 -> 182
    //   94: getstatic 1069	awcl:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   97: aload 5
    //   99: iconst_0
    //   100: invokestatic 1074	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   103: invokevirtual 1077	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   106: pop
    //   107: aload 4
    //   109: monitorexit
    //   110: aload_0
    //   111: getfield 34	auqh:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   114: astore 4
    //   116: aload 4
    //   118: monitorenter
    //   119: iload_3
    //   120: ifeq +18 -> 138
    //   123: iload_2
    //   124: getstatic 24	auqh:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   127: invokevirtual 1078	java/util/concurrent/atomic/AtomicInteger:get	()I
    //   130: if_icmpne +8 -> 138
    //   133: aload_0
    //   134: aload_1
    //   135: invokespecial 1080	auqh:b	(Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;)V
    //   138: aload 4
    //   140: monitorexit
    //   141: iload_3
    //   142: ireturn
    ...
    //   148: ldc_w 1082
    //   151: aload_1
    //   152: invokestatic 365	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   155: aload 4
    //   157: monitorexit
    //   158: iconst_0
    //   159: ireturn
    ...
    //   170: iconst_1
    //   171: ldc_w 1084
    //   174: invokestatic 425	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   177: aload 4
    //   179: monitorexit
    //   180: iconst_0
    //   181: ireturn
    ...
    //   185: iconst_1
    //   186: ldc_w 1086
    //   189: invokestatic 425	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   192: goto -85 -> 107
    //   195: astore_1
    //   196: aload 4
    //   198: monitorexit
  ...
  public boolean b(int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 34	auqh:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   4: astore_3
    //   5: aload_3
    //   6: monitorenter
    //   7: iload_1
    ...
    //   14: ireturn
    //   15: aload_0
    //   16: invokevirtual 70	auqh:a	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;
    //   19: astore 4
    //   21: aload 4
    //   23: ifnonnull +7 -> 30
    //   26: aload_3
    ...
    //   29: ireturn
    //   30: aload 4
    //   32: getfield 76	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody:rptMsgNumRedInfo	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   35: invokevirtual 86	com/tencent/mobileqq/pb/PBRepeatMessageField:get	()Ljava/util/List;
    //   38: astore 4
    //   40: aload 4
    //   42: ifnull +66 -> 108
    //   45: aload 4
    ...
    //   71: checkcast 105	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedInfo
    //   74: astore 5
    //   76: aload 5
    //   78: getfield 109	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedInfo:appid	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   81: invokevirtual 114	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   84: iload_1
    //   85: if_icmpne -31 -> 54
    //   88: aload 5
    //   90: getfield 1137	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedInfo:flag	Lcom/tencent/mobileqq/pb/PBBoolField;
    //   93: invokevirtual 832	com/tencent/mobileqq/pb/PBBoolField:get	()Z
    //   96: istore_2
    //   97: aload_3
    //   98: monitorexit
    //   99: iload_2
