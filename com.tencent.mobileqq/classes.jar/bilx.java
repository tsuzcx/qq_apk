...
public class bilx
{
  ...
  private bikz jdField_a_of_type_Bikz = new bikz();
  ...
  private void e(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_Bikz.a(paramFloat1, paramFloat2);
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_Bikz.a(this.jdField_b_of_type_AndroidGraphicsRectF, a());
  }
  ...
  public bilu a(float paramFloat1, float paramFloat2)
  {
    RectF localRectF = this.jdField_a_of_type_Bikz.a(paramFloat1, paramFloat2);
    ...
    return new bilu(this.jdField_b_of_type_AndroidGraphicsRectF.centerX() - localRectF.centerX() + paramFloat1, this.jdField_b_of_type_AndroidGraphicsRectF.centerY() - localRectF.centerY() + paramFloat2, c(), b());
  }
  
  public bilu a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    this.jdField_a_of_type_Bikz.d(false);
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor != null)
    {
      this.jdField_a_of_type_Bikz.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor, paramFloat3, paramFloat4);
      ...
      RectF localRectF2 = this.jdField_a_of_type_Bikz.a(paramFloat1, paramFloat2);
      bilu localbilu = new bilu(paramFloat1, paramFloat2, c(), a());
      localbilu.a(biky.b(localRectF2, localRectF1, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
      return localbilu;
    }
    return null;
  }
  ...
  {
    this.jdField_c_of_type_Float = (Math.round((this.jdField_b_of_type_Float + paramInt) / 90.0F) * 90);
    this.jdField_a_of_type_Bikz.a(this.jdField_b_of_type_AndroidGraphicsRectF, a());
  }
  ...
  {
    if (this.jdField_a_of_type_Bikz.c()) {}
  ...
  {
    this.jdField_a_of_type_Bikz.a(paramCanvas);
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Bikz.a();
  }
  ...
  public boolean a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Bikz.a(false);
      this.jdField_a_of_type_Bikz.b(true);
      this.jdField_a_of_type_Bikz.c(false);
      return paramBoolean;
    }
  }
  ...
  public bilu b(float paramFloat1, float paramFloat2)
  {
    return new bilu(paramFloat1, paramFloat2, c(), b());
  }
  ...
  public void b(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor = this.jdField_a_of_type_Bikz.a(paramFloat1, paramFloat2);
  }
  ...
  {
    this.jdField_a_of_type_Bikz.c(paramBoolean);
  }
  ...
  public bilu c(float paramFloat1, float paramFloat2)
  {
    bilu localbilu = new bilu(paramFloat1, paramFloat2, c(), a());
    RectF localRectF1 = new RectF(this.jdField_a_of_type_Bikz.a());
    localRectF1.offset(paramFloat1, paramFloat2);
    if (this.jdField_a_of_type_Bikz.d())
    {
      ...
      localbilu.a(biky.a(localRectF1, localRectF2));
      return localbilu;
    }
    RectF localRectF2 = new RectF();
    if (this.jdField_a_of_type_Bikz.b())
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_Bikz.a(paramFloat1, paramFloat2));
      localbilu.a(biky.a(localRectF1, localRectF2, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
      return localbilu;
    }
    this.jdField_a_of_type_AndroidGraphicsMatrix.setRotate(a(), this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY());
    this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_AndroidGraphicsRectF);
    localbilu.a(biky.b(localRectF1, localRectF2, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
    return localbilu;
  }
  ...
  {
    this.jdField_a_of_type_Bikz.a(paramFloat);
  }
  ...
  public void d(float paramFloat1, float paramFloat2)
  {
    ...
    a();
    this.jdField_a_of_type_Bikz.d(true);
  }
