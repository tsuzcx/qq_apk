  ...
  implements lpa
{
  ...
  public String a;
  public Timer a;
  kzq jdField_a_of_type_Kzq = new lov(this);
  lox jdField_a_of_type_Lox = new lox(this);
  public loz a;
  lrc jdField_a_of_type_Lrc = null;
  public lru a;
  public boolean a;
  ...
  public lou(SmallScreenService paramSmallScreenService)
  {
    ...
    this.jdField_a_of_type_Lru = new low(this);
  ...
  {
    RedPacketGameSmallScreenView localRedPacketGameSmallScreenView = (RedPacketGameSmallScreenView)paramViewGroup.findViewById(2131306751);
  ...
  private void b(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.jdField_a_of_type_Loz != null) && (paramInt != this.jdField_a_of_type_Loz.f())) {
        break;
      }
      return;
    }
    ...
    this.jdField_a_of_type_Loz.g(paramInt);
  ...
  public void a(long paramLong)
  {
    ...
    {
      localObject = this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService.jdField_b_of_type_ComTencentAvSmallscreenSmallScreenRelativeLayout.findViewById(2131309244);
      if (localObject != null) {
        ((View)localObject).findViewById(2131309248).clearAnimation();
      }
    }
    if (this.jdField_a_of_type_JavaUtilTimer != null)
    {
    ...
    {
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.b(this.jdField_a_of_type_Lox);
  ...
  {
    krx.c("SmallScreenVideoController", "notifyEvent :" + paramInteger + "|" + paramObject1 + "|" + paramObject2);
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    if ((paramAppRuntime instanceof VideoAppInterface))
    {
      ...
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(this.jdField_a_of_type_Lox);
  ...
  void a(boolean paramBoolean)
  {
    ...
    if ((localObject != null) && (QLog.isColorLevel())) {
      QLog.d("SmallScreenVideoController", 2, "onCreateUI SessionType = " + ((kvq)localObject).jdField_d_of_type_Int);
    }
    this.jdField_a_of_type_AndroidGraphicsBitmap = mjg.a(this.jdField_a_of_type_AndroidContentContext, 2130841373);
    if (this.jdField_a_of_type_ComTencentAvCameraCameraUtils == null)
    {
    ...
    View localView = this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService.jdField_b_of_type_ComTencentAvSmallscreenSmallScreenRelativeLayout.findViewById(2131297390);
    if (this.jdField_a_of_type_Loz == null)
    {
      this.jdField_a_of_type_Loz = new loz(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, localView, this);
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_ComTencentAvVideoController.f) && (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null)) {
        this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new lol(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Lru);
      }
      if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI != null) {
        this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI.a(paramBoolean);
      }
      if ((localObject != null) && (((kvq)localObject).jdField_g_of_type_Int != 4) && (this.jdField_c_of_type_Int == 1) && (!this.jdField_a_of_type_Boolean))
      {
        int i = bavz.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getAccount(), 6, true, null);
        if (i > 0)
        {
          int j = bavz.a();
          localObject = bavz.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, i, j, null);
          if (localObject != null)
          {
            localObject = new File((String)localObject);
            if ((localObject != null) && (((File)localObject).exists()) && (this.jdField_a_of_type_Loz != null)) {
              this.jdField_a_of_type_Loz.w();
            }
          }
        }
      }
      ...
      if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null) {
        ...
        {
          this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new SmallScreenMultiVideoControlUI(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Lru);
          if (localObject != null)
          {
            this.jdField_c_of_type_Int = ((kvq)localObject).jdField_d_of_type_Int;
            this.jdField_d_of_type_Int = ((kvq)localObject).jdField_f_of_type_Int;
          }
        }
        else
        {
          ...
          if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null) {
            ...
            else if (this.jdField_a_of_type_ComTencentAvVideoController.a().A == 2)
            {
              this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new SmallScreenMultiVideoControlUI(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Lru);
            }
            else
            {
              this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new SmallScreenMultiVideoControlUI(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Lru);
              continue;
              if ((localObject != null) && (((kvq)localObject).a.jdField_b_of_type_Int > 0))
              {
                if (((kvq)localObject).a.jdField_a_of_type_Int == 3) {
                  this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new SmallScreenMultiVideoControlUI(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Lru);
                } else {
                  this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new lol(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Lru);
                }
              }
              else if ((localObject != null) && (((kvq)localObject).jdField_e_of_type_Boolean) && ((((kvq)localObject).jdField_g_of_type_Int == 1) || (((kvq)localObject).jdField_g_of_type_Int == 2))) {
                this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new lol(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Lru);
              }
            }
          }
  ...
  public boolean a(int paramInt)
  {
    ...
    while ((this.jdField_a_of_type_Int == paramInt) || (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null) || (!(this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI instanceof lol))) {
      return false;
    }
    if (!this.jdField_a_of_type_ComTencentAvVideoController.a().k)
    {
      krx.e("SmallScreenVideoController", "Remote not has video, nOff=" + paramInt);
      return false;
    }
    QLog.d("SmallScreenVideoController", 1, "setGlassSwitch nOff=" + paramInt + ", prior=" + this.jdField_a_of_type_Int);
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_ComTencentAvVideoController.a().O = paramInt;
    switch (paramInt)
    {
    }
    for (;;)
    {
      return true;
      this.jdField_a_of_type_Loz.n();
      this.jdField_a_of_type_ComTencentAvVideoController.a(0);
      continue;
      this.jdField_a_of_type_Loz.m();
      this.jdField_a_of_type_ComTencentAvVideoController.a(0);
      continue;
      this.jdField_a_of_type_Loz.n();
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentAvVideoController != null)
      {
        ...
        if ((i == 1) || (i == 2))
        {
          ...
          if ((localkvq.i != 1011) && (!this.jdField_a_of_type_ComTencentAvVideoController.f))
          {
            ...
            if (localkvq.I)
            {
              ...
              localIntent2.putExtra("GroupId", localkvq.jdField_d_of_type_JavaLangString);
        ...
        else
        {
          ...
          if ((l != 0L) || (localException3.a.jdField_b_of_type_Int > 0))
          {
            ...
            else
            {
              ...
              localIntent2.putExtra("sessionType", i);
              localIntent2.putExtra("uinType", mjg.c(j));
              localIntent2.putExtra("isDoubleVideoMeeting", localException3.I);
              localIntent2.putExtra("MultiAVType", localException3.A);
              localIntent2.putExtra("Fromwhere", "SmallScreen");
              try
              {
                this.jdField_a_of_type_AndroidContentContext.startActivity(localIntent2);
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_d_of_type_Int == 2) {
      if (this.jdField_a_of_type_ComTencentAvVideoController.a().j())
      {
        ...
        {
          bool1 = true;
          this.jdField_a_of_type_Loz.a((String)localObject, 1, bool2, false, bool1);
          if ((this.jdField_a_of_type_ComTencentAvVideoController.a().j) && (!this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.c()))
          {
            ...
            this.jdField_a_of_type_Loz.a(true, false);
            this.jdField_a_of_type_Loz.c(l2, this.jdField_a_of_type_ComTencentAvCameraCameraUtils.a());
          }
        }
      }
    }
    ...
    {
      leb localleb = (leb)((ArrayList)localObject).get(i);
      str = String.valueOf(localleb.jdField_a_of_type_Long);
      j = localleb.jdField_a_of_type_Int;
      bool2 = localleb.jdField_a_of_type_Boolean;
      bool3 = localleb.jdField_b_of_type_Boolean;
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      if ((!str.equals(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin())) && (bool3)) {
        this.jdField_a_of_type_Loz.a(str, j, bool3, bool2, bool1);
      }
      i += 1;
      break label436;
      break;
  ...
  void i()
  {
    ...
    this.jdField_f_of_type_Int = this.jdField_a_of_type_ComTencentAvVideoController.a().x;
  ...
  void j()
  {
    if (this.jdField_a_of_type_Lrc == null) {
      this.jdField_a_of_type_Lrc = new loy(this, this.jdField_a_of_type_AndroidContentContext, 2);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Lrc != null) {
      this.jdField_a_of_type_Lrc.enable();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Lrc != null) {
      this.jdField_a_of_type_Lrc.disable();
    }
  }
}
