  ...
  implements agin, Handler.Callback, View.OnClickListener
{
  ...
  private aofu jdField_a_of_type_Aofu = new aghf(this);
  ...
  public aghe(BaseChatPie paramBaseChatPie)
  {
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = (ImageView)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mCustomTitleView.findViewById(2131369240);
    ...
    bekv.a("play#aio_icon_video", (HashMap)localObject);
    return;
  ...
  {
    boolean bool = true;
    Object localObject = (ViewStub)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mCustomTitleView.findViewById(2131365365);
    if (localObject == null) {
    ...
    do
    {
      ...
      return false;
      this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView = ((DiniFlyAnimationView)((View)localObject).findViewById(2131369276));
    } while (this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView != null);
    return false;
  }
  ...
  private boolean d()
  {
    ...
    Object localObject = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app.getManager(QQManagerFactory.TROOP_MANAGER);
    ...
    return ((argm)localObject).jdField_a_of_type_Boolean;
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app.addObserver(this.jdField_a_of_type_Aofu);
    if (!d()) {
      this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setVisibility(8);
    }
    String str = this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app.getCurrentUin() + this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.sessionInfo.curFriendUin;
    ...
    for (float f = 1.0F;; f = 3.0F)
    {
      ...
      try
      {
        if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
        {
          ...
          this.jdField_a_of_type_JavaLangString = nwo.a((InputStream)localObject);
          ((InputStream)localObject).close();
        }
        int i = ((TextView)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mCustomTitleView.findViewById(2131379001)).getCurrentTextColor();
  ...
  public void onClick(View paramView)
  {
    ...
    {
      agkk localagkk = (agkk)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.getHelper(43);
      if (localagkk != null) {
        localagkk.c(1);
      }
    }
