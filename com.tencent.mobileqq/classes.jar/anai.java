  ...
  implements Manager
{
  ...
  public RoamSetting a(String paramString)
  {
    ...
    //   5: areturn
    //   6: aload_0
    //   7: getfield 49	anai:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   10: invokeinterface 140 1 0
    //   15: aload_1
    //   16: invokestatic 144	bfyq:a	(Ljava/lang/String;)I
    //   19: istore_2
    //   20: iload_2
    //   21: iconst_1
    //   22: if_icmpne +106 -> 128
    //   25: aload_0
    //   26: getfield 44	anai:b	Lcom/tencent/commonsdk/cache/QQHashMap;
    //   29: aload_1
    ...
    //   45: astore 4
    //   47: aload_0
    //   48: getfield 21	anai:jdField_a_of_type_Boolean	Z
    //   51: ifne +65 -> 116
    //   54: aload_0
    //   55: getfield 35	anai:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   58: ldc 89
    //   60: aload_1
    ...
    //   97: if_icmpne +46 -> 143
    //   100: aload_0
    //   101: getfield 44	anai:b	Lcom/tencent/commonsdk/cache/QQHashMap;
    //   104: aload_1
    ...
    //   114: astore 4
    //   116: aload_0
    //   117: getfield 49	anai:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   120: invokeinterface 158 1 0
    //   125: aload 4
    //   127: areturn
    //   128: aload_0
    //   129: getfield 42	anai:jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap	Lcom/tencent/commonsdk/cache/QQHashMap;
    //   132: aload_1
    ...
    //   140: goto -103 -> 37
    //   143: aload_0
    //   144: getfield 42	anai:jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap	Lcom/tencent/commonsdk/cache/QQHashMap;
    //   147: aload_1
    ...
    //   162: astore_1
    //   163: aload_0
    //   164: getfield 49	anai:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
  ...
  public void a(RoamSetting paramRoamSetting)
  {
    ...
    int j = bfyq.a(paramRoamSetting.path);
    this.jdField_a_of_type_JavaUtilConcurrentLocksLock.lock();
    if (j == 1) {}
    for (;;)
    {
