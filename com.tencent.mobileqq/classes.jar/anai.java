...
public class anai
  implements bkzq
{
  public anai(CmGameFloatView paramCmGameFloatView) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    default: 
      return;
    case 0: 
      if ((this.a.jdField_a_of_type_Amyo != null) && (this.a.jdField_a_of_type_Amyo.a()))
      {
        QLog.d("cmframe_CmGameFloatView", 1, "pack up game");
        this.a.f();
        if (this.a.jdField_a_of_type_Amti != null) {
          this.a.jdField_a_of_type_Amti.c();
        }
    ...
    for (paramInt = 0;; paramInt = 1)
    {
      ...
      for (paramView = String.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);; paramView = "")
      {
        ...
        return;
        paramView = this.a.jdField_a_of_type_Amyo.a();
      ...
      if ((this.a.jdField_a_of_type_Amyo != null) && (this.a.jdField_a_of_type_Amyo.a()) && (this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)) {}
      try
      {
        ...
        this.a.jdField_a_of_type_Amyo.b(paramView.toString());
        if (this.a.jdField_a_of_type_Amti != null) {
          this.a.jdField_a_of_type_Amti.b();
        }
        if (this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
        {
      ...
      for (paramView = String.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);; paramView = "")
      {
        ...
        PublicFragmentActivity.a(this.a.jdField_a_of_type_Amyo.a(), paramView, ApolloGameInfoFragment.class, 10000);
        if (this.a.jdField_a_of_type_Amti == null) {
          break;
        }
        this.a.jdField_a_of_type_Amti.d();
        return;
        paramInt = 0;
        break label518;
      }
      ...
      if ((!TextUtils.isEmpty(paramView)) && (localActivity != null)) {
        amwn.b(localActivity, paramView);
      }
      for (paramInt = 0;; paramInt = 1)
      {
      ...
      for (boolean bool1 = true;; bool1 = false)
      {
        ...
        if ((bool2) || (!amro.a(this.a.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam))) {
          break label1082;
        }
        paramView.b(true);
        return;
