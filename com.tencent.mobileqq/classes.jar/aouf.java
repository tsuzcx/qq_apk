...
public class aouf
{
  ...
  public long a;
  private aoug jdField_a_of_type_Aoug = new aoug();
  ...
  public aoug a(int paramInt1, int paramInt2)
  {
    if (this.jdField_f_of_type_Boolean)
    {
      ...
      localObject2 = new aoug();
      ((aoug)localObject2).a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
      ((aoug)localObject2).a("CAMERA_MATRIX", arrayOfFloat2);
      ((aoug)localObject2).a("CAMERA_POSITION", localObject1);
      ((aoug)localObject2).a("POSE", arrayOfFloat1);
      return localObject2;
    }
    if (paramInt1 == 100)
    {
      ...
      ((aoug)localObject2).a("CAMERA_POSITION", localObject1);
      ((aoug)localObject2).a("POSE", arrayOfFloat1);
      ((aoug)localObject2).jdField_a_of_type_ArrayOfFloat = this.jdField_e_of_type_ArrayOfFloat;
      return localObject2;
    }
    if (paramInt1 == 8)
    {
      localObject1 = new aoug();
      this.jdField_b_of_type_Int = 1;
      arrayOfFloat1 = new float[jdField_a_of_type_Int];
      arrayOfFloat2 = new float[jdField_a_of_type_Int];
      ...
      Matrix.setIdentityM(arrayOfFloat1, 0);
      ((aoug)localObject1).a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
      ((aoug)localObject1).a("CAMERA_MATRIX", localObject2);
      ((aoug)localObject1).a("CAMERA_POSITION", arrayOfFloat1);
      ((aoug)localObject1).a("POSE", arrayOfFloat2);
      ((aoug)localObject1).jdField_a_of_type_ArrayOfFloat = this.jdField_e_of_type_ArrayOfFloat;
      return localObject1;
    }
    ...
    if ((this.jdField_h_of_type_Boolean) && (((paramInt2 == 0) && (!this.jdField_c_of_type_Boolean)) || (paramInt2 == 2) || ((paramInt2 == 1) && (!this.jdField_d_of_type_Boolean))))
    {
      ...
      localaoug = new aoug();
      localaoug.a("TARGET_SIZE", localObject1);
      localaoug.a("CAMERA_MATRIX", localObject2);
      localaoug.a("CAMERA_POSITION", arrayOfFloat1);
      localaoug.a("POSE", arrayOfFloat2);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aoug.a("TARGET_SIZE", new float[] { 1.0F, 1.0F });
    this.jdField_a_of_type_Aoug.a("POSE", arrayOfFloat1);
    this.jdField_a_of_type_Aoug.a("CAMERA_MATRIX", arrayOfFloat2);
    this.jdField_a_of_type_Aoug.a("CAMERA_POSITION", arrayOfFloat3);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
  }
  
  public void a(int paramInt1, int paramInt2, aoxu paramaoxu)
  {
    ...
    float f3;
    if (paramInt2 == 0) {
      if ((paramaoxu.jdField_a_of_type_Int == 0) || (paramaoxu.jdField_b_of_type_Int == 0))
      {
        this.k[0] = apew.jdField_a_of_type_Int;
        this.k[1] = apew.jdField_b_of_type_Int;
        paramaoxu = new float[jdField_a_of_type_Int];
        Matrix.setIdentityM(paramaoxu, 0);
        Matrix.perspectiveM(paramaoxu, 0, 45.0F, 1.0F * apew.jdField_b_of_type_Int / apew.jdField_a_of_type_Int, 100.0F, 8000.0F);
        float[] arrayOfFloat = new float[16];
        Matrix.setRotateM(arrayOfFloat, 0, 270.0F, 0.0F, 0.0F, 1.0F);
        Matrix.multiplyMM(this.l, 0, arrayOfFloat, 0, paramaoxu, 0);
        if (paramInt2 != 0) {
          break label659;
        }
        f1 = 1.25F;
        if (this.k[0] <= apew.jdField_a_of_type_Int) {
          break label665;
        }
        f2 = this.k[0];
        if (this.k[0] == 0.0F) {
        ...
        f3 = this.k[1] / this.k[0] / (1.0F * apew.jdField_b_of_type_Int / apew.jdField_a_of_type_Int);
        label233:
        if ((f3 <= 1.0F) || (this.k[1] <= apew.jdField_b_of_type_Int)) {
          break label680;
        }
        f1 *= f3;
      }
    ...
    for (;;)
    {
      ...
      paramaoxu = new float[jdField_a_of_type_Int];
      Matrix.setIdentityM(paramaoxu, 0);
      Matrix.translateM(paramaoxu, 0, this.k[1] / 2.0F, -this.k[0] / 2.0F, -f2 / 2.0F * 2.414214F * f1);
      Matrix.rotateM(paramaoxu, 0, 90.0F, 0.0F, 0.0F, 1.0F);
      System.arraycopy(paramaoxu, 0, this.m, 0, jdField_a_of_type_Int);
      ...
      System.arraycopy(this.n, 0, this.j, 0, jdField_a_of_type_Int);
      return;
      this.k[0] = paramaoxu.jdField_a_of_type_Int;
      this.k[1] = paramaoxu.jdField_b_of_type_Int;
      break;
  ...
  public void a(aoud paramaoud)
  {
    ...
    paramaoud = (aoub)paramaoud;
    this.jdField_c_of_type_Int = paramaoud.jdField_a_of_type_Int;
    this.jdField_g_of_type_ArrayOfFloat[0] = paramaoud.jdField_a_of_type_Float;
    this.jdField_g_of_type_ArrayOfFloat[1] = paramaoud.jdField_b_of_type_Float;
    System.arraycopy(paramaoud.jdField_b_of_type_ArrayOfFloat, 0, this.jdField_h_of_type_ArrayOfFloat, 0, jdField_a_of_type_Int);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.lock();
    System.arraycopy(paramaoud.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_i_of_type_ArrayOfFloat, 0, jdField_a_of_type_Int);
    this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
    System.arraycopy(paramaoud.jdField_a_of_type_ArrayOfFloat, 0, this.j, 0, jdField_a_of_type_Int);
  }
  
  public void a(boolean paramBoolean, aouc paramaouc)
  {
    QLog.i("AREngine_ARRenerArumentManager", 1, "start. trackMode = " + paramaouc.jdField_b_of_type_Int + ", arType = " + paramaouc.jdField_a_of_type_Int + ", isObjectAnim = " + paramBoolean);
    this.jdField_f_of_type_Boolean = paramBoolean;
    this.jdField_b_of_type_Int = paramaouc.jdField_b_of_type_Int;
    this.jdField_c_of_type_Int = paramaouc.jdField_c_of_type_Int;
    this.jdField_h_of_type_Boolean = false;
    if ((this.jdField_f_of_type_Boolean) || (paramaouc.jdField_a_of_type_Int == 100) || (paramaouc.jdField_a_of_type_Int == 8))
    {
      this.jdField_g_of_type_Boolean = true;
      return;
    }
    Object localObject;
    if (paramaouc.jdField_a_of_type_Int == 0)
    {
      localObject = (aouo)paramaouc;
      a(this.jdField_b_of_type_Int, paramaouc.jdField_a_of_type_Int, ((aouo)localObject).a);
    }
    for (;;)
    {
      this.jdField_g_of_type_Boolean = true;
      return;
      if ((paramaouc.jdField_a_of_type_Int == 2) || (paramaouc.jdField_a_of_type_Int == 3))
      {
        localObject = (aoux)paramaouc;
        a(this.jdField_b_of_type_Int, paramaouc.jdField_a_of_type_Int, ((aoux)localObject).a);
      }
      else if (paramaouc.jdField_a_of_type_Int == 4)
      {
        localObject = (aova)paramaouc;
        a(this.jdField_b_of_type_Int, paramaouc.jdField_a_of_type_Int, ((aova)localObject).a);
      }
    }
  }
