  ...
  implements DialogInterface.OnDismissListener, View.OnClickListener
{
  ...
  protected vhp a;
  private vhq jdField_a_of_type_Vhq;
  public boolean a;
  protected int b;
  protected View b;
  protected boolean b;
  ...
  public vhl(Activity paramActivity)
  {
    super(paramActivity, 2131755407);
  ...
  public String a()
  {
    ...
    String str = "";
    Object localObject;
    if ((this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.getText() instanceof bdoi))
    {
      localObject = (bdoi)this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.getText();
      if (localObject == null) {
        break label167;
      }
      localObject = ((bdoi)localObject).a();
    }
    for (;;)
    {
      localObject = b(bmpg.b(((String)localObject).replaceAll(anni.a(2131704587), anni.a(2131704589)).replaceAll(anni.a(2131704586), "/MM").replaceAll(BaseApplicationImpl.sApplication.getResources().getString(2131716316), "/chigua")));
      if (this.jdField_a_of_type_JavaUtilList != null) {
        this.jdField_a_of_type_JavaUtilList.clear();
      }
      return ((String)localObject).trim();
      localObject = str;
      if ((this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.getText() instanceof bdod))
      {
        bdod localbdod = (bdod)this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.getText();
        localObject = str;
        if (localbdod != null)
        {
  ...
  public void a(vhp paramvhp)
  {
    this.jdField_a_of_type_Vhp = paramvhp;
  }
  
  public void a(vhq paramvhq)
  {
    this.jdField_a_of_type_Vhq = paramvhq;
  }
  ...
  public int b()
  {
    ...
    int j = bclx.c(this.jdField_a_of_type_AndroidAppActivity) - this.jdField_a_of_type_Int - bclx.a(95.0F);
    int i = j;
    if (bclx.a(this.jdField_a_of_type_AndroidAppActivity))
    {
      int k = bclx.d(this.jdField_a_of_type_AndroidAppActivity);
      i = j - k;
  ...
  protected void c()
  {
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText = ((CommentEditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131378525));
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.setOnInputBackListener(new vhm(this));
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.setEditableFactory(bdoi.c);
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.a();
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363861));
    ...
    this.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidContentSharedPreferences.getInt("GroupSoftKeyboardHeight", afur.a(250.0F, getContext().getResources()));
    QLog.d("QCircleBaseInputPopupWindow", 1, "mEmojiPanel initView() step1 :" + this.jdField_a_of_type_Int);
    if (this.jdField_a_of_type_Int == 0)
    {
      this.jdField_a_of_type_Int = bclx.a(250.0F);
      QLog.d("QCircleBaseInputPopupWindow", 1, "mEmojiPanel initView() step2 :" + this.jdField_a_of_type_Int);
    }
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131363525);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new vhn(this));
  ...
  protected void e()
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationAlphaAnimation.setAnimationListener(new vho(this));
  ...
  public void f()
  {
    if (this.jdField_a_of_type_AndroidAppActivity != null)
    {
      ...
      localIntent.putExtra("param_max", bkyx.l());
  ...
  public void onDismiss(DialogInterface paramDialogInterface)
  {
    ...
    if (this.jdField_a_of_type_Vhq != null) {
      this.jdField_a_of_type_Vhq.a();
    }
  }
}
