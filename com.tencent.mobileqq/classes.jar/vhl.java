...
{
  public vhl(StructingMsgItemBuilder paramStructingMsgItemBuilder, Activity paramActivity, ChatMessage paramChatMessage, AbsStructMsg paramAbsStructMsg, String paramString, ArrayList paramArrayList) {}
  ...
  public void a(PopupMenuDialog.MenuItem paramMenuItem)
  {
    ...
    ((Dialog)localObject).setContentView(2130969238);
    ((Dialog)localObject).show();
    new Handler(this.jdField_a_of_type_AndroidAppActivity.getMainLooper()).postDelayed(new vhm(this, (Dialog)localObject), 1500L);
