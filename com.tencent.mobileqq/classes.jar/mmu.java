...
public final class mmu
  implements Runnable
{
  public mmu(boolean paramBoolean, String paramString1, String paramString2, String paramString3, FastWebRequestUtil.ResponseCallback paramResponseCallback) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        localObject2 = new String(HttpUtil.a(BaseApplicationImpl.getContext(), localException2.toString(), "GET", null, null));
