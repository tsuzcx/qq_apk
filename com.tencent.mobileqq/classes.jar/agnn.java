...
{
  public agnn(ApolloItemBuilder paramApolloItemBuilder) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      k = 0;
      break label95;
      localannm = new annm(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
      localObject = new ApolloActionData();
      ankc localankc = (ankc)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOOLO_DAO_MANAGER);
      if (localankc == null) {
        break label645;
      }
    ...
    for (;;)
    {
      ...
      localannm.jdField_a_of_type_ComTencentMobileqqDataApolloActionData = ((ApolloActionData)localObject);
      if (ApolloItemBuilder.a(this.a).isBarrageMode())
      {
        i = 1;
        localannm.d = i;
        localannm.b = ApolloItemBuilder.a(this.a).inputText;
        localannm.e = ApolloItemBuilder.a(this.a).audioId;
        localannm.jdField_a_of_type_Float = ApolloItemBuilder.a(this.a).audioStartTime;
        localannm.h = 2;
        admh.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, localannm);
        if (anhm.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) != 0) {
          break;
        }
