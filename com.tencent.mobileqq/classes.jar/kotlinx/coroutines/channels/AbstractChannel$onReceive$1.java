...
public final class AbstractChannel$onReceive$1
  implements SelectClause1<E>
{
  public <R> void registerSelectClause1(@NotNull SelectInstance<? super R> paramSelectInstance, @NotNull Function2<? super E, ? super Continuation<? super R>, ? extends Object> paramFunction2)
  {
    ...
    {
      AbstractChannel.access$registerSelectReceiveMode(localAbstractChannel, paramSelectInstance, 0, paramFunction2);
      return;
    }
 ...
 * Qualified Name:     kotlinx.coroutines.channels.AbstractChannel.onReceive.1
