...
public final class ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$1
  extends Lambda
  implements Function1<Throwable, Throwable>
{
  public ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$1(Constructor paramConstructor)
  {
    super(1);
  }
  ...
  public final Throwable invoke(@NotNull Throwable paramThrowable)
  {
    ...
    try
    {
      ...
      paramThrowable = this.$constructor$inlined.newInstance(new Object[] { paramThrowable.getMessage(), paramThrowable });
 ...
 * Qualified Name:     kotlinx.coroutines.internal.ExceptionsConstuctorKt.createConstructor..inlined.safeCtor.1
