...
final class ThreadContextKt$updateState$1
  extends Lambda
  implements Function2<ThreadState, CoroutineContext.Element, ThreadState>
{
  ...
  public final ThreadState invoke(@NotNull ThreadState paramThreadState, @NotNull CoroutineContext.Element paramElement)
  {
    if ((paramElement instanceof ThreadContextElement)) {
      paramThreadState.append(((ThreadContextElement)paramElement).updateThreadContext(paramThreadState.getContext()));
    }
 ...
 * Qualified Name:     kotlinx.coroutines.internal.ThreadContextKt.updateState.1
