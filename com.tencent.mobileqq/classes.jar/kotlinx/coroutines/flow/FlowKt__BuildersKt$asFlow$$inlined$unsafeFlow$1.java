...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$1
  implements Flow<T>
{
  public FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$1(Function0 paramFunction0) {}
  
  @Nullable
  public Object collect(@NotNull FlowCollector paramFlowCollector, @NotNull Continuation paramContinuation)
  {
    paramFlowCollector = paramFlowCollector.emit(this.$this_asFlow$inlined.invoke(), paramContinuation);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__BuildersKt.asFlow..inlined.unsafeFlow.1
