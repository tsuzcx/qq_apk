...
public final class FlowKt__MergeKt$flatMapConcat$$inlined$map$1
  implements Flow<Flow<? extends R>>
{
  public FlowKt__MergeKt$flatMapConcat$$inlined$map$1(Flow paramFlow, Function2 paramFunction2) {}
  
  @Nullable
  public Object collect(@NotNull FlowCollector paramFlowCollector, @NotNull Continuation paramContinuation)
  {
    paramFlowCollector = this.$this_unsafeTransform$inlined.collect((FlowCollector)new FlowKt__MergeKt.flatMapConcat..inlined.map.1.2(paramFlowCollector, this), paramContinuation);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__MergeKt.flatMapConcat..inlined.map.1
