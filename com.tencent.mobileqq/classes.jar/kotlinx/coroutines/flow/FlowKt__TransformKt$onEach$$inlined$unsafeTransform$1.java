...
public final class FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1
  implements Flow<T>
{
  public FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1(Flow paramFlow, Function2 paramFunction2) {}
  
  @Nullable
  public Object collect(@NotNull FlowCollector paramFlowCollector, @NotNull Continuation paramContinuation)
  {
    paramFlowCollector = this.$this_unsafeTransform$inlined.collect((FlowCollector)new FlowKt__TransformKt.onEach..inlined.unsafeTransform.1.2(paramFlowCollector, this), paramContinuation);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__TransformKt.onEach..inlined.unsafeTransform.1
