...
public final class FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1
  implements Flow<T>
{
  public FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1(Flow paramFlow) {}
  
  @Nullable
  public Object collect(@NotNull FlowCollector paramFlowCollector, @NotNull Continuation paramContinuation)
  {
    paramFlowCollector = this.$this_flattenConcat$inlined.collect((FlowCollector)new FlowKt__MergeKt.flattenConcat..inlined.unsafeFlow.1.lambda.1(paramFlowCollector), paramContinuation);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__MergeKt.flattenConcat..inlined.unsafeFlow.1
