...
public final class FlowKt__ZipKt$combineTransform$7
  ...
  implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object>
{
  ...
  public FlowKt__ZipKt$combineTransform$7(Flow[] paramArrayOfFlow, Function3 paramFunction3, Continuation paramContinuation)
  {
  ...
  {
    paramContinuation = new 7(this.$flowArray, this.$transform, paramContinuation);
  ...
  {
    return ((7)create(paramObject1, (Continuation)paramObject2)).invokeSuspend(Unit.INSTANCE);
  }
  ...
  public final Object invokeSuspend(@NotNull Object paramObject)
  {
    ...
    else
    {
      ResultKt.throwOnFailure(paramObject);
      paramObject = this.p$;
      Flow[] arrayOfFlow = this.$flowArray;
      Intrinsics.needClassReification();
      Function0 localFunction0 = (Function0)new FlowKt__ZipKt.combineTransform.7.1(this);
      Function3 localFunction3 = (Function3)new FlowKt__ZipKt.combineTransform.7.2(this, null);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__ZipKt.combineTransform.7
