...
public final class FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1$2
  implements FlowCollector<T>
{
  public FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1$2(FlowCollector paramFlowCollector, FlowKt__TransformKt.filterNot..inlined.unsafeTransform.1 param1) {}
  ...
  {
    InlineMarker.mark(4);
    new FlowKt__TransformKt.filterNot..inlined.unsafeTransform.1.2.1(this, paramContinuation);
    InlineMarker.mark(5);
    FlowCollector localFlowCollector = this.$this_unsafeFlow$inlined;
    if (!((Boolean)this.this$0.$predicate$inlined.invoke(paramObject, paramContinuation)).booleanValue())
    {
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__TransformKt.filterNot..inlined.unsafeTransform.1.2
