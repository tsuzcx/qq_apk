...
public final class FlowKt__CollectionKt$toCollection$$inlined$collect$1
  implements FlowCollector<T>
{
  public FlowKt__CollectionKt$toCollection$$inlined$collect$1(Collection paramCollection) {}
  
  @Nullable
  public Object emit(Object paramObject, @NotNull Continuation paramContinuation)
  {
    this.$destination$inlined.add(paramObject);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__CollectionKt.toCollection..inlined.collect.1
