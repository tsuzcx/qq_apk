...
public final class FlowKt__ChannelsKt$asFlow$$inlined$unsafeFlow$1
  implements Flow<T>
{
  public FlowKt__ChannelsKt$asFlow$$inlined$unsafeFlow$1(BroadcastChannel paramBroadcastChannel) {}
  
  @Nullable
  public Object collect(@NotNull FlowCollector paramFlowCollector, @NotNull Continuation paramContinuation)
  {
    paramFlowCollector = FlowKt.emitAll(paramFlowCollector, this.$this_asFlow$inlined.openSubscription(), paramContinuation);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__ChannelsKt.asFlow..inlined.unsafeFlow.1
