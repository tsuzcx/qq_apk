...
public final class FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1
  implements Flow<T>
{
  public FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1(Flow paramFlow, Function2 paramFunction2) {}
  
  @Nullable
  public Object collect(@NotNull FlowCollector paramFlowCollector, @NotNull Continuation paramContinuation)
  {
    paramFlowCollector = this.$this_unsafeTransform$inlined.collect((FlowCollector)new FlowKt__TransformKt.filterNot..inlined.unsafeTransform.1.2(paramFlowCollector, this), paramContinuation);
  ...
  {
    InlineMarker.mark(4);
    new FlowKt__TransformKt.filterNot..inlined.unsafeTransform.1.1(this, paramContinuation);
    InlineMarker.mark(5);
    Flow localFlow = this.$this_unsafeTransform$inlined;
    paramFlowCollector = (FlowCollector)new FlowKt__TransformKt.filterNot..inlined.unsafeTransform.1.2(paramFlowCollector, this);
    InlineMarker.mark(0);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__TransformKt.filterNot..inlined.unsafeTransform.1
