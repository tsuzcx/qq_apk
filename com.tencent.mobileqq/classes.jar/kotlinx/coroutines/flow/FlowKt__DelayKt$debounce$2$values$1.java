...
final class FlowKt__DelayKt$debounce$2$values$1
  ...
  implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object>
{
  ...
  FlowKt__DelayKt$debounce$2$values$1(FlowKt__DelayKt.debounce.2 param2, Continuation paramContinuation)
  {
  ...
  public final Object invokeSuspend(@NotNull Object paramObject)
  {
    ...
    else
    {
      ResultKt.throwOnFailure(paramObject);
      paramObject = this.p$;
      Flow localFlow = this.this$0.$this_debounce;
      FlowCollector localFlowCollector = (FlowCollector)new FlowKt__DelayKt.debounce.2.values.1.invokeSuspend..inlined.collect.1(paramObject);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.2.values.1
