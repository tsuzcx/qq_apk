...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$3
  implements Flow<R>
{
  public FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$3(Flow paramFlow, Function3 paramFunction3) {}
  
  @Nullable
  public Object collect(@NotNull FlowCollector paramFlowCollector, @NotNull Continuation paramContinuation)
  {
    paramFlowCollector = this.$this_unsafeTransform$inlined.collect((FlowCollector)new FlowKt__TransformKt.unsafeTransform..inlined.unsafeFlow.3.lambda.1(paramFlowCollector, this), paramContinuation);
  ...
  {
    InlineMarker.mark(4);
    new FlowKt__TransformKt.unsafeTransform..inlined.unsafeFlow.3.1(this, paramContinuation);
    InlineMarker.mark(5);
    Flow localFlow = this.$this_unsafeTransform$inlined;
    paramFlowCollector = (FlowCollector)new FlowKt__TransformKt.unsafeTransform..inlined.unsafeFlow.3.lambda.1(paramFlowCollector, this);
    InlineMarker.mark(0);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__TransformKt.unsafeTransform..inlined.unsafeFlow.3
