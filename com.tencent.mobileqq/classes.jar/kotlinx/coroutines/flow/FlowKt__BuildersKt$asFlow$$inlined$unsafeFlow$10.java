...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10
  implements Flow<Long>
{
  public FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10(LongRange paramLongRange) {}
  
  @Nullable
  public Object collect(@NotNull FlowCollector paramFlowCollector, @NotNull Continuation paramContinuation)
  {
    Object localObject1;
    if ((paramContinuation instanceof FlowKt__BuildersKt.asFlow..inlined.unsafeFlow.10.1))
    {
      localObject1 = (FlowKt__BuildersKt.asFlow..inlined.unsafeFlow.10.1)paramContinuation;
      if ((((FlowKt__BuildersKt.asFlow..inlined.unsafeFlow.10.1)localObject1).label & 0x80000000) != 0)
      {
        ((FlowKt__BuildersKt.asFlow..inlined.unsafeFlow.10.1)localObject1).label += -2147483648;
        paramContinuation = (Continuation)localObject1;
        break label53;
      }
    }
    paramContinuation = new FlowKt__BuildersKt.asFlow..inlined.unsafeFlow.10.1(this, paramContinuation);
    label53:
    ...
    if (i != 0)
    {
      if (i == 1)
      {
        ...
        localObject1 = (10)paramContinuation.L$0;
    ...
    do
    {
      ...
      paramContinuation.J$0 = l;
      paramContinuation.label = 1;
    } while (paramFlowCollector.emit(localLong, paramContinuation) != localObject3);
    return localObject3;
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__BuildersKt.asFlow..inlined.unsafeFlow.10
