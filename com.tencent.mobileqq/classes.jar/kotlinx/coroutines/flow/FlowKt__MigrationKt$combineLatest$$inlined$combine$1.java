...
public final class FlowKt__MigrationKt$combineLatest$$inlined$combine$1
  implements Flow<R>
{
  public FlowKt__MigrationKt$combineLatest$$inlined$combine$1(Flow[] paramArrayOfFlow, Function4 paramFunction4) {}
  
  @Nullable
  public Object collect(@NotNull FlowCollector paramFlowCollector, @NotNull Continuation paramContinuation)
  {
    paramFlowCollector = CombineKt.combineInternal(paramFlowCollector, this.$flows$inlined, (Function0)new FlowKt__MigrationKt.combineLatest..inlined.combine.1.2(this), (Function3)new FlowKt__MigrationKt.combineLatest..inlined.combine.1.3(null, this), paramContinuation);
  ...
  {
    InlineMarker.mark(4);
    new FlowKt__MigrationKt.combineLatest..inlined.combine.1.1(this, paramContinuation);
    InlineMarker.mark(5);
    Flow[] arrayOfFlow = this.$flows$inlined;
    Function0 localFunction0 = (Function0)new FlowKt__MigrationKt.combineLatest..inlined.combine.1.2(this);
    Function3 localFunction3 = (Function3)new FlowKt__MigrationKt.combineLatest..inlined.combine.1.3(null, this);
    InlineMarker.mark(0);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__MigrationKt.combineLatest..inlined.combine.1
