...
final class FlowKt__CollectKt$launchIn$1
  ...
  implements Function2<CoroutineScope, Continuation<? super Unit>, Object>
{
  ...
  FlowKt__CollectKt$launchIn$1(Flow paramFlow, Continuation paramContinuation)
  {
  ...
  {
    paramContinuation = new 1(this.$this_launchIn, paramContinuation);
  ...
  public final Object invokeSuspend(@NotNull Object paramObject)
  {
    ...
    else
    {
      ResultKt.throwOnFailure(paramObject);
      paramObject = this.p$;
      Flow localFlow = this.$this_launchIn;
      this.L$0 = paramObject;
      this.label = 1;
      if (FlowKt.collect(localFlow, this) == localObject) {
        return localObject;
      }
    }
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__CollectKt.launchIn.1
