...
public final class FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1
  implements Flow<T>
{
  public FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1(Flow paramFlow, Function2 paramFunction2) {}
  
  @Nullable
  public Object collect(@NotNull FlowCollector paramFlowCollector, @NotNull Continuation paramContinuation)
  {
    if ((paramContinuation instanceof FlowKt__LimitKt.takeWhile..inlined.unsafeFlow.1.1))
    {
      localObject1 = (FlowKt__LimitKt.takeWhile..inlined.unsafeFlow.1.1)paramContinuation;
      if ((((FlowKt__LimitKt.takeWhile..inlined.unsafeFlow.1.1)localObject1).label & 0x80000000) != 0)
      {
        ((FlowKt__LimitKt.takeWhile..inlined.unsafeFlow.1.1)localObject1).label += -2147483648;
        paramContinuation = (Continuation)localObject1;
        break label53;
      }
    }
    paramContinuation = new FlowKt__LimitKt.takeWhile..inlined.unsafeFlow.1.1(this, paramContinuation);
    label53:
    ...
    if (i != 0) {
      if (i == 1)
      {
        paramFlowCollector = (Flow)paramContinuation.L$4;
    ...
    localFlow = this.$this_takeWhile$inlined;
    localObject1 = paramFlowCollector;
    localFlowCollector = (FlowCollector)new FlowKt__LimitKt.takeWhile..inlined.unsafeFlow.1.lambda.1(paramFlowCollector, this);
    localObject1 = paramFlowCollector;
    ...
    localObject1 = paramFlowCollector;
    paramContinuation.L$4 = localFlow;
    localObject1 = paramFlowCollector;
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__LimitKt.takeWhile..inlined.unsafeFlow.1
