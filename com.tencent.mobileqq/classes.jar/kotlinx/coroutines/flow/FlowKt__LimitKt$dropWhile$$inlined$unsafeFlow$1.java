...
public final class FlowKt__LimitKt$dropWhile$$inlined$unsafeFlow$1
  implements Flow<T>
{
  public FlowKt__LimitKt$dropWhile$$inlined$unsafeFlow$1(Flow paramFlow, Function2 paramFunction2) {}
  ...
  public Object collect(@NotNull FlowCollector paramFlowCollector, @NotNull Continuation paramContinuation)
  {
    ...
    paramFlowCollector = this.$this_dropWhile$inlined.collect((FlowCollector)new FlowKt__LimitKt.dropWhile..inlined.unsafeFlow.1.lambda.1(paramFlowCollector, localBooleanRef, this), paramContinuation);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__LimitKt.dropWhile..inlined.unsafeFlow.1
