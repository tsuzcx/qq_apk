...
public final class FlowKt__ReduceKt$fold$$inlined$collect$1
  implements FlowCollector<T>
{
  public FlowKt__ReduceKt$fold$$inlined$collect$1(Ref.ObjectRef paramObjectRef, Function3 paramFunction3) {}
  
  @Nullable
  public Object emit(Object paramObject, @NotNull Continuation paramContinuation)
  {
    if ((paramContinuation instanceof FlowKt__ReduceKt.fold..inlined.collect.1.1))
    {
      localObject1 = (FlowKt__ReduceKt.fold..inlined.collect.1.1)paramContinuation;
      if ((((FlowKt__ReduceKt.fold..inlined.collect.1.1)localObject1).label & 0x80000000) != 0)
      {
        ((FlowKt__ReduceKt.fold..inlined.collect.1.1)localObject1).label += -2147483648;
        paramContinuation = (Continuation)localObject1;
        break label53;
      }
    }
    paramContinuation = new FlowKt__ReduceKt.fold..inlined.collect.1.1(this, paramContinuation);
    label53:
  ...
  {
    InlineMarker.mark(4);
    new FlowKt__ReduceKt.fold..inlined.collect.1.1(this, paramContinuation);
    InlineMarker.mark(5);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__ReduceKt.fold..inlined.collect.1
