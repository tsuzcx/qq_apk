...
public final class FlowKt__MergeKt$flatMapMerge$$inlined$map$1$2
  implements FlowCollector<T>
{
  public FlowKt__MergeKt$flatMapMerge$$inlined$map$1$2(FlowCollector paramFlowCollector, FlowKt__MergeKt.flatMapMerge..inlined.map.1 param1) {}
  
  @Nullable
  public Object emit(Object paramObject, @NotNull Continuation paramContinuation)
  {
    Object localObject1;
    if ((paramContinuation instanceof FlowKt__MergeKt.flatMapMerge..inlined.map.1.2.1))
    {
      localObject1 = (FlowKt__MergeKt.flatMapMerge..inlined.map.1.2.1)paramContinuation;
      if ((((FlowKt__MergeKt.flatMapMerge..inlined.map.1.2.1)localObject1).label & 0x80000000) != 0)
      {
        ((FlowKt__MergeKt.flatMapMerge..inlined.map.1.2.1)localObject1).label += -2147483648;
        paramContinuation = (Continuation)localObject1;
        break label53;
      }
    }
    paramContinuation = new FlowKt__MergeKt.flatMapMerge..inlined.map.1.2.1(this, paramContinuation);
    label53:
    ...
    if (i != 0)
    {
      if (i != 1)
      {
        if (i == 2)
        {
          ...
          paramObject = (FlowKt__MergeKt.flatMapMerge..inlined.map.1.2.1)paramContinuation.L$4;
          paramObject = paramContinuation.L$3;
          paramObject = (FlowKt__MergeKt.flatMapMerge..inlined.map.1.2.1)paramContinuation.L$2;
      ...
      paramObject = paramContinuation.L$5;
      localObject2 = (FlowKt__MergeKt.flatMapMerge..inlined.map.1.2.1)paramContinuation.L$4;
      localObject1 = paramContinuation.L$3;
      localObject3 = (FlowKt__MergeKt.flatMapMerge..inlined.map.1.2.1)paramContinuation.L$2;
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__MergeKt.flatMapMerge..inlined.map.1.2
