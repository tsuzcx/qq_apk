...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$1
  implements Flow<R>
{
  public FlowKt__ZipKt$combine$$inlined$unsafeFlow$1(Flow paramFlow1, Flow paramFlow2, Function3 paramFunction3) {}
  
  @Nullable
  public Object collect(@NotNull FlowCollector paramFlowCollector, @NotNull Continuation paramContinuation)
  {
    paramFlowCollector = CombineKt.combineTransformInternal(paramFlowCollector, this.$this_combine$inlined, this.$flow$inlined, (Function4)new FlowKt__ZipKt.combine..inlined.unsafeFlow.1.lambda.1(null, this), paramContinuation);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__ZipKt.combine..inlined.unsafeFlow.1
