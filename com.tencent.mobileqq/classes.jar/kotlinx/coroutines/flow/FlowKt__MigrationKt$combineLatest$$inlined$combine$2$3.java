...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/flow/FlowCollector;", "it", "", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", "kotlinx/coroutines/flow/FlowKt__ZipKt$combine$5$2", "kotlinx/coroutines/flow/FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2", "kotlinx/coroutines/flow/FlowKt__MigrationKt$combine$$inlined$combine$2$3"}, k=3, mv={1, 1, 16})
@DebugMetadata(c="kotlinx.coroutines.flow.FlowKt__MigrationKt$combineLatest$$inlined$combine$2$3", f="Migration.kt", i={0, 0, 0, 0, 1, 1}, l={323, 324}, m="invokeSuspend", n={"$receiver", "it", "continuation", "args", "$receiver", "it"}, s={"L$0", "L$1", "L$2", "L$3", "L$0", "L$1"})
  ...
  implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object>
{
  ...
  public FlowKt__MigrationKt$combineLatest$$inlined$combine$2$3(Continuation paramContinuation, FlowKt__MigrationKt.combineLatest..inlined.combine.2 param2)
  {
  ...
  public final Object invokeSuspend(@NotNull Object paramObject)
  {
    ...
    else
    {
      ...
      this.label = 1;
      localObject4 = ((Function5)localObject3).invoke(localObject4, localObject6, localObject7, localObject8, this);
  ...
  public final Object invokeSuspend$$forInline(@NotNull Object paramObject)
  {
    ...
    InlineMarker.mark(0);
    localObject1 = ((Function5)localObject2).invoke(localObject3, localObject4, localObject5, localObject1, this);
    InlineMarker.mark(1);
    InlineMarker.mark(0);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__MigrationKt.combineLatest..inlined.combine.2.3
