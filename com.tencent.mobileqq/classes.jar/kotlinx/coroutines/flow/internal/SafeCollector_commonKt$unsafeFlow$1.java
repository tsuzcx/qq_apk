...
public final class SafeCollector_commonKt$unsafeFlow$1
  implements Flow<T>
{
  public SafeCollector_commonKt$unsafeFlow$1(Function2 paramFunction2) {}
  ...
  {
    InlineMarker.mark(4);
    new SafeCollector_commonKt.unsafeFlow.1.collect.1(this, paramContinuation);
    InlineMarker.mark(5);
    this.$block.invoke(paramFlowCollector, paramContinuation);
    return Unit.INSTANCE;
  }
}
 ...
 * Qualified Name:     kotlinx.coroutines.flow.internal.SafeCollector_commonKt.unsafeFlow.1
