...
@Metadata(bv={1, 0, 3}, d1={""}, d2={"<anonymous>", "", "T1", "T2", "R", "value", "", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", "kotlinx/coroutines/flow/internal/CombineKt$combineTransformInternal$2$1$4"}, k=3, mv={1, 1, 16})
final class CombineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$3
  ...
  implements Function2<Object, Continuation<? super Unit>, Object>
{
  ...
  {
    paramContinuation = new 3(paramContinuation, this.this$0, this.$firstIsClosed$inlined, this.$firstChannel$inlined, this.$firstValue$inlined, this.$secondValue$inlined, this.$secondIsClosed$inlined, this.$secondChannel$inlined);
  ...
  public final Object invokeSuspend(@NotNull Object paramObject)
  {
    ...
    else
    {
      ...
      this.$secondValue$inlined.element = localObject4;
 ...
 * Qualified Name:     kotlinx.coroutines.flow.internal.CombineKt.combineTransformInternal.2.invokeSuspend..inlined.select.lambda.3
