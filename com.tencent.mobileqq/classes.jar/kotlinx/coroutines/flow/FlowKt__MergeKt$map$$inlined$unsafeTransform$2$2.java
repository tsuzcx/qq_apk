...
public final class FlowKt__MergeKt$map$$inlined$unsafeTransform$2$2
  implements FlowCollector<T>
{
  public FlowKt__MergeKt$map$$inlined$unsafeTransform$2$2(FlowCollector paramFlowCollector, FlowKt__MergeKt.map..inlined.unsafeTransform.2 param2) {}
  
  @Nullable
  public Object emit(Object paramObject, @NotNull Continuation paramContinuation)
  {
    paramObject = this.$this_unsafeFlow$inlined.emit(this.this$0.$transform$inlined$1.invoke(paramObject, paramContinuation), paramContinuation);
  ...
  {
    InlineMarker.mark(4);
    new FlowKt__MergeKt.map..inlined.unsafeTransform.2.2.1(this, paramContinuation);
    InlineMarker.mark(5);
    FlowCollector localFlowCollector = this.$this_unsafeFlow$inlined;
    paramObject = this.this$0.$transform$inlined$1.invoke(paramObject, paramContinuation);
    InlineMarker.mark(0);
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__MergeKt.map..inlined.unsafeTransform.2.2
