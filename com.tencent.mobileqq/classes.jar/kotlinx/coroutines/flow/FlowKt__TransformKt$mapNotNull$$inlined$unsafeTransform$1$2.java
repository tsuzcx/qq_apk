...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1$2
  implements FlowCollector<T>
{
  public FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1$2(FlowCollector paramFlowCollector, FlowKt__TransformKt.mapNotNull..inlined.unsafeTransform.1 param1) {}
  ...
  {
    InlineMarker.mark(4);
    new FlowKt__TransformKt.mapNotNull..inlined.unsafeTransform.1.2.1(this, paramContinuation);
    InlineMarker.mark(5);
    FlowCollector localFlowCollector = this.$this_unsafeFlow$inlined;
    paramObject = this.this$0.$transform$inlined$1.invoke(paramObject, paramContinuation);
    if (paramObject != null)
 ...
 * Qualified Name:     kotlinx.coroutines.flow.FlowKt__TransformKt.mapNotNull..inlined.unsafeTransform.1.2
