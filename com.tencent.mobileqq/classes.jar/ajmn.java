  ...
  implements Handler.Callback
{
  ...
  private final ajmo jdField_a_of_type_Ajmo;
  private ajmp jdField_a_of_type_Ajmp;
  private final Handler jdField_a_of_type_AndroidOsHandler;
  private boolean jdField_a_of_type_Boolean = true;
  private boolean b;
  
  public ajmn(ajmo paramajmo)
  {
    this.jdField_a_of_type_Ajmo = paramajmo;
    this.jdField_a_of_type_AndroidOsHandler = new bfnk(ThreadManager.getSubThreadLooper(), this);
  }
  ...
  public void a(int paramInt, ajmp paramajmp)
  {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    {
      while (!this.b) {
        switch (this.jdField_a_of_type_Ajmo.a(paramBundle))
        {
        case 0: 
        default: 
          break;
  ...
  {
    this.b = true;
    this.jdField_a_of_type_Ajmp = null;
