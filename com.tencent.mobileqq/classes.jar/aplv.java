...
class aplv
  extends xba
{
  aplv(aplu paramaplu, apaf paramapaf) {}
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.DownloadFileRspBody paramDownloadFileRspBody, Bundle paramBundle)
  {
    if (paramDownloadFileRspBody == null)
    {
      ...
      this.jdField_a_of_type_Apaf.a(-1, "");
      return;
    }
    paramBundle = TroopFileTransferManager.a(aplu.a(this.jdField_a_of_type_Aplu).b);
    if (paramBundle == null)
    {
      QLog.e("VideoForTroop<QFile>", 1, "getUrl: onReqDownloadFileResult: get troopFileTransferManager failed.");
      return;
    }
    paramBundle = paramBundle.a(aplu.a(this.jdField_a_of_type_Aplu));
    if (paramBundle == null)
    {
      this.jdField_a_of_type_Apaf.a(-2, "");
      return;
    }
    ...
    {
      paramBundle.cookieValue = bbea.a(paramDownloadFileRspBody.bytes_cookie_val.get().toByteArray());
    ...
    paramBundle.DownloadUrl = bbea.a(paramDownloadFileRspBody.bytes_download_url.get().toByteArray());
    ...
    if ((paramInt == -133) || (paramInt == -132) || (paramInt == -134))
    {
      ...
      this.jdField_a_of_type_Apaf.a(paramInt, "");
      return;
    }
    ...
    paramDownloadFileRspBody = apkb.a(paramBundle.DownloadIp, paramBundle.DownloadUrl, paramBundle.FilePath, paramBundle.cookieValue, "");
    ...
    {
      this.jdField_a_of_type_Apaf.a(paramDownloadFileRspBody, paramBundle.cookieValue);
      return;
    }
    this.jdField_a_of_type_Apaf.a(-3, "");
  }
}
