...
{
  public abua(SubLoginActivity paramSubLoginActivity) {}
  ...
  public void onGetKeyBack(String paramString1, String paramString2, String paramString3)
  {
    ...
    else
    {
      ...
      awrn.a(BaseApplication.getContext()).a(this.a.app.getCurrentAccountUin(), "actSBGeykey", false, 0L, 0L, paramString1, "");
      this.a.c();
      this.a.b(this.a.getString(2131654020));
    ...
    for (;;)
    {
      ...
      paramString1.put("fail_location", "subLogin");
      awrn.a(BaseApplication.getContext()).a(this.a.app.getCurrentAccountUin(), "actSBGeykey", true, 0L, 0L, paramString1, "");
      if (!SubLoginActivity.a(this.a))
      {
        ...
        axam.a(this.a.app, (byte)1, paramString2);
        axam.a(this.a.app, paramString2, 7);
        axal.b(this.a.app);
        axal.a(this.a.app);
        this.a.setTitle("");
        axal.a(this.a.app, this.a, paramString2);
        this.a.finish();
      }
      while (QLog.isColorLevel())
      {
        ...
        paramString1 = (axar)this.a.app.getManager(28);
        if (paramString1 != null) {
  ...
  public void onLoginFailed(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      awrn.a(BaseApplication.getContext()).a(this.a.app.getCurrentAccountUin(), "actSBLogin", false, 0L, 0L, paramString2, "");
      ...
      try
      {
        ...
        {
          this.a.b(this.a.getString(2131628946));
          return;
      ...
      catch (Exception paramString1)
      {
        ...
        this.a.b(this.a.getResources().getString(2131653053), paramString4, null);
      }
    }
  }
  ...
  public void onLoginTimeout(String paramString1, String paramString2, String paramString3)
  {
    ...
    paramString1.put("fail_location", "subLogin");
    awrn.a(BaseApplication.getContext()).a(this.a.app.getCurrentAccountUin(), "actSBLogin", false, 0L, 0L, paramString1, "");
    if (!this.a.getActivity().isFinishing()) {}
    try
    {
      this.a.c();
