  ...
  extends akie
{
  ...
  public akip a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new akiv(this);
  ...
  private List<akjl> jdField_b_of_type_JavaUtilList = new ArrayList();
  ...
  public akir(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new akis(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131368209)).setOnClickListener(new akit(this));
    Button localButton = (Button)findViewById(2131363745);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new akiu(this));
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Akip = new akip(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Blha, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Akip);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new akiw(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new akix(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new akiy(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemLongClickListener(new akiz(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Akip.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    if ((this.jdField_b_of_type_Boolean) && (AppNetConnInfo.isNetSupport()))
    {
      ...
      a(5, null);
      b(1);
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FCB", "0X8005FCB", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FCA", "0X8005FCA", 0, 0, "", "", "", "");
      return;
      this.jdField_b_of_type_Int = 0;
      this.jdField_a_of_type_Akip.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
      if (this.jdField_b_of_type_Boolean) {
        a(3, this.jdField_a_of_type_AndroidContentContext.getString(2131717763));
      } else {
        a(0, null);
      }
    }
  ...
  public void b(int paramInt)
  {
    ...
    Object localObject2 = (aocm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(92);
    Object localObject1 = ((aocm)localObject2).c();
    long l2;
    int j;
    int k;
    ...
    {
      l2 = ((Long)((aocm)localObject2).a((Calendar)localObject1).second).longValue();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(anzj.a(2131700198));
      ...
      {
        this.jdField_a_of_type_Akip.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_d_of_type_Boolean, 0);
        this.jdField_a_of_type_Akip.notifyDataSetChanged();
      }
      if (this.jdField_a_of_type_Akip.getCount() == 0) {
        a(4, null);
      }
      for (;;)
      {
      ...
      if ((l == this.jdField_a_of_type_Long) && (this.jdField_a_of_type_JavaLangString.equals(localObject1)))
      {
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_Akip.a(this.jdField_a_of_type_JavaUtilList, 4, this.jdField_d_of_type_Boolean, 0);
          this.jdField_a_of_type_Akip.notifyDataSetChanged();
        }
        ...
        if ((this.jdField_a_of_type_Long == l) && (this.jdField_a_of_type_JavaLangString.equals(localObject1)))
        {
          ...
          {
            localObject1 = new akjl(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)paramMessage.get(i));
            this.jdField_a_of_type_JavaUtilList.add(localObject1);
            this.jdField_a_of_type_JavaUtilSet.add(Long.valueOf(((akjl)localObject1).a.shmsgseq));
            i += 1;
          }
          ...
          this.jdField_a_of_type_Akip.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long);
          bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FC2", "0X8005FC2", 0, 0, "", "", "", "");
          continue;
          label1637:
          if (QLog.isColorLevel()) {
          ...
          if (this.e) {
            bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FCC", "0X8005FCC", 0, (int)(System.currentTimeMillis() - this.jdField_a_of_type_Long), "", "", "", "");
          }
          this.jdField_a_of_type_Akip.a(this.jdField_a_of_type_JavaUtilList, 4, this.jdField_d_of_type_Boolean, 1);
          this.jdField_a_of_type_Akip.notifyDataSetChanged();
          this.jdField_a_of_type_JavaUtilList.clear();
          continue;
          paramMessage = (HashMap)paramMessage.obj;
          ...
          if ((l == this.jdField_a_of_type_Long) && (this.jdField_a_of_type_JavaLangString.equals(localObject1)))
          {
            bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FC6", "0X8005FC6", 0, (int)(System.currentTimeMillis() - this.jdField_a_of_type_Long), "", "", "", "");
            this.jdField_c_of_type_Boolean = false;
            this.jdField_b_of_type_AndroidViewView.setVisibility(8);
            this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
            this.jdField_a_of_type_Akip.a(this.jdField_a_of_type_JavaUtilList, this.jdField_d_of_type_Boolean);
            if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_Akip.getCount() < 20))
            {
              this.jdField_c_of_type_AndroidWidgetTextView.setText(anzj.a(2131700200));
              this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131373040).setVisibility(8);
              this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
              this.jdField_b_of_type_AndroidViewView.setVisibility(0);
            }
            ...
            if ((l == this.jdField_a_of_type_Long) && (this.jdField_a_of_type_JavaLangString.equals(paramMessage)))
            {
              ...
              this.jdField_b_of_type_AndroidViewView.setVisibility(8);
              this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
              this.jdField_a_of_type_Akip.a((List)localObject1, this.jdField_d_of_type_Boolean);
              this.jdField_a_of_type_Akip.notifyDataSetChanged();
              this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Akip);
              this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
              this.jdField_a_of_type_JavaUtilList.clear();
