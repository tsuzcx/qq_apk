  ...
  extends lgb
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new lhx(this);
  ...
  private void b(long paramLong1, int paramInt, long paramLong2)
  {
    ...
    {
      localObject1 = new lhy();
      ((lhy)localObject1).a = paramLong1;
    ...
    if (((lhy)localObject1).a == localley.b()) {
      ((lhy)localObject1).a(localley, (String)localObject2);
    }
    localObject2 = ((lhy)localObject1).a();
    localObject1 = ((lhy)localObject1).a(paramInt, paramLong2);
  ...
  private void c(long paramLong)
  {
    ...
    localEditor.commit();
    lbc.d("VideoNodeReporter", "removeSpSessionRecord,roomId = " + paramLong);
  }
  
  lhy a(long paramLong)
  {
  ...
  protected void a()
  {
    lbc.d("VideoNodeReporter", "onCreate ");
    c();
  }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    {
      lbc.d("VideoNodeReporter", " report error 0: " + paramInt + "|" + this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      return;
    }
    if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.e)
    {
      lbc.d("VideoNodeReporter", " report error 1 ,exit has been called,node = " + paramInt);
      return;
    }
  ...
  public void a(long paramLong1, int paramInt, long paramLong2)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentAvAppVideoAppInterface == null) || (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a() == null) || (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a() == null))
    {
      lbc.d("VideoNodeReporter", " reportByRoomId error 0: " + paramInt + "|" + this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      return;
    }
    if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.e)
    {
      lbc.d("VideoNodeReporter", " reportByRoomId error 1 ,exit has been called,node = " + paramInt);
      return;
    }
    if (paramLong1 == 0L)
    {
  ...
  {
    lbc.d("VideoNodeReporter", " onSessionStatusChanged :" + paramInt + ",para = " + paramString2);
    switch (paramInt)
    {
    case 2: 
    case 3: 
    ...
    if (this.jdField_a_of_type_JavaUtilList.size() > 0)
    {
      ...
      while (paramString1.hasNext()) {
        ((lhy)paramString1.next()).b = System.currentTimeMillis();
      }
    }
  ...
  public void b()
  {
    try
    {
      ...
      long l1 = bgln.a(Process.myPid()) / 1024L / 1024L;
