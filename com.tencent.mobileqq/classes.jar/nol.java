...
public class nol
{
  ...
  private nol(String paramString1, int paramInt, String paramString2, long paramLong)
  {
  ...
  public static nol a(Intent paramIntent)
  {
    ...
    if (!TextUtils.isEmpty(str1))
    {
      ...
      if (!TextUtils.isEmpty(str2)) {
        paramIntent = new nol(str1, i, str2, l);
      }
    }
  ...
  public static void a(Intent paramIntent, nol paramnol)
  {
    if ((paramIntent != null) && (paramnol != null))
    {
      paramIntent.putExtra("key_from", paramnol.jdField_a_of_type_JavaLangString);
      paramIntent.putExtra("key_msg_seq", paramnol.jdField_a_of_type_Long);
      paramIntent.putExtra("uintype", paramnol.jdField_a_of_type_Int);
      paramIntent.putExtra("uin", paramnol.b);
      if (QLog.isDevelopLevel()) {
        QLog.i("AVGameBackAction", 4, "addAction, action[" + paramnol + "]");
      }
    }
  }
