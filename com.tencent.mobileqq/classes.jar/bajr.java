...
public class bajr
{
  ...
  public static int a(anpv paramanpv)
  {
    int k = 0;
    int i;
    int j;
    if ((paramanpv.mVipType & 0x2) != 0)
    {
      i = 1;
      j = k;
      if (!paramanpv.mVipHide)
      {
        if ((paramanpv.mBigVipHide) || (paramanpv.mBigVipLevel <= 0)) {
          break label49;
        }
        j = i + 768;
      }
    ...
    do
    {
      ...
      i = 0;
      break;
      if (((paramanpv.mVipType & 0x100) != 0) && (paramanpv.mVipLevel > 0)) {
        return i + 512;
      }
      j = k;
    } while (paramanpv.mVipType == 0);
    return 0;
  }
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      {
        return 0;
      } while ((paramQQAppInterface == null) || (!asbt.a().a()));
  ...
  public static int a(AppRuntime paramAppRuntime, String paramString)
  {
    ...
    if (paramAppRuntime != null)
    {
      ...
      paramAppRuntime = (ajjj)paramAppRuntime.getManager(51);
      if (paramAppRuntime == null) {
        break label151;
      }
  ...
  public static SpannableString a(int paramInt1, int paramInt2)
  {
    ...
    if (j >= 0)
    {
      ...
      localObject = ajjy.a(2131651004);
    }
    String str;
    for (;;)
    {
      str = ajjy.a(2131650996);
      switch (paramInt2)
      {
      default: 
        return null;
        label126:
        if (j == 1) {
          localObject = ajjy.a(2131650988);
        } else if (j == 2) {
          localObject = ajjy.a(2131651013);
        } else {
          localObject = j + ajjy.a(2131651007);
        }
        break;
      }
    }
    localObject = new SpannableString(ajjy.a(2131650986) + (String)localObject + ajjy.a(2131651001) + str);
    ...
    return localObject;
    localObject = new SpannableString(ajjy.a(2131651020) + (String)localObject + ajjy.a(2131650984) + str);
    paramInt1 = ((SpannableString)localObject).length() - str.length();
    ((SpannableString)localObject).setSpan(new ForegroundColorSpan(Color.parseColor("#0000ff")), paramInt1, str.length() + paramInt1, 34);
    return localObject;
    localObject = new SpannableString(ajjy.a(2131650993) + str);
    paramInt1 = ((SpannableString)localObject).length() - str.length();
    ((SpannableString)localObject).setSpan(new ForegroundColorSpan(Color.parseColor("#0000ff")), paramInt1, str.length() + paramInt1, 34);
    return localObject;
    localObject = new SpannableString(ajjy.a(2131651008) + str);
    paramInt1 = ((SpannableString)localObject).length() - str.length();
    ((SpannableString)localObject).setSpan(new ForegroundColorSpan(Color.parseColor("#0000ff")), paramInt1, str.length() + paramInt1, 34);
    return localObject;
    return new SpannableString(ajjy.a(2131650999) + (String)localObject + ajjy.a(2131651017));
    return new SpannableString(ajjy.a(2131650994) + (String)localObject + ajjy.a(2131650987));
    return new SpannableString(ajjy.a(2131650990));
    return new SpannableString(ajjy.a(2131651006));
    return new SpannableString(ajjy.a(2131651009));
    return new SpannableString(ajjy.a(2131651002));
    localObject = new SpannableString(ajjy.a(2131651014) + (String)localObject + ajjy.a(2131650983) + str);
    paramInt1 = ((SpannableString)localObject).length() - str.length();
    ((SpannableString)localObject).setSpan(new ForegroundColorSpan(Color.parseColor("#0000ff")), paramInt1, str.length() + paramInt1, 34);
    return localObject;
    localObject = new SpannableString(ajjy.a(2131651015) + str);
    paramInt1 = ((SpannableString)localObject).length() - str.length();
    ((SpannableString)localObject).setSpan(new ForegroundColorSpan(Color.parseColor("#0000ff")), paramInt1, str.length() + paramInt1, 34);
    return localObject;
    ...
    if (paramInt1 >= 0) {
      if (paramInt1 == 0) {
        localObject = ajjy.a(2131650992);
      }
    }
    for (;;)
    {
      localObject = new SpannableString(ajjy.a(2131651010) + (String)localObject + ajjy.a(2131651000) + str);
      paramInt1 = ((SpannableString)localObject).length() - str.length();
      ((SpannableString)localObject).setSpan(new ForegroundColorSpan(Color.parseColor("#0000ff")), paramInt1, str.length() + paramInt1, 34);
      return localObject;
      if (paramInt1 == 1)
      {
        localObject = ajjy.a(2131651019);
      }
      else if (paramInt1 == 2)
      {
        localObject = ajjy.a(2131650998);
      }
      else
      {
        localObject = paramInt1 + ajjy.a(2131650995);
        continue;
        localObject = ajjy.a(2131650985);
      }
    }
    return new SpannableString(ajjy.a(2131650997));
    return new SpannableString(ajjy.a(2131651005));
    return new SpannableString(ajjy.a(2131651011));
    return new SpannableString(ajjy.a(2131650989));
  }
  ...
  public static String a(anpv paramanpv, String paramString)
  {
    int i = a(paramanpv);
    i = (i & 0xF) << 8 | i >> 8;
    if ((i & 0xFF) == 3) {
      return String.format(paramString, new Object[] { Integer.valueOf(i), Integer.valueOf(paramanpv.mBigVipLevel), Integer.valueOf(paramanpv.mTemplateId) });
    }
    if ((i & 0xFF) == 2) {
      return String.format(paramString, new Object[] { Integer.valueOf(i), Integer.valueOf(paramanpv.mVipLevel), Integer.valueOf(paramanpv.mTemplateId) });
    }
    return null;
  }
  ...
  public static String a(AppRuntime paramAppRuntime, String paramString1, String paramString2, EVIPSPEC paramEVIPSPEC)
  {
    Object localObject = (ajjj)paramAppRuntime.getManager(51);
    if (localObject != null)
    {
      localObject = ((ajjj)localObject).e(paramString2);
      if (localObject != null)
      {
        int i;
        if (paramEVIPSPEC == EVIPSPEC.E_SP_BIGCLUB)
        {
          i = a(paramAppRuntime, paramString2, EVIPSPEC.E_SP_BIGCLUB);
          return String.format(paramString1, new Object[] { Integer.valueOf((i & 0xF) << 8 | i >> 8), Integer.valueOf(((Friends)localObject).getServiceLevel(paramEVIPSPEC)), Integer.valueOf(((Friends)localObject).bigClubTemplateId) });
        }
        if (paramEVIPSPEC == EVIPSPEC.E_SP_SUPERVIP)
        {
          i = a(paramAppRuntime, paramString2, EVIPSPEC.E_SP_SUPERVIP);
          return String.format(paramString1, new Object[] { Integer.valueOf((i & 0xF) << 8 | i >> 8), Integer.valueOf(((Friends)localObject).getServiceLevel(paramEVIPSPEC)), Integer.valueOf(((Friends)localObject).superVipTemplateId) });
        }
        if (paramEVIPSPEC == EVIPSPEC.E_SP_QQVIP)
        {
          i = a(paramAppRuntime, paramString2, EVIPSPEC.E_SP_QQVIP);
          return String.format(paramString1, new Object[] { Integer.valueOf((i & 0xF) << 8 | i >> 8), Integer.valueOf(((Friends)localObject).getServiceLevel(paramEVIPSPEC)), Integer.valueOf(0) });
        }
      }
    }
    return String.format(paramString1, new Object[] { Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0) });
  }
  ...
  public static void a(Activity paramActivity, bajx parambajx)
  {
    if ((parambajx == null) || (paramActivity == null) || (TextUtils.isEmpty(parambajx.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(parambajx.d)) || (TextUtils.isEmpty(parambajx.e)) || (TextUtils.isEmpty(parambajx.b)) || (TextUtils.isEmpty(parambajx.c)) || (parambajx.jdField_a_of_type_Int < 1)) {
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ((JSONObject)localObject).put("serviceCode", parambajx.b);
        ((JSONObject)localObject).put("aid", parambajx.d);
        ((JSONObject)localObject).put("openMonth", String.valueOf(parambajx.jdField_a_of_type_Int));
        ((JSONObject)localObject).put("offerId", parambajx.e);
        ((JSONObject)localObject).put("serviceName", parambajx.c);
        ((JSONObject)localObject).put("userId", parambajx.jdField_a_of_type_JavaLangString);
        if (!parambajx.jdField_a_of_type_Boolean) {
        ...
        parambajx = parambajx.f;
        PayBridgeActivity.tenpay(paramActivity, (String)localObject, 4, parambajx);
        return;
      }
  ...
  {
    String str = bant.a("kuoliePersonalCardMaster");
  ...
  {
    paramContext = babr.a(paramContext, 0, ajjy.a(2131651003), paramString2, paramString3, ajjy.a(2131650982), new bajs(paramBoolean, paramContext, paramString1, paramString4, paramInt), paramOnClickListener);
  ...
  {
    String str = ajjy.a(2131651012);
    if (paramBoolean) {}
    for (int i = 16;; i = 9)
    {
      paramContext = babr.a(paramContext, 0, str, a(0, i).toString(), ajjy.a(2131651018), null, null, new bajt());
      if (!paramContext.isShowing()) {
        paramContext.show();
      }
      return;
  ...
  {
    paramString = baop.a(paramString, baop.b, paramDrawable, null, new bajv(paramResources, paramString, paramImageView, paramDrawable));
    if (paramString != null)
    {
      int i = aciy.a(15.0F, paramResources);
  ...
  public static void a(View paramView, int paramInt, String paramString)
  {
    ...
    if (b(localQQAppInterface))
    {
      ...
      paramView.append(bant.a("NameplateClickSvip"));
      paramView.append("&qq=");
    ...
    for (paramString = "click_pk";; paramString = "click_getit")
    {
      ...
      return;
      paramView = bant.a("NameplateClickDefault");
    }
  }
  
  public static void a(View paramView, anpv paramanpv)
  {
    int i = a(paramanpv);
    Context localContext = paramView.getContext();
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    ...
    for (;;)
    {
      awqx.b(localQQAppInterface, "dc00898", "", "", "0X8009F0C", "0X8009F0C", 0, 0, "", "", "", "");
      return;
      a(localContext);
      continue;
      b(paramView, i, paramanpv.mUin);
      continue;
      QLog.e("VipUtils", 1, "klClickVipIcon: app is null");
    }
  }
  
  public static void a(anpv paramanpv, ImageView paramImageView)
  {
    int k = 1;
    int j = 0;
    ...
    {
      i = 1;
      localObject = a(paramanpv, ((QVipBigClubSVIP9Config)localObject).mAPngIconUrl);
      if (!a()) {
        break label192;
      }
      m = a(paramanpv);
      ...
      a(localResources, paramImageView, (String)localObject, localResources.getDrawable(2130845973));
      i = k;
    }
    for (;;)
    {
      ...
      for (i = j;; i = 8)
      {
        ...
        break;
        label107:
        a(localResources, paramImageView, (String)localObject, localResources.getDrawable(2130845971));
        i = k;
        break label90;
        label129:
        if (m >> 8 != 2) {
  ...
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String... paramVarArgs)
  {
    ...
    if ((paramAppInterface instanceof QQAppInterface))
    {
      ...
      {
        awqx.b(localQQAppInterface, "P_CliOper", paramVarArgs, "", paramString2, paramString3, paramInt1, paramInt2, arrayOfString[0], arrayOfString[1], arrayOfString[2], arrayOfString[3]);
        aiyo.a(paramAppInterface, paramString1, paramString2, paramString3, "", paramInt1, paramInt2, arrayOfString[0], arrayOfString[1], arrayOfString[2], arrayOfString[3]);
        return;
      }
    }
    ...
    for (paramVarArgs = "UNKNOWN";; paramVarArgs = paramString1)
    {
      awqx.b(null, "P_CliOper", paramVarArgs, "", paramString2, paramString3, paramInt1, paramInt2, arrayOfString[0], arrayOfString[1], arrayOfString[2], arrayOfString[3]);
      break;
    }
  }
  ...
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      if ((paramAppInterface instanceof QQAppInterface))
      {
        ...
        for (paramVarArgs = "UNKNOWN";; paramVarArgs = paramString1)
        {
          awqx.b(localQQAppInterface, "P_CliOper", paramVarArgs, paramString4, paramString2, paramString3, paramInt1, paramInt2, arrayOfString[0], arrayOfString[1], arrayOfString[2], arrayOfString[3]);
          aiyo.a(paramAppInterface, paramString1, paramString2, paramString3, paramString4, paramInt1, paramInt2, arrayOfString[0], arrayOfString[1], arrayOfString[2], arrayOfString[3]);
          return;
        }
      }
      if (paramAppInterface != null)
      ...
      for (paramVarArgs = "UNKNOWN";; paramVarArgs = paramString1)
      {
        awqx.b(null, "P_CliOper", paramVarArgs, paramString4, paramString2, paramString3, paramInt1, paramInt2, arrayOfString[0], arrayOfString[1], arrayOfString[2], arrayOfString[3]);
        break;
      }
    }
  }
  ...
  public static void a(BaseActivity paramBaseActivity, int paramInt, String paramString)
  {
    ...
    {
      bajx localbajx = new bajx();
      localbajx.jdField_a_of_type_JavaLangString = paramBaseActivity.app.getCurrentAccountUin();
      localbajx.d = paramString;
      localbajx.e = "1450000515";
      localbajx.b = "LTMCLUB";
      localbajx.c = paramBaseActivity.getString(2131629751);
      localbajx.jdField_a_of_type_Int = paramInt;
      localbajx.f = "vip";
      a(paramBaseActivity, localbajx);
    }
  }
  ...
  public static void a(BaseActivity paramBaseActivity, boolean paramBoolean1, int paramInt, boolean paramBoolean2, String paramString)
  {
    ...
    if ((paramBaseActivity != null) && (!TextUtils.isEmpty(paramString)) && (paramInt > 0))
    {
      ...
      localbajx.d = paramString;
      localbajx.jdField_a_of_type_Int = paramInt;
      localbajx.jdField_a_of_type_Boolean = paramBoolean2;
      if (!paramBoolean1) {
        break label103;
      }
      localbajx.e = "1450000516";
      localbajx.b = "CJCLUBT";
      localbajx.c = paramBaseActivity.getString(2131654075);
    }
    for (localbajx.f = "svip";; localbajx.f = "vip")
    {
      a(paramBaseActivity, localbajx);
      return;
      label103:
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt, String paramString1, String paramString2)
  {
    ...
    if (localajjj != null)
    {
      paramString1 = localajjj.e(paramString1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, Resources paramResources, acat paramacat, acam paramacam)
  {
    if (awnu.b())
    {
      paramacat.e.setTextColor(paramResources.getColor(2131101260));
      return;
    }
    amis.c();
    if (b(paramacam.h) != 0)
    {
      paramacat.e.setTextColor(paramResources.getColor(2131101391));
      return;
    }
    switch (a(paramacam.e))
    {
    default: 
      paramacat.e.setTextColor(paramResources.getColor(2131101260));
      return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, Resources paramResources, afpb paramafpb, afou paramafou)
  {
    if (awnu.b())
    {
      paramafpb.e.setTextColor(paramResources.getColor(2131101260));
      return;
    }
    amis.c();
    if (b(paramafou.h) != 0)
    {
      paramafpb.e.setTextColor(paramResources.getColor(2131101391));
      return;
    }
    switch (a(paramafou.e))
    {
    default: 
      paramafpb.e.setTextColor(paramResources.getColor(2131101260));
      return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, Resources paramResources, azdt paramazdt, afou paramafou)
  {
    if (awnu.b())
    {
      paramazdt.a.setTextColor(paramResources.getColor(2131101260));
      return;
    }
    amis.c();
    if (b(paramafou.h) != 0)
    {
      paramazdt.a.setTextColor(paramResources.getColor(2131101391));
      return;
    }
    switch (a(paramafou.e))
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, anpv paramanpv, NavBarAIO paramNavBarAIO, ImageView paramImageView, boolean paramBoolean)
  {
    if (awnu.b()) {
    ...
    String str = a(paramanpv, amis.c().mAPngIconUrl);
    int i = a(paramanpv);
    if (i >> 8 == 3) {
      paramNavBarAIO.setTitleIconRight(str, 2130845973);
    }
    while (i != 0)
    {
      paramImageView.setContentDescription(ajjy.a(2131650991));
      paramImageView.setFocusableInTouchMode(true);
      paramImageView.setOnTouchListener(new bajy(paramQQAppInterface, paramBoolean, paramImageView, paramanpv.mUin, a(paramanpv), true));
      return;
      if (i >> 8 == 2) {
        paramNavBarAIO.setTitleIconRight(str, 2130845973);
      } else {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, NavBarAIO paramNavBarAIO, ImageView paramImageView, boolean paramBoolean)
  {
    ...
    if (i >> 8 == 3)
    {
      paramNavBarAIO.setTitleIconRight(a(paramQQAppInterface, ((QVipBigClubSVIP9Config)localObject).mAPngIconUrl, paramString, EVIPSPEC.E_SP_BIGCLUB), 2130845973);
      NamePlateCfgInfo.vipNamePlateExposeReport(paramQQAppInterface, paramString);
    }
    while (a(paramQQAppInterface, paramString, false) == 3)
    {
      paramImageView.setContentDescription(ajjy.a(2131651016));
      paramImageView.setFocusableInTouchMode(true);
      paramImageView.setOnTouchListener(new bajy(paramQQAppInterface, paramBoolean, paramImageView, paramString, i, false));
      return;
      if (i >> 8 == 2)
      {
        localObject = a(paramQQAppInterface, ((QVipBigClubSVIP9Config)localObject).mAPngIconUrl, paramString, EVIPSPEC.E_SP_SUPERVIP);
        if ((i & 0xF) == 1) {
          paramNavBarAIO.setTitleIconRight((String)localObject, 2130845973);
        } else {
          paramNavBarAIO.setTitleIconRight((String)localObject, 2130845971);
        }
      }
      else
      {
  ...
  public static void a(SingleLineTextView paramSingleLineTextView, Context paramContext, String paramString, int paramInt)
  {
    ...
    if ((localObject != null) && ((localObject instanceof URLDrawable)))
    {
      ...
      if (((URLDrawable)localObject).getCurrDrawable() != null)
      {
        ...
        paramString = baop.a(paramString, baop.b, (Drawable)localObject, null, new baju(bool, paramSingleLineTextView, paramContext));
        if (!bool) {
          break label158;
        }
    ...
    for (;;)
    {
      paramSingleLineTextView.setCompoundDrawablePadding((int)bacc.a(paramContext, 5.0F));
      paramSingleLineTextView.setCompoundDrawables(null, a(aciy.a(15.0F, paramContext.getResources()), paramString));
      return;
  ...
  {
    QVipBigClubSVIP9Config localQVipBigClubSVIP9Config = amis.c();
    if ((paramFriends.isHideBigClub == 0) && (paramFriends.isServiceEnabled(EVIPSPEC.E_SP_BIGCLUB)))
    {
      a(paramSingleLineTextView, paramContext, a(paramQQAppInterface, localQVipBigClubSVIP9Config.mAPngIconUrl, paramFriends.uin, EVIPSPEC.E_SP_BIGCLUB), 2130845973);
      return;
    }
    if (paramFriends.isServiceEnabled(EVIPSPEC.E_SP_SUPERVIP))
    {
      a(paramSingleLineTextView, paramContext, a(paramQQAppInterface, localQVipBigClubSVIP9Config.mAPngIconUrl, paramFriends.uin, EVIPSPEC.E_SP_SUPERVIP), 2130845971);
      return;
    }
    if (paramFriends.isServiceEnabled(EVIPSPEC.E_SP_QQVIP))
    {
      a(paramSingleLineTextView, paramContext, a(paramQQAppInterface, localQVipBigClubSVIP9Config.mAPngIconUrl, paramFriends.uin, EVIPSPEC.E_SP_QQVIP), 2130845972);
      return;
    }
    paramSingleLineTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0);
  }
  
  public static void a(String paramString1, asbx paramasbx, QQAppInterface paramQQAppInterface, String paramString2)
  {
    if (paramasbx == null) {}
    do
    {
    ...
    awqx.b(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, "", "", "", "");
  }
  
  public static boolean a()
  {
    amiy localamiy = (amiy)alzw.a().a(465);
    if (localamiy == null) {
      return false;
    }
    return localamiy.jdField_a_of_type_Boolean;
  }
  ...
  public static boolean a(String paramString, int paramInt)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 988	bajr:a	Ljava/util/HashMap;
    //   6: ifnonnull +13 -> 19
    //   9: new 990	java/util/HashMap
    //   12: dup
    //   13: invokespecial 991	java/util/HashMap:<init>	()V
    //   16: putstatic 988	bajr:a	Ljava/util/HashMap;
    //   19: getstatic 988	bajr:a	Ljava/util/HashMap;
    //   22: aload_0
    //   23: invokevirtual 994	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    //   52: iload_3
    //   53: ireturn
    //   54: getstatic 988	bajr:a	Ljava/util/HashMap;
    //   57: aload_0
    //   58: iload_1
    //   59: invokestatic 289	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   62: invokevirtual 997	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   65: pop
    //   66: iconst_0
    //   67: istore_3
    //   68: goto -19 -> 49
  ...
  public static void b(View paramView, int paramInt, String paramString)
  {
    ...
    ((StringBuilder)localObject).append(bant.a("NameplateClickSvip"));
  ...
  public static void b(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    int i = badq.a(paramQQAppInterface.getApp().getApplicationContext());
    if (!str2.contains("?"))
    {
      localStringBuilder.append(str2 + "?platform=1&type=20001&networkInfo=" + i + "&aid=" + paramString);
      str2 = localStringBuilder.toString();
      paramString = ((auqh)paramQQAppInterface.getManager(36)).a(String.valueOf(100400));
      paramQQAppInterface = ((auqh)paramQQAppInterface.getManager(36)).a(str2, paramString);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramString.putExtra("leftBtnText", paramContext.getResources().getString(2131624009));
  ...
  public static void b(QQAppInterface paramQQAppInterface, SubMsgType0x120.MsgBody paramMsgBody)
  {
    ...
    Object localObject2 = asbt.a(str1);
    ...
    Object localObject3 = (ajjj)paramQQAppInterface.getManager(51);
    Object localObject1 = String.valueOf(paramMsgBody.uint64_frd_uin.get());
    Object localObject4 = babh.m(paramQQAppInterface, (String)localObject1);
    long l1 = paramMsgBody.uint32_notice_time.get();
    long l2 = paramMsgBody.uint32_notice_type.get();
    localObject4 = ascd.a(paramQQAppInterface, (String)localObject2, (String)localObject4, (ajjj)localObject3);
    Object localObject5 = ascd.a(paramQQAppInterface, (String)((List)localObject4).get(0), (String)localObject1);
    localObject3 = ascd.a(paramQQAppInterface.getApp(), (String)((List)localObject5).get(0));
    paramMsgBody = ((asce)((List)localObject3).get(0)).jdField_a_of_type_JavaLangString;
    ((List)localObject4).remove(0);
    ((List)localObject5).remove(0);
    ((List)localObject3).remove(0);
    localObject2 = new aqax((String)localObject1, (String)localObject1, paramMsgBody, 0, -5020, 2097153, awao.a());
    int i;
    Bundle localBundle;
    String str2;
    int j;
    if ((localObject5 != null) && (((List)localObject5).size() > 0))
    {
      ...
      while (i < ((List)localObject5).size())
      {
        ...
        if (!TextUtils.isEmpty(str2))
        {
          ...
          if (j >= 0) {
            ((aqax)localObject2).a(j, str2.length() + j, localBundle);
          }
          if (QLog.isColorLevel()) {
    ...
    {
      Collections.sort((List)localObject4, new bajw());
    ...
    for (;;)
    {
      ...
      for (int k = 1;; k = 0)
      {
        ...
        if (m >= 0)
        {
          ((aqax)localObject2).a(m, i, localBundle);
          if (QLog.isColorLevel()) {
        ...
        {
          localObject4 = (asce)((List)localObject3).get(i);
          localObject5 = new Bundle();
          ((Bundle)localObject5).putInt("key_action", 1);
          ((Bundle)localObject5).putString("key_action_DATA", ((asce)localObject4).b.replace("{uin}", (CharSequence)localObject1));
          j = ((asce)localObject4).jdField_a_of_type_Int;
          if (j >= 0) {
            ((aqax)localObject2).a(j, ((asce)localObject4).jdField_a_of_type_JavaLangString.length() + j, (Bundle)localObject5);
          }
          i += 1;
        }
        localObject3 = new MessageForUniteGrayTip();
        ((MessageForUniteGrayTip)localObject3).hasRead = 0;
        ((MessageForUniteGrayTip)localObject3).initGrayTipMsg(paramQQAppInterface, (aqax)localObject2);
        ...
        aqay.a(paramQQAppInterface, (MessageForUniteGrayTip)localObject3);
        return;
      }
    }
  }
  ...
  public static int d(int paramInt)
  {
    ...
    default: 
      ...
      {
        return aciy.a(f, localResources);
        i = 0;
        break;
      }
    case 1: 
