  ...
  implements View.OnTouchListener
{
  ...
  protected begr a;
  private beij jdField_a_of_type_Beij = new aozj(this);
  ...
  public aozd(Activity paramActivity)
  {
    super(paramActivity);
  }
  ...
  private String a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Begr != null) {
      str = this.jdField_a_of_type_Begr.a(paramInt);
    }
    return str;
  }
  ...
  private void a(List<bahx> paramList, int paramInt, View paramView)
  {
    ...
    do
    {
      ...
      localbahx = (bahx)paramList.next();
    } while (!str.equalsIgnoreCase(localbahx.jdField_a_of_type_JavaLangString));
    localbahx.jdField_a_of_type_AndroidViewView$OnClickListener.onClick(paramView);
  }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)BaseApplicationImpl.getContext().getSystemService("layout_inflater")).inflate(2131494934, this.jdField_a_of_type_AndroidViewViewGroup, false);
      this.e = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131306182));
      this.f = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131296982));
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131313068));
      this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131306303));
      this.h = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131309455));
      this.h.setText(ajjy.a(2131650468));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131306302));
      this.jdField_d_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131306074));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131306038));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131304227));
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131311636));
      this.g = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131297446));
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131300630));
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      Rect localRect = apdq.a(this.jdField_a_of_type_AndroidAppActivity, a(), paramInt1, paramInt2);
      if (localRect != null) {
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130843409, 0, 0);
    ...
    if (apdh.b(paramString1))
    {
      ...
      paramString2.setOnClickListener(new aozf(this, paramString1));
    ...
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new aozg(this));
  }
  
  public void a(List<bahx> paramList)
  {
    if (this.jdField_a_of_type_Begr == null)
    {
    ...
    while (localIterator.hasNext())
    {
      ...
      this.jdField_a_of_type_Begr.a(localbahx.jdField_a_of_type_JavaLangString, 0);
    }
    this.jdField_a_of_type_Begr.d(ajjy.a(2131650467));
    this.jdField_a_of_type_Begr.a(new aozh(this, paramList));
  }
  ...
  public void b(String paramString, View.OnClickListener paramOnClickListener)
  {
    ...
    {
      this.jdField_c_of_type_AndroidViewView = aojd.a(paramString).a(this.jdField_a_of_type_AndroidAppActivity);
      this.jdField_c_of_type_AndroidViewView.setId(2131313304);
      ...
      if (paramString != null) {
        paramString.addOnLayoutChangeListener(new aoze(this));
      }
      ...
      this.jdField_a_of_type_ComTencentWidgetDragView.setGestureChangeListener(this.jdField_a_of_type_Beij);
      paramString = new RelativeLayout.LayoutParams(-1, -1);
  ...
  public void d()
  {
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new aozi(this));
    }
  }
  ...
  public void d(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130844807);
      this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getString(2131625557));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130844805);
    this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getString(2131625560));
  }
