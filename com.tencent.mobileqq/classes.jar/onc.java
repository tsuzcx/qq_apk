  ...
  implements View.OnClickListener
{
  ...
  public onc(Context paramContext)
  {
  ...
  public View a(String paramString, View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      ((TextView)this.jdField_a_of_type_AndroidViewView).setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167363));
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130847109);
    ...
    localLayoutParams.addRule(3, 2131374261);
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      try
      {
        localObject2 = (ViewGroup)((FragmentActivity)this.jdField_a_of_type_AndroidContentContext).getChatFragment().a().mAIORootView.findViewById(2131364488);
    ...
    if (this.b == null)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131374261);
      ((RelativeLayout.LayoutParams)localObject2).addRule(11);
      this.b.setLayoutParams((ViewGroup.LayoutParams)localObject2);
    }
    this.b.setTag(2131362563, paramString2);
    this.b.setTag(2131362561, String.valueOf(paramInt1));
    this.b.setTag(2131362562, String.valueOf(paramInt2));
    this.b.setTag(2131362564, Integer.valueOf(paramInt3));
    ...
    try
    {
      ...
      ((URLImageView)this.b).setURLDrawableDownListener(new ond(this));
    }
    ...
    bdla.b(null, "dc00899", "Pb_account_lifeservice", "1", "0X80075A0", "0X80075A0", 0, 0, "", "", String.valueOf(paramInt1), String.valueOf(paramInt2));
  }
  ...
  public void onClick(View paramView)
  {
    ...
    } while ((paramView.getId() != 2131362560) || (this.jdField_a_of_type_AndroidContentContext == null));
    String str1 = (String)paramView.getTag(2131362563);
    String str2 = (String)paramView.getTag(2131362561);
    String str3 = (String)paramView.getTag(2131362562);
    Intent localIntent;
    if (((Integer)paramView.getTag(2131362564)).intValue() == 1)
    {
    ...
    for (;;)
    {
      bdla.b(null, "dc00899", "Pb_account_lifeservice", "1", "0X80075A1", "0X80075A1", 0, 0, "", "", str2, str3);
      break;
