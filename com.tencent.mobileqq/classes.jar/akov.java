...
public class akov
{
  ...
  public akov(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(akxc paramakxc, int paramInt1, int paramInt2, AppInterface paramAppInterface, Context paramContext)
  {
    ...
    for (paramInt1 = 14;; paramInt1 = 5)
    {
      ...
      akwt.a(paramakxc, paramInt1, paramAppInterface);
      return 0;
    }
  }
  ...
  public int a(akxc paramakxc, int paramInt, AppInterface paramAppInterface, Context paramContext)
  {
    ...
    paramAppInterface.actionId = -1;
    paramAppInterface.actionType = 0;
    akwt.a(paramakxc, 5, paramAppInterface);
    if (QLog.isColorLevel()) {
