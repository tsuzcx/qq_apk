  ...
  extends anpi
{
  ...
  public apzz(QQAppInterface paramQQAppInterface)
  {
    super("qq.android.flutter.engine.v8.2.8", paramQQAppInterface);
  }
  ...
  public static String e()
  {
    ...
    {
      return localObject;
      str = localObject + "/pddata/prd/" + "qq.android.flutter.engine.v8.2.8";
      localObject = str;
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    aqaa.a(0, paramLong1, paramLong2);
  }
  ...
  public void a(String paramString)
  {
    ...
    if (aqaa.a(paramString, (QFlutterEngineData)a())) {
      aqaa.a(0, true);
    }
    for (;;)
    {
  ...
  {
    String str = e();
    boolean bool = apvb.a(new File(str));
    if (QLog.isColorLevel()) {
  ...
  public void e(boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QFlutter.QFlutterEngineDownloader", 2, String.format("onBeforeUpdateConfig, bLoginElseNet: %s", new Object[] { Boolean.valueOf(paramBoolean) }));
    }
  }
