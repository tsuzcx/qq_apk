...
public class bjnj
  extends bjnh
{
  public bjnj(boolean paramBoolean)
  {
    super(paramBoolean);
  }
  ...
  public void c()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bjni != null) {
        this.jdField_a_of_type_Bjni.a((int)this.jdField_f_of_type_Float, -this.jdField_b_of_type_Float, -this.jdField_c_of_type_Float, this.d);
      }
      return;
      if (this.jdField_b_of_type_Float < -90.0F) {
        this.jdField_b_of_type_Float = -90.0F;
