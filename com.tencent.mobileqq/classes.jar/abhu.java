...
public class abhu
  extends abib
{
  abhq jdField_a_of_type_Abhq = new abhq();
  abht jdField_a_of_type_Abht = new abht();
  private final TransProcessorHandler jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new abhv(this, Looper.getMainLooper());
  private final ArrayList<abhw> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private Set<Long> jdField_a_of_type_JavaUtilSet = new HashSet(10);
  private ConcurrentHashMap<String, abhz> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(20);
  ...
  private void a(long paramLong1, String paramString, long paramLong2, int paramInt)
  {
    ...
    {
      paramString = new abhz(this, paramString, paramLong2, paramInt, "", 0L);
  ...
  {
    abhz localabhz = (abhz)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramSession.uSessionID));
    if (localabhz == null) {
      return;
    }
    Object localObject1;
    ...
    {
      this.jdField_a_of_type_Abht.a(paramSession, localabhz.jdField_a_of_type_JavaLangString, localabhz.jdField_a_of_type_Long, localabhz.jdField_a_of_type_Int, paramBoolean);
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if ((localObject1 instanceof QQAppInterface))
      {
        localObject1 = (QQAppInterface)localObject1;
        localObject2 = ((abgm)((QQAppInterface)localObject1).getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(Long.parseLong(localabhz.jdField_a_of_type_JavaLangString));
    ...
    for (int i = ((DeviceInfo)localObject2).productId;; i = 0)
    {
      ...
      {
        int j;
        if (paramSession.actionInfo.strServiceName.compareTo(abkw.f) == 0) {
          if (paramBoolean)
          {
            j = 0;
            absy.a((AppRuntime)localObject1, l, "Net_SendMsg_Audio", 0, j, i);
        ...
        for (i = 1003;; i = 1005)
        {
          ((abhy)localObject2).jdField_a_of_type_Int = i;
          ((abhy)localObject2).jdField_a_of_type_Long = localabhz.jdField_a_of_type_Long;
          ...
          return;
          if (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(abkw.f)) {
            break;
          }
          this.jdField_a_of_type_Abhq.a(paramSession, localabhz.jdField_a_of_type_JavaLangString, localabhz.jdField_a_of_type_Long, localabhz.jdField_a_of_type_Int, paramBoolean);
          break;
          j = 1;
          break label158;
          if (paramSession.actionInfo.strServiceName.compareTo(abkw.e) != 0) {
            break label171;
          }
          if (paramBoolean) {}
          for (j = 0;; j = 1)
          {
            absy.a((AppRuntime)localObject1, l, "Net_SendMsg_Video", 0, j, i);
            break;
          }
        }
      }
  ...
  private void c(Session paramSession)
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      MessageForDevShortVideo localMessageForDevShortVideo = (MessageForDevShortVideo)bcsa.a(-4503);
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(str1))
        {
          ...
          if ((localObject2 instanceof QQAppInterface))
          {
            ...
            MessageForDevPtt localMessageForDevPtt = (MessageForDevPtt)bcsa.a(-4501);
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      paramBundle = (abhz)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(i));
    } while (paramBundle == null);
    this.jdField_a_of_type_Abhq.a((Session)localObject, paramBundle.jdField_a_of_type_JavaLangString, paramBundle.jdField_a_of_type_Long, paramBundle.jdField_a_of_type_Int, f);
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler.obtainMessage();
    abhy localabhy = new abhy(this);
    localabhy.jdField_a_of_type_Int = 1002;
    localabhy.jdField_a_of_type_Float = f;
    localabhy.jdField_a_of_type_Long = paramBundle.jdField_a_of_type_Long;
    ((Message)localObject).obj = localabhy;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("DeviceAVFileMsgObserver", 2, "handleMessage" + ((abhy)paramMessage.obj).jdField_a_of_type_Long + " status " + paramMessage.what + "retCode " + paramMessage.arg1);
    }
    int i = 0;
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      Object localObject = (abhw)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((abhw)localObject).a();
      localObject = ((abhw)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((abhx)localObject).a(localView, (abhy)paramMessage.obj);
      }
      for (;;)
      {
        i += 1;
  ...
  public void a(View paramView, abhx paramabhx)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      abhw localabhw = (abhw)localIterator.next();
      if (localabhw.a() == paramView)
      {
        localabhw.b = new WeakReference(paramabhx);
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(new abhw(this, paramView, paramabhx));
  }
  ...
  public void a(MessageForDevPtt paramMessageForDevPtt)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        {
          paramMessageForDevPtt = new abhz(this, paramMessageForDevPtt.frienduin, paramMessageForDevPtt.uniseq, paramMessageForDevPtt.istroop, "", 0L);
  ...
  public void a(Session paramSession)
  {
    ...
    if ((!paramSession.bSend) && (paramSession.actionInfo.strServiceName.equalsIgnoreCase(abkw.e))) {
      c(paramSession);
    }
  }
  ...
  public void a(Session paramSession, float paramFloat)
  {
    ...
    if (localabhz != null)
    {
      ...
      this.jdField_a_of_type_Abht.a(paramSession, localabhz.jdField_a_of_type_JavaLangString, localabhz.jdField_a_of_type_Long, localabhz.jdField_a_of_type_Int, paramFloat);
      localMessage = this.jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler.obtainMessage();
      localabhy = new abhy(this);
    ...
    label165:
    label205:
    for (localabhy.jdField_a_of_type_Int = 1002;; localabhy.jdField_a_of_type_Int = 2002)
    {
      localabhy.jdField_a_of_type_Float = paramFloat;
      localabhy.jdField_a_of_type_Long = localabhz.jdField_a_of_type_Long;
      localMessage.obj = localabhy;
      this.jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler.sendMessageDelayed(localMessage, 0L);
      return;
      if (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(abkw.f)) {
        break;
      }
      this.jdField_a_of_type_Abhq.a(paramSession, localabhz.jdField_a_of_type_JavaLangString, localabhz.jdField_a_of_type_Long, localabhz.jdField_a_of_type_Int, paramFloat);
      break;
    }
  }
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localabhz = (abhz)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramSession.uSessionID));
    } while (localabhz == null);
    label135:
    Object localObject1;
    Object localObject2;
    if (paramSession.actionInfo.strServiceName.equalsIgnoreCase(abkw.e))
    ...
    for (int i = 2003;; i = 2005)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler.sendMessageDelayed((Message)localObject1, 0L);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(String.valueOf(paramSession.uSessionID));
      this.jdField_a_of_type_JavaUtilSet.remove(Long.valueOf(localabhz.jdField_a_of_type_Long));
      if (!paramBoolean) {
        break label439;
      }
      this.b.remove(Long.valueOf(localabhz.jdField_a_of_type_Long));
      return;
      if ((paramSession.actionInfo.strServiceName.equalsIgnoreCase(abkw.f)) || (!paramSession.actionInfo.strServiceName.equalsIgnoreCase(abkw.g))) {
        break label135;
      }
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if (!(localObject1 instanceof QQAppInterface)) {
      ...
      localObject1 = (QQAppInterface)localObject1;
      localObject2 = ((QQAppInterface)localObject1).getMessageFacade().getMsgItemByUniseq(localabhz.jdField_a_of_type_JavaLangString, localabhz.jdField_a_of_type_Int, localabhz.jdField_a_of_type_Long);
      if (localObject2 == null) {
        break;
      }
      ...
      if (paramBoolean) {}
      for (localMessageForDevPtt.fileSize = auea.a(paramSession.strFilePathSrc);; localMessageForDevPtt.fileSize = -1L)
      {
        localMessageForDevPtt.msg = localMessageForDevPtt.getSummary();
        localMessageForDevPtt.serial();
    ...
    label439:
    this.b.put(Long.valueOf(localabhz.jdField_a_of_type_Long), Long.valueOf(bcrg.a()));
  }
  ...
  public void a(MessageRecord paramMessageRecord, float paramFloat)
  {
    ...
    abhy localabhy = new abhy(this);
    localabhy.jdField_a_of_type_Int = 1002;
    localabhy.jdField_a_of_type_Long = paramMessageRecord.uniseq;
    localabhy.jdField_a_of_type_Float = paramFloat;
    localMessage.obj = localabhy;
    this.jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler.sendMessageDelayed(localMessage, 0L);
  }
  ...
  public void a(MessageRecord paramMessageRecord, Boolean paramBoolean)
  {
    ...
    {
      i = 1003;
      localabhy.jdField_a_of_type_Int = i;
      localabhy.jdField_a_of_type_Long = paramMessageRecord.uniseq;
      if (!paramBoolean.booleanValue()) {
        break label89;
      }
  ...
  public void a(String paramString1, String paramString2, long paramLong1, long paramLong2, int paramInt1, int paramInt2)
  {
    ...
    {
      localObject1 = (QQAppInterface)localObject1;
      localObject2 = (abgm)((QQAppInterface)localObject1).getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER);
      if ((!paramString1.equalsIgnoreCase(abkw.f)) || (localObject2 == null) || (!((abgm)localObject2).b(paramLong1))) {
        break label193;
      }
      localObject1 = new Session();
      ((Session)localObject1).uSessionID = ((abgm)localObject2).a(paramLong1, paramString2, paramInt2);
      ((Session)localObject1).strFilePathSrc = paramString2;
      ((Session)localObject1).uFileSizeSrc = auea.a(paramString2);
      ...
      paramString2 = new abhz(this, String.valueOf(paramLong1), paramLong2, paramInt1, paramString2, ((Session)localObject1).uFileSizeSrc);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localObject2, paramString2);
      label155:
      if (!NetworkUtil.isNetSupport(BaseApplication.getContext()))
      {
        if (!paramString1.equalsIgnoreCase(abkw.e)) {
          break label240;
        }
        this.jdField_a_of_type_Abht.a((Session)localObject1, String.valueOf(paramLong1), paramLong2, paramInt1, false);
      }
    }
    label193:
    label223:
    label240:
    while (!paramString1.equalsIgnoreCase(abkw.f))
    {
      return;
    ...
    this.jdField_a_of_type_Abhq.a((Session)localObject1, String.valueOf(paramLong1), paramLong2, paramInt1, false);
  }
  ...
  public boolean a(long paramLong)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((abhz)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).jdField_a_of_type_Long == paramLong) {
        return true;
      }
    }
    return false;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localabhz = (abhz)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramBundle.uSessionID));
    } while (localabhz == null);
    paramBundle.strFilePathSrc = localabhz.jdField_b_of_type_JavaLangString;
    paramBundle.uFileSizeSrc = localabhz.jdField_b_of_type_Long;
    Object localObject1 = this.jdField_a_of_type_Abhq;
    Object localObject2 = localabhz.jdField_a_of_type_JavaLangString;
    long l = localabhz.jdField_a_of_type_Long;
    int j = localabhz.jdField_a_of_type_Int;
    if (i == 0)
    {
      ((abhq)localObject1).a(paramBundle, (String)localObject2, l, j, bool);
      localObject1 = BaseApplicationImpl.getApplication().getRuntime();
      if ((localObject1 instanceof QQAppInterface))
      {
        localObject1 = (QQAppInterface)localObject1;
  ...
  public void b(Session paramSession)
  {
    ...
    abhy localabhy = new abhy(this);
    if (paramSession.bSend) {}
    for (localabhy.jdField_a_of_type_Int = 1001;; localabhy.jdField_a_of_type_Int = 2001)
    {
      localabhy.jdField_a_of_type_Long = localabhz.jdField_a_of_type_Long;
      localMessage.obj = localabhy;
      this.jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler.sendMessageDelayed(localMessage, 0L);
