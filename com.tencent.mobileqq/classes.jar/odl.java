...
public class odl
{
  ...
  public boolean a(Context paramContext, MessageRecord paramMessageRecord, TextView paramTextView, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        boolean bool = bgsp.a(paramString);
        if (bool) {
          return false;
        }
        try
        {
          ...
          {
            paramTextView.setBackgroundResource(2130847090);
            paramTextView.setVisibility(0);
            paramTextView.setText(anni.a(2131702403));
            localObject1 = paramContext.getResources().getDrawable(2130847093);
            ((Drawable)localObject1).setBounds(0, 0, 24, 16);
            paramTextView.setCompoundDrawables(null, null, (Drawable)localObject1, null);
            i = zlx.a(paramContext, 6.0F);
            paramTextView.setPadding(i, 0, i, 0);
            paramTextView.setCompoundDrawablePadding(zlx.a(paramContext, 2.0F));
            ...
            localObject1 = LayoutInflater.from(paramContext).inflate(2131559577, null);
            LinearLayout localLinearLayout = (LinearLayout)((View)localObject1).findViewById(2131370049);
            ...
            if (i < paramString.length())
            {
              ...
              ((LinearLayout)localObject3).setOnClickListener(new odm(this, j, (JSONObject)localObject2, paramContext, paramMessageRecord));
              ...
              ((LinearLayout.LayoutParams)localObject4).height = zlx.a(paramContext, 50.0F);
              ...
              ((LinearLayout.LayoutParams)localObject5).width = zlx.a(paramContext, 20.0F);
              ((LinearLayout.LayoutParams)localObject5).height = zlx.a(paramContext, 18.0F);
              ((LinearLayout.LayoutParams)localObject5).leftMargin = zlx.a(paramContext, 15.0F);
              localObject5 = ((JSONObject)localObject2).optString("icon_url", "");
              if (!bgsp.a((String)localObject5))
              {
                URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
                localURLDrawableOptions.mRequestHeight = zlx.a(paramContext, 20.0F);
                localURLDrawableOptions.mRequestWidth = zlx.a(paramContext, 18.0F);
              ...
              ((LinearLayout.LayoutParams)localObject3).leftMargin = zlx.a(paramContext, 10.0F);
              ...
              ((LinearLayout.LayoutParams)localObject3).height = zlx.a(paramContext, 1.0F);
        ...
        catch (JSONException paramString)
        {
          ...
          paramTextView.setOnClickListener(new odn(this, paramContext, paramTextView, paramMessageRecord));
          return true;
        }
        return false;
      }
