...
public class amro
{
  ...
  private WeakReference<amrp> jdField_a_of_type_JavaLangRefWeakReference;
  private BlockingQueue<amrx> jdField_a_of_type_JavaUtilConcurrentBlockingQueue = new ArrayBlockingQueue(100);
  private boolean jdField_a_of_type_Boolean;
  private BlockingQueue<amrx> b;
  private BlockingQueue<amrx> c;
  ...
  private void a(amrx paramamrx)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_JavaUtilConcurrentBlockingQueue.offer(paramamrx);
      ...
      ThreadManager.getUIHandler().post(new CmGameDebugManager.1(this, paramamrx));
      return;
      this.jdField_c_of_type_JavaUtilConcurrentBlockingQueue.offer(paramamrx);
      if (this.jdField_c_of_type_JavaUtilConcurrentBlockingQueue.size() == 50)
      {
        ...
        continue;
        this.jdField_b_of_type_JavaUtilConcurrentBlockingQueue.offer(paramamrx);
  ...
  private List<amrx> b(int paramInt)
  {
    Object localObject = Arrays.asList(this.jdField_a_of_type_JavaUtilConcurrentBlockingQueue.toArray(new amrx[0]));
    if (paramInt == 0) {
      return localObject;
    }
    ...
    {
      amrx localamrx = (amrx)((Iterator)localObject).next();
      if (localamrx.a == paramInt) {
        localArrayList.add(localamrx);
      }
    }
    return localArrayList;
  }
  
  public List<amrx> a(int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    switch (paramInt)
    {
    default: 
      return localArrayList;
    case 0: 
      return Arrays.asList(this.jdField_a_of_type_JavaUtilConcurrentBlockingQueue.toArray(new amrx[0]));
    case 1: 
      return b(1);
    case 2: 
      return b(2);
    case 3: 
      return Arrays.asList(this.jdField_b_of_type_JavaUtilConcurrentBlockingQueue.toArray(new amrx[0]));
    }
    return Arrays.asList(this.jdField_c_of_type_JavaUtilConcurrentBlockingQueue.toArray(new amrx[0]));
  }
  ...
  public void a(amrp paramamrp)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramamrp);
  }
  ...
  public void a(String paramString, int paramInt, Object... paramVarArgs)
  {
    ...
    a(new amrx(localStringBuilder.toString(), paramInt));
  }
