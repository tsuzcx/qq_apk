...
public class bjqh
{
  ...
  public static bjqh a()
  {
    try
    {
      if (jdField_a_of_type_Bjqh == null) {
        jdField_a_of_type_Bjqh = new bjqh();
      }
      bjqh localbjqh = jdField_a_of_type_Bjqh;
      return localbjqh;
    }
    finally {}
  }
  ...
  public int a(int paramInt)
  {
    ...
    {
      return paramInt;
      i = bjvf.a(bjjo.a().a(), null).a("Common_CGIReportFrequencyFailed");
      paramInt = i;
    } while (i != 0);
    return 100;
  }
  ...
  public Bundle a()
  {
    localObject1 = bjqj.a().a("report_cgi");
    ...
    try
    {
      ((Bundle)localObject1).putString("releaseversion", bjjo.a().f());
      ((Bundle)localObject1).putString("device", Build.DEVICE);
      ((Bundle)localObject1).putString("qua", bjvk.b);
      ...
      while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        localObject2 = bjve.h() + "&" + (String)((BaseData)localObject2).attrs.get("deviceInfo");
  ...
  public void a(Bundle paramBundle, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        bjjo.a().a(Long.valueOf(paramString2).longValue());
        if (QLog.isColorLevel()) {
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, boolean paramBoolean)
  {
    try
    {
      a(bjqq.a(paramString1, paramString2, paramString4, paramString5, paramString3, paramString6, paramString7, "", "", paramString8, paramString9), paramString3, paramString1, paramBoolean);
      return;
    }
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, boolean paramBoolean)
  {
    try
    {
      a(bjqq.a(paramString1, paramString2, paramString4, paramString5, paramString3, paramString6, paramString5, "", "", "", ""), paramString3, paramString1, paramBoolean);
      return;
    }
    catch (Exception paramString1)
    {
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    {
      j = bjvf.a(bjjo.a().a(), null).a("Common_CGIReportMaxcount");
      if (j != 0) {}
    }
    for (;;)
    {
      ...
      {
        j = bjvf.a(bjjo.a().a(), null).a("Agent_ReportBatchCount");
        if (j != 0) {
          i = j;
        }
      }
  ...
  public Bundle b()
  {
    for (;;)
    {
      try
      {
        Object localObject1 = bjqj.a().a("report_via");
        if (localObject1 != null) {
