...
public class bddn
{
  ...
  public static SpannableString a(Resources paramResources, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (!bdwo.a(localAppInterface.getApp(), paramInt1)) {
      bdwo.a((QQAppInterface)localAppInterface, paramInt1, null, false);
    }
    ...
    if (paramInt2 == 0)
    {
      ...
      paramInt2 = (int)paramResources.getDimension(2131298272);
      paramResources = paramResources.getDrawable(2130845441);
      paramResources = bduc.a(localAppInterface, bddf.a(paramInt1, bddf.a), "", paramResources, bduc.b, "halfStar", false, null);
    ...
    for (;;)
    {
      ...
      paramInt3 = (int)paramResources.getDimension(2131298272);
      paramInt2 = 0;
      if (paramInt2 < str1.length())
      {
        ...
        {
          localObject = paramResources.getDrawable(2130845439);
          localObject = bduc.a(localAppInterface, bddf.a(paramInt1, bddf.e), "", (Drawable)localObject, bduc.b, "crown", false, null);
          label466:
          if (localObject != null)
          {
            if (!"&".equalsIgnoreCase(str2)) {
        ...
        for (;;)
        {
          ...
          if ("@".equalsIgnoreCase(str2))
          {
            localObject = paramResources.getDrawable(2130845443);
            localObject = bduc.a(localAppInterface, bddf.a(paramInt1, bddf.d), "", (Drawable)localObject, bduc.b, "sun", false, null);
            break label466;
          }
          if ("#".equalsIgnoreCase(str2))
          {
            localObject = paramResources.getDrawable(2130845440);
            localObject = bduc.a(localAppInterface, bddf.a(paramInt1, bddf.c), "", (Drawable)localObject, bduc.b, "moon", false, null);
            break label466;
          }
          if ("%".equalsIgnoreCase(str2))
          {
            localObject = paramResources.getDrawable(2130845442);
            localObject = bduc.a(localAppInterface, bddf.a(paramInt1, bddf.b), "", (Drawable)localObject, bduc.b, "star", false, null);
            break label466;
          }
          if ("$".equalsIgnoreCase(str2))
          {
            localObject = paramResources.getDrawable(2130850143);
            break label466;
          }
          localObject = null;
          break label466;
  ...
  public static SpannableString a(View paramView, Resources paramResources, long paramLong, int paramInt, boolean paramBoolean)
  {
    ...
    for (localObject = bdvk.a().a(((QQAppInterface)localObject).c(), paramLong, paramInt, paramBoolean);; localObject = "")
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if (((URLDrawable)localObject).getStatus() == 1) {
          ((URLDrawable)localObject).setBounds(0, 0, xsm.a(BaseApplicationImpl.getContext(), 47.0F), xsm.a(BaseApplicationImpl.getContext(), 14.0F));
        }
      }
      for (;;)
      {
        if (localObject != null)
        {
          ((URLDrawable)localObject).setURLDrawableListener(new bddo(paramView));
          localSpannableString.setSpan(new ImageSpan((Drawable)localObject), 0, 1, 33);
          paramView = paramResources.getDrawable(2130845464);
          paramView.setBounds(0, 0, (int)paramResources.getDimension(2131297104), xsm.a(BaseApplicationImpl.getContext(), 5.0F));
  ...
  public static SpannableString a(View paramView, Resources paramResources, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    paramView = null;
    int i = (int)paramResources.getDimension(2131297133);
    ...
    if ((paramBoolean1) && (paramInt > 0))
    {
      ...
      localDrawable = paramResources.getDrawable(2130846610);
    ...
    for (;;)
    {
      ...
      {
        paramView.mutate();
        ((URLDrawable)paramView).setURLDrawableListener(new bddp(localWeakReference));
        localSpannableString.setSpan(new ImageSpan(paramView), 0, 1, 33);
        paramView = paramResources.getDrawable(2130845464);
        paramView.setBounds(0, 0, (int)paramResources.getDimension(2131297104), i);
        localSpannableString.setSpan(new ImageSpan(paramView), 1, 2, 33);
      }
      if (QLog.isDevelopLevel()) {
      ...
      if ((paramBoolean2) && (paramInt > 0))
      {
        ...
        localDrawable = paramResources.getDrawable(2130846611);
        paramView = URLDrawable.getDrawable(paramView, localDrawable, localDrawable);
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    boolean bool = SettingCloneUtil.readValue((Context)localObject2, null, ((Context)localObject2).getString(2131695482), "qqsetting_auto_receive_pic_key", true);
    int i;
    Object localObject3;
    if (bool)
    {
      ...
      localObject3 = (ayec)paramQQAppInterface.getManager(15);
      if (localObject3 != null)
      {
        bool = ((ayec)localObject3).b();
        if (!bool) {
          break label1197;
        }
        i = 1;
        ...
        if (!alqf.a(paramQQAppInterface, false)) {
          break label1202;
        }
        i = 1;
        label108:
        ((Map)localObject1).put("Download_new", Integer.valueOf(i));
        if (!SettingCloneUtil.readValue((Context)localObject2, null, ((Context)localObject2).getString(2131719890), "qqsetting_notify_icon_key", false)) {
          break label1207;
        }
        i = 1;
        label146:
        ((Map)localObject1).put("System_icon", Integer.valueOf(i));
        if (!SettingCloneUtil.readValue((Context)localObject2, null, paramQQAppInterface.getApp().getString(2131695437), "qqsetting_enter_sendmsg_key", false)) {
          break label1212;
        }
        i = 1;
        label186:
        ...
        if (!auwq.b(paramQQAppInterface.getAccount())) {
          break label1237;
        }
        i = 1;
        label322:
    ...
    for (;;)
    {
      try
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          azqs.b(paramQQAppInterface, "CliStatus", "", "", "Setting_tab", (String)localObject3, 0, 0, String.valueOf(((Map)localObject1).get(localObject3)), "", "", "");
          continue;
        }
        if (!SettingCloneUtil.readValue(paramQQAppInterface.getApp(), null, paramQQAppInterface.getApp().getString(2131695444), "qqsetting_screenshot_key", false)) {
          break label1292;
        }
        i = 1;
        azqs.b(paramQQAppInterface, "CliStatus", "", "", "Setting_tab", "Shake_screenshot_switch", 0, 0, String.valueOf(i), "", "", "");
        if (!paramQQAppInterface.c(false)) {
          break label1297;
        }
        i = 1;
        azqs.b(paramQQAppInterface, "CliStatus", "", "", "0X80044D1", "0X80044D1", 0, 0, String.valueOf(i), "", "", "");
        localObject1 = ((alto)paramQQAppInterface.getManager(51)).b(paramQQAppInterface.getCurrentAccountUin());
        if (localObject1 != null)
        {
          ...
          i = 1;
          azqs.b(paramQQAppInterface, "CliStatus", "", "", "0X8004884", "0X8004884", 0, 0, String.valueOf(i), "", "", "");
        }
        if (!HotChatManager.b(paramQQAppInterface)) {
          break label1307;
        }
        i = 1;
        azqs.b(paramQQAppInterface, "CliStatus", "", "", "0X8004B1E", "0X8004B1E", 0, 0, String.valueOf(i), "", "", "");
        if (!paramQQAppInterface.e(false)) {
          break label1312;
        }
        i = 1;
        azqs.b(paramQQAppInterface, "CliStatus", "", "", "0X8004C5C", "0X8004C5C", 0, 0, String.valueOf(i), "", "", "");
        if (!paramQQAppInterface.f(false)) {
          break label1317;
        }
        i = 1;
        azqs.b(paramQQAppInterface, "CliStatus", "", "", "0X8004C5D", "0X8004C5D", 0, 0, String.valueOf(i), "", "", "");
        localObject3 = (alto)paramQQAppInterface.getManager(51);
        i = ((alto)localObject3).c();
        if (i <= 0) {
          break label1322;
        }
        localObject1 = "1";
        if (i > 0)
        {
          ...
          azqs.b(paramQQAppInterface, "CliStatus", "", "", "0X8004C69", "0X8004C69", 0, 0, (String)localObject1, (String)localObject2, String.valueOf(((alto)localObject3).b()), "");
          if (((amga)paramQQAppInterface.getManager(85)).a(false))
          {
            i = 1;
            azqs.b(paramQQAppInterface, "CliStatus", "", "", "0X8004E0C", "0X8004E0C", 0, i, String.valueOf(i), "", "", "");
            if (!paramQQAppInterface.n) {
              continue;
            }
            i = 1;
            azqs.b(paramQQAppInterface, "CliStatus", "", "", "0X8004EDE", "0X8004EDE", 0, 0, String.valueOf(i), "", "", "");
            localObject1 = ((ahuf)paramQQAppInterface.getManager(295)).a();
            ...
            localObject2 = (ahua)((Iterator)localObject1).next();
            int j = ((ahua)localObject2).a;
            if (!((ahua)localObject2).e) {
              continue;
            }
            i = 2;
            azqs.b(paramQQAppInterface, "CliStatus", "", "", "0X80097A1", "0X80097A1", j, 0, String.valueOf(i), "", "", "");
            continue;
          }
        }
        else
  ...
  public static void c(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      azri.a(null).b(paramQQAppInterface, localStringBuilder.toString());
    }
  }
}
