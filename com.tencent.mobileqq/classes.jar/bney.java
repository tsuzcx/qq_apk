  ...
  extends bnee
{
  ...
  private int a(PublishParam paramPublishParam)
  {
    ...
    //   0: new 29	bodr
    //   3: dup
    //   4: invokespecial 30	bodr:<init>	()V
    //   7: astore 9
    ...
    //   74: lstore 7
    //   76: aload_0
    //   77: new 83	com/tencent/mobileqq/activity/shortvideo/EncodeVideoTask$ThumbInfo
    //   80: dup
    //   81: invokespecial 84	com/tencent/mobileqq/activity/shortvideo/EncodeVideoTask$ThumbInfo:<init>	()V
    //   84: putfield 86	bney:jdField_a_of_type_ComTencentMobileqqActivityShortvideoEncodeVideoTask$ThumbInfo	Lcom/tencent/mobileqq/activity/shortvideo/EncodeVideoTask$ThumbInfo;
    //   87: aload_1
    //   88: invokestatic 92	com/tencent/mobileqq/utils/FileUtils:fileExistsAndNotEmpty	(Ljava/lang/String;)Z
    //   91: ifne +23 -> 114
    ...
    //   113: ireturn
    //   114: aload 11
    //   116: invokestatic 92	com/tencent/mobileqq/utils/FileUtils:fileExistsAndNotEmpty	(Ljava/lang/String;)Z
    //   119: ifne +21 -> 140
    ...
    //   140: aload_1
    //   141: aload 9
    //   143: invokestatic 101	bodq:a	(Ljava/lang/String;Lbodr;)I
    //   146: istore_3
    //   147: iload_3
    //   148: ifeq +38 -> 186
    //   151: iload_3
    ...
    //   174: iload_3
    //   175: invokevirtual 106	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    ...
    //   201: istore 5
    //   203: aload 9
    //   205: getfield 109	bodr:a	[I
    //   208: iconst_2
    //   209: iaload
    //   210: istore 6
    //   212: aload 9
    //   214: getfield 109	bodr:a	[I
    //   217: iconst_0
    //   218: iaload
    //   219: istore 4
    //   221: aload 9
    //   223: getfield 109	bodr:a	[I
    //   226: iconst_1
    //   227: iaload
    //   228: istore_2
    //   229: iload 6
    ...
    //   257: aload 11
    //   259: aload_0
    //   260: getfield 19	bney:jdField_a_of_type_Double	D
    //   263: aload_0
    //   264: getfield 111	bney:b	D
    //   267: invokestatic 116	bfvo:a	(Ljava/lang/String;DD)Z
    //   270: pop
    ...
    //   280: astore_1
    //   281: new 118	java/io/FileInputStream
    //   284: dup
    //   285: aload 11
    //   287: invokespecial 119	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   290: astore 9
    //   292: aload 9
    //   294: aload_1
    //   295: invokevirtual 122	java/io/File:length	()J
    //   298: invokestatic 128	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   301: astore_1
    //   302: aload_1
    //   303: invokestatic 134	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   306: astore 10
    //   308: aload 9
    //   310: ifnull +8 -> 318
    //   313: aload 9
    //   315: invokevirtual 137	java/io/FileInputStream:close	()V
    //   318: aload 10
    //   320: invokestatic 143	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   323: ifeq +43 -> 366
    ...
    //   356: astore 9
    //   358: aload 9
    //   360: invokevirtual 148	java/io/IOException:printStackTrace	()V
    //   363: goto -45 -> 318
    //   366: aload 10
    //   368: ldc 150
    //   370: invokestatic 155	dov/com/tencent/mobileqq/shortvideo/ShortVideoUtils:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   373: astore 9
    //   375: aload 11
    //   377: aload 9
    //   379: invokestatic 159	com/tencent/mobileqq/utils/FileUtils:rename	(Ljava/lang/String;Ljava/lang/String;)Z
    //   382: ifeq +86 -> 468
    ...
    //   426: aload_0
    //   427: getfield 86	bney:jdField_a_of_type_ComTencentMobileqqActivityShortvideoEncodeVideoTask$ThumbInfo	Lcom/tencent/mobileqq/activity/shortvideo/EncodeVideoTask$ThumbInfo;
    //   430: aload 9
    //   432: putfield 169	com/tencent/mobileqq/activity/shortvideo/EncodeVideoTask$ThumbInfo:path	Ljava/lang/String;
    //   435: aload_0
    //   436: getfield 86	bney:jdField_a_of_type_ComTencentMobileqqActivityShortvideoEncodeVideoTask$ThumbInfo	Lcom/tencent/mobileqq/activity/shortvideo/EncodeVideoTask$ThumbInfo;
    //   439: aload_1
    //   440: putfield 173	com/tencent/mobileqq/activity/shortvideo/EncodeVideoTask$ThumbInfo:thumbMd5	[B
    //   443: aload_0
    //   444: getfield 86	bney:jdField_a_of_type_ComTencentMobileqqActivityShortvideoEncodeVideoTask$ThumbInfo	Lcom/tencent/mobileqq/activity/shortvideo/EncodeVideoTask$ThumbInfo;
    //   447: iload 4
    //   449: putfield 176	com/tencent/mobileqq/activity/shortvideo/EncodeVideoTask$ThumbInfo:width	I
    //   452: aload_0
    //   453: getfield 86	bney:jdField_a_of_type_ComTencentMobileqqActivityShortvideoEncodeVideoTask$ThumbInfo	Lcom/tencent/mobileqq/activity/shortvideo/EncodeVideoTask$ThumbInfo;
    //   456: iload_3
    //   457: putfield 179	com/tencent/mobileqq/activity/shortvideo/EncodeVideoTask$ThumbInfo:hight	I
    //   460: aload_0
    //   461: iload 5
    //   463: putfield 181	bney:c	I
    //   466: iconst_0
    //   467: ireturn
    //   468: aload 9
    //   470: invokestatic 92	com/tencent/mobileqq/utils/FileUtils:fileExistsAndNotEmpty	(Ljava/lang/String;)Z
    //   473: ifne +60 -> 533
  ...
  {
    // Byte code:
    //   0: invokestatic 217	dov/com/tencent/mobileqq/activity/richmedia/state/RMVideoStateMgr:a	()Ldov/com/tencent/mobileqq/activity/richmedia/state/RMVideoStateMgr;
    //   3: astore 10
    //   5: invokestatic 222	com/tencent/mobileqq/shortvideo/VideoEnvironment:supportSubmitCallback	()Z
    //   8: ifeq +234 -> 242
    //   11: ldc 224
    //   13: iconst_0
    //   14: invokestatic 230	cooperation/qzone/thread/QzoneHandlerThreadFactory:getHandlerThread	(Ljava/lang/String;Z)Lcooperation/qzone/thread/QzoneBaseThread;
    //   17: new 232	dov/com/tencent/biz/qqstory/takevideo/EditWebVideoPartManager$3
    //   20: dup
    //   21: aload_0
    //   22: aload 10
    //   24: invokespecial 235	dov/com/tencent/biz/qqstory/takevideo/EditWebVideoPartManager$3:<init>	(Lbney;Ldov/com/tencent/mobileqq/activity/richmedia/state/RMVideoStateMgr;)V
    //   27: invokevirtual 240	cooperation/qzone/thread/QzoneBaseThread:post	(Ljava/lang/Runnable;)V
    //   30: invokestatic 222	com/tencent/mobileqq/shortvideo/VideoEnvironment:supportSubmitCallback	()Z
    //   33: ifeq +208 -> 241
    //   36: lconst_0
    //   37: lstore 6
    //   39: aload 10
    //   41: getfield 243	dov/com/tencent/mobileqq/activity/richmedia/state/RMVideoStateMgr:a	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   44: astore 9
    //   46: aload 9
    //   48: monitorenter
    //   49: aload 10
    //   51: getfield 243	dov/com/tencent/mobileqq/activity/richmedia/state/RMVideoStateMgr:a	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   54: invokevirtual 248	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   57: istore 8
    //   59: lload 6
    //   61: lstore 4
    //   63: iload 8
    ...
    //   82: iconst_2
    //   83: ldc 250
    //   85: invokestatic 253	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   88: lload 6
    //   90: lstore_2
    //   91: invokestatic 258	android/os/SystemClock:elapsedRealtime	()J
    //   94: lstore 4
    //   96: lload 6
    //   98: lstore_2
    //   99: aload 10
    //   101: getfield 243	dov/com/tencent/mobileqq/activity/richmedia/state/RMVideoStateMgr:a	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   104: ldc2_w 259
    //   107: invokevirtual 266	java/lang/Object:wait	(J)V
    //   110: lload 6
    //   112: lstore_2
    //   113: invokestatic 258	android/os/SystemClock:elapsedRealtime	()J
    //   116: lload 4
    //   118: lsub
    //   119: lstore 6
    //   121: lload 6
    ...
    //   153: lload 6
    //   155: invokevirtual 271	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   158: invokevirtual 71	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   161: invokestatic 253	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   164: lload 6
    //   166: lstore 4
    //   168: aload 9
    //   170: monitorexit
    ...
    //   179: iconst_2
    //   180: ldc_w 273
    //   183: invokestatic 253	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   186: lload 4
    //   188: ldc2_w 274
    //   191: lcmp
    //   192: ifge +49 -> 241
    ...
    //   231: invokestatic 253	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   234: iload_1
    //   235: i2l
    //   236: lstore_2
    //   237: lload_2
    //   238: invokestatic 282	java/lang/Thread:sleep	(J)V
    //   241: return
    //   242: invokestatic 287	boct:a	()Lboct;
    //   245: invokevirtual 290	boct:a	()Lcom/tencent/maxvideo/mediadevice/AVCodec;
    //   248: invokevirtual 296	com/tencent/maxvideo/mediadevice/AVCodec:recordSubmit	()I
    //   251: pop
    ...
    //   260: iconst_2
    //   261: ldc_w 298
    //   264: invokestatic 253	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   267: goto -237 -> 30
    //   270: astore 9
    ...
    //   280: iconst_2
    //   281: ldc_w 300
    //   284: invokestatic 253	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   287: aload 9
    //   289: invokevirtual 301	java/lang/UnsatisfiedLinkError:printStackTrace	()V
    //   292: goto -262 -> 30
    //   295: astore 10
    //   297: lload_2
    //   298: lstore 4
    ...
    //   309: ldc_w 303
    //   312: aload 10
    //   314: invokestatic 307	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   317: lload_2
    //   318: lstore 4
    //   320: goto -152 -> 168
    //   323: astore 10
    ...
    //   342: ldc_w 309
    //   345: aload 9
    //   347: invokestatic 307	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   350: return
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	351	0	this	bney
