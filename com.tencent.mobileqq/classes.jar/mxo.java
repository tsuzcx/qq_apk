...
public class mxo
{
  static HashMap<Integer, Class<? extends myj>> a = new HashMap(5);
  
  static
  {
    a.put(Integer.valueOf(1), myk.class);
    a.put(Integer.valueOf(2), mym.class);
    a.put(Integer.valueOf(3), myn.class);
    a.put(Integer.valueOf(4), myo.class);
    a.put(Integer.valueOf(5), myp.class);
  }
  ...
  @Nullable
  public static mxp a(AvGameCommon.GameStatusInfo paramGameStatusInfo)
  {
    ...
    try
    {
      ...
      try
      {
        localmyd.a(paramGameStatusInfo);
        return localmyd;
      }
      catch (Exception localException1)
      {
        paramGameStatusInfo = localmyd;
      }
    }
  ...
  public static mxq a(AvGameCommon.GameQuestionInfo paramGameQuestionInfo, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localObject = (mxq)((Class)localObject).newInstance();
      ((mxq)localObject).a(paramBoolean);
      ((mxq)localObject).a(paramGameQuestionInfo);
  ...
  public static boolean a(myg parammyg)
  {
    if ((parammyg.a == 2) || (parammyg.a == 300) || (parammyg.a == 400)) {}
    int i;
    do
    {
      return false;
  ...
  @Nullable
  public static mxq b(AvGameCommon.GameQuestionInfo paramGameQuestionInfo, boolean paramBoolean)
  {
    try
    {
  ...
  public static boolean b(myg parammyg)
  {
    boolean bool = true;
    if (parammyg == null) {
      return false;
    }
    if ((a(parammyg)) && (parammyg.b == 1)) {}
    for (;;)
    {
      return bool;
      bool = false;
