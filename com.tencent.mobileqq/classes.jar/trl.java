  ...
  extends LinearLayout
{
  ...
  public trl(TabLayoutCompat paramTabLayoutCompat, Context paramContext)
  {
    super(paramContext);
  ...
  private void a(@Nullable TextView paramTextView, @Nullable ImageView paramImageView)
  {
    ...
    {
      localDrawable = this.jdField_a_of_type_Trk.a();
      if (this.jdField_a_of_type_Trk == null) {
        break label176;
      }
      localCharSequence1 = this.jdField_a_of_type_Trk.a();
      if (this.jdField_a_of_type_Trk == null) {
        break label182;
      }
      localCharSequence2 = this.jdField_a_of_type_Trk.b();
      label48:
  ...
  public void a(@Nullable trk paramtrk)
  {
    if (paramtrk != this.jdField_a_of_type_Trk)
    {
  ...
  public boolean performClick()
  {
    ...
    if (this.jdField_a_of_type_Trk != null)
    {
      ...
      trk localtrk = TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat);
      if (TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat) == this.jdField_a_of_type_Trk) {
        i = 1;
      }
      this.jdField_a_of_type_Trk.a();
      if ((TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat) != null) && (i == 0)) {
        TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat).a(this.jdField_a_of_type_Trk, localtrk, 1);
      }
      return true;
    }
    return bool;
