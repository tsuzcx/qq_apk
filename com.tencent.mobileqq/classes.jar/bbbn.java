...
public class bbbn
{
  ...
  private static Handler jdField_a_of_type_AndroidOsHandler = new bbbo(ThreadManager.getSubThreadLooper());
  private static bfnj<Integer> jdField_a_of_type_Bfnj = new bfnj(40);
  ...
  private static void c()
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        ...
        {
          jdField_a_of_type_Bfnj.a(localThread3.getId(), Integer.valueOf(localThread3.getPriority()));
  ...
  private static void d()
  {
    ...
    while (i < j)
    {
      ...
      {
        int k = ((Integer)jdField_a_of_type_Bfnj.a(localThread.getId(), Integer.valueOf(0))).intValue();
        if (k != 0) {
