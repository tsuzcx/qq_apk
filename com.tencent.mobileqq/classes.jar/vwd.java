...
public class vwd
{
  ...
  public static vwd a(qqstory_service.PromoteTask paramPromoteTask)
  {
    vwd localvwd = new vwd();
    localvwd.jdField_a_of_type_Long = paramPromoteTask.uint64_taskid.get();
    localvwd.jdField_a_of_type_Int = paramPromoteTask.uint32_promote_type.get();
    localvwd.jdField_a_of_type_JavaLangString = paramPromoteTask.bytes_union_id.get().toStringUtf8();
    localvwd.jdField_b_of_type_JavaLangString = paramPromoteTask.bytes_feed_id.get().toStringUtf8();
    localvwd.jdField_b_of_type_Long = paramPromoteTask.uint64_limit_count.get();
    localvwd.c = paramPromoteTask.uint64_minimal_video_count.get();
    localvwd.d = paramPromoteTask.uint64_expire_time.get();
    return localvwd;
  }
