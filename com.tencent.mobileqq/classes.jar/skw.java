...
{
  public skw(ForwardRecentActivity paramForwardRecentActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        if (((PhoneContactManagerImp)this.a.app.getManager(10)).f())
        {
          ...
          ForwardRecentActivity.a(this.a).findViewById(2131364624).setVisibility(8);
          return;
        }
    ...
    for (int j = 1;; j = 0)
    {
      ...
      paramView.putExtra("param_done_button_wording", this.a.getString(2131435947));
      paramView.putExtra("param_done_button_highlight_wording", this.a.getString(2131435948));
