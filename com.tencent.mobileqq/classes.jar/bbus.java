...
public class bbus
{
  ...
  {
    int i = ((Integer)paramView.getTag(2131380930)).intValue();
    Object localObject;
    View localView;
    ...
    if ((paramView instanceof LinearLayout))
    {
      ...
      paramView.removeView(paramView.findViewById(2131374335));
      paramView.removeView(paramView.findViewById(2131374336));
      if (paramView.getChildCount() == 1)
      {
        ...
        int j = ((Context)localObject).getResources().getDimensionPixelSize(2131298386);
        k = ((Context)localObject).getResources().getDimensionPixelSize(2131298387);
        switch (paramInt2)
        {
        default: 
    ...
    for (;;)
    {
      if (bbnk.a(paramInt3))
      {
        localObject = new bbvp((Context)localObject, paramInt3).a();
        ((View)localObject).setId(2131374336);
      ...
      if (((paramInt2 == 0) || (paramInt1 == 1)) && (paramBoolean1) && (i != 1))
      {
        ...
        ((View)localObject).setId(2131374335);
        ((View)localObject).setLayoutParams(new LinearLayout.LayoutParams(-1, paramView.getContext().getResources().getDimensionPixelSize(2131298380)));
        paramView.addView((View)localObject, 0);
  ...
  public static void a(bbmy parambbmy, int paramInt1, int paramInt2)
  {
    int j = 1;
    int i = j;
    if (paramInt1 > 1)
