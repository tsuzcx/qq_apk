      ...
      for (;;)
      {
        ...
        if ("getCache".equals(paramString))
        {
          try
          {
            ...
            pye.a().a(paramJSONObject.getString("url"), paramJSONObject.toString(), new rjx(paramOnInovkeCallback));
            return;
          }
          catch (JSONException paramString)
          {
        ...
        else if ("writeCache".equals(paramString))
        {
          try
          {
            ...
            {
              paramJSONObject.put("callid", 0);
              pye.a().a(paramJSONObject.getString("url"), paramJSONObject.toString(), null, paramJSONObject);
              return;
            }
          }
          catch (JSONException paramString)
