  ...
  implements Handler.Callback
{
  ...
  private oidb_cmd0xb77.ImageInfo a(awki paramawki)
  {
    if (paramawki == null) {
      return null;
    }
    if (!(paramawki.a instanceof int[])) {
      return null;
    }
    int[] arrayOfInt = (int[])paramawki.a;
    if (arrayOfInt.length != 5) {
      return null;
    }
    oidb_cmd0xb77.ImageInfo localImageInfo = new oidb_cmd0xb77.ImageInfo();
    localImageInfo.md5.set(paramawki.d);
    localImageInfo.uuid.set(paramawki.c);
    ...
    localImageInfo.file_id.set((int)paramawki.b);
    return localImageInfo;
  }
  
  private oidb_cmd0xdc2.ReqBody a(String paramString1, String paramString2, Map<ResultRecord, awki> paramMap)
  {
    oidb_cmd0xdc2.ReqBody localReqBody = new oidb_cmd0xdc2.ReqBody();
    localReqBody.msg_body.set(asdt.a(this.jdField_a_of_type_AndroidOsBundle, paramString1, paramString2, null));
    ...
    if (paramList.size() == 1)
    {
      ...
      if (((oidb_cmd0xdc2.BatchSendRsp)localObject1).err_code.get() == 901503)
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          paramList = asdt.jdField_a_of_type_JavaLangString;
        }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    asdt.a(this.jdField_a_of_type_ComTencentMobileqqMiniShareOpensdkOpenSdkShareModel, this.jdField_a_of_type_AndroidOsBundle, paramString1.msg_body);
    ...
    aseh.a("KEY_STAGE_2_NORMAL_DC2");
    mzy.a(paramString2, new asat(this), paramString1.toByteArray(), "OidbSvc.0xdc2_9", 3522, 9, localBundle, 0L);
  }
  
  private void a(Map<ResultRecord, awki> paramMap)
  {
    ...
    aseh.a("KEY_STAGE_2_IMAGE_DC2");
    mzy.a(localAppRuntime, new asas(this), paramMap.toByteArray(), "OidbSvc.0xdc2_9", 3522, 9, localBundle, 0L);
  }
  
  private void a(Map<ResultRecord, awki> paramMap, ResultRecord paramResultRecord, oidb_cmd0xdc2.BatchSendReq paramBatchSendReq)
  {
    if (paramMap != null)
    {
      paramMap = a((awki)paramMap.get(paramResultRecord));
      if (paramMap != null) {
  ...
  private void b()
  {
    ...
    WeakReference localWeakReference = new WeakReference(new asaq(this));
    ...
    AbsShareMsg.sendSdkShareMessageByServer(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, str1, i, str2, (awkh)localWeakReference.get());
  }
  ...
  private void b(List<oidb_cmd0xdc2.BatchSendRsp> paramList)
  {
    ...
    {
      paramList = aepi.a(localIntent, new int[] { 2 });
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Arzq.b(this.jdField_a_of_type_AndroidAppActivity);
      ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity);
      return;
      paramList = aepi.a(localIntent, null);
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_MqqOsMqqHandler.removeMessages(93);
    this.jdField_a_of_type_Arzq.b(this.jdField_a_of_type_AndroidAppActivity);
    ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, asdt.jdField_a_of_type_JavaLangString);
  }
  ...
  private void d()
  {
    ...
    aseh.a("KEY_STAGE_2_UPLOAD_IMAGE_MULT");
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
  ...
  void a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_Arzq = new arzq();
  }
  ...
  void a(List<ResultRecord> paramList)
  {
    ...
    paramList = azvd.a(this.jdField_a_of_type_AndroidOsBundle);
    ...
    if (!bdin.d(this.jdField_a_of_type_AndroidAppActivity))
    {
      ...
      ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, alud.a(2131705186));
      return;
    }
    a();
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Arzq.a(this.jdField_a_of_type_AndroidAppActivity);
      ...
      {
        this.jdField_a_of_type_Arzq.b(this.jdField_a_of_type_AndroidAppActivity);
        ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, alud.a(2131705185));
      }
      else
      {
        e();
