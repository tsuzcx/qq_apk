...
public class adcd
{
  ...
  private static adcd jdField_a_of_type_Adcd;
  
  public static adcd a()
  {
    if (jdField_a_of_type_Adcd == null) {}
    try
    {
      if (jdField_a_of_type_Adcd == null) {
        jdField_a_of_type_Adcd = new adcd();
      }
      return jdField_a_of_type_Adcd;
    }
    finally {}
  }
  ...
  {
    bmqj.a().a(paramString, paramLong2, paramArrayOfLong, paramLong1);
    ...
    if (jdField_a_of_type_Long > 0L)
    {
      ...
      localHashMap.put("hcState", String.valueOf(addy.a().a()));
    ...
    {
      if (bcow.e != 0L) {
        paramArrayOfLong = String.valueOf(paramLong1 - bcow.e);
      }
      if (bcow.d != 0L) {
        str1 = String.valueOf(paramLong1 - bcow.d);
      }
      if (bcow.g != 0L) {
        str2 = String.valueOf(paramLong1 - bcow.g);
      }
      if (bcow.f != 0L) {
        str3 = String.valueOf(paramLong1 - bcow.f);
      }
  ...
  public void a(String paramString)
  {
    ...
    if (paramString.equals("qzone_homepage")) {
      addy.a().a(0, 1, 1, 0, 1500, 701, 32L, Process.myTid(), "qzoneList", false);
    }
    while (!paramString.equals("list_photo")) {
      return;
    }
    addy.a().a(0, 1, 1, 0, 1500, 702, 32L, Process.myTid(), "photoList", false);
  }
