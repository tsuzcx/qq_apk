  ...
  extends azrf
{
  ...
  axpo(axpn paramaxpn, ArrayList paramArrayList, HashMap paramHashMap, MessageRecord paramMessageRecord, axow paramaxow, axpl paramaxpl) {}
  
  private int a(MessageForPic paramMessageForPic, azql paramazql)
  {
    ...
    for (;;)
    {
      ...
      paramMessageForPic.md5 = bhmi.c(axpf.a);
      ...
      for (;;)
      {
        if (i != 0)
        {
          ...
          if (paramazql.jdField_a_of_type_Int == 0)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.e("PicMultiMsgProcessor", 2, "WTF, picResult.mExtraObj is " + paramazql.jdField_a_of_type_JavaLangObject.getClass().getSimpleName());
            }
            i = 0;
            continue;
          }
      ...
      label591:
      for (int j = paramazql.jdField_a_of_type_Azqh.jdField_a_of_type_Int;; j = -1)
      {
        i = j;
        if (!QLog.isColorLevel()) {
          break;
  ...
  private boolean a(ArrayList<azql> paramArrayList)
  {
    ...
    if (n < this.b.size())
    {
      ...
      {
        i = k;
        if (((azql)paramArrayList.get(j)).b) {
          i = 1;
        }
      }
      if (((localObject1 instanceof MessageForPic)) || (((localObject1 instanceof MessageForReplyText)) && (((MessageForReplyText)localObject1).getSourceMessage() != null) && ((((MessageForReplyText)localObject1).getSourceMessage() instanceof MessageForPic))))
      {
        ...
        if ((localObject1 instanceof MessageForReplyText))
        {
          ...
          m = a((MessageForPic)localObject1, (azql)paramArrayList.get(j));
          k = i;
          bool2 = bool1;
          if (m != 0)
          {
            b(m);
            if (!this.jdField_a_of_type_Axpn.a(m)) {
              break label288;
            }
            bool2 = true;
            k = i;
        ...
        for (;;)
        {
          ...
          break label152;
          localObject2 = this.jdField_a_of_type_Axpn.a.a().a((MessageRecord)localObject1, axpn.a(), false);
          ...
          bool2 = this.jdField_a_of_type_Axpn.a.a().a(this.jdField_a_of_type_JavaUtilHashMap, (MessageRecord)localObject2);
          if (QLog.isColorLevel()) {
      ...
      if (((localObject1 instanceof MessageForMixedMsg)) || (((localObject1 instanceof MessageForReplyText)) && (((MessageForReplyText)localObject1).getSourceMessage() != null) && ((((MessageForReplyText)localObject1).getSourceMessage() instanceof MessageForMixedMsg)))) {
        if ((localObject1 instanceof MessageForReplyText))
        {
          ...
          m = a((MessageForPic)localObject2, (azql)paramArrayList.get(j));
          k = i;
          bool2 = bool1;
          if (m != 0)
          {
    ...
    for (;;)
    {
      ...
      break label483;
      label724:
      localObject2 = this.jdField_a_of_type_Axpn.a.a().a((MessageRecord)localObject2, anzj.a(2131707032), false);
      ...
      for (;;)
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          i1 = a((MessageForPic)localObject3, (azql)paramArrayList.get(j));
          k = i;
          bool2 = bool1;
          if (i1 != 0)
          {
            b(i1);
            if (this.jdField_a_of_type_Axpn.a(i1))
            {
              bool2 = true;
              k = i;
            }
        ...
        for (;;)
        {
          ...
          break label905;
          localObject3 = this.jdField_a_of_type_Axpn.a.a().a((MessageRecord)localObject3, anzj.a(2131707033), false);
          ...
          if (((localObject1 instanceof MessageForStructing)) || (((localObject1 instanceof MessageForReplyText)) && (((MessageForReplyText)localObject1).getSourceMessage() != null) && ((((MessageForReplyText)localObject1).getSourceMessage() instanceof MessageForMixedMsg))))
          {
            ...
            for (;;)
            {
              if ((localObject2 != null) && ((localObject2 instanceof StructMsgForImageShare)))
              {
                ...
                if ((localObject2 != null) && (((bdqr)localObject2).a != null))
                {
                  localObject2 = ((bdqr)localObject2).a;
                  if (QLog.isColorLevel()) {
                    QLog.d("PicMultiMsgProcessor", 2, "updateMessageForPic for MessageForPic, MsgIndex[" + n + "], resultIndex[" + j + "]");
                  }
                  ...
                  k = a((MessageForPic)localObject2, (azql)paramArrayList.get(j));
                  bool2 = bool1;
                  if (k != 0)
                  {
                    b(k);
                    bool2 = bool1;
                    if (this.jdField_a_of_type_Axpn.a(k)) {
                      bool2 = true;
                    }
                  }
                  k = j + 1;
                  ...
                  if (k != 0)
                  {
                    if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isReMultiMsg) {
                      bdll.b(this.jdField_a_of_type_Axpn.a, "CliOper", "", "", "0X800662B", "0X800662B", 0, 1, 0, "", "", "", "");
                    }
                    if (QLog.isColorLevel()) {
                      QLog.e("PicMultiMsgProcessor", 2, "requestUploadPics isPicMsgModify");
                    }
                    this.jdField_a_of_type_Axpn.a.a().a().a(this.b, null);
                  }
                  if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isReMultiMsg) {
                    bdll.b(this.jdField_a_of_type_Axpn.a, "CliOper", "", "", "0X800662A", "0X800662A", 0, 1, 0, "", "", "", "");
                  }
                  return bool1;
                }
              }
  ...
  public void a(int paramInt, ArrayList<azql> paramArrayList)
  {
    if ((paramInt == 0) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      {
        localbdmc.a(null, "MultiMsgPicSendResult", bool1, 0L, paramArrayList.size(), localHashMap, null);
        bool1 = bool2;
        if (!bool1) {
          break label317;
        }
        this.jdField_a_of_type_Axow.a(1, 1, this.jdField_a_of_type_Axpl);
        return;
    ...
    label317:
    this.jdField_a_of_type_Axow.a(0, 1, this.jdField_a_of_type_Axpl);
  }
}
