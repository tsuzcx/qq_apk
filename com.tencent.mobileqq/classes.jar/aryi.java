...
{
  public aryi(MapWidget paramMapWidget, int paramInt, aryn paramaryn) {}
  ...
  public void onFailure(int paramInt, String paramString, Throwable paramThrowable)
  {
    ...
    if (MapWidget.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget) != null) {
      MapWidget.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget).a(false, this.jdField_a_of_type_Aryn);
    }
  }
    ...
    for (;;)
    {
      if (paramObject != null)
      {
        ...
        if (bfwa.a())
        {
          ...
          label124:
          this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsModelPolyline = this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsTencentMap.addPolyline(new PolylineOptions().addAll(paramObject).color(paramInt).width(bawz.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.getContext(), 5.0F)));
          if (this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsModelPolyline != null)
          {
      ...
      {
        ((arym)localObject1).a(bool, this.jdField_a_of_type_Aryn);
        return;
        ...
        this.jdField_a_of_type_Aryn.a = paramObject.duration;
        this.jdField_a_of_type_Aryn.b = paramObject.distance;
        ...
        this.jdField_a_of_type_Aryn.a = ((float)((TransitResultObject.Route)localObject1).duration);
        this.jdField_a_of_type_Aryn.b = ((TransitResultObject.Route)localObject1).distance;
