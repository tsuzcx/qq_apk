  ...
  implements LiteTransferListenerCallback, LiteTransferOperatorCallback
{
  ...
  private amwl jdField_a_of_type_Amwl = new amqi(this);
  public amxk a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver;
  private bkok jdField_a_of_type_Bkok;
  ...
  public amqd(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Amxk = new amxk(paramQQAppInterface);
    this.jdField_a_of_type_Dk = new dk(paramQQAppInterface);
    this.jdField_a_of_type_Dc = new dc(paramQQAppInterface);
    this.jdField_c_of_type_Int = BaseApplication.getContext().getResources().getDimensionPixelSize(2131296825);
    this.jdField_d_of_type_Int = BaseApplication.getContext().getResources().getDimensionPixelSize(2131296824);
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new amqe(this);
    this.jdField_b_of_type_AndroidContentBroadcastReceiver = new amqg(this, paramQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new amqh(this);
    ...
    this.jdField_a_of_type_Bkok = new bkok(paramQQAppInterface);
    f();
    g();
  ...
  private ToServiceMsg a(boolean paramBoolean, long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2, int paramInt4)
  {
    ...
    paramString = a(13, paramString, localbbln, l, bblk.b(paramLong1), paramLong2);
  ...
  private void a(int paramInt1, DataLineMsgRecord paramDataLineMsgRecord, int paramInt2)
  {
    ...
    if (paramDataLineMsgRecord.isSend()) {
      if (paramInt2 == 2)
      {
        ...
        bcef.b(this.app, "CliOper", "", "", "0X8006223", "0X8006223", 0, 0, "", "", "", "");
      }
    }
    for (;;)
    {
      ...
      if ((paramInt2 == 32) || (paramInt2 == 11) || (paramInt2 == 8))
      {
        ...
        bcef.b(this.app, "CliOper", "", "", "0X8006224", "0X8006224", 0, 0, "", "", "", "");
      }
      else
      {
        paramDataLineMsgRecord.fileMsgStatus = 0L;
        ...
        if (paramInt2 == 2)
        {
          ...
          String str = ataj.a(paramDataLineMsgRecord.path);
          if (str != null)
          {
          ...
          this.app.getMessageFacade().getDatalineMessageManager(paramInt1).a(paramDataLineMsgRecord.msgId);
          this.app.getMessageFacade().getDatalineMessageManager(paramInt1).c();
          bcef.b(this.app, "CliOper", "", "", "0X8006226", "0X8006226", 0, 0, "", "", "", "");
        }
        else if ((paramInt2 == 32) || (paramInt2 == 11) || (paramInt2 == 8))
        {
          ...
          this.app.getMessageFacade().getDatalineMessageManager(paramInt1).c(paramDataLineMsgRecord.msgId);
          this.app.getMessageFacade().getDatalineMessageManager(paramInt1).b(paramDataLineMsgRecord.msgId);
          bcef.b(this.app, "CliOper", "", "", "0X8006227", "0X8006227", 0, 0, "", "", "", "");
        }
        else
        {
  ...
  private void a(long paramLong, int paramInt)
  {
    ...
    do
    {
      ...
      {
        ((bcxe)this.app.getManager(305)).a(localDataLineMsgRecord, i);
        return;
      }
  ...
  private void a(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo, boolean paramBoolean)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      for (;;)
      {
        ...
        if ((paramBoolean) && (paramNFCInfo.nSessionState != 1) && ((!paramNFCInfo.isSend()) || (!aszt.b(paramNFCInfo.path)))) {
          a(paramNFCInfo.path);
        }
        if (!paramSession.bSend) {
          break label676;
  ...
  private void a(DataLineMsgRecord paramDataLineMsgRecord, WeiYunFileInfo paramWeiYunFileInfo)
  {
    ...
    this.app.getFileManagerEngine().a().a(paramWeiYunFileInfo, new amqf(this, l));
  }
  
  private void a(ToServiceMsg paramToServiceMsg)
  {
    NewIntent localNewIntent = new NewIntent(this.app.getApplication(), amql.class);
  ...
  private boolean a(bbjl parambbjl)
  {
    int j = 0;
    int i = 0;
    StringBuffer localStringBuffer = new StringBuffer();
    int m = parambbjl.a(localStringBuffer);
    if (m == -1) {
      return false;
    }
    int k;
    ...
    parambbjl.a(a(parambbjl.a().longValue(), 1001, parambbjl.a(), m, localStringBuffer.toString().getBytes()));
    return true;
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size()) {
      if (!((bbjl)this.jdField_a_of_type_JavaUtilArrayList.get(i)).a().equals(paramToServiceMsg)) {}
    }
    for (paramToServiceMsg = (bbjl)this.jdField_a_of_type_JavaUtilArrayList.get(i);; paramToServiceMsg = null)
    {
      if (paramToServiceMsg == null) {}
      do
      {
  ...
  public void GetThumbFilePath(int paramInt, Session paramSession)
  {
    ...
    Object localObject = (amzy)this.app.getBusinessHandler(10);
    if ((localObject != null) && (((amzy)localObject).a() == 0))
    {
  ...
  public void OnSessionNew(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo)
  {
    if (paramSession.bSend)
    {
      bcef.b(this.app, "CliOper", "", "", "0X8006222", "0X8006222", 0, 0, "", "", "", "");
      if ((paramSession.actionInfo != null) && (paramSession.actionInfo.strServiceName != null) && (paramSession.actionInfo.strServiceName.length() != 0)) {
        break label210;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      a(paramSession);
      return;
      bcef.b(this.app, "CliOper", "", "", "0X8006225", "0X8006225", 0, 0, "", "", "", "");
      break;
      label199:
  ...
  public bkok a()
  {
    return this.jdField_a_of_type_Bkok;
  }
  ...
  public Session a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      localSession.strFilePathSrc = ataj.c(localDataLineMsgRecord.path);
  ...
  public Long a(String paramString, int paramInt)
  {
    ...
    localDataLineMsgRecord.issuc = false;
    ((anaj)this.app.getBusinessHandler(13)).a(localDataLineMsgRecord);
    ...
    localDataLineMsgRecord.issuc = true;
    paramString = new bbjl(paramString, localLong, localDataLineMsgRecord);
    if (!a(paramString)) {
      return Long.valueOf(0L);
    }
  ...
  protected void a(long paramLong1, long paramLong2, SubMsgType0x7.MsgBody.GenericSubCmd paramGenericSubCmd, SubMsgType0x7.MsgBody.MsgHeader paramMsgHeader)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        case 1: 
          ...
          default: 
            ...
            {
              localbbjk = new bbjk(Long.valueOf(paramGenericSubCmd.uint32_size.get()), Long.valueOf(l));
              this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), localbbjk);
            ...
            {
              localbbjk = (bbjk)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(l));
              continue;
            }
            if (!paramGenericSubCmd.uint32_index.has()) {
              break label697;
            }
            localbbjk.a(paramGenericSubCmd.uint32_index.get(), paramMsgHeader);
            if (!localbbjk.a()) {
              break label697;
            }
            ...
            if (i == 1)
            {
              paramGenericSubCmd = localbbjk.a();
              i = 0;
              ...
              h();
              a(8, true, new Object[] { Integer.valueOf((int)paramLong1), localbbjk.a(), Long.valueOf(((DataLineMsgRecord)localObject1).sessionid) });
              return;
            }
            break;
          }
      ...
      ((DataLineMsgRecord)localObject1).msg = localbbjk.a();
      continue;
      avth.a().a(paramGenericSubCmd);
      return;
      label691:
      break label705;
      label694:
  ...
  public void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    {
      localDataLineMsgRecord.thumbPath = FileUtil.combinPath(FileUtil.getThumbnailPath(this.app.getApplication()), aszt.a(paramFileManagerEntity.strThumbPath));
    ...
    Object localObject = (amqd)this.app.getBusinessHandler(8);
    localDataLineMsgRecord.sessionid = ((amqd)localObject).a(0, 0).longValue();
    localDataLineMsgRecord.msg = "";
    localDataLineMsgRecord.issend = 1;
    localDataLineMsgRecord.isread = true;
    localDataLineMsgRecord.issuc = false;
    ...
    ((amqd)localObject).a(7, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf((byte)b(localDataLineMsgRecord.msgtype)), Boolean.valueOf(false), Boolean.valueOf(false), Long.valueOf(localDataLineMsgRecord.filesize) });
  ...
  public void a(WeiYunFileInfo paramWeiYunFileInfo)
  {
    ...
    this.app.getMessageFacade().getDatalineMessageManager(DataLineMsgRecord.getDevTypeBySeId(localDataLineMsgRecord.sessionid)).a(localDataLineMsgRecord, true);
    localamqd.a(7, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf((byte)b(localDataLineMsgRecord.msgtype)), Boolean.valueOf(false), Boolean.valueOf(false), Long.valueOf(localDataLineMsgRecord.filesize) });
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.getServiceCmd().equals("MessageSvc.PbSendMsg"))
    {
      ...
      avth.a().a(paramToServiceMsg, paramFromServiceMsg, paramObject);
    }
    label72:
  ...
  {
    this.jdField_a_of_type_Bkok.a(paramMsg);
  }
  
  public void a(msg_comm.Msg paramMsg, SubMsgType0x7.MsgBody paramMsgBody)
  {
    this.jdField_a_of_type_Bkok.a(paramMsg, paramMsgBody);
    DataLineMsgRecord localDataLineMsgRecord;
    try
    {
      localDataLineMsgRecord = new DataLineMsgRecord();
    ...
    localObject = (amzy)this.app.getBusinessHandler(10);
    if ((localObject != null) && (((amzy)localObject).d() != 1)) {
      ((amzy)localObject).e(1);
    }
  ...
  public void a(msg_comm.Msg paramMsg, C2CType0x211_SubC2CType0x9.MsgBody paramMsgBody)
  {
    ...
    this.jdField_a_of_type_Amxk.a(this, paramMsg, paramMsgBody);
  }
  ...
  public int b()
  {
    return ((anaj)this.app.getBusinessHandler(13)).b();
  }
  ...
  public void d()
  {
    ...
    if ((l != 0L) && (l != this.jdField_c_of_type_Long))
    {
      ...
      ((abwi)this.app.getMsgHandler().a("c2c_processor")).a(localArrayList);
  ...
  public void onDestroy()
  {
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        if ((this.app != null) && (this.app.getApp() != null) && (this.jdField_a_of_type_Amwl != null))
        {
        ...
        this.jdField_a_of_type_Bkok.a();
        this.jdField_a_of_type_Dg.a();
        this.jdField_a_of_type_Amxk.a();
  ...
  {
    this.jdField_a_of_type_Bkok.a(paramToServiceMsg, paramFromServiceMsg, (byte[])paramObject);
