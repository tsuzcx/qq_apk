...
class slq
{
  ...
  private final slo[] jdField_a_of_type_ArrayOfSlo;
  ...
  slq(slo[] paramArrayOfslo, sls paramsls)
  {
    this.jdField_a_of_type_ArrayOfSlo = paramArrayOfslo;
  ...
  private void a(int paramInt, boolean paramBoolean)
  {
    ...
    int i = 0;
    Object localObject;
    while (i < this.jdField_a_of_type_ArrayOfSlo.length)
    {
      localObject = this.jdField_a_of_type_ArrayOfSlo[i].a(this.jdField_a_of_type_Char, c1, this.jdField_a_of_type_Sls.a());
      if (localObject != null)
      {
        this.jdField_a_of_type_ArrayOfChar = this.jdField_a_of_type_ArrayOfSlo[i].a();
        this.jdField_a_of_type_Int = ((slp)localObject).jdField_a_of_type_Int;
        this.jdField_b_of_type_Int = ((slp)localObject).jdField_b_of_type_Int;
        str2 = this.jdField_a_of_type_ArrayOfSlo[i].a();
      }
      i += 1;
    }
    if ((this.jdField_a_of_type_ArrayOfChar != null) && (paramInt > 1) && (!TextUtils.isEmpty(str2)))
    {
      ...
      if (this.jdField_a_of_type_Sls.a() == 1)
      {
        paramInt = 0;
        for (;;)
        {
      ...
      localObject = str1;
      if (this.jdField_a_of_type_Sls.a() == 2)
      {
        paramInt = 0;
        for (;;)
        {
  ...
  private void b()
  {
    float f1 = this.jdField_a_of_type_Sls.a(this.jdField_b_of_type_Char);
  ...
  void a(float paramFloat, boolean paramBoolean)
  {
    ...
    float f1 = this.jdField_a_of_type_Sls.a();
  ...
  void a(int paramInt, char paramChar, boolean paramBoolean)
  {
    ...
    this.e = this.jdField_a_of_type_Sls.a(paramChar);
