...
public class ncc
{
  ...
  private void a(ArrayList<TroopAppInfo> paramArrayList)
  {
    if (this.jdField_a_of_type_Ncf != null) {
      this.jdField_a_of_type_Ncf.a(paramArrayList);
    }
  }
  ...
  private void a(List<Long> paramList)
  {
    ...
    localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), mxh.class);
    ((NewIntent)localObject).putExtra("cmd", "OidbSvc.0x8d3_1");
    ((NewIntent)localObject).putExtra("data", paramList.toByteArray());
    ((NewIntent)localObject).setObserver(new nce(this));
  ...
  {
    if (this.jdField_a_of_type_Ncf != null) {
      this.jdField_a_of_type_Ncf.a();
    }
  }
  
  public void a()
  {
    this.jdField_a_of_type_Ncf = null;
    this.jdField_a_of_type_Boolean = true;
  }
  
  public boolean a(String paramString, ncf paramncf)
  {
    return a(paramString, paramncf, false);
  }
  
  public boolean a(String paramString, ncf paramncf, boolean paramBoolean)
  {
    this.jdField_a_of_type_Ncf = paramncf;
    paramncf = new oidb_0x8cf.ReqBody();
    try
    {
      paramncf.opt_uint64_groupcode.set(Long.parseLong(paramString));
      paramncf.opt_uint32_need_mobile_sysapps.set(1);
      paramString = new oidb_sso.OIDBSSOPkg();
      paramString.uint32_command.set(2255);
      paramString.uint32_service_type.set(6);
      paramString.bytes_bodybuffer.set(ByteStringMicro.copyFrom(paramncf.toByteArray()));
      paramncf = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), mxh.class);
      paramncf.putExtra("cmd", "OidbSvc.0x8cf_6");
      paramncf.putExtra("data", paramString.toByteArray());
      paramncf.setObserver(new ncd(this, paramBoolean));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet(paramncf);
      return true;
    }
    catch (NumberFormatException paramncf)
    {
