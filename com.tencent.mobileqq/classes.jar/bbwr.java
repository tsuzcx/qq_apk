  ...
  implements aoog
{
  ...
  public bbwr(Context paramContext, QQAppInterface paramQQAppInterface, RecyclerView paramRecyclerView, int paramInt)
  {
  ...
  private void a(bbwu parambbwu, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    boolean bool = true;
    ...
    if (paramDrawable == null)
    {
      ...
      if (this.jdField_a_of_type_Alno != null) {
        paramDrawable = this.jdField_a_of_type_Alno.a(paramRecentBaseData);
      }
      ...
      int j = ((Integer)alno.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentBaseData.getRecentUserType(), paramRecentBaseData.getRecentUserUin()).first).intValue();
      int i = j;
      if (j == 103) {
        i = 1;
      }
      localRecentDynamicAvatarView = parambbwu.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView;
    ...
    for (;;)
    {
      parambbwu.jdField_a_of_type_AndroidWidgetTextView.setText(paramRecentBaseData.getTitleName());
      return;
      break;
      label176:
      bool = false;
      break label143;
      label182:
      parambbwu.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView.setImageDrawable(paramDrawable);
    }
  }
  
  private void b(bbwu parambbwu, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    if ((parambbwu == null) || (paramRecentBaseData == null)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      a(parambbwu, paramRecentBaseData, localDrawable);
      return;
    }
  }
  ...
  {
    if ((paramViewHolder instanceof bbwu))
    {
      RecentBaseData localRecentBaseData = a(paramInt);
      a((bbwu)paramViewHolder, localRecentBaseData, null);
    }
  ...
  {
    if ((paramInt == 0) && (this.jdField_a_of_type_Boolean)) {
      return new bbwt(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562852, paramViewGroup, false));
    }
    return new bbwu(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561518, paramViewGroup, false), this.jdField_a_of_type_Bbws);
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String arg3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        if (!(paramBitmap instanceof bbwu))
        {
          break label437;
          this.jdField_a_of_type_Long = l;
          break;
        }
        paramBitmap = (bbwu)paramBitmap;
        RecentBaseData localRecentBaseData = a(paramBitmap.getAdapterPosition());
        if (localRecentBaseData == null) {
          break label437;
        }
        int i = localRecentBaseData.getRecentUserType();
        i = ((Integer)alno.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, localRecentBaseData.getRecentUserUin()).first).intValue();
        if (i == -2147483648) {
          break label437;
        }
