...
public class agbc
  extends anrc
{
  public agbc(TroopChatPie paramTroopChatPie) {}
  
  protected void a(bgki parambgki)
  {
    if ((parambgki.jdField_a_of_type_Int == 2) && (parambgki.jdField_a_of_type_Bgkl != null))
    {
      if (QLog.isColorLevel()) {
        QLog.d("troop_gag", 2, "onTroopGagStatusChange:" + parambgki.jdField_a_of_type_JavaLangString);
      }
      if ((!TextUtils.isEmpty(this.a.sessionInfo.curFriendUin)) && (!TextUtils.isEmpty(parambgki.jdField_a_of_type_JavaLangString))) {
        break label76;
      }
    }
    label76:
    while (!this.a.sessionInfo.curFriendUin.equals(parambgki.jdField_a_of_type_JavaLangString)) {
      return;
    }
    this.a.a(parambgki.jdField_a_of_type_Bgkl, true);
  }
  ...
  protected void b(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      if (paramBoolean2) {}
      for (String str = this.a.mActivity.getString(2131695935);; str = this.a.mActivity.getString(2131695846))
      {
        QQToast.a(this.a.mActivity.getApplicationContext(), 2, str, 1).b(this.a.mActivity.getTitleBarHeight());
        return;
      }
    }
    QQToast.a(this.a.mActivity.getApplicationContext(), 1, 2131695934, 1).b(this.a.mActivity.getTitleBarHeight());
  }
}
