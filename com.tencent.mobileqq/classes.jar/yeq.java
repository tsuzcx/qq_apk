  ...
  extends ybw
{
  ...
  private ArrayList<ybx> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private ConcurrentHashMap<Long, yby> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(20);
  private ConcurrentHashMap<Long, Long> b = new ConcurrentHashMap(10);
  
  public yeq(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private long a(MessageForDeviceFile paramMessageForDeviceFile, View paramView, anix paramanix)
  {
    long l1;
    ...
    {
      ybx localybx = (ybx)localIterator.next();
      if (localybx.a() == paramView) {
        localybx.b = new WeakReference(paramanix);
      }
    }
    for (int i = 1;; i = 0)
    {
      if (i == 0) {
        this.jdField_a_of_type_JavaUtilArrayList.add(new ybx(this, paramView, paramanix));
      }
  ...
  private MessageRecord a(long paramLong1, long paramLong2, JSONObject paramJSONObject)
  {
    ...
    MessageForDevPtt localMessageForDevPtt = (MessageForDevPtt)axas.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, Long.toString(paramLong2), null, 9501);
    ...
    localMessageForDevPtt.time = awzy.a();
    localMessageForDevPtt.msg = (bbcz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForDevPtt.senderuin, true) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691298));
  ...
  private void a(long paramLong1, String paramString, int paramInt, long paramLong2)
  {
    ...
    {
      paramString = new yby(this, paramString, paramInt, paramLong2);
  ...
  private MessageRecord b(long paramLong1, long paramLong2, JSONObject paramJSONObject)
  {
    ...
    MessageForDeviceFile localMessageForDeviceFile = (MessageForDeviceFile)axas.a(-4500);
    localMessageForDeviceFile.strServiceName = yer.d;
    ...
    localMessageForDeviceFile.time = awzy.a();
    localMessageForDeviceFile.msg = (bbcz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForDeviceFile.senderuin, true) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691595));
  ...
  private void b(MessageRecord paramMessageRecord)
  {
    ...
    {
      Object localObject = (ybx)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((ybx)localObject).a();
      localObject = ((ybx)localObject).a();
      if ((localView != null) && (localObject != null))
      {
        j = i;
        if ((paramMessageRecord instanceof MessageForDeviceFile)) {
          ((anix)localObject).a(localView, (MessageForDeviceFile)paramMessageRecord);
        }
      }
      for (int j = i;; j = i - 1)
      {
  ...
  public long a(MessageRecord paramMessageRecord, View paramView, anix paramanix)
  {
    if ((paramMessageRecord instanceof MessageForDeviceFile)) {
      return a((MessageForDeviceFile)paramMessageRecord, paramView, paramanix);
    }
    return 0L;
  }
  ...
  {
    Object localObject1 = (yby)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong));
    ...
    do
    {
      ...
      localObject2 = ((QQAppInterface)localObject2).a().a(((yby)localObject1).jdField_a_of_type_JavaLangString, ((yby)localObject1).jdField_a_of_type_Int, ((yby)localObject1).jdField_a_of_type_Long);
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        this.b.put(Long.valueOf(localMessageRecord.uniseq), Long.valueOf(awzy.a()));
      }
    } while (!QLog.isColorLevel());
