  ...
  implements qtx
{
  ...
  public nii(int paramInt1, int paramInt2, Activity paramActivity, ojc paramojc)
  {
    super(paramActivity);
    this.jdField_c_of_type_Int = 1;
    this.jdField_a_of_type_Ohe = new nij(this);
    this.jdField_d_of_type_Int = paramInt2;
    this.jdField_b_of_type_Int = paramInt1;
    this.jdField_a_of_type_Ojt = ((ojt)paramojc);
    this.jdField_a_of_type_Obl = new obl();
    this.jdField_a_of_type_Obl.jdField_a_of_type_Long = bgmq.a(paramInt1, (QQAppInterface)obz.a());
  }
  ...
  private void a(List<BaseArticleInfo> paramList, int paramInt)
  {
    ...
    localArrayList.addAll(this.jdField_a_of_type_Ojt.a());
    paramList = onu.a().a(this.jdField_b_of_type_Int, paramList, localArrayList, paramInt);
    this.jdField_a_of_type_Ojt.a(paramList);
    this.jdField_a_of_type_Ojt.a();
  }
  ...
  private void a(boolean paramBoolean1, int paramInt1, boolean paramBoolean2, int paramInt2)
  {
    ...
    long l = a();
    ArticleInfo localArticleInfo = (ArticleInfo)this.jdField_a_of_type_Ojt.a(0);
    ...
    this.jdField_a_of_type_Ojt.a(paramBoolean1);
    localArrayList = new ArrayList();
    ogy.a().a(this.jdField_b_of_type_Int, (List)localObject, i, true, false, this.jdField_c_of_type_Int, null, -1L, null, a(), 0L, 0L, null, paramInt1, false, null, 0, localArrayList);
    this.jdField_c_of_type_Int += 1;
    if ((a() instanceof ReadInJoyNewFeedsActivity)) {
      a(-2);
    }
    rvf.a(paramInt1, this.jdField_b_of_type_Int, a(), paramBoolean2, paramInt2);
  }
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    boolean bool2 = this.jdField_a_of_type_Ojt.a();
    boolean bool3 = nia.a(this.jdField_b_of_type_Int);
    Object localObject = (KandianMergeManager)((BaseActivity)a()).app.getManager(162);
    boolean bool1;
    if (System.currentTimeMillis() - this.jdField_a_of_type_Obl.d > 300000L)
    {
      bool1 = true;
      boolean bool4 = c();
      ...
      bool1 = nia.c(this.jdField_b_of_type_Int);
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Int != 70)
      {
        ...
        if (this.jdField_b_of_type_Int != 56)
        {
          ...
          {
            bool1 = paramBoolean;
            if (!odm.c(this.jdField_b_of_type_Int)) {
              bool1 = true;
            }
          }
        }
    ...
    label377:
    localObject = this.jdField_a_of_type_Obl;
    if (this.jdField_a_of_type_Obl.jdField_a_of_type_Long == 0L) {}
    for (;;)
    {
      ((obl)localObject).jdField_a_of_type_Long = l;
      if (this.jdField_b_of_type_Int == 0) {}
      return false;
      l = this.jdField_a_of_type_Obl.jdField_a_of_type_Long;
    }
  }
  ...
  {
    this.jdField_a_of_type_Ojt.a();
    this.jdField_a_of_type_Ojt.a(paramBaseArticleInfo, paramInt);
    bbmy.a(this.jdField_a_of_type_AndroidAppActivity, -1, this.jdField_a_of_type_AndroidAppActivity.getString(2131633875), 0).b(((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).getTitleBarHeight());
    if (onu.a(paramBaseArticleInfo.mRecommendSeq)) {
      onu.a().a(this.jdField_b_of_type_Int, paramBaseArticleInfo.mRecommendSeq);
    }
    do
    {
      do
      {
        ...
        localDislikeInfo.a = ajjy.a(2131646927);
        localDislikeInfo.jdField_c_of_type_Int = 9;
        localDislikeInfo.b = "";
        ArrayList localArrayList = new ArrayList();
        localArrayList.add(localDislikeInfo);
        ogy.a().a(Long.valueOf(str).longValue(), ((ArticleInfo)paramBaseArticleInfo).makeDislikeParam(localArrayList));
        ogy.a().a(this.jdField_b_of_type_Int, paramBaseArticleInfo);
      } while (paramInt != 0);
      paramBaseArticleInfo = (KandianMergeManager)((QQAppInterface)obz.a()).getManager(162);
    } while (this.jdField_a_of_type_Ojt.a().size() > 0);
  ...
  public void a(ReadInjoyXRecyclerView paramReadInjoyXRecyclerView, int paramInt)
  {
    ...
    for (;;)
    {
      ogy.a().a(this.jdField_b_of_type_Int, a(), paramInt, 0, i);
  ...
  public void a(ReadInjoyXRecyclerView paramReadInjoyXRecyclerView, boolean paramBoolean)
  {
    ...
    if ((!obz.a()) || (d()) || (paramBoolean))
    {
      ...
      ohb.a().a(2, null);
      ReadinjoyTabFrame localReadinjoyTabFrame = obz.a(a());
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Ojt.c();
    } while (!paramBoolean);
    this.jdField_a_of_type_Ojt.b();
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Ojt != null) {
      this.jdField_a_of_type_Ojt.a(a(Integer.valueOf(this.jdField_b_of_type_Int)), b(Integer.valueOf(this.jdField_b_of_type_Int)));
    }
    this.jdField_a_of_type_Obl.b = System.currentTimeMillis();
  ...
  public void c()
  {
    ...
    do
    {
      ...
      super.c();
    } while (this.jdField_a_of_type_Ojt == null);
    this.jdField_a_of_type_Ojt.a(b(Integer.valueOf(this.jdField_b_of_type_Int)), a(Integer.valueOf(this.jdField_b_of_type_Int)));
  }
  ...
  public void i()
  {
    this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)ogy.a().a(this.jdField_b_of_type_Int));
    if ((this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_JavaUtilArrayList.size() == 0)) {
      ogy.a().c(this.jdField_b_of_type_Int);
    }
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
      this.jdField_a_of_type_Ojt.c(this.jdField_a_of_type_JavaUtilArrayList);
    }
    ogy.a().a(this.jdField_b_of_type_Int);
  }
  ...
  public void k()
  {
    if (this.jdField_a_of_type_Ojt != null)
    {
      ...
      Map localMap2 = rvf.a(this.jdField_b_of_type_Int);
      ThreadManager.executeOnSubThread(new ReadInJoyChannelWaterFallViewController.2(this, localMap1, a(Integer.valueOf(this.jdField_b_of_type_Int)), localMap2, obz.e(this.jdField_b_of_type_Int)));
