...
public class aues
{
  ...
  public static auet a(int paramInt1, int paramInt2, aueu paramaueu, boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (i > j)
      {
        i3 = i;
        n = j;
        switch (paramaueu.jdField_a_of_type_Int)
        {
        default: 
          paramaueu = new auet();
          paramaueu.jdField_a_of_type_Int = paramInt1;
          paramaueu.b = paramInt2;
          return paramaueu;
        }
      }
      break;
  ...
  public static auet a(int paramInt1, int paramInt2, String paramString)
  {
    int i = g;
    int j = h;
    auet localauet = new auet();
    float f1;
    if (FileUtils.fileExistsAndNotEmpty(paramString))
    {
      ...
      localauet.jdField_a_of_type_Int = localOptions.outWidth;
      localauet.b = localOptions.outHeight;
      paramString = localauet;
  ...
  public static auet a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    int i;
    if (paramInt1 > paramInt2) {
      i = paramInt2;
    ...
    {
      aueu localaueu = a(i, j);
      i = a(paramInt1, paramInt2, jdField_a_of_type_Int);
      return a(paramInt1 * i, i * paramInt2, localaueu, false);
      i = paramInt1;
    }
  }
  
  public static auet a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (FileUtils.fileExistsAndNotEmpty(paramFileManagerEntity.strMiddleThumPath))
    {
      ...
      localauet.jdField_a_of_type_Int = localOptions.outWidth;
      localauet.b = localOptions.outHeight;
      paramFileManagerEntity = localauet;
  ...
  private static aueu a(int paramInt1, int paramInt2)
  {
    int i = 0;
    int j = 1;
    ...
    for (;;)
    {
      ...
      localaueu.jdField_a_of_type_Int = paramInt2;
      localaueu.b = paramInt1;
      return localaueu;
      paramInt1 = 2;
      paramInt2 = 2;
      continue;
  ...
  public static String a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (!TextUtils.isEmpty(paramFileManagerEntity.strFileMd5)) {
      paramFileManagerEntity = bkwk.a(paramFileManagerEntity.strFileMd5);
    }
    for (;;)
    {
      ...
      {
        paramFileManagerEntity = bkwk.a(paramFileManagerEntity.Uuid);
      }
      else if (FileUtil.fileExistsAndNotEmpty(paramFileManagerEntity.getFilePath()))
      {
        localObject = auea.e(paramFileManagerEntity.getFilePath());
        if ((localObject != null) && (localObject.length > 0)) {
          paramFileManagerEntity = HexUtil.bytes2HexStr((byte[])localObject).toUpperCase();
        } else {
          paramFileManagerEntity = bkwk.a(paramFileManagerEntity.fileName);
        }
      }
      else
      {
  ...
  public static String a(String paramString)
  {
    ...
    {
      return null;
      String str1 = HexUtil.bytes2HexStr(auea.e(paramString));
      a();
      str1 = audf.a().d() + a(5, str1);
        ...
        for (;;)
        {
          ...
          try
          {
            if (!FileUtils.fileExistsAndNotEmpty(str2)) {
              azlo.a(paramString, str2, true, "", 1);
            }
  ...
  private static String a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        azlo.a(paramString1, str, true, "", paramInt);
  ...
  public static URL a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject1)) {
      localObject2 = HexUtil.bytes2HexStr(auea.e(paramFileManagerEntity.getFilePath())).toUpperCase();
    }
    localObject1 = audf.a().d() + a(5, bkwk.a((String)localObject2));
  ...
  private static void a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    paramString = a(paramString, audf.a().d() + a(5, str), 1);
    if (paramString == null) {
  ...
  {
    if ((paramFileManagerEntity.status == 16) && (!auea.e(paramFileManagerEntity))) {}
    while ((paramFileManagerEntity.cloudType == 1) && (auea.a(paramFileManagerEntity))) {
      return true;
    }
    return false;
  }
