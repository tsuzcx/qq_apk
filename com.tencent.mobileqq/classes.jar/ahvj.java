  ...
  implements aggp
{
  ...
  static
  {
    ...
    int i = localBaseApplication.getResources().getDimensionPixelSize(2131296335);
    c = (int)(localDisplayMetrics.widthPixels - bhmg.a(localBaseApplication, 40.0F) * 2.0F - BaseChatItemLayout.t - BaseChatItemLayout.u - i * 2 - bhmg.a(localBaseApplication, 10.0F));
    if (c > 640) {
      c = 640;
    }
    d = c * 9 / 16;
  ...
  {
    if (paramInt1 == 0) {
      return new ascx(BaseApplicationImpl.getApplication().getResources(), null, paramInt2, paramInt3, -921103);
    }
    Object localObject;
    if (paramInt1 == 1) {
      localObject = beyq.b();
    ...
    for (;;)
    {
      if ((localObject instanceof SkinnableBitmapDrawable))
      {
        ...
        return new ascx(BaseApplicationImpl.getApplication().getResources(), (Bitmap)localObject, paramInt2, paramInt3, -921103);
        if (paramInt1 == 2) {
          localObject = beyq.a();
        }
      }
  ...
  /* Error */
  public static Drawable a(Context paramContext, bftf parambftf, MessageForTroopFile paramMessageForTroopFile)
  {
    // Byte code:
    //   0: aload_1
    //   1: getfield 124	bftf:d	Ljava/lang/String;
    //   4: astore 8
    //   6: aload_1
    //   7: getfield 126	bftf:a	Ljava/lang/String;
    //   10: ifnull +80 -> 90
    //   13: aload_1
    //   14: getfield 126	bftf:a	Ljava/lang/String;
    //   17: astore_2
    //   18: aload_2
    //   19: invokestatic 131	auog:a	(Ljava/lang/String;)Ljava/lang/String;
    //   22: astore_2
    //   23: aload_0
    ...
    //   62: ifeq +730 -> 792
    //   65: getstatic 30	ahvj:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   68: aload 8
    ...
    //   93: goto -75 -> 18
    //   96: aload_1
    //   97: getfield 126	bftf:a	Ljava/lang/String;
    //   100: ifnull +692 -> 792
    //   103: new 160	java/io/File
    //   106: dup
    //   107: aload_1
    //   108: getfield 126	bftf:a	Ljava/lang/String;
    ...
    //   129: invokestatic 180	ahvj:a	(II)[I
    //   132: astore_2
    //   133: aload_0
    //   134: aload_2
    //   135: iconst_0
    ...
    //   192: astore_0
    //   193: getstatic 30	ahvj:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   196: aload 8
    //   198: aload_0
    ...
    //   222: astore_2
    //   223: getstatic 30	ahvj:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   226: aload 8
    ...
    //   267: aload_0
    //   268: invokestatic 222	bhmq:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   271: pop
    //   272: aload_0
    ...
    //   288: invokestatic 231	beyq:a	(Ljava/lang/String;)I
    //   291: istore 7
    //   293: iload 7
    //   295: bipush 90
    ...
    //   320: iload 5
    //   322: iload 4
    //   324: invokestatic 180	ahvj:a	(II)[I
    //   327: astore_0
    //   328: aload_0
    //   329: iconst_0
    //   330: iaload
    ...
    //   494: iload 4
    //   496: iload 5
    //   498: invokestatic 275	bhmq:b	(Landroid/graphics/Bitmap;FII)Landroid/graphics/Bitmap;
    ...
    //   512: aload_1
    //   513: astore_0
    //   514: getstatic 30	ahvj:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   517: aload 8
    //   519: aload 9
    ...
    //   576: invokestatic 295	ahvj:a	(III)Landroid/graphics/drawable/Drawable;
    //   579: astore_0
    //   580: aload_0
    //   581: areturn
    //   582: astore_0
    ...
    //   586: iload 4
    //   588: iload 5
    //   590: invokestatic 295	ahvj:a	(III)Landroid/graphics/drawable/Drawable;
    //   593: astore_2
    ...
    //   655: iload 4
    //   657: iload 5
    //   659: invokestatic 295	ahvj:a	(III)Landroid/graphics/drawable/Drawable;
    //   662: astore 8
    //   664: aload_1
    //   665: astore_0
  ...
  {
    return aunj.a(((MessageForTroopFile)paramChatMessage).fileName) == 0;
  }
  
  public static boolean c(ChatMessage paramChatMessage)
  {
    paramChatMessage = (MessageForTroopFile)paramChatMessage;
    return ((paramChatMessage.width == 0) || (paramChatMessage.height != 0)) || (aunj.a(paramChatMessage.fileName) == 2);
  }
  ...
  public View a(int paramInt1, int paramInt2, ChatMessage paramChatMessage, View paramView, ViewGroup paramViewGroup, agjk paramagjk)
  {
    ...
    this.jdField_a_of_type_Atoy.a(paramViewGroup, paramView, paramChatMessage);
    return paramView;
  }
  
  public View a(ViewGroup paramViewGroup, ChatMessage paramChatMessage)
  {
    ahvk localahvk = (ahvk)paramViewGroup.getTag();
    if (localahvk.jdField_c_of_type_AndroidViewView != null) {
      localahvk.jdField_c_of_type_AndroidViewView.setVisibility(0);
    }
    if (localahvk.jdField_d_of_type_AndroidViewView != null) {
      localahvk.jdField_d_of_type_AndroidViewView.setVisibility(8);
    }
    if (localahvk.jdField_a_of_type_AndroidViewView != null)
    {
      ViewGroup.LayoutParams localLayoutParams = localahvk.jdField_a_of_type_AndroidViewView.getLayoutParams();
      localLayoutParams.width = BaseChatItemLayout.z;
      localLayoutParams.height = -2;
      localahvk.jdField_a_of_type_AndroidViewView.setLayoutParams(localLayoutParams);
    }
    for (;;)
    {
      a(localahvk, paramViewGroup, paramChatMessage);
      if (jdField_e_of_type_Boolean) {}
      try
      {
        localahvk.jdField_b_of_type_JavaLangStringBuilder.append(localahvk.jdField_a_of_type_AndroidWidgetTextView.getText()).append(" ");
        localahvk.jdField_b_of_type_JavaLangStringBuilder.append(localahvk.jdField_b_of_type_AndroidWidgetTextView.getText());
        localahvk.jdField_b_of_type_JavaLangStringBuilder.append(localahvk.jdField_c_of_type_AndroidWidgetTextView.getText());
        localahvk.jdField_b_of_type_JavaLangStringBuilder.append("按钮");
        paramViewGroup.setContentDescription(localahvk.jdField_b_of_type_JavaLangStringBuilder.toString());
  ...
  {
    paramChatMessage = (ahvk)paramaggl;
  ...
  protected MessageForTroopFile a(View paramView)
  {
    ...
    if (paramView.a.isMultiMsg) {
      return (MessageForTroopFile)aunj.a(paramView.a);
    }
  ...
  public String a(ChatMessage paramChatMessage)
  {
    if (bhnt.a(paramChatMessage.issend)) {
      return anzj.a(2131714100);
    }
    return anzj.a(2131714104);
  }
  
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage) {}
  
  public void a(ahvk paramahvk, ViewGroup paramViewGroup, ChatMessage paramChatMessage)
  {
    if (paramahvk.jdField_d_of_type_AndroidWidgetTextView == null)
    {
      paramahvk.jdField_d_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
      paramahvk.jdField_d_of_type_AndroidWidgetTextView.setBackgroundResource(2130842581);
      paramahvk.jdField_d_of_type_AndroidWidgetTextView.setTextSize(1, 12.0F);
      paramahvk.jdField_d_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167302));
      paramahvk.jdField_d_of_type_AndroidWidgetTextView.setText(2131696541);
      paramahvk.jdField_d_of_type_AndroidWidgetTextView.setSingleLine();
      paramahvk.jdField_d_of_type_AndroidWidgetTextView.setGravity(16);
      paramahvk.jdField_d_of_type_AndroidWidgetTextView.setPadding(bhgr.a(this.jdField_a_of_type_AndroidContentContext, 5.0F), 0, bhgr.a(this.jdField_a_of_type_AndroidContentContext, 5.0F), 0);
      paramahvk.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams.addRule(3, 2131364423);
      this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131296335);
      bhgr.a(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      paramViewGroup.addView(paramahvk.jdField_d_of_type_AndroidWidgetTextView, localLayoutParams);
    }
    paramahvk.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
    if (paramChatMessage.isSend())
    {
      paramViewGroup = (RelativeLayout.LayoutParams)paramahvk.jdField_d_of_type_AndroidWidgetTextView.getLayoutParams();
      ...
      paramahvk.jdField_d_of_type_AndroidWidgetTextView.setLayoutParams(paramViewGroup);
      return;
    }
    paramViewGroup = (RelativeLayout.LayoutParams)paramahvk.jdField_d_of_type_AndroidWidgetTextView.getLayoutParams();
  ...
  void a(View paramView, boolean paramBoolean)
  {
    ...
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_files", "", "AIOchat", "Clk_filesbubble", 0, 0, paramView.frienduin + "", "", "", "");
    bftf localbftf = bgsk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForTroopFile);
    if (localbftf.b == 12) {
      bgri.a(localActivity, String.format(localActivity.getString(2131696649), new Object[] { bgsk.a(localbftf.g) }), 1);
    }
    do
    {
      return;
    ...
    auoo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramView, l, localbftf, localMessageForTroopFile.senderuin, localMessageForTroopFile.lastTime, 3, 3, null, false, false);
  }
  ...
  public void a(ChatMessage paramChatMessage, Context paramContext, BaseChatItemLayout paramBaseChatItemLayout, aggl paramaggl, int paramInt1, int paramInt2)
  {
    ...
    boolean bool1 = b(paramChatMessage);
    boolean bool2 = c(paramChatMessage);
    if ((!bool1) && (!bool2) && (paramaggl.jdField_a_of_type_AndroidViewView != null))
    {
      if (paramChatMessage.isSend()) {
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      else if (!ahvk.class.isInstance(localObject))
      {
        QLog.e("TroopFileItemBuilder", 1, "item click holder tag class[" + localObject.getClass().getName() + "] is not Holder");
      }
      else
      {
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A68A", "0X800A68A", 0, 0, "4", "", "", "");
        localObject = (ahvk)localObject;
        localObject = a(paramView);
        if ((!b((ChatMessage)localObject)) && (!c((ChatMessage)localObject)) && ((!((MessageForTroopFile)localObject).isMultiMsg) || (aunj.a((ChatMessage)localObject, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext))))
        {
          a(paramView, false);
          agej.n = true;
        }
