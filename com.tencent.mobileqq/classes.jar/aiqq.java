...
public class aiqq
  extends aiqm
{
  protected aiqq(QQAppInterface paramQQAppInterface, Context paramContext, auko paramauko)
  {
  ...
  public View a(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, View.OnClickListener paramOnClickListener)
  {
    ...
    if ((paramView == null) || (!(paramView.getTag() instanceof aiqr)))
    {
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558853, paramViewGroup, false);
      paramOnClickListener = new aiqr();
      paramOnClickListener.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131367679));
      paramOnClickListener.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)paramViewGroup.findViewById(2131377033));
      paramOnClickListener.c = ((SingleLineTextView)paramViewGroup.findViewById(2131378278));
      paramOnClickListener.b = ((ImageView)paramViewGroup.findViewById(2131368708));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton = ((Button)paramViewGroup.findViewById(2131375183));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131375193));
      paramViewGroup.setTag(paramOnClickListener);
      a(paramViewGroup.findViewById(2131367679));
      localPhoneContact = (PhoneContact)this.jdField_a_of_type_Auko;
      ...
      paramInt2 = bbcz.a(localPhoneContact.detalStatusFlag, localPhoneContact.iTermType);
    ...
    case 8: 
      for (;;)
      {
        if ((paramInt2 == 0) || (paramInt2 == 6))
        {
          ...
          paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131701219));
          paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(ajya.a(2131701222));
          label504:
          if (AppSetting.d)
          {
            ...
            paramOnClickListener.append(bbcz.b(paramInt1));
            paramViewGroup.setContentDescription(paramOnClickListener);
          }
          label533:
          return paramViewGroup;
          paramOnClickListener = (aiqr)paramView.getTag();
    ...
    for (;;)
    {
      ...
      paramOnClickListener.c.setVisibility(8);
      break label381;
      if (((ajxl)localObject).a(localPhoneContact.unifiedCode, true))
      {
        paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131701221));
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(ajya.a(2131701223));
        break label504;
      }
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setText(ajya.a(2131689628));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setTag(localPhoneContact);
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setContentDescription(ajya.a(2131689628));
