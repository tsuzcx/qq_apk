  ...
  extends aouj
{
  ...
  protected void a(boolean paramBoolean, long paramLong1, long paramLong2, String paramString, int paramInt)
  {
    ...
    FileManagerEntity localFileManagerEntity = aoxw.a(this.a).a().a(paramLong2, paramLong1, paramString, paramInt);
    if ((localObject != null) && (localFileManagerEntity != null))
    {
      localObject = ((apsi)localObject).a();
      if (localObject != null) {
        ((apsh)localObject).a(0, paramInt, paramString, (int)(localFileManagerEntity.fProgress * 100.0F), new Bundle());
      }
    }
  }
  ...
  protected void a(boolean paramBoolean, long paramLong1, long paramLong2, String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    FileManagerEntity localFileManagerEntity = aoxw.a(this.a).a().a(paramLong2, paramLong1, paramString1, paramInt1);
