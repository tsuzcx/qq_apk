  ...
  extends bcfs
{
  ...
  public bcep()
  {
    this.jdField_c_of_type_Int = 2131167071;
  ...
  public bcep(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong, List<String> paramList, int paramInt)
  {
    this.jdField_c_of_type_Int = 2131167071;
    this.jdField_g_of_type_Int = -1;
    this.jdField_h_of_type_Int = -1;
  ...
  public bcep(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong, List<String> paramList, int paramInt1, String paramString7, String paramString8, int paramInt2, String paramString9, String paramString10, String paramString11)
  {
    this.jdField_c_of_type_Int = 2131167071;
    this.jdField_g_of_type_Int = -1;
    this.jdField_h_of_type_Int = -1;
  ...
  private void a()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          bkgt.a((QQAppInterface)localObject3, this.jdField_l_of_type_Int, this.jdField_b_of_type_JavaLangString);
          bkgt.a((QQAppInterface)localObject3, this.jdField_b_of_type_JavaLangString, str1);
          if ((!bkgt.b(this.jdField_l_of_type_Int)) && (!bkgt.c(this.jdField_l_of_type_Int))) {
            break;
          }
      ...
      if (TextUtils.isEmpty((CharSequence)localObject2)) {
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131695490);
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = bcmw.a(Long.parseLong(((JSONObject)localObject3).optString("create_time")));
  ...
  public CharSequence a()
  {
    ...
    do
    {
      try
      {
        CharSequence localCharSequence = bcni.a(this.jdField_c_of_type_JavaLangString, a(), true);
      ...
      localObject = new bcmx(this.jdField_a_of_type_JavaUtilList, a());
      if (d() != 1002) {
        break;
      }
      this.jdField_c_of_type_JavaLangString = bcni.a(this.jdField_c_of_type_JavaLangString);
      localSpannableString = ((bcmx)localObject).a(this.jdField_c_of_type_JavaLangString, true);
      localObject = localSpannableString;
    } while (localSpannableString != null);
    return "";
    this.jdField_c_of_type_JavaLangString = bcni.a(this.jdField_c_of_type_JavaLangString);
    SpannableString localSpannableString = ((bcmx)localObject).a(this.jdField_c_of_type_JavaLangString, true);
    if (((bcmx)localObject).jdField_a_of_type_Int > 0) {}
    for (;;)
    {
  ...
  public Object a(String paramString)
  {
    ...
    {
      paramString = BaseApplicationImpl.getApplication().getResources().getString(2131698506);
      ...
      for (;;)
      {
        ...
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131698508);
        continue;
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131698506);
        bool = true;
        continue;
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131698507);
      }
    }
  ...
  public void a(View paramView)
  {
    ...
    default: 
      ...
      if ((localObject2 instanceof bbzq))
      {
        localObject3 = (bbzq)localObject2;
        if (((bbzq)localObject3).b()) {}
        localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        localObject1 = ((bbzq)localObject3).a();
        if (!(localObject1 instanceof bbzp)) {
          break label2613;
        }
      }
      break;
    ...
    label2565:
    label2613:
    for (Object localObject1 = (bbzp)localObject1;; localObject1 = null)
    {
      switch (((bbzq)localObject3).a())
      {
      default: 
        label204:
        if (d() == 268435456)
        {
          bcni.a("all_result", "clk_function", new String[] { "" + this.jdField_a_of_type_JavaLangString, "" + this.jdField_b_of_type_JavaLangString, "" + (this.jdField_j_of_type_Int + 1) });
          if ("63".equals(b()))
          {
            localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
            if (!ammh.a(paramView.getContext(), (QQAppInterface)localObject1)) {
              break;
            }
          }
        }
      ...
      do
      {
        ...
        {
          return;
          bcni.a(this.jdField_a_of_type_JavaLangString, 70, 0, this.jdField_j_of_type_Int, paramView);
          if (this.jdField_o_of_type_Int == 1)
          {
            bdll.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 0, 0, "", "", "", "");
            bdll.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 2, 0, "", "", "", "");
            break;
          }
          bdll.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 0, 0, "", "", "", "");
          bdll.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 1, 0, "", "", "", "");
          break;
          bcni.a(this.jdField_a_of_type_JavaLangString, 80, 0, this.jdField_j_of_type_Int, paramView);
          break;
          bcni.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_JavaLangString, this.jdField_s_of_type_JavaLangString, e(), e());
          bcni.a(this.jdField_a_of_type_JavaLangString, 120, 0, this.jdField_j_of_type_Int, paramView);
          if ((this.jdField_s_of_type_JavaLangString != null) && (!TextUtils.isEmpty(this.jdField_s_of_type_JavaLangString)))
          {
            bcjy.a(null, 0, this.jdField_a_of_type_Int, "0X8009D31", 4, 0, this.jdField_b_of_type_JavaLangString, null);
            break;
          }
          ...
          {
            bcjy.a(null, 0, this.jdField_a_of_type_Int, "0X8009D35", 0, 0, this.jdField_b_of_type_JavaLangString, null);
            break;
          }
          bcjy.a(null, 0, this.jdField_a_of_type_Int, "0X8009D49", 0, 0, this.jdField_b_of_type_JavaLangString, null);
          break;
          QQAppInterface localQQAppInterface;
          JSONObject localJSONObject;
          if ((bbzx.jdField_b_of_type_JavaUtilHashMap.containsKey(this)) && (d() != 268435456))
          {
            localObject4 = (bbzy)bbzx.jdField_b_of_type_JavaUtilHashMap.get(this);
          ...
          try
          {
            ...
            localJSONObject.put("obj_lct", ((bbzy)localObject4).jdField_a_of_type_Int);
            localJSONObject.put("get_src", "web");
            bcjy.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(this.jdField_a_of_type_Long + "").obj2(((bbzy)localObject4).jdField_b_of_type_JavaLangString).ver1(this.jdField_a_of_type_JavaLangString).ver2(bcjy.a(this.jdField_a_of_type_Int)).ver7(localJSONObject.toString()).session_id(localQQAppInterface.getCurrentAccountUin() + bbzx.jdField_a_of_type_Long));
            if (bcni.a(this.jdField_a_of_type_Long)) {
              if (bbzx.jdField_a_of_type_JavaUtilHashMap.containsKey(this))
              {
                localObject4 = (bbzy)bbzx.jdField_a_of_type_JavaUtilHashMap.get(this);
                if (((bbzy)localObject4).jdField_b_of_type_Boolean)
                {
                  i1 = 2;
                  bcni.a("all_result", "clk_object", i1, 0, new String[] { this.jdField_a_of_type_JavaLangString, "" + this.jdField_a_of_type_Long, ((bbzy)localObject4).jdField_b_of_type_JavaLangString + "", ((bbzy)localObject4).jdField_a_of_type_Int + "" });
                }
              }
              else
              {
                if ((localObject1 == null) || (!((bbzp)localObject1).b())) {
                  break label204;
                }
                ((bbzp)localObject1).a(true);
                bcni.a("all_result", "clk_first_result", new String[] { ((bbzq)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(3), bcni.a("dynamic_tab_search.1", ((bbzq)localObject3).a()) });
              }
            }
          }
          catch (JSONException localJSONException2)
          {
            ...
            if (bbzx.jdField_b_of_type_Boolean) {}
            for (i1 = 2;; i1 = 1)
            {
              bcni.a("all_result", "clk_content", i1, 0, new String[] { ((bbzq)localObject3).a(), "" + this.jdField_a_of_type_Long, "", bcni.a("dynamic_tab_search.1", ((bbzq)localObject3).a()) });
              if ((localObject1 == null) || (!((bbzp)localObject1).b())) {
                break;
              }
              ((bbzp)localObject1).a(true);
              bcni.a("all_result", "clk_first_result", new String[] { ((bbzq)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), bcni.a("dynamic_tab_search.1", ((bbzq)localObject3).a()) });
              break;
            }
          }
        }
        ...
        {
          ((bbzp)localObject1).a(true);
          bcni.a("all_result", "clk_tab_first_result", new String[] { ((bbzq)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), bcni.a("dynamic_tab_search.1", ((bbzq)localObject3).a()) });
        }
        bcni.a("all_result", "clk_tab_result", new String[] { ((bbzq)localObject3).a(), "" + this.jdField_a_of_type_Long, "", bcni.a("dynamic_tab_search.1", ((bbzq)localObject3).a()) });
        break label204;
        if ((localObject1 != null) && (((bbzp)localObject1).b()))
        {
          ((bbzp)localObject1).a(true);
          bcni.a("sub_result", "clk_sub_first_result", new String[] { ((bbzq)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), bcni.a("dynamic_tab_search.1", ((bbzq)localObject3).a()) });
        }
        bcni.a("sub_result", "clk_result", new String[] { ((bbzq)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), bcni.a("dynamic_tab_search.1", ((bbzq)localObject3).a()) });
        break label204;
        if (((paramView.getContext() instanceof UniteSearchActivity)) && (bbzx.jdField_b_of_type_JavaUtilHashMap.containsKey(this)))
        {
          localObject1 = (bbzy)bbzx.jdField_b_of_type_JavaUtilHashMap.get(this);
          localObject3 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
          localObject4 = new JSONObject();
        }
        try
        {
          ((JSONObject)localObject4).put("project", bcjy.a());
          ((JSONObject)localObject4).put("event_src", "client");
          ((JSONObject)localObject4).put("obj_lct", ((bbzy)localObject1).jdField_a_of_type_Int);
          ((JSONObject)localObject4).put("get_src", "native");
          bcjy.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(((bbzy)localObject1).jdField_a_of_type_Long + "").obj2(((bbzy)localObject1).jdField_b_of_type_JavaLangString).ver1(((bbzy)localObject1).jdField_a_of_type_JavaLangString).ver2(bcjy.a(UniteSearchActivity.jdField_d_of_type_Int)).ver7(((JSONObject)localObject4).toString()).session_id(((QQAppInterface)localObject3).getCurrentAccountUin() + bbzx.jdField_a_of_type_Long));
        ...
        catch (JSONException localJSONException1)
        {
          ...
          {
            paramView = bhni.a(((BaseActivity)paramView.getContext()).app, (Context)localObject2, this.jdField_e_of_type_JavaLangString);
            if (paramView != null)
            {
              paramView.a();
              return;
        ...
        {
          bcni.a(paramView.getContext(), Integer.valueOf(this.jdField_b_of_type_JavaLangString).intValue(), this.jdField_a_of_type_Int);
          return;
        }
        if (this.jdField_a_of_type_Long == 1001L)
        {
          ...
          if (bgpy.b((QQAppInterface)localObject1, this.jdField_b_of_type_JavaLangString))
          {
      ...
      for (;;)
      {
        ...
        bguq.a(paramView.getContext(), (Bundle)localObject1, 2);
        return;
        i1 = 104;
        break;
  ...
  {
    bcmx localbcmx = new bcmx(this.jdField_a_of_type_JavaUtilList, a());
    this.jdField_g_of_type_JavaLangString = bcni.a(this.jdField_g_of_type_JavaLangString);
    SpannableString localSpannableString = null;
    Object localObject = localSpannableString;
    if (this.jdField_f_of_type_Int == 1)
    {
      LhLogoResources localLhLogoResources = bhyu.a(this.jdField_g_of_type_Int);
      localObject = localSpannableString;
      if (localLhLogoResources != null) {
        localObject = localLhLogoResources.lightColor;
      }
    }
    localSpannableString = localbcmx.a(bhyu.a(this.jdField_f_of_type_Int, this.jdField_g_of_type_Int, false, this.jdField_g_of_type_JavaLangString), (String)localObject, false, false, true);
    localObject = localSpannableString;
    if (localSpannableString == null) {
      localObject = "";
    }
  ...
  public CharSequence c()
  {
    boolean bool = false;
    bcmx localbcmx = new bcmx(this.jdField_a_of_type_JavaUtilList, a());
    this.jdField_a_of_type_JavaLangCharSequence = bcni.a(this.jdField_a_of_type_JavaLangCharSequence);
    SpannableString localSpannableString = localbcmx.a(this.jdField_a_of_type_JavaLangCharSequence, false, false, false);
    if (localbcmx.jdField_a_of_type_Int > 0) {
      bool = true;
    }
  ...
  public CharSequence d()
  {
    ...
    {
      return localObject;
      localSpannableString = new bcmx(this.jdField_a_of_type_JavaUtilList, a()).a(this.jdField_b_of_type_JavaLangCharSequence, false, this.jdField_a_of_type_Boolean);
      localObject = localSpannableString;
    } while (localSpannableString != null);
    return "";
  }
