...
public class bgog
{
  ...
  public static void a(int paramInt)
  {
    if (!b)
    {
      ...
      bctj.a(BaseApplication.getContext()).a("", "actRPPttPlayerType", true, 0L, 0L, localHashMap, "");
      b = true;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (!TextUtils.equals(aher.jdField_a_of_type_JavaLangString, str1))
      {
        aher.jdField_a_of_type_JavaLangString = str1;
        aher.g = false;
    ...
    aqri localaqri = (aqri)aqlk.a().a(442);
    aqxd localaqxd = aqxe.c();
    ...
    if (localaqxd.a > 1)
    {
      bool1 = bool2;
      label159:
      QLog.e("vip_ptt.PttUtils", 1, "ignore initAutoToTextSwitch is svip=" + bool2 + " stage=" + localaqxd.a);
      if (((localaqri == null) || (localaqri.a())) && (!bool1)) {
        break label334;
      }
    ...
    for (;;)
    {
      aher.jdField_a_of_type_Long = localSharedPreferences.getLong(str2, 9223372036854775807L);
      aher.e = localSharedPreferences.getBoolean(str3, false);
      aher.g = true;
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.i("PttUtils", 2, "initAutoToTextSwitch switch:" + aher.d + ", time:" + aher.jdField_a_of_type_Long + ", hasAddTips:" + aher.e);
      return;
      bool1 = false;
      break label159;
      label334:
      aher.d = localSharedPreferences.getBoolean(str1, false);
      QLog.e("vip_ptt.PttUtils", 1, "initAutoToTextSwitch enable=" + aher.d);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    for (;;)
    {
      bcst.b(paramQQAppInterface, "CliOper", "", "", "0X8004603", "0X8004603", 0, 0, i + "", "", "", "");
      if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt1 == 0)
    {
      ...
      bcst.b(paramQQAppInterface, "CliOper", "", "", "0X8006189", "0X8006189", 0, 0, "", paramInt1 + "", paramInt3 + "", "");
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      if ((paramInt2 == 1) || (paramInt2 == 2))
      {
        ...
        for (int i = 1;; i = 2)
        {
          bcst.b(paramQQAppInterface, "CliOper", "", "", "0X8004600", "0X8004600", 0, 0, i + "", paramInt1 + "", paramInt3 + "", "");
          break;
        }
      }
      if (paramInt2 == 4) {
        bcst.b(paramQQAppInterface, "CliOper", "", "", "0X8005C1E", "0X8005C1E", 0, 0, "", paramInt1 + "", paramInt3 + "", "");
      } else {
        bcst.b(paramQQAppInterface, "CliOper", "", "", "0X8004601", "0X8004601", 0, 0, "", paramInt1 + "", paramInt3 + "", "");
      }
    }
  }
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("param_version", Build.VERSION.SDK_INT + "");
      localHashMap.put("param_deviceName", Build.MANUFACTURER + "_" + Build.MODEL);
      bctj.a(BaseApplication.getContext()).a("", "actRPSonicSoLoadStatus", true, 0L, 0L, localHashMap, "");
  ...
  public static final boolean a(String paramString, int[] paramArrayOfInt)
  {
    ...
    //   36: dup
    //   37: aload_0
    //   38: invokestatic 334	bgmg:a	(Ljava/io/File;)[B
    ...
    //   49: aload 4
    //   51: aload_1
    //   52: invokestatic 339	bgog:a	(Ljava/io/ByteArrayInputStream;[I)Z
    //   55: istore_2
    //   56: iload_2
    //   57: istore_3
    //   58: iload_3
