...
public class jnq
  implements Runnable
{
  public jnq(RedPacketGameView paramRedPacketGameView, AVRedPacketManager paramAVRedPacketManager) {}
  ...
  public void run()
  {
    ...
    if ((localObject != null) && (this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.a != null))
    {
      ...
      ThreadManager.postImmediately(new jnr(this, (VideoLayerUI)localObject, localBitmap), null, true);
    }
  }
}
