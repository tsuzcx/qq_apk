...
public class adxb
  extends Handler
{
  public adxb(ChatSettingForTroop paramChatSettingForTroop) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopColorNick))
      {
        ...
        localObject1 = new bdnf(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopColorNick, 16).a();
        paramMessage.setRightText((CharSequence)localObject1);
        bgwv.a(this.a.app, paramMessage.a(), (Spannable)localObject1);
        return;
      }
      paramMessage.setRightText(this.a.getString(2131696852));
      bgwv.a(this.a.app, paramMessage.a(), new SpannableString(""));
      return;
    ...
    if (this.a.jdField_c_of_type_AndroidWidgetTextView != null) {
      this.a.jdField_c_of_type_AndroidWidgetTextView.setText(anni.a(2131700559) + this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.wMemberNum + anni.a(2131700565));
    }
    this.a.b(true);
    this.a.e();
    this.a.a(this.a.e);
    ...
    for (;;)
    {
      ...
      if ((localObject2 != null) && (((List)localObject2).size() > 0))
      {
        ...
        for (;;)
        {
          if (((Iterator)localObject2).hasNext())
          {
            ...
            continue;
            if ((this.a.jdField_a_of_type_Bgao == null) || (TextUtils.isEmpty(this.a.jdField_a_of_type_Bgao.a))) {
              break label1404;
            }
            if (anni.a(2131700552).equals(this.a.jdField_a_of_type_Bgao.a))
            {
              i = 0;
              break;
            }
            paramMessage = this.a.jdField_a_of_type_Bgao.a;
            i = 1;
            break;
          }
        }
      ...
      {
        localObject2 = (FormSimpleItem)localView2.findViewById(2131368913);
        localSwitch = ((FormSwitchItem)localView1).a();
        localObject3 = (TextView)localView2.findViewById(2131368619);
        ((TextView)localObject3).setBackgroundResource(2130839434);
        localObject1 = "";
        paramMessage = "";
        Boolean localBoolean = (Boolean)this.a.jdField_a_of_type_Bgrs.c.get(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
        ...
        localView1.setBackgroundResource(2130839439);
      ...
      for (;;)
      {
        ((FormSimpleItem)localObject2).setRightText(new bdnt((CharSequence)localObject1, 3));
        ((TextView)localObject3).setText(paramMessage);
        ((TextView)localObject3).setTextColor(this.a.getResources().getColor(2131167060));
        awhv.a().c(this.a.app, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
        return;
        label1045:
        localView1.setBackgroundResource(2130839442);
        localView1.getBackground().setAlpha(255);
        if (!localSwitch.isChecked())
        {
          localSwitch.setTag(Boolean.TRUE);
        ...
        default: 
          ...
          break;
        case 2: 
          localObject1 = this.a.getString(2131696925);
          paramMessage = this.a.getString(2131696927);
          break;
        case 3: 
          localObject1 = this.a.getString(2131692805);
          paramMessage = this.a.getString(2131696923);
          break;
        case 4: 
          localObject1 = this.a.getString(2131696929);
          paramMessage = this.a.getString(2131696931);
          break;
          label1204:
          localView2.setVisibility(0);
          localView1.setBackgroundResource(2130839442);
      ...
      {
        localObject1 = (TextView)paramMessage.findViewById(2131378776);
        ...
        paramMessage = (ProgressBar)paramMessage.findViewById(2131372881);
        if (paramMessage != null) {
      ...
      if (i == 0) {}
      for (paramMessage = null;; paramMessage = this.a.getResources().getDrawable(2130850388))
      {
