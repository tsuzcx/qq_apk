...
public class atbd
{
  ...
  public static int a(Context paramContext, @Nonnull WatchTogetherFloatingData paramWatchTogetherFloatingData)
  {
    ...
    } while (atbj.a().a(paramContext, paramWatchTogetherFloatingData) == 0);
    return 2;
  }
  ...
  public static Dialog a(Context paramContext)
  {
    ...
    betk.b();
    paramContext = bdcd.a(paramContext, 230, null, "一起看将收起为小窗进行展示，请开启QQ悬浮窗权限以正常使用功能。", paramContext.getString(2131690648), paramContext.getString(2131694951), new atbe(paramContext), null);
  ...
  public static Dialog a(Context paramContext, Intent paramIntent)
  {
    ...
    paramContext.b(2131717650);
    paramContext.a(2131690890, 3);
    paramContext.c(2131690648);
    paramContext.a(new atbf(paramIntent, paramContext));
    return paramContext;
  }
  ...
  public static void a()
  {
    ...
    if (!BaseApplicationImpl.getApplication().getQQProcessName().endsWith(":tool"))
    {
      ...
      QIPCServerHelper.getInstance().callClient("com.tencent.mobileqq:tool", "WatchTogetherClientIPCModule", "ACTION_CLOSE_OR_QUIT_WATCH_FLOATING_WINDOWS", localBundle, new atbi());
      return;
    }
    atbj.a().b();
  }
  ...
  public static void a(Context paramContext, @Nonnull WatchTogetherFloatingData paramWatchTogetherFloatingData)
  {
    if (!BaseApplicationImpl.getApplication().getQQProcessName().endsWith(":tool"))
    {
      ...
      QIPCServerHelper.getInstance().callClient("com.tencent.mobileqq:tool", "WatchTogetherClientIPCModule", "ACTION_QUIT_WATCH_FLOATING_WINDOWS", paramContext, new atbh());
      return;
    }
  ...
  public static void a(boolean paramBoolean1, String paramString, int paramInt, boolean paramBoolean2)
  {
    ...
    for (a = "";; a = "2_" + paramString + "_" + paramInt)
    {
      if (7 == BaseApplicationImpl.sProcessId)
      {
        ...
        QIPCClientHelper.getInstance().callServer("TogetherBusinessIPCModule", "action_set_floating", localBundle, new atbg());
      }
      return;
    }
  }
