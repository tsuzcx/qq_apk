...
{
  public adnu(ChatHistory paramChatHistory) {}
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramInt1 < this.a.c)
        {
          ...
          this.a.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130849601);
          if (this.a.d > 1) {
            break label395;
          }
      ...
      catch (Exception localException2)
      {
        for (;;)
        {
          ...
          this.a.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839158);
        }
      }
      label421:
      paramInt2 = 0;
