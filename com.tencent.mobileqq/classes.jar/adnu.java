  ...
  implements avck, avfw, avga
{
  ...
  HashSet<adnv> jdField_a_of_type_JavaUtilHashSet = new HashSet();
  long b;
  long c;
  
  adnu(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo);
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState = null;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_Adnw.a = new WeakReference(this);
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState = null;
    ...
    if (this.jdField_a_of_type_Avev != null) {
      this.jdField_a_of_type_Avev.a(this.jdField_a_of_type_Adnw);
    }
  }
  ...
  private void b()
  {
    ...
    abju.a(this.jdField_a_of_type_AndroidContentContext, localIntent, PublicFragmentActivity.class, SignatureHistoryFragment.class);
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "signiture", "aio_clk_his", 0, 0, "", "", "", "");
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0x8009434", "0x8009434", 0, 0, "", "1", "", "");
  ...
  private void c()
  {
    if (System.currentTimeMillis() - this.b > 2000L)
    {
      ...
      awqx.b(null, "dc00898", "", "", "0X800A4EB", "0X800A4EB", 0, 0, "0", "0", "", "");
    }
  }
  
  protected acjc a()
  {
    adnv localadnv = new adnv();
    this.jdField_a_of_type_JavaUtilHashSet.add(localadnv);
    return localadnv;
  }
  ...
  protected View a(MessageRecord paramMessageRecord, acjc paramacjc, View paramView, LinearLayout paramLinearLayout, acmv paramacmv)
  {
    ...
    paramLinearLayout = (adnv)paramacjc;
    ...
    if (paramView == null)
    {
      ...
      paramacjc = new ViewGroup.MarginLayoutParams(-1, -2);
      int i = aciy.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      paramacjc.leftMargin = i;
      paramacjc.rightMargin = i;
      paramMessageRecord.setLayoutParams(paramacjc);
      paramLinearLayout.a = new avfq(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord, this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState.frienduin);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Ackc.a != null) {
      paramLinearLayout.a.jdField_a_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Ackc.a.getDefaultColor();
    }
    paramacjc = this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState.ver;
    if ((paramacjc != null) && (paramacjc.equals("1.0"))) {
    ...
    label576:
    label608:
    for (paramacjc = baiu.a(this.jdField_a_of_type_AndroidContentContext, 3, this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState.time * 1000L);; paramacjc = null)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d != null)
      {
        ...
        paramView = axng.a(20, paramView);
        paramacmv = paramView + ajjy.a(2131647657);
        paramLinearLayout.a.jdField_a_of_type_JavaLangString = paramacmv;
        if (e)
        {
          paramacmv = jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.getPlainText();
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForRichState.time > 0L) {
          paramLinearLayout.b.append("于").append(paramacjc);
        }
        paramLinearLayout.b.append("更新了签名，内容是：").append(paramacmv);
  ...
  public void a()
  {
    ...
    {
      adnv localadnv = (adnv)((Iterator)localObject).next();
      if (localadnv.a != null) {
        localadnv.a.k();
      }
    }
    if (this.jdField_a_of_type_Avev != null) {
      this.jdField_a_of_type_Avev.b(this.jdField_a_of_type_Adnw);
    }
    localObject = (VasQuickUpdateManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(184);
    this.jdField_a_of_type_Avev = null;
  ...
  public void a(View paramView, int paramInt, avfv paramavfv)
  {
    ...
    for (;;)
    {
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A98E", "0X800A98E", paramInt, 0, "0", "0", "", "");
      return;
      if (paramInt == 4)
      {
        a(paramavfv);
  ...
  public void a(avfv paramavfv)
  {
    ...
    if (!TextUtils.isEmpty(jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.feedsId))
    {
      ...
      bbmy.a(this.jdField_a_of_type_AndroidContentContext, localResources.getString(2131626719), 0).b(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).getTitleBarHeight());
    }
    label62:
    int i;
    int j;
    do
    {
      ...
      {
        bbmy.a(this.jdField_a_of_type_AndroidContentContext, localResources.getString(2131625268), 0).b(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).getTitleBarHeight());
        return;
      }
      this.c = l;
      try
      {
        paramavfv = (avfq)paramavfv;
        i = paramavfv.d;
        if (paramavfv.f != 0) {
          break;
        }
        paramavfv.f = 1;
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "signiture", "aio_act_on", 0, 0, "", "", "", "");
        i += 1;
        j = 1;
        paramavfv.d = i;
        paramavfv.j();
        ((SignatureHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(41)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramavfv.jdField_b_of_type_JavaLangString, 255, j);
        return;
      }
      catch (Exception paramavfv) {}
    } while (!QLog.isColorLevel());
    QLog.i("ChatItemBuilder", 2, paramavfv.getMessage(), paramavfv);
    return;
    paramavfv.f = 0;
    i -= 1;
    if (i > 0) {}
    for (;;)
    {
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "signiture", "aio_act_off", 0, 0, "", "", "", "");
      j = 0;
      break;
      i = 0;
    }
  ...
  {
    QLog.d("ChatItemBuilder", 1, new Object[] { "onClick topic=", paramavfz });
    paramavfz = paramavfz.a();
    if ((paramavfz instanceof Pair))
    {
      paramavfz = (Pair)paramavfz;
      if (QLog.isColorLevel()) {
        QLog.i("ChatItemBuilder", 2, String.format("aio onTopicClick [%d,%s]", new Object[] { paramavfz.first, paramavfz.second }));
      }
      avgf.a(this.jdField_a_of_type_AndroidContentContext, avgf.a(((Integer)paramavfz.first).intValue(), (String)paramavfz.second), -1);
    }
  }
