...
public class tlx
{
  ...
  private static volatile tlx jdField_a_of_type_Tlx;
  ...
  public tlx()
  {
    this.jdField_a_of_type_Tly = null;
  }
  
  public static tlx a()
  {
    if (jdField_a_of_type_Tlx == null) {}
    try
    {
      if (jdField_a_of_type_Tlx == null) {
        jdField_a_of_type_Tlx = new tlx();
      }
      return jdField_a_of_type_Tlx;
    }
    finally {}
  }
  ...
  {
    return jdField_a_of_type_Tlx != null;
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localJSONObject.put("articles_request_type", qep.a());
      if (!qep.a()) {
        break label339;
      }
      i = 1;
    ...
    if (this.jdField_b_of_type_Boolean) {
      olh.a(null, "", "0X8009296", "0X8009296", 0, 0, String.valueOf((NetConnInfoCenter.getServerTimeMillis() - this.jdField_b_of_type_Long) / 1000.0D), "", "", localJSONObject.toString(), false);
    }
    for (;;)
    {
      qep.a(false);
      ...
      str = "0";
      break;
      olh.a(null, "", "0X80089D1", "0X80089D1", 0, 0, String.valueOf((NetConnInfoCenter.getServerTimeMillis() - this.jdField_b_of_type_Long) / 1000.0D), "", "", localJSONObject.toString(), false);
    }
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Tly == null) {
      this.jdField_a_of_type_Tly = new tly(this, null);
    }
