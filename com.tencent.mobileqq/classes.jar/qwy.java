...
public class qwy
{
  ...
  public static qwy a(articlesummary.RecommendFollowInfos paramRecommendFollowInfos)
  {
    boolean bool = true;
    qwy localqwy = new qwy();
    ...
    for (;;)
    {
      localqwy.jdField_a_of_type_Boolean = bool;
      if (paramRecommendFollowInfos.bytes_account_next_cookie.has()) {
        localqwy.jdField_a_of_type_ArrayOfByte = paramRecommendFollowInfos.bytes_account_next_cookie.get().toByteArray();
      }
      localqwy.jdField_a_of_type_Int = paramRecommendFollowInfos.uint32_card_style.get();
      localqwy.jdField_a_of_type_JavaLangString = paramRecommendFollowInfos.bytes_card_title.get().toStringUtf8();
      localqwy.jdField_b_of_type_JavaLangString = paramRecommendFollowInfos.bytes_jump_url.get().toStringUtf8();
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        localqwy.jdField_a_of_type_JavaUtilList.add(localRecommendFollowInfo);
        if ((localqwy.jdField_a_of_type_Int == 2) && (!TextUtils.isEmpty(localRecommendFollowInfo.className)))
        {
    ...
    if (!((HashMap)localObject2).isEmpty())
    {
      ...
      while (paramRecommendFollowInfos.hasNext())
      {
        ...
        {
          localObject3 = new qwc();
          ((qwc)localObject3).jdField_a_of_type_JavaLangString = ((String)((Map.Entry)localObject1).getKey());
          ((qwc)localObject3).jdField_a_of_type_JavaUtilList = ((List)localObject2);
          localqwy.jdField_b_of_type_JavaUtilList.add(localObject3);
        }
      }
    }
    return localqwy;
  ...
  public static qwy a(oidb_0xc2f.GetFollowUserRecommendListRsp paramGetFollowUserRecommendListRsp)
  {
    qwy localqwy = new qwy();
    localqwy.jdField_b_of_type_JavaLangString = paramGetFollowUserRecommendListRsp.bytes_jump_url.get().toStringUtf8();
