...
public class asiu
{
      ...
      try
      {
        if ((paramUinPairMsg.service_type.has()) && (paramUinPairMsg.service_type.get() == 164))
        {
          if (paramUinPairMsg.uint64_to_tiny_id.has())
          {
            ...
            return Long.parseLong(paramQQAppInterface.a().a(String.valueOf(paramLong), paramUinPairMsg));
          }
          if (QLog.isColorLevel())
          {
  ...
  {
    ((asil)paramQQAppInterface.getManager(358)).a(paramString);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, C2CMsgReadedNotify paramC2CMsgReadedNotify)
  {
    try
    {
      ...
      paramString = paramQQAppInterface.a().a(paramString, String.valueOf(paramC2CMsgReadedNotify.uint64_to_tiny_id));
      paramQQAppInterface.a().a(paramString, 10007, paramC2CMsgReadedNotify.lLastReadTime);
      if (paramC2CMsgReadedNotify.lLastReadTime >= 0L) {
        paramQQAppInterface.a().a.a(paramString, 10007);
      }
      return;
    }
    catch (Exception paramQQAppInterface)
  ...
  public static void a(QQAppInterface paramQQAppInterface, msg_svc.PbC2CReadedReportReq paramPbC2CReadedReportReq, long paramLong, ConversationInfo paramConversationInfo)
  {
    ...
    do
    {
      ...
      {
        return;
        paramConversationInfo = paramQQAppInterface.a().a(paramConversationInfo.uin);
        try
        {
  ...
  public static void a(QQAppInterface paramQQAppInterface, msg_svc.PbMsgReadedReportReq paramPbMsgReadedReportReq, String paramString, long paramLong)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = paramQQAppInterface.a().a(paramString);
        try
        {
  ...
  private static void a(msg_comm.Msg paramMsg, QQAppInterface paramQQAppInterface, ayva paramayva, String paramString1, String paramString2)
  {
    if (paramMsg.msg_head.has())
    {
      paramMsg = (msg_comm.C2CTmpMsgHead)((msg_comm.MsgHead)paramMsg.msg_head.get()).c2c_tmp_msg_head.get();
      if ((!paramayva.d) && (paramMsg.sig.has()))
      {
        paramMsg = paramMsg.sig.get().toByteArray();
        paramQQAppInterface.a().d(paramString1, paramString2, paramMsg);
        if (QLog.isDevelopLevel()) {
          QLog.d("Q.tiny_msg.decoder.TinyMsgCodec", 4, "saveTokenSig tempHead.sig.get()----> sig:" + bdcv.a(paramMsg) + ",length:" + paramMsg.length);
        }
      }
    }
  }
  
  public static void a(msg_comm.Msg paramMsg, im_msg_body.Elem paramElem, List<MessageRecord> paramList, QQAppInterface paramQQAppInterface, ayva paramayva)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((hummer_commelem.MsgElemInfo_servtype34)localObject1).from_nickname.has())
        {
          ...
          a(paramQQAppInterface, (String)localObject1);
          ((MessageRecord)localObject2).saveExtInfoToExtStr("ext_key_game_msg_info", str5);
          if (paramayva.i) {
            continue;
          }
          ((MessageRecord)localObject2).frienduin = paramQQAppInterface.a().a(String.valueOf(l3), String.valueOf(l2));
          a(paramMsg, paramQQAppInterface, paramayva, ((MessageRecord)localObject2).frienduin, str4);
          paramayva.e = Long.parseLong(((MessageRecord)localObject2).frienduin);
          if (!QLog.isColorLevel()) {
            continue;
          }
          QLog.d("Q.tiny_msg.decoder.TinyMsgCodecdecodePBMsgGameInterCommElem", 2, "toTinyId = " + l3 + ", fromTinyId = " + l2 + ", ctx.senderUin = " + paramayva.b + ", ctx.friendUin = " + paramayva.e + ", mr = " + ((MessageRecord)localObject2).getBaseInfoString());
          continue;
        }
      }
