  ...
  extends anud
{
      ...
      try
      {
        ...
        if (n == 0)
        {
          ...
          if (localRspBody.uint32_result.has())
          {
            ...
            aqyt.a(this.app, str, aqyl.e, k, m, paramToServiceMsg);
            label169:
          ...
          while (QLog.isColorLevel())
          {
            ...
            break label141;
            label280:
            aqyt.a(this.app, str, k, m, paramToServiceMsg);
            break label169;
            label297:
  ...
  private void b(QQAppInterface paramQQAppInterface, aqyl paramaqyl)
  {
    long l1 = bcrg.a();
    ...
    aqyl.a(paramQQAppInterface, "redpoint_box_show", l1);
    aqyt.a(paramQQAppInterface, false, true);
    paramQQAppInterface.a().a().d(antf.aM, 1032);
    apaw localapaw = paramQQAppInterface.a().a();
    paramQQAppInterface = (RecentUser)localapaw.findRecentUser(antf.aM, 1032);
    int i;
    if (paramQQAppInterface == null)
    {
      paramQQAppInterface = new RecentUser(antf.aM, 1032);
    ...
    for (;;)
    {
      if (i != 0)
      {
        localapaw.saveRecentUser(paramQQAppInterface);
        paramQQAppInterface = this.mApp.getHandler(Conversation.class);
        if (paramQQAppInterface != null) {
          paramQQAppInterface.sendEmptyMessage(1009);
        }
      }
      notifyUI(4, true, paramaqyl);
      return;
  ...
  private void c(QQAppInterface paramQQAppInterface, aqyl paramaqyl)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ConfessHandler", 2, "onNeedShowLebaRedPoint");
    }
    aqyl.a(paramQQAppInterface, "redpoint_leba_show", bcrg.a());
  }
  ...
  public void a(aqzb paramaqzb)
  {
    ...
    if ((RecentUser)this.app.a().a().findRecentUser(antf.aM, 1032) != null)
    {
    ...
    notifyUI(2, true, paramaqzb);
  }
  
  public void a(QQAppInterface paramQQAppInterface, aqyl paramaqyl)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ConfessHandler", 2, String.format("onGetNewConfig boxEntry:%d contactEntry:%d", new Object[] { Integer.valueOf(paramaqyl.h), Integer.valueOf(paramaqyl.i) }));
    }
    if (paramaqyl.h == 2) {
      b(paramQQAppInterface, paramaqyl);
    }
    if (paramaqyl.i == 2) {
      c(paramQQAppInterface, paramaqyl);
    }
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo, int paramInt3)
  {
    ...
    if (paramInt3 == -1)
    {
      ...
      bdll.b(this.app, "dc00898", "", "", (String)localObject, (String)localObject, 0, 0, "", "", "", "");
  ...
  public void b(aqzb paramaqzb)
  {
    ...
    int i;
    if ((paramaqzb != null) && (paramaqzb.a()))
    {
      localapaw = this.app.a().a();
      localRecentUser = (RecentUser)localapaw.findRecentUser(antf.aM, 1032);
      if (localRecentUser != null) {
        break label124;
      }
      localRecentUser = new RecentUser();
      localRecentUser.uin = antf.aM;
      localRecentUser.setType(1032);
      localRecentUser.lastmsgtime = paramaqzb.a;
      paramaqzb = localRecentUser;
      i = 1;
    }
    for (;;)
    {
      if (i != 0)
      {
        localapaw.saveRecentUser(paramaqzb);
        paramaqzb = this.mApp.getHandler(Conversation.class);
        if (paramaqzb != null) {
          paramaqzb.sendEmptyMessage(1009);
        }
      }
      notifyUI(1, true, null);
      return;
      label124:
      if (localRecentUser.lastmsgtime < paramaqzb.a)
      {
        localRecentUser.lastmsgtime = paramaqzb.a;
        paramaqzb = localRecentUser;
        i = 1;
