...
{
  public uaq(TroopAssistantActivity paramTroopAssistantActivity) {}
  ...
  void a(String paramString)
  {
    ...
    this.a.runOnUiThread(new uar(this));
  }
  ...
  protected void onSetGenralSettingsTroopFilter(boolean paramBoolean, Map paramMap)
  {
    ...
    if (paramBoolean)
    {
      QQToast.a(this.a.app.getApp(), 2, this.a.getString(2131434529), 0).b(this.a.getTitleBarHeight());
      return;
    }
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    {
      ThreadManager.post(new uas(this, paramString), 8, null, true);
      return;
    }
    this.a.c();
  }
  ...
  {
    if (paramBoolean) {
      ThreadManager.post(new uat(this), 5, null, true);
    }
  }
