...
public class uaq
  extends Handler
{
  private uaq(ViolaVideoView paramViolaVideoView) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  ViolaVideoView.a(this.a).setBackgroundDrawable(ViolaVideoView.a(this.a, 2130843292));
                ...
                ViolaVideoView.a(this.a).clearAnimation();
                ViolaVideoView.a(this.a).setBackgroundDrawable(ViolaVideoView.a(this.a, 2130843294));
                ViolaVideoView.b(this.a).setVisibility(0);
                ViolaVideoView.b(this.a).setText("");
                return;
              } while (ViolaVideoView.a(this.a).a() == null);
          ...
          ViolaVideoView.a(this.a).clearAnimation();
          ViolaVideoView.a(this.a).setBackgroundDrawable(ViolaVideoView.a(this.a, 2130843293));
          ViolaVideoView.b(this.a).setText("");
          return;
        } while (ViolaVideoView.a(this.a).a() == null);
        ViolaVideoView.a(this.a).clearAnimation();
    ...
    ViolaVideoView.a(this.a).clearAnimation();
    ViolaVideoView.a(this.a).setBackgroundDrawable(ViolaVideoView.a(this.a, 2130848636));
    ViolaVideoView.b(this.a).setVisibility(0);
    ViolaVideoView.b(this.a).setVisibility(0);
