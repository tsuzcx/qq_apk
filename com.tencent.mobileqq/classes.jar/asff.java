  ...
  extends asfq
{
  ...
  asff(ases paramases, MessageRecord paramMessageRecord)
  {
    super(paramases);
  ...
  void a(String paramString, int paramInt, asfo paramasfo)
  {
    ...
    ases.a(this.jdField_a_of_type_Ases).getFileManagerEngine().a().a(paramString, paramInt, this.d, 106, this.b, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.c, new asfg(this, paramString, paramasfo));
  }
}
