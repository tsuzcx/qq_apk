...
{
  public ozj(AppActivity paramAppActivity, String paramString, QQAppInterface paramQQAppInterface, ScannerParams paramScannerParams, View paramView, QrHandleResultCallBack paramQrHandleResultCallBack) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if ((paramBoolean) && (paramBundle != null))
    {
      ...
      for (;;)
      {
        ...
        ((QQCustomDialog)localObject1).setTitle(2131430012);
        ((QQCustomDialog)localObject1).setMessage(paramBundle);
        localObject4 = new ozk(this);
        ((QQCustomDialog)localObject1).setPositiveButton(2131433030, new ozl(this, paramBundle));
        ((QQCustomDialog)localObject1).setNegativeButton(2131433029, (DialogInterface.OnClickListener)localObject4);
