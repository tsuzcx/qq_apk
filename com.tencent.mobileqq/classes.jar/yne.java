  ...
  implements ynl
{
  ...
  /* Error */
  public boolean a(ymw paramymw, java.lang.String paramString, java.lang.String... paramVarArgs)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnonnull +12 -> 13
    //   4: ldc 21
    //   6: ldc 23
    //   8: invokestatic 29	yny:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   11: iconst_1
    //   12: ireturn
    //   13: aload_1
    //   14: invokevirtual 34	ymw:a	()Landroid/app/Activity;
    //   17: astore 4
    //   19: aload 4
    //   21: ifnull -17 -> 4
    ...
    //   43: invokestatic 46	yny:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   46: aload 5
    //   48: ldc 48
    ...
    //   249: astore_2
    //   250: aload_2
    //   251: invokestatic 139	ypo:a	(Lcom/tencent/gdtad/aditem/GdtAd;)Lcom/tencent/gdtad/views/canvas/GdtCanvasData;
    //   254: astore_3
    //   255: aload_0
    //   256: aload_3
    //   257: aload 6
    //   259: aload 5
    //   261: invokevirtual 141	yne:a	(Lcom/tencent/gdtad/views/canvas/GdtCanvasData;Ltencent/gdt/qq_ad_get$QQAdGetRsp$AdInfo;Lorg/json/JSONObject;)V
    //   264: aload 4
    //   266: ldc 143
    //   268: aload_3
    ...
    //   273: ifnull +58 -> 331
    //   276: aload_1
    //   277: invokevirtual 149	ymw:a	()Ljava/lang/String;
    //   280: astore_1
    //   281: aload 4
    //   283: iconst_0
    //   284: ldc 151
    ...
    //   296: ldc 23
    //   298: aload_1
    //   299: invokestatic 160	yny:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   302: goto -298 -> 4
    //   305: astore_2
    //   306: ldc 21
    //   308: ldc 23
    //   310: aload_2
    //   311: invokestatic 160	yny:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   314: aconst_null
    //   315: astore_2
    //   316: goto -226 -> 90
    //   319: astore_1
    ...
    //   322: ldc 23
    //   324: aload_1
    //   325: invokestatic 160	yny:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   328: goto -324 -> 4
    //   331: aconst_null
    //   332: astore_1
    //   333: goto -52 -> 281
