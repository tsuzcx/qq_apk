  ...
  implements AppConstants
{
  public static Intent a(Context paramContext, int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, String paramString12, String paramString13, String paramString14, String paramString15, String paramString16, String paramString17, String paramString18, Intent paramIntent, int paramInt3, String paramString19, long paramLong)
  {
    ...
    if ((paramContext instanceof bguf))
    {
      paramString2 = ((bguf)paramContext).a();
    ...
    paramString1 = bchh.a(localIntent.getExtras());
    if (paramString1 != null)
    {
      ...
      do
      {
        do
        {
          ...
          {
            return localIntent;
          } while (((1001 != paramInt1) && (38 != paramInt1)) || (!(paramContext instanceof bguf)));
          paramContext = ((bguf)paramContext).a();
  ...
  public static MessageRecord a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        int i = bbjb.a;
        bbjb.a = i + 1;
        paramString = bbli.a(paramQQAppInterface, str, paramString, str, paramInt, i, paramAbsStructMsg);
        afoa.a().a(paramString.uniseq, 0L, paramAbsStructMsg.forwardID);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, AbsStructMsg paramAbsStructMsg, BusinessObserver paramBusinessObserver, String paramString2, String paramString3)
  {
    ...
    {
      paramAbsStructMsg = bbli.a(paramQQAppInterface, str, paramString1, paramBusinessObserver, paramInt, l, paramAbsStructMsg);
      QLog.i(bctz.i, 1, "sendDocsStructingMsg. disUin = " + paramString1 + ", disUinType = " + paramInt + ", seq = " + l + ", shmsgseq = " + paramAbsStructMsg.shmsgseq + ", time = " + paramAbsStructMsg.time);
      paramQQAppInterface.getMessageFacade().addAndSendMessage(paramAbsStructMsg, null);
      if ((paramInt != 0) && (paramInt != 1)) {
        break;
      }
      bcvs.a(paramQQAppInterface, paramString1, paramInt, paramAbsStructMsg.shmsgseq, paramAbsStructMsg.time + 1L, paramString2, paramString3);
      return;
    }
  }
    ...
    do
    {
      do
      {
        ...
        if (paramAbsStructMsg.mMsgServiceID == 80)
        {
          ...
          for (;;)
          {
            paramString2 = bbli.a(paramQQAppInterface, paramBusinessObserver, paramString1, paramString2, paramInt, l, paramAbsStructMsg);
            if (paramAbsStructMsg.mMsgServiceID != 41) {
              break;
            }
            afoa.a().a(paramString2.uniseq, paramAbsStructMsg.parentUniseq, i);
        ...
        if (paramAbsStructMsg.mMsgServiceID == 100)
        {
          ...
          paramString1 = bbli.a(paramQQAppInterface, paramBusinessObserver, paramString1, paramBusinessObserver, paramInt, l, paramAbsStructMsg);
          afoa.a().a(paramString1.uniseq, paramAbsStructMsg.parentUniseq, i);
          paramQQAppInterface.getMessageFacade().addAndSendMessage(paramString1, new bfyw());
          return;
        }
        afoa.a().a(paramString2.uniseq, paramAbsStructMsg.parentUniseq, i);
      ...
      if (paramAbsStructMsg.mMsgServiceID == 1)
      {
        ...
        i = bbjb.a;
        bbjb.a = i + 1;
        paramString1 = bbli.a(paramQQAppInterface, paramString2, paramString1, paramString2, paramInt, i, paramAbsStructMsg);
