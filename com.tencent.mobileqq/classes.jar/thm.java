...
{
  public thm(PublicAccountListActivity paramPublicAccountListActivity) {}
  
  public void a(AdapterView paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    paramAdapterView = null;
    paramView = paramView.getTag();
    if ((paramView instanceof thy)) {}
    String str;
    do
    {
      paramAdapterView = ((thy)paramView).a;
      while (paramAdapterView == null)
      {
        ...
        return;
        if ((paramView instanceof thz)) {
          paramAdapterView = ((thz)paramView).a;
        }
      }
    ...
    paramView.putExtra("selfSet_leftViewText", this.a.getString(2131437771));
