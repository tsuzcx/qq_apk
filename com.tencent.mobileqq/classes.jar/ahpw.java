...
class ahpw
  implements Runnable
{
  ahpw(ahpv paramahpv, boolean paramBoolean, Bundle paramBundle) {}
  
  public void run()
  {
    Object localObject3 = (FriendsManager)StatusManager.a(this.jdField_a_of_type_Ahpv.a).getManager(50);
    Object localObject2;
    int i;
    Object localObject4;
    if (localObject3 != null)
    {
      localObject2 = ((FriendsManager)localObject3).a(StatusManager.a(this.jdField_a_of_type_Ahpv.a).getAccount());
      localObject1 = localObject2;
      if (localObject2 == null)
      {
        localObject1 = new ExtensionInfo();
        ((ExtensionInfo)localObject1).uin = StatusManager.a(this.jdField_a_of_type_Ahpv.a).getAccount();
      }
    ...
    for (Object localObject1 = localObject2;; localObject1 = null)
    {
      ...
      for (;;)
      {
        StatusManager.a(this.jdField_a_of_type_Ahpv.a, null);
        ThreadManager.getUIHandler().post(new ahpx(this, j, (RichStatus)localObject1, (TipsInfo)localObject2));
        return;
        label507:
        localObject1 = "0";
        break;
