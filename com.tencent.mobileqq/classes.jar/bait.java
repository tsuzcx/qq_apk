...
public class bait
{
  private static volatile bait jdField_a_of_type_Bait;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  
  public static bait a()
  {
    if (jdField_a_of_type_Bait == null) {}
    try
    {
      if (jdField_a_of_type_Bait == null) {
        jdField_a_of_type_Bait = new bait();
      }
      return jdField_a_of_type_Bait;
    }
    finally {}
  }
  
  public void a(EntityManager paramEntityManager, long paramLong, baiu parambaiu)
  {
    long l = System.currentTimeMillis() - 86400000L;
    ThreadManager.post(new PushDialogDbUtil.1(this, paramEntityManager, new String[] { String.valueOf(paramLong), String.valueOf(l) }, paramLong, l, parambaiu), 8, null, false);
  }
