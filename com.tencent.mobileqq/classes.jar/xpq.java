...
public class xpq
{
  public static MessageRecord a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    {
      xpo localxpo = (xpo)paramQQAppInterface.getManager(208);
      String str = a(paramString);
      paramString = localxpo.a(paramString);
      if (paramString != null) {
  ...
  {
    return ("gs_" + paramMessageForShortVideo.frienduin + '_' + paramMessageForShortVideo.getMd5() + '_' + bflr.d(paramMessageForShortVideo.uuid) + "-700").toLowerCase();
  }
  ...
  {
    return (ulu.i()) && (paramInt == 1) && ((paramMessageRecord instanceof MessageForShortVideo)) && (((MessageForShortVideo)paramMessageRecord).busiType == 1);
  }
