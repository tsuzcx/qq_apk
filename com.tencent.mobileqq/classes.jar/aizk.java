...
{
  private static SparseArray<aizs> b;
  private aizn jdField_a_of_type_Aizn;
  private aizo jdField_a_of_type_Aizo;
  ...
  private CopyOnWriteArrayList<aizm> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  public static aizs a(int paramInt)
  {
    return (aizs)jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
  }
      ...
      if (paramBoolean)
      {
        ...
        try
        {
          ...
          if ("apollo_router_game.apl_audio_linkcmd_save_audio_data".equals(localObject1))
          {
            ...
            paramBundle = (aizm)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(paramInt);
            if (paramBundle == null) {
              break label2956;
            }
          ...
          if ("apollo_router_game.apl_audio_linkcmd_query_status".equals(localObject1))
          {
            if (l1 == 0L)
            {
              ...
              localObject1 = (aizm)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(paramInt);
              ...
              paramBoolean = false;
              ((aizm)localObject1).a(str, paramBoolean);
              break label2963;
            }
            i = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
            paramInt = 0;
        ...
        if ("ltgame_gamepanel.query_top_gamelist".equals(localObject1))
        {
          ...
          this.jdField_a_of_type_Aizo = new aizo(this);
          this.jdField_a_of_type_Aizo.jdField_a_of_type_JavaLangString = str;
          ...
          this.jdField_a_of_type_Aizo.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("description", ajyc.a(2131702111));
          if ((localJSONArray != null) && (localJSONArray.length() > 0))
          {
            ...
            if (paramInt < j)
            {
              ...
              this.jdField_a_of_type_Aizo.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(k));
              this.jdField_a_of_type_Aizo.c.add(localObject1);
              if (localJSONObject.optInt("isGameApp") != 1) {
                break label3024;
              }
              i = 1;
              label1082:
              localObject2 = localajmw.a(k);
              ...
              if (localObject1 != null)
              {
                this.jdField_a_of_type_Aizo.jdField_b_of_type_JavaUtilList.add(localObject1);
                break label3017;
              }
            ...
            if (((List)localObject3).size() > 0) {
              ((ajmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).e((List)localObject3);
            }
            if (localArrayList.size() > 0)
            {
              localObject1 = (bbqp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71);
              localObject2 = new Bundle();
              ((Bundle)localObject2).putInt("key_get_game_detail_from", 1);
              ((Bundle)localObject2).putString("key_get_game_detail_friuin", str);
              ((bbqp)localObject1).a(localArrayList, paramBundle);
              return;
            }
            i = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
            paramInt = 0;
            ...
            paramBundle.a(str, this.jdField_a_of_type_Aizo);
            break label3030;
          }
        ...
        if ("ltgame_gamepanel.query_self_gamelist".equals(localObject1))
        {
          ...
          if ((localJSONArray != null) && (localJSONArray.length() > 0))
          {
            ...
            if (localArrayList.size() > 0) {
              ((ajmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).e(localArrayList);
            }
            if (((ArrayList)localObject3).size() > 0)
            {
              paramBundle = (bbqp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71);
            ...
            Collections.sort((List)localObject2, this.jdField_a_of_type_Aizn);
            i = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
            paramInt = 0;
            if (paramInt >= i) {
              break label3055;
        ...
        if ("ltgame_playmate.get_playmate_info".equals(localObject1))
        {
          ...
          if (!TextUtils.isEmpty(paramBundle))
          {
            ...
            ((aizm)localObject1).a(str, paramBundle);
            break label3057;
          }
        ...
        if ("ltgame_msg_auth.get_sign".equals(localObject1))
        {
          ...
          if (l1 == -10002L)
          {
            ...
            ApolloItemBuilder.a(ajyc.a(2131702110), 1, BaseApplicationImpl.getContext());
            return;
          }
          if (l1 == -10000L)
          {
          ...
          if (l1 == -10001L)
          {
            ...
            ApolloItemBuilder.a(ajyc.a(2131702116), 1, BaseApplicationImpl.getContext());
            return;
          }
          if (!QLog.isColorLevel()) {
            continue;
          }
          ApolloItemBuilder.a(ajyc.a(2131702112) + l1, 1, BaseApplicationImpl.getContext());
          return;
        }
        long l2;
  ...
  private void a(long paramLong)
  {
    ...
    while (i < j)
    {
      aizm localaizm = (aizm)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
      if (localaizm != null) {
        localaizm.d(String.valueOf(paramLong));
      }
      i += 1;
    }
  }
  ...
  private void a(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    {
      return;
      List localList = aizg.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramInt2, paramInt1, paramLong);
      ...
      while (paramInt1 < i)
      {
        aizm localaizm = (aizm)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(paramInt1);
        if (localaizm != null) {
          localaizm.a(paramString, paramInt2, localList);
        }
        paramInt1 += 1;
      }
    }
  ...
  private void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3)
  {
    ...
    localIntent.putExtra("leftViewText", ajyc.a(2131702113));
  ...
  public static void a(JSONArray paramJSONArray)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        i = actn.a(7.0F, BaseApplicationImpl.getContext().getResources());
        if (bbct.a() > 2.0F) {
          break label201;
        }
        i = actn.a(9.0F, BaseApplicationImpl.getContext().getResources());
      }
      ...
      if (j < k)
      {
        ...
        {
          localaizs = new aizs();
          localaizs.jdField_a_of_type_JavaLangCharSequence = localJSONObject.optString("tips");
          localaizs.jdField_a_of_type_Int = localJSONObject.optInt("id");
          localaizs.jdField_b_of_type_Int = localJSONObject.optInt("tipsType");
          if (!TextUtils.isEmpty(localaizs.jdField_a_of_type_JavaLangCharSequence))
          {
            if (localaizs.jdField_b_of_type_Int == 1) {
              localaizs.jdField_a_of_type_JavaLangCharSequence = new ayki(ayla.c(localJSONObject.optInt("tips")), 3, i);
            }
            jdField_b_of_type_AndroidUtilSparseArray.put(localaizs.jdField_a_of_type_Int, localaizs);
          }
        }
        j += 1;
      }
  ...
  private void b(long paramLong)
  {
    ...
    while (i < j)
    {
      aizm localaizm = (aizm)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
      if (localaizm != null) {
        localaizm.e(String.valueOf(paramLong));
      }
      i += 1;
    }
  }
  ...
  private void b(boolean paramBoolean, String paramString, int paramInt, long paramLong)
  {
    ...
    while (i < j)
    {
      aizm localaizm = (aizm)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
      if (localaizm != null) {
        localaizm.b(paramBoolean, paramString, paramInt, paramLong);
      }
      i += 1;
    }
  }
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_Aizn = new aizn(this.jdField_a_of_type_AndroidUtilSparseArray);
  }
  ...
  private void c(String paramString, int paramInt, long paramLong)
  {
    ...
    while (i < j)
    {
      aizm localaizm = (aizm)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
      if (localaizm != null) {
        localaizm.a(paramString, paramInt, paramLong);
      }
      i += 1;
    }
  }
  ...
  private void c(String paramString1, String paramString2)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramString1 = aizg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, 1036);
          if ((paramString1 == null) || (paramString1.isEmpty()))
          {
            QLog.e("CmGameTemp_CmGameTempSessionHandler", 2, "onQueryTempGameStatusRsp msgList == null || msgList.isEmpty()");
            return;
          }
          airt localairt = ((airv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).a();
          int i = 0;
          if (i < paramString2.length())
          {
            ...
            if (localObject2 != null)
            {
              ...
              if ((k >= 4) && (l > 0L) && (j > 0))
              {
                MessageForApollo localMessageForApollo = aizg.a(paramString1, j, l);
                if (localMessageForApollo != null)
                {
                  ...
                  localairt.a(localMessageForApollo);
                }
              }
            }
            i += 1;
  ...
  private void i(String paramString)
  {
    ...
    try
    {
      ...
      localObject2 = aizg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, 1036);
    ...
    if ((j >= 4) && (l > 0L) && (i > 0))
    {
      localObject2 = aizg.a((List)localObject2, i, l);
      if (localObject2 != null)
      {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        do
        {
          ...
          ((airv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).a().a((MessageForApollo)localObject2);
          return;
  ...
  public void a()
  {
    this.jdField_a_of_type_Bfnk.removeMessages(255);
  ...
  public void a(int paramInt)
  {
    ...
    if ((BaseActivity.sTopActivity instanceof FragmentActivity))
    {
      ...
      if (localObject1 != null)
      {
        ...
        if (!(localObject1 instanceof aena)) {}
      }
    }
    for (localObject1 = (aena)localObject1;; localObject1 = null)
    {
      if (localObject1 != null)
      {
        localObject2 = ((aena)localObject1).b();
        if (localObject2 != null) {
          break label285;
        }
      }
      ...
      do
      {
        return;
        Collections.sort((List)localObject2, this.jdField_a_of_type_Aizn);
        ((aena)localObject1).b((List)localObject2);
      } while (((aena)localObject1).a == null);
      ((aena)localObject1).a.m();
      return;
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    try
    {
      ...
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aiwi.class);
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, String paramString2, int paramInt3)
  {
    ...
    try
    {
      ...
      localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
      paramString1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aiwi.class);
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(paramaizm);
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramaizm);
    QLog.i("CmGameTemp_CmGameTempSessionHandler", 1, "addMsgUIHandler size:" + this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() + " cmGameMsgUIHandler:" + paramaizm);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ("close_aio".equals(str))
        {
          ...
          paramTunnelMsgStream = (aizm)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
          if (paramTunnelMsgStream == null) {
            break label741;
          }
        ...
        if ("mphone_status".equals(str))
        {
          ...
          paramTunnelMsgStream = (aizm)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(j);
          if (paramTunnelMsgStream == null) {
            break label748;
          }
      ...
      else
      {
        ...
        {
          aizg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), l3, j);
          return;
        }
      ...
      for (int i = 1;; i = 0)
      {
        ...
        if ("robot_send_arkmsg".equals(str))
        {
          ...
          aizg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l2), paramTunnelMsgStream, l1, i);
          return;
        }
  ...
  public void a(String paramString)
  {
    try
    {
      ...
      localObject2 = aizg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, 1036, 1);
      if ((localObject2 == null) || (((List)localObject2).isEmpty()))
      {
        if (!QLog.isColorLevel()) {
          return;
    ...
    ((WebSSOAgent.UniSsoServerReqComm)localObject3).mqqver.set("8.2.8");
    ...
    Object localObject1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aiwi.class);
  ...
  public void a(String paramString1, String paramString2)
  {
    try
    {
      ...
      localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
      paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), aiwi.class);
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = new NewIntent(BaseApplicationImpl.getContext(), aiwi.class);
        ((NewIntent)localObject).putExtra("timeout", 10000L);
  ...
  public void a(List<ApolloGameData> paramList, Bundle paramBundle)
  {
    ...
    if (i == 1)
    {
      this.jdField_a_of_type_Aizo.jdField_b_of_type_JavaUtilList.clear();
      k = this.jdField_a_of_type_Aizo.jdField_b_of_type_JavaUtilList.size();
      i = 0;
      while (i < k)
      {
        int m = ((Integer)this.jdField_a_of_type_Aizo.jdField_a_of_type_JavaUtilList.get(i)).intValue();
        paramBundle = ((ajmw)localObject).a(m);
        if (paramBundle != null)
        {
          this.jdField_a_of_type_Aizo.jdField_b_of_type_JavaUtilList.add(paramBundle);
          i += 1;
        }
        else
        {
    ...
    for (;;)
    {
      ...
      while (i < k)
      {
        paramBundle = (aizm)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
        if (paramBundle != null) {
          paramBundle.a(paramList, this.jdField_a_of_type_Aizo);
        }
        i += 1;
      }
      continue;
      if (i == 2)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          ApolloGameData localApolloGameData = ((ajmw)localObject).a(i);
        ...
        Collections.sort(paramBundle, this.jdField_a_of_type_Aizn);
        j = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size();
        i = 0;
        while (i < j)
        {
          localObject = (aizm)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(0);
          if (localObject != null) {
            ((aizm)localObject).a(paramList, paramBundle);
          }
          i += 1;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        while (i < k)
        {
          aizm localaizm = (aizm)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i);
          if (localaizm != null) {
            localaizm.a(paramBoolean, paramString1, j, l, paramString2);
          }
          i += 1;
        }
        return;
  ...
  public void b(aizm paramaizm)
  {
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(paramaizm);
    QLog.i("CmGameTemp_CmGameTempSessionHandler", 1, "removeMsgUIHandler size:" + this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() + " cmGameMsgUIHandler:" + paramaizm);
  }
      ...
      try
      {
        if ((BaseActivity.sTopActivity instanceof FragmentActivity))
        {
          ...
          if (localObject1 != null)
          {
            ...
            if ((localObject1 instanceof aena))
            {
              localObject1 = (aena)localObject1;
              ...
              if ((localObject1 == null) || (!((aena)localObject1).D()))
              {
                a(str, (String)localObject2, true, paramString);
                return;
              }
              aena.U = true;
              ((aena)localObject1).a(j, i, paramString);
              return;
            }
          }
        }
