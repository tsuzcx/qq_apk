...
public class msn
{
  ...
  private static final String jdField_a_of_type_JavaLangString = anni.a(2131707670);
  ...
  public static mso a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        mso localmso = new mso();
        localmso.jdField_b_of_type_Int = 2147483647;
        i = 0;
        if (i < localJSONArray.length())
        {
          JSONObject localJSONObject = localJSONArray.getJSONObject(i);
          if ((localJSONObject.getInt("type") == paramInt) && (localJSONObject.getInt("priority") < localmso.jdField_b_of_type_Int))
          {
            localmso.jdField_a_of_type_Int = localJSONObject.getInt("id");
            localmso.jdField_a_of_type_JavaLangString = localJSONObject.getString("url");
            localmso.jdField_b_of_type_Int = localJSONObject.getInt("priority");
            localmso.c = localJSONObject.getInt("type");
          }
        }
        else if (localmso.jdField_b_of_type_Int < 2147483647)
        {
          QLog.i("QAVConfigUtils", 1, "MoreBtnTips. getHighestPriorityMoreBtnTips. highest. id = " + localmso.jdField_a_of_type_Int + ", url = " + localmso.jdField_a_of_type_JavaLangString + ", priority = " + localmso.jdField_b_of_type_Int + ", type = " + localmso.c);
          return localmso;
        }
      }
  ...
  public static void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        new mso().jdField_b_of_type_Int = 2147483647;
        i = 0;
        if (i >= localJSONArray.length()) {
          break;
        }
