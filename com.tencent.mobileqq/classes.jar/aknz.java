...
public class aknz
  implements Runnable
{
  public aknz(AppInterface paramAppInterface, DialogInterface.OnClickListener paramOnClickListener) {}
  ...
  public void run()
  {
    ...
    localMyAppDialog.a(2131428535, this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener, true);
    localMyAppDialog.b(2131428536, this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener, true);
    localMyAppDialog.a(localResources.getString(2131428526));
    localMyAppDialog.b(localResources.getString(2131428537));
    localMyAppDialog.setCancelable(false);
    localMyAppDialog.setOnDismissListener(new akoa(this));
