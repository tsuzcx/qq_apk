...
public class aknz
{
  ...
  protected static anth a;
  public static String a;
  public static WeakReference<akof> a;
  public static int b;
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidOsHandler = new akoa(Looper.myLooper());
    jdField_a_of_type_Anth = new anth(jdField_a_of_type_AndroidOsHandler);
  }
  ...
  public static ArrayList<PfaFriend> a()
  {
    ...
    do
    {
      ...
      localObject2 = ((aong)localObject1).getRecentList(true);
  ...
  public static HashMap<String, Object> a(akof paramakof, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramakof);
    ...
    paramakof = new HashMap();
    if (jdField_a_of_type_WalletPfaFriendRsp == null)
    {
      paramakof.put(jdField_a_of_type_JavaLangString, a());
    ...
    for (;;)
    {
      paramakof.put(jdField_b_of_type_JavaLangString, jdField_a_of_type_WalletPfaFriendRsp.vecPfaMsg);
      if (!paramBoolean) {
        break;
      }
      ...
      return paramakof;
      label142:
      paramakof.put(jdField_a_of_type_JavaLangString, jdField_a_of_type_WalletPfaFriendRsp.vecRec);
    }
  }
  ...
  public static void a(int paramInt1, int paramInt2)
  {
    ...
    localQQAppInterface.addObserver(jdField_a_of_type_Anth);
    PfaFriendRqt localPfaFriendRqt = new PfaFriendRqt();
    localPfaFriendRqt.mqq_version = bgln.a(BaseApplicationImpl.getContext());
    if (jdField_a_of_type_WalletPfaFriendRsp != null)
    {
    ...
    for (;;)
    {
      ((antg)localQQAppInterface.a(42)).a(localPfaFriendRqt);
      return;
  ...
  public static void a(SelectMemberActivity paramSelectMemberActivity, ArrayList<ResultRecord> paramArrayList)
  {
    ...
    Object localObject2 = anni.a(2131713713);
    ...
    for (localObject2 = (String)localObject1 + "、";; localObject2 = localObject1)
    {
      ...
      {
        QQToast.a(paramSelectMemberActivity, paramSelectMemberActivity.getString(2131718639), 0).a();
        return;
      }
      paramArrayList = new akob(new WeakReference(paramSelectMemberActivity), localArrayList);
      localObject2 = paramSelectMemberActivity.getIntent().getExtras();
      paramSelectMemberActivity = bglp.a(paramSelectMemberActivity, (String)localObject1, ((Bundle)localObject2).getString("choose_friend_content"), ((Bundle)localObject2).getString("choose_friend_subcontent"), paramSelectMemberActivity.f, null, paramArrayList, paramArrayList, 36, false);
      bcst.b(akww.a(), "P_CliOper", "Vip_pay_mywallet", "", "wallet", "friendpay.selectpage.windowshow", 0, 0, "", "", "", "");
  ...
  public static void a(SelectMemberActivity paramSelectMemberActivity, ArrayList<ResultRecord> paramArrayList, bgqn parambgqn)
  {
    if ((paramSelectMemberActivity == null) || (paramSelectMemberActivity.isFinishing()) || (paramSelectMemberActivity.getIntent() == null) || (paramSelectMemberActivity.getIntent().getExtras() == null)) {}
    ...
    if (parambgqn != null) {
      paramArrayList.putString("choose_friend_feedback", parambgqn.getInputValue());
    }
    parambgqn = new TopayManager.5(null, new WeakReference(paramSelectMemberActivity), localResultReceiver, localArrayList1, localArrayList3);
    b(paramSelectMemberActivity, true);
    paramSelectMemberActivity = Parcel.obtain();
    parambgqn.writeToParcel(paramSelectMemberActivity, 0);
    paramSelectMemberActivity.setDataPosition(0);
    parambgqn = (ResultReceiver)ResultReceiver.CREATOR.createFromParcel(paramSelectMemberActivity);
    paramSelectMemberActivity.recycle();
    paramArrayList.putParcelable("callback", parambgqn);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null) {
      paramQQAppInterface.removeObserver(jdField_a_of_type_Anth);
    }
  }
  ...
  protected static void a(boolean paramBoolean)
  {
    if (jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      akof localakof = (akof)jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localakof != null) {
        localakof.b(paramBoolean);
      }
    }
  }
  ...
  {
    akod localakod = new akod(paramActivity);
    paramList1 = new akoe(paramActivity, paramList1, paramList2);
    paramActivity = bglp.a(paramActivity, 230, null, anni.a(2131713714), anni.a(2131713712), "留在QQ", paramList1, localakod);
