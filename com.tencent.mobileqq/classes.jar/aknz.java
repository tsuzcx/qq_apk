...
{
  public static int a;
  private static aknz jdField_a_of_type_Aknz;
  public static ArrayList<String> a;
  private long jdField_a_of_type_Long;
  private SharedPreferences jdField_a_of_type_AndroidContentSharedPreferences;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private Vector<akoa> jdField_a_of_type_JavaUtilVector;
  public boolean a;
  ...
  {
    if (jdField_a_of_type_Aknz == null) {}
    try
    {
      if (jdField_a_of_type_Aknz == null) {
        jdField_a_of_type_Aknz = new aknz();
      }
      return jdField_a_of_type_Aknz;
    }
    finally {}
  }
  ...
  private void a(int paramInt, xot paramxot)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilVector.iterator();
      if (localIterator.hasNext()) {
        ((akoa)localIterator.next()).a(paramInt, paramxot);
      }
    }
  }
  ...
  private void a(long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilVector.iterator();
      if (localIterator.hasNext()) {
        ((akoa)localIterator.next()).a(paramLong);
      }
    }
  }
  ...
  private void d()
  {
    ...
    long l2 = (100 - akag.a().jdField_a_of_type_Int) * Runtime.getRuntime().maxMemory() / 100L;
    ...
    {
      this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putLong("key_use_heap", l1).putString("key_act_name", (String)localObject).putBoolean("key_clear_flag", akag.a().jdField_a_of_type_Xos.jdField_a_of_type_Boolean).commit();
  ...
  private void f()
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      localObject = (ajvi)((QQAppInterface)localObject).getManager(53);
      if (localObject != null)
      {
        i = ((ajvi)localObject).a().size();
        localStringBuffer.append("dc=");
        localStringBuffer.append(i);
        localStringBuffer.append("&");
        i = ((ajvi)localObject).b();
  ...
  public void a(akoa paramakoa)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.add(paramakoa);
      return;
    }
  }
  
  public boolean a(long paramLong1, long paramLong2, xos paramxos, int paramInt)
  {
    xot localxot = paramxos.a(paramInt);
    if ((localxot != null) && (paramLong1 >= localxot.jdField_a_of_type_Int * paramLong2 / 100L))
    {
      if (QLog.isColorLevel()) {
        QLog.d("MemoryReporter", 2, "onNeedTrimMemory|maxHeap=" + paramLong2 / 1024L / 1024L + ",totalSize=" + paramLong1 / 1024L / 84L);
      }
      paramxos.jdField_a_of_type_Int = localxot.b;
      a(paramInt, localxot);
      return true;
    }
    return false;
  ...
  public void b(akoa paramakoa)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.remove(paramakoa);
      return;
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    paramMessage = akag.a().jdField_a_of_type_Xos;
    xow.a().c();
    int i;
