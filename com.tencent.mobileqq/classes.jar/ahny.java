  ...
  implements Camera.PictureCallback
{
  ...
  public ahny(CameraControl paramCameraControl, int paramInt1, File paramFile, Rect paramRect, CameraCover.PictureCallback paramPictureCallback, boolean paramBoolean, int paramInt2) {}
  ...
  public void onPictureTaken(byte[] paramArrayOfByte, Camera paramCamera)
  {
    ...
    catch (Exception paramCamera)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new ahnz(this, paramArrayOfByte, paramCamera));
    }
  }
}
