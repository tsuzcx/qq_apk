...
public class awmg
  implements Manager
{
  private static final String jdField_a_of_type_JavaLangString = anhk.ba + "fight/pic_expire.png";
  private long jdField_a_of_type_Long;
  public QQAppInterface a;
  public ConcurrentHashMap<Long, ChatMessage> a;
  
  public awmg(QQAppInterface paramQQAppInterface)
  {
  ...
  private MessageForMixedMsg a(List<MessageRecord> paramList, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, int paramInt, boolean paramBoolean)
  {
    ...
    MessageForMixedMsg localMessageForMixedMsg = (MessageForMixedMsg)bbzh.a(-1035);
    ...
    if (localMessageForMixedMsg.istroop == 1) {
      njo.a().b(localMessageForMixedMsg);
    }
    ...
    bfmd.a(paramInt, paramSourceMsgInfo.toString(), localMessageForMixedMsg);
  ...
  public static MessageForPic a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    {
      paramString2 = bbzh.a(paramQQAppInterface, paramString3, paramString2, paramInt);
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, ArrayList<ayxr> paramArrayList, MessageForMixedMsg paramMessageForMixedMsg)
  {
    ayxx localayxx = ayxn.a(8, 7);
    localayxx.a(paramArrayList);
    localayxx.a(new awmh(this, paramMessageForMixedMsg, paramQQAppInterface, paramString, paramInt));
  ...
  private void a(MessageForMixedMsg paramMessageForMixedMsg, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList, String paramString, Map<String, Boolean> paramMap)
  {
    ...
    ((bauy)localObject).a(paramString, paramMessageForMixedMsg.uniseq);
    ((bauy)localObject).a(paramMessageForMixedMsg, null);
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((paramString instanceof MessageForPic))
      {
        ...
        if (atwl.a(localMessageForPic.path))
        {
          localObject = (List)localMap.get(localMessageForPic.path);
          paramString = (String)localObject;
          if (localObject == null)
          {
            localHashMap.put(localMessageForPic, new awmk(this, paramMessageForMixedMsg, localMap, localMessageForPic.path, paramArrayList));
    ...
    if (paramMessageForMixedMsg.hasNext())
    {
      ...
      paramString = (awmk)paramArrayList.getValue();
      if (paramMap == null) {
        break label346;
      }
  ...
  private void a(MessageForMixedMsg paramMessageForMixedMsg, boolean paramBoolean, String paramString)
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Long.valueOf(paramMessageForMixedMsg.mForwardFromUniSeq));
    bauy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForMixedMsg.frienduin, paramMessageForMixedMsg.uniseq);
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, MessageForMixedMsg paramMessageForMixedMsg, String paramString)
  {
    ...
    bctj.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "MixedMsgForward", paramBoolean1, 0L, 0L, localHashMap, "");
  }
  ...
  public void a(SessionInfo paramSessionInfo, long paramLong, int paramInt)
  {
    ...
    if (localObject != null) {
      if (((ChatMessage)localObject).msgtype == -1036)
      {
        ...
        baku.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMixedMsg)localObject, paramSessionInfo, paramInt);
      }
    }
    ...
    do
    {
      ...
      do
      {
        ...
        if ((TextUtils.isEmpty(paramMixedMsgInfo.b())) && (localObject1 != null) && (((List)localObject1).size() == 1))
        {
          ...
          ahqr.a(paramQQAppInterface, paramBaseChatPie, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout, false, null).a(paramBaseChatPie, (List)localObject1, false);
          return;
        }
        int i;
        ...
        if (localObject1 == null)
        {
          ...
          if (paramArrayList != null)
          {
            ...
            {
              localObject2 = (bftx)paramQQAppInterface.getManager(203);
              ...
              } while (!((bftx)localObject2).a(((MessageForText.AtTroopMemberInfo)((Iterator)localObject3).next()).uin));
              bool1 = true;
            }
          }
          ...
          if ((localObject3 instanceof MixedMsgInfo.TextMsgNode))
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject4))
            {
              ...
              localObject5 = bbzh.a(paramQQAppInterface, (String)localObject1, m, localSourceMsgInfo, (String)localObject4);
          ...
          if ((localObject3 instanceof MixedMsgInfo.PhotoMsgNode))
          {
            ...
            if ((localObject3 != null) && (atwl.a(((MixedMsgInfo.PhotoItem)localObject3).path)))
            {
        ...
        for (;;)
        {
          ...
          break;
          localObject5 = bbzh.a(paramQQAppInterface, paramQQAppInterface.getCurrentAccountUin(), (String)localObject1, (String)localObject1, m, (byte)1, (byte)0, (short)0, (String)localObject4);
  ...
  protected void a(QQAppInterface paramQQAppInterface, MessageForPic paramMessageForPic, boolean paramBoolean, ayyt paramayyt)
  {
    bdzn localbdzn = new bdzn();
    localbdzn.jdField_b_of_type_JavaLangString = paramMessageForPic.selfuin;
    localbdzn.c = paramMessageForPic.frienduin;
    localbdzn.jdField_a_of_type_Int = paramMessageForPic.istroop;
    localbdzn.jdField_b_of_type_Int = 1;
    localbdzn.jdField_a_of_type_Long = (paramMessageForPic.uniseq + paramMessageForPic.subMsgId);
    for (Object localObject = localbdzn.c + localbdzn.jdField_a_of_type_Long; paramQQAppInterface.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(localObject); localObject = localbdzn.c + localbdzn.jdField_a_of_type_Long) {
      localbdzn.jdField_a_of_type_Long += 100L;
    }
    localbdzn.jdField_a_of_type_Boolean = true;
    localbdzn.jdField_e_of_type_Boolean = false;
    localObject = new bdzr();
    ((bdzr)localObject).jdField_a_of_type_Boolean = paramBoolean;
    localbdzn.jdField_a_of_type_JavaLangObject = localObject;
    localbdzn.i = paramMessageForPic.path;
    localbdzn.jdField_a_of_type_Ayyt = paramayyt;
    localbdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = paramMessageForPic;
    paramQQAppInterface.a().a(localbdzn);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, ArrayList<String> paramArrayList, boolean paramBoolean, String paramString2, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList1, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo)
  {
    ...
    {
      paramString2 = bbzh.a(paramQQAppInterface, paramString1, paramInt, paramSourceMsgInfo, paramString2);
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (atwl.a(paramString2))
        {
          ...
          if (paramString2 != null)
          {
            ...
            paramString2 = bbzh.a(paramQQAppInterface, paramQQAppInterface.getCurrentAccountUin(), paramString1, paramString1, paramInt, (byte)1, (byte)0, (short)0, paramString2);
            paramString2.atInfoList = paramArrayList1;
            if ((paramString2.atInfoList == null) || (paramString2.atInfoList.isEmpty())) {
              break label411;
            }
            bftx localbftx = (bftx)paramQQAppInterface.getManager(203);
      ...
      for (bool = true;; bool = false)
      {
        ...
        while (paramSourceMsgInfo.hasNext())
        {
          ...
          if ((localObject instanceof MessageForPic))
          {
            ...
            if (atwl.a(((MessageForPic)localObject).path)) {
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    bctj.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "MixedMsgReceived", true, 0L, 0L, localHashMap, "");
  }
  ...
  public void a(String paramString, int paramInt, MessageForMixedMsg paramMessageForMixedMsg, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        paramString = new awmi(this, paramQQAppInterface, paramMessageForMixedMsg, paramString, paramInt);
        paramBoolean = a(paramQQAppInterface, arrayOfByte, paramQQAppInterface.getCurrentAccountUin(), paramMessageForMixedMsg.frienduin, paramMessageForMixedMsg.frienduin, paramMessageForMixedMsg.istroop, paramMessageForMixedMsg.uniseq, 1035, new awmj(this, paramQQAppInterface, paramMessageForMixedMsg, paramString));
        if (!paramBoolean) {
          break;
        }
      } while (!QLog.isColorLevel());
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      bctj.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "MixedMsgClientAutoPull", true, 0L, 0L, localHashMap, "");
      return;
    }
    bctj.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "MixedMsgClientManualPull", true, 0L, 0L, localHashMap, "");
  }
