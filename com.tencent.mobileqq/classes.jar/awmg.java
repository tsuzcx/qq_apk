  ...
  extends awlv
{
  ...
  public awmg(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, ArrayList<String> paramArrayList, List<FTSMessage> paramList, String paramString3, CharSequence paramCharSequence)
  {
    ...
    {
      i = ((ajvk)paramQQAppInterface.getManager(53)).a(this.jdField_d_of_type_JavaLangString);
      if (i <= 0) {
        this.f = "";
      }
    }
  ...
  public CharSequence a()
  {
    if (this.jdField_a_of_type_JavaLangCharSequence == null) {
      this.jdField_a_of_type_JavaLangCharSequence = bbcl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_d_of_type_JavaLangString, this.jdField_e_of_type_Int);
    }
  ...
  public void a(View paramView)
  {
    ...
    if ((paramView.getContext() instanceof UniteSearchActivity)) {
      ...
      {
        localObject1 = (awiv)awiu.b.get(this);
    ...
    try
    {
      ...
      localJSONObject.put("obj_lct", ((awiv)localObject1).jdField_a_of_type_Int);
      ...
      awso.a(null, this.s, 0, "0X8009D4D", 0, 0, null, null);
      if (this.jdField_a_of_type_JavaLangCharSequence != null) {
        this.jdField_a_of_type_JavaLangCharSequence = bbma.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_d_of_type_JavaLangString, this.jdField_e_of_type_Int, this.jdField_e_of_type_JavaLangString);
      }
      localObject1 = (Integer)paramView.getTag(2131379209);
      localObject2 = (Integer)paramView.getTag(2131379207);
      if (((paramView.getContext() instanceof UniteSearchActivity)) && (((Integer)localObject1).intValue() >= 0) && (((Integer)localObject2).intValue() >= 0))
      {
        awvy.a("all_result", "clk_talk", new String[] { "" + this.jdField_a_of_type_JavaLangString, "" + localObject2, "" + (((Integer)localObject1).intValue() + 1) });
        if (this.jdField_a_of_type_JavaUtilList.size() != 1) {
          break label699;
        }
        bbmb.f = 1;
        bbmb.jdField_d_of_type_Int = this.jdField_a_of_type_Int;
        bbmb.g = this.jdField_e_of_type_Int;
        bbmb.h = this.jdField_b_of_type_Int;
        bbmb.i = this.jdField_c_of_type_Int;
        bbmb.j = this.jdField_d_of_type_Int;
        bbma.a(paramView);
        if (this.jdField_a_of_type_JavaUtilList.size() != 1) {
          break label725;
        }
        ...
        if (((FTSMessage)localObject1).msgExts != null)
        {
          ...
          ahpf.jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject1).msgExts).shmsgseq;
        }
        akgc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
        ahpf.a(paramView.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_d_of_type_JavaLangString, this.jdField_e_of_type_Int, (String)this.jdField_a_of_type_JavaLangCharSequence, false);
        awvy.a(this.jdField_a_of_type_JavaLangString, 40, paramView, false);
    ...
    catch (JSONException localJSONException)
    {
      for (;;)
      {
        ...
        {
          awvy.a("talk", "clk_talk", new String[] { "" + this.jdField_a_of_type_JavaLangString, "" + localObject2, "" + (((Integer)localObject1).intValue() + 1) });
          continue;
          label699:
          bbmb.f = 2;
          continue;
          label706:
          ahpf.jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject1).msgExts).time;
          continue;
          label725:
  ...
  public CharSequence c()
  {
    ...
    if (this.jdField_d_of_type_JavaLangCharSequence == null)
    {
      ...
      if (i == 1) {
        this.jdField_d_of_type_JavaLangCharSequence = awvy.a(((FTSEntity)this.jdField_a_of_type_JavaUtilList.get(0)).mContent, ((FTSEntity)this.jdField_a_of_type_JavaUtilList.get(0)).mProximityStart, this.jdField_a_of_type_JavaUtilArrayList);
      }
    }
    else
    {
    ...
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder(i + ajyc.a(2131704953) + "\"");
    if ((this.jdField_c_of_type_JavaLangString != null) && ((this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_JavaUtilArrayList.isEmpty()))) {
      localSpannableStringBuilder.append(awvy.a(this.jdField_c_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString));
    }
    for (;;)
    {
