...
public class bckj
  implements bgso, bgte
{
  public static String a;
  protected final int a;
  protected long a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private bcex jdField_a_of_type_Bcex;
  ...
  public bckj(boolean paramBoolean, bcex parambcex)
  {
    this.jdField_a_of_type_Int = 1000;
    this.jdField_a_of_type_Boolean = paramBoolean;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_Bcex = parambcex;
  }
  
  private void a()
  {
    if (this.jdField_a_of_type_Bcex == null) {}
    ...
    while (((Iterator)localObject2).hasNext()) {
      ((JSONArray)localObject1).put(bcko.a((WadlResult)((Iterator)localObject2).next()));
    }
    localObject1 = ((JSONArray)localObject1).toString();
    localObject2 = this.jdField_a_of_type_Bcex.getJsCallbackMethod();
  ...
  private void a(int paramInt, WadlParams paramWadlParams)
  {
    ...
    while (i != 0)
    {
      a(bcko.a(paramInt));
      return;
      bgsw.a().c(0, paramWadlParams.jdField_a_of_type_JavaLangString);
      i = j;
      continue;
      bgsw.a().a(0, paramWadlParams.jdField_a_of_type_JavaLangString);
  ...
  private void b(String paramString)
  {
    ...
    {
      return;
      bckd.b(jdField_a_of_type_JavaLangString, "doJsCallBack loadJs=" + paramString);
      try
      {
        WebView localWebView = this.jdField_a_of_type_Bcex.getWebview();
      ...
      {
        bckd.a(jdField_a_of_type_JavaLangString, "doJsCallback exception", paramString);
      }
    }
  }
  ...
  public void a(WadlResult paramWadlResult)
  {
    ...
    {
      paramWadlResult = bcko.a(paramWadlResult).toString();
      str = this.jdField_a_of_type_Bcex.getJsCallbackMethod();
  ...
  public void a(String paramString)
  {
    ...
    {
      bckd.a(jdField_a_of_type_JavaLangString, "showToast>>>", paramString);
    }
  }
  ...
  {
    bckd.b(jdField_a_of_type_JavaLangString, "onCmdRsp cmd=" + paramString + ",isSucc");
  ...
  {
    bckd.b(jdField_a_of_type_JavaLangString, "onQueryCallback params:" + paramArrayList);
    ...
    if (paramArrayList != null) {
      try
      {
        ...
        {
          localJSONArray.put(bcko.a((WadlResult)paramArrayList.next()));
          continue;
          return;
        }
      }
      ...
      {
        bckd.a(jdField_a_of_type_JavaLangString, "onQueryCallback exception:" + paramArrayList.getMessage());
      }
    }
  ...
  {
    bckd.b(jdField_a_of_type_JavaLangString, "onQueryCallbackVia params:" + paramArrayList);
    JSONArray localJSONArray;
    if (paramArrayList != null) {
      try
      {
      ...
      {
        bckd.a(jdField_a_of_type_JavaLangString, "onQueryCallbackVia exception:" + paramArrayList.getMessage());
      }
    }
  ...
  public void onWadlTaskStatusChanged(WadlResult paramWadlResult)
  {
    ...
    {
      bckd.a(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged error wadlResult is null");
      return;
    }
    WadlParams localWadlParams = paramWadlResult.a;
    String str = localWadlParams.jdField_a_of_type_JavaLangString;
    int i = bcko.a(paramWadlResult.b);
    bcki.b(localWadlParams.jdField_a_of_type_JavaLangString);
    bckd.b(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged:" + paramWadlResult + ",localStatus:" + i);
    switch (i)
    {
    default: 
      bckd.a(jdField_a_of_type_JavaLangString, "download status not response!");
      return;
    case 3: 
    case 4: 
    case 6: 
    ...
    case -2: 
      ...
      bckd.a(jdField_a_of_type_JavaLangString, "onWadlTaskStatusChanged  error,wadlErrCode=" + i);
      c(str);
      a(i, localWadlParams);
      a(paramWadlResult);
      return;
