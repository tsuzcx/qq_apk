...
{
  public bckj(ClearableEditText paramClearableEditText, View paramView)
  {
    super(paramView);
  }
  ...
  {
    if (paramInt == 0) {
      paramAccessibilityEvent.setContentDescription(ajya.a(2131701945));
    }
  }
  ...
  public void onPopulateNodeForVirtualView(int paramInt, AccessibilityNodeInfoCompat paramAccessibilityNodeInfoCompat)
  {
    if (paramInt == 0)
    {
      paramAccessibilityNodeInfoCompat.setContentDescription(ajya.a(2131701944));
