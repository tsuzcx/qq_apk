...
public class bckj
{
  ...
  public static bckj a()
  {
    if (jdField_a_of_type_Bckj == null) {}
    try
    {
      if (jdField_a_of_type_Bckj == null) {
        jdField_a_of_type_Bckj = new bckj();
      }
      return jdField_a_of_type_Bckj;
    }
    finally {}
  }
  ...
  {
    paramString = bckk.a().a(paramString);
  ...
  public String a(String paramString, bckk parambckk)
  {
    String str1 = paramString;
    if (parambckk.c != null) {
      str1 = paramString.replace("<$FROM>", parambckk.c);
    }
    paramString = str1;
    if (parambckk.a != null) {
      paramString = str1.replace("<$GC>", parambckk.a);
    }
    str1 = paramString;
    if (parambckk.e != null) {
      str1 = paramString.replace("<$NICK>", parambckk.e);
    }
    paramString = str1;
    if (parambckk.d != null) {
      paramString = str1.replace("<$TYPE>", parambckk.d);
    }
    str1 = paramString;
    if (parambckk.b != null) {
      str1 = paramString.replace("<$UIN>", parambckk.b);
    }
    paramString = str1;
    if (parambckk.f != null) {
      paramString = str1.replace("<$CATEID>", parambckk.f);
    }
    str1 = paramString;
    if (parambckk.g != null) {
      str1 = paramString.replace("<$SUBID>", parambckk.g);
    }
    paramString = str1;
    if (parambckk.j != null) {
      paramString = str1.replace("<$GRAY>", parambckk.j);
    }
    str1 = paramString;
    if (parambckk.h != null) {}
    try
    {
      str1 = paramString.replace("<$TITLE>", URLEncoder.encode(parambckk.h, "UTF-8").replaceAll("\\+", "%20"));
      paramString = str1;
      if (parambckk.i == null) {}
    }
    catch (UnsupportedEncodingException localUnsupportedEncodingException)
    {
      ...
      for (;;)
      {
        try
        {
          paramString = str1.replace("<$CONTENT>", URLEncoder.encode(parambckk.i, "UTF-8").replaceAll("\\+", "%20"));
          return paramString;
        }
  ...
  {
    paramString1 = bckk.a().b(paramString2).a(paramString1);
  ...
  {
    paramString3 = bckk.a().a(paramString1).b(paramString2).e(paramString3).d("3").c("aio");
  ...
  {
    Object localObject = bckk.a().a(paramString);
    if (paramBoolean) {}
    for (paramString = "1";; paramString = "0")
    {
      paramString = ((bckk)localObject).f(paramString);
  ...
  public String b(String paramString, bckk parambckk)
  {
