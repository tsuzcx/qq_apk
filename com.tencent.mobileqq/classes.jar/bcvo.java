  ...
  extends MSFServlet
{
  ...
  {
    new bmaq().a(paramFileStoragePushFSSvcList);
  }
  ...
  public static void a(FileStoragePushFSSvcList paramFileStoragePushFSSvcList, QQAppInterface paramQQAppInterface)
  {
    ...
    aqwz.a(paramFileStoragePushFSSvcList, paramQQAppInterface);
    ...
    bahy.a(paramQQAppInterface).a(true, false);
  }
          ...
          if ("qqwifi.notifyAvail".equals(str))
          {
            ...
            if (paramIntent != null)
            {
              ...
              for (int i = 1032;; i = 1033)
              {
                ...
                bdla.b(localQQAppInterface, "CliOper", "", "", "QQWIFI", "show_buleNotify", 0, 0, "", "", "", "");
                return;
              }
            }
          }
