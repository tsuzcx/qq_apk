...
class zhm
  implements Runnable
{
  zhm(zhl paramzhl, BaseActivity paramBaseActivity) {}
  ...
  public void run()
  {
    ...
    if ((bool) && (SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, null, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131433595), "qqsetting_screenshot_key", false)) && (ReflectionUtil.a(BaseApplicationImpl.sApplication)))
    {
