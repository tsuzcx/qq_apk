...
{
  bjbi(boolean paramBoolean1, boolean paramBoolean2, List paramList, boolean paramBoolean3) {}
  
  /* Error */
  protected Bitmap a(Void... paramVarArgs)
  {
    // Byte code:
    //   0: invokestatic 34	bkqo:a	()Lbkqo;
    //   3: astore_1
    //   4: aload_1
    //   5: invokevirtual 37	bkqo:a	()Landroid/graphics/Bitmap;
    //   8: astore_1
    //   9: aload_1
    //   10: astore_2
    //   11: aload_1
    ...
    //   21: ifne +181 -> 202
    //   24: aload_0
    //   25: getfield 14	bjbi:jdField_a_of_type_Boolean	Z
    //   28: ifne +119 -> 147
    //   31: aload_0
    //   32: getfield 16	bjbi:b	Z
    //   35: ifeq +51 -> 86
    //   38: getstatic 48	bjww:a	Lbkxk;
    //   41: ifnull +155 -> 196
    //   44: new 50	bkxk
    //   47: dup
    //   48: invokespecial 51	bkxk:<init>	()V
    //   51: astore_2
    //   52: aload_2
    //   53: getstatic 48	bjww:a	Lbkxk;
    //   56: getfield 54	bkxk:a	Landroid/opengl/EGLContext;
    //   59: aload_1
    //   60: invokevirtual 58	android/graphics/Bitmap:getWidth	()I
    //   63: aload_1
    //   64: invokevirtual 61	android/graphics/Bitmap:getHeight	()I
    //   67: invokevirtual 64	bkxk:a	(Landroid/opengl/EGLContext;II)V
    //   70: aload_2
    //   71: aload_1
    //   72: aload_0
    //   73: getfield 18	bjbi:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   76: getstatic 48	bjww:a	Lbkxk;
    //   79: invokevirtual 67	bkxk:a	(Landroid/graphics/Bitmap;Ljava/util/List;Lbkxk;)Landroid/graphics/Bitmap;
    //   82: astore_2
    //   83: goto +115 -> 198
    //   86: new 50	bkxk
    //   89: dup
    //   90: invokespecial 51	bkxk:<init>	()V
    //   93: astore_3
    //   94: aload_3
    //   95: aload_1
    ...
    //   103: invokevirtual 70	bkxk:b	(II)V
    //   106: aload_3
    //   107: aload_1
    //   108: aload_0
    //   109: getfield 18	bjbi:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   112: aload_0
    //   113: getfield 20	bjbi:c	Z
    //   116: invokevirtual 73	bkxk:a	(Landroid/graphics/Bitmap;Ljava/util/List;Z)Landroid/graphics/Bitmap;
    //   119: astore_2
    //   120: aload_3
    //   121: invokevirtual 75	bkxk:a	()V
    //   124: goto +74 -> 198
    //   127: astore_3
    //   128: aload_1
    //   129: astore_2
  ...
  {
    bjww localbjww = bkqo.a().a();
    if ((localbjww != null) && (paramBitmap != null) && (!paramBitmap.isRecycled()))
    {
      localbjww.a(paramBitmap, true);
      localbjww.x();
    }
  }
}
