...
public class bigb
{
  ...
  public bigb(AppInterface paramAppInterface, bifc parambifc, Intent paramIntent, Context paramContext, boolean paramBoolean)
  {
  ...
  public bigb(AppInterface paramAppInterface, bifc parambifc, Intent paramIntent, TouchWebView paramTouchWebView)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_Bifc = parambifc;
    this.jdField_a_of_type_AndroidContentIntent = paramIntent;
  ...
  private void b(TouchWebView paramTouchWebView)
  {
    ...
    paramTouchWebView.setWebChromeClient(localbigc);
    this.jdField_a_of_type_Ofz = localbigc;
  }
  ...
  public TouchWebView a(TouchWebView paramTouchWebView, AppInterface paramAppInterface, Intent paramIntent)
  {
    ...
    String str1 = a(this.jdField_a_of_type_Bifc);
    boolean bool;
    ...
    for (;;)
    {
      localWebSettings.setUserAgentString(biit.a((String)localObject, str1, bool));
      ...
      try
      {
        ...
        if (paramTouchWebView.getX5WebViewExtension() != null)
        {
          paramTouchWebView.getX5WebViewExtension().setWebViewClientExtension(new bigf(this, paramTouchWebView, this.jdField_a_of_type_Bifc));
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("WebLog_WebViewWrapper", 2, new Object[] { "sReportPerformance:", Boolean.valueOf(bihv.x), " cost:", Long.valueOf(biis.jdField_a_of_type_Long) });
          }
          ...
          paramAppInterface.put("coreInit", String.valueOf(biis.jdField_a_of_type_Long));
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {}
    for (Object localObject = new bigd(this);; localObject = new bige(this))
    {
