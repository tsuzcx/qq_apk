...
public class bigb
{
  ...
  static
  {
    try
    {
      ...
      jdField_a_of_type_JavaLangString = bjms.a("b84cf5");
  ...
  public static bigb a()
  {
    bigb localbigb = new bigb();
    try
    {
      localbigb.jdField_b_of_type_Long = (DeviceInfoUtil.getSystemAvaialbeMemory() / 1048576L);
      localbigb.i = String.valueOf(DeviceInfoUtil.getSDCardMemory()[1]);
      localbigb.jdField_b_of_type_JavaLangString = "";
      localbigb.jdField_a_of_type_Int = 0;
      return localbigb;
    }
    catch (Exception localException)
    {
