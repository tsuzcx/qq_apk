  ...
  implements MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnSeekCompleteListener
{
  ...
  private abbs jdField_a_of_type_Abbs;
  ...
  public void a(abbs paramabbs)
  {
    this.jdField_a_of_type_Abbs = paramabbs;
  }
  ...
  public void a(VsMusicItemInfo paramVsMusicItemInfo)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewVsMusicItemInfo != null)
    {
      ...
      abbe.a("edit_smart_music_play", abbe.a((HashMap)localObject));
    }
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Abbs == null);
      this.jdField_a_of_type_Abbs.a(this.jdField_a_of_type_AndroidMediaMediaPlayer, -2, -1);
      return;
    ...
    this.jdField_a_of_type_Abbs.a(this.jdField_a_of_type_AndroidMediaMediaPlayer, -1, -1);
    return;
  ...
  {
    if ((this.jdField_a_of_type_Abbs != null) && (paramInt1 != -38)) {
      this.jdField_a_of_type_Abbs.a(paramMediaPlayer, paramInt1, paramInt2);
    }
    return false;
  }
  ...
  {
    if ((paramMediaPlayer != null) && (this.jdField_a_of_type_Abbs != null) && (!paramMediaPlayer.isPlaying()))
    {
      this.c = (System.currentTimeMillis() - this.jdField_a_of_type_Long);
      this.jdField_b_of_type_Long = System.currentTimeMillis();
      this.jdField_a_of_type_Abbs.a(paramMediaPlayer, this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewVsMusicItemInfo);
    }
  }
}
