...
{
  private static auwx jdField_a_of_type_Auwx;
  ...
  private auwx(String paramString)
  {
    super(paramString);
  }
  ...
  {
    if (jdField_a_of_type_Auwx == null) {}
    try
    {
      if (jdField_a_of_type_Auwx == null) {
        jdField_a_of_type_Auwx = new auwx("JubaoIPCServer");
      }
      return jdField_a_of_type_Auwx;
    }
    finally {}
  }
  ...
  public void a(String paramString)
  {
    ...
    NewIntent localNewIntent = new NewIntent(localQQAppInterface.getApplication().getApplicationContext(), auwy.class);
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    paramString = a();
    paramBundle = new NewIntent(paramString.getApplication().getApplicationContext(), auwy.class);
