  ...
  extends awum
{
  public View a(Context paramContext, View paramView, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramView != null)
    {
      ...
      if ((paramView instanceof RelativeLayout))
      {
        ...
        if (paramView.getChildCount() == j)
        {
          ...
          localObject1 = (awul)this.jdField_a_of_type_JavaUtilArrayList.get(i);
          ...
          {
            localObject1 = (awzf)localObject1;
            if (paramBoolean)
            {
              ((awzf)localObject1).b("black");
              label122:
              localObject2 = ((awzf)localObject1).f();
              if ((localObject2 == null) || (!((String)localObject2).equals("1"))) {
                break label189;
              }
              ((awzf)localObject1).c("22");
              ((awzf)localObject1).a(true);
              ((awzf)localObject1).a(paramContext, paramView.findViewById(2), paramBundle);
            }
          }
          for (;;)
          {
            i += 1;
            break;
            ((awzf)localObject1).b(null);
            break label122;
            label189:
            if ((localObject2 != null) && (((String)localObject2).equals("2")))
            {
              ((awzf)localObject1).c("44");
              ((awzf)localObject1).a(true);
              ((awzf)localObject1).a(paramContext, paramView.findViewById(3), paramBundle);
            }
            else
            {
              ((awzf)localObject1).c("30");
              ((awzf)localObject1).b(20);
              ((awzf)localObject1).a(paramContext, paramView.findViewById(4), paramBundle);
              continue;
              if ("picture".equals(localObject2))
              {
                localObject1 = (awwo)localObject1;
                if ((((awwo)localObject1).c != null) && (!((awwo)localObject1).c.equals("")))
                {
                  localObject2 = ((awwo)localObject1).a(paramContext, paramView.findViewById(6), true, paramBundle);
                  ((View)localObject2).setClickable(true);
                  ((View)localObject2).setOnClickListener((View.OnClickListener)localObject1);
                }
                else
                {
                  ((awwo)localObject1).a(paramContext, paramView.findViewById(5), true, paramBundle);
                }
              }
            }
          }
    ...
    for (;;)
    {
      ...
      paramView.rightMargin = aciy.a(20.0F, localResources);
      ...
      if (i < j)
      {
        localObject2 = (awul)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        ...
        if ("summary".equals(localObject3))
        {
          ...
          if (paramBoolean)
          {
            ((awzf)localObject2).b("black");
            label527:
            localObject3 = ((awzf)localObject2).f();
            if ((localObject3 == null) || (!((String)localObject3).equals("1"))) {
              break label621;
            }
            ((awzf)localObject2).c("22");
            ((awzf)localObject2).a(true);
            localObject2 = ((awzf)localObject2).a(paramContext, null, paramBundle);
      ...
      for (;;)
      {
        i += 1;
        break;
        ((awzf)localObject2).b(null);
        break label527;
        label621:
        if ((localObject3 != null) && (((String)localObject3).equals("2")))
        {
          ((awzf)localObject2).c("44");
          ((awzf)localObject2).a(true);
          localObject2 = ((awzf)localObject2).a(paramContext, null, paramBundle);
          ((View)localObject2).setId(3);
          localObject3 = new LinearLayout.LayoutParams(-2, -2);
          ((LinearLayout.LayoutParams)localObject3).topMargin = aciy.a(-3.5F, localResources);
          localLinearLayout.addView((View)localObject2, (ViewGroup.LayoutParams)localObject3);
        }
        else
        {
          ((awzf)localObject2).c("30");
          ((awzf)localObject2).b(20);
          localObject2 = ((awzf)localObject2).a(paramContext, null, paramBundle);
          ...
          {
            localObject3 = (awwo)localObject2;
            localObject2 = ((awwo)localObject3).a(paramContext, null, true, paramBundle);
            RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(aciy.a(40.0F, localResources), aciy.a(40.0F, localResources));
            if ((((awwo)localObject3).c != null) && (!((awwo)localObject3).c.equals("")))
            {
            ...
            else
            {
              ...
              if (paramView != null)
              {
                paramContext = new RelativeLayout.LayoutParams(aciy.a(40.0F, localResources), aciy.a(40.0F, localResources));
                if (((RelativeLayout)localObject1).findViewById(6) != null)
                {
                  paramContext.addRule(0, 6);
                  paramContext.rightMargin = aciy.a(7.5F, localResources);
              ...
              for (;;)
              {
                ...
                a((View)localObject1);
                i = aciy.a(22.5F, localResources);
                j = aciy.a(22.5F, localResources);
                ((RelativeLayout)localObject1).setPadding(i, aciy.a(10.75F, localResources), j, aciy.a(11.75F, localResources));
                return localObject1;
