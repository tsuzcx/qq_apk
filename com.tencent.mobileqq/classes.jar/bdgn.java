...
public class bdgn
{
  ...
  {
    if (paramQQAppInterface != null) {
      return ((behu)paramQQAppInterface.getManager(289)).a();
    }
    return 0L;
  }
  
  public static bdho a(String paramString)
  {
    bdho localbdho = new bdho();
    try
    {
      paramString = new JSONObject(paramString);
      localbdho.jdField_a_of_type_JavaLangString = paramString.optString("creatorId");
      localbdho.jdField_a_of_type_Long = paramString.optLong("mtime");
      localbdho.jdField_b_of_type_JavaLangString = paramString.optString("padId");
      return localbdho;
    }
  ...
  {
    paramActivity = bfur.a(paramActivity, amtj.a(2131719700), 2131719668, 2131719706, paramOnClickListener2, paramOnClickListener1);
    if ((paramActivity != null) && (!paramActivity.isShowing())) {
      paramActivity.show();
    }
  }
  
  public static void a(Context paramContext, String paramString1, String paramString2, bdgq parambdgq)
  {
    ...
    paramContext.setNegativeButton(paramString2, new bdgp(paramContext, parambdgq));
    ...
    bfpm.a(paramContext, true);
  }
  
  public static void a(BaseActivity paramBaseActivity, bdgq parambdgq)
  {
    Resources localResources = paramBaseActivity.getResources();
    paramBaseActivity = bfur.a(paramBaseActivity, localResources.getString(2131719721), localResources.getString(2131719709), localResources.getString(2131719713), new bdgo(parambdgq));
  ...
  public static boolean a(bdee parambdee)
  {
    if ((parambdee == null) || (TextUtils.isEmpty(parambdee.jdField_a_of_type_JavaLangString))) {}
    while (parambdee.jdField_a_of_type_JavaLangString.length() <= a()) {
      return false;
    }
    return true;
  }
