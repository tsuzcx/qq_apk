  ...
  implements View.OnClickListener, View.OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener
{
  ...
  private final vsv jdField_a_of_type_Vsv = new vsv(this, null);
  private vsw jdField_a_of_type_Vsw;
  ...
  public vst(View paramView)
  {
    super(paramView);
    this.jdField_a_of_type_AndroidContentContext = paramView.getContext();
    this.jdField_a_of_type_AndroidWidgetHorizontalScrollView = ((HorizontalScrollView)a(2131368363));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)a(2131370352));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131370778));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131370779));
    this.c = ((TextView)a(2131370780));
    this.d = ((TextView)a(2131370781));
  ...
  public void a(int paramInt, String paramString, Object paramObject)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablePadding(vnc.jdField_b_of_type_Int);
    ...
    this.c.setCompoundDrawablePadding(vnc.jdField_b_of_type_Int);
  ...
  public void b(int paramInt, String paramString, Object paramObject)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setCompoundDrawablePadding(vnc.jdField_b_of_type_Int);
    ...
    this.d.setCompoundDrawablePadding(vnc.jdField_b_of_type_Int);
  ...
  public void c()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(this.jdField_a_of_type_Vsv);
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(this.jdField_a_of_type_Vsv);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Vsw.a(paramView.getTag());
        continue;
        if (this.jdField_a_of_type_Vsw != null) {
          this.jdField_a_of_type_Vsw.b(paramView.getTag());
        }
      }
    }
  }
  ...
  public void onGlobalLayout()
  {
    ...
    vmp.a("WSMarqueeDirector", "onGlobalLayout: ");
