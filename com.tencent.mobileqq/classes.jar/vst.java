  ...
  implements DownCallBack
{
  ...
  public vst(MultiForwardChatPie paramMultiForwardChatPie, long paramLong)
  {
  ...
  public void a(DownCallBack.DownResult paramDownResult)
  {
    ...
    do
    {
      ...
      localMultiForwardChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.runOnUiThread(new vsu(this, localMultiForwardChatPie, paramDownResult));
      return;
      if (QLog.isColorLevel()) {
    ...
    localMultiForwardChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.runOnUiThread(new vsv(this, localMultiForwardChatPie));
  }
}
