...
public class akkz
  implements akld, aklm, Handler.Callback
{
  ...
  private volatile akky jdField_a_of_type_Akky;
  private volatile aklc jdField_a_of_type_Aklc;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajjy.a(2131634973);
    jdField_b_of_type_JavaLangString = ajjy.a(2131634974);
    jdField_c_of_type_JavaLangString = ajjy.a(2131634969);
    jdField_d_of_type_JavaLangString = ajjy.a(2131634970);
    jdField_e_of_type_JavaLangString = ajjy.a(2131634972);
    jdField_f_of_type_JavaLangString = ajjy.a(2131634976);
    jdField_g_of_type_JavaLangString = ajjy.a(2131634971);
    jdField_h_of_type_JavaLangString = ajjy.a(2131634975);
  }
  ...
  private boolean c()
  {
    return (a()) && (this.jdField_a_of_type_Akky.a());
  }
  ...
  private void d(int paramInt)
  {
    ...
    if (c())
    {
      ...
      {
        this.jdField_a_of_type_Aklc.a(0);
        this.jdField_a_of_type_Aklc.b();
      }
      if ((paramInt == 2) || (paramInt == 4) || (paramInt == 6) || (paramInt == 1) || (paramInt == 3))
      {
        this.jdField_a_of_type_Akky.a(false, true);
        this.m = paramInt;
    ...
    {
      return;
      this.jdField_a_of_type_Akky.a(false, false);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  private void e(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (!this.jdField_c_of_type_Boolean) {
        if (paramInt == 11) {
          akkv.a(jdField_a_of_type_JavaLangString, false);
        }
      }
      for (;;)
      {
  ...
  private void j()
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Akky != null) && (this.jdField_a_of_type_Akky.a())) {
        this.jdField_a_of_type_Akky.a(false, true);
      }
    } while (this.jdField_a_of_type_Aklc == null);
    this.jdField_a_of_type_Aklc.b();
  }
  ...
  private void l()
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((this.m == -1) && (this.jdField_a_of_type_Akky != null)) {
        this.jdField_a_of_type_Akky.a(false, false);
      }
    }
  }
  ...
  private void n()
  {
    ...
    if ((this.jdField_a_of_type_Akky == null) || (this.jdField_a_of_type_Aklc == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (this.jdField_a_of_type_Aklc.a() != 0) {
            break label145;
          }
          if (!akkv.a(104857600L))
          {
            akkv.a(jdField_c_of_type_JavaLangString, jdField_d_of_type_JavaLangString);
            return;
          }
          if (this.jdField_a_of_type_Akky.a(true, null)) {
            break;
          }
          akkv.a(jdField_a_of_type_JavaLangString, false);
        } while (!QLog.isColorLevel());
        ...
        return;
        a("0X8008A54");
        this.jdField_a_of_type_Aklc.a(1);
      } while (!QLog.isColorLevel());
      QLog.i("ARVideoRecordUIControllerImpl", 2, "startVideoRecord end");
      return;
      if (c())
      {
        this.jdField_a_of_type_Akky.a(true, true);
        this.m = 7;
        this.jdField_d_of_type_Boolean = true;
        a("0X8008A55");
        if (QLog.isColorLevel()) {
  ...
  public void a(Object paramObject)
  {
    ...
    do
    {
      ...
      {
        this.jdField_a_of_type_Aklc = ((aklc)paramObject);
        this.jdField_a_of_type_Aklc.a(this);
        return;
      }
    } while (!(paramObject instanceof akky));
    this.jdField_a_of_type_Akky = ((akky)paramObject);
    this.jdField_a_of_type_Akky.a(this);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      return;
      this.jdField_a_of_type_Aklc = null;
      this.jdField_a_of_type_Akky = null;
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Akky != null) && (this.jdField_a_of_type_Akky.b());
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Akky != null) && (this.jdField_a_of_type_Akky.b()) && (!this.jdField_a_of_type_Akky.a());
  }
  ...
  public void d()
  {
    ...
    if ((!this.jdField_e_of_type_Boolean) || (!this.jdField_f_of_type_Boolean)) {}
    while (this.jdField_a_of_type_Akky == null) {
      return;
    }
    this.jdField_a_of_type_Akky.a(System.currentTimeMillis());
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (int n = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.RECORD_AUDIO");; n = 0)
    {
      ...
      ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).requestPermissions(new akla(this), 1, new String[] { "android.permission.RECORD_AUDIO" });
      return true;
      ...
      e(paramMessage.arg1);
      return true;
      if (((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.RECORD_AUDIO") != 0)
      {
      ...
      this.jdField_a_of_type_Akky.a(false, null);
      return true;
      if (this.jdField_a_of_type_Akky == null) {
        break;
      }
