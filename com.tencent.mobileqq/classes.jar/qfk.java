  ...
  implements View.OnTouchListener
{
  ...
  public qfk(Context paramContext, int paramInt)
  {
  ...
  private Drawable a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (localFile.exists())
      {
        ...
        localURLDrawableOptions.mPlayGifImage = auoy.a(paramString);
        ...
        localURLDrawableOptions.mRequestWidth = bbkx.b(114.0F);
        localURLDrawableOptions.mRequestHeight = bbkx.b(114.0F);
  ...
  public void a(qfn paramqfn)
  {
    this.jdField_a_of_type_Qfn = paramqfn;
  }
  
  public void a(qfo paramqfo)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup = new qfm(this, null);
      paramViewGroup.a = ((ImageView)paramView.findViewById(2131378560));
      paramViewGroup.b = ((ImageView)paramView.findViewById(2131378557));
    ...
    for (;;)
    {
      ...
      paramViewGroup.a.setOnClickListener(new qfl(this));
      return paramView;
      paramViewGroup = (qfm)paramView.getTag();
      break;
      label177:
      if ("".equals(localObject))
      {
        paramViewGroup.b.setImageResource(2130841281);
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    if (this.jdField_a_of_type_Qfo != null) {
      return this.jdField_a_of_type_Qfo.a(paramView, paramMotionEvent);
    }
    return false;
  }
}
