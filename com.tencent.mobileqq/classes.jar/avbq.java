  ...
  extends Handler
{
  ...
  public avbq(QQMusicPlayService paramQQMusicPlayService, Looper paramLooper)
  {
    super(paramLooper);
    ...
    do
    {
      do
      {
        do
        {
                    ...
                    do
                    {
                          ...
                          do
                          {
                            do
                            {
                              ...
                              do
                              {
                                ...
                                localavbt = (avbt)paramMessage.obj;
                              } while (localavbt == null);
                              ...
                              for (paramMessage = "null";; paramMessage = QQMusicPlayService.b().a())
                              {
                                ...
                                {
                                  localavbt.a.release();
                                  if (QQMusicPlayService.a() == localavbt.a) {
                      ...
                      if ((paramMessage.equals(QQMusicPlayService.b())) && ((QQMusicPlayService.f() == 2) || (QQMusicPlayService.f() == 1)))
                      {
                        ...
                        for (i = -1;; i = Math.abs(m - paramMessage.a()))
                        {
                          ...
                          avbo.a(i, NetworkUtil.getNetworkType((Context)localObject));
                          return;
                        }
                      }
                      if (QQMusicPlayService.a().isPlaying())
                      {
                        ...
                        avbo.b(QQMusicPlayService.b(), QQMusicPlayService.e());
                      }
          ...
          } while (!NetworkUtil.isNetworkAvailable(((QQMusicPlayService)localObject).getApplicationContext()));
          if (QLog.isColorLevel()) {
