...
{
  public aoda(PoiListLayout paramPoiListLayout) {}
  ...
  public boolean a(int paramInt, View paramView, ListView paramListView)
  {
    ...
    if (this.a.a == 0L)
    {
      ...
      new Handler(Looper.getMainLooper()).postDelayed(new aodb(this), 300L);
    }
    for (;;)
    {
      ...
      break;
      label114:
      new Handler(Looper.getMainLooper()).postDelayed(new aodc(this), 300L);
    }
  }
