  ...
  public void a(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localExtensionInfo = localajjj.a(paramString, true);
        bool1 = localajjj.a(false);
      } while ((bool1) || (localExtensionInfo == null));
      i = ascd.a(6, paramString, localExtensionInfo, bool1);
      j = ascd.a(5, paramString, localExtensionInfo, bool1);
      l1 = localExtensionInfo.lastFriendshipTime;
      l2 = localExtensionInfo.lastChatTime;
      int k = ascd.b();
      bool1 = ascd.a(k, l2 * 1000L);
      bool2 = ascd.a(k, l1 * 1000L);
    ...
    if (baiu.c(l2) == 2131654440)
    {
      bool1 = true;
      label279:
      if (baiu.c(l3) != 2131654440) {
        break label507;
      }
      bool2 = true;
      label292:
