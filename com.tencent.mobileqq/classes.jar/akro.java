...
public class akro
{
  ...
  public static aktr a(int paramInt)
  {
    akua localakua = a();
    if (localakua == null) {
      return null;
  ...
  public static aktr a(int paramInt1, int paramInt2)
  {
    akua localakua = a();
    if (localakua == null) {
      return null;
    }
    return localakua.a(paramInt1, paramInt2);
  }
  
  public static aktr a(long paramLong)
  {
  ...
  public static akua a()
  {
    ...
    if ((localAppInterface instanceof CmGameAppInterface)) {
      return (akua)((CmGameAppInterface)localAppInterface).getManager(255);
    }
    return null;
  }
  
  public static akuf a(int paramInt)
  {
    aktr localaktr = a(paramInt);
    if (localaktr != null) {
      return localaktr.a();
    }
  ...
  public static akuf a(long paramLong)
  {
    aktr localaktr = b(paramLong);
    if (localaktr != null) {
      return localaktr.a();
  ...
  public static ApolloSurfaceView a()
  {
    ...
    {
      return null;
      localObject = ((akua)localObject).a();
    } while (localObject == null);
    return ((aktr)localObject).a();
  }
  ...
  public static void a(Activity paramActivity, Conversation paramConversation)
  {
    ...
    {
      return;
      localakji = (akji)a().getManager(153);
      if (a(null)) {
        localakji.k = true;
      }
    } while ((localakji == null) || (!localakji.j) || (paramActivity == null) || (!(paramActivity instanceof SplashActivity)) || (paramActivity.isFinishing()) || (!((SplashActivity)paramActivity).isResume()) || (paramConversation == null));
    if (FrameHelperActivity.b())
    {
      FrameHelperActivity.c(true);
      FrameHelperActivity.s();
    }
    a(paramConversation.b, localakji.a());
    localakji.j = false;
  ...
  public static void a(View paramView, String paramString)
  {
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        localTextView.setBackgroundResource(2130838486);
        localTextView.setPadding((int)(bdcb.jdField_a_of_type_Float * 7.0F), (int)(bdcb.jdField_a_of_type_Float * 7.0F), (int)(bdcb.jdField_a_of_type_Float * 7.0F), 0);
        ...
        int i = (int)((float)bdcb.k() - bdcb.jdField_a_of_type_Float * 7.0F - localTextView.getMeasuredWidth());
        int j = (int)(localRect.bottom - 6.0F * bdcb.jdField_a_of_type_Float);
  ...
  public static void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, int paramInt3, long paramLong, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("sqVersion", "8.3.3.4515");
      ...
      paramJSONObject = new NewIntent(paramAppInterface.getApp(), akns.class);
      ...
      paramJSONObject.setObserver(new akrp());
  ...
  public static void a(CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    else
    {
      ...
      if ((paramStartCheckParam.mStartType == 2) || (paramStartCheckParam.mStartType == 1) || (paramStartCheckParam.mStartType == 3))
      {
        ...
        if (localList != null)
        {
          ...
          if (i < localList.size())
          {
            localObject3 = (akud)localList.get(i);
            if ((localObject3 == null) || (((akud)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam == null)) {
              break label713;
            }
            localObject1 = localakua.a(((akud)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
            if (localObject1 == null) {
              break label713;
            }
            localObject4 = ((aktr)localObject1).a();
            if ((((aktr)localObject1).a() != paramStartCheckParam.gameId) || ((paramStartCheckParam.roomId != 0L) && (paramStartCheckParam.roomId != ((aliq)localObject4).jdField_a_of_type_Long))) {
              break label713;
            }
            if (((aktr)localObject1).a() == null) {
              break label1490;
            }
          }
        }
    ...
    label849:
    label1490:
    for (localObject1 = ((aktr)localObject1).a().getClass();; localObject1 = null)
    {
      QLog.i("cmgame_process.CmGameUtil", 1, " launchGame found old task.mStartCheckParam:" + ((akud)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
      if (localObject1 == null)
      {
        if ((localList != null) && (localList.size() >= akua.jdField_a_of_type_ArrayOfJavaLangClass.length))
        {
          localObject2 = (akud)localList.get(0);
          if ((localObject2 != null) && (((akud)localObject2).jdField_a_of_type_JavaLangRefWeakReference != null))
          {
            localObject3 = (Activity)((akud)localObject2).jdField_a_of_type_JavaLangRefWeakReference.get();
            if (localObject3 != null)
            {
              ((Activity)localObject3).finish();
              if (((akud)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
              {
                aktg.a("cs.close_room.local", "{}", false, null, ((akud)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                QLog.i("cmgame_process.CmGameUtil", 1, " launchGame close old  task.mStartCheckParam.gameId:" + ((akud)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
              }
            }
          }
          localakua.jdField_a_of_type_JavaUtilList.remove(0);
        }
        localObject2 = new HashMap();
        i = 0;
        for (;;)
        {
          if (i < localakua.jdField_a_of_type_JavaUtilList.size())
          {
            localObject3 = (akud)localakua.jdField_a_of_type_JavaUtilList.get(i);
            if ((localObject3 != null) && (((akud)localObject3).jdField_a_of_type_JavaLangString != null)) {
              ((HashMap)localObject2).put(((akud)localObject3).jdField_a_of_type_JavaLangString, ((akud)localObject3).jdField_a_of_type_JavaLangString);
            }
            i += 1;
            continue;
            i += 1;
        ...
        i = 0;
        if (i >= akua.jdField_a_of_type_ArrayOfJavaLangClass.length) {
          break label1483;
        }
        if (TextUtils.isEmpty((String)((HashMap)localObject2).get(akua.jdField_a_of_type_ArrayOfJavaLangClass[i].getSimpleName())))
        {
          localObject2 = akua.jdField_a_of_type_ArrayOfJavaLangClass[i];
      ...
      for (;;)
      {
        ...
        {
          localObject1 = akua.jdField_a_of_type_ArrayOfJavaLangClass[0];
          QLog.e("cmgame_process.CmGameUtil", 1, "can not find activityClass, use first class");
        }
        localObject2 = new akud();
        ((akud)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        ((akud)localObject2).jdField_a_of_type_JavaLangString = ((Class)localObject1).getSimpleName();
        localakua.jdField_a_of_type_JavaUtilList.add(localObject2);
        for (;;)
        {
          if (QLog.isColorLevel())
          {
            localObject2 = localakua.jdField_a_of_type_JavaUtilList.iterator();
            for (;;)
            {
              if (((Iterator)localObject2).hasNext())
              {
                localObject3 = (akud)((Iterator)localObject2).next();
                QLog.d("cmgame_process.CmGameUtil", 2, "launchGame task:" + ((akud)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                continue;
                i += 1;
                break;
                ...
                while (i < localList.size())
                {
                  ...
                  {
                    localObject3 = localObject1;
                    if (localakud.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
                    {
                      localObject3 = localakua.a(localakud.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                      boolean bool1 = bool2;
                      localObject2 = localObject1;
                      if (localObject3 != null)
                      {
                        aliq localaliq = ((aktr)localObject3).a();
                        bool1 = bool2;
                        localObject2 = localObject1;
                        if (((aktr)localObject3).a() == paramStartCheckParam.gameId) {
                          if (paramStartCheckParam.roomId != 0L)
                          {
                            bool1 = bool2;
                            localObject2 = localObject1;
                            if (paramStartCheckParam.roomId != localaliq.jdField_a_of_type_Long) {}
                          }
                          else
                          {
                            bool2 = true;
                            bool1 = bool2;
                            localObject2 = localObject1;
                            if (((aktr)localObject3).a() != null)
                            {
                              localObject2 = ((aktr)localObject3).a().getClass();
                              bool1 = bool2;
                            }
                          }
                        }
                      ...
                      if (!bool1)
                      {
                        ...
                        {
                          localObject1 = (Activity)localakud.jdField_a_of_type_JavaLangRefWeakReference.get();
                          if (localObject1 != null)
                          {
                            ((Activity)localObject1).finish();
                            if (localakud.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) {
                              aktg.a("cs.close_room.local", "{}", false, null, localakud.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                            }
                            QLog.i("cmgame_process.CmGameUtil", 1, " launchGame close old  task.mStartCheckParam.gameId:" + localakud.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                          }
                        }
                        ((List)localObject4).add(localakud);
                        localObject3 = localObject2;
                      }
                    }
                  }
        ...
        for (;;)
        {
          ...
          localObject2 = akua.jdField_a_of_type_ArrayOfJavaLangClass[0];
          break;
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      localakva = a();
    } while (localakva == null);
    localakva.a(paramString1, paramString2, -1L, 4, false, null);
  }
  ...
  public static void a(Object... paramVarArgs)
  {
    akoe localakoe = a();
    if (localakoe != null) {
      localakoe.a("cmg_launch", 4, paramVarArgs);
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    ApolloGameData localApolloGameData = ((aleh)localObject).a(paramStartCheckParam.gameId);
    akji localakji = (akji)paramQQAppInterface.getManager(153);
    if (localakji != null)
    {
      paramStartCheckParam.game = localApolloGameData;
      if ((localApolloGameData != null) && ((((aleh)localObject).a(paramStartCheckParam.gameId)) || (paramStartCheckParam.isRequestConf))) {
        break label244;
      }
    }
    label244:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramStartCheckParam.isWhiteUsr = localakji.c((String)localObject);
      paramStartCheckParam.apolloStatus = localakji.b((String)localObject);
      paramStartCheckParam.pushItem = localakji.a().a();
      ...
      paramStartCheckParam.gender = ((auqc)paramQQAppInterface.getManager(106)).b();
      paramStartCheckParam.isEnableMSAA = c(paramStartCheckParam.gameId);
      paramStartCheckParam.mIsTransGame = alee.c.contains(Integer.valueOf(paramStartCheckParam.gameId));
      return true;
    }
  }
  ...
  public static int b()
  {
    ...
    akji localakji = (akji)a().getManager(153);
    if ((localakji != null) && (localakji.j())) {
      return 1;
    }
    return 0;
  }
  ...
  public static int b(int paramInt)
  {
    try
    {
      ...
      ((StringBuilder)localObject).append(alef.s).append(paramInt).append(File.separator).append("gameConfig.json");
      ...
      localObject = new JSONObject(bdcs.b((File)localObject)).optJSONArray("subpackages");
      if (localObject != null)
      {
  ...
  public static aktr b(int paramInt1, int paramInt2)
  {
    akua localakua = a();
    if (localakua == null) {
      return null;
    }
    return localakua.b(paramInt1, paramInt2);
  }
  
  public static aktr b(long paramLong)
  {
    akua localakua = a();
    if (localakua == null) {
      return null;
    }
    return localakua.a(paramLong);
  }
  ...
  public static String b(CmGameInitParams paramCmGameInitParams)
  {
    ...
    for (;;)
    {
      try
      {
        localJSONObject1 = alep.a(0, akzg.a);
        ...
        if (("1".equals(paramCmGameInitParams.mGameName)) || ("2".equals(paramCmGameInitParams.mGameName)))
        {
          ...
          if ((!ApolloGameStateMachine.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.getAndSet(false)) || (ApolloGameStateMachine.jdField_a_of_type_Akpo == null)) {
            break label999;
          }
          localJSONObject1.put("freeMemory", ApolloGameStateMachine.jdField_a_of_type_Akpo.jdField_b_of_type_Long);
          localJSONObject1.put("totalMemory", ApolloGameStateMachine.jdField_a_of_type_Akpo.jdField_c_of_type_Long);
          localJSONObject1.put("osVersion", akpo.jdField_a_of_type_JavaLangString);
          localJSONObject1.put("model", akpo.jdField_b_of_type_JavaLangString);
          localJSONObject1.put("cpuType", akpo.jdField_c_of_type_JavaLangString);
          localJSONObject1.put("cpuNumber", akpo.jdField_a_of_type_Int);
          localJSONObject1.put("cpuFrequency", akpo.jdField_a_of_type_Long);
          localJSONObject1.put("gameVersion", paramCmGameInitParams.mVersion);
          localJSONObject1.put("QQVer", "8.3.3.4515");
      ...
      localJSONObject1.put("connType", bdee.a(BaseApplicationImpl.getContext()));
      ...
      continue;
      label999:
      localJSONObject1.put("freeMemory", bdcb.a(Process.myPid()));
      localJSONObject1.put("totalMemory", bdcb.f());
      localJSONObject1.put("osVersion", bdcb.e());
      localJSONObject1.put("model", bdcb.i());
      localJSONObject1.put("cpuType", bdcb.g());
      localJSONObject1.put("cpuNumber", bdcb.b());
      localJSONObject1.put("cpuFrequency", bdcb.a());
    }
  }
  ...
  public static void b()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localObject = (akji)a().getManager(153);
        if ((localObject != null) && (((akji)localObject).k())) {
          ((akji)localObject).a().b();
        }
        i = a();
      } while (-1 == i);
      localObject = akrg.a().a(i);
    } while (localObject == null);
    ((aktw)localObject).c();
  }
  ...
  public static void b(int paramInt)
  {
    try
    {
      ...
      ((bdpx)a().getBusinessHandler(71)).a("apollo_router_game.game_extend_linkcmd_set_plus_flag", localJSONObject.toString(), -1L, 0);
      return;
    }
    catch (Exception localException) {}
  }
  ...
  public static boolean c(int paramInt)
  {
    ...
    try
    {
      ...
      int i = new JSONObject(bdcs.b((File)localObject)).optInt("enableMSAA");
  ...
  public static int e()
  {
    ...
    if (jdField_a_of_type_Float < 0.0F) {
      jdField_a_of_type_Float = (float)bdcb.a() / 1.0F / 1024.0F;
    }
    if (d < 0L) {
      d = Math.ceil(bdcb.d() / 1073741824.0D);
    }
    if (QLog.isColorLevel()) {
