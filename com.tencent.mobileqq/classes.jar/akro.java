...
{
  akro(akrn paramakrn, JSONObject paramJSONObject, List paramList, TracePathData paramTracePathData, SharedPreferences paramSharedPreferences, QQSportsOrbit.OrbitReq paramOrbitReq) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    akrn.a(this.jdField_a_of_type_Akrn, paramBoolean, paramInt);
    int i;
    if (paramBoolean)
    {
      try
      {
        ...
        try
        {
          ...
          if ((paramInt == -1) || (paramBundle.retCode.get() != 0))
          {
            ...
            if (this.jdField_a_of_type_Akrn.a.a == null) {
              break label802;
            }
            paramBundle = Message.obtain();
            paramBundle.what = 1;
            paramBundle.obj = this.jdField_a_of_type_OrgJsonJSONObject;
            this.jdField_a_of_type_Akrn.a.a.sendMessage(paramBundle);
            return;
          }
        }
        ...
        if (paramInt >= this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          this.jdField_a_of_type_Akrn.a.a(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqVashealthTracePathData.startTime));
          QLog.d("PathTraceManager", 1, "upload success");
          PathTraceManager.a(this.jdField_a_of_type_Akrn.a, null);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          paramBundle.putExtra("extra_cmd", akrn.a(this.jdField_a_of_type_Akrn));
        ...
        try
        {
          ...
          if (this.jdField_a_of_type_Akrn.a.a != null)
          {
            ...
            this.jdField_a_of_type_Akrn.a.a.sendMessage(localMessage);
            return;
          }
        }
        catch (Exception paramBundle)
