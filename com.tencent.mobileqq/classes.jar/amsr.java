  ...
  implements SensorEventListener
{
  ...
  public amsr(Context paramContext, long paramLong, int paramInt)
  {
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_AndroidHardwareSensorManager == null)
    {
      ...
      ampj.a().callbackFromRequest(this.jdField_a_of_type_Long, 1, "cs.xy_device_gyro_sensor_start.local", "{}");
      return;
    }
    ...
    if (localObject == null)
    {
      ...
      ampj.a().callbackFromRequest(this.jdField_a_of_type_Long, 2, "cs.xy_device_gyro_sensor_start.local", "{}");
      return;
    }
  ...
  public void onSensorChanged(SensorEvent paramSensorEvent)
  {
    try
    {
      ...
      ampj.a().callbackFromRequest(this.jdField_a_of_type_Long, 0, "cs.xy_device_gyro_sensor_scope_update.local", localJSONObject.toString());
      return;
    }
