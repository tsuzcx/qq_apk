...
public class xhc
{
  ...
  private static xhc jdField_a_of_type_Xhc;
  ...
  public static xhc a()
  {
    if (jdField_a_of_type_Xhc == null) {}
    try
    {
      if (jdField_a_of_type_Xhc == null) {
        jdField_a_of_type_Xhc = new xhc();
      }
      return jdField_a_of_type_Xhc;
    }
    finally {}
  }
  
  private void a(String paramString1, String paramString2, String paramString3, xhe paramxhe)
  {
    xhf localxhf = new xhf(0, "success");
    try
    {
      wak.b(this.jdField_a_of_type_AndroidContentContext, paramString1, paramString2, paramString3, new xhd(this, paramxhe, localxhf));
      return;
    }
    catch (FFmpegCommandAlreadyRunningException paramString1)
    {
      do
      {
        ...
        {
          localxhf.a(943004);
          localxhf.a(paramString1.getMessage());
          paramxhe.b(localxhf);
        }
  ...
  private void b(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, xhe paramxhe)
  {
    // Byte code:
    //   0: new 91	xhf
    //   3: dup
    //   4: iconst_0
    //   5: ldc 93
    //   7: invokespecial 96	xhf:<init>	(ILjava/lang/String;)V
    //   10: astore 19
    //   12: aconst_null
    //   13: astore 18
    ...
    //   41: iload 4
    //   43: iload 5
    //   45: invokestatic 152	baxi:a	(Ljava/io/InputStream;Landroid/graphics/Rect;II)Landroid/graphics/Bitmap;
    //   48: astore 18
    //   50: aload 16
    //   52: ifnull +16 -> 68
    //   55: iload 4
    ...
    //   120: iload 4
    //   122: iload 5
    //   124: invokestatic 159	baxi:a	(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    //   127: astore 17
    //   129: aload 17
    ...
    //   155: aload 19
    //   157: ldc 160
    //   159: invokevirtual 113	xhf:a	(I)V
    //   162: iload 4
    //   164: istore 11
    //   166: iload 5
    //   168: istore 13
    ...
    //   178: aload 19
    //   180: ldc 162
    //   182: invokevirtual 118	xhf:a	(Ljava/lang/String;)V
    //   185: iload 4
    //   187: istore 11
    //   189: iload 5
    //   191: istore 13
    ...
    //   356: aload 19
    //   358: ldc 160
    //   360: invokevirtual 113	xhf:a	(I)V
    //   363: aload 19
    //   365: ldc 162
    //   367: invokevirtual 118	xhf:a	(Ljava/lang/String;)V
    //   370: aload 8
    //   372: aload 19
    ...
    //   394: istore 14
    //   396: aload_1
    //   397: invokestatic 168	bbef:b	(Ljava/lang/String;)I
    //   400: istore 15
    //   402: aload 17
    //   404: astore_1
    //   405: iload 4
    ...
    //   615: iload 4
    //   617: iload 5
    //   619: invokestatic 198	avtq:a	()Lavtq;
    //   622: iconst_1
    //   623: invokevirtual 201	avtq:a	(I)I
    //   626: iconst_4
    //   627: imul
    //   628: sipush 1000
    //   631: imul
    ...
    //   644: iload 6
    //   646: iload 7
    //   648: invokespecial 213	xhk:<init>	(Ljava/lang/String;IIIJZI)V
    //   651: putfield 215	xhc:jdField_a_of_type_Xhk	Lxhk;
    //   654: aload_0
    //   655: getfield 215	xhc:jdField_a_of_type_Xhk	Lxhk;
    //   658: bipush 16
    //   660: invokevirtual 216	xhk:a	(I)V
    ...
    //   676: pop
    //   677: aload_0
    //   678: getfield 215	xhc:jdField_a_of_type_Xhk	Lxhk;
    //   681: aload_2
    //   682: aload 8
    //   684: invokevirtual 226	xhk:a	(Ljava/util/List;Lxhe;)V
    //   687: return
    //   688: astore 16
    //   690: goto -622 -> 68
    //   693: astore 16
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, xhe paramxhe)
  {
    xhf localxhf = new xhf(0, "success");
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString3)))
    {
      localxhf.a(940007);
      localxhf.a("Invalid argument");
      paramxhe.b(localxhf);
    }
    do
    {
      ...
      {
        localxhf.a(941003);
        localxhf.a("duration is 0");
        paramxhe.b(localxhf);
        return;
      }
      if (!apvd.b(paramString2)) {
        break;
      }
    } while (paramxhe == null);
    localxhf.a(0);
    ...
    {
      ThreadManager.newFreeThread(new VideoStoryPicToVideo.1(this, paramString1, paramString2, paramString3, paramInt1, paramInt2, paramBoolean, paramInt3, paramxhe), "videoStoryPicToVideo", 5).start();
      return;
    }
    a(paramString1, paramString2, paramString3, paramxhe);
  }
}
