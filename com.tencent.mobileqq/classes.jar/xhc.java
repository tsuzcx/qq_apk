  ...
  extends MSFServlet
{
  ...
  private void a(VSBaseRequest paramVSBaseRequest)
  {
    ...
    {
      veg.b("VSNetworkHelper| Protocol Cache", "start to response cache");
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg != null) {
      try
      {
        ...
        notifyObserver(paramIntent, paramFromServiceMsg.getServiceCmd().hashCode(), paramFromServiceMsg.isSuccess(), localBundle, xgw.class);
        return;
      }
      catch (Throwable paramFromServiceMsg)
      {
        QLog.e("VSNetworkHelper", 2, new Object[] { Integer.valueOf(1), paramFromServiceMsg + "onReceive error" });
        notifyObserver(paramIntent, localVSBaseRequest.getCmdName().hashCode(), false, localBundle, xgw.class);
        return;
      }
    }
