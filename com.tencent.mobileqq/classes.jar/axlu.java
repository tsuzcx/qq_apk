...
public class axlu
{
  Handler jdField_a_of_type_AndroidOsHandler = new axlw(this, Looper.getMainLooper());
  axmd jdField_a_of_type_Axmd;
  axmg jdField_a_of_type_Axmg = new axlv(this);
  private WeakReference<Activity> jdField_a_of_type_JavaLangRefWeakReference;
  ArrayList<axlx> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  AppRuntime jdField_a_of_type_MqqAppAppRuntime;
  
  public axlu(AppRuntime paramAppRuntime)
  {
    this.jdField_a_of_type_MqqAppAppRuntime = paramAppRuntime;
    this.jdField_a_of_type_Axmd = ((axmd)paramAppRuntime.getManager(185));
  }
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    {
      axlx localaxlx = (axlx)localIterator.next();
      if (1 == paramInt) {
        localaxlx.b(paramBundle);
      } else if (-2 == paramInt) {
        localaxlx.a(paramBundle);
      }
    }
  }
  ...
  public void a(axlx paramaxlx, boolean paramBoolean)
  {
    if (paramaxlx != null)
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramaxlx);
      if (paramBoolean) {
        this.jdField_a_of_type_JavaUtilArrayList.add(paramaxlx);
      }
    }
  }
  ...
  public void b()
  {
    this.jdField_a_of_type_Axmd.c();
    if ((this.jdField_a_of_type_MqqAppAppRuntime instanceof QQAppInterface)) {
      ((awnq)((QQAppInterface)this.jdField_a_of_type_MqqAppAppRuntime).a(154)).b();
    }
  }
  ...
  public boolean b()
  {
    ...
    if (!bool1) {
      ...
      {
        localObject = "2920";
        awqx.b((QQAppInterface)this.jdField_a_of_type_MqqAppAppRuntime, "CliOper", "", "", "Setting_tab", "Night_mode", 0, 0, "1", "", "", "");
    ...
    for (;;)
    {
      ...
      ThemeSwitcher.a((String)localObject, "202", this.jdField_a_of_type_Axmg);
      return true;
      localObject = "1103";
      break;
      if (!bool2) {
    ...
    label187:
    Bundle localBundle = axmf.a((QQAppInterface)this.jdField_a_of_type_MqqAppAppRuntime);
    ...
    for (;;)
    {
      awqx.b((QQAppInterface)this.jdField_a_of_type_MqqAppAppRuntime, "CliOper", "", "", "Setting_tab", "Night_mode", 0, 0, "0", "", "", "");
      break;
      localObject = "1000";
    }
  }
