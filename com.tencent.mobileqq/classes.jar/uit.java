...
public class uit
{
  ...
  public static DownloadInfo a(String paramString)
  {
    ...
    try
    {
      ...
      for (int i = TMAssistantDownloadConst.SHOW_NOTIFICATION_TRUE;; i = TMAssistantDownloadConst.SHOW_NOTIFICATION_FALSE)
      {
        ...
        localDownloadInfo.m = pay.f(40677);
  ...
  public static void b(Context paramContext, String paramString)
  {
    ...
    if (a != null)
    {
      ...
      paramContext.setMessage(amtj.a(2131715234));
      paramContext.setNegativeButton(amtj.a(2131715222), new uiv()).setPositiveButton(amtj.a(2131715178), new uiu());
      paramContext.show();
      return;
    }
