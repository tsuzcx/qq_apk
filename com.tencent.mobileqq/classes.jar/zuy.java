...
public class zuy
  implements Runnable
{
  public zuy(DataLineMsgProxy paramDataLineMsgProxy, long paramLong, int paramInt, DataLineMsgProxy.LoadMoreAioMessageCb paramLoadMoreAioMessageCb) {}
  ...
  public void run()
  {
    ...
    new Handler(Looper.getMainLooper()).post(new zuz(this, localList));
  }
}
