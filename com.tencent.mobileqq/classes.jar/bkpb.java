  ...
  extends MiniAppProxy
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper(), new bkpi(this));
  private MiniAppConfig jdField_a_of_type_ComTencentMobileqqMiniApkgMiniAppConfig;
  private DownloadListener jdField_a_of_type_ComTencentOpenDownloadnewDownloadListener = new bkpg(this);
  ...
  private void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localBundle.putString(bjmy.jdField_b_of_type_JavaLangString, paramString1);
    localBundle.putString(bjmy.j, paramString4);
    localBundle.putString(bjmy.f, paramString2);
    localBundle.putInt(bjmy.k, 2);
    localBundle.putString(bjmy.i, "MiniApp");
    localBundle.putString(bjmy.l, paramString3);
    localBundle.putInt(bjmy.I, 1);
    bjmu.a(this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadListener);
    bjmu.a(paramActivity, localBundle, "biz_src_miniapp", null, 0);
  ...
  private void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    {
      bjhq.b(((BasePluginActivity)paramContext).getOutActivity(), localBundle);
    ...
    {
      bjhq.b((Activity)paramContext, localBundle);
      InnerAppReportDc4239.innerAppReport(this.jdField_a_of_type_ComTencentMobileqqMiniApkgMiniAppConfig, null, "launchapp", "downloadapp", "yybdownload");
      return;
    }
  ...
  {
    paramIMiniAppContext.performAction(new bkpj());
  ...
  private void a(IMiniAppContext paramIMiniAppContext, String paramString)
  {
    ...
    MiniAppConfig localMiniAppConfig = bkpw.a(paramIMiniAppContext.getMiniAppInfo());
  ...
  private void a(MiniAppInfo paramMiniAppInfo)
  {
    ...
    QIPCClientHelper.getInstance().callServer("MiniAppTransferModule", "sync_mini_app_data", localBundle, new bkpl(this, paramMiniAppInfo));
  }
  ...
  private void b(MiniAppInfo paramMiniAppInfo)
  {
    ...
    MiniAppCmdUtil.getInstance().setUserAppTop(paramMiniAppInfo.appId, paramMiniAppInfo.topType, paramMiniAppInfo.verType, null, new bkpm(this, paramMiniAppInfo));
  }
  ...
  private void c(IMiniAppContext paramIMiniAppContext)
  {
    ...
    ((IActivityResultManager)localObject).addActivityResultListener(new bkpk(this, (IActivityResultManager)localObject, paramIMiniAppContext));
  ...
  private void e(IMiniAppContext paramIMiniAppContext)
  {
    ...
    localObject = "https://tucao.qq.com/qq_miniprogram/tucao?appid=" + localMiniAppInfo.appId + "&openid=" + MainPageFragment.getUin() + "&avatar=" + paramIMiniAppContext + anvx.a(2131700850);
    ...
    paramIMiniAppContext = bkpw.a(localMiniAppInfo);
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      ((Intent)localObject2).putExtra("key_mini_app_config", bkpw.a((MiniAppInfo)localObject1));
      ...
      ((Intent)localObject2).putExtra("showFavorite", true);
      ...
      ((IActivityResultManager)localObject1).addActivityResultListener(new bkpp(this, (IActivityResultManager)localObject1));
      ...
      if ((localObject2 instanceof bkqp))
      {
        localObject2 = ((bkqp)localObject2).a();
        if ((!bool4) && (localObject2 != null))
        {
          i = a((aqnr)localObject2);
          continue;
  ...
  public void a(Context paramContext, String paramString)
  {
    ...
    TroopUtils.openTroopInfoActivity(paramContext, TroopInfoActivity.a(paramString, 5), 2);
  }
  
  public boolean addShortcut(Context paramContext, MiniAppInfo paramMiniAppInfo, AsyncResult paramAsyncResult)
  {
    bkrh.a((Activity)paramContext, paramMiniAppInfo, new bkpd(this, paramAsyncResult));
    return true;
  }
  ...
  public void b(IMiniAppContext paramIMiniAppContext)
  {
    ...
    QIPCClientHelper.getInstance().callServer("MiniAppTransferModule", "query_mini_app_data", localBundle, new bkpo(this, localMiniAppInfo));
  }
  ...
  public boolean chooseLocation(Context paramContext, AsyncResult paramAsyncResult)
  {
    ...
    localIActivityResultManager.addActivityResultListener(new bkpf(this, paramAsyncResult, localIActivityResultManager));
  ...
  public boolean downloadApp(Context paramContext, MiniAppInfo paramMiniAppInfo, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqMiniApkgMiniAppConfig = bkpw.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo);
  ...
  public boolean enterQRCode(Context paramContext, boolean paramBoolean, AsyncResult paramAsyncResult)
  {
    ...
    if (!alhp.a(localBaseActivity))
    {
      paramAsyncResult.onReceiveResult(false, null);
      return true;
    }
    paramContext = new Intent((BaseActivity)paramContext, ScannerActivity.class);
    paramContext.putExtra("leftViewText", localBaseActivity.getString(2131690676));
    paramContext.putExtra("selfSet_leftViewText", localBaseActivity.getString(2131690676));
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bkpc(this, paramAsyncResult);
  ...
  {
    IActivityResultManager localIActivityResultManager = AppLoaderFactory.g().getMiniAppEnv().getActivityResultManager();
    localIActivityResultManager.addActivityResultListener(new bkph(this, localIActivityResultManager, paramIAppUpdateListener));
  ...
  public boolean getLocation(Context paramContext, String paramString, boolean paramBoolean, AsyncResult paramAsyncResult)
  {
    ...
    {
      SosoInterface.startLocation(new bkpe(this, 0, true, true, 5000L, false, false, "miniApp", bool, paramBoolean, paramAsyncResult));
      return true;
    }
  }
  ...
  {
    bhcl.a(paramContext, paramBoolean);
  }
  ...
  public boolean openNativePage(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      return true;
      label44:
      if (paramString3.equals("public_account")) {
  ...
  public void setDrawableCallback(Drawable paramDrawable, MiniAppProxy.IDrawableLoadedCallBack paramIDrawableLoadedCallBack)
  {
    if ((paramDrawable != null) && ((paramDrawable instanceof URLDrawable))) {
      ((URLDrawable)paramDrawable).setURLDrawableListener(new bkpn(this, paramIDrawableLoadedCallBack));
    }
  }
