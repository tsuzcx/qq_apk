  ...
  extends qxr
{
  ...
  public nnu(nnt paramnnt, View paramView, BaseData paramBaseData)
  {
  ...
  {
    ViewFactory.findClickableViewListener(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer.getVirtualView(), new nnv(this, paramBaseData, paramContext));
  }
  ...
  private void a(Container paramContainer)
  {
    if (paramContainer != null)
    {
      ...
      if ((localViewBase2 != null) && ((localViewBase2 instanceof nrw))) {
        ((nrw)localViewBase2).a(null, true);
      }
      if (((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataProteusItemData instanceof AdData)) && (((AdData)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataProteusItemData).a != null) && (npa.a((AdData)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataProteusItemData)))
      {
        localViewBase1 = localViewBase1.findViewBaseByName("id_game_small_img");
        if ((localViewBase1 != null) && ((localViewBase1 instanceof pap)) && (!TextUtils.isEmpty(((AdData)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataProteusItemData).J)))
        {
          int i = aciy.a(40.0F, paramContainer.getContext().getResources());
          npa.a(paramContainer.getContext(), localViewBase1, ((AdData)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataProteusItemData).J, 10, i, i);
        }
      }
    }
  }
  ...
  public void a(ProteusBannerVideoItemData paramProteusBannerVideoItemData1, ProteusBannerVideoItemData paramProteusBannerVideoItemData2)
  {
    ...
    do
    {
      ...
      nas localnas = new nas();
      AdvertisementInfo localAdvertisementInfo = npk.a(paramProteusBannerVideoItemData1);
      localnas.e = paramProteusBannerVideoItemData1.l;
      localnas.d = paramProteusBannerVideoItemData1.w;
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInJoyArticleBottomVideoView.a(localnas, localAdvertisementInfo, paramProteusBannerVideoItemData1, paramProteusBannerVideoItemData2);
  ...
  public void a(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if ((paramBaseData1 != null) && (paramBaseData1.p == 17))
      {
        ...
        a(paramBaseData2, nnt.a(this.jdField_a_of_type_Nnt), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataProteusItemData.b);
