  ...
  extends auye
{
  ...
  private void a(int paramInt, List<FeedsProtocol.TopicCfg> paramList, FeedsProtocol.VideoItem paramVideoItem, ArrayList<VideoData> paramArrayList)
  {
    ...
    paramArrayList.add(auyu.a(paramList, localVideoData));
  ...
  public void a()
  {
    ...
    new auza(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_a_of_type_JavaLangString + "&num=" + 10, new auyl(this));
  }
  ...
  public void b()
  {
    ...
    new auza(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_a_of_type_JavaLangString + "&num=" + 10, new auyk(this));
  }
}
