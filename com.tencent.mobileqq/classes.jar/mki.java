  ...
  implements View.OnClickListener, View.OnTouchListener
{
  ...
  private int jdField_b_of_type_Int = 2131755805;
  ...
  public mki(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewWindowManager = ((WindowManager)paramContext.getSystemService("window"));
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131559597, null);
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener(this);
  }
  
  public TextView a()
  {
    return (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370647);
  }
  ...
  {
    ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365824)).setImageBitmap(paramBitmap);
  }
  
  public void a(Bitmap paramBitmap, String paramString)
  {
    ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365824)).setImageBitmap(paramBitmap);
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370647)).setText(paramString);
  }
  
  public void a(String paramString)
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369940));
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369940);
    Button localButton1 = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131361813);
    Button localButton2 = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131375093);
    ...
    if (paramBoolean3) {
      if (this.jdField_b_of_type_Boolean) {
        localTextView.setText(localTextView.getResources().getString(2131695661));
      }
    }
    for (;;)
    {
      ...
      return;
      localTextView.setText(localTextView.getResources().getString(2131695662));
      continue;
      if (this.jdField_b_of_type_Boolean) {
        localTextView.setText(localTextView.getResources().getString(2131695660));
      } else {
        localTextView.setText(localTextView.getResources().getString(2131695663));
      }
    }
  }
  ...
  void b()
  {
    ...
    for (;;)
    {
      ...
      {
        lcg.e("VideoInviteFloatBar", "startHandler error : " + localException2);
      }
  ...
  {
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131377301));
  ...
  public void c()
  {
    ...
    Button localButton = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131375093);
    ((Button)localObject).setVisibility(4);
    localButton.setVisibility(4);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
    localObject = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369940);
    this.jdField_a_of_type_AndroidViewView.invalidate();
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131361813: 
      ...
      for (;;)
      {
        ...
        ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131375093)).setClickable(false);
