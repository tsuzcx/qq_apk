  ...
  extends lfe
{
  ...
  protected void a(long paramLong, int paramInt, String paramString)
  {
    ...
    while ((this.a.jdField_a_of_type_ComTencentAvVideoController == null) || (this.a.jdField_a_of_type_Ley.j())) {
      return;
    }
  }
  ...
  protected void a(String paramString, Bitmap paramBitmap)
  {
    ...
    if ((this.a.jdField_b_of_type_Int == 25) && (this.a.jdField_a_of_type_Mkf != null)) {
      this.a.jdField_a_of_type_Mkf.a(paramBitmap);
    }
  ...
  protected void d(String paramString)
  {
    ...
    if (this.a.jdField_b_of_type_Int == 25)
    {
      ...
      if (this.a.jdField_a_of_type_Mkf != null) {
        this.a.jdField_a_of_type_Mkf.d(this.a.jdField_b_of_type_JavaLangString);
      }
    }
  }
}
