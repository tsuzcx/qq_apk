  ...
  implements Handler.Callback
{
  ...
  private HashMap<String, beft> jdField_a_of_type_JavaUtilHashMap;
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  public befs(QQAppInterface paramQQAppInterface)
  {
      ...
      try
      {
        ...
        if (i < j)
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject4))
          {
            ...
            localObject4 = new beft(this, localObject3[0], Integer.valueOf(localObject3[1]).intValue(), Integer.valueOf(localObject3[2]).intValue(), Long.valueOf(localObject3[3]).longValue(), Integer.valueOf(localObject3[4]).intValue());
            localHashMap2.put(localObject3[0], localObject4);
            if (QLog.isColorLevel()) {
              QLog.d("NCtr", 2, "LimitEntry:[" + ((beft)localObject4).toString() + "]");
            }
          }
  ...
  private void a(Context paramContext, String paramString)
  {
    ...
    {
      beft localbeft = (beft)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
      paramContext = paramContext.getSharedPreferences("config_prefile", 0).edit();
      paramContext.putString("extra_limit_entry_" + this.mApp.getAccount() + "_" + paramString, localbeft.toString());
      paramContext.apply();
    }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            l = a().longValue();
            localObject = (beft)((HashMap)localObject).get(paramString);
            if (QLog.isColorLevel()) {
              QLog.d("NCtr", 2, "todayBeginTime = " + new Date(l) + "----" + l + " ，entry.mBaseLineTime = " + new Date(((beft)localObject).jdField_a_of_type_Long) + "----" + ((beft)localObject).jdField_a_of_type_Long);
            }
            if (((beft)localObject).jdField_a_of_type_Long >= 1L) {
              continue;
            }
            if (((beft)localObject).b <= 0) {
              continue;
            }
            ((beft)localObject).jdField_a_of_type_Long = l;
            ((beft)localObject).c += 1;
            paramInt = 1;
            bool2 = bool1;
            if (paramInt != 0)
            {
      ...
      if (!bool2) {
        awqx.b(this.app, "dc00898", "", paramString, "0X8009995", "0X8009995", 0, 0, "" + System.currentTimeMillis(), "", "", "");
      }
      awqx.b(this.app, "dc00898", "", paramString, "0X8009996", "0X8009996", 0, 0, "" + System.currentTimeMillis(), "", "", "");
      if (QLog.isColorLevel()) {
      ...
      bool1 = false;
      continue;
      if ((int)((l - ((beft)localObject).jdField_a_of_type_Long) / 86400000L) >= ((beft)localObject).jdField_a_of_type_Int)
      {
        ((beft)localObject).jdField_a_of_type_Long = l;
        ((beft)localObject).c = 0;
        paramInt = 1;
        if ((((beft)localObject).b > 0) && (((beft)localObject).c < ((beft)localObject).b))
        {
          ((beft)localObject).c += 1;
          paramInt = 1;
        }
  ...
  public void b(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject3 = (beft)((HashMap)localObject1).get(paramString);
        ((HashMap)localObject1).remove(paramString);
        if ((j == ((beft)localObject3).jdField_a_of_type_Int) && (k == ((beft)localObject3).b))
        {
          localHashMap.put(paramString, localObject3);
          break label935;
        }
        localHashMap.put(paramString, new beft(this, paramString, j, k, 0L, 0));
        break label935;
      }
      localHashMap.put(paramString, new beft(this, paramString, j, k, 0L, 0));
      break label935;
    ...
    for (;;)
    {
      ...
      if (localHashMap.size() > 0)
      {
        ...
        {
          str = (String)((Iterator)localObject1).next();
          beft localbeft = (beft)localHashMap.get(str);
          ((SharedPreferences.Editor)localObject2).putString("extra_limit_entry_" + (String)localObject3 + "_" + str, localbeft.toString());
          paramString.append(str).append(",");
          if (QLog.isColorLevel()) {
            QLog.d("NCtr", 2, "LimitEntry:[" + localbeft.toString() + "]");
          }
        }
