  ...
  extends qsa
{
  ...
  static
  {
    jdField_a_of_type_Qsl = new qsl(null);
  }
  ...
  public void a(@Nullable String paramString, int paramInt1, int paramInt2, @Nullable qsc paramqsc)
  {
    RIJRedPacketManager.a().a(paramString, paramInt1, paramInt2, (qrg)new qsn(paramqsc));
  }
  
  public void a(@NotNull qsf paramqsf)
  {
    Intrinsics.checkParameterIsNotNull(paramqsf, "callback");
    RIJRedPacketManager.a().a(1, (qrh)new qso(paramqsf));
  }
  ...
  public String b()
  {
    ...
    localObject = ((RIJRedPacketManager)localObject).a();
  ...
  public boolean b(@NotNull String paramString)
  {
    ...
    if ((!bool) && (!this.jdField_a_of_type_Boolean))
    {
      ...
      RIJRedPacketManager.a().a(paramString, (qrf)new qsm(this, paramString));
    }
    return bool;
  }
