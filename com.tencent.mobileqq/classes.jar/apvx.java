  ...
  implements ark.ModuleCallbackWrapper
{
  ...
  private Map<String, Set<apzm>> jdField_a_of_type_JavaUtilMap = new HashMap();
  private long jdField_b_of_type_Long = 1L;
  public String b;
  private final HashMap<String, apwd> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  public String c;
  ...
  protected apvx(ark.Application paramApplication, long paramLong)
  {
  ...
  {
    return apxt.a(paramSessionInfo);
  }
  ...
  private void a()
  {
    ...
    if (arrayOfapwd != null)
    {
      int j = arrayOfapwd.length;
      int i = 0;
      while (i < j)
      {
        apwd localapwd = arrayOfapwd[i];
        this.jdField_b_of_type_JavaUtilHashMap.put(localapwd.a(), localapwd);
        i += 1;
      }
    }
  }
  ...
  private boolean a(apwd paramapwd)
  {
    if (paramapwd.a()) {}
  ...
  private boolean b(apwd paramapwd)
  {
    if (a()) {
      return true;
    }
  ...
  private boolean c(apwd paramapwd)
  {
    return apuj.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, paramapwd.b());
  }
  ...
  {
    paramString = (apwd)this.jdField_b_of_type_JavaUtilHashMap.get(paramString);
    if (paramString == null) {
      return false;
    }
    if (!a(paramString))
  ...
  {
    apwd localapwd = (apwd)this.jdField_b_of_type_JavaUtilHashMap.get(paramString);
    if (localapwd == null) {
      return false;
    }
    if (!a(paramString))
    ...
    if ((a()) || (localapwd.b()))
    {
      localapwd.a(this, paramArrayOfVariantWrapper, paramVariantWrapper);
      return true;
    }
    QLog.i("ArkApp.ArkAppModuleBase", 1, "Invoke, method not support multiprocess, method=" + localapwd);
    return false;
  }
  ...
  protected void a(String paramString, long paramLong1, long paramLong2)
  {
    if ((!TextUtils.isEmpty(paramString)) && (paramLong2 > 0L))
    {
      ...
      ((Set)localObject).add(new apzm(paramLong1, paramLong2));
    }
  }
  ...
  public void a(List<apzv> paramList)
  {
    if (paramList != null)
    {
      ...
      {
        apzv localapzv = (apzv)paramList.next();
        a(localapzv.jdField_a_of_type_JavaLangString, localapzv.jdField_a_of_type_Long, localapzv.jdField_b_of_type_Long);
      }
    }
  }
  ...
  protected boolean a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      {
        apzm localapzm = (apzm)((Iterator)localObject).next();
        if (!localapzm.a())
        {
          QLog.i("ArkApp", 2, String.format("ModuleBase.checkFrequency.Refuse:%s,%s ", new Object[] { paramString, localapzm.toString() }));
          return false;
        }
      }
      return true;
