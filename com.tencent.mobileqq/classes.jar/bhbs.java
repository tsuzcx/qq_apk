...
public class bhbs
{
  ...
  public bhbs()
  {
    this.jdField_a_of_type_Bhbu = new bhbu(this, null);
  }
  ...
  private void e()
  {
    if (this.jdField_a_of_type_AndroidAppActivity != null)
    {
      ...
      this.jdField_a_of_type_AndroidAppActivity.registerReceiver(this.jdField_a_of_type_Bhbu, localIntentFilter);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_AndroidAppActivity != null) {
      this.jdField_a_of_type_AndroidAppActivity.unregisterReceiver(this.jdField_a_of_type_Bhbu);
    }
  }
