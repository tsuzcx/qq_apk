...
public class bjiv
{
  private static bjiv jdField_a_of_type_Bjiv;
  private String jdField_a_of_type_JavaLangString;
  private ConcurrentLinkedQueue<bjiw> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue = new ConcurrentLinkedQueue();
  ...
  public static bjiv a()
  {
    try
    {
      if (jdField_a_of_type_Bjiv == null) {
        jdField_a_of_type_Bjiv = new bjiv();
      }
      bjiv localbjiv = jdField_a_of_type_Bjiv;
      return localbjiv;
    }
    finally {}
  }
  ...
  private String a(String paramString)
  {
    try
    {
      ...
      if (localFile.exists())
      {
        ...
        paramString = blgk.a(paramString);
        return paramString;
      }
    }
  ...
  private String b(PackageInfo paramPackageInfo)
  {
    ...
    return bleb.a(paramPackageInfo);
  }
  ...
  private void c()
  {
    ...
    try
    {
      ...
      localSharedInfoPacket.qq_version.set(a("8.4.5"));
      if (QLog.isColorLevel()) {
        QLog.d("SecShare.AV", 2, String.format("Version = %s intVersion= 0x%x", new Object[] { "8.4.5", Integer.valueOf(a("8.4.5")) }));
      }
      if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.isEmpty()) {
        break label561;
      }
      localSendInfo = new SecSharedInfo.SendInfo();
      localObject1 = (bjiw)this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.poll();
      i = ((bjiw)localObject1).a();
      localObject3 = ((bjiw)localObject1).a();
      str3 = ((bjiw)localObject1).b();
      j = ((bjiw)localObject1).b();
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          localObject2 = blev.a((String)localObject3);
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.offer(new bjiw(paramInt1, paramString1, paramInt2, paramString2));
  }
