...
public class wvh
  extends AsyncTask<wvj, wvl, wvk>
{
  public final wke a;
  
  public wvh(wke paramwke)
  {
    if (paramwke == null) {
  ...
  public static String a(String paramString)
  {
    ...
    //   57: ldc 50
    //   59: ldc 52
    //   61: invokestatic 57	yuk:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   64: aload_3
    //   65: astore_0
    //   66: aload_2
    //   67: ifnull +9 -> 76
    ...
    //   85: invokestatic 67	wvh:a	([B)Ljava/lang/String;
    //   88: astore 4
    //   90: aload 4
    //   92: astore_3
    //   93: aload_3
  ...
  {
    yuk.b("FileDownloadTask", paramString);
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    yuk.b("FileDownloadTask", "expectedMd5 = " + paramString2);
    yuk.b("FileDownloadTask", "file Md5    = " + paramString1);
  ...
  protected wvk a(wvj... paramVarArgs)
  {
    ...
    if (a(paramVarArgs.b, paramVarArgs.c))
    {
      ...
      return new wvk(paramVarArgs, 0, "has local file already");
    }
    this.a.a(new wvi(this, paramVarArgs));
    ...
    if ((i == 0) && (!a(paramVarArgs.b, paramVarArgs.c)))
    {
      ...
      try
      {
        zom.d(paramVarArgs.b);
        return new wvk(paramVarArgs, -1, "file md5 mismatch");
      }
    ...
    return new wvk(paramVarArgs, i, "error=" + i);
  }
}
