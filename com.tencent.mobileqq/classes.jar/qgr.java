...
public class qgr
{
  private static Pattern a = Pattern.compile(bbff.c.pattern() + "|" + bbff.d.pattern(), 2);
  ...
  private static int a(Spannable paramSpannable, int paramInt1, int paramInt2)
  {
    ...
    while (localMatcher.find())
    {
      ...
      paramInt2 += 1;
      paramSpannable.setSpan(new rrg(str), i, j, 0);
    }
    return paramInt2;
  }
  ...
  public static boolean a(Spannable paramSpannable)
  {
    ...
    {
      return false;
      if (bbff.b.matcher(paramSpannable).find())
      {
        Object localObject = (rrg[])paramSpannable.getSpans(0, m, rrg.class);
        int j;
        int n;
        int i;
        ...
        int k = 0;
        localObject = (rre[])paramSpannable.getSpans(0, m, rre.class);
        if ((localObject != null) && (localObject.length > 0))
        {
          Arrays.sort((Object[])localObject, new qgs(paramSpannable));
  ...
  public static boolean a(EditText paramEditText, String paramString, boolean paramBoolean1, boolean paramBoolean2, List<SocializeFeedsInfo.BiuCommentInfo> paramList)
  {
    ...
    paramEditText = oni.b(a(localEditable.toString(), str));
    if (TextUtils.isEmpty(paramEditText))
    {
      paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), ""));
      return true;
    }
    rre[] arrayOfrre = (rre[])localEditable.getSpans(0, localEditable.length(), rre.class);
    if ((arrayOfrre == null) || (arrayOfrre.length <= 0))
    {
      if (paramBoolean1) {
        break label650;
      }
    ...
    for (;;)
    {
      paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), axas.a(b((String)localObject + paramEditText, str))));
      return true;
      int m = arrayOfrre.length;
      Arrays.sort(arrayOfrre, new qgs(localEditable));
      paramEditText = axas.a(b(localEditable.subSequence(0, localEditable.getSpanStart(arrayOfrre[0])).toString(), str));
      ...
      if (i < m)
      {
        ...
        if (i == m - 1)
        {
          ...
          paramEditText = "";
          if (j - n > 0) {
            paramEditText = axas.a(b(localEditable.subSequence(n, j).toString(), str));
          }
        ...
        for (;;)
        {
          i += 1;
          break;
          j = localEditable.getSpanStart(arrayOfrre[(i + 1)]);
          break label372;
          label481:
          ...
          else if ((localObject instanceof rrf))
          {
            paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), paramEditText, 3, new SocializeFeedsInfo.JumpInfo(0L, ajyc.a(2131716018), ((rrf)localObject).a())));
          }
        }
      }
      return false;
