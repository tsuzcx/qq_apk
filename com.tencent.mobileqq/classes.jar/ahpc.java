...
public class ahpc
  extends akdk
{
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ahpd(this);
  public LinkedHashMap<String, List<ahpb>> a;
  private boolean jdField_a_of_type_Boolean;
  public int[] a;
  public String[] a;
  
  public ahpc(PublicAccountFragment paramPublicAccountFragment)
  {
  ...
  public ahpc(PublicAccountFragment paramPublicAccountFragment, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
    super(paramContext, paramQQAppInterface, paramXListView, paramBoolean);
    this.jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
    this.jdField_a_of_type_ArrayOfInt = new int[0];
    this.jdField_a_of_type_ArrayOfJavaLangString = new String[0];
    this.jdField_a_of_type_AndroidGraphicsBitmap = bdda.a(true);
  }
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    if ((ThemeUtil.isNowThemeDefaultCache) || (ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqActivityContactsFragmentPublicAccountFragment.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null))) {
      paramView.setBackgroundResource(2130849573);
    }
    for (;;)
    {
      paramView.setPadding(i, 0, 0, 0);
      paramView.setText(this.jdField_a_of_type_ArrayOfJavaLangString[paramInt]);
      paramView.setTextColor(this.jdField_a_of_type_ComTencentMobileqqActivityContactsFragmentPublicAccountFragment.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getColorStateList(2131166979));
      return;
  ...
  public void b()
  {
    ...
    do
    {
      ...
      {
        ahpb localahpb = (ahpb)((Iterator)localObject2).next();
        if ((localahpb.jdField_a_of_type_JavaLangString == null) || (localahpb.jdField_a_of_type_JavaLangString.length() == 0))
        {
          localObject1 = "#";
        ...
        for (localObject1 = ((String)localObject1).toUpperCase();; localObject1 = "#")
        {
          ...
          ((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localObject1)).add(localahpb);
          break;
          localObject1 = localahpb.jdField_a_of_type_JavaLangString.substring(0, 1);
          break label92;
        }
      }
  ...
  public Object getItem(int paramInt)
  {
    ...
    i = -(i + 1) - 1;
    return (ahpb)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityContactsFragmentPublicAccountFragment.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getLayoutInflater().inflate(2131559491, paramViewGroup, false);
      paramViewGroup = new ahpe();
    ...
    for (;;)
    {
      ...
      {
        i = -(i + 1) - 1;
        localObject = (ahpb)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
        paramViewGroup.jdField_a_of_type_Ahpb = ((ahpb)localObject);
        paramViewGroup.jdField_a_of_type_JavaLangString = String.valueOf(((ahpb)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.uin);
        paramViewGroup.jdField_a_of_type_AndroidViewView.setVisibility(0);
        paramViewGroup.f.setVisibility(8);
        paramViewGroup.d.setVisibility(0);
        paramViewGroup.d.setText(((ahpb)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name);
        if (((ahpb)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.certifiedGrade > 0L)
        {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqActivityContactsFragmentPublicAccountFragment.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_ComTencentMobileqqActivityContactsFragmentPublicAccountFragment.getResources().getDrawable(2130841431);
          ...
          paramViewGroup.e.setText(((ahpb)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.summary);
          ...
          if (((ahpb)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.extendType != 2) {
            break label858;
          }
        }
      }
      for (boolean bool = ndv.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactsFragmentPublicAccountFragment.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((ahpb)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin(), 1024);; bool = false)
      {
        if (bool)
        {
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setTag(-1, ((ahpb)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin());
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setTag(-2, ((ahpb)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name);
        ...
        {
          return paramView;
          paramViewGroup = (ahpe)paramView.getTag();
          break;
          ...
          break label544;
          paramViewGroup.jdField_a_of_type_Ahpb = null;
        ...
        paramViewGroup.f.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivityContactsFragmentPublicAccountFragment.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131691953), new Object[] { ((String)localObject).toLowerCase() }));
        return paramView;
      }
    }
  }
