...
public class apok
{
  ...
  public apok(Context paramContext, apon paramapon)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Apon = paramapon;
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Apon.d()) && (b())) {}
    do
    {
      return;
      Intent localIntent = this.jdField_a_of_type_Apon.a();
      if (localIntent == null)
      {
      ...
      this.jdField_a_of_type_Apon.b(localBundle);
  ...
  private boolean b()
  {
    ...
    do
    {
      do
      {
        ...
        {
          return false;
          localChatMessage = this.jdField_a_of_type_Apon.a();
        ...
        return false;
        localSessionInfo = this.jdField_a_of_type_Apon.a();
      ...
      return false;
      if (this.jdField_a_of_type_Apon.c())
      {
        if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_Apon.d()) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    return false;
    adpg.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidGraphicsRect, localChatMessage, localSessionInfo, this.jdField_a_of_type_Apon.a(), this.jdField_a_of_type_Apon.e(), this.jdField_a_of_type_Apon.f(), null);
    return true;
  }
  
  private void c()
  {
    apom localapom = new apom(this);
    String str1 = this.jdField_a_of_type_AndroidContentContext.getString(2131692673);
    String str2 = this.jdField_a_of_type_AndroidContentContext.getString(2131692675);
    aptt.a(this.jdField_a_of_type_AndroidContentContext, str1, str2, localapom);
  }
  
  public void a()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Apon.b()))
    {
      if (apvm.a(this.jdField_a_of_type_AndroidContentContext, false, new apol(this))) {
        c();
      }
      return;
    }
