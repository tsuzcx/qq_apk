  ...
  extends BaseBubbleBuilder
{
  ...
  protected HashMap<String, SparseArray<WeakReference<ahet>>> a;
  protected float b;
  final String b;
  ...
  protected String d;
  protected final int e = 2131375015;
  protected final int f = 2131375022;
  protected final int g = 2131375014;
  protected final int h = 2131375013;
  protected final int i = 2131375017;
  protected int j;
  protected int k;
  protected int l;
  protected int m;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = aheq.class.getSimpleName();
  }
  
  public aheq(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_c_of_type_Int = 2131374998;
    this.jdField_d_of_type_Int = 2131375027;
    this.jdField_b_of_type_JavaLangString = "pay";
    this.jdField_d_of_type_JavaLangString = "";
    this.jdField_b_of_type_Float = 1.0F;
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new aher(this);
    this.jdField_a_of_type_Akwo = new ahes(this);
    this.jdField_d_of_type_JavaLangString = paramContext.getString(2131716638);
  ...
  private RelativeLayout a(ahet paramahet, Context paramContext)
  {
    ...
    localQQWalletTransferBubbleView.setId(2131374998);
    ...
    ((TextView)localObject1).setId(2131375015);
    ...
    localTextView.setId(2131375022);
    ...
    ((RelativeLayout.LayoutParams)localObject3).addRule(3, 2131374998);
    ((QQWalletTransferBubbleView)localObject2).setLayoutParams((ViewGroup.LayoutParams)localObject3);
    ((QQWalletTransferBubbleView)localObject2).setBackgroundResource(2130847255);
    ((QQWalletTransferBubbleView)localObject2).setId(2131375014);
    ...
    paramContext.setId(2131375013);
    ((QQWalletTransferBubbleView)localObject2).addView(paramContext);
    localRelativeLayout.addView((View)localObject2);
    paramahet.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject1);
    paramahet.jdField_b_of_type_AndroidWidgetTextView = localTextView;
    paramahet.jdField_a_of_type_AndroidWidgetImageView = localImageView;
    paramahet.c = paramContext;
    paramahet.jdField_a_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView = ((QQWalletTransferBubbleView)localObject2);
    paramahet.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView = localQQWalletTransferBubbleView;
  ...
  private void a(ahet paramahet, MessageForQQWalletMsg paramMessageForQQWalletMsg, QQWalletBaseMsgElem paramQQWalletBaseMsgElem, boolean paramBoolean, aftk paramaftk)
  {
    if (paramMessageForQQWalletMsg.messageType == 16) {}
    for (int i1 = 1;; i1 = 0)
    {
      a(paramahet.jdField_a_of_type_AndroidWidgetTextView, paramQQWalletBaseMsgElem.title);
      paramahet.jdField_a_of_type_AndroidWidgetTextView.setTextColor(paramQQWalletBaseMsgElem.titleColor);
      paramahet.jdField_b_of_type_AndroidWidgetTextView.setText(paramQQWalletBaseMsgElem.subTitle);
      paramahet.jdField_b_of_type_AndroidWidgetTextView.setTextColor(paramQQWalletBaseMsgElem.subtitleColor);
      paramahet.c.setText(paramQQWalletBaseMsgElem.content);
      if (i1 != 0)
      {
        ...
        if (!TextUtils.isEmpty(paramQQWalletBaseMsgElem.iconUrl)) {
          localObject = URLDrawableHelper.getDrawable(paramQQWalletBaseMsgElem.iconUrl, (int)bhdz.a(this.jdField_a_of_type_AndroidContentContext, this.k), (int)bhdz.a(this.jdField_a_of_type_AndroidContentContext, this.k), null, null);
        }
        paramahet.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      }
      if (ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().waitAppRuntime(null), false, null))
      {
        paramahet.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleNightBackground(2130847254, Color.parseColor("#FF19BAFF"), paramBoolean);
        paramahet.jdField_a_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130847255, Color.parseColor("#A4A5A8"), paramBoolean);
        paramahet.jdField_a_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#B2B2B2"));
        paramahet.jdField_b_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#B2B2B2"));
        paramahet.c.setTextColor(Color.parseColor("#5D616B"));
      }
      for (;;)
      {
        paramahet.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(paramQQWalletBaseMsgElem.title + paramQQWalletBaseMsgElem.subTitle + this.jdField_d_of_type_JavaLangString);
        paramahet.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        paramahet.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnLongClickListener(paramaftk);
        paramahet.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnTouchListener(paramaftk);
        if (i1 != 0) {
          a(paramahet, paramMessageForQQWalletMsg, paramQQWalletBaseMsgElem);
        }
        return;
        if (bdfk.b())
        {
          paramahet.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130847254, Color.parseColor("#FF19BAFF"), paramBoolean);
          paramahet.jdField_a_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130847255, Color.parseColor("#FFECEDF2"), paramBoolean);
          paramahet.c.setTextColor(Color.parseColor("#FF878B99"));
        }
        else
        {
          paramahet.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130847254, paramQQWalletBaseMsgElem.background, paramBoolean);
          if (paramQQWalletBaseMsgElem.contentBgColor != 0) {
            paramahet.jdField_a_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130847255, paramQQWalletBaseMsgElem.contentBgColor, paramBoolean);
          }
          if (paramQQWalletBaseMsgElem.contentColor != 0) {
            paramahet.c.setTextColor(paramQQWalletBaseMsgElem.contentColor);
          }
        }
      }
    }
  ...
  private boolean a(Context paramContext, String paramString1, String paramString2, String paramString3, MessageForQQWalletMsg paramMessageForQQWalletMsg, SessionInfo paramSessionInfo)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        try
        {
          paramString1 = aheq.class.getClassLoader();
  ...
  {
    ahet localahet = (ahet)paramafqr;
    paramafqr = null;
    if ((paramChatMessage instanceof MessageForQQWalletMsg)) {
      paramafqr = (MessageForQQWalletMsg)paramChatMessage;
    }
    if ((paramafqr == null) || (paramafqr.mQQWalletTransferMsg == null)) {
      return null;
    }
    if ((localahet.jdField_a_of_type_AndroidWidgetRelativeLayout == null) || ((localahet.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (localahet.jdField_a_of_type_Long != paramChatMessage.uniseq)))
    {
      localahet.jdField_a_of_type_AndroidWidgetRelativeLayout = a(localahet, this.jdField_a_of_type_AndroidContentContext);
      paramBaseChatItemLayout.addView(a(this.jdField_a_of_type_AndroidContentContext));
    }
    localahet.jdField_a_of_type_Long = paramChatMessage.uniseq;
    paramView = paramafqr.mQQWalletTransferMsg.elem;
    if (paramView == null) {
      return localahet.jdField_a_of_type_AndroidWidgetRelativeLayout;
    }
    boolean bool;
    if (!paramChatMessage.isSend())
    {
      bool = true;
      a(localahet, paramafqr, paramView, bool, paramaftk);
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "transferaccountmsg", "show", 0, 0, "" + paramafqr.mQQWalletTransferMsg.templateId, "", "", "");
      paramChatMessage = (TextView)paramBaseChatItemLayout.findViewById(2131375017);
    ...
    for (;;)
    {
      if (paramafqr.messageType == 16)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.registObserver(this.jdField_a_of_type_Akwo);
        if (!TextUtils.isEmpty(paramafqr.mQQWalletTransferMsg.listId))
        {
          paramView = (SparseArray)this.jdField_a_of_type_JavaUtilHashMap.get(paramafqr.mQQWalletTransferMsg.listId);
          paramChatMessage = paramView;
          if (paramView == null)
          {
            paramChatMessage = new SparseArray();
            this.jdField_a_of_type_JavaUtilHashMap.put(paramafqr.mQQWalletTransferMsg.listId, paramChatMessage);
          }
          paramChatMessage.put((int)paramafqr.uniseq, new WeakReference(localahet));
        }
      }
      return localahet.jdField_a_of_type_AndroidWidgetRelativeLayout;
      bool = false;
  ...
  public void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.unRegistObserver(this.jdField_a_of_type_Akwo);
  ...
  protected void a(ahet paramahet, MessageForQQWalletMsg paramMessageForQQWalletMsg, QQWalletBaseMsgElem paramQQWalletBaseMsgElem)
  {
    int i2;
    boolean bool;
    if (paramMessageForQQWalletMsg.messageType == 16)
    {
      ...
      paramQQWalletBaseMsgElem = BaseApplicationImpl.getContext().getString(2131716631);
      i1 = 2130847231;
      a(paramahet.jdField_a_of_type_AndroidWidgetTextView, paramQQWalletBaseMsgElem);
      if ((i1 != 0) && (paramahet.jdField_a_of_type_AndroidWidgetImageView != null))
      {
        paramQQWalletBaseMsgElem = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(i1);
        paramahet.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramQQWalletBaseMsgElem);
      }
      if (paramahet.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView != null)
      {
        paramahet = paramahet.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView;
        if (paramMessageForQQWalletMsg.isSend()) {
          break label337;
        }
        bool = true;
        label120:
        paramahet.setBubbleBackground(2130847254, i2, bool);
      }
    }
    return;
    label132:
    paramQQWalletBaseMsgElem = akwm.a(1, paramMessageForQQWalletMsg.mQQWalletTransferMsg.listId, paramMessageForQQWalletMsg);
    ...
    for (int i1 = paramQQWalletBaseMsgElem.a("state", -1);; i1 = -1)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          paramQQWalletBaseMsgElem = BaseApplicationImpl.getContext().getString(2131716637);
          i1 = 2130847232;
          i2 = -7676215;
        }
      ...
      if (i1 == 2)
      {
        paramQQWalletBaseMsgElem = BaseApplicationImpl.getContext().getString(2131716632);
        i1 = 2130847229;
        i2 = -7676215;
        break;
      }
      if (i1 == 3)
      {
        paramQQWalletBaseMsgElem = BaseApplicationImpl.getContext().getString(2131716634);
        i1 = 2130847229;
        i2 = -7676215;
        break;
      }
      if (paramMessageForQQWalletMsg.isSend())
      {
        paramQQWalletBaseMsgElem = BaseApplicationImpl.getContext().getString(2131716635);
        i1 = 2130847230;
        break;
      }
      paramQQWalletBaseMsgElem = BaseApplicationImpl.getContext().getString(2131716633);
      i1 = 2130847230;
      break;
      label337:
      bool = false;
  ...
  public void a(View paramView, ChatMessage paramChatMessage)
  {
    ...
    {
      paramView.setPadding(t, v, u, paramView.getResources().getDimensionPixelSize(2131296386));
      return;
    }
