public class xda
{
  ...
  /* Error */
  public static xda a(String paramString, long paramLong)
  {
    // Byte code:
    //   0: new 2	xda
    //   3: dup
    //   4: invokespecial 21	xda:<init>	()V
    //   7: astore 6
    ...
    //   84: putfield 70	xda:jdField_a_of_type_Long	J
    //   87: aload 4
    //   89: astore_3
    //   90: aload 6
    //   92: aload 4
    //   94: aload 6
    //   96: getfield 70	xda:jdField_a_of_type_Long	J
    //   99: invokestatic 76	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   102: putfield 78	xda:jdField_a_of_type_ArrayOfByte	[B
    //   105: aload 4
    //   107: astore_3
    //   108: aload 6
    //   110: aload 6
    //   112: getfield 78	xda:jdField_a_of_type_ArrayOfByte	[B
    //   115: invokestatic 83	bdhe:a	([B)Ljava/lang/String;
    //   118: putfield 85	xda:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   121: aload 4
    //   123: astore_3
    ...
    //   162: putfield 103	xda:jdField_a_of_type_Int	I
    //   165: aload 4
    //   167: astore_3
    //   168: aload 6
    //   170: aload 5
    //   172: getfield 106	android/graphics/BitmapFactory$Options:outWidth	I
    //   175: putfield 108	xda:jdField_b_of_type_Int	I
    //   178: aload 4
    //   180: astore_3
    //   181: aload 6
    //   183: aload_0
    //   184: putfield 110	xda:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   187: aload 4
    //   189: astore_3
    //   190: aload 6
    //   192: lload_1
    //   193: putfield 112	xda:jdField_b_of_type_Long	J
    //   196: aload 4
    //   198: ifnull +8 -> 206
    //   201: aload 4
