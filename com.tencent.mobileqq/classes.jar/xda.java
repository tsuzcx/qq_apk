  ...
  extends VideoFilterBase
{
  ...
  public xda(DoodleItem paramDoodleItem, String paramString)
  {
  ...
  void a(ArrayList<PointF> paramArrayList)
  {
    ...
    {
      f1 = (float)xde.a((PointF)this.jdField_a_of_type_JavaUtilList.get(i - 3), (PointF)this.jdField_a_of_type_JavaUtilList.get(i - 2));
      f2 = (float)xde.a((PointF)this.jdField_a_of_type_JavaUtilList.get(i - 2), (PointF)this.jdField_a_of_type_JavaUtilList.get(i - 1));
      f1 = 1.0F / ((int)(((float)xde.a((PointF)this.jdField_a_of_type_JavaUtilList.get(i - 1), (PointF)this.jdField_a_of_type_JavaUtilList.get(i)) + (f1 + f2)) / (f3 * 1.5F)) * 12 * 1.0F);
      if (f1 > 0.1F) {
        f1 = 0.1F;
      }
    }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      ...
      if (j > 0)
      {
        ...
        int m = (int)((float)xde.a((PointF)localObject1, (PointF)localObject2) / f1 * 18.0F) + 1;
        int k = m;
        if (m < 6) {
          k = 6;
        }
