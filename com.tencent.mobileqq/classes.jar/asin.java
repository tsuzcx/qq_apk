...
public class asin
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = asiv.jdField_a_of_type_JavaLangString + "GameMsgUtil";
  ...
  public static Intent a(Context paramContext, QQMessageFacade.Message paramMessage, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      localObject = (asil)paramQQAppInterface.getManager(358);
      paramContext = ((asil)localObject).a(str3);
      if (paramContext == null) {
        break label376;
      }
      paramContext = ((asil)localObject).a(paramContext.c);
    ...
    paramContext = ((asil)localObject).a();
    if (i == 0)
    {
      localObject = ((asil)localObject).a(str1);
      if (localObject != null)
      {
  ...
  public static Bitmap a(QQMessageFacade.Message paramMessage, QQAppInterface paramQQAppInterface)
  {
    ...
    paramMessage = asio.b(paramMessage);
    Object localObject;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramQQAppInterface = ((asil)paramQQAppInterface.getManager(358)).a(paramMessage);
      if (paramQQAppInterface != null) {
        break;
      }
    ...
    paramMessage = bame.a(paramQQAppInterface.mFaceUrl);
    ...
    for (;;)
    {
      ...
      return paramMessage;
      paramMessage = BaseApplicationImpl.getApplication().getResources().getDrawable(2130840157);
      ...
      catch (MalformedURLException paramQQAppInterface)
      {
        for (;;)
        {
          try
          {
            paramMessage.setTag(bcuq.b(100, 100, 6));
            paramMessage.setDecodeHandler(bcuq.a);
  ...
  public static URLDrawable a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    paramQQAppInterface = ((asil)paramQQAppInterface.getManager(358)).a(paramString);
    if (paramQQAppInterface == null)
    {
    ...
    localURLDrawableOptions.mRequestWidth = aekt.a(60.0F, paramContext.getResources());
    localURLDrawableOptions.mRequestHeight = aekt.a(60.0F, paramContext.getResources());
    try
    {
      paramContext = URLDrawable.getDrawable(new URL(paramQQAppInterface.mFaceUrl), localURLDrawableOptions);
      try
      {
        paramContext.setTag(bcuq.b(100, 100, 6));
        paramContext.setDecodeHandler(bcuq.a);
        return paramContext;
      }
      catch (MalformedURLException paramQQAppInterface) {}
    }
  ...
  {
    paramString = BaseApplicationImpl.getContext().getString(2131693018) + paramString;
    if (paramQQAppInterface == null) {
      return paramString;
    }
    paramMessageRecord = asio.a(paramMessageRecord);
    ...
    return BaseApplicationImpl.getContext().getString(2131693019) + paramMessageRecord.i;
  }
  ...
  public static String a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      String str = asio.b(paramMessageRecord);
      paramQQAppInterface = ((asil)paramQQAppInterface.getManager(358)).a(str);
    ...
    return BaseApplicationImpl.getApplication().getResources().getString(2131693013);
  }
  ...
  public static String a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      localObject = ((asil)paramQQAppInterface.getManager(358)).a(((ConversationInfo)localObject).tinyInfo.fromRoleId);
  ...
  public static void a(Context paramContext, asik paramasik)
  {
    ...
    QLog.i(jdField_a_of_type_JavaLangString, 1, "appId:" + paramasik.c);
    String str2 = paramasik.l;
    String str1 = str2;
    if (TextUtils.isEmpty(str2)) {
      str1 = GameBasicInfo.getDefaultGameLaunchUrl(paramasik.c);
    }
    paramasik = new Intent(paramContext, QQBrowserActivity.class);
    paramasik.putExtra("url", str1);
    paramContext.startActivity(paramasik);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        GameCenterSessionInfo localGameCenterSessionInfo = ((asil)paramQQAppInterface.getManager(358)).a(paramString);
  ...
  public static void a(QQAppInterface paramQQAppInterface, QQMessageFacade.Message paramMessage, MsgSummary paramMsgSummary, RecentItemPublicAccountChatMsgData paramRecentItemPublicAccountChatMsgData)
  {
    ...
    asil localasil = (asil)paramQQAppInterface.getManager(358);
    if (!localasil.b()) {}
      ...
      do
      {
        do
        {
          do
          {
            ...
            paramRecentItemPublicAccountChatMsgData.mUnreadNum += localasil.b();
          ...
          return;
          localGameCenterSessionInfo = localasil.a();
          if (QLog.isColorLevel()) {
    ...
    {
      paramMsgSummary.strContent = new baig("[" + localGameCenterSessionInfo.b() + "位好友请求] 来自" + localGameCenterSessionInfo.e(), 3, 16, -1);
    ...
    {
      localasil.a = true;
      bkeu.a().a(localGameCenterSessionInfo.d(), "1", "145", "920", "92003", "206345", "0", "0", "8", "0");
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      paramMsgSummary.strContent = new baig(paramQQAppInterface + " " + (String)localObject + ": " + localGameCenterSessionInfo.h(), 3, 16, -1);
      localRecentUser.lastmsgtime = localGameCenterSessionInfo.a();
      paramRecentItemPublicAccountChatMsgData.mDisplayTime = localGameCenterSessionInfo.a();
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    azmj.b(null, "dc00898", "", "", str, str, paramInt2, 0, String.valueOf(new TinyInfo(paramString, paramQQAppInterface.isSend()).gameAppId), "", "", "");
  }
