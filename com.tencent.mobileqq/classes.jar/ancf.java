...
public class ancf
{
  ...
  public static void a(List<String> paramList)
  {
    ...
    Object localObject1 = (QQAppInterface)bhfc.a();
    ancg localancg = (ancg)((QQAppInterface)localObject1).getManager(149);
    ajhx localajhx = (ajhx)((QQAppInterface)localObject1).a(72);
    ...
    for (;;)
    {
      ...
      if (!a(localCustomEmotionData1.emoOriginalPath))
      {
        ...
        localancg.c(localCustomEmotionData1);
        localajhx.notifyUI(2, true, null);
        a(false, 1, 0);
        i = k + 1;
        k = i;
        break;
      ...
      localObject2 = ajed.bf + akhi.a(str1) + str3 + (String)localObject2;
      boolean bool = bace.d((String)localObject1, (String)localObject2);
      if (QLog.isColorLevel()) {
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        {
          localancg.a(localCustomEmotionData2, localList.indexOf(localCustomEmotionData2));
          i = 1;
        }
      }
      for (;;)
      {
        ...
        {
          localancg.a(localCustomEmotionData2);
        }
        else
        {
          n = 1;
  ...
  public static void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (paramBoolean)
    {
      ...
      awrn.a(BaseApplication.getContext()).a(null, "FavEmoUploadLocal", false, 0L, 0L, localHashMap, null);
      if (!paramBoolean) {
        break label91;
      }
    }
  ...
  public static boolean a(String paramString)
  {
    try
    {
      amcg localamcg = (amcg)alzw.a().a(561);
      if (new File(paramString).length() >= localamcg.a) {
        return false;
      }
      if (!atra.a(paramString))
      {
        ...
        if (localOptions.outWidth < localamcg.b)
        {
