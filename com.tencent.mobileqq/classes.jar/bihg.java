  ...
  implements bkwq
{
  ...
  public bihg(bjqu parambjqu, bjqt parambjqt)
  {
  ...
  private void ag()
  {
    ...
    {
      if (i != 0) {
        this.jdField_a_of_type_Bjqu.a().setResult(-1, null);
      }
      if ((localBundle != null) && (localBundle.getInt("entrance_type") == 107)) {
        this.jdField_a_of_type_Bjqu.a().setResult(-1, localActivity.getIntent());
      }
  ...
  private void d(Intent paramIntent)
  {
    ...
    if (!TextUtils.isEmpty(paramIntent))
    {
      ...
      localArrayList.add("*");
      armk.a(paramIntent, null, localArrayList, null);
    }
    localActivity.finish();
  }
  ...
  public void I()
  {
    if (Build.VERSION.SDK_INT >= 17)
    {
      vuc.a().c(21);
      vuc.a().b(12);
      a(this.jdField_a_of_type_Bjqu.a(), false);
    }
    for (;;)
    {
      vel.a("video_shoot", "clk_slides_entry", 0, 0, new String[0]);
      vel.a("video_shoot_slides", "clk_slides_entry", 0, 0, new String[0]);
      IntentFilter localIntentFilter;
      if (this.jdField_a_of_type_AndroidContentBroadcastReceiver == null)
      {
        this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bihh(this);
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramIntent != null)
    {
      ...
      this.jdField_a_of_type_Bjqu.a().setResult(paramInt2, paramIntent);
    }
  ...
  public void a(int paramInt, bjcl parambjcl)
  {
    ...
    int i = parambjcl.a();
    parambjcl = vel.b(i());
    jdField_a_of_type_JavaUtilHashSet.add(Integer.valueOf(parambjcl));
    if ((i == 2) || (i == 4) || (i == 5))
    {
    ...
    for (paramInt = (int)(jdField_a_of_type_Long - this.jdField_b_of_type_Long);; paramInt = 0)
    {
      ...
      vel.a("time_waitshoot", 10002, paramInt, new String[] { "", parambjcl, "", "" });
      return;
    }
  }
  ...
  public void a(Activity paramActivity, boolean paramBoolean)
  {
    ...
    {
      vel.a("time_waitshoot", 10002, i, new String[] { "", "3", "", "" });
      if (!this.jdField_b_of_type_JavaUtilHashSet.contains(Integer.valueOf(2)))
      {
        ...
        vel.a("start_shoot", 10002, 0, new String[] { vel.b(2), "0", "", l });
      }
      return;
    }
  }
  ...
  {
    int i = this.jdField_a_of_type_Bjqu.a().getIntent().getIntExtra("entrance_type", 1);
    this.jdField_a_of_type_Bjqm = new bjqm(10002, i, 1);
    super.a(paramBundle);
    if (i == 104) {
      vel.a("video_shoot_fromweb", "exp_cam", 0, 0, new String[0]);
    }
    if (i == 18) {
      vel.a("video_shoot_new", "shoot_exp", 1, 0, new String[] { "", "", "", "18" });
    }
    jdField_a_of_type_Long = -1L;
    y = false;
    jdField_a_of_type_JavaUtilHashSet = new HashSet();
    l = String.valueOf(i);
    z = false;
    long l1 = this.jdField_a_of_type_Bjqu.a().getIntent().getLongExtra("TIMESTAMP_START_ACTIVITY", 0L);
    if (l1 != 0L)
    {
  ...
  public void a(avum paramavum)
  {
    ...
    if (this.jdField_a_of_type_Bjqm.jdField_b_of_type_Int != 102)
    {
      ...
      bool4 = true;
      label56:
      Object localObject = new bjqp(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a()).b(bool1).c(bool2).d(true).a(bool4).e(bool3).c(i()).a(11).a();
      this.jdField_a_of_type_Bjqm.a((bjqn)localObject);
      ...
      bkuq.a(this.jdField_a_of_type_Bjqu.a(), paramavum, this.jdField_a_of_type_Bjqm, this.jdField_a_of_type_AndroidOsBundle, this.jdField_a_of_type_Int, (Bundle)localObject);
      if (!y)
      {
        y = true;
        vel.a("clk_mode", 10002, 0, new String[] { ShortVideoUtils.a(jdField_a_of_type_JavaUtilHashSet), "0", "", "" });
      }
      if (!z)
      {
        z = true;
    ...
    {
      vel.a("time_shoot", 10002, i, new String[] { vel.b(i()), "0", "", "" });
      return;
      bool1 = false;
      break;
      bool2 = false;
  ...
  public void a(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (this.jdField_a_of_type_Bjqm.jdField_b_of_type_Int != 102)
    {
      ...
      if ((this.jdField_a_of_type_Bjqm.c() == 108) || (!this.h)) {
        break label432;
      }
      bool4 = true;
      label110:
      Bundle localBundle = this.jdField_a_of_type_Bjqu.a().getIntent().getExtras();
      Object localObject = new bjqs().a(false).e(bool1).f(bool2).g(true).h(bool4).i(bool3).c(i()).j(true);
      this.jdField_a_of_type_Bjqm.a(((bjqs)localObject).a());
      if (!this.h) {
        break label438;
      }
      i = 2;
    ...
    for (int i = (int)(System.currentTimeMillis() - jdField_a_of_type_Long);; i = 0)
    {
      vel.a("time_shoot", 10002, i, new String[] { vel.b(i()), String.valueOf(paramLocalMediaInfo.mDuration), "", "" });
      return;
      bool1 = false;
      break;
      bool2 = false;
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (!paramBoolean1)
    {
      ...
      localObject = this.jdField_a_of_type_Bizx;
      if (paramBoolean1) {
        break label206;
      }
      paramBoolean2 = true;
      label30:
      ((bizx)localObject).g(paramBoolean2);
      if (!paramBoolean1) {
        break label211;
      }
      ...
      if ((this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.e != null))
      {
        ...
        i = vzo.a(this.jdField_a_of_type_Bjqu.a(), 88.0F);
    ...
    int i = vzo.a(this.jdField_a_of_type_Bjqu.a(), 88.0F);
    this.e.setTranslationY(i);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.e, (ViewGroup.LayoutParams)localObject);
  ...
  public boolean a()
  {
    ...
    {
      vel.a("time_waitshoot", 10002, i, new String[] { "", "1", "", "" });
      if ((!y) && (bool))
      {
        y = true;
        vel.a("clk_mode", 10002, 0, new String[] { ShortVideoUtils.a(jdField_a_of_type_JavaUtilHashSet), "1", "", "" });
      }
      return bool;
    }
  }
  ...
  public void ac()
  {
    ...
    if (!this.jdField_b_of_type_JavaUtilHashSet.contains(Integer.valueOf(this.jdField_b_of_type_Int)))
    {
      ...
      vel.a("start_shoot", 10002, 0, new String[] { vel.b(i()), "0", "", l });
    }
  }
  ...
  void ad()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 185	bihg:jdField_a_of_type_DovComQqImCaptureModeCaptureModeController	Ldov/com/qq/im/capture/mode/CaptureModeController;
    //   4: invokevirtual 430	dov/com/qq/im/capture/mode/CaptureModeController:a	()Lbjrh;
    //   7: invokevirtual 762	bjrh:b	()Ljava/lang/String;
    //   10: astore_3
    //   11: aload_3
    //   12: ifnull +231 -> 243
    ...
    //   87: aload 4
    //   89: ldc_w 794
    //   92: invokestatic 798	ajyc:a	(I)Ljava/lang/String;
    ...
    //   162: aload_0
    //   163: getfield 617	bihg:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   166: ldc_w 835
    ...
    //   210: ldc_w 859
    //   213: aload_0
    //   214: getfield 401	bihg:jdField_b_of_type_Int	I
    ...
    //   232: aload_0
    //   233: getfield 617	bihg:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   236: ldc_w 835
    //   239: aload_3
  ...
  {
    int i = 0;
    int k = this.jdField_a_of_type_Bjqu.a().getIntent().getExtras().getInt("capture_intent_mode", 0);
    int j = bjcn.a(k);
  ...
  public void d(int paramInt)
  {
    ...
    case 2: 
      ...
      return;
    case 3: 
      this.jdField_a_of_type_DovComQqImCaptureViewStoryImageToastView.a(ajyc.a(2131709840)).a(2130843832).a(false);
      return;
    case 4: 
      this.jdField_a_of_type_DovComQqImCaptureViewStoryImageToastView.a(ajyc.a(2131709847)).a(2130843831).a(false);
      return;
    case 5: 
      this.jdField_a_of_type_DovComQqImCaptureViewStoryImageToastView.b();
      return;
  ...
  public void i()
  {
    ...
    if ((this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraStoryCaptureButtonLayout.b()) || (this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraStoryCaptureButtonLayout.c())) {
      vel.a("clk_shoot", vel.b(avtb.jdField_a_of_type_Int), 1, new String[0]);
    }
    for (;;)
    {
      ThreadManager.getUIHandler().post(new QIMStoryEffectCameraCaptureUnit.2(this));
      return;
      vel.a("clk_shoot", vel.b(avtb.jdField_a_of_type_Int), 3, new String[0]);
    }
  }
  ...
  public void i(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      if ((this.jdField_a_of_type_Bizx != null) && (this.jdField_a_of_type_DovComQqImCaptureModeCaptureModeController.jdField_a_of_type_Boolean)) {
        this.jdField_a_of_type_Bizx.n();
      }
      if (this.e != null) {
  ...
  public void j()
  {
    ...
    for (int i = (int)(System.currentTimeMillis() - this.jdField_b_of_type_Long);; i = 0)
    {
      vel.a("time_waitshoot", 10002, i, new String[] { "", "0", "", "" });
      if (!this.jdField_b_of_type_JavaUtilHashSet.contains(Integer.valueOf(this.jdField_b_of_type_Int)))
      {
        this.jdField_b_of_type_JavaUtilHashSet.add(Integer.valueOf(this.jdField_b_of_type_Int));
        vel.a("start_shoot", 10002, 0, new String[] { vel.b(i()), "0", "", l });
  ...
  protected void u()
  {
    this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraStoryCaptureButtonLayout = ((QIMCameraStoryCaptureButtonLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363881));
    ...
    ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131372817)).inflate();
    this.jdField_a_of_type_DovComQqImCaptureViewStoryImageToastView = ((StoryImageToastView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372816));
    this.jdField_a_of_type_DovComQqImCaptureViewStoryTextToastView = ((StoryTextToastView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372807));
  }
}
