...
public class bihg
{
  private static bihg jdField_a_of_type_Bihg;
  private Pattern jdField_a_of_type_JavaUtilRegexPattern = Pattern.compile("(\\d+)\\.(\\d+).(\\d+)_(\\d+)");
  
  public static bihg a()
  {
    if (jdField_a_of_type_Bihg == null) {}
    try
    {
      if (jdField_a_of_type_Bihg == null) {
        jdField_a_of_type_Bihg = new bihg();
      }
      return jdField_a_of_type_Bihg;
    }
    finally {}
  }
      ...
      try
      {
        ...
        if (localObject.length >= 2)
        {
          ...
          if ((paramString != null) && (localObject != null) && (paramString.length >= 4) && (localObject.length >= 4))
          {
            ...
            paramString = this.jdField_a_of_type_JavaUtilRegexPattern.matcher(bizf.a());
            if (paramString.find())
            {
