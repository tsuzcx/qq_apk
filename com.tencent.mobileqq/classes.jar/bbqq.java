  ...
  implements View.OnClickListener, bljd, IBrowserItemEventListener
{
  ...
  public bbqq(Activity paramActivity, bbpr parambbpr)
  {
    super(paramActivity, parambbpr);
    this.jdField_a_of_type_AndroidOsMessageQueue$IdleHandler = new bbqt(this);
  ...
  private void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Bbpr.a(paramLong, paramInt1, 1);
  }
  ...
  private void a(Uri paramUri, ArrayList<ShareActionSheetBuilder.ActionSheetItem> paramArrayList)
  {
    ...
    label110:
    Matrix localMatrix;
    if ((localObject3 != null) && ((((View)localObject3).getTag() instanceof bbqv)))
    {
      localObject1 = ((bbqv)((View)localObject3).getTag()).jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView;
  ...
  private void a(RichMediaBrowserInfo paramRichMediaBrowserInfo, AIOFilePictureData paramAIOFilePictureData, bbpj parambbpj, File paramFile, int paramInt)
  {
    ...
    if (parambbpj.a(paramAIOFilePictureData, 16) != null)
    {
      parambbpj = URLDrawable.getFileDrawable(paramAIOFilePictureData.jdField_b_of_type_JavaLangString, null);
      parambbpj.downloadImediatly();
      localURLDrawableOptions.mLoadingDrawable = parambbpj;
    }
    for (;;)
    {
      ...
      try
      {
        parambbpj = URLDrawable.getFileDrawable(paramFile.getAbsolutePath(), localURLDrawableOptions);
        if (parambbpj != null)
        {
          parambbpj.setTag(Integer.valueOf(1));
          this.jdField_a_of_type_Bbpr.mActiveDrawable.put(Integer.valueOf(paramInt), parambbpj);
          paramFile = paramFile.getAbsolutePath();
          this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.setGalleryImageListener(new bbqu(this, paramRichMediaBrowserInfo, paramFile, parambbpj, paramAIOFilePictureData));
          this.jdField_a_of_type_JavaLangRunnable = agej.a(this.jdField_b_of_type_AndroidWidgetImageView, parambbpj);
          if ((this.jdField_a_of_type_JavaLangRunnable == null) && (parambbpj.getStatus() == 1))
          {
            a(paramRichMediaBrowserInfo, paramFile, parambbpj, paramInt);
            this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.setImageDrawable(parambbpj);
          }
        }
        else
        {
      ...
      catch (Throwable parambbpj)
      {
        for (;;)
        {
          BrowserLogHelper.getInstance().getGalleryLog().d("AIOGalleryFilePicView", 4, "[getView] URLDrawable.getDrawable failed.");
          parambbpj = localObject;
          continue;
          this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(parambbpj, this.mScreenWidthPx, this.mScreenHeightPx, this.jdField_a_of_type_Bbpr.getRotation(paramRichMediaBrowserInfo.orientation));
        }
      }
    }
  }
  ...
  private void a(RichMediaBrowserInfo paramRichMediaBrowserInfo, AIOFilePictureData paramAIOFilePictureData, File paramFile, int paramInt)
  {
    ...
    catch (Throwable localThrowable)
    {
      try
      {
        ...
        this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(localObject1, this.mScreenWidthPx, this.mScreenHeightPx, this.jdField_a_of_type_Bbpr.getRotation(paramRichMediaBrowserInfo.orientation));
        this.jdField_a_of_type_Bbpr.onLoadFinish(paramInt, true);
        return;
    ...
    if (localObject1 != null) {
      this.jdField_a_of_type_Bbpr.mActiveDrawable.put(Integer.valueOf(paramInt), localObject1);
    }
  ...
  private void a(RichMediaBrowserInfo paramRichMediaBrowserInfo, String paramString, URLDrawable paramURLDrawable, int paramInt)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bbpr.mActiveDrawable.put(Integer.valueOf(paramInt), paramURLDrawable);
      this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(paramURLDrawable, this.mScreenWidthPx, this.mScreenHeightPx, this.jdField_a_of_type_Bbpr.getRotation(paramRichMediaBrowserInfo.orientation));
      this.jdField_a_of_type_Bbpr.onLoadFinish(paramInt, true);
      return;
    }
  ...
  private void a(File paramFile, AIOFilePictureData paramAIOFilePictureData)
  {
    ...
    if (paramFile == null) {
      localFile = new bbpj().a(paramAIOFilePictureData, 20);
    }
    if (localFile == null)
    {
    ...
    aunj.a(this.mContext, localFile.getAbsolutePath());
  }
  ...
  private boolean a(AIOFilePictureData paramAIOFilePictureData, GalleryUrlImageView paramGalleryUrlImageView)
  {
    ...
    Object localObject2 = new bbpj();
    if (((bbpj)localObject2).a(paramAIOFilePictureData, 16) != null)
    {
      ...
      localObject2 = ((bbpj)localObject2).a(paramAIOFilePictureData, 16);
  ...
  private boolean b(AIOFilePictureData paramAIOFilePictureData, GalleryUrlImageView paramGalleryUrlImageView)
  {
    ...
    {
      paramAIOFilePictureData = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838072);
      paramGalleryUrlImageView.setImageDrawable(paramAIOFilePictureData);
      this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(paramAIOFilePictureData, this.mScreenWidthPx, this.mScreenHeightPx, 0);
      bool = true;
    }
  ...
  private void l()
  {
    AIOFilePictureData localAIOFilePictureData = this.jdField_a_of_type_Bbpr.a();
    if ((localAIOFilePictureData != null) && (new bbpj().a(localAIOFilePictureData, 20)))
    {
      if (localAIOFilePictureData.jdField_c_of_type_Long > 0L) {
        a(String.format(Locale.CHINA, this.mContext.getString(2131694456), new Object[] { auog.a(localAIOFilePictureData.jdField_c_of_type_Long) }));
      }
    }
    else {
      return;
  ...
  public void a(int paramInt)
  {
    ...
    if (localAIOFilePictureData != null)
    {
      ...
      localObject2 = localbbpj.a(localAIOFilePictureData, 20);
      Object localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = localbbpj.a(localAIOFilePictureData, 18);
      }
      localObject2 = localObject1;
      if (localObject1 == null) {
        localObject2 = localbbpj.a(localAIOFilePictureData, 16);
      }
      if ((localObject2 != null) || (!bbox.a().a())) {}
    }
    else
    {
      return;
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setItemClickListenerV2(new bbqs(this, paramAIOFilePictureData, paramFile));
  }
  ...
  public void a(AIOFilePictureData paramAIOFilePictureData, File paramFile, int paramInt)
  {
    ...
    if (paramFile != null)
    {
      bhrt.a(2, localArrayList1);
      if ((PicShareToWX.a().a()) && (PicShareToWX.a().a(paramFile))) {
        bhrt.a(9, localArrayList1);
      }
      bhrt.a(27, localArrayList1);
      bhrt.a(39, localArrayList2);
      bhrt.a(6, localArrayList2);
      if ((bbox.a().g()) && (!TextUtils.isEmpty(bbox.a().c()))) {
        bhrt.a(54, localArrayList2);
      }
      if (this.jdField_a_of_type_Boolean) {
        bhrt.a(52, localArrayList2);
      }
    ...
    for (;;)
    {
      ...
      paramAIOFilePictureData = this.jdField_a_of_type_Bbpr.a(paramAIOFilePictureData, this.mContext);
  ...
  public void ak_()
  {
    this.jdField_a_of_type_Bbpr.updateSystemUIVisablity();
  }
  ...
  public boolean b()
  {
    if (super.b())
    {
      ...
      {
        bbpj localbbpj = new bbpj();
        File localFile2 = localbbpj.a(localAIOFilePictureData, 20);
        File localFile1 = localFile2;
        if (localFile2 == null) {
          localFile1 = localbbpj.a(localAIOFilePictureData, 18);
        }
        if ((localFile1 != null) || (!bbox.a().a())) {
          break label67;
        }
      }
    }
    label67:
    while ((bbox.a().a()) || (bbox.a().c())) {
      return false;
    }
    return true;
  }
  ...
  public void bindView(int paramInt)
  {
    ...
    RichMediaBrowserInfo localRichMediaBrowserInfo = this.jdField_a_of_type_Bbpr.getItem(paramInt);
    ...
    {
      a(this.jdField_a_of_type_Bbpr.a(), localRichMediaBrowserInfo);
      ...
      URLDrawable localURLDrawable = (URLDrawable)this.jdField_a_of_type_Bbpr.mActiveDrawable.get(Integer.valueOf(paramInt));
      String str2 = localbbpj.a(localAIOFilePictureData, 20);
      String str3 = localbbpj.a(localAIOFilePictureData, 18);
      String str4 = localbbpj.a(localAIOFilePictureData, 16);
      String str1 = "";
      localObject = str1;
      ...
      localObject = localbbpj.a(localAIOFilePictureData, 20);
      ...
      this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(localURLDrawable, this.mScreenWidthPx, this.mScreenHeightPx, this.jdField_a_of_type_Bbpr.getRotation(localRichMediaBrowserInfo.orientation));
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.setMainBrowserPresenter(this.jdField_a_of_type_Bbpr.mainBrowserPresenter);
      localObject = new bbqv(this);
      ((bbqv)localObject).jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView = this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView;
      ((bbqv)localObject).jdField_a_of_type_AndroidWidgetTextView = this.jdField_c_of_type_AndroidWidgetTextView;
      ((bbqv)localObject).jdField_a_of_type_AndroidWidgetImageView = this.jdField_c_of_type_AndroidWidgetImageView;
      ...
      if (localObject != null)
      {
        a(localRichMediaBrowserInfo, localAIOFilePictureData, localbbpj, (File)localObject, paramInt);
      }
      else
      {
        localObject = localbbpj.a(localAIOFilePictureData, 18);
        if (localObject != null)
        {
          a(localRichMediaBrowserInfo, localAIOFilePictureData, (File)localObject, paramInt);
        }
        else if (localbbpj.a(localAIOFilePictureData, 16) != null)
        {
          ...
          BrowserLogHelper.getInstance().getGalleryLog().d("AIOGalleryFilePicView", 4, "getView(): url is " + localbbpj.a(localAIOFilePictureData, 16) + ", file type is " + 16);
        }
        else
        {
          if ((!auoo.a(localAIOFilePictureData.jdField_e_of_type_Int, localAIOFilePictureData.f, localAIOFilePictureData.jdField_e_of_type_Long)) && (localAIOFilePictureData.jdField_g_of_type_Int != 1))
          {
          ...
          localObject = BaseApplicationImpl.getApplication().getResources().getDrawable(2130844282);
          this.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
          this.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
          this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
          this.jdField_c_of_type_AndroidWidgetTextView.setText(2131692195);
          this.jdField_a_of_type_Bbpr.a().b();
        }
      }
    }
  }
  ...
  public boolean c()
  {
    if ((this.mContext.getIntent().getBooleanExtra("extra.FROM_AIO", false)) || (bbox.a().c() == 3) || (bbox.a().c() == 2)) {}
    for (int i = 1;; i = 0)
    {
  ...
  public void e(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Bbpr.a() != null) && (this.jdField_a_of_type_Bbpr.a().b()))
    {
      this.jdField_a_of_type_Bbpr.a().jdField_a_of_type_Boolean = false;
      return;
    }
    showContentView(false);
    b(false);
    this.jdField_a_of_type_Bbpr.a().g();
  }
  ...
  {
    if (((paramView instanceof RelativeLayout)) && ((paramView.getTag() instanceof bbqv)))
    {
      this.mBrowserItemView = ((RelativeLayout)paramView);
      paramView = (bbqv)paramView.getTag();
    ...
    for (;;)
    {
      ...
      paramView.addRule(3, 2131366278);
      paramView.addRule(14);
      paramView.topMargin = agej.a(4.0F, this.mContext.getResources());
      ...
      this.jdField_c_of_type_AndroidWidgetImageView.setId(2131366278);
  ...
  public void i()
  {
    ...
    {
      if (!bhnv.d(this.mContext))
      {
        QQToast.a(this.mContext, this.mContext.getString(2131693371), 0).a();
        updateUI();
      }
    }
    else {
    ...
    {
      QQToast.a(this.mContext, this.mContext.getString(2131692472), 0).a();
      updateUI();
      return;
    }
    ...
    long l = atyt.a();
    if ((localAIOFilePictureData.jdField_e_of_type_Long > l) && (aunj.a())) {
      try
      {
        aunj.a(false, this.mContext, new bbqr(this, localAIOFilePictureData));
        return;
      }
      catch (Throwable localThrowable)
      {
    ...
    this.jdField_a_of_type_Bbpr.a(localThrowable.jdField_a_of_type_Long, localThrowable.jdField_a_of_type_Int, 2);
  ...
  void j()
  {
    ...
    default: 
      ...
      if (d())
      {
        localObject2 = RichMediaBrowserManager.getInstance().getProvider().getForwardData(localAIOFilePictureData.jdField_a_of_type_Long, localAIOFilePictureData.jdField_a_of_type_Int, bbox.a().a());
        if (localObject2 != null)
        {
  ...
  public void k()
  {
    if (this.mBrowserItemView != null)
    {
      ...
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.mBrowserItemView.findViewById(2131374359));
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      Object localObject = this.jdField_a_of_type_Bbpr.getSelectedItem();
      if ((localObject != null) && (((RichMediaBrowserInfo)localObject).baseData != null) && (((RichMediaBrowserInfo)localObject).baseData.getType() == 102))
      {
        this.jdField_a_of_type_Bbpr.back();
        continue;
        localObject = this.jdField_a_of_type_Bbpr.a();
        if (localObject != null)
        {
          if (RichMediaBrowserManager.getInstance().getProvider() != null) {
          ...
          this.jdField_a_of_type_Bbpr.a(((AIOFilePictureData)localObject).jdField_a_of_type_Long, ((AIOFilePictureData)localObject).jdField_a_of_type_Int, 0);
          updateUI();
          continue;
          d();
          continue;
          ...
          localObject = this.jdField_a_of_type_Bbpr.a();
          if (localObject != null) {
            MiniChatActivity.a(this.mContext, bbox.a().a(), bbox.a().a(), false, 26, ((AIOFilePictureData)localObject).jdField_d_of_type_Long, 0L);
          }
          this.jdField_a_of_type_Bbpr.l();
        }
      }
    }
  }
  ...
  public void onItemSelected(int paramInt)
  {
    ...
    AIOFilePictureData localAIOFilePictureData = this.jdField_a_of_type_Bbpr.a();
    if ((localAIOFilePictureData != null) && (!this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.isOriginalImage()) && ((localObject instanceof SkinnableBitmapDrawable)) && (localAIOFilePictureData.jdField_b_of_type_Int == 1) && (localAIOFilePictureData.jdField_c_of_type_Long > atyt.c()))
    {
    ...
    if (localAIOFilePictureData != null)
    {
      localObject = new bbpj();
      if ((((bbpj)localObject).a(localAIOFilePictureData, 20) == null) && (((bbpj)localObject).a(localAIOFilePictureData, 18) == null) && (((bbpj)localObject).a(localAIOFilePictureData, 16) == null) && ((auoo.a(localAIOFilePictureData.jdField_e_of_type_Int, localAIOFilePictureData.f, localAIOFilePictureData.jdField_e_of_type_Long)) || (localAIOFilePictureData.jdField_g_of_type_Int == 1))) {
        this.jdField_a_of_type_Bbpr.a().b();
      }
    }
    updateUI();
  ...
  public void updateUI()
  {
    ...
    case 1: 
      ...
      g(false);
      d(false);
      this.jdField_a_of_type_Bbpr.onLoadStart(this.jdField_a_of_type_Bbpr.getSelectedIndex(), localAIOFilePictureData.progress);
      return;
    case 2: 
      this.jdField_a_of_type_Bbpr.onLoadFinish(this.jdField_a_of_type_Bbpr.getSelectedIndex(), true);
      f(false);
      c(false);
      g(false);
      d(false);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131698975) + localAIOFilePictureData.progress / 100 + "%");
    ...
    c(b());
    d(a(this.jdField_a_of_type_Bbpr.getSelectedItem()));
    boolean bool;
    bbpj localbbpj;
    if (!auog.b(localAIOFilePictureData.jdField_d_of_type_JavaLangString))
    {
      bool = true;
      f(bool);
      g(true);
    ...
    for (;;)
    {
      ...
      break;
      label324:
      if ((localbbpj.a(localAIOFilePictureData, 18) != null) || (localbbpj.a(localAIOFilePictureData, 20) != null)) {
        h(true);
      } else {
        h(false);
      }
  ...
  {
    paramString1 = null;
    paramString2 = this.jdField_a_of_type_Bbpr.getItem(paramInt);
    Object localObject;
    ImageView localImageView;
    AIOFilePictureData localAIOFilePictureData;
    if ((paramString2 != null) && (paramString2.baseData != null) && (paramString2.baseData.getType() == 102) && (this.mBrowserItemView != null) && ((paramView.getTag() instanceof bbqv)))
    {
      localObject = (bbqv)paramView.getTag();
      paramView = ((bbqv)localObject).jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView;
      localImageView = ((bbqv)localObject).jdField_a_of_type_AndroidWidgetImageView;
      localObject = ((bbqv)localObject).jdField_a_of_type_AndroidWidgetTextView;
      localAIOFilePictureData = (AIOFilePictureData)paramString2.baseData;
      paramString2 = new bbpj();
    ...
    {
      if ((paramString2 == null) && (auog.b(localAIOFilePictureData.jdField_b_of_type_JavaLangString)))
      {
        paramString1 = URLDrawable.URLDrawableOptions.obtain();
        paramString1.mLoadingDrawable = beyq.a;
        paramString1.mFailedDrawable = beyq.a;
      ...
      do
      {
        ...
        if ((auoo.a(localAIOFilePictureData.jdField_e_of_type_Int, localAIOFilePictureData.f, localAIOFilePictureData.jdField_e_of_type_Long)) || (localAIOFilePictureData.jdField_g_of_type_Int == 1))
        {
          paramString1 = BaseApplicationImpl.getApplication().getResources().getDrawable(2130844282);
          localImageView.setVisibility(0);
          localImageView.setImageDrawable(paramString1);
          ((TextView)localObject).setVisibility(0);
          ((TextView)localObject).setText(2131692195);
          this.jdField_a_of_type_Bbpr.a().b();
        }
        for (;;)
        {
          this.jdField_a_of_type_Bbpr.onLoadFinish(paramInt, false);
          this.jdField_a_of_type_Bbpr.a().d();
          return;
          paramString1 = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838072);
          paramView.setImageDrawable(paramString1);
      ...
      bindView(paramInt);
      paramString2 = bhmi.b(localAIOFilePictureData.jdField_c_of_type_JavaLangString);
      ...
      this.jdField_a_of_type_Bbpr.a().c();
      return;
    }
  }
}
