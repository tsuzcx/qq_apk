...
public class afzi
  implements DialogInterface.OnDismissListener, AdapterView.OnItemClickListener, bles
{
  ...
  public aasr a;
  private afzk jdField_a_of_type_Afzk;
  public Activity a;
  ...
  public afzi(Activity paramActivity, WebView paramWebView)
  {
  ...
  public void a(int paramInt, String paramString, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        ...
        znl.a(2, 2131691266);
        if ((this.h) && (!TextUtils.isEmpty(this.jdField_a_of_type_Aasr.p))) {
      ...
      for (;;)
      {
        ...
        if (paramInt == 11)
        {
          ...
          try
          {
            ...
            if (i != 0)
            {
              ...
              olh.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1008, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
            }
          }
        ...
        else
        {
          if (paramInt == 2)
          {
            ...
            for (;;)
            {
              this.jdField_a_of_type_Aasr.g = bool1;
          ...
          if (paramInt == 4)
          {
            ...
            try
            {
              ...
              bdla.b(null, "P_CliOper", "VIPCOMIC", "", "0X800619F", "0X800619F", 1000, 0, nwo.b(str2, new String[0]), null, null, null);
              bdla.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_48", "browser_share", 0, 1, 0, "", "", "", "");
              if ((str3 == null) || ("".equals(str3))) {
                continue;
              }
              olh.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1006, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
            }
          ...
          else if (paramInt != 5)
          {
            if (paramInt == 3)
            {
              ...
              uuc.a(1002, (String)localObject1, this.jdField_b_of_type_Int);
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Aasr.p)) {
                this.jdField_a_of_type_Aasr.a((String)localObject4, 2, false);
              }
              for (;;)
              {
            ...
            if (paramInt == 6)
            {
              if (this.jdField_a_of_type_Aasr.a((String)localObject4)) {
                this.jdField_a_of_type_Aasr.a((String)localObject4, 9, false);
              }
              if ((str3 != null) && (!"".equals(str3))) {
                olh.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1007, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
              }
            }
            else if ((paramInt == 9) || (paramInt == 10))
            {
              ...
              if (paramInt == 9)
              {
                uuc.a(1003, (String)localObject1, this.jdField_b_of_type_Int);
              ...
              for (;;)
              {
                ...
                break;
                uuc.a(1004, (String)localObject1, this.jdField_b_of_type_Int);
                break label1289;
              ...
              {
                if (!TextUtils.isEmpty(this.jdField_a_of_type_Aasr.p)) {
                  this.jdField_a_of_type_Aasr.a((String)localObject4, 3, true);
                }
                for (;;)
                {
                  ...
                  olh.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1003, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
                  break;
              ...
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Aasr.p)) {
                this.jdField_a_of_type_Aasr.a((String)localObject4, 4, true);
              }
              for (;;)
              {
            ...
            {
              this.jdField_a_of_type_Aasr.a((String)localObject4, 5, true);
            }
            else if (paramInt == 15)
            {
              if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment == null) {
              ...
              a().a(j, new afzj(this));
              bdla.b(null, "P_CliOper", "Grp_open", "", "third_app", "add_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 16)
            {
              ...
              this.jdField_a_of_type_AndroidAppActivity.startActivity(paramString);
              bdla.b(null, "P_CliOper", "Grp_open", "", "third_app", "detail_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 17)
            {
              paramString = "";
              ...
              paramBundle.putExtra("hide_more_button", true);
              this.jdField_a_of_type_AndroidAppActivity.startActivity(paramBundle);
              bdla.b(null, "P_CliOper", "Grp_open", "", "third_app", "share_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 7)
            {
              b();
            ...
            else if ((paramInt == 19) || (paramInt == 20))
            {
              ...
              for (i = 6;; i = 7)
              {
                ...
                this.jdField_a_of_type_Aasr.a((String)localObject4, i, false);
                break;
              }
              this.jdField_a_of_type_Aasr.a((String)localObject4, i, true);
            }
            else
            {
              if (paramInt == 12)
              {
                if (!TextUtils.isEmpty(this.jdField_a_of_type_Aasr.p)) {
                  this.jdField_a_of_type_Aasr.a((String)localObject4, 8, false);
                }
                for (;;)
                {
                  ...
                  olh.a(null, "", "0X800787A", "0X800787A", 0, 0, (String)localObject1, paramBundle, "", "");
                  uuc.a(1005, paramBundle, this.jdField_b_of_type_Int);
                  break;
                  this.jdField_a_of_type_Aasr.a((String)localObject4, 8, false);
                }
              }
              ...
              else if (paramInt == 35)
              {
                ...
                if (this.jdField_b_of_type_JavaUtilArrayList != null)
                {
                  ...
                  do
                  {
                    ...
                    paramString = (okk)((Iterator)localObject2).next();
  ...
  public void a(aasr paramaasr)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Long = this.jdField_a_of_type_Afzk.jdField_a_of_type_Long;
      a();
      c();
      ...
      this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(BaseApplicationImpl.getApplication().getString(2131718786));
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Afzk = new afzk();
      ...
      try
      {
        this.jdField_a_of_type_Afzk.jdField_a_of_type_Long = Long.parseLong(str, 10);
      ...
      catch (NumberFormatException localNumberFormatException2)
      {
        try
        {
          this.jdField_a_of_type_Afzk.jdField_b_of_type_Long = Long.parseLong(str, 10);
        ...
        catch (NumberFormatException localNumberFormatException2)
        {
          try
          {
            for (;;)
            {
              this.jdField_a_of_type_Afzk.c = Long.parseLong(str, 10);
              ...
              try
              {
                this.jdField_a_of_type_Afzk.d = Long.parseLong(paramString, 10);
                return;
              }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      uuc.a(1001, paramString3, this.jdField_b_of_type_Int);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Aasr.p)) {
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a()
  {
    ...
    for (Object localObject1 = BaseApplicationImpl.getApplication().getRuntime();; localObject1 = null)
    {
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (!uta.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:qq")) && ((this.jdField_a_of_type_Long & 0x8) == 0L))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696130);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839146;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696143);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839147;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
      ...
      if (((this.jdField_a_of_type_Long & 0x8000000) != 0L) && (bmhv.a()) && (!uta.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:kandian")) && (localObject1 != null))
      {
        ...
        {
          localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
          ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696144);
          ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839145;
          ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696150);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839150;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696133);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839144;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).action = 10;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).argus = "";
        localArrayList.add(localObject2);
      }
      if ((this.g) && (!uta.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:sinaWeibo")))
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696147);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839149;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696126);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130842695;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696127);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130842691;
      ...
      if ((!uta.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:qiDian")) && ((this.jdField_a_of_type_Long & 0x10) == 0L)) {
        bjxa.a(this.jdField_a_of_type_AndroidAppActivity, localArrayList);
      }
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131696141);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130844390;
      ...
      if ((this.jdField_e_of_type_Boolean) && (this.jdField_b_of_type_JavaUtilArrayList != null))
      {
        ...
        {
          localObject3 = (okk)localIterator.next();
          ...
          case 2: 
            ...
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).label = BaseApplicationImpl.getApplication().getString(2131695016);
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).icon = 2130842689;
      ...
      if ((this.jdField_f_of_type_Boolean) && (this.jdField_b_of_type_JavaUtilArrayList != null))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          case 3: 
            localObject3 = new ShareActionSheetBuilder.ActionSheetItem();
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).label = BaseApplicationImpl.getApplication().getString(2131696131);
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).icon = 2130842698;
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).iconNeedBg = true;
      ...
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (!uta.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:favorite")) && ((this.jdField_a_of_type_Long & 0x2000) == 0L))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).icon = 2130844149;
      ...
      if ((!uta.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:setFont")) && (!this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Boolean))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).icon = 2130842693;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).iconNeedBg = true;
      ...
      if ((!uta.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:copyUrl")) && ((this.jdField_a_of_type_Long & 0x20) == 0L))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).icon = 2130839142;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).iconNeedBg = true;
      ...
      if ((!uta.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:exposeArticle")) && (this.jdField_b_of_type_Boolean))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).icon = 2130842681;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).iconNeedBg = true;
  ...
  public void b()
  {
    Object localObject = this.jdField_a_of_type_AndroidAppActivity.getLayoutInflater().inflate(2131559190, null);
    ...
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new blew(anvx.a(2131701916), TypedValue.applyDimension(1, 15.0F, FontSettingManager.systemMetrics)));
    localArrayList.add(new blew(anvx.a(2131701920), TypedValue.applyDimension(1, 16.0F, FontSettingManager.systemMetrics)));
    localArrayList.add(new blew("", TypedValue.applyDimension(1, 17.0F, FontSettingManager.systemMetrics)));
    localArrayList.add(new blew("", TypedValue.applyDimension(1, 17.0F, FontSettingManager.systemMetrics)));
    localArrayList.add(new blew(anvx.a(2131701919), TypedValue.applyDimension(1, 18.0F, FontSettingManager.systemMetrics)));
    ...
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131691092));
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131691093));
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131691094));
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131691095));
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131691096));
