...
public class qnc
{
  private static final String jdField_a_of_type_JavaLangString = qnc.class.getSimpleName();
  ...
  public qnc(ColorBandVideoEntranceButton paramColorBandVideoEntranceButton, Context paramContext)
  {
    ...
    paramColorBandVideoEntranceButton = onk.a();
    ...
    for (;;)
    {
      this.jdField_a_of_type_Npv = ((npv)paramColorBandVideoEntranceButton.a(90));
      this.jdField_a_of_type_Npw = new qnd(this, null);
      paramColorBandVideoEntranceButton.addObserver(this.jdField_a_of_type_Npw);
      this.jdField_a_of_type_Qnf = new qnf(this, null);
      osm.a().a(this.jdField_a_of_type_Qnf);
      return;
      label121:
  ...
  {
    SharedPreferences localSharedPreferences = bhvh.a(this.jdField_c_of_type_JavaLangString);
  ...
  private VideoInfo a()
  {
    Object localObject = bhvh.a(this.jdField_c_of_type_JavaLangString);
  ...
  public static void a(rva paramrva)
  {
    qjn.a().a(paramrva);
    if (paramrva == null) {}
    label201:
    ...
    do
    {
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            if (!(paramrva instanceof VideoInfo)) {
              break label244;
            }
            localObject = (VideoInfo)paramrva;
            ...
            if (localObject != null)
            {
              ...
              paramrva = ((VideoInfo)localObject).jdField_g_of_type_JavaLangString;
              localJSONObject.put("rowkey", paramrva);
              noo.a(null, "CliOper", "", "", "0X80081C6", "0X80081C6", 0, 0, "", "", "", localJSONObject.toString(), false);
              if (QLog.isColorLevel()) {
              ...
              noo.a(null, "", "0X8009A22", "0X8009A22", 0, 0, "", "", "", onk.a((VideoInfo)localObject, i), false);
              return;
            }
          }
          catch (Exception paramrva)
          {
            paramrva.printStackTrace();
            return;
          }
          i = 1;
          continue;
      ...
      noo.a(null, "", "0X80094FE", "0X80094FE", 0, 0, "", "", "", onk.a((VideoInfo)localObject, i), false);
      return;
    } while (!(paramrva instanceof VideoInfo.EntranceDownloadInfo));
    paramrva = (VideoInfo.EntranceDownloadInfo)paramrva;
    Object localObject = new qze("", "", "", "");
    ((qze)localObject).W(1).a(paramrva.jdField_c_of_type_JavaLangString).a(0);
    noo.a(null, "", "0X80094FE", "0X80094FE", 0, 0, "", "", "", ((qze)localObject).a().a(), false);
  }
  ...
  public static void b(rva paramrva)
  {
    ThreadManager.excute(new VideoFeedsFirstVideoRecommendationManager.1(paramrva), 16, null, true);
  }
  ...
  private void e()
  {
    ...
    {
      localObject = bhvh.a(this.jdField_c_of_type_JavaLangString);
      if (localObject != null) {
  ...
  {
    boolean bool;
    if ((this.jdField_a_of_type_Npv != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetReddotColorBandVideoEntranceButton != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetReddotColorBandVideoEntranceButton.getVisibility() == 0) && (!this.jdField_a_of_type_Boolean))
    {
      npv localnpv = this.jdField_a_of_type_Npv;
      npw localnpw = this.jdField_a_of_type_Npw;
      String str = this.jdField_b_of_type_JavaLangString;
      if (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null)
      {
        bool = true;
        localnpv.a(localnpw, str, paramInt, bool);
        if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    ...
    if ((localQQAppInterface != null) && (this.jdField_a_of_type_Npw != null)) {
      localQQAppInterface.removeObserver(this.jdField_a_of_type_Npw);
    }
  }
  ...
  public void c()
  {
    ...
    osm.a().b(this.jdField_a_of_type_Qnf);
  }
  ...
  public void d()
  {
    ...
    {
      this.jdField_a_of_type_Npv = ((npv)localQQAppInterface.a(90));
      localQQAppInterface.addObserver(this.jdField_a_of_type_Npw);
