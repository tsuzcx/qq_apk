...
public class bmaa
{
  ...
  {
    return bmac.a().a("contentboxlaunch", "gocontentboxminiprogram", 0);
  }
  ...
  public static void a(bmab parambmab)
  {
    if (parambmab != null) {
      QzoneHandlerThreadFactory.getHandlerThread("Normal_HandlerThread").post(new QZoneConfigHelper.1(parambmab));
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    try
    {
      boolean bool = ((axft)paramQQAppInterface.getManager(10)).b();
      return bool;
    }
