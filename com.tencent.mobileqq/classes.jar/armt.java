  ...
  implements Manager
{
  ...
  public ConcurrentHashMap<Long, arms> a;
  public MqqHandler a;
  ...
  private ConcurrentHashMap<String, ConcurrentHashMap<String, army>> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  public boolean b;
  ...
  private ConcurrentHashMap<String, ConcurrentHashMap<String, armx>> jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bedk.a(anhk.ba + "DoutuRes" + File.separator);
  }
  
  public armt(QQAppInterface paramQQAppInterface)
  {
  ...
  private int a(List<ChatMessage> paramList, SessionInfo paramSessionInfo, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (j != 0)
      {
        ...
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FA7", "0X8007FA7", 0, 0, "", "", "", "");
  ...
  public static void a(RelativeLayout paramRelativeLayout, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (armt)paramQQAppInterface.getManager(214);
  ...
  private void a(ChatMessage paramChatMessage)
  {
    ...
    if (paramChatMessage.isSend())
    {
      ...
      if (((MessageForMarketFace)localObject2).mMarkFaceMessage != null)
      {
        ...
        paramChatMessage = arpm.a(paramChatMessage.sbufID, paramChatMessage.mediaType);
      }
      i = 1;
    }
    for (;;)
    {
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AF0B", "0X800AF0B", 0, 0, String.valueOf(i), "", paramChatMessage, "");
      return;
      label84:
        ...
        for (paramList.isDui = false;; paramList.isDui = false)
        {
          do
          {
            if (paramList.isDui)
            {
              ...
              {
                bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008012", "0X8008012", 0, 0, "", "", "", "");
  ...
  private boolean a(String paramString)
  {
    ...
    if (bgsg.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))
    {
      if (QLog.isColorLevel()) {
      ...
      for (paramInt = 0;; paramInt = i)
      {
        ...
        for (;;)
        {
          if (paramInt > 0)
          {
            ...
            {
              bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008095", "0X8008095", 0, 0, "", "", "", "");
              this.jdField_e_of_type_Int = (localArrayList.size() - 1);
              if (paramInt == 3) {
                bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008094", "0X8008094", 0, 0, "", "", "", "");
              }
            }
          }
          ...
          for (;;)
          {
            ...
            paramList = new arnd(paramList.senderuin, paramInt - 2, bool);
  ...
  private void f()
  {
    this.jdField_f_of_type_Boolean = bgsg.k(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_c_of_type_Boolean = bgsg.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_d_of_type_Boolean = bgsg.l(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_b_of_type_Boolean = bgsg.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    long l1 = bgsg.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    int i = bgsg.ap(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    long l2 = bgsg.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    long l3 = bgsg.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    int j = bgsg.am(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (l1 > 0L) {
  ...
  public int a(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((armx)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Int;
    }
    return 0;
  }
  ...
  public long a(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((army)((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Long;
    }
    return 0L;
  }
  ...
  public void a(long paramLong)
  {
    ...
    {
      localObject = (arms)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong));
      ((arms)localObject).jdField_a_of_type_Int += 1;
    }
    if (QLog.isColorLevel())
    {
    ...
    label203:
    for (int i = ((arms)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int;; i = 0)
    {
      QLog.i("DoutuManager", 2, i);
      if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong)) != null) && (((arms)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int >= 1))
      {
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Long.valueOf(paramLong));
        if ((this.jdField_a_of_type_Armo != null) && (this.jdField_a_of_type_Armo.jdField_a_of_type_Long == paramLong)) {
  ...
  public void a(Context paramContext, ViewGroup paramViewGroup, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler, arms paramarms)
  {
    ...
    Object localObject = (LinearLayout)paramViewGroup.findViewById(2131365648);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
      ...
      paramViewGroup = (DoutuEmotionHorizonListView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365651);
      this.jdField_a_of_type_Armo = ((armo)paramViewGroup.getAdapter());
      if (this.jdField_a_of_type_Armo == null)
      {
        this.jdField_a_of_type_Armo = new armo(paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseActivity, paramSessionInfo, paramMqqHandler, this.jdField_b_of_type_Boolean, paramarms, this.jdField_a_of_type_Int);
        paramViewGroup.setAdapter(this.jdField_a_of_type_Armo);
      }
      c();
    }
    for (;;)
    {
      if ((this.jdField_g_of_type_Long <= 0L) || (System.currentTimeMillis() - this.jdField_g_of_type_Long <= 0L) || (System.currentTimeMillis() - this.jdField_g_of_type_Long >= 1000L))
      {
          ...
          if (paramContext.hasNext())
          {
            ...
            if (this.jdField_c_of_type_JavaUtilList.size() < 20)
            {
              ...
              if (!TextUtils.isEmpty(paramBaseActivity.pic_md5))
              {
                ...
                this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)View.inflate(paramContext, 2131558593, null));
                localObject = (DoutuEmotionHorizonListView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365651);
                this.jdField_a_of_type_Armo = new armo(paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseActivity, paramSessionInfo, paramMqqHandler, this.jdField_b_of_type_Boolean, paramarms, this.jdField_a_of_type_Int);
                ((DoutuEmotionHorizonListView)localObject).setAdapter(this.jdField_a_of_type_Armo);
                ((DoutuEmotionHorizonListView)localObject).setOnScrollStateChangedListener(new armu(this));
                ((DoutuEmotionHorizonListView)localObject).setTouchListener(new armw(this, paramMqqHandler));
        ...
        if (this.jdField_a_of_type_Armo != null)
        {
          this.jdField_a_of_type_Armo.jdField_b_of_type_JavaUtilList = new ArrayList();
          this.jdField_a_of_type_Armo.jdField_b_of_type_JavaUtilList.addAll(this.jdField_c_of_type_JavaUtilList);
        }
        this.jdField_b_of_type_JavaUtilList.clear();
        h();
        label568:
        if (this.jdField_a_of_type_Armo != null)
        {
          this.jdField_a_of_type_Armo.a();
          this.jdField_a_of_type_Armo.notifyDataSetChanged();
        }
    ...
    label818:
    label856:
    for (paramContext = paramarms.toString();; paramContext = "")
    {
      QLog.d("DoutuManager", 2, paramContext);
      if ((paramarms != null) && (paramarms.a()) && (this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Armo != null))
      {
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Long.valueOf(this.jdField_a_of_type_Armo.jdField_a_of_type_Long), new arms(this.jdField_a_of_type_Armo.jdField_a_of_type_Long, 0));
        a(paramarms, paramSessionInfo, this.jdField_a_of_type_Armo.jdField_a_of_type_Long);
      }
      if (Build.VERSION.SDK_INT >= 14) {
        paramViewGroup.setScrollX(0);
      }
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(0);
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FA9", "0X8007FA9", 0, 0, "", "", "", "");
  ...
  public void a(arms paramarms, SessionInfo paramSessionInfo, long paramLong)
  {
    ThreadManager.post(new DoutuManager.4(this, paramarms, paramLong, paramSessionInfo), 5, null, true);
  }
  ...
  public void a(SessionInfo paramSessionInfo, ChatMessage paramChatMessage)
  {
    ...
    {
      ((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramChatMessage)).put(paramSessionInfo, new army(this, l1, l2));
      return;
    }
    ConcurrentHashMap localConcurrentHashMap = new ConcurrentHashMap();
    localConcurrentHashMap.put(paramSessionInfo, new army(this, l1, l2));
  ...
  public void a(SessionInfo paramSessionInfo, ChatMessage paramChatMessage, int paramInt1, int paramInt2)
  {
    ...
    {
      ((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).put(paramSessionInfo, new armx(this, l1, l2, paramChatMessage.senderuin, paramInt1, paramInt2));
      return;
    }
    ConcurrentHashMap localConcurrentHashMap = new ConcurrentHashMap();
    localConcurrentHashMap.put(paramSessionInfo, new armx(this, l1, l2, paramChatMessage.senderuin, paramInt1, paramInt2));
  ...
  public void a(List<ChatMessage> paramList, SessionInfo paramSessionInfo, BaseChatPie paramBaseChatPie, int paramInt)
  {
    ...
    label17:
    while (bgjw.b(paramSessionInfo.jdField_a_of_type_JavaLangString)) {
      return;
    }
    if (c()) {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    bgsg.h(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramBoolean);
    if (paramBoolean) {
  ...
  public void a(boolean paramBoolean, List<DoutuData> paramList)
  {
    ...
    if ((this.jdField_a_of_type_Armo != null) && (this.jdField_c_of_type_JavaUtilList.size() == 0))
    {
      if (QLog.isColorLevel()) {
      ...
      h();
      this.jdField_a_of_type_Armo.a();
      if (this.jdField_a_of_type_Armo.jdField_a_of_type_MqqOsMqqHandler != null) {
        this.jdField_a_of_type_Armo.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(81);
      }
    }
    int i;
    if (this.jdField_b_of_type_JavaUtilList.size() > 0) {
  ...
  public void a(boolean paramBoolean, List<DoutuData> paramList, long paramLong)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      i = ((arms)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int;
  ...
  public long b(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((armx)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Long;
    }
    return 0L;
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout != null)
    {
      ...
      this.jdField_a_of_type_Armo = null;
      this.jdField_c_of_type_JavaUtilList.clear();
      this.jdField_a_of_type_JavaUtilList.clear();
      g();
    }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    a();
    if ((bgnt.a(BaseApplication.getContext())) && (!paramBoolean)) {
      e();
    }
  }
  ...
  public long c(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((armx)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_b_of_type_Long;
    }
    return 0L;
  }
  ...
  {
    if (this.jdField_a_of_type_Armo == null) {}
    while ((this.jdField_a_of_type_Armo.jdField_a_of_type_JavaUtilHashMap == null) && (this.jdField_a_of_type_Armo.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData == null)) {
      return;
    }
    Object localObject1 = new armz();
    ((armz)localObject1).jdField_a_of_type_JavaLangString = "dc03631";
    localObject1.getClass();
    Object localObject2 = new arna((armz)localObject1);
    ((arna)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
    if (this.jdField_a_of_type_Armo.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData != null)
    {
      ((arna)localObject2).d = this.jdField_a_of_type_Armo.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData.pic_md5;
      ((arna)localObject2).e = this.jdField_a_of_type_Armo.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData.pic_down_url;
    }
    if (this.jdField_a_of_type_Armo.jdField_a_of_type_Arms != null)
    {
      ((arna)localObject2).c = this.jdField_a_of_type_Armo.jdField_a_of_type_Arms.c;
      ((arna)localObject2).jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Armo.jdField_a_of_type_Arms.jdField_b_of_type_JavaLangString;
    }
    if ((this.jdField_a_of_type_Armo.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_Armo.jdField_a_of_type_JavaUtilHashMap.size() > 0))
    {
      ArrayList localArrayList1 = new ArrayList();
      ArrayList localArrayList2 = new ArrayList();
      Iterator localIterator = this.jdField_a_of_type_Armo.jdField_a_of_type_JavaUtilHashMap.keySet().iterator();
      while (localIterator.hasNext())
      {
        String str = (String)localIterator.next();
        localArrayList1.add(str);
        localArrayList2.add(this.jdField_a_of_type_Armo.jdField_a_of_type_JavaUtilHashMap.get(str));
      }
      ((arna)localObject2).jdField_a_of_type_JavaUtilArrayList = localArrayList1;
      ((arna)localObject2).jdField_b_of_type_JavaUtilArrayList = localArrayList2;
    }
    int i;
    if (this.jdField_a_of_type_Armo.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null)
    {
      i = this.jdField_a_of_type_Armo.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int;
      if (i != 0) {
        break label401;
      }
      ((arna)localObject2).f = "c2c";
    }
    for (;;)
    {
      ((arna)localObject2).h = this.jdField_a_of_type_Armo.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
      ((arna)localObject2).g = "android";
      ((armz)localObject1).jdField_a_of_type_Arna = ((arna)localObject2);
      localObject1 = ((armz)localObject1).a();
      localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), arnb.class);
      ...
      this.jdField_a_of_type_Armo.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData = null;
      this.jdField_a_of_type_Armo.jdField_a_of_type_JavaUtilHashMap = null;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject2);
      return;
      label401:
      if (i == 1) {
        ((arna)localObject2).f = "group";
      } else if (i == 3000) {
        ((arna)localObject2).f = "discuss";
      } else {
        ((arna)localObject2).f = "other";
      }
    }
  }
  ...
  public boolean d()
  {
    return a(bgsg.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()));
  }
  ...
  public void e()
  {
    ...
    String str1 = bgsg.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    String str2 = bgsg.l(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    ...
    if (!a(str1))
    {
      ...
      bhhf localbhhf = new bhhf(str2, new File(str3));
      localbhhf.n = true;
      ...
      localbhhk.a(localbhhf, new armv(this, str2, str3, str1), null);
      return;
    }
    DuiButtonImageView.a();
    jdField_a_of_type_Boolean = false;
