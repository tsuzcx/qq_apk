...
public class bfmq
{
  ...
  protected static HttpURLConnection a(bfmr parambfmr)
  {
    for (;;)
    {
      try
      {
        localObject1 = MsfSdkUtils.insertMtype("yingyongbao", parambfmr.jdField_b_of_type_JavaLangString);
        if (bflk.a(bfbm.a().a()))
        {
          i = "http://".length();
          localObject3 = bflk.c(bfbm.a().a());
          String str = bflk.d(bfbm.a().a());
          j = ((String)localObject1).indexOf('/', i);
          if (j < 0)
          {
            localObject2 = ((String)localObject1).substring(i);
            localObject1 = "";
            bflp.c(jdField_a_of_type_JavaLangString, "http://" + (String)localObject3 + ":" + str + (String)localObject1);
            localObject3 = (HttpURLConnection)new URL("http://" + (String)localObject3 + ":" + str + (String)localObject1).openConnection();
            localObject1 = localObject3;
          }
        }
      }
      catch (Exception parambfmr)
      {
        int j;
        Object localObject2;
        localObject3 = null;
        bflp.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- Exception!!!", parambfmr);
      ...
      try
      {
        ...
        localObject3 = localObject1;
        if (parambfmr.jdField_c_of_type_Long > 0L)
        {
          localObject3 = localObject1;
          ...
          localObject3 = localObject1;
          ((HttpURLConnection)localObject1).setRequestProperty("If-Modified-Since", ((SimpleDateFormat)localObject2).format(new Date(parambfmr.jdField_c_of_type_Long)));
        }
        localObject3 = localObject1;
        i = ((HttpURLConnection)localObject1).getResponseCode();
        localObject3 = localObject1;
        bflp.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- reponseCode=" + i);
        if ((i == 302) || (i == 301))
        {
          localObject3 = localObject1;
          parambfmr = ((HttpURLConnection)localObject1).getHeaderField("Location");
          localObject3 = localObject1;
          bflp.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- loc=" + parambfmr);
          localObject3 = localObject1;
          a((HttpURLConnection)localObject1);
          parambfmr = null;
          localObject1 = parambfmr;
          bflp.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- uc=" + parambfmr);
          return parambfmr;
      ...
      if (localObject2 != null)
      {
        ...
        parambfmr.jdField_a_of_type_Long = (a((HttpURLConnection)localObject2) * 1000L);
        localObject3 = localObject2;
        if (parambfmr.jdField_a_of_type_Long == 0L)
        {
          localObject3 = localObject2;
          parambfmr.jdField_a_of_type_Long = 86400000L;
        }
      }
      localObject3 = localObject2;
      parambfmr.jdField_b_of_type_Long = System.currentTimeMillis();
      parambfmr = (bfmr)localObject2;
      continue;
      localObject3 = localObject1;
      ...
      {
        localObject3 = localObject1;
        bflp.c(jdField_a_of_type_JavaLangString, "--getimg-- " + parambfmr.jdField_b_of_type_JavaLangString + " not modified");
        localObject3 = localObject1;
        parambfmr.jdField_a_of_type_Long = (a((HttpURLConnection)localObject1) * 1000L);
        localObject3 = localObject1;
        parambfmr.jdField_b_of_type_Long = System.currentTimeMillis();
        localObject3 = localObject1;
        a((HttpURLConnection)localObject1);
  ...
  protected static void a(HttpURLConnection paramHttpURLConnection)
  {
    ...
    {
      bflp.c("", "", paramHttpURLConnection);
    }
  }
  
  /* Error */
  public static boolean a(bfmr parambfmr)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 12
    ...
    //   7: istore 6
    //   9: aload_0
    //   10: invokestatic 274	bfmq:a	(Lbfmr;)Ljava/net/HttpURLConnection;
    //   13: astore 7
    //   15: aload 7
    //   17: ifnonnull +91 -> 108
    //   20: getstatic 14	bfmq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   36: aload_0
    //   37: getfield 72	bfmr:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   52: invokestatic 131	bflp:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   55: iconst_0
    //   56: ifeq +11 -> 67
    ...
    //   113: i2l
    //   114: lstore_3
    //   115: invokestatic 291	bfiu:a	()J
    //   118: lload_3
    //   119: lcmp
    //   120: ifge +86 -> 206
    //   123: getstatic 14	bfmq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   139: aload_0
    //   140: getfield 72	bfmr:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   155: invokestatic 131	bflp:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   158: iconst_0
    //   159: ifeq +11 -> 170
    ...
    //   213: lconst_0
    //   214: lstore_3
    //   215: getstatic 16	bfmq:jdField_a_of_type_Int	I
    //   218: newarray byte
    //   220: astore 9
    ...
    //   233: aload 9
    //   235: iconst_0
    //   236: getstatic 16	bfmq:jdField_a_of_type_Int	I
    //   239: invokevirtual 306	java/io/InputStream:read	([BII)I
    //   242: istore_2
    //   243: iload_2
    //   244: ifle +77 -> 321
    //   247: getstatic 19	bfmq:b	I
    //   250: istore_1
    //   251: lload_3
    //   252: iload_1
    //   253: i2l
    ...
    //   328: invokestatic 316	bfiu:e	()Ljava/lang/String;
    ...
    //   340: aload_0
    //   341: getfield 321	bfmr:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   353: aload_0
    //   354: getfield 72	bfmr:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   357: invokestatic 330	bflm:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   524: ldc_w 372
    //   527: aload_0
    //   528: getfield 373	bfmr:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   531: invokestatic 131	bflp:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   534: aload_0
    //   535: aload 7
    //   537: invokevirtual 376	java/net/HttpURLConnection:getLastModified	()J
    //   540: putfield 169	bfmr:jdField_c_of_type_Long	J
    //   543: iconst_1
    //   544: istore 5
    //   546: aload 9
    //   548: ifnull +8 -> 556
    ...
    //   596: aconst_null
    //   597: astore 8
    //   599: getstatic 14	bfmq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   602: ldc_w 379
    //   605: aload 9
    //   607: invokestatic 268	bflp:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   610: aload 10
    //   612: ifnull +17 -> 629
    //   615: aload 10
