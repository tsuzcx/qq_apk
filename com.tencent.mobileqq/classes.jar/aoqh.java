  ...
  extends aoqb
{
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new aoqj(null));
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    aoqj localaoqj = (aoqj)paramView.getTag();
    int i = 0;
    for (;;)
    {
      View localView;
      if (i < 4)
      {
        localView = a(paramInt1, paramInt2 * 4 + i, paramBoolean, localaoqj.a[i], paramViewGroup);
        if (localView != null) {}
      }
      else
      {
      ...
      for (;;)
      {
        try
        {
          ...
          try
          {
            localaoqa = new aoqa();
            paramView = paramViewGroup;
            localaoqa.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramViewGroup.findViewById(2131367776));
            paramView = paramViewGroup;
            localaoqa.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131367793));
            paramView = paramViewGroup;
            localaoqa.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131367790));
            paramView = paramViewGroup;
            ...
            paramView = paramViewGroup;
            paramViewGroup.setTag(localaoqa);
            paramView = paramViewGroup;
            ((FileInfo)localObject).a((String)getGroup(paramInt1));
            paramView = paramViewGroup;
            localaoqa.jdField_a_of_type_JavaLangObject = localObject;
            paramView = paramViewGroup;
            ...
            if (((FileInfo)localObject).c() != null)
            {
              ...
              {
                paramView = paramViewGroup;
                if (apvd.b(((FileInfo)localObject).c()))
                {
                  paramView = paramViewGroup;
                  localaoqa.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setAsyncImage(((FileInfo)localObject).c());
                }
              }
            }
            paramView = paramViewGroup;
            ...
            if (apel.a((FileInfo)localObject))
            {
              ...
              paramView = paramViewGroup;
              localaoqa.jdField_a_of_type_AndroidWidgetImageView.setContentDescription((CharSequence)localObject);
              paramView = paramViewGroup;
              localaoqa.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setContentDescription((CharSequence)localObject);
              return paramViewGroup;
            ...
            paramView = paramViewGroup;
            localObject = str + ajya.a(2131709689);
            paramView = paramViewGroup;
