...
public class uxr
{
  ...
  public static int a(int paramInt, stMetaUgcVideoSeg paramstMetaUgcVideoSeg)
  {
    if ((paramstMetaUgcVideoSeg == null) || (paramstMetaUgcVideoSeg.width == 0))
    {
      ...
      {
        uya.d("WSFeedUtils", paramstMetaUgcVideoSeg);
        return paramInt * 4 / 3;
      }
    }
    uya.b("WSFeedUtils", "[getClippedVideoHeight] width: " + paramstMetaUgcVideoSeg.width + ", height: " + paramstMetaUgcVideoSeg.height);
  ...
  {
    uya.b("WSFeedUtils", "feed create time: " + paramInt + ", corresponding date: " + new Date(paramInt * 1000));
    long l = System.currentTimeMillis() / 1000L - paramInt;
    if ((l >= 0L) && (l < 60L)) {
      return b(2131693212);
    }
    if ((l >= 60L) && (l < 3600L)) {
      return String.format(b(2131693213), new Object[] { Long.valueOf(l / 60L) });
    }
    if ((l >= 3600L) && (l < 86400L)) {
      return a(2131693211, new Object[] { Long.valueOf(l / 3600L) });
    }
    if ((l >= 86400L) && (l < 2592000L)) {
      return a(2131693207, new Object[] { Long.valueOf(l / 86400L) });
    }
    return a(2131693207, new Object[] { Integer.valueOf(30) });
  }
  ...
  public static List<use> a(List<stFeed> paramList, int paramInt, boolean paramBoolean)
  {
  ...
  {
    LocalMultiProcConfig.putBool("weishi_usergrowth" + uyo.a(), "key_player_mute_guide_show", true);
  }
  ...
  public static void a(Activity paramActivity, stSchema paramstSchema, int paramInt1, int paramInt2, String paramString)
  {
    ...
    default: 
      return;
    case 1: 
      ukw.a(paramActivity, paramstSchema.miniAppSchema, null);
      return;
    case 2: 
      a(paramActivity, paramstSchema.schema, paramInt1, paramInt2, paramString);
      return;
    }
    ukw.a(paramActivity, paramstSchema.H5Url);
  }
  ...
  public static void a(Activity paramActivity, stSchema paramstSchema, int paramInt, String paramString)
  {
    ...
    {
      if (TextUtils.equals(paramString, uyo.f())) {
        uyo.d("homepage_main");
      }
    }
    else {
  ...
  {
    uya.b("WSFeedUtils", "[openWeishiViaScheme] scheme: " + paramString1 + ", eventId: " + paramInt1);
    ...
    {
      uxi.a(paramActivity, new uxv(paramActivity, paramString1, localWSDownloadParams, paramString2, paramInt2));
      return;
    }
    unq.a(paramActivity, localWSDownloadParams, true);
  }
  
  public static void a(Context paramContext, bjoe parambjoe, bjog parambjog)
  {
    paramContext = bjnw.a(paramContext);
    paramContext.a("取消关注", 3);
    paramContext.d("取消");
    paramContext.a(new uxs(parambjoe, paramContext));
    paramContext.a(new uxt(parambjog));
    paramContext.show();
  }
  ...
  public static void a(TextView paramTextView, int paramInt, boolean paramBoolean)
  {
    ...
    case 2: 
    case 4: 
      paramTextView.setBackgroundResource(2130850776);
      return;
    case 3: 
      paramTextView.setBackgroundResource(2130850774);
      return;
    case 5: 
      paramTextView.setBackgroundResource(2130850775);
      return;
    }
    paramTextView.setBackgroundResource(2130850777);
  }
  
  private static void a(List<use> paramList, List<stFeed> paramList1, int paramInt)
  {
    ...
    paramList.add(uzy.a(paramList1.feed));
  }
  ...
  {
    return LocalMultiProcConfig.getBool("weishi_usergrowth" + uyo.a(), "key_player_mute_guide_show", false);
  }
