...
public class xfy
{
  ...
  public xfy(@NonNull Activity paramActivity, @NonNull RMVideoStateMgr paramRMVideoStateMgr, @NonNull Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Boolean = paramIntent.getBooleanExtra("extra_now_tab", vpl.a(2131099651).booleanValue());
    ...
    if ((paramIntent.getIntExtra("edit_video_type", 0) == 10002) && (this.jdField_a_of_type_Long > 0L)) {
      xwa.b("take_video", "video_startup", 0, 0, new String[] { "", String.valueOf(SystemClock.uptimeMillis() - this.jdField_a_of_type_Long), String.valueOf(this.jdField_b_of_type_Int) });
    }
    xvv.a("QQStoryTakeVideoHelper", "default label:%s", this.jdField_a_of_type_JavaLangString);
  }
  ...
  private void a(PublishParam paramPublishParam, String paramString, int paramInt)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      if (vpm.a())
      {
        StoryTransitionActivity.a(this.jdField_a_of_type_AndroidAppActivity, xfh.class.getName(), null);
  ...
  private boolean a()
  {
    ...
    {
      xvv.e("QQStoryTakeVideoHelper", "check manifest's existance error. directory is null.");
      return false;
    }
    return FileUtils.fileExists(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_JavaLangString + File.separator + "manifest.ini");
  }
  
  public String a()
  {
    return (String)((vuq)vux.a(10)).b("StorySvc.get_photography_guide.word", amtj.a(2131710163));
  }
  
  public String a(String paramString)
  {
    Object localObject = (vuq)vux.a(10);
    int i = ((Integer)((vuq)localObject).b("StoryVideoWidth", Integer.valueOf(-1))).intValue();
    int j = ((Integer)((vuq)localObject).b("StoryVideoHeight", Integer.valueOf(-1))).intValue();
    int k = ((Integer)((vuq)localObject).b("StoryVideoMaxrate", Integer.valueOf(-1))).intValue();
    int m = ((Integer)((vuq)localObject).b("StoryVideoMinrate", Integer.valueOf(-1))).intValue();
    String str = (String)((vuq)localObject).b("StoryVideoKey", "960*720#600#1000;640*480#450#750");
    xvv.b("QQStoryTakeVideoHelper", "setupStoryVideoConfig : key = " + str + " width = " + i + " height = " + j + " maxrate = " + k + " minrate = " + m);
    if ((i == -1) && (j == -1) && (k == -1) && (m == -1) && ((str == null) || (str.isEmpty()) || (str.equals("-1")))) {
      xvv.b("QQStoryTakeVideoHelper", "setupStoryVideoConfig : no configs");
    }
    label390:
    ...
    xvv.d("QQStoryTakeVideoHelper", "setupStoryVideoConfig(): newConfig = " + paramString);
    return paramString;
  }
  
  public void a()
  {
    xqh.a(new xgb(this, (vuq)vux.a(10)));
  }
  
  public void a(Intent paramIntent, @NonNull ImageView paramImageView)
  {
    xvv.b("QQStoryTakeVideoHelper", "preview confirm");
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        xvv.b("QQStoryTakeVideoHelper", "preview confirm takephoto ");
      ...
      if (!a())
      {
        xvv.d("QQStoryTakeVideoHelper", "manifest file doesn't exist. generate again before publishing.");
        a(new xfz(this, localPublishParam, str, i));
        return;
      }
      xvv.c("QQStoryTakeVideoHelper", "manifest file already exists. start publishing.");
      a(localPublishParam, str, i);
      return;
    }
  ...
  public void a(xgc paramxgc)
  {
    ...
    Stream.of(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr).map(new ThreadOffFunction("QQStoryTakeVideoHelper", 2)).map(new yjq()).subscribe(new xga(this, paramxgc));
  }
