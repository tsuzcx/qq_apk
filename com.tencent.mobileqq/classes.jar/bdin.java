  ...
  extends BaseAdapter
{
  ...
  private bdio jdField_a_of_type_Bdio;
  private List<ShareActionSheetBuilder.ActionSheetItem> jdField_a_of_type_JavaUtilList;
  
  public bdin(Context paramContext, List<ShareActionSheetBuilder.ActionSheetItem> paramList)
  {
  ...
  protected bdio a(Context paramContext)
  {
    return new bdio(paramContext);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_Bdio == null) {
      this.jdField_a_of_type_Bdio = a(paramViewGroup.getContext());
    }
    if (paramView == null)
    {
    ...
    if (paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.firstLineCount > 0)
    {
      ...
      localObject1 = this.jdField_a_of_type_Bdio.a((Drawable)localObject1, paramInt, i);
      if (!paramViewGroup.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.enable) {
        break label489;
      }
      localObject2 = bdio.a(this.jdField_a_of_type_Bdio, (Drawable)localObject1);
      localObject1 = this.jdField_a_of_type_Bdio.a((Drawable)localObject1, (Drawable)localObject2);
    ...
    for (;;)
    {
      ...
      break label357;
      label489:
      localObject1 = bdio.b(this.jdField_a_of_type_Bdio, (Drawable)localObject1);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject1);
    }
    label512:
