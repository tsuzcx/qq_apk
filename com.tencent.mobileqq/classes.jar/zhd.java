  ...
  extends zhc
{
  ...
  private boyj a(int paramInt1, int paramInt2)
  {
    boolean bool1;
    switch (paramInt1)
    {
    ...
    {
      return new boyl().a(false).e(bool1).f(bool2).g(true).h(true).j(true).b(false).k(true).d(false).c(2).a();
      return new boyl().a(true).f(false).g(true).h(true).j(true).b(true).k(false).d(false).c(2).a();
      bool1 = false;
      break;
    }
  }
  
  public void a(zhe paramzhe)
  {
    if (QLog.isColorLevel()) {
      QLog.i("VideoMerger", 2, "start combine");
    }
    if (paramzhe.jdField_a_of_type_JavaUtilList == null) {}
    for (;;)
    {
      return;
      Object localObject2 = new znh();
      Object localObject1 = new ArrayList(paramzhe.jdField_a_of_type_JavaUtilList.size());
      Object localObject5 = new ArrayList(paramzhe.jdField_a_of_type_JavaUtilList.size());
      Object localObject3 = (zgs)QQStoryContext.a().getBusinessHandler(1);
      Object localObject6 = new ArrayList();
      Object localObject4 = paramzhe.jdField_a_of_type_JavaUtilList.iterator();
      Object localObject7;
      Object localObject8;
      for (boolean bool1 = false; ((Iterator)localObject4).hasNext(); bool1 = bool2)
      {
        localObject7 = (SlideItemInfo)((Iterator)localObject4).next();
        localObject8 = ((zgs)localObject3).a(((SlideItemInfo)localObject7).jdField_b_of_type_JavaLangString);
        bool2 = bool1;
      ...
      if (a(paramzhe))
      {
        a(9, "", null, null, null, paramzhe);
        return;
      }
      if (this.jdField_a_of_type_AndroidMediaMediaFormat == null) {
        if (((zgs)localObject3).a() != null)
        {
          this.jdField_a_of_type_AndroidMediaMediaFormat = ((zgs)localObject3).a();
          if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        if (paramzhe.jdField_a_of_type_Zhf != null) {
          paramzhe.jdField_a_of_type_Zhf.a(bool1);
        }
        localObject4 = zgo.a();
        ...
        {
          this.jdField_a_of_type_AndroidMediaMediaFormat = zgv.a((String)((List)localObject1).get(0));
          if (QLog.isColorLevel()) {
        ...
        if (this.jdField_a_of_type_AndroidMediaMediaFormat == null)
        {
          this.jdField_a_of_type_AndroidMediaMediaFormat = zgv.a();
          if (QLog.isColorLevel())
          {
      ...
      label770:
      for (boolean bool2 = ((znh)localObject2).a((List)localObject6, (String)localObject3);; bool2 = true)
      {
        label627:
      ...
      if (bool2)
      {
        ...
        bool2 = ((znh)localObject2).a((List)localObject1, (String)localObject4, 720, 1280, this.jdField_a_of_type_AndroidMediaMediaFormat);
        ...
        ((LocalMediaInfo)localObject5).mTransferPosList = ((znh)localObject2).b((List)localObject1, (String)localObject4);
      ...
      try
      {
        ...
        if (bool2)
        {
          ...
          yqu.a("actAlbumTime", new String[] { l1 - l2 + "", paramzhe.jdField_a_of_type_JavaUtilList.size() + "" });
          ...
          if (bool1)
          {
            ...
            localObject1 = null;
            localObject2 = paramzhe.jdField_a_of_type_AndroidAppActivity.getIntent();
            if (localObject2 != null) {
              localObject1 = bojm.a((Intent)localObject2);
            }
            localObject2 = localObject1;
            if (localObject1 == null) {
              localObject2 = new Bundle();
            }
            localObject3 = paramzhe.jdField_a_of_type_AndroidAppActivity.getIntent().getExtras();
            localObject1 = localObject3;
            if (localObject3 == null) {
              localObject1 = new Bundle();
            }
            localObject3 = paramzhe.jdField_a_of_type_AndroidAppActivity.getIntent();
            ...
            localObject7 = a(zgl.a().a(), i);
            j = ((Bundle)localObject1).getInt("qq_sub_business_id", 1);
            localObject3 = new boyf(((Bundle)localObject1).getInt("edit_video_type", 10002), i, j);
            ((boyf)localObject3).a((boyj)localObject7);
            ((boyf)localObject3).a(2);
            ...
            ((Bundle)localObject1).putInt("extra_slide_entrance", paramzhe.jdField_a_of_type_Int);
            ((Bundle)localObject1).putInt("extra_slide_sticker_id", paramzhe.jdField_b_of_type_Int);
            ((Bundle)localObject1).putString("extra_slide_sticker_str", paramzhe.jdField_a_of_type_JavaLangString);
            if (paramzhe.jdField_a_of_type_JavaUtilList.size() > 0)
            {
              ((Bundle)localObject1).putString("extra_transiton_default", ((SlideItemInfo)paramzhe.jdField_a_of_type_JavaUtilList.get(0)).e);
              if (QLog.isColorLevel()) {
                QLog.d("VideoMerger", 2, "doMerge mTransId=" + ((SlideItemInfo)paramzhe.jdField_a_of_type_JavaUtilList.get(0)).e);
              }
              if (((SlideItemInfo)paramzhe.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_Wcl != null)
              {
                ((Bundle)localObject1).putInt("extra_ablum_type", ((SlideItemInfo)paramzhe.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_Wcl.jdField_a_of_type_Int);
                if (QLog.isColorLevel()) {
                  QLog.d("VideoMerger", 2, "doMerge mAlbumType=" + ((SlideItemInfo)paramzhe.jdField_a_of_type_JavaUtilList.get(0)).jdField_a_of_type_Wcl.jdField_a_of_type_Int);
                }
              }
              localObject7 = zgi.a(paramzhe.jdField_a_of_type_AndroidAppActivity).a(((SlideItemInfo)paramzhe.jdField_a_of_type_JavaUtilList.get(0)).e);
              if ((localObject7 != null) && (((List)localObject7).size() > 0))
              {
                localObject7 = ((QIMMusicConfigManager)bojv.a(2)).a(((zgj)((List)localObject7).get(0)).jdField_a_of_type_Int, ((zgj)((List)localObject7).get(0)).jdField_b_of_type_Int);
            ...
            paramzhe.jdField_a_of_type_AndroidOsHandler.post(new VideoMerger.1(this, paramzhe, (CameraCaptureView.VideoCaptureResult)localObject6, (LocalMediaInfo)localObject5, (boyf)localObject3, (Bundle)localObject2, (Bundle)localObject1));
            localObject1 = paramzhe.jdField_a_of_type_JavaUtilList.iterator();
            i = 0;
            ...
            break label917;
            label1934:
            ((LocalMediaInfo)localObject5).mTransferPosList = ((znh)localObject2).b((List)localObject1);
          }
        }
      }
      catch (Throwable localThrowable2)
      {
        ...
        for (;;)
        {
          ...
          continue;
          int k = paramzhe.jdField_a_of_type_JavaUtilList.size();
          if (this.jdField_a_of_type_Boolean)
          {
            j = 0;
            yqu.a("video_edit_slides", "suc_compose", j, 0, new String[] { "", paramzhe.jdField_a_of_type_JavaUtilList.size() + "", k - i + "", i + "" });
            yqu.a("actAlbumResult", new String[] { "0" });
            if (!bncn.z)
            {
              bncn.z = true;
              i = 0;
              if (bncn.jdField_a_of_type_Long != -1L) {
                i = (int)(System.currentTimeMillis() - bncn.jdField_a_of_type_Long);
              }
            }
          }
          for (;;)
          {
            try
            {
              l1 = bauq.a((String)localObject4);
              yqu.a("time_shoot", 10002, i, new String[] { String.valueOf(2), String.valueOf(l1), "", "" });
              if (paramzhe.jdField_a_of_type_Zhf != null) {
                paramzhe.jdField_a_of_type_Zhf.j();
              }
              if (!QLog.isColorLevel()) {
                break;
              }
            ...
            paramzhe.jdField_a_of_type_AndroidOsHandler.post(new VideoMerger.2(this, paramzhe));
          }
        }
      }
    }
