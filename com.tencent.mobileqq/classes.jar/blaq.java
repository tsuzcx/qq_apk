...
public class blaq
{
  ...
  private static ThreadLocal<char[]> jdField_a_of_type_JavaLangThreadLocal = new blar();
  ...
  public static String a(Context paramContext)
  {
    ...
    try
    {
      jdField_b_of_type_JavaLangString = bkfy.a("2240ca");
      if (TextUtils.isEmpty(jdField_b_of_type_JavaLangString)) {
  ...
  public static void a(Intent paramIntent, bhmg parambhmg)
  {
    if ((paramIntent == null) || (parambhmg == null)) {
    ...
    for (;;)
    {
      ...
      bhro.a(l7 - l1, l2 - l1, l3, l4, l5 - l2, 0L, parambhmg.b, parambhmg.e, parambhmg.c, parambhmg.a, parambhmg.d, parambhmg.f, 2L, 0L, i, 0L, l6 - l5, l7 - l6 + "", Build.VERSION.RELEASE, j + "");
      return;
  ...
  public static void a(AppInterface paramAppInterface, blad paramblad)
  {
    ...
    localObject = paramblad.a();
    a(null, "dc01327", Arrays.asList(new String[] { "", "android", "201", Build.VERSION.RELEASE, "8.4.1", "", "android", paramAppInterface, jdField_a_of_type_JavaLangString, paramblad.o(), "", paramblad.a(), "", paramblad.b(), paramblad.c(), "", paramblad.e(), localObject[1], localObject[2], localObject[3], localObject[4], localObject[5], localObject[6], localObject[7], localObject[8], "", "", "", paramblad.j(), "", paramblad.m(), paramblad.d(), paramblad.f(), paramblad.g(), paramblad.k(), paramblad.h(), paramblad.l(), paramblad.i(), "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", localObject[0], localObject[9], paramblad.n() }));
  }
  ...
  public static void a(AppInterface paramAppInterface, String paramString1, Context paramContext, String paramString2, String paramString3, String paramString4, String paramString5, String... paramVarArgs)
  {
    ...
    arrayOfString[5] = a();
    paramString1 = Arrays.asList(new String[] { "1", paramString1, a(paramContext), "", "android", "201", Build.VERSION.RELEASE, "8001", "8001001", "", "", "", blae.e, "", "", paramString2, blae.jdField_a_of_type_JavaLangString, "", paramString3, paramString4, paramString5, "", "", "8.4.1", "", "", "", "", "", "android", str, jdField_a_of_type_JavaLangString, "", arrayOfString[0], arrayOfString[1], arrayOfString[2], arrayOfString[3], arrayOfString[4], arrayOfString[5], arrayOfString[6], arrayOfString[7], arrayOfString[8], "", blae.f, "", "", "" });
  ...
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String... paramVarArgs)
  {
    ...
    if (TextUtils.isEmpty(blae.jdField_b_of_type_JavaLangString))
    {
      ...
      paramString1 = blae.jdField_a_of_type_Blai.a();
    ...
    for (paramAppInterface = (QQAppInterface)paramAppInterface;; paramAppInterface = null)
    {
      a(paramAppInterface, "dc00145", paramString1);
      return;
      paramVarArgs = blae.jdField_b_of_type_JavaLangString;
      break;
      paramString1 = blae.jdField_a_of_type_Blai;
      break label1066;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, List<String> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      bcrt.a(paramQQAppInterface, paramString, paramList);
    }
