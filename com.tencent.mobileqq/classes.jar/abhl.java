...
{
  public abhl(ARMapActivity paramARMapActivity, int paramInt, boolean paramBoolean1, boolean paramBoolean2, long paramLong, boolean paramBoolean3, boolean paramBoolean4, String paramString)
  {
  ...
  public void a(int paramInt, SosoInterface.SosoLbsInfo paramSosoLbsInfo)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentMobileqqArmapARGLSurfaceView != null) {
        this.a.jdField_a_of_type_ComTencentMobileqqArmapARGLSurfaceView.queueEvent(new abhm(this, d1, d2, (String)localObject2, d3, i, (String)localObject1, j));
      }
      if (!this.a.g) {
        this.a.g = true;
      }
