...
public class abhl
{
  ...
  public abhl(abhi paramabhi, CustomWebView paramCustomWebView)
  {
  ...
  {
    paramString = bitb.g(paramString);
    bitb.a("catchHtml");
    WebSoService.WebSoState.WebSo3 localWebSo3 = abhi.a(this.jdField_a_of_type_Abhi).a();
    if (localWebSo3 != null)
    {
      WebSoService.a(paramString, localWebSo3.jdField_a_of_type_JavaLangString, localWebSo3.b, Uri.parse(localWebSo3.d));
      return;
    }
    bitb.a("return webSo3 == null");
  }
