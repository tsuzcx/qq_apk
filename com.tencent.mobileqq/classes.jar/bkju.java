...
public class bkju
{
  private static bkju jdField_a_of_type_Bkju;
  private List<WeakReference<bkjv>> jdField_a_of_type_JavaUtilList = new ArrayList();
  private Map<String, bkjw> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  public static bkju a()
  {
    if (jdField_a_of_type_Bkju == null) {}
    try
    {
      if (jdField_a_of_type_Bkju == null) {
        jdField_a_of_type_Bkju = new bkju();
      }
      return jdField_a_of_type_Bkju;
    }
    finally {}
  }
  ...
  private bkjw a()
  {
    if (this.jdField_a_of_type_JavaUtilMap != null) {
      return (bkjw)this.jdField_a_of_type_JavaUtilMap.get(a());
    }
    return null;
  }
  ...
  private void a()
  {
    ...
    bkkc.a().a("AUTH_PROCESS").a();
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    QQALive.GetOpenInfoReq localGetOpenInfoReq = new QQALive.GetOpenInfoReq();
    NewIntent localNewIntent = new NewIntent(localAppRuntime.getApplication(), bkka.class);
    localNewIntent.putExtra("data", bgau.a(localGetOpenInfoReq.toByteArray()));
  ...
  private boolean a()
  {
    ...
    for (;;)
    {
      ...
      {
        String str2 = bjmz.b((String)localObject2, a());
        String str3 = bjmz.b((String)localObject3, a());
        ...
        if ((!TextUtils.isEmpty(str2)) && (!TextUtils.isEmpty(str3))) {
          this.jdField_a_of_type_JavaUtilMap.put(localException, new bkjw(str2, str3));
        }
      }
      else
      {
  ...
  public stAuth a()
  {
    ...
    do
    {
      do
      {
        ...
        localbkjw = a();
        if (localbkjw != null) {
          return new stAuth(1, localbkjw.a, localbkjw.b);
        }
      } while (!a());
      localbkjw = a();
    } while (localbkjw == null);
    return new stAuth(1, localbkjw.a, localbkjw.b);
  }
  
  @NotNull
  public void a(bkjv parambkjv)
  {
    stAuth localstAuth = a();
    if (localstAuth != null)
    {
      parambkjv.onGetAuthInfo(true, localstAuth);
      QLog.e("IliveAuthManager", 1, "getStAuth use local");
      return;
    }
    parambkjv = new WeakReference(parambkjv);
    this.jdField_a_of_type_JavaUtilList.add(parambkjv);
  ...
  public void a(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    for (Object localObject1 = "success";; localObject1 = "fail")
    {
      ...
      bkkc.a().a("AUTH_PROCESS").a("auth_process", (HashMap)localObject2);
      if (paramBoolean)
      {
        if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2))) {
          this.jdField_a_of_type_JavaUtilMap.put(a(), new bkjw(paramString1, paramString2));
        }
        localObject1 = bjmz.a(paramString1, a());
        localObject2 = bjmz.a(paramString2, a());
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (localObject2 != null)
        {
          localObject2 = (bkjv)((WeakReference)localObject2).get();
          if (localObject2 != null) {
            ((bkjv)localObject2).onGetAuthInfo(paramBoolean, new stAuth(1, paramString1, paramString2));
          }
        }
      }
    }
