  ...
  implements bkjo
{
  ...
  public bkju(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  private Bitmap a(Context paramContext, Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      label26:
      int k = bkxd.jdField_a_of_type_Int;
      if (j <= k) {
        break label226;
      }
      i = (int)(i * k / j);
    ...
    for (;;)
    {
      ...
      {
        localObject = bbdr.a(paramContext, bbdr.c(paramBitmap), 0.4F, 25.0F);
      ...
      for (;;)
      {
        paramContext = vxy.a(vxy.a(paramContext, i, j, true), paramBitmap);
  ...
  public boolean a(String paramString, long paramLong1, long paramLong2, int paramInt, bkjv parambkjv)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambkjv);
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Bkxk != null) {
      this.jdField_a_of_type_Bkxk.a();
    }
  }
}
