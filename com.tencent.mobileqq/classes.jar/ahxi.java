  ...
  extends BaseBubbleBuilder
{
  ...
  public ahxi(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new ahxj(this);
  }
  ...
  private void a(TextView paramTextView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      int m = localResources.getDimensionPixelSize(2131297587);
      paramInt = k;
      if (k == 0) {
        paramInt = 1;
      }
    ...
    if (paramInt == 2)
    {
      ...
      if (paramSessionInfo.jdField_a_of_type_Int == 3000) {
        if (paramQQAppInterface.a().b() != l) {
          bdll.b(paramQQAppInterface, "CliOper", "", "", "Multi_call", "Multi_call_disobj_launch", 0, 0, "", "", "", "");
        }
      }
      ...
      if (paramInt == 10)
      {
        ...
        for (;;)
        {
          bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8005DC6", "0X8005DC6", 0, 0, "", "", "", "");
          return;
          label242:
          bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8005925", "0X8005925", 0, 0, "", "", "", "");
        }
      }
      bdll.b(paramQQAppInterface, "CliOper", "", "", "0X80046CB", "0X80046CB", 0, 0, "", "", "", "");
      return;
    }
    boolean bool = bhoj.a("qqVideoEx", paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, int paramInt, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    long l2 = bapc.b(str);
    QLog.w("ChatItemBuilder", 1, "showGroupQavActionSheet, avType[" + paramInt + "], isVideo[" + paramBoolean + "], msgSelfUin[" + paramString1 + "], uinType[" + j + "], groupId[" + str + "], curFriendNick[" + paramSessionInfo.d + "], troopUin[" + paramSessionInfo.jdField_b_of_type_JavaLangString + "], fromWhere[" + paramString2 + "], isVideoActionSheetShown[" + mvg.a() + "], seq[" + l1 + "]");
    if (10 == paramInt)
    {
      i = 0;
      boolean bool = false;
      ...
      {
        paramString1 = bhoj.a(paramQQAppInterface, str);
        bool = paramString1.getBoolean("forceDisableInviteBox");
        i = paramString1.getInt("errId", 2131695029);
      }
      if (bool)
      {
        bhlq.a(paramContext, 230, null, paramContext.getResources().getString(i), 2131694814, 2131719223, new ahxk(), null).show();
        return;
      }
    }
    if (paramBoolean)
    ...
    {
      if (i != 0) {
        AudioHelper.a(anzj.a(2131715074));
      }
      if ((!paramQQAppInterface.a().a(l1, str)) && (i == 0)) {
        break label451;
      }
      paramSessionInfo = new Bundle();
      paramSessionInfo.putInt("MultiAVType", mvd.a(j));
      if (paramBoolean) {
        paramSessionInfo.putBoolean("isVideo", true);
      }
      if (j == 1) {
        paramSessionInfo.putBoolean("enableInvite", bhoj.a("showGroupQavActionSheet", paramQQAppInterface, str));
      }
    ...
    label451:
    paramString1 = paramQQAppInterface.a().a(bapc.b(str));
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, MessageForVideo paramMessageForVideo)
  {
    ...
    {
      bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8005642", "0X8005642", 0, 0, "", "", "", "");
      return;
    }
    bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8005243", "0X8005243", 0, 0, "", "", "", "");
  }
  ...
  static void a(QQAppInterface paramQQAppInterface, Context paramContext, MessageForVideo paramMessageForVideo, SessionInfo paramSessionInfo)
  {
    ...
    else
    {
      try
      {
        ...
        int i = mvd.b(paramSessionInfo.jdField_a_of_type_Int);
        l = paramQQAppInterface.a().a(i, l);
        Object localObject = (bgsl)paramQQAppInterface.getManager(48);
        boolean bool1 = ((bgsl)localObject).a(paramSessionInfo.jdField_a_of_type_JavaLangString, paramQQAppInterface.getCurrentAccountUin());
        boolean bool2 = ((bgsl)localObject).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
        boolean bool3 = ((bgsl)localObject).b(paramSessionInfo.jdField_a_of_type_JavaLangString);
        localObject = ((bgsl)localObject).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
        if ((l == 0L) && (((!bool3) && (bool1)) || ((!bool2) && (localObject != null) && (((bgss)localObject).a > 0L))))
        {
          QQToast.a(paramQQAppInterface.getApp(), anzj.a(2131715073), 0).b(paramQQAppInterface.getApp().getResources().getDimensionPixelSize(2131299011));
          return;
        }
      }
  ...
  private static void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean, int paramInt)
  {
    ...
    if (!paramBoolean)
    {
      ...
      default: 
        paramSessionInfo = "0";
        label72:
        bdll.b(paramQQAppInterface, "CliOper", "", "", str1, str2, 0, 0, paramSessionInfo, "", "", "");
        if (paramInt == 2) {
          bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8004009", "", 0, 0, "2", "", "", "");
        }
        break;
      }
    }
    for (;;)
    {
      ...
      bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8005643", "0X8005643", 0, 0, "", "", "", "");
      return;
      str1 = "Two_video_call";
      ...
      break label72;
      if (paramInt == 0) {
        bdll.b(paramQQAppInterface, "CliOper", "", "", "0X800400A", "", 0, 0, "2", "", "", "");
      }
    }
    label238:
    bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8005244", "0X8005244", 0, 0, "", "", "", "");
  }
  ...
  static void a(QQAppInterface paramQQAppInterface, MessageForVideo paramMessageForVideo, SessionInfo paramSessionInfo)
  {
    ...
    if (paramMessageForVideo.type == 13)
    {
      ...
      bdll.b(paramQQAppInterface, "CliOper", "", "", "Multi_call", "Multi_call_disobj", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      if ((paramMessageForVideo.type == 2) || (paramMessageForVideo.type == 24)) {
        bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8004009", "", 0, 0, "1", "", "", "");
      }
      if (paramMessageForVideo.type == 0) {
        bdll.b(paramQQAppInterface, "CliOper", "", "", "0X800400A", "", 0, 0, "1", "", "", "");
      }
      return;
      label123:
      if (i == 1) {
        if (paramMessageForVideo.extInt == 10) {
          bdll.b(paramQQAppInterface, "CliOper", "", "", "0X8005924", "0X8005924", 0, 0, "", "", "", "");
        } else {
          bdll.b(null, "dc00899", "Grp_video", "", "notice", "video", 0, 0, paramSessionInfo.jdField_a_of_type_JavaLangString, "" + bguq.a(paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString), "0", "");
        }
      }
    }
  }
  ...
  private void a(MessageForVideo paramMessageForVideo, Context paramContext, View paramView)
  {
    ...
    if (paramMessageForVideo.selfuin.equals(paramMessageForVideo.senderuin))
    {
      if (-2016 == paramMessageForVideo.msgtype) {
        localObject1 = anzj.a(2131715067);
      }
      ...
      if (!paramMessageForVideo.text.contains(paramContext.getResources().getString(2131719219))) {
        break label267;
      }
    ...
    for (;;)
    {
      paramView.setContentDescription(((String)localObject1).replace(anzj.a(2131715075), anzj.a(2131715066)));
      return;
      localObject1 = bhlg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForVideo.senderuin, 0);
      break;
      label259:
      i = 2131718783;
      break label132;
      label267:
      if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131719208)))
      {
        paramContext = paramContext.getResources();
        if (paramMessageForVideo.isVideo) {}
        for (i = 2131719227;; i = 2131690162)
        {
          localObject1 = paramContext.getString(i);
          break;
        }
      }
      if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131695346))) {
        localObject1 = paramContext.getResources().getString(2131717871);
      } else if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131695345))) {
        localObject1 = paramContext.getResources().getString(2131717459);
      } else if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131694771))) {
        localObject1 = paramContext.getResources().getString(2131717871);
      } else if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131694770))) {
        localObject1 = paramContext.getResources().getString(2131717459);
      }
    }
  }
  ...
  public View a(ChatMessage paramChatMessage, aggl paramaggl, View paramView, BaseChatItemLayout paramBaseChatItemLayout, agjk paramagjk)
  {
    ...
    localahxl.a.setTextColor(localResources.getColor(i));
    localahxl.a.setText(paramView.text);
    if ((paramView.istroop == 1) && (this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131694972).equals(paramView.text))) {
      bdll.b(null, "dc00899", "Grp_video", "", "notice", "exp", 0, 0, paramView.frienduin, "" + bguq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView.frienduin), "", "");
    }
    ...
    if (jdField_e_of_type_Boolean) {
      a(paramView, paramBaseChatItemLayout, paramaggl);
    }
    return paramaggl;
  }
  ...
  String a(MessageForVideo paramMessageForVideo, Context paramContext, View paramView)
  {
    ...
    String str1 = paramContext.getResources().getString(2131719219) + ",";
    ...
    for (;;)
    {
      ...
      label331:
      for (localObject = str1 + k + anzj.a(2131715069);; localObject = str1)
      {
        paramContext = (Context)localObject;
        if (j > 0) {
          paramContext = (String)localObject + j + anzj.a(2131715071);
        }
        localObject = paramContext;
        if (i > 0) {
          localObject = paramContext + i + anzj.a(2131715070);
        }
        paramContext = paramView.getResources();
        if (paramMessageForVideo.isVideo) {}
        for (i = 2131718797;; i = 2131718783)
        {
  ...
  {
    ahxl localahxl = (ahxl)paramaggl;
    localahxl.a.setTextSize(0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_b_of_type_Int);
    if ((paramaqkt.jdField_a_of_type_Int == 0) || (!paramaqkt.a()))
    {
      paramView = paramView.getResources();
      if (localahxl.a.getText().toString().contains(this.jdField_a_of_type_AndroidContentContext.getString(2131719205)))
      {
        paramaggl = paramView.getColorStateList(2131165923);
        localahxl.a.setTextColor(paramaggl);
        return;
      }
      ...
      {
        localahxl.a.setLinkTextColor(paramaggl);
        return;
    ...
    if (paramaqkt.jdField_b_of_type_Int == 0) {
      localahxl.a.setTextColor(-16777216);
    }
    while (paramaqkt.c == 0)
    {
      localahxl.a.setLinkTextColor(paramView.getResources().getColorStateList(2131167011));
      return;
      localahxl.a.setTextColor(paramaqkt.jdField_b_of_type_Int);
    }
    localahxl.a.setLinkTextColor(paramaqkt.c);
  }
