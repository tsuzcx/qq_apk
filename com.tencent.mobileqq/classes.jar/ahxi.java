...
public class ahxi
  implements alkh
{
  public ahxi(AddContactsView paramAddContactsView) {}
  ...
  public void b()
  {
    ...
    this.a.e();
    this.a.jdField_a_of_type_ComTencentWidgetSwipListView.getViewTreeObserver().addOnGlobalLayoutListener(new ahxj(this));
  }
}
