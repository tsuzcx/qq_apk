...
public class aoev
{
  ...
  public static Bitmap a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, anoe paramanoe)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          ...
          localPaint.setColor(-1);
          a(paramAppInterface, paramContext, paramInt1, paramInt2, paramInt3, paramString1, paramString2, paramString3, paramJSONArray, paramanoe, i, j, k, m, str, localCanvas, localPaint);
          ...
          paramAppInterface = paramContext.getResources().getDrawable(2130844528);
          paramAppInterface.setBounds(i / 2 - 45, j - 102 - 42, i / 2 + 45, j - 102);
          paramAppInterface.draw(localCanvas);
          paramAppInterface = alpo.a(2131702792);
  ...
  public static String a(AppInterface paramAppInterface, Context paramContext, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramContext = xxb.a(paramContext, str, paramBitmap);
        paramAppInterface = paramContext;
        if (QLog.isColorLevel())
        {
  ...
  public static String a(String paramString, float paramFloat)
  {
    ...
    int i;
    int j;
    if (aoey.a(paramString) > paramFloat)
    {
    ...
    for (;;)
    {
      if ((i >= paramString.length()) || (aoey.a(paramString.substring(0, i) + "…") > paramFloat))
      {
  ...
  public static ArrayList<aofg> a(JSONArray paramJSONArray)
  {
    ...
    if (i < j)
    {
      ...
      do
      {
        ...
        localArrayList.add(new aofg(str));
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, anoe paramanoe, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString4, Canvas paramCanvas, Paint paramPaint)
  {
    if (paramInt3 == 0)
    {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (aoez)paramJSONArray.next();
        localObject2 = ((aoez)localObject1).jdField_a_of_type_JavaUtilArrayList.iterator();
        label721:
        if (((Iterator)localObject2).hasNext())
        {
          localObject3 = (aofa)((Iterator)localObject2).next();
          paramString3.left = (((aofa)localObject3).jdField_a_of_type_AndroidGraphicsRect.left + paramString2.left + 1);
          paramString3.top = (((aofa)localObject3).jdField_a_of_type_AndroidGraphicsRect.top + paramString2.top + 1);
          paramString3.right = (((aofa)localObject3).jdField_a_of_type_AndroidGraphicsRect.right + paramString2.left - 2);
          paramString3.bottom = (((aofa)localObject3).jdField_a_of_type_AndroidGraphicsRect.bottom + paramString2.top - 2);
          paramPaint.setColor(((aoez)localObject1).jdField_a_of_type_Int);
          if (!((aoez)localObject1).jdField_b_of_type_Boolean) {
            break label913;
          }
          paramInt1 = 178;
          paramPaint.setAlpha(paramInt1);
          paramPaint.setFakeBoldText(((aoez)localObject1).jdField_a_of_type_Boolean);
          paramString1 = Paint.Align.CENTER;
          if (((aoez)localObject1).c != -1) {
            break label920;
          }
        ...
        {
          label849:
          a(paramCanvas, paramPaint, paramString3, ((aofa)localObject3).jdField_a_of_type_JavaLangString, paramString1, ((aoez)localObject1).d, ((aoez)localObject1).jdField_b_of_type_Int);
          break label721;
          break;
          label913:
          paramInt1 = 255;
      ...
      if (paramanoe != null)
      {
        paramAppInterface = paramanoe.a(paramAppInterface.getCurrentAccountUin(), true);
        QLog.i("ConfessShareHelper", 4, "preLoadQQSelfHeaderBitmap " + paramAppInterface);
      }
      for (paramAppInterface = new BitmapDrawable(paramAppInterface);; paramAppInterface = paramContext.getResources().getDrawable(2130844521))
      {
        ...
        paramContext = a(paramString4, 8.0F) + alpo.a(2131702793);
  ...
  public static final void a(String paramString, Canvas paramCanvas, Rect paramRect)
  {
    ...
    try
    {
      localObject = xxb.a(paramString, -1);
      m = ((gs)localObject).a();
  ...
  public static boolean a(Context paramContext, Canvas paramCanvas, int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    aoew[] arrayOfaoew = a(paramInt2, paramInt1);
    paramInt2 = arrayOfaoew.length;
    paramInt1 = 0;
    aoew localaoew;
    if (paramInt1 < paramInt2) {
      localaoew = arrayOfaoew[paramInt1];
    }
    for (;;)
    {
      try
      {
        localDrawable = paramContext.getResources().getDrawable(localaoew.jdField_a_of_type_Int);
        if (localaoew.jdField_a_of_type_Int == 2130844530) {
          break label316;
        }
        if (localaoew.jdField_a_of_type_Int != 2130844523) {
          break label309;
        }
      }
      ...
      m = (int)(localaoew.jdField_b_of_type_Int - j * localaoew.jdField_a_of_type_Float * f1 / 2.0F);
      n = (int)(localaoew.c * f2 - k * localaoew.jdField_a_of_type_Float * f1 / 2.0F);
      f3 = localaoew.jdField_b_of_type_Int;
      localDrawable.setBounds(m, n, (int)(j * localaoew.jdField_a_of_type_Float * f1 / 2.0F + f3), (int)(f2 * localaoew.c + k * localaoew.jdField_a_of_type_Float * f1 / 2.0F));
      if (localaoew.jdField_a_of_type_Boolean)
      {
  ...
  public static aoew[] a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 0) {
      switch (paramInt2)
      {
    ...
    do
    {
      ...
      {
        return new aoew[0];
        return new aoew[] { new aoew(2130844495, 60, 60, true, 0.75F), new aoew(2130844500, 458, 84, true, 0.75F), new aoew(2130844501, 142, 250, true, 0.75F), new aoew(2130844495, 368, 188, true, 0.75F), new aoew(2130844493, 168, 120, true, 0.75F), new aoew(2130844526, 120, 40, true, 0.75F), new aoew(2130844527, 120, 110, true, 0.75F), new aoew(2130844524, 30, 150, true, 0.75F), new aoew(2130844524, 180, 200, true, 0.75F), new aoew(2130844526, 420, 160, true, 0.75F), new aoew(2130844527, 495, 150, true, 0.75F), new aoew(2130844523, 257, 82, false, 1.0F) };
        return new aoew[] { new aoew(2130844502, 60, 88, true, 0.75F), new aoew(2130844494, 226, 56, true, 0.75F), new aoew(2130844501, 480, 140, true, 0.75F), new aoew(2130844499, 330, 198, true, 0.75F), new aoew(2130844500, 168, 244, true, 0.75F), new aoew(2130844526, 300, 50, true, 0.75F), new aoew(2130844527, 460, 50, true, 0.75F), new aoew(2130844524, 60, 230, true, 0.75F), new aoew(2130844526, 120, 120, true, 0.75F), new aoew(2130844526, 440, 270, true, 0.75F), new aoew(2130844523, 257, 82, false, 1.0F) };
        return new aoew[] { new aoew(2130844495, 174, 58, true, 0.75F), new aoew(2130844497, 70, 146, true, 0.75F), new aoew(2130844499, 390, 106, true, 0.75F), new aoew(2130844494, 206, 240, true, 0.75F), new aoew(2130844496, 470, 225, true, 0.75F), new aoew(2130844527, 120, 88, true, 0.75F), new aoew(2130844527, 480, 70, true, 0.75F), new aoew(2130844524, 110, 230, true, 0.75F), new aoew(2130844526, 340, 210, true, 0.75F), new aoew(2130844523, 257, 82, false, 1.0F) };
        return new aoew[] { new aoew(2130844501, 138, 88, true, 0.75F), new aoew(2130844495, 68, 232, true, 0.75F), new aoew(2130844499, 298, 206, true, 0.75F), new aoew(2130844502, 480, 140, true, 0.75F), new aoew(2130844531, 382, 140, true, 0.75F), new aoew(2130844526, 60, 90, true, 0.75F), new aoew(2130844524, 182, 64, true, 0.75F), new aoew(2130844524, 440, 210, true, 0.75F), new aoew(2130844526, 440, 30, true, 0.75F), new aoew(2130844526, 190, 200, true, 0.75F), new aoew(2130844523, 257, 82, false, 1.0F) };
        if (paramInt1 != 1) {
          break;
        }
        switch (paramInt2)
      ...
      return new aoew[] { new aoew(2130844496, 110, 230, true, 1.0F), new aoew(2130844499, 656, 170, true, 1.0F), new aoew(2130844494, 516, 350, true, 1.0F), new aoew(2130844495, 84, 550, true, 1.0F), new aoew(2130844500, 656, 586, true, 1.0F), new aoew(2130844495, 526, 735, true, 1.0F), new aoew(2130844501, 198, 830, true, 1.0F), new aoew(2130844497, 70, 1016, true, 1.0F), new aoew(2130844499, 397, 952, true, 1.0F), new aoew(2130844502, 670, 880, true, 1.0F), new aoew(2130844494, 220, 1257, true, 1.0F), new aoew(2130844498, 606, 1220, true, 1.0F), new aoew(2130844531, 452, 475, true, 1.0F), new aoew(2130844493, 240, 645, true, 1.0F), new aoew(2130844524, 160, 300, true, 1.0F), new aoew(2130844527, 660, 330, true, 1.0F), new aoew(2130844525, 620, 450, true, 1.0F), new aoew(2130844526, 175, 500, true, 1.0F), new aoew(2130844526, 460, 570, true, 1.0F), new aoew(2130844527, 180, 630, true, 1.0F), new aoew(2130844524, 40, 690, true, 1.0F), new aoew(2130844524, 260, 750, true, 1.0F), new aoew(2130844527, 710, 600, true, 1.0F), new aoew(2130844526, 600, 710, true, 1.0F), new aoew(2130844526, 140, 970, true, 1.0F), new aoew(2130844524, 85, 1200, true, 1.0F), new aoew(2130844524, 600, 1050, true, 1.0F), new aoew(2130844527, 420, 1100, true, 1.0F), new aoew(2130844526, 540, 1250, true, 1.0F), new aoew(2130844530, 375, 134, false, 1.0F) };
      return new aoew[] { new aoew(2130844499, 110, 368, true, 1.0F), new aoew(2130844500, 570, 256, true, 1.0F), new aoew(2130844495, 655, 475, true, 1.0F), new aoew(2130844502, 75, 740, true, 1.0F), new aoew(2130844494, 320, 686, true, 1.0F), new aoew(2130844501, 670, 832, true, 1.0F), new aoew(2130844499, 505, 955, true, 1.0F), new aoew(2130844500, 260, 1020, true, 1.0F), new aoew(2130844498, 75, 1216, true, 1.0F), new aoew(2130844494, 565, 1235, true, 1.0F), new aoew(2130844531, 430, 355, true, 1.0F), new aoew(2130844493, 110, 174, true, 1.0F), new aoew(2130844524, 140, 250, true, 1.0F), new aoew(2130844527, 640, 195, true, 1.0F), new aoew(2130844524, 170, 450, true, 1.0F), new aoew(2130844526, 490, 1220, true, 1.0F), new aoew(2130844525, 350, 520, true, 1.0F), new aoew(2130844525, 630, 410, true, 1.0F), new aoew(2130844527, 60, 500, true, 1.0F), new aoew(2130844527, 680, 655, true, 1.0F), new aoew(2130844527, 310, 1110, true, 1.0F), new aoew(2130844526, 470, 660, true, 1.0F), new aoew(2130844526, 190, 780, true, 1.0F), new aoew(2130844526, 680, 1060, true, 1.0F), new aoew(2130844524, 180, 1230, true, 1.0F), new aoew(2130844530, 375, 134, false, 1.0F) };
      return new aoew[] { new aoew(2130844495, 110, 220, true, 1.0F), new aoew(2130844501, 654, 240, true, 1.0F), new aoew(2130844499, 562, 482, true, 1.0F), new aoew(2130844497, 95, 537, true, 1.0F), new aoew(2130844494, 295, 672, true, 1.0F), new aoew(2130844496, 683, 660, true, 1.0F), new aoew(2130844498, 60, 850, true, 1.0F), new aoew(2130844500, 442, 872, true, 1.0F), new aoew(2130844494, 114, 1046, true, 1.0F), new aoew(2130844495, 680, 950, true, 1.0F), new aoew(2130844500, 230, 1197, true, 1.0F), new aoew(2130844502, 480, 1260, true, 1.0F), new aoew(2130844531, 670, 1200, true, 1.0F), new aoew(2130844524, 140, 630, true, 1.0F), new aoew(2130844524, 500, 960, true, 1.0F), new aoew(2130844524, 330, 1050, true, 1.0F), new aoew(2130844524, 50, 1150, true, 1.0F), new aoew(2130844525, 290, 430, true, 1.0F), new aoew(2130844525, 330, 760, true, 1.0F), new aoew(2130844526, 60, 310, true, 1.0F), new aoew(2130844526, 480, 580, true, 1.0F), new aoew(2130844526, 220, 820, true, 1.0F), new aoew(2130844527, 600, 150, true, 1.0F), new aoew(2130844527, 700, 410, true, 1.0F), new aoew(2130844527, 25, 900, true, 1.0F), new aoew(2130844527, 150, 430, true, 1.0F), new aoew(2130844530, 375, 134, false, 1.0F) };
      return new aoew[] { new aoew(2130844495, 104, 278, true, 1.0F), new aoew(2130844498, 588, 200, true, 1.0F), new aoew(2130844494, 690, 390, true, 1.0F), new aoew(2130844497, 420, 534, true, 1.0F), new aoew(2130844496, 92, 592, true, 1.0F), new aoew(2130844500, 660, 624, true, 1.0F), new aoew(2130844495, 475, 735, true, 1.0F), new aoew(2130844501, 192, 818, true, 1.0F), new aoew(2130844502, 696, 880, true, 1.0F), new aoew(2130844499, 430, 990, true, 1.0F), new aoew(2130844494, 64, 1034, true, 1.0F), new aoew(2130844494, 272, 1250, true, 1.0F), new aoew(2130844498, 584, 1205, true, 1.0F), new aoew(2130844493, 254, 638, true, 1.0F), new aoew(2130844524, 200, 320, true, 1.0F), new aoew(2130844524, 260, 780, true, 1.0F), new aoew(2130844524, 620, 1000, true, 1.0F), new aoew(2130844524, 150, 1250, true, 1.0F), new aoew(2130844525, 70, 420, true, 1.0F), new aoew(2130844525, 460, 590, true, 1.0F), new aoew(2130844525, 630, 450, true, 1.0F), new aoew(2130844526, 70, 800, true, 1.0F), new aoew(2130844526, 280, 980, true, 1.0F), new aoew(2130844526, 610, 720, true, 1.0F), new aoew(2130844526, 480, 1220, true, 1.0F), new aoew(2130844527, 170, 590, true, 1.0F), new aoew(2130844527, 330, 1160, true, 1.0F), new aoew(2130844527, 700, 680, true, 1.0F), new aoew(2130844527, 660, 290, true, 1.0F), new aoew(2130844530, 375, 134, false, 1.0F) };
    } while (paramInt1 != 2);
    return new aoew[] { new aoew(2130844496, 110, 310, true, 1.0F), new aoew(2130844499, 650, 216, true, 1.0F), new aoew(2130844494, 516, 350, true, 1.0F), new aoew(2130844496, 92, 592, true, 1.0F), new aoew(2130844500, 656, 586, true, 1.0F), new aoew(2130844495, 470, 716, true, 1.0F), new aoew(2130844501, 198, 830, true, 1.0F), new aoew(2130844502, 670, 980, true, 1.0F), new aoew(2130844499, 397, 1060, true, 1.0F), new aoew(2130844497, 70, 1016, true, 1.0F), new aoew(2130844524, 200, 320, true, 1.0F), new aoew(2130844493, 240, 438, true, 1.0F), new aoew(2130844531, 452, 475, true, 0.75F), new aoew(2130844524, 200, 600, true, 1.0F), new aoew(2130844524, 1000, 620, true, 1.0F), new aoew(2130844525, 70, 420, true, 1.0F) };
  }
  
  public static Bitmap b(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, anoe paramanoe)
  {
    if ((paramJSONArray == null) || (paramJSONArray.length() < 1) || (paramContext == null))
    {
      paramAppInterface = null;
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          try
          {
            ...
            localPaint.setColor(-1);
            a(paramAppInterface, paramContext, paramInt1, paramInt2, paramInt3, null, paramString2, paramString3, paramJSONArray, paramanoe, i, j, 5, 5, str, localCanvas, localPaint);
            localPaint.setAlpha(255);
            localPaint.setColor(-1);
            return paramString1;
          }
