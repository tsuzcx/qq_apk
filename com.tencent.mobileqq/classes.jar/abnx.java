...
public abstract class abnx
{
  ...
  public abnx(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  public void a(int paramInt, boolean paramBoolean, Object paramObject)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      if (localIterator.hasNext()) {
        ((amgs)localIterator.next()).b(paramInt, paramBoolean, paramObject);
      }
    }
  }
  ...
  public void a(amgs paramamgs)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramamgs);
      return;
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      if (localIterator.hasNext()) {
        ((amgs)localIterator.next()).a(getClass().getSimpleName(), paramString, paramBoolean1, paramInt, paramBoolean2, paramBoolean3);
      }
    }
  }
  ...
  {
    int i = abot.a(???, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      if (localIterator.hasNext()) {
        ((amgs)localIterator.next()).a(getClass().getSimpleName(), paramString, paramBoolean1, i, paramBoolean2, paramBoolean3);
      }
    }
  }
  ...
  protected void a(ArrayList<MessageRecord> paramArrayList1, ArrayList<MessageRecord> paramArrayList2, boolean paramBoolean)
  {
    if (paramArrayList1.size() > 0)
    {
      ...
      while (paramArrayList1.hasNext())
      {
        ...
        if (!alsh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, paramBoolean)) {
  ...
  public void a(msg_svc.PbMsgReadedReportReq paramPbMsgReadedReportReq)
  {
    ...
    a(true, true, false, 0L, new abny(this, paramPbMsgReadedReportReq));
  }
  
  protected void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, long paramLong, abnz paramabnz)
  {
    int i;
    if (paramLong == 0L)
    {
      i = aytq.jdField_a_of_type_Int;
    ...
    for (;;)
    {
      ...
      if (!paramBoolean1)
      {
        paramabnz = paramabnz.a();
        if (paramabnz == null) {
          return;
        }
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.BaseMessageProcessor", 2, "processRequest cmd=" + paramabnz.getServiceCmd() + ",reqSeq=" + paramLong);
        }
        a(paramabnz, paramLong, paramBoolean2, paramBoolean3);
        return;
      }
      ...
      while (i < 9)
      {
        localSendMessageHandler.a(new BaseMessageProcessor.1(this, paramabnz, paramLong, l, paramBoolean2, paramBoolean3));
        i += 1;
      }
      i = 0;
      label168:
  ...
  {
    return alsh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord, paramBoolean);
  }
  ...
  public void b(int paramInt, boolean paramBoolean, Object paramObject)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      if (localIterator.hasNext()) {
        ((amgs)localIterator.next()).c(paramInt, paramBoolean, paramObject);
      }
    }
  }
}
