  ...
  implements Manager
{
  ...
  public alne(QQAppInterface paramQQAppInterface)
  {
  ...
  public String a()
  {
    ...
    {
      List localList = this.jdField_a_of_type_Awbw.a(EqqConfig.class);
      String str1 = str2;
      if (localList != null)
      {
        str1 = str2;
  ...
  public void a()
  {
    ...
    Object localObject = this.jdField_a_of_type_Awbw.a(EqqDetail.class, false, "followType=?", new String[] { "0" }, null, null, null, null);
    if (localObject != null) {
  ...
  public void b(EqqDetail paramEqqDetail)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Awbw.b(paramEqqDetail);
