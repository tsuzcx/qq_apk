  ...
  extends WebViewPlugin
{
  ...
  protected void a(String paramString)
  {
    try
    {
      ...
      QQToast.a(this.mRuntime.a(), 0, anvx.a(2131714569), 0).a();
      return;
    }
  ...
  protected void d(String paramString)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        TroopUtils.openTroopInfoActivity(localActivity, localBundle, 2);
        return;
      }
    }
    catch (Exception paramString)
  ...
  protected void f(String paramString)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        Activity localActivity = this.mRuntime.a();
        Intent localIntent = AIOUtils.setOpenAIOIntent(new Intent(localActivity, SplashActivity.class), null);
        localIntent.putExtra("uin", str);
  ...
  public void onDestroy()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 350	com/tencent/mobileqq/webview/swift/WebViewPlugin:onDestroy	()V
    //   4: aload_0
    //   5: getfield 352	bfxo:jdField_a_of_type_Aady	Laady;
    //   8: ifnull +10 -> 18
    //   11: aload_0
    //   12: getfield 352	bfxo:jdField_a_of_type_Aady	Laady;
    //   15: invokevirtual 356	aady:b	()V
    //   18: aload_0
    //   19: getfield 18	bfxo:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   22: iconst_0
    //   23: invokevirtual 359	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   26: return
    //   27: astore_1
    //   28: aload_0
    //   29: getfield 18	bfxo:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   32: iconst_0
    //   33: invokevirtual 359	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   36: return
    //   37: astore_1
    //   38: aload_0
    //   39: getfield 18	bfxo:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   42: iconst_0
    //   43: invokevirtual 359	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   46: aload_1
    //   47: athrow
