...
public class awqk
{
  private static final awqm jdField_a_of_type_Awqm = new awqm(null);
  ...
  public awqk(String paramString)
  {
  ...
  private long a(String paramString, awqa paramawqa)
  {
    ...
    try
    {
      ...
      paramawqa.jdField_b_of_type_Long = l1;
      paramawqa.jdField_a_of_type_Long = l2;
      return l2;
    }
    catch (Exception paramString) {}
    return -1L;
  ...
  private awpx a(String paramString, int paramInt1, int paramInt2, awpx paramawpx)
  {
    long l2 = 0L;
    paramString = paramString.split("\\,");
    if (paramString.length < 2) {}
    ...
    for (;;)
    {
      return new awpx(l2, l1, paramInt1, paramInt2);
      l2 = l3;
    }
  }
  ...
  private void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        localObject3 = new awqa();
        if (a((String)localObject2, (awqa)localObject3) != -1L)
        {
          a(paramString, (awqa)localObject3);
  ...
  private void a(String paramString, awqa paramawqa)
  {
    label244:
    for (;;)
    {
      ...
      try
      {
        paramawqa.jdField_a_of_type_JavaLangString = "";
        if (paramString == null) {
          break;
        }
        ...
        if (localMatcher.find())
        {
          ...
          if (localArrayList.size() > 0) {
            paramString = (awpx)localArrayList.get(localArrayList.size() - 1);
          }
        ...
        paramawqa.jdField_a_of_type_JavaLangString = ((String)localObject1);
      }
      catch (Exception paramString)
      {
      ...
      paramawqa.jdField_b_of_type_JavaUtilArrayList = localArrayList;
      return;
    }
  }
  ...
  public awpy a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 47	awqk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   4: astore_2
    //   5: aload_2
    //   6: ifnull +64 -> 70
    //   9: aload_2
    ...
    //   216: invokespecial 240	awqk:a	(Ljava/lang/String;)V
    //   219: goto -24 -> 195
    //   222: astore 4
    //   224: aload_3
    //   225: astore_2
    ...
    //   271: astore_2
    //   272: aload_0
    //   273: getfield 45	awqk:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   276: getstatic 36	awqk:jdField_a_of_type_Awqm	Lawqm;
    ...
    //   288: iconst_2
    //   289: aload_0
    //   290: getfield 89	awqk:jdField_a_of_type_Int	I
    //   293: aload_0
    //   294: getfield 45	awqk:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   297: invokespecial 255	awpy:<init>	(IILjava/util/ArrayList;)V
    //   300: astore 4
    //   302: aload_3
    //   303: ifnull +7 -> 310
    //   306: aload_3
