...
public class bcdj
{
  ...
  {
    return bcdm.a().i(paramString5).k(paramString1).j(paramString2).l(paramString3).m(paramString4).b();
  }
  
  public static void a(int paramInt, String paramString)
  {
    bcds.b("AppCenterReporter", "[report] type=" + paramInt + "\ndata=" + paramString);
    SDKReportManager2.getInstance().postReport(paramInt, paramString);
  }
  
  public static void a(bcdm parambcdm)
  {
    parambcdm = parambcdm.a();
    bcds.b("AppCenterReporter", "[reportExposure] type=3002\ndata=" + parambcdm);
    SDKReportManager2.getInstance().postReport(3002, parambcdm);
  }
  ...
  private static long b(String paramString)
  {
    ...
    bcds.b("AppCenterReporter", "[getInstalledAppFileSize]" + paramString + ": NOT INSTALLED!");
    return 0L;
  }
  
  public static void b(bcdm parambcdm)
  {
    parambcdm = parambcdm.a();
    bcds.b("AppCenterReporter", "[reportClick] type=3003\ndata=" + parambcdm);
    SDKReportManager2.getInstance().postReport(3003, parambcdm);
  }
  ...
  {
    paramString1 = a(paramString1, paramString2, paramString3, paramString4, paramString5) + "|" + bcdm.a().d() + "|" + "200";
    bcds.b("AppCenterReporter", "[reportClick] type=3003\ndata=" + paramString1);
  ...
  private static String c(DownloadInfo paramDownloadInfo)
  {
    ...
    return bcdm.a().i(paramDownloadInfo.o).k(paramDownloadInfo.t).j(paramDownloadInfo.u).l(paramDownloadInfo.v).m(paramDownloadInfo.h).b();
  }
  ...
  private static String d(DownloadInfo paramDownloadInfo)
  {
    ...
    return bcdm.a().a(paramDownloadInfo.f).b(paramDownloadInfo.e).a(paramDownloadInfo.jdField_b_of_type_Int).c(paramDownloadInfo.c).d(paramDownloadInfo.k).e(paramDownloadInfo.r).f(paramDownloadInfo.s).g(paramDownloadInfo.d).h(paramDownloadInfo.q).c();
  }
  
  public static void d(DownloadInfo paramDownloadInfo)
  {
    bcds.b("AppCenterReporter", ">tryInitMonitorTask info:" + paramDownloadInfo);
    if (paramDownloadInfo == null) {
      return;
    }
    ...
    for (paramDownloadInfo = a(paramDownloadInfo);; paramDownloadInfo = localMonitorTask)
    {
      ...
      bcds.b("AppCenterReporter", ">tryInitMonitorTask 已有task2:" + localMonitorTask);
    }
  }
  
  public static void e(DownloadInfo paramDownloadInfo)
  {
    bcds.b("AppCenterReporter", ">downloadSuccCheck info:" + paramDownloadInfo);
    if (paramDownloadInfo == null) {
      return;
    }
    ...
    for (;;)
    {
      bcds.b("AppCenterReporter", ">downloadSuccCheck task:" + localMonitorTask1);
  ...
  {
    bcds.b("AppCenterReporter", ">deleteCheck info:" + paramDownloadInfo);
    if (paramDownloadInfo == null) {}
    do
    {
      return;
  ...
  {
    bcds.b("AppCenterReporter", ">installStartCheck ,info:" + paramDownloadInfo);
    if (paramDownloadInfo == null) {
      return;
    }
    MonitorTask localMonitorTask2 = ReplaceMonitor.get().getTask(paramDownloadInfo.jdField_b_of_type_JavaLangString);
    ...
    for (;;)
    {
      bcds.b("AppCenterReporter", ">installStartCheck task:" + localMonitorTask1);
      if (localMonitorTask1 == null) {
        break;
      }
