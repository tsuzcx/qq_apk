...
public class bcdj
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bcdj.class.getSimpleName();
  }
  
  public bcdj(List<ParagraphInfo> paramList, bcbn parambcbn, String paramString)
  {
    this.jdField_a_of_type_Bcbn = parambcbn;
        ...
        try
        {
          ...
          if ((k >= 0) && (k < ((List)localObject).size()))
          {
            ...
            if (this.jdField_a_of_type_Bcbn != null) {
              this.jdField_a_of_type_Bcbn.a((WordInfo)localObject);
            }
          }
