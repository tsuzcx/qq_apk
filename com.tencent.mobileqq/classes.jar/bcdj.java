  ...
  implements ahqp
{
  ...
  public bcdj(QQAppInterface paramQQAppInterface, Context paramContext, TroopChatPie paramTroopChatPie, View paramView, XListView paramXListView)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_ComTencentWidgetXListView = paramXListView;
    this.jdField_a_of_type_Bcdm = new bcdm(this, paramTroopChatPie);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Bcdm);
    a();
  }
  ...
  public void a(String paramString, int paramInt, float paramFloat)
  {
    ...
    {
      return;
      paramInt = this.jdField_a_of_type_Bcdm.a(paramString);
    } while (paramInt == -1);
