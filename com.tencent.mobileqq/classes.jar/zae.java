...
public class zae
  implements Runnable
{
  public zae(FrameHelperActivity paramFrameHelperActivity, QQAppInterface paramQQAppInterface) {}
  ...
  public void run()
  {
    ...
    RandomCoverView localRandomCoverView = (RandomCoverView)this.jdField_a_of_type_ComTencentMobileqqAppFrameHelperActivity.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131371199);
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppFrameHelperActivity.jdField_a_of_type_AndroidOsHandler.postDelayed(new zaf(this, (Card)localObject), 3000L);
  }
}
