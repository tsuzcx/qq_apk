  ...
  implements awvj
{
  ...
  public aezg(NewAuthDevUgFragment paramNewAuthDevUgFragment)
  {
  ...
  public void a(int paramInt, Exception paramException)
  {
    ...
    {
      awvm.a(NewAuthDevUgFragment.a(localNewAuthDevUgFragment), paramException, 3, NewAuthDevUgFragment.b(localNewAuthDevUgFragment));
      return;
    }
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString1 = plw.a();
        if ((!bhnv.h(localNewAuthDevUgFragment.getActivity())) && (paramString1 != null)) {
        ...
        int i = asvf.a().a(NewAuthDevUgFragment.a(localNewAuthDevUgFragment).getAppInterface(), NewAuthDevUgFragment.a(localNewAuthDevUgFragment), paramString1);
        if (i != 0)
        {
