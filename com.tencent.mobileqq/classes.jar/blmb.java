...
{
  static final ArrayList<blng> c = new ArrayList();
  ...
  ArrayList<blng> jdField_b_of_type_JavaUtilArrayList;
  private final boolean jdField_b_of_type_Boolean;
  
  public blmb(ArrayList<blng> paramArrayList1, ArrayList<blng> paramArrayList2, ListAdapter paramListAdapter)
  {
  ...
  private boolean a(ArrayList<blng> paramArrayList)
  {
    if (paramArrayList != null)
    {
      paramArrayList = paramArrayList.iterator();
      while (paramArrayList.hasNext()) {
        if (!((blng)paramArrayList.next()).jdField_a_of_type_Boolean) {
          return false;
        }
      }
    }
  ...
  public boolean a(View paramView)
  {
    ...
    {
      if (((blng)this.jdField_a_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_AndroidViewView == paramView)
      {
  ...
  public boolean b(View paramView)
  {
    ...
    {
      if (((blng)this.jdField_b_of_type_JavaUtilArrayList.get(i)).jdField_a_of_type_AndroidViewView == paramView)
      {
  ...
  public Object getItem(int paramInt)
  {
    int i = a();
    if (paramInt < i) {
      return ((blng)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_JavaLangObject;
    }
    int j = paramInt - i;
    paramInt = 0;
    if (this.jdField_a_of_type_AndroidWidgetListAdapter != null)
    ...
    return ((blng)this.jdField_b_of_type_JavaUtilArrayList.get(j - paramInt)).jdField_a_of_type_JavaLangObject;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    View localView;
    if (paramInt < k) {
      localView = ((blng)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_AndroidViewView;
    }
    for (;;)
    {
      ...
      try
      {
        localView = ((blng)this.jdField_b_of_type_JavaUtilArrayList.get(m - i)).jdField_a_of_type_AndroidViewView;
      }
  ...
  public boolean isEnabled(int paramInt)
  {
    int k = a();
    if (paramInt < k) {
      return ((blng)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_Boolean;
    }
    int m = paramInt - k;
    int i;
    if (this.jdField_a_of_type_AndroidWidgetListAdapter != null)
    ...
    boolean bool = ((blng)this.jdField_b_of_type_JavaUtilArrayList.get(m - i)).jdField_a_of_type_Boolean;
    return bool;
  }
