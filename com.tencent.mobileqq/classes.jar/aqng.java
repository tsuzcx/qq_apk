  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramBoolean)
    {
      ...
      try
      {
        ...
        aqnd.a(this.a.a).opType("huiyin").opName("loginresult").d1(String.valueOf(this.a.a.jdField_a_of_type_Long)).d2(String.valueOf(this.a.a.jdField_a_of_type_Boolean)).report();
    ...
    if (paramBundle.containsKey("data_error_msg"))
    {
      ...
      IVPluginDataReporter localIVPluginDataReporter = aqnd.a(this.a.a).opType("huiyin").opName("login_fail");
    ...
    aqnd.a(this.a.a).opType("huiyin").opName("login_fail").report();
  }
}
