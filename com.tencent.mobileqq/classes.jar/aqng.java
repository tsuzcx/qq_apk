...
public class aqng
  extends aqmy
{
  public aqng(BusinessCardEditActivity paramBusinessCardEditActivity) {}
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      QQToast.a(this.a.getActivity(), 2, anzj.a(2131700170), 0).b(this.a.getTitleBarHeight());
      this.a.finish();
      return;
    }
    QQToast.a(this.a.getActivity(), 1, anzj.a(2131700165), 0).b(this.a.getTitleBarHeight());
  }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if ((paramBoolean) && (paramString.equals(this.a.jdField_a_of_type_JavaLangString)))
    {
      ...
      {
        this.a.c = 0;
        this.a.jdField_a_of_type_Aqmx.a(false);
      }
      if ((!this.a.jdField_a_of_type_Boolean) || (!this.a.b) || (this.a.isFinishing())) {
        break label190;
      }
      this.a.jdField_a_of_type_Aqmx.a(paramString);
    ...
    {
      return;
      paramString = this.a.jdField_a_of_type_Aqmx.a(paramString);
  ...
  public void b(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      this.a.b(anzj.a(2131700167));
      bdll.b(this.a.app, "CliOper", "", "", "0X8007748", "0X8007748", this.a.d, 0, "", "", "", "");
      return;
    }
    QQToast.a(this.a.getActivity(), 2, anzj.a(2131700175), 0).b(this.a.getTitleBarHeight());
  }
  ...
  public void b(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      localObject = ((Resources)localObject).getString(2131697866);
    ...
    paramString = ((Resources)localObject).getString(2131697864);
    if (paramInt == 66) {
      paramString = ((Resources)localObject).getString(2131697865);
    }
