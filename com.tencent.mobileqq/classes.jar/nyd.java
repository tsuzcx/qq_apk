  ...
  implements Manager
{
  ...
  public nyd(QQAppInterface paramQQAppInterface)
  {
  ...
  private oib a()
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      return (oib)((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getManager(237);
    }
    return null;
  }
  ...
  private void b()
  {
    ...
    if (localTVK_IProxyFactory != null)
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setPreloadCallback(new nyh(this, null));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setOnPreLoadCompleteCallback(new nyi(this, null));
    }
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_UserInfo = new TVK_UserInfo(b(), "");
    this.jdField_a_of_type_Nyg = new nyg(this, this);
    AppNetConnInfo.registerConnectionChangeReceiver(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Nyg);
  ...
  public void a(nxq paramnxq)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        c("handlePreloadTaskFromMessage msgid:" + paramnxq.c + ", vid:" + localnxr.b);
        if (!TextUtils.isEmpty(localnxr.b))
        {
          ...
          localPAAdPreloadTask.mMsgId = paramnxq.c;
          ...
          if (paramnxq.jdField_a_of_type_Long > 0L)
          {
            ...
            c("handlePreloadTaskFromMessage msgid:" + paramnxq.c + ", vid:" + localnxr.b + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label309:
      c("handlePreloadTaskFromMessage msgid:" + paramnxq.c + ", vid:" + localnxr.b + ", exist in queue, ignore");
    }
  }
  
  public void a(nxq paramnxq, int paramInt)
  {
    Object localObject = this.jdField_a_of_type_JavaLangObject;
    if (paramnxq != null) {}
    for (;;)
    {
      ...
      try
      {
        if ((paramnxq.jdField_a_of_type_Nxs == null) || (paramnxq.jdField_a_of_type_JavaUtilArrayList == null) || (paramnxq.jdField_a_of_type_JavaUtilArrayList.size() <= paramInt))
        {
          c("handlePreloadTaskFromPlay invalid item");
          return;
        }
        str = ((nxr)paramnxq.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).b;
        c("handlePreloadTaskFromPlay msgid:" + paramnxq.c + ", index:" + paramInt + ", vid:" + str);
        if (!TextUtils.isEmpty(str))
        {
          PAAdPreloadTask localPAAdPreloadTask = new PAAdPreloadTask();
          localPAAdPreloadTask.mUserUin = b();
          ...
          if (paramnxq.jdField_a_of_type_Long > 0L)
          {
            ...
            localPAAdPreloadTask.mExpireTime = (localPAAdPreloadTask.mReceiveTime + jdField_a_of_type_JavaLangLong.longValue());
            localPAAdPreloadTask.mPreloadState = 1;
            localPAAdPreloadTask.mNetworkType = paramnxq.jdField_a_of_type_Nxs.e;
            this.c.add(localPAAdPreloadTask);
            ThreadManager.executeOnNetWorkThread(new AdvertisementVideoPreloadManager.9(this));
            c("handlePreloadTaskFromPlay msgid:" + paramnxq.c + ", index:" + paramInt + ", vid:" + str + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label317:
      c("handlePreloadTaskFromPlay msgid:" + paramnxq.c + ", index:" + paramInt + ", vid:" + str + ", exist in queue, ignore");
    }
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Nyg != null)
    {
      ...
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Nyg);
      this.jdField_a_of_type_Nyg = null;
    }
