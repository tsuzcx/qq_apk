  ...
  extends WebViewPlugin
{
  ...
  public nyd()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBusinessObserver = new nye(this);
  ...
  private void a(int paramInt, long paramLong, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog == null) {
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = Utils.createPluginSetDialogForWeb(this.mRuntime.a(), this.jdField_a_of_type_Aady, this.jdField_a_of_type_ComTencentMobileqqAppBusinessObserver, paramInt, paramLong, paramString1, paramString2);
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (l != -1L)
        {
          ...
          this.jdField_a_of_type_Aady.a(18, paramString2, this.jdField_a_of_type_ComTencentMobileqqAppBusinessObserver);
        }
      }
      ...
      if (paramString3.equals("getPluginStatus")) {
        try
        {
          ...
          this.jdField_a_of_type_Aady.a(18, paramString1, this.jdField_a_of_type_ComTencentMobileqqAppBusinessObserver);
        }
        catch (JSONException paramJsBridgeListener)
        {
          paramJsBridgeListener.printStackTrace();
        ...
        try
        {
          ...
          if (!TextUtils.isEmpty(paramJsBridgeListener))
          {
            ...
            bcnc.a("hot_list", "clk_hot_list", new String[] { paramJsBridgeListener });
          }
        }
        catch (JSONException paramJsBridgeListener)
        {
