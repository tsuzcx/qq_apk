...
public final class sfq
{
  ...
  static
  {
    jdField_a_of_type_Sfr = new sfr(null);
  }
  
  @SuppressLint({"ClickableViewAccessibility"})
  private final void a(View paramView)
  {
    paramView = (ViewStub)paramView.findViewById(2131380508);
    if (this.jdField_a_of_type_AndroidViewView == null) {
      this.jdField_a_of_type_AndroidViewView = paramView.inflate();
    }
    paramView = this.jdField_a_of_type_AndroidViewView;
    if (paramView != null) {
      paramView.setOnTouchListener((View.OnTouchListener)new sfu(this));
    }
  }
  ...
  private final void a(Function0<Unit> paramFunction0)
  {
    ...
    if (localView != null)
    {
      ...
      this.jdField_a_of_type_AndroidViewViewPropertyAnimator = localView.animate().alpha(1.0F).setDuration(300L).setListener((Animator.AnimatorListener)new sfw(this, paramFunction0));
  ...
  private final boolean a()
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if ((i == 0) || (!bkwm.a("video_column", j)) || (this.d)) {
        break;
      }
      return true;
    }
  ...
  {
    paramView = (ViewStub)paramView.findViewById(2131380506);
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView = ((DiniFlyAnimationView)paramView.findViewById(2131380507));
    ...
    if (paramView != null)
    {
      ...
      paramView.addAnimatorListener((Animator.AnimatorListener)new sfv(this));
  ...
  private final void d()
  {
    ...
    if (localObject != null)
    {
      ...
      localObjectAnimator.addListener((Animator.AnimatorListener)new sfs((View)localObject));
