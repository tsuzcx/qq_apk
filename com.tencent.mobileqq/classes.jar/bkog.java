  ...
  private void b(InnerFavoritesData paramInnerFavoritesData)
  {
    try
    {
      ...
      if ((localObject1 instanceof QQAppInterface))
      {
        ...
        String str1 = localQQAppInterface.getApplication().getString(2131692160) + paramInnerFavoritesData.title;
        String str2 = paramInnerFavoritesData.entryPath;
        String str3 = localQQAppInterface.getApplication().getString(2131692159);
