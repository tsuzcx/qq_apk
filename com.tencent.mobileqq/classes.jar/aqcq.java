...
public class aqcq
{
  ...
  public static void a(Activity paramActivity, apwv paramapwv, String paramString, EditExtendFriendInfo.SchoolInfo paramSchoolInfo)
  {
    ...
    paramString = String.format(paramActivity.getString(2131699249), new Object[] { paramString });
    bdcd.a(paramActivity, 230).setMessage(paramString).setPositiveButton(paramActivity.getString(2131699250), new aqcv(paramapwv, paramSchoolInfo)).setNegativeButton(paramActivity.getString(2131690654), new aqcu()).show();
  }
  ...
  public static void a(Activity paramActivity, String paramString)
  {
    ...
    View localView = paramActivity.getLayoutInflater().inflate(2131560916, null);
    localDialogFromBottom.setContentView(localView);
    ((TextView)localView.findViewById(2131377968)).setText(new baig(paramActivity.getResources().getString(2131699260) + "\024\022", 6, 16));
    ((ImageView)localView.findViewById(2131362823)).setOnClickListener(new aqcr(localDialogFromBottom));
    localDialogFromBottom.setOnCancelListener(new aqcs());
    Button localButton = (Button)localView.findViewById(2131367256);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new aqct(paramActivity, paramString, localDialogFromBottom));
    ((LinearLayout)localView.findViewById(2131364700)).setVisibility(8);
    ((Button)localView.findViewById(2131376117)).setVisibility(8);
