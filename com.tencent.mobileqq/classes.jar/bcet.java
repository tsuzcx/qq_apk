...
public class bcet
{
  ...
  protected static HttpURLConnection a(bceu parambceu)
  {
    for (;;)
    {
      try
      {
        localObject1 = MsfSdkUtils.insertMtype("yingyongbao", parambceu.jdField_b_of_type_JavaLangString);
        if (bcdn.a(bbtm.a().a()))
        {
          i = "http://".length();
          localObject3 = bcdn.c(bbtm.a().a());
          String str = bcdn.d(bbtm.a().a());
          j = ((String)localObject1).indexOf('/', i);
          if (j < 0)
          {
            localObject2 = ((String)localObject1).substring(i);
            localObject1 = "";
            bcds.c(jdField_a_of_type_JavaLangString, "http://" + (String)localObject3 + ":" + str + (String)localObject1);
            localObject3 = (HttpURLConnection)new URL("http://" + (String)localObject3 + ":" + str + (String)localObject1).openConnection();
            localObject1 = localObject3;
          }
        }
      }
      catch (Exception parambceu)
      {
        int j;
        Object localObject2;
        localObject3 = null;
        bcds.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- Exception!!!", parambceu);
      ...
      try
      {
        ...
        localObject3 = localObject1;
        if (parambceu.jdField_c_of_type_Long > 0L)
        {
          localObject3 = localObject1;
          ...
          localObject3 = localObject1;
          ((HttpURLConnection)localObject1).setRequestProperty("If-Modified-Since", ((SimpleDateFormat)localObject2).format(new Date(parambceu.jdField_c_of_type_Long)));
        }
        localObject3 = localObject1;
        i = ((HttpURLConnection)localObject1).getResponseCode();
        localObject3 = localObject1;
        bcds.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- reponseCode=" + i);
        if ((i == 302) || (i == 301))
        {
          localObject3 = localObject1;
          parambceu = ((HttpURLConnection)localObject1).getHeaderField("Location");
          localObject3 = localObject1;
          bcds.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- loc=" + parambceu);
          localObject3 = localObject1;
          a((HttpURLConnection)localObject1);
          parambceu = null;
          localObject1 = parambceu;
          bcds.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- uc=" + parambceu);
          return parambceu;
      ...
      if (localObject2 != null)
      {
        ...
        parambceu.jdField_a_of_type_Long = (a((HttpURLConnection)localObject2) * 1000L);
        localObject3 = localObject2;
        if (parambceu.jdField_a_of_type_Long == 0L)
        {
          localObject3 = localObject2;
          parambceu.jdField_a_of_type_Long = 86400000L;
        }
      }
      localObject3 = localObject2;
      parambceu.jdField_b_of_type_Long = System.currentTimeMillis();
      parambceu = (bceu)localObject2;
      continue;
      localObject3 = localObject1;
      ...
      {
        localObject3 = localObject1;
        bcds.c(jdField_a_of_type_JavaLangString, "--getimg-- " + parambceu.jdField_b_of_type_JavaLangString + " not modified");
        localObject3 = localObject1;
        parambceu.jdField_a_of_type_Long = (a((HttpURLConnection)localObject1) * 1000L);
        localObject3 = localObject1;
        parambceu.jdField_b_of_type_Long = System.currentTimeMillis();
        localObject3 = localObject1;
        a((HttpURLConnection)localObject1);
  ...
  protected static void a(HttpURLConnection paramHttpURLConnection)
  {
    ...
    {
      bcds.c("", "", paramHttpURLConnection);
    }
  }
  
  /* Error */
  public static boolean a(bceu parambceu)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 12
    ...
    //   7: istore 6
    //   9: aload_0
    //   10: invokestatic 274	bcet:a	(Lbceu;)Ljava/net/HttpURLConnection;
    //   13: astore 7
    //   15: aload 7
    //   17: ifnonnull +91 -> 108
    //   20: getstatic 14	bcet:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   36: aload_0
    //   37: getfield 72	bceu:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   52: invokestatic 131	bcds:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   55: iconst_0
    //   56: ifeq +11 -> 67
    ...
    //   113: i2l
    //   114: lstore_3
    //   115: invokestatic 291	bcax:a	()J
    //   118: lload_3
    //   119: lcmp
    //   120: ifge +86 -> 206
    //   123: getstatic 14	bcet:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   139: aload_0
    //   140: getfield 72	bceu:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   155: invokestatic 131	bcds:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   158: iconst_0
    //   159: ifeq +11 -> 170
    ...
    //   213: lconst_0
    //   214: lstore_3
    //   215: getstatic 16	bcet:jdField_a_of_type_Int	I
    //   218: newarray byte
    //   220: astore 9
    ...
    //   233: aload 9
    //   235: iconst_0
    //   236: getstatic 16	bcet:jdField_a_of_type_Int	I
    //   239: invokevirtual 306	java/io/InputStream:read	([BII)I
    //   242: istore_2
    //   243: iload_2
    //   244: ifle +77 -> 321
    //   247: getstatic 19	bcet:b	I
    //   250: istore_1
    //   251: lload_3
    //   252: iload_1
    //   253: i2l
    ...
    //   328: invokestatic 315	bcax:d	()Ljava/lang/String;
    //   331: invokevirtual 121	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   334: getstatic 318	com/tencent/open/base/img/ImageCache:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   337: invokevirtual 121	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   340: aload_0
    //   341: getfield 320	bceu:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   344: invokevirtual 121	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   347: getstatic 325	java/io/File:separator	Ljava/lang/String;
    //   350: invokevirtual 121	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   353: aload_0
    //   354: getfield 72	bceu:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   357: invokestatic 329	bcdp:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   393: invokespecial 332	java/io/File:<init>	(Ljava/lang/String;)V
    //   396: astore 10
    //   398: aload 10
    //   400: invokevirtual 335	java/io/File:getParent	()Ljava/lang/String;
    //   403: ifnull +23 -> 426
    //   406: aload 10
    //   408: invokevirtual 339	java/io/File:getParentFile	()Ljava/io/File;
    //   411: invokevirtual 343	java/io/File:exists	()Z
    //   414: ifne +12 -> 426
    //   417: aload 10
    //   419: invokevirtual 339	java/io/File:getParentFile	()Ljava/io/File;
    //   422: invokevirtual 346	java/io/File:mkdirs	()Z
    //   425: pop
    //   426: aload 10
    //   428: invokevirtual 343	java/io/File:exists	()Z
    //   431: ifeq +9 -> 440
    //   434: aload 10
    //   436: invokevirtual 349	java/io/File:delete	()Z
    //   439: pop
    //   440: aload 10
    //   442: invokevirtual 352	java/io/File:createNewFile	()Z
    //   445: pop
    //   446: new 354	java/io/FileOutputStream
    //   449: dup
    ...
    //   471: invokespecial 355	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   474: astore 9
    //   476: aload 9
    //   478: aload 13
    //   480: invokevirtual 359	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   483: invokevirtual 362	java/io/FileOutputStream:write	([B)V
    //   486: aload 9
    //   488: invokevirtual 365	java/io/FileOutputStream:flush	()V
    //   491: new 322	java/io/File
    //   494: dup
    //   495: aload 14
    //   497: invokespecial 332	java/io/File:<init>	(Ljava/lang/String;)V
    //   500: astore 12
    //   502: aload 12
    //   504: invokevirtual 343	java/io/File:exists	()Z
    //   507: ifeq +9 -> 516
    //   510: aload 12
    //   512: invokevirtual 349	java/io/File:delete	()Z
    //   515: pop
    //   516: aload 10
    //   518: aload 12
    //   520: invokevirtual 369	java/io/File:renameTo	(Ljava/io/File;)Z
    //   523: pop
    //   524: ldc_w 371
    //   527: aload_0
    //   528: getfield 372	bceu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   531: invokestatic 131	bcds:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   534: aload_0
    //   535: aload 7
    //   537: invokevirtual 375	java/net/HttpURLConnection:getLastModified	()J
    //   540: putfield 169	bceu:jdField_c_of_type_Long	J
    //   543: iconst_1
    //   544: istore 5
    //   546: aload 9
    //   548: ifnull +8 -> 556
    //   551: aload 9
    //   553: invokevirtual 376	java/io/FileOutputStream:close	()V
    //   556: aload 8
    //   558: ifnull +8 -> 566
    //   561: aload 8
    ...
    //   596: aconst_null
    //   597: astore 8
    //   599: getstatic 14	bcet:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   602: ldc_w 378
    //   605: aload 9
    //   607: invokestatic 268	bcds:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   610: aload 10
    //   612: ifnull +17 -> 629
    //   615: aload 10
    //   617: invokevirtual 343	java/io/File:exists	()Z
    //   620: ifeq +9 -> 629
    //   623: aload 10
    //   625: invokevirtual 349	java/io/File:delete	()Z
    //   628: pop
    //   629: aload 11
    //   631: ifnull +17 -> 648
    //   634: aload 11
    //   636: invokevirtual 343	java/io/File:exists	()Z
    //   639: ifeq +9 -> 648
    //   642: aload 11
    //   644: invokevirtual 349	java/io/File:delete	()Z
    //   647: pop
    //   648: aload_0
    //   649: ifnull +7 -> 656
    //   652: aload_0
    //   653: invokevirtual 376	java/io/FileOutputStream:close	()V
    //   656: aload 7
    //   658: ifnull +8 -> 666
    //   661: aload 7
    ...
    //   703: ifnull +8 -> 711
    //   706: aload 9
    //   708: invokevirtual 376	java/io/FileOutputStream:close	()V
    //   711: aload 8
    //   713: ifnull +8 -> 721
    //   716: aload 8
