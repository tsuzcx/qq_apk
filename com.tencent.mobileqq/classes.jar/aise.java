...
public class aise
  implements Runnable
{
  public aise(ConfigSetting paramConfigSetting, ConfigurationService.Config paramConfig) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      localObject4 = ((JSONObject)localObject3).optJSONObject("fileType");
      ...
      while (((Iterator)localObject6).hasNext())
      {
        ...
        aisl localaisl = new aisl(this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting, null);
        localaisl.jdField_b_of_type_ArrayOfJavaLangString = ConfigSetting.a(this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting, str);
        ConfigSetting.a(this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting).put(localObject7, localaisl);
      }
      ...
      if (((Iterator)localObject4).hasNext())
      {
        ...
        localObject7 = (aisl)ConfigSetting.a(this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting).get(localObject5);
        str = ((JSONObject)localObject6).optString("key");
        ((aisl)localObject7).jdField_a_of_type_ArrayOfJavaLangString = ConfigSetting.a(this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting, str);
        if (ConfigSetting.e(this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting) == 1) {
          ((aisl)localObject7).jdField_a_of_type_JavaLangString = ((JSONObject)localObject6).optString("Tips1");
        }
        for (((aisl)localObject7).jdField_b_of_type_JavaLangString = ((JSONObject)localObject6).optString("Link1");; ((aisl)localObject7).jdField_b_of_type_JavaLangString = ((JSONObject)localObject6).optString("Link0"))
        {
          ...
          localEditor.putString("key_str_key_tips" + (String)localObject5, ((aisl)localObject7).jdField_a_of_type_JavaLangString);
          localEditor.putString("key_str_key_link" + (String)localObject5, ((aisl)localObject7).jdField_b_of_type_JavaLangString);
          break;
          ((aisl)localObject7).jdField_a_of_type_JavaLangString = ((JSONObject)localObject6).optString("Tips0");
        }
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localObject2 = (TicketManager)BaseApplicationImpl.getApplication().getRuntime().getManager(2);
      if (TextUtils.isEmpty(((TicketManager)localObject2).getPskey(this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting.a.getCurrentAccountUin(), "docs.qq.com")))
      {
        localObject3 = this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting.a.getCurrentAccountUin();
        localObject4 = ConfigSetting.a(this.jdField_a_of_type_ComTencentMobileqqTeamworkSpreadConfigSetting);
        ((TicketManager)localObject2).GetPskey((String)localObject3, 16L, new String[] { "docs.qq.com" }, (WtTicketPromise)localObject4);
        break;
      }
