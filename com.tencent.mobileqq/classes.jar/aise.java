  ...
  extends aira
{
  ...
  aise(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  protected void a(Intent paramIntent, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    if (this.jdField_a_of_type_Bdmu != null)
    {
      ...
      {
        bool = true;
        paramArrayList = ((bdmu)localObject).a(paramArrayList, bool, this.mPhotoCommonData.selectedMediaInfoHashMap, this.mPhotoCommonData.allMediaInfoHashMap);
  ...
  public boolean addAndRemovePhotoByGesture(LocalMediaInfo paramLocalMediaInfo, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (bool) && (this.jdField_a_of_type_Bdmu != null))
    {
      localbdmu = this.jdField_a_of_type_Bdmu;
    ...
    {
      localbdmu.a(localAbstractPhotoListActivity, paramLocalMediaInfo, paramBoolean, this.mPhotoCommonData.selectedMediaInfoHashMap, this.mPhotoCommonData.allMediaInfoHashMap, true);
      return bool;
    }
  }
  ...
  public Intent caseNoSingModeImage(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    azqs.b(null, "dc00898", "", "", "0X800A06C", "0X800A06C", 3, 0, this.mPhotoCommonData.selectedPhotoList.size() + "", "", "", "");
    ...
    for (int i = 2;; i = 1)
    {
      azqs.b(null, "dc00898", "", "", "0X800AB6D", "0X800AB6D", i, 0, "", "", "", "");
  ...
  {
    if (this.jdField_a_of_type_Aiqz.a != null)
    {
      int i = PhotoUtils.c(this.jdField_a_of_type_Aiqz.a);
      azqs.b(null, "CliOper", "", this.mPhotoCommonData.myUin, "0X800A915", "0X800A915", i, 0, "", "", "", "");
    }
  ...
  public void initData(Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Aiqz.isSupportVideoCheckbox = true;
    this.jdField_a_of_type_Aiqz.isSingleMode = false;
    this.jdField_a_of_type_Aiqz.e = true;
    this.jdField_a_of_type_Aiqz.c = true;
    this.jdField_a_of_type_Aiqz.filter.setSupportWebp(true);
    this.jdField_a_of_type_Boolean = paramIntent.getBooleanExtra("PhotoConst.QZONE_ALBUM_FROM_AIO", false);
    this.jdField_a_of_type_Aiqz.customSendBtnText = ((NewPhotoListActivity)this.mActivity).getResources().getString(2131695307);
    if (this.mPhotoCommonData.currentQualityType == 2) {
      this.c = true;
    }
    paramIntent = new bdmu().a(this.mPhotoCommonData.jdField_a_of_type_Int).b(this.mPhotoCommonData.videoSizeLimit);
    if ((!this.b) && (!this.jdField_a_of_type_Aiqz.l)) {}
  ...
  public void onCheckBoxClick(View paramView, int paramInt, CheckBox paramCheckBox)
  {
    ...
    for (int j = 2;; j = 1)
    {
      azqs.b(null, "dc00898", "", "", "0X800AB6C", "0X800AB6C", j, 0, "", "", "", "");
      if (i == 0) {
        break label211;
      }
      long l = System.currentTimeMillis();
      if (l - this.jdField_a_of_type_Aiqz.lastTimeShowToast >= 1000L)
      {
    ...
    if (k == 1)
    {
      ...
      if (this.jdField_a_of_type_Bdmu != null)
      {
        localObject2 = this.jdField_a_of_type_Bdmu;
        ...
        bool2 = true;
        label294:
        ((bdmu)localObject2).a(localAbstractPhotoListActivity, paramCheckBox, bool2, this.mPhotoCommonData.selectedMediaInfoHashMap, this.mPhotoCommonData.allMediaInfoHashMap, true);
      }
      if ((this.jdField_a_of_type_Aiqz.isSupportVideoCheckbox) && (localObject1 != null) && ("video".equals(localObject1[0])))
      {
        ...
        if (this.jdField_a_of_type_Aiqz.videoSelectedCnt == 1) {
          this.jdField_a_of_type_Aiqz.selectedVideoInfo = paramView;
        }
      }
      ...
      aips.a(((NewPhotoListActivity)this.mActivity).getIntent(), "param_totalSelNum");
      ...
      paramView = (LinkedHashMap)bdfa.sSelectItemPosMap.get(this.mPhotoCommonData.albumId);
      if (paramView != null) {
        break label972;
      }
      paramView = new LinkedHashMap();
      bdfa.sSelectItemPosMap.put(this.mPhotoCommonData.albumId, paramView);
    }
    label680:
    label972:
    for (;;)
    {
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        if ((this.jdField_a_of_type_Aiqz.isSupportVideoCheckbox) && (localObject1 != null) && ("video".equals(localObject1[0])))
        {
          localObject1 = this.jdField_a_of_type_Aiqz;
          ((aiqz)localObject1).videoSelectedCnt -= 1;
          if (this.jdField_a_of_type_Aiqz.videoSelectedCnt == 1) {
            this.jdField_a_of_type_Aiqz.selectedVideoInfo = paramView;
          }
        }
        ...
        {
          localObject1 = this.jdField_a_of_type_Aiqz;
          ((aiqz)localObject1).gifSelectedCount -= 1;
        }
        ...
        aips.a(((NewPhotoListActivity)this.mActivity).getIntent(), "param_cancelSelNum");
        paramView = (HashMap)bdfa.sSelectItemPosMap.get(this.mPhotoCommonData.albumId);
        if (paramView != null) {
  ...
  public void onPreviewBtnClick(View paramView)
  {
    ...
    azqs.b(null, "dc00898", "", "", "0X800A06C", "0X800A06C", 2, 0, this.mPhotoCommonData.selectedPhotoList.size() + "", "", "", "");
  }
  ...
  public void onQualityBtnClick(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (!this.jdField_a_of_type_Aiqz.d) {
  ...
  public void onTitleBtnCancelClick(View paramView)
  {
    ...
    {
      int i = PhotoUtils.c(this.jdField_a_of_type_Aiqz.a);
      azqs.b(null, "CliOper", "", this.mPhotoCommonData.myUin, "0X800A916", "0X800A916", i, 0, "", "", "", "");
    }
