...
{
  public rxt(ChatHistoryForC2C paramChatHistoryForC2C, ActionSheet paramActionSheet) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (paramView = "删除本地的聊天记录和对应的云端聊天记录，无法恢复";; paramView = "删除本地聊天记录，再次进入聊天记录可从云端重新获取聊天记录")
    {
      ...
      localQQCustomDialog.setNegativeButton(2131432998, new rxu(this));
      localQQCustomDialog.setPositiveButton(2131432999, new rxv(this, paramInt));
