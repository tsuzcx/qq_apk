...
public class rxt
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new rxw(this, Looper.getMainLooper());
  ...
  public rxt(Activity paramActivity, AppRuntime paramAppRuntime, View paramView, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131380542));
  }
  ...
  public void a(VideoInfo paramVideoInfo)
  {
    ...
    do
    {
      ...
      i = bnrf.H(this.jdField_a_of_type_MqqAppAppRuntime);
    } while (i >= 3);
    bnrf.B(this.jdField_a_of_type_MqqAppAppRuntime, i + 1);
    ...
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131380547);
    if (!TextUtils.isEmpty(paramVideoInfo.g)) {
      localTextView.setText(anzj.a(2131714942));
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new rxu(this));
      this.jdField_b_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new rxv(this));
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new VideofeedsUserGuideController.4(this), 300L);
      return;
      localTextView.setText(anzj.a(2131714941));
    }
  }
