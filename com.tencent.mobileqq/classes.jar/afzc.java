...
public class afzc
  implements behi
{
  private afzc(AlbumListActivity paramAlbumListActivity) {}
  
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    paramAdapterView = this.a.jdField_a_of_type_Afze.a(paramInt);
    if ((paramAdapterView == null) || (paramAdapterView.mMediaFileCount <= 0) || (TextUtils.isEmpty(paramAdapterView.name))) {
      bbmy.a(this.a, 2131624466, 0).a();
    }
    Object localObject;
    do
    {
      ...
      bfpr.a(this.a, (bfpy)localObject, paramView, 0);
    ...
    for (paramInt = 0;; paramInt = 1) {
      for (;;)
      {
        for (;;)
        {
          urp.a("pic_choose_slides", "change_album", paramInt, 0, new String[0]);
          return;
