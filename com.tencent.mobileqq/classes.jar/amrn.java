...
public class amrn
{
  static amrn jdField_a_of_type_Amrn;
  private balz jdField_a_of_type_Balz = new amro(this);
  ShareAppLogHelper jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper;
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  
  amrn(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramQQAppInterface);
  }
  
  public static amrn a(QQAppInterface paramQQAppInterface)
  {
    jdField_a_of_type_Amrn = new amrn(paramQQAppInterface);
    return jdField_a_of_type_Amrn;
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper.a(this.jdField_a_of_type_Balz);
