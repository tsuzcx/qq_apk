...
public class bfbc
{
  ...
  private void b(byte[] paramArrayOfByte)
  {
    ...
    //   1: ifnonnull +4 -> 5
    //   4: return
    //   5: getstatic 25	bfbc:jdField_a_of_type_Boolean	Z
    //   8: ifne -4 -> 4
    //   11: iconst_1
    //   12: putstatic 25	bfbc:jdField_a_of_type_Boolean	Z
    ...
    //   60: aload_0
    //   61: iload_2
    //   62: invokevirtual 52	bfbc:a	(I)Z
    //   65: ifne +59 -> 124
    //   68: aload_0
    //   69: monitorenter
    //   70: getstatic 54	bfbc:jdField_a_of_type_Int	I
    //   73: iconst_1
    //   74: isub
    //   75: putstatic 54	bfbc:jdField_a_of_type_Int	I
    //   78: aload_0
    //   79: monitorexit
    //   80: iconst_0
    //   81: putstatic 25	bfbc:jdField_a_of_type_Boolean	Z
    //   84: return
    //   85: astore_1
    //   86: iconst_0
    //   87: putstatic 25	bfbc:jdField_a_of_type_Boolean	Z
    //   90: aload_1
    //   91: invokevirtual 57	java/lang/Exception:printStackTrace	()V
    //   94: aload_0
    //   95: iload_2
    //   96: invokevirtual 52	bfbc:a	(I)Z
    //   99: ifne +184 -> 283
    //   102: aload_0
    //   103: monitorenter
    //   104: getstatic 54	bfbc:jdField_a_of_type_Int	I
    //   107: iconst_1
    //   108: isub
    //   109: putstatic 54	bfbc:jdField_a_of_type_Int	I
    //   112: aload_0
    //   113: monitorexit
    //   114: iconst_0
    //   115: putstatic 25	bfbc:jdField_a_of_type_Boolean	Z
    //   118: return
    //   119: astore_1
    //   120: aload_0
    //   121: monitorexit
    ...
    //   213: aload 4
    //   215: aload 5
    //   217: invokevirtual 74	bfbc:a	(Lcom/tencent/ims/safecheckPB$ReqMQScanRequest;Lcom/tencent/ims/safecheckPB$RspMQScanReport;)V
    //   220: goto -126 -> 94
    //   223: aload_0
    //   224: aload 4
    //   226: aload 5
    //   228: invokevirtual 76	bfbc:b	(Lcom/tencent/ims/safecheckPB$ReqMQScanRequest;Lcom/tencent/ims/safecheckPB$RspMQScanReport;)V
    //   231: goto -137 -> 94
    //   234: aload_0
    //   235: aload 4
    //   237: aload 5
    //   239: invokevirtual 79	bfbc:c	(Lcom/tencent/ims/safecheckPB$ReqMQScanRequest;Lcom/tencent/ims/safecheckPB$RspMQScanReport;)V
    //   242: goto -148 -> 94
    //   245: aload_0
    //   246: aload 4
    //   248: aload 5
    //   250: invokevirtual 82	bfbc:e	(Lcom/tencent/ims/safecheckPB$ReqMQScanRequest;Lcom/tencent/ims/safecheckPB$RspMQScanReport;)V
    //   253: goto -159 -> 94
    //   256: aload_0
    //   257: aload 4
    //   259: aload 5
    //   261: invokevirtual 85	bfbc:f	(Lcom/tencent/ims/safecheckPB$ReqMQScanRequest;Lcom/tencent/ims/safecheckPB$RspMQScanReport;)V
    //   264: goto -170 -> 94
    //   267: aload_0
    //   268: aload 4
    //   270: aload 5
    //   272: invokevirtual 88	bfbc:d	(Lcom/tencent/ims/safecheckPB$ReqMQScanRequest;Lcom/tencent/ims/safecheckPB$RspMQScanReport;)V
    //   275: goto -181 -> 94
    //   278: astore_1
    //   279: aload_0
    //   280: monitorexit
    ...
    //   410: aload_0
    //   411: getfield 15	bfbc:jdField_a_of_type_Bfba	Lbfba;
    //   414: ifnull -410 -> 4
    //   417: aload_0
    //   418: getfield 15	bfbc:jdField_a_of_type_Bfba	Lbfba;
    //   421: getfield 117	bfba:jdField_a_of_type_Bfax	Lbfax;
    //   424: astore 6
    //   426: aload 6
    //   428: ifnull -424 -> 4
    //   431: aload_1
    ...
    //   483: aload_0
    //   484: monitorenter
    //   485: getstatic 54	bfbc:jdField_a_of_type_Int	I
    //   488: iconst_1
    //   489: isub
    //   490: putstatic 54	bfbc:jdField_a_of_type_Int	I
    //   493: aload_0
    //   494: monitorexit
    //   495: iconst_0
    //   496: putstatic 25	bfbc:jdField_a_of_type_Boolean	Z
    //   499: return
    //   500: aload_0
    //   501: getfield 15	bfbc:jdField_a_of_type_Bfba	Lbfba;
    //   504: ifnull -500 -> 4
    //   507: aload_0
    //   508: getfield 15	bfbc:jdField_a_of_type_Bfba	Lbfba;
    //   511: getfield 117	bfba:jdField_a_of_type_Bfax	Lbfax;
    //   514: astore 6
    //   516: aload 6
    //   518: ifnull -514 -> 4
    //   521: aload 5
    ...
    //   424	134	6	localbfax	bfax
    //   446	102	7	localbfay	bfay
    // Exception table:
    //   from	to	target	type
  ...
  public void a(safecheckPB.ReqMQScanRequest paramReqMQScanRequest, safecheckPB.RspMQScanReport paramRspMQScanReport)
  {
    ...
    if (this.jdField_a_of_type_Bfba != null) {
      localObject1 = this.jdField_a_of_type_Bfba.jdField_a_of_type_AndroidContentContext;
    }
  ...
  public void b(safecheckPB.ReqMQScanRequest paramReqMQScanRequest, safecheckPB.RspMQScanReport paramRspMQScanReport)
  {
    ...
    if (this.jdField_a_of_type_Bfba != null) {
      paramReqMQScanRequest = this.jdField_a_of_type_Bfba.jdField_a_of_type_AndroidContentContext;
    }
  ...
  public void c(safecheckPB.ReqMQScanRequest paramReqMQScanRequest, safecheckPB.RspMQScanReport paramRspMQScanReport)
  {
    ...
    if (this.jdField_a_of_type_Bfba != null) {
      localObject = this.jdField_a_of_type_Bfba.jdField_a_of_type_AndroidContentContext;
    }
    if (localObject == null) {
      return;
    }
  ...
  public void d(safecheckPB.ReqMQScanRequest paramReqMQScanRequest, safecheckPB.RspMQScanReport paramRspMQScanReport)
  {
    ...
    //   1: astore 6
    //   3: aload_0
    //   4: getfield 15	bfbc:jdField_a_of_type_Bfba	Lbfba;
    //   7: ifnull +330 -> 337
    //   10: aload_0
    //   11: getfield 15	bfbc:jdField_a_of_type_Bfba	Lbfba;
    //   14: getfield 146	bfba:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   17: astore 4
    //   19: aload 4
    //   21: ifnonnull +4 -> 25
    //   24: return
  ...
  public void e(safecheckPB.ReqMQScanRequest paramReqMQScanRequest, safecheckPB.RspMQScanReport paramRspMQScanReport)
  {
    int i = 0;
    if (this.jdField_a_of_type_Bfba != null) {}
    for (Object localObject1 = this.jdField_a_of_type_Bfba.jdField_a_of_type_AndroidContentContext;; localObject1 = null)
    {
      if (localObject1 == null) {}
      for (;;)
      {
