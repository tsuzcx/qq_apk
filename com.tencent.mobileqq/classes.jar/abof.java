  ...
  extends abnx
{
  ...
  public abof(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
    super(paramQQAppInterface, paramMessageHandler);
    this.jdField_a_of_type_JavaUtilComparator = new abog(this);
  }
  ...
  private Pair<String, Integer> a(String paramString, msg_comm.UinPairMsg paramUinPairMsg, long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    ayva localayva = new ayva(l6, Long.parseLong(paramString), true, paramBoolean2, paramBoolean3, false);
    localayva.jdField_e_of_type_Boolean = true;
    localayva.a(1000, localHashMap);
    localayva.a(1001, localHashSet);
    int i2 = 0;
    long l2 = -1L;
    ...
    long l3 = l2;
    l8 = alsh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l9, l8, paramUinPairMsg.peer_uin.get(), paramUinPairMsg);
    i1 = n;
    l4 = l1;
    localObject2 = localObject1;
    l3 = l2;
    ...
    else
    {
      ...
      localObject2 = localObject1;
      l3 = l2;
      localayva.jdField_a_of_type_Boolean = bool;
      i1 = n;
      l4 = l1;
      localObject2 = localObject1;
      l3 = l2;
      localayva.jdField_e_of_type_Long = l8;
      i1 = n;
      l4 = l1;
      localObject2 = localObject1;
      l3 = l2;
      localayva.h = paramBoolean3;
      i1 = n;
      l4 = l1;
      localObject2 = localObject1;
      l3 = l2;
      localObject4 = a((msg_comm.Msg)localObject4, localayva).iterator();
      i1 = n;
      l4 = l1;
      localObject2 = localObject1;
      l3 = l2;
      if (((Iterator)localObject4).hasNext())
      {
        ...
        if (l5 != -1L)
        {
          ...
          localObject2 = localObject1;
          l3 = l2;
          paramBoolean3 = bdec.a(((MessageRecord)localObject5).issend);
          if (paramBoolean3) {
            l1 = l5;
          }
        }
        for (;;)
        {
            ...
            for (;;)
            {
              ...
              try
              {
                ...
                for (;;)
                {
                  ...
                  if (aljq.az.equals(((MessageRecord)localObject5).frienduin)) {
                    ((MessageRecord)localObject5).time = NetConnInfoCenter.getServerTime();
                  }
                  if (aljq.aS.equals(((MessageRecord)localObject5).frienduin)) {
                  ...
                  {
                    if ((!paramBoolean3) && (azqa.a(((MessageRecord)localObject5).msgUid, ((MessageRecord)localObject5).shmsgseq) != null)) {
                      bark.a(true);
                    }
                    if ((paramBoolean3) && ((localObject5 instanceof MessageForPtt)) && (abot.d(((MessageRecord)localObject5).istroop)))
                    {
                  ...
                  if (((MessageRecord)localObject5).msgtype == -2002)
                  {
                    ...
                    localObject2 = localObject1;
                    l3 = l2;
                    if (bdec.a(((MessageRecord)localObject5).issend))
                    {
                      if (l1 != -1L)
                      {
                        i1 = n;
          ...
          if ("2290230341".equals(((MessageRecord)localObject5).frienduin)) {
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80090E1", "0X80090E1", 0, 0, "", "", "", "");
          }
        }
      }
      break label2389;
      ...
      if (localArrayList1.size() > 0)
      {
        ...
        i1 = abot.a(localArrayList1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        aoep.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList1);
      ...
      for (paramBoolean1 = true;; paramBoolean1 = false)
      {
        ...
        amgj.a((MessageRecord)localArrayList1.get(0), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (n == 1008)
        {
          localObject1 = (aluw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56);
          if (localObject1 != null) {
            ((aluw)localObject1).a(localArrayList1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
        }
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          amfl.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, 0, (MessageRecord)localObject3);
        }
      }
      if (QLog.isColorLevel()) {
  ...
  private Pair<List<MessageRecord>, List<MessageRecord>> a(List<msg_comm.Msg> paramList, List<MessageRecord> paramList1, long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    List localList = ((alsl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(92)).a(String.valueOf(paramLong1), paramLong2 - 30L, 30L + paramLong3);
  ...
  private msg_svc.PbGetMsgResp a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      if (paramArrayOfByte == null) {
        azmz.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "msf.msg.decodeerr", false, 0L, 0L, new HashMap(), "");
      }
  ...
  private void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString1, String paramString2, long paramLong1, long paramLong2, long paramLong3, msg_comm.MsgHead paramMsgHead)
  {
    ...
    for (;;)
    {
      ...
      for (Object localObject4 = alsh.a(paramQQAppInterface, paramString1, str2);; localObject4 = paramMsgHead) {
        for (;;)
        {
          String str1;
          Object localObject5;
          ...
          try
          {
            ...
            if ((paramInt == -126) || (paramInt == 2))
            {
              ...
              if (paramLong2 > 0L)
              {
                paramMsgHead = (String)localObject4 + alpo.a(2131701661);
                paramString2 = alsh.a(paramQQAppInterface, String.valueOf(paramLong2), str2);
                n = i2;
                ...
                if (i1 == 1)
                {
                  paramMsgHead = paramMsgHead + alpo.a(2131701660);
                  localObject2 = paramMsgHead + paramString2 + alpo.a(2131701662);
                  str1 = paramString2;
                  ...
                  localObject3 = paramQQAppInterface.getApp().getApplicationContext().getString(2131697844);
                  if (!a(str2)) {
                    break label2148;
                  }
                  paramString2 = paramString2 + "，" + (String)localObject3;
                  localObject2 = "";
                  localObject6 = (MessageForGrayTips)ayvw.a(-1012);
                  ...
                  paramMsgHead = (bclk)paramQQAppInterface.getManager(81);
                  ...
                  if (!bool)
                  {
                    ...
                    paramMsgHead = ((alzf)paramQQAppInterface.a(20)).a();
                    if ((paramMsgHead.b("newMember")) && (paramMsgHead.a(str2))) {
                      paramMsgHead.c(str2, paramString1);
                    }
                    new azmo(paramQQAppInterface).a("dc00899").b("Grp_AIO").c("newman_join").d("exp_bar").a(new String[] { str2, "", "" + bclo.b(paramQQAppInterface, str2) }).a();
                  }
                  if (!QLog.isColorLevel()) {
                    break;
                  }
          ...
          catch (Exception paramMsgHead)
          {
            ...
            l1 = paramLong1;
            continue;
            localObject2 = paramMsgHead + paramString2 + alpo.a(2131701663);
            str1 = paramString2;
            paramString2 = (String)localObject2;
            continue;
            paramString2 = (String)localObject4 + alpo.a(2131701650);
            paramMsgHead = "";
            n = 0;
            str1 = "";
            continue;
            localObject2 = paramQQAppInterface.getApp().getApplicationContext().getString(2131697845);
          ...
          if (((paramInt != -125) && (paramInt != 3)) || (((bbml)paramQQAppInterface.getManager(32)).a(str2, (String)localObject3))) {
            break;
          }
          paramMsgHead = alsh.a(paramQQAppInterface, paramString2, str2);
          n = 0;
          if ((!TextUtils.isEmpty((CharSequence)localObject2)) && (((String)localObject2).equals(paramString2)))
          {
            paramMsgHead = alpo.a(2131701649);
            n = 1;
          }
          for (;;)
          {
            if (n != 0)
            {
              str1 = paramMsgHead + alpo.a(2131701651);
              label1538:
              localObject2 = str1 + (String)localObject4 + alpo.a(2131701658);
              localObject3 = paramQQAppInterface.getApp().getApplicationContext().getString(2131697845);
              localObject2 = (String)localObject2 + "，" + (String)localObject3;
              localObject5 = (MessageForGrayTips)ayvw.a(-1012);
              ...
              paramString2 = (bclk)paramQQAppInterface.getManager(81);
            ...
            for (bool = true;; bool = false)
            {
              if (!bool)
              {
                ...
                paramString2 = ((alzf)paramQQAppInterface.a(20)).a();
              ...
              return;
              str1 = paramMsgHead + alpo.a(2131701656);
              break label1538;
            }
          }
          label2148:
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   52: checkcast 931	[B
    //   55: checkcast 931	[B
    //   58: invokespecial 933	abof:a	([B)Lmsf/msgsvc/msg_svc$PbGetMsgResp;
    //   61: astore 25
    ...
    //   206: aload_0
    //   207: getfield 500	abof:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   210: aload_1
    //   211: aload_2
    ...
    //   254: astore 24
    //   256: aload_0
    //   257: getfield 500	abof:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   260: iconst_0
    ...
    //   373: aload 22
    //   375: iload 6
    //   377: invokespecial 980	abof:a	([B[BI)V
    //   380: iconst_0
    //   381: istore 10
    //   383: aload_0
    //   384: getfield 500	abof:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    ...
    //   398: ifle +25 -> 423
    //   401: aload_0
    //   402: getfield 500	abof:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   405: iload 4
    //   407: aload_2
    //   408: iload 5
    //   410: iload 11
    ...
    //   777: aload_3
    //   778: aload_0
    //   779: getfield 63	abof:jdField_a_of_type_JavaUtilComparator	Ljava/util/Comparator;
    //   782: invokestatic 1024	java/util/Collections:sort	(Ljava/util/List;Ljava/util/Comparator;)V
    //   785: aload_0
    //   786: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   789: bipush 51
    //   791: invokevirtual 360	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   794: checkcast 1026	aloz
    //   797: aload_3
    //   798: iconst_0
    ...
    //   822: invokevirtual 1029	aloz:a	(J)V
    //   825: aload_0
    //   826: getfield 500	abof:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   829: aload_2
    //   830: iconst_0
    ...
    //   847: iload 11
    //   849: iload 12
    //   851: invokespecial 1034	abof:a	(Ljava/lang/String;Lmsf/msgcomm/msg_comm$UinPairMsg;JZZZ)Landroid/util/Pair;
    //   854: astore_2
    //   855: aload_2
    ...
    //   880: ifne +169 -> 1049
    //   883: aload_0
    //   884: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   887: invokevirtual 248	com/tencent/mobileqq/app/QQAppInterface:a	()Layvc;
    //   890: aload_1
    //   891: invokevirtual 1046	ayvc:g	(Ljava/lang/String;)J
    //   894: lstore 18
    //   896: aload_3
    //   897: iconst_0
    ...
    //   999: ifge +35 -> 1034
    //   1002: aload_0
    //   1003: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1006: invokevirtual 248	com/tencent/mobileqq/app/QQAppInterface:a	()Layvc;
    //   1009: aload_1
    //   1010: lload 20
    //   1012: lconst_0
    //   1013: invokevirtual 1053	ayvc:b	(Ljava/lang/String;JJ)V
    //   1016: iload 4
    //   1018: ifle +16 -> 1034
    //   1021: aload_0
    //   1022: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1025: invokevirtual 248	com/tencent/mobileqq/app/QQAppInterface:a	()Layvc;
    //   1028: aload_1
    //   1029: lload 20
    //   1031: invokevirtual 1055	ayvc:g	(Ljava/lang/String;J)V
    //   1034: iload 4
    //   1036: ifne +13 -> 1049
    //   1039: aload_0
    //   1040: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1043: invokevirtual 248	com/tencent/mobileqq/app/QQAppInterface:a	()Layvc;
    //   1046: invokevirtual 1057	ayvc:c	()V
    //   1049: iconst_0
    //   1050: istore 8
    //   1052: iload 11
    //   1054: ifeq +441 -> 1495
    ...
    //   1065: aload_0
    //   1066: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1069: bipush 11
    //   1071: invokevirtual 360	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1074: checkcast 1059	aubm
    //   1077: aload_1
    //   1078: invokeinterface 1061 2 0
    //   1083: ifnull +3 -> 1086
    //   1086: iload 5
    //   1088: invokestatic 1064	abot:a	(I)I
    //   1091: sipush 1032
    ...
    //   1100: aload 22
    //   1102: aload_0
    //   1103: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1106: iload 9
    //   1108: invokestatic 1069	asiu:a	(Lmsf/msgcomm/msg_comm$UinPairMsg;Lcom/tencent/mobileqq/app/QQAppInterface;I)Ljava/lang/String;
    //   1111: astore_1
    ...
    //   1458: aload_0
    //   1459: getfield 500	abof:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   1462: astore_3
    //   1463: iload 4
    //   1465: ifgt +121 -> 1586
    //   1468: iconst_1
    ...
    //   1484: aload_0
    //   1485: getfield 36	abof:jdField_b_of_type_JavaUtilSet	Ljava/util/Set;
    //   1488: aload_1
    ...
    //   1571: aload_2
    //   1572: iconst_0
    //   1573: invokespecial 1137	abof:a	(BLmsf/msgcomm/msg_comm$UinPairMsg;Ljava/lang/String;I)I
    //   1576: istore 5
    //   1578: iconst_1
    //   1579: istore 8
    //   1581: aload_2
    ...
    //   1589: goto -118 -> 1471
    //   1592: aload_0
    //   1593: getfield 34	abof:jdField_a_of_type_JavaUtilSet	Ljava/util/Set;
    //   1596: aload_1
    ...
    //   1608: ifgt +544 -> 2152
    //   1611: aload_0
    //   1612: getfield 500	abof:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   1615: invokevirtual 1138	com/tencent/mobileqq/app/MessageHandler:c	()V
    //   1618: iload 11
    //   1620: ifeq +454 -> 2074
    //   1623: aload_0
    //   1624: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1627: invokevirtual 1141	com/tencent/mobileqq/app/QQAppInterface:a	()Labol;
    //   1630: invokevirtual 1145	abol:a	()Ljava/util/Set;
    ...
    //   1679: invokestatic 1064	abot:a	(I)I
    //   1682: sipush 1032
    ...
    //   1726: aload_0
    //   1727: getfield 34	abof:jdField_a_of_type_JavaUtilSet	Ljava/util/Set;
    //   1730: invokeinterface 1152 1 0
    //   1735: ifle +19 -> 1754
    //   1738: aload_0
    //   1739: getfield 34	abof:jdField_a_of_type_JavaUtilSet	Ljava/util/Set;
    //   1742: aload_2
    ...
    //   1760: aload_0
    //   1761: getfield 36	abof:jdField_b_of_type_JavaUtilSet	Ljava/util/Set;
    //   1764: invokeinterface 1152 1 0
    //   1769: ifle +19 -> 1788
    //   1772: aload_0
    //   1773: getfield 36	abof:jdField_b_of_type_JavaUtilSet	Ljava/util/Set;
    //   1776: aload_2
    ...
    //   1792: invokestatic 401	abot:d	(I)Z
    //   1795: ifeq -156 -> 1639
    //   1798: aload_2
    //   1799: invokestatic 1158	abol:c	(Lcom/tencent/mobileqq/data/ConversationInfo;)I
    //   1802: ifle -163 -> 1639
    ...
    //   1874: aload_0
    //   1875: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1878: invokevirtual 248	com/tencent/mobileqq/app/QQAppInterface:a	()Layvc;
    //   1881: aload_2
    //   1882: getfield 1148	com/tencent/mobileqq/data/ConversationInfo:uin	Ljava/lang/String;
    //   1885: invokevirtual 1165	ayvc:m	(Ljava/lang/String;)[B
    //   1888: astore_3
    //   1889: aload_3
    ...
    //   1993: aload_0
    //   1994: getfield 500	abof:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   1997: aload_3
    //   1998: iconst_1
    ...
    //   2065: aload_0
    //   2066: getfield 36	abof:jdField_b_of_type_JavaUtilSet	Ljava/util/Set;
    //   2069: invokeinterface 1181 1 0
    //   2074: invokestatic 1186	bhof:a	()Lbhof;
    //   2077: invokevirtual 1188	bhof:e	()V
    //   2080: iload 6
    //   2082: tableswitch	default:+26 -> 2108, 0:+132->2214, 1:+153->2235, 2:+165->2247
    //   2109: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   2112: invokevirtual 248	com/tencent/mobileqq/app/QQAppInterface:a	()Layvc;
    //   2115: invokevirtual 1190	ayvc:i	()V
    //   2118: aload_0
    //   2119: getfield 500	abof:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    ...
    //   2143: aload_0
    //   2144: getfield 500	abof:jdField_a_of_type_ComTencentMobileqqAppMessageHandler	Lcom/tencent/mobileqq/app/MessageHandler;
    //   2147: iconst_0
    //   2148: iconst_0
    ...
    //   2193: ldc_w 1199
    //   2196: lload 14
    //   2198: invokestatic 1201	amgj:a	(Ljava/lang/String;J)V
    //   2201: return
    //   2202: aload_0
    //   2203: getfield 34	abof:jdField_a_of_type_JavaUtilSet	Ljava/util/Set;
    ...
    //   2218: iconst_1
    //   2219: aconst_null
    //   2220: invokevirtual 914	abof:a	(IZLjava/lang/Object;)V
    //   2223: aload_0
    //   2224: sipush 4001
    //   2227: iconst_1
    //   2228: aconst_null
    //   2229: invokevirtual 914	abof:a	(IZLjava/lang/Object;)V
    //   2232: goto -124 -> 2108
    //   2235: aload_0
    //   2236: sipush 4001
    //   2239: iconst_1
    //   2240: aconst_null
    //   2241: invokevirtual 914	abof:a	(IZLjava/lang/Object;)V
    //   2244: goto -136 -> 2108
    //   2247: aload_0
    //   2248: sipush 4016
    //   2251: iconst_1
    //   2252: aconst_null
    //   2253: invokevirtual 914	abof:a	(IZLjava/lang/Object;)V
    //   2256: goto -148 -> 2108
    //   2259: iload 5
    //   2261: istore 9
    //   2263: goto -1163 -> 1100
  ...
  private void a(String paramString, int paramInt, long paramLong, msg_svc.PbMsgReadedReportReq paramPbMsgReadedReportReq)
  {
    ...
    {
      return;
      if (aljq.G.equals(paramString))
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a();
        return;
      }
      if ((paramInt != 1001) || (Long.valueOf(paramString).longValue() <= aljq.l))
      {
        if ((paramInt == 1001) && ((abot.d(paramString)) || (abot.e(paramString))))
        {
          if (abot.f(paramString))
          {
            aped.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, null);
            return;
          }
          if (abot.e(paramString))
          {
            aped.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            return;
          }
        ...
        if (paramInt == 1006)
        {
          localObject = bdbt.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
        ...
        while (l1 != -1L) {
          if (paramInt == 10007)
          {
            asiu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramPbMsgReadedReportReq, paramString, paramLong);
            return;
            ...
            if (paramInt == 1024)
            {
              ...
              if (paramString != null)
              {
                if (QLog.isDevelopLevel()) {
                  QLog.d("Q.msg.sendReadConfirm_PB", 4, "Readcomfirmed------->Sig:" + bdcv.a(paramString) + ",length:" + paramString.length);
                }
  ...
  private void a(msg_comm.Msg paramMsg, FromServiceMsg paramFromServiceMsg, msg_onlinepush.PbPushMsg paramPbPushMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject2 = new ayva(l7, l2, true, false, false, false);
        ((ayva)localObject2).h = true;
      ...
      catch (Exception paramMsg)
      {
        ...
        bool2 = alsh.a((ArrayList)localObject2);
        n = abot.a((List)localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        if (!bool2) {
          break label856;
        }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    bdlr.a(paramArrayOfByte, 10);
    int n = bdlr.a(paramArrayOfByte, 16);
    Object localObject = null;
    if (n > 0) {
      localObject = bdlr.a(paramArrayOfByte, 18, n);
    }
    if (QLog.isColorLevel()) {
      QLog.i("Q.msg.C2CMessageProcessor", 2, "----->handleHotChatAnnouncementMsg dwGroupCode = " + l1 + ", len = " + n + ", announcement = " + (String)localObject);
    }
    paramArrayOfByte = (alpu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(35);
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    catch (OutOfMemoryError paramFromServiceMsg)
    {
      ...
      Object localObject1 = (alsl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(92);
      int n = 0;
      if (((i1 != 0) && (i1 != 1)) || (i1 == 0)) {}
      for (;;)
      {
        try
        {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(str, ((Long)localObject4).longValue(), paramFromServiceMsg.last_msgtime.get(), paramToServiceMsg.extraData.getLong("lEndTime"), (short)0, paramFromServiceMsg.random.get(), 1, ((alsl)localObject1).a(), ((alsl)localObject1).b(), paramToServiceMsg.extraData.getBoolean("fetchMore"), i2, bool2, bool3);
            return;
          }
        }
        ...
        if (!((ArrayList)localObject2).isEmpty())
        {
          ...
          l1 = alsh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((msg_comm.MsgHead)((msg_comm.Msg)localObject6).msg_head.get()).from_uin.get(), ((msg_comm.MsgHead)((msg_comm.Msg)localObject6).msg_head.get()).to_uin.get(), paramFromServiceMsg.peer_uin.get());
        }
        ...
        localObject4 = new ayva(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()), l1, true, true, false, false);
        ((ayva)localObject4).h = true;
        ...
        while (((Iterator)localObject5).hasNext())
        {
          ...
          try
          {
            localObject6 = a((msg_comm.Msg)localObject6, (ayvz)localObject4);
        ...
        {
          Collections.sort((List)localObject3, new aboh(this));
          if (localObject1 == null) {}
        }
        try
        {
          ((alsl)localObject1).a((List)localObject3, str, bool3);
          ...
          ((alsl)localObject1).a().b(str, paramToServiceMsg.extraData.getLong("lBeginTime"), 3);
          if (QLog.isColorLevel()) {
  ...
  private void b(ArrayList<MessageRecord> paramArrayList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        PAMessage localPAMessage = aepx.a(localMessageRecord);
        if ((localPAMessage != null) && (localPAMessage.mMsgId > 0L)) {
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", localMessageRecord.frienduin, "mp_msg_sys_15", "msg_get", 0, 1, 0, Long.toString(localPAMessage.mMsgId), "", "", "");
        }
      }
  ...
  private void b(msg_comm.Msg paramMsg, FromServiceMsg paramFromServiceMsg, msg_onlinepush.PbPushMsg paramPbPushMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject1 = new ayva(l7, l3, true, false, false, false);
        ((ayva)localObject1).h = true;
        localObject1 = a(paramMsg, (ayvz)localObject1);
    ...
    for (;;)
    {
      ...
      ayvy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject2);
      return;
      label1511:
      n = 0;
      localObject2 = null;
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (!paramToServiceMsg.isEmpty())
      {
        ...
        l1 = alsh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((msg_comm.MsgHead)((msg_comm.Msg)localObject).msg_head.get()).from_uin.get(), ((msg_comm.MsgHead)((msg_comm.Msg)localObject).msg_head.get()).to_uin.get(), paramFromServiceMsg.peer_uin.get());
      }
      localayva = new ayva(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()), l1, true, true, false, false);
      localayva.h = true;
      ...
      for (;;)
      {
        ...
        try
        {
          localObject = a((msg_comm.Msg)localObject, localayva);
    ...
    {
      Collections.sort(paramObject, new aboi(this));
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   167: aload_2
    //   168: iconst_0
    //   169: invokespecial 1894	abof:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;Z)V
    //   172: return
    //   173: astore_3
    ...
    //   373: aload 15
    //   375: aload 16
    //   377: invokespecial 175	abof:a	(Ljava/util/List;Ljava/util/List;)V
    //   380: aload_0
    //   381: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   401: iconst_0
    //   402: iconst_0
    //   403: invokespecial 189	ayva:<init>	(JJZZZZ)V
    //   406: astore 17
    //   408: aload 17
    //   410: iconst_1
    //   411: putfield 273	ayva:h	Z
    ...
    //   651: aload 17
    //   653: lload 6
    //   655: putfield 271	ayva:jdField_e_of_type_Long	J
    //   658: aload_0
    //   659: aload_2
    //   660: aload 17
    //   662: invokevirtual 276	abof:a	(Lmsf/msgcomm/msg_comm$Msg;Layvz;)Ljava/util/ArrayList;
    //   665: astore_2
    //   666: aload_2
    //   667: ifnull -237 -> 430
    //   670: aload_2
    ...
    //   703: dup
    //   704: aload_0
    //   705: invokespecial 1926	aboj:<init>	(Labof;)V
    ...
    //   868: aload_0
    //   869: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   960: iconst_0
    //   961: aload 14
    //   963: invokevirtual 914	abof:a	(IZLjava/lang/Object;)V
    //   966: return
    //   967: aload 14
    //   969: ldc_w 1947
    //   972: aload_2
    ...
    //   1015: iconst_1
    //   1016: aload 14
    //   1018: invokevirtual 914	abof:a	(IZLjava/lang/Object;)V
    //   1021: return
    //   1022: iconst_0
    //   1023: istore 12
    //   1025: goto -28 -> 997
    ...
    //   1030: aload_2
    //   1031: iconst_0
    //   1032: invokespecial 1894	abof:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;Z)V
    //   1035: return
    //   1036: lload 6
    //   1038: lload 10
    //   1040: lcmp
  ...
  public ArrayList<MessageRecord> a(msg_comm.Msg paramMsg, ayvz paramayvz)
  {
    if (!(paramayvz instanceof ayva)) {
      return new ArrayList();
    }
    ayva localayva = (ayva)paramayvz;
    ...
    if ((paramMsg == null) || (!paramMsg.msg_head.has()) || (!paramMsg.msg_body.has()))
    {
      if (QLog.isColorLevel())
      {
        paramayvz = new StringBuilder().append("decodeSinglePBMsg_C2C return : ");
        if (paramMsg != null) {
          break label104;
        }
      }
    ...
    {
      paramayvz = (msg_comm.ContentHead)paramMsg.content_head.get();
      i5 = paramayvz.div_seq.get();
      i4 = paramayvz.pkg_num.get();
      i3 = paramayvz.pkg_index.get();
    }
    for (;;)
    {
      long l1 = -1L;
      ...
      Object localObject1;
      Object localObject2;
      if (!localayva.jdField_d_of_type_Boolean)
      {
        paramayvz = ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, String.valueOf(localayva.jdField_e_of_type_Long), String.valueOf(l5));
        if (((Long)paramayvz.first).longValue() != 4294967295L) {
          l1 = ((Long)paramayvz.first).longValue();
        }
      }
      else
      {
        localayva.jdField_b_of_type_Long = l5;
        localayva.jdField_c_of_type_Long = l3;
        int i8 = ayvu.a(paramMsg);
        localayva.jdField_a_of_type_Int = i8;
        localayva.jdField_d_of_type_Long = alxl.a((int)l1, i8);
        localayva.jdField_b_of_type_Int = ayvu.e(paramMsg);
        if (l5 != localayva.jdField_a_of_type_Long) {
          break label1138;
        }
        localayva.jdField_a_of_type_Boolean = true;
        localayva.f = true;
        if (!QLog.isColorLevel()) {
          break label1158;
        }
        localObject1 = new StringBuilder();
        localObject2 = ((StringBuilder)localObject1).append("<---decodeSinglePBMsg_C2C : decode msg: msgTime:").append(l3).append(" shortSeq:").append(i7).append(" uint32Seq:").append(localMsgHead.msg_seq.get()).append(" msgUid:").append(l6).append(" toUin:").append(l2).append(" senderUin:").append(l5).append(" friendUin:").append(localayva.jdField_e_of_type_Long).append(" isReaded:").append(localayva.jdField_a_of_type_Boolean).append(" isSyncFromOtherTerm:").append(localayva.f).append(" msgType:").append(i6).append(" C2CCmd:").append(i2).append(" hasTemp:").append(localMsgHead.c2c_tmp_msg_head.has()).append(" hasShare:").append(paramMsg.appshare_info.has()).append(" pkgID:");
        if (paramayvz != null) {
          break label1147;
        }
        paramayvz = "nullPair";
        label626:
        ((StringBuilder)localObject2).append(paramayvz).append(" longMsgID:").append(i5).append(" longMsgCount:").append(i4).append(" longMsgIndex:").append(i3).append("init_direction_flag").append(0);
        QLog.d("Q.msg.C2CMessageProcessor", 2, ((StringBuilder)localObject1).toString());
        label687:
        paramayvz = new ArrayList();
        if ((i6 != 140) && (i6 != 141) && ((i6 != 529) || (localMsgHead.c2c_cmd.get() != 6))) {
          break label1242;
        }
        i1 = 1;
        localObject1 = ayvu.a(paramMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (((aywa)localObject1).jdField_a_of_type_Int != -1) {
          break label1180;
        }
        n = 0;
        label756:
        ...
        i2 = ((aywa)localObject1).jdField_b_of_type_Int;
        ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramayvz, paramMsg, (aywa)localObject1, localayva);
        n = ((aywa)localObject1).jdField_a_of_type_Int;
        if ((paramayvz.size() <= 0) || (!aoep.a((MessageRecord)paramayvz.get(0)))) {
          break label5372;
        }
        if (!((MessageRecord)paramayvz.get(0)).isSelfConfessor()) {
          break label1235;
        }
        n = 1033;
        label825:
        ((aywa)localObject1).jdField_a_of_type_Int = n;
        n = ((aywa)localObject1).jdField_a_of_type_Int;
      }
      label1138:
      label1147:
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            catch (Throwable localThrowable)
            {
              ...
              l1 = l2;
              continue;
              ((MessageRecord)localObject3).selfuin = String.valueOf(localayva.jdField_a_of_type_Long);
              ((MessageRecord)localObject3).frienduin = String.valueOf(localayva.jdField_e_of_type_Long);
              ((MessageRecord)localObject3).senderuin = String.valueOf(localayva.jdField_b_of_type_Long);
              ((MessageRecord)localObject3).time = localayva.jdField_c_of_type_Long;
              ...
              if ((1 != n) || (!abot.t(((MessageRecord)localObject3).istroop)) || (abot.a(((MessageRecord)localObject3).istroop) == 1032) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(((MessageRecord)localObject3).frienduin)) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(((MessageRecord)localObject3).frienduin, abot.a(((MessageRecord)localObject3).istroop), abot.a(abot.a(((MessageRecord)localObject3).istroop))))) {
                continue;
              }
              abot.a((MessageRecord)localObject3, true);
              ...
              if ((!abot.t(i1)) || (!(localObject3 instanceof MessageForStructing))) {
                continue;
              }
              i2 = amgd.a((MessageRecord)localObject3, 1);
              if (i2 <= 0) {
                continue;
              }
              ((MessageRecord)localObject3).saveExtInfoToExtStr("nearby_gift_msg", "1|" + String.valueOf(i2));
              paramayvz = (MessageForStructing)localObject3;
              if ((paramayvz.structingMsg.mMsgServiceID != 52) || ((alsy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(124) == null)) {
                continue;
              }
              paramayvz = new NearbyFlowerMessage(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramayvz);
              if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c().equals(paramayvz.sUin)) {
                continue;
              }
              azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80060AF", "0X80060AF", 0, 0, "", "", "", "");
              if (!"4".equals(paramayvz.version)) {
                continue;
              }
              if (!QLog.isColorLevel()) {
                continue;
              ...
              ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, l5, i7, l6, i6);
              continue;
              abot.a((MessageRecord)localObject3, false);
              continue;
              if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c().equals(paramayvz.rUin)) {
                continue;
              }
              azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80060B0", "0X80060B0", 0, 0, "", "", "", "");
              continue;
              paramayvz = (msg_comm.C2CTmpMsgHead)localMsgHead.c2c_tmp_msg_head.get();
              if ((paramayvz == null) || (!paramayvz.lock_display.has()) || (paramayvz.lock_display.get() != 1)) {
                continue;
              }
              ...
              ((aloz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(String.valueOf(localayva.jdField_e_of_type_Long), localMsgHead.from_nick.get());
              ((MessageRecord)localObject3).frienduin = bdbt.f(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(localayva.jdField_e_of_type_Long));
              ((MessageRecord)localObject3).senderuin = bdbt.f(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l5));
              if ((!TextUtils.isEmpty(((MessageRecord)localObject3).frienduin)) || (!localayva.jdField_d_of_type_Boolean)) {
                continue;
              }
              ((MessageRecord)localObject3).frienduin = String.valueOf(localayva.jdField_e_of_type_Long);
              ...
              QLog.e("Q.msg.C2CMessageProcessor", 1, String.format("decodeMessage error, getPhoneNumByUin is null, friendUin: %d senderUin: %d uinType: %d msgType: %d", new Object[] { Long.valueOf(localayva.jdField_e_of_type_Long), Long.valueOf(l5), Integer.valueOf(((MessageRecord)localObject3).istroop), Integer.valueOf(((MessageRecord)localObject3).msgtype) }));
              continue;
              if (!localayva.f) {
                continue;
              }
              ...
              ((MessageRecord)localObject3).vipBubbleID = localayva.jdField_d_of_type_Long;
              ((MessageRecord)localObject3).vipBubbleDiyTextId = localayva.jdField_a_of_type_Int;
              ((MessageRecord)localObject3).vipSubBubbleId = localayva.jdField_b_of_type_Int;
              if (localayva.jdField_b_of_type_Int <= 0) {
                continue;
              }
              ((MessageRecord)localObject3).saveExtInfoToExtStr("bubble_sub_id", String.valueOf(localayva.jdField_b_of_type_Int));
              i2 = ayvu.c(paramMsg);
              if (i2 <= 0) {
                continue;
              }
              ...
              try
              {
                ...
                {
                  paramayvz = (MessageForStructing)localObject3;
                  if ((paramayvz.structingMsg != null) && (paramayvz.structingMsg.mMsgServiceID == 76)) {
                    ((nga)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(171)).a(paramayvz);
                  }
                }
                if (((MessageRecord)localObject3).msgtype == -7005)
                {
                  athk.a((MessageRecord)localObject3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
                  continue;
                  if (((MessageRecord)localObject3).msgtype == -2037) {
                    continue;
                  }
                  ((MessageRecord)localObject3).isread = localayva.jdField_a_of_type_Boolean;
                }
              }
              catch (Throwable paramayvz)
              {
                QLog.e("Q.msg.C2CMessageProcessor", 2, "<---decodeMessage: ", paramayvz);
                continue;
              ...
              paramayvz = new StringBuilder("decode apollo c2c msg: ").append(", id: ").append(((MessageForApollo)localObject4).mApolloMessage.id).append(", name: ").append(new String(((MessageForApollo)localObject4).mApolloMessage.name)).append(", doubleAction: ").append(((MessageForApollo)localObject4).isDoubleAction()).append(", signTS: ").append(((MessageForApollo)localObject4).signTs);
              ...
              ApolloBaseInfo localApolloBaseInfo = localakji.b(((MessageForApollo)localObject4).mApolloMessage.peer_uin + "");
              ...
              localakji.a(localApolloBaseInfo);
              if (!QLog.isColorLevel()) {
                continue;
              }
              ...
              QLog.d("Q.msg.C2CMessageProcessor", 2, paramayvz.toString());
              if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) {
                continue;
              }
              i2 = localakji.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
              if (((MessageForApollo)localObject4).msgType != 0) {
                continue;
              }
              paramayvz = String.valueOf(((MessageForApollo)localObject4).mApolloMessage.id);
              VipUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "cmshow", "Apollo", "rev_action", String.valueOf(((MessageForApollo)localObject4).mApolloMessage.peer_uin), 0, ((MessageForApollo)localObject4).msgType, new String[] { paramayvz, Integer.toString(i2), Integer.toString(akji.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)), String.valueOf(System.currentTimeMillis() / 1000L) });
              continue;
              i2 = 0;
              continue;
              localApolloBaseInfo = localakji.b(((MessageForApollo)localObject4).senderuin);
              ...
              paramayvz = "" + ((MessageForApollo)localObject4).gameId;
              continue;
              ...
              paramayvz = (im_msg_body.Elem)paramMsg.next();
              if (!paramayvz.pub_acc_info.has()) {
                continue;
              }
              n = paramayvz.pub_acc_info.uint32_is_inter_num.get();
              paramMsg = paramayvz.pub_acc_info.string_msg_template_id.get();
              if (n == 0) {
                continue;
              }
              paramayvz = localArrayList.iterator();
              if (!paramayvz.hasNext()) {
                continue;
              }
              ((MessageRecord)paramayvz.next()).saveExtInfoToExtStr("inter_num", String.valueOf(n));
              continue;
              paramayvz = localArrayList.iterator();
              if (!paramayvz.hasNext()) {
                continue;
              }
              ((MessageRecord)paramayvz.next()).saveExtInfoToExtStr("msg_template_id", paramMsg);
              continue;
              bhof.a().f(System.currentTimeMillis() - l4);
              i1 = 0;
              ...
              paramayvz = (MessageRecord)paramMsg.next();
              i1 = paramayvz.istroop;
              if (paramayvz.isread) {
                continue;
              }
              n += 1;
          ...
          l1 = ((Long)paramayvz.second).longValue();
          break;
          localayva.f = false;
          break label424;
          paramayvz = (Serializable)paramayvz.first;
          break label626;
          if (localayva.jdField_e_of_type_Long != 0L) {
            break label687;
          }
          QLog.e("Q.msg.C2CMessageProcessor", 1, "<---decodeSinglePBMsg_C2C : decode msg: frienduin=0");
          break label687;
          if ((((aywa)localObject1).jdField_a_of_type_Int != 1000) && (((aywa)localObject1).jdField_a_of_type_Int != 1020))
          {
            n = i1;
            if (((aywa)localObject1).jdField_a_of_type_Int != 1004) {
              break label756;
            }
          }
          localayva.jdField_b_of_type_Long = ((aywa)localObject1).jdField_b_of_type_Long;
          n = i1;
          break label756;
          return localArrayList;
          n = 1034;
          ...
          {
            ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramayvz, paramMsg, 0L, 0L, localayva.jdField_d_of_type_Boolean);
            n = 0;
          }
          else
          {
            if ((ayvy.c(i6)) && (localMsgHead.c2c_cmd.has())) {}
            switch (i2)
            {
            default: 
              n = 0;
            ...
            case 243: 
              ...
              l1 = localayva.jdField_e_of_type_Long;
              bool1 = localayva.jdField_a_of_type_Boolean;
              bool2 = localayva.jdField_b_of_type_Boolean;
              if (l5 == localayva.jdField_a_of_type_Long) {}
              for (i9 = 1;; i9 = 0)
              {
                ayvu.a((MessageHandler)localObject1, paramayvz, i2, paramMsg, l1, bool1, bool2, i9, localayva.jdField_d_of_type_Long, localayva.jdField_d_of_type_Boolean, localayva.jdField_a_of_type_Int);
                n = 0;
                break;
              }
            case 11: 
            case 175: 
              ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramayvz, paramMsg, localayva.jdField_e_of_type_Long, localayva.jdField_b_of_type_Boolean, localayva.jdField_a_of_type_Boolean, localayva.jdField_d_of_type_Boolean);
              n = 0;
              break;
            case 193: 
              n = 0;
            ...
            case 131: 
            case 133: 
              ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, localayva.jdField_e_of_type_Long, localayva.jdField_a_of_type_Boolean, localayva.jdField_b_of_type_Boolean, localayva.jdField_d_of_type_Long, localayva.jdField_a_of_type_Int);
              n = 0;
              continue;
              if (i6 == 208)
              {
                ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramayvz, paramMsg);
                n = 0;
              }
              else
              {
                if (i6 == 193)
                {
                  if (!localayva.jdField_d_of_type_Boolean)
                  {
                    ayvu.c(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, localayva);
                    n = 0;
                  }
                }
                else
                {
                  if (i6 == 734)
                  {
                    ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, localayva);
                    n = 0;
                    continue;
                  }
                  if (i6 == 562)
                  {
                    ayvu.b(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, localayva);
                    n = 0;
                    continue;
                  }
                  if (i6 == 519)
                  {
                    if ((!localayva.jdField_d_of_type_Boolean) && (VideoConstants.jdField_a_of_type_Boolean))
                    {
                      ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, localayva.jdField_a_of_type_Boolean, localayva.f);
                      n = 0;
                    }
                  }
                  else
                  {
                    if (SystemMsg.isSystemMessage(i6))
                    {
                      ...
                      if ((!localayva.jdField_c_of_type_Boolean) && (n == 0)) {
                        this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a().a(2);
                      }
                      localayva.jdField_e_of_type_Long = 9998L;
                      ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, localayva.jdField_a_of_type_Boolean, localayva.f, localayva.jdField_d_of_type_Boolean, i7);
                      ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, l5, i7, l6, i6);
                      return localArrayList;
                    }
                    if (a(i6))
                    {
                      a(paramayvz, paramMsg, localayva.jdField_d_of_type_Boolean);
                      n = 0;
                      continue;
                    }
                    if (732 == i6)
                    {
                      a(paramayvz, paramMsg, i7, l5, l6, i6, localayva.jdField_d_of_type_Boolean);
                      n = 0;
                      continue;
                    }
                    if (524 == i6)
                    {
                      if ((paramayvz == null) || (paramMsg == null) || (!paramMsg.msg_body.has()) || (!paramMsg.msg_body.msg_content.has())) {
                        return localArrayList;
                      }
                      localObject1 = paramMsg.msg_body.msg_content.get().toByteArray();
                      bdlr.a((byte[])localObject1, 0);
                      n = localObject1[4];
                      if (n == 25) {
                        if (!localayva.jdField_d_of_type_Boolean) {
                          amgb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (byte[])localObject1, 5, null, false);
                        }
                      }
                      for (;;)
                      {
                        ...
                        if (n == 35)
                        {
                          ...
                          if (!localayva.jdField_d_of_type_Boolean) {
                            amgb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (byte[])localObject1, 5, null, false);
                          }
                        }
                      }
                    }
                    if (SystemMsg.isTroopSystemMessage(i6))
                    {
                      ...
                      localayva.jdField_e_of_type_Long = 9998L;
                      ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, localayva.jdField_a_of_type_Boolean, localayva.f, localayva.jdField_d_of_type_Boolean);
                      if (n == 0) {
                        baba.a().a(l5, l3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
                      }
                      return localArrayList;
                    }
                    if (i6 == 528)
                    {
                      if (!localayva.jdField_d_of_type_Boolean)
                      {
                        ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, localayva.jdField_a_of_type_Long, paramMsg, localayva.h, localayva.jdField_d_of_type_Boolean);
                        n = 0;
                      }
                    }
                    else
                    {
                      if (i6 == 529)
                      {
                        ...
                        for (i9 = 1;; i9 = 0)
                        {
                          ayvu.a((MessageHandler)localObject1, paramayvz, paramMsg, l1, bool1, bool2, i9, localayva.jdField_d_of_type_Long, localayva.jdField_d_of_type_Boolean, localayva.jdField_a_of_type_Int);
                          n = 0;
                          break;
                          if ((((aywa)localObject1).jdField_a_of_type_Int != 1000) && (((aywa)localObject1).jdField_a_of_type_Int != 1020))
                          {
                          ...
                          {
                            i1 = n;
                            if (((aloz)localObject1).b(String.valueOf(((msg_comm.MsgHead)paramMsg.msg_head.get()).from_uin.get()))) {
                              break label2351;
                            }
                            i1 = 1025;
                            break label2351;
                          ...
                          i1 = n;
                          if (((aloz)localObject1).b(String.valueOf(((msg_comm.MsgHead)paramMsg.msg_head.get()).to_uin.get()))) {
                            break label2351;
                          }
                          i1 = 1025;
                          break label2351;
                      ...
                      if (i6 == 38)
                      {
                        localObject1 = String.valueOf(bcwj.a(paramMsg.msg_body.msg_content.get().toByteArray()));
                        ...
                        if (localObject2 != null) {
                          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getHandler(getClass()).postDelayed(new C2CMessageProcessor.2(this, (alzf)localObject2, (String)localObject1), 2000L);
                        }
                        ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, l5, i7, l6, i6);
                      }
                    }
        ...
        l1 = l3;
        localObject2 = paramayvz.iterator();
        for (;;)
        {
          ...
          if ((localObject3 != null) && ((localayva.jdField_b_of_type_Long != 3338705755L) || (!syb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) && ((localayva.jdField_b_of_type_Long != 2171946401L) || (!ors.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))))
          {
            if (localayva.jdField_b_of_type_Long == 2171946401L) {
            ...
            if (((i1 != 1025) && (i1 != 1024)) || (((MessageRecord)localObject3).msgtype != -1000) || (!((MessageRecord)localObject3).msg.startsWith("default:SigT=")))
            {
              ...
              localObject1 = null;
              paramayvz = (ayvz)localObject1;
              if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
              {
                localObject4 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
                paramayvz = (ayvz)localObject1;
                if (localObject4 != null) {
                  paramayvz = ((ayvc)localObject4).a(String.valueOf(localayva.jdField_e_of_type_Long), String.valueOf(localayva.jdField_a_of_type_Long));
                }
              }
              ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, l5, i7, l6, i6, paramayvz);
              if (i1 != 1032) {
                break;
              }
              if (QLog.isColorLevel()) {
  ...
  public void a(C2CMsgReadedNotify paramC2CMsgReadedNotify)
  {
    ...
    if (paramC2CMsgReadedNotify.uAioType == 3L) {
      asiu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, paramC2CMsgReadedNotify);
    }
    do
    {
      return;
        ...
        do
        {
          ...
          do
          {
            do
            {
              ...
              bdlr.a((byte[])localObject, 0, arrayOfByte1, 0, localObject.length);
            } while (localObject.length < 5);
            n = localObject[4];
            if (QLog.isColorLevel()) {
              QLog.d("Q.msg.C2CMessageProcessor", 2, "<---hotchat and opentroop push  groupCode:" + bdlr.a(arrayOfByte1, 0) + " subType:" + n);
            }
            if ((n != 12) && (n != 14)) {
              break;
            }
          } while (!((bcjl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a((byte[])localObject, paramInt1));
          ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), paramLong1, paramInt1, paramLong2, paramInt2);
          return;
          if ((n != 16) && (n != 17) && (n != 20)) {
            break;
          }
          localObject = new abok(this);
          if (arrayOfByte1.length > 7)
          {
            bclk localbclk = (bclk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(81);
            byte[] arrayOfByte2 = new byte[arrayOfByte1.length - 7];
            bdlr.a(arrayOfByte2, 0, arrayOfByte1, 7, arrayOfByte2.length);
            paramArrayList.add(localbclk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, arrayOfByte2, paramInt1, paramMsg.msg_head.msg_time.get(), true, paramBoolean, (abok)localObject));
          }
        } while (!((abok)localObject).jdField_a_of_type_Boolean);
        ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), paramLong1, paramInt1, paramLong2, paramInt2);
  ...
  public void a(ArrayList<MessageRecord> paramArrayList, boolean paramBoolean)
  {
    ...
    //   15: aload_0
    //   16: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   34: aload_0
    //   35: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   38: invokestatic 2670	bcys:a	(Landroid/content/Context;Lcom/tencent/common/app/AppInterface;)Z
    //   41: ifeq -30 -> 11
    //   44: aload_1
    ...
    //   77: invokestatic 2280	abot:t	(I)Z
    //   80: ifeq -30 -> 50
    //   83: aload 8
    //   85: invokestatic 2671	abot:d	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   88: ifeq -38 -> 50
    //   91: aload_0
    //   92: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   95: aload 8
    //   97: invokestatic 2674	abot:c	(Lcom/tencent/mobileqq/app/QQAppInterface;Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   100: ifne -50 -> 50
    //   103: aload 8
    ...
    //   122: ifeq -111 -> 11
    //   125: aload_0
    //   126: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   129: bipush 51
    //   131: invokevirtual 360	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   134: checkcast 1026	aloz
    //   137: aload_0
    //   138: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   141: invokevirtual 147	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   144: invokevirtual 2677	aloz:b	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Card;
    //   147: astore 7
    //   149: aload_0
    //   150: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   179: istore 4
    //   181: aload_0
    //   182: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   185: bipush 106
    //   187: invokevirtual 360	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   190: checkcast 2681	auqc
    //   193: invokevirtual 2682	auqc:a	()Z
    //   196: istore 6
    ...
    //   243: aload_0
    //   244: getfield 2689	abof:jdField_a_of_type_Boolean	Z
    //   247: ifne +293 -> 540
    ...
    //   535: aload_0
    //   536: iconst_1
    //   537: putfield 2689	abof:jdField_a_of_type_Boolean	Z
    ...
    //   550: aload_0
    //   551: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   587: astore 7
    //   589: aload_0
    //   590: getfield 54	abof:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    ...
    //   600: astore 7
    //   602: aload_0
    //   603: getfield 54	abof:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   606: ifnonnull +130 -> 736
    //   609: aload_0
    //   610: new 29	java/util/HashSet
    //   613: dup
    //   614: invokespecial 32	java/util/HashSet:<init>	()V
    //   617: putfield 54	abof:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   620: aload 11
    //   622: new 93	java/lang/StringBuilder
    //   625: dup
    //   626: invokespecial 94	java/lang/StringBuilder:<init>	()V
    //   629: aload_0
    //   630: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   706: ifle +13 -> 719
    //   709: aload_0
    //   710: getfield 54	abof:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   713: aload 7
    ...
    //   740: astore 8
    //   742: aload_0
    //   743: getfield 56	abof:jdField_b_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    ...
    //   753: astore 8
    //   755: aload_0
    //   756: getfield 56	abof:jdField_b_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   759: ifnonnull +125 -> 884
    //   762: aload_0
    //   763: new 29	java/util/HashSet
    //   766: dup
    //   767: invokespecial 32	java/util/HashSet:<init>	()V
    //   770: putfield 56	abof:jdField_b_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   773: aload 11
    //   775: new 93	java/lang/StringBuilder
    //   778: dup
    //   779: invokespecial 94	java/lang/StringBuilder:<init>	()V
    //   782: aload_0
    //   783: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   859: ifle +13 -> 872
    //   862: aload_0
    //   863: getfield 56	abof:jdField_b_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   866: aload 8
    ...
    //   920: aload_0
    //   921: aload 13
    //   923: invokevirtual 2741	abof:a	(Lcom/tencent/mobileqq/data/MessageRecord;)Z
    //   926: ifeq +641 -> 1567
    //   929: aload_1
    //   930: astore 9
    //   932: aload 10
    ...
    //   950: astore 8
    //   952: aload_0
    //   953: getfield 54	abof:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   956: aload 13
    ...
    //   964: ifne +89 -> 1053
    //   967: aload_0
    //   968: getfield 54	abof:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   971: aload 13
    ...
    //   1009: aload_0
    //   1010: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1060: ifeq +196 -> 1256
    //   1063: aload_0
    //   1064: getfield 42	abof:f	I
    //   1067: istore_3
    //   1068: aload_0
    //   1069: aload_0
    //   1070: getfield 54	abof:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   1073: invokevirtual 2755	java/util/HashSet:size	()I
    //   1076: putfield 2757	abof:h	I
    //   1079: aload_0
    //   1080: getfield 2757	abof:h	I
    //   1083: iload_3
    //   1084: irem
    //   1085: ifne +113 -> 1198
    //   1088: aload_0
    //   1089: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1092: aload 13
    //   1094: iload_2
    //   1095: invokevirtual 2758	com/tencent/mobileqq/app/QQAppInterface:a	(Lcom/tencent/mobileqq/data/MessageRecord;Z)V
    //   1098: aload_0
    //   1099: getfield 54	abof:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    ...
    //   1119: aload_0
    //   1120: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1159: ifeq +39 -> 1198
    //   1162: aload_0
    //   1163: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1166: ldc_w 449
    //   1169: ldc_w 421
    //   1172: ldc_w 421
    //   1175: ldc_w 2764
    ...
    //   1189: ldc_w 421
    //   1192: ldc_w 421
    //   1195: invokestatic 456	azmj:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   1198: aload_1
    //   1199: astore 7
    //   1201: aload 8
    //   1203: astore_1
    ...
    //   1253: goto -258 -> 995
    //   1256: aload_0
    //   1257: getfield 38	abof:d	I
    //   1260: istore_3
    //   1261: goto -193 -> 1068
    //   1264: iload 6
    //   1266: ifeq +11 -> 1277
    //   1269: aload_0
    //   1270: getfield 44	abof:g	I
    //   1273: istore_3
    //   1274: goto -206 -> 1068
    //   1277: aload_0
    //   1278: getfield 40	abof:e	I
    //   1281: istore_3
    //   1282: goto -214 -> 1068
    //   1285: aload 13
    ...
    //   1311: astore 8
    //   1313: aload_0
    //   1314: getfield 56	abof:jdField_b_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   1317: aload 13
    ...
    //   1325: ifne +85 -> 1410
    //   1328: aload_0
    //   1329: getfield 56	abof:jdField_b_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   1332: aload 13
    ...
    //   1368: aload_0
    //   1369: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1417: ifeq +192 -> 1609
    //   1420: aload_0
    //   1421: getfield 50	abof:k	I
    //   1424: istore_3
    //   1425: aload_0
    //   1426: aload_0
    //   1427: getfield 56	abof:jdField_b_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   1430: invokevirtual 2755	java/util/HashSet:size	()I
    //   1433: putfield 2766	abof:m	I
    //   1436: aload 8
    //   1438: astore 9
    //   1440: aload_0
    //   1441: getfield 2766	abof:m	I
    //   1444: iload_3
    //   1445: irem
    //   1446: ifne +121 -> 1567
    //   1449: aload_0
    //   1450: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1453: aload 13
    //   1455: iload_2
    //   1456: invokevirtual 2758	com/tencent/mobileqq/app/QQAppInterface:a	(Lcom/tencent/mobileqq/data/MessageRecord;Z)V
    //   1459: aload_0
    //   1460: getfield 56	abof:jdField_b_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    ...
    //   1480: aload_0
    //   1481: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1524: ifeq +43 -> 1567
    //   1527: aload_0
    //   1528: getfield 119	abof:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1531: ldc_w 449
    //   1534: ldc_w 421
    //   1537: ldc_w 421
    //   1540: ldc_w 2764
    ...
    //   1554: ldc_w 421
    //   1557: ldc_w 421
    //   1560: invokestatic 456	azmj:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   1563: aload 8
    //   1565: astore 9
    //   1567: aload 7
    //   1569: astore_1
    ...
    //   1606: goto -252 -> 1354
    //   1609: aload_0
    //   1610: getfield 46	abof:i	I
    //   1613: istore_3
    //   1614: goto -189 -> 1425
    //   1617: iload 6
    //   1619: ifeq +11 -> 1630
    //   1622: aload_0
    //   1623: getfield 52	abof:l	I
    //   1626: istore_3
    //   1627: goto -202 -> 1425
    //   1630: aload_0
    //   1631: getfield 48	abof:j	I
    //   1634: istore_3
    //   1635: goto -210 -> 1425
    //   1638: iconst_1
    //   1639: istore 4
  ...
  public void a(List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean)
  {
    ...
    long l1 = bdal.a(paramMsg, 0);
    int n = paramMsg[4];
    String str = String.valueOf(bdal.a(paramMsg, 5));
    n = paramMsg[9];
    long l2 = bdal.a(paramMsg, 10);
    int i1 = paramMsg[14];
    try
    {
      ...
      if (!paramBoolean)
      {
        ...
        ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(l1 + "", str, paramList.auth_nick.get());
        paramMsg = new ArrayList();
        paramMsg.add(new Pair(Long.valueOf(paramList.from_uin.get()), Long.valueOf(paramList.msg_time.get())));
        ((abof)this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a("c2c_processor")).a(paramMsg);
      }
      return;
    }
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
    ...
    while (((paramMessageRecord.senderuin != null) && (paramMessageRecord.senderuin.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) || (((paramMessageRecord.istroop == 1001) || (paramMessageRecord.istroop == 10002)) && ((paramMessageRecord.msgtype == -3001) || (!abot.d(paramMessageRecord)) || (abot.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord))))) {
      return false;
    }
    return true;
  }
  ...
  public boolean a(ArrayList<MessageRecord> paramArrayList)
  {
    ...
    } while ((localMessageRecord.isSend()) || (localMessageRecord.isread) || ((abot.d(localMessageRecord)) && (!abot.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord))) || (FriendsStatusUtil.a(localMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) || (!ajbg.a(localMessageRecord.frienduin)) || (!asiu.a(localMessageRecord)));
