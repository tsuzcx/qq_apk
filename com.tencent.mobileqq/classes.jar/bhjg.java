...
{
  public static final DownloadParams.DecodeHandler a = new bhjh();
  public static final DownloadParams.DecodeHandler b = new bhji(bhez.t, a);
  ...
  public static Bitmap a(@NonNull Bitmap paramBitmap1, @NonNull Bitmap paramBitmap2, int paramInt1, int paramInt2)
  {
    ...
    paramBitmap2.setDensity((int)bhtq.c());
