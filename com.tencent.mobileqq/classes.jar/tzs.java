  ...
  implements View.OnClickListener
{
  ...
  public tzs(View paramView, tzq paramtzq)
  {
    this.jdField_a_of_type_AndroidContentContext = paramtzq.jdField_a_of_type_AndroidContentContext;
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131311450));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131298792));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131298797));
    this.c = ((TextView)paramView.findViewById(2131298802));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131304216));
    this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardViewShareGroupInnerListView = ((ShareGroupInnerListView)paramView.findViewById(2131302563));
    this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardViewShareGroupInnerListView.setSelection(0);
    azve.a(this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardViewShareGroupInnerListView, false);
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardViewShareGroupInnerListView.setLoadMoreDataListener(this.jdField_a_of_type_Tzq.jdField_a_of_type_Uaa);
    paramtzq = (uhm)this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardViewShareGroupInnerListView.a();
    paramtzq.a(this.jdField_a_of_type_Tzq.jdField_a_of_type_ComTencentBizQqstoryShareGroupModelShareGroupItem.shareGroupId);
    paramtzq.a(this.jdField_a_of_type_Tzq.jdField_a_of_type_Uaa);
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131303538);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131303539);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131306129));
    this.d = ((TextView)paramView.findViewById(2131296590));
    a();
  }
  ...
  protected void a()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130845524);
  ...
  public void a(VideoCollectionItem paramVideoCollectionItem, View paramView, int paramInt)
  {
    ...
    this.jdField_a_of_type_Tzq.jdField_a_of_type_JavaUtilHashMap.put(paramVideoCollectionItem.collectionId, new WeakReference(this));
    paramView = vlf.a(paramVideoCollectionItem.collectionTime);
    ...
    if (!TextUtils.isEmpty(paramView[0]))
    {
      ...
      ((LinearLayout.LayoutParams)localObject).setMargins(0, vms.a(this.jdField_a_of_type_AndroidContentContext, -8.0F), 0, 0);
      ...
      ((RelativeLayout.LayoutParams)localObject).leftMargin = vms.a(this.jdField_a_of_type_AndroidContentContext, 80.0F);
      this.c.setLayoutParams((ViewGroup.LayoutParams)localObject);
      if ((paramVideoCollectionItem.collectionCount > 0) || (paramInt != 2)) {
        break label655;
      }
      this.c.setText(ajjy.a(2131648133));
      label382:
      localObject = this.jdField_a_of_type_Tzq.jdField_a_of_type_ComTencentBizQqstoryShareGroupModelShareGroupItem;
      ...
      paramVideoCollectionItem.height = vms.a(this.jdField_a_of_type_AndroidContentContext, 150.0F);
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setLayoutParams((ViewGroup.LayoutParams)localObject);
      localObject = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
      if ((paramInt == 3) && (TextUtils.equals(paramView[1], ajjy.a(2131648126)))) {
        ((RelativeLayout.LayoutParams)localObject).setMargins(0, vms.a(this.jdField_a_of_type_AndroidContentContext, 10.0F), 0, vms.a(this.jdField_a_of_type_AndroidContentContext, 7.0F));
      }
      for (;;)
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setLayoutParams((ViewGroup.LayoutParams)localObject);
        break;
        ((RelativeLayout.LayoutParams)localObject).setMargins(0, 0, 0, vms.a(this.jdField_a_of_type_AndroidContentContext, 7.0F));
      }
      label655:
      this.c.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131633736, new Object[] { Integer.valueOf(paramVideoCollectionItem.collectionCount) }));
      break label382;
      label689:
      ...
      break label457;
      label740:
      if (TextUtils.equals(paramView[1], ajjy.a(2131648130))) {
        paramVideoCollectionItem.height = vms.a(this.jdField_a_of_type_AndroidContentContext, 172.0F);
      } else {
        paramVideoCollectionItem.height = vms.a(this.jdField_a_of_type_AndroidContentContext, 176.0F);
      }
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    {
      urk.b("Q.qqstory.shareGroup.ShareGroupsListAdapter", "no data to share");
      return;
    }
    vlf.b(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryModelVideoCollectionItem.collectionTime);
    ...
    do
    {
      ...
      paramView = (uhj)localIterator.next();
    } while ((paramView == null) || (uho.a(paramView)) || (0 != 0));
    for (;;)
    {
      if (paramView != null)
      {
        this.jdField_a_of_type_Tzq.jdField_a_of_type_Uaa.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryModelVideoCollectionItem.collectionId, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryModelVideoCollectionItem.collectionTime, paramView.a, i, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryModelVideoCollectionItem.feedId, null);
        return;
      }
      urk.b("Q.qqstory.shareGroup.ShareGroupsListAdapter", "cannot found first data to share to qq");
      return;
      paramView = null;
    }
  }
