...
public class auku
{
  ...
  /* Error */
  public static aukw a(String paramString)
  {
    // Byte code:
    //   0: lconst_0
    //   1: lstore_1
    ...
    //   25: aconst_null
    //   26: lconst_0
    //   27: invokespecial 215	aukw:<init>	(Ljava/lang/String;J)V
    //   30: areturn
    ...
    //   332: astore 14
    //   334: aload 11
    //   336: invokestatic 257	auku:a	(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    //   339: astore 15
    //   341: aload 15
    //   343: astore 10
    //   345: lload_1
    ...
    //   585: aload 10
    //   587: lload_1
    //   588: invokespecial 215	aukw:<init>	(Ljava/lang/String;J)V
    //   591: areturn
    //   592: astore 13
    //   594: lconst_0
    //   595: lstore_3
  ...
  public static void a(String paramString, aukx paramaukx)
  {
    auel.a().execute(new UniformDownloadUtil.2(paramString, paramaukx));
  }
  
  public static void a(String paramString, auky paramauky)
  {
    ThreadManager.getSubThreadHandler().post(new UniformDownloadUtil.1(paramString, paramauky));
  }
  
  public static void a(String paramString1, String paramString2)
  {
    a(paramString1, new aukv(paramString1, paramString2));
  }
  
  public static boolean a(String paramString)
  {
    return (paramString != null) && (FileUtil.getExtension(paramString).equalsIgnoreCase(".apk"));
  }
  
  public static void b(String paramString1, String paramString2)
  {
    QLog.i("UniformDownloadUtil", 1, "[UniformDL] >>>openFileWithOtherApp. localPath:" + paramString1);
    if ((paramString1 == null) || (!FileUtil.isFileExists(paramString1)))
    {
      QLog.e("UniformDownloadUtil", 1, "[UniformDL] openFileWithOtherApp. file is not existed. localPath:" + paramString1);
      return;
    }
    BaseApplication localBaseApplication = BaseApplication.getContext();
    String str = MimeTypesTools.getMimeType(localBaseApplication, paramString1);
