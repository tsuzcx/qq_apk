...
{
  attm(FileManagerEntity paramFileManagerEntity, Activity paramActivity, boolean paramBoolean) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      if ((bool1) && (!FileUtils.fileExistsAndNotEmpty(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath()))) {
        QQToast.a(BaseApplicationImpl.getApplication(), 1, BaseApplicationImpl.getApplication().getString(2131719254), 0).b(BaseApplicationImpl.getApplication().getResources().getDimensionPixelSize(2131299080));
      }
      for (;;)
      {
        EventCollector.getInstance().onViewClicked(paramView);
        return;
        bdla.b(localQQAppInterface, "dc00898", "", "", "0X8009063", "0X8009063", 0, 0, "", "", "", "");
        break;
        label241:
        ...
        beaz.a(localTeamWorkFileImportInfo, this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface, localTeamWorkFileImportInfo.jdField_d_of_type_Int);
        continue;
