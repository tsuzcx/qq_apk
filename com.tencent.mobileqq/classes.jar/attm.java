  ...
  implements atsz
{
  ...
  public String a()
  {
    ...
    if (this.jdField_a_of_type_Attn.jdField_a_of_type_ArrayOfJavaLangString == null)
    {
      this.jdField_a_of_type_Boolean = true;
      return this.jdField_a_of_type_Attn.jdField_a_of_type_JavaLangString;
    }
    int i = this.jdField_a_of_type_Int + 1;
    if (i >= this.jdField_a_of_type_Attn.jdField_a_of_type_ArrayOfJavaLangString.length)
    {
      attn localattn = this.jdField_a_of_type_Attn;
      localattn.jdField_a_of_type_Int -= 1;
      if (this.jdField_a_of_type_Attn.jdField_a_of_type_Int <= 0)
      {
        this.jdField_a_of_type_Boolean = true;
        return this.jdField_a_of_type_Attn.jdField_a_of_type_JavaLangString;
      }
      ...
      return this.jdField_a_of_type_Attn.jdField_a_of_type_ArrayOfJavaLangString[(i + 1)];
    }
    return this.jdField_a_of_type_Attn.jdField_a_of_type_ArrayOfJavaLangString[i];
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Attn == null) {
  ...
  public void a(Message paramMessage)
  {
    ...
    if (this.jdField_a_of_type_Attn.jdField_a_of_type_Atta != null) {
      this.jdField_a_of_type_Attn.jdField_a_of_type_Atta.a((Bitmap)paramMessage.obj);
    }
    this.jdField_a_of_type_Int += 1;
    ThreadManager.post(this.jdField_a_of_type_JavaLangRunnable, 5, null, true);
  }
  
  public void a(attn paramattn)
  {
    this.jdField_a_of_type_Attn = paramattn;
  }
  
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Attn != null) {
      this.jdField_a_of_type_Attn.jdField_a_of_type_JavaLangString = paramString;
    }
  }
