  ...
  extends zdf
{
  ...
  public ayux(AppInterface paramAppInterface)
  {
      ...
      if (i1 == 3)
      {
        ...
        try
        {
          ...
          for (;;)
          {
            ...
            ((SummaryCardBusiEntry.comm)localObject3).qqver.set("8.3.3.4515");
            ...
            localObject5[0] = 40;
            bdlr.a((byte[])localObject5, 1, k);
            bdlr.a((byte[])localObject5, 5, i4);
            bdlr.a((byte[])localObject5, 9, (byte[])localObject3, k);
            int m = localObject3.length + 9;
            k = m;
            if (localObject4 != null)
            {
              bdlr.a((byte[])localObject5, m, (byte[])localObject4, i4);
              k = m + i4;
            }
            localObject5[k] = 41;
  ...
  private boolean D(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    {
      localByteBuffer.putInt(allj.a(localObject3[0]));
      localByteBuffer.putInt(allj.a(localObject3[1]));
      localByteBuffer.putInt(allj.a(localObject3[2]));
      localByteBuffer.putInt(allj.a(localObject3[3]));
      localObject3 = ByteBuffer.allocate(16);
      if ((localObject2 == null) || (localObject2.length != 4)) {
        break label482;
      }
      ((ByteBuffer)localObject3).putInt(allj.a(localObject2[0]));
      ((ByteBuffer)localObject3).putInt(allj.a(localObject2[1]));
      ((ByteBuffer)localObject3).putInt(allj.a(localObject2[2]));
      ((ByteBuffer)localObject3).putInt(allj.a(localObject2[3]));
    }
    for (;;)
    {
      short s2 = (short)k;
  ...
  public static ReqSummaryCard a(ToServiceMsg paramToServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      if (!bool)
      {
        localObject4 = new SSummaryCardQueryReq(1, Long.parseLong(paramToServiceMsg.getUin()), l2, "8.3.3", k, 109L);
        ...
        try
        {
          ...
          if ((l2 > 0L) || (bool))
          {
            ...
            if (((Iterator)localObject3).hasNext())
            {
              ...
              ((SummaryCardBusiEntry.comm)localObject8).qqver.set("8.3.3.4515");
              ...
              else
              {
                ...
                localObject9[0] = 40;
                bdlr.a((byte[])localObject9, 1, i1);
                bdlr.a((byte[])localObject9, 5, j);
                bdlr.a((byte[])localObject9, 9, (byte[])localObject8, i1);
                j = localObject8.length + 9;
                if (((BusinessBuff)localObject7).a() == null) {
                  break label1057;
                }
                bdlr.a((byte[])localObject9, j, ((BusinessBuff)localObject7).a(), ((BusinessBuff)localObject7).a().length);
  ...
  public static ArrayList<ahea> a(ArrayList<byte[]> paramArrayList)
  {
    ...
    if (i < k)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          break label53;
          n = (int)bdlr.a((byte[])localObject1, 1);
          m = (int)bdlr.a((byte[])localObject1, 5);
        } while ((n <= 0) || (n + 9 >= j));
        localObject2 = new byte[n];
        bdlr.a((byte[])localObject2, 0, (byte[])localObject1, 9, n);
        j = n + 9;
        ...
        for (;;)
        {
          try
          {
            ...
            bdlr.a((byte[])localObject2, 0, (byte[])localObject1, j, m);
            localObject1 = new AccountSearchPb.search();
            ((AccountSearchPb.search)localObject1).mergeFrom((byte[])localObject2);
            localObject2 = new ahea();
            ((ahea)localObject2).jdField_a_of_type_Int = n;
            ((ahea)localObject2).jdField_b_of_type_Int = ((AccountSearchPb.search)localObject1).start.get();
            if (((AccountSearchPb.search)localObject1).end.get() != 1) {
              break label496;
            }
            bool = true;
            ((ahea)localObject2).jdField_a_of_type_Boolean = bool;
            ((ahea)localObject2).jdField_b_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).list.get();
            ((ahea)localObject2).jdField_a_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).highlight.get();
            ((ahea)localObject2).jdField_a_of_type_JavaLangString = ((AccountSearchPb.search)localObject1).article_more_url.get();
            ((ahea)localObject2).jdField_a_of_type_ComTencentPbAddcontactsAccountSearchPb$hotwordrecord = ((AccountSearchPb.hotwordrecord)((AccountSearchPb.search)localObject1).hotword_record.get());
            ((ahea)localObject2).jdField_c_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).result_items.get();
            ((ahea)localObject2).jdField_b_of_type_Boolean = ((AccountSearchPb.search)localObject1).bool_keyword_suicide.get();
            if (((((ahea)localObject2).jdField_b_of_type_JavaUtilList == null) || (((ahea)localObject2).jdField_b_of_type_JavaUtilList.size() <= 0)) && ((((ahea)localObject2).jdField_c_of_type_JavaUtilList == null) || (((ahea)localObject2).jdField_c_of_type_JavaUtilList.size() <= 0)) && (!((ahea)localObject2).jdField_b_of_type_Boolean)) {
              break;
            }
    ...
    for (int j = 1;; j = 2)
    {
      ((ahea)localObject2).jdField_c_of_type_Int = j;
      break;
      if (!QLog.isDevelopLevel()) {
        break;
      }
  ...
  private boolean e(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    boolean bool = ((aloz)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(51)).b(String.valueOf(l));
  ...
  private boolean g(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg.vClientVersion = "8.3.3".getBytes();
  ...
  private Object p(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.vUserList != null) && (!paramFromServiceMsg.vUserList.isEmpty()))
    {
      ...
      while (i < paramFromServiceMsg.vUserList.size())
      {
        ...
        String str1 = allj.a(paramToServiceMsg.dwCountry);
        String str2 = allj.a(paramToServiceMsg.dwProvince);
        String str3 = allj.a(paramToServiceMsg.dwCity);
        paramToServiceMsg.locDesc = ((allj)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(59)).b(new String[] { str1, str2, str3, "0" });
        i += 1;
      }
    }
    return paramFromServiceMsg;
  ...
  private boolean q(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    localObject = new ReqVoiceManage(i, new VoiceInfo(bcyw.a((String)localObject), s, (byte)0, null), l);
    SummaryCard.ReqHead localReqHead = new SummaryCard.ReqHead();
    localReqHead.iVersion = 2;
    paramUniPacket.setServantName("SummaryCardServantObj");
  ...
  private boolean t(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        localSSummaryCardSetLabel.version = "8.3.3";
  ...
  private boolean u(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    try
    {
      ...
      localSSummaryCardLikeIt.version = "8.3.3";
      paramUniPacket.setServantName("SummaryCard");
