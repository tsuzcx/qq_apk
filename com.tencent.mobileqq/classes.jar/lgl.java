...
public class lgl
{
  ...
  private lgm jdField_a_of_type_Lgm;
  
  public lgl(VideoAppInterface paramVideoAppInterface)
  {
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface = paramVideoAppInterface;
    this.jdField_a_of_type_Lgm = new lgm(this);
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(this.jdField_a_of_type_Lgm);
  }
  ...
  private void a(Observable paramObservable, Object paramObject)
  {
    ...
    case 203: 
      ...
      {
        return;
        a(muk.a(paramObservable, 1), 2, null);
        return;
  ...
  {
    if (((paramInt == 3) || (paramInt == 1)) && (!((lih)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(5)).a(3, paramInt, paramString))) {
      ((lgx)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3)).a(paramInt, paramString);
    }
    return 0;
  }
  ...
  public int a(String paramString)
  {
    ...
    label660:
    label677:
    for (lix locallix = localObject[0];; locallix = null)
    {
      if (locallix == null) {
        return 0;
      }
      ...
      for (String str2 = localObject[2];; str2 = null)
      {
        ...
        for (long l1 = AudioHelper.a(localObject[3]);; l1 = 0L)
        {
          ...
          int i;
          if (locallix.startsWith("EMPTY_ITEM"))
          {
            if (!ZimuToolbar.isSupport()) {
              break;
            }
            locallix = (lix)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
            localObject = (ZimuItem)locallix.a();
            if ((localObject == null) || (TextUtils.isEmpty(((ZimuItem)localObject).getId()))) {
              break label660;
            }
            QLog.w("BusinessMessageCenter", 1, "onReceivedChangingZimuOfPeer, 对方取消字幕, info[" + paramString + "], sessionid[" + str1 + "], cmdSeq[" + str2 + "], seq[" + l3 + "], sendTime[" + l1 + "], offset[" + (l2 - l1) + "], isTranslation[" + locallix.c() + "], cur[" + ((ZimuItem)localObject).getId() + "]");
            paramString = (lix)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
            paramString.a("onReceivedChangingZimuOfPeer", l3);
            new mcz(l3, "onReceivedChangingZimuOfPeer", 3, "0").a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
          ...
          for (;;)
          {
            ...
            localObject = (lix)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
            ZimuItem localZimuItem1 = (ZimuItem)((lix)localObject).a(locallix);
            ZimuItem localZimuItem2 = (ZimuItem)((lix)localObject).a();
            QLog.w("BusinessMessageCenter", 1, "onReceivedChangingZimuOfPeer, 对方选择字幕, info[" + paramString + "], zimuId[" + locallix + "], sessionid[" + str1 + "], cmdSeq[" + str2 + "], seq[" + l3 + "], sendTime[" + l1 + "], offset[" + (l2 - l1) + "], isTranslation[" + ((lix)localObject).c() + "], ZimuItem[" + localZimuItem1 + "], CurItem[" + localZimuItem2 + "]");
            boolean bool;
            if (localZimuItem1 != null) {
              if (localZimuItem2 == null)
              {
                ...
                ((lix)localObject).a("onReceivedChangingZimuOfPeer", false, l3, str1);
                ((lix)localObject).a(l3, locallix);
                if (!localZimuItem1.isUsable()) {
                  ((lix)localObject).a(l3, localZimuItem1);
                }
                new mcz(l3, "onReceivedChangingZimuOfPeer", 1, locallix).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
                if (localZimuItem2 != null) {
                  break label650;
                }
                i = 3;
  ...
  {
    lbj.c("BusinessMessageCenter", "notifyEvent :" + paramInteger + "|" + paramObject);
  ...
  public int b(int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      {
        return 0;
      } while (((lih)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(5)).a(0, paramInt, paramString));
      a(paramString);
      return 0;
    } while (((lih)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(5)).a(0, paramInt, paramString));
    ...
    paramString = new lgi(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a().d, str, str, 2);
    paramString.a = true;
