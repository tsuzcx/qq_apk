...
public class bjlh
{
  public static int a(String paramString, bjli parambjli)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          parambjli.a[0] = Integer.parseInt(str1);
          parambjli.a[1] = Integer.parseInt(str2);
          parambjli.a[3] = Integer.parseInt(str3);
          i = 0;
        }
        ...
        try
        {
          parambjli.a[2] = Integer.parseInt(paramString);
          parambjli.a[4] = 0;
          return i;
        }
