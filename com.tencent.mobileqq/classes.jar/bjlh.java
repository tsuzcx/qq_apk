  ...
  extends bjli
{
  ...
  bjlj jdField_a_of_type_Bjlj = null;
  ...
  public bjlh(TraeAudioManager paramTraeAudioManager)
  {
  ...
  void a(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        this.jdField_a_of_type_Bjlj.a("DEVICE_BLUETOOTHHEADSET", true);
        do
        {
          return;
        } while (k != 0);
        this.jdField_a_of_type_Bjlj.a("DEVICE_BLUETOOTHHEADSET", false);
        return;
  ...
  public boolean a(Context paramContext, bjlj parambjlj)
  {
    ...
    if ((this.jdField_a_of_type_AndroidContentContext == null) || (this.jdField_a_of_type_Bjlj == null)) {}
    for (;;)
    {
      return false;
      try
      ...
      catch (Exception parambjlj)
      {
        ...
        catch (Exception parambjlj)
        {
          ...
          catch (NoSuchMethodException parambjlj)
          {
            try
            {
              do
              {
                for (;;)
                {
                  ...
                  this.jdField_a_of_type_Bjlj.a("DEVICE_BLUETOOTHHEADSET", a());
                  if (!a()) {
                    break label337;
                  }
                  this.jdField_a_of_type_Bjlj.a("DEVICE_BLUETOOTHHEADSET", true);
                  ...
                  if (QLog.isColorLevel())
                  {
                    ...
                    parambjlj = parambjlj;
                    if (QLog.isColorLevel()) {
                      QLog.e("TraeAudioManager", 2, "BTLooperThread BluetoothHeadset.ServiceListener class not found:" + parambjlj);
                    }
                  }
                }
                parambjlj = parambjlj;
