  ...
  implements ITransactionCallback
{
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    bben.a(String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Aywa.jdField_a_of_type_Long), "segment", "index: " + this.jdField_a_of_type_Int + "<BDH_LOG> step: resp onFailed errorCoed:" + paramInt + " BdhTransId : " + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.getTransationId());
    synchronized (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor)
    {
      ...
      paramHashMap = (aypb)this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_b_of_type_JavaUtilHashMap.get(Integer.valueOf(this.jdField_a_of_type_Int));
    ...
    if (ShortVideoUploadProcessor.c(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor) == 2)
    {
      ...
      bben.a(String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Aywa.jdField_a_of_type_Long), "onFailed", "TransactionListener.onFailed mVideoPreUpStatus = " + ShortVideoUploadProcessor.b(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor) + " mVideoRecordStatus = " + ShortVideoUploadProcessor.c(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor));
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor)
      {
        ...
        localObject1 = (aypb)this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_b_of_type_JavaUtilHashMap.get(Integer.valueOf(this.jdField_a_of_type_Int));
      ...
      if ((ShortVideoUploadProcessor.jdField_a_of_type_Boolean) && (paramArrayOfByte != null) && (paramArrayOfByte.length > 0))
      {
        ...
        try
        {
          ...
          else
          {
            ...
            bben.a(String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Aywa.jdField_a_of_type_Long), "svrcomp_r", "TransactionListener.onSuccess -> get MD5 from Server success!  MD5:" + HexUtil.bytes2HexStr((byte[])localObject2));
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Aywa.f = HexUtil.bytes2HexStr((byte[])localObject2);
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Aywa.f;
            if (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_JavaUtilHashMap != null)
            {
              this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_JavaUtilHashMap.put("param_fileMD5", this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Aywa.f);
            ...
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Aywa.i = ShortVideoUtils.a((MessageForShortVideo)this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Aywa.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, "mp4");
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Ayqm;
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Ayqm;
    ...
    ((ayqm)localObject2).e = l;
    ((ayqm)localObject1).jdField_a_of_type_Long = l;
  ...
  public void onUpdateProgress(int paramInt)
  {
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Ayqm.e = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.s;
        if (this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.cacheIp == 0) {
          break label317;
        }
