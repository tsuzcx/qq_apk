...
public class bonu
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alkn.jdField_a_of_type_JavaLangString + "/Tencent/qim/hum_recognition";
  ...
  private String a()
  {
    ...
    int i = a();
    String str1 = bonh.a("musicopi_12345683" + "a45a1b" + l);
  ...
  public bonu a(float paramFloat)
  {
    if (QLog.isColorLevel()) {
