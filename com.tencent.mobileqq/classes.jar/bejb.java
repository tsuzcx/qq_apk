...
public class bejb
{
  ...
  public bejb(Context paramContext)
  {
    paramContext = paramContext.getResources();
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getDrawable(2130840962);
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = paramContext.getDrawable(2130840963);
