  ...
  extends bhbu
{
  ...
  private final bhbi jdField_a_of_type_Bhbi = new bhbi(this);
  @Nullable
  ...
  {
    paramDrawable.setCallback((Drawable.Callback)this.jdField_a_of_type_Bhbi);
  ...
  public final void a()
  {
    bhbq localbhbq = bhbt.a();
    Intrinsics.checkExpressionValueIsNotNull(localbhbq, "loader");
    if (!localbhbq.a())
    {
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = ((Drawable)this.c.invoke());
      c();
    }
    ThreadManagerV2.executeOnSubThread((Runnable)new DynamicDrawable.build.1(this, localbhbq));
  }
  ...
  {
    Drawable localDrawable = this.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
    if ((localDrawable != null) && (bhbn.a(localDrawable))) {
      bhbn.a().a(localDrawable);
    }
