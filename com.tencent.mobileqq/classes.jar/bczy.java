...
public class bczy
  implements bdip
{
  public bczy(ChallengeBragBase paramChallengeBragBase) {}
  ...
  protected void a(Intent paramIntent)
  {
    ...
    if (i != 0)
    {
      ...
      bdht.e("qqBaseActivity", "onSendChallengeComplete error:{KEY_ERROR_CODE:" + i + "; KEY_ERROR_MSG:" + paramIntent.getStringExtra("key_error_msg") + "}");
    }
  ...
  {
    this.a.d();
    bdht.c("qqBaseActivity", "SendChallenge exception." + paramException.getMessage(), paramException);
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        if (localObject != null)
        {
          bdjc.a("400", (String)localObject, this.a.c);
    ...
    {
      bdht.c("qqBaseActivity", "SendChallenge exception." + paramJSONObject.getMessage(), paramJSONObject);
