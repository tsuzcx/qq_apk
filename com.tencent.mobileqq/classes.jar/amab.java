  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public amab(BaseActivity paramBaseActivity)
  {
  ...
  {
    bhdj.a(paramContext, 232, null, paramContext.getString(paramInt), new amac(paramContext), null).show();
  }
  ...
  protected int a()
  {
    ...
    //   3: istore_3
    //   4: aload_0
    //   5: getfield 53	amab:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   8: iconst_1
    ...
    //   63: invokestatic 196	com/tencent/mobileqq/utils/FileUtils:createFileIfNotExits	(Ljava/lang/String;)V
    //   66: new 198	java/io/File
    //   69: dup
    //   70: aload 6
    //   72: invokespecial 200	java/io/File:<init>	(Ljava/lang/String;)V
    //   75: astore 9
    //   77: new 198	java/io/File
    //   80: dup
    //   81: aload 9
    //   83: invokevirtual 203	java/io/File:getParent	()Ljava/lang/String;
    //   86: invokespecial 200	java/io/File:<init>	(Ljava/lang/String;)V
    //   89: astore 4
    //   91: aload 4
    //   93: invokevirtual 206	java/io/File:exists	()Z
    //   96: ifeq +11 -> 107
    //   99: aload 4
    //   101: invokevirtual 209	java/io/File:isDirectory	()Z
    //   104: ifne +9 -> 113
    //   107: aload 4
    //   109: invokevirtual 212	java/io/File:mkdirs	()Z
    //   112: pop
    //   113: aload 9
    //   115: invokevirtual 206	java/io/File:exists	()Z
    //   118: ifeq +11 -> 129
    //   121: aload 9
    //   123: invokevirtual 215	java/io/File:isFile	()Z
    //   126: ifne +9 -> 135
    //   129: aload 9
    //   131: invokevirtual 218	java/io/File:createNewFile	()Z
    //   134: pop
    //   135: new 220	java/io/BufferedOutputStream
    //   138: dup
    //   139: new 222	java/io/FileOutputStream
    //   142: dup
    //   143: aload 9
    //   145: invokespecial 225	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   148: invokespecial 228	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   151: astore 5
    //   153: aload 8
    //   155: ifnull +214 -> 369
    //   158: aload 5
    //   160: astore 4
    //   162: aload 8
    //   164: getstatic 234	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   167: bipush 80
    //   169: aload 5
    //   171: invokevirtual 240	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   174: pop
    //   175: aload 5
    //   177: astore 4
    //   179: aload 5
    //   181: invokevirtual 243	java/io/BufferedOutputStream:flush	()V
    //   184: iload_2
    //   185: istore_1
    //   186: aload 5
    //   188: ifnull +10 -> 198
    //   191: aload 5
    //   193: invokevirtual 246	java/io/BufferedOutputStream:close	()V
    //   196: iload_2
    //   197: istore_1
    //   198: aload 9
    //   200: invokevirtual 206	java/io/File:exists	()Z
    //   203: ifeq +782 -> 985
    //   206: new 248	java/io/FileInputStream
    //   209: dup
    //   210: aload 6
    //   212: invokespecial 249	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   215: astore 4
    //   217: aload 4
    //   219: aload 9
    //   221: invokevirtual 252	java/io/File:length	()J
    //   224: invokestatic 258	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   227: invokestatic 264	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   230: astore 5
    //   232: aload 4
    //   234: ifnull +8 -> 242
    //   237: aload 4
    //   239: invokevirtual 265	java/io/FileInputStream:close	()V
    //   242: aload 5
    //   244: invokestatic 271	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   247: ifeq +361 -> 608
    ...
    //   280: invokestatic 275	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   283: aload_0
    //   284: aload 5
    //   286: putfield 96	amab:g	Ljava/lang/String;
    //   289: aload_0
    //   290: aload 6
    //   292: putfield 277	amab:f	Ljava/lang/String;
    //   295: aload 8
    //   297: ifnull +21 -> 318
    //   300: aload_0
    //   301: aload 8
    //   303: invokevirtual 280	android/graphics/Bitmap:getWidth	()I
    //   306: putfield 282	amab:jdField_b_of_type_Int	I
    //   309: aload_0
    //   310: aload 8
    //   312: invokevirtual 285	android/graphics/Bitmap:getHeight	()I
    //   315: putfield 287	amab:jdField_c_of_type_Int	I
    //   318: new 248	java/io/FileInputStream
    //   321: dup
    //   322: aload_0
    //   323: getfield 53	amab:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   326: invokespecial 249	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   329: astore 5
    //   331: aload_0
    //   332: aload 5
    //   334: new 198	java/io/File
    //   337: dup
    //   338: aload_0
    //   339: getfield 53	amab:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   342: invokespecial 200	java/io/File:<init>	(Ljava/lang/String;)V
    //   345: invokevirtual 252	java/io/File:length	()J
    //   348: invokestatic 258	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   351: invokestatic 264	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   354: putfield 88	amab:e	Ljava/lang/String;
    //   357: iload_1
    //   358: ireturn
    //   359: astore 4
    //   361: aload 4
    //   363: invokevirtual 290	java/io/IOException:printStackTrace	()V
    //   366: goto -231 -> 135
    //   369: iconst_2
    //   370: istore_2
    //   371: goto -187 -> 184
    ...
    //   420: aload 7
    //   422: invokevirtual 297	java/io/FileNotFoundException:getMessage	()Ljava/lang/String;
    ...
    //   431: invokestatic 275	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   434: aload 5
    //   436: ifnull +8 -> 444
    //   439: aload 5
    //   441: invokevirtual 246	java/io/BufferedOutputStream:close	()V
    //   444: iconst_2
    //   445: istore_1
    //   446: goto -248 -> 198
    //   449: astore 4
    ...
    //   502: aload 7
    //   504: invokevirtual 300	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   513: invokestatic 275	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   516: aload 5
    //   518: ifnull +8 -> 526
    //   521: aload 5
    //   523: invokevirtual 246	java/io/BufferedOutputStream:close	()V
    //   526: iconst_2
    //   527: istore_1
    //   528: goto -330 -> 198
    //   531: astore 4
    ...
    //   545: ifnull +8 -> 553
    //   548: aload 4
    //   550: invokevirtual 246	java/io/BufferedOutputStream:close	()V
    //   553: aload 5
    //   555: athrow
    //   556: astore 7
    ...
    //   591: aload 7
    //   593: invokevirtual 300	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   602: invokestatic 275	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   605: goto -363 -> 242
    //   608: aload 5
    //   610: ldc 179
    ...
    //   617: aload 6
    //   619: aload 7
    //   621: invokestatic 306	com/tencent/mobileqq/utils/FileUtils:rename	(Ljava/lang/String;Ljava/lang/String;)Z
    //   624: ifeq +430 -> 1054
    //   627: aload 7
    //   629: astore 6
    //   631: goto -348 -> 283
    ...
    //   637: astore 4
    //   639: aload 5
    //   641: invokevirtual 307	java/io/FileNotFoundException:printStackTrace	()V
    //   644: aload 4
    //   646: ifnull +8 -> 654
    //   649: aload 4
    //   651: invokevirtual 265	java/io/FileInputStream:close	()V
    //   654: aconst_null
    //   655: invokestatic 271	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   658: ifeq +95 -> 753
    ...
    //   690: invokestatic 275	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   693: iconst_2
    //   694: istore_1
    //   695: aconst_null
    //   696: astore 5
    ...
    //   736: aload 5
    //   738: invokevirtual 300	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   747: invokestatic 275	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   750: goto -96 -> 654
    //   753: aconst_null
    //   754: ldc 179
    ...
    //   765: aload 6
    //   767: aload 5
    //   769: invokestatic 306	com/tencent/mobileqq/utils/FileUtils:rename	(Ljava/lang/String;Ljava/lang/String;)Z
    //   772: ifeq +7 -> 779
    //   775: aload 5
    //   777: astore 7
    //   779: iconst_2
    ...
    //   798: ifnull +8 -> 806
    //   801: aload 4
    //   803: invokevirtual 265	java/io/FileInputStream:close	()V
    //   806: aconst_null
    //   807: invokestatic 271	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   810: ifeq +90 -> 900
    ...
    //   842: invokestatic 275	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   845: aload 5
    //   847: athrow
    //   848: astore 4
    ...
    //   883: aload 4
    //   885: invokevirtual 300	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   894: invokestatic 275	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   897: goto -91 -> 806
    //   900: aload 6
    //   902: aconst_null
    //   903: ldc 179
    ...
    //   908: invokestatic 306	com/tencent/mobileqq/utils/FileUtils:rename	(Ljava/lang/String;Ljava/lang/String;)Z
    //   911: ifeq -66 -> 845
    //   914: goto -69 -> 845
    //   917: astore 6
    //   919: iconst_5
    ...
    //   949: aload_0
    //   950: getfield 53	amab:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   962: aload 6
    //   964: invokevirtual 297	java/io/FileNotFoundException:getMessage	()Ljava/lang/String;
    ...
    //   973: invokestatic 275	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   976: aload 4
    //   978: astore 5
    //   980: iload_2
    //   981: istore_1
    ...
    //   995: iconst_2
    //   996: ldc_w 313
    //   999: invokestatic 275	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   1002: iconst_2
    //   1003: ireturn
    //   1004: astore 4
    //   1006: iload_2
  ...
  protected void a(Integer paramInteger)
  {
    ...
    case 1: 
      ...
      Object localObject2 = bcwz.a(0, 2);
      Object localObject1 = bcwz.a(2, paramInteger, (bcxr)localObject2);
      ((bcxr)localObject2).a((bcyj)localObject1);
      localObject2 = new bcwi(((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).app);
      ...
      localObject2 = bcwz.a(0, 2);
      localObject1 = bcwz.a(localObject1, (bcxr)localObject2);
      ((bcyj)localObject1).a = false;
      ((bcxr)localObject2).a((bcyj)localObject1);
      bcwz.a((bcxr)localObject2, ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).app);
    ...
    case 2: 
    case 6: 
      b((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718874);
      return;
    case 3: 
      b((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718869);
      return;
    case 4: 
      b((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718840);
      return;
    }
    b((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718866);
  }
  
  protected void onPreExecute()
  {
    super.onPreExecute();
    a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131694652);
  }
}
