...
public class amab
  implements alkr, BusinessObserver
{
  protected void a() {}
  ...
  protected void a(boolean paramBoolean1, String paramString1, ArrayList<bcpp> paramArrayList, byte[] paramArrayOfByte, boolean paramBoolean2, String paramString2) {}
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return;
        a(paramBoolean, (bctb)paramObject);
        return;
        long l;
        if ((paramObject instanceof Object[]))
        {
        ...
        for (;;)
        {
          ...
          if ((paramObject instanceof Object[]))
          {
            ...
            localObject1 = localObject2;
            if (paramObject.length > 0) {
              localObject1 = (bbtw)paramObject[0];
            }
          }
          a(paramBoolean, (bbtw)localObject1);
          return;
          i = 0;
          paramInt = i;
          if (paramObject != null)
          ...
          for (paramObject = (List)localObject1[2];; paramObject = null)
          {
            ...
            a(paramBoolean, ((Integer)paramObject[0]).intValue(), ((Long)paramObject[1]).longValue(), (bckv)paramObject[2]);
            return;
            if (!(paramObject instanceof Object[])) {
              break;
            }
