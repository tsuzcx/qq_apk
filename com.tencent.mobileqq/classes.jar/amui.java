  ...
  extends ScanningData
{
  ...
  public amui(Context paramContext)
  {
    super(paramContext);
    l();
    a();
  ...
  private void l()
  {
    ...
    this.i = (bdkf.a(1.5F) * this.jdField_c_of_type_Float);
  ...
  public void g()
  {
    ...
    {
      this.jdField_g_of_type_AndroidAnimationObjectAnimator = ObjectAnimator.ofFloat(this, "fCPositionY", new float[] { -bdkf.a(25.0F), 0.0F });
