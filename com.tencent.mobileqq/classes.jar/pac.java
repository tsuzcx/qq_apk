...
public class pac
{
  ...
  public static Intent a(Context paramContext, ArticleInfo paramArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      paramContext.putExtra("req_create_time", ozr.a(paramArticleInfo.mTime));
  ...
  {
    // Byte code:
    //   0: invokestatic 213	ozs:a	()Lmqq/app/AppRuntime;
  ...
  public static Intent b(Context paramContext, ArticleInfo paramArticleInfo)
  {
    ...
    {
      localObject1 = pfa.a().a();
      if (localObject1 != null) {
        ((ppe)localObject1).a(paramArticleInfo.mArticleContentUrl, String.valueOf(paramArticleInfo.innerUniqueID), paramArticleInfo.mSubscribeID, 1, null);
      }
    ...
    if (sel.h(paramArticleInfo))
    {
      ...
      if (!sel.l(paramArticleInfo)) {
        localObject1 = ((qzd)paramArticleInfo.mSocialFeedInfo.a.a.get(0)).b;
      }
    }
    ...
    else
    {
      ...
      localBundle.putBoolean("preload_tool_white_list", ozs.h());
      ...
      if ((bhmi.b(antf.cK + paramContext)) && (PreloadManager.a().b(paramContext) != null))
      {
        localBundle.putString("read_in_joy_from_cache", paramContext);
        if (!pfa.a().a(paramArticleInfo.mArticleID))
        {
          ...
          {
            ThreadManager.post(new ReadinjoyJumpUtils.1(paramArticleInfo, (txy)paramContext.get(0)), 5, null, false);
            if (paramContext.size() <= 1) {
              break label742;
            }
            localBundle.putString("preload_iamge_url", ((txy)paramContext.get(1)).a);
          }
        }
      }
    }
    for (;;)
    {
      ...
      paramContext = paramArticleInfo.a(paramContext);
      if ((paramContext != null) && (paramContext.size() > 0)) {
        localBundle.putString("preload_iamge_url", ((txy)paramContext.get(0)).a);
      } else {
        localBundle.putString("preload_iamge_url", null);
      }
    }
