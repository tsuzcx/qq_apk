  ...
  extends WebViewPlugin
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bcim.class.getSimpleName();
  }
  ...
  private void b(String paramString)
  {
    ...
    do
    {
      ...
      paramString = bbex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Context)localObject, paramString);
  ...
  {
    paramString = bbex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.mRuntime.a(), paramString);
    if (paramString != null) {
      paramString.c();
    }
  }
      ...
      } else if (paramLong == 8589934601L)
      {
        if ((!TextUtils.isEmpty(paramString)) && ((paramString.contains("chatplay/hall")) || (paramString.contains("avwithstranger/avchathall")) || (paramString.contains("chatplay/avchathall"))) && (paramString.endsWith("#child")))
        {
          if ((paramString.contains("adtag=client.tab")) && (this.mRuntime != null) && (this.mRuntime.a() != null))
          {
            ...
            ((IphoneTitleBarActivity)this.mRuntime.a()).setLeftViewName(2131720033);
          }
          while ((this.mRuntime != null) && (this.mRuntime.a() != null) && (this.mRuntime.a().canGoBack()))
          {
            ...
            return true;
            label178:
            if (((this.mRuntime.a() instanceof bccs)) && (!bcgq.a()))
            {
              paramString = this.mRuntime.a();
              if ((paramString != null) && (paramString.a.a != null)) {
                paramString.a.a.setText(2131720033);
              }
            }
          }
        }
        ...
        if ((this.mRuntime.a() instanceof IphoneTitleBarActivity))
        {
          ((IphoneTitleBarActivity)this.mRuntime.a()).setLeftViewName(2131690572);
        }
        else if (((this.mRuntime.a() instanceof bccs)) && (!bcgq.a()))
        {
          paramString = this.mRuntime.a();
          if ((paramString != null) && (paramString.a.a != null)) {
            paramString.a.a.setText(2131690572);
          }
        }
      }
    }
  ...
  public boolean handleSchemaRequest(String paramString1, String paramString2)
  {
            ...
            do
            {
              do
              {
                do
                {
                      ...
                      do
                      {
                        do
                        {
                          do
                          {
                            ...
                            {
                              return bool1;
                              if ((wij.a(paramString1)) && (whj.a(paramString1))) {
                                return false;
                              }
                              localObject1 = null;
                              ...
                              if (paramString1.startsWith("tel:"))
                              {
                                ...
                                if ((!bbnf.jdField_a_of_type_Boolean) && (bbnc.a().a())) {
                                  bbnc.a().a(paramString1);
                                }
                                a(paramString1);
                                return true;
                              }
                          ...
                          this.b = true;
                          paramString1 = bbex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.mRuntime.a(), paramString1);
                          bool1 = bool2;
                        ...
                        this.b = false;
                        return true;
                        if ((!wij.a(paramString1)) && (!paramString1.startsWith("mqqopensdkapi:"))) {
                          break;
                        }
                        paramString2 = this.mRuntime.a();
                        bool1 = bool2;
                      } while (paramString2 == null);
                      paramString2 = bbex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2, paramString1);
                  ...
                  paramString1 = bbex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2, paramString1);
                  ...
                  if (paramString1.startsWith("http://clientui.3g.qq.com/mqqapi/"))
                  {
                    ...
                    {
                      paramString2 = nau.b(paramString1, new String[0]);
                      paramString1 = paramString2;
                      if (paramString2.length() > 512) {
                        paramString1 = paramString2.substring(0, 512);
                      }
                      axqy.b(null, "P_CliOper", "BizTechReport", "", "webview_jump", "http_jumpaction", 0, 1, 0, nau.b((String)localObject1, new String[0]), paramString1, "", "");
                    }
                    return false;
                  }
    ...
    return true;
    if ((paramString1.startsWith("mqqflyticket://")) || (wij.b(paramString1)))
    {
      b(paramString1);
      return true;
    }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          paramString2 = bfnx.a(paramString1);
