...
public class bjeh
{
  ...
  static
  {
    ...
    jdField_f_of_type_Int = bajq.a(66.0F);
  }
  ...
  public static void a(Activity paramActivity)
  {
    ...
    {
      jdField_b_of_type_Int = mjg.b(BaseApplicationImpl.getApplication());
      jdField_c_of_type_Int = mjg.a(BaseApplicationImpl.getApplication());
      jdField_a_of_type_Boolean = false;
    }
    try
    {
  ...
  public static int[] a(Context paramContext)
  {
    ...
    boolean bool = bepu.a(paramContext);
    if (bool) {}
    for (int i = bepu.a(paramContext);; i = 0)
    {
      if (QLog.isColorLevel()) {
