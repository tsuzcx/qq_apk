...
public abstract class akon
{
  ...
  public akon(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  public void a(int paramInt, boolean paramBoolean, Object paramObject)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      if (localIterator.hasNext()) {
        ((akqk)localIterator.next()).b(paramInt, paramBoolean, paramObject);
      }
    }
  }
  ...
  public void a(akqk paramakqk)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramakqk);
      return;
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      if (localIterator.hasNext()) {
        ((akqk)localIterator.next()).a(getClass().getSimpleName(), paramString, paramBoolean1, paramInt, paramBoolean2, paramBoolean3);
      }
    }
  }
  ...
  {
    int i = akpx.a(???, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      if (localIterator.hasNext()) {
        ((akqk)localIterator.next()).a(getClass().getSimpleName(), paramString, paramBoolean1, i, paramBoolean2, paramBoolean3);
      }
    }
  }
  ...
  protected void a(ArrayList<MessageRecord> paramArrayList1, ArrayList<MessageRecord> paramArrayList2, boolean paramBoolean)
  {
    if (paramArrayList1.size() > 0)
    {
      ...
      while (paramArrayList1.hasNext())
      {
        ...
        if (!akas.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, paramBoolean)) {
  ...
  public void a(msg_svc.PbMsgReadedReportReq paramPbMsgReadedReportReq)
  {
    ...
    a(true, true, false, 0L, new akoo(this, paramPbMsgReadedReportReq));
  }
  
  protected void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, long paramLong, akop paramakop)
  {
    int i;
    if (paramLong == 0L)
    {
    ...
    for (;;)
    {
      ...
      if (!paramBoolean1)
      {
        paramakop = paramakop.a();
        if (paramakop == null) {
          return;
        }
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.BaseMessageProcessor", 2, "processRequest cmd=" + paramakop.getServiceCmd() + ",reqSeq=" + paramLong);
        }
        a(paramakop, paramLong, paramBoolean2, paramBoolean3);
        return;
      }
      ...
      while (i < 9)
      {
        localSendMessageHandler.a(new BaseMessageProcessor.1(this, paramakop, paramLong, l, paramBoolean2, paramBoolean3));
        i += 1;
      }
      i = 0;
      label168:
  ...
  {
    return akas.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord, paramBoolean);
  }
  ...
  public void b(int paramInt, boolean paramBoolean, Object paramObject)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      if (localIterator.hasNext()) {
        ((akqk)localIterator.next()).c(paramInt, paramBoolean, paramObject);
      }
    }
  }
}
