...
public class aarv
  extends aata
  implements Handler.Callback, bfob, bfpc, bfrq
{
  ...
  private boolean a(aodw paramaodw, boolean paramBoolean)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryFileActivity != null) {
      if (paramaodw.jdField_a_of_type_Boolean != paramBoolean)
      {
        if (!paramBoolean) {
          break label46;
        }
        ...
        paramaodw.jdField_a_of_type_Boolean = true;
        this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryFileActivity.a(paramaodw);
      }
    }
    for (;;)
    {
      return true;
      label46:
      paramaodw.jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryFileActivity.b(paramaodw);
      continue;
      if ((this.jdField_a_of_type_Aarw != null) && (paramaodw.jdField_a_of_type_Boolean != paramBoolean))
      {
        if (paramBoolean)
        {
          if (this.jdField_a_of_type_Aarw.a()) {
            break;
          }
          paramaodw.jdField_a_of_type_Boolean = true;
          this.jdField_a_of_type_Aarw.a(paramaodw);
          continue;
        }
        paramaodw.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_Aarw.b(paramaodw);
      }
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Aodj.a() <= paramInt);
      localObject = this.jdField_a_of_type_Aodj.a(paramInt);
    } while (!aodw.class.isInstance(localObject));
    Object localObject = (aodw)localObject;
    this.jdField_d_of_type_Boolean = ((aodw)localObject).jdField_a_of_type_Boolean;
    if (!this.jdField_d_of_type_Boolean) {}
    for (boolean bool = true;; bool = false)
    {
      if (a((aodw)localObject, bool)) {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject = this.jdField_a_of_type_Aodj.a(paramInt1);
        if (aodw.class.isInstance(localObject)) {
          break;
        }
        paramInt1 += 1;
      }
    ...
    if (paramInt1 <= this.jdField_c_of_type_Int)
    {
      ...
      for (;;)
      {
        paramInt1 += 1;
        break;
        a((aodw)localObject, this.jdField_d_of_type_Boolean);
      }
    }
  ...
  {
    Object localObject = this.jdField_a_of_type_Aodj.a();
    if (localObject != null)
    {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        this.jdField_a_of_type_Bfnk.post(new ChatHistoryEmotionView.4(this));
        return;
      }
      f();
      return;
  ...
  public void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    this.jdField_a_of_type_Aodq = new aodq(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Int);
    ...
    this.jdField_a_of_type_Aodj = new aodj(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Aodq, this.jdField_a_of_type_Bfnk, m, this.jdField_a_of_type_ComTencentWidgetGestureSelectGridView);
    this.jdField_a_of_type_ComTencentWidgetGestureSelectGridView.setAdapter(this.jdField_a_of_type_Aodj);
    ...
    this.jdField_a_of_type_Aodj.a(true);
  ...
  public void d()
  {
    if (!this.jdField_a_of_type_Aodj.jdField_b_of_type_Boolean)
    {
      this.jdField_b_of_type_Boolean = true;
      this.jdField_a_of_type_Aodj.jdField_b_of_type_Boolean = true;
      this.jdField_a_of_type_ComTencentWidgetGestureSelectGridView.setSelectMode(true);
      this.jdField_a_of_type_Aodj.notifyDataSetChanged();
    }
  }
  ...
  public void e()
  {
    if (this.jdField_a_of_type_Aodj.jdField_b_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Aodj.jdField_b_of_type_Boolean = false;
      this.jdField_a_of_type_ComTencentWidgetGestureSelectGridView.setSelectMode(false);
      this.jdField_a_of_type_Aodj.notifyDataSetChanged();
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (paramMessage.obj == null)
      {
        ...
        this.jdField_a_of_type_Aodj.a((List)localObject);
      }
      for (;;)
      {
        if (this.jdField_a_of_type_Aarw == null) {
          break label112;
        }
        this.jdField_a_of_type_Aarw.a();
        return false;
        localObject = (List)paramMessage.obj;
        break;
        this.jdField_a_of_type_Aodj.b((List)localObject);
  ...
  {
    paramAdapterView = this.jdField_a_of_type_Aodj.getItem(paramInt);
    if (!aodw.class.isInstance(paramAdapterView)) {}
    for (;;)
    {
      return;
      paramAdapterView = (aodw)paramAdapterView;
      if (!this.jdField_b_of_type_Boolean) {
        break;
      }
    ...
    AIOEmotionFragment.a(paramView.getContext(), paramAdapterView.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, localSessionInfo, xpx.a(paramView));
  }
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    if (paramInt == 0)
    {
      ...
      int i = this.jdField_a_of_type_Aodj.a();
      if (((paramInt >= i - 28) || (paramInt == i)) && (this.jdField_a_of_type_Int != i))
      {
        if (QLog.isColorLevel()) {
