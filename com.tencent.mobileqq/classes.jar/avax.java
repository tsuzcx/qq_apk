  ...
  extends BitmapDrawable
{
  ...
  public avax(Resources paramResources, Bitmap paramBitmap)
  {
    super(paramResources, paramBitmap);
  }
  
  public static avax[] a(int paramInt, Resources paramResources, Bitmap paramBitmap)
  {
    if ((paramBitmap != null) && (paramResources != null))
    {
      avax[] arrayOfavax2 = new avax[paramInt];
      e = paramBitmap.getWidth() / 2;
      d = paramBitmap.getHeight() / 2;
      int i = 0;
      for (;;)
      {
        arrayOfavax1 = arrayOfavax2;
        if (i >= paramInt) {
          break;
        }
        arrayOfavax2[i] = new avax(paramResources, paramBitmap);
        i += 1;
      }
    }
    avax[] arrayOfavax1 = null;
    return arrayOfavax1;
  }
