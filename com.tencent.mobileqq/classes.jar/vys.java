  ...
  implements View.OnClickListener
{
  ...
  private List<vxh> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public vys(Activity paramActivity, View paramView, int paramInt1, int paramInt2, vyy paramvyy)
  {
    super(paramView);
    ...
    this.jdField_a_of_type_Asbg = new asbg(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130846402);
    this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView = ((AlbumImageView)paramView.findViewById(2131362568));
    this.jdField_b_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView = ((AlbumImageView)paramView.findViewById(2131362581));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131362644));
    this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewRoundCornerLayout = ((RoundCornerLayout)paramView.findViewById(2131362571));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362646));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362641));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362583));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362624));
    this.e = ((TextView)paramView.findViewById(2131362645));
    this.f = ((TextView)paramView.findViewById(2131362627));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362577));
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131362573);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362582));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362618));
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131364409));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131364410));
    this.g = ((TextView)paramView.findViewById(2131364411));
    ...
    this.jdField_a_of_type_AndroidOsHandler = new vyw(this, Looper.getMainLooper());
    paramActivity = (vwv)wjs.a(30);
  ...
  private int a()
  {
    ...
    if (this.jdField_a_of_type_Vxg != null) {
      i = this.jdField_a_of_type_Vxg.e;
    }
    return i;
  }
  
  private int a(List<vxh> paramList, int paramInt)
  {
    int i;
    ...
    for (;;)
    {
      ...
      i = j;
      if (new File(((vxh)paramList.get(j)).jdField_a_of_type_JavaLangString).exists()) {
        break;
      }
      j += 1;
    }
  ...
  private Drawable a(String paramString)
  {
    ...
    //   64: ldc_w 298
    //   67: aload_3
    //   68: invokestatic 303	ykq:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   71: aload_2
    //   72: ifnull +49 -> 121
    //   75: aload_2
  ...
  private URLDrawable a(String paramString1, String paramString2, int paramInt1, int paramInt2, boolean paramBoolean, vys paramvys)
  {
    QQLiveDrawable.QQLiveDrawableParams localQQLiveDrawableParams = new QQLiveDrawable.QQLiveDrawableParams();
    paramvys = new vyz(paramvys);
    ...
    localQQLiveDrawableParams.mCoverLoadingDrawable = this.jdField_a_of_type_Asbg;
    if (!paramBoolean) {
    ...
    {
      localQQLiveDrawableParams.mListener = paramvys;
      localQQLiveDrawableParams.mDownloadListener = paramvys;
      paramString2 = URLDrawable.URLDrawableOptions.obtain();
      paramString2.mExtraInfo = localQQLiveDrawableParams;
      paramString2.mFailedDrawable = this.jdField_a_of_type_Asbg;
      paramString2.mLoadingDrawable = this.jdField_a_of_type_Asbg;
  ...
  {
    if (this.jdField_a_of_type_Vxg != null) {
      this.jdField_a_of_type_Vxg.e = paramInt;
    }
  }
  ...
  {
    ykq.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg :%s", new Object[] { this.jdField_a_of_type_Vxg });
    this.jdField_c_of_type_Int = 3;
    if (paramList.size() == 0)
    {
      ykq.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg error , no pic list");
      return;
    }
    ...
    {
      ykq.b("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg error , %s", paramList);
      return;
    }
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_Vxg.a() == 0) {
    ...
    if ((this.jdField_b_of_type_AndroidWidgetLinearLayout.getVisibility() == 0) && (this.jdField_b_of_type_AndroidWidgetLinearLayout.getAnimation() == null))
    {
      ...
      localAlphaAnimation.setAnimationListener(new vyt(this));
    ...
    if (i < 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Vxg.jdField_b_of_type_JavaLangString);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Vxg.a(((List)localObject).size()))) {
        break label364;
      }
      this.jdField_c_of_type_AndroidWidgetTextView.setText(String.format(anvx.a(2131699670), new Object[] { this.jdField_a_of_type_Vxg.jdField_b_of_type_JavaLangString, Integer.valueOf(((List)localObject).size()) }));
    }
    for (;;)
    {
      this.f.setText(String.valueOf(this.jdField_a_of_type_Vxg.b()));
      this.e.setText(this.jdField_a_of_type_Vxg.a());
      return;
      this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView.setLocalDrawable(((vxh)((List)localObject).get(i)).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      break;
      label364:
      this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Vxg.a(((List)localObject).size()));
    }
  }
  ...
  private void e()
  {
    ...
    a(localHashSet);
    wzk.a(this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView, null, this.jdField_b_of_type_JavaLangString, false, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131699676));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(anvx.a(2131699678));
  }
  ...
  private void f()
  {
    ...
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130846404);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130846402);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131699685));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131699668));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(anvx.a(2131699686));
    this.g.setText(anvx.a(2131699663));
  }
  ...
  private void g()
  {
    ...
    localHashSet.add(this.g);
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130846407);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130846402);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131699679));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131699683));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(anvx.a(2131699689));
    this.g.setText(anvx.a(2131699661));
  }
  ...
  private void h()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130846402);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131699687));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131699688));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(anvx.a(2131699684));
    this.g.setText(anvx.a(2131699664));
  }
  ...
  private void i()
  {
    ...
    localHashSet.add(this.g);
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130846405);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130846402);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131699674));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131699669));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(anvx.a(2131699680));
    this.g.setText(anvx.a(2131699682));
  }
  
  private void j()
  {
    ykq.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop :%s", new Object[] { this.jdField_a_of_type_Vxg });
    if ((this.jdField_a_of_type_Vxg == null) || (this.jdField_a_of_type_Vxg.a()))
    {
      ykq.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop error ,album not exist");
      this.jdField_c_of_type_Int = 0;
      return;
    }
    ...
    {
      ykq.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop error ,get pick count not enough ,size = %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()) });
      this.jdField_c_of_type_Int = 0;
      return;
    }
    this.jdField_d_of_type_Int = 0;
    this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1);
    ykq.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop success ,get pick count = %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()) });
  }
  
  private void k()
  {
    ykq.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayLoop");
    this.jdField_c_of_type_Int = 0;
    ...
    if (this.jdField_a_of_type_Vxg != null)
    {
      localObject = this.jdField_a_of_type_Vxg.a();
      if (((List)localObject).size() <= 0) {
        break label111;
      }
    }
    label111:
    for (Object localObject = ((vxh)((List)localObject).get(0)).jdField_a_of_type_JavaLangString;; localObject = "")
    {
  ...
  private void l()
  {
    ykq.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayMp4 :%s", new Object[] { this.jdField_a_of_type_Vxg });
    ...
    localURLDrawableOptions.mFailedDrawable = this.jdField_a_of_type_Asbg;
    localURLDrawableOptions.mLoadingDrawable = this.jdField_a_of_type_Asbg;
  ...
  private void m()
  {
    ykq.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayMp4");
    this.jdField_c_of_type_Int = 0;
    if (this.jdField_a_of_type_ComTencentImageURLDrawable != null)
    {
      if ((this.jdField_a_of_type_ComTencentImageURLDrawable.getCurrDrawable() instanceof QQLiveDrawable))
      {
        ...
        ykq.b("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayMp4 suc");
      }
  ...
  private void o()
  {
    ykq.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayCenterImg");
    this.jdField_c_of_type_Int = 0;
  ...
  {
    if (this.jdField_a_of_type_Vxg != null) {
      a(this.jdField_a_of_type_Vxg);
    }
  }
  
  public void a(@NonNull vxg paramvxg)
  {
    if ((this.jdField_a_of_type_Vxg != null) && (!this.jdField_a_of_type_Vxg.equals(paramvxg)) && (this.jdField_c_of_type_Int != 0)) {
      c();
    }
    this.jdField_a_of_type_Vxg = paramvxg;
    Object localObject = this.jdField_a_of_type_Vxg.a();
    paramvxg = new ArrayList();
    localObject = ((List)localObject).iterator();
    while (((Iterator)localObject).hasNext())
    {
      vxh localvxh = (vxh)((Iterator)localObject).next();
      if (localvxh.a()) {
        paramvxg.add(localvxh);
      }
    }
    this.jdField_a_of_type_JavaUtilList = paramvxg;
    if (this.jdField_c_of_type_Int == 0)
    {
      if (!this.jdField_a_of_type_Vxg.a()) {
        break label185;
      }
      if (this.jdField_a_of_type_Vxg.jdField_d_of_type_Int == 1) {
        e();
      }
    }
    else
    ...
    if (this.jdField_a_of_type_Vxg.jdField_d_of_type_Int == 3)
    {
      f();
      return;
    }
    if (this.jdField_a_of_type_Vxg.jdField_d_of_type_Int == 2)
    {
      g();
      return;
    }
    if (this.jdField_a_of_type_Vxg.jdField_d_of_type_Int == 5)
    {
      i();
      return;
    }
  ...
  {
    if (this.jdField_a_of_type_Vxg == null) {
      ykq.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "data empty , startPlay error!");
    }
    do
    {
      do
    ...
    } while (this.jdField_a_of_type_Vxg.jdField_d_of_type_Int != 2);
    a(vws.a().a(vws.jdField_a_of_type_Int));
    return;
    j();
  }
  ...
  {
    if (this.jdField_a_of_type_Vxg == null) {
      ykq.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "data empty , stopPlay error!");
    }
    while (this.jdField_c_of_type_Int == 0) {
      return;
    }
    ykq.a("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stop play :%s", this.jdField_a_of_type_Vxg);
    this.jdField_c_of_type_Int = 0;
    if (this.jdField_a_of_type_Vxg.a()) {
      if (this.jdField_a_of_type_Vxg.jdField_d_of_type_Int == 1) {
        m();
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      int i = ((Integer)((wjl)localObject).b("key_album_delete_dialog_show_count", Integer.valueOf(0))).intValue();
      if (i < 3)
      {
        ((wjl)localObject).b("key_album_delete_dialog_show_count", Integer.valueOf(i + 1));
        localObject = new vyu(this);
        localObject = bhdj.a(this.jdField_a_of_type_AndroidAppActivity, 230, 2131559043, anvx.a(2131699665), null, anvx.a(2131699672), anvx.a(2131699675), (DialogInterface.OnClickListener)localObject, (DialogInterface.OnClickListener)localObject);
      ...
      for (;;)
      {
        ykv.a("video_shoot_slides", "delete_smartalbum", 0, 0, new String[] { String.valueOf(this.jdField_a_of_type_Vxg.d()), "1" });
        break;
        if (this.jdField_a_of_type_Vyy != null) {
          this.jdField_a_of_type_Vyy.b(this.jdField_a_of_type_Vxg);
        }
      }
      if (!UIUtils.isFastDoubleClick()) {
        book.a(this.jdField_a_of_type_AndroidViewView, 300L, new vyv(this), new float[] { 1.0F, 0.95F, 1.0F });
      }
    }
  }
}
