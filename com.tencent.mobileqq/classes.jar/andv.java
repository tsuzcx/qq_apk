...
{
  public byte a;
  private final int jdField_a_of_type_Int = amox.a();
  public long a;
  ...
  public andv(short paramShort, byte paramByte)
  {
  ...
  public void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        aneb localaneb = (aneb)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if ((localaneb.d == null) || (!localaneb.d.contains(paramString))) {}
      }
      for (;;)
      {
        if (i == -1) {
