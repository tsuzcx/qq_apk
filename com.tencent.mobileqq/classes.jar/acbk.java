...
public class acbk
  implements afcf
{
  public acbk(TroopRequestActivity paramTroopRequestActivity) {}
  ...
  public void a(String paramString, structmsg.StructMsg paramStructMsg, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.a.jdField_a_of_type_Ajtg == null);
        try
        {
          long l = Long.parseLong(this.a.jdField_a_of_type_JavaLangString);
          this.a.h();
          this.a.jdField_a_of_type_Ajtg.a(l, 8390784);
          return;
        }
    ...
    label250:
    awqx.b(this.a.app, "P_CliOper", "Grp_contacts", "", "notice", "agree_invite", 0, 0, paramString, "", "0", "0");
  ...
  public void a(String paramString1, structmsg.StructMsg paramStructMsg, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    {
      bbmy.a(paramStructMsg, paramInt1, 1).a();
