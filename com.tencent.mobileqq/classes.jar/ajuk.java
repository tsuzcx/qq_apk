...
{
  public ajuk(HealthBusinessPlugin paramHealthBusinessPlugin, ajva paramajva, IVideoViewBase paramIVideoViewBase, FrameLayout paramFrameLayout) {}
  
  public void onClick(View paramView)
  {
    if (!this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.d)
    {
      this.jdField_a_of_type_Ajva.c.setImageResource(2130839760);
      ((View)this.jdField_a_of_type_ComTencentQqliveMediaplayerViewIVideoViewBase).setOnTouchListener(new ajul(this));
      this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.mRuntime.a().findViewById(2131363226).setVisibility(8);
    ...
    this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.mRuntime.a().findViewById(2131363226).setVisibility(0);
    if (((ViewGroup)this.jdField_a_of_type_ComTencentMobileqqVashealthHealthBusinessPlugin.mRuntime.a().findViewById(16908290).getParent().getParent()).getChildAt(1) != null) {
    ...
    this.jdField_a_of_type_Ajva.c.setImageResource(2130839759);
