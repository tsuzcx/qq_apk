...
public class ldb
{
  ...
  public ldb(VideoAppInterface paramVideoAppInterface)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Long = moi.a().n;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          str2 = locallff.e;
          i = locallff.F;
          j = locallff.jdField_d_of_type_Int;
          bool1 = locallff.N;
          bool2 = locallff.P;
          bool3 = locallff.g;
  ...
  public void a()
  {
    ...
    {
      ldc.a(true, System.currentTimeMillis() - this.jdField_b_of_type_Long);
      ...
      {
        localObject = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a();
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(((lff)localObject).j, ((lff)localObject).jdField_d_of_type_JavaLangString, ((lff)localObject).f);
      }
    }
    a(true);
    d();
  ...
  public void a(int paramInt)
  {
    ...
    {
      this.d = false;
      ldc.a(paramInt, System.currentTimeMillis() - this.jdField_c_of_type_Long);
    }
    a(false);
    f();
  }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject3 = lcb.a(j, (String)localObject1, new int[0]);
        localObject3 = lcb.a().a((String)localObject3, false);
        ((lff)localObject3).j = 0;
        ((lff)localObject3).jdField_d_of_type_JavaLangString = ((String)localObject1);
        ((lff)localObject3).e = ((String)localObject2);
        ((lff)localObject3).F = j;
        ((lff)localObject3).ai = true;
        ((lff)localObject3).i = l2;
        ((lff)localObject3).a(l3, "recoverLastCallIfNeed", 1);
        ((lff)localObject3).S = true;
        ((lff)localObject3).N = bool1;
        ((lff)localObject3).g = bool3;
        ...
        if (lzq.f())
        {
          lzq.a(l3, 1, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp(), false, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), false);
          localObject1 = ((VideoController)localObject2).a;
          if (localObject1 != null) {
            ((mur)localObject1).a("DEVICE_SPEAKERPHONE;DEVICE_EARPHONE;DEVICE_BLUETOOTHHEADSET;DEVICE_WIREDHEADSET;");
          }
          this.jdField_c_of_type_Boolean = true;
          this.jdField_b_of_type_Long = System.currentTimeMillis();
          this.e = bool2;
          ldc.a(paramInt, paramLong, this.jdField_c_of_type_Boolean);
          return;
        }
      }
      catch (Throwable localThrowable)
      ...
      lzq.a(0L, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 2);
      continue;
      label589:
