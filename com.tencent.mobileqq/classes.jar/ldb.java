...
public class ldb
{
  ...
  public static String a(ConfigurationService.Config paramConfig, int paramInt1, int paramInt2)
  {
    ...
    while (paramInt1 < paramInt2)
    {
      ...
      else
      {
        ...
        {
          localObject1 = albw.a((byte[])localObject2);
  ...
  public static void a(int paramInt, String paramString, ConfigurationService.ConfigSeq paramConfigSeq)
  {
    ...
    for (;;)
    {
      ...
      continue;
      paramInt = bbjn.a(BaseApplicationImpl.getContext());
      paramConfigSeq.version.set(paramInt);
      paramConfigSeq.compress.set(1);
    }
  }
  ...
  public static void b(int paramInt, String paramString, ConfigurationService.Config paramConfig)
  {
    ...
    for (;;)
    {
      ...
      if (paramConfig != null)
      {
        ...
        if (paramConfig != null)
        {
          lpv.a(localQQAppInterface.getApplication(), paramConfig, k, true);
          paramString = paramConfig;
          continue;
          i = bbjn.a(localQQAppInterface.getApplication());
          paramConfig = a(paramConfig, i, paramInt);
          paramString = paramConfig;
          paramInt = i;
          if (paramConfig != null)
          {
            bbjn.a(localQQAppInterface.getApplication(), k);
            paramString = bbjn.c(localQQAppInterface.getCurrentAccountUin());
            if (paramString != null) {
