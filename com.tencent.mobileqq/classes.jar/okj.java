...
public class okj
  implements Runnable
{
  public okj(EditVideoPlayer paramEditVideoPlayer, int paramInt1, int paramInt2) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Int > this.b) {
        this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoPlayer.b.post(new okk(this));
      }
