...
public class okj
{
  ...
  private static String a(String paramString1, String paramString2)
  {
    ...
    paramString1 = qpb.a().a(paramString2);
    return paramString1;
  }
  ...
  public static void a(@NonNull Activity paramActivity, @NonNull Intent paramIntent)
  {
    ...
    rwv.a(paramActivity, localBundle, paramIntent.getStringExtra("pushRowKey"), 27);
  ...
  public static void a(@NonNull Activity paramActivity, @NonNull Intent paramIntent, int paramInt)
  {
    ...
    localBundle.putInt("RETURN_SCENE", paramIntent.getIntExtra("return_scene", 0));
    localBundle.putInt("REPORT_VIDEO_FEEDS_CHANNEL_ID", a(paramIntent));
    if ((paramInt != 1) || (bkwt.a(localBundle))) {
      ozh.a(32);
    }
    bkwt.a(paramActivity, 3, paramInt, localBundle, a(paramIntent));
  ...
  private static void a(Activity paramActivity, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      ...
      rwv.a(paramActivity, null, true, i);
      return;
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo1, ArticleInfo paramArticleInfo2, boolean paramBoolean)
  {
    ...
    localIntent.putExtra("channel_name", amtj.a(2131712129));
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    ...
    //   145: iconst_0
    //   146: invokestatic 599	odq:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    //   149: aload_0
    //   150: ldc_w 600
    //   153: getstatic 604	paa:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   156: iconst_0
    //   157: iload_2
    //   158: aload_1
    //   159: invokestatic 444	okj:a	(Landroid/content/Context;ILjava/lang/String;IILjava/util/Map;)V
    //   162: return
    //   163: astore 5
    //   165: aconst_null
    //   166: astore_1
  ...
  public static void a(Context paramContext, String paramString1, int paramInt, String paramString2, boolean paramBoolean)
  {
    ...
    localIntent.putExtra("big_brother_source_key", pay.f(paramInt));
    localIntent.putExtra("launch_app_time", System.currentTimeMillis());
    paramString1 = new okk(new WeakReference(paramContext), paramBoolean, paramString2, paramString1);
    jdField_a_of_type_Int = apdi.a().a(paramString1);
  ...
  public static void a(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    {
      boolean bool2 = bfwv.a(paramContext, str1);
  ...
  public static Intent b(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    try
    {
      ...
      if (TextUtils.isEmpty(paramContext))
      {
        ...
        if (str2 != null) {
          localArticleInfo.mArticleContentUrl = new String(bfuc.decode(str2, 0));
        }
        if (localObject != null) {
          ...
          for (;;)
          {
            try
            {
              ...
              if ("nativeArticleRecommend".equalsIgnoreCase(str14))
              {
                ...
                rwv.a((Activity)paramContext, (Bundle)localObject, i, str5, j, str7, k, m, n, str11, str3, paramHashMap, str13, str12, 0L, false, 0L, 0, null, null, null, null, null);
                return;
              }
            }
            catch (Exception paramContext)
  ...
  public static void c(Context paramContext, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramContext)) {
          bkwm.a("DAILY_CHILD_FEEDS_REQUEST_CONFIG" + str1, paramContext);
        }
