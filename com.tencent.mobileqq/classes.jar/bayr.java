  ...
  implements Manager
{
  ...
  public bayr(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Bayt = new bayt(this, null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Bayt);
    this.jdField_a_of_type_Bays = new bays(this, null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Bays);
    this.jdField_a_of_type_Bayu = new bayu(this, null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bayu);
  ...
  private void a(int paramInt, Object paramObject, boolean paramBoolean, Object... paramVarArgs)
  {
    ...
    Object localObject;
    boolean bool1;
    if (((paramObject instanceof bayn)) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      localObject = (bayn)paramObject;
      if ((TextUtils.isEmpty(((bayn)localObject).a)) || (!((bayn)localObject).a.equals((String)paramVarArgs[0]))) {
        break label272;
      }
      bool1 = true;
    }
    for (;;)
    {
      ...
      return;
      if (((paramObject instanceof baym)) && (paramVarArgs != null) && (paramVarArgs.length > 1))
      {
        localObject = (baym)paramObject;
        bool1 = bool2;
        if (!TextUtils.isEmpty(((baym)localObject).a))
        {
          bool1 = bool2;
          if (((baym)localObject).a.equals((String)paramVarArgs[1])) {
            bool1 = true;
          }
        }
      }
      ...
      {
        if (((paramObject instanceof bayo)) && (paramVarArgs != null) && (paramVarArgs.length > 1))
        {
          localObject = (bayo)paramObject;
          if ((!TextUtils.isEmpty(((bayo)localObject).a)) && (((bayo)localObject).a.equals((String)paramVarArgs[1])))
          {
            bool1 = true;
            continue;
          }
  ...
  public String a(FaceInfo paramFaceInfo)
  {
    ...
    if (bbbm.a()) {
      localStringBuilder.append(ajsd.bK);
    }
    for (;;)
    {
    ...
    if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0)) {
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if (localIterator.hasNext()) {
          a(paramInt, (bayl)localIterator.next(), paramBoolean, paramVarArgs);
        }
      }
    }
  }
  ...
  public void a(FaceInfo paramFaceInfo)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 220	bayr:jdField_a_of_type_ComTencentMobileqqAppNearByFaceDownloader	Lcom/tencent/mobileqq/app/NearByFaceDownloader;
    //   6: astore_2
    //   7: aload_2
    //   8: ifnonnull +18 -> 26
    //   11: aload_0
    ...
    //   15: dup
    //   16: aload_0
    //   17: getfield 39	bayr:jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface	Lcom/tencent/mobileqq/nearby/NearbyAppInterface;
    ...
    //   23: putfield 220	bayr:jdField_a_of_type_ComTencentMobileqqAppNearByFaceDownloader	Lcom/tencent/mobileqq/app/NearByFaceDownloader;
    //   26: aload_0
    //   27: getfield 220	bayr:jdField_a_of_type_ComTencentMobileqqAppNearByFaceDownloader	Lcom/tencent/mobileqq/app/NearByFaceDownloader;
    //   30: ifnull +11 -> 41
    //   33: aload_0
    //   34: getfield 220	bayr:jdField_a_of_type_ComTencentMobileqqAppNearByFaceDownloader	Lcom/tencent/mobileqq/app/NearByFaceDownloader;
    //   37: aload_1
      ...
      if ((paramObject instanceof bayl)) {
        synchronized (this.jdField_a_of_type_JavaUtilList)
        {
          if (!this.jdField_a_of_type_JavaUtilList.contains(paramObject)) {
            this.jdField_a_of_type_JavaUtilList.add((bayl)paramObject);
          }
          return;
        }
      }
      if ((paramObject instanceof bayk)) {
        synchronized (this.b)
        {
          if (!this.b.contains(paramObject)) {
            this.b.add((bayk)paramObject);
          }
          return;
        }
      }
    } while (!(paramObject instanceof bayp));
    synchronized (this.c)
    {
      if (!this.c.contains(paramObject)) {
        this.c.add((bayp)paramObject);
      }
      return;
    }
  }
  ...
  public final void b(int paramInt, boolean paramBoolean, Object... paramVarArgs)
  {
    if ((this.b != null) && (this.b.size() > 0)) {
      synchronized (this.b)
      {
        ...
        if (localIterator.hasNext()) {
          a(paramInt, (bayk)localIterator.next(), paramBoolean, paramVarArgs);
        }
      }
    }
  }
  ...
  public final void c(int paramInt, boolean paramBoolean, Object... paramVarArgs)
  {
    if ((this.c != null) && (this.c.size() > 0)) {
      synchronized (this.c)
      {
        ...
        if (localIterator.hasNext()) {
          a(paramInt, (bayp)localIterator.next(), paramBoolean, paramVarArgs);
        }
      }
    }
  }
  ...
  public void onDestroy()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Bayt);
      this.b.clear();
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Bays);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Bayu);
    }
  }
}
