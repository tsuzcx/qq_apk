  ...
  implements VideoPreDownloadMgr.PreDownloadController
{
  ...
  public mgl(ReadInJoyBaseAdapter paramReadInJoyBaseAdapter) {}
  ...
  public List a(int paramInt, boolean paramBoolean)
  {
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter.getCount()))
    {
      ...
      do
      {
        ...
        i = 1;
        break;
        localArrayList.add(new VideoPreDownloadMgr.VideoPreDownloadParam(localBaseArticleInfo.mVideoVid, localBaseArticleInfo.innerUniqueID, localBaseArticleInfo.busiType));
        i += 1;
        if (!paramBoolean) {
          break label331;
        }
