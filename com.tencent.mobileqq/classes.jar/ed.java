  ...
  extends BaseAdapter
{
  ...
  private void b()
  {
    ...
    while (i < 3)
    {
      ...
      this.jdField_a_of_type_ArrayOfComDatalineUtilWidgetAsyncImageView[i].setDefaultImage(2130850731);
      ...
      this.jdField_a_of_type_ArrayOfComDatalineUtilWidgetAsyncImageView[i].setContentDescription(anni.a(2131701542));
      i += 1;
    }
  }
  ...
  public void a()
  {
    ...
    if (i < 3)
    {
      ...
      if (localDataLineMsgRecord == null) {
        localAsyncImageView.setImageResource(2130850731);
      }
      for (;;)
      {
        i += 1;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      ((AsyncImageView)localObject).setImageResource(2130850731);
    }
    String str = atwe.c(localDataLineMsgRecord.path);
    if ((str != null) && (new VFSFile(str).exists())) {
