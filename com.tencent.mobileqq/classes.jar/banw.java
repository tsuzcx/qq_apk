...
public class banw
  extends beez
{
  public banw(PendantInfo paramPendantInfo, Looper paramLooper, Handler.Callback paramCallback)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      if (this.a.r == 0)
      {
        this.a.jdField_a_of_type_Banx = null;
        return;
        label435:
        localBitmap.recycle();
      ...
      if (PendantInfo.g == l)
      {
        ...
        {
          localObject = (Drawable)paramMessage.next();
          if ((localObject != null) && ((localObject instanceof acow))) {
            this.a.a((acow)localObject, l);
          }
        }
        break;
      }
      paramMessage = (Drawable)this.a.jdField_a_of_type_ComTencentMobileqqVasPendantInfo$AnimationLruCache.get(Long.valueOf(l));
      if ((paramMessage == null) || (!(paramMessage instanceof acow))) {
        break;
      }
      this.a.a((acow)paramMessage, l);
      return;
    }
  }
}
