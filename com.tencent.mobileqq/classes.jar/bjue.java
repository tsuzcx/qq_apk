  ...
  extends BaseAdapter
{
  ...
  public bjue(EditVideoArtFilter paramEditVideoArtFilter, Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_Int = bkht.a(this.jdField_a_of_type_AndroidContentContext, 120.0F);
    this.b = bkht.a(this.jdField_a_of_type_AndroidContentContext, 90.0F);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      return localView1;
      paramViewGroup = (bjuf)paramView.getTag();
    ...
    if (paramView == null)
    {
      ...
      paramView = bawu.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoArtFilter.jdField_a_of_type_AndroidContentContext.getResources(), 2130841057, this.b, this.jdField_a_of_type_Int);
    ...
    if (paramInt == 0) {
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(ajyc.a(2131703816));
    }
    for (;;)
    {
      if (paramInt != this.c) {
      ...
      break;
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(ajyc.a(2131703919) + localvkb.c);
    }
    label305:
