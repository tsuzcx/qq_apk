...
public class bcmt
  extends BaseAdapter
{
  public bcmt(GridListView paramGridListView) {}
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new bcmr(null));
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    if (this.a.jdField_a_of_type_Int == 0) {
      return this.a.jdField_a_of_type_Bcms.getItemViewType(paramInt) + 2;
    }
    return 1;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      bcmr localbcmr = (bcmr)paramView.getTag();
      ...
      paramViewGroup = localbcmr.a[paramInt];
      int k = this.a.jdField_a_of_type_Bcms.b(j + paramInt);
      if ((paramViewGroup != null) && (((Integer)paramViewGroup.getTag(2131361822)).intValue() != k)) {
        paramViewGroup = null;
      }
      for (;;)
      {
        View localView = this.a.jdField_a_of_type_Bcms.getView(j + paramInt, paramViewGroup, paramView);
        localView.setTag(2131361822, Integer.valueOf(k));
        localbcmr.a[paramInt] = localView;
        ...
        if ((this.a.jdField_a_of_type_Bfpt != null) && (this.a.jdField_a_of_type_Bcms.isEnabled(j + paramInt)))
        {
        ...
        i = this.a.jdField_a_of_type_Bcms.a(paramInt) + 2;
        ...
        paramView = this.a.jdField_a_of_type_Bcms.getView(paramInt, (View)localObject, paramViewGroup);
        paramView.setTag(2131361822, Integer.valueOf(i));
        if ((this.a.jdField_a_of_type_Bfpt != null) && (this.a.jdField_a_of_type_Bcms.isEnabled(paramInt)))
        {
