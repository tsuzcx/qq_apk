  ...
  extends ProtocolDownloader.Adapter
{
  ...
  public static Drawable a(Context paramContext, HotVideoData paramHotVideoData)
  {
    ...
    paramHotVideoData = auie.a(paramHotVideoData, 10.0F, paramContext);
  ...
  private void a(File paramFile, HotVideoData paramHotVideoData, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    paramFile = new bgoe(paramHotVideoData.url.replaceFirst("https", "http"), localFile);
    paramFile.n = true;
    paramFile.b = 2;
    int i = bgog.a(paramFile, null, null);
    if (i == 0)
    {
      paramFile = ayja.a(localFile.getAbsolutePath());
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    paramURLDrawableHandler = ayja.a(paramFile.getAbsolutePath());
  ...
  public File loadImageFile(DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    {
      paramDownloadParams.GetPreviewURLAsync((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), 0, "0", new auid(this, paramDownloadParams, localFile, paramURLDrawableHandler));
      return localFile;
    }
