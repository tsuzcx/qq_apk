  ...
  implements wef
{
  ...
  public HashMap<String, WeakReference<xsy>> a;
  public List<HotSortVideoEntry> a;
  xtg a;
  protected boolean a;
  protected boolean b;
  
  public xsw(Context paramContext, boolean paramBoolean)
  {
    super(paramContext);
  ...
  private static void b(ImageView paramImageView, int paramInt, String paramString)
  {
    if (paramImageView == null) {
      ykq.e("Q.qqstory.shareGroup.ShareGroupsListAdapter", "update imageView error. imageView is null.");
    }
    do
    {
      return;
    ...
    UIUtils.setCircleViewByURL(paramImageView, zfe.a(paramString), 80, 80, null, "StoryDiscoverHeadImage");
  }
  ...
  protected View a(int paramInt, ViewGroup paramViewGroup)
  {
    ...
    if (paramInt == 1)
    {
      localView = localLayoutInflater.inflate(2131561790, paramViewGroup, false);
      localView.setTag(new xsy(localView, this));
    }
    do
    {
      return localView;
      if (paramInt == 0)
      {
        paramViewGroup = localLayoutInflater.inflate(2131561725, paramViewGroup, false);
        paramViewGroup.setTag(new xtd(paramViewGroup, this));
        return paramViewGroup;
      }
      if (paramInt == 2)
      {
        paramViewGroup = localLayoutInflater.inflate(2131561789, paramViewGroup, false);
        paramViewGroup.setTag(new xtc(paramViewGroup, this));
        return paramViewGroup;
      }
    } while (paramInt != 7);
    paramViewGroup = localLayoutInflater.inflate(2131561786, paramViewGroup, false);
    paramViewGroup.setTag(new xtb(paramViewGroup, this));
    return paramViewGroup;
  }
  ...
  public void a(String paramString, List<yap> paramList)
  {
    ...
    if ((paramList != null) && (paramList.get() != null))
    {
      ...
      ((xsy)paramList.get()).a.setData(localVideoCollectionItem);
    }
    label55:
    while (!QLog.isColorLevel()) {
      return;
