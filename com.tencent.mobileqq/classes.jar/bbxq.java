  ...
  extends aber
{
  ...
  private static ConcurrentHashMap<String, bhhm> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  
  public static void a(bhhm parambhhm, String paramString)
  {
    jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, parambhhm);
  }
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    else
    {
      ...
      if (jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(bhhm.a(paramToServiceMsg)))
      {
        paramToServiceMsg = ((bhhm)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(bhhm.a(paramToServiceMsg))).a(paramToServiceMsg, paramFromServiceMsg, localUniPacket);
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    } while (!jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(bhhm.a(paramToServiceMsg)));
    Object localObject = (bhhm)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(bhhm.a(paramToServiceMsg));
    int i = jdField_a_of_type_Int;
    jdField_a_of_type_Int = i + 1;
    ((bhhm)localObject).a(paramToServiceMsg, paramUniPacket, i);
    return true;
  }
