...
public class bigl
{
  ...
  private static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, bigw parambigw, int paramInt)
  {
    paramActivity = new FreeWifiHelper.5(paramActivity, paramString1, paramString2, paramString3, paramString4, new bigp(paramInt, paramActivity, parambigw), new bigq(parambigw, paramInt), new bigr(parambigw, paramInt), paramInt);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = bihb.a(localBaseApplication, str);
        if (QLog.isColorLevel()) {
      ...
      return;
      long l = bihb.c(localBaseApplication, str);
    ...
    Object localObject = new anyn(paramQQAppInterface);
    anyo localanyo = new anyo(paramQQAppInterface);
    localanyo.a(new bign(paramQQAppInterface, localanyo));
    paramQQAppInterface.addObserver(localanyo);
    ((anyn)localObject).a(2);
    bihb.c(localBaseApplication, str, System.currentTimeMillis());
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, ConfigurationService.Config paramConfig)
  {
    ...
    int j = bgsg.a(paramQQAppInterface.getApp(), "wifi_connect_config_version", str);
    if (QLog.isColorLevel()) {
    ...
    if (i != j)
    {
      bgsg.a(paramQQAppInterface.getApp(), "wifi_connect_config_version", str, i);
      ...
      if (!TextUtils.isEmpty(paramConfig))
      {
        ...
        try
        {
          ...
          {
            e = bool;
            bgsg.a(paramQQAppInterface.getApp(), paramQQAppInterface.c(), c, d, e);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    try
    {
      if (((d) || (e)) && (Conversation.b > 0L))
      {
        ...
        long l2 = bihb.a((Context)localObject, str);
        long l3 = bihb.b((Context)localObject, str) * 60 * 60 * 1000L;
        if (QLog.isColorLevel()) {
        ...
        bihb.a((Context)localObject, str, l1);
        anyn localanyn = new anyn(paramQQAppInterface);
        anyo localanyo = new anyo(paramQQAppInterface);
        localanyo.a(new bigm((Context)localObject, str, paramQQAppInterface, localanyo));
        paramQQAppInterface.addObserver(localanyo);
        localanyn.a(1);
      }
    }
  ...
  public static boolean a(Activity paramActivity, int paramInt, bigw parambigw)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        str1 = paramActivity.getString(2131692369);
        str2 = paramActivity.getString(2131692372);
        i = 1;
      }
      while (i != 0)
      {
        String str5 = paramActivity.getString(2131692375);
        String str4 = bihb.a(paramActivity);
        String str3 = str4;
        if (TextUtils.isEmpty(str4)) {
          str3 = paramActivity.getString(2131692368);
        }
        QLog.i("WifiSdk", 2, "shouldOverrideDialog btn1Text: " + str3);
        a(paramActivity, str5, str1, str3, str2, parambigw, paramInt);
        return false;
        if ((paramInt == 2) || (paramInt == 4))
        {
          str1 = paramActivity.getString(2131692371);
          str2 = paramActivity.getString(2131692374);
          i = 1;
        }
        else if (paramInt == 3)
        {
          str1 = paramActivity.getString(2131692370);
          str2 = paramActivity.getString(2131692373);
          i = 1;
        }
        else if (paramInt == 5)
        {
          str1 = paramActivity.getString(2131692324);
          str2 = paramActivity.getString(2131692374);
          i = 1;
        }
        else
  ...
  public static boolean a(Context paramContext)
  {
    ...
    try
    {
      ...
      if (!TMSDKWifiManager.init(paramContext.getApplicationContext(), new TMSDKCustomConfig().setCustomToast(new bigv()).setCustomInstaller(new bigu()).setCustomThreadPool(new bigt()).setCustomReporter(new bigs()))) {
        bool = true;
      }
      b = bool;
      WifiSDKUIApi.init(new bigy(), new bigz());
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      str = paramQQAppInterface.getCurrentAccountUin();
      localBaseApplication = paramQQAppInterface.getApp();
      long l = bihb.b(localBaseApplication, str);
      if ((l == -1L) || (System.currentTimeMillis() - l >= 86400000L)) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    anyn localanyn = new anyn(paramQQAppInterface);
    anyo localanyo = new anyo(paramQQAppInterface);
    localanyo.a(new bigo(paramQQAppInterface, localanyo));
    paramQQAppInterface.addObserver(localanyo);
    localanyn.a(3);
    bihb.b(localBaseApplication, str, System.currentTimeMillis());
  }
  ...
  public static void c(Context paramContext, int paramInt)
  {
    ...
    biha localbiha = biha.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
    if (QLog.isColorLevel()) {
      QLog.i("WifiSdk", 2, "dialog click, jumpType: " + localbiha.jdField_a_of_type_Int + " jumpUrl: " + localbiha.jdField_a_of_type_JavaLangString);
    }
    if (WifiSDKUIApi.isWiFiManagerExist())
    {
      if (localbiha.jdField_a_of_type_Int == 4)
      {
    ...
    switch (localbiha.jdField_a_of_type_Int)
    {
    case 4: 
    default: 
      a(paramContext, paramInt);
      ...
      return;
    case 1: 
      a(paramContext, localbiha.jdField_a_of_type_JavaLangString);
