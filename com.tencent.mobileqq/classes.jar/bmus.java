  ...
  extends MSFServlet
{
  public static void a(long paramLong, int paramInt1, String paramString, int paramInt2, qq_ad_get.QQAdGet.DeviceInfo paramDeviceInfo)
  {
    try
    {
      ...
      paramDeviceInfo = new NewIntent(paramString.getApplication(), bmus.class);
      paramDeviceInfo.putExtra("data", bguc.a(localVacAdvReq.toByteArray()));
  ...
  public static void a(bmtu parambmtu, qq_ad_get.QQAdGet.DeviceInfo paramDeviceInfo)
  {
    if (parambmtu == null) {
      return;
    }
    for (;;)
    {
      try
      {
        ...
        if (parambmtu.jdField_a_of_type_JavaLangString == null)
        {
          str = "";
          localPBStringField.set(str);
          localMobileAdvReportReq.adv_pos.set(parambmtu.jdField_a_of_type_Int);
          localMobileAdvReportReq.action_type.set(parambmtu.jdField_b_of_type_Int);
          localMobileAdvReportReq.action_value.set(parambmtu.d);
          localMobileAdvReportReq.feed_index.set(parambmtu.c);
          if (paramDeviceInfo != null) {
            localMobileAdvReportReq.device_info.set(paramDeviceInfo);
          }
          localMobileAdvReportReq.qq.set(parambmtu.jdField_a_of_type_Long);
          if (!TextUtils.isEmpty(parambmtu.jdField_b_of_type_JavaLangString))
          {
            paramDeviceInfo = new adv_report.SubscribeInfo();
            paramDeviceInfo.id.set(parambmtu.jdField_b_of_type_JavaLangString);
            localMobileAdvReportReq.subscribe_info.set(paramDeviceInfo);
          }
          paramDeviceInfo = new NewIntent(localAppRuntime.getApplication(), bmus.class);
          paramDeviceInfo.putExtra("data", bguc.a(localMobileAdvReportReq.toByteArray()));
          paramDeviceInfo.putExtra("cmd", "MobileAdv.AdvReport");
          if (QZLog.isColorLevel()) {
            QZLog.i("GdtGeneralServlet", " @getGdtInfo sendGdtADVReportReq " + parambmtu.toString());
          }
          localAppRuntime.startServlet(paramDeviceInfo);
          return;
        }
      }
      catch (Exception parambmtu)
      {
        QZLog.e("GdtGeneralServlet", "sendGdtADVReportReq error" + parambmtu.toString());
        return;
      }
      String str = parambmtu.jdField_a_of_type_JavaLangString;
    }
  }
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    try
    {
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        {
          bmup.a().a(i, paramFromServiceMsg);
          return;
        }
  ...
  public void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    try
    {
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        bgva.a(new byte[i], 0, paramFromServiceMsg.getWupBuffer(), 4, i);
      }
      return;
    }
    catch (Exception paramIntent)
