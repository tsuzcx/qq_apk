...
public final class wlg
{
  ...
  public static boolean a(Context paramContext, yml paramyml)
  {
    if (paramyml == null) {
      return false;
    }
    return a(paramContext, String.valueOf(paramyml.jdField_a_of_type_Long), String.valueOf(paramyml.jdField_a_of_type_Int));
  }
