...
public class bfyq
  implements bhuk
{
  public bfyq(QidianProfileCardActivity paramQidianProfileCardActivity, String paramString) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        if (this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity.jdField_a_of_type_Bfyh.d(this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity.jdField_a_of_type_Awqt.a.jdField_a_of_type_JavaLangString)) {
