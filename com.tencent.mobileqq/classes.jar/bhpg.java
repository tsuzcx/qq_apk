...
public class bhpg
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "[PhotoAlbum]" + bhpg.class.getSimpleName();
  ...
  public static Rect a(View paramView)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23) {
      try
      {
        paramView = bhnv.a(paramView, "getRootWindowInsets", false, null, null);
        QZLog.d(jdField_a_of_type_JavaLangString, 1, new Object[] { "insets:", paramView });
        Object localObject3 = bhnv.a(paramView, "getDisplayCutout", false, null, null);
        if (localObject3 == null)
        {
          QZLog.d(jdField_a_of_type_JavaLangString, 1, "displayCutout == null");
          return localRect;
        }
        paramView = bhnv.a(localObject3, "getSafeInsetTop", false, null, null);
        Object localObject1 = bhnv.a(localObject3, "getSafeInsetBottom", false, null, null);
        Object localObject2 = bhnv.a(localObject3, "getSafeInsetLeft", false, null, null);
        localObject3 = bhnv.a(localObject3, "getSafeInsetRight", false, null, null);
  ...
  public static boolean b(Context paramContext)
  {
    try
    {
      paramContext = bhnv.a("android.util.FtFeature", "isFeatureSupport", false, bhpj.a().a(new Class[] { Integer.TYPE }), new Object[] { Integer.valueOf(32) });
  ...
  public static boolean e(Context paramContext)
  {
    try
    {
      paramContext = bhnv.a("smartisanos.api.DisplayUtilsSmt", "isFeatureSupport", false, bhpj.a().a(new Class[] { Integer.TYPE }), new Object[] { Integer.valueOf(1) });
      if ((paramContext instanceof Boolean))
      {
        boolean bool = ((Boolean)paramContext).booleanValue();
        return bool;
