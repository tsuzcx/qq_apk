...
public class qcn
{
  ...
  {
    if (bgmq.b(paramAppRuntime, "VIDEO_FEEDS_SOFT_AD_LOCAL_CONFIG_DATE")) {
  ...
  {
    if (((paramView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) && (paramView.getTag(2131297012) == null))
    {
      ...
      localValueAnimator.addUpdateListener(new qct(i, localMarginLayoutParams, j, paramView));
      localValueAnimator.addListener(new qcu(paramView));
      paramView.setTag(2131297012, localValueAnimator);
  ...
  private static Drawable a(Context paramContext)
  {
    ...
    localGradientDrawable.setCornerRadius(aciy.a(3.0F, paramContext.getResources()));
  ...
  public static Long a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (paramBaseArticleInfo.busiType == 6)
    {
      if (qoe.a((ArticleInfo)paramBaseArticleInfo)) {
        return Long.valueOf(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Pqo.jdField_a_of_type_Long);
      }
      return Long.valueOf(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Pre.jdField_a_of_type_Long);
    }
  ...
  public static String a(int paramInt)
  {
    ...
    return f(paramInt) + ajjy.a(2131650366);
  }
  ...
  {
    return bcdu.d(paramQQAppInterface.getCurrentAccountUin() + "_" + paramString + "_" + System.currentTimeMillis());
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramBoolean = odw.a(localBundle.getInt("VIDEO_FROM_TYPE", -1));
        for (;;)
        {
          if (!paramBoolean) {
            break label212;
          ...
          if (paramBundle != null) {
            paramBoolean = odw.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), paramBundle.jdField_b_of_type_Int, paramBundle.jdField_c_of_type_Int, paramBundle.jdField_d_of_type_Int);
          } else {
            paramBoolean = odw.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), Integer.valueOf(localBundle.getString("VIDEO_WIDTH")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_HEIGHT")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_TIME")).intValue());
          }
        }
      }
  ...
  {
    a(paramContext, paramTextView, ajjy.a(2131650412), ajjy.a(2131650417), bati.a("kandian"), null);
  }
  ...
  public static void a(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, View.OnClickListener paramOnClickListener)
  {
    ...
    paramString1.setSpan(new qco(paramString3, paramContext, paramOnClickListener), i, j, 33);
  ...
  public static void a(Context paramContext, UrlJumpInfo paramUrlJumpInfo)
  {
    if ((paramUrlJumpInfo != null) && (paramContext != null))
    {
      ...
      if (!TextUtils.isEmpty(paramUrlJumpInfo.jdField_a_of_type_JavaLangString)) {
        obz.a(paramContext, paramUrlJumpInfo.jdField_a_of_type_JavaLangString);
      }
    }
    for (;;)
    {
      ...
      {
        if (!nji.a(paramUrlJumpInfo.jdField_b_of_type_JavaLangString))
        {
          if (!QLog.isColorLevel()) {
            break;
          }
        ...
        if (bady.a(paramContext, paramUrlJumpInfo.jdField_b_of_type_JavaLangString)) {
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      int i = aciy.a(16.0F, paramContext.getResources());
      localTextView.setPadding(i, 0, i, 0);
      paramString = new Dialog(paramContext, 2131689774);
      paramString.setContentView(localTextView, new ViewGroup.LayoutParams(-2, azvv.a(paramContext, 40.0F)));
  ...
  public static void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ...
        localObjectAnimator.addListener(new qda(paramView));
        localObjectAnimator.start();
        return;
      }
    ...
    localObjectAnimator.start();
    paramView.setLayerType(2, null);
    localObjectAnimator.addListener(new qdb(paramView));
    localObjectAnimator.start();
  }
  ...
  public static void a(View paramView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      if (paramInt2 == 0)
      {
        ...
        paramView.setLayerType(2, null);
        localObjectAnimator2.addListener(new qcy(paramView));
    ...
    localObjectAnimator1.setRepeatCount(0);
    paramView.setLayerType(2, null);
    localObjectAnimator1.addListener(new qcz(paramView));
  ...
  public static void a(View paramView1, View paramView2, int[] paramArrayOfInt, Animator.AnimatorListener paramAnimatorListener)
  {
    ...
    paramArrayOfInt = ValueAnimator.ofObject(new pyc(), new Object[] { new Point(paramView2.getWidth(), paramView2.getHeight()), new Point(paramArrayOfInt[0], paramArrayOfInt[1]) });
    paramArrayOfInt.addUpdateListener(new qcx(paramView2, paramView1));
    paramView1 = ObjectAnimator.ofFloat(paramView2, "translationX", new float[] { paramView2.getTranslationX(), -bajq.a(6.0F) });
    paramView2 = ObjectAnimator.ofFloat(paramView2, "translationY", new float[] { paramView2.getTranslationY(), -bajq.a(60.0F) });
  ...
  public static void a(ViewGroup paramViewGroup1, ViewGroup paramViewGroup2, WindowManager paramWindowManager, WindowManager.LayoutParams paramLayoutParams, Animator.AnimatorListener paramAnimatorListener)
  {
    ...
    ValueAnimator localValueAnimator = ValueAnimator.ofObject(new pyc(), new Object[] { new Point(0, 0), new Point((int)babp.i() - i, (int)babp.j() - j) });
    localValueAnimator.addUpdateListener(new qcv(paramViewGroup2, i, j));
    paramViewGroup2 = ValueAnimator.ofObject(new pyc(), new Object[] { new Point(paramLayoutParams.x, paramLayoutParams.y), new Point(0, 0) });
    paramViewGroup2.addUpdateListener(new qcw(paramWindowManager, paramViewGroup1, paramLayoutParams));
    ...
    if (paramVideoInfo.jdField_a_of_type_Int != 0)
    {
      if (paramVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo == null)
      {
        ...
        if (paramVideoInfo.jdField_b_of_type_Boolean)
        {
          ...
          localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Pre.b = new ArrayList();
          prg localprg = new prg();
          localprg.h = paramVideoInfo.jdField_f_of_type_JavaLangString;
          localprg.e = paramVideoInfo.jdField_c_of_type_JavaLangString;
          localprg.jdField_d_of_type_JavaLangString = paramVideoInfo.jdField_b_of_type_JavaLangString;
          localprg.jdField_a_of_type_Long = paramVideoInfo.jdField_d_of_type_Int;
          localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Pre.b.add(localprg);
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    ((nec)paramQQAppInterface.a(155)).a(paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    qcr localqcr = new qcr(paramString, paramBoolean);
    if (paramBoolean) {}
    for (int i = 2;; i = 1)
    {
      localoqv.a(paramQQAppInterface, paramString, true, localqcr, i);
      return;
    }
  }
  ...
  public static void a(String paramString1, String paramString2, TextView paramTextView)
  {
    if (!TextUtils.isEmpty(paramString1))
    {
      ...
      try
      {
        nzq.a(paramTextView, paramString1);
  ...
  {
    bgmq.x(paramAppRuntime, paramInt);
  }
  
  public static void a(AppRuntime paramAppRuntime, Activity paramActivity)
  {
    if (onp.a(paramActivity, true)) {
      babr.a(paramActivity, 230, paramActivity.getString(2131652787), paramActivity.getString(2131652786), 2131625035, 2131652785, new qcs(), null).setMessageCount(null).show();
    }
  }
  ...
  public static boolean a(Activity paramActivity, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (i == 1)
    {
      if (obz.a(paramBaseArticleInfo.bytes_jump_url))
      {
        obz.a(paramActivity, obz.a(paramBaseArticleInfo.bytes_jump_url));
        return true;
      }
    }
    else if ((i == 2) && (obz.a(paramBaseArticleInfo.bytes_jump_bundle)) && (bady.a(paramActivity, obz.a(paramBaseArticleInfo.bytes_jump_bundle))))
    {
      a(paramActivity, obz.a(paramBaseArticleInfo.bytes_jump_schema));
      return true;
    }
    return false;
  }
  ...
  {
    String str = oag.a(paramBaseArticleInfo);
    if (!TextUtils.isEmpty(str))
    {
      if (pol.a(str))
      {
        obz.a(paramContext, paramBaseArticleInfo, str);
        return true;
      }
      a(paramContext, str);
      return true;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    try
    {
      boolean bool = ogy.a().b(Long.valueOf(paramLong));
      return bool;
    }
  ...
  public static String b(int paramInt)
  {
    ...
    return f(paramInt) + ajjy.a(2131650411);
  }
  ...
  public static void b(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, View.OnClickListener paramOnClickListener)
  {
    ...
    paramString1 = new SpannableString(paramString1);
    paramString1.setSpan(new qcp(paramTextView), i, j, 33);
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
    paramTextView.setText(paramString1);
    paramTextView.setOnClickListener(new qcq(paramString3, paramContext, paramOnClickListener));
  }
  ...
  public static void b(View paramView, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ...
        localAlphaAnimation.setAnimationListener(new qdc(paramView));
    ...
    localAlphaAnimation.setDuration(paramInt2);
    localAlphaAnimation.setFillAfter(true);
    localAlphaAnimation.setAnimationListener(new qdd(paramView));
    paramView.clearAnimation();
    paramView.startAnimation(localAlphaAnimation);
  }
  ...
  public static boolean b(Activity paramActivity, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    {
      if ((obz.a(paramBaseArticleInfo.bytes_jump_bundle)) && (bady.a(paramActivity, obz.a(paramBaseArticleInfo.bytes_jump_bundle))))
      {
        a(paramActivity, obz.a(paramBaseArticleInfo.bytes_jump_schema));
        return true;
      }
  ...
  {
    if (paramLong <= 0L) {
      return ajjy.a(2131650430);
    }
    return b(paramLong) + ajjy.a(2131650426);
  }
  ...
  public static String e(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt >= 10004999)
      {
        ...
        return jdField_d_of_type_JavaTextDecimalFormat.format(paramInt / 10000.0D) + ajjy.a(2131650378);
      }
      if (paramInt >= 10000)
      {
        ...
        return jdField_c_of_type_JavaTextDecimalFormat.format(paramInt / 10000.0D) + ajjy.a(2131650358);
      }
    } while (paramInt <= 0);
    return paramInt + "";
  }
  ...
  private static String f(int paramInt)
  {
    ...
    if (paramInt >= 100000000) {
      str = jdField_a_of_type_JavaTextDecimalFormat.format(paramInt / 100000000.0D) + ajjy.a(2131650405);
    }
    do
    {
      return str;
      if (paramInt >= 10000) {
        return jdField_a_of_type_JavaTextDecimalFormat.format(paramInt / 10000.0D) + ajjy.a(2131650403);
      }
    } while (paramInt < 0);
    return paramInt + "";
  }
