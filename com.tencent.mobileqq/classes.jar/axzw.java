  ...
  implements Handler.Callback, Manager
{
  ...
  private ayad jdField_a_of_type_Ayad;
  ayae jdField_a_of_type_Ayae;
  ...
  private ConcurrentHashMap<Integer, ayad> b = new ConcurrentHashMap();
  ...
  public axzw(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Ayae = new axzv(paramQQAppInterface, this);
    d();
  }
  ...
  private void a(RedTouchItem paramRedTouchItem, int paramInt)
  {
    ...
    if (localRedTouchItem == null)
    {
      ...
      ayaf.a(localRedTouchItem, paramRedTouchItem);
    ...
    do
    {
      ...
      j = ayaf.a(localRedTouchItem.redtouchType);
      k = ayaf.a(paramRedTouchItem.redtouchType);
      if (k > j)
      {
        localRedTouchItem = new RedTouchItem();
        ayaf.a(localRedTouchItem, paramRedTouchItem);
  ...
  private void a(RedTouchItem paramRedTouchItem, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Ayae.a(paramRedTouchItem, localRedPointConfig1.redPointId);
  ...
  private void d()
  {
    this.jdField_a_of_type_Ayad = new ayad();
    this.jdField_a_of_type_Ayad.jdField_a_of_type_Int = -1;
    this.b.put(Integer.valueOf(this.jdField_a_of_type_Ayad.jdField_a_of_type_Int), this.jdField_a_of_type_Ayad);
    ayad localayad1 = new ayad();
    localayad1.jdField_a_of_type_Int = 10018;
    localayad1.jdField_a_of_type_Ayad = this.jdField_a_of_type_Ayad;
    this.b.put(Integer.valueOf(localayad1.jdField_a_of_type_Int), localayad1);
    localayad1 = new ayad();
    localayad1.jdField_a_of_type_Int = -3;
    localayad1.jdField_a_of_type_Ayad = this.jdField_a_of_type_Ayad;
    this.b.put(Integer.valueOf(localayad1.jdField_a_of_type_Int), localayad1);
    localayad1.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject1 = new ayad();
    ((ayad)localObject1).jdField_a_of_type_Int = -7;
    this.b.put(Integer.valueOf(((ayad)localObject1).jdField_a_of_type_Int), localObject1);
    ((ayad)localObject1).jdField_a_of_type_Ayad = localayad1;
    localayad1.jdField_a_of_type_JavaUtilList.add(localObject1);
    ((ayad)localObject1).jdField_a_of_type_JavaUtilList = new ArrayList();
    ayad localayad2 = new ayad();
    localayad2.jdField_a_of_type_Int = -4;
    this.b.put(Integer.valueOf(localayad2.jdField_a_of_type_Int), localayad2);
    localayad2.jdField_a_of_type_Ayad = localayad1;
    localayad1.jdField_a_of_type_JavaUtilList.add(localayad2);
    localayad2.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject2 = new ayad();
    ((ayad)localObject2).jdField_a_of_type_Int = 10015;
    this.b.put(Integer.valueOf(((ayad)localObject2).jdField_a_of_type_Int), localObject2);
    ((ayad)localObject2).jdField_a_of_type_Ayad = ((ayad)localObject1);
    ((ayad)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new ayad();
    ((ayad)localObject2).jdField_a_of_type_Int = 10016;
    this.b.put(Integer.valueOf(((ayad)localObject2).jdField_a_of_type_Int), localObject2);
    ((ayad)localObject2).jdField_a_of_type_Ayad = ((ayad)localObject1);
    ((ayad)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new ayad();
    ((ayad)localObject2).jdField_a_of_type_Int = 100601;
    ((ayad)localObject2).jdField_a_of_type_Ayad = ((ayad)localObject1);
    ((ayad)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    this.b.put(Integer.valueOf(100601), localObject2);
    localObject1 = new ayad();
    ((ayad)localObject1).jdField_a_of_type_Int = 10019;
    this.b.put(Integer.valueOf(((ayad)localObject1).jdField_a_of_type_Int), localObject1);
    ((ayad)localObject1).jdField_a_of_type_Ayad = localayad2;
    localayad2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new ayad();
    ((ayad)localObject1).jdField_a_of_type_Int = 10020;
    this.b.put(Integer.valueOf(((ayad)localObject1).jdField_a_of_type_Int), localObject1);
    ((ayad)localObject1).jdField_a_of_type_Ayad = localayad2;
    localayad2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new ayad();
    ((ayad)localObject1).jdField_a_of_type_Int = 10022;
    this.b.put(Integer.valueOf(((ayad)localObject1).jdField_a_of_type_Int), localObject1);
    ((ayad)localObject1).jdField_a_of_type_Ayad = localayad2;
    localayad2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new ayad();
    ((ayad)localObject1).jdField_a_of_type_Int = 10021;
    this.b.put(Integer.valueOf(((ayad)localObject1).jdField_a_of_type_Int), localObject1);
    ((ayad)localObject1).jdField_a_of_type_Ayad = localayad2;
    localayad2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new ayad();
    ((ayad)localObject1).jdField_a_of_type_Int = 10023;
    ((ayad)localObject1).jdField_a_of_type_Ayad = localayad2;
    this.b.put(Integer.valueOf(((ayad)localObject1).jdField_a_of_type_Int), localObject1);
    localayad2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new ayad();
    ((ayad)localObject1).jdField_a_of_type_Int = 10024;
    ((ayad)localObject1).jdField_a_of_type_Ayad = localayad2;
    this.b.put(Integer.valueOf(((ayad)localObject1).jdField_a_of_type_Int), localObject1);
    localayad2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new ayad();
    ((ayad)localObject1).jdField_a_of_type_Int = 10025;
    ((ayad)localObject1).jdField_a_of_type_Ayad = localayad2;
    this.b.put(Integer.valueOf(((ayad)localObject1).jdField_a_of_type_Int), localObject1);
    localayad2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new ayad();
    ((ayad)localObject1).jdField_a_of_type_Int = 10026;
    ((ayad)localObject1).jdField_a_of_type_Ayad = localayad2;
    this.b.put(Integer.valueOf(((ayad)localObject1).jdField_a_of_type_Int), localObject1);
    localayad2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new ayad();
    ((ayad)localObject1).jdField_a_of_type_Int = 10027;
    ((ayad)localObject1).jdField_a_of_type_Ayad = localayad2;
    this.b.put(Integer.valueOf(((ayad)localObject1).jdField_a_of_type_Int), localObject1);
    localayad2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localayad2 = new ayad();
    localayad2.jdField_a_of_type_Int = -2;
    localayad2.jdField_a_of_type_Ayad = this.jdField_a_of_type_Ayad;
    this.b.put(Integer.valueOf(localayad2.jdField_a_of_type_Int), localayad2);
    this.jdField_a_of_type_Ayad.jdField_a_of_type_JavaUtilList = Arrays.asList(new ayad[] { localayad1, localayad2 });
    localayad2.jdField_a_of_type_JavaUtilList = new ArrayList();
    localObject1 = new ayad();
    ((ayad)localObject1).jdField_a_of_type_Int = 100510;
    this.b.put(Integer.valueOf(((ayad)localObject1).jdField_a_of_type_Int), localObject1);
    ((ayad)localObject1).jdField_a_of_type_Ayad = localayad2;
    localayad2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localayad1 = new ayad();
    localayad1.jdField_a_of_type_Int = 10011;
    localayad1.jdField_a_of_type_Ayad = ((ayad)localObject1);
    this.b.put(Integer.valueOf(localayad1.jdField_a_of_type_Int), localayad1);
    localObject2 = new ArrayList();
    ((List)localObject2).add(localayad1);
    ((ayad)localObject1).jdField_a_of_type_JavaUtilList = ((List)localObject2);
    localObject1 = new ArrayList();
    localObject2 = new ayad();
    ((ayad)localObject2).jdField_a_of_type_Int = 100523;
    ((ayad)localObject2).jdField_a_of_type_Ayad = localayad1;
    this.b.put(Integer.valueOf(((ayad)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localObject2 = new ayad();
    ((ayad)localObject2).jdField_a_of_type_Int = 100517;
    ((ayad)localObject2).jdField_a_of_type_Ayad = localayad1;
    this.b.put(Integer.valueOf(((ayad)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localayad1.jdField_a_of_type_JavaUtilList = ((List)localObject1);
    localayad1 = new ayad();
    localayad1.jdField_a_of_type_Int = -5;
    localayad1.jdField_a_of_type_Ayad = localayad2;
    localayad2.jdField_a_of_type_JavaUtilList.add(localayad1);
    localayad1.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localayad1.jdField_a_of_type_Int), localayad1);
    localayad1 = new ayad();
    localayad1.jdField_a_of_type_Int = -6;
    localayad1.jdField_a_of_type_Ayad = localayad2;
    localayad2.jdField_a_of_type_JavaUtilList.add(localayad1);
    localayad1.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localayad1.jdField_a_of_type_Int), localayad1);
    localObject1 = new ayad();
    ((ayad)localObject1).jdField_a_of_type_Int = 10014;
    ((ayad)localObject1).jdField_a_of_type_Ayad = localayad1;
    localayad1.jdField_a_of_type_JavaUtilList.add(localObject1);
    this.b.put(Integer.valueOf(((ayad)localObject1).jdField_a_of_type_Int), localObject1);
    localayad1 = new ayad();
    localayad1.jdField_a_of_type_Int = 10013;
    localayad1.jdField_a_of_type_Ayad = localayad2;
    localayad2.jdField_a_of_type_JavaUtilList.add(localayad1);
    this.b.put(Integer.valueOf(localayad1.jdField_a_of_type_Int), localayad1);
  }
  ...
  private void e()
  {
    ...
    a();
    ??? = (ConcurrentHashMap)bgmg.a("red_point_configs_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (??? != null)
    {
    ...
    try
    {
      ??? = (ConcurrentHashMap)bgmg.a("red_point_info_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      if (??? != null)
      {
        this.c.clear();
        this.c.putAll((Map)???);
  ...
  private void e(int paramInt)
  {
    ...
    if ((localRedTouchItem1 != null) && (localRedTouchItem1.passThroughLevel > 0))
    {
      ...
      {
        ayad localayad = (ayad)this.b.get(Integer.valueOf(i));
        if ((localayad == null) || (localayad.jdField_a_of_type_Ayad == null)) {
          break;
        }
        RedTouchItem localRedTouchItem2 = (RedTouchItem)this.c.get(Integer.valueOf(localayad.jdField_a_of_type_Ayad.jdField_a_of_type_Int));
        if (localRedTouchItem2 != null) {
          localRedTouchItem2.unReadFlag = false;
        }
        if (localayad.jdField_a_of_type_Ayad.jdField_a_of_type_JavaUtilList != null)
        {
          i = 0;
          while (i < localayad.jdField_a_of_type_Ayad.jdField_a_of_type_JavaUtilList.size())
          {
            j = ((ayad)localayad.jdField_a_of_type_Ayad.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_Int;
            ...
            if ((localRedTouchItem2 != null) && (localRedTouchItem2.unReadFlag) && (!localRedTouchItem2.isClosed) && (localRedTouchItem2.passThroughLevel > 0)) {
              a(localRedTouchItem2, localayad.jdField_a_of_type_Ayad.jdField_a_of_type_Int);
            }
            i += 1;
          }
        }
        i = localayad.jdField_a_of_type_Ayad.jdField_a_of_type_Int;
        paramInt += 1;
      }
    }
  }
  ...
  private void f()
  {
    bgmg.a("red_point_info_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.c);
  }
  ...
  private void g()
  {
    ...
    if ((localConcurrentHashMap != null) && (localConcurrentHashMap.size() > 0))
    {
      ...
      {
        ((ayag)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a(localArrayList, false);
        long l = SystemClock.elapsedRealtime();
        axdz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(l));
      }
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    ((ayag)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a();
  }
  ...
  public String a()
  {
    if (this.jdField_a_of_type_JavaLangString == null) {
      this.jdField_a_of_type_JavaLangString = ((String)axdz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", ""));
    }
    if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    if (this.jdField_a_of_type_JavaUtilVector.size() > 0)
    {
      ...
      f();
      this.jdField_a_of_type_Ayae.a(this.jdField_a_of_type_JavaUtilVector);
  ...
  public void a(int paramInt, boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      ((ayag)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a(localArrayList);
      return;
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      axdz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", paramString);
    }
  }
  ...
  public void a(cmd0x6f5.RspBody paramRspBody)
  {
    ...
    if ((paramRspBody != null) && (paramRspBody.rpt_task_info != null) && (paramRspBody.rpt_task_info.has()))
    {
      ...
      bgmg.a("red_point_configs_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localConcurrentHashMap);
    }
  }
  ...
  public void a(short paramShort)
  {
    ...
    long l1 = ((Long)axdz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(0L))).longValue();
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      for (int i = 0;; i = localRedPointConfig.redPointId)
      {
        ...
        antv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        this.jdField_a_of_type_Ayae.a(Collections.singletonList(paramArrayOfByte));
        return;
      }
