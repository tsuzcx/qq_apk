  ...
  implements aksu, aksy, akte
{
  ...
  public void a(long paramLong)
  {
    ...
    if (((0x4 & paramLong) != 0L) && (this.jdField_a_of_type_Akss != null)) {
      this.jdField_a_of_type_Akss.c();
    }
  ...
  public void a(long paramLong, akti paramakti)
  {
    ...
    {
      if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Aksr != null)) {
        this.jdField_a_of_type_Aksr.a(paramLong, paramakti);
      }
      return;
    }
  }
  ...
  public void a(long paramLong, byte[] paramArrayOfByte)
  {
    ...
    } while (this.jdField_a_of_type_Akss == null);
    this.jdField_a_of_type_Akss.a(paramLong, paramArrayOfByte);
  }
  
  public void a(aksw paramaksw)
  {
    a(4L, paramaksw);
  }
  ...
  public boolean a()
  {
    ...
    if ((this.jdField_a_of_type_Akss != null) && (!this.jdField_a_of_type_Akss.b()))
    {
      this.jdField_b_of_type_Boolean = false;
  ...
  public boolean a(long paramLong)
  {
    ...
    if (((0x4 & paramLong) != 0L) && (this.jdField_a_of_type_Akss != null)) {
      return this.jdField_a_of_type_Akss.c();
    }
    if (((0x1000 & paramLong) != 0L) && (this.jdField_a_of_type_ComTencentMobileqqArArengineARLocalGestureCircleRecog != null)) {
  ...
  public boolean a(akse paramakse)
  {
    ...
    return this.jdField_a_of_type_Akss.a(paramakse);
  }
  
  public boolean a(Context arg1, long paramLong, int paramInt1, int paramInt2, ArConfigInfo paramArConfigInfo, ArrayList<ArCloudConfigInfo> paramArrayList, ARScanStarFaceConfigInfo paramARScanStarFaceConfigInfo, aksr paramaksr)
  {
    ...
    this.jdField_a_of_type_Aksr = paramaksr;
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqArArengineARLocalMarkerRecog != null) || (this.jdField_a_of_type_Akss != null) || (this.jdField_a_of_type_ComTencentMobileqqArArengineARLocalGestureCircleRecog != null)) {}
      for (this.jdField_a_of_type_Boolean = true;; this.jdField_a_of_type_Boolean = false)
      {
        ...
        akue.a().a(System.currentTimeMillis() - l, this.jdField_a_of_type_Boolean);
  ...
  {
    if (((0x4 & paramLong) != 0L) && (this.jdField_a_of_type_Akss != null)) {
      return this.jdField_a_of_type_Akss.d();
    }
    return true;
  }
