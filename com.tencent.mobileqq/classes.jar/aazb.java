...
public class aazb
  implements bfoq
{
  public aazb(DiscussionInfoCardActivity paramDiscussionInfoCardActivity, bfol parambfol) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_Bfol != null) && (this.jdField_a_of_type_Bfol.isShowing()) && (!this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionInfoCardActivity.isFinishing()))
      {
