  ...
  implements pgb
{
  ...
  private oig jdField_a_of_type_Oig = new oig();
  private Map<Integer, List<oif>> b = new HashMap();
  private Map<String, List<Double>> c = new HashMap();
  
  private oid()
  {
    pfw.a(this);
    bnro.a().a(this.jdField_a_of_type_Oig);
  }
  ...
  private JSONObject a()
  {
    ...
    localJSONObject.put("cpu_type", bhlo.g());
    localJSONObject.put("cpu_frequency", bhlo.a());
    localJSONObject.put("cache_memory", bhlo.d());
    localJSONObject.put("device_model", bhlo.d());
    localJSONObject.put("os_version", bhlo.e());
    if (NetworkState.isWifiConn()) {}
    for (int i = 1;; i = 2)
    {
      localJSONObject.put("network_type", i);
      localJSONObject.put("package_name", "8.4.5.4745");
  ...
  {
    boolean bool = ((Boolean)bnrf.a("sp_key_readinjoy_feeds_drop_frame_switch", Boolean.valueOf(true))).booleanValue();
  ...
  public void a(int paramInt, oif paramoif)
  {
    ...
    {
      if (!((List)localObject).contains(paramoif)) {
        ((List)localObject).add(paramoif);
      }
  ...
  public void b(int paramInt, oif paramoif)
  {
    if ((this.b != null) && (this.b.get(Integer.valueOf(paramInt)) != null)) {
      ((List)this.b.get(Integer.valueOf(paramInt))).remove(paramoif);
    }
  }
