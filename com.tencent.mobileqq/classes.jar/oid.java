  ...
  implements begh
{
  ...
  private HashMap<Long, ohq> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private ohy jdField_a_of_type_Ohy;
  public boolean a;
  private int jdField_b_of_type_Int;
  public long b;
  public ArrayList<Long> b;
  private HashMap<Long, Float> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  private ohy jdField_b_of_type_Ohy;
  private int jdField_c_of_type_Int;
  public long c;
  private ArrayList<oic> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  private int d;
  public long d;
  private int e;
  public long e;
  ...
  private ohy a(AbsListView paramAbsListView)
  {
    ...
    paramAbsListView = new ohy(this.jdField_a_of_type_Ohp, null);
    ...
    if (this.jdField_a_of_type_Ohy == null) {}
    for (long l = System.currentTimeMillis() - this.jdField_d_of_type_Long;; l = System.currentTimeMillis() - this.jdField_a_of_type_Ohy.jdField_a_of_type_Long)
    {
      paramAbsListView.jdField_b_of_type_Long = l;
      this.jdField_a_of_type_Ohy = paramAbsListView;
      QLog.d("ReadinjoySPEventReport", 2, new Object[] { paramAbsListView });
      return paramAbsListView;
    }
  }
  
  private oic a(AbsListView paramAbsListView)
  {
    oic localoic = new oic();
    localoic.jdField_e_of_type_Int = this.jdField_b_of_type_Int;
    localoic.f = this.jdField_c_of_type_Int;
    if (this.jdField_d_of_type_Int - this.f > 0) {}
    for (int i = this.jdField_d_of_type_Int - this.f;; i = 0)
    {
      localoic.g = i;
      localoic.jdField_a_of_type_Int = this.jdField_e_of_type_Int;
      localoic.jdField_a_of_type_Long = (this.jdField_c_of_type_Long - this.jdField_b_of_type_Long);
      localoic.h = this.f;
      localoic.i = paramAbsListView.getWidth();
      localoic.jdField_a_of_type_ArrayOfFloat = ((float[])((ReadInJoyXListView)paramAbsListView).jdField_a_of_type_ArrayOfFloat.clone());
      localoic.b = ((float[])((ReadInJoyXListView)paramAbsListView).b.clone());
      return localoic;
    }
  }
  ...
  public String a()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localStringBuilder.append((ohq)((Iterator)localObject).next()).append("|");
    }
  ...
  public void a(int paramInt, AbsListView paramAbsListView)
  {
    ...
    //   44: ifle +14 -> 58
    //   47: aload_0
    //   48: getfield 138	oid:jdField_d_of_type_Long	J
    //   51: lstore_3
    //   52: lload_3
    //   53: lconst_0
    //   54: lcmp
    ...
    //   60: return
    //   61: aload_0
    //   62: getfield 46	oid:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   65: invokevirtual 265	java/util/ArrayList:size	()I
    //   68: ifle +12 -> 80
    //   71: aload_0
    //   72: getfield 266	oid:jdField_a_of_type_Int	I
    //   75: iload_1
    //   76: iand
    //   77: ifne -19 -> 58
    //   80: iload_1
    ...
    //   83: ifeq +15 -> 98
    //   86: aload_0
    //   87: getfield 268	oid:jdField_a_of_type_Boolean	Z
    //   90: ifeq -32 -> 58
    //   93: aload_0
    //   94: iconst_0
    //   95: putfield 268	oid:jdField_a_of_type_Boolean	Z
    //   98: aload_0
    //   99: aload_0
    //   100: getfield 266	oid:jdField_a_of_type_Int	I
    //   103: iload_1
    //   104: ior
    //   105: putfield 266	oid:jdField_a_of_type_Int	I
    //   108: aload_0
    //   109: aload_2
    //   110: invokespecial 270	oid:a	(Lcom/tencent/widget/AbsListView;)Lohy;
    //   113: astore_2
    //   114: aload_2
    //   115: ifnull -57 -> 58
    //   118: aload_0
    //   119: aload_2
    //   120: invokevirtual 273	oid:a	(Lohy;)V
    //   123: aload_0
    //   124: aload_2
    //   125: invokevirtual 276	ohy:a	()Ljava/util/ArrayList;
    //   128: putfield 46	oid:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   131: ldc 142
    //   133: iconst_2
    //   134: iconst_1
  ...
  public void a(ohy paramohy)
  {
    if ((paramohy == null) || (this.jdField_d_of_type_Long == 0L)) {
      return;
    }
    Iterator localIterator = paramohy.jdField_a_of_type_JavaUtilArrayList.iterator();
    label23:
    Object localObject;
    long l1;
    float f1;
    ...
    if (localIterator.hasNext())
    {
      ...
      l1 = paramohy.jdField_b_of_type_Long;
      f1 = ((Float)((Pair)localObject).second).floatValue();
      ohq localohq = (ohq)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(localBaseArticleInfo.mArticleID));
      localObject = localohq;
      if (localohq == null)
      {
        localObject = new ohq(this.jdField_a_of_type_Ohp, null);
        ((ohq)localObject).jdField_a_of_type_Long = localBaseArticleInfo.mRecommendSeq;
        ((ohq)localObject).jdField_b_of_type_Long = localBaseArticleInfo.mArticleID;
        ((ohq)localObject).jdField_a_of_type_JavaLangString = localBaseArticleInfo.mTitle;
        this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(localBaseArticleInfo.mArticleID), localObject);
      }
      l2 = ((ohq)localObject).jdField_c_of_type_Long;
      if (f1 <= 0.8F) {
        break label204;
      }
    }
    for (;;)
    {
      ((ohq)localObject).jdField_c_of_type_Long = (l1 + l2);
      ((ohq)localObject).jdField_a_of_type_Float = Math.max(((ohq)localObject).jdField_a_of_type_Float, f1);
      break label23;
      break;
      label204:
      l1 = 0L;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Ohy != null)
    {
      localArrayList1 = this.jdField_a_of_type_Ohy.a();
      if (this.jdField_b_of_type_Ohy == null) {
        break label267;
      }
      localArrayList2 = this.jdField_b_of_type_Ohy.a();
      ...
      do
      {
        ...
        localohq = (ohq)this.jdField_a_of_type_JavaUtilHashMap.get(localLong);
      } while (localohq == null);
      localohq.jdField_a_of_type_Int = 1;
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(localLong)) {
        break label273;
      }
    }
    for (localohq.jdField_a_of_type_Int = 0;; localohq.jdField_a_of_type_Int = 2) {
      label267:
      label273:
      do
      {
        if (this.jdField_b_of_type_JavaUtilArrayList.contains(localLong)) {
          localohq.jdField_a_of_type_Boolean = true;
        }
        if ((localArrayList2 != null) && (localArrayList2.contains(localLong))) {
          localohq.jdField_b_of_type_Boolean = true;
        }
        if (this.jdField_b_of_type_JavaUtilHashMap.containsKey(localLong)) {
          localohq.jdField_b_of_type_JavaLangString = String.format("%.2f", new Object[] { this.jdField_b_of_type_JavaUtilHashMap.get(localLong) });
        }
        localStringBuilder.append(localohq.toString()).append("\n");
        break label96;
    ...
    this.jdField_a_of_type_Ohp.b = this;
    this.jdField_a_of_type_Ohp.a = new oid(this.jdField_a_of_type_Ohp);
  }
  ...
  public String b()
  {
    ...
    {
      localStringBuilder.append(((oic)this.jdField_c_of_type_JavaUtilArrayList.get(i)).a()).append("|");
      i += 1;
    }
    if (localStringBuilder.length() == 0) {
      return "nil";
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    case 0: 
      ...
      localoic = a(paramAbsListView);
      this.jdField_c_of_type_JavaUtilArrayList.add(localoic);
      this.jdField_a_of_type_Ohy = a(paramAbsListView);
    ...
    case 1: 
      while ((paramInt <= i) && (paramInt < paramAbsListView.getCount()))
      {
        ...
        this.jdField_a_of_type_Ohy = a(paramAbsListView);
        this.jdField_b_of_type_Ohy = this.jdField_a_of_type_Ohy;
        a(this.jdField_a_of_type_Ohy);
        return;
      }
      QLog.d("ReadinjoySPEventReport", 2, "one scroll " + localoic.a());
      return;
    }
    this.jdField_a_of_type_Ohy = a(paramAbsListView);
    a(this.jdField_a_of_type_Ohy);
