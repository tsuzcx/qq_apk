...
public class blzn
{
  private static String jdField_a_of_type_JavaLangString = blzn.class.getSimpleName();
  private Handler jdField_a_of_type_AndroidOsHandler;
  private blzp jdField_a_of_type_Blzp;
  private GifEncoder jdField_a_of_type_DovComQqImVideoGifEncoder = new GifEncoder();
  private List<String> jdField_a_of_type_JavaUtilList;
  private String b = bljp.b;
  private String c;
  private String d;
  private String e;
  
  public blzn(String paramString)
  {
    this.e = paramString;
  ...
  private List<String> a(String paramString)
  {
    ...
    {
      localObject = ((File)localObject).list(new blzo(this));
      if (localObject != null)
      {
  ...
  public void a(blzp paramblzp)
  {
    this.jdField_a_of_type_Blzp = paramblzp;
    QLog.d(jdField_a_of_type_JavaLangString, 4, new Object[] { "start create gif, gif path = ", this.c });
    this.jdField_a_of_type_AndroidOsHandler.post(new GIFCreator.1(this, paramblzp));
  }
}
