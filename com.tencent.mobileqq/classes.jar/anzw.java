  ...
  implements bcug
{
  ...
  public anzw(QQAppInterface paramQQAppInterface)
  {
    this.a = paramQQAppInterface;
  }
  
  private boolean a(bcvc parambcvc, String paramString)
  {
    if (parambcvc == null) {}
    while (parambcvc.a(paramString) == -1) {
      return false;
    }
    return true;
  }
  ...
  public ReqItem a(int paramInt)
  {
    ...
    if ((j - i > paramInt) || (j < i))
    {
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).client_ver.set("8.4.10");
      ...
      Object localObject4 = bhhs.a((SharedPreferences)localObject1, "key_web_plugin_list" + this.a.getCurrentAccountUin(), null);
      if ((localObject4 != null) && (!((Set)localObject4).isEmpty()))
      {
        localObject3 = (bcvc)this.a.getManager(QQManagerFactory.GAMECENTER_MANAGER);
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        do
        {
          ...
          bhhs.a(paramRespItem, "key_web_plugin_list" + this.a.getCurrentAccountUin(), (Object[])localObject2);
          ...
          paramRespItem = (WebProcessManager)this.a.getManager(QQManagerFactory.WEBPROCESS_MANAGER);
