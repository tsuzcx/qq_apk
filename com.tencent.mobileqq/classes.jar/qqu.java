  ...
  public void a(boolean paramBoolean, String paramString1, int paramInt, String paramString2)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (!paramString1.d)
      {
        ...
        ozb.a().a(this.a.getActivity(), VideoFeedsRecommendFragment.a(this.a).c(), 2, paramString1.g, paramString2);
      }
    }
    label134:
    if (paramString1.e)
    {
      paramString2 = new bcql(this.a.getActivity().getApplicationContext());
      paramString2.d(2000);
      if (!paramBoolean) {
        break label243;
      }
      ...
      paramString2.b(this.a.getActivity().getApplicationContext().getResources().getDimensionPixelSize(2131298865) - (int)bbdv.a(this.a.getActivity().getApplicationContext(), 5.0F));
    }
    for (;;)
    {
