...
public class qqu
{
  ...
  private static int a(Spannable paramSpannable, int paramInt1, int paramInt2)
  {
    ...
    while (localMatcher.find())
    {
      ...
      paramInt2 += 1;
      paramSpannable.setSpan(new shc(str), i, j, 0);
    }
    return paramInt2;
  }
  ...
  public static boolean a(Spannable paramSpannable)
  {
    ...
    for (;;)
    {
      ...
      if (bdix.b.matcher(paramSpannable).find())
      {
        ...
        int k = 0;
        localObject = (sha[])paramSpannable.getSpans(0, m, sha.class);
        if ((localObject != null) && (localObject.length > 0))
        {
          Arrays.sort((Object[])localObject, new qqv(paramSpannable));
  ...
  public static boolean a(EditText paramEditText, String paramString, boolean paramBoolean1, boolean paramBoolean2, List<SocializeFeedsInfo.BiuCommentInfo> paramList)
  {
    ...
    paramEditText = orq.b(a(localEditable.toString(), str));
    if (TextUtils.isEmpty(paramEditText))
    {
      paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), ""));
      return true;
    }
    sha[] arrayOfsha = (sha[])localEditable.getSpans(0, localEditable.length(), sha.class);
    if ((arrayOfsha == null) || (arrayOfsha.length <= 0))
    {
      if (paramBoolean1) {
        break label650;
      }
    ...
    for (;;)
    {
      ...
      if (i < m)
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          j = localEditable.getSpanStart(arrayOfsha[(i + 1)]);
          break label372;
          label481:
