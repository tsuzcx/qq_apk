  ...
  implements AbsListView.OnScrollListener
{
  ...
  private owr(MoveFileActivity paramMoveFileActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramViewGroup = this.jdField_a_of_type_ComTencentBizTroopFileMoveFileActivity.getLayoutInflater().inflate(2130969880, MoveFileActivity.a(this.jdField_a_of_type_ComTencentBizTroopFileMoveFileActivity), false);
      paramView = new ows(null);
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131368322));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131368321));
      paramView.b = ((TextView)paramViewGroup.findViewById(2131368323));
      paramViewGroup.setTag(paramView);
    }
    paramView = (ows)paramViewGroup.getTag();
    ...
    if (localTroopFileInfo != null)
    {
      ...
      paramView.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130841286);
    }
    while (paramInt == MoveFileActivity.a(this.jdField_a_of_type_ComTencentBizTroopFileMoveFileActivity))
    {
      ...
      paramView.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130841288);
    }
