  ...
  implements Handler.Callback
{
  ...
  alfv jdField_a_of_type_Alfv;
  amfa jdField_a_of_type_Amfa;
  public RectF a;
  Camera.PreviewCallback jdField_a_of_type_AndroidHardwareCamera$PreviewCallback = new aubj(this);
  ...
  public aubg(Context paramContext, aubl paramaubl, SurfaceHolder paramSurfaceHolder)
  {
    ...
    this.jdField_a_of_type_Amfa = amfa.a();
    this.jdField_a_of_type_AndroidViewOrientationEventListener = new aubh(this, paramContext);
    paramContext = aucg.a();
  ...
  private int a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Int = axhn.b();
      }
      finally {}
      iy.a(this.jdField_a_of_type_AndroidHardwareCamera, 0, 0);
      int m = 90;
      if (axho.d(axho.g)) {
        m = 270;
      }
      ...
      Object localObject3 = a(this.jdField_a_of_type_AndroidHardwareCamera, axli.jdField_a_of_type_Int, axli.jdField_b_of_type_Int, false);
      if (QLog.isColorLevel()) {
      ...
      catch (Exception localException3)
      {
        try
        {
          ...
          Point localPoint = a(this.jdField_a_of_type_AndroidHardwareCamera, axli.jdField_a_of_type_Int, axli.jdField_b_of_type_Int, true);
  ...
  private Point a(Camera paramCamera, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    Collections.sort((List)localObject, new aubi(this));
    paramCamera = null;
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_b_of_type_Boolean)
        {
          ...
          axqw.b(null, "dc00898", "", "", "0X80082C1", "0X80082C1", 0, 0, "", "", "", "");
          this.jdField_b_of_type_Long = System.currentTimeMillis();
        }
        if (this.jdField_a_of_type_Alfv == null) {
          this.jdField_a_of_type_Alfv = new alfv(alfv.jdField_a_of_type_Int);
        }
      ...
      finally
      {
        try
        {
          bool = this.jdField_a_of_type_Alfv.a(paramArrayOfByte, this.g, this.h);
        }
        ...
        try
        {
          ...
          axqw.b(null, "dc00898", "", "", "0X80082C3", "0X80082C3", 0, 0, "", "", "", "");
          axqw.b(null, "dc00898", "", "", "0X80082C5", "0X80082C5", 0, 0, String.valueOf(l1), "", "", "");
          ...
          bcpw.a(BaseApplicationImpl.getContext(), 1, 2131699239, 0).a();
        }
        catch (Throwable paramArrayOfByte)
        {
          break label310;
      ...
      this.jdField_b_of_type_Boolean = true;
      paramArrayOfByte = this.jdField_a_of_type_Alfv.a();
      ...
      else
      {
        if (this.jdField_a_of_type_Aubl != null) {
          this.jdField_a_of_type_Aubl.a();
        }
        paramArrayOfByte = aubp.a(paramArrayOfByte, this.g, this.h, this.k, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
        if (this.jdField_a_of_type_Aubl != null) {
          this.jdField_a_of_type_Aubl.a(paramArrayOfByte);
        }
      }
    }
  }
  ...
  private boolean b()
  {
    ...
    //   8: monitorenter
    //   9: aload_0
    //   10: getfield 152	aubg:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   13: ifnull +191 -> 204
    //   16: aload_0
    //   17: getfield 57	aubg:jdField_a_of_type_AndroidViewSurfaceHolder	Landroid/view/SurfaceHolder;
    //   20: astore 5
    //   22: aload 5
    //   24: ifnull +180 -> 204
    //   27: aload_0
    //   28: getfield 53	aubg:jdField_a_of_type_AndroidHardwareCamera$PreviewCallback	Landroid/hardware/Camera$PreviewCallback;
    //   31: ifnull +52 -> 83
    //   34: aload_0
    //   35: getfield 255	aubg:g	I
    //   38: aload_0
    //   39: getfield 257	aubg:h	I
    //   42: imul
    //   43: aload_0
    //   44: getfield 264	aubg:l	I
    //   47: imul
    //   48: bipush 8
    //   50: idiv
    //   51: istore_1
    //   52: aload_0
    //   53: aload_0
    //   54: getfield 152	aubg:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   57: iload_1
    //   58: invokespecial 503	aubg:a	(Landroid/hardware/Camera;I)Z
    //   61: istore 4
    //   63: iload 4
    //   65: ifne +7 -> 72
    //   68: aload_0
    ...
    //   71: ireturn
    //   72: aload_0
    //   73: getfield 152	aubg:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   76: aload_0
    //   77: getfield 53	aubg:jdField_a_of_type_AndroidHardwareCamera$PreviewCallback	Landroid/hardware/Camera$PreviewCallback;
    //   80: invokevirtual 507	android/hardware/Camera:setPreviewCallbackWithBuffer	(Landroid/hardware/Camera$PreviewCallback;)V
    //   83: aload_0
    //   84: getfield 152	aubg:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   87: aload_0
    //   88: getfield 57	aubg:jdField_a_of_type_AndroidViewSurfaceHolder	Landroid/view/SurfaceHolder;
    //   91: invokevirtual 511	android/hardware/Camera:setPreviewDisplay	(Landroid/view/SurfaceHolder;)V
    //   94: aload_0
    //   95: getfield 152	aubg:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   98: invokevirtual 514	android/hardware/Camera:startPreview	()V
    //   101: aload_0
    //   102: invokevirtual 516	aubg:f	()V
    //   105: iconst_1
    //   106: istore_2
    //   107: iload_2
    //   108: ifeq +8 -> 116
    //   111: aload_0
    //   112: iconst_0
    //   113: putfield 518	aubg:jdField_d_of_type_Boolean	Z
    //   116: iload_2
    //   117: istore_3
  ...
  private boolean d()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 152	aubg:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   8: astore_2
    //   9: aload_2
    //   10: ifnull +59 -> 69
    //   13: aload_0
    //   14: getfield 152	aubg:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   17: invokevirtual 539	android/hardware/Camera:release	()V
    //   20: aload_0
    //   21: aconst_null
    //   22: putfield 541	aubg:jdField_b_of_type_ArrayOfByte	[B
    //   25: aload_0
    //   26: monitorexit
    //   27: iload_1
    //   28: ireturn
    ...
    //   30: aload_0
    //   31: aconst_null
    //   32: putfield 152	aubg:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   35: aload_0
    //   36: aconst_null
    //   37: putfield 57	aubg:jdField_a_of_type_AndroidViewSurfaceHolder	Landroid/view/SurfaceHolder;
    //   40: ldc 107
    //   42: iconst_1
  ...
  public void a()
  {
    ...
    do
    {
      ...
      Message localMessage = this.jdField_a_of_type_Bfnk.obtainMessage(0);
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_e_of_type_Int == 1)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.i("Q.ocr.camera", 1, "setOcrMode device model: " + bbct.i());
      }
    }
  }
  ...
  public boolean a()
  {
    ...
    if ((this.jdField_e_of_type_Int == 1) && (this.jdField_f_of_type_Boolean) && (this.i * this.j >= this.g * this.h)) {
      this.jdField_a_of_type_AndroidHardwareCamera.takePicture(null, null, null, new aubk(this));
    }
    for (;;)
    {
      return true;
  ...
  {
    if ((paramArrayOfByte == null) || (this.jdField_a_of_type_Bfnk == null) || (this.jdField_a_of_type_AndroidHardwareCamera == null)) {
      return false;
    }
    this.jdField_a_of_type_Bfnk.post(new OcrCamera.8(this, paramBoolean, paramArrayOfByte));
    return true;
  }
  ...
  public void b()
  {
    ...
    Message localMessage = this.jdField_a_of_type_Bfnk.obtainMessage(1);
    this.jdField_a_of_type_Bfnk.sendMessage(localMessage);
    if (QLog.isColorLevel()) {
  ...
  public void c()
  {
    ...
    Message localMessage = this.jdField_a_of_type_Bfnk.obtainMessage(2);
    this.jdField_a_of_type_Bfnk.sendMessage(localMessage);
    if (QLog.isColorLevel()) {
  ...
  public void d()
  {
    ...
    Message localMessage = this.jdField_a_of_type_Bfnk.obtainMessage(3);
    this.jdField_a_of_type_Bfnk.sendMessage(localMessage);
    if (QLog.isColorLevel()) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
      ...
      do
      {
        do
        {
          do
          {
            for (;;)
            {
              ...
              if (!this.jdField_c_of_type_Boolean) {
                try
                {
                  ...
                  if (this.jdField_a_of_type_Aubl != null)
                  {
                    this.jdField_a_of_type_Aubl.a(m, this.g, this.h, this.k);
                    return false;
                  }
                }
            ...
            bool = b();
          } while (this.jdField_a_of_type_Aubl == null);
          this.jdField_a_of_type_Aubl.a(bool);
          return false;
          bool = c();
        } while (this.jdField_a_of_type_Aubl == null);
        this.jdField_a_of_type_Aubl.b(bool);
        return false;
    ...
    this.jdField_a_of_type_Aubl.c(bool);
    return false;
  }
}
