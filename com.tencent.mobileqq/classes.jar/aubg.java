  ...
  implements View.OnTouchListener
{
  ...
  private blau jdField_a_of_type_Blau = new aubk(this);
  ...
  public aubg(Activity paramActivity)
  {
    super(paramActivity);
  }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)BaseApplicationImpl.getContext().getSystemService("layout_inflater")).inflate(2131560876, this.jdField_a_of_type_AndroidViewViewGroup, false);
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131380791));
      this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131373224));
      this.h = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376618));
      this.h.setText(anvx.a(2131715622));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373223));
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131372915));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370885));
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131379110));
      this.g = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363325));
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131366761));
    }
  }
  ...
  public void a(long paramLong, View.OnLongClickListener paramOnLongClickListener)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView = ((BaseVideoView)bapu.b(this.jdField_a_of_type_AndroidAppActivity, paramLong, null, null));
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetDragContainerLayout.setGestureChangeListener(this.jdField_a_of_type_Blau);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130844282, 0, 0);
    ...
    if (FileUtil.fileExistsAndNotEmpty(paramString1))
    {
      ...
      paramString2.setOnClickListener(new aubh(this, paramString1));
    ...
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new aubi(this));
  }
  ...
  public void d()
  {
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new aubj(this));
    }
  }
  ...
  public void d(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130845700);
      this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getString(2131691111));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130845698);
    this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getString(2131691114));
  }
