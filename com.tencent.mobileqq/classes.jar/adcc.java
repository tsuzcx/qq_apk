...
public class adcc
  extends ntf
{
  public adcc(VerifyUrlJobSegment paramVerifyUrlJobSegment, awxt paramawxt, String paramString) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.i("DoraemonOpenAPI.jobVerifyUrl", 2, "onResult type=" + this.jdField_a_of_type_Awxt.jdField_a_of_type_Int + ", appid=" + this.jdField_a_of_type_Awxt.jdField_a_of_type_JavaLangString + ", url=" + this.jdField_a_of_type_ComTencentMobileqqDoraemonImplWebviewVerifyUrlJobSegment.jdField_a_of_type_JavaLangString + ", code=" + paramInt);
    }
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        if (paramBundle.check_url_rsp.is_authed.get())
        {
          ...
          VerifyUrlJobSegment.a(this.jdField_a_of_type_ComTencentMobileqqDoraemonImplWebviewVerifyUrlJobSegment, this.jdField_a_of_type_Awxt);
          return;
        }
