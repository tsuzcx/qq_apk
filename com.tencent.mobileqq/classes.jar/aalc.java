...
{
  public aalc(AuthDevActivity paramAuthDevActivity) {}
  ...
  public void OnCheckDevLockSms(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    do
    {
      ...
      paramWUserSigInfo = (akge)this.a.app.a(34);
      if (paramWUserSigInfo != null) {
        paramWUserSigInfo.a();
      }
      ...
      aoen.a().a(this.a.app, this.a, this.a.app.getCurrentAccountUin(), true);
      AuthDevActivity.c(this.a, true);
      bcpw.a(this.a.getApplicationContext(), 2, this.a.getString(2131692094), 0).b(this.a.getTitleBarHeight());
    ...
    {
      bcpw.a(this.a.getApplicationContext(), 1, paramErrMsg.getMessage(), 0).b(this.a.getTitleBarHeight());
      return;
    }
    bcpw.a(this.a.getApplicationContext(), 1, this.a.getString(2131692145), 0).b(this.a.getTitleBarHeight());
  }
  ...
  public void OnCloseDevLock(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    if (paramInt == 0)
    {
      ...
      AuthDevActivity.a(this.a).setVisibility(8);
      aoen.a().a(this.a.app, this.a, this.a.app.getCurrentAccountUin(), false);
      bcpw.a(this.a.getApplicationContext(), 2, this.a.getString(2131692109), 0).b(this.a.getTitleBarHeight());
      paramWUserSigInfo = this.a.app.getHandler(LoginInfoActivity.class);
      if (paramWUserSigInfo != null) {
    ...
    bcpw.a(this.a.getApplicationContext(), 1, this.a.getString(2131692108), 0).b(this.a.getTitleBarHeight());
  }
}
