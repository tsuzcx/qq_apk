...
public class bjhz
{
  ...
  private bjia jdField_a_of_type_Bjia;
  private final String jdField_a_of_type_JavaLangString;
  private AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
  private int b;
  private int c;
  
  public bjhz(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  private void a()
  {
    ...
    do
    {
      ...
      } while (!bjib.a(((File)localObject).getAbsolutePath()));
      localObject = this.jdField_a_of_type_Bjia;
    } while (localObject == null);
    if (!bjhx.a(str)) {}
    for (boolean bool = true;; bool = false)
    {
      ((bjia)localObject).a(this, bool);
      return;
    }
  }
  ...
  public String a()
  {
    return bjhx.a(this.jdField_a_of_type_JavaLangString, this.c);
  }
  ...
  public void a(bjia parambjia)
  {
    this.jdField_a_of_type_Bjia = parambjia;
  }
