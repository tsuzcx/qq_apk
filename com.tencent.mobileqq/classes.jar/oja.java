...
public class oja
{
  static oja jdField_a_of_type_Oja;
  ...
  public static oja a()
  {
    try
    {
      if (jdField_a_of_type_Oja == null) {
        jdField_a_of_type_Oja = new oja();
      }
      return jdField_a_of_type_Oja;
    }
    finally {}
  }
  ...
  public Fragment a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    if (paramTabChannelCoverInfo.mChannelCoverId == opa.a()) {
    ...
    for (;;)
    {
      ...
      {
      default: 
        if (rjb.a(paramTabChannelCoverInfo.mChannelJumpUrl))
        {
      ...
      case 41450: 
        ...
        if (paramTabChannelCoverInfo.bid > 0L)
        {
          ...
          if (localObject2 != null)
          {
            ...
            if (!TextUtils.isEmpty(((ofb)localObject2).b("cgi"))) {}
