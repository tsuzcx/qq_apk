  ...
  extends DynamicTextItem
{
  ...
  static
  {
    ...
    int i = bpdd.a();
    jdField_e_of_type_Int = localResources.getDisplayMetrics().widthPixels - yri.a - i * 2;
  }
  
  public boll(int paramInt, @NonNull List<String> paramList, Typeface paramTypeface, Bitmap paramBitmap)
  {
  ...
  private CharSequence a(String paramString)
  {
    ...
    if (i < paramString.length())
    {
      ...
      for (;;)
      {
        ...
        paramString.setSpan(new bokl(k, 0.85F), i, i + 1, 17);
        f1 += k;
        j += 1;
      }
    }
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new boln(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    paramString = a(paramInt, new bolm(this));
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidTextStaticLayout = bomr.a((CharSequence)localObject, 0, ((CharSequence)localObject).length(), this.jdField_a_of_type_AndroidTextTextPaint, (int)f1, Layout.Alignment.ALIGN_CENTER, 1.0F, 0.0F, false, null, 0, jdField_a_of_type_ArrayOfInt.length);
      ...
      for (localObject = paramString.substring(0, paramInt - 1);; localObject = paramString.substring(0, paramInt))
      {
        ...
        this.jdField_b_of_type_AndroidTextStaticLayout = bomr.a(paramString, 0, paramString.length(), this.jdField_a_of_type_AndroidTextTextPaint, (int)f1, Layout.Alignment.ALIGN_CENTER, 1.0F, 0.0F, false, null, 0, jdField_a_of_type_ArrayOfInt.length);
