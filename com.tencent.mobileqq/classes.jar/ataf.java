...
public class ataf
{
  ...
  public static String a(long paramLong)
  {
    ...
    if (l2 < 600000L) {
      return ajjy.a(2131641434);
    }
    if (l2 < 3600000L) {
      return l2 / 60L / 1000L + 1L + ajjy.a(2131641427);
    }
    if ((l2 < 21600000L) && (k == i)) {
      return l2 / 60L / 60L / 1000L + ajjy.a(2131641421);
    }
    if ((l2 < 86400000L) && (k == i))
    {
    ...
    {
      localSimpleDateFormat.applyPattern("HH:mm");
      return ajjy.a(2131641432) + localSimpleDateFormat.format(localCalendar.getTime());
    }
    if (m == j)
    {
