...
public class arga
  extends BaseAdapter
  implements argm, URLDrawableDownListener
{
  public static final Object a;
  public static final Object b;
  public static final Object c;
  int jdField_a_of_type_Int = 4;
  private ahak jdField_a_of_type_Ahak = new ahak();
  ...
  public arga(Activity paramActivity, argi paramargi, Handler paramHandler, int paramInt, GridView paramGridView)
  {
    this.jdField_a_of_type_AndroidContentContext = paramActivity;
    this.jdField_a_of_type_Argi = paramargi;
  ...
  private void a(int paramInt1, View paramView, int paramInt2, Object paramObject)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
        } while (!arge.class.isInstance(paramObject));
        paramObject = (arge)paramObject;
      ...
      {
        paramInt1 /= 4;
        paramObject.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(amtj.a(2131700799) + (paramInt1 + 1) + amtj.a(2131700751) + str);
      }
    } while (!a());
    ...
    paramObject.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(this.jdField_a_of_type_Ahak.a(str));
    paramObject.jdField_a_of_type_AndroidWidgetCheckBox.setClickable(false);
    paramView.setOnClickListener(new argb(this, str));
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Ahak.a(this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_Int)) {
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    if (!argo.class.isInstance(localObject2))
    {
      QLog.d("ChatHistoryEmotionAdapter", 2, "[updateView] is not AIORichMediaInfo, position:" + paramInt);
      return;
    }
    if (!(localObject1 instanceof argc))
    {
      QLog.d("ChatHistoryEmotionAdapter", 2, "[updateView] is not ContentHolder, position:" + paramInt);
      return;
    }
    localObject1 = (argc)localObject1;
    localObject2 = (argo)localObject2;
    Object localObject3 = ((argc)localObject1).jdField_a_of_type_ComTencentImageURLImageView;
    Object localObject4 = this.jdField_a_of_type_Argi;
    localObject4 = argi.a(this.jdField_a_of_type_AndroidContentContext, (argo)localObject2);
    if (((argo)localObject2).jdField_b_of_type_Boolean)
    {
      if (((argo)localObject2).jdField_c_of_type_Boolean) {
        ((URLImageView)localObject3).setURLDrawableDownListener(this);
      }
    }
    else
    {
      if ((!(localObject4 instanceof avks)) || (((avks)localObject4).a() == null)) {
        break label341;
      }
      ((URLImageView)localObject3).setImageBitmap(argh.a(((avks)localObject4).a(), this.jdField_c_of_type_Int, this.jdField_c_of_type_Int));
      label191:
      localObject3 = ((argc)localObject1).jdField_a_of_type_AndroidWidgetImageView;
      localObject1 = ((argc)localObject1).b;
      if (!this.jdField_a_of_type_Boolean) {
        break label374;
      }
      if (!((argo)localObject2).jdField_a_of_type_Boolean) {
        break label351;
      }
      ((ImageView)localObject3).setVisibility(0);
      ((ImageView)localObject1).setImageResource(2130845588);
      ((ImageView)localObject1).setVisibility(0);
    }
    for (;;)
    {
      int i = paramInt / 4;
      paramView.setContentDescription(amtj.a(2131700757) + (i + 1) + amtj.a(2131700817) + (paramInt % 4 + 1) + amtj.a(2131700798));
      return;
      if (AbsDownloader.getFile(URLDrawableHelper.getURL((MessageForPic)((argo)localObject2).jdField_a_of_type_ComTencentMobileqqDataMessageRecord, 65537).toString()) != null) {
        break;
      }
      a((MessageForPic)((argo)localObject2).jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
      break;
      label341:
      ...
      ((ImageView)localObject1).setImageResource(2130845585);
      ((ImageView)localObject1).setVisibility(0);
      continue;
      label374:
      ((ImageView)localObject3).setVisibility(4);
  ...
  {
    argl localargl = new argl(paramMessageForPic, this.jdField_a_of_type_AndroidOsHandler, this);
    if (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramMessageForPic)) {
      this.jdField_a_of_type_JavaUtilHashMap.put(paramMessageForPic, localargl);
    }
    Object localObject = a(paramMessageForPic);
    if (localObject != null) {
      ((BasePicDownloadProcessor)localObject).addDownCallback(localargl);
    }
    do
    {
      return;
      localObject = aydj.a(5, 1536, 1);
      ((ayds)localObject).a(paramMessageForPic, paramMessageForPic.getPicDownloadInfo());
      ((ayds)localObject).a(localargl);
    ...
    aydj.a((ayds)localObject, (QQAppInterface)paramMessageForPic);
  }
  ...
  public void a(boolean paramBoolean, List<MessageRecord> paramList)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilCalendar == null)
      {
        ...
        this.jdField_a_of_type_JavaUtilCalendar.setTimeInMillis(bbko.a() * 1000L);
      }
      i = paramList.size() - 1;
    }
    for (;;)
    {
      ...
      localObject1 = new argo((MessageRecord)localObject2);
          ...
          if (k > 0)
          {
            ...
            for (;;)
            {
              if (j < this.jdField_a_of_type_Int - k)
              {
                ...
                j += 1;
                continue;
                this.jdField_a_of_type_Ahak.a(this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_Int);
                break;
              }
            }
          }
    ...
    label292:
    Object localObject1 = this.jdField_a_of_type_Ahak;
    if (!paramBoolean)
    {
      paramBoolean = bool;
    ...
    ((ahak)localObject1).a(paramBoolean, this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaUtilList);
  }
  ...
  public int b()
  {
    return a() + this.jdField_a_of_type_Ahak.a();
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      break;
      if (argc.class.isInstance(localObject1))
      {
      ...
      else
      {
        ...
        paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject2).findViewById(2131372552));
        paramView.b = ((ImageView)((View)localObject2).findViewById(2131372553));
        ...
        else
        {
          ...
          localObject1 = localObject2;
          continue;
          if (arge.class.isInstance(localObject1))
          {
            localObject2 = paramView;
            paramView = (View)localObject1;
            localObject1 = localObject2;
          ...
          else
          {
            ...
            localObject1 = new argd(this, this.jdField_a_of_type_AndroidContentContext);
            ...
            else
            {
              ...
              {
                localObject2 = new argd(this, this.jdField_a_of_type_AndroidContentContext);
                ...
                ((argd)localObject2).addView(paramView);
