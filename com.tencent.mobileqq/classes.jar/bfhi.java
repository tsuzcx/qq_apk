...
public class bfhi
{
  ...
  static
  {
    jdField_a_of_type_JavaUtilComparator = new bfhk();
    jdField_b_of_type_JavaUtilComparator = new bfhj();
  ...
  {
    return bdcv.a(a(paramString));
  }
  
  public static String a(byte[] paramArrayOfByte)
  {
    return bdcv.a(a(paramArrayOfByte));
  }
  ...
  public static String b(String paramString)
  {
    try
    {
      paramString = bdcv.a(a(paramString.getBytes("UTF-8")));
      return paramString;
    }
  ...
  public static String d(String paramString)
  {
    ...
    paramString = new bfhi().b(paramString);
