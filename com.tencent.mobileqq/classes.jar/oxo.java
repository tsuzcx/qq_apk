  ...
  implements ViewBase.OnClickListener
{
  ...
  public oxo(ArticleInfo paramArticleInfo, Context paramContext, int paramInt, String paramString)
  {
  ...
  private void a()
  {
    bacn localbacn = bade.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString);
    if (localbacn != null) {
      localbacn.c();
    }
  }
  ...
  private void a(String paramString)
  {
    ...
    try
    {
      ...
      localJSONObject.put("feeds_type", obz.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
      localJSONObject.put("channel_id", "" + this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mChannelID);
      localJSONObject.put("feeds_source", obz.c(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
  ...
  public void onClick(ViewBase paramViewBase)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo.jdField_a_of_type_Pri != null) && ((this.jdField_a_of_type_Int == 72) || (this.jdField_a_of_type_Int == 73)))
      {
        a("4");
        return;
      }
