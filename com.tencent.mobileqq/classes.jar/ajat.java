...
public class ajat
  implements bdhu, bdhw
{
  private static ajat jdField_a_of_type_Ajat;
  public int a;
  ...
  public WeakReference<ajbb> a;
  public HashMap<MessageForPtt, MessageForQQWalletMsg> a;
  public Map<MessageForPtt, ajbd> a;
  ...
  public static ajat a()
  {
    try
    {
      if (jdField_a_of_type_Ajat == null) {
        jdField_a_of_type_Ajat = new ajat();
      }
      ajat localajat = jdField_a_of_type_Ajat;
      return localajat;
    }
    finally {}
  }
  
  private ajbc a(byte[] paramArrayOfByte)
  {
    boolean bool = true;
    ajbc localajbc = new ajbc();
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length == 0)) {
      return localajbc;
    }
    ajas.a().a();
    if (ajas.a().a(paramArrayOfByte, paramArrayOfByte.length) == 1) {}
    for (;;)
    {
      localajbc.jdField_a_of_type_Boolean = bool;
      localajbc.jdField_a_of_type_Float = ajas.a().a();
      localajbc.jdField_a_of_type_JavaLangString = a(localajbc.jdField_a_of_type_Float);
      ajas.a().b();
  ...
  private ajbc a(byte[] paramArrayOfByte, MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
  ...
  private void a(int paramInt1, long paramLong, int paramInt2, MessageForQQWalletMsg paramMessageForQQWalletMsg, float paramFloat)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (ajas.a().a(localQQAppInterface)) {
        paramInt1 = 1;
      } else {
        paramInt1 = 0;
      }
  ...
  {
    ajbb localajbb = (ajbb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((localajbb != null) && (!localajbb.c())) {
      localajbb.a(paramInt, paramString);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(MessageRecord paramMessageRecord, long paramLong, byte[] paramArrayOfByte, String paramString)
  {
    ...
    try
    {
      MessageForPtt localMessageForPtt = acex.a(ajaf.a(), paramMessageRecord.getLocalFilePath(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, -2, paramMessageRecord.voiceType);
      if (localMessageForPtt != null)
      {
        this.jdField_a_of_type_JavaUtilMap.put(localMessageForPtt, new ajbd(paramMessageRecord, paramLong, paramArrayOfByte, paramString));
        paramArrayOfByte = new QQRecorder.RecorderParam(bdic.jdField_b_of_type_Int, 16000, 1);
        if (a(this.jdField_a_of_type_ArrayOfByte, this.jdField_a_of_type_JavaLangString, paramMessageRecord.getLocalFilePath(), paramArrayOfByte))
        {
          ...
          if ((paramString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (localMessageForPtt != null))
          {
            ...
            paramArrayOfByte = (ajbb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
  ...
  public static void a(String paramString, MessageForPtt paramMessageForPtt, banb parambanb)
  {
    b(paramString, paramMessageForPtt);
    if (parambanb != null)
    {
      if (!(parambanb instanceof bank)) {
        break label38;
      }
      paramString = ((bank)parambanb).a();
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (!(parambanb instanceof bapa)) {
            break;
          }
          paramString = ((bapa)parambanb).a(paramMessageForPtt);
        } while ((paramString == null) || (paramMessageForPtt == null));
        paramMessageForPtt.richText = paramString;
        return;
      } while (!(parambanb instanceof bape));
      paramString = ((bape)parambanb).a(paramMessageForPtt);
    } while ((paramString == null) || (paramMessageForPtt == null));
    paramMessageForPtt.richText = paramString;
  }
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          awtg.a(paramString2);
          paramRecorderParam = bdic.a(paramRecorderParam.jdField_c_of_type_Int, paramRecorderParam.jdField_a_of_type_Int);
          awtg.a(paramString2, paramRecorderParam, paramRecorderParam.length);
          ...
          awtg.a(paramString2, ((awuh)localObject).jdField_a_of_type_ArrayOfByte, ((awuh)localObject).jdField_a_of_type_Int);
        }
  ...
  public int a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    paramString = (ajbb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (paramString != null) {
  ...
  public String a(float paramFloat)
  {
    ...
    if (localObject1 != null)
    {
      ...
      if (localObject1 != null)
      {
        localObject1 = ((aitd)localObject1).a("voice_pwd", new String[] { "scoreIdMap" });
        if (localObject1 == null) {}
      }
    }
    int i;
  ...
  public void a(ajba paramajba)
  {
    Object localObject = ajaf.a();
    if ((localObject == null) || (paramajba == null)) {}
    do
    {
      return;
      localObject = ((TicketManager)((QQAppInterface)localObject).getManager(2)).GetSkey(((QQAppInterface)localObject).getCurrentAccountUin(), 16L, new ajaz(this, paramajba));
    } while ((localObject == null) || (((Ticket)localObject)._sig == null) || (((Ticket)localObject)._sig.length == 0));
    paramajba.a(new String(((Ticket)localObject)._sig));
  }
  
  public void a(ajbb paramajbb)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramajbb);
  }
  ...
  public void a(SessionInfo paramSessionInfo, MessageForQQWalletMsg paramMessageForQQWalletMsg, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      i = agig.a(paramMessageForQQWalletMsg.messageType);
      str1 = paramString;
      if (TextUtils.isEmpty(paramString)) {
      ...
      localRecorderParam = new QQRecorder.RecorderParam(bdic.jdField_b_of_type_Int, 16000, 1);
      if (!bdcs.a())
      {
        b(2131694851);
        c("no sdcard");
    ...
    boolean bool2 = true;
    long l1 = aiqz.a(localQQAppInterface.getCurrentAccountUin(), "voice_recognieze_in_phone", 0L);
    ...
    if ((!this.jdField_c_of_type_Boolean) && (!bool1)) {
      a(2, aiqz.a(localQQAppInterface.getCurrentAccountUin(), "voice_recognieze_in_phone_tips", BaseApplicationImpl.getContext().getResources().getString(2131695802)));
    }
    if (paramBoolean)
    {
    ...
    for (;;)
    {
      ...
      do
      {
        str1 = banc.a(localQQAppInterface.getCurrentAccountUin(), null, 2, null, false);
        ...
        paramSessionInfo = acex.a(localQQAppInterface, paramString, paramSessionInfo, -2, localRecorderParam.jdField_c_of_type_Int);
  ...
  public void a(MessageRecord paramMessageRecord, alsi paramalsi, long paramLong, byte[] paramArrayOfByte, String paramString, banb parambanb)
  {
    QQAppInterface localQQAppInterface;
    Object localObject1;
    Object localObject2;
    ...
    {
      localQQAppInterface = ajaf.a();
      localObject1 = (ajbb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      i = 0;
      if (localObject1 != null) {
        i = localObject1.hashCode();
      }
      if ((localQQAppInterface == null) || (paramMessageRecord == null) || (!(paramMessageRecord instanceof MessageForPtt)) || (localObject1 == null) || (((ajbb)localObject1).c()) || (this.jdField_b_of_type_Boolean) || (i != this.jdField_a_of_type_Int)) {
        return;
      }
      ...
      if (i == 1)
      {
        paramMessageRecord = (ajbb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        ...
        localQQAppInterface.a().a((MessageRecord)localObject2, paramalsi);
        return;
      }
      if (i != 2) {
        break label307;
    ...
    for (;;)
    {
      a(new ajav(this, localQQAppInterface, (MessageForQQWalletMsg)localObject1, i, paramLong, paramArrayOfByte, paramString, (MessageForPtt)localObject2, parambanb, paramalsi));
      return;
    ...
    if (i == 3)
    {
      ...
      {
        paramMessageRecord = (MessageForPtt)paramMessageRecord;
        localObject2 = (ajbd)this.jdField_a_of_type_JavaUtilMap.get(paramMessageRecord);
        ...
        for (;;)
        {
          a(new ajax(this, localMessageForQQWalletMsg, localQQAppInterface, i, (ajbd)localObject2, paramLong, paramArrayOfByte, paramString, (MessageForQQWalletMsg)localObject1, paramMessageRecord, parambanb, paramalsi));
          return;
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam, double paramDouble)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      bool = ((ajbc)localObject2).jdField_a_of_type_Boolean;
      if (bool) {
        b(((ajbc)localObject2).jdField_a_of_type_JavaLangString, (MessageRecord)localObject1);
      }
      localObject2 = (ajbb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((localObject2 == null) || (((ajbb)localObject2).c()) || (bool)) {
        break label679;
      }
      ((ajbb)localObject2).a(false, "");
      break label679;
      localObject2 = (MessageForQQWalletMsg)this.jdField_a_of_type_JavaUtilHashMap.get(localObject1);
      ...
      j = agig.a(((MessageForQQWalletMsg)localObject2).messageType);
      if (j == 8) {
        if (((MessageForQQWalletMsg)localObject2).mQQWalletRedPacketMsg.elem.songFlag == 0) {
          if (this.jdField_d_of_type_Int == -1) {
            if (!ajaf.a(BaseApplicationImpl.getContext())) {
              break label682;
            }
          }
        }
  ...
  {
    if (((paramawug instanceof WechatNsWrapper)) && (this.jdField_a_of_type_JavaIoByteArrayOutputStream != null) && (paramawuh != null) && (this.jdField_d_of_type_Boolean)) {
      this.jdField_a_of_type_JavaIoByteArrayOutputStream.write(paramawuh.jdField_a_of_type_ArrayOfByte, 0, paramawuh.jdField_a_of_type_Int);
    }
  }
