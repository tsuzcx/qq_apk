...
public class atel
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new ateq(this);
  ...
  private boolean a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561191, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367896));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367900));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561213, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367896));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367897));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561212, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367896));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367897));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561200, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367896));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367901));
    }
  ...
  private void b(ArrayList<String> paramArrayList)
  {
    ...
    do
    {
      ...
      if (j > 0)
      {
        ...
        localObject = aoot.a(localQQAppInterface, 1, (String)localObject, 4, localDrawable, localDrawable);
        ((aoot)localObject).mutate();
        localDrawable = localImageView.getDrawable();
        if ((localDrawable != null) && (localDrawable != localObject) && ((localDrawable instanceof aoot))) {
      ...
      for (;;)
      {
        ...
        localObject = null;
        break label225;
        localImageView.setImageDrawable(bhmq.a(true));
        localImageView.setVisibility(0);
        continue;
    ...
    if (localQQAppInterface != null)
    {
      ...
      aoot.a(localQQAppInterface, 1, paramArrayList, 4, (Drawable)localObject, (Drawable)localObject);
    }
  ...
  void b()
  {
    ...
    for (int i = agej.a(2.0F, ((Context)localObject2).getResources());; i = agej.a(1.0F, ((Context)localObject2).getResources()))
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setPadding(i, i, i, i);
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130845142);
      ...
      ((RelativeLayout.LayoutParams)localObject2).addRule(7, 2131367896);
      ((RelativeLayout.LayoutParams)localObject2).addRule(6, 2131367896);
      ...
      try
      {
        ...
        ((ScaleAnimation)localObject1).setAnimationListener(new atem(this));
  ...
  void c()
  {
    ...
    int j = i - ((Context)localObject1).getResources().getDimensionPixelSize(2131298112);
    if (this.jdField_a_of_type_Int == 2)
    {
      j = ((Context)localObject1).getResources().getDimensionPixelSize(2131298120);
      i -= ((Context)localObject1).getResources().getDimensionPixelSize(2131298118);
    }
    for (;;)
    {
      ...
      localObject3 = new ateo(this, (AnimatorSet)localObject1);
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() > 1)
      {
        ...
        for (;;)
        {
          if (j < this.jdField_a_of_type_JavaUtilList.size() - 1)
          {
            ...
            j = ((Context)localObject1).getResources().getDimensionPixelSize(2131298123);
            i -= ((Context)localObject1).getResources().getDimensionPixelSize(2131298121);
            break;
          }
        }
