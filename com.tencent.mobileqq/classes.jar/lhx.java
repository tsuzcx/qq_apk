  ...
  extends BroadcastReceiver
{
  ...
  private lhx(VideoAppInterface paramVideoAppInterface)
  {
    ...
    do
    {
            ...
            do
            {
              do
              {
                ...
                if ("com.tencent.qav.notify.refuse".equals(paramContext))
                {
                  ...
                  paramIntent = lfb.a().c(paramContext);
                  if (QLog.isColorLevel()) {
      ...
      if (TextUtils.equals(paramContext, "avChatRoom"))
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null) {
            ((lmr)localObject).a(i, paramIntent);
          }
        }
      }
