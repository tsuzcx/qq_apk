  ...
  extends lhs
{
  ...
  public lhx(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public lhu a(int paramInt1, int paramInt2)
  {
    ...
    if ((this.jdField_a_of_type_Lhw != null) && (locallhu != null) && (locallhu.a != null))
    {
      boolean bool = lhq.a().b();
      if ((!a(locallhu.a)) || (bool)) {
        this.jdField_a_of_type_Lhw.c(0);
      }
    }
    return locallhu;
  }
  ...
  public boolean a(long paramLong, PendantItem paramPendantItem)
  {
    ...
    if ((bool) && (paramPendantItem != null) && (!TextUtils.equals("0", paramPendantItem.getId())))
    {
      ...
      if (localObject != null) {
        ((lgt)localObject).a(3002, paramPendantItem.getId());
      }
    }
  ...
  protected boolean a(PendantItem paramPendantItem)
  {
    ...
    {
      lbj.e(this.jdField_a_of_type_JavaLangString, "isTemplateUsable:" + a() + "|");
      return false;
    }
    ...
    if (!bool)
    {
      localObject1 = lbm.b() + paramPendantItem.getName();
      ...
      if (localFile.exists())
      {
        ...
        lbj.c(this.jdField_a_of_type_JavaLangString, "isTemplateUsable :" + (String)localObject1 + "|" + (String)localObject2 + "|" + (l2 - l1));
