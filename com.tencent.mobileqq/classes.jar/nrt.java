...
public class nrt
{
  public static int a(QQAppInterface paramQQAppInterface, String paramString, AccountDetail paramAccountDetail)
  {
    ...
    {
      return i;
      i = syb.a(((AccountDetail)localObject).accountFlag);
      break;
      i = 3;
      continue;
      i = 4;
      if (syb.a(((AccountDetail)localObject).accountFlag2) == -8L)
      {
        i = 8;
        continue;
        i = 5;
  ...
  public static void a(ArticleInfo paramArticleInfo)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject2).put("feeds_type", "" + ors.a(paramArticleInfo));
      ...
      ((JSONObject)localObject2).put("mark_type", "" + ors.a(paramArticleInfo));
    ...
    if ((rqj.b(paramArticleInfo)) || (rqj.i(paramArticleInfo)) || (rqj.j(paramArticleInfo)) || (rqj.k(paramArticleInfo)))
    {
      ...
      a(null, ors.d(paramArticleInfo), str2, str2, 0, 0, String.valueOf(paramArticleInfo.mFeedId), (String)localObject2, "" + paramArticleInfo.mStrategyId, (String)localObject1, false);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if ((i != 2) && (syb.a(paramQQAppInterface, paramString) != -7)) {
