...
public class abfc
  implements adbw, anps, IMemoryManager, IAppStateChangeListener
{
  private static abfc jdField_a_of_type_Abfc;
  ...
  private Vector<abfd> jdField_a_of_type_JavaUtilVector;
  public boolean a;
  ...
  public static abfc a()
  {
    if (jdField_a_of_type_Abfc == null) {}
    try
    {
      if (jdField_a_of_type_Abfc == null) {
        jdField_a_of_type_Abfc = new abfc();
      }
      return jdField_a_of_type_Abfc;
    }
    finally {}
  }
  ...
  public static void a(String paramString, int paramInt)
  {
    ...
    for (Object localObject = ((AppRuntime)localObject).getAccount();; localObject = null)
    {
      ...
      {
        if (paramString != null) {
          bctj.a(BaseApplicationImpl.getApplication()).a((String)localObject, paramString, true, 0L, 0L, localHashMap, "", true);
        }
        return;
        if (paramInt == l)
        {
  ...
  {
    a(2);
    abfa.a(BaseApplicationImpl.class.getClassLoader());
  }
    ...
    for (String str2 = "low_mem_report_rdm_time";; str2 = "bg_mem_report_rdm_time")
    {
      ...
      if (l1 > 0L) {
        if (Math.abs(l2 - l1) > 3600000L)
        {
          ...
          label402:
          bctj.a(BaseApplicationImpl.getApplication()).a(null, str1, true, 0L, 0L, localHashMap, null);
  ...
  {
    abey localabey = MagnifierSDK.a().a().a;
    if (QLog.isColorLevel()) {
      QLog.d("MemoryClearManagerNew", 2, "onNeedTrimMemory|clear= " + localabey.jdField_a_of_type_Boolean + "configId" + localabey.jdField_a_of_type_JavaLangString);
    }
    if ((a(paramabez.jdField_b_of_type_Int * localabey.jdField_b_of_type_Int * 1000)) && (localabey.jdField_a_of_type_Boolean)) {}
    try
    {
      b(paramInt, paramabez);
      return;
    }
    catch (Exception paramabez)
    {
      while (!QLog.isColorLevel()) {}
      QLog.d("MemoryClearManagerNew", 2, "clearMemory Exception= " + paramabez);
    }
  }
  ...
  public void a(abfd paramabfd)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.add(paramabfd);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((i1 > 600) && (i1 - this.n > 250) && (this.jdField_a_of_type_Boolean))
    {
      ...
      if (Math.abs(l1 - l2) >= 3600000L)
      {
        ...
        localHashMap.put("topActivity", anrr.a());
        ...
        localHashMap.put("sProcessId", String.valueOf(BaseApplicationImpl.sProcessId));
        bctj.a(BaseApplicationImpl.getApplication()).a(null, "MemoryIncreaseInfo", true, 0L, 0L, localHashMap, "", true);
  ...
  public void b()
  {
    try
    {
      ...
      ((SharedPreferences.Editor)localObject).putString("topActivity", anrr.a());
      ((SharedPreferences.Editor)localObject).putString("key_mem_info", bcte.a().a());
  ...
  public void b(int paramInt, abez paramabez)
  {
    long l6;
    Object localObject3;
    int i1;
    ...
    for (;;)
    {
      try
      {
        ...
        synchronized (this.jdField_a_of_type_JavaUtilVector)
        {
          ...
          {
            i1 += ((abfd)((Iterator)localObject3).next()).a();
            continue;
          }
          l2 = i1;
          l1 = i1;
          ...
          i2 = (int)(i1 * paramabez.jdField_b_of_type_Float);
          l3 = i1;
          BaseApplicationImpl.sImageCache.trimToSize(i2);
          if ((paramabez.a > 0.0F) && (paramabez.a < 1.0F))
          {
            l4 = MemoryManager.a() * 1L / 32L;
            if (BaseApplicationImpl.sImageCache.maxSize() >= l4) {
              BaseApplicationImpl.sImageCache.resetMaxSize(paramabez.a);
            }
          }
          i10 = 0 + (i1 - i2);
          l4 = i10;
    ...
    if (((Iterator)???).hasNext())
    {
      ...
      if (localObject3 != null)
      {
        ...
        if (localObject4 != null)
        {
          ...
          ((QQLruCache)localObject4).clearOnLowMemory((int)(((QQLruCache)localObject4).size() * paramabez.jdField_b_of_type_Float));
        ...
        else
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            {
              localLruCache.trimToSize((int)(localLruCache.size() * paramabez.jdField_b_of_type_Float));
          ...
          if (paramInt == 1)
          {
            paramabez = this.jdField_b_of_type_JavaUtilList.iterator();
            if (!paramabez.hasNext()) {
              break label1449;
            }
            ??? = (WeakReference)paramabez.next();
            if (??? == null) {
              break label1446;
            }
            ...
            if (paramInt == 1)
            {
              paramabez = this.jdField_a_of_type_JavaUtilList.iterator();
              if (!paramabez.hasNext()) {
                break label1468;
              }
              ??? = (WeakReference)paramabez.next();
              ...
              break label1465;
              label842:
              paramabez = SkinEngine.getInstances().releasePreloadDrawableCache();
              Object localObject1;
              l2 = localObject1;
              i1 = i9;
              if (paramabez.length < 2) {
                break label1522;
              }
              if ((paramabez[0] instanceof Integer)) {
                i2 = Integer.parseInt(paramabez[0].toString());
              }
              l2 = localObject1;
              i1 = i2;
              if (!(paramabez[1] instanceof Long)) {
                break label1522;
              }
              l2 = Long.parseLong(paramabez[1].toString());
              i1 = i2;
              break label1522;
            }
          }
  ...
  public void b(abfd paramabfd)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.remove(paramabfd);
      return;
    }
  }
  ...
  public final void d()
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("sProcessId", String.valueOf(BaseApplicationImpl.sProcessId));
      bctj.a(BaseApplicationImpl.getApplication()).a(null, "memory_oom_Info", true, 0L, 0L, localHashMap, null);
