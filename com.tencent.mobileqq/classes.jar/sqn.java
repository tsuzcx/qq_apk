  ...
  implements IphonePickerView.IphonePickListener, IphonePickerView.PickerViewAdapter, ActionSheet.OnDismissListener
{
  ...
  sqp jdField_a_of_type_Sqp;
  int b;
  
  public sqn(ActionSheet paramActionSheet, List paramList, String paramString, sqp paramsqp)
  {
  ...
  {
    if ((this.jdField_a_of_type_Sqp != null) && (this.b >= 0) && (this.b < this.jdField_a_of_type_JavaUtilList.size())) {
      this.jdField_a_of_type_Sqp.a(1, (String)this.jdField_a_of_type_JavaUtilList.get(this.b));
    }
  ...
  {
    if ((this.jdField_a_of_type_Sqp != null) && (this.b >= 0) && (this.b < this.jdField_a_of_type_JavaUtilList.size())) {
      this.jdField_a_of_type_Sqp.a(2, (String)this.jdField_a_of_type_JavaUtilList.get(this.b));
    }
  }
  ...
  public void onItemSelected(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      this.b = paramInt1;
      if ((this.jdField_a_of_type_Sqp != null) && (this.b >= 0) && (this.b < this.jdField_a_of_type_JavaUtilList.size())) {
        this.jdField_a_of_type_Sqp.a(0, (String)this.jdField_a_of_type_JavaUtilList.get(this.b));
      }
      return;
      paramInt1 = paramInt2;
      if (paramInt2 >= this.jdField_a_of_type_JavaUtilList.size()) {
