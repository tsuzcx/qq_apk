  ...
  extends BusinessHandler
{
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      axsb.b("OlympicHandler", new Object[] { "handleDeliverTorch, req or res or data == null, return" });
      return;
    }
    axsb.b("OlympicHandler", new Object[] { "handleDeliverTorch, req=", paramToServiceMsg, ", res=", paramFromServiceMsg, ", data=", paramObject });
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramToServiceMsg.msg_rsp_head.has())
        {
          ...
          axsb.b("OlympicHandler", new Object[] { "handleDeliverTorch, rspHead or torchInfo == null, result set to -100" });
      ...
      {
        axsb.b("OlympicHandler", new Object[] { "handleDeliverTorch, InvalidProtocolBufferMicroException, result set to -101, msg=", paramToServiceMsg.getMessage() });
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      axsb.b("OlympicHandler", new Object[] { "handleDeliverTorch, result=", Integer.valueOf(k), ", errMsg=", paramFromServiceMsg, ", minUpdateTime=", Integer.valueOf(i), ", expireTime=", Integer.valueOf(j), ", sig=", paramObject });
      return;
  ...
  public void a(torch_transfer.TorchbearerInfo paramTorchbearerInfo)
  {
    ...
    {
      axsb.b("OlympicHandler", new Object[] { "handlePush0xb4, torchInfo == null, return" });
      return;
    }
    axsb.b("OlympicHandler", new Object[] { "handlePush0xb4, torchInfo=", paramTorchbearerInfo });
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null) || (paramObject == null))
    {
      axsb.b("OlympicHandler", new Object[] { "handleClearTorchFlag, req or res or data == null, return" });
      return;
    }
    axsb.b("OlympicHandler", new Object[] { "handleClearTorchFlag, req=", paramToServiceMsg.toString(), ", res=", paramFromServiceMsg.toString(), ", data=", paramObject.toString() });
    ...
    for (;;)
    {
      ...
      {
        label150:
        axsb.b("OlympicHandler", new Object[] { "handleClearTorchFlag, InvalidProtocolBufferMicroException, result set to -101, msg=", paramToServiceMsg.getMessage() });
        if (!QLog.isColorLevel()) {
          continue;
        }
        paramToServiceMsg.printStackTrace();
      ...
      if (i == 0)
      {
        ...
        axsb.b("OlympicHandler", new Object[] { "handleClearTorchFlag, result=", Integer.valueOf(i), ", errMsg=", paramToServiceMsg });
        return;
        label242:
        paramToServiceMsg = null;
      }
