...
public class axqb
  extends axob
{
  public axqb(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    if ((j != 0) && (badq.g(this.a.getApplicationContext())))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        new axrg().a(paramOutputStream, paramDownloadParams, paramURLDrawableHandler);
        paramOutputStream.close();
        paramURLDrawableHandler = new File(str3);
        localFile = new File(str1);
        if (!paramURLDrawableHandler.renameTo(localFile))
        {
          bace.a(paramURLDrawableHandler, localFile);
          paramURLDrawableHandler.delete();
        }
        bfhz.a(this.a.waitAppRuntime(null), false, new File(str1).length());
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    for (;;)
    {
      ...
      if (5 == apck.a(paramFile.getName()))
      {
        localObject = apcc.a(this.a, paramFile.getPath());
        if (localObject != null)
        {
