...
public class auep
{
  ...
  {
    this.jdField_a_of_type_Float = paramauep.jdField_a_of_type_Float;
    this.b = paramauep.b;
    this.c = paramauep.c;
    this.d = paramauep.d;
    this.jdField_a_of_type_AndroidGraphicsMatrix.set(paramauep.jdField_a_of_type_AndroidGraphicsMatrix);
  }
