...
{
  public aegd(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
            ...
            do
            {
              ...
              do
              {
                do
                {
                  ...
                  {
                    if (this.a.jdField_a_of_type_Aegv.jdField_b_of_type_JavaUtilList.contains(str)) {
                      this.a.jdField_a_of_type_Aegv.jdField_b_of_type_JavaUtilList.remove(str);
                    }
                    for (;;)
                    {
                      TroopMemberListActivity.a(this.a);
                      this.a.jdField_a_of_type_Aegv.notifyDataSetChanged();
                      return;
                      if (i != 0) {
                        this.a.jdField_a_of_type_Aegv.jdField_b_of_type_JavaUtilList.add(str);
                      }
                    }
                  }
                  if (!bool1) {
        ...
        QQToast.a(this.a, this.a.getString(2131694768), 0).b(this.a.getTitleBarHeight());
        return;
