...
{
  public adko(AuthDevOpenUgActivity paramAuthDevOpenUgActivity) {}
  ...
  public void onCheckDevLockSms(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    if (paramInt == 0)
    {
      ...
      asll.a().a(this.a.app, this.a, this.a.app.getCurrentAccountUin(), true);
      QQToast.a(this.a.getApplicationContext(), 2, this.a.getString(2131691933), 0).b(this.a.getTitleBarHeight());
    ...
    QQToast.a(this.a.getApplicationContext(), 1, this.a.getString(2131691975), 0).b(this.a.getTitleBarHeight());
  }
  ...
  public void onCheckDevLockStatus(WUserSigInfo paramWUserSigInfo, DevlockInfo paramDevlockInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    {
      QQToast.a(this.a, this.a.getString(2131691984), 0).b(this.a.getTitleBarHeight());
      return;
    }
