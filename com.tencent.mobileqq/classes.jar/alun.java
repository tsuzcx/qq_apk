  ...
  extends ambm
{
  ...
  public List<amfs> c = new ArrayList();
  public List<amfs> d = new ArrayList();
  public List<amfs> e = new ArrayList();
  public List<amfs> f = new ArrayList();
  public List<amfs> g = new ArrayList();
  
  public alun(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView)
  {
    ...
    this.jdField_a_of_type_Anxg = new aluo(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Int = afur.a(44.0F, paramContext.getResources());
  ...
  public alup a(int paramInt1, int paramInt2)
  {
    ...
    case 0: 
      ...
      localalup = new alup(this);
      localalup.jdField_a_of_type_ComTencentMobileqqPersistenceEntity = localEntity;
      localalup.jdField_a_of_type_Int = 0;
      return localalup;
    case 4: 
      localEntity = ((amfs)this.c.get(paramInt2)).jdField_a_of_type_ComTencentMobileqqPersistenceEntity;
      localalup = new alup(this);
      localalup.jdField_a_of_type_ComTencentMobileqqPersistenceEntity = localEntity;
      localalup.jdField_a_of_type_Int = 4;
      return localalup;
    case 6: 
      localEntity = ((amfs)this.d.get(paramInt2)).jdField_a_of_type_ComTencentMobileqqPersistenceEntity;
      localalup = new alup(this);
      localalup.jdField_a_of_type_ComTencentMobileqqPersistenceEntity = localEntity;
      localalup.jdField_a_of_type_Int = 6;
      return localalup;
    case 2: 
      localEntity = ((amfs)this.e.get(paramInt2)).jdField_a_of_type_ComTencentMobileqqPersistenceEntity;
      localalup = new alup(this);
      localalup.jdField_a_of_type_ComTencentMobileqqPersistenceEntity = localEntity;
      localalup.jdField_a_of_type_Int = 2;
      return localalup;
    case 8: 
      localEntity = ((amfs)this.f.get(paramInt2)).jdField_a_of_type_ComTencentMobileqqPersistenceEntity;
      localalup = new alup(this);
      localalup.jdField_a_of_type_ComTencentMobileqqPersistenceEntity = localEntity;
      localalup.jdField_a_of_type_Int = 8;
      return localalup;
    }
    Entity localEntity = ((amfs)this.g.get(paramInt2)).jdField_a_of_type_ComTencentMobileqqPersistenceEntity;
    alup localalup = new alup(this);
    localalup.jdField_a_of_type_ComTencentMobileqqPersistenceEntity = localEntity;
    localalup.jdField_a_of_type_Int = 13;
    return localalup;
  }
