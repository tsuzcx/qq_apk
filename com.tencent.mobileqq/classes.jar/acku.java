...
public class acku
  implements agpe
{
  public acku(CustomizeStrategyFactory.SkinRedPacketStrategy.1 param1) {}
  ...
  public void onResult(int paramInt, PreloadManager.PathResult paramPathResult)
  {
    ...
    try
    {
      ...
      BitmapFactory.Options localOptions = bacm.a(str1, paramInt);
    ...
    if (paramInt < j)
    {
      ...
      localObject2 = SafeBitmapFactory.decodeFile((String)localObject2, bacm.a((String)localObject2, i));
