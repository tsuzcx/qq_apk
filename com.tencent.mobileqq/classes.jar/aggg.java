...
public class aggg
  implements agim, agin, RelatedEmotionPanel.IAIORelatedEmotionExpandHelper
{
  ...
  public aggg(BaseChatPie paramBaseChatPie)
  {
  ...
  public void a(ChatMessage paramChatMessage, URLDrawable paramURLDrawable)
  {
    ...
    do
    {
      return;
      if (this.jdField_a_of_type_ComTencentMobileqqEmoticonviewRelateemoRelatedEmotionPanel == null) {
        this.jdField_a_of_type_ComTencentMobileqqEmoticonviewRelateemoRelatedEmotionPanel = ((RelatedEmotionPanel)View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131558651, null));
      }
      this.c = ((Integer)bhhr.a(BaseApplication.getContext(), "", "sp_key_input_height", Integer.valueOf(0))).intValue();
      if (this.c == 0) {
