...
{
  private SparseArray<List<blko>> a = new SparseArray();
  
  public blkn(AppRuntime paramAppRuntime)
  {
    super("com.tencent.qqfav.favoritesremotecommand");
    a(0, new blkp());
  }
  
  public boolean a(int paramInt, blko paramblko)
  {
    ...
    if (!((List)localObject).contains(paramblko)) {
      return ((List)localObject).add(paramblko);
    }
    return false;
  }
  
  public boolean b(int paramInt, blko paramblko)
  {
    List localList = (List)this.a.get(paramInt);
    if ((localList != null) && (localList.contains(paramblko))) {
      return localList.remove(paramblko);
    }
    return false;
  }
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    if (-1 != i)
    {
      ...
      } while (!((blko)paramOnInvokeFinishLinstener.next()).a(i, paramBundle));
    }
    label100:
    do
    {
