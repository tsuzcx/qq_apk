...
public class ndv
{
        ...
        if (localObject == null)
        {
          ...
          if (localObject != null)
          {
            ...
            if (localObject == null)
            {
              ...
              localObject = new NewIntent(paramContext.getApplicationContext(), mzx.class);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt, BusinessObserver paramBusinessObserver)
  {
    ...
    {
      paramContext = new NewIntent(paramContext.getApplicationContext(), mzx.class);
  ...
  private static void b(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, PublicAccountInfo paramPublicAccountInfo, EqqDetail paramEqqDetail, String paramString)
  {
    ...
    for (;;)
    {
      if (bool)
      {
        ...
        NewIntent localNewIntent = new NewIntent(paramContext.getApplicationContext(), nrz.class);
        ...
        localNewIntent.setObserver(new ndx(paramContext, paramQQAppInterface, paramPublicAccountInfo, paramEqqDetail, paramSessionInfo, paramString));
