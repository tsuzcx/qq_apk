  ...
  extends bjwu
{
  ...
  public bjwo(@NonNull bjww parambjww)
  {
    super(parambjww);
  }
  ...
  private boolean b()
  {
    try
    {
      ...
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView = ((StoryGuideLineView)a(2131371295));
      Object localObject1 = "";
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    ...
    if ((!paramBoolean3) || (paramBoolean4))
    {
      ...
      {
        localObject = this.jdField_a_of_type_Bjww.a();
        vvg localvvg = this.jdField_a_of_type_Bjww.a();
        if (localObject != null) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView.setLinkerObject((bkja)localObject);
        }
        if (this.jdField_a_of_type_Boolean) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView.setFollow();
        }
        if (localvvg != null) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView.setStoryTag(localvvg);
        }
      }
      if ((this.jdField_a_of_type_Bjww instanceof bkpf))
      {
        ...
        if (!((bkpf)this.jdField_a_of_type_Bjww).r)
        {
          paramBoolean3 = true;
  ...
  protected boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          return bool;
          if ((paramMessage.obj == null) || (!(paramMessage.obj instanceof bjwp))) {
            break;
          }
          bjwp localbjwp = (bjwp)paramMessage.obj;
          if (QLog.isColorLevel()) {
            QLog.d("Q.qqstory.publish.edit.StoryDoodle", 2, "showLimitView : left : " + localbjwp.d + " right : " + localbjwp.c + " top : " + localbjwp.jdField_a_of_type_Boolean + " bottom : " + localbjwp.b);
          }
          if (localbjwp.e)
          {
            a(localbjwp.d, localbjwp.c, localbjwp.jdField_a_of_type_Boolean, localbjwp.b);
            break;
          }
