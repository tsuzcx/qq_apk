...
public class orv
{
  public static void a(ToServiceMsg paramToServiceMsg, int paramInt)
  {
    ...
    if (paramToServiceMsg != null)
    {
      ...
      Long localLong = (Long)paramToServiceMsg.getAttribute(oqg.d);
    ...
    for (;;)
    {
      try
      {
        ((ocg)localObject).a("is_reddot", paramToServiceMsg);
        if (!bool1) {
          continue;
        }
        paramToServiceMsg = "1";
        ((ocg)localObject).a("hit_preload", paramToServiceMsg);
        ((ocg)localObject).a("refresh_cost", String.valueOf(l));
        ((ocg)localObject).a("refresh_num", String.valueOf(paramInt));
      }
  ...
  {
    ort.a().a(new FeedsPreloadDataReport.1(paramString1, paramString2));
  }
  ...
  public static void a(boolean paramBoolean, int paramInt)
  {
    ...
    try
    {
      for (;;)
      {
        localocg.a("preload_reddot", str);
        localocg.a("preload_num", String.valueOf(paramInt));
        a("0X8009C15", localocg.a());
        return;
        str = "0";
      }
    }
  ...
  public static void a(boolean paramBoolean, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        localocg.a("preload_reddot", str);
        localocg.a("preload_num", String.valueOf(paramInt));
        localocg.a("package_size", String.valueOf(paramLong));
        if (paramLong <= 20000L) {
          continue;
        }
        str = "1";
        localocg.a("is_too_large", str);
      }
      catch (JSONException localJSONException)
      {
