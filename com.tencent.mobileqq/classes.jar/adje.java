  ...
  implements adif, View.OnClickListener
{
  ...
  public adje(BaseChatPie paramBaseChatPie)
  {
  ...
  private void a(RedTouch paramRedTouch, int paramInt)
  {
    ...
    {
      BusinessInfoCheckUpdate.RedTypeInfo localRedTypeInfo = ((avps)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(paramInt);
  ...
  private void a(RedTouch paramRedTouch, int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0)
    {
      BusinessInfoCheckUpdate.AppInfo localAppInfo = ((avps)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(paramInt1, String.valueOf(paramInt2));
  ...
  private void h()
  {
    this.o = actj.a(4.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (AppSetting.jdField_d_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(ajya.a(2131714184));
      }
      return;
      bool1 = false;
      break;
    ...
    label114:
    this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(ajya.a(2131714191));
  }
  ...
  public void a(TextView paramTextView)
  {
    ...
    if (paramTextView != null)
    {
      ...
      if ((localObject instanceof RelativeLayout.LayoutParams))
      {
        ...
        ((RelativeLayout.LayoutParams)localObject).leftMargin = actj.a(14.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
  ...
  public void a(Boolean paramBoolean)
  {
    ...
    {
      axmv.a((SystemBarCompact)localObject, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().getWindow(), paramBoolean);
      p();
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    int i2 = 2130838020;
    boolean bool = true;
    Object localObject = (adjp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(23);
    if ((localObject != null) && ((((adjp)localObject).b()) || (this.jdField_f_of_type_Boolean))) {}
    for (int i1 = 1;; i1 = 0)
    {
  ...
  protected void b()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout != null) && (this.jdField_a_of_type_Boolean) && (this.jdField_b_of_type_Boolean)) {
      if (this.jdField_a_of_type_AndroidWidgetImageButton != null)
      {
        ...
        if (this.jdField_a_of_type_AndroidWidgetImageButton != null)
        {
          this.jdField_a_of_type_AndroidWidgetImageButton.setSelected(false);
          if (AppSetting.jdField_d_of_type_Boolean) {
            this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(ajya.a(2131714179));
          }
        }
        if (this.jdField_b_of_type_AndroidWidgetImageButton == null) {
          break label787;
        ...
        if (this.jdField_b_of_type_AndroidWidgetImageButton != null)
        {
          this.jdField_b_of_type_AndroidWidgetImageButton.setSelected(false);
          if (AppSetting.jdField_d_of_type_Boolean) {
            this.jdField_b_of_type_AndroidWidgetImageButton.setContentDescription(ajya.a(2131714176));
          }
        }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
        {
          ...
          ((FrameLayout.LayoutParams)localObject1).leftMargin = actj.a(8.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton != null)
        {
          ...
          if ((localObject2 instanceof LinearLayout.LayoutParams))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setText("");
            if (AppSetting.jdField_d_of_type_Boolean) {
              this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setContentDescription(ajya.a(2131714186));
            }
    ...
    while ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aetn))
    {
      for (;;)
      {
        int i1;
        return;
        localObject1 = (ViewStub)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout.findViewById(2131362361);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton != null)
    {
      ...
      if ((localObject2 instanceof LinearLayout.LayoutParams))
      {
        ...
        if ((this.jdField_e_of_type_Int != -1) && (this.jdField_f_of_type_Int != -1))
        {
          ...
          if (AppSetting.jdField_d_of_type_Boolean) {
            this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setContentDescription(ajya.a(2131714189));
          }
          if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
          {
            localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton;
  ...
  {
    Object localObject1 = (adjp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(23);
    boolean bool = paramBoolean;
    if (localObject1 != null) {
      if (!((adjp)localObject1).b())
      {
        bool = paramBoolean;
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton != null) && (this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Boolean))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setText(2131690745);
      if (AppSetting.jdField_d_of_type_Boolean) {
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setContentDescription(ajya.a(2131714187));
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setVisibility(0);
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setEnabled(true);
      ...
      if ((localObject1 instanceof LinearLayout.LayoutParams))
      {
        ...
        ((LinearLayout.LayoutParams)localObject1).leftMargin = actj.a(2.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
        ((LinearLayout.LayoutParams)localObject1).rightMargin = actj.a(6.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
      ...
      if ((localObject2 instanceof LinearLayout.LayoutParams))
      {
        ...
        {
          ((LinearLayout.LayoutParams)localObject2).width = (((LinearLayout.LayoutParams)localObject2).width + this.g + this.h + this.k + this.l - actj.a(8.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources()));
    ...
    for (int i1 = 2130838020;; i1 = 2130838021)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setText("");
      if (AppSetting.jdField_d_of_type_Boolean) {
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setContentDescription(ajya.a(2131714182));
      }
      localObject1 = this.jdField_a_of_type_AndroidWidgetLinearLayout.getLayoutParams();
      if ((localObject1 instanceof LinearLayout.LayoutParams))
      {
  ...
  public boolean c()
  {
    adjp localadjp = (adjp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(23);
    return (localadjp != null) && ((localadjp.b()) || (this.jdField_f_of_type_Boolean));
  }
  ...
  void e()
  {
    ...
    {
      BusinessInfoCheckUpdate.RedTypeInfo localRedTypeInfo = ((avps)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(10);
  ...
  public void g()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout != null) && (b()) && (this.jdField_b_of_type_Boolean))
    {
      ...
      int i1 = actj.a(10.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout != null) && (this.jdField_b_of_type_Int != -1) && (this.jdField_c_of_type_Int != -1))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(actj.a(1.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources()));
      }
