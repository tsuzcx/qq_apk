...
public class bkqk
{
  ...
  static
  {
    ...
    for (;;)
    {
      ...
      {
        if (bkqk.class.getName().equals(arrayOfStackTraceElement[i].getClassName())) {
  ...
  public bkqk a(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    return this;
  }
  
  public bkqk a(String paramString1, int paramInt, String paramString2)
  {
  ...
  public bkqk b(String paramString1, int paramInt, String paramString2)
  {
    a(paramString1, paramInt, 4, paramString2, this.b);
    return this;
  }
  
  public bkqk c(String paramString1, int paramInt, String paramString2)
  {
