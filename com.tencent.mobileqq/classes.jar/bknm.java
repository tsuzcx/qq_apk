...
{
  bknm(bknl parambknl, ChannelProxy.AuthListResult paramAuthListResult) {}
  ...
  public void onCmdListener(boolean paramBoolean, JSONObject paramJSONObject)
  {
    ...
    do
    {
      ...
      while (paramJSONObject.hasNext())
      {
        ...
        localArrayList2.add(bknl.a(this.jdField_a_of_type_Bknl, (INTERFACE.StUserSettingInfo)localObject));
      }
