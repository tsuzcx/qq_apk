...
public class bglx
{
  ...
  private OnPluginInstallListener jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener = new bgly(this);
  
  public bglx(Context paramContext, bgkq parambgkq, QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Bgkq = parambgkq;
  ...
  private List<String> a()
  {
    ...
    if (bbev.a(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      if (i < k)
      {
        ...
        if ((str.equals("Photoplus.apk")) && (bfni.d())) {}
        for (;;)
        {
          i += 1;
          break;
    ...
    if ((bbct.e()) || (bbdj.a() <= 1.048576E+008F))
    {
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    localEditor.commit();
    this.jdField_a_of_type_Bgkq.a(paramString, this.jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener, true);
    if (("qqreaderplugin.apk".equals(paramString)) && (bgto.a(this.jdField_a_of_type_AndroidContentContext) == -1))
    {
    ...
    bggu.a(1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  private void c()
  {
    if (!PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_AndroidContentContext).getString("plugin_pre_install_qq_version", "").equals(bbct.c()))
    {
      SharedPreferences.Editor localEditor = PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_AndroidContentContext).edit();
  ...
  public void a()
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        try
        {
          if (this.jdField_a_of_type_Bgkq.isPlugininstalled(str)) {
            continue;
          }
          int i = a(str);
          if (i >= 10) {
