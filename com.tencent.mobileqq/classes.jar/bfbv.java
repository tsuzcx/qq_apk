  ...
  implements View.OnClickListener, bfbu
{
  ...
  public bfbv(PublishHomeWorkFragment paramPublishHomeWorkFragment, String paramString)
  {
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131373089);
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131379245));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
      if (!this.jdField_a_of_type_JavaLangBoolean.booleanValue()) {
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      }
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131379251));
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131379372);
  ...
  public void a(int paramInt)
  {
    ...
    {
      bgjt.a("Grp_edu", "homework", "createHW_lele", 0, 0, new String[] { str, localBundle.getString("reportIdentity", ""), localBundle.getString("reportCourse", "") });
      return;
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    catch (JSONException paramIntent)
    {
      ...
      localObject = anni.a(2131696702) + " (" + this.jdField_a_of_type_Int + anni.a(2131696703) + ")\n" + anni.a(2131696704) + "\n" + this.jdField_b_of_type_JavaLangString;
  ...
  protected void a(View paramView)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder(((bezs)aqlk.a().a(605)).a());
