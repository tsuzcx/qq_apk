...
{
  public aavj(GdtVideoImaxFragment paramGdtVideoImaxFragment, float paramFloat1, float paramFloat2, int paramInt) {}
  
  public void onAnimationUpdate(ValueAnimator paramValueAnimator)
  {
    float f = paramValueAnimator.getAnimatedFraction();
    f = this.jdField_a_of_type_Float + f * (this.b - this.jdField_a_of_type_Float);
    aase.a("GdtVideoImaxFragment", "onAnimationUpdate() called with: current = [" + f + "]");
