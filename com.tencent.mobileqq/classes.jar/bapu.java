...
public final class bapu
{
  ...
  public static <T extends bapt> T a(int paramInt1, int paramInt2, String paramString)
  {
    if (paramInt1 == 2) {
  ...
  public static String a(@NonNull String paramString, @NonNull Bundle paramBundle)
  {
    ...
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_TROOP_UIN"))
    {
      ...
      localObject = bhsz.a(paramString, "troopuin", (String)localObject);
    }
    ...
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_OWNER_UIN"))
    {
      ...
      paramString = bhsz.a((String)localObject, "troopowneruin", paramString);
    }
    localObject = paramString;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_IS_OWNER")) {
      localObject = bhsz.a(paramString, "isowner", paramBundle.getBoolean("TOGETHER_BUNDLE_KEY_IS_OWNER", false) + "");
    }
    paramString = (String)localObject;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_IS_ADMIN")) {
      paramString = bhsz.a((String)localObject, "isadmin", paramBundle.getBoolean("TOGETHER_BUNDLE_KEY_IS_ADMIN", false) + "");
    }
    localObject = paramString;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_OPEN_STATUS")) {
      localObject = bhsz.a(paramString, "isopen", paramBundle.getBoolean("TOGETHER_BUNDLE_KEY_OPEN_STATUS", false) + "");
    }
    paramString = (String)localObject;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_FROM_TYPE")) {
      paramString = bhsz.a((String)localObject, "from", paramBundle.getInt("TOGETHER_BUNDLE_KEY_FROM_TYPE", 0) + "");
    }
    if (QLog.isColorLevel()) {
  ...
  public static void a(int paramInt, java.util.Map<String, Object> paramMap, java.util.Map<String, String> paramMap1)
  {
    ...
    //   288: invokestatic 223	baph:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)Lbaph;
    //   291: aload_1
    //   292: iload_0
    //   293: iload_3
    //   294: aload_2
    //   295: lload 4
    //   297: invokevirtual 226	baph:a	(Lcom/tencent/mobileqq/app/BaseActivity;IILjava/lang/String;J)V
    //   300: return
    //   301: iconst_m1
    //   302: istore_3
    //   303: goto -186 -> 117
  ...
  public static void a(@NonNull Context paramContext, int paramInt1, @NonNull String paramString1, @Nullable String paramString2, @NonNull Bundle paramBundle, int paramInt2)
  {
    ...
    {
    default: 
      QQToast.a(paramContext, 0, 2131721418, 0).a();
      return;
    case 1: 
  ...
  public static void a(@NonNull QQAppInterface paramQQAppInterface, @NonNull bapt parambapt, boolean paramBoolean)
  {
    a(paramQQAppInterface, parambapt.d + "_" + parambapt.jdField_e_of_type_Int + "_" + parambapt.jdField_e_of_type_JavaLangString, paramBoolean, true);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 2)
      {
        ...
        paramString = ((alto)localObject).a(paramString, false);
        if (paramString != null)
        {
          bool = paramString.isTogetherBusinessOpen(paramInt2);
          paramString.setTogetherBusiness(paramBoolean, paramInt2);
          ((alto)localObject).a(paramString);
          if (QLog.isColorLevel()) {
            QLog.i("TogetherUtils", 2, "setBusinessTogetherOpen troopinfo saved, last=" + bool);
          }
          i = j;
  ...
  public static boolean a(@NonNull QQAppInterface paramQQAppInterface, @NonNull bapt parambapt)
  {
    return a(paramQQAppInterface, parambapt.d + "_" + parambapt.jdField_e_of_type_Int + "_" + parambapt.jdField_e_of_type_JavaLangString, true, true);
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      paramQQAppInterface = localalto.a(paramString, false);
  ...
  public static String b(@NonNull String paramString, @NonNull Bundle paramBundle)
  {
    ...
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_C2C_FRIEND_OPENID")) {
      str = bhsz.a(paramString, "friend_user_openid", paramBundle.getString("TOGETHER_BUNDLE_KEY_C2C_FRIEND_OPENID"));
    }
    paramString = str;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_OPEN_STATUS")) {
      paramString = bhsz.a(str, "isopen", paramBundle.getBoolean("TOGETHER_BUNDLE_KEY_OPEN_STATUS") + "");
    }
    str = paramString;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_FROM_TYPE")) {
      str = bhsz.a(paramString, "from", paramBundle.getInt("TOGETHER_BUNDLE_KEY_FROM_TYPE") + "");
    }
    if (QLog.isColorLevel()) {
