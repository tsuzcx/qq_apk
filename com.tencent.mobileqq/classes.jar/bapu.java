...
public class bapu
  implements View.OnClickListener, ViewTreeObserver.OnPreDrawListener, bapy, baqd, fx
{
  ...
  bgfo jdField_a_of_type_Bgfo;
  bggs jdField_a_of_type_Bggs;
  private bggy jdField_a_of_type_Bggy = new bapv(this);
  public ETTextView a;
  ...
  public Observer a;
  WeakReference<bapz> jdField_a_of_type_MqqUtilWeakReference;
  boolean jdField_a_of_type_Boolean;
  long jdField_b_of_type_Long;
  View jdField_b_of_type_AndroidViewView;
  ImageView jdField_b_of_type_AndroidWidgetImageView;
  SingleLineTextView jdField_b_of_type_ComTencentWidgetSingleLineTextView;
  WeakReference<baqd> jdField_b_of_type_MqqUtilWeakReference;
  ...
  public bapu(Context paramContext, AppInterface paramAppInterface, View paramView, String paramString)
  {
    this.jdField_a_of_type_JavaUtilObserver = new bapw(this);
  ...
  private void m()
  {
    if (jdField_a_of_type_ArrayOfInt == null)
    {
      ...
      jdField_a_of_type_ArrayOfInt[0] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166465);
      jdField_a_of_type_ArrayOfInt[1] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166466);
      jdField_a_of_type_ArrayOfInt[2] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166467);
      jdField_a_of_type_ArrayOfInt[3] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166469);
      jdField_a_of_type_ArrayOfInt[4] = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298445);
      jdField_a_of_type_ArrayOfInt[5] = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298443);
      jdField_a_of_type_ArrayOfInt[6] = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298444);
      jdField_a_of_type_ArrayOfInt[7] = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298446);
      ...
      jdField_a_of_type_ArrayOfInt[13] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166468);
      jdField_a_of_type_ArrayOfInt[14] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166465);
      jdField_a_of_type_ArrayOfInt[15] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167350);
      jdField_a_of_type_ArrayOfInt[16] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167337);
    }
  }
  ...
  private void n()
  {
    ...
    if (bool1)
    {
      localObject = bfzl.c(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.time * 1000L);
  ...
  private void o()
  {
    int j;
    Object localObject;
    if (this.jdField_a_of_type_Bgfo.jdField_a_of_type_Bgfq != null)
    {
      j = 1;
      if (j == 0) {
        break label229;
      }
      localObject = this.jdField_a_of_type_Bgfo.n;
      label24:
      ...
      if ((this.jdField_a_of_type_Bgfo.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (TextUtils.isEmpty(this.jdField_a_of_type_Bgfo.n))) {
        break label246;
      }
      localObject = this.jdField_a_of_type_Bgfo.n;
      label86:
      ...
      this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setHint(2131698507);
      this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setHintTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166466));
    }
    for (;;)
    {
  ...
  public View a(RichStatus paramRichStatus)
  {
    ...
    paramRichStatus.signType = this.jdField_a_of_type_Bgfo.g;
    boolean bool;
    if (this.jdField_a_of_type_Bgfo.jdField_a_of_type_Bgfq != null)
    {
      bool = true;
      this.jdField_a_of_type_Boolean = bool;
      this.jdField_b_of_type_Boolean = this.jdField_a_of_type_Bgfo.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get();
  ...
  protected bgfo a()
  {
    ...
    return baos.a().a(this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.tplId);
  }
  ...
  protected CharSequence a(RichStatus paramRichStatus, baqd parambaqd, int paramInt)
  {
    ...
    baoy localbaoy = (baoy)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(15);
    Resources localResources = this.jdField_a_of_type_AndroidContentContext.getResources();
    SpannableString localSpannableString = new SpannableString(paramRichStatus.toSpannableStringWithoutAction(parambaqd));
    if ((paramRichStatus != null) && (localResources != null) && (!TextUtils.isEmpty(paramRichStatus.actionText)))
    {
      ...
      parambaqd = (baqd)localObject;
      if (!TextUtils.isEmpty(paramRichStatus.dataText)) {
        parambaqd = (String)localObject + paramRichStatus.dataText;
      }
      Drawable localDrawable = localResources.getDrawable(2130849505);
      localObject = new SpannableStringBuilder(localSpannableString);
      ((SpannableStringBuilder)localObject).insert(0, "[S] ");
      int j;
      if (localbaoy != null)
      {
        paramRichStatus = localbaoy.a(paramRichStatus.actionId, 200);
        paramRichStatus = new bhji(localResources, paramRichStatus, false, false);
      ...
      label273:
      for (paramRichStatus = new bank(paramRichStatus, 1, parambaqd, j, localDrawable, paramInt);; paramRichStatus = new bank(paramRichStatus, 0, parambaqd, j, localDrawable, paramInt))
      {
        ((SpannableStringBuilder)localObject).setSpan(paramRichStatus, 0, "[S]".length(), 17);
        return new QQText((CharSequence)localObject, 1);
        paramRichStatus = bfpx.a(localResources, 2130849498);
        break;
      }
    }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561462, null, false));
    ...
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131376567);
    this.e = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131370143);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131370233);
    this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131370234);
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131365665);
    this.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131379870));
    this.jdField_b_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131379704));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131369200));
    UIUtils.expandViewTouchArea(this.jdField_b_of_type_AndroidWidgetImageView, m, m, m, m);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131369431));
    UIUtils.expandViewTouchArea(this.jdField_a_of_type_AndroidWidgetImageView, m, m, m, m);
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView = ((ETTextView)this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131379837));
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setOnTextOrFontChangeListener(this);
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setMovementMethod(baqe.a());
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnTouchListener(mum.a);
  ...
  public void a(bapz parambapz)
  {
    if (parambapz != null)
    {
      this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(parambapz);
      return;
    }
  ...
  {
    QLog.d("BaseSignViewHolder", 1, new Object[] { "onClick topic=", parambaqc });
    if (this.jdField_b_of_type_MqqUtilWeakReference != null) {}
    for (baqd localbaqd = (baqd)this.jdField_b_of_type_MqqUtilWeakReference.get();; localbaqd = null)
    {
      if (localbaqd != null) {
        localbaqd.a(parambaqc, paramView);
      }
      return;
    }
  }
  ...
  public void a(baqd parambaqd)
  {
    if (parambaqd != null)
    {
      this.jdField_b_of_type_MqqUtilWeakReference = new WeakReference(parambaqd);
      return;
    }
  ...
  {
    baqi.a(paramETTextView, paramETTextView.getText(), 1);
  }
  
  public void a(ETTextView paramETTextView, CharSequence paramCharSequence)
  {
    baqi.a(paramETTextView, paramCharSequence, 0);
  }
  ...
  protected void d()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130846027);
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131377490, Integer.valueOf(-1));
    e();
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849581);
    this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130846024);
    a(true);
  }
  ...
  protected void f()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable == null)
    {
      ...
      localbghk = new bghk(this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable, this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.i);
      this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable.a(localbghk);
      if (a() != -1) {
        break label190;
      }
    }
    ...
    {
      localbghk.a(bool);
      this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable.a(this.jdField_a_of_type_Bggy);
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131377490, Integer.valueOf(this.jdField_a_of_type_Bgfo.f));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131377498, Integer.valueOf(this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.tplId));
  ...
  protected void g()
  {
    ...
    {
      this.jdField_a_of_type_Bggs = new bggs(this.jdField_a_of_type_ComTencentCommonAppAppInterface, j);
      localbghn = new bghn(this.jdField_a_of_type_Bggs, this.jdField_a_of_type_ComTencentCommonAppAppInterface, k);
      ...
      {
        localbghn.a(localETTextView, f1, bool);
        this.jdField_a_of_type_Bggs.a(localbghn);
        localbghn.a(a());
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131377491, Integer.valueOf(j));
        return;
      }
    }
    bghn localbghn = (bghn)this.jdField_a_of_type_Bggs.a();
    ...
    {
      localbghn.a(localETTextView, f1, bool);
      ((bghn)this.jdField_a_of_type_Bggs.a()).a(j, k);
      break;
      bool = false;
    }
  }
  ...
  protected void h()
  {
    ...
    int n = jdField_a_of_type_ArrayOfInt[3];
    this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.setShadowColor(n);
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Bgfo.e)) {
      j = Color.parseColor(this.jdField_a_of_type_Bgfo.e);
    }
    boolean bool = a(j);
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setTextColor(j);
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setHintTextColor(k);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849582);
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130846025);
    }
  }
  ...
  public void j()
  {
    ...
    label59:
    for (localObject = this.jdField_a_of_type_AndroidContentContext.getString(2131719598);; localObject = this.jdField_a_of_type_AndroidContentContext.getString(2131719597))
    {
  ...
  public void k()
  {
    ...
    if ((this.jdField_a_of_type_Bggs != null) && (this.jdField_a_of_type_Bggs.a() != null)) {
      this.jdField_a_of_type_Bggs.a().c();
    }
    if (this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable != null) {
  ...
  public void onClick(View paramView)
  {
    ...
    {
      localbapz = (bapz)this.jdField_a_of_type_MqqUtilWeakReference.get();
    ...
    for (;;)
    {
      ...
      if ((j > 0) && (localbapz != null)) {
        localbapz.a(paramView, j, this);
      }
