...
public class axro
  extends bilh
{
  public axro(GameRoomInviteActivity paramGameRoomInviteActivity) {}
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 0)
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.setComplete(new axrp(this));
    ...
    {
      this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.a.setText(anvx.a(2131704572));
      this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.c();
    ...
    this.a.jdField_a_of_type_Bilj.a();
  ...
  public void a(submsgtype0xdd.MsgBody paramMsgBody)
  {
    ...
    case 1: 
      do
      {
        ...
        {
          ((axsh)localObject).jdField_a_of_type_Boolean = bool;
