...
public class zch
{
  ...
  private static int a(zcq paramzcq)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 30	zcq:b	()Ljava/lang/String;
    ...
    //   557: aload 8
    //   559: invokestatic 134	zch:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   562: aload 6
    //   564: astore 4
    //   566: aload 8
  ...
  public static void a(Context paramContext)
  {
    ...
    zcq localzcq = zcr.a(paramContext, "dex");
    if ((jdField_a_of_type_Int == 0) && (a(paramContext, localzcq)))
    {
      a(localzcq);
      int j;
      if (jdField_a_of_type_Int == 500) {
        if ((localzcq.b()) && (PatchCommonUtil.isArtGeN()) && (!SoLoadUtil.a()))
        {
          j = a(localzcq);
          i = j;
          if (j != 800)
          {
            String str = akhc.a(BaseApplicationImpl.sApplication, 0);
      ...
      for (int i = j;; i = 0)
      {
        a(paramContext, localzcq);
        PatchReporter.reportPatchEvent(paramContext, "", "actPatchInstall", jdField_a_of_type_Int, localzcq.b(), i);
        ...
        if (PatchCommonUtil.isDalvik()) {
          PatchResolveForDalvik.a(paramContext, localzcq);
        }
      }
    }
  ...
  private static void a(Context paramContext, zcq paramzcq)
  {
    paramContext = new DexPatchInstaller.1(paramzcq, paramContext);
  ...
  private static void a(zcq paramzcq)
  {
    long l = System.currentTimeMillis();
    try
    {
      paramzcq = paramzcq.b();
      String str = PatchCommonUtil.getPatchPath(paramzcq);
      if ("Success".equals(akhc.a(BaseApplicationImpl.sApplication, str, null, false)))
      {
        jdField_a_of_type_Int = 500;
        jdField_a_of_type_JavaLangString = paramzcq;
      }
      for (;;)
      {
    ...
    catch (Throwable paramzcq)
    {
      for (;;)
      {
        jdField_a_of_type_Int = 502;
        QLog.d("PatchLogTag", 1, "DexPatchInstaller injectDexPatch throwable=" + paramzcq);
      }
    }
  }
  
  private static boolean a(Context paramContext, zcq paramzcq)
  {
    if (paramzcq == null) {
      QLog.d("PatchLogTag", 1, "DexPatchInstaller checkDexPatchConfigAndStatus patch config is null");
    }
    while (!paramzcq.a(paramContext, true)) {
      return false;
    }
    String str = paramzcq.b();
    ...
    if (localFile.length() != paramzcq.b())
    {
