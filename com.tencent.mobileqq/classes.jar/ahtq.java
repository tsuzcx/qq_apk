              ...
              try
              {
                ...
                else
                {
                  if (localStructMsgForGeneralShare.msgId > 0L)
                  {
                    ...
                    ThreadManager.getSubThreadHandler().postDelayed(new ahtr(this, localStructMsgForGeneralShare, (QQAppInterface)localObject1), 0L);
                  }
                  if (QLog.isDevelopLevel()) {
                  ...
                  if ((localStructingMsgViewHolder != null) && (localStructMsgForGeneralShare.hasFlag(16)))
                  {
                    ...
                    ThreadManager.post(new ahts(this, localStructingMsgViewHolder, (QQAppInterface)localObject1), 2, null, false);
                  }
