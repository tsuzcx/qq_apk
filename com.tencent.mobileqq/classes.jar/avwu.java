...
{
  avwu(avws paramavws, ayxn paramayxn) {}
  ...
  public void onCallback(EIPCResult paramEIPCResult)
  {
    ...
    if ((paramEIPCResult == null) || (paramEIPCResult.data == null))
    {
      ...
      this.jdField_a_of_type_Ayxn.a(null, -1, "eipcResult is null");
      return;
    }
    Object localObject;
    if (paramEIPCResult.code == 0)
    {
      ...
      localObject = this.jdField_a_of_type_Avws;
      if (bool) {}
      for (;;)
      {
        avws.a((avws)localObject, i);
        paramEIPCResult = paramEIPCResult.data.getString("msg");
        this.jdField_a_of_type_Ayxn.a(bool, paramEIPCResult);
        return;
        i = 10;
      }
    }
    if (paramEIPCResult.code == -102)
    {
      ...
      paramEIPCResult = paramEIPCResult.data.getString("msg");
      this.jdField_a_of_type_Ayxn.a((String)localObject, i, paramEIPCResult);
      return;
    }
    avws.a(this.jdField_a_of_type_Avws, 11);
    QLog.e("FaceContext", 1, new Object[] { "refreshIpStateOnSubProcess error, unknown code : ", Integer.valueOf(paramEIPCResult.code) });
    this.jdField_a_of_type_Ayxn.a(null, -1, "unknown code");
  }
}
