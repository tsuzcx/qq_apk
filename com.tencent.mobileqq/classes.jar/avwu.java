...
public class avwu
  extends avxd
{
  public avwu(Context paramContext)
  {
    super(paramContext);
  }
  ...
  public void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString, avwx paramavwx)
  {
    paramavwx.f = paramInt1;
    if (paramInt2 == 0) {
      paramavwx.b = 0;
    }
    for (;;)
    {
      paramAppInterface = (aszf)paramAppInterface.getManager(106);
      if (paramAppInterface != null)
      {
        paramavwx.d = paramAppInterface.a();
        paramavwx.e = paramAppInterface.b();
      }
      paramavwx.g = Calendar.getInstance().get(11);
      paramavwx.h = bbfj.a(BaseApplication.getContext());
      return;
      if (paramInt2 == 3000)
      {
        paramavwx.b = 3000;
      ...
      else
      {
        if (paramInt2 == 1)
        {
          ...
          for (;;)
          {
            ...
            paramavwx.c = paramString.wMemberNum;
            break;
            paramavwx.b = 1;
            continue;
            paramavwx.b = 3;
