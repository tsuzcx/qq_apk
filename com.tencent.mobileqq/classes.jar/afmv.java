  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    NotificationView.a(this.a, (structmsg.StructMsg)localafmp.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.get(), localafmp.c);
    ...
    label265:
    String str1;
    if (localafmp.b < this.a.jdField_a_of_type_Afmn.jdField_a_of_type_Int)
    {
      paramView = "1";
      ...
      axqy.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_public", "", "oper", "focus_notice", 0, 0, "", "", "", localafmp.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.req_uin.get() + "");
      NotificationView.a(this.a, localafmp.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.req_uin.get(), (structmsg.StructMsg)localafmp.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.get());
    }
    for (;;)
    {
      ...
      if (localafmp.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.group_msg_type.get() == 2)
      {
        ...
        bbbp.a("Grp_contacts_news", "notice", "agree_invite", 0, 0, new String[] { str3, paramView, str1, "1" });
      }
      else
      {
        NotificationView.a(this.a, 1, (structmsg.StructMsg)localafmp.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.get());
        ...
        {
          bbbp.a("Grp_contacts_news", "notice", "agree_ask", 0, 0, new String[] { str3, paramView, str1, "1" });
        }
        else if (localafmp.jdField_a_of_type_Int == 2)
        {
          ...
          continue;
          label752:
          NotificationView.a(this.a, 0, (structmsg.StructMsg)localafmp.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.get());
          if (localafmp.jdField_a_of_type_Int == 1) {
            bbbp.a("Grp_contacts_news", "notice", "refuse_ask", 0, 0, new String[] { str3, paramView, str1, "1" });
          } else if (localafmp.jdField_a_of_type_Int == 2) {
            bbbp.a("Grp_contacts_news", "notice", "refuse_invite", 0, 0, new String[] { str3, paramView, str1, "1" });
          }
        }
      }
    }
