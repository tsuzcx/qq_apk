...
public final class bmqy
{
  ...
  public static String a(String paramString, boolean paramBoolean)
  {
    ...
    for (paramString = "&";; paramString = "?")
    {
      ...
      bmqw.e("ReaderUrlHelper", "getUrlWithBid = " + (String)localObject);
      return localObject;
  ...
  private static String d(String paramString)
  {
    String str2 = null;
    String str1;
    if ((bmpn.a != null) && (bmpn.a.size() > 0)) {
      str1 = (String)bmpn.a.get(paramString);
    }
    for (;;)
    {
      bmqw.d("ReaderUrlHelper", "getUrl = " + str1);
      return str1;
      if (bmpn.a != null) {
        str2 = (String)bmpn.a.get(paramString);
      }
      str1 = str2;
      if (str2 == null) {
