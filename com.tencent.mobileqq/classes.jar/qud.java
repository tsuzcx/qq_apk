  ...
  extends BaseAdapter
{
  ...
  List<sqw> jdField_b_of_type_JavaUtilList;
  
  public qud(ComponentContentGridImage paramComponentContentGridImage, que paramque)
  {
    a(paramque);
  }
  ...
  public void a(que paramque)
  {
    this.jdField_b_of_type_JavaUtilList = paramque.a();
    this.jdField_a_of_type_JavaUtilList = paramque.b();
    this.jdField_a_of_type_JavaLangString = paramque.a();
    this.jdField_b_of_type_JavaLangString = paramque.b();
    a();
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      ((SquareCornerTextImageView)paramView).a((sqw)this.jdField_b_of_type_JavaUtilList.get(paramInt), ((URL)this.jdField_a_of_type_JavaUtilList.get(paramInt)).toString(), b(), a());
