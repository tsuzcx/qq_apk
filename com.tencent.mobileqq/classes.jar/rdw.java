...
public class rdw
{
  ...
  public static rdw a(articlesummary.RecommendFollowInfos paramRecommendFollowInfos)
  {
    boolean bool = true;
    rdw localrdw = new rdw();
    ...
    for (;;)
    {
      localrdw.jdField_a_of_type_Boolean = bool;
      if (paramRecommendFollowInfos.bytes_account_next_cookie.has()) {
        localrdw.jdField_a_of_type_ArrayOfByte = paramRecommendFollowInfos.bytes_account_next_cookie.get().toByteArray();
      }
      localrdw.jdField_a_of_type_Int = paramRecommendFollowInfos.uint32_card_style.get();
      localrdw.jdField_a_of_type_JavaLangString = paramRecommendFollowInfos.bytes_card_title.get().toStringUtf8();
      localrdw.jdField_b_of_type_JavaLangString = paramRecommendFollowInfos.bytes_jump_url.get().toStringUtf8();
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        localrdw.jdField_a_of_type_JavaUtilList.add(localRecommendFollowInfo);
        if ((localrdw.jdField_a_of_type_Int == 2) && (!TextUtils.isEmpty(localRecommendFollowInfo.className)))
        {
    ...
    if (!((HashMap)localObject2).isEmpty())
    {
      ...
      while (paramRecommendFollowInfos.hasNext())
      {
        ...
        {
          localObject3 = new rda();
          ((rda)localObject3).jdField_a_of_type_JavaLangString = ((String)((Map.Entry)localObject1).getKey());
          ((rda)localObject3).jdField_a_of_type_JavaUtilList = ((List)localObject2);
          localrdw.jdField_b_of_type_JavaUtilList.add(localObject3);
        }
      }
    }
    return localrdw;
  ...
  public static rdw a(oidb_0xc2f.GetFollowUserRecommendListRsp paramGetFollowUserRecommendListRsp)
  {
    rdw localrdw = new rdw();
    localrdw.jdField_b_of_type_JavaLangString = paramGetFollowUserRecommendListRsp.bytes_jump_url.get().toStringUtf8();
