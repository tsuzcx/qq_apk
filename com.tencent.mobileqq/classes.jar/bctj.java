...
public class bctj
{
  ...
  private static volatile bctj jdField_a_of_type_Bctj;
  ...
  bctn jdField_a_of_type_Bctn = new bctn();
  ...
  private LinkedList<bctm> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  private Stack<String> jdField_a_of_type_JavaUtilStack = new Stack();
  boolean jdField_a_of_type_Boolean = false;
  private bctp[] jdField_a_of_type_ArrayOfBctp = { new bctp("com.tencent.mtt", "qqBrowser"), new bctp("com.tencent.android.qqdownloader", "qqMarket"), new bctp("com.tencent.qqgame", "qqGame"), new bctp("com.tencent.qqmusic", "qqMusic"), new bctp("com.tencent.news", "qqNews"), new bctp("com.qq.reader", "qqReader"), new bctp("com.tencent.qqlive", "qqVideo"), new bctp("com.tencent.wblog", "qqMicroblog"), new bctp("com.tencent.qqphonebook", "qqPhonebook") };
  private int jdField_b_of_type_Int;
  private StringBuilder jdField_b_of_type_JavaLangStringBuilder = new StringBuilder("Thread info:\n");
  private String jdField_d_of_type_JavaLangString;
  
  protected bctj(Context paramContext)
  {
    jdField_a_of_type_AndroidContentContext = paramContext;
  }
  
  private bctj(Context paramContext, long paramLong)
  {
    jdField_a_of_type_AndroidContentContext = paramContext;
  ...
  public static bctj a(Context paramContext)
  {
    return a(paramContext, 3000L);
  }
  
  public static bctj a(Context paramContext, long paramLong)
  {
    if (jdField_a_of_type_Bctj == null) {}
    for (;;)
    {
      try
      {
        ...
        {
          if (anrj.a()) {
            jdField_a_of_type_Bctj = new bctj(BaseApplicationImpl.getApplication(), paramLong);
          }
        }
        else if (jdField_a_of_type_Bctj == null) {}
      }
      finally {}
      try
      {
        if ((anrj.a()) && ((jdField_a_of_type_Bctj instanceof bcto))) {
          jdField_a_of_type_Bctj = new bctj(BaseApplicationImpl.getApplication(), paramLong);
        }
        return jdField_a_of_type_Bctj;
      }
      finally {}
      jdField_a_of_type_Bctj = new bcto(BaseApplicationImpl.getApplication());
    }
  }
  ...
  private static Map<String, String> a()
  {
    ...
    localHashMap.put("param_MODEL", bgln.d());
    localHashMap.put("param_manu", bgln.k());
    localHashMap.put("param_OS", bgln.e());
    localHashMap.put("param_Resolution", MsfSdkUtils.getResolutionString(jdField_a_of_type_AndroidContentContext));
    localHashMap.put("param_IMEI", bgln.a());
    localHashMap.put("param_IMSI", bgln.b());
    localHashMap.put("param_NetworkType", "" + bgnt.b(jdField_a_of_type_AndroidContentContext));
    localHashMap.put("param_ProductVersion", "" + AppSetting.a());
    localHashMap.put("param_CPU", bgln.g());
    localHashMap.put("param_totalmemory", MsfSdkUtils.getTotalMemory());
    localHashMap.put("param_availmemory", String.valueOf(bgln.e() / 1024L) + "kB");
    ...
    localHashMap.put("param_Camera", "" + bgln.c());
    return localHashMap;
  }
  ...
  {
    Object localObject1 = bgvk.a("android.app.ActivityThread", "currentActivityThread", new Object[0], new Class[0]);
    paramContext = paramContext.getPackageName();
    paramContext = (Map)bgvk.a("android.app.LoadedApk", ((WeakReference)((Map)bgvk.a("android.app.ActivityThread", localObject1, "mPackages")).get(paramContext)).get(), "mReceivers");
  ...
  void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bctn.jdField_a_of_type_Boolean = ((JSONObject)localObject).getBoolean("control_switch");
      this.jdField_a_of_type_Bctn.jdField_a_of_type_Int = ((JSONObject)localObject).getInt("control_level");
      this.jdField_a_of_type_Bctn.jdField_b_of_type_Int = ((JSONObject)localObject).getInt("control_window");
      this.jdField_a_of_type_Bctn.c = ((JSONObject)localObject).getInt("control_freq");
      ...
      ((StringBuilder)localObject).append(",switch=").append(this.jdField_a_of_type_Bctn.jdField_a_of_type_Boolean);
      ((StringBuilder)localObject).append(",level=").append(this.jdField_a_of_type_Bctn.jdField_a_of_type_Int);
      ((StringBuilder)localObject).append(",window=").append(this.jdField_a_of_type_Bctn.jdField_b_of_type_Int);
      ((StringBuilder)localObject).append(",Freq=").append(this.jdField_a_of_type_Bctn.c);
  ...
  public void a(String paramString1, String paramString2, String paramString3, boolean paramBoolean1, long paramLong1, long paramLong2, HashMap<String, String> paramHashMap, String paramString4, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    adbs.a(paramString3, paramHashMap);
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean1, long paramLong1, long paramLong2, HashMap<String, String> paramHashMap, String paramString3, boolean paramBoolean2, boolean paramBoolean3)
  {
    a("", paramString1, paramString2, paramBoolean1, paramLong1, paramLong2, paramHashMap, paramString3, paramBoolean2, paramBoolean3);
  }
  ...
  public void a(StringBuilder paramStringBuilder)
  {
    ...
    //   13: invokestatic 1014	android/os/Process:myPid	()I
    ...
    //   74: invokevirtual 1024	java/io/File:list	()[Ljava/lang/String;
    //   77: astore 10
    //   79: aload 8
    //   81: astore 7
    //   83: aload 9
    ...
    //   90: dup
    //   91: invokespecial 912	java/util/HashMap:<init>	()V
    //   94: astore 8
    //   96: iconst_0
    //   97: istore_2
    //   98: aload 5
    ...
    //   236: astore 6
    //   238: aload 8
    //   240: invokevirtual 1035	java/util/HashMap:entrySet	()Ljava/util/Set;
    ...
    //   283: checkcast 1037	java/util/Map$Entry
    //   286: astore 9
    //   288: aload 5
    //   290: astore 7
    //   292: aload 5
    ...
    //   360: ifnull +8 -> 368
    //   363: aload 7
    //   365: invokevirtual 1056	java/io/BufferedReader:close	()V
    //   368: return
    //   369: aload 5
    //   371: astore 7
    //   373: aload 5
    ...
    //   389: aload 5
    //   391: astore 6
    //   393: new 1053	java/io/BufferedReader
    //   396: dup
    //   397: new 1058	java/io/FileReader
    //   400: dup
    //   401: aload 9
    //   403: invokespecial 1061	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   406: bipush 64
    //   408: invokespecial 1064	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   411: astore 5
    //   413: aload 5
    //   415: invokevirtual 1067	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   418: astore 6
    //   420: aload 6
    //   422: ifnull +327 -> 749
    //   425: aload 6
    ...
    //   444: iconst_1
    //   445: aaload
    //   446: invokevirtual 1072	java/lang/String:trim	()Ljava/lang/String;
    //   449: astore 6
    //   451: aload 8
    //   453: aload 6
    //   455: invokevirtual 921	java/util/HashMap:containsKey	(Ljava/lang/Object;)Z
    //   458: ifeq +49 -> 507
    //   461: aload 8
    //   463: aload 6
    //   465: aload 8
    //   467: aload 6
    //   469: invokevirtual 922	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    //   489: ifnull +47 -> 536
    //   492: aload 5
    //   494: invokevirtual 1056	java/io/BufferedReader:close	()V
    //   497: aconst_null
    //   498: astore 5
    //   500: iload_2
    //   501: iconst_1
    ...
    //   565: aload 5
    //   567: astore 6
    //   569: invokestatic 1079	com/tencent/mobileqq/app/ThreadLog:needRecordJob	()Z
    //   572: ifeq +36 -> 608
    //   575: aload 5
    //   577: astore 7
    //   579: aload 5
    ...
    //   598: astore 6
    //   600: aload_1
    //   601: invokestatic 1082	com/tencent/mobileqq/app/ThreadManager:reportCurrentState	()Ljava/lang/String;
    ...
    //   649: lload_3
    //   650: lsub
    //   651: invokestatic 1089	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   654: aastore
    //   655: dup
    //   656: iconst_2
    //   657: ldc_w 1091
    ...
    //   673: ifnull -305 -> 368
    //   676: aload 5
    //   678: invokevirtual 1056	java/io/BufferedReader:close	()V
    //   681: return
    //   682: astore_1
    //   683: ldc_w 327
    //   686: iconst_2
    ...
    //   711: ifnull +8 -> 719
    //   714: aload 6
    //   716: invokevirtual 1056	java/io/BufferedReader:close	()V
    //   719: aload_1
    //   720: athrow
    //   721: astore 5
    //   723: ldc_w 327
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    ...
    Object localObject = new NewIntent(paramAppRuntime.getApplication(), bcdh.class);
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramAppRuntime.getApplication(), bcdh.class);
  ...
  public void a(AppRuntime paramAppRuntime, String paramString1, int paramInt, String paramString2, String paramString3, String paramString4)
  {
    ...
    do
    {
      ...
      paramString2 = new NewIntent(paramAppRuntime.getApplication(), bcdh.class);
  ...
  public void a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    paramString1 = new NewIntent(paramAppRuntime.getApplication(), bcdh.class);
  ...
  public void a(AppRuntime paramAppRuntime, String paramString, Map<String, Integer> paramMap)
  {
    ...
    paramMap = new NewIntent(paramAppRuntime.getApplication(), bcdh.class);
  ...
  void b()
  {
    if (!this.jdField_a_of_type_Bctn.jdField_a_of_type_Boolean) {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Bctn.jdField_a_of_type_Int == 2) && ((TextUtils.isEmpty((CharSequence)localObject)) || (!((String)localObject).contains("QQBroadcastReceiver"))))
      {
    ...
    if ((l1 <= 0L) || (l2 <= l1) || (i < 0) || (l2 - l1 > this.jdField_a_of_type_Bctn.jdField_b_of_type_Int * 1000))
    {
      i = 1;
      l1 = l2;
    }
    for (;;)
    {
      if (i > this.jdField_a_of_type_Bctn.c)
      {
  ...
  void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      localSharedPreferences.edit().putLong("starttime", l1).putInt("crashcount", i).putBoolean("allowpreload", bool1).putInt("controlwindow", this.jdField_a_of_type_Bctn.jdField_b_of_type_Int).commit();
      return;
      i += 1;
    }
  }
  ...
  public void b(String paramString1, String paramString2)
  {
    ...
    {
      return;
      paramString1 = new bctm(System.currentTimeMillis(), paramString1, paramString2);
      ...
      for (this.jdField_b_of_type_Int = (paramString1.jdField_a_of_type_Int + i); (this.jdField_b_of_type_Int > 15360L) && (this.jdField_a_of_type_JavaUtilLinkedList.size() > 1); this.jdField_b_of_type_Int -= paramString1.jdField_a_of_type_Int) {
        paramString1 = (bctm)this.jdField_a_of_type_JavaUtilLinkedList.removeLast();
      }
    }
  }
  ...
  public void c(String paramString)
  {
    ...
    CrashReport.initCrashReport(jdField_a_of_type_AndroidContentContext, new bctk(this), null, bool, (CrashStrategyBean)localObject, 30000L);
    try
    {
      ...
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "PatchInstallStatus", String.valueOf(acut.jdField_a_of_type_Int));
      if (!TextUtils.isEmpty(acut.jdField_a_of_type_JavaLangString)) {
        CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "PatchNameInstalled", acut.jdField_a_of_type_JavaLangString);
      }
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "Revision", AppSetting.g());
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "Version.buildNum", "8.4.1.4680");
      ...
      CrashReport.putUserData(jdField_a_of_type_AndroidContentContext, "topActivity", anrr.a());
