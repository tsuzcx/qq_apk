...
{
  private bftg jdField_a_of_type_Bftg;
  ...
  {
    wsv.b("TextEffectModule", "handleJsRequest method = " + paramString);
    try
    {
      if ("wordSplit".equals(paramString))
      {
        ...
        paramJSONObject = ania.a((AppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), paramJSONObject);
      ...
      {
        paramJSONObject = ((blnl)blmf.a(5)).a.b;
        if (!TextUtils.isEmpty(paramJSONObject)) {
          paramInvokeCallback.exec(0, "success", new JSONObject(paramJSONObject));
        }
        while (this.jdField_a_of_type_Bftg != null)
        {
