...
public class acuy
{
  ...
  public acuy(Context paramContext, int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView = ((IphonePickerView)LayoutInflater.from(paramContext).inflate(2131561127, null));
    int j = this.d;
    int k = this.g;
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView.a(new acvb(this, j - k + 1));
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView.setPickListener(new acvc(this, null));
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView.setBackgroundColor(paramContext.getResources().getColor(2131167072));
    a(paramInt);
    if (paramBoolean) {
  ...
  public void a(acva paramacva)
  {
    this.jdField_a_of_type_Acva = paramacva;
  }
}
