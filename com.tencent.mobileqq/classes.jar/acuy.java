...
public abstract class acuy
{
  ...
  public static acuy a(String paramString, JSONObject paramJSONObject)
  {
    if ("dex".equals(paramString))
    {
      ...
      do
      {
        ...
        if (PatchCommonUtil.isDalvik()) {
          return new acvb(paramJSONObject);
        }
        if (PatchCommonUtil.isArtLM()) {
          return new acva(paramJSONObject);
        }
      } while (!PatchCommonUtil.isArtGeN());
      return new acuz(paramJSONObject);
    }
    if ("Native".equals(paramString)) {
      return new acvc(paramJSONObject);
    }
