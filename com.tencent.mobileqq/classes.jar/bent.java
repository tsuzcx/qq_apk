  ...
  extends beny
{
  ...
  public String a;
  public URL a;
  public ConcurrentHashMap<String, bkxx> a;
  public int b;
  protected String b;
  public String c;
  public int d;
  ...
  public bent(String paramString)
  {
    b(paramString);
    a();
  ...
  public bent(JSONObject paramJSONObject)
  {
    a(paramJSONObject);
    this.jdField_d_of_type_JavaLangString = String.valueOf(hashCode());
  }
  ...
  public bkxx a(String paramString1, String paramString2)
  {
    ...
    {
      paramString2 = new bkxx(wkp.a(), paramString1, paramString2);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString1, paramString2);
      return paramString2;
    }
    return (bkxx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString1);
  }
  ...
  public Stream<bent> a(XMediaEditor paramXMediaEditor)
  {
    ...
    if (!FileUtil.fileExistsAndNotEmpty(this.jdField_c_of_type_JavaLangString)) {
      localObject1 = ((Stream)localObject2).map(new benu(this.jdField_d_of_type_Int));
    }
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      localObject1 = ((Stream)localObject1).map(new benv(0, paramXMediaEditor, paramXMediaEditor.a("troopuin")));
    }
    for (;;)
    {
      localObject2 = paramXMediaEditor.findViewHolderForLayoutPosition(this.jdField_c_of_type_Int);
      if ((localObject2 instanceof beou))
      {
        localObject2 = (beou)localObject2;
        if (this.jdField_d_of_type_JavaLangString.equals(((beou)localObject2).a.getTag())) {
          ((beoq)((benk)paramXMediaEditor.getAdapter()).a.a(1)).a((beou)localObject2, this, 0);
        }
      }
