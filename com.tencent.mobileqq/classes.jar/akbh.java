...
public class akbh
{
  ...
  public static Object a(AppInterface paramAppInterface, FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, xom paramxom)
  {
    ...
    {
      arzy.a("LBS", "CMD_GET_ENCOUNTER eReplyCode:" + localRespHeader.eReplyCode);
      localUserData = null;
      bool = false;
      if (localRespHeader == null) {
        break label488;
      ...
      if (!(paramxom instanceof awzv)) {
        break label385;
      }
      ((awzv)paramxom).a[i] = localUserData;
      label140:
      if (atbr.b())
      {
        ...
        label154:
        atbr.a("NearbyCmdHelper", new Object[] { "decodeGetEncounter", Integer.valueOf(i), paramAppInterface });
      }
      if (localUserData != null)
      {
        anmi.a(paramToServiceMsg.extraData.getString("account"), localUserData.iLon, localUserData.iLat, localUserData.lTime);
    ...
    for (;;)
    {
      ...
      arzy.a("LBS", "CMD_GET_ENCOUNTER eReplyCode:" + null);
      break;
      label385:
      if (!(paramxom instanceof awzt)) {
        break label140;
      }
      ((awzt)paramxom).a[i] = localUserData;
      break label140;
      label407:
      ...
      akbl.a(paramAppInterface, i);
      paramAppInterface = localUserData;
      continue;
      label488:
      akbl.a(paramAppInterface, -1111);
      return null;
      label497:
      bool = true;
      paramAppInterface = paramFromServiceMsg;
  ...
  public static Object a(xom paramxom, FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      paramxom = (RespGetPoint)paramxom.a(paramFromServiceMsg.getWupBuffer(), "RespGetPoint", new RespGetPoint());
      if (paramxom != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.nearby", 2, "LBSService --> decodeGetPointInfo(), url: " + new String(paramxom.stUDLinfo.SOSOUrl) + " , cityId = " + paramxom.stUDLinfo.cityId);
        }
        return paramxom;
      }
    }
  ...
  public static void a(ajtb paramajtb, byte paramByte)
  {
    try
    {
      long l = Long.parseLong(paramajtb.getCurrentAccountUin());
      Object localObject = new byte[13];
      bbmx.a((byte[])localObject, 0, l);
      localObject[4] = 0;
      bbmx.a((byte[])localObject, 5, (short)1);
      bbmx.a((byte[])localObject, 7, 40493);
      bbmx.a((byte[])localObject, 9, (short)2);
      bbmx.a((byte[])localObject, 11, (short)paramByte);
      localObject = paramajtb.makeOIDBPkg("OidbSvc.0x4ff_9", 1279, 9, (byte[])localObject);
      ...
      paramajtb.sendPbReq((ToServiceMsg)localObject);
      anml.a("send_oidb_0x4ff_9", new Object[] { Byte.valueOf(paramByte) });
      return;
    }
    catch (Exception paramajtb)
    {
      while (!QLog.isColorLevel()) {}
      QLog.w("Q.dating", 2, "send_oidb_0x4ff_9 error", paramajtb);
    }
  }
  
  public static void a(ajtb paramajtb, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramObject != null) && (paramFromServiceMsg.isSuccess()))
    {
      ...
      if (bool1) {
        if ((paramObject != null) && (paramObject.SOSOUrl.length > 0)) {
          paramajtb.notifyUI(paramInt, true, paramObject.SOSOUrl);
        }
      }
    }
    do
    {
      ...
      if (paramObject.cityId != null)
      {
        ...
        if (paramObject.cityId.length == 16)
        {
          ...
          paramToServiceMsg[0] = ajtw.a(localByteBuffer.getInt());
          paramToServiceMsg[1] = ajtw.a(localByteBuffer.getInt());
          paramToServiceMsg[2] = ajtw.a(localByteBuffer.getInt());
          paramToServiceMsg[3] = "0";
        }
      }
      paramajtb.notifyUI(paramInt, true, new Object[] { "", paramObject.strProvince, paramObject.strCity, paramObject.strDistrict, paramObject.strTown, "", paramObject.strRoad, "", Integer.valueOf(paramFromServiceMsg.stGps.iLat), Integer.valueOf(paramFromServiceMsg.stGps.iLon), Integer.valueOf(paramFromServiceMsg.stGps.iAlt), paramToServiceMsg });
      return;
      if (bool1)
      {
        paramajtb.notifyUI(paramInt, false, null);
        return;
      }
    } while (!bool2);
    paramajtb.notifyUI(paramInt, false, null);
  ...
  public static void a(ajtb paramajtb, int paramInt1, List<atfm> paramList, int paramInt2, int paramInt3)
  {
    if (paramList == null)
    {
      c(paramajtb, paramInt1, null, null, null);
      return;
    }
    ...
    {
      atfm localatfm = (atfm)paramList.get(paramInt1);
      if (localatfm != null) {
        localReqBody.rpt_msg_tags.add(localatfm.a());
      }
      paramInt1 += 1;
    }
    paramList = paramajtb.makeOIDBPkg("OidbSvc.0x9c7_0", 2503, 0, localReqBody.toByteArray());
    paramList.extraData.putInt("set_mode", paramInt2);
    paramList.extraData.putInt("test_mode", paramInt3);
    paramajtb.sendPbReq(paramList);
  }
  
  public static void a(ajtb paramajtb, long paramLong, int paramInt, byte[] paramArrayOfByte)
  {
    Object localObject = new cmd0x682.ReqBody();
    ((cmd0x682.ReqBody)localObject).rpt_uint64_touinlist.add(Long.valueOf(paramLong));
    localObject = paramajtb.makeOIDBPkg("OidbSvc.0x682", 1666, 0, ((cmd0x682.ReqBody)localObject).toByteArray());
    ((ToServiceMsg)localObject).extraData.putByteArray("showlove_chat_sig", paramArrayOfByte);
    paramajtb.sendPbReq((ToServiceMsg)localObject);
    a(paramajtb.mApp, paramInt);
    anml.c("getShowLove", new Object[] { "from type " + paramInt });
  }
  
  public static void a(ajtb paramajtb, boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2)
  {
    if ((!paramBoolean1) && (!paramBoolean2)) {
      return;
    }
    ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", paramajtb.getCurrentAccountUin(), "NeighborSvc.ReqGetPoint");
    ...
    for (;;)
    {
      paramajtb.send(localToServiceMsg);
      return;
  ...
  private static void a(AppInterface paramAppInterface, int paramInt)
  {
    ...
    if ((paramInt & 0x4) == 4)
    {
      ...
      anml.c("getShowLove", new Object[] { "report value ", str });
      str = "";
      if ((paramInt & 0x1) != 1) {
        break label184;
      }
    ...
    for (;;)
    {
      ...
      {
        paramAppInterface.reportClickEvent("CliOper", "", "", str, str, 0, 0, "", "", "", "");
        anml.c("getShowLove", new Object[] { "report value2 ", str });
      }
      return;
      if ((paramInt & 0x8) == 8)
      {
  ...
  public static boolean a(AppInterface paramAppInterface, ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket, xom paramxom)
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyCmdHelper", 2, "handleGetEncounter start...");
    }
    if (paramToServiceMsg.extraData.getBoolean("isCheckInReq", false)) {
      return b(paramAppInterface, paramToServiceMsg, paramUniPacket, paramxom);
    }
    int i = a(paramToServiceMsg);
    if ((paramxom instanceof awzv)) {
      paramxom = ((awzv)paramxom).a[i];
    }
    label155:
    label1454:
    for (;;)
    {
      ...
      if (atbr.b())
      {
        if (paramxom == null)
        {
          ...
          atbr.a("NearbyCmdHelper", new Object[] { "handleGetEncounter", Integer.valueOf(i), localObject1 });
        }
      }
      else
      {
        ...
        localReqHeader.lMID = xom.a(Long.parseLong(paramToServiceMsg.getUin()));
      ...
      label1784:
      label1919:
      for (Object localObject2 = new UserData();; localObject2 = paramxom)
      {
        ...
        if (localObject5 != null)
        {
          ...
          if (localObject5.length > 0)
          {
            ...
            paramxom = ((awzt)paramxom).a[i];
            break;
            localObject1 = paramxom.strProvince;
            break label75;
        ...
        if ((QLog.isColorLevel()) && (paramxom != null)) {
          QLog.d("NearbyCmdHelper", 2, "request stUserData.lTime=" + paramxom.lTime + " iLat=" + paramxom.iLat + " iLon" + paramxom.iLon + " lOriginGrid=" + paramxom.lOriginGrid + " lNextGrid=" + paramxom.lNextGrid + " strProvince=" + paramxom.strProvince + " strCookie" + paramxom.strCookie);
        }
        if (atbr.b()) {
          atbr.a("NearbyCmdHelper", "handleGetEncounter interest", new Object[] { Byte.valueOf(b2), Long.valueOf(l2) });
        }
        paramToServiceMsg = (DatingFilters)paramToServiceMsg.extraData.getParcelable("datingFilter");
        paramxom = new cmd0x5fb.ReqInfo();
        if (paramToServiceMsg != null)
        {
          paramxom.uint32_time.set(paramToServiceMsg.jdField_b_of_type_Int);
          paramxom.uint32_subject.set(paramToServiceMsg.d);
          paramxom.uint32_gender.set(paramToServiceMsg.jdField_a_of_type_Int);
          paramxom.uint32_age_low.set(DatingFilters.jdField_b_of_type_ArrayOfInt[paramToServiceMsg.e]);
          paramxom.uint32_age_up.set(DatingFilters.jdField_a_of_type_ArrayOfInt[paramToServiceMsg.e]);
          PBUInt32Field localPBUInt32Field = paramxom.uint32_profession;
          if (paramToServiceMsg.f >= 0) {
            break label1687;
          }
          i = 0;
          localPBUInt32Field.set(i);
          paramxom.bytes_cookie.set(ByteStringMicro.copyFrom(new byte[0]));
          if ((paramToServiceMsg.jdField_a_of_type_AppointDefineAppoint_define$LocaleInfo != null) && (paramToServiceMsg.d == 5)) {
            paramxom.msg_destination.set(paramToServiceMsg.jdField_a_of_type_AppointDefineAppoint_define$LocaleInfo);
          }
        }
        if (((Boolean)atbi.a(paramAppInterface.getAccount(), "is_nearby_novice", Boolean.valueOf(false))).booleanValue())
        {
          i = 1;
          if (QLog.isColorLevel()) {
          ...
          paramToServiceMsg = new ReqGetEncounterV2(localReqUserInfo1, (UserData)localObject2, k, -1, (ArrayList)localObject3, new byte[1], (byte)j, 2000, -1, 0, null, (byte[])localObject4, 0, (byte)1, b1, b3, b4, m, n, i2, i3, (byte)1, i1, localReqUserInfo2, 15, paramxom.toByteArray(), (byte)0, (byte)0, b2, (String)localObject5, l1, 0L, b5, i, i4, l2);
        ...
        for (paramToServiceMsg = "lbs is not null";; paramToServiceMsg = "isUseGps is true")
        {
          ...
          paramUniPacket.put("param_NetType", bbfj.a(null) + "");
          axrn.a(BaseApplicationImpl.getContext()).a(paramAppInterface.getCurrentAccountUin(), "GET_ENCOUNTER_LOCATION", true, 0L, 0L, paramUniPacket, "");
          return true;
          i = paramToServiceMsg.f;
          break;
          i = 0;
          break label1454;
          paramToServiceMsg = new ReqGetEncounterV2(localReqUserInfo1, (UserData)localObject2, k, -1, (ArrayList)localObject3, new byte[1], (byte)0, 2000, -1, 0, null, (byte[])localObject4, 0, (byte)1, b1, b3, b4, m, n, i2, i3, (byte)1, i1, null, 15, paramxom.toByteArray(), (byte)0, (byte)0, b2, (String)localObject5, l1, 0L, b5, i, i4, l2);
          break label1567;
        }
        if (QLog.isColorLevel()) {
        ...
        paramToServiceMsg.put("param_NetType", bbfj.a(null) + "");
        axrn.a(BaseApplicationImpl.getContext()).a(paramAppInterface.getCurrentAccountUin(), "GET_ENCOUNTER_LOCATION", false, 0L, 0L, paramToServiceMsg, "");
        return false;
      }
      label946:
      paramxom = null;
  ...
  public static boolean a(xom paramxom, ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    boolean bool1 = false;
    int j = 0;
    ...
    {
      paramxom = new NeighborSvc.ReqHeader();
      paramxom.shVersion = 2;
      paramxom.lMID = xom.a(Long.parseLong(paramToServiceMsg.getUin()));
      paramxom.iAppID = AppSetting.a();
      paramxom.eBusiType = 0;
      paramxom.eMqqSysType = 2;
      ...
      for (i = 1;; i = 0) {
        for (;;)
        {
          ...
          paramUniPacket.put("ReqHeader", paramxom);
          ...
          akuf.a(new akbi("LBSService.Point", paramToServiceMsg));
          try
          {
            paramToServiceMsg.wait();
            Object localObject2 = asyz.a(true, akuf.a("LBSService.Point"));
    ...
    paramxom = new FromServiceMsg(paramToServiceMsg.getUin(), paramToServiceMsg.getServiceCmd());
    paramxom.setMsgFail();
    try
    {
      paramToServiceMsg.actionListener.onActionResult(paramxom);
      return false;
    }
    catch (RemoteException paramxom) {}
    return false;
  }
  ...
  private static byte[] a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return localObject;
      label100:
      localObject = a(asyz.a());
    }
  }
  
  public static void b(ajtb paramajtb, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    boolean bool2 = false;
    int i = -1;
    try
    {
      ...
      if (bool1)
      {
        ...
        if (localRspBody.uint32_config_seq.has())
        {
          ...
          atbi.a(paramajtb.mApp.getAccount(), "toplist_hide_boygod_seq", Integer.valueOf(j));
        }
        if (localRspBody.uint32_config_time.has())
        {
          j = localRspBody.uint32_config_time.get();
          atbi.a(paramajtb.mApp.getAccount(), "key_last_config_time", Integer.valueOf(j));
        }
        ...
        if ((i == 2) && (localRspBody.msg_charm_event.has()))
        {
          ...
          if (!(paramajtb.mApp instanceof NearbyAppInterface)) {
            break label600;
          }
        }
        int k;
        ...
        for (;;)
        {
          ...
          paramajtb.notifyUI(paramInt, true, new Object[] { Boolean.valueOf(false), Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(n), Integer.valueOf(i1), paramToServiceMsg });
          paramToServiceMsg = "0X80052B1";
          if (k - i < 0) {
            paramToServiceMsg = "0X80052B2";
          }
          paramajtb.mApp.reportClickEvent("CliOper", "", "", paramToServiceMsg, paramToServiceMsg, 0, 0, "", "", "", "");
          return;
          ...
          break;
          label600:
          if ((paramajtb.mApp instanceof QQAppInterface)) {
            ((QQAppInterface)paramajtb.mApp).a().a(paramToServiceMsg.getUin(), paramFromServiceMsg, paramObject, (Oidb_0x686.CharmEvent)localObject1, (Oidb_0x686.NearbyCharmNotify)localObject2);
          }
        }
        label637:
        if ((localObject2 != null) && (((Oidb_0x686.NearbyCharmNotify)localObject2).uint32_pop_flag.get() == 1))
        {
          ...
          paramajtb.notifyUI(paramInt, true, new Object[] { Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(n), Integer.valueOf(i1), Integer.valueOf(i2), Integer.valueOf(i3), paramToServiceMsg });
  ...
  protected static boolean b(AppInterface paramAppInterface, ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket, xom paramxom)
  {
    ...
    if ((i != 0) && (j != 0))
    {
      ...
      paramAppInterface.lMID = xom.a(Long.parseLong(paramToServiceMsg.getUin()));
      ...
      paramxom = new ReqGetEncounterV2();
      paramxom.stUserData = new UserData();
      paramxom.stUserInfo = paramToServiceMsg;
      paramxom.eNewListType = 100;
      paramxom.neighbor_list_source = 4;
      paramUniPacket.setEncodeName("utf-8");
      paramUniPacket.setServantName("EncounterObj");
      paramUniPacket.setFuncName("CMD_GET_ENCOUNTERV2");
      paramUniPacket.put("ReqHeader", paramAppInterface);
      paramUniPacket.put("ReqGetEncounterV2", paramxom);
      return true;
    }
    return false;
  }
  
  public static void c(ajtb paramajtb, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null))
    {
      paramajtb.notifyUI(paramInt, false, new Object[] { "", null, ajya.a(2131707130), Integer.valueOf(-1), Integer.valueOf(-1) });
      return;
    }
    int i;
    int j;
    ...
    if (paramToServiceMsg.extraData == null)
    {
      ...
      m = ajtb.parseOIDBPkg(paramFromServiceMsg, paramObject, localRspBody);
      if (m != 0) {
        break label472;
      }
    ...
    for (paramFromServiceMsg = localRspBody.rpt_msg_tags.get();; paramFromServiceMsg = null)
    {
      ...
      {
        atfm localatfm = atfm.a((appoint_define.InterestTag)paramFromServiceMsg.get(k));
        if (localatfm != null) {
          paramObject.add(localatfm);
        }
        k += 1;
      }
    ...
    {
      paramajtb.notifyUI(4, false, new Object[] { "", null, ajya.a(2131707131), Integer.valueOf(i), Integer.valueOf(j) });
      atbr.a("Q.nearby_people_card.", "handle_oidb_0x9c7_0", new Object[] { Integer.valueOf(m), Boolean.valueOf(true), null, paramToServiceMsg });
      return;
    }
    if ((paramajtb.mApp instanceof NearbyAppInterface)) {
      ((NearbyAppInterface)paramajtb.mApp).a().a(localRspBody);
    }
    for (;;)
    {
      paramajtb.notifyUI(paramInt, true, new Object[] { paramToServiceMsg, paramObject, "", Integer.valueOf(i), Integer.valueOf(j) });
      atbr.a("Q.nearby_people_card.", "handle_oidb_0x9c7_0", new Object[] { Integer.valueOf(m), Boolean.valueOf(true), paramObject, paramToServiceMsg });
      return;
      if (paramajtb.app != null) {
        paramajtb.app.a().a(localRspBody);
      }
    }
    label472:
    ...
    {
      paramajtb.notifyUI(paramInt, false, new Object[] { "", null, paramToServiceMsg, Integer.valueOf(i), Integer.valueOf(j) });
      return;
    }
  }
  
  public static void d(ajtb paramajtb, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    boolean bool2 = true;
    boolean bool1;
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg.uint32_result.has()))
        {
          ...
          if ((i == 0) && (paramFromServiceMsg.bytes_bodybuffer.has()) && (paramFromServiceMsg.bytes_bodybuffer.get() != null))
          {
            ...
            if (4 <= paramFromServiceMsg.length)
            {
              ...
              if ((paramFromServiceMsg == null) || (!paramFromServiceMsg.equals(paramajtb.getCurrentAccountUin())))
              {
                if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      if ((paramajtb.mApp instanceof QQAppInterface)) {
        if (paramInt == 7)
        {
          ...
          if (bool1)
          {
            paramToServiceMsg = ((QQAppInterface)paramajtb.mApp).a();
            if (paramInt != 0) {
              break label294;
            }
            paramToServiceMsg.a(bool2);
          }
          paramajtb.notifyUI(7, bool1, null);
        }
      }
      for (;;)
      {
        ...
        if ((paramajtb.mApp instanceof NearbyAppInterface))
        {
          paramFromServiceMsg = (NearbyAppInterface)paramajtb.mApp;
          if (paramInt == 10)
          {
            ...
            paramajtb.notifyUI(10, bool1, null);
          }
        }
      }
      label364:
  ...
  public static void e(ajtb paramajtb, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    cmd0x682.RspBody localRspBody = new cmd0x682.RspBody();
    int i = ajtb.parseOIDBPkg(paramFromServiceMsg, paramObject, localRspBody);
    anml.a("getShowLove", new Object[] { "handleGetShowLoveLimit result = " + i });
    int n;
    if ((i == 0) && (localRspBody.rpt_msg_chatinfo.has()) && (localRspBody.rpt_msg_chatinfo.size() > 0))
    {
      ...
      if ((paramajtb instanceof atbz)) {
        paramajtb.notifyUI(9, true, new Object[] { Long.valueOf(l), Boolean.valueOf(bool1), Boolean.valueOf(bool2), paramToServiceMsg, paramFromServiceMsg, paramObject });
      }
      if (QLog.isColorLevel()) {
      ...
      if (i1 == 1) {
        paramajtb.mApp.reportClickEvent("CliOper", "", "", "0X8005290", "0X8005290", 0, 0, "", "", "", "");
      }
    }
    for (;;)
    {
      ...
      if (n == 1)
      {
        paramajtb.mApp.reportClickEvent("CliOper", "", "", "0X8005291", "0X8005291", 0, 0, "", "", "", "");
        continue;
        paramajtb.notifyUI(paramInt, false, null);
      }
    }
