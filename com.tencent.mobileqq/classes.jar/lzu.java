  ...
  implements maa
{
  ...
  public String a;
  public Timer a;
  ljl jdField_a_of_type_Ljl = new lzv(this);
  lzx jdField_a_of_type_Lzx = new lzx(this);
  public lzz a;
  ...
  public lzu(SmallScreenService paramSmallScreenService)
  {
    ...
    this.jdField_a_of_type_Mct = new lzw(this);
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          break;
          locallff = paramVideoController.a();
          i = locallff.jdField_d_of_type_Int;
          if (QLog.isColorLevel()) {
        ...
        } while ((locallff.jdField_j_of_type_Int == 1011) || (paramVideoController.f));
        ...
        if (locallff.J)
        {
          ...
          localIntent.putExtra("sessionType", locallff.jdField_d_of_type_Int);
          localIntent.putExtra("GroupId", locallff.jdField_d_of_type_JavaLangString);
          localIntent.putExtra("uin", locallff.jdField_d_of_type_JavaLangString);
        ...
        l = locallff.jdField_g_of_type_Long;
        j = locallff.F;
        if ((l == 0L) && (locallff.a.jdField_b_of_type_Int <= 0)) {
          break label692;
        }
        if (locallff.a.jdField_b_of_type_Int <= 0) {
          break label545;
        }
      } while ((locallff.jdField_d_of_type_Int == 1) || (locallff.a.jdField_a_of_type_Int == 1) || (locallff.jdField_d_of_type_Int == 3) || (locallff.a.jdField_a_of_type_Int == 3) || (!QLog.isColorLevel()));
      ...
      paramVideoController.putExtra("uinType", mvd.c(j));
      paramVideoController.putExtra("isDoubleVideoMeeting", locallff.J);
      paramVideoController.putExtra("MultiAVType", locallff.D);
      ...
      if (QLog.isColorLevel())
      {
        ...
        continue;
        label692:
        if ((paramVideoController.d()) && (locallff.i()))
        {
          paramVideoController = new Intent(paramContext, VideoInviteActivity.class);
          paramVideoController.addFlags(268435456);
          paramVideoController.putExtra("uinType", locallff.jdField_j_of_type_Int);
          paramVideoController.putExtra("peerUin", locallff.jdField_d_of_type_JavaLangString);
          paramVideoController.putExtra("extraUin", locallff.jdField_f_of_type_JavaLangString);
          if (locallff.jdField_f_of_type_Int == 1) {}
          for (;;)
          {
  ...
  {
    RedPacketGameSmallScreenView localRedPacketGameSmallScreenView = (RedPacketGameSmallScreenView)paramViewGroup.findViewById(2131373578);
  ...
  private void b(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.jdField_a_of_type_Lzz != null) && (paramInt != this.jdField_a_of_type_Lzz.f())) {
        break;
      }
      return;
    }
    ...
    this.jdField_a_of_type_Lzz.g(paramInt);
  ...
  public void a(long paramLong)
  {
    ...
    for (Object localObject = null;; localObject = this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService.a(1))
    {
      if (localObject != null)
      {
        View localView = ((SmallScreenRelativeLayout)localObject).findViewById(2131376374);
        if (localView != null) {
          localView.findViewById(2131376378).clearAnimation();
        }
      }
      if (this.jdField_a_of_type_JavaUtilTimer != null)
      {
      ...
      if (this.jdField_a_of_type_Lzz != null)
      {
        this.jdField_a_of_type_Lzz.p();
        this.jdField_a_of_type_Lzz = null;
      }
      ...
      {
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.b(this.jdField_a_of_type_Lzx);
  ...
  {
    lbj.c("SmallScreenVideoController", "notifyEvent :" + paramInteger + "|" + paramObject1 + "|" + paramObject2);
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    if ((paramAppRuntime instanceof VideoAppInterface))
    {
      ...
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(this.jdField_a_of_type_Lzx);
  ...
  void a(boolean paramBoolean)
  {
    ...
    if ((localObject != null) && (QLog.isColorLevel())) {
      QLog.d("SmallScreenVideoController", 2, "onCreateUI SessionType = " + ((lff)localObject).jdField_d_of_type_Int);
    }
    this.jdField_a_of_type_AndroidGraphicsBitmap = mvd.a(this.jdField_a_of_type_AndroidContentContext, 2130841927);
    if (this.jdField_a_of_type_ComTencentAvCameraCameraUtils == null)
    {
      ...
      this.jdField_a_of_type_ComTencentAvCameraCameraUtils.a(this.jdField_a_of_type_ComTencentAvVideoController.a);
    }
    View localView = this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService.a(1).findViewById(2131363100);
    if (this.jdField_a_of_type_Lzz == null)
    {
      this.jdField_a_of_type_Lzz = new lzz(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, localView, this);
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_ComTencentAvVideoController.f) && (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null)) {
        this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new lzi(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mct);
      }
      if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI != null) {
        this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI.a(paramBoolean);
      }
      if ((localObject != null) && (((lff)localObject).jdField_g_of_type_Int != 4) && (this.jdField_c_of_type_Int == 1) && (!this.jdField_a_of_type_Boolean))
      {
        int i = biki.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getAccount(), 6, true, null);
        if (i > 0)
        {
          int j = biki.a();
          localObject = biki.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, i, j, null);
          if (localObject != null)
          {
            localObject = new File((String)localObject);
            if ((localObject != null) && (((File)localObject).exists()) && (this.jdField_a_of_type_Lzz != null)) {
              this.jdField_a_of_type_Lzz.w();
            }
          }
        }
      }
      ...
      if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null) {
        ...
        {
          this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new SmallScreenMultiVideoControlUI(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mct);
          if (localObject != null)
          {
            this.jdField_c_of_type_Int = ((lff)localObject).jdField_d_of_type_Int;
            this.jdField_d_of_type_Int = ((lff)localObject).jdField_f_of_type_Int;
          }
        }
        else
        {
          ...
          else
          {
            ...
            if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null) {
              ...
              else
              {
                this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new SmallScreenMultiVideoControlUI(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mct);
                continue;
                if ((localObject != null) && (((lff)localObject).a.jdField_b_of_type_Int > 0))
                {
                  if (((lff)localObject).a.jdField_a_of_type_Int == 3) {
                    this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new SmallScreenMultiVideoControlUI(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mct);
                  } else {
                    this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new lzi(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mct);
                  }
                }
                else if ((localObject != null) && (((lff)localObject).jdField_e_of_type_Boolean) && ((((lff)localObject).jdField_g_of_type_Int == 1) || (((lff)localObject).jdField_g_of_type_Int == 2))) {
                  this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new lzi(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mct);
                }
              }
            }
  ...
  public boolean a(int paramInt)
  {
    ...
    while ((this.jdField_a_of_type_Int == paramInt) || (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null) || (!(this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI instanceof lzi))) {
      return false;
    }
    if (!this.jdField_a_of_type_ComTencentAvVideoController.a().k)
    {
      lbj.e("SmallScreenVideoController", "Remote not has video, nOff=" + paramInt);
      return false;
    }
    ...
    {
      return true;
      this.jdField_a_of_type_Lzz.n();
      this.jdField_a_of_type_ComTencentAvVideoController.a(0);
      continue;
      this.jdField_a_of_type_Lzz.m();
      this.jdField_a_of_type_ComTencentAvVideoController.a(0);
      continue;
      this.jdField_a_of_type_Lzz.n();
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService == null)
    {
      ...
      label18:
      if ((!this.jdField_b_of_type_Boolean) || (locallzp == null) || (!locallzp.b()) || (localSmallScreenRelativeLayout == null) || (localSmallScreenRelativeLayout.getVisibility() == 8)) {
        break label78;
      }
    ...
    {
      return;
      locallzp = this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService.a(1);
      break;
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_d_of_type_Int == 2) {
      if (this.jdField_a_of_type_ComTencentAvVideoController.a().l())
      {
        ...
        this.jdField_a_of_type_Lzz.a((String)localObject, 1, bool1, false, this.jdField_a_of_type_ComTencentAvVideoController.b(this.jdField_a_of_type_JavaLangString));
        if ((this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_j_of_type_Boolean) && (!this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.c()))
        {
          ...
          this.jdField_a_of_type_Lzz.a(true, false);
          this.jdField_a_of_type_Lzz.c(l2, this.jdField_a_of_type_ComTencentAvCameraCameraUtils.a());
        }
      }
    }
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      if ((!str.equals(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin())) && (bool3)) {
        this.jdField_a_of_type_Lzz.a(str, j, bool3, bool2, bool1);
      }
      i += 1;
      break label422;
      break;
  ...
  void j()
  {
    if (this.jdField_a_of_type_Mcd == null) {
      this.jdField_a_of_type_Mcd = new lzy(this, this.jdField_a_of_type_AndroidContentContext, 2);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Mcd != null) {
      this.jdField_a_of_type_Mcd.enable();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Mcd != null) {
      this.jdField_a_of_type_Mcd.disable();
    }
  }
}
