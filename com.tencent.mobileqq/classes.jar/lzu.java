  ...
  implements View.OnClickListener, View.OnTouchListener
{
  ...
  private int jdField_b_of_type_Int = 2131690195;
  ...
  public lzu(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewWindowManager = ((WindowManager)paramContext.getSystemService("window"));
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131494026, null);
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener(this);
  }
  
  public TextView a()
  {
    return (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131304981);
  }
  ...
  {
    ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131300226)).setImageBitmap(paramBitmap);
  }
  
  public void a(Bitmap paramBitmap, String paramString)
  {
    ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131300226)).setImageBitmap(paramBitmap);
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131304981)).setText(paramString);
  }
  
  public void a(String paramString)
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131304261));
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131304261);
    Button localButton1 = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131296278);
    Button localButton2 = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131309345);
    ...
    if (paramBoolean3) {
      if (this.jdField_b_of_type_Boolean) {
        localTextView.setText(localTextView.getResources().getString(2131629979));
      }
    }
    for (;;)
    {
      ...
      return;
      localTextView.setText(localTextView.getResources().getString(2131629980));
      continue;
      if (this.jdField_b_of_type_Boolean) {
        localTextView.setText(localTextView.getResources().getString(2131629978));
      } else {
        localTextView.setText(localTextView.getResources().getString(2131629981));
      }
    }
  }
  ...
  void b()
  {
    ...
    for (;;)
    {
      ...
      {
        krx.e("VideoInviteFloatBar", "startHandler error : " + localException2);
      }
  ...
  {
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131311487));
  ...
  public void c()
  {
    Object localObject = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131296278);
    Button localButton = (Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131309345);
    ((Button)localObject).setVisibility(4);
    localButton.setVisibility(4);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
    localObject = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131304261);
    this.jdField_a_of_type_AndroidViewView.invalidate();
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131296278: 
      ...
      for (;;)
      {
        ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131296278)).setClickable(false);
        ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131309345)).setClickable(false);
