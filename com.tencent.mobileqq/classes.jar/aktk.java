...
public class aktk
{
  ...
  public aktk(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(albr paramalbr, int paramInt1, int paramInt2, AppInterface paramAppInterface, Context paramContext)
  {
    ...
    for (paramInt1 = 14;; paramInt1 = 5)
    {
      ...
      albi.a(paramalbr, paramInt1, paramAppInterface);
      return 0;
    }
  }
