...
public class atok
{
  private static atok jdField_a_of_type_Atok;
  ...
  {
    if (jdField_a_of_type_Atok == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Atok == null) {
        jdField_a_of_type_Atok = new atok();
      }
      return jdField_a_of_type_Atok;
    }
  }
  ...
  public int a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString, WtloginObserver paramWtloginObserver)
  {
    ...
    return paramQQAppInterface.RegGetSMSVerifyLoginAccount(paramArrayOfByte1, paramArrayOfByte2, paramString, "8.2.6", paramWtloginObserver);
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    localbafb.setTitle(2131651376);
    localbafb.setMessage(2131651375);
    paramQQAppInterface = new atol(this, str, paramActivity, paramQQAppInterface);
    paramActivity = new atom(this);
    localbafb.setPositiveButton(2131651374, paramQQAppInterface);
    localbafb.setNegativeButton(2131625035, paramActivity);
    localbafb.show();
    return false;
  }
