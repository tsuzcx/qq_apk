  ...
  extends njz
{
  ...
  private nkb jdField_a_of_type_Nkb = new nkb();
  private nkd jdField_a_of_type_Nkd;
  private nke jdField_a_of_type_Nke = new nke();
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    {
      this.jdField_b_of_type_Int = babd.a(this.jdField_b_of_type_Int);
      this.jdField_c_of_type_Int = babd.a(this.jdField_c_of_type_Int);
      return;
      this.jdField_b_of_type_Int = 720;
    }
  }
  
  private void b(nkd paramnkd, int paramInt1, int paramInt2)
  {
    this.jdField_a_of_type_Nkd = paramnkd;
    a(paramInt1, paramInt2);
    this.jdField_a_of_type_Nkb.a(paramInt1, paramInt2, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
    this.jdField_a_of_type_Nke.a(b(), c(), this.jdField_a_of_type_Nkb);
  ...
  private boolean g()
  {
    if ((this.jdField_a_of_type_Nkd.a()) || (this.jdField_a_of_type_Nkb.b()))
    {
      ArrayList localArrayList = this.jdField_a_of_type_Nkd.a();
      this.f = this.jdField_a_of_type_Nkb.a(localArrayList);
      this.jdField_a_of_type_Nke.a(localArrayList);
    ...
    if ((this.jdField_a_of_type_Mnx != null) && (this.f > 0) && (System.currentTimeMillis() - this.jdField_b_of_type_Long < this.jdField_e_of_type_Int))
    {
      this.jdField_a_of_type_Mnx.a(3553, this.f, null, null, SystemClock.elapsedRealtimeNanos());
      return true;
    }
    return false;
  }
  ...
  public void a(View paramView, int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Nkb.a(paramView, paramInt, paramBoolean);
    if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Nke.jdField_a_of_type_Boolean)) {
      this.jdField_a_of_type_Nke.a(paramBoolean);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    //   23: iconst_1
    //   24: aload_0
    //   25: getfield 78	nkc:jdField_e_of_type_Boolean	Z
    ...
    //   35: aload_0
    //   36: iconst_1
    //   37: putfield 53	nkc:jdField_d_of_type_Boolean	Z
    //   40: aload_0
    //   41: getfield 53	nkc:jdField_d_of_type_Boolean	Z
    //   44: ifeq +31 -> 75
    //   47: aload_0
    //   48: getfield 78	nkc:jdField_e_of_type_Boolean	Z
    //   51: ifeq +24 -> 75
    //   54: aload_0
    //   55: getfield 38	nkc:jdField_a_of_type_Nke	Lnke;
    //   58: astore_1
    //   59: aload_0
    //   60: getfield 162	nkc:jdField_c_of_type_Boolean	Z
    //   63: ifne +15 -> 78
    //   66: aload_1
    //   67: iload_2
    //   68: aload_0
    //   69: getfield 191	nkc:jdField_a_of_type_Long	J
    //   72: invokevirtual 194	nke:a	(ZJ)V
    //   75: aload_0
    //   76: monitorexit
    //   77: return
    //   78: iconst_0
  ...
  {
    if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Nke.jdField_a_of_type_Boolean)) {
      this.jdField_a_of_type_Nke.a(paramArrayList);
    }
  }
  
  public void a(nkd paramnkd, int paramInt1, int paramInt2)
  {
    if (QLog.isColorLevel()) {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      b(paramnkd, paramInt1, paramInt2);
      l = njt.b().jdField_b_of_type_Int * 1000;
      paramnkd = mzl.a().a().a();
      if ((!f()) || (paramnkd.startGameTimeMills <= 0L)) {
        break label222;
      }
      if (QLog.isColorLevel()) {
        QLog.d("GuessPictureGameRecordCtrl", 2, new Object[] { "scheduleStartRecord, gameRecordInfo:", paramnkd });
      }
      if ((paramnkd.videoFilePath == null) || (!new File(paramnkd.videoFilePath).exists())) {
        break label136;
      }
      if (QLog.isColorLevel()) {
    ...
    return;
    label136:
    this.jdField_a_of_type_Long = paramnkd.startGameTimeMills;
    long l = Math.min(Math.max(System.currentTimeMillis() - this.jdField_a_of_type_Long, l), 0L);
    for (;;)
    {
      mzl.a().a().a(null, null, this.jdField_a_of_type_Long);
  ...
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Mnx != null) && (paramArrayOfByte != null)) {
  ...
  public void c(View paramView)
  {
    ...
    this.jdField_a_of_type_Nkb.a(paramView);
  }
  ...
  public boolean e()
  {
    ...
    this.jdField_a_of_type_Mnx.a(this.jdField_a_of_type_Bafx, this);
    if (QLog.isColorLevel()) {
  ...
  public void k()
  {
    ...
    do
    {
      return;
      super.k();
    } while (this.jdField_a_of_type_Mnx == null);
  ...
  public void m()
  {
    ...
    //   24: iconst_1
    //   25: aload_0
    //   26: getfield 53	nkc:jdField_d_of_type_Boolean	Z
    ...
    //   36: aload_0
    //   37: iconst_1
    //   38: putfield 78	nkc:jdField_e_of_type_Boolean	Z
    //   41: aload_0
    //   42: getfield 175	nkc:jdField_a_of_type_Boolean	Z
    //   45: ifne +68 -> 113
    //   48: invokestatic 256	com/tencent/mobileqq/app/ThreadManager:getSubThreadHandler	()Lmqq/os/MqqHandler;
    //   51: aload_0
    //   52: getfield 76	nkc:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   55: invokevirtual 326	mqq/os/MqqHandler:removeCallbacks	(Ljava/lang/Runnable;)V
    //   58: aload_0
    //   59: getfield 53	nkc:jdField_d_of_type_Boolean	Z
    //   62: ifeq +38 -> 100
    //   65: aload_0
    //   66: getfield 78	nkc:jdField_e_of_type_Boolean	Z
    //   69: ifeq +31 -> 100
    //   72: aload_0
    //   73: getfield 203	nkc:jdField_b_of_type_Boolean	Z
    //   76: ifeq +24 -> 100
    //   79: aload_0
    //   80: getfield 38	nkc:jdField_a_of_type_Nke	Lnke;
    //   83: astore_2
    //   84: aload_0
    //   85: getfield 162	nkc:jdField_c_of_type_Boolean	Z
    //   88: ifne +20 -> 108
    //   91: aload_2
    //   92: iload_1
    //   93: aload_0
    //   94: getfield 191	nkc:jdField_a_of_type_Long	J
    //   97: invokevirtual 194	nke:a	(ZJ)V
    //   100: aload_0
    //   101: iconst_0
    //   102: putfield 203	nkc:jdField_b_of_type_Boolean	Z
    //   105: aload_0
    //   106: monitorexit
    //   107: return
    //   108: iconst_0
  ...
  public void n()
  {
    ...
    this.jdField_e_of_type_Int = (njt.b().jdField_c_of_type_Int * 1000);
    this.jdField_a_of_type_Bafx = new bafx(this.jdField_a_of_type_Nke.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, this.jdField_d_of_type_Int, 1, false, 0);
    if (QLog.isColorLevel()) {
