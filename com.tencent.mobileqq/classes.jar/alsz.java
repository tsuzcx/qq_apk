...
public class alsz
  extends Handler
{
  public alsz(P2VEditMusicDialog paramP2VEditMusicDialog) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      do
      {
        do
        {
          ...
          {
            this.a.jdField_a_of_type_Yxh.a(this.a.jdField_a_of_type_JavaUtilArrayList);
            this.a.jdField_a_of_type_Yxh.notifyDataSetChanged();
          }
          paramMessage = this.a.jdField_a_of_type_Altb.a();
          if (this.a.jdField_a_of_type_Yxh != null) {
        ...
        return;
        if (!this.a.jdField_a_of_type_Altb.c())
        {
          this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(3);
          return;
        }
      ...
      this.a.jdField_a_of_type_Altb.a(3);
    ...
    case 11: 
      ...
      paramMessage.e = (paramMessage.d + this.a.jdField_a_of_type_Int);
      this.a.jdField_a_of_type_Altb.a(paramMessage);
      this.a.jdField_a_of_type_Altb.a(3);
      this.a.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      this.a.jdField_b_of_type_AndroidViewView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(0);
    ...
    case 3: 
      this.a.b();
      this.a.jdField_a_of_type_Altb.a(yxk.jdField_a_of_type_Yxk);
      this.a.jdField_a_of_type_Altb.a(0);
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText("");
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131707320));
      this.a.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(8);
      return;
    case 6: 
      this.a.b();
      this.a.jdField_a_of_type_Altb.a(yxk.jdField_b_of_type_Yxk);
      this.a.jdField_a_of_type_Altb.a(1);
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText("");
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131707319));
      this.a.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(8);
