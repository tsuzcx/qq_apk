...
public class alsz
{
  ...
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2)
  {
    ...
    ArkAppMgr.getInstance().getAppPathByName(paramString1, paramString2, "0.0.0.1", null, new alta());
  }
  ...
  public static boolean a()
  {
    if ((BaseActivity.sTopActivity instanceof FragmentActivity))
    {
      ...
      if (localObject != null)
      {
        ...
        if ((localObject != null) && ((localObject instanceof aert))) {
          return true;
        }
      }
    }
