  ...
  implements View.OnClickListener, baxl
{
  ...
  public atyo(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560899, null);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131372166));
    ...
    this.jdField_a_of_type_Baxk = new baxk(this.jdField_a_of_type_AndroidContentContext, ((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app);
    this.jdField_a_of_type_Baxk.a(this);
    this.jdField_a_of_type_Aweo = ((aweo)((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app.getManager(15));
    ...
    {
      paramContext = paramContext.getString("key_nearbyrecommender_title", this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131694570));
  ...
  {
    bcrj localbcrj = new bcrj(this.jdField_a_of_type_AndroidContentContext.getResources(), this.jdField_a_of_type_Aweo.a(paramInt, 200), false, false);
    if (this.c == 0) {
      this.c = ((int)(paramSingleLineTextView.a() * 1.1F + 0.5F));
    }
    localbcrj.setBounds(0, 0, this.c, this.c);
    paramSingleLineTextView.setCompoundDrawablesWithIntrinsicBounds(localbcrj, null);
  }
  ...
  public void a(RespEncounterInfo paramRespEncounterInfo, ImageView paramImageView)
  {
    ...
    try
    {
      if (paramRespEncounterInfo.tiny_id > 0L)
      {
        ...
        paramRespEncounterInfo = this.jdField_a_of_type_Baxk.a(32, str, 202);
        if (paramRespEncounterInfo == null)
        {
          if (!this.jdField_a_of_type_Baxk.a()) {
            this.jdField_a_of_type_Baxk.a(str, 202, true, false);
          }
          if (this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable == null) {
            this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = ((BitmapDrawable)bbdr.a());
          }
    ...
    if (paramRespEncounterInfo.lEctID > 0L)
    {
      ...
      paramRespEncounterInfo = this.jdField_a_of_type_Baxk.a(32, str, 200);
      if (paramRespEncounterInfo == null)
      {
        this.jdField_a_of_type_Baxk.a(str, 200, true, false);
        if (this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable == null) {
          this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = ((BitmapDrawable)bbdr.a());
        }
        paramImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable);
  ...
  public void a(View paramView, RespEncounterInfo paramRespEncounterInfo)
  {
    ...
    SingleLineTextView localSingleLineTextView1 = (SingleLineTextView)paramView.findViewById(2131377031);
    Object localObject4 = (ImageView)paramView.findViewById(2131362878);
    ImageView localImageView5 = (ImageView)paramView.findViewById(2131368040);
    Object localObject1 = (TextView)paramView.findViewById(2131377097);
    ImageView localImageView2 = (ImageView)paramView.findViewById(2131379267);
    SingleLineTextView localSingleLineTextView2 = (SingleLineTextView)paramView.findViewById(2131364957);
    Object localObject2 = (SingleLineTextView)paramView.findViewById(2131377292);
    Object localObject3 = paramView.findViewById(2131368673);
    ...
    ImageView localImageView4 = (ImageView)paramView.findViewById(2131364060);
    LinearLayout localLinearLayout = (LinearLayout)paramView.findViewById(2131375757);
    ...
    if (!TextUtils.isEmpty(paramRespEncounterInfo.strNick))
    {
      ...
      localImageView5.setBackgroundResource(2130845048);
      localObject4 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844675);
      ((TextView)localObject1).setBackgroundDrawable(bamn.a(this.jdField_a_of_type_AndroidContentContext.getResources(), -17883, (Drawable)localObject4));
      ((TextView)localObject1).setText(ajyc.a(2131701697));
      label311:
    ...
    for (;;)
    {
      ...
      default: 
        ...
        if (paramRespEncounterInfo.constellation == 0)
        {
          ...
          {
          default: 
            localImageView4.setImageResource(2130844592);
            if (AppSetting.d) {
              localImageView4.setContentDescription(ajyc.a(2131701699));
            }
            label713:
            if (paramRespEncounterInfo.watch_color == 0)
            {
      ...
      for (;;)
      {
        ...
        localObject4 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130844675);
        ((TextView)localObject1).setBackgroundDrawable(bamn.a(this.jdField_a_of_type_AndroidContentContext.getResources(), -17883, (Drawable)localObject4));
        ((TextView)localObject1).setText(ajyc.a(2131701700));
        break label311;
        label860:
        ...
        break label548;
        ((StringBuilder)localObject1).append(" ").append(bazo.a(paramRespEncounterInfo.constellation));
        break label581;
        label980:
        ((StringBuilder)localObject1).append(" ").append(bazj.e[paramRespEncounterInfo.profession_id]);
        break label597;
        label1003:
        paramView.setVisibility(8);
        break label636;
        localImageView4.setImageResource(2130844594);
        break label696;
  ...
  public void a(List<RespEncounterInfo> paramList)
  {
    ...
    while (i < paramList.size())
    {
      ...
      if ((localView != null) && (localRespEncounterInfo != null)) {
        this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(localView, new LinearLayout.LayoutParams(-1, bawz.a(this.jdField_a_of_type_AndroidContentContext, 84.0F)));
      }
      i += 1;
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    paramView = (ajxn)((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app.getManager(51);
    if (paramView != null) {}
    for (boolean bool = paramView.b(Long.toString(((RespEncounterInfo)localObject).lEctID));; bool = false)
    {
      ...
      if (bool)
      {
        ...
        paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131694539);
        if (!"0".equals(String.valueOf(((RespEncounterInfo)localObject).cSex))) {
          break label282;
        }
      }
      label282:
      for (paramView = String.format(paramView, new Object[] { ajyc.a(2131701698) });; paramView = String.format(paramView, new Object[] { ajyc.a(2131701696) }))
      {
        atyp.a(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app, Long.toString(((RespEncounterInfo)localObject).lEctID), Long.toString(((RespEncounterInfo)localObject).lEctID), paramView, 1001, true, true);
        ...
        localObject = atyp.a(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app);
        axqw.b(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app, "CliOper", "", "", "0X80055FC", "0X80055FC", 0, 0, localObject[0], paramView, "", "");
        return;
