...
public class atyo
{
  ...
  {
    return azyk.c(paramContext) + "wzryTemplate/";
  }
  ...
  {
    return (paramLong == atxe.i) || (paramLong == atxe.j);
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    if ("cardWZ.zip".equals(paramString))
    {
      ...
      if (atyl.jdField_a_of_type_Atyl == null) {
        atyl.a(paramContext.getAbsolutePath());
      }
      if (atyl.jdField_a_of_type_Atyl != null)
      {
        ...
        {
          bool1 = true;
          localObject = atyl.jdField_a_of_type_Atyl;
          if (((atyl)localObject).jdField_a_of_type_AndroidUtilSparseArray == null) {
            break label338;
          }
          i = 0;
          label207:
          bool2 = bool1;
          if (i >= ((atyl)localObject).jdField_a_of_type_AndroidUtilSparseArray.size()) {
            break label341;
          }
          paramContext = (atym)((atyl)localObject).jdField_a_of_type_AndroidUtilSparseArray.valueAt(i);
          bool2 = bool1;
