  ...
  implements atgu
{
  ...
  private athh a()
  {
    synchronized (this.d)
    {
      athh localathh = this.jdField_a_of_type_Athh;
      return localathh;
    }
  }
  ...
  private boolean a(long paramLong)
  {
    ...
    localathh = new athh(this.jdField_c_of_type_Long, atdm.a().a(), this.jdField_c_of_type_JavaLangString, this.b, this.g, new athf(this));
    a(localathh);
    QLog.i(jdField_a_of_type_JavaLangString, 1, "[UniformDL][" + this.jdField_c_of_type_Long + "] runWorker. start ,mTempStrFilePath=" + this.f);
    return localathh.a(this.f, paramLong);
  }
  ...
  private void b()
  {
    ...
    {
      aszt.a(localQQAppInterface, this.jdField_c_of_type_Long, "actFileUfGenDownload", this.jdField_a_of_type_Long, "", "", "", "", 1, str, 0L, h() * this.b, this.b, this.jdField_c_of_type_JavaLangString, "", 0, str, null);
      aszt.a(localQQAppInterface, this.jdField_c_of_type_Long, "actFileUfGenDownloadDetail", this.jdField_a_of_type_Long, "", "", "", "", 1, str, 0L, h() * this.b, this.b, this.jdField_c_of_type_JavaLangString, "", 0, str, null);
  ...
  public int a()
  {
    ...
    QQAppInterface localQQAppInterface = atdm.a().a();
    if (localQQAppInterface != null) {
      bcev.a(localQQAppInterface.getApplication().getApplicationContext(), localQQAppInterface.getCurrentAccountUin(), "Start_download_2-3_3-1");
    }
    if (!a())
    {
    ...
    if (!NetworkUtil.isNetSupport(BaseApplication.getContext()))
    {
      ...
      if (localQQAppInterface != null)
      {
        aszt.a(localQQAppInterface, this.jdField_c_of_type_Long, "actFileUfGenDownload", this.jdField_a_of_type_Long, "", "", "", "", 2, str, 0L, h() * this.b, this.b, this.jdField_c_of_type_JavaLangString, "", 0, str, null);
        aszt.a(localQQAppInterface, this.jdField_c_of_type_Long, "actFileUfGenDownloadDetail", this.jdField_a_of_type_Long, "", "", "", "", 2, str, 0L, h() * this.b, this.b, this.jdField_c_of_type_JavaLangString, "", 0, str, null);
        bcev.a(localQQAppInterface.getApplication().getApplicationContext(), localQQAppInterface.getCurrentAccountUin(), "Stop_download_2-0_3-1");
      }
      for (;;)
      {
        if (this.jdField_a_of_type_Atgv != null) {
          this.jdField_a_of_type_Atgv.a(2, "net broken", null);
        }
        return -2;
    ...
    if (l2 > this.b)
    {
      ...
      str = atgs.a(9);
      aszt.a(localQQAppInterface, this.jdField_c_of_type_Long, "actFileUfGenDownload", this.jdField_a_of_type_Long, "", "", "", "", 9, str, 0L, l2, this.b, this.jdField_c_of_type_JavaLangString, "", 0, str, null);
      aszt.a(localQQAppInterface, this.jdField_c_of_type_Long, "actFileUfGenDownloadDetail", this.jdField_a_of_type_Long, "", "", "", "", 9, str, 0L, l2, this.b, this.jdField_c_of_type_JavaLangString, "", 0, str, null);
      bcev.a(localQQAppInterface.getApplication().getApplicationContext(), localQQAppInterface.getCurrentAccountUin(), "Stop_download_2-0_3-1");
    }
    for (;;)
    {
      if (this.jdField_a_of_type_Atgv != null) {
        this.jdField_a_of_type_Atgv.a(9, "no space", null);
      }
      return -2;
      a((int)(l2 / this.b));
      break;
    ...
    for (;;)
    {
      try
      {
        ...
        if (1 == i)
        {
          i = 1;
          c(2);
          if ((i != 0) && (this.jdField_a_of_type_Atgv != null)) {
            this.jdField_a_of_type_Atgv.a(h(), null);
          }
          return 0;
        }
      }
  ...
  public int a(String paramString, Bundle paramBundle)
  {
    ...
    paramBundle = atgk.a().a(paramString);
    if (paramBundle != null)
    {
    ...
    for (;;)
    {
      ...
      atgk.a().a(paramString, null, this.b, this.f, this.e);
    }
  }
