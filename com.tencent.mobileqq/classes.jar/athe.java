...
class athe
  extends mxi
{
  athe(athb paramathb, atgy paramatgy, Comments.Comment paramComment) {}
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null))
    {
      ...
      try
      {
        ...
        if (paramBundle.busi_buf.has())
        {
          ...
          this.jdField_a_of_type_Atgy.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment, (int)paramArrayOfByte.result.get());
          paramArrayOfByte = (AppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (paramArrayOfByte == null) {
            return;
          }
          ((atvs)paramArrayOfByte.getManager(263)).a(athb.a(this.jdField_a_of_type_Athb).a, this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment.a);
          return;
        }
