...
{
  public adjr(AssociatedAccountManageActivity paramAssociatedAccountManageActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (AssociatedAccountManageActivity.a(this.a) == null)
      {
        ...
        if (AppSetting.c) {
          paramView.setContentDescription(this.a.getString(2131690825));
        }
      }
      else if (AssociatedAccountManageActivity.a(this.a) == paramView)
      {
        ...
        if (AppSetting.c) {
          paramView.setContentDescription(this.a.getString(2131719791));
        }
      }
      else
      {
        ...
        {
          paramView.setContentDescription(this.a.getString(2131690825));
          AssociatedAccountManageActivity.a(this.a).setContentDescription(this.a.getString(2131719791));
        }
        if ((localView1 instanceof ShaderAnimLayout)) {
          ((ShaderAnimLayout)localView1).showIgnoreVisible();
        }
