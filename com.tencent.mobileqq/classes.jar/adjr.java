  ...
  implements adih
{
  ...
  private baoi jdField_a_of_type_Baoi;
  private BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie;
  private SessionInfo jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public adjr(BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    this.jdField_a_of_type_AndroidContentContext = paramBaseChatPie.jdField_a_of_type_AndroidContentContext;
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie = paramBaseChatPie;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
    this.jdField_a_of_type_Baoi = new adjs(this);
  }
  
  private int a(int paramInt)
  {
    if (paramInt == 4) {
      return actn.a(-11.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    }
    return 0;
  }
  ...
  private void d()
  {
    Object localObject = (ajfg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
    ajfb localajfb = ((ajfg)localObject).a();
    if (localajfb == null) {}
    do
    {
      do
  ...
  public RobotPanelLayoutBase a()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aemf)) {
      localTroopAIORobotLayout = ((aemf)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a;
    }
    while (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aetp)) {
      return localTroopAIORobotLayout;
    }
    return ((aetp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a;
  }
  ...
  public String a(boolean paramBoolean)
  {
    ...
    if (localRobotPanelLayoutBase.getVisibility() != 0) {
      bahx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X8009FA1", str, "");
    }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getChildCount() > 0)
      {
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.setOnMeasureListener(new adjt(this, j, i + m));
          return;
          i -= 1;
          break;
          k = -1;
  ...
  public void a(int paramInt, RobotPanelLayoutBase paramRobotPanelLayoutBase, RelativeLayout paramRelativeLayout)
  {
    ...
    do
    {
      ...
      {
        return;
        paramRobotPanelLayoutBase = (TextView)paramRelativeLayout.findViewById(2131370505);
    ...
    ((RelativeLayout.LayoutParams)paramRobotPanelLayoutBase).addRule(2, 2131362356);
  }
  ...
  public void a(View paramView)
  {
    ...
    ((RelativeLayout.LayoutParams)paramView).addRule(2, 2131362356);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131378793);
    ...
    if (paramBoolean)
    {
      ((RelativeLayout.LayoutParams)localObject).addRule(6, 2131362356);
      return;
    }
  ...
  public boolean a()
  {
    return ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aemf)) || ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aetp));
  }
  ...
  public boolean a(MotionEvent paramMotionEvent, boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        paramMotionEvent = ((ajfg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249)).a();
      }
    }
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    else if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aetp))
    {
  ...
  public void b()
  {
    ...
    {
      return;
      ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131364076);
      if ((localViewGroup != null) && (this.jdField_a_of_type_AndroidContentContext != null))
      {
        Object localObject1 = (RobotPanelLayoutBase)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131362356);
        if (localObject1 != null)
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aemf)) {
            ((aemf)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a = ((TroopAIORobotLayout)localObject1);
          }
          for (;;)
          {
            ((RobotPanelLayoutBase)localObject1).setListener(this.jdField_a_of_type_Baoi);
            return;
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aetp)) {
              ((aetp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a = ((RobotChatPanelLayout)localObject1);
            }
          }
        }
        if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          ...
          localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131362264);
          int i = 1;
          ...
          {
            ((RobotPanelLayoutBase)localObject1).setListener(this.jdField_a_of_type_Baoi);
            localObject1 = (adjr)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(23);
            if (localObject1 == null) {
              break;
            }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      return;
      if (((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aemf)) && (((aemf)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).X))
      {
        String str1 = ((aemf)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).g;
        String str2 = ((aemf)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).h;
        ((TroopAIORobotLayout)localRobotPanelLayoutBase).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str1, str2, (aemf)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, new adju(this, str1));
        return;
      }
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aetp))
      {
  ...
  public void c()
  {
    ...
    for (;;)
    {
      ...
      Object localObject;
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aemf)) {
        localObject = ((aemf)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a;
      }
      while (localObject != null)
      {
        ...
        return;
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aetp)) {
          localObject = ((aetp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a;
        } else {
          localObject = null;
        }
      }
