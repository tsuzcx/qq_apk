  ...
  implements aqov
{
  ...
  private void a(Context paramContext, ColorNote paramColorNote)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        six.a(paramContext, (Bundle)localObject2, 32, ((VideoInfo)localObject1).g, ((VideoInfo)localObject1).jdField_a_of_type_Int, ((VideoInfo)localObject1).jdField_a_of_type_JavaLangString, ((VideoInfo)localObject1).b(), ((VideoInfo)localObject1).c(), ((VideoInfo)localObject1).a(), ((VideoInfo)localObject1).c, ((VideoInfo)localObject1).jdField_b_of_type_JavaLangString, ((VideoInfo)localObject1).f, ((VideoInfo)localObject1).k, ((VideoInfo)localObject1).j, ((VideoInfo)localObject1).jdField_b_of_type_Long, ((VideoInfo)localObject1).jdField_b_of_type_Boolean, ((VideoInfo)localObject1).jdField_d_of_type_Long, ((VideoInfo)localObject1).h, ((VideoInfo)localObject1).r, ((VideoInfo)localObject1).jdField_d_of_type_JavaLangString, ((VideoInfo)localObject1).o, ((VideoInfo)localObject1).p, ((VideoInfo)localObject1).e);
  ...
  private void b(Context paramContext, ColorNote paramColorNote)
  {
    ...
    catch (Exception paramColorNote)
    {
      ...
      paramColorNote = pkj.b(paramContext, paramColorNote);
  ...
  private void c(Context paramContext, ColorNote paramColorNote)
  {
    ...
    try
    {
      ...
      tto.a(paramContext, null, str1, (Bundle)localObject, bool);
      return;
    }
