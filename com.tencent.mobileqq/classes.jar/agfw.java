  ...
  extends acup
{
  ...
  public agfw(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    this.jdField_a_of_type_Adte = new agfx(paramContext, paramQQAppInterface, paramSessionInfo, null, null);
    this.jdField_a_of_type_Acuq = null;
  }
  ...
  {
    ((agfx)this.jdField_a_of_type_Adte).a(paramBoolean);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((paramView != null) && ((paramView instanceof agfu)))
    {
      paramViewGroup = (agfu)paramView;
      paramViewGroup.setIsShieldTouchForItem(true);
      paramViewGroup.setFrom(((agfx)this.jdField_a_of_type_Adte).a);
