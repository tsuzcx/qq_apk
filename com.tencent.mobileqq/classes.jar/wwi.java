  ...
  extends wxz
{
  ...
  public wwi(String paramString1, String paramString2, boolean paramBoolean)
  {
    a(false, true);
  ...
  public void a()
  {
    ...
    wug localwug = new wug();
    localwug.jdField_c_of_type_Int = 1;
    ...
    localwug.b = arrayOfString[1];
    localwug.jdField_c_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
    wfi.a().a(localwug, new wwj(this, arrayOfString));
  }
