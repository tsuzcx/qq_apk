...
public class mlg
  implements Runnable
{
  public mlg(ReadInJoyBaseAdapter paramReadInJoyBaseAdapter, long paramLong1, List paramList, int paramInt1, int paramInt2, long paramLong2) {}
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          localLinkedList.add(mlp.a(localURL, ReadInJoyDisplayUtils.c()));
        }
      ...
      if (((BaseArticleInfo)localObject2).mVideoCoverUrl != null)
      {
        ...
        localLinkedList.add(mlp.a((URL)localObject1, ReadInJoyDisplayUtils.d()));
      ...
      if ((((BaseArticleInfo)localObject2).mPictures == null) || (((BaseArticleInfo)localObject2).mPictures.length <= 0))
      {
        ...
        if ((localObject3 != null) && (((JSONArray)localObject3).length() > 0))
        {
          ...
          if (localObject1 == null)
          {
            ...
            label439:
            localLinkedList.add(mlp.a(ReadInJoyUtils.a((String)localObject1), ReadInJoyDisplayUtils.a()));
      ...
      else
      {
        if ((((BaseArticleInfo)localObject2).mPictures.length < 1) || (localObject2.mPictures[0] == null))
        {
          localObject1 = ((BaseArticleInfo)localObject2).mSinglePicture;
          label602:
          localLinkedList.add(mlp.a((URL)localObject1, ReadInJoyDisplayUtils.a()));
        ...
        label743:
        localLinkedList.add(mlp.a(((BaseArticleInfo)localObject2).mSinglePicture, ReadInJoyDisplayUtils.b()));
      }
    }
    for (;;)
    {
      localLinkedList.add(mlp.a(((BaseArticleInfo)localObject2).mSinglePicture, ReadInJoyDisplayUtils.a()));
      break label61;
      label787:
      if (ReadInJoyBaseAdapter.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseAdapter) != this.jdField_a_of_type_Long) {
        break;
      ...
      {
        localObject2 = (mlp)((Iterator)localObject1).next();
        if ((localObject2 != null) && (((mlp)localObject2).jdField_a_of_type_JavaNetURL != null))
        {
          localObject3 = new ImageRequest();
          ((ImageRequest)localObject3).jdField_a_of_type_JavaNetURL = ((mlp)localObject2).jdField_a_of_type_JavaNetURL;
          ((ImageRequest)localObject3).jdField_a_of_type_Int = ((Integer)((mlp)localObject2).jdField_a_of_type_AndroidUtilPair.first).intValue();
          ((ImageRequest)localObject3).jdField_b_of_type_Int = ((Integer)((mlp)localObject2).jdField_a_of_type_AndroidUtilPair.second).intValue();
