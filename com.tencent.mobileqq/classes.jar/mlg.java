  ...
  implements lrq
{
  ...
  {
    boolean bool = b(paramlrp, paramMotionEvent);
  ...
  boolean b(lrp paramlrp, MotionEvent paramMotionEvent)
  {
    boolean bool2 = true;
    boolean bool1;
    if ((paramlrp == null) || (paramMotionEvent == null) || (this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface == null) || (this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvVideoController == null)) {
      bool1 = false;
    }
    label438:
    label459:
          ...
          do
          {
            do
            {
              do
              {
                ...
                mdy[] arrayOfmdy = this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMdy;
                int k = arrayOfmdy.length;
                int i = 0;
                int j = 0;
                if (i < k)
                {
                  if (paramlrp == arrayOfmdy[i]) {
                ...
                for (;;)
                {
                  ...
                  {
                    paramlrp = MotionEvent.obtain(paramMotionEvent);
                    paramlrp.setAction(0);
                    VideoLayerUI.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI).a(paramlrp);
                    paramlrp.recycle();
                  }
                  ...
                  i += 1;
                  break label486;
                  paramlrp = this.jdField_a_of_type_ComTencentAvUiVideoLayerUI;
                  if (!VideoLayerUI.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI).a()) {}
                  for (bool1 = true;; bool1 = false)
                  {
                    VideoLayerUI.c(paramlrp, bool1);
                  ...
                  {
                    paramlrp = MotionEvent.obtain(paramMotionEvent);
                    paramlrp.setAction(3);
                    VideoLayerUI.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI).onTouchEvent(paramlrp);
            ...
            bool1 = bool2;
          } while (2 != this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMdy[0].h());
          bool1 = bool2;
