...
public class llr
{
  ...
  {
    Object localObject2 = (DoodleSurfaceView)paramViewGroup.findViewById(2131373362);
    ...
    if (localObject2 == null)
    {
      ...
      localView = paramViewGroup.findViewById(2131373658);
      if (localView == null) {
        break label67;
      }
    }
  ...
  public static llm a(int paramInt)
  {
    Object localObject;
    switch (paramInt)
    {
    ...
    for (;;)
    {
      ((llm)localObject).a = paramInt;
      return localObject;
      localObject = new lls();
      continue;
      localObject = new llx(2130968656);
    }
  }
  
  public static void a(ViewGroup paramViewGroup)
  {
    View localView = paramViewGroup.findViewById(2131373362);
    if (localView != null) {
  ...
  public static boolean b()
  {
    ...
    if (i < 4)
    {
      lbj.c("DoodleUtils", "isSupportOfDevice error cpucount = " + i);
      return false;
    }
    long l = llk.d();
    if (l < 1400000L)
    {
      lbj.c("DoodleUtils", "isSupportOfDevice error cpuFrequency = " + l);
      return false;
    }
    l = bhlo.d();
    if (l < 1073741824L)
    {
      lbj.c("DoodleUtils", "isSupportOfDevice error memory = " + l);
      return false;
    }
    return true;
  }
