...
public class baoj
{
  ...
  public baoj()
  {
    ...
    this.jdField_a_of_type_Baok = new baok();
    this.jdField_b_of_type_Baok = new baok();
    this.jdField_c_of_type_Baok = new baok();
    this.jdField_a_of_type_Baol = new baol();
    this.jdField_b_of_type_Baol = new baol();
    this.jdField_g_of_type_Long = System.currentTimeMillis();
  }
  
  public baoj(String paramString1, String paramString2, int paramInt)
  {
    this.jdField_a_of_type_Int = -1;
    this.jdField_b_of_type_Int = -1;
    this.jdField_d_of_type_Int = -1;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    default: 
      return;
    case 2: 
      localbaol = this.jdField_a_of_type_Baol;
      localbaol.jdField_b_of_type_Int += 1;
      return;
    case 4: 
      localbaol = this.jdField_a_of_type_Baol;
      localbaol.e += paramInt2;
      return;
    case 3: 
      localbaol = this.jdField_a_of_type_Baol;
      localbaol.d += paramInt2;
      return;
    }
    this.jdField_a_of_type_Baol.c = true;
  }
