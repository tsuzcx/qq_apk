  ...
  extends WebViewPlugin
{
  ...
  private String d = anzj.a(2131704791);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1)) {
          paramVarArgs = aber.c((String)localObject1, aber.b(1));
        }
  ...
  private void b(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramVarArgs))
        {
          paramVarArgs = aber.c(paramVarArgs, aber.b(1));
      ...
      catch (JSONException paramVarArgs)
      {
        ...
        QIPCClientHelper.getInstance().callServer("JubaoIPCServer", "", (Bundle)localObject, new awjr(this));
        bdll.b(null, "dc00898", "", "", "0x800A851", "0x800A851", 2, 0, "", "", "", "");
        return;
      }
      catch (JsonORM.JsonParseException paramVarArgs)
      {
  ...
  public void a(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    int j = 1;
    int i = 0;
    bdll.b(null, "dc00898", "", "", "0x800A851", "0x800A851", 3, 0, "", "", "", "");
    String str;
    if (paramInt == 0)
    {
      str = "";
    ...
    for (;;)
    {
      ...
      j = i;
      i = paramInt;
      bdll.b(null, "dc00898", "", "", "0x800A851", "0x800A851", 2, 0, "" + j, "" + i, "", "");
      return;
      label226:
      if (paramBundle != null)
      {
  ...
  public void callJs(String paramString, String... paramVarArgs)
  {
    if ((paramString != null) && (this.b != null) && (paramString.equals(this.b))) {
      bdll.b(null, "dc00898", "", "", "0x800A851", "0x800A851", 4, 0, "", "", "", "");
    }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("jubao".equals(paramString2))
    {
      if ("selectMsgs".equalsIgnoreCase(paramString3))
      {
        if ((paramVarArgs != null) && (paramVarArgs.length > 0))
        {
          ...
          a(paramVarArgs);
          bdll.b(null, "dc00898", "", "", "0x800A851", "0x800A851", 0, 0, "" + 0, "", "", "");
        }
        return true;
      }
    ...
    for (int i = 0;; i = 1)
    {
      bdll.b(null, "dc00898", "", "", "0x800A851", "0x800A851", 1, 0, "" + i, "", "", "");
      return true;
