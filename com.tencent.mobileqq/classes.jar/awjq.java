...
class awjq
  extends QIPCModule
{
  awjq(awjp paramawjp, String paramString)
  {
    super(paramString);
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          if (awjo.a.equals(paramString)) {
            return awjp.a(this.a, paramBundle, paramInt);
          }
          if (awjo.b.equals(paramString))
          {
            paramString = awjp.a(this.a, paramBundle, paramInt);
            if (paramString.isSuccess())
            {
              ...
              if (awjp.a(this.a).a().a((PrecoverResource)localObject, new Object[] { "PrecoverIPCServer_MODEL", Integer.valueOf(paramInt) })) {
              ...
              awjp.a(this.a).callbackResult(paramInt, EIPCResult.createResult(-2, paramBundle));
            }
            return paramString;
          }
        } while (!awjo.c.equals(paramString));
      ...
      paramString = awjp.a(this.a).a().a((String)localObject);
