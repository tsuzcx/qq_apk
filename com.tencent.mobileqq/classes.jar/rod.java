...
public class rod
  implements Runnable
{
  public rod(BaseChatPie paramBaseChatPie, long paramLong1, int paramInt1, long paramLong2, int paramInt2, Runnable paramRunnable) {}
  ...
  public void run()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().runOnUiThread(new roe(this, localMessageRecord));
  }
}
