...
public class xsv
{
  ...
  public static int a(String paramString)
  {
    ...
    try
    {
      ...
      {
        wxe.d("Q.qqstory.publish.VideoUtils", "cannot get metadata from video. rotation = " + paramString + " width = " + str2 + " height = " + str3);
        return -1;
      }
    }
    catch (IllegalArgumentException paramString)
    {
      wxe.b("Q.qqstory.publish.VideoUtils", "media exception", paramString);
      return -1;
    }
    ...
    for (;;)
    {
      wxe.d("Q.qqstory.publish.VideoUtils", "getVideoToPortraitRotation. neeRotate = " + bool1 + " orgRotation = " + i + " return = " + (i + 90) % 360);
      if (!bool1) {
        break;
      }
      return (i + 90) % 360;
  ...
  public static Pair<Integer, Integer> a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    return new Pair(Integer.valueOf(axpm.a(paramInt1)), Integer.valueOf(axpm.a(paramInt2)));
  }
  
  @TargetApi(16)
  public static ArrayList<xsw> a(String paramString, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramString.containsKey("durationUs"))
        {
          ...
          wxe.b("Q.qqstory.publish.VideoUtils", "getClosetKeyFramePosArray() find it video index = " + i);
          if (i >= 0) {
            break label172;
          }
          wxe.e("Q.qqstory.publish.VideoUtils", "getClosetKeyFramePosArray() Can not find video track index.");
      ...
      {
        wxe.c("Q.qqstory.publish.VideoUtils", "Open file error in getClosetKeyFramePosArray() file = " + paramString, localIOException);
        localMediaExtractor.release();
        return null;
      }
      wxe.e("Q.qqstory.publish.VideoUtils", "getClosetKeyFramePosArray() Can not find duration.");
      localMediaExtractor.release();
      return null;
      label165:
      i += 1;
      ...
      if (l1 - l2 < paramLong)
      {
        paramString.add(new xsw(l2, l1 - l2));
        i = 0;
        label237:
      ...
      label302:
      for (((xsw)paramString.get(i)).b = (l1 - l2);; ((xsw)paramString.get(i)).b = (((xsw)paramString.get(i + 1)).a - ((xsw)paramString.get(i)).a))
      {
        i += 1;
        break label237;
        paramString.add(new xsw(l2, paramLong));
        l2 += paramLong;
        break;
      }
      label341:
  ...
  public static int[] a(String paramString)
  {
    ...
    try
    {
      ...
      {
        wxe.d("Q.qqstory.publish.VideoUtils", "retriever.release error" + paramString);
        return arrayOfInt;
      }
      try
      {
      ...
      catch (RuntimeException localRuntimeException)
      {
        for (;;)
        {
          wxe.d("Q.qqstory.publish.VideoUtils", "retriever.release error" + localRuntimeException);
        }
      }
    }
    catch (Exception paramString)
    {
      ...
      wxe.b("Q.qqstory.publish.VideoUtils", "exception", paramString);
      try
      {
        localMediaMetadataRetriever.release();
        return null;
