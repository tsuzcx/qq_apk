  ...
  extends bdsu
{
  ...
  protected int a;
  protected long a;
  anqd jdField_a_of_type_Anqd = new bdyn(this);
  protected anuz a;
  ...
  public bdyk(bdzi parambdzi, bdzn parambdzn)
  {
    super(parambdzi, parambdzn);
    if ((this.jdField_a_of_type_Bdzn != null) && (this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForShortVideo)))
    {
      this.x = ((MessageForShortVideo)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).busiType;
      this.g = ((MessageForShortVideo)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).isStoryVideo;
      if (this.g) {
        this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo = ((MessageForShortVideo)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
      }
    }
    ...
    for (;;)
    {
      ...
      arrayOfString = parambdzi.split("QQ_&_MoblieQQ_&_QQ");
      if (4 == arrayOfString.length) {
        break;
      }
      if (QLog.isColorLevel()) {
        QLog.d("ShortVideoForwardProcessor", 2, "path was not set correctlly------path = " + parambdzi);
      }
      b(9304, "path =" + parambdzi);
      d();
  ...
  private beci a()
  {
    beci localbeci = new beci();
    localbeci.jdField_g_of_type_Int = ((int)this.jdField_a_of_type_Bdzn.jdField_a_of_type_Long);
    localbeci.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Bdzn.jdField_b_of_type_JavaLangString;
    localbeci.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_Bdzn.jdField_c_of_type_JavaLangString;
    localbeci.jdField_f_of_type_Int = this.jdField_a_of_type_Bdzn.jdField_a_of_type_Int;
    localbeci.jdField_l_of_type_Int = 0;
    localbeci.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Bdzn.jdField_c_of_type_JavaLangString;
    localbeci.jdField_e_of_type_Int = 2;
    if ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_JavaLangObject != null) && ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_JavaLangObject instanceof bceh)))
    {
      localObject = (bceh)this.jdField_a_of_type_Bdzn.jdField_a_of_type_JavaLangObject;
      localbeci.jdField_a_of_type_Int = ((bceh)localObject).jdField_c_of_type_Int;
      localbeci.jdField_b_of_type_Int = ((bceh)localObject).jdField_d_of_type_Int;
      localbeci.jdField_c_of_type_Int = ((bceh)localObject).jdField_e_of_type_Int;
      localbeci.jdField_d_of_type_Int = ((bceh)localObject).jdField_f_of_type_Int;
      this.x = localbeci.jdField_c_of_type_Int;
      int i = ((bceh)localObject).jdField_j_of_type_Int;
      this.jdField_c_of_type_Int = i;
      localbeci.k = i;
      localbeci.jdField_f_of_type_JavaLangString = ((bceh)localObject).jdField_a_of_type_JavaLangString;
      localbeci.jdField_a_of_type_JavaLangString = ((bceh)localObject).k;
      localbeci.jdField_j_of_type_Int = ((bceh)localObject).jdField_l_of_type_Int;
      localbeci.jdField_g_of_type_JavaLangString = ((bceh)localObject).jdField_l_of_type_JavaLangString;
      this.jdField_a_of_type_JavaUtilHashMap.put("param_fileFormat", String.valueOf(localbeci.jdField_j_of_type_Int));
      ...
      this.jdField_a_of_type_JavaUtilHashMap.put("param_fromChatType", String.valueOf(localbeci.jdField_a_of_type_Int));
      this.jdField_a_of_type_JavaUtilHashMap.put("param_toChatType", String.valueOf(localbeci.jdField_b_of_type_Int));
      this.jdField_a_of_type_JavaUtilHashMap.put("param_fromBusiType", String.valueOf(localbeci.jdField_c_of_type_Int));
      this.jdField_a_of_type_JavaUtilHashMap.put("param_toBusiType", String.valueOf(localbeci.jdField_d_of_type_Int));
      if ((this.jdField_b_of_type_JavaLangString != null) && (this.jdField_b_of_type_JavaLangString.length() > 0)) {
        localbeci.jdField_a_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
      }
      localbeci.jdField_a_of_type_Long = this.jdField_b_of_type_Long;
      localbeci.jdField_b_of_type_Long = this.jdField_a_of_type_Long;
      localbeci.i = this.jdField_a_of_type_Int;
      localbeci.jdField_h_of_type_Int = this.jdField_b_of_type_Int;
      if (localbeci.jdField_a_of_type_JavaLangString != null) {
        break label416;
      }
    }
    label416:
    for (Object localObject = "";; localObject = localbeci.jdField_a_of_type_JavaLangString)
    {
      localbeci.jdField_a_of_type_JavaLangString = ((String)localObject);
      localbeci.jdField_a_of_type_ArrayOfByte = this.jdField_b_of_type_ArrayOfByte;
      localbeci.jdField_b_of_type_ArrayOfByte = this.jdField_a_of_type_ArrayOfByte;
      return localbeci;
  ...
  private im_msg_body.RichText a()
  {
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForShortVideo))
        {
          Object localObject1 = (MessageForShortVideo)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
          ...
          if (this.jdField_a_of_type_Boolean)
          {
            ...
            ((im_msg_body.Text)localObject3).str.set(ByteStringMicro.copyFromUtf8(anni.a(2131712824)));
  ...
  private void r()
  {
    ...
    this.jdField_a_of_type_Bduk.c.a();
  ...
  public void a(int paramInt, HashMap<String, String> paramHashMap, long paramLong)
  {
    ...
    a(paramInt, "OnFailed.", "", this.jdField_b_of_type_Bdsz);
    d();
  }
  ...
  public void a(bebv parambebv, beck parambeck)
  {
    ...
    if (parambeck != null)
    {
      ...
      {
        parambebv = (becz)parambeck.jdField_a_of_type_JavaUtilList.get(i);
        ...
        {
          this.z = parambebv.jdField_a_of_type_Int;
          this.A = parambebv.jdField_b_of_type_Int;
          if (QLog.isColorLevel()) {
            QLog.d("ShortVideoForwardProcessor", 2, "onBusiProtoResp()------response.videoAttr = " + parambebv.jdField_a_of_type_Int + ", response.videoKandianType = " + parambebv.jdField_b_of_type_Int);
          }
        ...
        if (-5100026 == this.jdField_j_of_type_Int) {
          b(-5100026, "安全打击mUiRequest.mMd5:" + this.jdField_a_of_type_Bdzn.jdField_f_of_type_JavaLangString);
        }
        for (;;)
        {
          d();
          break;
          b(9045, anni.a(2131712850));
        }
      }
    }
  }
  
  public void a(becz parambecz)
  {
    if (this.x == 0)
    {
      if (QLog.isColorLevel()) {
        QLog.i("ShortVideoForwardProcessor", 2, "check ShortVideo before forward:" + this.jdField_a_of_type_Bdzn.i);
      }
      if ((a()) && (ShortVideoUtils.d()))
      {
        b(9305, "onBusiProtoResp=> video file can not play");
        d();
        parambecz = new HashMap();
        parambecz.put(BaseConstants.RDM_NoChangeFailCode, "");
        parambecz.put("filePath", this.jdField_a_of_type_Bdzn.i);
        parambecz.put("uuid", this.jdField_l_of_type_JavaLangString);
        parambecz.put("md5", this.jdField_a_of_type_Bdzn.jdField_f_of_type_JavaLangString);
        bctj.a(BaseApplication.getContext()).a(null, "actForwardVideoBroken", true, 0L, 0L, parambecz, "");
      }
    }
    while (!b()) {
      return;
    ...
    if ((this.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_JavaLangString.length() > 0))
    {
      if ((this.jdField_f_of_type_ArrayOfByte == null) || (this.jdField_f_of_type_ArrayOfByte.length == 0)) {
        this.jdField_f_of_type_ArrayOfByte = HexUtil.hexStr2Bytes(bgmg.c(this.jdField_a_of_type_JavaLangString));
      }
    ...
    this.jdField_r_of_type_Long = parambecz.jdField_a_of_type_Long;
    this.w = 1;
    h();
  }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    while ((this.jdField_j_of_type_Boolean) || ((paramBoolean) && ((this.jdField_m_of_type_Int & 0x2) > 0)) || ((!paramBoolean) && ((this.jdField_m_of_type_Int & 0x1) > 0))) {
      return;
    }
    ...
    if (paramBoolean)
    {
      ...
      b(true, l);
      bctj.a(BaseApplication.getContext()).a(null, c(), true, l, this.jdField_q_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    for (;;)
    {
      m();
      Log.i("AutoMonitor", "ShortVideoForward, cost=" + (this.jdField_b_of_type_Bdsz.jdField_b_of_type_Long - this.jdField_b_of_type_Bdsz.jdField_a_of_type_Long) / 1000000L + ", getReportTAG = " + c());
      return;
      i = 1;
      break;
      label495:
      ...
      b(false, l);
      bctj.a(BaseApplication.getContext()).a(null, c(), false, l, this.jdField_q_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
  
  protected void a(boolean paramBoolean, int paramInt, String paramString1, String paramString2)
  {
    this.jdField_a_of_type_Bedj.jdField_l_of_type_JavaLangString = (this.x + "");
    this.jdField_a_of_type_Bedj.jdField_j_of_type_JavaLangString = this.jdField_d_of_type_JavaLangString;
    ...
    {
      localbedj.k = str;
      this.jdField_a_of_type_Bedj.jdField_a_of_type_JavaLangString = paramString1;
      this.jdField_a_of_type_Bedj.jdField_b_of_type_JavaLangString = paramString2;
      this.jdField_a_of_type_Bedj.jdField_c_of_type_JavaLangString = String.valueOf(paramInt);
      this.jdField_a_of_type_Bedj.jdField_b_of_type_Long = this.jdField_q_of_type_Long;
  ...
  public void a(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap, String paramString, long paramLong)
  {
    ...
    try
    {
      ...
      long l5 = Long.valueOf((String)paramHashMap.get("dwFlow_Xg")).longValue();
      if (QLog.isColorLevel()) {
        QLog.d("ShortVideoForwardProcessor", 2, "<BDH_LOG> Transaction End : Success. New : SendTotalCost:" + (l1 - paramLong) + "ms ,fileSize:" + this.jdField_a_of_type_Bduk.jdField_a_of_type_Long + " transInfo:" + (String)paramHashMap.get("rep_bdhTrans"));
      }
      b(paramHashMap);
  ...
  public boolean a()
  {
    ...
    //   2: iconst_0
    //   3: istore_2
    //   4: new 928	android/media/MediaPlayer
    //   7: dup
    //   8: invokespecial 929	android/media/MediaPlayer:<init>	()V
    //   11: astore 5
    //   13: new 931	java/io/FileInputStream
    //   16: dup
    //   17: aload_0
    //   18: getfield 65	bdyk:jdField_a_of_type_Bdzn	Lbdzn;
    //   21: getfield 81	bdzn:i	Ljava/lang/String;
    //   24: invokespecial 932	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   27: astore 4
    //   29: aload 5
    //   31: aload 4
    //   33: invokevirtual 936	java/io/FileInputStream:getFD	()Ljava/io/FileDescriptor;
    //   36: invokevirtual 940	android/media/MediaPlayer:setDataSource	(Ljava/io/FileDescriptor;)V
    //   39: aload 5
    //   41: invokevirtual 943	android/media/MediaPlayer:prepare	()V
    //   44: aload 5
    //   46: ifnull +8 -> 54
    //   49: aload 5
    //   51: invokevirtual 946	android/media/MediaPlayer:release	()V
    //   54: iload_2
    //   55: istore_1
    //   56: aload 4
    //   58: ifnull +10 -> 68
    //   61: aload 4
    //   63: invokevirtual 949	java/io/FileInputStream:close	()V
    //   66: iload_2
    //   67: istore_1
    //   68: iload_1
    //   69: ireturn
    ...
    //   93: ifnull +7 -> 100
    //   96: aload_3
    //   97: invokevirtual 946	android/media/MediaPlayer:release	()V
    //   100: aload 4
    //   102: ifnull -34 -> 68
    //   105: aload 4
    //   107: invokevirtual 949	java/io/FileInputStream:close	()V
    //   110: iconst_1
    //   111: ireturn
    //   112: astore_3
    //   113: iconst_1
    ...
    //   124: ifnull +8 -> 132
    //   127: aload 5
    //   129: invokevirtual 946	android/media/MediaPlayer:release	()V
    //   132: aload 4
    //   134: ifnull +8 -> 142
    //   137: aload 4
    //   139: invokevirtual 949	java/io/FileInputStream:close	()V
    //   142: aload_3
    //   143: athrow
    //   144: astore 4
    //   146: goto -4 -> 142
  ...
  public byte[] a(beci parambeci)
  {
    ...
    localPttShortVideoUploadReq.uint64_touin.set(Long.parseLong(parambeci.jdField_d_of_type_JavaLangString));
    localPttShortVideoUploadReq.uint32_chat_type.set(parambeci.jdField_b_of_type_Int);
    localPttShortVideoUploadReq.uint32_client_type.set(parambeci.jdField_e_of_type_Int);
    PttShortVideo.PttShortVideoFileInfo localPttShortVideoFileInfo;
    PBStringField localPBStringField;
    if (parambeci.jdField_b_of_type_JavaLangString != null)
    {
      localPttShortVideoUploadReq.uint64_group_code.set(Long.parseLong(parambeci.jdField_b_of_type_JavaLangString));
      localPttShortVideoUploadReq.uint32_agent_type.set(parambeci.jdField_l_of_type_Int);
      localPttShortVideoUploadReq.uint32_business_type.set(parambeci.jdField_d_of_type_Int);
      ...
      if (parambeci.jdField_a_of_type_JavaLangString != null) {
        break label276;
      }
    }
    label276:
    for (String str = "";; str = parambeci.jdField_a_of_type_JavaLangString)
    {
      localPBStringField.set(str);
      localPttShortVideoFileInfo.bytes_file_md5.set(ByteStringMicro.copyFrom(parambeci.jdField_a_of_type_ArrayOfByte));
      localPttShortVideoFileInfo.bytes_thumb_file_md5.set(ByteStringMicro.copyFrom(parambeci.jdField_b_of_type_ArrayOfByte));
      localPttShortVideoFileInfo.uint64_file_size.set(parambeci.jdField_a_of_type_Long);
      localPttShortVideoFileInfo.uint32_file_res_length.set(parambeci.jdField_h_of_type_Int);
      localPttShortVideoFileInfo.uint32_file_res_width.set(parambeci.i);
      localPttShortVideoFileInfo.uint32_file_format.set(parambeci.jdField_j_of_type_Int);
      localPttShortVideoFileInfo.uint32_file_time.set(parambeci.k);
      localPttShortVideoFileInfo.uint64_thumb_file_size.set(parambeci.jdField_b_of_type_Long);
  ...
  public void aN_()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 124	bdyk:jdField_q_of_type_Boolean	Z
    //   4: ifeq +4 -> 8
    //   7: return
    ...
    //   23: aload_0
    //   24: invokespecial 1030	bdsu:aN_	()V
    //   27: aload_0
    //   28: sipush 1001
    //   31: invokevirtual 654	bdyk:d	(I)V
    //   34: aload_0
    //   35: getfield 521	bdyk:jdField_a_of_type_Bduk	Lbduk;
    //   38: invokevirtual 909	bduk:a	()V
    //   41: aload_0
    //   42: getfield 65	bdyk:jdField_a_of_type_Bdzn	Lbdzn;
    //   45: getfield 664	bdzn:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    //   48: invokestatic 1036	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   51: ifne +40 -> 91
    //   54: aload_0
    //   55: aload_0
    //   56: getfield 65	bdyk:jdField_a_of_type_Bdzn	Lbdzn;
    //   59: getfield 664	bdzn:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    //   62: invokestatic 147	com/qq/taf/jce/HexUtil:hexStr2Bytes	(Ljava/lang/String;)[B
    //   65: putfield 255	bdyk:jdField_b_of_type_ArrayOfByte	[B
    //   68: aload_0
    //   69: getfield 521	bdyk:jdField_a_of_type_Bduk	Lbduk;
    //   72: astore_1
    //   73: aload_0
    //   74: getfield 65	bdyk:jdField_a_of_type_Bdzn	Lbdzn;
    //   77: getfield 664	bdzn:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    //   80: astore_2
    //   81: aload_1
    //   82: aload_2
    //   83: putfield 1037	bduk:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    //   86: aload_0
    //   87: aload_2
    //   88: putfield 1038	bdyk:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   91: aload_0
    //   92: getfield 65	bdyk:jdField_a_of_type_Bdzn	Lbdzn;
    //   95: getfield 178	bdzn:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   98: ifnull +105 -> 203
    //   101: aload_0
    //   102: getfield 65	bdyk:jdField_a_of_type_Bdzn	Lbdzn;
    //   105: getfield 178	bdzn:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   108: instanceof 180
    //   111: ifeq +92 -> 203
    //   114: aload_0
    //   115: getfield 65	bdyk:jdField_a_of_type_Bdzn	Lbdzn;
    //   118: getfield 178	bdzn:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   121: checkcast 180	bceh
    //   124: astore_1
    //   125: aload_0
    //   126: aload_1
    //   127: getfield 1039	bceh:i	I
    //   130: i2l
    //   131: putfield 244	bdyk:jdField_b_of_type_Long	J
    //   134: aload_0
    //   135: aload_1
    //   136: getfield 1040	bceh:jdField_m_of_type_Int	I
    //   139: i2l
    //   140: putfield 246	bdyk:jdField_a_of_type_Long	J
    //   143: aload_0
    //   144: aload_1
    //   145: getfield 1041	bceh:jdField_g_of_type_Int	I
    //   148: putfield 229	bdyk:jdField_a_of_type_Int	I
    //   151: aload_0
    //   152: aload_1
    //   153: getfield 1042	bceh:jdField_h_of_type_Int	I
    //   156: putfield 226	bdyk:jdField_b_of_type_Int	I
    //   159: aload_0
    //   160: aload_1
    //   161: getfield 1044	bceh:jdField_c_of_type_Boolean	Z
    //   164: putfield 394	bdyk:jdField_a_of_type_Boolean	Z
    //   167: aload_0
    //   168: getfield 255	bdyk:jdField_b_of_type_ArrayOfByte	[B
    //   171: ifnull +20 -> 191
    //   174: aload_0
    //   175: getfield 255	bdyk:jdField_b_of_type_ArrayOfByte	[B
    //   178: arraylength
    //   179: ifeq +12 -> 191
    //   182: aload_0
    //   183: getfield 244	bdyk:jdField_b_of_type_Long	J
    //   186: lconst_0
    //   187: lcmp
    //   188: ifgt +79 -> 267
    //   191: aload_0
    //   192: invokevirtual 1046	bdyk:h	()Z
    //   195: ifne +33 -> 228
    //   198: aload_0
    //   199: invokevirtual 121	bdyk:d	()V
    //   202: return
    //   203: aload_0
    //   204: ldc_w 1048
    //   207: ldc_w 261
    //   210: invokevirtual 264	bdyk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   213: aload_0
    //   214: sipush 9302
    //   217: ldc_w 1050
    //   220: invokevirtual 119	bdyk:b	(ILjava/lang/String;)V
    //   223: aload_0
    //   224: invokevirtual 121	bdyk:d	()V
    //   227: return
    //   228: aload_0
    //   229: aload_0
    //   230: getfield 255	bdyk:jdField_b_of_type_ArrayOfByte	[B
    //   233: putfield 729	bdyk:e	[B
    //   236: new 715	java/io/File
    //   239: dup
    //   240: aload_0
    //   241: getfield 65	bdyk:jdField_a_of_type_Bdzn	Lbdzn;
    //   244: getfield 81	bdzn:i	Ljava/lang/String;
    //   247: invokespecial 718	java/io/File:<init>	(Ljava/lang/String;)V
    //   250: astore_1
    //   251: aload_0
    //   252: aload_1
    //   253: invokevirtual 723	java/io/File:length	()J
    //   256: putfield 244	bdyk:jdField_b_of_type_Long	J
    //   259: aload_0
    //   260: aload_1
    //   261: invokevirtual 1053	java/io/File:getName	()Ljava/lang/String;
    //   264: putfield 238	bdyk:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   267: aload_0
    //   268: getfield 149	bdyk:jdField_a_of_type_ArrayOfByte	[B
    //   271: ifnull +34 -> 305
    //   274: aload_0
    //   275: getfield 149	bdyk:jdField_a_of_type_ArrayOfByte	[B
    //   278: arraylength
    //   279: ifeq +26 -> 305
    //   282: aload_0
    //   283: getfield 246	bdyk:jdField_a_of_type_Long	J
    //   286: lconst_0
    //   287: lcmp
    //   288: ifle +17 -> 305
    //   291: aload_0
    //   292: getfield 229	bdyk:jdField_a_of_type_Int	I
    //   295: ifle +10 -> 305
    //   298: aload_0
    //   299: getfield 226	bdyk:jdField_b_of_type_Int	I
    //   302: ifgt +132 -> 434
    //   305: new 931	java/io/FileInputStream
    //   308: dup
    //   309: aload_0
    //   310: getfield 133	bdyk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   313: invokespecial 932	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   316: astore_2
    //   317: aload_2
    //   318: astore_1
    //   319: aload_0
    //   320: aload_2
    //   321: lconst_0
    //   322: invokestatic 1059	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   325: putfield 149	bdyk:jdField_a_of_type_ArrayOfByte	[B
    //   328: aload_2
    //   329: astore_1
    //   330: aload_0
    //   331: getfield 149	bdyk:jdField_a_of_type_ArrayOfByte	[B
    ...
    //   356: aload_0
    //   357: getfield 133	bdyk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   366: invokevirtual 119	bdyk:b	(ILjava/lang/String;)V
    //   369: aload_2
    //   370: astore_1
    //   371: aload_0
    //   372: invokevirtual 121	bdyk:d	()V
    //   375: aload_2
    //   376: ifnull -369 -> 7
    //   379: aload_2
    //   380: invokevirtual 949	java/io/FileInputStream:close	()V
    //   383: return
    //   384: astore_1
    //   385: aload_1
    //   386: invokevirtual 1062	java/io/IOException:printStackTrace	()V
    //   389: return
    //   390: aload_2
    //   391: astore_1
    //   392: aload_0
    //   393: aload_0
    //   394: getfield 149	bdyk:jdField_a_of_type_ArrayOfByte	[B
    //   397: putfield 708	bdyk:jdField_f_of_type_ArrayOfByte	[B
    //   400: aload_2
    //   401: ifnull +7 -> 408
    //   404: aload_2
    //   405: invokevirtual 949	java/io/FileInputStream:close	()V
    //   408: aload_0
    //   409: new 715	java/io/File
    //   412: dup
    //   413: aload_0
    //   414: getfield 133	bdyk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   417: invokespecial 718	java/io/File:<init>	(Ljava/lang/String;)V
    //   420: invokevirtual 723	java/io/File:length	()J
    //   423: putfield 246	bdyk:jdField_a_of_type_Long	J
    //   426: aload_0
    //   427: aload_0
    //   428: getfield 133	bdyk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   431: invokevirtual 725	bdyk:b	(Ljava/lang/String;)V
    //   434: aload_0
    //   435: invokevirtual 747	bdyk:f	()V
    //   438: return
    //   439: astore_1
    //   440: aload_1
    //   441: invokevirtual 1062	java/io/IOException:printStackTrace	()V
    //   444: goto -36 -> 408
    //   447: astore_3
    //   448: aconst_null
    //   449: astore_2
    ...
    //   452: aload_0
    //   453: aconst_null
    //   454: putfield 149	bdyk:jdField_a_of_type_ArrayOfByte	[B
    //   457: aload_2
    //   458: astore_1
    //   459: aload_0
    //   460: aload_3
    //   461: invokevirtual 1065	bdyk:a	(Ljava/io/IOException;)V
    //   464: aload_2
    //   465: astore_1
    //   466: aload_0
    //   467: invokevirtual 121	bdyk:d	()V
    //   470: aload_2
    //   471: ifnull -464 -> 7
    //   474: aload_2
    //   475: invokevirtual 949	java/io/FileInputStream:close	()V
    //   478: return
    //   479: astore_1
    //   480: aload_1
    //   481: invokevirtual 1062	java/io/IOException:printStackTrace	()V
    //   484: return
    //   485: astore_2
    //   486: aconst_null
    //   487: astore_1
    ...
    //   489: ifnull +7 -> 496
    //   492: aload_1
    //   493: invokevirtual 949	java/io/FileInputStream:close	()V
    //   496: aload_2
    //   497: athrow
    //   498: astore_1
    //   499: aload_1
    //   500: invokevirtual 1062	java/io/IOException:printStackTrace	()V
    //   503: goto -7 -> 496
    //   506: astore_2
    //   507: goto -19 -> 488
    //   510: astore_3
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ShortVideoForwardProcessor", 2, "resume()  + mIsPause : " + this.jdField_m_of_type_Boolean);
    }
    if (this.jdField_m_of_type_Boolean)
    {
      ...
      r();
      this.jdField_a_of_type_Bdsv.a.post(new ShortVideoForwardProcessor.1(this));
    }
    return 0;
  }
  ...
  void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Bdzn.jdField_e_of_type_Int == 1010) && (this.jdField_a_of_type_Bdzn.jdField_a_of_type_Ayyt != null))
      {
        super.e();
        localObject2 = new ayyu();
        ((ayyu)localObject2).jdField_a_of_type_Int = 0;
        ((ayyu)localObject2).jdField_a_of_type_Long = this.jdField_b_of_type_Long;
        ((ayyu)localObject2).jdField_d_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
        if (this.jdField_f_of_type_JavaLangString == null) {}
        for (localObject1 = this.jdField_l_of_type_JavaLangString;; localObject1 = this.jdField_f_of_type_JavaLangString)
        {
          ((ayyu)localObject2).jdField_c_of_type_JavaLangString = ((String)localObject1);
          ((ayyu)localObject2).jdField_c_of_type_Long = this.jdField_a_of_type_Long;
          ((ayyu)localObject2).jdField_c_of_type_Int = this.z;
          ((ayyu)localObject2).jdField_d_of_type_Int = this.A;
          this.jdField_a_of_type_Bdzn.jdField_a_of_type_Ayyt.a((ayyu)localObject2);
          this.jdField_a_of_type_Bdzn.jdField_a_of_type_Ayyt.b((ayyu)localObject2);
          return;
        }
      }
      ((bauy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(326)).a((MessageRecord)localObject1, this.jdField_a_of_type_Anqd);
    } while ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_JavaLangObject == null) || (!(this.jdField_a_of_type_Bdzn.jdField_a_of_type_JavaLangObject instanceof bceh)));
    label266:
    Object localObject2 = (bceh)this.jdField_a_of_type_Bdzn.jdField_a_of_type_JavaLangObject;
    bard localbard = new bard(BaseApplication.getContext());
    int j;
    switch (((bceh)localObject2).jdField_c_of_type_Int)
    {
    default: 
      i = 5;
    case 0: 
      j = k;
      switch (((bceh)localObject2).jdField_f_of_type_Int)
      {
      default: 
        j = k;
      }
    ...
    for (;;)
    {
      localbard.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((bceh)localObject2).jdField_h_of_type_JavaLangString, j, ((MessageRecord)localObject1).istroop, ((MessageRecord)localObject1).frienduin, true, paramBoolean, i, ((bceh)localObject2).jdField_m_of_type_JavaLangString, ((bceh)localObject2).jdField_j_of_type_Int, ((bceh)localObject2).jdField_e_of_type_JavaLangString);
      return;
      i = 1;
      break;
      i = 3000;
  ...
  public boolean b()
  {
    if ((this.jdField_a_of_type_Bdzn.i != null) && (this.jdField_a_of_type_Bdzn.i.length() > 0))
    {
      if ((this.e == null) || (this.e.length == 0)) {
        this.e = HexUtil.hexStr2Bytes(bgmg.c(this.jdField_a_of_type_Bdzn.i));
      }
      File localFile = new File(this.jdField_a_of_type_Bdzn.i);
  ...
  public void c(boolean paramBoolean)
  {
    ...
    for (String str = this.jdField_l_of_type_JavaLangString;; str = this.jdField_f_of_type_JavaLangString)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_Bdzn.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Bdzn.jdField_a_of_type_Int, localMessageRecord.uniseq, localMessageForShortVideo.msgData);
      return;
    }
  }
  ...
  protected void d(int paramInt)
  {
    super.d(paramInt);
    if (this.g) {
      bovt.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, paramInt, f());
    }
    if ((this.jdField_m_of_type_Boolean) && (1004 != paramInt)) {
      return;
    }
  ...
  {
    super.e();
    if (this.jdField_a_of_type_Anuz != null) {
      this.jdField_a_of_type_Anuz.a(this.jdField_a_of_type_Bdzn.jdField_f_of_type_JavaLangString + this.jdField_a_of_type_Bdzn.jdField_c_of_type_JavaLangString + this.jdField_a_of_type_Bdzn.jdField_a_of_type_Long);
    }
    String str;
    if (this.jdField_a_of_type_Bdzn.jdField_a_of_type_Ayyt != null)
    {
      ...
      localayyu.jdField_a_of_type_Long = this.jdField_b_of_type_Long;
      ...
      if (this.jdField_f_of_type_JavaLangString == null)
      {
        ...
        localayyu.jdField_c_of_type_Long = this.jdField_a_of_type_Long;
        localayyu.jdField_c_of_type_Int = this.z;
        localayyu.jdField_d_of_type_Int = this.A;
        this.jdField_a_of_type_Bdzn.jdField_a_of_type_Ayyt.b(localayyu);
      }
    }
    for (;;)
  ...
  void f()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ShortVideoForwardProcessor", 2, "sendGetUrlReq()----busiReq.seq : " + this.jdField_a_of_type_Bdzn.jdField_a_of_type_Long);
    }
    beci localbeci = a();
    if (localbeci == null) {}
    do
    {
      ...
      localbebv.jdField_a_of_type_JavaLangString = "short_video_fw";
      localbebv.jdField_a_of_type_JavaUtilList.add(localbeci);
  ...
  public void h()
  {
    ...
    byte[] arrayOfByte = a(localbeci);
    if (QLog.isColorLevel()) {
      QLog.d("ShortVideoForwardProcessor", 2, "<BDH_LOG> sendFileByBDH . ,shortVideoReq.md5 :" + HexUtil.bytes2HexStr(localbeci.jdField_a_of_type_ArrayOfByte) + ",shortVideoReq.thumbFileMd5 = " + HexUtil.bytes2HexStr(localbeci.jdField_b_of_type_ArrayOfByte) + ",mLocalMd5 = " + HexUtil.bytes2HexStr(this.jdField_b_of_type_ArrayOfByte));
    }
    bdyl localbdyl = new bdyl(this, (String)localObject, l);
    if (localbeci.jdField_c_of_type_Int == 0) {}
    for (int i = 25;; i = 12)
    {
      this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), i, (String)localObject, (int)this.jdField_r_of_type_Long, this.jdField_b_of_type_ArrayOfByte, localbdyl, arrayOfByte, true);
      localObject = new bdym(this);
