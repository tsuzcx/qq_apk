...
public final class uam
{
  ...
  @JvmStatic
  @NotNull
  public final List<two> a(@NotNull JSONArray paramJSONArray, @Nullable JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject1 = (Integer)uak.a().get(localObject2);
          if (localObject1 == null) {
            break label334;
          }
          localArrayList.add(new two((String)localObject2, ((Integer)localObject1).intValue(), false));
          break label334;
        }
        ...
        if ((TextUtils.isEmpty((CharSequence)localObject1)) || (uak.a().get(localObject1) == null)) {
          break label334;
        }
        ...
        localObject2 = (Integer)uak.a().get(localObject1);
      ...
      localArrayList.add(new txg((String)localObject1, j, bool, (String)localObject2));
      break label334;
      label245:
      return (List)localArrayList;
      label251:
    ...
    Object localObject2 = (Integer)uak.a().get(localObject1);
    if (localObject2 != null) {
      j = ((Integer)localObject2).intValue();
    }
    for (;;)
    {
      label300:
      localArrayList.add(new two((String)localObject1, j, bool));
      break label334;
      j = 0;
      label334:
      label341:
  ...
  @JvmStatic
  @NotNull
  public final List<two> b()
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new two("kandian", 13, false));
    localArrayList.add(new two("qq_friend", 2, false));
    localArrayList.add(new two("qzone", 3, false));
    localArrayList.add(new two("we_chat", 9, false));
    localArrayList.add(new two("we_chat_circle", 10, false));
    localArrayList.add(new two("we_bo", 12, false));
    localArrayList.add(new two("send_pc", 26, false));
    localArrayList.add(new two("qq_browser", 5, false));
    localArrayList.add(new two("sys_browser", 4, false));
    return (List)localArrayList;
  }
  
  @JvmStatic
  @NotNull
  public final List<two> c()
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new two("screen_shot", 21, false));
    localArrayList.add(new two("set_font", 7, false));
    localArrayList.add(new two("add_favourite", 6, false));
    localArrayList.add(new two("copy_link", 1, false));
    localArrayList.add(new two("report", 11, false));
    return (List)localArrayList;
  }
}
