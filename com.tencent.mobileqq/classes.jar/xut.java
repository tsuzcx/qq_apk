...
public class xut
{
  ...
  public xut(@NonNull Activity paramActivity, @NonNull RMVideoStateMgr paramRMVideoStateMgr, @NonNull Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Boolean = paramIntent.getBooleanExtra("extra_now_tab", weg.a(2131099651).booleanValue());
    ...
    if ((paramIntent.getIntExtra("edit_video_type", 0) == 10002) && (this.jdField_a_of_type_Long > 0L)) {
      ykv.b("take_video", "video_startup", 0, 0, new String[] { "", String.valueOf(SystemClock.uptimeMillis() - this.jdField_a_of_type_Long), String.valueOf(this.jdField_b_of_type_Int) });
    }
    ykq.a("QQStoryTakeVideoHelper", "default label:%s", this.jdField_a_of_type_JavaLangString);
  }
  ...
  private void a(PublishParam paramPublishParam, String paramString, int paramInt)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      if (weh.a())
      {
        StoryTransitionActivity.a(this.jdField_a_of_type_AndroidAppActivity, xuc.class.getName(), null);
  ...
  private boolean a()
  {
    ...
    {
      ykq.e("QQStoryTakeVideoHelper", "check manifest's existance error. directory is null.");
      return false;
    }
  ...
  public String a()
  {
    return (String)((wjl)wjs.a(10)).b("StorySvc.get_photography_guide.word", anvx.a(2131710510));
  }
  
  public String a(String paramString)
  {
    Object localObject = (wjl)wjs.a(10);
    int i = ((Integer)((wjl)localObject).b("StoryVideoWidth", Integer.valueOf(-1))).intValue();
    int j = ((Integer)((wjl)localObject).b("StoryVideoHeight", Integer.valueOf(-1))).intValue();
    int k = ((Integer)((wjl)localObject).b("StoryVideoMaxrate", Integer.valueOf(-1))).intValue();
    int m = ((Integer)((wjl)localObject).b("StoryVideoMinrate", Integer.valueOf(-1))).intValue();
    String str = (String)((wjl)localObject).b("StoryVideoKey", "960*720#600#1000;640*480#450#750");
    ykq.b("QQStoryTakeVideoHelper", "setupStoryVideoConfig : key = " + str + " width = " + i + " height = " + j + " maxrate = " + k + " minrate = " + m);
    if ((i == -1) && (j == -1) && (k == -1) && (m == -1) && ((str == null) || (str.isEmpty()) || (str.equals("-1")))) {
      ykq.b("QQStoryTakeVideoHelper", "setupStoryVideoConfig : no configs");
    }
    label390:
    ...
    ykq.d("QQStoryTakeVideoHelper", "setupStoryVideoConfig(): newConfig = " + paramString);
    return paramString;
  }
  
  public void a()
  {
    yfc.a(new xuw(this, (wjl)wjs.a(10)));
  }
  
  public void a(Intent paramIntent, @NonNull ImageView paramImageView)
  {
    ykq.b("QQStoryTakeVideoHelper", "preview confirm");
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        ykq.b("QQStoryTakeVideoHelper", "preview confirm takephoto ");
      ...
      if (!a())
      {
        ykq.d("QQStoryTakeVideoHelper", "manifest file doesn't exist. generate again before publishing.");
        a(new xuu(this, localPublishParam, str, i));
        return;
      }
      ykq.c("QQStoryTakeVideoHelper", "manifest file already exists. start publishing.");
      a(localPublishParam, str, i);
      return;
    }
  ...
  public void a(xux paramxux)
  {
    this.jdField_a_of_type_Int = 1;
    Stream.of(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr).map(new ThreadOffFunction("QQStoryTakeVideoHelper", 2)).map(new yyj()).subscribe(new xuv(this, paramxux));
  }
