...
public class avyf
{
  ...
  private static void a(BaseActivity paramBaseActivity, avyk paramavyk)
  {
    ThreadManagerV2.postImmediately(new MultiAIOStarter.2(paramBaseActivity, paramavyk), null, false);
  }
  ...
  public static boolean a(Context paramContext, String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    if (!((avyj)BaseApplicationImpl.getApplication().getRuntime().getManager(325)).a())
    {
      if (QLog.isColorLevel()) {
    ...
    if (avxy.a(paramInt))
    {
      ...
      avyk localavyk = avyk.a(localQQAppInterface);
      Bitmap localBitmap = a(paramContext);
      int i = a(paramContext);
      a = true;
      localavyk.a(localBitmap);
      localavyk.a(i);
      a((BaseActivity)paramContext, localavyk);
      localavyk.a((QQAppInterface)localQQAppInterface, (FragmentActivity)paramContext, paramString3, paramInt, paramString1, paramString2);
      localavyk.a(new avyg(paramContext));
      localIntent.putExtra("OPEN_MULTI_AIO_CONTEXT", localavyk.a());
      if ("open_from_aio".equals(paramString3)) {
        localIntent.putExtra("OPEN_MULTI_AIO_LIST_VIEW_SPECIFY_BOTTOM", a(paramContext));
      }
      adxr.a(paramContext, localIntent, PublicTransFragmentActivity.class, MultiAIOFragment.class);
      return true;
    }
    return false;
  }
  ...
  private static int[] a(Context paramContext)
  {
    ...
    if ((paramContext instanceof BaseActivity))
    {
      paramContext = (ListView)((BaseActivity)paramContext).findViewById(2131370017);
      if (paramContext != null)
      {
