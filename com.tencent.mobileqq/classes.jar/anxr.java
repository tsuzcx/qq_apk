...
public class anxr
{
  ...
  public anxr(anyf paramanyf)
  {
    this.jdField_a_of_type_Anyf = paramanyf;
  }
  
  public anxr(QQAppInterface paramQQAppInterface, anyf paramanyf)
  {
    this(paramanyf);
  ...
  public static Bundle a(int paramInt1, String paramString, boolean paramBoolean, int paramInt2)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1)
    {
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        localBundle.putBoolean("extra_after_sync_msg", aobd.a());
        localObject = aobd.a(paramString);
        ...
        aobd.a(paramString.getApp(), 3, true);
        return localBundle;
        paramInt1 = 1;
        break;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, amji paramamji)
  {
    anxv.a(paramQQAppInterface.a().a().a(paramQQAppInterface.getCurrentAccountUin(), paramamji));
  }
  ...
  private void a(ColorNote paramColorNote)
  {
    ...
    if (this.jdField_a_of_type_Anyf == null)
    {
      ...
      if (localObject != null) {
        this.jdField_a_of_type_Anyf = ((ProxyManager)localObject).a();
      }
      if (this.jdField_a_of_type_Anyf == null)
      {
    ...
    for (int i = 1;; i = 0)
    {
      localObject = this.jdField_a_of_type_Anyf;
      paramColorNote.animate = true;
      if ((((anyf)localObject).a()) || (i != 0) || (paramColorNote.getServiceType() == 16973824))
      {
        ((anyf)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramColorNote, null, false);
        if (QLog.isColorLevel()) {
        ...
        localObject = bdiv.a(BaseApplicationImpl.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
        ...
        for (int j = 1;; j = 0)
        {
          if (j != 0)
          {
            aobd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), true, false);
            if (i != 0) {
          ...
          aobd.a(BaseApplicationImpl.getContext());
          return;
          i = 0;
          break label216;
        }
      ...
      QLog.d("ColorNoteHelper", 2, "addColorNoteInner~~~ fail cause count limit, maxCount = " + anyf.a + " , currCount = " + ((anyf)localObject).a());
      return;
    }
  }
  ...
  protected static void a(String paramString, int paramInt)
  {
    ...
    paramString = ((anyf)localObject1).a(paramString, paramInt);
    if (paramString == null) {}
    do
    {
      return;
      ((anyf)localObject1).a(((QQAppInterface)localObject2).c(), paramString, null);
      aobd.a(((QQAppInterface)localObject2).getApp(), 3, false);
      ...
      localIntent.putExtra("extra_can_add_colornote", ((anyf)localObject1).a());
      localIntent.putExtras(paramString.parseBundle());
      BaseApplicationImpl.getContext().sendBroadcast(localIntent);
      localObject1 = new ArrayList();
      ((ArrayList)localObject1).add(paramString);
      anxv.a((ArrayList)localObject1);
  ...
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    anyf localanyf = localQQAppInterface.a().a();
    aobd.a(localQQAppInterface.getApp(), true, false);
    return localanyf.a(localQQAppInterface.c(), paramColorNote);
  }
  ...
  public Bundle a(String paramString, boolean paramBoolean)
  {
    ...
    if (d())
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (this.jdField_a_of_type_Anyf == null)) {
        return null;
      }
      paramString = this.jdField_a_of_type_Anyf.a(paramString);
      if (paramString != null)
      {
        if (paramBoolean) {
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        localBundle.putBoolean("extra_after_sync_msg", aobd.a());
        paramString = aobd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        localBundle.putInt("key_float_window_position_x", paramString.x);
        localBundle.putInt("key_float_window_position_y", paramString.y);
        aobd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 3, true);
        return localBundle;
        i = 1;
        break;
      }
  ...
  public boolean a(String paramString)
  {
    ...
    if (d())
    {
      ...
      return a(paramString, this.jdField_a_of_type_Anyf.a(false));
    }
    Bundle localBundle = new Bundle();
  ...
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (this.jdField_a_of_type_Anyf == null) || (bdje.a(paramString))) {}
    do
    {
      return false;
      paramString = this.jdField_a_of_type_Anyf.a(paramString, paramInt);
    } while (paramString == null);
    this.jdField_a_of_type_Anyf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramString, null);
    aobd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 3, false);
    Object localObject = paramString.getServiceType() + "";
    String str = paramString.getSubType();
    Intent localIntent = new Intent("key_delete_item_call");
    localIntent.putExtra("key_color_note_servicetype_list", new String[] { localObject });
    localIntent.putExtra("key_color_note_suptype_list", new String[] { str });
    localIntent.putExtra("extra_can_add_colornote", this.jdField_a_of_type_Anyf.a());
    localIntent.putExtras(paramString.parseBundle());
    BaseApplicationImpl.getContext().sendBroadcast(localIntent);
    localObject = new ArrayList();
    ((ArrayList)localObject).add(paramString);
    anxv.a((ArrayList)localObject);
  ...
  boolean b(ColorNote paramColorNote)
  {
    ...
    aobd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), true, false);
    return this.jdField_a_of_type_Anyf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramColorNote);
  }
  ...
  public boolean b(String paramString1, String paramString2, Object paramObject)
  {
    ...
    do
    {
      ...
      {
        bool1 = bool3;
        if (this.jdField_a_of_type_Anyf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramString1, paramString2, paramObject) != null) {
          bool1 = true;
        }
      }
      bool2 = bool1;
  ...
  {
    if (d()) {
      return this.jdField_a_of_type_Anyf.a();
    }
    Object localObject = QIPCClientHelper.getInstance().getClient().callServer("ColorNoteIPCServer", "cmd_can_add_colornote", null);
    if ((localObject != null) && (((EIPCResult)localObject).isSuccess())) {
      return ((EIPCResult)localObject).data.getBoolean("extra_can_add_colornote", false);
