    ...
    if (paramString2.equalsIgnoreCase("historicalSig"))
    {
      ...
      do
      {
          ...
          do
          {
            try
            {
              ...
              if (ChatActivityUtils.a(paramString2))
              {
                ...
                abtu.a(paramJsBridgeListener, paramString3, PublicFragmentActivity.class, SignatureHistoryFragment.class);
              }
              QLog.d("JumpProfilePlugin", 1, new Object[] { "historicalSiglist", "fromType=", paramString1, " fromUin", bbjw.e(paramString2) });
            }
            ...
            try
            {
              ...
              QLog.d("JumpProfilePlugin", 1, new Object[] { "personalTagList", "fromType=", paramString1, " fromUin", bbjw.e(paramString2) });
              return true;
            }
            catch (JSONException paramJsBridgeListener) {}
          } while (!QLog.isColorLevel());
        ...
        try
        {
          ...
          QLog.d("JumpProfilePlugin", 1, new Object[] { "zanlist", "fromType=", paramString2, " fromUin", bbjw.e(paramString3) });
          return true;
        }
        catch (JSONException paramJsBridgeListener) {}
      } while (!QLog.isColorLevel());
