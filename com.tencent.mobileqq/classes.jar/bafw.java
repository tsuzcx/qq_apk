  ...
  implements DialogInterface.OnDismissListener, View.OnClickListener
{
  ...
  baim jdField_a_of_type_Baim = new bafx(this);
  ...
  public bafw(Context paramContext, int paramInt)
  {
    ...
    label194:
    for (paramInt = baik.a(0);; paramInt = (int)(150.0F * this.jdField_a_of_type_AndroidContentResResources.getDisplayMetrics().density))
    {
  ...
  public String a()
  {
    ...
    Object localObject;
    if ((this.jdField_a_of_type_AndroidWidgetEditText.getText() instanceof axkr))
    {
      localObject = (axkr)this.jdField_a_of_type_AndroidWidgetEditText.getText();
      if (localObject != null) {
        return ((axkr)localObject).a();
      }
    }
    else if ((this.jdField_a_of_type_AndroidWidgetEditText.getText() instanceof axkn))
    {
      localObject = (axkn)this.jdField_a_of_type_AndroidWidgetEditText.getText();
      if (localObject != null) {
        return ((axkn)localObject).a();
      }
    }
  ...
  {
    bagf localbagf = new bagf(this);
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if ((localAppRuntime instanceof QQAppInterface))
    {
      int i = getContext().getResources().getDimensionPixelSize(2131167766);
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel = ((EmoticonMainPanel)View.inflate(getContext(), 2131493455, null));
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setCallBack(localbagf);
    ...
    if (this.h == 7)
    {
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel = new SystemAndEmojiEmoticonPanel(paramContext, localbagf);
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel = new SystemEmoticonPanel(paramContext, localbagf);
  }
  ...
  public void c(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetEditText != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new bage(this, paramInt));
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    while (paramView.getId() == 2131299981)
    {
      if (localObject != null)
      {
        if (this.c)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130839571));
      ...
      if ((paramView != null) && ((paramView instanceof Integer)) && (((Integer)paramView).intValue() == 2130839572))
      {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130839572));
      if (this.jdField_a_of_type_Boolean) {
        ((View)localObject).setMinimumHeight(baik.a(0));
      }
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131299575));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131302566));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131299981));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
    findViewById(2131309898).setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetEditText.setEditableFactory(axkn.b);
    this.jdField_a_of_type_AndroidWidgetEditText.setSingleLine(this.b);
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new baga(this));
    Object localObject = (Context)this.jdField_a_of_type_JavaLangRefSoftReference.get();
    if (localObject == null) {
      return;
    }
    yes.a((Context)localObject, this.jdField_a_of_type_AndroidWidgetEditText);
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Baik = new baik(((ViewGroup)getWindow().getDecorView().findViewById(16908290)).getChildAt(0), this.jdField_a_of_type_AndroidViewWindowManager.getDefaultDisplay().getHeight(), this.jdField_a_of_type_Baim);
      this.jdField_a_of_type_Int = this.jdField_a_of_type_Baik.a();
      this.jdField_a_of_type_Int = baik.a(this.jdField_a_of_type_Int);
      setOnDismissListener(this);
      a((Context)localObject);
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setDispatchKeyEventListener(new bagb(this));
    }
    for (;;)
    {
      localObject = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131309891);
      if ((localObject instanceof ScrollView)) {
        this.jdField_a_of_type_AndroidWidgetScrollView = ((ScrollView)localObject);
      }
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.getViewTreeObserver().addOnGlobalLayoutListener(new bagd(this));
      return;
      a((Context)localObject);
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel.setBackgroundResource(2130837699);
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel.setMinimumHeight(aciy.a(150.0F, this.jdField_a_of_type_AndroidContentResResources));
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel.setDispatchKeyEventListener(new bagc(this));
    }
  }
  ...
  public bafb setNegativeButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new bafy(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public bafb setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.rBtn.setOnClickListener(new bafz(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
