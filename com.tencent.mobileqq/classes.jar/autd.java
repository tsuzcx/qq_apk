...
public class autd
{
  private static final String jdField_a_of_type_JavaLangString = anvx.a(2131718628);
  ...
  private void a(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      nty.a().a = true;
      admh.b(localQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramBundle, str);
      return;
    }
  ...
  private void a(Bundle paramBundle, String paramString1, String paramString2, long paramLong)
  {
    ...
    {
      paramString1 = auui.a(paramBundle, paramString1, paramString2, null, l);
      auui.a(this.jdField_a_of_type_ComTencentMobileqqMiniShareOpensdkOpenSdkShareModel, paramBundle, paramString1);
    ...
    ntb.a(paramString2, new autf(this, paramLong, paramBundle), paramString1.toByteArray(), "OidbSvc.0xb77_9", 2935, 9, localBundle, 0L);
  }
  
  private void a(azlb paramazlb, Bundle paramBundle, long paramLong)
  {
    String str;
    Object localObject;
    if (System.currentTimeMillis() - paramLong > 10000L)
    {
      ...
      a(new Object[] { Integer.valueOf(0), "", anvx.a(2131704269), "" }, -3);
    }
    label143:
    label150:
    label157:
  ...
  private void a(AbsShareMsg paramAbsShareMsg, Bundle paramBundle)
  {
    ...
    aute localaute = new aute(this, paramBundle, System.currentTimeMillis());
    if (a(paramBundle))
    {
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForArkApp = AbsShareMsg.sendSdkFakeMessage(paramBundle, localQQAppInterface, paramAbsShareMsg, str1, i, str2, localaute);
    ...
    AbsShareMsg.sendSdkShareMessageByServer(localQQAppInterface, paramAbsShareMsg, str1, i, str2, localaute);
  }
  ...
  private void a(Object[] paramArrayOfObject, int paramInt)
  {
    ...
    ((auuc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.SDK_SHARE)).a(this.b, localHashMap);
  }
  ...
  private void b(Object[] paramArrayOfObject, int paramInt)
  {
    ...
    ausd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageForArkApp, paramInt, (String)paramArrayOfObject[2]);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, AbsShareMsg paramAbsShareMsg, Activity paramActivity, Bundle paramBundle, String paramString)
  {
    ...
    {
      a(new Object[] { Integer.valueOf(0), "", anvx.a(2131704270), "" }, -2);
    ...
    bdla.b(null, "dc00898", "", "", "0X8009C93", "0X8009C93", 0, 0, String.valueOf(paramBundle.getLong("req_share_id")), paramQQAppInterface, paramActivity, paramString);
  ...
  public void a(MessageForArkApp paramMessageForArkApp, Context paramContext, JSONObject paramJSONObject)
  {
    ...
    if (!NetworkUtil.isNetSupport(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      auqo.a((Activity)paramContext, anvx.a(2131704270), new autg(this));
      return;
    }
    ...
    AbsShareMsg.resendSdkFakeMessage(paramMessageForArkApp, paramJSONObject, new auth(this, paramContext, System.currentTimeMillis()));
