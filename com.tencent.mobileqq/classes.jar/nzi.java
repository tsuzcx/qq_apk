...
public class nzi
  implements Manager, sum
{
  private int jdField_a_of_type_Int;
  private final Object jdField_a_of_type_JavaLangObject = new Object();
  private ArrayList<String> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private suo jdField_a_of_type_Suo;
  private int b;
  
  public nzi(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b()
  {
    for (;;)
    {
      ...
      {
        String str1;
        if ((this.jdField_a_of_type_Suo == null) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
          str1 = (String)this.jdField_a_of_type_JavaUtilArrayList.remove(0);
        }
        try
        {
          Object localObject2 = new URL(str1);
          if (sun.a().a((URL)localObject2))
          {
            b();
            if (QLog.isColorLevel()) {
          ...
          this.jdField_a_of_type_Suo = new suo();
          this.jdField_a_of_type_Suo.jdField_a_of_type_JavaNetURL = ((URL)localObject2);
          this.jdField_a_of_type_Suo.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
          this.jdField_a_of_type_Suo.b = this.b;
          localObject2 = sun.a().a(this.jdField_a_of_type_Suo);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("NativeAdPreloadManager", 2, "onFail url:" + paramsuo.jdField_a_of_type_JavaNetURL.toString());
    }
    if (paramsuo.equals(this.jdField_a_of_type_Suo))
    {
      this.jdField_a_of_type_Suo = null;
      b();
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("NativeAdPreloadManager", 2, "onSuccess url:" + paramsuo.jdField_a_of_type_JavaNetURL.toString());
    }
    if (paramsuo.equals(this.jdField_a_of_type_Suo))
    {
      this.jdField_a_of_type_Suo = null;
