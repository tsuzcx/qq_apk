...
public class oze
{
  ...
  private static ozf jdField_a_of_type_Ozf = new ozf(null);
  private static ozg jdField_a_of_type_Ozg = new ozg(null);
    ...
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          localObject2 = bidn.a().a("com.tencent.reading");
          boolean bool;
  ...
  {
    String str = b(pay.a(), "sp_key_local_apk_path");
  ...
  private static void b(Context paramContext, String paramString)
  {
    ...
    {
      a(pay.a(), "sp_key_current_app_version_name", paramContext.versionName);
      QLog.d("KBPreDownloadUtils", 2, "[saveVersionInfo] versionName: " + paramContext.versionName);
      paramContext = MD5Utils.encodeFileHexStr(paramString);
      if (paramContext == null) {
        break label129;
      }
    }
    ...
    {
      a(pay.a(), "sp_key_local_apk_path", paramString);
      a(pay.a(), "sp_key_current_app_md5", paramContext);
  ...
  private static void b(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    StatisticCollector.getInstance(pay.a().getApplication()).collectPerformance(str, "actKBPreDownload", paramBoolean, paramLong, 0L, localHashMap, null, false);
  }
  
  private static boolean b(Context paramContext)
  {
    boolean bool2 = false;
    paramContext = b(pay.a(), "sp_key_current_app_version_name");
    String str1 = b(pay.a(), "sp_key_latest_app_version_name");
    String str2 = b(pay.a(), "sp_key_current_app_md5");
    String str3 = b(pay.a(), "sp_key_latest_app_md5");
