...
public final class bbkv
{
  ...
  public static int a()
  {
    ...
    if (!TextUtils.isEmpty(bbay.a("ro.build.version.opporom"))) {
      return 3;
    }
    if (!TextUtils.isEmpty(bbay.a("ro.vivo.os.version"))) {
      return 4;
    }
    return 0;
  }
  ...
  public static void a()
  {
    ...
    if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface))
    {
      ...
      aqxh localaqxh = (aqxh)((QQAppInterface)localObject).getManager(219);
      if (localaqxh != null) {
        localaqxh.d();
      }
  ...
  public static void a(Activity paramActivity, AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, Bundle paramBundle)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      {
        localObject1 = bbpp.a("signatureEntrance");
        str1 = str2;
      }
    ...
    for (;;)
    {
      ...
      localObject1 = bbpp.a("signatureDIYEntrance");
  ...
  {
    int i3 = 1;
    axbt localaxbt = (axbt)paramQQAppInterface.getManager(12);
    int i;
    int j;
    label51:
    int k;
    ...
    if (localaxbt != null)
    {
      ...
      if (i != 0)
      {
        ...
        i2 = 1;
        bool = ((ho)paramQQAppInterface.getManager(42)).a;
        if (!bool) {
          break label312;
        }
    ...
    for (;;)
    {
      ...
      {
        if (i != 0) {
          ((avpq)paramQQAppInterface.getManager(36)).b("100005");
        }
        return;
        i = 0;
        break;
    ...
    for (BubbleManager localBubbleManager = (BubbleManager)paramQQAppInterface.getManager(44);; localBubbleManager = null)
    {
      if ((paramXListView != null) && (localBubbleManager != null))
      {
        ...
        while (i >= 0)
        {
          ...
          {
            acun localacun = (acun)actn.a((View)localObject);
            localObject = actn.a((View)localObject);
            if ((localObject != null) && (((ChatMessage)localObject).needVipBubble()) && (localacun != null) && (localacun.a != null) && (localacun.a.jdField_a_of_type_Int == amch.a.jdField_a_of_type_Int) && (localBubbleManager.a(akfw.a(((ChatMessage)localObject).vipBubbleID)))) {
              return true;
            }
            if ((localObject != null) && (((ho)paramQQAppInterface.getManager(42)).a(localacun, (ChatMessage)localObject))) {
              return true;
            }
          }
          else if ((localObject != null) && ((actn.a((View)localObject) instanceof adyu)))
          {
            return true;
          }
          i -= 1;
