  ...
  implements View.OnClickListener
{
  ...
  public bdqx(Context paramContext, ExtendGridView paramExtendGridView)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Int = 9;
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqTroopActivityExtendGridView = paramExtendGridView;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130847755);
    this.jdField_a_of_type_JavaLangCharSequence = BaseApplication.getContext().getText(2131695718);
    this.jdField_b_of_type_JavaLangCharSequence = BaseApplication.getContext().getResources().getText(2131717198);
  ...
  {
    int i = (int)bfvh.a(paramContext, 60.0F);
    int j = (int)bfvh.a(paramContext, 5.0F);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559924, null);
      localbdqy = new bdqy();
      localbdqy.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131380230));
      localbdqy.b = ((ImageView)localView.findViewById(2131368547));
      localbdqy.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131376714));
      localView.setTag(localbdqy);
      ...
      localbdqy.jdField_a_of_type_ComTencentImageURLImageView.setScaleType(ImageView.ScaleType.FIT_XY);
      localbdqy.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130842523);
      localbdqy.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_a_of_type_JavaLangCharSequence);
      localbdqy.b.setVisibility(8);
    }
    label260:
    label275:
    String str;
    do
    {
      ...
      return localView;
      localbdqy = (bdqy)paramView.getTag();
      localView = paramView;
      break;
      paramView.width = i;
      paramView.height = i;
    ...
    if (i < 0)
    {
      ...
      label321:
      i = Math.min(100, i);
      localbdqy.jdField_a_of_type_ComTencentImageURLImageView.setAdjustViewBounds(false);
    ...
    for (;;)
    {
      ...
      localbdqy.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(paramView);
      localbdqy.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_b_of_type_JavaLangCharSequence);
      localbdqy.b.setVisibility(0);
      localbdqy.b.setTag(Integer.valueOf(paramInt));
      localbdqy.b.setOnClickListener(this);
      localbdqy.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
      break;
      j = i;
      break label303;
      label484:
