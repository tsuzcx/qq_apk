  ...
  extends aood
{
  ...
  private arya jdField_a_of_type_Arya;
  ...
  public aooe(QQAppInterface paramQQAppInterface, arya paramarya, HashMap<String, ArrayList<MessageRecord>> paramHashMap, arxn paramarxn)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Arya = paramarya;
    this.jdField_a_of_type_Arxn = paramarxn;
    ...
    if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (!this.jdField_a_of_type_JavaUtilHashMap.isEmpty()))
    {
      ...
      do
      {
        ...
        paramarya = (String)paramQQAppInterface.next();
        paramHashMap = ((ArrayList)this.jdField_a_of_type_JavaUtilHashMap.get(paramarya)).iterator();
        while (paramHashMap.hasNext())
        {
          paramarxn = (MessageRecord)paramHashMap.next();
          if ((paramarxn instanceof MessageForReplyText))
          {
            this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText = ((MessageForReplyText)paramarxn);
            this.jdField_a_of_type_JavaLangString = paramarya;
          }
        }
  ...
  public int a()
  {
    ...
    while (this.jdField_a_of_type_Arya.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo == null) {
      return -1;
    }
    return this.jdField_a_of_type_Arya.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int;
  }
  ...
  public String a()
  {
    ...
    if (this.jdField_a_of_type_Arya.jdField_a_of_type_ComTencentMobileqqDataMessageForStructing == null) {
      return "";
    }
    return String.valueOf(this.jdField_a_of_type_Arya.jdField_a_of_type_ComTencentMobileqqDataMessageForStructing.uniseq);
  }
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText != null) && (this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText.getSourceMessage() != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
      {
        ...
        if ((localObject1 instanceof MessageForFile))
        {
          ...
          if ((localObject2 != null) && (((FileManagerEntity)localObject2).getCloudType() == 0))
          {
            ...
            localObject2 = ajjy.a(2131647611) + ((MessageRecord)localObject1).getExtInfoFromExtStr("_m_ForwardFileName");
        ...
        if (apck.a((MessageRecord)localObject1))
        {
          int i = a();
          if ((i != 0) && (i != 3000) && (i != 1))
          {
            QLog.i("ReplyMsgForwardRequest<QFile>", 1, "getForwardMessageList. init UploadSourceMsgList, find unsupport chatType file.");
            localObject2 = ajjy.a(2131647608) + ((MessageRecord)localObject1).getExtInfoFromExtStr("_m_ForwardFileName");
  ...
  public void a(int paramInt, List<MessageRecord> paramList1, List<MessageRecord> paramList2)
  {
    ...
    if (paramInt == 1)
    {
      ...
      paramList2 = ajjy.a(2131647610) + paramList1.getExtInfoFromExtStr("_m_ForwardFileName");
      ...
      this.jdField_a_of_type_Arxn.a(1, 2, this.jdField_a_of_type_Arya);
      return;
    }
  ...
  public void a(String paramString, List<MessageRecord> paramList, MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    paramList = ajjy.a(2131647609) + paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFileName");
  ...
  public String b()
  {
    ...
    if (this.jdField_a_of_type_Arya.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo == null) {
      return "";
    }
    return String.valueOf(this.jdField_a_of_type_Arya.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  }
}
