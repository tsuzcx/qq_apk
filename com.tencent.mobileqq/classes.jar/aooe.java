  ...
  extends FaceDecodeTask
{
  ...
  public aooe(QQAppInterface paramQQAppInterface, FaceInfo paramFaceInfo, aooc paramaooc)
  {
    super(paramQQAppInterface, paramFaceInfo, paramaooc);
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceInfo.jdField_a_of_type_Int != 101)
    {
      ...
      aoof.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceInfo);
    }
    for (;;)
    {
      for (;;)
      ...
      {
        aqib localaqib = (aqib)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(180);
  ...
  public boolean b()
  {
    ...
    {
      localObject = (anwo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
      if (this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceInfo.jdField_a_of_type_Int == 1001)
      {
        this.jdField_a_of_type_AndroidGraphicsBitmap = ((anwo)localObject).a(GroupIconHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceInfo.jdField_a_of_type_JavaLangString), false);
    ...
    do
    {
      ...
      {
        return true;
        this.jdField_a_of_type_AndroidGraphicsBitmap = ((anwo)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceInfo.jdField_a_of_type_JavaLangString, false);
        break;
      ...
      this.jdField_a_of_type_AndroidGraphicsBitmap = bhmq.a(BaseApplicationImpl.sApplication.getResources(), i);
      ...
      return true;
      if (!bguq.a(this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceInfo.jdField_a_of_type_JavaLangString))
      {
        this.jdField_a_of_type_AndroidGraphicsBitmap = ((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceInfo.jdField_a_of_type_JavaLangString, false);
        this.jdField_a_of_type_Boolean = false;
        return true;
      }
