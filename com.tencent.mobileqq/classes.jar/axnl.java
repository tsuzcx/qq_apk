  ...
  implements Manager
{
  ...
  private axnp jdField_a_of_type_Axnp;
  private axnq jdField_a_of_type_Axnq;
  private axnr jdField_a_of_type_Axnr;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private HashMap<Long, WeakReference<axno>> jdField_a_of_type_JavaUtilHashMap = new HashMap(5);
  private boolean jdField_a_of_type_Boolean = true;
  private HashMap<Long, WeakReference<axnm>> b = new HashMap(20);
  private HashMap<Long, Boolean> c = new HashMap(200);
  private HashMap<Long, WeakReference<axnn>> d = new HashMap(5);
  private HashMap<Long, ArrayList<Long>> e = new HashMap(5);
  private HashMap<Long, ArrayList<Long>> f = new HashMap(5);
  
  public axnl(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Avgx = ((avgx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(323));
  }
  ...
  private ArrayList<Long> a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 58	axnl:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   20: aload_0
    //   21: getfield 58	axnl:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
  ...
  private void a(long paramLong, axno paramaxno)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.3(this, paramLong, paramaxno));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, axnm paramaxnm)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.2(this, paramLong, paramArrayList, paramaxnm));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, axnn paramaxnn)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.1(this, paramArrayList, paramLong, paramaxnn));
  }
  ...
  public IntimateInfo a(long paramLong1, long paramLong2)
  {
    ...
    if (localIntimateInfo2 == null)
    {
      ...
      localIntimateInfo2 = this.jdField_a_of_type_Avgx.a(str);
  ...
  public void a(long paramLong)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Axnp);
      this.jdField_a_of_type_Axnp = null;
    }
    if (this.jdField_a_of_type_Axnq != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Axnq);
      this.jdField_a_of_type_Axnq = null;
    }
    if (this.jdField_a_of_type_Axnr != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Axnr);
  ...
  public void a(Context paramContext, long paramLong, ArrayList<Long> arg4, axnm paramaxnm)
  {
    if (QLog.isColorLevel())
    {
    ...
    for (Object localObject1 = ???.toString();; localObject1 = "null")
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramaxnm != null) && (??? != null))
      {
        if (bhnv.d(paramContext)) {
          break;
        }
        a(paramLong, ???, paramaxnm);
      }
      return;
    }
    ...
    a(paramLong, ???, paramaxnm);
    paramaxnm = new WeakReference(paramaxnm);
    synchronized (this.b)
    {
      this.b.put(Long.valueOf(paramLong), paramaxnm);
      ??? = new HashMap(5);
      ???.put("alreadyRequest", localObject1);
      ???.put("notRequest", paramContext);
      paramaxnm = new ArrayList(1);
      paramaxnm.add(Long.valueOf(paramLong));
      ???.put("groupUin", paramaxnm);
      ((avgv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(153)).a(paramLong, paramContext, ???);
      return;
    }
  }
  
  public void a(Context arg1, long paramLong, ArrayList<Long> paramArrayList, axnn paramaxnn)
  {
    Object localObject2;
    if (QLog.isColorLevel())
    {
    ...
    {
      QLog.d("MultiCardManager", 2, (String)localObject1);
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramaxnn != null) && (paramArrayList != null))
      {
        if (bhnv.d(???)) {
          break;
        }
        a(paramLong, paramArrayList, paramaxnn);
      }
      return;
    }
    synchronized (this.e)
    ...
    for (;;)
    {
      ...
      paramArrayList = new WeakReference(paramaxnn);
      synchronized (this.d)
      {
        this.d.put(Long.valueOf(paramLong), paramArrayList);
        ((aoip)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(false, paramLong + "", "0", 9);
        return;
        label317:
  ...
  public void a(String paramString, IntimateInfo paramIntimateInfo)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Avgx.a(paramString, paramIntimateInfo);
