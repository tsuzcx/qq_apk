  ...
  implements axaw
{
  ...
  {
    if (mzl.jdField_a_of_type_Boolean) {
      return null;
    }
    mzl.jdField_a_of_type_Boolean = true;
    if (QLog.isColorLevel()) {
      QLog.d(mzl.jdField_a_of_type_JavaLangString, 2, "getCheckUpdateItemData");
    }
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      localReqBody.uint32_platform.set(mzl.jdField_a_of_type_Int);
      if (QLog.isColorLevel()) {
        QLog.d(mzl.jdField_a_of_type_JavaLangString, 1, String.format("OfflineExpireCheckUpdate, check update QQ Version: %s", new Object[] { "8.2.8.4440" }));
      }
      ...
      paramInt = nar.a(((QQAppInterface)localObject).getApp());
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        catch (NumberFormatException localNumberFormatException1)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.i(mzl.jdField_a_of_type_JavaLangString, 2, "NumberFormatException:" + str);
          }
          paramInt = 0;
          continue;
        }
      ...
      return null;
      if (QLog.isColorLevel()) {
        QLog.i(mzl.jdField_a_of_type_JavaLangString, 2, "Exception:" + str);
      }
      paramInt = 0;
      continue;
    ...
    label426:
    localReqItem.vecParam = bblm.a(localReqBody.toByteArray());
    return localReqItem;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(mzl.jdField_a_of_type_JavaLangString, 2, "handleCheckUpdateItemData");
    }
    Object localObject = BaseApplicationImpl.getApplication().getRuntime();
    if ((localObject instanceof QQAppInterface))
    {
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        mzl.a(new String(localRspBody.str_expire_pkg.get().toByteArray(), "UTF-8"));
        mzl.a(new String(localRspBody.str_predown_pkg_ex.get().toByteArray(), "UTF-8"), (QQAppInterface)localObject, ((QQAppInterface)localObject).getApp().getApplicationContext(), 1);
      ...
      catch (InvalidProtocolBufferMicroException paramRespItem)
      {
        for (;;)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.i(mzl.jdField_a_of_type_JavaLangString, 2, "handleCheckUpdateItemData: " + QLog.getStackTraceString(paramRespItem));
          }
        }
      }
    ...
    QLog.d(mzl.jdField_a_of_type_JavaLangString, 2, "***handleCheckUpdateItemData fail respitem.cResult:" + paramRespItem.cResult);
  }
}
