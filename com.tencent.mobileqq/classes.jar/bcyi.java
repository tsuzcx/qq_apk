  ...
  extends bcvt
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (((Iterator)localObject2).hasNext())
    {
      ...
      if (!"live".equals(localbcvs.a)) {
        break label255;
      }
      paramBundle = (bcxb)localbcvs;
    }
    label247:
    label255:
    for (;;)
    {
      ...
      if (paramView != null)
      {
        paramContext = (bcyj)paramView.getTag();
        localObject2 = null;
        ...
        paramView = new bcyj();
        paramView.jdField_a_of_type_Bcxb = paramBundle;
        paramView.jdField_a_of_type_ComTencentBizNowNowVideoLayout = paramContext;
      }
      for (;;)
      {
        ((View)localObject1).setTag(paramView);
        paramView = ((View)localObject1).findViewById(2131377944);
        if (paramView != null) {
        ...
        paramContext = (NowVideoLayout)((View)localObject2).findViewById(2131377944);
        paramContext.a();
