  ...
  static boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localFile.exists())
        {
          if ((a().equals(paramString1)) && (bcwn.a(paramQQAppInterface, "tracking_config_file")))
          {
        ...
        try
        {
          ...
          boolean bool3 = bcwn.a(paramQQAppInterface, "tracking_config_file");
