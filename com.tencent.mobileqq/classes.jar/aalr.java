  ...
  extends AccountObserver
{
  ...
  public void onLoginFailed(String paramString1, String paramString2, String paramString3, int paramInt1, byte[] paramArrayOfByte, int paramInt2)
  {
    ...
    if (QLog.isDevelopLevel()) {
      QLog.d("AutoLoginHelper", 4, String.format(Locale.getDefault(), "onLoginFailed, ret: %s, uin: %s, msg: %s, alias: %s", new Object[] { Integer.valueOf(paramInt1), aalo.a(this.a), paramString2, paramString1 }));
    }
    this.a.c = false;
    aalo.a(this.a);
    if (aalo.a(this.a) != null)
    {
      paramString1 = new Intent(aalo.a(this.a), LoginActivity.class);
      paramString1.putExtra("uin", aalo.a(this.a));
      paramString1.putExtra("tab_index", MainFragment.b);
      paramString1.addFlags(131072);
      aalo.a(this.a).startActivity(paramString1);
  ...
  public void onLoginTimeout(String paramString)
  {
    ...
    this.a.c = false;
    aalo.a(this.a);
    aalo.a(this.a).a.post(new AutoLoginHelper.4.1(this));
  }
