  ...
  implements tck
{
  ...
  private LocationListener jdField_a_of_type_AndroidLocationLocationListener = new vlz(this);
  public final Object a;
  public final List<vlu> a;
  public final Queue<vlu> a;
  public final ConcurrentHashMap<String, vlu> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ssi.g + "emoji";
  ...
  public static String a(vlv paramvlv, String paramString)
  {
    return paramvlv.a("emoji_pack_url_" + paramString, "");
  }
  
  private static tog a()
  {
    int i = 0;
    try
    {
      byte[] arrayOfByte = vyi.b(new File(jdField_a_of_type_JavaLangString + "/" + "list.pb"));
      if (arrayOfByte != null) {
        i = arrayOfByte.length;
      }
      veg.a("DoodleEmojiManager", "restoreFilterItemListLocked file length = %d", Integer.valueOf(i));
      if (arrayOfByte == null) {
        return null;
      }
      ...
      if (i == 18)
      {
        ...
        try
        {
          ...
          return new tog((qqstory_service.RspGetEmoticonPackList)localObject, arrayOfByte, l);
        }
        catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
        {
          veg.e("DoodleEmojiManager", "restoreResponseFromFile error : " + localInvalidProtocolBufferMicroException);
          return null;
        }
      }
      return null;
    ...
    {
      veg.d("DoodleEmojiManager", "restoreResponseFromFile failed FileNotFoundException");
      return null;
      veg.d("DoodleEmojiManager", "restoreResponseFromFile find illegal file with magic code %d", new Object[] { Integer.valueOf(i) });
      return null;
    }
    catch (Exception localException)
    {
      veg.c("DoodleEmojiManager", "restoreResponseFromFile failed", localException);
    }
  }
  ...
  /* Error */
  public static void a(tog paramtog)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   12: getstatic 51	vlv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   31: invokestatic 273	vyi:d	(Ljava/lang/String;)Z
    //   34: pop
    //   35: getstatic 51	vlv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   38: invokestatic 54	vlv:a	(Ljava/lang/String;)V
    ...
    //   67: aload_2
    //   68: aload_0
    //   69: getfield 286	tog:jdField_a_of_type_Long	J
    //   72: invokevirtual 290	java/io/ObjectOutputStream:writeLong	(J)V
    //   75: aload_2
    //   76: aload_0
    //   77: getfield 293	tog:jdField_a_of_type_ArrayOfByte	[B
    //   80: arraylength
    //   81: invokevirtual 284	java/io/ObjectOutputStream:writeInt	(I)V
    //   84: aload_2
    //   85: aload_0
    //   86: getfield 293	tog:jdField_a_of_type_ArrayOfByte	[B
    ...
    //   111: getstatic 51	vlv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   153: ldc_w 313
    //   156: aload_0
    //   157: getfield 293	tog:jdField_a_of_type_ArrayOfByte	[B
    //   160: arraylength
    //   161: invokestatic 187	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   164: invokestatic 192	veg:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    //   167: aload_1
    //   168: ifnull +7 -> 175
    //   171: aload_1
    ...
    //   205: ldc_w 318
    //   208: aload_2
    //   209: invokestatic 249	veg:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   212: aload_0
    //   213: ifnull +7 -> 220
    //   216: aload_0
  ...
  public static void a(vlv paramvlv, String paramString1, String paramString2)
  {
    paramvlv.a("emoji_pack_md5_" + paramString1, paramString2);
  }
  ...
  private static boolean a(File paramFile)
  {
    ...
    {
      return false;
      paramFile = paramFile.listFiles(new vmd());
  ...
  public static String b(vlv paramvlv, String paramString)
  {
    return paramvlv.a("emoji_pack_name_" + paramString, "");
  }
  
  private static void b(vlv paramvlv, String paramString1, String paramString2)
  {
    paramvlv.a("emoji_pack_url_" + paramString1, paramString2);
  }
  
  public static String c(vlv paramvlv, String paramString)
  {
    return paramvlv.a("emoji_pack_config_" + paramString, "");
  }
  
  private static void c(vlv paramvlv, String paramString1, String paramString2)
  {
    paramvlv.a("emoji_pack_name_" + paramString1, paramString2);
  }
  
  public static String d(vlv paramvlv, String paramString)
  {
    return paramvlv.a("emoji_pack_md5_" + paramString, "");
  }
  
  private static void d(vlv paramvlv, String paramString1, String paramString2)
  {
    paramvlv.a("emoji_pack_config_" + paramString1, paramString2);
  }
  
  private void e()
  {
    long l = 0L;
    veg.b("DoodleEmojiManager", "fireRequestEmojiPackList, cookie = " + this.jdField_b_of_type_JavaLangString);
    if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.getAndSet(true))
    {
      ...
      if (l > 5000L) {
        veg.d("DoodleEmojiManager", "fireRequestEmojiPackList previous requesting is time out, fire another request, past time = %d", new Object[] { Long.valueOf(l) });
      }
    }
    else
    {
      this.jdField_a_of_type_Long = SystemClock.elapsedRealtime();
      syr.a().a(new tmi(this.jdField_b_of_type_JavaLangString, 50), new vmc(this));
      return;
    }
    veg.d("DoodleEmojiManager", "fireRequestEmojiPackList now is already requesting, just waiting is ok, requesting past time = %d", new Object[] { Long.valueOf(l) });
  }
  ...
  public String a(@NonNull String paramString1, @NonNull String paramString2)
  {
    ...
    veg.b("DoodleEmojiManager", "getStringValue, key : %s, value : %s", paramString1, paramString2);
    return paramString2;
  }
  ...
  public List<vlu> a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      {
        veg.d("DoodleEmojiManager", "current emoji packages is null.");
    ...
    veg.c("DoodleEmojiManager", "current emoji packages's size=" + localArrayList.size());
    return localArrayList;
  }
  
  @NonNull
  public List<vlu> a(boolean paramBoolean)
  {
    if (!a()) {
      return Collections.EMPTY_LIST;
    }
  ...
  public void a(int paramInt1, int paramInt2, vmi paramvmi)
  {
    paramvmi = new WeakReference(paramvmi);
    syr.a().a(new tms(paramInt1, paramInt2), new vmb(this, paramvmi));
  }
  ...
  public void a(Context paramContext)
  {
    ...
    {
      paramContext = (vlv)tdc.a(8);
      Object localObject1 = new File(jdField_a_of_type_JavaLangString);
      if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
      {
        localObject1 = ((File)localObject1).listFiles(new vlw(this));
        if (localObject1 != null)
        {
          ...
          if (i < j)
          {
            ...
            Object localObject2 = localFile.listFiles(new vlx(this));
            if ((localObject2 != null) && (localObject2.length > 0))
            {
              localObject2 = a(localFile);
              Object localObject3 = b(paramContext, (String)localObject2);
              localObject3 = new vlu((String)localObject2, a(paramContext, (String)localObject2), (String)localObject3, null, c(paramContext, (String)localObject2), d(paramContext, (String)localObject2));
              ((vlu)localObject3).a(localFile.getPath());
      ...
      {
        veg.c("DoodleEmojiManager", "has valid emoji packages cache. startTime=" + paramContext.jdField_a_of_type_Long + " currentTime=" + System.currentTimeMillis());
  ...
  {
    veg.b("DoodleEmojiManager", "saveStringValue, key : %s, value : %s", paramString1, paramString2);
    this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putString(paramString1, paramString2).apply();
  }
  
  public void a(teu paramteu, vmi paramvmi)
  {
    veg.b("DoodleEmojiManager", "requestPoiFaces " + paramvmi);
    ...
    if (localteu != null)
    {
      a(localteu.b, localteu.jdField_a_of_type_Int, paramvmi);
      return;
    }
    localtev.a(new vma(this, paramvmi));
    localtev.c();
  }
  
  protected void a(boolean paramBoolean1, @NonNull tog paramtog, boolean paramBoolean2)
  {
    vlv localvlv = (vlv)tdc.a(8);
    ...
    Iterator localIterator = paramtog.jdField_a_of_type_JavaUtilList.iterator();
    toh localtoh;
    vlu localvlu;
    if (localIterator.hasNext())
    {
      localtoh = (toh)localIterator.next();
      if (localtoh.b != 1) {
        break label476;
      }
      localvlu = (vlu)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(localtoh.jdField_a_of_type_JavaLangString);
      if (localvlu == null) {
        break label476;
      }
      ??? = localvlu.a();
      if (TextUtils.equals(localvlu.g, localtoh.f)) {
        break label473;
      }
      veg.a("DoodleEmojiManager", "EmojiPack md5 has changed. old : %s, new : %s", localvlu.g, localtoh.f);
    }
    for (;;)
    {
      try
      {
        vyi.d((String)???);
        ??? = null;
        localvlu = new vlu(localtoh);
        localvlu.a((String)???);
        b(localvlv, localvlu.jdField_a_of_type_JavaLangString, localvlu.jdField_b_of_type_JavaLangString);
        c(localvlv, localvlu.jdField_a_of_type_JavaLangString, localvlu.d);
        d(localvlv, localvlu.jdField_a_of_type_JavaLangString, localvlu.f);
        a(localvlv, localvlu.jdField_a_of_type_JavaLangString, localvlu.g);
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localtoh.jdField_a_of_type_JavaLangString, localvlu);
        if (paramBoolean2)
        {
          veg.a("DoodleEmojiManager", "from local get doodle item : %s", localvlu);
          localArrayList.remove(localvlu);
          localArrayList.add(localvlu);
        }
      }
      catch (Exception localException)
      {
        ...
        continue;
        veg.a("DoodleEmojiManager", "from network get doodle item : %s", localException);
        continue;
      }
      do
      {
        synchronized (this.jdField_a_of_type_JavaUtilList)
        {
          ...
          ste.a().dispatch(new vmf());
          this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
          if ((!paramBoolean2) && (!paramtog.jdField_a_of_type_Boolean))
          {
            e();
            return;
          }
      ...
      veg.b("DoodleEmojiManager", "start download the first emoji pack if needed : " + ((vlu)localArrayList.get(0)).jdField_a_of_type_JavaLangString);
      a(((vlu)localArrayList.get(0)).jdField_a_of_type_JavaLangString, false);
      return;
      label473:
      continue;
      label476:
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    vlu localvlu = (vlu)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (localvlu == null)
    {
      veg.d("DoodleEmojiManager", "can not find pack item by id " + paramString);
      return false;
    }
    ??? = new File(b(localvlu.jdField_a_of_type_JavaLangString));
    if ((a((File)???)) && (!paramBoolean))
    {
      veg.d("DoodleEmojiManager", "already has local emoji folder, notify download success directly");
      localvlu.a(((File)???).getPath());
      ste.a().dispatch(new vme(localvlu, 0, true, 0L, 0L));
      return true;
    }
    if (!TextUtils.isEmpty(localvlu.a()))
    {
      veg.d("DoodleEmojiManager", "local emoji folder is missing");
      localvlu.a(null);
    }
    if (TextUtils.isEmpty(localvlu.e))
    {
    ...
    {
      if (!this.jdField_a_of_type_JavaUtilQueue.contains(localvlu))
      {
        this.jdField_a_of_type_JavaUtilQueue.offer(localvlu);
  ...
  protected void c()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_Vlu == null)
      {
        this.jdField_a_of_type_Vlu = ((vlu)this.jdField_a_of_type_JavaUtilQueue.poll());
        if (this.jdField_a_of_type_Vlu != null)
        {
          veg.b("DoodleEmojiManager", "downloader startDownload : " + this.jdField_a_of_type_Vlu);
          Bosses.get().postJob(new vly(this, this.jdField_a_of_type_Vlu));
        }
        return;
      }
      veg.b("DoodleEmojiManager", "can not start download because find one is still downloading : " + this.jdField_a_of_type_Vlu);
    }
  }
  
  public void d()
  {
    veg.b("DoodleEmojiManager", "stopRequestSpeed.");
