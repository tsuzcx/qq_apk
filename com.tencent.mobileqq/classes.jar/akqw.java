  ...
  extends akon
{
  ...
  public akqw(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject, structmsg.RspSystemMsgNew paramRspSystemMsgNew)
  {
    ...
    do
    {
      ...
      {
        aydc.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bool1);
        localakbn = (akbn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(34);
        j = localakbn.c();
        aydc.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, m);
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajsd.M, 0);
        localakbn.b();
        a(4014, true, null);
        return;
      }
    ...
    localakbn.a(new atyv(paramToServiceMsg, l1));
    return;
    label884:
    j = k;
    if (m == 0)
    ...
    aydc.a().a(false, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    label1328:
    label1334:
    label1340:
    label1876:
    if (j == 0)
    {
      ...
      if (paramRspSystemMsgNew.size() > 0)
      {
        ...
        l3 = aydc.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajsd.M, 0, l3);
        localObject2 = paramFromServiceMsg.iterator();
        if (j < 20) {
          while (((Iterator)localObject2).hasNext())
          {
            localObject1 = (ChatMessage)((Iterator)localObject2).next();
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(ajsd.M, 0, ((ChatMessage)localObject1).uniseq, false);
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(ajsd.M, 0, ((ChatMessage)localObject3).uniseq, false);
            ((Iterator)localObject2).remove();
          }
          else if ((localObject3 instanceof MessageForSystemMsg))
          {
            ...
            if ((j == 13) && (((ajxl)localObject1).b(str)))
            {
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(ajsd.M, 0, ((ChatMessage)localObject3).uniseq, false);
              ((Iterator)localObject2).remove();
            }
        ...
        {
          aydc.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l2);
          ...
          if ((!akas.a(paramRspSystemMsgNew)) || (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Stop)) {
            break label1925;
          }
          bool2 = true;
          ...
          localakbn.a(new atyv(paramObject, l1));
        }
      }
    }
    for (;;)
    {
      ...
      aydc.a().a(true, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      break;
      label1925:
      bool2 = false;
      break label1842;
  ...
  private void a(List<MessageRecord> paramList)
  {
    ...
    RecentUser localRecentUser = localaktf.a(ajsd.D, 4000);
    localRecentUser.msgType = 26;
    localRecentUser.displayName = akbn.jdField_a_of_type_JavaLangString;
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject, structmsg.RspSystemMsgNew paramRspSystemMsgNew)
  {
    ...
    do
    {
      ...
      if (m == 3)
      {
        afoo.a(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRspSystemMsgNew, paramFromServiceMsg, i1, str1);
        return;
      }
      afoo.a(paramRspSystemMsgNew, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    } while (n == 0);
    this.d = 0;
    ...
    aydd.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i1);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(ajsd.W, 9000, i1 - j);
    paramObject = new ArrayList();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajsd.N, 0, true, false);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajsd.S, 0, true, false);
    aydd.a().a(false, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    paramToServiceMsg = (asks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37);
    if (paramToServiceMsg != null) {
      paramToServiceMsg.a(false);
    }
    Collections.sort(paramFromServiceMsg, new akqx(this));
    j = 0;
    if (j < n)
    {
      localObject1 = axas.a(-2018);
      ((MessageRecord)localObject1).msgtype = -2018;
      ((MessageRecord)localObject1).selfuin = str1;
      ((MessageRecord)localObject1).frienduin = ajsd.N;
      ...
      if ((m == 1) && (!bool1)) {
        if ((k == 2) && (i3 == 2))
        {
          ...
          if (((TroopManager)localObject3).b(str2) == null)
          {
            ...
            ((akhp)localObject4).a(paramToServiceMsg.troopuin, false, "", true, true, true, false);
            ((akhp)localObject4).a(1, ajsx.a(paramToServiceMsg.troopuin), 0L, 2, 0, 0, true);
            ((akhp)localObject4).notifyUI(127, true, new Object[] { str2 });
          }
          if (localMessageForSystemMsg.structMsg.msg.msg_invite_extinfo.has())
          {
            ...
            if ((k == 2) || (k == 4))
            {
              ...
              aqvc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForSystemMsg, paramToServiceMsg, str2);
              if (QLog.isColorLevel()) {
            ...
            bool1 = false;
            label1729:
            paramToServiceMsg = (akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
            if (paramToServiceMsg != null) {
        ...
        else
        {
          ...
          else
          {
            ...
            if ((k == 2) && (i3 == 2))
            {
              ...
              {
                if ((k == 2) || (k == 4)) {
                  aqvc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForSystemMsg, paramToServiceMsg, String.valueOf(l1));
                }
                bool2 = bool3;
                if (k == 4) {
                  bool2 = false;
            ...
            else if ((k == 13) || (k == 6))
            {
              ...
              if ((paramToServiceMsg != null) && (!paramToServiceMsg.a(((structmsg.StructMsg)localObject2).msg.group_code.get(), ((structmsg.StructMsg)localObject2).msg_time.get())))
              {
                ...
                if (localObject4 != null) {
                  ((akhp)localObject4).a(str2, (String)localObject3, true);
                }
                paramToServiceMsg.a(((structmsg.StructMsg)localObject2).msg.group_code.get(), ((structmsg.StructMsg)localObject2).msg_time.get());
              }
            }
    ...
    if (paramObject.size() > 0)
    {
      ...
      if ((!akas.a(paramObject)) || (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackground_Stop)) {
        break label3830;
      }
    }
    label3830:
    for (bool1 = true;; bool1 = false)
    {
      ...
      if (!TextUtils.isEmpty(paramRspSystemMsgNew.grp_msg_display.get())) {
        aydd.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRspSystemMsgNew.grp_msg_display.get());
      }
      if ((paramRspSystemMsgNew.msg_ribbon_group.has()) && (paramRspSystemMsgNew.msg_ribbon_group.get() != null))
      {
        ...
        paramToServiceMsg = axas.a(-2018);
        paramToServiceMsg.selfuin = str1;
        paramToServiceMsg.frienduin = ajsd.S;
      ...
      paramToServiceMsg = (akfb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(33);
      paramRspSystemMsgNew = ((MessageForSystemMsg)paramObject.get(0)).getSystemMsg();
      aydd.a().a(paramRspSystemMsgNew);
      l1 = paramRspSystemMsgNew.msg_time.get();
      paramToServiceMsg.a(ajsd.W, 9000, ajya.a(2131691088), l1, l1);
  ...
  public void a()
  {
    ...
    a(true, true, false, 0L, new akrb(this, l1, l2, localReqSystemMsgRead));
  }
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, structmsg.SystemMsgActionInfo paramSystemMsgActionInfo, int paramInt6, String paramString)
  {
    ...
    paramSystemMsgActionInfo = new aytk();
    ...
    paramSystemMsgActionInfo.jdField_a_of_type_Aytj = new akqz(this);
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, structmsg.SystemMsgActionInfo paramSystemMsgActionInfo, int paramInt6, structmsg.StructMsg paramStructMsg, boolean paramBoolean)
  {
    ...
    localaytk.a();
    localaytk.jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqSystemMsgAction.Friend";
    localaytk.jdField_a_of_type_ArrayOfByte = ((structmsg.ReqSystemMsgAction)localObject).toByteArray();
    ...
    localaytk.jdField_a_of_type_JavaLangObject = localObject;
    localaytk.jdField_a_of_type_Aytj = new akra(this, paramInt6, paramInt3, paramSystemMsgActionInfo, paramStructMsg, paramLong2);
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, long paramLong1, long paramLong2, msg_comm.MsgHead paramMsgHead)
  {
    ...
    {
      aqvc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramArrayOfByte, paramLong1, paramLong2, paramMsgHead);
      b(2001, true, null);
    }
  }
  ...
  public void a(long paramLong1, long paramLong2, short paramShort, int paramInt1, msg_comm.Msg paramMsg, int paramInt2)
  {
    ...
    while (paramShort != 190)
    {
      ...
      localObject = SystemMsg.decode(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bbea.a((byte[])localObject), String.valueOf(str), paramInt1);
      if (localObject != null) {}
      for (localObject = ((SystemMsg)localObject).strGameName;; localObject = "")
      {
        ...
        afkk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramLong1, paramLong2, paramShort, paramMsg, paramInt2);
        return;
      }
    }
    ((ajxl)localObject).a(str, false);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (long l1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().e("last_group_suspicious_seq");; l1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().e("last_group_seq"))
    {
      ...
      aytk localaytk = new aytk();
      localaytk.jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqSystemMsgRead.Group";
      localaytk.jdField_a_of_type_ArrayOfByte = localReqSystemMsgRead.toByteArray();
      localaytk.jdField_a_of_type_Aytj = new akrd(this, l2, l3, l1);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a(localaytk);
      return;
    }
  }
  ...
  public void b()
  {
    ...
    aytk localaytk = new aytk();
    localaytk.jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqSystemMsgRead.Friend";
    localaytk.jdField_a_of_type_ArrayOfByte = localReqSystemMsgRead.toByteArray();
    localaytk.jdField_a_of_type_Aytj = new akrc(this, l1, l2, l3);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a(localaytk);
  }
  ...
  public void c(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localObject = new aytk();
      ((aytk)localObject).a();
      ((aytk)localObject).jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqNextSystemMsg.Group";
      ((aytk)localObject).jdField_a_of_type_ArrayOfByte = localReqNextSystemMsg.toByteArray();
      ((aytk)localObject).jdField_a_of_type_JavaLangObject = new Integer(paramInt);
      ((aytk)localObject).jdField_a_of_type_Aytj = new akqy(this);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a((aytk)localObject);
      return;
  ...
  public void d()
  {
    ...
    a(true, true, false, 0L, new akre(this, l, localReqSystemMsgRead));
  }
  ...
  public void e()
  {
    ...
    a(true, true, false, 0L, new akrf(this, l1, l2, localReqSystemMsgRead));
  }
  ...
  public void g()
  {
    ...
    localObject = new aytk();
    ((aytk)localObject).a();
    ((aytk)localObject).jdField_a_of_type_JavaLangString = "ProfileService.Pb.ReqNextSystemMsg.Friend";
    ((aytk)localObject).jdField_a_of_type_ArrayOfByte = localReqNextSystemMsg.toByteArray();
    ((aytk)localObject).jdField_a_of_type_Aytj = new akrg(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().a((aytk)localObject);
  }
