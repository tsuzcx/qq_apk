...
public class aftq
  extends aojs
{
  public aftq(TroopInviteStatusFragment paramTroopInviteStatusFragment) {}
    ...
    for (;;)
    {
      synchronized (this.a)
      {
        ...
        if (paramInt1 != 6) {
          ...
          {
            paramArrayList = "1";
            bhju.a("Grp_AIO", "invite", "in_exp", 0, 0, new String[] { paramArrayList, String.valueOf(paramInt1) });
      ...
      {
      default: 
        QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, anzj.a(2131714254), 0).b(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight()).show();
        paramInt1 = paramInt4;
        break;
      case 1282: 
      case 1283: 
      ...
      case 1285: 
        ...
        paramArrayList = "2";
        continue;
        bhju.a("Grp_AIO", "invite", "in_past", 0, 0, new String[0]);
      }
    }
  }
}
