  ...
  extends bgpw
{
  ...
  private agpt jdField_a_of_type_Agpt = new bgos(this);
  private ArkViewImplement.LoadCallback jdField_a_of_type_ComTencentArkArkViewImplement$LoadCallback = new bgot(this);
  ...
  public bgor(Context paramContext, int paramInt)
  {
  ...
  private agpq a(bgou parambgou, Bundle paramBundle)
  {
    ...
    if (QLog.isDebugVersion()) {
      QLog.d("QQCustomArkDialog", 4, "w=" + i + ",h=" + j + ", appName:" + parambgou.jdField_a_of_type_JavaLangString);
    }
    i = paramBundle.getInt("req_type");
    if (ArkFullScreenAppActivity.a(paramBundle))
    {
      this.jdField_a_of_type_Agpq.a(parambgou.jdField_a_of_type_JavaLangString, parambgou.b, parambgou.c, parambgou.d, parambgou.jdField_a_of_type_Float, parambgou.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
      if ((this.jdField_e_of_type_Int == 0) || (this.jdField_f_of_type_Int == 0)) {
        break label230;
      }
      this.jdField_a_of_type_Agpq.setFixSize(this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
    }
    for (;;)
    {
      apih.a = false;
      ...
      this.jdField_a_of_type_Agpq.a("com.tencent.structmsg", bgki.a(i), "0.0.0.1", paramBundle, apoh.a(), parambgou.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
      break;
      label230:
      this.jdField_a_of_type_Agpq.setFixSize(this.jdField_d_of_type_Int, this.g);
      this.jdField_a_of_type_Agpq.setMaxSize(this.jdField_d_of_type_Int, this.jdField_a_of_type_Int);
      this.jdField_a_of_type_Agpq.setMinSize(this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
    }
  }
  ...
  public static String a(Bundle paramBundle, String paramString)
  {
    ...
    try
    {
      ...
      {
        str1 = str3;
        if (str3.contains(anni.a(2131708963))) {
          str1 = str3.replace(anni.a(2131708967), "");
        }
      }
    ...
    for (;;)
    {
      ...
      bgmg.d(str6, paramString + File.separator + str1);
  ...
  private void a(Bundle paramBundle)
  {
    ...
    localbgou.jdField_a_of_type_Float = apoh.a();
    paramBundle = a(localbgou, paramBundle);
  ...
  public void a()
  {
    ((LinearLayout)findViewById(2131368663)).setVisibility(8);
  }
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Agpq.doOnEvent(paramInt);
  }
  ...
  public void a(Context paramContext, Bundle paramBundle)
  {
    try
    {
      ...
      Object localObject1 = localView.findViewById(2131362934);
      ...
      if ((ArkFullScreenAppActivity.a(paramBundle)) && ("card".equals(((ArkAppMessage.Config)localObject1).type))) {
        this.g = apoh.jdField_a_of_type_Int;
      }
      ...
      if (bool2)
      {
        ...
        if (localObject2 != null)
        {
          ...
          if ((((ArkAppMessage.Config)localObject1).autoSize != null) && (((ArkAppMessage.Config)localObject1).autoSize.intValue() == 1)) {
            this.jdField_e_of_type_Int = apoh.jdField_a_of_type_Int;
          }
      ...
      if (this.bodyLayout != null)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject1).topMargin = ((int)paramContext.getResources().getDimension(2131296834));
        ((RelativeLayout.LayoutParams)localObject1).leftMargin = ((int)paramContext.getResources().getDimension(2131296805));
        ((RelativeLayout.LayoutParams)localObject1).rightMargin = ((int)paramContext.getResources().getDimension(2131296806));
        ((RelativeLayout.LayoutParams)localObject1).bottomMargin = ((int)paramContext.getResources().getDimension(2131296830));
      }
      if (!bool1)
      {
        ...
        i = paramContext.getResources().getDimensionPixelSize(2131296829);
  ...
  public void a(String paramString)
  {
    ...
    ((TextView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131380139)).setText(paramString);
  }
