...
public class aynv
{
  ...
  public static ArrayList<aynt> a()
  {
    int i = 0;
    ArrayList localArrayList = new ArrayList();
    Object localObject1 = BaseApplicationImpl.getApplication().getRuntime();
    Object localObject2 = (String)axqc.a(((AppRuntime)localObject1).getAccount(), "key_nearby_publish_menu", "");
    if (!TextUtils.isEmpty((String)axqc.a(((AppRuntime)localObject1).getAccount(), "cike_guide_content", ""))) {}
      ...
      for (;;)
      {
        try
        {
          ...
          if (i < ((JSONArray)localObject1).length())
          {
            ...
            aynt localaynt2 = new aynt();
            localaynt2.jdField_a_of_type_Int = ((JSONObject)localObject2).optInt("id");
            if ((!bool) && (localaynt2.jdField_a_of_type_Int != 1) && (localaynt2.jdField_a_of_type_Int != 2)) {
              break label337;
            }
            localaynt2.jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("icon");
            localaynt2.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("title");
            localaynt2.c = ((JSONObject)localObject2).optString("subTitle");
            localaynt2.d = ((JSONObject)localObject2).optString("jumpUrl");
            localArrayList.add(localaynt2);
          }
        }
        catch (Exception localException)
        {
          ...
          {
            aynt localaynt1 = new aynt();
            localaynt1.jdField_a_of_type_Int = 1;
            localaynt1.jdField_b_of_type_Int = 2130841380;
            localaynt1.jdField_b_of_type_JavaLangString = anvx.a(2131706848);
            localArrayList.add(localaynt1);
            localaynt1 = new aynt();
            localaynt1.jdField_a_of_type_Int = 2;
            localaynt1.jdField_b_of_type_Int = 2130841379;
            localaynt1.jdField_b_of_type_JavaLangString = anvx.a(2131706849);
            localArrayList.add(localaynt1);
          }
  ...
  public static void a(Context paramContext, aynt paramaynt, String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyPublishMenuHelper", 2, "handleMenuItemClick：id=" + paramaynt.jdField_a_of_type_Int);
    }
    switch (paramaynt.jdField_a_of_type_Int)
    {
    default: 
      a(paramContext, paramaynt.d);
      return;
    case 1: 
      a(paramContext);
      return;
  ...
  {
    axnl localaxnl = axnl.a(paramContext, BaseApplicationImpl.getApplication().getRuntime().getAccount(), 0);
    if (localaxnl != null)
    {
      if (axnl.a(paramContext))
      {
        a(paramContext, localaxnl.d);
        return;
      }
      localaxnl.f = a(paramString1, paramString2);
      paramContext = new aynm(paramContext);
      paramContext.a(localaxnl);
      paramContext.show();
      return;
    }
  ...
  {
    new bdlf(null).a("dc00899").b("grp_lbs").c(paramString1).d(paramString2).a();
  }
  ...
  protected static void b(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      {
        QQToast.a(paramContext, 2131718340, 0).a();
        if (QLog.isColorLevel()) {
      ...
      else
      {
        ...
        for (localObject1 = (AppActivity)paramContext;; localObject2 = null)
        {
          ...
          if ((Build.VERSION.SDK_INT >= 23) && (((AppActivity)localObject1).checkSelfPermission("android.permission.CAMERA") != 0))
          {
            ...
            ((AppActivity)localObject1).requestPermissions(new aynw(paramContext, str, (AppActivity)localObject1, localIntent), 1, new String[] { "android.permission.CAMERA" });
          }
          for (int i = 1;; i = 0) {
            for (;;)
            {
              ...
              catch (Exception localException)
              {
                ...
                QQToast.a(paramContext, 2131690695, 0).a();
                return;
              }
            }
          }
  ...
  {
    bisl localbisl = new bisl(paramContext, paramContext.getResources().getDimensionPixelSize(2131299080));
    localbisl.c(2131693769);
    ThreadManager.post(new NearbyPublishMenuHelper.2(localbisl, paramString2, paramContext, paramString1), 5, null, true);
  }
