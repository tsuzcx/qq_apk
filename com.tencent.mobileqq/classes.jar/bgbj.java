  ...
  implements bgbi
{
  ...
  public static bgbi a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("cooperation.qzone.plugin.QZoneRemotePluginManager");
    if ((localIInterface != null) && ((localIInterface instanceof bgbi))) {
      return (bgbi)localIInterface;
    }
    return new bgbk(paramIBinder);
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    case 3: 
      paramParcel1.enforceInterface("cooperation.qzone.plugin.QZoneRemotePluginManager");
      bool = a(paramParcel1.readString(), bfzr.a(paramParcel1.readStrongBinder()), paramParcel1.readInt());
      paramParcel2.writeNoException();
      paramInt1 = k;
      if (bool) {
        paramInt1 = 1;
    ...
    case 7: 
      paramParcel1.enforceInterface("cooperation.qzone.plugin.QZoneRemotePluginManager");
      a(bfzo.a(paramParcel1.readStrongBinder()), paramParcel1.readInt());
      paramParcel2.writeNoException();
      return true;
    }
    paramParcel1.enforceInterface("cooperation.qzone.plugin.QZoneRemotePluginManager");
