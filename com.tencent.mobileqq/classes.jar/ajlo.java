  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public ajlo(Activity paramActivity, RMVideoStateMgr paramRMVideoStateMgr, String paramString1, int paramInt1, String paramString2, float paramFloat, boolean paramBoolean1, double paramDouble1, double paramDouble2, ajlk paramajlk, int paramInt2, int paramInt3, String paramString3, int paramInt4, ArrayList<String> paramArrayList, boolean paramBoolean2, String paramString4, boolean paramBoolean3, int paramInt5, int paramInt6, String paramString5)
  {
    ...
    a(paramActivity, paramRMVideoStateMgr, paramString1, paramInt1, paramString2, paramFloat, paramBoolean1, paramDouble1, paramDouble2, paramajlk, paramInt2, paramInt3);
  }
  
  public ajlo(Activity paramActivity, RMVideoStateMgr paramRMVideoStateMgr, String paramString1, int paramInt1, String paramString2, float paramFloat, boolean paramBoolean1, double paramDouble1, double paramDouble2, ajlk paramajlk, int paramInt2, int paramInt3, String paramString3, int paramInt4, ArrayList<String> paramArrayList, boolean paramBoolean2, String paramString4, boolean paramBoolean3, String paramString5, String paramString6, int paramInt5, int paramInt6, String paramString7, String paramString8, long paramLong, int paramInt7, boolean paramBoolean4)
  {
    this(paramActivity, paramRMVideoStateMgr, paramString1, paramInt1, paramString2, paramFloat, paramBoolean1, paramDouble1, paramDouble2, paramajlk, paramInt2, paramInt3, paramString3, paramInt4, paramArrayList, paramBoolean2, paramString4, paramBoolean3, paramString5, paramString6, paramLong);
  ...
  public ajlo(Activity paramActivity, RMVideoStateMgr paramRMVideoStateMgr, String paramString1, int paramInt1, String paramString2, float paramFloat, boolean paramBoolean1, double paramDouble1, double paramDouble2, ajlk paramajlk, int paramInt2, int paramInt3, String paramString3, int paramInt4, ArrayList<String> paramArrayList, boolean paramBoolean2, String paramString4, boolean paramBoolean3, String paramString5, String paramString6, int paramInt5, boolean paramBoolean4, boolean paramBoolean5)
  {
    this.jdField_k_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = paramString3;
    this.jdField_c_of_type_Int = paramInt4;
  ...
  public ajlo(Activity paramActivity, RMVideoStateMgr paramRMVideoStateMgr, String paramString1, int paramInt1, String paramString2, float paramFloat, boolean paramBoolean1, double paramDouble1, double paramDouble2, ajlk paramajlk, int paramInt2, int paramInt3, String paramString3, int paramInt4, ArrayList<String> paramArrayList, boolean paramBoolean2, String paramString4, boolean paramBoolean3, String paramString5, String paramString6, long paramLong)
  {
    this.jdField_k_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = paramString3;
    this.jdField_c_of_type_Int = paramInt4;
  ...
  public ajlo(Activity paramActivity, RMVideoStateMgr paramRMVideoStateMgr, String paramString1, int paramInt1, String paramString2, float paramFloat, boolean paramBoolean1, double paramDouble1, double paramDouble2, ajlk paramajlk, int paramInt2, int paramInt3, boolean paramBoolean2)
  {
    this.jdField_k_of_type_JavaLangString = "";
    a(paramActivity, paramRMVideoStateMgr, paramString1, paramInt1, paramString2, paramFloat, paramBoolean1, paramDouble1, paramDouble2, paramajlk, paramInt2, paramInt3);
  }
  
  private void a(Activity paramActivity, RMVideoStateMgr paramRMVideoStateMgr, String paramString1, int paramInt1, String paramString2, float paramFloat, boolean paramBoolean, double paramDouble1, double paramDouble2, ajlk paramajlk, int paramInt2, int paramInt3)
  {
    ...
    if (this.jdField_c_of_type_Long != 0L)
    {
      ...
      label163:
      this.jdField_l_of_type_Int = (this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_Ajow.jdField_e_of_type_Int * this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_Ajow.jdField_f_of_type_Int * 3 / 2);
      ...
      if ((RMVideoStateMgr.jdField_a_of_type_Boolean) && (!paramBoolean)) {
        this.jdField_e_of_type_Int = paramRMVideoStateMgr.jdField_a_of_type_Ajow.jdField_e_of_type_Int;
      }
      if (paramBoolean)
      {
    ...
    for (;;)
    {
      paramActivity = paramRMVideoStateMgr.jdField_a_of_type_Ajpg.a();
      ...
      boolean bool = azcw.d(azcw.jdField_c_of_type_JavaLangString);
      if (bool) {
        this.jdField_e_of_type_Boolean = false;
      }
      if ((!TextUtils.isEmpty(this.jdField_i_of_type_JavaLangString)) && (bdcs.b(this.jdField_i_of_type_JavaLangString))) {
  ...
  private void b(Intent paramIntent)
  {
    ...
    localBundle.putInt("sv_encode_max_bitrate", azds.r);
    localBundle.putInt("sv_encode_min_bitrate", azds.s);
    localBundle.putInt("sv_encode_qmax", azds.t);
    localBundle.putInt("sv_encode_qmin", azds.u);
    localBundle.putInt("sv_encode_qmaxdiff", azds.v);
    ...
    localBundle.putInt("sv_encode_totaltime_adjust", azds.E);
    localBundle.putInt("sv_encode_timestamp_fix", azds.F);
    localBundle.putInt("sv_encode_bless_audio_time_low", azds.G);
    localBundle.putInt("sv_encode_bless_audio_time_high", azds.H);
    localBundle.putInt("sv_encode_bless_audio_time_ratio", azds.I);
  ...
  int a()
  {
    ...
    while (i1 < i5)
    {
      ...
      if (str.endsWith(".vf"))
      {
        long l1 = bdcs.a(localFile.getAbsolutePath() + "/" + str);
        if (QLog.isColorLevel()) {
  ...
  protected Integer a(Void... paramVarArgs)
  {
    ...
    //   4: putfield 541	ajlo:jdField_a_of_type_Long	J
    //   7: aload_0
    //   8: getfield 266	ajlo:jdField_k_of_type_Int	I
    //   11: ifeq +11 -> 22
    //   14: aload_0
    //   15: getfield 266	ajlo:jdField_k_of_type_Int	I
    ...
    //   31: ifeq +14 -> 45
    //   34: aload_0
    //   35: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   38: iconst_2
    //   39: ldc_w 549
    ...
    //   46: lstore 7
    //   48: aload_0
    //   49: getfield 152	ajlo:jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr	Lcom/tencent/mobileqq/activity/richmedia/state/RMVideoStateMgr;
    ...
    //   57: monitorenter
    //   58: aload_0
    //   59: getfield 152	ajlo:jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr	Lcom/tencent/mobileqq/activity/richmedia/state/RMVideoStateMgr;
    ...
    //   90: lstore_3
    //   91: aload_0
    //   92: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   95: iconst_2
    //   96: ldc_w 558
    ...
    //   112: lstore_3
    //   113: aload_0
    //   114: getfield 150	ajlo:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   117: new 560	com/tencent/mobileqq/activity/richmedia/FlowSendTask$2
    //   120: dup
    //   121: aload_0
    //   122: invokespecial 561	com/tencent/mobileqq/activity/richmedia/FlowSendTask$2:<init>	(Lajlo;)V
    //   125: invokevirtual 564	android/app/Activity:runOnUiThread	(Ljava/lang/Runnable;)V
    //   128: lload 7
    //   130: lstore_3
    //   131: aload_0
    //   132: getfield 152	ajlo:jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr	Lcom/tencent/mobileqq/activity/richmedia/state/RMVideoStateMgr;
    ...
    //   138: getstatic 49	ajlo:jdField_d_of_type_Long	J
    ...
    //   170: lstore_3
    //   171: aload_0
    //   172: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   175: iconst_2
    ...
    //   209: ifeq +14 -> 223
    //   212: aload_0
    //   213: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   216: iconst_2
    //   217: ldc_w 573
    //   220: invokestatic 85	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   223: lload 5
    //   225: getstatic 49	ajlo:jdField_d_of_type_Long	J
    //   228: lcmp
    //   229: iflt +65 -> 294
    //   232: bipush 249
    ...
    //   246: ifeq -42 -> 204
    //   249: aload_0
    //   250: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   253: iconst_2
    ...
    //   293: athrow
    //   294: aload_0
    //   295: invokevirtual 580	ajlo:a	()I
    //   298: istore_2
    //   299: iload_2
    //   300: ifeq +42 -> 342
    ...
    //   306: ifeq +31 -> 337
    //   309: aload_0
    //   310: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   313: iconst_2
    ...
    //   341: areturn
    //   342: aload_0
    //   343: getfield 213	ajlo:jdField_e_of_type_Boolean	Z
    //   346: ifne +13 -> 359
    //   349: aload_0
    //   350: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   362: ifeq +14 -> 376
    //   365: aload_0
    //   366: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   369: iconst_2
    //   370: ldc_w 584
    //   373: invokestatic 85	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   376: aload_0
    //   377: getfield 92	ajlo:jdField_j_of_type_Int	I
    //   380: bipush 90
    //   382: if_icmpeq +13 -> 395
    //   385: aload_0
    //   386: getfield 92	ajlo:jdField_j_of_type_Int	I
    //   389: sipush 270
    //   392: if_icmpne +21 -> 413
    //   395: aload_0
    //   396: getfield 216	ajlo:jdField_e_of_type_Int	I
    //   399: istore_2
    //   400: aload_0
    //   401: aload_0
    //   402: getfield 264	ajlo:jdField_f_of_type_Int	I
    //   405: putfield 216	ajlo:jdField_e_of_type_Int	I
    //   408: aload_0
    //   409: iload_2
    //   410: putfield 264	ajlo:jdField_f_of_type_Int	I
    //   413: aload_0
    //   414: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   417: aload_0
    //   418: getfield 332	ajlo:jdField_a_of_type_Double	D
    //   421: aload_0
    //   422: getfield 334	ajlo:jdField_b_of_type_Double	D
    //   425: invokestatic 589	bdda:a	(Ljava/lang/String;DD)Z
    //   428: ifeq +119 -> 547
    //   431: new 478	java/io/File
    //   434: dup
    //   435: aload_0
    //   436: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   439: invokespecial 481	java/io/File:<init>	(Ljava/lang/String;)V
    //   442: astore 10
    //   444: new 591	java/io/FileInputStream
    //   447: dup
    //   448: aload_0
    //   449: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   469: putfield 315	ajlo:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    //   472: aload_1
    //   473: ifnull +7 -> 480
    //   476: aload_1
    //   477: invokevirtual 610	java/io/FileInputStream:close	()V
    //   480: aload_0
    //   481: getfield 315	ajlo:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   493: ifeq +14 -> 507
    //   496: aload_0
    //   497: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   500: iconst_2
    //   501: ldc_w 612
    ...
    //   517: goto -37 -> 480
    //   520: aload_0
    //   521: getfield 315	ajlo:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    //   524: ldc_w 617
    ...
    //   530: astore_1
    //   531: aload_0
    //   532: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   535: aload_1
    //   536: invokestatic 625	bdcs:d	(Ljava/lang/String;Ljava/lang/String;)Z
    //   539: ifeq +13 -> 552
    //   542: aload_0
    //   543: aload_1
    //   544: putfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   547: iconst_0
    //   548: invokestatic 547	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   551: areturn
    //   552: aload_1
    //   553: invokestatic 328	bdcs:b	(Ljava/lang/String;)Z
    //   556: ifne -9 -> 547
    //   559: invokestatic 63	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   562: ifeq +44 -> 606
    //   565: aload_0
    //   566: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   569: iconst_2
    ...
    //   583: aload_0
    //   584: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   612: aload_0
    //   613: aload_0
    //   614: getfield 157	ajlo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   617: aload_0
    //   618: getfield 216	ajlo:jdField_e_of_type_Int	I
    //   621: aload_0
    //   622: getfield 264	ajlo:jdField_f_of_type_Int	I
    //   625: aload_0
    //   626: getfield 92	ajlo:jdField_j_of_type_Int	I
    ...
    //   635: putfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   638: aload_0
    //   639: getfield 92	ajlo:jdField_j_of_type_Int	I
    //   642: bipush 90
    //   644: if_icmpeq +13 -> 657
    //   647: aload_0
    //   648: getfield 92	ajlo:jdField_j_of_type_Int	I
    //   651: sipush 270
    //   654: if_icmpne +21 -> 675
    //   657: aload_0
    //   658: getfield 216	ajlo:jdField_e_of_type_Int	I
    //   661: istore_2
    //   662: aload_0
    //   663: aload_0
    //   664: getfield 264	ajlo:jdField_f_of_type_Int	I
    //   667: putfield 216	ajlo:jdField_e_of_type_Int	I
    //   670: aload_0
    //   671: iload_2
    //   672: putfield 264	ajlo:jdField_f_of_type_Int	I
    //   675: aload_0
    //   676: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   688: ifeq +14 -> 702
    //   691: aload_0
    //   692: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   695: iconst_2
    //   696: ldc_w 642
    ...
    //   707: areturn
    //   708: aload_0
    //   709: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   712: aload_0
    //   713: getfield 332	ajlo:jdField_a_of_type_Double	D
    //   716: aload_0
    //   717: getfield 334	ajlo:jdField_b_of_type_Double	D
    //   720: invokestatic 589	bdda:a	(Ljava/lang/String;DD)Z
    //   723: pop
    //   724: new 478	java/io/File
    //   727: dup
    //   728: aload_0
    //   729: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   748: dup
    //   749: aload_0
    //   750: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   775: putfield 315	ajlo:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    //   778: aload 10
    //   780: ifnull +8 -> 788
    //   783: aload 10
    //   785: invokevirtual 610	java/io/FileInputStream:close	()V
    //   788: aload_0
    //   789: getfield 315	ajlo:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   801: ifeq +14 -> 815
    //   804: aload_0
    //   805: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   808: iconst_2
    //   809: ldc_w 612
    ...
    //   825: goto -37 -> 788
    //   828: aload_0
    //   829: getfield 315	ajlo:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    //   832: ldc_w 617
    ...
    //   838: astore_1
    //   839: aload_0
    //   840: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   843: aload_1
    //   844: invokestatic 644	bdcs:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   847: ifeq +13 -> 860
    //   850: aload_0
    //   851: aload_1
    //   852: putfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   855: iconst_0
    //   856: invokestatic 547	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   859: areturn
    //   860: aload_1
    //   861: invokestatic 328	bdcs:b	(Ljava/lang/String;)Z
    //   864: ifne -9 -> 855
    //   867: invokestatic 63	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   870: ifeq +44 -> 914
    //   873: aload_0
    //   874: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   877: iconst_2
    ...
    //   891: aload_0
    //   892: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   943: aload_0
    //   944: getfield 315	ajlo:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   956: ifeq +14 -> 970
    //   959: aload_0
    //   960: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   963: iconst_2
    //   964: ldc_w 612
    ...
    //   980: goto -37 -> 943
    //   983: aload_0
    //   984: getfield 315	ajlo:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    //   987: ldc_w 617
    ...
    //   993: astore_1
    //   994: aload_0
    //   995: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   998: aload_1
    //   999: invokestatic 644	bdcs:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   1002: ifeq +11 -> 1013
    //   1005: aload_0
    //   1006: aload_1
    //   1007: putfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   1010: goto -155 -> 855
    //   1013: aload_1
    //   1014: invokestatic 328	bdcs:b	(Ljava/lang/String;)Z
    //   1017: ifne -162 -> 855
    //   1020: invokestatic 63	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   1023: ifeq +44 -> 1067
    //   1026: aload_0
    //   1027: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   1030: iconst_2
    ...
    //   1044: aload_0
    //   1045: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1085: aload_0
    //   1086: getfield 315	ajlo:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1098: ifeq +14 -> 1112
    //   1101: aload_0
    //   1102: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   1105: iconst_2
    //   1106: ldc_w 612
    ...
    //   1122: goto -37 -> 1085
    //   1125: aload_0
    //   1126: getfield 315	ajlo:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    //   1129: ldc_w 617
    ...
    //   1135: astore_1
    //   1136: aload_0
    //   1137: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   1140: aload_1
    //   1141: invokestatic 644	bdcs:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   1144: ifeq +11 -> 1155
    //   1147: aload_0
    //   1148: aload_1
    //   1149: putfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   1152: aload 10
    //   1154: athrow
    //   1155: aload_1
    //   1156: invokestatic 328	bdcs:b	(Ljava/lang/String;)Z
    //   1159: ifne -7 -> 1152
    //   1162: invokestatic 63	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   1165: ifeq +44 -> 1209
    //   1168: aload_0
    //   1169: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   1172: iconst_2
    ...
    //   1186: aload_0
    //   1187: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1218: ifeq +34 -> 1252
    //   1221: aload_0
    //   1222: getfield 98	ajlo:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   1225: iconst_2
    ...
    //   1239: aload_0
    //   1240: getfield 312	ajlo:jdField_e_of_type_JavaLangString	Ljava/lang/String;
  ...
  void a(Intent paramIntent)
  {
    ...
    paramIntent.putExtra("sv_encode_max_bitrate", azds.r);
    paramIntent.putExtra("sv_encode_min_bitrate", azds.s);
    paramIntent.putExtra("sv_encode_qmax", azds.t);
    paramIntent.putExtra("sv_encode_qmin", azds.u);
    paramIntent.putExtra("sv_encode_qmaxdiff", azds.v);
    paramIntent.putExtra("sv_encode_ref_frame", azds.w);
    paramIntent.putExtra("sv_encode_smooth", azds.x);
    ...
    paramIntent.putExtra("sv_encode_totaltime_adjust", azds.E);
    paramIntent.putExtra("sv_encode_timestamp_fix", azds.F);
    paramIntent.putExtra("sv_encode_bless_audio_time_low", azds.G);
    paramIntent.putExtra("sv_encode_bless_audio_time_high", azds.H);
    paramIntent.putExtra("sv_encode_bless_audio_time_ratio", azds.I);
    ...
    azet.a("sv_filter_mp4_fps", this.jdField_b_of_type_Int * 1000 / this.jdField_a_of_type_Int);
  ...
  protected void a(Integer paramInteger)
  {
    ...
    if (paramInteger.intValue() == 0)
    {
      ...
      for (paramInteger = "";; paramInteger = this.jdField_a_of_type_Ajlk.a())
      {
        ...
        if (("qzone_plugin.apk".equals(str)) && (bool1))
        {
          ...
          bizm.a(this.jdField_a_of_type_AndroidAppActivity, "", paramInteger, -1);
        }
      ...
      if (this.jdField_a_of_type_Ajlk != null)
      {
        this.jdField_a_of_type_Ajlk.a(this.jdField_a_of_type_AndroidAppActivity, paramInteger);
        return;
      }
    ...
    for (int i1 = 3;; i1 = 2)
    {
      ...
      if ((this.jdField_c_of_type_JavaLangString != null) && (this.jdField_c_of_type_JavaLangString.equals(MessageForBlessPTV.BLESS_REQ_UIN)))
      {
        ...
        if (this.jdField_b_of_type_Boolean)
        {
          ...
          paramInteger.putExtra("param_title", this.jdField_a_of_type_AndroidAppActivity.getString(2131690565));
          paramInteger.putExtra("param_done_button_wording", this.jdField_a_of_type_AndroidAppActivity.getString(2131691088));
      ...
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity, alpo.a(2131705033), 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298914));
      if (QLog.isColorLevel()) {
