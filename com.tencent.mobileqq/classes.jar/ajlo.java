...
public class ajlo
{
  ...
  {
    if (paramInt == 2052) {
      return ajjy.a(2131628077);
    }
    if (paramInt == 1033) {
      return ajjy.a(2131628076);
    }
    return "";
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      str = akhw.a(paramContext, "key_local_cache", "0");
      a("initializeAppLocale, localeIdStr:" + str);
      if (!"0".equals(str)) {
        break label182;
      }
      jdField_a_of_type_Int = 2052;
      akhw.a(paramContext, "key_local_cache", String.valueOf(jdField_a_of_type_Int));
      str = akhw.a(paramContext, "key_local_last", "0");
      if (!"0".equals(str)) {
        break label200;
      }
    ...
    {
      b = bool1;
      akhw.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
  ...
  public static void a(Context paramContext, int paramInt)
  {
    ...
    akhw.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
    akhw.a(paramContext, "key_local_cache", String.valueOf(paramInt));
