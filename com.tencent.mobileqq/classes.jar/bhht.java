  ...
  extends ReportDialog
{
  ...
  public bhht(Context paramContext)
  {
    this(paramContext, 0);
  }
  
  public bhht(Context paramContext, int paramInt)
  {
    this(paramContext, paramInt, 2131561384, 48);
  }
  
  public bhht(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363572));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371418));
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_b_of_type_Int = paramInt3;
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378702));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378703));
  ...
  public void a(bhhv parambhhv)
  {
    this.jdField_a_of_type_Bhhv = parambhhv;
  }
  ...
  {
    setOnKeyListener(new bhhu(this, paramBoolean));
  }
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 159	achg:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 159	achg:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 159	achg:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
  ...
  public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent paramAccessibilityEvent)
  {
    ...
    if (AppSetting.c) {
      QQAppInterface.speak(this.jdField_a_of_type_JavaLangString);
    }
    return true;
  }
