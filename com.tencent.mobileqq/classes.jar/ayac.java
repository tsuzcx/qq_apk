  ...
  implements axzw
{
  ...
  public ayac(Context paramContext)
  {
  ...
  {
    this.jdField_a_of_type_Axzx = paramaxzx;
  }
  
  public void a(axzy paramaxzy)
  {
    this.jdField_a_of_type_Axzy = paramaxzy;
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong)
  {
    ...
    do
    {
      ...
      String str = wbk.a(paramString1, 0);
      this.b = paramString2;
      this.c = paramString3;
      ...
      if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null)
      {
        ...
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnCompletionListener(new ayad(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnErrorListener(new ayae(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnInfoListener(new ayaf(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoPreparedListener(new ayag(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnDownloadCallback(new ayah(this, paramString2, paramString1, paramString3));
      }
      paramString1 = a(str, paramString2, paramLong);
      paramString1.setConfigMap("keep_last_frame", "true");
      if ((!TextUtils.isEmpty(paramString2)) && (wbl.a(new File(paramString2))))
      {
    ...
    {
      Bosses.get().postJob(new ayai(this, "VideoViewTVKImpl", paramString3, paramString1));
      return;
    }
