  ...
  implements uqm
{
  private boolean a(List<String> paramList)
  {
    ...
    {
      wxe.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleAlbumEntraConfig type: 日迹主页影集入口配置, content: \n", paramList);
      paramList = (uio)uwa.a(30);
        ...
        catch (NumberFormatException localNumberFormatException3)
        {
          try
          {
            for (;;)
            {
              ...
              wxe.e("Q.qqstory.config.QQStoryConfigServletHandler", "get enableCqMode= " + str11 + " from json error:" + localNumberFormatException1);
              continue;
              localNumberFormatException2 = localNumberFormatException2;
              wxe.e("Q.qqstory.config.QQStoryConfigServletHandler", "get highBitrate= " + str11 + " from json error:" + localNumberFormatException2);
              continue;
              bool = false;
            }
            localNumberFormatException3 = localNumberFormatException3;
            wxe.e("Q.qqstory.config.QQStoryConfigServletHandler", "get codecProfile= " + str11 + " from json error:" + localNumberFormatException3);
          }
          catch (NumberFormatException localNumberFormatException4)
          {
            for (;;)
            {
              wxe.e("Q.qqstory.config.QQStoryConfigServletHandler", "get maxVideoSize= " + str11 + " from json error:" + localNumberFormatException4);
            }
          }
        }
      }
  ...
  private boolean a(List<String> paramList, String paramString)
  {
    ...
    {
      return false;
      wxe.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleQzoneSync2QQStory config=%s", paramList);
    ...
    catch (Throwable paramString)
    {
      for (;;)
      {
        wxe.e("Q.qqstory.config.QQStoryConfigServletHandler", "handleQzoneSync2QQStory  parseLong error");
      }
    }
  ...
  private boolean b(List<String> paramList)
  {
    ...
    for (paramList = "";; paramList = str)
    {
      wxe.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleAlbumConfig type: 影集配置, content: \n", paramList);
      if ((!TextUtils.isEmpty(str)) && (str.trim().length() != 0)) {
        break;
      }
      localuio.f();
  ...
  private boolean b(List<String> paramList, int paramInt)
  {
    ...
    return ((uvx)uwa.a(5)).a(paramList);
  }
  ...
  private boolean c(List<String> paramList)
  {
    ...
    uza localuza = (uza)QQStoryContext.a().getManager(252);
    String str = (String)paramList.get(0);
    if (str == null) {}
    for (paramList = "";; paramList = str)
    {
      wxe.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleMsgTabTakeVideoNodeConfig type: 日迹拍摄配置, content: \n", paramList);
      if ((!TextUtils.isEmpty(str)) && (str.trim().length() != 0)) {
        break;
      }
      localuza.a();
  ...
  private boolean d(List<String> paramList)
  {
    ...
    paramList = (String)paramList.get(0);
    wxe.a("Q.qqstory.config.QQStoryConfigServletHandler", "handledAIOSyncToStory config=%s", paramList);
    if (TextUtils.isEmpty(paramList))
    {
      wxe.d("Q.qqstory.config.QQStoryConfigServletHandler", "handledAIOSyncToStory content is null!!");
      bmim.b();
      return true;
    }
    try
  ...
  private boolean e(List<String> paramList)
  {
    ...
    wxe.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig config=%s", paramList);
    paramList = (String)paramList.get(0);
    if (TextUtils.isEmpty(paramList))
    {
      wxe.d("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig clear config");
      uvt.c(false);
      uvt.e(false);
      return true;
    }
    try
    {
      ...
      wxe.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig showSyncBtn = %d,defaultStatus=%d", Integer.valueOf(i), Integer.valueOf(j));
      if (i == 1)
      {
        bool = true;
        uvt.c(bool);
    ...
    {
      xqq.a("handleStorySync2QzoneConfig:" + paramList.toString(), new Object[0]);
      paramList.printStackTrace();
    }
  }
  ...
  private boolean f(List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramList = (uvv)JsonORM.a(new JSONObject(paramList), uvv.class);
        localuvt = (uvt)uwa.a(10);
        localuvt.b("boolean_enable_revert_play_mode", Boolean.valueOf(true));
        localuvt.b("boolean_enable_fast_play_mode", Boolean.valueOf(true));
        localuvt.b("boolean_enable_slow_play_mode", Boolean.valueOf(true));
        localuvt.b("boolean_enable_hw_encode_pic_to_video", Boolean.valueOf(true));
        localuvt.b("boolean_enable_flow_decode", Boolean.valueOf(true));
        localuvt.b("boolean_use_flow_decode_first", Boolean.valueOf(false));
        localuvt.b("key_story_home_preload_count", Integer.valueOf(4));
        localuvt.b("key_story_video_preload_duration", Integer.valueOf(2));
        uvw[] arrayOfuvw;
        int k;
        if (paramList.f != null)
        {
          arrayOfuvw = paramList.f;
          k = arrayOfuvw.length;
          i = 0;
          if (i < k)
          {
            ...
            localuvt.b("boolean_use_flow_decode_first", Boolean.valueOf(true));
          }
        }
        if (paramList.jdField_a_of_type_ArrayOfUvw != null)
        {
          arrayOfuvw = paramList.jdField_a_of_type_ArrayOfUvw;
          k = arrayOfuvw.length;
          i = 0;
          if (i < k)
          {
            ...
            localuvt.b("boolean_enable_revert_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.jdField_b_of_type_ArrayOfUvw != null)
        {
          arrayOfuvw = paramList.jdField_b_of_type_ArrayOfUvw;
          k = arrayOfuvw.length;
          i = 0;
          if (i < k)
          {
            ...
            localuvt.b("boolean_enable_fast_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.c != null)
        {
          arrayOfuvw = paramList.c;
          k = arrayOfuvw.length;
          i = 0;
          if (i < k)
          {
            ...
            localuvt.b("boolean_enable_slow_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.d != null)
        {
          arrayOfuvw = paramList.d;
          k = arrayOfuvw.length;
          i = 0;
          if (i < k)
          {
            ...
            localuvt.b("boolean_enable_hw_encode_pic_to_video", Boolean.valueOf(false));
          }
        }
        if (paramList.e != null)
        {
          arrayOfuvw = paramList.e;
          k = arrayOfuvw.length;
          i = 0;
          if (i < k)
          {
            ...
            localuvt.b("boolean_enable_flow_decode", Boolean.valueOf(false));
          }
        }
      ...
      localuvt.b("string_story_global_log_level", Integer.valueOf(i));
      localuvt.b("string_auto_play_report_control", paramList.jdField_b_of_type_JavaLangString);
      if ((paramList.jdField_a_of_type_Int > 0) && (paramList.jdField_a_of_type_Int < 20)) {
        localuvt.b("key_story_home_preload_count", Integer.valueOf(paramList.jdField_a_of_type_Int));
      }
      if ((paramList.jdField_b_of_type_Int > 0) && (paramList.jdField_b_of_type_Int < 10))
      {
        localuvt.b("key_story_video_preload_duration", Integer.valueOf(paramList.jdField_b_of_type_Int));
        break label726;
        i = j;
  ...
  private boolean g(List<String> paramList)
  {
    ...
    paramList = (String)paramList.get(0);
    if (!TextUtils.isEmpty(paramList)) {
      bdne.i(localQQAppInterface.getApp(), localQQAppInterface.c(), paramList);
    }
    for (;;)
    {
      ((ulu)localQQAppInterface.getManager(181)).b(paramList);
      if (QLog.isColorLevel()) {
        QLog.d("Q.qqstory.config.QQStoryConfigServletHandler", 2, "handleStoryPlayerProxyConfigCmd configContent = " + paramList);
      }
      return true;
      bdne.i(localQQAppInterface.getApp(), localQQAppInterface.c(), null);
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (ndd.a((String)localObject2)))
          {
            localuvt.b("CertificationLinkText", localObject1);
            localuvt.b("CertificationLinkUrl", localObject2);
            ...
            localuvt.b("localVideoScanInterval", String.valueOf(i));
            localObject1 = localJSONObject.optJSONObject("mainHallConfig");
            if (localObject1 == null) {
              break label554;
            }
            localuvt.b("mainHallConfig", ((JSONObject)localObject1).toString());
            localObject1 = localJSONObject.optJSONObject("troopStoryHallConfig");
            if (localObject1 == null) {
              break label567;
            }
            localuvt.b("troopStoryHallConfig", ((JSONObject)localObject1).toString());
            ...
            bool = true;
            localuvt.b("key_share_encrypt_flag", Boolean.valueOf(bool));
            ...
            bool = true;
            localuvt.b("key_show_in_friend_story_main_page", Boolean.valueOf(bool));
            ...
            localuvt.b("boolean_enable_multi_video_fragment", Boolean.valueOf(true));
            i = 0;
            if (i < j)
            {
              ...
              localuvt.b("boolean_enable_multi_video_fragment", Boolean.valueOf(false));
            }
            i = localJSONObject.optInt("qim_sync_to_qq", 0);
            QLog.d("Q.qqstory.commonConfig", 2, "qim_sync_to_qq: " + paramList);
            localuvt.b("key_qim_int_qim_sync_to_qq_default", Integer.valueOf(i));
            return true;
          }
          localuvt.b("CertificationLinkText", "");
          localuvt.b("CertificationLinkUrl", "");
          continue;
        }
        localuvt.b("CertificationLinkText", "");
      }
      ...
      continue;
      label540:
      localuvt.b("localVideoScanInterval", "1441");
      continue;
      label554:
      localuvt.b("mainHallConfig", "");
      continue;
      label567:
      localuvt.b("troopStoryHallConfig", "");
      continue;
      label580:
      localuvt.b("key_share_encrypt_flag", Boolean.valueOf(false));
      continue;
      label595:
      localuvt.b("key_show_in_friend_story_main_page", Boolean.valueOf(true));
      continue;
      label610:
      localuvt.b("boolean_enable_multi_video_fragment", Boolean.valueOf(true));
      continue;
  ...
  public boolean a(int paramInt, Intent paramIntent, ConfigurationService.Config paramConfig)
  {
    ...
    Object localObject = uvt.a(paramInt);
    int i = bdne.a(QQStoryContext.a().getApp(), (String)localObject, str);
    int j = paramConfig.version.get();
    localObject = aozj.a(paramConfig, i, paramInt);
    if (localObject == null) {
      return bool2;
    }
    switch (paramInt)
