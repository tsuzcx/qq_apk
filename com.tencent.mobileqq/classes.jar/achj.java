...
{
  achj(achi paramachi, FileInfo paramFileInfo, ActionSheet paramActionSheet) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    if ((!FileUtil.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileInfo.c())) || (FileUtil.c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileInfo.c())))
    {
      ...
      this.jdField_a_of_type_Achi.a.a.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileInfo);
    }
    try
    {
      ...
      this.jdField_a_of_type_Achi.a.a.a.sendBroadcast(paramView);
      label104:
      this.jdField_a_of_type_Achi.a.a.d();
