  ...
  implements View.OnClickListener, View.OnLongClickListener
{
  ...
  public void onClick(View paramView)
  {
    if (this.jdField_a_of_type_Yop != null) {
      this.jdField_a_of_type_Yop.a(this.jdField_b_of_type_Int, paramView, this.jdField_a_of_type_JavaLangObject, this);
    }
  ...
  {
    if (this.jdField_a_of_type_Yop != null) {
      this.jdField_a_of_type_Yop.b(this.jdField_b_of_type_Int, paramView, this.jdField_a_of_type_JavaLangObject, this);
    }
    return true;
  }
}
