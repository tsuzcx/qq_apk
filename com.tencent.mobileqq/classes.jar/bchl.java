  ...
  implements Manager
{
  ...
  alzf jdField_a_of_type_Alzf;
  @NonNull
  SparseArray<Integer> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray(10);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  final Object jdField_a_of_type_JavaLangObject = new Object();
  String jdField_a_of_type_JavaLangString;
  ThreadLocal<SimpleDateFormat> jdField_a_of_type_JavaLangThreadLocal = new bchm(this);
  protected Map<String, JSONObject> a;
  protected boolean a;
  protected final int b;
  protected SparseArray<bchi> b;
  String b;
  protected String c;
  
  public bchl(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Alzf = ((alzf)paramQQAppInterface.a(20));
    a();
    ...
    while (i < j)
    {
      ...
      bchi localbchi = new bchi();
      localbchi.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getString("appinfo_date_" + k, "");
      localbchi.jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getInt("KEY_APP_LIST_TIME_STAMP_" + k, 0);
      this.jdField_b_of_type_AndroidUtilSparseArray.put(k, localbchi);
      i += 1;
    }
    f();
    d();
    ...
    this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getString("appinfo_all_app_string", alpo.a(2131715570));
  }
  ...
  private void f()
  {
    ...
    {
      Object localObject3 = localawbw.a(TroopAIOAppInfo.class);
      ...
      if (((ListIterator)localObject1).hasNext())
      {
        ...
        bchi localbchi = (bchi)this.jdField_b_of_type_AndroidUtilSparseArray.get(((TroopAIOAppInfo)localObject3).groupType);
        xmh.a(localbchi);
        localbchi.a(((TroopAIOAppInfo)localObject3).appid, (TroopAIOAppInfo)localObject3);
      }
    }
    localawbw.a();
  }
  ...
  {
    bchi localbchi = (bchi)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
    if (localbchi != null) {}
    ...
    return localbchi.jdField_b_of_type_Int;
  }
  
  public TroopAIOAppInfo a(int paramInt1, int paramInt2)
  {
    Object localObject1 = (bchi)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt2, null);
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        localObject1 = (TroopAIOAppInfo)((bchi)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt1));
        if (localObject1 != null)
        {
  ...
  public List<TroopAIOAppInfo> a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Alzf.a(1, paramInt, null, paramBoolean);
    }
    ArrayList localArrayList = new ArrayList();
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      Object localObject2 = (bchi)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
      xmh.a(localObject2);
      localObject2 = ((bchi)localObject2).a().iterator();
  ...
  public void a()
  {
    bcho[] arrayOfbcho = bcho.jdField_a_of_type_ArrayOfBcho;
    int j = arrayOfbcho.length;
    int i = 0;
    while (i < j)
    {
      bcho localbcho = arrayOfbcho[i];
      Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getString("KEY_APP_CONFIG_PREFIX-" + localbcho.jdField_a_of_type_JavaLangString, null);
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        localObject = localbcho.a((String)localObject);
        this.jdField_a_of_type_JavaUtilMap.put(localbcho.jdField_a_of_type_JavaLangString, localObject);
      }
      i += 1;
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    bchi localbchi = (bchi)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt, null);
    if (localbchi != null) {}
    for (boolean bool = true;; bool = false)
    {
      xmh.a(bool);
      if (localbchi != null) {
        localbchi.jdField_a_of_type_JavaLangString = ((String)localObject);
      }
  ...
  {
    bchi localbchi = (bchi)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt2);
    boolean bool;
    if (localbchi != null)
    {
      bool = true;
    ...
    do
    {
      ...
      bool = false;
      break;
      TroopAIOAppInfo localTroopAIOAppInfo = (TroopAIOAppInfo)localbchi.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Integer.valueOf(paramInt1));
      if (localTroopAIOAppInfo != null)
      {
        xmh.a(localbchi.a(localTroopAIOAppInfo));
  ...
  public void a(int paramInt, boolean paramBoolean, String paramString)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
      {
        ...
        b();
        ??? = new azmo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("add_page").d("Clk_app").a(new String[] { paramString }).a(new String[] { String.valueOf(paramInt) });
        if (paramBoolean)
        {
          paramString = "0";
          ((azmo)???).a(new String[] { paramString }).a();
          return;
        }
      }
      paramString = "1";
  ...
  public void a(ArrayList<Integer> paramArrayList)
  {
    ...
    bchi localbchi = (bchi)this.jdField_b_of_type_AndroidUtilSparseArray.get(0, null);
    if (localbchi != null) {}
    for (boolean bool = true;; bool = false)
    {
      xmh.a(bool);
      ...
      } while (localbchi.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(localInteger));
      QLog.w(".troop.troop_app", 1, "TroopAppMgr:sortTroopAppList error, there is no appid in hashtable");
      return;
    }
    this.jdField_a_of_type_Alzf.a(a(0), paramArrayList);
  }
  ...
  public void a(ArrayList<TroopAIOAppInfo> paramArrayList, int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        localbchi.a(localTroopAIOAppInfo.appid, localTroopAIOAppInfo);
      }
    }
    label104:
  ...
  public void a(ArrayList<Integer> paramArrayList1, ArrayList<Integer> paramArrayList2)
  {
    ...
    do
    {
      ...
      {
        this.jdField_a_of_type_Alzf.a(a(0), paramArrayList1, paramArrayList2);
        return;
      }
    } while (!QLog.isColorLevel());
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    {
      bcho localbcho = arrayOfbcho[i];
      JSONObject localJSONObject = localbcho.a(paramJSONObject.optJSONObject(localbcho.jdField_a_of_type_JavaLangString));
      if (localJSONObject != null) {
        a(localbcho.jdField_a_of_type_JavaLangString, localJSONObject);
      }
      i += 1;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean) {
          localbchi.jdField_a_of_type_Int |= 0x2;
        } else {
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean) {
          localbchi.jdField_a_of_type_Int |= 0x1;
        } else {
  ...
  public boolean a(int paramInt)
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 44	bchl:jdField_b_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   8: iload_1
    //   9: aconst_null
    //   10: invokevirtual 283	android/util/SparseArray:get	(ILjava/lang/Object;)Ljava/lang/Object;
    //   13: checkcast 71	bchi
    //   16: astore 4
    //   18: aload 4
    //   20: ifnull +20 -> 40
    //   23: iconst_1
    ...
    //   42: goto -17 -> 25
    //   45: aload 4
    //   47: getfield 478	bchi:jdField_a_of_type_Int	I
    //   50: istore_1
    //   51: iload_1
    //   52: iconst_1
    //   53: iand
  ...
  public boolean a(awbw paramawbw, awbv paramawbv)
  {
    ...
    do
    {
      ...
      bool1 = bool2;
    } while (paramawbv.getStatus() != 1002);
  ...
  public boolean a(TroopAIOAppInfo paramTroopAIOAppInfo)
  {
    ...
    Object localObject = (bchi)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramTroopAIOAppInfo.groupType);
    boolean bool1;
    if (localObject != null)
    {
      bool1 = true;
    ...
    do
    {
      ...
      bool1 = false;
      break;
      localObject = (TroopAIOAppInfo)((bchi)localObject).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i));
    } while (localObject == null);
    xmh.a(paramTroopAIOAppInfo.hashVal);
    xmh.a(((TroopAIOAppInfo)localObject).hashVal);
  ...
  public boolean a(List<Integer> paramList, int paramInt)
  {
    ...
    {
      xmh.a(bool1);
      if ((localbchi != null) && (paramList != null)) {
        break label59;
      }
      return false;
      bool1 = false;
    ...
    new ArrayList();
    Object localObject;
    if (paramList.size() != localbchi.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size())
    {
      bool1 = bool2;
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool1)
        {
          localbchi.a(paramList, paramInt);
          b(localbchi.a(), paramInt);
        }
        return bool1;
      }
      finally {}
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          int k = arrayOfInt[i];
          Object localObject3 = (bchi)this.jdField_b_of_type_AndroidUtilSparseArray.get(k);
          xmh.a(localObject3);
          localObject3 = (TroopAIOAppInfo)((bchi)localObject3).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
          if (localObject3 != null)
          {
        ...
        {
          if (bool) {
            ThreadManager.post(new TroopAppMgr.5(this, localArrayList, localawbw), 8, null, false);
          }
          if (QLog.isColorLevel()) {
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    localbchi.jdField_b_of_type_Int = paramInt1;
  ...
  {
    int i = paramTroopAIOAppInfo.appid;
    bchi localbchi = (bchi)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramTroopAIOAppInfo.groupType);
    if (localbchi != null) {}
    for (boolean bool = true;; bool = false)
    {
      xmh.a(bool);
    ...
    if ((TroopAIOAppInfo)localbchi.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i)) != null) {
      return true;
    }
    localbchi.a(paramTroopAIOAppInfo.appid, paramTroopAIOAppInfo);
    return false;
  }
  ...
  public void c()
  {
    ...
    try
    {
      ...
      mzy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new bchn(this), localReqBody.toByteArray(), "OidbSvc.0xa1e", 2590, 0);
      return;
    }
    finally {}
  }
  ...
  public void onDestroy()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      while (i < j)
      {
        int k = arrayOfInt[i];
        a(false, k);
        bchi localbchi = (bchi)this.jdField_b_of_type_AndroidUtilSparseArray.get(k);
        xmh.a(localbchi);
        localbchi.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
        localbchi.a();
        localbchi.jdField_b_of_type_Int = 0;
        i += 1;
      }
      return;
    }
