...
public abstract class qxc
  ...
  implements View.OnClickListener, qoa, qxp
{
  private static final String jdField_a_of_type_JavaLangString = qxc.class.getSimpleName();
  public int a;
  public Activity a;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new qxe(this);
  private Handler jdField_a_of_type_AndroidOsHandler = new bfob(this.jdField_a_of_type_AndroidOsHandler$Callback);
  ...
  public qxc(View paramView, Activity paramActivity, int paramInt)
  {
    super(paramView);
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_e_of_type_AndroidViewViewGroup = ((ViewGroup)paramView.findViewById(2131364564));
    this.jdField_f_of_type_AndroidViewViewGroup = ((ViewGroup)paramView.findViewById(2131379015));
    ...
    this.jdField_b_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131364809));
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131363002));
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131363003);
    ...
    this.jdField_k_of_type_AndroidViewViewGroup = ((ViewGroup)paramView.findViewById(2131363356));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131364869));
    ...
    this.jdField_h_of_type_AndroidViewViewGroup = ((ViewGroup)paramView.findViewById(2131378944));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131379133));
    ...
    this.o = ((ViewGroup)paramView.findViewById(2131378967));
    this.jdField_m_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379040));
    this.jdField_l_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131366875));
    this.jdField_j_of_type_AndroidViewViewGroup = ((LinearLayout)paramView.findViewById(2131364271));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.getLayoutParams().height = bbll.b(50.0F);
    this.jdField_a_of_type_AndroidWidgetImageView.getLayoutParams().width = bbll.b(50.0F);
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365734));
    ...
    this.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131378966);
    this.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131370538);
    this.jdField_d_of_type_AndroidViewView.setAlpha(ope.a());
  ...
  private void a()
  {
    qoi.b(this.jdField_d_of_type_AndroidViewView, 8);
  ...
  {
    qyk localqyk = new qyk();
    localqyk.jdField_a_of_type_AndroidWidgetSeekBar = this.jdField_a_of_type_AndroidWidgetSeekBar;
    localqyk.jdField_b_of_type_AndroidWidgetSeekBar = this.jdField_b_of_type_AndroidWidgetSeekBar;
    localqyk.jdField_a_of_type_AndroidViewViewGroup = this.jdField_h_of_type_AndroidViewViewGroup;
    localqyk.jdField_a_of_type_AndroidWidgetTextView = this.jdField_c_of_type_AndroidWidgetTextView;
    localqyk.jdField_b_of_type_AndroidWidgetTextView = this.jdField_d_of_type_AndroidWidgetTextView;
    localqyk.jdField_a_of_type_ComTencentImageURLImageView = this.jdField_b_of_type_ComTencentImageURLImageView;
    localqyk.jdField_a_of_type_AndroidViewView = this.jdField_c_of_type_AndroidViewView;
    localqyk.jdField_c_of_type_AndroidWidgetTextView = this.jdField_g_of_type_AndroidWidgetTextView;
    localqyk.jdField_a_of_type_AndroidWidgetImageView = this.jdField_a_of_type_AndroidWidgetImageView;
    localqyk.jdField_b_of_type_AndroidViewViewGroup = this.jdField_g_of_type_AndroidViewViewGroup;
    localqyk.jdField_d_of_type_AndroidWidgetTextView = this.jdField_e_of_type_AndroidWidgetTextView;
    localqyk.jdField_e_of_type_AndroidWidgetTextView = this.jdField_f_of_type_AndroidWidgetTextView;
    localqyk.jdField_f_of_type_AndroidWidgetTextView = this.jdField_h_of_type_AndroidWidgetTextView;
    if ((this instanceof nzq))
    {
      this.jdField_a_of_type_Qyg = new nzr(new nzt(), localqyk, paramVideoFeedsPlayManager, false);
      return;
    }
    this.jdField_a_of_type_Qyg = new qyg(localqyk, paramVideoFeedsPlayManager, false);
  }
  
  private void a(VideoFeedsPlayManager paramVideoFeedsPlayManager, qkv paramqkv)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsGestureLayout.setVideoBrightnessController(paramqkv);
  }
  ...
  private boolean a(ImageView paramImageView, URL paramURL)
  {
    ...
    do
    {
      do
      {
        ...
        ((rph)localObject).jdField_a_of_type_Int = i2;
        ((rph)localObject).jdField_b_of_type_Int = i1;
  ...
  private void b(VideoInfo paramVideoInfo)
  {
    ...
    {
      this.jdField_a_of_type_Qql = new qql();
      this.jdField_a_of_type_Qql.jdField_a_of_type_Qjs = this.jdField_a_of_type_Qyg;
    }
    this.jdField_a_of_type_Qql.jdField_a_of_type_ComTencentBizPubaccountVideoInfo = paramVideoInfo;
    this.jdField_a_of_type_Qql.jdField_a_of_type_AndroidViewViewGroup = this.jdField_f_of_type_AndroidViewViewGroup;
    this.jdField_a_of_type_Qql.jdField_b_of_type_Int = this.jdField_a_of_type_Int;
    this.jdField_a_of_type_Qql.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Qql.jdField_a_of_type_AndroidOsBundle.putInt("video_feeds_index", this.jdField_a_of_type_Int);
    this.jdField_a_of_type_Qql.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_Qql.jdField_b_of_type_Boolean = true;
  }
  ...
  private void f()
  {
    if ((this.jdField_a_of_type_Qql != null) && (this.jdField_a_of_type_Qql.jdField_a_of_type_Qty != null)) {
      this.jdField_a_of_type_Qql.jdField_a_of_type_Qty.c();
    }
    ...
    if ((this.jdField_a_of_type_Qql != null) && (this.jdField_a_of_type_Qql.jdField_a_of_type_Qty != null)) {
      this.jdField_a_of_type_Qql.jdField_a_of_type_Qty.d();
    }
  }
  ...
  private void f(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidViewAnimationScaleAnimation.setAnimationListener(new qxd(this, paramBoolean));
    ...
    qoi.b(this.jdField_j_of_type_AndroidWidgetTextView, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.u, "赞");
  }
  ...
  private void g()
  {
    ...
    for (localLayoutParams.width = -1;; localLayoutParams.width = -1)
    {
      ...
      return;
      localLayoutParams.height = qxl.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo);
    }
  }
  ...
  private void g(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Qyg.a(true);
    this.jdField_a_of_type_Qyg.a();
  }
  ...
  private void h(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      qoi.a(this.jdField_h_of_type_AndroidViewViewGroup, 0);
      qoi.a(this.jdField_g_of_type_AndroidViewViewGroup, 0);
      if (!this.jdField_a_of_type_Boolean) {
        qoi.b(this.o, 0);
      }
    ...
    for (;;)
    {
      g(paramBoolean);
      return;
      qoi.a(this.jdField_h_of_type_AndroidViewViewGroup, 8);
      if (this.jdField_a_of_type_Qxr.a(this)) {
        qoi.a(this.jdField_g_of_type_AndroidViewViewGroup, 8);
      }
      qoi.b(this.o, 8);
  ...
  {
    this.jdField_a_of_type_Qyg.a(false);
  ...
  {
    if ((paramInt == 0) && (!this.jdField_a_of_type_Qxr.a(this))) {
      d(false);
    }
    while (ope.b() <= 0) {
      return;
  ...
  {
    if ((this.jdField_a_of_type_Boolean) || (!this.jdField_a_of_type_Qxr.a(this))) {
      return;
    }
    if (this.jdField_a_of_type_Qxr != null)
    {
      ...
      this.jdField_a_of_type_Qxr.a(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo, paramView[0] + paramInt1, paramView[1] + paramInt2);
    }
  ...
  public void a(VideoInfo paramVideoInfo)
  {
    ...
    if (bkvi.b())
    {
      if (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.b(this.jdField_a_of_type_AndroidAppActivity))
      {
        ...
        qxl.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_i_of_type_AndroidViewViewGroup);
      }
    }
    else {
      return;
    ...
    this.jdField_i_of_type_AndroidViewViewGroup.setPadding(0, 0, 0, 0);
    qxl.b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_i_of_type_AndroidViewViewGroup);
  }
  
  public void a(qxr paramqxr, qxo paramqxo, VideoFeedsPlayManager paramVideoFeedsPlayManager, qkv paramqkv)
  {
    this.jdField_a_of_type_Qxr = paramqxr;
    this.jdField_a_of_type_Qxo = paramqxo;
    a(paramVideoFeedsPlayManager);
    a(paramVideoFeedsPlayManager, paramqkv);
  }
  ...
  public void b()
  {
    qoi.b(this.jdField_i_of_type_AndroidWidgetTextView, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.e, "评论");
    ...
    qoi.b(this.jdField_a_of_type_AndroidWidgetTextView, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.f, "Biu");
    ...
    if ((this.jdField_a_of_type_AndroidViewViewGroup != null) && (!rlz.a().b())) {
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundDrawable(a(2130841323));
      if ((bkvi.b()) && (!this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.b(this.jdField_a_of_type_AndroidAppActivity))) {
        qxl.b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_k_of_type_AndroidViewViewGroup);
      }
    }
    for (;;)
    {
      ...
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundDrawable(a(2130841324));
      this.jdField_k_of_type_AndroidViewViewGroup.setPadding(0, 0, 0, 0);
    }
  }
  ...
  public void c()
  {
    qoi.a(this.jdField_d_of_type_AndroidViewView, 8, 0);
    d(true);
    ...
    ((ViewGroup.LayoutParams)localObject1).height = qxl.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo);
    ...
    if (localObject1 != null)
    {
      if ((this.jdField_a_of_type_Int != 0) || (!a(this.jdField_b_of_type_ComTencentImageURLImageView, (URL)localObject1)))
      {
        ...
        ((URLDrawable.URLDrawableOptions)localObject2).mRequestWidth = qoi.b(this.jdField_a_of_type_AndroidAppActivity)[0];
      ...
      qoi.a(this.jdField_b_of_type_ComTencentImageURLImageView, 0, 0);
    ...
    for (;;)
    {
      ...
      qoi.a(this.jdField_c_of_type_AndroidWidgetTextView, 0L);
      qoi.a(this.jdField_d_of_type_AndroidWidgetTextView, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a() * 1000);
      qoi.a(this.jdField_m_of_type_AndroidWidgetTextView, this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a() * 1000);
      this.jdField_g_of_type_AndroidViewViewGroup.setVisibility(0);
      this.jdField_a_of_type_Qyg.a(0);
      ...
      if (this.jdField_b_of_type_AndroidWidgetTextView != null) {
        this.jdField_b_of_type_AndroidWidgetTextView.setText(qxl.a(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.s));
      }
      ...
      ((URLDrawable)localObject1).setDecodeHandler(bavw.w);
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_Qxo.a(this.jdField_e_of_type_AndroidViewViewGroup, 0, new FrameLayout.LayoutParams(this.jdField_e_of_type_AndroidViewViewGroup.getLayoutParams()));
      return;
    }
    this.jdField_m_of_type_AndroidViewViewGroup.addView(this.jdField_e_of_type_AndroidViewViewGroup, this.jdField_c_of_type_Int);
  ...
  {
    qxc localqxc = (qxc)paramView.getTag();
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              return;
            } while (this.jdField_a_of_type_Qxr.a(this));
            this.jdField_a_of_type_Qxo.c(this.jdField_a_of_type_Int);
            return;
            if (this.jdField_a_of_type_Boolean)
            {
            ...
            this.jdField_a_of_type_Qxo.c();
            return;
            this.jdField_a_of_type_Qxo.d();
            return;
          } while (this.jdField_a_of_type_Qxr == null);
          this.jdField_a_of_type_Qxr.h();
          return;
        } while (this.jdField_a_of_type_Qxr == null);
        this.jdField_a_of_type_Qxr.i();
        return;
      } while (this.jdField_a_of_type_Qxr == null);
      this.jdField_a_of_type_Qxr.e(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo);
      return;
    }
    if (this.jdField_a_of_type_Qxr != null) {
      this.jdField_a_of_type_Qxr.f(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo);
    }
    f(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.l);
  }
}
