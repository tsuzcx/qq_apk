  ...
  implements Handler.Callback
{
  ...
  protected Handler a;
  protected View a;
  private ArrayList<bhyx> a;
  protected int b;
  protected String c;
  
  public bhyx(View paramView)
  {
  ...
  public bhyx(String paramString, View paramView)
  {
    this(paramView);
    this.c = paramString;
  }
  ...
  public ViewGroup.LayoutParams a(JSONObject paramJSONObject, bhyx parambhyx)
  {
    ...
    parambhyx.a((ViewGroup.LayoutParams)localObject1, paramJSONObject);
    return localObject1;
  }
  
  public bhyx a(String paramString)
  {
    bhyx localbhyx2 = null;
    bhyx localbhyx1 = localbhyx2;
    if (!TextUtils.isEmpty(this.c))
    {
      if (this.jdField_a_of_type_JavaUtilArrayList != null) {
        break label25;
      }
      localbhyx1 = localbhyx2;
    }
    label25:
    do
    {
      ...
      localbhyx2 = (bhyx)localIterator.next();
      if (localbhyx2 == null) {
        break label110;
      }
      localbhyx2 = localbhyx2.a(paramString);
      localbhyx1 = localbhyx2;
    } while (localbhyx2 != null);
    localbhyx1 = localbhyx2;
    label110:
    for (;;)
    {
  ...
  public void a(bhyx parambhyx)
  {
    ...
    this.jdField_a_of_type_JavaUtilArrayList.add(parambhyx);
  }
  ...
  public void c()
  {
    ...
    while (localIterator.hasNext())
    {
      bhyx localbhyx = (bhyx)localIterator.next();
      if (localbhyx != null) {
        localbhyx.c();
      }
    }
