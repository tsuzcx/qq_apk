...
public class ajuj
{
  public static Comparator<aukm> a = new ajuk();
  ...
  public static ArrayList<aukm> a(ArrayList<aukm> paramArrayList, aukm paramaukm)
  {
    ...
    {
      paramArrayList.add(paramaukm);
      return paramArrayList;
    }
    Groups localGroups1 = (Groups)paramaukm;
    int j = 0;
    ...
    paramArrayList.add(i + 1, paramaukm);
    return paramArrayList;
  }
