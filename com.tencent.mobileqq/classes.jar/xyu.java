  ...
  implements View.OnClickListener
{
  ...
  public xyu(TroopAddFrdsInnerFrame paramTroopAddFrdsInnerFrame)
  {
    ...
    paramTroopAddFrdsInnerFrame.b = paramTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getResources().getDimensionPixelOffset(2131559381);
    paramTroopAddFrdsInnerFrame.c = paramTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getResources().getDimensionPixelOffset(2131559382);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130970277, paramViewGroup, false);
      paramView = new TroopAddFrdsInnerFrame.AddFrdHolder();
      paramView.jdField_a_of_type_AndroidViewView = localView.findViewById(2131363900);
      paramView.jdField_a_of_type_AndroidViewView.setId(2131362460);
      paramViewGroup = localView.findViewById(2131369903);
      localObject2 = (RelativeLayout.LayoutParams)paramViewGroup.getLayoutParams();
      ((RelativeLayout.LayoutParams)localObject2).addRule(0, 2131362460);
      ...
      paramView.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131366518));
      paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131369905));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131362876));
      paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131369907));
      paramView.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131368907));
      paramView.d = ((TextView)localView.findViewById(2131368908));
      paramView.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)localView.findViewById(2131368425));
      paramView.e = ((TextView)localView.findViewById(2131363914));
      paramView.jdField_b_of_type_AndroidViewView = localView.findViewById(2131369895);
      ...
      {
        localView.findViewById(2131362460).setPadding(0, 0, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.b, 0);
    ...
    for (;;)
    {
      ...
      {
        localAddFrdHolder.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.getResources().getString(2131435498, new Object[] { Integer.valueOf(((TroopMemberInfo)localObject2).commonFrdCnt) }));
      ...
      for (;;)
      {
        ...
        if (paramInt != 0)
        {
          ...
          localView.setBackgroundResource(2130838581);
        ...
        for (paramInt = i;; paramInt = 8)
        {
          ...
          return localView;
          localView.findViewById(2131362460).setPadding(0, 0, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.c, 0);
          break;
          label1039:
          localAddFrdHolder.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
          break label485;
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.f == TroopAddFrdsInnerFrame.d)
        {
          ...
          localAddFrdHolder.e.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131435980), new Object[] { paramView.toLowerCase() }));
          return localView;
        }
        localAddFrdHolder.e.setVisibility(8);
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      for (;;)
      {
        notifyDataSetChanged();
        return;
        this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.d(paramView.jdField_a_of_type_ComTencentMobileqqDataTroopMemberInfo.memberuin);
    ...
    ((Bundle)localObject).putString("selfSet_leftViewText", this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131433092));
    ((Bundle)localObject).putString("custom_leftbackbutton_name", this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131433681));
