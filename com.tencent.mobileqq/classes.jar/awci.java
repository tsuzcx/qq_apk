...
public class awci
{
  ...
  public static Pair<Integer, Bitmap> a(String paramString1, String paramString2, awah paramawah, int paramInt)
  {
    localObject1 = null;
    k = 0;
    ...
    for (;;)
    {
      ...
      {
        Object localObject2;
        if ((paramawah == null) || (paramawah.b)) {
          break label519;
        }
        paramawah.b = true;
        if ((paramInt == 1) && (paramawah.c)) {
          break label519;
        }
        localObject1 = a(paramString1, paramString2, paramawah, paramInt);
        paramawah = (Bitmap)((Pair)localObject1).second;
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      catch (Exception paramawah)
      {
        ...
        QLog.d("Q.olympic", 2, "decodeBitmap Exception:" + paramawah.toString() + ",filePath:" + paramString2);
        paramawah = null;
        localObject1 = null;
        int i = 1;
        int j = 0;
      ...
      catch (Exception paramString1)
      {
        ...
        paramawah = (awah)localObject1;
        localObject1 = localObject3;
        continue;
      }
      paramString1 = new Pair(Integer.valueOf(paramInt), paramawah);
      if (QLog.isColorLevel())
      {
        if (paramawah != null) {
          continue;
