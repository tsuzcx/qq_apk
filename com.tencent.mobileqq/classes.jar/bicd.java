  ...
  implements Manager
{
  ...
  public static HashMap<String, bich> a;
  public static String[] a;
  bhyn jdField_a_of_type_Bhyn = new bice(this);
  ...
  public bicd(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3)
  {
    ...
    //   12: istore_0
    //   13: getstatic 24	bicd:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   16: aload_1
    //   17: invokevirtual 75	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   20: checkcast 77	bich
    //   23: astore 7
    //   25: aload 7
    //   27: ifnull +88 -> 115
    //   30: aload 7
    //   32: getfield 80	bich:jdField_a_of_type_Bici	Lbici;
    //   35: ifnull +84 -> 119
    //   38: aload_1
    //   39: aload_2
    //   40: iload_3
    //   41: invokestatic 85	bicj:a	(Ljava/lang/String;Ljava/lang/String;I)V
    //   44: aload 7
    //   46: getfield 80	bich:jdField_a_of_type_Bici	Lbici;
    //   49: aload_1
    //   50: iload 4
    //   52: iload_0
    ...
    //   107: getstatic 24	bicd:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   110: aload_1
    ...
    //   119: aload 7
    //   121: iconst_1
    //   122: putfield 118	bich:jdField_a_of_type_Boolean	Z
    //   125: aload 7
    //   127: iload_0
    //   128: putfield 121	bich:jdField_a_of_type_Int	I
    //   131: goto -16 -> 115
    //   134: astore_1
    //   135: ldc 2
    //   137: monitorexit
  ...
  public static void a(Context paramContext, bica parambica, String paramString, bibz parambibz)
  {
    if ((bich)jdField_a_of_type_JavaUtilHashMap.get(parambica.jdField_a_of_type_JavaLangString) == null) {
      b(paramContext, parambica, paramString, parambibz);
    }
    ((bich)jdField_a_of_type_JavaUtilHashMap.get(parambica.jdField_a_of_type_JavaLangString)).jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.c();
  }
  
  public static void a(Context paramContext, bica parambica, String paramString, bibz parambibz, bicf parambicf)
  {
    bich localbich = (bich)jdField_a_of_type_JavaUtilHashMap.get(parambica.jdField_a_of_type_JavaLangString);
    if (localbich != null) {
      localbich.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.jdField_a_of_type_Boolean = false;
    }
    localbich = new bich();
    localbich.jdField_a_of_type_Bica = parambica;
    localbich.jdField_a_of_type_Bicf = parambicf;
    localbich.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread = new QQVoiceChangerThread(paramContext, parambica, parambicf, paramString, parambibz);
    jdField_a_of_type_JavaUtilHashMap.put(parambica.jdField_a_of_type_JavaLangString, localbich);
    localbich.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.start();
  }
  ...
  public static void a(bica parambica)
  {
    ...
    if (localbich != null)
    {
      localbich.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.d();
      jdField_a_of_type_JavaUtilHashMap.remove(parambica.jdField_a_of_type_JavaLangString);
    }
  }
  
  public static boolean a(String paramString, bici parambici)
  {
    for (;;)
    {
      try
      {
        ...
        bich localbich = (bich)jdField_a_of_type_JavaUtilHashMap.get(paramString);
        if (localbich == null)
        {
          if (QLog.isColorLevel()) {
        ...
        if (localbich.jdField_a_of_type_Boolean)
        {
          bicj.a(paramString, localbich.jdField_a_of_type_Bica.jdField_a_of_type_JavaLangString, localbich.jdField_a_of_type_Bica.f);
          jdField_a_of_type_JavaUtilHashMap.remove(paramString);
          parambici.onCompressFinished(paramString, localbich.jdField_a_of_type_Bica.e, localbich.jdField_a_of_type_Int);
          if (QLog.isColorLevel()) {
            QLog.d("VoiceChangeManager", 2, "queryStateByPath onCompressFinished filePath=" + paramString + " time=" + localbich.jdField_a_of_type_Int + " voiceType=" + localbich.jdField_a_of_type_Bica.e);
          }
        }
        else
        {
          localbich.jdField_a_of_type_Bici = parambici;
        }
      }
      finally {}
      boolean bool = true;
  ...
  public static void b(Context paramContext, bica parambica, String paramString, bibz parambibz)
  {
    a(paramContext, parambica, paramString, parambibz, bicf.a());
  }
  
  public static void b(bica parambica)
  {
    bich localbich = (bich)jdField_a_of_type_JavaUtilHashMap.get(parambica.jdField_a_of_type_JavaLangString);
    if (localbich != null)
    {
  ...
  public boolean a(ArrayList<bicb> paramArrayList, JSONObject paramJSONObject)
  {
    boolean bool = bibh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), "VoiceChangeManager", false);
    if (!bool)
    {
      ...
      if (i < arrayOfInt.length)
      {
        if (arrayOfInt[i] == j)
        {
          ...
          if (i < 0)
          {
            ...
            break label1363;
            this.jdField_a_of_type_Bhyn.onDone(null);
            return true;
          }
        }
        else
        ...
        paramJSONObject = (bicb)paramArrayList.get(i);
        label687:
        if (paramJSONObject == null)
        {
          if (!QLog.isColorLevel()) {
        ...
        if (j != 0)
        {
          ...
          {
            i = j;
            if (bhnm.a(((JSONObject)localObject2).getString("QQVersion"), "8.4.10"))
            {
              j = 0;
              i = j;
              if (QLog.isColorLevel())
        ...
        for (localObject2 = paramJSONObject.jdField_b_of_type_JavaLangString;; localObject2 = ((JSONObject)localObject4).getString("description"))
        {
          ...
          paramJSONObject.jdField_a_of_type_Bicc.jdField_a_of_type_JavaLangString = ((String)localObject3);
          break label1363;
          localObject3 = bhln.jdField_b_of_type_JavaLangString + (String)localObject3;
      ...
      for (;;)
      {
        if (i < paramJSONObject.length)
        {
          ...
          if (localObject1 != null)
          {
            ...
            {
              localObject1 = bhln.jdField_b_of_type_JavaLangString + (String)localObject1;
