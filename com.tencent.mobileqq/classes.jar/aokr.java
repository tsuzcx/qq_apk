...
public class aokr
{
  private AudioManager.OnAudioFocusChangeListener jdField_a_of_type_AndroidMediaAudioManager$OnAudioFocusChangeListener = new aoks(this);
  private AudioManager jdField_a_of_type_AndroidMediaAudioManager;
  private aokt jdField_a_of_type_Aokt;
  private bbly jdField_a_of_type_Bbly;
  private BaseActivity jdField_a_of_type_ComTencentMobileqqAppBaseActivity;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  
  public aokr(aokt paramaokt, BaseActivity paramBaseActivity)
  {
    this.jdField_a_of_type_Aokt = paramaokt;
  ...
  public boolean a(String arg1)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if (!apvd.a(???))
        {
          str = ayph.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getCurrentAccountUin(), MD5.toMD5(???), 23, null);
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      this.jdField_a_of_type_Bbly = new bbly(str, new Handler(), 1);
      this.jdField_a_of_type_Bbly.b();
      this.jdField_a_of_type_Bbly.a(this.jdField_a_of_type_Aokt);
