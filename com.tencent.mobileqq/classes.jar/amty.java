  ...
  implements amkw
{
  ...
  public amty(int paramInt, amug paramamug)
  {
    this.jdField_a_of_type_Int = paramInt;
    this.b = ("cmshow_script_" + paramInt + ".js");
    this.jdField_a_of_type_Amug = paramamug;
    if ((paramamug != null) && (paramamug.a() != null)) {
      this.jdField_a_of_type_Amul = ((amul)paramamug.a().getManager(249));
    }
  ...
  {
    String str = amzq.b(paramString, paramQQAppInterface);
    ...
    amuh.a(paramQQAppInterface, str, new amub(this, paramBoolean, paramQQAppInterface, paramString, paramInt1, paramArrayOfInt, paramInt2));
  }
  ...
  public amkg a()
  {
    ...
    return this.jdField_a_of_type_Amug.a();
  }
  ...
  {
    if ((TextUtils.isEmpty(paramString)) || (this.jdField_a_of_type_Amug == null)) {
    ...
    {
      return;
      localamkg = this.jdField_a_of_type_Amug.a();
    } while (localamkg == null);
    localamkg.runRenderTask(new SpriteAioScript.1(this, paramString, localamkg, paramInt, paramBoolean));
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          localObject = amzq.a(paramString, a(), false);
        } while ((localObject == null) || (localObject.length != 2));
        i = ((Integer)localObject[0]).intValue();
        localObject = (int[])localObject[1];
      } while ((localObject == null) || (localObject.length == 0));
      if (2 != ((amhd)localQQAppInterface.getManager(153)).b(paramString)) {
        break;
      }
    } while (!paramBoolean);
    a(localQQAppInterface, paramString, i, (int[])localObject, 0);
    return;
    amuh.a(localQQAppInterface, paramString, i, (int[])localObject, new amtz(this, paramBoolean));
  }
  ...
  public void a(boolean paramBoolean, QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int[] paramArrayOfInt, int paramInt2)
  {
    ...
    Object localObject = amzq.a(paramString, i, a(), false);
    i = ((Integer)localObject[0]).intValue();
    ...
    amuh.b(paramQQAppInterface, paramString, i, (int[])localObject, new amua(this, paramBoolean, paramInt1, paramArrayOfInt));
  }
  ...
  public boolean b()
  {
    try
    {
      ...
      if (!localFile.exists())
      {
        ...
        if (TextUtils.isEmpty(ancb.au)) {
          anaw.a(this.jdField_a_of_type_Amug.a(), 300, 202, new Object[] { "Fail to read script file:", str });
        } else {
          anaw.a(this.jdField_a_of_type_Amug.a(), 300, 200, new Object[] { "Fail to read script file:", str });
        }
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      ...
      anaw.a(this.jdField_a_of_type_Amug.a(), 300, 150, new Object[] { "loadScript:", localOutOfMemoryError });
      return false;
      if (!a(localOutOfMemoryError))
      {
        anaw.a(this.jdField_a_of_type_Amug.a(), 300, 201, new Object[] { "Fail to verify script file:", localOutOfMemoryError });
        return false;
      }
    ...
    catch (Throwable localThrowable)
    {
      ...
      anaw.a(this.jdField_a_of_type_Amug.a(), 300, 30, new Object[] { "loadScript:", localThrowable });
      return false;
    }
    return false;
  }
