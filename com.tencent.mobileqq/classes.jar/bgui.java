...
public class bgui
{
  ...
  private Intent a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (paramActivity == null)
      {
        ...
        paramBundle.putExtras(bgtq.a(paramBundle, 1));
      }
    ...
    str1 = bbdh.a(paramActivity).a;
    String str2 = bgwk.a(paramActivity);
    if (l2 != 0L) {}
    for (paramBundle = String.valueOf(l2);; paramBundle = "")
    {
      bgwi.a(str1, str2, "2198", paramBundle, "2", "");
      paramActivity = a(paramActivity);
  ...
  private View a()
  {
    ...
    localTextView.setText(2131693979);
    localTextView.setTextColor(-16777216);
    localTextView.setGravity(17);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, -2);
    localLayoutParams.addRule(13);
    localTextView.setPadding(0, baxn.a(this.jdField_a_of_type_AndroidAppActivity, 120.0F), 0, 0);
    localRelativeLayout.addView(localTextView, localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView = localTextView;
    bguq.a().a(this.jdField_a_of_type_AndroidAppActivity, localImageView);
  ...
  {
    boolean bool = bgvn.a();
    bgwf.e("ReaderSplashImpl", "jumpToPlugin: isUseShadow = " + bool);
    if (bool)
    {
      bgvn.a(this.jdField_a_of_type_AndroidAppActivity, paramIntent, "com.qqreader.pureader.SSReaderActivity", new bgul(this));
      return;
    }
  ...
  private void a(View paramView)
  {
    ...
    {
      bgwf.a("ReaderSplashImpl", "showLoadingView: mContentView == null");
      return;
    }
  ...
  private void a(JsCallParams paramJsCallParams)
  {
    if (bgtw.a().a())
    {
      ReaderJsPluginProxy localReaderJsPluginProxy = bgtw.a().a(new bguk(this));
      ...
      for (;;)
      {
        d();
        return;
        bgwf.a("ReaderSplashImpl", "checkPluginForHandleSpecialJsCall: plugin is ready but jsPluginProxy is null");
      }
    }
  ...
  private void b(@NonNull Bundle paramBundle)
  {
    if (this.jdField_a_of_type_AndroidAppActivity == null) {
      bgwf.a("ReaderSplashImpl", "doJump: activity is null");
    }
    Intent localIntent;
    do
    {
    ...
    localIntent.putExtra("login_interval", bgwk.a(BaseApplicationImpl.getApplication()));
  ...
  private void c()
  {
    ...
    {
      bgwf.a("ReaderSplashImpl", "handlePendingJumpPluginIntent: mPendingJumpPluginIntent == null");
      return;
    }
    ...
    {
      bgwf.b("ReaderSplashImpl", "handlePendingJumpPluginIntent: activity is destroyed");
      return;
    }
    bgtq.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidContentIntent, "com.qqreader.pureader.SSReaderActivity", new bgum(this));
  ...
  public void a()
  {
    bgwf.d("ReaderSplashImpl", "onCreate");
    ...
    {
      this.jdField_a_of_type_Bgun = new bgun(this, null);
      this.jdField_a_of_type_AndroidAppActivity.registerReceiver(this.jdField_a_of_type_Bgun, (IntentFilter)localObject);
    }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Bgun != null)
    {
      this.jdField_a_of_type_AndroidAppActivity.unregisterReceiver(this.jdField_a_of_type_Bgun);
