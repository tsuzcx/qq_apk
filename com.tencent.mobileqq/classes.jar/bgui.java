...
{
  private static Singleton<bgui, Void> jdField_a_of_type_ComTencentWeiyunUtilsSingleton = new bguj();
  private long jdField_a_of_type_Long = 1L;
  private ConcurrentHashMap<Integer, bguk> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
  
  public static bgui a()
  {
    return (bgui)jdField_a_of_type_ComTencentWeiyunUtilsSingleton.get(null);
  }
  ...
  private void a(int paramInt, String paramString, byte[] paramArrayOfByte)
  {
    ...
    {
      paramArrayOfByte = new bgug(i, paramArrayOfByte);
      ...
      paramString.putWupBuffer(bguh.a(paramArrayOfByte));
      paramString.extraData.putInt("sequence", paramInt);
      paramString.extraData.putLong("sendtimekey", System.currentTimeMillis());
      paramArrayOfByte = new NewIntent(localAppRuntime.getApplication(), bgul.class);
  ...
  void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      localbgug = bguh.a(paramFromServiceMsg.getWupBuffer());
      label53:
    ...
    {
      label99:
      bguk localbguk = (bguk)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Integer.valueOf(k));
      if (localbguk != null) {
        if (localbgug != null) {
          break label196;
        }
      }
      for (paramFromServiceMsg = localObject;; paramFromServiceMsg = localbgug.a())
      {
        localbguk.a(i, paramToServiceMsg, paramFromServiceMsg);
        return;
        ...
        localbgug = null;
        break label53;
        paramFromServiceMsg = localbgug.a();
  ...
  public void a(String paramString, byte[] paramArrayOfByte, bguk parambguk)
  {
    int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
    if (parambguk != null) {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(i), parambguk);
    }
