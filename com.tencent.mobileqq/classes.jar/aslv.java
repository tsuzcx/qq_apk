...
public class aslv
{
  ...
  public aslv(AppInterface paramAppInterface)
  {
  ...
  public void a(long paramLong1, long paramLong2, int paramInt1, int paramInt2, boolean paramBoolean, asmc paramasmc)
  {
    ...
    for (paramInt2 = 1;; paramInt2 = 2)
    {
      ...
      mmj.a(this.a, new asma(this, paramasmc), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
    }
  }
  
  public void a(long paramLong, String paramString, asmc paramasmc)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      mmj.a(this.a, new asmb(this, paramasmc), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
    }
  }
  
  public void a(String paramString, asmc paramasmc)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      mmj.a(this.a, new aslx(this, paramasmc), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
    }
  }
  
  public void a(String paramString, asmc paramasmc, Bundle paramBundle)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      mmj.a(this.a, new aslw(this, paramasmc), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, paramBundle, 0L);
    }
  }
  
  public void b(String paramString, asmc paramasmc)
  {
    ...
    if (a(localReqBody))
    {
      ...
      mmj.a(this.a, new aslz(this, paramString, paramasmc), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
    }
  }
  
  public void b(String paramString, asmc paramasmc, Bundle paramBundle)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      mmj.a(this.a, new asly(this, paramasmc), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, paramBundle, 0L);
    }
  }
}
