...
public abstract class kwt
{
  ...
  protected kwt(VideoAppInterface paramVideoAppInterface)
  {
  ...
  {
    if ((paramInt >= 0) && (paramInt < 13) && (paramInt < jdField_a_of_type_ArrayOfJavaLangString.length))
    {
      String str = "Business_" + jdField_a_of_type_ArrayOfJavaLangString[paramInt];
      paramContext = baig.b(paramContext).edit();
      paramContext.putBoolean(str, paramBoolean);
      paramContext.commit();
      krx.e(paramString, "setPreload zzzzz  bid=" + paramInt);
      return;
    }
    krx.e(paramString, "setPreload ERROR : bid=" + paramInt);
  }
  ...
  static boolean a(String paramString, VideoAppInterface paramVideoAppInterface, int paramInt)
  {
    ...
    {
      String str = "Business_" + jdField_a_of_type_ArrayOfJavaLangString[paramInt];
      boolean bool = baig.b(paramVideoAppInterface.getApplication()).getBoolean(str, false);
      krx.c(paramString, "isPreloaded:" + str + "|" + bool);
      return bool;
    }
    krx.e(paramString, "isPreloaded ERROR : bid=" + paramInt);
    return false;
  }
