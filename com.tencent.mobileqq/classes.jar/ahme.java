  ...
  public static final void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, short paramShort, msg_comm.Msg paramMsg, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (localObject1 = "0xbc";; localObject1 = "0xbd")
      {
        ...
        localObject1 = String.format(alud.a(2131707888), new Object[] { paramMsg });
        ...
        localPushPlatform.str_title.set(alud.a(2131707890));
        ...
        ((atzz)paramQQAppInterface.getManager(284)).a((SubMsgType0x27.MsgBody)localObject2, (short)(a.getAndIncrement() % 32767), paramInt);
        return;
        if (!bool2)
        {
