...
public class bcxk
{
  private static bcxk jdField_a_of_type_Bcxk;
  private String jdField_a_of_type_JavaLangString;
  private ConcurrentLinkedQueue<bcxl> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue = new ConcurrentLinkedQueue();
  ...
  public static bcxk a()
  {
    try
    {
      if (jdField_a_of_type_Bcxk == null) {
        jdField_a_of_type_Bcxk = new bcxk();
      }
      bcxk localbcxk = jdField_a_of_type_Bcxk;
      return localbcxk;
    }
    finally {}
  }
  ...
  private String a(String paramString)
  {
    try
    {
      ...
      if (localFile.exists())
      {
        ...
        paramString = bfmv.a(paramString);
        return paramString;
      }
    }
  ...
  private String b(PackageInfo paramPackageInfo)
  {
    ...
    return bfko.a(paramPackageInfo);
  }
  ...
  private void c()
  {
    ...
    try
    {
      ...
      localSharedInfoPacket.qq_version.set(a("8.3.0"));
      if (QLog.isColorLevel()) {
        QLog.d("SecShare.AV", 2, String.format("Version = %s intVersion= 0x%x", new Object[] { "8.3.0", Integer.valueOf(a("8.3.0")) }));
      }
      if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.isEmpty()) {
        break label561;
      }
      localSendInfo = new SecSharedInfo.SendInfo();
      localObject1 = (bcxl)this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.poll();
      i = ((bcxl)localObject1).a();
      localObject3 = ((bcxl)localObject1).a();
      str3 = ((bcxl)localObject1).b();
      j = ((bcxl)localObject1).b();
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          localObject2 = bflg.a((String)localObject3);
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.offer(new bcxl(paramInt1, paramString1, paramInt2, paramString2));
  }
