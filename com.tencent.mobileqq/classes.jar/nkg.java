  ...
  implements View.OnClickListener
{
  ...
  protected ArrayList<nkd> a;
  protected ndl a;
  protected nju a;
  protected nkh a;
  protected boolean a;
  
  public nkg(Context paramContext, nju paramnju)
  {
  ...
  private View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      paramViewGroup = (AddMemberItemView)this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558767, null);
  ...
  private View b(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        nkd localnkd = (nkd)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
        if ((paramView == null) || (!(paramView instanceof MemberItemView)))
        {
          paramView = (MemberItemView)this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558769, null);
          paramView.a();
          paramView.setOnClickListener(this);
          localView = paramView;
          paramViewGroup = paramView;
          paramViewGroup.a(this.jdField_a_of_type_Ndl, localnkd, this.jdField_a_of_type_Nju);
          return localView;
        }
      }
      finally {}
  ...
  private View c(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      paramView = (EmptyMemberItemView)this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558768, null);
      paramView.a();
    }
    for (;;)
    {
  ...
  public void a(List<nkd> paramList, boolean paramBoolean)
  {
  ...
  public void a(nkh paramnkh)
  {
    this.jdField_a_of_type_Nkh = paramnkh;
  }
  ...
  public void onClick(View paramView)
  {
    if ((paramView instanceof MemberItemView))
    {
      ...
      if (this.jdField_a_of_type_Nkh != null) {
        this.jdField_a_of_type_Nkh.a(localMemberItemView.a);
      }
    }
    for (;;)
    {
      ...
      return;
      if (((paramView instanceof AddMemberItemView)) && (this.jdField_a_of_type_Nkh != null)) {
        this.jdField_a_of_type_Nkh.a();
      }
    }
  }
}
