  ...
  extends apbm
{
  ...
  protected void a(int paramInt, String paramString)
  {
    ...
    apbi.b(this.jdField_a_of_type_Apbi, 11, 12);
    apbi.c(this.jdField_a_of_type_Apbi, 11, 12);
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_Apbi.jdField_a_of_type_Long + "] state change :(" + this.jdField_a_of_type_Apbm.a() + "->StateExcepInvalidWhenChangeToOff");
