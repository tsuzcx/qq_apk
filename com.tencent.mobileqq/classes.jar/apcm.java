...
final class apcm
  implements apdl
{
  apcm(QQAppInterface paramQQAppInterface, int paramInt) {}
  ...
  public long a(String paramString1, int paramInt1, String paramString2, int paramInt2, String paramString3, String paramString4, String paramString5, long paramLong1, int paramInt3, long paramLong2, int paramInt4)
  {
    ...
    {
      localDataLineMsgRecord.thumbPath = apdh.a(apdh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()), apck.a(paramString5));
      bace.d(paramString5, localDataLineMsgRecord.thumbPath);
    }
    ...
    for (localDataLineMsgRecord.nOpType = 29;; localDataLineMsgRecord.nOpType = 31)
    {
      ...
      paramString1 = (ajgm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8);
      ...
      ((ajrm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(localDataLineMsgRecord);
      localDataLineMsgRecord.time = awao.a();
      localDataLineMsgRecord.progress = 0.2F;
      localDataLineMsgRecord.fileMsgStatus = 0L;
      localDataLineMsgRecord.msgtype = ajgm.a(0);
      ...
      paramString1.a(7, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf((byte)ajgm.b(localDataLineMsgRecord.msgtype)), Boolean.valueOf(false), Boolean.valueOf(false), Long.valueOf(localDataLineMsgRecord.filesize) });
