...
public class qza
{
  ...
  private static volatile qza jdField_a_of_type_Qza;
  public final boolean a;
  private final String jdField_b_of_type_JavaLangString = nvf.a("3980") + "3980";
  ...
  public static qza a()
  {
    if (jdField_a_of_type_Qza == null) {}
    try
    {
      if (jdField_a_of_type_Qza == null) {
        jdField_a_of_type_Qza = new qza();
      }
      return jdField_a_of_type_Qza;
    }
    finally {}
  }
  ...
  private boolean b()
  {
    ...
    boolean bool1 = FileUtils.fileExists((String)localObject);
    boolean bool2 = qze.a(str);
    jdField_a_of_type_JavaLangString = qze.b(str);
