...
public class awhb
  implements aysa
{
  public awhb(ScribbleResMgr.4 param4) {}
  
  public void onResp(aysx paramaysx)
  {
    int j = 2;
    if (QLog.isColorLevel()) {
      QLog.i("ScribbleResMgr", 2, "onResp  mResult: " + paramaysx.jdField_a_of_type_Int + " url:" + this.a.a.sourceUrl);
    }
    int i = j;
    Object localObject;
    String str1;
    ...
    for (i = 0;; i = 1)
    {
      ...
      {
        j = i;
        localObject = (ayxq)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(193);
        i = j;
        if (((ayxq)localObject).a())
        {
          ((ayxq)localObject).a(this.a.a.sourceUrl, paramaysx.jdField_a_of_type_Long);
          i = j;
        }
