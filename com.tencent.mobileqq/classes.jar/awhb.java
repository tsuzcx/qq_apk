...
public class awhb
  extends Handler
{
  public awhb(ScribbleResMgr paramScribbleResMgr, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        Object localObject = (awhf)localIterator.next();
        if (localObject != null)
        {
          View localView = ((awhf)localObject).a();
          localObject = ((awhf)localObject).a();
          if ((localView != null) && (localObject != null)) {
            ((awhg)localObject).a(localView, paramMessage.arg1, (ScribbleResMgr.ResInfo)paramMessage.obj, paramMessage.what);
          } else {
