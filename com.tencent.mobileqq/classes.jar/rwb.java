  ...
  implements rwh
{
  public void a()
  {
    Object localObject = rwa.a("http://viola/viola_config.json?v_bid=3192");
    if (!TextUtils.isEmpty((CharSequence)localObject)) {
      try
      {
        ...
        {
          rwa.a((String)localJSONArray.get(i), null);
          i += 1;
        }
        ...
        if (((JSONObject)localObject).has("use_main")) {
          rwa.jdField_a_of_type_Boolean = ((Boolean)((JSONObject)localObject).get("use_main")).booleanValue();
        }
