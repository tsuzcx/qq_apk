...
public class rwb
{
  ...
  public static DownloadInfo a(String paramString)
  {
    ...
    try
    {
      ...
      for (int i = TMAssistantDownloadConst.SHOW_NOTIFICATION_TRUE;; i = TMAssistantDownloadConst.SHOW_NOTIFICATION_FALSE)
      {
        ...
        localDownloadInfo.m = obz.f(40677);
  ...
  public static void b(Context paramContext, String paramString)
  {
    ...
    if (a != null)
    {
      ...
      paramContext.setMessage(ajjy.a(2131650428));
      paramContext.setNegativeButton(ajjy.a(2131650416), new rwd()).setPositiveButton(ajjy.a(2131650372), new rwc());
      paramContext.show();
      return;
    }
