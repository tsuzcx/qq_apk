  ...
  implements BadcaseReportUtils.ReportItemData
{
  ...
  {
    if (paramBoolean) {}
    for (BadcaseReportUtils.ENABLE_REPORT = axkr.h();; BadcaseReportUtils.ENABLE_REPORT = false)
    {
      BadcaseReportUtils.sTotalReportNumber = axkr.c();
      if (QLog.isColorLevel()) {
  ...
  {
    Object localObject = new StringBuilder(ahwa.a);
