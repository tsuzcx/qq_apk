  ...
  extends aoki
{
  ...
  public void a(boolean paramBoolean, FaceInfo paramFaceInfo)
  {
    ...
    if ((this.a.jdField_a_of_type_Aoki != null) && (this.a.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface != null)) {
      this.a.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.removeObserver(this.a.jdField_a_of_type_Aoki);
    }
    if (paramBoolean)
    {
