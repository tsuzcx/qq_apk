...
public class aoko
{
  ...
  public aoko(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = paramMessageRecord;
    this.jdField_a_of_type_Boolean = paramQQAppInterface.n();
    this.b = bhhv.a(paramQQAppInterface.getApp().getApplicationContext(), paramQQAppInterface);
    this.c = b(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
    this.d = bhhv.b(paramQQAppInterface.getApp().getApplicationContext(), paramQQAppInterface);
  ...
  private void a(int paramInt)
  {
    ...
    while (j < k)
    {
      ((aokn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.jdField_a_of_type_JavaUtilList.get(j)).b(paramInt);
      j += 1;
    }
  }
  ...
  private void a(MessageRecord paramMessageRecord)
  {
    ...
    for (int j = 0;; j = localAudioManager.getStreamVolume(2))
    {
      ...
      if (localaqqr != null)
      {
        if (!aqqr.a(paramMessageRecord)) {
          break;
        }
        localaqqr.b(paramMessageRecord);
      }
      return;
    }
    localaqqr.b();
  ...
  private void c(MessageRecord paramMessageRecord, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    boolean bool1;
    boolean bool2;
    if ((paramMessageRecord != null) && (localaqqr != null))
    {
      boolean bool3 = localaqqr.b(paramMessageRecord.frienduin, paramMessageRecord.istroop);
      boolean bool4 = localaqqr.a(paramMessageRecord.senderuin);
      bool1 = bool4;
      bool2 = bool3;
      if (QLog.isColorLevel())
      {
    ...
    for (;;)
    {
      ...
      if (((paramBoolean1) && (bool2) && (bool1)) || (bidn.a(paramMessageRecord))) {
        localaqqr.b(paramMessageRecord);
      }
      return;
      bool1 = false;
  ...
  void a(MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    if (localaqqr != null)
    {
      ...
      if (paramMessageRecord != null) {
        bool1 = localaqqr.b(this.h, paramMessageRecord.frienduin, paramMessageRecord.istroop);
      }
    }
    if (QLog.isColorLevel()) {
  ...
  void a(MessageRecord paramMessageRecord, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localObject = aqqr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    ...
    if (localObject != null)
    {
      bool1 = bool2;
      if (paramMessageRecord != null) {
        bool1 = ((aqqr)localObject).a(this.i, paramMessageRecord.frienduin, paramMessageRecord.istroop);
      }
    }
    ...
    if (paramMessageRecord != null)
    {
      ...
      if (paramMessageRecord.istroop == 1001)
      {
        ...
        if (!asbc.b(paramMessageRecord))
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.e("SpecialCare", 2, "message.istroop = " + paramMessageRecord.istroop + " MsgBoxUtil.shouldInMsgBox(message) = " + asbc.b(paramMessageRecord));
            }
  ...
  public void b(MessageRecord paramMessageRecord, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    boolean bool2 = a(bhru.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
  ...
  {
    axdx localaxdx = (axdx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(349);
    if (localaxdx != null) {
      return localaxdx.a(paramMessageRecord);
    }
    return true;
  }
  ...
  {
    return (paramMessageRecord != null) && (paramMessageRecord.istroop == 1008) && (antf.u.equals(paramMessageRecord.senderuin));
  }
}
