...
public class bjgq
  extends DbCacheData
{
  public static final DbCacheData.DbCreator<bjgq> a;
  public int a;
  public String a;
  ...
  static
  {
    jdField_a_of_type_ComTencentOpenComponentCacheDatabaseDbCacheData$DbCreator = new bjgr();
  }
  ...
  public static final List<bjgq> a(JSONObject paramJSONObject)
  {
    ...
    while (i < n)
    {
      ...
      if (j < i1)
      {
        ...
        for (localObject = ((JSONObject)localObject).getString("label");; localObject = null)
        {
          ...
          localFriend.jdField_b_of_type_JavaLangString = bjkr.a(paramJSONObject);
          localFriend.jdField_c_of_type_JavaLangString = bjkr.a((String)localObject);
      ...
      paramJSONObject = new bjgq();
      paramJSONObject.jdField_a_of_type_Int = i;
      paramJSONObject.jdField_a_of_type_JavaLangString = bjkr.a(localJSONObject.getString("label"));
  ...
  public static final List<bjgq> b(JSONObject paramJSONObject)
  {
    ...
    localbjgq.jdField_a_of_type_Int = 0;
    localbjgq.jdField_a_of_type_JavaLangString = anvx.a(2131704347);
    localbjgq.jdField_a_of_type_JavaUtilList = localArrayList2;
    localArrayList1.add(localbjgq);
    int j = 0;
    int i = 1;
    while (j < m)
    {
      ...
      while (k < i2)
      {
        ...
        else
        {
          ...
          for (String str1 = localJSONObject2.getString("remark");; str1 = null)
          {
            ...
            localFriend.jdField_b_of_type_JavaLangString = bjkr.a((String)localObject);
            localFriend.jdField_c_of_type_JavaLangString = bjkr.a(str1);
      ...
      Object localObject = new bjgq();
      ((bjgq)localObject).jdField_a_of_type_Int = i;
      ((bjgq)localObject).jdField_a_of_type_JavaLangString = bjkr.a(localJSONObject1.getString("groupname"));
      ((bjgq)localObject).jdField_a_of_type_JavaUtilList = localArrayList3;
    ...
    if (localArrayList2.size() == 0)
    {
      ...
      {
        paramJSONObject = (bjgq)localArrayList1.get(i);
  ...
  public static final List<bjgq> c(JSONObject paramJSONObject)
  {
    JSONArray localJSONArray1 = paramJSONObject.getJSONArray("qqlist");
    int m = localJSONArray1.length();
    int n = paramJSONObject.optInt("app_tid", -1);
    ...
    ArrayList localArrayList2 = new ArrayList();
    bjgq localbjgq2 = new bjgq();
    localbjgq2.jdField_a_of_type_Int = 0;
    localbjgq2.jdField_a_of_type_JavaLangString = anvx.a(2131704346);
    localbjgq2.jdField_a_of_type_JavaUtilList = localArrayList2;
    localArrayList1.add(localbjgq2);
    int i = 0;
    bjgq localbjgq1 = null;
    int j = 1;
    if (i < m)
    {
      ...
      if (anvx.a(2131704345).equals(localJSONObject1.getString("label")))
      {
        localbjgq1 = new bjgq();
        localbjgq1.jdField_a_of_type_Int = 0;
        localbjgq1.jdField_a_of_type_JavaLangString = bjkr.a(localJSONObject1.getString("label"));
        localbjgq1.jdField_a_of_type_JavaUtilList = localArrayList3;
      }
      for (;;)
      {
        i += 1;
        ...
        ((bjgq)localObject).jdField_a_of_type_Int = j;
        ((bjgq)localObject).jdField_a_of_type_JavaLangString = bjkr.a(localJSONObject1.getString("label"));
        ((bjgq)localObject).jdField_a_of_type_JavaUtilList = localArrayList3;
        localArrayList1.add(localObject);
        j += 1;
      }
    ...
    if (paramJSONObject.getInt("only") == 1)
    {
      ...
      paramJSONObject.add(localbjgq2);
      return paramJSONObject;
    }
    if (localArrayList2.size() == 0)
    {
      if ((localbjgq1 == null) || (localbjgq1.jdField_a_of_type_JavaUtilList == null) || (localbjgq1.jdField_a_of_type_JavaUtilList.size() <= 0)) {
        break label493;
      }
      localArrayList1.remove(0);
      localArrayList1.add(0, localbjgq1);
    }
    for (;;)
    {
      return localArrayList1;
