...
class bcbl
  extends mxj
{
  bcbl(bcbh parambcbh, bcbn parambcbn, int paramInt) {}
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramArrayOfByte == null)
        {
          ...
          if (this.jdField_a_of_type_Bcbn != null)
          {
            ...
            this.jdField_a_of_type_Bcbn.a(paramBundle);
          }
          return;
        }
      }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramBundle = paramArrayOfByte;
          localObject = new bcbm(null);
          paramBundle = paramArrayOfByte;
          ((bcbm)localObject).jdField_a_of_type_Long = (l2 * 1000L + l1);
          paramBundle = paramArrayOfByte;
          ((bcbm)localObject).jdField_a_of_type_Int = localUrlCheckResult.result.get();
          paramBundle = paramArrayOfByte;
          ((bcbm)localObject).jdField_b_of_type_Int = localUrlCheckResult.jump_result.get();
          paramBundle = paramArrayOfByte;
          ((bcbm)localObject).jdField_a_of_type_JavaLangString = localUrlCheckResult.jump_url.get();
          paramBundle = paramArrayOfByte;
          ((bcbm)localObject).c = localUrlCheckResult.uint32_level.get();
          paramBundle = paramArrayOfByte;
          ((bcbm)localObject).d = localUrlCheckResult.uint32_sub_level.get();
          paramBundle = paramArrayOfByte;
          ((bcbm)localObject).e = localUrlCheckResult.uint32_umrtype.get();
          paramBundle = paramArrayOfByte;
          ((bcbm)localObject).f = localUrlCheckResult.ret_from.get();
          paramBundle = paramArrayOfByte;
          ((bcbm)localObject).jdField_b_of_type_Long = localUrlCheckResult.operation_bit.get();
          if (paramInt == 0) {
            paramArrayOfByte = (byte[])localObject;
          }
          paramBundle = paramArrayOfByte;
          this.jdField_a_of_type_Bcbh.a.put(str, localObject);
          paramInt += 1;
        }
