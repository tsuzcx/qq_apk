  ...
  implements bhou
{
  ...
  public achf(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localObject2 = ache.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationInfo().sourceDir);
    ...
    for (int i = 0;; i = 1)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject1 = (MSFNetTransportProvider)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(63);
          localObject1 = new bhoo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), (bhol)localObject1);
          if (localObject1 == null) {
            break;
          }
          localObject1 = (bhot)((bhoo)localObject1).a("sig_check");
          if (localObject1 == null) {
            break;
          }
          ((bhot)localObject1).a(this);
          ((bhot)localObject1).a(((JSONObject)localObject4).toString());
          return;
        }
