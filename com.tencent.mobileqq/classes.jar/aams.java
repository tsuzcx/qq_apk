...
import com.tencent.mobileqq.activity.Conversation.28.1;
import com.tencent.mobileqq.activity.Conversation.28.2;
import com.tencent.mobileqq.activity.Conversation.28.3;
import com.tencent.mobileqq.activity.Conversation.28.4;
import com.tencent.mobileqq.activity.Conversation.28.5;
...
public class aams
  extends ajjh
{
  public aams(Conversation paramConversation) {}
  ...
  protected void onCancelMayKnowRecommend(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      ajls localajls = (ajls)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
      ArrayList localArrayList = localajls.c();
      if (localajls.a(paramString)) {
  ...
  protected void onGetGenralSettings(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      localObject1 = null;
      ariz.a().i(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localObject1 != null) {
        break label176;
      }
    }
    for (;;)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          if (localObject1 != null) {
            ((akeu)localObject1).b(localRecentUser);
          }
          ahcq.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, 1);
    ...
    label186:
    this.a.a(9, ajed.C, 5000);
    this.a.a(9, ajed.aJ, 5001);
    if (QLog.isColorLevel()) {
  ...
  protected void onGetMayKnowRecommend(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      if (!bool)
      {
        paramBundle = (ajls)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
        if (!paramBundle.b()) {
          break label103;
        }
        paramBundle.c();
    ...
    for (;;)
    {
      ...
      break;
      label103:
      this.a.p = paramBundle.b("sp_mayknow_entry_list_msg");
      if (QLog.isColorLevel()) {
        QLog.d("Q.recent", 2, "onGetMayKnowRecommend shouldShowConversationMayknow = " + this.a.p);
      }
      ArrayList localArrayList = paramBundle.c();
      if ((this.a.p) && (localArrayList != null) && (localArrayList.size() > 0))
      {
        paramBundle.d();
      }
      else
  ...
  protected void onGetStoreFace(boolean paramBoolean, HashSet<String> paramHashSet)
  {
    ...
    this.a.a(new Conversation.28.3(this, paramHashSet));
  }
  ...
  protected void onHideConversationMayKnowRecommend(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      paramObject = (ajls)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
      paramObject.e();
      this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(1009);
    ...
    bbmy.a(BaseApplication.getContext(), ajjy.a(2131636807), 0).a();
    paramBoolean = ((ajls)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159)).b("sp_mayknow_ml_s_a_vl");
    paramObject = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    if (paramBoolean) {}
    for (;;)
    {
  ...
  protected void onMayknowStateChanged(boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (((ajls)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159)).b("sp_mayknow_ml_s_a_vl")))
    {
      this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(1009);
      this.a.jdField_a_of_type_MqqOsMqqHandler.removeCallbacks(this.a.jdField_a_of_type_JavaLangRunnable);
      this.a.jdField_a_of_type_MqqOsMqqHandler.postDelayed(this.a.jdField_a_of_type_JavaLangRunnable, 1600L);
  ...
  protected void onSetGenralSettingsTroopFilter(boolean paramBoolean, Map<String, Integer> paramMap)
  {
    ...
    if (localObject == null)
    {
      ...
      ariz.a().a(str, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    for (;;)
    {
      ...
      try
      {
        RecentUser localRecentUser = ((akeu)localObject).b(str, 1);
      ...
      break;
      label315:
      ariz.a().c(str, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    label333:
    this.a.a(9, ajed.C, 5000);
    this.a.a(9, ajed.aJ, 5001);
  ...
  protected void onUpdateCustomHead(boolean paramBoolean, String paramString)
  {
    ...
    if (!azzz.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
    {
      this.a.a(new Conversation.28.2(this, paramString));
      return;
    }
    this.a.jdField_a_of_type_ComTencentMobileqqAppFrameHelperActivity.a.sendEmptyMessage(3);
  }
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {}
    while (azzz.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount())) {
      return;
    }
    this.a.a(0L);
  }
  ...
  protected void onUpdateFriendList(boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((paramBoolean1) && (paramBoolean2))
    {
      ...
      this.a.a(0L);
      this.a.a(new Conversation.28.1(this));
    }
  }
  ...
  protected void onUpdateHotFriendLevel(boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    if (paramBoolean) {
      this.a.a(new Conversation.28.5(this, paramArrayList));
    }
  }
  ...
  {
    if (paramBoolean) {
      this.a.a(new Conversation.28.4(this, paramString));
    }
  }
}
