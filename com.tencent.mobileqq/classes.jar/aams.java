...
{
  public aams(BaseChatPie paramBaseChatPie) {}
  
  private boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    adho localadho = (adho)this.a.a(52);
    return ((this.a.jdField_a_of_type_ComTencentWidgetXPanelContainer.a() == 1) && (paramInt2 - paramInt1 != paramInt4 - paramInt3)) || ((localadho != null) && (localadho.a()));
  }
  ...
  public void onLayoutChange(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8)
  {
    ...
    if (paramView != null)
    {
      ...
      if (paramView.a)
      {
        paramInt3 = actn.a(40.0F, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
        paramInt1 = paramInt5 + paramInt3;
      }
    }
    paramView = (adjr)this.a.a(23);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          this.a.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.setOnMeasureListener(new aamt(this, paramInt1, paramInt5 + paramInt4 + paramInt3));
          return;
        }
        paramInt2 -= 1;
      }
