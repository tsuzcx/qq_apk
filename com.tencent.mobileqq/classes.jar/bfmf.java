...
public class bfmf
{
  ...
  public final Queue<bfmk> a;
  
  public bfmf(SnapshotResultReceiver paramSnapshotResultReceiver)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put("offline_pkg", noe.b());
  }
  ...
  public static void a(Application paramApplication, String paramString, int paramInt)
  {
    ...
    localEditor.putBoolean("need_set_proxy", true);
    localEditor.commit();
    bftf.a(paramApplication, "com.tencent.mobileqq:tool");
    if (QLog.isColorLevel())
    {
      QLog.d("UnifiedDebugManager", 2, "set x5 proxy: " + paramString + ":" + paramInt);
      QLog.d("UnifiedDebugManager", 2, "http_proxy_address: " + localSharedPreferences.getString("http_proxy_address", "no proxy"));
      QLog.d("UnifiedDebugManager", 2, "qproxy_address_lists: " + localSharedPreferences.getString("qproxy_address_lists", "no proxy"));
      QLog.d("UnifiedDebugManager", 2, "sQQBrowserActivityCounter =  " + QQBrowserActivity.d);
    }
  }
  ...
  public bfml a(Context paramContext)
  {
    bfml localbfml = new bfml(this);
    localbfml.jdField_a_of_type_JavaLangString = (DeviceInfoUtil.getManufactureInfo() + " " + DeviceInfoUtil.getDeviceModel());
    localbfml.jdField_b_of_type_JavaLangString = Build.VERSION.RELEASE;
    localbfml.c = "8.4.8.4810";
    DeviceInfoUtil.NetInfo localNetInfo = DeviceInfoUtil.getNetInfo(paramContext);
    localbfml.d = localNetInfo.networkType;
    localbfml.e = localNetInfo.operatorName;
    localbfml.jdField_a_of_type_Int = DeviceInfoUtil.getCpuNumber();
    localbfml.jdField_a_of_type_Long = DeviceInfoUtil.getCpuFrequency();
    localbfml.jdField_b_of_type_Long = DeviceInfoUtil.getSystemTotalMemory();
    localbfml.f = DeviceInfoUtil.getCpuType();
    localbfml.jdField_a_of_type_Boolean = a(paramContext);
    localbfml.jdField_b_of_type_Int = QbSdk.getTbsVersion(paramContext);
    if (localbfml.jdField_b_of_type_Int == 0) {}
    for (boolean bool = false;; bool = true)
    {
      localbfml.jdField_b_of_type_Boolean = bool;
      return localbfml;
    }
  }
  ...
  public String a()
  {
    bfme localbfme = bfmd.a("getprop net.dns1");
    if (localbfme.jdField_a_of_type_Boolean)
    {
      if (!localbfme.jdField_a_of_type_JavaUtilList.isEmpty()) {
        return (String)localbfme.jdField_a_of_type_JavaUtilList.get(0);
      }
    }
    else if (QLog.isColorLevel()) {
      QLog.d("UnifiedDebugManager", 2, localbfme.jdField_a_of_type_JavaLangString);
    }
    return "";
  }
  ...
  {
    // Byte code:
    //   0: invokestatic 403	java/util/Calendar:getInstance	()Ljava/util/Calendar;
    //   3: astore 18
    //   5: aload 18
    //   7: lload_1
    //   8: invokevirtual 407	java/util/Calendar:setTimeInMillis	(J)V
    //   11: invokestatic 403	java/util/Calendar:getInstance	()Ljava/util/Calendar;
    //   14: astore 19
    //   16: aload 19
    //   18: lload_3
    //   19: invokevirtual 407	java/util/Calendar:setTimeInMillis	(J)V
    ...
    //   34: aload 19
    //   36: lload 16
    //   38: invokevirtual 407	java/util/Calendar:setTimeInMillis	(J)V
    //   41: aload 18
    //   43: iconst_1
    //   44: invokevirtual 414	java/util/Calendar:get	(I)I
    //   47: istore 7
    //   49: aload 18
    //   51: iconst_2
    //   52: invokevirtual 414	java/util/Calendar:get	(I)I
    //   55: istore 8
    //   57: aload 18
    //   59: iconst_5
    //   60: invokevirtual 414	java/util/Calendar:get	(I)I
    //   63: istore 9
    //   65: aload 18
    //   67: bipush 10
    //   69: invokevirtual 414	java/util/Calendar:get	(I)I
    //   72: istore 10
    //   74: aload 19
    //   76: iconst_1
    //   77: invokevirtual 414	java/util/Calendar:get	(I)I
    //   80: istore 11
    //   82: aload 19
    //   84: iconst_2
    //   85: invokevirtual 414	java/util/Calendar:get	(I)I
    //   88: istore 12
    //   90: aload 19
    //   92: iconst_5
    //   93: invokevirtual 414	java/util/Calendar:get	(I)I
    //   96: istore 13
    //   98: aload 19
    //   100: bipush 10
    //   102: invokevirtual 414	java/util/Calendar:get	(I)I
    //   105: istore 14
    //   107: new 416	java/util/HashSet
    //   110: dup
    //   111: invokespecial 417	java/util/HashSet:<init>	()V
    //   114: astore 20
    //   116: iconst_0
    //   117: istore 6
    //   119: invokestatic 421	com/tencent/qphone/base/util/QLog:getLogFileFormatter	()Ljava/text/SimpleDateFormat;
    //   122: lload_1
    //   123: invokestatic 427	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   126: invokevirtual 433	java/text/SimpleDateFormat:format	(Ljava/lang/Object;)Ljava/lang/String;
    //   129: astore 18
    //   131: aload 20
    //   133: aload 18
    //   135: invokevirtual 437	java/util/HashSet:add	(Ljava/lang/Object;)Z
    //   138: pop
    //   139: iload 6
    //   141: istore 5
    //   143: iload 6
    //   145: ifne +10 -> 155
    //   148: aload 18
    //   150: invokevirtual 440	java/lang/String:length	()I
    //   153: istore 5
    //   155: lload_1
    //   156: ldc2_w 441
    //   159: ladd
    ...
    //   172: lcmp
    //   173: ifle -54 -> 119
    //   176: new 444	java/util/ArrayList
    //   179: dup
    //   180: invokespecial 445	java/util/ArrayList:<init>	()V
    //   183: astore 22
    //   185: new 447	java/io/File
    //   188: dup
    //   189: invokestatic 450	com/tencent/qphone/base/util/QLog:getLogPath	()Ljava/lang/String;
    //   192: invokespecial 451	java/io/File:<init>	(Ljava/lang/String;)V
    //   195: astore 21
    //   197: aload 21
    //   199: invokevirtual 454	java/io/File:exists	()Z
    //   202: ifeq +183 -> 385
    //   205: aload 21
    //   207: invokevirtual 458	java/io/File:listFiles	()[Ljava/io/File;
    //   210: astore 23
    //   212: aload 23
    //   214: ifnull +177 -> 391
    //   217: aload 23
    ...
    //   237: astore 24
    //   239: aload 24
    //   241: invokevirtual 461	java/io/File:getName	()Ljava/lang/String;
    //   244: astore 19
    //   246: aload 19
    //   248: ldc_w 463
    //   251: invokevirtual 271	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   254: ifeq +12 -> 266
    //   257: iload 6
    //   259: iconst_1
    //   260: iadd
    ...
    //   266: aload 19
    //   268: ldc_w 465
    //   271: invokevirtual 271	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   274: ifeq +78 -> 352
    //   277: aload 19
    //   279: iconst_0
    //   280: aload 19
    //   282: invokevirtual 440	java/lang/String:length	()I
    //   285: iconst_4
    //   286: isub
    //   287: invokevirtual 469	java/lang/String:substring	(II)Ljava/lang/String;
    //   290: astore 18
    //   292: aload 18
    //   294: getstatic 472	com/tencent/qphone/base/util/QLog:packageName	Ljava/lang/String;
    //   297: invokevirtual 262	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   300: ifeq -43 -> 257
    //   303: aload 18
    //   305: aload 18
    //   307: invokevirtual 440	java/lang/String:length	()I
    //   310: iload 5
    //   312: isub
    //   313: invokevirtual 475	java/lang/String:substring	(I)Ljava/lang/String;
    //   316: astore 18
    //   318: aload 18
    //   320: invokestatic 480	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   323: ifne -66 -> 257
    //   326: aload 20
    //   328: aload 18
    //   330: invokevirtual 482	java/util/HashSet:contains	(Ljava/lang/Object;)Z
    //   333: ifeq -76 -> 257
    //   336: aload 22
    //   338: aload 24
    //   340: invokevirtual 485	java/io/File:getPath	()Ljava/lang/String;
    //   343: invokeinterface 486 2 0
    //   348: pop
    //   349: goto -92 -> 257
    //   352: aload 19
    //   354: astore 18
    //   356: aload 19
    //   358: ldc_w 488
    //   361: invokevirtual 271	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   364: ifeq -72 -> 292
    //   367: aload 19
    //   369: iconst_0
    //   370: aload 19
    //   372: invokevirtual 440	java/lang/String:length	()I
    //   375: iconst_5
    //   376: isub
    //   377: invokevirtual 469	java/lang/String:substring	(II)Ljava/lang/String;
    //   380: astore 18
    //   382: goto -90 -> 292
    //   385: aload 21
    //   387: invokevirtual 491	java/io/File:mkdirs	()Z
    //   390: pop
    //   391: aconst_null
    //   392: astore 18
    //   394: aload 21
    //   396: invokevirtual 454	java/io/File:exists	()Z
    //   399: ifeq +145 -> 544
    //   402: new 447	java/io/File
    //   405: dup
    //   406: aload 21
    //   408: ldc_w 493
    //   411: invokespecial 496	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   414: astore 18
    //   416: new 498	java/io/BufferedWriter
    //   419: dup
    //   420: new 500	java/io/OutputStreamWriter
    //   423: dup
    //   424: new 502	java/io/FileOutputStream
    //   427: dup
    //   428: aload 18
    //   430: invokespecial 505	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   433: invokespecial 508	java/io/OutputStreamWriter:<init>	(Ljava/io/OutputStream;)V
    //   436: invokespecial 511	java/io/BufferedWriter:<init>	(Ljava/io/Writer;)V
    //   439: astore 20
    //   441: aload 20
    //   443: astore 19
    //   445: aload 21
    //   447: invokevirtual 458	java/io/File:listFiles	()[Ljava/io/File;
    //   450: astore 21
    //   452: aload 21
    //   454: ifnull +71 -> 525
    //   457: aload 20
    ...
    //   496: aload 23
    //   498: invokevirtual 461	java/io/File:getName	()Ljava/lang/String;
    ...
    //   513: invokevirtual 516	java/io/BufferedWriter:write	(Ljava/lang/String;)V
    //   516: iload 5
    //   518: iconst_1
    //   519: iadd
    //   520: istore 5
    ...
    //   527: astore 19
    //   529: aload 20
    //   531: invokevirtual 519	java/io/BufferedWriter:flush	()V
    //   534: aload 20
    //   536: ifnull +8 -> 544
    //   539: aload 20
    //   541: invokevirtual 522	java/io/BufferedWriter:close	()V
    //   544: aload 18
    //   546: ifnull +16 -> 562
    //   549: aload 22
    //   551: aload 18
    //   553: invokevirtual 485	java/io/File:getPath	()Ljava/lang/String;
    //   556: invokeinterface 486 2 0
    //   561: pop
    //   562: new 447	java/io/File
    //   565: dup
    //   566: ldc_w 524
    //   569: invokespecial 451	java/io/File:<init>	(Ljava/lang/String;)V
    //   572: astore 18
    //   574: aload 18
    //   576: invokevirtual 454	java/io/File:exists	()Z
    //   579: ifeq +16 -> 595
    //   582: aload 22
    //   584: aload 18
    //   586: invokevirtual 485	java/io/File:getPath	()Ljava/lang/String;
    //   589: invokeinterface 486 2 0
    //   594: pop
    //   595: new 148	java/lang/StringBuilder
    //   598: dup
    //   599: invokespecial 149	java/lang/StringBuilder:<init>	()V
    //   602: invokestatic 450	com/tencent/qphone/base/util/QLog:getLogPath	()Ljava/lang/String;
    ...
    //   705: aload 22
    //   707: aload 18
    //   709: invokestatic 533	bfmp:a	(Ljava/util/List;Ljava/lang/String;)V
    //   712: aload 18
    //   714: areturn
    //   715: astore 19
    //   717: ldc 140
    ...
    //   720: ldc_w 535
    //   723: aload 19
    //   725: invokestatic 538	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   728: goto -184 -> 544
    //   731: astore 21
    //   733: aconst_null
    //   734: astore 20
    ...
    //   743: ldc_w 540
    //   746: aload 21
    //   748: invokestatic 538	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   751: aload 20
    //   753: ifnull +8 -> 761
    //   756: aload 20
    //   758: invokevirtual 522	java/io/BufferedWriter:close	()V
    //   761: goto -217 -> 544
    //   764: astore 19
    //   766: ldc 140
    //   768: iconst_1
    //   769: ldc_w 535
    //   772: aload 19
    //   774: invokestatic 538	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   777: goto -233 -> 544
    //   780: astore 18
    //   782: aconst_null
    //   783: astore 19
    ...
    //   787: ifnull +8 -> 795
    //   790: aload 19
    //   792: invokevirtual 522	java/io/BufferedWriter:close	()V
    //   795: aload 18
    //   797: athrow
    //   798: astore 19
    //   800: ldc 140
    ...
    //   803: ldc_w 535
    //   806: aload 19
    //   808: invokestatic 538	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   811: goto -16 -> 795
    //   814: astore 18
    //   816: goto -31 -> 785
    //   819: astore 21
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    {
      paramString = paramContext.list(new bfmi(this, paramString));
      ...
      finally
      {
        try
        {
          ...
          try
          {
            ...
            bfmp.a(localArrayList, paramContext);
            bfmp.a(localArrayList);
            return paramContext;
          }
  ...
  public String a(Context paramContext, List<String> paramList)
  {
    ...
    if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
    {
      ...
      while (paramList.hasNext())
      {
        localObject2 = ((File)localObject1).list(new bfmg(this, c((String)paramList.next()).substring(0, 16)));
  ...
  {
    // Byte code:
    //   0: new 708	android/os/Bundle
    //   3: dup
    //   4: invokespecial 709	android/os/Bundle:<init>	()V
    //   7: astore 12
    //   9: aload 12
    //   11: ldc_w 711
    //   14: ldc_w 392
    //   17: invokestatic 714	bgyb:c	(Ljava/lang/String;)Ljava/lang/String;
    //   20: invokevirtual 717	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   23: invokestatic 722	com/tencent/smtt/sdk/CookieManager:getInstance	()Lcom/tencent/smtt/sdk/CookieManager;
    //   26: astore_1
    //   27: aload_1
    //   28: iconst_1
    //   29: invokevirtual 726	com/tencent/smtt/sdk/CookieManager:setAcceptCookie	(Z)V
    //   32: aload_1
    //   33: aload 4
    //   35: invokevirtual 729	com/tencent/smtt/sdk/CookieManager:getCookie	(Ljava/lang/String;)Ljava/lang/String;
    //   38: astore_1
    //   39: aload_1
    //   40: ifnull +69 -> 109
    //   43: aload 12
    //   45: ldc_w 731
    //   48: aload_1
    //   49: invokevirtual 717	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   74: aload_1
    //   75: iconst_0
    //   76: anewarray 258	java/lang/String
    //   79: invokestatic 738	npn:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   91: aload 4
    //   93: iconst_0
    //   94: anewarray 258	java/lang/String
    //   97: invokestatic 742	npn:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   116: invokestatic 747	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   119: invokevirtual 750	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   122: ldc_w 752
    ...
    //   131: astore 9
    //   133: new 447	java/io/File
    //   136: dup
    //   137: aload 9
    //   139: invokespecial 451	java/io/File:<init>	(Ljava/lang/String;)V
    //   142: astore_1
    //   143: aload_1
    //   144: invokevirtual 454	java/io/File:exists	()Z
    //   147: ifne +8 -> 155
    //   150: aload_1
    //   151: invokevirtual 491	java/io/File:mkdirs	()Z
    //   154: pop
    //   155: lload_2
    //   156: invokestatic 755	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   159: astore 10
    ...
    //   193: astore 11
    //   195: new 447	java/io/File
    //   198: dup
    //   199: aload 11
    //   201: invokespecial 451	java/io/File:<init>	(Ljava/lang/String;)V
    //   204: astore 6
    //   206: aconst_null
    //   207: astore_1
    //   208: aconst_null
    ...
    //   211: aconst_null
    //   212: astore 7
    //   214: new 502	java/io/FileOutputStream
    //   217: dup
    //   218: aload 6
    //   220: invokespecial 505	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   223: astore 6
    //   225: new 569	java/net/URL
    //   228: dup
    //   229: aload 4
    //   231: invokespecial 570	java/net/URL:<init>	(Ljava/lang/String;)V
    //   234: invokevirtual 761	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   237: checkcast 763	java/net/HttpURLConnection
    //   240: astore_1
    //   241: aload_1
    //   242: ldc_w 765
    //   245: invokevirtual 768	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   248: aload_1
    //   249: sipush 6000
    //   252: invokevirtual 772	java/net/HttpURLConnection:setConnectTimeout	(I)V
    //   255: aload_1
    //   256: sipush 6000
    //   259: invokevirtual 775	java/net/HttpURLConnection:setReadTimeout	(I)V
    //   262: aload 12
    //   264: invokevirtual 779	android/os/Bundle:keySet	()Ljava/util/Set;
    //   267: invokeinterface 782 1 0
    //   272: astore 4
    //   274: aload 4
    //   276: invokeinterface 244 1 0
    //   281: ifeq +110 -> 391
    //   284: aload 4
    //   286: invokeinterface 248 1 0
    //   291: checkcast 258	java/lang/String
    //   294: astore 7
    //   296: aload 12
    //   298: aload 7
    //   300: invokevirtual 784	android/os/Bundle:get	(Ljava/lang/String;)Ljava/lang/Object;
    //   303: astore 8
    //   305: aload 8
    //   307: instanceof 258
    //   310: ifeq -36 -> 274
    ...
    //   314: aload 7
    //   316: aload 8
    //   318: checkcast 258	java/lang/String
    //   321: invokevirtual 787	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   324: goto -50 -> 274
    //   327: astore 7
    //   329: aload 6
    //   331: astore 4
    ...
    //   350: ldc_w 789
    //   353: aload 6
    //   355: invokestatic 538	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   358: aload 6
    //   360: athrow
    //   361: astore 7
    //   363: aload_1
    ...
    //   371: ifnull +8 -> 379
    //   374: aload 6
    //   376: invokevirtual 792	java/io/OutputStream:close	()V
    //   379: aload 4
    //   381: ifnull +8 -> 389
    //   384: aload 4
    //   386: invokevirtual 795	java/net/HttpURLConnection:disconnect	()V
    //   389: aload_1
    //   390: athrow
    //   391: aload_1
    //   392: invokevirtual 798	java/net/HttpURLConnection:connect	()V
    //   395: sipush 200
    //   398: aload_1
    //   399: invokevirtual 801	java/net/HttpURLConnection:getResponseCode	()I
    //   402: if_icmpne +56 -> 458
    //   405: sipush 1024
    //   408: newarray byte
    //   410: astore 4
    //   412: new 803	java/io/BufferedInputStream
    //   415: dup
    //   416: aload_1
    //   417: invokevirtual 807	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   420: invokespecial 810	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   423: astore 7
    //   425: aload 7
    //   427: aload 4
    //   429: invokevirtual 816	java/io/InputStream:read	([B)I
    //   432: istore 5
    //   434: iconst_m1
    //   435: iload 5
    ...
    //   444: iconst_0
    //   445: iload 5
    //   447: invokevirtual 819	java/io/OutputStream:write	([BII)V
    //   450: goto -25 -> 425
    //   453: aload 6
    //   455: invokevirtual 820	java/io/OutputStream:flush	()V
    //   458: aload 6
    //   460: ifnull +8 -> 468
    //   463: aload 6
    //   465: invokevirtual 792	java/io/OutputStream:close	()V
    //   468: aload_1
    //   469: ifnull +7 -> 476
    //   472: aload_1
    //   473: invokevirtual 795	java/net/HttpURLConnection:disconnect	()V
    //   476: new 444	java/util/ArrayList
    //   479: dup
    //   480: invokespecial 445	java/util/ArrayList:<init>	()V
    //   483: astore_1
    //   484: aload_1
    //   485: aload 11
    //   487: invokeinterface 486 2 0
    //   492: pop
    ...
    //   527: aload_1
    //   528: aload 4
    //   530: invokestatic 533	bfmp:a	(Ljava/util/List;Ljava/lang/String;)V
    //   533: aload 4
    //   535: areturn
    //   536: astore 4
    //   538: ldc 140
    ...
    //   541: ldc_w 789
    //   544: aload 4
    //   546: invokestatic 538	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   549: goto -81 -> 468
    //   552: astore 6
    //   554: ldc 140
    //   556: iconst_1
    //   557: ldc_w 789
    //   560: aload 6
    //   562: invokestatic 538	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   565: goto -186 -> 379
    //   568: astore_1
    //   569: aconst_null
    //   570: astore 6
  ...
  public String a(File paramFile, List<String> paramList)
  {
    ...
    bfmp.a(paramFile, paramList, str);
    return str;
  }
  ...
  public void a(Context paramContext, String paramString1, int paramInt, long paramLong1, long paramLong2, String paramString2)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilQueue.offer(new bfmk(this, paramString1, paramInt, paramLong1, paramLong2, paramString2));
        return;
      }
  ...
  public void a(Context paramContext, List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = paramContext.listFiles(new bfmh(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, Handler paramHandler)
  {
    ...
    new bfmq(paramQQAppInterface, paramHandler).a(paramLong, str1, paramString);
  }
  ...
  public boolean a(Context paramContext, long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      bfmk localbfmk = (bfmk)this.jdField_a_of_type_JavaUtilQueue.poll();
      if ((localbfmk != null) && (localbfmk.jdField_b_of_type_Long == paramLong))
      {
        localbfmk = (bfmk)this.jdField_a_of_type_JavaUtilQueue.peek();
        if (localbfmk != null)
        {
          b(paramContext, localbfmk.jdField_a_of_type_JavaLangString, localbfmk.jdField_a_of_type_Int, localbfmk.jdField_a_of_type_Long, localbfmk.jdField_b_of_type_Long, localbfmk.jdField_b_of_type_JavaLangString);
          if (QLog.isColorLevel()) {
            QLog.d("UnifiedDebugManager", 2, "finish once webview debug, start new debug(dequeue one cmd): seq=" + localbfmk.jdField_b_of_type_Long);
          }
        }
        while (!QLog.isColorLevel()) {
          return true;
  ...
  {
    paramContext = bfmp.a(a(paramContext));
  ...
  public void b(Context paramContext, String paramString, List<String> paramList)
  {
    ...
    if ((paramContext.exists()) && (paramContext.isDirectory()))
    {
      paramString = paramContext.list(new bfmj(this, paramString));
      if ((paramString != null) && (paramString.length > 0))
      {
        int j = paramString.length;
        int i = 0;
