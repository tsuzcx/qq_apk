...
public class avzm
{
  ...
  avzm(BaseActivity paramBaseActivity, TencentMap paramTencentMap, LatLng paramLatLng, String paramString)
  {
  ...
  void a(avzo paramavzo)
  {
    this.jdField_a_of_type_Avzo = paramavzo;
  }
