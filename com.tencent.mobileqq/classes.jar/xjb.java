...
{
  public xjb(LoginView paramLoginView) {}
  ...
  protected void onLoginFailed(String paramString1, String paramString2, String paramString3, int paramInt, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new xjc(this));
      if (QLog.isColorLevel()) {
    ...
    catch (Exception localException)
    {
      ...
      {
        QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2131433196, 0).a();
        return;
      }
      ...
      if (paramInt == 2008)
      {
        DialogUtil.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230, "提示", "对不起，你的QQ号码没有获得内测资格", "OK", null, new xjd(this), null).show();
        QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2131433201, 0).a();
        return;
      }
      DialogUtil.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230, "登录失败", paramString2, new xje(this), null).show();
    }
  }
