...
public class bbwy
  implements bgma
{
  public bbwy(RobotChatPanelLayout paramRobotChatPanelLayout, long paramLong, int paramInt, String paramString, bgoa parambgoa) {}
  ...
  public void a(int paramInt, cmd0x934.RspBody paramRspBody)
  {
    ...
    {
      this.jdField_a_of_type_Bgoa.a(bool1, this.jdField_a_of_type_JavaLangString);
      if (!QLog.isColorLevel()) {
        break;
      }
