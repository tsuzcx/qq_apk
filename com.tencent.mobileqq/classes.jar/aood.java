...
public class aood
  implements aooi
{
  public aood(QQDailyArkView paramQQDailyArkView) {}
  ...
  public void a()
  {
    ...
    do
    {
      ...
      localView = QQDailyArkView.a(this.a).findViewById(2131370198);
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean, ArkViewModel paramArkViewModel)
  {
    ...
    if (paramBoolean) {
      paramString.setOnClickListener(new aooe(this, paramArkViewModel));
    }
    for (;;)
    {
      QQDailyArkView.b(this.a);
      paramString.setVisibility(0);
      paramArkViewModel = paramString.findViewById(2131370198);
