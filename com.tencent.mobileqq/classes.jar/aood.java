  ...
  implements Runnable
{
  ...
  public aood(BaseShortVideoOprerator paramBaseShortVideoOprerator, ArrayList paramArrayList)
  {
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      localTransferRequest.jdField_a_of_type_ComTencentMobileqqPicUpCallBack = new aooe(this, j);
