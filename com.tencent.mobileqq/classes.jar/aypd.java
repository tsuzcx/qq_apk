  ...
  extends aynv
{
  ...
  public aypd(String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
  ...
  public aypd(String paramString1, String paramString2, int paramInt, String paramString3)
  {
    this.jdField_a_of_type_Boolean = true;
  ...
  public void a(View paramView)
  {
    ...
    default: 
      ...
      {
        localObject2 = bdib.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramView.getContext(), (String)localObject1);
    ...
    case -1: 
      ...
      {
        return;
        ActiveEntitySearchActivity.a(paramView.getContext(), this.jdField_a_of_type_JavaLangString, alud.a(2131714035), new long[] { 1001L, 1002L });
        ayvm.a("all_result", "clk_people_group", new String[] { this.jdField_a_of_type_JavaLangString });
        ayvm.a("all_search", "all_result", "clk_user_grp", 0, 0, new String[] { "", "", this.jdField_a_of_type_JavaLangString, "" });
      ...
      try
      {
        ((JSONObject)localObject2).put("project", aysc.a());
        ...
        aysc.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(paramView.jdField_a_of_type_Long + "").obj2(paramView.jdField_b_of_type_JavaLangString).ver1(paramView.jdField_a_of_type_JavaLangString).ver2(aysc.a(UniteSearchActivity.d)).ver7(((JSONObject)localObject2).toString()).session_id(((QQAppInterface)localObject1).getCurrentAccountUin() + ayif.jdField_a_of_type_Long));
        aysc.a(null, this.s, 0, "0X8009D3F", 0, 0, null, null);
        return;
      }
    ...
    for (int i = 0;; i = 0)
    {
      for (;;)
      {
        ...
        {
          localObject1 = ayvj.a(this.jdField_a_of_type_JavaLangString, i, "group");
          label480:
          if (!TextUtils.isEmpty((CharSequence)localObject1))
          {
          ...
          ayvm.a("all_result", "clk_net_search", new String[] { localObject1 });
  ...
  public CharSequence c()
  {
    ...
    case -1: 
      ...
      return ayhw.a(BaseApplicationImpl.getContext(), localQQAppInterface.c());
    }
    return this.g;
  }
