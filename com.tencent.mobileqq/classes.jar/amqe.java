...
public final class amqe
  implements amqb, Handler.Callback, bfoj, bfor, bfpr
{
  private static amqe jdField_a_of_type_Amqe;
  private int jdField_a_of_type_Int;
  private amqa jdField_a_of_type_Amqa;
  ...
  private WeakReference<amqg> jdField_a_of_type_JavaLangRefWeakReference;
  private final ArrayList<amqh> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  public boolean a;
  ...
  private int a(int paramInt1, int paramInt2)
  {
    ...
    String str;
    Bundle localBundle;
    if ((this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper != null) && (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amqj != null) && (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amqj.jdField_a_of_type_JavaLangString != null))
    {
      str = this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amqj.jdField_a_of_type_JavaLangString;
      localBundle = new Bundle();
      localBundle.putString(bfoh.b, "100686848");
      localBundle.putString(bfoh.j, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.strNewSoftwareURL);
      localBundle.putString(bfoh.f, this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName());
      localBundle.putInt(bfoh.k, paramInt1);
      if (paramInt1 == 12) {
        localBundle.putBoolean(bfoh.o, true);
      }
      localBundle.putString(bfoh.i, "ANDROIDQQ.QQUPDATE");
      localBundle.putString(bfoh.l, str);
      if (paramInt2 == 0) {
        break label319;
      }
      localBundle.putString(bfoh.m, "_100686848");
    ...
    {
      localBundle.putString(bfoh.jdField_c_of_type_JavaLangString, "6633");
      localBundle.putInt(bfoh.e, this.jdField_a_of_type_Int);
      localBundle.putBoolean(bfoh.g, true);
      localBundle.putBoolean(bfoh.h, true);
      localBundle.putInt(bfoh.n, 1);
      localBundle.putInt(bfoh.A, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.bGray);
      bfod.a(BaseActivity.sTopActivity, localBundle, "biz_src_jc_update", this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail, i);
      return 0;
      str = "新版手Q";
      break;
      label319:
  ...
  {
    if (jdField_a_of_type_Amqe == null) {
      jdField_a_of_type_Amqe = new amqe();
    }
    return jdField_a_of_type_Amqe;
  }
  ...
  public static String a()
  {
    ...
    if (localObject != null)
    {
      localObject = ((amqe)localObject).jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper;
      str1 = str2;
      if (localObject != null)
      {
        str1 = str2;
  ...
  {
    return bhsz.a(paramString, "nt", amqd.a());
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo != null)) {
        if ((((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iUpgradeType > 0) && (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.bNewSwitch == 1))
        {
          ...
          if (alqf.a(paramQQAppInterface, ((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iNewTimeStamp)) {
            break label96;
          }
          bool1 = bool2;
        }
    ...
    for (;;)
    {
      bool2 = bool1;
      if (!bool1) {
        bool2 = ((aual)paramQQAppInterface.getManager(244)).a();
      }
      return bool2;
      bool1 = false;
      break;
  ...
  private void b(int paramInt)
  {
    try
    {
      alqf localalqf = (alqf)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getRuntime()).a(4);
      ...
      localalqf.a(str, paramInt, this.jdField_a_of_type_JavaLangString);
      return;
    }
    finally
    {
  ...
  private void c(int paramInt)
  {
    ...
    do
    {
      ...
      localamqg = (amqg)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localamqg == null);
    if (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo != null) {
      localamqg.a(paramInt, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper, this);
    }
  ...
  private void d(int paramInt)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      if (localIterator.hasNext()) {
        ((amqh)localIterator.next()).a(paramInt, this);
      }
    }
  }
  ...
  private void g()
  {
    try
    {
      if (!a())
      {
        this.jdField_a_of_type_Amqf = new amqf(this);
        this.jdField_a_of_type_Amqf.a();
      }
      return;
    }
    finally
  ...
  private void h()
  {
    try
    {
      if (a())
      {
        ...
        this.jdField_a_of_type_Amqf = null;
      }
      return;
    }
    finally
  ...
  private void i()
  {
    ...
    azqs.b((QQAppInterface)localObject, "CliOper", "", "", "0X800716C", "0X800716C", 0, 0, "", "", "", "");
    int i = 0;
    this.jdField_a_of_type_Boolean = false;
    if (bdin.h(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl)) {
      i = 1;
    }
    ...
    azri.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", true, 0L, 0L, (HashMap)localObject, "", true);
  }
  ...
  private void k()
  {
    try
    {
      ...
      if (this.d)
      {
        ...
        {
          bfod.b(this.jdField_a_of_type_Amqa);
  ...
  public void a()
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo != null) && (this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo.jdField_c_of_type_Int == 1))
      {
        ...
        alqf.b(localQQAppInterface, false);
        d(false);
        return;
      }
    } while (this.b);
    b(alqf.a(localQQAppInterface, false));
  }
  ...
  public void a(int paramInt)
  {
    ...
    {
      azri.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeWritten", bool, 0L, 0L, localHashMap, "", true);
      return;
    }
  }
  ...
  public void a(amqh paramamqh)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(paramamqh)) {
        this.jdField_a_of_type_JavaUtilArrayList.add(paramamqh);
      }
      return;
    }
  }
  ...
  {
    String str = alqf.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl);
  ...
  public void a(String paramString)
  {
    ...
    b(this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amqj.jdField_a_of_type_Int);
  }
  ...
  public void a(ArrayList<ApkUpdateDetail> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      {
        if (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amqj.jdField_a_of_type_Int == paramArrayList.versioncode) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Amqa == null)
        {
          ...
          this.jdField_a_of_type_Amqa = new amqa(paramString2, this);
          bfod.a(this.jdField_a_of_type_Amqa);
      ...
      if (i != 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amqj = null;
        c(-1);
      }
    }
  }
  ...
  boolean a()
  {
    return this.jdField_a_of_type_Amqf != null;
  }
  ...
  public boolean a(UpgradeInfo paramUpgradeInfo, amqg paramamqg)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amqj = alqf.a(paramUpgradeInfo);
    if ((paramamqg == null) || (paramUpgradeInfo == null)) {
      return false;
    }
    ...
    j();
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramamqg);
    if (QLog.isColorLevel()) {
      QLog.d("UpgradeController", 2, "handleUpgradeInfo packageName = " + this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName() + ", bGray = " + paramUpgradeInfo.bGray + ", versioncode = " + this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amqj.jdField_a_of_type_Int);
    }
    paramUpgradeInfo = new ApkUpdateParam(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName(), paramUpgradeInfo.bGray, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amqj.jdField_a_of_type_Int);
    paramamqg = new ArrayList();
    paramamqg.add(paramUpgradeInfo);
    bfpq.a().b(paramamqg);
    return true;
  }
  ...
  public void b(amqh paramamqh)
  {
    ...
    {
      if (this.jdField_a_of_type_JavaUtilArrayList.contains(paramamqh)) {
        this.jdField_a_of_type_JavaUtilArrayList.remove(paramamqh);
      }
      return;
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    alqf.b(localQQAppInterface, paramBoolean);
    if (paramBoolean)
    {
      g();
      return;
  ...
  public void c()
  {
    ...
    //   18: aload_0
    //   19: getfield 243	amqe:b	Z
    //   22: ifeq +21 -> 43
    //   25: aload_0
    //   26: iconst_0
    //   27: putfield 243	amqe:b	Z
    //   30: aload_0
    //   31: invokevirtual 760	amqe:e	()V
    //   34: aload_0
    //   35: invokespecial 762	amqe:h	()V
    //   38: ldc 138
    //   40: invokestatic 764	bfod:a	(Ljava/lang/String;)V
    //   43: aload_0
    //   44: monitorexit
    //   45: return
    //   46: astore_1
  ...
  public void onDownloadError(DownloadInfo paramDownloadInfo, int paramInt1, String paramString, int paramInt2)
  {
    ...
    azri.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", false, 0L, 0L, paramDownloadInfo, "", true);
  }
  ...
  public void onDownloadFinish(DownloadInfo paramDownloadInfo)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
      ...
      {
        paramDownloadInfo = bfok.a().a(paramDownloadInfo);
        localObject1 = localObject2;
    ...
    for (;;)
    {
      int k = apao.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl);
      ...
      for (i = 101;; i = 9527)
      {
        ...
        azri.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", false, 0L, 0L, (HashMap)localObject1, "", true);
        if (bool) {
          break;
        }
        this.jdField_a_of_type_Bhtd.sendEmptyMessage(0);
        return;
