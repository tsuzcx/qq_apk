...
public class alzz
{
  private amac jdField_a_of_type_Amac = new amac(null);
  private amad jdField_a_of_type_Amad = new amad(null);
  private amae jdField_a_of_type_Amae = new amae(null);
  ...
  private void b(alzl paramalzl, alzs[] paramArrayOfalzs, int paramInt, Exception paramException) {}
  
  private void b(alzm paramalzm, File paramFile, Exception paramException) {}
  ...
  {
    awpu.a(new QConfigureException(paramException, "TAG: " + paramString2 + " Message: " + paramException.getMessage()), paramString1);
  }
  
  public void a(alzl paramalzl, alzs[] paramArrayOfalzs, int paramInt, Exception paramException)
  {
    int i = paramalzl.a();
    ...
    b(paramalzl, paramArrayOfalzs, paramInt, paramException);
  }
  
  public void a(alzm paramalzm, File paramFile, Exception paramException)
  {
    if (QLog.isColorLevel()) {
    ...
    b(paramalzm, paramFile, paramException);
  }
