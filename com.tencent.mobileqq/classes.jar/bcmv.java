  ...
  extends MSFServlet
{
  ...
  {
    Object localObject = new NewIntent(paramQQAppInterface.getApp(), bcmv.class);
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramMessageForPtt.istroop == 0)
          {
            ...
            ((HashMap)localObject).put("appversion", "8.4.8");
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (bool2 = true;; bool2 = false)
    {
      ...
      notifyObserver(paramIntent, m, bool2, paramFromServiceMsg, bcmt.class);
      return;
      break;
    }
  }
