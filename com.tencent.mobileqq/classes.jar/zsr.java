...
class zsr
  extends mmn
{
  zsr(zsq paramzsq, armr paramarmr) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.i("DoraemonOpenAPI.permissionHelper.jobApiPermission", 2, "onResult type=" + this.jdField_a_of_type_Armr.jdField_a_of_type_Int + ", appid=" + this.jdField_a_of_type_Armr.jdField_a_of_type_JavaLangString + ", code=" + paramInt);
    }
    if ((paramInt != 0) || (paramArrayOfByte == null))
    {
      zsq.a(this.jdField_a_of_type_Zsq, new AppInfoError(6, "jobApiPermission req error"));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        zsq.b(this.jdField_a_of_type_Zsq, new AppInfoError(6, "jobApiPermission rsp invalid"));
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      {
        zsq.c(this.jdField_a_of_type_Zsq, new AppInfoError(6, "jobApiPermission parse rsp error"));
      }
      if (QLog.isColorLevel())
      {
        ...
        paramArrayOfByte = zsi.a();
        paramArrayOfByte.a(paramBundle.get_privilege_rsp.api_groups.get(), this.jdField_a_of_type_Armr.jdField_a_of_type_JavaUtilSet);
        if (paramBundle.get_privilege_rsp.api_names.size() > 0)
        {
          ...
          while (((Iterator)localObject).hasNext())
          {
            ...
            if (zsi.a(paramArrayOfByte, str)) {
              this.jdField_a_of_type_Armr.jdField_a_of_type_JavaUtilSet.add(str);
            }
          }
        }
        this.jdField_a_of_type_Armr.c = (NetConnInfoCenter.getServerTimeMillis() + Math.max(paramBundle.get_privilege_rsp.next_req_duration.get() * 1000L, 300000L));
        armw.a().a(this.jdField_a_of_type_Armr);
        zsq.a(this.jdField_a_of_type_Zsq, this.jdField_a_of_type_Armr);
        return;
        label513:
        paramBundle = "";
      }
