...
public class bguw
{
  ...
  public final Queue<bgvb> a;
  
  public bguw(SnapshotResultReceiver paramSnapshotResultReceiver)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put("offline_pkg", nvf.b());
  }
  ...
  public static void a(Application paramApplication, String paramString, int paramInt)
  {
    ...
    localEditor.putBoolean("need_set_proxy", true);
    localEditor.commit();
    bhbx.a(paramApplication, "com.tencent.mobileqq:tool");
    if (QLog.isColorLevel())
    {
  ...
  public bgvc a(Context paramContext)
  {
    bgvc localbgvc = new bgvc(this);
    localbgvc.jdField_a_of_type_JavaLangString = (DeviceInfoUtil.getManufactureInfo() + " " + DeviceInfoUtil.getDeviceModel());
    localbgvc.jdField_b_of_type_JavaLangString = Build.VERSION.RELEASE;
    localbgvc.c = "8.4.10.4875";
    DeviceInfoUtil.NetInfo localNetInfo = DeviceInfoUtil.getNetInfo(paramContext);
    localbgvc.d = localNetInfo.networkType;
    localbgvc.e = localNetInfo.operatorName;
    localbgvc.jdField_a_of_type_Int = DeviceInfoUtil.getCpuNumber();
    localbgvc.jdField_a_of_type_Long = DeviceInfoUtil.getCpuFrequency();
    localbgvc.jdField_b_of_type_Long = DeviceInfoUtil.getSystemTotalMemory();
    localbgvc.f = DeviceInfoUtil.getCpuType();
    localbgvc.jdField_a_of_type_Boolean = a(paramContext);
    localbgvc.jdField_b_of_type_Int = QbSdk.getTbsVersion(paramContext);
    if (localbgvc.jdField_b_of_type_Int == 0) {}
    for (boolean bool = false;; bool = true)
    {
      localbgvc.jdField_b_of_type_Boolean = bool;
      return localbgvc;
    }
  }
  ...
  public String a()
  {
    bguv localbguv = bguu.a("getprop net.dns1");
    if (localbguv.jdField_a_of_type_Boolean)
    {
      if (!localbguv.jdField_a_of_type_JavaUtilList.isEmpty()) {
        return (String)localbguv.jdField_a_of_type_JavaUtilList.get(0);
      }
    }
    else if (QLog.isColorLevel()) {
      QLog.d("UnifiedDebugManager", 2, localbguv.jdField_a_of_type_JavaLangString);
    }
    return "";
  }
  ...
  public String a(long paramLong1, long paramLong2)
  {
    ...
    //   705: aload 22
    //   707: aload 18
    //   709: invokestatic 533	bgvg:a	(Ljava/util/List;Ljava/lang/String;)V
    //   712: aload 18
    //   714: areturn
    //   715: astore 19
    //   717: ldc 140
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    {
      paramString = paramContext.list(new bguz(this, paramString));
      ...
      finally
      {
        try
        {
          ...
          try
          {
            ...
            bgvg.a(localArrayList, paramContext);
            bgvg.a(localArrayList);
            return paramContext;
          }
  ...
  public String a(Context paramContext, List<String> paramList)
  {
    ...
    if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
    {
      ...
      while (paramList.hasNext())
      {
        localObject2 = ((File)localObject1).list(new bgux(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public String a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    //   11: ldc_w 711
    //   14: ldc_w 392
    //   17: invokestatic 714	biit:c	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   79: invokestatic 738	nwo:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   97: invokestatic 742	nwo:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   527: aload_1
    //   528: aload 4
    //   530: invokestatic 533	bgvg:a	(Ljava/util/List;Ljava/lang/String;)V
    //   533: aload 4
    //   535: areturn
    //   536: astore 4
    //   538: ldc 140
  ...
  public String a(File paramFile, List<String> paramList)
  {
    ...
    bgvg.a(paramFile, paramList, str);
    return str;
  }
  ...
  public void a(Context paramContext, String paramString1, int paramInt, long paramLong1, long paramLong2, String paramString2)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilQueue.offer(new bgvb(this, paramString1, paramInt, paramLong1, paramLong2, paramString2));
        return;
      }
  ...
  public void a(Context paramContext, List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = paramContext.listFiles(new bguy(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, Handler paramHandler)
  {
    ...
    new bgvh(paramQQAppInterface, paramHandler).a(paramLong, str1, paramString);
  }
  ...
  public boolean a(Context paramContext, long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      bgvb localbgvb = (bgvb)this.jdField_a_of_type_JavaUtilQueue.poll();
      if ((localbgvb != null) && (localbgvb.jdField_b_of_type_Long == paramLong))
      {
        localbgvb = (bgvb)this.jdField_a_of_type_JavaUtilQueue.peek();
        if (localbgvb != null)
        {
          b(paramContext, localbgvb.jdField_a_of_type_JavaLangString, localbgvb.jdField_a_of_type_Int, localbgvb.jdField_a_of_type_Long, localbgvb.jdField_b_of_type_Long, localbgvb.jdField_b_of_type_JavaLangString);
          if (QLog.isColorLevel()) {
            QLog.d("UnifiedDebugManager", 2, "finish once webview debug, start new debug(dequeue one cmd): seq=" + localbgvb.jdField_b_of_type_Long);
          }
        }
        while (!QLog.isColorLevel()) {
          return true;
  ...
  {
    paramContext = bgvg.a(a(paramContext));
  ...
  public void b(Context paramContext, String paramString, List<String> paramList)
  {
    ...
    if ((paramContext.exists()) && (paramContext.isDirectory()))
    {
      paramString = paramContext.list(new bgva(this, paramString));
      if ((paramString != null) && (paramString.length > 0))
      {
        int j = paramString.length;
        int i = 0;
