...
public class bgsb
  extends aavj
{
  public bgsb(TroopFileTransferManager paramTroopFileTransferManager) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, group_file_common.FileInfo paramFileInfo)
  {
    if ((paramBoolean) && (paramFileInfo != null))
    {
      ...
      if (localObject != null)
      {
        ((bfrs)localObject).a = paramFileInfo.uint32_bus_id.get();
        ((bfrs)localObject).c = paramFileInfo.uint32_dead_time.get();
      }
      this.a.a().d((bfrs)localObject);
    }
  }
}
