...
public class aslf
  implements aslb
{
  private aprt jdField_a_of_type_Aprt;
  private apru jdField_a_of_type_Apru;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public aslf(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private aprs a(int paramInt)
  {
    QLog.i("MsgBackupFileProcessor<QFile>", 1, "getMsgBackupHandler: chatTYpe[" + paramInt + "]");
    Object localObject1 = null;
    if (paramInt == 1)
    {
      if (this.jdField_a_of_type_Aprt == null) {
        this.jdField_a_of_type_Aprt = new aprt(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      localObject1 = this.jdField_a_of_type_Aprt;
    }
    for (;;)
    {
      ...
      if (localObject1 == null)
      {
        ...
        localObject2 = this.jdField_a_of_type_Aprt;
      }
      return localObject2;
      if (paramInt == 2)
      {
      ...
      else if (paramInt == 3)
      {
        if (this.jdField_a_of_type_Apru == null) {
          this.jdField_a_of_type_Apru = new apru(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        }
        localObject1 = this.jdField_a_of_type_Apru;
      }
    }
  }
  
  private aprs a(MessageRecord paramMessageRecord)
  {
    ...
    if (paramMessageRecord.isMultiMsg)
    {
      ...
      if (!TextUtils.isEmpty(paramMessageRecord))
      {
        ...
        localObject = this.jdField_a_of_type_Apru;
      }
    }
    for (;;)
    {
      ...
      localObject = this.jdField_a_of_type_Aprt;
      continue;
  ...
  public aslo a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    ...
    localaslo.a = a(Integer.parseInt(str)).a(paramMessageRecord, paramMsgBackupResEntity);
    return localaslo;
  }
  
  public String a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    paramMessageRecord = new File(aprs.b);
    if (!paramMessageRecord.exists()) {
      paramMessageRecord.mkdirs();
    }
    paramMessageRecord = new File(aprs.a);
    if (!paramMessageRecord.exists()) {
      paramMessageRecord.mkdirs();
    }
  ...
  {
    aprs localaprs = a(paramMessageRecord);
    if (localaprs != null) {
      localaprs.a(paramMessageRecord, paramList);
    }
  }
  ...
  public void b(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    aprs localaprs = a(paramMessageRecord);
    if (localaprs != null) {
      localaprs.b(paramMessageRecord, paramList);
    }
  }
}
