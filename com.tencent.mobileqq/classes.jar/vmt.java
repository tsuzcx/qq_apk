...
{
  public vmt(StructingMsgItemBuilder paramStructingMsgItemBuilder, ChatMessage paramChatMessage, Activity paramActivity, AbsStructMsg paramAbsStructMsg) {}
  ...
  public void a(PopupMenuDialog.MenuItem paramMenuItem)
  {
    ...
    localNewIntent.setObserver(new vmu(this, str));
