...
public class afec
{
  ...
  private afeg jdField_a_of_type_Afeg;
  ...
  public afec(QQAppInterface paramQQAppInterface, afeg paramafeg)
  {
    ...
    this.jdField_a_of_type_Afeg = paramafeg;
    this.jdField_a_of_type_Ajjh = new afed(this);
  ...
  private long a()
  {
    long l = this.jdField_a_of_type_Ajls.a(2);
    if (QLog.isColorLevel()) {
  ...
  private void a(ArrayList<MayKnowRecommend> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Ajls.a((List)???, l2, l1, true);
    ...
    if (paramArrayList != null) {
      Collections.sort(paramArrayList, new afee(this));
    }
    a(paramArrayList);
  ...
  private void a(List<MayKnowRecommend> paramList)
  {
    ...
    for (String str = "NULL";; str = paramList.toString())
    {
      ...
      this.jdField_a_of_type_Afeg.a(paramList);
      return;
    }
  }
  ...
  private boolean a()
  {
    ...
    return this.jdField_a_of_type_Ajls.b(2);
  }
  ...
  private boolean a(Bundle paramBundle)
  {
    ...
    return this.jdField_a_of_type_Ajls.a(2, paramBundle);
  }
  ...
  private boolean a(MayKnowRecommend paramMayKnowRecommend)
  {
    ...
    {
      if (!this.jdField_a_of_type_Ajjj.b(paramMayKnowRecommend.uin))
      {
        boolean bool = this.jdField_a_of_type_Ajjj.a(paramMayKnowRecommend.uin, false, true);
        if (bool) {}
        for (int i = 1;; i = 0)
        {
  ...
  private ArrayList<MayKnowRecommend> c()
  {
    ...
    Collections.sort(localArrayList, new afef(this));
    if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Afeg.a())
    {
      if (a())
      {
        int i;
