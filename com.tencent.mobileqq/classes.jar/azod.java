...
public class azod
  implements azoc, Manager
{
  private static Set<Integer> jdField_a_of_type_JavaUtilSet = new HashSet();
  private azob jdField_a_of_type_Azob;
  private azoe jdField_a_of_type_Azoe;
  private azof jdField_a_of_type_Azof;
  ...
  private aznz[] jdField_a_of_type_ArrayOfAznz = new aznz[jdField_a_of_type_JavaUtilSet.size()];
  ...
  public azod(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_a_of_type_Azof = new azof(paramQQAppInterface, this);
    this.jdField_a_of_type_Azob = azob.a();
    this.jdField_a_of_type_Azoe = new azoe(this);
  ...
  private boolean a(String paramString, Class<? extends Entity> paramClass)
  {
    ...
    //   37: iconst_3
    //   38: aload_2
    //   39: invokevirtual 245	java/lang/Class:getSimpleName	()Ljava/lang/String;
    //   42: aastore
    //   43: invokestatic 201	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   46: aload_1
    //   47: invokestatic 286	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   50: ifne +29 -> 79
    //   53: aload_2
    //   54: ldc 171
    //   56: if_acmpeq +30 -> 86
    ...
    //   83: goto -70 -> 13
    //   86: aload_0
    //   87: getfield 82	azod:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   90: invokevirtual 249	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   93: astore_3
    //   94: aload_3
    //   95: invokevirtual 254	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   98: aload_2
    //   99: invokevirtual 245	java/lang/Class:getSimpleName	()Ljava/lang/String;
    //   102: astore_2
    //   103: aload_1
    //   104: ldc_w 275
    //   107: invokevirtual 293	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   110: ifeq +63 -> 173
    //   113: ldc_w 295
    //   116: iconst_1
    ...
    //   122: aload_2
    //   123: aastore
    //   124: invokestatic 299	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   127: astore_1
    ...
    //   149: aload_1
    //   150: aastore
    //   151: invokestatic 201	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   154: aload_0
    //   155: getfield 82	azod:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   158: aload_1
    //   159: invokevirtual 305	com/tencent/mobileqq/persistence/EntityManager:execSQL	(Ljava/lang/String;)Z
    //   162: pop
    //   163: aload_3
    //   164: invokevirtual 260	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   167: aload_3
    //   168: invokevirtual 263	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   171: iconst_1
    //   172: ireturn
    //   173: ldc_w 307
    //   176: iconst_2
    ...
    //   186: aload_1
    //   187: aastore
    //   188: invokestatic 299	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   191: astore_1
    //   192: goto -64 -> 128
    //   195: astore_1
    ...
    //   216: iconst_1
    //   217: aload_1
    //   218: invokevirtual 198	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   221: aastore
    //   222: invokestatic 201	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   225: aload_1
    //   226: invokevirtual 204	java/lang/Exception:printStackTrace	()V
    //   229: aload_3
    //   230: invokevirtual 263	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   233: iconst_0
    //   234: ireturn
    //   235: astore_1
    //   236: aload_3
    //   237: invokevirtual 263	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   240: aload_1
    //   241: athrow
  ...
  private boolean b()
  {
    ...
    int i = this.jdField_a_of_type_Azob.a;
    if (i == 2)
    {
      if (QLog.isColorLevel()) {
  ...
  public int a()
  {
    if (this.jdField_a_of_type_Azob != null) {
      return this.jdField_a_of_type_Azob.a;
    }
    return 0;
  }
  ...
  public azob a()
  {
    return this.jdField_a_of_type_Azob;
  }
  
  public azoe a()
  {
    return this.jdField_a_of_type_Azoe;
  }
  
  public azof a()
  {
    return this.jdField_a_of_type_Azof;
  }
  ...
  public void a(int paramInt, String paramString, PrecoverResource paramPrecoverResource, Object paramObject)
  {
    ...
    this.jdField_a_of_type_Azof.b(this);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (???.hasNext())
        {
          ...
          localObject5 = azoj.a((String)((Pair)localObject4).second);
          if ((localObject5 == null) || (((Pair)localObject5).first == null) || (((Pair)localObject5).second == null)) {
            continue;
          }
          if (QLog.isColorLevel()) {
            QLog.d("PrecoverManager", 2, new Object[] { "onHandleConfigs, businessid=", ((azoa)((Pair)localObject5).first).a, ", name=", ((azoa)((Pair)localObject5).first).b, ", list.size=", Integer.valueOf(((List)((Pair)localObject5).second).size()) });
          }
          if (TextUtils.isEmpty(((azoa)((Pair)localObject5).first).a)) {
            continue;
          }
          String str = ((azoa)((Pair)localObject5).first).a;
  ...
  {
    boolean bool = azoj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + "_config_cover");
    if (QLog.isColorLevel()) {
      QLog.d("PrecoverManager", 2, new Object[] { "checkReportConfigCover, succ=", Boolean.valueOf(paramBoolean), ", need=", Boolean.valueOf(bool) });
    }
    if (bool)
    {
      azoj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + "_config_cover");
      this.jdField_a_of_type_Azoe.a(paramBoolean);
    }
  }
  
  public boolean a()
  {
    boolean bool = azoj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "get_config_time");
    int j = azoj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", 0);
    if (bool)
    {
      azoj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "get_config_time");
      azoj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", 1);
      return true;
    }
    if (a() != null) {}
    ...
    azoj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", j + 1);
    return true;
  }
  ...
  protected boolean a(PrecoverResource paramPrecoverResource)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (localPrecoverRetryInfo.totalRetryCount <= this.jdField_a_of_type_Azob.c) {
          break;
        }
      } while (!QLog.isColorLevel());
      ...
      if (localPrecoverRetryInfo.itemRetryCount < this.jdField_a_of_type_Azob.b)
      {
        localPrecoverRetryInfo.itemRetryCount += 1;
        localPrecoverRetryInfo.totalRetryCount += 1;
        localPrecoverRetryInfo.retryUpdateTime = l;
