  ...
  implements IServiceCmdCallback
{
  ...
  public azod(azob paramazob, String paramString)
  {
  ...
  public void e()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaUtilMap)
      {
        ...
        azob.b(this.jdField_b_of_type_Azob, new String[] { "fg30CmdCount", "|", String.valueOf(i) });
        ...
        if (localIterator1.hasNext())
        {
          ...
          azob.b(this.jdField_b_of_type_Azob, new String[] { "fg30CmdAlarm", "|", str, "|", localStringBuilder.toString() });
        }
      }
  ...
  public void f()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaUtilMap)
      {
        ...
        azob.b(this.jdField_b_of_type_Azob, new String[] { "bg5CmdCount", "|", String.valueOf(i) });
        ...
        if (localIterator1.hasNext())
        {
          ...
          azob.b(this.jdField_b_of_type_Azob, new String[] { "bg5CmdAlarm", "|", str, "|", localStringBuilder.toString() });
        }
      }
      this.jdField_c_of_type_JavaUtilMap.clear();
      return;
  ...
  public void onCmdRequest(String paramString)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Azos.a(paramString);
    ...
    if ((localMap == null) || ((localMap != null) && (localMap.size() > 0)))
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if (!azob.a())
        {
          ...
          label299:
          if (!azob.a.contains(localObject)) {
            break label475;
          }
          i = 1;
        }
    ...
    for (;;)
    {
      ...
      azob.a(this.jdField_b_of_type_Azob, new String[] { "cmd|", localStringBuilder.toString() });
      localObject = this.jdField_b_of_type_Azob;
      if (j > this.jdField_c_of_type_Int)
      {
        i = 1;
        azob.a((azob)localObject, 3, 0, i, alpo.a(2131701448) + paramString, "2秒钟命令字请求次数：" + j);
      }
      for (;;)
      {
        ...
        if ((azob.a(this.jdField_b_of_type_Azob) != null) && (QLog.isColorLevel())) {
          azob.a(this.jdField_b_of_type_Azob, "No high frequnecy cmd in last 2seconds");
        }
      }
      break label236;
    }
