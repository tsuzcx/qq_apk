  ...
  implements Animator.AnimatorListener
{
  ...
  public affp(Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_Afgp = new afgp(paramContext);
    this.jdField_a_of_type_Afgp.a(new affq(this));
  }
  ...
  public void a(afge paramafge)
  {
    ...
    this.jdField_a_of_type_JavaLangString = awgw.c();
    ...
    if ((bool) && (this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable == null))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable.setImageAssetDelegate(new affr(this));
    }
    try
    {
      ...
      LottieComposition.Factory.fromInputStream(a(), localFileInputStream, new affs(this));
      super.a(paramafge);
      paramafge.a(bool);
      return;
    }
  ...
  public void b()
  {
    ...
    {
      this.jdField_a_of_type_Afgp.b();
      this.jdField_a_of_type_Afgp.c();
    }
    a(8);
    super.b();
  }
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_Afgp != null) && (this.jdField_a_of_type_Afgp.a())) {
      this.jdField_a_of_type_Afgp.d();
    }
  }
