  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      {
        return;
        localaffq = (affq)paramView;
        paramView = affq.a(localaffq);
        if (!TextUtils.isEmpty(paramView)) {
          break;
        }
        Log.i("AutoVideoItemBuilder", "onClick: empty schema");
        paramView = bdds.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.a.jdField_a_of_type_AndroidContentContext, paramView);
        if (paramView != null) {
          paramView.c();
        }
      } while (!(localaffq.a instanceof MessageForStructing));
      paramView = (MessageForStructing)localaffq.a;
    ...
    if (paramView.getVideoItem() != null)
    {
      ...
      azmj.b(null, "dc00898", "", this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "auth_aio", "clk_content", 0, 0, "", "", this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d, paramView);
      return;
      if ((!paramView.contains("&width=")) && (!paramView.contains("?width=")))
      {
        ...
        paramView = paramView + "?width=" + localaffq.e + "&height=" + localaffq.f;
      }
    }
    label275:
    label308:
    ...
    for (;;)
    {
      ...
      {
        if (i != 0) {}
        for (Object localObject = paramView + "&width=" + localaffq.e;; localObject = paramView)
        {
          paramView = (View)localObject;
          if (j == 0) {
            break label275;
          }
          paramView = (String)localObject + "&height=" + localaffq.f;
          break label275;
