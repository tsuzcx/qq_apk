  ...
  implements View.OnClickListener
{
  ...
  private List<wcm> jdField_a_of_type_JavaUtilList = new ArrayList();
  private wcl jdField_a_of_type_Wcl;
  private wed jdField_a_of_type_Wed;
  public int b;
  public View b;
  public ImageView b;
  ...
  public wdx(Activity paramActivity, View paramView, int paramInt1, int paramInt2, wed paramwed)
  {
    super(paramView);
    ...
    this.jdField_a_of_type_Wed = paramwed;
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_b_of_type_Int = paramInt2;
    this.jdField_a_of_type_Arnj = new arnj(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130846381);
    this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView = ((AlbumImageView)paramView.findViewById(2131362535));
    this.jdField_b_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView = ((AlbumImageView)paramView.findViewById(2131362548));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131362611));
    this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewRoundCornerLayout = ((RoundCornerLayout)paramView.findViewById(2131362538));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362613));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362608));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362550));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362591));
    this.e = ((TextView)paramView.findViewById(2131362612));
    this.f = ((TextView)paramView.findViewById(2131362594));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362544));
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131362540);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362549));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362585));
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131364264));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131364265));
    this.g = ((TextView)paramView.findViewById(2131364266));
    ...
    this.jdField_a_of_type_AndroidOsHandler = new web(this, Looper.getMainLooper());
    paramActivity = (wca)wpm.a(30);
  ...
  private int a()
  {
    ...
    if (this.jdField_a_of_type_Wcl != null) {
      i = this.jdField_a_of_type_Wcl.e;
    }
    return i;
  }
  
  private int a(List<wcm> paramList, int paramInt)
  {
    int i;
    ...
    for (;;)
    {
      ...
      i = j;
      if (new File(((wcm)paramList.get(j)).jdField_a_of_type_JavaLangString).exists()) {
        break;
      }
      j += 1;
    }
  ...
  private Drawable a(String paramString)
  {
    ...
    //   64: ldc_w 298
    //   67: aload_3
    //   68: invokestatic 303	yqp:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   71: aload_2
    //   72: ifnull +49 -> 121
    //   75: aload_2
  ...
  private URLDrawable a(String paramString1, String paramString2, int paramInt1, int paramInt2, boolean paramBoolean, wdx paramwdx)
  {
    QQLiveDrawable.QQLiveDrawableParams localQQLiveDrawableParams = new QQLiveDrawable.QQLiveDrawableParams();
    paramwdx = new wee(paramwdx);
    ...
    localQQLiveDrawableParams.mCoverLoadingDrawable = this.jdField_a_of_type_Arnj;
    if (!paramBoolean) {
    ...
    {
      localQQLiveDrawableParams.mListener = paramwdx;
      localQQLiveDrawableParams.mDownloadListener = paramwdx;
      paramString2 = URLDrawable.URLDrawableOptions.obtain();
      paramString2.mExtraInfo = localQQLiveDrawableParams;
      paramString2.mFailedDrawable = this.jdField_a_of_type_Arnj;
      paramString2.mLoadingDrawable = this.jdField_a_of_type_Arnj;
  ...
  {
    if (this.jdField_a_of_type_Wcl != null) {
      this.jdField_a_of_type_Wcl.e = paramInt;
    }
  }
  ...
  {
    yqp.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg :%s", new Object[] { this.jdField_a_of_type_Wcl });
    this.jdField_c_of_type_Int = 3;
    if (paramList.size() == 0)
    {
      yqp.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg error , no pic list");
      return;
    }
    ...
    {
      yqp.b("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayCenterImg error , %s", paramList);
      return;
    }
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_Wcl.a() == 0) {
    ...
    if ((this.jdField_b_of_type_AndroidWidgetLinearLayout.getVisibility() == 0) && (this.jdField_b_of_type_AndroidWidgetLinearLayout.getAnimation() == null))
    {
      ...
      localAlphaAnimation.setAnimationListener(new wdy(this));
    ...
    if (i < 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Wcl.jdField_b_of_type_JavaLangString);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Wcl.a(((List)localObject).size()))) {
        break label364;
      }
      this.jdField_c_of_type_AndroidWidgetTextView.setText(String.format(anni.a(2131698977), new Object[] { this.jdField_a_of_type_Wcl.jdField_b_of_type_JavaLangString, Integer.valueOf(((List)localObject).size()) }));
    }
    for (;;)
    {
      this.f.setText(String.valueOf(this.jdField_a_of_type_Wcl.b()));
      this.e.setText(this.jdField_a_of_type_Wcl.a());
      return;
      this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView.setLocalDrawable(((wcm)((List)localObject).get(i)).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      break;
      label364:
      this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Wcl.a(((List)localObject).size()));
    }
  }
  ...
  private void e()
  {
    ...
    a(localHashSet);
    xfe.a(this.jdField_a_of_type_ComTencentBizQqstoryAlbumViewAlbumImageView, null, this.jdField_b_of_type_JavaLangString, false, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anni.a(2131698983));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(anni.a(2131698985));
  }
  ...
  private void f()
  {
    ...
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130846383);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130846381);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anni.a(2131698992));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131698975));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(anni.a(2131698993));
    this.g.setText(anni.a(2131698970));
  }
  ...
  private void g()
  {
    ...
    localHashSet.add(this.g);
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130846386);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130846381);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anni.a(2131698986));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131698990));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(anni.a(2131698996));
    this.g.setText(anni.a(2131698968));
  }
  ...
  private void h()
  {
    ...
    localHashSet.add(this.g);
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130846382);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130846381);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anni.a(2131698994));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131698995));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(anni.a(2131698991));
    this.g.setText(anni.a(2131698971));
  }
  ...
  private void i()
  {
    ...
    localHashSet.add(this.g);
    a(localHashSet);
    this.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130846384);
    this.jdField_b_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130846381);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anni.a(2131698981));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131698976));
    this.jdField_c_of_type_AndroidWidgetTextView.setText(anni.a(2131698987));
    this.g.setText(anni.a(2131698989));
  }
  
  private void j()
  {
    yqp.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop :%s", new Object[] { this.jdField_a_of_type_Wcl });
    if ((this.jdField_a_of_type_Wcl == null) || (this.jdField_a_of_type_Wcl.a()))
    {
      yqp.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop error ,album not exist");
      this.jdField_c_of_type_Int = 0;
      return;
    }
    ...
    {
      yqp.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop error ,get pick count not enough ,size = %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()) });
      this.jdField_c_of_type_Int = 0;
      return;
    }
    this.jdField_d_of_type_Int = 0;
    this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1);
    yqp.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayLoop success ,get pick count = %d", new Object[] { Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()) });
  }
  
  private void k()
  {
    yqp.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayLoop");
    this.jdField_c_of_type_Int = 0;
    ...
    if (this.jdField_a_of_type_Wcl != null)
    {
      localObject = this.jdField_a_of_type_Wcl.a();
      if (((List)localObject).size() <= 0) {
        break label111;
      }
    }
    label111:
    for (Object localObject = ((wcm)((List)localObject).get(0)).jdField_a_of_type_JavaLangString;; localObject = "")
    {
  ...
  private void l()
  {
    yqp.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "startPlayMp4 :%s", new Object[] { this.jdField_a_of_type_Wcl });
    ...
    localURLDrawableOptions.mFailedDrawable = this.jdField_a_of_type_Arnj;
    localURLDrawableOptions.mLoadingDrawable = this.jdField_a_of_type_Arnj;
  ...
  private void m()
  {
    yqp.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayMp4");
    this.jdField_c_of_type_Int = 0;
    if (this.jdField_a_of_type_ComTencentImageURLDrawable != null)
    {
      if ((this.jdField_a_of_type_ComTencentImageURLDrawable.getCurrDrawable() instanceof QQLiveDrawable))
      {
        ...
        yqp.b("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayMp4 suc");
      }
  ...
  private void o()
  {
    yqp.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stopPlayCenterImg");
    this.jdField_c_of_type_Int = 0;
  ...
  {
    if (this.jdField_a_of_type_Wcl != null) {
      a(this.jdField_a_of_type_Wcl);
    }
  }
  
  public void a(@NonNull wcl paramwcl)
  {
    if ((this.jdField_a_of_type_Wcl != null) && (!this.jdField_a_of_type_Wcl.equals(paramwcl)) && (this.jdField_c_of_type_Int != 0)) {
      c();
    }
    this.jdField_a_of_type_Wcl = paramwcl;
    Object localObject = this.jdField_a_of_type_Wcl.a();
    paramwcl = new ArrayList();
    localObject = ((List)localObject).iterator();
    while (((Iterator)localObject).hasNext())
    {
      wcm localwcm = (wcm)((Iterator)localObject).next();
      if (localwcm.a()) {
        paramwcl.add(localwcm);
      }
    }
    this.jdField_a_of_type_JavaUtilList = paramwcl;
    if (this.jdField_c_of_type_Int == 0)
    {
      if (!this.jdField_a_of_type_Wcl.a()) {
        break label185;
      }
      if (this.jdField_a_of_type_Wcl.jdField_d_of_type_Int == 1) {
        e();
      }
    }
    else
    ...
    if (this.jdField_a_of_type_Wcl.jdField_d_of_type_Int == 3)
    {
      f();
      return;
    }
    if (this.jdField_a_of_type_Wcl.jdField_d_of_type_Int == 2)
    {
      g();
      return;
    }
    if (this.jdField_a_of_type_Wcl.jdField_d_of_type_Int == 5)
    {
      i();
      return;
    }
  ...
  {
    if (this.jdField_a_of_type_Wcl == null) {
      yqp.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "data empty , startPlay error!");
    }
    do
    {
      do
    ...
    } while (this.jdField_a_of_type_Wcl.jdField_d_of_type_Int != 2);
    a(wbw.a().a(wbw.jdField_a_of_type_Int));
    return;
    j();
  }
  ...
  {
    if (this.jdField_a_of_type_Wcl == null) {
      yqp.d("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "data empty , stopPlay error!");
    }
    while (this.jdField_c_of_type_Int == 0) {
      return;
    }
    yqp.a("Q.qqstory.recommendAlbum.ui.AlbumGalleryAdapterHolder", "stop play :%s", this.jdField_a_of_type_Wcl);
    this.jdField_c_of_type_Int = 0;
    if (this.jdField_a_of_type_Wcl.a()) {
      if (this.jdField_a_of_type_Wcl.jdField_d_of_type_Int == 1) {
        m();
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      int i = ((Integer)((wpf)localObject).b("key_album_delete_dialog_show_count", Integer.valueOf(0))).intValue();
      if (i < 3)
      {
        ((wpf)localObject).b("key_album_delete_dialog_show_count", Integer.valueOf(i + 1));
        localObject = new wdz(this);
        localObject = bglp.a(this.jdField_a_of_type_AndroidAppActivity, 230, 2131559009, anni.a(2131698972), null, anni.a(2131698979), anni.a(2131698982), (DialogInterface.OnClickListener)localObject, (DialogInterface.OnClickListener)localObject);
      ...
      for (;;)
      {
        yqu.a("video_shoot_slides", "delete_smartalbum", 0, 0, new String[] { String.valueOf(this.jdField_a_of_type_Wcl.d()), "1" });
        break;
        if (this.jdField_a_of_type_Wed != null) {
          this.jdField_a_of_type_Wed.b(this.jdField_a_of_type_Wcl);
        }
      }
      if (!zlx.b()) {
        botv.a(this.jdField_a_of_type_AndroidViewView, 300L, new wea(this), new float[] { 1.0F, 0.95F, 1.0F });
      }
    }
  }
}
