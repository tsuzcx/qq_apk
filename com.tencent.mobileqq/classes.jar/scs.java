...
{
  scs(scq paramscq, long paramLong, NewIntent paramNewIntent, scu paramscu, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      if (this.jdField_a_of_type_Scu != null) {
        this.jdField_a_of_type_Scu.a(this.jdField_a_of_type_JavaLangString, "error");
      }
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Scu != null)
        {
          ...
          this.jdField_a_of_type_Scu.a(this.jdField_a_of_type_JavaLangString, paramBundle);
        }
      } while (!QLog.isColorLevel());
