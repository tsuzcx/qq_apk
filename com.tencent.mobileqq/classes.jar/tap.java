...
{
  public tap(StoryInputBarView paramStoryInputBarView) {}
  ...
  public boolean onEditorAction(TextView paramTextView, int paramInt, KeyEvent paramKeyEvent)
  {
    if (paramInt == 4)
    {
      ...
      if (this.a.jdField_a_of_type_Szs != null) {
        this.a.jdField_a_of_type_Szs.a(paramTextView, this.a.jdField_a_of_type_ComTencentBizQqstoryDatabaseCommentEntry);
      }
      this.a.c();
