...
{
  public avfm(ShortVideoCommentsView paramShortVideoCommentsView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (str2.equals(""))
    {
      this.a.a(this.a.getContext().getResources().getString(2131696852));
      return;
    }
    if (str2.length() > 140)
    {
      this.a.a(this.a.getContext().getResources().getString(2131696853));
      return;
    }
    ...
    azqs.b(this.a.a, "dc00899", "grp_lbs", "", "new_thing", "clk_reply", 0, 0, "", "", "", "");
  }
}
