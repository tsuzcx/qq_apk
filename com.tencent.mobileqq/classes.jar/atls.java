...
public class atls
{
  ...
  public atls(atlr paramatlr)
  {
    this.jdField_a_of_type_JavaLangString = paramatlr.jdField_a_of_type_JavaLangString;
    this.jdField_b_of_type_JavaLangString = paramatlr.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_Int = paramatlr.jdField_a_of_type_Int;
    this.d = paramatlr.jdField_b_of_type_Int;
    this.e = paramatlr.jdField_c_of_type_Int;
    if (paramatlr.jdField_b_of_type_Boolean)
    {
      this.jdField_a_of_type_Long = paramatlr.d;
      this.jdField_a_of_type_ArrayOfByte = a(paramatlr.jdField_c_of_type_Long);
      this.jdField_b_of_type_Long = paramatlr.jdField_b_of_type_Long;
      this.jdField_b_of_type_ArrayOfByte = a(paramatlr.jdField_a_of_type_Long);
      return;
    }
    this.jdField_a_of_type_Long = paramatlr.jdField_b_of_type_Long;
    this.jdField_a_of_type_ArrayOfByte = a(paramatlr.jdField_a_of_type_Long);
  }
  ...
  public String a(String paramString)
  {
    ...
    try
    {
      paramString = bach.a(this.jdField_a_of_type_ComTencentQphoneBaseUtilCryptor.encrypt(paramString.getBytes(), this.jdField_a_of_type_ArrayOfByte));
      return paramString;
    }
  ...
  public String b(String paramString)
  {
    try
    {
      paramString = bach.a(paramString);
