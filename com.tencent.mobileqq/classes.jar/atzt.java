  ...
  extends ajtb
{
  ...
  private void a(int paramInt, Intent paramIntent, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      for (paramIntent = Integer.toString(j);; paramIntent = i + "_" + j)
      {
        ...
        axrn.a(this.mApp.getApplication()).a(this.app.getCurrentAccountUin(), "ocrTextSearch", bool, l, 0L, paramArrayOfByte, "");
        if (QLog.isColorLevel()) {
  ...
  private void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      Object localObject4 = ayqh.a().b(l1);
      Object localObject5 = ayqh.a().a(l1);
      ...
      try
      {
        ...
        ((ayrx)localObject1).jdField_a_of_type_ArrayOfByte = ((byte[])localObject5);
        ((ayrx)localObject1).jdField_a_of_type_Aysc = new atzu(this, paramIntent, (byte[])localObject2, (String)localObject3);
        ((ayrx)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject4);
        ((ayrx)localObject1).jdField_a_of_type_Int = 1;
        ((ayrx)localObject1).f = 57;
        ((ayrx)localObject1).jdField_a_of_type_JavaUtilHashMap.put("Accept-Encoding", "identity");
        ((ayrx)localObject1).jdField_c_of_type_Int = 2;
        ((ayrx)localObject1).jdField_c_of_type_Long = 15000L;
        paramIntent = BaseApplicationImpl.sApplication.getRuntime();
        if ((paramIntent instanceof AppInterface))
        {
          ((AppInterface)paramIntent).getNetEngine(0).a((aysy)localObject1);
          if (QLog.isColorLevel()) {
