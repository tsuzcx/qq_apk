  ...
  extends alij
{
  ...
  public agud(Conversation paramConversation, ViewGroup paramViewGroup)
  {
    super(paramConversation, paramViewGroup);
    this.jdField_a_of_type_Befz = new ague(this);
  ...
  {
    belr.jdField_a_of_type_Int = paramInt;
  }
  ...
  private void e(boolean paramBoolean)
  {
    try
    {
      ...
      ((agtk)this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(342)).a((ViewGroup)this.jdField_a_of_type_AndroidViewView, paramBoolean);
      return;
    }
  ...
  private void g(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (paramInt == 3) {
        agvs.a("sq.xcx.qp", 1, 0, null);
      } else {
        agvs.a("sq.dz", 1, 0, null);
      }
    }
  }
  ...
  private void g(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        j = bajq.b(110.0F);
        ahek.jdField_a_of_type_Int = j;
        ahek localahek = this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_Ahek;
        if (localahek != null) {
          localahek.g();
        }
        if (!QLog.isColorLevel()) {
  ...
  private void q()
  {
    try
    {
      ...
      if (!this.i)
      {
        ...
        ((agtk)this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(342)).b();
        this.i = true;
        if (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalEntryUiSpringHbEntrySplashView != null) {
  ...
  private void r()
  {
    try
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_Ahbv != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_Ahbv.a())) {
        this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_Ahbv.b();
      }
      s();
      h();
      this.jdField_a_of_type_AndroidOsHandler.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
  ...
  private void v()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_ComTencentWidgetARMapHongBaoListView = ((ARMapHongBaoListView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131309126));
        ...
        int m = aciy.a(50.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
        if ((localObject == null) || (((View)localObject).getBottom() - ((View)localObject).getTop() == 0))
        {
          ...
          if (k != 0)
          {
            ...
            int n = (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131165923);
            this.jdField_f_of_type_Int = ((int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131165924));
            this.g = ((int)(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131166928) - this.jdField_c_of_type_Int) / 2);
            ...
            this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131297448));
  ...
  private void w()
  {
    if (this.jdField_a_of_type_ComTencentWidgetARMapHongBaoListView != null)
    {
      boolean bool = ((agtk)this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(342)).d();
      this.jdField_a_of_type_ComTencentWidgetARMapHongBaoListView.b(bool);
      bool = ((agtk)this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(342)).e();
  ...
  private void x()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityConversation != null)
    {
      ...
      if (localObject != null)
      {
        localObject = ((PullRefreshHeader)localObject).findViewById(2131309304);
        if (localObject != null)
        {
  ...
  public void a(android.graphics.Bitmap paramBitmap, java.lang.String paramString, java.util.List<android.graphics.Bitmap> paramList)
  {
    ...
    //   0: aload_0
    //   1: aload_0
    //   2: getfield 305	agud:jdField_a_of_type_AndroidViewViewGroup	Landroid/view/ViewGroup;
    //   5: ldc_w 306
    ...
    //   14: putfield 195	agud:jdField_a_of_type_ComTencentWidgetARMapHongBaoListView	Lcom/tencent/widget/ARMapHongBaoListView;
    //   17: aload_0
    //   18: getfield 195	agud:jdField_a_of_type_ComTencentWidgetARMapHongBaoListView	Lcom/tencent/widget/ARMapHongBaoListView;
    //   21: ifnonnull +13 -> 34
    //   24: ldc 62
    //   26: iconst_2
    //   27: ldc_w 473
    ...
    //   33: return
    //   34: getstatic 476	agtw:jdField_a_of_type_Int	I
    //   37: istore 4
    //   39: ldc 62
    //   41: iconst_2
    ...
    //   118: aload_0
    //   119: getfield 26	agud:e	I
    //   122: iconst_2
    //   123: if_icmpeq +49 -> 172
    //   126: aload_0
    //   127: iconst_2
    //   128: invokespecial 409	agud:f	(I)V
    //   131: aload_0
    //   132: getfield 74	agud:jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalEntryUiSpringHbEntrySplashView	Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/entry/ui/SpringHbEntrySplashView;
    //   135: iconst_0
    ...
    //   139: aload_0
    //   140: getfield 195	agud:jdField_a_of_type_ComTencentWidgetARMapHongBaoListView	Lcom/tencent/widget/ARMapHongBaoListView;
    //   143: iload 4
    //   145: invokevirtual 485	com/tencent/widget/ARMapHongBaoListView:a	(I)V
    //   148: aload_0
    //   149: getfield 195	agud:jdField_a_of_type_ComTencentWidgetARMapHongBaoListView	Lcom/tencent/widget/ARMapHongBaoListView;
    //   152: aload_0
    //   153: getfield 33	agud:jdField_a_of_type_Befz	Lbefz;
    //   156: invokevirtual 487	com/tencent/widget/ARMapHongBaoListView:a	(Lbefz;)V
    //   159: aload_0
    //   160: getfield 74	agud:jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalEntryUiSpringHbEntrySplashView	Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/entry/ui/SpringHbEntrySplashView;
    //   163: aload_0
    //   164: getfield 50	agud:jdField_a_of_type_AndroidViewView	Landroid/view/View;
    //   167: aload_1
    //   168: aload_2
    ...
    //   172: invokestatic 494	agtw:a	()Lagtw;
    //   175: aload_0
    //   176: getfield 144	agud:jdField_a_of_type_ComTencentMobileqqActivityConversation	Lcom/tencent/mobileqq/activity/Conversation;
    ...
    //   182: invokevirtual 497	agtw:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   185: return
    //   186: astore_1
    //   187: ldc 62
    //   189: iconst_1
    ...
    //   212: aload_0
    //   213: iconst_2
    //   214: invokespecial 409	agud:f	(I)V
    //   217: aload_0
    //   218: getfield 195	agud:jdField_a_of_type_ComTencentWidgetARMapHongBaoListView	Lcom/tencent/widget/ARMapHongBaoListView;
    //   221: iload 4
    //   223: invokevirtual 485	com/tencent/widget/ARMapHongBaoListView:a	(I)V
    //   226: aload_0
    //   227: getfield 195	agud:jdField_a_of_type_ComTencentWidgetARMapHongBaoListView	Lcom/tencent/widget/ARMapHongBaoListView;
    //   230: new 503	aguf
    //   233: dup
    //   234: aload_0
    //   235: invokespecial 504	aguf:<init>	(Lagud;)V
    //   238: invokevirtual 508	com/tencent/widget/ARMapHongBaoListView:setOnPendentClickListener	(Lbegb;)V
    //   241: goto -69 -> 172
  ...
  public void a(boolean paramBoolean)
  {
    try
    {
      ...
      for (;;)
      {
        agtw.jdField_b_of_type_Boolean = paramBoolean;
        g(paramBoolean);
        return;
        this.jdField_a_of_type_ComTencentWidgetARMapHongBaoListView.d();
      }
  ...
  public void a(boolean paramBoolean, SpringFestivalRedpakcetPreviewConfBean.BreathLight paramBreathLight)
  {
    for (;;)
    {
      try
      {
        ...
        if ((paramBoolean) && (paramBreathLight != null) && (paramBreathLight.breathTimeInfo != null) && (!baip.a(paramBreathLight.resUrl)))
        {
          ...
          w();
          PreloadManager.a().a(localDownloadParam, new agug(this, paramBreathLight));
          if (!QLog.isColorLevel()) {
            break;
          }
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_ComTencentWidgetARMapHongBaoListView != null)
        {
          ...
          j = k;
          if (k < bajq.a(aguo.a - 20.0F))
          {
            this.jdField_a_of_type_ComTencentWidgetARMapHongBaoListView.j();
            j = k;
          }
          if (QLog.isDevelopLevel()) {
            QLog.i("springHb_SpringHbConversationEntry", 4, "resumeAnim...,viewScrollY:" + j + ",pendent_height:" + bajq.a(aguo.a));
          }
          return;
        }
      }
  ...
  public void d()
  {
    try
    {
      ...
      ((agtk)this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(342)).a();
      b();
      w();
      if (!b()) {
        return;
  ...
  public void e()
  {
    try
    {
      ...
      if ((agtw.jdField_a_of_type_Int == 1) && (!this.jdField_f_of_type_Boolean))
      {
        c(0);
        c(true);
        return;
  ...
  public void f()
  {
    try
    {
      super.f();
      if (b()) {
        QLog.i("springHb_SpringHbConversationEntry", 1, "onDestroy....,mEntryMode:" + agtw.jdField_a_of_type_Int);
      }
      agtw.jdField_a_of_type_Int = 0;
      u();
      a(false, null);
      a(false);
      return;
