  ...
  implements umd
{
  private boolean a(List<String> paramList)
  {
    ...
    {
      wsv.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleAlbumEntraConfig type: 日迹主页影集入口配置, content: \n", paramList);
      paramList = (uef)urr.a(30);
        ...
        catch (NumberFormatException localNumberFormatException3)
        {
          try
          {
            for (;;)
            {
              ...
              wsv.e("Q.qqstory.config.QQStoryConfigServletHandler", "get enableCqMode= " + str11 + " from json error:" + localNumberFormatException1);
              continue;
              localNumberFormatException2 = localNumberFormatException2;
              wsv.e("Q.qqstory.config.QQStoryConfigServletHandler", "get highBitrate= " + str11 + " from json error:" + localNumberFormatException2);
              continue;
              bool = false;
            }
            localNumberFormatException3 = localNumberFormatException3;
            wsv.e("Q.qqstory.config.QQStoryConfigServletHandler", "get codecProfile= " + str11 + " from json error:" + localNumberFormatException3);
          }
          catch (NumberFormatException localNumberFormatException4)
          {
            for (;;)
            {
              wsv.e("Q.qqstory.config.QQStoryConfigServletHandler", "get maxVideoSize= " + str11 + " from json error:" + localNumberFormatException4);
            }
          }
        }
      }
  ...
  private boolean a(List<String> paramList, String paramString)
  {
    ...
    {
      return false;
      wsv.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleQzoneSync2QQStory config=%s", paramList);
    ...
    catch (Throwable paramString)
    {
      for (;;)
      {
        wsv.e("Q.qqstory.config.QQStoryConfigServletHandler", "handleQzoneSync2QQStory  parseLong error");
      }
    }
  ...
  private boolean b(List<String> paramList)
  {
    ...
    for (paramList = "";; paramList = str)
    {
      wsv.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleAlbumConfig type: 影集配置, content: \n", paramList);
      if ((!TextUtils.isEmpty(str)) && (str.trim().length() != 0)) {
        break;
      }
      localuef.f();
  ...
  private boolean b(List<String> paramList, int paramInt)
  {
    ...
    return ((uro)urr.a(5)).a(paramList);
  }
  ...
  private boolean c(List<String> paramList)
  {
    ...
    uur localuur = (uur)QQStoryContext.a().getManager(252);
    String str = (String)paramList.get(0);
    if (str == null) {}
    for (paramList = "";; paramList = str)
    {
      wsv.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleMsgTabTakeVideoNodeConfig type: 日迹拍摄配置, content: \n", paramList);
      if ((!TextUtils.isEmpty(str)) && (str.trim().length() != 0)) {
        break;
      }
      localuur.a();
  ...
  private boolean d(List<String> paramList)
  {
    ...
    paramList = (String)paramList.get(0);
    wsv.a("Q.qqstory.config.QQStoryConfigServletHandler", "handledAIOSyncToStory config=%s", paramList);
    if (TextUtils.isEmpty(paramList))
    {
      wsv.d("Q.qqstory.config.QQStoryConfigServletHandler", "handledAIOSyncToStory content is null!!");
      bmea.b();
      return true;
    }
    try
  ...
  private boolean e(List<String> paramList)
  {
    ...
    wsv.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig config=%s", paramList);
    paramList = (String)paramList.get(0);
    if (TextUtils.isEmpty(paramList))
    {
      wsv.d("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig clear config");
      urk.c(false);
      urk.e(false);
      return true;
    }
    try
    {
      ...
      wsv.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig showSyncBtn = %d,defaultStatus=%d", Integer.valueOf(i), Integer.valueOf(j));
      if (i == 1)
      {
        bool = true;
        urk.c(bool);
    ...
    {
      xmh.a("handleStorySync2QzoneConfig:" + paramList.toString(), new Object[0]);
      paramList.printStackTrace();
    }
  }
  ...
  private boolean f(List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramList = (urm)JsonORM.a(new JSONObject(paramList), urm.class);
        localurk = (urk)urr.a(10);
        localurk.b("boolean_enable_revert_play_mode", Boolean.valueOf(true));
        localurk.b("boolean_enable_fast_play_mode", Boolean.valueOf(true));
        localurk.b("boolean_enable_slow_play_mode", Boolean.valueOf(true));
        localurk.b("boolean_enable_hw_encode_pic_to_video", Boolean.valueOf(true));
        localurk.b("boolean_enable_flow_decode", Boolean.valueOf(true));
        localurk.b("boolean_use_flow_decode_first", Boolean.valueOf(false));
        localurk.b("key_story_home_preload_count", Integer.valueOf(4));
        localurk.b("key_story_video_preload_duration", Integer.valueOf(2));
        urn[] arrayOfurn;
        int k;
        if (paramList.f != null)
        {
          arrayOfurn = paramList.f;
          k = arrayOfurn.length;
          i = 0;
          if (i < k)
          {
            ...
            localurk.b("boolean_use_flow_decode_first", Boolean.valueOf(true));
          }
        }
        if (paramList.jdField_a_of_type_ArrayOfUrn != null)
        {
          arrayOfurn = paramList.jdField_a_of_type_ArrayOfUrn;
          k = arrayOfurn.length;
          i = 0;
          if (i < k)
          {
            ...
            localurk.b("boolean_enable_revert_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.jdField_b_of_type_ArrayOfUrn != null)
        {
          arrayOfurn = paramList.jdField_b_of_type_ArrayOfUrn;
          k = arrayOfurn.length;
          i = 0;
          if (i < k)
          {
            ...
            localurk.b("boolean_enable_fast_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.c != null)
        {
          arrayOfurn = paramList.c;
          k = arrayOfurn.length;
          i = 0;
          if (i < k)
          {
            ...
            localurk.b("boolean_enable_slow_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.d != null)
        {
          arrayOfurn = paramList.d;
          k = arrayOfurn.length;
          i = 0;
          if (i < k)
          {
            ...
            localurk.b("boolean_enable_hw_encode_pic_to_video", Boolean.valueOf(false));
          }
        }
        if (paramList.e != null)
        {
          arrayOfurn = paramList.e;
          k = arrayOfurn.length;
          i = 0;
          if (i < k)
          {
            ...
            localurk.b("boolean_enable_flow_decode", Boolean.valueOf(false));
          }
        }
      ...
      localurk.b("string_story_global_log_level", Integer.valueOf(i));
      localurk.b("string_auto_play_report_control", paramList.jdField_b_of_type_JavaLangString);
      if ((paramList.jdField_a_of_type_Int > 0) && (paramList.jdField_a_of_type_Int < 20)) {
        localurk.b("key_story_home_preload_count", Integer.valueOf(paramList.jdField_a_of_type_Int));
      }
      if ((paramList.jdField_b_of_type_Int > 0) && (paramList.jdField_b_of_type_Int < 10))
      {
        localurk.b("key_story_video_preload_duration", Integer.valueOf(paramList.jdField_b_of_type_Int));
        break label726;
        i = j;
  ...
  private boolean g(List<String> paramList)
  {
    ...
    paramList = (String)paramList.get(0);
    if (!TextUtils.isEmpty(paramList)) {
      bdiv.i(localQQAppInterface.getApp(), localQQAppInterface.c(), paramList);
    }
    for (;;)
    {
      ((uhl)localQQAppInterface.getManager(181)).b(paramList);
      if (QLog.isColorLevel()) {
        QLog.d("Q.qqstory.config.QQStoryConfigServletHandler", 2, "handleStoryPlayerProxyConfigCmd configContent = " + paramList);
      }
      return true;
      bdiv.i(localQQAppInterface.getApp(), localQQAppInterface.c(), null);
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          {
            localurk.b("CertificationLinkText", localObject1);
            localurk.b("CertificationLinkUrl", localObject2);
            ...
            localurk.b("localVideoScanInterval", String.valueOf(i));
            localObject1 = localJSONObject.optJSONObject("mainHallConfig");
            if (localObject1 == null) {
              break label554;
            }
            localurk.b("mainHallConfig", ((JSONObject)localObject1).toString());
            localObject1 = localJSONObject.optJSONObject("troopStoryHallConfig");
            if (localObject1 == null) {
              break label567;
            }
            localurk.b("troopStoryHallConfig", ((JSONObject)localObject1).toString());
            ...
            bool = true;
            localurk.b("key_share_encrypt_flag", Boolean.valueOf(bool));
            ...
            bool = true;
            localurk.b("key_show_in_friend_story_main_page", Boolean.valueOf(bool));
            ...
            localurk.b("boolean_enable_multi_video_fragment", Boolean.valueOf(true));
            i = 0;
            if (i < j)
            {
              ...
              localurk.b("boolean_enable_multi_video_fragment", Boolean.valueOf(false));
            }
            i = localJSONObject.optInt("qim_sync_to_qq", 0);
            QLog.d("Q.qqstory.commonConfig", 2, "qim_sync_to_qq: " + paramList);
            localurk.b("key_qim_int_qim_sync_to_qq_default", Integer.valueOf(i));
            return true;
          }
          localurk.b("CertificationLinkText", "");
          localurk.b("CertificationLinkUrl", "");
          continue;
        }
        localurk.b("CertificationLinkText", "");
      }
      ...
      continue;
      label540:
      localurk.b("localVideoScanInterval", "1441");
      continue;
      label554:
      localurk.b("mainHallConfig", "");
      continue;
      label567:
      localurk.b("troopStoryHallConfig", "");
      continue;
      label580:
      localurk.b("key_share_encrypt_flag", Boolean.valueOf(false));
      continue;
      label595:
      localurk.b("key_show_in_friend_story_main_page", Boolean.valueOf(true));
      continue;
      label610:
      localurk.b("boolean_enable_multi_video_fragment", Boolean.valueOf(true));
      continue;
  ...
  public boolean a(int paramInt, Intent paramIntent, ConfigurationService.Config paramConfig)
  {
    ...
    Object localObject = urk.a(paramInt);
    int i = bdiv.a(QQStoryContext.a().getApp(), (String)localObject, str);
    int j = paramConfig.version.get();
    localObject = aova.a(paramConfig, i, paramInt);
    if (localObject == null) {
      return bool2;
    }
    switch (paramInt)
