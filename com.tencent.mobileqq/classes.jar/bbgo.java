  ...
  extends BaseAdapter
{
  ...
  public bbgo(ArrayList<String> paramArrayList, Context paramContext, QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(bbgq parambbgq)
  {
    this.jdField_a_of_type_Bbgq = parambbgq;
  }
  ...
  {
    paramView = new bbgp(this);
    paramView.jdField_a_of_type_Int = paramInt;
    paramView.jdField_a_of_type_Boolean = this.jdField_a_of_type_Boolean;
    View localView1 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561485, paramViewGroup, false);
    if (bkpg.a()) {
      localView1.setAlpha(0.4F);
    }
    TextView localTextView = (TextView)localView1.findViewById(2131367987);
    localTextView.setText((CharSequence)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt));
    View localView2 = localView1.findViewById(2131365329);
