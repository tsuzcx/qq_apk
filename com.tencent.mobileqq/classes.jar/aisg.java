...
{
  public aisg(ClassificationSearchActivity paramClassificationSearchActivity) {}
    ...
    if ((paramInt == 3) || ((paramKeyEvent != null) && (paramKeyEvent.getKeyCode() == 66)))
    {
      ...
      if (!TextUtils.isEmpty(paramTextView)) {
        if ((this.a.f == ClassificationSearchActivity.jdField_a_of_type_Int) && (!TextUtils.isEmpty(paramTextView.trim())))
        {
          ...
          oat.a(null, "dc00899", "Pb_account_lifeservice", "", "0X80067C4", "0X80067C4", 0, 0, "", "", paramTextView, "", true);
      ...
      for (;;)
      {
        ...
        {
          oat.a(null, "", "0X800742D", "0X800742D", 0, 0, paramTextView, "", "", "");
          ClassificationSearchActivity.a(this.a, paramTextView);
        }
        else
        {
          ...
          if (this.a.f == ClassificationSearchActivity.jdField_a_of_type_Int)
          {
            ...
            if ((!TextUtils.isEmpty(paramTextView.trim())) && (!TextUtils.equals(paramTextView, anni.a(2131700730))) && (!TextUtils.equals(paramTextView, anni.a(2131700745))))
            {
              this.a.a(paramTextView);
              oat.a(null, "dc00899", "Pb_account_lifeservice", "", "0X80067C4", "0X80067C4", 0, 0, "", "", paramTextView, "", true);
              ClassificationSearchActivity.a(this.a, paramTextView);
