  ...
  implements ViewBase.OnClickListener
{
  ...
  public qgt(ArticleInfo paramArticleInfo, Context paramContext)
  {
  ...
  public static void a(ArticleInfo paramArticleInfo, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ((JSONObject)localObject2).put("imei", pha.h());
        ((JSONObject)localObject2).put("imsi", pha.i());
      ...
      oat.a(null, pha.d(paramArticleInfo), str2, str2, 0, 0, String.valueOf(paramArticleInfo.mFeedId), (String)localObject2, "" + paramArticleInfo.mStrategyId, (String)localObject1, false);
      return;
      paramInt = 1;
      continue;
      paramInt = 0;
  ...
  {
    int i = pha.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
    pmh.a().a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mExtraBiuBriefInfo, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
