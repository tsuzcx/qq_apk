...
{
  public shu(ChatSettingForTroop paramChatSettingForTroop, ActionSheet paramActionSheet) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    if (paramView != null)
    {
      ...
      paramView = (ProgressBar)paramView.findViewById(2131364818);
      if (paramView != null) {
        paramView.setVisibility(0);
      }
    }
    ThreadManager.post(new sju(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop), 5, null, false);
