...
public final class shu
{
  ...
  static
  {
    jdField_a_of_type_Shw = new shw(null);
  }
  ...
  @RequiresApi(26)
  private final void a(Activity paramActivity, View paramView, float paramFloat, shv paramshv)
  {
    ...
    try
    {
      PixelCopy.request(paramActivity, new Rect(arrayOfInt[0], arrayOfInt[1], arrayOfInt[0] + paramView.getWidth(), arrayOfInt[1] + paramView.getHeight()), localBitmap, (PixelCopy.OnPixelCopyFinishedListener)new shy(localBitmap, this, paramView, paramFloat, paramshv), this.jdField_a_of_type_AndroidOsHandler);
      return;
    }
  ...
  private final void a(Bitmap paramBitmap, rqx paramrqx)
  {
    String str = URLDrawableHelper.diskCachePath.toString() + File.separator + AbsDownloader.getFileName(new StringBuilder().append("screen_capture").append(System.currentTimeMillis()).toString());
    rqg localrqg = new rqg(paramBitmap, str);
    localrqg.a((URLDrawable.DownloadListener)new shz(this, str, paramrqx, paramBitmap));
    localrqg.a();
  }
  
  private final void a(Bitmap paramBitmap, shv paramshv)
  {
    int i;
    if (!paramBitmap.isRecycled())
    {
  ...
  private final void a(View paramView, boolean paramBoolean, float paramFloat, shv paramshv)
  {
    ThreadManager.getFileThreadHandler().post((Runnable)new ScreenCaptureHelper.captureViewLowApi.1(this, paramView, paramFloat, paramshv));
  }
  
  private final void a(String paramString, rqx paramrqx)
  {
    ...
    paramString = (rqy)new rrb(localContext, (QQAppInterface)localAppRuntime, paramString);
    paramString.a(paramrqx);
    paramString.a();
  }
  ...
  private final boolean b(TextureView paramTextureView)
  {
    ...
    tmp9_5;
    paramTextureView.getLocationOnScreen(arrayOfInt);
    if ((arrayOfInt[0] < 0) || (arrayOfInt[0] > DisplayUtil.getWindowScreenWidth((Context)BaseApplicationImpl.getContext()))) {
      return false;
    }
    return (arrayOfInt[1] >= 0) && (arrayOfInt[1] <= DisplayUtil.getWindowScreenHeight((Context)BaseApplicationImpl.getContext()));
  }
  
  public final void a(@NotNull Activity paramActivity, boolean paramBoolean, float paramFloat, @Nullable rqx paramrqx)
  {
    Intrinsics.checkParameterIsNotNull(paramActivity, "activity");
    a(paramActivity, paramBoolean, paramFloat, (shv)new shx(this, paramrqx));
  }
  
  public final void a(@NotNull Activity paramActivity, boolean paramBoolean, float paramFloat, @Nullable shv paramshv)
  {
    Intrinsics.checkParameterIsNotNull(paramActivity, "activity");
    try
    {
      ...
      if (Build.VERSION.SDK_INT >= 26)
      {
        ...
        a(paramActivity, (View)localObject, paramFloat, paramshv);
        return;
      }
      Intrinsics.checkExpressionValueIsNotNull(localObject, "captureView");
      a((View)localObject, paramBoolean, paramFloat, paramshv);
      return;
    }
