  ...
  implements View.OnClickListener
{
  ...
  public beji(Context paramContext, ExtendGridView paramExtendGridView)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Int = 9;
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqTroopActivityExtendGridView = paramExtendGridView;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130847826);
    this.jdField_a_of_type_JavaLangCharSequence = BaseApplication.getContext().getText(2131695536);
    this.jdField_b_of_type_JavaLangCharSequence = BaseApplication.getContext().getResources().getText(2131716848);
  ...
  {
    int i = (int)bgme.a(paramContext, 60.0F);
    int j = (int)bgme.a(paramContext, 5.0F);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559916, null);
      localbejj = new bejj();
      localbejj.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131380320));
      localbejj.b = ((ImageView)localView.findViewById(2131368449));
      localbejj.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131376822));
      localView.setTag(localbejj);
      ...
      localbejj.jdField_a_of_type_ComTencentImageURLImageView.setScaleType(ImageView.ScaleType.FIT_XY);
      localbejj.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130842464);
      localbejj.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_a_of_type_JavaLangCharSequence);
      localbejj.b.setVisibility(8);
    }
    label260:
    label275:
    String str;
    do
    {
      ...
      return localView;
      localbejj = (bejj)paramView.getTag();
      localView = paramView;
      break;
      paramView.width = i;
      paramView.height = i;
    ...
    if (i < 0)
    {
      ...
      label321:
      i = Math.min(100, i);
      localbejj.jdField_a_of_type_ComTencentImageURLImageView.setAdjustViewBounds(false);
    ...
    for (;;)
    {
      ...
      localbejj.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(paramView);
      localbejj.jdField_a_of_type_ComTencentImageURLImageView.setContentDescription(this.jdField_b_of_type_JavaLangCharSequence);
      localbejj.b.setVisibility(0);
      localbejj.b.setTag(Integer.valueOf(paramInt));
      localbejj.b.setOnClickListener(this);
      localbejj.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
      break;
      j = i;
      break label303;
      label484:
