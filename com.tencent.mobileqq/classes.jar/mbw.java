...
public abstract class mbw
{
  ...
  public lgf a;
  lnw jdField_a_of_type_Lnw = new mbx(this);
  public mkl a;
  ...
  public void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Mkl != null) {}
    for (TextView localTextView = this.jdField_a_of_type_Mkl.a();; localTextView = null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentAvGaudioBaseGaInvite$GetGaFaceRunnable == null) {
        this.jdField_a_of_type_ComTencentAvGaudioBaseGaInvite$GetGaFaceRunnable = new BaseGaInvite.GetGaFaceRunnable(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, this.jdField_a_of_type_Long, this.jdField_b_of_type_Long, this.jdField_a_of_type_Lnw);
      }
  ...
  void a(boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "refreshUI, isMultiCall[" + mqr.b(this.jdField_b_of_type_Int) + "], multiIncomingCall[" + paramBoolean + "], mUinType[" + this.jdField_b_of_type_Int + "], mIsAudioMode[" + this.jdField_a_of_type_Boolean + "]");
    }
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Mkl == null)
      {
        this.jdField_a_of_type_Mkl = new mkl(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getApplicationContext());
        this.jdField_a_of_type_Mkl.a(this.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_b_of_type_JavaLangString);
        localObject = new Date();
        localObject = new SimpleDateFormat("HH:mm").format((Date)localObject);
        this.jdField_a_of_type_Mkl.b((String)localObject);
        this.jdField_a_of_type_Mkl.a(this.jdField_a_of_type_Boolean, mqr.b(this.jdField_b_of_type_Int), paramBoolean);
        if (mqr.b(this.jdField_b_of_type_Int)) {
      ...
      if (this.jdField_a_of_type_Lgf != null)
      {
        ...
        if (this.jdField_a_of_type_Lgf.z == 1)
        {
          ...
          if (this.jdField_b_of_type_Int == 9500)
          {
            i = j;
            localObject = str;
            if (!TextUtils.isEmpty(this.jdField_a_of_type_Lgf.p))
            {
              localObject = this.jdField_a_of_type_Lgf.p;
              i = 0;
            }
          }
        }
      ...
      {
        if (this.jdField_a_of_type_Lgf != null) {
          this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Lgf.a();
        }
        if (QLog.isColorLevel()) {
