  ...
  extends Handler
{
  ...
  public bfrl(SubmitHomeWorkFragment paramSubmitHomeWorkFragment, Looper paramLooper)
  {
    super(paramLooper);
    ...
    do
    {
      do
      {
        ...
        if (paramSubmitHomeWorkFragment.jdField_a_of_type_JavaUtilLinkedList.isEmpty())
        {
          ...
          paramSubmitHomeWorkFragment.jdField_b_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorXMediaEditor.setHint(paramSubmitHomeWorkFragment.getActivity().getString(2131697230));
      ...
      while (localIterator.hasNext())
      {
        ...
        paramSubmitHomeWorkFragment.jdField_a_of_type_ComTencentMobileqqTroopHomeworkXmediaeditorXMediaEditor.a(bfus.a(localJSONObject));
      }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 3: 
      ...
      localSubmitHomeWorkFragment.jdField_a_of_type_Bkzi.d(false);
      return;
    case 513: 
    ...
    if (i < 1000)
    {
      QQToast.a(localSubmitHomeWorkFragment.getActivity(), anvx.a(2131714014), 0).a();
    ...
    if (!NetworkUtil.isNetSupport(localSubmitHomeWorkFragment.getActivity()))
    {
      ...
      QQToast.a(localSubmitHomeWorkFragment.getActivity(), 2131696954, 0).a();
      localSubmitHomeWorkFragment.jdField_a_of_type_Boolean = false;
      localSubmitHomeWorkFragment.j();
      return;
    }
    ...
    {
      paramMessage = new bfuq(paramMessage, null, i / 1000, (int)l, localSubmitHomeWorkFragment.d);
