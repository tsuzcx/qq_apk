  ...
  extends agci
{
  ...
  private ahgz jdField_a_of_type_Ahgz;
  protected Rect a;
  public View a;
  public bgyz a;
  public String a;
  ...
  public agbz(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  public boolean a(String paramString)
  {
    ...
    localObject = bgmg.a(paramString);
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    this.jdField_a_of_type_Bgyz = ((bgyz)paramVarArgs[6]);
  ...
  public boolean b()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Ahgz = null;
      this.c = afur.a(Long.valueOf(this.jdField_a_of_type_JavaLangString).longValue(), this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
      localObject = afur.a(afur.a(this.jdField_a_of_type_ComTencentWidgetListView, this.c));
      if ((localObject != null) && ((localObject instanceof ahgz))) {
        this.jdField_a_of_type_Ahgz = ((ahgz)localObject);
      }
      while (this.jdField_a_of_type_Ahgz == null)
      {
        a(true);
        return false;
        if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_Ahgz.a != null)
      {
        localObject = this.jdField_a_of_type_Ahgz.a.a();
    ...
    {
      label284:
      m += (int)(this.jdField_a_of_type_Bgyz.a * k);
      j += (int)(this.jdField_a_of_type_Bgyz.b * i);
      localObject = this.jdField_a_of_type_AndroidGraphicsRect;
      float f = this.jdField_a_of_type_Bgyz.c;
      k = (int)(k * f);
      f = this.jdField_a_of_type_Bgyz.d;
      ...
      if (this.jdField_a_of_type_AndroidViewView == null)
      {
        ...
        localObject = afur.a(afur.a(this.jdField_a_of_type_ComTencentWidgetListView, this.c));
        if ((localObject != null) && ((localObject instanceof agca)))
        {
          this.jdField_a_of_type_Agca = ((agca)localObject);
          label484:
          ...
          j = this.jdField_a_of_type_Agca.a.getRight() - this.jdField_a_of_type_Agca.a.getLeft();
          i = this.jdField_a_of_type_Agca.a.getBottom() - this.jdField_a_of_type_Agca.a.getTop();
        }
      }
      for (;;)
      {
