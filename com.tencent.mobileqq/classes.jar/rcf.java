...
public class rcf
  implements View.OnClickListener, qvd
{
  ...
  public rcf(Context paramContext, ViewGroup paramViewGroup)
  {
    this.jdField_a_of_type_Ajus = new rcg(this);
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new rci(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewViewGroup = paramViewGroup;
    this.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131312511));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131312510));
  ...
  private static void a(String paramString1, String paramString2)
  {
    ...
    ndn.a(null, "", paramString1, paramString1, 0, 0, str, "", "", paramString2, false);
  }
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(amfg.a().jdField_a_of_type_JavaLangString))
      {
        ...
        if (this.jdField_a_of_type_Ajuq == null) {
          this.jdField_a_of_type_Ajuq = new ajuq(localQQAppInterface);
        }
        this.jdField_a_of_type_Ajuq.a(localQQAppInterface, 10);
      }
    }
  }
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131653270);
      this.jdField_b_of_type_AndroidWidgetTextView.setText(2131653270);
    ...
    do
    {
      ...
      localObject1 = avwc.a("kFTSReadInJoySearchPlaceholderPrefix");
      if (!paramBoolean) {
        break;
      }
      ...
      ((ObjectAnimator)localObject2).addListener(new rch(this, (String)localObject1));
      jdField_a_of_type_Int += 1;
      avsv.a(null, new ReportModelDC02528().module("hot_list").action("exp_default_word").ver2(avsv.a(25)).ver4(this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.title));
      localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      if (this.jdField_a_of_type_Ajuq == null) {
        this.jdField_a_of_type_Ajuq = new ajuq((QQAppInterface)localObject1);
      }
      this.jdField_a_of_type_Ajuq.a((QQAppInterface)localObject1, "exp_default_word", this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.title, avsv.a(25), null);
    ...
    if (paramInt1 == 0)
    {
      localObject1 = "1";
      label476:
      avsv.a(null, ((ReportModelDC02528)localObject2).ver1((String)localObject1).obj3(paramInt2 + ""));
      localObject2 = obz.a();
    }
    try
    {
      ((ocg)localObject2).a("channelid", paramInt2 + "");
      if (paramInt1 != 0) {
        break label743;
      }
      localObject1 = "1";
      label551:
      ((ocg)localObject2).a("refresh_way", (String)localObject1);
    }
    ...
    a("0X800A4C5", ((ocg)localObject2).a());
  ...
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    amff localamff = amfg.a();
    this.jdField_a_of_type_Ajuq = null;
    if (!TextUtils.isEmpty(localamff.jdField_a_of_type_JavaLangString))
    {
  ...
  public void onClick(View paramView)
  {
    ...
    for (paramView = this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$GIFInfo;; paramView = null)
    {
      ...
      {
        avsv.a(localQQAppInterface, localReportModelDC02528.ver1(paramView).ver7("{experiment_id:" + avsv.jdField_b_of_type_JavaLangString + "}"));
        avsv.a(null, 0, 25, "0X8009D15", 0, 0, null, null);
        return;
      }
    }
  }
