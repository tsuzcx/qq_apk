  ...
  extends azqk
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localLinearLayout.setId(2131370150);
      localBubbleViewLayout = new BubbleViewLayout(paramContext);
      localBubbleViewLayout.setId(2131370149);
      ...
      ((RelativeLayout)localObject3).setId(2131370143);
      ...
      ((RelativeLayout)localObject3).setBackgroundResource(2130844281);
      ...
      localObject2 = (azqj)((Iterator)localObject4).next();
      localObject5 = ((azqj)localObject2).a;
      if (!"title".equals(localObject5)) {
        break label685;
      }
      localObject2 = (TextView)((azqj)localObject2).a(paramContext, null, paramBundle);
    ...
    for (;;)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject5).addRule(3, 2131370143);
      ...
      ((TextView)localObject2).setBackgroundColor(localResources.getColor(2131167192));
      ...
      break;
      label439:
      localBubbleViewLayout.setLayoutParams(new LinearLayout.LayoutParams(BaseChatItemLayout.d - aekt.a(20.0F, localResources), -2));
      break label101;
      label467:
      ((RelativeLayout)localObject3).setBackgroundResource(2130844282);
      break label203;
      label477:
      if (bool)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject4).addRule(0, 2131370143);
        paramView.setLayoutParams((ViewGroup.LayoutParams)localObject4);
        paramView.setId(2131373315);
        ...
        ((RelativeLayout)localObject3).setBackgroundResource(2130844274);
        paramView.setImageDrawable(localResources.getDrawable(2130844277));
      }
      for (;;)
      {
        label536:
        ...
        ((RelativeLayout.LayoutParams)localObject4).addRule(1, 2131370143);
        break label536;
        label652:
        ((RelativeLayout)localObject3).setBackgroundResource(2130844275);
        paramView.setImageDrawable(localResources.getDrawable(2130844276));
      }
      label673:
      ((RelativeLayout.LayoutParams)localObject5).setMargins(0, 0, 0, 0);
    }
    ...
    for (;;)
    {
      try
      {
        long l = Long.parseLong(((azvd)localObject2).Y);
        localObject2 = Calendar.getInstance();
        ((Calendar)localObject2).setTimeInMillis(l * 1000L);
        localObject5 = new TextView(paramContext);
        ((TextView)localObject5).setId(2131377793);
        RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(aekt.a(68.0F, localResources), aekt.a(18.0F, localResources));
        localLayoutParams.addRule(14);
        if (!this.jdField_a_of_type_Boolean) {
          break label1317;
        }
        f = 51.0F;
        localLayoutParams.topMargin = aekt.a(f, localResources);
      ...
      if (("head".equals(localObject5)) && ((localException instanceof azsf)))
      {
        paramBundle.putInt("bundle_args_avatar_width", aekt.a(52.0F, localResources));
        paramBundle.putInt("bundle_args_avatar_height", aekt.a(52.0F, localResources));
        paramBundle.putInt("bundle_args_cover_width", aekt.a(52.0F, localResources));
        paramBundle.putInt("bundle_args_cover_height", aekt.a(52.0F, localResources));
        if (BaseApplicationImpl.sApplication.getRuntime().getAccount().equalsIgnoreCase(((azsf)localException).S))
        {
        ...
        if (this.jdField_a_of_type_Boolean) {}
        for (paramBundle.topMargin = aekt.a(9.0F, localResources);; paramBundle.topMargin = aekt.a(7.0F, localResources))
        {
          paramBundle.addRule(3, 2131377793);
          localRelativeLayout.setLayoutParams(paramBundle);
          ((RelativeLayout)localObject3).addView(localRelativeLayout);
          localObject3 = new RelativeLayout.LayoutParams(aekt.a(52.0F, localResources), aekt.a(52.0F, localResources));
          paramBundle = (Bundle)localObject1;
          if (localObject1 == null) {
            paramBundle = new LinearLayout(paramContext);
          }
          paramBundle.setId(2131376329);
          ...
          localObject1 = new RelativeLayout.LayoutParams(aekt.a(52.0F, localResources), aekt.a(52.0F, localResources));
          ((RelativeLayout.LayoutParams)localObject1).addRule(1, 2131376329);
          ((RelativeLayout.LayoutParams)localObject1).leftMargin = aekt.a(15.0F, localResources);
          paramBundle = paramView;
          if (paramView == null) {
            paramBundle = new LinearLayout(paramContext);
          }
          paramBundle.setId(2131366904);
