  ...
  implements aztk
{
  ...
  protected aztp(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, aztr paramaztr)
  {
    this.jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_Int = 0;
    this.jdField_a_of_type_Azsd = new azsd();
    this.jdField_a_of_type_Xbd = new aztq(this);
    this.jdField_b_of_type_Long = paramLong;
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item = paramItem;
    this.jdField_a_of_type_Aztr = paramaztr;
  ...
  public static aztp b(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, aztr paramaztr)
  {
    if (paramLong == 0L)
    {
    ...
    return new aztp(paramLong, paramItem, paramBundle, paramaztr);
  }
  ...
  public void a(int paramInt)
  {
    ...
    {
      azsr.c("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] stop. but had stoped. mStatus:" + this.jdField_a_of_type_Int);
      return;
    }
    this.jdField_b_of_type_Boolean = true;
    a(8, 0);
    azsr.c("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] stop. mStatus:" + this.jdField_a_of_type_Int);
    ...
    for (;;)
    {
      azsb.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, j);
      b(0);
      this.jdField_a_of_type_Azsd.jdField_c_of_type_Int = i;
      b();
      j();
      return;
      if (paramInt == 2)
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Aztj != null)
    {
      this.jdField_a_of_type_Azsd.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Aztj.d();
      this.jdField_a_of_type_Azsd.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Aztj.e();
      this.jdField_a_of_type_Azsd.jdField_a_of_type_Int = this.jdField_a_of_type_Aztj.c();
      this.jdField_a_of_type_Azsd.jdField_b_of_type_Int = this.jdField_a_of_type_Aztj.d();
    }
    this.jdField_a_of_type_Azsd.jdField_c_of_type_Int = paramInt1;
    this.jdField_a_of_type_Azsd.jdField_d_of_type_Int = paramInt2;
    this.jdField_a_of_type_Azsd.jdField_b_of_type_Long = this.jdField_d_of_type_Long;
    if (this.jdField_c_of_type_Long != 0L)
    {
      this.jdField_a_of_type_Azsd.jdField_c_of_type_Long = (System.currentTimeMillis() - this.jdField_c_of_type_Long);
      if ((this.jdField_d_of_type_Long > 0L) && (this.jdField_a_of_type_Azsd.jdField_c_of_type_Long > 0L))
      {
        float f1 = (float)this.jdField_a_of_type_Azsd.jdField_c_of_type_Long / 1000.0F;
        this.jdField_a_of_type_Azsd.jdField_e_of_type_Long = (((float)this.jdField_d_of_type_Long / f1));
      }
    }
    else
    {
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    for (this.jdField_d_of_type_Long += paramLong1 - this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressValue;; this.jdField_d_of_type_Long = paramLong1)
    {
      ...
      azsb.b(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item);
      return;
    }
  }
  ...
  protected final void a(azqt paramazqt, String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      azsr.a("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] addFMEntity fail app=null ");
      return;
    }
  ...
  public void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal >= this.jdField_a_of_type_Azsd.jdField_a_of_type_Long) {
      this.jdField_d_of_type_Long = (this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal - this.jdField_a_of_type_Azsd.jdField_a_of_type_Long);
    }
    h();
  }
  ...
  protected void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    azsb.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 12);
    b();
    j();
    if (paramBoolean)
    {
      ...
      bamh.b(paramInt1, paramInt2, str);
    }
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.retryTimes = 0;
    azsr.a("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onFileInvailDel  nReportResultCode:" + paramInt1 + " nReportSecResultCode:" + paramInt2);
    if (this.jdField_a_of_type_Aztr != null) {
      this.jdField_a_of_type_Aztr.a(a(), false, paramInt2, this);
    }
  }
  ...
  protected void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    i();
    b(4);
    azsb.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 10, paramInt3);
    b();
    j();
    if (paramBoolean)
    {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.retryTimes = 0;
    azsr.a("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onDownloadErr  nReportResultCode:" + paramInt1 + " nReportSecResultCode:" + paramInt2 + " troopFileError:" + paramInt3);
    if (this.jdField_a_of_type_Aztr != null) {
      this.jdField_a_of_type_Aztr.a(a(), false, paramInt2, this);
    }
  }
  ...
  public void a(boolean paramBoolean, long paramLong, int paramInt, String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    int i = azsp.a(paramString1);
    int n = i;
    if (i == 0) {
      n = azsp.b(paramString2);
    }
    int i5 = azsp.c(paramString1);
    int j;
    if (!paramBoolean)
    {
      ...
      a(i, j);
      this.jdField_a_of_type_Azsd.jdField_e_of_type_Int = i5;
      this.jdField_a_of_type_Azsd.f = n;
      k();
    ...
    azsr.a("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onHasErr. download fail. errCode:" + paramInt + " transferedSize:" + paramLong);
    ...
    for (;;)
    {
      ...
      else if (this.jdField_a_of_type_Aztj.b())
      {
        m = 4;
        paramInt = bami.p;
        i = 105;
  ...
  public boolean a()
  {
    ...
    {
      azsr.a("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] start filepath is null");
      return false;
    }
    ...
    {
      azsr.c("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] start filename:" + this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName + " filePath:" + this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FilePath + " bResueFromW2MPause:" + bool1);
      this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.Pausing = 0;
      Object localObject = azsp.a(this.jdField_b_of_type_Long);
      if (localObject != null)
      {
        localObject = ((bajk)localObject).a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FilePath);
        if (localObject != null) {
          this.jdField_a_of_type_Azsd.h = ((azpg)localObject).jdField_c_of_type_Int;
        }
      }
      if (!bbev.g(BaseApplication.getContext()))
      {
        azsr.a("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] no network");
        this.jdField_b_of_type_Boolean = true;
        b(4);
        ...
        azsb.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 10, 106);
        bamh.b(bami.jdField_b_of_type_Int, bami.k);
        return false;
      }
  ...
  {
    if (b()) {}
    for (this.jdField_a_of_type_Azsd.g = 1;; this.jdField_a_of_type_Azsd.g = 0)
    {
      azsc.b(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, "actGroupFileDown", this.jdField_a_of_type_Azsd);
      return;
    }
  }
  ...
  {
    azsr.c("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onChangeUrl:" + paramString);
  }
  ...
  protected void c()
  {
    ...
    for (this.jdField_a_of_type_Azsd.g = 1;; this.jdField_a_of_type_Azsd.g = 0)
    {
      azsc.b(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, this.jdField_a_of_type_Azsd);
      return;
    }
  }
  ...
  public boolean c()
  {
    ...
    {
      return bool;
      this.jdField_b_of_type_JavaLangString = ajsf.bl;
      localVFSFile = new VFSFile(this.jdField_b_of_type_JavaLangString);
      if (!localVFSFile.exists()) {
        localVFSFile.mkdirs();
      }
      this.jdField_c_of_type_JavaLangString = ajsf.bo;
      bool = true;
  ...
  public void d()
  {
    azsr.c("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onRetryDownload");
    if (this.jdField_a_of_type_Aztj != null) {
      this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.retryTimes = this.jdField_a_of_type_Aztj.b();
    }
  ...
  public void e()
  {
    azsb.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 8);
    b(5);
  }
  ...
  public void f()
  {
    ...
    if (localQQAppInterface == null)
    {
      azsr.a("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] reqDownload app=null");
      this.jdField_a_of_type_Azsd.jdField_c_of_type_Int = 9;
      this.jdField_a_of_type_Azsd.jdField_d_of_type_Int = 902;
      a(true, bami.jdField_b_of_type_Int, bami.w, 1);
      return;
    }
    azsr.c("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] reqDownload");
    Object localObject = azsp.a(this.jdField_b_of_type_Long);
    if (localObject != null)
    {
      ...
      if (localazpg != null)
      {
        ...
        if (localObject != null)
        {
          localazpg.jdField_e_of_type_Int = 8;
          ((azpg)localObject).a(localazpg);
        }
      }
    }
    this.jdField_a_of_type_Azsf = xap.a(localQQAppInterface, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, 0, false, false, this.jdField_a_of_type_Xbd);
    b(1);
    this.f = awzw.a();
    bamh.b();
  }
  ...
  protected void g()
  {
    ...
    if (localQQAppInterface == null)
    {
      azsr.a("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] startDownload app=null");
      this.jdField_a_of_type_Azsd.jdField_c_of_type_Int = 9;
      this.jdField_a_of_type_Azsd.jdField_d_of_type_Int = 902;
      a(true, bami.jdField_b_of_type_Int, bami.w, 1);
      return;
    ...
    String str = "/ftn_handler/" + this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.DownloadUrl + "/?fname=" + bbdm.b(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FilePath);
    ...
    {
      this.jdField_c_of_type_Long = System.currentTimeMillis();
      this.jdField_a_of_type_Azsd.jdField_a_of_type_Long = apvb.a(this.jdField_d_of_type_JavaLangString);
      l = azsp.a();
      boolean bool2 = false;
      Object localObject2 = null;
      bool1 = bool2;
      localObject1 = localObject2;
      if (bakj.b(localQQAppInterface))
      {
        bool1 = bool2;
        localObject1 = localObject2;
        if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.DownloadDNS))
  ...
  protected void h()
  {
    ...
    {
      azsr.a("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "]  file size check fail. filesize:" + this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal + " transSize:" + l);
      a(7, 704);
      a(true, bami.jdField_b_of_type_Int, bami.q, 305);
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        if (bbdj.a(this.jdField_e_of_type_JavaLangString)) {
          this.jdField_e_of_type_JavaLangString = apue.b(this.jdField_e_of_type_JavaLangString);
        }
        if (apue.a(new VFSFile(this.jdField_d_of_type_JavaLangString), new VFSFile(this.jdField_e_of_type_JavaLangString))) {
          break;
        }
        azsr.a("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] renameFile fail  mFilePath:" + this.jdField_e_of_type_JavaLangString);
        a(7, 706);
        a(true, bami.jdField_b_of_type_Int, bami.o, 307);
        return;
        if (i > j)
        {
      ...
      azsr.c("TroopFileDownloadWorker", azsr.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onDownlaodSuc  mFilePath:" + this.jdField_e_of_type_JavaLangString);
  ...
  protected final void k()
  {
    ...
    for (this.jdField_a_of_type_Azsd.g = 1;; this.jdField_a_of_type_Azsd.g = 0)
    {
      azsc.b(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, "actGroupFileDownDetail", this.jdField_a_of_type_Azsd);
      return;
    }
  }
}
