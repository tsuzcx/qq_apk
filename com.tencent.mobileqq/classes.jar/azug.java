  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof RelativeLayout)))
    {
      ...
      if (paramContext != null)
      {
        ...
        paramBundle.rightMargin = aekt.a(7.5F, localResources);
        if (paramView.findViewById(1) == null) {
          break label873;
        }
        paramBundle.addRule(1, 1);
        paramContext.setPadding(aekt.a(7.5F, localResources), 0, 0, 0);
        label130:
    ...
    {
      a(paramView);
      paramView.setPadding(aekt.a(11.0F, localResources), 0, aekt.a(11.0F, localResources), 0);
      return paramView;
      label175:
      paramView = (azqj)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      ...
      ((azvd)paramView).c("28");
      ((azvd)paramView).a(true);
      if (this.l != 0) {
        ((azvd)paramView).a(a(), this.l);
      }
      for (;;)
      {
        ...
        paramView.setLayoutParams((ViewGroup.LayoutParams)localObject);
        break;
        ((azvd)paramView).b("black");
      }
      localRelativeLayout = new RelativeLayout(paramContext);
      localRelativeLayout.setLayoutParams(new RelativeLayout.LayoutParams(-1, aekt.a(40.0F, localResources)));
      i = 0;
      paramView = localRelativeLayout;
      if (i >= j) {
        break label67;
      ...
      if ("picture".equals(localObject))
      {
        ...
        paramView.setId(1);
        localObject = new RelativeLayout.LayoutParams(aekt.a(40.0F, localResources), aekt.a(30.0F, localResources));
        ((RelativeLayout.LayoutParams)localObject).addRule(9, -1);
        ((RelativeLayout.LayoutParams)localObject).addRule(15, -1);
      ...
      for (;;)
      {
        ...
        int m = aekt.a(89.5F, localResources);
