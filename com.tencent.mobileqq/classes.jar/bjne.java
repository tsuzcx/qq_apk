  ...
  implements View.OnTouchListener
{
  ...
  private ScaleGestureDetector.OnScaleGestureListener jdField_a_of_type_AndroidViewScaleGestureDetector$OnScaleGestureListener = new bjnf(this);
  private ScaleGestureDetector jdField_a_of_type_AndroidViewScaleGestureDetector;
  private VelocityTracker jdField_a_of_type_AndroidViewVelocityTracker;
  private View jdField_a_of_type_AndroidViewView;
  private bjna jdField_a_of_type_Bjna;
  ...
  public bjne(View paramView, Context paramContext, bjna parambjna, bjno parambjno)
  {
    this.jdField_a_of_type_Bjna = parambjna;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Int = parambjno.a();
    this.jdField_b_of_type_Int = parambjno.b();
    this.jdField_c_of_type_Int = parambjno.d();
  ...
  private void a(float paramFloat1, float paramFloat2)
  {
    if (this.jdField_a_of_type_Bjna != null) {
      this.jdField_a_of_type_Bjna.a(paramFloat1, paramFloat2);
    }
    this.g += paramFloat1;
    this.h += paramFloat2;
    if (this.g > 90.0F) {
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    while (paramMotionEvent.getAction() != 2)
    {
      ...
      if (paramMotionEvent.getAction() == 1)
      {
        ...
        if ((Math.abs(f1 - this.i) <= m) && (Math.abs(f2 - this.j) <= m) && (this.jdField_a_of_type_Bjna != null)) {
          this.jdField_a_of_type_Bjna.a();
        }
