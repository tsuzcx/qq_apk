  ...
  implements TextWatcher, View.OnClickListener
{
  ...
  public bmui(@NonNull Context paramContext, bmix parambmix)
  {
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(getContext()).inflate(2131561417, null));
    this.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentWidgetXEditText = ((XEditTextEx)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365835));
    ...
    this.jdField_a_of_type_Wfh = new wfh(getContext(), this.jdField_a_of_type_AndroidViewViewGroup, new bmuj(this));
    this.jdField_a_of_type_Wfh.a(this.jdField_a_of_type_AndroidContentContext.getString(2131690626));
  }
  
  public void a(String paramString, boolean paramBoolean)
  {
    super.setOnShowListener(new bmuk(this, paramBoolean));
    super.show();
    if (paramString != null)
    {
