...
public class agfo
{
  ...
  {
    SpannableString localSpannableString = new SpannableString(anni.a(2131715520) + this.jdField_a_of_type_JavaLangString);
  ...
  public void a(QQAppInterface paramQQAppInterface, ColorStateList paramColorStateList, agfp paramagfp)
  {
    this.jdField_a_of_type_AndroidContentResColorStateList = paramColorStateList;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaUtilTimer = new Timer();
    this.jdField_a_of_type_Agfp = paramagfp;
  }
