  ...
  implements View.OnTouchListener
{
  ...
  public String a(int paramInt, String paramString1, String paramString2)
  {
    ...
    Map localMap = blhn.a(paramString1);
    ...
    paramString1 = blhn.a(paramString1, "s", paramString2);
  ...
  {
    return a(4, paramString, bdep.b(BaseApplicationImpl.getContext()), bdep.a(BaseApplicationImpl.getContext()), 0, 0);
  }
  ...
  String a(String paramString1, long paramLong, boolean paramBoolean1, boolean paramBoolean2, String paramString2)
  {
    ...
    {
      i = 1;
      j = bdep.b(BaseApplicationImpl.getContext());
      k = bdep.a(BaseApplicationImpl.getContext());
      str = paramString2;
    ...
    for (;;)
    {
      ...
      {
        acvc.d("GdtMotiveVideoClickCoordinateReportHelper", "getReportString error", localException);
        continue;
      }
  ...
  public String a(String paramString, acrw paramacrw)
  {
    if (paramacrw == null)
    {
    ...
    try
    {
      ...
      localJSONObject.put("aa", String.valueOf(this.jdField_a_of_type_Int - paramacrw.c));
      localJSONObject.put("ab", String.valueOf(this.jdField_b_of_type_Int - paramacrw.d));
      localJSONObject.put("ba", String.valueOf(this.c - paramacrw.c));
      localJSONObject.put("bb", String.valueOf(this.d - paramacrw.d));
      localJSONObject.put("d", "0");
      localJSONObject.put("p", "0");
      localJSONObject.put("f", "0");
      localJSONObject.put("x", "1");
      localJSONObject.put("db", String.valueOf(paramacrw.jdField_b_of_type_Int));
      localJSONObject.put("da", String.valueOf(paramacrw.jdField_a_of_type_Int));
      localJSONObject.put("px", String.valueOf(paramacrw.c));
      localJSONObject.put("py", String.valueOf(paramacrw.d));
      return a(1, paramString, localJSONObject.toString());
    }
    catch (Exception paramacrw)
    {
      for (;;)
      {
        acvc.d("GdtMotiveVideoClickCoordinateReportHelper", "getReportString error", paramacrw);
      }
    }
  }
  ...
  public void a()
  {
    this.jdField_a_of_type_Acrx = null;
  ...
  public String b(String paramString, acrw paramacrw)
  {
    if (paramacrw == null)
    {
    ...
    return a(2, paramString, paramacrw.jdField_a_of_type_Int, paramacrw.jdField_b_of_type_Int, paramacrw.c, paramacrw.d);
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Acrx != null) {
        this.jdField_a_of_type_Acrx.a(this.jdField_a_of_type_Long, this.jdField_b_of_type_Long, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.c, this.d);
      }
    }
  }
}
