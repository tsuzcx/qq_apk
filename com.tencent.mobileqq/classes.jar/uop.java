...
public class uop
  extends TimerTask
{
  public uop(DoodleMsgView paramDoodleMsgView, long paramLong1, long paramLong2) {}
  
  public void run()
  {
    if (DoodleMsgView.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioDoodleDoodleMsgView) == null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioDoodleDoodleMsgView.a(new uoq(this));
    }
    do
    {
      return;
