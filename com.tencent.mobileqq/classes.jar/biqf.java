  ...
  extends AutoCompleteTextView
{
  ...
  public biqf(NewStyleDropdownView paramNewStyleDropdownView, Context paramContext)
  {
    super(paramContext);
    setId(526);
  ...
  public biqf(NewStyleDropdownView paramNewStyleDropdownView, Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  public biqf(NewStyleDropdownView paramNewStyleDropdownView, Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
      ...
      try
      {
        for (;;)
        {
          ...
          if ((localObject2 instanceof PopupWindow)) {
            ((PopupWindow)localObject2).setAnimationStyle(2130772300);
          }
