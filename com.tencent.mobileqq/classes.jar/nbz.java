...
public class nbz
{
  ...
  private void a(ArrayList<TroopAppInfo> paramArrayList)
  {
    if (this.jdField_a_of_type_Ncc != null) {
      this.jdField_a_of_type_Ncc.a(paramArrayList);
    }
  }
  ...
  private void a(List<Long> paramList)
  {
    ...
    ((NewIntent)localObject).setObserver(new ncb(this));
  ...
  public void a()
  {
    this.jdField_a_of_type_Ncc = null;
    this.jdField_a_of_type_Boolean = true;
  }
  
  public boolean a(String paramString, ncc paramncc)
  {
    return a(paramString, paramncc, false);
  }
  
  public boolean a(String paramString, ncc paramncc, boolean paramBoolean)
  {
    this.jdField_a_of_type_Ncc = paramncc;
    paramncc = new oidb_0x8cf.ReqBody();
    try
    {
      paramncc.opt_uint64_groupcode.set(Long.parseLong(paramString));
      paramncc.opt_uint32_need_mobile_sysapps.set(1);
      paramString = new oidb_sso.OIDBSSOPkg();
      paramString.uint32_command.set(2255);
      paramString.uint32_service_type.set(6);
      paramString.bytes_bodybuffer.set(ByteStringMicro.copyFrom(paramncc.toByteArray()));
      paramncc = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), mxe.class);
      paramncc.putExtra("cmd", "OidbSvc.0x8cf_6");
      paramncc.putExtra("data", paramString.toByteArray());
      paramncc.setObserver(new nca(this, paramBoolean));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet(paramncc);
      return true;
    }
    catch (NumberFormatException paramncc)
    {
