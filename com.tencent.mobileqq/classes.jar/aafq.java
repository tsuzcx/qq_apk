...
public class aafq
{
  ...
  public aafq()
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new aafr(this);
    this.jdField_a_of_type_MqqAppAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    this.c = false;
  }
  
  public aafq(Activity paramActivity)
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new aafr(this);
  ...
  public aafq(Activity paramActivity, aafs paramaafs)
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new aafr(this);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Aafs = paramaafs;
    if ((this.jdField_a_of_type_AndroidAppActivity instanceof AppActivity))
    {
      this.jdField_a_of_type_MqqAppAppRuntime = ((AppActivity)this.jdField_a_of_type_AndroidAppActivity).getAppRuntime();
      this.c = true;
  ...
  public static String a(Resources paramResources, LightAppSettingInfo paramLightAppSettingInfo, String paramString)
  {
    ...
    {
      str = paramResources.getString(2131691627);
    }
    if ((!TextUtils.isEmpty(paramLightAppSettingInfo.b)) && (!TextUtils.isEmpty(paramLightAppSettingInfo.jdField_a_of_type_JavaLangString)) && (bfms.a(paramLightAppSettingInfo.b))) {
      return paramResources.getString(2131691629, new Object[] { str });
    }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    {
      bfms.a(paramActivity, paramString1);
      return;
    }
    ...
    bfir.b(paramActivity, localBundle);
  }
  ...
  private void d()
  {
    ...
    {
      aagc.a((String)localObject, localBundle, this.jdField_a_of_type_MqqAppAppRuntime, this.jdField_a_of_type_MqqObserverBusinessObserver);
      return;
    }
  }
  ...
  public LightAppSettingInfo a(DeviceInfo paramDeviceInfo)
  {
    ...
    if (localLightAppSettingInfo2 == null)
    {
      ...
      if (!this.c)
      {
        ...
        {
          a(((ztp)((QQAppInterface)localAppRuntime).a(51)).a());
  ...
  public void a()
  {
    ...
    {
      localObject1 = ((ztp)((QQAppInterface)localObject1).a(51)).a();
  ...
  public void a(DeviceInfo paramDeviceInfo, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    {
      if (this.jdField_a_of_type_Aafs != null) {
        this.jdField_a_of_type_Aafs.a(false);
      }
      return;
    }
    if (paramBundle != null) {}
    for (boolean bool = paramBundle.getBoolean("showProgress", true);; bool = true)
    {
      ...
      for (;;)
      {
        if ((str == null) && (0 == 0))
        {
          ...
          aagb.a(null, "Net_LiteApp_Setting", 0, 1, localLightAppSettingInfo.jdField_c_of_type_Int);
          if (str != null) {
            break label713;
          }
          ...
          this.jdField_a_of_type_Aafs.a(true);
          return;
        ...
        for (Intent localIntent = new Intent();; localIntent = null)
        {
          ...
          for (;;)
          {
            ...
            break;
            localIntent.putExtra("uinname", aagc.a(paramDeviceInfo));
          }
          label713:
          ...
          bkce.a().a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_MqqAppAppRuntime, this.jdField_a_of_type_MqqAppAppRuntime.getAccount(), paramDeviceInfo, str, -1, null, SmartDevicePluginProxyActivity.class);
          break label247;
          label794:
          break;
          ...
          bflz.a().a(2131691632);
          if ((this.jdField_a_of_type_Bety != null) && (!this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
  ...
  protected void b()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Bety.c(2131691631);
      this.jdField_a_of_type_Bety.show();
    }
    while (this.jdField_a_of_type_MqqAppAppRuntime == null)
    {
      bflp.d("LightAppUtil", "app == null when dologin");
      if (this.jdField_a_of_type_Aafs != null) {
        this.jdField_a_of_type_Aafs.a(false);
      }
      return;
