...
public class amtz
{
  public static void a(AppInterface paramAppInterface, int paramInt, String paramString, amua paramamua)
  {
    ...
    try
    {
      ...
      paramString = new NewIntent(BaseApplicationImpl.getContext(), amrc.class);
      ...
      paramString.setObserver(paramamua);
