...
public class aube
  implements bfph
{
  public aube(OCRResultFragmentNew paramOCRResultFragmentNew, List paramList, auaf paramauaf) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    if (paramInt < this.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      if (!paramView.equalsIgnoreCase(this.jdField_a_of_type_Auaf.a)) {
        break label108;
      }
    ...
    for (;;)
    {
      ...
      return;
      label108:
      bcql.a(OCRResultFragmentNew.a(this.jdField_a_of_type_ComTencentMobileqqOcrOCRResultFragmentNew), 0, 2131699247, 0).a();
      auad.a.a(paramView);
      try
      {
        if (QLog.isColorLevel()) {
          QLog.i("OCRResultFragmentNew", 2, "requestOcr lan:" + paramView + ", ctx:" + auad.a.a());
        }
        OCRResultFragmentNew.a(this.jdField_a_of_type_ComTencentMobileqqOcrOCRResultFragmentNew, auad.a);
      }
