...
public class bmpu
  implements bmmx<bmmg>
{
  int jdField_a_of_type_Int;
  long jdField_a_of_type_Long;
  int b;
  
  private bmpu(DoodleLayout paramDoodleLayout) {}
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    ((AlphaAnimation)localObject).setAnimationListener(new bmpv(this));
    ...
    localAlphaAnimation.setAnimationListener(new bmpw(this));
    if (paramBoolean2) {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_Bmpo != null) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_Bmpo.b((Animation)localObject);
      }
      return;
    }
  }
  
  public boolean a(bmmg parambmmg, MotionEvent paramMotionEvent)
  {
    bnao localbnao = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.a();
    if (localbnao != null) {}
    int i;
    int j;
    switch (localbnao.jdField_a_of_type_Int)
    {
    default: 
    ...
    do
    {
      do
      {
        do
        {
          return false;
          i = localbnao.b;
          if (i != bmrh.jdField_a_of_type_Int) {
          ...
          for (;;)
          {
            localObject = (bmrh)parambmmg.a(101);
            if (localObject != null) {
              ((bmrh)localObject).a(i);
            }
            if (parambmmg.b()) {
              break;
            }
          ...
          parambmmg.a((AppInterface)localObject, 2, localbnao.b);
          break;
