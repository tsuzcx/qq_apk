...
public class bjtt
{
  ...
  public static Bitmap a(java.lang.String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    //   38: aload 4
    //   40: areturn
    //   41: invokestatic 42	bjtt:a	()Landroid/graphics/BitmapFactory$Options;
    //   44: astore 11
    ...
    //   114: iload_2
    //   115: iload_3
    //   116: invokestatic 59	bjtt:a	(Landroid/graphics/BitmapFactory$Options;IIZ)Landroid/graphics/BitmapFactory$Options;
    //   119: pop
    //   120: aload 5
    //   122: astore_0
    //   123: aload 5
    ...
    //   225: aload 11
    //   227: iload_3
    //   228: invokestatic 80	bjtt:a	(Landroid/graphics/Bitmap;IILandroid/graphics/BitmapFactory$Options;Z)Landroid/graphics/Bitmap;
    //   231: astore 6
    //   233: aload 6
    //   235: astore 4
    //   237: aload 5
