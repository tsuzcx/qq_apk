...
public class bjtt
  extends bjts
{
  private static CopyOnWriteArrayList<bjtu> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  private bjtu a()
  {
    ...
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 38	bjtu:<init>	(Lbjtt;)V
    //   8: astore 8
    //   10: aload 8
    //   12: aload_0
    //   13: getfield 41	bjtt:jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin	Lcom/tencent/mobileqq/webview/swift/WebViewPlugin;
    //   16: getfield 47	com/tencent/mobileqq/webview/swift/WebViewPlugin:mRuntime	Lbecq;
    //   19: invokevirtual 52	becq:a	()Lcom/tencent/common/app/AppInterface;
    //   22: invokevirtual 58	com/tencent/common/app/AppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   25: putfield 61	bjtu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   46: aload 8
    //   48: getfield 61	bjtu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   188: aload 5
    //   190: astore 4
    //   192: getstatic 28	bjtt:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   195: aload 8
    ...
    //   234: iconst_0
    //   235: invokestatic 150	com/tencent/mobileqq/utils/SecurityUtile:b	(Ljava/lang/String;Z)Ljava/lang/String;
    //   238: astore 9
    //   240: aload 5
    //   242: astore 4
    //   244: aload 5
    ...
    //   284: iconst_0
    //   285: invokestatic 150	com/tencent/mobileqq/utils/SecurityUtile:b	(Ljava/lang/String;Z)Ljava/lang/String;
    //   288: astore 6
    //   290: aload 5
    //   292: astore 4
    //   294: aload 8
    //   296: getfield 153	bjtu:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   299: aload 9
    //   301: aload 6
    ...
    //   411: iconst_0
    //   412: invokestatic 150	com/tencent/mobileqq/utils/SecurityUtile:b	(Ljava/lang/String;Z)Ljava/lang/String;
    //   415: astore 7
    //   417: aload 7
    //   419: astore 6
    //   421: aload 5
    ...
    //   480: astore 4
    //   482: aload 8
    //   484: getfield 153	bjtu:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   487: aload 9
    //   489: aload 6
  ...
  private boolean a(String paramString)
  {
    ...
    for (;;)
    {
            ...
            if (!TextUtils.isEmpty(str4))
            {
              ...
              if (i == 1)
              {
                ...
                if (!TextUtils.isEmpty(str5))
                {
                  ...
                  {
                    ((PublishEventTag)localObject3).b = "http://qzonestyle.gtimg.cn/aoi/sola/20170323194618_Xgy5reWQh0.png";
      ...
      {
        localObject4 = bjut.a((Context)localObject3, (String)localObject4);
    ...
    if ("signInSuccess".equals(paramString3))
    {
      try
      {
        ...
        if (paramString3.optBoolean("shareToWX"))
        {
          ...
          bjmn.a().a().a(paramString1, paramJsBridgeListener, paramString2, paramString3);
