  ...
  implements View.OnClickListener
{
  ...
  public aiew(PhotoListPanel paramPhotoListPanel) {}
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aiez == null) {}
    ...
    for (;;)
    {
      ...
      Object localObject;
      long l1;
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aiez.getItemCount() > 0)
      {
        localLocalMediaInfo = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aiez.a(this.jdField_a_of_type_Int);
        j = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aiez.getItemViewType(this.jdField_a_of_type_Int);
        if ((!localLocalMediaInfo.mChecked) && (bhkd.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_JavaUtilLinkedList, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_AndroidAppActivity, PhotoListPanel.jdField_a_of_type_Int)))
        {
        ...
        else
        {
          ...
          String str;
          for (i = 0; ((Iterator)localObject).hasNext(); i = (int)(i + bhmi.a(str))) {
            str = (String)((Iterator)localObject).next();
          }
          if (i + bhmi.a(localLocalMediaInfo.path) <= 52428800L) {
            break label316;
          }
          localObject = (abur)this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51);
          if ((localObject == null) || (!((abur)localObject).a())) {
            break label316;
          }
          l1 = 0L;
        }
      ...
      if (!((abur)localObject).a(l1, 1)) {
        break label316;
      }
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_AndroidAppActivity, "选择图片总大小不能超过50M", 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.getResources().getDimensionPixelSize(2131299011));
      this.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(localLocalMediaInfo.mChecked);
    }
    label316:
    boolean bool;
    if (!localLocalMediaInfo.mChecked)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aiex != null) {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aiex.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.a());
      }
      ...
      bdll.b(null, "CliOper", "", "", "0X8005E08", "0X8005E08", 0, 0, "", "", "", "");
