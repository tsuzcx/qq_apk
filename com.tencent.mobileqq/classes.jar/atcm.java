  ...
  extends asyw
{
  ...
  protected void b(boolean paramBoolean, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt2, String paramString6, long paramLong, Bundle paramBundle)
  {
    ...
    atcn localatcn = atcl.a(this.a, paramLong, false);
    if (localatcn == null)
    {
    ...
    if (!paramBoolean)
    {
      this.a.a.a().a(false, 50, new Object[] { localatcn.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity });
      this.a.a(paramLong);
      this.a.a(paramLong, false, null, 0, null, null, paramString2, false, null, (short)0, null);
      return;
    }
    ...
    paramString5 = "/ftn_video_pic/rkey=" + paramString3 + "&filetype=" + localatcn.b + "&size=" + this.a.a(localatcn.jdField_a_of_type_Int) + "&";
    paramBoolean = false;
    short s1 = 0;
    if ((atgz.h(this.a.a)) && (paramBundle != null))
    {
