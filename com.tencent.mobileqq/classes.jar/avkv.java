...
public class avkv
  extends ajus
{
  public avkv(ActiveEntitySearchFragment paramActiveEntitySearchFragment) {}
  ...
  public void a(String paramString1, boolean paramBoolean, String paramString2, int paramInt, String paramString3, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      try
      {
        this.a.jdField_a_of_type_AndroidGraphicsBitmap = BitmapFactory.decodeResource(this.a.getResources(), 2130841726);
        this.a.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(this.a.jdField_a_of_type_AndroidGraphicsBitmap);
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(ajjy.a(2131633979));
        this.a.g.setOnClickListener(new avkx(this));
      ...
      this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new avky(this));
    }
  }
  ...
  public void a(String paramString1, boolean paramBoolean1, String paramString2, byte[] paramArrayOfByte, boolean paramBoolean2, List<avom> paramList, long[] paramArrayOfLong, String paramString3, List<DynamicTabSearch.SubHotWord> paramList1, boolean paramBoolean3, String paramString4)
  {
    ...
    {
      localObject2 = (avom)((Iterator)localObject1).next();
      if (((avom)localObject2).a() == null) {
        break label3403;
      }
      if (!(localObject2 instanceof avnk)) {
        break label3400;
      }
      localObject3 = (avnk)localObject2;
      localObject4 = ((avnk)localObject3).a();
      Iterator localIterator = ((List)localObject4).iterator();
      while (localIterator.hasNext())
      {
        Object localObject5 = (avon)localIterator.next();
        if ((localObject5 instanceof avnl))
        {
          localObject5 = (avnl)localObject5;
          if (ActiveEntitySearchActivity.b) {
            ((avnl)localObject5).l = 1;
          }
          paramString2.add(Long.valueOf(((avnl)localObject5).d()));
        }
      }
      if (l1 != -1L) {
        break label3397;
      }
      l1 = ((avnk)localObject3).a;
      l2 = ((avnk)localObject3).a;
      if ((((List)localObject4).size() > 0) && (((avnk)localObject3).a == 1001L))
      {
        awqx.b(null, "dc00898", "", "", "0X800A339", "0X800A339", 1, 0, "", "", "", "");
        i = j + ((avom)localObject2).a().size();
        l3 = l1;
        l1 = l2;
        l2 = l3;
      }
    ...
    for (;;)
    {
      ...
      j = i;
      break label363;
      if ((((List)localObject4).size() > 0) && (((avnk)localObject3).a == 1002L)) {
        awqx.b(null, "dc00898", "", "", "0X800A339", "0X800A339", 2, 0, "", "", "", "");
      }
      break label572;
      ...
      if (!paramBoolean1)
      {
        ...
        avwf.a("sub_result", "load_result", new String[] { this.a.jdField_b_of_type_JavaLangString, avwf.a(paramString3), "", avwf.a("dynamic_tab_search.1", this.a.jdField_a_of_type_ArrayOfLong) });
      }
      ...
      {
        bool1 = true;
        avwa.a(paramString2, paramList, bool1, this.a.jdField_a_of_type_ArrayOfLong, this.a.jdField_e_of_type_JavaLangString, this.a.jdField_b_of_type_JavaLangString);
        if (j != 0) {
          break label1347;
        }
        if ((this.a.getActivity() instanceof aviu)) {}
        switch (((aviu)this.a.getActivity()).a())
        {
        case 2: 
        default: 
          if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        bool1 = false;
        break;
        avwf.a("sub_result", "no_result", new String[] { this.a.jdField_b_of_type_JavaLangString, avwf.a(this.a.jdField_a_of_type_ArrayOfLong), "", avwf.a("dynamic_tab_search.1", paramArrayOfLong) });
        break label892;
        avwf.a("all_result", "exp_tab_empty", new String[] { this.a.jdField_b_of_type_JavaLangString, avwf.a(this.a.jdField_a_of_type_ArrayOfLong), "", avwf.a("dynamic_tab_search.1", paramArrayOfLong) });
        break label892;
        if ((this.a.jdField_a_of_type_ArrayOfByte != null) || (!(this.a.getActivity() instanceof aviu))) {
          break label892;
        }
        paramString2 = (aviu)this.a.getActivity();
        ...
        default: 
          break;
        case 1: 
          avwf.a("all_result", "exp_tab_page", new String[] { this.a.jdField_b_of_type_JavaLangString, avwf.a(this.a.jdField_b_of_type_JavaUtilList), "", avwf.a("UnifySearch.Unite", paramString2.a()) });
          break;
        case 3: 
          avwf.a("sub_result", "exp_result", new String[] { paramString2.a(), avwf.a(this.a.jdField_b_of_type_JavaUtilList), "", avwf.a("dynamic_tab_search.1", paramString2.a()) });
          break;
          if (QLog.isColorLevel()) {
      ...
      if ((!TextUtils.isEmpty(ActiveEntitySearchFragment.a(this.a))) && (ActiveEntitySearchFragment.a(this.a).size() > 0))
      {
        ...
        k = azvv.a(paramString3, 8.0F);
        m = azvv.a(paramString3, 10.0F);
        int n = azvv.a(paramString3, 2.0F);
        paramList1 = new GradientDrawable();
        paramList1.setCornerRadius(azvv.a(this.a.getActivity(), 15.0F));
        ...
        while (paramString4.hasNext())
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ...
            for (;;)
            {
              ...
              ((TextView)localObject3).setTag(2131302015, localObject1);
        ...
        if (this.a.jdField_a_of_type_AndroidWidgetLinearLayout.getChildCount() == 0)
        {
          ...
          paramString2 = avjb.a(paramList, paramBoolean1, this.a.jdField_f_of_type_Boolean);
          if ((paramBoolean1) || (l1 != ActiveEntitySearchFragment.a(this.a)) || (paramBoolean3) || (paramString2 == null) || (paramString2.size() <= 0)) {
            break label2428;
          }
          paramArrayOfByte = (avol)this.a.jdField_a_of_type_JavaUtilList.get(this.a.jdField_a_of_type_JavaUtilList.size() - 1);
          ...
          if (!((avol)paramString2.get(i) instanceof avnu)) {
            break label2415;
          }
        }
      }
      for (;;)
      {
        if ((paramArrayOfByte instanceof avon))
        {
          paramArrayOfByte = (avon)paramArrayOfByte;
          k = paramArrayOfByte.a();
          avwi.a(paramArrayOfByte, k + i, k - 1);
        }
        for (;;)
        {
          m = 0;
          for (;;)
          {
            if (m < i)
            {
              paramArrayOfByte = (avol)paramString2.get(m);
              if ((paramArrayOfByte instanceof avon)) {
                avwi.a((avon)paramArrayOfByte, k + i, k + m);
              }
              m += 1;
              continue;
          ...
          this.a.jdField_a_of_type_Avkq.a(this.a.jdField_a_of_type_JavaUtilList);
          ...
          for (;;)
          {
            ...
            {
              this.a.g.setVisibility(0);
              paramString3 = (ajls)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
              if ((!bool1) && (paramString3.jdField_d_of_type_Boolean)) {
                if (this.a.jdField_a_of_type_Aesj == null)
                {
                  this.a.jdField_a_of_type_Aesj = new aesn(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.getActivity(), this.a.jdField_b_of_type_ComTencentWidgetXListView, null);
                  paramString2 = this.a.jdField_a_of_type_Aesj.a();
                  paramArrayOfByte = new TextView(this.a.getActivity());
                  paramArrayOfByte.setGravity(17);
                  paramArrayOfByte.setLayoutParams(new AbsListView.LayoutParams(-1, aciy.a(105.0F, this.a.getResources())));
                  paramArrayOfByte.setTextColor(this.a.getResources().getColor(2131101336));
                  paramArrayOfByte.setTextSize(1, 17.0F);
                  paramArrayOfByte.setText(ajjy.a(2131633983));
                  paramArrayOfByte.setBackgroundResource(2130838504);
                  paramString2.addHeaderView(paramArrayOfByte);
                  paramArrayOfByte = new TextView(this.a.getActivity());
                  paramArrayOfByte.setTextColor(this.a.getResources().getColor(2131101336));
                  paramArrayOfByte.setTextSize(1, 14.0F);
                  paramArrayOfByte.setGravity(16);
                  paramArrayOfByte.setPadding(aciy.a(15.0F, this.a.getResources()), 0, 0, 0);
                  paramArrayOfByte.setLayoutParams(new AbsListView.LayoutParams(-1, aciy.a(40.0F, this.a.getResources())));
                  paramArrayOfByte.setText(ajjy.a(2131633981));
                  paramArrayOfByte.setBackgroundResource(2130838504);
                  paramString2.addHeaderView(paramArrayOfByte);
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                this.a.jdField_a_of_type_Avkq.a(this.a.jdField_a_of_type_JavaUtilList);
                break;
                this.a.jdField_a_of_type_Aesj.b();
                break label2965;
                ...
                try
                {
                  ...
                  this.a.jdField_b_of_type_AndroidWidgetTextView.setText(ajjy.a(2131633974));
                  if (bool1)
                  {
                    this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
                    this.a.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new avkw(this, paramString2));
                    if (TextUtils.isEmpty(paramArrayOfByte)) {
                      break label2976;
                    }
                    this.a.jdField_a_of_type_AndroidWidgetButton.setText(paramArrayOfByte);
                    this.a.jdField_b_of_type_AndroidWidgetTextView.setPadding(0, azvv.a(this.a.jdField_b_of_type_AndroidWidgetTextView.getContext(), 15.0F), 0, 0);
                  }
                }
