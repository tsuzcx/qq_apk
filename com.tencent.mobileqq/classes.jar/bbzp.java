  ...
  implements Manager
{
  ...
  public static HashMap<String, bbzt> a;
  public static String[] a;
  bbwf jdField_a_of_type_Bbwf = new bbzq(this);
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = ajsf.aW + "voiceChange/";
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { null, null, null };
  }
  
  public bbzp(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3)
  {
    ...
    //   12: istore_0
    //   13: getstatic 24	bbzp:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   16: aload_1
    //   17: invokevirtual 75	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   20: checkcast 77	bbzt
    //   23: astore 7
    //   25: aload 7
    //   27: ifnull +88 -> 115
    //   30: aload 7
    //   32: getfield 80	bbzt:jdField_a_of_type_Bbzu	Lbbzu;
    //   35: ifnull +84 -> 119
    //   38: aload_1
    //   39: aload_2
    //   40: iload_3
    //   41: invokestatic 85	bbzv:a	(Ljava/lang/String;Ljava/lang/String;I)V
    //   44: aload 7
    //   46: getfield 80	bbzt:jdField_a_of_type_Bbzu	Lbbzu;
    //   49: aload_1
    //   50: iload 4
    //   52: iload_0
    ...
    //   107: getstatic 24	bbzp:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   110: aload_1
    ...
    //   119: aload 7
    //   121: iconst_1
    //   122: putfield 117	bbzt:jdField_a_of_type_Boolean	Z
    //   125: aload 7
    //   127: iload_0
    //   128: putfield 120	bbzt:jdField_a_of_type_Int	I
    //   131: goto -16 -> 115
    //   134: astore_1
    //   135: ldc 2
    //   137: monitorexit
  ...
  public static void a(Context paramContext, bbzm parambbzm, String paramString, bbzl parambbzl)
  {
    if ((bbzt)jdField_a_of_type_JavaUtilHashMap.get(parambbzm.jdField_a_of_type_JavaLangString) == null) {
      b(paramContext, parambbzm, paramString, parambbzl);
    }
    ((bbzt)jdField_a_of_type_JavaUtilHashMap.get(parambbzm.jdField_a_of_type_JavaLangString)).jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.c();
  }
  
  public static void a(Context paramContext, bbzm parambbzm, String paramString, bbzl parambbzl, bbzr parambbzr)
  {
    bbzt localbbzt = (bbzt)jdField_a_of_type_JavaUtilHashMap.get(parambbzm.jdField_a_of_type_JavaLangString);
    if (localbbzt != null) {
      localbbzt.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.jdField_a_of_type_Boolean = false;
    }
    localbbzt = new bbzt();
    localbbzt.jdField_a_of_type_Bbzm = parambbzm;
    localbbzt.jdField_a_of_type_Bbzr = parambbzr;
    localbbzt.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread = new QQVoiceChangerThread(paramContext, parambbzm, parambbzr, paramString, parambbzl);
    jdField_a_of_type_JavaUtilHashMap.put(parambbzm.jdField_a_of_type_JavaLangString, localbbzt);
    localbbzt.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.start();
  }
  
  public static void a(bbzm parambbzm)
  {
    bbzt localbbzt = (bbzt)jdField_a_of_type_JavaUtilHashMap.get(parambbzm.jdField_a_of_type_JavaLangString);
    if (localbbzt != null)
    {
      localbbzt.jdField_a_of_type_ComTencentMobileqqVoicechangeQQVoiceChangerThread.d();
      jdField_a_of_type_JavaUtilHashMap.remove(parambbzm.jdField_a_of_type_JavaLangString);
    }
  }
  
  public static boolean a(String paramString, bbzu parambbzu)
  {
    for (;;)
    {
      try
      {
        ...
        bbzt localbbzt = (bbzt)jdField_a_of_type_JavaUtilHashMap.get(paramString);
        if (localbbzt == null)
        {
          if (QLog.isColorLevel()) {
        ...
        if (localbbzt.jdField_a_of_type_Boolean)
        {
          bbzv.a(paramString, localbbzt.jdField_a_of_type_Bbzm.jdField_a_of_type_JavaLangString, localbbzt.jdField_a_of_type_Bbzm.f);
          jdField_a_of_type_JavaUtilHashMap.remove(paramString);
          parambbzu.a(paramString, localbbzt.jdField_a_of_type_Bbzm.e, localbbzt.jdField_a_of_type_Int);
          if (QLog.isColorLevel()) {
            QLog.d("VoiceChangeManager", 2, "queryStateByPath onCompressFinished filePath=" + paramString + " time=" + localbbzt.jdField_a_of_type_Int + " voiceType=" + localbbzt.jdField_a_of_type_Bbzm.e);
          }
        }
        else
        {
          localbbzt.jdField_a_of_type_Bbzu = parambbzu;
        }
      }
      finally {}
      boolean bool = true;
  ...
  public static void b(Context paramContext, bbzm parambbzm, String paramString, bbzl parambbzl)
  {
    a(paramContext, parambbzm, paramString, parambbzl, bbzr.a());
  }
  
  public static void b(bbzm parambbzm)
  {
    bbzt localbbzt = (bbzt)jdField_a_of_type_JavaUtilHashMap.get(parambbzm.jdField_a_of_type_JavaLangString);
    if (localbbzt != null)
    {
  ...
  public boolean a(ArrayList<bbzn> paramArrayList, JSONObject paramJSONObject)
  {
    boolean bool = bbyt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), "VoiceChangeManager", false);
    if (!bool)
    {
      ...
      if (i < arrayOfInt.length)
      {
        if (arrayOfInt[i] == j)
        {
          ...
          if (i < 0)
          {
            ...
            break label1363;
            this.jdField_a_of_type_Bbwf.onDone(null);
            return true;
          }
        }
        else
        ...
        paramJSONObject = (bbzn)paramArrayList.get(i);
        label687:
        if (paramJSONObject == null)
        {
          if (!QLog.isColorLevel()) {
        ...
        if (j != 0)
        {
          ...
          {
            i = j;
            if (bbpm.a(((JSONObject)localObject2).getString("QQVersion"), "8.2.8"))
            {
              j = 0;
              i = j;
              if (QLog.isColorLevel())
        ...
        for (localObject2 = paramJSONObject.jdField_b_of_type_JavaLangString;; localObject2 = ((JSONObject)localObject4).getString("description"))
        {
          ...
          paramJSONObject.jdField_a_of_type_Bbzo.jdField_a_of_type_JavaLangString = ((String)localObject3);
          break label1363;
          localObject3 = bbnq.jdField_a_of_type_JavaLangString + (String)localObject3;
      ...
      for (;;)
      {
        if (i < paramJSONObject.length)
        {
          ...
          if (localObject1 != null)
          {
            ...
            {
              localObject1 = bbnq.jdField_a_of_type_JavaLangString + (String)localObject1;
