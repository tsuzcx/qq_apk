...
public final class ahoz
  implements Runnable
{
  public ahoz(QQAppInterface paramQQAppInterface) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      String str1 = SharedPreUtils.p(this.a.getApp(), this.a.getCurrentAccountUin());
      str3 = SharedPreUtils.q(this.a.getApp(), this.a.getCurrentAccountUin());
    ...
    if (!RedBagVideoManager.a(str2, this.a))
    {
      ...
      localDownloaderInterface.a(localDownloadTask, new ahpa(this, str3, str4, str2), null);
    }
    for (;;)
    {
      return;
