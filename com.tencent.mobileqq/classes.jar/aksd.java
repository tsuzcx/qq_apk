...
public class aksd
{
  private static aksd jdField_a_of_type_Aksd;
  private aksf jdField_a_of_type_Aksf = new aksf(this, null);
  private aksh jdField_a_of_type_Aksh;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(new akse(this));
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  private aksd(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.registObserver(this.jdField_a_of_type_Aksf);
    }
  }
  
  public static aksd a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Aksd == null) {
      jdField_a_of_type_Aksd = new aksd(paramAppInterface);
    }
    return jdField_a_of_type_Aksd;
  }
  ...
  public static void a()
  {
    if (jdField_a_of_type_Aksd != null)
    {
      jdField_a_of_type_Aksd.b();
      jdField_a_of_type_Aksd = null;
    }
  }
  ...
  private void a(boolean paramBoolean, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Aksh != null)
    {
      ...
      this.jdField_a_of_type_Aksh.a(paramInt, paramBoolean, (ArrayList)localObject);
    }
  }
  ...
  private void b()
  {
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.unRegistObserver(this.jdField_a_of_type_Aksf);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool2)
        {
          ...
          SosoInterface.startLocation(new aksg(this, 0, true, true, 30000L, false, false, "NewFlowCameraActivity", paramInt));
        }
        if (this.jdField_a_of_type_Aksh != null) {
          this.jdField_a_of_type_Aksh.a(paramInt, bool2);
        }
        return;
      }
  ...
  {
    this.jdField_a_of_type_Aksh = paramaksh;
  }
}
