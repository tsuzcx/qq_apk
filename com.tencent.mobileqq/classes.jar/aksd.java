...
public class aksd
{
  ...
  public aksd(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    return akpy.a(paramMessageRecord1.frienduin, paramMessageRecord1.istroop).equals(akpy.a(paramMessageRecord2.frienduin, paramMessageRecord2.istroop));
  }
  ...
  public int a(boolean paramBoolean)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      for (int i = 0; localIterator.hasNext(); i = localMessage.counter + i)
      {
        ...
        if ((localMessage.istroop == 1037) || (localMessage.istroop == 1044) || ((paramBoolean) && (bfnr.a(localMessage)))) {
          break label20;
        }
      }
      return i;
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      if (i >= 0)
      {
        localakse = (akse)localMessage.msgInfoList.get(i);
        if ((localakse.jdField_a_of_type_Int == 3000) || (localakse.jdField_a_of_type_Int == 1))
        {
          if (localakse.c != paramMessageRecord.shmsgseq) {
            break label486;
          }
          j = i;
        }
      ...
      for (;;)
      {
        if (j == -1)
        {
          ...
          return;
          if (localakse.b != paramMessageRecord.msgUid) {
            break;
          }
          j = i;
          if (localakse.c != paramMessageRecord.shmsgseq) {
        ...
        else
        {
          if ((j == k - 1) && (k > 1))
          {
            paramMessageRecord = (akse)localMessage.msgInfoList.get(k - 2);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if (((paramInt == ((QQMessageFacade.Message)localObject2).istroop) || ((akpy.c(paramInt)) && (akpy.c(((QQMessageFacade.Message)localObject2).istroop)))) && (((QQMessageFacade.Message)localObject2).frienduin.equals(paramString)))
        {
          ...
          if (bool1)
          {
            ...
            if ((!bfnr.a(paramInt)) || (!bfnr.a(paramString))) {
              break label309;
            }
            bfnr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(paramString);
          }
          return;
        }
      }
  ...
  public int b(boolean paramBoolean)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      {
        QQMessageFacade.Message localMessage = (QQMessageFacade.Message)localIterator.next();
        if ((localMessage.istroop != 1008) && (localMessage.istroop != 1037) && (localMessage.istroop != 1044) && ((!paramBoolean) || (!bfnr.a(localMessage))))
        {
          if (7000 != localMessage.istroop) {
            break label155;
          }
          ayav localayav = (ayav)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(61);
          if (localayav == null) {
            break label146;
          }
          j = localayav.b(localMessage.frienduin);
          break label148;
        }
      }
      return i;
  ...
  public void b(QQMessageFacade.Message paramMessage)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      if (localObject != null)
      {
        ...
        localObject = new akse(paramMessage.frienduin, paramMessage.istroop, paramMessage.uniseq, paramMessage.msgUid, paramMessage.shmsgseq);
