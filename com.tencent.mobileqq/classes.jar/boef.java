...
{
  public boef(AEEditorCommonEditFragment paramAEEditorCommonEditFragment) {}
  
  public void a(@Nullable List<AEEditorFilterBean> paramList)
  {
    bnzb.b(AEEditorCommonEditFragment.d(), "mFiltersObserver-onChanged");
    ...
    bofw.a().d();
    bofw.a(this.a.getActivity().getApplicationContext());
    this.a.m();
  }
}
