  ...
  implements amwq
{
  ...
  public amsm a;
  public bkti a;
  private AVVideoCtrl.EnableCameraCompleteCallback jdField_a_of_type_ComTencentTMGSdkAVVideoCtrl$EnableCameraCompleteCallback = new ancd(this);
  ...
  public anbz(int paramInt)
  {
    this.jdField_a_of_type_Bkti = new ancc(this);
  ...
  private void a(String[] paramArrayOfString, String paramString)
  {
    ...
    paramArrayOfString = new ancf(this);
    if (QLog.isColorLevel())
    {
      i = j;
      while (i < localArrayList1.size())
    ...
    if ((anmc.a(BaseApplicationImpl.getContext()).a() != null) && (anmc.a(BaseApplicationImpl.getContext()).a().getRoom() != null) && (localArrayList1.size() > 0)) {
      anmc.a(BaseApplicationImpl.getContext()).a().getRoom().requestViewList((String[])localArrayList1.toArray(new String[localArrayList1.size()]), (AVView[])localArrayList2.toArray(new AVView[localArrayList2.size()]), localArrayList1.size(), paramArrayOfString);
    }
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    this.f = paramBoolean;
    if ((anbd.b(this.jdField_a_of_type_Long) != null) && (anbd.b(this.jdField_a_of_type_Long).a != null))
    {
      AppActivity localAppActivity = (AppActivity)anbd.b(this.jdField_a_of_type_Long).a.get();
      localAppActivity.requestPermissions(new ance(this, localAppActivity), 1, new String[] { "android.permission.CAMERA" });
    }
  }
  ...
  AVVideoCtrl a()
  {
    AVContext localAVContext = anmc.a(BaseApplicationImpl.getContext()).a();
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        anlu.a().b(paramBoolean);
        break label60;
      } while ((anmc.a(BaseApplicationImpl.getContext()).a() == null) || (anmc.a(BaseApplicationImpl.getContext()).a().getRoom() == null));
      label130:
      label140:
      anmc.a(BaseApplicationImpl.getContext()).a().getRoom().cancelAllView(new ancg(this));
    }
  }
  ...
  public void d()
  {
    ...
    {
      anlu.a().a("" + this.jdField_a_of_type_Int);
      if (this.jdField_a_of_type_Amsm != null) {
        this.jdField_a_of_type_Amsm.b();
      }
      b(false);
  ...
  public void grant()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        anbd.a().callbackFromRequest(this.jdField_a_of_type_Long, 0, "cs.audioRoom_camera_enable.local", ((JSONObject)localObject).toString());
        return;
      }
      ...
      try
      {
        ...
        anbd.a().callbackFromRequest(this.jdField_a_of_type_Long, i, "cs.audioRoom_camera_enable.local", ((JSONObject)localObject).toString());
