...
{
  public aqsm(QQGamePubAccountFragment paramQQGamePubAccountFragment, LinearLayoutManager paramLinearLayoutManager) {}
  ...
  public void onScrollStateChanged(RecyclerView paramRecyclerView, int paramInt)
  {
    ...
    do
    {
      ...
      {
        yod.a(ajae.a(), "769", "205029", "", "76902", "1", "160", new String[] { this.jdField_a_of_type_ComTencentMobileqqGamecenterFragmentQQGamePubAccountFragment.a(), "", "20" });
      ...
      while (paramInt <= i)
      {
        ...
        if (((paramRecyclerView instanceof aqqj)) && (QQGamePubAccountFragment.a(this.jdField_a_of_type_ComTencentMobileqqGamecenterFragmentQQGamePubAccountFragment).a(paramInt) != null) && (QQGamePubAccountFragment.a(this.jdField_a_of_type_ComTencentMobileqqGamecenterFragmentQQGamePubAccountFragment).a(paramInt).type != 3)) {
          ((aqqj)paramRecyclerView).a.g();
        }
        paramInt += 1;
      }
      paramInt = aqsu.a(QQGamePubAccountFragment.a(this.jdField_a_of_type_ComTencentMobileqqGamecenterFragmentQQGamePubAccountFragment));
