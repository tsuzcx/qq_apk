  ...
  implements aqsi
{
  ...
  private void a(Context paramContext, int paramInt)
  {
    String str = "";
    if (paramInt == 1) {
      str = paramContext.getString(2131692197);
    }
  ...
  private void a(Context paramContext, ColorNote paramColorNote)
  {
    ...
    paramColorNote = new auhr((QQAppInterface)localObject, paramContext, paramColorNote, 10001);
    localObject = new Bundle();
    ((Bundle)localObject).putBoolean("from_qlink_enter_recent", false);
    paramColorNote.a((Bundle)localObject);
    paramContext = new auht(paramContext, paramColorNote);
    paramContext.a(14);
  ...
  private void b(Context paramContext, ColorNote paramColorNote)
  {
    ...
    try
    {
      ...
      paramColorNote = bgsk.a(localQQAppInterface, l, paramColorNote.getString("file_color_note_file_uuid"), paramColorNote.getString("file_color_note_file_url"), paramColorNote.getString("file_color_note_fileName"), paramColorNote.getLong("file_color_note_fileSize"), paramColorNote.getInt("file_color_note_busId"));
      if (paramColorNote == null)
      {
        a(paramContext, 1);
        return;
    ...
    paramContext = new auht(paramContext, new auhx(localQQAppInterface, paramContext, l, paramColorNote, -1));
    paramContext.a(14);
  ...
  private void c(Context paramContext, ColorNote paramColorNote)
  {
    ...
    int i = auoo.a(paramColorNote.getSubType());
    paramColorNote = new auhr((QQAppInterface)localObject, paramContext, aunj.a(FileInfo.a(str)), 10000);
    localObject = new Bundle();
  ...
  private void d(Context paramContext, ColorNote paramColorNote)
  {
    ...
    try
    {
      ...
      if (paramColorNote != null)
      {
        paramContext = new auht(paramContext, new auhs(paramContext, aunj.a(paramColorNote)));
        paramContext.a(14);
        paramContext.b(268435456);
        paramContext.a();
        return;
  ...
  private void e(Context paramContext, ColorNote paramColorNote)
  {
    ...
    try
    {
      ...
      localObject = new auhy((QQAppInterface)localObject, paramContext, localWeiYunFileInfo);
      ((auhy)localObject).a(paramColorNote);
      paramContext = new auht(paramContext, (auhw)localObject);
      paramContext.a(14);
      paramContext.b(268435456);
      paramContext.a();
      return;
  ...
  public void launch(Context paramContext, ColorNote paramColorNote)
  {
    ...
    do
    {
      ...
      i = auoo.a(paramColorNote.getSubType());
      if (i == -1)
      {
