...
public class axts
{
  public static List<aoxh> a(long paramLong1, long paramLong2, aoci paramaoci, ConcurrentHashMap<Long, Set<DanmuItemBean>> paramConcurrentHashMap)
  {
    paramConcurrentHashMap = (Set)paramConcurrentHashMap.get(Long.valueOf(paramLong1));
    if (paramConcurrentHashMap != null) {
      return a(a(paramConcurrentHashMap, paramLong2), paramaoci);
    }
    return null;
  }
  
  public static List<aoxh> a(long paramLong, List<DanmuItemBean> paramList, aoci paramaoci, ConcurrentHashMap<Long, Set<DanmuItemBean>> paramConcurrentHashMap)
  {
    if ((paramList == null) || (paramList.isEmpty()) || (paramaoci == null)) {
    ...
    {
      aoxh localaoxh = paramaoci.a(new aocn((DanmuItemBean)paramConcurrentHashMap.next()));
      if (localaoxh != null)
      {
        localaoxh.a(5000);
        localaoxh.e(true);
        paramList.add(localaoxh);
      }
    }
    return paramList;
  }
  
  public static List<aoxh> a(long paramLong1, List<DanmuItemBean> paramList, aoci paramaoci, ConcurrentHashMap<Long, Set<DanmuItemBean>> paramConcurrentHashMap, long paramLong2)
  {
    ...
    return a(a(paramLong1, paramList, paramConcurrentHashMap, paramLong2), paramaoci);
  }
  ...
  private static List<aoxh> a(List<DanmuItemBean> paramList, aoci paramaoci)
  {
    if ((paramList != null) && (!paramList.isEmpty()) && (paramaoci != null))
    {
      ArrayList localArrayList = new ArrayList();
      ...
      while (paramList.hasNext())
      {
        ...
        aocn localaocn = new aocn((DanmuItemBean)localObject);
        aoxh localaoxh = paramaoci.a(localaocn);
        if (localaoxh != null)
        {
          localaoxh.b(((DanmuItemBean)localObject).c);
          if (!TextUtils.isEmpty(localaocn.a))
          {
            localObject = BaseApplicationImpl.getApplication().getRuntime().getAccount();
            if ((!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).equals(localaocn.a))) {
              localaoxh.e(true);
            }
          }
          localArrayList.add(localaoxh);
        }
      }
      return localArrayList;
    }
  ...
  public static boolean a(RichMediaBrowserInfo paramRichMediaBrowserInfo)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      localStringBuilder.append("shouldShowDanmakuBtn, paramsManager.isFromMultiMsg() = ").append(axtu.a().c());
      localStringBuilder.append(" , paramsManager.getmCurType() = ").append(axtu.a().a());
      localStringBuilder.append(" , paramsManager.getSourceEntrance() = ").append(axtu.a().c());
      localStringBuilder.append(" , paramsManager.isReplyMsgFromSameSession() = ").append(axtu.a().h());
      localStringBuilder.append(" , paramsManager.isMixedMsg = ").append(axtu.a().b);
      localStringBuilder.append(" , paramsManager.isReplySrcMsgExist = ").append(axtu.a().c);
