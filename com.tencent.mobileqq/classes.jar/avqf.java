  ...
  extends AccountObserver
{
  ...
  public void onGetQuickRegisterAccount(boolean paramBoolean, int paramInt, String paramString1, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    if (!paramBoolean) {
      try
      {
        ...
        if (TextUtils.isEmpty(paramString1)) {
          paramString2 = this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.getString(2131717143);
        }
    ...
    if (paramInt == 0)
    {
      avqe.a(this.a, paramString1);
      avqe.b(this.a, paramString2);
      if ((TextUtils.isEmpty(avqe.a(this.a))) || (TextUtils.isEmpty(avqe.b(this.a))))
      {
      ...
      paramString1.putExtra("uin", avqe.a(this.a));
      paramString1.putExtra("key_register_password", avqe.c(this.a));
      ...
      {
        avqe.a(this.a, paramString1, false);
        return;
      }
  ...
  public void onRegisterCommitPassResp(boolean paramBoolean, int paramInt, String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    try
    {
      ...
      if (paramBoolean)
      {
        ...
        localObject = "";
        axqy.a(localQQAppInterface, "new_reg", "setting_page_yes", "result", "", 1, "", str, "", (String)localObject, "", "", "", "", "");
        this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.c();
        if (paramBoolean) {
          break label179;
        }
        ...
        if (TextUtils.isEmpty(paramArrayOfByte2)) {
          paramString = this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.getString(2131717143);
        }
    ...
    catch (UnsupportedEncodingException paramArrayOfByte2)
    {
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        avqe.a(this.a, paramString);
        avqe.a(this.a, paramArrayOfByte1);
        if (!TextUtils.isEmpty(avqe.a(this.a))) {
          break;
        }
        this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131717143, 1);
        return;
      }
      if ((avqe.a(this.a) == null) || (avqe.a(this.a).length == 0))
      {
        this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131717143, 1);
        return;
      }
