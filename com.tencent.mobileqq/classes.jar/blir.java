  ...
  extends ReportDialog
{
  ...
  private bljb jdField_a_of_type_Bljb;
  private bljd jdField_a_of_type_Bljd;
  private blje jdField_a_of_type_Blje;
  private CharSequence jdField_a_of_type_JavaLangCharSequence;
  public Object a;
  private ArrayList<Pair<CharSequence, Integer>> jdField_a_of_type_JavaUtilArrayList;
  private HashMap<CharSequence, bliq> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private Map<Integer, bljc> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private View.OnClickListener jdField_d_of_type_AndroidViewView$OnClickListener = new blix(this);
  ...
  protected blir(Context paramContext)
  {
    this(paramContext, false, false);
  }
  
  protected blir(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    this(paramContext, paramBoolean1, paramBoolean2, true, -1, null);
  }
  
  @TargetApi(14)
  protected blir(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt, ViewGroup.LayoutParams paramLayoutParams)
  {
    super(paramContext, 2131755229);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bliy(this);
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131361965));
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131361973));
  ...
  public static blir a(Context paramContext)
  {
    paramContext = new blir(paramContext, false, false);
  ...
  public static blir a(Context paramContext, int paramInt, ViewGroup.LayoutParams paramLayoutParams)
  {
    paramContext = new blir(paramContext, false, false, true, paramInt, paramLayoutParams);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755013);
    }
    return paramContext;
  ...
  public static blir a(Context paramContext, boolean paramBoolean)
  {
    paramContext = new blir(paramContext, false, true, paramBoolean, -1, null);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755013);
    }
    return paramContext;
  ...
  private CharSequence a(CharSequence paramCharSequence, Drawable paramDrawable)
  {
    ...
    paramDrawable.setBounds(0, 0, bhtq.a(20.0F), bhtq.a(20.0F));
    paramDrawable = new VerticalCenterImageSpan(paramDrawable, 0);
    paramDrawable.setPadding(bhtq.a(6.5F), bhtq.a(6.5F));
  ...
  private void a(TextView paramTextView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramTextView.setContentDescription(getContext().getString(2131690977) + paramTextView.getText());
      return;
    }
    paramTextView.setContentDescription(getContext().getString(2131690979) + paramTextView.getText());
  }
  ...
  private void a(URLDrawable paramURLDrawable, Pair<CharSequence, Integer> paramPair, TextView paramTextView)
  {
    ...
    paramURLDrawable.setURLDrawableListener(new bliu(this, paramTextView, paramPair));
    paramURLDrawable.setDownloadListener(new bliv(this));
    ThreadManagerV2.executeOnSubThread(new ActionSheet.5(this, paramURLDrawable));
  }
  
  private void a(CharSequence paramCharSequence, bljc parambljc)
  {
    if ((paramCharSequence == null) || (parambljc == null)) {
      return;
    }
    int j = paramCharSequence.hashCode();
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(j), parambljc);
  }
  
  public static blir b(Context paramContext)
  {
    paramContext = new blir(paramContext, false, true);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755013);
    }
    return paramContext;
  ...
  private void b(Pair<CharSequence, Integer> paramPair, TextView paramTextView)
  {
    ...
    do
    {
      do
      {
        ...
        a((CharSequence)paramPair.first, new blit(this, paramTextView));
  ...
  public static blir c(Context paramContext)
  {
    paramContext = new blir(paramContext, true, false);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755013);
    }
    return paramContext;
  ...
  public static blir d(Context paramContext)
  {
    paramContext = new blir(paramContext, true, true);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755013);
    }
    return paramContext;
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_JavaLangCharSequence != null)
    {
      ...
      ((View)localObject1).setOnClickListener(new blis(this));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131361984));
      ...
      {
        localObject2 = (TextView)((View)localObject1).findViewById(2131361981);
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        if (j < m)
        {
          ...
          if (((Integer)localPair.second).intValue() == 65537)
          {
            ...
            localObject2 = (TextView)((View)localObject3).findViewById(2131361970);
            localObject1 = (TextView)((View)localObject3).findViewById(2131378235);
            ...
            if ((n >= 0) && (n < ((CharSequence)localPair.first).length()))
            {
              ...
              ((View)localObject3).findViewById(2131364046).setContentDescription(((TextView)localObject2).getText());
              label408:
              ...
              bhga.b(((View)localObject3).findViewById(2131364046), LinearLayout.class.getName());
              label452:
              if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.size() > 0))
              {
                localObject1 = (bliq)this.jdField_a_of_type_JavaUtilHashMap.get(localPair.first);
                if ((localObject1 != null) && (((bliq)localObject1).jdField_b_of_type_Int != 0)) {
                  ((TextView)localObject2).setId(((bliq)localObject1).jdField_b_of_type_Int);
                }
              }
              ...
              ((RelativeLayout.LayoutParams)localObject4).rightMargin = bhgr.a(this.jdField_a_of_type_AndroidContentContext, 15.0F);
              ...
              {
                ((RelativeLayout.LayoutParams)localObject4).width = bhgr.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
                ((RelativeLayout.LayoutParams)localObject4).height = bhgr.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
                ((RelativeLayout.LayoutParams)localObject4).addRule(15);
              }
              ((RelativeLayout.LayoutParams)localObject4).rightMargin = bhgr.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
              ((ImageView)localObject1).setLayoutParams((ViewGroup.LayoutParams)localObject4);
              ...
              if (this.jdField_a_of_type_Boolean)
              {
                ...
                ((View)localObject3).findViewById(2131361971).setVisibility(0);
          ...
          for (;;)
          {
            ...
            localObject2 = (TextView)((View)localObject1).findViewById(2131361970);
            ((TextView)localObject2).setText((CharSequence)localPair.first);
            bhga.b((View)localObject2, Button.class.getName());
  ...
  protected int a(int paramInt)
  {
    ...
    case 7: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131165200);
    case 8: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131165729);
    }
  ...
  public bliq a(int paramInt)
  {
    return a(a(paramInt));
  }
  
  public bliq a(CharSequence paramCharSequence)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap == null) {
      return null;
    }
    return (bliq)this.jdField_a_of_type_JavaUtilHashMap.get(paramCharSequence);
  }
  ...
  public void a(int paramInt1, CharSequence paramCharSequence, int paramInt2)
  {
    if ((paramInt1 >= 0) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (paramInt1 < this.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      ...
      if (localObject != null)
      {
        localObject = ((View)localObject).findViewById(2131361970);
  ...
  public void a(bliq parambliq, int paramInt)
  {
    if (parambliq == null) {
      return;
    }
    this.jdField_a_of_type_JavaUtilHashMap.put(parambliq.a, parambliq);
    a(parambliq.a, paramInt);
  }
  
  public void a(bliz parambliz)
  {
    this.jdField_a_of_type_Bliz = parambliz;
  }
  
  public void a(blja paramblja)
  {
    this.jdField_a_of_type_Blja = paramblja;
  }
  
  public void a(bljb parambljb)
  {
    this.jdField_a_of_type_Bljb = parambljb;
  }
  
  public void a(bljd parambljd)
  {
    this.jdField_a_of_type_Bljd = parambljd;
  }
  
  public void a(blje paramblje)
  {
    this.jdField_a_of_type_Blje = paramblje;
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      ((VerticalCenterImageSpan)localObject).setPadding(agej.a(10.0F, this.jdField_a_of_type_AndroidContentResResources), 0);
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      while (j < k)
      {
        ...
        if (localView != null)
        {
          localView.findViewById(2131361971).setVisibility(8);
          a((TextView)localView.findViewById(2131361970), false);
        }
        j += 1;
      }
    }
  ...
  public void d(int paramInt)
  {
    if ((paramInt >= 0) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (paramInt < this.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      ...
      if (this.jdField_b_of_type_AndroidUtilSparseArray != null)
      {
        ...
        if (localView != null)
        {
          localView.findViewById(2131361971).setVisibility(0);
          a((TextView)localView.findViewById(2131361970), true);
        }
      }
    }
  }
  ...
  public void dismiss()
  {
    if (this.jdField_a_of_type_Bljd != null) {
      this.jdField_a_of_type_Bljd.ak_();
    }
    if (this.g)
    {
      this.g = false;
  ...
  public void e()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 844	android/app/Dialog:dismiss	()V
    //   4: aload_0
    //   5: invokestatic 849	adkm:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 849	adkm:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 849	adkm:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
