...
public class bcyj
{
  ...
  public static <T> T b(JSONObject paramJSONObject, Class<T> paramClass)
  {
    ...
    try
    {
      ...
      if ((localField.isAnnotationPresent(bcym.class)) || (Modifier.isStatic(localField.getModifiers()))) {
        break label346;
      }
      if (localField.isAnnotationPresent(bcyk.class)) {
        paramClass = ((bcyk)localField.getAnnotation(bcyk.class)).a();
      }
    ...
    if (List.class.isAssignableFrom(localClass2))
    {
      ...
      if (!localField.isAnnotationPresent(bcyl.class)) {
        return null;
      }
      localClass1 = ((bcyl)localField.getAnnotation(bcyl.class)).a();
