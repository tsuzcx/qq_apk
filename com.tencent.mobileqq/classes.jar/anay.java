...
public class anay
  implements anjf
{
  public anay(CmGameServerQIPCModule.5 param5) {}
  ...
  public void a(boolean paramBoolean, String paramString, List<anjd> paramList)
  {
    ...
    if (paramBoolean)
    {
      ...
      paramString = anhm.a(this.a.jdField_a_of_type_ComTencentMobileqqApolloScriptSpriteTaskParam, this.a.jdField_a_of_type_ComTencentMobileqqApolloSdkIPCSpriteContext, this.a.jdField_a_of_type_ComTencentMobileqqApolloSdkCmShowRenderView$PlayActionConfig);
