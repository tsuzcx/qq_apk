  ...
  implements Handler.Callback
{
  ...
  private bnlz jdField_a_of_type_Bnlz;
  private int b;
  private int c;
  
  public bnly(int paramInt1, int paramInt2)
  {
  ...
  private boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bnlz != null) {
        this.jdField_a_of_type_Bnlz.a(this.jdField_a_of_type_Bnlz, bool2, i * j, this.c);
      }
      this.c += 1;
      return true;
      label179:
