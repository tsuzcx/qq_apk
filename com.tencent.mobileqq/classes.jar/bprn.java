  ...
  implements bprh
{
  ...
  public bprn(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  private Bitmap a(Context paramContext, Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      label26:
      int k = bqek.jdField_a_of_type_Int;
      if (j <= k) {
        break label226;
      }
      i = (int)(i * k / j);
    ...
    for (;;)
    {
      ...
      {
        localObject = bgmo.a(paramContext, bgmo.c(paramBitmap), 0.4F, 25.0F);
      ...
      for (;;)
      {
        paramContext = zkh.a(zkh.a(paramContext, i, j, true), paramBitmap);
  ...
  public boolean a(String paramString, long paramLong1, long paramLong2, int paramInt, bpro parambpro)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambpro);
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Bqer != null) {
      this.jdField_a_of_type_Bqer.a();
    }
  }
}
