  ...
  implements Handler.Callback
{
  ...
  private bpro jdField_a_of_type_Bpro;
  private int b;
  private int c;
  
  public bprn(int paramInt1, int paramInt2)
  {
  ...
  private boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bpro != null) {
        this.jdField_a_of_type_Bpro.a(this.jdField_a_of_type_Bpro, bool2, i * j, this.c);
      }
      this.c += 1;
      return true;
      label179:
