  ...
  implements amnp
{
  ...
  public amnt(short paramShort, byte paramByte)
  {
  ...
  public long a(int paramInt)
  {
    ...
    return ((amnu)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_Long;
  }
  
  public amnu a(long paramLong, String paramString1, byte paramByte, String paramString2, String paramString3, String paramString4, String paramString5, short paramShort, String paramString6)
  {
    amnu localamnu = new amnu(this);
    localamnu.jdField_a_of_type_Long = paramLong;
    localamnu.jdField_a_of_type_JavaLangString = paramString1;
    localamnu.b = paramString2;
    localamnu.d = paramString3;
    localamnu.jdField_a_of_type_Byte = paramByte;
    localamnu.c = paramString4;
    localamnu.e = paramString5;
    localamnu.jdField_a_of_type_Short = paramShort;
    localamnu.f = paramString6;
    localamnu.jdField_a_of_type_Int = 0;
    return localamnu;
  }
  
  public amnu a(long paramLong, String paramString1, byte paramByte, String paramString2, byte[] paramArrayOfByte, String paramString3)
  {
    amnu localamnu = new amnu(this);
    localamnu.jdField_a_of_type_Long = paramLong;
    localamnu.jdField_a_of_type_JavaLangString = paramString1;
    localamnu.b = paramString2;
    localamnu.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    localamnu.d = paramString3;
    localamnu.jdField_a_of_type_Byte = paramByte;
    localamnu.jdField_a_of_type_Int = 0;
    return localamnu;
  ...
  public amnu a(long paramLong, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, short paramShort)
  {
    return a(paramLong, paramString1, (byte)3, paramString2, paramString3, paramString4, paramString5, paramShort, "");
  }
  
  public amnu a(long paramLong, String paramString1, String paramString2, byte[] paramArrayOfByte, String paramString3)
  {
  ...
  public android.graphics.Bitmap a(int paramInt)
  {
    ...
    //   17: iload_1
    //   18: aload_0
    //   19: getfield 166	amnt:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   37: astore 5
    //   39: aload_0
    //   40: getfield 166	amnt:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   43: iload_1
    //   44: invokevirtual 176	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   47: checkcast 178	amnu
    //   50: astore 8
    //   52: aload 7
    //   54: astore 5
    //   56: aload 8
    //   58: getfield 195	amnu:jdField_a_of_type_Byte	B
    //   61: istore_2
    //   62: aload 4
    //   64: astore 5
    //   66: iload_2
    ...
    //   96: astore 5
    //   98: aload 8
    //   100: getfield 190	amnu:b	Ljava/lang/String;
    //   103: invokestatic 230	azvq:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   106: astore 4
    //   108: aload 4
    //   110: areturn
    //   111: aload 7
    //   113: astore 5
    //   115: aload_0
    //   116: getfield 166	amnt:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   119: iload_1
    //   120: invokevirtual 176	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   123: checkcast 178	amnu
    //   126: getfield 214	amnu:jdField_a_of_type_ArrayOfByte	[B
    //   129: astore 9
    //   131: aload 7
    //   133: astore 5
    //   135: aload_0
    //   136: getfield 166	amnt:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   139: iload_1
    //   140: invokevirtual 176	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   143: checkcast 178	amnu
    //   146: getfield 198	amnu:c	Ljava/lang/String;
    //   149: astore 10
    //   151: aload 10
    //   153: ifnull +47 -> 200
    //   156: aload 7
    //   158: astore 5
    //   160: aload_0
    //   161: getfield 231	amnt:jdField_a_of_type_Byte	B
    //   164: iconst_1
    //   165: if_icmpne +35 -> 200
    //   168: aload 7
    //   170: astore 5
    //   172: aload_0
    //   173: invokevirtual 233	amnt:a	()Z
    //   176: ifne +24 -> 200
    //   179: aload 7
    //   181: astore 5
    //   183: aload_0
    //   184: invokevirtual 235	amnt:b	()Z
    //   187: ifne +13 -> 200
    //   190: aload 7
    //   192: astore 5
    //   194: aload 10
    //   196: invokestatic 230	azvq:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   199: areturn
    //   200: aload 10
    //   202: ifnull +94 -> 296
    //   205: aload 7
    //   207: astore 5
    //   209: aload_0
    //   210: getfield 231	amnt:jdField_a_of_type_Byte	B
    //   213: ifne +83 -> 296
    //   216: aload 7
    //   218: astore 5
    ...
    //   237: astore 5
    //   239: aload 10
    //   241: invokestatic 230	azvq:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   244: astore 4
    //   246: aload 4
    //   248: ifnonnull +261 -> 509
    //   251: aload 8
    //   253: getfield 236	amnu:jdField_a_of_type_Boolean	Z
    //   256: ifeq +253 -> 509
    //   259: aload 8
    //   261: iconst_0
    //   262: putfield 236	amnu:jdField_a_of_type_Boolean	Z
    //   265: aload_0
    //   266: aload 8
    //   268: getfield 190	amnu:b	Ljava/lang/String;
    //   271: invokevirtual 238	amnt:c	(Ljava/lang/String;)V
    //   274: aload 4
    //   276: areturn
    //   277: aload 7
    //   279: astore 5
    //   281: aload_0
    //   282: aload 8
    //   284: getfield 190	amnu:b	Ljava/lang/String;
    //   287: invokevirtual 238	amnt:c	(Ljava/lang/String;)V
    //   290: aconst_null
    //   291: astore 4
    //   293: goto -19 -> 274
    //   296: aload 7
    //   298: astore 5
    //   300: aload 10
    //   302: invokestatic 244	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   305: ifne +143 -> 448
    //   308: aload 7
    //   310: astore 5
    //   312: aload_0
    //   313: getfield 231	amnt:jdField_a_of_type_Byte	B
    //   316: iconst_2
    ...
    //   347: astore 5
    //   349: aload 10
    //   351: invokestatic 230	azvq:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   354: astore 4
    //   356: aload 4
    //   358: astore 5
    //   360: aload 4
    ...
    //   369: aload_0
    //   370: aload 8
    //   372: getfield 190	amnu:b	Ljava/lang/String;
    //   375: invokevirtual 238	amnt:c	(Ljava/lang/String;)V
    //   378: aload 4
    //   380: areturn
    //   381: astore 6
    //   383: aload 5
    ...
    //   399: iconst_2
    //   400: aload 6
    //   402: invokestatic 250	com/tencent/qphone/base/util/QLog:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   405: invokestatic 252	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   408: aload 4
    //   410: areturn
    //   411: astore 9
    //   413: aload 6
    ...
    //   476: aload 9
    //   478: arraylength
    //   479: invokestatic 260	android/graphics/BitmapFactory:decodeByteArray	([BII)Landroid/graphics/Bitmap;
    //   482: astore 4
    //   484: aload 4
    //   486: areturn
    //   487: astore 4
  ...
  public String a(int paramInt)
  {
    ...
    return ((amnu)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).e;
  }
      ...
      if (!paramString.startsWith("/"))
      {
        ...
        if ((paramString.startsWith("http://")) && (!paramString.endsWith(".png")))
        {
          if (this.jdField_a_of_type_Byte == 6) {
            str = paramString + "_" + alzf.b + "_" + alzf.jdField_a_of_type_Byte + ".png";
          } else if (this.jdField_a_of_type_Byte == 0) {
            str = paramString + "_" + (alzf.jdField_a_of_type_Byte - 2) + ".png";
          } else if ((this.jdField_a_of_type_Byte == 1) && (paramString.contains("[]"))) {
            str = paramString.replace("[]", babp.g() + "x" + babp.h());
          } else {
            str = paramString + "_" + alzf.jdField_a_of_type_Byte + ".png";
          }
        }
        else
        {
  ...
  public short a(int paramInt)
  {
    ...
    return ((amnu)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).jdField_a_of_type_Short;
  }
    ...
    if (j > 0)
    {
      ...
      if (i < j)
      {
        ...
        if (this.jdField_a_of_type_Byte == 2) {
          localamnu.b(paramDataInputStream);
        }
        for (;;)
        {
          a(localamnu);
          i += 1;
          break;
          localamnu.a(paramDataInputStream);
        }
      }
    }
  }
  ...
  public void a(DataOutputStream paramDataOutputStream)
  {
    ...
    if (i < j)
    {
      localamnu = (amnu)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (this.jdField_a_of_type_Byte != 2) {
        break label117;
      }
      localamnu.b(paramDataOutputStream);
    }
    for (;;)
    {
      i += 1;
      ...
      break;
      label117:
      localamnu.a(paramDataOutputStream);
    }
  }
  ...
  public void a(String paramString, byte[] arg2)
  {
    ...
    {
      ArrayList localArrayList = alzf.a();
      int i = 0;
      while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        amnu localamnu = (amnu)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if (paramString.startsWith(localamnu.b))
        {
          if (this.jdField_a_of_type_Byte == 1)
          {
            localamnu.c = (BaseApplication.getContext().getFilesDir().getAbsolutePath() + "/" + "flashlogo.png");
            a(???, localamnu.c, this.b);
            if (localArrayList == null) {
              break;
            }
            ??? = localArrayList.iterator();
            while (???.hasNext()) {
              ((alzg)???.next()).a(true, this.jdField_a_of_type_Short, i, paramString);
            }
          }
          if (this.jdField_a_of_type_Byte == 0)
          {
            a(???, String.valueOf(localamnu.f));
            try
            {
              ??? = new File(localamnu.c);
              if (!MD5.getFileMD5(???).equalsIgnoreCase(localamnu.f))
              {
                ???.delete();
                if (localamnu.jdField_a_of_type_Int < 1)
                {
                  localamnu.jdField_a_of_type_Int += 1;
                  c(localamnu.b);
                }
              }
              if (localArrayList == null) {
          ...
          for (;;)
          {
            try
            {
              ...
              if (!paramString.equalsIgnoreCase(localamnu.f))
              {
                ???.delete();
                if (localamnu.jdField_a_of_type_Int >= 1) {
                  break label517;
              ...
              QLog.d("PicAndAdConf", 2, "handle download NearbyBanner image, cid = " + localamnu.jdField_a_of_type_Long + ", md5 is " + paramString.equalsIgnoreCase(localamnu.f));
              return;
            }
            ...
            QLog.d("PicAndAdConf", 2, "handleImgData exception, item md5 = " + localamnu.f, paramString);
            return;
            label517:
            synchronized (this.jdField_a_of_type_JavaUtilHashMap)
            {
              this.jdField_a_of_type_JavaUtilHashMap.put(localamnu.b, Long.valueOf(System.currentTimeMillis()));
            }
          }
        }
        i += 1;
  ...
  public boolean a(bakw parambakw1, bakw parambakw2, int paramInt)
  {
    if (paramInt == 3)
    {
      parambakw2 = parambakw2.a("Content-Type");
      parambakw1 = null;
      if (parambakw2 != null) {
        parambakw1 = parambakw2.toLowerCase();
      }
      if ((parambakw1 != null) && (parambakw1.indexOf("image") != -1)) {
        return true;
      }
    }
    return false;
  ...
  public String b(int paramInt)
  {
    ...
    return ((amnu)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).f;
  }
  ...
  public void b(bakw parambakw1, bakw parambakw2)
  {
    ...
    while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      parambakw2 = (amnu)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (parambakw1.a().startsWith(parambakw2.b))
      {
        parambakw2 = alzf.a();
        if (parambakw2 == null) {
          break;
        }
        parambakw2 = parambakw2.iterator();
        while (parambakw2.hasNext()) {
          ((alzg)parambakw2.next()).a(false, this.jdField_a_of_type_Short, i, parambakw1.a());
        }
      }
      i += 1;
    }
  ...
  public String c(int paramInt)
  {
    ...
    return ((amnu)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).d;
  }
  ...
  public void c(String paramString)
  {
    ...
    ((HttpCommunicator)???).a(new bakw(paramString, null, this, true));
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Byte == 2)
    {
      ...
      if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        if (localamnu.c != null)
        {
          File localFile = new File(localamnu.c);
        ...
        for (;;)
        {
          ...
          break;
          label92:
          localStringBuilder.append(" | ").append(localamnu.jdField_a_of_type_Long);
          ThreadManager.post(new PicAndAdConf.1(this, localamnu), 5, null, false);
        }
      }
      if (QLog.isColorLevel()) {
