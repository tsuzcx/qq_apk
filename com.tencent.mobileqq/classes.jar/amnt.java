  ...
  extends AsyncTask<Integer, Void, Bitmap>
{
  ...
  private WeakReference<amns> jdField_a_of_type_JavaLangRefWeakReference;
  
  public amnt(amns paramamns, int paramInt)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramamns);
  ...
  protected Bitmap a(Integer... paramVarArgs)
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: getfield 21	amnt:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   66: aload_3
    //   67: getfield 66	amns:a	Ljava/lang/String;
  ...
  protected void a(Bitmap paramBitmap)
  {
    ...
    amns localamns = (amns)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((localamns != null) && (paramBitmap != null) && (!paramBitmap.isRecycled())) {
      localamns.a(paramBitmap, this.jdField_a_of_type_Int);
    }
  }
}
