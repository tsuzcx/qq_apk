...
public class bqas
{
  ...
  public static bqas a()
  {
    if (jdField_a_of_type_Bqas == null) {}
    try
    {
      if (jdField_a_of_type_Bqas == null) {
        jdField_a_of_type_Bqas = new bqas();
      }
      return jdField_a_of_type_Bqas;
    }
    finally {}
  }
  ...
  {
    byte[] arrayOfByte = bhmi.a(new File(paramString1));
    ...
    if (str != null)
    {
      ...
      {
        if (!bqap.a(new File(paramString2), new File(str))) {
          break label135;
        }
    ...
    if (bqap.a(paramString2, (byte[])localObject, arrayOfByte, arrayOfByte.length, 0.0D))
    {
      if (!QLog.isColorLevel()) {
        break label185;
      }
    ...
    for (;;)
    {
      bhmi.a(paramString2, paramString1);
      return;
      label185:
