  ...
  implements baic, tex
{
  ...
  WeakReference<bjxz> jdField_a_of_type_MqqUtilWeakReference;
  tey jdField_a_of_type_Tey = null;
  double jdField_b_of_type_Double = 0.0D;
  ArrayList<TroopBarPOI> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  
  public bjfz(bjgc parambjgc)
  {
    this.jdField_a_of_type_Bjgc = parambjgc;
  }
  ...
  public bjxz a()
  {
    if (this.jdField_a_of_type_MqqUtilWeakReference != null) {
      return (bjxz)this.jdField_a_of_type_MqqUtilWeakReference.get();
    }
    return null;
  }
  ...
  public void a()
  {
    ved.b("FacePoiManager", "requestPoiList");
  ...
  {
    ved.b("FacePoiManager", "onPOIListRequestResult.");
    ...
    if ((paramInt == 0) && (paramtey != null)) {
      if (!paramtey.a())
      {
        ...
        if ((this.jdField_a_of_type_Tey != null) && (this.jdField_a_of_type_Tey.b())) {
        ...
        ved.a("FacePoiManager", "onPOIListRequestResult, CurrentPOIList : %s , CurrentPOI : %s .", this.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI);
        this.jdField_a_of_type_Bjgc.a(true, bool, this.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI);
      }
    }
    for (;;)
    {
      ...
      bool = false;
      break;
      this.jdField_a_of_type_Bjgc.a(false, false, null, null);
    }
  }
  
  public void a(bjxz parambjxz, String paramString)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(parambjxz);
  ...
  {
    ved.b("FacePoiManager", "requestSosoPoi");
    this.jdField_a_of_type_Bjgc.a(2, new String[0]);
    new avtl(paramActivity, new bjga(this, paramBoolean)).a();
  }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_MqqUtilWeakReference != null)
    {
      bjxz localbjxz = (bjxz)this.jdField_a_of_type_MqqUtilWeakReference.get();
      if (localbjxz != null) {
        localbjxz.a();
      }
    }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Tey != null) {
      this.jdField_a_of_type_Tey.a();
    }
  }
}
