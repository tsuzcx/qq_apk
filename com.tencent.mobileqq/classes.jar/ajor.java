...
public class ajor
  extends Handler
{
  public ajor(P2VEditMusicDialog paramP2VEditMusicDialog) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      do
      {
        do
        {
          return;
          this.a.b();
          if (this.a.jdField_a_of_type_Xfz != null)
          {
            this.a.jdField_a_of_type_Xfz.a(this.a.jdField_a_of_type_JavaUtilArrayList);
            this.a.jdField_a_of_type_Xfz.notifyDataSetChanged();
          }
          paramMessage = this.a.jdField_a_of_type_Ajot.a();
          if (this.a.jdField_a_of_type_Xfz != null) {
            this.a.jdField_a_of_type_Xfz.a(paramMessage);
          }
        ...
        return;
        if (!this.a.jdField_a_of_type_Ajot.c())
        {
          this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(3);
          return;
        }
      ...
      this.a.jdField_a_of_type_Ajot.a(3);
      ...
      this.a.c();
      MusicHorizontalSeekView.a((this.a.a() + 500) / 1000, this.a.getContext().getResources().getDisplayMetrics().widthPixels - bdkf.a(8.0F));
    ...
    case 11: 
      this.a.b();
      paramMessage = this.a.jdField_a_of_type_Xgc;
      paramMessage.f = ((int)ShortVideoUtils.a(paramMessage.g));
      if (paramMessage.d < 0) {
        paramMessage.d = 0;
      }
      ...
      paramMessage.e = (paramMessage.d + this.a.jdField_a_of_type_Int);
      this.a.jdField_a_of_type_Ajot.a(paramMessage);
      this.a.jdField_a_of_type_Ajot.a(3);
      this.a.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      this.a.jdField_b_of_type_AndroidViewView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(0);
    ...
    case 3: 
      this.a.b();
      this.a.jdField_a_of_type_Ajot.a(xgc.jdField_a_of_type_Xgc);
      this.a.jdField_a_of_type_Ajot.a(0);
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText("");
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131708243));
      this.a.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(8);
      return;
    case 6: 
      this.a.b();
      this.a.jdField_a_of_type_Ajot.a(xgc.jdField_b_of_type_Xgc);
      this.a.jdField_a_of_type_Ajot.a(1);
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText("");
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131708242));
      this.a.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      this.a.jdField_a_of_type_AndroidViewView.setVisibility(8);
    ...
    paramMessage = (xgc)paramMessage.obj;
