...
public class toa
  extends AsyncTask
{
  public toa(ScoreQAVFragment paramScoreQAVFragment) {}
  ...
  protected HashMap a(String... paramVarArgs)
  {
    ...
    if (this.a.e.isEmpty())
    {
      this.a.e = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131429657);
      if (QLog.isColorLevel()) {
    ...
    if (this.a.f.isEmpty())
    {
      this.a.f = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131429658);
      if (QLog.isColorLevel()) {
    ...
    if (this.a.g.isEmpty())
    {
      this.a.g = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131429659);
      if (QLog.isColorLevel()) {
