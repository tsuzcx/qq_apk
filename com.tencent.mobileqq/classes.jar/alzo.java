...
public class alzo
  extends ampn
{
  public alzo(PublicAccountHandler paramPublicAccountHandler, String paramString, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
      ...
      catch (Throwable paramSosoLbsInfo)
      {
        try
        {
          for (;;)
          {
            ...
            paramSosoLbsInfo.put("version", "8.3.5");
