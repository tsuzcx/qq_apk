...
public class ahgp
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, SubMsgType0x87.MsgBody paramMsgBody)
  {
    ...
    Object localObject2 = alpo.a(2131702330);
    String str4 = String.format("%s(%s)", new Object[] { str2, localObject1 });
    String str5 = alpo.a(2131702328);
    if (j == 1) {}
    for (paramMsgBody = alpo.a(2131702322);; paramMsgBody = alpo.a(2131702325))
    {
      String str7 = String.format(str5, new Object[] { paramMsgBody });
      String str6 = String.format("%s(%s)", new Object[] { str3, str1 });
      paramMsgBody = alpo.a(2131702326);
      str5 = alpo.a(2131702323);
      aslp localaslp = new aslp(str1, str1, (String)localObject2 + str4 + str7 + str6 + "的好友列表中。\n不想和他们是好友关系，可选择" + paramMsgBody + "。\n不想再被其他好友克隆，可选择" + str5 + "。", 0, -5040, 2686977, ayvc.a());
      ...
      localaslp.a(j, str5.length() + j, (Bundle)localObject1);
      ...
      paramMsgBody.msg = String.format(alpo.a(2131702327), new Object[] { str2, str3, str1 });
      paramMsgBody.time = ayvc.a();
      paramQQAppInterface.a().a(paramMsgBody, paramQQAppInterface.c());
      paramMsgBody = new MessageForUniteGrayTip();
      paramMsgBody.initGrayTipMsg(paramQQAppInterface, new aslp(str1, str1, alpo.a(2131702324), 0, -5020, 2686977, ayvc.a()));
      aslq.a(paramQQAppInterface, paramMsgBody);
