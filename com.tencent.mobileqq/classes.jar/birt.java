  ...
  implements TextWatcher, View.OnClickListener
{
  ...
  public birt(@NonNull Context paramContext, bigb parambigb)
  {
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(getContext()).inflate(2131495637, null));
    this.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentWidgetXEditText = ((XEditTextEx)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131300153));
    ...
    this.jdField_a_of_type_Udw = new udw(getContext(), this.jdField_a_of_type_AndroidViewViewGroup, new biru(this));
    this.jdField_a_of_type_Udw.a(this.jdField_a_of_type_AndroidContentContext.getString(2131625014));
  }
  
  public void a(String paramString, boolean paramBoolean)
  {
    super.setOnShowListener(new birv(this, paramBoolean));
    super.show();
    if (paramString != null)
    {
