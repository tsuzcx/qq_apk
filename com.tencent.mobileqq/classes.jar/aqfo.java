  ...
  implements aqet
{
  ...
  aqfm jdField_a_of_type_Aqfm;
  public boolean a;
  
  public aqfo(HotPicPageView paramHotPicPageView, aqfm paramaqfm)
  {
    this.jdField_a_of_type_Aqfm = paramaqfm;
  }
  
  public RecyclerView.ViewHolder a(ViewGroup paramViewGroup, int paramInt)
  {
    return new aqfs(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView, LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_AndroidContentContext).inflate(2131493001, paramViewGroup, false), null);
  }
  ...
  public void a(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    {
      aqfa.a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(paramInt);
      this.jdField_a_of_type_Boolean = true;
    }
    if (this.jdField_a_of_type_Int == 1)
    {
      paramViewHolder.itemView.findViewById(2131302028).setVisibility(0);
      paramViewHolder.itemView.findViewById(2131302029).setVisibility(4);
      return;
    }
    if (HotPicPageView.b())
    {
      paramViewHolder.itemView.findViewById(2131302029).setVisibility(0);
      paramViewHolder.itemView.findViewById(2131302028).setVisibility(8);
      return;
    }
