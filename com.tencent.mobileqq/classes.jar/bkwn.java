      ...
      if (this.a.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreProxyAdProxy$IRewardVideoAdListener != null)
      {
        ...
        if (paramJSONObject != null)
        {
          ...
          if (paramJSONObject.isValid())
          {
            ...
            bkwm localbkwm = this.a;
            i = j;
            if (this.a.c == 90) {
              i = 0;
            }
            localbkwm.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMotiveVideoPageData = RewardedVideoAdPlugin.mockMVPageData(paramJSONObject, str, i);
            if (this.a.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMotiveVideoPageData != null)
            {
              ...
              bkxw.a(this.a.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMotiveVideoPageData.adId + "");
            }
          }
        }
        else
