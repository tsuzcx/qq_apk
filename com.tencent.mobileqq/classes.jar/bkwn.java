  ...
  extends QIPCModule
{
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if (MobileQQ.sMobileQQ != null)
    {
      ...
      {
        QQToast.a(MobileQQ.sMobileQQ, MobileQQ.sMobileQQ.getResources().getString(2131718143), 1).a();
        return null;
      }
      paramInt = paramBundle.getInt("VIDEO_STORY_FROM_TYPE", bkwm.a.a());
      if (paramInt == bkwm.a.a()) {
      ...
      bkwq.a(MobileQQ.sMobileQQ, paramBundle);
      return null;
    }
