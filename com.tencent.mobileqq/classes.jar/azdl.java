  ...
  extends bcpq
{
  ...
  private azdl(@NonNull Context paramContext, @NonNull String paramString1, @NonNull String paramString2, int paramInt, String paramString3, String paramString4, azdp paramazdp)
  {
    super(paramContext);
    a(paramContext, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData, paramString1, paramString2, paramInt, paramString3, paramString4, paramazdp);
  }
  ...
  {
    new bcqc(this.jdField_a_of_type_AndroidContentContext).a(paramInt1, a(), 0, paramInt2);
  }
  
  private void a(@NonNull Context paramContext, @NonNull TroopInfoData paramTroopInfoData, String paramString1, String paramString2, int paramInt, String paramString3, String paramString4, azdp paramazdp)
  {
    if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Akim = new azdm(this);
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new azdn(this);
    a();
  }
  
  public static void a(Context paramContext, String paramString1, String paramString2, int paramInt, String paramString3, String paramString4, boolean paramBoolean, azdp paramazdp)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AddTroopUtil", 2, "joinTroop by uin");
    }
    paramContext = new azdl(paramContext, paramString1, paramString2, paramInt, paramString3, paramString4, paramazdp);
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Azdp != null) {
      this.jdField_a_of_type_Azdp.a(paramString, paramInt);
    }
    dismiss();
  }
  ...
  private void a(boolean paramBoolean, int paramInt1, int paramInt2, String paramString)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Akhq.b(Long.parseLong(paramString), Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()));
      return;
      if (QLog.isColorLevel()) {
      ...
      if (1 == paramInt1)
      {
        ...
        bamn.a((Activity)this.jdField_a_of_type_AndroidContentContext, paramInt2);
        a(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, 2);
      }
    }
  }
  ...
  private int b()
  {
    ...
    {
      return i;
      if ((this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.pa == 34) && (aoep.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())))
      {
        aokr.a(this.jdField_a_of_type_AndroidContentContext).show();
        return 1;
      }
      ...
      try
      {
        ...
        this.jdField_a_of_type_Akhq.a(l, 8390785);
        return 0;
      }
  ...
  private static void b(@NonNull azdl paramazdl)
  {
    paramazdl.setCancelable(false);
    paramazdl.setCanceledOnTouchOutside(false);
    paramazdl.c(2131694930);
    if (paramazdl.b() == 0)
    {
      paramazdl.show();
      return;
    ...
    paramazdl.b();
    paramazdl.a(paramazdl.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, 2);
  }
  ...
  private void c()
  {
    ...
    bahk.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, "join");
  }
  ...
  private void c(String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      bcpw.a(this.jdField_a_of_type_AndroidContentContext, 2, 2131718742, 1).b(a());
    }
    for (;;)
    {
  ...
  private void d()
  {
    ...
    afnu.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
  }
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_Akhq.a(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, "", this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.getStatOption(), this.b, this.c, null, null);
  }
