  ...
  extends MSFServlet
{
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    swa.a(arrayOfByte, (String)localObject);
    ...
    for (;;)
    {
      try
      {
        ...
        if ((paramIntent.getBooleanExtra("useNewProtocol", false)) || (((super.getAppRuntime() instanceof QQAppInterface)) && (syb.a((QQAppInterface)super.getAppRuntime(), l + "") != -4)))
        {
