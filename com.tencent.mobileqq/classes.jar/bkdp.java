  ...
  implements bdmd, bdpc
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new bkdq(this);
  ...
  public bkdp(Context paramContext, bkdr parambkdr)
  {
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (int i = 0;; i = 1)
    {
      this.jdField_a_of_type_Bdpb = new bdpb(paramString, localHandler, i);
      this.jdField_a_of_type_Bdpb.a(BaseApplication.getContext());
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      this.jdField_a_of_type_Bkdr.b(this.jdField_b_of_type_Int, paramString);
      this.jdField_b_of_type_Int = 0;
      return;
    }
    this.jdField_a_of_type_Bkdr.a(3, this.e);
  }
  ...
  {
    awxp.b(paramString);
    this.jdField_a_of_type_Bkdr.a(paramString, paramDouble);
  }
  
  public void a(String paramString1, QQRecorder.RecorderParam paramRecorderParam, String paramString2)
  {
    awxp.a(paramString1);
    this.jdField_a_of_type_Bkdr.c();
  }
  ...
  public void b(String paramString)
  {
    ...
    if ((this.jdField_a_of_type_Bkdr != null) && (!TextUtils.isEmpty(str1)))
    {
      this.jdField_a_of_type_Bkdr.a(1, paramString);
      d(str1);
      return;
    }
    ...
    for (;;)
    {
      if (i != 0)
      {
        if (new StatFs(Environment.getExternalStorageDirectory().getAbsolutePath()).getAvailableBlocks() > 1)
        {
          ...
          paramString = barl.a(paramString, null, 2, null);
        ...
        QQToast.a(BaseApplication.getContext(), 2131719552, 0).a();
        return;
      }
    }
    QQToast.a(BaseApplication.getContext(), 2131694853, 0).a();
  }
}
