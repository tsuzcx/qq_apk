...
public class bkdp
{
  private static bkdp jdField_a_of_type_Bkdp;
  private long jdField_a_of_type_Long = -1L;
  
  public static bkdp a()
  {
    if (jdField_a_of_type_Bkdp == null) {}
    try
    {
      if (jdField_a_of_type_Bkdp == null) {
        jdField_a_of_type_Bkdp = new bkdp();
      }
      return jdField_a_of_type_Bkdp;
    }
    finally {}
  }
  ...
  public void a(MobileCommConf paramMobileCommConf)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        } while (bhpe.a(BaseApplicationImpl.getApplication(), str));
        localArrayList.add(str);
      } while (localArrayList.size() < paramMobileCommConf.maxScanNum);
    } while (localArrayList.size() <= 0);
    this.jdField_a_of_type_Long = l;
    a(this.jdField_a_of_type_Long);
    paramMobileCommConf = new NewIntent(BaseApplicationImpl.getApplication(), bkdr.class);
    try
    {
