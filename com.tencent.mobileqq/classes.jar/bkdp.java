...
public class bkdp
  implements bkcg
{
  private bkdp(DoodleLayout paramDoodleLayout) {}
  ...
  public void a(DynamicTextItem paramDynamicTextItem, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      this.a.f();
      if (QLog.isColorLevel()) {
        QLog.d("DoodleLayout", 2, "raymondguo count " + localbkaj.b() + ", items:" + localbkaj.jdField_a_of_type_JavaUtilArrayList.size());
      }
      return;
      localbkaj.b(paramDynamicTextItem);
      paramInt = 1;
      continue;
      if (paramInt == 0)
      {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    this.a.jdField_a_of_type_Bkdo.q();
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      this.a.setTrackerState(this.a.a().jdField_a_of_type_Bkam, 0);
      return;
      DoodleLayout.a(this.a, new bkdq(this, paramBoolean));
    }
  }
}
