...
public class apmp
{
  ...
  public apmp(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new mqq.util.WeakReference(paramAppInterface);
  }
  
  public static apmr a(AppInterface paramAppInterface, String paramString)
  {
    apmr localapmr = new apmr();
    localapmr.jdField_a_of_type_JavaLangString = paramString;
    ArkRecommendLogic.a().a(new ArkAiDictMgr.3(paramAppInterface, localapmr, paramString));
    return localapmr;
  }
  ...
  private static boolean b(AppInterface paramAppInterface)
  {
    ...
    {
      return true;
      paramAppInterface = aqmv.b(170).a();
  ...
  private static void d()
  {
    try
    {
      if ((apme.b) && (!jdField_a_of_type_Boolean))
      {
        ...
        if (jdField_a_of_type_Boolean) {
          WordSegment.setLogCallback(new apmq());
        }
      }
      return;
    }
  ...
  public void b()
  {
    ...
    bgsg.i(localAppInterface.getApp(), localAppInterface.getCurrentAccountUin());
    a();
  }
}
