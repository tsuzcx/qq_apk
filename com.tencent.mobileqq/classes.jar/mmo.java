...
public class mmo
{
  ...
  public static void a(int paramInt, long paramLong)
  {
    ...
    lbd.d(jdField_a_of_type_JavaLangString, String.format("reportVoiceChange voiceType = %s, duration = %s", new Object[] { Integer.valueOf(paramInt), Long.valueOf(paramLong) }));
  }
  
  public static void a(int paramInt, String paramString)
  {
    lbd.d(jdField_a_of_type_JavaLangString, String.format("onConnected sessionType = %s, roomid = %s", new Object[] { Integer.valueOf(paramInt), paramString }));
    d = true;
  ...
  {
    lbd.d(jdField_a_of_type_JavaLangString, String.format("reportClickEvent key = %s, type = %s, roomid = %s", new Object[] { paramString1, paramString2, jdField_b_of_type_JavaLangString }));
    bdla.b(null, "dc00898", "", "", paramString1, paramString1, 0, 0, paramString2, "", jdField_b_of_type_JavaLangString, "");
  }
  
  public static void a(lfe paramlfe)
  {
    if ((!jdField_c_of_type_Boolean) || (!d)) {
      return;
    }
    if ((paramlfe.d == 1) || (paramlfe.d == 2)) {
  ...
  public static void a(lfe paramlfe, int paramInt)
  {
    lbd.d(jdField_a_of_type_JavaLangString, String.format("updateReportData sessionType = %d, voiceType = %d", new Object[] { Integer.valueOf(paramlfe.d), Integer.valueOf(paramInt) }));
    ...
    while ((paramlfe.d != 2) && (paramlfe.d != 4)) {
      return;
    }
    if (jdField_a_of_type_Int != 0) {
      jdField_c_of_type_Int = jdField_a_of_type_Int;
