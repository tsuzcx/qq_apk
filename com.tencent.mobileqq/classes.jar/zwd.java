...
public class zwd
  implements Runnable
{
  public zwd(GreetingCardRender paramGreetingCardRender, int paramInt1, int paramInt2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3) {}
