...
class atlz
  implements atig
{
  atlz(atlu paramatlu, VideoData paramVideoData) {}
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null))
    {
      ...
      try
      {
        ...
        if (paramBundle.busi_buf.has())
        {
          ...
          this.jdField_a_of_type_Atlu.f(true);
          ...
          atlu.b(this.jdField_a_of_type_Atlu, false);
          ((atvq)this.jdField_a_of_type_Atlu.a.getManager(263)).a(atlu.a(this.jdField_a_of_type_Atlu), paramArrayOfByte.total.get());
          if (QLog.isColorLevel()) {
