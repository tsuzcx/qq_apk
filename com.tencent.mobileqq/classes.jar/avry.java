...
public class avry
{
  ...
  avsb jdField_a_of_type_Avsb = new avsb(this);
  List<avsc> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private void a(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localavsc != null) {
        localavsc.onGetKeyComplete(paramString, paramBoolean, paramInt);
      }
    }
  ...
  public avsb a()
  {
    return this.jdField_a_of_type_Avsb;
  }
  
  public void a()
  {
    this.jdField_a_of_type_Avsb = new avsb(this);
  }
  
  public void a(AppInterface paramAppInterface, String paramString1, Context paramContext, String paramString2, avsc paramavsc)
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Avsb.b))
    {
      if (paramavsc != null) {
        paramavsc.onGetKeyComplete(paramString1, true, 0);
      }
      return;
    }
    avsa localavsa = new avsa(this, paramavsc, paramString1);
    ...
    paramString2 = bjlo.a(paramContext);
    ...
    for (;;)
    {
      ...
      paramContext = new NewIntent(paramContext, nta.class);
      ...
      try
      {
        ...
        paramContext.setObserver(localavsa);
      ...
      catch (Exception paramString2)
      {
        for (;;)
        {
          paramavsc.onGetKeyComplete(paramString1, false, -10001);
        }
      }
    }
  }
  
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, avsc paramavsc, boolean paramBoolean, String paramString5)
  {
    QLog.i("XProxy", 2, "开始拉取A1，uin = " + paramString1 + " appid = " + paramString4);
    if ((this.jdField_a_of_type_Avsb.a != null) && (!paramBoolean) && (System.currentTimeMillis() - this.jdField_a_of_type_Long < 43200000L))
    {
      if (paramavsc != null) {
        paramavsc.onGetKeyComplete(paramString2, true, 0);
      }
      return true;
    }
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramavsc);
      return true;
    }
    ...
    for (;;)
    {
      this.jdField_a_of_type_OicqWlogin_sdkRequestWtloginHelper.SetListener(new avrz(this, paramString2));
      this.jdField_a_of_type_JavaUtilList.add(paramavsc);
