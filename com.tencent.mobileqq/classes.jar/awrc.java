  ...
  implements alkr
{
  ...
  public awrc(ProfileHeaderView paramProfileHeaderView)
  {
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    if ((paramBoolean) && (paramInt == 66) && ((paramObject instanceof Set)))
    {
      ...
      if (paramObject.contains(localProfileHeaderView.jdField_a_of_type_Awmk.a.jdField_a_of_type_JavaLangString))
      {
        localProfileHeaderView.b(localProfileHeaderView.jdField_a_of_type_Awmk, false);
