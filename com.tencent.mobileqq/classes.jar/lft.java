  ...
  extends anii
{
  ...
  private lfo jdField_a_of_type_Lfo = lfo.a();
  private lfs jdField_a_of_type_Lfs = lfs.a();
  private int b;
  ...
  private AudioTransClientTransInfo.IntHead a(int paramInt1, int paramInt2)
  {
    ...
    localIntHead.str_session_id.set(String.valueOf(this.jdField_a_of_type_Lfs.jdField_a_of_type_Long));
  ...
  private AudioTransClientTransInfo.IntReqBody a(int paramInt1, boolean paramBoolean, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      paramArrayOfByte.uint32_client_ver.set(mue.b());
  ...
  {
    Object localObject1 = this.jdField_a_of_type_Lfo;
    localObject1 = lfo.a(paramArrayOfByte);
    paramArrayOfByte = ((lfp)localObject1).a;
    localObject1 = ((lfp)localObject1).b;
  ...
  public void a(String paramString1, long paramLong, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      lfo locallfo = this.jdField_a_of_type_Lfo;
      localToServiceMsg.putWupBuffer(lfo.a(localIntHead.toByteArray(), paramArrayOfByte.toByteArray()));
      if (bgnt.g(this.mApp.getApplication().getApplicationContext())) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (bool)
    {
      paramObject = this.jdField_a_of_type_Lfo;
      ...
      for (;;)
      {
        ...
        else if (j == 6)
        {
          ...
          this.jdField_a_of_type_Lfs.jdField_a_of_type_Int = paramFromServiceMsg.enum_channel_type.get();
          if (AudioHelper.f())
          {
            m = paramFromServiceMsg.uint32_combine_num.get();
            QLog.d("AudioTransClientInterfaceHandler", 2, "enum_channel_type = " + this.jdField_a_of_type_Lfs.jdField_a_of_type_Int);
            ...
            while (paramFromServiceMsg.hasNext())
            {
              ...
              lfo locallfo = this.jdField_a_of_type_Lfo;
              QLog.d("AudioTransClientInterfaceHandler", 2, lfo.a(paramObject.fixed32_IP.get()));
              ...
              locallfo = this.jdField_a_of_type_Lfo;
              QLog.d("AudioTransClientInterfaceHandler", 2, lfo.a(paramObject.fixed32_inner_IP.get()));
            }
          }
        }
      }
