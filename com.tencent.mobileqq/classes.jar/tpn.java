...
public class tpn
{
  ...
  private static JSONObject a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      localJSONObject1.put("statistics_data_report", tqa.a(paramContext, paramAdvertisementInfo, localJSONObject2).toString());
  ...
  private static void a(Activity paramActivity, int paramInt, VideoAdInfo paramVideoAdInfo)
  {
    ...
    AdvertisementInfo localAdvertisementInfo = nzq.a(paramVideoAdInfo);
    ...
    {
      a(paramActivity, paramVideoAdInfo, localAdvertisementInfo, nzq.R, 0, paramInt);
      return;
    }
    a(paramActivity, paramVideoAdInfo, localAdvertisementInfo, nzq.P, 0, paramInt);
  }
  ...
  public static void a(Activity paramActivity, int paramInt, boolean paramBoolean)
  {
    ...
    AdvertisementInfo localAdvertisementInfo = nzq.a(localVideoAdInfo);
    if (QLog.isColorLevel()) {
  ...
  private static void a(Activity paramActivity, VideoAdInfo paramVideoAdInfo, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    nzq.a(new tlx().a(paramActivity).a(nzq.B).b(paramInt1).a(paramAdvertisementInfo).a(paramVideoAdInfo).e(a(paramActivity, paramAdvertisementInfo, paramInt2, paramInt3)).a());
  }
  ...
  private void a(Activity paramActivity, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    nzq.a(new tlx().a(paramActivity).a(nzq.B).b(paramInt1).a(paramAdvertisementInfo).e(a(paramActivity, paramAdvertisementInfo, paramInt2, paramInt3)).a());
  }
  ...
  {
    boolean bool = "1".equals(bnrf.a("readinjjoy_ad_supplement_config"));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject1 != null) && (((Long)localObject1).longValue() != 0L))
        {
          ...
          AdvertisementInfo localAdvertisementInfo = nzq.a((VideoAdInfo)localObject2);
          if (((VideoAdInfo)localObject2).jdField_c_of_type_Boolean) {
            a(paramActivity, (VideoAdInfo)localObject2, localAdvertisementInfo, nzq.R, (int)(System.currentTimeMillis() - ((Long)localObject1).longValue()), 50);
          } else {
            a(paramActivity, (VideoAdInfo)localObject2, localAdvertisementInfo, nzq.P, (int)(System.currentTimeMillis() - ((Long)localObject1).longValue()), 50);
          }
        }
      }
    }
  ...
  public void a(sel paramsel, Activity paramActivity)
  {
    if ((paramsel == null) || (paramActivity == null) || (this.jdField_c_of_type_Boolean)) {}
    ...
    do
    {
      ...
      i = paramsel.a();
    } while ((localReadInJoyXListView == null) || (localList == null) || (!tqa.a(i)));
    c();
    ...
    if (i <= m)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        paramsel = (BaseArticleInfo)localList.get(i - k);
        if (AdvertisementInfo.isAdvertisementInfo(paramsel)) {
          a(localReadInJoyXListView, j, m, i, (AdvertisementInfo)paramsel, paramActivity);
        }
      }
    }
    a(paramActivity);
