...
public class alnx
{
  ...
  public static HashMap<String, alnx> a(int paramInt, JSONObject paramJSONObject)
  {
    ...
    if (paramJSONObject.has("animation_sets"))
    {
      ...
      for (;;)
      {
        ...
        if (localObject1 != null)
        {
          ...
          for (localObject1 = alnz.a((JSONObject)localObject1);; localObject1 = alny.a((JSONObject)localObject1))
          {
            if (localObject1 == null) {
              break label226;
            }
            ((alnx)localObject1).jdField_a_of_type_Int = paramInt;
            paramJSONObject.put(((alnx)localObject1).jdField_a_of_type_JavaLangString, localObject1);
            break;
          }
        }
      }
    ...
    if ((localObject1 != null) && (((HashMap)localObject1).size() > 0)) {
      almr.a().a.put(Integer.valueOf(paramInt), localObject1);
    }
    return localObject1;
  }
