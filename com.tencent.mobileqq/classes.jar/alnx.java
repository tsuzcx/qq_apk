  ...
  extends AsyncTask<Integer, Void, Bitmap>
{
  ...
  private WeakReference<alnw> jdField_a_of_type_JavaLangRefWeakReference;
  
  public alnx(alnw paramalnw, int paramInt)
  {
  ...
  protected Bitmap a(Integer... paramVarArgs)
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: getfield 21	alnx:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   66: aload_3
    //   67: getfield 66	alnw:a	Ljava/lang/String;
  ...
  protected void a(Bitmap paramBitmap)
  {
    ...
    alnw localalnw = (alnw)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((localalnw != null) && (paramBitmap != null) && (!paramBitmap.isRecycled())) {
      localalnw.a(paramBitmap, this.jdField_a_of_type_Int);
    }
  }
}
