...
public class bobd
{
  private static bobd jdField_a_of_type_Bobd;
  ...
  static
  {
    jdField_a_of_type_JavaIoFile = a(new File(aktw.d), "qqstroy_follow_capture");
    c();
  }
  
  public static bobd a()
  {
    if (jdField_a_of_type_Bobd == null) {}
    try
    {
      if (jdField_a_of_type_Bobd == null) {
        jdField_a_of_type_Bobd = new bobd();
      }
      return jdField_a_of_type_Bobd;
    }
    finally {}
  }
  ...
  public boolean a()
  {
    return !TextUtils.isEmpty(vuq.d());
  }
