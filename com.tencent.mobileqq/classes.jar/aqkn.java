...
class aqkn
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new aqkp(this);
  private aqqb jdField_a_of_type_Aqqb = new aqko(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private List<aqqa> jdField_a_of_type_JavaUtilList = new ArrayList();
  private List<aqqa> b = new ArrayList();
  ...
  private void a(Intent paramIntent)
  {
    ...
    localaqqi.a(paramIntent.getStringExtra("closeRoomFrom"), localNewTogetherRoomMessageData);
  }
  
  private void a(Intent paramIntent, List<aqqa> paramList)
  {
    int i;
    String str;
  ...
  void a(Bundle paramBundle, aqqa paramaqqa)
  {
    Intent localIntent = a();
    localIntent.putExtra("command_type", 4);
    localIntent.putExtra("closeRoomBundle", paramBundle);
    b(localIntent);
    this.jdField_a_of_type_JavaUtilList.add(paramaqqa);
  }
  
  void a(aqqa paramaqqa)
  {
    this.b.add(paramaqqa);
  }
