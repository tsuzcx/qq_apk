...
public class aqkn
{
  ...
  private ServerConfigObserver jdField_a_of_type_MqqObserverServerConfigObserver = new aqko(this);
  private boolean jdField_a_of_type_Boolean = true;
  private boolean b;
  
  public aqkn(QQAppInterface paramQQAppInterface)
  {
  ...
  private Hashtable<String, ResourcePluginInfo> a()
  {
    ...
    localResourcePluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131692868);
    ...
    localResourcePluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131692054);
    localResourcePluginInfo.strResDesc = "";
    localResourcePluginInfo.strResURL = "";
    localResourcePluginInfo.sResSubType = 2;
    localResourcePluginInfo.cCanChangeState = 0;
  ...
  {
    aqkn localaqkn = paramQQAppInterface.a();
    Object localObject2 = paramResourcePluginInfo.strGotoUrl;
    Object localObject1 = "version=8.4.1.4680&appid=" + AppSetting.a() + "&QUA=" + blsb.a();
    Object localObject3;
    ...
    {
      localObject3 = (String)localObject1 + "&adtag=4680";
    }
    if (paramResourcePluginInfo.strPkgName.equals("com.tencent.Feedback_5_8"))
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramResourcePluginInfo.isNew == 0)
          {
            ...
            ThreadManager.post(new AboutConfig.3(localaqkn, paramResourcePluginInfo), 8, null, false);
          }
          return;
  ...
  public void a(ResourcePluginInfo paramResourcePluginInfo)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 39	aqkn:jdField_a_of_type_JavaUtilHashtable	Ljava/util/Hashtable;
    //   4: ifnull +76 -> 80
    //   7: aload_1
    //   8: ifnull +72 -> 80
    //   11: aload_0
    //   12: getfield 39	aqkn:jdField_a_of_type_JavaUtilHashtable	Ljava/util/Hashtable;
    //   15: aload_1
    //   16: getfield 51	com/tencent/mobileqq/data/ResourcePluginInfo:strPkgName	Ljava/lang/String;
    //   19: invokevirtual 504	java/util/Hashtable:containsKey	(Ljava/lang/Object;)Z
    //   22: ifeq +58 -> 80
    //   25: aload_0
    //   26: getfield 39	aqkn:jdField_a_of_type_JavaUtilHashtable	Ljava/util/Hashtable;
    //   29: aload_1
    //   30: getfield 51	com/tencent/mobileqq/data/ResourcePluginInfo:strPkgName	Ljava/lang/String;
    //   33: invokevirtual 423	java/util/Hashtable:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   36: checkcast 44	com/tencent/mobileqq/data/ResourcePluginInfo
    //   39: astore_2
    //   40: aload_2
    //   41: aload_1
    //   42: getfield 89	com/tencent/mobileqq/data/ResourcePluginInfo:cLocalState	B
    //   45: putfield 89	com/tencent/mobileqq/data/ResourcePluginInfo:cLocalState	B
    //   48: aload_2
    //   49: aload_1
    //   50: getfield 95	com/tencent/mobileqq/data/ResourcePluginInfo:isNew	B
    //   53: putfield 95	com/tencent/mobileqq/data/ResourcePluginInfo:isNew	B
    //   56: aload_0
    //   57: getfield 29	aqkn:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   60: invokevirtual 507	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   63: invokevirtual 513	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   66: astore_1
    //   67: aload_1
    //   68: aload_2
