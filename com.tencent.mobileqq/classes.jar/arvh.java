...
public class arvh
  implements View.OnClickListener, arwd, arwe, arwf
{
  ...
  public arvh(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131496964, null);
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131309754));
      if (ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, null)) {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundDrawable(paramFragmentActivity.getResources().getDrawable(2130840100));
      }
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131311631);
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131297449));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131312440));
      this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator = ((SimpleSlidingIndicator)this.jdField_a_of_type_AndroidViewView.findViewById(2131310489));
      a(paramQQAppInterface, paramContext, String.valueOf(this.jdField_a_of_type_Long));
      this.jdField_a_of_type_AndroidWidgetTextView.setOnTouchListener(new arvi(this));
      if (AppSetting.c) {
        this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(ajjy.a(2131641209));
      }
      if (ImmersiveUtils.isSupporImmersive() == 1)
      {
        ...
        int i = j;
        if (b()) {
          i = j - aciy.a(10.0F, this.jdField_b_of_type_AndroidViewView.getResources());
        }
        paramFragmentActivity.setMargins(0, i, 0, 0);
        this.jdField_b_of_type_AndroidViewView.setLayoutParams(paramFragmentActivity);
      }
      this.jdField_a_of_type_Arwc = ((arwc)paramQQAppInterface.getManager(329));
      return;
    }
  ...
  private void a(int paramInt)
  {
    ...
    case 0: 
      ...
      {
        localFragmentTransaction.hide(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardRecommendFragment).add(2131300715, this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardFragment, this.jdField_a_of_type_Int + "").commit();
        return;
      }
      break;
    case 1: 
      if ((!this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardRecommendFragment.isAdded()) && (this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getSupportFragmentManager().findFragmentByTag(this.jdField_a_of_type_Int + "") == null)) {
        localFragmentTransaction.hide(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardFragment).add(2131300715, this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardRecommendFragment, this.jdField_a_of_type_Int + "").commit();
      }
      for (;;)
      {
        arxf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        return;
  ...
  {
    this.jdField_a_of_type_Boolean = arxi.a(paramQQAppInterface).a(paramString);
    if (!this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setVisibility(8);
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setTabData(new String[] { paramContext.getResources().getString(2131654635), paramContext.getResources().getString(2131654636) }, new int[] { 0, 1 });
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setOnTabListener(new arvj(this));
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    {
      localView = this.jdField_a_of_type_AndroidViewView.findViewById(2131312325);
      if (localView != null) {
        if (!paramBoolean) {
          break label34;
        }
  ...
  public void a()
  {
    ...
    awqx.b(null, "dc00898", "", "", "0X800A212", "0X800A212", 0, 0, "", "", "", "");
    ...
    for (;;)
    {
      try
      {
        ...
        {
          FragmentTransaction localFragmentTransaction = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getSupportFragmentManager().beginTransaction();
          localFragmentTransaction.add(2131300715, (Fragment)localObject, this.jdField_a_of_type_Int + "");
      ...
      if (this.jdField_a_of_type_Arwc != null) {
        this.jdField_a_of_type_Arwc.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Long, this);
      }
      i = PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_AndroidContentContext).getInt(aduv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), 0);
      if (QLog.isColorLevel()) {
  ...
  public void a(ArrayList<Long> paramArrayList, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Arwc == null);
      if (paramBoolean1) {
        this.jdField_a_of_type_Arwc.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Long, paramArrayList, this);
      }
    } while (!paramBoolean2);
    this.jdField_a_of_type_Arwc.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Long, paramArrayList, this);
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Arwc != null) {
      this.jdField_a_of_type_Arwc.a(this.jdField_a_of_type_Long);
    }
  }
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Arwc != null)
    {
      this.jdField_a_of_type_Arwc.b(this.jdField_a_of_type_Long);
      this.jdField_a_of_type_Arwc = null;
    }
