...
public class bhod
{
  ...
  {
    boolean bool = true;
    jdField_a_of_type_JavaLangString = bhod.class.getSimpleName();
  ...
  public static boolean b()
  {
    ...
    QzoneModuleManager.getInstance().downloadModule("animatedWebp.so", new bhoe());
    return false;
  }
  ...
  {
    String str = bdks.a().getString("PREFERENCE_SO_MD5_KEY", null);
    if (TextUtils.isEmpty(str)) {}
