...
{
  public aity(C2CPicUploadProcessor paramC2CPicUploadProcessor, long paramLong) {}
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap paramHashMap)
  {
    ...
    ThreadManager.post(new aiua(this, l2, l3, l4, l5), 5, null, false);
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap paramHashMap)
  {
    ...
    ThreadManager.executeOnSubThread(new aitz(this, l2, l3, l4, l5));
