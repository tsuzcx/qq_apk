  ...
  extends View
{
  ...
  public alxq(ScreenShot paramScreenShot, Context paramContext)
  {
    super(paramContext);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (int i = ((Rect)localObject).top;; i = 0)
    {
      ...
      {
        azmj.b(null, "CliOper", "", "", "0X8005007", "0X8005007", 0, 0, (String)localObject, "", "", "");
        invalidate();
        return;
    ...
    do
    {
      try
      {
        for (;;)
        {
          ...
          Toast.makeText(this.jdField_a_of_type_ComTencentMobileqqAppScreenShot.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 2131719301, 1).show();
          return;
          i = getWidth();
          j = getHeight();
      ...
      if (this.jdField_a_of_type_AndroidGraphicsRect.isEmpty())
      {
        ...
        paramCanvas.drawText(this.jdField_a_of_type_ComTencentMobileqqAppScreenShot.jdField_a_of_type_AndroidContentContext.getString(2131720225), getWidth() / 2, m + 26.0F * f1, this.jdField_b_of_type_AndroidGraphicsPaint);
      }
