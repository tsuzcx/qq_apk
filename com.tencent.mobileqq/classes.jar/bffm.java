...
public class bffm
{
  ...
  {
    return (paramLong2 != -1L) && ((paramLong1 == -1L) || ((paramInt1 == paramInt2) && (paramLong1 > paramLong2)) || ((paramInt1 != paramInt2) && (bffl.a(paramInt2, paramInt1))));
  }
  ...
  public void a(bffm parambffm)
  {
    if (parambffm != null)
    {
      this.jdField_a_of_type_Int = parambffm.jdField_a_of_type_Int;
      this.jdField_a_of_type_Long = parambffm.jdField_a_of_type_Long;
      this.b = parambffm.b;
    }
  }
  ...
  public boolean a(bffm parambffm)
  {
    if (parambffm == null) {
      return false;
    }
    return a(parambffm.jdField_a_of_type_Int, parambffm.jdField_a_of_type_Long, parambffm.b);
  }
