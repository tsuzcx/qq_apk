  ...
  implements bffl
{
  ...
  public static bffm a()
  {
    if (jdField_a_of_type_Bffm == null) {
      jdField_a_of_type_Bffm = new bffm();
    }
    return jdField_a_of_type_Bffm;
  }
  ...
  protected String a(int paramInt)
  {
    ...
    catch (JSONException localJSONException)
    {
      for (;;)
      {
        bfhg.c("DownloadCallbackWebImpl", "getCallBackJsonObject >>> ", localJSONException);
      }
    }
  }
  ...
  protected String a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, String paramString3, int paramInt4, int paramInt5)
  {
    ...
    catch (JSONException paramString1)
    {
      for (;;)
      {
        bfhg.c("DownloadCallbackWebImpl", "getCallBackJsonObject >>> ", paramString1);
      }
    }
  }
  ...
  public JSONObject a(DownloadInfo paramDownloadInfo, int paramInt)
  {
    ...
    {
      bfhg.c("DownloadCallbackWebImpl", "onNetworkConnect " + paramDownloadInfo.getMessage(), paramDownloadInfo);
    }
    return localJSONObject;
  }
  ...
  {
    bffq localbffq = bffq.a();
    for (;;)
    {
      int i;
      try
      {
        int j = localbffq.a().size();
        i = 0;
        if (i < j)
        {
          Object localObject = (bfil)localbffq.a().get(i);
          ...
          if (localWebView != null) {
            if (TextUtils.isEmpty(((bfil)localObject).getJsCallbackMethod()))
            {
              ...
              bfhg.a("DownloadCallbackWebImpl", " commonJsCallBack >>> " + (String)localObject);
      ...
      {
        bfhg.c("DownloadCallbackWebImpl", "doJsCallback >>> ", paramString);
      }
      i += 1;
    }
  }
