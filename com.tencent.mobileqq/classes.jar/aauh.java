  ...
  extends akil
{
    ...
    do
    {
      for (;;)
      {
        ...
        if ((1 == paramInt1) && ((this.a.isResume()) || (this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.cGroupOption == 1)))
        {
          ...
          case -1: 
          default: 
            this.a.jdField_a_of_type_Bcqi.b(2, 2131693687, 1500);
          }
          for (;;)
          {
            this.a.b = null;
            return;
            ((akhp)this.a.app.a(20)).b(Long.parseLong(paramString), Long.parseLong(this.a.app.getAccount()));
            continue;
            this.a.jdField_a_of_type_Bcqi.b(2, 2131693688, 1500);
            this.a.finish();
            ...
            if (localObject != null)
            {
              ...
              continue;
              this.a.jdField_a_of_type_Bcqi.b(2, 2131720506, 1500);
            }
          }
        }
        if (this.a.isResume())
        {
          ...
          if (paramInt2 == 0)
          {
            ...
            for (paramString = null;; paramString = paramString.b(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin))
            {
              ...
              this.a.c.setText(ajya.a(2131701754) + this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.wMemberNum + ajya.a(2131701756));
              return;
            }
          }
        }
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong, ArrayList<bamj> paramArrayList)
  {
