  ...
  implements CompoundButton.OnCheckedChangeListener
{
  ...
  public adxu(Context paramContext, bdbb parambdbb, QQAppInterface paramQQAppInterface)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (adxt)paramView.getTag();
    }
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      localObject = (adxt)paramCompoundButton.getTag();
      if (i == 0)
      {
        ...
        for (paramBoolean = true;; paramBoolean = false)
        {
          ...
          paramCompoundButton.setOnCheckedChangeListener(((adxt)localObject).jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener);
          return;
          i = 2;
          break;
        }
      }
      ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(1)).a(Long.valueOf(((adxt)localObject).jdField_a_of_type_JavaLangString).longValue(), paramBoolean);
      return;
    }
  }
}
