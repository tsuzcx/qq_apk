...
public class axbb
{
  public static SpannableStringBuilder a(Context paramContext, SpannableStringBuilder paramSpannableStringBuilder)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localObject2 = awzy.a((String)localObject1);
      ...
      {
        localObject5 = (axaa)((Iterator)localObject4).next();
        if (TextUtils.isEmpty(((axaa)localObject5).jdField_b_of_type_JavaLangString)) {
          break label635;
        }
        localaxab = new axab(paramContext, 0, ((axaa)localObject5).jdField_b_of_type_JavaLangString, bgtn.b(16.0F), null);
        localObject2 = "[icon]";
        if (!TextUtils.isEmpty(((axaa)localObject5).c)) {
          localObject2 = ((axaa)localObject5).c;
        }
        ((axaa)localObject5).jdField_a_of_type_Int += i;
        ((axaa)localObject5).jdField_b_of_type_Int += i;
        paramSpannableStringBuilder.replace(((axaa)localObject5).jdField_a_of_type_Int, ((axaa)localObject5).jdField_b_of_type_Int, (CharSequence)localObject2);
        paramSpannableStringBuilder.setSpan(localaxab, ((axaa)localObject5).jdField_a_of_type_Int, ((axaa)localObject5).jdField_a_of_type_Int + ((String)localObject2).length(), 33);
        i = ((axaa)localObject5).jdField_a_of_type_Int + ((String)localObject2).length() - ((axaa)localObject5).jdField_b_of_type_Int + i;
        break label641;
      }
      ...
      for (;;)
      {
        ...
        if ((j == 0) && (awzy.b.containsKey(localObject3)))
        {
          localObject4 = (Integer)awzy.b.get(localObject3);
  ...
  private static String a(QQAppInterface paramQQAppInterface, String paramString, List<axbc> paramList)
  {
    ...
    if (j < paramList.size())
    {
      int k = ((axbc)paramList.get(j)).jdField_a_of_type_Int;
      int m = ((axbc)paramList.get(j)).jdField_b_of_type_Int;
      if (!awzn.a(paramQQAppInterface, k, m)) {
        break label260;
      }
      if (i == 0)
      {
  ...
  private static String a(QQAppInterface paramQQAppInterface, List<axbc> paramList)
  {
    ...
    String str = axav.a(paramQQAppInterface.getApp(), 134);
    if (QLog.isColorLevel()) {
  ...
  public static String a(String paramString)
  {
    ...
    Iterator localIterator = awzy.a(paramString).iterator();
    while (localIterator.hasNext()) {
      paramString = paramString.replaceAll(((axaa)localIterator.next()).jdField_a_of_type_JavaLangString, "");
    }
    localIterator = awzy.a().iterator();
    while (localIterator.hasNext())
    {
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, String paramString)
  {
    ...
    bgsg.e(BaseApplicationImpl.getContext(), paramQQAppInterface.c(), str, paramString);
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    bgsg.a(BaseApplicationImpl.getContext(), paramQQAppInterface.c(), paramString, paramLong);
  }
  
  private static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, aofx paramaofx, int paramInt1, int paramInt2, long paramLong, String paramString4)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      do
      {
        ...
        paramString2 = awzs.a(paramQQAppInterface, paramString4, paramString3);
        paramString3 = paramString3.toString();
        paramString4 = new auxc(paramString4, paramString4, paramString3, 0, -5040, paramInt1, bbyp.a());
        ...
        ((MessageForUniteGrayTip)localObject).tipParam.d = (paramString1 + "_reactive_" + paramaofx.b + "_" + paramLong);
        awzs.a(paramQQAppInterface, paramString3, paramString4, paramString2);
        ...
        bcst.b(paramQQAppInterface, "dc00898", "", "", "0X800A1BC", "0X800A1BC", 0, 0, "", "", "", "");
      ...
      bcst.b(paramQQAppInterface, "dc00898", "", "", "0X800A1BE", "0X800A1BE", 1, 0, "", "", "", "");
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ReactivePushHelper", 2, "decodeC2CMsgPkgSubMsgType0xc7 app:" + paramQQAppInterface + "  changeInfo:" + paramRelationalChainChange + "  msginfo:" + paramaofx);
    }
    ...
    a(paramQQAppInterface, paramRelationalChainChange, str, paramaofx);
  }
  
  private static void a(QQAppInterface paramQQAppInterface, submsgtype0xc7.RelationalChainChange paramRelationalChainChange, String paramString, aofx paramaofx)
  {
    ...
    for (long l1 = localToDegradeInfo.notify_time.get();; l1 = 0L)
    {
      ...
      {
        paramRelationalChainChange = bglf.m(paramQQAppInterface, paramString);
        localRelationalChainChange = paramRelationalChainChange;
        if (QLog.isColorLevel())
        {
    ...
    {
      paramRelationalChainChange.add(new axbc(j, k, m, n, l2));
      if (!QLog.isColorLevel()) {
        break;
      }
    ...
    if ((!TextUtils.isEmpty(paramRelationalChainChange)) && (!awzy.a(paramQQAppInterface))) {
      a(paramQQAppInterface, paramString, paramRelationalChainChange, localRelationalChainChange, paramaofx, 2097155, 0, l1, paramString);
    }
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    {
      return false;
      l = bgsg.a(BaseApplicationImpl.getContext(), paramQQAppInterface.c(), paramString);
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, QQMessageFacade.Message paramMessage)
  {
    ...
    catch (Exception paramQQAppInterface)
    {
      ...
      if ((paramQQAppInterface.tipParam != null) && (awzy.b(paramQQAppInterface.tipParam.jdField_b_of_type_Int)))
      {
        if (QLog.isColorLevel()) {
