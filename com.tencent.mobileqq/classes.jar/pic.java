...
{
  public static final pic a;
  private volatile Handler a;
  
  static
  {
    jdField_a_of_type_Pic = new pic();
  }
  ...
  public void execute(java.lang.Runnable paramRunnable)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 24	pic:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   4: ifnonnull +42 -> 46
    //   7: aload_0
    //   8: monitorenter
    //   9: aload_0
    //   10: getfield 24	pic:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   13: astore_2
    //   14: aload_2
    //   15: ifnonnull +29 -> 44
    //   18: ldc 26
    ...
    //   41: putfield 24	pic:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   44: aload_0
    //   45: monitorexit
    //   46: aload_0
    //   47: getfield 24	pic:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   50: aload_1
    ...
    //   79: putfield 24	pic:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   82: goto -38 -> 44
    //   85: astore_1
    //   86: aload_0
    //   87: monitorexit
