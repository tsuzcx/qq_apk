  ...
  extends AladdinRequestHandler
{
  ...
  private static void b(Bundle paramBundle)
  {
    ...
    paramBundle = StatisticCollector.getInstance(pkh.a().getApplication());
    String str = pkh.a();
    if (i == 0) {}
  ...
  public void onSend(byte[] paramArrayOfByte, Bundle paramBundle, AladdinResponseHandler paramAladdinResponseHandler)
  {
    ...
    NewIntent localNewIntent = new NewIntent(localAppRuntime.getApplication(), pky.class);
    ...
    localNewIntent.putParcelableArrayListExtra("key_aladdin_listeners", pkt.a);
