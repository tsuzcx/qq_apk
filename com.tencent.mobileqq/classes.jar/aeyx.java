...
public class aeyx
  implements aeyw, Handler.Callback
{
  int jdField_a_of_type_Int = vpp.b(BaseApplicationImpl.getContext(), 50.0F);
  private acth jdField_a_of_type_Acth;
  private aeyv jdField_a_of_type_Aeyv;
  Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new aeyy(this);
  ...
  private ArrayList<aeyz> jdField_a_of_type_JavaUtilArrayList;
  public List<QQOperationViopTipTask> a;
  private Observer jdField_a_of_type_JavaUtilObserver;
  protected final MqqHandler a;
  int jdField_b_of_type_Int = vpp.b(BaseApplicationImpl.getContext(), 30.0F);
  Animation jdField_b_of_type_AndroidViewAnimationAnimation;
  ImageView jdField_b_of_type_AndroidWidgetImageView;
  RelativeLayout jdField_b_of_type_AndroidWidgetRelativeLayout;
  Animation c;
  
  public aeyx(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, acth paramacth, XPanelContainer paramXPanelContainer, List<QQOperationViopTipTask> paramList)
  {
  ...
  private RelativeLayout a()
  {
    ...
    //   23: putfield 111	aeyx:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   26: aload_1
    //   27: astore_2
    //   28: new 113	java/io/File
    //   31: dup
    //   32: getstatic 119	nqq:h	Ljava/lang/String;
    ...
    //   74: getstatic 119	nqq:h	Ljava/lang/String;
    ...
    //   92: astore_2
    //   93: aload_0
    //   94: getfield 111	aeyx:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   97: aload_2
  ...
  private boolean a(aeyz paramaeyz)
  {
    boolean bool3 = false;
    Object localObject1 = a(paramaeyz.b());
    int i = -1;
    int[] arrayOfInt = paramaeyz.a();
    boolean bool1;
    if (arrayOfInt != null)
    {
      if (this.jdField_a_of_type_Aeyv != null) {
        i = this.jdField_a_of_type_Aeyv.b();
      }
      boolean bool2 = true;
      int j = 0;
    ...
    for (;;)
    {
      if ((bool1) && ((paramaeyz instanceof aeyv)) && (this.jdField_a_of_type_Aeyv != null) && (this.jdField_a_of_type_Aeyv.a() > ((aeyv)paramaeyz).a()))
      {
  ...
  {
    if (this.jdField_a_of_type_Aeyv != null) {
      return this.jdField_a_of_type_Aeyv.b();
    }
    return -1;
  }
  ...
  public aeyv a()
  {
    return this.jdField_a_of_type_Aeyv;
  }
  ...
  public void a()
  {
    if (Thread.currentThread() == Looper.getMainLooper().getThread())
    {
      if (this.jdField_a_of_type_Acth != null) {
        this.jdField_a_of_type_Acth.a(this.jdField_a_of_type_Aeyv);
      }
      this.jdField_a_of_type_Aeyv = null;
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((aeyz)localIterator.next()).a(paramInt, paramVarArgs);
      }
    }
  }
  
  public void a(aeyz paramaeyz)
  {
    if (paramaeyz == null) {}
    do
    {
    ...
    } while (this.jdField_a_of_type_JavaUtilArrayList.contains(paramaeyz));
    this.jdField_a_of_type_JavaUtilArrayList.add(paramaeyz);
  }
  ...
  public void a(View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout == null) {
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentWidgetXPanelContainer.findViewById(2131364076));
    }
  ...
  public boolean a(aeyb paramaeyb, Object... paramVarArgs)
  {
    if (paramaeyb != null)
    {
      if (a(paramaeyb)) {
    ...
    {
      return false;
      paramVarArgs = paramaeyb.a(paramVarArgs);
      if (paramVarArgs != null)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramVarArgs, paramVarArgs.selfuin);
        if (QLog.isColorLevel()) {
          QLog.d("TipsManager", 2, "showGrayTips() success: from " + a(paramaeyb.b()));
        }
        return true;
      }
    } while (!QLog.isColorLevel());
    QLog.d("TipsManager", 2, "showGrayTips() failure: MessageRecord null, from " + a(paramaeyb.b()));
    return false;
  }
  
  public boolean a(aeyv paramaeyv, Object... paramVarArgs)
  {
    if (actn.l) {}
    label136:
    do
    {
      ...
      if (Thread.currentThread() == Looper.getMainLooper().getThread())
      {
        paramVarArgs = paramaeyv.a(paramVarArgs);
        this.jdField_a_of_type_Acth.a(paramVarArgs, paramaeyv);
        this.jdField_a_of_type_Aeyv = paramaeyv;
      }
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TipsManager", 2, "showTipsBar() success: from " + a(paramaeyv.b()));
        }
        return true;
        paramVarArgs = new TipsManager.1(this, paramaeyv, paramVarArgs);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (i = j + k;; i = j)
        {
          ...
          localLayoutParams.rightMargin = vpp.b(BaseApplicationImpl.getContext(), 40.0F);
