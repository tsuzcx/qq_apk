  ...
  extends WtloginObserver
{
  ...
  public void OnRegGetSMSVerifyLoginAccount(int paramInt, long paramLong, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3)
  {
    if (QLog.isColorLevel()) {
      QLog.d(avqc.jdField_a_of_type_JavaLangString, 2, "OnRegGetSMSVerifyLoginAccount ret=" + paramInt + " uin=" + paramLong);
    }
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfByte3 = "";
        axqy.a(localQQAppInterface, "new_reg", "setting_page_no", "result", "", 1, "", str, "", paramArrayOfByte3, "", "", "", "", "");
        this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.c();
        if (paramInt != 0) {
          break label469;
        }
        avqc.a(this.a, Long.valueOf(paramLong).toString());
        avqc.a(this.a, paramArrayOfByte2);
        if (!TextUtils.isEmpty(avqc.a(this.a))) {
          break;
        }
        this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131717143, 1);
        return;
      }
    ...
    if ((avqc.a(this.a) == null) || (avqc.a(this.a).length == 0))
    {
      this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131717143, 1);
      return;
    }
    if (QLog.isDevelopLevel()) {
      QLog.d(avqc.jdField_a_of_type_JavaLangString, 4, String.format(Locale.getDefault(), "OnRegGetSMSVerifyLoginAccount ret: %s, uin: %s, sign: %s", new Object[] { Integer.valueOf(paramInt), Long.valueOf(paramLong), MD5.toMD5(avqc.a(this.a)) }));
    }
    ...
    paramArrayOfByte1.putExtra("uin", avqc.a(this.a));
    paramArrayOfByte1.putExtra("key_register_sign", avqc.a(this.a));
    paramArrayOfByte1.putExtra("key_register_from_send_sms", avqc.a(this.a));
