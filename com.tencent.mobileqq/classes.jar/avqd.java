  ...
  extends AccountObserver
{
  ...
  public void onGetQuickRegisterAccount(boolean paramBoolean, int paramInt, String paramString1, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    if (!paramBoolean) {
      try
      {
        ...
        if (TextUtils.isEmpty(paramString1)) {
          paramString2 = this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.getString(2131717132);
        }
    ...
    if (paramInt == 0)
    {
      avqc.a(this.a, paramString1);
      avqc.b(this.a, paramString2);
      if ((TextUtils.isEmpty(avqc.a(this.a))) || (TextUtils.isEmpty(avqc.b(this.a))))
      {
      ...
      paramString1.putExtra("uin", avqc.a(this.a));
      paramString1.putExtra("key_register_password", avqc.c(this.a));
      ...
      {
        avqc.a(this.a, paramString1, false);
        return;
      }
  ...
  public void onRegisterCommitPassResp(boolean paramBoolean, int paramInt, String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    try
    {
      ...
      if (paramBoolean)
      {
        ...
        localObject = "";
        axqw.a(localQQAppInterface, "new_reg", "setting_page_yes", "result", "", 1, "", str, "", (String)localObject, "", "", "", "", "");
        this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.c();
        if (paramBoolean) {
          break label179;
        }
        ...
        if (TextUtils.isEmpty(paramArrayOfByte2)) {
          paramString = this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.getString(2131717132);
        }
    ...
    catch (UnsupportedEncodingException paramArrayOfByte2)
    {
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        avqc.a(this.a, paramString);
        avqc.a(this.a, paramArrayOfByte1);
