...
public class bjju
{
  private static volatile bjju jdField_a_of_type_Bjju;
  private ITMAssistantExchangeURLListenner jdField_a_of_type_ComTencentTmdatasourcesdkITMAssistantExchangeURLListenner = new bjjv(this);
  ...
  private int a(Bundle paramBundle, String paramString, ApkUpdateDetail paramApkUpdateDetail)
  {
    ...
    bjko.b("DownloadResolver", "[doDownloadActionBySDK] pParmas =" + paramBundle);
    String str1 = paramBundle.getString(bjmy.j);
    if (TextUtils.isEmpty(str1))
    {
      bjko.e("DownloadResolver", "[doDownloadActionBySDK] url is empty");
      return -1;
    }
    String str14 = paramBundle.getString(bjmy.f);
    int i = paramBundle.getInt(bjmy.k);
    String str15 = paramBundle.getString(bjmy.i);
    String str16 = paramBundle.getString(bjmy.l);
    String str13 = paramBundle.getString(bjmy.E);
    int j = paramBundle.getInt(bjmy.I);
    String str12 = paramBundle.getString(bjmy.J);
    ...
    String str4 = paramBundle.getString(bjmy.L, "");
    ...
    for (;;)
    {
      ...
      try
      {
        ((DownloadInfo)localObject1).jdField_b_of_type_Int = paramBundle.getInt(bjmy.jdField_e_of_type_JavaLangString);
        ((DownloadInfo)localObject1).jdField_d_of_type_Long = paramBundle.getLong(bjmy.H);
        label534:
        ...
        bjko.b("DownloadResolver", "[doDownloadActionBySDK] action == Downloader.ACTION_DOWNLOAD");
        bjjq.a().b((DownloadInfo)localObject1);
        continue;
        ...
        ((DownloadInfo)localObject1).a();
        bjjq.a().b((DownloadInfo)localObject1);
        bjko.c("DownloadResolver", "[doDownloadActionBySDK] action == Downloader.ACTION_UPDATE " + bool1);
        continue;
        return bjjq.a().a(str1);
        localObject1 = localObject2;
        if (!bool2) {
          continue;
        }
        bjlu.a("305", str15, str17, str12);
        paramString = bjjq.a().b(str1);
        ...
        if (paramString == null)
        {
          ...
          ((DownloadInfo)localObject1).j = paramBundle.getString(bjmy.jdField_c_of_type_JavaLangString);
          ((DownloadInfo)localObject1).jdField_b_of_type_Int = paramBundle.getInt(bjmy.jdField_e_of_type_JavaLangString);
          ((DownloadInfo)localObject1).jdField_c_of_type_Boolean = paramBundle.getBoolean(bjmy.y, true);
          ((DownloadInfo)localObject1).jdField_h_of_type_Int = k;
          ((DownloadInfo)localObject1).n = str13;
          ((DownloadInfo)localObject1).jdField_d_of_type_Int = 0;
          ((DownloadInfo)localObject1).o = str12;
        ...
        ((DownloadInfo)localObject1).a("big_brother_ref_source_key", str10);
        ((DownloadInfo)localObject1).a("hideInstallSuccessPage", str11);
        bjjq.a().a((DownloadInfo)localObject1);
        continue;
        bjjq.a().a(str1, true);
        localObject1 = localObject2;
      }
  ...
  public static bjju a()
  {
    if (jdField_a_of_type_Bjju == null) {}
    try
    {
      if (jdField_a_of_type_Bjju == null) {
        jdField_a_of_type_Bjju = new bjju();
      }
      return jdField_a_of_type_Bjju;
    }
    finally {}
  }
  ...
  {
    bjmu.a(paramActivity, paramBundle);
  }
  ...
  public static boolean a(Bundle paramBundle)
  {
    if (paramBundle.getInt(bjmy.k) == 5)
    {
      ...
      if (TextUtils.isEmpty(str1))
      {
        bjko.e("DownloadResolver", "[installApp] url is empty");
        return false;
      }
      String str2 = paramBundle.getString(bjmy.f);
      String str3 = paramBundle.getString(bjmy.i);
      String str4 = paramBundle.getString(bjmy.l);
      Object localObject = paramBundle.getString(bjmy.J);
      ...
      bjlu.a("305", str3, str5, (String)localObject);
      localObject = bjjq.a().b(str1);
      if (localObject == null)
      {
        ...
        ((DownloadInfo)localObject).j = paramBundle.getString(bjmy.jdField_c_of_type_JavaLangString);
        ((DownloadInfo)localObject).k = paramBundle.getString(bjmy.jdField_d_of_type_JavaLangString);
        ((DownloadInfo)localObject).jdField_b_of_type_Int = paramBundle.getInt(bjmy.jdField_e_of_type_JavaLangString);
        ((DownloadInfo)localObject).o = paramBundle.getString(bjmy.J);
  ...
  {
    bjko.b("DownloadResolver", "[doDownloadActionByMyApp] pParmas =" + paramBundle + " myAppConfig = " + paramInt);
    ...
    Object localObject1;
    if (paramBundle.getInt(bjmy.jdField_e_of_type_JavaLangString, -10) < 0)
    {
      ??? = TMAssistantGetAppDetailTool.getInstance(this.jdField_a_of_type_ComTencentTmdatasourcesdkITMAssistantExchangeURLListenner, bizw.a().a());
    ...
    do
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        try
        {
          ...
          {
            bjjq.a().b(bizw.a().a().getString(2131694436));
            return;
          }
        }
      ...
      paramBundle.putInt(bjmy.jdField_e_of_type_JavaLangString, ((Integer)localObject1).intValue());
      ...
      if (paramInt == 1)
      {
        ...
        bjnn.a().a(paramActivity, paramBundle, new bjjw(this, paramBundle, paramString, paramApkUpdateDetail));
        return;
      }
    } while ((paramInt != 2) && (paramInt != 0));
    bjnn.a().b(paramActivity, paramBundle, new bjjx(this, paramBundle, paramString, paramApkUpdateDetail));
  }
  ...
  public List<DownloadInfo> a()
  {
    ...
    {
      bjko.b("DownloadResolver", localObject1);
      if ((localObject2 != null) && (((Map)localObject2).size() != 0)) {
        break;
      }
      bjko.e("DownloadResolver", "infos is null!!");
    ...
    if (((Map)localObject2).size() > 0)
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if ((((DownloadInfo)localObject3).jdField_c_of_type_Int == 0) && (!TextUtils.isEmpty(((DownloadInfo)localObject3).jdField_e_of_type_JavaLangString)) && (((DownloadInfo)localObject3).jdField_c_of_type_Boolean))
        {
          ...
          localObject4 = bjjq.a().a(((DownloadInfo)localObject3).jdField_d_of_type_JavaLangString);
          bjko.b("DownloadResolver", "\ninfo=" + ((DownloadInfo)localObject3).toString() + "\ntaskInfo:" + a((TMAssistantDownloadTaskInfo)localObject4));
        }
        for (;;)
        {
          ((List)localObject1).add(Long.valueOf(System.currentTimeMillis() - l2));
          break;
          bjko.e("DownloadResolver", "Info is not SDK && APK task!! \ninfo=" + ((DownloadInfo)localObject3).toString());
        }
      }
    }
    else
    {
      bjko.e("DownloadResolver", "infos is empty!!");
    }
    localObject2 = new Long[((List)localObject1).size()];
    ((List)localObject1).toArray((Object[])localObject2);
    bjko.e("DownloadResolver", "Total time Cost:" + (System.currentTimeMillis() - l1) + ";Every loop time cost:" + Arrays.toString((Object[])localObject2));
    return localArrayList;
  }
  ...
  public void a(List<DownloadInfo> paramList, bjnh parambjnh)
  {
    if (paramList == null)
    {
      bjko.b("DownloadResolver", "[queryByDownloadManagerV2] infos == null");
      return;
    }
    if (parambjnh == null) {
      bjko.b("DownloadResolver", "[queryByDownloadManagerV2] listener == null");
    }
    ThreadManager.getSubThreadHandler().post(new DownloadProxy.2(this, paramList, parambjnh));
  }
