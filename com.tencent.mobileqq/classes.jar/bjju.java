...
public class bjju
{
  ...
  public static final int[] g = { 107, 2130843712, 2130843712, 2131372814 };
  public static final int[] h = { 112, 2130843716, 2130843716, 2131372817 };
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 108, 2130848605, 2130848605, 2131372811 };
    jdField_b_of_type_ArrayOfInt = new int[] { 101, 2130848606, 2130848606, 2131372812 };
    jdField_c_of_type_ArrayOfInt = new int[] { 102, 2130848608, 2130848608, 2131372816 };
    jdField_d_of_type_ArrayOfInt = new int[] { 103, 2130848609, 2130848609, 2131372815 };
    jdField_e_of_type_ArrayOfInt = new int[] { 104, 2130848607, 2130848607, 2131372813 };
    jdField_f_of_type_ArrayOfInt = new int[] { 105, 2130848604, 2130848604, 2131372810 };
  }
  
  public bjju(int paramInt)
  {
  ...
  public ProviderView a(Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_e_of_type_Boolean)
      {
        ...
        ((ProviderView)localObject1).setId(2131363881);
        continue;
        localObject1 = localObject2;
        if (this.jdField_c_of_type_Boolean)
        {
          localObject1 = new QIMFilterProviderView(paramContext);
          ((ProviderView)localObject1).setId(2131363883);
          continue;
          ...
          if (this.jdField_f_of_type_Boolean)
          {
            ...
            ((ProviderView)localObject1).setId(2131363891);
            continue;
            localObject1 = localObject2;
