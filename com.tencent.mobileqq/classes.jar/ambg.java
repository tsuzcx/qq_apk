...
public class ambg
{
  ...
  public ambg(int paramInt1, int paramInt2, int paramInt3)
  {
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_c_of_type_JavaLangString = "";
  ...
  public ambg(int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, amcm paramamcm, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2, double paramDouble, String[] paramArrayOfString, ambh paramambh1, int paramInt5, int paramInt6, ambh paramambh2, List<Pair<ambh, ambh>> paramList, HashMap<String, String> paramHashMap)
  {
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_c_of_type_JavaLangString = "";
    ...
    this.jdField_a_of_type_Amcm = paramamcm;
    ...
    this.jdField_a_of_type_Ambh = paramambh1;
    this.jdField_b_of_type_Ambh = paramambh2;
  ...
  private Drawable a(Context paramContext, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      paramInt1 = bbay.a(localDrawable) + bbay.a(paramContext);
  ...
  private Pair<ambh, ambh> a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      } while (!paramString.equals(((ambh)localPair.first).jdField_b_of_type_JavaLangString));
    }
  ...
  public Drawable a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, View paramView, String paramString, int paramInt)
  {
    ...
    if (paramBoolean2)
    {
      ...
      localObject2 = new amcy(paramQQAppInterface.getApp().getResources(), this.jdField_a_of_type_AndroidGraphicsNinePatch, this.jdField_b_of_type_AndroidGraphicsNinePatch, this.jdField_a_of_type_Int);
      if (paramBoolean1) {
        break label644;
      }
      bool = true;
      ((amcy)localObject2).a(bool, paramBoolean3);
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      int j;
      if (((localObject2 instanceof amcy)) && (!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString)))
      {
        if ((this.jdField_a_of_type_Amcm == null) || (paramView == null)) {
          break label832;
        }
        j = paramView.getWidth();
        if (this.jdField_a_of_type_Amcm.jdField_c_of_type_Int == 0) {
          ((amcy)localObject2).a(true, this.jdField_e_of_type_JavaLangString, this.jdField_a_of_type_Amcm.jdField_a_of_type_ArrayOfInt, this.jdField_a_of_type_Amcm.jdField_a_of_type_JavaLangString);
        }
      }
      else if (((localObject2 instanceof amcy)) && (paramBoolean2) && (!paramBoolean3) && (paramInt > 0))
      {
        paramString = paramString + "_" + paramInt;
        localObject1 = (amcy)localObject2;
        if (paramBoolean1) {
          break label855;
        }
      }
      ...
      {
        ((amcy)localObject1).a(paramQQAppInterface, paramString, paramBoolean1);
        ...
        if (i > this.jdField_a_of_type_Amcm.jdField_c_of_type_Int)
        {
          ((amcy)localObject2).a(true, this.jdField_e_of_type_JavaLangString, this.jdField_a_of_type_Amcm.jdField_a_of_type_ArrayOfInt, this.jdField_a_of_type_Amcm.jdField_a_of_type_JavaLangString);
          break label562;
        }
        ((amcy)localObject2).a(false, null, null, null);
        break label562;
        if (!(localObject2 instanceof amcy)) {
          break label562;
        }
        ((amcy)localObject2).a(false, null, null, null);
        break label562;
  ...
  {
    amcm localamcm = this.jdField_a_of_type_Amcm;
    if (!paramBoolean4) {
    ...
    this.jdField_a_of_type_Amcm = localamcm;
    return paramQQAppInterface;
  }
  
  public Pair<ambh, ambh> a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    for (paramQQAppInterface = "null";; paramQQAppInterface = "first:" + ((Pair)localObject1).first + ",second:" + ((Pair)localObject1).second)
    {
      ...
      return localObject1;
      if (((ambd)localObject2).a == null) {
        break;
      }
      paramQQAppInterface = ((ambd)localObject2).a.jdField_b_of_type_JavaLangString;
      break label102;
      if (((ambd)localObject2).b == null) {
        break;
      }
      paramQQAppInterface = ((ambd)localObject2).b.jdField_b_of_type_JavaLangString;
      break label102;
      paramQQAppInterface = "width";
      if (((ambd)localObject2).c == null) {
        break label102;
      }
      paramQQAppInterface = ((ambd)localObject2).c.jdField_b_of_type_JavaLangString;
      break label102;
      ...
      break label102;
      if (((ambd)localObject2).d == null) {
        break;
      }
      paramQQAppInterface = ((ambd)localObject2).d.jdField_b_of_type_JavaLangString;
      break label102;
      if (((ambd)localObject2).e == null) {
        break;
      }
      paramQQAppInterface = ((ambd)localObject2).e.jdField_b_of_type_JavaLangString;
      break label102;
    }
  }
