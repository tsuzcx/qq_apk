  ...
  extends BaseAdapter
{
  ...
  public boolean a;
  public Object b;
  protected List<afss> b;
  
  static
  {
    jdField_b_of_type_JavaLangString = afst.class.getSimpleName();
  }
  
  public afrj(Context paramContext, beez parambeez, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  protected ChatHistorySearchData a(ChatHistorySearchData paramChatHistorySearchData, ArrayList<afss> paramArrayList)
  {
      ...
      do
      {
        ...
        while (i < paramChatHistorySearchData.mSearchData1.size())
        {
          ...
          if (a(localMessageRecord)) {
            paramArrayList.add(new afss(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord));
          }
          i += 1;
        }
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
    ...
    {
      return false;
      str = babh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramMessageRecord.isSend(), paramMessageRecord.senderuin).toLowerCase(Locale.US);
      paramMessageRecord = afss.a(paramMessageRecord.msg).toLowerCase(Locale.US);
    } while ((!str.contains(afss.jdField_a_of_type_JavaLangString)) && (!paramMessageRecord.contains(afss.jdField_a_of_type_JavaLangString)));
    return true;
  }
  
  public ChatHistorySearchData b(ChatHistorySearchData paramChatHistorySearchData, ArrayList<afss> paramArrayList)
  {
    int i = 0;
    for (;;)
    {
