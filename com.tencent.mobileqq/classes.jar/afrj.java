...
public class afrj
  extends anyu
{
  public afrj(TroopAssistantActivity paramTroopAssistantActivity) {}
  ...
  protected void onSetGenralSettingsTroopFilter(boolean paramBoolean, Map<String, Integer> paramMap)
  {
    ...
    do
    {
      return;
      int i;
      if (("batch_setting".equals(this.a.b)) && (this.a.jdField_a_of_type_JavaUtilList != null) && (this.a.jdField_a_of_type_JavaUtilList.size() > 0) && (this.a.jdField_a_of_type_Bhru != null))
      {
        i = 0;
        for (;;)
        {
          ...
          if (((Boolean)this.a.jdField_a_of_type_Bhru.c.get(paramMap)).booleanValue()) {
            break;
          }
          i += 1;
        }
        QQToast.a(this.a.app.getApp(), 2, anzj.a(2131713989), 0).b(this.a.getTitleBarHeight());
    ...
    if (paramBoolean)
    {
      QQToast.a(this.a.app.getApp(), 2, this.a.getString(2131718984), 0).b(this.a.getTitleBarHeight());
      return;
    }
