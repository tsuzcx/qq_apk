  ...
  extends apto
{
  ...
  public aptk(Context paramContext, int paramInt, SensorManager paramSensorManager, aptg paramaptg)
  {
    super(paramContext, paramInt, paramSensorManager, paramaptg);
    paramContext = paramSensorManager.getDefaultSensor(4);
    paramaptg = paramSensorManager.getDefaultSensor(1);
    paramSensorManager = paramSensorManager.getDefaultSensor(2);
    if ((paramContext != null) && (paramaptg != null) && (paramSensorManager != null))
    {
      this.jdField_a_of_type_JavaUtilList.add(paramContext);
      this.jdField_a_of_type_JavaUtilList.add(paramaptg);
  ...
  private void a(SensorEvent paramSensorEvent)
  {
    ...
    if (!this.jdField_c_of_type_Boolean)
    {
      ...
      arrayOfFloat = apti.a(this.k);
      SensorManager.getOrientation(arrayOfFloat, new float[3]);
      this.l = apti.a(this.l, arrayOfFloat);
    ...
    if ((this.jdField_a_of_type_Float != 0.0F) && (this.jdField_c_of_type_Boolean))
    {
      ...
      arrayOfFloat = new float[9];
      apti.c(arrayOfFloat, this.jdField_d_of_type_ArrayOfFloat);
      this.l = apti.a(this.l, arrayOfFloat);
      SensorManager.getOrientation(this.l, this.e);
      e();
      if ((this.jdField_a_of_type_Int == 1) && (this.jdField_a_of_type_Aptg != null)) {
  ...
  private void b(float paramFloat1, float paramFloat2, float paramFloat3, long paramLong)
  {
    ...
    this.jdField_a_of_type_Aptg.updateGyroscope(paramFloat1, paramFloat2, paramFloat3, paramLong);
  }
  ...
  private void e()
  {
    ...
    for (;;)
    {
      this.l = apti.a(this.f);
      apti.a(this.l, this.m);
