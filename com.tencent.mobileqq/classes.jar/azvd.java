...
public class azvd
{
  public static azwj a(azwj paramazwj)
  {
    for (paramazwj = paramazwj.a(); (paramazwj != null) && (paramazwj.jdField_a_of_type_Int != 1); paramazwj = paramazwj.a()) {}
    return paramazwj;
  }
  ...
  public static AbsStructMsg a()
  {
    ...
    localStructMsgForGeneralShare.mMsgBrief = alud.a(2131714990);
    ...
    azvc.a(0).a(new StructMsgItemTitle(""));
  ...
  public static AbsStructMsg a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong, byte[] paramArrayOfByte, int paramInt2)
  {
    ...
    if ((paramArrayOfByte != null) && ((paramArrayOfByte instanceof AbsShareMsg)))
    {
      ...
      if ((l1 == 23L) && ((paramInt1 == 82) || (paramInt1 == 43))) {
        azqs.b(paramQQAppInterface, "P_CliOper", "Grp_AIO", paramQQAppInterface.getCurrentAccountUin(), "AIOchat", "appear_obj", 0, 0, String.valueOf(paramLong), String.valueOf(l1), String.valueOf(l2), "");
      }
      if (l1 == 52L)
      {
        paramQQAppInterface = new StringBuilder("rec flower msg,");
        paramQQAppInterface.append(azxe.a(paramArrayOfByte));
  ...
  public static AbsStructMsg a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    //   93: astore_3
    //   94: aload_3
    //   95: invokestatic 250	azvd:a	(Ljava/lang/String;)Z
    //   98: istore_2
    //   99: aload_3
    //   100: aload_0
    //   101: iload_2
    //   102: invokestatic 255	bamd:a	(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    //   105: invokestatic 258	azvd:a	(Ljava/lang/String;)Ljava/lang/String;
    //   108: astore_3
    ...
    //   153: new 270	azwk
    //   156: dup
    //   157: invokespecial 271	azwk:<init>	()V
    //   160: astore 4
    //   162: aload 4
    //   164: aload_0
    //   165: invokevirtual 273	azwk:a	(Ljava/lang/String;)V
    //   168: aload 4
    //   170: iload_2
    //   171: invokevirtual 276	azwk:a	(Z)V
    ...
    //   192: aload 4
    //   194: invokevirtual 297	azwk:a	()Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   197: astore_3
    //   198: aload_3
    //   199: astore_0
    //   200: aload_3
  ...
  public static String a(azwj paramazwj)
  {
    if (paramazwj.jdField_a_of_type_Int == 3) {}
    Object localObject;
    for (paramazwj = paramazwj.jdField_a_of_type_JavaLangString;; paramazwj = ((StringBuilder)localObject).toString())
    {
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          if (localazwj.jdField_a_of_type_Int == 3) {
            ((StringBuilder)localObject).append(localazwj.jdField_a_of_type_JavaLangString);
          }
        }
      }
    }
  ...
  public static final String a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = aepi.a().append(paramString);
        i = 0;
        k = 0;
