  ...
  implements Manager
{
  ...
  public ConcurrentHashMap<Integer, azvc> a;
  private boolean a;
  
  public azvd(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Amxf = ((amxf)paramQQAppInterface.getBusinessHandler(56));
  }
  ...
  private void a(long[] paramArrayOfLong, azvc paramazvc, String paramString, boolean paramBoolean)
  {
    ThreadManager.post(new NumRedMsgManager.2(this, paramArrayOfLong, paramazvc, paramBoolean, paramString), 5, null, false);
  }
  ...
  public void a(NumRedMsg.NumMsgRspBody paramNumMsgRspBody, ToServiceMsg paramToServiceMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      paramNumMsgRspBody = (azvc)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i));
      if (paramNumMsgRspBody == null) {
        break;
      }
  ...
  public void a(List<Submsgtype0x89.NumRedBusiInfo> paramList, String paramString, azvc paramazvc)
  {
    ThreadManager.post(new NumRedMsgManager.1(this, paramList, paramazvc, paramString), 5, null, false);
  }
  
  public void a(long[] paramArrayOfLong, String paramString, azvc paramazvc)
  {
    a(paramArrayOfLong, paramazvc, paramString, false);
  }
