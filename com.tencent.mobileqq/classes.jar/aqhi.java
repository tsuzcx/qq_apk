...
public class aqhi
{
  ...
  public aqhi(int paramInt1, int paramInt2, int paramInt3)
  {
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_c_of_type_JavaLangString = "";
  ...
  public aqhi(int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, aqio paramaqio, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2, double paramDouble, String[] paramArrayOfString, aqhj paramaqhj1, int paramInt5, int paramInt6, aqhj paramaqhj2, List<Pair<aqhj, aqhj>> paramList, HashMap<String, String> paramHashMap)
  {
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_c_of_type_JavaLangString = "";
    ...
    this.jdField_a_of_type_Aqio = paramaqio;
    ...
    this.jdField_a_of_type_Aqhj = paramaqhj1;
    this.jdField_b_of_type_Aqhj = paramaqhj2;
  ...
  private Drawable a(Context paramContext, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      paramInt1 = bhbd.a(localDrawable) + bhbd.a(paramContext);
  ...
  private Drawable a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2, Drawable paramDrawable)
  {
    ...
    {
      paramQQAppInterface = new aqjb(paramQQAppInterface.getApp().getResources(), this.jdField_a_of_type_AndroidGraphicsNinePatch, this.jdField_b_of_type_AndroidGraphicsNinePatch, this.jdField_a_of_type_Int);
      if (!paramBoolean1)
      {
        paramBoolean1 = true;
  ...
  private Pair<aqhj, aqhj> a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      } while (!paramString.equals(((aqhj)localPair.first).jdField_b_of_type_JavaLangString));
    }
  ...
  public Drawable a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, View paramView, String paramString, int paramInt)
  {
    ...
    for (Object localObject2 = a(paramQQAppInterface, paramBoolean1, paramBoolean3, null);; localObject2 = null)
    {
      ...
      int j;
      if (((localObject2 instanceof aqjb)) && (!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString)))
      {
        if ((this.jdField_a_of_type_Aqio == null) || (paramView == null)) {
          break label375;
        }
        j = paramView.getWidth();
        if (this.jdField_a_of_type_Aqio.jdField_c_of_type_Int == 0) {
          ((aqjb)localObject2).a(true, this.jdField_e_of_type_JavaLangString, this.jdField_a_of_type_Aqio.jdField_a_of_type_ArrayOfInt, this.jdField_a_of_type_Aqio.jdField_a_of_type_JavaLangString);
        }
      }
      else if (((localObject2 instanceof aqjb)) && (paramBoolean2) && (!paramBoolean3) && (paramInt > 0))
      {
        paramString = paramString + "_" + paramInt;
        localObject1 = (aqjb)localObject2;
        if (paramBoolean1) {
          break label398;
        }
      }
      ...
      {
        ((aqjb)localObject1).a(paramQQAppInterface, paramString, paramBoolean1);
        ...
        if (i > this.jdField_a_of_type_Aqio.jdField_c_of_type_Int)
        {
          ((aqjb)localObject2).a(true, this.jdField_e_of_type_JavaLangString, this.jdField_a_of_type_Aqio.jdField_a_of_type_ArrayOfInt, this.jdField_a_of_type_Aqio.jdField_a_of_type_JavaLangString);
          break;
        }
        ((aqjb)localObject2).a(false, null, null, null);
        break;
        label375:
        if (!(localObject2 instanceof aqjb)) {
          break;
        }
        ((aqjb)localObject2).a(false, null, null, null);
        break;
  ...
  {
    aqio localaqio = this.jdField_a_of_type_Aqio;
    if (!paramBoolean4) {
    ...
    this.jdField_a_of_type_Aqio = localaqio;
    return paramQQAppInterface;
  }
  
  public Pair<aqhj, aqhj> a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    for (paramQQAppInterface = "null";; paramQQAppInterface = "first:" + ((Pair)localObject1).first + ",second:" + ((Pair)localObject1).second)
    {
      ...
      return localObject1;
      if (((aqhf)localObject2).a == null) {
        break;
      }
      paramQQAppInterface = ((aqhf)localObject2).a.jdField_b_of_type_JavaLangString;
      break label102;
      if (((aqhf)localObject2).b == null) {
        break;
      }
      paramQQAppInterface = ((aqhf)localObject2).b.jdField_b_of_type_JavaLangString;
      break label102;
      paramQQAppInterface = "width";
      if (((aqhf)localObject2).c == null) {
        break label102;
      }
      paramQQAppInterface = ((aqhf)localObject2).c.jdField_b_of_type_JavaLangString;
      break label102;
      ...
      break label102;
      if (((aqhf)localObject2).d == null) {
        break;
      }
      paramQQAppInterface = ((aqhf)localObject2).d.jdField_b_of_type_JavaLangString;
      break label102;
      if (((aqhf)localObject2).e == null) {
        break;
      }
      paramQQAppInterface = ((aqhf)localObject2).e.jdField_b_of_type_JavaLangString;
      break label102;
    }
  }
