...
public class adzq
{
  ...
  public adzq(Context paramContext, int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView = ((IphonePickerView)LayoutInflater.from(paramContext).inflate(2131561252, null));
    int j = this.d;
    int k = this.g;
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView.a(new adzt(this, j - k + 1));
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView.setPickListener(new adzu(this, null));
    this.jdField_a_of_type_ComTencentMobileqqConditionsearchWidgetIphonePickerView.setBackgroundColor(paramContext.getResources().getColor(2131167050));
    a(paramInt);
    if (paramBoolean) {
  ...
  public void a(adzs paramadzs)
  {
    this.jdField_a_of_type_Adzs = paramadzs;
  }
}
