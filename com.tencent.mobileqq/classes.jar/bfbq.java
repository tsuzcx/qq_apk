  ...
  implements AVRoomMulti.EventListener
{
  ...
  public void onEndpointsUpdateInfo(int paramInt, String[] paramArrayOfString)
  {
    ...
    if (this.a.jdField_a_of_type_Bfbt != null) {
      this.a.jdField_a_of_type_Bfbt.a(paramInt, paramArrayOfString);
    }
  }
  ...
  public void onEnterRoomComplete(int paramInt, String paramString)
  {
    ...
    if (this.a.jdField_a_of_type_Bfbs != null) {
      this.a.jdField_a_of_type_Bfbs.a(paramInt, paramString);
    }
  }
  ...
  public void onExitRoomComplete()
  {
    ...
    this.a.jdField_a_of_type_ComTencentTMGSdkAVContext.getAudioCtrl().stopTRAEService();
    if (this.a.jdField_a_of_type_Bfbt != null) {
      this.a.jdField_a_of_type_Bfbt.a();
    }
  }
  ...
  {
    if (this.a.jdField_a_of_type_Bfbt != null) {
      this.a.jdField_a_of_type_Bfbt.a(paramInt, paramString);
    }
  }
  ...
  public void onSemiAutoRecvCameraVideo(String[] paramArrayOfString)
  {
    ...
    if (this.a.jdField_a_of_type_Bfbt != null) {
      this.a.jdField_a_of_type_Bfbt.a(paramArrayOfString);
    }
  }
