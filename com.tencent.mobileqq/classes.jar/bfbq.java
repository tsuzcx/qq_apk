...
public class bfbq
  extends zsa
{
  public bfbq(TroopFileTransferManager paramTroopFileTransferManager) {}
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.DownloadFileRspBody paramDownloadFileRspBody, Bundle paramBundle)
  {
    ...
    int i = aszt.a(FileUtil.getExtension(((TroopFileTransferManager.Item)localObject1).FileName));
    paramInt = paramBundle.getInt("thumbNail");
    boolean bool2 = paramBundle.getBoolean("isPreview", false);
    paramBundle = new bfbu();
    ...
    catch (NullPointerException localNullPointerException)
    {
      ...
      if (bool2)
      {
        bfaw.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.e, 700);
        paramBundle.jdField_a_of_type_Boolean = false;
        ((amoo)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(22)).c(paramBundle);
        return;
      }
    ...
    if (bool2)
    {
      ...
      paramBundle.d = HexUtil.bytes2HexStr(paramDownloadFileRspBody.bytes_download_url.get().toByteArray());
    }
    ...
    if (i < 0)
    {
      ...
      if (bool2)
      {
        ...
        if (TextUtils.isEmpty(paramBundle.c)) {
          paramBundle.c = amtj.a(2131714374);
        }
        paramBundle.jdField_a_of_type_Boolean = false;
        ((amoo)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(22)).c(paramBundle);
        return;
    ...
    while ((paramInt == 128) || (paramInt == 383) || (paramInt == 640))
    {
      ...
      this.a.jdField_a_of_type_ArrayOfBfbv[4].a(paramDownloadFileRspBody);
      return;
      if (i == -134)
      {
    ...
    if (!this.a.c((TroopFileTransferManager.Item)localObject1)) {
      this.a.jdField_a_of_type_ArrayOfBfbv[3].a(new TroopFileTransferManager.TaskHttpDownload(this.a, (TroopFileTransferManager.Item)localObject1));
    }
  }
}
