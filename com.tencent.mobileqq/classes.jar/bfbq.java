...
{
  public bfbq(AgentActivity paramAgentActivity) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("action_login_sucess".equals(paramIntent.getAction())) {
      ...
      {
        paramContext = bfii.a(paramIntent, "login_success_uin");
        ...
        adpn.a(this.a, AgentActivity.a(this.a), PublicFragmentActivityForOpenSDK.class, OpenAuthorityFragment.class, 0);
      }
    }
    for (;;)
    {
