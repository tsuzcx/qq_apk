...
public class aiqs
  extends ajfb
{
  public aiqs(AppInterface paramAppInterface)
  {
  ...
  public void a(int paramInt, String paramString, ArrayList<aiqa> paramArrayList)
  {
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      {
        aiqa localaiqa = (aiqa)paramArrayList.next();
        STCommon.STLocalCVerInfo localSTLocalCVerInfo = new STCommon.STLocalCVerInfo();
        localSTLocalCVerInfo.busId.set(localaiqa.jdField_a_of_type_Int);
        localSTLocalCVerInfo.itemId.set(localaiqa.jdField_a_of_type_JavaLangString);
        localSTLocalCVerInfo.localVer.set(localaiqa.jdField_b_of_type_Int);
    ...
    paramArrayList = new NewIntent(this.mApp.getApp(), aiqt.class);
  ...
  public void a(ReportInfoManager.ReportChannlInfo paramReportChannlInfo)
  {
    ...
    try
    {
      ...
      paramReportChannlInfo = new NewIntent(this.mApp.getApp(), aiqt.class);
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, long paramLong1, String paramString2, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    try
    {
      ...
      paramString2 = new NewIntent(this.mApp.getApp(), aiqt.class);
  ...
  public void a(String paramString, int paramInt, long paramLong)
  {
    ...
    try
    {
      ...
      localObject = new NewIntent(this.mApp.getApp(), aiqt.class);
      ...
      if (("apollo_game_av.get_usraccinfo".equals(paramString)) && (paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()))
      {
        ...
        try
        {
          ...
          if ((paramArrayOfByte != null) && (paramArrayOfByte.size() > 0))
          {
            ...
            paramIntent = aing.a(paramIntent.getIntExtra("gameId", -1));
            if (paramIntent != null)
            {
  ...
  public void a(String paramString1, String paramString2, long paramLong, int paramInt, boolean paramBoolean, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        paramArrayOfByte = new NewIntent(this.mApp.getApp(), aiqt.class);
  ...
  public void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        ((aiqj)localObject1).c(paramFromServiceMsg.getResultCode(), paramIntent);
        return;
      }
    }
    ...
    {
      ((aiqj)localObject1).c(paramArrayOfByte.subCode.get(), paramIntent);
      return;
    }
    Object localObject2 = new aiqi();
    if (paramArrayOfByte.updateFlag.get() == 1)
    {
      bool = true;
      ((aiqi)localObject2).jdField_a_of_type_Boolean = bool;
    ...
    {
      ((aiqi)localObject2).jdField_b_of_type_Boolean = bool;
      ((aiqi)localObject2).jdField_a_of_type_Int = paramArrayOfByte.svrVer.get();
      ((aiqi)localObject2).jdField_b_of_type_Int = i;
      ((aiqi)localObject2).jdField_d_of_type_JavaLangString = paramArrayOfByte.url.get();
      ((aiqi)localObject2).c = paramArrayOfByte.md5.get();
      ((aiqi)localObject2).jdField_a_of_type_ArrayOfByte = paramArrayOfByte.patchContent.get().toByteArray();
      ((aiqi)localObject2).e = paramArrayOfByte.patchUrl.get();
      ((aiqi)localObject2).jdField_b_of_type_Long = paramArrayOfByte.packageSize.get();
      ((aiqi)localObject2).jdField_a_of_type_Long = paramArrayOfByte.tipsSize.get();
      ((aiqi)localObject2).jdField_a_of_type_JavaLangString = paramArrayOfByte.itemId.get();
      ((aiqi)localObject2).jdField_b_of_type_JavaLangString = paramIntent;
      ((aiqi)localObject2).jdField_d_of_type_Int = 1;
      ((aiqj)localObject1).a((aiqi)localObject2);
      return;
      bool = false;
      break;
    }
  ...
  public void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((localaips == null) || (localaips.a() == null))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          if (i < paramFromServiceMsg.length())
          {
            ...
            localObject1 = new ailx(((JSONObject)localObject1).optString("icon"), (String)localObject2, paramArrayOfByte);
            localaips.a().updateUserInfo((ailx)localObject1);
            if (j == aios.jdField_a_of_type_Int) {
              localaips.a().getOpenApiHead(l, paramArrayOfByte);
            } else if (j == aios.jdField_b_of_type_Int) {
              localaips.a().getOpenApiNick(l, paramArrayOfByte);
            }
          }
        }
      }
      ...
      for (;;)
      {
        try
        {
          ...
          localaips.a().nativeOpenApiGetHeadCallBack(l, paramFromServiceMsg.getString(0), -1, 0, 0, null);
        ...
        localaips.a().callbackFromRequest(l, 0, "cs.preload_userInfoList.local", paramFromServiceMsg.toString());
        return;
        if (j == aios.jdField_a_of_type_Int)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localaips.a().nativeOpenApiGetHeadCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), 0, 0, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_HEAD error openid=" + paramIntent.getString(0));
          return;
        }
        if (j == aios.jdField_b_of_type_Int)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localaips.a().nativeOpenApiGetNickCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), null);
        ...
        localaips.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), "cs.preload_userInfoList.local", paramIntent.toString());
        ...
        {
          paramFromServiceMsg = new JSONObject(str).optJSONArray("uidList");
          localaips.a().nativeOpenApiGetNickCallBack(l, paramFromServiceMsg.getString(0), -1, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_NICK error openid=" + paramFromServiceMsg.getString(0));
        }
        else if (j == aios.c)
        {
          localaips.a().callbackFromRequest(l, -1, "cs.preload_userInfoList.local", "{}");
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_PRELOAD error ");
        }
      }
      label859:
  ...
  public void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        do
        {
          for (;;)
          {
            ...
            try
            {
              ...
              if (i == 4)
              {
                localaips.a().callbackFromRequest(l, (int)localUniSsoServerRsp.ret.get(), str3, paramArrayOfByte);
                return;
              }
            }
            catch (Throwable paramArrayOfByte)
            {
              ...
              try
              {
                ...
                if (i == 4)
                {
                  localaips.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), paramIntent, "{}");
                  return;
                }
              }
        ...
        paramArrayOfByte = aing.a(localJSONObject1.optInt("gameId"));
    ...
    localaips.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), str3, "{}");
  }
