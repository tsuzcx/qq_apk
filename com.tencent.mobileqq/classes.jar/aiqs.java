...
public class aiqs
  extends aiqo
{
  protected aiqs(QQAppInterface paramQQAppInterface, Context paramContext, aukm paramaukm)
  {
  ...
  public View a(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, View.OnClickListener paramOnClickListener)
  {
    ...
    {
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558853, paramViewGroup, false);
      paramOnClickListener = new aiqt();
      paramOnClickListener.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131367679));
      paramOnClickListener.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)paramViewGroup.findViewById(2131377031));
      paramOnClickListener.c = ((SingleLineTextView)paramViewGroup.findViewById(2131378275));
      paramOnClickListener.b = ((ImageView)paramViewGroup.findViewById(2131368709));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton = ((Button)paramViewGroup.findViewById(2131375181));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131375191));
      paramViewGroup.setTag(paramOnClickListener);
      a(paramViewGroup.findViewById(2131367679));
      localPhoneContact = (PhoneContact)this.jdField_a_of_type_Aukm;
      ...
      paramInt2 = bbcl.a(localPhoneContact.detalStatusFlag, localPhoneContact.iTermType);
    ...
    case 8: 
      for (;;)
      {
        if ((paramInt2 == 0) || (paramInt2 == 6))
        {
          ...
          paramOnClickListener.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setTextColor(a(this.jdField_a_of_type_AndroidContentContext, 2131166861));
          ...
          paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131701208));
          paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(ajyc.a(2131701211));
          label504:
          if (AppSetting.d)
          {
            ...
            paramOnClickListener.append(bbcl.b(paramInt1));
            paramViewGroup.setContentDescription(paramOnClickListener);
          }
          label533:
          return paramViewGroup;
          paramOnClickListener = (aiqt)paramView.getTag();
    ...
    for (;;)
    {
      ...
      paramOnClickListener.c.setVisibility(8);
      break label381;
      if (((ajxn)localObject).a(localPhoneContact.unifiedCode, true))
      {
        paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131701210));
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(ajyc.a(2131701212));
        break label504;
      }
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setText(ajyc.a(2131689628));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setTag(localPhoneContact);
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setContentDescription(ajyc.a(2131689628));
