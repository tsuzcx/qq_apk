...
public class bfkj
{
  ...
  static
  {
    jdField_d_of_type_JavaLangString = anvx.a(2131714668);
  }
    ...
    while (this.jdField_a_of_type_JavaLangString.indexOf('[') > 0)
    {
      ...
      if ((i < this.jdField_a_of_type_JavaLangString.length() - 1) && (this.jdField_a_of_type_JavaLangString.charAt(i + 1) == '('))
      {
        ...
        if (m > 0)
        {
          ...
          bfkk localbfkk = new bfkk();
          localbfkk.jdField_a_of_type_Int = k;
          localbfkk.jdField_b_of_type_Int = (i + 1);
          localbfkk.jdField_a_of_type_JavaLangString = str;
          this.jdField_a_of_type_JavaUtilArrayList.add(localbfkk);
        }
      }
    }
  }
