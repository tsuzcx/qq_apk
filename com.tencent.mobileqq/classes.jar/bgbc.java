...
public class bgbc
{
  ...
  public bgbc(QQAppInterface paramQQAppInterface, Context paramContext, Handler paramHandler)
  {
    ...
    bgbf.a(paramContext, this.jdField_a_of_type_JavaUtilMap);
  }
  ...
  private void a(UPDATE_INFO paramUPDATE_INFO, PluginRecord paramPluginRecord)
  {
    ...
    paramPluginRecord.mInstalledPath = bgbf.a(BaseApplicationImpl.getContext(), paramPluginRecord.id).getAbsolutePath();
  }
  
  private void a(PluginRecord paramPluginRecord)
  {
    File localFile = bgbf.c(BaseApplicationImpl.getContext(), paramPluginRecord.id);
    if ((localFile != null) && (localFile.exists())) {
      localFile.delete();
    }
    bgbf.a(paramPluginRecord);
    LpReportInfo_dc01500.reportConfig(paramPluginRecord.id, paramPluginRecord.old_ver, paramPluginRecord.ver, 0);
  }
  
  private void a(String paramString)
  {
    paramString = bgbf.c(BaseApplicationImpl.getContext(), paramString);
  ...
  {
    PluginIntent localPluginIntent = new PluginIntent(BaseApplicationImpl.getContext(), bfzf.class);
    localPluginIntent.a = a();
    localPluginIntent.b = bfxr.a().a();
    localPluginIntent.a(new bgbd(this));
  ...
  public void a(bgbe parambgbe)
  {
    this.jdField_a_of_type_Bgbe = parambgbe;
  }
