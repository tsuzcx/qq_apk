...
public class zab
{
  ...
  public zab(AppInterface paramAppInterface)
  {
  ...
  private JSONObject a(String paramString)
  {
    ...
    //   49: aload_0
    //   50: aload_1
    //   51: invokevirtual 102	zab:c	(Ljava/lang/String;)V
    //   54: aconst_null
    //   55: areturn
    ...
    //   281: aload_0
    //   282: aload_1
    //   283: invokevirtual 102	zab:c	(Ljava/lang/String;)V
  ...
  public static void c()
  {
    try
    {
      Object localObject = new File(BaseApplicationImpl.getApplication().getApplicationContext().getFilesDir(), bdmy.e.jdField_a_of_type_JavaLangString);
  ...
  public OfflineWebRes a(String paramString)
  {
    ...
    return (OfflineWebRes)this.jdField_a_of_type_Awbw.a(OfflineWebRes.class, paramString);
  }
  ...
  public void a(OfflineWebRes paramOfflineWebRes)
  {
      ...
      do
      {
        ...
        if (paramOfflineWebRes.getStatus() == 1000)
        {
          ...
          if (((File)localObject1).exists())
          {
            ...
            bdcs.a((File)localObject1, new File((File)localObject2, paramOfflineWebRes.hashName));
            if (QLog.isColorLevel()) {
              QLog.i("OfflineWebResManager", 2, "now copy " + paramOfflineWebRes.fileName + " into /data");
            }
            this.jdField_a_of_type_Awbw.b(paramOfflineWebRes);
            return;
          }
    ...
    if (new File((File)localObject1, paramOfflineWebRes.hashName).exists())
    {
      ...
      this.jdField_a_of_type_Awbw.a(paramOfflineWebRes);
      return;
    }
    this.jdField_a_of_type_Awbw.b(paramOfflineWebRes);
  }
  ...
  {
    Object localObject = this.jdField_a_of_type_Awbw.a(OfflineWebRes.class, false, "bid= ? and fileName= ?", new String[] { paramString2, paramString1 }, null, null, null, null);
    ...
    for (;;)
    {
      ...
      if (localFile1.exists())
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          this.jdField_a_of_type_Awbw.a(localOfflineWebRes, "bid= ? and fileName= ?", new String[] { paramString2, paramString1 });
          if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    ...
    label49:
    while (!this.jdField_a_of_type_Awbw.d(OfflineWebRes.class.getSimpleName())) {
      return;
    }
    for (;;)
    {
      ...
      if ((l1 >= 4194304.0D) && (l1 < 5242880L))
      {
        ...
        localObject2 = this.jdField_a_of_type_Awbw.a(OfflineWebRes.class, (String)localObject1, null);
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          this.jdField_a_of_type_Awbw.b(localOfflineWebRes);
        }
      ...
      Object localObject2 = this.jdField_a_of_type_Awbw.a(OfflineWebRes.class, (String)localObject1, null);
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Awbw.a(OfflineWebRes.class.getSimpleName());
        return;
      }
      i += 1;
    }
  ...
  {
    Object localObject = this.jdField_a_of_type_Awbw.a(OfflineWebRes.class, false, "bid=?", new String[] { paramString }, null, null, null, null);
    if ((localObject == null) || (((List)localObject).size() == 0)) {}
    for (;;)
    {
      return;
      ...
      if (localFile1.exists())
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          this.jdField_a_of_type_Awbw.a(localOfflineWebRes, "bid=?", new String[] { paramString });
          if (QLog.isColorLevel()) {
