...
public final class bmgo
{
  ...
  public static String a(String paramString, boolean paramBoolean)
  {
    ...
    for (paramString = "&";; paramString = "?")
    {
      ...
      if (!((String)localObject).contains("&ChannelID=")) {
        paramString = (String)localObject + "&ChannelID=" + bmgr.a();
      }
      localObject = paramString;
      if (QRDebugEnvUrlUtils.isDebugEnv()) {
        localObject = QRDebugEnvUrlUtils.getTestUrl(paramString);
      }
      bmgm.e("ReaderUrlHelper", "getUrlWithBid = " + (String)localObject);
      return localObject;
  ...
  private static String d(String paramString)
  {
    String str2 = null;
    String str1;
    if ((bmfd.a != null) && (bmfd.a.size() > 0)) {
      str1 = (String)bmfd.a.get(paramString);
    }
    for (;;)
    {
      bmgm.d("ReaderUrlHelper", "getUrl = " + str1);
      return str1;
      if (bmfd.a != null) {
        str2 = (String)bmfd.a.get(paramString);
      }
      str1 = str2;
      if (str2 == null) {
