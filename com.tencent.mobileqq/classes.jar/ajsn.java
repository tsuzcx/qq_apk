...
public class ajsn
  extends QIPCModule
{
  private static volatile ajsn jdField_a_of_type_Ajsn;
  private ajtq jdField_a_of_type_Ajtq = new ajso(this);
  private auuw jdField_a_of_type_Auuw = new auuw();
  ...
  public ajsn(String paramString)
  {
    super(paramString);
  ...
  public static ajsn a()
  {
    ...
    {
      if (jdField_a_of_type_Ajsn == null) {
        jdField_a_of_type_Ajsn = new ajsn("BabyQIPCModule");
      }
      return jdField_a_of_type_Ajsn;
    }
    finally {}
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get("setFriendGrouping") != null)
    {
      ...
      if ((this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne != null) && (ProfileActivity.AllInOne.b(this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne)))
      {
        localBundle.putString("key_method_action", "setFriendGrouping");
        localBundle.putString("web_js_call_back_id", (String)localObject1);
        localObject2 = (ajxn)((QQAppInterface)localObject2).getManager(51);
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        ...
        int i;
        return;
        Object localObject1 = ((ajxn)localObject2).e(this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a);
      }
    }
    QLog.d("BabyQIPCModule", 2, "babyqWeb callWebJSHandledSetGroup");
  }
  ...
  public void b()
  {
    ...
    {
      localQQAppInterface.addObserver(this.jdField_a_of_type_Ajtq);
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqDataCard = bazo.a(localQQAppInterface, ajsf.aC);
      this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataCard = this.jdField_a_of_type_ComTencentMobileqqDataCard;
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqDataCard != null) && (localObject != null)) {
      if (!((ajxn)localObject).b(this.jdField_a_of_type_ComTencentMobileqqDataCard.uin)) {
        break label153;
      }
    }
    ajtk localajtk;
    ...
    for (localObject = new ProfileActivity.AllInOne(this.jdField_a_of_type_ComTencentMobileqqDataCard.uin, 1);; localObject = new ProfileActivity.AllInOne(this.jdField_a_of_type_ComTencentMobileqqDataCard.uin, 19))
    {
      ...
      localajtk = (ajtk)localQQAppInterface.a(2);
      if (localajtk != null) {
        break;
      }
      return;
    ...
    localajtk.a(localQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_ComTencentMobileqqDataCard.uin, 1, 0L, (byte)1, 0L, 0L, new byte[] { 0 }, "", l, 10004, new byte[] { 0 }, (byte)1);
    localajtk.w();
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    {
      paramString = (ajxn)localQQAppInterface.getManager(51);
      if (paramString == null) {
        break label1357;
      }
    }
    ...
    label1351:
    label1357:
    for (boolean bool = paramString.b(ajsf.aC);; bool = false)
    {
      if (bool) {}
      for (long l = 1L;; l = 0L)
      {
      ...
      {
        paramString = (ajtk)localQQAppInterface.a(2);
        int i;
        if ((paramString != null) && (this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataCard != null) && (bbev.d(BaseApplication.getContext()))) {
          if (this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataCard.bAvailVoteCnt <= 0)
          {
            paramInt = 1;
            if ((this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataCard.bHaveVotedCnt > 0) || (this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataCard.bAvailVoteCnt > 0)) {
              break label599;
            }
            i = 1;
            if ((paramInt != 0) || (i != 0)) {
            ...
            paramInt = 3;
            axqw.b(localQQAppInterface, "CliOper", "", "", "P_prof", "Prof_good", 1, 1, paramInt, Integer.toString(ProfileActivity.a(this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.h)), String.valueOf(1), localQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataCard.uin);
            l = 0L;
          }
        }
        for (;;)
        {
          if (QLog.isColorLevel()) {
            QLog.i("BabyQIPCModule", 2, "babyqWeb vote, card.bAvailVoteCnt = " + this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataCard.bAvailVoteCnt + ",card.bHaveVotedCnt = " + this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataCard.bHaveVotedCnt + ",card.strVoteLimitedNotice = " + this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataCard.strVoteLimitedNotice);
          }
      ...
      if (paramString.equals("addFriend")) {
        axqw.b(localQQAppInterface, "dc00898", "", "", "0X8008274", "0X8008274", 0, 0, "", "", "", "");
      }
      label1001:
      do
      {
        ...
        {
          localBundle.putParcelable("key_parcel_allinone", this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne);
          return EIPCResult.createSuccessResult(localBundle);
        }
        if (paramString.equals("deleteFriend"))
        {
          ...
          {
            ((FriendListHandler)localQQAppInterface.a(1)).c(this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a, (byte)2);
            paramString = localQQAppInterface.getHandler(ChatActivity.class);
            if (paramString != null) {
              paramString.sendMessage(paramString.obtainMessage(16711681, this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a));
            }
            ...
            axqw.b(localQQAppInterface, "dc00898", "", "", "0X8007FDF", "0X8007FDF", 0, 0, "", "", "", "");
            return EIPCResult.createSuccessResult(localBundle);
          }
        ...
        if (paramString.equals("getFriendGrouping"))
        {
          if ((this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne != null) && (ProfileActivity.AllInOne.b(this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne)))
          {
            paramBundle = (ajxn)localQQAppInterface.getManager(51);
            if (paramBundle != null) {
              break label1001;
            }
          }
          for (paramString = null;; paramString = paramBundle.e(this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a))
          {
            if (paramString != null)
            {
        ...
        if (paramString.equals("setFriendGrouping"))
        {
          ...
          for (paramBundle = null;; paramBundle = paramBundle.e(this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a))
          {
            if (paramBundle != null)
            {
              localBundle.putString("friendUin", this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a);
        ...
        if (paramString.equals("reportFriend"))
        {
          ...
          try
          {
            localBundle.putString("key_report_msg", xkq.a(localQQAppInterface, this.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a, "", 21001, null));
            return EIPCResult.createSuccessResult(localBundle);
          }
