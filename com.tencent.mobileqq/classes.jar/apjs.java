  ...
  implements Manager
{
  ...
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new apjt(this);
  public awbw a;
  ...
  public apjs(QQAppInterface paramQQAppInterface)
  {
  ...
  public List<EmoticonFromGroupEntity> a()
  {
    ...
    return this.jdField_a_of_type_Awbw.a(EmoticonFromGroupEntity.class);
  }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord instanceof MessageForPic)) {
      d(((bdqa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(paramMessageRecord));
    }
    for (;;)
    {
      ...
      if ((paramMessageRecord instanceof MessageForMixedMsg))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if ((localObject instanceof MessageForPic))
          {
            ...
            d(((bdqa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a((MessageRecord)localObject));
          }
        }
      }
    }
    ...
    do
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject instanceof MessageForPic))
        {
          localObject = (MessageForPic)localObject;
          MessageForMixedMsg.copyBaseInfoFromMixedToPic((MessageForPic)localObject, paramMessageRecord);
          localObject = ((bdqa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a((MessageRecord)localObject);
