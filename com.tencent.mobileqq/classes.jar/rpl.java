...
public class rpl
{
  ...
  private static volatile rpl jdField_a_of_type_Rpl;
  ...
  public rpl()
  {
    this.jdField_a_of_type_Rpm = null;
  }
  
  public static rpl a()
  {
    if (jdField_a_of_type_Rpl == null) {}
    try
    {
      if (jdField_a_of_type_Rpl == null) {
        jdField_a_of_type_Rpl = new rpl();
      }
      return jdField_a_of_type_Rpl;
    }
    finally {}
  }
  ...
  {
    return jdField_a_of_type_Rpl != null;
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localJSONObject.put("articles_request_type", ozr.a());
      if (!ozr.b()) {
        break label312;
      }
      i = 1;
    ...
    if (this.jdField_b_of_type_Boolean) {
      noo.a(null, "", "0X8009296", "0X8009296", 0, 0, String.valueOf((NetConnInfoCenter.getServerTimeMillis() - this.jdField_b_of_type_Long) / 1000.0D), "", "", localJSONObject.toString(), false);
    }
    for (;;)
    {
      ozr.a(false);
      ...
      str = "0";
      break;
      noo.a(null, "", "0X80089D1", "0X80089D1", 0, 0, String.valueOf((NetConnInfoCenter.getServerTimeMillis() - this.jdField_b_of_type_Long) / 1000.0D), "", "", localJSONObject.toString(), false);
    }
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Rpm == null) {
      this.jdField_a_of_type_Rpm = new rpm(this, null);
    }
