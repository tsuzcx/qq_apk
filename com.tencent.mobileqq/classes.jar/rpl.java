...
public class rpl
  implements Runnable
{
  public rpl(BaseChatPie paramBaseChatPie, String paramString, Editable paramEditable) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_MqqOsMqqHandler.post(new rpm(this, (List)localObject1));
        return;
        label407:
        bool = false;
      }
