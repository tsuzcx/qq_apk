...
public class alng
{
  ...
  private SurfaceHolder.Callback jdField_a_of_type_AndroidViewSurfaceHolder$Callback = new alnh(this);
  public SurfaceView a;
  
  public alng(Context paramContext, int paramInt)
  {
  ...
  AVVideoCtrl a()
  {
    AVContext localAVContext = amgw.a(this.jdField_a_of_type_AndroidContentContext).a();
