...
public class ntt
{
  ...
  public ntt(QQAppInterface paramQQAppInterface)
  {
  ...
  private userinfo.UserInfo a(SosoInterface.SosoLbsInfo paramSosoLbsInfo)
  {
    ...
    try
    {
      ...
      paramSosoLbsInfo.str_app_version.set(DeviceInfoUtil.getQQVersion());
      localUserInfo.app_info.set(paramSosoLbsInfo);
      localUserInfo.bytes_client_version.set(ByteStringMicro.copyFromUtf8("8.4.10"));
  ...
  private void a(String paramString, byte[] paramArrayOfByte, BusinessObserver paramBusinessObserver)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.a.getApplication(), nta.class);
  ...
  private void a(userinfo.UserInfo paramUserInfo, ntu paramntu)
  {
    ...
    a("SearchAsmTab.GetPopClassific", localReqBody.toByteArray(), new ntv(paramntu, this.a, 1));
  }
  
  public void a(ntu paramntu)
  {
    try
    {
      a(a(null), paramntu);
