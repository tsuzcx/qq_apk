...
public class bcxm
{
  ...
  public static bcxm a()
  {
    try
    {
      if (jdField_a_of_type_Bcxm == null) {
        jdField_a_of_type_Bcxm = new bcxm();
      }
      bcxm localbcxm = jdField_a_of_type_Bcxm;
      return localbcxm;
    }
    finally {}
  }
  ...
  public long a()
  {
    try
    {
      ...
      bdht.b("CommonDataAdapter", "get uin from app runtim succ:" + this.jdField_a_of_type_Long);
      label46:
  ...
  protected void a()
  {
    ...
    {
      bdht.e("AppUpdate", "getPackageInfo NameNotFoundException : " + localNameNotFoundException.toString());
      return;
    }
    catch (Exception localException)
    {
      bdht.e("AppUpdate", "getPackageInfo exception : " + localException.toString());
    }
  }
  ...
  public void a(String paramString, Context paramContext, WebView paramWebView)
  {
    try
    {
      ...
      localJSONObject2.put("imei", bdja.c());
      localJSONObject2.put("imsi", bdja.d());
      localJSONObject2.put("mac_addr", bdja.a());
      localJSONObject2.put("model_info", Build.MODEL);
      localJSONObject2.put("network_type", bdho.a(a().a()));
      localJSONObject2.put("network_operater", "");
      localJSONObject2.put("location", bdja.f());
    ...
    {
      bdht.e("AppUpdate", "getUpdateApp parse H5 params error : " + localJSONException.toString());
      if (!paramContext.getSharedPreferences("appcenter_app_report", 0).getBoolean("is_app_last_fullReport_success", false))
      {
        bdht.c("AppUpdate", "getUpdateApp will do full report");
        bdjd.a(paramContext, paramString, paramWebView, String.valueOf(a().a()), false);
        return;
      ...
      {
        bdht.c("AppUpdate", "getUpdateApp will do incremental report");
        bdjd.a(paramContext, null, 0, paramString, paramWebView, String.valueOf(a().a()));
        return;
      }
      bdht.c("AppUpdate", "getUpdateApp will get update app directly");
      bdjg.a(paramContext, paramWebView, paramString, true, String.valueOf(a().a()));
    }
  }
