  ...
  extends akif
{
  ...
  akkp(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
  ...
  public void initData(Intent paramIntent)
  {
    ...
    ((akib)this.mOtherCommonData).a(this.d, this.mPhotoCommonData);
  }
  ...
  public void initUI()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        {
          ((NewPhotoPreviewActivity)this.mActivity).findViewById(2131365326).setVisibility(0);
          ((NewPhotoPreviewActivity)this.mActivity).findViewById(2131365326).setOnClickListener(new akkq(this));
        }
        if (((this.jdField_a_of_type_Akic.g) || (this.jdField_a_of_type_Akic.isSingleMode)) && (!this.jdField_a_of_type_Boolean)) {
        ...
        if ((this.jdField_a_of_type_Akic.paths.size() > 1) && (this.mPhotoCommonData.selectedPhotoList.size() > 1)) {
          break;
        }
  ...
  public void onMagicStickClick(View paramView, int paramInt1, Bundle paramBundle, int paramInt2, Intent paramIntent)
  {
    ...
    if (this.jdField_a_of_type_Akic.a != null)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (paramInt1 < this.jdField_a_of_type_Akic.paths.size()) {
          this.jdField_a_of_type_Akic.a = ((String)this.jdField_a_of_type_Akic.paths.get(paramInt1));
        }
      }
      paramView = EditPicActivity.a(this.mActivity, this.jdField_a_of_type_Akic.a, true, true, true, true, true, 8);
      ...
      {
        paramInt2 = this.jdField_a_of_type_Akic.e;
    ...
    for (paramInt1 = this.mPhotoCommonData.selectedPhotoList.size();; paramInt1 = 0)
    {
      ...
      paramView = EditPicActivity.a(this.mActivity, this.jdField_a_of_type_Akic.a, true, true, true, true, true, paramInt2, 99, 4, paramView);
      break;
      label511:
      paramView = new Bundle();
      paramView = EditPicActivity.a(this.mActivity, this.jdField_a_of_type_Akic.a, true, true, true, true, true, 2, 99, 4, paramView);
      break;
  ...
  public void updateButton()
  {
    ...
    for (int i = 1;; i = 0)
    {
      if ((i != 0) && (!this.jdField_a_of_type_Akic.g) && (!this.jdField_a_of_type_Akic.isSingleMode) && (this.jdField_a_of_type_Boolean)) {
        ((NewPhotoPreviewActivity)this.mActivity).magicStickBtn.setEnabled(true);
      }
      return;
    }
