  ...
  implements FaceDecoder.DecodeTaskCompletionListener
{
  ...
  public lnz(ReadInJoySubscribeFragement paramReadInJoySubscribeFragement, Activity paramActivity, ListView paramListView)
  {
  ...
  private void c()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130969629, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367053));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367231));
    this.b = this.jdField_a_of_type_AndroidViewView.findViewById(2131367232);
    ...
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new loa(this));
