  ...
  extends afbm
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = asiv.jdField_a_of_type_JavaLangString + "GameMsgChatHelper";
  }
  
  public afaf(BaseChatPie paramBaseChatPie)
  {
  ...
  private asik a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) || (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aglv)))
    {
      QLog.w(jdField_a_of_type_JavaLangString, 1, " param error.");
      return null;
    }
    return ((aglv)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a();
  }
  ...
  protected void a()
  {
    ...
    {
      Object localObject1 = (LinearLayout)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131366997);
      ...
      if ((localObject2 instanceof LinearLayout.LayoutParams))
      {
        ...
        ((LinearLayout.LayoutParams)localObject2).width = aekt.a(60.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
        ((LinearLayout.LayoutParams)localObject2).height = aekt.a(34.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
        ...
        if (AppSetting.c) {
          this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setContentDescription(alpo.a(2131714561));
        }
      }
  ...
  {
    super.c();
    LinearLayout localLinearLayout = (LinearLayout)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131366997);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      asik localasik = a();
      if (localasik != null) {
        bkeu.a().a(localasik.c, "1", "145", "920", "92005", "206353", "", "", "20", "0");
      }
    }
  }
}
