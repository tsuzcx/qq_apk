  ...
  implements BusinessObserver
{
  ...
  private static aiug jdField_a_of_type_Aiug;
  ...
  private final SparseArray<WeakReference<aiuk>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private WeakReference<AppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  private List<aiuj> jdField_a_of_type_JavaUtilList;
  ...
  public static aiug a()
  {
    try
    {
      if (jdField_a_of_type_Aiug == null) {
        jdField_a_of_type_Aiug = new aiug();
      }
      aiug localaiug = jdField_a_of_type_Aiug;
      return localaiug;
    }
    finally {}
  }
  ...
  private void a(int paramInt)
  {
    ...
    {
      ((aiuk)localWeakReference.get()).a(false, null);
      this.jdField_a_of_type_AndroidUtilSparseArray.remove(paramInt);
    }
    QLog.i("rscContent_CmShowRscUpdateHandler", 1, "onContentCheckFailed requestId:" + paramInt);
  }
  
  private void a(int paramInt, aiuj paramaiuj)
  {
    if (paramaiuj == null) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("rscContent_CmShowRscUpdateHandler", 2, "onContentCheckSuccess result" + paramaiuj);
    }
    if ((paramaiuj.jdField_a_of_type_Int == 100) && (paramaiuj.jdField_a_of_type_Long == 1L))
    {
      if (1 == BaseApplicationImpl.sProcessId) {
        break label293;
      }
      if ("all_room3D".equals(paramaiuj.jdField_a_of_type_JavaLangString)) {
        aiub.a().a();
      }
    }
    else
    {
      label79:
      a(paramaiuj, paramaiuj.jdField_b_of_type_Int);
      if (paramaiuj.jdField_b_of_type_Boolean)
      {
        if (paramaiuj.jdField_d_of_type_Int <= 0) {
          break label417;
        }
        if (jdField_a_of_type_Int == paramaiuj.jdField_d_of_type_Int) {
          break label380;
        }
        jdField_a_of_type_Int = paramaiuj.jdField_d_of_type_Int;
        this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putInt("json_content_update_interval", paramaiuj.jdField_d_of_type_Int).commit();
        QLog.i("rscContent_CmShowRscUpdateHandler", 1, "onContentCheckSuccess interval != result.mCheckServerInterval:" + paramaiuj.jdField_d_of_type_Int);
      }
    }
    label417:
    for (;;)
    {
      for (;;)
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilList.remove(paramaiuj);
        ...
        ((aiuk)((WeakReference)localObject).get()).a(true, paramaiuj);
        this.jdField_a_of_type_AndroidUtilSparseArray.remove(paramInt);
        return;
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("rscContent_CmShowRscUpdateHandler", 2, "onContentCheckSuccess interval == result.mCheckServerInterval:" + paramaiuj.jdField_d_of_type_Int);
        continue;
        QLog.i("rscContent_CmShowRscUpdateHandler", 1, "onContentCheckSuccess result.mCheckServerInterval <= 0" + paramaiuj.jdField_d_of_type_Int);
      }
    }
  }
  ...
  private void a(int paramInt, List<aiuj> paramList)
  {
    if (paramList != null)
    {
      if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        if (localObject != null)
        {
          ...
          if ((localObject != null) && (((bbwi)localObject).a(3) != null))
          {
            paramList = paramList.iterator();
            while (paramList.hasNext())
            {
              aiuj localaiuj = (aiuj)paramList.next();
              if (localaiuj != null)
              {
                localObject = new File(localaiuj.c());
                ((File)localObject).getParentFile().mkdirs();
                if (((File)localObject).exists()) {
                  ((File)localObject).delete();
                }
                String str1 = localaiuj.e();
                if ((localaiuj.jdField_a_of_type_Boolean) && (!new File(str1).exists()))
                {
                  localaiuj.jdField_a_of_type_Boolean = false;
                  QLog.e("rscContent_CmShowRscUpdateHandler", 1, "updateResource old version File no exist :" + str1);
                }
                if (localaiuj.jdField_a_of_type_Boolean)
                {
                  if (localaiuj.jdField_a_of_type_ArrayOfByte != null)
                  {
                    String str2 = localaiuj.d();
                    if (bbdj.a(localaiuj.jdField_a_of_type_ArrayOfByte, str2))
                    {
                      if (BspatchUtil.a(str1, str2, ((File)localObject).getAbsolutePath()))
                      {
                        ...
                        try
                        {
                          str1 = bdhv.a(((File)localObject).getAbsolutePath());
                          if (QLog.isColorLevel()) {
                            QLog.d("rscContent_CmShowRscUpdateHandler", 2, " updateResource onDone dstMd5:" + str1 + " result.mMd5:" + localaiuj.jdField_d_of_type_JavaLangString);
                          }
                          if (!b(localaiuj, str1)) {
                            break label640;
                          }
                        ...
                        catch (Exception localException)
                        {
                          for (;;)
                          {
                            ...
                            a(paramInt);
                            break;
                            boolean bool = bbdj.d(((File)localObject).getAbsolutePath(), localException.b() + localException.jdField_e_of_type_JavaLangString);
  ...
  private void a(aiuj paramaiuj)
  {
    if (QLog.isColorLevel()) {
      QLog.d("rscContent_CmShowRscUpdateHandler", 2, "downloadZipAndPatch result:" + paramaiuj);
    }
    if (paramaiuj == null) {}
    Object localObject;
    do
    {
      ...
      localObject = ((bbwi)localObject).a(3);
    } while (localObject == null);
    if (TextUtils.isEmpty(paramaiuj.c))
    {
      QLog.e("rscContent_CmShowRscUpdateHandler", 2, "downloadZipAndPatch result.mDownloadPatchFileUrl is empty result:" + paramaiuj);
      return;
    }
    File localFile = new File(paramaiuj.d());
    localFile.getParentFile().mkdirs();
    if (localFile.exists()) {
      localFile.delete();
    }
    bbwg localbbwg = new bbwg(paramaiuj.c, localFile);
    localbbwg.p = true;
    localbbwg.n = true;
    localbbwg.f = "apollo_res";
    localbbwg.jdField_b_of_type_Int = 1;
    localbbwg.q = true;
    localbbwg.r = true;
    localbbwg.jdField_a_of_type_JavaLangString = (paramaiuj.jdField_b_of_type_JavaLangString + "_" + paramaiuj.jdField_a_of_type_JavaLangString);
    ((bbwl)localObject).a(localbbwg, new aiuh(this, localFile, paramaiuj), null);
  }
  
  private void b(aiuj paramaiuj)
  {
    if (QLog.isColorLevel()) {
      QLog.d("rscContent_CmShowRscUpdateHandler", 2, "downloadAllZip result:" + paramaiuj);
    }
    if ((this.jdField_a_of_type_JavaLangRefWeakReference == null) || (paramaiuj == null)) {}
    Object localObject;
    do
    {
      do
    ...
    if (TextUtils.isEmpty(paramaiuj.jdField_b_of_type_JavaLangString))
    {
      QLog.e("rscContent_CmShowRscUpdateHandler", 2, "downloadAllZip result.mDownloadFileUrl is empty result:" + paramaiuj);
      return;
    }
    File localFile = new File(paramaiuj.c());
    localFile.getParentFile().mkdirs();
    if (localFile.exists()) {
      localFile.delete();
    }
    bbwg localbbwg = new bbwg(paramaiuj.jdField_b_of_type_JavaLangString, localFile);
    localbbwg.p = true;
    localbbwg.n = true;
    localbbwg.f = "apollo_res";
    localbbwg.jdField_b_of_type_Int = 1;
    ...
    localbbwg.r = true;
    localbbwg.jdField_a_of_type_JavaLangString = (paramaiuj.jdField_b_of_type_JavaLangString + "_" + paramaiuj.jdField_a_of_type_JavaLangString);
    ((bbwl)localObject).a(localbbwg, new aiui(this, localFile, paramaiuj), null);
  }
  
  private static boolean b(aiuj paramaiuj)
  {
    if (paramaiuj == null) {}
    while ((TextUtils.isEmpty(paramaiuj.jdField_e_of_type_JavaLangString)) || (!paramaiuj.jdField_e_of_type_JavaLangString.endsWith(".zip"))) {
      return false;
    }
    return true;
  }
  
  private static boolean b(aiuj paramaiuj, String paramString)
  {
    if (paramaiuj == null) {}
    do
    {
      return false;
      if (TextUtils.isEmpty(paramaiuj.jdField_d_of_type_JavaLangString)) {
        return true;
      }
    } while ((paramString == null) || (!paramString.equalsIgnoreCase(paramaiuj.jdField_d_of_type_JavaLangString)));
    return true;
  }
  ...
  public void a(int paramInt, aiuk paramaiuk)
  {
    synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
    {
      this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, new WeakReference(paramaiuk));
      return;
    }
  }
  
  public void a(aiuj paramaiuj, int paramInt)
  {
    if (paramaiuj != null)
    {
      this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putInt(paramaiuj.a(), paramInt).commit();
  ...
  public void a(AppInterface paramAppInterface, int paramInt, boolean paramBoolean)
  {
    ...
    {
      return;
      if (!aiuj.a(100, 1L, "all_room3D", "all_room3D.json"))
      {
      ...
      try
      {
        ...
        localObject1 = new NewIntent(BaseApplicationImpl.getContext(), arpb.class);
