...
public class aiug
  implements aiil, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, Handler.Callback, View.OnClickListener, TouchWebView.OnScrollChangedListener
{
  public float a;
  int jdField_a_of_type_Int = 1;
  private aiij jdField_a_of_type_Aiij;
  ...
  public aiug(RelativeLayout paramRelativeLayout, aiup paramaiup)
  {
    this.jdField_a_of_type_Aiup = paramaiup;
    ...
    paramaiup = new RelativeLayout.LayoutParams(100, 100);
    this.jdField_a_of_type_Aiij = new aiuh(this);
    this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRender().setRenderCallback(this.jdField_a_of_type_Aiij);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView, paramaiup);
    this.jdField_e_of_type_Float = (ajia.a() / 16.0F);
    if (this.jdField_e_of_type_Float != 0.0F) {
      this.jdField_d_of_type_Float = (babp.a() / this.jdField_e_of_type_Float);
    }
    if (this.jdField_d_of_type_Float == 0.0F) {
      this.jdField_d_of_type_Float = babp.a();
    }
    ...
    this.jdField_a_of_type_Aiul = new aiul();
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = new RelativeLayout(paramRelativeLayout);
    paramaiup = new ImageView(paramRelativeLayout);
    paramaiup.setImageResource(2130839113);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(13, -1);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.addView(paramaiup, localLayoutParams);
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundResource(2130838433);
  ...
  private String b(int paramInt, boolean paramBoolean, ApolloWebAvatarParam paramApolloWebAvatarParam)
  {
    ...
    if (!aiwi.a(paramApolloWebAvatarParam.uin, paramApolloWebAvatarParam.roleId, paramApolloWebAvatarParam.dressIds, null))
    {
      bbmy.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), ajjy.a(2131634782), 0).a();
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        if ((paramApolloWebAvatarParam.tapRectWidth > 0) && (paramApolloWebAvatarParam.tapRectHeight > 0))
        {
          ...
          this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(23, 500L);
          ...
          ((RelativeLayout.LayoutParams)???).topMargin = ((int)(paramApolloWebAvatarParam.y * this.jdField_d_of_type_Float - (float)babp.j() * this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.rate));
          ((RelativeLayout.LayoutParams)???).rightMargin = ((int)((float)babp.i() - this.jdField_d_of_type_Float * paramApolloWebAvatarParam.x - ((RelativeLayout.LayoutParams)???).width - ApolloUtil.a(68.0F, this.jdField_d_of_type_Float) * this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.rate / 0.289F));
          ...
          this.jdField_a_of_type_Befq.sendMessage(paramApolloWebAvatarParam);
  ...
  private void e()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) {
          if (this.jdField_i_of_type_Int == 0) {
            ...
            for (;;)
            {
              if (!new File(aitw.b(this.jdField_i_of_type_Int)).exists()) {
                break label395;
              }
              this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(24, (int)(this.jdField_f_of_type_Float * 1000.0F));
              return;
              k = 0;
              break;
              m = 0;
      ...
      if ((!TextUtils.isEmpty(aiwj.a().jdField_a_of_type_JavaLangString)) && ("interactive".equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.tab)))
      {
        this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(24, 0L);
        return;
      }
    ...
    for (int m = 1;; m = 0)
    {
      ...
      if ((!aitw.a(this.jdField_c_of_type_Int)) || (m != 0) || (k != 0) || (n == 0)) {
        break;
      }
      try
      {
        baan.a(BaseApplicationImpl.getContext(), true);
        this.jdField_a_of_type_AndroidMediaMediaPlayer.reset();
        this.jdField_a_of_type_AndroidMediaMediaPlayer.setDataSource(aiys.jdField_d_of_type_JavaLangString + this.jdField_c_of_type_Int + "/" + "music.amr");
  ...
  private void f()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Befq != null) {
        this.jdField_a_of_type_Befq.removeMessages(24);
      }
      return;
    }
  ...
  public String a()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null))
    {
      ...
      String[] arrayOfString = aiwi.a(10, -1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
      if ((arrayOfString.length > 0) && (!TextUtils.isEmpty(arrayOfString[0])) && (arrayOfString[0].length() - "action".length() > 0)) {}
      aiwj.a().jdField_a_of_type_JavaLangString = arrayOfString[0].substring(0, arrayOfString[0].length() - "action".length());
    ...
    this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(22, 100L);
    return a(ajjy.a(2131634770));
  }
  ...
  public String a(int paramInt, boolean paramBoolean, ApolloWebAvatarParam paramApolloWebAvatarParam)
  {
    ...
    if (!aiwi.a(paramApolloWebAvatarParam.uin, paramApolloWebAvatarParam.roleId, paramApolloWebAvatarParam.dressIds, null))
    {
      bbmy.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), ajjy.a(2131634769), 0).a();
      return a("dresses is not download!");
    }
    if ((!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString)) && (!this.jdField_e_of_type_JavaLangString.equals(paramApolloWebAvatarParam.tab)))
    {
      ...
      this.jdField_a_of_type_Befq.postDelayed(new ApolloViewController.2(this, paramInt, paramBoolean, paramApolloWebAvatarParam), 100L);
    }
    for (;;)
    {
      return b("initAvatar成功");
  ...
  public String a(aiuk paramaiuk)
  {
    if (this.j)
    {
      ...
      return a(ajjy.a(2131634775));
    }
    if (paramaiuk == null) {
      return a("actionData is null");
    }
    if (paramaiuk.jdField_a_of_type_Int > 1) {}
    for (this.jdField_a_of_type_Aiuk = paramaiuk; (paramaiuk.jdField_c_of_type_Int == 1) && (!TextUtils.isEmpty(paramaiuk.jdField_b_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (!paramaiuk.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)); this.jdField_a_of_type_Aiuk = null) {
      return a(ajjy.a(2131634780));
    }
    if ((TextUtils.isEmpty(paramaiuk.jdField_b_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)) {
      paramaiuk.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId;
    }
    if (TextUtils.isEmpty(paramaiuk.jdField_b_of_type_JavaLangString)) {
      return a("未传apolloId");
    }
    if (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramaiuk.jdField_b_of_type_JavaLangString)) {
      return a(ajjy.a(2131634778));
    }
    Object localObject1 = (ApolloWebAvatarParam)this.jdField_a_of_type_JavaUtilHashMap.get(paramaiuk.jdField_b_of_type_JavaLangString);
    if (localObject1 == null) {
      return a(ajjy.a(2131634763));
    }
    int m = 0;
    int k = m;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
    {
      k = m;
      if (paramaiuk.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)) {
        k = 1;
      }
    }
    if ((k != 0) && (!aiwi.a(((ApolloWebAvatarParam)localObject1).uin, ((ApolloWebAvatarParam)localObject1).roleId, ((ApolloWebAvatarParam)localObject1).dressIds, null)))
    {
      bbmy.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), ajjy.a(2131634765), 0).a();
      return a(ajjy.a(2131634776));
    }
    if (!ApolloUtil.a(paramaiuk.jdField_b_of_type_Int, paramaiuk.jdField_c_of_type_Int))
    {
      if (k != 0) {
        bbmy.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), ajjy.a(2131634783), 0).a();
      }
      return a(ajjy.a(2131634766));
    }
    ...
    {
      if (k != 0) {
        bbmy.a(BaseApplicationImpl.getContext(), ajjy.a(2131634781), 0).a();
      }
      return a(ajjy.a(2131634771));
    }
    if (k != 0) {
      f();
    }
    this.jdField_i_of_type_Int = paramaiuk.m;
    this.jdField_f_of_type_Float = paramaiuk.jdField_a_of_type_Float;
    boolean bool;
    label556:
    label616:
    float f1;
    ...
    if (paramaiuk.l == 0)
    {
      ...
      this.jdField_h_of_type_Boolean = paramaiuk.jdField_a_of_type_Boolean;
      if ((this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (paramaiuk.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId))) {
        this.jdField_c_of_type_Int = paramaiuk.jdField_b_of_type_Int;
      }
      this.jdField_b_of_type_Boolean = true;
      this.jdField_a_of_type_AndroidWidgetFrameLayout.setVisibility(8);
      this.jdField_a_of_type_Befq.removeMessages(16);
      this.jdField_f_of_type_Int = paramaiuk.jdField_i_of_type_Int;
      this.jdField_d_of_type_JavaLangString = paramaiuk.jdField_a_of_type_JavaLangString;
      this.jdField_g_of_type_Int = paramaiuk.k;
      if (paramaiuk.j != 1) {
        break label1141;
      }
      bool = true;
      this.jdField_f_of_type_Boolean = bool;
      if ((!paramaiuk.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Aiul != null)) {
        this.jdField_a_of_type_Aiul.a();
      }
      if ((!TextUtils.isEmpty(paramaiuk.jdField_a_of_type_JavaLangString)) && (!paramaiuk.jdField_a_of_type_Boolean)) {
        break label1147;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView.setVisibility(8);
      }
      if (paramaiuk.jdField_d_of_type_Int != 0) {
        break label1518;
      }
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.setVisibility(0);
      ...
      if (this.jdField_a_of_type_Int != paramaiuk.jdField_c_of_type_Int)
      {
        ...
        if (paramaiuk.jdField_c_of_type_Int != 1) {
          break label1218;
        }
        if (ApolloUtil.c(this.jdField_f_of_type_Int))
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, aitw.a(this.jdField_f_of_type_Int), null);
      ...
      this.jdField_a_of_type_Aiul.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView, paramaiuk.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, paramaiuk.jdField_c_of_type_Int);
      this.jdField_a_of_type_Aiul.a(paramaiuk.jdField_b_of_type_Float);
      this.jdField_a_of_type_Int = paramaiuk.jdField_c_of_type_Int;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      if (TextUtils.isEmpty(paramaiuk.jdField_a_of_type_JavaLangString)) {
        break label1496;
      }
      if (paramaiuk.k != 1) {
        break label1453;
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView != null)
      {
        ...
        n = (int)((float)babp.j() * ((ApolloWebAvatarParam)localObject1).rate * 1.14F);
        ...
        label1086:
        if (!paramaiuk.jdField_a_of_type_Boolean) {
          aijj.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getWidth(), n, this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView, BaseApplicationImpl.getContext(), "", paramaiuk.jdField_a_of_type_JavaLangString, true);
        }
      }
    }
    for (;;)
    {
      ...
      localObject2 = aiwi.a(13, paramaiuk.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, true);
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, ((ApolloWebAvatarParam)localObject1).apolloId, paramaiuk.jdField_b_of_type_Int, 0, localObject2[0], localObject2[1]);
      if (paramaiuk.jdField_c_of_type_Int != 1) {
        break label890;
      }
      localObject2 = aiwi.a(13, paramaiuk.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, false);
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, paramaiuk.jdField_b_of_type_Int, 0, localObject2[0], localObject2[1]);
      break label890;
      label1384:
      ...
      break label1086;
      label1453:
      aiwj.a().jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(8);
    ...
    if ((!this.jdField_c_of_type_Boolean) || (this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView == null))
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.init(new aiui(this, (DisplayMetrics)localObject1, paramaiuk));
      if (this.jdField_b_of_type_Aiij == null) {
        this.jdField_b_of_type_Aiij = new aiuj(this);
      }
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRender().setRenderCallback(this.jdField_b_of_type_Aiij);
      label1745:
      this.jdField_a_of_type_Int = 1;
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      ...
      localObject1 = ajjy.a(2131634784);
      label1800:
      ...
      label1836:
      if ((paramaiuk.jdField_h_of_type_Int != 1) && (paramaiuk.jdField_e_of_type_Int > 0)) {
        break label2002;
      }
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setTag(Integer.valueOf(paramaiuk.jdField_b_of_type_Int));
      break;
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      localObject1 = this.jdField_a_of_type_Befq.obtainMessage(19, paramaiuk.jdField_c_of_type_Int, paramaiuk.jdField_b_of_type_Int);
      if (paramaiuk.jdField_a_of_type_Boolean) {
        ((Message)localObject1).obj = Float.valueOf(paramaiuk.jdField_b_of_type_Float);
      }
      this.jdField_a_of_type_Befq.sendMessageDelayed((Message)localObject1, 100L);
      break label1745;
      label1981:
      ...
      label2002:
      if (QLog.isColorLevel()) {
        QLog.d("ApolloViewController", 2, new Object[] { "vipFlag:", Integer.valueOf(paramaiuk.jdField_f_of_type_Int), ", isSvip:", Boolean.valueOf(paramaiuk.jdField_b_of_type_Boolean) });
      }
      if (paramaiuk.jdField_f_of_type_Int <= 0)
      {
        bool = true;
        label2061:
        if (TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString))
      ...
      label2157:
      for (localObject1 = ajjy.a(2131634764);; localObject1 = ajjy.a(2131634786))
      {
        ((TextView)localObject2).setText((CharSequence)localObject1);
        this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
        ApolloUtil.a(this.jdField_b_of_type_AndroidWidgetImageView, paramaiuk.jdField_e_of_type_Int, bool);
        if ((paramaiuk.jdField_f_of_type_Int > 0) || (paramaiuk.jdField_b_of_type_Boolean)) {
          break label2168;
        }
  ...
  public String a(ArrayList<ApolloWebAvatarParam> paramArrayList)
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if (!aiwi.a(localApolloWebAvatarParam.uin, localApolloWebAvatarParam.roleId, localApolloWebAvatarParam.dressIds, null))
      {
        bbmy.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), ajjy.a(2131634767), 0).a();
        return a("dresses is not download!");
      }
    }
  ...
  public String a(int[] paramArrayOfInt)
  {
    if (this.j)
    {
      ...
      return a(ajjy.a(2131634777));
    }
    if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam == null) {
      return a(ajjy.a(2131634768));
    }
    if (!aiwi.a(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.uin, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, paramArrayOfInt, null))
    {
      bbmy.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), ajjy.a(2131634785), 0).a();
      return a(ajjy.a(2131634774));
    }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getColor(2131101176));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(4);
      Object localObject1 = new RelativeLayout.LayoutParams(-2, (int)((float)babp.j() * 0.6F));
      ((RelativeLayout.LayoutParams)localObject1).addRule(13, -1);
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = ApolloUtil.a(25.0F, this.jdField_d_of_type_Float);
      ((RelativeLayout.LayoutParams)localObject1).rightMargin = ApolloUtil.a(25.0F, this.jdField_d_of_type_Float);
      Object localObject2 = LayoutInflater.from(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext()).inflate(2131493070, null);
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)((View)localObject2).findViewById(2131298237));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((View)localObject2).findViewById(2131297037));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      amyn localamyn = new amyn(-7707920, 15.0F, (int)(babp.i() - aciy.a(72.0F, this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources())), aciy.a(44.0F, this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources()));
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundDrawable(localamyn);
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject2).findViewById(2131297036));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject2).findViewById(2131297034));
      ...
      ((ImageView)localObject1).setId(2131297065);
      ...
      ((ImageView)localObject1).setBackgroundResource(2130838263);
  ...
  {
    this.jdField_a_of_type_Befq.removeMessages(23);
    this.jdField_b_of_type_Int = paramInt;
    if (this.jdField_g_of_type_Boolean)
    {
      this.jdField_a_of_type_Befq.removeMessages(16);
      this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(16, 3000L);
    }
    label218:
    label250:
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
      {
        if ("mall".equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.tab)) {
          ...
          {
            this.jdField_a_of_type_JavaLangString = ajjy.a(2131634787);
            if (this.jdField_h_of_type_Int == 1) {
              this.jdField_a_of_type_JavaLangString = aitw.a(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId);
            }
        ...
        for (;;)
        {
          ...
          {
            this.jdField_a_of_type_JavaLangString = ajjy.a(2131634772);
            break;
          }
  ...
  public void a(aiil paramaiil)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaiil);
  }
  
  public void a(Activity paramActivity, AppInterface paramAppInterface, String paramString1, String paramString2)
  {
    c(false);
    this.jdField_a_of_type_Befq.postDelayed(new ApolloViewController.3(this, paramActivity, paramAppInterface, paramString1, paramString2), 500L);
  }
  ...
  public void c(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = 1;
      this.jdField_a_of_type_Befq.obtainMessage(18).sendToTarget();
      return;
      label79:
  ...
  public boolean handleMessage(Message arg1)
  {
    ...
    case 27: 
      do
      {
        do
        {
          do
          {
            for (;;)
            {
              ...
              if ((this.jdField_a_of_type_AndroidMediaAudioManager != null) && (this.jdField_a_of_type_AndroidMediaAudioManager.getRingerMode() == 1))
              {
                ...
                n = 1;
                if ((!new File(aitw.b(this.jdField_i_of_type_Int)).exists()) || (m != 0) || (k != 0) || (n == 0)) {}
              }
              try
              {
                baan.a(BaseApplicationImpl.getContext(), true);
                this.jdField_a_of_type_AndroidMediaMediaPlayer.reset();
                this.jdField_a_of_type_AndroidMediaMediaPlayer.setDataSource(aitw.b(this.jdField_i_of_type_Int));
                this.jdField_a_of_type_AndroidMediaMediaPlayer.prepare();
                this.jdField_a_of_type_AndroidMediaMediaPlayer.start();
                if (!TextUtils.isEmpty(aiwj.a().jdField_a_of_type_JavaLangString))
                {
                  ??? = aiwj.a().jdField_a_of_type_JavaLangString;
                  if (???.startsWith("def"))
                  {
                    ??? = aiys.jdField_c_of_type_JavaLangString + "/" + ???;
                    aiwj.a().jdField_a_of_type_JavaLangString = "";
                    ??? = ApolloUtil.a(???, "amr");
                    if (??? == null) {}
                  }
              ...
              catch (Throwable ???)
              {
                try
                {
                  ...
                  ??? = aiys.jdField_a_of_type_JavaLangString + "/" + ???;
                }
                catch (IOException ???)
                {
                  for (;;)
          ...
          ??? = aiwi.a(4, -1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
        ...
        if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_Int != 0))
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId, aitw.a, null);
          }
        }
        for (;;)
        {
          synchronized (this.jdField_a_of_type_JavaUtilHashMap)
          {
            ...
            if ((???.arg1 > 0) && (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString)) && (this.jdField_f_of_type_Boolean) && (this.jdField_g_of_type_Int == 0))
            {
              ...
              if (this.jdField_a_of_type_Aiup != null) {
                this.jdField_a_of_type_Aiup.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView);
              }
              a(false);
              ...
              this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(21, 100L);
              return false;
              if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
              {
              ...
              for (;;)
              {
                synchronized (this.jdField_a_of_type_JavaUtilHashMap)
                {
                  for (;;)
                  {
                    ...
                    {
                      ???.a(1, localApolloWebAvatarParam.apolloId, aitw.a, null);
                      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
                      {
      ...
      if (!TextUtils.isEmpty((CharSequence)???))
      {
        if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)) {
          synchronized (this.jdField_a_of_type_JavaUtilHashMap)
          {
            if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(???))
            {
              ...
              if (localApolloWebAvatarParam != null)
              {
                ...
                if (??? != null)
                {
                  ...
                  ((aigt)???).a(1, localApolloWebAvatarParam.apolloId, localApolloWebAvatarParam.roleId, ApolloUtil.a(localApolloWebAvatarParam.rate), localApolloWebAvatarParam.x, this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight() / this.jdField_d_of_type_Float - localApolloWebAvatarParam.y);
                  if (localApolloWebAvatarParam.roleId != 0) {
                    break label1995;
                  }
                  ((aigt)???).a(1, localApolloWebAvatarParam.apolloId, aitw.a, null);
                }
              }
            }
            ...
            ((aigt)???).a(1, localApolloWebAvatarParam.apolloId, localApolloWebAvatarParam.dressIds, null);
          }
        }
    ...
    case 19: 
      ...
      {
        f2 = 77.0F;
        f4 = (float)(Math.max(babp.h(), babp.g()) / 7L) / 368.0F;
        ??? = ???.obj;
    ...
    for (int k = 1;; k = 0)
    {
      ...
      {
        f1 = 330.0F * f4 / babp.jdField_a_of_type_Float / 2.0F;
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, aitw.a(this.jdField_f_of_type_Int), null);
        ??? = aiwi.a(13, n, this.jdField_f_of_type_Int, false);
        if (k != 0)
        {
          this.jdField_a_of_type_Aiul.a(this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView, n, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, m);
          this.jdField_a_of_type_Aiul.a(f3);
        }
      }
      for (;;)
      {
        ...
        ??? = aiwi.a(13, n, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
          ...
          if (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString))
          {
            if (this.jdField_g_of_type_Int == 1)
            {
              ...
              if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != ???)
              {
                ...
                ???.bottomMargin = (aciy.a(f2, this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources()) + (this.jdField_a_of_type_AndroidWidgetRelativeLayout.getHeight() - this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight()) / 2);
              ...
              aijj.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getWidth(), k, this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView, BaseApplicationImpl.getContext(), "", this.jdField_d_of_type_JavaLangString, true);
              return true;
              f2 = 42.0F;
              break;
            ...
            aiwj.a().jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId, "Bubble");
        return true;
        if ((this.jdField_a_of_type_Aiuk == null) || (this.jdField_a_of_type_Aiuk.jdField_a_of_type_Int <= 0)) {
          break;
        }
        ??? = this.jdField_a_of_type_Aiuk;
        ???.jdField_a_of_type_Int -= 1;
        a(this.jdField_a_of_type_Aiuk);
        return false;
        label2851:
        return true;
        f1 = 0.0F;
  ...
  {
    if (paramView.getId() == 2131297065)
    {
      this.jdField_a_of_type_Befq.sendEmptyMessage(15);
      f();
    }
    ...
    f();
    if ((this.jdField_a_of_type_Aiup != null) && ((paramView.getTag() instanceof Integer))) {
      this.jdField_a_of_type_Aiup.a(((Integer)paramView.getTag()).intValue());
    }
    this.jdField_a_of_type_Befq.sendEmptyMessage(15);
  }
  ...
  public void onNotifyLongTouch(String paramString)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((aiil)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onNotifyLongTouch(paramString);
    }
  }
  ...
  public void onNotifyStatusChanged(int paramInt, String paramString)
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((aiil)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onNotifyStatusChanged(paramInt, paramString);
    }
  }
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Befq.sendEmptyMessage(18);
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((aiil)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onSurfaceReady(paramInt1, paramInt2);
    }
  }
}
