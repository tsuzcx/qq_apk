  ...
  implements bcsn
{
  ...
  public bcsl(Context paramContext, bcsk parambcsk, TypedArray paramTypedArray)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Bcsk = parambcsk;
  ...
  public bcsm a(ViewGroup paramViewGroup, int paramInt)
  {
    return new bcsm(new SimpleMonthView(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentResTypedArray), this);
  }
  ...
  public void a(bcsm parambcsm, int paramInt)
  {
    SimpleMonthView localSimpleMonthView = parambcsm.a;
    HashMap localHashMap = new HashMap();
    parambcsm = this.jdField_a_of_type_Bcsk.a();
    ...
    if (parambcsm.getTimeInMillis() > localCalendarDay2.getTimeInMillis()) {
      parambcsm = new CalendarDay(localCalendarDay1.year, localCalendarDay1.month - 1, 1);
    }
    for (;;)
    {
      int i = (parambcsm.month + paramInt) % 12;
      int j = parambcsm.year;
      paramInt = (parambcsm.month + paramInt) / 12 + j;
      ...
      localSimpleMonthView.setStartAndEndDate(parambcsm, localCalendarDay1);
      localSimpleMonthView.invalidate();
      this.jdField_a_of_type_Bcsk.a(localSimpleMonthView, paramInt, i);
      return;
    }
  }
  ...
  public void a(SimpleMonthView paramSimpleMonthView, CalendarDay paramCalendarDay, Object paramObject)
  {
    ...
    {
      a(paramCalendarDay);
      this.jdField_a_of_type_Bcsk.a(paramCalendarDay, (MessageRecord)paramObject);
    }
  }
  
  public int getItemCount()
  {
    int i = this.jdField_a_of_type_Bcsk.a().year * 12 + this.jdField_a_of_type_Bcsk.a().month;
    int j = this.jdField_a_of_type_Bcsk.b().year * 12 + this.jdField_a_of_type_Bcsk.b().month;
    if (i == j) {
      return 2;
    }
    return j - i + 1;
