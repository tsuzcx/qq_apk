  ...
  extends BaseBubbleBuilder
{
  ...
  public ahmu(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new ahmv(this);
  }
  ...
  private void a(TextView paramTextView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      int m = localResources.getDimensionPixelSize(2131297643);
      paramInt = k;
      if (k == 0) {
        paramInt = 1;
      }
    ...
    if (paramInt == 2)
    {
      ...
      if (paramSessionInfo.curType == 3000) {
        if (paramQQAppInterface.getAVNotifyCenter().b() != l) {
          bdla.b(paramQQAppInterface, "CliOper", "", "", "Multi_call", "Multi_call_disobj_launch", 0, 0, "", "", "", "");
        }
      }
      ...
      if (paramInt == 10)
      {
        ...
        for (;;)
        {
          bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8005DC6", "0X8005DC6", 0, 0, "", "", "", "");
          return;
          label242:
          bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8005925", "0X8005925", 0, 0, "", "", "", "");
        }
      }
      bdla.b(paramQQAppInterface, "CliOper", "", "", "0X80046CB", "0X80046CB", 0, 0, "", "", "", "");
      return;
    }
    boolean bool = bhfy.a("qqVideoEx", paramQQAppInterface, paramSessionInfo.curFriendUin);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, int paramInt, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    long l2 = baps.b(str);
    QLog.w("ChatItemBuilder", 1, "showGroupQavActionSheet, avType[" + paramInt + "], isVideo[" + paramBoolean + "], msgSelfUin[" + paramString1 + "], uinType[" + j + "], groupId[" + str + "], curFriendNick[" + paramSessionInfo.curFriendNick + "], troopUin[" + paramSessionInfo.troopUin + "], fromWhere[" + paramString2 + "], isVideoActionSheetShown[" + mvn.a() + "], seq[" + l1 + "]");
    if (10 == paramInt)
    {
      i = 0;
      boolean bool = false;
      ...
      {
        paramString1 = bhfy.a(paramQQAppInterface, str);
        bool = paramString1.getBoolean("forceDisableInviteBox");
        i = paramString1.getInt("errId", 2131695384);
      }
      if (bool)
      {
        bhdj.a(paramContext, 230, null, paramContext.getResources().getString(i), 2131695168, 2131719961, new ahmw(), null).show();
        return;
      }
    }
    if (paramBoolean)
    ...
    {
      if (i != 0) {
        AudioHelper.a(anvx.a(2131715656));
      }
      if ((!paramQQAppInterface.getAVNotifyCenter().a(l1, str)) && (i == 0)) {
        break label451;
      }
      paramSessionInfo = new Bundle();
      paramSessionInfo.putInt("MultiAVType", mvk.a(j));
      if (paramBoolean) {
        paramSessionInfo.putBoolean("isVideo", true);
      }
      if (j == 1) {
        paramSessionInfo.putBoolean("enableInvite", bhfy.a("showGroupQavActionSheet", paramQQAppInterface, str));
      }
    ...
    label451:
    paramString1 = paramQQAppInterface.getAVNotifyCenter().a(baps.b(str));
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, MessageForVideo paramMessageForVideo)
  {
    ...
    {
      bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8005642", "0X8005642", 0, 0, "", "", "", "");
      return;
    }
    bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8005243", "0X8005243", 0, 0, "", "", "", "");
  }
  ...
  static void a(QQAppInterface paramQQAppInterface, Context paramContext, MessageForVideo paramMessageForVideo, SessionInfo paramSessionInfo)
  {
    ...
    else
    {
      try
      {
        ...
        int i = mvk.b(paramSessionInfo.curType);
        ...
        boolean bool1 = ((bgkf)localObject).a(paramSessionInfo.curFriendUin, paramQQAppInterface.getCurrentAccountUin());
        boolean bool2 = ((bgkf)localObject).a(paramSessionInfo.curFriendUin);
        boolean bool3 = ((bgkf)localObject).b(paramSessionInfo.curFriendUin);
        localObject = ((bgkf)localObject).a(paramSessionInfo.curFriendUin);
        if ((l == 0L) && (((!bool3) && (bool1)) || ((!bool2) && (localObject != null) && (((bgkm)localObject).a > 0L))))
        {
          QQToast.a(paramQQAppInterface.getApp(), anvx.a(2131715655), 0).b(paramQQAppInterface.getApp().getResources().getDimensionPixelSize(2131299080));
          return;
        }
      }
  ...
  private static void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean, int paramInt)
  {
    ...
    if (!paramBoolean)
    {
      ...
      default: 
        paramSessionInfo = "0";
        label72:
        bdla.b(paramQQAppInterface, "CliOper", "", "", str1, str2, 0, 0, paramSessionInfo, "", "", "");
        if (paramInt == 2) {
          bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8004009", "", 0, 0, "2", "", "", "");
        }
        break;
      }
    }
    for (;;)
    {
      ...
      bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8005643", "0X8005643", 0, 0, "", "", "", "");
      return;
      str1 = "Two_video_call";
      ...
      break label72;
      if (paramInt == 0) {
        bdla.b(paramQQAppInterface, "CliOper", "", "", "0X800400A", "", 0, 0, "2", "", "", "");
      }
    }
    label238:
    bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8005244", "0X8005244", 0, 0, "", "", "", "");
  }
  ...
  static void a(QQAppInterface paramQQAppInterface, MessageForVideo paramMessageForVideo, SessionInfo paramSessionInfo)
  {
    ...
    if (paramMessageForVideo.type == 13)
    {
      ...
      bdla.b(paramQQAppInterface, "CliOper", "", "", "Multi_call", "Multi_call_disobj", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      if ((paramMessageForVideo.type == 2) || (paramMessageForVideo.type == 24)) {
        bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8004009", "", 0, 0, "1", "", "", "");
      }
      if (paramMessageForVideo.type == 0) {
        bdla.b(paramQQAppInterface, "CliOper", "", "", "0X800400A", "", 0, 0, "1", "", "", "");
      }
      return;
      label123:
      if (i == 1) {
        if (paramMessageForVideo.extInt == 10) {
          bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8005924", "0X8005924", 0, 0, "", "", "", "");
        } else {
          bdla.b(null, "dc00899", "Grp_video", "", "notice", "video", 0, 0, paramSessionInfo.curFriendUin, "" + TroopUtils.getTroopIdentity(paramQQAppInterface, paramSessionInfo.curFriendUin), "0", "");
        }
      }
    }
  }
  ...
  private void a(MessageForVideo paramMessageForVideo, Context paramContext, View paramView)
  {
    ...
    if (paramMessageForVideo.selfuin.equals(paramMessageForVideo.senderuin))
    {
      if (-2016 == paramMessageForVideo.msgtype) {
        localObject1 = anvx.a(2131715649);
      }
      ...
      if (!paramMessageForVideo.text.contains(paramContext.getResources().getString(2131719957))) {
        break label267;
      }
    ...
    for (;;)
    {
      paramView.setContentDescription(((String)localObject1).replace(anvx.a(2131715657), anvx.a(2131715648)));
      return;
      ...
      break label132;
      label267:
      if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131719946)))
      {
        paramContext = paramContext.getResources();
        if (paramMessageForVideo.isVideo) {}
        for (i = 2131719965;; i = 2131690225)
        {
          localObject1 = paramContext.getString(i);
          break;
        }
      }
      if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131695702))) {
        localObject1 = paramContext.getResources().getString(2131718494);
      } else if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131695701))) {
        localObject1 = paramContext.getResources().getString(2131718062);
      } else if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131695125))) {
        localObject1 = paramContext.getResources().getString(2131718494);
      } else if (paramMessageForVideo.text.contains(paramContext.getResources().getString(2131695124))) {
        localObject1 = paramContext.getResources().getString(2131718062);
      }
    }
  }
  ...
  public View a(ChatMessage paramChatMessage, afqr paramafqr, View paramView, BaseChatItemLayout paramBaseChatItemLayout, aftk paramaftk)
  {
    ...
    localahmx.a.setTextColor(localResources.getColor(i));
    localahmx.a.setText(paramView.text);
    if ((paramView.istroop == 1) && (this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131695326).equals(paramView.text))) {
      bdla.b(null, "dc00899", "Grp_video", "", "notice", "exp", 0, 0, paramView.frienduin, "" + TroopUtils.getTroopIdentity(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView.frienduin), "", "");
    }
    ...
    if (jdField_e_of_type_Boolean) {
      a(paramView, paramBaseChatItemLayout, paramafqr);
    }
    return paramafqr;
  }
  ...
  String a(MessageForVideo paramMessageForVideo, Context paramContext, View paramView)
  {
    ...
    String str1 = paramContext.getResources().getString(2131719957) + ",";
    ...
    for (;;)
    {
      ...
      label331:
      for (localObject = str1 + k + anvx.a(2131715651);; localObject = str1)
      {
        paramContext = (Context)localObject;
        if (j > 0) {
          paramContext = (String)localObject + j + anvx.a(2131715653);
        }
        localObject = paramContext;
        if (i > 0) {
          localObject = paramContext + i + anvx.a(2131715652);
        }
        paramContext = paramView.getResources();
        if (paramMessageForVideo.isVideo) {}
        for (i = 2131719451;; i = 2131719437)
        {
  ...
  {
    ahmx localahmx = (ahmx)paramafqr;
    localahmx.a.setTextSize(0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.textSizeForTextItem);
    if ((paramaqhi.a == 0) || (!paramaqhi.a()))
    {
      paramView = paramView.getResources();
      if (localahmx.a.getText().toString().contains(this.jdField_a_of_type_AndroidContentContext.getString(2131719943)))
      {
        paramafqr = paramView.getColorStateList(2131165950);
        localahmx.a.setTextColor(paramafqr);
        return;
      }
      ...
      {
        localahmx.a.setLinkTextColor(paramafqr);
        return;
    ...
    if (paramaqhi.b == 0) {
      localahmx.a.setTextColor(-16777216);
    }
    while (paramaqhi.c == 0)
    {
      localahmx.a.setLinkTextColor(paramView.getResources().getColorStateList(2131167047));
      return;
      localahmx.a.setTextColor(paramaqhi.b);
    }
    localahmx.a.setLinkTextColor(paramaqhi.c);
  }
