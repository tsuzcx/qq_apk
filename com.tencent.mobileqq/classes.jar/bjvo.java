  ...
  implements ChannelProxy
{
  ...
  private volatile zmn jdField_a_of_type_Zmn;
  
  private bmvj a(TianShuAccess.AdItem paramAdItem, String paramString, int paramInt)
  {
  ...
  {
    return new bjwb(paramAsyncResult);
  }
  ...
  private void a(Activity paramActivity, PublishMoodInfo paramPublishMoodInfo, MiniAppInfo paramMiniAppInfo)
  {
    ...
    if (paramMiniAppInfo != null)
    {
      ...
      if (paramMiniAppInfo != null)
      {
        ...
        if (!TextUtils.isEmpty(paramPublishMoodInfo.mPath))
        {
          ...
          paramPublishMoodInfo = paramActivity.getResources().getString(2131693689);
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("button_txt", paramActivity.getResources().getString(2131693698));
  ...
  public void JudgeTiming(String paramString1, int paramInt1, int paramInt2, int paramInt3, long paramLong, int paramInt4, String paramString2, int paramInt5, String paramString3, int paramInt6, COMM.StCommonExt paramStCommonExt, String paramString4, String paramString5, AsyncResult paramAsyncResult)
  {
    ...
    MiniAppSSOCmdHelper.sendSSOCmdRequest("LightAppSvc.mini_app_growguard.JudgeTiming", paramString1, paramString4, INTERFACE.StJudgeTimingRsp.class, new bjvu(this, paramAsyncResult));
  }
  ...
  public void ReportExecute(String paramString1, int paramInt, String paramString2, String paramString3, AsyncResult paramAsyncResult)
  {
    ...
    MiniAppSSOCmdHelper.sendSSOCmdRequest("LightAppSvc.mini_app_growguard.ReportExecute", paramString1, localStReportExecuteReq, INTERFACE.StReportExecuteRsp.class, new bjvv(this, paramAsyncResult));
  }
  ...
  public void addGroupApp(IMiniAppContext paramIMiniAppContext, AsyncResult paramAsyncResult)
  {
    ...
    return;
    label198:
    QIPCClientHelper.getInstance().callServer("MiniAppTransferModule", "query_user_troop_info", new Bundle(), new bjvt(this, paramIMiniAppContext, str, paramAsyncResult));
  }
  ...
  {
    akmf.a(new FocusMpIdReq(paramString1, paramString2), new bjwa(this, paramAsyncResult));
    return true;
  }
  ...
  public void ffmpegExecCommand(String[] paramArrayOfString, ChannelProxy.ICommandListenr paramICommandListenr)
  {
    try
    {
      ...
      this.jdField_a_of_type_Zmn.a(paramArrayOfString, new bjvs(this, paramICommandListenr));
      return;
    }
  ...
  {
    MiniAppCmdUtil.getInstance().getAuthList(null, paramString, new bjvp(this, paramAuthListResult));
  }
  ...
  {
    aevv.a(paramActivity, paramIntent, PublicFragmentActivityForMini.class, AddPhoneNumberFragment.class, paramInt);
  }
  
  public void launchPhoneNumberManagementFragment(Activity paramActivity, Intent paramIntent, int paramInt)
  {
    aevv.a(paramActivity, paramIntent, PublicFragmentActivityForMini.class, PhoneNumberManagementFragment.class, paramInt);
  }
  ...
  public boolean openGroup(Context paramContext, String paramString, AsyncResult paramAsyncResult)
  {
    if ((paramContext instanceof Activity))
    {
      ...
      paramString.addActivityResultListener(new bjvz(this, paramString, paramAsyncResult));
  ...
  {
    MiniAppSendSmsCodeServlet.sendSmsCodeRequest(paramString1, paramString2, new bjvw(this, paramAsyncResult));
  }
  ...
  {
    MiniAppSendSmsCodeServlet.sendVerifySmsCodeRequest(paramString1, paramString2, paramString3, new bjvx(this, paramAsyncResult));
  }
  ...
  {
    bmvi.a().a(a(paramAdItem, paramString, paramInt));
    return true;
  }
  ...
  public boolean tianshuRequestAdv(Context paramContext, String paramString, int paramInt1, int paramInt2, int paramInt3, AsyncResult paramAsyncResult)
  {
    ...
    try
    {
      ...
      MiniTianShuManager.requestAdv(Collections.singletonList(paramContext), new bjvy(this, paramAsyncResult));
      return true;
    }
