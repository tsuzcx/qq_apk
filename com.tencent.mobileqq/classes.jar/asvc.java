...
public class asvc
{
  private static asvc jdField_a_of_type_Asvc;
  private static byte[] jdField_a_of_type_ArrayOfByte = new byte[0];
  private Messenger jdField_a_of_type_AndroidOsMessenger;
  private anyu jdField_a_of_type_Anyu = new asvd(this);
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new asve(this);
  
  public static asvc a()
  {
    if (jdField_a_of_type_Asvc == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Asvc == null) {
        jdField_a_of_type_Asvc = new asvc();
      }
      return jdField_a_of_type_Asvc;
    }
  }
  ...
  public static void a()
  {
    if (jdField_a_of_type_Asvc != null) {
      synchronized (jdField_a_of_type_ArrayOfByte)
      {
        if ((jdField_a_of_type_Asvc != null) && (jdField_a_of_type_Asvc.jdField_a_of_type_JavaLangRefWeakReference != null))
        {
          QQAppInterface localQQAppInterface = (QQAppInterface)jdField_a_of_type_Asvc.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localQQAppInterface != null) {
            localQQAppInterface.removeObserver(jdField_a_of_type_Asvc.jdField_a_of_type_Anyu);
          }
          jdField_a_of_type_Asvc = null;
        }
        return;
      }
    }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    label30:
    for (int i = -1;; i = asvf.a().a(localQQAppInterface, localQQAppInterface.getCurrentAccountUin(), null, paramArrayOfByte, this.jdField_a_of_type_MqqObserverWtloginObserver))
    {
      a(i);
      return;
    }
