  ...
  implements agsv
{
  ...
  protected agvg(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
  ...
  private int a()
  {
    ...
    if (this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      int i = 0;
      k = i;
      if (j >= this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilArrayList.size()) {
        break label78;
      }
      String str = (String)this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilArrayList.get(j);
  ...
  public static agss b(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
    ...
    {
      if ((jdField_a_of_type_Agss == null) || (jdField_a_of_type_Agss.jdField_a_of_type_MqqUtilWeakReference.get() != paramNewPhotoPreviewActivity)) {
        jdField_a_of_type_Agss = new agvg(paramNewPhotoPreviewActivity);
      }
  ...
  {
    this.jdField_a_of_type_Agsr.g = true;
    super.a(paramIntent);
    ...
    this.jdField_a_of_type_Agsb.a(this.b);
  ...
  protected void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Agsb.b.contains(Integer.valueOf(i)))
    {
      if ((this.jdField_a_of_type_Agsb.b.indexOf(Integer.valueOf(i)) >= 0) && (i != -1) && (this.jdField_a_of_type_JavaUtilHashMap != null)) {
        this.jdField_a_of_type_JavaUtilHashMap.remove(this.jdField_a_of_type_Agsr.jdField_a_of_type_JavaUtilArrayList.get(i));
      }
      super.a(paramView);
      return;
    }
    if (i != -1) {}
    for (String str = (String)this.jdField_a_of_type_Agsr.jdField_a_of_type_JavaUtilArrayList.get(i);; str = "")
    {
      LocalMediaInfo localLocalMediaInfo = ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).b(str);
      if ((this.c) && (this.jdField_a_of_type_Agsr.jdField_a_of_type_JavaUtilArrayList != null) && (((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(str) == 1) && (!bbbj.a((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), a(), localLocalMediaInfo, this.jdField_a_of_type_Agsb.a())))
      {
      ...
      str = (String)this.jdField_a_of_type_Agsr.jdField_a_of_type_JavaUtilArrayList.get(i);
      if ((!this.c) && (!this.jdField_a_of_type_Agsb.a())) {
        break;
      }
  ...
  protected void a(View paramView, int paramInt1, Bundle paramBundle, int paramInt2, Intent paramIntent)
  {
    ...
    label615:
    for (paramView = (LocalMediaInfo)this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilHashMap.get(this.jdField_a_of_type_Agsr.d);; paramView = null)
    {
      if ((this.jdField_a_of_type_Boolean) && (bbbj.a(paramView) == 1) && (this.c) && (this.jdField_a_of_type_Agsr.g))
      {
        ...
        paramBundle.putExtra("file_send_path", this.jdField_a_of_type_Agsr.d);
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Agsr.g)
        {
          ...
          if (this.c) {
            paramView = QzoneEditPictureActivity.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), this.jdField_a_of_type_Agsr.d);
          } else {
            paramView = EditPicActivity.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), this.jdField_a_of_type_Agsr.d, true, true, true, true, true, 3, 99, 4, paramView);
          }
        }
        else
        {
  ...
  public void a_(SlideItemInfo paramSlideItemInfo)
  {
    ...
    for (;;)
    {
      if ((i >= 0) && (i < this.jdField_a_of_type_Agsr.jdField_a_of_type_JavaUtilArrayList.size()) && (this.jdField_a_of_type_JavaUtilHashMap != null)) {
        this.jdField_a_of_type_JavaUtilHashMap.remove(this.jdField_a_of_type_Agsr.jdField_a_of_type_JavaUtilArrayList.get(i));
      }
      return;
      i += 1;
  ...
  public void aq_()
  {
    ...
    if (i != -1)
    {
      String str = (String)this.jdField_a_of_type_Agsr.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (this.c)
      {
        if (this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilHashMap == null) {
          this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  protected void d()
  {
    ...
    {
      localObject = ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getString(2131699533);
      if (this.jdField_a_of_type_Int == 1) {
        localObject = ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getString(2131695106);
      }
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilArrayList.size() > 0) && (this.jdField_a_of_type_Int == 1))
      {
      ...
      else if (this.jdField_a_of_type_Boolean)
      {
        ...
        if ((this.c) && (this.jdField_a_of_type_Agsr.jdField_a_of_type_JavaUtilArrayList != null)) {
      ...
      for (boolean bool1 = bool2;; bool1 = false)
      {
        ...
        g();
        return;
        localObject = ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getString(2131695084);
        break;
        bool1 = false;
        break label138;
      }
  ...
  protected void h()
  {
    if (this.d)
    {
      ...
      ((Intent)localObject1).putIntegerArrayListExtra("PhotoConst.SELECTED_INDEXS", this.jdField_a_of_type_Agsb.b);
    ...
    Object localObject2;
    Object localObject3;
    if ((this.c) && (this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilArrayList.isEmpty()) && (((ArrayList)localObject1).size() == 1))
    {
      ...
      if (localObject3 != null)
      {
        ...
        if (this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilHashMap != null)
        {
          ...
          this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilHashMap.put(localObject2, localObject3);
        }
      }
      if ((((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).a((String)localObject2) == 1) && (!bbbj.a((Context)this.jdField_a_of_type_MqqUtilWeakReference.get(), a(), (LocalMediaInfo)localObject3, this.e)))
      {
    ...
    {
      agqf.a(((ArrayList)localObject1).size(), this.jdField_a_of_type_Agsr.jdField_b_of_type_Int);
      agqf.a(((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getIntent(), ((ArrayList)localObject1).size(), this.jdField_a_of_type_Agsb.c);
    }
    Intent localIntent = ((NewPhotoPreviewActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).getIntent();
    if (localObject1 != null) {
      ahvz.a((List)localObject1);
    }
    if ((this.c) || (this.jdField_a_of_type_Agsb.a()))
    {
