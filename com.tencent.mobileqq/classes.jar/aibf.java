...
public class aibf
  implements Runnable
{
  public aibf(QQFilterRenderManager paramQQFilterRenderManager, byte[] paramArrayOfByte, int paramInt1, int paramInt2, IFaceDetectCallBack paramIFaceDetectCallBack) {}
