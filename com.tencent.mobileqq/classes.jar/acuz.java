  ...
  implements acun
{
  ...
  public static GdtMotiveVideoPageData a(qq_ad_get.QQAdGetRsp.AdInfo paramAdInfo, int paramInt)
  {
    ...
    if ((localGdtAd != null) && (localGdtAd.info != null))
    {
      ...
      acvc.d("GdtOpenMvPageHandler", "VideoUrl " + localGdtMotiveVideoPageData.url);
      Object localObject1;
      if (localGdtAd.getImageData() == null)
      {
        ...
        if (paramAdInfo != null) {
          localObject1 = acvb.a(paramAdInfo);
        }
  ...
  public void a(GdtMotiveVideoPageData paramGdtMotiveVideoPageData, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (paramGdtMotiveVideoPageData != null)
    {
      ...
      if (str != null)
      {
        ...
        {
          paramGdtMotiveVideoPageData = (acts)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (paramGdtMotiveVideoPageData != null)
          {
  ...
  public boolean a(acts paramacts, String paramString, String... paramVarArgs)
  {
    ...
    {
      acvc.d("GdtOpenMvPageHandler", "GdtOpenMvPageHandler error");
      return true;
    }
    String str2 = "";
    for (;;)
    {
      try
      {
        acvc.a("GdtOpenMvPageHandler", "args = " + paramVarArgs[0]);
      ...
      catch (Throwable localThrowable1)
      {
        try
        {
          ...
          k = i;
          paramVarArgs = (qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(acvb.a(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(paramVarArgs)));
        }
        ...
        try
        {
          ...
          if (localGdtMotiveVideoPageData != null)
          {
            ...
            GdtMotiveVideoFragment.b(paramacts.a(), GdtMotiveVideoFragment.class, localGdtMotiveVideoPageData);
          }
          if (paramacts == null) {
            break label377;
          }
