  ...
  implements bbil
{
  ...
  private MessageQueue.IdleHandler jdField_a_of_type_AndroidOsMessageQueue$IdleHandler = new acva(this);
  public FragmentActivity a;
  private View jdField_a_of_type_AndroidViewView;
  public ViewGroup a;
  private bbil jdField_a_of_type_Bbil = new acvb(this);
  ...
  public acuz(BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetDrawerFrame.setDrawerCallbacks(this.jdField_a_of_type_Bbil);
  ...
  {
    boolean bool = true;
    if ((ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, null)) || (awnu.b())) {
      bool = false;
    }
    return bool;
  }
