  ...
  implements aywc
{
  ...
  public aywd(QQAppInterface paramQQAppInterface)
  {
  ...
  public ReqItem a(int paramInt)
  {
    ...
    {
      zdf localzdf = this.app.a.a(this.jdField_a_of_type_ComTencentQphoneBaseRemoteToServiceMsg.getServiceCmd());
      ...
      if (localzdf != null)
      {
        ...
        localObject1 = localObject2;
        if (localzdf.a(this.jdField_a_of_type_ComTencentQphoneBaseRemoteToServiceMsg, localUniPacket))
        {
