  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      notifyObserver(paramIntent, j, bool1, localBundle, bman.class);
      return;
      ...
      if (((MqqLbsPack.RspGetPOIList)localObject).msg_head.has())
      {
        ...
        if (k != 0) {
          bmap.a("actLbsSendPoiListFailure", k);
        }
        for (;;)
        {
          if (QLog.isColorLevel()) {
          ...
          break;
          bmap.a("actLbsSendPoiListFailure");
        }
        ...
        if (((MqqLbsPack.RspOpenLBSRPReport)localObject).msg_head.has())
        {
          ...
          if (paramFromServiceMsg != null)
          {
            ...
            if (((MqqLbsPack.RspGetLBSPID)localObject).msg_head.has())
            {
              ...
              bmap.a("actLbsSendGetPidFailure");
            }
            for (;;)
            {
              localBundle.putInt("key_receive_result", k);
              ...
              break;
              bmap.a("actLbsSendGetPidFailure", k);
            }
            ...
            default: 
              break;
            case 1: 
              bmap.a("actLbsSendPoiListFailure", -10006);
              break;
            case 2: 
              break;
            case 3: 
              bmap.a("actLbsSendGetPidFailure", -10006);
              break;
            case 4: 
              if (QLog.isColorLevel())
              {
