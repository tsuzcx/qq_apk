...
public class bmao
{
  private static bmao jdField_a_of_type_Bmao;
  private ArrayList<bmap> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  public boolean a;
  
  public static bmao a()
  {
    if (jdField_a_of_type_Bmao == null) {}
    try
    {
      if (jdField_a_of_type_Bmao == null) {
        jdField_a_of_type_Bmao = new bmao();
      }
      return jdField_a_of_type_Bmao;
    }
    finally {}
  }
  
  public bmap a(long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      {
        bmap localbmap = (bmap)localIterator.next();
        if (localbmap.jdField_a_of_type_Long == paramLong)
        {
          this.jdField_a_of_type_JavaUtilArrayList.remove(localbmap);
          if (QLog.isColorLevel()) {
  ...
  public byte[] a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      if (localIterator.hasNext()) {
        localArrayList1.add(((bmap)localIterator.next()).jdField_a_of_type_AndroidContentIntent.getExtras());
      }
    }
