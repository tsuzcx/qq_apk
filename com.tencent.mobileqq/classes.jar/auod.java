...
public class auod
{
  private static Map<String, auod> jdField_a_of_type_JavaUtilMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new auoe(this);
  ...
  private final List<auof> jdField_a_of_type_JavaUtilList = new LinkedList();
  ...
  private auod(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
  ...
  private Intent a()
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      localIntent.putExtra("qqVersion", "8.4.8");
      return localIntent;
    }
  }
  
  public static auod a(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
    try
    {
      auod localauod2 = (auod)jdField_a_of_type_JavaUtilMap.get(paramInstalledPlugin.pluginFile.getName());
      auod localauod1 = localauod2;
      if (localauod2 == null)
      {
        localauod1 = new auod(paramContext, paramInstalledPlugin);
        jdField_a_of_type_JavaUtilMap.put(paramInstalledPlugin.pluginFile.getName(), localauod1);
      }
      return localauod1;
    }
    finally {}
  ...
  private RunningPlugin a()
  {
    ...
    a("HuayangPluginLauncher", amtj.a(2131704764));
    try
    {
      ...
      {
        a("HuayangPluginLauncher", amtj.a(2131704774) + (System.currentTimeMillis() - l));
    ...
    catch (Exception localException2)
    {
      ...
      a(80);
      a("HuayangPluginLauncher", amtj.a(2131704778) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + amtj.a(2131704773) + (System.currentTimeMillis() - l));
    }
  ...
  private void a(int paramInt)
  {
    ...
    a("HuayangPluginLauncher", amtj.a(2131704772) + paramInt);
  ...
  private void a(RunningPlugin paramRunningPlugin)
  {
    ...
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", amtj.a(2131704762) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    ...
    for (;;)
    {
      try
      {
        ...
        a(true, null);
        if (!aunx.a(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
          continue;
        }
        auoj.a("2691707");
      ...
      a("HuayangPluginLauncher", amtj.a(2131704777) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + amtj.a(2131704770) + (System.currentTimeMillis() - l));
      return;
      if (aunx.b(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
        auoj.a("2597725");
      }
    }
  }
  ...
  {
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", amtj.a(2131704768) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    Intent localIntent = a();
    try
    {
      paramRunningPlugin.startInitActivity(localIntent).get();
      a("HuayangPluginLauncher", amtj.a(2131704766) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + amtj.a(2131704763) + (System.currentTimeMillis() - l));
      return;
    }
    catch (Throwable paramRunningPlugin)
    {
  ...
  public void b(auof paramauof)
  {
    if (paramauof != null) {
      this.jdField_a_of_type_JavaUtilList.remove(paramauof);
    }
  }
}
