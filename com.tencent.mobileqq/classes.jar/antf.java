...
public abstract interface antf
{
  ...
  static
  {
    ...
    bl = bigv.a(aZ + "/Tencent/QQ_Favorite/");
    bm = bigv.a(aZ + "/Tencent/QQ_CameraEmo/");
    bn = aZ + "/DCIM/Camera/";
    bo = bigv.a(aZ + "/Tencent/QQ_Collection/");
    bp = bigv.a(aZ + "/Tencent/QQfile_recv/");
    bq = bp + ".thumbnails/";
    br = bp + ".tmp/";
    bs = bp + ".trooptmp/";
    bt = aZ + "/Tencent/QQ_Secretfile/";
    bu = bigv.a(aZ + "/Tencent/QQ_Video/");
    bv = aZ + "/Tencent/QQfile_share/";
    bw = aZ + "/Tencent/QQHomework_recv/";
    bx = aZ + "/Tencent/QQHomework_attach/";
    by = ba + "Troop_reward/";
    bz = bigv.a(ba + "ar_cloud_img/");
    bA = bigv.a(ba + "ar_cloud_marker_feature/");
    bB = bigv.a(ba + "ar_cloud_marker_config/");
    bC = bigv.a(ba + "ar_cloud_marker_model/");
    bD = bigv.a(ba + "ARRelationShip/");
    bE = bigv.a(ba + "ar_cloud_transfer/");
    bF = bigv.a(ba + "qqmusic/");
    bG = ba + "pe";
    bH = ba + "poke";
    bI = ba + "newpoke";
    ...
    for (String str = ba;; str = "/sdcard/Android/data/com.tencent.mobileqq/files/Tencent/MobileQQ/")
    {
      ...
      bQ = bK + "_dhd/";
      bR = bK + "_SSOhd/";
      bS = bigv.a(bJ + ".starHead/");
      bT = bigv.a(bJ + ".pendant/");
      bU = ba + ".secmsgPic/";
      bV = bigv.a(ba + ".emotionsm/");
      bW = ba + ".emoQFace/";
      bX = bigv.a(ba + ".diy/");
      bY = bigv.a(ba + ".indivAnim/");
      bZ = bigv.a(new StringBuilder().append(ba).append("pddata/vas/").toString()) + "individual_sign/";
      ca = bZ + "stickers/";
      ...
      ce = ba + "device/";
      cf = ba + "location/";
      cg = bigv.a(ba + "system_background/");
      ...
      cn = cg + "resource/";
      co = ba + "turnbrand/";
      cp = bigv.a(ba + "Scribble/");
      cq = bigv.a(ba + ".profilecard" + "/");
      cr = ba + "card/";
      cs = ba + "card/starfans/";
      ...
      cJ = cI + "animation/";
      cK = bigv.a(cB + "preload/");
      cL = bigv.a(cB + "preimg/");
      cM = aZ + "/DCIM/Video/";
      cN = aZ + anzj.a(2131699526);
      cO = aZ + anzj.a(2131699527);
      cP = aZ + "/Camera/Video/";
