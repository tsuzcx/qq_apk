  ...
  implements Animatable
{
  ...
  public ancz(int paramInt1, int[] paramArrayOfInt, ImageView paramImageView, int paramInt2)
  {
  ...
  public ancz(int[] paramArrayOfInt, ImageView paramImageView, int paramInt)
  {
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new anda(this);
    this.jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new andb(this);
  }
