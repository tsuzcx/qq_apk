  ...
  extends pxz
{
  ...
  public pwn(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qnd paramqnd, Handler paramHandler)
  {
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 2) {
      if ((j == 0) && (paramToServiceMsg.msg_ks_get_subscribed_list_rsp.has()) && (((oidb_cmd0xd46.KsGetSubscribedListRsp)paramToServiceMsg.msg_ks_get_subscribed_list_rsp.get()).bytes_ks_subscribed_list.has()))
      {
        ...
        pmk.a().a(new pwo(this, j, paramToServiceMsg));
      }
    }
    while (i != 1) {
      for (;;)
  ...
  protected ToServiceMsg a(qnj paramqnj)
  {
    ...
    if (paramqnj.jdField_a_of_type_Boolean) {
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_all_channel_list.set(1);
    }
    if (paramqnj.jdField_b_of_type_Boolean) {
    ...
    for (;;)
    {
      ...
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_important.set(paramqnj.jdField_b_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_id.set(paramqnj.jdField_c_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_cover.set(paramqnj.jdField_d_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_seq.set(paramqnj.jdField_e_of_type_Int);
      localObject = qnf.a("OidbSvc.0x69f", 1695, 0, ((oidb_cmd0x69f.ReqBody)localObject).toByteArray());
      ((ToServiceMsg)localObject).getAttributes().put(c, Integer.valueOf(paramqnj.jdField_a_of_type_Int));
      ((ToServiceMsg)localObject).getAttributes().put("debug", Boolean.valueOf(paramqnj.l));
      return localObject;
  ...
  public void a(int paramInt1, int paramInt2, List<Integer> paramList, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    ((oidb_cmd0x908.ReqBody)localObject).uint64_uin.set(Long.valueOf(pha.a()).longValue());
    ...
    for (;;)
    {
      ...
      localObject = qnf.a("OidbSvc.0x908", 2312, 0, ((oidb_cmd0x908.ReqBody)localObject).toByteArray());
  ...
  public void a(String paramString)
  {
    ...
    localObject = qnf.a("OidbSvc.0xd46", 3398, 0, ((oidb_cmd0xd46.ReqBody)localObject).toByteArray());
  ...
  public void a(boolean paramBoolean, int paramInt, List<Integer> paramList)
  {
    ...
    if (paramBoolean)
    {
      ...
      a(qnf.a("OidbSvc.0x8f5", 2293, 0, localReqBody.toByteArray()));
      if (QLog.isColorLevel()) {
        if (paramList != null) {
          break label150;
        }
  ...
  public void b(List<Integer> paramList)
  {
    ...
    localObject = qnf.a("OidbSvc.0x69e", 1694, 0, ((oidb_cmd0x69e.ReqBody)localObject).toByteArray());
  ...
  {
    Object localObject = new qnj();
    ((qnj)localObject).jdField_a_of_type_Int = 4;
    ((qnj)localObject).jdField_a_of_type_Boolean = true;
    ((qnj)localObject).jdField_b_of_type_Boolean = true;
    ((qnj)localObject).jdField_c_of_type_Boolean = false;
    ((qnj)localObject).jdField_d_of_type_Boolean = true;
    ((qnj)localObject).j = true;
    ((qnj)localObject).k = true;
    ((qnj)localObject).jdField_e_of_type_Boolean = false;
    ((qnj)localObject).f = false;
    ((qnj)localObject).g = false;
    ((qnj)localObject).h = false;
    ((qnj)localObject).jdField_b_of_type_Int = 1;
    ((qnj)localObject).l = paramBoolean;
    localObject = a((qnj)localObject);
  ...
  protected void c(List<rex> paramList)
  {
    if (paramList == null) {
      return;
    }
    ...
    while (paramList.hasNext())
    {
      Iterator localIterator = ((rex)paramList.next()).a.iterator();
  ...
  protected void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0) {
      if (i == 1)
      {
        ...
        {
          paramObject = qnc.a(localRspBody.rpt_channel_list.get());
  ...
  public List<ChannelInfo> e()
  {
    ...
    Collections.sort((List)localObject1, new pwp(this));
  ...
  {
    if (qnf.a(paramFromServiceMsg, paramObject, new oidb_cmd0x69e.RspBody()) == 0) {}
  ...
  public List<Integer> g()
  {
    ...
    Collections.sort((List)localObject1, new pwq(this));
    localObject2 = new ArrayList(((ArrayList)localObject1).size());
    localObject1 = ((ArrayList)localObject1).iterator();
    while (((Iterator)localObject1).hasNext()) {
  ...
  {
    int i = qnf.a(paramFromServiceMsg, paramObject, new oidb_cmd0x8f5.RspBody());
    if (QLog.isColorLevel()) {
