...
public class xuu
  extends almw
{
  public xuu(QRDisplayActivity paramQRDisplayActivity) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong1, String paramString1, String paramString2, long paramLong2)
  {
    ...
    Object localObject = this.a.jdField_a_of_type_Almt.a(this.a.jdField_c_of_type_JavaLangString, true);
    ...
    localObject = xxb.a(paramString2, -1);
    if (localObject != null)
    {
      ((TextView)this.a.findViewById(2131372971)).setText(paramString2);
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    if (paramBoolean1)
    {
      paramString = ((almt)this.a.app.a(6)).a(paramString, true);
