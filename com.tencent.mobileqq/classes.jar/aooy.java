  ...
  extends acme
{
  ...
  public aooy(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(int paramInt1, aizi paramaizi, int paramInt2, String paramString, long paramLong)
  {
    ...
    paramaizi.a(new ajbi(paramString, paramLong));
  }
  ...
  private void a(int paramInt, structmsg.StructMsg paramStructMsg, MessageForSystemMsg paramMessageForSystemMsg, boolean[] paramArrayOfBoolean)
  {
    ...
    if (paramMessageForSystemMsg.structMsg.msg.msg_invite_extinfo.has())
    {
      ...
      if ((i == 2) || (i == 4))
      {
        ...
        avia.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForSystemMsg, localMsgInviteExt, str);
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      paramMessageForSystemMsg = (aoep)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER);
  ...
  private void a(anvk paramanvk, int paramInt, aizi paramaizi, ArrayList<MessageRecord> paramArrayList, String paramString, boolean paramBoolean)
  {
    int i = paramArrayList.size();
    long l1 = ((MessageRecord)paramArrayList.get(i - 1)).time;
    long l2 = bdzx.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    ...
    a(paramanvk, paramArrayList, i, l1, localList, localList.iterator());
    if (localList.size() == 0)
    {
      bdzx.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l1);
      paramanvk = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade();
      paramString = String.valueOf(paramString);
      if ((!anyv.a(paramArrayList)) || (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundStop)) {
        break label190;
      }
    }
    label190:
    ...
    {
      paramanvk.addMessage(paramArrayList, paramString, bool);
      paramaizi.a(true);
      a(paramArrayList);
      ...
      bdzx.a().a(true, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      break;
    }
  }
  
  private void a(anvk paramanvk, ArrayList<MessageRecord> paramArrayList, int paramInt, long paramLong, List<ChatMessage> paramList, Iterator<ChatMessage> paramIterator)
  {
    if (paramInt < 20) {
      while (paramIterator.hasNext())
      {
        paramanvk = (ChatMessage)paramIterator.next();
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().removeMsgByUniseq(AppConstants.FRIEND_SYSTEM_MSG_UIN, 0, paramanvk.uniseq, false);
        paramIterator.remove();
      }
    }
    a(paramanvk, paramArrayList, paramLong, paramIterator);
  }
  
  private void a(anvk paramanvk, ArrayList<MessageRecord> paramArrayList, long paramLong, Iterator<ChatMessage> paramIterator)
  {
    while (paramIterator.hasNext())
    {
  ...
  private void a(awzf paramawzf)
  {
    aqxt localaqxt = (aqxt)aqxe.a().a(634);
    if (localaqxt != null)
    {
      int i = localaqxt.d;
      ...
      if ((!paramawzf.a()) && (localList != null) && (localList.size() < i) && (localaqxt.a))
      {
        if (QLog.isColorLevel()) {
  ...
  private void a(FromServiceMsg paramFromServiceMsg, anvk paramanvk, List<structmsg.StructMsg> paramList, int paramInt1, int paramInt2, aizi paramaizi, String paramString, long paramLong)
  {
    ...
    if (paramFromServiceMsg.getUin() == null)
    {
      ...
      localMessageRecord = bcsa.a(-2050);
    ...
    if (localArrayList.size() > 0) {
      a(paramanvk, paramInt2, paramaizi, localArrayList, paramFromServiceMsg, bool1);
    }
    for (;;)
    {
      paramaizi.a(new ajbi(paramString, paramLong));
  ...
  private void a(ToServiceMsg paramToServiceMsg, int paramInt1, String paramString, structmsg.RspSystemMsgNew paramRspSystemMsgNew, List<structmsg.StructMsg> paramList, int paramInt2, int paramInt3)
  {
    ...
    bdzy.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt3);
    ...
    if ((localaqxv != null) && (localaqxv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (localajfn != null)) {
      localajfn.a(paramInt3);
    }
    i = paramInt3 - i;
    ...
    if (paramToServiceMsg.getServiceCmd().equals("ProfileService.Pb.ReqSystemMsgNew"))
    {
      ...
      bdzy.a().a(false, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      bool1 = bool2;
      if (localawzf != null)
      {
        localawzf.a(false);
    ...
    aocd localaocd = (aocd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.RECENT_MANAGER_FOR_3RDPART);
    if (localStructMsg != null)
    {
      bdzy.a().a(localStructMsg);
      if ((localaqxv == null) || (!localaqxv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())))
      {
        ...
        {
          localaocd.a(AppConstants.TROOP_NOTIFICATION_UIN, 9000, anvx.a(2131691074), l, l);
          if (QLog.isColorLevel()) {
        ...
        if (i != 0) {
          bdla.b(null, "dc00898", "", "", "0X800B528", "0X800B528", 0, 0, "", "", null, null);
        }
      }
    }
    a(paramString, paramRspSystemMsgNew, paramInt3, localajfn, false, paramToServiceMsg);
    ...
    paramToServiceMsg = (aqxt)aqxe.a().a(634);
    if ((!localawzf.a()) && (bool1) && (paramToServiceMsg != null) && (paramToServiceMsg.a))
    {
      if (QLog.isColorLevel()) {
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      ajhg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return;
    }
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject, structmsg.RspSystemMsgNew paramRspSystemMsgNew)
  {
    ...
    paramRspSystemMsgNew = (anvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER);
    ...
    for (boolean bool = true;; bool = false)
    {
      bdzx.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bool);
      localaizi = (aizi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.NEW_FRIEND_MANAGER);
      i = localaizi.c();
      bdzx.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, m);
    ...
    if (l2 == l3)
    {
      a(m, localaizi, i, (String)localObject, l1);
      return;
    }
    int i = j;
    if (m == 0)
    ...
    bdzx.a().a(false, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    if (i == 0) {
      a(paramFromServiceMsg, paramRspSystemMsgNew, localList, k, m, localaizi, (String)localObject, l1);
    }
    for (;;)
    {
      a(4005, true, null);
  ...
  private void a(String paramString, TroopManager paramTroopManager)
  {
    if (paramTroopManager.b(paramString) == null)
    {
      ...
      paramTroopManager = (aoep)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER);
      paramTroopManager.a(localTroopInfo.troopuin, false, "SystemMessageProcessor.AgreeGroupInvation", true, true, true, false);
      paramTroopManager.a(1, anrb.a(localTroopInfo.troopuin), 0L, 2, 0, 0, true);
  ...
  private void a(String paramString, structmsg.RspNextSystemMsg paramRspNextSystemMsg)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramRspNextSystemMsg != null) && (!TextUtils.isEmpty(paramString))) {
      ajhg.a(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRspNextSystemMsg, paramString);
    }
  }
  
  private void a(String paramString, structmsg.RspNextSystemMsg paramRspNextSystemMsg, ArrayList<MessageRecord> paramArrayList, awzf paramawzf)
  {
    if (paramArrayList.size() > 0)
    {
      if (paramArrayList.size() < 100)
      {
        bdzy.a().a(true, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (paramawzf != null) {
          paramawzf.a(true);
        }
      }
      ...
      paramString = (ajfn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_NOTIFICATION_MANAGER);
      int i = bdzy.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (paramString != null) {
  ...
  private void a(String paramString, structmsg.RspSystemMsgNew paramRspSystemMsgNew)
  {
    if ((paramRspSystemMsgNew.msg_ribbon_group.has()) && (paramRspSystemMsgNew.msg_ribbon_group.get() != null))
    {
      ...
      paramRspSystemMsgNew = bcsa.a(-2018);
  ...
  private void a(String paramString, structmsg.RspSystemMsgNew paramRspSystemMsgNew, int paramInt, ajfn paramajfn, boolean paramBoolean, ArrayList<MessageRecord> paramArrayList)
  {
    if (paramArrayList.size() > 0)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().clearHistory(AppConstants.TROOP_SYSTEM_RIBBON_MSG_UIN, 0, true, true);
      if (paramajfn != null) {
        paramajfn.a(paramArrayList, paramInt);
      }
      a("handleGetSystemMsgResp", true, paramInt, paramBoolean, false);
      if (!TextUtils.isEmpty(paramRspSystemMsgNew.grp_msg_display.get())) {
        bdzy.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRspSystemMsgNew.grp_msg_display.get());
      }
    }
  }
  ...
  private void a(List<MessageRecord> paramList)
  {
    ...
    RecentUser localRecentUser = (RecentUser)localaoxz.findRecentUserByUin(AppConstants.RECOMMEND_CONTACT_UIN, 4000);
    localRecentUser.msgType = 26;
    localRecentUser.displayName = aizi.a;
  ...
  private void a(structmsg.RspSystemMsgNew paramRspSystemMsgNew, List<structmsg.StructMsg> paramList, int paramInt, String paramString)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramRspSystemMsgNew != null) && (paramList != null) && (!TextUtils.isEmpty(paramString))) {
      ajhg.a(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRspSystemMsgNew, paramList, paramInt, paramString);
    }
  }
  ...
  private void b(int paramInt1, int paramInt2, structmsg.StructMsg paramStructMsg, int paramInt3, MessageForSystemMsg paramMessageForSystemMsg, int paramInt4, boolean[] paramArrayOfBoolean)
  {
    ...
    if ((paramInt3 == 2) && (paramInt4 == 2))
    {
      ...
      if (paramMessageForSystemMsg.structMsg.msg.msg_invite_extinfo.has())
      {
        ...
        if ((paramInt1 == 2) || (paramInt1 == 4)) {
          avia.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForSystemMsg, paramStructMsg, String.valueOf(l));
        }
        if (paramInt1 == 4) {
          paramArrayOfBoolean[0] = false;
        }
    ...
    if (localaoep != null) {
      localaoep.a(paramArrayOfBoolean, str, true);
    }
  ...
  private void b(String paramString, structmsg.RspNextSystemMsg paramRspNextSystemMsg)
  {
    ...
    localObject1 = (awzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOPINFO_MANAGER);
    a(paramString, paramRspNextSystemMsg, localArrayList, (awzf)localObject1);
    a((awzf)localObject1);
  }
  
  private void b(List<structmsg.StructMsg> paramList)
  {
    Collections.sort(paramList, new aooz(this));
  }
  ...
  private void d(structmsg.StructMsg paramStructMsg)
  {
    ...
    for (paramStructMsg.Administrator = paramStructMsg.Administrator.substring(0, paramStructMsg.Administrator.length() - 1);; paramStructMsg.Administrator = "")
    {
      ...
      if (localObject != null) {
        ((aoep)localObject).c(Long.parseLong(paramStructMsg.troopuin));
      }
      return;
    }
  }
  ...
  public void a()
  {
    ...
    a(true, true, false, 0L, new aopd(this, l1, l2, localReqSystemMsgRead));
  }
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localObject2 = (awzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOPINFO_MANAGER);
      i = 4;
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, structmsg.SystemMsgActionInfo paramSystemMsgActionInfo, int paramInt6, String paramString)
  {
    ...
    paramSystemMsgActionInfo.callback = new aopb(this);
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, structmsg.SystemMsgActionInfo paramSystemMsgActionInfo, int paramInt6, structmsg.StructMsg paramStructMsg, boolean paramBoolean)
  {
    ...
    localProtoReq.callback = new aopc(this, paramInt6, paramInt3, paramSystemMsgActionInfo, paramStructMsg, paramLong2);
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, long paramLong1, long paramLong2, msg_comm.MsgHead paramMsgHead)
  {
    ...
    {
      avia.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramArrayOfByte, paramLong1, paramLong2, paramMsgHead);
      b(2001, true, null);
    }
  }
  ...
  public void a(long paramLong1, long paramLong2, short paramShort, int paramInt1, msg_comm.Msg paramMsg, int paramInt2)
  {
    ...
    while (paramShort != 190)
    {
      ...
      for (localObject = ((SystemMsg)localObject).strGameName;; localObject = "")
      {
        ...
        aizx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramLong1, paramLong2, paramShort, paramMsg, paramInt2);
        return;
      }
    }
    ((anvk)localObject).a(str, false);
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().clearHistory(AppConstants.FRIEND_SYSTEM_MSG_UIN, 0);
        ((aizi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.NEW_FRIEND_MANAGER)).b();
      }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (long l1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().e("last_group_suspicious_seq");; l1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().e("last_group_seq"))
    {
      ...
      localProtoReq.callback = new aopf(this, l2, l3, l1);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().sendProtoReq(localProtoReq);
      return;
    }
  }
  ...
  public void b()
  {
    ...
    localProtoReq.reqBody = localReqSystemMsgRead.toByteArray();
    localProtoReq.callback = new aope(this, l1, l2, l3);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().sendProtoReq(localProtoReq);
  }
  ...
  public void c(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      ((ProtoReqManager.ProtoReq)localObject).callback = new aopa(this);
  ...
  public void d()
  {
    ...
    a(true, true, false, 0L, new aopg(this, l, localReqSystemMsgRead));
  }
  ...
  public void e()
  {
    ...
    a(true, true, false, 0L, new aoph(this, l1, l2, localReqSystemMsgRead));
  }
  ...
  public void g()
  {
    ...
    ((ProtoReqManager.ProtoReq)localObject).reqBody = localReqNextSystemMsg.toByteArray();
    ((ProtoReqManager.ProtoReq)localObject).callback = new aopi(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProtoReqManager().sendProtoReq((ProtoReqManager.ProtoReq)localObject);
  }
