...
public class bmeq
{
  private static volatile bmeq jdField_a_of_type_Bmeq;
  private String jdField_a_of_type_JavaLangString = "CHANNEL_ID_SHOW_BADGE";
  
  public static bmeq a()
  {
    if (jdField_a_of_type_Bmeq == null) {}
    try
    {
      if (jdField_a_of_type_Bmeq == null) {
        jdField_a_of_type_Bmeq = new bmeq();
      }
      return jdField_a_of_type_Bmeq;
    }
    finally {}
  }
  ...
  public Notification b(PendingIntent paramPendingIntent, Context paramContext, Bitmap paramBitmap, String paramString1, String paramString2, int paramInt)
  {
    ...
    //   78: aload_3
    //   79: aload_0
    //   80: getfield 15	bmeq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
