  ...
  implements tgs
{
  public static String a(String paramString, ImageData paramImageData)
  {
    ...
    while (!((Boolean)bmhv.a("sp_native_web_sharpp_pic_switch", Boolean.valueOf(false))).booleanValue()) {
      return paramString;
    }
    ...
    paramImageData = bkyp.a(paramString);
    ...
    for (;;)
    {
      QLog.d(qfg.a, 2, "sharpSupport, url : " + paramString);
      return paramString;
  ...
  {
    return new thi(LayoutInflater.from(paramContext).inflate(2131560230, null), paramBaseData);
  }
