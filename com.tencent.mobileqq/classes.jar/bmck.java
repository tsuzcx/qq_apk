  ...
  extends ReportDialog
{
  ...
  public bmck(Context paramContext)
  {
    super(paramContext, 2131755832);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    paramContext = LayoutInflater.from(paramContext).inflate(2131560802, null);
    ...
    localObject = (TextView)paramContext.findViewById(2131369231);
    if (localObject != null)
    {
      ((TextView)localObject).setVisibility(0);
      ((TextView)localObject).setText(2131690676);
    }
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131369278));
    try
    {
      if (this.jdField_a_of_type_AndroidWidgetTextView != null)
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131692175);
      }
      label140:
      paramContext = (FadeIconImageView)paramContext.findViewById(2131369245);
      if (paramContext != null)
      {
        paramContext.setVisibility(0);
        paramContext.setImageResource(2130840352);
      }
  ...
  public void onWindowFocusChanged(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableAnimatable = ((Animatable)this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839468));
