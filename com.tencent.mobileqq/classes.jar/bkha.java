  ...
  extends LinearLayout
{
  ...
  public bkha(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener)
  {
    super(paramContext);
  ...
  public void a(bkgg parambkgg, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject2 = ((View)localObject1).findViewById(2131369550);
      localURLImageView = (URLImageView)((View)localObject1).findViewById(2131369539);
      localObject3 = (TextView)((View)localObject1).findViewById(2131369551);
      localProgressBar = (ProgressBar)((View)localObject1).findViewById(2131369549);
      str = parambkgg.b(paramInt2);
      localObject1 = parambkgg.a(paramInt2);
      if (localObject1 != null) {
        break label146;
      }
      ved.e("LocationFaceAdapter", "FacePackage's thumbUri is empty , pkg : %s", new Object[] { parambkgg.toString() });
    }
    for (;;)
    {
      paramInt2 += 1;
    ...
    Object localObject2 = new bkhb((String)localObject1, localURLImageView, localProgressBar);
    ...
    if (((URLDrawable)localObject1).getStatus() == 1) {
      ((bkhb)localObject2).onLoadSuccessed(localURLImageView, (URLDrawable)localObject1);
    }
    if (paramBoolean) {}
    for (;;)
    {
