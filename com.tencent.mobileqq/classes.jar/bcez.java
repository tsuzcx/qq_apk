...
public class bcez
{
  ...
  public static String e()
  {
    ...
    WindowManager localWindowManager = (WindowManager)bbtm.a().a().getSystemService("window");
  ...
  public static String f()
  {
    ...
    {
      bcds.c("getLocation", "getLocation>>>", localException);
    }
    return "";
  }
  ...
  public static String h()
  {
    try
    {
      ...
      String str = bcdn.b(localContext);
      ...
      for (int i = 1;; i = 0)
      {
        ...
        localStringBuilder.append("wifi=").append(bcdn.e(localContext));
  ...
  public static String i()
  {
    ...
    try
    {
      localJSONObject.put("qua", bbtm.a().f());
      localJSONObject.put("longitude", f());
      localJSONObject.put("platform", bbtm.a().g());
      localJSONObject.put("uin", bbtm.a().a());
      localJSONObject.put("imei", c());
      localJSONObject.put("imei", c());
      localJSONObject.put("resolution", e());
      localJSONObject.put("network", bcdn.a(bbtm.a().a()));
      ...
      localJSONObject.put("qua", bbtm.a().f());
      localJSONObject.put("qz_ver", bbtm.a().c());
      localJSONObject.put("imsi", d());
      localJSONObject.put("androidID", Settings.Secure.getString(bbtm.a().a().getContentResolver(), "android_id"));
      localJSONObject.put("os_api_level", Build.VERSION.SDK_INT);
      localJSONObject.put("sdkVersionCode", 1);
      localJSONObject.put("QVersionCode", bbtm.a().a());
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        bcds.e("getMobileInfo", "gather mobile info exception.");
      }
    }
  }
}
