...
public class bmnw
  extends Dialog
  implements Handler.Callback, View.OnClickListener, bhyr, bmsu
{
  private float jdField_a_of_type_Float;
  public int a;
  Context jdField_a_of_type_AndroidContentContext;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bmny(this);
  public View a;
  public ViewGroup a;
  ...
  public boolean a;
  private InputFilter[] jdField_a_of_type_ArrayOfAndroidTextInputFilter = { new bmok(20) };
  ...
  private int j = 580;
  private int k;
  private int l = bltu.jdField_b_of_type_Int;
  private int m;
  private int n;
  
  public bmnw(Context paramContext, boolean paramBoolean)
  {
    super(paramContext, 2131755180);
    this.jdField_b_of_type_Int = -1;
    this.jdField_c_of_type_Int = bnam.a();
    this.jdField_a_of_type_Bmng = new bmng();
  ...
  private void a()
  {
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(getContext()).inflate(2131559040, null));
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new bmoj(this, null);
    this.jdField_a_of_type_AndroidViewViewGroup.getViewTreeObserver().addOnGlobalLayoutListener(new bmoi(this, null));
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout = ((FitSystemWindowsRelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376002));
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout.setFitsSystemWindows(true);
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout.setOnTouchListener(new bmnx(this));
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer = ((XPanelContainer)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375981));
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377632);
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiPanelEditTextPanel = ((EditTextPanel)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365621).findViewById(2131371543));
    ...
    this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView = ((PressScaleTextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377605));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377606));
    if (this.jdField_d_of_type_Boolean)
    {
      this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView.setOnClickListener(new bmnz(this));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new bmoa(this));
    }
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView = ((EditTextPreView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377644));
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView.setOnClickListener(new bmob(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusableInTouchMode(true);
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusable(true);
    this.jdField_a_of_type_AndroidWidgetEditText.setOnFocusChangeListener(new bmoc(this));
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a(this.jdField_a_of_type_AndroidWidgetEditText);
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new bmod(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new bmoe(this));
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout = ((HorizontalSelectColorLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131371081));
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setStrokeStrategy(new bnam(), false, 0);
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setSelectedStrokeWithColor(bnam.a());
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setOnStrokeSelectedListener(new bmof(this));
  }
  ...
  private void b()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      if (bngs.f())
      {
        int[] arrayOfInt = bngs.a(this.jdField_a_of_type_AndroidContentContext);
  ...
  private void c()
  {
    ...
    getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new bmog(this));
  }
  ...
  public void a(blst paramblst)
  {
    this.jdField_a_of_type_Blst = paramblst;
  }
  
  public void a(bmoh parambmoh)
  {
    this.jdField_a_of_type_Bmoh = parambmoh;
  }
  ...
  public void a(DynamicTextConfigManager.DynamicTextConfigBean paramDynamicTextConfigBean, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != null) && (this.jdField_a_of_type_AndroidWidgetEditText != null) && (paramDynamicTextConfigBean != null))
    {
      ...
      paramDynamicTextConfigBean = this.jdField_a_of_type_Blst.a(paramDynamicTextConfigBean.text_id, (List)localObject);
      ...
      if (!(paramDynamicTextConfigBean instanceof bltu)) {
        break label391;
      }
      ((bltu)paramDynamicTextConfigBean).a(this.jdField_c_of_type_Int);
      ...
      if (!this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a().equals(blst.a(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.c(), this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.b()))) {
        break label427;
      }
    ...
    for (;;)
    {
      ...
      return;
      label357:
      localObject = blst.a(blst.a(paramDynamicTextConfigBean.text_id), this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem);
  ...
  public void a(DynamicTextItem paramDynamicTextItem, int paramInt)
  {
    ...
    wsv.b("EditTextDialog", "setTextInfo:" + paramDynamicTextItem + " index:" + paramInt + " text:" + str1);
    this.jdField_a_of_type_Bmng.jdField_a_of_type_JavaLangString = str1;
    this.jdField_a_of_type_AndroidWidgetEditText.setText(this.jdField_a_of_type_Bmng.jdField_a_of_type_JavaLangString);
    if (this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.c() != 0)
    {
      if (this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a() == null) {
        this.jdField_a_of_type_AndroidWidgetEditText.setFilters(this.jdField_a_of_type_ArrayOfAndroidTextInputFilter);
    ...
    for (;;)
    {
      paramInt = this.jdField_a_of_type_Blst.a(paramDynamicTextItem);
      ...
      if (!(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem instanceof bltu)) {
        break label494;
      }
      paramDynamicTextItem = (bltu)this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Bmoh.a(false);
    this.jdField_a_of_type_Bmoh.a(c(), d());
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView.setPreViewDrawer(null);
    localObject = this.jdField_a_of_type_Bmoh;
    DynamicTextItem localDynamicTextItem = this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem;
    if (!paramBoolean) {}
    for (paramBoolean = true;; paramBoolean = false)
    {
      ((bmoh)localObject).a(localDynamicTextItem, paramBoolean, this.g, this.jdField_c_of_type_Boolean);
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 34)
    {
      ...
      {
        int i1 = this.jdField_a_of_type_Blst.a(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem);
  ...
  public int c()
  {
    ...
    wsv.b("EditTextDialog", "getPreViewCenterX:" + i1);
    return i1;
  }
  ...
  public int d()
  {
    ...
    wsv.b("EditTextDialog", "getPreViewCenterY()=" + i1);
    return i1;
  }
  ...
  public void onDetachedFromWindow()
  {
    ...
    if (this.jdField_a_of_type_Bmoh == null) {
      return;
    }
  ...
  {
    this.jdField_a_of_type_Int = aekt.a(100.0F, getContext().getResources());
    b();
    a();
