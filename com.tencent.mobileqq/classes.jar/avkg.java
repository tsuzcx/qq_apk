...
public class avkg
{
  public static View a(Context paramContext, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    case 5: 
    case 7: 
      return LayoutInflater.from(paramContext).inflate(2131559193, paramViewGroup, false);
    }
  ...
  public static avkb a(Context paramContext, int paramInt, ViewGroup paramViewGroup)
  {
    ...
    default: 
      return null;
    case 5: 
      return new avki(paramContext, localView, paramViewGroup);
    case 7: 
      return new avkh(paramContext, localView, paramViewGroup);
    }
    return new avkc(paramContext, localView, paramViewGroup);
  }
}
