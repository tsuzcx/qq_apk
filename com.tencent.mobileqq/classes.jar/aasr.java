...
public class aasr
  implements Runnable
{
  public aasr(ARMapActivity paramARMapActivity, int paramInt1, int paramInt2, long paramLong1, long paramLong2, int paramInt3, String paramString1, String paramString2, String paramString3, int paramInt4, int paramInt5, double paramDouble1, double paramDouble2, Object paramObject) {}
  ...
  public void run()
  {
    ...
    do
    {
      do
      {
          ...
          do
          {
            do
            {
              do
              {
                      ...
                      do
                      {
                        do
                        {
                          do
                          {
                            do
                            {
                              QQToast.a(this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity.getApplicationContext(), 2131437295, 1).b(this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity.getTitleBarHeight());
                              break label34;
                              break label34;
                              break label34;
                              break label34;
                              ...
                              for (int i = 3;; i = 0)
                              {
                                ...
                                ARMapActivity.a(this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity).setOnDismissListener(new aass(this));
                            ...
                            {
                              this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity.jdField_a_of_type_AndroidAppProgressDialog = new ProgressDialog(this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity, 2131624515);
                              ...
                              this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity.jdField_a_of_type_AndroidAppProgressDialog.setContentView(2130969181);
                            }
                            ((TextView)this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity.jdField_a_of_type_AndroidAppProgressDialog.findViewById(2131363381)).setText("正在加载...");
                ...
                ARMapActivity.a(this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity).setOnDismissListener(new aast(this));
        ...
        if (((LbsPackInfo)localObject3).jdField_a_of_type_Int == 1)
        {
          ...
          ARMapActivity.a(this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity).setOnDismissListener(new aasu(this));
          ARMapActivity.a(this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity).a(this.d, this.e);
          return;
        }
        if (QLog.isColorLevel()) {
        ...
        if (this.jdField_c_of_type_Int > ((LbsPackManager)localObject1).a.g)
        {
          ...
          ARMapActivity.a(this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity).setOnDismissListener(new aasv(this));
          ARMapActivity.a(this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity).b();
          return;
        }
        ...
        if (TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          ((TextView)this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity.jdField_a_of_type_AndroidAppProgressDialog.findViewById(2131363381)).setText("正在加载资源...");
          if (!this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity.isFinishing()) {
            this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity.jdField_a_of_type_AndroidAppProgressDialog.show();
          }
    ...
    for (localObject2 = "";; localObject2 = localObject2[1].toString())
    {
      ...
      if (ARMapActivity.a(this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity) == null) {
        ARMapActivity.a(this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity, new aasw(this));
      }
      if (ARMapActivity.a(this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity) == null)
      {
