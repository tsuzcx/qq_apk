...
public class nnx
{
  private static final nnx jdField_a_of_type_Nnx = new nnx();
  ...
  {
    paramString = ((akdi)paramAppInterface.getManager(56)).b(paramString + "");
  ...
  private mobileqq_mp.SendMenuEventRequest a(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localSendMenuEventRequest.versionInfo.set("8.2.8,3,4440");
    ...
    for (;;)
    {
      ...
      for (localObject = ((RecentUser)localObject).uin;; localObject = "0")
      {
        ...
        if (((RecentUser)localObject).getType() == 7210)
        {
          ...
          if (sdf.a().a(paramQQAppInterface) != 0) {
            i = 1;
          }
          break label153;
        }
        if ((((RecentUser)localObject).getType() != 7230) || (sbc.a().b() == 0)) {
          break label421;
        }
        i = 1;
        break label153;
  ...
  private void a(Context paramContext, QQAppInterface paramQQAppInterface)
  {
    ...
    aikw.a().a(paramQQAppInterface, 4);
  }
  ...
  private void a(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    if (AudioHelper.b(0))
    {
      bbcv.a(paramContext, 230, paramContext.getString(2131698453), paramContext.getString(2131698454), new nok(this), null).show();
      return;
    }
    if (AudioHelper.a(0))
    {
      bbcv.a(paramContext, 230, paramContext.getString(2131698453), paramContext.getString(2131698455), new nol(this), null).show();
      return;
    }
    paramQQAppInterface.a().b();
    acxv.a(paramQQAppInterface, (BaseActivity)paramContext, 1, 0);
    ...
    try
    {
      ...
      this.jdField_b_of_type_AndroidContentBroadcastReceiver = new nnz(this);
  ...
  private static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, mobileqq_mp.ButtonInfo paramButtonInfo)
  {
    ...
    if ((paramContext instanceof FragmentActivity))
    {
      ...
      if (localObject != null)
      {
        ...
        if ((localObject instanceof aerv))
        {
          localObject = (aerv)localObject;
          ((aerv)localObject).y += 1;
        }
      }
    }
    ...
    for (;;)
    {
      ...
      ((Intent)localObject).putExtra("big_brother_source_key", sgj.b(paramString));
  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    ...
    localIntent.putExtra("big_brother_source_key", sgj.b(paramString2));
    paramContext.startActivity(localIntent);
  }
  ...
  private void a(Context paramContext, MqqHandler paramMqqHandler, boolean paramBoolean)
  {
    ...
    localIntent.putExtra("from", nnx.class.getName());
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new noj(this, paramBoolean, paramMqqHandler);
  ...
  private void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    sgj.a(localIntent, paramQQAppInterface, paramContext, paramString, -1);
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, mobileqq_mp.ButtonInfo paramButtonInfo, String paramString2)
  {
    ...
    if ((!TextUtils.isEmpty(paramString2)) && (bdiw.a(paramString2)))
    {
      awzj localawzj = new awzj();
      int i;
      Bundle localBundle;
      int j;
      if (awzj.a((String)localObject) == 0)
      {
        i = 0;
        localBundle = awzj.a((String)localObject);
        j = localBundle.getInt("a_launch_mode", 268435456);
        if (i == 0) {
          break label136;
        }
        localawzj.a(paramQQAppInterface, paramContext, String.valueOf(l), (String)localObject, paramString2, j);
      }
      for (;;)
      {
        if (!bool) {
        ...
        break;
        label136:
        bool = bdiw.a(paramContext, paramString2, localBundle, j);
      }
    }
    a(paramQQAppInterface, paramContext, paramString1, paramButtonInfo);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, MqqHandler paramMqqHandler)
  {
    ...
    aikw.a().a(paramQQAppInterface, 3);
  }
  ...
  private void a(mobileqq_mp.SendMenuEventRequest paramSendMenuEventRequest)
  {
    ...
    NewIntent localNewIntent = new NewIntent(localContext, nov.class);
    ...
    ((PROTOCAL.StQWebReq)localObject).qua.set(bgxr.a());
    ((PROTOCAL.StQWebReq)localObject).deviceInfo.set(bgxq.a().c());
    ...
    localNewIntent.setObserver(new nod(this, localNewIntent, localContext, str1, localBusinessObserver, localQQAppInterface));
  ...
  private void b(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    if (localUri != null)
    {
      bfol localbfol = bfol.a((BaseActivity)paramContext);
      String[] arrayOfString = paramContext.getResources().getStringArray(2130968663);
      int j = arrayOfString.length;
      int i = 0;
      while (i < j)
      {
        localbfol.c(arrayOfString[i]);
        i += 1;
      }
      localbfol.c(2131690596);
      localbfol.a(new noa(this, paramQQAppInterface, paramContext, localUri, paramSessionInfo, localbfol));
      localbfol.show();
    }
    for (;;)
    {
      ...
      try
      {
        ...
        label120:
        this.jdField_b_of_type_AndroidContentBroadcastReceiver = null;
        this.jdField_b_of_type_AndroidContentBroadcastReceiver = new nob(this);
        paramQQAppInterface = new IntentFilter("com.tencent.biz.pubaccount.picResultAction");
        paramContext.registerReceiver(this.jdField_b_of_type_AndroidContentBroadcastReceiver, paramQQAppInterface, "com.tencent.msg.permission.pushnotify", null);
        this.jdField_a_of_type_Int = 2;
        return;
        acxv.a(paramQQAppInterface, (Activity)paramContext, paramSessionInfo, null, null);
        paramQQAppInterface = (akhq)paramQQAppInterface.a(20);
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    RecentUser localRecentUser = localaktg.a(paramString, 1008);
  ...
  private void c(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    catch (Exception paramSessionInfo)
    {
      try
      {
        ...
        this.jdField_c_of_type_AndroidContentBroadcastReceiver = new noc(this, paramQQAppInterface, bool);
  ...
  protected int a(String paramString, int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    case 1024: 
      do
      {
        ...
        return 1;
      } while (!nbc.b(paramQQAppInterface, paramString));
      return 2;
    case 0: 
      return 3;
    case 1: 
  ...
  public NewIntent a(Context paramContext, AppInterface paramAppInterface, long paramLong1, long paramLong2, long paramLong3, long paramLong4, int paramInt, List<Long> paramList)
  {
    ...
    paramContext = new NewIntent(paramContext, nou.class);
  ...
  public NewIntent a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, BusinessObserver paramBusinessObserver, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localNewIntent = new NewIntent(paramContext, nov.class);
      ...
      ((PROTOCAL.StQWebReq)localObject1).qua.set(bgxr.a());
      ((PROTOCAL.StQWebReq)localObject1).deviceInfo.set(bgxq.a().c());
      ...
      localNewIntent.setObserver(new noe(this, localNewIntent, paramQQAppInterface, paramString, paramContext, paramBusinessObserver));
  ...
  public NewIntent a(String paramString, int paramInt, boolean paramBoolean, Context paramContext, AppInterface paramAppInterface, non paramnon)
  {
    paramContext = new NewIntent(paramContext, nou.class);
    ...
    paramContext.setObserver(new noh(this, paramContext, paramnon));
    if (paramAppInterface != null) {
      paramAppInterface.startServlet(paramContext);
    }
    return paramContext;
  ...
  public void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, nom paramnom)
  {
    if ((paramString1 != null) && (!paramString1.equals(this.jdField_c_of_type_JavaLangString))) {
      a(paramString1);
    }
    this.jdField_c_of_type_JavaLangString = paramString1;
    ThreadManager.executeOnSubThread(new PublicAccountManager.1(this, paramString2, paramQQAppInterface, paramnom, paramContext));
  }
  ...
  public void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean, double paramDouble1, double paramDouble2, BusinessObserver paramBusinessObserver, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    try
    {
      ...
      NewIntent localNewIntent = new NewIntent(paramContext, nov.class);
      localNewIntent.putExtra("cmd", "CertifiedAccountSvc.certified_account_write.SendMenuEvent");
      paramString2 = new PROTOCAL.StQWebReq();
      paramString2.Seq.set(-1L);
      paramString2.qua.set(bgxr.a());
      paramString2.deviceInfo.set(bgxq.a().c());
      ...
      localNewIntent.setObserver(new nof(this, localNewIntent, paramContext, paramString1, paramBusinessObserver, paramQQAppInterface));
      if (paramQQAppInterface != null) {
        paramQQAppInterface.startServlet(localNewIntent);
      }
      return;
  ...
  public void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, BusinessObserver paramBusinessObserver)
  {
    ...
    catch (Exception paramString2)
    {
      do
      {
        ...
        paramString3 = new NewIntent(paramBaseActivity, nov.class);
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      axqw.b(null, "dc01160", "Pb_account_lifeservice", "", "0X800661D", "0X800661D", 0, 0, "", "", (String)localObject, "");
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, mobileqq_mp.GetPublicAccountMenuResponse paramGetPublicAccountMenuResponse)
  {
    ...
    do
    {
      ...
      if (((aukn)localObject).a(PublicAccountMenuEntity.class, paramString) == null) {
        break label391;
      }
      PublicAccountMenuEntity localPublicAccountMenuEntity2 = (PublicAccountMenuEntity)((aukn)localObject).a(PublicAccountMenuEntity.class, paramString);
      if (localPublicAccountMenuEntity2 == null) {
        break label381;
      }
      localPublicAccountMenuEntity2.clone(localPublicAccountMenuEntity1);
      ((aukn)localObject).a(localPublicAccountMenuEntity2);
      ((aukn)localObject).a();
    ...
    {
      axqw.a(paramQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005EC2", "0X8005EC2", 0, 0, paramString, paramGetPublicAccountMenuResponse, "", "");
      ...
      axqw.a(paramQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005EC3", "0X8005EC3", 0, 0, paramString, String.valueOf(((mobileqq_mp.ButtonInfo)((List)localObject).get(0)).sub_button.get().size()), "", "");
      return;
      i = 0;
      break label43;
      label381:
      ((aukn)localObject).a(localPublicAccountMenuEntity1);
      break label137;
      label391:
      ((aukn)localObject).a(localPublicAccountMenuEntity1);
      break label137;
  ...
  public void a(String paramString1, Context paramContext, QQAppInterface paramQQAppInterface, String paramString2, int paramInt1, BusinessObserver paramBusinessObserver, MqqHandler paramMqqHandler, int paramInt2, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      if (localButtonInfo.type.has())
      {
        ...
        noo.a(null, "P_CliOper", "Pb_account_lifeservice", paramString2, "mp_caidan_click", "aio_caidan_click", 0, 0, String.valueOf(paramInt2), String.valueOf(paramInt1), paramString1, String.valueOf(i), false);
        ota.a().a(paramString2, paramInt1, paramInt2, localButtonInfo);
        ...
        if (i == 2)
        {
          ...
          paramString1 = axun.a(localButtonInfo.url.get());
        }
        ...
        noo.a(null, "P_CliOper", "Pb_account_lifeservice", paramString2, "0X8005D4B", "0X8005D4B", 0, 0, (String)localObject + ";REFERRER=" + paramString1, "", "", "", false);
      ...
      for (boolean bool = localButtonInfo.is_new_menu.get();; bool = false)
      {
        ...
        if ((paramContext instanceof FragmentActivity))
        {
          ...
          if (paramString1 != null)
          {
            ...
            if ((paramString1 instanceof aerv))
            {
              paramString1 = (aerv)paramString1;
              paramString1.w += 1;
            }
          }
        }
      ...
      paramSessionInfo = bbej.a(paramQQAppInterface, paramContext, paramString1);
  ...
  public boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    } while ((bbct.e()) || (bbdj.a() <= 1.048576E+008F));
