...
public class vuy
  extends vva
{
  public vuy(PhotoListPanel.SwipeUpAndDragListener paramSwipeUpAndDragListener, Context paramContext, ViewGroup paramViewGroup)
  {
  ...
  private boolean a(int paramInt)
  {
    ...
    ((AnimationSet)localObject1).setAnimationListener(new vuz(this));
    return true;
  }
  ...
  boolean b(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      {
        return true;
        this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.a(i, paramMotionEvent, false, true, "0X8005E0D", "1", i + "", false);
      }
