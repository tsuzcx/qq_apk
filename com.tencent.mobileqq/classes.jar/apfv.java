...
public class apfv
{
  ...
  private static NativeMonitorConfig a(SharedPreferences paramSharedPreferences, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramSharedPreferences)) {
      try
      {
        ...
        return (NativeMonitorConfig)atgx.a(paramSharedPreferences, NativeMonitorConfig.class);
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, ConfigurationService.Config paramConfig)
  {
    ...
    int i = bdne.aF(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int k = bdne.aG(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int m = AppSetting.a();
    if (QLog.isColorLevel()) {
    ...
    if (k != m)
    {
      bdne.Y(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), m);
      i = 0;
    }
    String str;
    if (j != i)
    {
      str = aozj.b(paramConfig, i, paramInt);
    ...
    for (;;)
    {
      try
      {
        ...
        paramConfig = (NativeMonitorConfig)atgx.a(paramConfig, NativeMonitorConfig.class);
        if (paramConfig == null)
        {
          a(new NativeMonitorConfig());
          bdne.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, "");
          bdne.t(paramQQAppInterface.getApp(), 0);
      ...
      catch (JSONException paramConfig)
      {
        ...
        a(paramConfig);
        bdne.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, str);
        bdne.t(paramQQAppInterface.getApp(), paramConfig.soHook);
        continue;
      }
      a(new NativeMonitorConfig());
      bdne.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, "");
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (localNativeMonitorConfig != null)
      {
        ...
        amdq.a(jdField_a_of_type_ComTencentMobileqqDataNativemonitorNativeMonitorConfig.getTmChance());
      }
  ...
  public static void b()
  {
    ...
    //   51: new 432	apfw
    //   54: dup
    //   55: invokespecial 433	apfw:<init>	()V
