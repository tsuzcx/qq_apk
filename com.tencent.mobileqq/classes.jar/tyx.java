...
{
  tyx(tyo paramtyo, String paramString) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (i == 0)
        {
          ...
          this.jdField_a_of_type_Tyo.k = ((JSONObject)localObject2).optString("puin");
          if (i == -1)
          {
            paramInt = ((JSONObject)localObject2).optInt("refuseSec");
            if (paramInt > 0)
            {
              this.jdField_a_of_type_Tyo.jdField_a_of_type_Boolean = true;
              this.jdField_a_of_type_Tyo.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(1000, paramInt * 1000);
            }
          }
          ...
          {
            localObject4 = tyo.a(((Integer)((Iterator)localObject3).next()).intValue());
          ...
          Object localObject4 = (ArrayList)tyo.b.get(this.jdField_a_of_type_JavaLangString);
          paramInt = 0;
          if (paramInt < ((ArrayList)localObject2).size())
          {
            String str = (String)tyo.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt));
            if ((str != null) && (((Integer)((ArrayList)localObject2).get(paramInt)).intValue() == 1) && (tyo.a((ArrayList)localObject4, str))) {
              ((ArrayList)localObject3).add(str);
            }
          }
          else
          {
            tyo.jdField_a_of_type_JavaUtilMap.put(this.jdField_a_of_type_JavaLangString, localObject3);
            tyo.b.remove(this.jdField_a_of_type_JavaLangString);
            localObject2 = new ArrayList();
            if (localObject4 != null)
            {
              ...
              {
                if (tyo.a((ArrayList)localObject3, (String)((ArrayList)localObject4).get(paramInt))) {
                  break label583;
                }
        ...
        else
        {
          ...
          if (this.jdField_a_of_type_Tyo.m != null) {
            this.jdField_a_of_type_Tyo.callJs(this.jdField_a_of_type_Tyo.m, new String[] { paramBundle });
          }
          return;
        }
      }
