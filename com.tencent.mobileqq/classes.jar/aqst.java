  ...
  extends WebViewPlugin
{
  ...
  ajuc jdField_a_of_type_Ajuc = new aqsy(this);
  ...
  private void a(int paramInt1, int paramInt2)
  {
    if (this.mRuntime.a() != null) {
      bbmy.a(this.mRuntime.a(), paramInt2, this.mRuntime.a().getString(paramInt1), 0).b(this.mRuntime.a().getResources().getDimensionPixelSize(2131167766));
    }
  }
  
  private void a(TroopInfo paramTroopInfo)
  {
    this.jdField_a_of_type_Wis.a(paramTroopInfo.troopuin, this.jdField_b_of_type_Int, this.e);
  }
  ...
  private void a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localJSONObject.put("contactsnum", azia.b(localContext));
          localJSONObject.put("appnum", azia.a(localContext));
          localJSONObject.put("medianum", azia.c(localContext) + azia.d(localContext));
          localJSONObject.put("storage", azia.c() + azia.a());
          localJSONObject.put("storagetotal", azia.d() + azia.b());
          if (Build.VERSION.SDK_INT < 23) {
            break label216;
          }
          if (!azia.a(localContext, 4))
          {
            j = 1;
            i = j;
            if (!azia.a(localContext, 59)) {
              i = j + 2;
            }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
        ...
        if (!"openRewardDetail".equals(paramString3)) {
          if ("previewRewardVideo".equals(paramString3))
          {
            try
            {
              ...
              this.jdField_a_of_type_Wis.b(paramJsBridgeListener, paramString1, new aqsu(this, l1, l2, paramString2));
            }
          ...
          else if ("setRedPoint".equals(paramString3))
          {
            try
            {
              ...
              if (!ayqn.a().a(paramJsBridgeListener, paramString1)) {
                continue;
              }
              ...
              paramString1 = (RelativeLayout)paramJsBridgeListener.findViewById(2131309694);
              if (paramString1 == null) {
                continue;
              }
              paramString2 = new RelativeLayout.LayoutParams(-2, -2);
              paramString2.addRule(7, 2131302832);
              paramString2.setMargins(0, aciy.a(5.0F, paramJsBridgeListener.getResources()), aciy.a(5.0F, paramJsBridgeListener.getResources()), 0);
              this.jdField_a_of_type_AndroidWidgetImageView.setLayoutParams(paramString2);
              this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
              this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849054);
            ...
            if (QLog.isColorLevel())
            {
              ...
              {
                paramJsBridgeListener.jdField_a_of_type_Bazb.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
                this.jdField_a_of_type_AndroidWidgetImageView = new ImageView(paramJsBridgeListener.getActivity());
                paramString1 = (RelativeLayout)paramJsBridgeListener.jdField_a_of_type_Bbcj.d.findViewById(2131309694);
                if (paramString1 != null)
                {
                  paramString2 = new RelativeLayout.LayoutParams(-2, -2);
                  paramString2.addRule(7, 2131302832);
          ...
          else if ("saveTroopMemberTitle".equals(paramString3))
          {
            try
            {
              this.jdField_b_of_type_Wis = wis.a();
              this.jdField_b_of_type_Wis.a();
              ...
              this.jdField_b_of_type_Wis.a(paramString1, paramString2, i);
            }
            catch (Exception paramJsBridgeListener) {}
            if (QLog.isColorLevel()) {
          ...
          else if ("clickMineButton".equals(paramString3))
          {
            try
            {
              ...
              ayqn.a().a(paramJsBridgeListener, paramString1, false);
            }
            catch (Exception paramJsBridgeListener) {}
            if (QLog.isColorLevel()) {
          ...
          else if ("addTroop".equals(paramString3))
          {
            ...
            catch (JSONException paramJsBridgeListener)
            {
              ...
              continue;
              this.jdField_a_of_type_Wis.a(paramJsBridgeListener, 8390785);
            }
            catch (Exception paramJsBridgeListener)
            {
              if (QLog.isColorLevel()) {
          ...
          else if ("huanjiStatus".equals(paramString3))
          {
            try
            {
              ...
              this.jdField_a_of_type_Wis.a(paramString1, paramString2, paramString3, new aqsv(this));
            }
            catch (JSONException paramJsBridgeListener) {}
            if (QLog.isColorLevel()) {
          ...
          else if ("huanjiDownload".equals(paramString3))
          {
            try
            {
              ...
              this.jdField_a_of_type_Wis.a(i, paramString1, paramString3, paramString2, new aqsw(this));
            }
            catch (JSONException paramJsBridgeListener) {}
            if (QLog.isColorLevel()) {
          ...
          else if ("huanjiGetInfo".equals(paramString3))
          {
            try
            {
              ...
              ((AppActivity)paramString1).requestPermissions(new aqsx(this, paramJsBridgeListener), 1, new String[] { "android.permission.READ_CONTACTS" });
            }
            catch (Exception paramJsBridgeListener) {}
            if (QLog.isColorLevel()) {
          ...
          else if ("thirdAppCreateGroupCallback".equals(paramString3))
          {
            ...
            try
            {
              ...
              abju.a(paramString1, paramString2, PublicFragmentActivity.class, BindGroupFragment.class);
          ...
          else
          {
            ...
            if (paramVarArgs != null)
            {
              try
              {
                ...
                azlj.a(this.mRuntime.a(), paramString1, 2);
              }
              catch (JSONException paramJsBridgeListener) {}
              if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = this.jdField_a_of_type_Wis;
        if (i != 1) {
          break label2078;
        }
        bool = true;
  ...
  public void onCreate()
  {
    ...
    this.jdField_a_of_type_Wis.a(this.jdField_a_of_type_Ajuc);
  }
  ...
  public void onDestroy()
  {
    ...
    {
      this.jdField_a_of_type_Wis.b(this.jdField_a_of_type_Ajuc);
    ...
    if (this.jdField_b_of_type_Wis != null) {
      this.jdField_b_of_type_Wis.b();
    }
  }
}
