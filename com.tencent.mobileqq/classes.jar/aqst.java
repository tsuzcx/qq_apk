  ...
  implements Handler.Callback
{
  ...
  aqst(QQAppInterface paramQQAppInterface, Context paramContext, aqsv paramaqsv)
  {
    super(paramContext);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    if (paramMessage.what == f) {
      if (this.i == c)
      {
        ...
        j = Math.min(j, 99);
        paramMessage = String.format(amtj.a(2131702012), new Object[] { Integer.valueOf(j) });
        this.jdField_a_of_type_AndroidWidgetTextView.setText(paramMessage);
        this.jdField_a_of_type_Bjmp.sendEmptyMessageDelayed(f, 500L);
      }
    }
    while (paramMessage.what != g)
    {
      do
      {
        ...
        if (this.i == d)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetTextView.setText(amtj.a(2131702013));
          this.jdField_a_of_type_Bjmp.sendEmptyMessageDelayed(g, 100L);
          return false;
        }
      } while (this.i != e);
      dismiss();
      this.jdField_a_of_type_Aqsv.a(this.i);
      return false;
    }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2131559338);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131365334));
    ...
    for (int j = 1;; j = 2)
    {
      ...
      super.setOnKeyListener(new aqsu(this));
      return;
    }
  }
  ...
  {
    super.onStart();
    this.jdField_a_of_type_Bjmp.sendEmptyMessage(f);
  }
}
