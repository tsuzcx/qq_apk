  ...
  extends agax
{
  ...
  public agbr(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  private BaseChatItemLayout a(long paramLong)
  {
    ...
    if (paramLong == 0L)
    {
      ...
      while (k < this.jdField_a_of_type_ComTencentWidgetListView.getChildCount())
      {
        ...
        {
          localObject2 = (afwr)afur.a((View)localObject1);
          if ((((afwr)localObject2).jdField_a_of_type_Int != 0) && (((afwr)localObject2).jdField_a_of_type_AndroidViewView.getTop() + ((View)localObject1).getTop() + BaseChatItemLayout.h > 0)) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if (((localObject2 instanceof BaseChatItemLayout)) && (((afwr)afur.a((View)localObject2)).jdField_a_of_type_Int != 0)) {
  ...
  private void a(agbe paramagbe, ChatMessage paramChatMessage)
  {
    agbq.a(null, "0X800B072", paramChatMessage.frienduin, paramagbe);
  }
  
  private void a(Object[] paramArrayOfObject)
  {
    if ((paramArrayOfObject.length < 5) || (!(paramArrayOfObject[3] instanceof agbe)) || (!(paramArrayOfObject[4] instanceof ChatMessage))) {}
    agbe localagbe;
    do
    {
      return;
      localagbe = (agbe)paramArrayOfObject[3];
    } while (!a(localagbe.a));
    paramArrayOfObject = (ChatMessage)paramArrayOfObject[4];
    if (QLog.isColorLevel()) {
      QLog.d("FloorJumper", 2, "set jump url, url = " + localagbe.a);
    }
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new agbs(this, localagbe, paramArrayOfObject));
  }
  ...
  int a(int paramInt, afwr paramafwr)
  {
    int k;
    int m;
    int n;
    if (paramafwr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend())
    {
      k = paramafwr.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.k + BaseChatItemLayout.p;
      m = paramafwr.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.j - BaseChatItemLayout.o;
      if (paramInt > k) {
        break label135;
      }
    ...
    {
      return n;
      k = paramafwr.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.j + BaseChatItemLayout.o;
      m = paramafwr.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.k - BaseChatItemLayout.k;
      break;
      d1 = Math.random();
  ...
  public long a()
  {
    ...
    case 3: 
      ...
      if (this.jdField_b_of_type_Int == 1)
      {
        ...
        {
          localafwr = (afwr)afur.a(localBaseChatItemLayout);
          if (localafwr != null)
          {
            this.jdField_b_of_type_Int = 2;
            this.jdField_a_of_type_Long = 0L;
            this.jdField_b_of_type_Long = localafwr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq;
            this.jdField_d_of_type_Long = 0L;
            this.jdField_e_of_type_Int = 0;
            k = localafwr.jdField_a_of_type_AndroidViewView.getTop();
            ...
            this.jdField_g_of_type_Int = a((localafwr.jdField_a_of_type_AndroidViewView.getLeft() + localafwr.jdField_a_of_type_AndroidViewView.getRight()) / 2, localafwr);
            this.h = 0;
      ...
      if (localBaseChatItemLayout != null)
      {
        ...
        if (localafwr != null)
        {
          ...
          this.jdField_e_of_type_Int = (a(this.i, localafwr) - this.i);
  ...
  public boolean a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      while ((this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner == null) || (this.jdField_a_of_type_AndroidViewView == null))
      {
        ...
        return false;
        k = afur.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
        ...
        {
          afwr localafwr = (afwr)afur.a(afur.a(this.jdField_a_of_type_ComTencentWidgetListView, k));
          if (localafwr != null)
          {
            k = localafwr.jdField_a_of_type_AndroidViewView.getTop();
            k = localafwr.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            if (k != 0)
            {
              this.h += k;
              this.j += k;
          ...
          else
          {
            ...
            return false;
            k = afur.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            int m = afur.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            ...
            {
              localafwr = (afwr)afur.a(afur.a(this.jdField_a_of_type_ComTencentWidgetListView, k));
              if (localafwr != null)
              {
                k = localafwr.jdField_a_of_type_AndroidViewView.getTop();
                k = localafwr.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            ...
            {
              localafwr = (afwr)afur.a(afur.a(this.jdField_a_of_type_ComTencentWidgetListView, m));
              if (localafwr != null)
              {
                k = localafwr.jdField_a_of_type_AndroidViewView.getTop();
                k = localafwr.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.h - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
