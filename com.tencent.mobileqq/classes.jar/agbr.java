  ...
  extends BaseBubbleBuilder
{
  ...
  public agbr(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new agbs(this);
    this.b = paramContext;
  ...
  private RelativeLayout a(Context paramContext)
  {
    ...
    localQQWalletTransferBubbleView.setId(2131379968);
    ...
    ((ImageView)localObject1).setId(2131379964);
    localQQWalletTransferBubbleView.addView((View)localObject1);
    localObject1 = new LinearLayout(paramContext);
    localObject2 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject2).addRule(0, 2131379964);
    ...
    ((TextView)localObject2).setId(2131379967);
    ...
    ((TextView)localObject2).setId(2131379966);
    ((LinearLayout)localObject1).addView((View)localObject2);
    localQQWalletTransferBubbleView.addView((View)localObject1);
    ...
    ((RelativeLayout.LayoutParams)localObject1).addRule(3, 2131379968);
    localQQWalletTransferBubbleView.setLayoutParams((ViewGroup.LayoutParams)localObject1);
    localQQWalletTransferBubbleView.setBackgroundResource(2130846709);
    localQQWalletTransferBubbleView.setId(2131379963);
  ...
  {
    boolean bool2 = true;
    paramView = (agbt)paramaelt;
    if (paramView.a == null) {
      paramView.a = a(this.b);
    }
    if ((paramChatMessage instanceof MessageForVIPDonate)) {}
    for (paramaelt = (MessageForVIPDonate)paramChatMessage;; paramaelt = null)
    {
      if (paramaelt == null)
      {
      ...
      paramaelt.parse();
      paramaelt = paramaelt.donateMsg;
      if (paramaelt == null)
      {
        QLog.e("VIPDonateMsgItemBuilder", 1, "donateMsg empty");
        return null;
      }
      paramBaseChatItemLayout = (TextView)paramView.a.findViewById(2131379967);
      paramBaseChatItemLayout.setText(paramaelt.title);
      paramBaseChatItemLayout.setTextColor(-1);
      paramBaseChatItemLayout = (TextView)paramView.a.findViewById(2131379966);
      paramBaseChatItemLayout.setText(paramaelt.subTitle);
      paramBaseChatItemLayout.setTextColor(-1);
      ((TextView)paramView.a.findViewById(2131379965)).setText(paramaelt.footer);
      ((ImageView)paramView.a.findViewById(2131379964)).setImageResource(2130850119);
      paramBaseChatItemLayout = (QQWalletTransferBubbleView)paramView.a.findViewById(2131379963);
      QQWalletTransferBubbleView localQQWalletTransferBubbleView = (QQWalletTransferBubbleView)paramView.a.findViewById(2131379968);
      int m = Color.rgb(255, 170, 57);
      if (!paramChatMessage.isSend())
      {
        bool1 = true;
        localQQWalletTransferBubbleView.setBubbleBackground(2130846708, m, bool1);
      ...
      {
        paramBaseChatItemLayout.setBubbleBackground(2130846709, m, bool1);
        if (jdField_e_of_type_Boolean) {
          paramView.a.setContentDescription(paramaelt.subTitle + paramaelt.title);
        }
        paramView.a.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        paramView.a.setOnLongClickListener(paramaeov);
        paramView.a.setOnTouchListener(paramaeov);
        return paramView.a;
        bool1 = false;
        break;
      }
  ...
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    default: 
      ...
      return;
    case 2131365069: 
      acex.b(this.b, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
      return;
    }
  ...
  public bdlb[] a(View paramView)
  {
    ...
    acex.a(localbdkz, this.b, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
