  ...
  extends VasWebviewJsPlugin
{
  ...
  binn jdField_a_of_type_Binn = new binp(this);
  public binr a;
  public String a;
  ...
  {
    bimq.a(paramJSONObject.optInt("useWebBundle"));
  }
  ...
  private void b(JSONObject paramJSONObject)
  {
    ...
    bior.a(str1, false, bior.b);
    for (;;)
    {
      a(localIntent.getExtras());
      bimq.a(paramJSONObject, localIntent, 100);
      return;
      label126:
      bior.a(str1, false, bior.e);
    }
  }
  ...
  private static String c()
  {
    ...
    return bdzf.a("tencent/MobileQQ/qqcomic/cache/");
  }
  ...
  public void a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_1
    //   3: putstatic 121	bino:f	Ljava/lang/String;
    //   6: getstatic 26	bino:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   18: monitorexit
    //   19: return
    //   20: getstatic 26	bino:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   23: iconst_1
    //   24: invokevirtual 287	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   27: new 289	cooperation/comic/jsp/QQComicJsPlugin$4
    //   30: dup
    //   31: aload_0
    //   32: invokespecial 290	cooperation/comic/jsp/QQComicJsPlugin$4:<init>	(Lbino;)V
    //   35: iconst_5
    //   36: aconst_null
    //   37: iconst_1
  ...
  public void a(String paramString1, JSONObject paramJSONObject, String paramString2)
  {
    if (this.jdField_a_of_type_Binr == null)
    {
      ...
      this.jdField_a_of_type_Binr = biof.a(this.mRuntime, this.jdField_a_of_type_Binn);
    }
    if (this.jdField_a_of_type_Binr != null) {
      this.jdField_a_of_type_Binr.a(paramString1, paramJSONObject);
    }
    do
    {
      return;
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      {
        paramJsBridgeListener = (String)bimq.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.get();
        paramString1 = new JSONObject();
        ...
        for (;;)
        {
          ...
          paramString1.put("message", alud.a(2131710566));
    ...
    else
    {
      ...
      if ("setSwitchChannel".equals(paramString3))
      {
        ...
        if ((paramString3 != null) && (paramString3.length() > 0))
        {
          ...
          paramVarArgs.a.a(new bega(m, k, paramString1, paramString2, paramJsBridgeListener));
          break label2111;
        }
      }
      else
      {
        ...
        else
        {
          ...
          if ("setTabRedPoint".equals(paramString3))
          {
            ...
            break label2111;
            label1078:
            paramVarArgs.a.a(new begb(paramJsBridgeListener, j, paramString2));
            break label2111;
          }
          ...
          if ("openQQBrowser".equals(paramString3))
          {
            ...
            bimq.a(paramString1, paramString2, -1);
            break label2111;
          }
          ...
          if ("setTitleAndBottomBar".equals(paramString3))
          {
            ...
            paramJsBridgeListener = (begc)paramString1;
            bool1 = bool2;
            if (!bool3) {
              bool1 = true;
            }
          ...
          if ("getReporterInfo".equals(paramString3))
          {
            paramJsBridgeListener = new JSONObject();
            paramString1 = new JSONObject();
            paramString1.put("mod", bimq.jdField_a_of_type_JavaLangString);
            paramString1.put("land_page", bimq.c);
            paramString1.put("obj_ownerid", bimq.b);
            paramJsBridgeListener.put("data", paramString1);
