  ...
  extends Dialog
{
  ...
  private bepr jdField_a_of_type_Bepr;
  String jdField_a_of_type_JavaLangString;
  private int jdField_b_of_type_Int = 48;
  private ImageView jdField_b_of_type_AndroidWidgetImageView;
  private int c = -2;
  
  public bepp(Context paramContext)
  {
    this(paramContext, 0);
  }
  
  public bepp(Context paramContext, int paramInt)
  {
    this(paramContext, paramInt, 2131561217, 48);
  }
  
  public bepp(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  public void a(bepr parambepr)
  {
    this.jdField_a_of_type_Bepr = parambepr;
  }
  ...
  {
    setOnKeyListener(new bepq(this, paramBoolean));
  }
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 157	abqm:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 157	abqm:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 157	abqm:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
  ...
  {
    super.onBackPressed();
    if (this.jdField_a_of_type_Bepr != null) {
      this.jdField_a_of_type_Bepr.a();
    }
  }
