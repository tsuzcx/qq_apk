...
public class aylc
{
  ...
  {
    bgpd.a(null, a(paramString)).b(paramQQAppInterface, null).a(paramActivity, paramQQAppInterface.getAccount());
  ...
  public static void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    if (!TextUtils.isEmpty(paramString1))
    {
      ...
      if (localClipboardManager != null)
      {
        ...
        if (paramBoolean) {
          bcpw.a(BaseApplicationImpl.getContext(), 2, ajyc.a(2131706549), 0).a();
        }
      }
    }
  }
