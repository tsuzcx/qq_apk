...
public class aylc
{
  ...
  static
  {
    jdField_a_of_type_Int = ayjy.jdField_b_of_type_ArrayOfJavaLangString.length;
  }
  ...
  public static final Drawable a(int paramInt)
  {
    ...
    {
      i = j;
      if (paramInt < ayjy.jdField_b_of_type_Int) {
  ...
  public static final Drawable a(int paramInt, ayld paramayld)
  {
    if (paramInt < 0) {
      throw new IllegalArgumentException("invaid emoji index: " + paramInt);
    }
    ...
    if (paramInt >= 1000)
    {
      ...
      ThreadManager.executeOnFileThread(new TextUtils.1(paramInt, paramayld));
      return null;
    }
    ...
    for (paramInt = 2130839808 + paramInt;; paramInt = 2130839942)
    {
      if (BaseApplicationImpl.sImageCache != null)
      {
        ...
        ThreadManager.executeOnFileThread(new TextUtils.2(paramInt, paramayld));
        return null;
      }
  ...
  public static final Drawable a(int paramInt, boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      paramInt = ayjy.jdField_b_of_type_ArrayOfInt[paramInt];
      if (BaseApplicationImpl.sImageCache != null) {
    ...
    do
    {
      ...
      int i = ayjy.jdField_a_of_type_ArrayOfInt[paramInt];
      j = ayjy.jdField_b_of_type_ArrayOfInt[paramInt];
      try
      {
  ...
  public static Drawable a(Resources paramResources, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramInt = bbay.a((Drawable)localObject);
  ...
  {
    if ((paramInt < 0) || (paramInt >= ayjy.d.length)) {
      throw new IllegalArgumentException("invaid sys emotcation index: " + paramInt);
    }
    return String.valueOf(Character.toChars(ayjy.d[paramInt]));
  }
        ...
        if (paramString != null)
        {
          for (;;)
          {
            ...
            catch (Throwable paramString)
            {
              ...
              paramString[j] = 13;
              continue;
              paramString = anqz.a(paramString);
              if (paramString == null) {
                break label428;
              }
            }
            ...
            if (localStringBuilder.codePointAt(i) == 20)
            {
              ...
              if (i < localStringBuilder.length() - 1)
              {
                ...
                if (k >= ayjy.jdField_a_of_type_Int) {
                  continue;
                }
                paramString = ayjy.jdField_a_of_type_ArrayOfJavaLangString[k];
  ...
  public static String a(String paramString, Paint paramPaint, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    if ((k < i3) && (paramInt2 < paramInt3))
    {
      ...
      if (((paramInt1 & 0x6) > 0) && (i5 == 20) && (k < i3 - 1))
      {
        ...
        if (paramInt2 < ayjy.jdField_a_of_type_Int)
        {
          paramInt2 = 2;
          i += 1;
          j = 1;
  ...
  {
    QQSysAndEmojiBaseInfo localQQSysAndEmojiBaseInfo = anwr.a().a(1);
    boolean bool = false;
  ...
  public static final Drawable b(Resources paramResources, int paramInt)
  {
    ...
    //   63: getstatic 440	ayjv:b	Ljava/lang/String;
    ...
    //   114: astore_0
    //   115: aload 6
    //   117: invokestatic 466	ayjv:a	([B)I
    //   120: istore_2
    //   121: aload 5
    //   123: astore_0
    ...
    //   212: getstatic 440	ayjv:b	Ljava/lang/String;
    ...
    //   256: astore_0
    //   257: aload 6
    //   259: invokestatic 489	bbbr:a	(Landroid/graphics/Bitmap;)I
    //   262: istore_2
    //   263: aload 5
    //   265: astore_0
    ...
    //   408: ldc_w 472
    //   411: iconst_2
    //   412: invokestatic 503	actj:a	()Ljava/lang/StringBuilder;
    //   415: ldc_w 505
    ...
    //   448: getstatic 440	ayjv:b	Ljava/lang/String;
    ...
    //   465: getstatic 440	ayjv:b	Ljava/lang/String;
    ...
    //   521: getstatic 440	ayjv:b	Ljava/lang/String;
    ...
    //   533: ldc_w 472
    //   536: iconst_2
    //   537: invokestatic 503	actj:a	()Ljava/lang/StringBuilder;
    //   540: ldc_w 505
    ...
    //   575: getstatic 440	ayjv:b	Ljava/lang/String;
  ...
  {
    if ((paramInt < 0) || (paramInt >= bhvd.e.length)) {
      throw new IllegalArgumentException("invaid emotcation index: " + paramInt);
    }
    return String.valueOf(Character.toChars(bhvd.e[paramInt]));
  }
  ...
  public static String b(String paramString)
  {
    ...
    do
    {
      return str1;
      i = 0;
      while (i < ayjy.d.length)
      {
        j = paramString.indexOf(ayjy.d[i], 0);
        str1 = paramString;
        if (j != -1)
        {
          str1 = paramString;
      ...
      catch (AccountNotMatchException localAccountNotMatchException)
      {
        for (;;)
        {
          try
          {
            ...
            localObject1 = (askf)((AppInterface)localObject1).getManager(14);
            ...
            if (localStringBuilder.codePointAt(i) == 20)
            {
              ...
              {
                k = localStringBuilder.charAt(i + 1);
                if ((k >= ayjy.jdField_a_of_type_Int) && (250 != k)) {
                  break label244;
                }
                j = k;
                if (250 == k) {
                ...
                paramString = ayjy.jdField_a_of_type_ArrayOfJavaLangString[j];
                localStringBuilder.replace(i, i + 2, paramString);
                j = i + (paramString.length() - 1);
              }
            }
  ...
  public static final String e(int paramInt)
  {
    ...
    return ayjy.jdField_a_of_type_ArrayOfJavaLangString[paramInt];
  }
  ...
  public static String e(String paramString)
  {
    ...
    {
      k = paramString.indexOf(ayjy.d[i], 0);
      localObject = paramString;
      if (k != -1)
      {
        ...
        catch (AccountNotMatchException paramString)
        {
          for (;;)
          {
            try
            {
              ...
              localObject = ayjy.jdField_a_of_type_ArrayOfJavaLangString[m];
              if (k != 0) {
                break label650;
              }
              localObject = ajya.a(2131714894) + (String)localObject;
