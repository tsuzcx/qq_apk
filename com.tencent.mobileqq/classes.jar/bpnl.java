  ...
  extends bpnb
{
  ...
  public bpnl(@NonNull String paramString)
  {
    super(paramString);
  ...
  public int a(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return ((bpnn)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_Int;
    }
    return 0;
  }
  ...
  public int a(String paramString)
  {
    if ((!bgsp.a(paramString)) && (this.jdField_a_of_type_JavaUtilList != null))
    {
      ...
      {
        bpnn localbpnn = (bpnn)localIterator.next();
        if (paramString.equals(localbpnn.jdField_a_of_type_JavaLangString)) {
          return localbpnn.jdField_a_of_type_Int;
        }
      }
    }
    return 0;
  ...
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return ((bpnn)this.jdField_a_of_type_JavaUtilList.get(paramInt)).b;
    }
    return null;
  }
  ...
  public List<bpnn> a()
  {
    ...
    {
      File[] arrayOfFile = ((File)localObject).listFiles(new bpnm(this));
      if (arrayOfFile != null)
      {
    ...
    for (;;)
    {
      ...
      {
        localArrayList.add(new bpnn(str, localFile1.toURI().toString(), i, (String)localObject));
        j += 1;
        break;
        if (!str.endsWith(".gif")) {
          break label293;
  ...
  public void a(List<bpnn> paramList)
  {
    if (paramList == null) {
      return;
    }
  ...
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return ((bpnn)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_c_of_type_JavaLangString;
    }
    return null;
  }
