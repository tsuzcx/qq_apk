...
{
  public uac(QCircleCommentPraiseLayout paramQCircleCommentPraiseLayout, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {}
  ...
  public void a(boolean paramBoolean, long paramLong, String paramString, FeedCloudWrite.StDoLikeRsp paramStDoLikeRsp)
  {
    ...
    for (;;)
    {
      ...
      QQToast.a(this.jdField_a_of_type_ComTencentBizQqcircleWidgetsQCircleCommentPraiseLayout.getContext(), paramString, 0).a();
