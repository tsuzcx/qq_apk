...
public class bget
{
  private static bget jdField_a_of_type_Bget;
  ...
  private long d;
  private long e;
  private String g = QzoneConfig.getInstance().getConfig("PhotoUpload", "PhotoGuideCreateGifSo", "https://d3g.qq.com/sngapp/app/update/20181219175050_4961/libandroidndkgif.so");
  ...
  private String j = QzoneConfig.getInstance().getConfig("PhotoUpload", "PhotoGuideQzoneVisionSoMD5", "f428bc70e52b7eb3fba4327e123a779b");
  private String k = QzoneConfig.getInstance().getConfig("PhotoUpload", "PhotoGuideLibCShareSoMD5", "f507c0f741a32f7a30fa162faa894ebc");
  private String l = QzoneConfig.getInstance().getConfig("PhotoUpload", "PhotoGuideCreateGifSoMD5", "16dd3ecb57fac1a97a60a9cf3891accb");
  ...
  public bget()
  {
    ...
    this.jdField_d_of_type_Long = QzoneConfig.getInstance().getConfig("PhotoUpload", "PhotoGuideLibCShareSoLength", 657000);
    this.jdField_e_of_type_Long = QzoneConfig.getInstance().getConfig("PhotoUpload", "PhotoGuideQzoneVisionSoLength", 2422908);
  }
  
  public static bget a()
  {
    try
    {
      if (jdField_a_of_type_Bget == null) {
        jdField_a_of_type_Bget = new bget();
      }
      bget localbget = jdField_a_of_type_Bget;
      return localbget;
    }
    finally {}
  }
  ...
  public void a(String paramString1, String paramString2, Downloader.DownloadListener paramDownloadListener)
  {
    ...
    paramDownloadListener = new bgeu(this, paramString2, paramDownloadListener, paramString1);
    paramString2 = jdField_a_of_type_JavaIoFile.getAbsolutePath() + "/tmp" + paramString2;
    this.jdField_a_of_type_Bfrt.a(paramString1, paramString2, paramDownloadListener);
  }
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    if (localFile.length() == a(paramString)) {
      if (paramBoolean)
      {
        String str1 = bcdu.a(b(paramString));
  ...
  public void b()
  {
    QzoneModuleManager.getInstance().downloadModule("pictureMarkerSo.zip", new bgev(this));
  }
  ...
  public void c()
  {
    QzoneModuleManager.getInstance().downloadModule("libandroidndkbeauty.so", new bgew(this));
  }
}
