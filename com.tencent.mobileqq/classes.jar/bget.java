...
public class bget
{
  ...
  private WeakReference<bgev> jdField_a_of_type_MqqUtilWeakReference;
  private boolean jdField_a_of_type_Boolean;
  private long b;
  
  public bget(bgev parambgev, String paramString, long paramLong1, long paramLong2, boolean paramBoolean, Object paramObject)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Long = paramLong1;
    this.b = paramLong2;
    this.jdField_a_of_type_Boolean = paramBoolean;
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(parambgev);
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      localBundle.putString("qqver", "8.4.10.4875");
      ...
      for (localObject = "1";; localObject = "0")
      {
        ...
        new bghj("https://app.qun.qq.com/cgi-bin/api/inner_setunifiedapp", "POST", new bgeu(this), 1000, null).a(localHashMap);
