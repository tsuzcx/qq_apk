  ...
  implements View.OnClickListener
{
  ...
  public atxz(AppInterface paramAppInterface, Context paramContext)
  {
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_ComTencentMobileqqNearbyNowViewWidgetRoundRelativeLayout = ((RoundRelativeLayout)findViewById(2131363510));
    ...
    this.c = ((RoundRelativeLayout)findViewById(2131369494));
    ...
    this.jdField_b_of_type_ComTencentMobileqqNearbyNowViewWidgetRoundRelativeLayout.setRoundLayoutRadius(axli.a(3.0F));
    this.c.setRoundLayoutRadius(axli.a(3.0F));
  ...
  public void a(ImageView paramImageView, String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 155	atxz:jdField_a_of_type_AndroidGraphicsDrawableDrawable	Landroid/graphics/drawable/Drawable;
    //   4: ifnonnull +19 -> 23
    //   7: aload_0
    ...
    //   20: putfield 155	atxz:jdField_a_of_type_AndroidGraphicsDrawableDrawable	Landroid/graphics/drawable/Drawable;
    //   23: aconst_null
    //   24: astore 4
    ...
    //   30: aload_3
    //   31: aload_0
    //   32: getfield 103	atxz:jdField_b_of_type_Int	I
    //   35: putfield 176	com/tencent/image/URLDrawable$URLDrawableOptions:mRequestHeight	I
    //   38: aload_3
    //   39: aload_0
    //   40: getfield 101	atxz:jdField_a_of_type_Int	I
    //   43: putfield 179	com/tencent/image/URLDrawable$URLDrawableOptions:mRequestWidth	I
    //   46: aload_3
    //   47: aload_0
    //   48: getfield 155	atxz:jdField_a_of_type_AndroidGraphicsDrawableDrawable	Landroid/graphics/drawable/Drawable;
    //   51: putfield 182	com/tencent/image/URLDrawable$URLDrawableOptions:mFailedDrawable	Landroid/graphics/drawable/Drawable;
    //   54: aload_3
    //   55: aload_0
    //   56: getfield 155	atxz:jdField_a_of_type_AndroidGraphicsDrawableDrawable	Landroid/graphics/drawable/Drawable;
    ...
    //   132: aload_0
    //   133: getfield 82	atxz:c	Lcom/tencent/mobileqq/nearby/now/view/widget/RoundRelativeLayout;
    //   136: iconst_0
    //   137: invokevirtual 208	com/tencent/mobileqq/nearby/now/view/widget/RoundRelativeLayout:setVisibility	(I)V
    //   140: aload_0
    //   141: getfield 45	atxz:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   144: new 210	com/tencent/mobileqq/nearby/widget/NearbyActivityDialog$1
    //   147: dup
    //   148: aload_0
    //   149: invokespecial 213	com/tencent/mobileqq/nearby/widget/NearbyActivityDialog$1:<init>	(Latxz;)V
    //   152: ldc2_w 214
    ...
    //   164: dup
    //   165: aload_0
    //   166: invokespecial 222	atya:<init>	(Latxz;)V
    ...
    //   183: ifnonnull +8 -> 191
    //   186: aload_0
    //   187: getfield 155	atxz:jdField_a_of_type_AndroidGraphicsDrawableDrawable	Landroid/graphics/drawable/Drawable;
    //   190: astore_2
    //   191: aload_1
    //   192: aload_2
  ...
  {
    String str = (Integer)atbg.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1)) + "";
    int i = paramView.getId();
    if (i == 2131367938)
    {
      dismiss();
      axqw.b(null, "dc00899", "grp_lbs", "", "home", "pop_clk_close", 0, 0, str, "", "", "");
    }
    while (i != 2131363451) {
      return;
    }
    ...
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      ...
      sgj.a(paramView, this.jdField_a_of_type_JavaLangString);
      this.jdField_a_of_type_AndroidContentContext.startActivity(paramView);
    }
    for (;;)
    {
      dismiss();
      axqw.b(null, "dc00899", "grp_lbs", "", "home", "pop_clk_btn", 0, 0, str, "", "", "");
      return;
      label221:
