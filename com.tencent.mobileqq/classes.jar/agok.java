...
public class agok
  extends Handler
{
  public agok(PressToChangeVoicePanel paramPressToChangeVoicePanel, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    else
    {
      ...
      bamr.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a, (QQRecorder.RecorderParam)localObject1);
      Object localObject2 = (ListenChangeVoicePanel)this.a.f.findViewById(2131370056);
      ...
      if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof ainh)) {
        ocd.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005850", "0X8005850", 0, 0, "", "", Double.toString(this.a.jdField_a_of_type_Double), "", false);
      }
      paramMessage = (ViewGroup)((ListenChangeVoicePanel)localObject2).findViewById(2131364359);
      if (VersionUtils.isHoneycomb())
      {
        ...
        localAnimatorSet.addListener(new agol(this, paramMessage));
