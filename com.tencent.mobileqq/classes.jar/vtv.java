  ...
  implements vuf
{
  ...
  private void a(@Nullable String paramString1, @Nullable Object paramObject, @Nullable String paramString2)
  {
    ...
    {
      xvv.d("ConfigManager", paramString1);
      return;
    }
  }
  ...
  public <V> V a(@NonNull String paramString, @NonNull V paramV)
  {
    ...
    for (;;)
    {
      xvv.b("ConfigManager", "get value : K : %s, V : %s", paramString, localObject);
  ...
  public void a(String paramString)
  {
    ...
    {
      xvv.e("ConfigManager", "remove value error : K:%s.", new Object[] { paramString });
      return;
    }
    xvv.b("ConfigManager", "remove value success :  K:%s.", paramString);
  }
  ...
  public <V> void a(String paramString, V paramV)
  {
    ...
    while (!bool)
    {
      xvv.e("ConfigManager", "set value error : K:%s, V:%s .", new Object[] { paramString, paramV });
      return;
      if (paramV.getClass() == Long.class) {
    ...
    xvv.b("ConfigManager", "set value success :  K:%s, V:%s .", paramString, paramV);
  }
  
  public void b()
  {
    xvv.b("ConfigManager", "onDestroy");
  }
}
