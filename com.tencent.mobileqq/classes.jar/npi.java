...
public class npi
{
  ...
  public static boolean a(AdvertisementInfo paramAdvertisementInfo, ProteusBannerVideoItemData paramProteusBannerVideoItemData, Context paramContext, int paramInt)
  {
    ...
    return false;
    label109:
    if (obz.b.equals(paramAdvertisementInfo))
    {
      if (paramInt == 0) {
        return false;
      }
      if ((paramInt == 1) && (paramContext != null) && (pyu.a(paramContext))) {
        return true;
      }
      if ((paramInt == 2) && (paramContext != null) && (badq.g(paramContext))) {
        return true;
      }
    }
    if (obz.c.equals(paramAdvertisementInfo))
    {
      if (paramInt == 0) {
        return false;
      }
      ...
      if ((paramInt == 2) && (paramContext != null) && (pyu.a(paramContext))) {
        return true;
      }
    }
    return false;
