...
public class ydv
  extends yeb<HotRecommendFeedItem>
{
  public ydv(@NonNull HotRecommendFeedItem paramHotRecommendFeedItem)
  {
    ...
    if (!this.c.isEmpty())
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (!TextUtils.isEmpty(localStoryVideoItem.mOwnerUid)) {
          localwke.b(localStoryVideoItem.mOwnerUid);
        }
      }
    }
  }
