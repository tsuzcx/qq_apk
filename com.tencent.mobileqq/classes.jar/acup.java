  ...
  implements baxz
{
  ...
  public acup(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner, BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(true);
    this.jdField_a_of_type_AndroidSupportV4UtilArraySet = new ArraySet();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Adte = new adte(paramContext, paramQQAppInterface, paramSessionInfo, paramAIOAnimationConatiner, paramBaseChatPie);
    ...
    {
      this.b = l;
      this.jdField_a_of_type_Aibr = new aibr(this, paramQQAppInterface);
      this.jdField_a_of_type_Aibt = new aibt(paramBaseChatPie);
      this.jdField_a_of_type_Acuq = new acuq(this);
      return;
    }
  }
  ...
  protected static void a(MessageForStructing paramMessageForStructing, acuj paramacuj, View paramView, boolean paramBoolean)
  {
    int i = 2130848939;
    int j = 2130848763;
    int k = 2130838146;
    ...
    for (i = k;; i = 2130838130)
    {
      ...
      if (!paramMessageForStructing.structingMsg.hasFlag(4))
      {
        ...
        if (paramBoolean) {}
        for (i = j;; i = 2130848764) {
          break;
        }
      }
      if (paramBoolean) {}
      for (i = 2130838146;; i = 2130838130)
      {
        paramView.setBackgroundResource(i);
        return;
      }
    ...
    for (paramChatMessage1 = ((MessageForMarketFace)paramChatMessage1).mMarkFaceMessage;; paramChatMessage1 = (ChatMessage)localObject)
    {
      ...
      if (paramChatMessage1 != null)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            bool1 = bool2;
            if (anqz.a(paramChatMessage1.sbufID, paramChatMessage1.mediaType).equals(anqz.a(((MarkFaceMessage)localObject).sbufID, ((MarkFaceMessage)localObject).mediaType)))
            {
              axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "Ep_show_follow", 0, 0, "", paramChatMessage1.dwTabID + "", "", "");
              bool1 = true;
            }
          }
        }
  ...
  {
    this.jdField_a_of_type_Adte.a(paramChatMessage, this).a(paramView, paramChatMessage, paramInt);
  }
  ...
  public void a(ChatMessage paramChatMessage, int paramInt)
  {
    ...
    if (i >= 0)
    {
      ...
      localChatMessage = (ChatMessage)localView.getTag(2131364122);
  ...
  public void a(List<ChatMessage> paramList)
  {
    ...
    if (paramList.size() > 0)
    {
      ...
      for (;;)
      {
        if ((axau.a(localChatMessage1.msgtype)) || (akpx.i(localChatMessage1.msgtype)))
        {
          i += 1;
          ...
          else
          {
            ...
            if (paramList.size() - k >= 0)
            {
              ...
              {
                if (!axau.a(localChatMessage3.msgtype))
                {
                  localChatMessage2 = localChatMessage3;
                  localChatMessage4 = localChatMessage1;
                  i = j;
                  if (!akpx.i(localChatMessage3.msgtype)) {
                    break label216;
                  }
                }
                k += 1;
  ...
  public void a(List<ChatMessage> paramList, CharSequence paramCharSequence, int paramInt)
  {
    ...
    if (i < paramList.size())
    {
      ...
      boolean bool2 = axau.b(localChatMessage.msgtype);
    ...
    for (;;)
    {
      ...
      paramCharSequence = (ajxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) || ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) && (paramCharSequence != null) && (paramCharSequence.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))) {
        ((anoi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(214)).a(paramList, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, paramInt);
      }
  ...
  public void c()
  {
    ...
    label295:
    if (this.jdField_a_of_type_Adte != null) {
      this.jdField_a_of_type_Adte.a();
    }
    ...
    this.jdField_a_of_type_Aibt.c();
  }
  
  public void d()
  {
    if (this.jdField_a_of_type_Acuq.a != null)
    {
      aice localaice = this.jdField_a_of_type_Acuq.a.a();
      if ((localaice == null) || (!localaice.c())) {
        break label41;
      }
      localaice.d();
    }
    label41:
    while (!this.jdField_a_of_type_Acuq.a.a()) {
      return;
    }
    this.jdField_a_of_type_Acuq.a.a();
  }
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return adte.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    bbkj.a(null, "AIO_ChatAdapter_getView" + " | " + localChatMessage1.getClass().getName());
    acuz localacuz = this.jdField_a_of_type_Adte.a(localChatMessage1, this);
    if (paramInt != 0)
    {
    ...
    paramView = localacuz.a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage1, paramView, paramViewGroup, this.jdField_a_of_type_Acuq);
    if (paramView != null)
    {
      paramView.setTag(2131364122, localChatMessage1);
      if (((localacuz instanceof actm)) && ((paramView instanceof agfu))) {
        paramViewGroup = (agfu)paramView;
      }
    }
    bbkj.a("AIO_ChatAdapter_getView" + " | " + localChatMessage1.getClass().getName(), null);
    return paramView;
  }
