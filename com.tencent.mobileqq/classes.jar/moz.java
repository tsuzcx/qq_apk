  ...
  implements mox
{
  ...
  protected int a(Paint paramPaint, String paramString)
  {
    ...
    if (this.jdField_a_of_type_Moy != null) {
      f1 = this.jdField_a_of_type_Moy.jdField_a_of_type_Float;
    }
  ...
  {
    lbd.f(this.jdField_a_of_type_JavaLangString, "start:" + paramLong);
  }
  ...
  public void a(Typeface paramTypeface, int paramInt, moy parammoy)
  {
    ...
    for (paramTypeface = this.jdField_a_of_type_Lgo.a;; paramTypeface = null)
    {
  ...
  public void a(lgo paramlgo)
  {
    ...
    if (this.jdField_a_of_type_Lgo != null)
    {
      localObject = this.jdField_a_of_type_Lgo.b;
      localObject = (String)localObject;
      this.jdField_a_of_type_Lgo = paramlgo;
      if ((this.jdField_a_of_type_Lgo != null) && (!this.jdField_a_of_type_Lgo.a()) && (paramlgo != null) && (TextUtils.isEmpty(paramlgo.b)) && (localObject != null) && (!TextUtils.isEmpty((CharSequence)localObject))) {
        this.jdField_a_of_type_Lgo.b = ((CharSequence)localObject);
      }
      if (this.jdField_a_of_type_Lgo == null) {
        break label124;
      }
    ...
    label124:
    for (paramlgo = this.jdField_a_of_type_Lgo.a;; paramlgo = null)
    {
      paramlgo = (String)paramlgo;
      this.c = a(this.jdField_a_of_type_AndroidGraphicsPaint, paramlgo);
      return;
      localObject = null;
      break;
    }
  ...
  Bitmap b()
  {
    ...
    do
    {
      ...
      {
        return localObject3;
        lbd.f(this.jdField_a_of_type_JavaLangString, "build:" + toString());
  ...
  public void d()
  {
    lbd.f(this.jdField_a_of_type_JavaLangString, "releaseBitmap:" + this.jdField_a_of_type_AndroidGraphicsBitmap);
