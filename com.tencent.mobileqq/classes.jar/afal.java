...
public class afal
{
  static volatile afal jdField_a_of_type_Afal;
  private int jdField_a_of_type_Int;
  private final String jdField_a_of_type_JavaLangString = "DoodleResHelper";
  private Map<Integer, afam> jdField_a_of_type_JavaUtilMap;
  
  public static afal a()
  {
    if (jdField_a_of_type_Afal == null) {}
    try
    {
      if (jdField_a_of_type_Afal == null) {
        jdField_a_of_type_Afal = new afal();
      }
      return jdField_a_of_type_Afal;
    }
    finally {}
  }
  ...
  public Bitmap a(int paramInt1, int paramInt2)
  {
    ...
    //   4: iload_1
    //   5: iload_2
    //   6: invokevirtual 52	afal:a	(II)Ljava/lang/String;
    //   9: astore 8
    //   11: aload 8
    ...
    //   33: aload 8
    //   35: iconst_0
    //   36: invokespecial 66	afal:a	(Ljava/lang/String;I)Ljava/lang/String;
    ...
    //   107: aload 8
    //   109: iconst_0
    //   110: invokespecial 66	afal:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   113: aload 4
  ...
  public Drawable a(int paramInt1, int paramInt2)
  {
    ...
    //   14: iload_1
    //   15: iload_2
    //   16: invokevirtual 115	afal:b	(II)Ljava/lang/String;
    //   19: astore 6
    //   21: aload 6
    ...
    //   35: aload 6
    //   37: iconst_1
    //   38: invokespecial 66	afal:a	(Ljava/lang/String;I)Ljava/lang/String;
    ...
    //   105: aload 6
    //   107: iconst_1
    //   108: invokespecial 66	afal:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   111: aload 4
  ...
  public Drawable a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt2 > 0)
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject3).mFailedDrawable = ((Context)localObject2).getResources().getDrawable(2130837747);
      ((URLDrawable.URLDrawableOptions)localObject3).mLoadingDrawable = ((Context)localObject2).getResources().getDrawable(2130837747);
  ...
  public void a(int paramInt1, int paramInt2, View paramView, aygt paramaygt)
  {
    if (Looper.getMainLooper() != Looper.myLooper()) {
      new Handler(Looper.getMainLooper()).post(new DoodleResHelper.1(this, paramInt1, paramInt2, paramView, paramaygt));
    }
    ...
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ScribbleResMgr.a().a(localQQAppInterface, 3, paramInt2, paramView, paramaygt);
        return;
      }
    } while ((paramInt1 != 1) && (paramInt1 != 2));
    ScribbleResMgr.a().a(localQQAppInterface, 4, paramInt2, paramView, paramaygt);
  }
  ...
  public void a(Bitmap paramBitmap)
  {
    ...
    {
      afam localafam = (afam)((Iterator)localObject).next();
      if ((localafam.jdField_a_of_type_JavaLangRefWeakReference != null) && (localafam.jdField_a_of_type_JavaLangRefWeakReference.get() == paramBitmap))
      {
        localafam.jdField_a_of_type_Boolean = true;
        QLog.d("DoodleResHelper", 2, "releaseBitmap succ:" + this.jdField_a_of_type_JavaUtilMap.size());
        return;
      }
    }
    localObject = new afam(this);
    ((afam)localObject).b = paramBitmap.getHeight();
    ((afam)localObject).jdField_a_of_type_Int = paramBitmap.getWidth();
    ((afam)localObject).jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramBitmap);
    ((afam)localObject).jdField_a_of_type_Boolean = true;
  ...
  public Bitmap b(int paramInt1, int paramInt2)
  {
    ...
    //   39: aload 6
    //   41: iconst_0
    //   42: invokespecial 66	afal:a	(Ljava/lang/String;I)Ljava/lang/String;
    ...
    //   89: aload 6
    //   91: iconst_0
    //   92: invokespecial 66	afal:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   95: aload 4
  ...
  public void b(int paramInt1, int paramInt2, View paramView, aygt paramaygt)
  {
    if (Looper.getMainLooper() != Looper.myLooper()) {
      new Handler(Looper.getMainLooper()).post(new DoodleResHelper.2(this, paramInt1, paramInt2, paramView, paramaygt));
    }
    QQAppInterface localQQAppInterface;
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ScribbleResMgr.a().a(localQQAppInterface, 1, paramInt2, paramView, paramaygt);
        return;
      }
    } while ((paramInt1 != 1) && (paramInt1 != 2));
    ScribbleResMgr.a().a(localQQAppInterface, 2, paramInt2, paramView, paramaygt);
  }
  ...
  public Bitmap c(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject5 = (afam)((Map.Entry)((Iterator)localObject4).next()).getValue();
        if ((localObject5 == null) || (((afam)localObject5).jdField_a_of_type_JavaLangRefWeakReference == null) || (((afam)localObject5).jdField_a_of_type_JavaLangRefWeakReference.get() == null))
        {
          ((Iterator)localObject4).remove();
          QLog.d("DoodleResHelper", 2, "getBitmap remove a invalid item");
          continue;
        }
        if (!((afam)localObject5).jdField_a_of_type_Boolean) {
          continue;
        }
      }
      finally {}
      if ((((afam)localObject5).b == paramInt2) && (((afam)localObject5).jdField_a_of_type_Int == paramInt1))
      {
        if (((afam)localObject5).jdField_a_of_type_JavaLangRefWeakReference != null) {}
        label233:
        Object localObject3;
        for (Object localObject2 = (Bitmap)((afam)localObject5).jdField_a_of_type_JavaLangRefWeakReference.get(); localObject2 != null; localObject3 = null)
        {
          QLog.d("DoodleResHelper", 2, "getBitmap find idle :" + this.jdField_a_of_type_JavaUtilMap.size());
          ((afam)localObject5).jdField_a_of_type_Boolean = false;
          return localObject2;
          QLog.d("DoodleResHelper", 2, "getBitmap add new item");
          localObject2 = new afam(this);
          ((afam)localObject2).b = paramInt2;
          ((afam)localObject2).jdField_a_of_type_Int = paramInt1;
          try
          {
            localObject4 = Bitmap.createBitmap(paramInt1, paramInt2, Bitmap.Config.ARGB_8888);
            ((afam)localObject2).jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(localObject4);
            ((afam)localObject2).jdField_a_of_type_Boolean = false;
