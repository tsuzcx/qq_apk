...
{
  public afal(PlayOperationViewModel paramPlayOperationViewModel) {}
  ...
  public boolean onDoubleTap(MotionEvent paramMotionEvent)
  {
    if (System.currentTimeMillis() - PlayOperationViewModel.a(this.a) >= 500L)
    {
      ...
      ((LikeAniView)this.a.jdField_a_of_type_AndroidViewView.findViewById(2131370579)).a(i, j);
    ...
    for (;;)
    {
      ...
      return true;
      label73:
      if ((!PlayOperationViewModel.b(this.a)) && (this.a.jdField_a_of_type_AndroidViewView.findViewById(2131370579).getVisibility() == 0))
      {
