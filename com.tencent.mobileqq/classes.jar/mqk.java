  ...
  extends mqi
{
  ...
  private boolean a(int paramInt, Bundle paramBundle)
  {
    ...
    //   1: astore 12
    //   3: aload_0
    //   4: getfield 113	mqk:i	Ljava/lang/String;
    //   7: astore 6
    ...
    //   61: ifnull +708 -> 769
    //   64: ldc 139
    //   66: invokestatic 144	anvx:a	(I)Ljava/lang/String;
    //   69: aload_2
    ...
    //   274: aload_0
    //   275: invokevirtual 206	mqk:a	()Lmqb;
    //   278: astore 14
    //   280: aload_2
    //   281: astore 13
    //   283: aload 9
    ...
    //   324: astore 11
    //   326: aload 14
    //   328: getfield 211	mqb:a	Lmqh;
    //   331: getfield 217	mqh:jdField_c_of_type_Boolean	Z
    //   334: ifeq +59 -> 393
    //   337: aload_2
    //   338: astore 13
    //   340: aload 9
    ...
    //   346: astore 11
    //   348: aload 14
    //   350: getfield 211	mqb:a	Lmqh;
    //   353: getfield 219	mqh:a	Ljava/lang/String;
    //   356: aload_0
    //   357: getfield 221	mqk:jdField_a_of_type_Mqy	Lmqy;
    //   360: getfield 225	mqy:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   363: invokestatic 228	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   366: ifeq +27 -> 393
    //   369: ldc 230
    //   371: astore 13
    //   373: aload 14
    //   375: getfield 211	mqb:a	Lmqh;
    //   378: getfield 233	mqh:b	Ljava/lang/String;
    //   381: astore 11
    //   383: aload 14
    //   385: getfield 211	mqb:a	Lmqh;
    //   388: getfield 234	mqh:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   391: astore 12
    //   393: aload 13
    //   395: aload 11
    //   397: aload 12
    //   399: invokestatic 236	mqk:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    //   402: istore_3
    //   403: aload_0
    //   404: getfield 221	mqk:jdField_a_of_type_Mqy	Lmqy;
    //   407: aload 13
    //   409: putfield 237	mqy:i	Ljava/lang/String;
    //   412: aload_0
    //   413: getfield 221	mqk:jdField_a_of_type_Mqy	Lmqy;
    //   416: aload 8
    //   418: putfield 238	mqy:h	Ljava/lang/String;
    //   421: aload_0
    //   422: getfield 221	mqk:jdField_a_of_type_Mqy	Lmqy;
    //   425: aload 10
    //   427: putfield 239	mqy:g	Ljava/lang/String;
    //   430: aload_0
    //   431: getfield 221	mqk:jdField_a_of_type_Mqy	Lmqy;
    //   434: aload 11
    //   436: putfield 242	mqy:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   439: aload_0
    //   440: getfield 221	mqk:jdField_a_of_type_Mqy	Lmqy;
    //   443: aload 12
    //   445: putfield 245	mqy:f	Ljava/lang/String;
    //   448: aload_0
    //   449: getfield 113	mqk:i	Ljava/lang/String;
    //   452: iconst_1
    ...
    //   495: aload_0
    //   496: getfield 190	mqk:g	Ljava/lang/String;
    ...
    //   507: aload_0
    //   508: getfield 194	mqk:h	Ljava/lang/String;
    ...
    //   590: istore 4
    //   592: aload_0
    //   593: getfield 221	mqk:jdField_a_of_type_Mqy	Lmqy;
    //   596: iload 4
    //   598: putfield 269	mqy:jdField_e_of_type_Int	I
    //   601: aload_0
    //   602: invokevirtual 271	mqk:b	()V
    //   605: aload_0
    //   606: getfield 221	mqk:jdField_a_of_type_Mqy	Lmqy;
    //   609: invokestatic 276	mqw:b	(Lmqy;)V
    //   612: iconst_1
    //   613: ireturn
    //   614: iconst_0
    //   615: istore 5
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Mqy.jdField_e_of_type_Int = 4;
    b();
  }
  
  public boolean a(VideoAppInterface paramVideoAppInterface, AVActivity paramAVActivity, mqy parammqy, WeakReference<mql> paramWeakReference)
  {
    ...
    long l = mqx.a(paramVideoAppInterface);
    if (l == 0L)
    {
      QLog.w(this.i, 1, "GetRedBag, userId为空");
      parammqy.jdField_e_of_type_Int = 2;
      return false;
    }
    ...
    try
    {
      ...
      localJSONObject2.put("listid", parammqy.jdField_c_of_type_JavaLangString);
      localJSONObject2.put("authkey", parammqy.d);
      ...
      if ((paramAVActivity != null) && (paramAVActivity.b() != -1) && (paramAVActivity.b() != 5))
      {
        ...
        QLog.w(this.i, 1, "GetRedBag, userName[" + str + "], userId[" + l + "], redPocketId[" + parammqy.jdField_c_of_type_JavaLangString + "], json[" + AudioHelper.a(localJSONObject1) + "], Activity[" + paramAVActivity + "]");
        parammqy.jdField_e_of_type_Int = 1;
        return true;
      }
    }
  ...
  void b()
  {
    ...
    {
      mql localmql = (mql)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localmql != null) {
        localmql.a(this);
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      lts.b(bool, this.jdField_a_of_type_Mqy.jdField_e_of_type_JavaLangString, this.jdField_a_of_type_Mqy.f);
      return;
    }
  }
}
