  ...
  implements avma
{
  ...
  avms jdField_a_of_type_Avms;
  public boolean a;
  
  public avmu(HotPicPageView paramHotPicPageView, avms paramavms)
  {
    this.jdField_a_of_type_Avms = paramavms;
  }
  
  public RecyclerView.ViewHolder a(ViewGroup paramViewGroup, int paramInt)
  {
    return new avmy(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView, LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_AndroidContentContext).inflate(2131558628, paramViewGroup, false), null);
  }
  ...
  public void a(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    {
      avmh.a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(paramInt);
      this.jdField_a_of_type_Boolean = true;
    }
    if (this.jdField_a_of_type_Int == 1)
    {
      paramViewHolder.itemView.findViewById(2131368344).setVisibility(0);
      paramViewHolder.itemView.findViewById(2131368345).setVisibility(4);
      return;
    }
    if (HotPicPageView.b())
    {
      paramViewHolder.itemView.findViewById(2131368345).setVisibility(0);
      paramViewHolder.itemView.findViewById(2131368344).setVisibility(8);
      return;
    }
