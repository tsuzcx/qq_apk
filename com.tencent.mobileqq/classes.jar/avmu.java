  ...
  implements bdrm
{
  ...
  public avmu(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, int paramInt2, long paramLong2, long paramLong3, int paramInt3)
  {
    ...
    do
    {
      ...
      paramString = new auxc((String)localObject, (String)localObject, paramString, paramInt1, i, paramInt3, bbyp.a());
      ...
      bool = auxd.a(paramQQAppInterface, (MessageForUniteGrayTip)localObject);
  ...
  {
    bdrn localbdrn = ((bdrb)this.a.getManager(339)).a(2, 1, paramString);
    if ((localbdrn instanceof WatchTogetherSession))
    {
      localbdrn.g = 3;
      localbdrn.jdField_h_of_type_Int = 3;
      bdro.a(this.a, paramString, false);
      a(true, (WatchTogetherSession)localbdrn, 1007, "");
    }
  }
    ...
    do
    {
      ...
      do
      {
        ...
        for (paramObject = localVideoChangePushInfo.bytes_gray_tips.get().toStringUtf8();; paramObject = null)
        {
          ...
          long l4 = ((bdrb)paramQQAppInterface.getManager(339)).a(2, 1, l2);
          if (l1 >= l4) {
            break label348;
          }
          if (!QLog.isColorLevel()) {
        ...
        WatchTogetherSession localWatchTogetherSession = (WatchTogetherSession)bdro.a(2, 1, String.valueOf(l2));
        if (i == 1)
        {
          if (l3 != -1L) {
            break;
  ...
  public void a(QQAppInterface paramQQAppInterface, WatchTogetherSession paramWatchTogetherSession, int paramInt, long paramLong1, String paramString, long paramLong2, long paramLong3, TroopTips0x857.VideoChangePushInfo paramVideoChangePushInfo)
  {
    ...
    localbdrb.a(2, 1, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramLong2);
    WatchTogetherSession localWatchTogetherSession2 = (WatchTogetherSession)localbdrb.a(paramWatchTogetherSession.jdField_d_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString);
    ...
    if (localWatchTogetherSession2 != null)
    {
      ...
      if (paramQQAppInterface.getCurrentAccountUin().equals(String.valueOf(paramLong1)))
      {
        ...
        bdro.a(paramQQAppInterface, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, true);
      }
    }
    for (;;)
    {
      ...
      {
        paramQQAppInterface = localbdrb.a(2, 1, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, 1003);
        ...
        localbdrb.a(2, 1, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, 1003);
      }
      return;
      localbdrb.a(paramWatchTogetherSession.jdField_d_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession);
      localWatchTogetherSession1 = paramWatchTogetherSession;
      break;
      label277:
      if (paramInt == 2) {
        bdro.a(paramQQAppInterface, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, false);
      }
    }
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, aio_media.RspLatestPlayingState paramRspLatestPlayingState)
  {
    ...
    paramToServiceMsg = (WatchTogetherSession)localbdrb.a(2, 1, str);
    Object localObject = paramToServiceMsg;
    if (paramToServiceMsg == null)
    {
      localObject = (WatchTogetherSession)bdro.a(2, 1, str);
      localbdrb.a(2, 1, str, (bdrn)localObject);
    }
    boolean bool1;
    label470:
    boolean bool2;
    if (((WatchTogetherSession)localObject).a())
    {
      ...
      {
        bglf.h(this.a, ((WatchTogetherSession)localObject).jdField_e_of_type_JavaLangString, ((WatchTogetherSession)localObject).jdField_f_of_type_JavaLangString);
        bool2 = bool1;
        paramRspLatestPlayingState = paramToServiceMsg;
      }
    }
  ...
  {
    bdrb localbdrb = (bdrb)this.a.getManager(339);
    Object localObject = localbdrb.a(2, 1, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramInt);
    if ((paramBoolean) && (paramInt == 1003) && ((((bdrh)localObject).jdField_a_of_type_JavaLangObject instanceof TroopTips0x857.VideoChangePushInfo)))
    {
      int i = ((bdrh)localObject).jdField_a_of_type_AndroidOsBundle.getInt("action_type");
      String str = ((bdrh)localObject).jdField_a_of_type_AndroidOsBundle.getString("tips");
      long l1 = ((bdrh)localObject).jdField_a_of_type_AndroidOsBundle.getLong("seq");
      long l2 = ((bdrh)localObject).jdField_a_of_type_AndroidOsBundle.getLong("msgSeq");
      localbdrb.a(paramWatchTogetherSession, i, str, l1, l2, (TroopTips0x857.VideoChangePushInfo)((bdrh)localObject).jdField_a_of_type_JavaLangObject);
      localbdrb.b(paramWatchTogetherSession, i, str, l1, l2, (TroopTips0x857.VideoChangePushInfo)((bdrh)localObject).jdField_a_of_type_JavaLangObject);
    }
    boolean bool1;
    label201:
    boolean bool2;
    ...
    {
      bdro.a(this.a, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, false);
      if ((paramWatchTogetherSession.g == 1) && (paramWatchTogetherSession.jdField_h_of_type_Int == 2))
      {
        ...
        bool2 = true;
        label224:
        if ((!bool1) || (!bool2) || (!avmc.b(paramWatchTogetherSession.jdField_d_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession.jdField_e_of_type_Int))) {
          break label561;
        }
        if (QLog.isColorLevel()) {
        ...
        label360:
        avmc.a(BaseApplicationImpl.context, (WatchTogetherFloatingData)localObject);
      }
    }
    for (;;)
    {
      ...
      localbdrb.a(paramBoolean, paramWatchTogetherSession, paramInt, paramString);
      localbdrb.b(2, 1, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramInt);
      return;
      bdro.a(this.a, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, true);
      break;
      label540:
      bool1 = false;
      break label201;
      ...
      break label360;
      label561:
      if (avmc.b(paramWatchTogetherSession.jdField_d_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession.jdField_e_of_type_Int))
      {
        if (QLog.isColorLevel()) {
          QLog.d("WatchTogetherParser", 1, "isSameFloatingInfo but param error isSupportRoomType=" + bool1 + " isUrlValid=" + bool2);
        }
        avmc.a(false, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession.jdField_e_of_type_Int, false);
      }
    }
  }
}
