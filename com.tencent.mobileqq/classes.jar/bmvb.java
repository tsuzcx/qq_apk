  ...
  extends alba
{
  ...
  private bmva jdField_a_of_type_Bmva;
  ...
  private Drawable a(String paramString)
  {
    ...
    localGradientDrawable.setCornerRadius(bgtn.b(20.0F));
  ...
  private String a()
  {
    if (this.jdField_a_of_type_Bmva == null) {
      return "";
    }
    if (this.jdField_a_of_type_Bmva.d != 1) {
      return this.jdField_a_of_type_Bmva.h;
    }
    return a(this.jdField_a_of_type_Bmva.e, this.jdField_a_of_type_Bmva.f);
  }
  ...
  public View a()
  {
    ...
    this.b = ((TextView)localView.findViewById(2131379889));
    this.c = ((TextView)localView.findViewById(2131379537));
    return localView;
  }
  ...
  {
    super.a(paramalaw);
    ThreadManagerV2.getUIHandlerV2().post(new QbossADBannerCountDownManager.1(this, paramalaw));
  }
