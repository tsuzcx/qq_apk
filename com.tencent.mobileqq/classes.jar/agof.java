...
{
  private agof(PersonalityLabelGalleryActivity paramPersonalityLabelGalleryActivity) {}
  
  private void a(agoe paramagoe, PersonalityLabelInfo paramPersonalityLabelInfo)
  {
    if (this.a.jdField_b_of_type_Boolean)
    {
      if (paramagoe.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramagoe.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramagoe.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramagoe.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      if (paramagoe.jdField_d_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramagoe.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramagoe.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramagoe.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      paramagoe.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
      paramagoe.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
      paramagoe.jdField_b_of_type_AndroidViewView.setTag(2131370950, Integer.valueOf(4));
      paramagoe.jdField_b_of_type_AndroidViewView.setTag(2131362740, paramagoe);
      paramagoe = paramagoe.jdField_b_of_type_AndroidWidgetImageView;
      if (!this.a.jdField_b_of_type_Boolean) {
        break label384;
      }
    }
    ...
    {
      paramagoe.setImageResource(i);
      return;
      if (PersonalityLabelGalleryActivity.a(this.a))
      {
        if (paramagoe.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 0) {
          paramagoe.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        if (paramagoe.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 0) {
          paramagoe.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        ...
        if (paramagoe.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 8) {
          paramagoe.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
        }
        paramagoe.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
        paramagoe.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
        paramagoe.jdField_b_of_type_AndroidViewView.setTag(2131370950, Integer.valueOf(1));
        break;
      }
      if (paramagoe.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramagoe.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramagoe.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramagoe.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramagoe.jdField_d_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramagoe.jdField_d_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      if (paramagoe.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramagoe.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      paramagoe.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
      paramagoe.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
      paramagoe.jdField_b_of_type_AndroidViewView.setTag(2131370950, Integer.valueOf(3));
      break;
    }
  }
  ...
  public void a(PersonalityLabelInfo paramPersonalityLabelInfo)
  {
    ...
    localBundle.putString("key_title", this.a.getString(2131432705));
  ...
  void a(PersonalityLabelInfo paramPersonalityLabelInfo, agoe paramagoe)
  {
    String str = paramagoe.jdField_b_of_type_AndroidWidgetTextView.getText().toString();
    if (paramPersonalityLabelInfo.praiseCount > 0L)
    {
      ...
      if (!TextUtils.equals(paramPersonalityLabelInfo, str)) {
        paramagoe.jdField_b_of_type_AndroidWidgetTextView.setText(paramPersonalityLabelInfo);
      }
      paramPersonalityLabelInfo = paramagoe.jdField_b_of_type_AndroidWidgetTextView;
      if (!this.a.jdField_b_of_type_Boolean) {
        break label375;
      }
    }
    ...
    for (float f = 0.5F;; f = 1.0F)
    {
      ...
      return;
      paramPersonalityLabelInfo = this.a.getResources().getString(2131439085);
      break;
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.a.getLayoutInflater().inflate(2130970510, paramViewGroup, false);
      paramViewGroup = new agoe(null);
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131370955);
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370945));
      paramViewGroup.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131370949);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131370950));
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131370951));
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362740));
      paramViewGroup.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131370952));
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView = ((GlowCountRecyclerView)paramView.findViewById(2131363008));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370954));
      paramViewGroup.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131370530);
      paramViewGroup.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131362841);
      paramViewGroup.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
      paramViewGroup.jdField_c_of_type_AndroidViewView.setTag(2131370950, Integer.valueOf(5));
      if (!PersonalityLabelGalleryActivity.a(this.a)) {
      ...
      localObject1 = new agod(this.a, null);
      ...
      localObject2 = (Integer)paramViewGroup.jdField_a_of_type_AndroidViewView.getTag(2131370945);
      if ((localObject2 == null) || (((Integer)localObject2).intValue() != ((PersonalityLabelInfo)localObject1).bgColor))
      {
        ...
        paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(2131370945, Integer.valueOf(((PersonalityLabelInfo)localObject1).bgColor));
      }
      ...
      paramViewGroup.jdField_b_of_type_AndroidViewView.setTag(2131370954, paramViewGroup);
      if (!PersonalityLabelGalleryActivity.a(this.a))
      {
        if (((PersonalityLabelInfo)localObject1).praiseFlag <= 0) {
          break label820;
        }
        paramViewGroup.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130842972);
      }
      if (PersonalityLabelGalleryActivity.a(this.a))
      {
        ...
        paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setTag(2131370950, Integer.valueOf(2));
      }
      ...
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.setAdapter(new agol(this.a, ((PersonalityLabelInfo)localObject1).id));
      ...
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.setOnScrollListener(new agog(this, (PersonalityLabelInfo)localObject1));
      label684:
    ...
    for (paramInt = i;; paramInt = -2)
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilHashSet.size() > 0) {
        this.a.jdField_b_of_type_AndroidOsHandler.post(new agoh(this));
      }
      return paramView;
      paramViewGroup = (agoe)paramView.getTag();
      break;
      paramViewGroup.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130842960);
      break label435;
      bool1 = false;
      break label524;
      paramInt = 8;
  ...
  {
    Object localObject1 = paramView.getTag(2131370950);
    int i;
    if ((localObject1 != null) && ((localObject1 instanceof Integer)))
    {
      ...
      if (localObject1 != null)
      {
        ...
        paramView.c("从空间相册选择");
        paramView.d("取消");
        paramView.a(new agoi(this, (PersonalityLabelInfo)localObject1, paramView));
        paramView.show();
    ...
    for (;;)
    {
      ...
      for (localObject1 = ((PersonalityLabelZan)localObject2).nick;; localObject1 = ContactUtils.a(this.a.app, this.a.app.getCurrentAccountUin()))
      {
        ...
        a(localPersonalityLabelInfo, (agoe)paramView.getTag(2131370954));
        ((ImageView)paramView.findViewById(2131370952)).setImageResource(2130842972);
      ...
      if (i == 4)
      {
        ...
        {
          DialogUtil.a(this.a, (String)localObject1, 2131433015, 2131434739, new agoj(this, paramView, (PersonalityLabelInfo)localObject2), new agok(this)).show();
          return;
        }
      }
      if (i != 5) {
