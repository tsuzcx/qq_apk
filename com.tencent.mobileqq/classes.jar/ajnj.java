...
public class ajnj
{
  ...
  WeakReference<ajnk> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, Runnable paramRunnable1, Runnable paramRunnable2)
  {
    ...
    do
    {
      ...
      if (VersionUtils.isM())
      {
        ...
        localajnl.jdField_a_of_type_JavaLangRunnable = paramRunnable1;
        localajnl.jdField_b_of_type_JavaLangRunnable = paramRunnable2;
        localajnl.jdField_a_of_type_Int = 1;
        paramQQAppInterface.a().a(paramActivity, localajnl, null, new String[] { "android.permission.READ_CONTACTS", "android.permission.WRITE_CONTACTS", "android.permission.GET_ACCOUNTS" });
        return;
      }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Ajnl.jdField_b_of_type_Int = a();
      QLog.d("contact.PermissionChecker", 1, "onPermissionResult = " + this.jdField_a_of_type_Ajnl.jdField_b_of_type_Int);
      ...
      localajnk.a(paramBoolean, this.jdField_a_of_type_Ajnl);
    }
    for (;;)
    {
      this.jdField_a_of_type_Ajnl = null;
      return;
      label78:
      localajnk = (ajnk)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      break;
      label92:
      this.jdField_a_of_type_Ajnl.a(paramBoolean);
    }
  }
  ...
  public void a(Activity paramActivity, ajnl paramajnl, ajnk paramajnk, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramActivity = paramajnl;
        if (paramajnl == null) {
          paramActivity = new ajnl();
        }
        paramajnl = new StringBuilder(512);
        ...
        if (i < j)
        {
          ...
          paramajnl.append(str).append(",");
          i += 1;
        }
        else
        {
          paramActivity.jdField_a_of_type_JavaUtilList = localArrayList;
          this.jdField_a_of_type_Ajnl = paramActivity;
          this.jdField_a_of_type_JavaLangRefWeakReference = null;
          if (paramajnk != null) {
            this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramajnk);
          }
          QLog.d("contact.PermissionChecker", 1, "requestPermissions = " + paramajnl.toString());
