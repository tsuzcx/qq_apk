  ...
  implements View.OnClickListener
{
  ...
  public ajnj(View paramView)
  {
    super(paramView);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368452));
    this.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox = ((NumberCheckBox)paramView.findViewById(2131364467));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368484));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368453));
    this.jdField_b_of_type_ComTencentMobileqqWidgetNumberCheckBox = ((NumberCheckBox)paramView.findViewById(2131364468));
    this.d = ((ImageView)paramView.findViewById(2131368485));
    this.e = ((ImageView)paramView.findViewById(2131368454));
    this.jdField_c_of_type_ComTencentMobileqqWidgetNumberCheckBox = ((NumberCheckBox)paramView.findViewById(2131364469));
    this.f = ((ImageView)paramView.findViewById(2131368486));
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Ajni != null) {
      this.jdField_a_of_type_Ajni.a(((Integer)this.itemView.getTag()).intValue(), paramView.getId());
    }
