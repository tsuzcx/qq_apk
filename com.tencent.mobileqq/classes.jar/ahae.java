...
public class ahae
{
  private static ahae jdField_a_of_type_Ahae;
  ...
  private Map<String, ahac> jdField_a_of_type_JavaUtilMap = new HashMap();
  private volatile boolean jdField_a_of_type_Boolean;
  
  public static ahae a()
  {
    if (jdField_a_of_type_Ahae == null) {}
    try
    {
      if (jdField_a_of_type_Ahae == null) {
        jdField_a_of_type_Ahae = new ahae();
      }
      return jdField_a_of_type_Ahae;
    }
    finally {}
  }
  
  private void a(ahac paramahac, String paramString, boolean paramBoolean)
  {
    if ((paramahac == null) || (TextUtils.isEmpty(paramString)) || (paramahac.a == null)) {
      return;
    }
    int i = 0;
    label22:
    ahad localahad;
    if (i < paramahac.a.size())
    {
      localahad = (ahad)paramahac.a.valueAt(i);
      if ((localahad != null) && (!TextUtils.isEmpty(localahad.a))) {
        break label73;
      }
    }
    for (;;)
    {
      ...
      break;
      label73:
      if (localahad.a.equalsIgnoreCase(paramString)) {
        localahad.a(paramBoolean);
      }
    }
  }
  ...
  private void b(QQAppInterface paramQQAppInterface, ahac paramahac)
  {
    if ((paramahac == null) || (paramahac.a == null) || (paramahac.a.size() == 0))
    {
      b(paramQQAppInterface);
      return;
    }
    paramQQAppInterface = new ahaf(this, paramQQAppInterface, paramahac, paramahac.a.size());
    int i = 0;
    label47:
    ahad localahad;
    if (i < paramahac.a.size())
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentComponentNetworkDownloaderDownloader != null) {
        this.jdField_a_of_type_ComTencentComponentNetworkDownloaderDownloader.download(localahad.a, localahad.c, false, paramQQAppInterface);
      }
    }
  }
  
  public ahac a(String paramString)
  {
    ...
    {
      paramString = (ahac)this.jdField_a_of_type_JavaUtilMap.get(paramString);
      return paramString;
    }
  }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    SharedPreferences.Editor localEditor = auem.a().edit();
  ...
  public void a(QQAppInterface paramQQAppInterface, ahac paramahac)
  {
    if (paramQQAppInterface == null)
    {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_JavaUtilMap.put(str, paramahac);
    }
    if (paramahac.b())
    {
    ...
    b(paramQQAppInterface, paramahac);
  }
  ...
  {
    long l = auem.a().getLong("qbossNextRequestTime_" + paramInt, 0L);
