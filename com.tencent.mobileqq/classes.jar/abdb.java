...
public class abdb
{
  ...
  public abdb()
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new abdc(this);
    this.jdField_a_of_type_MqqAppAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    this.c = false;
  }
  
  public abdb(Activity paramActivity)
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new abdc(this);
  ...
  public abdb(Activity paramActivity, abdd paramabdd)
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new abdc(this);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Abdd = paramabdd;
    if ((this.jdField_a_of_type_AndroidAppActivity instanceof AppActivity))
    {
      this.jdField_a_of_type_MqqAppAppRuntime = ((AppActivity)this.jdField_a_of_type_AndroidAppActivity).getAppRuntime();
      this.c = true;
  ...
  public static String a(Resources paramResources, LightAppSettingInfo paramLightAppSettingInfo, String paramString)
  {
    ...
    {
      str = paramResources.getString(2131691420);
    }
    if ((!TextUtils.isEmpty(paramLightAppSettingInfo.b)) && (!TextUtils.isEmpty(paramLightAppSettingInfo.jdField_a_of_type_JavaLangString)) && (biam.a(paramLightAppSettingInfo.b))) {
      return paramResources.getString(2131691422, new Object[] { str });
    }
    return paramResources.getString(2131691421, new Object[] { str });
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    {
      biam.a(paramActivity, paramString1);
      return;
    }
    ...
    bhwo.b(paramActivity, localBundle);
  }
  ...
  private void d()
  {
    ...
    {
      abdn.a((String)localObject, localBundle, this.jdField_a_of_type_MqqAppAppRuntime, this.jdField_a_of_type_MqqObserverBusinessObserver);
      return;
    }
  }
  ...
  public LightAppSettingInfo a(DeviceInfo paramDeviceInfo)
  {
    ...
    if (localLightAppSettingInfo2 == null)
    {
      ...
      if (!this.c)
      {
        ...
        {
          a(((aara)((QQAppInterface)localAppRuntime).getBusinessHandler(51)).a());
  ...
  public void a()
  {
    ...
    {
      localObject1 = ((aara)((QQAppInterface)localObject1).getBusinessHandler(51)).a();
  ...
  public void a(DeviceInfo paramDeviceInfo, Bundle paramBundle, boolean paramBoolean)
  {
    if (paramDeviceInfo == null)
    {
      if (this.jdField_a_of_type_Abdd != null) {
        this.jdField_a_of_type_Abdd.a(false);
      }
      return;
    }
    if (paramBundle != null) {}
    for (boolean bool = paramBundle.getBoolean("showProgress", true);; bool = true)
    {
      ...
      for (;;)
      {
        if ((str == null) && (0 == 0))
        {
          ...
          abdm.a(null, "Net_LiteApp_Setting", 0, 1, localLightAppSettingInfo.jdField_c_of_type_Int);
          if (str != null) {
            break label713;
          }
          ...
          this.jdField_a_of_type_Abdd.a(true);
          return;
        ...
        for (Intent localIntent = new Intent();; localIntent = null)
        {
          ...
          for (;;)
          {
            ...
            break;
            localIntent.putExtra("uinname", abdn.a(paramDeviceInfo));
          }
          label713:
          ...
          bkxa.a().a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_MqqAppAppRuntime, this.jdField_a_of_type_MqqAppAppRuntime.getAccount(), paramDeviceInfo, str, -1, null, SmartDevicePluginProxyActivity.class);
          break label247;
          label794:
          break;
          ...
          bhzt.a().a(2131691425);
          if ((this.jdField_a_of_type_Bhht != null) && (!this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
  ...
  protected void b()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Bhht.c(2131691424);
      this.jdField_a_of_type_Bhht.show();
    }
    while (this.jdField_a_of_type_MqqAppAppRuntime == null)
    {
      bhzm.d("LightAppUtil", "app == null when dologin");
      if (this.jdField_a_of_type_Abdd != null) {
        this.jdField_a_of_type_Abdd.a(false);
      }
      return;
