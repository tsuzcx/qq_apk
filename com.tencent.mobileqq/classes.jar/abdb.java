  ...
  extends VasWebviewJsPlugin
{
  ...
  private boolean a(String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramVarArgs = arph.a("ipc_cmd_share_robot_card", (String)localObject, this.mOnRemoteResp.key, localBundle);
      arui.a().a(paramVarArgs);
      return true;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject != null)
        {
          ...
          paramVarArgs = arph.a("ipc_cmd_invoke_robot_function", (String)localObject, this.mOnRemoteResp.key, localBundle);
          arui.a().a(paramVarArgs);
          return true;
        }
      }
  ...
  private boolean c(String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramVarArgs = arph.a("ipc_cmd_robot_member_change_function", (String)localObject, this.mOnRemoteResp.key, localBundle);
      arui.a().a(paramVarArgs);
      return true;
    }
    catch (JSONException paramVarArgs)
  ...
  public void onResponse(Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        bfpx.a(null, (Activity)localObject1, null, paramBundle.getString("robotuin"), paramBundle.getString("robotname"), 21);
        return;
      ...
      if (i == 1)
      {
        bfpx.a(localActivity, str5, (String)localObject1, str4, (String)localObject2, paramBundle, str1, str3, str2, i);
        return;
      }
    } while (i != 0);
    bfpx.a(localActivity, (String)localObject1, null, str4, (String)localObject2, paramBundle, str1, str3, str2, i);
  }
}
