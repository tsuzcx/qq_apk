...
public class abro
{
  ...
  @Nullable
  private static volatile abro jdField_a_of_type_Abro;
  @Nullable
  private static volatile abrr jdField_a_of_type_Abrr;
  @NonNull
  private static abru jdField_a_of_type_Abru = new abru();
  public static Vector<abrr> a;
  private static final String b;
  public static Vector<abrw> b;
  public String a;
  ...
  @Nullable
  public static abro a()
  {
    if (jdField_a_of_type_Abro == null) {}
    try
    {
      if (jdField_a_of_type_Abro == null) {
        jdField_a_of_type_Abro = new abro();
      }
      return jdField_a_of_type_Abro;
    }
    finally {}
  }
  ...
  private abrq a()
  {
    abrq localabrq = new abrq(this, null);
    try
    {
      long[] arrayOfLong = jdField_a_of_type_Abru.a();
      if (arrayOfLong != null)
      {
        abrq.a(localabrq, arrayOfLong[0]);
        abrq.b(localabrq, arrayOfLong[1]);
        abrq.c(localabrq, arrayOfLong[2]);
        abrq.d(localabrq, arrayOfLong[4]);
      }
    }
    catch (Exception localException)
    {
  ...
  private ArrayList<Double> a(int paramInt)
  {
    ...
    //   135: dload_2
    //   136: dstore 8
    //   138: getstatic 56	abro:jdField_b_of_type_JavaLangString	Ljava/lang/String;
  ...
  private abrr b()
  {
    ...
    localabrr.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    localabrr.f = System.currentTimeMillis();
    localabrr.jdField_a_of_type_Long = (localabrr.f / 1000L);
    Object localObject = a();
    long l1;
    label84:
    label106:
    double d;
    if (abrq.a((abrq)localObject) > 0L)
    {
      l1 = abrq.a((abrq)localObject);
      localabrr.c = l1;
      if (abrq.b((abrq)localObject) <= 0L) {
        break label385;
      }
      l1 = abrq.b((abrq)localObject);
      localabrr.d = l1;
      if (abrq.c((abrq)localObject) <= 0L) {
        break label392;
      }
      l1 = abrq.c((abrq)localObject);
      localabrr.e = l1;
      if ((jdField_a_of_type_Long == 0L) || (abrq.d((abrq)localObject) == 9223372036854775807L)) {
        break label399;
      }
      l1 = abrq.d((abrq)localObject) * jdField_a_of_type_Long;
      label142:
      localabrr.jdField_b_of_type_Long = l1;
      if (jdField_a_of_type_Abrr == null) {
        break label462;
      }
      jdField_a_of_type_Abrr.f = localabrr.f;
      jdField_a_of_type_Abrr.jdField_a_of_type_Long = localabrr.jdField_a_of_type_Long;
      if ((jdField_a_of_type_Abrr.c == 9223372036854775807L) || (jdField_a_of_type_Abrr.d == 9223372036854775807L) || (jdField_a_of_type_Abrr.e == 9223372036854775807L)) {
        break label416;
      }
      l1 = localabrr.c;
      long l2 = jdField_a_of_type_Abrr.c;
      long l3 = localabrr.d - jdField_a_of_type_Abrr.d;
      long l4 = localabrr.e;
      long l5 = jdField_a_of_type_Abrr.e;
      if (l3 > 0L)
      {
        localabrr.jdField_a_of_type_Double = ((l1 - l2) * 1.0D / l3);
        localabrr.jdField_b_of_type_Double = (1.0D * (l4 - l5) / l3);
      }
      if (localabrr.jdField_a_of_type_Double <= 0.0D) {
        break label406;
      }
      d = localabrr.jdField_a_of_type_Double;
      label314:
      localabrr.jdField_a_of_type_Double = d;
      if (localabrr.jdField_b_of_type_Double <= 0.0D) {
        break label411;
      }
      d = localabrr.jdField_b_of_type_Double;
      label336:
      localabrr.jdField_b_of_type_Double = d;
    }
    for (;;)
    {
      jdField_a_of_type_Abrr.c = localabrr.c;
      jdField_a_of_type_Abrr.d = localabrr.d;
      jdField_a_of_type_Abrr.e = localabrr.e;
      return localabrr;
      ...
      localabrr.jdField_b_of_type_Double = ((Double)((ArrayList)localObject).get(0)).doubleValue();
      localabrr.jdField_a_of_type_Double = ((Double)((ArrayList)localObject).get(1)).doubleValue();
    }
    label462:
    jdField_a_of_type_Abrr = new abrr();
    jdField_a_of_type_Abrr.f = localabrr.f;
    jdField_a_of_type_Abrr.jdField_a_of_type_Long = localabrr.jdField_a_of_type_Long;
    jdField_a_of_type_Abrr.c = localabrr.c;
    jdField_a_of_type_Abrr.d = localabrr.d;
    jdField_a_of_type_Abrr.e = localabrr.e;
    localabrr.jdField_a_of_type_Double = 0.0D;
    localabrr.jdField_b_of_type_Double = 0.0D;
    return localabrr;
  }
  ...
  public abrr a()
  {
    abrr localabrr = b();
    if (localabrr != null) {
      jdField_a_of_type_JavaUtilVector.add(localabrr);
    }
    return localabrr;
  }
}
