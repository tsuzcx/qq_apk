...
public class akju
{
  private static SparseArray<Class<? extends RecentBaseData>> jdField_a_of_type_AndroidUtilSparseArray = new akjv();
  ...
  private static RecentBaseData a(RecentUser paramRecentUser, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    } while ((!bkwm.a(paramQQAppInterface)) || (bkwm.c()));
  ...
  public static RecentBaseData a(RecentUser paramRecentUser, QQAppInterface paramQQAppInterface, Context paramContext, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        akmb.a(paramQQAppInterface.getApp(), false, paramRecentUser);
  ...
  public static void a(List<RecentUser> paramList, QQAppInterface paramQQAppInterface, Context paramContext, List<RecentBaseData> paramList1, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        bjun.a(((RecentUser)localObject2).uin);
        bfzg.a(null, "Recent_LoadData_conv_uin_record");
        String str = akla.a(((RecentUser)localObject2).uin, ((RecentUser)localObject2).getType());
        Object localObject1 = akla.a().a(str);
        if (localObject1 == null)
        {
          bfzg.a(null, "Recent_LoadData_build_item");
          localObject2 = a((RecentUser)localObject2, paramQQAppInterface, paramContext);
          bfzg.a("Recent_LoadData_build_item", null);
          localObject1 = localObject2;
          if (localObject2 != null)
          {
            akla.a().a((RecentBaseData)localObject2, str);
            localObject1 = localObject2;
          }
          bfzg.a("Recent_LoadData_conv_uin_record", null);
          if (localObject1 != null) {
        ...
        else
        {
          ...
          bfzg.a(null, "Recent_LoadData_update");
          try
          {
            ((RecentBaseData)localObject1).update(paramQQAppInterface, paramContext);
            bfzg.a("Recent_LoadData_update", null);
          }
          catch (Throwable paramList)
          {
            akmb.a(paramContext, false, paramList);
  ...
  private static RecentBaseData b(RecentUser paramRecentUser, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    while ((TextUtils.equals(paramRecentUser.uin, AppConstants.NEW_KANDIAN_UIN)) && (bkwm.a(paramQQAppInterface))) {
      return null;
    }
