...
public class bkbd
{
  ...
  public static Map<String, String> a()
  {
    try
    {
      Map localMap = a(new FileInputStream("/proc/cpuinfo"), new bkbe());
      return localMap;
    }
  ...
  /* Error */
  private static Map<String, String> a(InputStream paramInputStream, bkbg parambkbg)
  {
    // Byte code:
  ...
  private static void a(Set<String> paramSet, Map<String, String> paramMap)
  {
    ...
    //   57: dup
    //   58: invokestatic 93	bkbd:d	()Ljava/lang/String;
  ...
  private static boolean a()
  {
    ...
    return (bgjq.a()) && (!localFile.exists());
  }
  ...
  private static String b(Map<String, String> paramMap, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        paramMap = Long.toString(bgln.d());
      }
      else if (paramString.equals("ts"))
      {
        paramMap = Long.toString(bgln.b()[0]);
      }
  ...
  private static Map<String, String> b()
  {
    ...
    {
      return localHashMap;
      a(a(localInputStream, new bkbf()), localHashMap);
  ...
  private static void b()
  {
    ...
    bkac.b(localStringBuilder.toString().substring(1), 110);
  }
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null) {
        try
        {
          ...
          localObject = Base64.encodeToString((bgln.c() + "_" + Long.toString(l ^ 0xADCD123)).getBytes(), 2);
          return localObject;
        }
        catch (Exception localException) {}
      }
