  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg != null)
    {
      ...
      paramIntent = bgbq.a(paramFromServiceMsg.getWupBuffer());
      if (paramIntent == null) {
        break label68;
      }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    bgbq localbgbq = new bgbq(l, i, j, paramIntent.getIntExtra("code", 0), (String)localObject);
    localObject = localbgbq.encode();
    paramIntent = (Intent)localObject;
    if (localObject == null)
    {
      QLog.e("QbossErrorReportServlet", 1, "onSend request encode result is null.cmd=" + localbgbq.uniKey());
      paramIntent = new byte[4];
    }
    paramPacket.setTimeout(60000L);
    paramPacket.setSSOCommand("SQQzoneSvc." + localbgbq.uniKey());
