...
public class abcr
  implements View.OnClickListener, bipl
{
  ...
  public abcr(AppInterface paramAppInterface, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_MqqObserverBusinessObserver = new abcu(this);
    this.jdField_a_of_type_AndroidOsHandler = new abcv(this);
    ...
    if ((paramActivity instanceof bhni)) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference((bhni)paramActivity);
    }
    while (this.jdField_a_of_type_JavaLangRefWeakReference == null)
    {
      QLog.e(jdField_a_of_type_JavaLangString, 2, "Error! mWebUiUtils still null! " + paramActivity.toString());
      return;
      if ((paramActivity instanceof bhne))
      {
        paramAppInterface = ((bhne)paramActivity).a();
    ...
    paramAppInterface = (bhni)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((paramAppInterface != null) && ((paramAppInterface instanceof bhsx)))
    {
      this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = ((bhsx)paramAppInterface).getWebView();
      if (QLog.isColorLevel())
      {
  ...
  public static final String a(List<abcw> paramList, int paramInt)
  {
    ...
    label270:
    label276:
    for (localObject2 = (abcw)paramList.get(i1);; localObject3 = localObject1)
    {
      try
      {
        int i3 = Integer.valueOf(((abcw)localObject2).b.get()).intValue();
        if (i3 >= paramInt)
        {
          localObject2 = ((abcw)localObject2).a.get();
          localObject1 = localObject2;
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ...
            if (localObject2 == null)
            {
              ...
              localObject2 = (abcw)paramList.get(i1);
            }
          }
          i1 += 1;
        }
      ...
      catch (NumberFormatException localNumberFormatException1)
      {
        try
        {
          i2 = Integer.valueOf(((abcw)localObject2).b.get()).intValue();
          if (i2 >= paramInt) {
            break label267;
          }
          localObject2 = ((abcw)localObject2).a.get();
  ...
  public static List<abcw> a(PBRepeatMessageField<GetAppInfoProto.MsgIconsurl> paramPBRepeatMessageField)
  {
    if ((paramPBRepeatMessageField != null) && (!paramPBRepeatMessageField.isEmpty()))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        paramPBRepeatMessageField.add(new abcw(localMsgIconsurl.url, localMsgIconsurl.size));
      }
  ...
  private void a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, Bitmap paramBitmap)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        ((Bundle)localObject2).putString("intext_3", "" + bipo.b(paramInt));
        ((Bundle)localObject2).putString("intext_2", "" + i2);
        ((Bundle)localObject2).putString("stringext_1", paramString3);
        bipi.a().a((Bundle)localObject2, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      }
      ...
      ((Bundle)localObject1).putLong("share_begin_time", bhpv.jdField_b_of_type_Long);
      if (!(this.jdField_a_of_type_AndroidAppActivity instanceof bhne)) {
        break label3714;
      }
      paramString1 = ((bhne)this.jdField_a_of_type_AndroidAppActivity).a();
    ...
    for (;;)
    {
      if ((paramInt != 0) || (!bltb.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_b_of_type_AndroidAppActivity, (Bundle)localObject1, null))) {
        zvc.a(1, 2131689486);
      }
      return;
      ...
      if (paramInt == 1)
      {
        ...
        if ((this.jdField_a_of_type_AndroidAppActivity instanceof bhne))
        {
          paramBitmap = ((bhne)this.jdField_a_of_type_AndroidAppActivity).a();
          if ((paramBitmap == null) || (paramBitmap.getComponentProvider() == null)) {
            break label3704;
          }
          localObject1 = (bhpv)paramBitmap.getComponentProvider().a(4);
          if (localObject1 == null) {
            break label3704;
          }
          paramBitmap = ((bhpv)localObject1).a();
          localObject1 = ((bhpv)localObject1).jdField_e_of_type_JavaLangString;
        }
      }
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            catch (Exception paramBitmap)
            {
              ...
              localObject4 = ((Resources)localObject9).getString(2131695713);
              continue;
              paramBitmap = "plugin";
            ...
            if ((this.jdField_a_of_type_AndroidAppActivity instanceof PublicAccountBrowser))
            {
              ...
              if ((TextUtils.isEmpty(str2)) || (TextUtils.isEmpty((CharSequence)localObject4))) {
                if (jdField_f_of_type_Boolean)
                {
                  ...
                  if (paramInt != 0)
                  {
                    localObject4 = this.jdField_b_of_type_AndroidAppActivity.getString(2131695717);
                  ...
                  bgsc.a(this.jdField_a_of_type_AndroidAppActivity, 1001, 146, "web_share", str2, paramString4, paramString1, paramString2, String.format(((Resources)localObject9).getString(2131695697), new Object[] { paramString1 }), paramString3, "web", null, null, null, paramBitmap, null, (String)localObject1, (String)localObject2, (String)localObject3, (String)localObject4, "", localIntent, -1, null, -1L);
                  i1 = 0;
                  if (TextUtils.isEmpty(paramString4)) {
                    i1 = 1;
                  }
                  ...
                  bipi.a().a(paramString1, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
                  return;
                  localIntent.putExtra("isWebCompShare", true);
            ...
            for (;;)
            {
              ...
              for (localObject1 = "https://qzonestyle.gtimg.cn/qzone/phone/n/QQ-Qzone-Android/logo_16.png";; localObject1 = paramBitmap)
              {
                ...
                if ((this.jdField_a_of_type_AndroidAppActivity instanceof bhne))
                {
                  localObject8 = ((bhne)this.jdField_a_of_type_AndroidAppActivity).a();
                  paramBitmap = (Bitmap)localObject6;
                ...
                label1942:
                if (bdjg.a(paramString3))
                {
                  localObject7 = "web";
                  localObject4 = anni.a(2131712635);
                  if (TextUtils.isEmpty(arag.a().h()))
                  {
                    localObject1 = bdjg.jdField_b_of_type_JavaLangString;
                    label1980:
                    localObject2 = bdjg.jdField_d_of_type_JavaLangString;
                    paramInt = 95;
                    l1 = bdjg.jdField_a_of_type_Long;
                ...
                for (;;)
                {
                  if ((bool2) || (bool1))
                  {
                    ...
                    localObject8 = this.jdField_b_of_type_AndroidAppActivity.getString(2131695697, new Object[] { paramString1 });
                  ...
                  for (i2 = -1;; i2 = 1001)
                  {
                    bgsc.a((Context)localObject7, i1, paramInt, "web_share", paramBitmap, paramString4, paramString1, paramString2, (String)localObject8, paramString3, "web", null, null, null, (String)localObject1, null, (String)localObject5, (String)localObject3, (String)localObject2, (String)localObject4, "", localIntent, i2, (String)localObject6, l1);
                    break;
                    localObject2 = this.jdField_b_of_type_AndroidAppActivity.getString(2131695713);
                  ...
                  if ((paramInt == 3) || (paramInt == 4)) {
                    if (paramInt == 3)
                    {
                      ...
                      {
                        this.jdField_a_of_type_Bihh = new abct(this, paramString3);
                        WXShareHelper.a().a(this.jdField_a_of_type_Bihh);
                      }
                      this.o = String.valueOf(System.currentTimeMillis());
                      if ((TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString)) || (!bdjg.jdField_b_of_type_JavaUtilMap.containsKey(this.jdField_f_of_type_JavaLangString))) {
                        break label2586;
                      }
                      paramString4 = (Integer)bdjg.jdField_b_of_type_JavaUtilMap.get(this.jdField_f_of_type_JavaLangString);
                  ...
                  for (;;)
                  {
                    ...
                    if ((paramString3 != null) && (paramString3.contains("docs.qq.com/")))
                    {
                      if (paramInt == 3)
                      {
                        ...
                        if ((a() != null) && (a().l != null))
                        {
                          ...
                          paramString1 = bdjg.a(this.jdField_g_of_type_JavaLangString);
                          if ((TextUtils.isEmpty(this.jdField_g_of_type_JavaLangString)) || (!bdjg.d(this.jdField_g_of_type_JavaLangString))) {
                            break label2664;
                          }
                          if (paramString1 == null) {
                            break label2655;
                    ...
                    if (paramInt == 5)
                    {
                      ...
                      {
                        bcst.b(null, "CliOper", "", "", "0X8006277", "0X8006277", 0, 0, "", "", "", "");
                      ...
                      if (bmqg.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_b_of_type_AndroidAppActivity, (Bundle)localObject1, null, 0)) {
                        break;
                      }
                      zvc.a(1, 2131689486);
                      return;
                    ...
                    {
                      bjft.a(this.jdField_a_of_type_AndroidAppActivity, paramInt, paramString1, paramString2, paramString3, paramString4, "", 0, false);
                      return;
                    }
                    if (paramInt == 8)
                    {
                      ...
                      catch (PackageManager.NameNotFoundException paramString2)
                      {
                        for (;;)
                        {
                          ...
                          {
                            Toast.makeText(BaseApplicationImpl.getContext(), anni.a(2131712636), 1).show();
                    ...
                    if ((this.jdField_a_of_type_AndroidAppActivity instanceof FastWebActivity))
                    {
                      ...
                      pvl.a().a(this.jdField_a_of_type_AndroidAppActivity, null, 1, this.x, this.jdField_e_of_type_JavaLangString, this.h, this.i, this.w, paramString3);
                      bljv.a(paramString2, 42, 2);
                      return;
                    }
                    if ((this.jdField_a_of_type_AndroidAppActivity instanceof bhne))
                    {
  ...
  {
    Bundle localBundle = bgou.a(paramString2, paramString3, "0.0.0.1", paramString4, this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().scaledDensity, null, null);
  ...
  public static final void a(AppInterface paramAppInterface, Context paramContext, String paramString1, long paramLong1, long paramLong2, BusinessObserver paramBusinessObserver, String paramString2)
  {
    ...
    localGetAppinfoRequest.qqv.set("8.4.1");
    ...
    paramContext = new NewIntent(paramContext, biqf.class);
  ...
  public static List<abcw> b(PBRepeatMessageField<appType.MsgIconsurl> paramPBRepeatMessageField)
  {
    if ((paramPBRepeatMessageField != null) && (!paramPBRepeatMessageField.isEmpty()))
    {
      Object localObject = paramPBRepeatMessageField.get();
  ...
  private void b(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    {
      if (((paramString.length() > 180) || ((!(this.jdField_a_of_type_AndroidAppActivity instanceof PublicAccountBrowser)) && (paramString.length() > 60))) && (!(this.jdField_a_of_type_AndroidAppActivity instanceof TeamWorkDocEditBrowserActivity)) && (!bdjg.a(paramString))) {
  ...
  public bdhj a()
  {
    return this.jdField_a_of_type_Bdhj;
  }
  ...
  public biau a()
  {
    ...
    if (this.jdField_a_of_type_Biau == null)
    {
      ...
      localbhni = (bhni)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((localbhni == null) || (!(localbhni instanceof bhsw)) || (this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
        break label134;
      }
      i1 = ((bhsw)localbhni).getTitleBarHeight();
    }
    for (;;)
    {
      this.jdField_a_of_type_Biau = new biau(this.jdField_a_of_type_AndroidAppActivity, i1);
      this.jdField_a_of_type_Biau.c(2131689482);
      ...
      {
        i1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298998);
      }
      else
      {
  ...
  public String a()
  {
    ...
    for (;;)
    {
      if (TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
        {
          localObject = (bhni)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if ((localObject != null) && ((localObject instanceof bhsx))) {
            localObject = ((bhsx)localObject).getCurrentUrl();
          }
        }
      }
      else
      {
        return nmj.a((String)localObject, new String[0]);
      }
      localObject = "";
    }
  }
  ...
  void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131369385));
    ...
    do
    {
      do
      {
        ...
        this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131369386);
        this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
        a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_AndroidAppActivity, this.n, bgkh.b(this.jdField_a_of_type_Long), 0L, this.jdField_a_of_type_MqqObserverBusinessObserver);
        ...
        this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130842023);
        localObject1 = new LinearLayout.LayoutParams((int)mue.a(this.jdField_a_of_type_AndroidContentContext, 19.0F), (int)mue.a(this.jdField_a_of_type_AndroidContentContext, 19.0F));
        this.jdField_b_of_type_AndroidWidgetLinearLayout = new LinearLayout(this.jdField_a_of_type_AndroidContentContext);
        localObject2 = new LinearLayout.LayoutParams(-2, -2);
        this.jdField_b_of_type_AndroidWidgetLinearLayout.setPadding((int)mue.a(this.jdField_a_of_type_AndroidContentContext, 10.0F), 0, (int)mue.a(this.jdField_a_of_type_AndroidContentContext, 10.0F), 0);
        ...
        this.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130840327);
        localObject1 = new LinearLayout.LayoutParams((int)mue.a(this.jdField_a_of_type_AndroidContentContext, 30.0F), (int)mue.a(this.jdField_a_of_type_AndroidContentContext, 30.0F));
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setPadding((int)mue.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), 0, (int)mue.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), 0);
        this.jdField_a_of_type_AndroidWidgetTextView.setSingleLine(true);
        this.jdField_a_of_type_AndroidWidgetTextView.setEllipsize(TextUtils.TruncateAt.END);
        localObject1 = new LinearLayout.LayoutParams(-2, -2);
        ((LinearLayout.LayoutParams)localObject1).weight = 1.0F;
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131690053);
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130841816);
        ...
        localObject1 = new LinearLayout.LayoutParams((int)mue.a(this.jdField_a_of_type_AndroidContentContext, 56.0F), (int)mue.a(this.jdField_a_of_type_AndroidContentContext, 30.0F));
        ((LinearLayout.LayoutParams)localObject1).rightMargin = ((int)mue.a(this.jdField_a_of_type_AndroidContentContext, 10.0F));
        ...
        localObject1 = new FrameLayout.LayoutParams(-1, (int)mue.a(this.jdField_a_of_type_AndroidContentContext, 44.0F));
        ((FrameLayout.LayoutParams)localObject1).gravity = 80;
        ((FrameLayout.LayoutParams)localObject1).bottomMargin = ((int)mue.a(this.jdField_a_of_type_AndroidContentContext, 50.0F));
      } while (!(this.jdField_a_of_type_AndroidAppActivity instanceof bhne));
      localObject2 = ((bhne)this.jdField_a_of_type_AndroidAppActivity).a();
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    try
    {
      ...
      for (;;)
      {
        if ((paramInt3 == 1) && ((paramInt2 == 0) || (paramInt2 == 1)) && (this.jdField_a_of_type_Bdhj != null)) {
  ...
  public void a(Context paramContext, GetAppInfoProto.GetAppinfoResponse paramGetAppinfoResponse)
  {
    ...
    try
    {
      if ((paramGetAppinfoResponse.has()) && (paramGetAppinfoResponse.ret.get() == 0))
      {
        ...
        {
          arrayOfByte = nlw.a(paramContext, paramGetAppinfoResponse, "GET", null, null);
          if (arrayOfByte == null)
          {
            if (!QLog.isColorLevel()) {
              return;
    ...
    catch (Exception paramContext)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        catch (OutOfMemoryError localOutOfMemoryError)
        {
          ...
          paramContext = nlw.a(paramContext, String.format("https://openmobile.qq.com/api/get_app_info_by_id?appid=%d", new Object[] { Long.valueOf(bgkh.b(this.jdField_a_of_type_Long)) }), "GET", null, null);
        ...
        if (bgnw.a(paramContext, localAndroidInfo.packName.get()))
        {
          paramContext = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1001);
          try
          {
  ...
  public void a(bhni parambhni)
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference == null) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambhni);
    }
    parambhni = (bhni)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((parambhni != null) && ((parambhni instanceof bhsx)))
    {
      this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = ((bhsx)parambhni).getWebView();
      if (QLog.isColorLevel())
      {
        parambhni = jdField_a_of_type_JavaLangString;
        localObject = new StringBuilder().append(" Share secret webview is null?");
        if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView != null) {
          break label122;
        }
        bool = true;
        QLog.d(parambhni, 2, bool);
      }
    }
    label122:
    while (!QLog.isColorLevel()) {
  ...
  public boolean a()
  {
    ...
    for (Object localObject = null;; localObject = this.h)
    {
      ...
      localQZoneShareData.jdField_b_of_type_Long = bhpv.jdField_b_of_type_Long;
      ...
      bltb.a(this.jdField_b_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), localQZoneShareData, null, -1);
      return true;
      this.jdField_b_of_type_AndroidAppActivity = this.jdField_a_of_type_AndroidAppActivity;
      break;
      localObject = this.jdField_e_of_type_JavaLangString;
  ...
  public boolean a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Bipq.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Bipq.jdField_b_of_type_Int = bipo.b(paramInt);
      localBundle = new Bundle();
      localBundle.putString("report_type", "102");
      localBundle.putString("act_type", "90");
      localStringBuilder = new StringBuilder().append("");
      if (this.jdField_a_of_type_Bipq.jdField_a_of_type_Int != 0) {
        break label407;
      }
    }
    label407:
    for (int i1 = 0;; i1 = 1)
    {
      ...
      localBundle.putString("intext_3", "" + this.jdField_a_of_type_Bipq.jdField_b_of_type_Int);
      localBundle.putString("intext_2", "" + this.jdField_a_of_type_Bipq.jdField_a_of_type_Int);
      localBundle.putString("stringext_1", "" + paramString);
      bipi.a().a(localBundle, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      this.jdField_a_of_type_Bipq.jdField_a_of_type_Boolean = false;
      ...
      paramString.putString("intext_1", "" + bipo.a(1));
      paramString.putString("intext_3", "1");
      paramString.putString("intext_4", "0");
      bipi.a().a(paramString, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      return false;
    }
    ...
    if ((!this.jdField_a_of_type_Biau.isShowing()) && (bool)) {
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, Bundle paramBundle)
  {
    ...
    //   7: aload_0
    //   8: aload_3
    //   9: invokevirtual 1728	abcr:a	(Ljava/lang/String;)Z
    //   12: ifne +5 -> 17
    //   15: iconst_0
    //   16: ireturn
    //   17: aload_0
    //   18: aload_1
    //   19: putfield 376	abcr:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   22: aload_0
    //   23: aload_2
    //   24: putfield 380	abcr:h	Ljava/lang/String;
    //   27: aload_0
    //   28: aload 4
    //   30: putfield 384	abcr:i	Ljava/lang/String;
    //   33: aload_0
    //   34: getfield 384	abcr:i	Ljava/lang/String;
    //   37: ifnull +43 -> 80
    //   40: aload_0
    //   41: getfield 384	abcr:i	Ljava/lang/String;
    //   44: ldc_w 1730
    ...
    //   67: aload_0
    //   68: getfield 384	abcr:i	Ljava/lang/String;
    ...
    //   77: putfield 384	abcr:i	Ljava/lang/String;
    //   80: aload_0
    //   81: iconst_1
    //   82: putfield 1148	abcr:jdField_e_of_type_Boolean	Z
    //   85: aload 5
    //   87: ifnull +173 -> 260
    //   90: aload 5
    //   92: ldc_w 1737
    ...
    //   125: aload_0
    //   126: getfield 376	abcr:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   138: aload_0
    //   139: getfield 380	abcr:h	Ljava/lang/String;
    ...
    //   151: aload_0
    //   152: getfield 384	abcr:i	Ljava/lang/String;
    ...
    //   174: aload_0
    //   175: getfield 77	abcr:jdField_a_of_type_Bipq	Lbipq;
    //   178: iconst_1
    //   179: putfield 1679	bipq:jdField_a_of_type_Boolean	Z
    //   182: aload_0
    //   183: getfield 77	abcr:jdField_a_of_type_Bipq	Lbipq;
    //   186: iconst_0
    //   187: putfield 1683	bipq:jdField_a_of_type_Int	I
    //   190: aload 4
    //   192: invokestatic 281	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   195: ifeq +430 -> 625
    //   198: aload_0
    //   199: getfield 77	abcr:jdField_a_of_type_Bipq	Lbipq;
    //   202: astore 4
    //   204: aload 4
    //   206: aload 4
    //   208: getfield 1683	bipq:jdField_a_of_type_Int	I
    //   211: iconst_1
    //   212: ior
    //   213: putfield 1683	bipq:jdField_a_of_type_Int	I
    //   216: aload_2
    //   217: invokestatic 281	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   220: ifeq +18 -> 238
    //   223: aload_0
    //   224: getfield 77	abcr:jdField_a_of_type_Bipq	Lbipq;
    //   227: astore_2
    //   228: aload_2
    //   229: aload_2
    //   230: getfield 1683	bipq:jdField_a_of_type_Int	I
    //   233: iconst_2
    //   234: ior
    //   235: putfield 1683	bipq:jdField_a_of_type_Int	I
    //   238: aload_1
    //   239: invokestatic 281	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   242: ifeq +18 -> 260
    //   245: aload_0
    //   246: getfield 77	abcr:jdField_a_of_type_Bipq	Lbipq;
    //   249: astore_1
    //   250: aload_1
    //   251: aload_1
    //   252: getfield 1683	bipq:jdField_a_of_type_Int	I
    //   255: iconst_4
    //   256: ior
    //   257: putfield 1683	bipq:jdField_a_of_type_Int	I
    //   260: aload_0
    //   261: aconst_null
    //   262: putfield 1146	abcr:jdField_a_of_type_JavaLangRefSoftReference	Ljava/lang/ref/SoftReference;
    //   265: aload 5
    //   267: ifnull +263 -> 530
    //   270: getstatic 63	abcr:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   273: iconst_1
    //   274: ldc_w 1747
    ...
    //   435: putfield 72	abcr:jdField_a_of_type_Int	I
    //   438: aload_0
    //   439: aload 5
    //   441: ldc_w 1775
    //   444: invokevirtual 1761	android/os/Bundle:getBoolean	(Ljava/lang/String;)Z
    //   447: putfield 1777	abcr:jdField_c_of_type_Boolean	Z
    //   450: aload_0
    //   451: getfield 128	abcr:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   454: ifnull +76 -> 530
    //   457: aload_0
    //   458: getfield 128	abcr:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   461: instanceof 1142
    //   464: ifeq +66 -> 530
    //   467: aload_0
    //   468: getfield 128	abcr:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    ...
    //   485: aload_1
    //   486: aload_0
    //   487: getfield 70	abcr:jdField_a_of_type_Boolean	Z
    //   490: aload_0
    //   491: getfield 72	abcr:jdField_a_of_type_Int	I
    ...
    //   497: aload_1
    //   498: aload_0
    //   499: getfield 1767	abcr:jdField_d_of_type_Boolean	Z
    ...
    //   510: iconst_1
    //   511: aload_0
    //   512: getfield 1773	abcr:j	Ljava/lang/String;
    //   515: aconst_null
    ...
    //   567: ldc_w 1805
    //   570: aload_0
    //   571: getfield 81	abcr:jdField_d_of_type_Int	I
    //   574: invokestatic 1806	cooperation/qzone/LocalMultiProcConfig:putInt	(Ljava/lang/String;I)V
    //   577: aload_0
    //   578: getfield 223	abcr:jdField_a_of_type_ComTencentBizPubaccountCustomWebView	Lcom/tencent/biz/pubaccount/CustomWebView;
    //   581: ifnull +16 -> 597
    //   584: ldc_w 1808
    //   587: aload_0
    //   588: getfield 223	abcr:jdField_a_of_type_ComTencentBizPubaccountCustomWebView	Lcom/tencent/biz/pubaccount/CustomWebView;
    ...
    //   607: astore_1
    //   608: aload_0
    //   609: getfield 128	abcr:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   612: ifnull +11 -> 623
    //   615: aload_0
    //   616: getfield 128	abcr:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   619: aload_1
    ...
    //   625: aload_0
    //   626: iconst_2
    //   627: putfield 1815	abcr:jdField_b_of_type_Int	I
    //   630: goto -414 -> 216
    //   633: astore_1
    //   634: getstatic 63	abcr:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   637: iconst_1
    //   638: ldc_w 1817
    //   641: invokestatic 180	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   644: aload_0
    //   645: iconst_m1
    //   646: putfield 79	abcr:jdField_c_of_type_Int	I
    //   649: goto -281 -> 368
    //   652: astore_1
    //   653: getstatic 63	abcr:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   656: iconst_1
    //   657: ldc_w 1819
    ...
    //   667: aload_0
    //   668: aconst_null
    //   669: putfield 1773	abcr:j	Ljava/lang/String;
    //   672: getstatic 63	abcr:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   675: iconst_1
    //   676: ldc_w 1821
    ...
    //   686: aload_0
    //   687: iconst_m1
    //   688: putfield 72	abcr:jdField_a_of_type_Int	I
    //   691: goto -253 -> 438
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    if (this.jdField_a_of_type_Biau == null)
    {
      paramString7 = (bhni)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((paramString7 == null) || (!(paramString7 instanceof bhsw))) {
        break label456;
      }
    }
    label139:
    ...
    label192:
    label456:
    for (int i1 = ((bhsw)paramString7).getTitleBarHeight();; i1 = 0)
    {
      this.jdField_a_of_type_Biau = new biau(this.jdField_a_of_type_AndroidAppActivity, i1);
      this.jdField_a_of_type_Biau.c(2131689482);
      boolean bool;
      ...
      for (;;)
      {
        ...
        String str = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131695697), new Object[] { paramString2 });
        bgsc.a(this.jdField_a_of_type_AndroidAppActivity, 1001, 146, "struct_msg_from_h5", paramString1, paramString5, paramString2, paramString3, str, paramString4, "web", null, null, null, "plugin", null, paramString7, paramString8, "https://url.cn/JS8oE7", paramString6, null);
        int i2 = 0;
  ...
  public void onClick(View paramView)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse != null) && (this.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse.androidInfo != null))
    {
      ...
      if (!bgnw.a(this.jdField_a_of_type_AndroidAppActivity, ((GetAppInfoProto.AndroidInfo)localObject).packName.get())) {
        break label104;
      }
      bgnw.a(this.jdField_a_of_type_AndroidAppActivity, ((GetAppInfoProto.AndroidInfo)localObject).packName.get(), null);
      localObject = "run";
      nmj.a(null, "", "webviewsourceclick", bgkh.b(this.jdField_a_of_type_Long), 0L, (String)localObject);
    }
    label414:
    for (;;)
    {
      ...
      biqa.a(this.jdField_a_of_type_AndroidAppActivity, String.valueOf(bgkh.b(this.jdField_a_of_type_Long)), 2470, localBundle);
      localObject = "setup";
      break;
      label203:
      if (paramView == this.jdField_b_of_type_AndroidWidgetTextView)
      {
        ...
        {
          bgnw.a(this.jdField_a_of_type_AndroidAppActivity, ((GetAppInfoProto.AndroidInfo)localObject).packName.get(), null);
          biur.a().a(this.n, String.valueOf(bgkh.b(this.jdField_a_of_type_Long)), "ANDROIDQQ.SHAREBAR", "203", false);
        }
        for (;;)
        {
          ...
          localBundle.putBoolean("autoDownload", true);
          localBundle.putString("packageName", ((GetAppInfoProto.AndroidInfo)localObject).packName.get());
          localBundle.putString("appId", String.valueOf(bgkh.b(this.jdField_a_of_type_Long)));
          biqa.b(this.jdField_a_of_type_AndroidAppActivity, localBundle);
          biur.a().a(this.n, String.valueOf(bgkh.b(this.jdField_a_of_type_Long)), "ANDROIDQQ.SHAREBAR", "202", false);
        }
      }
