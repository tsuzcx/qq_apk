  ...
  implements INetInfoHandler
{
  ...
  public void a(axuh paramaxuh, int paramInt)
  {
    Object localObject = null;
    if (paramaxuh != null)
    {
      localObject = new StringBuffer(200);
      ((StringBuffer)localObject).append("http://").append(paramaxuh.jdField_a_of_type_JavaLangString);
      if (paramaxuh.jdField_a_of_type_Int != 80) {
        ((StringBuffer)localObject).append(":").append(paramaxuh.jdField_a_of_type_Int);
      }
