...
public class awqo
{
  ...
  private static void a(awqi paramawqi)
  {
    boolean bool = a(paramawqi.jdField_a_of_type_JavaLangCharSequence);
    if (((paramawqi.jdField_b_of_type_Boolean) && (paramawqi.jdField_a_of_type_JavaLangCharSequence.length() <= 5)) || (!bool))
    {
      paramawqi.jdField_c_of_type_Int = 0;
      return;
    }
    paramawqi.jdField_c_of_type_Int = 4;
  }
  
  public static void a(List<awqi> paramList, PersonalityLabel paramPersonalityLabel, float paramFloat)
  {
    ...
    Collections.sort(localArrayList, new awqp());
    ...
    awqi localawqi = new awqi();
    localawqi.jdField_a_of_type_JavaLangCharSequence = str;
    boolean bool = a(str);
    label398:
    int i4;
    label420:
    ...
    {
      localawqi.jdField_b_of_type_Int = ((PersonalityLabelInfo)localObject2).bgColor;
      localawqi.jdField_e_of_type_Int = 2;
      localawqi.jdField_a_of_type_Int = ((PersonalityLabelInfo)localObject2).fgColor;
      if (localawqi.jdField_e_of_type_Int != 2) {
        break label886;
      }
      i4 = 1;
      ...
      {
        localawqi.jdField_b_of_type_Boolean = true;
        localawqi.jdField_e_of_type_Boolean = true;
        i2 = n + 1;
      }
      i1 = i2;
      n = i;
      if (!localawqi.jdField_e_of_type_Boolean)
      {
        if ((i5 > 1) && (i < 2) && (i != i5 - 1) && (str.length() <= 6)) {
          break label892;
        }
        localawqi.jdField_b_of_type_Boolean = true;
        if (localawqi.jdField_b_of_type_Boolean) {
          break label905;
        }
        n = i + 1;
        i1 = i2;
    ...
    for (;;)
    {
      ...
      for (j = m + 1;; j = m)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            localawqi.jdField_a_of_type_Float = (m * paramFloat);
            localawqi.jdField_a_of_type_AndroidTextTextPaint.setTextSize(localawqi.jdField_a_of_type_Float);
            if (QLog.isColorLevel()) {
              QLog.i("TagUtil", 2, "getTags " + localawqi.jdField_a_of_type_JavaLangCharSequence + " sizeLevel:" + i + " size:" + localawqi.jdField_a_of_type_Float / paramFloat);
            }
            paramList.add(localawqi);
            m = j;
            j = i2;
            i = n;
            break label265;
            ...
            localawqi.d = true;
            localawqi.jdField_a_of_type_AndroidTextTextPaint.setFakeBoldText(true);
            break label398;
            label886:
            i4 = 0;
            break label420;
            label892:
            localawqi.jdField_b_of_type_Boolean = ((Random)localObject1).nextBoolean();
            break label544;
            label905:
            i1 = i2 + 1;
            n = i;
            ...
            if (n == 0)
            {
              paramPersonalityLabel = (awqi)paramList.get(0);
            ...
            if ((i == 0) && (i5 > 1))
            {
              ...
              if (j < paramList.size())
              {
                paramPersonalityLabel = (awqi)paramList.get(j);
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                j += 1;
                break label1033;
                localObject2 = new awqi();
                ((awqi)localObject2).jdField_a_of_type_JavaLangCharSequence = ((CharSequence)localObject1);
                ((awqi)localObject2).jdField_c_of_type_Boolean = true;
                ((awqi)localObject2).jdField_b_of_type_Boolean = false;
                ((awqi)localObject2).jdField_a_of_type_Float = paramPersonalityLabel.jdField_a_of_type_Float;
                ((awqi)localObject2).jdField_a_of_type_AndroidTextTextPaint.setTextSize(paramPersonalityLabel.jdField_a_of_type_Float);
