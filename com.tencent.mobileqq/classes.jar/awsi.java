...
{
  awsi(awsa paramawsa, awxp paramawxp, int paramInt, Context paramContext, boolean paramBoolean, SongInfo paramSongInfo, awpf paramawpf) {}
  
  public void onClick(View paramView)
  {
    int i = 1;
    paramView = this.jdField_a_of_type_Awxp.a;
    paramView.setTag(Integer.valueOf(this.jdField_a_of_type_Int));
    awsa.a(this.jdField_a_of_type_Awsa, new WeakReference(paramView));
    if ((QQPlayerService.a() == 2) && (awsa.a(this.jdField_a_of_type_Awsa) == awvy.a))
    {
      ...
      {
        paramView.setImageResource(2130848577);
        i = 0;
      }
    }
    for (;;)
    {
      ...
      {
        paramView = (awiv)awiu.b.get(this.jdField_a_of_type_Awpf);
      ...
      try
      {
        ...
        if ((this.jdField_a_of_type_AndroidContentContext instanceof UniteSearchActivity))
        {
          ...
          awso.a(null, localReportModelDC02528.action(paramView).obj1(this.jdField_a_of_type_Awpf.a + "").obj2(this.jdField_a_of_type_Awpf.d).ver1(UniteSearchActivity.b).ver2(awso.a(UniteSearchActivity.d)).ver7(localJSONObject.toString()).session_id(localQQAppInterface.getCurrentAccountUin() + awiu.a));
          do
          {
            return;
            paramView.setImageResource(2130848576);
            i = 0;
            break;
          ...
          QQPlayerService.a(this.jdField_a_of_type_Awsa);
