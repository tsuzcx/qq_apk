  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public vki(Activity paramActivity, String paramString1, String paramString2, int paramInt1, WeakReference<AppInterface> paramWeakReference, int paramInt2)
  {
  ...
  {
    if (!axll.d((AppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get())) {
      return -1002;
    }
    axll.d(null);
    ...
    ((axkh)localObject).jdField_b_of_type_JavaLangString = paramString1;
    ...
    for (;;)
    {
      ...
      {
        i = axko.a(paramString3, paramString1, paramString4, 0);
        paramString2.delete();
        if (i != 0)
        {
  ...
  protected void a(Integer paramInteger)
  {
    ...
    a(ajya.a(2131716370) + paramInteger, null);
  }
  
  protected void onPreExecute()
  {
    a(this.jdField_a_of_type_AndroidAppActivity, 2131695126);
  }
}
