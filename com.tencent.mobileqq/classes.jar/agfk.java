  ...
  extends agdi
{
  ...
  public agbp a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new agfo(this);
  ...
  public agfk(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new agfl(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131367678)).setOnClickListener(new agfm(this));
    Button localButton = (Button)findViewById(2131363479);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new agfn(this));
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Agbp = new agbp(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Bfnk, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Agbp);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new agfp(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new agfq(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new agfr(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemLongClickListener(new agfs(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Agbp.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Agbp.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131715191));
        ...
        {
          this.jdField_a_of_type_Agbp.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_d_of_type_Boolean, 0);
          this.jdField_a_of_type_Agbp.notifyDataSetChanged();
        }
        if (this.jdField_a_of_type_Agbp.getCount() == 0) {
          a(4, null);
        }
        for (;;)
        {
      ...
      this.jdField_a_of_type_Agbp.a(this.jdField_a_of_type_JavaUtilList, this.jdField_d_of_type_Boolean);
      if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_Agbp.getCount() < 20))
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131715193));
        this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131371996).setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
      }
    ...
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Agbp.a((List)localObject, this.jdField_d_of_type_Boolean);
    this.jdField_a_of_type_Agbp.notifyDataSetChanged();
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Agbp);
    this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
    this.jdField_a_of_type_JavaUtilList.clear();
