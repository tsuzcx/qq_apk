...
public class bmmb
{
  ...
  private static bmmb jdField_a_of_type_Bmmb;
  ...
  {
    if (jdField_a_of_type_Bmmb == null) {}
    try
    {
      if (jdField_a_of_type_Bmmb == null) {
        jdField_a_of_type_Bmmb = new bmmb();
      }
      return jdField_a_of_type_Bmmb;
    }
    finally {}
  }
  ...
  public void a(bmmg parambmmg)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      parambmmg.a(this.jdField_a_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("vip_tar_engine.jar", new bmmc(this, parambmmg));
  }
  ...
  public void b(bmmg parambmmg)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      parambmmg.a(this.jdField_b_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("libTar.so", new bmmd(this, parambmmg));
  }
}
