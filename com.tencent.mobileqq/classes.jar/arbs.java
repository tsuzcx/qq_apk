...
public class arbs
{
  ...
  private static Map<String, arbt> jdField_b_of_type_JavaUtilMap = new HashMap();
  ...
  public static void a(String paramString, byte[] paramArrayOfByte)
  {
    ...
    localarbt.jdField_a_of_type_JavaLangString = paramString;
    localarbt.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    jdField_b_of_type_JavaUtilMap.put(paramString, localarbt);
  }
  ...
  private static boolean a(long paramLong)
  {
    ...
    {
      arri.a(0, String.format(BaseApplicationImpl.getApplication().getResources().getString(2131692744), new Object[] { Integer.valueOf(jdField_c_of_type_Int) }), 0);
      return false;
    }
    if ((jdField_a_of_type_Long > 0L) && (d() + paramLong > jdField_a_of_type_Long))
    {
      String str = BaseApplicationImpl.getApplication().getResources().getString(2131692751);
      arri.a(0, str + arso.a(jdField_a_of_type_Long), 0);
      return false;
    }
    return true;
  }
  ...
  public static boolean b()
  {
    ...
    while (localIterator.hasNext())
    {
      str = arso.a(((FileInfo)localIterator.next()).d());
      if ((str == null) || (str.length() == 0)) {
        return false;
      }
      str = str.toLowerCase();
      if (!baic.jdField_a_of_type_JavaLangString.contains(str)) {
        return false;
      }
    }
    ...
    while (localIterator.hasNext())
    {
      str = arso.a(((FileManagerEntity)localIterator.next()).fileName);
      if ((str == null) || (str.length() == 0)) {
        return false;
      }
      str = str.toLowerCase();
  ...
  {
    paramFileInfo = arso.a(paramFileInfo.d());
    if ((paramFileInfo == null) || (paramFileInfo.length() == 0)) {}
    do
    {
      return false;
      paramFileInfo = paramFileInfo.toLowerCase();
    } while (!baic.jdField_a_of_type_JavaLangString.contains(paramFileInfo));
    return true;
  }
  ...
  public static boolean b(FileManagerEntity paramFileManagerEntity)
  {
    ...
    } while (!baic.jdField_a_of_type_JavaLangString.contains(paramFileManagerEntity));
    return true;
  }
  ...
  public static long c()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (arqo.a(localFileManagerEntity).a(false)) {
        l += arso.a(localFileManagerEntity.getFilePath());
      }
    }
    return l;
  }
