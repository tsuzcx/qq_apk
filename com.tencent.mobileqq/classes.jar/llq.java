...
public class llq
{
  ...
  llf jdField_a_of_type_Llf = null;
  ...
  public llq(String paramString, Context paramContext)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Lmb = new lmb();
    lmb.a();
    this.jdField_a_of_type_Llf = new llf();
  }
  ...
  public static int a(Context paramContext)
  {
    ...
    try
    {
      paramContext = msi.a(paramContext, "ro.qq.camera.sensor");
  ...
  public static String a(Context paramContext)
  {
    ...
    llf localllf = new llf();
    if (localllf.a(paramContext) != 0)
    {
      if (QLog.isColorLevel()) {
  ...
  {
    int i1 = 0;
    Object localObject = lgo.a(paramContext);
    if (!((lle)localObject).a())
    {
      lkr locallkr = new lkr();
      jdField_b_of_type_Boolean = locallkr.b((lle)localObject);
      if (jdField_b_of_type_Boolean)
      {
        jdField_a_of_type_Byte = locallkr.jdField_a_of_type_Byte;
        jdField_b_of_type_Byte = locallkr.jdField_b_of_type_Byte;
        jdField_c_of_type_Byte = locallkr.jdField_c_of_type_Byte;
        jdField_d_of_type_Byte = locallkr.jdField_d_of_type_Byte;
        e = locallkr.e;
        f = locallkr.f;
        g = locallkr.g;
        h = locallkr.h;
        ...
        j = locallkr.j;
        k = locallkr.k;
        jdField_a_of_type_Int = locallkr.jdField_b_of_type_Int;
        if (QLog.isColorLevel()) {
      ...
      boolean bool = locallkr.d((lle)localObject);
      i1 = bool;
      if (bool)
      {
        l = locallkr.l;
        ...
        u = locallkr.u;
        v = locallkr.v;
        jdField_b_of_type_Int = locallkr.jdField_d_of_type_Int;
        i1 = bool;
        if (QLog.isColorLevel())
        {
    ...
    do
    {
      do
      {
        do
        {
          ...
          localObject = new llf();
        } while (((llf)localObject).a(paramContext) != 0);
        paramContext = ((llf)localObject).a();
      } while (paramContext == null);
      jdField_a_of_type_Byte = paramContext.jdField_a_of_type_Lli.jdField_a_of_type_Byte;
      jdField_b_of_type_Byte = paramContext.jdField_a_of_type_Lli.jdField_a_of_type_Byte;
      jdField_c_of_type_Byte = paramContext.jdField_a_of_type_Lli.jdField_c_of_type_Byte;
      jdField_d_of_type_Byte = paramContext.jdField_a_of_type_Lli.e;
      e = paramContext.jdField_a_of_type_Lli.g;
      f = paramContext.jdField_a_of_type_Lli.i;
      g = paramContext.jdField_a_of_type_Lli.jdField_d_of_type_Byte;
      h = paramContext.jdField_a_of_type_Lli.f;
      i = paramContext.jdField_a_of_type_Lli.h;
      j = paramContext.jdField_a_of_type_Lli.j;
      w = paramContext.jdField_a_of_type_Lli.k;
      x = paramContext.jdField_a_of_type_Lli.l;
  ...
  static void a(Context paramContext, byte[] paramArrayOfByte)
  {
    ...
    while (!QLog.isColorLevel())
    {
      ...
      paramContext = paramArrayOfByte.jdField_a_of_type_Llm;
      break label92;
    }
    label277:
  ...
  public static boolean a(String paramString, Context paramContext, byte[] paramArrayOfByte)
  {
    ...
    if (paramArrayOfByte != null)
    {
      paramString = new llq(paramString, paramContext);
  ...
  {
    lwd.a().a("request", -1);
    return new llq(paramString, paramContext).a(paramLong);
  }
  ...
  public static int[] a(byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      do
      {
        return null;
        localllf = new llf();
        if (localllf.a(paramArrayOfByte) == 0) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d("ConfigSystemImpl", 2, "unPack PB err");
      return null;
      paramArrayOfByte = localllf.a();
    } while ((paramArrayOfByte == null) || (!paramArrayOfByte.jdField_a_of_type_Llk.jdField_a_of_type_Boolean));
    return new int[] { paramArrayOfByte.jdField_a_of_type_Llk.jdField_a_of_type_Int, paramArrayOfByte.jdField_a_of_type_Llk.jdField_b_of_type_Int, paramArrayOfByte.jdField_a_of_type_Llk.jdField_c_of_type_Int, paramArrayOfByte.jdField_a_of_type_Llk.jdField_d_of_type_Int, paramArrayOfByte.jdField_a_of_type_Llk.jdField_e_of_type_Int, paramArrayOfByte.jdField_a_of_type_Llk.f, paramArrayOfByte.jdField_a_of_type_Llk.g, paramArrayOfByte.jdField_a_of_type_Llk.h, paramArrayOfByte.jdField_a_of_type_Llk.i, paramArrayOfByte.jdField_a_of_type_Llk.j, paramArrayOfByte.jdField_a_of_type_Llk.k, paramArrayOfByte.jdField_a_of_type_Llk.l };
  }
  ...
  {
    Object localObject = this.jdField_a_of_type_Llf;
    localObject.getClass();
    localObject = new llp((llf)localObject);
    ((llp)localObject).jdField_a_of_type_Int = 201;
    ((llp)localObject).jdField_b_of_type_Int = this.jdField_a_of_type_Lmb.d();
    ((llp)localObject).jdField_c_of_type_Int = lmb.f();
    ((llp)localObject).jdField_d_of_type_Int = lmb.e();
    ((llp)localObject).jdField_e_of_type_Int = ((int)(lmb.c() / 1000L));
    ((llp)localObject).f = 0;
    ((llp)localObject).g = 0;
    ((llp)localObject).h = 0;
    ((llp)localObject).i = this.jdField_a_of_type_Lmb.g;
    ((llp)localObject).j = this.jdField_a_of_type_Lmb.h;
    ((llp)localObject).k = 22;
    ((llp)localObject).l = ConfigInfo.getSharpConfigVersionFromFile(this.jdField_a_of_type_AndroidContentContext);
    ((llp)localObject).m = 37;
    ((llp)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    ((llp)localObject).jdField_b_of_type_JavaLangString = ("android_" + Build.VERSION.RELEASE);
    ((llp)localObject).jdField_c_of_type_JavaLangString = lmb.c();
    ((llp)localObject).jdField_d_of_type_JavaLangString = Build.VERSION.INCREMENTAL;
    ((llp)localObject).jdField_e_of_type_JavaLangString = Common.a(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_Llf.a(paramLong, (llp)localObject);
    return this.jdField_a_of_type_Llf.a();
  }
