...
public class bnub
{
  ...
  public int a;
  public long a;
  private Handler jdField_a_of_type_AndroidOsHandler = new bnud(this, Looper.getMainLooper());
  public bntu a;
  protected bntv a;
  public bnue a;
  private bnuj jdField_a_of_type_Bnuj = new bnuc(this);
  public Lyric a;
  ...
  public bnub(LyricView paramLyricView)
  {
    this.jdField_c_of_type_Int = 100;
    this.jdField_a_of_type_DovComQqImAeeditorLyricCommonTimerTaskManager = bntq.a();
    this.jdField_a_of_type_Bntv = new bntv();
    ...
    this.jdField_a_of_type_Bntu = paramLyricView.a();
    this.jdField_a_of_type_DovComQqImAeeditorLyricWidgetLyricViewScroll.setScrollListener(this.jdField_a_of_type_Bnuj);
  }
  ...
  private void b(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bnue != null) {
        paramInt = this.jdField_a_of_type_Bnue.a();
      } else {
        paramInt = (int)bobc.a().a(false);
      }
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    bntq.a().post(new LyricViewController.5(this, paramInt));
  }
  
  protected void a(int paramInt1, int paramInt2)
  {
    bntq.a().post(new LyricViewController.6(this, paramInt1, paramInt2));
  }
  
  public void a(int paramInt, boolean paramBoolean)
  {
    bntq.a().post(new LyricViewController.4(this, paramInt, paramBoolean));
  }
  
  public void a(bntw parambntw)
  {
    this.jdField_a_of_type_Bntv.a(parambntw);
  }
  ...
  public void a(Lyric paramLyric1, Lyric paramLyric2, Lyric paramLyric3)
  {
    ...
    bntq.a().post(new LyricViewController.3(this, paramLyric3, paramLyric1, paramLyric2));
  }
  
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Bntu != null) {
      this.jdField_a_of_type_Bntu.setEffectEnable(paramBoolean);
    }
  }
  
  public void b(int paramInt)
  {
    this.jdField_a_of_type_ComTencentWeseevideoEditorStickerMusicLyricDataLyric = this.jdField_a_of_type_Bntu.a();
  ...
  {
    if ((this.jdField_a_of_type_ComTencentWeseevideoEditorStickerMusicLyricDataLyric != null) || (this.jdField_a_of_type_Bntu != null))
    {
      paramInt = this.jdField_a_of_type_Bntu.a(paramInt);
    ...
    do
    {
      ...
      i = this.jdField_a_of_type_Bntu.b();
    ...
    } while (this.jdField_a_of_type_Bntv == null);
    ...
    this.jdField_a_of_type_Bntv.a(l1, i);
    return;
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_ComTencentWeseevideoEditorStickerMusicLyricDataLyric.mSentences.size()))
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Bntv != null) {
          this.jdField_a_of_type_Bntv.a(l1);
        }
  ...
  protected void d(int paramInt)
  {
    if ((this.jdField_a_of_type_ComTencentWeseevideoEditorStickerMusicLyricDataLyric != null) || (this.jdField_a_of_type_Bntu != null))
    {
      paramInt = this.jdField_a_of_type_Bntu.b(paramInt);
      if ((this.jdField_a_of_type_ComTencentWeseevideoEditorStickerMusicLyricDataLyric == null) || (this.jdField_a_of_type_ComTencentWeseevideoEditorStickerMusicLyricDataLyric.isEmpty())) {
    ...
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_ComTencentWeseevideoEditorStickerMusicLyricDataLyric.mSentences.size()))
    {
      ...
      for (;;)
      {
        ...
        bnrh.a("ModuleController", "onScrolling() scrollY => " + i + ",position => " + l1 + ",lineNo:" + paramInt);
        this.jdField_a_of_type_Bntv.a(l1, i);
        return;
        label235:
        l1 = l2;
