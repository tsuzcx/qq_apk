  ...
  implements Manager
{
  ...
  public bilu(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_JavaUtilHashSet = new HcePluginManager.1(this);
  }
  
  public static bilu a()
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if ((localAppRuntime instanceof QQAppInterface)) {
      return (bilu)((QQAppInterface)localAppRuntime).getManager(291);
    }
    return null;
  }
  ...
  public int a(byte[] paramArrayOfByte)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      byte[] arrayOfByte = bilr.a(str);
      if (QLog.isColorLevel()) {
        QLog.i("HcePluginManager", 2, "aidApdu: " + bilr.a(arrayOfByte) + " commandApdu" + bilr.a(paramArrayOfByte));
      }
  ...
  public long a()
  {
    String str = bczr.a(BaseApplicationImpl.getApplication(), "vfcStartTime");
    if (bdje.a(str)) {
      return 0L;
    }
  ...
  public void a()
  {
    bczr.a(BaseApplicationImpl.getApplication(), "vfcStartTime", System.currentTimeMillis() + "");
  }
  
  public void a(Context paramContext, int paramInt)
  {
    if (paramContext != null) {
      bczr.a(paramContext, "vfcState", paramInt + "");
    }
    if (QLog.isColorLevel()) {
  ...
  {
    return (paramContext != null) && ("1".equals(bczr.a(paramContext, "vfcState")));
  }
  ...
  {
    this.jdField_a_of_type_Bilv = null;
  }
}
