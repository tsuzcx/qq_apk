...
public class acrs
{
  ...
  private acrd jdField_a_of_type_Acrd;
  private acre jdField_a_of_type_Acre;
  ...
  private acrf[] jdField_a_of_type_ArrayOfAcrf;
  private String b;
  private String c;
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    awrn.a(BaseApplication.getContext()).a(null, "pttSliceToText", true, 0L, 0L, localHashMap, "");
  }
  ...
  private void a(String paramString1, String paramString2, byte paramByte)
  {
    ...
    //   48: astore_1
    //   49: iload_3
    //   50: invokestatic 148	bahn:a	(B)I
    //   53: istore 5
    //   55: new 150	com/tencent/mobileqq/utils/SilkCodecWrapper
    //   58: dup
    //   59: aload_0
    //   60: getfield 66	acrs:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   80: astore 10
    //   82: iload 5
    //   84: invokestatic 162	bahn:a	(I)I
    //   87: istore 4
    //   89: aload_2
    //   90: astore 8
    //   92: aload_1
    ...
    //   191: astore 10
    //   193: aload_0
    //   194: getfield 173	acrs:jdField_a_of_type_Boolean	Z
    //   197: ifeq +91 -> 288
    //   200: aload_2
    //   201: astore 7
    //   203: aload_1
    ...
    //   342: astore 10
    //   344: aload_0
    //   345: getfield 173	acrs:jdField_a_of_type_Boolean	Z
    //   348: ifeq -60 -> 288
    //   351: aload_2
    //   352: astore 8
    //   354: aload_1
    ...
    //   359: astore 10
    //   361: aload 15
    //   363: invokestatic 189	bahn:a	([B)I
    //   366: istore 5
    //   368: iload 5
    //   370: ifgt +127 -> 497
    //   373: aload_2
    ...
    //   515: astore 10
    //   517: aload_0
    //   518: getfield 173	acrs:jdField_a_of_type_Boolean	Z
    //   521: ifeq -233 -> 288
    //   524: aload_2
    //   525: astore 8
    //   527: aload_1
    ...
    //   688: astore 10
    //   690: aload_0
    //   691: getfield 173	acrs:jdField_a_of_type_Boolean	Z
    //   694: ifeq -406 -> 288
    //   697: aload_2
    //   698: astore 8
    //   700: aload_1
  ...
  public byte a(String paramString)
  {
    ...
    //   14: astore_1
    //   15: aload 4
    //   17: invokestatic 239	bahn:a	(Ljava/io/InputStream;)B
    //   20: istore_2
    //   21: iload_2
    //   22: istore_3
    //   23: aload 4
  ...
  public String a(acrf paramacrf, int paramInt)
  {
    this.jdField_a_of_type_ArrayOfAcrf[paramInt] = paramacrf;
    paramacrf = new StringBuffer();
    paramInt = 0;
    for (;;)
    {
      acrf localacrf;
      if (paramInt < this.jdField_a_of_type_ArrayOfAcrf.length)
      {
        localacrf = this.jdField_a_of_type_ArrayOfAcrf[paramInt];
        if (localacrf != null) {
          break label42;
        }
      }
      ...
      do
      {
        return paramacrf.toString();
        paramacrf.append(localacrf.jdField_a_of_type_JavaLangString);
      } while (!localacrf.jdField_a_of_type_Boolean);
      paramInt += 1;
    }
  }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Axvo.d(this.c, ((Long)this.jdField_a_of_type_JavaUtilList.get(i)).longValue());
      i += 1;
    }
  ...
  public void a(acrf paramacrf, int paramInt)
  {
    if ((this.jdField_a_of_type_ArrayOfAcrf == null) || (paramInt >= this.jdField_a_of_type_ArrayOfAcrf.length) || ((this.jdField_a_of_type_ArrayOfAcrf[paramInt] != null) && (this.jdField_a_of_type_ArrayOfAcrf[paramInt].jdField_a_of_type_Boolean)))
    {
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Acre.a(a(paramacrf, paramInt));
  }
  
  public void a(String paramString)
  {
    bcod.a(new VoiceTextEdtiController.2(this, paramString));
  }
  
  public void a(String paramString1, QQAppInterface paramQQAppInterface, acre paramacre, int paramInt, String paramString2)
  {
    this.b = paramString1;
    this.jdField_a_of_type_Acre = paramacre;
    ...
    this.jdField_a_of_type_Axvs = new acrt(this);
    this.jdField_a_of_type_Axvs.addFilter(new Class[] { axtf.class });
  }
  ...
  {
    bcod.a(new VoiceTextEdtiController.3(this, paramString));
  }
