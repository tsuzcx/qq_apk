  ...
  extends pkt
{
  ...
  private void d(List<Long> paramList)
  {
    ...
    for (int i = 5;; i = paramList.size())
    {
      ...
      while (j < i)
      {
        ...
        ArticleInfo localArticleInfo = pkm.a().a(ojk.a(this.a), l);
        if ((localArticleInfo != null) && (!pay.a(localArticleInfo))) {
          ((ArrayList)localObject).add((ArticleInfo)localArticleInfo);
        }
        j += 1;
      }
    }
    pkm.a().a().a((List)localObject);
  }
  
  public void a(int paramInt, List<Long> paramList)
  {
    if (paramInt != ojk.a(this.a)) {
      return;
    }
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ojk.a(this.a, pkm.a().a(Integer.valueOf(ojk.a(this.a)), paramList), 1);
      Object localObject1 = (Long)paramList.get(0);
      Object localObject2 = pkm.a().a(ojk.a(this.a), ((Long)localObject1).longValue());
      ...
      for (localObject1 = Long.valueOf(((ArticleInfo)localObject2).mArticleID);; localObject1 = "-1")
      {
        ...
        QLog.d("ReadInJoyChannelWaterFallViewController_" + ojk.a(this.a), 1, (String)localObject1);
      ...
      QLog.d("ReadInJoyChannelWaterFallViewController_" + ojk.a(this.a), 1, ((StringBuilder)localObject1).toString());
    }
    label326:
  ...
  public void a(int paramInt, boolean paramBoolean, List<ChannelCoverInfo> paramList)
  {
    ...
    if ((paramInt == ojk.a(this.a)) && (paramBoolean) && (paramList != null) && (!paramList.isEmpty())) {
    ...
    for (;;)
    {
      ...
      if ((paramList != null) && (paramList.size() >= 5))
      {
        ...
        while (i < 5)
        {
          ...
          Object localObject = pkm.a().a(ojk.a(this.a), l);
          if ((localObject != null) && (!pay.a(((BaseArticleInfo)localObject).mArticleContentUrl, ((BaseArticleInfo)localObject).mChannelID, (ArticleInfo)localObject)) && (!pay.a((BaseArticleInfo)localObject)) && (!pkm.a().a(((BaseArticleInfo)localObject).mArticleID)))
          {
  ...
  public void a(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1) {
      if ((paramList != null) && (paramInt > 0) && (paramList.size() > 0))
      {
        if (QLog.isColorLevel())
        {
          ...
          QLog.d("ReadInJoyChannelWaterFallViewController_" + ojk.a(this.a), 1, ((StringBuilder)localObject).toString());
        }
        ojk.a(this.a, pkm.a().a(Integer.valueOf(ojk.a(this.a)), paramList), 1);
        localObject = String.format(this.a.a().getResources().getString(2131717235), new Object[] { Integer.valueOf(paramInt) });
    ...
    for (;;)
    {
      ...
      {
        this.a.a.b(true);
        d(this.a.a().getResources().getString(2131717478));
      }
      else
      {
        localObject = this.a.a().getResources().getString(2131717234);
        this.a.a.a(true, (String)localObject);
        continue;
        if (this.a.a.a()) {
          d(this.a.a().getResources().getString(2131717437));
        }
  ...
  {
    if ((paramInt != ojk.a(this.a)) || (paramList == null)) {
      return;
    }
    paramList = pkm.a().a(Integer.valueOf(ojk.a(this.a)), paramList);
  ...
  public void b(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    if ((paramBoolean1) && (paramList != null)) {
      ojk.a(this.a, pkm.a().a(Integer.valueOf(ojk.a(this.a)), paramList), 2);
    }
    pod localpod;
    if ((paramBoolean1) && (paramList == null))
    {
    ...
    for (;;)
    {
      localpod.a(paramBoolean1, bool);
      if ((paramList != null) && (!paramList.isEmpty())) {
        ojk.a(this.a, NetConnInfoCenter.getServerTime());
      }
      if (QLog.isColorLevel()) {
        QLog.d("ReadInJoyChannelWaterFallViewController", 2, "autoLoad:" + ojk.b(this.a) + " noMoreData:" + paramBoolean2 + " fore:" + GesturePWDUtils.isAppOnForeground(this.a.a()));
      }
      if ((!ojk.b(this.a)) && (paramBoolean2) && (GesturePWDUtils.isAppOnForeground(this.a.a())) && (ojk.a(this.a) != 70))
      {
        paramList = this.a.a().getResources().getString(2131717234);
    ...
    do
    {
      ...
      if (paramList.size() > 0)
      {
        if (QLog.isColorLevel())
        {
          ...
          QLog.d("ReadInJoyChannelWaterFallViewController_" + ojk.a(this.a), 1, localStringBuilder.toString());
        }
        ojk.a(this.a, pkm.a().a(Integer.valueOf(ojk.a(this.a)), paramList), 1);
        return;
      }
