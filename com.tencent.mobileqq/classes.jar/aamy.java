...
public class aamy
  extends ajfo
{
  public aamy(Conversation paramConversation) {}
  ...
  protected void onCardDownload(boolean paramBoolean, Object paramObject)
  {
    ...
    {
      if ((paramBoolean) && (paramObject != null) && (!azzz.a(paramObject.uin, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) {
  ...
  protected void onSetNotDisturb(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      if (!paramBoolean)
      {
        ThreadManagerV2.getUIHandlerV2().post(new Conversation.34.1(this));
        return;
      }
      Conversation.a(this.a.jdField_a_of_type_MqqOsMqqHandler, this.a.a());
    } while (FriendsStatusUtil.a(this.a.a()));
    ThreadManagerV2.getUIHandlerV2().post(new Conversation.34.2(this));
  }
  ...
  protected void onUpdateAvatar(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (azzz.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) {
