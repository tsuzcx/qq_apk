...
public class qea
{
  ...
  private qdz jdField_a_of_type_Qdz;
  private qeb jdField_a_of_type_Qeb;
  private boolean jdField_a_of_type_Boolean;
  private int[] jdField_a_of_type_ArrayOfInt;
  private URLDrawable[] jdField_a_of_type_ArrayOfComTencentImageURLDrawable;
  
  public qea(Activity paramActivity, int paramInt)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          jdField_a_of_type_Int = aciy.a(28.0F, paramActivity.getResources());
          this.jdField_a_of_type_AndroidViewViewGroup.getLocationInWindow(this.jdField_a_of_type_ArrayOfInt);
          this.jdField_a_of_type_JavaUtilRandom = new Random();
          paramActivity = a();
          if (paramActivity != null)
          {
            this.jdField_a_of_type_Qdz = ((qdz)paramActivity.a(138));
            this.jdField_a_of_type_Qeb = new qeb(this);
            paramActivity.addObserver(this.jdField_a_of_type_Qeb);
          }
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo = bgmq.a();
          if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo == null) {
            break label236;
          }
          if ((this.jdField_a_of_type_Qdz == null) || (!bgmq.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo.jdField_a_of_type_Int))) {
            break;
          }
          this.jdField_a_of_type_Qdz.a(paramInt);
          bgmq.a(System.currentTimeMillis());
      ...
      return;
    } while (this.jdField_a_of_type_Qdz == null);
    this.jdField_a_of_type_Qdz.a(paramInt);
    bgmq.a(System.currentTimeMillis());
  }
  ...
  public void a()
  {
    ...
    if (localQQAppInterface != null) {
      localQQAppInterface.removeObserver(this.jdField_a_of_type_Qeb);
    }
  }
