  ...
  implements qft
{
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    rfn localrfn2 = paramBaseArticleInfo.mKdLiveInfo;
    rfn localrfn1 = localBaseArticleInfo.mKdLiveInfo;
    String str2 = " ";
    String str1 = str2;
    ...
    localJSONObject.put("left_live_status_bg_url", localrfn2.a);
    if (!TextUtils.isEmpty(localrfn2.b)) {
      localJSONObject.put("left_live_status_icon_url", localrfn2.b);
    }
    localJSONObject.put("left_live_status_text", localrfn2.c);
    if (!TextUtils.isEmpty(localrfn2.d)) {
      localJSONObject.put("left_live_hot_icon_url", localrfn2.d);
    }
    localJSONObject.put("left_live_hot_text", localrfn2.e);
    str2 = " ";
    str1 = str2;
    ...
    for (str1 = str1 + "...";; str1 = localBaseArticleInfo.mSubscribeName)
    {
      ...
      localJSONObject.put("right_live_status_bg_url", localrfn1.a);
      if (!TextUtils.isEmpty(localrfn1.b)) {
        localJSONObject.put("right_live_status_icon_url", localrfn1.b);
      }
      localJSONObject.put("right_live_status_text", localrfn1.c);
      if (!TextUtils.isEmpty(localrfn1.d)) {
        localJSONObject.put("right_live_hot_icon_url", localrfn1.d);
      }
      localJSONObject.put("right_live_hot_text", localrfn1.e);
