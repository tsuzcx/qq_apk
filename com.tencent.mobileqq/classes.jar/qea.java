...
public class qea
{
  private long a(String paramString)
  {
    ...
    return ((SharedPreferences)localObject).getLong("event_simple_g_info_" + qeb.a(paramString), -1L);
  }
  ...
  private void a(String paramString, long paramLong)
  {
    ...
    ((SharedPreferences.Editor)localObject).putLong("event_simple_g_info_" + qeb.a(paramString), paramLong);
  ...
  private void a(String paramString, TroopInfo paramTroopInfo)
  {
    ...
    while ((paramTroopInfo.timeSec == a(paramTroopInfo.troopuin)) && (!qdz.a().a)) {
      return;
    }
