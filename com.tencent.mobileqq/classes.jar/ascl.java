...
public class ascl
{
  ...
  private static ascm a()
  {
    Object localObject1 = BaseApplication.getContext();
    ascm localascm = new ascm();
    try
    {
      String str1;
      String str2;
      ...
      try
      {
        ...
        if ((str3 != null) && (str3.startsWith("ctwap"))) {
          ...
          {
            localascm.jdField_a_of_type_JavaLangString = str1;
            localascm.jdField_a_of_type_Int = Integer.valueOf(str2).intValue();
          }
          else
          {
            localascm.jdField_a_of_type_JavaLangString = "10.0.0.200";
            localascm.jdField_a_of_type_Int = 80;
          }
        }
      }
      ...
      if ((str3 != null) && (str3.startsWith("cmwap")))
      {
        ...
        {
          localascm.jdField_a_of_type_JavaLangString = "10.0.0.172";
          localascm.jdField_a_of_type_Int = 80;
        }
      }
  ...
  public static InetSocketAddress a()
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject1 = a();
          str = ((ascm)localObject1).jdField_a_of_type_JavaLangString;
          i = ((ascm)localObject1).jdField_a_of_type_Int;
        }
      }
    }
  }
