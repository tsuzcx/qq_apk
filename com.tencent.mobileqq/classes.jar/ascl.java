...
public abstract class ascl
  extends asbv
{
  public ascl(String paramString, QQAppInterface paramQQAppInterface)
  {
  ...
  {
    return (llq.f() > 2) || ((a(paramContext, "traeimp-armeabi")) && (a(paramContext, "TcVpxDec-armeabi")) && (a(paramContext, "TcVpxEnc-armeabi")));
  }
