...
class asjn
  extends antv
{
  final WeakReference<asjj> a;
  
  public asjn(asjj paramasjj)
  {
    this.a = new WeakReference(paramasjj);
  }
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramBoolean = localasjj.a.a(localasjj.b);
        if (QLog.isColorLevel()) {
      ...
      return;
      localasjj.a((Emoticon)paramObject.get(0));
    } while (!QLog.isColorLevel());
