  ...
  implements bebd
{
  ...
  public void a(String paramString)
  {
    ...
    boolean bool1 = axig.a(axig.a(paramString, "isNew"));
    boolean bool2 = axig.a(axig.a(paramString, "isInsert"));
    axig.a(paramString, "title");
    axig.a(axig.a(paramString, "startDate")).longValue();
    axig.a(axig.a(paramString, "endDate")).longValue();
    if (bool1)
    {
      paramString = "0";
      if (!bool2) {
    ...
    for (String str = "0";; str = "1")
    {
      ...
      azmj.b(null, "CliOper", "", "", "Time_reminder", "Updata_clock", 0, 0, str, paramString, "", "");
      return;
      paramString = "1";
      break;
    }
  ...
  {
    long l = axig.a(axig.a(paramString, "currentDate")).longValue();
    axig.a(this.jdField_a_of_type_AndroidAppActivity, l * 1000L, new axik(this), paramJsBridgeListener);
  }
  ...
  public void b(String paramString)
  {
    ...
    catch (Exception localException1)
    {
      do
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "startTime : " + axil.a(1000L * l2) + " endTime : " + axil.a(1000L * l3));
        }
        i = axig.a(this.jdField_a_of_type_AndroidAppActivity, (String)localObject2, 1000L * l2, 1000L * l3, str1, str2, paramString);
      ...
      azmj.b(null, "CliOper", "", "", "Time_reminder", "Rec_ckl_add", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (("calendar".equals(paramString2)) && ("remindDelete".equals(paramString3)))
    {
      ...
      azmj.b(null, "CliOper", "", "", "Time_reminder", "Delete_clock", 0, 0, "", "", "", "");
      return true;
    }
    if (("calendar".equals(paramString2)) && ("remindMsgReport".equals(paramString3)))
    {
      ...
      azmj.b(null, "CliOper", "", "", "Time_reminder", "Obj_clock", 0, 0, axig.a(paramVarArgs[0], "entranceType"), axig.a(paramVarArgs[0], "role"), "", "");
      return true;
    }
    if (("calendar".equals(paramString2)) && ("remindAioReport".equals(paramString3)))
    {
      ...
      azmj.b(null, "CliOper", "", "", "Time_reminder", "Clock_card_clk", 0, 0, "", "", "", "");
      return true;
    }
    return false;
  }
