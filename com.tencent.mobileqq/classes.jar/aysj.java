  ...
  implements IRequestCallback
{
  ...
  public void onResponse(HwResponse paramHwResponse)
  {
    ...
    if (paramHwResponse.retCode == 0)
    {
      if (paramHwResponse.segmentResp.uint32_cache_addr.has())
      {
        ...
        if (i != 0)
        {
          ...
          if ((aysg.a(this.a) != 0) && (aysg.a(this.a) != i)) {
      ...
      if ((localObject1 != null) && (localObject1.length > 0)) {
        try
        {
          ...
          {
            if ((aysg.jdField_a_of_type_Boolean) || (!QLog.isColorLevel())) {
              return;
            }
    ...
    else
    {
      ...
      bben.a(String.valueOf(this.a.jdField_a_of_type_Aywa.a), "svrcomp_r", "sendAckToBDHServer success!  MD5:" + HexUtil.bytes2HexStr((byte[])localObject3));
      this.a.jdField_a_of_type_Aywa.f = HexUtil.bytes2HexStr((byte[])localObject3);
      this.a.jdField_a_of_type_Aywa.i = ShortVideoUtils.a(aysg.a(this.a), "mp4");
      this.a.c = this.a.jdField_a_of_type_Aywa.f;
