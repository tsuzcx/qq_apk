  ...
  extends moc
{
  ...
  Handler jdField_a_of_type_AndroidOsHandler = new moe(this.jdField_a_of_type_JavaLangString, this);
  ...
  public mod(Context paramContext, WeakReference<ZimuView> paramWeakReference, int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    this.m = ((int)paramContext.getResources().getDimension(2131297717));
  ...
  private void a(Canvas paramCanvas, int paramInt)
  {
    ...
    paramCanvas.drawText((String)this.jdField_a_of_type_Lgc.a, paramInt, f, this.jdField_a_of_type_AndroidGraphicsPaint);
    this.jdField_a_of_type_AndroidGraphicsPaint.setStyle(Paint.Style.FILL_AND_STROKE);
  ...
  private void d(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_c_of_type_AndroidGraphicsPaint.setColor(this.jdField_b_of_type_Mob.b);
    this.jdField_c_of_type_AndroidGraphicsPaint.setStrokeWidth(this.jdField_b_of_type_Mob.jdField_a_of_type_Float);
    ...
    paramCanvas.drawText((String)this.jdField_a_of_type_Lgc.b, paramInt1, f, this.jdField_c_of_type_AndroidGraphicsPaint);
    this.jdField_c_of_type_AndroidGraphicsPaint.setStyle(Paint.Style.FILL_AND_STROKE);
    this.jdField_c_of_type_AndroidGraphicsPaint.setColor(this.jdField_b_of_type_Mob.jdField_a_of_type_Int);
  ...
  protected void a(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      lba.f(this.jdField_a_of_type_JavaLangString, "onDraw film:|" + (l2 - l1));
      return;
      i1 = 0;
      break;
      label76:
  ...
  public void a(lgc paramlgc)
  {
    ...
    for (paramlgc = this.jdField_a_of_type_Lgc.b;; paramlgc = null)
    {
      paramlgc = (String)paramlgc;
      this.j = a(this.jdField_c_of_type_AndroidGraphicsPaint, paramlgc);
      int i1 = c();
      this.e = ((this.g - i1) / 2);
      if ((this.jdField_a_of_type_Lgc != null) && (this.jdField_a_of_type_Lgc.a()))
      {
        paramlgc = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(0);
        this.jdField_a_of_type_AndroidOsHandler.sendMessageDelayed(paramlgc, 2000L);
      }
      return;
    }
  }
  ...
  public void b(Typeface paramTypeface, int paramInt, mob parammob)
  {
    if (paramTypeface != null) {
      this.jdField_c_of_type_AndroidGraphicsPaint.setTypeface(paramTypeface);
    }
    this.jdField_b_of_type_Mob = parammob;
    this.jdField_c_of_type_AndroidGraphicsPaint.setTextSize(paramInt);
    if (this.jdField_a_of_type_Lgc != null) {}
    for (paramTypeface = this.jdField_a_of_type_Lgc.b;; paramTypeface = null)
    {
  ...
  public int d()
  {
    return (int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131297715);
  }
  
  Bitmap d()
  {
    if ((this.jdField_a_of_type_Lgc == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Lgc.b))) {
      return null;
    }
    try
    {
  ...
  int g()
  {
    ...
    label48:
    for (Object localObject = this.jdField_a_of_type_Lgc.b;; localObject = null)
    {
