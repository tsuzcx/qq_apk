  ...
  implements ayou, aypq
{
  ...
  public aytv(@NotNull QQAppInterface paramQQAppInterface, @NotNull Activity paramActivity, @NotNull ayos paramayos, @NotNull aymu paramaymu)
  {
    ...
    this.jdField_d_of_type_AndroidViewView.setOnClickListener((View.OnClickListener)new aytw(this));
    paramQQAppInterface = this.jdField_d_of_type_AndroidViewView.findViewById(2131381127);
    ...
    this.jdField_e_of_type_AndroidViewView.setOnClickListener((View.OnClickListener)aytx.a);
    ...
    paramQQAppInterface = this.jdField_a_of_type_ComTencentQphoneBaseUtilBaseApplication;
    Intrinsics.checkExpressionValueIsNotNull(paramQQAppInterface, "appContext");
    this.jdField_a_of_type_Int = (j - afur.a(80.0F, paramQQAppInterface.getResources()));
    paramQQAppInterface = this.jdField_a_of_type_ComTencentQphoneBaseUtilBaseApplication;
    Intrinsics.checkExpressionValueIsNotNull(paramQQAppInterface, "appContext");
    this.jdField_b_of_type_Int = afur.a(211.0F, paramQQAppInterface.getResources());
    this.jdField_c_of_type_Float = (12 * bgln.a());
    paramQQAppInterface = this.jdField_a_of_type_ComTencentQphoneBaseUtilBaseApplication;
    Intrinsics.checkExpressionValueIsNotNull(paramQQAppInterface, "appContext");
    paramQQAppInterface = bggl.a(paramQQAppInterface.getResources(), 2130841452, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
    if (paramQQAppInterface != null)
    {
      paramQQAppInterface = bgmo.d(paramQQAppInterface, this.jdField_c_of_type_Float, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
  ...
  private final void a(String paramString, ImageView paramImageView, int paramInt1, int paramInt2, int paramInt3, Drawable paramDrawable)
  {
    ...
    do
    {
      ...
      if (paramInt1 > 0)
      {
        ...
        paramString.setTag(bgey.b(localURLDrawableOptions.mRequestWidth, localURLDrawableOptions.mRequestHeight, paramInt1));
        paramString.setDecodeHandler(bgey.h);
      }
  ...
  private final void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      break label86;
      label126:
      localButton.setText(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getText(2131694344));
  ...
  {
    this.jdField_a_of_type_Ayuf = ((ayuf)new ayua(this));
  }
  ...
  private final void b(boolean paramBoolean)
  {
    ...
    if (localObject1 != null)
    {
      ...
      ((TextView)localObject1).setOnClickListener((View.OnClickListener)new ayty(this, localObjectRef, paramBoolean));
      ((TextView)localObject1).setOnTouchListener((View.OnTouchListener)new muf());
      if (!bkpg.a()) {
        break label166;
      }
  ...
  private final void c()
  {
    ...
    {
      this.jdField_e_of_type_AndroidViewView.setBackgroundResource(2130846139);
    ...
    {
      return;
      this.jdField_e_of_type_AndroidViewView.setBackgroundResource(2130846138);
      ...
      ((ayot)localObject).a = ((BaseActivity)localActivity);
      this.jdField_a_of_type_Ayos.a((ayot)localObject, (ayou)this);
      localObject = this.jdField_c_of_type_AndroidViewView;
  ...
  private final void f()
  {
    ...
    if (localObject != null)
    {
      ...
      boolean bool3 = ((aypo)localObject).a(this.jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusPermissionChecker$OnlineStatusPermissionItem, (aypq)this);
      bool2 = bool1;
      bool1 = bool3;
    }
    for (;;)
  ...
  public final View a()
  {
    View localView = View.inflate((Context)BaseApplication.context, 2131561554, null);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131381124));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131370464));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378354));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131381126));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131377148));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131381123));
    this.f = ((TextView)localView.findViewById(2131377134));
    this.g = ((TextView)localView.findViewById(2131377127));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131362199));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131365230));
    this.jdField_c_of_type_AndroidViewView = localView.findViewById(2131371730);
    this.h = ((TextView)localView.findViewById(2131370480));
    this.i = ((TextView)localView.findViewById(2131378008));
  ...
  public final String a(long paramLong)
  {
    ...
    localObject = aysh.a().format((Date)localObject);
  ...
  public final void a()
  {
    ...
    Friends localFriends = ((anmw)localObject1).d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    ...
    else
    {
      ...
      if (localObject1 != null) {
        ((Button)localObject1).setOnClickListener((View.OnClickListener)new aytz(this));
      }
      this.jdField_a_of_type_Boolean = true;
      a(false);
      localObject2 = (aqqh)aqlk.a().a(652);
      localObject1 = this.jdField_a_of_type_ComTencentQphoneBaseUtilBaseApplication;
      Intrinsics.checkExpressionValueIsNotNull(localObject1, "appContext");
      j = afur.a(26.0F, ((BaseApplication)localObject1).getResources());
      if (localObject2 == null) {
        break label577;
      }
      localObject1 = ((aqqh)localObject2).a(localFriends.weatherTypeId);
      if (localObject1 == null) {
        break label577;
      }
      localObject1 = ((ayse)localObject1).b;
      label333:
      a((String)localObject1, this.jdField_a_of_type_AndroidWidgetImageView, 0, j, j, bdzx.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) {
        break label583;
      }
      localObject1 = bdzx.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
      label361:
      if (localObject2 == null) {
        break label592;
      }
      localObject2 = ((aqqh)localObject2).a(localFriends.weatherTypeId);
      if (localObject2 == null) {
        break label592;
      }
      localObject2 = ((ayse)localObject2).c;
      label390:
    ...
    label685:
    localObject1 = ((aypo)localObject1).a(40001, false, (aypq)this);
    boolean bool1 = bool2;
    if (localObject1 != null)
    {
      bool1 = bool2;
  ...
  protected void d()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.unRegistObserver((BusinessObserver)this.jdField_a_of_type_Ayuf);
  }
  
  public void onBackPressed()
  {
    super.onBackPressed();
    this.jdField_a_of_type_Aymu.a(1030);
  }
  
  public void show()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.registObserver((BusinessObserver)this.jdField_a_of_type_Ayuf);
