...
public class njo
{
  ...
  public static niv a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    if ((paramMessageRecord instanceof MessageForStructing))
    {
      ...
      if ((localMessageForStructing.structingMsg != null) && ((localMessageForStructing.structingMsg instanceof AbsShareMsg)))
      {
              ...
              if (((axuo)localObject3).a.size() > 0)
              {
                ...
                for (;;)
                {
                  ...
                  if ((localObject4 instanceof axzq))
                  {
                    ...
                    if ((!TextUtils.isEmpty(((axzq)localObject4).S)) && (!TextUtils.isEmpty(((axzq)localObject4).T)))
                    {
                      localObject4 = new niw(i, ((axzq)localObject4).S, ((axzq)localObject4).T);
                      i += 1;
                      ((ArrayList)localObject1).add(localObject4);
                      localArrayList2.add(((niw)localObject4).b);
                      localArrayList1.add(((niw)localObject4).a);
                    }
                  }
                }
              }
        ...
        {
          localObject1 = new niv(paramMessageRecord.senderuin, localMessageForStructing.structingMsg.mMsgUrl, (ArrayList)localObject1, localMessageForStructing.structingMsg.mCommonData);
          if (((niv)localObject1).b())
          {
            ((niv)localObject1).c = String.valueOf(localMessageForStructing.structingMsg.msgId);
            if (!paramBoolean)
            {
              ((niv)localObject1).a = NetConnInfoCenter.getServerTimeMillis();
              paramMessageRecord.saveExtInfoToExtStr("recent_list_advertisement_message_push_time", String.valueOf(((niv)localObject1).a));
            }
            for (;;)
            {
              if (QLog.isColorLevel()) {
                QLog.d("AD_Util", 2, "start preload msgid:" + ((niv)localObject1).c);
              }
              ThreadManager.executeOnSubThread(new PublicAccountAdUtil.1(localArrayList1));
              if (paramQQAppInterface == null) {
                break;
              }
              paramQQAppInterface = (nji)paramQQAppInterface.getManager(238);
              if (paramQQAppInterface != null) {
                paramQQAppInterface.a((niv)localObject1);
              }
              return localObject1;
              paramMessageRecord = paramMessageRecord.getExtInfoFromExtStr("recent_list_advertisement_message_push_time");
              try
              {
                ((niv)localObject1).a = Long.parseLong(paramMessageRecord);
              }
              catch (Exception paramMessageRecord)
              {
                ((niv)localObject1).a = 0L;
              }
            }
          }
          return null;
  ...
  public static oidb_cmd0x886.PhoneInfo a()
  {
    ...
    Object localObject = oai.a();
    String str = oai.c();
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      localObject = bdhv.d(((String)localObject).toLowerCase()).toLowerCase();
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        str = bdhv.d((String)localObject).toLowerCase();
