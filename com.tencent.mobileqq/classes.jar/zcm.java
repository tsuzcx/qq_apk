...
{
  static final String jdField_a_of_type_JavaLangString = weg.a("StoryGroupSvc.do_group_video_forward");
  public int a;
  public Handler a;
  anyz jdField_a_of_type_Anyz = new zco(this);
  public QQAppInterface a;
  public MessageForTroopStory a;
  ntd jdField_a_of_type_Ntd = new zcn(this);
  protected boolean a;
  public int b;
  public String b;
  public int c;
  ...
  private zcm(QQAppInterface paramQQAppInterface, Bundle paramBundle, SessionInfo paramSessionInfo)
  {
  ...
  private zcm(QQAppInterface paramQQAppInterface, MessageForTroopStory paramMessageForTroopStory)
  {
  ...
  public static zcm a(QQAppInterface paramQQAppInterface, Bundle paramBundle, SessionInfo paramSessionInfo)
  {
    try
    {
      paramQQAppInterface = new zcm(paramQQAppInterface, paramBundle, paramSessionInfo);
  ...
  public static zcm a(QQAppInterface paramQQAppInterface, MessageForTroopStory paramMessageForTroopStory)
  {
    return new zcm(paramQQAppInterface, paramMessageForTroopStory);
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ntb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Ntd, localReqGroupVideoForward.toByteArray(), jdField_a_of_type_JavaLangString);
        return;
      }
  ...
  public void c()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().sendMessage(this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopStory, this.jdField_a_of_type_Anyz);
  }
