...
public class ajbn
{
  ...
  public static ResourceInfo a(String paramString, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    String str = ajan.a(paramString, paramInt2);
  ...
  public static List<ajbo> a(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (str.startsWith("url_last_use_time")) {
          localArrayList.add(new ajbo(str.substring("url_last_use_time".length(), str.length()), ((Long)localEntry.getValue()).longValue(), paramInt));
        }
      }
    }
  ...
  public static void a(int paramInt, PreloadConfig paramPreloadConfig)
  {
    ...
    return;
    Object localObject = ajan.a(paramInt);
    long l2 = System.currentTimeMillis();
    long l3 = bdhb.b((String)localObject);
    ...
    if (l3 > 209715200L)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ajbo localajbo = (ajbo)((Iterator)localObject).next();
        if ((localajbo != null) && (!TextUtils.isEmpty(localajbo.jdField_a_of_type_JavaLangString)) && (l1 - localajbo.jdField_a_of_type_Long > 2592000000L) && (!paramPreloadConfig.isUrlInConfig(localajbo.jdField_a_of_type_JavaLangString)))
        {
          ResourceInfo localResourceInfo = a(localajbo.jdField_a_of_type_JavaLangString, false, 0, localajbo.jdField_a_of_type_Int);
          if (localResourceInfo != null)
          {
            b(localajbo.jdField_a_of_type_JavaLangString, localajbo.jdField_a_of_type_Int);
            ajeu.a(localResourceInfo.filePath);
            ajeu.a(localResourceInfo.folderPath);
            ajbm.a(localajbo.jdField_a_of_type_JavaLangString, 8, localajbo.jdField_a_of_type_Int);
          }
        }
      }
    }
