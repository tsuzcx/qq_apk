  ...
  extends aggs
{
  ...
  public ajbn(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    this.jdField_a_of_type_Ajbq = new ajbq(this, null);
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      boolean bool2 = bcsa.b(localChatMessage.msgtype);
  ...
  {
    this.jdField_a_of_type_Ajbp = paramajbp;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    Object localObject = this.jdField_a_of_type_Ahgk.a(localChatMessage, this);
    if ((localObject instanceof BaseBubbleBuilder)) {
      ((BaseBubbleBuilder)localObject).c = true;
    }
    View localView = ((aghc)localObject).a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Ajbq);
    if (localView != null) {
      localView.setTag(2131364436, localChatMessage);
    }
    ...
    for (;;)
    {
      ...
      {
        if ((localObject instanceof ahlh)) {
          ((ahlh)localObject).a(false);
        }
      }
      else if ((localChatMessage.msgtype == -2039) && ((localObject instanceof ApolloItemBuilder)))
      {
        ((ApolloItemBuilder)localObject).a(false);
        localObject = (agyp)agej.a(localView);
        ((agyp)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.setUnread(false, null, null);
        if (((agyp)localObject).jdField_a_of_type_AndroidWidgetImageView != null)
        {
          localObject = ((agyp)localObject).jdField_a_of_type_AndroidWidgetImageView.getDrawable();
