  ...
  implements QGBitmapLoader.QGBitmapLoaderImpl
{
  ...
  public android.graphics.Bitmap load(java.lang.String paramString)
  {
    ...
    //   48: monitorenter
    //   49: aload_1
    //   50: invokestatic 61	bglc:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   53: astore_2
    //   54: aload_2
    //   55: ifnull +15 -> 70
    //   58: aload_2
    ...
    //   72: monitorexit
    //   73: aload_1
    //   74: invokestatic 71	nlw:a	(Ljava/lang/String;)Z
    //   77: ifeq +365 -> 442
    ...
    //   96: invokespecial 87	tyc:<init>	(Lcom/tencent/common/app/BaseApplicationImpl;)V
    //   99: astore 4
    ...
    //   129: dup
    //   130: aload_0
    //   131: invokespecial 103	bjen:<init>	(Lbjem;)V
    //   134: invokevirtual 107	tyc:loadImageFile	(Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/io/File;
    //   137: astore_3
    //   138: aload_3
    //   139: astore 8
    //   141: aload_3
    ...
    //   233: astore 7
    //   235: aload_1
    //   236: invokestatic 71	nlw:a	(Ljava/lang/String;)Z
    //   239: ifeq +78 -> 317
    //   242: aload 6
    //   244: astore_2
    //   245: aload 6
    ...
    //   285: bipush 100
    //   287: aload 8
    //   289: invokestatic 142	bgmo:a	(Landroid/graphics/Bitmap;ILjava/io/File;)Z
    //   292: pop
    //   293: aload 6
    //   295: astore_3
    //   296: aload 6
    ...
    //   392: aload_1
    //   393: aload_2
    //   394: invokestatic 152	bglc:a	(Ljava/lang/String;Landroid/graphics/Bitmap;)V
    //   397: ldc 56
    //   399: monitorexit
    //   400: aload_2
    //   401: areturn
