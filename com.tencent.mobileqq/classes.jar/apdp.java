  ...
  implements apdn
{
  ...
  private apdo jdField_a_of_type_Apdo;
  ...
  private final String jdField_a_of_type_JavaLangString = anvx.a(2131700262);
  ...
  public apdp(View paramView)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_ComTencentMobileqqArARRecordARVideoRecordButtonView = ((ARVideoRecordButtonView)paramView.findViewById(2131370630));
    this.c = paramView.findViewById(2131364298);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131362909);
    this.jdField_a_of_type_Boolean = apdg.a();
    if (this.jdField_a_of_type_Boolean) {
      this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    }
    this.c.setOnClickListener(null);
    this.c.setOnTouchListener(new apdq(this));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362911));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362910));
  ...
  public void a(apdo paramapdo)
  {
    this.jdField_a_of_type_Apdo = paramapdo;
  }
