...
class apdp
  implements bidp<WeiyunPB.CrossBidProxyOfflineFileGetListMsgRsp>
{
  apdp(apdj paramapdj, int paramInt) {}
  ...
  public void a(int paramInt, String paramString, WeiyunPB.CrossBidProxyOfflineFileGetListMsgRsp paramCrossBidProxyOfflineFileGetListMsgRsp)
  {
    ...
    apdj.a(this.jdField_a_of_type_Apdj).a().a(false, 32, new Object[] { Integer.valueOf(paramInt), paramString });
  }
    ...
    for (int i = paramCrossBidProxyOfflineFileGetListMsgRsp.rpt_msg_recv_offline_file.size() + 0;; i = 0)
    {
      ...
      if ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Int == 2))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          localOfflineFileInfo1.c = (awzw.a() * 1000L + localOfflineFileInfo.uint32_life_time.get() * 1000L);
      ...
      for (;;)
      {
        apdj.a(this.jdField_a_of_type_Apdj).a().a(true, 32, new Object[] { Boolean.valueOf(bool), localArrayList });
        return;
        bool = false;
        continue;
        if (this.jdField_a_of_type_Int == 1)
