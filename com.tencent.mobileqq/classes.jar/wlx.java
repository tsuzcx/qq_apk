  ...
  implements wsc
{
  ...
  {
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView = ((VideoPlayerView)paramView.findViewById(2131379341));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131369402);
    ...
    this.jdField_a_of_type_Bfxr = new bfxr(a(), new wme(this, null));
  ...
  {
    if (bbjw.a(paramStFeed.video.fileId.get())) {
      QLog.w(jdField_a_of_type_JavaLangString, 1, "video fileId is empty");
    }
    do
    {
      return;
      if (bbjw.a(paramStFeed.video.playUrl.get()))
      {
  ...
  private void q()
  {
    this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(new wly(this));
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setPreviewVideoClickListener(new wlz(this));
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setNextVideoClickListener(new wma(this));
    if (a() != null) {
      a().a(new wmb(this));
    }
    a().addOnItemTouchListener(new wmc(this));
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetSubscribeFollowInfoView.setOnTouchListener(new wmd(this));
  }
  ...
  public wlj a()
  {
    return (wlj)a().a("RELATIVE_ADAPTER_UNIQUE_KEY");
  }
  ...
  protected void a(CertifiedAccountRead.StGetFeedDetailRsp paramStGetFeedDetailRsp, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null) && (wiv.a(paramStGetFeedDetailRsp.type.get())))
    {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if ((!axmt.b()) && (this.jdField_a_of_type_ComTencentWidgetImmersiveSystemBarCompact != null)) {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368679));
    ...
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368562));
    if (a() != null)
    {
      bkur.a(a());
      bkur.c(a());
  ...
  {
    if (("share_key_continue_feeds".equals(paramString)) && (paramwpi != null) && (this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null)) {
      this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setContinueFeeds((List)paramwpi.a);
    }
  }
