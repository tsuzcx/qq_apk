...
public class bluq
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajrx.jdField_a_of_type_JavaLangString + "/Tencent/qim/hum_recognition";
  ...
  private String a()
  {
    ...
    int i = a();
    String str1 = blud.a("musicopi_12345683" + "a45a1b" + l);
  ...
  public bluq a(float paramFloat)
  {
    if (QLog.isColorLevel()) {
