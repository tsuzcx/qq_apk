  ...
  implements View.OnClickListener
{
  ...
  private bihs jdField_a_of_type_Bihs;
  ...
  public bihp(Activity paramActivity, bihs parambihs, int paramInt1, String paramString, int paramInt2)
  {
    super(paramActivity, 2131755824);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Bihs = parambihs;
  ...
  public bihp(Activity paramActivity, CustomWebView paramCustomWebView, String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    super(paramActivity, 2131755824);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
  ...
  private void a()
  {
    setContentView(2131558975);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131363280));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131370769));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131365226));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)findViewById(2131365083));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131364153));
    ...
    Object localObject2 = new ColorDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167294));
    Object localObject3;
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Bihs != null) {
      this.jdField_a_of_type_Bihs.callback(3);
    }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      Object localObject1 = bihq.a(this.jdField_b_of_type_JavaLangString);
      Object localObject2;
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {
      ...
      for (;;)
      {
        ...
        {
          if (this.jdField_a_of_type_Bihs != null) {
            this.jdField_a_of_type_Bihs.callback(4);
          }
          dismiss();
          if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView == null) {
            break;
      ...
      if (this.jdField_a_of_type_Bihs != null) {
        this.jdField_a_of_type_Bihs.callback(1);
      }
      dismiss();
      if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView != null) {}
      try
