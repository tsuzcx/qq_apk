  ...
  extends afqz
{
  ...
  public akef(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    this.jdField_a_of_type_Agvm = new akeg(paramContext, paramQQAppInterface, paramSessionInfo, null, null);
    this.jdField_a_of_type_Afra = null;
  }
  ...
  {
    ((akeg)this.jdField_a_of_type_Agvm).a(paramBoolean);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localView != null) && ((localView instanceof aked)))
    {
      aked localaked = (aked)localView;
      localaked.setIsShieldTouchForItem(true);
      localaked.setFrom(((akeg)this.jdField_a_of_type_Agvm).a);
