...
{
  static ArrayList<akeo> jdField_a_of_type_JavaUtilArrayList;
  ...
  public akef(QQAppInterface paramQQAppInterface)
  {
  ...
  private void j(byte[] paramArrayOfByte)
  {
    ...
    if ((j == 1) && (i == 2))
    {
      new bgjz(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(new akem(this, paramArrayOfByte));
      return;
    }
    new lxv((Context)localObject).a(new aken(this, paramArrayOfByte));
  }
  ...
  public void a(int paramInt1, String paramString, int paramInt2, long[] paramArrayOfLong, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    catch (Exception localException)
    {
      ...
      paramInt3 = 23;
      lnr locallnr = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(l1);
      if ((locallnr == null) || (locallnr.a <= 0) || (paramInt2 != 0)) {
        break label210;
      }
      this.jdField_a_of_type_ComTencentAvGaudioAVNotifyCenter.a(5, 1, l1, null, locallnr.a);
    ...
    for (;;)
    {
      ...
      if ((i == 2) && (paramInt1 == 1) && (((bamq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(164)).a(paramString) == 1)) {
  ...
  void a(long paramLong, int paramInt, byte paramByte)
  {
    ...
    lcl.d("QQGAudioMsgHandler", String.format("queryRoomMemberNum| discussId=%d, dataType= %d, wReserve=%s", new Object[] { Long.valueOf(paramLong), Integer.valueOf(paramInt), Byte.valueOf(paramByte) }));
  ...
  public void a(byte[] paramArrayOfByte, msg_comm.Msg paramMsg)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (i == 7)
        {
          ...
          ((bamq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(164)).a(l2);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      jdField_a_of_type_JavaUtilArrayList.add(new akeo(paramMsg, Long.valueOf(paramArrayOfByte).longValue(), l2));
      ...
      return;
      label670:
      paramMsg = (aver)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(38);
  ...
  void b(long paramLong)
  {
    ...
    ((ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).a(paramLong);
  ...
  public void b(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    long l1 = ldz.b((byte[])localObject, j);
    if (QLog.isColorLevel()) {
    ...
    if (paramInt != 0)
    {
      if ((jdField_a_of_type_JavaUtilArrayList != null) && (!jdField_a_of_type_JavaUtilArrayList.isEmpty()))
      {
        ...
        {
          paramArrayOfByte = (akeo)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    ...
    do
    {
      do
      {
        do
        {
          ...
          while (paramInt < jdField_a_of_type_JavaUtilArrayList.size())
          {
            localObject = (akeo)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
            if ((localObject != null) && (((akeo)localObject).jdField_a_of_type_Long == l1) && (((akeo)localObject).jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.compareAndSet(false, true))) {
              paramArrayOfByte.add(localObject);
            }
            paramInt += 1;
          }
          Collections.sort(paramArrayOfByte, new akep());
          paramInt = 0;
          while (paramInt < paramArrayOfByte.size() - 1)
          {
            if (QLog.isColorLevel()) {
              QLog.d("QQGAudioMsgHandler", 2, "onRecvMultiVideoC2SACK_0x31-retCode->list =" + ((akeo)paramArrayOfByte.get(paramInt)).b);
            }
            localObject = (akeo)paramArrayOfByte.get(paramInt);
            arrayOfByte1 = new byte[8];
            arrayOfByte2 = ((im_msg_body.MsgBody)((akeo)localObject).jdField_a_of_type_MsfMsgcommMsg_comm$Msg.msg_body.get()).msg_content.get().toByteArray();
            System.arraycopy(arrayOfByte2, (arrayOfByte2[10] & 0xFF) + 19, arrayOfByte1, 0, 8);
            l2 = ldz.b(arrayOfByte1, 8);
            VideoMsgTools.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, 6, true, Long.toString(l1), Long.toString(l2), false, null, false, new Object[] { ((akeo)localObject).jdField_a_of_type_MsfMsgcommMsg_comm$Msg });
            paramInt += 1;
          }
        } while (paramArrayOfByte.size() <= 0);
        paramArrayOfByte = ((im_msg_body.MsgBody)((akeo)paramArrayOfByte.get(paramArrayOfByte.size() - 1)).jdField_a_of_type_MsfMsgcommMsg_comm$Msg.msg_body.get()).msg_content.get().toByteArray();
      } while (this.jdField_a_of_type_ArrayOfByte == null);
  ...
  {
    lcl.d("QQGAudioMsgHandler", "onRecvAppTipMsgData.");
    if (!a()) {}
    byte[] arrayOfByte1;
    Object localObject3;
    byte[] arrayOfByte2;
    ...
    for (;;)
    {
      ...
      l1 = ldz.b((byte[])localObject3, 4);
      j += 4;
      continue;
      j += 2;
      System.arraycopy(paramArrayOfByte, j, localObject3, 0, 4);
      i = ldz.a((byte[])localObject3, 4);
      if (i == 0)
      {
        b(l1);
        ...
        for (;;)
        {
          ...
          localObject2[i1] = ldz.b(arrayOfByte2, 8);
          i1 += 1;
          m += 8;
        }
        System.arraycopy(paramArrayOfByte, j, arrayOfByte1, 0, 2);
  ...
  {
    lcl.d("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31.");
    if (this.jdField_a_of_type_ComTencentAvGaudioAVNotifyCenter == null) {
      return;
    }
    Object localObject1 = null;
    ...
    for (;;)
    {
      ...
      int i = ldz.a(arrayOfByte2, 4);
      if (i != 0)
      {
        localObject1 = new byte[2];
        System.arraycopy(paramArrayOfByte, paramArrayOfByte.length - 2, localObject1, 0, 2);
        lcl.d("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31| retCode wR0=" + localObject1[0] + " wR1=" + localObject1[1]);
        if (localObject1[0] == 3)
        {
          b(paramArrayOfByte, i);
          return;
        }
        lcl.e("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31|wrong retCode.");
        return;
      }
      localObject2 = new byte[2];
      System.arraycopy(paramArrayOfByte, paramArrayOfByte.length - 2, localObject2, 0, 2);
      lcl.d("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31| relation type wR0=" + localObject2[0] + " wR1=" + localObject2[1]);
      int j;
      long l1;
      int k;
      if (localObject2[0] == 1)
      ...
      else
      {
        ...
        case 9: 
          for (;;)
          {
            ...
            lcl.e("QQGAudioMsgHandler", "onRecvMultiVideoC2SACK_0x31|wrong relation type.");
            j = 2;
            break;
            i += 2;
            System.arraycopy(paramArrayOfByte, i, arrayOfByte2, 0, 4);
            i += 4;
            l1 = ldz.b(arrayOfByte2, 4);
            continue;
            i += 6;
            continue;
            System.arraycopy(paramArrayOfByte, i, arrayOfByte1, 0, 2);
  ...
  {
    lcl.d("QQGAudioMsgHandler", "onRecvMultiVideoS2C_0x95.");
    if (!a()) {}
    int i;
    label974:
    do
        ...
        while (j < n)
        {
          ...
          if (k < i1)
          {
            ...
            for (;;)
            {
              k += 1;
              break;
              l = ldz.a(localByteBuffer.getInt());
              continue;
              i = localByteBuffer.getInt();
              continue;
              localByteBuffer.getInt();
          ...
          mri.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l), new akeg(this, l, i));
          j += 1;
        }
      }
  ...
  void f(byte[] paramArrayOfByte)
  {
    ...
    long l1 = ldz.b((byte[])localObject, 8);
    int j = i + 8;
    localObject = new byte[4];
    System.arraycopy(paramArrayOfByte, j, localObject, 0, 4);
    i = ldz.a((byte[])localObject, 4);
    j += 4;
    localObject = new byte[2];
    ...
    if (k == 2)
    {
      ...
      ((ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).b(l2);
      if (this.jdField_a_of_type_ComTencentAvGaudioAVNotifyCenter != null) {
        this.jdField_a_of_type_ComTencentAvGaudioAVNotifyCenter.a(7, 2, l2, new long[] { l1 }, 1L);
      }
      paramArrayOfByte = Long.toString(l2);
      localObject = Long.toString(l1);
      ((aver)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(38)).a(0, l2, (String)localObject, "");
    ...
    while ((k == 1) && (i == 2))
    {
      new bgjz(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(new akeh(this));
      return;
      if ((k == 1) && (i == 10))
      {
        localObject = new byte[4];
    ...
    new lxv(BaseApplication.getContext()).a(new akei(this));
  }
  ...
  void g(byte[] paramArrayOfByte)
  {
    ...
    long l1 = ldz.b(arrayOfByte, 8);
    i += 8;
    arrayOfByte = new byte[4];
    System.arraycopy(paramArrayOfByte, i, arrayOfByte, 0, 4);
    int j = ldz.a(arrayOfByte, 4);
    arrayOfByte = new byte[4];
    System.arraycopy(paramArrayOfByte, i + 4, arrayOfByte, 0, 4);
    long l2 = ldz.b(arrayOfByte, 4);
    mri.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l2), new akej(this, l2, j, l1));
  }
  ...
  void h(byte[] paramArrayOfByte)
  {
    ...
    ((ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).b(l);
