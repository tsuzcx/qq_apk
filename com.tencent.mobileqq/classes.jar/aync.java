...
public class aync
{
  ...
  public static long a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString, long paramLong1, java.io.RandomAccessFile paramRandomAccessFile, long paramLong2, int paramInt)
  {
    ...
    //   17: lconst_0
    //   18: lconst_0
    //   19: invokespecial 31	ayng:<init>	([B[BJJJJJ)V
    //   22: astore_0
    //   23: new 33	aynf
    //   26: dup
    //   27: iload 8
    ...
    //   32: iadd
    //   33: i2l
    //   34: invokespecial 36	aynf:<init>	(J)V
    //   37: astore_1
    //   38: iload 8
    //   40: sipush 364
    //   43: iadd
    ...
    //   49: aload_1
    //   50: aload 12
    //   52: invokevirtual 45	aynf:a	(Ljava/nio/ByteBuffer;)V
    //   55: aload_0
    //   56: aload 12
    //   58: invokevirtual 46	ayng:a	(Ljava/nio/ByteBuffer;)V
    //   61: aload 5
    //   63: lload 6
    ...
    //   261: dup
    //   262: aload 12
    //   264: invokespecial 134	aynf:<init>	(Ljava/nio/ByteBuffer;)V
    //   267: astore 5
    //   269: new 136	aynh
    //   272: dup
    //   273: aload 12
    //   275: invokespecial 137	aynh:<init>	(Ljava/nio/ByteBuffer;)V
    //   278: astore 12
    //   280: aload 5
    //   282: getfield 141	aynf:b	J
    //   285: lconst_0
    //   286: lcmp
    //   287: ifne +189 -> 476
    //   290: aload 12
    //   292: getfield 144	aynh:jdField_a_of_type_Int	I
    //   295: istore 9
    //   297: iload 9
    //   299: iconst_1
    ...
    //   402: lreturn
    //   403: aload 12
    //   405: getfield 181	aynh:jdField_a_of_type_Long	J
    //   408: lstore_3
    //   409: goto -106 -> 303
    //   412: astore_0
    //   413: aconst_null
  ...
  public static aynd a(Bundle paramBundle, String paramString1, String paramString2)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("TroopBar", 2, "applyUpload title = " + str1 + ", tags = " + str2 + ", cat = " + str3 + ", filePath = " + str4 + ", size = " + bace.a(str4));
    }
    ...
    for (;;)
    {
      try
      {
        ...
        paramBundle = new aynd(paramBundle.getJSONObject("result"));
      }
