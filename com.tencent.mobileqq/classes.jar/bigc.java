  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject = new NewIntent(BaseApplicationImpl.getApplication(), bigj.class);
          ...
          ((NewIntent)localObject).putExtra("has_report_yes", new Boolean(bigb.jdField_a_of_type_Boolean));
          BaseApplicationImpl.getApplication().getRuntime().startServlet((NewIntent)localObject);
          bigb.jdField_a_of_type_Float = bigb.jdField_a_of_type_Int - bigb.b + bigb.c;
          localObject = BaseApplicationImpl.getApplication().getRuntime().getAccount();
          if (!TextUtils.isEmpty((CharSequence)localObject)) {
            bigb.jdField_a_of_type_JavaLangString = (String)localObject;
          }
          bigb.jdField_a_of_type_Long = NetConnInfoCenter.getServerTimeMillis();
          QLog.i("SSOHttpUtils", 1, "SSOHttpUtils do report success steps:" + bigb.jdField_a_of_type_Float);
        }
        ...
        if (((JSONObject)localObject).has("svr_steps"))
        {
          ...
          paramBundle = new NewIntent(BaseApplicationImpl.getApplication(), bigj.class);
