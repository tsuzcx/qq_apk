...
public class awdr
{
  private static awdr jdField_a_of_type_Awdr;
  ...
  {
    if (jdField_a_of_type_Awdr == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Awdr == null) {
        jdField_a_of_type_Awdr = new awdr();
      }
      return jdField_a_of_type_Awdr;
    }
  }
  ...
  public int a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString, WtloginObserver paramWtloginObserver)
  {
    ...
    return paramQQAppInterface.RegGetSMSVerifyLoginAccount(paramArrayOfByte1, paramArrayOfByte2, paramString, "8.3.3", paramWtloginObserver);
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    localbdfq.setTitle(2131717551);
    localbdfq.setMessage(2131717550);
    paramQQAppInterface = new awds(this, str, paramActivity, paramQQAppInterface);
    paramActivity = new awdt(this);
    localbdfq.setPositiveButton(2131717549, paramQQAppInterface);
    localbdfq.setNegativeButton(2131690648, paramActivity);
    localbdfq.show();
    return false;
  }
