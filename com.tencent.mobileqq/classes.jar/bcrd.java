...
public class bcrd
  extends BaseAdapter
  implements antz, URLDrawableDownListener
{
  ...
  public bcrd(Context paramContext, Gallery paramGallery)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    this.jdField_a_of_type_ComTencentWidgetGallery = paramGallery;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130837968);
    this.jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
    paramContext = (anug)((AppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(180);
    if (paramContext == null) {}
    this.jdField_a_of_type_Antx = paramContext.a();
  ...
  public Drawable a(String paramString)
  {
    ...
    localURLDrawableOptions.mFailedDrawable = bayu.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
    localURLDrawableOptions.mLoadingDrawable = bayu.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Antx != null) {
      this.jdField_a_of_type_Antx.b(this);
    }
  }
  ...
  protected void a(int paramInt, MediaPreviewInfo paramMediaPreviewInfo, bcrf parambcrf)
  {
    long l = System.currentTimeMillis();
    if ((parambcrf == null) || (paramMediaPreviewInfo == null)) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.i("MediaPreviewAdapter", 2, "loadVideo() mediaInfo = " + paramMediaPreviewInfo);
    }
    parambcrf.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
    File localFile;
    boolean bool2;
    if (!TextUtils.isEmpty(paramMediaPreviewInfo.c))
    {
      ...
      if (bool2) {
        a(paramInt, parambcrf.jdField_a_of_type_ComTencentImageURLImageView, localFile, paramMediaPreviewInfo.jdField_a_of_type_JavaLangString);
      }
      bool1 = bool2;
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (!bool1)
      {
        ...
        {
          bool1 = antx.b(paramMediaPreviewInfo.b);
          if (bool1)
          {
            localFile = antx.a(paramMediaPreviewInfo.b);
            a(paramInt, parambcrf.jdField_a_of_type_ComTencentImageURLImageView, localFile, paramMediaPreviewInfo.jdField_a_of_type_JavaLangString);
          }
          bool2 = bool1;
          if (QLog.isColorLevel())
      ...
      if (!bool2)
      {
        ...
        parambcrf.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(a(paramMediaPreviewInfo.jdField_a_of_type_JavaLangString));
        if (bdin.a(this.jdField_a_of_type_AndroidContentContext)) {
          break label401;
        }
        parambcrf.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        parambcrf.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bcre(this, parambcrf, paramMediaPreviewInfo));
      }
      while (QLog.isColorLevel())
      {
        ...
        label401:
        parambcrf.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        b(paramMediaPreviewInfo, parambcrf);
        continue;
        label419:
        parambcrf.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
        if (QLog.isColorLevel()) {
  ...
  public void a(MediaPreviewInfo paramMediaPreviewInfo, bcrf parambcrf)
  {
    if ((parambcrf == null) || (paramMediaPreviewInfo == null)) {}
    for (;;)
    {
      ...
      try
      {
        ...
        for (paramMediaPreviewInfo = new File(paramMediaPreviewInfo).toURL();; paramMediaPreviewInfo = new URL(paramMediaPreviewInfo))
        {
          ...
          a(parambcrf.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle);
          parambcrf.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
          paramMediaPreviewInfo = URLDrawable.getDrawable(paramMediaPreviewInfo, (URLDrawable.URLDrawableOptions)localObject);
          parambcrf.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(paramMediaPreviewInfo);
          parambcrf.jdField_a_of_type_ComTencentImageURLImageView.setTag(parambcrf);
          parambcrf.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(this);
          return;
        }
        if (!QLog.isColorLevel()) {}
      }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if ((localMediaPreviewInfo != null) && (paramString.equals(localMediaPreviewInfo.b)) && ((localObject instanceof bcrf)))
    {
      a(((bcrf)localObject).jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle, paramInt);
      if (QLog.isColorLevel()) {
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if ((localMediaPreviewInfo != null) && (paramString.equals(localMediaPreviewInfo.b)) && ((localObject instanceof bcrf)))
    {
      localObject = (bcrf)localObject;
      boolean bool = false;
      paramBoolean2 = bool;
      if (paramBoolean1)
      {
        paramBoolean2 = bool;
        if (antx.b(localMediaPreviewInfo.b))
        {
          File localFile = antx.a(localMediaPreviewInfo.b);
          ((bcrf)localObject).jdField_a_of_type_ComTencentImageURLImageView.post(new MediaPreviewAdapter.3(this, (bcrf)localObject, i, localFile, localMediaPreviewInfo));
          paramBoolean2 = true;
        }
      }
      if (!paramBoolean2)
      {
        ...
        ((bcrf)localObject).jdField_a_of_type_ComTencentImageURLImageView.post(new MediaPreviewAdapter.4(this, (bcrf)localObject));
      }
    }
  }
  ...
  protected void b(MediaPreviewInfo paramMediaPreviewInfo, bcrf parambcrf)
  {
    long l = System.currentTimeMillis();
    if (this.jdField_a_of_type_Antx != null) {
      this.jdField_a_of_type_Antx.a(paramMediaPreviewInfo.b);
    }
    a(parambcrf.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle, 0);
    if (QLog.isColorLevel()) {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559249, null);
      paramViewGroup = new bcrf(this);
      paramViewGroup.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131367921));
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle = ((ImageProgressCircle)paramView.findViewById(2131368021));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376990));
    ...
    {
      return paramView;
      paramViewGroup = (bcrf)paramView.getTag();
      break;
    }
  ...
  {
    a(((bcrf)paramView.getTag()).jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle, paramInt);
  }
  
  public void onLoadSuccessed(View paramView, URLDrawable paramURLDrawable)
  {
    paramView = (bcrf)paramView.getTag();
