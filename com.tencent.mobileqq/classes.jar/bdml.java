  ...
  implements View.OnClickListener
{
  ...
  public bdml(TribeVideoListPlayerFragment paramTribeVideoListPlayerFragment, View paramView)
  {
    super(paramView);
  }
  ...
  {
    bdmu localbdmu = (bdmu)this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int);
    String str;
    ...
    for (;;)
    {
      ...
      str = "2";
      break;
      Object localObject1 = new ProfileActivity.AllInOne(String.valueOf(localbdmu.jdField_c_of_type_Long), 86);
      ...
      boolean bool = BaseApplicationImpl.getApplication().getRuntime().getAccount().equals(String.valueOf(localbdmu.jdField_c_of_type_Long));
      ...
      for (;;)
      {
        bcef.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_poster", 0, 0, localbdmu.d, localbdmu.b + "", "", str);
        break;
      ...
      if (!localbdmu.jdField_c_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.a(1, String.valueOf(localbdmu.jdField_c_of_type_Long), new bdmm(this, localbdmu, str));
        continue;
        ...
        label847:
        for (localObject1 = "" + localbdmu.h;; localObject1 = "")
        {
          bcef.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_comment", this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.e, 0, localbdmu.d, localbdmu.b + "", (String)localObject1, str);
          break;
        ...
        for (;;)
        {
          bcef.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_comment", this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.e, 0, localbdmu.d, localbdmu.b + "", "", str);
          break;
        ...
        for (;;)
        {
          bcef.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_share", 0, 0, localbdmu.d, localbdmu.b + "", "", str);
          break;
          if (TribeVideoListPlayerFragment.a(this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment).jdField_c_of_type_Boolean)
          {
            if (TribeVideoListPlayerFragment.a(this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment).webView != null) {
        ...
        if (localbdmu.k != 1)
        {
          this.jdField_a_of_type_ComTencentMobileqqTribeFragmentTribeVideoListPlayerFragment.a(localbdmu.b, localbdmu.d, new bdmn(this, localbdmu));
          bcef.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_like", 0, 0, localbdmu.d, localbdmu.b + "", "", str);
          continue;
          ...
          ((Intent)localObject1).putExtra("url", localbdmu.g);
          ...
          bcef.b(null, "dc00899", "Grp_tribe", "", "video_player", "Clk_detail", 0, 0, localbdmu.d, localbdmu.b + "", "", str);
        }
      }
    }
  }
