...
{
  public acrf(EditInfoActivity paramEditInfoActivity) {}
  
  public void onClick(View paramView)
  {
    paramView = this.a.a.getText();
    if (paramView != null) {}
    for (paramView = new baig(paramView.toString(), 3);; paramView = null)
    {
      Object localObject1;
      if (paramView == null)
      {
        ...
        if (!this.a.jdField_g_of_type_Boolean)
        {
          if (this.a.jdField_e_of_type_Int == 0)
          {
            ...
            while (!this.a.b.equals(paramView))
            {
              ...
              QQToast.a(this.a, this.a.getString(2131693679), 0).b(this.a.getTitleBarHeight());
              return;
            }
      ...
      if (!bdee.d(this.a.app.getApplication().getApplicationContext()))
      {
      ...
      {
        localacrp = new acrp(null);
        if (EditInfoActivity.a(this.a, localacrp))
        {
          this.a.b(true);
          paramView = (bdpx)this.a.app.a(71);
          ...
          } while (((bejq)((Iterator)localObject1).next()).c != 1);
        }
      }
      for (int i = 1;; i = 0)
      {
        if (i == 0)
        {
          QQToast.a(this.a, alpo.a(2131704002), 0).b(this.a.getTitleBarHeight());
          return;
        }
        ...
        {
          QQToast.a(this.a, this.a.getString(2131693556), 0).b(this.a.getTitleBarHeight());
          return;
        }
        ...
        localObject2 = (alzf)this.a.app.a(20);
        if ((localObject2 != null) && (!TextUtils.isEmpty(this.a.jdField_e_of_type_JavaLangString)))
        {
          this.a.b(true);
          ((alzf)localObject2).a(this.a.jdField_e_of_type_JavaLangString, paramView, (ArrayList)localObject1);
        }
        ...
        {
          this.a.j = true;
          azmj.b(this.a.app, "P_CliOper", "Grp_manage", "", "modify_name", "complete", 0, 0, this.a.jdField_e_of_type_JavaLangString, i + "", "" + this.a.d, "");
          return;
