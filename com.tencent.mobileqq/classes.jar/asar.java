...
public class asar
{
  ...
  private asad jdField_a_of_type_Asad;
  asap jdField_a_of_type_Asap = new asas(this);
  public Conversation a;
  boolean jdField_a_of_type_Boolean = true;
  private ViewGroup b;
  
  public asar(Conversation paramConversation, ViewGroup paramViewGroup)
  {
  ...
  private void a(Context paramContext)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      if (this.jdField_a_of_type_Asad == null)
      {
        this.jdField_a_of_type_Asad = new asad("Login.Guide");
        this.jdField_a_of_type_Asad.observerOnUiThread = true;
      }
      if (!bool1) {
        akuf.a(this.jdField_a_of_type_Asad);
      }
      return;
    }
  }
  
  private void a(asam paramasam)
  {
    ...
    {
      return;
      if (!TextUtils.isEmpty(paramasam.jdField_a_of_type_JavaLangString)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("LoginWelcomeManager", 2, "Bad url: " + paramasam.jdField_a_of_type_JavaLangString);
    return;
    if (QLog.isColorLevel()) {
    ...
    localIntent.putExtra("url", paramasam.jdField_a_of_type_JavaLangString);
    localIntent.putExtra("flag_show_loading_dialog", false);
    localIntent.putExtra("hide_left_button", true);
    localIntent.setData(Uri.parse(paramasam.jdField_a_of_type_JavaLangString));
    localBaseActivity.startActivity(localIntent);
    LoginWelcomeManager.a(this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a).c = false;
    LoginWelcomeManager.a(this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a, paramasam.jdField_a_of_type_Int);
  }
  ...
  private void a(URLDrawable paramURLDrawable)
  {
    ...
    {
      return;
      if ((this.b != null) && (this.b.findViewById(2131364644) == null) && (paramURLDrawable != null) && (paramURLDrawable.getStatus() == 1) && (this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a != null)) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    if (this.jdField_a_of_type_AndroidViewViewGroup == null)
    {
      ...
      Object localObject1 = (ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364281);
      ((ImageView)localObject1).setContentDescription(ajya.a(2131706373));
      ((ImageView)localObject1).setOnClickListener(new asat(this));
      ...
      ((Button)localObject2).setContentDescription(this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a().getString(2131698716));
      ((Button)localObject2).setOnClickListener(new asau(this, (Activity)localObject1));
      localObject2 = (TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365293);
      ((TextView)localObject2).setContentDescription(((Activity)localObject1).getString(2131698715));
      ((TextView)localObject2).setOnClickListener(new asav(this, (Activity)localObject1));
      localObject1 = (ThemeImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364692);
      ((ThemeImageView)localObject1).setMaskShape(bfwr.b);
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a != null) {
      ((LoginWelcomeManager)this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a.getManager(146)).a(this.jdField_a_of_type_Asap);
    }
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Asad != null)
    {
      akuf.b(this.jdField_a_of_type_Asad);
      this.jdField_a_of_type_Asad = null;
    }
  }
