...
public class bkar
{
  ...
  private static bkar jdField_a_of_type_Bkar;
  ...
  {
    if (jdField_a_of_type_Bkar == null) {}
    try
    {
      if (jdField_a_of_type_Bkar == null) {
        jdField_a_of_type_Bkar = new bkar();
      }
      return jdField_a_of_type_Bkar;
    }
    finally {}
  }
  ...
  public void a(bkaw parambkaw)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      parambkaw.a(this.jdField_a_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("vip_tar_engine.jar", new bkas(this, parambkaw));
  }
  ...
  public void b(bkaw parambkaw)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      parambkaw.a(this.jdField_b_of_type_Boolean);
      return;
    }
    ...
    QzoneModuleManager.getInstance().downloadModule("libTar.so", new bkat(this, parambkaw));
  }
}
