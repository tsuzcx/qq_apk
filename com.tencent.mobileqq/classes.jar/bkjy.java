  ...
  extends QIMEffectCameraCaptureUnit
{
  ...
  public bkjy(bmcv parambmcv, bmcu parambmcu)
  {
    super(parambmcv, parambmcu);
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bkjz(this);
    this.jdField_a_of_type_Bmcn = new bmcn(10007, 7, 6);
  ...
  public static Bundle a(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, String paramString1, String paramString2, boolean paramBoolean6, boolean paramBoolean7, String paramString3, String paramString4, int paramInt2, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, bkjx parambkjx)
  {
    ...
    if (parambkjx != null)
    {
      localBundle.putBoolean("arg_support_combo", parambkjx.jdField_a_of_type_Boolean);
      localBundle.putBoolean("arg_unfold_combo", parambkjx.jdField_b_of_type_Boolean);
      localBundle.putString("arg_combo_name", parambkjx.jdField_c_of_type_JavaLangString);
      localBundle.putString("arg_combo_id", parambkjx.jdField_d_of_type_JavaLangString);
      localBundle.putBoolean("arg_support_music", parambkjx.jdField_c_of_type_Boolean);
      localBundle.putBoolean("arg_unfold_music", parambkjx.jdField_d_of_type_Boolean);
      localBundle.putString("arg_music_name", parambkjx.g);
      localBundle.putString("arg_music_id", parambkjx.h);
    }
  ...
  public View a()
  {
    ...
    if ((this.B) && (!this.C))
    {
      ...
      this.f = this.jdField_a_of_type_Bmcv.a().getIntent().getIntExtra("videoId", 0);
      if (this.f == 0) {
        break label103;
      }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt1 == 10007) && (paramInt2 == -1) && (paramIntent != null))
    {
      ...
      {
        localActivity = this.jdField_a_of_type_Bmcv.a();
    ...
    for (paramInt1 = 15;; paramInt1 = 32)
    {
      ...
      bkkb.a(localActivity, (SessionInfo)localObject, localPublishParam, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult, paramIntent, null);
  ...
  {
    super.a(paramBundle);
    this.g = this.jdField_a_of_type_Bmcv.a().getIntent().getIntExtra("type", 1);
    this.h = this.jdField_a_of_type_Bmcv.a().getIntent().getIntExtra("WebSceneType", ajli.jdField_d_of_type_Int);
    paramBundle = new IntentFilter();
    paramBundle.addAction("tencent.video.q2v.startUploadPTV");
    this.jdField_a_of_type_Bmcv.a().registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, paramBundle);
  }
  
  public void a(axmn paramaxmn)
  {
    super.a(paramaxmn);
    bmco localbmco = new bmcq(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a()).a(3).a();
    localbmco.jdField_a_of_type_Int = this.jdField_j_of_type_Int;
    localbmco.jdField_a_of_type_JavaLangString = this.jdField_q_of_type_JavaLangString;
  ...
  public void a(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    Object localObject = new bmct().b(3).a();
    if (this.jdField_j_of_type_Int == jdField_d_of_type_Int)
    {
      ((bmcr)localObject).i = true;
      ((bmcr)localObject).jdField_a_of_type_JavaLangString = this.jdField_q_of_type_JavaLangString;
    }
    ((bmcr)localObject).jdField_a_of_type_Int = this.g;
    ((bmcr)localObject).jdField_b_of_type_Int = this.h;
    ((bmcr)localObject).jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Bmcv.a().getIntent().getStringExtra("succUrl");
    ((bmcr)localObject).jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Bmcv.a().getIntent().getStringExtra("failedUrl");
    this.jdField_a_of_type_Bmcn.a((bmcr)localObject);
    a(paramLocalMediaInfo);
    localObject = new bnge();
    if (this.h == ajli.jdField_b_of_type_Int)
    {
      ...
      {
        ((bnge)localObject).jdField_a_of_type_Int = this.jdField_c_of_type_Int;
        ((bnge)localObject).jdField_a_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
        ((bnge)localObject).g = this.jdField_e_of_type_JavaLangString;
        ((bnge)localObject).f = this.jdField_d_of_type_JavaLangString;
        ((bnge)localObject).jdField_b_of_type_JavaLangString = (localPtvTemplateInfo.categoryId + "");
        ((bnge)localObject).jdField_c_of_type_JavaLangString = localPtvTemplateInfo.id;
        ((bnge)localObject).jdField_a_of_type_Boolean = true;
        if (localPtvTemplateInfo.kind != 8) {
          break label387;
        }
        bool1 = true;
        ((bnge)localObject).jdField_b_of_type_Boolean = bool1;
        if (localPtvTemplateInfo.kind != 9) {
          break label392;
        }
        bool1 = true;
        label324:
        ((bnge)localObject).jdField_c_of_type_Boolean = bool1;
    ...
    {
      ((bnge)localObject).jdField_d_of_type_Boolean = bool1;
      ((bnge)localObject).jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewEffectsCameraCaptureView.e();
      bngr.a(this.jdField_a_of_type_Bmcv.a(), paramVideoCaptureResult, paramLocalMediaInfo, this.jdField_a_of_type_Bmcn, this.jdField_a_of_type_AndroidOsBundle, 5, (bnge)localObject);
      return;
      bool1 = false;
      break;
      bool1 = false;
