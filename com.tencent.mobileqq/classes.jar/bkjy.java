...
public class bkjy
{
  ...
  {
    a(paramQQAppInterface, paramActivity, paramInt, 2131691367);
  }
  ...
  {
    int i = bdne.aS(paramContext, paramQQAppInterface.getCurrentAccountUin());
    if (i == 1)
    {
      String str = bdne.u(paramContext, paramQQAppInterface.getCurrentAccountUin());
      i = bdne.aT(paramContext, paramQQAppInterface.getCurrentAccountUin());
