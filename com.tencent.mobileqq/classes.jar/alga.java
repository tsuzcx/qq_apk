...
{
  private aldh jdField_a_of_type_Aldh;
  protected View a;
  ...
  public static alga a(BaseActivity paramBaseActivity, aldh paramaldh)
  {
    Object localObject = alfy.a().a(a());
    if (localObject != null)
    {
      if (bmll.a(((alfw)localObject).jdField_c_of_type_JavaLangString)) {}
      for (localObject = ((alfw)localObject).b();; localObject = ((alfw)localObject).a())
      {
        if (localObject != null) {
          ((alga)localObject).a(paramBaseActivity, paramaldh);
        }
        return localObject;
      }
    }
  ...
  private void b(alfw paramalfw)
  {
    this.jdField_b_of_type_Boolean = paramalfw.a();
    if (this.jdField_b_of_type_Boolean)
    {
      this.c = this.jdField_a_of_type_Aldh.a();
      if (this.c) {
        i();
      }
    }
  ...
  public View a()
  {
    ...
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131368771);
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368761));
  ...
  public void a()
  {
    alfw localalfw = alfy.a().a(a());
    if (localalfw != null)
    {
      QbossReportManager.getInstance().reportClick(localalfw.jdField_b_of_type_JavaLangString, null);
      bmll.a(a() + "", 138, localalfw.jdField_c_of_type_Int + "", localalfw.jdField_b_of_type_JavaLangString);
    }
  }
  ...
  protected void a(alfw paramalfw)
  {
    ...
    String str = paramalfw.jdField_a_of_type_JavaLangString;
    ...
    QbossReportManager.getInstance().reportExpose(paramalfw.jdField_b_of_type_JavaLangString, null);
    bmll.a(a() + "", 137, paramalfw.jdField_c_of_type_Int + "", paramalfw.jdField_b_of_type_JavaLangString);
  }
  
  public void a(BaseActivity paramBaseActivity, aldh paramaldh)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Aldh = paramaldh;
  }
  ...
  public boolean a()
  {
    ...
    localObject = alfy.a().a((String)localObject);
    if ((localObject == null) || (((alfw)localObject).jdField_a_of_type_AndroidUtilSparseArray == null) || (((alfw)localObject).jdField_a_of_type_AndroidUtilSparseArray.size() == 0))
    {
  ...
  public void b()
  {
    ...
    if (localalfw != null)
    {
      QbossReportManager.getInstance().reportClose(localalfw.jdField_b_of_type_JavaLangString, null);
      bmll.a(a() + "", 122, localalfw.jdField_c_of_type_Int + "", localalfw.jdField_b_of_type_JavaLangString);
    }
  }
  ...
  public void c()
  {
    ...
    alfw localalfw = alfy.a().a(a());
    if ((localalfw != null) && (localalfw.jdField_a_of_type_AndroidUtilSparseArray != null))
    {
      alfx localalfx = (alfx)localalfw.jdField_a_of_type_AndroidUtilSparseArray.get(1);
      if (localalfx == null)
      {
      ...
      if ((!TextUtils.isEmpty(localalfx.jdField_c_of_type_JavaLangString)) && ((localalfw.jdField_a_of_type_Int == 1) || (localalfw.jdField_a_of_type_Int == 0)))
      {
        ...
        if (localalfw.jdField_a_of_type_Int == 1) {}
        for (boolean bool = true;; bool = false)
        {
          ((URLDrawable.URLDrawableOptions)localObject).mPlayGifImage = bool;
          localObject = URLDrawable.getFileDrawable(localalfx.jdField_c_of_type_JavaLangString, (URLDrawable.URLDrawableOptions)localObject);
          if (localObject != null) {
            break;
          }
          QLog.i("QbossADBannerManager", 1, "initQbossADBanner urlDrawable == null  file path = " + localalfx.jdField_c_of_type_JavaLangString);
          e();
          return;
        }
        ...
        ((URLDrawable)localObject).setURLDrawableListener(new algb(this, localalfw, localalfx));
        ThreadManager.executeOnFileThread(new QbossADBannerManager.2(this, (URLDrawable)localObject));
        return;
      }
      QLog.i("QbossADBannerManager", 1, "initQbossADBanner resType is wrong: " + localalfw.jdField_a_of_type_Int + " file path = " + localalfx.jdField_c_of_type_JavaLangString);
      e();
      return;
    }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      bdla.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00898", "", "", "0X8009EE2", "0X8009EE2", 11, 0, "", "", "", "");
      alfw localalfw;
      for (;;)
      {
        ...
        alfy.a().a(a());
        break;
        localalfw = alfy.a().a(a());
        if ((localalfw != null) && (!TextUtils.isEmpty(localalfw.jdField_a_of_type_JavaLangString))) {
          break label139;
        }
      ...
      a();
      if (QLog.isColorLevel()) {
        QLog.i("QbossADBannerManager", 2, "qboss banner jump url = " + localalfw.jdField_a_of_type_JavaLangString);
      }
      Object localObject1;
      if (localalfw.jdField_b_of_type_Int == 1)
      {
        Object localObject2 = localalfw.jdField_a_of_type_JavaLangString;
        ...
        for (localObject1 = (String)localObject1 + "&qboss_trace=" + localalfw.jdField_b_of_type_JavaLangString;; localObject1 = (String)localObject1 + "?qboss_trace=" + localalfw.jdField_b_of_type_JavaLangString)
        {
          localObject1 = (String)localObject1 + MobileReportManager.getStringQboos2H5(BaseApplicationImpl.getApplication().getRuntime().getAccount(), localalfw.jdField_b_of_type_JavaLangString, "&");
          if (QLog.isDevelopLevel()) {
      ...
      if (localalfw.jdField_b_of_type_Int == 2)
      {
        localObject1 = bhey.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, localalfw.jdField_a_of_type_JavaLangString);
        ...
        {
          QbossReportManager.getInstance().sendErrorReport(2741, localalfw.jdField_c_of_type_Int, 100, "qboss banner jump scheme action = null , url =  " + localalfw.jdField_a_of_type_JavaLangString);
        }
      }
    }
  }
