...
public class absy
  implements Runnable
{
  public absy(ConfigServlet paramConfigServlet, File paramFile, String paramString) {}
  ...
  public void run()
  {
    ...
    //   4: istore_2
    //   5: aload_0
    //   6: getfield 16	absy:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   134: dup
    //   135: aload_0
    //   136: getfield 16	absy:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   199: aload_0
    //   200: getfield 18	absy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   239: pop
    //   240: aload_0
    //   241: getfield 14	absy:jdField_a_of_type_ComTencentMobileqqConfigSplashlogoConfigServlet	Lcom/tencent/mobileqq/config/splashlogo/ConfigServlet;
    ...
    //   320: aload_0
    //   321: getfield 18	absy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   411: pop
    //   412: aload_0
    //   413: getfield 16	absy:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   416: invokevirtual 128	java/io/File:exists	()Z
    //   419: ifeq +11 -> 430
    //   422: aload_0
    //   423: getfield 16	absy:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   492: aload_0
    //   493: getfield 16	absy:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   496: invokevirtual 128	java/io/File:exists	()Z
    //   499: ifeq +11 -> 510
    //   502: aload_0
    //   503: getfield 16	absy:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   617: aload_0
    //   618: getfield 16	absy:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   621: invokevirtual 128	java/io/File:exists	()Z
    //   624: ifeq -189 -> 435
    //   627: aload_0
    //   628: getfield 16	absy:jdField_a_of_type_JavaIoFile	Ljava/io/File;
