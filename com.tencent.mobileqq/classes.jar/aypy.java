...
public class aypy
  extends aypt
{
  public aypy(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  {
    String str = bbdr.a(paramContext, paramString, 0);
    ImageInfo localImageInfo = new ImageInfo();
    bbdr.a(4, paramContext, paramString, str, true, localImageInfo, 0);
