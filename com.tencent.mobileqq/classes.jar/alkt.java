  ...
  extends BaseAdapter
{
  ...
  public alkt(Context paramContext, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      paramView = new alku();
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558867, null);
      paramView.jdField_a_of_type_ComTencentMobileqqWidgetSquareImageView = ((SquareImageView)localView.findViewById(2131377538));
      paramView.jdField_a_of_type_AndroidViewView = localView.findViewById(2131368710);
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (alku)paramView.getTag();
      localView = paramView;
