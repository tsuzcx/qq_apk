...
public class aolr
{
  ...
  public static String a(String paramString, Context paramContext)
  {
    ...
    return paramString + paramContext.getResources().getString(2131698950);
  }
  ...
  public View a(Context paramContext, aogi paramaogi, ViewGroup paramViewGroup)
  {
    if (paramaogi == null) {}
    int i;
    do
    {
      return null;
      paramViewGroup = LayoutInflater.from(paramContext).inflate(2131560762, null);
      ...
      paramContext = a(paramaogi.a, paramContext);
    } while (paramContext == null);
    TextView localTextView = (TextView)paramViewGroup.findViewById(2131377030);
    localTextView.setText(paramaogi.a);
    ...
    if (paramaogi.a()) {
      paramContext.setBackgroundResource(2130844289);
    }
  ...
  public aogi a(int paramInt)
  {
    return (aogi)this.a.get(paramInt);
  }
  
  public void a(ArrayList<aogi> paramArrayList)
  {
    int i = 0;
    int j = 0;
