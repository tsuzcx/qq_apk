...
{
  final Runnable jdField_a_of_type_JavaLangRunnable = new ybh(this);
  ...
  public void a(AVCodec.AVCodecCallback paramAVCodecCallback, MessageStruct paramMessageStruct)
  {
    ...
    paramAVCodecCallback.jdField_a_of_type_Ybc = null;
    ...
    paramAVCodecCallback.jdField_a_of_type_AndroidOsHandler.post(new ybj(this));
    e();
  }
    ...
    for (;;)
    {
      ...
      if (paramVarArgs != null) {
        if ((paramVarArgs[0] instanceof Boolean))
        {
          ...
          ThreadManager.post(new ybk(this), 8, null, true);
        }
                    ...
                    case 3: 
                      ...
                      else
                      {
                        ...
                        if (((RMVideoStateMgr)localObject).jdField_a_of_type_AndroidOsHandler != null) {
                          ((RMVideoStateMgr)localObject).jdField_a_of_type_AndroidOsHandler.post(new ybl(this));
                        }
  ...
  void d()
  {
    ...
    localRMVideoStateMgr.jdField_a_of_type_AndroidOsHandler.postDelayed(new ybg(this), 50L);
  }
  ...
  void e()
  {
    ...
    if (b())
    {
      ...
      localRMVideoStateMgr.jdField_a_of_type_AndroidOsHandler.post(new ybi(this));
    }
  }
