  ...
  implements View.OnClickListener
{
  ...
  private zjy jdField_a_of_type_Zjy;
  ...
  public zkk(Activity paramActivity, zkm paramzkm)
  {
  ...
  private void a(View paramView)
  {
    ...
    localObjectAnimator1.setInterpolator(new zjp(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    localObjectAnimator2.setInterpolator(new zjp(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    localObjectAnimator3.setInterpolator(new zjp(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    paramView.setInterpolator(new zjp(0.33F, 0.0F, 0.67F, 1.0F));
  ...
  private void f()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131374698);
    this.jdField_a_of_type_AndroidViewView.setVisibility(0);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131374694);
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView = ((RecyclerView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374700));
      ...
      this.jdField_a_of_type_Zjy = new zjy(this.jdField_a_of_type_AndroidViewView.getContext(), this, this.jdField_a_of_type_Zkm);
      this.jdField_a_of_type_Zjy.a(zkg.a().a());
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Zjy);
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getRecycledViewPool().setMaxRecycledViews(this.jdField_a_of_type_Zjy.getItemViewType(0), 10);
      this.jdField_a_of_type_Zjy.a(new zkl(this));
      new blsg(new zkf(this.jdField_a_of_type_Zjy)).attachToRecyclerView(this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374701));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374702));
      this.c = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374693));
      this.c.setOnClickListener(this);
      this.d = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374692));
      ...
      if (a())
      {
        ...
        zkg.a().a(this.jdField_a_of_type_Int);
      }
      return;
      i = 0;
      break;
  ...
  public String a()
  {
    if (this.jdField_a_of_type_Zjy != null) {
      return this.jdField_a_of_type_Zjy.a();
    }
    return "";
  }
  ...
  public void a()
  {
    ...
    for (int i1 = localList.size();; i1 = 0)
    {
      ...
      if (i1 > 0)
      {
        ...
        {
          this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167159));
          this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167159));
          if (this.d.getVisibility() != 0)
          {
            localObject = zkg.a().a().iterator();
            i = 0;
            j = 0;
            i2 = 0;
            if (((Iterator)localObject).hasNext())
      ...
      for (;;)
      {
        ...
        if (localSlideItemInfo.jdField_b_of_type_Int == 0)
        {
          ...
          if (m != 0)
          {
            ...
            localObject = "0";
            yup.a("pic_choose", "exp_autoCut", i3, 0, new String[] { localObject, i2 + "", j + "", i + "" });
            this.d.setVisibility(0);
            if (k == 0) {
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131698460, new Object[] { Integer.valueOf(this.jdField_a_of_type_Int / 1000) }));
            }
            this.jdField_a_of_type_AndroidWidgetTextView.setText(zkj.a(l));
          ...
          {
            if (this.jdField_a_of_type_Zjy != null) {
              this.jdField_a_of_type_Zjy.a(localList);
            }
            return;
            i3 = 1;
            break;
            ...
            if (n != 0)
            {
              this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131166898));
              this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167160));
            }
            for (;;)
            {
              this.d.setVisibility(8);
              break;
              this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167302));
            ...
            if (n != 0)
            {
              ...
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131698462));
            }
            for (;;)
            {
              ...
              break label674;
              label753:
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131698461));
            }
            bool = false;
            break label511;
            if (m == 0)
  ...
  {
    if (this.jdField_a_of_type_Zjy != null) {
      this.jdField_a_of_type_Zjy.a(paramInt);
    }
  }
  
  public void b()
  {
    List localList = zkg.a().a();
    if ((this.jdField_a_of_type_AndroidSupportV7WidgetLinearLayoutManager != null) && (this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView != null))
    {
      ...
      while (i <= j)
      {
        ...
        if (localObject != null)
        {
          ...
          if ((localObject instanceof zkb))
          {
            SlideItemInfo localSlideItemInfo1 = (SlideItemInfo)((zkb)localObject).a.getTag();
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131377795: 
      for (;;)
      {
        ...
        i = zkg.a().a().indexOf(localObject1);
        if ((this.jdField_a_of_type_Zkm != null) && (localObject1 != null)) {
          this.jdField_a_of_type_Zkm.a(((SlideItemInfo)localObject1).jdField_b_of_type_JavaLangString);
        }
        a(i);
      }
    case 2131374693: 
      ...
      for (;;)
      {
        try
        {
          ...
          yup.a("pic_fictitious", "clk_next", this.jdField_a_of_type_AndroidAppActivity.getIntent(), new String[0]);
          if ((!zkg.a().a()) || (this.jdField_a_of_type_AndroidAppActivity == null)) {
            break;
          }
          yup.a("video_edit_new", "change_pic", this.jdField_a_of_type_AndroidAppActivity.getIntent(), new String[0]);
        }
        catch (Exception localException) {}
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, blhk.a(localException));
        break;
        i = 1;
        break label117;
        label335:
    ...
    Object localObject2 = zkg.a().a().iterator();
    int k = 0;
    int j = 0;
    int i = 0;
    label455:
    ...
    for (;;)
    {
      ...
      if (localSlideItemInfo.jdField_b_of_type_Int == 0)
      {
        ...
        {
          yup.a("pic_choose", "clk_autoCut", n, 0, new String[] { localObject2, k + "", j + "", i + "" });
          zkg.a().i();
          break;
          m = 0;
          break label551;
