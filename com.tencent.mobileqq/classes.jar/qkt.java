...
public class qkt
{
  public static void a(List<ArticleInfo> paramList, String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      qkq.a().a(new FeedsPreloadExposeReport.1((pvj)localObject, paramList, paramString));
      return;
    }
  ...
  private static List<ReportInfo> b(List<ArticleInfo> paramList)
  {
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        Object localObject2;
        if ((pqw.s((BaseArticleInfo)localObject1)) && (((ArticleInfo)localObject1).mNewPolymericInfo != null) && (((ArticleInfo)localObject1).mNewPolymericInfo.a != null))
        {
          localObject1 = ((ArticleInfo)localObject1).mNewPolymericInfo.a.iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (rpt)((Iterator)localObject1).next();
            ReportInfo localReportInfo = new ReportInfo();
            localReportInfo.mUin = pkh.a();
            localReportInfo.mOperation = 56;
            localReportInfo.mSourceArticleId = ((rpt)localObject2).a;
            localReportInfo.mInnerId = ((rpt)localObject2).g;
            localReportInfo.mAlgorithmId = ((int)((rpt)localObject2).b);
