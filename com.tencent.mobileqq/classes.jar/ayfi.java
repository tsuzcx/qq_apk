...
{
  ayfi(ayfg paramayfg, TicketManager paramTicketManager, ReSendCmd paramReSendCmd) {}
  ...
  public void Done(Ticket paramTicket)
  {
    ...
    for (;;)
    {
      ...
      paramTicket = this.jdField_a_of_type_MqqManagerTicketManager.getSkey(this.jdField_a_of_type_Ayfg.mApp.getCurrentAccountUin());
      if ((!TextUtils.isEmpty(paramTicket)) && (paramTicket.length() > 0))
      {
        ayfg.b(this.jdField_a_of_type_Ayfg, 0);
        QLog.i("TeamWorkHandler", 1, "getSkeyFromServerAndRetry get skey from server success!");
      }
      ayfg.a(this.jdField_a_of_type_Ayfg, this.jdField_a_of_type_ComTencentMobileqqTeamworkReSendCmd);
      return;
