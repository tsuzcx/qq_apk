...
public class aizg
{
  ...
  public static android.graphics.drawable.Drawable a(Context paramContext, int paramInt1, int paramInt2, String paramString)
  {
    ...
    //   22: iload_1
    //   23: iload_2
    //   24: invokespecial 38	anov:<init>	(IFII)V
    //   27: astore 5
    //   29: new 27	anov
    //   32: dup
    //   33: ldc 29
    ...
    //   42: iload_1
    //   43: iload_2
    //   44: invokespecial 38	anov:<init>	(IFII)V
    //   47: astore_0
    //   48: new 27	anov
    //   51: dup
    //   52: aload_3
    ...
    //   60: iload_1
    //   61: iload_2
    //   62: invokespecial 38	anov:<init>	(IFII)V
    //   65: astore 4
    //   67: new 27	anov
    //   70: dup
    ...
    //   108: iload_1
    //   109: iload_2
    //   110: invokespecial 38	anov:<init>	(IFII)V
    //   113: astore_3
    //   114: aload_3
    //   115: sipush 204
  ...
  public static List<MessageForApollo> a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    Object localObject = paramQQAppInterface.a().b(paramString, paramInt);
    ...
    for (;;)
    {
      if ((paramQQAppInterface == null) || (paramQQAppInterface.size() == 0))
      {
        ...
        paramQQAppInterface = paramQQAppInterface.a().a(paramString, paramInt, new int[] { -2039 }, 20);
      }
      else
      {
  ...
  public static List<MessageForApollo> a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    Object localObject = paramQQAppInterface.a().b(paramString, paramInt1);
    if ((localObject != null) && (((List)localObject).size() > 0))
    {
      if (!QLog.isColorLevel()) {
        break label236;
    ...
    for (;;)
    {
      if ((paramQQAppInterface == null) || (paramQQAppInterface.size() == 0))
      {
        ...
        paramQQAppInterface = paramQQAppInterface.a().a(paramString, paramInt1, new int[] { -2039 }, 20);
      }
      else
      {
        paramString = new ArrayList();
  ...
  public static List<MessageForApollo> a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    Object localObject1 = paramQQAppInterface.a().b(paramString, paramInt1);
    ...
    for (;;)
    {
      if ((paramString == null) || (paramString.size() == 0))
      {
        ...
        paramString = paramQQAppInterface.a().a(paramString, paramInt1, new int[] { -2039 }, 20);
      }
      else
      {
        ...
        if (paramInt1 >= 0)
        {
          ...
          for (;;)
          {
            ...
            if ((((MessageForApollo)localObject2).gameId == paramInt2) && (((MessageForApollo)localObject2).roomId == paramLong))
            {
              ...
              if (a()) {
                localairv.a().a((MessageForApollo)localObject2);
              }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ApolloGameData paramApolloGameData, int paramInt)
  {
    ...
    if (!bbfd.a(paramContext, paramApolloGameData.gameAppPkgName))
    {
    ...
    ((airz)paramQQAppInterface.getManager(153)).a().a(paramApolloGameData.gameId, paramApolloGameData.gameAppid, 0, paramSessionInfo.jdField_a_of_type_JavaLangString, paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localajrf.e = 1;
        localajrf.d = 3;
        a(paramQQAppInterface, paramString, localajrf);
        return;
        localajrf.jdField_b_of_type_JavaLangString = ajyc.a(2131702105);
        i = 0;
      }
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, ajrf paramajrf)
  {
    if ((paramajrf == null) || (paramQQAppInterface == null))
    {
      QLog.e("CmGameTemp_CmGameSessionUtil", 1, "[sendGameMsg], errInfo->param is null.");
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("CmGameTemp_CmGameSessionUtil", 2, new Object[] { "[sendGameMsg], gameId:", Integer.valueOf(paramajrf.jdField_a_of_type_Int), ",roomId:", Long.valueOf(paramajrf.jdField_a_of_type_Long), ",extendInfo:", paramajrf.jdField_c_of_type_JavaLangString });
    }
    ApolloMessage localApolloMessage = new ApolloMessage();
    if (!TextUtils.isEmpty(paramajrf.jdField_a_of_type_JavaLangString)) {
      localApolloMessage.name = paramajrf.jdField_a_of_type_JavaLangString.getBytes();
    }
    if (0 == 0) {}
    for (;;)
    {
      try
      {
        ...
        ((JSONObject)localObject).put("gameId", paramajrf.jdField_a_of_type_Int);
        ((JSONObject)localObject).put("gameMode", paramajrf.jdField_c_of_type_Int);
        ((JSONObject)localObject).put("roomid", paramajrf.jdField_a_of_type_Long);
        if (paramajrf.jdField_a_of_type_Int == 1)
        {
          ((JSONObject)localObject).put("msgTyep", 2);
          ((JSONObject)localObject).put("gameName", paramajrf.jdField_b_of_type_JavaLangString);
          if (!TextUtils.isEmpty(paramajrf.jdField_c_of_type_JavaLangString)) {
            ((JSONObject)localObject).put("gameExtendJson", paramajrf.jdField_c_of_type_JavaLangString);
          }
          ((JSONObject)localObject).put("gameStatus", paramajrf.e);
          if (localObject != null) {
            localApolloMessage.extStr = ((JSONObject)localObject).toString();
          }
          localObject = ((airz)paramQQAppInterface.getManager(153)).b(paramQQAppInterface.getCurrentAccountUin());
          localApolloMessage.sender_ts = bbbd.a(((ApolloBaseInfo)localObject).apolloServerTS);
          localApolloMessage.sender_status = ((ApolloBaseInfo)localObject).apolloStatus;
          localObject = ((ajmw)paramQQAppInterface.getManager(155)).a(paramajrf.jdField_a_of_type_Int);
          if ((localObject == null) || (1 != ((ApolloGameData)localObject).hasOwnArk)) {
            break label511;
          }
          i = 297;
          localApolloMessage.flag = (i | 0x200);
          paramString = axaq.a(paramQQAppInterface, paramString, paramQQAppInterface.getCurrentAccountUin(), 1036, localApolloMessage);
          if (paramajrf.jdField_a_of_type_Int == 1)
          {
            paramString.msgType = 2;
            paramString.gameId = paramajrf.jdField_a_of_type_Int;
            paramString.mGameMode = paramajrf.jdField_c_of_type_Int;
            paramString.roomId = paramajrf.jdField_a_of_type_Long;
            paramString.mApolloMessage.id = paramajrf.jdField_b_of_type_Int;
            paramString.gameName = paramajrf.jdField_b_of_type_JavaLangString;
            paramString.gameExtendJson = paramajrf.jdField_c_of_type_JavaLangString;
            paramString.gameStatus = paramajrf.e;
            paramString.extendJson = ("{\"gameStatus\":" + paramajrf.e + "}");
        ...
        {
          ((JSONObject)localObject).put("msgTyep", paramajrf.d);
          continue;
        }
        paramString.msgType = paramajrf.d;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    ((airz)paramQQAppInterface.getManager(153)).a().b(paramString1, paramString2);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, long paramLong, int paramInt)
  {
    ...
    ApolloGameData localApolloGameData = ((ajmw)localObject2).a(paramInt);
    Object localObject1 = ajyc.a(2131702104);
    if ((localApolloGameData != null) && (!TextUtils.isEmpty(localApolloGameData.name)))
    {
      localObject2 = ((ajmw)localObject2).a(localApolloGameData.actionId);
    ...
    for (;;)
    {
      int i = localApolloGameData.actionId;
      localajrf.jdField_b_of_type_JavaLangString = localApolloGameData.name;
      localajrf.jdField_a_of_type_JavaLangString = ((String)localObject1);
      localajrf.jdField_b_of_type_Int = i;
      localajrf.jdField_a_of_type_Int = paramInt;
      localajrf.jdField_a_of_type_Long = paramLong;
      localajrf.e = 0;
      ...
      if (!TextUtils.isEmpty(localajrf.jdField_a_of_type_JavaLangString)) {
        ((ApolloMessage)localObject2).name = localajrf.jdField_a_of_type_JavaLangString.getBytes();
      }
      localObject1 = null;
      if (0 == 0) {}
      for (;;)
      {
        try
        {
          ...
          ((JSONObject)localObject1).put("gameId", localajrf.jdField_a_of_type_Int);
          ((JSONObject)localObject1).put("gameMode", localajrf.jdField_c_of_type_Int);
          ((JSONObject)localObject1).put("roomid", localajrf.jdField_a_of_type_Long);
          if (localajrf.jdField_a_of_type_Int == 1)
          {
            ((JSONObject)localObject1).put("msgTyep", 2);
            ((JSONObject)localObject1).put("gameName", localajrf.jdField_b_of_type_JavaLangString);
            if (!TextUtils.isEmpty(localajrf.jdField_c_of_type_JavaLangString)) {
              ((JSONObject)localObject1).put("gameExtendJson", localajrf.jdField_c_of_type_JavaLangString);
            }
            ((JSONObject)localObject1).put("gameStatus", localajrf.e);
            if (localObject1 != null) {
              ((ApolloMessage)localObject2).extStr = ((JSONObject)localObject1).toString();
            }
            localObject1 = ((airz)paramQQAppInterface.getManager(153)).b(paramQQAppInterface.getCurrentAccountUin());
            ((ApolloMessage)localObject2).sender_ts = bbbd.a(((ApolloBaseInfo)localObject1).apolloServerTS);
            ...
            localObject1 = axaq.a(paramQQAppInterface, paramString1, paramQQAppInterface.getCurrentAccountUin(), 1036, (ApolloMessage)localObject2);
            if (localajrf.jdField_a_of_type_Int != 1) {
              break label698;
            }
            ((MessageForApollo)localObject1).msgType = 2;
            ((MessageForApollo)localObject1).gameId = localajrf.jdField_a_of_type_Int;
            ((MessageForApollo)localObject1).mGameMode = localajrf.jdField_c_of_type_Int;
            ((MessageForApollo)localObject1).roomId = localajrf.jdField_a_of_type_Long;
            ((MessageForApollo)localObject1).mApolloMessage.id = localajrf.jdField_b_of_type_Int;
            ((MessageForApollo)localObject1).gameName = localajrf.jdField_b_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameExtendJson = localajrf.jdField_c_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameStatus = localajrf.e;
            ((MessageForApollo)localObject1).extendJson = ("{\"gameStatus\":" + localajrf.e + ",\"robotOpenId\":" + paramString2 + "}");
            ...
            jdField_a_of_type_Long = System.currentTimeMillis();
            return;
            localajrf.jdField_b_of_type_JavaLangString = ajyc.a(2131702106);
            i = 0;
            break;
          }
          ((JSONObject)localObject1).put("msgTyep", localajrf.d);
          continue;
          ((MessageForApollo)localObject1).msgType = localajrf.d;
        }
        catch (Throwable paramQQAppInterface)
        {
          QLog.d("CmGameTemp_CmGameSessionUtil", 2, paramQQAppInterface, new Object[0]);
  ...
  public static boolean a()
  {
    if ((BaseActivity.sTopActivity instanceof FragmentActivity))
    {
      ...
      if (localObject != null)
      {
        ...
        if (!(localObject instanceof aena)) {}
      }
    }
    for (Object localObject = (aena)localObject;; localObject = null) {
      return (localObject != null) && (((aena)localObject).D());
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      localSessionInfo.jdField_b_of_type_JavaLangString = paramQQAppInterface.getCurrentAccountUin();
      ...
      aaod.b(paramQQAppInterface, localSessionInfo, (ArkAppMessage)localObject);
      return true;
    }
