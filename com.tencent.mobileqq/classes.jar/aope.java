  ...
  implements aopk
{
  ...
  /* Error */
  public long a(axsq paramaxsq, aoph paramaoph)
  {
    // Byte code:
    //   0: new 30	java/io/ByteArrayInputStream
    //   3: dup
    //   4: aload_1
    //   5: getfield 35	axsq:a	[B
    ...
    //   39: aload_2
    //   40: ldc2_w 54
    //   43: putfield 59	aoph:jdField_a_of_type_Long	J
    //   46: aload_2
    //   47: ldc 61
    //   49: putfield 62	aoph:c	Ljava/lang/String;
    //   52: aload_0
    //   53: aload_2
    //   54: invokevirtual 65	aope:a	(Laoph;)V
    //   57: aload_1
    ...
    //   109: lstore 4
    //   111: aload_2
    //   112: getfield 78	aoph:h	J
    //   115: lconst_0
    //   116: lcmp
    //   117: ifne +9 -> 126
    //   120: aload_2
    //   121: lload 4
    //   123: putfield 78	aoph:h	J
    //   126: aload_2
    //   127: lload 4
    //   129: aload_2
    //   130: getfield 78	aoph:h	J
    //   133: lsub
    //   134: putfield 81	aoph:i	J
    //   137: aload_1
    ...
    //   154: aload_2
    //   155: lconst_0
    //   156: putfield 59	aoph:jdField_a_of_type_Long	J
    //   159: aload_2
    //   160: aload_2
    //   161: getfield 84	aoph:e	J
    //   164: lconst_1
    //   165: ladd
    //   166: putfield 87	aoph:f	J
    //   169: aload_0
    //   170: aload_2
    //   171: invokevirtual 89	aope:b	(Laoph;)V
    //   174: aload_1
    ...
    //   188: aload_2
    //   189: ldc2_w 54
    //   192: putfield 59	aoph:jdField_a_of_type_Long	J
    //   195: aload_2
    //   196: ldc 91
    //   198: putfield 62	aoph:c	Ljava/lang/String;
    //   201: aload_0
    //   202: aload_2
    //   203: invokevirtual 65	aope:a	(Laoph;)V
    //   206: aload_1
    ...
    //   0	265	0	this	aope
    //   0	265	1	paramaxsq	axsq
    //   0	265	2	paramaoph	aoph
    //   82	70	3	i	int
    //   99	48	4	l	long
  ...
  {
    this.jdField_a_of_type_Aopi.a(paramLong1, paramLong2);
  }
  
  public void a(aoph paramaoph)
  {
    QLog.i("DiscFileUploader<FileAssistant>", 1, "=_= ^! [Upload Step] Send Error!:" + paramaoph.c);
    paramaoph.c();
    this.jdField_a_of_type_Aopi.a(null, 0);
  }
  
  public void a(String paramString1, String paramString2, long paramLong, aopi paramaopi)
  {
  ...
  public void a(boolean paramBoolean, aoph paramaoph) {}
  
  public byte[] a(byte[] paramArrayOfByte, long paramLong, aoph paramaoph)
  {
    if ((this.jdField_a_of_type_JavaLangString == null) || (this.b == null) || (this.jdField_a_of_type_JavaLangString.length() == 0) || (this.b.length() == 0))
    {
      ...
      paramaoph.jdField_a_of_type_Long = 9005L;
      a(paramaoph);
      return null;
    }
    ...
    catch (IOException paramArrayOfByte)
    {
      ...
      paramaoph.jdField_a_of_type_Long = 9003L;
      paramaoph.c = apck.a();
      a(paramaoph);
      try
      {
