  ...
  implements Manager
{
  ...
  private WeakReference<akou> jdField_a_of_type_MqqUtilWeakReference;
  private WeakReference<akov> b;
  
  public akos(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Akou = new akot(this);
  ...
  private boolean a()
  {
    ...
    if ((aknx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) && (localaknx != null) && (1 == localaknx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()))) {
      return true;
    }
  ...
  public void a(int paramInt, apollo_push_msgInfo.STPushMsgElem paramSTPushMsgElem)
  {
    ...
    for (;;)
    {
      ...
      ((aliw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramSTPushMsgElem);
      ...
      if ((!TextUtils.isEmpty(str)) && (!str.equals(localObject))) {
        aknx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, "apllo_redPack_action");
      }
      if ((TextUtils.isEmpty(str)) || (str.equals(paramSTPushMsgElem))) {
        break;
      }
      aknx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSTPushMsgElem, "apllo_redPack_action");
      return;
  ...
  public void a(akou paramakou)
  {
    ...
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramakou);
  }
  ...
  public void a(akov paramakov)
  {
    ...
    this.b = new WeakReference(paramakov);
  }
  ...
  public void a(ApolloActionPush paramApolloActionPush)
  {
    ...
    if (paramApolloActionPush.mWordShowType == 1)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        ...
        localObject2 = ((aliw)localObject1).a(localSpriteTaskParam.f);
        if (localObject2 == null) {
          break label253;
        }
        if (TextUtils.isEmpty(localSpriteTaskParam.jdField_c_of_type_JavaLangString)) {
          localSpriteTaskParam.jdField_c_of_type_JavaLangString = algj.a(((ApolloActionData)localObject2).bubbleText);
        }
      }
    }
    for (;;)
    {
      localObject1 = albi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localObject1 != null) {
        ((albf)localObject1).a().a(localSpriteTaskParam);
      }
      ...
      ((aliw)localObject1).a((List)localObject2);
    }
  }
  ...
  public void a(apollo_push_msgInfo.STPushMsgElem paramSTPushMsgElem)
  {
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          if ((a()) && ("tab_list_android_json_v665".equals(localObject1)))
          {
            ...
            if (m > i)
            {
              ((aknx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(true, "onLinePush", 1);
              if (!QLog.isColorLevel()) {
                continue;
              }
            ...
            if ((a()) && (amqn.a().equals(localObject1)))
            {
              i = 0;
              localObject1 = new File(aliu.av);
              if (!((File)localObject1).exists())
              {
                ...
                i = 1;
                localObject1 = aliu.av + "base.zip";
                if (i != 0)
                {
                  localObject2 = new Bundle();
                  ((Bundle)localObject2).putLong("version", m);
                  aldv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1, aliu.at, (Bundle)localObject2, new amqp());
                }
                if (!QLog.isColorLevel()) {
                  continue;
                }
              ...
              if ("apollo_thunder_json_v670".equals(localObject1)) {
                alfs.a(null, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, m, false);
              }
            }
          }
        }
      ...
      for (;;)
      {
        try
        {
          ...
          l = ((aknx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(1, i) / 1000L;
          if (l != m) {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!aknx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) || (localObject2 == null) || (1 != ((aknx)localObject2).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()))) {
          break;
        }
        i = Integer.parseInt(localException1);
        l = ((aknx)localObject2).a(2, i) / 1000L;
        if (l != m) {
          aldv.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), null, -1, new int[] { i }, -1, -1, true);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
    ...
    if ((localObject2 != null) && (((List)localObject2).size() > 0))
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if (localSTPushMsgElem0x3.dotId.get() != 1003)
        {
          ...
          ((awgf)localObject1).b((awge)localObject3);
          ...
          ApolloGameUtil.a((awgf)localObject1);
        }
        for (;;)
        {
          break;
          ...
          if (this.b != null)
          {
            ...
            if (this.b.get() != null)
            {
              ...
              {
                j = 2;
                ((akov)this.b.get()).a(1, localObject3);
              }
            }
          }
          i = j;
      ...
      localObject1 = (aliw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
      if (localObject1 != null) {
        ((aliw)localObject1).a(paramSTPushMsgElem, i);
      }
      for (;;)
      {
        ((alug)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(255)).a(NetConnInfoCenter.getServerTimeMillis());
        return;
