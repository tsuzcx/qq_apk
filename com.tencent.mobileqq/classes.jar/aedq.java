...
public class aedq
  extends aeev
  implements Handler.Callback, blih, bljm, blma
{
  ...
  private boolean a(asuo paramasuo, boolean paramBoolean)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryFileActivity != null) {
      if (paramasuo.jdField_a_of_type_Boolean != paramBoolean)
      {
        if (!paramBoolean) {
          break label46;
        }
        ...
        paramasuo.jdField_a_of_type_Boolean = true;
        this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryFileActivity.a(paramasuo);
      }
    }
    for (;;)
    {
      return true;
      label46:
      paramasuo.jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryFileActivity.b(paramasuo);
      continue;
      if ((this.jdField_a_of_type_Aedr != null) && (paramasuo.jdField_a_of_type_Boolean != paramBoolean))
      {
        if (paramBoolean)
        {
          if (this.jdField_a_of_type_Aedr.a()) {
            break;
          }
          paramasuo.jdField_a_of_type_Boolean = true;
          this.jdField_a_of_type_Aedr.a(paramasuo);
          continue;
        }
        paramasuo.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_Aedr.b(paramasuo);
      }
    }
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Asua != null) {
      this.jdField_a_of_type_Asua.a();
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Asua.a() <= paramInt);
      localObject = this.jdField_a_of_type_Asua.a(paramInt);
    } while (!asuo.class.isInstance(localObject));
    Object localObject = (asuo)localObject;
    this.jdField_d_of_type_Boolean = ((asuo)localObject).jdField_a_of_type_Boolean;
    if (!this.jdField_d_of_type_Boolean) {}
    for (boolean bool = true;; bool = false)
    {
      if (a((asuo)localObject, bool)) {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject = this.jdField_a_of_type_Asua.a(paramInt1);
        if (asuo.class.isInstance(localObject)) {
          break;
        }
        paramInt1 += 1;
      }
    ...
    if (paramInt1 <= this.jdField_c_of_type_Int)
    {
      ...
      for (;;)
      {
        paramInt1 += 1;
        break;
        a((asuo)localObject, this.jdField_d_of_type_Boolean);
      }
    }
  ...
  {
    Object localObject = this.jdField_a_of_type_Asua.a();
    if (localObject != null)
    {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        this.jdField_a_of_type_Blhq.post(new ChatHistoryEmotionView.4(this));
        return;
      }
      g();
      return;
  ...
  public void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    this.jdField_a_of_type_Asui = new asui(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Int);
    ...
    this.jdField_a_of_type_Asua = new asua(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Asui, this.jdField_a_of_type_Blhq, m, this.jdField_a_of_type_ComTencentWidgetGestureSelectGridView);
    this.jdField_a_of_type_Asua.a(true);
    this.jdField_a_of_type_Asua.a(this.jdField_b_of_type_Int);
    this.jdField_a_of_type_ComTencentWidgetGestureSelectGridView.setAdapter(this.jdField_a_of_type_Asua);
  ...
  {
    if (this.jdField_a_of_type_Asua != null) {
      return this.jdField_a_of_type_Asua.a();
    }
    return false;
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Asua.b();
  }
  
  public void e()
  {
    if (!this.jdField_a_of_type_Asua.jdField_a_of_type_Boolean)
    {
      this.jdField_b_of_type_Boolean = true;
      this.jdField_a_of_type_Asua.jdField_a_of_type_Boolean = true;
  ...
  public void f()
  {
    if (this.jdField_a_of_type_Asua.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Asua.jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_ComTencentWidgetGestureSelectGridView.setSelectMode(false);
      this.jdField_a_of_type_Asua.notifyDataSetChanged();
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (paramMessage.obj == null)
      {
        ...
        this.jdField_a_of_type_Asua.a((List)localObject);
      }
      for (;;)
      {
        ...
        this.jdField_a_of_type_Aedr.a();
        return false;
        localObject = (List)paramMessage.obj;
        break;
        this.jdField_a_of_type_Asua.b((List)localObject);
  ...
  {
    paramAdapterView = this.jdField_a_of_type_Asua.getItem(paramInt);
    if (!asuo.class.isInstance(paramAdapterView)) {}
    for (;;)
    {
      return;
      paramAdapterView = (asuo)paramAdapterView;
      if (!this.jdField_b_of_type_Boolean) {
        break;
      }
    ...
    AIOEmotionFragment.a(paramView.getContext(), paramAdapterView.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, localSessionInfo, abke.a(paramView));
  }
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    if (paramInt == 0)
    {
      ...
      int i = this.jdField_a_of_type_Asua.a();
      int j = this.jdField_a_of_type_Asua.b();
