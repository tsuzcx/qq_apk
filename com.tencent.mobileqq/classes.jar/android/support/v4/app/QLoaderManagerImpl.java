...
class QLoaderManagerImpl
  extends QLoaderManager
{
  static boolean DEBUG = false;
  static final String TAG = "LoaderManager";
  QFragmentActivity mActivity;
  boolean mCreatingLoader;
  final SparseArrayCompat<QLoaderManagerImpl.LoaderInfo> mInactiveLoaders = new SparseArrayCompat();
  final SparseArrayCompat<QLoaderManagerImpl.LoaderInfo> mLoaders = new SparseArrayCompat();
  boolean mRetaining;
  boolean mRetainingStarted;
  boolean mStarted;
  final String mWho;
  
  QLoaderManagerImpl(String paramString, QFragmentActivity paramQFragmentActivity, boolean paramBoolean)
  {
  ...
  private QLoaderManagerImpl.LoaderInfo createAndInstallLoader(int paramInt, Bundle paramBundle, QLoaderManager.LoaderCallbacks<Object> paramLoaderCallbacks)
  {
    try
    {
  ...
  private QLoaderManagerImpl.LoaderInfo createLoader(int paramInt, Bundle paramBundle, QLoaderManager.LoaderCallbacks<Object> paramLoaderCallbacks)
  {
    QLoaderManagerImpl.LoaderInfo localLoaderInfo = new QLoaderManagerImpl.LoaderInfo(this, paramInt, paramBundle, paramLoaderCallbacks);
  ...
  public void destroyLoader(int paramInt)
  {
    ...
    QLoaderManagerImpl.LoaderInfo localLoaderInfo;
    if (i >= 0)
    {
      localLoaderInfo = (QLoaderManagerImpl.LoaderInfo)this.mLoaders.valueAt(i);
    ...
    if (paramInt >= 0)
    {
      localLoaderInfo = (QLoaderManagerImpl.LoaderInfo)this.mInactiveLoaders.valueAt(paramInt);
  ...
  void doDestroy()
  {
    if (!this.mRetaining)
    {
      ...
      while (i >= 0)
      {
        ((QLoaderManagerImpl.LoaderInfo)this.mLoaders.valueAt(i)).destroy();
        i -= 1;
      }
      this.mLoaders.clear();
    }
    ...
    while (i >= 0)
    {
      ((QLoaderManagerImpl.LoaderInfo)this.mInactiveLoaders.valueAt(i)).destroy();
      i -= 1;
    }
  ...
  void doReportNextStart()
  {
    ...
    while (i >= 0)
    {
      ((QLoaderManagerImpl.LoaderInfo)this.mLoaders.valueAt(i)).mReportNextStart = true;
      i -= 1;
    }
  }
  ...
  void doReportStart()
  {
    ...
    while (i >= 0)
    {
      ((QLoaderManagerImpl.LoaderInfo)this.mLoaders.valueAt(i)).reportStart();
      i -= 1;
    }
  }
  ...
  void doRetain()
  {
    ...
    for (;;)
    {
      ...
      while (i >= 0)
      {
        ((QLoaderManagerImpl.LoaderInfo)this.mLoaders.valueAt(i)).retain();
        i -= 1;
      }
    }
  }
  ...
  void doStart()
  {
    ...
    for (;;)
    {
      ...
      while (i >= 0)
      {
        ((QLoaderManagerImpl.LoaderInfo)this.mLoaders.valueAt(i)).start();
        i -= 1;
      }
    }
  }
  ...
  void doStop()
  {
    ...
    while (i >= 0)
    {
      ((QLoaderManagerImpl.LoaderInfo)this.mLoaders.valueAt(i)).stop();
      i -= 1;
    }
    this.mStarted = false;
  }
  ...
  public void dump(String paramString, FileDescriptor paramFileDescriptor, PrintWriter paramPrintWriter, String[] paramArrayOfString)
  {
    ...
    if (this.mInactiveLoaders.size() > 0)
    {
      ...
      {
        localLoaderInfo = (QLoaderManagerImpl.LoaderInfo)this.mInactiveLoaders.valueAt(i);
        paramPrintWriter.print(paramString);
        paramPrintWriter.print("  #");
  ...
  void finishRetain()
  {
    if (this.mRetaining)
    {
      ...
      while (i >= 0)
      {
        ((QLoaderManagerImpl.LoaderInfo)this.mLoaders.valueAt(i)).finishRetain();
        i -= 1;
      }
    }
  }
  ...
  public <D> Loader<D> getLoader(int paramInt)
  {
    ...
    QLoaderManagerImpl.LoaderInfo localLoaderInfo = (QLoaderManagerImpl.LoaderInfo)this.mLoaders.get(paramInt);
  ...
  public boolean hasRunningLoaders()
  {
    ...
    if (i < j)
    {
      QLoaderManagerImpl.LoaderInfo localLoaderInfo = (QLoaderManagerImpl.LoaderInfo)this.mLoaders.valueAt(i);
  ...
  public <D> Loader<D> initLoader(int paramInt, Bundle paramBundle, QLoaderManager.LoaderCallbacks<D> paramLoaderCallbacks)
  {
    if (this.mCreatingLoader) {
      throw new IllegalStateException("Called while creating a loader");
    }
  ...
  void installLoader(QLoaderManagerImpl.LoaderInfo paramLoaderInfo)
  {
  ...
  public <D> Loader<D> restartLoader(int paramInt, Bundle paramBundle, QLoaderManager.LoaderCallbacks<D> paramLoaderCallbacks)
  {
    if (this.mCreatingLoader) {
      throw new IllegalStateException("Called while creating a loader");
    }
    QLoaderManagerImpl.LoaderInfo localLoaderInfo1 = (QLoaderManagerImpl.LoaderInfo)this.mLoaders.get(paramInt);
    if ((DEBUG) && (QLog.isDevelopLevel())) {
      QLog.d("LoaderManager", 4, "restartLoader in " + this + ": args=" + paramBundle);
    }
    if (localLoaderInfo1 != null)
    {
      QLoaderManagerImpl.LoaderInfo localLoaderInfo2 = (QLoaderManagerImpl.LoaderInfo)this.mInactiveLoaders.get(paramInt);
  ...
  void updateActivity(QFragmentActivity paramQFragmentActivity)
  {
    this.mActivity = paramQFragmentActivity;
  }
}
 ...
 * Qualified Name:     android.support.v4.app.QLoaderManagerImpl
