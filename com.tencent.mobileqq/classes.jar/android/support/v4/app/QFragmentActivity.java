...
public class QFragmentActivity
  extends QBaseActivity
{
  ...
  SimpleArrayMap<String, QLoaderManagerImpl> mAllLoaderManagers;
  boolean mCheckedForLoaderManager;
  final QFragmentContainer mContainer = new QFragmentActivity.2(this);
  boolean mCreated;
  final QFragmentManagerImpl mFragments = new QFragmentManagerImpl();
  final Handler mHandler = new QFragmentActivity.1(this);
  QFragment.IFragmentAttachCallback mIFragmentAttachCallback;
  QLoaderManagerImpl mLoaderManager;
  ...
  public void doOnActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (i != 0)
    {
      ...
      {
        return;
        localQFragment = (QFragment)this.mFragments.mActive.get(i);
      ...
      return;
      localQFragment.onActivityResult(0xFFFF & paramInt1, paramInt2, paramIntent);
      return;
    }
  ...
  public boolean doOnCreate(Bundle paramBundle)
  {
    ...
    QFragmentActivity.NonConfigurationInstances localNonConfigurationInstances = (QFragmentActivity.NonConfigurationInstances)getLastNonConfigurationInstance();
    if (localNonConfigurationInstances != null) {
      this.mAllLoaderManagers = localNonConfigurationInstances.loaders;
    }
    Parcelable localParcelable;
    QFragmentManagerImpl localQFragmentManagerImpl;
    if (paramBundle != null)
    {
      localParcelable = paramBundle.getParcelable("android:support:fragments");
      localQFragmentManagerImpl = this.mFragments;
      if (localNonConfigurationInstances == null) {
        break label102;
      }
    }
    ...
    {
      localQFragmentManagerImpl.restoreAllState(localParcelable, paramBundle);
  ...
  public void doOnStart()
  {
    ...
    int j;
    QLoaderManagerImpl[] arrayOfQLoaderManagerImpl;
    for (;;)
    {
      ...
      arrayOfQLoaderManagerImpl = new QLoaderManagerImpl[j];
      i = j - 1;
      while (i >= 0)
      {
        arrayOfQLoaderManagerImpl[i] = ((QLoaderManagerImpl)this.mAllLoaderManagers.valueAt(i));
        i -= 1;
      }
      label143:
    ...
    while (i < j)
    {
      QLoaderManagerImpl localQLoaderManagerImpl = arrayOfQLoaderManagerImpl[i];
      localQLoaderManagerImpl.finishRetain();
      localQLoaderManagerImpl.doReportStart();
      i += 1;
    }
  }
  ...
  QLoaderManagerImpl getLoaderManager(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (this.mAllLoaderManagers == null) {
      this.mAllLoaderManagers = new SimpleArrayMap();
    }
    QLoaderManagerImpl localQLoaderManagerImpl = (QLoaderManagerImpl)this.mAllLoaderManagers.get(paramString);
    if (localQLoaderManagerImpl == null)
    {
      if (paramBoolean2)
      {
        localQLoaderManagerImpl = new QLoaderManagerImpl(paramString, this, paramBoolean1);
        this.mAllLoaderManagers.put(paramString, localQLoaderManagerImpl);
      }
      return localQLoaderManagerImpl;
    }
    localQLoaderManagerImpl.updateActivity(this);
    return localQLoaderManagerImpl;
  }
  
  public QFragmentManager getSupportFragmentManager()
  {
    return this.mFragments;
  }
  
  public QLoaderManager getSupportLoaderManager()
  {
    if (this.mLoaderManager != null) {
  ...
  public QFragmentManager getThisFragmentManager()
  {
    return this.mFragments;
  }
  ...
  void invalidateSupportFragment(String paramString)
  {
    ...
    {
      QLoaderManagerImpl localQLoaderManagerImpl = (QLoaderManagerImpl)this.mAllLoaderManagers.get(paramString);
      if ((localQLoaderManagerImpl != null) && (!localQLoaderManagerImpl.mRetaining))
      {
        localQLoaderManagerImpl.doDestroy();
        this.mAllLoaderManagers.remove(paramString);
      }
    }
  }
  
  public void onAttachFragment(QFragment paramQFragment)
  {
    if (this.mIFragmentAttachCallback != null) {
      this.mIFragmentAttachCallback.onFragmentAttached(paramQFragment);
    }
  }
  ...
  public View onCreateView(String paramString, Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    TypedArray localTypedArray = paramContext.obtainStyledAttributes(paramAttributeSet, QFragmentActivity.FragmentTag.Fragment);
    String str1 = str2;
    if (str2 == null) {
    ...
    if (!QFragment.isSupportFragmentClass(this, str1)) {
      return super.onCreateView(paramString, paramContext, paramAttributeSet);
    }
    if (0 != 0) {
    ...
    if (paramContext == null)
    {
      paramContext = QFragment.instantiate(this, str1);
  ...
  public final Object onRetainNonConfigurationInstance()
  {
    ...
    if (this.mAllLoaderManagers != null)
    {
      ...
      localObject2 = new QLoaderManagerImpl[m];
      int i = m - 1;
      while (i >= 0)
      {
        localObject2[i] = ((QLoaderManagerImpl)this.mAllLoaderManagers.valueAt(i));
        i -= 1;
      }
      i = 0;
      k = i;
    ...
    Object localObject2 = new QFragmentActivity.NonConfigurationInstances();
    ((QFragmentActivity.NonConfigurationInstances)localObject2).activity = null;
    ((QFragmentActivity.NonConfigurationInstances)localObject2).custom = localObject1;
    ((QFragmentActivity.NonConfigurationInstances)localObject2).children = null;
    ((QFragmentActivity.NonConfigurationInstances)localObject2).fragments = localArrayList;
    ((QFragmentActivity.NonConfigurationInstances)localObject2).loaders = this.mAllLoaderManagers;
    return localObject2;
  }
  
  public void setFragmentAttachListener(QFragment.IFragmentAttachCallback paramIFragmentAttachCallback)
  {
  ...
  public void startActivityFromFragment(QFragment paramQFragment, Intent paramIntent, int paramInt)
  {
    if (paramInt == -1)
    {
    ...
    super.startActivityForResult(paramIntent, (paramQFragment.mIndex + 1 << 16) + (0xFFFF & paramInt));
  }
 ...
 * Qualified Name:     android.support.v4.app.QFragmentActivity
