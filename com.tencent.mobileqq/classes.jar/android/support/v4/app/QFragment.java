  ...
  implements ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  QFragmentManagerImpl mChildFragmentManager;
  ViewGroup mContainer;
  int mContainerId;
  boolean mDeferStart;
  boolean mDetached;
  int mFragmentId;
  QFragmentManagerImpl mFragmentManager;
  boolean mFromLayout;
  boolean mHasMenu;
  boolean mHidden;
  QFragment.IFragmentLifecycleCallback mIFragmentLifecycleCallback;
  boolean mInLayout;
  int mIndex = -1;
  View mInnerView;
  ...
  public static QFragment instantiate(Context paramContext, String paramString)
  {
    return instantiate(paramContext, paramString, null);
  }
  
  public static QFragment instantiate(Context paramContext, String paramString, Bundle paramBundle)
  {
    try
    {
      ...
      paramContext = (QFragment)localClass1.newInstance();
      if (paramBundle != null)
      {
    ...
    {
      throw new QFragment.InstantiationException("Unable to instantiate fragment " + paramString + ": make sure class name exists, is public, and has an empty constructor that is public", paramContext);
    }
  ...
  static boolean isSupportFragmentClass(Context paramContext, String paramString)
  {
    try
    {
      ...
      boolean bool = QFragment.class.isAssignableFrom(localClass1);
      return bool;
    }
    catch (ClassNotFoundException paramContext) {}
    return false;
  ...
  QFragment findFragmentByWho(String paramString)
  {
  ...
  public final QFragmentActivity getActivity()
  {
  ...
  public final QFragmentManager getChildFragmentManager()
  {
    if (this.mChildFragmentManager == null)
    {
  ...
  public final QFragmentManager getFragmentManager()
  {
  ...
  public QLoaderManager getLoaderManager()
  {
    if (this.mLoaderManager != null) {
  ...
  public final QFragment getParentFragment()
  {
  ...
  public final QFragment getTargetFragment()
  {
    return this.mTarget;
  }
  ...
  {
    this.mChildFragmentManager = new QFragmentManagerImpl();
    this.mChildFragmentManager.attachActivity(this.mActivity, new QFragment.1(this), this);
  }
  ...
  public void setFragmentLifecycleCallback(QFragment.IFragmentLifecycleCallback paramIFragmentLifecycleCallback)
  {
  ...
  final void setIndex(int paramInt, QFragment paramQFragment)
  {
    this.mIndex = paramInt;
    if (paramQFragment != null)
    {
      this.mWho = (paramQFragment.mWho + ":" + this.mIndex);
      return;
    }
    this.mWho = ("android:fragment:" + this.mIndex);
  }
  
  public void setInitialSavedState(QFragment.SavedState paramSavedState)
  {
    if (this.mIndex >= 0) {
      throw new IllegalStateException("Fragment already active");
    }
  ...
  public void setTargetFragment(QFragment paramQFragment, int paramInt)
  {
    this.mTarget = paramQFragment;
 ...
 * Qualified Name:     android.support.v4.app.QFragment
