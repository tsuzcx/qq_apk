  ...
  extends pbh
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = pcb.class.getSimpleName();
  }
  
  public pcb(AppInterface paramAppInterface, aukn paramaukn, ExecutorService paramExecutorService, pou parampou, Handler paramHandler)
  {
  ...
  private void a(int paramInt, BaseVideoArticleInfo paramBaseVideoArticleInfo)
  {
    ...
    do
    {
      ...
      localotp = (otp)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(274);
    } while (localotp == null);
    long l = NetConnInfoCenter.getServerTime();
    localotp.a(sgj.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramBaseVideoArticleInfo), l);
  }
  ...
  private void a(boolean paramBoolean1, int paramInt, boolean paramBoolean2, List<WeiShiVideoArticleInfo> paramList, long paramLong1, long paramLong2)
  {
    ...
    if (!paramBoolean1)
    {
      osm.a().b(false, paramInt, null, false);
      return;
    }
    if (paramList == null)
    {
      osm.a().b(true, paramInt, null, true);
      return;
    }
    ...
    osm.a().b(true, paramInt, paramList, paramBoolean1);
  }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0)
    {
      ...
      paramFromServiceMsg = quo.a(localRspBody.rspChannelArticle.rpt_article_list.get(), i, j);
      bool2 = true;
    }
    for (;;)
    {
  ...
  private void b(boolean paramBoolean1, int paramInt, boolean paramBoolean2, List<WeiShiVideoArticleInfo> paramList, long paramLong1, long paramLong2, ToServiceMsg paramToServiceMsg)
  {
    ...
    {
      paramList = b(Integer.valueOf(paramInt));
      osm.a().a(paramBoolean1, paramInt, paramList, paramBoolean2);
      return;
  ...
  List<WeiShiVideoArticleInfo> a(int paramInt1, int paramInt2, long paramLong, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      localObject = this.jdField_a_of_type_Aukn.a(WeiShiVideoArticleInfo.class, true, str, new String[] { String.valueOf(paramInt1), String.valueOf(paramLong) }, null, null, "recommendSeq desc", String.valueOf(paramInt2));
      if (localObject != null) {
  ...
  public List<WeiShiVideoArticleInfo> a(Integer paramInteger)
  {
    ...
    Collections.sort(localArrayList, new pcc(this));
    return localArrayList;
  }
  ...
  public void a(int paramInt1, long paramLong, int paramInt2)
  {
    ...
    if (j < paramInt2)
    {
      Collections.sort((List)localObject1, new pcd(this));
      int i = 0;
      for (;;)
      {
        if (i >= paramInt2 - j) {
