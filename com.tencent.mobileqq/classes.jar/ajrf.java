...
{
  public ajrf(TroopSuspiciousFragment paramTroopSuspiciousFragment) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (ajpz.a(i) == 0)
      {
        ...
        bguq.a(this.a.getActivity(), (Bundle)localObject1, 2);
        if ((i == 2) || (i == 10) || (i == 12))
        {
          i = 1;
          label117:
    ...
    default: 
      ...
      label370:
      if (((anyw)TroopSuspiciousFragment.a(this.a).getManager(51)).b((String)localObject1)) {
    ...
    for (;;)
    {
      ...
      bdll.b(TroopSuspiciousFragment.a(this.a), "P_CliOper", "Grp_contacts", "", "notice", "see_fromdata", 0, 0, ((ajpp)localObject2).jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.group_code.get() + "", "3", "", "");
      break;
