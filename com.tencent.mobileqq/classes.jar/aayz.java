...
public class aayz
{
  ...
  public static void a(String paramString, long paramLong, aaza paramaaza)
  {
    try
    {
      ...
      ((Timer)localObject).schedule(new EventControlUtils.1(paramaaza), paramLong);
  ...
  public static void b(String paramString, long paramLong, aaza paramaaza)
  {
    if (b == null) {
    ...
    try
    {
      ...
      localTimer.schedule(new EventControlUtils.2(paramaaza), paramLong);
