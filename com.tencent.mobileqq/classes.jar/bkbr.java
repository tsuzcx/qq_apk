...
public class bkbr
{
  ...
  private CopyOnWriteArrayList<bkbt> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  
  public bkbr()
  {
    bkct.a("MobileQQprotect.QSecCb", new bkbs(this));
    a();
  }
  ...
  private String a()
  {
    return bkaa.a() + File.separator + "QSecCb.dat";
  }
  
  private void a()
  {
    byte[] arrayOfByte = new bkcp().a(a(), null, 1);
    if (arrayOfByte != null) {
      a(arrayOfByte);
    }
  }
  ...
  private void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramString)
      {
        ...
        ((bkbt)paramString.next()).a(localLinkedList);
        continue;
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    //   37: astore_1
    //   38: aload_0
    //   39: getfield 18	bkbr:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   42: iload_3
  ...
  private byte[] a()
  {
    ...
    //   16: astore 4
    //   18: aload_0
    //   19: getfield 18	bkbr:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
  ...
  private void b()
  {
    byte[] arrayOfByte = a();
    if (arrayOfByte != null) {
      new bkcp().a(a(), arrayOfByte, null, 1);
    }
  }
  ...
  public void a(bkbt parambkbt)
  {
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(parambkbt);
  }
  ...
  public void a(boolean paramBoolean)
  {
    try
    {
      ...
      bkct.a("MobileQQprotect.QSecCb", localQSecCbQuery.toByteArray());
      return;
    }
