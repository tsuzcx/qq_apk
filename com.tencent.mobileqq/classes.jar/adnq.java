  ...
  implements asvw
{
  ...
  private View.OnClickListener b = new adns(this);
  
  public adnq(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
  ...
  private void a(View paramView, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((TextView)((View)localObject6).findViewById(2131378520)).setText((CharSequence)localObject4);
        ...
        ((ImageView)localObject3).setImageDrawable(bayh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, String.valueOf(l)));
        bool2 = axmv.b();
        if (!bool1) {
          break label947;
        }
      ...
      paramView = ((ViewStub)paramView.findViewById(2131379243)).inflate();
      paramString = (TextView)paramView.findViewById(2131378517);
      ...
      return;
      label377:
      localObject4 = bayh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
      Object localObject6 = bayh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, String.valueOf(l));
    ...
    return;
    label460:
    Object localObject2 = ((ViewStub)paramView.findViewById(2131379241)).inflate();
    Object localObject3 = (URLImageView)((View)localObject2).findViewById(2131368046);
    Object localObject4 = (TextView)((View)localObject2).findViewById(2131378519);
    paramView = (TextView)((View)localObject2).findViewById(2131378518);
    ...
    if (TextUtils.isEmpty((CharSequence)localObject5))
    {
      ...
      i = actj.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ...
    for (;;)
    {
      try
      {
        paramString = URLDrawable.getDrawable(ayst.a(paramString), (URLDrawable.URLDrawableOptions)localObject5);
        paramView = paramString;
        paramString.setTag(bavw.b(i, i, (int)f));
        paramView = paramString;
      ...
      do
      {
        ((TextView)((ViewStub)paramView.findViewById(2131379243)).inflate().findViewById(2131378517)).setText(ajya.a(2131702223));
        return;
  ...
  protected View a(MessageRecord paramMessageRecord, actn paramactn, View paramView, LinearLayout paramLinearLayout, acxj paramacxj)
  {
    ...
    if (paramView == null)
    {
      paramactn = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560689, null);
      a(paramactn, paramMessageRecord.msg);
    }
