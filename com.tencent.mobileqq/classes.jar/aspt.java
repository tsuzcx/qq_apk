...
public class aspt
{
  private static aspt jdField_a_of_type_Aspt;
  ...
  {
    if (jdField_a_of_type_Aspt == null) {
      jdField_a_of_type_Aspt = new aspt();
    }
    return jdField_a_of_type_Aspt;
  }
  
  private void a()
  {
    aspw localaspw = new aspw(this);
    ThreadManagerV2.getUIHandlerV2().post(new LocalTbsViewManager.4(this, localaspw));
  }
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramBoolean1)
    {
      bcef.b(null, "dc00898", "", "", "0X800B00B", "0X800B00B", 0, 0, "", "", "", "");
      return;
    }
    if (paramBoolean2) {}
    for (int i = 1;; i = 2)
    {
      bcef.b(null, "dc00898", "", "", "0X800B00C", "0X800B00C", i, 0, "", "", "", "");
      return;
    }
  }
  ...
  public TbsReaderView a(Activity paramActivity, String paramString, aspy paramaspy)
  {
    ...
    this.jdField_a_of_type_ComTencentTbsReaderTbsReaderView = new TbsReaderView(paramActivity, new aspz(this, paramaspy, paramActivity, paramString));
    ...
    paramaspy = str;
    if (str.startsWith(".")) {
      paramaspy = str.replaceFirst(".", "");
    }
    if (this.jdField_a_of_type_ComTencentTbsReaderTbsReaderView.preOpen(paramaspy, false))
    {
  ...
  public void a(int paramInt, aspy paramaspy)
  {
    ThreadManagerV2.getUIHandlerV2().post(new LocalTbsViewManager.6(this, paramInt, paramaspy));
  }
  ...
  public void a(Context paramContext, Bundle paramBundle)
  {
    ...
    {
      return;
      bcef.b(null, "dc00898", "", "", "0X800AF73", "0X800AF73", 0, 0, "", "", "", "");
  ...
  public void a(Context paramContext, Bundle paramBundle, String paramString)
  {
    ...
    if (atdm.a().a(paramBundle))
    {
      QLog.w("LocalTbsViewManager<FileAssistant>", 1, "downloadQQBrowser isExistedDownloadOfUrl show toast!");
      QQToast.a(paramContext, 0, 2131697684, 0).a();
      return;
    }
    Bundle localBundle = new Bundle();
    localBundle.putString("_open_with_qq_browser_", paramString);
    localBundle.putBoolean("tbs_new_report", true);
    aszt.a(paramContext, paramBundle, localBundle);
    a("stat_download_start");
  }
  
  public void a(Context paramContext, Object paramObject1, Object paramObject2, String paramString, aspy paramaspy)
  {
    ...
    default: 
      return;
    case 1: 
      bcef.b(null, "dc00898", "", "", "0X800AF71", "0X800AF71", 0, 0, "", "", "", "");
      return;
    case 2: 
      bcef.b(null, "dc00898", "", "", "0X800AF72", "0X800AF72", 1, 0, "", "", "", "");
      return;
    case 4: 
      bcef.b(null, "dc00898", "", "", "0X800AF74", "0X800AF74", 0, 0, "", "", "", "");
      return;
    case 5: 
      bcef.b(null, "dc00898", "", "", "0X800AF75", "0X800AF75", 0, 0, "", "", "", "");
    ...
    a(paramObject2, paramaspy);
  }
  
  public void a(Object paramObject, Activity paramActivity, aspy paramaspy)
  {
    if (paramObject == null) {
      return;
    }
    int i = ((Bundle)paramObject).getInt("function_id");
    paramaspy.a(TbsReaderView.getResString(paramActivity, i), TbsReaderView.getResDrawable(paramActivity, i + 1), TbsReaderView.getResDrawable(paramActivity, i + 2), new aspx(this, i, paramActivity));
  }
  
  public void a(Object paramObject, aspy paramaspy)
  {
    paramaspy = paramaspy.a();
    if (((paramObject instanceof ViewGroup)) && ((paramaspy instanceof View))) {
      ((ViewGroup)paramObject).addView(paramaspy);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      ...
      {
        bcef.b(null, "dc00898", "", "", "0X800AF76", "0X800AF76", 0, 0, "", "", "", "");
        return;
      }
  ...
  public boolean a(Activity paramActivity, String paramString, aspy paramaspy, boolean paramBoolean)
  {
    if (!a(true)) {}
    do
    {
    ...
    } while (paramaspy == null);
    paramaspy.b(false);
    return false;
    TbsReaderView localTbsReaderView = new TbsReaderView(paramActivity, new aspu(this, paramaspy));
    ...
    for (;;)
    {
      ...
      label165:
      if ((paramBoolean) && (paramaspy != null)) {
        paramaspy.b(true);
      }
      if (QLog.isColorLevel()) {
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    aspv localaspv = new aspv(this);
    paramBoolean = ReaderEngine.getInstance().fileEnginePreLoad(BaseApplicationImpl.getApplication(), localaspv, paramBoolean);
    if (paramBoolean)
    {
    ...
    bcef.b(null, "dc00898", "", "", "0X800B009", "0X800B009", 0, 0, "", "", "", "");
    return paramBoolean;
  }
