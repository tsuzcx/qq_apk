  ...
  extends oqg
{
  ...
  public opc(AppInterface paramAppInterface, atmp paramatmp, ExecutorService paramExecutorService, pdc parampdc, Handler paramHandler)
  {
  ...
  private void b()
  {
    ...
    Object localObject = this.jdField_a_of_type_Atmp.a(ChannelInfo.class, true, null, null, null, null, null, null);
    if (localObject == null)
    {
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 2) {
      if ((j == 0) && (paramToServiceMsg.msg_ks_get_subscribed_list_rsp.has()) && (((oidb_cmd0xd46.KsGetSubscribedListRsp)paramToServiceMsg.msg_ks_get_subscribed_list_rsp.get()).bytes_ks_subscribed_list.has()))
      {
        ...
        ohb.a().a(new opd(this, j, paramToServiceMsg));
      }
    }
    while (i != 1) {
      for (;;)
  ...
  protected ToServiceMsg a(pdi parampdi)
  {
    ...
    if (parampdi.jdField_a_of_type_Boolean) {
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_all_channel_list.set(1);
    }
    if (parampdi.jdField_b_of_type_Boolean) {
    ...
    for (;;)
    {
      ...
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_important.set(parampdi.jdField_b_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_id.set(parampdi.jdField_c_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_cover.set(parampdi.jdField_d_of_type_Int);
      ((oidb_cmd0x69f.ReqBody)localObject).uint32_req_channel_seq.set(parampdi.jdField_e_of_type_Int);
      localObject = pde.a("OidbSvc.0x69f", 1695, 0, ((oidb_cmd0x69f.ReqBody)localObject).toByteArray());
      ((ToServiceMsg)localObject).getAttributes().put(c, Integer.valueOf(parampdi.jdField_a_of_type_Int));
      ((ToServiceMsg)localObject).getAttributes().put("debug", Boolean.valueOf(parampdi.l));
      return localObject;
  ...
  public void a(int paramInt1, int paramInt2, List<Integer> paramList, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    ((oidb_cmd0x908.ReqBody)localObject).uint64_uin.set(Long.valueOf(obz.a()).longValue());
    ...
    for (;;)
    {
      ...
      localObject = pde.a("OidbSvc.0x908", 2312, 0, ((oidb_cmd0x908.ReqBody)localObject).toByteArray());
  ...
  public void a(String paramString)
  {
    ...
    localObject = pde.a("OidbSvc.0xd46", 3398, 0, ((oidb_cmd0xd46.ReqBody)localObject).toByteArray());
  ...
  public void a(boolean paramBoolean, int paramInt, List<Integer> paramList)
  {
    ...
    localReqBody.uint64_uin.set(Long.valueOf(obz.a()).longValue());
    if (paramBoolean)
    {
      ...
      a(pde.a("OidbSvc.0x8f5", 2293, 0, localReqBody.toByteArray()));
      if (QLog.isColorLevel()) {
        if (paramList != null) {
          break label150;
        }
  ...
  public void b(List<Integer> paramList)
  {
    ...
    localObject = pde.a("OidbSvc.0x69e", 1694, 0, ((oidb_cmd0x69e.ReqBody)localObject).toByteArray());
  ...
  {
    Object localObject = new pdi();
    ((pdi)localObject).jdField_a_of_type_Int = 4;
    ((pdi)localObject).jdField_a_of_type_Boolean = true;
    ((pdi)localObject).jdField_b_of_type_Boolean = true;
    ((pdi)localObject).jdField_c_of_type_Boolean = false;
    ((pdi)localObject).jdField_d_of_type_Boolean = true;
    ((pdi)localObject).j = true;
    ((pdi)localObject).k = true;
    ((pdi)localObject).jdField_e_of_type_Boolean = false;
    ((pdi)localObject).f = false;
    ((pdi)localObject).g = false;
    ((pdi)localObject).h = false;
    ((pdi)localObject).jdField_b_of_type_Int = 1;
    ((pdi)localObject).l = paramBoolean;
    localObject = a((pdi)localObject);
  ...
  protected void c(List<pox> paramList)
  {
    if (paramList == null) {
      return;
    }
    ...
    while (paramList.hasNext())
    {
      Iterator localIterator = ((pox)paramList.next()).a.iterator();
  ...
  protected void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0) {
      if (i == 1)
      {
        ...
        {
          paramObject = pdb.a(localRspBody.rpt_channel_list.get());
  ...
  public List<ChannelInfo> e()
  {
    ...
    Collections.sort((List)localObject1, new ope(this));
  ...
  {
    if (pde.a(paramFromServiceMsg, paramObject, new oidb_cmd0x69e.RspBody()) == 0) {}
  ...
  public List<Integer> g()
  {
    ...
    Collections.sort((List)localObject1, new opf(this));
    localObject2 = new ArrayList(((ArrayList)localObject1).size());
    localObject1 = ((ArrayList)localObject1).iterator();
    while (((Iterator)localObject1).hasNext()) {
  ...
  {
    int i = pde.a(paramFromServiceMsg, paramObject, new oidb_cmd0x8f5.RspBody());
    if (QLog.isColorLevel()) {
  ...
  public void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = pde.a(paramFromServiceMsg, paramObject, (MessageMicro)localObject);
    boolean bool1;
    if (k == 0)
    {
