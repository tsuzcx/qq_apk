...
public class alcj
{
  public static int a(String paramString)
  {
    try
    {
      int i = alca.a("arsdk2", a(), alca.b("arsdk2", a(), "arsdk2"), paramString);
      return i;
    }
    finally
    {
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        alca.a("arsdk2", a(), "arsdk2", paramString2);
        try
        {
          albw.a(paramString1, alca.a("arsdk2", a(), alca.b("arsdk2", a(), "arsdk2")));
          paramString2 = alca.a("arsdk2", a(), alca.b("arsdk2", a(), "arsdk2")) + File.separator + "md5_config.xml";
        ...
        catch (IOException paramString2)
        {
          ...
          String str;
          i = -6;
          bbdj.a(alca.a("arsdk2", a(), alca.b("arsdk2", a(), "arsdk2")), false);
      ...
      try
      {
        paramString2 = a(bbdj.b((File)localObject));
        ...
        paramString1 = alca.a("arsdk2", a(), alca.b("arsdk2", a(), "arsdk2")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".so";
        alca.a("arsdk2", a(), "libAlphaAR", (String)((Map.Entry)localObject).getValue());
      }
      catch (IOException paramString2)
      {
      ...
      catch (OutOfMemoryError paramString2)
      {
        ...
        paramString1 = alca.a("arsdk2", a(), alca.b("arsdk2", a(), "arsdk2")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".so";
        alca.a("arsdk2", a(), "libYTCommon", (String)((Map.Entry)localObject).getValue());
        continue;
        if (!((String)((Map.Entry)localObject).getKey()).equalsIgnoreCase("AlphaAR_mqq_license")) {
          continue;
        }
        paramString1 = alca.a("arsdk2", a(), alca.b("arsdk2", a(), "arsdk2")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".dat";
        alca.a("arsdk2", a(), "AlphaAR_mqq_license", (String)((Map.Entry)localObject).getValue());
        continue;
  ...
  {
    File localFile1 = new File(alca.a("arsdk2", a(), alca.b("arsdk2", a(), "arsdk2")) + File.separator + "libYTCommon" + ".so");
    File localFile2 = new File(alca.a("arsdk2", a(), alca.b("arsdk2", a(), "arsdk2")) + File.separator + "libAlphaAR" + ".so");
    File localFile3 = new File(alca.a("arsdk2", a(), alca.b("arsdk2", a(), "arsdk2")) + File.separator + "AlphaAR_mqq_license" + ".dat");
  ...
  public static boolean a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        String str = alca.a("arsdk2", a(), alca.b("arsdk2", a(), "arsdk2")) + File.separator + paramString + ".so";
        ...
        if (((File)localObject).exists())
        {
          paramString = alca.b("arsdk2", a(), paramString);
  ...
  {
    String str = alca.a("arsdk2", a(), alca.b("arsdk2", a(), "arsdk2")) + File.separator + "AlphaAR_mqq_license" + ".dat";
