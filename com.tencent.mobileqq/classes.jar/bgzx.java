...
public class bgzx
{
  private static bgzx jdField_a_of_type_Bgzx;
  ...
  private bgzx()
  {
    ...
    for (int i = 4;; i = 0)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentSharedPreferences != null) {
        this.jdField_a_of_type_AndroidContentSharedPreferences.registerOnSharedPreferenceChangeListener(new bgzy(this));
      }
      return;
    }
  }
  ...
  {
    if (jdField_a_of_type_Bgzx == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Bgzx == null) {
        jdField_a_of_type_Bgzx = new bgzx();
      }
      return jdField_a_of_type_Bgzx;
    }
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    String str = paramActivity.getResources().getString(2131718282);
