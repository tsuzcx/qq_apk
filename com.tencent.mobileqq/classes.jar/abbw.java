...
{
  public abbw(ForwardRecentActivity paramForwardRecentActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (i == 2131365763)
    {
      ...
      axqy.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D91", ForwardRecentActivity.a(this.a), 0, "", "", "", "");
    }
    label56:
    label328:
    Object localObject;
    ...
    do
    {
      do
      {
        ...
        if (this.a.jdField_a_of_type_Aqbe != null)
        {
          this.a.jdField_a_of_type_Aqbe.a(false);
        ...
        this.a.finish();
        axqy.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D8F", ForwardRecentActivity.a(this.a), 0, "", "", "", "");
      } while (!this.a.getIntent().getBooleanExtra("forward_mini_program_ark_from_sdk", false));
      axqy.b(this.a.app, "dc00898", "", "", "0X8009F7A", "0X8009F7A", 0, 0, "2", "", "", "");
      return;
      if (ForwardRecentActivity.a(this.a))
      {
        ForwardRecentActivity.c(this.a);
        axqy.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D98", ForwardRecentActivity.a(this.a), 0, "", "", "", ForwardRecentActivity.a(this.a));
        return;
      }
      ForwardRecentActivity.d(this.a);
      axqy.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D93", ForwardRecentActivity.a(this.a), 0, "", "", "", ForwardRecentActivity.a(this.a));
      return;
      Bundle localBundle;
      if (i == 2131368431)
      {
        if (ForwardRecentActivity.a(this.a))
        {
          ...
          axqy.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D94", ForwardRecentActivity.a(this.a), 0, "", "", "", "");
        }
      }
      else
      {
        ...
        localBundle = this.a.jdField_a_of_type_Aqbe.a();
        ...
        ((Intent)localObject).putExtras(this.a.jdField_a_of_type_Aqbe.a());
      ...
      for (;;)
      {
        ...
        case 2131366616: 
          ...
          axqy.b(this.a.app, "CliOper", "", "", "0X800665F", "0X800665F", 0, 0, "", "", "", "");
          ...
          axqy.b(this.a.app, "CliOper", "", "", "Two_call", "Tc_msg_cate", 0, 0, "0", "", "", "");
          axqy.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D95", ForwardRecentActivity.a(this.a), 0, "", "", "", "");
          ...
          axqy.b(this.a.app, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.buyerselectpage.select", 0, 0, "", "", "", "");
          return;
          if (this.a.jdField_a_of_type_Aqbe != null)
          {
            this.a.jdField_a_of_type_Aqbe.a(false);
      ...
      aneh.a(this.a, this.a.app, paramView, (Runnable)localObject);
      localObject = this.a.app;
      if (this.a.e) {}
      for (paramView = "2";; paramView = "1")
      {
        axqy.b((QQAppInterface)localObject, "dc00899", "Share", "", "select_friend", "clk_addressbook", 0, 0, paramView, "", "", "");
        return;
      }
    } while ((this.a.b != 1) || (this.a.jdField_c_of_type_Int != 2));
    label924:
    label943:
    axqy.b(this.a.app, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.payerselectpage.select", 0, 0, "", "", "", "");
    label1057:
    return;
    this.a.a("0X8007826");
    i = 1;
    if (!this.a.jdField_a_of_type_Aqbe.a(aqau.b)) {
      i = 2;
    }
    ...
    paramView.putExtra("param_done_button_wording", this.a.getString(2131719221));
    paramView.putExtra("param_done_button_highlight_wording", this.a.getString(2131719222));
    ...
    axqy.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D92", ForwardRecentActivity.a(this.a), 0, "", "", "", "");
    return;
    ForwardRecentActivity.a(this.a, (Intent)localObject);
    if (this.a.i)
    {
      ...
      if (!this.a.jdField_a_of_type_Aqbe.a(aqau.d))
      {
      ...
      for (paramView = "2";; paramView = "1")
      {
        axqy.b((QQAppInterface)localObject, "dc00899", "Share", "", "select_friend", "clk_group", 0, 0, paramView, "", "", "");
        new axrc(this.a.app).a("dc00899").b("Grp_listNew").c("send_to").d("clk_grpList").a();
        return;
        if (this.a.jdField_a_of_type_Aqbe.a(aqau.c)) {
          break;
        }
        ((Intent)localObject).putExtra("onlyOneSegement", true);
    ...
    abtq.a(this.a, (Intent)localObject, PublicTransFragmentActivity.class, ForwardTroopListFragment.class, 20000);
    axqy.b(this.a.app, "CliOper", "", "", "friendchoose", "0X8009D96", ForwardRecentActivity.a(this.a), 0, "", "", "", "");
  }
}
