  ...
  implements bhuj
{
  ...
  public bhul(QQAppInterface paramQQAppInterface)
  {
    this.a = new bhum(paramQQAppInterface);
  }
  ...
  private void a()
  {
    ...
    try
    {
      bhut localbhut = (bhut)((bhuk)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(QQManagerFactory.QQ_VAS_UPDATE_MANAGER)).a().getDbManager();
      if (localbhut != null) {
        localbhut.a();
      }
      b();
