...
public class bhul
{
  ...
  public void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 13	bhul:a	Landroid/media/MediaPlayer;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnonnull +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 13	bhul:a	Landroid/media/MediaPlayer;
    //   18: invokevirtual 18	android/media/MediaPlayer:stop	()V
    //   21: aload_0
    //   22: getfield 13	bhul:a	Landroid/media/MediaPlayer;
    //   25: invokevirtual 21	android/media/MediaPlayer:release	()V
    //   28: aload_0
    //   29: aconst_null
    //   30: putfield 13	bhul:a	Landroid/media/MediaPlayer;
    //   33: goto -22 -> 11
    //   36: astore_1
    //   37: aload_0
    //   38: monitorexit
  ...
  public boolean a()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 13	bhul:a	Landroid/media/MediaPlayer;
    //   8: astore_2
    //   9: aload_2
    //   10: ifnonnull +7 -> 17
    //   13: aload_0
    ...
    //   16: ireturn
    //   17: aload_0
    //   18: getfield 13	bhul:a	Landroid/media/MediaPlayer;
  ...
  public boolean a(java.lang.String paramString)
  {
    ...
    //   19: putfield 13	bhul:a	Landroid/media/MediaPlayer;
    //   22: aconst_null
    //   23: astore 7
    //   25: aconst_null
    //   26: astore 5
    ...
    //   36: astore 4
    //   38: aload_0
    //   39: getfield 13	bhul:a	Landroid/media/MediaPlayer;
    //   42: iconst_3
    ...
    //   89: ireturn
    //   90: aload_0
    //   91: getfield 13	bhul:a	Landroid/media/MediaPlayer;
    ...
    //   122: astore 4
    //   124: aload_0
    //   125: getfield 13	bhul:a	Landroid/media/MediaPlayer;
    //   128: aload_1
    ...
    //   136: astore 4
    //   138: aload_0
    //   139: getfield 13	bhul:a	Landroid/media/MediaPlayer;
    ...
    //   204: astore 4
    //   206: aload 5
    //   208: invokevirtual 78	java/io/IOException:printStackTrace	()V
    //   211: iload_3
    //   212: istore_2
    //   213: aload_1
    //   214: ifnull -128 -> 86
    //   217: aload_1
    //   218: invokevirtual 77	java/io/FileInputStream:close	()V
    //   221: iload_3
    //   222: istore_2
    //   223: goto -137 -> 86
    //   226: astore_1
    ...
    //   238: astore 4
    //   240: aload 5
    //   242: invokevirtual 79	java/lang/IllegalArgumentException:printStackTrace	()V
    //   245: iload_3
    //   246: istore_2
    //   247: aload_1
    //   248: ifnull -162 -> 86
    //   251: aload_1
    //   252: invokevirtual 77	java/io/FileInputStream:close	()V
    //   255: iload_3
    //   256: istore_2
    //   257: goto -171 -> 86
    //   260: astore_1
