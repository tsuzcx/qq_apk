  ...
  implements bevy
{
  ...
  protected bctl a;
  protected bepp a;
  bfvh jdField_a_of_type_Bfvh = new bcti(this);
  protected bhpy a;
  protected bhqi a;
  ...
  public bctc(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData)
  {
    this(paramBaseActivity, paramTroopInfoData, null);
  }
  
  public bctc(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, bctl parambctl)
  {
    this.jdField_a_of_type_Int = -1;
    this.jdField_b_of_type_Int = -1;
    this.jdField_a_of_type_Amab = new bcth(this);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData = paramTroopInfoData;
    if (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.addObserver(this.jdField_a_of_type_Bfvh);
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.addObserver(this.jdField_a_of_type_Amab);
    }
  ...
  public static Bitmap a(String paramString, Resources paramResources, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    catch (OutOfMemoryError paramString)
    {
      ...
      if (paramBoolean)
      {
        ...
        paramResources = bcwc.a(paramResources, 2130839477);
  ...
  public static String a(String paramString, Context paramContext)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = paramContext.getString(2131720056);
    }
    return str;
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, int paramInt)
  {
    try
    {
      localAbsShareMsg = new azqg(StructMsgForGeneralShare.class).c(132).a(paramBundle.getString("summary")).e(paramBundle.getString("targetUrl")).a(1105290942L).a();
      ...
      for (localAbsShareMsg.mSourceName = "NOW";; localAbsShareMsg.mSourceName = "")
      {
        ...
        ((azqk)localObject).a(paramBundle.getString("imageUrl"), paramBundle.getString("title"), str);
        ...
        arum.a(paramActivity, paramBundle, paramInt);
        return;
  ...
  public static void a(Activity paramActivity, MessageForQQStory paramMessageForQQStory, int paramInt)
  {
    try
    {
      AbsShareMsg localAbsShareMsg = new azqg(StructMsgForGeneralShare.class).c(80).a(paramMessageForQQStory.brief).e("").a();
      ...
      try
      {
        ...
        arum.a(paramActivity, (Intent)localObject, paramInt);
        if (QLog.isColorLevel())
        {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, int paramInt, Intent paramIntent)
  {
    ...
    localIntent = aekt.a(new Intent(paramActivity, SplashActivity.class), null);
  ...
  public static List<ShareActionSheetBuilder.ActionSheetItem>[] a(Context paramContext, boolean paramBoolean)
  {
    ...
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131696871);
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).icon = 2130838916;
    ...
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131696884);
    ...
    localArrayList.add(localObject);
    localObject = new ShareActionSheetBuilder.ActionSheetItem();
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131696891);
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).icon = 2130838920;
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).action = 9;
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).argus = "";
    localArrayList.add(localObject);
    localObject = new ShareActionSheetBuilder.ActionSheetItem();
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131696874);
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).icon = 2130838914;
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).action = 10;
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).argus = "";
    localArrayList.add(localObject);
    localObject = new ArrayList();
    ShareActionSheetBuilder.ActionSheetItem localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
    localActionSheetItem.label = paramContext.getString(2131696863);
    ...
    if (paramBoolean)
    {
      ...
      localActionSheetItem.label = paramContext.getString(2131717574);
      localActionSheetItem.icon = 2130842092;
      localActionSheetItem.iconNeedBg = true;
  ...
  public static void b(Activity paramActivity, Bundle paramBundle, int paramInt)
  {
    try
    {
      Object localObject = new azqg(StructMsgForGeneralShare.class);
      if ("action_mqq".equals(paramBundle.getString("jump_action")))
      {
        localObject = ((azqg)localObject).c(129).a(paramBundle.getString("summary")).a(1104763709L).a();
      ...
      for (;;)
      {
        ...
        String str = paramBundle.getString("summary");
        localazqk.a(paramBundle.getString("imageUrl"), paramBundle.getString("title"), str);
        ...
        arum.a(paramActivity, paramBundle, paramInt);
        return;
        localObject = ((azqg)localObject).c(129).a(paramBundle.getString("summary")).e(paramBundle.getString("targetUrl")).a(1104763709L).a();
        ((AbsShareMsg)localObject).mMsgBrief = paramBundle.getString("summary");
        ((AbsShareMsg)localObject).mContentSummary = paramBundle.getString("summary");
        ((AbsShareMsg)localObject).mContentTitle = paramBundle.getString("title");
        ((AbsShareMsg)localObject).mSourceAction = "";
  ...
  private void h()
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        azmj.b(localQQAppInterface, "CliOper", "", "", "Grp", (String)localObject, 0, 0, str, "", "", "");
        bool = bdee.d(BaseApplication.getContext());
        ...
        if (this.jdField_a_of_type_Bctl != null) {
          this.jdField_a_of_type_Bctl.a(this.jdField_a_of_type_Int, false);
        }
        this.jdField_a_of_type_Int = -1;
        this.jdField_b_of_type_Int = -1;
    ...
    {
      ((bfvi)localQQAppInterface.a(85)).b(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
      return;
    }
    Object localObject = (alzf)localQQAppInterface.a(20);
    ...
    default: 
      return;
    case 0: 
      this.jdField_c_of_type_JavaLangString = bcgh.a("", this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, 0);
      l();
      return;
    case 3: 
      i();
  ...
  private void i()
  {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject3)) {
        localObject1 = alpo.a(2131716169) + bdbt.e(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
      }
  ...
  private void j()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopName == null)
    {
      ...
      str1 = alpo.a(2131716165) + bdbt.e(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
    }
    label337:
    for (;;)
    {
  ...
  private void k()
  {
    ...
    if (bool)
    {
      ...
      localObject1 = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131720049), new Object[] { localObject2 }) + "(" + this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin + ")" + a();
      ...
      ((Bundle)localObject3).putString("desc", alpo.a(2131716168) + bdbt.e(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin));
    }
    for (;;)
    {
      ...
      bjao.a(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (Bundle)localObject3, null, 145);
      if (QLog.isColorLevel()) {
      ...
      this.jdField_b_of_type_Int = -1;
      return;
      localObject1 = bcgh.a("", this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, 0) + "100";
      break;
      label539:
  ...
  private void l()
  {
    ...
    for (localObject3 = (String)localObject1 + "(" + ((TroopInfo)localObject3).wMemberNum + ")";; localObject3 = localObject1)
    {
      ...
      AbsShareMsg localAbsShareMsg = new azqg(StructMsgForGeneralShare.class).c(15).a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131719129) + (String)localObject3).a("web", a(), (String)localObject1, (String)localObject1, (String)localObject1).a();
      ...
      for (;;)
      {
        ...
        localazui.b(1);
        localazui.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131696659));
        azqk localazqk = azqt.a(2);
        String str = this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.mRichFingerMemo;
        if (TextUtils.isEmpty(str))
        {
          localObject2 = alpo.a(2131716167) + bdbt.e(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
          label423:
          localazqk.a((String)localObject1, (String)localObject3, (String)localObject2, 1);
          localAbsShareMsg.addItem(localazui);
        ...
        for (int i = 21;; i = 3)
        {
          arum.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (Intent)localObject2, i);
          if ((this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity instanceof TroopCreateLogicActivity)) {
  ...
  private void m()
  {
    ...
    str1 = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131693808), new Object[] { str1, a() });
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131691364), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
      if (this.jdField_a_of_type_Bctl != null) {
        this.jdField_a_of_type_Bctl.a(this.jdField_a_of_type_Int, true);
      }
      this.jdField_a_of_type_Int = -1;
      this.jdField_b_of_type_Int = -1;
      return;
  ...
  public void a()
  {
    try
    {
      if ((this.jdField_a_of_type_Bepp == null) && (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null))
      {
  ...
  public void a(bctm parambctm)
  {
    ThreadManager.post(new TroopShareUtility.10(this, parambctm), 8, null, false);
  }
  ...
  public void a(BaseResp paramBaseResp)
  {
    ...
    if (this.jdField_a_of_type_Bctl != null)
    {
      bctl localbctl = this.jdField_a_of_type_Bctl;
    ...
    else
    {
      ...
      case -1: 
      default: 
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131720019), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
      }
    }
    for (;;)
    {
      ...
      bool = false;
      break;
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131720038), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
    }
  }
  ...
  public void a(TroopInfoData paramTroopInfoData)
  {
    ...
    azmj.b((QQAppInterface)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppRuntime(), "CliOper", "", "", "Grp", "Clk_share_grplink", 0, 0, "", "", "", "");
    this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData = paramTroopInfoData;
    d();
  }
  ...
  protected void b(boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        str1 = "0";
        localazmo = new azmo(null).a("P_CliOper").b("Grp_set").c("Grp_data").d((String)localObject);
    ...
    {
      localazmo.a(new String[] { str2, localObject, str1 }).a();
      return;
  ...
  protected void d()
  {
    ...
    for (int i = 5;; i = 4)
    {
      ...
      while (j <= i)
      {
        ((List)localObject).add(bhqi.a(j));
        j += 1;
      }
    }
    if ((this.jdField_a_of_type_Bhqi == null) && (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null)) {
      this.jdField_a_of_type_Bhqi = new bhqi(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
    }
    if (this.jdField_a_of_type_Bhqi != null) {
      this.jdField_a_of_type_Bhqi.a((List)localObject);
    }
    if (this.jdField_a_of_type_Bhpy == null)
    {
      localObject = new bctd(this);
      if (this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder == null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setOnDismissListener(new bcte(this));
  ...
  protected void e()
  {
    this.jdField_b_of_type_Bhpy = ((bhpy)bhql.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, null));
    this.jdField_b_of_type_Bhpy.b(2131721151);
    this.jdField_b_of_type_Bhpy.b(2131721152);
    this.jdField_b_of_type_Bhpy.c(2131690648);
    this.jdField_b_of_type_Bhpy.setOnDismissListener(new bctf(this));
    this.jdField_b_of_type_Bhpy.a(new bctg(this));
    String str;
    switch (this.jdField_a_of_type_Int)
    {
    default: 
      str = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131721149);
    }
    for (;;)
    {
      this.jdField_b_of_type_Bhpy.a(str);
      ...
      return;
      str = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131690843), new Object[] { this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131721150) });
      continue;
      str = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131690843), new Object[] { this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131721153) });
      continue;
      str = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131690843), new Object[] { this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131720045) });
      continue;
      str = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131690843), new Object[] { this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131720048) });
    }
  }
  
  public void f()
  {
    this.jdField_a_of_type_Bctl = null;
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.removeObserver(this.jdField_a_of_type_Bfvh);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.removeObserver(this.jdField_a_of_type_Amab);
  ...
  public void g()
  {
    ...
    localIntent.putExtra("title", alpo.a(2131716164));
    int i;
