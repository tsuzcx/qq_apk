  ...
  extends BaseAdapter
{
  ...
  private abjj(JobSelectionActivity paramJobSelectionActivity)
  {
    ...
    label74:
    label81:
    for (paramJobSelectionActivity = ajtw.jdField_a_of_type_ArrayOfInt;; paramJobSelectionActivity = bazx.b)
    {
      this.jdField_a_of_type_ArrayOfInt = paramJobSelectionActivity;
      return;
      paramJobSelectionActivity = bazx.d;
      break;
      paramJobSelectionActivity = bazx.e;
      break label42;
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivityJobSelectionActivity.getLayoutInflater().inflate(2131560798, paramViewGroup, false);
      paramView = new abjk(null);
      paramView.jdField_a_of_type_ComTencentMobileqqWidgetInterestLabelTextView = ((InterestLabelTextView)localView.findViewById(2131376835));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131370647));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131364187));
      localView.setTag(paramView);
    }
    paramView = (abjk)localView.getTag();
    paramInt = this.jdField_a_of_type_ComTencentMobileqqActivityJobSelectionActivity.a(paramInt);
    ...
    int i = actj.a(4.0F, JobSelectionActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityJobSelectionActivity).getResources());
