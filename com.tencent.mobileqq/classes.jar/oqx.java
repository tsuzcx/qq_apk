...
public class oqx
  extends oqr<String, DynamicChannelDataModel>
{
  private oqw a;
  public final String b = "ReadInJoyCGIDynamicChannelAdapter";
  
  public oqx(Activity paramActivity, RecyclerViewWithHeaderFooter paramRecyclerViewWithHeaderFooter, int paramInt)
  {
    super(paramActivity, paramRecyclerViewWithHeaderFooter, paramInt);
    this.jdField_a_of_type_Oqw = new oqw();
    this.jdField_a_of_type_Oqw.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, 0);
  }
  ...
  public bfyo a(ViewGroup paramViewGroup, int paramInt)
  {
    if (this.jdField_a_of_type_Oqw.a(paramInt))
    {
      Object localObject = (String)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        paramViewGroup = oqq.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, a(), (String)localObject);
        if ((paramInt == oqo.b) && (paramViewGroup != null)) {
        ...
        return new oqy(this, (View)localObject);
      }
  ...
  public void a(bfyo parambfyo, int paramInt)
  {
    DynamicChannelDataModel localDynamicChannelDataModel = (DynamicChannelDataModel)a(paramInt);
    int i = parambfyo.getItemViewType();
    parambfyo = (ProteusItemView)parambfyo.itemView;
    if (localDynamicChannelDataModel != null)
    {
      if (!this.jdField_a_of_type_Oqw.a(i)) {
        break label139;
      }
      if (i != oqo.b) {
        break label120;
      }
      parambfyo.setVisibility(8);
    }
    for (;;)
    {
      a(localDynamicChannelDataModel.uniqueID, localDynamicChannelDataModel);
      QLog.d("ReadInJoyCGIDynamicChannelAdapter", 2, new Object[] { "onBindViewHolder, dataModel = ", localDynamicChannelDataModel, ", proteusItemView = ", parambfyo, " , position = ", Integer.valueOf(paramInt), ", type = ", Integer.valueOf(i) });
      return;
      label120:
      this.jdField_a_of_type_Oqw.a(parambfyo, i, localDynamicChannelDataModel, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, paramInt);
      continue;
      label139:
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    {
      paramInt = i;
      if (this.jdField_a_of_type_Oqw.a((DynamicChannelDataModel)localObject))
      {
        i = this.jdField_a_of_type_Oqw.a((DynamicChannelDataModel)localObject);
