  ...
  implements ViewBase.OnClickListener
{
  ...
  qrr(ArticleInfo paramArticleInfo, Context paramContext)
  {
  ...
  private void a(ArticleInfo paramArticleInfo, int paramInt)
  {
    if (paramArticleInfo != null)
    {
      ...
      if (localObject != null)
      {
        localrqf.jdField_a_of_type_Long = ((SocializeFeedsInfo)localObject).jdField_a_of_type_Long;
        if (((SocializeFeedsInfo)localObject).jdField_a_of_type_Rqy != null) {
          localrqf.jdField_b_of_type_Long = ((SocializeFeedsInfo)localObject).jdField_a_of_type_Rqy.jdField_a_of_type_Long;
        }
        localrqf.jdField_a_of_type_Int = ((SocializeFeedsInfo)localObject).jdField_b_of_type_Int;
        localrqf.jdField_b_of_type_Int = ((SocializeFeedsInfo)localObject).d;
        ...
        if ((paramArticleInfo != null) && (!paramArticleInfo.isEmpty()))
        {
          ...
          {
            localObject = (rqy)paramArticleInfo.next();
            if (localObject != null) {
              localrqf.jdField_a_of_type_JavaUtilList.add(Long.valueOf(((rqy)localObject).jdField_a_of_type_Long));
            }
          }
        }
      }
  ...
  public static void a(ArticleInfo paramArticleInfo, String paramString1, String paramString2)
  {
    ...
    if (uvs.a(paramArticleInfo.mChannelID))
    {
      ...
      paramString1 = pqf.a((int)paramArticleInfo.mChannelID, paramArticleInfo.mAlgorithmID, pqw.a(paramArticleInfo), paramString1, paramArticleInfo.innerUniqueID, i + 1, j, k, m, n).a();
    ...
    for (;;)
    {
      if ((ppe.i(paramArticleInfo)) || (ppe.g(paramArticleInfo)) || (ppe.j(paramArticleInfo)) || (ppe.k(paramArticleInfo)))
      {
        if (!ppe.o(paramArticleInfo)) {
          olh.a(null, String.valueOf(localSocializeFeedsInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Long), paramString2, paramString2, 0, 0, String.valueOf(localSocializeFeedsInfo.jdField_a_of_type_Long), String.valueOf(l), "" + paramArticleInfo.mStrategyId, paramString1, false);
        }
        ...
        break label28;
        paramString1 = "" + localSocializeFeedsInfo.jdField_a_of_type_Rqy.jdField_a_of_type_Long;
        break label40;
        i = 0;
        break label59;
        j = 1;
      ...
      olh.a(null, paramArticleInfo.mSubscribeID, paramString2, paramString2, 0, 0, String.valueOf(localSocializeFeedsInfo.jdField_a_of_type_Long), String.valueOf(l), "" + paramArticleInfo.mStrategyId, paramString1, false);
      return;
    }
  }
  ...
  public final void onClick(ViewBase paramViewBase)
  {
    ...
    ukj.a(paramViewBase, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, false);
  }
}
