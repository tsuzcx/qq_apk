...
public class apfs
{
  private ArrayList<apft> a = new ArrayList();
  
  /* Error */
  public static apfs a(String paramString)
  {
    // Byte code:
    ...
    //   103: aload_2
    //   104: invokestatic 100	apfs:b	(Ljava/lang/String;)Lapfs;
    //   107: astore_2
    //   108: aload_0
    //   109: ifnull +7 -> 116
    //   112: aload_0
  ...
  public static apfs b(String paramString)
  {
    try
    {
      Object localObject = new JSONObject(paramString);
      apfs localapfs = new apfs();
      JSONArray localJSONArray = ((JSONObject)localObject).getJSONArray("360senceinfo");
      paramString = localapfs;
      if (((JSONObject)localObject).has("360senceinfo"))
      {
        ...
        if (j > 0)
        {
          ...
          for (;;)
          {
            ...
            localObject = new apft();
            if (paramString.has("text")) {
              ((apft)localObject).jdField_a_of_type_JavaLangString = paramString.optString("text");
            }
            if (paramString.has("starttime")) {
              ((apft)localObject).jdField_a_of_type_Long = paramString.optLong("starttime");
            }
            if (paramString.has("endtime")) {
              ((apft)localObject).b = paramString.optLong("endtime");
            }
            localapfs.a.add(localObject);
            if (QLog.isColorLevel()) {
              QLog.d("ARTransferDoorVideoInfo", 2, "ARTransferDoorVideoInfo parseJson index: " + i + "," + ((apft)localObject).toString());
            }
            i += 1;
          }
        }
  ...
  public apft a(long paramLong)
  {
    Iterator localIterator = this.a.iterator();
    while (localIterator.hasNext())
    {
      apft localapft = (apft)localIterator.next();
      long l = localapft.jdField_a_of_type_Long;
      if ((paramLong < localapft.b * 1000L) && (paramLong >= l * 1000L)) {
        return localapft;
      }
    }
    return null;
