...
public class bjlx
  extends Handler
{
  public bjlx(CropVideoActivity paramCropVideoActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      do
      {
        ...
        if ((CropVideoActivity.a(this.a) >= CropVideoActivity.b(this.a)) && (CropVideoActivity.b(this.a) >= 0L))
        {
          ...
          bcpw.a(this.a.getApplicationContext(), ajyc.a(2131702624), 1).a();
          return;
        }
      } while (CropVideoActivity.a(this.a, CropVideoActivity.a(this.a)) != 0);
      if (Build.VERSION.SDK_INT >= 18) {
        bjma.a(CropVideoActivity.a(this.a), CropVideoActivity.b(this.a), CropVideoActivity.a(this.a), CropVideoActivity.b(this.a), CropVideoActivity.c(this.a), CropVideoActivity.d(this.a), CropVideoActivity.e(this.a), CropVideoActivity.f(this.a), CropVideoActivity.a(this.a), CropVideoActivity.b(this.a), new bjly(this));
      }
      for (;;)
      {
        this.a.a();
    ...
    case 4: 
      ...
      bcpw.a(this.a.getApplicationContext(), 1, ajyc.a(2131702622), 1).a();
      this.a.finish();
      return;
    }
    if (QLog.isColorLevel()) {
