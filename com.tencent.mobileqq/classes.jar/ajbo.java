  ...
  implements aivp
{
  ...
  private HashMap<String, aiyo> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public ajbo(int paramInt, Activity paramActivity)
  {
    this.jdField_b_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_Ajnj = new ajnj(ajac.a(), paramActivity);
    this.jdField_a_of_type_Ajnn = new ajnn(paramActivity, ajac.a());
  ...
  private void a(long paramLong, int paramInt, ajcj paramajcj)
  {
    ApolloCmdChannel localApolloCmdChannel = ajac.a();
    if (localApolloCmdChannel != null)
    {
      localApolloCmdChannel.callbackFromRequest(paramLong, paramInt, "cs.get_redPacket_result.local", paramajcj.a());
      paramajcj.jdField_b_of_type_Int = 0;
      paramajcj.jdField_a_of_type_Boolean = false;
      return;
    }
    QLog.e("cmgame_process.CmGameSubProcessHandler", 1, "[notifyRedPacketResult] cmdChannel is null");
  }
  
  private void a(long paramLong, String paramString, aabl paramaabl)
  {
    if (paramaabl == null) {
      return;
    }
    ...
    paramaabl.a(str, null, new ajbt(this, paramString, paramLong));
  }
  
  private void a(long paramLong, String paramString1, String paramString2)
  {
    Object localObject = ajac.a(this.jdField_d_of_type_Int);
    if (localObject == null) {
    ...
    ((ajaf)localObject).a(paramLong, paramString1, paramString2);
  }
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_JavaUtilRegexPattern == null)
        {
          ...
          if (localObject != null)
          {
            localObject = ((ajco)localObject).a(this.jdField_d_of_type_Int);
            if (QLog.isColorLevel()) {
  ...
  {
    if ((!paramString1.startsWith("cs.")) && (!paramString1.endsWith(".local")) && (!aivt.a(paramString1)) && (a(paramString1))) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          paramString2 = ajac.a(this.jdField_d_of_type_Int);
        ...
        if ("apollo_router_game.game_ad_linkcmd_get_ad".equals(paramString1))
        {
          ...
          ((ajdo)localObject2).a(paramString1, (String)localObject1, paramLong, 4, bool, paramString2);
          break;
  ...
  private byte[] a(String paramString)
  {
    ...
    try
    {
      ...
      localObject1 = yys.a((Context)localObject1);
  ...
  private void c()
  {
    ...
    do
    {
      ...
      {
        return;
        Activity localActivity = ((ajcf)localObject).a();
  ...
  private void d()
  {
    ...
    if (localActivity != null) {
      ajac.a(this.jdField_d_of_type_Int, localActivity);
    }
  }
  ...
  private void e(long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ajac.a(ajac.a(), i, j, this.jdField_d_of_type_Int, k, paramString);
        i = 0;
      }
      catch (Exception paramString)
      {
  ...
  private void f(long paramLong, String paramString)
  {
    ...
    ((ajdf)localObject).b(paramLong, paramString);
  }
  ...
  private void h(long paramLong, String paramString)
  {
    ...
    ((ajdf)localObject).a(paramLong, paramString);
  }
  ...
  private void h(String paramString)
  {
    ...
    paramString = a();
    if (paramString != null) {
      aqbe.a(paramString, localIntent, 20180427);
    }
  }
  ...
  private void i(long paramLong, String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        localCmGameInitParams = ((ajcf)localObject).a();
      } while (localCmGameInitParams == null);
      localObject = ((ajcf)localObject).a(localCmGameInitParams.appId, ((ajcf)localObject).a());
    } while (localObject == null);
    if (localCmGameInitParams.accessTokenRet != 1)
    {
      ...
      ((aabl)localObject).a("login", null, new ajbs(this, paramString, paramLong, (aabl)localObject, localCmGameInitParams));
      return;
    }
    a(paramLong, paramString, (aabl)localObject);
  }
  ...
  private void i(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ajcf localajcf = ajac.a(this.jdField_d_of_type_Int);
        if (localajcf != null)
        {
          localajcf.jdField_c_of_type_Int = 0;
          ajrd localajrd2 = localajcf.a();
          ajrd localajrd1;
          if ((localajrd2 != null) && (localajrd2.jdField_a_of_type_Long != 0L))
          {
            localajrd1 = localajrd2;
            if (localajrd2.jdField_a_of_type_Int != 0) {}
          }
          else
          {
            localajrd1 = this.jdField_a_of_type_Ajnj.a(paramString);
          }
          if (localajrd1 != null)
          {
            this.jdField_a_of_type_Ajnj.a(localajrd1);
            this.jdField_a_of_type_Ajnj.a(str);
            ThreadManager.getUIHandler().post(new CmGameSubProcessHandler.9(this));
            paramString = localajcf.a();
            if (paramString != null)
            {
  ...
  private void j(long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((ajcj)localObject).jdField_d_of_type_Int = i;
        if ((((ajcj)localObject).jdField_a_of_type_Int <= 0) || (((ajcj)localObject).jdField_d_of_type_Int < ((ajcj)localObject).jdField_a_of_type_Int)) {
          break label345;
        }
        if (QLog.isColorLevel()) {
          QLog.d("cmgame_process.CmGameSubProcessHandler", 2, "[hanldeGetRedPacketResult] score:" + ((ajcj)localObject).jdField_d_of_type_Int + "info.grabState:" + ((ajcj)localObject).jdField_b_of_type_Int);
        }
        if (((ajcj)localObject).jdField_b_of_type_Int == 3)
        {
          a(paramLong, 0, (ajcj)localObject);
          if (!"0".equals(((ajcj)localObject).f)) {
            break label429;
          }
          ahiw.a(((ajcj)localObject).jdField_b_of_type_JavaLangString, ((ajcj)localObject).jdField_a_of_type_Long, ((ajcj)localObject).jdField_d_of_type_Int + "", Integer.parseInt(((ajcj)localObject).jdField_d_of_type_JavaLangString), bool1, false, this.jdField_d_of_type_Int);
          return;
        }
      }
      catch (Exception paramString)
      ...
      if (((ajcj)localObject).jdField_b_of_type_Int == 0)
      {
        if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
          ahiw.a(ajac.a(), ((ajcj)localObject).g + "", this.jdField_d_of_type_Int + "", i + "", new CmGameSubProcessHandler.4(this, null, paramLong));
        }
        ((ajcj)localObject).jdField_b_of_type_Int = 1;
        return;
      }
      ((ajcj)localObject).jdField_a_of_type_Boolean = true;
      return;
      label345:
      a(paramLong, 0, (ajcj)localObject);
      if ("0".equals(((ajcj)localObject).f)) {}
  ...
  private void j(String paramString)
  {
    ...
    try
    {
      localajcf = ajac.a(this.jdField_d_of_type_Int);
      if (localajcf == null) {
        return;
      }
      localajrd = localajcf.a();
      paramString = new JSONObject(paramString);
    ...
    localajrd.jdField_c_of_type_JavaLangString = paramString.optString("extendInfo");
    paramString = localajcf.a();
    if (paramString != null)
    {
      paramString.mRoomId = l;
      localajrd.jdField_b_of_type_JavaLangString = paramString.mChineseName;
      localajrd.jdField_b_of_type_Int = paramString.mActionId;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString != null)
        {
          ...
          {
            ahiw.a(ajac.a(), paramString.g + "", this.jdField_d_of_type_Int + "", i + "", new CmGameSubProcessHandler.5(this, null, paramLong));
  ...
  private void k(String paramString)
  {
    ...
    if (localAppInterface != null) {
      ajnc.a(localAppInterface, paramString);
    }
  }
  
  private void l(long paramLong, String paramString)
  {
    Object localObject = ajac.b(paramLong);
    paramString = (String)localObject;
    if (localObject == null) {
      paramString = ajac.a((int)paramLong);
    }
    if (paramString != null)
    {
      ...
      if (localObject != null)
      {
        ...
        paramString.a("login", null, new ajbr(this, (CmGameInitParams)localObject, paramLong));
      }
    }
    try
    {
  ...
  private void m(long paramLong, String paramString)
  {
    ...
    {
      ajac.a().callbackFromRequest(paramLong, 6, "cs.xy_device_vibrate.local", "{}");
      QLog.e("cmgame_process.CmGameSubProcessHandler", 1, paramString, new Object[0]);
    }
  }
  ...
  private void n(long paramLong, String paramString)
  {
    ...
    {
      ajac.a().callbackFromRequest(paramLong, 4, "cs.xy_device_gyro_sensor_start.local", "{}");
      QLog.e("cmgame_process.CmGameSubProcessHandler", 1, paramString, new Object[0]);
    }
  }
  ...
  public aivv a(long paramLong, String paramString1, String paramString2)
  {
    ...
    ajcf localajcf = ajac.a(this.jdField_d_of_type_Int);
    if ((localajcf != null) && (!localajcf.b())) {
      if (paramLong == localajcf.a()) {
        break label104;
      }
    }
    label104:
    do
    {
      do
      {
        ...
        {
          return null;
        } while ((localajcf == null) || (localajcf.a() == null));
        if (localajcf.a().getLuaState() == paramLong) {
          break;
        }
      ...
      {
        ajnc.a(this.jdField_d_of_type_Int, paramString2, a());
        return null;
      }
  ...
  {
    paramString = ajee.a(paramString);
    ajcf localajcf = ajac.a(this.jdField_d_of_type_Int);
    if ((paramString == null) || (localajcf == null))
    {
      QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[playADsVideo], adInfo or launcher is null.");
      return;
    }
    paramString.b = paramLong;
    localajcf.a(paramString);
  }
  
  public void a(long paramLong, String paramString, aivq paramaivq)
  {
    if ((this.jdField_b_of_type_JavaUtilHashMap != null) && (this.jdField_b_of_type_JavaUtilHashMap.containsKey(paramString))) {
      paramaivq.a((Bitmap)this.jdField_b_of_type_JavaUtilHashMap.get(paramString), 200);
    }
    for (;;)
    {
      return;
      ...
      {
        ThreadManagerV2.excute(new CmGameSubProcessHandler.10(this, ((aiyo)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).jdField_a_of_type_JavaLangString, paramaivq, paramString), 128, null, true);
        return;
      }
      paramaivq = ajac.a();
      if (paramaivq != null)
      {
        Object localObject1 = ajac.a(this.jdField_d_of_type_Int);
        if (localObject1 == null)
        {
          QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[getUserInfo], launcher is null, mGameId:" + this.jdField_d_of_type_Int);
          return;
        }
        Object localObject2 = ((ajcf)localObject1).a();
        try
        {
          ...
          paramaivq.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject1).toString(), paramLong, jdField_a_of_type_Int);
          if (QLog.isColorLevel())
          {
  ...
  public void a(long paramLong, String paramString, aivr paramaivr)
  {
    if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))) {
      paramaivr.a(((aiyo)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).jdField_b_of_type_JavaLangString);
    }
    for (;;)
    {
      return;
      ...
      if (paramaivr != null)
      {
        ...
        try
        {
          ...
          ((JSONArray)localObject2).put(paramString);
          ((JSONObject)localObject1).put("uidList", localObject2);
          paramaivr.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject1).toString(), paramLong, jdField_b_of_type_Int);
          if (QLog.isColorLevel())
          {
  ...
  public void a(aiyo paramaiyo)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap != null) {
      this.jdField_a_of_type_JavaUtilHashMap.put(paramaiyo.jdField_c_of_type_JavaLangString, paramaiyo);
    }
  }
  ...
  {
    int i = this.e;
    if (ajnc.a(a(), paramString, this.jdField_d_of_type_Int, i)) {}
    try
    {
  ...
  public void b(String paramString)
  {
    try
    {
      ...
      paramString = ajac.a(this.jdField_d_of_type_Int);
      if (paramString != null) {
        paramString.a(i);
      }
      return;
  ...
  {
    int i = 0;
    ajdo localajdo = ajac.a();
    if (localajdo != null)
    {
      localObject1 = ajac.a(this.jdField_d_of_type_Int);
      if (localObject1 == null) {
        QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[getUserInfo], launcher is null, mGameId:" + this.jdField_d_of_type_Int);
      }
    }
    ...
    Object localObject1 = ((ajcf)localObject1).a();
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          localajdo.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject2).toString(), paramLong, jdField_c_of_type_Int, false, null);
          return;
        }
      }
      catch (Exception paramString)
  ...
  {
    Object localObject2 = ajac.b(paramLong);
    Object localObject1 = localObject2;
    if (localObject2 == null) {
      localObject1 = ajac.a((int)paramLong);
    }
    if (localObject1 != null)
    {
      localObject2 = ((ajcf)localObject1).a();
      if (localObject2 != null) {
        try
        {
          CmGameInitParams localCmGameInitParams = ((ajcf)localObject1).a();
