...
public class acwn
{
  ...
  public static int a(String paramString, int paramInt)
  {
    ...
    {
      acvc.d("GdtUIUtils", "getColor error", paramString);
    }
    return paramInt;
  }
  ...
  public static Drawable a(@ColorInt int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      localPaintDrawable.setShaderFactory(new acwo(f1, f3, f2, f4, arrayOfInt));
  ...
  public static boolean a(Activity paramActivity)
  {
    ...
    acvc.a("GdtMvViewController", "hasTopLiuHai  " + LiuHaiUtils.a);
