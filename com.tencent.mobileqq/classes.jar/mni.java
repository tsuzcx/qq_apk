...
public class mni
{
  ...
  private LruCache<String, mnk> jdField_a_of_type_AndroidUtilLruCache = new mnj(this, 4194304);
  private LinkedList<mnl> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  private mnl jdField_a_of_type_Mnl;
  private byte[] jdField_a_of_type_ArrayOfByte;
  private byte[] b;
  
  public mni(int paramInt)
  {
  ...
  public void a()
  {
    try
    {
      this.jdField_a_of_type_Mnl = null;
      return;
    }
    finally
    {
  ...
  public void a(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        mnk localmnk = (mnk)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
        if (localmnk != null)
        {
          this.jdField_a_of_type_Mnl = new mnl(localmnk, true);
          continue;
        }
        if (!QLog.isColorLevel()) {
          break label96;
      ...
      label96:
      a(paramString);
      paramString = (mnk)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
      if (paramString != null) {
        this.jdField_a_of_type_Mnl = new mnl(paramString, true);
      }
    }
  }
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    try
    {
      ...
      mnl localmnl = this.jdField_a_of_type_Mnl;
      if (localmnl != null) {
        localmnl.a(this.jdField_a_of_type_ArrayOfByte, 0, paramInt);
      }
      Arrays.fill(this.b, (byte)0);
      if ((this.jdField_a_of_type_JavaUtilLinkedList.size() > 0) && (i < paramInt))
      {
        localmnl = (mnl)this.jdField_a_of_type_JavaUtilLinkedList.get(0);
        if (localmnl != null)
        {
          int j = i + localmnl.a(this.b, i, paramInt);
          i = j;
          if (!localmnl.a()) {
            break label229;
          }
      ...
      {
        mnm.a(paramArrayOfByte, this.jdField_a_of_type_ArrayOfByte, this.b, paramInt);
        return;
      }
    }
    finally {}
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      if (arrayOfByte != null)
      {
        localObject = new mnk(paramString, arrayOfByte);
  ...
  public void b(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        if (localmnk != null)
        {
          paramString = new mnl(localmnk, false);
      ...
      if (paramString != null)
      {
        paramString = new mnl(paramString, false);
        this.jdField_a_of_type_JavaUtilLinkedList.add(paramString);
      }
    }
  }
