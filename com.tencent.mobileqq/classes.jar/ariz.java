...
public class ariz
{
  ...
  public static ariz a()
  {
    try
    {
      if (jdField_a_of_type_Ariz == null) {
        jdField_a_of_type_Ariz = new ariz();
      }
      ariz localariz = jdField_a_of_type_Ariz;
      return localariz;
    }
    finally {}
  }
  
  private TroopAssistantData a(atmp paramatmp, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      ...
      paramatmp = localTroopAssistantData;
  ...
  {
    jdField_a_of_type_Ariz = null;
  }
  
  /* Error */
  private void a(atmp arg1)
  {
    // Byte code:
    //   0: aload_1
    //   1: ldc 64
    ...
    //   8: ldc 93
    //   10: aconst_null
    //   11: invokevirtual 98	atmp:a	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   14: astore_2
    //   15: aload_2
    //   16: ifnull +198 -> 214
    //   19: aload_2
    ...
    //   32: dup
    //   33: aload_0
    //   34: invokespecial 109	arja:<init>	(Lariz;)V
    ...
    //   76: aload_0
    //   77: getfield 38	ariz:jdField_b_of_type_JavaLangObject	Ljava/lang/Object;
    //   80: astore_1
    //   81: aload_1
    //   82: monitorenter
    //   83: aload_0
    //   84: aload_2
    //   85: putfield 145	ariz:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   88: aload_0
    //   89: getfield 145	ariz:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   92: ifnonnull +16 -> 108
    //   95: aload_0
    ...
    //   105: putfield 145	ariz:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   108: aload_1
    //   109: monitorexit
    //   110: aload_0
    //   111: getfield 47	ariz:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   114: astore_1
    //   115: aload_1
    //   116: monitorenter
    //   117: aload_0
    //   118: getfield 47	ariz:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   121: invokeinterface 153 1 0
    //   126: aload_0
    //   127: getfield 145	ariz:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   154: astore_3
    //   155: aload_0
    //   156: getfield 47	ariz:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   159: aload_3
  ...
  private void a(atmp paramatmp, TroopAssistantData paramTroopAssistantData)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        ...
        ThreadManager.post(new TroopAssistantManager.4(this, paramTroopAssistantData, paramatmp), 8, null, false);
        return;
        paramatmp = finally;
        throw paramatmp;
        i += 1;
  ...
  private boolean a(atmp paramatmp, String paramString)
  {
    ...
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      ...
      if (paramString != null)
      {
        ThreadManager.post(new TroopAssistantManager.3(this, paramatmp, paramString), 8, null, false);
        return true;
        paramatmp = finally;
        throw paramatmp;
      }
  ...
  private boolean a(QQAppInterface paramQQAppInterface, int paramInt, long paramLong)
  {
    ...
    case 2: 
      if (bool)
      {
        localObject = localakeu.a(ajed.C, 5000);
        ((RecentUser)localObject).uin = ajed.C;
    ...
    for (;;)
    {
      ...
      if (paramInt != 3)
      {
        paramQQAppInterface = localakeu.b(ajed.C, 5000);
        if (paramQQAppInterface != null) {
          localakeu.b(paramQQAppInterface);
        }
      }
    }
  }
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_JavaUtilSet != null)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if ((!TextUtils.isEmpty(str)) && (!acxd.a(str, 1, paramQQAppInterface))) {
              i += 1;
            }
          }
          else
      ...
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if (acxd.a(localTroopAssistantData.troopUin, 1, paramQQAppInterface)) {
              continue;
            }
  ...
  public void a(atmp paramatmp, QQAppInterface paramQQAppInterface)
  {
    try
    {
      a(paramQQAppInterface);
      akeu localakeu = paramQQAppInterface.a().a();
      Object localObject2 = localakeu.a(false);
      ...
      if (((List)localObject1).size() > 0)
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          localObject3 = a(paramatmp, paramQQAppInterface, ((RecentUser)localObject2).uin);
          ...
          {
            a(paramatmp, (TroopAssistantData)localObject3);
  ...
  public void a(QQAppInterface paramQQAppInterface, mmn parammmn)
  {
    ThreadManager.post(new TroopAssistantManager.2(this, paramQQAppInterface, parammmn), 8, null, true);
  }
  ...
  public void a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    ...
    a(paramMessageRecord, paramMessageRecord.frienduin, paramMessageRecord.time, localatmp, paramQQAppInterface);
    localatmp.a();
  }
  
  public void a(MessageRecord paramMessageRecord, String paramString, long paramLong, atmp paramatmp, QQAppInterface paramQQAppInterface)
  {
    TroopAssistantData localTroopAssistantData = a(paramatmp, paramQQAppInterface, paramString);
    ...
    for (localTroopAssistantData.lastmsgtime = paramMessageRecord.time;; localTroopAssistantData.lastmsgtime = paramLong)
    {
      ...
      a(paramatmp, localTroopAssistantData);
  ...
  public void a(String paramString, long paramLong, atmp paramatmp, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      a(paramQQAppInterface, 0, paramLong);
      return;
      localTroopAssistantData = a(paramatmp, paramQQAppInterface, paramString);
      break;
      label94:
      a(paramatmp, localTroopAssistantData);
    }
  ...
  public void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    atmp localatmp = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    akeu localakeu = paramQQAppInterface.a().a();
    RecentUser localRecentUser = localakeu.b(paramString, 1);
    QQMessageFacade.Message localMessage;
    if (localRecentUser != null)
    {
      paramString = a(localatmp, paramQQAppInterface, paramString);
    ...
    for (paramString.lastmsgtime = localMessage.time;; paramString.lastmsgtime = localRecentUser.lastmsgtime)
    {
      ...
      a(localatmp, paramString);
      e(paramString.troopUin, paramQQAppInterface);
      ahay.a().a(localRecentUser.uin + "-" + localRecentUser.getType());
      if ((!(localRecentUser.msg instanceof ahdl)) && (!(localRecentUser.msg instanceof aheb)) && (!(localRecentUser.msg instanceof ahdo)) && (!(localRecentUser.msg instanceof ahdu)) && (!(localRecentUser.msg instanceof ahdk)) && (!(localRecentUser.msg instanceof bgom)) && (!(localRecentUser.msg instanceof ahdz)) && (!(localRecentUser.msg instanceof ahdt))) {
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_JavaUtilSet = baih.a((SharedPreferences)localObject2, "troop_assis_new_unread_list", null);
      if (this.jdField_a_of_type_JavaUtilSet == null)
      {
        this.jdField_a_of_type_JavaUtilSet = new HashSet();
  ...
  public void c(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      {
        localObject = localatmp;
        RecentUser localRecentUser = localakeu.a(String.valueOf(localTroopAssistantData.troopUin), 1);
        localObject = localatmp;
  ...
  public void i(QQAppInterface paramQQAppInterface)
  {
    ...
    if (((ArrayList)localObject3).size() > 0)
    {
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        localObject5 = a(localatmp, paramQQAppInterface, ((RecentUser)???).uin);
        ...
        {
          a(localatmp, (TroopAssistantData)localObject5);
          ((akeu)localObject1).b((RecentUser)???);
    ...
    if (((ArrayList)localObject2).size() > 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        ??? = ((akeu)localObject1).a(((TroopAssistantData)localObject3).troopUin, 1);
        ...
        if (a(localatmp, ((TroopAssistantData)localObject3).troopUin))
        {
          ((akeu)localObject1).a((RecentUser)???);
  ...
  public void k(QQAppInterface paramQQAppInterface)
  {
    try
    {
      ...
      if (a(paramQQAppInterface) == true)
      {
        ...
        a().a(localatmp, paramQQAppInterface);
        localatmp.a();
      }
      c(paramQQAppInterface);
      if (arjb.a().a(paramQQAppInterface) == true)
      {
        localatmp = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
        arjb.a().a(localatmp, paramQQAppInterface);
        localatmp.a();
      }
      return;
    }
