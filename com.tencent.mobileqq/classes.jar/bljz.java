...
public final class bljz
{
  ...
  public static bcxy a(StructMsgForImageShare paramStructMsgForImageShare)
  {
    if (paramStructMsgForImageShare.getItemCount() > 0)
    {
      paramStructMsgForImageShare = paramStructMsgForImageShare.getItemByIndex(0);
      if ((paramStructMsgForImageShare instanceof bczv))
      {
        paramStructMsgForImageShare = (bczv)paramStructMsgForImageShare;
        if ((paramStructMsgForImageShare.a.size() > 0) && ((paramStructMsgForImageShare.a.get(0) instanceof bcxy))) {
          return (bcxy)paramStructMsgForImageShare.a.get(0);
        }
      }
    }
    return null;
  ...
  public static blju a(byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length <= 16)) {
      return null;
    }
    ...
    if ((localObject2 instanceof ChatMessage))
    {
      if ((localObject2 instanceof MessageForStructing))
      {
        ...
        {
          localObject1 = bcwd.a((byte[])localObject1);
          ((MessageForStructing)localObject2).structingMsg = ((AbsStructMsg)localObject1);
        }
        return new blju((ChatMessage)localObject2, paramArrayOfByte);
      }
      return new blju((ChatMessage)localObject2, paramArrayOfByte);
    }
    return null;
  ...
  public static List<bljt> a(List<byte[]> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      return null;
    }
    ...
    while (paramList.hasNext())
    {
      ...
      if (l1 != 2L)
      {
        ...
        if (l1 == 1L)
        {
          ...
          if (localObject != null) {
            localArrayList.add(new bljt(l2, l1, ((blju)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage, ((blju)localObject).jdField_a_of_type_JavaLangString));
        ...
        else if (l1 == 3L)
        {
          ...
          localObject = a((byte[])localObject);
          if (localObject != null) {
            localArrayList.add(new bljt(l2, l1, (ContentValues)localObject));
          }
        }
      }
    }
  ...
  public static void a(long paramLong, List<bljt> paramList1, List<bljt> paramList2)
  {
    ...
    for (;;)
    {
      ...
      {
        bljt localbljt = (bljt)paramList1.next();
        if (localbljt.b == paramLong) {
          paramList2.add(localbljt);
        }
      }
    }
  }
  ...
  public static void a(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = paramContext.getResources().getDimensionPixelSize(2131298998) - (int)bgme.a(paramContext, 5.0F);
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    ...
    paramInt = paramContext.getResources().getDimensionPixelSize(2131298998) - (int)bgme.a(paramContext, 5.0F);
    paramContext = Looper.getMainLooper();
    if (Thread.currentThread() != paramContext.getThread())
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForStructing paramMessageForStructing, List<ChatMessage> paramList, Map<String, String> paramMap, ArrayList<byte[]> paramArrayList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramList = (String)paramMap.get(acwh.c(localChatMessage));
        ...
        continue;
        paramList = awwm.a().a(paramQQAppInterface, paramMessageForStructing.uniseq);
      }
  ...
  public static boolean a(Activity paramActivity)
  {
    if (!bgjq.a())
    {
      a(paramActivity, 2131693371, 1);
      return false;
    }
    if (bgjq.a() < 500L)
    {
      a(paramActivity, 2131693370, 1);
      return false;
    }
    return true;
  }
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, long paramLong, ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = agmg.a(paramQQAppInterface, paramChatMessage);
    }
  ...
  public static String[] a(byte[] paramArrayOfByte)
  {
    ...
    //   864: astore 21
    //   866: aload 9
    //   868: invokestatic 901	bljz:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   871: astore 25
    //   873: aload 4
    //   875: astore 23
    //   877: aload 5
    ...
    //   1070: astore 21
    //   1072: aload 9
    //   1074: invokestatic 901	bljz:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   1077: astore 24
    //   1079: aload 4
    //   1081: astore 23
    //   1083: aload 5
  ...
  public static byte[] b(QQAppInterface paramQQAppInterface, long paramLong, ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (((paramChatMessage instanceof MessageForTroopFile)) || ((paramChatMessage instanceof MessageForFile)))
    {
      ...
      localObject = agmg.a(paramQQAppInterface, paramChatMessage);
      a((FileManagerEntity)localObject);
      if (localObject == null) {
        break label218;
      }
      localbljl.a(paramQQAppInterface, null, (FileManagerEntity)localObject, paramChatMessage, true);
    }
    for (;;)
    {
      paramQQAppInterface = new ContentValues();
      localObject = (ContentValues)localbljl.a().getExtras().getParcelable("fileContents");
      if (localObject != null) {
        paramQQAppInterface.put("fileContents", a((ContentValues)localObject));
      }
      localObject = acwh.c(paramChatMessage);
      ...
      localObject = atvo.a(paramQQAppInterface, (MessageForFile)paramChatMessage);
      break;
      label218:
      label482:
      if (QLog.isColorLevel())
      {
        ...
        if ((paramChatMessage instanceof MessageForTroopFile))
        {
          ...
          {
            a((FileManagerEntity)localObject);
            agmg.a((FileManagerEntity)localObject, localMessageForTroopFile);
            if (localObject == null) {
              break label482;
            }
            localbljl.a(paramQQAppInterface, null, (FileManagerEntity)localObject, localMessageForTroopFile, true);
            break;
            if (QLog.isColorLevel()) {
              QLog.d("qqfav", 2, "parcelFileMsg, isMultiMsg T, find in db");
            }
            localObject = bfsj.a(paramQQAppInterface, localMessageForTroopFile);
            if (localObject != null)
            {
              FileManagerEntity localFileManagerEntity = agmg.a((bety)localObject);
              localObject = bfrm.a(paramQQAppInterface, ((bety)localObject).b);
              if ((localObject != null) && (localFileManagerEntity != null) && (!TextUtils.isEmpty(localFileManagerEntity.strTroopFilePath)))
              {
                besl localbesl = ((bfrm)localObject).a(localFileManagerEntity.strTroopFilePath);
                localObject = localFileManagerEntity;
                if (localbesl != null)
                {
                  localFileManagerEntity.lastTime = localbesl.c;
                  localFileManagerEntity.selfUin = String.valueOf(localbesl.b);
                  localObject = localFileManagerEntity;
                }
              }
              else
