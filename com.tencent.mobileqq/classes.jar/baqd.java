...
{
  public baqd(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  private String a(MessageForPic paramMessageForPic, String paramString)
  {
    ...
    while (!bdcs.a(paramMessageForPic.path)) {
      return paramString;
    }
    paramMessageForPic = new CompressInfo(paramMessageForPic.path, 0);
    awga.b(paramMessageForPic);
  ...
  private void a(DownloadParams paramDownloadParams, OutputStream paramOutputStream, URLDrawableHandler paramURLDrawableHandler, boolean paramBoolean)
  {
    ...
    if ((paramDownloadParams.tag != null) && ((paramDownloadParams.tag instanceof MessageForPic)))
    {
      ...
      i = baul.a(paramDownloadParams.url.getProtocol(), false);
    ...
    for (;;)
    {
      ...
      if (((MessageForPic)localObject5).picExtraFlag == batv.f)
      {
        paramDownloadParams = ((bard)((MessageForPic)localObject5).picExtraObject).c;
        ...
        for (;;)
        {
          try
          {
            if ((QLog.isColorLevel()) && (localObject1 != null)) {
              QLog.i("lbs", 2, "CONVERT_URL success,@time:" + ((baok)localObject1).jdField_b_of_type_Long + ",uniseq=" + (String)localObject3);
            }
            localObject4 = new baol();
          }
          ...
          try
          {
            ((baol)localObject4).jdField_a_of_type_Long = System.currentTimeMillis();
            if (QLog.isColorLevel()) {
              QLog.i("lbs", 2, "DOWNLOAD_FILE start,@time:" + ((baol)localObject4).jdField_a_of_type_Long + ",uniseq=" + (String)localObject3);
            }
            paramURLDrawableHandler = new bamh(paramOutputStream, paramURLDrawableHandler, (QQAppInterface)localObject5);
            paramURLDrawableHandler.jdField_a_of_type_JavaLangString = "lbs";
            localObject7 = new bamg(paramDownloadParams, null, paramURLDrawableHandler, true);
            paramOutputStream = "gprs";
            if (bdee.b(BaseApplication.getContext()) == 1) {
              paramOutputStream = "wifi";
            }
            ((bamg)localObject7).a("Net-type", paramOutputStream);
            ((bamg)localObject7).b(5);
            ((bamg)localObject7).a(true);
            ((bamg)localObject7).a("Accept-Encoding", "identity");
            j = 0;
            if (i > 3) {
              continue;
            }
            try
            {
              ((bamg)localObject7).a("Range", "bytes=" + j + "-");
              paramURLDrawableHandler.jdField_a_of_type_Boolean = false;
              ((bamg)localObject7).jdField_a_of_type_Boolean = false;
              ((QQAppInterface)localObject5).getHttpCommunicatort().b((bdlo)localObject7);
              j = paramURLDrawableHandler.jdField_a_of_type_Int;
              if (!paramURLDrawableHandler.jdField_a_of_type_Boolean) {
                continue;
              }
              ((baol)localObject4).jdField_e_of_type_Int = ((bamg)localObject7).jdField_e_of_type_Int;
          ...
          if (i == 3)
          {
            ((baok)localObject1).jdField_a_of_type_Boolean = false;
            ((baok)localObject1).jdField_b_of_type_Long = System.currentTimeMillis();
            ((baok)localObject1).jdField_b_of_type_Int = j;
            ((baok)localObject1).jdField_a_of_type_Int = k;
            ((baok)localObject1).c = l2;
            ((baok)localObject1).jdField_a_of_type_JavaLangString = paramDownloadParams.getMessage();
            ...
            localObject4 = new baok();
          }
          DownloadParams localDownloadParams;
          try
          {
            ((baok)localObject4).jdField_a_of_type_Long = System.currentTimeMillis();
            if (QLog.isColorLevel())
            {
              QLog.i("lbs", 2, "CONVERT_URL start @time:" + ((baok)localObject4).jdField_a_of_type_Long + ",uniseq=" + (String)localObject3);
              break label2074;
              if (i <= 3)
              {
                paramDownloadParams = new bami();
                if (paramBoolean)
                {
                  j = 1;
                  byte b = (byte)j;
                ...
                j = 0;
                continue;
                ((baok)localObject4).jdField_b_of_type_Int = i;
          ...
          try
          {
            ...
            try
            {
              ((baok)localObject4).jdField_b_of_type_Long = System.currentTimeMillis();
              if (QLog.isColorLevel()) {
                QLog.d("lbs", 2, "<--downloadLBSImage actualUrl=" + paramDownloadParams);
              }
              ((baok)localObject4).jdField_a_of_type_Boolean = true;
              j = 3;
            ...
            if ((paramURLDrawableHandler.jdField_a_of_type_Long > 0L) && (j >= paramURLDrawableHandler.jdField_a_of_type_Long)) {
              ((bamg)localObject7).jdField_a_of_type_Boolean = true;
            }
            if (!((bamg)localObject7).jdField_a_of_type_Boolean) {
              break label2121;
            }
            if (QLog.isColorLevel()) {
            ...
            {
              ((baol)localObject4).jdField_e_of_type_Int = ((bamg)localObject7).jdField_e_of_type_Int;
              ((baol)localObject4).jdField_a_of_type_Int = ((bamg)localObject7).f;
              ((baol)localObject4).jdField_a_of_type_JavaLangString = ((bamg)localObject7).b;
              throw new FileDownloadFailedException(((bamg)localObject7).f, ((bamg)localObject7).c, ((bamg)localObject7).b, false);
            }
            ((baol)localObject4).jdField_a_of_type_Boolean = ((bamg)localObject7).jdField_a_of_type_Boolean;
            ((baol)localObject4).jdField_b_of_type_Long = System.currentTimeMillis();
            ((baol)localObject4).jdField_e_of_type_Long = paramURLDrawableHandler.jdField_a_of_type_Int;
            ((baol)localObject4).f = paramURLDrawableHandler.jdField_a_of_type_Long;
            if (!QLog.isColorLevel()) {
              break;
            }
            QLog.i("lbs", 2, "DOWNLOAD_FILE success,@time:" + ((baol)localObject4).jdField_b_of_type_Long + ",uniseq=" + (String)localObject3);
            return;
          }
          catch (Exception paramDownloadParams)
          {
