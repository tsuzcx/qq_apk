  ...
  extends ajjh
{
  ...
  protected void onAddFriend(String paramString)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(ktu.jdField_a_of_type_JavaLangString, 2, "onAddFriend 进入好友列表" + paramString);
    }
    ktu.a(this.a, paramString, 4);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(ktu.jdField_a_of_type_JavaLangString, 2, "onGetAutoInfo  isSuccess= " + paramBoolean + ",uin=" + paramString1 + ",remark=" + paramString2 + ",groupId" + paramInt);
    }
  }
  ...
  protected void onQueryUinSafetyFlag(boolean paramBoolean, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(ktu.jdField_a_of_type_JavaLangString, 2, "onQueryUinSafetyFlag isSuccess=" + paramBoolean + ",status=" + paramInt2 + ",uin=" + paramLong);
      }
      if ((!paramBoolean) || (paramInt2 == 0)) {
        ktu.a(this.a, String.valueOf(paramLong));
      }
    }
    else
    {
    ...
    ktu.a(this.a, String.valueOf(paramLong), 3, paramInt2);
  }
  ...
  protected void onUpdateAddFriend(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString, Bundle paramBundle)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(ktu.jdField_a_of_type_JavaLangString, 2, "onUpdateAddFriend 请求加好友回调  isSuccess= " + paramBoolean1 + ",addSuccess=" + paramBoolean2 + ",reqestUin=" + paramString + ",friendSetting" + i);
    }
  ...
  protected void onUpdateAddFriendSetting(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    int i = paramBundle.getInt("friend_setting");
    if (QLog.isColorLevel()) {
      QLog.d(ktu.jdField_a_of_type_JavaLangString, 2, "onUpdateAddFriendSetting  isSuccess= " + paramBoolean + ",uin" + str + ",friendSetting=" + i);
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(ktu.jdField_a_of_type_JavaLangString, 2, "好友onUpdateCustomHead success = " + paramBoolean + ", uin = " + paramString);
    }
  }
  ...
  protected void onUpdateDelFriend(boolean paramBoolean, Object paramObject)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(ktu.jdField_a_of_type_JavaLangString, 2, "onUpdateDelFriend 删除好友" + paramObject);
    }
    ktu.a(this.a, paramObject, 0);
