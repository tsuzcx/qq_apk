  ...
  implements View.OnClickListener
{
  ...
  {
    Object localObject3 = (yqa)paramView.getTag();
    if (((yqa)localObject3).a.jdField_a_of_type_Boolean)
    {
      ...
      paramView.putExtra("filepath", this.a.e + ((yqa)localObject3).a.jdField_a_of_type_JavaLangString);
      paramView.putExtra("filename", "" + ((yqa)localObject3).a.jdField_a_of_type_JavaLangString);
      paramView.putExtra("nSessionId", this.a.jdField_b_of_type_Long);
      paramView.putExtra("isHttps", ypy.a(this.a));
      if (!TextUtils.isEmpty(ypy.a(this.a))) {
        paramView.putExtra("httpsDomain", ypy.a(this.a));
      }
      paramView.putExtra("httpsPort", ypy.a(this.a));
    ...
    localForwardFileInfo.b(((yqa)localObject3).a.jdField_b_of_type_Long);
    localForwardFileInfo.d(((yqa)localObject3).a.jdField_a_of_type_JavaLangString);
    localForwardFileInfo.d(((yqa)localObject3).a.jdField_a_of_type_Long);
    localForwardFileInfo.b("");
    Object localObject2;
    if (this.a.jdField_a_of_type_Long == 0L)
    {
      localObject2 = (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime();
      Object localObject4 = ((QQAppInterface)localObject2).a().b(((yqa)localObject3).a.jdField_b_of_type_Long);
      ...
      if (paramView != null)
      {
        ((yqa)localObject3).a.jdField_b_of_type_Long = paramView.nSessionId;
        paramView.isZipInnerFile = true;
      }
      localForwardFileInfo.b(((yqa)localObject3).a.jdField_b_of_type_Long);
      if (localForwardFileInfo.d() == 0L)
      {
        armz.a(alpo.a(2131717427));
        return;
      }
      ...
      {
        arjn localarjn = (arjn)((Iterator)localObject4).next();
        if ((arni.a(localarjn.jdField_a_of_type_JavaLangString) == 0) && (localarjn.jdField_a_of_type_Long != 0L))
        {
          FileManagerEntity localFileManagerEntity = ((QQAppInterface)localObject2).a().b(localarjn.jdField_b_of_type_Long);
          ...
          if (paramView != null)
          {
            ...
            localarjn.jdField_b_of_type_Long = paramView.nSessionId;
          }
          ((ArrayList)localObject3).add(Long.valueOf(localarjn.jdField_b_of_type_Long));
        }
      }
    ...
    {
      localObject2 = (arjn)((Iterator)localObject1).next();
      if (arni.a(((arjn)localObject2).jdField_a_of_type_JavaLangString) == 0) {
        paramView.add(Long.valueOf(((arjn)localObject2).jdField_b_of_type_Long));
      }
    }
