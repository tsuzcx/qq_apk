  ...
  extends bcvt
{
  ...
  private RelativeLayout a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestWidth = afur.a(70.0F, localResources);
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestHeight = afur.a(70.0F, localResources);
      localObject1 = URLDrawable.getDrawable(paramString1, (URLDrawable.URLDrawableOptions)localObject1);
      localAnyScaleTypeImageView.setId(2131368246);
      localAnyScaleTypeImageView.setImageDrawable((Drawable)localObject1);
      paramString1 = new RelativeLayout.LayoutParams(afur.a(70.0F, localResources), afur.a(70.0F, localResources));
      paramString1.addRule(9);
      paramString1.addRule(10);
      localTextViewWrapLayout.addView(localAnyScaleTypeImageView, paramString1);
      i = afur.a(10.0F, localResources);
      paramString1 = new TextView(paramContext);
      paramString1.setId(2131379957);
  ...
  private RelativeLayout a(Context paramContext, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      j = localResources.getDimensionPixelSize(2131296389);
      if (!paramBoolean) {
        break label135;
      }
      k = localResources.getDimensionPixelSize(2131296390);
      if (!a(1)) {
        break label147;
      }
      m = afur.a(15.0F, localResources);
      i = afur.a(6.0F, localResources);
      if (!a(2)) {
        break label159;
      }
      i = afur.a(15.0F, localResources);
    }
    for (;;)
    {
      ...
      break;
      label135:
      k = localResources.getDimensionPixelSize(2131298901);
      break label63;
      label147:
      m = afur.a(6.0F, localResources);
      break label80;
      label159:
      if (a(1)) {
        i = afur.a(15.0F, localResources);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (((Bundle)localObject3).getBoolean("pre_dialog") == true)
    {
      ...
      {
        localObject4 = (bcvs)((Iterator)localObject5).next();
        if ((localObject4 instanceof bdaz))
        {
          localObject4 = (bdaz)localObject4;
          if (!((bdaz)localObject4).a()) {
            break label164;
          }
          localObject2 = ((bdaz)localObject4).aa;
          localObject4 = ((bdaz)localObject4).ae;
    ...
    for (;;)
    {
      ...
      if ((localObject4 instanceof StructMsgItemTitle))
      {
        ...
        if (((Bundle)localObject3).getInt("accostType") == AbsStructMsg.SOURCE_ACCOUNT_TYPE_PA)
        {
          ...
          paramView.setBackgroundColor(paramContext.getResources().getColor(2131165286));
          n = afur.a(10.0F, (Resources)localObject5);
          int i1 = afur.a(4.0F, (Resources)localObject5);
          int i2 = afur.a(5.0F, (Resources)localObject5);
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject1 = ((bcvs)localObject4).a(paramContext, null, (Bundle)localObject3);
              localObject4 = ((View)localObject1).findViewById(2131368420);
              if ((localObject4 != null) && ((localObject4 instanceof AnyScaleTypeImageView))) {
                ((AnyScaleTypeImageView)localObject4).setTag(2131373036, Integer.valueOf(1));
              }
              k = i;
            ...
            else
            {
              if ("video".equals(str))
              {
                if ((localObject4 instanceof bdaz))
                {
                  localObject1 = (bdaz)localObject4;
                  if (this.jdField_a_of_type_Boolean) {
                    ((bdaz)localObject1).c = false;
                  }
                  if (((bdaz)localObject1).a()) {
                    if (!this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.hasFlag(4))
                    {
                      ...
                      {
                        localObject1 = (bcvs)this.jdField_a_of_type_JavaUtilArrayList.get(k);
                        if (!"title".equals(((bcvs)localObject1).jdField_a_of_type_JavaLangString)) {
                          break label859;
                        }
                ...
                for (;;)
                {
                  ...
                  localObject4 = ((bcvs)localObject4).a(paramContext, null, (Bundle)localObject3);
                  k = 1;
                ...
                if (localObject1 != null)
                {
                  ...
                  i = ((Resources)localObject5).getDimensionPixelSize(2131296389);
                ...
                for (k = (int)(i / 1.8F);; k = m)
                {
                  ...
                  for (;;)
                  {
                    ...
                    if ((j != 0) && (!TextUtils.isEmpty(paramBundle)) && ((localObject1 instanceof TitledImageView)))
                    {
                      ...
                      ((TitledImageView)localObject3).setTextSize(afur.a(2, 18, (Resources)localObject5));
                      ((TitledImageView)localObject3).setTextBackground(paramContext.getResources().getColor(2131165286));
                      ((TitledImageView)localObject3).setTextPadding(afur.a(10.0F, (Resources)localObject5));
                      ((TitledImageView)localObject3).settextBgRadius(afur.a(12.0F, (Resources)localObject5));
                    }
                    if ((j != 0) && (!TextUtils.isEmpty(paramBundle)))
                    {
                      paramContext = ((View)localObject1).getTag(2131377940);
                      if ((paramContext != null) && ((paramContext instanceof bdbg))) {
                        ((bdbg)paramContext).a.setText(paramBundle);
                      }
                    }
                    ...
                    ((RelativeLayout)localObject2).setId(2131377937);
                    return localObject2;
                    i = ((Resources)localObject5).getDimensionPixelSize(2131298900);
                    break;
                  }
                  i = k - i * 2;
                  break label960;
