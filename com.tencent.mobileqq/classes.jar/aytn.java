...
public class aytn
{
  ...
  public static void a()
  {
    ...
    axrn.a(BaseApplication.getContext()).a(null, "actPttCpuArch", false, 0L, 0L, localHashMap, "");
  }
  ...
  public static void a(int paramInt)
  {
    ...
    localHashMap.put(BaseConstants.RDM_NoChangeFailCode, "");
    axrn.a(BaseApplication.getContext()).a(null, "actPttLongPressFate2", false, 0L, 0L, localHashMap, "");
  }
  ...
  public static void a(int paramInt1, int paramInt2)
  {
    ...
    for (long l1 = jdField_c_of_type_Long / jdField_b_of_type_Int;; l1 = 0L)
    {
      ...
      for (long l2 = d / jdField_c_of_type_Int;; l2 = 0L)
      {
        ...
        axrn.a(BaseApplication.getContext()).a(null, "actPttGcCount", true, paramInt2, jdField_a_of_type_Int, localHashMap, "");
  ...
  public static void a(long paramLong1, int paramInt1, long paramLong2, int paramInt2)
  {
    ...
    for (boolean bool = jdField_b_of_type_Boolean;; bool = jdField_a_of_type_Boolean)
    {
      ...
      axrn.a(BaseApplication.getContext()).a(null, "actPttProcessFrameCost", true, paramLong1, paramInt1, localHashMap, "");
      return;
    }
  }
  ...
  {
    axqy.b(paramQQAppInterface, "CliOper", "", "", "0X80059B1", "0X80059B1", paramInt, 0, "", "", "", "8.3.0");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      axqy.b(paramQQAppInterface, "CliOper", "", "", "0X8005C1D", "0X8005C1D", paramInt1, paramInt2, "", "", "", "8.3.0");
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      axqy.b(paramQQAppInterface, "CliOper", "", "", "0X8005C1C", "0X8005C1C", i * 10 + paramInt1 * 100 + paramInt2, 0, "", "", "", "8.3.0");
      return;
    }
  }
  ...
  public static void a(String paramString, boolean paramBoolean1, boolean paramBoolean2, int paramInt, long paramLong)
  {
    for (;;)
    {
      ...
      axrn.a(BaseApplication.getContext()).a(null, str, paramBoolean2, l1 - l2, paramLong, (HashMap)localObject, "");
  ...
  {
    HashMap localHashMap = new HashMap();
    axrn.a(BaseApplication.getContext()).a(null, "actPttDownloadStream2Offline", paramBoolean, 0L, 0L, localHashMap, "");
  }
  ...
  public static void a(boolean paramBoolean, long paramLong1, long paramLong2, long paramLong3)
  {
    if ((paramLong1 == 1000L) || (paramLong1 == 1001L) || (paramLong1 == 10002L) || (paramLong1 == 10004L) || (paramLong1 == 1002L) || (paramLong1 == 1003L) || (paramLong1 == 1004L) || (paramLong1 == 1005L) || (paramLong1 == 1006L) || (paramLong1 == 1008L) || (paramLong1 == 1009L) || (paramLong1 == 1010L) || (paramLong1 == 1011L) || (paramLong1 == 1020L) || (paramLong1 == 1021L) || (paramLong1 == 1022L) || (paramLong1 == 1023L) || (paramLong1 == 1024L) || (paramLong1 == 1025L))
    {
      ...
      axrn.a(BaseApplication.getContext()).a(null, "actAllC2CPttUp", paramBoolean, paramLong2, paramLong3, localHashMap, "");
    }
  }
  ...
  public static void a(boolean paramBoolean, String paramString)
  {
    ...
    for (;;)
    {
      ...
      axrn.a(BaseApplication.getContext()).a(null, "actPttSoUpdate", false, 0L, 0L, paramString, "");
      return;
  ...
  public static void b(int paramInt)
  {
    ...
    if (l > 0L)
    {
      HashMap localHashMap = new HashMap();
      localHashMap.put(BaseConstants.RDM_NoChangeFailCode, "");
      localaxrn.a("", "PTTCostUntilPrepare", true, l, paramInt, localHashMap, "");
      if (QLog.isColorLevel()) {
  ...
  public static void b(boolean paramBoolean)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put(BaseConstants.RDM_NoChangeFailCode, "");
    axrn.a(BaseApplication.getContext()).a(null, "actPttNoRangeFailed", paramBoolean, 0L, 0L, localHashMap, "");
  }
  ...
  public static void c(int paramInt)
  {
    ...
    localHashMap.put(BaseConstants.RDM_NoChangeFailCode, "");
    localHashMap.put("param_FailCode", String.valueOf(paramInt));
    localaxrn.a("", "PTTStraightRecordCount", false, 0L, 0L, localHashMap, "");
