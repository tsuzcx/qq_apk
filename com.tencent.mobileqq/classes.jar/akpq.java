...
public class akpq
{
  private static List<akpr> jdField_a_of_type_JavaUtilList = new ArrayList(32);
  ...
  public static void a()
  {
    synchronized (jdField_a_of_type_JavaUtilList)
    {
      ...
      {
        akpr localakpr = (akpr)localIterator.next();
        HashMap localHashMap = new HashMap();
        localHashMap.put("param_FailCode", String.valueOf(localakpr.jdField_a_of_type_Int));
        localHashMap.put(BaseConstants.RDM_NoChangeFailCode, "");
        localHashMap.put("msgType", String.valueOf(localakpr.b));
        localHashMap.put("uinType", String.valueOf(localakpr.c));
        axrn.a(BaseApplication.getContext()).a(localakpr.jdField_a_of_type_JavaLangString, "actBelatedMsg", false, localakpr.jdField_a_of_type_Long, 0L, localHashMap, "");
      }
    }
    akpr.a(jdField_a_of_type_JavaUtilList);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    axrn.a(BaseApplication.getContext()).a(null, "actNoCachedLastMsg", true, 0L, 0L, paramQQAppInterface, "");
  }
  ...
  public static void a(MessageRecord arg0, QQAppInterface paramQQAppInterface)
  {
    ...
    for (int i = 1;; i = 2)
    {
      paramQQAppInterface = akpr.a(i, paramQQAppInterface.c(), l, ???.msgtype, ???.istroop);
      synchronized (jdField_a_of_type_JavaUtilList)
      {
  ...
  public static void a(String paramString, long paramLong)
  {
    if (Math.abs(jdField_a_of_type_JavaUtilRandom.nextInt() % 10000) < 10)
    {
      HashMap localHashMap = new HashMap();
      localHashMap.put(BaseConstants.RDM_NoChangeFailCode, "");
      axrn.a(BaseApplication.getContext()).a(null, paramString, true, paramLong, 0L, localHashMap, "");
    }
  }
}
