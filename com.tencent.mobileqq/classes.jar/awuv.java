...
public class awuv
{
  private static final SparseArray<Class<? extends awum>> jdField_a_of_type_AndroidUtilSparseArray;
  private static HashMap<String, Class<? extends awul>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  
  static
  {
    jdField_a_of_type_JavaUtilHashMap.put("pavideo", awyz.class);
    jdField_a_of_type_JavaUtilHashMap.put("video", awzo.class);
    jdField_a_of_type_JavaUtilHashMap.put("picture", awwo.class);
    jdField_a_of_type_JavaUtilHashMap.put("title", StructMsgItemTitle.class);
    jdField_a_of_type_JavaUtilHashMap.put("summary", awzf.class);
    jdField_a_of_type_JavaUtilHashMap.put("timer", awzj.class);
    jdField_a_of_type_JavaUtilHashMap.put("hr", awwq.class);
    jdField_a_of_type_JavaUtilHashMap.put("image", awwr.class);
    jdField_a_of_type_JavaUtilHashMap.put("more", awyt.class);
    jdField_a_of_type_JavaUtilHashMap.put("progress", awzd.class);
    jdField_a_of_type_JavaUtilHashMap.put("checklist", awzx.class);
    jdField_a_of_type_JavaUtilHashMap.put("vote", awzz.class);
    jdField_a_of_type_JavaUtilHashMap.put("price", awzc.class);
    jdField_a_of_type_JavaUtilHashMap.put("button", awwi.class);
    jdField_a_of_type_JavaUtilHashMap.put("remark", awze.class);
    jdField_a_of_type_JavaUtilHashMap.put("paaudio", awyu.class);
    jdField_a_of_type_JavaUtilHashMap.put("textButton", awzh.class);
    jdField_a_of_type_JavaUtilHashMap.put("content", awwn.class);
    jdField_a_of_type_JavaUtilHashMap.put("tips", awwa.class);
    jdField_a_of_type_JavaUtilHashMap.put("live", awvu.class);
    jdField_a_of_type_JavaUtilHashMap.put("tr", awzm.class);
    jdField_a_of_type_JavaUtilHashMap.put("td", awzg.class);
    jdField_a_of_type_JavaUtilHashMap.put("head", awwh.class);
    jdField_a_of_type_JavaUtilHashMap.put("type", awzn.class);
    jdField_a_of_type_JavaUtilHashMap.put("tag", awvy.class);
    jdField_a_of_type_JavaUtilHashMap.put("taglist", awvz.class);
    jdField_a_of_type_JavaUtilHashMap.put("group", awvo.class);
    jdField_a_of_type_JavaUtilHashMap.put("groupitem", awvq.class);
    jdField_a_of_type_JavaUtilHashMap.put("voice", awwb.class);
    jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
    jdField_a_of_type_AndroidUtilSparseArray.append(0, awyk.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(1, awws.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(2, awxe.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(3, awxy.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(4, awyb.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(5, awyc.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(6, awye.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(7, awyg.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(8, awyi.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(9, awyj.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(10, awwt.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(11, awwv.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(12, awwx.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(18, awxb.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(19, awxd.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(20, awxf.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(21, awxi.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(22, awxj.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(23, awxk.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(24, awxm.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(25, awxp.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(26, awxq.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(27, awxr.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(28, awxs.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(29, awxv.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(30, awxz.class);
  }
  
  public static awul a(String paramString)
  {
    return a(paramString, 0);
  }
  
  /* Error */
  public static awul a(String paramString, int paramInt)
  {
    // Byte code:
    //   0: ldc 210
    //   2: aload_0
    ...
    //   6: ifne +72 -> 78
    //   9: getstatic 18	awuv:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   12: aload_0
    ...
    //   76: aload_3
    //   77: areturn
    //   78: getstatic 143	awuv:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   81: iload_1
  ...
  /* Error */
  public static awum a(int paramInt)
  {
    // Byte code:
    //   0: getstatic 143	awuv:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   3: iload_0
