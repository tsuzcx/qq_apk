...
public class bgnf
{
  ...
  public static bgng a(String paramString)
  {
    int i = 0;
    if (paramString == null) {}
    bgng localbgng;
    ...
    for (;;)
    {
      localbgng.a = paramString.getString("k=");
      localbgng.b = d(paramString.getString("u="));
      localObject = b(paramString.getString("n="));
      if (localObject != null)
      {
        localbgng.c = URLDecoder.decode((String)localObject, "UTF-8");
        if (localbgng.c != null) {}
      }
      for (localbgng.c = localbgng.b;; localbgng.c = localbgng.b)
      {
        localbgng.d = paramString.getString("o=");
        localbgng.e = paramString.getString("p=");
        localbgng.f = paramString.getString("d=");
        if ((localbgng.a == null) || (localbgng.b == null) || (localbgng.d == null)) {
          break;
        }
        return localbgng;
      }
