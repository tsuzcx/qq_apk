...
public class bgnf
{
  ...
  private static bgni jdField_a_of_type_Bgni = new bgni(Looper.getMainLooper(), null);
  ...
  private static BlockingQueue<WeakReference<bgnf>> jdField_a_of_type_JavaUtilConcurrentBlockingQueue = new LinkedBlockingQueue();
  ...
  public bgnf(Context paramContext)
  {
  ...
  public static bgnf a(Context paramContext, int paramInt1, CharSequence paramCharSequence, int paramInt2)
  {
    paramContext = new bgnf(paramContext);
  ...
  public static bgnf a(Context paramContext, CharSequence paramCharSequence, int paramInt)
  {
  ...
  public static boolean a(Context paramContext, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((jdField_a_of_type_Int == -1) || (paramBoolean))
      {
        ...
        QMLog.d("QQToast", "canUseCustomToast = " + jdField_a_of_type_Int);
  ...
  {
    return a(paramInt, 2131559361, null);
  }
  
  public Toast a(int paramInt1, int paramInt2, View.OnTouchListener paramOnTouchListener)
  {
    bgnh localbgnh = new bgnh(this.jdField_a_of_type_AndroidContentContext);
    ...
    if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
    {
      ...
      localbgnh.setGravity(55, 0, 0);
    }
    for (;;)
    {
      localbgnh.setView(localView);
      localbgnh.setDuration(this.jdField_c_of_type_Int);
      if (a()) {
        localView.setOnTouchListener(new bgng(this, localbgnh, paramOnTouchListener));
      }
      return localbgnh;
      ...
      if (paramInt1 == 6316128) {
        localbgnh.setGravity(55, 0, a());
      } else {
        localbgnh.setGravity(55, 0, b());
      }
    }
  }
  ...
  public void a()
  {
    ...
    jdField_a_of_type_Bgni.sendEmptyMessage(2);
  }
