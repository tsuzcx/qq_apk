  ...
  implements anac, auas
{
  ...
  public anad(Handler paramHandler, Context paramContext)
  {
  ...
  private boolean b(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramArrayOfByte = this.jdField_a_of_type_Amzy.a(paramArrayOfByte, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, 0);
      bool2 = amzy.a(paramArrayOfByte);
      ...
      bool1 = bool2;
    } while (this.jdField_a_of_type_Anae == null);
    this.jdField_a_of_type_Anae.a(bool2, paramArrayOfByte, paramBoolean);
    return bool2;
  }
  ...
  public int a()
  {
    ...
    this.jdField_a_of_type_Amzy.a(this);
    this.jdField_a_of_type_Amzy.a(this);
    this.jdField_a_of_type_Amzy.a(this.jdField_a_of_type_AndroidContentContext, hashCode(), "MiniRecog");
    this.jdField_c_of_type_Int = auan.a();
  ...
  {
    boolean bool1 = this.jdField_a_of_type_Amzy.c();
    ...
    catch (Throwable paramArrayOfByte)
    {
      ...
      try
      {
        ...
        bool1 = bool2;
        bool2 = this.jdField_a_of_type_Amzy.a(paramRect, this.jdField_a_of_type_Long);
        bool3 = bool2;
        if (!bool2)
        {
          bool1 = bool2;
  ...
  public Bitmap a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    while (amzy.a(this.jdField_a_of_type_ArrayOfInt, paramArrayOfByte, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int) != 0) {
      try
      {
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Amzy.c(this);
      this.jdField_a_of_type_Amzy.b(this);
      this.jdField_a_of_type_Amzy.a(hashCode(), "MiniRecog");
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    anak.d(this.jdField_c_of_type_Int, (int)l);
  }
  ...
  {
    this.jdField_a_of_type_Anae = ((anae)paramamzx);
  }
  ...
  public void a(List<amzu> paramList, long paramLong)
  {
    ...
    {
      if ((((amzu)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect.width() > 0) && (((amzu)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect.height() > 0))
      {
        Rect localRect = new Rect(((amzu)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect);
        ...
        localamzu.jdField_a_of_type_Int = ((amzu)paramList.get(i)).jdField_a_of_type_Int;
        localamzu.jdField_a_of_type_Float = ((amzu)paramList.get(i)).jdField_a_of_type_Float;
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Amzy.c()) && (this.jdField_c_of_type_Boolean) && (!this.jdField_b_of_type_Boolean);
  }
