  ...
  implements qqa
{
  ...
  private void a(ArticleInfo paramArticleInfo, int paramInt, String paramString1, String paramString2)
  {
    ...
    if (rnv.a().a(paramArticleInfo, false, rnv.jdField_a_of_type_Int)) {
      localHashMap.put("jump_src", Integer.valueOf(rnz.a(paramArticleInfo)));
    }
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (localObject1 = ((Context)localObject1).getResources().getString(2131717782);; localObject1 = "")
    {
      ...
      if (paramBaseArticleInfo.jdField_a_of_type_Boolean)
      {
        ...
        if (paramInt < paramBaseArticleInfo.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          rrv localrrv = (rrv)paramBaseArticleInfo.jdField_a_of_type_JavaUtilList.get(paramInt);
          ((JSONObject)localObject2).put("video_jump_url", localrrv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructUrlJumpInfo.jdField_a_of_type_JavaLangString);
          ((JSONObject)localObject2).put("video_cover_url", localrrv.c);
          ((JSONObject)localObject2).put("video_title_text", localrrv.jdField_b_of_type_JavaLangString);
          ((JSONObject)localObject2).put("rowkey", localrrv.jdField_a_of_type_JavaLangString);
          String str1 = bmhv.b(localrrv.jdField_a_of_type_Int);
          String str2 = bmhv.c(localrrv.jdField_b_of_type_Int);
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (localrrv.jdField_a_of_type_Int > 0)) {
      ...
      else
      {
        ...
        while (paramInt < paramBaseArticleInfo.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          localObject2 = (rrv)paramBaseArticleInfo.jdField_a_of_type_JavaUtilList.get(paramInt);
          ((JSONObject)localObject1).put("video_jump_url", ((rrv)localObject2).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructUrlJumpInfo.jdField_a_of_type_JavaLangString);
          ((JSONObject)localObject1).put("video_cover_url", ((rrv)localObject2).c);
          ((JSONObject)localObject1).put("video_title_text", ((rrv)localObject2).jdField_b_of_type_JavaLangString);
          ((JSONObject)localObject1).put("rowkey", ((rrv)localObject2).jdField_a_of_type_JavaLangString);
          ((JSONObject)localObject1).put("video_duration_text", bmhv.c(((rrv)localObject2).jdField_b_of_type_Int));
  ...
  public void a(int paramInt1, Container paramContainer, qfw paramqfw, int paramInt2)
  {
    ...
    {
      localObject = String.format(paramContainer.getContext().getResources().getString(2131717783), new Object[] { localObject });
      ...
      localObject = (qwn)localViewBase.findViewBaseByName("id_column_list");
      ((qwn)localObject).a(paramqfw);
      ((qwn)localObject).a(new qok(this, localArticleInfo, paramContainer));
      ((qwn)localObject).a(new qol(this, localArticleInfo, paramContainer));
      return;
    }
  }
  ...
  public boolean a(int paramInt, Container paramContainer, qfw paramqfw, ViewBase paramViewBase)
  {
    ...
    do
    {
      ...
      {
        paramViewBase.setOnClickListener(new qom(this, paramqfw, paramContainer));
        return true;
      }
    } while (!"multi_video_column_tail_click".equals(str));
    paramViewBase.setOnClickListener(new qon(this, paramqfw, paramContainer));
    return true;
  }
}
