...
public class ahcu
{
  ...
  public static ResourceInfo a(String paramString, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    String str = ahbt.a(paramString, paramInt2);
  ...
  public static List<ahcv> a(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if (str.startsWith("url_last_use_time")) {
          localArrayList.add(new ahcv(str.substring("url_last_use_time".length(), str.length()), ((Long)localEntry.getValue()).longValue(), paramInt));
        }
      }
    }
  ...
  public static void a(int paramInt, PreloadConfig paramPreloadConfig)
  {
    ...
    return;
    Object localObject = ahbt.a(paramInt);
    long l2 = System.currentTimeMillis();
    long l3 = bbdx.b((String)localObject);
    ...
    if (l3 > 209715200L)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ahcv localahcv = (ahcv)((Iterator)localObject).next();
        if ((localahcv != null) && (!TextUtils.isEmpty(localahcv.jdField_a_of_type_JavaLangString)) && (l1 - localahcv.jdField_a_of_type_Long > 2592000000L) && (!paramPreloadConfig.isUrlInConfig(localahcv.jdField_a_of_type_JavaLangString)))
        {
          ResourceInfo localResourceInfo = a(localahcv.jdField_a_of_type_JavaLangString, false, 0, localahcv.jdField_a_of_type_Int);
          if (localResourceInfo != null)
          {
            b(localahcv.jdField_a_of_type_JavaLangString, localahcv.jdField_a_of_type_Int);
            ahiw.a(localResourceInfo.filePath);
            ahiw.a(localResourceInfo.folderPath);
            ahct.a(localahcv.jdField_a_of_type_JavaLangString, 8, localahcv.jdField_a_of_type_Int);
          }
        }
      }
    }
