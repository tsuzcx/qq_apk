  ...
  implements Handler.Callback
{
  ...
  public balo a;
  private bavn jdField_a_of_type_Bavn;
  SessionInfo jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
  public CameraCaptureView a;
  private ArrayList<bavn> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public bavo(CameraCaptureView paramCameraCaptureView, long paramLong)
  {
    super(paramLong);
  ...
  private void c()
  {
    try
    {
      if ((this.jdField_a_of_type_Boolean) && (this.jdField_c_of_type_JavaLangString != null) && (this.jdField_f_of_type_Boolean) && (!this.jdField_c_of_type_Boolean))
      {
        ...
        this.jdField_a_of_type_Balo.a(201, -1, localBundle);
  ...
  public void a()
  {
    ...
    try
    {
      ...
      Bundle localBundle = a();
      this.jdField_a_of_type_Balo.a(208, -1, localBundle);
      if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_e_of_type_JavaLangString != null)
    {
      ...
      localbckv = new bckv();
      localbckv.jdField_a_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
      localbckv.jdField_b_of_type_JavaLangString = c();
      localbckv.jdField_a_of_type_Int = 0;
      localbckv.d = paramInt;
      localbckv.c = bcjb.n;
      if (bcjb.p != 2) {
        break label178;
      }
      localbckv.jdField_b_of_type_Int = 16;
      if (bcjb.o != 16) {
        break label188;
      }
      localbckv.e = 1;
    ...
    for (;;)
    {
      ...
      return;
      label178:
      localbckv.jdField_b_of_type_Int = 8;
      break;
      label188:
      localbckv.e = 2;
      break label101;
      label197:
      paramInt = AudioEncoder.a(localbckv);
      if (paramInt == 0) {
        break label256;
      }
      this.jdField_a_of_type_JavaUtilHashMap.put("param_audio_error", String.valueOf(paramInt));
  ...
  public void a(int paramInt, long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_Balo.a(207, -1, localBundle);
    avsp.c();
    if (QLog.isColorLevel()) {
  ...
  public void a(bavn parambavn, boolean paramBoolean, MediaFormat paramMediaFormat)
  {
    int i = parambavn.a();
    long l = parambavn.a();
    String str = parambavn.a();
    if (QLog.isColorLevel()) {
      QLog.d("SegmentManager", 2, "onEncodeVideoSegment:" + parambavn);
    }
    int j = paramMediaFormat.getInteger("width");
    int k = paramMediaFormat.getInteger("height");
    parambavn = a();
    parambavn.putString("video_slice_path", str);
    parambavn.putInt("video_slice_index", i);
    parambavn.putInt("video_slice_width", j);
    parambavn.putInt("video_slice_height", k);
    parambavn.putLong("video_slice_timestamp", l);
    this.jdField_a_of_type_Balo.a(200, -1, parambavn);
    if (i == 0) {
    ...
    if (paramBoolean)
    {
      ...
      parambavn = a();
      this.jdField_a_of_type_Balo.a(204, -1, parambavn);
      c();
    }
  }
  ...
  public void b()
  {
    ...
    Bundle localBundle = a();
    this.jdField_a_of_type_Balo.a(206, -1, localBundle);
    a();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    try
    {
      ...
      case 1: 
        ...
        this.jdField_a_of_type_Bavn = new bavn(d(), i);
        this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Bavn);
        if (QLog.isColorLevel()) {
          QLog.d("SegmentManager", 2, "Muxer_Start :" + this.jdField_a_of_type_Bavn);
        }
        this.jdField_a_of_type_AndroidMediaMediaMuxer = new MediaMuxer(this.jdField_a_of_type_Bavn.a(), 0);
    ...
    paramMessage = (batm)paramMessage.obj;
    ...
    for (;;)
    {
      ...
      if (a(l, bool))
      {
        ...
        this.jdField_b_of_type_Long = 0L;
        this.jdField_a_of_type_AndroidMediaMediaMuxer.release();
        a(this.jdField_a_of_type_Bavn, false, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a());
        i = this.jdField_a_of_type_JavaUtilArrayList.size();
        this.jdField_a_of_type_Bavn = new bavn(d(), i);
        this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Bavn);
        this.jdField_a_of_type_AndroidMediaMediaMuxer = new MediaMuxer(this.jdField_a_of_type_Bavn.a(), 0);
      ...
      this.jdField_a_of_type_Bavn.a(paramMessage);
      ...
      return true;
      if (QLog.isColorLevel()) {
        QLog.d("SegmentManager", 2, "Muxer_Stop :" + this.jdField_a_of_type_Bavn);
      }
      this.jdField_a_of_type_AndroidMediaMediaMuxer.release();
      a(this.jdField_a_of_type_Bavn, true, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a());
      return true;
      return true;
      boolean bool = true;
      continue;
