...
public class aaib
  extends akav
{
  public aaib(AddRequestActivity paramAddRequestActivity) {}
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    try
    {
      ...
      if (!paramBoolean) {
        if (!TextUtils.isEmpty(paramString3))
        {
          ...
          if (aydc.a(localStructMsg, paramInt3, paramString2, paramString4)) {
            this.a.finish();
          }
          AddRequestActivity.a(this.a, false);
          return;
    ...
    catch (Exception paramString1)
    {
      for (;;)
      {
        ...
        l1 = l2;
        continue;
        paramString3 = this.a.getResources().getString(2131719251);
      }
    ...
    this.a.setResult(-1);
    this.a.finish();
    paramString1 = this.a.getResources().getString(2131692793);
    label257:
    do
    {
      do
      {
        bcpw.a(this.a, 2, paramString1, 0).b(this.a.getTitleBarHeight());
        break;
        paramString1 = paramString2;
      } while (paramInt1 != 0);
      paramString1 = paramString2;
    } while (localStructMsg == null);
    paramString2 = this.a.getResources().getString(2131692781);
