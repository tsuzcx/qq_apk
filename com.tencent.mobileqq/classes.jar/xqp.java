  ...
  extends BaseAdapter
{
  ...
  public xqp(List<QQStoryUserInfo> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(this.jdField_a_of_type_ComTencentBizQqstorySettingsQQStoryShieldListActivity).inflate(2131561793, null);
      paramView = new xqq(this);
      ...
      paramView.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131365495));
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (xqq)paramView.getTag();
      localView = paramView;
      ...
      break label186;
      label349:
      paramView.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(bheg.a());
    }
  }
}
