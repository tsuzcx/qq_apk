...
public class rcq
  extends rbp
{
  public rcq(Context paramContext, FaceDecoder paramFaceDecoder, szd paramszd)
  {
  ...
  public rbp d()
  {
    ...
    if ((this.jdField_a_of_type_Rbo != null) && ((this.jdField_a_of_type_Rbo instanceof ComponentContentGallery))) {
      localLinearLayout.addView((ComponentContentGallery)this.jdField_a_of_type_Rbo);
    }
  ...
  public rbp g()
  {
    this.jdField_a_of_type_Rbo = new ComponentContentGallery(this.jdField_a_of_type_AndroidContentContext);
    return this;
  }
  ...
  public rbp o()
  {
    ...
    if ((this.jdField_a_of_type_Rbo != null) && ((this.jdField_a_of_type_Rbo instanceof ComponentContentGallery)))
    {
      ((ComponentContentGallery)this.jdField_a_of_type_Rbo).setAdapter(this.jdField_a_of_type_Szd);
      ((ComponentContentGallery)this.jdField_a_of_type_Rbo).setPosition(this.jdField_a_of_type_Int);
    }
    return this;
  }
}
