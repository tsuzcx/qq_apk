  ...
  implements Manager
{
  ...
  private ahnv jdField_a_of_type_Ahnv;
  ...
  private final ahnv jdField_b_of_type_Ahnv = new ahnt(this);
  private File jdField_b_of_type_JavaIoFile;
  private List<ahmx> jdField_b_of_type_JavaUtilList;
  private boolean jdField_b_of_type_Boolean = true;
  private File c;
  private File d;
  
  public ahns(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilList = new CopyOnWriteArrayList();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_a_of_type_Avsq = ((avsq)paramQQAppInterface.getManager(14));
    a(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
    d();
    if (this.jdField_b_of_type_JavaUtilList != null) {
      this.jdField_b_of_type_JavaUtilList.clear();
    }
    a(new ahnr(paramQQAppInterface));
    this.jdField_a_of_type_Ahni = new ahni(paramQQAppInterface);
    a(this.jdField_a_of_type_Ahni);
    this.jdField_a_of_type_Ahnp = new ahnp(paramQQAppInterface);
    a(this.jdField_a_of_type_Ahnp);
    a(new ahoj(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
  }
  ...
  public static ahns a(QQAppInterface paramQQAppInterface)
  {
    return (ahns)paramQQAppInterface.getManager(314);
  }
  ...
  public static File a(String paramString)
  {
    try
    {
      ...
      paramString = new File(ahnl.jdField_a_of_type_JavaLangString + paramString);
      return paramString;
    }
  ...
  private Object a(String paramString)
  {
    ...
    //   1: astore 6
    //   3: aload_1
    //   4: invokestatic 309	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   7: ifeq +8 -> 15
    //   10: aload 6
    //   12: astore_3
    //   13: aload_3
    //   14: areturn
    //   15: new 311	java/io/ObjectInputStream
    //   18: dup
    //   19: new 313	java/io/BufferedInputStream
    //   22: dup
    //   23: new 315	java/io/FileInputStream
    //   26: dup
    //   27: aload_1
    //   28: invokespecial 316	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   31: invokespecial 319	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   34: invokespecial 320	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   37: astore 4
    //   39: aload 4
    //   41: astore_3
    //   42: aload 4
    //   44: invokevirtual 323	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   47: astore 5
    //   49: aload 5
    //   51: astore_1
    //   52: aload_1
    ...
    //   56: ifnull -43 -> 13
    //   59: aload 4
    //   61: invokevirtual 326	java/io/ObjectInputStream:close	()V
    //   64: aload_1
    //   65: areturn
    //   66: astore_3
    //   67: aload_1
    ...
    //   74: aload 4
    //   76: astore_3
    //   77: invokestatic 331	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   80: ifeq +47 -> 127
    //   83: aload 4
    //   85: astore_3
    //   86: ldc_w 333
    ...
    //   113: aload 5
    //   115: invokevirtual 338	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   124: invokestatic 342	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   127: aload 4
    //   129: astore_3
    //   130: aload 5
    //   132: instanceof 344
    ...
    //   138: ifnull +8 -> 146
    //   141: aload 4
    //   143: invokevirtual 326	java/io/ObjectInputStream:close	()V
    //   146: aload 6
    //   148: astore_3
    //   149: iload_2
    //   150: ifeq -137 -> 13
    //   153: aload_1
    //   154: invokestatic 350	com/tencent/mobileqq/utils/FileUtils:deleteFile	(Ljava/lang/String;)Z
    //   157: pop
    //   158: aconst_null
    //   159: areturn
    //   160: astore_1
    ...
    //   164: aload 4
    //   166: astore_3
    //   167: invokestatic 331	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   170: ifeq +16 -> 186
    //   173: aload 4
    //   175: astore_3
    //   176: ldc_w 333
    //   179: iconst_2
    //   180: ldc_w 352
    //   183: invokestatic 342	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   186: aload 6
    //   188: astore_3
    //   189: aload 4
    //   191: ifnull -178 -> 13
    //   194: aload 4
    //   196: invokevirtual 326	java/io/ObjectInputStream:close	()V
    //   199: aconst_null
    //   200: areturn
    //   201: astore_1
    //   202: aconst_null
    ...
    //   208: ifnull +7 -> 215
    //   211: aload_3
    //   212: invokevirtual 326	java/io/ObjectInputStream:close	()V
    //   215: aload_1
    //   216: athrow
    //   217: astore_3
    //   218: goto -72 -> 146
  ...
  private List<ahmw> a(List<ahmw> paramList, StickerRecommendSortEntity paramStickerRecommendSortEntity)
  {
    int i2 = 0;
    int j;
    int m;
    ...
    if (paramStickerRecommendSortEntity != null)
    {
      try
      {
        ...
        arrayOfahmw[i] = ((ahmw)paramList.get(i1));
        i += 1;
      }
      ...
      if (n < m)
      {
        ...
        arrayOfahmw[i] = ((ahmw)paramList.get(j));
        i += 1;
        break label464;
      }
    }
    for (;;)
    {
      if (i1 < k)
      {
        ...
        if ((i < i3) && (j < i3))
        {
          arrayOfahmw[j] = ((ahmw)paramList.get(i));
          i = j + 1;
          break label473;
        }
      }
      ...
      {
        paramList = Arrays.asList(arrayOfahmw);
        return paramList;
        return null;
      }
      i = j;
  ...
  private void a(String paramString, Object paramObject)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokestatic 309	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   4: ifeq +4 -> 8
    //   7: return
    //   8: new 478	java/io/ObjectOutputStream
    //   11: dup
    //   12: new 480	java/io/BufferedOutputStream
    //   15: dup
    //   16: new 482	java/io/FileOutputStream
    //   19: dup
    //   20: aload_1
    //   21: invokespecial 483	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   24: invokespecial 486	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   27: invokespecial 487	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   30: astore 4
    //   32: aload 4
    //   34: astore_3
    //   35: aload 4
    //   37: aload_2
    //   38: invokevirtual 491	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   41: aload 4
    //   43: astore_3
    //   44: aload 4
    //   46: invokevirtual 494	java/io/ObjectOutputStream:flush	()V
    //   49: aload 4
    //   51: ifnull -44 -> 7
    //   54: aload 4
    //   56: invokevirtual 495	java/io/ObjectOutputStream:close	()V
    //   59: return
    //   60: astore_1
    //   61: aload_1
    //   62: invokevirtual 496	java/io/IOException:printStackTrace	()V
    //   65: return
    //   66: astore 5
    //   68: aconst_null
    //   69: astore_2
    //   70: aload_2
    //   71: astore_3
    //   72: invokestatic 331	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   75: ifeq +46 -> 121
    //   78: aload_2
    //   79: astore_3
    //   80: ldc_w 333
    ...
    //   104: invokevirtual 152	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   107: aload 5
    //   109: invokevirtual 338	java/lang/Exception:toString	()Ljava/lang/String;
    //   112: invokevirtual 152	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   115: invokevirtual 155	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   118: invokestatic 342	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   121: aload_2
    //   122: ifnull -115 -> 7
    //   125: aload_2
    //   126: invokevirtual 495	java/io/ObjectOutputStream:close	()V
    //   129: return
    //   130: astore_1
    //   131: aload_1
    //   132: invokevirtual 496	java/io/IOException:printStackTrace	()V
    //   135: return
    //   136: astore_1
    //   137: aconst_null
    //   138: astore_3
    ...
    //   140: ifnull +7 -> 147
    //   143: aload_3
    //   144: invokevirtual 495	java/io/ObjectOutputStream:close	()V
    //   147: aload_1
    //   148: athrow
    //   149: astore_2
    //   150: aload_2
    //   151: invokevirtual 496	java/io/IOException:printStackTrace	()V
    //   154: goto -7 -> 147
    //   157: astore_1
    //   158: goto -19 -> 139
    //   161: astore 5
  ...
  private void a(String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    for (boolean bool = true;; bool = false) {
      for (;;)
      {
        ...
        ((HttpNetReq)localObject).mCallback = new ahnu(this, paramString2, bool, paramString3);
        ...
        try
        {
          ...
          ((QQAppInterface)paramString2).getNetEngine(0).sendReq((NetReq)localObject);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void a(boolean paramBoolean, String paramString, SessionInfo paramSessionInfo)
  {
    ...
    if ((paramBoolean) && (this.jdField_b_of_type_JavaUtilList != null))
    {
      ...
      {
        Object localObject = (ahmx)localIterator.next();
        if (((ahmx)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString))
        {
          localObject = ((ahmx)localObject).a(paramString, paramSessionInfo);
          if ((localObject != null) && (!((List)localObject).isEmpty())) {
            localArrayList.addAll((Collection)localObject);
          }
        }
      }
      paramString = ahmy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList);
      ...
      {
        ((ahmw)this.jdField_a_of_type_JavaUtilList.get(i)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i);
        i += 1;
      }
      if (QLog.isColorLevel()) {
  ...
  private void a(byte[] paramArrayOfByte)
  {
    try
    {
      ...
      else
      {
        ...
        localObject = bfyz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "words_version_key805_gray_one", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("StickerRecManager", 2, bjna.a(paramArrayOfByte));
        return;
        if (QLog.isColorLevel()) {
  ...
  private void a(byte[] paramArrayOfByte, String paramString1, String paramString2, boolean paramBoolean, StickerRecommendSortEntity paramStickerRecommendSortEntity, int paramInt)
  {
    ...
    try
    {
      ...
      localObject = new PicSearchSvr.RspBody();
      ...
      if (((PicSearchSvr.RspBody)localObject).int32_result.get() != 0)
      {
        ...
        QLog.d("StickerRecManager", 2, "handleResponse response code error,result:" + ((PicSearchSvr.RspBody)localObject).int32_result.get() + " message : " + ((PicSearchSvr.RspBody)localObject).bytes_fail_msg.get());
        return;
      }
      localList = ((PicSearchSvr.RspBody)localObject).rpt_msg_img_info.get();
    ...
    if (((PicSearchSvr.RspBody)localObject).bytes_rsp_other.has())
    {
      paramArrayOfByte = ((PicSearchSvr.RspBody)localObject).bytes_rsp_other.get().toStringUtf8();
      ...
      while (i < localList.size())
      {
        ...
        localahnm.f(i);
        localahnm.c(localImgInfo.uint64_img_size.get());
        localahnm.a(localImgInfo.uint32_img_width.get());
        localahnm.b(localImgInfo.uint32_img_height.get());
        localahnm.d(localImgInfo.bytes_img_md5.get().toStringUtf8());
        localahnm.b(localImgInfo.bytes_img_down_url.get().toStringUtf8());
        localahnm.d(localImgInfo.uint64_thumb_size.get());
        localahnm.d(localImgInfo.uint32_thumb_img_height.get());
        localahnm.c(localImgInfo.uint32_thumb_img_width.get());
        localahnm.c(localImgInfo.bytes_thumb_down_url.get().toStringUtf8());
        localahnm.e(localImgInfo.bytes_thumb_img_md5.get().toStringUtf8());
        localahnm.g(localImgInfo.uint32_src_type.get());
        localahnm.f(localImgInfo.bytes_src_desc.get().toStringUtf8());
        localahnm.g(localImgInfo.bytes_web_url.get().toStringUtf8());
        localahnm.h("");
        localahnm.i(localImgInfo.bytes_pack_name.get().toStringUtf8());
        localahnm.h(localImgInfo.uint32_pack_id.get());
        if (localImgInfo.bytes_img_other.has()) {
          localahnm.j(localImgInfo.bytes_img_other.get().toStringUtf8());
        }
        localahnm.k(paramArrayOfByte);
        localahnm.e(paramInt);
        localArrayList.add(localahnm);
        i += 1;
      }
    ...
    label784:
    label785:
    for (paramString2 = ((PicSearchSvr.RspBody)localObject).bytes_rsp_other.get().toStringUtf8();; paramString2 = "999")
    {
      if (paramBoolean)
      {
        this.jdField_b_of_type_Ahnv.a(paramArrayOfByte, paramString1, paramString2, 0, null);
        return;
      }
      if (this.jdField_a_of_type_Ahnv != null)
      {
        localArrayList = null;
        ...
        if (paramInt == 1)
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
          {
            ...
            paramStickerRecommendSortEntity = localArrayList;
            if (localObject != null) {
              paramStickerRecommendSortEntity = ((ahom)localObject).b();
            }
          }
        }
        this.jdField_a_of_type_Ahnv.a(paramArrayOfByte, paramString1, paramString2, paramInt, paramStickerRecommendSortEntity);
        return;
        break label651;
  ...
  public static boolean a(ahmw paramahmw)
  {
    return paramahmw.a();
  }
  ...
  private boolean a(File paramFile1, File paramFile2)
  {
    ...
    try
    {
      ...
      npo.a(paramFile1, localFile.getAbsolutePath() + File.separator);
  ...
  public static boolean b(ahmw paramahmw)
  {
    return !a(paramahmw);
  }
  ...
  public static String d(String paramString)
  {
    ...
    {
      paramString = Utils.Crc64String(paramString);
      paramString = ahnl.jdField_a_of_type_JavaLangString + paramString;
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  {
    Object localObject = new File(ahnl.jdField_a_of_type_JavaLangString);
  ...
  public void a()
  {
    ...
    try
    {
      ...
      try
      {
        if (FileUtils.fileExists(this.c.getAbsolutePath())) {
          break label119;
        }
    ...
    if (QLog.isColorLevel())
    {
      QLog.d("StickerRecManager", 2, bjna.a(localException1));
    ...
    l2 = bfyz.o(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
    if ((!FileUtils.fileExists(this.jdField_b_of_type_JavaIoFile.getAbsolutePath())) || ((l2 != 0L) && (System.currentTimeMillis() - l2 >= 86400000L)))
    {
      bfyz.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), 0L);
      localObject1 = new HashSet();
      localObject2 = this.jdField_a_of_type_Avsq.b();
      localList = this.jdField_a_of_type_Avsq.jdField_a_of_type_JavaUtilList;
      ...
      {
        FileUtil.deleteFile(this.jdField_b_of_type_JavaIoFile.getAbsolutePath());
    ...
    for (;;)
    {
      ...
      if (localObject1 != null) {
        this.jdField_a_of_type_ComTencentMobileqqDataCard = ((amsw)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      }
  ...
  public void a(ahmx paramahmx)
  {
    ...
    } while (this.jdField_b_of_type_JavaUtilList.contains(paramahmx));
    this.jdField_b_of_type_JavaUtilList.add(paramahmx);
  }
  
  public void a(ahnv paramahnv)
  {
    this.jdField_a_of_type_Ahnv = paramahnv;
  }
  ...
  protected void a(Context paramContext, String paramString)
  {
    try
    {
      this.jdField_b_of_type_Boolean = bfyz.B(paramContext, paramString);
      return;
    }
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        QLog.d("StickerRecManager", 2, bjna.a(paramIntent));
        continue;
      }
      finally {}
      label123:
      ...
      {
        ((azwy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285)).a(paramFromServiceMsg);
      }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 65	ahns:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: astore 5
    //   8: aload 5
    //   10: ifnonnull +6 -> 16
    //   13: aload_0
    //   14: monitorexit
    //   15: return
    //   16: new 1241	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody
    //   19: dup
    //   20: invokespecial 1242	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:<init>	()V
    //   23: astore 5
    //   25: aload 5
    //   27: iconst_1
    //   28: invokevirtual 1243	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:setHasFlag	(Z)V
    ...
    //   42: invokestatic 1246	android/os/SystemClock:uptimeMillis	()J
    //   45: invokevirtual 601	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   48: invokevirtual 155	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   51: astore 6
    //   53: invokestatic 1250	com/tencent/common/config/AppSetting:a	()I
    //   56: invokestatic 1252	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   59: astore 7
    //   61: aload_0
    //   62: getfield 65	ahns:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   65: invokevirtual 91	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   68: invokestatic 1257	aqmy:a	(Landroid/content/Context;)Ljava/lang/String;
    //   71: astore 8
    //   73: invokestatic 331	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   76: ifeq +83 -> 159
    //   79: ldc_w 333
    //   82: iconst_2
    ...
    //   117: iload_2
    //   118: invokevirtual 390	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   121: ldc_w 1265
    ...
    //   149: iload_3
    //   150: invokevirtual 390	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   153: invokevirtual 155	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   156: invokestatic 503	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   159: aload 5
    //   161: getfield 1270	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:bytes_session_id	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   164: aload 6
    //   166: invokestatic 194	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   169: invokevirtual 200	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   172: aload 5
    //   174: getfield 1271	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:uint64_src_uin	Lcom/tencent/mobileqq/pb/PBUInt64Field;
    //   177: aload_1
    //   178: invokestatic 210	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   181: invokevirtual 215	com/tencent/mobileqq/pb/PBUInt64Field:set	(J)V
    //   184: aload 5
    //   186: getfield 1272	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:uint32_src_term	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   189: iload_2
    //   190: invokevirtual 224	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   193: aload 5
    //   195: getfield 1275	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:bytes_appid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   198: aload 7
    //   200: invokestatic 194	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   203: invokevirtual 200	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   206: aload 5
    //   208: getfield 1278	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:bytes_version	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   211: aload 8
    //   213: invokestatic 194	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   216: invokevirtual 200	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   219: aload 5
    //   221: getfield 1281	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:uin32_gender	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   224: iload_3
    //   225: invokevirtual 224	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   228: aload 5
    //   230: getfield 1282	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:uint32_age	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   233: iload 4
    //   235: invokevirtual 224	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   238: aload 5
    //   240: invokevirtual 1285	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:toByteArray	()[B
    //   243: astore_1
    //   244: aload_1
    //   245: arraylength
    //   246: iconst_4
    //   247: iadd
    //   248: invokestatic 1291	java/nio/ByteBuffer:allocate	(I)Ljava/nio/ByteBuffer;
    //   251: astore 5
    //   253: aload 5
    //   255: aload_1
    //   256: arraylength
    //   257: iconst_4
    //   258: iadd
    //   259: invokevirtual 1293	java/nio/ByteBuffer:putInt	(I)Ljava/nio/ByteBuffer;
    //   262: aload_1
    //   263: invokevirtual 1296	java/nio/ByteBuffer:put	([B)Ljava/nio/ByteBuffer;
    //   266: pop
    //   267: aload 5
    //   269: invokevirtual 1299	java/nio/ByteBuffer:array	()[B
    //   272: astore_1
    //   273: new 1301	mqq/app/NewIntent
    //   276: dup
    //   277: aload_0
    //   278: getfield 65	ahns:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   281: invokevirtual 91	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   284: ldc_w 1303
    //   287: invokespecial 1306	mqq/app/NewIntent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   290: astore 5
    //   292: aload 5
    //   294: ldc_w 1308
    //   297: aload_1
    //   298: invokevirtual 1312	mqq/app/NewIntent:putExtra	(Ljava/lang/String;[B)Landroid/content/Intent;
    //   301: pop
    //   302: aload 5
    //   304: ldc_w 1314
    //   307: ldc_w 1214
    //   310: invokevirtual 1317	mqq/app/NewIntent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   313: pop
    //   314: aload_0
    //   315: getfield 65	ahns:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   318: aload 5
    //   320: invokevirtual 1321	com/tencent/mobileqq/app/QQAppInterface:startServlet	(Lmqq/app/NewIntent;)V
    //   323: goto -310 -> 13
    //   326: astore_1
    //   327: aload_0
    //   328: monitorexit
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, ahom paramahom)
  {
    if (paramahom != null) {}
    for (;;)
    {
      try
      {
        String str = paramahom.a();
        if (str == null) {
          return;
        }
        str = paramString1 + SystemClock.uptimeMillis();
        Object localObject1 = a(str, paramString1, paramInt1, paramInt2, paramString2, paramahom.a()).toByteArray();
        ...
        localObject1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ahnz.class);
        ((NewIntent)localObject1).putExtra("key_body", (byte[])localObject2);
        ((NewIntent)localObject1).putExtra("key_cmd", "SceneFaceRec.PullFaces");
        paramahom = paramahom.a();
        ((NewIntent)localObject1).putExtra("REQUEST_SCENES_ID", paramahom);
        ((NewIntent)localObject1).putExtra("USER_KEYWORD", paramahom);
        boolean bool;
        if (paramInt1 == 4)
        {
          bool = true;
          ...
          if (QLog.isColorLevel()) {
            QLog.d("StickerRecManager", 2, "send pull pics args:sessionId = " + str + " uin=" + paramString1 + " termType=" + paramInt1 + " aioType : " + paramInt2 + " toUin : " + paramString2 + "  scenesID: " + paramahom);
          }
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, List<String> paramList)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: new 145	java/lang/StringBuilder
    //   5: dup
    //   6: invokespecial 146	java/lang/StringBuilder:<init>	()V
    //   9: aload_1
    //   10: invokevirtual 152	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   13: invokestatic 1246	android/os/SystemClock:uptimeMillis	()J
    //   16: invokevirtual 601	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   19: invokevirtual 155	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   22: astore 7
    //   24: aload_0
    //   25: aload 7
    //   27: aload_1
    ...
    //   30: aload 4
    //   32: aload 5
    //   34: invokespecial 1327	ahns:a	(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/util/List;)Lcom/tencent/pb/emosm/PicSearchSvr$ReqBody;
    //   37: invokevirtual 1328	com/tencent/pb/emosm/PicSearchSvr$ReqBody:toByteArray	()[B
    //   40: astore 8
    //   42: aload 8
    //   44: arraylength
    //   45: iconst_4
    //   46: iadd
    //   47: invokestatic 1291	java/nio/ByteBuffer:allocate	(I)Ljava/nio/ByteBuffer;
    //   50: astore 9
    //   52: aload 9
    //   54: aload 8
    //   56: arraylength
    //   57: iconst_4
    //   58: iadd
    //   59: invokevirtual 1293	java/nio/ByteBuffer:putInt	(I)Ljava/nio/ByteBuffer;
    //   62: aload 8
    //   64: invokevirtual 1296	java/nio/ByteBuffer:put	([B)Ljava/nio/ByteBuffer;
    //   67: pop
    //   68: aload 9
    //   70: invokevirtual 1299	java/nio/ByteBuffer:array	()[B
    //   73: astore 9
    //   75: new 1301	mqq/app/NewIntent
    //   78: dup
    //   79: aload_0
    //   80: getfield 65	ahns:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   83: invokevirtual 91	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   86: ldc_w 1303
    //   89: invokespecial 1306	mqq/app/NewIntent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   92: astore 8
    //   94: aload 8
    //   96: ldc_w 1308
    //   99: aload 9
    //   101: invokevirtual 1312	mqq/app/NewIntent:putExtra	(Ljava/lang/String;[B)Landroid/content/Intent;
    //   104: pop
    //   105: aload 8
    //   107: ldc_w 1314
    //   110: ldc_w 1218
    //   113: invokevirtual 1317	mqq/app/NewIntent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   116: pop
    //   117: aload 5
    //   119: iconst_0
    //   120: invokeinterface 398 2 0
    //   125: checkcast 249	java/lang/String
    //   128: astore 5
    //   130: aload 8
    //   132: ldc_w 1207
    //   135: aload 5
    //   137: invokevirtual 1317	mqq/app/NewIntent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   140: pop
    //   141: iload_2
    //   142: iconst_4
    ...
    //   151: ldc_w 1222
    //   154: iload 6
    //   156: invokevirtual 1333	mqq/app/NewIntent:putExtra	(Ljava/lang/String;Z)Landroid/content/Intent;
    //   159: pop
    //   160: invokestatic 331	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   163: ifeq +86 -> 249
    //   166: ldc_w 333
    //   169: iconst_2
    //   170: new 145	java/lang/StringBuilder
    //   173: dup
    ...
    //   194: aload_1
    //   195: invokevirtual 152	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   198: ldc_w 1263
    //   201: invokevirtual 152	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   204: iload_2
    //   205: invokevirtual 390	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   208: ldc_w 1337
    //   211: invokevirtual 152	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   214: iload_3
    //   215: invokevirtual 390	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   218: ldc_w 1339
    //   221: invokevirtual 152	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   224: aload 4
    ...
    //   235: aload 5
    //   237: invokestatic 1346	ahns:c	(Ljava/lang/String;)Ljava/lang/String;
    //   240: invokevirtual 152	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   243: invokevirtual 155	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   246: invokestatic 503	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   249: aload_0
    //   250: getfield 65	ahns:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   253: aload 8
    //   255: invokevirtual 1321	com/tencent/mobileqq/app/QQAppInterface:startServlet	(Lmqq/app/NewIntent;)V
    //   258: aload_0
    //   259: monitorexit
    //   260: return
    //   261: iconst_0
  ...
  public void a(String paramString, boolean paramBoolean, SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_a_of_type_Ahnv != null) && (!this.jdField_a_of_type_JavaUtilList.isEmpty())) {
      this.jdField_a_of_type_Ahnv.a(this.jdField_a_of_type_JavaUtilList, paramString, "999", 0, null);
    }
  }
  ...
  public void a(List<ahoa> paramList, boolean paramBoolean, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject4 = (ahoa)localIterator1.next();
        if (localObject4 != null)
        {
          str = ((ahoa)localObject4).jdField_a_of_type_JavaLangString;
          localObject2 = ((ahoa)localObject4).jdField_a_of_type_JavaUtilList;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          localObject3 = (ahmw)localIterator2.next();
          ((ahmw)localObject3).b(System.currentTimeMillis());
          if (((ahmw)localObject3).c() != null)
          {
            localObject2 = ((ahmw)localObject3).d();
            if (!android.text.TextUtils.isEmpty((CharSequence)localObject2)) {
              ((StringBuilder)localObject6).append((String)localObject2);
            }
            ((StringBuilder)localObject6).append(((ahmw)localObject3).c());
            ((StringBuilder)localObject6).append(";");
            if (((ahmw)localObject3).a() != null)
            {
              ((StringBuilder)localObject5).append(((ahmw)localObject3).a());
              ((StringBuilder)localObject5).append(";");
            }
            localObject2 = localObject1;
            if (((ahmw)localObject3).b()) {
              localObject2 = localObject3;
            }
            localObject1 = localObject2;
            if (((ahmw)localObject3).a() != 0L)
            {
              ahnw.a(true, str, paramInt, paramString, (ahmw)localObject3);
              localObject1 = localObject2;
              continue;
              if (paramInt == 1)
              {
      ...
      if (((ahoa)localObject4).jdField_a_of_type_Int == 1)
      {
        localObject2 = new ahol();
        ((ahol)localObject2).l = "dc05550";
        ((ahol)localObject2).c = str;
        ((ahol)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(l);
        ((ahol)localObject2).jdField_b_of_type_JavaLangString = paramString;
        ((ahol)localObject2).d = paramList;
      }
      for (paramList = (List<ahoa>)localObject2;; paramList = (List<ahoa>)localObject2)
      {
        paramList.k = ((ahoa)localObject4).jdField_b_of_type_JavaLangString;
        paramList.e = String.valueOf(AppSetting.a());
        if (localObject1 != null)
        {
          localObject3 = ((ahmw)localObject1).c();
          localObject4 = ((ahmw)localObject1).d();
          localObject2 = localObject3;
          ...
          paramList.i = ((ahmw)localObject1).a();
          ahnw.a(false, str, paramInt, paramString, (ahmw)localObject1);
        }
        paramList.f = ((String)localObject6);
        paramList.g = ((String)localObject5);
        paramList.j = "android";
        localObject1 = paramList.a();
        localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ahnz.class);
        ((NewIntent)localObject2).putExtra("key_cmd", "MQInference.CommonReport");
        ((NewIntent)localObject2).putExtra("key_body", bgau.a(((JSONObject)localObject1).toString().getBytes()));
        if (QLog.isColorLevel()) {
        ...
        break label22;
        break;
        localObject2 = new ahnx();
        ((ahnx)localObject2).l = "dc04577";
        ((ahnx)localObject2).jdField_b_of_type_JavaLangString = str;
        if (QLog.isColorLevel()) {
          ((ahnx)localObject2).jdField_b_of_type_JavaLangString = c(((ahnx)localObject2).jdField_b_of_type_JavaLangString);
        }
        ((ahnx)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(l);
        ((ahnx)localObject2).d = paramString;
        ((ahnx)localObject2).c = paramList;
      }
      label716:
      paramList = "";
    }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    bfyz.u(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), paramBoolean);
  }
  ...
  public boolean a(ahom paramahom, int paramInt, String paramString)
  {
    if (!a()) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        if ((paramahom.a() == null) || (StringUtil.isEmpty(paramahom.a())))
        {
          if (!QLog.isColorLevel()) {
            continue;
          }
      ...
      catch (Exception paramahom)
      {
        if (QLog.isColorLevel()) {
          QLog.d("StickerRecManager", 2, bjna.a(paramahom));
        }
      }
    }
    for (;;)
    {
      return true;
      String str = paramahom.a();
      this.jdField_a_of_type_MqqOsMqqHandler.post(new StickerRecManager.4(this, str, paramInt, paramString, paramahom));
    }
  }
  ...
  public boolean a(String paramString1, int paramInt, String paramString2, boolean paramBoolean1, boolean paramBoolean2, SessionInfo paramSessionInfo)
  {
    ...
    try
    {
      ...
      if (!bool)
      {
        ...
        if ((!paramBoolean2) || (this.jdField_a_of_type_Ahnv == null)) {
          break label260;
        }
    ...
    catch (Exception paramString1)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("StickerRecManager", 2, bjna.a(paramString1));
        }
      }
    }
    return true;
  ...
  public boolean a(String paramString, SessionInfo paramSessionInfo)
  {
    ...
    if (paramSessionInfo != null) {
      bool = a(paramString, paramSessionInfo.curType, paramSessionInfo.curFriendUin, false, true, paramSessionInfo);
    }
    return bool;
  }
  ...
  public Collection<String> b()
  {
    ...
    Object localObject1 = ((arba)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(149)).a();
    if (localObject1 != null)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (("isUpdate".equals(((CustomEmotionData)localObject2).RomaingType)) || ("needDownload".equals(((CustomEmotionData)localObject2).RomaingType)) || ("overflow".equals(((CustomEmotionData)localObject2).RomaingType)) || ("overflow_downloaded".equals(((CustomEmotionData)localObject2).RomaingType))) {
          ...
          {
            localObject2 = localavsq.a(((CustomEmotionData)localObject2).emoPath, ((CustomEmotionData)localObject2).eId);
  ...
  public void b(List<ahoa> paramList)
  {
    Iterator localIterator = new ArrayList(paramList).iterator();
    while (localIterator.hasNext())
    {
      Object localObject1 = (ahoa)localIterator.next();
      if (localObject1 != null)
      {
        Object localObject2 = ((ahoa)localObject1).jdField_a_of_type_JavaLangString;
        int i = ((ahoa)localObject1).jdField_a_of_type_Int;
        label103:
        Object localObject3;
        if (i == 1)
        {
          ...
          localObject1 = ((ahoa)localObject1).jdField_a_of_type_JavaUtilList.iterator();
          do
          {
            if (!((Iterator)localObject1).hasNext()) {
              break;
            }
            localObject2 = (ahmw)((Iterator)localObject1).next();
          } while (((ahmw)localObject2).a());
          localObject2 = (ahnm)localObject2;
          localObject3 = Integer.valueOf(((ahnm)localObject2).d());
          if (!((ahnm)localObject2).b()) {
            break label224;
          }
        ...
        localObject2 = ((ahoa)localObject1).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject2).hasNext())
        {
          localObject3 = (ahmw)((Iterator)localObject2).next();
          if (!((ahmw)localObject3).a())
          {
            localObject3 = (ahnm)localObject3;
            if (((ahnm)localObject3).b()) {
              paramList.addClicked(Integer.valueOf(((ahnm)localObject3).d()));
            } else {
              paramList.addExposed(Integer.valueOf(((ahnm)localObject3).d()));
            }
          }
        }
        localObject1 = ((ahoa)localObject1).jdField_b_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject1).hasNext())
        {
          localObject2 = (ahmw)((Iterator)localObject1).next();
          if (!((ahmw)localObject2).a()) {
            paramList.addNoExpose(Integer.valueOf(((ahnm)localObject2).d()));
          }
        }
        if ((paramList.noExposeList != null) && (paramList.noExposeList.size() == 0))
        {
