...
public class sop
{
  ...
  static ArrayList<soz> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  static boolean jdField_a_of_type_Boolean;
  private static int b;
  private Activity jdField_a_of_type_AndroidAppActivity;
  protected bfpt a;
  
  public sop(Activity paramActivity, ArrayList<soz> paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    this.jdField_a_of_type_Bfpt = new soq(this);
  ...
  static int a()
  {
    ...
    int j = (jdField_a_of_type_Int - actj.a(110.0F, jdField_a_of_type_AndroidContentContext.getResources())) / 3;
    if (i % 2 == 0) {
      return i / 2 * j;
    }
    return (i + 1) / 2 * j;
  ...
  private ArrayList<soz> a(ArrayList<soz> paramArrayList)
  {
  ...
  private void a(RelativeLayout paramRelativeLayout)
  {
    ...
    int i = actj.a(2.0F, jdField_a_of_type_AndroidContentContext.getResources());
    int j = (b - i) / 2;
    paramRelativeLayout = (GridView)paramRelativeLayout.findViewById(2131374948);
    ...
    paramRelativeLayout.setOnItemClickListener(this.jdField_a_of_type_Bfpt);
    if (Build.VERSION.SDK_INT >= 9) {
      paramRelativeLayout.setOverScrollMode(2);
    }
    paramRelativeLayout.setAdapter(new sor(this));
  }
  ...
  public View a(Activity paramActivity, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView != null) && ((paramView instanceof RelativeLayout)))
    {
      ...
      if ((localObject != null) && ((localObject instanceof sot)))
      {
    ...
    paramView = new sot();
    paramView.jdField_a_of_type_ComTencentWidgetGridView = ((GridView)paramActivity.findViewById(2131374948));
    paramView.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAlphaMaskView = ((VideoFeedsAlphaMaskView)paramActivity.findViewById(2131369817));
    paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramActivity.findViewById(2131374935));
    ...
    if ((jdField_a_of_type_JavaUtilArrayList == null) && (jdField_a_of_type_Boolean))
    {
      ...
      int i = actj.a(66.0F, jdField_a_of_type_AndroidContentContext.getResources());
