  ...
  extends ahac
{
  ...
  public bgqq(tAdvDesc paramtAdvDesc)
  {
    super(paramtAdvDesc);
  }
  ...
  protected void a()
  {
    ...
    try
    {
      ...
      localObject = new bgqs(this, null);
      ((ahad)localObject).a = this.f;
      ((ahad)localObject).b = this.g;
      if (!TextUtils.isEmpty(this.f)) {
        ((ahad)localObject).c = (QzoneZipCacheHelper.getBasePath("qboss_banner", String.valueOf(this.f.hashCode())) + ".zip");
      }
    ...
    catch (Exception localException)
    {
      ...
      bgbr.a().a(2741, this.jdField_a_of_type_BOSSStrategyCenterTAdvDesc.task_id, 102, "CountDownBanner json parseError exception = " + localException.getMessage() + " json string = " + str);
    }
  }
}
