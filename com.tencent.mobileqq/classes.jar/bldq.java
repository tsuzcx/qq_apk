  ...
  implements Manager
{
  ...
  public bldq(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_JavaUtilHashSet = new HcePluginManager.1(this);
  }
  
  public static bldq a()
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if ((localAppRuntime instanceof QQAppInterface)) {
      return (bldq)((QQAppInterface)localAppRuntime).getManager(291);
    }
    return null;
  }
  ...
  public int a(byte[] paramArrayOfByte)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      byte[] arrayOfByte = bldn.a(str);
      if (QLog.isColorLevel()) {
        QLog.i("HcePluginManager", 2, "aidApdu: " + bldn.a(arrayOfByte) + " commandApdu" + bldn.a(paramArrayOfByte));
      }
  ...
  public long a()
  {
    String str = bgjb.a(BaseApplicationImpl.getApplication(), "vfcStartTime");
    if (bgsp.a(str)) {
      return 0L;
    }
  ...
  public void a()
  {
    bgjb.a(BaseApplicationImpl.getApplication(), "vfcStartTime", System.currentTimeMillis() + "");
  }
  
  public void a(Context paramContext, int paramInt)
  {
    if (paramContext != null) {
      bgjb.a(paramContext, "vfcState", paramInt + "");
    }
    if (QLog.isColorLevel()) {
  ...
  {
    return (paramContext != null) && ("1".equals(bgjb.a(paramContext, "vfcState")));
  }
