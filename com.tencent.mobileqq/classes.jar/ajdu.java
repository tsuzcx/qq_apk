...
{
  public ajdu(MainFragment paramMainFragment) {}
  ...
  public boolean onLongClick(View paramView)
  {
    if (this.a.a() == MainFragment.b)
    {
      ...
      if (paramView != null)
      {
        ...
        if (paramView != null) {
          avyf.a(this.a.getActivity(), paramView.getRecentUserUin(), paramView.getRecentUserType(), paramView.getTitleName(), "conversation_tab_bottom");
        }
      }
    }
    return true;
