...
public class ajdu
  implements Runnable
{
  public ajdu(AvatarWallViewPagerAdapter paramAvatarWallViewPagerAdapter, String paramString, AvatarWallAdapter.AvatarInfo paramAvatarInfo, URLImageView paramURLImageView) {}
  ...
  public void run()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetAvatarWallViewPagerAdapter.jdField_a_of_type_AndroidOsHandler.post(new ajdv(this));
  }
}
