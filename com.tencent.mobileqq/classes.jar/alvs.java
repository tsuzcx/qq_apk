  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public alvs(BaseActivity paramBaseActivity, Intent paramIntent)
  {
  ...
  {
    bgpa localbgpa = bglp.a(paramBaseActivity, 232, null, paramBaseActivity.getString(paramInt), new alvt(paramBoolean, paramBaseActivity), null);
  ...
  public int a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 35	alvs:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   20: ireturn
    //   21: aload_0
    //   22: getfield 65	alvs:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   25: ifnull +60 -> 85
    //   28: aload_0
    //   29: getfield 65	alvs:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   32: invokevirtual 206	java/util/ArrayList:isEmpty	()Z
    //   35: ifne +50 -> 85
    //   38: aload_0
    //   39: getfield 35	alvs:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   51: aload_0
    //   52: getfield 65	alvs:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   55: aload_0
    //   56: getfield 81	alvs:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   59: aload_0
    //   60: getfield 89	alvs:jdField_a_of_type_Int	I
    //   63: invokestatic 215	bgrw:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/util/List;Ljava/lang/String;I)V
    //   66: aload_0
    //   67: getfield 57	alvs:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   70: ifnull +12 -> 82
    //   73: aload_0
    //   74: getfield 57	alvs:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   77: ldc 217
    //   79: if_acmpne +6 -> 85
    //   82: bipush 9
    //   84: ireturn
    ...
    //   114: invokestatic 238	bgsg:p	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   117: astore 7
    //   119: iload_2
    //   120: istore_1
    //   121: aload 7
    ...
    //   242: aload 11
    //   244: aload_0
    //   245: getfield 57	alvs:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   248: iload_1
    //   249: invokestatic 267	com/tencent/mobileqq/shortvideo/ShortVideoUtils:a	(Landroid/content/Context;Ljava/lang/String;I)Landroid/graphics/Bitmap;
    //   252: astore 8
    //   254: aload 8
    ...
    //   267: iconst_2
    //   268: ldc_w 269
    //   271: invokestatic 271	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   274: aload_0
    //   275: getfield 273	alvs:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   278: ifnull +201 -> 479
    //   281: aload_0
    //   282: getfield 273	alvs:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   285: astore 8
    //   287: aload_0
    //   288: aload 8
    //   290: invokevirtual 278	android/graphics/Bitmap:getWidth	()I
    //   293: putfield 280	alvs:jdField_b_of_type_Int	I
    //   296: aload_0
    //   297: aload 8
    //   299: invokevirtual 283	android/graphics/Bitmap:getHeight	()I
    //   302: putfield 285	alvs:jdField_c_of_type_Int	I
    //   305: aload_0
    //   306: getfield 280	alvs:jdField_b_of_type_Int	I
    //   309: ifeq +10 -> 319
    //   312: aload_0
    //   313: getfield 285	alvs:jdField_c_of_type_Int	I
    //   316: ifne +201 -> 517
    ...
    //   327: iconst_2
    //   328: ldc_w 287
    //   331: invokestatic 271	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   334: iconst_0
    //   335: ifeq +11 -> 346
    //   338: new 289	java/lang/NullPointerException
    //   341: dup
    //   342: invokespecial 290	java/lang/NullPointerException:<init>	()V
    //   345: athrow
    //   346: iconst_0
    //   347: ifeq +11 -> 358
    //   350: new 289	java/lang/NullPointerException
    //   353: dup
    //   354: invokespecial 290	java/lang/NullPointerException:<init>	()V
    //   357: athrow
    //   358: iconst_0
    //   359: ifeq +11 -> 370
    //   362: new 289	java/lang/NullPointerException
    //   365: dup
    //   366: invokespecial 290	java/lang/NullPointerException:<init>	()V
    //   369: athrow
    //   370: iconst_2
    //   371: ireturn
    //   372: astore 7
    ...
    //   385: ldc_w 292
    //   388: aload 7
    //   390: invokestatic 295	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   393: iload_2
    //   394: istore_1
    //   395: goto -185 -> 210
    //   398: astore 11
    ...
    //   431: ldc_w 297
    //   434: aload 11
    //   436: invokestatic 295	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   439: iconst_3
    //   440: istore_1
    //   441: iconst_0
    //   442: ifeq +11 -> 453
    //   445: new 289	java/lang/NullPointerException
    //   448: dup
    //   449: invokespecial 290	java/lang/NullPointerException:<init>	()V
    //   452: athrow
    //   453: aload 7
    //   455: ifnull +8 -> 463
    //   458: aload 7
    //   460: invokevirtual 302	java/io/BufferedOutputStream:close	()V
    //   463: aload 10
    //   465: ifnull -446 -> 19
    //   468: aload 10
    //   470: invokevirtual 305	java/io/FileInputStream:close	()V
    //   473: iconst_3
    //   474: ireturn
    //   475: astore 7
    //   477: iconst_3
    ...
    //   479: iconst_0
    //   480: ifeq +11 -> 491
    //   483: new 289	java/lang/NullPointerException
    //   486: dup
    //   487: invokespecial 290	java/lang/NullPointerException:<init>	()V
    //   490: athrow
    //   491: iconst_0
    //   492: ifeq +11 -> 503
    //   495: new 289	java/lang/NullPointerException
    //   498: dup
    //   499: invokespecial 290	java/lang/NullPointerException:<init>	()V
    //   502: athrow
    //   503: iconst_0
    //   504: ifeq +11 -> 515
    //   507: new 289	java/lang/NullPointerException
    //   510: dup
    //   511: invokespecial 290	java/lang/NullPointerException:<init>	()V
    //   514: athrow
    //   515: iconst_2
    //   516: ireturn
    ...
    //   529: invokestatic 311	java/lang/System:currentTimeMillis	()J
    ...
    //   538: ldc_w 313
    //   541: invokestatic 316	com/tencent/mobileqq/shortvideo/ShortVideoUtils:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   544: astore 13
    //   546: new 126	java/lang/StringBuilder
    //   549: dup
    //   550: invokespecial 127	java/lang/StringBuilder:<init>	()V
    //   553: invokestatic 318	com/tencent/mobileqq/shortvideo/ShortVideoUtils:a	()Ljava/lang/String;
    ...
    //   568: invokestatic 325	bgmg:c	(Ljava/lang/String;)V
    //   571: new 327	java/io/File
    //   574: dup
    //   575: aload 13
    //   577: invokespecial 329	java/io/File:<init>	(Ljava/lang/String;)V
    //   580: astore 12
    //   582: new 327	java/io/File
    //   585: dup
    //   586: aload 12
    //   588: invokevirtual 332	java/io/File:getParent	()Ljava/lang/String;
    //   591: invokespecial 329	java/io/File:<init>	(Ljava/lang/String;)V
    //   594: astore 7
    //   596: aload 7
    //   598: invokevirtual 335	java/io/File:exists	()Z
    //   601: ifeq +11 -> 612
    //   604: aload 7
    //   606: invokevirtual 338	java/io/File:isDirectory	()Z
    //   609: ifne +9 -> 618
    //   612: aload 7
    //   614: invokevirtual 341	java/io/File:mkdirs	()Z
    //   617: pop
    //   618: aload 12
    //   620: invokevirtual 335	java/io/File:exists	()Z
    //   623: ifeq +11 -> 634
    //   626: aload 12
    //   628: invokevirtual 344	java/io/File:isFile	()Z
    //   631: ifne +9 -> 640
    //   634: aload 12
    //   636: invokevirtual 347	java/io/File:createNewFile	()Z
    //   639: pop
    //   640: new 299	java/io/BufferedOutputStream
    //   643: dup
    //   644: new 349	java/io/FileOutputStream
    //   647: dup
    //   648: aload 12
    //   650: invokespecial 352	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   653: invokespecial 355	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   656: astore 7
    //   658: aload 8
    //   660: getstatic 361	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   663: bipush 80
    //   665: aload 7
    //   667: invokevirtual 365	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   670: pop
    //   671: aload 7
    //   673: invokevirtual 368	java/io/BufferedOutputStream:flush	()V
    //   676: new 304	java/io/FileInputStream
    //   679: dup
    //   680: aload 12
    //   682: invokespecial 369	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   685: astore 10
    //   687: aload 7
    //   689: astore 9
    //   691: aload 10
    //   693: astore 8
    //   695: aload 12
    //   697: invokevirtual 371	java/io/File:length	()J
    //   700: lstore 5
    //   702: aload 7
    //   704: astore 9
    //   706: aload 10
    ...
    //   711: aload 10
    //   713: lload 5
    //   715: invokestatic 377	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   718: invokestatic 383	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   721: putfield 385	alvs:g	Ljava/lang/String;
    //   724: aload 7
    //   726: astore 9
    //   728: aload 10
    //   730: astore 8
    //   732: aload_0
    //   733: getfield 385	alvs:g	Ljava/lang/String;
    //   736: invokestatic 390	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   739: ifeq +88 -> 827
    //   742: aload 7
    //   744: astore 9
    //   746: aload 10
    ...
    //   780: aload_0
    //   781: getfield 385	alvs:g	Ljava/lang/String;
    ...
    //   790: invokestatic 271	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   793: iconst_0
    //   794: ifeq +11 -> 805
    //   797: new 289	java/lang/NullPointerException
    //   800: dup
    //   801: invokespecial 290	java/lang/NullPointerException:<init>	()V
    //   804: athrow
    //   805: aload 7
    //   807: ifnull +8 -> 815
    //   810: aload 7
    //   812: invokevirtual 302	java/io/BufferedOutputStream:close	()V
    //   815: aload 10
    //   817: ifnull +8 -> 825
    //   820: aload 10
    //   822: invokevirtual 305	java/io/FileInputStream:close	()V
    //   825: iconst_5
    //   826: ireturn
    //   827: aload 7
    //   829: astore 9
    ...
    //   835: aload_0
    //   836: aload_0
    //   837: getfield 385	alvs:g	Ljava/lang/String;
    //   840: ldc_w 313
    //   843: invokestatic 316	com/tencent/mobileqq/shortvideo/ShortVideoUtils:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   846: putfield 394	alvs:f	Ljava/lang/String;
    //   849: aload 7
    //   851: astore 9
    //   853: aload 10
    //   855: astore 8
    //   857: aload 13
    //   859: aload_0
    //   860: getfield 394	alvs:f	Ljava/lang/String;
    //   863: invokestatic 397	bgmg:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   866: istore 4
    //   868: iload 4
    //   870: ifne +37 -> 907
    //   873: iconst_0
    //   874: ifeq +11 -> 885
    //   877: new 289	java/lang/NullPointerException
    //   880: dup
    //   881: invokespecial 290	java/lang/NullPointerException:<init>	()V
    //   884: athrow
    //   885: aload 7
    //   887: ifnull +8 -> 895
    //   890: aload 7
    //   892: invokevirtual 302	java/io/BufferedOutputStream:close	()V
    //   895: aload 10
    //   897: ifnull +8 -> 905
    //   900: aload 10
    //   902: invokevirtual 305	java/io/FileInputStream:close	()V
    //   905: iconst_5
    //   906: ireturn
    //   907: aload 7
    //   909: astore 9
    ...
    //   915: aload 11
    //   917: lload 5
    //   919: invokestatic 403	android/text/format/Formatter:formatFileSize	(Landroid/content/Context;J)Ljava/lang/String;
    //   922: astore 11
    //   924: aload 7
    //   926: astore 9
    //   928: aload 10
    ...
    //   970: invokestatic 271	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   973: aload 7
    //   975: astore 9
    //   977: aload 10
    //   979: astore 8
    //   981: aload_0
    //   982: getfield 73	alvs:jdField_b_of_type_Long	J
    //   985: lconst_0
    //   986: lcmp
    //   987: ifne +22 -> 1009
    //   990: aload 7
    ...
    //   998: aload_0
    //   999: aload_0
    //   1000: getfield 57	alvs:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   1003: invokestatic 407	com/tencent/mobileqq/shortvideo/ShortVideoUtils:a	(Ljava/lang/String;)J
    //   1006: putfield 73	alvs:jdField_b_of_type_Long	J
    //   1009: iconst_0
    //   1010: ifeq +11 -> 1021
    //   1013: new 289	java/lang/NullPointerException
    //   1016: dup
    //   1017: invokespecial 290	java/lang/NullPointerException:<init>	()V
    //   1020: athrow
    //   1021: aload 7
    //   1023: ifnull +8 -> 1031
    //   1026: aload 7
    //   1028: invokevirtual 302	java/io/BufferedOutputStream:close	()V
    //   1031: aload 10
    //   1033: ifnull +8 -> 1041
    //   1036: aload 10
    //   1038: invokevirtual 305	java/io/FileInputStream:close	()V
    //   1041: iconst_1
    //   1042: ireturn
    //   1043: astore 11
    //   1045: aconst_null
    ...
    //   1076: ldc_w 297
    //   1079: aload 11
    //   1081: invokestatic 295	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   1084: iconst_0
    //   1085: ifeq +11 -> 1096
    //   1088: new 289	java/lang/NullPointerException
    //   1091: dup
    //   1092: invokespecial 290	java/lang/NullPointerException:<init>	()V
    //   1095: athrow
    //   1096: aload 7
    //   1098: ifnull +8 -> 1106
    //   1101: aload 7
    //   1103: invokevirtual 302	java/io/BufferedOutputStream:close	()V
    //   1106: aload 10
    //   1108: ifnull +8 -> 1116
    //   1111: aload 10
    //   1113: invokevirtual 305	java/io/FileInputStream:close	()V
    //   1116: iconst_5
    //   1117: ireturn
    //   1118: astore 11
    //   1120: aconst_null
    ...
    //   1151: ldc_w 409
    //   1154: aload 11
    //   1156: invokestatic 295	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   1159: iconst_4
    //   1160: istore_1
    //   1161: iconst_0
    //   1162: ifeq +11 -> 1173
    //   1165: new 289	java/lang/NullPointerException
    //   1168: dup
    //   1169: invokespecial 290	java/lang/NullPointerException:<init>	()V
    //   1172: athrow
    //   1173: aload 7
    //   1175: ifnull +8 -> 1183
    //   1178: aload 7
    //   1180: invokevirtual 302	java/io/BufferedOutputStream:close	()V
    //   1183: aload 10
    //   1185: ifnull -1166 -> 19
    //   1188: aload 10
    //   1190: invokevirtual 305	java/io/FileInputStream:close	()V
    //   1193: iconst_4
    //   1194: ireturn
    //   1195: astore 7
    //   1197: iconst_4
    ...
    //   1207: iconst_0
    //   1208: ifeq +11 -> 1219
    //   1211: new 289	java/lang/NullPointerException
    //   1214: dup
    //   1215: invokespecial 290	java/lang/NullPointerException:<init>	()V
    //   1218: athrow
    //   1219: aload 7
    //   1221: ifnull +8 -> 1229
    //   1224: aload 7
    //   1226: invokevirtual 302	java/io/BufferedOutputStream:close	()V
    //   1229: aload 8
    //   1231: ifnull +8 -> 1239
    //   1234: aload 8
    //   1236: invokevirtual 305	java/io/FileInputStream:close	()V
    //   1239: aload 10
    //   1241: athrow
    //   1242: astore 7
    //   1244: goto -753 -> 491
    ...
    //   580	116	12	localFile	java.io.File
    //   544	314	13	str2	String
    // Exception table:
    //   from	to	target	type
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_JavaLangString.equals(ShortVideoPreviewActivity.class.getName())))
    {
      ...
      localObject1 = bcec.a(0, 2);
      ((bcev)localObject1).a(bcec.a(2, localIntent, (bcev)localObject1));
      bcec.a((bcev)localObject1, ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).app);
    }
    for (;;)
    {
      ...
      Object localObject2 = bcec.a(0, 0);
      localObject1 = bcec.a(0, localIntent, (bcev)localObject2);
      ((bcev)localObject2).a((bcfn)localObject1);
      localObject2 = new bcdm(((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).app);
      ...
      if (((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).app != null) {
        ((bauy)((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).app.getManager(326)).a(((MessageRecord)localObject1).frienduin, ((MessageRecord)localObject1).uniseq);
      }
  ...
  protected void a(Integer paramInteger)
  {
    ...
    case 2: 
    case 6: 
      a((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718114, this.jdField_a_of_type_Boolean);
      return;
    case 3: 
      a((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718109, this.jdField_a_of_type_Boolean);
      return;
    case 4: 
      a((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718080, this.jdField_a_of_type_Boolean);
      return;
    case 5: 
      a((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718106, this.jdField_a_of_type_Boolean);
      return;
    }
    ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).finish();
  }
  ...
  {
    super.onPreExecute();
    a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131694295);
  }
}
