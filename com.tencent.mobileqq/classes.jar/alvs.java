...
public class alvs
{
  protected static final ark.ApplicationCallback a = new alwd();
  
  public static void a()
  {
    String str3 = alte.a().a();
    String str1 = "";
    ...
    ArkDelegateManager.getInstance().init(str2, (String)localObject, "8.3.0", BaseApplicationImpl.getContext());
    ...
    ArkDelegateManager.getInstance().setSetupDelegate(new alvx());
    ArkDelegateManager.getInstance().setNetDelegate(new alvy());
    ArkDelegateManager.getInstance().setInputCallback(new alwe(null));
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    try
    {
      if (!ArkAppCenter.a)
      {
        ((ArkEnvironmentManager)localObject1).setThreadCreator(new alvt());
        ((ArkEnvironmentManager)localObject1).setLogCallback(new alvu());
        ((ArkEnvironmentManager)localObject1).setLibraryLoader(new alvv());
        ((ArkEnvironmentManager)localObject1).setDebugFlag(false);
        ((ArkEnvironmentManager)localObject1).setProfilingLogFlag(true);
        ((ArkEnvironmentManager)localObject1).setDataReport(new alvw());
        ArkAppCenter.a = true;
      }
