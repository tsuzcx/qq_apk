...
public class alvs
  implements amdz
{
  public alvs(CmGameServerQIPCModule.5 param5) {}
  ...
  public void a(boolean paramBoolean, String paramString, List<amdx> paramList)
  {
    ...
    if (paramBoolean)
    {
      ...
      paramString = amcg.a(this.a.jdField_a_of_type_ComTencentMobileqqApolloScriptSpriteTaskParam, this.a.jdField_a_of_type_ComTencentMobileqqApolloSdkIPCSpriteContext, this.a.jdField_a_of_type_ComTencentMobileqqApolloSdkCmShowRenderView$PlayActionConfig);
