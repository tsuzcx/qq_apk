...
public class abdi
{
  ...
  public abdi(abdf paramabdf, CustomWebView paramCustomWebView)
  {
  ...
  {
    paramString = bhsg.g(paramString);
    bhsg.a("catchHtml");
    WebSoService.WebSoState.WebSo3 localWebSo3 = abdf.a(this.jdField_a_of_type_Abdf).a();
    if (localWebSo3 != null)
    {
      WebSoService.a(paramString, localWebSo3.jdField_a_of_type_JavaLangString, localWebSo3.b, Uri.parse(localWebSo3.d));
      return;
    }
    bhsg.a("return webSo3 == null");
  }
