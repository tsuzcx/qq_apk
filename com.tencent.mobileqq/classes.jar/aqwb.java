  ...
  implements View.OnClickListener
{
  ...
  public aqwf a;
  URLDrawableDownListener jdField_a_of_type_ComTencentImageURLDrawableDownListener = new aqwc(this);
  ...
  public aqwb(Context paramContext, QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler, boolean paramBoolean, aqwf paramaqwf, int paramInt)
  {
    ...
    this.jdField_a_of_type_Aqwf = paramaqwf;
    if ((paramBoolean) && (this.jdField_a_of_type_Aqwf != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Aqwf.b))) {}
    ...
    this.jdField_b_of_type_Int = AIOUtils.dp2px(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.c = AIOUtils.dp2px(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.d = AIOUtils.dp2px(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.e = AIOUtils.dp2px(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject1 = new aqwd(null);
          ((aqwd)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout = new RelativeLayout(this.jdField_a_of_type_AndroidContentContext);
          paramView = new ViewGroup.LayoutParams(this.jdField_b_of_type_Int, this.c);
          ((aqwd)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setLayoutParams(paramView);
          ((aqwd)localObject1).jdField_a_of_type_ComTencentImageURLImageView = new URLImageView(this.jdField_a_of_type_AndroidContentContext);
          paramView = new RelativeLayout.LayoutParams(this.d, this.e);
          paramView.addRule(13, -1);
          ((aqwd)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.addView(((aqwd)localObject1).jdField_a_of_type_ComTencentImageURLImageView, paramView);
          ((aqwd)localObject1).jdField_a_of_type_AndroidWidgetProgressBar = new ProgressBar(this.jdField_a_of_type_AndroidContentContext);
          ((aqwd)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setIndeterminateDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839445));
          paramView = new RelativeLayout.LayoutParams((int)(this.jdField_a_of_type_Float * 30.0F), (int)(this.jdField_a_of_type_Float * 30.0F));
          paramView.addRule(13, -1);
          ((aqwd)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.addView(((aqwd)localObject1).jdField_a_of_type_AndroidWidgetProgressBar, paramView);
          paramView = ((aqwd)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout;
          paramView.setTag(localObject1);
          ((aqwd)localObject1).jdField_a_of_type_ComTencentMobileqqDoutuDoutuData = localDoutuData;
          ((aqwd)localObject1).jdField_a_of_type_Int = paramInt;
          ((aqwd)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
        ...
        try
        {
          ...
          if (localURL == null)
          {
            ...
            paramView = localURL;
            continue;
            localObject1 = (aqwd)paramView.getTag();
          }
        }
    ...
    label566:
    ((aqwd)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable((Drawable)localObject2);
    ((aqwd)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(this.jdField_a_of_type_ComTencentImageURLDrawableDownListener);
    ((aqwd)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setTag(localObject1);
    ((aqwd)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setFocusable(true);
    ((aqwd)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setFocusableInTouchMode(true);
    ...
    for (;;)
    {
      ...
      break;
      label627:
      ((aqwd)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(4);
      ...
      break label566;
      label675:
      ((aqwd)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if ((localObject1 != null) && ((localObject1 instanceof aqwd))) {}
    for (localObject1 = (aqwd)localObject1;; localObject1 = null)
    {
      ...
      for (;;)
      {
        ...
        return;
        DoutuData localDoutuData = ((aqwd)localObject1).jdField_a_of_type_ComTencentMobileqqDoutuDoutuData;
        if ((localDoutuData != null) && (localDoutuData.thumb_down_url != null))
        {
          Object localObject2 = (URLDrawable)((aqwd)localObject1).jdField_a_of_type_ComTencentImageURLImageView.getDrawable();
          if (localObject2 != null)
          {
            ...
            if (localObject2 != null)
            {
              ...
              bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FAB", "0X8007FAB", 0, 0, "", String.valueOf(((aqwd)localObject1).jdField_a_of_type_Int + 1), localDoutuData.pic_md5, localDoutuData.pic_down_url);
