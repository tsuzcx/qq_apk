...
{
  public ajwp(TroopFileTransferManager paramTroopFileTransferManager) {}
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.ResendRspBody paramResendRspBody, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      paramResendRspBody = new TroopFileError.SimpleErrorInfo(((TroopFileTransferManager.Item)localObject).FileName, this.a.e, 3, 207);
