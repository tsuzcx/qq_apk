  ...
  extends bfxe
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new afmo(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  protected SlideDetectListView a;
  public List<MessageRecord> a;
  private List<MessageRecord> b = new ArrayList();
  
  public afmn(Context paramContext, QQAppInterface paramQQAppInterface, afjj paramafjj, int paramInt, SlideDetectListView paramSlideDetectListView)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      ((Button)paramView.findViewById(2131377873)).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
