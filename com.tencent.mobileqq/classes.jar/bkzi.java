  ...
  extends ReportDialog
{
  ...
  private bkzs jdField_a_of_type_Bkzs;
  ...
  private HashMap<CharSequence, bkzh> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private Map<Integer, bkzt> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private View.OnClickListener jdField_d_of_type_AndroidViewView$OnClickListener = new bkzo(this);
  ...
  protected bkzi(Context paramContext)
  {
    this(paramContext, false, false);
  }
  
  protected bkzi(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    this(paramContext, paramBoolean1, paramBoolean2, true, -1, null);
  }
  
  @TargetApi(14)
  protected bkzi(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt, ViewGroup.LayoutParams paramLayoutParams)
  {
    super(paramContext, 2131755230);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bkzp(this);
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131361966));
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131361974));
  ...
  public static bkzi a(Context paramContext)
  {
    paramContext = new bkzi(paramContext, false, false);
  ...
  public static bkzi a(Context paramContext, int paramInt, ViewGroup.LayoutParams paramLayoutParams)
  {
    paramContext = new bkzi(paramContext, false, false, true, paramInt, paramLayoutParams);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755013);
    }
    return paramContext;
  ...
  public static bkzi a(Context paramContext, boolean paramBoolean)
  {
    paramContext = new bkzi(paramContext, false, true, paramBoolean, -1, null);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755013);
    }
    return paramContext;
  ...
  private void a(TextView paramTextView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramTextView.setContentDescription(getContext().getString(2131691102) + paramTextView.getText());
      return;
    }
    paramTextView.setContentDescription(getContext().getString(2131691104) + paramTextView.getText());
  }
  ...
  private void a(URLDrawable paramURLDrawable, Pair<CharSequence, Integer> paramPair, TextView paramTextView)
  {
    ...
    paramURLDrawable.setURLDrawableListener(new bkzl(this, paramTextView, paramPair));
    paramURLDrawable.setDownloadListener(new bkzm(this));
    ThreadManagerV2.executeOnSubThread(new ActionSheet.5(this, paramURLDrawable));
  }
  
  private void a(CharSequence paramCharSequence, bkzt parambkzt)
  {
    if ((paramCharSequence == null) || (parambkzt == null)) {
      return;
    }
    int j = paramCharSequence.hashCode();
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(j), parambkzt);
  }
  
  public static bkzi b(Context paramContext)
  {
    paramContext = new bkzi(paramContext, false, true);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755013);
    }
    return paramContext;
  ...
  private void b(Pair<CharSequence, Integer> paramPair, TextView paramTextView)
  {
    ...
    do
    {
      do
      {
        ...
        a((CharSequence)paramPair.first, new bkzk(this, paramTextView));
  ...
  public static bkzi c(Context paramContext)
  {
    paramContext = new bkzi(paramContext, true, false);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755013);
    }
    return paramContext;
  ...
  public static bkzi d(Context paramContext)
  {
    paramContext = new bkzi(paramContext, true, true);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755013);
    }
    return paramContext;
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_JavaLangCharSequence != null)
    {
      ...
      ((View)localObject1).setOnClickListener(new bkzj(this));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131361985));
      ...
      {
        localObject2 = (TextView)((View)localObject1).findViewById(2131361982);
    ...
    for (int j = 1;; j = 0)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        if (j < m)
        {
          ...
          if (((Integer)localPair.second).intValue() == 65537)
          {
            ...
            localObject2 = (TextView)((View)localObject3).findViewById(2131361971);
            localObject1 = (TextView)((View)localObject3).findViewById(2131378293);
            ...
            if ((n >= 0) && (n < ((CharSequence)localPair.first).length()))
            {
              ...
              ((View)localObject3).findViewById(2131364145).setContentDescription(((TextView)localObject2).getText());
              label408:
              ...
              bgyd.b(((View)localObject3).findViewById(2131364145), LinearLayout.class.getName());
              label452:
              if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.size() > 0))
              {
                localObject1 = (bkzh)this.jdField_a_of_type_JavaUtilHashMap.get(localPair.first);
                if ((localObject1 != null) && (((bkzh)localObject1).jdField_b_of_type_Int != 0)) {
                  ((TextView)localObject2).setId(((bkzh)localObject1).jdField_b_of_type_Int);
                }
              }
              localObject1 = (ImageView)((View)localObject3).findViewById(2131361983);
              ...
              label593:
              localObject1 = (ImageView)((View)localObject3).findViewById(2131361984);
              localObject4 = (RelativeLayout.LayoutParams)((ImageView)localObject1).getLayoutParams();
              ...
              if (this.jdField_a_of_type_Boolean)
              {
                ...
                ((View)localObject3).findViewById(2131361972).setVisibility(0);
          ...
          for (;;)
          {
            ...
            break label408;
            localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558440, null);
            localObject2 = (TextView)((View)localObject1).findViewById(2131361971);
            ((TextView)localObject2).setText((CharSequence)localPair.first);
            bgyd.b((View)localObject2, Button.class.getName());
      ...
      if (this.jdField_c_of_type_JavaLangCharSequence != null)
      {
        ...
        {
          localObject2 = (Button)((View)localObject1).findViewById(2131361969);
        ...
        localObject2 = (Button)((View)localObject1).findViewById(2131361970);
  ...
  protected int a(int paramInt)
  {
    ...
    case 7: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131165200);
    case 8: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131165748);
    }
  ...
  public bkzh a(int paramInt)
  {
    return a(a(paramInt));
  }
  
  public bkzh a(CharSequence paramCharSequence)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap == null) {
      return null;
    }
    return (bkzh)this.jdField_a_of_type_JavaUtilHashMap.get(paramCharSequence);
  }
  ...
  public void a(int paramInt1, CharSequence paramCharSequence, int paramInt2)
  {
    if ((paramInt1 >= 0) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (paramInt1 < this.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      ...
      if (localObject != null)
      {
        localObject = ((View)localObject).findViewById(2131361971);
  ...
  public void a(bkzh parambkzh, int paramInt)
  {
    if (parambkzh == null) {
      return;
    }
    this.jdField_a_of_type_JavaUtilHashMap.put(parambkzh.a, parambkzh);
    a(parambkzh.a, paramInt);
  }
  
  public void a(bkzq parambkzq)
  {
    this.jdField_a_of_type_Bkzq = parambkzq;
  }
  
  public void a(bkzr parambkzr)
  {
    this.jdField_a_of_type_Bkzr = parambkzr;
  }
  
  public void a(bkzs parambkzs)
  {
    this.jdField_a_of_type_Bkzs = parambkzs;
  }
  
  public void a(bkzu parambkzu)
  {
    this.jdField_a_of_type_Bkzu = parambkzu;
  }
  ...
  public void d()
  {
    ...
    for (;;)
    {
      ...
      while (j < k)
      {
        ...
        if (localView != null)
        {
          localView.findViewById(2131361972).setVisibility(8);
          a((TextView)localView.findViewById(2131361971), false);
        }
        j += 1;
      }
    }
  ...
  public void d(int paramInt)
  {
    if ((paramInt >= 0) && (this.jdField_a_of_type_JavaUtilArrayList != null) && (paramInt < this.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      ...
      if (this.jdField_b_of_type_AndroidUtilSparseArray != null)
      {
        ...
        if (localView != null)
        {
          localView.findViewById(2131361972).setVisibility(0);
          a((TextView)localView.findViewById(2131361971), true);
        }
      }
    }
  }
  ...
  public void dismiss()
  {
    if (this.jdField_a_of_type_Bkzu != null) {
      this.jdField_a_of_type_Bkzu.ad_();
    }
    if (this.g)
    {
      this.g = false;
  ...
  public void e()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 852	acxo:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 852	acxo:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 852	acxo:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
