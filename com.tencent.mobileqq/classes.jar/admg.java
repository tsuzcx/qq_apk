...
public abstract class admg
  extends BaseBubbleBuilder
{
  public admg(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
  ...
  private View a(Context paramContext, View paramView, MessageRecord paramMessageRecord, String paramString1, String paramString2, int paramInt, boolean paramBoolean, View.OnClickListener paramOnClickListener)
  {
    ...
    for (;;)
    {
      ...
      localTextView.setId(2131298580);
      if (!TextUtils.isEmpty(paramString2))
      {
        Drawable localDrawable = localResources.getDrawable(2130849111);
        localDrawable.setBounds(0, 0, aciy.a(12.0F, localResources), aciy.a(12.0F, localResources));
        paramString1 = localResources.getDrawable(2130849112);
        paramString1.setBounds(0, 0, aciy.a(12.0F, localResources), aciy.a(12.0F, localResources));
        try
        {
        ...
        paramContext.setBounds(0, 0, aciy.a(12.0F, localResources), aciy.a(12.0F, localResources));
  ...
  public View a(QQAppInterface paramQQAppInterface, BaseChatItemLayout paramBaseChatItemLayout, SessionInfo paramSessionInfo, MessageRecord paramMessageRecord, View.OnClickListener paramOnClickListener)
  {
    ...
    apgn localapgn = ((FlashChatManager)paramQQAppInterface.getManager(217)).a;
    ...
    do
    {
      ...
      if ((!TextUtils.isEmpty(localapgn.b)) && (bool) && ("1".equals(str))) {
        break;
      }
    } while (localRelativeLayout == null);
    paramBaseChatItemLayout.removeView(localRelativeLayout);
    return paramBaseChatItemLayout;
    awqx.b(paramQQAppInterface, "dc00898", "", "", "0X8008279", "0X8008279", i, 0, "", "", "", "");
    a(paramBaseChatItemLayout, paramMessageRecord, paramOnClickListener, paramSessionInfo, localRelativeLayout, localapgn.b, localapgn.d, -1, true);
    return paramBaseChatItemLayout;
  }
  ...
  protected void a(BaseChatItemLayout paramBaseChatItemLayout, MessageRecord paramMessageRecord, View.OnClickListener paramOnClickListener, Context paramContext, RelativeLayout paramRelativeLayout, String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    if (paramRelativeLayout == null)
    {
      ...
      paramRelativeLayout.setId(2131310768);
    }
    for (int i = 1;; i = 0)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject1).topMargin = aciy.a(-2.0F, (Resources)localObject2);
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = aciy.a(0.0F, (Resources)localObject2);
      ...
      if (bool)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject1).leftMargin = (aciy.a(18.0F, (Resources)localObject2) + j);
      ...
      for (;;)
      {
        ...
        return;
        j = ((RelativeLayout.LayoutParams)localObject1).leftMargin;
        ((RelativeLayout.LayoutParams)localObject1).leftMargin = (aciy.a(9.0F, (Resources)localObject2) + j);
