  ...
  extends DynamicTextItem
{
  ...
  bjgh jdField_a_of_type_Bjgh = null;
  ...
  public bjgj(int paramInt, @NonNull List<String> paramList)
  {
    ...
    this.jdField_b_of_type_AndroidTextTextPaint.setStrokeWidth(actn.a(3.0F, BaseApplicationImpl.getContext().getResources()));
  }
  ...
  private void a(float paramFloat1, float paramFloat2, float paramFloat3, int paramInt)
  {
    ...
    {
      this.g = paramInt;
      this.jdField_d_of_type_Int = actn.a(paramFloat1, BaseApplicationImpl.getApplication().getResources());
      this.jdField_e_of_type_Int = actn.a(paramFloat2, BaseApplicationImpl.getApplication().getResources());
      this.f = actn.a(paramFloat3, BaseApplicationImpl.getApplication().getResources());
    }
  }
  ...
  private void a(boolean paramBoolean, float paramFloat, int paramInt)
  {
    ...
    {
      this.jdField_b_of_type_Int = actn.a(paramFloat, BaseApplicationImpl.getContext().getResources());
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString, int paramInt5, int paramInt6, Point paramPoint)
  {
    ...
    while (j >= paramInt4)
    {
      ...
      StaticLayout localStaticLayout1 = bjig.a(paramString, 0, paramString.length(), this.jdField_a_of_type_AndroidTextTextPaint, paramInt1, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, paramInt6);
      StaticLayout localStaticLayout2 = bjig.a(paramString, 0, paramString.length(), this.jdField_b_of_type_AndroidTextTextPaint, paramInt1, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, paramInt6);
  ...
  public float a()
  {
    return this.jdField_a_of_type_Bjgh.jdField_a_of_type_AndroidGraphicsBitmap.getWidth();
  }
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new bjgk(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    while (paramInt < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      bjgh localbjgh = (bjgh)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
      localObject1[paramInt] = 0;
      f1 = localbjgh.jdField_c_of_type_Int;
      f2 = localbjgh.jdField_d_of_type_Int;
      localObject1[paramInt] = a((int)f1, (int)f2, localbjgh.h, localbjgh.g, (String)localObject2, localbjgh.jdField_a_of_type_Int, localbjgh.i, localObject3[paramInt]);
    ...
    {
      localObject3 = (bjgh)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
      ...
      {
        f1 = actn.a(((bjgh)localObject3).jdField_c_of_type_Int, this.jdField_a_of_type_AndroidContentResResources);
        f2 = actn.a(((bjgh)localObject3).jdField_d_of_type_Int, this.jdField_a_of_type_AndroidContentResResources);
      ...
      if (localObject2[paramInt] > localObject2[i])
      {
        ...
        for (;;)
        {
          if (j == 0)
          {
            ...
            this.jdField_a_of_type_Bjgh = ((bjgh)this.jdField_a_of_type_JavaUtilArrayList.get(i));
  ...
  {
    paramCanvas.save();
    paramCanvas.drawBitmap(this.jdField_a_of_type_Bjgh.jdField_a_of_type_AndroidGraphicsBitmap, 0.0F, 0.0F, this.jdField_a_of_type_AndroidGraphicsPaint);
    if (this.jdField_b_of_type_AndroidTextStaticLayout != null)
    {
      ...
      this.jdField_a_of_type_Float = (this.jdField_a_of_type_Bjgh.jdField_e_of_type_Int + (this.jdField_a_of_type_Bjgh.jdField_c_of_type_Int - this.jdField_c_of_type_Float) / 2.0F);
      this.jdField_b_of_type_Float = (this.jdField_a_of_type_Bjgh.f + (this.jdField_a_of_type_Bjgh.jdField_d_of_type_Int - this.jdField_d_of_type_Float) / 2.0F);
  ...
  public float b()
  {
    return this.jdField_a_of_type_Bjgh.jdField_a_of_type_AndroidGraphicsBitmap.getHeight();
  }
