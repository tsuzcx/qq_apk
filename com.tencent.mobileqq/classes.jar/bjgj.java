  ...
  extends BaseAdapter
{
  ...
  private bjgk jdField_a_of_type_Bjgk;
  private List<bahx> jdField_a_of_type_JavaUtilList;
  
  public bjgj(Context paramContext, List<bahx> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_Bjgk == null) {
      this.jdField_a_of_type_Bjgk = new bjgk(paramViewGroup.getContext());
    }
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131493268, paramViewGroup, false);
      paramViewGroup = new bjgl();
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (bjgl)paramView.getTag();
    }
    paramView.setId(paramViewGroup.jdField_a_of_type_Bahx.jdField_a_of_type_Int);
    paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(bjgh.a(paramViewGroup.jdField_a_of_type_Bahx.jdField_a_of_type_JavaLangString, 6));
    paramInt = -8947849;
    ...
    if (paramViewGroup.jdField_a_of_type_Bahx.c)
    {
      ...
      localObject = this.jdField_a_of_type_Bjgk.a((Drawable)localObject, paramInt, i);
      if (!paramViewGroup.jdField_a_of_type_Bahx.c) {
        break label421;
      }
      Drawable localDrawable = bjgk.a(this.jdField_a_of_type_Bjgk, (Drawable)localObject);
      localObject = this.jdField_a_of_type_Bjgk.a((Drawable)localObject, localDrawable);
    ...
    for (;;)
    {
      ...
      break label294;
      label421:
      localObject = bjgk.b(this.jdField_a_of_type_Bjgk, (Drawable)localObject);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
    }
    label444:
