  ...
  implements View.OnClickListener
{
  ...
  public bbmy()
  {
    ...
    this.jdField_a_of_type_Alox = new bbnb(this, null);
  }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    mzy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new bbmz(this, paramLong), localReqBody.toByteArray(), "OidbSvc.0x487_0", 1159, paramInt);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, Observer paramObserver, SessionInfo paramSessionInfo, RelativeLayout paramRelativeLayout, aelz paramaelz, ChatXListView paramChatXListView)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373393);
    }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_c_of_type_AndroidViewView) == -1)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject).topMargin = bcwh.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
      ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131373393);
      ((RelativeLayout.LayoutParams)localObject).addRule(11);
      ((RelativeLayout.LayoutParams)localObject).height = bcwh.a(this.jdField_a_of_type_AndroidContentContext, 41.0F);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131378259));
    ...
    ((LinearLayout.LayoutParams)localObject).leftMargin = bcwh.a(this.jdField_a_of_type_AndroidContentContext, 4.0F);
    ((LinearLayout.LayoutParams)localObject).rightMargin = bcwh.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
    int i = bcwh.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
    ...
    for (;;)
    {
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843251);
  ...
  public void c()
  {
    ...
    ImageView localImageView = (ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131378258);
    localImageView.setVisibility(0);
    LinearLayout.LayoutParams localLayoutParams = (LinearLayout.LayoutParams)localImageView.getLayoutParams();
    localLayoutParams.height = -2;
    localLayoutParams.width = -2;
    localLayoutParams.leftMargin = bcwh.a(this.jdField_a_of_type_AndroidContentContext, 3.0F);
    localLayoutParams.rightMargin = bcwh.a(this.jdField_a_of_type_AndroidContentContext, 8.0F);
    Drawable localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843252);
    localLayoutParams.leftMargin = bcwh.a(this.jdField_a_of_type_AndroidContentContext, 11.0F);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131698105);
  }
  ...
  public void e()
  {
    ...
    {
      azmj.b(localQQAppInterface, "P_CliOper", "Grp_public", "", "oper", str1, 0, 0, "", "", "", str2);
      return;
