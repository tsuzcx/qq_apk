...
{
  afoo jdField_a_of_type_Afoo = afoo.a();
  ...
  public avxz(Activity paramActivity, String paramString1, String paramString2, MiniMsgUserParam paramMiniMsgUserParam)
  {
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = View.inflate(this.jdField_a_of_type_AndroidAppActivity.getApplicationContext(), 2131563066, null);
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
      String str = bghb.a("", this.jdField_a_of_type_JavaLangString, 0);
      ...
      URLImageView localURLImageView = (URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371343);
  ...
  public void c()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniMsgUserParam != null)
    {
      ...
      {
        akep localakep = MiniMsgIPCClient.getInstance().getBusinessInfo(this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniMsgUserParam.businessName);
        if (localakep != null)
        {
          int[] arrayOfInt = ((aken)this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniMsgUserParam.unreadCallback).a();
          if (arrayOfInt != null)
          {
            localakep.c = arrayOfInt[0];
            localakep.d = arrayOfInt[1];
          }
        }
      }
      MiniMsgIPCClient.getInstance();
