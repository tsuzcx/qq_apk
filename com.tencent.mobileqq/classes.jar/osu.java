  ...
  implements otj
{
  ...
  public osu(FragmentActivity paramFragmentActivity, ReadInJoyCommentListFragment paramReadInJoyCommentListFragment, ReadInJoyCommentListView paramReadInJoyCommentListView, int paramInt)
  {
    ...
    this.jdField_a_of_type_Otq = paramReadInJoyCommentListFragment;
    ...
    this.jdField_a_of_type_Osr = new osr(paramReadInJoyCommentListView, this.jdField_a_of_type_JavaUtilList, this);
    this.jdField_a_of_type_Tty = new tty(paramFragmentActivity, null);
    paramReadInJoyCommentListView.setOnScrollListener(this.jdField_a_of_type_ComTencentWidgetAbsListView$OnScrollListener);
  }
  
  public osu(FastWebActivity paramFastWebActivity, ReadInJoyCommentListView paramReadInJoyCommentListView, int paramInt)
  {
    ...
    this.jdField_a_of_type_Otq = paramFastWebActivity;
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListView = paramReadInJoyCommentListView;
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListView.setRefreshCallback(this);
    this.d = paramInt;
    jdField_a_of_type_Int = paramInt;
    ...
    this.jdField_a_of_type_Osb.a(a());
    this.jdField_a_of_type_Osr = new osr(paramReadInJoyCommentListView, this.jdField_a_of_type_JavaUtilList, this);
    this.jdField_a_of_type_Tty = new tty(paramFastWebActivity, null);
    paramReadInJoyCommentListView.setOnScrollListener(this.jdField_a_of_type_ComTencentWidgetAbsListView$OnScrollListener);
  }
  ...
  private void a(int paramInt)
  {
    if (this.jdField_a_of_type_Otq != null) {
      this.jdField_a_of_type_Otq.b(paramInt);
    }
  }
  
  private void a(List<ouo> paramList)
  {
    if (this.jdField_a_of_type_Ouu.a() == null) {}
    for (;;)
    {
      return;
      Object localObject = this.jdField_a_of_type_Ouu.a();
      if ((((owe)localObject).jdField_a_of_type_Boolean) && (((owe)localObject).b != null) && (paramList != null))
      {
        paramList = paramList.iterator();
        while (paramList.hasNext())
        {
          localObject = (ouo)paramList.next();
          if ((localObject != null) && (((ouo)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData != null) && (((ouo)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.isAnchor)) {
            ((ouo)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.isAnchor = false;
          }
        }
      }
    }
  ...
  public int a()
  {
    ...
    for (;;)
    {
      ...
      ouo localouo = (ouo)this.jdField_a_of_type_JavaUtilList.get(i);
      j = i;
      if (localouo.jdField_a_of_type_Int == 2) {
        break;
      }
      j = i;
      if (localouo.jdField_a_of_type_Int == 1) {
        break;
      }
      i += 1;
    }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Ouu.a(this.c, 1);
  ...
  public void a(ArticleInfo paramArticleInfo, AnchorData paramAnchorData, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    this.c = paramInt1;
    this.jdField_a_of_type_Ouu = ouu.a(paramArticleInfo, paramInt2);
    String str;
    if (this.jdField_a_of_type_Ouu != null)
    {
      this.jdField_a_of_type_Ouu.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataCommonCommentData);
      if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a())) {
        this.jdField_a_of_type_Ouu.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.b(), paramInt1);
      }
      this.jdField_a_of_type_Otl = new otl(this, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, paramInt2);
    ...
    {
      paramArticleInfo = new owe(paramArticleInfo, str, paramBoolean, paramAnchorData.jdField_a_of_type_Boolean);
      this.jdField_a_of_type_Ouu.a(paramArticleInfo);
      this.jdField_a_of_type_Ouu.a(paramInt1, 1);
  ...
  public void a(ouo paramouo)
  {
    super.a(paramouo);
    if (this.jdField_a_of_type_Otl != null) {
      this.jdField_a_of_type_Otl.a(1, paramouo);
    }
  }
  
  public void a(ouo paramouo, SubCommentData paramSubCommentData, int paramInt)
  {
    if ((this.jdField_a_of_type_Otq != null) && (paramouo != null) && (paramouo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo != null) && (paramouo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData != null))
    {
      String str = null;
      if (paramSubCommentData != null) {
        str = paramSubCommentData.commentId;
      }
      this.jdField_a_of_type_Otq.a(true, paramouo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.commentId, str);
      if (this.jdField_a_of_type_Otl != null) {
        this.jdField_a_of_type_Otl.a(paramouo, paramInt);
      }
    }
  }
  ...
  public void d()
  {
    ...
    if ((this.jdField_a_of_type_Otl != null) && (jdField_a_of_type_Int != 1)) {
      this.jdField_a_of_type_Otl.a(l, 2);
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 6)
    {
      paramView = this.jdField_a_of_type_Ouu.a().a(paramViewGroup, (View)localObject, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, a(paramInt));
    ...
    if (osb.a(a(paramInt)))
    {
      localTemplateBean = this.jdField_a_of_type_Osb.a(a(paramInt));
      if (localObject != null) {
        break label412;
      }
    }
    ...
    {
      osb.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, (Container)paramView, localTemplateBean, this, paramInt, i, true);
      localObject = paramView;
      if (this.jdField_a_of_type_Otl != null) {
        this.jdField_a_of_type_Otl.c(paramInt);
      }
      if (this.jdField_a_of_type_Oui != null) {
        this.jdField_a_of_type_Oui.a(paramInt, (View)localObject);
      }
      ...
      if (localObject == null)
      {
        ...
        if (a(paramInt) != null)
        {
          ...
          paramView = a();
          AIOUtils.catchedExceptionInReleaseV2("ReadInJoyCommentListAdapter", "first comment convertview is null", new NullPointerException((String)localObject));
        }
      }
      else
      {
        localObject = paramView;
        break;
        paramView = orx.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, a(paramInt), i, true, this);
        if (localObject != null) {
          break label409;
        }
        bjun.a("ReadInJoyCommentAdapter.create convertView");
      ...
      for (;;)
      {
        orx.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, (Container)localObject, paramView, this, paramInt, i, true);
        break;
  ...
  public void h()
  {
    ...
    if ((localObject instanceof ssm))
    {
      localObject = ((ssm)localObject).a().iterator();
      do
      {
      ...
      } while (!(localListAdapter instanceof ssq));
    }
  ...
  public void onCommentCreate(boolean paramBoolean, ouo paramouo, List<ouo> paramList, int paramInt)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Osv != null) {
        this.jdField_a_of_type_Osv.a(this.jdField_a_of_type_Ouu.a(paramInt));
      }
    ...
    if ((localBaseCommentData instanceof SubCommentData)) {
      paramouo = ((SubCommentData)localBaseCommentData).parentCommentId;
    }
    pkp.a().a(true, localBaseCommentData.rowKey, localBaseCommentData.commentId, localBaseCommentData.commentContent, localBaseCommentData.level, "onCommentSend", paramList.getInt("seq"), paramouo);
    return;
    QQToast.a(BaseApplication.getContext(), 1, amtj.a(2131711899), 0).a();
  }
  ...
  public void onCommentCreate(boolean paramBoolean1, ouo paramouo, boolean paramBoolean2, List<ouo> paramList, int paramInt)
  {
    ...
    this.c = 2;
    a(paramBoolean2);
    onCommentCreate(paramBoolean1, paramouo, paramList, paramInt);
  }
  
  public void onCommentDelete(int paramInt1, boolean paramBoolean, ouo paramouo, int paramInt2)
  {
    if ((!paramBoolean) || (this.jdField_a_of_type_Ouu == null)) {
      return;
    }
    if (!a(paramInt2))
    {
    ...
    if (paramInt1 == 1)
    {
      paramouo = this.jdField_a_of_type_Ouu.a(paramInt2);
      if ((paramouo != null) && (this.jdField_a_of_type_JavaUtilList != null))
      {
        this.jdField_a_of_type_JavaUtilList.clear();
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Osv.a(this.jdField_a_of_type_Ouu.a(paramInt2));
      return;
      if ((paramInt1 == 2) && (this.jdField_a_of_type_JavaUtilList != null))
      {
        ...
        {
          ouo localouo = (ouo)this.jdField_a_of_type_JavaUtilList.get(paramInt1);
          if ((localouo == null) || (localouo.jdField_a_of_type_Int != 0)) {}
          for (;;)
          {
            paramInt1 += 1;
            break;
            if ((paramouo != null) && (paramouo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData != null) && (localouo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData != null) && (TextUtils.equals(localouo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.commentId, ((SubCommentData)paramouo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData).parentCommentId))) {
              localouo.a();
            }
          }
        }
  ...
  public void onCommentListLoad(int paramInt1, boolean paramBoolean1, List<ouo> paramList, boolean paramBoolean2, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Owf != null) {
        this.jdField_a_of_type_Owf.onCommentListLoad(paramInt1, paramBoolean1, paramList, paramBoolean2, paramInt2, paramInt3);
      }
      if (this.jdField_a_of_type_Osv == null) {
        break;
      }
      long l = this.jdField_a_of_type_Ouu.a(this.c);
      this.jdField_a_of_type_Osv.a(l);
  ...
  public void onCommentReply(boolean paramBoolean, ouo paramouo)
  {
    ...
    do
    {
      ...
      QQToast.a(BaseApplication.getContext(), 2, amtj.a(2131712236), 0).a();
      if (this.jdField_a_of_type_JavaUtilList != null)
      {
        int i = 0;
        if (i < this.jdField_a_of_type_JavaUtilList.size())
        {
          localObject = (ouo)this.jdField_a_of_type_JavaUtilList.get(i);
          if ((localObject == null) || (((ouo)localObject).jdField_a_of_type_Int != 0) || (((ouo)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData == null)) {}
          for (;;)
          {
            i += 1;
            break;
            if (TextUtils.equals(((ouo)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData.commentId, ((SubCommentData)paramouo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataBaseCommentData).parentCommentId)) {
              ((ouo)localObject).a();
            }
          }
        }
      ...
      if (this.jdField_a_of_type_Osv != null) {
        this.jdField_a_of_type_Osv.a(this.jdField_a_of_type_Ouu.a(this.c));
      }
    ...
    pkp.a().a(true, localBaseCommentData.rowKey, localBaseCommentData.commentId, localBaseCommentData.commentContent, localBaseCommentData.level, "onCommentSend", ((Bundle)localObject).getInt("seq"), paramouo);
    return;
