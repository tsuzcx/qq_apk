...
public class ayew
  extends amar
{
  public ayew(UniteSearchActivity paramUniteSearchActivity) {}
  ...
  public void a(String paramString, int paramInt, List<AssociateSearchWordsFragment.AssociateItem> paramList, List<DynamicAssociationWord.SuggestUrlItem> paramList1, DynamicAssociationWord.SuggestUrlItem paramSuggestUrlItem)
  {
    if (paramString.equals(this.a.f))
    {
      ...
      aynt.a(null, new ReportModelDC02528().module("all_result").action("exp_thinkword_list").ver1(this.a.a()).ver2(aynt.a(this.a.jdField_c_of_type_Int)).ver3(UniteSearchActivity.jdField_d_of_type_JavaLangString).ver6(UniteSearchActivity.jdField_c_of_type_JavaLangString).ver7("{experiment_id:" + aynt.b + "}").session_id(UniteSearchActivity.e).ver4(localStringBuilder.toString()));
    }
  }
  ...
  public void a(String paramString1, boolean paramBoolean1, String paramString2, byte[] paramArrayOfByte, boolean paramBoolean2, List<ayjf> paramList, List<ayjk> paramList1)
  {
    for (;;)
    {
      ...
      continue;
      label125:
      if ((paramList.size() > 0) && ((((ayjf)paramList.get(0)).jdField_a_of_type_JavaLangString.equals(alpo.a(2131716284))) || ((((ayjf)paramList.get(0)).jdField_a_of_type_JavaUtilList != null) && (((ayjf)paramList.get(0)).jdField_a_of_type_JavaUtilList.size() == 0)))) {
        paramList.remove(0);
      }
      this.a.jdField_c_of_type_AndroidViewView.setVisibility(0);
      this.a.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
