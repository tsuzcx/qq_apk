...
public class abxf
  extends akge
{
  public abxf(QQSettingSettingActivity paramQQSettingSettingActivity) {}
  ...
  protected void a(Object paramObject)
  {
    ...
    if (paramObject == null)
    {
      ...
      {
        bool2 = bool1;
        if ((paramObject instanceof akcn)) {
          bool2 = ((akcn)paramObject).b;
        }
      }
      paramObject = this.a.findViewById(2131373196);
      if (paramObject != null)
      {
        if (!bool2) {
          break label190;
    ...
    for (;;)
    {
      ...
      {
        paramObject = (akco)this.a.app.getManager(102);
  ...
  public void a(boolean paramBoolean, int paramInt, String paramString)
  {
    ...
    bcql.a(this.a.getApplicationContext(), paramString, 0).b(this.a.getTitleBarHeight());
  }
