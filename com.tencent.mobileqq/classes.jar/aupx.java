  ...
  implements atqq
{
  ...
  public aupx(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString, int paramInt)
  {
  ...
  public void b(atqr paramatqr)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ReceiptMsgManager", 2, "upload receipt msg pack failed, result.errStr=" + paramatqr.b + ",result.errStr=" + paramatqr.jdField_a_of_type_JavaLangString + " uniseq=" + this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq);
    }
