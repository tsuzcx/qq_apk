...
public class awce
  extends awcj
{
  public awce(alxk paramalxk, String paramString)
  {
    ...
    catch (Exception paramawcg)
    {
      try
      {
        if (paramClass.getName().equals(MessageRecord.class.getName()))
        {
          ...
          paramawcg = paramCursor.getString(paramCursor.getColumnIndex("extStr"));
          int k = paramCursor.getInt(paramCursor.getColumnIndex("istroop"));
          MessageRecord localMessageRecord = ayvw.a(i, paramClass, j, paramawcg, k);
          localMessageRecord.msgData = paramClass;
          localMessageRecord._id = l1;
          localMessageRecord.extLong = j;
          localMessageRecord.extStr = paramawcg;
