...
public class bngu
{
  public static int a(EditText paramEditText, ArrayList<ResultRecord> paramArrayList, List<bngt> paramList, int paramInt)
  {
    int i;
    ...
    for (;;)
    {
      ...
      bngt localbngt = new bngt();
      if (!TextUtils.isEmpty(((ResultRecord)localObject).b)) {}
      for (localbngt.jdField_a_of_type_JavaLangString = ((ResultRecord)localObject).b;; localbngt.jdField_a_of_type_JavaLangString = ((ResultRecord)localObject).jdField_a_of_type_JavaLangString) {
        try
        {
          long l = Long.valueOf(((ResultRecord)localObject).jdField_a_of_type_JavaLangString).longValue();
          localbngt.jdField_a_of_type_Long = l;
          if ((localbngt.jdField_a_of_type_JavaLangString == null) || (localbngt.jdField_a_of_type_Long == 0L)) {
            break label15;
          }
          i = paramInt;
          if (paramList == null) {
          ...
          paramList.add(localbngt);
          localObject = "@" + localbngt.jdField_a_of_type_JavaLangString + " ";
          i = paramInt;
  ...
  public static int a(CharSequence paramCharSequence, int paramInt1, int paramInt2, List<bngt> paramList, int paramInt3, int paramInt4, String paramString)
  {
  ...
  public static SystemEmoticonPanel a(Context paramContext, EditText paramEditText)
  {
    try
    {
      paramContext = new SystemEmoticonPanel(paramContext, new bngv(paramEditText));
      return paramContext;
    }
  ...
  public static String a(EditText paramEditText, List<bngt> paramList)
  {
    if (paramEditText != null)
    {
      paramEditText = a(paramEditText);
      if (!TextUtils.isEmpty(paramEditText)) {
        return a(paramEditText, paramList).replaceAll(anzj.a(2131704691), anzj.a(2131704695)).replaceAll(anzj.a(2131704692), "/MM");
      }
    }
    return "";
  }
  ...
  public static String a(String paramString, List<bngt> paramList)
  {
  ...
  public static void a(String paramString, int paramInt, EditText paramEditText)
  {
    ...
    Editable localEditable = behe.c.newEditable(paramEditText.getText());
  ...
  public static boolean a(String paramString1, boolean paramBoolean, List<bngt> paramList, int paramInt1, int paramInt2, String paramString2)
  {
    if (((a(paramInt1, paramInt2, paramString2)) || (!paramBoolean)) && (paramList != null))
    {
      ...
      {
        paramString2 = (bngt)paramList.get(paramInt1);
  ...
  public static String b(String paramString, List<bngt> paramList)
  {
    String str;
    if (paramString == null) {
      str = null;
    ...
    for (;;)
    {
      ...
      bngt localbngt = (bngt)localIterator.next();
      str = localbngt.jdField_a_of_type_JavaLangString;
      paramList = str;
      if (str == null) {
        paramList = localbngt.jdField_a_of_type_Long + "";
      }
      paramList = paramList.replace("%", "%25").replace(",", "%2C").replace("}", "%7D");
      paramList = "@{uin:" + localbngt.jdField_a_of_type_Long + ",nick:" + paramList + "}";
      str = "@" + localbngt.jdField_a_of_type_JavaLangString;
      if ((!TextUtils.isEmpty(localbngt.jdField_a_of_type_JavaLangString)) && (paramString.contains(str))) {
