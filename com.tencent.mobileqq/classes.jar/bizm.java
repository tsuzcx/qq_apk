  ...
  extends AutoCompleteTextView
{
  ...
  public bizm(NewStyleDropdownView paramNewStyleDropdownView, Context paramContext)
  {
    super(paramContext);
    setId(526);
  ...
  public bizm(NewStyleDropdownView paramNewStyleDropdownView, Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  public bizm(NewStyleDropdownView paramNewStyleDropdownView, Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          try
          {
            ((ListView)localObject2).setPadding(agej.a(13.0F, getResources()), 0, agej.a(13.0F, getResources()), 0);
      ...
      if ((localThrowable.getChildAt(j) != null) && ((localThrowable.getChildAt(j) instanceof LoginPopupRightMaskView)))
      {
        ...
        if (i == 0)
        {
          ...
          FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(agej.a(20.0F, getResources()), -1);
        ...
        localObject4 = new FrameLayout.LayoutParams(-1, agej.a(14.0F, getResources()));
