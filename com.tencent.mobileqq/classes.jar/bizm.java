  ...
  implements bizg
{
  ...
  private bizn jdField_a_of_type_Bizn;
  
  public bizm(bizh parambizh)
  {
    bize localbize = parambizh.a;
    if (localbize != null) {
      localbize.setNetTransportEventListener("sig_check", this);
    }
    this.jdField_a_of_type_Bizh = parambizh;
  }
  
  public void a(bizn parambizn)
  {
    this.jdField_a_of_type_Bizn = parambizn;
  }
  ...
  public void a(Object paramObject1, Object paramObject2)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return;
          } while (this.jdField_a_of_type_Bizh == null);
          paramObject1 = this.jdField_a_of_type_Bizh.a;
    ...
    try
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Bizn.a(paramObject1.toString());
        return;
      }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        l2 = l1;
        continue;
        localObject2 = this.jdField_a_of_type_Bizh.a;
        if (localObject2 == null) {
          continue;
        }
        localObject1 = paramString.toByteArray();
        localObject4 = ((bize)localObject2).getCodec("sig_check");
        paramString = (String)localObject1;
        if (localObject4 != null) {
          paramString = ((bizf)localObject4).encode(localObject1);
        }
        ((bize)localObject2).send(paramString);
        return;
      }
      try
      {
