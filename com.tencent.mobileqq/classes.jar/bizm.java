...
public class bizm
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = alpo.a(2131712292);
  }
  ...
  {
    Intent localIntent = new Intent();
    localIntent.putExtra("key_left_tab_title", paramContext.getString(2131718026));
    localIntent.putExtra("key_rihgt_tab_title", paramContext.getString(2131718107));
  ...
  @NonNull
  private static Intent a(bizt parambizt, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambizt);
  ...
  private static Intent a(bizt parambizt, String paramString)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambizt);
  ...
  public static SurfaceView a(Context paramContext, String paramString)
  {
    try
    {
      if (f())
      {
        bfhq.a().a(jdField_b_of_type_JavaLangString, 1);
        return null;
      }
      try
      {
  ...
  {
    bdcd.a(paramActivity, 230).setMessage(2131718614).setPositiveButton(2131718137, new bizn()).setNegativeButton(2131720079, paramOnClickListener).show();
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, bizt parambizt, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    Intent localIntent = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void a(Activity paramActivity, bizt parambizt, int paramInt)
  {
    c(paramActivity, parambizt, null, paramInt);
  }
  
  public static void a(Activity paramActivity, bizt parambizt, int paramInt, Bundle paramBundle)
  {
    Intent localIntent = new Intent();
    localIntent.putExtras(paramBundle);
    a(localIntent, parambizt);
  ...
  public static void a(Activity paramActivity, bizt parambizt, int paramInt, String paramString, long paramLong1, long paramLong2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambizt);
    ...
    QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, localIntent, 0);
  }
  
  public static void a(Activity paramActivity, bizt parambizt, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2, int paramInt9, int paramInt10, boolean paramBoolean3)
  {
    a(paramActivity, parambizt, paramInt1, paramString1, paramString2, paramString3, paramString4, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramString5, paramInt8, paramBundle, paramBoolean1, paramBoolean2, paramInt9, paramInt10, paramBoolean3, null);
  }
  ...
  public static void a(Activity paramActivity, bizt parambizt, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, Bundle paramBundle1, boolean paramBoolean1, boolean paramBoolean2, int paramInt9, int paramInt10, boolean paramBoolean3, Bundle paramBundle2)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt2 = 1;; paramInt2 = 0)
      {
        ...
        QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, paramString1, paramInt1, null, true);
        return;
      }
    }
  }
  ...
  {
    a(paramActivity, parambizt, paramInt1, paramString1, paramString2, paramString3, paramString4, paramInt2, paramBoolean1, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramString5, paramInt8, paramInt9, paramBoolean2, paramString6, paramBoolean3, null);
  }
  ...
  public static void a(Activity paramActivity, bizt parambizt, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, boolean paramBoolean1, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, int paramInt9, boolean paramBoolean2, String paramString6, boolean paramBoolean3, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt7 = 1;; paramInt7 = 0)
      {
        ...
        QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, paramString1, paramInt1, null, paramBoolean2);
        return;
      }
    }
  }
  
  public static void a(Activity paramActivity, bizt parambizt, long paramLong, int paramInt)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambizt);
  ...
  public static void a(Activity paramActivity, bizt parambizt, Intent paramIntent)
  {
    a(paramActivity, parambizt, paramIntent, -1);
  }
  
  public static void a(Activity paramActivity, bizt parambizt, Intent paramIntent, int paramInt)
  {
    a(paramIntent, parambizt);
    if (paramInt >= 0) {
    ...
    for (;;)
    {
      ...
      QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, paramIntent, paramInt);
      return;
      paramIntent.putExtra("bNeedCallBack", false);
    }
  }
  
  public static void a(Activity paramActivity, bizt parambizt, Intent paramIntent, int paramInt, DialogInterface.OnDismissListener paramOnDismissListener)
  {
    QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, paramIntent, paramInt, paramOnDismissListener, true);
  }
  
  public static void a(Activity paramActivity, bizt parambizt, Intent paramIntent, int paramInt, boolean paramBoolean)
  {
    a(paramIntent, parambizt);
    if (paramInt >= 0) {
      paramIntent.putExtra("bNeedCallBack", true);
    ...
    {
      QzonePluginProxyActivity.a(paramIntent, "com.qzone.misc.web.QZoneTranslucentActivity");
      QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, paramIntent, paramInt, null, paramBoolean);
      return;
      paramIntent.putExtra("bNeedCallBack", false);
    }
  }
  
  public static void a(Activity paramActivity, bizt parambizt, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(parambizt, "com.qzone.album.ui.activity.QZonePersonalAlbumSelectActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void a(Activity paramActivity, bizt parambizt, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt)
  {
    paramBaseBusinessAlbumInfo = a(parambizt, paramBaseBusinessAlbumInfo);
    QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, paramBaseBusinessAlbumInfo, paramInt);
  }
  
  public static void a(Activity paramActivity, bizt parambizt, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt, String paramString)
  {
    paramBaseBusinessAlbumInfo = a(parambizt, paramBaseBusinessAlbumInfo);
  ...
  public static void a(Activity paramActivity, bizt parambizt, CoverCacheData paramCoverCacheData, String paramString, int paramInt)
  {
    parambizt = bizq.a(parambizt.jdField_a_of_type_JavaLangString, paramString, "usersummary", true);
    paramCoverCacheData = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramCoverCacheData);
    paramCoverCacheData.putExtra("url", parambizt);
    if (bect.a.containsKey("Qzone")) {
      paramCoverCacheData.putExtra("insertPluginsArray", new String[] { "Qzone" });
    }
    paramCoverCacheData.setData(Uri.parse(parambizt));
    c(paramCoverCacheData);
    paramActivity.startActivityForResult(paramCoverCacheData, paramInt);
  }
  
  public static void a(Activity paramActivity, bizt parambizt, Long paramLong, int paramInt1, int paramInt2, int paramInt3, asor paramasor)
  {
    paramLong = a(paramActivity, paramLong, paramInt1);
    a(paramLong, parambizt);
    a(paramLong, paramInt2);
    QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, paramLong, paramInt3, paramasor);
  }
  
  public static void a(Activity paramActivity, bizt parambizt, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    a(paramActivity, parambizt, paramLong, paramInt1, paramBoolean, paramInt2, 5);
  }
  
  public static void a(Activity paramActivity, bizt parambizt, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2, int paramInt3)
  {
    ...
    QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, paramLong, paramInt2);
  }
  
  @Deprecated
  public static void a(Activity paramActivity, bizt parambizt, String paramString, int paramInt)
  {
    if (TextUtils.isEmpty(paramString)) {
      return;
    }
  ...
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, int paramInt, Bundle paramBundle, String paramString2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambizt);
  ...
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, int paramInt, String paramString2)
  {
  ...
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, long paramLong, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    Intent localIntent = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, localIntent, paramInt1);
  }
  
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, long paramLong, String paramString2, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, long paramLong, String paramString2, int paramInt, String paramString3, boolean paramBoolean)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_OPEN_VIP");
    a(localIntent, parambizt);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.module.vipcomponent.ui.DiamondYellowOpenActivity");
  ...
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, long paramLong, String paramString2, String paramString3, int paramInt)
  {
    Object localObject;
    if (paramActivity == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((Intent)localObject).putExtra("userId", parambizt.jdField_a_of_type_JavaLangString);
        ((Intent)localObject).putExtra("userName", parambizt.jdField_b_of_type_JavaLangString);
  ...
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, String paramString2, int paramInt)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambizt);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.detail.ui.activity.QzoneDetailActivity");
  ...
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambizt);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.detail.ui.activity.QzoneDetailActivity");
    ...
    QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, localIntent, paramInt2);
  }
  
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3)
  {
    ...
    parambizt = paramString1;
    if (!TextUtils.isEmpty(paramString3)) {
      parambizt = paramString1 + "&source=" + paramString3;
    }
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "forwardToQunAlbumList:" + parambizt);
    }
    paramString1.putExtra("url", parambizt);
    if (bect.a.containsKey("Qzone")) {
      paramString1.putExtra("insertPluginsArray", new String[] { "Qzone" });
    }
    paramString1.setData(Uri.parse(parambizt));
    c(paramString1);
    paramActivity.startActivityForResult(paramString1, paramInt2);
  }
  
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, String paramString2, String paramString3, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    parambizt = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumPhotoList", "https://h5.qzone.qq.com/groupphoto/inqq/photo/{QUN_ID}/{ALBUM_ID}?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1).replace("{ALBUM_ID}", paramString2);
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    paramString1.putExtra("url", parambizt);
    if (bect.a.containsKey("Qzone")) {
  ...
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, Bundle paramBundle)
  {
    a(paramActivity, parambizt, paramString1, paramString2, paramString3, paramString4, paramInt, paramBundle, true, false);
  }
  
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, String paramString2, String paramString3, String paramString4, long paramLong, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, String paramString2, ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<Long> paramArrayList, int paramInt, String paramString3, String paramString4)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_RESHIP_FROM_QUN_AIO_TO_QUN");
    a(localIntent, parambizt);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
  ...
  public static void a(Activity paramActivity, bizt parambizt, String paramString1, String paramString2, boolean paramBoolean, int paramInt)
  {
    parambizt = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunFeed", "https://h5.qzone.qq.com/groupphoto/inqq/recent/{QUN_ID}/groupphoto?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1);
    ...
    paramString1.putExtra("source_name", BaseApplicationImpl.getContext().getString(2131718329));
    paramString1.setData(Uri.parse(parambizt));
  ...
  public static void a(Activity paramActivity, bizt parambizt, boolean paramBoolean, String paramString1, String paramString2, int paramInt1, String paramString3, String paramString4, long paramLong1, long paramLong2, int paramInt2)
  {
  ...
  public static void a(Activity paramActivity, bizt parambizt, boolean paramBoolean, String paramString1, String paramString2, int paramInt1, ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<Long> paramArrayList3, ArrayList<Long> paramArrayList4, int paramInt2)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_QUOTE_FROM_AIO");
    a(localIntent, parambizt);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
  ...
  public static void a(Activity paramActivity, String paramString1, int paramInt1, int paramInt2, long paramLong, String paramString2, String paramString3, String paramString4, int paramInt3, int paramInt4)
  {
    ...
    a(paramString1, localbizt);
    QzonePluginProxyActivity.a(paramString1, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
    QzonePluginProxyActivity.a(paramActivity, localbizt.jdField_a_of_type_JavaLangString, paramString1, paramInt3);
  }
  ...
  {
    bizt localbizt = bizt.a();
    localbizt.jdField_a_of_type_JavaLangString = paramString2;
    ...
    b(paramActivity, localbizt, paramString2, -1);
  }
  ...
  public static void a(Context paramContext, bizt parambizt)
  {
    parambizt = QzoneConfig.getInstance().getConfig("H5Url", "QzonePictureSettingPage", "https://h5.qzone.qq.com/image/setting/imageSetting?_wv=3&_proxy=1&uin={uin}").replace("{uin}", String.valueOf(parambizt.jdField_a_of_type_JavaLangString)).replace("{host_uin}", parambizt.jdField_a_of_type_JavaLangString).replace("{UIN}", String.valueOf(parambizt.jdField_a_of_type_JavaLangString)).replace("{HOST_UIN}", parambizt.jdField_a_of_type_JavaLangString);
    if (!bhos.b(parambizt).containsKey("_wv")) {
      bhos.a(parambizt, "_wv", "5");
    }
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "jump qzone setting URL:" + parambizt);
    }
    Intent localIntent = new Intent(BaseApplication.getContext(), QQBrowserActivity.class);
    a(localIntent);
    localIntent.putExtra("url", parambizt);
    ...
    localIntent.setData(Uri.parse(parambizt));
    localIntent.addFlags(268435456);
    c(localIntent);
    paramContext.startActivity(localIntent);
  }
  
  public static void a(Context paramContext, bizt parambizt, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    a(paramContext, parambizt, paramString, paramInt1, paramInt2, paramInt3, null, null, false);
  }
  
  public static void a(Context paramContext, bizt parambizt, String paramString, int paramInt1, int paramInt2, int paramInt3, asor paramasor, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      QzonePluginProxyActivity.a(paramContext, parambizt.jdField_a_of_type_JavaLangString, localIntent, paramInt2, paramasor);
      return;
      i = 0;
      break;
      label107:
  ...
  public static void a(Context paramContext, bizt parambizt, String paramString1, int paramInt1, int paramInt2, asor paramasor, String paramString2, boolean paramBoolean)
  {
    ...
    QzonePluginProxyActivity.a(paramContext, parambizt.jdField_a_of_type_JavaLangString, paramString1, paramInt1, paramasor);
  }
  
  public static void a(Context paramContext, bizt parambizt, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambizt);
    localIntent.putExtra("startup_sceneid", 4);
    ...
    try
    {
      ...
      for (paramString1 = paramBundle;; paramString1 = new Bundle())
      {
        ...
        QzonePluginProxyActivity.a(paramContext, parambizt.jdField_a_of_type_JavaLangString, localIntent, paramInt, null, paramBoolean1);
        return;
      }
      return;
    }
  ...
  public static void a(Intent paramIntent, bizt parambizt)
  {
    paramIntent.putExtra("qzone_uin", parambizt.jdField_a_of_type_JavaLangString);
    paramIntent.putExtra("nickname", parambizt.jdField_b_of_type_JavaLangString);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, bizt parambizt, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2, boolean paramBoolean3, boolean paramBoolean4, String paramString3, boolean paramBoolean5, String paramString4, String paramString5, boolean paramBoolean6, boolean paramBoolean7, boolean paramBoolean8, boolean paramBoolean9, String paramString6, boolean paramBoolean10, boolean paramBoolean11, boolean paramBoolean12, int paramInt2, boolean paramBoolean13, Bundle paramBundle)
  {
    ...
    if (paramBoolean12)
    {
      ...
      if (paramBoolean2)
      {
        parambizt = aepf.a(aljq.bk);
        paramQQAppInterface.putBoolean("support_photo_merge", true);
        paramQQAppInterface.putString("qcamera_photo_filepath", parambizt);
        ...
        paramQQAppInterface.putString("pic_confirm_text", alpo.a(2131712296));
      }
    ...
    for (;;)
    {
      paramActivity.overridePendingTransition(2130772299, 2130772295);
      return;
      ...
      break;
      label387:
      bdcd.a(paramActivity, 230).setMessage(alpo.a(2131712294)).setPositiveButton(2131694951, new bizp()).show();
    }
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, PublishMoodInfo paramPublishMoodInfo, Intent paramIntent, int paramInt, boolean paramBoolean)
  {
    ...
    bjao.a(paramQQAppInterface, paramActivity, localBundle, null, paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ServiceConnection paramServiceConnection)
  {
    ...
    localbimp.jdField_d_of_type_JavaLangString = "QQ空间";
    localbimp.jdField_a_of_type_JavaLangString = paramQQAppInterface.getCurrentAccountUin();
    localbimp.jdField_e_of_type_JavaLangString = "com.qzone.publish.business.publishqueue.PublishQueueService";
    localbimp.jdField_a_of_type_AndroidContentIntent = localIntent;
  ...
  public static void a(QQAppInterface paramQQAppInterface, asor paramasor)
  {
    ThreadManager.post(new QZoneHelper.8(paramQQAppInterface, paramasor), 8, null, false);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, asor paramasor, boolean paramBoolean)
  {
    if ((paramQQAppInterface == null) || (c())) {
      return;
    }
    ...
    {
      azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8005E9C", "0X8005E9C", 1, 0, "", "", "", "");
      aznh.a().a("actQZLoadHitRateRed", true);
    }
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        try
        {
          ...
          for (;;)
          {
            ((Intent)localObject).putExtra("cpuNum", bdcb.b());
            ...
            if (!azjg.jdField_d_of_type_Boolean) {
              break label498;
            }
            if (QLog.isColorLevel()) {
              QLog.d("Perf", 2, "disable preload qzone process");
            }
            azjg.e = System.currentTimeMillis();
            return;
            if ("Leba".equals(paramString))
            {
              azmj.b(paramQQAppInterface, "CliOper", "", "", "0X8005E9C", "0X8005E9C", 1, 0, "", "", "", "");
              aznh.a().a("actQZLoadHitRateLeba", true);
              break;
            }
            if (!"FriendProfileCardActivity".equals(paramString)) {
              break;
            }
            aznh.a().a("actQZLoadHitRateProfile", true);
            break;
            QLog.d("QZoneHelper", 1, "preloadQzone is not allowed as crash frequently.");
            azmz.a(BaseApplicationImpl.getContext()).a(paramQQAppInterface.getCurrentAccountUin(), "actNoPreloadQzone", true, 0L, 0L, null, "");
            return;
        ...
        catch (Exception paramString)
        {
          ...
          paramString.jdField_a_of_type_Asor = paramasor;
          ...
          bimg.c(paramQQAppInterface.getApp(), paramString);
        }
      }
    }
  }
  ...
  public static void a(WebViewPlugin paramWebViewPlugin, becq parambecq, Activity paramActivity, String paramString1, String paramString2)
  {
    Intent localIntent = new Intent();
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
    localIntent.putExtra("startup_sceneid", 6);
    ...
    QzonePluginProxyActivity.a(paramActivity, paramString1, localIntent, a(paramWebViewPlugin, parambecq, 1));
  }
  ...
  public static void a(BaseApplication paramBaseApplication, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        localIntent.putExtra("cpuNum", bdcb.b());
    ...
    catch (Exception paramString2)
    {
      ...
      paramString2.jdField_a_of_type_JavaLangString = paramString1;
      paramString2.jdField_a_of_type_Asor = null;
      ...
      bimg.c(paramBaseApplication, paramString2);
    }
  }
  ...
  public static void a(String paramString, Context paramContext)
  {
    ...
    ((Intent)localObject).putExtra("source_name", BaseApplicationImpl.getContext().getString(2131718329));
  ...
  public static void a(String paramString1, ArrayList<String> paramArrayList1, int paramInt1, LbsDataV2.PoiInfo paramPoiInfo, String paramString2, String paramString3, ArrayList<String> paramArrayList2, HashMap<String, String> paramHashMap1, HashMap<String, String> paramHashMap2, String paramString4, int paramInt2)
  {
    ...
    bjmn.a().a("cmd.publishMixMood", paramString2, false);
  }
  ...
  public static void a(String paramString1, ArrayList<String> paramArrayList1, int paramInt1, ArrayList<String> paramArrayList2, int paramInt2, int paramInt3, String paramString2, boolean paramBoolean1, boolean paramBoolean2, int paramInt4, String paramString3)
  {
    ...
    bjmn.a().a("cmd.publishMoodForAll", localBundle, false);
  }
  ...
  {
    bjod.a(paramString1, paramInt1, paramString2, paramInt2);
  }
  ...
  public static void a(AppRuntime paramAppRuntime, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      bdal.a(BaseApplicationImpl.getContext(), "com.tencent.mobileqq:picture");
      ...
      bdal.a(BaseApplicationImpl.getContext(), "com.tencent.mobileqq:qzonevideo");
      bjdq.a((Context)localObject);
      if (!TextUtils.isEmpty(str))
      {
      ...
      {
        arof.c((String)localObject + File.separator + "qz_predownload_config.xml");
        arof.c((String)localObject + File.separator + "QZ_Per_Config.xml");
        arof.c((String)localObject + File.separator + "QZONE_UNREAD.xml");
      }
      localObject = bduw.a(Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "tencent" + File.separator + "MobileQQ" + File.separator + "trace");
      if (localObject != null) {
  ...
  public static void a(boolean paramBoolean, bizs parambizs)
  {
    if (!paramBoolean)
    {
      parambizs.a(false, true);
      return;
    }
    ThreadManager.postImmediately(new QZoneHelper.6(parambizs), null, true);
  }
  ...
  public static boolean a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    if (QzoneConfig.getInstance().getConfig("QZoneSetting", "aio2qzonedetail", 1) == 1)
    {
      ...
      QzonePluginProxyActivity.a(paramActivity, bizt.a().jdField_a_of_type_JavaLangString, paramString2, 0);
      if (QLog.isColorLevel()) {
    ...
    try
    {
      if (azib.a())
      {
        if ((paramContext instanceof FragmentActivity))
        {
          ...
          if (!bjdh.a((FragmentActivity)paramContext, ((FragmentActivity)paramContext).app)) {
            return false;
          }
        }
  ...
  {
    return bhpe.a(paramContext, paramString);
  }
  ...
  public static boolean a(String paramString, @NonNull Context paramContext)
  {
    if (Build.VERSION.SDK_INT < 26) {
      return bdhy.a(paramContext, new String[] { paramString });
    }
  ...
  {
    bdcd.a(paramActivity, 230).setMessage(2131718615).setPositiveButton(2131720079, paramOnClickListener).setNegativeButton(2131718137, new bizo()).show();
  }
  
  public static void b(Activity paramActivity, bizt parambizt, int paramInt)
  {
    parambizt = QzoneConfig.getInstance().getConfig("H5Url", "QzoneSettingMainPage", "https://h5.qzone.qq.com/qzone/setting?_wv=3&_proxy=1&uin={uin}").replace("{uin}", String.valueOf(parambizt.jdField_a_of_type_JavaLangString)).replace("{host_uin}", parambizt.jdField_a_of_type_JavaLangString).replace("{UIN}", String.valueOf(parambizt.jdField_a_of_type_JavaLangString)).replace("{HOST_UIN}", parambizt.jdField_a_of_type_JavaLangString);
    if (!bhos.b(parambizt).containsKey("_wv")) {
      bhos.a(parambizt, "_wv", "5");
    }
    if (QLog.isColorLevel()) {
  ...
  public static void b(Activity paramActivity, bizt parambizt, Intent paramIntent)
  {
    a(paramIntent, parambizt);
    QzonePluginProxyActivity.a(paramIntent, "com.qzone.misc.web.QZoneTranslucentActivity2");
    QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, paramIntent, 0);
  }
  
  public static void b(Activity paramActivity, bizt parambizt, Intent paramIntent, int paramInt)
  {
  ...
  public static void b(Activity paramActivity, bizt parambizt, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(parambizt, "com.qzone.album.business.photolist.activity.QZonePersonalPhotoListActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void b(Activity paramActivity, bizt parambizt, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt)
  {
    paramBaseBusinessAlbumInfo = a(parambizt, paramBaseBusinessAlbumInfo);
  ...
  public static void b(Activity paramActivity, bizt parambizt, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt, String paramString)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambizt);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.album.business.photolist.activity.QZonePersonalPhotoListActivity");
  ...
  public static void b(Activity paramActivity, bizt parambizt, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    a(paramActivity, parambizt, paramLong, paramInt1, paramBoolean, paramInt2, 12);
  }
  
  public static void b(Activity paramActivity, bizt parambizt, String paramString, int paramInt)
  {
    try
    {
      Intent localIntent = new Intent();
  ...
  public static void b(Activity paramActivity, bizt parambizt, String paramString1, long paramLong, String paramString2, int paramInt)
  {
  ...
  public static void b(Activity paramActivity, bizt parambizt, String paramString1, String paramString2, int paramInt)
  {
    parambizt = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumDetail", "https://h5.qzone.qq.com/groupphoto/inqq/detail/{QQ_URL}?_wv=3&_proxy=1").replace("{QQ_URL}", URLEncoder.encode(paramString1));
    paramString1 = new Intent(BaseApplication.getContext(), QQBrowserDelegationActivity.class);
    paramString1.putExtra("url", parambizt);
    paramString1.putExtra("fromQZone", true);
    paramString1.putExtra("injectrecommend", true);
  ...
  {
    if (!bdhy.a(paramQQAppInterface.getApp(), new String[] { paramString1 })) {
      return;
    }
    a(paramIntent, paramQQAppInterface, paramString2, paramBitmap);
    Thread.sleep(1000L);
    bdhy.a(paramQQAppInterface, paramIntent, paramString2, paramBitmap);
    Thread.sleep(1000L);
  }
  ...
  public static void b(WebViewPlugin paramWebViewPlugin, becq parambecq, Activity paramActivity, String paramString1, String paramString2)
  {
    paramString2 = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, paramString1, paramString2, a(paramWebViewPlugin, parambecq, 6));
  }
  ...
  public static void c(Activity paramActivity, bizt parambizt, int paramInt)
  {
    parambizt = new SimpleDateFormat("yyyyMM", Locale.getDefault()).format(new Date());
    parambizt = QzoneConfig.getInstance().getConfig("H5Url", "QzoneShuoshuoDailyCalendar", "https://h5.qzone.qq.com/v2/shuoshuo-daily/calendar/{date}?_wv=16777216").replace("{date}", parambizt).replace("{DATE}", parambizt);
    if (!bhos.b(parambizt).containsKey("_wv")) {
      bhos.a(parambizt, "_wv", "1027");
    }
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "jump qzone ShuoshuoDailyCalendar URL:" + parambizt);
    }
    Intent localIntent = new Intent(BaseApplication.getContext(), QQBrowserActivity.class);
    a(localIntent);
    localIntent.putExtra("url", parambizt);
  ...
  public static void c(Activity paramActivity, bizt parambizt, Intent paramIntent, int paramInt)
  {
    Intent localIntent = paramIntent;
    if (paramIntent == null) {
      localIntent = new Intent();
  ...
  public static void c(Activity paramActivity, bizt parambizt, Bundle paramBundle, int paramInt)
  {
    bjmn.a().a("cmd.cancelKillPictureProcess", null, false);
    Intent localIntent = a(parambizt, "com.qzone.preview.QzonePictureViewer");
    localIntent.putExtras(paramBundle);
    localIntent.putExtra("fromQZone", false);
    QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, localIntent, paramInt, null, false);
  }
  
  public static void c(Activity paramActivity, bizt parambizt, String paramString, int paramInt)
  {
    ...
    localIntent.putExtra("key_title", alpo.a(2131712291));
    localIntent.putExtra("key_desc", "");
    localIntent.putExtra("key_need_save_draft", false);
    QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void c(Activity paramActivity, bizt parambizt, String paramString1, String paramString2, int paramInt)
  {
    if (TextUtils.isEmpty(paramString1)) {
      return;
    }
    parambizt = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumSelect", "https://h5.qzone.qq.com/groupphoto/inqq/album/{QUN_ID}/select?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1);
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    paramString1.putExtra("url", parambizt);
    if (bect.a.containsKey("Qzone")) {
  ...
  public static void c(Context paramContext, String paramString)
  {
    ...
    a((Activity)paramContext, bizt.a(), localIntent);
  }
  ...
  private static void c(Bitmap paramBitmap, @NonNull QQAppInterface paramQQAppInterface, String paramString1, long paramLong, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      if (Build.VERSION.SDK_INT < 26)
      {
        ...
        bdhy.a(paramQQAppInterface, b(paramQQAppInterface, paramString1, paramLong), paramString2, paramBitmap);
        Thread.sleep(1000L);
        if (bdix.a(paramQQAppInterface.getApplication(), new String[] { paramString1 }))
        {
          bfhq.a().a(2131691368);
          return;
        }
  ...
  public static void d(Activity paramActivity, bizt parambizt, Bundle paramBundle, int paramInt)
  {
    bjmn.a().a("cmd.cancelKillPictureProcess", null, false);
    Intent localIntent = a(parambizt, "com.qzone.preview.QzonePictureViewer");
    localIntent.putExtras(paramBundle);
  ...
  public static void d(Activity paramActivity, bizt parambizt, String paramString, int paramInt)
  {
    parambizt = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunPassiveFeed", "https://h5.qzone.qq.com/groupphoto/inqq/relatedme/{QUN_ID}/{UIN}?_wv=3&_proxy=1").replace("{QUN_ID}", paramString).replace("{UIN}", parambizt.jdField_a_of_type_JavaLangString);
    paramString = new Intent(BaseApplication.getContext(), QQBrowserDelegationActivity.class);
    paramString.putExtra("url", parambizt);
    ...
    paramString.putExtra("source_name", BaseApplicationImpl.getContext().getString(2131718329));
    paramString.setData(Uri.parse(parambizt));
  ...
  public static void e(Activity paramActivity, bizt parambizt, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(parambizt, "com.qzone.album.business.dlna.activity.DLNAActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, parambizt.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  ...
  public static void f(Activity paramActivity, bizt parambizt, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = new Intent();
