...
public class bghd
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    MessageForGrayTips localMessageForGrayTips = (MessageForGrayTips)bcsa.a(-2043);
    ...
    if (paramTroopTipsEntity.highlightNum != 0) {
      bgmf.a(localMessageForGrayTips, paramTroopTipsEntity.highlightItems);
    }
    if (paramTroopTipsEntity.optShowLatest == 1) {
      localMessageForGrayTips.shmsgseq = 0L;
    }
    if (!anyv.a(paramQQAppInterface, localMessageForGrayTips, false))
    {
      if (QLog.isColorLevel()) {
      ...
      if (!((bgiy)paramQQAppInterface.getManager(QQManagerFactory.TROOP_BIND_PUBACCOUNT_MANAGER)).a(paramTroopTipsEntity.troopUin))
      {
        bffl localbffl = new bffl();
        Object localObject1 = new bffl();
        ((bffl)localObject1).a.a(4, localMessageForGrayTips.shmsgseq, localMessageForGrayTips.uniseq);
        localbffl.a((bffl)localObject1);
        localMessageForGrayTips.mMessageInfo = ((bffl)localObject1);
        ((awzf)paramQQAppInterface.getManager(QQManagerFactory.TROOPINFO_MANAGER)).a(paramTroopTipsEntity.troopUin, localbffl);
        Object localObject2 = new acmb(paramQQAppInterface);
        localObject1 = ((acmb)localObject2).jdField_a_of_type_Aoxz;
        localObject2 = ((acmb)localObject2).jdField_a_of_type_JavaUtilMap;
        localObject1 = (RecentUser)((aoxz)localObject1).findRecentUserByUin(paramTroopTipsEntity.troopUin, 1);
        int i = localbffl.b(paramQQAppInterface, true, paramTroopTipsEntity.troopUin);
        if (i >= ((RecentUser)localObject1).msgType)
        {
          ((RecentUser)localObject1).msgType = i;
          ((RecentUser)localObject1).msg = bfzj.a(paramQQAppInterface, paramTroopTipsEntity.troopUin, localbffl, ((RecentUser)localObject1).msg, localMessageForGrayTips, true);
          ((Map)localObject2).put(acnh.a(paramTroopTipsEntity.troopUin, 1), localObject1);
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    ((aoep)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER)).notifyUI(61, true, new Object[] { paramString, str, Boolean.valueOf(false) });
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong)
  {
    ...
    String str = ((Resources)localObject).getString(2131697249);
    localObject = ((Resources)localObject).getString(2131697245);
    ...
    for (String str = "";; str = paramString1)
    {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty(paramString1)) {
          bglm.a(paramQQAppInterface, paramString1, i);
        }
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, bghf parambghf, boolean paramBoolean)
  {
    if ((paramQQAppInterface == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)))
    {
      if (QLog.isColorLevel())
      {
        parambghf = new StringBuilder().append("checkIdentity error. app null: ");
      ...
      {
        parambghf = parambghf.append(String.valueOf(paramBoolean)).append(", troopUin: ");
        paramQQAppInterface = paramString1;
        if (TextUtils.isEmpty(paramString1)) {
          paramQQAppInterface = "";
        }
        paramString1 = parambghf.append(paramQQAppInterface).append(", memberUin: ");
    ...
    ((TroopManager)paramQQAppInterface.getManager(QQManagerFactory.TROOP_MANAGER)).a(paramString1, paramString2, new bghe(paramString1, paramString2, paramBoolean, paramQQAppInterface, parambghf));
  }
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      ...
      Object localObject2 = auea.a(localFileInfo);
  ...
  private static void b(bghf parambghf, int paramInt)
  {
    if (parambghf == null) {
      return;
    }
    ...
    {
      parambghf.a(paramInt);
      return;
    }
    ThreadManager.getUIHandler().post(new HWTroopUtils.2(parambghf, paramInt));
  }
