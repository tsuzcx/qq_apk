...
public class azzo
{
  ...
  public static int a;
  private static azzt jdField_a_of_type_Azzt;
  ...
  private static final String c = ajjy.a(2131648914);
  
  static
  {
    jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(false);
    jdField_a_of_type_Azzt = new azzt();
  ...
  public static String a(Context paramContext, Uri paramUri, String paramString1, String paramString2)
  {
    ...
    //   28: aload_2
    //   29: aload_3
    //   30: invokestatic 149	azzo:a	(Landroid/content/Context;Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
  ...
  public static void a(Context paramContext, azzr paramazzr, acmv paramacmv)
  {
    jdField_a_of_type_Azzt.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    jdField_a_of_type_Azzt.jdField_a_of_type_Acmv = paramacmv;
    paramazzr.a(paramacmv);
    paramazzr.a(new azzq());
  }
  ...
  {
    if ((paramSessionInfo.jdField_a_of_type_Int != 1) && (paramSessionInfo.jdField_a_of_type_Int != 3000) && (paramSessionInfo.jdField_a_of_type_Int != 0) && (!akbm.d(paramSessionInfo.jdField_a_of_type_Int)))
    {
    ...
    paramViewGroup.setOnDragListener(new azzp(localImageView, localColorDrawable1, paramViewGroup, localColorDrawable2, paramContext, paramQQAppInterface, paramSessionInfo));
  }
  ...
  private static azzs b(Context paramContext, acju paramacju)
  {
    long l = 0L;
    Object localObject1;
    if ((paramacju instanceof admd))
    {
      localObject1 = apdq.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramacju.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
      l = bace.a((String)localObject1);
      paramacju = paramacju.jdField_a_of_type_AndroidViewView;
    }
    for (;;)
    {
      label76:
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1))
      {
        ...
        if ((paramacju instanceof admf))
        {
          localObject1 = apdq.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramacju.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
          l = bace.a((String)localObject1);
          paramacju = ((admf)paramacju).a;
          continue;
        }
        if ((paramacju instanceof adla))
        {
          localObject2 = (MessageForPic)paramacju.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject3 = ((MessageForPic)localObject2).getBiggestFilePath();
          String str = apck.a((String)localObject3);
          int i = bfcq.a((String)localObject3);
          localObject1 = ".jpg";
          if (i == 1001) {
            localObject1 = ".png";
          }
          for (;;)
          {
            ...
            if ((!bace.d(((MessageForPic)localObject2).getBiggestFilePath(), (String)localObject1)) || (TextUtils.isEmpty(str))) {
              break label76;
            }
            l = ((MessageForPic)localObject2).size;
            paramacju = ((adla)paramacju).a;
            break;
            if (i == 1005) {
              localObject1 = ".bmp";
            } else if (i == 2000) {
        ...
        if ((paramacju instanceof ados))
        {
          localObject2 = (MessageForShortVideo)paramacju.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject1 = ShortVideoUtils.a((MessageForShortVideo)localObject2, "mp4");
          l = ((MessageForShortVideo)localObject2).videoFileSize;
          paramacju = ((ados)paramacju).a;
          continue;
        }
        if ((paramacju instanceof adpi))
        {
          localObject2 = (MessageForShortVideo)paramacju.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject1 = ShortVideoUtils.a((MessageForShortVideo)localObject2, "mp4");
          l = ((MessageForShortVideo)localObject2).videoFileSize;
          paramacju = ((adpi)paramacju).a;
        }
      }
      else
      {
        ...
        return new azzs((File)localObject2, paramacju, ClipData.newUri(paramContext.getContentResolver(), "uri", (Uri)localObject1));
      }
      paramacju = null;
      localObject1 = null;
    }
  ...
  private static boolean b(DragEvent paramDragEvent, ImageView paramImageView, ColorDrawable paramColorDrawable1, ViewGroup paramViewGroup, ColorDrawable paramColorDrawable2, Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    paramImageView = new ProgressDialog(paramContext, 2131690181);
    paramImageView.setCancelable(true);
    paramImageView.setContentView(2131493818);
    ((TextView)paramImageView.findViewById(2131305861)).setText(ajjy.a(2131648913));
