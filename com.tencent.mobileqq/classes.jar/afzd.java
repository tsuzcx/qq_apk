...
public class afzd
  extends agqd
{
  public afzd(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
  ...
  public View a(ChatMessage paramChatMessage, aezf paramaezf, View paramView, BaseChatItemLayout paramBaseChatItemLayout, afce paramafce)
  {
    ...
    paramBaseChatItemLayout = (agql)paramaezf;
    paramaezf = paramView;
    if (paramView == null)
    {
      paramaezf = new ETTextView((Context)localObject);
      paramaezf.setTextColor(((Context)localObject).getResources().getColorStateList(2131167031));
      paramaezf.setLinkTextColor(((Context)localObject).getResources().getColorStateList(2131167024));
      paramaezf.setSpannableFactory(QQText.SPANNABLE_FACTORY);
      paramaezf.setMaxWidth(BaseChatItemLayout.e);
      paramaezf.setMovementMethod(LinkMovementMethod.getInstance());
      paramaezf.setId(2131364444);
      paramBaseChatItemLayout.d = paramaezf;
    }
    ...
    if ((paramChatMessage instanceof MessageForDeviceText))
    {
      ...
      if (paramChatMessage.msgtype == -2008) {
        if (paramChatMessage.isSend()) {
          paramBaseChatItemLayout.d.setText(((Context)localObject).getString(2131718033));
        }
      }
    }
    for (;;)
    {
      paramBaseChatItemLayout.d.setOnTouchListener(paramafce);
      paramBaseChatItemLayout.d.setOnLongClickListener(paramafce);
      if ((paramBaseChatItemLayout.d instanceof AnimationTextView)) {
        ((AnimationTextView)paramBaseChatItemLayout.d).onDoubleClick = new afzi(this);
      }
      return paramaezf;
      paramBaseChatItemLayout.d.setText(((Context)localObject).getString(2131718032));
      continue;
      if ("device_lock_msg".equals(paramView.extStr))
      {
        ...
        localObject = new afzg(this);
        afzh localafzh = new afzh(this);
        ((ClickableSpan)localObject).updateDrawState(paramChatMessage);
        localafzh.updateDrawState(paramChatMessage);
        paramView.setSpan(localObject, i, j + i, 33);
        paramView.setSpan(localafzh, k, m + k, 33);
  ...
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    paramContext = (aavk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(49);
  ...
  public void a(View paramView)
  {
    ...
    bfur.a(this.jdField_a_of_type_AndroidContentContext, 230, str1, str2, new afze(this, paramView), new afzf(this)).show();
  }
  ...
  public bgbb[] a(View paramView)
  {
    ...
    localbgaz.a(2131365216, amtj.a(2131702357), 2130838962);
