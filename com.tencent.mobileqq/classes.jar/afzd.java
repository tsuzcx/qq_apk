...
public class afzd
  extends atdk
{
  public afzd(AlbumListActivity paramAlbumListActivity) {}
  ...
  protected void c(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if ((paramBoolean) && (paramBundle != null) && ((paramBundle instanceof get_albumlist_num_rsp)))
    {
      ...
      if (this.a.jdField_a_of_type_Afze != null)
      {
        this.a.jdField_a_of_type_Afze.a(this.a.jdField_a_of_type_Long);
        this.a.jdField_a_of_type_Afze.a();
