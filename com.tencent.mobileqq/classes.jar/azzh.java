  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    localBundle.putString("file_send_path", azzg.a(this.a));
    ...
    do
    {
      ...
      paramView = "";
      if ((azzg.b(this.a) == null) || (azzg.b(this.a).equals(""))) {
        break label500;
      }
      localBundle.putString("struct_msg_video_info", azzg.b(this.a));
      ...
      try
      {
        localObject2 = new JSONObject(azzg.b(this.a));
      ...
      azqs.b((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", "", "0X8005C9A", "0X8005C9A", 0, 1, 0, ((StructMsgForGeneralShare)localObject1).uin, ((StructMsgForGeneralShare)localObject1).currentAccountUin, azzg.a(this.a), paramView);
    ...
    try
    {
      ...
      paramView.put("mobile_imei", bdgk.a());
      paramView.put("obj", "");
