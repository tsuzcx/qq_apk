...
public class bhkj
{
  ...
  private void a()
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        try
        {
          this.jdField_a_of_type_JavaLangObject = bhkp.a("android.telephony.MSimTelephonyManager", "getDefault", null, null);
          this.jdField_b_of_type_JavaLangObject = bhkp.a("android.telephony.MSimSmsManager", "getDefault", null, null);
          return;
        }
        ...
        try
        {
          this.jdField_a_of_type_ArrayOfY[0] = z.a(bhkq.a("isms"));
          this.jdField_a_of_type_ArrayOfY[1] = z.a(bhkq.a("isms2"));
          if (this.jdField_a_of_type_ArrayOfAndroidTelephonyTelephonyManager == null)
          {
            ...
            this.jdField_a_of_type_ArrayOfAndroidTelephonyTelephonyManager[0] = ((TelephonyManager)bhkp.a("android.telephony.TelephonyManager", "getDefault"));
            this.jdField_a_of_type_ArrayOfAndroidTelephonyTelephonyManager[1] = ((TelephonyManager)bhkp.a("android.telephony.TelephonyManager", "getSecondary"));
            return;
          }
        }
  ...
  public int a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramInt = ((Integer)bhkp.a(this.jdField_a_of_type_JavaLangObject, "getSimState", new Object[] { Integer.valueOf(paramInt) })).intValue();
        return paramInt;
      }
      catch (Exception localException1)
      {
      ...
      try
      {
        ...
        {
          paramInt = ((Integer)bhkp.a(localObject, "getIccState", new Object[] { Integer.valueOf(paramInt) })).intValue();
          return paramInt;
        }
      }
      catch (Exception localException2)
