  ...
  extends ailp
{
  ...
  private boolean a;
  public List<aukm> b = new ArrayList();
  public List<aiqb> c = new ArrayList();
  ...
  public aiga(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView)
  {
    ...
    this.jdField_a_of_type_Akim = new aigb(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Int = actn.a(44.0F, paramContext.getResources());
  ...
  public aigc a(int paramInt1, int paramInt2)
  {
    ...
    default: 
      return null;
    case 0: 
      localaukm = (aukm)this.b.get(paramInt2);
      localaigc = new aigc(this);
      localaigc.jdField_a_of_type_Aukm = localaukm;
      localaigc.jdField_a_of_type_Int = 0;
      return localaigc;
    case 4: 
      localaukm = ((aiqb)this.c.get(paramInt2)).jdField_a_of_type_Aukm;
      localaigc = new aigc(this);
      localaigc.jdField_a_of_type_Aukm = localaukm;
      localaigc.jdField_a_of_type_Int = 4;
      return localaigc;
    case 6: 
      localaukm = ((aiqb)this.d.get(paramInt2)).jdField_a_of_type_Aukm;
      localaigc = new aigc(this);
      localaigc.jdField_a_of_type_Aukm = localaukm;
      localaigc.jdField_a_of_type_Int = 6;
      return localaigc;
    case 2: 
      localaukm = ((aiqb)this.e.get(paramInt2)).jdField_a_of_type_Aukm;
      localaigc = new aigc(this);
      localaigc.jdField_a_of_type_Aukm = localaukm;
      localaigc.jdField_a_of_type_Int = 2;
      return localaigc;
    case 8: 
      localaukm = ((aiqb)this.f.get(paramInt2)).jdField_a_of_type_Aukm;
      localaigc = new aigc(this);
      localaigc.jdField_a_of_type_Aukm = localaukm;
      localaigc.jdField_a_of_type_Int = 8;
      return localaigc;
    }
    aukm localaukm = ((aiqb)this.g.get(paramInt2)).jdField_a_of_type_Aukm;
    aigc localaigc = new aigc(this);
    localaigc.jdField_a_of_type_Aukm = localaukm;
    localaigc.jdField_a_of_type_Int = 13;
    return localaigc;
  }
