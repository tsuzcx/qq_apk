  ...
  implements Manager
{
  ...
  private WeakReference<aigc> jdField_a_of_type_MqqUtilWeakReference;
  private WeakReference<aigd> b;
  
  public aiga(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Aigc = new aigb(this);
  ...
  private boolean a()
  {
    ...
    if ((aifg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) && (localaifg != null) && (1 == localaifg.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()))) {
      return true;
    }
  ...
  public void a(int paramInt, apollo_push_msgInfo.STPushMsgElem paramSTPushMsgElem)
  {
    ...
    for (;;)
    {
      ...
      ((aiyu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramSTPushMsgElem);
      ...
      if ((!TextUtils.isEmpty(str)) && (!str.equals(localObject))) {
        aifg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, "apllo_redPack_action");
      }
      if ((TextUtils.isEmpty(str)) || (str.equals(paramSTPushMsgElem))) {
        break;
      }
      aifg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSTPushMsgElem, "apllo_redPack_action");
      return;
  ...
  public void a(aigc paramaigc)
  {
    ...
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramaigc);
  }
  
  public void a(aigd paramaigd)
  {
    if (paramaigd == null)
    {
      this.b = null;
    ...
    this.b = new WeakReference(paramaigd);
  }
  ...
  public void a(ApolloActionPush paramApolloActionPush)
  {
    ...
    localaisk.f = paramApolloActionPush.mActionId;
    localaisk.jdField_c_of_type_Int = 0;
    localaisk.h = paramApolloActionPush.mAioType;
    localaisk.g = 4;
    localaisk.jdField_a_of_type_Long = -10000L;
    localaisk.i = 0;
    localaisk.jdField_a_of_type_Float = 0.0F;
    localaisk.e = paramApolloActionPush.mActionType;
    localaisk.jdField_c_of_type_JavaLangString = paramApolloActionPush.mContent;
    Object localObject1;
    Object localObject2;
    if (paramApolloActionPush.mWordShowType == 1)
    {
      localaisk.jdField_b_of_type_Boolean = true;
      localaisk.jdField_a_of_type_JavaLangString = String.valueOf(paramApolloActionPush.mSendUin);
      localaisk.jdField_b_of_type_JavaLangString = String.valueOf(paramApolloActionPush.mRcvUin);
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        ...
        localaisk.jdField_a_of_type_Boolean = bool;
        localObject1 = (aiyu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
        localObject2 = ((aiyu)localObject1).a(localaisk.f);
        if (localObject2 == null) {
          break label253;
        }
        if (TextUtils.isEmpty(localaisk.jdField_c_of_type_JavaLangString)) {
          localaisk.jdField_c_of_type_JavaLangString = aiwi.a(((ApolloActionData)localObject2).bubbleText);
        }
      }
    }
    for (;;)
    {
      localObject1 = aisl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localObject1 != null) {
        ((aisi)localObject1).a().a(localaisk);
      }
      ThreadManager.post(new ApolloPushManager.3(this, paramApolloActionPush, localaisk), 5, null, true);
      return;
      ...
      localApolloActionData.actionId = localaisk.f;
      ((List)localObject2).add(localApolloActionData);
      ((aiyu)localObject1).a((List)localObject2);
    }
  }
  ...
  public void a(apollo_push_msgInfo.STPushMsgElem paramSTPushMsgElem)
  {
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          if ((a()) && ("tab_list_android_json_v665".equals(localObject1)))
          {
            ...
            if (m > i)
            {
              ((aifg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(true, "onLinePush", 1);
              if (!QLog.isColorLevel()) {
                continue;
              }
            ...
            if ((a()) && (akgx.a().equals(localObject1)))
            {
              i = 0;
              localObject1 = new File(aiys.av);
              if (!((File)localObject1).exists())
              {
                ...
                i = 1;
                localObject1 = aiys.av + "base.zip";
                if (i != 0)
                {
                  localObject2 = new Bundle();
                  ((Bundle)localObject2).putLong("version", m);
                  aitw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1, aiys.at, (Bundle)localObject2, new akgz());
                }
                if (!QLog.isColorLevel()) {
                  continue;
                }
              ...
              if ("apollo_thunder_json_v670".equals(localObject1)) {
                aivr.a(null, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, m, false);
              }
            }
          }
        }
      ...
      for (;;)
      {
        try
        {
          ...
          l = ((aifg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(1, i) / 1000L;
          if (l != m) {
            aitw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), null, i, null, -1, -1, true);
          }
          if (!QLog.isColorLevel()) {
            break;
          }
    ...
    for (;;)
    {
      try
      {
        localObject2 = (aifg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
        if ((!aifg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) || (localObject2 == null) || (1 != ((aifg)localObject2).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()))) {
          break;
        }
        i = Integer.parseInt(localException1);
        l = ((aifg)localObject2).a(2, i) / 1000L;
        if (l != m) {
          aitw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), null, -1, new int[] { i }, -1, -1, true);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
    ...
    if ((localObject2 != null) && (((List)localObject2).size() > 0))
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if (localSTPushMsgElem0x3.dotId.get() != 1003)
        {
          ...
          ((atmp)localObject1).b((atmo)localObject3);
          bajr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "cmshow", "Apollo", "get_notice", ((ApolloGameRedDot)localObject3).mDotId, 1, new String[] { String.valueOf(((ApolloGameRedDot)localObject3).mGameId), "", ((ApolloGameRedDot)localObject3).mActId });
          ApolloGameUtil.a((atmp)localObject1);
        }
        for (;;)
        {
          break;
          ...
          if (this.b != null)
          {
            ...
            if (this.b.get() != null)
            {
              ...
              {
                j = 2;
                ((aigd)this.b.get()).a(1, localObject3);
              }
            }
          }
          i = j;
      ...
      localObject1 = (aiyu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
      if (localObject1 != null) {
        ((aiyu)localObject1).a(paramSTPushMsgElem, i);
      }
      for (;;)
      {
        ((ajjz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(255)).a(NetConnInfoCenter.getServerTimeMillis());
        return;
