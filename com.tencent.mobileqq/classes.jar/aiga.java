...
public class aiga
  extends anxg
{
  public aiga(TroopChatPie paramTroopChatPie) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if ((paramInt1 == 9) && (this.a.ae)) {
      QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, anni.a(2131713941), 0).a();
    }
  }
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    if ((paramInt1 == 2) || (paramInt1 == 9))
    {
      if (paramInt2 == 0)
      {
        ...
        String str = anni.a(2131713946);
        if (this.a.ae) {
          str = anni.a(2131713944);
        }
        ...
        ((anwd)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a().a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      }
    }
    else {
      return;
    }
    QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, anni.a(2131713939), 0).a();
  }
  
  protected void a(beuz parambeuz)
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "onPushTroopEnterEffect: troopUin = " + parambeuz.b + ", data.id = " + parambeuz.jdField_a_of_type_Int);
    }
    ...
    parambeuz = this.a.a();
    parambeuz.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    parambeuz.a();
  }
  ...
  {
    if (!bgjw.a(String.valueOf(paramLong1), this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {}
    do
    {
      return;
      if (QLog.isColorLevel())
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        i = 1;
        break;
        if ((this.a.c != null) && (awwm.a().jdField_a_of_type_Int != 2)) {
          this.a.c.dismiss();
        }
        awwm.a().b.clear();
      ...
      if (awwm.a().jdField_a_of_type_Int == 6)
      {
        ((agmg)TroopChatPie.a(this.a).a(11)).a((Map)paramObject, awwm.a().jdField_a_of_type_JavaUtilArrayList, awwm.a().jdField_a_of_type_Int);
        return;
      }
      ((agmj)TroopChatPie.b(this.a).a(1)).a((Map)paramObject, awwm.a().jdField_a_of_type_JavaUtilArrayList, awwm.a().jdField_a_of_type_Int);
      return;
      label405:
      i = 0;
    }
  ...
  protected void a(boolean paramBoolean, String paramString, int paramInt, List<String> paramList)
  {
    ...
    if ((paramBoolean) && (bfyp.a(paramInt)) && (paramString.equalsIgnoreCase((String)localObject)))
    {
  ...
  protected void a(boolean paramBoolean, String paramString, long paramLong1, long paramLong2)
  {
    ...
    if (i != 0) {
      new bfdy(this.a.jdField_a_of_type_AndroidContentContext, "3171", "libWXVoice.so", "WXVoice").a();
    }
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals(paramString1)) && (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(paramString2)) && (paramInt1 == 1) && (paramInt2 == 0))
    {
      ...
      bcst.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "AIOchat", "Get_history", 0, 0, paramString1, "", "", "");
      if (QLog.isColorLevel()) {
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString3, String paramString4)
  {
    if (paramBoolean)
    {
      if (paramInt4 == 0)
      {
        njo.a().a(paramString1, paramInt2, paramInt1, paramString2, paramInt3, null, paramString4);
    ...
    this.a.a(1, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131689991));
  }
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt, String paramString3, String paramString4)
  {
    ...
    {
      if ((!bfpj.a(paramInt)) && (TroopChatPie.a(this.a) != null) && ((TroopChatPie.a(this.a).a instanceof bfhg))) {
        ((bfhg)TroopChatPie.a(this.a).a).b(this.a);
      }
  ...
  protected void a(boolean paramBoolean1, String paramString, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      bfqk.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      return;
    }
  }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, List<bgat> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        localbgat = (bgat)paramList.next();
        if (!TextUtils.equals(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, localbgat.jdField_a_of_type_JavaLangString)) {
          continue;
        }
        if (localbgat.jdField_a_of_type_Long == 1104445552L)
        {
          if (QLog.isColorLevel()) {
            QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, new Object[] { "onUpdateTroopUnreadMsg homework. num=", Integer.valueOf(localbgat.b) });
          }
          ...
          if ((TroopChatPie.a(this.a) != null) && ((TroopChatPie.a(this.a).a instanceof bfhg))) {
            ((bfhg)TroopChatPie.a(this.a).a).a(false, this.a);
          }
        }
      }
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "receive troop album  red dot, push=" + paramBoolean2 + ", num=" + localbgat.b);
        }
        Message localMessage = TroopChatPie.c(this.a).obtainMessage(85);
        localMessage.arg1 = localbgat.b;
        localMessage.sendToTarget();
        break label72;
        break;
        label328:
        if (localbgat.jdField_a_of_type_Long == 1106611799L)
        {
          if (QLog.isColorLevel()) {
            QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "receive game feed red dot, push=" + paramBoolean2 + ", num=" + localbgat.b);
          }
  ...
  protected void c(String paramString1, String paramString2)
  {
    if (this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals(paramString1))
    {
      List localList = this.a.jdField_a_of_type_Afwy.a();
      ...
      paramString1 = ((bftt)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(152)).a(paramString1, paramString2);
      if (paramString1 != null)
      {
  ...
  protected void c(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    {
      paramString2 = (bgbd)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234);
  ...
  {
    if ((this.a.M) || (this.a.jdField_a_of_type_Bgau == null)) {}
    boolean bool1;
    boolean bool2;
    do
    {
      ...
      bool1 = ((avwk)this.a.a(33)).c();
      bool2 = ((agnm)this.a.a(43)).c();
    } while ((this.a.U) || (bool1) || (bool2));
    if (!paramBoolean)
    {
      this.a.jdField_a_of_type_Bgau.a(2);
      return;
    }
    paramString2 = ((bgbd)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234)).a(paramString1);
    if (!TextUtils.isEmpty(paramString2))
    {
      this.a.c(true);
      this.a.f.setText(paramString2);
    }
    if (this.a.jdField_a_of_type_Bgau != null)
    {
      this.a.jdField_a_of_type_Bgau.a(paramString1);
      if (this.a.jdField_a_of_type_Bgau.a())
      {
        this.a.jdField_a_of_type_Bgau.d();
        TroopChatPie.a(this.a, true);
        return;
      }
      this.a.jdField_a_of_type_Bgau.a(0);
  ...
  protected void d(boolean paramBoolean, String paramString, List<TroopAIONotifyItem> paramList)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.a.jdField_a_of_type_Beqr == null);
      bool1 = this.a.jdField_a_of_type_Beqr.a();
      bool2 = this.a.jdField_a_of_type_Beqr.d();
      int j = 0;
      int i = j;
      if (paramList != null)
      {
        ...
        if (paramList.size() > 0)
        {
          this.a.jdField_a_of_type_Beqr.a(paramList);
          i = j;
          if (!bool2)
          {
            i = j;
            if (!bool1)
            {
              this.a.jdField_a_of_type_Beqr.f();
              i = 1;
            }
          }
        }
