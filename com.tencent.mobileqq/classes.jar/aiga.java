  ...
  extends BaseAdapter
{
  ...
  public boolean a;
  public Object b;
  protected List<aihj> b;
  
  static
  {
    jdField_b_of_type_JavaLangString = aihk.class.getSimpleName();
  }
  
  public aiga(Context paramContext, bhsl parambhsl, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  protected ChatHistorySearchData a(ChatHistorySearchData paramChatHistorySearchData, ArrayList<aihj> paramArrayList)
  {
      ...
      do
      {
        ...
        while (i < paramChatHistorySearchData.mSearchData1.size())
        {
          ...
          if (a(localMessageRecord)) {
            paramArrayList.add(new aihj(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord));
          }
          i += 1;
        }
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
    ...
    {
      return false;
      str = bdgc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramMessageRecord.isSend(), paramMessageRecord.senderuin).toLowerCase(Locale.US);
      paramMessageRecord = aihj.a(paramMessageRecord.msg).toLowerCase(Locale.US);
    } while ((!str.contains(aihj.jdField_a_of_type_JavaLangString)) && (!paramMessageRecord.contains(aihj.jdField_a_of_type_JavaLangString)));
    return true;
  }
  
  public ChatHistorySearchData b(ChatHistorySearchData paramChatHistorySearchData, ArrayList<aihj> paramArrayList)
  {
    int i = 0;
    for (;;)
    {
