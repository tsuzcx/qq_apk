...
public final class rvh
  implements Runnable
{
  public rvh(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, NewestFeedInfo paramNewestFeedInfo, String paramString) {}
      ...
      if (localObject != null)
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          if (localMessageRecord != null)
          {
            ...
            SharedPreUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), localMessageRecord.frienduin, 0L);
          }
        }
      }
