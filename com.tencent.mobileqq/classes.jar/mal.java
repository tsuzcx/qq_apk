  ...
  implements mas
{
  ...
  ViewTreeObserver.OnGlobalLayoutListener jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new mam(this);
  LinearLayout jdField_a_of_type_AndroidWidgetLinearLayout;
  VideoAppInterface jdField_a_of_type_ComTencentAvAppVideoAppInterface;
  final String jdField_a_of_type_JavaLangString = "AvTipsView_" + AudioHelper.b();
  mao jdField_a_of_type_Mao;
  map jdField_a_of_type_Map;
  boolean jdField_a_of_type_Boolean = false;
  int b = 0;
  
  static void a(TextView paramTextView, maq parammaq)
  {
    paramTextView.setTextSize(parammaq.jdField_a_of_type_Int);
    paramTextView.setTextColor(parammaq.b);
    paramTextView.setText(parammaq.jdField_a_of_type_AndroidTextSpannableString);
    paramTextView.setVisibility(0);
    maq.a(paramTextView, parammaq.c, parammaq.d);
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Mao != null) {
      this.jdField_a_of_type_Mao.a();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Mao != null) {
      this.jdField_a_of_type_Mao.jdField_a_of_type_Int = paramInt;
    }
  }
  ...
  void a(RelativeLayout.LayoutParams paramLayoutParams)
  {
    ...
    paramLayoutParams.topMargin = (this.b + (int)muf.a(this.jdField_a_of_type_AndroidWidgetLinearLayout.getContext(), 6.0F));
  ...
  public void a(VideoAppInterface paramVideoAppInterface)
  {
    ...
    ((ljk)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(11)).b();
  ...
  {
    this.jdField_a_of_type_AndroidViewView = paramViewGroup.findViewById(2131372507);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramViewGroup.findViewById(2131372504));
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface = paramVideoAppInterface;
    this.jdField_a_of_type_Mao = new mao(this.jdField_a_of_type_AndroidWidgetLinearLayout);
    this.jdField_a_of_type_Map = new map(this.jdField_a_of_type_AndroidWidgetLinearLayout);
    e();
  }
  ...
  void a(boolean paramBoolean)
  {
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      if ((((lgf)localObject).k) || (((lgf)localObject).j)) {
        break label416;
      }
      i = 1;
      if (QLog.isDevelopLevel()) {
        QLog.w(this.jdField_a_of_type_JavaLangString, 1, "adjustPos, sessionType[" + ((lgf)localObject).d + "->" + i + "]");
      }
    ...
    if (j == 4)
    {
      if (((lgf)localObject).c.size() <= 0) {
        break label421;
      }
      paramBoolean = ((los)((lgf)localObject).c.get(0)).b;
      i = ((los)((lgf)localObject).c.get(0)).jdField_a_of_type_Int;
    }
    for (;;)
    {
      if ((!paramBoolean) || (i == 0))
  ...
  {
    if ((this.jdField_a_of_type_Map != null) && (this.jdField_a_of_type_Map.a != null))
    {
      this.jdField_a_of_type_Map.a.setOnClickListener(paramOnClickListener);
      if (paramBoolean) {
        mts.a(this.jdField_a_of_type_Map.a, 2130841546, 2131165858);
      }
      paramOnClickListener = this.jdField_a_of_type_Map.a;
      if (!paramBoolean) {
        break label68;
      }
    }
  ...
  public boolean a()
  {
    ...
    return this.jdField_a_of_type_Mao.a();
  }
  ...
  public boolean a(mav parammav)
  {
    ...
    parammav = maq.a(this.jdField_a_of_type_Mao.a(), parammav, this.jdField_a_of_type_Mao);
    if (QLog.isDevelopLevel()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "ShowMainTipsView, tipsInfo[" + parammav.jdField_a_of_type_AndroidTextSpannableString + "]");
    }
    return this.jdField_a_of_type_Mao.a(parammav);
  }
  ...
  {
    if ((this.jdField_a_of_type_Mao != null) && (this.jdField_a_of_type_Mao.jdField_a_of_type_AndroidWidgetProgressBar != null)) {
      this.jdField_a_of_type_Mao.jdField_a_of_type_AndroidWidgetProgressBar.getIndeterminateDrawable().setColorFilter(-11113603, PorterDuff.Mode.MULTIPLY);
    }
  }
  ...
  void b(RelativeLayout.LayoutParams paramLayoutParams)
  {
    ...
    for (float f = this.jdField_a_of_type_AndroidWidgetLinearLayout.getRotation();; f = 0.0F)
    {
      ...
      {
        paramLayoutParams.height = -2;
        paramLayoutParams.topMargin = ((int)muf.a(this.jdField_a_of_type_AndroidWidgetLinearLayout.getContext(), 188.0F));
        paramLayoutParams.addRule(14, -1);
        paramLayoutParams.addRule(13, 0);
        return;
      }
      paramLayoutParams.height = (muf.a(this.jdField_a_of_type_AndroidWidgetLinearLayout.getContext()) * 23 / 25);
  ...
  public boolean b()
  {
    ...
    return this.jdField_a_of_type_Map.a();
  }
  ...
  public boolean b(mav parammav)
  {
    ...
    parammav = maq.a(this.jdField_a_of_type_Map.a(), parammav, this.jdField_a_of_type_Map);
    if (QLog.isDevelopLevel()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "ShowSubTipsView, tipsInfo[" + parammav.jdField_a_of_type_AndroidTextSpannableString + "]");
    }
    return this.jdField_a_of_type_Map.a(parammav);
  }
  
  public void c()
  {
    if (this.jdField_a_of_type_Mao != null) {
      this.jdField_a_of_type_Mao.a(4);
    }
    if (this.jdField_a_of_type_Map != null) {
      this.jdField_a_of_type_Map.a(4);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Mao != null) {
      this.jdField_a_of_type_Mao.a(0);
    }
    if (this.jdField_a_of_type_Map != null) {
      this.jdField_a_of_type_Map.a(0);
    }
  }
