...
public class bqra
{
  ...
  public bqra(int paramInt1, int paramInt2, Typeface paramTypeface, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
  ...
  public static bqra a(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, Typeface paramTypeface, bqqi parambqqi)
  {
    paramTypeface = new bqra(paramInt1, paramInt2, paramTypeface, paramInt3, paramInt4, paramInt5, paramInt6);
    paramTypeface.f = 1;
    paramTypeface.a(paramCharSequence, parambqqi);
  ...
  public void a(CharSequence paramCharSequence, bqqi parambqqi)
  {
    a(paramCharSequence, parambqqi, 0);
  }
  
  public void a(CharSequence paramCharSequence, bqqi parambqqi, int paramInt)
  {
    ...
    for (int j = (paramInt - this.e) / (paramCharSequence.length() - 1);; j = 0)
    {
      ...
      while (k < paramCharSequence.length())
      {
        ...
        else
        {
          ...
          if (this.f == 0)
          {
            localbqqt.b = parambqqi.a("", this.c + a(), this.d, 0, 255, new LinearInterpolator());
            label282:
            localbqqt.jdField_a_of_type_AndroidGraphicsBitmap = ((Bitmap)localObject);
            if (k != 0) {
              break label374;
            }
            localbqqt.jdField_a_of_type_Int = paramInt;
          }
          for (paramInt = localbqqt.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() + paramInt;; paramInt = localbqqt.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() + j + paramInt)
          {
            this.jdField_a_of_type_JavaUtilArrayList.add(localbqqt);
            break;
            localbqqt.b = parambqqi.a("", this.c + this.d * k / paramCharSequence.length(), this.d, 0, 255, new LinearInterpolator());
            break label282;
            label374:
            localbqqt.jdField_a_of_type_Int = (paramInt + j);
          }
        }
      }
      return;
