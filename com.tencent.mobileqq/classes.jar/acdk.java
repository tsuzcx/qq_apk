...
{
  public acdk(LocalFileBrowserActivity paramLocalFileBrowserActivity) {}
  ...
  public void a(SlideDetectListView paramSlideDetectListView, View paramView, int paramInt)
  {
    ...
    {
      return;
      paramSlideDetectListView = paramView.findViewById(2131362723);
    ...
    paramView = (Button)paramSlideDetectListView.findViewById(2131364578);
  ...
  public void b(SlideDetectListView paramSlideDetectListView, View paramView, int paramInt)
  {
    ...
    if (paramSlideDetectListView != null)
    {
      ...
      paramSlideDetectListView = (Button)paramSlideDetectListView.findViewById(2131364578);
