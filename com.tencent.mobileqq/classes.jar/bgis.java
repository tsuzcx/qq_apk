...
{
  private FilenameFilter jdField_a_of_type_JavaIoFilenameFilter = new bgit(this);
  ...
  {
    boolean bool2 = false;
    File localFile1 = new File(ajsf.aV, "/tencent/MobileQQ/qqcomic/offline/");
    ...
    for (;;)
    {
      ...
      int k = bbdj.a(localFile2.getAbsolutePath(), ((File)localObject).getAbsolutePath());
  ...
  {
    Object localObject = new File(ajsf.aV, "/tencent/MobileQQ/qqcomic/offline/").list(this.jdField_a_of_type_JavaIoFilenameFilter);
    boolean bool;
  ...
  {
    return new File(new File(ajsf.aV, "/tencent/MobileQQ/qqcomic/offline/"), paramString);
  }
  ...
  public String[] reportHistoryFileInfo()
  {
    ...
    File localFile = new File(ajsf.aV, "/tencent/MobileQQ/qqcomic/offline/");
    ...
    if ((arrayOfString2 != null) && (arrayOfString2.length > 0))
    {
      ...
      while (i < j)
      {
        ...
        l2 += bbdj.b(new File(localFile, str).getAbsolutePath());
        l1 += bbdj.c(new File(localFile, str).getAbsolutePath());
        i += 1;
      }
