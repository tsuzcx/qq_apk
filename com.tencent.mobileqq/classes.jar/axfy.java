  ...
  implements Handler.Callback, Manager
{
  ...
  private ConcurrentHashMap<Integer, axgf> b = new ConcurrentHashMap();
  ...
  public axfy(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Axgg = new axfx(paramQQAppInterface, this);
    d();
  }
  ...
  private void a(RedTouchItem paramRedTouchItem, int paramInt)
  {
    ...
    if (localRedTouchItem == null)
    {
      ...
      axgh.a(localRedTouchItem, paramRedTouchItem);
    ...
    do
    {
      ...
      j = axgh.a(localRedTouchItem.redtouchType);
      k = axgh.a(paramRedTouchItem.redtouchType);
      if (k > j)
      {
        localRedTouchItem = new RedTouchItem();
        axgh.a(localRedTouchItem, paramRedTouchItem);
  ...
  private void a(RedTouchItem paramRedTouchItem, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Axgg.a(paramRedTouchItem, localRedPointConfig1.redPointId);
  ...
  private void d()
  {
    this.jdField_a_of_type_Axgf = new axgf();
    this.jdField_a_of_type_Axgf.jdField_a_of_type_Int = -1;
    this.b.put(Integer.valueOf(this.jdField_a_of_type_Axgf.jdField_a_of_type_Int), this.jdField_a_of_type_Axgf);
    axgf localaxgf1 = new axgf();
    localaxgf1.jdField_a_of_type_Int = 10018;
    localaxgf1.jdField_a_of_type_Axgf = this.jdField_a_of_type_Axgf;
    this.b.put(Integer.valueOf(localaxgf1.jdField_a_of_type_Int), localaxgf1);
    localaxgf1 = new axgf();
    localaxgf1.jdField_a_of_type_Int = -3;
    localaxgf1.jdField_a_of_type_Axgf = this.jdField_a_of_type_Axgf;
    this.b.put(Integer.valueOf(localaxgf1.jdField_a_of_type_Int), localaxgf1);
    localaxgf1.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject1 = new axgf();
    ((axgf)localObject1).jdField_a_of_type_Int = -7;
    this.b.put(Integer.valueOf(((axgf)localObject1).jdField_a_of_type_Int), localObject1);
    ((axgf)localObject1).jdField_a_of_type_Axgf = localaxgf1;
    localaxgf1.jdField_a_of_type_JavaUtilList.add(localObject1);
    ((axgf)localObject1).jdField_a_of_type_JavaUtilList = new ArrayList();
    axgf localaxgf2 = new axgf();
    localaxgf2.jdField_a_of_type_Int = -4;
    this.b.put(Integer.valueOf(localaxgf2.jdField_a_of_type_Int), localaxgf2);
    localaxgf2.jdField_a_of_type_Axgf = localaxgf1;
    localaxgf1.jdField_a_of_type_JavaUtilList.add(localaxgf2);
    localaxgf2.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject2 = new axgf();
    ((axgf)localObject2).jdField_a_of_type_Int = 10015;
    this.b.put(Integer.valueOf(((axgf)localObject2).jdField_a_of_type_Int), localObject2);
    ((axgf)localObject2).jdField_a_of_type_Axgf = ((axgf)localObject1);
    ((axgf)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new axgf();
    ((axgf)localObject2).jdField_a_of_type_Int = 10016;
    this.b.put(Integer.valueOf(((axgf)localObject2).jdField_a_of_type_Int), localObject2);
    ((axgf)localObject2).jdField_a_of_type_Axgf = ((axgf)localObject1);
    ((axgf)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new axgf();
    ((axgf)localObject2).jdField_a_of_type_Int = 100601;
    ((axgf)localObject2).jdField_a_of_type_Axgf = ((axgf)localObject1);
    ((axgf)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    this.b.put(Integer.valueOf(100601), localObject2);
    localObject1 = new axgf();
    ((axgf)localObject1).jdField_a_of_type_Int = 10019;
    this.b.put(Integer.valueOf(((axgf)localObject1).jdField_a_of_type_Int), localObject1);
    ((axgf)localObject1).jdField_a_of_type_Axgf = localaxgf2;
    localaxgf2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new axgf();
    ((axgf)localObject1).jdField_a_of_type_Int = 10020;
    this.b.put(Integer.valueOf(((axgf)localObject1).jdField_a_of_type_Int), localObject1);
    ((axgf)localObject1).jdField_a_of_type_Axgf = localaxgf2;
    localaxgf2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new axgf();
    ((axgf)localObject1).jdField_a_of_type_Int = 10022;
    this.b.put(Integer.valueOf(((axgf)localObject1).jdField_a_of_type_Int), localObject1);
    ((axgf)localObject1).jdField_a_of_type_Axgf = localaxgf2;
    localaxgf2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new axgf();
    ((axgf)localObject1).jdField_a_of_type_Int = 10021;
    this.b.put(Integer.valueOf(((axgf)localObject1).jdField_a_of_type_Int), localObject1);
    ((axgf)localObject1).jdField_a_of_type_Axgf = localaxgf2;
    localaxgf2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new axgf();
    ((axgf)localObject1).jdField_a_of_type_Int = 10023;
    ((axgf)localObject1).jdField_a_of_type_Axgf = localaxgf2;
    this.b.put(Integer.valueOf(((axgf)localObject1).jdField_a_of_type_Int), localObject1);
    localaxgf2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new axgf();
    ((axgf)localObject1).jdField_a_of_type_Int = 10024;
    ((axgf)localObject1).jdField_a_of_type_Axgf = localaxgf2;
    this.b.put(Integer.valueOf(((axgf)localObject1).jdField_a_of_type_Int), localObject1);
    localaxgf2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new axgf();
    ((axgf)localObject1).jdField_a_of_type_Int = 10025;
    ((axgf)localObject1).jdField_a_of_type_Axgf = localaxgf2;
    this.b.put(Integer.valueOf(((axgf)localObject1).jdField_a_of_type_Int), localObject1);
    localaxgf2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new axgf();
    ((axgf)localObject1).jdField_a_of_type_Int = 10026;
    ((axgf)localObject1).jdField_a_of_type_Axgf = localaxgf2;
    this.b.put(Integer.valueOf(((axgf)localObject1).jdField_a_of_type_Int), localObject1);
    localaxgf2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new axgf();
    ((axgf)localObject1).jdField_a_of_type_Int = 10027;
    ((axgf)localObject1).jdField_a_of_type_Axgf = localaxgf2;
    this.b.put(Integer.valueOf(((axgf)localObject1).jdField_a_of_type_Int), localObject1);
    localaxgf2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new axgf();
    ((axgf)localObject1).jdField_a_of_type_Int = 10028;
    ((axgf)localObject1).jdField_a_of_type_Axgf = localaxgf2;
    this.b.put(Integer.valueOf(((axgf)localObject1).jdField_a_of_type_Int), localObject1);
    localaxgf2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localaxgf2 = new axgf();
    localaxgf2.jdField_a_of_type_Int = -2;
    localaxgf2.jdField_a_of_type_Axgf = this.jdField_a_of_type_Axgf;
    this.b.put(Integer.valueOf(localaxgf2.jdField_a_of_type_Int), localaxgf2);
    this.jdField_a_of_type_Axgf.jdField_a_of_type_JavaUtilList = Arrays.asList(new axgf[] { localaxgf1, localaxgf2 });
    localaxgf2.jdField_a_of_type_JavaUtilList = new ArrayList();
    localObject1 = new axgf();
    ((axgf)localObject1).jdField_a_of_type_Int = 100510;
    this.b.put(Integer.valueOf(((axgf)localObject1).jdField_a_of_type_Int), localObject1);
    ((axgf)localObject1).jdField_a_of_type_Axgf = localaxgf2;
    localaxgf2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localaxgf1 = new axgf();
    localaxgf1.jdField_a_of_type_Int = 10011;
    localaxgf1.jdField_a_of_type_Axgf = ((axgf)localObject1);
    this.b.put(Integer.valueOf(localaxgf1.jdField_a_of_type_Int), localaxgf1);
    localObject2 = new ArrayList();
    ((List)localObject2).add(localaxgf1);
    ((axgf)localObject1).jdField_a_of_type_JavaUtilList = ((List)localObject2);
    localObject1 = new ArrayList();
    localObject2 = new axgf();
    ((axgf)localObject2).jdField_a_of_type_Int = 100523;
    ((axgf)localObject2).jdField_a_of_type_Axgf = localaxgf1;
    this.b.put(Integer.valueOf(((axgf)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localObject2 = new axgf();
    ((axgf)localObject2).jdField_a_of_type_Int = 100517;
    ((axgf)localObject2).jdField_a_of_type_Axgf = localaxgf1;
    this.b.put(Integer.valueOf(((axgf)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localaxgf1.jdField_a_of_type_JavaUtilList = ((List)localObject1);
    localaxgf1 = new axgf();
    localaxgf1.jdField_a_of_type_Int = -5;
    localaxgf1.jdField_a_of_type_Axgf = localaxgf2;
    localaxgf2.jdField_a_of_type_JavaUtilList.add(localaxgf1);
    localaxgf1.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localaxgf1.jdField_a_of_type_Int), localaxgf1);
    localaxgf1 = new axgf();
    localaxgf1.jdField_a_of_type_Int = -6;
    localaxgf1.jdField_a_of_type_Axgf = localaxgf2;
    localaxgf2.jdField_a_of_type_JavaUtilList.add(localaxgf1);
    localaxgf1.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localaxgf1.jdField_a_of_type_Int), localaxgf1);
    localObject1 = new axgf();
    ((axgf)localObject1).jdField_a_of_type_Int = 10014;
    ((axgf)localObject1).jdField_a_of_type_Axgf = localaxgf1;
    localaxgf1.jdField_a_of_type_JavaUtilList.add(localObject1);
    this.b.put(Integer.valueOf(((axgf)localObject1).jdField_a_of_type_Int), localObject1);
    localaxgf1 = new axgf();
    localaxgf1.jdField_a_of_type_Int = 10013;
    localaxgf1.jdField_a_of_type_Axgf = localaxgf2;
    localaxgf2.jdField_a_of_type_JavaUtilList.add(localaxgf1);
    this.b.put(Integer.valueOf(localaxgf1.jdField_a_of_type_Int), localaxgf1);
  }
  ...
  private void e(int paramInt)
  {
    ...
    if ((localRedTouchItem1 != null) && (localRedTouchItem1.passThroughLevel > 0))
    {
      ...
      {
        axgf localaxgf = (axgf)this.b.get(Integer.valueOf(i));
        if ((localaxgf == null) || (localaxgf.jdField_a_of_type_Axgf == null)) {
          break;
        }
        RedTouchItem localRedTouchItem2 = (RedTouchItem)this.c.get(Integer.valueOf(localaxgf.jdField_a_of_type_Axgf.jdField_a_of_type_Int));
        if (localRedTouchItem2 != null) {
          localRedTouchItem2.unReadFlag = false;
        }
        if (localaxgf.jdField_a_of_type_Axgf.jdField_a_of_type_JavaUtilList != null)
        {
          i = 0;
          while (i < localaxgf.jdField_a_of_type_Axgf.jdField_a_of_type_JavaUtilList.size())
          {
            j = ((axgf)localaxgf.jdField_a_of_type_Axgf.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_Int;
            ...
            if ((localRedTouchItem2 != null) && (localRedTouchItem2.unReadFlag) && (!localRedTouchItem2.isClosed) && (localRedTouchItem2.passThroughLevel > 0)) {
              a(localRedTouchItem2, localaxgf.jdField_a_of_type_Axgf.jdField_a_of_type_Int);
            }
            i += 1;
          }
        }
        i = localaxgf.jdField_a_of_type_Axgf.jdField_a_of_type_Int;
        paramInt += 1;
      }
    }
  }
  ...
  private void g()
  {
    ...
    if ((localConcurrentHashMap != null) && (localConcurrentHashMap.size() > 0))
    {
      ...
      {
        ((axgi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(91)).a(localArrayList, false);
        long l = SystemClock.elapsedRealtime();
        awka.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(l));
      }
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    ((axgi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(91)).a();
  }
  ...
  public String a()
  {
    if (this.jdField_a_of_type_JavaLangString == null) {
      this.jdField_a_of_type_JavaLangString = ((String)awka.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", ""));
    }
    if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    if (this.jdField_a_of_type_JavaUtilVector.size() > 0)
    {
      ...
      f();
      this.jdField_a_of_type_Axgg.a(this.jdField_a_of_type_JavaUtilVector);
  ...
  public void a(int paramInt, boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      ((axgi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(91)).a(localArrayList);
      return;
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      awka.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", paramString);
    }
  }
  ...
  public void a(short paramShort)
  {
    ...
    long l1 = ((Long)awka.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(0L))).longValue();
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      for (int i = 0;; i = localRedPointConfig.redPointId)
      {
        ...
        amzu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        this.jdField_a_of_type_Axgg.a(Collections.singletonList(paramArrayOfByte));
        return;
      }
