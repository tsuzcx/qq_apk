...
public class qsx
  extends qqt
{
  public qsx(Context paramContext, aobu paramaobu, snh paramsnh)
  {
  ...
  public qqt a()
  {
    ...
    return c(this.jdField_a_of_type_Snh, this.jdField_a_of_type_Aobu).q().l().n().h().j();
  }
  ...
  public qqt d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null)
    {
      ...
      localRelativeLayout2.setLayoutParams(new LinearLayout.LayoutParams(-1, afur.a(86.0F, this.jdField_a_of_type_AndroidContentContext.getResources())));
      ...
      localRelativeLayout2.setOnClickListener(new qsy(this));
