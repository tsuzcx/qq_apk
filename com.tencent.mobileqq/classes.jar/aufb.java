  ...
  implements aysc
{
  ...
  static aysb jdField_a_of_type_Aysb = new aufc();
  private aysa jdField_a_of_type_Aysa;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private List<aufd> jdField_a_of_type_JavaUtilList = new Vector();
  Set<String> jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
  
  public aufb(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(String paramString1, String paramString2, Object paramObject, int paramInt1, boolean paramBoolean, int paramInt2, String paramString3)
  {
    ...
    localayrx.c = paramString3;
    localayrx.e = 1;
    localayrx.a(new Object[] { paramString2, paramObject, Integer.valueOf(paramInt1), Boolean.valueOf(paramBoolean), Integer.valueOf(paramInt2) });
  ...
  public void a(aufd paramaufd)
  {
    if (paramaufd == null) {}
    while (this.jdField_a_of_type_JavaUtilList.contains(paramaufd)) {
      return;
    }
    this.jdField_a_of_type_JavaUtilList.add(paramaufd);
  }
    ...
    for (String str1 = ".mp4";; str2 = "")
    {
      if (!a(paramString2, str1))
      {
        ...
        if ((paramObject != null) && ((paramObject instanceof String[])))
        {
          ...
          if ((paramObject != null) && ("shuayishua_anim".equals(paramObject)))
          {
            ...
            if ((bbdx.a((String)localObject)) && (bbdx.a(str3)) && (bbdx.a(str4)) && (bbdx.a(str5))) {}
          }
        }
        try
        {
          ...
          bbdx.a(a() + paramString2, str1, false);
          if (QLog.isColorLevel()) {
        ...
        try
        {
          ...
          bbdx.a(a() + paramString2, paramString1, false);
          if (QLog.isColorLevel()) {
      ...
      if (paramBoolean2)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            augv.b("OlympicResources", new Object[] { "download, checkLimit == false, url=", paramString1 });
            return true;
          }
      ...
      ((ayrx)localObject).c = (a() + paramString2 + localException);
      ((ayrx)localObject).e = 1;
      ((ayrx)localObject).a(new Object[] { paramString2, paramObject, Integer.valueOf(0), Boolean.valueOf(paramBoolean1), Integer.valueOf(paramInt) });
      ((ayrx)localObject).jdField_a_of_type_Aysb = jdField_a_of_type_Aysb;
      this.jdField_a_of_type_Aysa.a((aysy)localObject);
      return true;
    }
  }
  
  public void b(aufd paramaufd)
  {
    if (paramaufd == null) {
      return;
    }
    this.jdField_a_of_type_JavaUtilList.remove(paramaufd);
  }
  ...
  public void onResp(aysz paramaysz)
  {
    ...
    if (paramaysz.jdField_a_of_type_Int == 0)
    {
      ...
      localObject2 = new File(localayrx.c);
      ...
      localObject1 = aurn.a(((File)localObject2).getAbsolutePath());
    ...
    for (;;)
    {
      ...
      if ((j == 1) || (j == 2))
      {
        if (j == 1)
        {
          ...
          localHashMap.put("url", augv.a(localayrx.jdField_a_of_type_JavaLangString));
          ...
          {
            localObject3 = str2;
            if (paramaysz.jdField_a_of_type_JavaUtilHashMap.containsKey("netresp_param_reason")) {
              localObject3 = (String)paramaysz.jdField_a_of_type_JavaUtilHashMap.get("netresp_param_reason");
            }
          }
          ...
          axrn.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), (String)localObject2, true, 0L, l, localHashMap, "", false);
          augv.b("OlympicResources", new Object[] { "onResp report Download, reportKey=", localObject2, ", errcode=", Integer.valueOf(i), ", url=", localayrx.jdField_a_of_type_JavaLangString });
        }
      }
      else
      {
        ...
        label499:
        if (QLog.isColorLevel()) {
          QLog.i("OlympicResources", 2, "onResp.url=" + localayrx.jdField_a_of_type_JavaLangString + ", result=" + paramaysz.jdField_a_of_type_Int + ", errCode=" + i + ",md5 = " + (String)localObject1);
        }
        j = 0;
        for (;;)
        {
          ...
          {
            localObject4 = (aufd)this.jdField_a_of_type_JavaUtilList.get(j);
            if (localObject4 != null) {
              ((aufd)localObject4).a(localayrx.jdField_a_of_type_JavaLangString, (String)localObject1, localObject2, i, (String)localObject3);
            }
            j += 1;
            continue;
            bool1 = false;
            ...
            if (QLog.isColorLevel()) {
              QLog.i("OlympicResources", 2, "onResp.retry.url=" + localayrx.jdField_a_of_type_JavaLangString + ",md5=" + (String)localObject4 + ", result=" + paramaysz.jdField_a_of_type_Int + ", errCode=" + i + ",retryCount=" + k);
            }
            a(localayrx.jdField_a_of_type_JavaLangString, (String)localObject4, localObject5, k + 1, bool2, j, localayrx.c);
          }
        }
      }
      label807:
      ...
      while (bool1)
      {
        for (;;)
        {
          ...
          try
          {
            ...
            axrn.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), (String)localObject2, false, 0L, 0L, localHashMap, "", false);
          }
        ...
        ((File)localObject2).delete();
        axrn.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "olympic_down_null", bool1, 0L, 0L, null, "", false);
        localObject3 = null;
        localObject2 = null;
        localObject1 = null;
        break label499;
      }
      QLog.i("OlympicResources", 1, "onResp.url=" + localayrx.jdField_a_of_type_JavaLangString + ", result=" + paramaysz.jdField_a_of_type_Int + ", errCode=" + i + ",md5 = " + (String)localObject1 + ", errDesc=" + str1);
      return;
      label1015:
      localObject1 = null;
      l = 0L;
  ...
  public void onUpdateProgeress(aysy paramaysy, long paramLong1, long paramLong2)
  {
    ...
    if ((paramaysy == null) || (!(paramaysy instanceof ayrx))) {
      return;
    }
    String str = ((ayrx)paramaysy).jdField_a_of_type_JavaLangString;
    paramaysy = paramaysy.a();
    if ((paramaysy != null) && ((paramaysy instanceof Object[])))
    {
      localObject = (Object[])paramaysy;
      paramaysy = (String)localObject[0];
      localObject = localObject[1];
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.i("OlympicResources", 2, "onUpdateProgeress.url=" + str + ", md5=" + paramaysy + ", userData=" + localObject + ",curOffset=" + paramLong1 + ",totalLen=" + paramLong2);
      }
      int i = 0;
      while (i < this.jdField_a_of_type_JavaUtilList.size())
      {
        aufd localaufd = (aufd)this.jdField_a_of_type_JavaUtilList.get(i);
        if (localaufd != null) {
          localaufd.a(str, paramaysy, localObject, paramLong1, paramLong2);
        }
        i += 1;
      }
      break;
