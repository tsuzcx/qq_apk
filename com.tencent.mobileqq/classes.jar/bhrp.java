...
public class bhrp
{
  ...
  static
  {
    jdField_a_of_type_Bhmj = new bhrq();
  }
  
  private static int a(Context paramContext, String paramString, int paramInt, bcdp parambcdp)
  {
    int i = 2;
  ...
  public static void a(Context paramContext, bcdp parambcdp)
  {
    parambcdp = bbdj.a(paramContext, 0);
    parambcdp.setMessage(paramContext.getString(2131720274));
    parambcdp.setPositiveButton(paramContext.getString(2131691920), new bhrr(paramContext));
    parambcdp.setNegativeButton(paramContext.getString(2131693377), new bhrs(parambcdp));
    try
    {
      if (!parambcdp.isShowing()) {
        parambcdp.show();
      }
      return;
    }
  ...
  /* Error */
  private static void a(bcdp parambcdp, String paramString)
  {
    // Byte code:
    //   0: iconst_m1
    //   1: istore_3
    ...
    //   110: pop
    //   111: aload_0
    //   112: invokevirtual 300	bcdp:a	()Landroid/app/Activity;
    //   115: astore_0
    //   116: aload_0
    //   117: ifnull -111 -> 6
    //   120: aload_0
  ...
  static void a(bcdp parambcdp, String... paramVarArgs)
  {
    if ((parambcdp != null) && (parambcdp.a() != null) && (paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        Object localObject1 = parambcdp.a(parambcdp.a());
        if ((localObject1 != null) && ((localObject1 instanceof bcif)))
        {
          localObject1 = ((bcif)localObject1).a().a();
          if ((localObject1 != null) && (((bcqf)localObject1).isShowing())) {
            ((bcqf)localObject1).dismiss();
          }
        }
        jdField_a_of_type_ComTencentBizPubaccountCustomWebView = parambcdp.a();
        ...
        paramVarArgs = new QZoneWebViewJsHandleLogic.2(parambcdp, localHashMap, str2, str3, paramVarArgs, str1, (String)localObject1);
        if (TextUtils.isEmpty((CharSequence)localObject2))
        {
          paramVarArgs.run();
          return;
        }
        ThreadManager.post(new QZoneWebViewJsHandleLogic.3((String)localObject2, localHashMap, parambcdp, paramVarArgs), 8, null, false);
        return;
      }
      catch (Exception parambcdp)
      {
        QZLog.e("QZoneWebViewJsHandleLogic", "shareMiniProgramFromQzone error", parambcdp);
      }
    }
  }
  
  private static void a(WebViewPlugin paramWebViewPlugin, bcdp parambcdp, String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (parambcdp == null) || (paramVarArgs.length <= 0)) {}
    Object localObject5;
    Object localObject2;
    Object localObject3;
    Object localObject4;
    ...
    do
    {
      do
      {
        do
        {
          for (;;)
          {
            ...
            try
            {
              ...
              paramVarArgs = parambcdp.a().getUrl();
              if (!bhpl.a().a(paramVarArgs, (String)localObject1))
              {
            ...
            if (bool)
            {
              ...
              try
              {
                if (((String)localObject2).indexOf("uin=") != -1)
                {
                  ...
                  bgyp.a((Context)localObject4, bgyw.a(), paramWebViewPlugin, 0, 0, 0);
                  return;
                }
              }
        ...
        parambcdp = parambcdp.a((Activity)localObject4);
        if (!(parambcdp instanceof bcdq)) {
          break label1115;
        }
        i = ((bcdq)parambcdp).switchRequestCode(paramWebViewPlugin, (byte)3);
        if (TextUtils.isEmpty(paramVarArgs))
        {
          bgyp.a((Activity)localObject4, bgyw.a(), (String)localObject1, i);
          return;
        }
        bgyp.a((Activity)localObject4, bgyw.a(), (String)localObject1, i, paramVarArgs);
        return;
      ...
      localObject6 = parambcdp.a((Activity)localObject4);
      if (!(localObject6 instanceof bcdq)) {
        break label1120;
      }
      i = ((bcdq)localObject6).switchRequestCode(paramWebViewPlugin, (byte)3);
      paramWebViewPlugin = bgyw.a();
      paramWebViewPlugin.jdField_a_of_type_JavaLangString = parambcdp.a().getAccount();
      parambcdp = new Bundle();
      parambcdp.putString("source", paramVarArgs.getQueryParameter("source"));
      parambcdp.putString("bypassparam", paramVarArgs.getQueryParameter("bypassparam"));
      parambcdp.putAll(localBundle);
      bgyp.a((Activity)localObject4, paramWebViewPlugin, (String)localObject1, (String)localObject2, (String)localObject3, (String)localObject5, i, parambcdp);
      return;
      if (!"mqzone://arouse/dynamicnickname".equalsIgnoreCase((String)localObject2)) {
        break;
      }
    } while ((parambcdp == null) || (parambcdp.a() == null) || (parambcdp.a() == null));
    bgyp.a(parambcdp.a(), parambcdp.a().getAccount());
    return;
    if (((String)localObject2).startsWith("mqzone://arouse/uploadphoto"))
    {
      bgyp.a(paramWebViewPlugin, parambcdp, parambcdp.a(), parambcdp.a().getAccount(), (String)localObject2);
      return;
    }
    if ((((String)localObject2).startsWith("mqzone://arouse/facade")) || (((String)localObject2).startsWith("mqzonev2://arouse/facade")))
    {
      a(parambcdp.a(), (String)localObject2, 81, parambcdp);
      return;
    }
    if (((String)localObject2).startsWith("mqzone://arouse/moodVoiceRecord"))
    {
      bgyp.b(paramWebViewPlugin, parambcdp, parambcdp.a(), parambcdp.a().getAccount(), (String)localObject2);
      return;
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        i = bhrt.a(paramWebViewPlugin, parambcdp, 4);
        bgyp.a((Activity)localObject4, bgyw.a(), paramVarArgs, i, bool);
        return;
      }
      bgyp.a((Activity)localObject4, bgyw.a(), paramVarArgs, -1, bool);
      return;
      label1084:
  ...
  public static boolean a(WebViewPlugin paramWebViewPlugin, bcdp parambcdp, String paramString, String... paramVarArgs)
  {
    if ("updateFeedContainer".equalsIgnoreCase(paramString)) {
      f(parambcdp, paramVarArgs);
    }
    do
    {
      return true;
  ...
  private static void b(bcdp parambcdp, String... paramVarArgs)
  {
    if ((parambcdp != null) && (parambcdp.a() != null) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      parambcdp = new Intent("qzone.pickgamemates");
      parambcdp.putExtra("gamemates", paramVarArgs[0]);
      BaseApplicationImpl.getApplication().sendBroadcast(parambcdp);
      if (QLog.isColorLevel()) {
  ...
  private static void c(bcdp parambcdp, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      parambcdp = new Intent("updateIsSpecialFollow");
      parambcdp.putExtra("isSpecialFollow", i);
      BaseApplicationImpl.getApplication().sendBroadcast(parambcdp);
      if (QLog.isColorLevel()) {
    ...
    {
      QLog.e("QZoneWebViewJsHandleLogic", 1, "handleUpdateIsSpecialFollow catch an exception. ", parambcdp);
    }
  }
  ...
  private static void d(bcdp parambcdp, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      parambcdp = new Intent("showFollowActionSheet");
      parambcdp.putExtra("followStatus", i);
      BaseApplicationImpl.getApplication().sendBroadcast(parambcdp);
      if (QLog.isColorLevel()) {
        QLog.d("QZoneWebViewJsHandleLogic", 1, "followStatus = " + i);
      }
    ...
    {
      QLog.e("QZoneWebViewJsHandleLogic", 1, "handleShowFollowActionSheet catch an exception. ", parambcdp);
    }
  }
  
  private static void e(bcdp parambcdp, String... paramVarArgs)
  {
    Activity localActivity;
    if ((parambcdp != null) && (parambcdp.a() != null) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      localActivity = parambcdp.a();
      if (bbfr.a(localActivity, "com.tencent.weishi"))
      {
        parambcdp = "";
        try
        {
          paramVarArgs = new JSONObject(paramVarArgs[0]).optString("schema");
          parambcdp = paramVarArgs;
          if (!TextUtils.isEmpty(paramVarArgs))
          {
            parambcdp = paramVarArgs;
            Intent localIntent = new Intent();
        ...
        {
          QLog.e("QZoneWebViewJsHandleLogic", 1, "handleClickWeiShiWidget catch an exception. weishi schema is " + parambcdp, paramVarArgs);
          return;
        }
      }
    }
  ...
  private static void f(bcdp parambcdp, String... paramVarArgs)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            if (!(parambcdp.a().getParent() instanceof RelativeLayout)) {
              continue;
            }
            ((RelativeLayout)parambcdp.a().getParent()).setVisibility(8);
          }
        }
        catch (JSONException parambcdp)
        {
          QLog.e("QZoneWebViewJsHandleLogic", 1, parambcdp, new Object[0]);
          return;
        }
      }
    } while (!(parambcdp.a().getParent() instanceof RelativeLayout));
    ((RelativeLayout)parambcdp.a().getParent()).setVisibility(0);
  }
  
  private static void g(bcdp parambcdp, String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0)) {}
    for (;;)
    {
      ...
      try
      {
        ...
        if (((JSONObject)localObject).getInt("success") == 1)
        {
          ...
          if ((paramVarArgs != null) && (paramVarArgs.length() > 0) && (localJSONArray != null) && (localJSONArray.length() == paramVarArgs.length()))
          {
            ...
            parambcdp.a().setResult(-1, localIntent);
            parambcdp.a().finish();
            if (QLog.isColorLevel())
            {
  ...
  private static void h(bcdp parambcdp, String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0)) {
      return;
    }
  ...
  private static void i(bcdp parambcdp, String... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        try
        {
          ...
          if (!TextUtils.isEmpty(str1)) {
            ((StringBuilder)localObject2).append(bdlb.b).append("=").append(str1);
          }
          if (!TextUtils.isEmpty(paramVarArgs)) {
            ((StringBuilder)localObject2).append("&").append(bdlb.f).append("=").append(paramVarArgs);
          }
          if (!TextUtils.isEmpty((CharSequence)localObject1)) {
            ((StringBuilder)localObject2).append("&").append(bdlb.c).append("=").append((String)localObject1);
          }
          if (!TextUtils.isEmpty(str2)) {
            ((StringBuilder)localObject2).append("&").append(bdlb.d).append("=").append(str2);
          }
          if (!TextUtils.isEmpty(str3)) {
            ((StringBuilder)localObject2).append("&").append(bdlb.i).append("=").append(str3);
          }
          if (!TextUtils.isEmpty(str4)) {
            ((StringBuilder)localObject2).append("&").append(bdlb.e).append("=").append(str4);
          }
          if (!TextUtils.isEmpty(str5)) {
            ((StringBuilder)localObject2).append("&").append(bdlb.B).append("=").append(str5);
          }
          ...
          bgyp.a((Bundle)localObject1);
          bdfk.a(parambcdp.a(), (Bundle)localObject1);
          return;
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e("QZoneWebViewJsHandleLogic", 2, "json 解析异常", parambcdp);
        }
      }
    }
  }
