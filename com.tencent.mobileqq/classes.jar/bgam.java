...
class bgam
  extends bfss
{
  bgam(bfzz parambfzz, int paramInt, String paramString, MessageForDeliverGiftTips paramMessageForDeliverGiftTips, boolean paramBoolean) {}
  ...
  public void a(int paramInt, oidb_0x962.RspBody paramRspBody)
  {
    ...
    if ((this.jdField_a_of_type_Bfzz.a != null) && (this.jdField_a_of_type_Boolean)) {
      this.jdField_a_of_type_Bfzz.a.a.a().createEntityManager().update(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips);
    }
  }
}
