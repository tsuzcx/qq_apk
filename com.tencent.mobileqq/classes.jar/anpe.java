...
public class anpe
{
  ...
  {
    if (paramInt == 2052) {
      return anni.a(2131693177);
    }
    if (paramInt == 1033) {
      return anni.a(2131693176);
    }
    return "";
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      str = aoqd.a(paramContext, "key_local_cache", "0");
      a("initializeAppLocale, localeIdStr:" + str);
      if (!"0".equals(str)) {
        break label182;
      }
      jdField_a_of_type_Int = 2052;
      aoqd.a(paramContext, "key_local_cache", String.valueOf(jdField_a_of_type_Int));
      str = aoqd.a(paramContext, "key_local_last", "0");
      if (!"0".equals(str)) {
        break label200;
      }
    ...
    {
      b = bool1;
      aoqd.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
  ...
  public static void a(Context paramContext, int paramInt)
  {
    ...
    aoqd.a(paramContext, "key_local_last", String.valueOf(jdField_a_of_type_Int));
    aoqd.a(paramContext, "key_local_cache", String.valueOf(paramInt));
