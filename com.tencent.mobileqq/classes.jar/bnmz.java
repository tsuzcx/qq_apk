  ...
  implements binj
{
  ...
  private bnnn[] jdField_a_of_type_ArrayOfBnnn;
  ...
  {
    int i = 0;
    if ((this.jdField_a_of_type_ArrayOfBnnn == null) || (this.jdField_a_of_type_ArrayOfBnnn.length == 0))
    {
      this.jdField_a_of_type_ArrayOfBnnn = new bnnn[] { new bnmm(), new bnpu(), new bnou(), new bnnf(), new bnns(), new bnno(), new bnnh(), new bnmd(), new bnni(), new bnnu(), new bnme(), new bnmk(), new bnnx(), new bnnb(), new bnna(), new bnof(), new bnmh(), new bnos(), new bnpa(), new bnmc(), new bnol(), new bnne(), new bnnm(), new bnom(), new bnma(), new bnop(), new bnps(), new bnmq(), new bnmr(), new bnng(), new bnnc(), new bnmo(), new bnov(), new bnpb(), new bnog(), new bnor(), new bnlz(), new bnnq(), new bnmb(), new bnlw() };
      bnnn[] arrayOfbnnn = this.jdField_a_of_type_ArrayOfBnnn;
      int j = arrayOfbnnn.length;
      while (i < j)
      {
        arrayOfbnnn[i].a(this);
        i += 1;
      }
    }
  }
  ...
  private boolean a(String paramString)
  {
    try
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        bool = bnku.a((String)localObject, paramString, bool);
        if (!bool) {
          break;
        }
        return true;
  ...
  public Object handleEvent(String paramString, long paramLong)
  {
    ...
    while (i < j)
    {
      Object localObject = arrayOfbnnn[i].a(paramString, paramLong);
      if (localObject != null) {
        return localObject;
      }
      i += 1;
  ...
  public boolean handleEvent(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        if (arrayOfbnnn[i].a(paramString, paramLong, paramMap)) {
          break;
        }
        i += 1;
      }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    while (i < j)
    {
      if (arrayOfbnnn[i].a(paramJsBridgeListener, paramString1, paramString2, paramString3, paramVarArgs)) {
        return true;
      }
      i += 1;
    }
    return bnmv.a(this, this.mRuntime, paramString3, paramVarArgs);
  }
  
  public void onActivityResult(Intent paramIntent, byte paramByte, int paramInt)
  {
    a();
    Object localObject = this.jdField_a_of_type_ArrayOfBnnn;
