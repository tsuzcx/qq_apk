...
public class aaeg
  implements aaeb
{
  private static aaeg jdField_a_of_type_Aaeg;
  aaea jdField_a_of_type_Aaea;
  ...
  private aaeg()
  {
    ...
    for (this.jdField_a_of_type_Aaea = new aaec();; this.jdField_a_of_type_Aaea = new aaee())
    {
      this.jdField_a_of_type_Aaea.a(this);
      return;
      if (QLog.isColorLevel()) {
  ...
  public static aaeg a()
  {
    if (jdField_a_of_type_Aaeg == null) {}
    try
    {
      if (jdField_a_of_type_Aaeg == null) {
        jdField_a_of_type_Aaeg = new aaeg();
      }
      return jdField_a_of_type_Aaeg;
    }
    finally {}
  }
  ...
  private Map<String, APIQuotaItem> a(String paramString1, int paramInt, String paramString2)
  {
    ...
    try
    {
      ...
      if (i != 0) {
        this.jdField_a_of_type_Aaea.a(paramString1, paramInt, paramString2);
      }
      return localObject;
    }
    finally {}
  ...
  public void a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    this.jdField_a_of_type_Aaea.a(paramString1, paramInt, paramString2, paramString3);
  }
