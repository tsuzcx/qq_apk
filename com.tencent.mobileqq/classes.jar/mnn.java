...
public class mnn
{
      ...
      do
      {
        ...
        if (j == -2)
        {
          ...
          if ((!this.jdField_c_of_type_Boolean) && ((this.jdField_b_of_type_Boolean) || (this.jdField_d_of_type_Boolean)))
          {
            ...
            if (this.jdField_a_of_type_Mns.a != null) {
              this.jdField_a_of_type_Mns.a.j();
            }
          }
  ...
  protected void a(mne parammne, boolean paramBoolean)
  {
    if (AudioHelper.e()) {
      QLog.w("QavRecordEncoder", 1, "handleAudioFrame, frame[" + parammne + "], endOfStream[" + paramBoolean + "], mNoAudio[" + this.jdField_d_of_type_Boolean + "]");
    }
    if (this.jdField_d_of_type_Boolean) {
      return;
    }
    this.jdField_a_of_type_JavaNioByteBuffer.clear();
    this.jdField_a_of_type_JavaNioByteBuffer.put(parammne.a);
    this.jdField_a_of_type_JavaNioByteBuffer.position(parammne.a.length);
    ...
    if (j >= 0)
    {
      ...
      this.jdField_b_of_type_AndroidMediaMediaCodec.queueInputBuffer(j, 0, parammne.a.length, parammne.jdField_b_of_type_Long, 0);
      if (QLog.isColorLevel()) {
        QLog.d("QavRecordEncoder", 2, "encode, write to codec, size=" + parammne.a.length);
      }
      label280:
      parammne = this.jdField_b_of_type_AndroidMediaMediaCodec.getOutputBuffers();
      i = 0;
    }
    for (;;)
    {
  ...
  public void a(byte[] paramArrayOfByte, long paramLong)
  {
    ...
    paramArrayOfByte = new mne(paramArrayOfByte, l);
  ...
  public void b()
  {
    ...
    long l = this.jdField_a_of_type_Long;
    this.jdField_a_of_type_Long = (1L + l);
    mne localmne = new mne(new byte[0], l);
    localmne.jdField_b_of_type_Long = this.jdField_b_of_type_Long;
    a(localmne, true);
    a(true);
    c();
    if (this.jdField_a_of_type_JavaNioByteBuffer != null)
