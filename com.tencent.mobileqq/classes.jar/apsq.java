...
public class apsq
{
  ...
  public ArrayList<apso> f = new ArrayList();
  ...
  private Rect a()
  {
    ...
    {
      return localObject;
      Collections.sort(this.jdField_b_of_type_JavaUtilArrayList, new apsr(this));
      localRect = (Rect)this.jdField_b_of_type_JavaUtilArrayList.get(apsn.jdField_a_of_type_JavaUtilRandom.nextInt(Math.min(this.jdField_b_of_type_JavaUtilArrayList.size(), 3)));
  ...
  private Rect a(Rect paramRect)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        k = apsn.jdField_a_of_type_JavaUtilRandom.nextInt(this.jdField_a_of_type_JavaUtilArrayList.size());
        if (k != 0)
        {
          localObject = (apsv)this.jdField_a_of_type_JavaUtilArrayList.get(0);
        ...
        do
        {
          ...
          localRect = a((apsv)((Iterator)localObject).next(), paramRect, m, n, i, j);
    ...
    for (;;)
    {
      ...
      if (localRect.top == paramRect.bottom)
      {
        ...
        if (paramRect.width() < paramRect.height())
        {
          ...
          j = k;
          break;
          k = apsn.jdField_a_of_type_JavaUtilRandom.nextInt(Math.min(this.jdField_a_of_type_JavaUtilArrayList.size(), 3));
          break label136;
          return null;
        }
        bool = false;
  ...
  private Rect a(Rect paramRect, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8)
  {
    if ((paramInt4 <= paramInt2) && (paramInt3 <= paramInt1)) {
      if (paramRect.width() - paramInt3 >= apsn.jdField_a_of_type_Int + 8) {}
    }
    for (;;)
    {
      if (paramRect.height() - paramInt4 < apsn.jdField_a_of_type_Int + 8) {}
      for (;;)
      {
  ...
  private Rect a(Rect paramRect, boolean paramBoolean)
  {
    ...
    {
      apso localapso = (apso)localIterator.next();
      int i = localapso.jdField_a_of_type_AndroidGraphicsRect.width();
      int j = localapso.jdField_a_of_type_AndroidGraphicsRect.height();
      if (((paramBoolean) || (k * 5 < i * j) || (k <= 576)) && (a(paramRect, localapso.jdField_a_of_type_AndroidGraphicsRect)))
      {
        localapso.jdField_a_of_type_AndroidGraphicsRect.union(paramRect);
        a(localapso, localapso.jdField_a_of_type_AndroidGraphicsRect);
        return paramRect;
      }
      if (paramBoolean)
      {
        ...
        j = 0;
        if ((localRect.left <= localapso.jdField_a_of_type_AndroidGraphicsRect.left) && (localRect.right >= localapso.jdField_a_of_type_AndroidGraphicsRect.right))
        {
          localRect.left = localapso.jdField_a_of_type_AndroidGraphicsRect.left;
          localRect.right = localapso.jdField_a_of_type_AndroidGraphicsRect.right;
          i = 1;
        }
        while ((i != 0) && (a(localRect, localapso.jdField_a_of_type_AndroidGraphicsRect)))
        {
          localapso.jdField_a_of_type_AndroidGraphicsRect.union(localRect);
          a(localapso, localapso.jdField_a_of_type_AndroidGraphicsRect);
          return localRect;
          i = j;
          if (paramRect.top <= localapso.jdField_a_of_type_AndroidGraphicsRect.top)
          {
            i = j;
            if (paramRect.bottom >= localapso.jdField_a_of_type_AndroidGraphicsRect.bottom)
            {
              localRect.top = localapso.jdField_a_of_type_AndroidGraphicsRect.top;
              localRect.bottom = localapso.jdField_a_of_type_AndroidGraphicsRect.bottom;
              i = 1;
            }
          }
        }
  ...
  private Rect a(apsv paramapsv, Rect paramRect, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    int j = paramapsv.c;
    int i = j;
    if (paramapsv.jdField_a_of_type_Int >= 1) {
      i = Math.max(24, (int)(j * (0.95F - apsn.jdField_a_of_type_JavaUtilRandom.nextInt(10) / 100.0F))) / 4 * 4;
    }
    ...
    if (n < 10)
    {
      ...
      if (m >= 24)
      {
        k = (int)(m * paramapsv.jdField_a_of_type_Float);
        localObject1 = localObject2;
        i = j;
        if (paramInt1 * paramInt2 >= m * k)
        {
          localObject3 = paramapsv.jdField_a_of_type_JavaUtilSet.iterator();
          i = j;
          localObject1 = localObject2;
          label142:
    ...
    for (;;)
    {
      if (paramRect == null)
      {
        ...
        m = Math.max(24, (int)(m * (0.95F - apsn.jdField_a_of_type_JavaUtilRandom.nextInt(6) / 100.0F))) / 4 * 4;
        n += 1;
      ...
      {
        paramapsv = new apso(paramapsv, -1, paramRect, m, true, i);
        a(paramapsv, paramRect);
        this.f.add(paramapsv);
        return paramRect;
      }
      return null;
      label324:
  ...
  private void a(apso paramapso, Rect paramRect)
  {
    paramapso.jdField_a_of_type_JavaUtilArrayList.clear();
    int i4 = paramapso.e;
    int i5 = paramapso.b;
    float f2 = paramapso.jdField_a_of_type_Apsv.jdField_a_of_type_Float;
    int i3 = 0;
    int i;
    label75:
    int j;
    ...
    for (int m = j;; m = j)
    {
      ...
      for (;;)
      {
        ...
        {
          float f1 = 0.0F;
          i2 = paramapso.jdField_a_of_type_Apsv.b / i4;
          ...
          if (i2 <= 1)
          {
            ...
            i = Math.max(m, 0);
            Math.max(k, 0);
            bool = apsn.jdField_a_of_type_JavaUtilRandom.nextBoolean();
            f1 = i + paramRect.top;
            i = 0;
          }
          for (;;)
          {
            ...
            if (k < i2)
            {
              ...
              for (j = i;; j = i4 + i)
              {
                localObject1 = (Pair)paramapso.jdField_a_of_type_Apsv.jdField_a_of_type_JavaUtilArrayList.get(j);
                j = Math.round(f2);
                m = Math.round(f1);
                float f5 = i5;
                localObject2 = new apsp(new Rect(j, m, Math.round(((Float)((Pair)localObject1).second).floatValue() * f5 + f2), Math.round(i5 + f1)), (String)((Pair)localObject1).first);
                paramapso.jdField_a_of_type_JavaUtilArrayList.add(localObject2);
                f5 = i5;
  ...
  private void a(ArrayList<apsv> paramArrayList, boolean paramBoolean)
  {
    Collections.sort(paramArrayList, new apsu(this, paramBoolean, paramArrayList));
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        Collections.sort(this.jdField_b_of_type_JavaUtilArrayList, new apss(this));
  ...
  private boolean a(Rect paramRect1, Rect paramRect2, int paramInt)
  {
    ...
    while (localIterator.hasNext()) {
      if (a((apsv)localIterator.next(), paramRect1, paramInt)) {
        return true;
      }
    }
  ...
  private boolean a(apsv paramapsv, Rect paramRect, int paramInt)
  {
    Iterator localIterator = paramapsv.jdField_a_of_type_JavaUtilSet.iterator();
    while (localIterator.hasNext())
    {
      Integer localInteger = (Integer)localIterator.next();
      if (((paramRect.width() + 8) * localInteger.intValue() >= paramapsv.jdField_a_of_type_Float * paramInt) && (paramRect.height() + 8 >= localInteger.intValue() * paramInt)) {
        return true;
      }
    }
    return false;
  ...
  private void c()
  {
    ...
    {
      Collections.sort(this.jdField_b_of_type_JavaUtilArrayList, new apst(this));
      int i4 = this.jdField_b_of_type_JavaUtilArrayList.size();
      localObject2 = null;
      i = 0;
      localObject1 = null;
      j = -1;
      k = apsn.jdField_a_of_type_Int;
      int i3 = 0;
      while (i3 < i4)
      {
        ...
        localObject3 = localObject1;
        i1 = i;
        if (localRect.width() >= apsn.jdField_a_of_type_Int)
        {
          if (localRect.height() < apsn.jdField_a_of_type_Int)
          {
            i1 = i;
            localObject3 = localObject1;
            n = j;
        ...
        {
          localObject3 = (apsv)localIterator1.next();
          Iterator localIterator2 = ((apsv)localObject3).jdField_a_of_type_JavaUtilSet.iterator();
          i1 = i;
          localObject2 = localObject1;
          n = j;
          m = k;
          ...
          if (localIterator2.hasNext())
          {
            ...
            if ((localRect.width() * ((Integer)localObject1).intValue() < ((apsv)localObject3).jdField_a_of_type_Float * apsn.jdField_a_of_type_Int) || (localRect.height() < apsn.jdField_a_of_type_Int * ((Integer)localObject1).intValue())) {
              break label639;
            }
            float f1 = ((apsv)localObject3).jdField_a_of_type_Float / ((Integer)localObject1).intValue();
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localRect = a(localObject2, localObject2.width(), localObject2.height(), (int)(k * ((apsv)localObject1).jdField_a_of_type_Float / j), k * j, -1, -1, k, apsn.jdField_a_of_type_Int);
        if (localRect == null) {
          break;
        }
        a(localObject2, localRect, true);
        localObject1 = new apso((apsv)localObject1, -1, localRect, k, false, j);
        a((apso)localObject1, localRect);
  ...
  public ArrayList<apso> a(ArrayList<apsv> paramArrayList, Rect paramRect, ArrayList<Rect> paramArrayList1)
  {
    a();
    ...
    for (int i = 1;; i = 0)
    {
      ...
      else
      {
        ...
        paramRect = (apsv)paramArrayList.next();
        paramRect.a();
        if (paramRect.b == 13) {
          break label365;
        }
