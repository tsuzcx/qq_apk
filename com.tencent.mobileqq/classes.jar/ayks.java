  ...
  implements ayjj
{
  ...
  public ayks(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, boolean paramBoolean)
  {
  ...
  public ayks(QQAppInterface paramQQAppInterface, int paramInt1, byte[] paramArrayOfByte, int paramInt2, boolean paramBoolean)
  {
    this.jdField_a_of_type_JavaLangObject = new Object();
    this.jdField_a_of_type_Int = paramInt1;
  ...
  public static List<ayks> a(QQAppInterface paramQQAppInterface, List<DynamicDiscovery.Result> paramList, int paramInt)
  {
      ...
      if (i < paramList.size())
      {
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            bdiv.a(paramQQAppInterface.getCurrentAccountUin(), arrayOfString);
            ...
            continue;
            localObject = new ayhq(paramQQAppInterface, k, ((DynamicDiscovery.Result)localObject).toByteArray(), paramInt, false);
          }
        }
      }
      boolean bool = a(arrayOfInt, aydn.a(paramQQAppInterface, paramInt, false));
      aydn.a(paramQQAppInterface, paramInt, bool, false);
      if (bool) {
        aydn.a(paramQQAppInterface, paramInt, arrayOfInt, false);
      }
    }
  ...
  public static List<ayks> b(QQAppInterface paramQQAppInterface, List<UnifySearchDiscovery.Result> paramList, int paramInt)
  {
      ...
      if (i < paramList.size())
      {
        ...
        for (;;)
        {
          ...
          else
          {
            ...
            bdiv.b(paramQQAppInterface.getCurrentAccountUin(), arrayOfString);
            ...
            continue;
            localObject = new ayhq(paramQQAppInterface, k, ((UnifySearchDiscovery.Result)localObject).toByteArray(), paramInt, true);
          }
        }
      }
      boolean bool = a(arrayOfInt, aydn.a(paramQQAppInterface, paramInt, true));
      aydn.a(paramQQAppInterface, paramInt, bool, true);
      if (bool) {
        aydn.a(paramQQAppInterface, paramInt, arrayOfInt, true);
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d("SearchEntryDataModel", 2, "convertPbDataToModel, modelList = " + localArrayList.size());
  ...
  public void a()
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      {
        this.jdField_a_of_type_ArrayOfByte = bdcs.a(BaseApplication.getContext().getFileStreamPath("search_discovery_sp_prefixpref_search_model_data" + localQQAppInterface.getCurrentAccountUin() + "_" + this.jdField_a_of_type_Int + "_" + this.b));
        a(this.jdField_a_of_type_ArrayOfByte);
        return;
      }
      this.jdField_a_of_type_ArrayOfByte = bdcs.a(BaseApplication.getContext().getFileStreamPath("search_discovery_sp_prefix_unifypref_search_model_data" + localQQAppInterface.getCurrentAccountUin() + "_" + this.jdField_a_of_type_Int + "_" + this.b));
      a(this.jdField_a_of_type_ArrayOfByte);
    }
  }
