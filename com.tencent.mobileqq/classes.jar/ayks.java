  ...
  extends SpannableStringBuilder
{
  ...
  static
  {
    jdField_a_of_type_AndroidTextEditable$Factory = new aykt();
    jdField_b_of_type_AndroidTextEditable$Factory = new ayku();
  }
  
  public ayks(CharSequence paramCharSequence, int paramInt)
  {
    this(paramCharSequence, paramInt, 32);
  }
  
  public ayks(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
  ...
  private static final CharSequence a(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
    if ((paramCharSequence instanceof ayki)) {
      return ((ayki)paramCharSequence).a();
    }
    return new ayki(paramCharSequence, paramInt1, paramInt2).a();
  }
  ...
  public String a()
  {
    ...
    int k = "[emoji]".length();
    localObject1 = (aykp[])getSpans(0, i, aykp.class);
    i = 0;
    if (j < localObject1.length)
    {
      ...
      for (;;)
      {
        ...
        continue;
        localObject2 = ayjw.a[(localObject2.jdField_a_of_type_Int & 0x7FFFFFFF)];
        localStringBuffer.replace(m + i, n + i, (String)localObject2);
        i += ((String)localObject2).length() - (n - m);
      }
    }
  ...
  public SpannableStringBuilder replace(int paramInt1, int paramInt2, CharSequence paramCharSequence, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      i = paramInt2;
      localObject = new ayki(paramCharSequence, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int).a();
  ...
  public CharSequence subSequence(int paramInt1, int paramInt2)
  {
    ...
    localObject2 = (aykp[])getSpans(i, paramInt1, aykp.class);
    if (paramInt1 - i > 0)
    {
      paramInt2 = 0;
      if (paramInt2 < localObject2.length)
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ((StringBuilder)localObject1).replace(j - i, k - i, ayla.a(localObject3.jdField_a_of_type_Int));
          }
          ...
          continue;
          Object localObject4 = (aykr)localException;
          localObject4 = anqu.a(((aykr)localObject4).e, ((aykr)localObject4).f);
          ...
          continue;
          ((StringBuilder)localObject1).replace(j - i, k - i, ayla.c(((aykp)localObject4).jdField_a_of_type_Int));
        }
      }
    }
    return localObject1;
  ...
  public String toString()
  {
    ...
    if (i < localObject1.length)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        localStringBuilder.replace(k, m, ayla.a(((aykp)localObject2).jdField_a_of_type_Int));
        continue;
        localObject2 = (aykr)localObject2;
        localObject2 = anqu.a(((aykr)localObject2).e, ((aykr)localObject2).f);
        ...
        if (QLog.isColorLevel())
        {
          ...
          continue;
          localStringBuilder.replace(k, m, ayla.c(((aykp)localObject2).jdField_a_of_type_Int));
          continue;
          if (QLog.isColorLevel()) {
