  ...
  public void a(Drawable paramDrawable, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      ...
      for (;;)
      {
        ...
        return;
        this.jdField_a_of_type_AndroidWidgetImageView.setAdjustViewBounds(true);
        this.jdField_a_of_type_AndroidWidgetImageView.setMaxWidth(ViewUtils.dip2px(120.0F));
        this.jdField_a_of_type_AndroidWidgetImageView.setMaxHeight(ViewUtils.dip2px(120.0F));
        this.jdField_a_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
      }
      if (paramInt == 2)
      {
        this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130840178);
        return;
      }
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130840179);
      return;
    }
