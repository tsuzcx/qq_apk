  ...
  implements Handler.Callback
{
  ...
  public static axnx a()
  {
    if (QLog.isColorLevel()) {
      QLog.i("AutoMonitor", 2, "onApplicationCreate ");
    }
    axnx localaxnx = new axnx();
    localaxnx.a(0);
    axpl.b(0, localaxnx, jdField_b_of_type_ArrayOfInt).step();
    ...
    jdField_a_of_type_Boolean = false;
    axpl.b(12, localaxnx, null).step();
    if (BaseApplicationImpl.sProcessId == 2)
    {
      axpl.b(10, localaxnx, null).step();
      axpl.b(39, localaxnx, null).step();
      ThreadManager.post(axpl.b(0, localaxnx, l), 10, null, false);
      axpl.b(0, localaxnx, jdField_k_of_type_ArrayOfInt).step();
    }
    label384:
    for (;;)
    {
      ...
      {
        axpl.b(0, localaxnx, r).step();
      }
      else if ((BaseApplicationImpl.sProcessId == 5) || (BaseApplicationImpl.sProcessId == 7))
      {
        axpl.b(10, localaxnx, null).step();
        axpl.b(7, localaxnx, null).step();
        axpl.b(0, localaxnx, jdField_i_of_type_ArrayOfInt).step();
        axpl.b(11, localaxnx, null).step();
        axpl.b(46, localaxnx, null).step();
      }
      ...
      else if (!BaseApplicationImpl.processName.endsWith(":qqfav"))
      {
        ...
        {
          ThreadManager.excute(axpl.b(0, localaxnx, jdField_a_of_type_ArrayOfInt), 16, null, false);
        }
        else
        {
          ...
          for (;;)
          {
            ...
            axpl.b(37, localaxnx, null).step();
            break;
            axpl.b(0, localaxnx, jdField_j_of_type_ArrayOfInt).step();
          }
        }
      }
    }
        ...
        if (!str1.isEmpty())
        {
          ...
          if (arrayOfString.length > 0)
          {
            ...
            if (i1 < i3)
            {
              ...
              aklb.jdField_a_of_type_JavaUtilSet.add(Integer.valueOf(Integer.parseInt(str2)));
              i1 += 1;
              continue;
            }
          }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ThreadManager.getSubThreadHandler().postAtFrontOfQueue(axpl.b(9, this, null));
      if (jdField_a_of_type_Int == 1) {
        ThreadManager.getSubThreadHandler().post(axpl.b(21, this, null));
      }
    }
    ...
    if (paramBoolean)
    {
      ...
      if ((BaseApplicationImpl.sShowTime <= 0L) || (!bbfj.g(BaseApplicationImpl.sApplication))) {
        break label314;
      }
    }
    label314:
  ...
  private void a(int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt)
  {
    ...
    paramArrayOfInt1 = axpl.b(0, this, paramArrayOfInt1);
    if (paramArrayOfInt2 != null)
    {
      this.jdField_f_of_type_Int = 2;
      this.jdField_g_of_type_Int = paramInt;
      paramArrayOfInt1.setResultListener(this.jdField_b_of_type_AndroidOsHandler, 10);
      paramArrayOfInt2 = axpl.b(0, this, paramArrayOfInt2);
  ...
  private void b(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {
      localTextView.setText(2131693582);
    }
    for (;;)
    {
      ...
      return;
      localTextView.setText(ajya.a(2131714358));
    }
  }
  ...
  public void a(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission == null) {
        this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission = ((CheckPermission)axpl.b(3, this, null));
      }
    ...
    if (this.jdField_e_of_type_Int == 2)
    {
      if (1 == BaseApplicationImpl.sProcessId) {
        ThreadManager.getFileThreadHandler().postDelayed(axpl.b(13, this, null), 1000L);
      }
      a(11, 1, 5L);
      a(3);
    }
    ...
    for (paramObject = (AppActivity)paramObject;; paramObject = null)
    {
      ...
      if (paramObject == null)
      {
        ...
        if (this.jdField_e_of_type_Int == 1)
        {
          ...
          {
            paramObject = o;
            axpl.b(0, this, paramObject).step();
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramIntent = (SetSplash)axpl.b(2, this, null);
          paramIntent.step();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      for (;;)
      {
        return true;
        a(4, 0, 300L);
        bool1 = axpl.b(12, this, null).step();
        ...
        if (this.jdField_a_of_type_MqqAppAppActivity != null)
        {
          ...
          if (this.jdField_a_of_type_MqqAppAppActivity != null)
          {
            bbkd.a(this.jdField_a_of_type_MqqAppAppActivity, "com.tencent.mobileqq.activity.MainActivity");
            bbkd.a(this.jdField_a_of_type_MqqAppAppActivity, SplashActivity.class.getName());
            return true;
            ...
            this.jdField_a_of_type_Axny.a(this);
            if (this.jdField_a_of_type_Long > 0L) {
      ...
      axpl.b(28, this, null).step();
      return true;
    } while (this.jdField_a_of_type_Axny.jdField_a_of_type_Boolean);
    this.jdField_a_of_type_Axny.a();
