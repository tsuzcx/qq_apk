  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject1 = paramView.getTag(2131378150);
    if ((localObject1 != null) && ((localObject1 instanceof bdtl)))
    {
      localObject6 = (bdtl)localObject1;
    ...
    for (;;)
    {
      ...
      if (this.a.v == 4)
      {
        ...
        {
          bdte.a(this.a);
          localObject2 = (onq)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(QQManagerFactory.EC_SHOP_ASSISTANT_MANAGER);
          if (localObject2 != null) {
            ((onq)localObject2).a(this.a, (Activity)localContext);
          }
        }
        else
        {
          ...
          long l1 = l2;
          if (((bdtl)localObject6).a.getDrawable() != null)
          {
            l1 = l2;
            if ((((bdtl)localObject6).a.getDrawable() instanceof URLDrawable))
            {
              localObject4 = (URLDrawable)((bdtl)localObject6).a.getDrawable();
              l1 = l2;
          ...
          localObject4 = (String)paramView.getTag(2131378157);
          if (!TextUtils.isEmpty((CharSequence)localObject4))
          {
            String str = bkyp.a(bkyp.a((String)localObject4, "progress", String.valueOf(l1)), "msgId", (String)localObject2);
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                try
                {
                  ...
                  localIntent.putExtra("big_brother_source_key", uuc.b(this.a.ab));
      ...
      else
      {
        if (pkh.a(this.a.a))
        {
          bool = bdte.a(localContext, this.a.a.uinType);
          localObject2 = new StringBuilder().append(this.a.a.mMsgUrl).append("&sourceAutoPlay=");
          if (bool) {}
          for (i = 1;; i = 0)
          {
            pkh.b(localContext, i);
            break;
          }
        }
        localObject2 = bdnp.a();
        if (!((bdnp)localObject2).a())
        {
        ...
        else if (((bdnp)localObject2).a(localContext, 3, this.a.a.uinType))
        {
          if ((this.a.a instanceof StructMsgForGeneralShare))
          {
            localObject2 = (StructMsgForGeneralShare)this.a.a;
