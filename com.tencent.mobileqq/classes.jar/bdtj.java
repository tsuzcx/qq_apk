  ...
  extends bdon
{
  ...
  public bdtj(String paramString)
  {
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if ((paramContext instanceof BaseActivity))
      {
        ...
        localObject1 = bhlg.a((QQAppInterface)localObject3, ((JSONObject)localObject2).optString("invitedUin"), 0);
        localStringBuilder.append("你邀请").append(bhlg.a((String)localObject1, 12.0F));
      }
      for (;;)
      {
        ...
        localStringBuilder.append("加入群聊“").append(bhlg.a((String)localObject1, 12.0F)).append("”，进入可查看详情。");
        this.ai = localStringBuilder.toString();
        return super.a(paramContext, paramView, paramBundle);
        label247:
        localStringBuilder.append(bhlg.a(bhlg.a((QQAppInterface)localObject3, (String)localObject1, 0), 12.0F)).append("邀请你");
      }
    }
