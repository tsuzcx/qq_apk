  ...
  implements Handler.Callback, IEventReceiver
{
  public static int a;
  public Handler a;
  private boln jdField_a_of_type_Boln;
  public bolr a;
  public bolu a;
  public bpyf a;
  public ArrayList<QIMTemplateItem> a;
  public HashMap<String, bolr> a;
  public wnx a;
  ...
  public HashMap<String, bolu> b;
  public Handler c;
  public ArrayList<QIMFilterCategoryItem> c;
  public HashMap<String, boky> c;
  public ArrayList<QIMFilterCategoryItem> d;
  public HashMap<String, bomb> d;
  ArrayList<bole> e;
  public HashMap<String, ArrayList<bolg>> e;
  ...
  public bolb()
  {
    ...
    this.jdField_b_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper(), new bold(this));
    ...
    this.jdField_a_of_type_ArrayOfBolf = new bolf[5];
    int i = 0;
    while (i < this.jdField_a_of_type_ArrayOfBolf.length)
    {
      this.jdField_a_of_type_ArrayOfBolf[i] = new bolf(i);
      i += 1;
    }
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), new bolc(this));
    this.jdField_a_of_type_Boln = new boln();
  }
  
  private void a(Activity paramActivity, int paramInt)
  {
    bolr localbolr = bpye.a().a[paramInt];
    if (localbolr != null) {
      localbolr.a(paramActivity, paramInt);
    }
    bpye.a().a(null, paramActivity, paramInt);
  }
  ...
  {
    bolk localbolk = (bolk)bojv.a(15);
    bomb localbomb = localbolk.a();
    if (localbomb != null)
    {
      localbomb.a(paramActivity, paramInt);
      if (paramInt == 0) {
        localbolk.a(null);
      }
    }
  ...
  public boky a(FilterDesc paramFilterDesc)
  {
    boky localboky2 = (boky)this.jdField_c_of_type_JavaUtilHashMap.get(paramFilterDesc.name);
    boky localboky1 = localboky2;
    if (localboky2 == null)
    {
      localboky1 = new boky(paramFilterDesc);
      this.jdField_c_of_type_JavaUtilHashMap.put(paramFilterDesc.name, localboky1);
    }
    return localboky1;
  }
  
  public bolf a(int paramInt)
  {
    return this.jdField_a_of_type_ArrayOfBolf[paramInt];
  }
  
  public boln a()
  {
    return this.jdField_a_of_type_Boln;
  }
  
  public bolr a(QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    bolr localbolr2 = (bolr)this.jdField_a_of_type_JavaUtilHashMap.get(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString);
    Object localObject1 = localbolr2;
    Object localObject2;
    Object localObject3;
    int j;
    int i;
    ...
    if (localbolr2 == null)
    {
      localbolr2 = new bolr(paramQIMFilterCategoryItem);
      localObject1 = paramQIMFilterCategoryItem.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (String)((Iterator)localObject1).next();
        localObject3 = bpye.a().a((String)localObject2);
        if (localObject3 != null) {
          localbolr2.c(a((FilterDesc)localObject3));
        ...
        if (k < n)
        {
          ...
          for (;;)
          {
            try
            {
              ...
              localObject3 = booi.a(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString, (String)localObject4, (String)localObject1, f1, f2, f3);
              if (localObject3 != null)
              {
                ((bokw)localObject3).a((SegmentKeeper)localObject2);
                localbolr2.c((bokw)localObject3);
                k += 1;
                break;
              }
              m = 1;
      ...
      if (paramQIMFilterCategoryItem.jdField_b_of_type_OrgJsonJSONArray != null)
      {
        ...
        if (m < i1)
        {
          ...
          try
          {
            ...
            k = i;
            localObject3 = booi.a((String)localObject2);
            if (localObject3 != null)
            {
              k = i;
              localbolr2.c((bokw)localObject3);
      ...
      if (paramQIMFilterCategoryItem.c != null)
      {
        ...
        if (m < i1)
        {
          ...
          try
          {
            ...
            k = j;
            localObject3 = booi.b((String)localObject2);
            if (localObject3 != null)
            {
              k = j;
              localbolr2.c((bokw)localObject3);
      ...
      else
      {
        for (;;)
        {
          try
          {
            ...
            j = i;
            localObject2 = booi.a(str3, (List)localObject3, f1, f2, f3);
            if (localObject2 != null)
            {
              j = i;
              ((bokw)localObject2).a((SegmentKeeper)localObject4);
              j = i;
              localbolr2.c((bokw)localObject2);
              k = i;
            }
            else
            {
          ...
          if (j == 0) {
            this.jdField_a_of_type_JavaUtilHashMap.put(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString, localbolr2);
          }
          bolr localbolr1 = localbolr2;
          localbolr1.jdField_a_of_type_JavaLangObject = paramQIMFilterCategoryItem;
          return localbolr1;
          label1280:
          break;
          label1283:
  ...
  public bolr a(QIMFilterCategoryItem paramQIMFilterCategoryItem, Activity paramActivity, Bundle paramBundle)
  {
    bolb localbolb = (bolb)bojv.a(5);
    bolr localbolr = localbolb.a(paramQIMFilterCategoryItem);
    localbolr.b(paramActivity, paramBundle.getInt("capture_scene", -1));
    localbolr.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
    localbolb.a(paramQIMFilterCategoryItem);
    switch (localbolr.jdField_a_of_type_Int)
    {
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.i("QCombo", 2, "applyCombo state = " + localbolr.jdField_a_of_type_Int);
      }
      return localbolr;
      a(new bolg(localbolr, paramBundle, paramActivity));
      paramQIMFilterCategoryItem = Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, 0, 0, localbolr);
  ...
  public bolr a(String paramString)
  {
    Object localObject1 = null;
    bolr localbolr = null;
    Object localObject2 = this.jdField_a_of_type_Bpyf;
    if (localObject2 != null)
    {
      localObject2 = ((bpyf)localObject2).a.jdField_a_of_type_JavaUtilArrayList.iterator();
      localObject1 = localbolr;
      if (((Iterator)localObject2).hasNext())
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (TextUtils.equals(localQIMFilterCategoryItem.jdField_a_of_type_JavaLangString, paramString)) {
            localbolr = a(localQIMFilterCategoryItem);
          }
        }
      }
    }
  ...
  public bolu a(QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    ...
    {
      localObject2 = (String)((Iterator)localObject1).next();
      localObject2 = bpye.a().a((String)localObject2);
      if (localObject2 != null) {
        localArrayList.add(localObject2);
      }
    }
    Object localObject2 = (bolu)this.jdField_b_of_type_JavaUtilHashMap.get(paramQIMFilterCategoryItem.jdField_a_of_type_JavaLangString);
    localObject1 = localObject2;
    if (localObject2 == null)
    {
      localObject1 = new bolu(paramQIMFilterCategoryItem);
      localObject2 = localArrayList.iterator();
      while (((Iterator)localObject2).hasNext()) {
        ((bolu)localObject1).c(a((FilterDesc)((Iterator)localObject2).next()));
      }
  ...
  public bolu a(String paramString)
  {
    Object localObject = this.jdField_a_of_type_Bpyf;
    if (localObject != null)
    {
      localObject = ((bpyf)localObject).a.jdField_c_of_type_JavaUtilArrayList.iterator();
  ...
  public bomb a(QIMTemplateItem paramQIMTemplateItem)
  {
    Object localObject2 = (bomb)this.jdField_d_of_type_JavaUtilHashMap.get(paramQIMTemplateItem.jdField_a_of_type_JavaLangString);
    ...
    if (localObject2 == null)
    {
      localObject1 = new bomb(paramQIMTemplateItem);
      if (QLog.isColorLevel()) {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localObject4 = bpye.a().a((String)localObject3);
        if (localObject4 != null) {
          ((bomb)localObject1).d(a((FilterDesc)localObject4));
        } else if (QLog.isColorLevel()) {
      ...
      if (paramQIMTemplateItem.jdField_a_of_type_OrgJsonJSONArray != null)
      {
        ...
        if (i < j)
        {
          ...
          try
          {
            ...
            localObject4 = booi.a(paramQIMTemplateItem.jdField_a_of_type_JavaLangString, (String)localObject5, (String)localObject2, f1, f2, f3);
            if (localObject4 != null)
            {
              ((bokw)localObject4).a((SegmentKeeper)localObject3);
              ((bomb)localObject1).d((bokw)localObject4);
            }
            else if (QLog.isColorLevel())
            {
      ...
      if (paramQIMTemplateItem.jdField_b_of_type_OrgJsonJSONArray != null)
      {
        ...
        if (i < j)
        {
          ...
          try
          {
            ...
            localObject4 = booi.a((String)localObject3);
            if (localObject4 != null) {
              ((bomb)localObject1).d((bokw)localObject4);
            } else if (QLog.isColorLevel()) {
      ...
      if (paramQIMTemplateItem.c != null)
      {
        ...
        if (i < j)
        {
          ...
          try
          {
            ...
            localObject4 = booi.b((String)localObject3);
            if (localObject4 != null) {
              ((bomb)localObject1).d((bokw)localObject4);
            } else if (QLog.isColorLevel()) {
      ...
      else
      {
        for (;;)
        {
          try
          {
            ...
            localObject3 = booi.a(str3, (List)localObject4, f1, f2, f3);
            if (localObject3 != null)
            {
              ((bokw)localObject3).a((SegmentKeeper)localObject5);
              ((bomb)localObject1).d((bokw)localObject3);
            }
            else if (QLog.isColorLevel())
            {
          ...
          ((bomb)localObject1).jdField_a_of_type_JavaLangObject = paramQIMTemplateItem;
          return localObject1;
          label1086:
          i += 1;
          break;
  ...
  public bomb a(QIMTemplateItem paramQIMTemplateItem, Activity paramActivity, Bundle paramBundle)
  {
    paramQIMTemplateItem = ((bolb)bojv.a(5)).a(paramQIMTemplateItem);
    ...
    for (;;)
    {
      ...
      a(new bolg(paramQIMTemplateItem, paramBundle, paramActivity));
  ...
  public bpyg a()
  {
    if (this.jdField_a_of_type_Bpyf != null) {
      return this.jdField_a_of_type_Bpyf.a;
    }
    return null;
  }
  ...
  public QIMFilterCategoryItem a(int paramInt)
  {
    ...
    Object localObject1 = this.jdField_a_of_type_Bpyf;
    if (localObject1 == null) {
      return null;
    }
    localObject1 = ((bpyf)localObject1).a;
    if (localObject1 == null) {
      return null;
    }
    localObject1 = ((bpyg)localObject1).jdField_a_of_type_JavaUtilArrayList;
    if (localObject1 != null)
    {
  ...
  public QIMFilterCategoryItem a(Activity paramActivity, bnbf parambnbf, int paramInt)
  {
    parambnbf = (ComboProviderView)paramActivity.findViewById(2131364144);
    if (parambnbf != null)
    {
      parambnbf.b();
      parambnbf = bosj.a().a(parambnbf.g);
      if ((parambnbf != null) && (parambnbf.a() != null))
      {
        parambnbf.a().a();
        parambnbf.a().a();
        parambnbf.a().a();
    ...
    parambnbf = (StaticStickerProviderView)paramActivity.findViewById(2131364155);
    if (parambnbf != null) {
      parambnbf.b();
    }
    parambnbf = (QIMFilterProviderView)paramActivity.findViewById(2131364146);
    if (parambnbf != null) {
      parambnbf.b();
    }
    paramActivity = (MusicProviderView)paramActivity.findViewById(2131364154);
    if (paramActivity != null) {
      paramActivity.b();
    }
    return bpye.a().a(paramInt);
  }
  
  public QIMFilterCategoryItem a(bolr parambolr, ArrayList<QIMFilterCategoryItem> paramArrayList)
  {
    ...
    if (parambolr != null)
    {
      ...
      if ((parambolr.jdField_a_of_type_JavaLangObject instanceof QIMFilterCategoryItem))
      {
        localObject3 = (QIMFilterCategoryItem)parambolr.jdField_a_of_type_JavaLangObject;
    ...
    label280:
    label283:
    for (localObject1 = null;; localObject1 = parambolr)
    {
      if (localObject1 == null)
      {
        localObject3 = ((QIMFilterCategoryItem)localObject3).jdField_a_of_type_JavaUtilArrayList.iterator();
        parambolr = (bolr)localObject2;
        do
        {
          localObject2 = parambolr;
        ...
        if (QQAVImageFilterConstants.getFilterType(((FilterDesc)localObject2).id) == 2)
        {
          ...
          {
            parambolr = (QIMFilterCategoryItem)paramArrayList.next();
            if ((parambolr.jdField_a_of_type_JavaUtilArrayList.size() == 1) && (parambolr.jdField_a_of_type_JavaUtilArrayList.contains(((FilterDesc)localObject2).name)))
            {
              localObject1 = parambolr;
              return localObject1;
              label176:
  ...
  public QIMFilterCategoryItem a(bomb parambomb, ArrayList<QIMFilterCategoryItem> paramArrayList)
  {
    Object localObject3 = null;
    Object localObject2 = null;
    Object localObject1 = localObject3;
    ...
    {
      localObject1 = localObject3;
      if ((parambomb.jdField_a_of_type_JavaLangObject instanceof QIMTemplateItem))
      {
        localObject3 = (QIMTemplateItem)parambomb.jdField_a_of_type_JavaLangObject;
    ...
    label280:
    label283:
    for (localObject1 = null;; localObject1 = parambomb)
    {
      if (localObject1 == null)
      {
        localObject3 = ((QIMTemplateItem)localObject3).jdField_a_of_type_JavaUtilArrayList.iterator();
        parambomb = (bomb)localObject2;
        do
        {
          localObject2 = parambomb;
          if (!((Iterator)localObject3).hasNext()) {
            break;
          }
          localObject2 = (String)((Iterator)localObject3).next();
        ...
        if (QQAVImageFilterConstants.getFilterType(((FilterDesc)localObject2).id) == 2)
        {
          ...
          while (paramArrayList.hasNext())
          {
            parambomb = (QIMFilterCategoryItem)paramArrayList.next();
            if ((parambomb.jdField_a_of_type_JavaUtilArrayList.size() == 1) && (parambomb.jdField_a_of_type_JavaUtilArrayList.contains(((FilterDesc)localObject2).name)))
            {
              localObject1 = parambomb;
              return localObject1;
              label176:
              Iterator localIterator1 = paramArrayList.iterator();
              parambomb = null;
  ...
  {
    Object localObject = bpye.a().a(paramInt);
    if (localObject != null)
    {
      localObject = a((QIMFilterCategoryItem)localObject);
      if ((localObject != null) && (((bolr)localObject).jdField_a_of_type_Int == 1))
      {
        localObject = new Bundle();
        ((Bundle)localObject).putInt("capture_scene", paramInt);
        bolr localbolr = bpye.a().a[paramInt];
        if (localbolr != null) {
          a((QIMFilterCategoryItem)localbolr.jdField_a_of_type_JavaLangObject, paramActivity, (Bundle)localObject);
        }
        if (QLog.isColorLevel()) {
  ...
  {
    bolf[] arrayOfbolf = this.jdField_a_of_type_ArrayOfBolf;
    int j = arrayOfbolf.length;
    int i = 0;
    while (i < j)
    {
      arrayOfbolf[i].c(paramActivity);
      i += 1;
    }
  }
  ...
  public void a(bole parambole)
  {
    synchronized (this.jdField_e_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_e_of_type_JavaUtilArrayList.contains(parambole)) {
        this.jdField_e_of_type_JavaUtilArrayList.add(parambole);
      }
      return;
    }
  }
  
  public void a(bolg parambolg)
  {
    synchronized (this.jdField_e_of_type_JavaUtilHashMap)
    {
      String str = parambolg.jdField_a_of_type_Bolj.b();
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadComboSuccess captureSet " + parambolj);
    }
    if ((parambolj.jdField_a_of_type_JavaLangObject instanceof QIMFilterCategoryItem)) {}
    synchronized (this.jdField_d_of_type_JavaUtilArrayList)
    {
      this.jdField_d_of_type_JavaUtilArrayList.add((QIMFilterCategoryItem)parambolj.jdField_a_of_type_JavaLangObject);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1);
      Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, 0, 0, parambolj).sendToTarget();
      return;
    }
  }
  
  public void a(bolj parambolj, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadComboFailed captureset " + parambolj);
    }
    if ((parambolj.jdField_a_of_type_JavaLangObject instanceof QIMFilterCategoryItem)) {}
    synchronized (this.jdField_d_of_type_JavaUtilArrayList)
    {
      this.jdField_d_of_type_JavaUtilArrayList.add((QIMFilterCategoryItem)parambolj.jdField_a_of_type_JavaLangObject);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1);
      Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, paramInt, 0, parambolj).sendToTarget();
      return;
    }
  }
  ...
  public void a(bolr parambolr)
  {
    ...
    while (localIterator.hasNext()) {
      ((bole)localIterator.next()).a(parambolr);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadTemplateSuccess templateSet " + parambomb);
    }
    if ((parambomb.jdField_a_of_type_JavaLangObject instanceof QIMTemplateItem)) {}
    synchronized (this.jdField_b_of_type_JavaUtilArrayList)
    {
      this.jdField_b_of_type_JavaUtilArrayList.add((QIMTemplateItem)parambomb.jdField_a_of_type_JavaLangObject);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(3);
      Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, 0, 0, parambomb).sendToTarget();
      return;
    }
  }
  
  public void a(bomb parambomb, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "downloadTemplateFailed templateSet " + parambomb + ", error " + paramInt);
    }
    if ((parambomb.jdField_a_of_type_JavaLangObject instanceof QIMTemplateItem)) {}
    synchronized (this.jdField_b_of_type_JavaUtilArrayList)
    {
      this.jdField_b_of_type_JavaUtilArrayList.add((QIMTemplateItem)parambomb.jdField_a_of_type_JavaLangObject);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(3);
      Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 7, paramInt, 0, parambomb).sendToTarget();
      return;
    }
  }
  ...
  public void a(bpyf parambpyf)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (parambpyf != null)
      {
        ...
        this.jdField_a_of_type_Boln.a(parambpyf);
        Message.obtain(this.jdField_c_of_type_AndroidOsHandler, 9, parambpyf).sendToTarget();
      }
      a(1);
      return;
    }
  ...
  public void a(QIMFilterCategoryItem paramQIMFilterCategoryItem, Activity paramActivity, Bundle paramBundle)
  {
    ...
    QIMFilterCategoryItem localQIMFilterCategoryItem = bpye.a().b(i);
    boolean bool1;
    boolean bool2;
    ...
    for (;;)
    {
      ...
      break label58;
      label171:
      paramQIMFilterCategoryItem = ((bolb)bojv.a(5)).a(paramQIMFilterCategoryItem);
      ...
      while (QLog.isColorLevel())
      {
        ...
        return;
        a(new bolg(paramQIMFilterCategoryItem, paramBundle, paramActivity));
        ...
        else
        {
          ...
          continue;
          a(new bolg(paramQIMFilterCategoryItem, paramBundle, paramActivity));
          boud.a(paramQIMFilterCategoryItem).a();
  ...
  public boolean a()
  {
    for (;;)
    {
      ...
      synchronized (this.jdField_d_of_type_JavaUtilArrayList)
      {
        ...
        if (((bolj)???).jdField_a_of_type_Int == 1)
        {
          int j = ((bolj)???).a();
          if (j != ((bolj)???).jdField_a_of_type_Int)
          {
            if (QLog.isColorLevel()) {
              QLog.d("QCombo", 2, "buildComboBatch progress: " + localQIMFilterCategoryItem1.jdField_b_of_type_JavaLangString + ", progress: " + ((bolj)???).jdField_b_of_type_Int);
            }
            ((bolj)???).jdField_a_of_type_Int = j;
          }
          j = (int)(10000.0F * ((bolj)???).a());
          if (j != ((bolj)???).jdField_b_of_type_Int)
          {
            ((bolj)???).jdField_b_of_type_Int = j;
            if (QLog.isColorLevel()) {
              QLog.i("QCombo", 2, "buildComboBatch progress: " + j + ", progress: " + ((bolj)???).jdField_b_of_type_Int);
            }
          }
          bool = true;
          i -= 1;
      ...
      if (((bolj)???).jdField_a_of_type_Int == 2)
      {
        ((bolj)???).a();
        localQIMFilterCategoryItem2 = (QIMFilterCategoryItem)this.jdField_c_of_type_JavaUtilArrayList.remove(i);
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMFilterCategoryItem2.jdField_b_of_type_JavaLangString + ",  STATE_NEED_DOWNLOAD progress: " + ((bolj)???).jdField_b_of_type_Int);
        }
        bool = true;
      }
      else if (((bolj)???).jdField_a_of_type_Int == 3)
      {
        ((bolj)???).a();
        ((bolj)???).jdField_b_of_type_Int = 10000;
        localQIMFilterCategoryItem2 = (QIMFilterCategoryItem)this.jdField_c_of_type_JavaUtilArrayList.remove(i);
        boud.a(???).b();
        Message.obtain(this.jdField_b_of_type_AndroidOsHandler, 2, ???).sendToTarget();
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMFilterCategoryItem2.jdField_b_of_type_JavaLangString + ", STATE_DOWNLOADED progress: " + ((bolj)???).jdField_b_of_type_Int);
        }
        bool = true;
        continue;
        label470:
  ...
  public boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      label411:
      int j;
      if ((paramMessage.obj instanceof bolu))
      {
        paramMessage = (bolu)paramMessage.obj;
        if (i == 0)
        {
        ...
        else
        {
          for (;;)
          {
            ...
            localObject3 = (bolg)((Iterator)localObject2).next();
            i = ((bolg)localObject3).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
            ??? = bpye.a().b(i);
            if ((localObject1 != null) && (??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString)) && (!this.jdField_a_of_type_Boolean))
            {
              ...
              ((bnbo)bojv.a(13)).a(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString);
              ??? = (Activity)((bolg)localObject3).jdField_a_of_type_JavaLangRefWeakReference.get();
              if (??? != null)
              {
                ...
                synchronized (this.jdField_e_of_type_JavaUtilArrayList)
                {
                  ...
                  ((bole)((Iterator)???).next()).a(paramMessage, true, 0, ((bolg)localObject3).jdField_a_of_type_AndroidOsBundle);
                }
                boud.a(paramMessage).c();
                break;
              }
            }
          }
          this.jdField_a_of_type_Bolu = paramMessage;
          continue;
        }
        localObject2 = ((ArrayList)localObject2).iterator();
        while (((Iterator)localObject2).hasNext())
        {
          localObject3 = (bolg)((Iterator)localObject2).next();
          j = ((bolg)localObject3).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
          ??? = bpye.a().b(j);
          if ((localObject1 != null) && (??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString)))
          {
            ...
            ((bnbo)bojv.a(13)).a(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString);
            if ((Activity)((bolg)localObject3).jdField_a_of_type_JavaLangRefWeakReference.get() != null) {
              synchronized (this.jdField_e_of_type_JavaUtilArrayList)
              {
                ??? = this.jdField_e_of_type_JavaUtilArrayList.iterator();
                if (((Iterator)???).hasNext()) {
                  ((bole)((Iterator)???).next()).a(paramMessage, false, i, ((bolg)localObject3).jdField_a_of_type_AndroidOsBundle);
                }
              }
            }
            QQToast.a(BaseApplicationImpl.sApplication, anni.a(2131700159), 0).a();
          }
        }
      }
      else if ((paramMessage.obj instanceof bolr))
      {
        paramMessage = (bolr)paramMessage.obj;
        if (i == 0)
        {
          boud.a(paramMessage).b();
          localObject1 = (QIMFilterCategoryItem)paramMessage.jdField_a_of_type_JavaLangObject;
        ...
        else
        {
          ...
          for (;;)
          {
            ...
            if (??? != null)
            {
              ...
              if ((??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString)))
              {
                ...
                ((bnbo)bojv.a(13)).b(((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString);
                b((Activity)???, i);
                if (!boky.a(paramMessage, i)) {
                  paramMessage.a((Activity)???, i);
                }
                synchronized (this.jdField_e_of_type_JavaUtilArrayList)
                {
          ...
          label982:
          this.jdField_a_of_type_Bolr = paramMessage;
          continue;
        }
        localObject2 = ((ArrayList)localObject3).iterator();
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if ((??? != null) && (TextUtils.equals(((QIMFilterCategoryItem)???).jdField_a_of_type_JavaLangString, ((QIMFilterCategoryItem)localObject1).jdField_a_of_type_JavaLangString)))
          {
            ...
            if (??? != null)
            {
              ...
              ??? = (bolb)bojv.a(5);
              ??? = ((bolb)???).jdField_a_of_type_Bolr;
              if (??? != null) {
                ((bolb)???).a((QIMFilterCategoryItem)((bolr)???).jdField_a_of_type_JavaLangObject, (Activity)???, ((bolg)localObject3).jdField_a_of_type_AndroidOsBundle);
              }
            }
            QQToast.a(BaseApplicationImpl.sApplication, anni.a(2131700161), 0).a();
          }
        }
      }
      else if ((paramMessage.obj instanceof bomb))
      {
        localObject1 = (bolk)bojv.a(15);
        paramMessage = (bomb)paramMessage.obj;
        if (i == 0)
        {
          boud.a(paramMessage).b();
        ...
        else
        {
          ...
          for (;;)
          {
            ...
            ??? = (bolg)((Iterator)localObject3).next();
            ??? = (Activity)((bolg)???).jdField_a_of_type_JavaLangRefWeakReference.get();
            if (??? != null)
            {
              i = ((bolg)???).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
              ??? = ((bolk)localObject1).a(i);
              if ((??? != null) && (TextUtils.equals(((QIMTemplateItem)???).jdField_a_of_type_JavaLangString, ((QIMTemplateItem)localObject2).jdField_a_of_type_JavaLangString)))
              {
                ...
                a((Activity)???, i);
                if (!((bolk)localObject1).a(paramMessage, i)) {
                  paramMessage.a((Activity)???, i);
                }
                synchronized (this.jdField_e_of_type_JavaUtilArrayList)
                {
                  ...
                  ((bole)((Iterator)???).next()).a(paramMessage, true, 0, ((bolg)???).jdField_a_of_type_AndroidOsBundle);
                }
                boud.a(paramMessage).c();
                break;
              }
          ...
          label1590:
          ((bolk)localObject1).a(paramMessage);
          continue;
        }
        localObject3 = ((ArrayList)???).iterator();
        ...
        {
          ??? = (bolg)((Iterator)localObject3).next();
          j = ((bolg)???).jdField_a_of_type_AndroidOsBundle.getInt("capture_scene", -1);
          ??? = ((bolk)localObject1).a(j);
          if ((??? != null) && (TextUtils.equals(((QIMTemplateItem)???).jdField_a_of_type_JavaLangString, ((QIMTemplateItem)localObject2).jdField_a_of_type_JavaLangString)))
          {
            if (QLog.isColorLevel()) {
            ...
            if (??? != null)
            {
              synchronized (this.jdField_e_of_type_JavaUtilArrayList)
              {
                ...
                if (((Iterator)localObject7).hasNext()) {
                  ((bole)((Iterator)localObject7).next()).a(paramMessage, false, i, ((bolg)???).jdField_a_of_type_AndroidOsBundle);
                }
              }
              ??? = ((bolk)localObject1).a();
              Object localObject7 = (bolb)bojv.a(5);
              if (??? != null) {
                ((bolb)localObject7).a((QIMTemplateItem)((bomb)???).jdField_a_of_type_JavaLangObject, (Activity)???, ((bolg)???).jdField_a_of_type_AndroidOsBundle);
              }
            }
            QQToast.a(BaseApplicationImpl.sApplication, anni.a(2131700160), 0).a();
          }
        }
        paramMessage = (bpyf)paramMessage.obj;
        try
        {
          localObject1 = this.jdField_e_of_type_JavaUtilArrayList.iterator();
          while (((Iterator)localObject1).hasNext()) {
            ((bole)((Iterator)localObject1).next()).a(paramMessage);
          }
        }
        finally {}
      }
  ...
  public void b()
  {
    this.jdField_a_of_type_Boln.a();
  }
  
  public void b(bole parambole)
  {
    synchronized (this.jdField_e_of_type_JavaUtilArrayList)
    {
      this.jdField_e_of_type_JavaUtilArrayList.remove(parambole);
      return;
    }
  }
  
  public void b(bolj parambolj)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "notifyDownloadBegin combo " + parambolj);
    }
    synchronized (this.jdField_d_of_type_JavaUtilArrayList)
    {
      this.jdField_d_of_type_JavaUtilArrayList.add((QIMFilterCategoryItem)parambolj.jdField_a_of_type_JavaLangObject);
  ...
  public void b(bomb parambomb)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCombo", 2, "notifyDownloadTemplateBegin templateSet " + parambomb);
    }
    synchronized (this.jdField_b_of_type_JavaUtilArrayList)
    {
      this.jdField_b_of_type_JavaUtilArrayList.add((QIMTemplateItem)parambomb.jdField_a_of_type_JavaLangObject);
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaUtilArrayList)
      {
        ...
        if (((bolj)???).jdField_a_of_type_Int == 1)
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("QCombo", 2, "buildComboBatch progress: " + localQIMTemplateItem1.jdField_b_of_type_JavaLangString + ", progress: " + ((bolj)???).jdField_b_of_type_Int);
            }
            ((bolj)???).jdField_a_of_type_Int = j;
          }
          j = (int)(10000.0F * ((bolj)???).a());
      ...
      if (((bolj)???).jdField_a_of_type_Int == 2)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMTemplateItem2.jdField_b_of_type_JavaLangString + ",  STATE_NEED_DOWNLOAD progress: " + ((bolj)???).jdField_b_of_type_Int);
        }
        bool = true;
      }
      else if (((bolj)???).jdField_a_of_type_Int == 3)
      {
        ...
        Message.obtain(this.jdField_b_of_type_AndroidOsHandler, 2, ???).sendToTarget();
        if (QLog.isColorLevel()) {
          QLog.i("QCombo", 2, "removeComboBatch: " + localQIMTemplateItem2.jdField_b_of_type_JavaLangString + ", STATE_DOWNLOADED progress: " + ((bolj)???).jdField_b_of_type_Int);
        }
        bool = true;
        continue;
        label458:
  ...
  public void c()
  {
    bpye.a().a(BaseApplicationImpl.getContext(), null, false);
  ...
  public boolean c()
  {
    return (this.jdField_a_of_type_Wnx.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Wnx.b);
  }
  ...
  public void e()
  {
    bpyf localbpyf = this.jdField_a_of_type_Bpyf;
    if (QLog.isColorLevel()) {
      QLog.d("QCombo", 2, "randomliseData " + localbpyf);
    }
    if (localbpyf != null)
    {
      localbpyf.a();
  ...
  public void f()
  {
    a().notifyObservers(bolh.class, 971, true, null);
  }
