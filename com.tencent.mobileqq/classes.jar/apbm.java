...
{
  public static int a;
  amqq jdField_a_of_type_Amqq = new apbp(this);
  private Resources jdField_a_of_type_AndroidContentResResources;
  public SparseArray<ArrayList<String>> a;
  private apbc jdField_a_of_type_Apbc;
  public apbd a;
  private apbf jdField_a_of_type_Apbf = new apbo(this);
  private apbl jdField_a_of_type_Apbl = new apbn(this);
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  public Runnable a;
  public String a;
  public ArrayList<WeakReference<anhl>> a;
  public ConcurrentHashMap<String, DynamicAvatar> a;
  public volatile boolean a;
  private Runnable b;
  public String b;
  public ArrayList<WeakReference<anhl>> b;
  public ArrayList<WeakReference<anhl>> c;
  public ArrayList<WeakReference<anhl>> d;
  ...
  public apbm(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentCommonAppAppInterface.addObserver(this.jdField_a_of_type_Apbl, true);
    this.d = new ArrayList();
    this.c = new ArrayList();
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_b_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_Apbd = new apbd(paramAppInterface);
    this.jdField_a_of_type_Apbd.a(this.jdField_a_of_type_Apbf);
    this.jdField_a_of_type_AndroidContentResResources = BaseApplicationImpl.getContext().getResources();
    a();
    jdField_a_of_type_Int = this.jdField_a_of_type_Apbc.jdField_a_of_type_Int;
  ...
  private Setting a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 18)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof NearbyAppInterface)) {
        localObject1 = ((anho)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(216)).a(paramString);
      }
    }
    do
    {
  ...
  public static String a(anhl paramanhl, boolean paramBoolean)
  {
    if (paramanhl == null) {
      return "";
    }
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(paramanhl.jdField_b_of_type_Int).append("_").append(paramanhl.jdField_c_of_type_Int).append("_").append(paramanhl.jdField_a_of_type_JavaLangString);
    if ((paramBoolean) || ((paramanhl.jdField_e_of_type_Boolean) && (!TextUtils.isEmpty(paramanhl.jdField_b_of_type_JavaLangString)))) {
      localStringBuilder.append("_").append(paramanhl.jdField_b_of_type_JavaLangString);
    }
    return localStringBuilder.toString();
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    synchronized (this.c)
    {
      ...
      if (j >= 0)
      {
        ...
        {
          anhl localanhl = (anhl)localWeakReference.get();
          if (localanhl == null) {
            this.c.remove(j);
          } else if (paramString1.equals(localanhl.jdField_d_of_type_JavaLangString)) {
            if (TextUtils.isEmpty(paramString2))
            {
              localanhl.jdField_a_of_type_ComTencentImageURLDrawable = null;
              localanhl.a();
              this.c.remove(j);
            }
            else
            {
              localanhl.jdField_b_of_type_JavaLangString = paramString2;
              localanhl.jdField_c_of_type_JavaLangString = paramString3;
              if ((localanhl.jdField_a_of_type_MqqUtilWeakReference == null) || (localanhl.jdField_a_of_type_MqqUtilWeakReference.get() == null) || (!paramString2.equals(((DynamicAvatarView)localanhl.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_JavaLangString))) {
                break label225;
              }
  ...
  private void e()
  {
    ...
    {
      ThreadManager.getUIHandler().postDelayed(this.jdField_b_of_type_JavaLangRunnable, 10000L);
  ...
  public apbc a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Q.dynamicAvatar", 2, "getConfig DynamicAvatarConfig|" + this.jdField_a_of_type_Apbc);
    }
  ...
  public apbd a()
  {
    return this.jdField_a_of_type_Apbd;
  }
  ...
  public void a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Q.dynamicAvatar", 2, "DynamicAvatarConfig|init config:" + this.jdField_a_of_type_Apbc + ",costTime:" + (System.currentTimeMillis() - l));
    }
  }
  ...
  public void a(anhl paramanhl)
  {
    ...
    synchronized (this.d)
    {
      this.d.remove(paramanhl.jdField_b_of_type_MqqUtilWeakReference);
    }
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramanhl.jdField_b_of_type_MqqUtilWeakReference);
      this.jdField_b_of_type_JavaUtilArrayList.remove(paramanhl.jdField_b_of_type_MqqUtilWeakReference);
      synchronized (this.c)
      {
        this.c.remove(paramanhl.jdField_b_of_type_MqqUtilWeakReference);
        return;
      }
      paramanhl = finally;
      throw paramanhl;
  ...
  public void a(anhl paramanhl, boolean paramBoolean)
  {
    if (paramanhl == null) {
      return;
    }
    if (paramBoolean)
    {
      String str = a(paramanhl, false);
      ArrayList localArrayList2 = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramanhl.jdField_e_of_type_Int);
      ArrayList localArrayList1 = localArrayList2;
      if (localArrayList2 == null)
      {
        localArrayList1 = new ArrayList();
        this.jdField_a_of_type_AndroidUtilSparseArray.put(paramanhl.jdField_e_of_type_Int, localArrayList1);
      }
      localArrayList1.add(str);
      localArrayList1.add(a(paramanhl, true));
      if ((paramanhl.jdField_e_of_type_Int == 1) || (paramanhl.jdField_e_of_type_Int == 0)) {
        ThreadManager.post(new DynamicAvatarManager.6(this, paramanhl, System.currentTimeMillis()), 5, null, true);
      }
      if (paramanhl.jdField_a_of_type_MqqUtilWeakReference.get() != null) {
        ((DynamicAvatarView)paramanhl.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_JavaLangString = "";
      }
    }
    ThreadManager.postImmediately(new DynamicAvatarManager.7(this, paramanhl), null, true);
  }
  
  public void a(anhl paramanhl, boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((this.c.size() < jdField_a_of_type_Int) || (paramBoolean1))
    {
      ??? = paramanhl.jdField_d_of_type_JavaLangString;
      synchronized (this.c)
      {
        this.c.add(paramanhl.jdField_b_of_type_MqqUtilWeakReference);
        if (paramBoolean1) {}
      }
      for (;;)
      {
        ...
        {
          this.d.remove(paramanhl.jdField_b_of_type_MqqUtilWeakReference);
          ??? = new DynamicAvatarManager.3(this, paramanhl, (String)???);
          if (!paramBoolean2)
          {
            l1 = 0L;
            long l2 = l1;
            if (DeviceInfoUtil.getCpuNumber() <= 2) {
              l2 = l1 * 2L;
            }
        ...
        if (paramanhl.jdField_e_of_type_Int == 0) {
          l1 = 1500L;
        } else {
          l1 = 400L;
        }
    ...
    synchronized (this.d)
    {
      this.d.add(paramanhl.jdField_b_of_type_MqqUtilWeakReference);
      return;
    }
  }
  
  public void a(apbg paramapbg)
  {
    if (paramapbg == null) {}
    while (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
      return;
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          if ((paramapbg == null) || (paramapbg.jdField_a_of_type_JavaUtilArrayList == null) || (paramapbg.jdField_a_of_type_JavaUtilArrayList.isEmpty())) {
            continue;
          }
          paramapbg = paramapbg.jdField_a_of_type_JavaUtilArrayList.iterator();
          if (!paramapbg.hasNext()) {
            continue;
          }
          localObject1 = DynamicAvatar.convertFrom((apbh)paramapbg.next());
          if (localObject1 == null) {
            continue;
          }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramString.basicSmallUrl)) {
        localObject = apbd.a(paramString.basicSmallUrl);
      }
      try
      {
        ...
        if (!TextUtils.isEmpty(paramString.basicMiddleUrl)) {
          localObject = apbd.a(paramString.basicMiddleUrl);
        }
      }
      catch (Exception localException1)
      {
        try
        {
          do
          {
            ...
            paramString = apbd.a(paramString.basicBigUrl);
            try
            {
  ...
  {
    if ((paramBoolean) && (this.jdField_a_of_type_Apbc != null) && (this.jdField_a_of_type_Apbc.jdField_a_of_type_Boolean)) {}
    synchronized (this.jdField_a_of_type_Apbc)
    {
      this.jdField_a_of_type_Apbc.a();
      if (QLog.isColorLevel()) {
        QLog.d("Q.dynamicAvatar", 2, "---onDpcPullFinished---|mDynamicAvatarConfig:" + this.jdField_a_of_type_Apbc);
      }
      if (QLog.isColorLevel()) {
  ...
  public boolean a(int paramInt)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.dynamicAvatar", 2, "isPlayDynamicAvatar|source:" + paramInt + ",isPlay:" + bool1 + "\n" + this.jdField_a_of_type_Apbc);
      }
      return bool1;
      bool1 = this.jdField_a_of_type_Apbc.jdField_c_of_type_Boolean;
      continue;
      bool1 = this.jdField_a_of_type_Apbc.d;
      continue;
      bool1 = this.jdField_a_of_type_Apbc.f;
      continue;
      bool1 = this.jdField_a_of_type_Apbc.g;
      continue;
      bool1 = this.jdField_a_of_type_Apbc.jdField_e_of_type_Boolean;
      continue;
      bool1 = this.jdField_a_of_type_Apbc.h;
      continue;
      bool1 = true;
      continue;
      bool1 = this.jdField_a_of_type_Apbc.f;
  ...
  @TargetApi(11)
  public boolean a(anhl paramanhl)
  {
    int i = 640;
    Object localObject1;
    Object localObject2;
    ...
    if (!paramanhl.f)
    {
      localObject1 = a(paramanhl, false);
      localObject2 = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramanhl.jdField_e_of_type_Int);
    ...
    File localFile = apbd.a(paramanhl.jdField_b_of_type_JavaLangString);
    if (paramanhl.jdField_d_of_type_Int == 640) {}
    for (;;)
    {
      URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
      localURLDrawableOptions.mRequestWidth = i;
      localURLDrawableOptions.mRequestHeight = i;
      localObject2 = paramanhl.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
      localObject1 = localObject2;
      ...
      ((VideoDrawable.VideoDrawableParams)localObject1).mRequestedFPS = this.jdField_a_of_type_Apbc.jdField_c_of_type_Int;
      int j = i;
      if (bbyp.b()) {
        j = bfvo.a(i);
      }
      ...
      boolean bool2 = paramanhl.a(URLDrawable.getDrawable(localFile, localURLDrawableOptions));
      bool1 = bool2;
      if (!bool2) {
        break;
      }
      ...
      bool1 = bool2;
      if (anhl.jdField_a_of_type_ArrayOfInt.length <= paramanhl.jdField_e_of_type_Int) {
        break;
      }
      bool1 = bool2;
      ...
      apby.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, "0X800711C", anhl.jdField_a_of_type_ArrayOfInt[paramanhl.jdField_e_of_type_Int]);
      return bool2;
      if (paramanhl.jdField_d_of_type_Int == 200) {
        i = 200;
      } else {
        i = 100;
      }
  ...
  public void b(anhl paramanhl)
  {
    ...
    do
    {
      ...
      ??? = a(paramanhl, false);
      localArrayList = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramanhl.jdField_e_of_type_Int);
    ...
    a(paramanhl, true, true);
  }
  
  public void b(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (this.jdField_a_of_type_Apbd == null) {
      return;
    }
    this.jdField_a_of_type_Apbd.a(paramString);
  }
    ...
    synchronized (this.d)
    {
      ...
      if (i >= 0)
      {
        ...
        if ((localWeakReference1 != null) && (localWeakReference1.get() != null)) {
          ((anhl)localWeakReference1.get()).a();
        } else {
          this.d.remove(i);
        }
      }
      ...
      synchronized (this.c)
      {
        ...
        if (m >= jdField_a_of_type_Int)
        {
          ...
          if (j >= k - i)
          {
            ...
            ((ArrayList)localObject2).add(((anhl)localWeakReference2.get()).jdField_b_of_type_JavaLangString);
            break label434;
          }
        }
        else
        ...
        if (this.jdField_a_of_type_Apbd != null) {
          this.jdField_a_of_type_Apbd.a((ArrayList)localObject2);
        }
      }
      synchronized (this.d)
      {
        ...
        while (i >= 0)
        {
          ...
          {
            a((anhl)((WeakReference)localObject2).get(), false, false);
            i -= 1;
            continue;
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_ComTencentCommonAppAppInterface.removeObserver(this.jdField_a_of_type_Apbl);
