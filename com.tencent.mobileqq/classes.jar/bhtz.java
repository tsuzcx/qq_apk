  ...
  implements IWebviewWrapper
{
  ...
  private final bgww jdField_a_of_type_Bgww = bgww.a();
  private bhuc jdField_a_of_type_Bhuc;
  private TouchWebView jdField_a_of_type_ComTencentBizUiTouchWebView;
  
  public bhtz(Context paramContext)
  {
  ...
  {
    if (this.jdField_a_of_type_Bhuc != null) {
      this.jdField_a_of_type_Bhuc.a(paramString);
    }
  }
  ...
  {
    this.jdField_a_of_type_Bgww.a();
    onDetach();
    if (this.jdField_a_of_type_Bhuc != null) {
      this.jdField_a_of_type_Bhuc.c();
    }
  ...
  {
    this.jdField_a_of_type_Bgww.a("onDestroy");
    this.jdField_a_of_type_Bhuc = new bhuc(this.jdField_a_of_type_AndroidContentContext, paramActivity, paramIntent, bhuf.a().a(), true);
    this.jdField_a_of_type_ComTencentBizUiTouchWebView.setVisibility(4);
    this.jdField_a_of_type_Bhuc.a(this.jdField_a_of_type_ComTencentBizUiTouchWebView);
    this.jdField_a_of_type_Bhuc.a(new bhua(this, paramIWebviewListener));
    new bcbg(this.jdField_a_of_type_Bhuc).a(null, bhuf.a().a(), null);
  }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      try
      {
        if (paramIntent.getBooleanExtra("need_force_refresh", false))
        {
          ...
          xnh.a(this.jdField_a_of_type_ComTencentBizUiTouchWebView, str1, str2);
        }
      }
