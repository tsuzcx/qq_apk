...
public class apsu
  extends apsl
{
  private static apsv jdField_a_of_type_Apsv;
  public static final ArrayList<WeakReference<apsu>> a;
  private static String e = "";
  protected SongInfo a;
  private WeakReference<apsu> jdField_a_of_type_JavaLangRefWeakReference;
  protected long b = 0L;
  protected String d;
  ...
  public apsu(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    jdField_a_of_type_Apsv = new apsv(this.jdField_a_of_type_JavaLangString);
  ...
  {
    QQPlayerService.c(jdField_a_of_type_Apsv);
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    if (paramString.equals("SetCallback"))
    {
      ...
      QQPlayerService.b(jdField_a_of_type_Apsv);
      QQPlayerService.a(null);
      return true;
    }
