  ...
  implements Cursor
{
  ...
  protected acnc(acnf paramacnf, List<MessageRecord> paramList)
  {
    this.jdField_a_of_type_Acnf = paramacnf;
  ...
  private Object a(int paramInt)
  {
    ...
    case 14: 
      return ContactUtils.getDisplayName(this.jdField_a_of_type_Acnf.a(), localMessageRecord.senderuin, localMessageRecord.frienduin, 1, 0);
    case 15: 
      if (localMessageRecord.istroop == 3000) {
        return ContactUtils.getDiscussionNameDefaultUin(this.jdField_a_of_type_Acnf.a(), localMessageRecord.senderuin);
      }
      if (localMessageRecord.istroop == 1) {
        return ((TroopManager)this.jdField_a_of_type_Acnf.a().getManager(QQManagerFactory.TROOP_MANAGER)).a(localMessageRecord.senderuin);
      }
      return ContactUtils.getFriendNick(this.jdField_a_of_type_Acnf.a(), localMessageRecord.senderuin);
    case 16: 
      return Integer.valueOf(((anvk)this.jdField_a_of_type_Acnf.a().getManager(QQManagerFactory.FRIENDS_MANAGER)).b(localMessageRecord.frienduin));
    case 17: 
