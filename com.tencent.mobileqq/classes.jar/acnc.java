...
{
  public acnc(TroopShortcutbarFragment paramTroopShortcutbarFragment) {}
    ...
    if ((paramURLDrawable.getCurrDrawable() instanceof RegionDrawable))
    {
      ...
      while (paramThrowable.hasNext())
      {
        ...
        if ((((URLDrawable)localPair.first).getURL().equals(paramURLDrawable.getURL())) && (localPair.second != null)) {
          ((URLImageView)localPair.second).setImageDrawable(this.a.getResources().getDrawable(2130843105));
        }
      }
    }
  }
