...
public class acnc
{
  ...
  private static ajuc jdField_a_of_type_Ajuc;
  ...
  {
    if (baaf.a(paramSessionInfo.jdField_a_of_type_Int)) {}
    for (int i = 5;; i = 6)
    {
      if (mnf.a().a(paramSessionInfo.jdField_a_of_type_JavaLangString)) {
        i = 1;
      }
      return i;
    }
  ...
  public static int a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, ArrayList<String> paramArrayList, Intent paramIntent1, Intent paramIntent2)
  {
    ...
    if ((paramIntent1 == null) || (!paramIntent1.hasExtra("showFlashPic")))
    {
      ...
      paramIntent2.putExtra("showFlashPic", ajhz.a(paramSessionInfo.jdField_a_of_type_Int, (HotChatManager)localObject, paramSessionInfo.b));
    }
    ...
    for (;;)
    {
      ...
      paramIntent2.putExtra("ALBUM_ID", baaf.a(paramActivity));
      paramIntent2.putExtra("ALBUM_NAME", baaf.b(paramActivity));
      ...
      paramIntent2.putExtra("is_anonymous", mnf.a().a(paramSessionInfo.jdField_a_of_type_JavaLangString));
      ...
      if ((paramIntent1 != null) && (paramIntent1.getBooleanExtra("ReceiptMsgManager.EXTRA_KEY_IS_RECEIPT", false)))
      {
        ...
        paramIntent2.putExtra("PhotoConst.MAXUM_SELECTED_NUM", Math.min(aupz.b(paramQQAppInterface), j));
      }
      paramIntent2.putExtra("session_info", paramSessionInfo);
      ...
      if ((paramActivity instanceof SplashActivity))
      {
        ...
        paramIntent2 = aciy.a(paramIntent2, null);
        ...
        paramIntent2 = aciy.a(paramIntent2, null);
        paramIntent2.putExtra(baae.h, 80);
        ...
        localxrh = (xrh)paramQQAppInterface.a(51);
  ...
  public static void a(Intent paramIntent, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
    if (a(paramSessionInfo, paramQQAppInterface.a(paramSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      ...
      paramIntent.putExtra("binder_presendService", new BinderWarpper(new atqj(paramSessionInfo.jdField_a_of_type_Int, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.b, paramQQAppInterface.getAccount(), paramSessionInfo.jdField_e_of_type_Int).asBinder()));
    }
  }
  ...
  public static void a(AppInterface paramAppInterface, Activity paramActivity, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (!azzz.b())
      {
        bbmy.a(paramActivity, paramActivity.getResources().getString(2131653216), 0).a();
        return;
      }
      paramAppInterface = ajed.bh;
      boolean bool;
      label56:
      Object localObject;
      if (paramInt2 == 1)
      ...
      catch (Exception paramAppInterface)
      {
        for (;;)
        {
          ...
          bbmy.a(paramActivity, 2131625032, 0).a();
        }
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo)
  {
    ...
    if ((paramSessionInfo.jdField_a_of_type_Int == 9501) && (paramQQAppInterface != null) && (paramQQAppInterface.a()))
    {
      ...
      if ((paramSessionInfo.jdField_a_of_type_Int == 0) || (paramSessionInfo.jdField_a_of_type_Int == 3000) || (paramSessionInfo.jdField_a_of_type_Int == 1)) {
        localIntent.putExtra("select_file_support_send_docs_file", ammj.a().a());
      }
  ...
  {
    bfod.a(paramQQAppInterface, "tenpay.com", new acnf(paramInt1, paramSessionInfo, paramQQAppInterface, paramInt2, paramString, paramActivity));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, agqm paramagqm, List<agqm> paramList, int paramInt)
  {
    if (paramagqm == null) {
      return;
    }
    ...
    int i = 0;
    Object localObject2 = "";
    paramList = (agjk)paramQQAppInterface.getManager(125);
    if (paramList != null) {}
    label1422:
    label1561:
    label1569:
    for (String str = paramList.a();; str = null)
    {
      ...
      {
        int k;
        if (RedPacketManager.TYPEHBINFOMAP.get(Integer.valueOf(paramagqm.jdField_a_of_type_Int)) == null) {
          k = 1;
        }
        Object localObject3;
        switch (paramagqm.jdField_a_of_type_Int)
        {
        case 8: 
        case 9: 
        case 10: 
        ...
        case 7: 
          for (;;)
          {
            ...
            try
            {
              ...
              ((JSONObject)localObject3).put("bus_type", paramagqm);
              if (j > 0) {
            ...
            catch (JSONException paramagqm)
            {
              for (;;)
              {
                long l;
                paramagqm.printStackTrace();
                continue;
                if (paramInt == 1)
                {
                  aduw.a(paramQQAppInterface, "0X8005FC9", paramSessionInfo.jdField_a_of_type_Int);
                  continue;
            ...
            aduw.a(paramQQAppInterface, "0X8005CAF", paramSessionInfo.jdField_a_of_type_Int);
            if (jdField_a_of_type_Int != 0) {
              break label1523;
            }
            paramActivity = paramList + ".plus";
            awqx.b(paramQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", paramActivity, 0, 0, (String)localObject1, "", "", "");
            return;
            if (paramSessionInfo.jdField_a_of_type_Int == 3000)
            {
              i = 2;
              paramList = "entrance.click.group";
              j = ((ajhh)paramQQAppInterface.getManager(53)).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
              break;
            }
            if (paramSessionInfo.jdField_a_of_type_Int == 1)
            {
              ...
              try
              {
                ...
                paramList = (ajtg)paramQQAppInterface.a(20);
                if (jdField_a_of_type_Ajuc == null) {
                  jdField_a_of_type_Ajuc = new acne(paramSessionInfo);
                }
                paramQQAppInterface.addObserver(jdField_a_of_type_Ajuc);
                paramList.b(l, 32, 0);
              }
              ...
              {
                awqx.b(paramQQAppInterface, "CliOper", "", "", "0X8005B9C", "0X8005B9C", 0, 0, "", "", "", "");
                j = 6;
            ...
            for (paramList = paramQQAppInterface.a().l(paramSessionInfo.jdField_a_of_type_JavaLangString);; paramList = paramQQAppInterface.a().m(paramSessionInfo.jdField_a_of_type_JavaLangString))
            {
              ...
              paramList = baaw.encodeToString(paramList, 2);
              awqx.b(paramQQAppInterface, "CliOper", "", "", "0X8005B9D", "0X8005B9D", 0, 0, "", "", "", "");
              localObject3 = "entrance.click.c2c";
              localObject2 = paramList;
              i = 7;
              j = 1;
              paramList = (List<agqm>)localObject3;
              break;
            }
            k = ((Integer)RedPacketManager.TYPEHBINFOMAP.get(Integer.valueOf(paramagqm.jdField_a_of_type_Int))).intValue();
            break label165;
            localObject1 = "13140";
            paramagqm = String.valueOf(1);
            continue;
            localObject1 = "13141";
            paramagqm = String.valueOf(2);
            continue;
            localObject3 = "13142";
            paramagqm = (agqm)localObject1;
            localObject1 = localObject3;
        ...
        case 5: 
          ...
          awqx.b(paramQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "plus.hongbao.click", 0, 0, "", "", "", "");
          return;
        case 3: 
          if (paramagqm.jdField_a_of_type_OrgJsonJSONObject != null) {}
          for (paramagqm = paramagqm.jdField_a_of_type_OrgJsonJSONObject.optString("theme_id", "");; paramagqm = "")
          {
            localIntent.putExtra("theme_type", paramagqm);
        ...
        case 4: 
          ...
          paramList = paramagqm.jdField_a_of_type_OrgJsonJSONObject.optString("url", "");
          paramQQAppInterface = paramList;
          if (paramagqm.jdField_a_of_type_OrgJsonJSONObject.optInt("subtype", 0) == 1) {
        ...
        case 12: 
          paramagqm = paramagqm.jdField_a_of_type_OrgJsonJSONObject.optString("schema");
          if (TextUtils.isEmpty(paramagqm)) {
            break;
          }
          a(paramQQAppInterface, paramActivity, paramSessionInfo, i, j, paramagqm);
          return;
        }
      }
    }
  ...
  {
    awqx.b(paramQQAppInterface, "CliOper", "", paramSessionInfo.jdField_a_of_type_JavaLangString, "Music_gene", "Music_gene_AIO", 0, 0, String.valueOf(a(paramSessionInfo.jdField_a_of_type_Int)), "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, ArrayList<String> paramArrayList, Intent paramIntent, HashMap<LocalMediaInfo, LocalMediaInfo> paramHashMap)
  {
    ...
    for (;;)
    {
      ...
      return;
      localIntent.putExtra("PhotoConst.editPathMap", agdo.a(paramHashMap));
      paramActivity.startActivityForResult(localIntent, i);
    }
  }
  ...
  {
    new acnh(paramSessionInfo, paramQQAppInterface, paramContext, bacm.b(paramContext, paramUri)).execute(new Void[0]);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean, String paramString, BaseChatPie paramBaseChatPie)
  {
    ...
    if (((paramSessionInfo.jdField_a_of_type_Int == 1025) || (paramSessionInfo.jdField_a_of_type_Int == 0) || (paramSessionInfo.jdField_a_of_type_Int == 1000) || (paramSessionInfo.jdField_a_of_type_Int == 1004)) && (((bcpn)paramQQAppInterface.getManager(165)).d(paramSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      arrayOfInt[0] = 5;
      localmjj.b(2131632506);
    }
    for (int i = 1;; i = 0)
    {
      arrayOfInt[i] = 1;
      ...
      localmjj.a(new acnd(paramQQAppInterface));
      localmjj.a(new acng(localmjj, arrayOfInt, paramSessionInfo, paramQQAppInterface, paramBaseChatPie, paramContext, paramString));
      localmjj.show();
      awqx.b(paramQQAppInterface, "CliOper", "", "", "0X8004D68", "0X8004D68", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean, String paramString, Map<String, String> paramMap)
  {
    ...
    for (;;)
    {
      awqx.b(paramQQAppInterface, "CliOper", "", "", str2, str2, 0, 0, str1, "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, int paramInt1, int paramInt2)
  {
    ...
    if (AudioHelper.b(0))
    {
      babr.a(paramContext, 230, paramContext.getString(2131632717), paramContext.getString(2131632718), new acni(), null).show();
      return;
    }
    if (AudioHelper.a(0))
    {
      babr.a(paramContext, 230, paramContext.getString(2131632717), paramContext.getString(2131632719), new acnj(), null).show();
      return;
    }
    if (paramQQAppInterface.getApp().checkPermission("android.permission.CAMERA", Process.myPid(), Process.myUid()) != 0)
    {
      babr.a(paramContext, 230, paramContext.getString(2131632717), ajjy.a(2131642520), new acnk(), null).show();
      return;
    }
    ...
    for (int i = 1;; i = 17000)
    {
      ...
      yds.a(paramQQAppInterface, Long.parseLong(paramSessionInfo.jdField_a_of_type_JavaLangString), "Usr_AIO_SendMsg", 2, 0, paramInt1);
      return;
    }
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo)
  {
    ...
    bfhn.a(paramActivity, paramQQAppInterface.getAccount(), localIntent, -1, false);
    bfhz.b(paramQQAppInterface, 3, paramSessionInfo.jdField_a_of_type_Int);
  }
  ...
  {
    Object localObject = (aroh)paramQQAppInterface.getManager(11);
    String str;
    if (paramSessionInfo.jdField_a_of_type_Int == 1006) {
      str = ((aroh)localObject).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
    }
    for (localObject = paramSessionInfo.jdField_a_of_type_JavaLangString; paramString == null; localObject = ((aroh)localObject).b(str))
    {
  ...
  public static void c(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo)
  {
    ...
    paramQQAppInterface.putExtra(baae.h, 84);
