  ...
  extends BusinessHandler
{
  ...
  public aogy(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(int paramInt1, int paramInt2, ListenChangeVoicePanel paramListenChangeVoicePanel)
  {
    ...
    localvoiceChangeReq.str_qq_version.set("8.4.10");
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bjgx.a().a("voiceChange.Auth", 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 0, anvx.a(2131716204), true);
