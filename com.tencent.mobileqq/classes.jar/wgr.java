...
public class wgr
  extends Handler
{
  public wgr(QRLoginAuthActivity paramQRLoginAuthActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_b_of_type_Int == 77313)
      {
        label263:
        this.a.c = "Windows";
        this.a.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.a.getResources().getDrawable(2130846085));
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(this.a.getString(2131717222, new Object[] { this.a.c }));
        if (TextUtils.isEmpty(this.a.d)) {
          this.a.d = this.a.getString(2131720660);
        }
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(this.a.getString(2131717228, new Object[] { this.a.d }));
        if (!this.a.jdField_a_of_type_Boolean) {
          break label958;
        }
        this.a.jdField_b_of_type_AndroidWidgetButton.setVisibility(0);
        label410:
        axqy.b(null, "dc00898", "", "", "0X800A46D", "0X800A46D", wih.a(this.a.jdField_b_of_type_Int), 0, "", "", "", "");
        return;
        if (k == 32) {
          i = j;
        }
      ...
      for (;;)
      {
        ...
        {
          this.a.c = "Mac";
          this.a.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.a.getResources().getDrawable(2130846083));
          break;
        }
        if (this.a.jdField_b_of_type_Int == 3)
        {
          this.a.c = "iPad";
          this.a.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.a.getResources().getDrawable(2130846082));
          break;
        }
        if (wih.b(this.a.jdField_b_of_type_Int))
        {
          this.a.c = ajya.a(2131711211);
          this.a.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.a.getResources().getDrawable(2130846084));
          break;
        }
        this.a.c = ajya.a(2131711212);
        ...
        for (;;)
        {
          try
          {
            ...
            if (this.a.jdField_a_of_type_Bcqf.isShowing()) {
