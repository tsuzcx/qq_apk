...
import java.util.HashMap<Ljava.lang.String;Lbazn;>;
...
public class bazo
  extends QIPCModule
{
  public static volatile bazo a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bazr(this);
  private String jdField_a_of_type_JavaLangString;
  private HashMap<String, HashMap<String, bazn>> jdField_a_of_type_JavaUtilHashMap;
  ...
  private bazo()
  {
    ...
    return;
    label105:
    QIPCClientHelper.getInstance().getClient().connect(new bazp(this));
    QIPCClientHelper.getInstance().getClient().addListener(new bazq(this));
  ...
  public static bazo a()
  {
    if (jdField_a_of_type_Bazo == null) {}
    try
    {
      if (jdField_a_of_type_Bazo == null) {
        jdField_a_of_type_Bazo = new bazo();
      }
      return jdField_a_of_type_Bazo;
    }
    finally {}
  }
  ...
  private String a()
  {
    ...
    String str2 = String.valueOf(bdin.a(localContext));
    String str1 = str2;
    if (!bdnn.a(str2))
    {
      str1 = str2;
      if (str2.equals(String.valueOf(1))) {
        str1 = awxs.a(localContext);
      }
    }
    return str1;
  }
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      localObject1 = baws.a(paramString1, (String)localObject1);
      return localObject1;
      label68:
  ...
  public static String a(HashMap<String, HashMap<String, bazn>> paramHashMap)
  {
    ...
    try
    {
      ...
      while (paramHashMap.hasNext())
      {
        ...
        localJSONObject.put("domain_map", bazn.a((HashMap)localObject));
  ...
  private ArrayList<bazs> a(ArrayList<bazs> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          if (((bazs)((Iterator)localObject).next()).b <= 0) {
            continue;
          }
  ...
  public static HashMap<String, HashMap<String, bazn>> a(String paramString)
  {
    if (paramString == null) {}
    do
    {
      ...
      try
      {
        ...
        while (i < paramString.length())
        {
          ...
          localObject = bazn.a(((JSONObject)localObject).getString("domain_map"));
          if (localObject != null) {
  ...
  private static HashMap<String, bazn> a(List<DomainIp.iplistInfo> paramList, HashMap<String, bazn> paramHashMap)
  {
    if (paramList == null) {}
    Object localObject1;
    String str;
    ...
    do
    {
      ...
      for (;;)
      {
        paramHashMap = (HashMap<String, bazn>)localObject1;
    ...
    {
      paramList = (bazn)((HashMap)localObject1).get(str);
      if (paramList.a != null) {
        break label392;
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (paramHashMap.hasNext())
        {
          ...
          bazs localbazs = new bazs();
          localbazs.jdField_a_of_type_JavaLangString = ((DomainIp.ServerList)localObject2).string_IP.get();
          localbazs.jdField_a_of_type_Int = ((DomainIp.ServerList)localObject2).uint32_Port.get();
          localbazs.c = i;
          paramList.a.add(localbazs);
          if (QLog.isColorLevel())
          {
            QLog.d("InnerDns", 2, "onDomainServerListUpdate type=" + i + " d:" + str + " " + localbazs.jdField_a_of_type_JavaLangString + " " + localbazs.jdField_a_of_type_Int);
            continue;
            paramList = new bazn(str, new ArrayList());
            break;
          }
        }
      }
  ...
  public ArrayList<String> a(String paramString, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localObject = a(((bazn)((HashMap)localObject).get(paramString)).a);
        if ((localObject != null) && (((ArrayList)localObject).size() > 0))
        {
          if (((bazs)((ArrayList)localObject).get(0)).b <= 0) {
            break label716;
          }
          i = 1;
          continue;
          ...
          azri.a(BaseApplication.getContext()).a(null, "actDnsReq", paramBoolean, BaseApplicationImpl.sProcessId, 0L, (HashMap)localObject, "");
      ...
      do
      {
        ...
        localbazs = (bazs)localIterator.next();
      } while (localbazs.c != paramInt2);
      String str = localbazs.jdField_a_of_type_JavaLangString;
      if ((localbazs.c == 1) && (localbazs.jdField_a_of_type_Int != 80)) {
        localObject = str + ":" + localbazs.jdField_a_of_type_Int;
      }
      for (;;)
      {
  ...
  public void a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 44	bazo:jdField_a_of_type_Boolean	Z
    //   4: ifeq +43 -> 47
    //   7: ldc 2
    //   9: monitorenter
    ...
    //   24: ldc 56
    //   26: aload_0
    //   27: getfield 72	bazo:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   30: invokestatic 418	bazo:a	(Ljava/util/HashMap;)Ljava/lang/String;
    ...
    //   50: aload_0
    //   51: getfield 36	bazo:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    int i;
    boolean bool1;
    if ((bdnn.a(paramString1)) || (bdnn.a(paramString2)) || (paramString1.equals(paramString2)))
    {
      i = 40;
      bool1 = false;
    }
    ...
    for (;;)
    {
      ...
      ((HashMap)localObject).put("param_FailCode", String.valueOf(i));
      azri.a(BaseApplication.getContext()).a(null, "actDnsBadIp", bool1, BaseApplicationImpl.sProcessId, 0L, (HashMap)localObject, "");
      return;
      localObject = a();
      if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject)))
      {
        try
        {
          ...
          {
            localObject = (bazn)((HashMap)localObject).get(paramString1);
            if (((bazn)localObject).a != null)
            {
              localObject = ((bazn)localObject).a.iterator();
              while (((Iterator)localObject).hasNext())
              {
                bazs localbazs = (bazs)((Iterator)localObject).next();
                if (paramString2.equals(localbazs.jdField_a_of_type_JavaLangString)) {
                  localbazs.b += 1;
                }
              }
            }
  ...
  public void b()
  {
    if ((BaseApplicationImpl.sProcessId == 1) && (!this.c))
    {
      ...
      localQQAppInterface.startServlet(new NewIntent(localQQAppInterface.getApp(), azbm.class));
      this.c = true;
    }
  }
