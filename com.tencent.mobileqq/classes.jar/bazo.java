...
public class bazo
{
  ...
  public static ArrayList<auvd> a;
  ...
  public static Intent a(Intent paramIntent, String paramString, QQAppInterface paramQQAppInterface, ProfileActivity.AllInOne paramAllInOne, BusinessCard paramBusinessCard)
  {
    ...
    String str = String.format("http://ti.qq.com/qcard/index.html?qq=%s&appid=%s&version=%s&_wv=1027", new Object[] { paramString, String.valueOf(paramQQAppInterface.getAppid()), "android-8.2.8" });
    paramString = str;
    if (b()) {
  ...
  public static SpannableString a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    if (!bbsu.a(paramContext, paramInt2)) {
      bbsu.a((QQAppInterface)localAppInterface, paramInt2, null, false);
    }
    Object localObject1;
    if (paramInt3 == 0)
    {
      ...
      paramContext = paramContext.getResources().getDrawable(2130845003);
      paramContext = bbql.a(localAppInterface, a(paramInt2, jdField_a_of_type_Int), "", paramContext, bbql.b, "halfstar", false, null);
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          localObject5 = paramContext.getResources().getDrawable(2130849627);
        ...
        localObject2 = localObject6;
        localObject4 = localObject8;
        localObject5 = paramContext.getResources().getDrawable(2130845001);
        localObject2 = localObject6;
        localObject4 = localObject8;
        localObject5 = bbql.a(localAppInterface, a(paramInt2, jdField_e_of_type_Int), "", (Drawable)localObject5, bbql.b, "crown", false, null);
        ...
        localObject2 = localObject5;
        localObject4 = localObject5;
        localObject6 = bbql.a(localAppInterface, a(paramInt2, jdField_d_of_type_Int), "", (Drawable)localObject6, bbql.b, "sun", false, null);
        ...
        localObject2 = localObject6;
        localObject4 = localObject6;
        localObject5 = bbql.a(localAppInterface, a(paramInt2, jdField_c_of_type_Int), "", (Drawable)localObject5, bbql.b, "moon", false, null);
        localObject2 = localObject5;
        localObject4 = localObject5;
        if (!"%".equalsIgnoreCase(localObject7.substring(paramInt3, paramInt3 + 1))) {
          break label934;
      ...
      if (paramInt3 < localObject7.length())
      {
        ...
        localObject2 = localObject5;
        localObject4 = localObject5;
        localObject6 = paramContext.getResources().getDrawable(2130845004);
        localObject2 = localObject5;
        localObject4 = localObject5;
        localObject5 = bbql.a(localAppInterface, a(paramInt2, jdField_b_of_type_Int), "", (Drawable)localObject6, bbql.b, "star", false, null);
      }
      label934:
  ...
  public static auvd a(auvd paramauvd)
  {
    if (paramauvd == null) {
      return null;
    }
    auvd localauvd = new auvd();
    localauvd.jdField_o_of_type_Long = paramauvd.jdField_o_of_type_Long;
    localauvd.jdField_a_of_type_JavaLangString = paramauvd.jdField_a_of_type_JavaLangString;
    localauvd.jdField_b_of_type_JavaLangString = paramauvd.jdField_b_of_type_JavaLangString;
    localauvd.jdField_c_of_type_JavaLangString = paramauvd.jdField_c_of_type_JavaLangString;
    localauvd.jdField_a_of_type_Int = paramauvd.jdField_a_of_type_Int;
    localauvd.jdField_b_of_type_Int = paramauvd.jdField_b_of_type_Int;
    localauvd.jdField_c_of_type_Int = paramauvd.jdField_c_of_type_Int;
    localauvd.jdField_d_of_type_JavaLangString = paramauvd.jdField_d_of_type_JavaLangString;
    localauvd.jdField_e_of_type_JavaLangString = paramauvd.jdField_e_of_type_JavaLangString;
    localauvd.jdField_f_of_type_JavaLangString = paramauvd.jdField_f_of_type_JavaLangString;
    localauvd.jdField_g_of_type_JavaLangString = paramauvd.jdField_g_of_type_JavaLangString;
    localauvd.jdField_h_of_type_JavaLangString = paramauvd.jdField_h_of_type_JavaLangString;
    localauvd.jdField_i_of_type_JavaLangString = paramauvd.jdField_i_of_type_JavaLangString;
    localauvd.jdField_j_of_type_JavaLangString = paramauvd.jdField_j_of_type_JavaLangString;
    localauvd.jdField_k_of_type_JavaLangString = paramauvd.jdField_k_of_type_JavaLangString;
    localauvd.jdField_d_of_type_Int = paramauvd.jdField_d_of_type_Int;
    localauvd.p = paramauvd.p;
    localauvd.q = paramauvd.q;
    localauvd.r = paramauvd.r;
    localauvd.s = paramauvd.s;
    localauvd.jdField_l_of_type_JavaLangString = paramauvd.jdField_l_of_type_JavaLangString;
    localauvd.n = paramauvd.n;
    localauvd.m = paramauvd.m;
    localauvd.jdField_o_of_type_JavaLangString = paramauvd.jdField_o_of_type_JavaLangString;
    localauvd.jdField_h_of_type_Int = paramauvd.jdField_h_of_type_Int;
    localauvd.t = paramauvd.t;
    localauvd.jdField_i_of_type_Int = paramauvd.jdField_i_of_type_Int;
    localauvd.jdField_j_of_type_Int = paramauvd.jdField_j_of_type_Int;
    localauvd.jdField_k_of_type_Int = paramauvd.jdField_k_of_type_Int;
    localauvd.jdField_e_of_type_Int = paramauvd.jdField_e_of_type_Int;
    localauvd.jdField_f_of_type_Int = paramauvd.jdField_f_of_type_Int;
    localauvd.jdField_g_of_type_Int = paramauvd.jdField_g_of_type_Int;
    localauvd.jdField_l_of_type_Int = paramauvd.jdField_l_of_type_Int;
    localauvd.jdField_a_of_type_Boolean = paramauvd.jdField_a_of_type_Boolean;
    return localauvd;
  }
  
  public static auvd a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    int k = 0;
    if (paramLong == auvd.jdField_a_of_type_Long) {
      return null;
    }
    ...
    if (i < m)
    {
      paramQQAppInterface = (auvd)localArrayList.get(i);
  ...
  public static ayvx a(QQAppInterface paramQQAppInterface, String paramString, Intent paramIntent)
  {
    String str = a();
    bbdr.a(paramString, str, 1080, 1080, 100);
    return a(paramQQAppInterface, str, paramIntent, true);
  }
  
  private static ayvx a(QQAppInterface paramQQAppInterface, String paramString, Intent paramIntent, boolean paramBoolean)
  {
    ...
    {
      localayvx.jdField_a_of_type_Int = -10000;
      localayvx.jdField_a_of_type_JavaLangString = "file not exist";
      a("onAvatarChanged", localayvx.jdField_a_of_type_Int, localayvx.jdField_a_of_type_JavaLangString);
      return localayvx;
    }
    if (!bbev.d(paramQQAppInterface.getApp()))
    {
      localayvx.jdField_a_of_type_Int = -10001;
      localayvx.jdField_a_of_type_JavaLangString = "network error";
      a("onAvatarChanged", localayvx.jdField_a_of_type_Int, localayvx.jdField_a_of_type_JavaLangString);
      return localayvx;
    }
    if ((l <= 0L) || (l >= 1749600L))
    {
      ...
      localayvx.jdField_a_of_type_Int = -10000;
      localayvx.jdField_a_of_type_JavaLangString = "image illegal, size must be square.";
      a("onAvatarChanged", localayvx.jdField_a_of_type_Int, localayvx.jdField_a_of_type_JavaLangString);
      return localayvx;
    }
    if (paramBoolean)
    ...
    localayvx.jdField_a_of_type_Int = 0;
    localayvx.jdField_a_of_type_JavaLangString = "ok";
    a(paramString);
    paramQQAppInterface.a().a(paramQQAppInterface, paramString, paramIntent);
    return localayvx;
  }
  
  public static bbpd a(String paramString)
  {
    if ((paramString != null) && (!paramString.equals("")))
    {
      ...
      try
      {
        ...
        localbbpd.jdField_b_of_type_Int = paramString.getInt("frameInterval");
        localbbpd.jdField_a_of_type_Int = paramString.getInt("frameNumber");
        localbbpd.jdField_a_of_type_Float = ((float)paramString.getDouble("positionX"));
        localbbpd.jdField_b_of_type_Float = ((float)paramString.getDouble("positionY"));
        localbbpd.c = ((float)paramString.getDouble("width"));
        localbbpd.d = ((float)paramString.getDouble("height"));
        return localbbpd;
      }
  ...
  public static FriendProfileCardBgDrawable a(Resources paramResources, String paramString1, String paramString2)
  {
    ...
    {
      localbbpd = a(bbdj.a(new File(paramString1, "config.json"), -1));
      if (localbbpd != null)
      {
        String[] arrayOfString = new String[localbbpd.jdField_a_of_type_Int];
        int i = 0;
        while (i < localbbpd.jdField_a_of_type_Int)
        {
          arrayOfString[i] = (paramString1 + "/" + (i + 1) + ".png");
          i += 1;
        }
        localbbpd.jdField_a_of_type_ArrayOfJavaLangString = arrayOfString;
      }
    }
    paramString1 = localbbpd;
    if (localbbpd == null) {
      paramString1 = new bbpd();
    }
  ...
  public static Card a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      localObject1 = localajxn.e(paramString);
      paramQQAppInterface = localajxn.b(paramString);
      if (paramQQAppInterface == null)
      {
        if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          ...
          localajxn.a(paramQQAppInterface);
          label381:
          if (paramQQAppInterface != null) {
    ...
    boolean bool2;
    boolean bool1;
    if (!bbbd.a(((Friends)localObject1).alias, paramQQAppInterface.strShowName))
    {
      paramQQAppInterface.strShowName = ((Friends)localObject1).alias;
      i = 1;
  ...
  public static BusinessInfoCheckUpdate.RedTypeInfo a()
  {
    ...
    atxb localatxb = (atxb)BaseApplicationImpl.getApplication().getRuntime().getManager(160);
    RedTouchItem localRedTouchItem = localatxb.a(-4);
    if ((localatxb.a(localRedTouchItem, true)) && (localRedTouchItem.count > 0))
    {
  ...
  public static String a()
  {
    ...
    localStringBuilder.append(ajtk.jdField_a_of_type_JavaLangString).append("temp").append("/").append(System.currentTimeMillis()).append("_portrait.tmp");
  ...
  public static String a(byte paramByte)
  {
    ...
    default: 
      return null;
    case 1: 
      return ajyc.a(2131708441);
    case 2: 
      return ajyc.a(2131708433);
    case 3: 
      return ajyc.a(2131708459);
    case 4: 
      return ajyc.a(2131708431);
    case 5: 
      return ajyc.a(2131708438);
    case 6: 
      return ajyc.a(2131708437);
    case 7: 
      return ajyc.a(2131708451);
    case 8: 
      return ajyc.a(2131708464);
    case 9: 
      return ajyc.a(2131708473);
    case 10: 
      return ajyc.a(2131708481);
    case 11: 
      return ajyc.a(2131708461);
    }
    return ajyc.a(2131708453);
  }
  ...
  {
    bbsu localbbsu = bbsu.a;
    switch (paramInt2)
    {
    default: 
      return "_";
    case 0: 
      return localbbsu.getDir(BaseApplicationImpl.getApplication(), localbbsu.getScid(paramInt1)) + "/half.png";
    case 1: 
      return localbbsu.getDir(BaseApplicationImpl.getApplication(), localbbsu.getScid(paramInt1)) + "/star.png";
    case 2: 
      return localbbsu.getDir(BaseApplicationImpl.getApplication(), localbbsu.getScid(paramInt1)) + "/moon.png";
    case 3: 
      return localbbsu.getDir(BaseApplicationImpl.getApplication(), localbbsu.getScid(paramInt1)) + "/sun.png";
    case 4: 
      return localbbsu.getDir(BaseApplicationImpl.getApplication(), localbbsu.getScid(paramInt1)) + "/crown.png";
    }
    return localbbsu.getDir(BaseApplicationImpl.getApplication(), localbbsu.getScid(paramInt1)) + "/more.png";
  }
  
  public static String a(Context paramContext)
  {
    paramContext = paramContext.getDir(".profilecard", 0);
    return paramContext.getAbsolutePath() + File.separator + "qvip_profile_label_config.json" + "8.2.8";
  }
  ...
  public static String a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (paramInt1 == 0)
    {
      localStringBuilder.append(paramContext.getString(2131694073));
    ...
    for (;;)
    {
      if (paramInt2 != 0)
      {
        ...
        localStringBuilder.append(paramContext.getString(2131719960));
        localStringBuilder.append("  ");
      }
      paramContext = bazj.c(paramInt3);
      ...
      {
        paramContext = str;
        if (!ajyc.a(2131708472).equals(paramString1)) {
  ...
  public static String a(Context paramContext, int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      {
        paramContext = str;
        if (!ajyc.a(2131708445).equals(paramString1)) {
          paramContext = "" + paramString1;
        }
      }
      paramString1 = paramContext;
  ...
  public static String a(Context paramContext, auuw paramauuw)
  {
    ...
    if (localCard != null)
    {
      ...
      if (i > 0)
      {
        localObject = paramauuw;
        if (!b()) {
          localObject = i + paramContext.getString(2131719960);
        }
      }
      paramauuw = "";
      if (localCard == null) {
      ...
      paramContext = paramauuw;
      if (!TextUtils.isEmpty(localCard.strCountry))
      {
        paramContext = paramauuw;
        if (!ajyc.a(2131708443).equals(localCard.strCountry)) {
          paramContext = "" + localCard.strCountry;
        }
      }
      paramauuw = paramContext;
      if (!TextUtils.isEmpty(localCard.strProvince))
      {
        ...
        paramauuw = paramauuw + localCard.strProvince;
      }
      paramContext = paramauuw;
    ...
    label554:
    for (paramauuw = "" + " " + (String)localObject;; paramauuw = "")
    {
      localObject = paramauuw;
      if (paramContext != null)
      {
        ...
        if (paramContext.length() > 0) {
          localObject = paramauuw + " " + paramContext;
        }
      }
      return localObject;
      ...
      {
        paramContext = paramauuw;
        if (!ajyc.a(2131708456).equals(localContactCard.strCountry)) {
      ...
      if (!TextUtils.isEmpty(localContactCard.strProvince))
      {
        ...
        paramauuw = paramauuw + localContactCard.strProvince;
      }
      paramContext = paramauuw;
  ...
  public static String a(auuw paramauuw, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    if ((paramauuw == null) || (paramauuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne == null) || (TextUtils.isEmpty(paramauuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString)) || (paramQQAppInterface == null) || (paramActivity == null)) {
      paramQQAppInterface = null;
    }
    do
    {
      return paramQQAppInterface;
      String str2 = paramauuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString;
      String str1 = paramauuw.jdField_a_of_type_JavaLangString;
      paramauuw = (bdto)paramQQAppInterface.getManager(165);
      if (paramauuw.a(str2)) {
        return String.format("https://datacard.qidian.qq.com/static/1_%s_more.htm?appid=%s&version=%s&_wv=1027", new Object[] { str2, String.valueOf(paramQQAppInterface.getAppid()), "android-8.2.8" });
      }
      if (paramauuw.f(str2)) {
        return paramActivity.getIntent().getStringExtra("key_qidian_detail_url");
      }
      paramQQAppInterface = String.format("http://ti.qq.com/qcard/index.html?qq=%s&appid=%s&version=%s&_wv=1027", new Object[] { str2, String.valueOf(paramQQAppInterface.getAppid()), "android-8.2.8" });
      paramauuw = paramQQAppInterface;
      if (!TextUtils.isEmpty(str1)) {
        paramauuw = paramQQAppInterface + "&troopUin=" + str1;
      }
      paramQQAppInterface = paramauuw;
    } while (!b());
    return paramauuw + "&intl=1";
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder(ajsf.cm);
  ...
  public static String a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    if ((paramLong != auvd.jdField_a_of_type_Long) && (paramLong > 0L)) {
  ...
  public static String a(String paramString)
  {
    ...
    localStringBuilder.append(ajtk.jdField_a_of_type_JavaLangString).append("HDAvatar").append("/").append(paramString).append(".jpg");
    return bbuv.a(localStringBuilder.toString());
  }
  ...
  /* Error */
  public static ArrayList<auvd> a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 6
    ...
    //   23: astore_0
    //   24: aload_0
    //   25: invokestatic 1216	bazo:b	(Landroid/content/Context;)Ljava/lang/String;
    //   28: astore 8
    ...
    //   53: ldc_w 1218
    //   56: astore 8
    //   58: getstatic 32	bazo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   61: aload 8
    //   63: invokestatic 1221	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   66: ifeq +20 -> 86
    //   69: getstatic 28	bazo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   72: invokevirtual 1223	java/util/ArrayList:isEmpty	()Z
    //   75: ifne +11 -> 86
    //   78: iload_1
    //   79: ifne +7 -> 86
    //   82: getstatic 28	bazo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   85: areturn
    ...
    //   203: aload 8
    //   205: putstatic 32	bazo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   208: aload 10
    //   210: putstatic 28	bazo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   213: aload 10
    //   215: areturn
    //   216: aload_0
    ...
    //   308: new 527	auvd
    //   311: dup
    //   312: invokespecial 528	auvd:<init>	()V
    //   315: astore 11
    //   317: aload 11
    //   319: aload 9
    //   321: ldc_w 1280
    ...
    //   754: putfield 600	auvd:jdField_l_of_type_Int	I
    //   757: iload 4
    //   759: iconst_1
    ...
    //   765: aload 11
    //   767: iload_1
    //   768: putfield 602	auvd:jdField_a_of_type_Boolean	Z
    //   771: aload 10
    //   773: aload 11
    ...
    //   786: new 527	auvd
    //   789: dup
    //   790: invokespecial 528	auvd:<init>	()V
    //   793: astore 6
    //   795: aload 6
    //   797: ldc2_w 1355
    //   800: putfield 531	auvd:jdField_o_of_type_Long	J
    //   803: aload 6
    //   805: iconst_1
    //   806: putfield 602	auvd:jdField_a_of_type_Boolean	Z
    //   809: aload 10
    //   811: aload 6
    ...
    //   817: new 527	auvd
    //   820: dup
    //   821: invokespecial 528	auvd:<init>	()V
    //   824: astore 6
    //   826: aload 6
    //   828: ldc2_w 1357
    //   831: putfield 531	auvd:jdField_o_of_type_Long	J
    //   834: aload 6
    //   836: iconst_1
    //   837: putfield 602	auvd:jdField_a_of_type_Boolean	Z
    //   840: aload 10
    //   842: aload 6
    ...
    //   848: new 527	auvd
    //   851: dup
    //   852: invokespecial 528	auvd:<init>	()V
    //   855: astore 6
    //   857: aload 6
    //   859: ldc2_w 1359
    //   862: putfield 531	auvd:jdField_o_of_type_Long	J
    //   865: aload 6
    //   867: iconst_1
    //   868: putfield 602	auvd:jdField_a_of_type_Boolean	Z
    //   871: aload 10
    //   873: aload 6
  ...
  public static ArrayList<auvd> a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (QLog.isColorLevel()) {
    ...
    if (!((ArrayList)localObject).isEmpty())
    {
      ...
      {
        auvd localauvd = (auvd)((Iterator)localObject).next();
        if ((paramBoolean1) || (!localauvd.jdField_a_of_type_Boolean)) {
          if (paramBoolean2) {
            localArrayList.add(localauvd);
          } else if (a(paramQQAppInterface, localauvd)) {
            localArrayList.add(localauvd);
          }
        }
      }
  ...
  public static List<String> a(Context paramContext, Card paramCard)
  {
    ...
    if (i == 0) {
      localArrayList.add(paramContext.getString(2131694073));
    }
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(paramContext)) && (!ajyc.a(2131708452).equals(paramContext))) {
        localStringBuilder.append(paramContext);
      }
      if (!TextUtils.isEmpty(str1))
      {
      ...
      paramContext = d(bazj.c(paramCard.constellation));
      if (TextUtils.isEmpty(paramContext)) {
        break;
      }
      localArrayList.add(paramContext);
  ...
  public static void a(Activity paramActivity, View paramView, String paramString, boolean paramBoolean1, boolean paramBoolean2, ProfileActivity.AllInOne paramAllInOne)
  {
    Intent localIntent = new Intent(paramActivity, FriendProfileImageActivity.class);
    localIntent.putExtra("friendUin", paramString);
    localIntent.putExtra("KEY_THUMBNAL_BOUND", xpx.a(paramView));
    localIntent.putExtra("requestType", 881);
  ...
  public static void a(Activity paramActivity, BusinessCard paramBusinessCard, ProfileActivity.AllInOne paramAllInOne, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramAllInOne.jdField_a_of_type_Int == 0)
    {
      axqw.b(null, "CliOper", "", "", "0X8006A7F", "0X8006A7F", 0, 0, "", "", "", "");
      return;
    }
    axqw.b(null, "CliOper", "", "", "0X8006A93", "0X8006A93", 0, 0, "", "", "", "");
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, String paramString3, boolean paramBoolean1, boolean paramBoolean2, String paramString4)
  {
    ...
    paramString2 = bbpp.a(paramActivity, "card", paramString2);
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt, String paramString3)
  {
    try
    {
      ...
      paramString1.jdField_h_of_type_JavaLangString = bbcl.a((QQAppInterface)localObject, paramString2);
      ...
      paramString2 = amew.a((QQAppInterface)localObject, paramString2);
      if (paramString2.mobilesNum.size() >= 3)
      {
        bcpw.a(paramActivity, 0, 2131695058, 0).a();
        return;
      }
  ...
  public static void a(Context paramContext)
  {
    ...
    paramContext = (atxb)BaseApplicationImpl.getApplication().getRuntime().getManager(160);
  ...
  public static void a(Context paramContext, long paramLong, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = String.format(bbpp.a("rareCard"), new Object[] { Long.valueOf(paramLong) });
    }
  ...
  public static void a(TextView paramTextView, String paramString1, String paramString2, View.OnLongClickListener paramOnLongClickListener)
  {
    ...
    ausf localausf = new ausf(str);
    if ((paramString1 != null) && (str.contains(paramString1)))
    {
      localausf.a("复制QQ号", paramString1);
      if ((paramString2 != null) && (paramString2.length() > 0) && (str.length() > paramString1.length() + 2)) {
        localausf.a(ajyc.a(2131708483), paramString2);
      }
    }
    for (;;)
    {
      paramTextView.setTag(new ausu(89, localausf));
      ...
      if ((paramString2 != null) && (str.contains(paramString2))) {
        localausf.a(ajyc.a(2131708449), paramString2);
      } else {
        localausf.a(ajyc.a(2131708434), str);
      }
    }
  }
  
  public static void a(auuw paramauuw, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    if ((paramauuw == null) || (paramQQAppInterface == null) || (paramActivity == null)) {}
    do
    {
      return;
      paramauuw = a(paramauuw, paramQQAppInterface, paramActivity);
      if (QLog.isColorLevel()) {
        QLog.i("Q.profilecard.FrdProfileCard", 2, String.format(Locale.getDefault(), "openDetails url: %s", new Object[] { paramauuw }));
      }
    } while (TextUtils.isEmpty(paramauuw));
    Intent localIntent = new Intent(paramActivity, QQBrowserActivity.class);
    localIntent.putExtra("url", paramauuw);
  ...
  {
    xkq.a(paramBaseActivity, paramLong, paramString1, paramString2, paramInt, "", new Bundle());
  }
  ...
  {
    xkq.a(paramBaseActivity, paramLong, paramString1, paramString2, paramInt, paramString3, paramBundle);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, View paramView, String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      baxa localbaxa = ((DynamicAvatarView)paramView).a;
      if ((localbaxa != null) && (localbaxa.jdField_a_of_type_Boolean) && (!TextUtils.isEmpty(localbaxa.jdField_c_of_type_JavaLangString)))
      {
        b(paramActivity, paramView, localbaxa.jdField_c_of_type_JavaLangString);
        paramInt1 = 1;
        if (paramInt2 == 0) {
          if (paramInt1 == 0) {
            break label159;
    ...
    {
      axqw.b(paramQQAppInterface, "dc00898", "", "", "0X8007103", "0X8007103", 0, 0, paramActivity, "", "", "");
      return;
      if (paramInt2 == 1)
      {
  ...
  public static void a(String paramString1, int paramInt1, boolean paramBoolean, String paramString2, String paramString3, long paramLong1, int paramInt2, int paramInt3, long paramLong2, String paramString4, String paramString5)
  {
    ...
    for (localObject = "actIntroPttUpload";; localObject = "actIntroPttDownload")
    {
      ...
      axrl.a(BaseApplication.getContext()).a(paramString1, (String)localObject, paramBoolean, paramLong1, paramLong2, localHashMap, "", false);
      return;
    }
    if (!ayoz.a(paramInt3, localHashMap))
    {
      ...
      {
        localHashMap.put(ayoz.jdField_k_of_type_JavaLangString, paramString4);
        label316:
        if (paramInt1 == 1) {
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    localbgyf.jdField_a_of_type_JavaLangString = paramQQAppInterface.getCurrentAccountUin();
    localbgyf.jdField_b_of_type_JavaLangString = bbcl.h(paramQQAppInterface, localbgyf.jdField_a_of_type_JavaLangString);
    bgxy.a(paramActivity, localbgyf, paramString, paramActivity.getString(2131692226), "", -1);
  }
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface, Activity paramActivity, boolean paramBoolean)
  {
    ...
    paramString.putExtra("url", ausy.jdField_c_of_type_JavaLangString);
  ...
  public static void a(byte[] paramArrayOfByte)
  {
    try
    {
      paramArrayOfByte = bbdm.a(paramArrayOfByte);
      String str = bbdm.a(paramArrayOfByte);
  ...
  public static boolean a(auuu paramauuu)
  {
    return paramauuu.jdField_a_of_type_Int == 160;
  }
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, auvd paramauvd)
  {
    long l = NetConnInfoCenter.getServerTime();
    if (((paramauvd.jdField_j_of_type_Int > 100) && (l < paramauvd.jdField_j_of_type_Int)) || ((paramauvd.jdField_k_of_type_Int > 100) && (l > paramauvd.jdField_k_of_type_Int)))
    {
      if (QLog.isColorLevel()) {
        QLog.w("ProfileCardUtil", 2, "filterTemplate->sytle:" + paramauvd.jdField_o_of_type_Long + ",beginTime:" + paramauvd.jdField_j_of_type_Int + ",endTime:" + paramauvd.jdField_k_of_type_Int);
      }
      return false;
    }
    return true;
  ...
  {
    if (bbwv.a(paramQQAppInterface, "show_diy_template_guide_for_guest_time", 0) >= 3) {}
    long l;
    do
    {
      return false;
  ...
  public static byte[] a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      arrayOfByte = bbdm.a(paramString);
    }
    return arrayOfByte;
  }
  ...
  public static long b()
  {
    ...
    {
      if (bbbd.a()) {
        return bbbd.a(new File(ajsf.aV));
      }
      long l = bbbd.a(new File(Environment.getRootDirectory().getPath()));
      return l;
    }
    catch (Exception localException) {}
    return -1L;
  ...
  {
    paramContext = paramContext.getDir(".profilecard", 0);
    return paramContext.getAbsolutePath() + File.separator + "qvip_profile_template.json" + "8.2.8";
  }
  
  public static String b(Context paramContext, auuw paramauuw)
  {
    int j = -1;
    String str = "";
    Card localCard = paramauuw.jdField_a_of_type_ComTencentMobileqqDataCard;
    ...
    if ((paramauuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Byte == 0) || (paramauuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Byte == 1))
    {
      ...
      str = paramContext.getString(2131694073);
    }
    for (;;)
    {
      return str + a(paramContext, paramauuw);
  ...
  public static String b(String paramString)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    paramString = MD5.toMD5(MD5.toMD5(MD5.toMD5(paramString)));
    localStringBuilder.append(ajtk.jdField_a_of_type_JavaLangString).append("FHDAvatar").append("/").append(paramString).append(".jpg");
    return bbuv.a(localStringBuilder.toString());
  }
  ...
  public static void b(Activity paramActivity, View paramView, String paramString)
  {
    ...
    ((Intent)localObject).putExtra("KEY_THUMBNAL_BOUND", xpx.a(paramView));
  ...
  {
    bbwv.a(paramQQAppInterface, "show_diy_template_guide_for_guest_time", bbwv.a(paramQQAppInterface, "show_diy_template_guide_for_guest_time", 0) + 1);
  }
  ...
  public static void b(String paramString, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    try
    {
      bgpd.b(paramString).a(paramActivity, paramQQAppInterface.getCurrentAccountUin());
      return;
    }
    catch (Exception paramString)
    {
      ...
      bcpw.a(paramActivity, paramActivity.getResources().getString(2131692901), 0).a();
    }
  }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(ajtk.jdField_a_of_type_JavaLangString).append("temp").append("/").append(System.currentTimeMillis()).append("_cardbg.tmp");
    return bbuv.a(localStringBuilder.toString());
  }
  ...
  {
    paramQQAppInterface = (atxb)paramQQAppInterface.getManager(160);
