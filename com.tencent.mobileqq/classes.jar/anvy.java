...
{
  public anvy(FacePoiUI paramFacePoiUI) {}
  ...
  public boolean a(int paramInt, View paramView, ListView paramListView)
  {
    ...
    if (this.a.a == 0L)
    {
      ...
      new Handler(Looper.getMainLooper()).postDelayed(new anvz(this), 300L);
    }
    for (;;)
    {
      ...
      break;
      label114:
      new Handler(Looper.getMainLooper()).postDelayed(new anwa(this), 300L);
    }
  }
