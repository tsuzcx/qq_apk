...
public class anvy
{
  ...
  anwq jdField_a_of_type_Anwq = null;
  ...
  List<Integer> jdField_f_of_type_JavaUtilList = Arrays.asList(new Integer[] { Integer.valueOf(2131301090), Integer.valueOf(2131301092), Integer.valueOf(2131301093), Integer.valueOf(2131301094), Integer.valueOf(2131301095), Integer.valueOf(2131301096), Integer.valueOf(2131301097), Integer.valueOf(2131301098), Integer.valueOf(2131301099), Integer.valueOf(2131301091) });
  int g;
  int h = 0;
  int i = 0;
  int j = 0;
  ...
  public anvy(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    for (long l = a(800, 1500);; l = 750L)
    {
      ...
      localRotateAnimation.setInterpolator(new anwd(this));
      this.jdField_a_of_type_AndroidWidgetImageView.startAnimation(localRotateAnimation);
      localRotateAnimation.setAnimationListener(new anwb(this, paramInt, paramBoolean));
      return;
    }
  }
  
  public void a(anwq paramanwq, boolean paramBoolean)
  {
    if ((paramanwq == null) || (this.jdField_a_of_type_AndroidContentContext == null))
    {
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendDisappearAnimation disappear data is " + paramanwq + " mContext " + this.jdField_a_of_type_AndroidContentContext);
      }
      return;
    }
    Object localObject = paramanwq.e;
    if ((paramanwq instanceof anwn)) {
      localObject = paramanwq.e + "_" + ((anwn)paramanwq).b;
    }
    ...
    for (int m = ((Integer)this.jdField_a_of_type_JavaUtilMap.get(localObject)).intValue();; m = -1)
    {
      if (m == -1)
      {
        ...
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendDisappearAnimation disappear uin " + paramanwq.e.substring(0, 4) + " is not in the hole");
        QLog.d(Face2FaceAddFriendActivity.b, 2, "startFriendDisappearAnimation disappear uin " + paramanwq.e.substring(0, 4) + " is not in the hole");
        this.h += 1;
        return;
      }
      ...
      if (paramBoolean)
      {
        ...
        localAnimationSet.setInterpolator(new anwe(this));
        localAnimationSet.setAnimationListener(new anwa(this));
        if (localObject != null) {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendDisappearAnimation disappear uin " + paramanwq.e.substring(0, 4));
      }
      ...
      a(m);
      ((Face2FaceAddFriendActivity)this.jdField_a_of_type_AndroidContentContext).c(paramanwq);
  ...
  public void a(anwq paramanwq, boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    if ((paramanwq == null) || (this.jdField_a_of_type_AndroidContentContext == null)) {
      if (QLog.isColorLevel()) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendInAnimation  data is " + paramanwq + " mContext " + this.jdField_a_of_type_AndroidContentContext);
      }
    }
    int n;
    int m;
    ...
    ((Face2FaceFriendBubbleView)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramanwq);
    ...
    if (QLog.isColorLevel())
    {
      if (!TextUtils.isEmpty(paramanwq.e)) {
        QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendInAnimation get ( currentUin= " + paramanwq.e.substring(0, 4) + " , index = " + m + " )");
      }
    }
    else
    {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        ((TranslateAnimation)localObject2).setInterpolator(new anwe(this));
        ((TranslateAnimation)localObject2).setAnimationListener(new anvz(this, paramanwq, m, d1, bool, paramBoolean3, paramanwq, paramBoolean1, paramBoolean2, (Face2FaceFriendBubbleView)localObject1, paramInt));
        ((Face2FaceFriendBubbleView)localObject1).startAnimation((Animation)localObject2);
        localObject1 = paramanwq.e;
        if ((paramanwq instanceof anwn)) {
          localObject1 = paramanwq.e + "_" + ((anwn)paramanwq).b;
        }
        break;
      }
      for (;;)
      {
        ...
        ((Face2FaceAddFriendActivity)this.jdField_a_of_type_AndroidContentContext).a(paramanwq, paramBoolean1, paramBoolean2);
        if (QLog.isColorLevel()) {
        ...
        {
          QLog.d(Face2FaceAddFriendActivity.a, 2, "startFriendInAnimation currentUIn= " + paramanwq.e.substring(0, 4) + " startAnimation OK");
          return;
          m = n;
          if (this.jdField_c_of_type_JavaUtilList.size() <= 1) {
            break label91;
  ...
  public void a(QQAppInterface paramQQAppInterface, View paramView, int paramInt, String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131299018));
    if ((paramInt == 1) && (!TextUtils.isEmpty(paramString)))
    {
      ((ImageView)paramView.findViewById(2131299019)).setVisibility(4);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839527);
      paramQQAppInterface = paramQQAppInterface.a(paramString, (byte)3, false, false);
      if (paramQQAppInterface != null) {
        break label476;
      }
      paramQQAppInterface = bacm.f();
    }
    label476:
    for (;;)
    {
      paramString = (ImageView)paramView.findViewById(2131311950);
  ...
  public void b()
  {
    ...
    for (this.jdField_b_of_type_Float = (this.jdField_a_of_type_Float - m);; this.jdField_b_of_type_Float = (m + f2))
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationRotateAnimation.setInterpolator(new anwd(this));
      this.jdField_a_of_type_AndroidWidgetImageView.startAnimation(this.jdField_a_of_type_AndroidViewAnimationRotateAnimation);
      this.jdField_a_of_type_AndroidViewAnimationRotateAnimation.setAnimationListener(new anwc(this));
      return;
