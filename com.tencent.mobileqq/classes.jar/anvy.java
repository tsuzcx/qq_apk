...
{
  private List<anvz> a = new ArrayList();
  
  public anvy(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(anvz paramanvz)
  {
    ...
    //   3: ifnull +18 -> 21
    //   6: aload_0
    //   7: getfield 18	anvy:a	Ljava/util/List;
    //   10: aload_1
    ...
    //   23: return
    //   24: aload_0
    //   25: getfield 18	anvy:a	Ljava/util/List;
    //   28: aload_1
  ...
  {
    if ((paramanvz == null) || (!this.a.contains(paramanvz))) {
      return;
    }
    this.a.remove(paramanvz);
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (parseOIDBPkg(paramFromServiceMsg, paramObject, localRspBody) == 0)
    {
      ...
      {
        anvz localanvz = (anvz)paramObject.next();
        if (localanvz != null) {
          localanvz.a(paramToServiceMsg, paramFromServiceMsg, localRspBody);
        }
      }
    }
  }
