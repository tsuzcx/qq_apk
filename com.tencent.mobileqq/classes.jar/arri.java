...
public class arri
{
  private static int jdField_a_of_type_Int = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131298914) - (int)bdgz.a(BaseApplicationImpl.getContext(), 5.0F);
