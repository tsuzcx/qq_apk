  ...
  implements arsm
{
  ...
  public arri()
  {
    this.jdField_a_of_type_EipcEIPCResultCallback = new arrj(this);
    this.jdField_b_of_type_EipcEIPCResultCallback = new arrk(this);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("listenTogether".equals(paramString2))
    {
      ...
      do
      {
        ...
        arsj.a(paramJsBridgeListener, "isOpener", this.jdField_b_of_type_EipcEIPCResultCallback);
        return true;
        if (!"isShowAtmosphere".equals(paramString3)) {
          break;
        }
      } while (TextUtils.isEmpty(this.c));
      arsj.a(paramJsBridgeListener, "isShowAtmosphere", this.jdField_a_of_type_EipcEIPCResultCallback);
      return true;
      if ("setPlayerId".equals(paramString3))
      {
        arsj.a(paramJsBridgeListener, "setPlayerId", null);
        return true;
      }
      if ("setThemeEnabled".equals(paramString3))
      {
        arsj.a(paramJsBridgeListener, "setThemeEnabled", null);
        return true;
      }
    }
    return false;
