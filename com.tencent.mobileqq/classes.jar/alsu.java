  ...
  implements alsv
{
  ...
  public void a(Context paramContext, ColorNote paramColorNote)
  {
    try
    {
      JSONObject localJSONObject1 = new JSONObject(new String(paramColorNote.getReserve()));
      i = localJSONObject1.optInt("colorNoteType", 0);
      if (i == 2)
      {
    ...
    catch (JSONException localJSONException)
    {
      ...
      do
      {
        ...
        if (i == 1)
        {
          a(paramContext, localJSONObject2);
          return;
        }
      } while (i != 3);
