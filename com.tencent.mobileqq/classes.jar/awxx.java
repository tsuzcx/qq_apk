  ...
  implements awxw
{
  ...
  public static awxw asInterface(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.mobileqq.music.IQQPlayerCallback");
    if ((localIInterface != null) && ((localIInterface instanceof awxw))) {
      return (awxw)localIInterface;
    }
    return new awxy(paramIBinder);
  }
