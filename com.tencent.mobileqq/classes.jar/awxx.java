  ...
  extends awyf
{
  ...
  public awxx(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      continue;
      this.jdField_c_of_type_Int = 2131560910;
    }
  }
  ...
  protected void a()
  {
    ...
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131364811));
    switch (this.jdField_a_of_type_Int)
    {
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidViewView = this.jdField_b_of_type_AndroidViewView.findViewById(2131364730);
      ...
      if (this.e != null)
      {
        ...
        if ((this.e instanceof ThemeImageView)) {
          ((ThemeImageView)this.e).setMaskShape(bfwa.jdField_c_of_type_Int);
        }
      }
      this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopActiveLayout = ((TroopActiveLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131361947));
      ...
      return;
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_b_of_type_AndroidViewView.findViewById(2131375181));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131375191));
      this.jdField_b_of_type_ComTencentMobileqqTroopWidgetTroopLabelLayout = ((TroopLabelLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131377827));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131369839));
      this.f = this.jdField_b_of_type_AndroidViewView.findViewById(2131378329);
      continue;
      ...
      this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopLabelLayout = ((TroopLabelLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131377827));
      if (this.h != null)
      {
        TextView localTextView = this.h;
        int j = axli.jdField_a_of_type_Int - axli.a(187.0F);
        int i = j;
        if (j <= 0) {
          i = axli.a(220.0F);
        }
