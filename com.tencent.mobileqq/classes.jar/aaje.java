  ...
  extends IArConfigManager.Stub
{
  ...
  public aaje(ArConfigService paramArConfigService)
  {
  ...
  public void c()
  {
    ...
    do
    {
      ...
      ArConfigService.a(localArConfigService).post(new aajf(this, localArConfigService, i));
    } while (i != 100);
    ArConfigService.a(localArConfigService).post(new aajg(this, localArConfigService));
  }
}
