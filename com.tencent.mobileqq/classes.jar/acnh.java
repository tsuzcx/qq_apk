...
public class acnh
{
  ...
  static
  {
    ...
    e = new int[] { -1034, -1042, -2015, -2061, -2003, -2004, -2009, -1001, -2076, -2012, -1013, -2030, -1019, -1018, -1014, -1043, -1045, -5000, -5001, -1024, -1028, 2024, -2042, -5005, -1046, -2027, -2037, -5006, -4011, -4012, -2029, -2034, -2033, -2041, -2060, -2062, -2065, -2063, -2066, -3016, -7007, -7010, -7009, -7011, -7012, -7015 };
    ...
    h = new int[] { -2006, -1034, -1042, -2015, -2061, -4002, -4003, -4004, -1001, -1047, -1013, -2030, -1019, -1018, -2012, -1014, -1004, -1016, -1017, -1050, -2021, -3011, -4020, -3009, -3010, -1041, -1043, -1044, -1045, -5000, -5001, -1024, -1028, 1018, 2024, -2042, -1012, -1046, -2027, -2029, -2043, -4021, -4022, -2049, -5021, -5023, -2065, -2060, -2062, -4023, -4024, -7007, -2077, -7010, -7009, -7011, -7012, -7013, -7015 };
    i = new int[0];
    j = new int[0];
    k = new int[] { 1008 };
    ...
    q = new int[] { 0, 1000, 1004, 1020, 1006, 1001, 10002, 10004, 1009, 1003, 1005, 1008, 1023, 1021, 1022, 1024, 1025, 1010, 7400, 1037, 1044, 1045, 1032, 1033, 1034, 1036, 1038, 10007, 10008, 10009, 10010, 10011 };
    r = new int[] { 1033, 1034 };
    s = new int[] { 1000, 1004, 1020 };
    t = new int[] { 1, 3000, 1006, 7000, 9501, 10005, 1033, 1034, 1036 };
    jdField_c_of_type_ArrayOfJavaLangString = new String[] { AppConstants.LBS_HELLO_UIN, AppConstants.DATE_UIN };
    u = new int[] { 1001, 10002, 1010 };
    v = new int[] { 0, 1, 3000, 1025, 1024 };
    w = new int[] { 0, 1, 3000 };
    jdField_a_of_type_JavaUtilComparator = new acni();
  }
  ...
  {
    return aqvh.a(paramInt1, paramInt2);
  }
  ...
  public static int a(List<MessageRecord> paramList, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      if (!localMessageRecord.isread)
      {
        ...
        {
          if (paramQQAppInterface.getMsgCache().a(localMessageRecord)) {
            break;
          }
          i2 = i1;
  ...
  public static String a(MessageRecord paramMessageRecord)
  {
    ...
    if (paramMessageRecord.istroop == 1032)
    {
      ...
      for (;;)
      {
        return aqvh.a(paramMessageRecord.senderuin, i1, paramMessageRecord.getConfessTopicId());
        i1 = 1034;
      }
    }
    if ((paramMessageRecord.istroop == 1033) || (paramMessageRecord.istroop == 1034)) {
      return aqvh.a(paramMessageRecord.frienduin, paramMessageRecord.istroop, paramMessageRecord.getConfessTopicId());
    }
  ...
  public static List<MessageRecord> a(List<MessageRecord> paramList, boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean) {
      Collections.sort(paramList, new acnj());
    }
  ...
  {
    Iterator localIterator = paramQQAppInterface.getMessageFacade().getMsgList(paramString, paramInt1).iterator();
    while (localIterator.hasNext())
    {
      ...
      if (paramInt2 == localMessageRecord.msgtype) {
        ...
        {
        default: 
          paramQQAppInterface.getMessageFacade().removeMsgFromCacheByUniseq(paramString, paramInt1, paramInt2, localMessageRecord.uniseq);
          break;
        case -3010: 
          paramQQAppInterface.getMessageFacade().removeMsgFromCacheByUniseq(paramString, paramInt1, paramInt2, localMessageRecord.uniseq);
          break;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong)
  {
    for (;;)
    {
        ...
        if ((localList != null) && (localList.size() > 0))
        {
          ...
          if (i4 >= 0)
          {
            ...
            if (localMessageRecord.shmsgseq > paramLong)
            {
              ...
              paramQQAppInterface.getMessageFacade().removeMsgByUniseq(paramString, 1, localMessageRecord.uniseq);
              if (QLog.isColorLevel())
              {
      ...
      for (;;)
      {
        ...
        bdla.b(paramQQAppInterface, "dc00899", "BizTechReport", "", "Grp_msg", "del_abnormal_local_msg", 0, 0, paramString, i2 + "", i3 + "", "");
        return;
        label426:
        i5 = i1;
        i1 = i3;
  ...
  public static void a(String paramString, int paramInt, List<MessageRecord> paramList, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      ArrayList localArrayList = new ArrayList();
      Object localObject1 = paramQQAppInterface.getMsgCache();
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    if (paramInt == 3000)
    {
      ...
      DiscussionInfo localDiscussionInfo = localantp.a(paramString, true);
      if ((localDiscussionInfo == null) || (localDiscussionInfo.isHidden())) {
        return true;
      }
      paramQQAppInterface = localantp.a(paramString, paramQQAppInterface.getCurrentAccountUin());
      if (paramQQAppInterface != null) {
    ...
    for (;;)
    {
      ...
      if (c(paramMessageRecord1, paramMessageRecord2))
      {
        ...
        if (c(paramMessageRecord1, paramMessageRecord2))
        {
          ...
          else if (avia.a(paramMessageRecord1))
          {
            paramBoolean = bool1;
            if (paramMessageRecord1.msgUid == paramMessageRecord2.msgUid)
            {
              ...
              do
              {
                do
                {
                  do
                  {
                    ...
                    paramBoolean1 = bool;
                  } while (avia.a(paramMessageRecord1));
  ...
  public static byte[] a(MessageRecord paramMessageRecord1, MessageRecord paramMessageRecord2)
  {
    ...
    paramMessageRecord1 = (MessageForTroopFile)bcsa.a(-2017);
  ...
  public static String c(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord.istroop == 1) && (nty.b(paramMessageRecord))) {
      return "80000000";
    }
    return paramMessageRecord.senderuin;
  }
  ...
  {
    return (d(paramMessageRecord)) && (!b(paramMessageRecord.frienduin, paramMessageRecord.istroop)) && (paramQQAppInterface.getConversationFacade().a(paramMessageRecord.frienduin));
  }
