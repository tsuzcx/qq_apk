...
public class arzn
  implements Manager
{
  arzi jdField_a_of_type_Arzi;
  private arzt jdField_a_of_type_Arzt;
  private final arzv jdField_a_of_type_Arzv;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private FloatMapWidget jdField_a_of_type_ComTencentMobileqqLocationWindowFloatMapWidget;
  public boolean a;
  
  public arzn(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Arzt = new arzt(paramQQAppInterface);
    this.jdField_a_of_type_Arzv = new arzv(paramQQAppInterface);
    this.jdField_a_of_type_Arzi = new arzi(paramQQAppInterface);
  }
  
  public static arzn a(QQAppInterface paramQQAppInterface)
  {
    return (arzn)paramQQAppInterface.getManager(143);
  }
  ...
  private void a(arum paramarum)
  {
    ...
    for (localObject = new LatLng(((TencentLocation)localObject).getLatitude(), ((TencentLocation)localObject).getLongitude());; localObject = null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqLocationWindowFloatMapWidget = ((FloatMapWidget)LayoutInflater.from(BaseApplicationImpl.context).inflate(2131559172, null).findViewById(2131369543));
      this.jdField_a_of_type_Arzi.a(paramarum, (CameraPosition)localObject, this.jdField_a_of_type_ComTencentMobileqqLocationWindowFloatMapWidget, null);
      return;
    }
  }
  
  private void a(BaseActivity paramBaseActivity, arum paramarum)
  {
    arzc localarzc = new arzc();
    localarzc.a(paramBaseActivity.getString(2131719613));
    localarzc.b(paramBaseActivity.getString(2131690832));
    localarzc.c(paramBaseActivity.getString(2131691240));
    localarzc.a(new arzq(this, paramBaseActivity, paramarum));
    localarzc.b(new arzr(this));
    localarzc.c(new arzs(this, localarzc));
    localarzc.a();
  }
  
  private boolean b(BaseActivity paramBaseActivity, arum paramarum)
  {
    ...
    if (i == 1)
    {
      arvm.a(paramBaseActivity);
      return false;
    }
    localFloatingScreenManager.setWindowClickListener(1, new arzo(this, paramBaseActivity, paramarum));
    return true;
  }
  ...
  public arzv a()
  {
    return this.jdField_a_of_type_Arzv;
  }
  ...
  public boolean a(BaseActivity paramBaseActivity, arum paramarum)
  {
    if (!AppNetConnInfo.isNetSupport()) {
      bcql.a(BaseApplicationImpl.context, 2131694610, 0).a();
    }
    do
    {
      return false;
      a(paramarum);
      a();
    } while (!b(paramBaseActivity, paramarum));
    a().a(paramarum);
    arus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).c(paramarum.a(), paramarum.a());
    arza.d();
    int i = arza.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramarum);
    if (i != 0) {
      axqy.b(null, "CliOper", "", "", "0X800A974", "0X800A974", i, 0, "0", "0", "0", "");
    }
    return true;
  }
