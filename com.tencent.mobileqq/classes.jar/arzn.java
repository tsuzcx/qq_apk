...
public final class arzn
{
  ...
  public arzn(WebViewPlugin paramWebViewPlugin)
  {
  ...
  private AppActivity a()
  {
    ...
    label38:
    for (Object localObject = null;; localObject = ((bifw)localObject).a())
    {
  ...
  private void b()
  {
    ...
    localAppActivity.requestPermissions(new arzo(this), 1819, new String[] { "android.permission.CAMERA" });
    if (this.jdField_a_of_type_AndroidOsHandler == null) {
      this.jdField_a_of_type_AndroidOsHandler = new arzp(this, Looper.getMainLooper());
    }
