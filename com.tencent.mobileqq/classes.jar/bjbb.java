  ...
  extends BaseAdapter
{
  ...
  public bjbb(Context paramContext, int paramInt)
  {
  ...
  private View a()
  {
    ...
    ((URLImageView)localObject2).setImageResource(2130843727);
    ...
    ((TextView)localObject3).setText(ajya.a(2131704611));
    ...
    ((TextView)localObject2).setBackgroundResource(2130843726);
    ((TextView)localObject2).setGravity(17);
    localObject3 = new RelativeLayout.LayoutParams(-1, bbll.b(31.0F));
    ((RelativeLayout.LayoutParams)localObject3).addRule(14, -1);
  ...
  public void a(List<QIMFilterCategoryItem> paramList)
  {
    ...
    if (!bkrf.a().c()) {
      bkrf.a(this.jdField_a_of_type_JavaUtilList);
    }
  }
    ...
    for (;;)
    {
      ...
      if (localQIMFilterCategoryItem.c())
      {
        ...
        if (bool)
        {
          ...
          localImageView1.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843728));
        }
        for (;;)
        {
          localImageView2.setVisibility(8);
          localTextView.setText(ajya.a(2131704612));
      ...
      paramView = ((bjcb)bjav.a(5)).a(localQIMFilterCategoryItem);
      if (bool)
      {
        localImageView3.setVisibility(0);
        ...
        ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843722);
        ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843722);
      ...
      label591:
      bkrf.a();
      bool = bkrf.a(3, localQIMFilterCategoryItem.jdField_a_of_type_Int, localQIMFilterCategoryItem.jdField_a_of_type_JavaLangString);
