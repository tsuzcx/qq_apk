  ...
  extends WebViewPlugin
{
  ...
  private void a(String... paramVarArgs)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          if ((localActivity != null) && ((localActivity instanceof bmnw)) && (((bmnw)localActivity).a())) {
            return;
          }
          ...
          if ((localActivity == null) || ((!(localActivity instanceof bmnw)) && (!(localActivity instanceof BasePluginActivity)))) {
            break label343;
          }
  ...
  private void c(String... paramVarArgs)
  {
    try
    {
      ...
      paramVarArgs.putExtra("key_left_tab_title", this.mRuntime.a().getString(2131716198));
      paramVarArgs.putExtra("key_right_tab_title", this.mRuntime.a().getString(2131716279));
