  ...
  extends YUVTexture
{
  ...
  private mep jdField_a_of_type_Mep;
  
  public lsf(Context paramContext, mep parammep, String paramString, long paramLong)
  {
    super(paramContext, paramString, paramLong);
    this.jdField_a_of_type_Mep = parammep;
  }
  ...
  private static void a(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      if (jdField_a_of_type_JavaLangString == null) {
        jdField_a_of_type_JavaLangString = bhlo.c();
      }
      paramContext = lot.a();
      f = false;
  ...
  public lru[] a(lqt paramlqt)
  {
    if (a() > b())
    {
      ...
      if ((!f) || (getImgWidth() > n) || (i <= ((lqu)paramlqt).c() / 3 * 2) || (getImgWidth() >= i) || (getImgWidth() == 0) || (this.jdField_a_of_type_Mep.a().size() != 0) || (VideoController.a().a().d != 2)) {
        break label211;
      }
    }
    label211:
