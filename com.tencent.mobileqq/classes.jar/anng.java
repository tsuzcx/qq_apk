  ...
  extends QQCustomDialog
{
  ...
  public anng(Context paramContext)
  {
  ...
  private void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqApolloViewApolloGameProcessBar = new ApolloGameProcessBar(paramContext, 2130838658, 2130838660);
    ...
    ((TextView)localObject).setText(anvx.a(2131699890));
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setText(anvx.a(2131699881));
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setBackground(paramContext.getResources().getDrawable(2130838659));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new annh(this));
    ...
    setCancelable(false);
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new anni(this));
  }
