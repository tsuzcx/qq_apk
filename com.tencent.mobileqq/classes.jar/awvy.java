...
public class awvy
{
  ...
  public static int a()
  {
    int i = BaseApplicationImpl.sApplication.getResources().getColor(2131166779);
    if (ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, "")) {
      i = BaseApplicationImpl.sApplication.getResources().getColor(2131166781);
    }
    return i;
  }
  ...
  private static long a(String paramString, bbcg parambbcg, boolean paramBoolean)
  {
    paramString = a(parambbcg, paramString);
    return a(paramString[0], paramString[1], parambbcg.jdField_a_of_type_JavaUtilList.size(), false, paramBoolean);
  }
    ...
    do
    {
      for (;;)
      {
        ...
        if (l != -9223372036854775808L) {
          return awig.r + l + paramLong;
        }
        if (paramBoolean1)
        {
          bbcg localbbcg = ChnToSpell.a(paramString2, 1);
          if (!paramString2.equals(localbbcg.jdField_a_of_type_JavaLangString)) {}
          while (i != 0)
          {
            l = a(paramString1, localbbcg, paramBoolean3);
            if (l == -9223372036854775808L) {
              break label123;
            }
            return awig.s + l + paramLong;
            i = 0;
          }
        }
      }
  ...
  public static long a(String paramString1, String paramString2, bbcg parambbcg1, bbcg parambbcg2, long paramLong)
  {
    if ((TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString1))) {}
    long l;
    label116:
    do
    {
      for (;;)
      {
        ...
        if ((parambbcg1 != null) && (parambbcg2 != null))
        {
          if (!paramString2.equals(parambbcg1.jdField_a_of_type_JavaLangString)) {}
          for (int i = 1; i != 0; i = 0)
          {
            l = a(paramString1, parambbcg1, false);
            if (l == -9223372036854775808L) {
              break label116;
            }
            return awig.s + l + paramLong;
      ...
      l = a(paramString1, parambbcg2, false);
    } while (l == -9223372036854775808L);
    return awig.s + l + paramLong;
  }
  ...
  {
    Drawable localDrawable = BaseApplicationImpl.sApplication.getResources().getDrawable(2130840065);
  ...
  public static Drawable a(baxk parambaxk, awod paramawod)
  {
    return a(parambaxk, paramawod.b(), paramawod.c());
  }
  
  public static Drawable a(baxk parambaxk, String paramString, int paramInt)
  {
    if (paramInt == 103) {}
    for (int i = 1;; i = paramInt)
    {
      Bitmap localBitmap = parambaxk.a(i, paramString);
      if (localBitmap != null)
      {
        if (paramInt == 103) {
      ...
      if (!parambaxk.a()) {
        parambaxk.a(paramString, i, true, (byte)1);
      }
      if (paramInt == 1) {
        return bbdr.b();
      }
      ...
      if (paramInt == 11) {
        return new BitmapDrawable(bbdr.b());
      }
      if (paramInt == 102) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130843408);
      }
      if (paramInt == 106) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130846126);
      }
      if (paramInt == 105)
      {
        parambaxk = sfh.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext(), 1);
        if ((parambaxk != null) && (parambaxk.a() != null)) {
          return parambaxk.a();
        }
        return sfh.a(BaseApplicationImpl.sApplication, 1);
      }
      if (String.valueOf(9999L).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130840073);
      }
      if (String.valueOf(9994L).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130840080);
      }
      if (String.valueOf(9992L).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130840078);
      }
      if (ajsf.aB.equals(paramString)) {
        return sbc.a();
      }
      if (String.valueOf(9980L).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130840079);
      }
      if (String.valueOf(9973L).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130843922);
      }
      if (paramInt == 9889987) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130842027);
      }
      if (paramInt == 108)
      {
        parambaxk = BaseApplicationImpl.sApplication.getRuntime();
        if (parambaxk != null) {
          return ((afaz)parambaxk.getManager(138)).a();
        }
      }
      else
      {
        if (String.valueOf(ajsf.D).equals(paramString)) {
          return BaseApplicationImpl.sApplication.getResources().getDrawable(2130840070);
        }
        if (paramInt == 110)
        {
          parambaxk = sfh.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), BaseApplicationImpl.sApplication, 2);
          if ((parambaxk != null) && (parambaxk.a() != null)) {
            return parambaxk.a().getConstantState().newDrawable();
          }
          return sfh.a(BaseApplicationImpl.sApplication, 2).getConstantState().newDrawable();
        }
        if (paramInt == 111)
        {
          parambaxk = sfh.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), BaseApplicationImpl.sApplication, 3);
          if ((parambaxk != null) && (parambaxk.a() != null)) {
            return parambaxk.a().getConstantState().newDrawable();
          }
          return sfh.a(BaseApplicationImpl.sApplication, 3).getConstantState().newDrawable();
        }
      }
      return bbdr.b();
    }
  ...
  public static awvw a(String paramString1, bbch parambbch1, String paramString2, bbch parambbch2, long paramLong)
  {
    if ((TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString1)) || (paramString2.contains(paramString1))) {
      return null;
    }
    if ((parambbch1 == null) || (parambbch2 == null)) {
      return null;
    }
    if (awwe.a(paramString1) == 0) {
      return null;
    }
    ...
    awvw localawvw = new awvw();
    String str2 = parambbch1.jdField_b_of_type_JavaLangString;
    String str4 = parambbch1.jdField_c_of_type_JavaLangString;
    parambbch1 = parambbch1.jdField_d_of_type_JavaLangString;
    String str3 = parambbch2.jdField_b_of_type_JavaLangString;
    String str5 = parambbch2.jdField_c_of_type_JavaLangString;
    paramString1 = parambbch2.jdField_d_of_type_JavaLangString;
    int i5 = awwe.a(paramString2);
    int i1 = 0;
    ...
    case 0: 
      for (;;)
      {
        localawvw.jdField_d_of_type_Int = m;
        localawvw.jdField_a_of_type_Boolean = true;
        localawvw.jdField_a_of_type_JavaLangString = str1;
        localawvw.jdField_b_of_type_JavaLangString = str2;
        localawvw.jdField_c_of_type_JavaLangString = paramString2;
        localawvw.jdField_d_of_type_JavaLangString = str3;
        k = j;
        if (paramString2.length() < j) {
          k = 0;
        }
        localawvw.jdField_a_of_type_Int = k;
        j = i;
        if (paramString2.length() - localawvw.jdField_a_of_type_Int < i) {
          j = paramString2.length() - localawvw.jdField_a_of_type_Int;
        }
        localawvw.jdField_b_of_type_Int = j;
        localawvw.jdField_c_of_type_Int = ((100 - m << 8) + (n << 4) + i4);
        return localawvw;
    ...
    case 1: 
      if (str3.contains(str2))
      {
        ...
        if (awwe.a(paramString2.charAt(i)))
        {
          if (str1.length() + i > paramString2.length()) {
            break label1021;
          }
          m = ((Integer)parambbch2.jdField_b_of_type_JavaUtilList.get(i)).intValue();
          if (str1.length() + i + 1 < parambbch2.jdField_b_of_type_JavaUtilList.size())
          {
            j = ((Integer)parambbch2.jdField_b_of_type_JavaUtilList.get(str1.length() + i + 1)).intValue();
            label518:
    ...
    for (;;)
    {
      ...
      {
        m = str1.length();
        n = ((Integer)parambbch2.jdField_b_of_type_JavaUtilList.get(j)).intValue();
        if (j + m + 1 < parambbch2.jdField_b_of_type_JavaUtilList.size())
        {
          i = ((Integer)parambbch2.jdField_b_of_type_JavaUtilList.get(str1.length() + j + 1)).intValue();
          label700:
          parambbch2 = str3.substring(n, i);
      ...
      for (;;)
      {
        ...
        if (str5.contains(str4))
        {
          ...
          {
            m = str1.length();
            n = ((Integer)parambbch2.jdField_b_of_type_JavaUtilList.get(i)).intValue();
            if (i + m + 1 < parambbch2.jdField_b_of_type_JavaUtilList.size())
            {
              j = ((Integer)parambbch2.jdField_b_of_type_JavaUtilList.get(str1.length() + i + 1)).intValue();
              label891:
              parambbch2 = str3.substring(n, j);
  ...
  public static awwa a(CharSequence paramCharSequence, String paramString, boolean paramBoolean)
  {
    ...
    if ((TextUtils.isEmpty(paramCharSequence)) || (TextUtils.isEmpty(paramString))) {
      return new awwa(paramCharSequence);
    }
    ...
    label293:
    return new awwa(paramCharSequence);
    return new awwa(paramCharSequence, i, j);
  }
  ...
  public static CharSequence a(TextView paramTextView, float paramFloat, int paramInt, CharSequence paramCharSequence, List<String> paramList, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    float f1 = a(paramTextView, ajyc.a(2131713669));
    ...
    do
    {
      do
      {
        ...
        for (;;)
        {
          ...
          awwa localawwa = a(paramCharSequence, (String)localObject, paramBoolean1);
          localObject = localawwa.jdField_a_of_type_JavaLangCharSequence;
          m = j;
          n = i;
          ...
          if (i == -1)
          {
            ...
            if (j == 0)
            {
              ...
              n = i;
              paramCharSequence = (CharSequence)localObject;
              if (localawwa.jdField_a_of_type_Int != -1)
              {
                m = j;
                n = i;
                paramCharSequence = (CharSequence)localObject;
                if (localawwa.jdField_b_of_type_Int > 0)
                {
                  n = localawwa.jdField_a_of_type_Int;
                  m = localawwa.jdField_b_of_type_Int;
                  paramCharSequence = (CharSequence)localObject;
                }
              }
            }
  ...
  public static CharSequence a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      jdField_a_of_type_AndroidGraphicsPaint = ((TextView)LayoutInflater.from(paramQQAppInterface.getApp()).inflate(2131562380, null).findViewById(2131377350)).getPaint();
      if (jdField_c_of_type_Int == 0) {
        jdField_c_of_type_Int = paramQQAppInterface.getApp().getResources().getDimensionPixelOffset(2131298187);
      }
    }
    String str = paramString1.toLowerCase();
  ...
  public static CharSequence a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, awvw paramawvw)
  {
    if (paramawvw == null) {
      return new SpannableStringBuilder(paramString1);
    }
    ...
    int k = paramawvw.jdField_a_of_type_Int;
    int m = paramawvw.jdField_b_of_type_Int;
    if ((k < 0) || (k > paramString1.length()) || (!paramString1.equalsIgnoreCase(paramawvw.jdField_c_of_type_JavaLangString)) || (paramawvw.jdField_d_of_type_Int > 1)) {
      return new SpannableStringBuilder(paramString1);
    }
    float f1 = jdField_a_of_type_AndroidGraphicsPaint.measureText(paramString1);
    ...
    if ((f1 >= jdField_c_of_type_Int) && (k >= 0))
    {
      ...
      paramawvw = new float[paramString2.length()];
      jdField_a_of_type_AndroidGraphicsPaint.getTextWidths(paramString2, paramawvw);
      i = paramawvw.length - 1;
      f1 = 0.0F;
      j = 0;
      if (i >= 0)
      {
  ...
  public static void a()
  {
    ...
    {
      if (i != 0) {
        axqw.b(null, "CliOper", "", "", "0X8005ECF", "0X8005ECF", i, 0, "", "", "", "");
      }
      return;
      j = 0;
      break;
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, String paramString1, String paramString2, int paramInt4)
  {
    ...
    default: 
      ...
      if (paramBoolean)
      {
        ...
        if (paramInt4 == 12)
        {
          ...
          label190:
          axrl.a(com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext()).a(null, "NetGroupSearchItemClick", true, 0L, 0L, localHashMap, null);
          paramString1 = "";
          switch (paramInt1)
          {
          }
    ...
    for (;;)
    {
      axqw.b(null, "CliOper", "", "", paramString1, paramString1, 0, 0, String.valueOf(paramInt3), "", "", "");
      return;
      i = 70;
      break;
      i = 80;
      ...
      for (;;)
      {
        axrl.a(com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext()).a(null, "NetModelSearchItemClick", true, 0L, 0L, localHashMap, null);
        break;
        localHashMap.put("isFolder", "0");
      }
      if (paramInt3 == 0)
    ...
    case 44: 
      do
      {
        do
        {
          ...
          return;
          ayan.a(localQQAppInterface, paramContext, String.valueOf(9992L));
      ...
      axqw.b(localQQAppInterface, "CliOper", "", "", "0X8006477", "0X8006477", paramInt2, 0, "", "", "", "");
      return;
    }
    ConfessMsgListFragment.a(paramContext, 2);
  }
  
  public static void a(Intent paramIntent, aqbc paramaqbc)
  {
    int j = 1006;
    boolean bool2 = false;
    String str1;
    ...
    int m;
    boolean bool1;
    if ((paramIntent != null) && (paramaqbc != null))
    {
      ...
      bool1 = true;
      if ((!(paramaqbc instanceof aqgb)) || (!paramIntent.hasExtra("contactSearchResultPhoneContactMobileCode")) || (k == 1006)) {
        break label395;
      }
  ...
  public static void a(View paramView, awoc paramawoc)
  {
    Activity localActivity = (Activity)paramView.getContext();
    Intent localIntent = new Intent();
    localIntent.putExtra("contactSearchResultUin", paramawoc.b());
    localIntent.putExtra("contactSearchResultUinType", paramawoc.d());
    localIntent.putExtra("contactSearchResultName", paramawoc.c());
    localIntent.putExtra("contactSearchResultNick", paramawoc.d());
    if (((paramawoc instanceof awmo)) || ((paramawoc instanceof awnb)) || ((paramawoc instanceof awmw))) {
      paramView = paramawoc.b();
    }
    for (;;)
    {
      String str;
      ...
      {
        localIntent.putExtra("contactSearchResultPhoneContactOriginBinder", ((awmy)paramawoc).a.originBinder);
        awmy localawmy = (awmy)paramawoc;
        str = localawmy.a.mobileCode;
        if (!TextUtils.isEmpty(str)) {
          break label282;
        }
        str = localawmy.a.mobileNo;
      }
      label282:
      for (;;)
      {
        localIntent.putExtra("contactSearchResultPhoneContactMobileCode", str);
        localIntent.putExtra("contactSearchResultPhoneContactNationCode", ((awmy)paramawoc).a.nationCode);
        localIntent.putExtra("contactSearchResultPhoneContactAbility", ((awmy)paramawoc).a.ability);
        ...
        {
          paramView = ((awmq)paramawoc).e();
          break;
        }
        if ((paramawoc instanceof awmx))
        {
          paramView = ((awmx)paramawoc).jdField_a_of_type_JavaLangString;
          break;
        }
        if (!(paramawoc instanceof awmz)) {
          break label285;
        }
        paramView = ((awmz)paramawoc).e();
        break;
      }
      label285:
      paramView = "";
  ...
  public static void a(awoc paramawoc, View paramView)
  {
    ThreadManager.postImmediately(new SearchUtils.2(paramView, paramawoc), null, true);
  }
  
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, List<String> paramList, String paramString3, Rect paramRect, awvz paramawvz)
  {
    ThreadManager.post(new SearchUtils.3(paramString1, paramString2, paramList, paramString3, paramRect, paramAppInterface, paramawvz), 8, null, true);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        paramQQAppInterface = bbej.a(paramQQAppInterface, paramActivity, paramString);
        if (paramQQAppInterface != null)
        {
  ...
  public static void a(String paramString)
  {
    ...
    for (int i = arrayOfString.length;; i = 0)
    {
      if (i > 1)
      {
        ...
        axqw.b(null, "CliOper", "", "", "0X8005E0F", "0X8005E0F", 0, 0, "" + i, "", "", "");
      }
      return;
    }
  }
  ...
  public static void a(String paramString, int paramInt1, int paramInt2, int paramInt3, View paramView)
  {
    ...
    if (bool)
    {
      int i = awvx.a(paramInt1);
      if (QLog.isColorLevel()) {
        QLog.d("searchUtils", 2, "moduleIndex:" + i + " searchKey:" + paramString);
      }
      axqw.b(null, "CliOper", "", "", "0X8005E10", "0X8005E10", paramInt1, 0, String.valueOf(i), String.valueOf(paramInt3), String.valueOf(paramInt2), "");
      ...
      axrl.a(com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext()).a(null, "GroupSearchItemClick", true, 0L, 0L, a(paramView), null);
      return;
    }
    axqw.b(null, "CliOper", "", "", "0X8005E11", "0X8005E11", paramInt1, 0, "", String.valueOf(paramInt3), String.valueOf(paramInt2), "");
    paramView = new HashMap();
    paramView.put("moduleType", Integer.toString(paramInt1));
    paramView.put("moduleChildType", Integer.toString(paramInt2));
    paramView.put("itemLinePosition", Integer.toString(paramInt3));
    paramView.put("keyword", paramString);
    axrl.a(com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext()).a(null, "ModelSearchItemClick", true, 0L, 0L, paramView, null);
  }
  
  public static void a(String paramString, int paramInt1, int paramInt2, View paramView)
  {
    boolean bool = a(paramView.getContext());
    int i = ((Integer)paramView.getTag(2131379209)).intValue() + 1;
    if (QLog.isColorLevel()) {
      QLog.d("searchUtils", 2, "moduleType:" + paramInt1 + " itemLinePosition:" + i);
    }
    if (bool)
    {
      int j = awvx.a(paramInt1);
      if (QLog.isColorLevel()) {
        QLog.d("searchUtils", 2, "moduleIndex:" + j + " searchKey:" + paramString);
      }
      axqw.b(null, "CliOper", "", "", "0X8005E10", "0X8005E10", paramInt1, 0, String.valueOf(j), String.valueOf(i), String.valueOf(paramInt2), "");
      paramView = new HashMap();
      paramView.put("moduleType", Integer.toString(paramInt1));
    ...
    axqw.b(null, "CliOper", "", "", "0X8005E11", "0X8005E11", paramInt1, 0, "", String.valueOf(i), String.valueOf(paramInt2), "");
    paramView = new HashMap();
    paramView.put("moduleType", Integer.toString(paramInt1));
    paramView.put("moduleChildType", Integer.toString(paramInt2));
    paramView.put("itemLinePosition", Integer.toString(i));
  ...
  public static void a(String paramString, int paramInt, View paramView, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      axqw.b(null, "CliOper", "", "", "0X8005E12", "0X8005E12", 40, 0, "3", "", "", "");
    }
    do
    {
      return;
      ...
      axqw.b(null, "CliOper", "", "", "0X8005E12", "0X8005E12", paramInt, 0, "1", "", "", "");
    } while (!UniteSearchActivity.jdField_b_of_type_Boolean);
    if (UniteSearchActivity.e == -1)
    {
      axqw.b(null, "CliOper", "", "", "0X8007E2E", "0X8007E2E", 2, 0, "", "" + UniteSearchActivity.jdField_b_of_type_Int, UniteSearchActivity.jdField_a_of_type_JavaLangString, "");
      return;
    }
    axqw.b(null, "CliOper", "", "", "0X8007E2E", "0X8007E2E", 1, 0, "", "" + UniteSearchActivity.jdField_b_of_type_Int, UniteSearchActivity.jdField_a_of_type_JavaLangString, "");
    return;
    if (QLog.isColorLevel()) {
      QLog.d("searchUtils", 2, "moduleType:" + paramInt + " -2 searchKey:" + "");
    }
    axqw.b(null, "CliOper", "", "", "0X8005E12", "0X8005E12", paramInt, 0, "2", "", "", "");
  }
  
  public static void a(String paramString1, String paramString2, int paramInt1, int paramInt2, String... paramVarArgs)
  {
    new axra(null).a("dc00899").b("Grp_all_search").c(paramString1).d(paramString2).a(paramInt1).b(paramInt2).a(paramVarArgs).a();
  }
  ...
  {
    new axra(null).a("dc00899").b(paramString1).c(paramString2).d(paramString3).a(paramInt1).b(paramInt2).a(paramVarArgs).a();
  }
  ...
  public static boolean a(awog paramawog)
  {
    return ((paramawog instanceof awmo)) || ((paramawog instanceof awms)) || ((paramawog instanceof awmw)) || ((paramawog instanceof awnb));
  }
  ...
  public static int[] a(bbcg parambbcg, String paramString)
  {
    ...
    tmp11_7[1] = 0;
    tmp11_7;
    int j = parambbcg.jdField_a_of_type_JavaLangString.indexOf(paramString);
    if (j < 0) {
      return arrayOfInt;
    }
    int i = 0;
    int k;
    if (i < parambbcg.jdField_a_of_type_JavaUtilList.size())
    {
      if (j == ((Integer)parambbcg.jdField_a_of_type_JavaUtilList.get(i)).intValue())
      {
        arrayOfInt[0] = i;
        k = i + 1;
        for (;;)
        {
          if ((k >= parambbcg.jdField_a_of_type_JavaUtilList.size()) || (j + paramString.length() <= ((Integer)parambbcg.jdField_a_of_type_JavaUtilList.get(k)).intValue()))
          {
            arrayOfInt[1] = (k - i);
            return arrayOfInt;
          }
      ...
      k = parambbcg.jdField_a_of_type_JavaLangString.indexOf(paramString, ((Integer)parambbcg.jdField_a_of_type_JavaUtilList.get(i)).intValue());
      if (k < 0) {
        return arrayOfInt;
      }
      j = i - 1;
    ...
    do
    {
      for (;;)
      {
        ...
        if (paramBoolean)
        {
          ...
          if (!paramString2.equals(((bbcg)localObject).jdField_a_of_type_JavaLangString)) {}
          for (int i = 1; i != 0; i = 0)
          {
            localObject = a((bbcg)localObject, paramString1);
  ...
  public static int b()
  {
    int i = BaseApplicationImpl.sApplication.getResources().getColor(2131166778);
    if (ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, "")) {
      i = BaseApplicationImpl.sApplication.getResources().getColor(2131166780);
    }
    return i;
  }
      ...
      while (i < paramString1.length)
      {
        ...
        if (!paramString1[i].equalsIgnoreCase(paramString2[i]))
        {
          ...
          if (arrayOfString1 != null)
          {
            ...
            {
              f1 = f2;
              if (awwe.a(arrayOfString1[0], arrayOfString2[0]))
              {
                f1 = f2;
                if (arrayOfString1.length > 1)
                {
                  f2 += f3;
                  f1 = f2;
                  if (awwe.b(arrayOfString1[1], arrayOfString2[1])) {
                    f1 = f2 + f3;
                  }
                }
              }
  ...
  {
    ((awpx)paramQQAppInterface.getManager(318)).a(paramString1, paramString2, paramString3, paramInt);
  }
  ...
  public static CharSequence c(String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt = 8;; paramInt = k + 1)
      {
        ...
        ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131166929)), 0, ((String)localObject1).length(), 17);
        while (paramInt >= 0)
        {
