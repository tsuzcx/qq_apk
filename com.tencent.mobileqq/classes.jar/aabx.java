...
public class aabx
{
  ...
  public aabx(AppInterface paramAppInterface)
  {
  ...
  private JSONObject a(String paramString)
  {
    ...
    //   1: astore_2
    //   2: aload_1
    //   3: invokestatic 73	noe:a	(Ljava/lang/String;)Ljava/lang/String;
    //   6: astore_3
    //   7: aload_3
    ...
    //   49: aload_0
    //   50: aload_1
    //   51: invokevirtual 102	aabx:c	(Ljava/lang/String;)V
    //   54: aconst_null
    //   55: areturn
    //   56: getstatic 107	nny:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   59: ifnull +42 -> 101
    //   62: getstatic 107	nny:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   65: aload_1
    //   66: invokevirtual 113	java/util/concurrent/ConcurrentHashMap:containsKey	(Ljava/lang/Object;)Z
    //   69: ifeq +32 -> 101
    //   72: getstatic 107	nny:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   75: aload_1
    ...
    //   138: astore_3
    //   139: aload 4
    //   141: invokestatic 137	npi:a	(Ljava/io/BufferedInputStream;)Ljava/lang/String;
    //   144: astore_2
    //   145: aload 4
    //   147: astore_3
    //   148: getstatic 107	nny:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   151: ifnull +15 -> 166
    //   154: aload 4
    //   156: astore_3
    //   157: getstatic 107	nny:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   160: aload_1
    //   161: aload_2
    ...
    //   290: aload_0
    //   291: aload_1
    //   292: invokevirtual 102	aabx:c	(Ljava/lang/String;)V
    //   295: getstatic 107	nny:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   298: ifnull -284 -> 14
    //   301: getstatic 107	nny:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   304: aload_1
  ...
  public static void c()
  {
    try
    {
      Object localObject = new File(BaseApplicationImpl.getApplication().getApplicationContext().getFilesDir(), bgcw.e.jdField_a_of_type_JavaLangString);
  ...
  public void a(OfflineWebRes paramOfflineWebRes)
  {
    ...
    do
    {
      do
      {
        ...
        {
          localObject1 = noe.a(paramOfflineWebRes.bid);
  ...
  public void b(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localObject1 = nny.d(paramString);
    ...
    for (;;)
    {
      for (;;)
      {
        try
        {
          ...
          localObject1 = npi.a(((MessageDigest)localObject3).digest());
        ...
        try
        {
          ...
          QLog.i("OfflineWebResManager", 2, "add or update url " + nny.d(paramString) + ", cost: " + (System.currentTimeMillis() - l));
          return;
        }
