  ...
  implements aacc
{
  ...
  public aabx()
  {
    ...
    this.jdField_a_of_type_JavaLangString = anzj.a(2131701181);
    this.jdField_b_of_type_JavaLangString = anzj.a(2131701255);
    this.jdField_c_of_type_JavaLangString = anzj.a(2131701254);
    this.jdField_d_of_type_JavaLangString = anzj.a(2131697275);
    this.jdField_e_of_type_JavaLangString = anzj.a(2131707738);
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (d())
    {
      ...
      if ((bhsr.a(this.jdField_f_of_type_JavaLangString)) && ((!paramBoolean2) || (this.jdField_a_of_type_AndroidViewView == null))) {
        break label180;
      }
      bool = true;
  ...
  protected RecyclerView.ViewHolder b(ViewGroup paramViewGroup, int paramInt)
  {
    if (this.jdField_a_of_type_ComTencentBizRichframeworkPartBlockBaseRefreshHeaderView == null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizRichframeworkPartBlockBaseRefreshHeaderView.setMinimumHeight(1);
      this.jdField_a_of_type_ComTencentBizRichframeworkPartBlockBaseRefreshHeaderView.setOnRefreshListener(this);
    }
    return new aaca(this.jdField_a_of_type_ComTencentBizRichframeworkPartBlockBaseRefreshHeaderView);
  }
  ...
  {
    if ((paramViewHolder instanceof aabz))
    {
      paramViewHolder = (aabz)paramViewHolder;
      if (!this.jdField_f_of_type_Boolean)
      {
        aabz.a(paramViewHolder).setVisibility(8);
    ...
    {
      bool = true;
      aabz.a(paramViewHolder).setIndeterminate(bool);
      localProgressBar = aabz.a(paramViewHolder);
      if (!bool) {
        break label153;
      }
    }
    ...
    for (paramInt = 0;; paramInt = 8)
    {
      ...
      if ((this.jdField_a_of_type_AndroidViewView == null) || (aabz.a(paramViewHolder) == null) || (!this.jdField_a_of_type_Boolean)) {
        break label159;
      }
      aabz.a(paramViewHolder).setVisibility(8);
      aabz.a(paramViewHolder).setVisibility(0);
    ...
    label159:
    aabz.a(paramViewHolder).setVisibility(0);
    aabz.a(paramViewHolder).setText(this.jdField_f_of_type_JavaLangString);
    if (this.jdField_a_of_type_AndroidViewView != null) {
      aabz.a(paramViewHolder).setVisibility(8);
    }
  ...
  {
    paramViewGroup = new aabz(LayoutInflater.from(paramViewGroup.getContext()).inflate(2131560747, paramViewGroup, false));
    if (this.jdField_a_of_type_AndroidViewView != null) {
      aabz.a(paramViewGroup).addView(this.jdField_a_of_type_AndroidViewView);
    }
  ...
  public void onAttachedToRecyclerView(RecyclerView paramRecyclerView)
  {
    ...
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.addOnScrollListener(new aaby(this));
  }
