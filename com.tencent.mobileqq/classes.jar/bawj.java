...
public class bawj
  extends bawg
{
  public bawj(VipFunCallPreviewActivity paramVipFunCallPreviewActivity) {}
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (TextUtils.isEmpty(paramObject)) {
        localObject3 = ajjy.a(2131650954);
      }
      paramObject = localObject3;
      if (!TextUtils.isEmpty((CharSequence)localObject2)) {
        break label607;
      }
      localObject1 = ajjy.a(2131650932);
      localObject2 = null;
      paramInt = 11;
      paramObject = localObject3;
    }
    for (;;)
    {
        ...
        if ((i == 22001) || (i == 6002))
        {
          ...
          if (!TextUtils.isEmpty(str))
          {
            ...
            if (TextUtils.isEmpty((CharSequence)localObject1)) {
              localObject3 = ajjy.a(2131650952);
            }
          }
          ...
          if (i == 9003)
          {
            ...
            if (TextUtils.isEmpty(paramObject)) {
              localObject1 = ajjy.a(2131650935);
            }
            paramObject = localObject1;
            if (!TextUtils.isEmpty((CharSequence)localObject2)) {
              break label607;
            }
            localObject3 = ajjy.a(2131650947);
            localObject2 = null;
            paramInt = 12;
            paramObject = localObject1;
          ...
          if ((i == 1005011) || (i == 5002))
          {
            ...
            localObject1 = paramObject;
            if (TextUtils.isEmpty(paramObject)) {
              localObject1 = ajjy.a(2131650941);
            }
            paramObject = localObject1;
            if (!TextUtils.isEmpty((CharSequence)localObject2)) {
              break label607;
            }
            localObject3 = ajjy.a(2131650945);
            localObject2 = null;
            paramInt = 2;
            paramObject = localObject1;
            localObject1 = localObject3;
          ...
          if ((i == 1005012) || (i == 4002))
          {
            ...
            localObject1 = paramObject;
            if (TextUtils.isEmpty(paramObject)) {
              localObject1 = ajjy.a(2131650950);
            }
            paramObject = localObject1;
            if (!TextUtils.isEmpty((CharSequence)localObject2)) {
              break label607;
            }
            localObject3 = ajjy.a(2131650942);
            localObject2 = null;
            paramInt = 1;
            paramObject = localObject1;
            localObject1 = localObject3;
          ...
          if (i == 461001)
          {
            localObject1 = ajjy.a(2131650957);
            if (!TextUtils.isEmpty((CharSequence)localObject2)) {
              break label601;
            }
          }
      ...
      label601:
      for (paramObject = ajjy.a(2131650951);; paramObject = localObject2)
      {
        localObject3 = ajjy.a(2131650940);
        str = bant.a("funCallMine");
        paramInt = 6;
        ...
        if (i == 3002)
        {
          paramObject = ajjy.a(2131650931);
          break label222;
        }
        if (i == 8002)
        {
          paramObject = ajjy.a(2131650958);
          break label222;
        }
        break label222;
      }
