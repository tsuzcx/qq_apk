...
public class brdl
{
  ...
  private brdn jdField_a_of_type_Brdn;
  private brdq jdField_a_of_type_Brdq;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alwf.jdField_d_of_type_JavaLangString + "pddata/prd/dov_capture_qsvf" + File.separator;
    jdField_b_of_type_JavaLangString = jdField_a_of_type_JavaLangString + "capture_res" + File.separator;
    e = alwf.jdField_d_of_type_JavaLangString + "qav" + File.separator + "beauty" + File.separator;
  ...
  private boolean a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Brdn != null) {
        this.jdField_a_of_type_Brdn.a();
      }
      return true;
      label334:
      i += 1;
  ...
  public void a()
  {
    this.jdField_a_of_type_Brdn = null;
  }
  ...
  public void a(brdn parambrdn)
  {
    this.jdField_a_of_type_Brdn = parambrdn;
  }
  
  public void a(brdq parambrdq)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Brdq = parambrdq;
      ...
      parambrdq = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
      while (parambrdq.hasNext())
      {
        Object localObject1 = (FilterCategory)parambrdq.next();
              ...
              if (localFilterDesc.predownload == 1)
              {
                ...
                if (!TextUtils.isEmpty(localFilterDesc.iconurl))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((beum)localObject3).jdField_a_of_type_Beuq = new brdp(this);
                ...
                if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject2)))
                {
                  ...
                  if (!((File)localObject3).exists())
                  {
                    ...
                    ((beum)localObject2).jdField_a_of_type_Beuq = new brdo(this);
    ...
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Brdq == null));
    this.jdField_a_of_type_Brdq.a(false);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Brdq = null;
  }
}
