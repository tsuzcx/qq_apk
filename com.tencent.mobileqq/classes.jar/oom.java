  ...
  extends oqg
{
  ...
  private ConcurrentHashMap<Integer, WeakReference<opn>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  public oom(AppInterface paramAppInterface, atmp paramatmp, ExecutorService paramExecutorService, pdc parampdc, Handler paramHandler)
  {
  ...
  private int a(int paramInt)
  {
    ...
    if (localObject2 != null)
    {
      ...
      if (((ConcurrentHashMap)localObject2).size() > 0)
      {
        ...
        Collections.sort((List)localObject1, new ooo(this));
    ...
    for (long l = localRspBody.uint64_uin.get();; l = -1L)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          nbe.a(new nmv().a(BaseApplication.getContext()).a(nbe.k).b(nbe.S).b(paramToServiceMsg).a());
          return;
        }
  ...
  public oidb_cmd0x68b.ReqAdvertisePara a(pdh parampdh, int paramInt1, int paramInt2, int paramInt3, int paramInt4, nab paramnab)
  {
    if (QLog.isColorLevel()) {
    ...
    Object localObject3 = yoy.a(BaseApplication.getContext(), (yoz)localObject1);
    oidb_cmd0x68b.ReqAdvertisePara localReqAdvertisePara;
    Object localObject2;
    long l;
    if (localObject3 != null)
    {
      localObject1 = ((ypa)localObject3).a;
      ...
      if ((localObject3 != null) && (((ypa)localObject3).a != null) && (((ypa)localObject3).a.muid != null) && (((ypa)localObject3).a.muid_type != null))
      {
        ((oidb_cmd0x68b.PhoneInfo)localObject2).bytes_muid.set(ByteStringMicro.copyFromUtf8(((ypa)localObject3).a.muid.get()));
        ((oidb_cmd0x68b.PhoneInfo)localObject2).uint32_muid_type.set(((ypa)localObject3).a.muid_type.get());
      }
      localObject3 = nox.b();
    ...
    ((oidb_cmd0x68b.PhoneInfo)localObject2).bytes_ads_context.set(ByteStringMicro.copyFromUtf8(nbe.a()));
    ...
    for (;;)
    {
      try
      {
        ...
        if ((paramnab != null) && (paramnab.a()))
        {
          ((JSONObject)localObject1).put("MaterialId", paramnab.jdField_a_of_type_Int);
          ((JSONObject)localObject1).put("RepeatedReqFlag", paramnab.b);
          ((JSONObject)localObject1).put("KdPos", paramnab.c);
          ((JSONObject)localObject1).put("adPosId", paramnab.jdField_a_of_type_Long);
        }
        if (!orx.b(parampdh)) {
          continue;
        }
        ...
        if ((npl.a().a()) && (paramInt2 == 1) && (npl.a().a().size() > 0))
        {
          ((JSONObject)localObject1).put("superMaskType", 2);
          ((JSONObject)localObject1).put("reqList", new JSONArray(npl.a().a()));
          npl.a().b(false);
        }
      ...
      catch (JSONException parampdh)
      {
        label986:
        parampdh.printStackTrace();
        continue;
      }
      parampdh = new oidb_cmd0x68b.AdReqInfo();
      parampdh.uint64_ad_channel_id.set(paramInt1);
      localReqAdvertisePara.msg_ad_req_info.set(parampdh);
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, nab paramnab)
  {
    ...
    localReqBody.req_advertise_para.set(a(null, paramInt1, paramInt2, paramInt3, paramInt4, paramnab));
    Object localObject = pde.a("OidbSvc.0x68b", 1675, 0, localReqBody.toByteArray());
    ((ToServiceMsg)localObject).getAttributes().put(jdField_d_of_type_JavaLangString, Long.valueOf(paramInt3));
    if ((paramnab != null) && (paramnab.b == 1))
    {
      ((ToServiceMsg)localObject).getAttributes().put(h, Integer.valueOf(paramnab.b));
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (bgmq.w())
        {
          paramnab = oqa.a(paramInt1);
          if (!TextUtils.isEmpty(paramnab)) {
            localReqBody.bytes_nearby_cookie.set(ByteStringMicro.copyFromUtf8(paramnab));
          }
          paramnab = pde.a("OidbSvc.0xcba", 3258, 0, localReqBody.toByteArray());
          paramnab.getAttributes().put("realTimeServiceKey", "default_feeds");
          paramnab.getAttributes().put(jdField_d_of_type_JavaLangString, Long.valueOf(paramInt3));
        }
      }
      if ((paramInt2 == 5) || (paramInt2 == 6))
      {
        paramnab.getAttributes().put(i, Integer.valueOf(paramInt1));
        paramnab.getAttributes().put(f, Integer.valueOf(0));
      }
      a(paramnab);
  ...
  public void a(int paramInt, opn paramopn)
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt), new WeakReference(paramopn));
  }
  ...
  public void a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, long paramLong, ArrayList<DislikeInfo> paramArrayList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        nbe.a(new nmv().a(paramContext).a(nbe.c).b(nbe.M).a(paramAdvertisementInfo).a((int)paramLong).a((String)localObject2).a());
        return;
      }
      if (obz.a(paramAdvertisementInfo)) {}
      for (i = nbe.Q;; i = nbe.L)
      {
        nbe.a(new nmv().a(paramContext).a(nbe.c).b(i).a(paramAdvertisementInfo).a((int)paramLong).a((String)localObject2).a());
        return;
      }
    }
  }
    ...
    try
    {
      ...
      else
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject2))
        {
          ...
          localObject2 = new NewIntent(paramAppInterface.getApplication(), ndt.class);
          ...
          ((NewIntent)localObject2).setObserver(new oop(this, paramAdvertisementInfo));
    ...
    for (;;)
    {
      ...
      if ((paramRspChannelArticle.rpt_advertise_list.has()) && (paramRspChannelArticle.rpt_advertise_list.get() != null))
      {
                ...
                if (((articlesummary.FeedsInfo)((articlesummary.ArticleSummary)localObject3).msg_feeds_info.get()).msg_pos_ad_info.has())
                {
                  ...
                  if (localObject2 != null)
                  {
                    ...
                    if (((articlesummary.PosAdInfo)localObject2).int32_ret.get() == 0)
                    {
                      ...
                      npj.a((AdvertisementInfo)localObject2);
                      pdb.a((articlesummary.ArticleSummary)localObject3, i, 0, (ArticleInfo)localObject2);
                      ...
                      if (obm.a()) {
                        obm.a().a((articlesummary.ArticleSummary)localObject3, (ArticleInfo)localObject2);
                      }
                      if (QLog.isColorLevel()) {
            ...
            for (;;)
            {
              ...
              try
              {
                for (;;)
                {
                  ...
                  k = m;
                  npl.a().a((AdvertisementInfo)localObject2);
                  k = m;
                  if (!a((AdvertisementInfo)localObject2))
                  {
                    if (npi.a((AdvertisementInfo)localObject2, null)) {
                    ...
                    try
                    {
                      ...
                      nbe.a(new nmv().a(BaseApplication.getContext()).a(nbe.k).b(nbe.S).a((AdvertisementInfo)localObject2).b((JSONObject)localObject3).a());
        ...
        if (paramRspChannelArticle.bytes_ads_context.has()) {
          nbe.a(paramRspChannelArticle.bytes_ads_context.get().toStringUtf8());
        }
      }
      for (;;)
      {
        ...
        if (paramRspChannelArticle == null)
        {
          ...
          paramBoolean = orx.a(paramToServiceMsg);
          if (QLog.isColorLevel()) {
          ...
          for (paramToServiceMsg = (ToServiceMsg)localObject1;; paramToServiceMsg = paramRspChannelArticle)
          {
            ...
            while (((Iterator)localObject1).hasNext())
            {
              ...
              ogy.a().a(i, (BaseArticleInfo)localObject2);
            }
            nbe.a("");
            break;
            nbe.a("");
  ...
  public ArrayList<AdvertisementInfo> b(int paramInt)
  {
    ...
    if ((localObject != null) && (((ConcurrentHashMap)localObject).size() > 0))
    {
      ...
      Collections.sort(localArrayList, new oon(this));
    }
    if (QLog.isColorLevel())
    {
