  ...
  extends bdnv
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (paramView == null)
    {
      ...
      bdsb localbdsb = new bdsb(null);
      paramBundle.setTag(2131374957, localbdsb);
      ...
      if (paramView == null)
      {
        ...
        localObject = localResources.getDrawable(2130847343);
        ...
        localbdsb.jdField_a_of_type_AndroidWidgetTextView = paramView;
        localbdsb.b = localTextView;
        localbdsb.jdField_a_of_type_AndroidWidgetImageView = localImageView;
        localbdsb.c = paramContext;
        localbdsb.jdField_a_of_type_AndroidWidgetLinearLayout = paramBundle;
        paramView = localbdsb;
    ...
    for (;;)
    {
      ...
      paramView = (bdsb)paramContext.getTag(2131374957);
      break label443;
      label517:
      ...
      try
      {
        ...
        paramBundle.setDecodeHandler(bgxc.a);
        ...
        paramView.c.setText(anvx.a(2131713994));
