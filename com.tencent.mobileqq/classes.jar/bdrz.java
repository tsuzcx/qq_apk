...
public abstract class bdrz
  implements bdpf, bdpj
{
  ...
  private static bdsb<bdpj> listeners = new bdsb();
  private static bdsb<WeakReference<bdpj>> weakListeners = new bdsb();
  ...
  protected void _onCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      bdcs.a(paramQQAppInterface, paramString2, false);
      return;
    }
  ...
  public void download(QQAppInterface paramQQAppInterface, int paramInt, bdpj parambdpj, boolean paramBoolean)
  {
    download(paramQQAppInterface, getScid(paramInt), parambdpj, paramBoolean);
  }
  ...
  public void download(QQAppInterface paramQQAppInterface, long paramLong, String paramString, bdpj parambdpj, boolean paramBoolean)
  {
    if (FlatBuffersParser.c())
    {
      ...
      if (parambdpj != null) {
        parambdpj.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10086, 0);
      }
    }
    do
    {
    ...
    } while (parambdpj == null);
    parambdpj.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10087, 0);
    return;
    ...
    for (;;)
    {
      if (parambdpj != null)
      {
        ...
        weakListeners.a((String)localObject, new WeakReference(parambdpj));
      }
      for (;;)
      {
        QLog.e("BaseUpdateCallback", 1, "download: " + paramLong + "_" + paramString + ", " + parambdpj);
        ...
        parambdpj.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10088, 0);
        return;
        listeners.a((String)localObject, parambdpj);
      }
    }
  }
  ...
  public void download(QQAppInterface paramQQAppInterface, String paramString, bdpj parambdpj, boolean paramBoolean)
  {
    download(paramQQAppInterface, getBID(), paramString, parambdpj, paramBoolean);
  }
  ...
  public final void onCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    for (localObject1 = listeners.b((String)localObject2);; localObject1 = listeners.a((String)localObject2))
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        ((bdpj)((Iterator)localObject1).next()).onCompleted(paramQQAppInterface, paramLong, paramString1, paramString2, paramString3, paramInt1, paramInt2);
      }
    ...
    for (localObject1 = weakListeners.b((String)localObject2);; localObject1 = weakListeners.a((String)localObject2))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (bdpj)((WeakReference)((Iterator)localObject1).next()).get();
        if (localObject2 != null) {
          ((bdpj)localObject2).onCompleted(paramQQAppInterface, paramLong, paramString1, paramString2, paramString3, paramInt1, paramInt2);
        }
      }
    }
  }
  ...
  public final void onProgress(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, long paramLong3)
  {
    ...
    for (boolean bool = false;; bool = ((VasQuickUpdateEngine.TagItemInfo)localObject1).bPreConfig)
    {
      ...
      while (((Iterator)localObject2).hasNext()) {
        ((bdpj)((Iterator)localObject2).next()).onProgress(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, paramLong3);
      }
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      localObject2 = (bdpj)((WeakReference)((Iterator)localObject1).next()).get();
      if (localObject2 != null) {
        ((bdpj)localObject2).onProgress(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, paramLong3);
      }
    }
  }
  
  public void removeListener(long paramLong, String paramString, bdpj parambdpj)
  {
    paramString = getKey(paramLong, paramString, "");
    listeners.a(paramString, parambdpj, false);
    weakListeners.a(paramString, parambdpj, true);
  }
}
