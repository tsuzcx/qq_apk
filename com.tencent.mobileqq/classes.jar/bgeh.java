...
public class bgeh
{
  ...
  private HashMap<Integer, bgej> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private HashMap<Integer, bgeg> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  private String c = "";
  
  public static bgeh a(String paramString)
  {
      ...
      if (paramString != null)
      {
        ...
        if (paramString.length() > 0)
        {
          ...
          for (;;)
          {
            ...
            localObject3 = str1;
            localObject1 = str2;
            localObject4 = new bgej(((JSONObject)localObject2).getInt("begin"), ((JSONObject)localObject2).getInt("end"), ((JSONObject)localObject2).getInt("rankid"), ((JSONObject)localObject2).getString("rankname"));
            localObject3 = str1;
            localObject1 = str2;
      ...
      if (paramString != null)
      {
        ...
        if (paramString.length() > 0)
        {
          ...
          for (;;)
          {
            ...
            localObject3 = str1;
            localObject1 = str2;
            localObject4 = new bgeg(((JSONObject)localObject2).getInt("titleId"), ((JSONObject)localObject2).getString("start"), ((JSONObject)localObject2).getString("end"));
            localObject3 = str1;
            localObject1 = str2;
    ...
    localObject1 = new bgeh();
    ((bgeh)localObject1).jdField_a_of_type_JavaUtilHashMap = localHashMap1;
    ((bgeh)localObject1).jdField_b_of_type_JavaUtilHashMap = localHashMap2;
    ((bgeh)localObject1).jdField_a_of_type_JavaUtilList = localArrayList;
    ((bgeh)localObject1).jdField_a_of_type_JavaUtilTreeMap = localTreeMap;
    ((bgeh)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject3);
    ((bgeh)localObject1).jdField_b_of_type_JavaLangString = ((String)localObject2);
    ((bgeh)localObject1).c = paramString;
    if (QLog.isColorLevel()) {
  ...
  public int a(int paramInt)
  {
    ...
    do
    {
      ...
      localObject = (bgej)this.jdField_a_of_type_JavaUtilHashMap.get(localObject);
    } while ((((bgej)localObject).jdField_a_of_type_Int > paramInt) || (paramInt > ((bgej)localObject).b));
    for (paramInt = ((bgej)localObject).c;; paramInt = 0) {
      return paramInt;
    }
  }
  ...
  public String a(int paramInt)
  {
    ...
    do
    {
      ...
      localObject2 = (bgej)this.jdField_a_of_type_JavaUtilHashMap.get(localObject2);
    } while ((localObject2 == null) || (((bgej)localObject2).jdField_a_of_type_Int > paramInt) || (((bgej)localObject2).b < paramInt));
    for (localObject1 = ((bgej)localObject2).jdField_a_of_type_JavaLangString;; localObject1 = "")
    {
      if (QLog.isColorLevel()) {
  ...
  public int[] a(int paramInt)
  {
    Object localObject = (bgeg)this.jdField_b_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt));
    if (localObject != null)
    {
      String str = ((bgeg)localObject).jdField_a_of_type_JavaLangString;
      localObject = ((bgeg)localObject).jdField_b_of_type_JavaLangString;
