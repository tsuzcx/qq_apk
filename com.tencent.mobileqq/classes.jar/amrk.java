...
public class amrk
  implements amiq, amkj, Handler.Callback, View.OnKeyListener
{
  public int a;
  public long a;
  private aded jdField_a_of_type_Aded;
  private amns jdField_a_of_type_Amns;
  private ampm jdField_a_of_type_Ampm;
  ...
  private amrg jdField_a_of_type_Amrg;
  private amro jdField_a_of_type_Amro;
  private amrx jdField_a_of_type_Amrx;
  private amry jdField_a_of_type_Amry;
  private amsc jdField_a_of_type_Amsc;
  private amsk jdField_a_of_type_Amsk;
  private amtd jdField_a_of_type_Amtd;
  private ancv jdField_a_of_type_Ancv;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new amrl(this);
  private andx jdField_a_of_type_Andx = new amrn(this);
  ...
  private amqb jdField_b_of_type_Amqb;
  ...
  public amrk(int paramInt)
  {
    ...
    if (localamrt != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel = localamrt.a();
    ...
    this.jdField_a_of_type_Amry = new amry(paramInt);
    this.jdField_e_of_type_Int = paramInt;
    amsd.a();
    this.jdField_a_of_type_Amsk = new amsk(paramInt);
    this.jdField_a_of_type_Ampm = new ampm(paramInt);
  }
  ...
  private void c(CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Amro = new amro();
      this.jdField_a_of_type_Amro.g = localJSONObject.optString("payParam");
      ...
      this.jdField_a_of_type_Amro.jdField_a_of_type_Int = localJSONObject.optInt("score", -1);
      this.jdField_a_of_type_Amro.jdField_c_of_type_JavaLangString = localJSONObject.optString("baseUrl");
      this.jdField_a_of_type_Amro.b = localJSONObject.optString("listId");
      this.jdField_a_of_type_Amro.jdField_c_of_type_Int = this.jdField_e_of_type_Int;
      if (ampj.a() != null) {
        this.jdField_a_of_type_Amro.jdField_a_of_type_Long = Long.parseLong(ampj.a().getCurrentAccountUin());
      }
      this.jdField_a_of_type_Amro.e = localJSONObject.optString("nickName", String.valueOf(this.jdField_a_of_type_Amro.jdField_a_of_type_Long));
      if (QLog.isColorLevel()) {
        QLog.d("cmgame_process.CmGameLauncher", 1, "[setRedPacketInfo] " + this.jdField_a_of_type_Amro.toString());
      }
      return;
    }
  ...
  private void n()
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      ampj.a(new Object[] { "[startGameEngine], game is not ready, so status:", Boolean.valueOf(this.k) });
    }
    for (;;)
    {
      return;
      Object localObject1;
      if ((this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams == null) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams.mGamePath)) || (!bgmg.a(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams.mGamePath)))
      {
        if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
      {
        ...
        this.i = true;
        this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "sc.init_global_var.local", ampj.b(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams));
        ...
        if (this.jdField_a_of_type_Ancv != null) {
          this.jdField_a_of_type_Ancv.a();
        }
      }
      try
      {
        if (b()) {
          ampj.a().callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "cs.xy_life_cycle_event_activity.local", "{}");
        }
        for (;;)
        {
          o();
          ...
          ampj.a(new Object[] { "[startGameEngine] cost:", Long.valueOf(l) });
          if (l <= 0L) {
            break;
          }
          ...
          bctj.a(((AppInterface)localObject2).getApp()).a(((AppInterface)localObject2).getCurrentAccountUin(), "cmgame_open_to_start_engine", true, l, 0L, (HashMap)localObject1, "", false);
          return;
          label516:
          localObject1 = String.valueOf(amnl.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.extendJson));
          break label241;
          ampj.a().callbackFromRequest(a(), 0, "cs.xy_life_cycle_event_activity.local", "{}");
        }
      }
  ...
  public aded a(long paramLong, Activity paramActivity)
  {
    if (this.jdField_a_of_type_Aded != null) {
      return this.jdField_a_of_type_Aded;
    }
    adei.a();
    this.jdField_a_of_type_Aded = adei.a(paramActivity, 5, String.valueOf(paramLong));
  ...
  public ampm a()
  {
    return this.jdField_a_of_type_Ampm;
  }
  
  public amqb a()
  {
    return this.jdField_a_of_type_Amqb;
  }
  ...
  public amry a()
  {
    return this.jdField_a_of_type_Amry;
  }
  
  public amsc a()
  {
    if ((this.jdField_a_of_type_Amsc == null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams != null)) {
      this.jdField_a_of_type_Amsc = new amsc(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView, this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams, (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    }
    return this.jdField_a_of_type_Amsc;
  }
  
  public amsk a()
  {
    return this.jdField_a_of_type_Amsk;
  }
  
  public amtd a()
  {
    return this.jdField_a_of_type_Amtd;
  }
  ...
  public angn a()
  {
    return this.jdField_a_of_type_Angn;
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null))
        {
          ...
          localObject = new amsf();
          ((amsf)localObject).jdField_e_of_type_Int = paramInt1;
          ((amsf)localObject).jdField_a_of_type_Long = System.currentTimeMillis();
          ((amsf)localObject).jdField_a_of_type_Int = this.jdField_e_of_type_Int;
          ((amsf)localObject).d = paramInt2;
          ((amsf)localObject).jdField_c_of_type_Int = paramInt3;
          ((amsf)localObject).jdField_a_of_type_JavaLangString = paramString;
          ((amsf)localObject).jdField_b_of_type_Int = this.jdField_b_of_type_Int;
          if (QLog.isColorLevel()) {
          ...
          amsd.a().a((amsf)localObject);
        }
        if ((this.jdField_a_of_type_Amrg == null) || (!this.jdField_a_of_type_Amrg.a())) {
          break label430;
        }
        paramInt3 = 1;
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localApolloFloatActivity.a != null)
        {
          ...
          paramString = "window.mqq && mqq.execEventCallback && mqq.execEventCallback(" + nmj.a("apolloGameWebMessage") + "," + String.valueOf(paramString) + "," + String.valueOf("") + ");";
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    if (this.jdField_a_of_type_Amns != null) {
      this.jdField_a_of_type_Amns.a(paramInt, paramString1, paramString2);
    }
  }
  ...
  public void a(amns paramamns)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel != null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addRenderRunner(paramamns);
    }
  }
  ...
  public void a(amtj paramamtj)
  {
    ...
    do
    {
      return;
      localamtp = a();
    } while (localamtp == null);
    localamtp.a(paramamtj);
  }
  ...
  public void a(Activity paramActivity)
  {
    ...
    if (this.jdField_a_of_type_Amsk != null) {
      this.jdField_a_of_type_Amsk.a(paramActivity);
    }
    this.jdField_a_of_type_Amrg = new amrg(a(), ampj.a());
    this.jdField_a_of_type_Amrg.a(null, this.jdField_e_of_type_Int);
  }
  ...
  public void a(Activity paramActivity, CmGameInitParams paramCmGameInitParams)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
      this.jdField_a_of_type_Bkgm.sendEmptyMessage(204);
  ...
  public void a(Activity paramActivity, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        if (!andw.a())
        {
          ...
          andw.a(this.jdField_a_of_type_Andx);
          andw.a("CmGameLauncher");
          return;
        }
        andw.b(this.jdField_a_of_type_Andx);
        a(paramActivity);
        a(paramActivity);
        this.jdField_a_of_type_Ancv = new ancv(this.jdField_e_of_type_Int);
        if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
          break label562;
        }
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {
      ...
      if (this.jdField_a_of_type_Amtd == null) {
        this.jdField_a_of_type_Amtd = new amtd((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_e_of_type_Int);
      }
    ...
    {
      QLog.e("cmgame_process.CmGameLauncher", 1, localThrowable, new Object[0]);
      bool2 = ampj.a(this.jdField_e_of_type_Int);
      if (!bool2) {}
    }
    label562:
    label755:
        ...
        try
        {
          if ((paramActivity instanceof ApolloGameActivity))
          {
            ...
            if (this.jdField_a_of_type_Amqt != null) {
              this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Amqt);
            }
            if (this.jdField_a_of_type_Amqf != null) {
              this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Amqf);
            }
            this.jdField_a_of_type_Amqt = new amqt(this.jdField_e_of_type_Int, paramActivity);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Amqt);
            this.jdField_a_of_type_Amqf = new amqf(this.jdField_e_of_type_Int);
            this.jdField_a_of_type_Amqr = new amqr(this);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Amqf);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Amqr);
  ...
  {
    if (this.jdField_a_of_type_Amrg != null) {
      this.jdField_a_of_type_Amrg.a(paramBitmap, this.jdField_e_of_type_Int);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        b(paramBundle);
        ampj.a(new Object[] { "[checkFinish], loading from main process and tool process is on, before cost:", Long.valueOf(l1) });
  ...
  public void b(int paramInt)
  {
    if (this.jdField_a_of_type_Amqb == null)
    {
      ...
      this.jdField_a_of_type_Amqb = new ampn(ampj.a(), this.jdField_e_of_type_Int);
    }
    for (;;)
    {
      if (this.jdField_b_of_type_Amqb == null) {
        this.jdField_b_of_type_Amqb = new ampq(this.jdField_a_of_type_Amqr);
      }
      return;
      label52:
      if (1 == paramInt) {
        this.jdField_a_of_type_Amqb = new ampy(this.jdField_e_of_type_Int);
      }
    }
  }
  ...
  public void b(Activity paramActivity, CmGameInitParams paramCmGameInitParams)
  {
    ...
    for (;;)
    {
      ...
      break label152;
      label230:
      str = String.valueOf(amnl.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.extendJson));
      break label164;
  ...
  public void b(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      this.jdField_a_of_type_Bkgm.removeMessages(203);
      Message localMessage = this.jdField_a_of_type_Bkgm.obtainMessage(203);
      localMessage.obj = paramString;
      this.jdField_a_of_type_Bkgm.sendMessageDelayed(localMessage, 1000L);
  ...
  {
    this.jdField_a_of_type_Bkgm.removeMessages(203);
    if (((!this.jdField_b_of_type_Boolean) || ((!TextUtils.isEmpty(paramString)) && (paramString.contains("inner")))) && (this.jdField_a_of_type_Amrg != null))
    {
      boolean bool = this.jdField_e_of_type_Boolean;
      this.jdField_a_of_type_Bkgm.post(new CmGameLauncher.9(this, paramString, bool));
    }
  ...
  {
    if (this.jdField_a_of_type_Amqf != null) {
      this.jdField_a_of_type_Amqf.b();
    }
    if (this.jdField_a_of_type_Amqb != null) {
      this.jdField_a_of_type_Amqb.a();
    }
    if (this.jdField_b_of_type_Amqb != null) {
      this.jdField_b_of_type_Amqb.a();
    }
    ApolloCmdChannel localApolloCmdChannel = ampj.a();
  ...
  public void f()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Amrx);
        if (this.jdField_a_of_type_Ancv != null) {
          this.jdField_a_of_type_Ancv.b();
        }
        if (this.jdField_a_of_type_Amrg != null) {
          this.jdField_a_of_type_Amrg.a();
        }
        if (this.jdField_a_of_type_Aded != null) {
          this.jdField_a_of_type_Aded.b();
        }
        if (this.jdField_a_of_type_Amtd != null) {
          this.jdField_a_of_type_Amtd.a();
        }
        if (this.jdField_a_of_type_Ampm != null) {
          this.jdField_a_of_type_Ampm.a();
        }
        if (QLog.isColorLevel()) {
          QLog.d("cmgame_process.CmGameLauncher", 2, "onDestroy");
        }
        return;
        this.jdField_a_of_type_Bkgm.obtainMessage(202).sendToTarget();
        if (!QLog.isColorLevel()) {
          continue;
        }
  ...
  public void g()
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        {
          if (this.jdField_a_of_type_Amns != null) {
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeRenderRunner(this.jdField_a_of_type_Amns);
          }
          if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
          ...
          if (this.jdField_a_of_type_Amqf != null) {
            this.jdField_a_of_type_Amqf.d();
          }
          if (this.jdField_a_of_type_Amqr != null)
          {
            this.jdField_a_of_type_Amqr.a();
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Amqr);
          }
        }
        return;
        label231:
  ...
  public void h()
  {
    ...
    {
      if (this.jdField_a_of_type_Amqf != null) {
        this.jdField_a_of_type_Amqf.a(false);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
      {
    ...
    amqz.a("cs.make_room_min.local", "{}", false, null, this.jdField_e_of_type_Int);
    if ((ampj.a() != null) && (this.jdField_a_of_type_JavaLangRefWeakReference != null)) {
      ampj.a(this.jdField_e_of_type_Int, (Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    }
    if (QLog.isColorLevel()) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      if ((this.jdField_a_of_type_Amrg == null) || (!this.jdField_a_of_type_Amrg.a(this.jdField_e_of_type_Int))) {
        break label271;
      }
      this.jdField_a_of_type_Amrg.a((String)paramMessage.obj, this.jdField_e_of_type_Int, this.jdField_e_of_type_Boolean);
    ...
    for (;;)
    {
      ...
      return false;
      label271:
      ancm.a(this.jdField_e_of_type_Int, (String)paramMessage.obj, a());
    }
  }
  ...
  public void i()
  {
    ...
    amqz.a("cs.close_room.local", "{}", false, null, this.jdField_e_of_type_Int);
  }
  ...
  public void j()
  {
    ...
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_query_check_game_data", localBundle, new amrm(this));
  }
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      {
        this.jdField_a_of_type_Bkgm.sendEmptyMessage(200);
        this.jdField_f_of_type_Boolean = false;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.mIsGameReady = true;
      }
      this.jdField_a_of_type_Amrx = new amrx(this.jdField_e_of_type_Int);
      AppNetConnInfo.registerConnectionChangeReceiver(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Amrx);
    }
  }
}
