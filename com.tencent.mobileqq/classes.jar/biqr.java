...
public class biqr
{
  ...
  public biqr(int paramInt1, int paramInt2, Typeface paramTypeface, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
  ...
  public static biqr a(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, Typeface paramTypeface, bipz parambipz)
  {
  ...
  public void a(CharSequence paramCharSequence, bipz parambipz)
  {
    a(paramCharSequence, parambipz, 0);
  }
  
  public void a(CharSequence paramCharSequence, bipz parambipz, int paramInt)
  {
    ...
    for (int j = (paramInt - this.e) / (paramCharSequence.length() - 1);; j = 0)
    {
      ...
      while (k < paramCharSequence.length())
      {
        ...
        else
        {
          ...
          if (this.f == 0)
          {
            localbiqk.b = parambipz.a("", this.c + a(), this.d, 0, 255, new LinearInterpolator());
            label282:
            localbiqk.jdField_a_of_type_AndroidGraphicsBitmap = ((Bitmap)localObject);
            if (k != 0) {
              break label374;
            }
            localbiqk.jdField_a_of_type_Int = paramInt;
          }
          for (paramInt = localbiqk.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() + paramInt;; paramInt = localbiqk.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() + j + paramInt)
          {
            this.jdField_a_of_type_JavaUtilArrayList.add(localbiqk);
            break;
            localbiqk.b = parambipz.a("", this.c + this.d * k / paramCharSequence.length(), this.d, 0, 255, new LinearInterpolator());
            break label282;
            label374:
            localbiqk.jdField_a_of_type_Int = (paramInt + j);
          }
        }
      }
      return;
