...
{
  public biqr(ParticipleView paramParticipleView) {}
  ...
  public void onAnimationUpdate(ValueAnimator paramValueAnimator)
  {
    ...
    {
      biqv localbiqv = (biqv)paramValueAnimator.next();
      float f = Math.min((float)(l - biqv.a(localbiqv)) / ParticipleView.a(this.a), 1.0F);
      biqv.a(localbiqv, f);
      if (f < 1.0F) {
        i = 0;
      }
