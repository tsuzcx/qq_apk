...
public abstract class asnu
  implements IExcitingTransferRecvListener
{
  protected final int a;
  protected long a;
  protected final asnv a;
  private asnx a;
  ...
  public asnu(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, asnv paramasnv)
  {
    ...
    this.d = paramLong1;
    this.jdField_a_of_type_Asnv = paramasnv;
    this.c = paramLong2;
  ...
  protected ExcitingTransferDownloadReqInfo a()
  {
    ...
    if (this.jdField_a_of_type_Asnv != null)
    {
      localExcitingTransferDownloadReqInfo.fileSize = this.jdField_a_of_type_Asnv.a();
      localExcitingTransferDownloadReqInfo.md5 = this.jdField_a_of_type_Asnv.a();
      localExcitingTransferDownloadReqInfo.isSupportHttps = this.jdField_a_of_type_Asnv.b();
      localExcitingTransferDownloadReqInfo.sslCName = this.jdField_a_of_type_Asnv.d();
      localExcitingTransferDownloadReqInfo.strFileName = this.jdField_a_of_type_Asnv.a();
      if (this.jdField_a_of_type_Asnv.a() != null) {
        localExcitingTransferDownloadReqInfo.mHosts = ((ExcitingTransferHostInfo[])this.jdField_a_of_type_Asnv.a().toArray(new ExcitingTransferHostInfo[this.jdField_a_of_type_Asnv.a().size()]));
      }
      localExcitingTransferDownloadReqInfo.strFileName = this.jdField_a_of_type_Asnv.a();
      localExcitingTransferDownloadReqInfo.serverPath = this.jdField_a_of_type_Asnv.b();
    }
    for (;;)
    {
  ...
  public void a(int paramInt, ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (this.jdField_a_of_type_Asnx != null) {
      this.jdField_a_of_type_Asnx.a(paramInt, paramExcitingTransferDownloadCompletedInfo);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Asnx != null) {
      this.jdField_a_of_type_Asnx.a(paramLong1, paramLong2, paramLong3);
    }
  }
  
  public void a(asnx paramasnx)
  {
    this.jdField_a_of_type_Asnx = paramasnx;
  }
  ...
  public void a(ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (this.jdField_a_of_type_Asnx != null) {
      this.jdField_a_of_type_Asnx.a(0, paramExcitingTransferDownloadCompletedInfo);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Asnv != null) {
      return "Cookie:t=0;v=" + AppSetting.a() + ";" + this.jdField_a_of_type_Asnv.c() + ";\r\n";
    }
    return "";
  }
  ...
  public void onOneSlotComplete(int paramInt, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    for (String str = paramExcitingTransferOneSlotComplete.m_strIp;; str = "")
    {
      ...
      this.jdField_a_of_type_Asnx.a(paramInt, paramExcitingTransferOneSlotComplete);
      return;
      str = "";
      break label52;
    }
  ...
  public void onRecvComplete(int paramInt, ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (paramInt == 0)
    {
      ...
      label69:
      QLog.i("ExcitingTransfer.BaseDownloader<FileAssistant>", 1, str);
      if ((bool) && (this.jdField_a_of_type_Asnv != null)) {
        this.jdField_b_of_type_Long = this.jdField_a_of_type_Asnv.a();
      }
  ...
  public void onRecvStart()
  {
    ...
    } while (this.jdField_a_of_type_Asnx == null);
    this.jdField_a_of_type_Asnx.a();
  }
