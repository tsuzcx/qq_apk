...
public class sup
{
  ...
  private static volatile sup jdField_a_of_type_Sup;
  ...
  public sup()
  {
    this.jdField_a_of_type_Suq = null;
  }
  
  public static sup a()
  {
    if (jdField_a_of_type_Sup == null) {}
    try
    {
      if (jdField_a_of_type_Sup == null) {
        jdField_a_of_type_Sup = new sup();
      }
      return jdField_a_of_type_Sup;
    }
    finally {}
  }
  ...
  {
    return jdField_a_of_type_Sup != null;
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localJSONObject.put("articles_request_type", pon.a());
      if (!pon.b()) {
        break label339;
      }
      i = 1;
    ...
    if (this.jdField_b_of_type_Boolean) {
      ocd.a(null, "", "0X8009296", "0X8009296", 0, 0, String.valueOf((NetConnInfoCenter.getServerTimeMillis() - this.jdField_b_of_type_Long) / 1000.0D), "", "", localJSONObject.toString(), false);
    }
    for (;;)
    {
      pon.a(false);
      ...
      str = "0";
      break;
      ocd.a(null, "", "0X80089D1", "0X80089D1", 0, 0, String.valueOf((NetConnInfoCenter.getServerTimeMillis() - this.jdField_b_of_type_Long) / 1000.0D), "", "", localJSONObject.toString(), false);
    }
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Suq == null) {
      this.jdField_a_of_type_Suq = new suq(this, null);
    }
