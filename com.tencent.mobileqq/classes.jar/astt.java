...
class astt
  implements auoo
{
  astt(asts paramasts, QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean) {}
  ...
  public void b(auop paramauop)
  {
    try
    {
      if (paramauop.jdField_a_of_type_Int == 0)
      {
        ...
        MessageForLongTextMsg localMessageForLongTextMsg = (MessageForLongTextMsg)axaq.a(-1051);
        ...
        if (mye.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord)) {
          mye.a().a(localMessageForLongTextMsg);
        }
      ...
      if (QLog.isColorLevel()) {
        QLog.d("StructLongTextMsg", 2, "MessageForReplyText upload multi msg pack failed, result.errStr=" + paramauop.b + ",result.errStr=" + paramauop.jdField_a_of_type_JavaLangString);
      }
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("StructLongTextMsg", 2, "MessageForReplyText upload multi msg pack failed, catch exception", paramauop);
      }
      asts.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
    }
  }
