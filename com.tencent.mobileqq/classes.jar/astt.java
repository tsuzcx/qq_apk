...
public class astt
{
  private static astt jdField_a_of_type_Astt;
  private ConcurrentHashMap<String, nlo> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  
  public static astt a()
  {
    try
    {
      if (jdField_a_of_type_Astt == null) {
        jdField_a_of_type_Astt = new astt();
      }
      astt localastt = jdField_a_of_type_Astt;
      return localastt;
    }
    finally {}
  }
  ...
  private void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, int paramInt, nlo paramnlo)
  {
    ...
    localIntent.putExtra("is_first_open_imax_ad", ajgm.c);
    ajgm.c = false;
  ...
  public void a(QQAppInterface paramQQAppInterface, ajee paramajee, AbsListView paramAbsListView)
  {
    int i;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (j < k + 1)
        {
          localObject1 = paramajee.getItem(j);
          ...
          if (!astv.a(paramAbsListView.getChildAt(j - i))) {
            break label360;
          }
          ...
          localObject1 = nlo.a(astv.b(paramQQAppInterface.c(), (String)localObject3));
        ...
        ((HashMap)localObject3).put("key_adapter", new WeakReference(paramajee));
  ...
  public void a(QQAppInterface paramQQAppInterface, RecentUser paramRecentUser)
  {
    ...
    for (Object localObject = null;; localObject = ((ProxyManager)localObject).a())
    {
      if (localObject != null)
      {
        ...
        ((amjk)localObject).b(paramRecentUser);
        ajgm.b(paramQQAppInterface, localnlo.jdField_a_of_type_JavaLangString, 10005);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (localnlo == null)
        {
          ...
          localnlo = nlo.a(astv.b(paramQQAppInterface.c(), paramString));
          bool1 = bool2;
          if (localnlo != null)
          {
            a(localnlo);
