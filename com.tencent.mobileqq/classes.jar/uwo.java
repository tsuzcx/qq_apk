...
public class uwo
{
  ...
  public uwo(WSTabLayout paramWSTabLayout, @NonNull View paramView)
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131381502));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131381493));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new uwp(this, paramWSTabLayout));
  }
