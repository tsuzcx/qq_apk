...
public class azej
{
  static final String jdField_a_of_type_JavaLangString = apgj.jdField_a_of_type_JavaLangString + "_Res";
  long jdField_a_of_type_Long = 0L;
  private apfz jdField_a_of_type_Apfz;
  private apgi jdField_a_of_type_Apgi;
  private azeo jdField_a_of_type_Azeo;
  ...
  public azej(ScanTorchActivity paramScanTorchActivity)
  {
    this.jdField_a_of_type_ComTencentMobileqqOlympicActivityScanTorchActivity = paramScanTorchActivity;
  }
  
  private void a(AppInterface paramAppInterface, apfz paramapfz)
  {
    if ((paramapfz != null) && ((!paramapfz.jdField_a_of_type_Boolean) || (paramapfz.a() != null)))
    {
      this.jdField_a_of_type_Apfz = paramapfz;
      d(paramAppInterface);
      apgj.a(paramAppInterface).a(paramAppInterface, paramapfz.jdField_a_of_type_JavaLangString);
      a(paramAppInterface, this.jdField_a_of_type_Azeo.c());
      return;
    }
  ...
  private void a(String paramString, AppInterface paramAppInterface)
  {
    ...
    do
    {
      ...
      bool2 = this.jdField_a_of_type_Azeo.b();
      if (this.jdField_a_of_type_ArrayOfInt[0] == 100) {
        bool1 = true;
      }
    ...
    this.jdField_a_of_type_Azeo.a(paramAppInterface);
  }
  ...
  private void a(String paramString, AppInterface paramAppInterface, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Azeo.a(paramAppInterface, false);
    return;
    a("checkAllRes", true);
    if (a())
    {
    ...
    if (!this.jdField_a_of_type_Azeo.a())
    {
    ...
    a();
    this.jdField_a_of_type_Azeo.a(paramAppInterface, true);
  }
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Azeo.a("PromotionRes_" + paramString, 0);
  }
  ...
  public apfz a()
  {
    return this.jdField_a_of_type_Apfz;
  }
  ...
  void a()
  {
    ...
    {
      return;
      localButton = (Button)this.jdField_a_of_type_ComTencentMobileqqOlympicActivityScanTorchActivity.findViewById(2131365307);
      localButton.setVisibility(0);
    } while (localButton.getTag() != null);
    localButton.setTag(new Object());
    localButton.setOnClickListener(new azen(this));
  }
  
  public void a(azeo paramazeo)
  {
    this.jdField_a_of_type_Azeo = paramazeo;
  }
  ...
  {
    if (this.jdField_a_of_type_Azeo.c())
    {
    ...
    apgj.a(paramAppInterface).a(paramAppInterface, new azek(this, paramString, paramAppInterface));
  }
  ...
  public boolean a(AppInterface paramAppInterface)
  {
    ...
    localObject1 = ((apfz)localObject1).a();
    ...
    {
      localObject2 = (apga)((Map.Entry)((Iterator)localObject1).next()).getValue();
      if (apgg.a(paramAppInterface.getCurrentAccountUin(), (apga)localObject2)) {
  ...
  public void b(AppInterface paramAppInterface)
  {
    ...
    {
      apgj.a(paramAppInterface).b(this.jdField_a_of_type_Apgi);
      this.jdField_a_of_type_Apgi = null;
    }
    if (this.jdField_a_of_type_Bczz != null) {
      bczy.a().a(false, this.jdField_a_of_type_Bczz);
    }
    this.jdField_a_of_type_Apfz = null;
  }
  ...
  public void c(AppInterface paramAppInterface)
  {
    ...
    QLog.w(jdField_a_of_type_JavaLangString, 1, "reTry, promotionItem[" + localapfz + "], isDownloading[" + bool2 + "], isDownloadError[" + bool1 + "], needShowDownloadProgress[" + this.jdField_a_of_type_Boolean + "], TotalProgress[" + a() + "]");
    this.jdField_a_of_type_Boolean = true;
    if (localapfz == null) {}
    while (bool2) {
      return;
    }
    apgj.a(paramAppInterface).a(paramAppInterface, localapfz.jdField_a_of_type_JavaLangString);
    a(paramAppInterface, this.jdField_a_of_type_Azeo.c());
  }
  ...
  void d(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Bczz = new azel(this, paramAppInterface);
    bczy.a().a(true, this.jdField_a_of_type_Bczz);
    this.jdField_a_of_type_Apgi = new azem(this, paramAppInterface);
    apgj.a(paramAppInterface).a(this.jdField_a_of_type_Apgi);
  }
