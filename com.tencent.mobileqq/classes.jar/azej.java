...
public class azej
  extends anii
{
  public azej(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(Activity paramActivity, String paramString, QQAppInterface paramQQAppInterface, PersonalityLabel paramPersonalityLabel, azfe paramazfe)
  {
    byte[] arrayOfByte = PersonalityLabel.convertToBytes(paramPersonalityLabel);
    paramActivity.runOnUiThread(new PersonalityLabelHandler.1(paramString, paramQQAppInterface, paramazfe, arrayOfByte));
    paramActivity = (anmw)paramQQAppInterface.getManager(51);
  ...
  {
    afwx localafwx = (afwx)this.mApp.getManager(282);
    Object localObject = localafwx.a(paramString2, 0, 3);
    if (localObject != null) {
        ...
        do
        {
          for (;;)
          {
            ...
            else
            {
              ...
              paramFromServiceMsg = localanmw.a(paramObject);
            ...
            try
            {
              ...
              for (paramToServiceMsg = ((PersonalityLabelPhoto)paramToServiceMsg.personalityLabelPhotos.get(0)).get128SizeUrl() + azdi.d;; paramToServiceMsg = "")
              {
