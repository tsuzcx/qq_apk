...
public class bhhq
{
  ...
  public static <T> T b(JSONObject paramJSONObject, Class<T> paramClass)
  {
    ...
    try
    {
      ...
      if ((localField.isAnnotationPresent(bhht.class)) || (Modifier.isStatic(localField.getModifiers()))) {
        break label346;
      }
      if (localField.isAnnotationPresent(bhhr.class)) {
        paramClass = ((bhhr)localField.getAnnotation(bhhr.class)).a();
      }
    ...
    if (List.class.isAssignableFrom(localClass2))
    {
      ...
      if (!localField.isAnnotationPresent(bhhs.class)) {
        return null;
      }
      localClass1 = ((bhhs)localField.getAnnotation(bhhs.class)).a();
