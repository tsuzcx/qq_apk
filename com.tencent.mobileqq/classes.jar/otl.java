...
public class otl
{
  ...
  static void a(AbsListView paramAbsListView)
  {
    ...
    localotn.jdField_a_of_type_Int = b();
    localotn.jdField_b_of_type_Int = Math.abs(jdField_b_of_type_Int - jdField_a_of_type_Int);
    localotn.jdField_a_of_type_Long = (jdField_b_of_type_Long - jdField_a_of_type_Long);
    localotn.c = (j - i);
    localotn.jdField_b_of_type_Long = jdField_b_of_type_Long;
    localotn.d = j;
    otm.a(localotn);
  }
  ...
  public static void a(AbsListView paramAbsListView, int paramInt)
  {
    ...
    do
    {
      ...
      } while ((otm.jdField_a_of_type_Long < 0L) || (otm.jdField_b_of_type_Long < 0L));
      switch (paramInt)
      {
      default: 
        return;
