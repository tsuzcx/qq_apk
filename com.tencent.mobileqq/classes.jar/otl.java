  ...
  implements bfos
{
  ...
  private HashMap<Long, osy> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private otg jdField_a_of_type_Otg;
  public boolean a;
  private int jdField_b_of_type_Int;
  public long b;
  public ArrayList<Long> b;
  private HashMap<Long, Float> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  private otg jdField_b_of_type_Otg;
  private int jdField_c_of_type_Int;
  public long c;
  private ArrayList<otk> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  private int d;
  public long d;
  private int e;
  public long e;
  ...
  private otg a(AbsListView paramAbsListView)
  {
    ...
    paramAbsListView = new otg(this.jdField_a_of_type_Osx, null);
    ...
    if (this.jdField_a_of_type_Otg == null) {}
    for (long l = System.currentTimeMillis() - this.jdField_d_of_type_Long;; l = System.currentTimeMillis() - this.jdField_a_of_type_Otg.jdField_a_of_type_Long)
    {
      paramAbsListView.jdField_b_of_type_Long = l;
      this.jdField_a_of_type_Otg = paramAbsListView;
      QLog.d("ReadinjoySPEventReport", 2, new Object[] { paramAbsListView });
      return paramAbsListView;
    }
  }
  
  private otk a(AbsListView paramAbsListView)
  {
    otk localotk = new otk();
    localotk.jdField_e_of_type_Int = this.jdField_b_of_type_Int;
    localotk.f = this.jdField_c_of_type_Int;
    if (this.jdField_d_of_type_Int - this.f > 0) {}
    for (int i = this.jdField_d_of_type_Int - this.f;; i = 0)
    {
      localotk.g = i;
      localotk.jdField_a_of_type_Int = this.jdField_e_of_type_Int;
      localotk.jdField_a_of_type_Long = (this.jdField_c_of_type_Long - this.jdField_b_of_type_Long);
      localotk.h = this.f;
      localotk.i = paramAbsListView.getWidth();
      localotk.jdField_a_of_type_ArrayOfFloat = ((float[])((ReadInJoyXListView)paramAbsListView).jdField_a_of_type_ArrayOfFloat.clone());
      localotk.b = ((float[])((ReadInJoyXListView)paramAbsListView).b.clone());
      return localotk;
    }
  }
  ...
  public String a()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localStringBuilder.append((osy)((Iterator)localObject).next()).append("|");
    }
  ...
  public void a(int paramInt, AbsListView paramAbsListView)
  {
    ...
    //   44: ifle +14 -> 58
    //   47: aload_0
    //   48: getfield 138	otl:jdField_d_of_type_Long	J
    //   51: lstore_3
    //   52: lload_3
    //   53: lconst_0
    //   54: lcmp
    ...
    //   60: return
    //   61: aload_0
    //   62: getfield 46	otl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   65: invokevirtual 265	java/util/ArrayList:size	()I
    //   68: ifle +12 -> 80
    //   71: aload_0
    //   72: getfield 266	otl:jdField_a_of_type_Int	I
    //   75: iload_1
    //   76: iand
    //   77: ifne -19 -> 58
    //   80: iload_1
    ...
    //   83: ifeq +15 -> 98
    //   86: aload_0
    //   87: getfield 268	otl:jdField_a_of_type_Boolean	Z
    //   90: ifeq -32 -> 58
    //   93: aload_0
    //   94: iconst_0
    //   95: putfield 268	otl:jdField_a_of_type_Boolean	Z
    //   98: aload_0
    //   99: aload_0
    //   100: getfield 266	otl:jdField_a_of_type_Int	I
    //   103: iload_1
    //   104: ior
    //   105: putfield 266	otl:jdField_a_of_type_Int	I
    //   108: aload_0
    //   109: aload_2
    //   110: invokespecial 270	otl:a	(Lcom/tencent/widget/AbsListView;)Lotg;
    //   113: astore_2
    //   114: aload_2
    //   115: ifnull -57 -> 58
    //   118: aload_0
    //   119: aload_2
    //   120: invokevirtual 273	otl:a	(Lotg;)V
    //   123: aload_0
    //   124: aload_2
    //   125: invokevirtual 276	otg:a	()Ljava/util/ArrayList;
    //   128: putfield 46	otl:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   131: ldc 142
    //   133: iconst_2
    //   134: iconst_1
  ...
  public void a(otg paramotg)
  {
    if ((paramotg == null) || (this.jdField_d_of_type_Long == 0L)) {
      return;
    }
    Iterator localIterator = paramotg.jdField_a_of_type_JavaUtilArrayList.iterator();
    label23:
    Object localObject;
    long l1;
    float f1;
    ...
    if (localIterator.hasNext())
    {
      ...
      l1 = paramotg.jdField_b_of_type_Long;
      f1 = ((Float)((Pair)localObject).second).floatValue();
      osy localosy = (osy)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(localBaseArticleInfo.mArticleID));
      localObject = localosy;
      if (localosy == null)
      {
        localObject = new osy(this.jdField_a_of_type_Osx, null);
        ((osy)localObject).jdField_a_of_type_Long = localBaseArticleInfo.mRecommendSeq;
        ((osy)localObject).jdField_b_of_type_Long = localBaseArticleInfo.mArticleID;
        ((osy)localObject).jdField_a_of_type_JavaLangString = localBaseArticleInfo.mTitle;
        this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(localBaseArticleInfo.mArticleID), localObject);
      }
      l2 = ((osy)localObject).jdField_c_of_type_Long;
      if (f1 <= 0.8F) {
        break label204;
      }
    }
    for (;;)
    {
      ((osy)localObject).jdField_c_of_type_Long = (l1 + l2);
      ((osy)localObject).jdField_a_of_type_Float = Math.max(((osy)localObject).jdField_a_of_type_Float, f1);
      break label23;
      break;
      label204:
      l1 = 0L;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Otg != null)
    {
      localArrayList1 = this.jdField_a_of_type_Otg.a();
      if (this.jdField_b_of_type_Otg == null) {
        break label267;
      }
      localArrayList2 = this.jdField_b_of_type_Otg.a();
      ...
      do
      {
        ...
        localosy = (osy)this.jdField_a_of_type_JavaUtilHashMap.get(localLong);
      } while (localosy == null);
      localosy.jdField_a_of_type_Int = 1;
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(localLong)) {
        break label273;
      }
    }
    for (localosy.jdField_a_of_type_Int = 0;; localosy.jdField_a_of_type_Int = 2) {
      label267:
      label273:
      do
      {
        if (this.jdField_b_of_type_JavaUtilArrayList.contains(localLong)) {
          localosy.jdField_a_of_type_Boolean = true;
        }
        if ((localArrayList2 != null) && (localArrayList2.contains(localLong))) {
          localosy.jdField_b_of_type_Boolean = true;
        }
        if (this.jdField_b_of_type_JavaUtilHashMap.containsKey(localLong)) {
          localosy.jdField_b_of_type_JavaLangString = String.format("%.2f", new Object[] { this.jdField_b_of_type_JavaUtilHashMap.get(localLong) });
        }
        localStringBuilder.append(localosy.toString()).append("\n");
        break label96;
    ...
    this.jdField_a_of_type_Osx.b = this;
    this.jdField_a_of_type_Osx.a = new otl(this.jdField_a_of_type_Osx);
  }
  ...
  public String b()
  {
    ...
    {
      localStringBuilder.append(((otk)this.jdField_c_of_type_JavaUtilArrayList.get(i)).a()).append("|");
      i += 1;
    }
    if (localStringBuilder.length() == 0) {
      return "nil";
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    case 0: 
      ...
      localotk = a(paramAbsListView);
      this.jdField_c_of_type_JavaUtilArrayList.add(localotk);
      this.jdField_a_of_type_Otg = a(paramAbsListView);
    ...
    case 1: 
      while ((paramInt <= i) && (paramInt < paramAbsListView.getCount()))
      {
        ...
        this.jdField_a_of_type_Otg = a(paramAbsListView);
        this.jdField_b_of_type_Otg = this.jdField_a_of_type_Otg;
        a(this.jdField_a_of_type_Otg);
        return;
      }
      QLog.d("ReadinjoySPEventReport", 2, "one scroll " + localotk.a());
      return;
    }
    this.jdField_a_of_type_Otg = a(paramAbsListView);
    a(this.jdField_a_of_type_Otg);
