...
public class mie
  extends lhe
{
  public mie(MultiVideoCtrlLayerUIBase paramMultiVideoCtrlLayerUIBase) {}
  ...
  protected void a(long paramLong1, int paramInt1, long paramLong2, long paramLong3, long paramLong4, int paramInt2)
  {
    ...
    {
      this.a.jdField_b_of_type_Meu.update(null, new Object[] { Integer.valueOf(105), Boolean.valueOf(bool), Long.valueOf(paramLong1) });
      this.a.C(paramLong1);
      ...
      for (;;)
      {
        ...
        if (paramLong3 == 2L)
        {
          mdd.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1029);
        }
        else if (paramLong3 == 4L)
        {
          if ((paramLong2 == this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getLongAccountUin()) && (!this.a.jdField_a_of_type_ComTencentAvVideoController.a().j))
          {
            ...
            mdd.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1031);
          }
          for (;;)
          {
  ...
  protected void a(long paramLong1, long paramLong2, long paramLong3, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.a.jdField_b_of_type_Meu.update(null, new Object[] { Integer.valueOf(104), localArrayList });
      if (paramInt == 2)
      {
        this.a.i(1036);
  ...
  protected void a(long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (((!this.a.jdField_a_of_type_ComTencentAvVideoController.v) && ((paramLong != this.a.c) || (!paramBoolean1)) && (paramBoolean1)) || (paramLong == 0L)) {
      this.a.e();
    }
    if ((this.a.jdField_a_of_type_ComTencentAvVideoController.v) || (paramLong == this.a.c) || (paramLong == 0L)) {}
    ...
    for (int i = 1;; i = 0)
    {
      ((lid)localObject).d("setRoomMicOff", i);
      return;
  ...
  protected void a(ArrayList<Long> paramArrayList, int paramInt)
  {
    if (paramInt == 0)
    {
      mdd.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034);
      mdd.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035);
    ...
    else
    {
      ...
      mtw.b((StringBuilder)localObject, paramArrayList, this.a.jdField_d_of_type_AndroidWidgetTextView.getPaint(), f);
      if (paramInt != 1) {
        break label419;
      }
    ...
    for (;;)
    {
      ...
      mdd.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034, paramArrayList);
      return;
