...
public class arjc
{
  ...
  public arhz a;
  private arja jdField_a_of_type_Arja;
  ActionCallback jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceActionCallback = new arje(this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public arjc(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Arhz = arjh.a().a();
  ...
  private void c(Bundle paramBundle)
  {
    ...
    {
      localObject2 = ayog.a(str2);
      localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = ayog.a(str2 + "?busiType=3");
      }
      localObject2 = str1;
    ...
    paramBundle.putString("hostVersion", String.valueOf(anet.a(BaseApplicationImpl.getContext())));
  ...
  {
    this.jdField_a_of_type_Arja = paramarja;
    paramarja = paramBundle.getString("mqqUrl", "");
    long l = System.currentTimeMillis();
    if ((l - this.jdField_a_of_type_Long < 1000L) && (!aric.c(paramBundle).equals("1")))
    {
      QLog.i("DynamicNow | NowEntry", 1, "开始处理mqq　scheme,time = " + System.currentTimeMillis() + " 点太快了");
      bcpw.a(BaseApplicationImpl.getContext(), ajyc.a(2131707664), 0).a();
      return;
    }
    this.jdField_a_of_type_Long = l;
    QLog.i("DynamicNow | NowEntry", 1, "开始进入now结合版,time = " + System.currentTimeMillis() + " mqqScheme = " + paramarja);
  ...
  {
    Object localObject1 = aric.a(paramBundle);
    Object localObject2 = aric.b(paramBundle);
    long l = aric.a(paramBundle);
    this.jdField_a_of_type_Arhz.a(false, (String)localObject2, String.valueOf(l), (String)localObject1, false, false, true);
    ...
    if ((a((String)localObject1)) || (ayog.a((String)localObject1) != null) || (ayog.a((String)localObject2) != null))
    {
      c(paramBundle);
      return;
    }
    ...
    ((URLDrawable)localObject1).setURLDrawableListener(new arjd(this, l, (AtomicBoolean)localObject2, paramBundle));
