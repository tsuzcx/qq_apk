  ...
  extends acew
{
  ...
  protected void a(List<MessageRecord> paramList, msg_comm.Msg paramMsg, im_msg_body.Elem paramElem)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        j = n;
        QLog.d("GeneralFlagsElemDecoder", 2, "vip_font_id = " + l + " fontId = " + gb.a(l) + " type = " + gb.b(l));
      }
      ...
      if (localResvAttr.uint32_holiday_flag.has())
      {
        ...
        if (k == 1)
        {
          ...
          {
            j = i;
            ((MessageRecord)paramList.get(0)).saveExtInfoToExtStr(bbkv.c, String.valueOf(k));
          }
        }
        j = i;
        if (QLog.isColorLevel())
      ...
      if (localResvAttr.uint32_service_msg_type.has())
      {
        ...
        {
          j = i;
          ((MessageRecord)paramList.get(0)).saveExtInfoToExtStr(bbkv.z, String.valueOf(k));
        }
        j = i;
      ...
      if (localResvAttr.uint32_service_msg_remind_type.has())
      {
        ...
        {
          j = i;
          ((MessageRecord)paramList.get(0)).saveExtInfoToExtStr(bbkv.A, String.valueOf(k));
        }
        j = i;
      ...
      if (localResvAttr.bytes_service_msg_name.has())
      {
        ...
        {
          j = i;
          ((MessageRecord)paramList.get(0)).saveExtInfoToExtStr(bbkv.B, (String)localObject);
        }
        j = i;
      ...
      if (k == 0)
      {
        ...
        if (l >= 0L)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("GeneralFlagsElemDecoder", 2, "old vip_font_id = " + l + " fontId = " + gb.a(l) + " type = " + gb.b(l));
          }
        }
      }
      return;
  ...
  public boolean a(List<im_msg_body.Elem> paramList, msg_comm.Msg paramMsg, List<MessageRecord> paramList1, StringBuilder paramStringBuilder, boolean paramBoolean1, boolean paramBoolean2, bdyi parambdyi, bblm parambblm, bbkm parambbkm)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      a(paramList1, paramStringBuilder, parambdyi);
      a(paramList1, paramMsg, parambdyi);
    }
    return false;
  }
