  ...
  implements acwf
{
  ...
  String V;
  public String W;
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new axyx(this);
  public ViewGroup a;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  URLDrawableDownListener.Adapter jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new axyy(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    Object localObject;
    if ((paramView != null) && ((paramView.getTag() instanceof axza)))
    {
      localObject = (axza)paramView.getTag();
      ((axza)localObject).c.clearAnimation();
      ((TextView)((axza)localObject).d).setText(String.valueOf(this.l) + "''");
    }
    for (;;)
    {
      int i;
      ...
      try
      {
        paramBundle = localResources.getDrawable(2130841296);
        if (TextUtils.isEmpty(this.S))
        {
          ((AnyScaleTypeImageView)((axza)localObject).jdField_a_of_type_AndroidViewView).setBackgroundDrawable(paramBundle);
          if (TextUtils.isEmpty(this.S)) {
            continue;
          }
          if (paramView.findViewById(97) == null)
          {
            ...
            paramContext.setBackgroundResource(2130841311);
          ...
          paramView.jdField_a_of_type_JavaLangString = aytb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.V);
      ...
      catch (OutOfMemoryError paramBundle)
      {
        ...
        if ((ayog.b(this.S)) || (!aywk.a(paramContext)))
        {
          bool1 = true;
          paramBundle.setAutoDownload(bool1);
          if ((paramBundle != null) && (paramBundle.getStatus() == 1))
          {
            ((AnyScaleTypeImageView)((axza)localObject).jdField_a_of_type_AndroidViewView).setBackgroundDrawable(null);
            ((AnyScaleTypeImageView)((axza)localObject).jdField_a_of_type_AndroidViewView).setBackgroundDrawable(paramBundle);
          }
        }
        else
        ...
        ((AnyScaleTypeImageView)((axza)localObject).jdField_a_of_type_AndroidViewView).setURLDrawableDownListener(this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter);
        ((axza)localObject).jdField_a_of_type_AndroidViewView.setBackgroundColor(15790320);
        continue;
      ...
      paramBundle.jdField_a_of_type_AndroidViewView.setContentDescription(localResources.getString(2131694746));
      ((AnyScaleTypeImageView)paramBundle.jdField_a_of_type_AndroidViewView).setDisplayRuleDef(bckq.a);
      ((AnyScaleTypeImageView)paramBundle.jdField_a_of_type_AndroidViewView).setScaleType(ImageView.ScaleType.CENTER_INSIDE);
      try
      {
        paramView = localResources.getDrawable(2130841296);
        if (TextUtils.isEmpty(this.S))
        {
          ...
          paramBundle.b.setBackgroundResource(2130841302);
          paramBundle.c = new ImageView(paramContext);
          paramBundle.c.setId(98);
          paramBundle.c.setBackgroundResource(2130841345);
          ...
          paramContext = new RelativeLayout.LayoutParams(actn.a(12.0F, localResources), actn.a(20.0F, localResources));
          paramContext.addRule(9, -1);
          paramContext.setMargins(actn.a(20.0F, localResources), 0, 0, 0);
          paramContext.addRule(15, -1);
          ((RelativeLayout)localObject).addView(paramBundle.b, paramContext);
          paramContext = new RelativeLayout.LayoutParams(actn.a(14.0F, localResources), actn.a(20.0F, localResources));
          paramContext.setMargins(actn.a(5.0F, localResources), 0, 0, 0);
          paramContext.addRule(15, -1);
          paramContext.addRule(1, paramBundle.b.getId());
          ((RelativeLayout)localObject).addView(paramBundle.c, paramContext);
          paramContext = new RelativeLayout.LayoutParams(-2, -2);
          paramContext.setMargins(actn.a(15.0F, localResources), 0, 0, 0);
          paramContext.addRule(15, -1);
  ...
  {
    if ((paramayqm.jdField_b_of_type_Int != 33) || (paramInt1 == 2002) || (paramInt1 == 2001)) {}
  ...
  void a(String paramString, View paramView)
  {
    if (asej.a().d())
    {
      ...
      bbcv.a(paramString, 232, null, paramString.getString(2131692321), new axyz(this), null).show();
      b();
      return;
    }
    acwd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(paramView, this);
    ...
    for (;;)
    {
      try
      {
        ...
        ((aywa)localObject).jdField_c_of_type_JavaLangString = paramString;
        ((aywa)localObject).jdField_a_of_type_Int = 1008;
        ((aywa)localObject).jdField_b_of_type_Int = 33;
        ((aywa)localObject).jdField_a_of_type_Long = paramView.uniseq;
        ((aywa)localObject).jdField_a_of_type_Boolean = false;
        ((aywa)localObject).e = ((MessageForPtt)paramView).urlAtServer;
        ((aywa)localObject).h = ((MessageForPtt)paramView).getLocalFilePath();
      ...
      ((aywa)localObject).jdField_b_of_type_Boolean = bool;
      ((aywa)localObject).f = ((MessageForPtt)paramView).md5;
      ((aywa)localObject).jdField_c_of_type_Long = ((MessageForPtt)paramView).groupFileID;
      ((aywa)localObject).g = ((MessageForPtt)paramView).groupFileKeyStr;
      ((aywa)localObject).d = ((MessageForPtt)paramView).subVersion;
      ((aywa)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageRecord = paramView;
      ((aywa)localObject).jdField_a_of_type_JavaLangObject = new aywf(1, 0);
  ...
  public boolean a(axwe paramaxwe)
  {
    ...
    this.S = paramaxwe.a("cover");
    this.k = Integer.parseInt(paramaxwe.a("busitype"));
    this.l = Integer.parseInt(paramaxwe.a("duration"));
    this.T = paramaxwe.a("md5");
    this.U = paramaxwe.a("filename");
    this.m = Integer.parseInt(paramaxwe.a("filesize"));
    this.V = paramaxwe.a("uuid");
    return true;
  }
  ...
  void b()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130841302);
    ...
    this.b.setBackgroundResource(2130841345);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioMediaPlayerManager.a(((acve)actn.a(this.jdField_a_of_type_AndroidViewViewGroup)).a);
    this.b.clearAnimation();
    this.b.setBackgroundResource(2130772117);
    ((AnimationDrawable)this.b.getBackground()).start();
  }
  ...
  public void d()
  {
    ...
    if (((acve)actn.a(this.jdField_a_of_type_AndroidViewViewGroup)).a.equals(localMediaPlayerManager.a())) {
