  ...
  implements Manager
{
  ...
  public ConcurrentHashMap<Integer, axhi> a;
  
  public axhj(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Altk = ((altk)paramQQAppInterface.a(56));
  }
  ...
  private void a(long[] paramArrayOfLong, axhi paramaxhi, String paramString, boolean paramBoolean)
  {
    ThreadManager.post(new NumRedMsgManager.2(this, paramArrayOfLong, paramaxhi, paramBoolean, paramString), 5, null, false);
  }
  ...
  {
    boolean bool = bdcs.a(new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getFilesDir(), "NumRedMsgFileName_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).getAbsolutePath(), paramNumMsgRspBody.toByteArray(), false);
    if (bool) {
  ...
  public void a(NumRedMsg.NumMsgRspBody paramNumMsgRspBody, ToServiceMsg paramToServiceMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      paramNumMsgRspBody = (axhi)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i));
      if (paramNumMsgRspBody == null) {
        break;
      }
  ...
  public void a(List<Submsgtype0x89.NumRedBusiInfo> paramList, String paramString, axhi paramaxhi)
  {
    ThreadManager.post(new NumRedMsgManager.1(this, paramList, paramaxhi, paramString), 5, null, false);
  }
  
  public void a(long[] paramArrayOfLong, String paramString, axhi paramaxhi)
  {
    a(paramArrayOfLong, paramaxhi, paramString, false);
  }
