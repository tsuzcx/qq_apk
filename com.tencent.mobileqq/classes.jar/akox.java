  ...
  extends akov
{
  ...
  public akox(QQAppInterface paramQQAppInterface, JSONObject paramJSONObject, QQSettingMe paramQQSettingMe)
  {
  ...
  public void a(akxc paramakxc, Context paramContext, QQAppInterface paramQQAppInterface)
  {
    ...
    ((akji)paramQQAppInterface.getManager(153)).a(paramQQAppInterface, paramContext, this.jdField_d_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, "drawer");
  }
    ...
    do
    {
      do
      {
        ...
        if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
          akwt.a(paramakxc, this.jdField_a_of_type_JavaLangString, 9, this.e);
        }
      } while ((TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) || (this.jdField_a_of_type_JavaLangRefWeakReference == null));
      paramakxc = (QQSettingMe)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (paramakxc == null);
    paramakxc.a(this.jdField_c_of_type_JavaLangString);
  }
}
