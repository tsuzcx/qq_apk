...
class yzw
  extends Handler
{
  yzw(yzu paramyzu, Looper paramLooper)
  {
    super(paramLooper);
  }
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                if ((localObject2 == null) || (!(localObject2 instanceof begy))) {
                  break;
                }
                if (paramMessage.arg1 != 4) {
                  break label535;
                }
                if ((yzu.jdField_a_of_type_JavaUtilHashMap == null) || (TextUtils.isEmpty(yzu.a(this.a)))) {
                  break;
                }
                localObject1 = (swb)yzu.jdField_a_of_type_JavaUtilHashMap.get(yzu.a(this.a));
          ...
          } while ((paramMessage.arg1 != 5) || (yzu.jdField_a_of_type_JavaUtilHashMap == null) || (TextUtils.isEmpty(yzu.a(this.a))));
          localObject2 = (swb)yzu.jdField_a_of_type_JavaUtilHashMap.get(yzu.a(this.a));
        } while (localObject2 == null);
      ...
      paramMessage = localException2.getResources().getDrawable(2130839200);
