...
public class botf
  extends botu
  implements bors, bozc, bozd, IEventReceiver
{
  ...
  private ViewTreeObserver.OnGlobalLayoutListener jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new botj(this);
  botm jdField_a_of_type_Botm;
  botn jdField_a_of_type_Botn;
  boto jdField_a_of_type_Boto;
  public boxk a;
  bpqp jdField_a_of_type_Bpqp = new both(this);
  ...
  public botf(@NonNull botw parambotw, int paramInt)
  {
    super(parambotw);
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_JavaLangRunnable = new EditVideoDoodle.5(this);
    this.jdField_a_of_type_Boxk = new botk(this);
  ...
  private void d()
  {
    ...
    int i;
    float f;
    if ((this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.d()) && (this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 14) && (this.jdField_a_of_type_Botw.a() != null) && (!this.jdField_a_of_type_Botw.a().isLandTakePicToVideo()) && ((this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource)))
    {
      ...
      f = j / i;
      if (!this.jdField_a_of_type_Botw.a().getTakePicToVideo()) {
  ...
  public JobSegment<bpel, bpel> a(int paramInt)
  {
    if (((this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditTakeVideoSource)) || ((this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource))) {
      return (JobSegment)weg.a(bpev.class, new Object[] { this, (bort)a(bort.class), Integer.valueOf(paramInt) });
    }
    return (JobSegment)weg.a(bpem.class, new Object[] { this, (bort)a(bort.class), Integer.valueOf(paramInt) });
  }
  ...
  public void a()
  {
    ...
    PtvTemplateManager.a(localAppInterface).a(localAppInterface, this.jdField_a_of_type_Bpqp);
  ...
  {
    this.jdField_a_of_type_Botw.a(false, paramFloat1, paramFloat2, paramFloat3, paramFloat4);
  }
  
  public void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6)
  {
    a().a(anvx.a(2131703255), true, 0L, new botl(this));
    this.jdField_a_of_type_Botw.a(paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5, paramFloat6);
  }
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((!paramBoolean) && (this.jdField_a_of_type_Botw.jdField_a_of_type_AndroidOsBundle != null))
    {
      Bundle localBundle = this.jdField_a_of_type_Botw.jdField_a_of_type_AndroidOsBundle.getBundle(bovr.jdField_a_of_type_JavaLangString);
      if (localBundle != null) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(localBundle);
      }
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Botw.jdField_a_of_type_AndroidOsBundle.getBundle("DynamicFaceLayer"));
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a() != null) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Botw.jdField_a_of_type_AndroidOsBundle.getBundle(bowf.jdField_a_of_type_JavaLangString));
      }
    }
  }
  ...
  public void a(int paramInt, @NonNull bpel parambpel)
  {
    ...
    parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoDoodleDescription = a().a(paramInt);
    this.jdField_a_of_type_Botw.a().setWordId(a().b());
    this.jdField_a_of_type_Botw.a().setStickerId(a().c());
    parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("all_doodle_text", a().a());
    parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.mMosaicMask = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a(paramInt);
    parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.mMosaicSize = 16;
    if (a().b(paramInt).size() > 0)
    {
      localObject1 = (bojs)bogd.a(4);
      parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLocationDescription = ((bojs)localObject1).a();
    }
    int i;
    label316:
    Object localObject3;
    int j;
    if (this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.d())
    {
      ...
      {
        parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLongitude = ((EditLocalVideoSource)this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.longitude;
        parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLatitude = ((EditLocalVideoSource)this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.latitude;
      }
    }
    else
    {
      ...
      if ((localObject2 != null) && (localObject2.length == 2))
      {
        ...
        localObject3 = this.jdField_a_of_type_Botw;
        ...
        localObject1 = "2";
        label375:
        ((botw)localObject3).a("pub_graffiti", j, 0, new String[] { "1", "", localObject1 });
        ykw.a("0X80076E0", ykw.jdField_b_of_type_Int);
        ykw.b("0X80075EA", ykw.jdField_a_of_type_Int);
        parambpel.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("1");
        parambpel.jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams.hasGraffiti = true;
        label447:
        if (localObject2[1] <= 0) {
          break label852;
        }
        ...
        localObject1 = "2";
        label484:
        ((botw)localObject3).a("pub_mosaics", j, 0, new String[] { "1", "", localObject1 });
        ykw.a("0X80076E1");
        ykw.b("0X80075EB");
        parambpel.jdField_b_of_type_Boolean = true;
        if (localObject2[0] == 0) {
          parambpel.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("1");
        }
      }
    ...
    for (;;)
    {
      ...
      if (!(this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalPhotoSource)) {
        break;
      }
      parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLongitude = ((EditLocalPhotoSource)this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.longitude;
      parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLatitude = ((EditLocalPhotoSource)this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.latitude;
      break;
      label808:
      i = 0;
      break label316;
    ...
    if (((List)localObject1).size() > 0)
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        ((StringBuilder)localObject4).append(((bovv)((Iterator)localObject1).next()).e).append(',');
      }
    ...
    if (localObject2[0] > 0)
    {
      localObject5 = this.jdField_a_of_type_Botw;
      j = this.jdField_a_of_type_Botw.b();
      ...
      {
        localObject1 = "2";
        ((botw)localObject5).a("pub_face", j, 0, new String[] { String.valueOf(k), localObject6, localObject1 });
        ykw.a("0X80076E3", ykw.jdField_b_of_type_Int);
        ykw.b("0X80075ED", ykw.jdField_a_of_type_Int);
        parambpel.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("4");
        parambpel.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 = ((StringBuilder)localObject3).toString();
        label1118:
        if (localObject2[1] <= 0) {
          break label1531;
        }
        this.jdField_a_of_type_Botw.a("pub_poi", this.jdField_a_of_type_Botw.b(), 0, new String[] { String.valueOf(localObject2[1]), ((StringBuilder)localObject4).toString() });
        ykw.a("0X80076E4");
        ykw.b("0X80075EE");
        if (localObject2[0] <= 0) {
          break label1502;
        }
        parambpel.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 = (parambpel.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 + "," + ((StringBuilder)localObject4).toString());
        label1225:
        localObject2 = a().a(paramInt);
        ...
        localObject3 = this.jdField_a_of_type_Botw;
        i = this.jdField_a_of_type_Botw.b();
        if (!this.jdField_a_of_type_Botw.a()) {
          break label1557;
        }
        localObject1 = "2";
        label1280:
        ((botw)localObject3).a("pub_text", i, 0, new String[] { "1", localObject2, localObject1 });
        ykw.a("0X80076E2", ykw.jdField_b_of_type_Int);
        ykw.b("0X80075EC", ykw.jdField_a_of_type_Int);
        parambpel.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("3");
        parambpel.jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams.hasText = true;
      }
    }
    for (;;)
    {
      ...
      label1502:
      parambpel.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("4");
      parambpel.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 = ((StringBuilder)localObject4).toString();
      break label1225;
      label1531:
      if ((i == 0) || (!bpeq.a(3))) {
        break label1225;
    ...
    this.jdField_a_of_type_Botw.a("person_gra", this.jdField_a_of_type_Botw.b(), 0, new String[] { localObject1 });
    label1615:
    Object localObject2 = bofz.a().getCurrentAccountUin();
    if (bpax.jdField_b_of_type_Boolean) {}
    for (Object localObject1 = parambpel.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLocationDescription;; localObject1 = "")
    {
      ...
      parambpel.jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams.hasFace = true;
      return;
    }
  }
  ...
  public void a(Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (localboud != null) {
      localboud.a(paramBitmap, paramBoolean);
    }
  }
  
  public void a(Animation paramAnimation)
  {
    this.jdField_a_of_type_Botw.a(paramAnimation);
  }
  
  public void a(bpbd parambpbd)
  {
    if (this.jdField_a_of_type_Botw.a()) {}
    for (parambpbd = "2";; parambpbd = "1")
    {
      ykv.a("video_edit", "add_place", 0, 0, new String[] { parambpbd, "", "0", "" });
      return;
    }
  }
  ...
  {
    if (!this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a())
    {
      this.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
      VideoSourceHelper.nativeSetMosaic(16, this.jdField_a_of_type_ArrayOfByte);
      boud localboud = (boud)a(boud.class);
      if (localboud != null) {
        localboud.a(16, paramArrayOfByte);
      }
    }
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Botw.a();
  }
  ...
  public void aJ_()
  {
    this.jdField_a_of_type_Bouo.a().postDelayed(new EditVideoDoodle.7(this), 200L);
  }
  ...
  public void a_(int paramInt, Object paramObject)
  {
    ...
    case 7: 
      ...
      return;
    case 2: 
      this.jdField_a_of_type_Botw.a(4, paramObject);
      return;
    case 3: 
      this.jdField_a_of_type_Botw.a(2, paramObject);
      return;
    case 4: 
      this.jdField_a_of_type_Botw.a(6);
      return;
    case 5: 
      this.jdField_a_of_type_Botw.a(5, paramObject);
      return;
    }
    this.jdField_a_of_type_Botw.a(5);
  }
  ...
  {
    this.jdField_a_of_type_Botw.b(paramAnimation);
  }
  
  public boolean b()
  {
    if (System.currentTimeMillis() < this.jdField_a_of_type_Long) {}
    while ((!botw.a(this.jdField_b_of_type_Int, 1)) || (!TextUtils.isEmpty(a().a(this.jdField_a_of_type_Botw.a())))) {
      return false;
    }
    if (this.jdField_a_of_type_Botw.jdField_a_of_type_Int == 12) {
      this.jdField_a_of_type_Botw.a(0);
    }
    return true;
  }
  ...
  public void c()
  {
    ...
    label635:
    for (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout = ((DoodleLayout)this.jdField_a_of_type_AndroidViewViewStub.inflate());; this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout = ((DoodleLayout)a(2131365803)))
    {
      if (this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.f == bnlb.c.a()) {
      ...
      if (!botw.a(this.jdField_b_of_type_Int, 1)) {
      ...
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.setMosaicStandardSize(this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a(), this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.b());
      ...
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.setEditVideoParams(this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams);
      ...
      {
        if (this.jdField_a_of_type_Botw.jdField_a_of_type_AndroidOsBundle.getBundle(bovr.jdField_a_of_type_JavaLangString) != null) {
          this.jdField_a_of_type_Botw.jdField_a_of_type_AndroidOsBundle.getBundle(bovr.jdField_a_of_type_JavaLangString).putBoolean("edit_type_photo", this.jdField_a_of_type_Botw.a());
        }
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Botw.jdField_a_of_type_AndroidOsBundle.getBundle(bovr.jdField_a_of_type_JavaLangString));
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Botw.jdField_a_of_type_AndroidOsBundle.getBundle("DynamicFaceLayer"));
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a() != null)
        {
          if (this.jdField_a_of_type_Botw.jdField_a_of_type_AndroidOsBundle.getBundle(bowf.jdField_a_of_type_JavaLangString) != null) {
            this.jdField_a_of_type_Botw.jdField_a_of_type_AndroidOsBundle.getBundle(bowf.jdField_a_of_type_JavaLangString).putBoolean("edit_type_photo", this.jdField_a_of_type_Botw.a());
          }
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Botw.jdField_a_of_type_AndroidOsBundle.getBundle(bowf.jdField_a_of_type_JavaLangString));
        }
      }
      bonc.a().a(this.jdField_a_of_type_Botw.g(), this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout);
      ...
      {
        this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer = this.jdField_a_of_type_Botw.jdField_a_of_type_Bosq.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer;
        if (this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer != null) {
          this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer.setLiuHaiParentView(this.jdField_a_of_type_Botw.jdField_a_of_type_AndroidWidgetRelativeLayout);
        }
        if ((localObject1 != null) && (this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer != null))
        {
          if ((this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource)) {
            int i = ((EditLocalVideoSource)this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_Int;
          }
          this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer.setStickerListener(((DoodleEditView)localObject1).a());
          ((DoodleEditView)localObject1).setDoodleEditViewListener(new botg(this));
        }
        a(2131365981).setOnTouchListener(new boti(this));
      }
      localObject1 = wad.a();
      Object localObject2 = new botn(this);
      this.jdField_a_of_type_Botn = ((botn)localObject2);
      ((Dispatcher)localObject1).registerSubscriber((Subscriber)localObject2);
      localObject1 = wad.a();
      localObject2 = new botm(this);
      this.jdField_a_of_type_Botm = ((botm)localObject2);
      ((Dispatcher)localObject1).registerSubscriber((Subscriber)localObject2);
      localObject1 = wad.a();
      localObject2 = new boto(this);
      this.jdField_a_of_type_Boto = ((boto)localObject2);
      ((Dispatcher)localObject1).registerSubscriber((Subscriber)localObject2);
      return;
    }
  }
  ...
  {
    this.c = true;
    if (this.jdField_a_of_type_Botn != null) {
      wad.a().unRegisterSubscriber(this.jdField_a_of_type_Botn);
    }
    if (this.jdField_a_of_type_Botm != null) {
      wad.a().unRegisterSubscriber(this.jdField_a_of_type_Botm);
    }
    if (this.jdField_a_of_type_Boto != null) {
      wad.a().unRegisterSubscriber(this.jdField_a_of_type_Boto);
    }
    this.jdField_a_of_type_AndroidOsHandler.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    bonc.a().a(this.jdField_a_of_type_Botw.g());
  }
  ...
  public void i()
  {
    this.jdField_a_of_type_Botw.a(true, 0.0F, 0.0F, 0.0F, 0.0F);
  }
