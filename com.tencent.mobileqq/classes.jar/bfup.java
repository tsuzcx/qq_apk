...
public class bfup
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, StringBuilder paramStringBuilder)
  {
    ...
    do
    {
      do
      {
        ...
        paramString = bgnn.a(MessageRecord.getOldTableName(paramString, paramInt), MessageRecord.getTableName(paramString, paramInt), paramQQAppInterface, localStringBuilder.toString());
  ...
  {
    return a(paramResources, paramInt, paramResources.getDrawable(2130849697));
  }
  ...
  public static Pair<String, ArrayList<MessageForText.AtTroopMemberInfo>> a(Editable paramEditable)
  {
    ...
    paramEditable = bfmd.a(paramEditable, localArrayList);
  ...
  public static bgbw a(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface)
  {
    if ((paramBaseActivity == null) || (paramBaseActivity.isFinishing()) || (paramTroopInfoData == null) || (paramQQAppInterface == null)) {
      return null;
    }
    paramBaseActivity = new bgbw(paramBaseActivity, paramTroopInfoData, new bfuq(paramTroopInfoData));
    paramBaseActivity.a(paramTroopInfoData);
    bcst.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_Admin_data", "Clk_share", 0, 0, paramTroopInfoData.troopUin, "", "", "");
    if (paramTroopInfoData.isMember) {
      bgjt.a("Grp_set_new", "grpData_admin", "clk_share", 0, 0, new String[] { paramTroopInfoData.troopUin, bgjt.a(paramTroopInfoData) });
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (l > 0L)
        {
          ...
          {
            localTroopInfoData.mRichFingerMemo = nlw.c(localTroopInfoData.mRichFingerMemo);
            localTroopInfoData.mRichFingerMemo = nlw.b(localTroopInfoData.mRichFingerMemo);
          }
          localTroopInfoData.cGroupOption = ((short)paramBundle.getByte("troop_info_opt"));
          localTroopInfoData.mStrJoinQuestion = bgju.b(paramContext, localTroopInfoData.troopUin);
          localTroopInfoData.nTroopGrade = paramBundle.getInt("TROOP_INFO_TROOP_GRADE");
          localTroopInfoData.mStrJoinAnswer = bgju.c(paramContext, localTroopInfoData.troopUin);
  ...
  public static String a(Context paramContext, long paramLong)
  {
    ...
    if (paramLong > 0L)
    {
      ...
      localObject = paramContext.getResources().getString(2131695429) + ((SimpleDateFormat)localObject).format(Long.valueOf(1000L * paramLong));
    }
    return localObject;
  }
  ...
  public static String a(String paramString, long paramLong, int paramInt, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    {
      str = "0";
      paramQQAppInterface = paramString.replace("$GCODE$", paramTroopInfoData.troopUin).replace("$CLIENTVER$", "android8.4.1").replace("$UIN$", paramQQAppInterface.getCurrentAccountUin()).replace("$LANG$", "zh_CN").replace("$GROUPAPPID$", Long.toString(paramLong)).replace("$ROLE$", str);
      if (!paramBoolean) {
        break label169;
      }
    }
  ...
  public static void a(long paramLong1, String paramString, long paramLong2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      localObject = (anwd)localQQAppInterface.a(20);
      ((anwd)localObject).notifyUI(2, false, null);
      ((anie)localQQAppInterface.a(22)).notifyUI(43, true, new Object[] { str, paramString, null });
      if (i != 0)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TroopUtils", 2, "TroopUtils handleModifyName :" + localTroopInfo.troopname);
        }
        ((anwd)localObject).b(str, String.valueOf(paramLong2), paramString);
      }
      return;
    }
  }
  ...
  {
    bibh localbibh = new bibh(paramActivity);
    int i = paramActivity.getResources().getDimensionPixelSize(2131298998);
    switch (paramInt)
    {
    case 6: 
    case 7: 
    ...
    case 10: 
    default: 
      localbibh.a(2131693147, i, 0, 1);
      return;
    case 2: 
      localbibh.a(anni.a(2131714489), i, 0, 1);
      return;
    case 3: 
      localbibh.a(anni.a(2131714478), i, 0, 1);
      return;
    case 4: 
      localbibh.a(anni.a(2131714484), i, 0, 1);
      return;
    case 5: 
      localbibh.a(anni.a(2131714479), i, 0, 1);
      return;
    }
    localbibh.a(2131718790, i, 0, 1);
  }
  ...
  public static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    VasWebviewUtil.openQQBrowserWithoutAD(paramActivity, bgyg.a(paramActivity, "background", ""), 33554432L, localIntent, true, paramInt);
    bcst.b(paramQQAppInterface, "CliOper", "", "", "0X8004E0E", "0X8004E0E", 0, 0, "", "", "", "");
  }
  ...
  {
    new bibh(paramContext).a(paramInt2, paramInt1, 0, paramInt3);
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (TextUtils.isEmpty(paramRecommendTroopItem.recommendReason))
        {
          ...
          ArrayList localArrayList = njn.a(paramRecommendTroopItem);
  ...
  public static void a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    paramContext = bglf.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramString, false);
    Intent localIntent = afur.a(new Intent((Context)localObject, SplashActivity.class), null);
    localIntent.putExtra("uin", paramString);
    localIntent.putExtra("uintype", 1);
  ...
  public static void a(View paramView, CharSequence paramCharSequence1, CharSequence paramCharSequence2, CharSequence paramCharSequence3, boolean paramBoolean, String paramString1, String paramString2, azmm paramazmm)
  {
    ...
    while (TextUtils.isEmpty(paramCharSequence2))
    {
      ...
      if (paramBoolean)
      {
        paramView = azml.a(paramView, paramString2, paramString1);
        if (paramView != null) {
          paramView.a(paramazmm);
        }
      }
    }
  ...
  public static void a(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      bgjt.a("Grp_set_new", "grpData_admin", "clk_report", 0, 0, new String[] { paramTroopInfoData.troopUin, bgjt.a(paramTroopInfoData) });
      paramTroopInfoData = abao.a(str1, 1);
      abao.a(paramBaseActivity, str1, null, null, str1, paramQQAppInterface.getAccount(), i, null, paramTroopInfoData);
      return;
      if (paramTroopInfoData.isMember) {
        i = 22000;
      } else {
    ...
    {
      bgjt.a("Grp_set_new", "grpData_visitor", "clk_report", 0, 0, new String[] { str2, paramTroopInfoData });
  ...
  {
    if (bglj.a(paramQQAppInterface.getCurrentAccountUin(), "troop_file_new", paramString) != 0) {}
    for (int i = 1;; i = 0)
    {
      if (i != 0) {
        bglj.a(paramQQAppInterface.getCurrentAccountUin(), "troop_file_new", paramString, 0);
      }
      Intent localIntent = new Intent();
      ...
      bcst.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp", "Clk_grpinfo_files", 0, 0, paramString, "0", "", "");
      if (QLog.isDevelopLevel()) {
        QLog.d("Clk_grpinfo_files", 4, "troopUin :" + paramString);
      }
      nlh.a(paramQQAppInterface, 67);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    paramString2 = (bfql)paramQQAppInterface.getManager(109);
    ...
    for (int i = 32;; i = 0)
    {
      ...
      for (paramString2 = paramString2.url.replace("$GCODE$", paramString1);; paramString2 = null)
      {
        ...
        bcst.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_app", "Clk_grpapp", 0, 0, paramString1, "", "", "");
        return;
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, int paramInt)
  {
    ...
    if (paramInt != 0)
    {
      ...
      localblsi.b = paramQQAppInterface.getCurrentNickname();
      anwd localanwd = (anwd)paramQQAppInterface.a(20);
      if (!TextUtils.isEmpty(paramString1)) {
        localanwd.e(paramString1, true);
      }
      if (bglj.a(paramQQAppInterface.getCurrentAccountUin(), "troop_photo_message", paramString1) <= 0) {
        break label123;
      }
      blsb.d(paramActivity, localblsi, paramString1, 7);
    }
    for (;;)
    {
      bcst.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_Admin_data", "Clk_album", 0, 0, paramString1, "", "", "");
      nlh.a(paramQQAppInterface, 66);
      return;
      bool = false;
      break;
      label123:
      blsb.a(paramActivity, localblsi, paramString1, paramString2, bool, 7);
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, Intent paramIntent, bfpo parambfpo)
  {
    ...
    if (str1.length() < 10)
    {
      ...
      a(paramQQAppInterface, paramContext, str3, parambfpo, 0, null);
    ...
    for (;;)
    {
      ...
      new bfpp(localStringBuilder.toString(), "GET", parambfpo, 1, null).a(paramQQAppInterface);
      return;
      ((StringBuilder)localObject1).append("0");
      ((StringBuilder)localObject1).append(str1);
      break;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, Bundle paramBundle)
  {
    ...
    localIntent.putExtras(paramBundle);
    paramContext.startActivity(localIntent);
    bcst.b(paramQQAppInterface, "P_CliOper", "Grp_set", "", "Grp_app", "Clk_grpapp", 0, 0, str, "", "", "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, MessageRecord paramMessageRecord, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      ((anwd)paramQQAppInterface.a(20)).c(paramString1, 2, i);
      bcst.b(paramQQAppInterface, "dc00898", "", "", "0X800AD4F", "0X800AD4F", (int)l, 0, String.valueOf(j), "", "", "");
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    if (localTroopManager != null)
    {
      ...
      if (paramString != null)
      {
        ...
        {
          paramQQAppInterface = new bgbw((BaseActivity)paramContext, localTroopInfoData);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    if (paramContext != null)
    {
      ...
      azgc.a(paramContext, paramQQAppInterface, localIntent, paramInt);
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, bfpo parambfpo, int paramInt, Bundle paramBundle)
  {
    Bundle localBundle = new Bundle();
    StringBuilder localStringBuilder = new StringBuilder();
    ...
    new bfpp(localStringBuilder.toString(), "GET", parambfpo, paramInt, paramBundle).a(paramQQAppInterface);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForUniteGrayTip paramMessageForUniteGrayTip)
  {
    ...
    try
    {
      ...
      if ((paramMessageForUniteGrayTip != null) && (paramMessageForUniteGrayTip.length > 1))
      {
        ...
        bcst.b(paramQQAppInterface, "dc00898", "", "", "0X800AD4E", "0X800AD4E", (int)Long.parseLong(paramMessageForUniteGrayTip[1]), 0, String.valueOf(i), "", "", "");
      }
      return;
    }
    catch (Exception paramQQAppInterface)
  ...
  {
    paramQQAppInterface = (awne)paramQQAppInterface.getManager(37);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, List<oidb_0xe3b.HighlightTitle> paramList, int paramInt2, long paramLong)
  {
    ...
    {
      localauxc = new auxc(paramString1, paramString1, paramString2, 1, -5020, 131088, bbyp.a());
      if (paramList != null)
      {
    ...
    for (;;)
    {
      ...
      paramString2.initGrayTipMsg(paramQQAppInterface, localauxc);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, List<ChatMessage> paramList)
  {
        ...
        if (i < paramList.size())
        {
          ...
          if ((!(localChatMessage instanceof MessageForGrayTips)) && ((!(localChatMessage instanceof MessageForUniteGrayTip)) || (localChatMessage.time == l)))
          {
            ...
            if ((localChatMessage instanceof MessageForSplitLineTips))
            {
              ...
              if (!anni.a(2131714481).equalsIgnoreCase(((MessageForSplitLineTips)localObject2).msgContent)) {
                break;
              }
            }
          }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = (MessageForSplitLineTips)bbzh.a(-4012);
        ((MessageForSplitLineTips)localObject2).init(paramQQAppInterface.getCurrentAccountUin(), paramString, paramQQAppInterface.getCurrentAccountUin(), anni.a(2131714486), l, -4012, 1, l);
        ...
        ((MessageForSplitLineTips)localObject2).msgContent = anni.a(2131714487);
  ...
  public static void a(TroopInfoData paramTroopInfoData, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      bcst.b(null, "P_CliOper", "Grp_nearby", "", "recom", "Clk_joingrp", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 18)
    {
      bcst.b(null, "P_CliOper", "Grp_join", "", "join_page", "Clk_join", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 24)
    {
      bcst.b(null, "P_CliOper", "Grp_nearby", "", "search", "Clk_joingrp", 0, 0, "", "", "", "");
      return;
    }
    if (paramTroopInfoData.pa == 17)
    {
      bcst.b(null, "CliOper", "", "", "Grp_recommend", "viewinfor_joingrp", 0, 0, paramTroopInfoData.troopUin, "", "", "");
      return;
    }
    int i = -1;
    int j;
    ...
    for (;;)
    {
      ...
      bcst.b(null, "P_CliOper", "Grp_set", "", "Grp_data", "Clk_joingrp", j, 0, paramTroopInfoData.troopUin, paramInt1 + "", "" + i, paramInt2 + "");
      bcst.b(null, "P_CliOper", "Grp_set", "", "Grp_data", "Clk_joingrp1", j, 0, paramTroopInfoData.troopUin, paramInt1 + "", paramInt3 + "", "");
      return;
      i = 0;
      break;
      i = 1;
  ...
  public static void a(String paramString)
  {
    ...
    do
    {
      ...
      bgjb.a(BaseApplicationImpl.getApplication(), paramString, paramString);
    } while (!QLog.isColorLevel());
  ...
  public static void a(List<String> paramList)
  {
    ...
    {
      bftx localbftx = (bftx)((QQAppInterface)localObject).getManager(203);
      localObject = null;
      Iterator localIterator = paramList.iterator();
      if (localIterator.hasNext())
      {
  ...
  public static void a(AppRuntime paramAppRuntime, TroopInfo paramTroopInfo, Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramActivity.setTitle(anni.a(2131714482)).setMessage(anni.a(2131714480)).setPositiveButton(anni.a(2131714488), paramOnClickListener);
    paramActivity.show();
    bgjt.a("Grp_manage_new", "gainUin_msgBox", "exp", 0, 0, new String[] { String.valueOf(paramTroopInfo.troopuin), "", bgjt.a(paramTroopInfo, paramAppRuntime) });
  }
  ...
  public static void a(boolean paramBoolean, TextView paramTextView)
  {
    if (paramBoolean)
    {
      ...
      paramTextView.setCompoundDrawablePadding(afur.a(10.0F, BaseApplicationImpl.getApplication().getResources()));
      paramTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130841367, 0);
      return;
    }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        return false;
        if (!TextUtils.equals("4680", paramContext)) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.i("TroopUtils", 2, String.format("isUpdateBeforeSomeVersion pre: %s, cur: %s", new Object[] { "4680", paramContext }));
      return false;
  ...
  {
    if ((paramTabInfo != null) && (paramTabInfo.appid.get() == 1106837471L) && ((paramView.getTag(2131378277) instanceof Integer))) {
      return ((Integer)paramView.getTag(2131378277)).intValue() == 1;
    }
    return false;
  }
  ...
  public static boolean a(String paramString)
  {
    ...
    return (anwd.jdField_a_of_type_Boolean) && (localTroopManager.b());
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, Context paramContext, MessageRecord paramMessageRecord, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      bcst.b(null, "dc00898", "", "", "0X800ADF1", "0X800ADF1", 0, 1, "", "", "", "");
      return;
    }
  ...
  {
    String str = bgjb.a(BaseApplicationImpl.getApplication(), paramString);
    if (QLog.isColorLevel()) {
