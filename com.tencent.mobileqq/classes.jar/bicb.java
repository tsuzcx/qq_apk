  ...
  implements Handler.Callback
{
  ...
  private bicc jdField_a_of_type_Bicc;
  ...
  public bicb(Context paramContext, Bitmap paramBitmap, int paramInt1, int paramInt2)
  {
    ...
    label301:
    for (this.d = (azkz.jdField_a_of_type_Int - paramContext.getResources().getDimensionPixelSize(2131298274));; this.d = azkz.jdField_a_of_type_Int)
    {
      int i = paramInt2;
      if (paramInt2 <= 0) {
        i = azkz.a(170.0F);
      ...
      this.c = this.f;
      this.jdField_a_of_type_Bicc = new bicc(this);
      return;
    }
  }
  ...
  private void e()
  {
    this.jdField_a_of_type_Bicc.jdField_a_of_type_Int = (this.g - this.e);
    this.jdField_a_of_type_Bicc.jdField_b_of_type_Int = (-(this.g - this.f - this.e));
    this.jdField_a_of_type_Bicc.c = 12000;
    this.jdField_a_of_type_Bicc.d = 3;
  }
  
  private void f()
  {
    this.jdField_a_of_type_Bicc.jdField_a_of_type_Int = this.f;
    this.jdField_a_of_type_Bicc.jdField_b_of_type_Int = (this.g - this.f - this.e);
    this.jdField_a_of_type_Bicc.c = 12000;
    this.jdField_a_of_type_Bicc.d = 2;
  }
  ...
  public void c()
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Bicc.jdField_a_of_type_Int = this.c;
      this.jdField_a_of_type_Bicc.c = (this.jdField_a_of_type_AndroidWidgetScroller.getDuration() - this.jdField_a_of_type_AndroidWidgetScroller.timePassed());
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return false;
    case 1: 
      this.jdField_a_of_type_AndroidWidgetScroller.startScroll(0, this.jdField_a_of_type_Bicc.jdField_a_of_type_Int, 0, this.jdField_a_of_type_Bicc.jdField_b_of_type_Int, this.jdField_a_of_type_Bicc.c);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(this.jdField_a_of_type_Bicc.d);
