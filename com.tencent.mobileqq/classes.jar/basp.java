  ...
  extends baqn
{
  ...
  public basp(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  /* Error */
  private Object b(DownloadParams paramDownloadParams, basq parambasq)
  {
    // Byte code:
    //   0: iconst_1
    //   1: istore_3
    ...
    //   6: astore 7
    //   8: aload_2
    //   9: getfield 148	basq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   12: astore 10
    //   14: aload 10
    //   16: ifnonnull +8 -> 24
    //   19: aload 7
    ...
    //   40: ifeq +63 -> 103
    //   43: aload_2
    //   44: getfield 162	basq:jdField_a_of_type_Boolean	Z
    //   47: ifeq +56 -> 103
    //   50: aload 7
    //   52: astore_2
    ...
    //   110: astore 12
    //   112: aload 12
    //   114: getstatic 197	bayu:a	Landroid/graphics/Bitmap$Config;
    ...
    //   306: aload_0
    //   307: aload 9
    //   309: invokevirtual 264	basp:a	([B)I
    //   312: istore 4
    //   314: iconst_4
    //   315: newarray byte
    //   317: astore 9
    ...
    //   326: aload_0
    //   327: aload 9
    //   329: invokevirtual 264	basp:a	([B)I
    ...
    //   365: invokestatic 283	basp:a	(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    //   368: astore 9
    //   370: aload 9
    //   372: astore_1
    //   373: aload_2
    ...
    //   448: invokestatic 294	baqo:b	(Landroid/graphics/BitmapFactory$Options;II)I
  ...
  public basq a(URL paramURL)
  {
    boolean bool2 = true;
    try
    {
      paramURL = paramURL.getFile().split("\\|");
      basq localbasq = new basq(this);
      localbasq.jdField_a_of_type_JavaLangString = paramURL[0];
      localbasq.jdField_a_of_type_Int = Integer.parseInt(paramURL[1]);
      localbasq.jdField_b_of_type_Int = Integer.parseInt(paramURL[2]);
      localbasq.jdField_a_of_type_Long = Long.parseLong(paramURL[3]);
      if (paramURL.length > 4)
      {
        if (Integer.parseInt(paramURL[4]) == 1)
        {
          bool1 = true;
          localbasq.jdField_a_of_type_Boolean = bool1;
        }
      }
      else
      {
        if (paramURL.length > 5)
        {
          ...
          bool1 = true;
          label106:
          localbasq.jdField_b_of_type_Boolean = bool1;
        }
  ...
  public Object a(DownloadParams paramDownloadParams, basq parambasq)
  {
    paramDownloadParams = parambasq.jdField_a_of_type_JavaLangString;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramDownloadParams.inPreferredConfig = bayu.b;
        ...
        parambasq = SafeBitmapFactory.decodeFile(localFile.getAbsolutePath(), paramDownloadParams);
        paramDownloadParams = parambasq;
        if (parambasq == null) {
          continue;
        }
        paramDownloadParams = a(parambasq);
        if (!parambasq.equals(paramDownloadParams.mBitmap)) {
          parambasq.recycle();
        }
        parambasq = new RoundRectBitmap(new bazi(localFile.getAbsolutePath()).a(paramDownloadParams.mBitmap), paramDownloadParams.mCornerRadius, paramDownloadParams.mBoardColor, paramDownloadParams.mBorderWidth);
        paramDownloadParams = parambasq;
        if (this.a == null) {
          continue;
        }
        parambasq.mDisplayWidth = this.a.getResources().getDisplayMetrics().widthPixels;
        parambasq.mDisplayHeight = this.a.getResources().getDisplayMetrics().heightPixels;
        return parambasq;
      }
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    do
    {
      ...
      {
        return paramFile;
        if (arrr.a(paramURLDrawableHandler.jdField_a_of_type_JavaLangString) == 2) {}
        for (i = 1;; i = 0)
        {
      ...
      return arrr.a(this.a, paramDownloadParams, 16);
      if (paramURLDrawableHandler.c)
      {
        paramFile = arrj.a(this.a, paramURLDrawableHandler.jdField_a_of_type_JavaLangString);
        if (paramFile != null) {
      ...
      for (;;)
      {
        ...
        if (paramFile == null)
        {
          ...
          i = arrr.a(paramURLDrawableHandler.jdField_a_of_type_JavaLangString);
          paramDownloadParams = a(paramFile.getResources().getDrawable(arrr.a(i)));
        }
        if (paramDownloadParams != null) {
          break;
        }
        return null;
        paramFile = a(BaseApplicationImpl.getContext().getResources().getDrawable(2130843875));
        continue;
        paramFile = paramFile.getThumb(paramDownloadParams.url, new basr(this));
      }
      paramFile = paramDownloadParams;
    } while (!paramURLDrawableHandler.jdField_b_of_type_Boolean);
    return arrr.a(this.a, paramDownloadParams, 16);
