  ...
  extends aauq
{
  ...
  private long a(String paramString)
  {
    ...
    {
      long l = bhzf.a((QQAppInterface)localAppRuntime, "name_plate_config_version", 0L);
  ...
  private boolean b(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg = paramToServiceMsg.extraData.getString(aogw.a);
    ...
    localVAResourcesReq.lastVisitTime = bhnz.a;
  ...
  private boolean c(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    String str3 = paramToServiceMsg.extraData.getString(aogw.a);
    Object localObject = paramToServiceMsg.extraData.getString(aogw.c);
    long l1 = paramToServiceMsg.extraData.getLong(aogw.m);
    boolean bool3 = bhou.a();
    boolean bool1 = false;
    boolean bool2 = false;
    ...
    String str4 = bhyk.a(0, BaseApplicationImpl.getContext());
    localObject = bhyk.a(1, BaseApplicationImpl.getContext());
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        localObject = paramToServiceMsg.extraData.getString(aogw.d);
        ...
        localPrivExtV2Req.pullPayRuleCfgTime = bhzf.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "last_pull_pay_rule", 0L);
        ...
        paramToServiceMsg.extraData.putBoolean(aogw.i, bool1);
        paramToServiceMsg.extraData.putBoolean(aogw.j, bool2);
    ...
    {
      if (bool1) {
        paramToServiceMsg.extraData.putString(aogw.k, localPrivExtV2Req.sImsi1);
      }
      if (bool2) {
        paramToServiceMsg.extraData.putString(aogw.l, localPrivExtV2Req.sImsi2);
      }
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      if (paramToServiceMsg.extraData.getInt(aogw.b) == 6) {
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    do
    {
      ...
      if ("ClubInfoSvc.guanjiaReport".equals(paramToServiceMsg.getServiceCmd()))
      {
        ...
        localObject = paramToServiceMsg.extraData.getString(aogw.a);
        ...
        localGuanjiaReportReq.sPhoneNum = paramToServiceMsg.extraData.getString(aogw.e);
        localGuanjiaReportReq.bKingCard = paramToServiceMsg.extraData.getBoolean(aogw.f);
        localGuanjiaReportReq.iCardType = paramToServiceMsg.extraData.getInt(aogw.g);
        localGuanjiaReportReq.iCardStatus = paramToServiceMsg.extraData.getInt(aogw.h);
      ...
      ((GetCustomOnlineStatusReq)localObject).lUin = paramToServiceMsg.extraData.getLong(aogw.n);
