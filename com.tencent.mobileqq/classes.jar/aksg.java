...
public abstract class aksg
{
  ...
  public aksg(AppRuntime paramAppRuntime)
  {
  ...
  public static String a(String paramString, int paramInt)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      {
        aktg.a(paramString, paramInt, NetConnInfoCenter.getServerTimeMillis());
        return str;
      }
    }
    return null;
  ...
  {
    return akxc.c + paramAppRuntime.getAccount() + "/" + ".preloaduni" + "/";
  }
  ...
  public abstract void a(DownloadParam paramDownloadParam, akse paramakse);
  ...
  public boolean a(String paramString)
  {
    ...
    int j = bgnt.a(this.a.getApplication());
  ...
  public void c(String paramString, akse paramakse)
  {
