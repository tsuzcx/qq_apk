...
public class bbxx
{
  ...
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = new bbxy(this);
  public boolean a;
  ...
  public bbxx(RegisterNewBaseActivity paramRegisterNewBaseActivity, View paramView, int paramInt)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity = paramRegisterNewBaseActivity;
    this.jdField_a_of_type_Bbyb = new bbyb(paramRegisterNewBaseActivity, this);
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_ComTencentWidgetScrollView = ((ScrollView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375510));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131379273));
  ...
  public static void a(Context paramContext, boolean paramBoolean, String paramString1, String paramString2, Intent paramIntent)
  {
    ...
    if (jdField_a_of_type_Int == 1)
    {
      ...
      for (str = "1";; str = "2")
      {
        axqw.a(null, "new_reg", "setting_page_yes", "result", "", 1, "", "", str, "", "", "", "", "", "");
    ...
    {
      axqw.a(null, "new_reg", "setting_page_no", "result", "", 1, "", "", str, "", "", "", "", "", "");
      break;
    }
    label211:
    if (bool) {
  ...
  public static void a(String paramString, Intent paramIntent)
  {
    ...
    try
    {
      ...
      if (paramIntent.hasExtra("phonenum")) {
        localStringBuilder.append("phoneNum: ").append(bbfj.a(paramIntent.getStringExtra("phonenum"))).append("\r\n");
      }
  ...
  private void e()
  {
    ...
    if (jdField_a_of_type_Int == 1)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363630));
      this.jdField_a_of_type_AndroidWidgetButton.setText(2131717127);
      ...
      ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371284)).setVisibility(0);
      localClearableEditText1 = (ClearableEditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131370836);
      ClearableEditText localClearableEditText2 = (ClearableEditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131371283);
      ...
      this.jdField_a_of_type_AndroidWidgetFrameLayout.addView(this.jdField_a_of_type_Bbyb.a(new bbyf(localIntent)));
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363543));
      break;
      label375:
      if (jdField_a_of_type_Int != 2) {
        break label250;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Avpw = new avpw(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Avpw.a(localIntent);
  ...
  public void b()
  {
    ...
    {
      if (this.jdField_a_of_type_Bbya != null) {
        this.jdField_a_of_type_AndroidWidgetFrameLayout.removeOnLayoutChangeListener(this.jdField_a_of_type_Bbya);
      }
      this.jdField_a_of_type_Bbya = null;
      this.jdField_a_of_type_AndroidWidgetFrameLayout.removeAllViews();
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((i == 0) && (paramBoolean))
      {
        this.jdField_a_of_type_Bbyb.a().a(true);
        return;
      }
      if (i == 0)
      {
        this.jdField_a_of_type_Bbyb.a().a(false);
        return;
      }
    ...
    this.jdField_a_of_type_AndroidViewView.findViewById(2131373424).getLocationOnScreen(arrayOfInt);
    j = arrayOfInt[1];
    this.jdField_a_of_type_AndroidViewView.findViewById(2131370836).getLocationOnScreen(arrayOfInt);
    int k = arrayOfInt[1];
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.addView(this.jdField_a_of_type_Bbyb.a());
    if (QLog.isColorLevel()) {
      QLog.i(jdField_a_of_type_JavaLangString, 2, String.format(Locale.getDefault(), "miniHeight: %d", new Object[] { Integer.valueOf(i) }));
    }
    if (this.jdField_a_of_type_Bbya == null) {
      this.jdField_a_of_type_Bbya = new bbya(this.jdField_a_of_type_ComTencentWidgetScrollView, this.jdField_b_of_type_Int, null);
    }
    this.jdField_a_of_type_AndroidWidgetFrameLayout.addOnLayoutChangeListener(this.jdField_a_of_type_Bbya);
  }
  
  public void c()
  {
    if (jdField_a_of_type_Int == 1) {
      axqw.a(null, "new_reg", "setting_page_yes", "lianghao_clk", "", 1, "");
    }
    while (jdField_a_of_type_Int != 2) {
      return;
    }
    axqw.a(null, "new_reg", "setting_page_no", "lianghao_clk", "", 1, "");
  }
