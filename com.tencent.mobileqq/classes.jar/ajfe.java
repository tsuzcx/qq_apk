...
{
  public ajfe(TroopNotifyAndRecommendView paramTroopNotifyAndRecommendView) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (ajeq.a(i) == 0)
      {
        ...
        bfup.a(this.a.a(), (Bundle)localObject1, 2);
        if ((i == 2) || (i == 10) || (i == 12))
        {
          i = 1;
          label117:
    ...
    default: 
      ...
      label370:
      if (((anmw)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b((String)localObject1)) {
    ...
    for (;;)
    {
      ...
      bcst.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_contacts", "", "notice", "see_fromdata", 0, 0, ((ajeg)localObject2).jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.group_code.get() + "", "3", "", "");
      break;
