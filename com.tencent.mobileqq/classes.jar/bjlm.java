...
public class bjlm
{
  ...
  protected static HttpURLConnection a(bjln parambjln)
  {
    for (;;)
    {
      try
      {
        localObject1 = MsfSdkUtils.insertMtype("yingyongbao", parambjln.jdField_b_of_type_JavaLangString);
        if (bjkj.a(bizw.a().a()))
        {
          i = "http://".length();
          localObject3 = bjkj.c(bizw.a().a());
          String str = bjkj.d(bizw.a().a());
          j = ((String)localObject1).indexOf('/', i);
          if (j < 0)
          {
            localObject2 = ((String)localObject1).substring(i);
            localObject1 = "";
            bjko.c(jdField_a_of_type_JavaLangString, "https://" + (String)localObject3 + ":" + str + (String)localObject1);
            localObject3 = (HttpURLConnection)new URL("http://" + (String)localObject3 + ":" + str + (String)localObject1).openConnection();
            localObject1 = localObject3;
          }
        }
      }
      catch (Exception parambjln)
      {
        int j;
        Object localObject2;
        localObject3 = null;
        bjko.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- Exception!!!", parambjln);
      ...
      try
      {
        ...
        if (parambjln.jdField_c_of_type_Long > 0L)
        {
          ...
          localObject3 = localObject1;
          ((HttpURLConnection)localObject1).setRequestProperty("If-Modified-Since", ((SimpleDateFormat)localObject2).format(new Date(parambjln.jdField_c_of_type_Long)));
        }
        localObject3 = localObject1;
        i = ((HttpURLConnection)localObject1).getResponseCode();
        localObject3 = localObject1;
        bjko.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- reponseCode=" + i);
        if ((i == 302) || (i == 301))
        {
          localObject3 = localObject1;
          parambjln = ((HttpURLConnection)localObject1).getHeaderField("Location");
          localObject3 = localObject1;
          bjko.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- loc=" + parambjln);
          localObject3 = localObject1;
          a((HttpURLConnection)localObject1);
          parambjln = null;
          localObject1 = parambjln;
          bjko.c(jdField_a_of_type_JavaLangString, "--getHttpConnection-- uc=" + parambjln);
          return parambjln;
      ...
      if (localObject2 != null)
      {
        ...
        parambjln.jdField_a_of_type_Long = (a((HttpURLConnection)localObject2) * 1000L);
        localObject3 = localObject2;
      ...
      {
        localObject3 = localObject1;
        bjko.c(jdField_a_of_type_JavaLangString, "--getimg-- " + parambjln.jdField_b_of_type_JavaLangString + " not modified");
        localObject3 = localObject1;
        parambjln.jdField_a_of_type_Long = (a((HttpURLConnection)localObject1) * 1000L);
        localObject3 = localObject1;
        parambjln.jdField_b_of_type_Long = System.currentTimeMillis();
        localObject3 = localObject1;
        a((HttpURLConnection)localObject1);
  ...
  /* Error */
  public static boolean a(bjln parambjln)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 12
    ...
    //   7: istore 4
    //   9: aload_0
    //   10: invokestatic 276	bjlm:a	(Lbjln;)Ljava/net/HttpURLConnection;
    //   13: astore 7
    //   15: aload 7
    //   17: ifnonnull +88 -> 105
    //   20: getstatic 14	bjlm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   36: aload_0
    //   37: getfield 72	bjln:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   52: invokestatic 133	bjko:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   55: iconst_0
    //   56: ifeq +11 -> 67
    ...
    //   110: i2l
    //   111: lstore 5
    //   113: invokestatic 293	bjht:a	()J
    //   116: lload 5
    //   118: lcmp
    //   119: ifge +85 -> 204
    //   122: getstatic 14	bjlm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   138: aload_0
    //   139: getfield 72	bjln:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   154: invokestatic 133	bjko:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   157: iconst_0
    //   158: ifeq +11 -> 169
    ...
    //   211: lconst_0
    //   212: lstore 5
    //   214: getstatic 16	bjlm:jdField_a_of_type_Int	I
    //   217: newarray byte
    //   219: astore 9
    ...
    //   232: aload 9
    //   234: iconst_0
    //   235: getstatic 16	bjlm:jdField_a_of_type_Int	I
    //   238: invokevirtual 308	java/io/InputStream:read	([BII)I
    //   241: istore_1
    //   242: iload_1
    //   243: ifle +79 -> 322
    //   246: getstatic 19	bjlm:b	I
    //   249: istore_2
    //   250: lload 5
    //   252: iload_2
    //   253: i2l
    ...
    //   329: invokestatic 318	bjht:e	()Ljava/lang/String;
    ...
    //   341: aload_0
    //   342: getfield 323	bjln:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   354: aload_0
    //   355: getfield 72	bjln:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   358: invokestatic 332	bjkl:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   525: ldc_w 374
    //   528: aload_0
    //   529: getfield 375	bjln:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   532: invokestatic 133	bjko:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   535: aload_0
    //   536: aload 7
    //   538: invokevirtual 378	java/net/HttpURLConnection:getLastModified	()J
    //   541: putfield 171	bjln:jdField_c_of_type_Long	J
    //   544: iconst_1
    //   545: istore_3
    //   546: aload 9
    //   548: ifnull +8 -> 556
    ...
    //   596: aconst_null
    //   597: astore 8
    //   599: getstatic 14	bjlm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   602: ldc_w 381
    //   605: aload 9
    //   607: invokestatic 270	bjko:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   610: aload 10
    //   612: ifnull +17 -> 629
    //   615: aload 10
