...
public class mnf
{
  ...
  private LruCache<String, mnh> jdField_a_of_type_AndroidUtilLruCache = new mng(this, 4194304);
  private LinkedList<mni> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  private mni jdField_a_of_type_Mni;
  private byte[] jdField_a_of_type_ArrayOfByte;
  private byte[] b;
  
  public mnf(int paramInt)
  {
  ...
  public void a(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        mnh localmnh = (mnh)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
        if (localmnh != null)
        {
          this.jdField_a_of_type_Mni = new mni(localmnh, true);
          continue;
        }
        if (!QLog.isColorLevel()) {
          break label96;
      ...
      label96:
      a(paramString);
      paramString = (mnh)this.jdField_a_of_type_AndroidUtilLruCache.get(paramString);
      if (paramString != null) {
        this.jdField_a_of_type_Mni = new mni(paramString, true);
      }
    }
  }
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    try
    {
      ...
      mni localmni = this.jdField_a_of_type_Mni;
      if (localmni != null) {
        localmni.a(this.jdField_a_of_type_ArrayOfByte, 0, paramInt);
      }
      Arrays.fill(this.b, (byte)0);
      if ((this.jdField_a_of_type_JavaUtilLinkedList.size() > 0) && (i < paramInt))
      {
        localmni = (mni)this.jdField_a_of_type_JavaUtilLinkedList.get(0);
        if (localmni != null)
        {
          int j = i + localmni.a(this.b, i, paramInt);
          i = j;
          if (!localmni.a()) {
            break label229;
          }
      ...
      {
        mnj.a(paramArrayOfByte, this.jdField_a_of_type_ArrayOfByte, this.b, paramInt);
        return;
      }
    }
    finally {}
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      if (arrayOfByte != null)
      {
        localObject = new mnh(paramString, arrayOfByte);
  ...
  public void b(String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        if (localmnh != null)
        {
          paramString = new mni(localmnh, false);
      ...
      if (paramString != null)
      {
        paramString = new mni(paramString, false);
        this.jdField_a_of_type_JavaUtilLinkedList.add(paramString);
      }
    }
  }
