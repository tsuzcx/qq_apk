...
public class azru
{
  ...
  public CharSequence a(armp paramarmp)
  {
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder();
    Object localObject = paramarmp.a().jdField_a_of_type_JavaUtilArrayList;
    localSpannableStringBuilder.append(paramarmp.a().jdField_a_of_type_JavaLangString);
    int i = 0;
    while (i < ((ArrayList)localObject).size()) {
      if (TextUtils.isEmpty(((armr)((ArrayList)localObject).get(i)).jdField_a_of_type_JavaLangString))
      {
        i += 1;
      }
      else
      {
        ...
        paramarmp = ((armr)((ArrayList)localObject).get(i)).jdField_a_of_type_JavaLangString;
        localObject = new ForegroundColorSpan(Color.parseColor("#4D94FF"));
        localSpannableStringBuilder.append(paramarmp);
        localSpannableStringBuilder.setSpan(localObject, j, paramarmp.length() + j, 33);
      }
    }
  ...
  {
    long l = aqxe.a().a(529, paramQQAppInterface.getCurrentAccountUin());
  ...
  {
    boolean bool = false;
    if (aqxe.a().a(529, paramQQAppInterface.getCurrentAccountUin()) > paramQQAppInterface.getApp().getSharedPreferences(paramQQAppInterface.getCurrentAccountUin(), 0).getLong("recommend_topic_version", -1L)) {
      bool = true;
    }
    return bool;
  }
