...
public class azru
{
  public static long a(String paramString)
  {
    ...
    {
      azpw.b("compress.Utils", "getFileSize()", "path is empty, or file does not exist. path:" + paramString);
      return 0L;
    }
  ...
  public static Bitmap a(Bitmap paramBitmap)
  {
    ...
    azpw.a("compress.Utils", "compositingWhiteBg()", "compositingWhiteBg is success");
    return paramBitmap;
  }
  ...
  public static ThumbWidthHeightDP a(ThumbWidthHeightDP paramThumbWidthHeightDP, int paramInt)
  {
    ...
    {
      paramInt = Math.max(j, besm.b(bool1));
      break;
      bool1 = false;
      break label69;
      bool1 = false;
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (bhmi.a(paramString)))
    {
      String str2 = bfcj.a(antf.ba + "thumb/");
    ...
    azpw.a("compress.Utils", "getThumbnailPath()", "realpath is empty, or file does not exist, realpath:" + paramString);
    return "";
  }
  
  public static String a(String paramString, int paramInt)
  {
    if ((!TextUtils.isEmpty(paramString)) && (bhmi.a(paramString)) && (azrn.a(paramInt)))
    {
      int i = paramString.lastIndexOf("/");
      int j = paramString.lastIndexOf(".");
      Object localObject;
    ...
    azpw.a("compress.Utils", "getSendPhotoPath()", "realpath is empty, or file does not exist, or picQuality Illegal realpath:" + paramString + " picQuality:" + paramInt);
    return "";
  }
  ...
  public static void a(Context paramContext, List<CompressInfo> paramList)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        QQToast.a(paramContext, paramList, 0).b(paramContext.getResources().getDimensionPixelSize(2131299011));
        return;
        j = 0;
        break;
        break label168;
  ...
  {
    return bhnv.b(BaseApplication.getContext()) == 1;
  }
  ...
  public static boolean a(Bitmap paramBitmap, boolean paramBoolean, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, ThumbWidthHeightDP paramThumbWidthHeightDP)
  {
    ...
    if (paramBoolean) {}
    for (int i = beyq.a(paramString1);; i = 0)
    {
      azpw.a("compress.Utils", paramString3, paramString4 + " ClipStrategy begin  thumbSizeMax：" + j + " thumbSizeMin:" + k + " degree:" + i);
      if ((paramThumbWidthHeightDP != null) && (paramThumbWidthHeightDP.mLimitSizeByServer))
      {
        ...
        azpw.a("compress.Utils", paramString3, paramString4 + " ClipStrategy fail");
        paramBoolean = bool;
      }
      label213:
      do
      {
        return paramBoolean;
        paramString1 = new azrl(j, k, i);
        paramBitmap = paramString1.a(paramBitmap);
        azpw.a("compress.Utils", paramString3, " needCut:" + paramString1.jdField_b_of_type_Boolean + " needScale:" + paramString1.c);
        break;
        azpw.a("compress.Utils", paramString3, paramString4 + " ClipStrategy suc  destWidth：" + paramBitmap.getWidth() + " destHeight:" + paramBitmap.getHeight());
        paramBitmap = a(paramBitmap);
        if (paramInt == 3)
        {
          paramBoolean = a(paramBitmap);
          azpw.a("compress.Utils", paramString3, paramString4 + " isDrawGIFSucc：" + paramBoolean);
        }
  ...
  private static boolean a(BitmapFactory.Options paramOptions, int paramInt)
  {
    ...
    {
      azpw.b("compress.Utils", "calculateInSampleSizeThumbnail()", "options is null");
      return false;
    }
    ...
    if ((m == 0) || (n == 0))
    {
      azpw.b("compress.Utils", "calculateInSampleSizeThumbnail()", "width == 0 || height ==0");
      return false;
    }
    int j = n;
    int k = m;
    ...
    for (paramInt = paramOptions.inSampleSize;; paramInt = 1)
    {
      ...
      azpw.a("compress.Utils", "calculateInSampleSizeThumbnail()", "options.inSampleSize=" + paramOptions.inSampleSize + " srcWidth:" + m + " srcHeight:" + n);
      return true;
      i *= 2;
      break;
    }
  ...
  public static boolean a(BitmapFactory.Options paramOptions, String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      azpw.b("compress.Utils", "calculateInSampleSize()", "options == null || TextUtils.isEmpty(filepath)");
      return false;
    }
    ...
    bhmq.a(paramString, paramOptions);
    ...
    for (paramInt1 = paramOptions.inSampleSize;; paramInt1 = 1)
    {
      ...
      azpw.a("compress.Utils", "calculateInSampleSize()", "options.inSampleSize=" + paramOptions.inSampleSize);
      return true;
      break;
    }
  }
  ...
  private static boolean a(JpegOptions paramJpegOptions, int paramInt)
  {
    ...
    for (paramInt = paramJpegOptions.inSampleSize;; paramInt = 1)
    {
      ...
      azpw.a("compress.Utils", "calculateInSampleSizeThumbnail()", "options.inSampleSize=" + paramJpegOptions.inSampleSize + " srcWidth:" + m + " srcHeight:" + n);
      return true;
      i *= 2;
      break;
    }
  ...
  public static boolean a(String paramString1, String paramString2, boolean paramBoolean, String paramString3, int paramInt, ThumbWidthHeightDP paramThumbWidthHeightDP)
  {
    ...
    {
      azpw.b("compress.Utils", "compressAIOThumbnail", paramString3 + " infilePath is empty, or outfilePath is empty, or file does not exist. infilePath:" + paramString1 + " outfilePath:" + paramString2);
      return false;
    }
    azpw.a("compress.Utils", "compressAIOThumbnail", paramString3);
    BitmapFactory.Options localOptions = new BitmapFactory.Options();
    localOptions.inJustDecodeBounds = true;
    bhmq.a(paramString1, localOptions);
    if (!a(localOptions, a(paramThumbWidthHeightDP, paramInt).mMaxWidth))
    {
      azpw.b("compress.Utils", "compressAIOThumbnail", paramString3 + " calculateInSampleSize fail");
      return false;
    }
    try
    {
      ...
      {
        azpw.b("compress.Utils", "compressAIOThumbnail", paramString3 + " bm == null, maybe is broken");
        return false;
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      localOutOfMemoryError.printStackTrace();
      azpw.b("compress.Utils", "compressAIOThumbnail", paramString3 + " decodeFile OutOfMemoryError");
      localOptions.inSampleSize *= 2;
      try
      {
        Bitmap localBitmap2 = bhmq.a(paramString1, localOptions);
        int i = localBitmap2.getWidth();
        int j = localBitmap2.getHeight();
        azpw.a("compress.Utils", "compressAIOThumbnail", paramString3 + " sample after W:" + i + " H:" + j);
      ...
      catch (OutOfMemoryError paramString1)
      {
        ...
        azpw.b("compress.Utils", "compressAIOThumbnail", paramString3 + " decodeFile OutOfMemoryError, op.inSampleSize:" + localOptions.inSampleSize);
      }
    }
    return false;
  }
  ...
  public static boolean b(String paramString)
  {
    ...
    {
      bool1 = bool3;
      if (!bhmi.b(paramString).equals("jpg")) {}
    }
    try
    {
      ...
      azpw.a("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality = " + f + ",picSize = " + l + "result = " + bool1);
      return bool1;
    }
    catch (RuntimeException paramString)
    {
      azpw.b("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality RuntimeException error = " + paramString + ",return false!");
      return false;
    }
    catch (OutOfMemoryError paramString)
    {
      azpw.b("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality OutOfMemoryError error = " + paramString + ",return false!");
    }
    return false;
  }
  ...
  private static boolean b(String paramString1, Bitmap paramBitmap, int paramInt, String paramString2, CompressInfo paramCompressInfo)
  {
    ...
    {
      azpw.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " TextUtils.isEmpty(destPath) || bm == null || quality > 100 || quality <= 0");
      return false;
    }
    azpw.a("compress.Utils", "compressQualityWithProgressive()", paramString2 + " quality:" + paramInt);
    ...
    try
    {
      ...
      localObject = new JpegCompressor(new azrv((File)localObject, paramCompressInfo));
      ((JpegCompressor)localObject).setParams(paramInt, true, true, false);
      try
      {
        bhnn.a();
        ((JpegCompressor)localObject).compress(paramBitmap);
        bhnn.a("peak_pgjpeg", "pgjpeg " + paramBitmap.getWidth() + "x" + paramBitmap.getHeight() + " compress");
        azpw.a("compress.Utils", "compressQualityWithProgressive()", paramString2 + " quality:" + paramInt);
        return true;
      }
    ...
    {
      azpw.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " FileOutputStream FileNotFoundException");
      paramString1.printStackTrace();
      return false;
    }
    catch (IOException paramString1)
    {
      azpw.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " createNewFile IOException");
      paramString1.printStackTrace();
    }
  }
  ...
  public static boolean b(String paramString1, String paramString2, boolean paramBoolean, String paramString3, int paramInt)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (!bhmi.b(paramString1)))
    {
      azpw.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " infilePath is empty, or outfilePath is empty, or file does not exist. infilePath:" + paramString1 + " outfilePath:" + paramString2);
      return false;
    }
    azpw.a("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3);
    ...
    {
      azpw.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " calculateInSampleSize fail");
      return false;
    }
    try
    {
      ...
      if (localBitmap3 == null)
      {
        azpw.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " bm == null, maybe is broken");
        return false;
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      localOutOfMemoryError.printStackTrace();
      azpw.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " decodeFile OutOfMemoryError");
      ...
      try
      {
        ...
        int i = localBitmap2.getWidth();
        int j = localBitmap2.getHeight();
        azpw.a("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " sample after W:" + i + " H:" + j);
        return a(localBitmap2, paramBoolean, paramString1, paramString2, "compressAIOThumbnailWithTrubo", paramString3, paramInt, null);
      }
      catch (OutOfMemoryError paramString1)
      {
        paramString1.printStackTrace();
        azpw.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " decodeFile OutOfMemoryError, op.inSampleSize:" + localJpegOptions.inSampleSize);
      }
    }
    return false;
  }
  ...
  private static boolean c(String paramString1, Bitmap paramBitmap, int paramInt, String paramString2, CompressInfo paramCompressInfo)
  {
    ...
    //   49: invokestatic 43	azpw:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   52: iconst_0
    //   53: istore 5
    //   55: iload 5
    //   57: ireturn
    ...
    //   87: invokestatic 115	azpw:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   98: astore 6
    //   100: aload 6
    //   102: invokevirtual 310	java/io/File:exists	()Z
    //   105: ifeq +9 -> 114
    //   108: aload 6
    //   110: invokevirtual 661	java/io/File:delete	()Z
    //   113: pop
    //   114: aload_0
    //   115: invokestatic 721	bhmi:a	(Ljava/lang/String;)Ljava/io/File;
    //   118: pop
    //   119: new 723	java/io/FileOutputStream
    //   122: dup
    //   123: aload 6
    //   125: invokespecial 726	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   128: astore 8
    //   130: new 728	java/io/BufferedOutputStream
    //   133: dup
    //   134: aload 8
    //   136: invokespecial 731	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   139: astore 7
    //   141: aload 7
    //   143: astore 6
    //   145: aload_1
    //   146: getstatic 737	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   149: iload_2
    //   150: aload 7
    //   152: invokevirtual 740	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   155: pop
    //   156: aload 7
    //   158: astore 6
    //   160: aload 7
    //   162: invokevirtual 743	java/io/BufferedOutputStream:flush	()V
    //   165: aload 7
    //   167: astore 6
    //   169: aload 8
    //   171: invokevirtual 747	java/io/FileOutputStream:getFD	()Ljava/io/FileDescriptor;
    //   174: astore_1
    //   175: aload_1
    //   176: ifnull +22 -> 198
    //   179: aload 7
    //   181: astore 6
    //   183: aload_1
    //   184: invokevirtual 752	java/io/FileDescriptor:valid	()Z
    //   187: ifeq +11 -> 198
    //   190: aload 7
    //   192: astore 6
    //   194: aload_1
    //   195: invokevirtual 755	java/io/FileDescriptor:sync	()V
    //   198: aload 7
    //   200: ifnull +8 -> 208
    //   203: aload 7
    //   205: invokevirtual 758	java/io/BufferedOutputStream:close	()V
    //   208: aload_0
    //   209: invokestatic 18	bhmi:b	(Ljava/lang/String;)Z
    //   212: ifne -157 -> 55
    //   215: ldc 20
    //   217: ldc_w 718
    ...
    //   240: invokestatic 43	azpw:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   243: iconst_0
    //   244: ireturn
    //   245: astore_1
    //   246: aload 4
    ...
    //   255: aload 4
    //   257: iconst_1
    //   258: invokevirtual 763	com/tencent/mobileqq/pic/CompressInfo:b	(Z)V
    //   261: aload 7
    //   263: astore 6
    //   265: ldc 20
    //   267: ldc_w 718
    //   270: ldc_w 765
    //   273: invokestatic 43	azpw:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   276: goto -78 -> 198
    //   279: astore_0
    //   280: aload 7
    //   282: astore 6
    ...
    //   309: invokestatic 43	azpw:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   312: aload 7
    //   314: astore 6
    //   316: aload_0
    //   317: invokevirtual 700	java/io/FileNotFoundException:printStackTrace	()V
    //   320: aload 7
    //   322: ifnull +8 -> 330
    //   325: aload 7
    //   327: invokevirtual 758	java/io/BufferedOutputStream:close	()V
    //   330: iconst_0
    //   331: ireturn
    //   332: astore_1
    //   333: aload 4
    ...
    //   342: aload 4
    //   344: iconst_1
    //   345: invokevirtual 763	com/tencent/mobileqq/pic/CompressInfo:b	(Z)V
    //   348: aload 7
    //   350: astore 6
    //   352: ldc 20
    //   354: ldc_w 718
    //   357: ldc_w 767
    //   360: invokestatic 43	azpw:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   363: goto -165 -> 198
    //   366: astore_0
    //   367: aload 7
    //   369: astore 6
    ...
    //   396: invokestatic 43	azpw:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   399: aload 7
    //   401: astore 6
    //   403: aload_0
    //   404: invokevirtual 770	java/lang/Exception:printStackTrace	()V
    //   407: aload 7
    //   409: ifnull +8 -> 417
    //   412: aload 7
    //   414: invokevirtual 758	java/io/BufferedOutputStream:close	()V
    //   417: iconst_0
    //   418: ireturn
    //   419: astore_1
    //   420: aload_1
    //   421: invokevirtual 703	java/io/IOException:printStackTrace	()V
    //   424: goto -216 -> 208
    //   427: astore_0
    //   428: aload_0
    //   429: invokevirtual 703	java/io/IOException:printStackTrace	()V
    //   432: goto -102 -> 330
    //   435: astore_0
    //   436: aload_0
    //   437: invokevirtual 703	java/io/IOException:printStackTrace	()V
    //   440: goto -23 -> 417
    //   443: astore_0
    //   444: aconst_null
    //   445: astore 6
    ...
    //   449: ifnull +8 -> 457
    //   452: aload 6
    //   454: invokevirtual 758	java/io/BufferedOutputStream:close	()V
    //   457: aload_0
    //   458: athrow
    //   459: astore_1
    //   460: aload_1
    //   461: invokevirtual 703	java/io/IOException:printStackTrace	()V
    //   464: goto -7 -> 457
    //   467: astore_0
    //   468: goto -21 -> 447
    //   471: astore_0
