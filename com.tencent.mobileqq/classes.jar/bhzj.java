  ...
  public void a()
  {
    try
    {
      ...
      if ((localAppRuntime instanceof QQAppInterface)) {
        ((VasQuickUpdateManager)localAppRuntime.getManager(QQManagerFactory.VAS_QUICKUPDATE_MANAGER)).downloadItem(1004L, "kcsdk_4_4_7_3661", "KC.TMSManager");
      }
      return;
    }
    finally
  ...
  public void a(Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramContext = bhzh.a().b(paramContext);
        if (bhiw.a(paramContext, str, "kcsdk_4.4.7.3661.jar"))
        {
