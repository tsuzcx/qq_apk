...
public final class ztw
  implements Runnable
{
  public ztw(RichStatus paramRichStatus, QQAppInterface paramQQAppInterface, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        long l2 = l1 - ((RichStatus)localObject3).time;
        ...
        localObject4 = MessageRecordFactory.a(-1034);
      }
      catch (Exception localException)
      {
        ...
        l2 = ((RichStatus)localObject3).time;
