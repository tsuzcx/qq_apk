...
{
  private static baon jdField_a_of_type_Baon;
  ...
  private baon(String paramString)
  {
    super(paramString);
  }
  
  public static baon a()
  {
    try
    {
      if (jdField_a_of_type_Baon == null) {
        jdField_a_of_type_Baon = new baon("VasApngIPCModule");
      }
      baon localbaon = jdField_a_of_type_Baon;
      return localbaon;
    }
    finally {}
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (bajo.a(str2, str1, "libAPNG_release_813.so"))
      {
  ...
  public void a(URLDrawableHandler paramURLDrawableHandler, boolean paramBoolean)
  {
    ...
    QIPCClientHelper.getInstance().callServer("VasApngIPCModule", jdField_a_of_type_JavaLangString, null, new baoo(this, paramURLDrawableHandler));
  }
