  ...
  implements Manager
{
  ...
  private agtb jdField_a_of_type_Agtb;
  private agtd jdField_a_of_type_Agtd;
  private agtq jdField_a_of_type_Agtq;
  private volatile agtx jdField_a_of_type_Agtx;
  ...
  private List<agtv> jdField_a_of_type_JavaUtilList;
  ...
  public agtk(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), new agtl(this));
    this.jdField_a_of_type_Agtb = ((agtb)paramQQAppInterface.getManager(341));
    this.jdField_a_of_type_Agtd = ((agtd)paramQQAppInterface.getManager(343));
  ...
  {
    return agtw.a(paramString, paramBoolean);
  }
  ...
  private SpringFestivalRedpacketConfBean.TimeInfo a(long paramLong)
  {
    ...
    Collections.sort(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo.entryShowTime, new agtp(this));
  ...
  private String a()
  {
    ...
    {
      str1 = str2;
      if (!baip.a(localActivityInfo.videoUrl)) {
  ...
  private void a(long paramLong)
  {
    if (QLog.isColorLevel())
    {
      QLog.i("springHb_SpringEntryManager", 2, "runCurrentTask. isPeedUp: " + i() + " currentTime is: " + baiu.b(paramLong) + " taskSize:" + this.jdField_a_of_type_JavaUtilList.size());
      localObject = this.jdField_a_of_type_JavaUtilList.iterator();
      while (((Iterator)localObject).hasNext())
      {
        agtv localagtv = (agtv)((Iterator)localObject).next();
        QLog.w("springHb_SpringEntryManager", 2, "runCurrentTask current task is: " + localagtv.a() + ": time is" + agsy.a(localagtv.jdField_a_of_type_Long));
      }
    }
    ...
    while (((Iterator)localObject).hasNext()) {
      if (agsy.a((SpringFestivalRedpacketConfBean.TimeInfo)((Iterator)localObject).next(), paramLong)) {
  ...
  {
    QLog.i("springHb_SpringEntryManager", 2, "handleTaskMsg isSpeedUp: " + i() + " currentTime is: " + baiu.b(b()));
    if (paramMessage.arg1 != 1)
    {
      paramMessage = (agtv)this.jdField_a_of_type_JavaUtilList.remove(0);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("springHb_SpringEntryManager", 2, "onTaskNeed2Execute -->entryId:" + paramString + ",action:" + agtv.a(paramInt));
    }
    long l = b();
    switch (paramInt)
    {
    ...
    case 4001: 
      ...
      do
      {
        ...
        if ((!baip.a(paramString)) && (!paramString.equals(this.jdField_a_of_type_JavaLangString)))
        {
        ...
        {
          if (!agsy.a(paramBannerInfo.soonTime, l)) {
            break label394;
          }
        ...
        for (;;)
        {
          ...
          return;
          if (agsy.a(paramBannerInfo.bannerTime, l)) {
  ...
  private Bitmap b()
  {
    try
    {
      ...
      if (!baip.a((String)localObject1))
      {
        ...
        if ((!baip.a((String)localObject2)) && (new File((String)localObject2).exists())) {
          break label142;
        }
        localObject2 = new DownloadParam();
        ((DownloadParam)localObject2).filePos = 0;
        ((DownloadParam)localObject2).url = ((String)localObject1);
        PreloadManager.a().a((DownloadParam)localObject2, new agtm(this));
      }
      for (;;)
      {
        if (this.jdField_a_of_type_AndroidGraphicsBitmap == null)
        {
          this.jdField_a_of_type_AndroidGraphicsBitmap = bacm.b(BaseApplicationImpl.getContext().getResources().getDrawable(2130846170));
  ...
  private DesktopDataManager.HongBaoResBuilder b()
  {
    ...
    localHongBaoResBuilder.setTextColor(Color.parseColor("#FFFFFF")).setSearchTitleColor(Color.parseColor("#FFFFFF")).setCapsuleLeftNormalResId(2130846366).setCapsuleLeftPressResId(2130846356).setCapsuleRightNormalResId(2130846365).setCapsuleRightPressResId(2130846355).setMoveUpGuideIconResId(2130846368).setModuleMoreIconResId(2130846367).setSearchBackgroundResId(2130846363).setSearchIconResId(2130846364).setMoveUpGuideBgIconResId(2131100804).setFullScreenRefreshBgColor(Color.parseColor("#CE5068")).setRefreshProgressResId(2130839115).setRefreshTextColor(Color.parseColor("#FFFFFF")).setBackgroundUrl(b()).setBackgroundResId(2130846170).setBackgroundLoadingResId(2130849317).setBackgroundFailedResId(2130846170).setRefreshArrowColor(1);
  ...
  private String b()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("springHb_SpringEntryManager", 2, "getMiniSkinUrl -->" + str1 + " SpringHbHelper.mEntryMode:" + agtw.jdField_a_of_type_Int);
    }
    return str1;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("springHb_SpringEntryManager", 2, "updatePartyState....oldState:" + agtu.a(this.jdField_a_of_type_Int) + ",currentState:" + agtu.a(paramInt));
    }
  ...
  private void b(long paramLong)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        if (i >= 0)
        {
          if (((agtv)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_Long <= paramLong) {
  ...
  private void b(SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo paramSpringFestivalHbEntryInfo)
  {
    ...
    if (!baip.a(paramSpringFestivalHbEntryInfo))
    {
  ...
  private void g()
  {
    try
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo.pendantEntryInfo != null) && (!a(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo.pendantEntryInfo.activityList)) && (this.jdField_a_of_type_Agtd != null))
      {
        ...
        while (localIterator.hasNext()) {
          if (!agsy.a(((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.ActivityInfo)localIterator.next()).activityTime))
          {
            if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        if ((localFixedEntryInfo != null) && (!a(localFixedEntryInfo.entryBannerList)))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if (!agsy.a(((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.PendantEntryInfo.BannerInfo)localObject3).bannerTime))
            {
              if (QLog.isColorLevel()) {
          ...
          Collections.sort(localFixedEntryInfo.entryBannerList, new agtn(this));
  ...
  private void i()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Agtd != null)
        {
          localSpringFestivalRedpakcetPreviewConfBean = this.jdField_a_of_type_Agtd.a();
  ...
  private void j()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 104	agtk:jdField_a_of_type_Agtd	Lagtd;
    //   6: ifnull +30 -> 36
    //   9: aload_0
    //   10: getfield 104	agtk:jdField_a_of_type_Agtd	Lagtd;
    //   13: invokevirtual 828	agtd:a	()Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/config/SpringFestivalRedpakcetPreviewConfBean;
    //   16: astore_1
    //   17: aload_1
    //   18: ifnonnull +21 -> 39
    ...
    //   39: aload_0
    //   40: aload_1
    //   41: invokespecial 838	agtk:a	(Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/config/SpringFestivalRedpakcetPreviewConfBean;)V
    //   44: goto -8 -> 36
    //   47: astore_1
    //   48: aload_0
    //   49: monitorexit
  ...
  private boolean j()
  {
    boolean bool = agtw.jdField_b_of_type_Boolean;
    if (QLog.isColorLevel()) {
  ...
  private void k()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((agsy.a(((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.ActivityInfo)localObject).activityTime)) && (agsy.a(((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.ActivityInfo)localObject).activityTime, ((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.ActivityInfo)localObject).pendantEndTime)))
        {
          localLinkedList.add(new agtv(2001, ((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.ActivityInfo)localObject).activityTime.beginTime + a(), ((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.ActivityInfo)localObject).id));
          localLinkedList.add(new agtv(2002, ((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.ActivityInfo)localObject).pendantEndTime, ((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.ActivityInfo)localObject).id));
          continue;
        }
        if (!QLog.isColorLevel()) {
          continue;
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localObject != null) && (((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.PendantEntryInfo.BannerInfo)localObject).soonTime != null) && (((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.PendantEntryInfo.BannerInfo)localObject).bannerTime != null)) {
        if ((agsy.a(((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.PendantEntryInfo.BannerInfo)localObject).bannerTime)) && (agsy.a(((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.PendantEntryInfo.BannerInfo)localObject).soonTime)) && (((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.PendantEntryInfo.BannerInfo)localObject).soonTime.endTime < ((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.PendantEntryInfo.BannerInfo)localObject).bannerTime.beginTime))
        {
          localList.add(new agtv(3001, ((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.PendantEntryInfo.BannerInfo)localObject).soonTime.beginTime, ""));
          localList.add(new agtv(3001, ((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.PendantEntryInfo.BannerInfo)localObject).bannerTime.beginTime, ""));
          localList.add(new agtv(3002, ((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.PendantEntryInfo.BannerInfo)localObject).bannerTime.endTime, ""));
        }
    ...
    if (!a(localList))
    {
      Collections.sort(localList, new agto(this));
  ...
  private void l()
  {
    ...
    //   11: aload_0
    //   12: invokevirtual 227	agtk:b	()J
    //   15: lstore_1
    //   16: aload_0
    //   17: lload_1
    //   18: invokespecial 897	agtk:a	(J)V
    //   21: aload_0
    //   22: lload_1
    //   23: invokespecial 899	agtk:b	(J)V
    //   26: aload_0
    //   27: invokespecial 371	agtk:m	()V
    //   30: aload_0
    //   31: monitorexit
    //   32: return
    //   33: astore_3
  ...
  private void m()
  {
    ...
    try
    {
      ...
      {
        return;
        agtv localagtv = (agtv)this.jdField_a_of_type_JavaUtilList.get(0);
        l2 = localagtv.jdField_a_of_type_Long - b();
        if (l2 >= -300000L) {
          break;
        }
        l();
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        localObject2 = (agtv)localIterator.next();
        QLog.i("springHb_SpringEntryManager", 2, "scheduleNextTask current task is: " + ((agtv)localObject2).a() + ": time is" + agsy.a(((agtv)localObject2).jdField_a_of_type_Long));
      }
      break;
      label316:
      if (!QLog.isColorLevel()) {
  ...
  private void q()
  {
    try
    {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo == null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo = this.jdField_a_of_type_Agtd.a();
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo != null) {
  ...
  public int a()
  {
    if (this.jdField_c_of_type_Int == 0) {
      this.jdField_c_of_type_Int = ((int)((bajq.a() - bajq.b(18.0F) * 2) * 0.412D));
    }
  ...
  public long a()
  {
    ...
    {
      return l1;
      agtd localagtd = this.jdField_a_of_type_Agtd;
      if (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo != null) {
  ...
  public agtt a()
  {
    agtt localagtt = new agtt();
    SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.ActivityInfo localActivityInfo = a(b());
    if (localActivityInfo != null)
    {
      localagtt.b = localActivityInfo.resUrl;
      localagtt.c = localActivityInfo.logoUrl;
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo.pendantEntryInfo != null)) {
      localagtt.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo.pendantEntryInfo.defaultResUrl;
    }
    if (QLog.isColorLevel()) {
      QLog.i("springHb_SpringEntryManager", 2, "getDrumResInfo -- >" + localagtt + ",mCurrentActivityInfo:" + localActivityInfo);
    }
    return localagtt;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("springHb_SpringEntryManager", 2, "getTransitionBitmap..." + this.jdField_a_of_type_AndroidGraphicsBitmap + ",mEntryMode:" + agtw.jdField_a_of_type_Int + ",mLoadBgDefault：" + this.jdField_c_of_type_Boolean);
    }
    if (agtw.jdField_a_of_type_Int == 3) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (i < j)
        {
          ...
          boolean bool = agsy.a(((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.ActivityInfo)localObject1).activityTime, paramLong);
          if (!bool) {
            i += 1;
          }
        }
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          bool = agsy.a(localTimeInfo, paramLong);
          if (!bool) {}
        }
        else
        {
  ...
  public SpringFestivalRedpakcetPreviewConfBean.BreathLight a(long paramLong)
  {
    for (;;)
    {
      try
      {
        ArrayList localArrayList = this.jdField_a_of_type_Agtd.a().jdField_b_of_type_JavaUtilArrayList;
        ...
        boolean bool = agsy.a(localBreathLight.breathTimeInfo, paramLong);
        if (!bool) {
          continue;
        }
      }
  ...
  public SpringFestivalRedpakcetPreviewConfBean.PreviewInfo a(long paramLong)
  {
    for (;;)
    {
      try
      {
        ArrayList localArrayList = this.jdField_a_of_type_Agtd.a().jdField_a_of_type_JavaUtilArrayList;
        if (localArrayList == null) {
          continue;
        }
        i = 0;
        ...
        boolean bool = agsy.a(localPreviewInfo.prewTimeInfo, paramLong);
        if (!bool) {
          continue;
        }
      }
  ...
  public String a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        str2 = str1;
        if (!baip.a(localBannerInfo.previewActivityUrl)) {
  ...
  public void a()
  {
    QLog.i("springHb_SpringEntryManager", 2, "onConversationFragmentResume partyStatus is: " + agtu.a(this.jdField_a_of_type_Int) + ",mCallback:" + this.jdField_a_of_type_Agtx);
    if (this.jdField_a_of_type_Agtx == null) {}
    do
    {
      return;
      if (j()) {
        agvs.a("sq.dz", 0, 0, null);
      }
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo.fixedEntryInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo.fixedEntryInfo.useStagger == 1))
        {
          ...
          if (localObject1 != null)
          {
            ...
            if (localObject2 != null)
            {
              ...
              long l3 = a();
              if (QLog.isColorLevel()) {
                QLog.i("springHb_SpringEntryManager", 2, "notifyMiniBannerClick...type:" + paramInt + ",mCallbackProxy:" + this.jdField_a_of_type_Agtx + ",manager:" + this + ",beginTime:" + baiu.b(l2) + ",delayTime:" + l3 + "currentTime:" + baiu.b(l1) + ",activityId:" + ((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.ActivityInfo)localObject1).id + "staggerPeakIntervalBefore:" + this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo.fixedEntryInfo.staggerPeakIntervalBefore);
              }
              if ((l2 - this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo.fixedEntryInfo.staggerPeakIntervalBefore < l1) && (l1 < l2 + l3))
              {
                ...
                if (localObject1 != null)
                {
                  ...
                  if (localObject2 != null)
                  {
                    try
                    {
                      localObject1 = new aguj(BaseActivity.sTopActivity).a(((SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo.PendantEntryInfo.BannerInfo)localObject1).popUpBgUrl, l1, l2 + l3);
                      QLog.e("springHb_SpringEntryManager", 1, localThrowable2, new Object[0]);
                    }
                    catch (Throwable localThrowable2)
                    {
      ...
      catch (Throwable localThrowable1)
      {
        ...
        QLog.e("springHb_SpringEntryManager", 1, "notifyMiniBannerClick... failed, type:" + paramInt + ",mCallbackProxy:" + this.jdField_a_of_type_Agtx + ",manager:" + this);
        continue;
      }
      if (this.jdField_a_of_type_Agtx == null) {
        break;
      }
      this.jdField_a_of_type_Agtx.a(paramInt);
    } while (!QLog.isColorLevel());
    QLog.i("springHb_SpringEntryManager", 2, "notifyMiniBannerClick... success, type:" + paramInt + ",mCallbackProxy:" + this.jdField_a_of_type_Agtx + ",manager:" + this);
  }
  ...
  public void a(agtx paramagtx)
  {
    ...
    //   4: return
    //   5: aload_0
    //   6: getfield 35	agtk:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   9: astore_2
    //   10: aload_2
    //   11: monitorenter
    //   12: aload_0
    ...
    //   16: dup
    //   17: aload_1
    //   18: invokespecial 1127	agtq:<init>	(Lagtx;)V
    //   21: putfield 1129	agtk:jdField_a_of_type_Agtq	Lagtq;
    //   24: aload_0
    //   25: ldc_w 1116
    ...
    //   38: aload_0
    //   39: getfield 1129	agtk:jdField_a_of_type_Agtq	Lagtq;
    ...
    //   45: checkcast 1116	agtx
    //   48: putfield 165	agtk:jdField_a_of_type_Agtx	Lagtx;
    //   51: aload_2
    //   52: monitorexit
    //   53: aload_0
    //   54: invokespecial 1151	agtk:p	()V
    //   57: ldc 253
    //   59: iconst_2
    ...
    //   83: aload_0
    //   84: getfield 165	agtk:jdField_a_of_type_Agtx	Lagtx;
  ...
  public void a(ViewGroup paramViewGroup, boolean paramBoolean)
  {
    try
    {
      if ((this.jdField_a_of_type_Agtx != null) && (this.jdField_a_of_type_Int == 2))
      {
        ...
        {
          localObject = str1;
          if (!baip.a(localActivityInfo.id)) {
            localObject = localActivityInfo.id;
          }
        }
        this.jdField_a_of_type_Agtx.a(paramViewGroup, localBitmap, str2, (String)localObject, str3, "");
        if (!QLog.isColorLevel()) {
          return;
        }
    ...
    QLog.i("springHb_SpringEntryManager", 1, "mCallbackProxy is null or not in party，mPartyStatus：" + agtu.a(this.jdField_a_of_type_Int));
  }
  ...
  public void a(SpringFestivalRedpacketConfBean.SpringFestivalHbEntryInfo paramSpringFestivalHbEntryInfo)
  {
    for (;;)
    {
      ...
      if (agtw.jdField_a_of_type_Int == 0)
      {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((paramMiniAppPullInterface instanceof QQMessagePageMiniAppEntryManager)) {
          agtw.jdField_a_of_type_Int = 3;
        } else {
          agtw.jdField_a_of_type_Int = 1;
        }
      }
  ...
  public boolean a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localActivityInfo != null) && (a(localActivityInfo.activityTime)) && ((agsy.a(l, localActivityInfo.activityTime.beginTime)) || (agsy.a(l, localActivityInfo.activityTime.endTime)))) {
        return true;
      }
    }
    return false;
  ...
  public boolean a(long paramLong)
  {
    ...
    do
    {
      ...
      {
        return false;
        localObject1 = this.jdField_a_of_type_Agtd.a();
        if (localObject1 != null) {
          break;
        }
      } while (!QLog.isColorLevel());
    ...
    if (((Iterator)localObject1).hasNext())
    {
      ...
      if (agsy.a(((SpringFestivalRedpakcetPreviewConfBean.PreviewInfo)localObject2).prewTimeInfo, paramLong))
      {
  ...
  public boolean a(String paramString)
  {
    boolean bool2 = false;
    boolean bool1 = false;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo == null) || (baip.a(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo.activityUrl)) || (baip.a(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo.activityPrefix)))
    {
      bool2 = bool1;
      if (QLog.isColorLevel())
      {
  ...
  public long b()
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.i("springHb_SpringEntryManager", 2, "getCurrentTime -->" + baiu.b(l));
      }
      return l;
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpakcetPreviewConfBean$BreathLight.type == 0)
        {
          ...
          agvs.a("sq.hxd", 0, 0, localHashMap);
          ...
          this.jdField_a_of_type_Agtx.a(false, null);
          return;
        }
      }
      catch (Throwable localThrowable)
  ...
  public void b(agtx paramagtx)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if ((this.jdField_a_of_type_Agtq != null) && (this.jdField_a_of_type_Agtq.jdField_a_of_type_Agtx == paramagtx))
      {
        this.jdField_a_of_type_Agtq.jdField_a_of_type_Agtx = null;
        this.jdField_a_of_type_Agtq = null;
        this.jdField_a_of_type_Agtx = null;
      }
      if (QLog.isColorLevel()) {
        QLog.i("springHb_SpringEntryManager", 2, "removeCallback callback is : " + paramagtx + ",mCallbackProxy:" + this.jdField_a_of_type_Agtx + ",manager:" + this);
      }
      return;
    }
  }
  ...
  public boolean b()
  {
    if ((this.jdField_a_of_type_Agtd == null) || (this.jdField_a_of_type_Agtd.a() == null) || (a(this.jdField_a_of_type_Agtd.a().c))) {
      return false;
    }
    Iterator localIterator = this.jdField_a_of_type_Agtd.a().c.iterator();
    while (localIterator.hasNext()) {
      if (agsy.a((SpringFestivalRedpacketConfBean.TimeInfo)localIterator.next(), b())) {
        return true;
      }
    }
    return false;
  ...
  public boolean c()
  {
    ...
    //   14: istore 9
    //   16: aload_0
    //   17: getfield 179	agtk:jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo	Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/config/SpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo;
    //   20: ifnull +26 -> 46
    //   23: aload_0
    //   24: getfield 179	agtk:jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo	Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/config/SpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo;
    ...
    //   30: ifnull +16 -> 46
    //   33: aload_0
    //   34: getfield 179	agtk:jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo	Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/config/SpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo;
    ...
    //   40: invokestatic 188	agtk:a	(Ljava/util/List;)Z
    //   43: ifeq +9 -> 52
    //   46: iconst_1
    //   47: istore 8
    //   49: iload 8
    //   51: ireturn
    //   52: aload_0
    //   53: getfield 179	agtk:jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo	Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/config/SpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo;
    ...
    //   66: ireturn
    //   67: aload_0
    //   68: invokevirtual 227	agtk:b	()J
    //   71: lstore 10
    //   73: aload_0
    //   74: getfield 179	agtk:jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo	Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/config/SpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo;
    ...
    //   83: invokestatic 188	agtk:a	(Ljava/util/List;)Z
    //   86: ifne +476 -> 562
    //   89: aload_0
    //   90: getfield 179	agtk:jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo	Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/config/SpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo;
    ...
    //   102: istore_2
    //   103: aload_0
    //   104: getfield 41	agtk:jdField_a_of_type_ArrayOfByte	[B
    //   107: astore 14
    //   109: iload_3
    //   110: istore_2
    //   111: aload 14
    ...
    //   154: istore_2
    //   155: aload 16
    //   157: invokestatic 797	agsy:a	(Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/config/SpringFestivalRedpacketConfBean$TimeInfo;)Z
    //   160: ifeq +408 -> 568
    //   163: iload 5
    //   165: istore_2
    //   166: lload 10
    ...
    //   173: aload_0
    //   174: getfield 179	agtk:jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo	Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/config/SpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo;
    ...
    //   199: aload_0
    //   200: getfield 179	agtk:jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketSpringfestivalConfigSpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo	Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/config/SpringFestivalRedpacketConfBean$SpringFestivalHbEntryInfo;
    ...
    //   270: goto +292 -> 562
    //   273: aload_0
    //   274: getfield 104	agtk:jdField_a_of_type_Agtd	Lagtd;
    //   277: ifnull +274 -> 551
    //   280: aload_0
    //   281: getfield 104	agtk:jdField_a_of_type_Agtd	Lagtd;
    //   284: invokevirtual 828	agtd:a	()Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/config/SpringFestivalRedpakcetPreviewConfBean;
    //   287: astore 14
    //   289: aload 14
    //   291: ifnull +260 -> 551
    //   294: aload 14
    ...
    //   299: invokestatic 188	agtk:a	(Ljava/util/List;)Z
    //   302: ifne +249 -> 551
    //   305: aload 14
    ...
    //   314: istore 7
    //   316: aload_0
    //   317: getfield 41	agtk:jdField_a_of_type_ArrayOfByte	[B
    //   320: astore 15
    //   322: iload 8
    //   324: istore 7
    //   326: aload 15
    ...
    //   362: invokestatic 797	agsy:a	(Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/config/SpringFestivalRedpacketConfBean$TimeInfo;)Z
    //   365: ifeq +136 -> 501
    //   368: iload 9
    //   370: istore 8
    //   372: aload_0
    ...
    //   382: invokespecial 1297	agtk:a	(Lcom/tencent/mobileqq/activity/qwallet/redpacket/springfestival/config/SpringFestivalRedpakcetPreviewConfBean$BreathLight;)J
    //   385: lstore 12
    //   387: lload 10
    //   389: lload 12
    //   391: lcmp
