  ...
  implements View.OnClickListener
{
  ...
  public psn(Context paramContext, baxy parambaxy, ram paramram)
  {
  ...
  private TextView a(int paramInt)
  {
    ...
    localTextView.setId(2131374777);
    localTextView.setTextSize(2, 11.0F);
    localTextView.setGravity(17);
    localTextView.setText(ajya.a(2131704454));
    localTextView.setWidth(baxn.a(this.jdField_a_of_type_AndroidContentContext, 30.0F));
    localTextView.setHeight(baxn.a(this.jdField_a_of_type_AndroidContentContext, 17.0F));
    if (paramInt == 0)
    {
      localTextView.setTextColor(Color.argb(255, 255, 255, 255));
      localTextView.setBackgroundResource(2130848433);
      return localTextView;
    }
    localTextView.setTextColor(-89258);
    localTextView.setBackgroundResource(2130848434);
    return localTextView;
  }
  ...
  public pqq d()
  {
    ...
    this.jdField_b_of_type_AndroidViewView = localView.findViewById(2131375364);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView = ((KandianUrlImageView)localView.findViewById(2131368543));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378383));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378287));
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131368595));
    this.jdField_c_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    localLayoutParams.leftMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
    localLayoutParams.gravity = 16;
    this.jdField_c_of_type_AndroidWidgetTextView.setTextSize(2, 12.0F);
    this.jdField_c_of_type_AndroidWidgetTextView.setId(2131374770);
    ...
    this.jdField_c_of_type_AndroidViewView = localView.findViewById(2131379167);
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363388));
  ...
  public pqq o()
  {
    ...
    {
      localpau = (pau)this.jdField_a_of_type_JavaLangObject;
    ...
    ((RelativeLayout.LayoutParams)localObject1).width = axlk.a;
    ...
    if (localArticleInfo.mVideoCoverUrl != null)
    {
      ...
      omr.a((KandianUrlImageView)localObject2, (URL)localObject1, this.jdField_a_of_type_AndroidContentContext, true);
      if (jdField_a_of_type_AndroidGraphicsDrawableDrawable == null) {
        jdField_a_of_type_AndroidGraphicsDrawableDrawable = bbef.b();
      }
    ...
    for (;;)
    {
      ...
      if (localpau.e() == 0)
      {
        ...
        ((FrameLayout.LayoutParams)localObject1).setMargins(baxn.a(this.jdField_a_of_type_AndroidContentContext, 5.0F), 0, 0, baxn.a(this.jdField_a_of_type_AndroidContentContext, 2.0F));
        ...
        ((ViewGroup.LayoutParams)localObject1).height = baxn.a(this.jdField_a_of_type_AndroidContentContext, 47.0F);
        ...
        localObject1 = onh.a(localArticleInfo.mFirstPagePicUrl);
        break;
    ...
    for (;;)
    {
      ...
      return this;
      label766:
      this.jdField_b_of_type_AndroidWidgetTextView.setText(qoi.c(localArticleInfo.mVideoPlayCount));
