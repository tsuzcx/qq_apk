  ...
  extends awca
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = amtj.a(2131715326);
  }
  
  public awcx(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private void a(HashMap<String, ArrayList<MessageRecord>> paramHashMap, ArrayList<MessageForShortVideo> paramArrayList, ArrayList<bbqj> paramArrayList1, bbqx parambbqx, awcs paramawcs, awcd paramawcd)
  {
    ...
    localbbqx.a(new awcy(this, paramArrayList, paramHashMap, paramawcd, paramawcs));
  ...
  public void a(awcs paramawcs, HashMap<String, ArrayList<MessageRecord>> paramHashMap, awcd paramawcd)
  {
    ...
    for (;;)
    {
      bbqj localbbqj = bbqf.a(5, localObject2, (bbqx)localObject1);
      if (localbbqj != null)
      {
        localArrayList1.add(localbbqj);
      ...
      if ((localArrayList1.size() > 0) && (localArrayList2.size() > 0))
      {
        ...
        a(paramHashMap, localArrayList2, localArrayList1, (bbqx)localObject2, paramawcs, paramawcd);
        return;
      }
      paramawcd.a(0, 8, paramawcs);
      return;
    }
  }
}
