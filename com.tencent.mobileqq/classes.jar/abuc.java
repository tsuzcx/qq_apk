...
{
  public abuc(TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment paramTeamWorkDocEditBrowserFragment) {}
    ...
    case 1: 
      do
      {
        do
        {
          ...
          if ((55 == paramMessage.getIntExtra(baae.h, -1)) && (paramMessage.getExtras().containsKey("PhotoConst.PHOTO_PATHS")))
          {
