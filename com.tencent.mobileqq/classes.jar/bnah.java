  ...
  implements bnab
{
  ...
  private WeakReference<bnai> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public bnah(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  private Bitmap a(Context paramContext, Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      label26:
      int k = bnnq.jdField_a_of_type_Int;
      if (j <= k) {
        break label226;
      }
      i = (int)(i * k / j);
    ...
    for (;;)
    {
      ...
      {
        localObject = bdhj.a(paramContext, bdhj.c(paramBitmap), 0.4F, 25.0F);
      ...
      for (;;)
      {
        paramContext = xqw.a(xqw.a(paramContext, i, j, true), paramBitmap);
  ...
  public boolean a(String paramString, long paramLong1, long paramLong2, int paramInt, bnai parambnai)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambnai);
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Bnnx != null) {
