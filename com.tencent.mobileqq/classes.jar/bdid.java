...
public class bdid
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bdid.class.getName();
  ...
  public static int a(Context paramContext)
  {
    ...
    //   4: getstatic 27	bdid:jdField_a_of_type_AndroidNetUri	Landroid/net/Uri;
    //   7: aconst_null
    //   8: aconst_null
    //   9: aconst_null
    //   10: aconst_null
  ...
  public static String c(Context paramContext)
  {
    ...
    //   6: getstatic 27	bdid:jdField_a_of_type_AndroidNetUri	Landroid/net/Uri;
    //   9: aconst_null
    //   10: aconst_null
    //   11: aconst_null
    //   12: aconst_null
  ...
  public static boolean d(Context paramContext)
  {
    ...
    {
      bdii.c(jdField_a_of_type_JavaLangString, "checkNetWork Exception", paramContext);
    }
  }
