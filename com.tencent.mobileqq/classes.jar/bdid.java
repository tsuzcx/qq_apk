...
public class bdid
{
  ...
  bdhk jdField_a_of_type_Bdhk = null;
  ...
  public void a(Intent paramIntent)
  {
    ...
    do
    {
      ...
      azri.a(BaseApplicationImpl.getApplication()).a(null, "jump_act_system_report", true, 0L, 0L, paramIntent, null);
    ...
    {
      str = this.jdField_a_of_type_Bdhk.jdField_b_of_type_JavaLangString;
      paramIntent = this.jdField_a_of_type_Bdhk.jdField_c_of_type_JavaLangString;
    }
    for (;;)
    {
      ...
      azri.a(BaseApplicationImpl.getApplication()).a(null, "jump_act_business_report", true, 0L, 0L, (HashMap)localObject, null);
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity, Intent paramIntent)
  {
        ...
        do
        {
          do
          {
            do
            {
              ...
              Object localObject = bdia.a(paramActivity);
    ...
    this.jdField_a_of_type_Bdhk = bdib.a(paramQQAppInterface, paramActivity, this.g);
  }
