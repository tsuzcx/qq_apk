  ...
  extends xop
{
  ...
  public awze(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Axbn = new axbn(paramQQAppInterface);
  }
  ...
  private boolean g(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        ((StringBuilder)localObject1).append("handleAddFriend [uin: ").append(bbbd.b(paramToServiceMsg)).append(", source_id: ").append(i).append(", sub_source_id: ").append(j);
        if (i == 3004)
        {
