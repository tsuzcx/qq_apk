...
public class aqhg
{
  ...
  public final ConcurrentHashMap<Integer, HashMap<String, aqin>> a;
  public final CopyOnWriteArrayList<aqjb> a;
  ...
  public Bitmap a(aqjb paramaqjb, aqio paramaqio)
  {
    if ((paramaqjb == null) || (paramaqio == null)) {
      return null;
    }
    paramaqjb = "BubbleDiyFetcher_" + paramaqio.jdField_a_of_type_Int + "_" + paramaqio.jdField_a_of_type_JavaLangString.toUpperCase() + "_" + "chartlet";
    paramaqio = (Bitmap)BaseApplicationImpl.sImageCache.get(paramaqjb);
    if (paramaqio != null)
    {
      this.c.remove(paramaqjb);
      return paramaqio;
    }
    this.c.add(paramaqjb);
    paramaqjb = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramaqjb instanceof QQAppInterface)) {
      a((QQAppInterface)paramaqjb, 500);
    }
    return null;
  }
  
  public String a(aqjb paramaqjb, String paramString)
  {
    Object localObject;
    if ((paramaqjb == null) || (TextUtils.isEmpty(paramString))) {
      localObject = "";
    }
    String str;
    do
    ...
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramaqjb);
    paramaqjb = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramaqjb instanceof QQAppInterface)) {
      a((QQAppInterface)paramaqjb, 500);
    }
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localaqjb != null) && (localaqjb.getCallback() != null) && (a(localaqjb.jdField_a_of_type_JavaLangString))) {
        localHashSet.add(localaqjb.jdField_a_of_type_JavaLangString);
      }
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, BusinessObserver paramBusinessObserver)
  {
    ...
    ((aqhh)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.BUBBLE_DIYTEXT_HANDLER)).a((List)localObject, paramBusinessObserver);
  }
  ...
  public Bitmap b(aqjb paramaqjb, aqio paramaqio)
  {
    if ((paramaqjb == null) || (paramaqio == null) || (TextUtils.isEmpty(paramaqjb.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_b_of_type_JavaUtilMap.containsKey(paramaqjb.jdField_a_of_type_JavaLangString))
    {
      Object localObject = (HashMap)this.jdField_b_of_type_JavaUtilMap.get(paramaqjb.jdField_a_of_type_JavaLangString);
      if ((localObject != null) && (((HashMap)localObject).containsKey(paramaqio.jdField_a_of_type_JavaLangString.toUpperCase())))
      {
        localObject = (String)((HashMap)localObject).get(paramaqio.jdField_a_of_type_JavaLangString.toUpperCase());
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          if (QLog.isColorLevel()) {
            QLog.i("BubbleDiyFetcher", 2, "diy id " + paramaqjb.jdField_a_of_type_JavaLangString + " has no pasterId for align: " + paramaqio.jdField_a_of_type_JavaLangString.toUpperCase());
          }
          return null;
        }
      }
      ...
      paramaqio = "BubbleDiyFetcher_" + paramaqio.jdField_a_of_type_Int + "_" + paramaqio.jdField_a_of_type_JavaLangString.toUpperCase() + "_" + (String)localObject;
      localObject = (Bitmap)BaseApplicationImpl.sImageCache.get(paramaqio);
      if (localObject != null)
      {
        this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArraySet.remove(paramaqio);
        return localObject;
      }
      if (QLog.isColorLevel()) {
        QLog.i("BubbleDiyFetcher", 2, "can not found bitmap cache in BaseApplicationImpl.sImageCache! " + paramaqio);
      }
      this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramaqio);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      return null;
      if (QLog.isColorLevel()) {
        QLog.i("BubbleDiyFetcher", 2, "can not found cache in diyPasterCache! " + paramaqjb.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramaqjb.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public void b()
  {
    ...
    if ((localObject1 instanceof QQAppInterface))
    {
      ...
      localVasQuickUpdateManager = (VasQuickUpdateManager)((AppRuntime)localObject1).getManager(QQManagerFactory.VAS_QUICKUPDATE_MANAGER);
      localObject2 = null;
  ...
  public void c(String paramString)
  {
      ...
      if (BaseApplicationImpl.sImageCache.get(paramString) == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (((File)localObject6).exists())
          {
            ...
            localObject2 = bgyo.a(((File)localObject6).getAbsolutePath());
            localObject1 = localObject2;
            if (localObject2 != null)
            {
    ...
    try
    {
      ...
      {
        localObject2 = (aqin)((HashMap)localObject2).get(localObject4);
      ...
      if (BaseApplicationImpl.sImageCache.get(paramString) == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (localFile.exists())
          {
            ...
            localObject2 = bgyo.a(localFile.getAbsolutePath());
            localObject1 = localObject2;
            if (localObject2 != null)
            {
