...
public class aani
{
  ...
  public aani(long paramLong1, long paramLong2)
  {
  ...
  private boolean a()
  {
    try
    {
      ...
      this.jdField_a_of_type_Aann = new aann(null, "MediaCodecGLFrameFetcher");
    }
    ...
    this.jdField_a_of_type_Aann.b(new MediaCodecGLFrameFetcher.2(this));
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_Aanm = new aanm();
    this.jdField_a_of_type_Aanm.a(true);
    this.jdField_a_of_type_Aanm.a();
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Aanm.a());
    this.f = aanh.a(this.c, this.d);
  }
  
  private void d()
  {
    f();
    this.jdField_a_of_type_Aann.b(new MediaCodecGLFrameFetcher.3(this));
  }
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture.setOnFrameAvailableListener(new aanj(this));
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Aann != null)
    {
      this.jdField_a_of_type_Aann.b(new MediaCodecGLFrameFetcher.1(this));
      this.jdField_a_of_type_Aann.a();
      this.jdField_a_of_type_Aann = null;
    }
    h();
