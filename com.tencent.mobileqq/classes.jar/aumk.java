...
public class aumk
{
  ...
  public static aumk a()
  {
    ...
    {
      if (jdField_a_of_type_Aumk == null) {
        jdField_a_of_type_Aumk = new aumk();
      }
      return jdField_a_of_type_Aumk;
    }
  }
  ...
  public int a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString, WtloginObserver paramWtloginObserver)
  {
    ...
    return paramQQAppInterface.RegGetSMSVerifyLoginAccount(paramArrayOfByte1, paramArrayOfByte2, paramString, "8.3.0", paramWtloginObserver);
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    localbbgu.setTitle(2131717179);
    localbbgu.setMessage(2131717178);
    paramQQAppInterface = new auml(this, str, paramActivity, paramQQAppInterface);
    paramActivity = new aumm(this);
    localbbgu.setPositiveButton(2131717177, paramQQAppInterface);
    localbbgu.setNegativeButton(2131690596, paramActivity);
    localbbgu.show();
    return false;
  }
