...
public class azij
{
  ...
  public static PhoneContact a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localavsy != null)
    {
      PhoneContact localPhoneContact = localavsy.c(paramString);
      ayca localayca = aycb.a(paramString);
      paramQQAppInterface = localPhoneContact;
      if (localPhoneContact == null) {
        paramQQAppInterface = localavsy.b(localayca.c);
      }
      paramString = paramQQAppInterface;
      if (paramQQAppInterface == null) {
        paramString = localavsy.b("+" + localayca.a + localayca.c);
      }
      paramQQAppInterface = paramString;
      if (paramString == null) {
        paramQQAppInterface = localavsy.b(localayca.a + localayca.c);
      }
      paramString = paramQQAppInterface;
      if (paramQQAppInterface == null) {
        paramString = localavsy.b("00" + localayca.a + localayca.c);
      }
      if (paramString == null) {
        return localavsy.b(localayca.a + "-" + localayca.c);
      }
      return paramString;
    }
    return null;
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (String str = ((PhoneContact)localObject2).uin;; str = null)
    {
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        if (!str.equals("0"))
        {
          localObject2 = ((amsw)paramQQAppInterface.getManager(51)).e(str);
  ...
  {
    ayca localayca = aycb.a(paramString);
    if (localayca.a.equals("86")) {
      paramString = localayca.c;
    }
    return paramString;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    localbjnw.a(2131689514);
    arrayOfInt[0] = 1;
    localbjnw.b(2131690613);
    localbjnw.c(2131690620);
    localbjnw.a(new azik());
    localbjnw.a(new azil(localbjnw, arrayOfInt, paramString, paramContext, paramQQAppInterface));
    localbjnw.show();
  }
