  ...
  implements Manager
{
  ...
  public Handler a;
  aqxo jdField_a_of_type_Aqxo = null;
  private bbwm jdField_a_of_type_Bbwm;
  public QQAppInterface a;
  public final Object a;
  public Vector<Integer> a;
  public ConcurrentHashMap<Integer, aqxg> a;
  ...
  static
  {
    ...
    jdField_a_of_type_Aqxa = new aqxk();
    jdField_b_of_type_Aqxa = new aqxl();
  }
  ...
  {
    aqxb localaqxb = aqwz.a().a(paramInt, 0, jdField_a_of_type_Aqxa);
    if ((localaqxb.jdField_a_of_type_Int != 2) && (localaqxb.jdField_a_of_type_Int != 1) && (localaqxb.jdField_a_of_type_Int != 4) && (localaqxb.jdField_a_of_type_Int != 3)) {
      localaqxb.a(false);
    }
    return localaqxb.jdField_a_of_type_Int;
  }
  
  public static aqxh a(QQAppInterface paramQQAppInterface)
  {
    return (aqxh)paramQQAppInterface.getManager(219);
  }
  
  public static bcpq a(Context paramContext)
  {
    if ((((FragmentActivity)paramContext).getChatFragment() != null) && (((FragmentActivity)paramContext).getChatFragment().a() != null))
    {
      if (((FragmentActivity)paramContext).getChatFragment().a().jdField_a_of_type_Bcpq == null) {
        ((FragmentActivity)paramContext).getChatFragment().a().jdField_a_of_type_Bcpq = new bcpq(paramContext);
      }
      return ((FragmentActivity)paramContext).getChatFragment().a().jdField_a_of_type_Bcpq;
    }
    return null;
  }
        ...
        try
        {
          ...
          if (TextUtils.isEmpty(str2))
          {
            ...
            if (TextUtils.isEmpty(paramArrayOfByte))
            {
              ...
              if (i == 1)
              {
                paramArrayOfByte = ajyc.a(2131705464);
                str3 = localTTipsInfo.str_button.get();
                str1 = str3;
                if (TextUtils.isEmpty(str3))
                {
                  if (i == 1) {
                    str1 = ajyc.a(2131705465);
                  }
                }
                else
                {
                  str3 = localTTipsInfo.str_url.get();
                  bbcv.a(paramContext, 230, str2, paramArrayOfByte, ajyc.a(2131705468), str1, new aqxi(i, str3, paramContext, localTTipsInfo, paramInt), new aqxj()).show();
                  ...
                  ((aqxh)paramContext.getChatFragment().a().jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(219)).jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
                }
              }
              else
              {
                ...
                paramArrayOfByte = ajyc.a(2131705469);
                continue;
              }
              String str1 = str3;
              if (i != 2) {
  ...
  private void f()
  {
    ...
    {
      aqxg localaqxg = (aqxg)localIterator.next();
      if (!localaqxg.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
        a(localaqxg.jdField_a_of_type_Int, true, false, false);
      }
    }
  }
  
  public aqxg a(int paramInt)
  {
    try
    {
      aqxg localaqxg2 = (aqxg)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
      aqxg localaqxg1 = localaqxg2;
      if (localaqxg2 == null)
      {
        localaqxg1 = new aqxg();
        localaqxg1.jdField_a_of_type_Int = paramInt;
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt), localaqxg1);
      }
      return localaqxg1;
    }
    finally {}
  ...
  public JSONObject a(int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject1.put("message", ajyc.a(2131705471));
      ...
      catch (Exception localException)
      {
        ...
        localJSONObject1.put("message", ajyc.a(2131705461));
        continue;
        localException.put("status", 2);
        localJSONObject1.put("result", 0);
        localJSONObject1.put("message", ajyc.a(2131705466));
        continue;
        i = 0;
        continue;
      }
      ...
      if (!localaqxg.jdField_a_of_type_Boolean) {
        continue;
      }
      localJSONObject2.put("status", 3);
      localJSONObject1.put("result", 0);
      localJSONObject1.put("message", ajyc.a(2131705459));
      if (localaqxg.c != -3) {
        continue;
      }
      localJSONObject2.put("canceling", i);
      localJSONObject2.put("progress", localaqxg.c);
    }
  }
  ...
  {
    aqxg localaqxg = a(paramInt);
    localaqxg.c = -3;
    localaqxg.jdField_b_of_type_Boolean = false;
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    jdField_a_of_type_Aqxa.a(paramInt);
  }
  
  public void a(int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    aqxg localaqxg = a(paramInt);
    Object localObject = new File(aqwz.c + localaqxg.jdField_a_of_type_Int + File.separator + "hifont.json");
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        for (;;)
        {
          try
          {
            ...
            localaqxg.jdField_a_of_type_JavaLangString = ((JSONObject)localObject).optString("name");
            localaqxg.jdField_b_of_type_Int = ((JSONObject)localObject).optInt("engine");
            localaqxg.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).optString("tag");
            if (!TextUtils.isEmpty(localaqxg.jdField_b_of_type_JavaLangString)) {
              localaqxg.jdField_b_of_type_JavaLangString = localaqxg.jdField_b_of_type_JavaLangString.toLowerCase();
            }
            localaqxg.jdField_a_of_type_Boolean = aqwz.a(paramInt);
            if (!localaqxg.jdField_a_of_type_Boolean)
            {
              localObject = new File(aqwz.c + localaqxg.jdField_a_of_type_Int + File.separator + "panelImg.png");
              if (((File)localObject).exists()) {
                localaqxg.jdField_a_of_type_AndroidGraphicsBitmap = bbdr.a(((File)localObject).getAbsolutePath(), null);
              }
            }
            else
            {
              if (paramBoolean3)
              {
                localObject = new File(aqwz.c + paramInt + File.separator + "aiodbclick.png");
                if (!((File)localObject).exists()) {
                  break label450;
                }
                localaqxg.jdField_b_of_type_AndroidGraphicsBitmap = bbdr.a(((File)localObject).getAbsolutePath(), null);
              }
              localaqxg.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
              if (paramBoolean2) {
                a();
              }
              ...
              ((Message)localObject).obj = localaqxg.jdField_b_of_type_AndroidGraphicsBitmap;
            ...
            b(localaqxg.jdField_a_of_type_Int);
            continue;
            if (!QLog.isColorLevel()) {
              break label488;
            }
  ...
  public void a(VipFontUpdate.TGetPosterFontRsp paramTGetPosterFontRsp, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        aqxg localaqxg = a(i);
        localaqxg.jdField_a_of_type_Int = i;
        localaqxg.jdField_a_of_type_Long = localTPosterFontInfo.u64_ts.get();
        if (a(localaqxg.jdField_a_of_type_Long)) {
    ...
    a();
    if (paramBoolean) {
      bbdj.a(paramTGetPosterFontRsp.toByteArray(), jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public boolean a()
  {
    apzd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    return (this.d.get()) && (b());
  }
  ...
  public boolean a(BaseChatPie paramBaseChatPie, String paramString, int paramInt1, int paramInt2)
  {
    ...
    bcpw.a(paramBaseChatPie.jdField_a_of_type_AndroidContentContext, ajyc.a(2131705463), 0).a();
    ...
    aaod.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, localHiBoomMessage, null);
    ...
    for (;;)
    {
      ...
      localObject = new aaok();
      paramBaseChatPie.a((aaok)localObject);
      ((aaok)localObject).i = paramBaseChatPie.J;
      paramBaseChatPie.J = false;
      if (paramBaseChatPie != null)
      {
        paramBaseChatPie = (adiy)paramBaseChatPie.a(27);
        if (paramBaseChatPie != null) {
          paramBaseChatPie.a(paramString, (aaok)localObject, 0);
        }
      }
      return true;
      localObject = "2";
    ...
    label373:
    bcpw.a(paramBaseChatPie.jdField_a_of_type_AndroidContentContext, "嗨爆字体不能超过20字", 0).a();
    return false;
  }
  ...
  public void b()
  {
    ...
    ((akfw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).b();
  }
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 0)
    {
      ...
      ??? = a(paramInt1);
      ((aqxg)???).jdField_b_of_type_Boolean = false;
      if (paramInt2 != 0) {
        break label267;
      }
      i = 100;
      ...
      ((aqxg)???).jdField_a_of_type_Boolean = bool;
    }
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject2))
        {
          ...
          if ((!((String)localObject2).equals("0")) && (this.jdField_a_of_type_Bbwm != null))
          {
            ??? = new Bundle();
            ((Bundle)???).putString("callbackId", (String)localObject2);
            ((Bundle)???).putInt("srcType", 2);
            localObject2 = this.jdField_a_of_type_Bbwm;
            long l = paramInt1;
            if (paramInt2 != 0) {
              break label286;
            }
            paramInt1 = j;
            ((bbwm)localObject2).a(l, paramInt1, (Bundle)???);
          }
        }
        return;
        ??? = "1";
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Aqxo != null) {
      this.jdField_a_of_type_Aqxo.a(paramBoolean);
    }
  }
  ...
  public void c()
  {
    ...
    byte[] arrayOfByte = bbdj.a(jdField_a_of_type_JavaLangString);
  ...
  public void d()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      this.jdField_a_of_type_Aqxo = null;
      return;
    }
  }
