...
public class lvh
  extends kur
{
  public lvh(MultiVideoCtrlLayerUIBase paramMultiVideoCtrlLayerUIBase) {}
  ...
  protected void a(long paramLong1, int paramInt1, long paramLong2, long paramLong3, long paramLong4, int paramInt2)
  {
    ...
    case 90: 
      if (paramLong3 == 3L)
      {
        ...
        localleb = (leb)localArrayList.get(paramInt1);
        if (paramLong2 != localleb.jdField_a_of_type_Long) {
          break;
        }
      }
      break;
    ...
    label612:
    label635:
    for (boolean bool = localleb.jdField_a_of_type_Boolean;; bool = false)
    {
      this.a.jdField_b_of_type_Lru.update(null, new Object[] { Integer.valueOf(105), Boolean.valueOf(bool), Long.valueOf(paramLong1) });
      this.a.y(paramLong1);
      ...
      for (;;)
      {
        ...
        if (paramLong3 == 2L)
        {
          lqb.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1029);
        }
        else if (paramLong3 == 4L)
        {
          if ((paramLong2 == this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getLongAccountUin()) && (!this.a.jdField_a_of_type_ComTencentAvVideoController.a().j))
          {
            ...
            lqb.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1031);
          }
          for (;;)
          {
            ...
            awqx.b(null, "CliOper", "", "", "0X8004CFD", "0X8004CFD", 0, 0, "", "", "", "");
            break;
            paramInt1 = 0;
            break label475;
            if (QLog.isColorLevel()) {
  ...
  protected void a(long paramLong1, long paramLong2, long paramLong3, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localleb.jdField_a_of_type_Long = paramLong3;
      localleb.jdField_a_of_type_Int = paramInt;
      ArrayList localArrayList = new ArrayList();
      localArrayList.add(localleb);
      this.a.jdField_b_of_type_Lru.update(null, new Object[] { Integer.valueOf(104), localArrayList });
      if (paramInt == 2)
      {
        this.a.i(1036);
  ...
  protected void a(ArrayList<Long> paramArrayList, int paramInt)
  {
    if (paramInt == 0)
    {
      lqb.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034);
      lqb.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035);
    ...
    {
      lqb.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034, 2131630155);
      lqb.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131630476), new lvi(this));
      return;
    }
    Object localObject;
    long l;
    ...
    else
    {
      ...
      float f = this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131165946);
      localObject = new StringBuilder();
      mgg.b((StringBuilder)localObject, paramArrayList, this.a.jdField_d_of_type_AndroidWidgetTextView.getPaint(), f);
      if (paramInt != 1) {
        break label419;
      }
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131630156));
      lqb.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131630477), new lvj(this));
    }
    for (;;)
    {
      paramArrayList = ((StringBuilder)localObject).toString();
      lqb.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034, paramArrayList);
      return;
      l = this.a.jdField_a_of_type_ComTencentAvVideoController.jdField_c_of_type_Long;
      break;
      label419:
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131630157)).append(paramInt);
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131630158));
      lqb.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131630478), new lvk(this));
    }
  }
  ...
  protected void b(long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      if ((this.a.jdField_a_of_type_ComTencentAvVideoController.a() != null) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().E != 1))
      {
        ...
        str = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131630171);
        float f = mgg.a(str, this.a.jdField_d_of_type_AndroidWidgetTextView.getPaint());
        f = Math.min(this.a.jdField_a_of_type_AndroidContentResResources.getDisplayMetrics().widthPixels - f - this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131166676) * 2, this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131165946));
        mgg.b(localStringBuilder, (String)localObject, this.a.jdField_d_of_type_AndroidWidgetTextView.getPaint(), f);
        localStringBuilder.append(str);
      }
      lqb.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, localStringBuilder.toString());
      if ((this.a.jdField_a_of_type_ComTencentAvVideoController.a() != null) && ((this.a.jdField_a_of_type_ComTencentAvVideoController.a().E != 1) || (!paramBoolean1)) && ((this.a.jdField_a_of_type_ComTencentAvVideoController.a().E != 0) || (paramBoolean1))) {
    ...
    for (int i = 1;; i = 0)
    {
      ((kvq)localObject).c("setRoomMicOff", i);
      return;
      if ((this.a.jdField_a_of_type_ComTencentAvVideoController.a() == null) || (this.a.jdField_a_of_type_ComTencentAvVideoController.a().E == 0)) {
        break;
      }
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131630168));
      break;
    }
  }
  ...
  protected void c(long paramLong, int paramInt)
  {
    ...
    if ((paramInt != -1) && (((leb)this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.get(paramInt)).jdField_a_of_type_Boolean))
    {
      this.a.E();
      lqb.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1036);
  ...
  protected void d(long paramLong, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ...
      float f = this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131165946);
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131630174));
      mgg.b(localStringBuilder, (String)localObject, this.a.jdField_d_of_type_AndroidWidgetTextView.getPaint(), f);
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131630173));
      lqb.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, localStringBuilder.toString());
      localObject = this.a;
      if (paramInt != 1) {
        break label287;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131630175));
      break;
    }
  }
}
