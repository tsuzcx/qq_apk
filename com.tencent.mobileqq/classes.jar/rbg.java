...
public class rbg
{
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    try
    {
      ...
      {
        paramBaseArticleInfo = bkyp.a(paramBaseArticleInfo);
        ...
        {
          paramBaseArticleInfo = (String)bkyp.a(Uri.decode(str)).get("rowkey");
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      this.d = bhfn.a(BaseApplicationImpl.getApplication(), "com.tencent.reading");
      c = false;
      return;
      bool = false;
    }
  ...
  public String a(String paramString)
  {
    ...
    {
      return paramString;
      str = (String)bkyp.a(paramString).get("rowkey");
  ...
  public void a(int paramInt, List<Long> paramList)
  {
    ...
    b(pvj.a().a(Integer.valueOf(paramInt), paramList));
  }
