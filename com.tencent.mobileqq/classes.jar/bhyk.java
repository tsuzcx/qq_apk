...
public class bhyk
{
  ...
  public static bhyl a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    bhyl localbhyl = new bhyl();
    localbhyl.jdField_a_of_type_JavaLangString = a(paramString);
    String str;
    if (!localSharedPreferences.getBoolean("guideEnable", false))
    {
      ...
      localbhyl.jdField_a_of_type_Int = 4;
      switch (localbhyl.jdField_a_of_type_Int)
      {
      case 3: 
      default: 
        str = "P3";
    ...
    for (;;)
    {
      ...
      if (localSharedPreferences.getInt("guideToastOpen", 0) == 1)
      {
        ...
        for (;;)
        {
          ...
          localbhyl.jdField_a_of_type_Int = 1;
          break;
          label258:
      ...
      if (localSharedPreferences.getInt("guidePopupOpen", 0) == 1)
      {
        ...
        if ((i == 0) || (i == 1))
        {
          ...
          {
            localbhyl.jdField_a_of_type_Int = 3;
          ...
          for (str = "lastTipTime_";; str = "lastDialogTime_")
          {
            ...
            if (localbhyl.jdField_a_of_type_Int == 4) {
              break;
            }
            localSharedPreferences.edit().putLong(str, l).commit();
            break;
            localbhyl.jdField_a_of_type_Int = 2;
            break label365;
          }
        }
        localbhyl.jdField_a_of_type_Int = 4;
  ...
  public static void a(TrafficResultInfo paramTrafficResultInfo, Bundle paramBundle)
  {
    ...
    boolean bool1 = paramBundle.getBoolean(aogw.i);
    boolean bool3 = paramBundle.getBoolean(aogw.j);
    String str2 = paramBundle.getString(aogw.k);
    String str1 = paramBundle.getString(aogw.l);
  ...
  public static boolean a(Activity paramActivity, int paramInt, bhym parambhym, String paramString)
  {
    boolean bool = true;
    ...
    {
      return bool;
      localbhyl = a(paramString, false, true);
      if (QLog.isColorLevel()) {
        QLog.i("CUKingCardHelper", 2, "shouldOverrideDialog, popUpType: " + localbhyl.jdField_a_of_type_Int);
      }
    } while (localbhyl.jdField_a_of_type_Int == 4);
    if (localbhyl.jdField_a_of_type_Int == 1)
    {
      if (parambhym != null) {
        parambhym.callback(2);
      }
      return false;
    }
    new bhyj(paramActivity, parambhym, paramInt, paramString, localbhyl.jdField_a_of_type_Int).show();
    return false;
  }
