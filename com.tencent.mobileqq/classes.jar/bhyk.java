...
public final class bhyk
{
  ...
  public static HashMap<String, bhyn> a;
  private static List<SoftReference<bhym>> jdField_a_of_type_JavaUtilList;
  ...
  static
  {
    ...
    ((StringBuilder)localObject).append("uin=[uin]").append("&client=androidQQ").append("&version=").append("8.4.5.4745").append("&platformId=2").append("&device=").append(Build.DEVICE).append("&system=").append(Build.VERSION.RELEASE).append("&density=[density]");
    ...
    ((StringBuilder)localObject).append("?uin=[uin]").append("&client=androidQQ").append("&version=").append("8.4.5.4745").append("&platformId=2").append("&device=").append(Build.DEVICE).append("&system=").append(Build.VERSION.RELEASE).append("&density=[density]").append("&_bid=182").append("&_wv=3");
    ...
    ((StringBuilder)localObject).append("?uin=[uin]").append("&client=androidQQ").append("&version=").append("8.4.5.4745").append("&platformId=2").append("&device=").append(Build.DEVICE).append("&system=").append(Build.VERSION.RELEASE).append("&density=[density]").append("&adtag=mvip.gxh.android.search").append("&_bid=2229").append("&_wv=1027");
  ...
  public static String a(String paramString, ImageView paramImageView)
  {
    ...
    {
      jdField_a_of_type_JavaUtilList.add(new SoftReference(new bhym(paramString, paramImageView)));
      paramImageView = localObject;
      if (!jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
        paramImageView = a(paramString, jdField_a_of_type_Bhyo);
      }
  ...
  public static String a(String paramString, bhyo parambhyo)
  {
    ...
    for (Object localObject2 = localObject1;; localObject2 = null)
    {
      ...
      if (TextUtils.isEmpty(localObject2)) {
        if (!jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
        {
          ...
          ThreadManager.post(new IndividuationUrlHelper.2(parambhyo), 5, null, true);
        }
      }
      for (;;)
      {
        parambhyo = (String)jdField_b_of_type_JavaUtilMap.get(paramString);
        localObject1 = parambhyo;
        if (QLog.isColorLevel())
        {
          QLog.d("IndividuationUrlHelper", 2, "getUrl, from default, id=" + paramString + ", url=" + parambhyo);
          localObject1 = parambhyo;
        }
        parambhyo = (bhyo)localObject1;
