...
public class apeg
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, RecentBaseData paramRecentBaseData)
  {
    ...
    for (;;)
    {
      ...
      bigm.a(paramQQAppInterface, "qqsport_click_messagetab", null);
      break label145;
      label286:
      if (j != 2)
      {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      if ("1".equals(paramMessageRecord.getExtInfoFromExtStr("is_AdArrive_Msg")))
      {
        ...
        txt.a(paramQQAppInterface, "", "", paramMessageRecord.senderuin, str1, str3, localArrayList);
        return;
      }
    } while (!"2290230341".equals(paramMessageRecord.frienduin));
    bdll.b(paramQQAppInterface, "CliOper", "", "", "0X80090E1", "0X80090E1", 0, 0, "", "", "", "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, AbsListView paramAbsListView, int paramInt)
  {
    ...
    do
    {
      ...
      } while (!(paramAbsListView.getAdapter() instanceof blmb));
      localObject = (blmb)paramAbsListView.getAdapter();
    } while (!(((blmb)localObject).getWrappedAdapter() instanceof alms));
    b.clear();
    alms localalms = (alms)((blmb)localObject).getWrappedAdapter();
    ...
    if (i < k - 1)
    {
      paramAbsListView = localalms.getItem(i);
      String str;
      if ((paramAbsListView instanceof RecentBaseData))
      {
        ...
        str = localRecentBaseData.getRecentUserUin();
      ...
      do
      {
        for (;;)
        {
          ...
          bigm.a(paramQQAppInterface, "qqsport_exposure_messagetab", null);
          break label193;
          switch (paramInt)
          {
          default: 
