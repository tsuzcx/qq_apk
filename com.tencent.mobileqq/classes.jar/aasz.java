...
public class aasz
  implements Runnable
{
  public aasz(ARMapActivity paramARMapActivity, boolean paramBoolean, String paramString, int paramInt) {}
  ...
  public void run()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_JavaLangString.equals("right")) {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity.a.setImageResource(2130842246);
      ...
      for (;;)
      {
        ...
        return;
        this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity.a.setImageResource(2130842247);
        break;
        if (this.jdField_a_of_type_JavaLangString.equals("left"))
        {
          if ((this.jdField_a_of_type_Int == POITaskInfo.g) || (this.jdField_a_of_type_Int == POITaskInfo.k)) {
            this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity.a.setImageResource(2130842244);
          }
          for (;;)
          {
            if (TextUtils.equals(this.jdField_a_of_type_JavaLangString, ARMapActivity.a(this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity))) {
            ...
            break;
            this.jdField_a_of_type_ComTencentMobileqqArmapARMapActivity.a.setImageResource(2130842245);
          }
        }
      }
    }
