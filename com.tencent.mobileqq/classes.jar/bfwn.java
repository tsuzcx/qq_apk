...
public final class bfwn
  implements bmjf
{
  public bfut a;
  
  public bfwn(HWReciteItem paramHWReciteItem, bfut parambfut)
  {
  ...
  public void a(String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.i("HWReciteItem", 2, "upload onComplete " + this.jdField_a_of_type_Bfut.b);
    }
    this.jdField_a_of_type_Bfut.b(paramString);
    this.jdField_a_of_type_Bfut.g = 3;
  }
  ...
  public void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_Bfut.g = 2;
