  ...
  implements zqu
{
  ...
  public zrb(HandlerThread paramHandlerThread)
  {
  ...
  public boolean a(ResultObject paramResultObject, zqv paramzqv)
  {
    ...
    if (localJSONObject != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localObject3 = new YunYingFileUploadRunnable((URL)localObject2, (String)localObject3, paramzqv, paramResultObject.dbId, this.a);
    ...
    paramResultObject = new JsonUploadRunnable(new URL("http://zhizi.qq.com/json.php"), localJSONObject, paramzqv, paramResultObject.dbId, this.a);
