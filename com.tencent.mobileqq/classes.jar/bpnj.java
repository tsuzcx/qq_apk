...
public class bpnj
{
  ...
  public bpnj()
  {
    this.jdField_a_of_type_Bpnk = new bpnk();
  }
  
  public bpnj(JSONObject paramJSONObject)
  {
  ...
  public boolean a()
  {
    if (this.jdField_a_of_type_Bpnk == null) {
      this.jdField_a_of_type_Bpnk = new bpnk();
    }
    try
    {
      ...
      this.jdField_a_of_type_Bpnk.jdField_a_of_type_Int = i;
      this.jdField_a_of_type_Bpnk.jdField_a_of_type_ArrayOfInt = new int[] { j, k, m, n };
      this.jdField_a_of_type_Bpnk.jdField_a_of_type_JavaLangString = ((String)localObject);
      this.jdField_a_of_type_Bpnk.b = i1;
      this.jdField_a_of_type_Bpnk.c = i2;
      this.jdField_a_of_type_Bpnk.d = i3;
      this.jdField_a_of_type_Bpnk.e = i4;
      this.jdField_a_of_type_Bpnk.f = i5;
      return true;
    }
  ...
  {
    return "Item{thumbUrl='" + this.jdField_a_of_type_JavaLangString + '\'' + ", name='" + this.b + '\'' + ", desc='" + this.c + '\'' + ", imageUrl='" + this.d + '\'' + ", imageDrawable=" + this.jdField_a_of_type_AndroidGraphicsDrawableDrawable + ", layoutJson='" + this.e + '\'' + ", params=" + this.jdField_a_of_type_Bpnk + '}';
  }
}
