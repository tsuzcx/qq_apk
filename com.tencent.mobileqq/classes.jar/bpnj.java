...
{
  bpnj(bpni parambpni, Context paramContext) {}
  
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    this.jdField_a_of_type_Bpni.b(this.jdField_a_of_type_Bpni.a.a);
    this.jdField_a_of_type_Bpni.a = null;
    if (paramInt == 1)
    {
      this.jdField_a_of_type_Bpni.c = true;
