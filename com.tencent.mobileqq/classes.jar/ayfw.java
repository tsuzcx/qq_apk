...
public class ayfw
  implements sjq
{
  public ayfw(TroopBarPublishActivity paramTroopBarPublishActivity, String paramString1, long paramLong, String paramString2) {}
  
  public void a(int paramInt, String paramString1, String paramString2)
  {
    vlm.f(this.jdField_a_of_type_JavaLangString);
    if (paramInt != 0)
    {
