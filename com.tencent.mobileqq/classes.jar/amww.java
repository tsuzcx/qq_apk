  ...
  public static MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, MsgInfo paramMsgInfo)
  {
    if (paramArrayOfByte != null)
    {
      try
      {
        ...
        paramArrayOfByte = (MessageForYanZhi)awbi.a(-2070);
        ...
        paramArrayOfByte.msg = (localMsgBody.uint32_like_count.get() + BaseApplicationImpl.getContext().getString(2131628751));
        ...
        paramArrayOfByte.frienduin = ajed.H;
        paramArrayOfByte.senderuin = ajed.ao;
