...
public class amww
{
  ...
  public void a()
  {
    this.jdField_a_of_type_JavaLangString = (amsl.a() + "ar_cloud_img/");
  ...
  public void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, ARRecognition paramARRecognition, amwx paramamwx)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_ARCloudPretreatmentManagert", 2, "[ScanStarFace]pretreatFaceRecogInfo,  FaceScanModelsLoader.hasFaceModelInit =  " + amtd.b);
    }
    if (!amtd.b)
    {
    ...
    localamwz.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    ...
    if (amxt.a != null)
    {
      if (amxt.a.hasMessages(4))
      {
        if (QLog.isColorLevel()) {
          QLog.d("AREngine_ARCloudPretreatmentManagert", 2, "[DEBUG_SCAN_yt_face] pretreatFaceRecogInfo, remove pending task");
        }
        amxt.a.removeMessages(4);
      }
      paramArrayOfByte = Message.obtain(amxt.a, new ARCloudPretreatmentManager.1(this, paramARRecognition, localFaceCluster, paramArrayOfByte, paramInt1, paramInt2));
      paramArrayOfByte.what = 4;
      if (amxt.a != null) {
        amxt.a.sendMessage(paramArrayOfByte);
      }
    }
    for (;;)
    {
      ...
      {
        localamwz.jdField_a_of_type_ArrayOfComTencentYTFaceModelFaceStatus = paramARRecognition;
        azmj.b(null, "dc00898", "", "", "0X800834C", "0X800834C", 0, 0, "", "", "", "");
      }
      paramamwx.a(localamwz);
      return;
      if (QLog.isColorLevel()) {
  ...
  public void a(byte[] paramArrayOfByte, ARRecognition paramARRecognition, amwx paramamwx)
  {
    paramArrayOfByte = new amxj();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramamwx.a(paramArrayOfByte);
  }
  
  public void a(byte[] paramArrayOfByte, ArrayList<ARRecognition> paramArrayList, amwx paramamwx, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramArrayOfByte.hasNext())
    {
      ...
      if (l3 == 1L) {
        a(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramamwx);
      }
      for (;;)
      {
        break;
        if (l3 == 2L)
        {
          b(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramamwx);
        }
        else if (l3 == 4L)
        {
          l1 = System.currentTimeMillis();
          a(this.jdField_a_of_type_ArrayOfByte, j, i, paramArrayList, paramamwx);
          l1 = System.currentTimeMillis() - l1;
        }
        else if (l3 == 64L)
        {
          d(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramamwx);
        }
        else if (l3 == 128L)
        {
          c(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramamwx);
        }
        else if (l3 == 2048L)
        {
          e(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramamwx);
        }
      }
    }
    paramArrayList = new YuvImage(this.jdField_a_of_type_ArrayOfByte, paramInt3, j, i, null);
    paramArrayOfByte = a();
    paramArrayOfByte = new amwy(this.jdField_a_of_type_JavaLangString, paramArrayOfByte, this.jdField_a_of_type_ArrayOfByte);
    ...
    amxq localamxq = amxq.a();
    localamxq.c = l1;
    localamxq.b = l2;
    l1 = paramArrayOfByte.jdField_a_of_type_ArrayOfByte.length / 8192;
    paramamwx.a(jdField_a_of_type_Int, paramArrayList, l1);
  }
  ...
  public void b(byte[] paramArrayOfByte, ARRecognition paramARRecognition, amwx paramamwx)
  {
    paramArrayOfByte = new amxa();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramamwx.a(paramArrayOfByte);
  }
  
  public void c(byte[] paramArrayOfByte, ARRecognition paramARRecognition, amwx paramamwx)
  {
    paramArrayOfByte = new amxa();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramamwx.b(paramArrayOfByte);
  }
  
  public void d(byte[] paramArrayOfByte, ARRecognition paramARRecognition, amwx paramamwx)
  {
    paramArrayOfByte = new amxb();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramamwx.a(paramArrayOfByte);
  }
  
  public void e(byte[] paramArrayOfByte, ARRecognition paramARRecognition, amwx paramamwx)
  {
    paramArrayOfByte = new amxc();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramamwx.a(paramArrayOfByte);
  }
}
