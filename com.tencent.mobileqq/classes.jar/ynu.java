  ...
  public boolean a(ymw paramymw, String paramString, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        yny.b("GdtVideoCeilingJsCall", ((JSONObject)localObject3).toString());
        ...
        {
          paramymw = paramymw.a();
          AdReporterForAnalysis.reportForJSBridgeInvoked(paramString, false, "showVideoCeiling", paramymw, (Ad)localObject2);
          return true;
        }
      }
      catch (JSONException paramymw)
      {
        yny.d("GdtVideoCeilingJsCall", "handleJsCallRequest error", paramymw);
        return true;
      }
      paramymw = null;
    }
