...
public class bhux
{
  ...
  private void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Int = aekt.a(1.0F, ((Context)localObject).getResources());
    if (this.h == 0)
    {
      f1 = 3.0F;
      this.jdField_b_of_type_Int = aekt.a(f1, ((Context)localObject).getResources());
      f1 = f3;
      if (this.h == 0) {
        f1 = 3.0F;
      }
      this.c = aekt.a(f1, ((Context)localObject).getResources());
      f1 = f2;
      if (this.h == 0) {
        f1 = 2.0F;
      }
      paramInt = aekt.a(f1, ((Context)localObject).getResources());
      if (this.h != 0) {
        break label352;
      }
    }
    ...
    {
      int i1 = aekt.a(f1, ((Context)localObject).getResources());
      this.e = i1;
      this.d = i1;
  ...
  private void a(Canvas paramCanvas, Context paramContext)
  {
    ...
    if (this.h == 0) {}
    for (int i1 = 2130837994;; i1 = 2130839245)
    {
