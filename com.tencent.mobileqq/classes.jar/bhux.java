  ...
  implements IWebviewWrapper
{
  ...
  private final bgxn jdField_a_of_type_Bgxn = bgxn.a();
  private bhut jdField_a_of_type_Bhut;
  private TouchWebView jdField_a_of_type_ComTencentBizUiTouchWebView;
  private boolean jdField_a_of_type_Boolean;
  
  public bhux(Context paramContext)
  {
    this(paramContext, false);
  }
  
  public bhux(Context paramContext, boolean paramBoolean)
  {
  ...
  {
    if (this.jdField_a_of_type_Bhut != null) {
      this.jdField_a_of_type_Bhut.a(paramString);
    }
  }
  ...
  {
    this.jdField_a_of_type_Bgxn.a("onDestroy");
    this.jdField_a_of_type_Bhut = new bhut(this.jdField_a_of_type_AndroidContentContext, paramActivity, paramIntent, bhuw.a().a(), true);
    this.jdField_a_of_type_ComTencentBizUiTouchWebView.setVisibility(4);
    this.jdField_a_of_type_Bhut.a(this.jdField_a_of_type_ComTencentBizUiTouchWebView);
    this.jdField_a_of_type_Bhut.a(new bhuy(this, paramIWebviewListener));
    new bcbu(this.jdField_a_of_type_Bhut).a(null, bhuw.a().a(), null);
  }
  
  public void onPause()
  {
    if (this.jdField_a_of_type_Bhut != null) {
      this.jdField_a_of_type_Bhut.b();
    }
  }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      try
      {
        if (paramIntent.getBooleanExtra("need_force_refresh", false))
        {
          ...
          xne.a(this.jdField_a_of_type_ComTencentBizUiTouchWebView, str1, str2);
        }
      }
