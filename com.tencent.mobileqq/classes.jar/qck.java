...
public class qck
  ...
  implements qci
{
  private static qck jdField_a_of_type_Qck = new qck();
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      QLog.d("gifvideo.KandianShortContentGifStrategy", 1, new Object[] { "convertVidToUrl resp result code ", Integer.valueOf(pjz.a(paramToServiceMsg, paramFromServiceMsg, paramObject, (MessageMicro)localObject1, bool)) });
      ...
      for (paramFromServiceMsg = paramObject.toString();; paramFromServiceMsg = "null")
      {
        ...
        while (paramObject.hasNext())
        {
          ...
          if (localObject2 != null)
          {
            ...
            sxc localsxc = new sxc();
            localsxc.b = ((content_vidurl_svr.UrlInfo)localObject2).vid.get();
            localsxc.jdField_a_of_type_JavaLangString = ((content_vidurl_svr.UrlInfo)localObject2).url.get();
            swx.a(localsxc);
          }
        }
      ...
      paramToServiceMsg = (qcj)a(Integer.valueOf(((Integer)paramToServiceMsg.getAttribute("vidToUrlSeq")).intValue()));
  ...
  {
    a(new String[] { paramString }, paramqcj);
  }
  
  public void a(String[] paramArrayOfString, qcj paramqcj)
  {
    if ((paramArrayOfString != null) && (paramArrayOfString.length > 0))
    {
      ...
      localObject = qcg.a(BaseApplicationImpl.getContext());
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
      ...
      localObject = qxp.a("OidbSvc.0xda2", 3490, 0, ((oidb_cmd0xda2.ReqBody)localObject).toByteArray());
