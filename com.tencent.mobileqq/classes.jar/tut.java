  ...
  implements IReportDelegate
{
  ...
  private JSONObject a(String paramString)
  {
    ...
    try
    {
      localJSONObject.put(ViolaEnvironment.COMMON_UIN, pkh.a());
      localJSONObject.put(ViolaEnvironment.COMMON_NET, Integer.toString(pkh.a(BaseApplication.getContext())));
      localJSONObject.put(ViolaEnvironment.COMMON_OPERATION_VERSION, DeviceInfoUtil.getDeviceOSVersion());
      localJSONObject.put(ViolaEnvironment.COMMON_QQ_VERSION, "8.4.10");
      localJSONObject.put(ViolaEnvironment.COMMON_PHONE_TYPE, Build.MODEL);
      String str2 = ViolaEnvironment.COMMON_BIZ;
      if (TextUtils.isEmpty(str1)) {}
      for (str1 = paramString;; str1 = paramString + "&offlineVersion=" + nuz.a(str1))
      {
        localJSONObject.put(str2, URLEncoder.encode(str1));
        localJSONObject.put(ViolaEnvironment.COMMON_PLATFORM, "0");
        localJSONObject.put(ViolaEnvironment.COMMON_OPEN_COUNT, Integer.toString(tto.a));
  ...
  public HashMap<String, String> getBaseReportData(String paramString)
  {
    ...
    label168:
    for (String str1 = paramString;; str1 = paramString + "&offlineVersion=" + nuz.a(str1))
    {
      ...
      localHashMap.put(ViolaEnvironment.COMMON_UIN, pkh.a());
      localHashMap.put(ViolaEnvironment.COMMON_NET, Integer.toString(pkh.a(BaseApplication.getContext())));
      localHashMap.put(ViolaEnvironment.COMMON_OPERATION_VERSION, DeviceInfoUtil.getDeviceOSVersion());
      localHashMap.put(ViolaEnvironment.COMMON_QQ_VERSION, "8.4.10");
      localHashMap.put(ViolaEnvironment.COMMON_PHONE_TYPE, Build.MODEL);
      localHashMap.put(ViolaEnvironment.COMMON_PLATFORM, "0");
      localHashMap.put(ViolaEnvironment.COMMON_OPEN_COUNT, Integer.toString(tto.a));
  ...
  public void reportJsError(boolean paramBoolean, int paramInt, String paramString)
  {
    ...
    try
    {
      ...
      olh.a(null, null, "0X800AC69", "0X800AC69", 0, 0, "", "", "", localJSONObject.toString(), false);
      return;
    }
    catch (Exception paramString)
    {
  ...
  public void reportNativeVueError(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      olh.a(null, null, "0X800B08D", "0X800B08D", 0, 0, "", "", "", localJSONObject.toString(), false);
      return;
    }
    catch (Exception paramString1)
    {
