  ...
  extends pne
{
  ...
  private noe jdField_a_of_type_Noe = new nog(this);
  ...
  public nof(AppInterface paramAppInterface)
  {
  ...
  {
    paramMaterialData = this.jdField_a_of_type_Atmp.a(MaterialData.class, MaterialData.class.getSimpleName(), true, "id=?", new String[] { String.valueOf(paramMaterialData.id) }, null, null, null, null);
  ...
  {
    return this.jdField_a_of_type_Atmp.a(MaterialData.class);
  }
  ...
  private List<MaterialData> a(int paramInt)
  {
    ...
    if (paramInt == -1) {
      return this.jdField_a_of_type_Atmp.a(MaterialData.class, MaterialData.class.getSimpleName(), true, "uin=? and end_time>? and isReady=?", new String[] { str, String.valueOf(l), String.valueOf(1) }, null, null, null, null);
    }
    return this.jdField_a_of_type_Atmp.a(MaterialData.class, MaterialData.class.getSimpleName(), true, "uin=? and end_time>? and isReady=? and ad_type=?", new String[] { str, String.valueOf(l), String.valueOf(1), String.valueOf(paramInt) }, null, null, null, null);
  }
  ...
  public static nof a(QQAppInterface paramQQAppInterface)
  {
    return (nof)paramQQAppInterface.getManager(337);
  }
  ...
  private void a(MaterialData paramMaterialData)
  {
    try
    {
      ...
      bace.a(paramMaterialData.res_path, false);
      this.jdField_a_of_type_Atmp.a(MaterialData.class.getSimpleName(), "id=? ", new String[] { String.valueOf(paramMaterialData.id) });
      return;
    }
  ...
  private static void a(MaterialData paramMaterialData, boolean paramBoolean, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        awpy.a(localQQAppInterface, "sendtdbank|b_pcg_ffc_game_dev_qq_kandian_commercial|ad_resource_statistics_report", paramString3 + "|" + localJSONObject.toString(), true);
        return;
      }
      catch (Exception paramMaterialData)
      {
  ...
  private boolean a(ArrayList<MaterialData> paramArrayList)
  {
    for (;;)
    {
      ...
      label170:
      this.jdField_a_of_type_Atmp.b(localMaterialData);
    }
    return true;
  }
  ...
  private List<MaterialData> b()
  {
    ...
    try
    {
      ...
      localObject = this.jdField_a_of_type_Atmp.a(MaterialData.class, MaterialData.class.getSimpleName(), true, "uin=? and end_time>? and isReady=?", new String[] { localObject, String.valueOf(l), String.valueOf(0) }, null, null, null, null);
      return localObject;
    }
    catch (Exception localException)
    {
  ...
  private void b(MaterialData paramMaterialData)
  {
    ...
    this.jdField_a_of_type_Atmp.a(paramMaterialData);
  }
      ...
      try
      {
        if (paramList.size() != 0)
        {
          ...
          while (paramList.hasNext())
          {
            ...
            bace.a(localMaterialData.res_path, false);
            ...
            if ((!this.jdField_a_of_type_Atmp.a(localMaterialData)) && (QLog.isColorLevel())) {
  ...
  private List<MaterialData> c()
  {
    ...
    {
      long l = NetConnInfoCenter.getServerTime();
      List localList = this.jdField_a_of_type_Atmp.a(MaterialData.class, MaterialData.class.getSimpleName(), true, "uin=? and end_time<?", new String[] { this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), String.valueOf(l) }, null, null, null, null);
      return localList;
    }
    catch (Exception localException)
    {
  ...
  public String a(String paramString1, String paramString2)
  {
    ...
    if ((this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap != null) && (this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString1) != null))
    {
      ...
      {
        if (bace.a(paramString1.res_path)) {
  ...
  public ArrayList<MaterialData> a(int paramInt)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((MaterialData)localEntry.getValue()).ad_type == paramInt) {
        if (bace.a(((MaterialData)localEntry.getValue()).res_path)) {
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) && (this.jdField_a_of_type_Noe != null))
    {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.addObserver(this.jdField_a_of_type_Noe);
  ...
  public void a(String paramString, BaseResData paramBaseResData)
  {
    ...
    if ((paramBaseResData instanceof MaterialData))
    {
      ...
      if (bace.a(((MaterialData)paramBaseResData).res_path)) {
        break label93;
      }
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        if (!this.jdField_a_of_type_Atmp.a(paramBaseResData)) {
          break;
        }
        if (QLog.isColorLevel()) {
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    if ((this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap != null) && (this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString1) != null))
    {
      ...
      bace.a(paramString2.res_path, false);
      b(paramString2);
  ...
  {
    if (this.jdField_a_of_type_Noe != null) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.removeObserver(this.jdField_a_of_type_Noe);
    }
    super.onDestroy();
  }
}
