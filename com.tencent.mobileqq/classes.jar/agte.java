  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      default: 
        return;
      case 1: 
        ((auul)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(106)).d.put(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, Integer.valueOf(1));
        ...
        if (this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1001)
        {
          paramView = "2";
          if (this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1001) {}
          alxp.a((QQAppInterface)localObject1, (String)localObject2, paramView, "1", 2, new agtf(this));
          localObject1 = (auac)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(16);
          ...
          paramView = "0";
          label235:
          if (!((auac)localObject1).a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
            break label290;
          }
        }
        label284:
        ...
        {
          azqs.b((QQAppInterface)localObject2, "dc00899", "grp_lbs", "", "c2c_tmp", "follow_aio", 0, 0, paramView, "0", (String)localObject1, "");
          return;
          paramView = "1";
          break;
          paramView = "1";
      ...
      {
        azqs.b((QQAppInterface)localObject2, "dc00899", "grp_lbs", "", "c2c_tmp", "block_aio", 0, 0, paramView, "0", (String)localObject1, "");
        return;
        paramView = "1";
        break;
      }
