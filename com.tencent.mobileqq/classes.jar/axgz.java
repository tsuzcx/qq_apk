  ...
  extends apap
{
  ...
  public axgz(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public static MessageRecord a(@NonNull QQAppInterface paramQQAppInterface, @NonNull byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        long l8 = bcrw.a(localMessageHandler, (msg_comm.Msg)localObject1, String.valueOf(l4), String.valueOf(l3));
        paramArrayOfByte = new ArrayList();
        if (((!bcsa.c(i1)) && (i1 != 208) && (i1 != 529)) || (!((msg_comm.MsgHead)localObject2).c2c_cmd.has())) {
          break label803;
        }
        l2 = a(paramQQAppInterface.getLongAccountUin(), l3, l4);
        a(paramQQAppInterface, (msg_comm.Msg)localObject1, localbfoy, (msg_comm.MsgHead)localObject2, i1, localMessageHandler, paramArrayOfByte);
        l1 = l2;
        if (i1 != 208) {
          break label841;
        }
        new bcsp().a(localMessageHandler, (msg_comm.Msg)localObject1, paramArrayOfByte, null);
        l1 = l2;
        int m = 0;
        int i2 = bcrw.a((msg_comm.Msg)localObject1);
        ...
        ((MessageRecord)localObject2).vipBubbleID = aogu.a((int)l8, i2);
        ...
        ((MessageRecord)localObject2).msgBackupMsgRandom = bcsa.b(l7);
        m += 1;
        continue;
        label579:
        ...
        a(paramQQAppInterface, (msg_comm.Msg)localObject1, localMessageHandler, paramArrayOfByte, localbfoy);
        continue;
        label617:
        l1 = l2;
        ...
        a(paramQQAppInterface, (msg_comm.Msg)localObject1, localbfoy, localMessageHandler, paramArrayOfByte);
      }
      ...
      do
      {
        if (antf.z.equals(Long.valueOf(l4))) {
  ...
  public static msg_comm.MsgHead a(MessageRecord paramMessageRecord, long paramLong)
  {
    ...
    Object localObject = adak.c(paramMessageRecord);
    for (;;)
    {
      try
      {
  ...
  public static im_msg_body.MsgBody a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    ...
    if ((paramMessageRecord.msgtype == -1000) || (paramMessageRecord.msgtype == -10000)) {
      if (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("sens_msg_source_msg_info"))) {
        paramQQAppInterface = bcrw.a(paramMessageRecord);
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          return paramQQAppInterface;
          paramQQAppInterface = bcrw.a((MessageForText)paramMessageRecord);
          break;
          if (paramMessageRecord.msgtype == -1049)
          {
            paramQQAppInterface = bcrw.a((MessageForReplyText)paramMessageRecord);
            break;
          }
          ...
          {
            paramQQAppInterface = bcrw.a((MessageForQQStoryComment)paramMessageRecord);
            break;
          }
          if (paramMessageRecord.msgtype == -2000)
          {
            paramQQAppInterface = bcrw.a((MessageForPic)paramMessageRecord);
            break;
          }
          if (paramMessageRecord.msgtype == -5008)
          {
            paramQQAppInterface = bcrw.a((MessageForArkApp)paramMessageRecord, true);
            break;
          }
          if (paramMessageRecord.msgtype == -5016)
          {
            paramQQAppInterface = bcrw.c((MessageForArkBabyqReply)paramMessageRecord, true);
            break;
          }
          if (paramMessageRecord.msgtype == -5017)
          {
            paramQQAppInterface = bcrw.b((MessageForArkApp)paramMessageRecord, true);
            break;
          }
          if (paramMessageRecord.msgtype == -5013)
          {
            paramQQAppInterface = bcrw.c((MessageForArkFlashChat)paramMessageRecord);
            break;
          }
          if (paramMessageRecord.msgtype == -5014)
          {
            paramQQAppInterface = bcrw.d((MessageForHiBoom)paramMessageRecord);
            break;
          }
          if (paramMessageRecord.msgtype != -2011) {
            break label378;
          }
          localObject2 = bcrw.a((MessageForStructing)paramMessageRecord);
        ...
        {
          paramQQAppInterface = bcrw.a((MessageForMixedMsg)paramMessageRecord);
          break;
        }
        if (paramMessageRecord.msgtype == -1051)
        {
          paramQQAppInterface = bcrw.a((MessageForLongTextMsg)paramMessageRecord, false);
          break;
        }
        ...
        {
          paramQQAppInterface = bcrw.a((MessageForMarketFace)paramMessageRecord);
          break;
        }
  ...
  private static void a(QQAppInterface paramQQAppInterface, msg_comm.Msg paramMsg, bfoy parambfoy, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    if (!paramQQAppInterface.a().a().b(paramArrayList, paramMsg)) {
      bcrw.a(paramMessageHandler, paramArrayList, paramMsg, false, false, parambfoy);
    }
    ...
    if ((paramQQAppInterface.rich_text.has()) && (((im_msg_body.RichText)paramQQAppInterface.rich_text.get()).ptt.has())) {
      new bcsk().a(paramMessageHandler, paramMsg, paramArrayList, null);
    }
  }
  
  private static void a(QQAppInterface paramQQAppInterface, msg_comm.Msg paramMsg, bfoy parambfoy, msg_comm.MsgHead paramMsgHead, int paramInt, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    int i = paramMsgHead.c2c_cmd.get();
    if ((paramInt == 529) && (i == 4)) {
      paramQQAppInterface.a().a().a(paramArrayList, ((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.get());
    }
    while ((i != 175) && (i != 11)) {
      return;
    }
    bcrw.a(paramMessageHandler, paramArrayList, paramMsg, true, false, parambfoy);
  }
  
  private static void a(QQAppInterface paramQQAppInterface, msg_comm.Msg paramMsg, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList, bfoy parambfoy)
  {
    if (!paramQQAppInterface.a().a().a(paramArrayList, paramMsg)) {
      bcrw.a(paramMessageHandler, paramArrayList, paramMsg, false, false, parambfoy);
    }
    paramQQAppInterface = (im_msg_body.MsgBody)paramMsg.msg_body.get();
    if (paramQQAppInterface.rich_text.has())
    {
      ...
      if (localRichText.elems.has())
      {
        ...
        if (paramQQAppInterface != null)
        {
          ...
          {
            parambfoy = (im_msg_body.Elem)paramQQAppInterface.next();
            if (parambfoy.anon_group_msg.has())
            {
              parambfoy = (im_msg_body.AnonymousGroupMsg)parambfoy.anon_group_msg.get();
              int i = parambfoy.uint32_flags.get();
              paramQQAppInterface = parambfoy.str_anon_id.get().toByteArray();
              byte[] arrayOfByte = parambfoy.str_anon_nick.get().toByteArray();
              int j = parambfoy.uint32_head_portrait.get();
              int k = parambfoy.uint32_expire_time.get();
              String str = parambfoy.str_rank_color.get().toStringUtf8();
              if (paramQQAppInterface != null) {}
              for (;;)
              {
                try
                {
                  ...
                  parambfoy = "";
                  localMessageRecord.saveExtInfoToExtStr("anonymous", nlj.a(i, paramQQAppInterface, parambfoy, j, k, str));
                ...
                continue;
                label304:
                parambfoy = new String(arrayOfByte);
              }
              if (QLog.isColorLevel()) {
  ...
  private static void a(MessageRecord paramMessageRecord, im_msg_body.RichText paramRichText)
  {
    if (nlj.a(paramMessageRecord))
    {
      ...
      nlk localnlk = nlj.a(paramMessageRecord);
      localAnonymousGroupMsg.uint32_flags.set(localnlk.jdField_a_of_type_Int);
      if (!TextUtils.isEmpty(localnlk.jdField_a_of_type_JavaLangString)) {
        localAnonymousGroupMsg.str_anon_id.set(ByteStringMicro.copyFrom(localnlk.jdField_a_of_type_JavaLangString.getBytes()));
      }
      if (!TextUtils.isEmpty(localnlk.jdField_b_of_type_JavaLangString)) {
        localAnonymousGroupMsg.str_anon_nick.set(ByteStringMicro.copyFrom(localnlk.jdField_b_of_type_JavaLangString.getBytes()));
      }
      localAnonymousGroupMsg.uint32_head_portrait.set(localnlk.jdField_b_of_type_Int);
      localAnonymousGroupMsg.uint32_expire_time.set(localnlk.jdField_c_of_type_Int);
      if (!TextUtils.isEmpty(localnlk.jdField_c_of_type_JavaLangString)) {
        localAnonymousGroupMsg.str_rank_color.set(ByteStringMicro.copyFrom(localnlk.jdField_c_of_type_JavaLangString.getBytes()));
      }
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    catch (Throwable paramQQAppInterface)
    {
      for (;;)
      {
        ...
        bdkh.a(paramQQAppInterface, "MsgBackup_msgproxy,mr = " + paramMessageRecord.getClass().getSimpleName());
        paramQQAppInterface = null;
      }
  ...
  public MsgBackupMsgEntity a(@NonNull MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      {
        axjn.a("transBackupEntity error,mr = %s ", paramMessageRecord.toString(), new Object[0]);
        return null;
      }
    }
    catch (Throwable localThrowable)
    {
      ...
      {
        QLog.e("MsgBackup_msgproxy", 1, "transToBackupEntity,getMsgBody error mr = " + paramMessageRecord.getClass().getSimpleName());
        bdkh.a(localThrowable, "MsgBackup_msgproxy,mr = " + paramMessageRecord.getClass().getSimpleName());
        localObject2 = null;
      }
      localMsg.msg_head.set(localMsgHead);
      ...
      ((MsgBackupMsgEntity)localObject2).chatType = axjn.b(paramMessageRecord.istroop);
      ((MsgBackupMsgEntity)localObject2).msgType = axjn.a(paramMessageRecord.msgtype);
    ...
    if (paramMessageRecord.istroop == 3000)
    {
      ...
      paramMessageRecord = axgo.a(i);
      if (paramMessageRecord != null) {
        break label402;
      }
      paramMessageRecord = localMsg.toByteArray();
      axgo.a(paramMessageRecord);
    }
    label363:
    ...
    {
      return localObject2;
      i = bcsa.b(paramMessageRecord.msgUid);
