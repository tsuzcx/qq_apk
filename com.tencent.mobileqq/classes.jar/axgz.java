  ...
  extends anvi
{
  protected void onAddFriend(String paramString)
  {
    ...
    if ((!axgu.a(this.a)) && (axgu.a(this.a) != null))
    {
      localArrayList = (ArrayList)axgu.a(this.a).get(Long.valueOf(axgu.a(this.a)));
    ...
    try
    {
      ...
      if (localArrayList.indexOf(Long.valueOf(l)) != -1)
      {
        ...
        localArrayList.add(Long.valueOf(axgu.a(this.a)));
        HashMap localHashMap = new HashMap(5);
        localHashMap.put("notRequest", paramString);
        localHashMap.put("groupUin", localArrayList);
        ((auzb)axgu.a(this.a).getBusinessHandler(BusinessHandlerFactory.INTIMATE_INFO_HANDLER)).a(axgu.a(this.a), paramString, localHashMap);
      }
      return;
    }
