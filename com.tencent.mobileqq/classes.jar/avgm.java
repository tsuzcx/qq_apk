...
{
  avgm(avgk paramavgk, String paramString) {}
  
  public void onClick(View paramView)
  {
    azmo localazmo = new azmo(this.jdField_a_of_type_Avgk.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app).b("grp_lbs").c("data_card").d("nonlive_clk").e(avgk.a(this.jdField_a_of_type_Avgk).uin);
