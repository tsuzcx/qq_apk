  ...
  implements abvc
{
  ...
  private abve jdField_a_of_type_Abve;
  private int jdField_b_of_type_Int;
  private long jdField_b_of_type_Long = -2147483648L;
  
  public abvf(abve paramabve)
  {
    this.jdField_a_of_type_Abve = paramabve;
  }
  ...
  private String a(String paramString)
  {
    ...
    for (Activity localActivity = this.jdField_a_of_type_Abve.a();; localActivity = null)
    {
      String str1 = str2;
  ...
  private void a(GdtAd paramGdtAd)
  {
    ...
    localabrr.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(2);
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localabrr);
  }
  ...
  private void b(GdtAd paramGdtAd)
  {
    ...
    abrr localabrr = new abrr();
    localabrr.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(1);
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localabrr);
  }
  ...
  private void c(GdtAd paramGdtAd)
  {
    ...
    abrr localabrr = new abrr();
    localabrr.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(5);
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localabrr);
  }
  ...
  private void d(GdtAd paramGdtAd)
  {
    ...
    abrr localabrr = new abrr();
    localabrr.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(6);
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localabrr);
  }
  ...
  private void f(GdtAd paramGdtAd)
  {
    ...
    abrr localabrr = new abrr();
    localabrr.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(3);
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localabrr.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localabrr);
  }
