  ...
  implements View.OnClickListener
{
  ...
  public luy(RedPacketGameView paramRedPacketGameView, AVActivity paramAVActivity)
  {
    this.jdField_a_of_type_ArrayOfLuu = new luu[4];
    this.jdField_a_of_type_Luu = new luu();
    this.jdField_b_of_type_Luu = new luu();
    this.jdField_c_of_type_Luu = new luu();
    ...
    int n = 0;
    while (n < this.jdField_a_of_type_ArrayOfLuu.length)
    {
      this.jdField_a_of_type_ArrayOfLuu[n] = new luu();
      this.jdField_a_of_type_ArrayOfLuu[n].jdField_b_of_type_Int = (n * 37 + 30);
      this.jdField_a_of_type_ArrayOfLuu[n].jdField_c_of_type_Int = 30;
      this.jdField_a_of_type_ArrayOfLuu[n].d = 37;
      this.jdField_a_of_type_ArrayOfLuu[n].e = 46;
      this.jdField_a_of_type_ArrayOfLuu[n].a(255);
      n += 1;
    }
    this.jdField_a_of_type_Luu.jdField_c_of_type_Int = 36;
    this.jdField_a_of_type_Luu.d = 200;
    this.jdField_a_of_type_Luu.e = 28;
    this.jdField_a_of_type_Luu.a(255);
    this.jdField_b_of_type_Luu.jdField_c_of_type_Int = 36;
    this.jdField_b_of_type_Luu.d = 200;
    this.jdField_b_of_type_Luu.e = 28;
    this.jdField_b_of_type_Luu.a(255);
    this.jdField_c_of_type_Luu.jdField_c_of_type_Int = 36;
    this.jdField_c_of_type_Luu.d = 200;
    this.jdField_c_of_type_Luu.e = 28;
    this.jdField_c_of_type_Luu.a(255);
    ...
    paramAVActivity.setId(2131373488);
    ...
    paramRedPacketGameView.setId(2131373489);
  ...
  private void e()
  {
    View localView = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131373488);
    ...
    localView = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131373489);
  ...
  private void f()
  {
    ...
    {
      this.jdField_a_of_type_Luu.jdField_b_of_type_Int = n;
      this.jdField_b_of_type_Luu.jdField_b_of_type_Int = n;
      this.jdField_c_of_type_Luu.jdField_b_of_type_Int = n;
      this.jdField_a_of_type_Luu.b(this.h, this.i, 0, 0);
      this.jdField_b_of_type_Luu.b(this.h, this.i, 0, 0);
  ...
  public void a()
  {
    Object localObject = this.jdField_a_of_type_Luu.a();
    int i1 = this.e * this.jdField_b_of_type_Int / this.jdField_c_of_type_Int + this.d;
    int n = ((Rect)localObject).width() + i1;
    this.jdField_c_of_type_Luu.a(i1, ((Rect)localObject).top, n, ((Rect)localObject).bottom);
  ...
  public void a(int paramInt)
  {
    if (this.jdField_a_of_type_Int != paramInt)
    {
      ...
      int i1 = paramInt;
      paramInt = i2;
      while (paramInt < this.jdField_a_of_type_ArrayOfLuu.length)
      {
        i2 = i1 / n;
        if (this.jdField_a_of_type_ArrayOfLuz != null) {
          this.jdField_a_of_type_ArrayOfLuu[paramInt].a = this.jdField_a_of_type_ArrayOfLuz[i2];
        }
        i1 %= n;
        n /= 10;
        paramInt += 1;
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    while (n < this.jdField_a_of_type_ArrayOfLuu.length)
    {
      this.jdField_a_of_type_ArrayOfLuu[n].b(paramInt1, paramInt2, paramInt3, paramInt4);
      n += 1;
    }
    this.h = paramInt1;
    this.i = paramInt2;
  ...
  public void a(long paramLong)
  {
    ...
    else
    {
      ...
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Luu.a(n);
        this.jdField_b_of_type_Luu.a(n);
        this.jdField_c_of_type_Luu.a(n);
        localObject = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131373488);
        ...
        localObject = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131373489);
  ...
  public void a(Canvas paramCanvas, Paint paramPaint)
  {
    ...
    while (n < this.jdField_a_of_type_ArrayOfLuu.length)
    {
      this.jdField_a_of_type_ArrayOfLuu[n].a(paramCanvas, paramPaint);
      n += 1;
    }
    this.jdField_a_of_type_Luu.a(paramCanvas, paramPaint);
    paramCanvas.save();
    paramCanvas.clipPath(this.jdField_a_of_type_AndroidGraphicsPath);
    this.jdField_b_of_type_Luu.a(paramCanvas, paramPaint);
    this.jdField_c_of_type_Luu.a(paramCanvas, paramPaint);
    paramCanvas.restore();
    paramCanvas.restore();
  }
  ...
  {
    this.jdField_a_of_type_Luu.a = new luz(paramAVRedPacketManager.a("qav_redpacket_progressbar_bg.png"));
    this.jdField_b_of_type_Luu.a = new luz(paramAVRedPacketManager.a("qav_redpacket_progressbar_red.png"));
    this.jdField_c_of_type_Luu.a = new luz(paramAVRedPacketManager.a("qav_redpacket_progressbar_yellow.png"));
    this.jdField_a_of_type_ArrayOfLuz = paramArrayOfluz;
    int n = 0;
    while (n < this.jdField_a_of_type_ArrayOfLuu.length)
    {
      this.jdField_a_of_type_ArrayOfLuu[n].a = this.jdField_a_of_type_ArrayOfLuz[0];
      n += 1;
    }
  }
  ...
  public void a(boolean paramBoolean, AVRedPacketManager paramAVRedPacketManager)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_AndroidGraphicsBitmap != null) {
        localView.setBackgroundDrawable(mtz.a(paramAVRedPacketManager, this.jdField_a_of_type_AndroidGraphicsBitmap, 2131166032));
      }
  ...
  public void b()
  {
    ...
    this.jdField_b_of_type_Luu.b();
    this.jdField_c_of_type_Luu.b();
    ...
    this.jdField_a_of_type_ArrayOfLuu = null;
    this.jdField_a_of_type_Luu = null;
    this.jdField_b_of_type_Luu = null;
    this.jdField_c_of_type_Luu = null;
  ...
  public void c()
  {
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131373488).getLayoutParams();
    localLayoutParams.width = (this.h * 52 / 750);
    localLayoutParams.height = (this.h * 52 / 750);
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131373489).getLayoutParams();
