...
public final class bjbq
{
  ...
  public static void a(Activity paramActivity)
  {
    ...
    if (DeviceProfileManager.a(paramActivity, arrayOfInteger, new alrg()) >= arrayOfInteger.length)
    {
  ...
  public static void a(Context paramContext)
  {
    ...
    localBusinessTask.a(new bjbr(paramContext), true);
    localBusinessTask.a();
  }
