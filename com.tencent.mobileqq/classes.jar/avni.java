  ...
  implements Manager
{
  ...
  private aqas jdField_a_of_type_Aqas;
  ...
  public avni(QQAppInterface paramQQAppInterface)
  {
  ...
  private int a()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Long == 0L) {
        this.jdField_a_of_type_Long = bfyz.n(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
      }
      if (localLong.longValue() - this.jdField_a_of_type_Long > 86400000L)
      {
        this.jdField_a_of_type_Long = bfzl.a(localLong.longValue());
        bfyz.l(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), this.jdField_a_of_type_Long);
        bfyz.ai(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), 0);
        this.d = 0;
        if (QLog.isColorLevel()) {
      ...
      {
        this.d = bfyz.aW(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
        if (QLog.isColorLevel()) {
  ...
  private boolean a(SessionInfo paramSessionInfo)
  {
    ...
    for (String str = paramSessionInfo.curFriendUin;; str = "") {
      for (;;)
      {
        if ((QLog.isColorLevel()) && (TextUtils.isEmpty(str))) {
          QLog.d("PushNotificationManager", 2, "sessionInfo.curType=" + paramSessionInfo.curType + " uin==null sessionInfo.realTroopUin=" + paramSessionInfo.realTroopUin);
        }
        if (QLog.isColorLevel()) {
        ...
        try
        {
          ...
          if ((localList == null) || (localList.size() == 0))
          {
            ...
            paramSessionInfo = new PushSwitchGrayTipsInfo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), str, paramSessionInfo.curType, this.jdField_a_of_type_Long, 1);
  ...
  private void b(SessionInfo paramSessionInfo, int paramInt)
  {
    ...
    for (str1 = a().b();; str1 = a().d())
    {
      do
      {
        aucf localaucf = new aucf(paramSessionInfo.curFriendUin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), str2, paramSessionInfo.curType, -5023, 655383, 0L);
        if (paramSessionInfo.curType == 0) {
          localaucf.jdField_a_of_type_Long = (bbko.a() + 1L);
        }
        ...
        if (i >= 0)
        {
          ...
          localaucf.a(i, str1.length() + i, paramSessionInfo);
        }
        paramSessionInfo = new MessageForUniteGrayTip();
        paramSessionInfo.initGrayTipMsg(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localaucf);
        aucg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSessionInfo);
        bcef.b(null, "dc00898", "", "", "0X8009ACE", "0X8009ACE", paramInt, paramInt, "", "", "", "");
        if (QLog.isColorLevel()) {
          QLog.d("PushNotificationManager", 2, "add gray tip =" + str2 + " fromType=" + paramInt);
        }
        return;
      } while ((paramSessionInfo.curType != 1) && (paramSessionInfo.curType != 3000));
      str2 = a().c();
    }
  }
  ...
  public aqas a()
  {
    ...
    {
      this.jdField_a_of_type_Aqas = new aqas();
      this.jdField_a_of_type_Aqas.a(false);
      if (QLog.isColorLevel()) {
        QLog.d("PushNotificationManager", 2, "pushNotificationBean=null, general new bean");
      }
    }
    return this.jdField_a_of_type_Aqas;
  }
  
  public void a(aqas paramaqas)
  {
    this.jdField_a_of_type_Aqas = paramaqas;
  }
  ...
  public void a(SessionInfo paramSessionInfo, int paramInt)
  {
    ...
    while (!QLog.isColorLevel())
    {
      ...
      this.d += 1;
      bfyz.ai(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), this.d);
