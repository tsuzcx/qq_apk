...
public class bbgg
{
  ...
  public static void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      bhsi.a(BaseApplicationImpl.getApplication().getSharedPreferences("CaptureUtil", 4).edit().putBoolean("capture_shared_gesture_recognize_result", paramBoolean1));
  ...
  public static boolean a()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bdmc.a(BaseApplicationImpl.getContext()).a(null, "actMediaCodecSupport", bool, 0L, 0L, localHashMap, "");
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        if (!jdField_a_of_type_Boolean)
        {
          ...
          int j = bork.a(borf.b);
          bpam.d("CaptureUtil", "PtvFilterSoLoad.getFilterSoState result = " + j);
          bpam.d("CaptureUtil", "[loadEffectSo] base so load start ");
          if (j != 1) {
            continue;
          }
          bool2 = bork.c();
