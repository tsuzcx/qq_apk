  ...
  extends Dialog
{
  ...
  private BaseAdapter adapter = new bbgh(this);
  ...
  ListView list;
  private bbgr mBrandColorManager = new bbgr(null);
  ...
  @TargetApi(14)
  public bbgg(Context paramContext)
  {
    super(paramContext);
  ...
  @TargetApi(14)
  public bbgg(Context paramContext, int paramInt)
  {
  ...
  @TargetApi(14)
  protected bbgg(Context paramContext, boolean paramBoolean, DialogInterface.OnCancelListener paramOnCancelListener)
  {
  ...
  {
    bbgi localbbgi = new bbgi(paramActivity);
    showPermissionSettingDialog(paramActivity, paramString1, paramString2, localbbgi, localbbgi, null);
  }
  ...
  public static void showPermissionSettingDialog(Activity paramActivity, String paramString1, String paramString2, DialogInterface.OnClickListener paramOnClickListener1, DialogInterface.OnClickListener paramOnClickListener2, DialogInterface.OnCancelListener paramOnCancelListener)
  {
    ...
    {
      paramActivity = ajyc.a(2131710203);
    }
    ...
    {
      paramActivity = ajyc.a(2131710195);
    }
    localbbgg.setMessage(paramActivity);
    localbbgg.setNegativeButton(ajyc.a(2131710202), paramOnClickListener1);
    localbbgg.setPositiveButton(ajyc.a(2131710187), paramOnClickListener2);
    localbbgg.setOnCancelListener(paramOnCancelListener);
    localbbgg.show();
  }
  
  public bbgg addCenterView(View paramView, LinearLayout.LayoutParams paramLayoutParams)
  {
  ...
  public bbgg addView(View paramView)
  {
    this.text.setVisibility(8);
  ...
  public bbgg addView(View paramView, LinearLayout.LayoutParams paramLayoutParams)
  {
    this.text.setVisibility(8);
    this.countText.setVisibility(8);
    this.bodyLayout.addView(paramView, paramLayoutParams);
  ...
  public void adjustMessageBottomMargin(float paramFloat)
  {
    if (this.bodyLayout != null)
    {
      ...
      localLayoutParams.bottomMargin = axli.a(paramFloat);
  ...
  public void adjustMessageTopBottomMargin(float paramFloat1, float paramFloat2)
  {
    ...
    {
      RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)this.bodyLayout.getLayoutParams();
      localLayoutParams.bottomMargin = axli.a(paramFloat2);
      localLayoutParams.topMargin = axli.a(paramFloat1);
      this.bodyLayout.setLayoutParams(localLayoutParams);
    }
  }
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 270	zzs:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 270	zzs:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 270	zzs:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
  ...
  {
    return (TextView)findViewById(2131365149);
  }
  ...
  public bbgg setCheckBox(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    findViewById(2131368929).setVisibility(0);
    this.checkTxt.setText(paramString);
    if (this.checkBox != null) {
      this.checkBox.setOnCheckedChangeListener(new bbgk(this, paramOnClickListener));
    }
    setSeperatorState();
    return this;
  }
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.title = ((TextView)findViewById(2131365151));
    this.text = ((TextView)findViewById(2131365147));
    this.dialogEdit = ((EditText)findViewById(2131365132));
    this.countText = ((TextView)findViewById(2131365125));
    this.dummyFirstPreviewImage = ((TextView)findViewById(2131365419));
    ...
    this.mVideoIcon = ((ImageView)findViewById(2131379002));
    this.mVideoSize = ((TextView)findViewById(2131369589));
    this.mVideoTime = ((TextView)findViewById(2131369590));
    this.lBtn = ((TextView)findViewById(2131365136));
    this.rBtn = ((TextView)findViewById(2131365142));
    this.editPicTag = ((TextView)findViewById(2131365133));
    this.progressBar = ((ProgressBar)findViewById(2131365177));
    this.lBtn.setVisibility(8);
    this.rBtn.setVisibility(8);
    this.bodyLayout = ((LinearLayout)findViewById(2131363315));
    this.checkBox = ((CheckBox)findViewById(2131377619));
    this.mSwitch = ((FormSwitchItem)findViewById(2131377621));
    this.checkTxt = ((TextView)findViewById(2131378452));
    this.list = ((ListView)findViewById(2131369266));
    this.rootView = ((ViewGroup)findViewById(2131365143));
    if ((this.list != null) && (Build.VERSION.SDK_INT >= 9)) {
      this.list.setOverScrollMode(2);
    }
    this.mBrandColorManager.a(findViewById(2131365110));
  }
  ...
  public bbgg setFirstDummyPreviewImage(Drawable paramDrawable)
  {
  ...
  public bbgg setImageOnClickListener(View.OnClickListener paramOnClickListener)
  {
  ...
  public bbgg setItems(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
  ...
  public bbgg setItems(String[] paramArrayOfString, DialogInterface.OnClickListener paramOnClickListener)
  {
  ...
  public bbgg setMessage(int paramInt)
  {
  ...
  public bbgg setMessage(CharSequence paramCharSequence)
  {
  ...
  public bbgg setMessageCount(String paramString)
  {
    if (paramString != null)
    {
  ...
  public bbgg setMessageMaxLine(int paramInt)
  {
    if (this.text != null)
    {
  ...
  public bbgg setMessageWithEmo(String paramString, float paramFloat)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      this.text.setText(new ayki(paramString, 3));
  ...
  public bbgg setMessageWithUrl(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
  ...
  public bbgg setMessageWithoutAutoLink(CharSequence paramCharSequence)
  {
    if (!TextUtils.isEmpty(paramCharSequence))
    {
      this.text.setMovementMethod(LinkMovementMethod.getInstance());
  ...
  public bbgg setMsgMaxLineWithEnd(String paramString, int paramInt)
  {
    if (this.text != null)
    {
      this.text.setMaxLines(paramInt);
      this.text.getViewTreeObserver().addOnGlobalLayoutListener(new bbgj(this, paramInt, paramString));
    }
    return this;
  }
  ...
  public bbgg setNegativeButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new bbgp(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  
  public bbgg setNegativeButton(String paramString, int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
      this.lBtn.setVisibility(8);
  ...
  public bbgg setNegativeButton(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
      this.lBtn.setVisibility(8);
    ...
    this.lBtn.setVisibility(0);
    this.lBtn.setOnClickListener(new bbgm(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public bbgg setOperateImage(Drawable paramDrawable)
  {
  ...
  public bbgg setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.rBtn.setOnClickListener(new bbgq(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  
  public bbgg setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener, boolean paramBoolean)
  {
    if (paramOnClickListener == null)
    {
      this.rBtn.setVisibility(8);
    ...
    this.rBtn.setVisibility(0);
    this.rBtn.setOnClickListener(new bbgo(this, paramOnClickListener, paramBoolean));
    setSeperatorState();
    return this;
  }
  
  public bbgg setPositiveButton(String paramString, int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
      this.rBtn.setVisibility(8);
  ...
  public bbgg setPositiveButton(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
      this.rBtn.setVisibility(8);
    ...
    this.rBtn.setVisibility(0);
    this.rBtn.setOnClickListener(new bbgn(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public bbgg setPreviewFixDimension(int paramInt1, int paramInt2)
  {
    ...
    localMarginLayoutParams.topMargin = actn.a(12.0F, this.framePreview.getResources());
    this.framePreviewImage.getLayoutParams().width = paramInt1;
    this.framePreviewImage.getLayoutParams().height = paramInt2;
    return this;
  }
  
  public bbgg setPreviewImage(Drawable paramDrawable)
  {
    return setPreviewImage(paramDrawable, false, 0);
  }
  
  public bbgg setPreviewImage(Drawable paramDrawable, boolean paramBoolean, int paramInt)
  {
  ...
  public bbgg setPreviewImageScaleType(boolean paramBoolean)
  {
  ...
  public bbgg setSwitch(String paramString, boolean paramBoolean, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (this.mSwitch != null)
    {
      ...
      if (paramOnClickListener != null) {
        this.mSwitch.setOnCheckedChangeListener(new bbgl(this, paramOnClickListener));
      }
    }
    return this;
  }
  ...
  public bbgg setText(String paramString, int paramInt)
  {
  ...
  public bbgg setTitle(String paramString)
  {
    if (paramString != null)
    {
  ...
  public bbgg setTitleWithEmo(CharSequence paramCharSequence)
  {
  ...
  public bbgg setVideoFormat(boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2)
  {
  ...
  public bbgg setView(View paramView)
  {
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, -2);
    this.bodyLayout.addView(paramView, localLayoutParams);
    return this;
