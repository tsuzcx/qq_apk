  ...
  extends azpo
{
  ...
  public azpq(azpl paramazpl, int paramInt)
  {
    super(paramazpl, paramInt);
    this.jdField_b_of_type_ComTencentMobileqqHighwayApiITransactionCallback = new azpr(this);
  }
  
  public void a()
  {
    String str1 = this.jdField_a_of_type_Azpl.jdField_b_of_type_JavaLangString;
    String str2 = this.jdField_a_of_type_Azpl.jdField_a_of_type_JavaLangString;
  ...
  protected boolean b(String paramString)
  {
    ...
    {
      arrayOfByte = akqi.a(paramString);
    ...
    do
    {
      ...
      localPttShortVideoFileInfo.uint32_file_time.set((int)this.jdField_a_of_type_Azpl.jdField_a_of_type_Long);
