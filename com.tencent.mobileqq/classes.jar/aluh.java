...
public class aluh
{
  ...
  private almg jdField_a_of_type_Almg = new alui(this);
  ...
  public aluh(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a()
  {
    ...
    if (amjd.a((ProxyManager)localObject2, "mr_dataline_printer")) {
      ((ProxyManager)localObject2).a((awbw)localObject1);
    }
    long l = 2147483647L;
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0) {
      l = ((PrinterItemMsgRecord)this.jdField_a_of_type_JavaUtilArrayList.get(0)).msgId;
    }
    localObject2 = ((awbw)localObject1).a(PrinterItemMsgRecord.class, "select * from mr_dataline_printer where msgid<? order by msgid desc limit 5", new String[] { String.valueOf(l) });
    ((awbw)localObject1).a();
  ...
  {
    if (!allz.a(paramSession, "printer")) {}
    Object localObject;
    do
    {
      do
      {
        ...
        ((PrinterItemMsgRecord)localObject).time = ayvc.a();
  ...
  {
    Object localObject = (alxb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(10);
    if ((((alxb)localObject).a() == 0) || (((alxb)localObject).e() != 1))
    {
      paramallz.a(12, false, null);
      if (this.jdField_a_of_type_JavaUtilHashMap.size() > 0)
      {
        localObject = new Timer();
        ((Timer)localObject).schedule(new PrinterHandler.1(this, paramallz, (Timer)localObject), 5000L);
      }
    }
  }
  
  public void a(allz paramallz, msg_comm.Msg paramMsg, C2CType0x211_SubC2CType0x9.MsgBody paramMsgBody)
  {
    boolean bool = false;
    int j;
    int i;
    ...
    case 2: 
      do
      {
        ...
        paramMsg = (aluk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(74);
        paramMsg.a(false);
      ...
      if ((((alxb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(10)).a() != 0) && (this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0)) {
        paramMsg.a(true);
      }
      paramallz.a(12, false, null);
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004022", "0X8004022", 0, 0, "", "", "", "");
      return;
    case 3: 
      j = -1;
    ...
    for (;;)
    {
      ...
      paramallz.a(18, bool, Long.valueOf(l));
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004021", "0X8004021", (int)l, i, "", "", "", "");
      return;
      ...
      else
      {
        ...
        paramallz.notifyUI(19, true, new Object[] { Long.valueOf(paramMsg.uint64_printer_din.get()), paramMsg.str_printer_qr_pic_url.get(), paramMsg.str_printer_qr_open_url.get(), paramMsg.str_printer_tip_url.get() });
        return;
      }
      label579:
      l = 0L;
  ...
  public void a(BaseActivity paramBaseActivity, String paramString)
  {
    if (arni.a())
    {
      if (bdcs.a(paramString) > aqxg.a())
      {
        armv.a(paramBaseActivity, 2131692752, 2131692757, new aluj(this, paramBaseActivity, paramString));
        return;
      }
      ...
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004059", "0X8004059", 0, 0, "", "", "", "");
      return;
    }
  ...
  public void a(PrinterItemMsgRecord paramPrinterItemMsgRecord)
  {
    ...
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004021", "0X8004021", (int)paramPrinterItemMsgRecord.uSessionID, -2, "", "", "", "");
  ...
  public String[] a()
  {
    if ((((aluk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(74)).a()) && (this.b != null))
    {
