...
public abstract class besx
  extends Binder
  implements besw
{
  public static besw a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.uodis.opendevice.aidl.OpenDeviceIdentifierService");
    if ((localIInterface != null) && ((localIInterface instanceof besw))) {
      return (besw)localIInterface;
    }
    return new besy(paramIBinder);
  }
