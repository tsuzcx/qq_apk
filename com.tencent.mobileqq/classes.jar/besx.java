...
{
  private static besx jdField_a_of_type_Besx;
  private static byte[] jdField_a_of_type_ArrayOfByte = new byte[1];
  private static final String jdField_b_of_type_JavaLangString = antf.cu + "fmtSrvAddr.ini";
  private static final String c = antf.cu + "srvAddr.ini";
  private static final String d = antf.cu + "ipDownAddr.ini";
  private static final String e = antf.cu + "ipDownAddr.tmp";
  private int jdField_a_of_type_Int = 0;
  private long jdField_a_of_type_Long = -1L;
  private FileStoragePushFSSvcList jdField_a_of_type_ConfigPushFileStoragePushFSSvcList = b();
  private balx jdField_a_of_type_Balx = new balx();
  private besy jdField_a_of_type_Besy = new besy();
  private besz jdField_a_of_type_Besz = new besz(this);
  private bexv jdField_a_of_type_Bexv = new bexv();
  ...
  public static besx a()
  {
    if (jdField_a_of_type_Besx == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Besx == null) {
        jdField_a_of_type_Besx = new besx();
      }
      return jdField_a_of_type_Besx;
    }
  }
  ...
  private byte[] a(besy parambesy)
  {
    ...
    if (parambesy != null)
    {
      ...
      if ((parambesy.jdField_a_of_type_JavaUtilArrayList == null) || (parambesy.jdField_a_of_type_JavaUtilArrayList.size() <= 0)) {
        break label842;
      }
      localObject1 = new byte[parambesy.jdField_a_of_type_JavaUtilArrayList.size()][];
      localObject2 = localObject3;
      if (parambesy.jdField_b_of_type_JavaUtilArrayList != null)
      {
        localObject2 = localObject3;
        if (parambesy.jdField_b_of_type_JavaUtilArrayList.size() > 0) {
          localObject2 = new byte[parambesy.jdField_b_of_type_JavaUtilArrayList.size()][];
        }
      }
    ...
    for (;;)
    {
      try
      {
        if (parambesy.jdField_a_of_type_JavaLangString == null) {
          break label836;
        }
        localDataOutputStream.writeUTF(parambesy.jdField_a_of_type_JavaLangString);
        localObject3 = localByteArrayOutputStream.toByteArray();
        localByteArrayOutputStream.reset();
        k = 0 + (localObject3.length + 3);
        j = 1;
        if (parambesy.jdField_b_of_type_JavaLangString == null) {
          break label830;
        }
        localDataOutputStream.writeUTF(parambesy.jdField_b_of_type_JavaLangString);
        ...
        m = k;
        Object localObject4;
        if (parambesy.jdField_a_of_type_JavaUtilArrayList != null)
        {
          i = j;
          m = k;
          if (parambesy.jdField_a_of_type_JavaUtilArrayList.size() > 0)
          {
            m = 0;
            i = k;
            k = m;
            if (k >= parambesy.jdField_a_of_type_JavaUtilArrayList.size()) {
              break label845;
            }
            localObject4 = (FileStorageServerListInfo)parambesy.jdField_a_of_type_JavaUtilArrayList.get(k);
        ...
        if ((parambesy.jdField_b_of_type_JavaUtilArrayList != null) && (parambesy.jdField_b_of_type_JavaUtilArrayList.size() > 0))
        {
          k = 0;
          j = m;
          if (k >= parambesy.jdField_b_of_type_JavaUtilArrayList.size()) {
            break label853;
          }
          localObject4 = (FileStorageServerListInfo)parambesy.jdField_b_of_type_JavaUtilArrayList.get(k);
          localDataOutputStream.writeInt(((FileStorageServerListInfo)localObject4).iPort);
          localDataOutputStream.writeUTF(((FileStorageServerListInfo)localObject4).sIP);
          ...
          {
            parambesy[2] = 1;
            localObject4 = bhvd.a((short)localObject3.length);
            System.arraycopy(localObject4, 0, parambesy, 3, localObject4.length);
            i = localObject4.length + 3;
            System.arraycopy(localObject3, 0, parambesy, i, localObject3.length);
          ...
          if (arrayOfByte != null)
          {
            parambesy[j] = 2;
            i = j + 1;
            localObject3 = bhvd.a((short)arrayOfByte.length);
            System.arraycopy(localObject3, 0, parambesy, i, localObject3.length);
            i += localObject3.length;
            System.arraycopy(arrayOfByte, 0, parambesy, i, arrayOfByte.length);
          ...
          if (localObject1 != null)
          {
            ...
            if (localObject1.length > 0)
            {
              ...
              if (k < localObject1.length)
              {
                parambesy[i] = 3;
                i += 1;
                localObject3 = bhvd.a((short)localObject1[k].length);
                System.arraycopy(localObject3, 0, parambesy, i, localObject3.length);
                i += localObject3.length;
                System.arraycopy(localObject1[k], 0, parambesy, i, localObject1[k].length);
          ...
          if ((localObject2 != null) && (localObject2.length > 0))
          {
            ...
            if (i < localObject2.length)
            {
              parambesy[j] = 4;
              j += 1;
              localObject1 = bhvd.a((short)localObject2[i].length);
              System.arraycopy(localObject1, 0, parambesy, j, localObject1.length);
              j += localObject1.length;
              System.arraycopy(localObject2[i], 0, parambesy, j, localObject2[i].length);
      ...
      catch (Throwable parambesy)
      {
        parambesy = parambesy;
        parambesy.printStackTrace();
        return null;
      }
      finally
      {
  ...
  {
    // Byte code:
    //   0: getstatic 54	besx:c	Ljava/lang/String;
    //   3: invokestatic 302	bhmi:a	(Ljava/lang/String;)Ljava/io/File;
    //   6: astore_2
    //   7: aload_2
  ...
  private ArrayList<FileStorageServerListInfo> b(int paramInt)
  {
    if (this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList != null)
    {
      ...
      return this.jdField_a_of_type_Besy.a(this.jdField_a_of_type_Balx.b());
    }
  ...
  private void c(FileStoragePushFSSvcList paramFileStoragePushFSSvcList)
  {
    ...
    //   5: aload_3
    //   6: astore_2
    //   7: getstatic 50	besx:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   10: invokestatic 302	bhmi:a	(Ljava/lang/String;)Ljava/io/File;
    //   13: astore 5
    //   15: aload_1
    //   16: ifnonnull +79 -> 95
    //   19: aload_3
    ...
    //   145: dup
    //   146: getstatic 54	besx:c	Ljava/lang/String;
        ...
        if ((this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList != null) && (this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList.domainIpChannel != null) && (this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList.domainIpChannel.vDomain_iplists != null))
        {
          ...
          if (i < this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList.domainIpChannel.vDomain_iplists.size())
          {
            ...
            if (i < ((ArrayList)localObject2).size())
            {
              ...
              ((FileStorageServerListInfo)localObject3).sIP = bhnv.a(((DomainIpInfo)((ArrayList)localObject2).get(i)).uIp);
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_Besz.a(this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList);
  ...
  private void e()
  {
    this.jdField_a_of_type_Besy = new besy();
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_Besy = a(this.jdField_a_of_type_ConfigPushFileStoragePushFSSvcList.pttlist);
  }
  ...
  public balx a()
  {
    return this.jdField_a_of_type_Balx;
  }
  
  /* Error */
  public besy a(byte[] paramArrayOfByte)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 11
    ...
    //   21: aload_0
    //   22: aload_1
    //   23: invokevirtual 570	besx:a	([B)Z
    //   26: ifne +15 -> 41
    //   29: new 77	besy
    //   32: dup
    //   33: invokespecial 78	besy:<init>	()V
    //   36: astore 9
    //   38: aload 9
    //   40: areturn
    //   41: aload 10
    ...
    //   106: new 77	besy
    //   109: dup
    //   110: invokespecial 78	besy:<init>	()V
    //   113: astore 15
    //   115: aload_1
    //   116: iconst_1
    //   117: baload
    ...
    //   163: aload 9
    //   165: iconst_0
    //   166: invokestatic 575	bhjx:a	([BI)S
    //   169: istore 6
    //   171: aload_1
    //   172: iload_3
    //   173: iload 6
    ...
    //   220: putfield 251	besy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   223: aload 9
    //   225: astore 8
    //   227: aload 10
    //   229: astore 9
    ...
    //   340: putfield 260	besy:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   381: astore 11
    //   383: aload 15
    //   385: getfield 592	besy:jdField_b_of_type_ArrayOfInt	[I
    //   388: iconst_0
    //   389: aload 9
    ...
    //   409: astore 11
    //   411: aload 15
    //   413: getfield 592	besy:jdField_b_of_type_ArrayOfInt	[I
    //   416: iconst_1
    //   417: aload 9
    ...
    //   458: new 77	besy
    //   461: dup
    //   462: invokespecial 78	besy:<init>	()V
    //   465: astore 12
    //   467: aload 8
    //   469: ifnull +8 -> 477
    //   472: aload 8
    ...
    //   552: aload 15
    //   554: getfield 238	besy:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   580: goto -349 -> 231
    //   583: aload 15
    //   585: getfield 242	besy:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
  ...
  public bexv a()
  {
    return this.jdField_a_of_type_Bexv;
  }
  ...
  public String a()
  {
    ...
    try
    {
      FileStorageServerListInfo localFileStorageServerListInfo = this.jdField_a_of_type_Besz.a();
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_Besy.a(this.jdField_a_of_type_Balx.b(), paramString);
        if (QLog.isDevelopLevel()) {
      ...
      this.jdField_a_of_type_Besz.a(paramInt, paramString);
    }
  }
  ...
  public byte[] a(long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 98	besx:jdField_a_of_type_ConfigPushFileStoragePushFSSvcList	LConfigPush/FileStoragePushFSSvcList;
    //   6: ifnull +43 -> 49
    //   9: aload_0
    //   10: getfield 98	besx:jdField_a_of_type_ConfigPushFileStoragePushFSSvcList	LConfigPush/FileStoragePushFSSvcList;
    //   13: getfield 403	ConfigPush/FileStoragePushFSSvcList:bigDataChannel	LConfigPush/BigDataChannel;
    //   16: ifnull +33 -> 49
    //   19: aload_0
    //   20: getfield 98	besx:jdField_a_of_type_ConfigPushFileStoragePushFSSvcList	LConfigPush/FileStoragePushFSSvcList;
    ...
    //   31: ifne +18 -> 49
    //   34: aload_0
    //   35: getfield 98	besx:jdField_a_of_type_ConfigPushFileStoragePushFSSvcList	LConfigPush/FileStoragePushFSSvcList;
  ...
  public byte[] a(byte[] paramArrayOfByte)
  {
    ...
    String str = this.jdField_a_of_type_Balx.b();
    boolean bool = this.jdField_a_of_type_Balx.a();
    if (this.jdField_a_of_type_Besy != null)
    {
      if (!bool) {
        break label58;
      }
      this.jdField_a_of_type_Besy.jdField_a_of_type_JavaUtilArrayList = paramArrayOfByte;
      this.jdField_a_of_type_Besy.jdField_a_of_type_JavaLangString = str;
    }
    for (;;)
    {
      return a(this.jdField_a_of_type_Besy);
      label58:
      this.jdField_a_of_type_Besy.jdField_b_of_type_JavaUtilArrayList = paramArrayOfByte;
      this.jdField_a_of_type_Besy.jdField_b_of_type_JavaLangString = str;
    }
  }
  ...
  public String b(int paramInt)
  {
    ...
    try
    {
      FileStorageServerListInfo localFileStorageServerListInfo = this.jdField_a_of_type_Besz.a(paramInt);
      if (localFileStorageServerListInfo != null)
      {
        localObject1 = new StringBuffer(200);
        ((StringBuffer)localObject1).append("http://").append(localFileStorageServerListInfo.sIP);
