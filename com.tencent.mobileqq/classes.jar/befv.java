  ...
  implements Handler.Callback, NotificationReportController
{
  ...
  private List<befw> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private void a()
  {
    ...
    for (QQAppInterface localQQAppInterface = (QQAppInterface)localObject;; localQQAppInterface = null)
    {
      if ((localQQAppInterface != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
      {
        ...
        {
          befw localbefw = (befw)localIterator.next();
          boolean bool = a(localQQAppInterface, localbefw.b);
          localObject = "";
          switch (localbefw.jdField_a_of_type_Int)
          {
          default: 
            label132:
            if ((localbefw.c == 7200) || (localbefw.c == 1008) || (localbefw.c == 7220)) {
              awqx.a(localQQAppInterface, bool, "tech_push", "push", (String)localObject, "", 0, "", "", localbefw.jdField_a_of_type_JavaLangString, localbefw.b + "", "" + localbefw.c, "", "", "", "");
            }
            break;
          }
          while (QLog.isDevelopLevel())
          {
            QLog.d("NotificationReportControllerImpl", 2, "report real msgType:" + localbefw.jdField_a_of_type_Int + "    frienduin:" + localbefw.jdField_a_of_type_JavaLangString + "   uinType:" + localbefw.c + "    nId:" + localbefw.b);
            break;
            ...
            break label132;
            awqx.a(localQQAppInterface, bool, "tech_push", "push", (String)localObject, "", 0, "", "", "", localbefw.b + "", "", "", "", "", "");
          }
        }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 3: 
    case 4: 
      paramMessage = (befw)paramMessage.obj;
  ...
  public void report(int paramInt1, int paramInt2, String paramString, int paramInt3)
  {
    ...
    localMessage.obj = new befw(paramInt1, paramInt2, paramString, paramInt3);
