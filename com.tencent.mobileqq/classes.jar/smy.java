...
public class smy
  extends sls<stSimpleGetFeedListRsp>
{
  public smy(String paramString1, byte paramByte1, byte paramByte2, ArrayList<String> paramArrayList, int paramInt, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    localstSimpleGetFeedListReq.linkStragetyArgs = snf.a();
    localstSimpleGetFeedListReq.qqNum = sni.a();
    this.a = localstSimpleGetFeedListReq;
    sne.d("RecommendRequest", "stSimpleGetFeedListReq  = " + localstSimpleGetFeedListReq.toString());
  }
}
