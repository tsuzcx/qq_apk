  ...
  implements ArkViewImplement.InputCallback
{
  ...
  public ajaa(ArkAppView paramArkAppView)
  {
  ...
  public void onFocusChanged(View paramView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      Object localObject2 = localArkAppView.getResources().getDrawable(2130838664);
      Object localObject1 = localArkAppView.getResources().getDrawable(2130838663);
  ...
  public void onSelectChanged(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((paramInt1 > 0) && (paramInt2 > 0) && ((paramInt1 < paramInt3) || (paramInt2 < paramInt4)))
    {
      ...
      int i = j;
      if (j <= 0) {
        i = localArkAppView.getResources().getDrawable(2130838664).getIntrinsicWidth();
      }
    ...
    for (;;)
    {
      ...
      paramInt1 = paramInt2;
      if (paramInt2 <= 0) {
        paramInt1 = localArkAppView.getResources().getDrawable(2130838663).getIntrinsicWidth();
      }
  ...
  public void onShowMenu(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt4 == 2)
    {
      localbhuk.a(0, anzj.a(2131699563));
      localbhuk.a(1, anzj.a(2131699559));
      localbhuk.a(2, anzj.a(2131699560));
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow = bhkx.a(paramView, paramInt1, paramInt2, paramInt3 + localArkAppView.getResources().getDrawable(2130838663).getIntrinsicHeight(), localbhuk, new ajab(this, paramInt4, (ArkViewImplement.ArkViewInterface)paramView));
      return;
      if (paramInt4 == 1)
      {
        localbhuk.a(0, anzj.a(2131699562));
        localbhuk.a(1, anzj.a(2131699558));
        localbhuk.a(2, anzj.a(2131699561));
      }
      else
      {
        localbhuk.a(0, anzj.a(2131699564));
      }
    }
  }
}
