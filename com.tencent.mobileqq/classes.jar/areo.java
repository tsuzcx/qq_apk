...
public class areo
{
  ...
  private area jdField_a_of_type_Area;
  arem jdField_a_of_type_Arem = new arep(this);
  public Conversation a;
  boolean jdField_a_of_type_Boolean = true;
  private ViewGroup b;
  
  public areo(Conversation paramConversation, ViewGroup paramViewGroup)
  {
  ...
  private void a(Context paramContext)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      if (this.jdField_a_of_type_Area == null)
      {
        this.jdField_a_of_type_Area = new area("Login.Guide");
        this.jdField_a_of_type_Area.observerOnUiThread = true;
      }
      if (!bool1) {
        akfu.a(this.jdField_a_of_type_Area);
      }
      return;
    }
  }
  
  private void a(arej paramarej)
  {
    ...
    {
      return;
      if (!TextUtils.isEmpty(paramarej.jdField_a_of_type_JavaLangString)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("LoginWelcomeManager", 2, "Bad url: " + paramarej.jdField_a_of_type_JavaLangString);
    return;
    if (QLog.isColorLevel()) {
    ...
    localIntent.putExtra("url", paramarej.jdField_a_of_type_JavaLangString);
    localIntent.putExtra("flag_show_loading_dialog", false);
    localIntent.putExtra("hide_left_button", true);
    localIntent.setData(Uri.parse(paramarej.jdField_a_of_type_JavaLangString));
    localBaseActivity.startActivity(localIntent);
    LoginWelcomeManager.a(this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a).c = false;
    LoginWelcomeManager.a(this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a, paramarej.jdField_a_of_type_Int);
  }
  ...
  private void a(URLDrawable paramURLDrawable)
  {
    ...
    {
      return;
      if ((this.b != null) && (this.b.findViewById(2131299085) == null) && (paramURLDrawable != null) && (paramURLDrawable.getStatus() == 1) && (this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a != null)) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    {
      this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(this.b.getContext()).inflate(2131493309, null));
      Object localObject1 = (ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131298724);
      ((ImageView)localObject1).setContentDescription(ajjy.a(2131640577));
      ((ImageView)localObject1).setOnClickListener(new areq(this));
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a();
      Object localObject2 = (Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131300670);
      ((Button)localObject2).setContentDescription(this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a().getString(2131632970));
      ((Button)localObject2).setOnClickListener(new arer(this, (Activity)localObject1));
      localObject2 = (TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131299726);
      ((TextView)localObject2).setContentDescription(((Activity)localObject1).getString(2131632969));
      ((TextView)localObject2).setOnClickListener(new ares(this, (Activity)localObject1));
      localObject1 = (ThemeImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131299133);
      ((ThemeImageView)localObject1).setMaskShape(beog.b);
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a != null) {
      ((LoginWelcomeManager)this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a.getManager(146)).a(this.jdField_a_of_type_Arem);
    }
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Area != null)
    {
      akfu.b(this.jdField_a_of_type_Area);
      this.jdField_a_of_type_Area = null;
    }
  }
