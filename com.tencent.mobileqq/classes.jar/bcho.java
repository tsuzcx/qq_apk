  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      View localView = paramView.findViewById(2131377871);
      if (localView != null)
      {
        Object localObject1 = localView.getTag(2131377871);
        if ((localObject1 != null) && (StructMsgForGeneralShare.class.isInstance(localObject1)))
        {
          ...
          for (;;)
          {
            for (;;)
            {
              ...
              break;
              if (paramView.getTag(2131377868) == null) {
                break;
              }
              do
              {
                localObject3 = null;
                break;
              } while (paramView.getTag(2131377868) != null);
              break;
              label253:
              ...
              if ((localObject2 != null) && ((localObject2 instanceof QQAppInterface)))
              {
                ...
                anxs.a((QQAppInterface)localObject2, 0, 4, localStructMsgForGeneralShare.message);
                ...
                try
                {
                  ...
                  uei.a((AppInterface)localObject2, localStructMsgForGeneralShare.message.selfuin, ((JSONObject)localObject4).toString(), "" + localStructMsgForGeneralShare.msgId);
                  Object localObject5 = (ofx)((QQAppInterface)localObject2).getManager(88);
                  localObject4 = (ogr)((QQAppInterface)localObject2).getBusinessHandler(88);
                  if ((localStructMsgForGeneralShare.message != null) && (localObject5 != null) && (localObject4 != null) && (((ofx)localObject5).a(localStructMsgForGeneralShare.message.senderuin)))
                  {
                    localObject5 = localStructMsgForGeneralShare.message;
                    if (TextUtils.isEmpty(localStructMsgForGeneralShare.index))
                    {
                      i = 0;
                      ((ogr)localObject4).a(false, (MessageRecord)localObject5, i, localStructMsgForGeneralShare.mMsgUrl);
                    }
                  }
                  else
                  {
                    ...
                    {
                      bcef.b((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", localStructMsgForGeneralShare.uin, "mp_msg_msgpic_click", "aio_morpic_click", 0, 0, "", "", Long.toString(localStructMsgForGeneralShare.msgId), "");
                    ...
                    if ((localObject3 != null) && (((agpx)localObject3).a != null)) {
                      npn.a((QQAppInterface)localObject2, "", "click", localStructMsgForGeneralShare.mSourceAppid, localStructMsgForGeneralShare.mMsgServiceID, npn.a(((agpx)localObject3).a.curType));
                    }
                    ...
                    bcef.b((QQAppInterface)localObject2, "CliOper", "", "", "0X800567A", "0X800567A", 0, 0, localStructMsgForGeneralShare.mMsgServiceID + "", "", "", "");
                    if (localStructMsgForGeneralShare.uinType != 1008) {
                      break label1678;
                    }
                    j = 2;
                    bcef.b((QQAppInterface)localObject2, "CliOper", "", "", "0X8004B5C", "0X8004B5C", j, 0, "", String.valueOf(i), (String)localObject4, localStructMsgForGeneralShare.source_puin);
                    bcef.b(null, "dc00898", "", "", "0X800A630", "0X800A630", 0, 0, "1", ForwardUtils.toTypeSimple(localStructMsgForGeneralShare.uinType), localStructMsgForGeneralShare.mContentTitle, String.valueOf(localStructMsgForGeneralShare.mSourceAppid));
                    ...
                    if ((localView instanceof ViewGroup))
                    {
                      ...
                      if ((localObject4 != null) && ((localObject4 instanceof TextViewWrapLayout)))
                      {
                        ...
                        if ((localObject4 != null) && ((localObject4 instanceof bcjp))) {
                          bcef.b((QQAppInterface)localObject2, "dc00898", "", "", "0X8007C38", "0X8007C38", 0, 0, ((bcjp)localObject4).o + "", "", "", "");
                        }
                      }
                    }
                    if ((localObject3 != null) && (localStructMsgForGeneralShare.hasFlag(16)))
                    {
                      ...
                      ThreadManager.post(new StructMsgForGeneralShare.5.2(this, (agpx)localObject3, (QQAppInterface)localObject2), 2, null, false);
                    }
                    if ((localStructMsgForGeneralShare != null) && (localObject3 != null) && (((agpx)localObject3).a != null) && ((((agpx)localObject3).a.curType == 1025) || (((agpx)localObject3).a.curType == 0)) && (!TextUtils.isEmpty(localStructMsgForGeneralShare.mMsgAction)) && (nns.b(((agpx)localObject3).a.curFriendUin)) && ((localStructMsgForGeneralShare.mMsgServiceID != 92) || (localStructMsgForGeneralShare.message == null))) {}
                  }
                  try
                  {
                    if (QLog.isColorLevel()) {
                    ...
                    if (!localStructMsgForGeneralShare.mQidianBulkTaskId.equals("0"))
                    {
                      ...
                      ((bing)((QQAppInterface)localObject2).getBusinessHandler(85)).a(((JSONObject)localObject4).toString(), localStructMsgForGeneralShare.message.frienduin, "", 10009, 0);
                    }
                  }
                  ...
                  ((bily)((QQAppInterface)localObject2).getManager(165)).a(localStructMsgForGeneralShare.mMsgAction, localStructMsgForGeneralShare.mMsg_A_ActionData, localStructMsgForGeneralShare.mMsgActionData, localStructMsgForGeneralShare.mMsgUrl, 0, "");
                  if ((localObject3 != null) && (ugf.a(((agpx)localObject3).a)) && (localStructMsgForGeneralShare.message != null)) {
                    bcef.b(null, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "public.message.click", 0, 0, localStructMsgForGeneralShare.message.time + "", "", "", localStructMsgForGeneralShare.mMsgBrief);
                  }
                  if (localChatFragment != null)
                  {
                  ...
                  StructMsgForGeneralShare.onClickEvent((QQAppInterface)localObject2, localContext, localStructMsgForGeneralShare, paramView, new bcht((QQAppInterface)localObject2, paramView, localStructMsgForGeneralShare));
                }
                catch (JSONException localJSONException)
                {
                  for (;;)
                  {
                    ...
                    else
                    {
                      ...
                      j = 1;
                      continue;
                      if ((localStructMsgForGeneralShare != null) && (localObject3 != null) && (((agpx)localObject3).a != null) && (!TextUtils.isEmpty(localStructMsgForGeneralShare.mMsgAction)) && (((agpx)localObject3).a.curType == 1024)) {
                        ((bily)((QQAppInterface)localObject2).getManager(165)).a(localStructMsgForGeneralShare.mMsgAction, localStructMsgForGeneralShare.mMsg_A_ActionData, localStructMsgForGeneralShare.mMsgActionData, localStructMsgForGeneralShare.mMsgUrl, 1, "");
                      }
                    }
                  }
                }
