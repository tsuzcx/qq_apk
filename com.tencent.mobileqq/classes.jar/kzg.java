...
{
  public kzg(PublicAccountManager paramPublicAccountManager, NewIntent paramNewIntent, QQAppInterface paramQQAppInterface, String paramString, Context paramContext, BusinessObserver paramBusinessObserver) {}
      ...
      try
      {
        for (;;)
        {
          ...
          try
          {
            ...
            {
              ThreadManager.executeOnSubThread(new kzh(this, localGetPublicAccountMenuResponse, paramInt, paramBoolean, paramBundle));
              return;
              l = 0L;
              break label101;
              label503:
