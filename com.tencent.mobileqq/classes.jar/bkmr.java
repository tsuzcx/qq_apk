  ...
  implements bkmq
{
  ...
  public static bkmq a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("cooperation.qlink.IQlinkService");
    if ((localIInterface != null) && ((localIInterface instanceof bkmq))) {
      return (bkmq)localIInterface;
    }
    return new bkms(paramIBinder);
  }
