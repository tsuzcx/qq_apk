...
public class mml
{
  ...
  {
    paramQQAppInterface = aoot.a(paramQQAppInterface, paramString, (byte)2).b();
  ...
  public static void a(QQAppInterface paramQQAppInterface, View paramView, Message paramMessage, boolean paramBoolean)
  {
    ...
    View localView = paramView.findViewById(2131371532);
    TextView localTextView = (TextView)paramView.findViewById(2131371511);
    ImageView localImageView = (ImageView)paramView.findViewById(2131371510);
    int i;
    int j;
    boolean bool;
    if ((paramMessage != null) && (paramMessage.obj != null))
    {
      ...
      localObject = (LinearLayout)paramView.findViewById(2131371507);
      if (i == 2)
      {
        paramMessage = paramQQAppInterface.a().a(l);
        ((LinearLayout)localObject).setVisibility(0);
        localObject = new ImageView[3];
        localObject[0] = ((ImageView)paramView.findViewById(2131363111));
        localObject[1] = ((ImageView)paramView.findViewById(2131363113));
        localObject[2] = ((ImageView)paramView.findViewById(2131363115));
        ...
        while (i < j)
        {
          ...
          localObject[0].setImageBitmap(a(String.valueOf(((lmz)paramMessage.get(0)).a), paramQQAppInterface));
        }
      }
    }
    else
    {
      ...
      lzq.a(localView, bool, paramBoolean);
    }
    label401:
    label925:
    for (;;)
    {
      bdll.a(paramQQAppInterface, "dc00898", "", "", "0X8009EE1", "0X8009EE1", 1, 0, "", "", "", "");
      return;
      label426:
      if (paramMessage.size() == 2)
      {
        ...
        localObject[2].setVisibility(8);
        localObject[0].setImageBitmap(a(String.valueOf(((lmz)paramMessage.get(0)).a), paramQQAppInterface));
        localObject[1].setImageBitmap(a(String.valueOf(((lmz)paramMessage.get(1)).a), paramQQAppInterface));
        break;
      }
      i = 0;
      while (i < localObject.length)
      {
        ...
        localObject[i].setImageBitmap(a(String.valueOf(((lmz)paramMessage.get(i)).a), paramQQAppInterface));
        i += 1;
      }
      break;
      ((LinearLayout)localObject).setVisibility(0);
      ...
      if (j == 6)
      {
        localTextView.setText(paramQQAppInterface.getApp().getString(2131695086));
        lzq.a(localView, bool, paramBoolean);
      }
      else if (j >= 5)
      {
        paramView = paramQQAppInterface.getApp().getString(2131695084);
        paramView = paramView + " ";
      ...
      {
        localTextView.setText(paramQQAppInterface.getApp().getString(2131694773));
        lzq.a(localView, bool, paramBoolean);
      }
      else
      {
        ...
        paramMessage = paramQQAppInterface.getApp().getString(2131692591);
        paramView = paramMessage;
        if (i == 2) {
          paramView = paramMessage.replace(paramQQAppInterface.getApp().getString(2131718785), paramQQAppInterface.getApp().getString(2131718786));
        }
        mvd.a(localView, paramView);
        label978:
        lzq.a(localView, bool, paramBoolean);
      }
    }
    ...
    for (;;)
    {
      ...
      {
        lzq.a(localView, false, paramBoolean);
        return;
        if (j == 1)
        {
          paramView = paramQQAppInterface.getApp().getString(2131689898);
          if (i != 2) {
            break label1533;
          }
          paramView = paramView.replace(paramQQAppInterface.getApp().getString(2131718785), paramQQAppInterface.getApp().getString(2131718786));
          localImageView.setImageDrawable(null);
          continue;
        }
        if (!QLog.isColorLevel()) {
      ...
      paramMessage = paramQQAppInterface.getApp().getString(2131692590);
      paramView = paramMessage;
      if (i == 2) {
        paramView = paramMessage.replace(paramQQAppInterface.getApp().getString(2131718785), paramQQAppInterface.getApp().getString(2131718786));
      }
      ...
      {
        if (paramQQAppInterface.a().f()) {
          localTextView.setText(2131695366);
        }
        for (;;)
        {
          mvd.a(localView, paramQQAppInterface.getApp().getString(2131690164));
          lzq.a(localView, bool, paramBoolean);
          break;
          paramView = paramQQAppInterface.a().e();
          paramMessage = paramQQAppInterface.getApp().getString(2131694764);
          localTextView.setText(paramMessage + " " + paramView);
        }
      }
      if ((i == 2) && (!paramQQAppInterface.a().k()))
      {
        ...
        for (;;)
        {
          ...
          break;
          paramView = paramQQAppInterface.a().e();
          paramMessage = paramQQAppInterface.getApp().getString(2131695340);
          localTextView.setText(paramMessage + " " + paramView);
        }
      }
      lzq.a(localView, false, paramBoolean);
