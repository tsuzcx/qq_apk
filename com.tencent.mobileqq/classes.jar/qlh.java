...
public class qlh
{
  ...
  private static String[] jdField_a_of_type_ArrayOfJavaLangString = { amtj.a(2131711925), amtj.a(2131712239), amtj.a(2131711911), amtj.a(2131711958), amtj.a(2131711918), amtj.a(2131712246), amtj.a(2131712100), amtj.a(2131712175), amtj.a(2131712045), amtj.a(2131711868) };
  ...
  public static ArticleInfo a(articlesummary.ArticleSummary paramArticleSummary, int paramInt1, int paramInt2, ArticleInfo paramArticleInfo)
  {
    ...
    if (localArticleInfo.scripCmsInfo != null)
    {
      ...
      pxs.a(BaseApplicationImpl.getApplication(), (String)localObject, pxs.a(BaseApplicationImpl.getApplication(), (String)localObject) + 1);
    }
    Object localObject = (articlesummary.AwesomeCommentInfo)psy.a(paramArticleSummary.awesome_comment_icon, null);
    if (localObject != null)
    {
      localArticleInfo.hasAwesome = true;
      rck.a(localArticleInfo, (articlesummary.AwesomeCommentInfo)localObject);
    }
    localObject = (articlesummary.SubscriptInfo)psy.a(paramArticleSummary.msg_subscript_20, null);
    if (localObject != null) {
      rfp.a(localArticleInfo, (articlesummary.SubscriptInfo)localObject);
    }
  ...
  public static ChannelCoverInfo a(oidb_cmd0x69f.ChannelInfo paramChannelInfo, int paramInt)
  {
    ...
    new qlf().a(paramChannelInfo, paramInt, localChannelCoverInfo1);
    paramChannelInfo = pkm.a().a(paramInt);
  ...
  public static ChannelInfo a(oidb_cmd0x69f.ChannelInfo paramChannelInfo)
  {
    ...
    localChannelInfo.mChannelID = psy.a(paramChannelInfo.uint32_channel_id);
    localChannelInfo.mChannelName = psy.a(paramChannelInfo.bytes_channel_name, "");
    localChannelInfo.mChannelType = psy.a(paramChannelInfo.uint32_channel_type);
    if (localChannelInfo.mChannelType == 1) {
      if (psy.a(paramChannelInfo.uint32_is_first_req) == 0) {
        break label113;
      }
    }
    for (boolean bool = true;; bool = false)
    {
      ...
      localChannelInfo.mFrameColor = psy.a(paramChannelInfo.uint32_frame_color);
      localChannelInfo.mFontColor = psy.a(paramChannelInfo.uint32_fonts_color);
      try
      {
        localChannelInfo.mJumpUrl = new String(psy.a(paramChannelInfo.bytes_channel_jump_url), "utf-8");
  ...
  public static TabChannelCoverInfo a(channel_button.Channel paramChannel)
  {
    ...
    localTabChannelCoverInfo.mChannelCoverId = ((int)psy.a(paramChannel.uint64_channel_id));
    localTabChannelCoverInfo.mChannelCoverName = psy.a(paramChannel.str_channel_name);
    if ((paramChannel.msg_red_point.has()) && (paramChannel.msg_red_point.uint64_start_time.has()) && (paramChannel.msg_red_point.uint64_end_time.has()))
    {
      ...
      localTabChannelCoverInfo.redPoint.jdField_a_of_type_Boolean = psy.a(paramChannel.msg_red_point.bool_red_point);
      ...
      localTabChannelCoverInfo.redPoint.jdField_a_of_type_JavaLangString = psy.a(paramChannel.msg_red_point.str_title_text);
    ...
    localTabChannelCoverInfo.mChannelCoverPicUrl = psy.a(paramChannel.str_cover_url);
    localTabChannelCoverInfo.mIconUrl = psy.a(paramChannel.str_icon_url);
    ...
    {
      localTabChannelCoverInfo.startTimestamp = psy.a(paramChannel.uint64_start_time);
      localTabChannelCoverInfo.endTimestamp = psy.a(paramChannel.uint64_end_time);
      localTabChannelCoverInfo.boldFont = psy.a(paramChannel.uint32_bold_font);
      localTabChannelCoverInfo.fontsColor = psy.a(paramChannel.uint32_fonts_color);
      localTabChannelCoverInfo.frameColor = psy.a(paramChannel.uint32_frame_color);
      localTabChannelCoverInfo.showCover = psy.a(paramChannel.uint32_show_cover);
      localTabChannelCoverInfo.showCover = psy.a(paramChannel.uint32_show_cover);
      localTabChannelCoverInfo.proxy = psy.a(paramChannel.str_proxy);
      localTabChannelCoverInfo.showIcon = psy.a(paramChannel.uint32_show_icon);
      localTabChannelCoverInfo.reason = psy.a(paramChannel.enum_reason);
      localTabChannelCoverInfo.onlyCover = psy.a(paramChannel.uint32_only_cover);
      localTabChannelCoverInfo.mChannelType = psy.a(paramChannel.uint32_channel_type);
      localTabChannelCoverInfo.sectionId = psy.a(paramChannel.uint64_section_id);
      localTabChannelCoverInfo.bid = psy.a(paramChannel.uint64_bid);
      a(localTabChannelCoverInfo);
      localTabChannelCoverInfo.dynamicSort = psy.a(paramChannel.uint32_dynamic_sort);
      localTabChannelCoverInfo.mChannelCoverIcon = psy.a(paramChannel.str_square_icon_url);
      localTabChannelCoverInfo.mChannelVersion = psy.a(paramChannel.str_channel_version);
  ...
  private static void a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    szc.a(str, String.valueOf(paramTabChannelCoverInfo.bid));
    szc.b(str);
    try
    {
  ...
  public static void a(List<ArticleInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      paramList = paramList.iterator();
      while (paramList.hasNext()) {
        pay.a((ArticleInfo)paramList.next());
      }
    }
  }
  ...
  public static void a(oidb_cmd0x68b.RspChannelArticle paramRspChannelArticle, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    paramRspChannelArticle = qlg.a(paramRspChannelArticle.bytes_req_query_id, "");
    try
    {
  ...
  public static List<rcu> c(List<oidb_cmd0x46f.DislikeResult> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if ((paramList == null) || (paramList.size() == 0)) {
      return localArrayList;
    ...
    while (paramList.hasNext())
    {
      ...
      if (localDislikeResult.uint64_articleid.has()) {
        localrcu.jdField_a_of_type_Long = localDislikeResult.uint64_articleid.get();
      }
      if (localDislikeResult.uint32_result.has()) {
        localrcu.jdField_a_of_type_Int = localDislikeResult.uint32_result.get();
      }
      if (localDislikeResult.str_message.has()) {
        localrcu.jdField_a_of_type_JavaLangString = localDislikeResult.str_message.get();
      }
      localArrayList.add(localrcu);
    }
    return localArrayList;
  }
