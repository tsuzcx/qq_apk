...
public class aanq
  extends alko
{
  public aanq(AppInterface paramAppInterface)
  {
  ...
  public void a(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    if (aowf.a(paramGdtBaseAdItem.jdField_a_of_type_JavaLangString, paramContext))
    {
      aanx.a(paramGdtBaseAdItem.f);
      ...
      {
        aaon.b(paramContext, paramGdtBaseAdItem);
        return;
      }
      aaon.a(paramContext, paramGdtBaseAdItem);
      return;
    }
    if (!TextUtils.isEmpty(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString))
    {
      ...
      label133:
      String str;
      if ((aaon.a()) && (paramGdtBaseAdItem.jdField_a_of_type_Boolean))
      {
        localObject = "1";
        if (QLog.isColorLevel()) {
          QLog.d("GdtAdHandler", 2, "doAppJump autoDownload  " + (String)localObject);
        }
        if (!aaon.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString)) {
          break label576;
        }
        if (("1".equals(localObject)) && (TextUtils.isEmpty((String)aaon.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("acttype")))) {
          paramGdtBaseAdItem.jdField_b_of_type_JavaLangString += "&acttype=42";
        }
        if (TextUtils.isEmpty((String)aaon.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("wv"))) {
          paramGdtBaseAdItem.jdField_b_of_type_JavaLangString += "&wv=1";
        }
        str = (String)aaon.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("_autodownload");
      ...
      label576:
      aanx.a(paramGdtBaseAdItem.f);
      paramContext = (String)bfel.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("auto_download");
