...
public class asnk
{
  ...
  public static int a()
  {
    int j = aoqs.a().jdField_b_of_type_Int;
    int i = j;
    if (j == 0) {
  ...
  public static String a()
  {
    String str2 = aoqs.a().jdField_a_of_type_JavaLangString;
    String str1 = str2;
  ...
  public static void a(Bundle paramBundle, String paramString)
  {
    ...
    bkis.a().a((WadlParams)localObject2);
  }
  ...
  {
    aoqr localaoqr = aoqs.a();
    if ((localaoqr != null) && (localaoqr.jdField_a_of_type_Int > 0))
    {
      if (QLog.isColorLevel()) {
  ...
  {
    String str2 = aoqs.a().jdField_b_of_type_JavaLangString;
    String str1;
    if (TextUtils.isEmpty(str2)) {
  ...
  public static void b(int paramInt, String paramString)
  {
    ...
    bkis.a();
    bkis.a().c(paramInt, paramString);
  }
  
  public static boolean b()
  {
    boolean bool2 = false;
    Object localObject = aoqs.a();
    boolean bool1 = bool2;
    if (localObject != null)
    {
      bool1 = bool2;
      if (((aoqr)localObject).c > 0)
      {
        localObject = ((aoqr)localObject).jdField_a_of_type_JavaLangString;
        bool1 = bool2;
