...
{
  public jxx(MultiMembersAudioUI paramMultiMembersAudioUI) {}
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    View localView1 = View.inflate(paramViewGroup.getContext(), 2130969322, null);
    Object localObject1;
    if (AudioHelper.a(0) == 1)
    {
      localView1.setBackgroundColor(-16776961);
      localView1.addOnLayoutChangeListener(new jxy(this));
      if (paramViewGroup.getTag(2131361845) == null)
      {
        paramViewGroup.setBackgroundColor(-16711936);
        localObject1 = new jxz(this);
    ...
    for (int i = this.a.jdField_b_of_type_Int - paramInt * 8;; i = 8)
    {
      ...
      for (;;)
      {
          ...
          if (localView2 != null)
          {
            ...
            if ((localMVMembersInfo.jdField_a_of_type_JavaLangString == null) || (localMVMembersInfo.jdField_a_of_type_AndroidGraphicsBitmap == null) || (!localMVMembersInfo.jdField_d_of_type_Boolean))
            {
              ...
              if (localObject2 == null)
              {
                ...
                localObject1 = BitmapFactory.decodeResource(this.a.getResources(), 2130840308, (BitmapFactory.Options)localObject2);
        ...
        try
        {
          localObject2 = BitmapFactory.decodeResource(this.a.getResources(), 2130840308, (BitmapFactory.Options)localObject2);
          localObject1 = localObject2;
        }
        ...
        for (;;)
        {
          ...
          localHolder.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130840287);
        ...
        for (;;)
        {
          localMVMembersInfo.jdField_a_of_type_AndroidGraphicsBitmap = ((BitmapDrawable)this.a.getResources().getDrawable(2130840238)).getBitmap();
          localMVMembersInfo.jdField_d_of_type_Boolean = true;
          break;
        ...
        default: 
          ...
          if (String.valueOf(localMVMembersInfo.jdField_a_of_type_Long).endsWith(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin()))
          {
            ...
            localObject1 = ((BitmapDrawable)this.a.getResources().getDrawable(2130840204)).getBitmap();
        ...
        for (;;)
        {
          ...
          break;
          localHolder.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130840079);
          break label1148;
          localHolder.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130840083);
          break label1148;
          localHolder.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130840081);
          break label1148;
          ...
          label1704:
          localHolder.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
          localHolder.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130839147);
          break label1385;
          label1728:
          if (localHolder.d.getVisibility() != 0) {
            break label1510;
