  ...
  extends pbe
{
  ...
  private List<qaz> jdField_a_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_a_of_type_Boolean = true;
  private long jdField_b_of_type_Long;
  private List<qay> jdField_b_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_b_of_type_Boolean = true;
  private long jdField_c_of_type_Long;
  private List<qaz> jdField_c_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_c_of_type_Boolean = true;
  private String j = "";
  private String k = "";
  
  public pan(AppInterface paramAppInterface, aukp paramaukp, ExecutorService paramExecutorService, por parampor, Handler paramHandler)
  {
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      paramToServiceMsg = qeb.a((Iterable)localObject, new pao(this));
    ...
    {
      paramToServiceMsg = qeb.a((Iterable)localObject, new pap(this));
    ...
    paramToServiceMsg = qeb.a((Iterable)localObject, new paq(this));
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    localReqBody.uint64_uin.set(onh.a());
    ...
    for (paramInt1 = 0;; paramInt1 = 1)
    {
      ...
      localObject = pot.a("OidbSvc.0x977", 2423, 5, localReqBody.toByteArray());
