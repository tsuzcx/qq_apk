  ...
  extends akac
{
  ...
  public akaf(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
    super(paramQQAppInterface, paramMessageHandler);
    this.jdField_a_of_type_JavaUtilComparator = new akah(this);
  }
  ...
  private boolean c(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord instanceof MessageForArkApp))
    {
      ...
      {
        bool1 = bool2;
        if (alck.a(paramMessageRecord.ark_app_message.appName)) {
          bool1 = true;
        }
      }
    }
  ...
  protected TroopMemberInfo a(msg_comm.Msg paramMsg, ArrayList<MessageRecord> paramArrayList, awbl paramawbl, boolean paramBoolean, aylt paramaylt)
  {
    long l5;
    Object localObject7;
    long l6;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramawbl == null) || (paramMsg == null) || (paramArrayList == null)) {
          break label7696;
        }
        ...
        if (paramawbl.c == 1026)
        {
          l3 = azzz.a(((msg_comm.MsgHead)localObject7).msg_seq.get());
          l2 = azzz.a(((msg_comm.MsgHead)localObject7).msg_time.get());
        }
        ...
        localObject2 = awbg.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, String.valueOf(l6), String.valueOf(l6));
        if (((Long)((Pair)localObject2).first).longValue() != 4294967295L)
        {
          ...
          {
            awbg.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, (List)localObject3, paramMsg, paramawbl.e, l2, false);
            localObject2 = null;
            l1 = 0L;
            if ((((List)localObject3).size() == 0) && (k > 1))
            {
              ...
              localObject4 = (MessageForText)awbi.a(-1000);
            ...
            localMessageRecord.istroop = paramawbl.c;
            localMessageRecord.senderuin = String.valueOf(l6);
            localMessageRecord.frienduin = String.valueOf(paramawbl.e);
            ...
            if (((msg_comm.MsgHead)localObject7).msg_flag.has())
            {
              ...
              if ((((msg_comm.MsgHead)localObject7).msg_flag.get() & 1L) == 1L)
              {
                ...
                {
                  b2 = 1;
                  localaylt.c.a(l3, localMessageRecord.uniseq);
                  b1 = b2;
                  if (QLog.isColorLevel())
                  {
            ...
            if ((localMessageRecord.istroop == 1) && (bara.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(localMessageRecord.msg, localMessageRecord.frienduin))) {
              localaylt.b.a(l3, localMessageRecord.uniseq);
            }
            if (((localMessageRecord instanceof MessageForTroopConfess)) && (((MessageForTroopConfess)localMessageRecord).isToSelf)) {
              localaylt.d.a(l3, localMessageRecord.uniseq);
            }
            if (a(localMessageRecord)) {
              localaylt.g.a(l3, localMessageRecord.uniseq);
            }
            if (b(localMessageRecord)) {
              localaylt.s.a(l3, localMessageRecord.uniseq);
            }
            if (c(localMessageRecord)) {
              localaylt.w.a(l3, localMessageRecord.uniseq);
            }
            if (localMessageRecord.msgtype == -1049)
            {
              ...
              if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(((MessageForReplyText)localObject4).mSourceMsgInfo.mSourceMsgSenderUin + ""))) {
                localaylt.l.a(l3, localMessageRecord.uniseq);
              }
            }
            if (localMessageRecord.msgtype == -5015) {
              localaylt.v.a(l3, localMessageRecord.uniseq);
            }
            if (localMessageRecord.msgtype == -2058) {
              EmojiStickerManager.a(localMessageRecord, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            }
            if (((localMessageRecord.msgtype != -2058) || (paramaylt.t.a != -1L) || (paramaylt.t.b != -1L)) || (localMessageRecord.msgtype == -1035))
            {
            ...
            if ((localMessageRecord.msgtype == -2035) || (localMessageRecord.msgtype == -2038))
            {
              ...
              localObject6 = babh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageForDeliverGiftTips)localObject4).istroop, ((MessageForDeliverGiftTips)localObject4).frienduin, ((MessageForDeliverGiftTips)localObject4).senderuin);
              ...
              if (!((MessageForDeliverGiftTips)localObject4).isFromNearby)
              {
                ...
                if (!TextUtils.isEmpty((CharSequence)localObject6))
                {
                  ...
                  localaylt.h.a(l3, localMessageRecord.uniseq);
                }
                localObject6 = (azfo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(223);
                if (localObject6 != null) {
                  ((azfo)localObject6).b((MessageForDeliverGiftTips)localObject4);
                }
              }
            }
            if (asdj.a(localMessageRecord))
            {
            ...
            {
              localObject4 = awuw.a(localMessageRecord.msgData);
              if ((localObject4 instanceof StructMsgForGeneralShare))
              {
                ...
                localObject9 = new ajzz(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
                localObject6 = ((ajzz)localObject9).jdField_a_of_type_Akeu;
                localObject9 = ((ajzz)localObject9).jdField_a_of_type_JavaUtilMap;
                localObject6 = ((akeu)localObject6).a((String)localObject4, 1);
                TroopManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord.frienduin, StructMsgForGeneralShare.eventId, localMessageRecord.shmsgseq, new akag(this, false, localaylt, l3, l8, (RecentUser)localObject6, (String)localObject4, localMessageRecord, (Map)localObject9));
              }
            }
            if ((localMessageRecord instanceof MessageForTroopFile)) {
              localaylt.n.a(l3, localMessageRecord.uniseq);
            }
            if (azhx.a(localMessageRecord)) {
              localaylt.j.a(l3, localMessageRecord.uniseq);
            }
            if (localMessageRecord.msgtype == -2039)
            {
              localObject6 = (MessageForApollo)localMessageRecord;
              localObject9 = new ArrayList(2);
              localObject10 = (aifg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
              localObject4 = null;
              if (QLog.isColorLevel()) {
              ...
              {
                localObject11 = ((aifg)localObject10).b(((MessageForApollo)localObject6).senderuin);
                if (QLog.isColorLevel()) {
              ...
              {
                localObject11 = ((aifg)localObject10).b(((MessageForApollo)localObject6).mApolloMessage.peer_uin + "");
                if (QLog.isColorLevel()) {
              ...
              if (((ArrayList)localObject9).size() > 0) {
                ((aifg)localObject10).b((List)localObject9);
              }
              if (QLog.isColorLevel()) {
              ...
              {
                i1 = ((aifg)localObject10).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
                localObject4 = "";
                ...
                bajr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "cmshow", "Apollo", "rev_action", String.valueOf(localMessageRecord.senderuin), n, ((MessageForApollo)localObject6).msgType, new String[] { localObject4, Integer.toString(i1), Integer.toString(aifg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)), String.valueOf(System.currentTimeMillis() / 1000L) });
              }
            }
            if (paramaylt != null)
            {
              if (localaylt.f.a != -1L) {
                localaylt.f.b = localMessageRecord.uniseq;
              }
              if (localaylt.jdField_a_of_type_Aylu.a != -1L) {
                localaylt.jdField_a_of_type_Aylu.b = localMessageRecord.uniseq;
              }
              if ((l3 > this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(String.valueOf(paramawbl.e), paramawbl.c)) && (localaylt.a()))
              {
                paramaylt.a(localaylt);
                localMessageRecord.mMessageInfo = localaylt;
              }
            }
            if (((paramawbl.c != 1) && (paramawbl.c != 1026) && (paramawbl.c != 3000)) || (localObject2 == null) || (TextUtils.equals(localMessageRecord.selfuin, localMessageRecord.senderuin))) {
              break label3543;
            }
            i = 0;
        ...
        l1 = awbk.a(((im_msg_body.Attr)((im_msg_body.RichText)localObject4).attr.get()).random.get());
        label2986:
        localObject2 = ((im_msg_body.RichText)localObject4).elems.get();
        if (((im_msg_body.RichText)localObject4).ptt.has())
        {
          awbg.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, (List)localObject3);
          continue;
        }
        localaylt.jdField_a_of_type_JavaLangString = String.valueOf(paramawbl.e);
        localaylt.jdField_a_of_type_Int = paramawbl.c;
        awbg.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, (List)localObject3, paramMsg, false, false, localaylt);
        continue;
        if (((MessageForDeliverGiftTips)localObject4).animationPackageId <= 0) {
          continue;
        }
        localaylt.i.a(l3, localMessageRecord.uniseq);
        continue;
      ...
      continue;
      label3141:
      if ((localObject4 != null) && (((StructMsgForGeneralShare)localObject4).mMsgServiceID == 19) && (!((StructMsgForGeneralShare)localObject4).mMsgBrief.startsWith(ajjy.a(2131635230))) && (!((StructMsgForGeneralShare)localObject4).mMsgBrief.equals(ajjy.a(2131635224))))
      {
        localaylt.o.a(l3, localMessageRecord.uniseq);
      }
      else if ((localObject4 != null) && (((StructMsgForGeneralShare)localObject4).mMsgServiceID == 106))
      {
        if ((((StructMsgForGeneralShare)localObject4).atMembers != null) && (((StructMsgForGeneralShare)localObject4).atMembers.contains(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) {
          localaylt.jdField_a_of_type_Aylu.a(l3, localMessageRecord.uniseq);
        }
      }
      else if ((localObject4 != null) && (((StructMsgForGeneralShare)localObject4).mMsgServiceID == 107))
      {
        localaylt.u.a(l3, localMessageRecord.uniseq);
        continue;
        label3303:
    ...
    else
    {
      ...
      if (localObject2 != null)
      {
          ...
          if (((im_msg_body.Elem)localObject9).anon_group_msg.has())
          {
            ...
            for (;;)
            {
              try
              {
                ...
                {
                  localObject6 = "";
                  localMessageRecord.saveExtInfoToExtStr("anonymous", mnf.a(i, (String)localObject4, (String)localObject6, n, i1, (String)localObject9));
        ...
        localObject9 = azhz.a(((im_msg_body.Elem)localObject9).group_business_msg);
        azhy.a(localMessageRecord, (azhz)localObject9);
        ...
        {
          awqx.b((QQAppInterface)localObject10, "P_CliOper", "Grp_AIO", "", "five_m", "revice_msg", 0, 0, (String)localObject3, localMessageRecord.msgtype + "", ((azhz)localObject9).c, "");
          localObject3 = localObject5;
          if (!QLog.isColorLevel()) {
            break;
          }
        ...
        i1 = -100;
        i5 = -100;
        if ((paramawbl.c == 1) || (paramawbl.c == 1026))
        {
          double d = -100.0D;
          i = -1;
                  ...
                  case 1: 
                    ...
                    do
                    {
                      ...
                      if (((im_msg_body.Elem)localObject6).general_flags.bytes_pb_reserve.has())
                      {
                        ...
                        paramaylt.mergeFrom(((im_msg_body.Elem)localObject6).general_flags.bytes_pb_reserve.get().toByteArray());
                        if (paramaylt.uint32_rich_card_name_ver.has()) {
                          paramaylt.uint32_rich_card_name_ver.get();
                        }
                        if (!paramaylt.uint32_nearby_charm_level.has()) {
                          break label7855;
                        }
                        i2 = paramaylt.uint32_nearby_charm_level.get();
                        if (!paramaylt.uint32_global_group_level.has()) {
                          break label7862;
                        }
                        i5 = paramaylt.uint32_global_group_level.get();
                        if (!paramaylt.uint32_vip_type.has()) {
                          break label7869;
                        }
                        i1 = paramaylt.uint32_vip_type.get();
                        if (!paramaylt.uint32_vip_level.has()) {
                          break label7875;
                        }
                        i6 = paramaylt.uint32_vip_level.get();
                        i6 = bajr.c(i6);
                        if (paramaylt.uint32_user_bigclub_flag.has()) {
                          j = paramaylt.uint32_user_bigclub_flag.get();
                        }
                        if (paramaylt.uint32_user_bigclub_level.has()) {
                          k = paramaylt.uint32_user_bigclub_level.get();
                        }
                        if (paramaylt.uint32_nameplate.has()) {
                          m = paramaylt.uint32_nameplate.get();
                        }
                        if (paramaylt.uint32_req_is_bigclub_hidden.has()) {
                          n = paramaylt.uint32_req_is_bigclub_hidden.get();
                        }
                        if (QLog.isColorLevel()) {
                          QLog.d("kaiyan", 2, "isHideBigClub=" + n);
                        }
                        i9 = i;
                        if (paramaylt.uint32_title_id.has())
                        {
                          i7 = paramaylt.uint32_title_id.get();
                          if (i7 > 0) {
                            i = i7;
                          }
                          i9 = i;
                          if (QLog.isColorLevel())
                          {
                            QLog.d("TroopRankConfig", 2, "decodeSinglePbMsg_GroupDis, titleId=" + i7 + ", troopUin=" + l1 + ", sender=" + l6 + ", msgTime=" + l2 + ", isSaveDb=" + paramBoolean);
                            i9 = i;
                          }
                        }
                        if ((paramawbl.c == 1) && (paramaylt.uint32_group_member_flag_ex2.has()))
                        {
                          i = paramaylt.uint32_group_member_flag_ex2.get();
                          ajyz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l1, i);
                        }
                        if ((paramawbl.c == 1) && (paramaylt.uint32_group_ringtone_id.has()) && (paramaylt.uint32_group_ringtone_id.get() > 0))
                        {
                          i = paramaylt.uint32_group_ringtone_id.get();
                          ajyz.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l1, i);
                        }
                        ...
                        if ((paramawbl.c == 1) && (paramaylt.uint32_custom_featureid.has()) && (localObject7 != null) && (paramaylt.uint32_custom_featureid.get() == 19713))
                        {
                          if (QLog.isColorLevel()) {
                        ...
                        if (!paramaylt.bytes_hudong_mark.has()) {
                          break label7881;
                        }
                        paramaylt = paramaylt.bytes_hudong_mark.get().toByteArray();
                        paramaylt = azce.a(paramaylt);
                        ((azcd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(346)).a(String.valueOf(l1), String.valueOf(l6), paramaylt);
                        i2 = i6;
                        i5 = j;
                        i6 = k;
                        i7 = m;
                      ...
                      localObject7 = ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).b(paramaylt);
                      if (localObject7 == null) {
                        break label7745;
                      }
                      l8 = ((im_msg_body.Elem)localObject6).general_flags.uint64_group_rank_seq.get();
                      if (QLog.isColorLevel()) {
                        QLog.d("Q.getTroopMemberLevelInfo", 2, "onNewMsg: troopUin=" + paramaylt + ", serverRankSeq=" + l8 + ", localRankSeq=" + ((TroopInfo)localObject7).dwGroupLevelSeq + ", isSyncMsgFinish=" + bool1);
                      }
                      if (l8 <= ((TroopInfo)localObject7).dwGroupLevelSeq) {
                        break label7745;
                      }
                      ((ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).c(paramaylt, false);
                      break label7745;
                      bool5 = bool1;
                    ...
                    if (((im_msg_body.Elem)localObject6).general_flags.uint32_to_uin_flag.get() == 2)
                    {
                      ...
                      if (QLog.isColorLevel())
                      {
                        QLog.d("Q.getTroopMemberLevelInfo", 2, "onNewMsg: troopUin=" + paramaylt + ", isSyncMsgFinish=" + bool1);
                        break label7745;
                        if ((((im_msg_body.Elem)localObject6).extra_info.has()) && (((im_msg_body.Elem)localObject6).extra_info.uint32_flags.has()))
                        {
                          ...
                          if (bool1)
                          {
                            ...
                            paramaylt = ((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(60)).a(l1 + "");
                            localObject6 = l6 + "";
                            if ((paramaylt == null) || (paramaylt.adminUins.contains(localObject6))) {
                              break label7893;
                            }
                            paramaylt.adminUins.add(localObject6);
                            break label7893;
                          }
                        }
                        else if (((im_msg_body.Elem)localObject6).pub_group.has())
                        {
                          ...
                          if (QLog.isColorLevel())
                          {
                            ...
                            paramaylt = ((im_msg_body.PubGroup)((im_msg_body.Elem)localObject6).pub_group.get()).bytes_nickname.get().toStringUtf8();
                            label5974:
                            QLog.d("Q.msg.BaseMessageProcessorForTroopAndDisc", 2, "decodeSinglePbMsg_GroupDis,receive  pub_group,bytes_nickname = " + paramaylt);
                            i4 = k;
                            i5 = j;
                            i6 = i1;
                            i7 = 1;
                          ...
                          if (((im_msg_body.Elem)localObject6).elem_flags2.has())
                          {
                            ...
                            if (((im_msg_body.ElemFlags2)((im_msg_body.Elem)localObject6).elem_flags2.get()).uint32_longtitude.has())
                            {
                              ...
                              if (((im_msg_body.ElemFlags2)((im_msg_body.Elem)localObject6).elem_flags2.get()).uint32_latitude.has())
                              {
                                ...
                                label6306:
                                paramaylt = String.valueOf(l1);
                                paramawbl = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                                localObject2 = paramawbl.b(paramaylt);
                                if (QLog.isColorLevel()) {
                                ...
                                if ((!bool1) && (localObject2 == null))
                                {
                                  ...
                                  ((TroopInfo)localObject2).troopuin = paramaylt;
                                  paramawbl.b((TroopInfo)localObject2);
                                  ((ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).j(paramaylt);
                                }
                                localObject2 = String.valueOf(l6);
                                i3 = ((msg_comm.GroupInfo)localObject5).group_level.get();
                                localObject6 = bami.a(((msg_comm.GroupInfo)localObject5).group_card.get());
                                ...
                                paramawbl = paramArrayList.iterator();
                                while (paramawbl.hasNext()) {
                                  ((MessageRecord)paramawbl.next()).isOpenTroopMessage = true;
                                }
                                paramawbl = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                                if ((paramawbl == null) || (paramawbl.f(paramaylt))) {
                                  break label7979;
                                }
                                paramawbl = (ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
                                if (paramawbl == null) {
                                  break label7979;
                                }
                                paramawbl.f(paramaylt, false);
                                break label7979;
                                label6649:
                                if (i2 != -100)
                                {
                                  paramawbl = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                                  if (paramawbl != null) {
                                    paramawbl.a(paramaylt, (String)localObject2, i2);
                                  }
                                }
                                if (paramBoolean) {
                                  paramawbl = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                                ...
                                {
                                case 1: 
                                  paramawbl.a(paramaylt, (String)localObject2, (String)localObject6, i, null, null, 0, 1, 100, l3, b2, 0L, d, null, -100, j, k, m, n, i1, i5);
                                case 2: 
                                  for (;;)
                                  {
                                    label6728:
                                    paramawbl.a(paramaylt, (String)localObject2, (String)localObject3);
                                    paramawbl = null;
                                    label6781:
                                    ...
                                    localObject2 = (azhx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(132);
                                    if (((azhx)localObject2).a(paramaylt)) {
                                      break label8020;
                                    }
                                    if (!((azhx)localObject2).b(paramaylt)) {
                                      break label7227;
                                    }
                                    ...
                                    i2 = i;
                                    if (!azhx.a((MessageRecord)localObject3)) {
                                      break label8013;
                                    }
                                    ...
                                    paramawbl.a(paramaylt, (String)localObject2, (String)localObject6, i, null, null, 0, 1, 100, l3, b2, 0L, d, null, -100, j, k, m, n, i1, i5);
                                    continue;
                                    paramawbl.a(paramaylt, (String)localObject2, "", i, (String)localObject6, null, 0, 1, 100, l3, b2, 0L, d, null, -100, j, k, m, n, i1, i5);
                                  }
                                  paramawbl = new TroopMemberInfo();
                                  paramawbl.troopuin = paramaylt;
                                  paramawbl.memberuin = ((String)localObject2);
                                  switch (i6)
                                  {
                                  case 2: 
                                    label7032:
                                    localObject3 = bami.b((String)localObject6);
                                    paramawbl.troopColorNick = ((String)localObject6);
                                    paramawbl.troopnick = ((String)localObject3);
                                    for (;;)
                                    {
                                      paramawbl.level = i;
                                      paramawbl.realLevel = i3;
                                      paramawbl.sex = 1;
                                      paramawbl.age = 0;
                                      paramawbl.distance = 100;
                                      paramawbl.msgseq = l3;
                                      if (b2 != 1) {
                                        break label8007;
                                      }
                                      paramBoolean = true;
                                      label7094:
                                      paramawbl.isTroopFollowed = paramBoolean;
                                      paramawbl.distanceToSelf = d;
                                      paramawbl.distanceToSelfUpdateTimeStamp = System.currentTimeMillis();
                                      break;
                                      paramawbl.troopnick = "";
                                      paramawbl.friendnick = ((String)localObject6);
                                    }
                                    i2 = i;
                                    if (i == 0)
                                    {
                                      ((azhx)localObject2).a(paramaylt, ((MessageRecord)localObject3).uniseq);
                                      i2 = 1;
                                    }
                                    if (QLog.isColorLevel()) {
                                      QLog.d("TroopBindPublicAccountMgr.redDot", 2, "decodePBAccountMSg:" + paramaylt + "," + ((MessageRecord)localObject3).uniseq + "," + ((MessageRecord)localObject3).shmsgseq);
                                    }
                                    ((azhx)localObject2).c(paramaylt);
                                    break label8013;
                                    label7227:
                                    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b(paramaylt) != 3) {
                                      break label8020;
                                    }
                                    if (QLog.isColorLevel()) {
                                      QLog.d(".troop.closeRcvMsgTmp", 2, "Shield troop recv msg:" + paramaylt);
                                    }
                                    ((ajtg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(paramaylt, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 0, 0);
                                    break label8020;
                                  }
                                  break;
                                }
    ...
    for (;;)
    {
      ...
      while (paramMsg.hasNext())
      {
        ...
        Object localObject1;
        paramArrayList.vipBubbleID = ajrm.a((int)localObject1, i);
      ...
      befa.a().g(System.currentTimeMillis() - l5);
      return paramawbl;
      label7652:
      label7659:
      label7662:
  ...
  protected void a(MessageRecord paramMessageRecord)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramMessageRecord))
    {
      ...
      if (akbm.p(paramMessageRecord.msgtype))
      {
        ajmn localajmn = new ajmn();
        localajmn.b = 1000;
        localajmn.c = 0;
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().notifyUI(5006, true, new Object[] { Long.valueOf(paramMessageRecord.uniseq), localajmn });
      }
    }
  }
}
