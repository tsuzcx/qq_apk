...
public class zxw
{
  ...
  private zyb jdField_a_of_type_Zyb;
  ...
  public zxw(long paramLong1, long paramLong2)
  {
  ...
  private boolean a()
  {
    try
    {
      ...
      this.jdField_a_of_type_Zyb = new zyb(null, "MediaCodecGLFrameFetcher");
    }
    ...
    this.jdField_a_of_type_Zyb.b(new MediaCodecGLFrameFetcher.2(this));
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_Zya = new zya();
    this.jdField_a_of_type_Zya.a(true);
    this.jdField_a_of_type_Zya.a();
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Zya.a());
    this.f = zxv.a(this.c, this.d);
  }
  
  private void d()
  {
    f();
    this.jdField_a_of_type_Zyb.b(new MediaCodecGLFrameFetcher.3(this));
  }
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture.setOnFrameAvailableListener(new zxx(this));
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Zyb != null)
    {
      this.jdField_a_of_type_Zyb.b(new MediaCodecGLFrameFetcher.1(this));
      this.jdField_a_of_type_Zyb.a();
      this.jdField_a_of_type_Zyb = null;
    }
    h();
