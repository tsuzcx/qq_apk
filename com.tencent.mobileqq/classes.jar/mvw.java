...
public class mvw
{
  ...
  mvx jdField_a_of_type_Mvx = null;
  mvy jdField_a_of_type_Mvy = null;
  mvz jdField_a_of_type_Mvz = null;
  mwa jdField_a_of_type_Mwa = new mwa();
  mwk jdField_a_of_type_Mwk;
  ...
  private mvw(Activity paramActivity, VideoController paramVideoController, mwk parammwk)
  {
  ...
  public static mvw a(mvw parammvw, Activity paramActivity, VideoController paramVideoController, mwk parammwk)
  {
    if (parammvw != null) {
      parammvw.a(false);
    }
    return new mvw(paramActivity, paramVideoController, parammwk);
  }
  
  public void a()
  {
    this.jdField_a_of_type_Mwa.a(this.jdField_a_of_type_ComTencentAvVideoController);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Mvx == null) || (this.jdField_a_of_type_Mvy == null) || (this.jdField_a_of_type_MqqUtilWeakReference == null) || (this.jdField_a_of_type_MqqUtilWeakReference.get() == null)) {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Mwa.a();
    } while (this.jdField_b_of_type_Boolean);
    this.jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidHardwareSensorManager.registerListener(this.jdField_a_of_type_Mvx, this.jdField_a_of_type_AndroidHardwareSensor, 3);
    this.jdField_a_of_type_AndroidHardwareSensorManager.registerListener(this.jdField_a_of_type_Mvy, this.jdField_b_of_type_AndroidHardwareSensor, 3);
    if (this.jdField_a_of_type_Mvz == null)
    {
      ...
      this.jdField_a_of_type_Mvz = new mvz(this);
      ((Context)this.jdField_a_of_type_MqqUtilWeakReference.get()).registerReceiver(this.jdField_a_of_type_Mvz, localIntentFilter);
      return;
    }
    ...
    {
      this.jdField_a_of_type_AndroidHardwareSensorManager.unregisterListener(this.jdField_a_of_type_Mvx);
      this.jdField_a_of_type_AndroidHardwareSensorManager.unregisterListener(this.jdField_a_of_type_Mvy);
      ...
      if (this.jdField_a_of_type_Mvz != null)
      {
        ((Context)this.jdField_a_of_type_MqqUtilWeakReference.get()).unregisterReceiver(this.jdField_a_of_type_Mvz);
        this.jdField_a_of_type_Mvz = null;
      }
    }
    this.jdField_b_of_type_Boolean = false;
    this.jdField_a_of_type_Mwa.b();
  }
  ...
  void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 197	mvw:a	()Z
    //   6: istore_3
    //   7: aload_0
    //   8: getfield 76	mvw:d	Z
    //   11: iload_1
    //   12: if_icmpeq +17 -> 29
    //   15: aload_0
    //   16: getfield 103	mvw:f	Z
    //   19: ifne +324 -> 343
    //   22: iload_1
    //   23: ifne +6 -> 29
    //   26: goto +317 -> 343
    //   29: aload_0
    //   30: getfield 41	mvw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   33: iconst_1
    //   34: ldc 199
    //   36: iconst_4
    ...
    //   82: return
    //   83: aload_0
    //   84: getfield 74	mvw:jdField_a_of_type_AndroidOsPowerManager$WakeLock	Landroid/os/PowerManager$WakeLock;
    //   87: ifnonnull +51 -> 138
    //   90: aload_0
    //   91: getfield 68	mvw:jdField_a_of_type_MqqUtilWeakReference	Lmqq/util/WeakReference;
    ...
    //   120: putfield 74	mvw:jdField_a_of_type_AndroidOsPowerManager$WakeLock	Landroid/os/PowerManager$WakeLock;
    //   123: aload_0
    //   124: getfield 74	mvw:jdField_a_of_type_AndroidOsPowerManager$WakeLock	Landroid/os/PowerManager$WakeLock;
    //   127: ifnull +11 -> 138
    //   130: aload_0
    //   131: getfield 74	mvw:jdField_a_of_type_AndroidOsPowerManager$WakeLock	Landroid/os/PowerManager$WakeLock;
    //   134: iconst_0
    //   135: invokevirtual 230	android/os/PowerManager$WakeLock:setReferenceCounted	(Z)V
    //   138: aload_0
    //   139: getfield 74	mvw:jdField_a_of_type_AndroidOsPowerManager$WakeLock	Landroid/os/PowerManager$WakeLock;
    //   142: ifnonnull +46 -> 188
    //   145: aload_0
    //   146: getfield 41	mvw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   149: iconst_1
    //   150: ldc 232
    ...
    //   170: ifeq -32 -> 138
    //   173: aload_0
    //   174: getfield 41	mvw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   177: iconst_2
    //   178: ldc 234
    //   180: aload 4
    ...
    //   185: goto -47 -> 138
    //   188: aload_0
    //   189: getfield 74	mvw:jdField_a_of_type_AndroidOsPowerManager$WakeLock	Landroid/os/PowerManager$WakeLock;
    //   192: ifnull -112 -> 80
    //   195: aload_0
    //   196: getfield 74	mvw:jdField_a_of_type_AndroidOsPowerManager$WakeLock	Landroid/os/PowerManager$WakeLock;
    //   199: invokevirtual 240	android/os/PowerManager$WakeLock:isHeld	()Z
    //   202: istore_3
    //   203: aload_0
    //   204: getfield 41	mvw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   207: iconst_1
    //   208: ldc 242
    //   210: iconst_2
    ...
    //   239: ifne +53 -> 292
    //   242: aload_0
    //   243: getfield 74	mvw:jdField_a_of_type_AndroidOsPowerManager$WakeLock	Landroid/os/PowerManager$WakeLock;
    //   246: invokevirtual 245	android/os/PowerManager$WakeLock:acquire	()V
    //   249: aload_0
    //   250: iconst_1
    //   251: putfield 76	mvw:d	Z
    //   254: aload_0
    //   255: getfield 62	mvw:jdField_a_of_type_Mwa	Lmwa;
    //   258: invokevirtual 247	mwa:c	()V
    //   261: aload_0
    //   262: iload_1
    //   263: putfield 76	mvw:d	Z
    //   266: goto -186 -> 80
    //   269: astore 4
    //   271: invokestatic 112	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   274: ifeq -194 -> 80
    //   277: aload_0
    //   278: getfield 41	mvw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   281: iconst_2
    //   282: ldc 249
    //   284: aload 4
    ...
    //   297: ifeq -36 -> 261
    //   300: aload_0
    //   301: getfield 74	mvw:jdField_a_of_type_AndroidOsPowerManager$WakeLock	Landroid/os/PowerManager$WakeLock;
    //   304: invokevirtual 252	android/os/PowerManager$WakeLock:release	()V
    //   307: aload_0
    //   308: iconst_0
    //   309: putfield 76	mvw:d	Z
    //   312: aload_0
    //   313: getfield 62	mvw:jdField_a_of_type_Mwa	Lmwa;
    //   316: aload_0
    //   317: getfield 82	mvw:j	Z
    //   320: aload_0
    //   321: getfield 103	mvw:f	Z
    //   324: aload_0
    //   325: getfield 80	mvw:h	Z
    //   328: aload_0
    //   329: getfield 64	mvw:jdField_a_of_type_Int	I
    //   332: iload_2
    //   333: aload_0
    //   334: getfield 66	mvw:jdField_a_of_type_ComTencentAvVideoController	Lcom/tencent/av/VideoController;
    //   337: invokevirtual 255	mwa:a	(ZZZIZLcom/tencent/av/VideoController;)V
    //   340: goto -79 -> 261
    //   343: iload_3
    //   344: ifeq -261 -> 83
    //   347: goto -318 -> 29
  ...
  void b()
  {
    ...
    if (this.jdField_a_of_type_Mvx == null) {
      this.jdField_a_of_type_Mvx = new mvx(this);
    }
    if (this.jdField_a_of_type_Mvy == null) {
      this.jdField_a_of_type_Mvy = new mvy(this);
    }
  }
