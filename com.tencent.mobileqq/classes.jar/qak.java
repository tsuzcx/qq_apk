  ...
  implements qdy
{
  ...
  public static que a(ArticleInfo paramArticleInfo, int paramInt)
  {
    if (paramInt == 0) {
      return new quf().a();
    }
  ...
  public void a(int paramInt1, Container paramContainer, pvc parampvc, int paramInt2)
  {
    ...
    qal localqal = new qal(this, parampvc, paramContainer);
    Object localObject2;
    if (localObject1 != null)
    {
      ...
      if (localObject2 != null)
      {
        ...
        ((qhz)localObject1).setOnClickListener(localqal);
      }
    }
    ...
    if (paramContainer != null)
    {
      ...
      paramContainer.setOnClickListener(localqal);
    }
    ...
    for (;;)
    {
      paramContainer.setPicClickListener(new qam(this, parampvc));
      break;
