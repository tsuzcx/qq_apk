...
public class aygh
{
  ...
  nkb jdField_a_of_type_Nkb;
  public boolean a;
  
  public aygh(AppInterface paramAppInterface, Activity paramActivity, bccx parambccx, Intent paramIntent, boolean paramBoolean)
  {
  ...
  {
    aygi localaygi = new aygi(this);
    paramTouchWebView.setWebChromeClient(localaygi);
    this.jdField_a_of_type_Nkb = localaygi;
  }
  ...
  public TouchWebView a(AppInterface paramAppInterface, Activity paramActivity, Intent paramIntent, boolean paramBoolean)
  {
    ...
    Object localObject2;
    if (aygd.a(paramActivity, paramIntent.getStringExtra("url")))
    {
      localObject2 = aygd.a(paramActivity);
    ...
    for (;;)
    {
      ...
      if (localObject2 == null)
      {
        ...
        String str2 = a(this.jdField_a_of_type_Bccx);
        if (((TouchWebView)localObject1).getX5WebViewExtension() == null) {
          break label891;
        }
        paramBoolean = true;
        QLog.i("WebLog_WebViewWrapper", 1, bcgq.a(str1, str2, paramBoolean));
        localObject3 = new StringBuilder();
        str1 = localWebSettings.getUserAgentString();
        str2 = a(this.jdField_a_of_type_Bccx);
        if (((TouchWebView)localObject1).getX5WebViewExtension() == null) {
          break label897;
        }
        paramBoolean = true;
        localWebSettings.setUserAgentString(bcgq.a(str1, str2, paramBoolean) + (String)localObject2);
      ...
      try
      {
        ...
        this.jdField_a_of_type_Aoyf = new aoyf(paramAppInterface, paramActivity, (TouchWebView)localObject1);
        this.jdField_a_of_type_Aoyf.a(paramBoolean);
        ((TouchWebView)localObject1).setDownloadListener(this.jdField_a_of_type_Aoyf);
        CookieSyncManager.createInstance(paramAppInterface.getApplication().getApplicationContext());
        if (((TouchWebView)localObject1).getX5WebViewExtension() != null)
        {
          ((TouchWebView)localObject1).getX5WebViewExtension().setWebViewClientExtension(new aygl(this, (TouchWebView)localObject1, this.jdField_a_of_type_Bccx));
          acsz.b(paramIntent, "use_x5", "1");
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("WebLog_WebViewWrapper", 2, new Object[] { "sReportPerformance:", Boolean.valueOf(bcfo.x), " cost:", Long.valueOf(bcgp.a) });
          }
          return localObject1;
          ...
          paramAppInterface.put("coreInit", String.valueOf(bcgp.a));
          paramAppInterface.put("coldStart", String.valueOf(bcfo.s));
          axrn.a(BaseApplicationImpl.getApplication().getApplicationContext()).a(null, "actWebviewInit", true, 0L, 0L, paramAppInterface, null);
        }
      }
  ...
  public nkb a()
  {
    return this.jdField_a_of_type_Nkb;
  }
  
  public void a()
  {
    if (this.jdField_a_of_type_Bccx != null) {
      this.jdField_a_of_type_Bccx = null;
    }
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Boolean) {
          ayge.a().a(this.jdField_a_of_type_ComTencentBizUiTouchWebView);
        }
        for (;;)
        {
          ...
          if (this.jdField_a_of_type_Nkb != null)
          {
            ...
            this.jdField_a_of_type_Nkb = null;
          }
          return;
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {}
    for (Object localObject = new aygj(this);; localObject = new aygk(this))
    {
