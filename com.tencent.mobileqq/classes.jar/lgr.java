...
public class lgr
  ...
  implements lgo, lha
{
  public static final String d = lbe.a() + 176 + File.separator;
  ...
  lgt jdField_a_of_type_Lgt = new lgt();
  private lhe jdField_a_of_type_Lhe = new lhe();
  private lib jdField_a_of_type_Lib;
  private WeakReference<lhb> jdField_a_of_type_MqqUtilWeakReference = new WeakReference(null);
  private boolean jdField_a_of_type_Boolean;
  private ArrayList<lgs> b = new ArrayList();
  private String e;
  private String f;
  ...
  private MagicFaceDataEntity a(FaceItem paramFaceItem, String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    {
      lba.f(this.jdField_a_of_type_JavaLangString, String.format("createMagicEntity: id=%s, senderType%s.", new Object[] { paramFaceItem.getId(), Integer.valueOf(paramInt) }));
      str1 = paramFaceItem.getId();
      str2 = paramFaceItem.getType();
      if (!"multi_result".equalsIgnoreCase(paramFaceItem.getAttr())) {
        break label100;
      }
      paramString = new lgy(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, str1, str2, paramString, paramBoolean, paramInt);
    }
    for (;;)
    {
      ...
      if ("huanlian".equalsIgnoreCase(paramFaceItem.getAttr())) {
        paramString = new lzu(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, str1, str2, paramString, paramBoolean, paramInt);
      } else {
  ...
  private MagicFaceDataEntity a(String paramString, boolean paramBoolean)
  {
    ...
    if (paramString != null)
    {
      ...
      this.jdField_a_of_type_Lgh.a(paramString, a(paramString), b(paramString), localArrayList, false);
      lba.h(this.jdField_a_of_type_JavaLangString, "prepareEntity FILE not exist: " + ((File)localObject).getPath());
    }
    return null;
  }
  
  private void a(long paramLong, MagicFaceDataEntity paramMagicFaceDataEntity, lhb paramlhb)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity != null)
    {
      ...
      if (localFaceItem != null)
      {
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          this.jdField_a_of_type_Lhe.a(paramLong, str, paramMagicFaceDataEntity, paramlhb, this);
        }
      }
    }
  }
  ...
  private boolean a(long paramLong)
  {
    if (this.jdField_a_of_type_JavaUtilQueue.size() > 0)
    {
      ...
      a(paramLong, localMagicFaceDataEntity, (lhb)this.jdField_a_of_type_MqqUtilWeakReference.get());
  ...
  private int b()
  {
    ...
    int i = localVideoController.b(locallez.d);
    if ((i == 2) || (i == 3) || (i == 4))
    {
      i = 1;
      if (i != 0) {
    ...
    do
    {
      ...
      i = 0;
      break;
      k = localVideoController.c(locallez.d);
  ...
  public int a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 3)
    {
      ...
      if ((bool1) || (bool2)) {
        if ((!"0".equalsIgnoreCase(str2)) && (!"0_iOS".equalsIgnoreCase(str2)))
        {
          ...
          new mch(l, str2, false, 4).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    ...
    for (;;)
    {
      ...
      if ("STOP".equals(str1))
      {
        continue;
        if (paramInt == 1) {
          new mch(l, paramString, false, 4).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
        }
      }
    }
  }
  ...
  public FaceItem a()
  {
    if ((this.jdField_a_of_type_Lgl != null) && (((FaceItem)this.jdField_a_of_type_Lgl).isSameType("creativecop"))) {
      return (FaceItem)this.jdField_a_of_type_Lgl;
    }
    return null;
  }
      ...
      else if (paramInt == 370)
      {
        if (((JSONObject)localObject1).has("blessingTips"))
        {
          ...
          while (i < localJSONArray.length())
          {
            ...
            lgs locallgs = new lgs();
            locallgs.jdField_a_of_type_JavaLangString = localJSONObject.optString("id");
            if (localJSONObject.has("start_date")) {
              locallgs.jdField_a_of_type_Long = ((SimpleDateFormat)localObject2).parse(localJSONObject.optString("start_date")).getTime();
            }
            if (localJSONObject.has("end_date")) {
              locallgs.jdField_b_of_type_Long = ((SimpleDateFormat)localObject2).parse(localJSONObject.optString("end_date")).getTime();
            }
            if (localJSONObject.has("text")) {
              locallgs.jdField_b_of_type_JavaLangString = localJSONObject.getString("text");
            }
            if (localJSONObject.has("image_url")) {
              locallgs.c = localJSONObject.getString("image_url");
            }
            if (localJSONObject.has("call_time_len")) {
              locallgs.jdField_a_of_type_Int = localJSONObject.getInt("call_time_len");
            }
            if (localJSONObject.has("show_time_len")) {
              locallgs.jdField_b_of_type_Int = localJSONObject.getInt("show_time_len");
            }
            this.b.add(locallgs);
            QLog.w(this.jdField_a_of_type_JavaLangString, 1, "parseConfig, blessingTips[" + locallgs + "]");
            i += 1;
          }
        }
        ...
        {
          this.jdField_a_of_type_Lgt.jdField_a_of_type_Int = ((JSONObject)localObject1).optInt("exposure_show_time_len", 5);
          this.jdField_a_of_type_Lgt.jdField_b_of_type_Int = ((JSONObject)localObject1).optInt("exposure_call_time", 2);
          this.jdField_a_of_type_Lgt.c = ((JSONObject)localObject1).optInt("click_call_time", 2);
          this.jdField_a_of_type_Lgt.d = ((JSONObject)localObject1).optInt("click_show_time_len", 5);
          this.jdField_a_of_type_Lgt.jdField_a_of_type_JavaLangString = ((JSONObject)localObject1).optString("exposure_show_text", this.jdField_a_of_type_Lgt.jdField_a_of_type_JavaLangString);
        }
      }
    }
  ...
  public lgt a()
  {
    return this.jdField_a_of_type_Lgt;
  }
  ...
  public void a()
  {
    ...
    if (locallgn != null) {
      locallgn.a(3003, this);
    }
    this.jdField_a_of_type_Lib = ((lib)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(5));
  }
  ...
  protected void a(long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    case 2: 
      ...
      new mci(paramLong, "onSessionStatusChanged", 5, null).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      lgu.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramString1);
      lgu.a(2, paramString1);
      lgu.a(2);
      return;
    }
    a(paramLong, 6101, null, Boolean.valueOf(false));
  ...
  public void a(long paramLong, String paramString, int paramInt)
  {
    ...
    {
      bool2 = this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity.a((lhc)localObject);
      bool1 = bool2;
      if (bool2)
      {
        bool1 = bool2;
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (!bool1)
      {
        ...
        {
          ((lhr)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2)).a(paramLong, this.e);
          a(paramLong, 6102, null, null);
          this.e = null;
        }
      }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      lgu.a(4, paramString2);
      lgu.a(4);
    } while (!this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(13));
    ((lhg)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(13)).a(l, "stopInteractiveVideo");
  }
  ...
  public boolean a(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity != null)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilQueue.clear();
        lba.h(this.jdField_a_of_type_JavaLangString, "stop dequeue" + paramString);
        this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity = null;
        if (paramBoolean) {
          e(paramString);
        }
        ...
        {
          this.jdField_a_of_type_Lhe.b();
          lba.h(this.jdField_a_of_type_JavaLangString, "stop " + paramString + ", mStopType =" + paramInt);
        }
      }
    }
  ...
  public boolean a(long paramLong, FaceItem paramFaceItem)
  {
    ...
    if ((paramFaceItem != null) && (paramFaceItem.isSameType("creativecop")))
    {
      ...
      ((FaceItem)this.jdField_a_of_type_Lgl).setDesc((String)localObject);
      bcef.b(null, "CliOper", "", "", "0X800A74C", "0X800A74C", 0, 0, "", "", paramFaceItem.getId(), "");
      j = b();
      if (this.jdField_a_of_type_Lib.a(3, "creative") != 1) {
        break label282;
      }
      bool1 = true;
      i = 0;
    ...
    for (;;)
    {
      ...
      if (i != 0) {
        mak.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1010, i);
      }
      if (bool2)
      {
        this.jdField_a_of_type_AndroidOsHandler.obtainMessage(101, this.jdField_a_of_type_Lgl).sendToTarget();
        if (paramFaceItem != null)
        {
          ...
          if ((!paramFaceItem.equalsIgnoreCase("face")) && (!paramFaceItem.equalsIgnoreCase("voicesticker")))
          {
            ...
            if (localObject != null) {
              ((lgn)localObject).a(3003, paramFaceItem);
            }
          }
        }
      }
  ...
  public boolean a(long paramLong, FaceItem paramFaceItem, String paramString, boolean paramBoolean, lhb paramlhb)
  {
    boolean bool2 = true;
    if (AudioHelper.f()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "start, id[" + paramString + "], curData[" + this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity + "], isSender[" + paramBoolean + "], queue[" + this.jdField_a_of_type_JavaUtilQueue.size() + "], isPlaying[" + this.jdField_a_of_type_Lhe.a() + "], mLastPendantId[" + this.e + "], seq[" + paramLong + "]");
    }
    boolean bool1;
    ...
    if (bool3)
    {
      ...
      this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramlhb);
      if ((this.jdField_a_of_type_Lhe == null) || (!this.jdField_a_of_type_Lhe.a())) {
        break label468;
      }
      if (bool3) {
        break label554;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((paramFaceItem != null) || (bool3))
        {
          ...
          paramFaceItem = (lhr)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2);
        ...
        for (;;)
        {
          QLog.w(this.jdField_a_of_type_JavaLangString, 1, "start, step[" + i + "], mLastPendantId[" + paramlhb + "->" + this.e + "]");
          ...
          a(paramLong, (MagicFaceDataEntity)localObject, paramlhb);
          paramFaceItem = (FaceItem)localObject;
          break label276;
          label506:
          i = 2;
  ...
  {
    if (log.b()) {
      log.b(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    }
    return true;
  }
