  ...
  extends arum<aruq>
{
  ...
  public arva(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(int paramInt, long paramLong, arui paramarui)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ReportLocationHandler", 2, new Object[] { "requestReportLocation: invoked. ", "uinType = [" + paramInt + "], sessionUin = [" + paramLong + "], locationItem = [" + paramarui + "]" });
    }
    RoomOperate.ReqReportLocation localReqReportLocation = new RoomOperate.ReqReportLocation();
    qq_lbs_share.RoomKey localRoomKey = aryx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, paramLong);
    localReqReportLocation.room_key.set(localRoomKey);
    localReqReportLocation.room_key.setHasFlag(true);
    localReqReportLocation.direction.set(paramarui.a());
    paramarui = paramarui.a();
    if (paramarui == null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("ReportLocationHandler", 2, new Object[] { "requestReportLocation: invoked. ", " latLng: ", paramarui });
      }
      return;
    }
    localReqReportLocation.lat.set(paramarui.latitude);
    localReqReportLocation.lon.set(paramarui.longitude);
    paramarui = new ToServiceMsg("mobileqq.service", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "QQLBSShareSvc.report_location");
    paramarui.putWupBuffer(localReqReportLocation.toByteArray());
    a().sendPbReq(paramarui);
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (a(paramToServiceMsg, paramFromServiceMsg, paramObject))
    {
      try
      {
        ...
        if (aryx.a((qq_lbs_share.ResultInfo)paramToServiceMsg.msg_result.get()))
        {
  ...
  public void a(String paramString, arvb paramarvb)
  {
  ...
  public boolean a(aruk paramaruk)
  {
    ...
    return new aruk(this.b, "" + this.jdField_a_of_type_JavaLangLong).equals(paramaruk);
  }
