...
public class por
  extends thb<TabChannelCoverInfo>
  implements View.OnClickListener, bkij, bkik, thh, thi
{
  public int a;
  private int[] a;
  private int c = -1;
  ...
  public por(ReadInJoyChannelPanelFragment paramReadInJoyChannelPanelFragment, Context paramContext, int paramInt1, int paramInt2)
  {
  ...
  private void a(int paramInt, TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    do
    {
      ...
      try
      {
        ReadInJoyChannelPanelFragment.a("0X800949C", new phi().b().a(paramTabChannelCoverInfo.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(paramTabChannelCoverInfo)).a());
    ...
    for (paramTabChannelCoverInfo.channelConfigType = ((rex)ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment).get(1)).a;; paramTabChannelCoverInfo.channelConfigType = paramTabChannelCoverInfo.sectionId)
    {
      localReadInJoyStaticGridView.a(localReadInJoyStaticGridView.a().getCount() - 1, 0, paramTabChannelCoverInfo);
      paramTabChannelCoverInfo = new pos(this, localReadInJoyStaticGridView);
      localReadInJoyStaticGridView.setTag(2131376006, paramTabChannelCoverInfo);
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = new rgg();
        ((rev)localObject).a = ((TabChannelCoverInfo)localList.get(i));
        ((rev)localObject).l = i;
        ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment, (rev)localObject, this.d);
        i += 1;
      }
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ReadInJoyChannelPanelFragment.a("0X800949B", new phi().b().a(localTabChannelCoverInfo.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(localTabChannelCoverInfo)).a());
      this.c = -1;
      return;
    }
    catch (JSONException localJSONException)
  ...
  public boolean a(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    try
    {
      ReadInJoyChannelPanelFragment.a("0X800949A", new phi().b().a(paramAdapterView.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(paramAdapterView)).a());
      return true;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment, 2131560210), null);
      localpot = new pot(this);
      localpot.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131369885));
      localpot.jdField_a_of_type_ComTencentMobileqqWidgetAutoFitTextView = ((AutoFitTextView)paramView.findViewById(2131364324));
      localpot.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376278));
      localpot.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376291));
      localpot.b = ((ImageView)paramView.findViewById(2131365326));
      localpot.b.setOnClickListener(this);
      localpot.jdField_a_of_type_ComTencentMobileqqWidgetAutoFitTextView.setOnGetMaxWidthCallback(localpot);
      localpot.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView = ((KanDianUrlRoundCornerImageView)paramView.findViewById(2131369156));
      if (localpot.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView != null) {
        localpot.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView.setCorner(ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment));
      }
      paramView.setTag(localpot);
    }
    for (;;)
    {
      paramView.setAlpha(1.0F);
      localpot.jdField_a_of_type_ComTencentMobileqqWidgetAutoFitTextView.setText(((TabChannelCoverInfo)localObject).mChannelCoverName);
      localpot.jdField_a_of_type_ComTencentMobileqqWidgetAutoFitTextView.setTextColor(ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment, (TabChannelCoverInfo)localObject));
      ImageView localImageView = localpot.b;
      int i;
      if (ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment))
      {
        ...
        localpot.b.setTag(localObject);
        localpot.b.setTag(2131376055, Integer.valueOf(paramInt));
        if ((paramInt < this.jdField_a_of_type_Int) && (ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment)))
        {
          ...
          localpot.b.setVisibility(8);
        }
        if (!ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment)) {
          break label413;
        }
        localpot.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        localpot.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
        if ((localpot.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView == null) || (!pih.a())) {}
      }
      try
      {
        localObject = new URL(((TabChannelCoverInfo)localObject).mChannelCoverIcon);
        pgk.a(localpot.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKanDianUrlRoundCornerImageView, (URL)localObject, paramView.getContext());
        EventCollector.getInstance().onListGetView(paramInt, paramView, paramViewGroup, getItemId(paramInt));
        return paramView;
        localpot = (pot)paramView.getTag();
        continue;
        i = 8;
        break label239;
        label413:
        localImageView = localpot.jdField_a_of_type_AndroidWidgetImageView;
        ...
        for (i = 0;; i = 8)
        {
          ...
          localpot.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
          ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment, (TabChannelCoverInfo)localObject, localpot.jdField_a_of_type_AndroidWidgetTextView);
          break;
        }
        label493:
        localpot.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      int i = ((Integer)paramView.getTag(2131376055)).intValue();
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (!ReadInJoyChannelPanelFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyChannelPanelFragment)) {
      try
      {
        ReadInJoyChannelPanelFragment.a("0X8009499", new phi().b().a(paramAdapterView.mChannelCoverId).m(ReadInJoyChannelPanelFragment.a(paramAdapterView)).n(ReadInJoyChannelPanelFragment.a(paramAdapterView)).c((int)paramAdapterView.sectionId).b("style", 1).a());
        ...
        if (bmqa.A())
        {
          pmh.a().a(paramAdapterView.mChannelCoverId, 3, false, true);
          pha.b().post(new ReadInJoyChannelPanelFragment.DynamicGridViewAdapter.1(this, paramAdapterView));
          return;
        }
      }
      catch (JSONException paramView)
      {
        for (;;)
        {
          ...
          continue;
          pmh.a().b(paramAdapterView.mChannelCoverId, 3);
        }
      }
    }
