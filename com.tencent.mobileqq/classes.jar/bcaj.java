  ...
  implements bbzr
{
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (!paramMessageHandler.a().a(str))
        {
          ...
          if ((paramInt1 == 241) || (bbzj.a(str, paramInt1)))
          {
        ...
        for (;;)
        {
          ...
          QLog.d("OfflineFileDecoder", 2, localStringBuilder.toString());
          return;
          if ((paramInt1 != 242) && (!bbzj.b(str, paramInt1))) {
            break;
          }
          if (!str.equals(""))
          {
          ...
          {
            label872:
            paramMsg = bdzv.a((String)localObject1, paramLong1, 2, false, (String)localObject1, null, "ftn");
            ...
            bdxh.a(paramMessageHandler.app, 1, false, 4);
            break;
            if (QLog.isColorLevel()) {
  ...
  public void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, bbyn parambbyn)
  {
    ...
    long l2 = parambbyn.e;
    boolean bool2 = parambbyn.jdField_a_of_type_Boolean;
    boolean bool3 = parambbyn.b;
    if (l1 == parambbyn.jdField_a_of_type_Long) {}
    for (boolean bool1 = true;; bool1 = false)
    {
      a(paramMessageHandler, paramList, i, paramMsg, l2, bool2, bool3, bool1, parambbyn.jdField_d_of_type_Long, parambbyn.jdField_d_of_type_Boolean, parambbyn.jdField_a_of_type_Int);
      return;
    }
  }
}
