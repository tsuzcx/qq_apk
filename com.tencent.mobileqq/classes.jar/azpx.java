  ...
  extends Handler
{
  ...
  public azpx(SuspendThreadManager paramSuspendThreadManager, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  private void c()
  {
    try
    {
      ...
      boolean bool1;
      if ((Build.VERSION.SDK_INT <= 23) && (azjg.h))
      {
      ...
      for (;;)
      {
        ...
        for (boolean bool2 = true;; bool2 = false)
        {
          ...
          this.jdField_a_of_type_Azpy = new azpy(this.jdField_a_of_type_ComTencentMobileqqStatisticsThreadSuspendThreadManager, this.jdField_a_of_type_AndroidOsHandlerThread.getLooper(), Thread.currentThread(), this);
  ...
  private void j()
  {
    ...
    azmz.a(BaseApplicationImpl.getApplication()).a((String)localObject, "suspendThreadMonitor", true, this.d, 0L, localHashMap, null);
  ...
  private void k()
  {
    ...
    localHashMap.put("qq_num", localObject);
    azmz.a(BaseApplicationImpl.getApplication()).a((String)localObject, "suspendThreadNotResume", true, 0L, 0L, localHashMap, null);
  }
