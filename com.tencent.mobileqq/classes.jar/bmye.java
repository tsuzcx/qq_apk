  ...
  extends bmxt
{
  ...
  public bmye(Context paramContext, String paramString)
  {
  ...
  private void d()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Bmyf.sendEmptyMessageDelayed(0, 40L);
      localBitmap = null;
  ...
  public Bitmap a()
  {
    ...
    ArrayList localArrayList = this.jdField_a_of_type_Bmxh.a(this.jdField_a_of_type_Bmxh.a());
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Bmyf != null) {
      this.jdField_a_of_type_Bmyf.removeCallbacksAndMessages(null);
    }
  }
  ...
  protected void b()
  {
    this.jdField_a_of_type_Bmyf = new bmyf(new WeakReference(this));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder = new bluw(this.jdField_b_of_type_JavaLangString);
        ...
        this.k = this.jdField_a_of_type_Bmxh.a("offsetX", 0L, 650L, (int)(-i1 * 0.3D), 0, new bmyc());
        this.l = this.jdField_a_of_type_Bmxh.a("offsetX", 100L, 650L, (int)(-i1 * 0.3D), 0, new bmyc());
        this.m = this.jdField_a_of_type_Bmxh.a("offsetX", 200L, 650L, (int)(-i1 * 0.3D), 0, new bmyc());
        this.n = this.jdField_a_of_type_Bmxh.a("alpha", 0L, 370L, 0, 255, new xmj(0.33F, 0.0F, 0.67F, 1.0F));
        this.o = this.jdField_a_of_type_Bmxh.a("alpha", 100L, 370L, 0, 255, new xmj(0.33F, 0.0F, 0.67F, 1.0F));
        this.p = this.jdField_a_of_type_Bmxh.a("alpha", 200L, 370L, 0, 255, new xmj(0.33F, 0.0F, 0.67F, 1.0F));
        return;
      }
  ...
  protected void c()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder != null) && (this.jdField_b_of_type_Boolean)) {
      this.jdField_a_of_type_Bmyf.sendEmptyMessage(0);
    }
  }
