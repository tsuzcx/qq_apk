...
public class aphy
{
  ...
  public aphy(String paramString1, String paramString2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4)
  {
    ...
    for (this.jdField_a_of_type_Long = new File(this.jdField_a_of_type_JavaLangString).length();; this.jdField_a_of_type_Long = 0L)
    {
      ...
      return;
      this.jdField_b_of_type_JavaLangString = apug.a(paramString1);
      break;
    }
  }
