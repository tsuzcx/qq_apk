  ...
  implements adgo
{
  ...
  private void a(String paramString1, int paramInt1, String paramString2, String paramString3, int paramInt2)
  {
    ...
    try
    {
      ...
      nir.a(localAppRuntime, new adgr(this, paramString1, paramString3, paramInt2), localReqBody.toByteArray(), "OidbSvc.0xb6f_1", 2927, 1, null, 0L);
      return;
    }
  ...
  private void a(String paramString1, int paramInt, String paramString2, String paramString3, long paramLong1, long paramLong2)
  {
    ...
    for (;;)
    {
      localObject = this.a;
      if (localObject != null) {
        ThreadManager.getUIHandler().post(new DoraemonAPIReporterMain.4(this, (adgp)localObject, paramString1, paramInt, paramString2, paramString3, paramLong1, paramLong2));
      }
      return;
      QLog.e("DoraemonOpenAPI.report", 1, "app is null");
    }
  ...
  private void a(String paramString, List<APIQuotaEntity> paramList)
  {
    ...
    if (localadgp != null)
    {
      ...
      ThreadManager.getUIHandler().post(new DoraemonAPIReporterMain.5(this, localadgp, paramString, localHashMap));
    }
  }
