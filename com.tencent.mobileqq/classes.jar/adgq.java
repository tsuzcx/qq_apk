...
{
  public adgq(AddFriendVerifyActivity paramAddFriendVerifyActivity, int paramInt) {}
  ...
  public void onClick(View paramView)
  {
    ...
    {
      localObject = new ReportDialog(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendVerifyActivity, 2131755829);
      ((Dialog)localObject).setContentView(2131562799);
      ((TextView)((Dialog)localObject).findViewById(2131365644)).setText(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendVerifyActivity.getString(2131691077));
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendVerifyActivity.getString(2131691907).equals(localObject)) && (!AddFriendVerifyActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendVerifyActivity))) {
      ...
      if (this.jdField_a_of_type_Int == 0) {
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendVerifyActivity.app, "dc00898", "", "", "0X800796F", "0X800796F", 0, 0, "", "", "", "");
      }
      for (;;)
      {
        ...
        break;
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqActivityAddFriendVerifyActivity.app, "dc00898", "", "", "0X8007976", "0X8007976", 0, 0, "", "", "", "");
      }
    }
  }
}
