...
public class alxz
  extends amgy
{
  public alxz(RecentMemberInnerFrame paramRecentMemberInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = (alya)paramView.getTag();
      localView = paramView;
    ...
    for (;;)
    {
      ...
      return localView;
      paramView = new alya(this.a, null);
      localView = this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getLayoutInflater().inflate(2131562851, paramViewGroup, false);
    ...
    if (this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.isResultListContainFriend(localRecentUser.uin))
    {
      ...
      if ((this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.mUinsSelectedDefault == null) || (!this.a.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.mUinsSelectedDefault.contains(localRecentUser.uin))) {
        break label358;
      }
      ...
      if (AppSetting.c)
      {
        ...
        localView.setContentDescription((String)localObject + anvx.a(2131712660));
      }
    }
    for (;;)
    {
      ...
      break label168;
      label348:
      localObject = ContactUtils.getFriendName((Friends)localObject);
      break label211;
      label358:
      paramView.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(true);
      break label271;
      label369:
      localView.setContentDescription((String)localObject + anvx.a(2131712657));
    }
  }
}
