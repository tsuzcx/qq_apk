...
public class bhwp
{
  public static int a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    if (ShortVideoTrimmer.a(paramContext, 0, 0))
    {
      ...
      {
        i = j;
        if (((axlo)localObject).jdField_a_of_type_Boolean)
        {
          ...
          localObject = new bhwq(paramString2, (int)(((axlo)localObject).b * 1024L), (int)((axlo)localObject).jdField_a_of_type_Long);
          if ((!new axmd().a(localFile, (axme)localObject, true)) || (((bhwq)localObject).a != null)) {
            break label339;
          }
          if (QLog.isColorLevel()) {
  ...
  public static String a(String paramString)
  {
    ...
    //   1: astore 5
    //   3: aload_0
    //   4: invokestatic 293	bhwp:b	(Ljava/lang/String;)Ljava/lang/String;
    //   7: astore 6
  ...
  public static JSONObject a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      localBundle.putString("bkn", String.valueOf(bamn.b((String)localObject)));
      try
      {
        ...
        if (bhwn.a().a()) {}
        for (paramAppRuntime = nak.a(paramAppRuntime, "https://qun.qq.com/cgi-bin/grouphw/upload_auth/put", localBundle, paramString1);; paramAppRuntime = nam.a(paramAppRuntime, "https://qun.qq.com/cgi-bin/grouphw/upload_auth/put", "GET", localBundle, paramString1))
        {
  ...
  public static String b(String paramString)
  {
    ...
    for (;;)
    {
      return bbuv.a(((StringBuilder)localObject).toString());
  ...
  public static JSONObject b(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramAppRuntime = paramAppRuntime.getApplication().getApplicationContext();
        if (bhwn.a().a()) {}
        for (paramAppRuntime = nak.a(paramAppRuntime, "https://qun.qq.com/cgi-bin/grouphw/upload_append", localBundle, paramString1);; paramAppRuntime = nam.a(paramAppRuntime, "https://qun.qq.com/cgi-bin/grouphw/upload_append", "GET", localBundle, paramString1))
        {
          paramString1 = paramAppRuntime;
          if (paramAppRuntime == null) {
            paramString1 = "";
