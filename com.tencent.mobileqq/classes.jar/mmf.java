  ...
  implements View.OnClickListener
{
  ...
  public mmf(View paramView, BaseData paramBaseData)
  {
    super(paramView, paramBaseData);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131361926));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367077));
    this.d = ((TextView)paramView.findViewById(2131367083));
    this.c = ((TextView)paramView.findViewById(2131367084));
    this.e = ((TextView)paramView.findViewById(2131367085));
    this.f = ((TextView)paramView.findViewById(2131367087));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView = ((KandianUrlImageView)paramView.findViewById(2131367082));
    paramView.findViewById(2131367081).setOnClickListener(this);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView.setRound(true);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131367086));
  ...
  private void a()
  {
    try
    {
      ThreadManager.post(new mmg(this), 8, null, false);
      return;
    }
    catch (Exception localException) {}
  }
  ...
  private void b()
  {
    ...
    {
      a(true);
      PublicAccountUtil.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_AndroidViewView.getContext(), Long.toString(a()), new mmi(this));
    }
  }
