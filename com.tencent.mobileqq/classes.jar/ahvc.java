  ...
  extends BaseAdapter
{
  ...
  public ahvc(QQAppInterface paramQQAppInterface, Context paramContext, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, ChatHistoryC2CLinkFragment paramChatHistoryC2CLinkFragment, ahze paramahze)
  {
    ...
    this.jdField_a_of_type_Ahze = paramahze;
    this.jdField_a_of_type_JavaTextSimpleDateFormat = new SimpleDateFormat("M月d日");
    this.jdField_a_of_type_Aloz = ((aloz)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.getActivity().app.getManager(51));
  }
  ...
  private void a(ahvh paramahvh, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          a(ahvh.a(paramahvh), (String)localObject);
          i = 1;
          if (i == 0) {
            ahvh.a(paramahvh).setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849787));
          }
          str1 = a(ahzf.a(paramMessageRecord));
          if (!(paramMessageRecord instanceof MessageForArkApp)) {
            break label300;
          }
          str2 = ((MessageForArkApp)paramMessageRecord).getTitle();
          localTextView = ahvh.a(paramahvh);
          localObject = str2;
          ...
          ahvh.b(paramahvh).setText((CharSequence)localObject);
          ahvh.c(paramahvh).setText(bdbt.m(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.getActivity().app, paramMessageRecord.senderuin));
          ahvh.a(paramahvh).setOnClickListener(new ahve(this, str1, paramahvh, paramMessageRecord));
          if (!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.c) {
            break label312;
          }
          ahvh.a(paramahvh).setVisibility(0);
          bool = this.jdField_a_of_type_Ahze.a(paramMessageRecord);
          ahvh.a(paramahvh).setChecked(bool);
          paramMessageRecord = (LinearLayout.LayoutParams)ahvh.a(paramahvh).getLayoutParams();
          paramMessageRecord.setMargins(paramMessageRecord.leftMargin, paramMessageRecord.topMargin, xod.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), paramMessageRecord.bottomMargin);
          ahvh.a(paramahvh).setLayoutParams(paramMessageRecord);
          return;
        }
      ...
      continue;
      label300:
      ahvh.a(paramahvh).setText(str1);
      continue;
      label312:
      ahvh.a(paramahvh).setVisibility(8);
      paramMessageRecord = (LinearLayout.LayoutParams)ahvh.a(paramahvh).getLayoutParams();
      paramMessageRecord.setMargins(paramMessageRecord.leftMargin, paramMessageRecord.topMargin, xod.a(this.jdField_a_of_type_AndroidContentContext, 50.0F), paramMessageRecord.bottomMargin);
      ahvh.a(paramahvh).setLayoutParams(paramMessageRecord);
      return;
      label374:
      int i = 0;
  ...
  public static void a(ImageView paramImageView, String paramString)
  {
    ...
    Drawable localDrawable = localBaseApplication.getResources().getDrawable(2130849787);
  ...
  private void a(String paramString)
  {
    ...
    if (bool2)
    {
      ...
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AC87", "0X800AC87", 5, 0, "1", "2", "", "");
    }
    for (;;)
    {
      ...
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AC87", "0X800AC87", 5, 0, "1", "1", "", "");
    }
  }
  ...
  public void a(URLImageView paramURLImageView, AbsShareMsg paramAbsShareMsg)
  {
    ...
    for (paramAbsShareMsg = Uri.fromFile(new File((String)localObject1)).toString();; paramAbsShareMsg = (AbsShareMsg)localObject1)
    {
      ...
      paramAbsShareMsg.setTag(bcuq.b(((ViewGroup.LayoutParams)localObject1).width, ((ViewGroup.LayoutParams)localObject1).height, xod.a(this.jdField_a_of_type_AndroidContentContext, 6.0F)));
      paramAbsShareMsg.setDecodeHandler(bcuq.i);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localObject2 instanceof MessageForStructing))
    {
      ...
      if ((paramView != null) && ((paramView.getTag() instanceof ahvg)))
      {
        paramViewGroup = (ahvg)paramView.getTag();
        ...
        if ((((MessageForStructing)localObject1).structingMsg != null) && ((((MessageForStructing)localObject1).structingMsg instanceof AbsShareMsg)))
        {
          ...
          localObject2 = bdbt.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.getActivity().app, ((MessageForStructing)localObject1).senderuin);
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(this.jdField_a_of_type_Ahze.a(localObject1));
    ...
    do
    {
      ...
      paramViewGroup = new ahvg(this);
      paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131558812, null);
      ...
      paramViewGroup.c = ((TextView)paramView.findViewById(2131365004));
      ...
      {
        if ((paramView != null) && ((paramView.getTag() instanceof ahvh)))
        {
          localObject1 = (ahvh)paramView.getTag();
          paramViewGroup = paramView;
        ...
        for (;;)
        {
          ...
          return paramViewGroup;
          paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558760, null);
          paramView = new ahvh(this, paramViewGroup);
    ...
    label391:
    if ((paramView != null) && ((paramView.getTag() instanceof ahvf)))
    {
      localObject1 = (ahvf)paramView.getTag();
      paramViewGroup = paramView;
      paramView = (View)localObject1;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramViewGroup.setTag(paramView);
      paramViewGroup.setOnClickListener(new ahvd(this, paramView));
      break;
    }
  }
}
