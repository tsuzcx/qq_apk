...
public class azjy
{
  ...
  public azjy(int paramInt1, int paramInt2, Map<Integer, String> paramMap)
  {
  ...
  {
    boolean bool = false;
    if ((paramObject instanceof azjy)) {
      bool = bgjw.a(((azjy)paramObject).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString);
    }
    return bool;
  }
}
