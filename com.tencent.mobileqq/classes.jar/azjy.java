  ...
  implements wxw
{
  ...
  private void g(String paramString)
  {
    ...
    a();
    localObject = new bcpq((Context)localObject, ((BaseActivity)localObject).getTitleBarHeight());
    ((bcpq)localObject).a(paramString);
    ((bcpq)localObject).setCancelable(false);
    ((bcpq)localObject).setOnDismissListener(new azka(this));
    this.jdField_a_of_type_Bcpq = ((bcpq)localObject);
  ...
  private void h(String paramString)
  {
    ...
    {
      bcpw.a((Context)localObject, 2131694607, 0).b(((BaseActivity)localObject).getTitleBarHeight());
      return;
    }
    g(((BaseActivity)localObject).getString(2131720581));
  ...
  private void j(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localIntent.putExtra("param_title", this.mRuntime.a().getString(2131693681));
        localIntent.putExtra("param_done_button_wording", this.mRuntime.a().getString(2131694793));
        localIntent.putExtra("param_done_button_highlight_wording", this.mRuntime.a().getString(2131694794));
        localIntent.putExtra("param_only_friends", true);
      ...
      catch (JSONException localJSONException1)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            paramString.putString("troop_info_title", localActivity.getString(2131696414));
  ...
  private void m(String paramString)
  {
    ...
    g(((Activity)localObject).getString(2131720586));
    localObject = new Intent((Context)localObject, TroopCreateLogicActivity.class);
  ...
  {
    c();
    bfol localbfol = (bfol)bfoy.a(this.mRuntime.a(), null);
    localbfol.a(2131720579);
    localbfol.a(2131720580, 3);
    localbfol.c(2131690596);
    localbfol.setOnDismissListener(new azkb(this));
    localbfol.a(new azkc(this));
  ...
  public void b(String paramString)
  {
    ...
    if (!bbev.d(localBaseActivity)) {
      bcpw.a(localBaseActivity, 2131694607, 0).b(localBaseActivity.getTitleBarHeight());
    }
  ...
  public void d(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 65	azjy:mRuntime	Lbcdb;
    //   4: invokevirtual 70	bcdb:a	()Landroid/app/Activity;
    //   7: astore_3
    ...
    catch (JSONException paramString)
    {
      try
      {
        ...
        if (paramString != null)
        {
          ...
          azjx.a(localActivity, localActivity.getIntent().getExtras(), paramString);
        }
        return;
      }
      catch (JSONException paramString) {}
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramString3 = this.jdField_a_of_type_Wxu;
      if (j == -1) {}
      ...
      if (paramString3.equals("insertCreateGroupSuccessMsg")) {
        try
        {
          ...
          this.jdField_a_of_type_Wxu.a(paramJsBridgeListener, paramString1, i, paramString2, this);
        }
      ...
      {
        bcpw.a(this.mRuntime.a(), 0, "该api功能已下架!", 0).a();
        break label2264;
      }
      ...
      {
        paramJsBridgeListener.a("8.2.8.4440");
        break label2264;
      }
      if (paramString3.equals("isNetworkConnected"))
      {
        paramJsBridgeListener.a(Boolean.valueOf(bdho.d(bcxm.a().a())));
        break label2264;
      }
    ...
    else
    {
      ...
      if ("updateTroopBindedPubAccount".equals(paramString3))
      {
        try
        {
          ...
          if (j > 0)
          {
            ...
            this.jdField_a_of_type_Wxu.a(l, paramString1);
          }
          if (!QLog.isColorLevel()) {
            break label2264;
          }
      ...
      else if ("getLastSpeakMessage".equals(paramString3))
      {
        try
        {
          ...
          paramString2 = paramString2.optString("callback");
          this.jdField_a_of_type_Wxu.a(paramJsBridgeListener, paramString1, new azjz(this, paramString2));
          if (!QLog.isColorLevel()) {
            break label2264;
          }
      ...
      else if ("notifyTroopEnterEffectStatus".equals(paramString3))
      {
        try
        {
          ...
          this.jdField_a_of_type_Wxu.a(i, j, k, paramString1);
      ...
      else if ("returnToTroopAIO".equals(paramString3))
      {
        ...
        SensorAPIJavaScript.returnToAio(this.jdField_a_of_type_Wxu, this.mRuntime.a(), paramJsBridgeListener, true);
        break label2264;
      }
      else
      {
        if ("notifyCreateTroops".equals(paramString3))
        {
          try
          {
            ...
            paramString2 = paramString2.optString("callback");
            this.jdField_a_of_type_Wxu.b(paramJsBridgeListener, paramString1, paramString2, this);
          }
          catch (JSONException paramJsBridgeListener)
          {
            if (!QLog.isColorLevel()) {
          ...
          for (;;)
          {
            try
            {
              ...
              if ((paramString2 != null) && (paramString2.length() > 0))
              {
                ...
                this.jdField_a_of_type_Wxu.a(paramString3);
  ...
  public void onActivityResult(Intent paramIntent, byte paramByte, int paramInt)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            paramInt = azol.a(paramByte);
            if (paramInt != 0) {
              bcpw.a(this.mRuntime.a(), paramInt, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
            }
    ...
    {
      if (bool) {
        bcpw.a((Context)localObject2, 2131720578, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
      for (;;)
      {
        ...
        return;
        bcpw.a((Context)localObject2, 2131720583, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
    }
    if (paramByte == 1002) {
      paramIntent = ((BaseActivity)localObject2).getString(2131720591);
    }
    for (;;)
    {
      bcpw.a((Context)localObject2, paramIntent, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      return;
      if (bool) {
        paramIntent = ((BaseActivity)localObject2).getString(2131720577);
      } else {
        paramIntent = ((BaseActivity)localObject2).getString(2131720582);
      }
    }
  }
