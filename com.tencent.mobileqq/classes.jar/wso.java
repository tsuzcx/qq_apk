  ...
  extends FlingGestureHandler
{
  ...
  public wso(Activity paramActivity)
  {
    super(paramActivity);
    ...
    if (this.mTopLayout != null)
    {
      ...
      this.mTopLayout.setInterceptTouchEventListener(new wsp(this, paramActivity));
    }
    onStart();
  }
  ...
  public void flingRToL()
  {
    if (this.mTopLayout != null)
    {
      ...
      wis.a(this.mTopLayout.getContext(), this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser);
    }
    label29:
    while (this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed == null) {
      return;
    }
    wis.a(this.mTopLayout.getContext(), this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed);
  }
}
