  ...
  extends BaseChatPie
{
  ...
  anrc jdField_a_of_type_Anrc = new afzv(this);
  private antq jdField_a_of_type_Antq = new afzu(this);
  protected anyz a;
  public bkzi a;
  private Observer jdField_a_of_type_JavaUtilObserver = new afzx(this);
  
  public afzr(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    super(paramQQAppInterface, paramViewGroup, paramFragmentActivity, paramContext);
    this.jdField_a_of_type_Anyz = new afzy(this);
  }
  ...
  private void b()
  {
    ...
    DiscussionInfo localDiscussionInfo = localantp.a(this.sessionInfo.curFriendUin);
    ...
    if (localantp.a.containsKey(this.sessionInfo.curFriendUin)) {
      c();
    }
  }
    ...
    for (paramIntent = paramIntent.getStringExtra("result");; paramIntent = "")
    {
      if ((paramIntent != null) && (!paramIntent.equals("")))
      {
        if (NetworkUtil.isNetSupport(getActivity())) {
          ((antl)this.app.getBusinessHandler(BusinessHandlerFactory.DISCUSSION_HANDLER)).a(Long.valueOf(this.sessionInfo.curFriendUin).longValue(), paramIntent);
        }
      }
      else {
        return;
      }
      QQToast.a(this.mContext, this.mContext.getString(2131694305), 0).b(getTitleBarHeight());
      return;
    }
  }
  ...
  private void c()
  {
    ...
    do
    {
      do
      {
        ...
        return;
        localObject1 = (String[])localantp.a.get(this.sessionInfo.curFriendUin);
    ...
    for (;;)
    {
      try
      {
        localObject1 = BitmapFactory.decodeResource(this.mContext.getResources(), 2130842508);
      ...
      catch (OutOfMemoryError localOutOfMemoryError1)
      {
        try
        {
          localObject2 = bheg.b((Bitmap)localObject1, 10.0F, 140, 140);
          this.jdField_a_of_type_AndroidAppDialog = bhdj.a(this.mContext, (Bitmap)localObject2, ContactUtils.getDiscussionMemberName(this.app, this.sessionInfo.curFriendUin, str2) + anvx.a(2131702819), anvx.a(2131702818) + str1, this.mContext.getString(2131718822), null, new afzt(this, str1), null);
          if ((this.jdField_a_of_type_AndroidAppDialog != null) && (!this.mActivity.isFinishing())) {
            this.jdField_a_of_type_AndroidAppDialog.show();
          }
          localantp.a.remove(this.sessionInfo.curFriendUin);
          return;
        }
  ...
  public void a(String paramString1, String paramString2, TextView paramTextView)
  {
    ...
    {
      return;
      i = ((antp)this.app.getManager(QQManagerFactory.DISCUSSION_MANAGER)).a(this.sessionInfo.curFriendUin);
    ...
    if (this.jdField_a_of_type_AndroidWidgetTextView == null) {
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.mTitleLayout.findViewById(2131365728));
    }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("_At_Me_DISC", 2, "memUin:" + paramString1 + " displayName:" + bhbx.a(paramString2) + " isRemoveOldAtFlag:" + paramBoolean);
    }
    ...
    if (this.sessionInfo.debugFilterMemberMsgCommand)
    {
      ...
      this.dirty = 131077;
      refresh(this.dirty);
      this.mFunBtn.setText(anvx.a(2131702815));
  ...
  public void addBusinessObservers()
  {
    ...
    this.app.addObserver(this.jdField_a_of_type_Antq);
  ...
  public void doOnStop()
  {
    if (!this.hasDestory)
    {
      bfzk localbfzk = (bfzk)this.app.getManager(QQManagerFactory.TROOP_AIO_NAVIGATE_BAR);
      if (localbfzk != null) {
        localbfzk.a(this.sessionInfo.curFriendUin + "&" + 3000, 0);
      }
    }
    super.doOnStop();
  }
  ...
  public void initTipsTaskList()
  {
    ...
    aikc localaikc = new aikc(this.app, this.mTipsMgr, this.mActivity, this.sessionInfo, this.listAdapter);
    aike localaike = new aike(this.app, this.mTipsMgr, this.mActivity, this.sessionInfo, this.listAdapter);
    this.jdField_a_of_type_Aikn = new aikn(this.app, this.mTipsMgr, this.mActivity, this.sessionInfo);
    this.mTipsMgr.a(localaikc);
    this.mTipsMgr.a(localaike);
  ...
  public void onShowFirst(int paramInt)
  {
    ...
    lnf locallnf = this.app.getAVNotifyCenter().a(Long.valueOf(this.sessionInfo.curFriendUin).longValue(), 2);
    if (locallnf != null)
    {
      if (!locallnf.a) {
        break label133;
      }
      bdla.b(null, "CliOper", "", "", "0X80066C0", "0X80066C0", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      ...
      return;
      label133:
      bdla.b(null, "CliOper", "", "", "0X80066BD", "0X80066BD", 0, 0, "", "", "", "");
    }
  }
  ...
  public void onTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      return;
      DiscussionInfo localDiscussionInfo = ((antp)this.app.getManager(QQManagerFactory.DISCUSSION_MANAGER)).a(this.sessionInfo.curFriendUin);
      bool = false;
      if (localDiscussionInfo != null) {
        bool = localDiscussionInfo.isDiscussHrMeeting();
      }
    } while ((bool) || (this.sessionInfo.curType != 3000) || (this.sessionInfo.curFriendUin == null) || (this.sessionInfo.curFriendUin.length() == 0) || (paramInt3 != 1) || ((paramCharSequence.charAt(paramInt1) != '@') && (paramCharSequence.charAt(paramInt1) != 65312)) || (this.isBeingInputDraft) || (((agjr)getHelper(27)).a));
    e();
  }
  ...
  public void removeBusinessObservers()
  {
    ...
    this.app.removeObserver(this.jdField_a_of_type_Antq);
  ...
  public void saveTextDraft(SessionInfo paramSessionInfo, awtg paramawtg, Spanned paramSpanned, QQAppInterface paramQQAppInterface, String paramString1, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, String paramString2)
  {
    if (paramSessionInfo.curType == 3000)
    {
      ...
      paramSpanned = bgcz.a(this.input.getEditableText(), paramSpanned);
    }
    for (;;)
    {
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      {
        paramObservable = (bffr)paramObject;
        if (paramObservable != null)
        {
          if (paramObservable.jdField_a_of_type_Int != bffq.jdField_a_of_type_Int) {
            break label127;
          }
      ...
      for (;;)
      {
        ...
        return;
        label127:
        if ((paramObservable.jdField_a_of_type_Int == bffq.b) && (this.speakerPhoneLayout != null))
        {
  ...
  {
    this.mTitleBtnCall.setOnClickListener(new afzs(this));
    if (mbl.a().a(this.app.getCurrentAccountUin()))
    {
      this.mTitleBtnCall.setVisibility(0);
      this.mTitleBtnCall.setContentDescription(this.mActivity.getResources().getString(2131698261));
    }
    for (;;)
    {
      adjustTitleDimension();
