  ...
  extends RelativeLayout
{
  ...
  public afzr(PanelAdapter paramPanelAdapter, Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    int k = paramPanelAdapter.a();
    int m = paramPanelAdapter.b();
    int i = afur.a(15.0F, getContext().getResources());
    ...
    while (i < m)
    {
      ...
      localLayoutParams.leftMargin = afur.a(20.0F, getContext().getResources());
      localLayoutParams.rightMargin = afur.a(20.0F, getContext().getResources());
      ...
      while (j < k)
      {
        ...
        View localView = LayoutInflater.from(paramContext).inflate(2131558870, null);
        paramAttributeSet.addView(localView, (ViewGroup.LayoutParams)localObject);
        localObject = new afzs();
        ((afzs)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131368270));
        ((afzs)localObject).jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch = new RedTouch(paramContext, ((afzs)localObject).jdField_a_of_type_AndroidWidgetImageView).a(8388661).a();
        ((afzs)localObject).b = ((ImageView)localView.findViewById(2131366734));
        ((afzs)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378460));
  ...
  public void a()
  {
    ...
    while (i < getChildCount())
    {
      ...
      if (localObject != null)
      {
        localObject = (afzs)((View)localObject).getTag();
        if ((localObject != null) && (((afzs)localObject).jdField_a_of_type_AndroidWidgetImageView != null)) {
          ((afzs)localObject).jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(null);
        }
      }
      i += 1;
    }
  ...
  protected void a(Context paramContext)
  {
    ...
    {
      int i = afur.a(18.0F, getContext().getResources());
      int j = afur.a(18.0F, getContext().getResources());
