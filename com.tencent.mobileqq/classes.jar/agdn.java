  ...
  extends agdk
{
  ...
  agdm jdField_a_of_type_Agdm;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new agdr(this);
  ...
  public agdn(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new agdo(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131367678)).setOnClickListener(new agdp(this));
    Button localButton = (Button)findViewById(2131363480);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new agdq(this));
  }
  ...
  private void h()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131370443));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131719085));
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_Agdm = new agdm(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Bfmt, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Agdm);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new agds(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new agdt(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new agdu(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Agdm.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Agdm.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
    a(0, null);
  }
  
  public void a(List<Object> paramList)
  {
    this.jdField_a_of_type_Agdm.a(paramList);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131701265));
        ...
        {
          this.jdField_a_of_type_Agdm.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_c_of_type_Boolean, 0);
          this.jdField_a_of_type_Agdm.notifyDataSetChanged();
        }
        if (this.jdField_a_of_type_Agdm.getCount() == 0) {
          a(4, null);
        }
        for (;;)
        {
      ...
      this.jdField_a_of_type_Agdm.a(this.jdField_a_of_type_JavaUtilList, this.jdField_c_of_type_Boolean);
      if ((this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Agdm.getCount() < 20))
      {
        this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131701268));
        this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131371996).setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
      }
    ...
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Agdm.a((List)localObject, this.jdField_c_of_type_Boolean);
    this.jdField_a_of_type_Agdm.notifyDataSetChanged();
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Agdm);
    this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
    this.jdField_a_of_type_JavaUtilList.clear();
