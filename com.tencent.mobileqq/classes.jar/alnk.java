  ...
  implements alnj
{
  ...
  public boolean a(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    if ("AttachEvent".equals(paramString))
    {
      ...
      {
        if (!aloz.a(this.a.jdField_a_of_type_JavaLangString, this.a.jdField_a_of_type_Long, this.a.jdField_a_of_type_ComTencentArkArk$Application, "permission.SENSORS")) {
          return false;
        }
      ...
      {
        this.a.jdField_a_of_type_Alop.a(paramString, l);
        return true;
        if ("Orientation".equals(paramVariantWrapper))
        {
          ...
          paramString = new alnm(this, l);
        }
        else
        {
          if ("Position".equals(paramVariantWrapper))
          {
            if (!aloz.a(this.a.jdField_a_of_type_JavaLangString, this.a.jdField_a_of_type_Long, this.a.jdField_a_of_type_ComTencentArkArk$Application, "permission.POSITION")) {
              return false;
            }
            ...
            if ((!paramVariantWrapper.getBoolean(str, false)) && (alpd.a))
            {
              ...
              alpf.a(paramArrayOfVariantWrapper, paramString);
            }
            for (;;)
            {
              return true;
              if (1 == alpf.a(paramArrayOfVariantWrapper, "ark_authority_api_location", paramString))
              {
              ...
              {
                alnh.a(this.a, l, false, 0.0D, 0.0D);
          ...
          {
            if (!aloz.a(this.a.jdField_a_of_type_JavaLangString, this.a.jdField_a_of_type_Long, this.a.jdField_a_of_type_ComTencentArkArk$Application, "permission.CONNECTION_TYPE")) {
              return false;
            }
            paramString = new alns(this, l);
          }
        }
      }
      return false;
    ...
    if ("DetachEvent".equals(paramString))
    {
      ...
      this.a.jdField_a_of_type_Alop.a(paramArrayOfVariantWrapper[0].GetString());
      return true;
    }
