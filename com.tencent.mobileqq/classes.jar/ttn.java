  ...
  extends ViewBase
{
  ...
  public ttn(VafContext paramVafContext)
  {
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131560051, null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369275));
    this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369362));
    this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369282));
  }
  ...
  private void a(View paramView)
  {
    ...
    if ((localObject1 != null) && (((Activity)localObject1).getWindow() != null))
    {
      ...
      this.d = agej.a(40.0F, ((Activity)localObject1).getResources());
    }
    if ((this.jdField_a_of_type_Ppu != null) && (this.jdField_a_of_type_Ppu.a() != null) && (this.jdField_a_of_type_Ppu.a().a() != null))
    {
      ...
      this.jdField_c_of_type_Int = this.jdField_a_of_type_Ppu.a().a().getTop();
