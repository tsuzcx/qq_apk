  ...
  implements ahav
{
  ...
  public static ahav a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof ahav))) {
      return (ahav)localIInterface;
    }
    return new ahax(paramIBinder);
  }
