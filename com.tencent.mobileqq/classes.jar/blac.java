...
public class blac
{
  private static blac jdField_a_of_type_Blac = new blac();
  private static final String jdField_a_of_type_JavaLangString = blac.class.getSimpleName();
  private Map<String, WeakReference<blae>> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  private Map<String, MetaMaterial> b = new HashMap();
  
  public static blac a()
  {
    return jdField_a_of_type_Blac;
  }
  ...
  private void a(MetaMaterial paramMetaMaterial)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramMetaMaterial.id))
    {
      ...
      if (localObject != null)
      {
        localObject = (blae)((WeakReference)localObject).get();
        if (localObject != null) {
          ((blae)localObject).a(paramMetaMaterial);
        }
      }
    }
  }
  ...
  private void a(MetaMaterial paramMetaMaterial, int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramMetaMaterial.id))
    {
      ...
      if (localObject != null)
      {
        localObject = (blae)((WeakReference)localObject).get();
        if (localObject != null) {
          ((blae)localObject).a(paramMetaMaterial, paramInt);
        }
      }
    }
  }
  ...
  {
    return new File(bkoz.e, paramMetaMaterial.id).getAbsolutePath();
  }
  
  public void a(AppInterface paramAppInterface, MetaMaterial paramMetaMaterial, blae paramblae)
  {
    if ((paramMetaMaterial == null) || (TextUtils.isEmpty(paramMetaMaterial.id)))
    {
      if (paramblae != null) {
        paramblae.b(paramMetaMaterial);
      }
      return;
    }
    this.jdField_a_of_type_JavaUtilMap.put(paramMetaMaterial.id, new WeakReference(paramblae));
  ...
  public boolean a(MetaMaterial paramMetaMaterial)
  {
    ...
    //   14: iconst_0
    //   15: ireturn
    //   16: getstatic 127	bkoz:d	Ljava/lang/String;
    //   19: astore_2
    ...
    //   44: invokestatic 140	bdhb:c	(Ljava/lang/String;)Ljava/lang/String;
    //   47: astore_3
    //   48: aload_3
    ...
    //   73: getstatic 80	bkoz:e	Ljava/lang/String;
    ...
    //   162: getstatic 80	bkoz:e	Ljava/lang/String;
