  ...
  implements com.tencent.mobileqq.app.BusinessObserver, mqq.observer.BusinessObserver
{
  ...
  private void onUpdate_getTroopNickName(int paramInt, boolean paramBoolean, Object paramObject)
  {
    if (paramInt != 3) {}
    do
    {
  ...
  private void onUpdate_notifyGetAllRobot(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    onGetAllRobots(paramBoolean, ((Integer)paramObject[0]).intValue(), ((Long)paramObject[1]).longValue(), (bglq)paramObject[2]);
  }
  ...
  private void onUpdate_notifyGetHomeworkInfo(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if ((paramObject instanceof Object[]))
    {
      ...
      if (paramObject.length > 0) {
        localObject1 = (bfoy)paramObject[0];
      }
    }
    onGetHomeworkInfo(paramBoolean, (bfoy)localObject1);
  }
  ...
  private void onUpdate_notifySetTroopEssenceMsg(int paramInt, boolean paramBoolean, Object paramObject)
  {
    if (paramInt != 159) {
      return;
    }
    if ((paramObject != null) && ((paramObject instanceof Object[])))
    {
      ...
      if (paramObject.length == 3)
      {
        onSetTroopEssenceMsg(paramBoolean, paramObject[0], paramObject[1], ((Integer)paramObject[2]).intValue());
        return;
      }
      onSetTroopEssenceMsg(false, null, null, -1);
      return;
    }
    onSetTroopEssenceMsg(false, null, null, -1);
  }
  ...
  private void onUpdate_notifyTroopEnterEffectPush(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    onPushTroopEnterEffect((bfku)paramObject);
  }
  ...
  private void onUpdate_notifyTroopMemberActiveRankingDesc(int paramInt, boolean paramBoolean, Object paramObject)
  {
    if (paramInt != 153) {}
    do
    {
    ...
    onTroopMemberActiveRankingDesc(paramBoolean, (String)paramObject[0], ((Boolean)paramObject[1]).booleanValue(), (String)paramObject[2]);
  }
  ...
  private void onUpdate_troopLink(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    onTroopShareLink(paramBoolean, (bgtz)paramObject);
  }
  ...
  protected void onGetAllRobots(boolean paramBoolean, int paramInt, long paramLong, bglq parambglq) {}
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    onUpdate_getTroopNickName(paramInt, paramBoolean, paramObject);
    ...
    onUpdate_notifyTroopMemberActiveRankingDesc(paramInt, paramBoolean, paramObject);
    ...
    onUpdate_notifySetTroopEssenceMsg(paramInt, paramBoolean, paramObject);
