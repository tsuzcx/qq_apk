  ...
  extends bfco
{
  ...
  static
  {
    Logger.init(new bfea());
  }
  
  public bfcw(begz parambegz)
  {
    super(parambegz);
    this.jdField_a_of_type_ComTencentTissueV8rtEngineEngine.setLibLoader(new bfde());
    this.jdField_a_of_type_ComTencentTissueV8rtEngineEngine.initEngine(parambegz.a());
    this.jdField_a_of_type_AndroidContentContext = parambegz.a();
  ...
  {
    ServiceEventHandlerProvider.getInstance().setServiceEventHandler(this.jdField_a_of_type_ComTencentTissueV8rtEngineV8JsRuntime, new bfda(this, parambfdd));
  }
    ...
    for (Object localObject = ((File)localObject).getAbsolutePath() + ".cc";; localObject = null)
    {
      ...
      for (int i = 1;; i = 0)
      {
        if (this.jdField_a_of_type_ComTencentTissueV8rtEngineV8JsRuntime != null)
        {
          ...
          this.jdField_a_of_type_ComTencentTissueV8rtEngineV8JsRuntime.getDefaultContext().evaluateJsAsyncWithCodeCache(paramString1, new bfcx(this), paramString2, (String)localObject);
        }
        return;
      ...
      if (i != 0)
      {
        this.jdField_a_of_type_ComTencentTissueV8rtEngineV8JsRuntime.getDefaultContext().evaluateJsAsyncWithCodeCache(paramString1, new bfcy(this, paramValueCallback), paramString2, (String)localObject);
        return;
      }
      this.jdField_a_of_type_ComTencentTissueV8rtEngineV8JsRuntime.getDefaultContext().evaluateJsAsyncWithReturn(paramString1, new bfcz(this, paramValueCallback));
      return;
      label324:
      paramString2 = null;
    }
  ...
  {
    a(a(true));
    MiniAppEnv.g().getBaselibLoader().loadBaselib(MiniAppEnv.g().getContext(), new bfdb(this));
  }
}
