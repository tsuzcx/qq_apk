...
public class bfcw
{
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, List<String> paramList, long paramLong)
  {
    ...
    return;
    Object localObject = amtj.a(2131719198);
    String str2 = amtj.a(2131719196);
    String str1 = amtj.a(2131719197);
    str2 = (String)localObject + " " + str2 + " " + str1;
    paramString1 = new aucf(paramString1, paramString2, str2, 1, -5040, 131086, System.currentTimeMillis() / 1000L);
    ...
    i = BaseApplicationImpl.getApplication().getResources().getColor(2131167306);
