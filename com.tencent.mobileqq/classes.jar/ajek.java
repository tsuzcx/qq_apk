  ...
  implements ajep, Handler.Callback, View.OnClickListener
{
  ...
  public ajek(RelativeLayout paramRelativeLayout, boolean paramBoolean, int paramInt)
  {
  ...
  private void a(double paramDouble, LinearLayout paramLinearLayout)
  {
    ...
    for (int i = 1;; i = 0)
    {
      int j = actn.a(15.0F, this.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources());
      LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(j, j);
      j = 0;
      if (j < n)
      {
        if (j == 0) {}
        for (localLayoutParams.leftMargin = 0;; localLayoutParams.leftMargin = actn.a(3.0F, this.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources()))
        {
  ...
  private boolean a()
  {
    if (this.jdField_a_of_type_Ajeg == null) {}
    while ((this.jdField_a_of_type_Ajeg.jdField_a_of_type_Int != 585) && (this.jdField_a_of_type_Ajeg.jdField_a_of_type_Int != 565)) {
      return false;
    }
    return true;
  }
  ...
  private void j()
  {
    ...
    {
      i = 1;
      m = this.jdField_a_of_type_Ajeq.a();
      i1 = this.jdField_a_of_type_Ajeq.b();
    ...
    for (int k = Math.max(((DisplayMetrics)localObject).widthPixels, ((DisplayMetrics)localObject).heightPixels);; k = Math.min(((DisplayMetrics)localObject).widthPixels, ((DisplayMetrics)localObject).heightPixels))
    {
      ...
      this.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable(URLDrawable.getDrawable(this.jdField_a_of_type_Ajeg.h, (URLDrawable.URLDrawableOptions)localObject));
  ...
  private void k()
  {
    ...
    for (;;)
    {
      localView = this.jdField_a_of_type_Ajeq.a();
      if (localView != null) {
        break;
      }
    ...
    try
    {
      Object localObject = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378936);
      ...
      l();
      localView.setOnClickListener(new ajeo(this));
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  private void l()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject1 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131363341);
        localObject7 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131363342);
        ((RelativeLayout)localObject7).setOnClickListener(this);
        ((RelativeLayout)localObject1).setOnClickListener(this);
        if (this.jdField_a_of_type_Ajeg.jdField_a_of_type_Int == 185)
        {
          ((RelativeLayout)localObject1).setVisibility(8);
          ((RelativeLayout)localObject7).setVisibility(0);
          localObject4 = (ImageView)((RelativeLayout)localObject7).findViewById(2131362031);
          localObject6 = (TextView)((RelativeLayout)localObject7).findViewById(2131362049);
          ...
          localTextView = (TextView)((RelativeLayout)localObject7).findViewById(2131362041);
          localObject1 = (LinearLayout)((RelativeLayout)localObject7).findViewById(2131362043);
          if (localObject4 != null)
          {
            if (TextUtils.isEmpty(this.jdField_a_of_type_Ajeg.f)) {
              break label852;
            }
            ...
            ((URLDrawable.URLDrawableOptions)localObject7).mLoadingDrawable = ((Resources)localObject8).getDrawable(2130844648);
            ((URLDrawable.URLDrawableOptions)localObject7).mFailedDrawable = ((Resources)localObject8).getDrawable(2130844648);
            localObject7 = URLDrawable.getDrawable(this.jdField_a_of_type_Ajeg.f, (URLDrawable.URLDrawableOptions)localObject7);
            ((URLDrawable)localObject7).setTag(bavi.b(vzo.a(BaseApplicationImpl.getContext(), 200.0F), vzo.a(BaseApplicationImpl.getContext(), 200.0F), bawz.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext(), 12.0F)));
            ((URLDrawable)localObject7).setDecodeHandler(bavi.c);
            ((ImageView)localObject4).setImageDrawable((Drawable)localObject7);
          }
          if (localObject6 != null) {
            ((TextView)localObject6).setText(this.jdField_a_of_type_Ajeg.d);
          }
          if (localObject3 != null)
          {
            localObject6 = this.jdField_a_of_type_Ajeg.e;
            ...
            ((TextView)localObject3).setText(ajyc.a(2131702138) + (String)localObject4);
          }
          if (localObject5 != null)
          {
            if ((this.jdField_a_of_type_Ajeg.jdField_b_of_type_Int != 12) && (this.jdField_a_of_type_Ajeg.jdField_b_of_type_Int != 19)) {
              break label862;
            }
            ((Button)localObject5).setText(ajyc.a(2131702136));
            ((Button)localObject5).setOnClickListener(this);
          }
          if (localTextView == null) {
            break;
          }
          this.jdField_a_of_type_Ajeg.jdField_a_of_type_Double /= 2.0D;
          localObject3 = new StringBuilder(500);
          if ((Double.compare(this.jdField_a_of_type_Ajeg.jdField_a_of_type_Double, 0.0D) != 0) && (this.jdField_a_of_type_Ajeg.jdField_a_of_type_Double >= 3.0D)) {
            break label876;
          }
          ...
          if ((0L != this.jdField_a_of_type_Ajeg.jdField_a_of_type_Long) && (this.jdField_a_of_type_Ajeg.jdField_a_of_type_Long >= 100000L)) {
            break label931;
          }
      ...
      Object localObject4 = (ImageView)localThrowable.findViewById(2131362030);
      Object localObject6 = (TextView)localThrowable.findViewById(2131362048);
      Object localObject3 = (TextView)localThrowable.findViewById(2131361970);
      TextView localTextView = (TextView)localThrowable.findViewById(2131362040);
      Object localObject5 = (Button)localThrowable.findViewById(2131362056);
      Object localObject2 = (LinearLayout)localThrowable.findViewById(2131362042);
      continue;
      label646:
      Object localObject7 = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131363341);
      Object localObject8 = (RelativeLayout.LayoutParams)((RelativeLayout)localObject7).getLayoutParams();
      ((RelativeLayout)localObject7).setOnClickListener(this);
      localObject2 = (Button)((RelativeLayout)localObject7).findViewById(2131362059);
      ...
      localObject5 = (Button)((RelativeLayout)localObject7).findViewById(2131362056);
      localObject7 = (LinearLayout)((RelativeLayout)localObject7).findViewById(2131362042);
      if (a())
      {
        ((Button)localObject2).setVisibility(8);
        ((Button)localObject5).setVisibility(0);
        ((RelativeLayout.LayoutParams)localObject8).height = actn.a(157.0F, this.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources());
      ...
      for (;;)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject8).height = actn.a(104.0F, this.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources());
      }
      label852:
      ((ImageView)localObject4).setImageResource(2130838339);
      continue;
      label862:
      ((Button)localObject5).setText(ajyc.a(2131702133));
      continue;
      label876:
      if (localObject2 != null) {
        ((LinearLayout)localObject2).setVisibility(0);
      }
      a(this.jdField_a_of_type_Ajeg.jdField_a_of_type_Double, (LinearLayout)localObject2);
      ((StringBuilder)localObject3).append(new DecimalFormat("0.0").format(this.jdField_a_of_type_Ajeg.jdField_a_of_type_Double)).append("分 ");
      continue;
      label931:
      if (this.jdField_a_of_type_Ajeg.jdField_a_of_type_Long < 1000000L) {
        ((StringBuilder)localObject3).append(this.jdField_a_of_type_Ajeg.jdField_a_of_type_Long);
      }
      for (;;)
      {
        if ((this.jdField_a_of_type_Ajeg.jdField_b_of_type_Int != 12) && (this.jdField_a_of_type_Ajeg.jdField_b_of_type_Int != 19)) {
        ...
        break;
        if (this.jdField_a_of_type_Ajeg.jdField_a_of_type_Long < 100000000L) {
          ((StringBuilder)localObject3).append(new BigDecimal(this.jdField_a_of_type_Ajeg.jdField_a_of_type_Long / 10000.0D).setScale(0, 4)).append("万");
        } else {
          ((StringBuilder)localObject3).append(new BigDecimal(this.jdField_a_of_type_Ajeg.jdField_a_of_type_Long / 100000000.0D).setScale(0, 4)).append("亿");
        }
      }
      label1082:
  ...
  public void a()
  {
    ...
    do
    {
      do
      {
        ...
        try
        {
          ajae.a().callbackFromRequest(this.jdField_a_of_type_Ajeg.jdField_b_of_type_Long, 0, "cs.xy_life_cycle_event_disactivity.local", "{}");
          if (!this.g)
          {
            ...
            this.g = true;
            this.jdField_a_of_type_Ajeq.a(this.jdField_c_of_type_Boolean);
            this.jdField_b_of_type_Int = ((int)((float)this.jdField_a_of_type_Ajeq.a() / 1000.0F));
            return;
          }
        }
      ...
      this.jdField_a_of_type_Ajeq.a();
    } while (this.jdField_a_of_type_Bfnk == null);
    this.jdField_a_of_type_Bfnk.obtainMessage(4).sendToTarget();
  }
  ...
  {
    if ((this.jdField_a_of_type_Ajeg == null) || (this.jdField_a_of_type_Ajeq == null)) {}
    while ((this.jdField_a_of_type_Boolean) && (!paramBoolean)) {
      return;
    }
    VipUtils.a(null, "cmshow", "Apollo", "video_SPA", this.jdField_a_of_type_Ajeg.jdField_c_of_type_Int, paramInt1, new String[] { Integer.toString(this.jdField_c_of_type_Int), Long.toString(this.jdField_b_of_type_Int), Integer.toString(paramInt2), Integer.toString(this.jdField_a_of_type_Ajeg.jdField_a_of_type_Int) });
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    for (;;)
    {
      ...
      if (paramLong1 == paramLong2)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131702132) + l);
      ...
      for (;;)
      {
        ...
        ajae.a().callbackFromRequest(this.jdField_a_of_type_Ajeg.jdField_b_of_type_Long, 0, "sc.game_ad_video_end.local", "{}");
        return;
        ...
        continue;
        label233:
        this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131702139) + paramLong1);
        this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
      }
    }
  }
  ...
  public void a(ajeg paramajeg)
  {
    ...
    this.jdField_a_of_type_Bfnk.obtainMessage(0).sendToTarget();
  }
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      GdtHandler.a(a((qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(yxr.a(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(paramString)))));
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131364264));
          this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131362135));
          this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131362847));
          ...
          this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131362038));
          this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378999));
          this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
          this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
          this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new ajel(this));
          return;
        }
      }
      catch (Throwable localThrowable)
  ...
  public void b()
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      a(8, this.jdField_a_of_type_Ajeq.a());
      a(1, 100, false);
    }
    if (!this.jdField_d_of_type_Boolean) {
      ajae.a().callbackFromRequest(this.jdField_a_of_type_Ajeg.jdField_b_of_type_Long, 0, "sc.game_ad_video_end.local", "{}");
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_AndroidWidgetRelativeLayout == null) || (this.jdField_a_of_type_Ajeq == null) || (this.jdField_a_of_type_Ajeg == null)) {}
    RelativeLayout localRelativeLayout;
    View localView;
    do
    {
      return;
      localRelativeLayout = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378936);
      localView = this.jdField_a_of_type_Ajeq.a();
    } while (localView == null);
    if (paramBoolean) {}
    try
    {
      ajae.a().callbackFromRequest(this.jdField_a_of_type_Ajeg.jdField_b_of_type_Long, 0, "sc.game_ad_video_view_close.local", "{}");
      label100:
      ...
      try
      {
        ajae.a().callbackFromRequest(this.jdField_a_of_type_Ajeg.jdField_b_of_type_Long, 0, "cs.xy_life_cycle_event_activity.local", "{}");
        return;
      }
      catch (Exception localException)
      {
  ...
  public void e()
  {
    ...
    this.jdField_a_of_type_Ajeq.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext(), ajae.a());
  ...
  public void f()
  {
    if (this.jdField_a_of_type_Ajeq != null)
    {
      if (this.jdField_a_of_type_Ajeq.c() != 5) {
        this.jdField_a_of_type_Ajeq.b();
      }
      if (this.jdField_a_of_type_Bfnk != null) {
        this.jdField_a_of_type_Bfnk.obtainMessage(3).sendToTarget();
      }
    }
  }
  ...
  public void g()
  {
    if ((this.jdField_a_of_type_Ajeq != null) && (!this.f) && (this.jdField_a_of_type_Bfnk != null) && (this.jdField_a_of_type_Ajeq.c() != 5)) {
      this.jdField_a_of_type_Ajeq.a();
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 1: 
      do
      {
        ...
        {
          return false;
        } while (this.jdField_a_of_type_Ajeg == null);
        b(false);
        m();
        e();
        k();
        if (this.jdField_a_of_type_Ajeq != null) {
          this.jdField_a_of_type_Ajeq.a(this.jdField_a_of_type_Ajeg.j, "sd", 0);
        }
        ajae.a().callbackFromRequest(this.jdField_a_of_type_Ajeg.jdField_b_of_type_Long, 0, "sc.game_ad_video_start.local", "{}");
        return false;
      } while ((this.jdField_a_of_type_Ajeq == null) || (this.jdField_a_of_type_Ajeq.a() == null));
      j();
      return false;
    case 2: 
      this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      ...
      for (;;)
      {
        try
        {
          ...
          if (this.jdField_b_of_type_Int > 15)
          {
            ...
            bbcv.a(localContext, 0, null, paramView, ajyc.a(2131702135), ajyc.a(2131702134), new ajem(this), new ajen(this)).show();
            return;
          }
        }
