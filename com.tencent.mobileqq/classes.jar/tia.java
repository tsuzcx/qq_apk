  ...
  implements bjoi
{
  ...
  public tia(BridgeModule paramBridgeModule)
  {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          if (((JSONArray)localObject2).length() > 0)
          {
            ...
            ((bjnw)localObject1).c(((JSONArray)localObject2).getString(j));
            j += 1;
            continue;
          }
        }
        ...
        if (!TextUtils.isEmpty(paramJSONObject)) {
          ((bjnw)localObject1).d(paramJSONObject);
        }
        ((bjnw)localObject1).a(new tib(this, paramString));
        ((bjnw)localObject1).a(new tic(this, paramString));
        ((bjnw)localObject1).setOnCancelListener(new tid(this, paramString));
