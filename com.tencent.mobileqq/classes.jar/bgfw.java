  ...
  implements Closeable
{
  ...
  public bgfw(String paramString, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
  ...
  private boolean a(RandomAccessFile paramRandomAccessFile, int paramInt, bgfx parambgfx)
  {
    byte[] arrayOfByte = this.jdField_b_of_type_ArrayOfByte;
    ...
    try
    {
      ...
      l2 = a(arrayOfByte, 0);
      long l3 = parambgfx.jdField_a_of_type_Long;
      if (l2 != l3) {
        return false;
      }
      k = a(arrayOfByte, 8);
      ...
      if ((parambgfx.jdField_a_of_type_ArrayOfByte == null) || (parambgfx.jdField_a_of_type_ArrayOfByte.length < m)) {
        parambgfx.jdField_a_of_type_ArrayOfByte = new byte[m];
      }
      arrayOfByte = parambgfx.jdField_a_of_type_ArrayOfByte;
      parambgfx.jdField_a_of_type_Int = m;
    ...
    {
      QLog.e("BlobCache", 2, "getBlob failed.", parambgfx);
      return false;
    }
    finally
    {
  ...
  public boolean a(bgfx parambgfx)
  {
    if ((a(parambgfx.jdField_a_of_type_Long, this.g)) && (a(this.jdField_d_of_type_JavaIoRandomAccessFile, this.j, parambgfx))) {}
    int k;
    do
    {
      return true;
      k = this.i;
      if ((!a(parambgfx.jdField_a_of_type_Long, this.h)) || (!a(this.jdField_e_of_type_JavaIoRandomAccessFile, this.j, parambgfx))) {
        break;
      }
    } while ((this.jdField_e_of_type_Int + 20 + parambgfx.jdField_a_of_type_Int > this.jdField_b_of_type_Int) || (this.jdField_d_of_type_Int * 2 >= this.jdField_a_of_type_Int));
    this.i = k;
    try
    {
      a(parambgfx.jdField_a_of_type_Long, parambgfx.jdField_a_of_type_ArrayOfByte, parambgfx.jdField_a_of_type_Int);
      this.jdField_d_of_type_Int += 1;
      a(this.jdField_a_of_type_ArrayOfByte, 16, this.jdField_d_of_type_Int);
      f();
      return true;
