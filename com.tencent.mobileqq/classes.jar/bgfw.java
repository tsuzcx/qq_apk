...
public class bgfw
  extends QIPCModule
{
  private static bgfw a;
  
  private bgfw(String paramString)
  {
    super(paramString);
  }
  
  /* Error */
  public static bgfw a()
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 14	bgfw:a	Lbgfw;
    //   6: ifnonnull +27 -> 33
    //   9: ldc 2
    //   11: monitorenter
    //   12: getstatic 14	bgfw:a	Lbgfw;
    //   15: ifnonnull +15 -> 30
    //   18: new 2	bgfw
    //   21: dup
    //   22: ldc 16
    //   24: invokespecial 17	bgfw:<init>	(Ljava/lang/String;)V
    //   27: putstatic 14	bgfw:a	Lbgfw;
    //   30: ldc 2
    //   32: monitorexit
    //   33: getstatic 14	bgfw:a	Lbgfw;
    //   36: astore_0
    //   37: ldc 2
    //   39: monitorexit
    //   40: aload_0
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          ((aneg)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(27)).notifyUI(5, true, paramBundle);
