...
public class qia
{
  public static String a(ArticleInfo paramArticleInfo, HashMap<String, String> paramHashMap)
  {
    ...
    JSONObject localJSONObject = ozs.a(paramArticleInfo.mAlgorithmID, ozs.a(paramArticleInfo), (int)paramArticleInfo.mChannelID, bhnv.h(null), str1, paramArticleInfo.innerUniqueID, ozs.f(paramArticleInfo), 0, ozs.d(), paramArticleInfo);
    ...
    for (;;)
    {
      ...
      if ((paramHashMap != null) && (paramHashMap.size() > 0))
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          if (!qho.a.a().contains(localObject3))
          {
            try
            {
  ...
  public static void a(sbg paramsbg, BaseArticleInfo paramBaseArticleInfo)
  {
    if ((!(paramBaseArticleInfo instanceof ArticleInfo)) || (paramsbg == null)) {}
    for (;;)
    {
      return;
      if (!qgg.a(paramBaseArticleInfo)) {
        continue;
      }
      try
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if ((!TextUtils.isEmpty(str1)) && (!TextUtils.isEmpty(str2))) {
            paramsbg.a(str1, str2);
          }
        }
        return;
      }
      catch (JSONException paramsbg)
      {
        QLog.e("PTSRijReport", 1, "[addPtsCardReportToR5], e = " + paramsbg);
      }
    }
  }
}
