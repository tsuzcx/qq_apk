...
public class qjm
  extends ViewBase
{
  ViewTreeObserver.OnGlobalLayoutListener jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new qjn(this);
  ...
  public qjm(VafContext paramVafContext)
  {
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Pka != null) {
      this.jdField_a_of_type_Pka.resumeAnimation();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Pka != null) {
      this.jdField_a_of_type_Pka.pauseAnimation();
    }
  }
  ...
  public boolean setAttribute(int paramInt, String paramString)
  {
    ...
    try
    {
      this.jdField_a_of_type_Pka = pka.a(paramString);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(this.jdField_a_of_type_Pka);
      return true;
    }
