...
public class qjm
{
  ...
  private ArrayList<qjn> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private Timer jdField_a_of_type_JavaUtilTimer;
  private qjo jdField_a_of_type_Qjo;
  private qjq jdField_a_of_type_Qjq;
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Qjq = new qjq(this, null);
    ...
    this.d = true;
    BaseApplicationImpl.getApplication().getBaseContext().registerReceiver(this.jdField_a_of_type_Qjq, paramString);
    paramString = (TelephonyManager)BaseApplicationImpl.getApplication().getBaseContext().getSystemService("phone");
    this.jdField_a_of_type_Qjo = new qjo(this);
    paramString.listen(this.jdField_a_of_type_Qjo, 32);
  }
  
  public void a(qjn paramqjn)
  {
    this.jdField_a_of_type_JavaUtilArrayList.add(paramqjn);
  }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    //   2: aload_0
    //   3: iload_1
    //   4: putfield 72	qjm:c	Z
    //   7: aload_0
    //   8: getfield 47	qjm:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   11: ifnull +80 -> 91
    //   14: aload_0
    //   15: getfield 54	qjm:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   18: ifnull +73 -> 91
    ...
    //   61: aload_0
    //   62: getfield 47	qjm:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   65: aload_0
    //   66: getfield 54	qjm:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   69: invokevirtual 231	android/os/Handler:removeCallbacks	(Ljava/lang/Runnable;)V
    //   72: aload_0
    //   73: getfield 72	qjm:c	Z
    //   76: ifeq +18 -> 94
    //   79: aload_0
    //   80: getfield 47	qjm:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   83: aload_0
    //   84: getfield 54	qjm:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    ...
    //   93: return
    //   94: aload_0
    //   95: getfield 47	qjm:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   98: aload_0
    //   99: getfield 54	qjm:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   102: ldc2_w 236
  ...
  public void b(String paramString)
  {
    if (this.jdField_a_of_type_JavaLangString.equals(paramString))
    {
      ...
      if (!"".equals(this.jdField_a_of_type_JavaLangString))
      {
        BaseApplicationImpl.getApplication().getBaseContext().unregisterReceiver(this.jdField_a_of_type_Qjq);
        ((TelephonyManager)BaseApplicationImpl.getApplication().getBaseContext().getSystemService("phone")).listen(this.jdField_a_of_type_Qjo, 0);
      }
      this.jdField_a_of_type_Qjo = null;
  ...
  {
    this.jdField_a_of_type_JavaUtilArrayList.remove(paramqjn);
  }
}
