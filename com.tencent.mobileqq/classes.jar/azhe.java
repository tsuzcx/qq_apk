...
public class azhe
{
  ...
  private static azhe jdField_a_of_type_Azhe;
  ...
  {
    int j = 0;
    if (!azhe.class.desiredAssertionStatus()) {}
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          Object localObject = aobe.b(BaseApplicationImpl.getContext());
  ...
  public static azhe a()
  {
    if (jdField_a_of_type_Azhe == null) {}
    try
    {
      if (jdField_a_of_type_Azhe == null) {
        jdField_a_of_type_Azhe = new azhe();
      }
      return jdField_a_of_type_Azhe;
    }
    finally {}
  }
