  ...
  implements ukd
{
  ...
  public static int a(Context paramContext)
  {
    ...
    uqf.b("wifiInfo", paramContext.toString());
    uqf.b("SSID", "" + paramContext.getIpAddress());
  ...
  public static stReportItem a()
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject))
    {
      ...
      localstReportItem.qua = bmsw.a();
      localstReportItem.vendor = bhlo.h();
      localObject = new stDevice();
      ((stDevice)localObject).encrypted_deviceid = ugd.a().e();
  ...
  public static stReportItem a(stSimpleMetaFeed paramstSimpleMetaFeed, int paramInt)
  {
    ...
    {
      uqf.d("weishi-report", "convertFeedToReport feed == null");
      return localstReportItem;
    }
  ...
  private static String a()
  {
    ...
    if ((c.endsWith(anzj.a(2131714754))) && (c.length() > 1)) {
  ...
  private static String a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      default: 
        return str;
        str = anzj.a(2131714750);
        continue;
        str = anzj.a(2131714727);
        continue;
        str = anzj.a(2131714737);
        continue;
        str = anzj.a(2131714744);
        continue;
        str = anzj.a(2131714734);
        continue;
        str = anzj.a(2131714738);
        continue;
        str = anzj.a(2131714753);
        continue;
        str = anzj.a(2131714721);
        continue;
        str = anzj.a(2131714724);
        continue;
        str = anzj.a(2131714729);
        continue;
        str = anzj.a(2131714751);
        continue;
        str = anzj.a(2131714746);
        continue;
        str = anzj.a(2131714740);
        switch (paramInt2)
        {
        default: 
          break;
        case 12: 
          str = anzj.a(2131714716);
          continue;
          str = anzj.a(2131714748);
          continue;
          str = anzj.a(2131714755);
          continue;
          str = anzj.a(2131714728);
          continue;
          str = anzj.a(2131714749);
          continue;
          str = anzj.a(2131714723);
          continue;
          str = anzj.a(2131714719);
          continue;
          str = anzj.a(2131714739);
          continue;
          str = anzj.a(2131714717);
          continue;
          str = anzj.a(2131714743);
          switch (paramInt2)
          {
          default: 
            break;
          case 12: 
            str = anzj.a(2131714731);
            continue;
            str = anzj.a(2131714725);
            switch (paramInt2)
            {
            default: 
              break;
            case 12: 
              str = anzj.a(2131714733);
              continue;
              str = anzj.a(2131714720);
              continue;
              str = anzj.a(2131714730);
              continue;
              str = anzj.a(2131714735);
              switch (paramInt2)
              {
              default: 
                break;
              case 2: 
                str = anzj.a(2131714752);
                break;
              case 6: 
                str = anzj.a(2131714741);
                continue;
                str = anzj.a(2131714742);
                switch (paramInt2)
                {
                default: 
                  break;
                case 2: 
                  str = anzj.a(2131714745);
                  break;
                case 14: 
                  str = anzj.a(2131714722);
                  break;
                case 12: 
                  str = anzj.a(2131714718);
                  break;
                case 6: 
                  str = anzj.a(2131714726);
                  continue;
                  str = anzj.a(2131714732);
                  switch (paramInt2)
                  {
                  case 10: 
                  case 11: 
  ...
  public static String a(Context paramContext)
  {
    ...
    try
    {
      jdField_a_of_type_JavaLangString = blhc.a("1d76c6");
    ...
    catch (Throwable paramContext)
    {
      for (;;)
      {
        uqf.d("weishi-810", "telephonyManager.getDeviceId encounter error:" + paramContext);
      }
    }
  }
  ...
  public static void a(stReportItem paramstReportItem)
  {
    if (paramstReportItem == null)
    {
      uqf.d("weishi-report", "report error item = null");
      return;
    }
  ...
  public static void a(ArrayList<stReportItem> paramArrayList)
  {
    ...
    {
      uqf.d("weishi-report", "report error items: " + paramArrayList);
      return;
    }
    ...
    while (localIterator.hasNext())
    {
      ...
      uqf.b("weishi-report", "report " + str + " stReportItem:" + localstReportItem.toString());
    }
    paramArrayList = new uko(new upa(paramArrayList), null, new unp(str), 2001);
    ukh.a().a(paramArrayList);
  }
  ...
  public static String b(Context paramContext)
  {
    ...
    try
    {
      uqf.b("weishi-810", "try get QIMei from UserAction.getQIMEI!");
      b = UserAction.getQIMEI();
      if (b == null)
      {
        uqf.d("weishi-810", "getImei finally encounter error and return empty");
        b = "";
      }
      return b;
    }
    catch (Throwable paramContext)
    {
      for (;;)
      {
        uqf.d("weishi-810", "UserAction.getQIMEI encounter error:" + paramContext);
      }
    }
  }
