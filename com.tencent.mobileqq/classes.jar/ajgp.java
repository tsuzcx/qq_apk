...
public class ajgp
  implements ajgf
{
  public ajgp(AddContactViewPagerTroopFragment paramAddContactViewPagerTroopFragment) {}
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      ...
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText(2131689622);
      this.a.jdField_b_of_type_AndroidWidgetTextView.setText(2131689626);
      this.a.c.setText(2131689623);
      this.a.c.setOnTouchListener(this.a.jdField_a_of_type_AndroidViewView$OnTouchListener);
      this.a.c.setOnClickListener(new ajgq(this));
