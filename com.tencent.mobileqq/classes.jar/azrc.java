...
public class azrc
{
  ...
  private Map<Integer, azrd> e = new ConcurrentHashMap();
  ...
  public azrc(AppInterface paramAppInterface)
  {
  ...
  {
    return bhaa.c(paramContext) + paramLong + ".zip";
  }
  ...
  public azrd a(int paramInt, boolean paramBoolean)
  {
    try
    {
      azrd localazrd = (azrd)this.e.get(Integer.valueOf(paramInt));
      if (localazrd == null)
      {
        localazrd = new azrd(this, paramInt);
        this.e.put(Integer.valueOf(paramInt), localazrd);
      }
      for (;;)
      {
        Object localObject2;
        ...
        for (;;)
        {
          ...
          {
            localObject2 = (VasQuickUpdateManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.VAS_QUICKUPDATE_MANAGER);
  ...
  {
    ((VasQuickUpdateManager)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.VAS_QUICKUPDATE_MANAGER)).cancelDwonloadItem(15L, "card." + paramLong);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    ((VasQuickUpdateManager)paramQQAppInterface.getManager(QQManagerFactory.VAS_QUICKUPDATE_MANAGER)).downloadItem(15L, paramString, "ProfileCardRes");
  }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramString2.exists())
          {
            ...
            FileUtils.uncompressZip(paramString2.getAbsolutePath(), str, false);
