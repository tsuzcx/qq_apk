  ...
  implements baaw
{
  ...
  public baau(JSONObject paramJSONObject)
  {
  ...
  public static JSONObject a(baau parambaau)
  {
    JSONObject localJSONObject = new JSONObject().put("type", "recite").put("troop_uin", parambaau.jdField_f_of_type_JavaLangString).put("subtype", 1).put("title", parambaau.jdField_b_of_type_JavaLangString).put("desc", parambaau.c).put("kid", parambaau.jdField_a_of_type_JavaLangString).put("error_count", parambaau.jdField_d_of_type_Int).put("remind_count", parambaau.jdField_e_of_type_Int).put("waste_time", parambaau.jdField_a_of_type_Long).put("grade", parambaau.jdField_f_of_type_Int).put("lyric", parambaau.jdField_g_of_type_JavaLangString);
    if (!TextUtils.isEmpty(parambaau.jdField_e_of_type_JavaLangString)) {
      localJSONObject.put("file_url", parambaau.jdField_e_of_type_JavaLangString);
    }
    if (!TextUtils.isEmpty(parambaau.jdField_d_of_type_JavaLangString)) {
      localJSONObject.put("file_path", parambaau.jdField_d_of_type_JavaLangString);
    }
    if (parambaau.jdField_a_of_type_JavaUtilList != null) {
      localJSONObject.put("pid_list", new JSONArray(parambaau.jdField_a_of_type_JavaUtilList));
    }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder(ajyc.a(2131705684)).append(paramString2);
    if ((paramList != null) && (!paramList.isEmpty())) {
      localStringBuilder.append(azzy.a(paramList));
    }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder(ajyc.a(2131705686)).append(paramString2);
