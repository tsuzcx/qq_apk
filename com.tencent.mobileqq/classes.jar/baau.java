...
public final class baau
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = ajed.aU + "avatarPendantIcons";
  ...
  public static String a(File paramFile)
  {
    ...
    try
    {
      paramFile = new String(bace.a(paramFile));
  ...
  {
    return ajed.bH + "font_info/" + paramString + File.separator + paramString + ".ttf";
  }
  
  public static void a()
  {
    File localFile = new File(ajed.aU + "avatarPendantDefaultHead");
    if (!localFile.exists()) {
      localFile.mkdir();
    }
    localFile = new File(ajed.bH);
    if (!localFile.exists()) {
      localFile.mkdir();
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, aqeb paramaqeb)
  {
    if ((paramContext == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      paramQQAppInterface.a(-1, new baav(paramaqeb));
      return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, boolean paramBoolean, ProfileActivity.AllInOne paramAllInOne)
  {
    ...
    if (paramAllInOne != null)
    {
      ...
      if ((i == 1) || (i == 0))
      {
        ...
        localauqh = (auqh)paramQQAppInterface.getManager(36);
        localauqh.b("100005.100006");
        ...
        i2 = 1;
        label202:
        if (!((fv)paramQQAppInterface.getManager(42)).jdField_a_of_type_Boolean) {
          break label495;
        }
    ...
    for (;;)
    {
      ...
      if (paramAllInOne == null)
      {
        ...
        localIntent.putExtra("url", bant.a(paramContext, "pendant", ""));
      ...
      for (i = 40202;; i = 40201)
      {
        ...
        awqx.b(paramQQAppInterface, "CliOper", "", "", "PendantMarket", "OtherEntrance", 0, 0, "", "", "", "");
        return;
  ...
  {
    ((baot)paramQQAppInterface.a(71)).a(new String[] { paramString }, new int[] { 27235 });
  }
  ...
  public static String b(long paramLong, int paramInt)
  {
    ...
    localStringBuilder.append(ajed.bH).append(paramLong).append(File.separator);
    switch (paramInt)
    {
    }
    for (;;)
  ...
  {
    return ajed.bH + "font_info/" + paramString + "/";
  }
  ...
  public static boolean b(String paramString)
  {
    ...
    return new File(ajed.bH + "sticker_info", paramString).exists();
  }
  ...
  public static String c(long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      return anam.a("VIP_avatar", localStringBuilder.toString());
      localStringBuilder.append("aio_50.png");
      continue;
      localStringBuilder.append("aio_file.zip");
      continue;
  ...
  {
    return ajed.bH + "sticker_info/" + paramString + ".png";
  }
}
