  ...
  implements ryb
{
  ...
  private void a(Context paramContext, int paramInt1, String paramString, stSimpleMetaFeed paramstSimpleMetaFeed, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        int i = a();
        sai.d("WSGridCardPresenter", "open weishi scheme = " + paramString + ", weishi_jump_url = " + paramstSimpleMetaFeed.weishi_jump_url);
        sak.a(paramContext.getApplicationContext(), "biz_src_jc_gzh_weishi", paramString, 1, i, paramInt2);
        if (i == 2) {
          rzu.a(paramstSimpleMetaFeed, paramInt1, 1000);
        }
        rzu.a(1, 114, paramInt1, paramstSimpleMetaFeed, null);
        return;
      }
      catch (Exception paramContext)
      {
        paramContext.printStackTrace();
        sai.d("WSGridCardPresenter", "open weishi error scheme = " + paramString);
        return;
      }
  ...
  private void a(Context paramContext, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    rxu.a((Activity)paramContext, localWSDownloadParams, false);
  }
  ...
  private void b(Context paramContext, int paramInt, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    for (;;)
    {
      rzu.a(paramstSimpleMetaFeed, paramInt, 1001);
      return;
      if (rxf.a().a()) {
        c(paramContext, paramInt, paramstSimpleMetaFeed);
      } else {
        sai.a("WSGridCardPresenter", "B test do not download when 4g is not open is server");
      }
    }
  }
  ...
  private void c(Context paramContext, int paramInt, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    if (i < 10000)
    {
      ...
      paramContext = ((rwm)localObject).a();
      label97:
      if (localObject == null) {
        break label158;
      }
    ...
    label153:
    label158:
    for (Object localObject = ((rwm)localObject).a();; localObject = null)
    {
      rxu.a(localActivity, localWSDownloadParams, paramContext, (RockDownloadListenerWrapper)localObject);
      rzu.a(1, 115, paramInt, paramstSimpleMetaFeed, rxu.a(localWSDownloadParams.mScene, localWSDownloadParams.mLinkStrategyType, localWSDownloadParams.mEventId));
      return;
      i = 100;
      break;
      paramContext = null;
  ...
  private void d(Context paramContext, int paramInt, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    if (paramstSimpleMetaFeed.video != null)
    {
      ...
      {
        obz.e(paramContext, localstH5OpInfo.h5Url);
        rzw.a(140, localstH5OpInfo.type, paramInt, paramstSimpleMetaFeed.h5_op_info.id);
        rzu.a(140, 9, null);
  ...
  public void a(Context paramContext, int paramInt, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    {
      rzu.a(str2, str3, str1, paramstSimpleMetaFeed.feed_desc, paramInt, 112, 1, 0);
      rzw.a(true);
      if ((paramContext instanceof BaseActivity))
      {
        paramContext = bade.a(((BaseActivity)paramContext).app, paramContext, paramstSimpleMetaFeed.video_url + "&click_index=" + (paramInt + 1));
        if (paramContext != null) {
          paramContext.c();
        }
        aqpb.jdField_a_of_type_JavaLangString = paramstSimpleMetaFeed.id;
        aqpb.b = paramstSimpleMetaFeed.feed_desc;
        aqpb.jdField_a_of_type_Int = paramInt;
      }
      return;
    }
  }
  ...
  public void a(Context paramContext, int paramInt, ArrayList<stSimpleMetaFeed> paramArrayList, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    {
      sam.a(paramContext, paramArrayList, 0, str, rxf.a().a(), this.a.a().a(), 2);
      if ((paramInt != 0) || (paramstSimpleMetaFeed.video_type != 7)) {
        break;
      }
      rzw.a(141, paramstSimpleMetaFeed.id);
      return;
    }
    rzw.a(112, Integer.valueOf(2));
  }
  ...
  public void a(Context paramContext, stSimpleMetaFeed paramstSimpleMetaFeed, int paramInt)
  {
    ...
    {
      rzw.a(112, paramstSimpleMetaFeed.h5_op_info.type, paramInt, paramstSimpleMetaFeed.h5_op_info.id);
    ...
    {
      rzu.a(i, (Map)localObject2, str1, j, str2, str3, str4, paramInt, "", (String)localObject1, paramstSimpleMetaFeed.h5_op_info.id);
      ...
      sam.a(paramContext, (String)localObject1, str1, paramstSimpleMetaFeed.h5_op_info.type, new ryf(this, paramContext, paramInt, paramstSimpleMetaFeed));
      return;
    }
  }
    ...
    while (i != 0)
    {
      ...
      else
      {
        ...
        if ((localstWaterFallItemStrategy != null) && (localstWaterFallItemStrategy.isCallWeishi))
        {
          ...
          i = rxf.a().b();
          j = rxf.a().c();
          if (!vnd.a(BaseApplicationImpl.getApplication())) {
            break label322;
          }
          bool2 = rxf.a().b();
          sai.d("WSGridCardPresenter", "openCallWeishi = " + bool1 + ", isOpenVideoPage = " + bool2 + ", callCount = " + i + ", openCallWSCount = " + localrwm.jdField_a_of_type_Int);
          rzw.a(112, Integer.valueOf(114));
          WSPublicAccReport.getInstance().feedsItemReport("gzh_click", sam.a(1), paramstSimpleMetaFeed, rzu.a(paramstSimpleMetaFeed, paramInt), 1000003);
          if ((!bool1) || (localrwm.jdField_a_of_type_Int >= i)) {
            break;
          }
          localrwm.jdField_a_of_type_Int += 1;
          if (i >= 10000) {
            break label307;
          }
          i = 104;
        ...
        for (i = 143;; i = 142)
        {
          rzu.a(paramstSimpleMetaFeed, paramInt, i);
          return true;
          bool1 = false;
          break;
          bool2 = false;
        ...
        label322:
        sai.d("WSGridCardPresenter", "openDownloadWeishi = " + bool2 + ", downloadCount = " + j + ", openDownloadWSCount = " + rwm.b);
        rzw.a(112, Integer.valueOf(115));
        WSPublicAccReport.getInstance().feedsItemReport("gzh_click", sam.a(1), paramstSimpleMetaFeed, rzu.a(paramstSimpleMetaFeed, paramInt), 1000002);
        if ((bool2) && (rwm.b < j))
        {
          a(paramContext, paramInt, paramArrayList, paramstSimpleMetaFeed);
