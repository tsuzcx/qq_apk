...
public class arzz
  extends arum
{
  private URLDrawableDownListener.Adapter jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new asaa(this);
  AbsShareMsg jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg;
  String h = "";
  boolean i = false;
  
  public arzz(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  private void a(boolean paramBoolean, String paramString, long paramLong)
  {
    ...
    {
      if (str2.startsWith(alpo.a(2131705213))) {
    ...
    for (;;)
    {
      ...
      adky.a(this.jdField_a_of_type_AndroidAppActivity, localIntent, MiniChatActivity.class, MiniMultiForwardFragment.class);
      return;
      str1 = str2;
      if (!str2.startsWith(alpo.a(2131705184))) {
        break;
      }
  ...
  private boolean a(AbsShareMsg paramAbsShareMsg)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = (azqj)paramAbsShareMsg.get(j);
        ...
        azqj localazqj = (azqj)((List)localObject).get(k);
        if ((!(localazqj instanceof azvm)) || (((azvm)localazqj).a())) {
          break label132;
        }
        bool1 = true;
      }
      ...
      do
      {
        do
        {
          ...
          paramAbsShareMsg = (aztc)localObject;
          bool1 = bool2;
  ...
  private View b()
  {
    ...
    for (;;)
    {
      ...
      if (j != 0)
      {
        ...
        ((ImageView)localObject).setImageResource(2130839708);
        ...
        ((View)localObject).setBackgroundResource(2130839718);
        localFrameLayout.addView((View)localObject, new FrameLayout.LayoutParams(-1, bdkf.a(33.0F), 16));
        ((View)localObject).setOnClickListener(new asab(this));
        ((View)localObject).setContentDescription(alpo.a(2131705185));
      }
  ...
  private void b(bdfq parambdfq)
  {
    ...
    {
      localObject3 = URLDrawable.getDrawable((String)localObject3, -1, aekt.a(165.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), localDrawable, localDrawable, true);
  ...
  private View c()
  {
    Object localObject1 = alpo.a(2131705202);
    ...
    if (k == 1) {
      localObject1 = alpo.a(2131705201) + (String)localObject2;
    }
    int j;
    if ((k == 0) || (k == -1))
    {
      localObject1 = (azqj)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mStructMsgItemLists.get(0);
      if ((localObject1 instanceof azqk))
      {
        localObject1 = (azqj)((azqk)localObject1).a.get(0);
        if ((localObject1 instanceof StructMsgItemTitle))
        {
          localObject1 = ((StructMsgItemTitle)localObject1).Y;
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.hasTSum()) && (((String)localObject1).endsWith(alpo.a(2131705182))))
          {
            j = 1;
            if (j == 0) {
              break label565;
            ...
            label183:
            localObject2 = alpo.a(2131705171) + (String)localObject1;
          }
        }
      }
    }
    for (;;)
    {
      ...
      ((EllipsizingTextView)localObject4).setText(new baig((CharSequence)localObject2, 3, 16));
      ((EllipsizingTextView)localObject4).setMaxLines(2);
      ((EllipsizingTextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      ((EllipsizingTextView)localObject4).setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131165620));
      ...
      localObject4 = new LinearLayout.LayoutParams(bdkf.a(8.0F), bdkf.a(14.0F));
      ((LinearLayout.LayoutParams)localObject4).gravity = 17;
      ((LinearLayout.LayoutParams)localObject4).setMargins(bdkf.a(3.0F), 0, 0, 0);
      ...
      if (k == 1)
      {
        bool = true;
        label450:
        ((View)localObject2).setOnClickListener(new asac(this, bool, (String)localObject1, l));
      ...
      while ((k != 0) && (k != -1))
      {
        ...
        j = 0;
        break;
        localObject1 = alpo.a(2131705179);
        break label183;
        bool = false;
        break label450;
      }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg != null)
    {
      ...
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForAudioShare)) {
          ...
          localLayoutParams.setMargins(aekt.a(-10.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, aekt.a(-7.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0);
        }
      }
  ...
  {
    super.b();
    this.jdField_a_of_type_Bdfq.adjustMessageBottomMargin(17.0F);
    this.jdField_a_of_type_Bdfq.setMessageTextColor(2131165649);
    this.jdField_a_of_type_Bdfq.setMessageTextSize(14.0F);
    ...
    {
      ViewGroup.LayoutParams localLayoutParams = ((LinearLayout)this.jdField_a_of_type_Bdfq.findViewById(2131363352)).getLayoutParams();
  ...
  protected boolean c()
  {
    ...
    if (f())
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
      {
        ...
        {
          localObject2 = aekt.a(new Intent(this.jdField_a_of_type_AndroidAppActivity, ChatActivity.class), null);
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
      {
        ...
        if (!this.jdField_a_of_type_AndroidOsBundle.getBoolean("k_back", true))
        {
          localObject1 = aekt.a(new Intent(this.jdField_a_of_type_AndroidAppActivity, ChatActivity.class), null);
  ...
  protected int d()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
    {
      localObject1 = birl.a((StructMsgForImageShare)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg);
      if ((localObject1 == null) || (!biqt.b(((azsp)localObject1).S).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null))) {}
    }
    else
    {
      for (j = 0;; j = 0)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID != 32) || (TextUtils.isEmpty((CharSequence)localObject1)) || (TextUtils.isEmpty(localObject2)) || (TextUtils.isEmpty(localObject3)) || (!biqt.a(Float.valueOf((String)localObject1).floatValue(), Float.valueOf(localObject2).floatValue(), localObject4, localObject3, null).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null))) {
          break label540;
        }
      }
      localObject1 = birl.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.getXmlBytes());
      if (!(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForAudioShare)) {
        break label545;
      }
    }
  ...
  protected void d()
  {
    ...
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800567B", "0X800567B", 0, 0, j + "", "", "", "");
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForGeneralShare))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = ((azua)localObject2).a.iterator();
          while (((Iterator)localObject2).hasNext())
          {
            Object localObject3 = (azqj)((Iterator)localObject2).next();
            if ((localObject3 instanceof azvm))
            {
              localObject3 = (azvm)localObject3;
              if (((azvm)localObject3).a()) {
                ntd.a("0X80065FF", ((StructMsgForGeneralShare)localObject1).uinType, ntd.a(((azvm)localObject3).r, ((StructMsgForGeneralShare)localObject1).mSourceName), ((azvm)localObject3).U, "");
              }
            }
          }
        }
    ...
    for (;;)
    {
      ...
      localObject1 = "";
      if (j != 0) {
        localObject1 = this.jdField_a_of_type_Bdfq.getInputValue();
      }
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
      {
        if (agej.b(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgActionData))
        {
          localObject1 = agej.b(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgActionData);
          if ((localObject1 != null) && (localObject1.length > 3))
          {
            localObject1 = localObject1[3];
            if ((localObject1 != null) && (((String)localObject1).equals("1")))
            {
              nrt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "", "0X80072A5", "0X80072A5", 0, 0, "", "", "", "");
              nrt.a("0X80072A5", "", "", "", "", "");
            }
          }
        }
  ...
  protected void y()
  {
    ((ztk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(49)).a().a(this.jdField_a_of_type_AndroidOsBundle.getString("uin"), this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg);
    this.jdField_a_of_type_AndroidAppActivity.finish();
  }
}
