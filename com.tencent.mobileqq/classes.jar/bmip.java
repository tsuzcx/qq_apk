  ...
  extends bmiv
{
  ...
  public bmip(@NonNull bmix parambmix)
  {
    super(parambmix);
  }
  ...
  private boolean b()
  {
    try
    {
      ...
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView = ((StoryGuideLineView)a(2131371607));
      Object localObject1 = "";
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    ...
    if ((!paramBoolean3) || (paramBoolean4))
    {
      ...
      {
        localObject = this.jdField_a_of_type_Bmix.a();
        xjv localxjv = this.jdField_a_of_type_Bmix.a();
        if (localObject != null) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView.setLinkerObject((bmvb)localObject);
        }
        if (this.jdField_a_of_type_Boolean) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView.setFollow();
        }
        if (localxjv != null) {
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiWidgetStoryGuideLineView.setStoryTag(localxjv);
        }
      }
      if ((this.jdField_a_of_type_Bmix instanceof bnbg))
      {
        ...
        if (!((bnbg)this.jdField_a_of_type_Bmix).r)
        {
          paramBoolean3 = true;
  ...
  protected boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          return bool;
          if ((paramMessage.obj == null) || (!(paramMessage.obj instanceof bmiq))) {
            break;
          }
          bmiq localbmiq = (bmiq)paramMessage.obj;
          if (QLog.isColorLevel()) {
            QLog.d("Q.qqstory.publish.edit.StoryDoodle", 2, "showLimitView : left : " + localbmiq.d + " right : " + localbmiq.c + " top : " + localbmiq.jdField_a_of_type_Boolean + " bottom : " + localbmiq.b);
          }
          if (localbmiq.e)
          {
            a(localbmiq.d, localbmiq.c, localbmiq.jdField_a_of_type_Boolean, localbmiq.b);
            break;
          }
