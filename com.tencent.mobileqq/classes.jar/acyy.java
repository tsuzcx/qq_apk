  ...
  implements Handler.Callback, beup, beuq, Manager
{
  ...
  private void a(aczh paramaczh)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 54	aczh:b	()Z
    //   4: ifne +4 -> 8
    //   7: return
    //   8: aload_1
    //   9: invokevirtual 57	aczh:b	()Ljava/lang/String;
    ...
    //   112: invokestatic 106	acyx:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   115: aload_2
    //   116: astore_1
    //   117: aload_2
    //   118: aload 5
    ...
    //   133: invokestatic 106	acyx:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   136: aload_2
    //   137: astore_1
    //   138: aload_2
    //   139: aload 6
    ...
    //   154: invokestatic 106	acyx:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   157: aload_2
    //   158: astore_1
    //   159: aload_2
    //   160: ldc 108
    ...
    //   214: aload 5
    //   216: invokestatic 106	acyx:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   219: aload_2
    //   220: ifnull -213 -> 7
    //   223: aload_2
    ...
    //   252: invokestatic 106	acyx:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   255: goto -36 -> 219
    //   258: astore_3
    //   259: aload_2
    //   260: astore_1
  ...
  {
    acyz localacyz = (acyz)parambevm.jdField_a_of_type_Bevl.a();
    if ((localacyz == null) || (localacyz.jdField_a_of_type_Aczh == null))
    {
    ...
    long l2 = localacyz.jdField_a_of_type_Long;
    String str3 = localacyz.jdField_a_of_type_Aczh.b();
    String str1 = localacyz.jdField_a_of_type_Aczh.c();
    int i = localacyz.jdField_a_of_type_Aczh.c();
    QLog.d("PatchLogTag", 1, "PatchDownloadManager doOnResp reslut=" + parambevm.jdField_a_of_type_Int + ", mTotalFileLen=" + parambevm.jdField_a_of_type_Long + ", downloadPatchSize=" + i + ", cost time=" + (l1 - l2));
    ...
    for (;;)
    {
      try
      {
        if ((parambevm.jdField_a_of_type_Int != 0) || (parambevm.jdField_a_of_type_Long != i)) {
          break label398;
        }
        boolean bool2 = true;
        boolean bool1 = bool2;
        if (!localacyz.jdField_a_of_type_Aczh.b())
        {
          bool1 = bool2;
          if (PatchCommonUtil.isArtGeN()) {
            bool1 = acza.a(localacyz.jdField_a_of_type_Aczh);
          }
        }
        bool2 = bool1;
        if (bool1) {
          bool2 = PatchChecker.checkPatchValid(localacyz.jdField_a_of_type_JavaLangString, str3);
        }
        if (bool2)
        {
          a(localacyz.jdField_a_of_type_Aczh);
          abiz.c();
          abiz.a(anzj.a(2131706780));
      ...
      {
        QLog.d("PatchLogTag", 1, "PatchDownloadManager doOnResp throwable=" + parambevm);
      ...
      if (parambevm.exists())
      {
        ...
        {
          str3 = "PatchDownloadManager doOnResp NOT ResultOk mErrCode=" + parambevm.b + ", mErrDesc=" + parambevm.jdField_a_of_type_JavaLangString;
          ...
          if (l2 - l1 > 21600000L)
          {
            bdkh.a(new RuntimeException(), str3);
            ((SharedPreferences)localObject).edit().putLong("patch_download_fail_report_time", l2).commit();
          }
          if ((parambevm.b == 9039) || (parambevm.b == 9301))
          {
            parambevm = new File(parambevm.jdField_a_of_type_Bevl.d);
            QLog.d("PatchLogTag", 1, "write temp patch fail path=" + parambevm.getAbsolutePath() + ", isExist=" + parambevm.exists() + ", canWrite=" + parambevm.canWrite());
          }
        }
        if (localacyz.jdField_a_of_type_Int < 3)
        {
          a(localacyz.jdField_a_of_type_Int, localacyz.jdField_a_of_type_JavaLangString, localacyz.jdField_a_of_type_Aczh);
          return;
        }
        abiz.c();
        parambevm = new File(str2);
        if (parambevm.exists()) {
          parambevm.delete();
        }
  ...
  public void a(int paramInt, String paramString, aczh paramaczh)
  {
    String str1 = paramaczh.d();
    String str2 = paramaczh.c();
    ...
    localbeum.c = PatchCommonUtil.getPatchPath(str2);
    localbeum.a(new acyz(this, paramInt + 1, SystemClock.elapsedRealtime(), paramString, paramaczh));
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(str2, localbeum);
  ...
  public void a(bevl parambevl, bevm parambevm)
  {
    ...
    parambevm.c = 0L;
    parambevl.jdField_a_of_type_JavaUtilHashMap.put("Range", "bytes=" + parambevl.jdField_a_of_type_Long + "-");
  }
  ...
  {
    if (this.jdField_a_of_type_AndroidOsHandler != null) {
      this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1, parambevm).sendToTarget();
    }
  }
  
  public void onUpdateProgeress(bevl parambevl, long paramLong1, long paramLong2)
  {
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(2, (int)paramLong1, (int)paramLong2, parambevl).sendToTarget();
  }
}
