...
public class acyy
{
  private aczc jdField_a_of_type_Aczc = new acyz(this);
  private aczd jdField_a_of_type_Aczd;
  public Context a;
  ...
  public acyy(Context paramContext, String paramString)
  {
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    if ((paramString.toLowerCase().startsWith("http://")) || (paramString.toLowerCase().startsWith("https://")))
    {
      ...
      localIntent.putExtra("selfSet_leftViewText", ajjy.a(2131640752));
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aczc = null;
    this.jdField_a_of_type_AndroidContentContext = null;
  }
  
  public void a(aczd paramaczd)
  {
    this.jdField_a_of_type_Aczd = paramaczd;
  }
  ...
  public void a(Context paramContext, ArrayList<IntimateInfo.MemoryDayInfo> paramArrayList)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout != null)
    {
      ...
      while (i < localArrayList.size())
      {
        ...
        localObject = new acza(this, paramContext);
        if (localObject != null)
        {
          ((acza)localObject).a(paramArrayList);
          ((acza)localObject).a(this.jdField_a_of_type_Aczc);
          if (((acza)localObject).a() != null) {
            this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(((acza)localObject).a());
          }
        }
        i += 1;
        continue;
