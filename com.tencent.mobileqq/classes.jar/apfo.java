...
public class apfo
  implements apgn
{
  public apfo(ArConfigService paramArConfigService) {}
    ...
    if (ArConfigService.b(this.a) != null) {
      try
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ((apif)ArConfigService.b(this.a).getBroadcastItem(i)).a(paramInt1, paramInt2);
            i += 1;
          }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ((apif)ArConfigService.b(this.a).getBroadcastItem(i)).a(paramInt);
        }
        catch (RemoteException localRemoteException)
        {
          localRemoteException.printStackTrace();
        }
        ((apif)ArConfigService.b(this.a).getBroadcastItem(i)).b(paramInt, 0);
      }
      catch (Exception localException)
      {
        if (QLog.isColorLevel()) {
