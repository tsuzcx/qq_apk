...
public class asii
{
  ...
  private static final String jdField_a_of_type_JavaLangString = asii.class.getName() + "Q.nearby.video_chat.gift";
  public static long[] a;
  ...
  public asii(AppInterface paramAppInterface, Context paramContext, SessionInfo paramSessionInfo, TroopGiftPanel paramTroopGiftPanel, ViewGroup paramViewGroup, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  private void b()
  {
    ...
    wnc localwnc = wnc.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Int);
    if (localwnc != null)
    {
      this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.setGiftData(localwnc, true);
      return;
    }
  ...
  public void a(int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    azfo localazfo = (azfo)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(223);
    azjq localazjq = (azjq)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113);
    String str = this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
    if (paramBoolean) {}
    for (int i = 4;; i = 3)
    {
      localazjq.a("OidbSvc.0x7f8", 2040, paramInt2, str, 2, i, 0, new asij(this, localazjq, l, localazfo, paramInt1));
      return;
    }
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    if (this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel != null)
    {
      ...
      if (paramBoolean1)
      {
        ...
        localObject = wnc.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Int);
        if (localObject == null) {
          break label172;
        }
        this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.setGiftData((wnc)localObject, true);
    ...
    {
      if (paramInt == 0) {
        SosoInterface.a(new asil(3, true, true, 60000L, true, false, "NearbyTroopsView"));
      }
      return;
      label172:
      this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.d();
