  ...
  implements Manager
{
  ...
  public IntimateInfo a(String paramString)
  {
    ...
    return (IntimateInfo)this.jdField_a_of_type_Awgf.a(IntimateInfo.class, paramString);
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          b(str);
        } while (this.jdField_a_of_type_Bbaa == null);
        Object localObject = new baub();
        ((baub)localObject).jdField_a_of_type_Baug = new asij(this);
        ((baub)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
        ((baub)localObject).jdField_a_of_type_Int = 0;
        ((baub)localObject).c = str;
        ((baub)localObject).e = 0;
        ((baub)localObject).jdField_a_of_type_Bauf = new asik(this);
        localObject = new bazy(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.b, new asil(this), (baub)localObject);
        this.jdField_a_of_type_Bbaa.a(10089, "prd", this.b, 0, this.jdField_a_of_type_JavaLangString, str, 2, 0, false, (bazx)localObject);
        return;
      } while (c());
      bool1 = b(str, a());
      bool2 = c();
  ...
  public void a(IntimateInfo paramIntimateInfo)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Awgf != null) && (this.jdField_a_of_type_Awgf.a())) {
        this.jdField_a_of_type_Awgf.a(paramIntimateInfo);
      }
    } while (!QLog.isColorLevel());
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      ...
      paramString = (IntimateInfo)this.jdField_a_of_type_Awgf.a(IntimateInfo.class, paramString);
      if (paramString != null) {
  ...
  public void a(String paramString, IntimateInfo paramIntimateInfo)
  {
    ...
    do
    {
      return;
      if ((this.jdField_a_of_type_Awgf != null) && (this.jdField_a_of_type_Awgf.a())) {
        this.jdField_a_of_type_Awgf.b(paramIntimateInfo);
      }
    } while (!QLog.isColorLevel());
