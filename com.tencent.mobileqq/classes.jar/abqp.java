  ...
  extends aodp
{
  ...
  protected void a(boolean paramBoolean, long paramLong1, long paramLong2, String paramString, int paramInt)
  {
    ...
    if (this.a.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      if (((abqu)this.a.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).a != paramLong1) {}
    }
    for (;;)
    {
      if (paramInt != -1) {
      ...
      for (;;)
      {
        if (paramInt < this.a.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          if (this.a.jdField_a_of_type_Bafb != null) {
            this.a.jdField_a_of_type_Bafb.setMessage(String.format(this.a.d, new Object[] { Integer.valueOf(this.a.jdField_a_of_type_Int + 1), Integer.valueOf(this.a.jdField_b_of_type_Int), Integer.valueOf((int)(paramString.fProgress * 100.0F)) }));
          }
        }
        return;
        paramInt += 1;
  ...
  protected void b(long paramLong1, long paramLong2, String paramString, int paramInt)
  {
    ...
    if (this.a.jdField_a_of_type_Bafb != null) {
      this.a.jdField_a_of_type_Bafb.setMessage(String.format(this.a.d, new Object[] { Integer.valueOf(this.a.jdField_a_of_type_Int + 1), Integer.valueOf(this.a.jdField_b_of_type_Int), Integer.valueOf(0) }));
    }
    this.a.jdField_a_of_type_JavaUtilList = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c();
  }
}
