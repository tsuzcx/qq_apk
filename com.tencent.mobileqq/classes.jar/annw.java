  ...
  extends AsyncTask<Integer, Void, Bitmap>
{
  ...
  private WeakReference<annv> jdField_a_of_type_JavaLangRefWeakReference;
  
  public annw(annv paramannv, int paramInt)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramannv);
  ...
  protected Bitmap a(Integer... paramVarArgs)
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: getfield 21	annw:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   66: aload_3
    //   67: getfield 66	annv:a	Ljava/lang/String;
  ...
  protected void a(Bitmap paramBitmap)
  {
    ...
    annv localannv = (annv)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((localannv != null) && (paramBitmap != null) && (!paramBitmap.isRecycled())) {
      localannv.a(paramBitmap, this.jdField_a_of_type_Int);
    }
  }
}
