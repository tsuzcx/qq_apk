...
{
  public static int a;
  private static annw jdField_a_of_type_Annw;
  public static int b;
  ...
  {
    if (jdField_a_of_type_Annw == null) {
      jdField_a_of_type_Annw = new annw();
    }
    return jdField_a_of_type_Annw;
  }
  ...
  {
    annx localannx = new annx(this);
    String str2 = paramContext.getString(2131626566);
    String str1 = paramContext.getString(2131626553);
    ...
    for (Object localObject = String.format(paramContext.getString(2131626564), new Object[] { Integer.valueOf(((Time)localObject).year), Integer.valueOf(((Time)localObject).month + 1), Integer.valueOf(((Time)localObject).monthDay), Integer.valueOf(((Time)localObject).hour), Integer.valueOf(((Time)localObject).minute) });; localObject = paramContext.getString(2131626565))
    {
      paramContext = babr.a(paramContext, 230, str2, String.format(paramContext.getString(2131626563), new Object[] { paramString, localObject }), null, localannx);
      if (paramContext != null)
      {
        paramContext.setNegativeButton(str1, localannx);
        paramContext.show();
      }
      return;
    }
