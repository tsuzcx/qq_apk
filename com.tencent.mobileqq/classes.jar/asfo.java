...
public class asfo
{
  private static asfo jdField_a_of_type_Asfo;
  private static byte[] jdField_a_of_type_ArrayOfByte = new byte[0];
  private Messenger jdField_a_of_type_AndroidOsMessenger;
  private anmu jdField_a_of_type_Anmu = new asfp(this);
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new asfq(this);
  
  public static asfo a()
  {
    if (jdField_a_of_type_Asfo == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Asfo == null) {
        jdField_a_of_type_Asfo = new asfo();
      }
      return jdField_a_of_type_Asfo;
    }
  }
  ...
  public static void a()
  {
    if (jdField_a_of_type_Asfo != null) {
      synchronized (jdField_a_of_type_ArrayOfByte)
      {
        if ((jdField_a_of_type_Asfo != null) && (jdField_a_of_type_Asfo.jdField_a_of_type_JavaLangRefWeakReference != null))
        {
          QQAppInterface localQQAppInterface = (QQAppInterface)jdField_a_of_type_Asfo.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localQQAppInterface != null) {
            localQQAppInterface.removeObserver(jdField_a_of_type_Asfo.jdField_a_of_type_Anmu);
          }
          jdField_a_of_type_Asfo = null;
        }
        return;
      }
    }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    label30:
    for (int i = -1;; i = asfr.a().a(localQQAppInterface, localQQAppInterface.getCurrentAccountUin(), null, paramArrayOfByte, this.jdField_a_of_type_MqqObserverWtloginObserver))
    {
      a(i);
      return;
    }
