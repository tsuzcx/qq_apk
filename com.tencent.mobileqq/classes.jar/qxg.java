...
public class qxg
{
  ...
  private static volatile qxg jdField_a_of_type_Qxg;
  public static int b;
  ...
  private qxg()
  {
    this.jdField_a_of_type_Qxk = new qxk(this);
    ...
    try
    {
      String str = (String)bkwm.a(jdField_a_of_type_JavaLangString, "");
      Object localObject2;
      ...
      Object localObject1 = (String)bkwm.a(jdField_b_of_type_JavaLangString, "");
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      ...
      bkwm.a(jdField_a_of_type_JavaLangString, "");
      bkwm.a(jdField_b_of_type_JavaLangString, "");
    }
  }
  ...
  public static qxg a()
  {
    if (jdField_a_of_type_Qxg == null) {}
    try
    {
      if (jdField_a_of_type_Qxg == null) {
        jdField_a_of_type_Qxg = new qxg();
      }
      return jdField_a_of_type_Qxg;
    }
    finally {}
  }
  ...
  private void a(AbsListView paramAbsListView, boolean paramBoolean)
  {
    ...
    {
      localObject1 = (qxh)this.jdField_a_of_type_JavaUtilList.get(((Integer)this.jdField_b_of_type_JavaUtilHashMap.get(str)).intValue());
      l3 = ((qxh)localObject1).jdField_b_of_type_Long;
      if (i1 <= 0) {
        break label521;
      }
    }
    ...
    {
      ((qxh)localObject1).jdField_b_of_type_Long = (l2 + l3);
      localObject2 = a(localView);
      if ((localObject2 != null) && (localObject2[1] - localObject2[0] >= localView.getHeight() * jdField_a_of_type_Double)) {
        ((qxh)localObject1).jdField_c_of_type_Long += l1;
      }
      ((qxh)localObject1).jdField_c_of_type_Boolean = this.jdField_a_of_type_JavaUtilHashMap.containsKey(str);
      if (!paramBoolean) {
        break;
      }
      ((qxh)localObject1).jdField_b_of_type_Boolean = true;
      break;
      localObject1 = new qxh(this);
      ((qxh)localObject1).jdField_a_of_type_JavaLangString = str;
      ((qxh)localObject1).jdField_a_of_type_Int = pay.a((BaseArticleInfo)localObject2);
      int m;
      label305:
      boolean bool;
      ...
      {
        m = 0;
        ((qxh)localObject1).jdField_b_of_type_Int = m;
        if (this.jdField_g_of_type_Long != -1L) {
          break label504;
        }
        bool = true;
        label326:
        ((qxh)localObject1).jdField_a_of_type_Boolean = bool;
        ((qxh)localObject1).jdField_c_of_type_Int = localView.getHeight();
        ((qxh)localObject1).jdField_b_of_type_JavaLangString = ((BaseArticleInfo)localObject2).mRecommentdReason;
        m = this.j;
        this.j = (m + 1);
        ((qxh)localObject1).jdField_d_of_type_Int = m;
        localObject2 = pbj.a().a();
      ...
      label504:
      label510:
      for (((qxh)localObject1).jdField_c_of_type_JavaLangString = (localObject2[0] + "_" + localObject2[1] + "_" + localObject2[2] + "_" + localObject2[3]);; ((qxh)localObject1).jdField_c_of_type_JavaLangString = "NULL")
      {
  ...
  private void e()
  {
    ...
    if (this.jdField_b_of_type_ArrayOfInt != null)
    {
      ...
      bkwm.a(jdField_b_of_type_JavaLangString, str);
    }
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)
    {
      ...
      bkwm.a(jdField_a_of_type_JavaLangString, str);
    }
  }
  
  public long a()
  {
    if (this.jdField_a_of_type_Qxk.jdField_a_of_type_Long == 0L) {
      return this.jdField_e_of_type_Long;
    }
    return this.jdField_a_of_type_Qxk.jdField_a_of_type_Long - this.jdField_a_of_type_Long;
  }
  ...
  public void a()
  {
    ...
    if ((this.jdField_d_of_type_Long != 0L) && (!TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) && (this.jdField_b_of_type_JavaUtilHashMap.containsKey(this.jdField_c_of_type_JavaLangString)))
    {
      ...
      qxh localqxh = (qxh)this.jdField_a_of_type_JavaUtilList.get(k);
      localqxh.jdField_a_of_type_Long = (l + localqxh.jdField_a_of_type_Long);
  ...
  public void a(AbsListView paramAbsListView, int paramInt)
  {
    ...
    ((ReadInJoyXListView)paramAbsListView).a(this.jdField_a_of_type_Qxk);
  ...
  public long b()
  {
    if (this.jdField_a_of_type_Qxk.jdField_b_of_type_Long == 0L) {
      return this.jdField_e_of_type_Long;
    }
    return this.jdField_c_of_type_Long - this.jdField_a_of_type_Qxk.jdField_b_of_type_Long;
  }
  ...
  public void c()
  {
    ...
    new pwu(null, null, null, qli.a(), null).a(this, BaseApplication.getContext());
    e();
    this.jdField_a_of_type_MqqUtilWeakReference = null;
    jdField_a_of_type_Qxg = null;
  }
