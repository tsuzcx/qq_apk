...
public class acxh
  implements acxg, ajzn, View.OnClickListener, bepi
{
  private int jdField_a_of_type_Int;
  ajzc jdField_a_of_type_Ajzc;
  private ajzi jdField_a_of_type_Ajzi = new acxi(this);
  Context jdField_a_of_type_AndroidContentContext;
  BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private String jdField_a_of_type_JavaLangString;
  
  acxh(BaseChatPie paramBaseChatPie)
  {
  ...
  private boolean a(int paramInt, String paramString)
  {
    ...
    int i = ((ajzj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285)).a(paramString, paramInt);
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        } while (!ajzm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString));
        this.jdField_a_of_type_Ajzc = new ajzc(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
        ...
        localajzj = (ajzj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285);
        localajzj.a(this);
        localajzj.a(this.jdField_a_of_type_Ajzi);
        return;
        QLog.i("IceBreak.HotPic", 1, "onMoveToState destroy.");
      } while (this.jdField_a_of_type_Ajzc == null);
      ajzj localajzj = (ajzj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285);
      localajzj.b(this);
      localajzj.e();
      this.jdField_a_of_type_Ajzc.b();
      this.jdField_a_of_type_Ajzc = null;
      return;
    ...
    ajzm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, false, this.jdField_a_of_type_Int);
  }
  
  public void a(int paramInt1, int paramInt2)
  {
    if ((this.jdField_a_of_type_Ajzc != null) && (paramInt2 == 0)) {
      this.jdField_a_of_type_Ajzc.a(false);
    }
  }
  
  public void a(AbsListView paramAbsListView, int paramInt1, int paramInt2, int paramInt3)
  {
    if (this.jdField_a_of_type_Ajzc != null) {
      this.jdField_a_of_type_Ajzc.a();
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    if (!ajzm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, str)) {}
    while ((TextUtils.isEmpty(str)) || (!str.equals(paramString)) || (((!paramBoolean) || (!ajzm.c(i))) && ((paramBoolean) || (!ajzm.b(i))) && (!ajzm.d(i)))) {
      return;
    }
  ...
  {
    if (!ajzm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {}
    do
    {
      return;
      if (QLog.isColorLevel()) {
    ...
    ajzm.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean2)
    {
      ...
      if (ajzm.b(i))
      {
        ...
        if ((this.jdField_a_of_type_Ajzc != null) && (localajjj.b(str)) && (!localajzj.a(str))) {
          localajzj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 3, 1, str);
        }
      }
      do
      {
        ...
        } while (localajzj.b(str));
        localajzj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 3, 2, str);
        return;
      } while ((!ajzm.d(i)) || (localajzj.c(str)));
      localajzj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 3, 1, str);
      return;
    }
    this.jdField_a_of_type_Ajzi.a(true, null);
  }
  ...
  {
    if ((!ajzm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) || (this.jdField_a_of_type_Ajzc == null)) {}
    do
    {
      return;
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Ajzc.a(true);
  }
  ...
  public void b(String paramString, boolean paramBoolean)
  {
    ...
    String str = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
    if (!ajzm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, str)) {}
    while ((TextUtils.isEmpty(paramString)) || (!str.equals(paramString)) || (((!paramBoolean) || (!ajzm.c(i))) && ((paramBoolean) || (!ajzm.b(i))) && (!ajzm.d(i)))) {
      return;
    }
  ...
  {
    if ((paramView.getId() == 2131302566) && (this.jdField_a_of_type_Ajzc != null))
    {
      if (QLog.isColorLevel()) {
