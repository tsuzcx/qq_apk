  ...
  implements behy<oidb_0x8e4.RspBody>
{
  ...
  public void a(int paramInt, oidb_0x8e4.RspBody paramRspBody)
  {
    ...
    do
    {
      QQToast.a(this.a.a(), 1, alpo.a(2131705475), 1).a();
      return;
      while ((!paramRspBody.getBooleanExtra("finishAIO", false)) || (!(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity instanceof ChatActivity)))
      {
        ...
        aush.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "game_room_last_time", Long.valueOf(ayvc.a()));
        paramInt = aekt.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, paramRspBody);
        if (paramInt != 0) {
          break;
        }
        if (QLog.isColorLevel()) {
