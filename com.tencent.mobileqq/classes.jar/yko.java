...
public class yko
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfJavaLangString = wjz.a(2130968663);
  }
  ...
  public String a(int paramInt, TextPaint paramTextPaint)
  {
    ...
    do
    {
      ...
      do
      {
        return str;
        if (j == 0) {
          return wjz.a(2131698506);
        }
        localStringBuilder.append(zlx.a(j)).append("个小视频");
        if (j > 0) {
        ...
        localStringBuilder.append(wjz.a(2131698520, new Object[] { Integer.valueOf(this.g) }));
        return localStringBuilder.toString();
        if (this.jdField_a_of_type_Boolean)
        {
          localStringBuilder.append(zlx.a(j)).append("个小视频");
          ...
          if (this.jdField_d_of_type_Int > 0) {
            localStringBuilder.append(jdField_a_of_type_ArrayOfJavaLangString[1]).append("赞").append(zlx.a(this.jdField_d_of_type_Int));
          }
          if (this.e <= 0) {
            break;
          }
          localStringBuilder.append(jdField_a_of_type_ArrayOfJavaLangString[1]).append("评论").append(zlx.a(this.e));
          break;
        }
        localStringBuilder.append(zlx.a(this.f)).append("个小视频发送失败");
        break;
        long l1 = l2;
        int k = i1;
        i = n;
        if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)
        {
          ...
          i = n;
          j = m;
          if (this.jdField_a_of_type_Wqp != null)
          {
            i = this.jdField_a_of_type_Wqp.b;
            k = this.jdField_a_of_type_Wqp.jdField_a_of_type_Int;
            l1 = this.jdField_a_of_type_Wqp.c;
            j = m;
          }
        }
        localStringBuilder.append(zlx.a(j)).append("个小视频");
        ...
        str = localStringBuilder.toString();
        if (k > 0) {
          localStringBuilder.append(jdField_a_of_type_ArrayOfJavaLangString[1]).append("赞").append(zlx.a(k));
        }
      } while ((paramTextPaint != null) && (paramTextPaint.measureText(localStringBuilder.toString()) > paramInt));
      str = localStringBuilder.toString();
      if (i > 0) {
        localStringBuilder.append(jdField_a_of_type_ArrayOfJavaLangString[1]).append("评论").append(zlx.a(i));
      }
    } while ((paramTextPaint == null) || (paramTextPaint.measureText(localStringBuilder.toString()) <= paramInt));
    return str;
  }
  ...
  public void a()
  {
    ...
    do
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        int i = ykw.a(localStoryVideoItem.mUploadStatus);
        if ((i == 1) || (i == 0))
        {
  ...
  public void c(StoryVideoItem paramStoryVideoItem)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          if ((this.jdField_a_of_type_JavaUtilArrayList.size() != 0) || (this.jdField_a_of_type_Wqp == null)) {
            break;
          }
          this.jdField_a_of_type_Wqp.b = 0;
          this.jdField_a_of_type_Wqp.jdField_a_of_type_Int = 0;
          this.jdField_a_of_type_Wqp.c = 0;
          paramStoryVideoItem = (wpf)wpm.a(10);
