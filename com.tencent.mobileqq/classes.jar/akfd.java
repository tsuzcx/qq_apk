  ...
  extends AsyncTask<Void, Void, Bitmap>
{
  ...
  private akfd(PhotoCropActivity paramPhotoCropActivity) {}
  ...
  protected Bitmap a(Void... paramVarArgs)
  {
    try
    {
      ...
      for (paramVarArgs = Bitmap.Config.ARGB_8888;; paramVarArgs = Bitmap.Config.RGB_565)
      {
        ...
        bgmo.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.jdField_c_of_type_JavaLangString, localOptions);
        localOptions.inSampleSize = akgy.a(localOptions, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.g, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.g);
        localOptions.inJustDecodeBounds = false;
        paramVarArgs = bgmo.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.jdField_c_of_type_JavaLangString, localOptions);
        return new beak(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.jdField_c_of_type_JavaLangString).a(paramVarArgs);
      }
      return null;
    }
  ...
  protected void a(Bitmap paramBitmap)
  {
    ...
    if (this.jdField_a_of_type_Int == 1) {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity, anni.a(2131706833), 0).a();
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int == 2) {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity, anni.a(2131706834), 0).a();
      } else {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity, anni.a(2131706832), 0).a();
      }
    }
  }
}
