  ...
  implements Handler.Callback
{
  ...
  protected Handler a;
  protected View a;
  private ArrayList<bmuf> a;
  protected int b;
  protected String c;
  
  public bmuf(View paramView)
  {
  ...
  public bmuf(String paramString, View paramView)
  {
    this(paramView);
    this.c = paramString;
  }
  ...
  public ViewGroup.LayoutParams a(JSONObject paramJSONObject, bmuf parambmuf)
  {
    ...
    parambmuf.a((ViewGroup.LayoutParams)localObject1, paramJSONObject);
    return localObject1;
  }
  
  public bmuf a(String paramString)
  {
    bmuf localbmuf2 = null;
    bmuf localbmuf1 = localbmuf2;
    if (!TextUtils.isEmpty(this.c))
    {
      if (this.jdField_a_of_type_JavaUtilArrayList != null) {
        break label25;
      }
      localbmuf1 = localbmuf2;
    }
    label25:
    do
    {
      ...
      localbmuf2 = (bmuf)localIterator.next();
      if (localbmuf2 == null) {
        break label110;
      }
      localbmuf2 = localbmuf2.a(paramString);
      localbmuf1 = localbmuf2;
    } while (localbmuf2 != null);
    localbmuf1 = localbmuf2;
    label110:
    for (;;)
    {
  ...
  public void a(bmuf parambmuf)
  {
    ...
    this.jdField_a_of_type_JavaUtilArrayList.add(parambmuf);
  }
  ...
  public void c()
  {
    ...
    while (localIterator.hasNext())
    {
      bmuf localbmuf = (bmuf)localIterator.next();
      if (localbmuf != null) {
        localbmuf.c();
      }
    }
