...
public class bmuf
{
  ...
  private static bmuj jdField_a_of_type_Bmuj = new bmuj(Looper.getMainLooper());
  ...
  {
    Message localMessage = jdField_a_of_type_Bmuj.obtainMessage();
    localMessage.what = 3001;
    jdField_a_of_type_Bmuj.sendMessage(localMessage);
  }
  ...
  public static void b(Activity paramActivity, int paramInt)
  {
    ...
    jdField_a_of_type_Bmuj.removeMessages(3000);
    Message localMessage = jdField_a_of_type_Bmuj.obtainMessage();
    localMessage.what = 3000;
    localMessage.obj = paramActivity;
    localMessage.arg1 = paramInt;
    jdField_a_of_type_Bmuj.sendMessageDelayed(localMessage, 1000L);
  }
  ...
  private static void d(Activity paramActivity, int paramInt)
  {
    ...
    if (b(paramInt))
    {
      str1 = BaseApplicationImpl.getContext().getString(2131692520);
      if (!b(paramInt)) {
        break label161;
      }
    }
    label161:
    for (String str2 = BaseApplicationImpl.getContext().getString(2131692513);; str2 = BaseApplicationImpl.getContext().getString(2131692516))
    {
      jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bhdj.a(paramActivity, 230, str1, str2, 2131692518, 2131692519, new bmug(paramInt, paramActivity), new bmuh());
      jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnDismissListener(new bmui());
      jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.show();
      return;
      str1 = BaseApplicationImpl.getContext().getString(2131692521);
      break;
    }
  }
}
