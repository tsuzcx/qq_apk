...
public class apel
{
  ...
  private static Map<String, apem> jdField_b_of_type_JavaUtilMap = new HashMap();
  ...
  public static void a(String paramString, byte[] paramArrayOfByte)
  {
    ...
    localapem.jdField_a_of_type_JavaLangString = paramString;
    localapem.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    jdField_b_of_type_JavaUtilMap.put(paramString, localapem);
  }
  ...
  private static boolean a(long paramLong)
  {
    ...
    {
      aptx.a(0, String.format(BaseApplicationImpl.getApplication().getResources().getString(2131692663), new Object[] { Integer.valueOf(jdField_c_of_type_Int) }), 0);
      return false;
    }
    if ((jdField_a_of_type_Long > 0L) && (d() + paramLong > jdField_a_of_type_Long))
    {
      String str = BaseApplicationImpl.getApplication().getResources().getString(2131692670);
      aptx.a(0, str + apvd.a(jdField_a_of_type_Long), 0);
      return false;
    }
    return true;
  }
  ...
  public static boolean b()
  {
    ...
    while (localIterator.hasNext())
    {
      str = apvd.a(((FileInfo)localIterator.next()).d());
      if ((str == null) || (str.length() == 0)) {
        return false;
      }
      str = str.toLowerCase();
      if (!ayfx.jdField_a_of_type_JavaLangString.contains(str)) {
        return false;
      }
    }
    ...
    while (localIterator.hasNext())
    {
      str = apvd.a(((FileManagerEntity)localIterator.next()).fileName);
      if ((str == null) || (str.length() == 0)) {
        return false;
      }
      str = str.toLowerCase();
  ...
  public static long c()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (aptd.a(localFileManagerEntity).a(false)) {
        l += apvd.a(localFileManagerEntity.getFilePath());
      }
    }
    return l;
  }
