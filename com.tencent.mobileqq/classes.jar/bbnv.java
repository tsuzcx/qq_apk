...
public class bbnv
{
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, bbmm parambbmm, bbnx parambbnx)
  {
    ...
    if (paramInt1 != 0)
    {
      ...
      localObject2[0] = 0;
      localObject2 = parambbmm.jdField_a_of_type_Bbnw;
      if (localObject2 == null) {
        break label169;
      }
      parambbmm = ((bbnw)localObject2).jdField_a_of_type_JavaLangString;
      localObject1 = ((bbnw)localObject2).jdField_a_of_type_AndroidGraphicsBitmap$CompressFormat;
    }
    for (paramInt1 = ((bbnw)localObject2).jdField_a_of_type_Int;; paramInt1 = 100)
    {
      ThreadManager.executeOnFileThread(new ThumbnailUtil.1(paramInt3, paramInt2, arrayOfInt1, arrayOfInt2, parambbmm, (Bitmap.CompressFormat)localObject1, paramInt1, parambbnx));
      return;
      GLES20.glReadPixels(0, 0, paramInt2, paramInt3, 6408, 5121, (Buffer)localObject1);
      break;
      label169:
      parambbmm = a(parambbmm.jdField_a_of_type_JavaLangString);
