  ...
  implements AlbumListLogic.IalbumListAdapterCallBack
{
  ...
  public aimb(AlbumListFragment paramAlbumListFragment)
  {
    super(paramAlbumListFragment);
    this.mAlbumListAdapterCallBack = this;
    this.mAlbumListData = new aima();
    this.a = ((aima)this.mAlbumListData);
  }
  
  protected aimd a()
  {
    return (aimd)super.getAlbumListAdapter();
  }
  ...
  {
    return new aimd((AlbumListFragment)this.mFragment);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject = paramViewGroup.mResources.getDrawable(2130847117);
  ...
  public void initData(Intent paramIntent)
  {
    ...
    String str1 = str2;
    if (str2 == null) {
      str1 = bllv.a().getCurrentAccountUin();
    }
    if (str1 != null) {
    ...
    {
      this.a.jdField_a_of_type_Avqu = new aimc(this);
      ...
      BaseApplicationImpl.getApplication().getRuntime().registObserver(this.a.jdField_a_of_type_Avqu);
  ...
  public boolean onItemClick(QQAlbumInfo paramQQAlbumInfo, int paramInt, Intent paramIntent)
  {
    ...
    if (paramQQAlbumInfo._id.equals("qzone_album"))
    {
      ...
      bizm.a(((AlbumListFragment)this.mFragment).getActivity(), localbizt, (Bundle)localObject, 100016);
    ...
    if ("$VideoAlbumId".equals(paramQQAlbumInfo._id)) {
      azmj.b(null, "CliOper", "", "", "0X8006131", "0X8006131", 0, 0, "", "", "", "");
    }
