  ...
  implements bcbk
{
  ...
  public anug(QQAppInterface paramQQAppInterface)
  {
  ...
  public ReqItem a(int paramInt)
  {
    ...
    {
      localObject1 = (bgrs)this.app.getManager(31);
      if (localObject1 != null) {
        ((bgrs)localObject1).a(true, this);
      }
    }
    if (this.a != null)
    {
      Object localObject2 = this.app.jdField_a_of_type_Bbxc.a(this.a.getServiceCmd());
