  ...
  implements Runnable
{
  ...
  public alul(QidianProfileCardActivity paramQidianProfileCardActivity, URLDrawable paramURLDrawable)
  {
  ...
  public void run()
  {
    ...
    String str = AppConstants.bA + localQidianProfileCardActivity.a.a.a + Utils.Crc64String(this.jdField_a_of_type_ComTencentImageURLDrawable.getURL().toString());
    localObject = str;
    ...
    catch (IOException localIOException)
    {
      ...
      localQidianProfileCardActivity.runOnUiThread(new alum(this, localQidianProfileCardActivity));
    }
  }
}
