...
public abstract class ascs
  implements asea
{
  asdl jdField_a_of_type_Asdl;
  aseb jdField_a_of_type_Aseb = null;
  ...
  public ascs(QQAppInterface paramQQAppInterface, asdl paramasdl)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Asdl = paramasdl;
    this.jdField_a_of_type_Aseb = new aseb(paramQQAppInterface);
  }
  ...
  public View a(int paramInt, View paramView, asdt paramasdt, EmoticonInfo paramEmoticonInfo)
  {
    return paramView;
  }
  ...
  public aseb a()
  {
    return this.jdField_a_of_type_Aseb;
  }
  ...
  public void b()
  {
    ...
    Object localObject = a(this.jdField_a_of_type_Asdl.jdField_a_of_type_JavaUtilList);
    if (localObject == null) {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Asdl.d((List)localObject);
      return;
    }
  }
  ...
  public void c()
  {
    ...
    Object localObject = this.jdField_a_of_type_Asdl.jdField_a_of_type_JavaUtilList;
    if (localObject == null) {
      localObject = new ArrayList();
    }
    for (;;)
  ...
  public void d()
  {
    this.jdField_a_of_type_Aseb.onDestroy();
    this.jdField_a_of_type_Asdl = null;
  }
