  ...
  extends anii
{
  ...
  public void d(safecheckPB.ReqMQScanRequest paramReqMQScanRequest, safecheckPB.RspMQScanReport paramRspMQScanReport)
  {
    ...
    //   22: astore 13
    //   24: aload_0
    //   25: getfield 48	anse:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   28: invokevirtual 54	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   31: astore 6
    //   33: aload 6
    //   35: aload_0
    //   36: getfield 48	anse:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
