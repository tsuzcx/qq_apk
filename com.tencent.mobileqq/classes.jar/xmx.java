...
public class xmx
{
  ...
  public static long a(String paramString)
  {
    ...
    {
      wsv.c("Q.qqstory:Utils", paramString, "", new Object[0]);
    }
    return -1L;
  }
  ...
  public static void a(Context paramContext, File paramFile)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        wsv.b("Q.qqstory:Utils", "exception", localException);
      }
    }
  }
  ...
  {
    wsv.d("Q.qqstory:Utils", "delete " + paramFile);
    if (paramFile.isFile()) {
      paramFile.delete();
    }
  ...
  public static void a(String paramString)
  {
    ...
    {
      a(paramString);
      wsv.d("Q.qqstory:Utils", "make flag file %b", new Object[] { Boolean.valueOf(bdcs.a(str, String.valueOf(System.currentTimeMillis()))) });
      return;
    }
    wsv.d("Q.qqstory:Utils", "flag file exist");
  }
  
  public static void a(String paramString, boolean paramBoolean)
  {
    wsv.d("Q.qqstory:Utils", "delete %s", new Object[] { paramString });
    bdcs.a(paramString, paramBoolean);
  }
  
  public static boolean a()
  {
    long l = a();
    wsv.b("Q.qqstory:Utils", "free spac:" + l / 1024L / 1024L + "MB--" + l);
    return l < 52428800L;
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    wsv.d("Q.qqstory:Utils", "low capacity!");
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    wsv.c("Q.qqstory:Utils", "saveVideoToAlbum: " + bool);
  ...
  public static boolean a(String paramString)
  {
    ...
    {
      wsv.d("Q.qqstory:Utils", "mkdirs failed, path:%s", new Object[] { paramString });
      return false;
    }
    return true;
  }
  ...
  {
    return bdcs.c(paramString1, paramString2);
  }
  ...
  {
    paramString = bdcs.a(paramString + "/" + "dont_delete.txt");
    if (paramString == null) {
      return 0L;
    }
    try
    ...
    {
      wsv.b("Q.qqstory:Utils", "exception", paramString);
    }
    return 0L;
  }
  ...
  {
    return bdcs.b(paramString1, paramString2);
  }
  ...
  {
    return bdcs.d(paramString1, paramString2);
  }
  
  public static boolean d(String paramString)
  {
    bdcs.a(paramString);
    wsv.d("Q.qqstory:Utils", "removeAllFiles " + paramString);
    return true;
  }
  ...
  public static boolean f(String paramString)
  {
    ...
    {
      wsv.d("Q.qqstory:Utils", "save from: delete path null");
      return false;
    }
    bdcs.d(paramString);
    wsv.d("Q.qqstory:Utils", "deleteFile %s", new Object[] { paramString });
    return true;
  }
  ...
  public static boolean g(String paramString)
  {
    ...
    bdcs.d(paramString);
    wsv.d("Q.qqstory:Utils", "tryDeleteFile %s", new Object[] { paramString });
    return true;
  }
}
