  ...
  implements View.OnClickListener
{
  ...
  private final wje jdField_a_of_type_Wje = (wje)wjs.a(15);
  protected wvu a;
  private xeg jdField_a_of_type_Xeg;
  private xep jdField_a_of_type_Xep;
  private xnl jdField_a_of_type_Xnl;
  private xnm jdField_a_of_type_Xnm;
  private final yck jdField_a_of_type_Yck = (yck)wjs.a(11);
  ...
  public xmx(ViewGroup paramViewGroup)
  {
  ...
  private void a(VideoListFeedItem paramVideoListFeedItem)
  {
    ...
    if (paramVideoListFeedItem.mHadLike == 1) {
      this.jdField_a_of_type_ComTencentBizQqstoryViewPressDarkImageView.setImageResource(2130846576);
    }
    while (paramVideoListFeedItem.mLikeCount > 0)
    {
      ...
      return;
      this.jdField_a_of_type_ComTencentBizQqstoryViewPressDarkImageView.setImageResource(2130846889);
    }
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131700681));
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    localMediaScanner.queryMediaInfoAsync(new xnd(this, paramString3, paramString4, paramString2, paramString5, paramString6, paramString1, localLocalMediaInfo), localLocalMediaInfo);
  }
  ...
  private void b(VideoListFeedItem paramVideoListFeedItem)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131700684));
  }
  ...
  private void d()
  {
    ...
    if (((Boolean)localwjl.b("first_clk_forward", Boolean.valueOf(true))).booleanValue())
    {
      VideoViewVideoHolder localVideoViewVideoHolder = ((StoryPlayerGroupHolder)a()).a();
      QQCustomDialog localQQCustomDialog = bhdj.a(b(), 230);
      localQQCustomDialog.setTitle(anvx.a(2131700682)).setMessage(anvx.a(2131700675)).setPositiveButton(anvx.a(2131700683), new xnb(this)).setOnDismissListener(new xna(this, localVideoViewVideoHolder));
      localQQCustomDialog.show();
      if (localVideoViewVideoHolder != null) {
        localVideoViewVideoHolder.c(true);
      }
      localwjl.b("first_clk_forward", Boolean.valueOf(false));
      ykv.a("play_video", "exp_window", 0, 0, new String[0]);
    }
    for (;;)
    {
      ykv.a("play_video", "clk_repost", 0, 0, new String[] { "", "", "", this.jdField_a_of_type_Xhf.jdField_a_of_type_JavaLangString });
      return;
      e();
    }
  }
  ...
  private void e()
  {
    ...
    Object localObject2 = (wke)wjs.a(2);
    ...
    Object localObject1 = this.jdField_a_of_type_Xhf.a();
    ...
    for (;;)
    {
      ykv.a("share", "clk_video", 0, 0, new String[] { localStoryVideoItem.mVid });
      return;
      localObject1 = ((VideoListFeedItem)localObject1).feedId;
      break;
      label171:
      a(b().getString(2131719924), true);
      this.jdField_a_of_type_Wca.a(localStoryVideoItem.mVid, 0, true, new xnc(this, localVideoViewVideoHolder, localStoryVideoItem, (QQUserUIItem)localObject2, (String)localObject1));
      if (localVideoViewVideoHolder != null) {
        localVideoViewVideoHolder.c(true);
      }
  ...
  {
    new xmy(this);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131381535);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131381536);
    this.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
    this.d = paramView.findViewById(2131370086);
    this.d.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentBizQqstoryViewPressDarkImageView = ((PressDarkImageView)paramView.findViewById(2131370092));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370090));
    this.jdField_e_of_type_AndroidViewView = paramView.findViewById(2131364890);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131364924));
    this.jdField_b_of_type_ComTencentBizQqstoryViewPressDarkImageView = ((PressDarkImageView)paramView.findViewById(2131364937));
  ...
  {
    paramMap.put(new xni(this), "");
    paramMap.put(new xng(this), "");
    paramMap.put(new xnh(this), "");
    paramMap.put(new xnj(this), "");
    paramMap.put(new xnf(this), "");
    paramMap.put(new xnk(this), "");
    this.jdField_a_of_type_Xnl = new xnl(this);
    a(this.jdField_a_of_type_Xnl);
  }
  ...
  public void a(@NonNull xhf paramxhf, @NonNull StoryVideoItem paramStoryVideoItem)
  {
    ...
    VideoListFeedItem localVideoListFeedItem = (VideoListFeedItem)this.jdField_a_of_type_Yck.a(paramxhf.jdField_b_of_type_JavaLangString, true);
    Object localObject;
    boolean bool1;
    boolean bool2;
    if ((!paramStoryVideoItem.isUploadSuc()) || (localVideoListFeedItem == null))
    {
      ...
      {
        ykq.d((String)localObject, "hide BottomWidget because uploading=%s, no-feed=%s , feed id = %s", new Object[] { Boolean.valueOf(bool1), Boolean.valueOf(bool2), paramxhf.jdField_b_of_type_JavaLangString });
        k();
        return;
        bool1 = false;
        break;
    ...
    label512:
    int k;
    if (TextUtils.equals(this.jdField_c_of_type_JavaLangString, paramxhf.jdField_a_of_type_JavaLangString))
    {
      this.jdField_e_of_type_Boolean = false;
      localObject = ((wke)wjs.a(2)).c(paramStoryVideoItem.mOwnerUid);
    ...
    for (int m = 1;; m = 0)
    {
      ...
      ykv.a("play_video", "exp_repost", 0, 0, new String[] { "", "", "", paramxhf.jdField_a_of_type_JavaLangString });
      return;
      ...
      {
        i = 1;
        ykq.d(this.jdField_b_of_type_JavaLangString, "show BottomWidget because friend and showBottomWidgetFlag=3");
        break label435;
      }
      i = 0;
      ykq.d(this.jdField_b_of_type_JavaLangString, "hide BottomWidget");
      break label435;
  ...
  {
    return (paramxhf.jdField_a_of_type_Wly == null) || (paramxhf.jdField_a_of_type_Wly.a != 13);
  }
  ...
  public boolean d()
  {
    ...
    for (;;)
    {
      ...
      xhf localxhf = this.jdField_a_of_type_Xhf;
      StoryVideoItem localStoryVideoItem = localxhf.a();
      VideoListFeedItem localVideoListFeedItem = localxhf.a();
      int i;
      boolean bool;
      if (localStoryVideoItem != null)
      {
        localObject = ((wke)localObject).b(localStoryVideoItem.mOwnerUid);
        if ((localObject == null) || (!((QQUserUIItem)localObject).isVip)) {
          break label309;
        }
        i = 1;
        if (((localObject != null) && (((QQUserUIItem)localObject).isMe())) && ((this.jdField_a_of_type_Xcy == null) || (!(this.jdField_a_of_type_Xcy instanceof xdm)))) {
          break label348;
        }
        ...
        l = ((wly)localObject).a(localStoryVideoItem.mVid);
      }
      for (;;)
      {
        ...
        for (localObject = ((MsgTabPlayInfo)((OpenPlayerBuilder.Data)localObject).mInfo).nodeUnionId;; localObject = null)
        {
          ...
          for (localObject = String.valueOf(l);; localObject = String.valueOf(ykv.a((String)localObject, localVideoListFeedItem)))
          {
            ykv.a("play_video", "dbl_like", i, j, new String[] { "", localObject, "", localxhf.jdField_a_of_type_JavaLangString });
            return true;
            localObject = null;
            break;
            i = 0;
  ...
  public void g()
  {
    ...
    if (this.jdField_a_of_type_Xep != null) {
      this.jdField_a_of_type_Xep.a();
    }
    if (this.jdField_a_of_type_Xnl != null) {
      b(this.jdField_a_of_type_Xnl);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject3 = this.jdField_a_of_type_Xhf.a();
    ...
    {
      i = 1;
      bool5 = wzk.a(localStoryVideoItem);
      bool2 = false;
      l = 0L;
      ...
      l = ((wly)localObject1).a(localStoryVideoItem.mVid);
    }
    for (;;)
    {
      label277:
      ...
      case 2131381536: 
        for (;;)
        {
          ...
          QQToast.a(wzk.a(), 1, anvx.a(2131700679), 0).a();
          break;
          i = 0;
          break label101;
          bool2 = true;
        ...
        if (this.jdField_a_of_type_Xep == null) {
          this.jdField_a_of_type_Xep = new xep();
        }
        localObject1 = anvx.a(2131700680);
        ...
        while (localQQUserUIItem == null)
        {
          ...
          if ((((OpenPlayerBuilder.Data)localObject3).mInfo instanceof MsgTabPlayInfo)) {
            bool1 = wmr.a(QQStoryContext.a()).a(((MsgTabPlayInfo)((OpenPlayerBuilder.Data)localObject3).mInfo).nodeUnionId);
          }
          localObject1 = (String)localObject1 + anvx.a(2131700677);
          this.jdField_a_of_type_Xeg = new xeg(b(), this.jdField_a_of_type_Xhf.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Xep, (String)localObject1, 4444, bool2, bool1);
          this.jdField_a_of_type_Xeg.show();
          this.jdField_a_of_type_Xeg.setOnDismissListener(new xmz(this, (VideoViewVideoHolder)localObject2));
          if (!(this.jdField_a_of_type_Xcy instanceof xdm)) {
            break label1261;
          }
          localObject1 = ((xdm)this.jdField_a_of_type_Xcy).jdField_a_of_type_Wly;
          ...
          localObject2 = "2";
          ykv.a("play_video", "input_reply", j, 0, new String[] { localObject1, localObject2, "", localStoryVideoItem.mVid });
          break;
        }
      ...
      case 2131377525: 
        for (;;)
        {
          ...
          {
            localObject1 = ((wka)wjs.a(23)).a(localQQUserUIItem, (String)localObject1, false, true);
            break label352;
          }
          ...
          {
            ykv.a("play_video", "clk_reply", j, 1, new String[] { localObject1, localObject2, "", localStoryVideoItem.mVid });
            break;
            localObject1 = "1";
            break label741;
          }
          ...
          for (;;)
          {
            if (localObject3 != null)
            {
              ...
              if (((VideoListFeedItem)localObject3).mHadLike == 1)
              {
                ...
                j = 106;
                label957:
                wgz.a((CommentLikeFeedItem)localObject3, bool4, k, j);
                i();
              ...
              {
                ykv.a("play_video", (String)localObject1, j, k, new String[] { localObject2, localObject3, String.valueOf(localStoryVideoItem.mOwnerUid), this.jdField_a_of_type_Xhf.jdField_a_of_type_JavaLangString });
                break;
                bool3 = false;
                break label907;
                label1128:
                ...
                localObject1 = "like";
                break label1039;
                j = ykv.a((String)localObject2, (VideoListFeedItem)localObject3);
                break label1048;
                localObject2 = "1";
                break label1063;
              }
