...
class bius
{
  ...
  private static bius jdField_b_of_type_Bius;
  ...
  public static bius a(int paramInt)
  {
    if (paramInt == 0)
    {
      if (jdField_a_of_type_Bius == null) {
        jdField_a_of_type_Bius = new bius(0);
      }
      return jdField_a_of_type_Bius;
    }
    if (jdField_b_of_type_Bius == null) {
      jdField_b_of_type_Bius = new bius(1);
    }
    return jdField_b_of_type_Bius;
  }
