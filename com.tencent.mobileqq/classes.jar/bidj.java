  ...
  implements Handler.Callback
{
  ...
  public Handler a;
  public View a;
  private final bidl jdField_a_of_type_Bidl;
  public boolean a;
  private boolean c;
  ...
  @TargetApi(19)
  public bidj(Window paramWindow, boolean paramBoolean)
  {
    ViewGroup localViewGroup = (ViewGroup)paramWindow.getDecorView();
    if (ImmersiveUtils.isSupporImmersive() == 1) {
      this.c = paramBoolean;
    }
    this.jdField_a_of_type_Bidl = new bidl(paramWindow, this.c, null);
    if (this.c) {
  ...
  private void a(Window paramWindow, ViewGroup paramViewGroup)
  {
    ...
    paramWindow = new FrameLayout.LayoutParams(-1, this.jdField_a_of_type_Bidl.a());
