  ...
  implements bkja, Manager
{
  ...
  private HashMap<Long, azbk> jdField_a_of_type_JavaUtilHashMap;
  ...
  public azbi(QQAppInterface paramQQAppInterface)
  {
        ...
        if ((localObject != null) && (localObject.length > 0))
        {
          ...
          for (;;)
          {
            ...
            try
            {
              ...
              if (l > 0L)
              {
                azbk localazbk = new azbk(this);
                localazbk.jdField_a_of_type_Long = this.jdField_a_of_type_AndroidContentSharedPreferences.getLong("gc_unread" + str1 + "_" + str2, 0L);
                localazbk.jdField_a_of_type_Boolean = this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean("gc_newmsg" + str1 + "_" + str2, false);
                localazbk.jdField_b_of_type_Boolean = this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean("gc_redpoint" + str1 + "_" + str2, false);
                localazbk.c = this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean("gc_tab" + str1 + "_" + str2, false);
                localazbk.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidContentSharedPreferences.getString("gc_text" + str1 + "_" + str2, "");
                localazbk.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_AndroidContentSharedPreferences.getString("gc_icon" + str1 + "_" + str2, "");
                localazbk.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidContentSharedPreferences.getInt("gc_type" + str1 + "_" + str2, -1);
                this.jdField_a_of_type_JavaUtilArrayList.add(Long.valueOf(l));
                this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), localazbk);
              }
            }
    ...
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilHashMap != null))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(Long.valueOf(l)))
        {
          ...
          {
            azbk localazbk = (azbk)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(l));
            localEditor.putLong("gc_unread" + str2 + "_" + l, localazbk.jdField_a_of_type_Long);
            localEditor.putBoolean("gc_newmsg" + str2 + "_" + l, localazbk.jdField_a_of_type_Boolean);
            localEditor.putBoolean("gc_redpoint" + str2 + "_" + l, localazbk.jdField_b_of_type_Boolean);
            localEditor.putBoolean("gc_tab" + str2 + "_" + l, localazbk.c);
            localEditor.putString("gc_text" + str2 + "_" + l, localazbk.jdField_a_of_type_JavaLangString);
            localEditor.putString("gc_icon" + str2 + "_" + l, localazbk.jdField_b_of_type_JavaLangString);
            localEditor.putInt("gc_type" + str2 + "_" + l, localazbk.jdField_a_of_type_Int);
            break;
          }
        }
      }
  ...
  public aslq a()
  {
    return this.jdField_a_of_type_Aslq;
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      if ((localBoolean == null) || (!localBoolean.booleanValue()))
      {
        ...
        jdField_a_of_type_ArrayOfByte = bdhb.a((File)localObject2);
  ...
  public void a(long paramLong1, boolean paramBoolean, long paramLong2)
  {
    ...
    {
      localObject = (azbk)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong1));
      ((azbk)localObject).jdField_a_of_type_Boolean = paramBoolean;
      ((azbk)localObject).jdField_a_of_type_Long = paramLong2;
      this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong1), localObject);
      e();
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), azbl.class);
  ...
  public void a(JSONArray paramJSONArray)
  {
    for (;;)
    {
      ...
      try
      {
        arrayOfString = aahi.a("APPOINTMENT_HAS_DOWNLOAD_LIST").split("\\|");
        i = 0;
        ...
        aahi.a("APPID_PKGNAME_" + str1, str2);
        if (!localJSONObject.optBoolean("isRes")) {
          break label287;
        }
        aahi.c(str1, "APPOINTMENT_RES_LIST");
        aahi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "426", "202238", str1, "42601", "1", "116");
      }
      ...
      if (j < arrayOfString.length)
      {
        ...
        if ((!TextUtils.isEmpty(arrayOfString[j])) && (!TextUtils.isEmpty(str1)) && (arrayOfString[j].equals(str1)))
        {
          ...
          {
            aahi.c(str1, "APPOINTMENT_LIST");
            aahi.a(str1, paramJSONArray.get(i).toString(), "APPOINT_APPID_DETAIL_");
            aahi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "426", "202238", str1, "42601", "1", "116");
          }
        }
        else
  ...
  public void a(MsgBody paramMsgBody)
  {
    ...
    do
    {
      ...
      case 1: 
        c();
        aahi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "426", "205581", "", "42601", "1", "116");
        return;
      case 2: 
        try
        {
      ...
      try
      {
        ...
        paramMsgBody = new azbj(this, i);
        if (i == 1)
        {
          aahx.a().a(paramMsgBody);
          return;
        }
      }
      catch (JSONException paramMsgBody)
      ...
      if (i == 2)
      {
        aahx.a().b(paramMsgBody);
        return;
      }
    } while (i != 3);
    aahx.a().c(paramMsgBody);
  }
  
  public boolean a(long paramLong)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(Long.valueOf(paramLong))) {
      return ((azbk)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Boolean;
    }
    return false;
  }
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      if (m < paramList.size())
      {
        ...
        do
        {
          ...
          localazbk = (azbk)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(localPluginInfo.Id));
          if (QLog.isColorLevel()) {
            QLog.d("Q.lebatab.GameCenterManagerImp", 2, "setNewUnread.i=" + m + ",before unreaddata:" + localazbk.toString());
          }
          if (localPluginInfo.Count > 0L)
          {
            j = i;
            if (localazbk.jdField_a_of_type_Long != localPluginInfo.Count)
            {
              bool2 = true;
              bool1 = bool2;
              j = i;
            ...
            localazbk.jdField_a_of_type_Long = localPluginInfo.Count;
            localazbk.jdField_a_of_type_JavaLangString = localPluginInfo.Text;
            localazbk.jdField_a_of_type_Boolean = false;
            localazbk.jdField_b_of_type_Boolean = false;
            if (TextUtils.isEmpty(localazbk.jdField_a_of_type_JavaLangString))
            {
              localazbk.jdField_a_of_type_Int = 1;
              localazbk.c = localPluginInfo.Tab;
              bool2 = bool1;
            }
          }
          do
          {
            ...
            if (QLog.isColorLevel())
            {
              QLog.d("Q.lebatab.GameCenterManagerImp", 2, "setNewUnread.i=" + m + ",unreaddata:" + localazbk.toString());
              k = j;
              bool3 = bool2;
            }
            bool1 = bool3;
            i = k;
            break;
            localazbk.jdField_a_of_type_Int = 4;
            break label296;
            if (localPluginInfo.Flag)
            {
              if (localazbk.jdField_a_of_type_Long > 0L) {
                break;
              }
              j = i;
              if (!localazbk.jdField_a_of_type_Boolean)
              {
                bool2 = true;
                bool1 = bool2;
                j = i;
              ...
              localazbk.jdField_a_of_type_Boolean = localPluginInfo.Flag;
              localazbk.jdField_b_of_type_Boolean = false;
              localazbk.jdField_a_of_type_Long = 0L;
              localazbk.jdField_a_of_type_JavaLangString = localPluginInfo.Text;
              if (TextUtils.isEmpty(localazbk.jdField_a_of_type_JavaLangString)) {}
              for (localazbk.jdField_a_of_type_Int = 3;; localazbk.jdField_a_of_type_Int = 6)
              {
                localazbk.c = localPluginInfo.Tab;
                bool2 = bool1;
                break;
        ...
        } while ((localazbk.jdField_a_of_type_Long > 0L) || ((localPluginInfo.Id == 769L) && (localazbk.jdField_a_of_type_Boolean)));
        j = i;
        ...
        localazbk.jdField_b_of_type_Boolean = localPluginInfo.RedPoint;
        localazbk.jdField_a_of_type_Boolean = false;
        localazbk.jdField_a_of_type_Long = 0L;
        localazbk.jdField_a_of_type_JavaLangString = localPluginInfo.Text;
        localazbk.jdField_b_of_type_JavaLangString = localPluginInfo.PicUrl;
        if (TextUtils.isEmpty(localazbk.jdField_a_of_type_JavaLangString)) {
          if (TextUtils.isEmpty(localazbk.jdField_b_of_type_JavaLangString)) {
            localazbk.jdField_a_of_type_Int = 2;
          }
        }
        for (;;)
        {
          ...
          bool2 = bool1;
          break;
          localazbk.jdField_a_of_type_Int = 7;
          continue;
          localazbk.jdField_a_of_type_Int = 5;
        }
      }
      e();
      if (QLog.isColorLevel()) {
      ...
      if (i != -1)
      {
        paramList = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), azbl.class);
  ...
  {
    bkjb.a().a();
    aahi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "426", "202238", "", "42601", "1", "116");
  }
  ...
  public void onCmdRsp(Intent paramIntent, String paramString, long paramLong, JSONObject paramJSONObject)
  {
    ...
    while ((!"12942".equals(paramString)) || (paramLong != 0L) || (paramJSONObject == null)) {
      try
      {
        ...
        aahi.a("APPOINTMENT_LOAD_GAP", paramLong);
        aahi.a(paramJSONObject.optLong("res_valid") * 1000L);
        if (QLog.isColorLevel()) {
        ...
        if ((!TextUtils.isEmpty(aahi.a("APPOINTMENT_LIST"))) || (!TextUtils.isEmpty(aahi.a("APPOINTMENT_CHECKLIST"))) || (!TextUtils.isEmpty(aahi.a("DELAY_LIST"))) || (!TextUtils.isEmpty(aahi.a("APPOINTMENT_RES_LIST")))) {
          aahe.a();
        }
        GameCenterCheck.b();
        GameCenterCheck.c();
    ...
    for (;;)
    {
      try
      {
        ...
        if (i < paramIntent.length())
        {
          ...
          if (!aahi.e(paramJSONObject.optString("appid"), paramJSONObject.optString("resName")))
          {
            aahi.a(paramJSONObject.toString(), false, 1);
