  ...
  extends ayfb
{
  ...
  public void a(TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    if ((paramTeamWorkFileImportInfo != null) && ((paramTeamWorkFileImportInfo.a()) || ((paramTeamWorkFileImportInfo.b()) && (paramTeamWorkFileImportInfo.g == 0))))
    {
      ...
      if (paramTeamWorkFileImportInfo.b()) {
        axqw.b(null, "dc00898", "", "", "0X800A627", "0X800A627", 1, 0, "", "", "", "");
      }
      if (TextUtils.isEmpty(paramTeamWorkFileImportInfo.h)) {
        break label136;
      }
      bcpw.a(localQQAppInterface.getApp(), 1, paramTeamWorkFileImportInfo.h, 0).a();
    }
    for (;;)
    {
      if ((paramTeamWorkFileImportInfo != null) && (paramTeamWorkFileImportInfo.c())) {
        ayhk.a(null, "0X800ABAD");
      }
      return;
      label136:
      bcpw.a(localQQAppInterface.getApp(), 1, 2131720242, 0).a();
    }
  }
  ...
  public void a(String paramString, TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    if ((paramTeamWorkFileImportInfo != null) && (paramTeamWorkFileImportInfo.c()))
    {
      if (paramTeamWorkFileImportInfo.l == 2)
      {
        ...
        ayhk.a(null, "0X800ABA7");
        if ((!bool) && (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Apwy != null)) {
          this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Apwy.a(1, paramString, bool);
        }
        if ((appk.a(this.a)) && (bool)) {
          appk.a(this.a, true);
        }
        if (!bool)
        {
          if (((paramTeamWorkFileImportInfo.jdField_a_of_type_Int != 1) && (paramTeamWorkFileImportInfo.jdField_a_of_type_Int != 0) && (paramTeamWorkFileImportInfo.jdField_a_of_type_Int != 3000)) || (paramTeamWorkFileImportInfo.jdField_a_of_type_JavaLangString == this.a.jdField_a_of_type_Apmx.h())) {
            break label452;
          }
          i = 1;
          label147:
    ...
    else
    {
      ...
      i = 1;
      label249:
      if ((i == 0) || (!paramTeamWorkFileImportInfo.b()) || (paramTeamWorkFileImportInfo.g != 0) || (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer == null) || (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Apxa == null)) {
        break label462;
      }
      long l = ayhk.a(paramTeamWorkFileImportInfo.k + "-" + paramTeamWorkFileImportInfo.d);
      if (l > 0L) {
        axqw.b(null, "dc00898", "", "", "0X800A62E", "0X800A62E", 0, 0, "", "", String.valueOf(l), "");
      }
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.e();
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Apxa.a(paramString, paramTeamWorkFileImportInfo, true, this.a.jdField_a_of_type_Apmx.h());
  ...
  public void a(String paramString1, String paramString2, TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    {
      localQQAppInterface = (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime();
      ancc localancc = ancg.a();
      ThreadManager.getFileThreadHandler().post(new SimpleFilePresenter.1.2(this, localancc, paramTeamWorkFileImportInfo, paramString2, localQQAppInterface, paramString1));
    }
  ...
  public void b(TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    {
      String str = this.a.jdField_a_of_type_AndroidAppActivity.getString(2131698467);
      if (paramTeamWorkFileImportInfo.b()) {
        str = ajyc.a(2131714161);
      }
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.h(str);
      ayhk.a(null, "0X800A21E");
    }
  }
  ...
  public void c(TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    if ((paramTeamWorkFileImportInfo != null) && (paramTeamWorkFileImportInfo.b())) {
      if (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer != null)
      {
        ...
        appk.a(this.a, true, paramTeamWorkFileImportInfo.jdField_a_of_type_Int);
      }
    }
    ...
    if (this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Apwy == null)
    {
    ...
    this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.jdField_a_of_type_Apwy.a();
  }
}
