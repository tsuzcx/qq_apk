...
public class beyo
{
  private static final beyo jdField_a_of_type_Beyo = new beyo();
  ...
  public static beyo a()
  {
    return jdField_a_of_type_Beyo;
  }
  
  private void a(byte[] paramArrayOfByte, List<APP_REPORT_TRANSFER.SingleDcData> paramList)
  {
    if ((paramArrayOfByte != null) && (paramArrayOfByte.length > 0)) {
      ((ChannelProxy)ProxyManager.get(ChannelProxy.class)).dataReport(paramArrayOfByte, new beyq(this, paramList));
    }
  }
  ...
  {
    if ((paramArrayOfByte != null) && (paramArrayOfByte.length > 0)) {
      ((ChannelProxy)ProxyManager.get(ChannelProxy.class)).report(paramArrayOfByte, paramString1, paramString2, new beyp(this, paramList));
    }
  }
  ...
  private static String b(REPORT.SingleDcData paramSingleDcData)
  {
    ...
    if (paramSingleDcData != null) {
      localStringBuilder.append(bfga.a(paramSingleDcData));
    }
  ...
  private void d()
  {
    if (!this.d.isEmpty())
    {
      ...
      this.d.clear();
      byte[] arrayOfByte = beyn.a(localArrayList).toByteArray();
  ...
  private void f()
  {
    ...
    if (!this.jdField_b_of_type_JavaUtilList.isEmpty())
    {
      ...
      localObject2 = beyn.a(localArrayList);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        besl.d("MiniProgramReporter", "performReportLaunchDcDataToServer", localException);
      }
      ...
      besl.a("MiniProgramReporter", "performReportLaunchDcDataToServer: split into " + i + " count");
      j = 0;
      i = k;
    }
    ...
    for (;;)
    {
      ...
      while (i <= localArrayList.size())
      {
        if ((j < i) && (j >= 0) && (i <= localArrayList.size()))
        {
          ...
          APP_REPORT_TRANSFER.StDataReportReq localStDataReportReq = beyn.a((List)localObject1);
  ...
  private void g()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        besl.d("MiniProgramReporter", "performReportToServer", localException);
      }
      if (localObject1.length > 262144) {
        break label108;
      }
      ...
      i = localObject1.length / 262144 + 1;
      k = localArrayList.size() / i;
      besl.a("MiniProgramReporter", "performReportToServer: split into " + i + " count");
      j = 0;
      i = k;
    }
    if (localObject1 == null) {}
    for (;;)
    {
      ...
      while (i <= localArrayList.size())
      {
        ...
        {
          localObject1 = localArrayList.subList(j, i);
          REPORT.StDcReportReq localStDcReportReq = beyn.a((List)localObject1);
  ...
  public void a()
  {
    ...
    try
    {
      j = belj.a("MiniApp", "mini_app_report_time_threshold", 10);
      i = j;
      int m = belj.a("MiniApp", "mini_app_report_count_threshold", 64);
      i = m;
      k = j;
      j = i;
    }
