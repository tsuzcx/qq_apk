  ...
  extends alyc
{
  ...
  public alxy(Context paramContext, int paramInt, SensorManager paramSensorManager, alxu paramalxu)
  {
    super(paramContext, paramInt, paramSensorManager, paramalxu);
    paramContext = paramSensorManager.getDefaultSensor(4);
    paramalxu = paramSensorManager.getDefaultSensor(1);
    paramSensorManager = paramSensorManager.getDefaultSensor(2);
    if ((paramContext != null) && (paramalxu != null) && (paramSensorManager != null))
    {
      this.jdField_a_of_type_JavaUtilList.add(paramContext);
      this.jdField_a_of_type_JavaUtilList.add(paramalxu);
  ...
  private void a(SensorEvent paramSensorEvent)
  {
    ...
    if (!this.jdField_c_of_type_Boolean)
    {
      ...
      arrayOfFloat = alxw.a(this.k);
      SensorManager.getOrientation(arrayOfFloat, new float[3]);
      this.l = alxw.a(this.l, arrayOfFloat);
    ...
    if ((this.jdField_a_of_type_Float != 0.0F) && (this.jdField_c_of_type_Boolean))
    {
      ...
      arrayOfFloat = new float[9];
      alxw.c(arrayOfFloat, this.jdField_d_of_type_ArrayOfFloat);
      this.l = alxw.a(this.l, arrayOfFloat);
      SensorManager.getOrientation(this.l, this.e);
      e();
      if ((this.jdField_a_of_type_Int == 1) && (this.jdField_a_of_type_Alxu != null)) {
  ...
  private void b(float paramFloat1, float paramFloat2, float paramFloat3, long paramLong)
  {
    ...
    this.jdField_a_of_type_Alxu.updateGyroscope(paramFloat1, paramFloat2, paramFloat3, paramLong);
  }
  ...
  private void e()
  {
    ...
    for (;;)
    {
      this.l = alxw.a(this.f);
      alxw.a(this.l, this.m);
