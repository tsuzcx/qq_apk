...
public class alxy
  implements alpe, alqx, Handler.Callback, View.OnKeyListener
{
  public int a;
  public long a;
  private acju jdField_a_of_type_Acju;
  private alug jdField_a_of_type_Alug;
  private alwa jdField_a_of_type_Alwa;
  private alwp jdField_a_of_type_Alwp;
  private alwt jdField_a_of_type_Alwt;
  private alxf jdField_a_of_type_Alxf;
  private alxh jdField_a_of_type_Alxh;
  private alxu jdField_a_of_type_Alxu;
  private alyc jdField_a_of_type_Alyc;
  private alyl jdField_a_of_type_Alyl;
  private alym jdField_a_of_type_Alym;
  private alyq jdField_a_of_type_Alyq;
  private alyy jdField_a_of_type_Alyy;
  private alzr jdField_a_of_type_Alzr;
  private amjj jdField_a_of_type_Amjj;
  private amkm jdField_a_of_type_Amkm = new alyb(this);
  private ammz jdField_a_of_type_Ammz;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new alxz(this);
  ...
  private alwp jdField_b_of_type_Alwp;
  ...
  public alxy(int paramInt)
  {
    ...
    if (localalyh != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel = localalyh.a();
    ...
    this.jdField_a_of_type_Alym = new alym(paramInt);
    this.jdField_e_of_type_Int = paramInt;
    alyr.a();
    this.jdField_a_of_type_Alyy = new alyy(paramInt);
    this.jdField_a_of_type_Alwa = new alwa(paramInt);
  }
  ...
  private void c(CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Alyc = new alyc();
      this.jdField_a_of_type_Alyc.g = localJSONObject.optString("payParam");
      ...
      this.jdField_a_of_type_Alyc.jdField_a_of_type_Int = localJSONObject.optInt("score", -1);
      this.jdField_a_of_type_Alyc.jdField_c_of_type_JavaLangString = localJSONObject.optString("baseUrl");
      this.jdField_a_of_type_Alyc.b = localJSONObject.optString("listId");
      this.jdField_a_of_type_Alyc.jdField_c_of_type_Int = this.jdField_e_of_type_Int;
      if (alvx.a() != null) {
        this.jdField_a_of_type_Alyc.jdField_a_of_type_Long = Long.parseLong(alvx.a().getCurrentAccountUin());
      }
      this.jdField_a_of_type_Alyc.e = localJSONObject.optString("nickName", String.valueOf(this.jdField_a_of_type_Alyc.jdField_a_of_type_Long));
      if (QLog.isColorLevel()) {
        QLog.d("cmgame_process.CmGameLauncher", 1, "[setRedPacketInfo] " + this.jdField_a_of_type_Alyc.toString());
      }
      return;
    }
  ...
  private void n()
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      alvx.a(new Object[] { "[startGameEngine], game is not ready, so status:", Boolean.valueOf(this.k) });
    }
    for (;;)
    {
      return;
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
      {
        ...
        this.i = true;
        this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "sc.init_global_var.local", alvx.b(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams));
      ...
      {
        if (b()) {
          alvx.a().callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "cs.xy_life_cycle_event_activity.local", "{}");
        }
        for (;;)
        {
          o();
          ...
          alvx.a(new Object[] { "[startGameEngine] cost:", Long.valueOf(l) });
          if (l <= 0L) {
            break;
          }
          ...
          return;
          label516:
          localObject1 = String.valueOf(altz.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.extendJson));
          break label241;
          alvx.a().callbackFromRequest(a(), 0, "cs.xy_life_cycle_event_activity.local", "{}");
        }
      }
  ...
  public acju a(long paramLong, Activity paramActivity)
  {
    if (this.jdField_a_of_type_Acju != null) {
      return this.jdField_a_of_type_Acju;
    }
    acjz.a();
    this.jdField_a_of_type_Acju = acjz.a(paramActivity, 5, String.valueOf(paramLong));
  ...
  public alwa a()
  {
    return this.jdField_a_of_type_Alwa;
  }
  ...
  public alyc a()
  {
    return this.jdField_a_of_type_Alyc;
  }
  
  public alym a()
  {
    return this.jdField_a_of_type_Alym;
  }
  
  public alyq a()
  {
    if ((this.jdField_a_of_type_Alyq == null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams != null)) {
      this.jdField_a_of_type_Alyq = new alyq(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView, this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams, (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    }
  ...
  public alyy a()
  {
    return this.jdField_a_of_type_Alyy;
  }
  ...
  public ammz a()
  {
    return this.jdField_a_of_type_Ammz;
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null))
        {
          ...
          localObject = new alyt();
          ((alyt)localObject).jdField_e_of_type_Int = paramInt1;
          ((alyt)localObject).jdField_a_of_type_Long = System.currentTimeMillis();
          ((alyt)localObject).jdField_a_of_type_Int = this.jdField_e_of_type_Int;
          ((alyt)localObject).d = paramInt2;
          ((alyt)localObject).jdField_c_of_type_Int = paramInt3;
          ((alyt)localObject).jdField_a_of_type_JavaLangString = paramString;
          ((alyt)localObject).jdField_b_of_type_Int = this.jdField_b_of_type_Int;
          if (QLog.isColorLevel()) {
          ...
          alyr.a().a((alyt)localObject);
        }
        if ((this.jdField_a_of_type_Alxu == null) || (!this.jdField_a_of_type_Alxu.a())) {
          break label430;
        }
        paramInt3 = 1;
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localApolloFloatActivity.a != null)
        {
          ...
          paramString = "window.mqq && mqq.execEventCallback && mqq.execEventCallback(" + npn.a("apolloGameWebMessage") + "," + String.valueOf(paramString) + "," + String.valueOf("") + ");";
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    if (this.jdField_a_of_type_Alug != null) {
      this.jdField_a_of_type_Alug.a(paramInt, paramString1, paramString2);
    }
  }
  ...
  public void a(alug paramalug)
  {
    this.jdField_a_of_type_Alug = paramalug;
    this.jdField_g_of_type_Int = 2;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel != null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addRenderRunner(paramalug);
    }
  }
  
  public void a(alzx paramalzx)
  {
    if (paramalzx == null) {}
    amad localamad;
    do
    {
      return;
      localamad = a();
    } while (localamad == null);
    localamad.a(paramalzx);
  }
  
  public void a(Activity paramActivity)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
    if (this.jdField_a_of_type_Alyy != null) {
      this.jdField_a_of_type_Alyy.a(paramActivity);
    }
    this.jdField_a_of_type_Alxu = new alxu(a(), alvx.a());
    this.jdField_a_of_type_Alxu.a(null, this.jdField_e_of_type_Int);
  }
  ...
  public void a(Activity paramActivity, CmGameInitParams paramCmGameInitParams)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
      this.jdField_a_of_type_Bjng.sendEmptyMessage(204);
  ...
  public void a(Activity paramActivity, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        if (!amkk.a())
        {
          ...
          amkk.a(this.jdField_a_of_type_Amkm);
          amkk.a("CmGameLauncher");
          return;
        }
        amkk.b(this.jdField_a_of_type_Amkm);
        a(paramActivity);
        a(paramActivity);
        this.jdField_a_of_type_Amjj = new amjj(this.jdField_e_of_type_Int);
        if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
          break label562;
        }
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {
      ...
      if (this.jdField_a_of_type_Alzr == null) {
        this.jdField_a_of_type_Alzr = new alzr((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_e_of_type_Int);
      }
    ...
    {
      QLog.e("cmgame_process.CmGameLauncher", 1, localThrowable, new Object[0]);
      bool2 = alvx.a(this.jdField_e_of_type_Int);
      if (!bool2) {}
    }
    label562:
    label755:
      ...
      for (;;)
      {
        try
        {
          if ((paramActivity instanceof ApolloGameActivity))
          {
            ...
            if (this.jdField_a_of_type_Alxh != null) {
              this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Alxh);
            }
            if (this.jdField_a_of_type_Alwt != null) {
              this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Alwt);
            }
            this.jdField_a_of_type_Alxh = new alxh(this.jdField_e_of_type_Int, paramActivity);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Alxh);
            this.jdField_a_of_type_Alwt = new alwt(this.jdField_e_of_type_Int);
            this.jdField_a_of_type_Alxf = new alxf(this);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Alwt);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Alxf);
  ...
  public void a(Bitmap paramBitmap)
  {
    if (this.jdField_a_of_type_Alxu != null) {
      this.jdField_a_of_type_Alxu.a(paramBitmap, this.jdField_e_of_type_Int);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        b(paramBundle);
        alvx.a(new Object[] { "[checkFinish], loading from main process and tool process is on, before cost:", Long.valueOf(l1) });
  ...
  {
    if (this.jdField_a_of_type_Alwp == null)
    {
      if (paramInt != 0) {
        break label52;
      }
      this.jdField_a_of_type_Alwp = new alwb(alvx.a(), this.jdField_e_of_type_Int);
    }
    for (;;)
    {
      if (this.jdField_b_of_type_Alwp == null) {
        this.jdField_b_of_type_Alwp = new alwe(this.jdField_a_of_type_Alxf);
      }
      return;
      label52:
      if (1 == paramInt) {
        this.jdField_a_of_type_Alwp = new alwm(this.jdField_e_of_type_Int);
      }
    }
  }
  ...
  public void b(Activity paramActivity, CmGameInitParams paramCmGameInitParams)
  {
    ...
    for (;;)
    {
      ...
      break label152;
      label230:
      str = String.valueOf(altz.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.extendJson));
      break label164;
  ...
  public void b(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      this.jdField_a_of_type_Bjng.removeMessages(203);
      Message localMessage = this.jdField_a_of_type_Bjng.obtainMessage(203);
      localMessage.obj = paramString;
      this.jdField_a_of_type_Bjng.sendMessageDelayed(localMessage, 1000L);
  ...
  public void d()
  {
    ...
    {
      if (this.jdField_a_of_type_Alwp != null) {
        this.jdField_a_of_type_Alwp.b();
      }
      if (this.jdField_b_of_type_Alwp != null) {
        this.jdField_b_of_type_Alwp.b();
      }
  ...
  {
    this.jdField_a_of_type_Bjng.removeMessages(203);
    if (((!this.jdField_b_of_type_Boolean) || ((!TextUtils.isEmpty(paramString)) && (paramString.contains("inner")))) && (this.jdField_a_of_type_Alxu != null))
    {
      boolean bool = this.jdField_e_of_type_Boolean;
      this.jdField_a_of_type_Bjng.post(new CmGameLauncher.9(this, paramString, bool));
    }
  ...
  {
    if (this.jdField_a_of_type_Alwt != null) {
      this.jdField_a_of_type_Alwt.b();
    }
    if (this.jdField_a_of_type_Alwp != null) {
      this.jdField_a_of_type_Alwp.a();
    }
    if (this.jdField_b_of_type_Alwp != null) {
      this.jdField_b_of_type_Alwp.a();
    }
    ApolloCmdChannel localApolloCmdChannel = alvx.a();
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Alwp != null) {
      this.jdField_a_of_type_Alwp.c();
    }
    if (this.jdField_b_of_type_Alwp != null) {
      this.jdField_b_of_type_Alwp.c();
    }
    ...
    for (;;)
    {
      ...
      this.i = false;
      this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams = null;
      if (this.jdField_a_of_type_Alyl != null) {}
      try
      {
        AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Alyl);
        if (this.jdField_a_of_type_Amjj != null) {
        ...
        if (this.jdField_a_of_type_Alzr != null) {
          this.jdField_a_of_type_Alzr.a();
        }
        if (this.jdField_a_of_type_Alwa != null) {
          this.jdField_a_of_type_Alwa.a();
        }
        if (QLog.isColorLevel()) {
          QLog.d("cmgame_process.CmGameLauncher", 2, "onDestroy");
        }
        return;
        this.jdField_a_of_type_Bjng.obtainMessage(202).sendToTarget();
        if (!QLog.isColorLevel()) {
          continue;
        }
  ...
  public void g()
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        {
          if (this.jdField_a_of_type_Alug != null) {
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeRenderRunner(this.jdField_a_of_type_Alug);
          }
          if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
          ...
          if (this.jdField_a_of_type_Alwt != null) {
            this.jdField_a_of_type_Alwt.d();
          }
          if (this.jdField_a_of_type_Alxf != null)
          {
            this.jdField_a_of_type_Alxf.a();
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Alxf);
          }
        }
        return;
        label231:
  ...
  public void h()
  {
    ...
    {
      if (this.jdField_a_of_type_Alwt != null) {
        this.jdField_a_of_type_Alwt.a(false);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
      {
    ...
    alxn.a("cs.make_room_min.local", "{}", false, null, this.jdField_e_of_type_Int);
    if ((alvx.a() != null) && (this.jdField_a_of_type_JavaLangRefWeakReference != null)) {
      alvx.a(this.jdField_e_of_type_Int, (Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    }
    if (QLog.isColorLevel()) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      if ((this.jdField_a_of_type_Alxu == null) || (!this.jdField_a_of_type_Alxu.a(this.jdField_e_of_type_Int))) {
        break label271;
      }
      this.jdField_a_of_type_Alxu.a((String)paramMessage.obj, this.jdField_e_of_type_Int, this.jdField_e_of_type_Boolean);
    ...
    for (;;)
    {
      ...
      return false;
      label271:
      amja.a(this.jdField_e_of_type_Int, (String)paramMessage.obj, a());
    }
  }
  ...
  public void i()
  {
    ...
    alxn.a("cs.close_room.local", "{}", false, null, this.jdField_e_of_type_Int);
  }
  ...
  public void j()
  {
    ...
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_query_check_game_data", localBundle, new alya(this));
  }
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      {
        this.jdField_a_of_type_Bjng.sendEmptyMessage(200);
        this.jdField_f_of_type_Boolean = false;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.mIsGameReady = true;
      }
      this.jdField_a_of_type_Alyl = new alyl(this.jdField_e_of_type_Int);
      AppNetConnInfo.registerConnectionChangeReceiver(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Alyl);
    }
  }
}
