  ...
  implements ViewPager.OnPageChangeListener
{
  ...
  public mmp(EffectCycleViewPager paramEffectCycleViewPager, ViewPager.OnPageChangeListener paramOnPageChangeListener, int paramInt)
  {
  ...
  public void onPageScrollStateChanged(int paramInt)
  {
    if (paramInt == 0)
    {
      ...
      lbc.c("EffectCycleViewPager", "onPageScrollStateChanged 00:1");
    ...
    for (;;)
    {
      ...
      {
        lbc.c("EffectCycleViewPager", "onPageScrollStateChanged 11:" + (this.jdField_a_of_type_ComTencentAvUiFunchatFilterEffectCycleViewPager.a.getCount() - 2));
