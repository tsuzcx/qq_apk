...
public class aimq
{
  ...
  public static int a(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      return 11;
    } while (aoqm.a(paramMessageRecord));
    return 7;
  }
      ...
      do
      {
        do
        {
          ...
          if (paramMessageRecord.msgtype == -2005) {
            return auea.a(paramQQAppInterface, paramMessageRecord);
          }
  ...
  private static int b(MessageRecord paramMessageRecord)
  {
    ...
    {
      if (auea.a(((MessageForFile)paramMessageRecord).fileName) != 0) {}
    }
    else {
      do
      {
    ...
    while ((!(paramMessageRecord instanceof MessageForTroopFile)) || (auea.a(((MessageForTroopFile)paramMessageRecord).fileName) != 0)) {
      return 5;
    }
    return 2;
  }
