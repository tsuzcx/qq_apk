...
public class aytf
  extends ayti
  implements Handler.Callback, View.OnClickListener, ayou, aypm, aypn, aypq
{
  public int a;
  ...
  public aytf(@NonNull BaseActivity paramBaseActivity, ayos paramayos)
  {
  ...
  private void c()
  {
    ...
    this.jdField_d_of_type_AndroidViewView = this.jdField_c_of_type_AndroidViewView.findViewById(2131365023);
    this.jdField_d_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_c_of_type_AndroidViewView.findViewById(2131363916));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_c_of_type_AndroidViewView.findViewById(2131363741));
    this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_c_of_type_AndroidViewView.findViewById(2131364055));
    this.jdField_a_of_type_AndroidWidgetButton.setTag(Integer.valueOf(2));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_c_of_type_AndroidViewView.findViewById(2131379715));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_c_of_type_AndroidViewView.findViewById(2131367206));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_c_of_type_AndroidViewView.findViewById(2131377126));
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_c_of_type_AndroidViewView.findViewById(2131371952));
  ...
  private void f()
  {
    ...
    for (int j = 32;; j = 86)
    {
      j = afur.a(j, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
  ...
  {
    Object localObject = (aqqh)aqlk.a().a(652);
    ArrayList localArrayList = new ArrayList();
    if ((localObject == null) || (((aqqh)localObject).a == null)) {
      return localArrayList;
    }
    localObject = ((aqqh)localObject).a.a(false).iterator();
    while (((Iterator)localObject).hasNext()) {
      localArrayList.add((aysb)((Iterator)localObject).next());
    }
    return localArrayList;
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Long = ayox.a().a(localQQAppInterface);
    f();
  }
  ...
  public void a(aypi paramaypi1, aypi paramaypi2, View paramView)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AutoStatusSelectView", 2, new Object[] { "oldItem =", paramaypi1, " oldItem=", paramaypi2 });
    }
    int i;
    if ((paramaypi1 == null) && (paramaypi2 != null))
    {
      i = 1;
      if (i != 0) {
        break label106;
    ...
    for (;;)
    {
      b(false);
      if (i != 0) {
        aypy.a("0X800AF3F", (int)paramaypi2.jdField_a_of_type_Long, String.valueOf(this.jdField_a_of_type_Int));
      }
      return;
      i = 0;
      break;
      label106:
      this.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
      if ((paramaypi2 instanceof aysb)) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(((aysb)paramaypi2).c);
      }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (!aypi.a(this.jdField_a_of_type_MqqAppAppRuntime$Status, this.jdField_a_of_type_Long))
    {
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setText(2131692850);
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
    this.jdField_a_of_type_AndroidWidgetButton.setTag(Integer.valueOf(2));
  }
  ...
  protected void a(int[] paramArrayOfInt)
  {
    ...
    paramArrayOfInt[0] = (this.jdField_b_of_type_AndroidViewView.getResources().getDisplayMetrics().widthPixels - afur.a(26.0F, this.jdField_b_of_type_AndroidViewView.getResources()));
    paramArrayOfInt[1] = afur.a(480.0F, this.jdField_b_of_type_AndroidViewView.getResources());
  }
  ...
  protected boolean a()
  {
    ...
    {
      OnlineStatusFriendsPermissionItem localOnlineStatusFriendsPermissionItem = ((aypo)((QQAppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null)).getManager(370)).a(40001L, false, this);
  ...
  protected boolean a(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusPermissionChecker$OnlineStatusPermissionItem != null) && (localaypo.a(this.jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusPermissionChecker$OnlineStatusPermissionItem, this))) {
      return true;
    }
    if (paramBoolean) {
      return false;
  ...
  public ArrayList<aypi> b()
  {
    ...
    Object localObject = ((aypo)((QQAppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null)).getManager(370)).a();
    if ((localObject != null) && (((List)localObject).size() > 0))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (localaypi.jdField_a_of_type_Long == localInteger.intValue()) {
            localArrayList1.add(localaypi);
          }
        }
      }
    }
  ...
  protected void b(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(new bdnt(str1, 3, 16));
      ...
      this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(new aytg(this, paramBoolean1));
      ...
      while (AppSetting.c)
      {
        this.jdField_b_of_type_AndroidWidgetTextView.setAccessibilityDelegate(new ayth(this));
        return;
  ...
  protected boolean b()
  {
    List localList = ((aypo)((QQAppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null)).getManager(370)).a();
    if (localList == null) {
      return true;
    }
  ...
  public ArrayList<Integer> c()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localArrayList.add(Integer.valueOf((int)((aypi)((Iterator)localObject).next()).jdField_a_of_type_Long));
    }
    return localArrayList;
  }
  ...
  public void show()
  {
    ...
    {
      this.jdField_d_of_type_AndroidViewView.setBackgroundResource(2130846139);
    ...
    for (;;)
    {
      ...
      a(this.jdField_a_of_type_AndroidWidgetTextView, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, 2131165612, 2131167251);
      super.show();
      b(true);
      return;
      this.jdField_d_of_type_AndroidViewView.setBackgroundResource(2130846138);
      ayot localayot = new ayot();
      localayot.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity;
      this.jdField_a_of_type_Ayos.a(localayot, this);
    }
  }
}
