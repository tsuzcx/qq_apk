  ...
  implements View.OnClickListener
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = afpc.class.getSimpleName();
  }
  
  public afpc(BaseActivity paramBaseActivity, int paramInt, View paramView)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramBaseActivity);
    this.jdField_a_of_type_Int = paramInt;
    paramBaseActivity = paramView.findViewById(2131375701);
    IphoneTitleBarActivity.setLayerType(paramBaseActivity);
    paramView = paramBaseActivity.findViewById(2131363480);
    if (paramView != null) {
      paramView.setVisibility(8);
    }
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)paramBaseActivity.findViewById(2131365764));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramBaseActivity.findViewById(2131378334));
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(awil.b());
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      awso.a(null, i, 0, "0X8009D15", 0, 0, null, null);
