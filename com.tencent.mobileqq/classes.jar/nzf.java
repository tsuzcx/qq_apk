...
import com.tencent.biz.pubaccount.readinjoy.ad.manager.GiftPackageManager.1;
...
public class nzf
{
  ...
  public static Pair<List<GiftServiceBean>, List<GiftServiceBean>> a(String paramString)
  {
    ...
    {
      paramString = "http://ag.qq.com/community/ajax/getAmsAreaInfo?gameId=" + paramString;
      localObject1 = new Bundle();
      naj.a((Bundle)localObject1);
    }
    for (;;)
    {
      int i;
      try
      {
        paramString = naj.a(BaseApplicationImpl.getContext(), paramString, "GET", null, (Bundle)localObject1);
        if (paramString != null)
        {
  ...
  public static Pair<Boolean, String> a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    bool3 = false;
    boolean bool4 = false;
    StringBuilder localStringBuilder = new StringBuilder("http://iyouxi3.vip.qq.com/ams3.0.php?_c=page");
    ...
    paramString1 = onh.a();
    paramString1 = ((TicketManager)((QQAppInterface)onh.a()).getManager(2)).getSkey(paramString1);
    ...
    for (paramString1 = "";; paramString1 = a(paramString1))
    {
      ...
      try
      {
        paramString1 = naj.a(BaseApplicationImpl.getContext(), localStringBuilder.toString(), "GET", null, paramString1);
        if (paramString1 == null) {
          break;
        }
        bool2 = bool5;
  ...
  public static List<GiftServiceBean> a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder("http://iyouxi3.vip.qq.com/ams3.0.php?_c=queryRoleInfoByGameId");
    if (!TextUtils.isEmpty(paramString1)) {
      localStringBuilder.append("&gameId=").append(paramString1);
    }
    if (!TextUtils.isEmpty(paramString2)) {
        ...
        if (paramString1 != null)
        {
          ...
          while (i < paramString1.length())
          {
            ...
            if ((!TextUtils.isEmpty(paramString3.ck)) && (TextUtils.isEmpty(paramString3.t))) {
              paramString3.t = ajya.a(2131705279);
            }
  ...
  public static JSONObject a(int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localJSONObject.put("net_type", String.valueOf(njl.a()));
    localJSONObject.put("plat_id", 1);
    localJSONObject.put("imei", oaf.a());
    if (!TextUtils.isEmpty(onh.a())) {
      localJSONObject.put("uin", Long.valueOf(onh.a()));
    }
