...
public class ohl
{
  ...
  public String a()
  {
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_OrgJsonJSONObject.put("source", onk.d());
  ...
  public ohl a(String paramString)
  {
    try
    {
