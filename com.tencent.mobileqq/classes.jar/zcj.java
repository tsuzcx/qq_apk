  ...
  implements zcg
{
  ...
  private zci jdField_a_of_type_Zci;
  private int jdField_b_of_type_Int;
  private long jdField_b_of_type_Long = -2147483648L;
  
  public zcj(zci paramzci)
  {
  ...
  private String a(String paramString)
  {
    ...
    for (Activity localActivity = this.jdField_a_of_type_Zci.a();; localActivity = null)
    {
      String str1 = str2;
  ...
  private void a(GdtAd paramGdtAd)
  {
    ...
    localyxx.jdField_a_of_type_ComTencentGdtadAditemGdtAd = paramGdtAd;
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(2);
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localyxx);
  }
  ...
  private void b(GdtAd paramGdtAd)
  {
    ...
    yxx localyxx = new yxx();
    localyxx.jdField_a_of_type_ComTencentGdtadAditemGdtAd = paramGdtAd;
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(1);
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localyxx);
  }
  ...
  private void c(GdtAd paramGdtAd)
  {
    ...
    yxx localyxx = new yxx();
    localyxx.jdField_a_of_type_ComTencentGdtadAditemGdtAd = paramGdtAd;
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(5);
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localyxx);
  }
  ...
  private void d(GdtAd paramGdtAd)
  {
    ...
    yxx localyxx = new yxx();
    localyxx.jdField_a_of_type_ComTencentGdtadAditemGdtAd = paramGdtAd;
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(6);
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localyxx);
  }
  ...
  private void f(GdtAd paramGdtAd)
  {
    ...
    yxx localyxx = new yxx();
    localyxx.jdField_a_of_type_ComTencentGdtadAditemGdtAd = paramGdtAd;
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(3);
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localyxx.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localyxx);
  }
