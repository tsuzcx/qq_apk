...
public abstract class bpbj<PACKAGE extends bpaw>
  extends BaseAdapter
{
  public int a;
  protected Context a;
  ...
  public bpbj(Context paramContext, FaceListPage paramFaceListPage)
  {
  ...
  {
    this.jdField_a_of_type_Bpaw = paramPACKAGE;
  }
  ...
  public int getCount()
  {
    ...
    int i = this.jdField_a_of_type_Bpaw.b();
    int j = this.jdField_a_of_type_Bpaw.a();
    if (j < 1) {
