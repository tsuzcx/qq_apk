...
public class auru
{
  ...
  public void a()
  {
    ...
    if (i < localObject4.length)
    {
      ...
      for (;;)
      {
        ...
        if (((Iterator)localObject5).hasNext())
        {
          ...
          bool1 = aurz.a(((PrecoverResource)localObject6).businessId, ((PrecoverResource)localObject6).md5);
          if (QLog.isColorLevel()) {
    ...
    {
      bool1 = true;
      j = aurz.a(this.a.a().getApp(), this.a.a().getCurrentAccountUin());
    ...
    label386:
    axrl.a(BaseApplicationImpl.getContext()).a(this.a.a().getCurrentAccountUin(), "precover_res_cover", bool1, 0L, 0L, (HashMap)localObject5, "", false);
    localObject4 = this.a.a();
    if (bool1)
    {
      localObject1 = "1";
      axqw.b((QQAppInterface)localObject4, "CliOper", "", "", "0X8007134", "0X8007134", 0, 0, String.valueOf(j), (String)localObject1, "id_all", "");
    ...
    {
      axqw.b((QQAppInterface)localObject5, "CliOper", "", "", "0X8007134", "0X8007134", 0, 0, String.valueOf(j), (String)localObject1, "id_" + (String)localObject4, "");
      break label471;
      localObject1 = "0";
      break;
    }
    for (;;)
    {
      ...
      {
        label578:
        localObject1 = (anox)this.a.a().getManager(77);
        if (localObject1 == null) {
          break;
        }
        localObject1 = (anpr)((anox)localObject1).a("qq.android.early.precover");
        if (localObject1 == null) {
          break;
        }
        bool1 = ((anpr)localObject1).i();
        boolean bool2 = ((anpr)localObject1).j();
        ...
        localObject1 = axrl.a(BaseApplicationImpl.getContext());
        localObject3 = this.a.a().getCurrentAccountUin();
        if ((!bool1) || (!bool2)) {
          break label776;
        }
        bool1 = true;
        ((axrl)localObject1).a((String)localObject3, "precover_handler", bool1, 0L, 0L, (HashMap)localObject2, "", false);
        return;
      }
  ...
  public void a(PrecoverResource paramPrecoverResource, int paramInt, String paramString1, String paramString2, long paramLong)
  {
    ...
    localHashMap.put("url", aurz.b(paramPrecoverResource.url));
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      axrl.a(BaseApplicationImpl.getContext()).a(this.a.a().getCurrentAccountUin(), "precover_download_result", bool, 0L, paramLong, localHashMap, "", false);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      return;
      int i = aurz.a(this.a.a().getApp(), this.a.a().getCurrentAccountUin());
      ...
      axrl.a(BaseApplicationImpl.getContext()).a(this.a.a().getCurrentAccountUin(), "precover_config_cover", paramBoolean, 0L, 0L, localHashMap, "", false);
      axqw.b(this.a.a(), "CliOper", "", "", "0X8007133 ", "0X8007133 ", 0, 0, String.valueOf(i), "", "id_all", "");
      if (localObject2 != null)
      {
        localObject1 = ((List)localObject2).iterator();
        while (((Iterator)localObject1).hasNext())
        {
          ...
          axqw.b(this.a.a(), "CliOper", "", "", "0X8007133 ", "0X8007133 ", 0, 0, String.valueOf(i), "", "id_" + ((PrecoverConfig)localObject2).businessId, "");
        }
      }
    }
  }
