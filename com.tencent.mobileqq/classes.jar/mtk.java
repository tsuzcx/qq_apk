...
public class mtk
{
  ...
  {
    Object localObject2 = ((axfr)paramQQAppInterface.getManager(11)).b(paramString);
    Object localObject1 = null;
    if (localObject2 != null) {
      localObject1 = bhlg.b(((PhoneContact)localObject2).name);
    }
    localObject2 = localObject1;
    if (localObject1 == null) {
      localObject2 = bhlg.b(paramString);
    }
    paramString = new bhhy(paramQQAppInterface.getApp(), (String)localObject2);
  ...
  public static List<AVPhoneUserInfo> a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    localObject1 = (anws)paramQQAppInterface.getManager(53);
    if (localObject1 == null) {
      return null;
    }
    paramString = ((anws)localObject1).a(paramString);
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      {
        paramQQAppInterface = ((axfr)localObject1).b(paramQQAppInterface);
        if (paramQQAppInterface == null) {
          break label266;
        }
      }
  ...
  public static List<Bitmap> a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    Map localMap = ((anws)localObject).a(paramString);
    ...
    if (paramInt1 < paramInt2)
    {
      ...
      for (;;)
      {
        paramInt1 += 1;
        break;
        PhoneContact localPhoneContact = localaxfr.b(str);
        paramString = null;
