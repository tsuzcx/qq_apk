...
public class xac
  extends RecyclerView.Adapter<xaf>
  implements Handler.Callback
{
  ...
  public befq a()
  {
    ...
    return this.jdField_a_of_type_Befq;
  }
  ...
  public xaf a(ViewGroup paramViewGroup, int paramInt)
  {
    return new xaf(this, LayoutInflater.from(paramViewGroup.getContext()).inflate(2131496998, null));
  }
  ...
  {
    VSNetworkHelper.a().a(new BatchGetMusicInfoRequest(paramArrayList), new xae(this, paramBoolean));
  }
  ...
  public void a(xab paramxab)
  {
    this.jdField_a_of_type_Xab = paramxab;
  }
  
  public void a(xaf paramxaf, int paramInt)
  {
    if (a() == 0) {}
    int i;
    ...
    for (;;)
    {
      vms.a(xaf.a(paramxaf), localVsMusicItemInfo.mAlbumUrl, vms.a(paramxaf.itemView.getContext(), 60.0F), vms.a(paramxaf.itemView.getContext(), 60.0F), vms.a(paramxaf.itemView.getContext(), 30.0F), paramxaf.itemView.getContext().getResources().getDrawable(2130838548), null);
      paramxaf.itemView.setOnClickListener(new xad(this, paramInt, localVsMusicItemInfo));
      return;
      i = a(paramInt);
      break;
      paramxaf.b(false);
  ...
  public void onAttachedToRecyclerView(RecyclerView paramRecyclerView)
  {
    ...
    this.jdField_a_of_type_Wzr = this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.a();
  }
