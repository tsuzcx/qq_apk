  ...
  implements View.OnClickListener
{
  ...
  wlj jdField_a_of_type_Wlj;
  boolean jdField_a_of_type_Boolean;
  
  public xac(@NonNull Context paramContext, String paramString, int paramInt, wlj paramwlj, boolean paramBoolean)
  {
    super(paramContext, 16973841);
    super.requestWindowFeature(1);
    super.setContentView(LayoutInflater.from(paramContext).inflate(2131561864, null));
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppTroopManager = ((TroopManager)wzk.a().getManager(QQManagerFactory.TROOP_MANAGER));
    this.jdField_a_of_type_Boolean = paramBoolean;
  }
  
  void a()
  {
    ((ElasticImageView)findViewById(2131364714)).setOnClickListener(this);
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager = ((ViewPager)findViewById(2131381152));
    this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetLeftTabBarView = ((LeftTabBarView)findViewById(2131378398));
    ...
    int i;
    if ((this.jdField_a_of_type_Wlj != null) && (this.jdField_a_of_type_Boolean))
    {
      if ((this.jdField_a_of_type_Wlj.a != null) && (!this.jdField_a_of_type_Wlj.a.isEmpty()))
      {
        ArrayList localArrayList2 = new ArrayList(this.jdField_a_of_type_Wlj.a.size());
        Iterator localIterator = this.jdField_a_of_type_Wlj.a.iterator();
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetLeftTabBarView.setOnTabChangeListener(new xad(this));
      this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setAdapter(new xaf(this, localArrayList1));
      this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setOnPageChangeListener(new xae(this));
    ...
    for (;;)
    {
      ykv.a("pub_control", "exp_list", 0, 0, new String[] { String.valueOf(i), "", "", this.jdField_a_of_type_JavaLangString });
      return;
      this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoMyVideoVisiblePersonPageView = new MyVideoVisiblePersonPageView(this, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
      break;
      label438:
