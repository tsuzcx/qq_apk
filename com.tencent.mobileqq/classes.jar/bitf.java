...
public class bitf
{
  ...
  public bitf()
  {
    this.jdField_a_of_type_MqqObserverSSOAccountObserver = new bitg(this);
  }
  
  public void a()
  {
    this.jdField_a_of_type_Bith = null;
  }
  
  public void a(bith parambith)
  {
    this.jdField_a_of_type_Bith = parambith;
  }
  ...
  public void a(AppRuntime paramAppRuntime, long paramLong, String paramString)
  {
    ...
    {
      byte[] arrayOfByte = this.jdField_a_of_type_MqqManagerWtloginManager.getPkgSigFromApkName(biip.a().a(), paramString);
      this.jdField_a_of_type_Long = paramLong;
      paramAppRuntime.ssoGetA1WithA1(biip.a().a() + "", paramString.getBytes(), 16L, paramLong, 1L, "5.0".getBytes(), arrayOfByte, this.jdField_a_of_type_MqqObserverSSOAccountObserver);
    }
  }
  ...
  public byte[] a(android.content.Context paramContext, long paramLong1, long paramLong2)
  {
    ...
    //   379: aload 7
    //   381: invokestatic 204	bisy:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   384: aload_1
    //   385: ifnull -26 -> 359
    //   388: aload_1
