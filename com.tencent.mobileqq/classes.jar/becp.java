...
public class becp
{
  public static becr a(DataInputStream paramDataInputStream)
  {
    becr localbecr = new becr(null);
    try
    {
      localbecr.jdField_a_of_type_Int = paramDataInputStream.readInt();
      localbecr.b = paramDataInputStream.readInt();
      localbecr.c = paramDataInputStream.readInt();
      if ((localbecr.c > 0) && (localbecr.c <= 256))
      {
        localbecr.jdField_a_of_type_ArrayOfByte = new byte[localbecr.c];
        paramDataInputStream.read(localbecr.jdField_a_of_type_ArrayOfByte);
        return localbecr;
      }
    }
  ...
  public static boolean a(java.io.File paramFile, String paramString)
  {
    ...
    //   98: pop
    //   99: aload 6
    //   101: invokestatic 124	becp:a	(Ljava/io/DataInputStream;)Lbecr;
    //   104: astore 8
    //   106: aload 8
    ...
    //   145: goto -24 -> 121
    //   148: aload 8
    //   150: getfield 23	becr:jdField_a_of_type_Int	I
    //   153: istore_3
    //   154: iload_3
    //   155: ldc 125
    ...
    //   194: goto -24 -> 170
    //   197: aload 8
    //   199: getfield 26	becr:b	I
    //   202: ifle +15 -> 217
    //   205: aload 8
    //   207: getfield 26	becr:b	I
    //   210: istore_3
    //   211: iload_3
    //   212: ldc 126
    ...
    //   299: goto -24 -> 275
    //   302: aload_1
    //   303: invokestatic 128	becp:a	(Ljava/lang/String;)Ljava/security/PublicKey;
    //   306: astore_1
    //   307: aload_1
    ...
    //   364: aload_0
    //   365: aload 8
    //   367: getfield 26	becr:b	I
    //   370: aload 8
    //   372: getfield 32	becr:jdField_a_of_type_ArrayOfByte	[B
    //   375: aload_1
    //   376: invokestatic 130	becp:a	(Ljava/io/DataInputStream;I[BLjava/security/PublicKey;)Z
    //   379: istore 5
    //   381: aload 6
    //   383: ifnull +8 -> 391
    //   386: aload 6
  ...
  public static byte[] a(java.io.File paramFile, String paramString)
  {
    ...
    //   140: astore_0
    //   141: aload_1
    //   142: invokestatic 128	becp:a	(Ljava/lang/String;)Ljava/security/PublicKey;
    //   145: astore 6
    //   147: aload 6
    ...
    //   216: aload 7
    //   218: aload 6
    //   220: invokestatic 136	becp:a	([B[BLjava/security/PublicKey;)Z
    //   223: istore 4
    //   225: iload 4
    //   227: ifeq +23 -> 250
    //   230: aload 5
