...
public class bjtg
{
  private static final bjsl<bjtg, Void> jdField_a_of_type_Bjsl = new bjth();
  private LinkedHashMap<Long, WebAppIpRecord> jdField_a_of_type_JavaUtilLinkedHashMap;
  
  public static bjtg a()
  {
    return (bjtg)jdField_a_of_type_Bjsl.b(null);
  }
  
  private File a()
  {
    File localFile = new File(bjhx.n() + File.separator + "webapp_iplist");
    if (!localFile.exists())
    {
  ...
  public void a()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 159	bjtg:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   8: ifnull +17 -> 25
    //   11: aload_0
    //   12: getfield 159	bjtg:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    ...
    //   49: aload_0
    //   50: getfield 159	bjtg:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    ...
    //   92: aload_0
    //   93: aload_0
    //   94: getfield 159	bjtg:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   97: iload_2
    //   98: sipush 1000
    //   101: imul
    //   102: i2l
    //   103: invokespecial 191	bjtg:a	(Ljava/util/LinkedHashMap;J)Ljava/util/LinkedHashMap;
    //   106: astore 8
    //   108: aload 6
    //   110: astore 5
    ...
    //   506: astore 5
    //   508: aload_0
    //   509: invokespecial 277	bjtg:a	()Ljava/io/File;
    //   512: astore 8
    //   514: aload 8
    //   516: ifnull +91 -> 607
    //   519: aload 6
  ...
  public void b()
  {
    ...
    //   19: invokestatic 39	bjhx:n	()Ljava/lang/String;
    ...
    //   78: pop
    //   79: aload 4
    //   81: invokestatic 314	bjtz:a	(Ljava/io/File;)Z
    //   84: pop
    //   85: aload 5
    //   87: ifnonnull +39 -> 126
    //   90: aload_3
    ...
    //   391: invokestatic 360	bjsk:c	(ILjava/lang/String;)V
    //   394: goto -83 -> 311
    //   397: astore_3
    //   398: aload_3
