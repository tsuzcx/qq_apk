...
public class rpi
{
  ...
  private static volatile rpi jdField_a_of_type_Rpi;
  ...
  public rpi()
  {
    this.jdField_a_of_type_Rpj = null;
  }
  
  public static rpi a()
  {
    if (jdField_a_of_type_Rpi == null) {}
    try
    {
      if (jdField_a_of_type_Rpi == null) {
        jdField_a_of_type_Rpi = new rpi();
      }
      return jdField_a_of_type_Rpi;
    }
    finally {}
  }
  ...
  {
    return jdField_a_of_type_Rpi != null;
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localJSONObject.put("articles_request_type", ozo.a());
      if (!ozo.b()) {
        break label312;
      }
      i = 1;
    ...
    if (this.jdField_b_of_type_Boolean) {
      nol.a(null, "", "0X8009296", "0X8009296", 0, 0, String.valueOf((NetConnInfoCenter.getServerTimeMillis() - this.jdField_b_of_type_Long) / 1000.0D), "", "", localJSONObject.toString(), false);
    }
    for (;;)
    {
      ozo.a(false);
      ...
      str = "0";
      break;
      nol.a(null, "", "0X80089D1", "0X80089D1", 0, 0, String.valueOf((NetConnInfoCenter.getServerTimeMillis() - this.jdField_b_of_type_Long) / 1000.0D), "", "", localJSONObject.toString(), false);
    }
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Rpj == null) {
      this.jdField_a_of_type_Rpj = new rpj(this, null);
    }
