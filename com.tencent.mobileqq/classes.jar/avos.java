  ...
  extends avoj
{
  ...
  public avos(QQAppInterface paramQQAppInterface, int paramInt, MiniAppLocalSearchEntity paramMiniAppLocalSearchEntity, String paramString)
  {
  ...
  {
    return avwf.b(this.jdField_a_of_type_ComTencentMobileqqMiniEntryMiniAppLocalSearchEntity.appName, this.jdField_a_of_type_JavaLangString, 10, true);
  }
  ...
  public void a(View paramView)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramView = "1";
          avsv.a(null, localReportModelDC02528.ver3(paramView).ver7(localJSONObject.toString()).session_id(localQQAppInterface.getCurrentAccountUin() + avjb.jdField_a_of_type_Long));
          avwf.b(localQQAppInterface, this.jdField_a_of_type_JavaLangString, this.i, e(), e());
          if ((this.i == null) || (TextUtils.isEmpty(this.i))) {
            break label379;
          }
          avsv.a(null, 0, this.b, "0X8009D31", 3, 0, null, null);
          return;
          label314:
      ...
      catch (JSONException localJSONException)
      {
        ...
        {
          avsv.a(null, 0, this.b, "0X8009D33", 0, 0, this.jdField_a_of_type_ComTencentMobileqqMiniEntryMiniAppLocalSearchEntity.appId, null);
          return;
        }
        avsv.a(null, 0, this.b, "0X8009D45", 0, 0, this.jdField_a_of_type_ComTencentMobileqqMiniEntryMiniAppLocalSearchEntity.appId, null);
      }
    }
  }
