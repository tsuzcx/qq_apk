  ...
  extends lsh
{
  ...
  mer jdField_a_of_type_Mer = null;
  ...
  public mep(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString)
  {
    this(paramContext, paramVideoAppInterface, paramString, 0L);
  }
  
  public mep(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString, long paramLong)
  {
    this(paramContext, paramVideoAppInterface, paramString, paramLong, true);
  }
  
  public mep(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString, long paramLong, boolean paramBoolean)
  {
    super(paramContext);
    ...
    this.t = agej.a(6.0F, paramContext.getResources());
    this.u = agej.a(10.0F, paramContext.getResources());
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(new meq(this, paramVideoAppInterface));
    }
    ...
    for (;;)
    {
      ...
      if ((localObject != null) && (((AVActivity)localObject).a != null) && ((((AVActivity)localObject).a instanceof MultiVideoCtrlLayerUIBase)))
      {
        ...
        try
        {
          ...
          paramInt = bhnv.b(BaseApplicationImpl.getApplication());
          if (paramInt == 1)
          {
            paramInt = 1;
            localStringBuilder.append(paramInt).append(';');
  ...
  Bitmap a(Bitmap paramBitmap)
  {
    ...
    //   55: aload_2
    //   56: bipush 20
    //   58: invokestatic 479	bhsp:a	(Landroid/graphics/Bitmap;I)V
    //   61: aload_2
    //   62: aload_1
    ...
    //   81: astore_1
    //   82: aload_0
    //   83: getfield 147	mep:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   86: iconst_2
    ...
    //   118: astore_1
    //   119: aload_0
    //   120: getfield 147	mep:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   123: iconst_2
  ...
  public met a(lqt paramlqt)
  {
    ...
    for (;;)
    {
      if (i1 != 0)
      {
        ...
        if (this.jdField_a_of_type_Lrx != null)
        {
          ...
          this.jdField_a_of_type_Met.a(paramlqt[0], i1, i2);
          return this.jdField_a_of_type_Met;
          i1 = 0;
          break;
          label139:
          i1 = 0;
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_Met.a(this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer.getTexId(), i5, i6);
          return this.jdField_a_of_type_Met;
          i1 = this.A;
          break;
          label548:
    ...
    if ((this.jdField_e_of_type_Boolean) && (this.jdField_c_of_type_Lrw != null))
    {
    ...
    this.jdField_a_of_type_Met.a(-1, 0, 0);
    return this.jdField_a_of_type_Met;
  }
  ...
  {
    if (this.jdField_c_of_type_Lrx != null)
    {
      this.jdField_c_of_type_Lrx.a();
      this.jdField_c_of_type_Lrx = null;
    }
    this.jdField_c_of_type_Lrx = new lrx(mvd.a(this.jdField_a_of_type_AndroidContentContext, paramInt1));
    this.jdField_c_of_type_Lrx.a(false);
    if (this.jdField_b_of_type_Lrx != null)
    {
      this.jdField_b_of_type_Lrx.a();
      this.jdField_b_of_type_Lrx = null;
    }
    this.jdField_b_of_type_Lrx = new lrx(mvd.a(this.jdField_a_of_type_AndroidContentContext, paramInt2));
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      if (this.jdField_a_of_type_Man != null)
      {
        this.jdField_a_of_type_Man.a();
        this.jdField_a_of_type_Man = null;
      }
      return;
    }
    if (this.jdField_a_of_type_Man == null)
    {
      this.jdField_a_of_type_Man = new man();
      int i1 = b();
      int i2 = c();
      this.jdField_a_of_type_Man.a(i1);
      this.jdField_a_of_type_Man.b(i2);
    }
    this.jdField_a_of_type_Man.a(paramInt1, paramInt2, paramInt3);
  }
  ...
  protected void a(lqt paramlqt, int paramInt)
  {
  ...
  protected void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Man != null)
      {
        this.jdField_a_of_type_Man.a(paramInt1);
        this.jdField_a_of_type_Man.b(paramInt2);
      }
      return;
    }
    catch (Exception localException)
  ...
  protected void d(lqt paramlqt)
  {
    ...
    for (float f1 = f5;; f1 = f6)
    {
      ...
      if ((!this.jdField_m_of_type_Boolean) && (a(i8)))
      {
        ...
        paramlqt.a(2);
        a(paramlqt, i1);
        paramlqt.a(i8 * 90, 0.0F, 0.0F, 1.0F);
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a((int)this.jdField_c_of_type_AndroidGraphicsRectF.width());
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.b((int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        ...
        this.jdField_a_of_type_Lrx.a(paramlqt, i9, i10, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        ...
        if (QLog.isColorLevel())
        {
          if (this.jdField_a_of_type_Mer == null) {
            this.jdField_a_of_type_Mer = new mer();
          }
          localObject = this.jdField_a_of_type_Mer;
      ...
      for (boolean bool2 = true;; bool2 = false)
      {
        ...
        break label400;
        if ((this.jdField_a_of_type_Man != null) && (this.jdField_a_of_type_Man.f()))
        {
          paramlqt.a((4 - i7) * 90, 0.0F, 0.0F, 1.0F);
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_Man.a(paramlqt, i9, i10, i2, i3);
            break;
            i4 = i2;
            i2 = i3;
            i3 = i4;
        ...
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(paramlqt, i9, i10, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        break label601;
      }
      label1174:
      f4 = f5;
  ...
  protected void e(lqt paramlqt)
  {
    ...
    if (this.jdField_m_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Man.a(paramlqt, (int)this.jdField_c_of_type_AndroidGraphicsRectF.left, (int)this.jdField_c_of_type_AndroidGraphicsRectF.top, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
    }
    for (;;)
    {
      paramlqt.c();
      lbj.c(this.jdField_c_of_type_JavaLangString, "renderDoubleScreenOfPC:|" + b() + "|" + h() + "|" + i2 + "|" + i3 + "|" + i4 + "|" + i5 + "|" + this.jdField_b_of_type_AndroidGraphicsRectF.toString() + "|" + this.jdField_c_of_type_AndroidGraphicsRectF.toString());
      return;
      i1 = this.A;
      break;
      label398:
  ...
  protected void finalize()
  {
    try
    {
      ...
      if (this.jdField_e_of_type_Lrw != null)
      {
        this.jdField_e_of_type_Lrw.a();
        this.jdField_e_of_type_Lrw = null;
      }
  ...
  protected void g(lqt paramlqt)
  {
    ...
    if (this.jdField_q_of_type_Boolean)
    {
      ...
      if (this.jdField_i_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Lsb.e(super.b() - this.u);
      ...
      if ((this.jdField_a_of_type_Lsb != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
      {
        ...
        i1 = this.u;
        i2 = i5 - this.jdField_a_of_type_Lsb.j() - this.t;
      }
    }
    for (;;)
    {
      ...
      {
        i1 = agej.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        i2 = this.y;
      }
    }
  }
  ...
  protected void i(lqt paramlqt)
  {
    ...
    int i6;
    int i1;
    if ((this.jdField_q_of_type_Boolean) && (this.jdField_a_of_type_Lsb != null))
    {
      locallrx = null;
      if (this.jdField_q_of_type_Int != 2) {
        break label168;
      }
      locallrx = this.jdField_c_of_type_Lrx;
      if (locallrx != null)
      {
        i3 = super.b();
        i4 = super.c();
    ...
    for (int i2 = i4 - this.jdField_a_of_type_Lsb.j() - this.t + this.jdField_a_of_type_Lsb.k() - i6 + (i6 - this.jdField_a_of_type_Lsb.k()) / 2;; i2 = this.y + this.jdField_a_of_type_Lsb.k() - i6 + Math.abs((i6 - this.jdField_a_of_type_Lsb.k()) / 2))
    {
      paramlqt.a(3);
      paramlqt.a((i5 - i3) / 2, (i6 - i4) / 2);
      locallrx.a(paramlqt, i1, i2, i5, i6);
      paramlqt.c();
      return;
      label168:
      ...
      locallrx = this.jdField_b_of_type_Lrx;
      break;
      label185:
      i1 = agej.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) + this.jdField_a_of_type_Lsb.c() + this.u;
    }
  }
  ...
  public void j(boolean paramBoolean)
  {
    if (this.jdField_e_of_type_Boolean != paramBoolean)
    {
      ...
      if (this.jdField_c_of_type_Lrw == null) {
        this.jdField_c_of_type_Lrw = new lsa(this.jdField_a_of_type_AndroidContentContext, 2130842275);
      }
      localGLRootView = a();
      if (localGLRootView != null) {
  ...
  public void m(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      this.z = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297856);
    }
  }
