...
public class aelu
  extends Handler
{
  public aelu(VisitorsActivity paramVisitorsActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      ...
      this.a.jdField_a_of_type_ComTencentWidgetSwipListView.springBackOverScrollHeaderView();
      this.a.jdField_a_of_type_ComTencentWidgetSwipListView.springBackOverScrollHeaderView();
      this.a.a(1, this.a.getString(2131694768));
      return;
    case 3: 
      ...
      for (;;)
      {
        ...
        return;
        this.a.jdField_b_of_type_Aemq.notifyDataSetChanged();
      }
    case 5: 
      ...
      if ((paramMessage instanceof Object[]))
      {
        ...
        this.a.jdField_a_of_type_Aemq.a(this.a.jdField_a_of_type_JavaUtilArrayList);
        if (QLog.isColorLevel()) {
          QLog.d("VisitorsActivity", 2, "setDataSet favor UI_ONINIT");
        }
        this.a.jdField_b_of_type_Aemq.a(this.a.jdField_b_of_type_JavaUtilArrayList);
        this.a.jdField_a_of_type_Aemq.notifyDataSetChanged();
        this.a.jdField_b_of_type_Aemq.notifyDataSetChanged();
      }
      ...
      return;
    case 6: 
      this.a.jdField_a_of_type_Awwy.b();
      return;
    case 7: 
      if (QLog.isColorLevel()) {
    ...
    case 9: 
      ...
      this.a.jdField_a_of_type_Awwy.a(paramMessage);
      return;
    case 10: 
    ...
    case 11: 
            ...
            if (paramMessage.length == 2)
            {
              ...
              if (i1 >= i2)
              {
                ...
                if (i1 <= i3)
                {
                  ...
                  if (localObject != null)
                  {
                    localObject = (TextView)((View)localObject).findViewById(2131379086);
                    j = m;
                    if (localObject != null)
                    {
                      int[] arrayOfInt = new int[2];
                      ((TextView)localObject).getLocationInWindow(arrayOfInt);
                      localawsr = (awsr)paramMessage[1];
                      if (!TextUtils.isEmpty(localawsr.jdField_b_of_type_JavaLangString)) {
                        break label929;
                      }
                      j = 1;
                      ...
                      if ((n <= 0) || (localawsr.c == null)) {
                        break label961;
                      }
                      this.a.jdField_a_of_type_ComTencentMobileqqNearbyAnimNearbyZanAnimLayout.a(localawsr, localawsr.c, f1, f2);
                      i -= 1;
                      if (i <= 0) {
                        break label983;
                      }
                      ...
                      i = apit.a[this.a.jdField_a_of_type_JavaUtilRandom.nextInt(apit.a.length)];
      ...
      for (;;)
      {
        ...
        break label542;
        label929:
        j = localawsr.jdField_b_of_type_JavaLangString.length() + 1;
        break label718;
        k = ((TextView)localObject).getText().length() * 2;
        break label729;
        this.a.jdField_a_of_type_ComTencentMobileqqNearbyAnimNearbyZanAnimLayout.a(localawsr, localawsr.jdField_b_of_type_AndroidGraphicsBitmap, f1, f2);
        break label811;
