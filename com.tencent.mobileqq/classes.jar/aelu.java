...
public class aelu
  extends amop
{
  public aelu(TroopInfoActivity paramTroopInfoActivity) {}
  ...
  protected void a(boolean paramBoolean, long paramLong, String paramString)
  {
    ...
    if ((this.a.jdField_a_of_type_Int == 0) || (1 == this.a.jdField_a_of_type_Int)) {
      bcef.b(this.a.app, "P_CliOper", "Grp_create", "", "edit_data", "ordinary_suc", 0, 0, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.a.jdField_b_of_type_JavaLangString, "", "");
    }
  ...
  public void a(boolean paramBoolean, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    do
    {
      ...
      if (TextUtils.isEmpty(paramString3)) {
        paramString1 = amtj.a(2131700893);
      }
