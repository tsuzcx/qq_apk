...
public class tbx
{
  private static int a(List<BaseData> paramList)
  {
    ...
    while (i > 0)
    {
      ...
      if ((tbb.a(localBaseData)) && (localBaseData.t != 0))
      {
  ...
  private static int a(List<BaseData> paramList, BaseData paramBaseData)
  {
    ...
    {
      i = k;
      if (((BaseData)paramList.get(j)).t == 6)
      {
        k -= 1;
        i = k;
        if (k == 1) {
  ...
  public static void a(List<BaseData> paramList)
  {
    ...
    if (((Iterator)localObject).hasNext()) {
      if (((BaseData)((Iterator)localObject).next()).t != 6) {
        break label144;
      }
    }
    label144:
  ...
  public static void a(List<BaseData> paramList1, List<BaseData> paramList2)
  {
    ...
    if (paramList1 != null)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if ((localBaseData.t == 9) || (localBaseData.t == 10) || (localBaseData.t == 11) || (localBaseData.t == 17) || (localBaseData.t == 24)) {
    ...
    if (paramList2 != null)
    {
      ...
      while (paramList2.hasNext())
      {
        ...
        if ((((BaseData)localObject1).t == 10) || (((BaseData)localObject1).t == 11) || (((BaseData)localObject1).t == 17) || (((BaseData)localObject1).t == 24))
        {
          a(paramList1, (BaseData)localObject1, null);
        }
        else
        {
          if (((BaseData)localObject1).t == 22) {}
  ...
  public static void a(List<BaseData> paramList1, List<BaseData> paramList2, ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, SparseArray<Float> paramSparseArray, ItemShowDispatcher paramItemShowDispatcher)
  {
    ...
    if (paramList1 != null)
    {
      ...
      {
        BaseData localBaseData = (BaseData)localIterator.next();
        if ((localBaseData.t == 7) || (localBaseData.t == 6) || (localBaseData.t == 8)) {
    ...
    if (paramList2 != null)
    {
      ...
      while (paramList2.hasNext())
      {
        ...
        if ((localObject instanceof ProteusItemData)) {
          tbf.a(paramArticleInfo, (ProteusItemData)localObject, 5, paramSparseArray);
        }
  ...
  public static void a(boolean paramBoolean, List<BaseData> paramList, FastWebArticleInfo paramFastWebArticleInfo, ArticleInfo paramArticleInfo)
  {
    ...
    if (i < paramList.size())
    {
      ...
      do
      {
        ...
        break;
        k = j;
      } while (((BaseData)localObject).t != 15);
    }
  ...
  {
    int j = 0;
    if (paramBaseData.t == 22)
    {
      boolean bool = ((ProteusInnerData)paramBaseData).g();
      ...
      if (i > 0)
      {
        ...
        {
          m = k;
          if (!tbb.a(paramBaseData)) {
            break label170;
          }
          m = k;
          if (paramBaseData.t == 0) {
            break label170;
          }
          k += 1;
          m = k;
  ...
  public static void b(List<BaseData> paramList)
  {
    ...
    for (;;)
    {
      ...
      } while (((BaseData)localIterator.next()).t != 16);
      for (int i = 1; i == 0; i = 0)
      {
  ...
  public static void c(List<BaseData> paramList, List<CommentInfo> paramList1)
  {
    ...
    for (;;)
    {
      j += 1;
      break;
      QLog.d(tbx.class.getSimpleName(), 2, "update comment data! size : " + i);
      return;
    }
  }
  ...
  private static void f(List<BaseData> paramList)
  {
    ...
    {
      localBaseData = (BaseData)localIterator.next();
      if ((localBaseData.t == 10) || (localBaseData.t == 17) || (localBaseData.t == 24)) {
        localArrayList.add(localBaseData);
      }
    }
    for (;;)
    {
      break label22;
      if ((localBaseData.t == 22) && (((ProteusInnerData)localBaseData).g()))
      {
        i = 1;
        continue;
        if (i == 0) {
