  ...
  implements tch
{
  ...
  private void a(@Nullable String paramString1, @Nullable Object paramObject, @Nullable String paramString2)
  {
    ...
    {
      ved.d("ConfigManager", paramString1);
      return;
    }
  }
  ...
  public <V> V a(@NonNull String paramString, @NonNull V paramV)
  {
    ...
    for (;;)
    {
      ved.b("ConfigManager", "get value : K : %s, V : %s", paramString, localObject);
  ...
  public void a(String paramString)
  {
    ...
    {
      ved.e("ConfigManager", "remove value error : K:%s.", new Object[] { paramString });
      return;
    }
    ved.b("ConfigManager", "remove value success :  K:%s.", paramString);
  }
  ...
  public <V> void a(String paramString, V paramV)
  {
    ...
    while (!bool)
    {
      ved.e("ConfigManager", "set value error : K:%s, V:%s .", new Object[] { paramString, paramV });
      return;
      if (paramV.getClass() == Long.class) {
    ...
    ved.b("ConfigManager", "set value success :  K:%s, V:%s .", paramString, paramV);
  }
  
  public void b()
  {
    ved.b("ConfigManager", "onDestroy");
  }
}
