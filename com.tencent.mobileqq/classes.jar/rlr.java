...
public class rlr
{
  private static Pattern a = Pattern.compile(bgny.c.pattern() + "|" + bgny.d.pattern(), 2);
  ...
  private static int a(Spannable paramSpannable, int paramInt1, int paramInt2)
  {
    ...
    while (localMatcher.find())
    {
      ...
      paramInt2 += 1;
      paramSpannable.setSpan(new tft(str), i, j, 0);
    }
    return paramInt2;
  }
  ...
  public static boolean a(Spannable paramSpannable)
  {
    ...
    {
      return false;
      if (bgny.b.matcher(paramSpannable).find())
      {
        Object localObject = (tft[])paramSpannable.getSpans(0, m, tft.class);
        int j;
        int n;
        int i;
        ...
        int k = 0;
        localObject = (tfr[])paramSpannable.getSpans(0, m, tfr.class);
        if ((localObject != null) && (localObject.length > 0))
        {
          Arrays.sort((Object[])localObject, new rls(paramSpannable));
  ...
  public static boolean a(EditText paramEditText, String paramString, boolean paramBoolean1, boolean paramBoolean2, List<SocializeFeedsInfo.BiuCommentInfo> paramList)
  {
    ...
    paramEditText = pgy.b(a(localEditable.toString(), str));
    if (TextUtils.isEmpty(paramEditText))
    {
      paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), ""));
      return true;
    }
    tfr[] arrayOftfr = (tfr[])localEditable.getSpans(0, localEditable.length(), tfr.class);
    if ((arrayOftfr == null) || (arrayOftfr.length <= 0))
    {
      if (paramBoolean1) {
        break label650;
      }
    ...
    for (;;)
    {
      paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), bbzj.a(b((String)localObject + paramEditText, str))));
      return true;
      int m = arrayOftfr.length;
      Arrays.sort(arrayOftfr, new rls(localEditable));
      paramEditText = bbzj.a(b(localEditable.subSequence(0, localEditable.getSpanStart(arrayOftfr[0])).toString(), str));
      ...
      if (i < m)
      {
        ...
        if (i == m - 1)
        {
          ...
          paramEditText = "";
          if (j - n > 0) {
            paramEditText = bbzj.a(b(localEditable.subSequence(n, j).toString(), str));
          }
        ...
        for (;;)
        {
          i += 1;
          break;
          j = localEditable.getSpanStart(arrayOftfr[(i + 1)]);
          break label372;
          label481:
          ...
          else if ((localObject instanceof tfs))
          {
            paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), paramEditText, 3, new SocializeFeedsInfo.JumpInfo(0L, anni.a(2131714690), ((tfs)localObject).a())));
          }
        }
      }
      return false;
