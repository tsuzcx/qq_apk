...
public class bfzt<T>
  extends Animation
{
  static final bgaa jdField_a_of_type_Bgaa = new bfzu();
  static final bgaa b;
  static final bgaa c;
  static final bgaa d;
  static final bgaa e = new bfzy();
  ...
  static
  {
    jdField_b_of_type_Bgaa = new bfzv();
    jdField_c_of_type_Bgaa = new bfzw();
    jdField_d_of_type_Bgaa = new bfzx();
  }
  
  public bfzt(T paramT1, T paramT2, bfzz<T> parambfzz)
  {
    this(paramT1, paramT2, parambfzz, false, false, null);
  }
  
  public bfzt(T paramT1, T paramT2, bfzz<T> parambfzz, boolean paramBoolean1, boolean paramBoolean2)
  {
    this(paramT1, paramT2, parambfzz, paramBoolean1, paramBoolean2, null);
  }
  
  public bfzt(T paramT1, T paramT2, bfzz<T> parambfzz, boolean paramBoolean1, boolean paramBoolean2, bgaa<T> parambgaa)
  {
    ...
    for (;;)
    {
      ...
      {
        this.f = jdField_a_of_type_Bgaa;
      }
      else if (Float.class == localClass)
      {
        this.f = jdField_b_of_type_Bgaa;
      }
      else if (Rect.class == localClass)
      {
        this.f = jdField_c_of_type_Bgaa;
      }
      else if (Point.class == localClass)
      {
        this.f = jdField_d_of_type_Bgaa;
      }
      else
      {
  ...
  public void a(bfzz<T> parambfzz)
  {
    this.jdField_a_of_type_Bfzz = parambfzz;
  }
  
  protected void applyTransformation(float paramFloat, Transformation paramTransformation)
  {
    if (this.jdField_a_of_type_Bfzz != null) {
      this.jdField_a_of_type_Bfzz.a(this, paramFloat, this.f.a(paramFloat, this.jdField_a_of_type_JavaLangObject, this.jdField_b_of_type_JavaLangObject), paramTransformation);
    }
  }
