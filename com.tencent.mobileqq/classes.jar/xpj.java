  ...
  implements xpv
{
  ...
  public void b()
  {
    ...
    this.a.b();
    if ((this.a.jdField_a_of_type_Xpu != null) && (!this.a.jdField_a_of_type_Xpu.a())) {
      this.a.jdField_a_of_type_Xpu.a();
    }
  }
  
  public void c()
  {
    if (this.a.jdField_a_of_type_Xpz.a().b) {
      this.a.jdField_a_of_type_ComTencentWidgetGallery.setVisibility(4);
    }
    this.a.c();
    if ((this.a.jdField_a_of_type_Xpu != null) && (this.a.jdField_a_of_type_Xpu.a())) {
      this.a.jdField_a_of_type_Xpu.b();
    }
  }
  ...
  public void d()
  {
    ...
    if (this.a.jdField_a_of_type_Xph != null) {
      this.a.jdField_a_of_type_Xph.a(4);
    }
    if ((this.a.jdField_a_of_type_Xpu != null) && (this.a.jdField_a_of_type_Xpu.a())) {
      this.a.jdField_a_of_type_Xpu.b();
    }
  ...
  public void e()
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      if (this.a.jdField_a_of_type_Xpz.a() != this.a) {
        break label87;
      }
    }
    label87:
