  ...
  implements Animation.AnimationListener
{
  ...
  public void onAnimationEnd(Animation paramAnimation)
  {
    ...
    if (this.a.jdField_b_of_type_AndroidViewAnimationTranslateAnimation == paramAnimation)
    {
      ...
      if (this.a.jdField_a_of_type_Bfgl != null) {
        this.a.jdField_a_of_type_Bfgl.d = false;
      }
    ...
    for (;;)
    {
      return;
      label247:
      bgie localbgie = (bgie)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_AIO_AD_MANAGER);
      String str = this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin;
      if (!TextUtils.isEmpty(str))
      {
        TroopAioTopADInfo localTroopAioTopADInfo = localbgie.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin);
        Object localObject;
        if (localTroopAioTopADInfo != null)
        {
          ...
          localObject = bhey.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Context)this.a.jdField_a_of_type_JavaLangRefWeakReference.get(), paramAnimation);
          if (localObject == null) {
            break label439;
          }
          ((bheh)localObject).a();
        ...
        for (;;)
        {
          bdla.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "notice_center", "Clk_Promote", 0, 0, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, localTroopAioTopADInfo.adId + "", "", "");
          localbgie.a(str);
          this.a.d = false;
          return;
          label430:
        ...
        {
          if ((this.a.jdField_a_of_type_AndroidViewView != null) && (this.a.jdField_a_of_type_Bfgl != null))
          {
            ...
            if ((this.a.c) && (this.a.jdField_a_of_type_AndroidViewView != null) && ((this.a.jdField_a_of_type_AndroidViewView instanceof TroopAioFeedsCenterView)))
            {
              ...
              this.a.jdField_a_of_type_Bfhz.b();
            }
          }
