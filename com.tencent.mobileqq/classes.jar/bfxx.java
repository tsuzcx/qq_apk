  ...
  implements bfyl
{
  ...
  public bfxx(bfxu parambfxu, WheelPickerLayout paramWheelPickerLayout)
  {
    ...
    if (i >= bfxu.a(parambfxu))
    {
      paramWheelPickerLayout.add(5, 1);
      paramWheelPickerLayout.set(11, bfxu.b(parambfxu));
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramWheelPickerLayout.add(12, bfxu.c(parambfxu) - i % bfxu.c(parambfxu));
      }
    }
  }
  ...
  private String b(int paramInt)
  {
    ...
    default: 
      return "";
    case 1: 
      return anni.a(2131714372);
    case 2: 
      return anni.a(2131714385);
    case 3: 
      return anni.a(2131714376);
    case 4: 
      return anni.a(2131714370);
    case 5: 
      return anni.a(2131714368);
    case 6: 
      return anni.a(2131714384);
    }
    return anni.a(2131714386);
  }
  ...
  public int a(int paramInt)
  {
    ...
    default: 
      return 0;
    case 0: 
      return bfxu.d(this.jdField_a_of_type_Bfxu);
    case 1: 
      paramInt = a(new int[] { this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout.a(0) }).get(11);
      return bfxu.a(this.jdField_a_of_type_Bfxu) - paramInt + 1;
    }
    return (60 - a(new int[] { this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout.a(0), this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout.a(1) }).get(12)) / bfxu.c(this.jdField_a_of_type_Bfxu);
  }
  ...
  public int a(Calendar paramCalendar, int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = (int)((paramCalendar.get(12) - l) / bfxu.c(this.jdField_a_of_type_Bfxu));
    if (paramInt1 > 0) {
      return paramInt1;
    }
    return 0;
  ...
  public Calendar a(int... paramVarArgs)
  {
    ...
    if (paramVarArgs[0] > 0)
    {
      ...
      localCalendar.set(11, bfxu.b(this.jdField_a_of_type_Bfxu));
    ...
    if (paramVarArgs.length > 2) {
      localCalendar.add(12, paramVarArgs[2] * bfxu.c(this.jdField_a_of_type_Bfxu));
    }
  ...
  public int[] a(long paramLong)
  {
    ...
    arrayOfInt[2] = ((localCalendar1.get(12) - localCalendar2.get(12)) / bfxu.c(this.jdField_a_of_type_Bfxu));
    return arrayOfInt;
  }
}
