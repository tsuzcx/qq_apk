...
public class azsd
  implements bkhw
{
  public azsd(ProfileCardMoreActivity paramProfileCardMoreActivity, String paramString, bkho parambkho) {}
    ...
    for (;;)
    {
      ...
      if (bgnt.d(BaseApplication.getContext()))
      {
        ...
        if (bgjw.b(this.jdField_a_of_type_JavaLangString)) {
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqProfilesettingProfileCardMoreActivity.app, "dc00898", "", "", "0X8007FDF", "0X8007FDF", 0, 0, "", "", "", "");
        }
        this.jdField_a_of_type_ComTencentMobileqqProfilesettingProfileCardMoreActivity.finish();
      }
      else
      {
        this.jdField_a_of_type_ComTencentMobileqqProfilesettingProfileCardMoreActivity.a(2131691307, 1);
        continue;
        if (bgjw.b(this.jdField_a_of_type_JavaLangString)) {
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqProfilesettingProfileCardMoreActivity.app, "dc00898", "", "", "0X8007FE0", "0X8007FE0", 0, 0, "", "", "", "");
        }
      }
    }
  }
