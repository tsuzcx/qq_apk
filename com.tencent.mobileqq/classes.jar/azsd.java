...
public class azsd
{
  ...
  public static void a(long paramLong, TroopFileTransferManager.Item paramItem)
  {
    ...
    {
      azst.b("TroopFileDataCenter", azst.a, "saveStatus. item.troopuin=0, change to:" + paramLong);
      paramItem.troopuin = paramLong;
    }
    if (paramItem.troopuin == 0L)
    {
      azst.a("TroopFileDataCenter", azst.a, "saveStatus. item.troopuin=0 err");
      return;
    }
  ...
  public static void a(long paramLong, TroopFileTransferManager.Item paramItem, int paramInt1, int paramInt2)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (paramItem.IsNewStatus) {
        azse.a(paramLong, paramItem, paramInt1, paramInt2);
      }
  ...
  public static void a(long paramLong, TroopFileTransferManager.Item paramItem, int paramInt, bajv parambajv)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramItem.ErrorCode = parambajv.a;
      paramItem.Pausing = 0;
      if (paramItem.W2MPause == 1) {
        paramItem.W2MPause = 0;
      }
  ...
  private boolean a()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
        default: 
          if ((!localItem.HasThumbnailFile_Small) || (azun.a(this.b, localItem, 128))) {
            break label180;
          }
          bool = true;
          break;
      ...
      if (!new VFSFile(localItem.LocalFile).exists())
      {
        ...
        continue;
        label180:
        if ((localItem.HasThumbnailFile_Large) && (!azun.a(this.b, localItem, 640)))
        {
          bool = true;
        }
        else if ((localItem.HasThumbnailFile_Middle) && (!azun.a(this.b, localItem, 383)))
        {
          bool = true;
          continue;
          label232:
  ...
  public static void b(long paramLong, TroopFileTransferManager.Item paramItem)
  {
    ...
    if ((jdField_a_of_type_Long == 0L) || (paramItem.StatusUpdateTimeMs == 0L) || (l2 > 5000L) || (l2 < 0L) || (l1 > 1000L) || (l1 < 0L))
    {
      ...
      QQAppInterface localQQAppInterface = azsr.a();
      if (localQQAppInterface != null) {
        ((ajsx)localQQAppInterface.a(22)).a(paramItem.getInfo(paramLong));
      }
    }
  }
  ...
  {
    bajt.a(azsr.a(), paramLong, paramItem.FileName, paramItem.Status, paramInt);
  }
}
