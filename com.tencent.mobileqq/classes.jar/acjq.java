...
public class acjq
  extends QIPCModule
{
  private static acjq a;
  
  public acjq(String paramString)
  {
    super(paramString);
  }
  
  public static acjq a()
  {
    if (a == null) {}
    try
    {
      a = new acjq("HardCoderModule");
      return a;
    }
    finally {}
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if (paramString.equals("start"))
    {
      ...
      localEIPCResult = EIPCResult.createResult(acjl.a().a(paramInt, i, j, k, m, n, l, Process.myTid(), paramString), null);
    }
