...
public class bdej
{
  ...
  public static int a;
  private static bdeo jdField_a_of_type_Bdeo;
  ...
  private static final String c = alud.a(2131715098);
  ...
  public static String a(Context paramContext, Uri paramUri, String paramString1, String paramString2)
  {
    ...
    //   28: aload_2
    //   29: aload_3
    //   30: invokestatic 149	bdej:a	(Landroid/content/Context;Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
  ...
  public static void a(Context paramContext, bdem parambdem, aetk paramaetk)
  {
    jdField_a_of_type_Bdeo.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    jdField_a_of_type_Bdeo.jdField_a_of_type_Aetk = paramaetk;
    parambdem.a(paramaetk);
    parambdem.a(new bdel());
  }
  ...
  {
    if ((paramSessionInfo.jdField_a_of_type_Int != 1) && (paramSessionInfo.jdField_a_of_type_Int != 3000) && (paramSessionInfo.jdField_a_of_type_Int != 0) && (!abti.e(paramSessionInfo.jdField_a_of_type_Int)))
    {
    ...
    paramViewGroup.setOnDragListener(new bdek(localImageView, localColorDrawable1, paramViewGroup, localColorDrawable2, paramContext, paramQQAppInterface, paramSessionInfo));
  }
  ...
  private static bden b(Context paramContext, aeqi paramaeqi)
  {
    long l = 0L;
    Object localObject1;
    if ((paramaeqi instanceof afyc))
    {
      localObject1 = arsx.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramaeqi.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
      l = bdhb.a((String)localObject1);
      paramaeqi = paramaeqi.jdField_a_of_type_AndroidViewView;
    }
    for (;;)
    {
      label76:
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1))
      {
        ...
        if ((paramaeqi instanceof afye))
        {
          localObject1 = arsx.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramaeqi.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
          l = bdhb.a((String)localObject1);
          paramaeqi = ((afye)paramaeqi).a;
          continue;
        }
        if ((paramaeqi instanceof afxa))
        {
          localObject2 = (MessageForPic)paramaeqi.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject3 = ((MessageForPic)localObject2).getBiggestFilePath();
          String str = arrr.a((String)localObject3);
          int i = biqe.a((String)localObject3);
          localObject1 = ".jpg";
          if (i == 1001) {
            localObject1 = ".png";
          }
          for (;;)
          {
            ...
            if ((!bdhb.d(((MessageForPic)localObject2).getBiggestFilePath(), (String)localObject1)) || (TextUtils.isEmpty(str))) {
              break label76;
            }
            l = ((MessageForPic)localObject2).size;
            paramaeqi = ((afxa)paramaeqi).a;
            break;
            if (i == 1005) {
              localObject1 = ".bmp";
            } else if (i == 2000) {
        ...
        if ((paramaeqi instanceof agas))
        {
          localObject2 = (MessageForShortVideo)paramaeqi.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject1 = ShortVideoUtils.a((MessageForShortVideo)localObject2, "mp4");
          l = ((MessageForShortVideo)localObject2).videoFileSize;
          paramaeqi = ((agas)paramaeqi).a;
          continue;
        }
        if ((paramaeqi instanceof agbi))
        {
          localObject2 = (MessageForShortVideo)paramaeqi.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject1 = ShortVideoUtils.a((MessageForShortVideo)localObject2, "mp4");
          l = ((MessageForShortVideo)localObject2).videoFileSize;
          paramaeqi = ((agbi)paramaeqi).a;
        }
      }
      else
      {
        ...
        return new bden((File)localObject2, paramaeqi, ClipData.newUri(paramContext.getContentResolver(), "uri", (Uri)localObject1));
      }
      paramaeqi = null;
      localObject1 = null;
    }
  ...
  private static boolean b(DragEvent paramDragEvent, ImageView paramImageView, ColorDrawable paramColorDrawable1, ViewGroup paramViewGroup, ColorDrawable paramColorDrawable2, Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    paramImageView.setContentView(2131559437);
    ((TextView)paramImageView.findViewById(2131371894)).setText(alud.a(2131715097));
