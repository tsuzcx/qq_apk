...
{
  public aslt(String paramString)
  {
    super(paramString);
  }
  ...
  public int a(String paramString)
  {
    ...
    //   4: istore_2
    //   5: aload_0
    //   6: getfield 19	aslt:mInnerDbHelper	Lcom/tencent/mobileqq/data/QQEntityManagerFactory$SQLiteOpenHelperImpl;
    ...
    //   27: invokestatic 36	asoi:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   30: iconst_0
    //   31: ireturn
    //   32: iload 4
    //   34: istore_3
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (localauko != null)
          {
            ...
            if (localClass == Long.TYPE) {
              localField.set(localauko, Long.valueOf(paramCursor.getLong(k)));
            } else if (localClass == Integer.TYPE) {
              localField.set(localauko, Integer.valueOf(paramCursor.getInt(k)));
            }
          }
        }
        catch (Exception paramClass)
        {
          ...
          if (localClass == String.class) {
            localField.set(localauko, paramCursor.getString(k));
          }
        }
        ...
        {
          localField.set(localauko, Byte.valueOf((byte)paramCursor.getShort(k)));
        }
        else if (localClass == [B.class)
        {
          localField.set(localauko, paramCursor.getBlob(k));
        }
        else if (localClass == Short.TYPE)
        {
          localField.set(localauko, Short.valueOf(paramCursor.getShort(k)));
        }
        else if (localClass == Boolean.TYPE)
        {
          ...
          bool = true;
          localField.set(localauko, Boolean.valueOf(bool));
        }
        else if (localClass == Float.TYPE)
        {
          localField.set(localauko, Float.valueOf(paramCursor.getFloat(k)));
        }
        else if (localClass == Double.TYPE)
        {
          localField.set(localauko, Double.valueOf(paramCursor.getDouble(k)));
          break label554;
          label455:
          if (paramaukz != null)
          {
            paramaukz.a(new NoColumnError(str, localClass));
            break label554;
            label481:
            if ((l != -1L) && (paramString != null)) {
              localauko.setStatus(1001);
            }
            while ((localauko instanceof MsgBackupMsgEntity))
            {
              ((MsgBackupMsgEntity)localauko).postRead();
              return localauko;
              localauko.setStatus(1002);
            }
            paramClass = localauko;
            if (!(localauko instanceof MsgBackupResEntity)) {
              continue;
            }
            ((MsgBackupResEntity)localauko).postRead();
            return localauko;
          }
        }
        label554:
  ...
  public List<MsgBackupExtraEntity> a()
  {
    ...
    {
      asoi.a("MsgBackup_db", "db is null queryExtraInfo ...", new Object[0]);
  ...
  public List<MsgBackupMsgEntity> a(long paramLong, int paramInt)
  {
    ...
    if (localObject2 == null)
    {
      asoi.a("MsgBackup_db", "db is null queryMsg ..125.", new Object[0]);
      return new ArrayList();
    }
    localObject1 = ((SQLiteDatabase)localObject2).rawQuery((String)localObject1, null);
  ...
  public List<MsgBackupResEntity> a(long paramLong1, long paramLong2)
  {
    ...
    if (localObject2 == null)
    {
      asoi.a("MsgBackup_db", "db is null queryRes ...", new Object[0]);
      return new ArrayList();
    }
    localObject1 = ((SQLiteDatabase)localObject2).rawQuery((String)localObject1, null);
  ...
  protected List<? extends auko> a(Class<? extends auko> paramClass, String paramString, Cursor paramCursor, aukz paramaukz)
  {
    localObject4 = null;
    ...
    catch (Exception paramClass)
    {
      do
      {
        try
        {
          localauko = a(paramClass, paramString, paramCursor, paramaukz);
          ...
          try
          {
            ...
            ((List)localObject2).add(localauko);
            localObject1 = localObject2;
          }
  ...
  public int b(String paramString)
  {
    ...
    //   28: invokestatic 36	asoi:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   31: iconst_0
    //   32: ireturn
    //   33: iload 4
    //   35: istore_3
  ...
  public List<MsgBackupResEntity> b(long paramLong, int paramInt)
  {
    ...
    if (localObject2 == null)
    {
      asoi.a("MsgBackup_db", "db is null queryRes ...135", new Object[0]);
      return new ArrayList();
    }
    localObject1 = ((SQLiteDatabase)localObject2).rawQuery((String)localObject1, null);
    localObject2 = a(MsgBackupResEntity.class, "res", (Cursor)localObject1, null);
  ...
  public void createDatabase(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    {
      asoi.b("MsgBackup_db", "db create is null", new Object[0]);
      return;
    }
    paramSQLiteDatabase.execSQL(aulp.a(new MsgBackupMsgEntity()));
    paramSQLiteDatabase.execSQL(aulp.a(new MsgBackupResEntity()));
    paramSQLiteDatabase.execSQL(aulp.a(new MsgBackupExtraEntity()));
  }
