  ...
  extends BaseAdapter
{
  ...
  protected List<aspq> a;
  protected Map<Integer, ArrayList<View>> a;
  public int b;
  protected List<aspq> b;
  protected int c;
  protected List<aspq> c;
  public int d;
  protected int e;
  ...
  public aslt(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, asmr paramasmr)
  {
    ...
    this.e = paramContext.getResources().getColor(2131166504);
    this.jdField_a_of_type_Float = paramContext.getResources().getDisplayMetrics().density;
  }
  
  public abstract View a(aslu paramaslu, int paramInt, View paramView, ViewGroup paramViewGroup);
  ...
  public RelativeLayout a()
  {
    ...
    try
    {
      ...
      localLayoutParams.addRule(2, 2131365952);
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject != null) && (((ArrayList)localObject).size() > 0))
        {
          ...
          while (i < ((ArrayList)localObject).size())
          {
            ...
            Integer localInteger = (Integer)localView.getTag(2131365995);
            if (aspy.jdField_a_of_type_Int == localInteger.intValue()) {
              aspy.a().a(j, localView);
            }
            i += 1;
          }
        }
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    do
    {
      ...
      paramView.setTag(2131365995, Integer.valueOf(this.d));
  ...
  public void a(View paramView, aspq paramaspq)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      paramaspq = (URLImageView)paramView.findViewById(2131365947);
      long l = System.currentTimeMillis();
      localObject2 = ((asmu)localObject1).a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Float);
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "getDrawable cost = " + (System.currentTimeMillis() - l));
      }
      paramaspq.setImageDrawable((Drawable)localObject2);
      paramaspq.setVisibility(0);
    } while (!(localObject1 instanceof asre));
    paramaspq = (asre)localObject1;
    Object localObject1 = (TextView)paramView.findViewById(2131365952);
    if (paramaspq.a != null)
    {
      localObject2 = paramaspq.a.name;
  ...
  {
    if (paramView == null) {}
    for (Object localObject = a();; localObject = (aslu)paramView.getTag())
    {
      localObject = a((aslu)localObject, paramInt, paramView, paramViewGroup);
