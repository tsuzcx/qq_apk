  ...
  extends akbj
{
  ...
  public aymy(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
    super(paramQQAppInterface, paramProxyManager);
    this.jdField_a_of_type_JavaUtilComparator = new aymz(this);
  }
  ...
  protected int a(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    atmx localatmx = a();
    String str = "( msgtype " + akbm.b() + " and isValid=1 ) and shmsgseq <= ?";
    long l = paramMessageRecord.shmsgseq;
    paramString = localatmx.a(false, paramString, new String[] { "_id" }, str, new String[] { String.valueOf(l) }, null, null, null, null);
    paramInt = i;
    if (paramString != null)
    {
  ...
  public MessageRecord a(String paramString, int paramInt, MessageRecord paramMessageRecord, List<MessageRecord> paramList)
  {
    ...
    label43:
    if (paramInt >= 0) {
      if (akbm.a((MessageRecord)paramList.get(paramInt), paramMessageRecord, true, true)) {
  ...
  public List<MessageRecord> a(String paramString, int paramInt1, long paramLong1, int paramInt2, long paramLong2, int paramInt3, int[] paramArrayOfInt)
  {
    ...
    paramString = badk.a(MessageRecord.getOldTableName(paramString, paramInt1), MessageRecord.getTableName(paramString, paramInt1), paramLong1, paramInt2, paramLong2, (String)localObject1, paramInt3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b());
    if (paramString == null) {
  ...
  protected List<MessageRecord> a(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localMessageRecord.shmsgseq == paramLong1) && ((!localMessageRecord.isSendFromLocal()) || (localMessageRecord.extraflag == 0)) && (!akbm.a(localMessageRecord))) {
  ...
  protected List<MessageRecord> a(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      synchronized (akbi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt))
      {
        ...
        if (Looper.myLooper() == Looper.getMainLooper())
        {
          ...
          localObject4 = a(paramString, paramInt, (awrt)localObject1);
          if ((((awrt)localObject1).jdField_b_of_type_Int != 0) && (awrn.a()) && (awrn.a(1)))
          {
            localObject2 = new HashMap();
            ((HashMap)localObject2).put("param_IsMainThread", String.valueOf(((awrt)localObject1).jdField_a_of_type_Int));
            ((HashMap)localObject2).put("param_OptType", ((awrt)localObject1).jdField_a_of_type_JavaLangString);
            ((HashMap)localObject2).put("param_OptTotalCost", String.valueOf(((awrt)localObject1).jdField_a_of_type_Long));
            ((HashMap)localObject2).put("param_OptCount", String.valueOf(((awrt)localObject1).jdField_b_of_type_Int));
            ((HashMap)localObject2).put("param_OptMsgCount", String.valueOf(((awrt)localObject1).c));
            ((HashMap)localObject2).put("param_OptOneCost", String.valueOf(((awrt)localObject1).jdField_b_of_type_Long));
            ((HashMap)localObject2).put("param_OptScene", ((awrt)localObject1).jdField_b_of_type_JavaLangString);
            ((HashMap)localObject2).put("param_WalSwitch", String.valueOf(ajrl.a));
            awrn.a(BaseApplication.getContext()).a(null, "actSqliteOptCost", true, ((awrt)localObject1).c, 0L, (HashMap)localObject2, null, false);
          }
    ...
    label541:
    new ArrayList();
    Object localObject2 = akbm.a((List)localObject4, false);
    ...
    if ((!akbm.a(paramString, paramInt, (List)localObject2)) && (akbm.b((List)localObject2)))
    {
      localObject1 = localObject2;
      if (!akbm.c((List)localObject2)) {}
    }
    else
    {
      if (QLog.isColorLevel()) {
      ...
      localObject1 = akbm.a((List)localObject4, false, 30);
    }
    if ((!akbm.a((List)localObject1)) && (localObject1 != null) && (!((List)localObject1).isEmpty()))
    {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject1 = akbm.a((List)localObject2, true);
        break label852;
        label1087:
  ...
  protected void a(SessionInfo paramSessionInfo, String paramString, int paramInt, Set<String> paramSet)
  {
    ...
    paramSessionInfo = ((ajhh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramString);
    paramString = paramSessionInfo.iterator();
    while (paramString.hasNext()) {
  ...
  protected void a(String paramString, int paramInt, long paramLong)
  {
    ...
    {
      a(paramString, paramInt, str2, localContentValues, String.format("isread=? and %s<=? and " + akbm.d(), new Object[] { "shmsgseq" }), new String[] { "0", str1 }, null);
      return;
    }
  ...
  protected void a(String paramString, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      synchronized (akbi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).a(paramString, paramInt))
      {
        ...
        if ((paramMessageRecord.isSendFromLocal()) || ((akbm.a(paramMessageRecord)) && (paramMessageRecord.msgtype != -4012) && (paramMessageRecord.msgtype != -4009) && (paramMessageRecord.msgtype != -5001) && (paramMessageRecord.msgtype != -5021)) || (akbm.f(paramMessageRecord)))
        {
          if ((localObject3 == null) || (((List)localObject3).isEmpty()) || (((MessageRecord)((List)localObject3).get(((List)localObject3).size() - 1)).shmsgseq <= 0L)) {
            break label618;
          }
          if ((!akbm.i(paramMessageRecord.msgtype)) || (paramMessageRecord.shmsgseq <= 0L)) {}
        }
        else
        {
          ...
          if ((localObject3 != null) && (((List)localObject3).size() > 40) && (!akbm.a(paramString)))
          {
            ...
            if ((akdn.a) && (((MsgLruCache)localObject3).getCacheType(localObject1) == akdn.d)) {
          ...
          if ((akbi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).b().containsKey(localObject1)) && (paramBoolean))
          {
            ...
            if ((paramMessageRecord.msgtype == -2006) && (agjk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, paramString)) && ((paramMessageRecord instanceof MessageForFoldMsg)) && (!paramMessageRecord.isSend()))
            {
              ...
              this.jdField_a_of_type_Agjk.a((List)localObject1, (MessageForFoldMsg)paramMessageRecord);
            }
          }
          return;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.TroopMsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + apck.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong1 + "] msgUid[" + paramLong2 + "]");
    }
    ...
    paramString = localatmx.a(paramString, new String[] { String.valueOf(paramLong1) }, localQQAppInterface);
    if (paramString != null) {
      return paramString;
    }
    return new ArrayList();
