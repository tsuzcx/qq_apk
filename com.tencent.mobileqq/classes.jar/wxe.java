...
public class wxe
{
  ...
  {
    return ImageLoader.getInstance().loadImage(paramString, new wxf(this, paramView));
  }
  ...
  private AnimationSet a()
  {
    ...
    localScaleAnimation.setAnimationListener(new wxg(this));
  ...
  private AnimationSet b()
  {
    ...
    localScaleAnimation.setAnimationListener(new wxh(this));
    localAnimationSet.addAnimation(localScaleAnimation);
    return localAnimationSet;
  }
  ...
  private AnimationSet c()
  {
    if (this.b != null)
    {
      ...
      localScaleAnimation.setAnimationListener(new wxi(this));
      localAnimationSet.addAnimation(localScaleAnimation);
  ...
  public void a(FrameLayout paramFrameLayout, View paramView, String paramString)
  {
    ...
    paramFrameLayout = wxm.a().a(paramString);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131298288));
    ...
    this.b = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131313599));
