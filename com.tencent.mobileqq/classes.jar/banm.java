...
public class banm
{
  ...
  public static void a(Activity paramActivity, String paramString, banr parambanr)
  {
    ...
    paramActivity = bdgm.a(paramActivity, 0, null, paramActivity.getString(2131719873), paramActivity.getString(2131690648), paramActivity.getString(2131691089), new banp(parambanr), new banq(parambanr));
    paramActivity.show();
    paramActivity.setCancelable(false);
    a("0X800A5C9");
  }
  
  public static void a(baot parambaot)
  {
    if (b()) {
  ...
  public static void a(boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2)
  {
    ...
    String str = localBaseActivity.getString(2131719876);
    if (!paramBoolean1) {
      str = localBaseActivity.getString(2131719872);
    }
    paramString1 = bdgm.a(localBaseActivity, 0, null, str, localBaseActivity.getString(2131690648), localBaseActivity.getString(2131691089), new bann(paramBoolean1, paramBoolean2), new bano(paramString1, paramString2));
    paramString1.show();
  ...
  public static boolean a(Activity paramActivity, String paramString, banr parambanr)
  {
    if ((paramActivity == null) || (paramActivity.isFinishing())) {}
    while (!b()) {
      return false;
    ...
    if ((paramActivity.getResources().getConfiguration().uiMode & 0x30) == 32)
    {
      ...
      a(paramActivity, paramString, parambanr);
    }
    for (;;)
    {
      return true;
      ...
      break;
      label141:
      ThreadManager.getUIHandler().post(new DarkModeManager.6(paramActivity, paramString, parambanr));
    }
  }
  ...
  private static void b(baot parambaot)
  {
    Object localObject;
    if (azmk.b())
    {
    ...
    for (;;)
    {
      ...
      ThemeSwitcher.a((String)localObject, "202", parambaot);
      return;
      localObject = baos.a(b());
  ...
  private static void b(boolean paramBoolean1, boolean paramBoolean2, baot parambaot)
  {
