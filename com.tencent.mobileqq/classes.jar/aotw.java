...
public class aotw
  implements Runnable
{
  public aotw(EditWebDanceMachineVideoActivity paramEditWebDanceMachineVideoActivity, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_Int == 0)
    {
      ...
      if (i != 0) {
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureActivityEditWebDanceMachineVideoActivity.runOnUiThread(new aotx(this, i));
      }
    }
    Object localObject;
    do
    {
      ...
      if (EditWebDanceMachineVideoActivity.a(this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureActivityEditWebDanceMachineVideoActivity) == null) {
        EditWebDanceMachineVideoActivity.a(this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureActivityEditWebDanceMachineVideoActivity, new aoty(this, (Bitmap)localObject));
      }
