  ...
  extends trh
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "http://story.now.qq.com/mobile/transfer.html?src_type=app&version=1&fromId=17&videoOwnerUin=%s&videoId=%s&unionid=%s&feedid=%s&ptype=%d&identify=1&actionnamekey=1&storysharefrom=%s&sharefromtype=%d&one_page=0" + sxp.a(2131699674);
  }
  
  public tqh(ShareGroupItem paramShareGroupItem, StoryVideoItem paramStoryVideoItem, String paramString, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_e_of_type_JavaLangString = localtdo.a(this.f, false);
    this.c = bbjw.a(paramShareGroupItem.name, 0, 16, "...");
    this.g = paramStoryVideoItem.mDoodleText;
    this.jdField_d_of_type_JavaLangString = a();
    this.k = (ajyc.a(2131713907) + this.c + ajyc.a(2131713915) + ssi.jdField_a_of_type_JavaLangString);
    this.l = (this.c + "\n" + paramInt2 + ajyc.a(2131713911));
