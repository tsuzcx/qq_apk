...
public class bnis
{
  ...
  private bnhu jdField_a_of_type_Bnhu = new bnhu();
  ...
  private void e(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_Bnhu.a(paramFloat1, paramFloat2);
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_Bnhu.a(this.jdField_b_of_type_AndroidGraphicsRectF, a());
  }
  ...
  public bnip a(float paramFloat1, float paramFloat2)
  {
    RectF localRectF = this.jdField_a_of_type_Bnhu.a(paramFloat1, paramFloat2);
    ...
    return new bnip(this.jdField_b_of_type_AndroidGraphicsRectF.centerX() - localRectF.centerX() + paramFloat1, this.jdField_b_of_type_AndroidGraphicsRectF.centerY() - localRectF.centerY() + paramFloat2, c(), b());
  }
  
  public bnip a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    this.jdField_a_of_type_Bnhu.d(false);
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor != null)
    {
      this.jdField_a_of_type_Bnhu.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor, paramFloat3, paramFloat4);
      ...
      RectF localRectF2 = this.jdField_a_of_type_Bnhu.a(paramFloat1, paramFloat2);
      bnip localbnip = new bnip(paramFloat1, paramFloat2, c(), a());
      localbnip.a(bnht.b(localRectF2, localRectF1, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
      return localbnip;
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_Bnhu.c()) {}
  ...
  {
    this.jdField_a_of_type_Bnhu.a(paramCanvas);
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Bnhu.a();
  }
  ...
  public boolean a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Bnhu.a(false);
      this.jdField_a_of_type_Bnhu.b(true);
      this.jdField_a_of_type_Bnhu.c(false);
      return paramBoolean;
    }
  }
  ...
  public bnip b(float paramFloat1, float paramFloat2)
  {
    return new bnip(paramFloat1, paramFloat2, c(), b());
  }
  ...
  public void b(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor = this.jdField_a_of_type_Bnhu.a(paramFloat1, paramFloat2);
  }
  ...
  {
    this.jdField_a_of_type_Bnhu.c(paramBoolean);
  }
  ...
  public bnip c(float paramFloat1, float paramFloat2)
  {
    bnip localbnip = new bnip(paramFloat1, paramFloat2, c(), a());
    RectF localRectF1 = new RectF(this.jdField_a_of_type_Bnhu.a());
    localRectF1.offset(paramFloat1, paramFloat2);
    if (this.jdField_a_of_type_Bnhu.d())
    {
      ...
      localbnip.a(bnht.a(localRectF1, localRectF2));
      return localbnip;
    }
    RectF localRectF2 = new RectF();
    if (this.jdField_a_of_type_Bnhu.b())
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_Bnhu.a(paramFloat1, paramFloat2));
      localbnip.a(bnht.a(localRectF1, localRectF2, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
      return localbnip;
    }
    this.jdField_a_of_type_AndroidGraphicsMatrix.setRotate(a(), this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY());
    this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_AndroidGraphicsRectF);
    localbnip.a(bnht.b(localRectF1, localRectF2, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
    return localbnip;
  }
  ...
  {
    this.jdField_a_of_type_Bnhu.a(paramFloat);
  }
  ...
  public void d(float paramFloat1, float paramFloat2)
  {
    ...
    a();
    this.jdField_a_of_type_Bnhu.d(true);
  }
