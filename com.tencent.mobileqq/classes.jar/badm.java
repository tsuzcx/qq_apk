...
public class badm
{
  public static asyd a(badq parambadq)
  {
    if (parambadq != null)
    {
      asyd localasyd = new asyd();
      localasyd.jdField_c_of_type_JavaLangString = parambadq.b;
      String str = parambadq.jdField_a_of_type_JavaLangString;
      localasyd.jdField_a_of_type_JavaLangString = str;
      localasyd.d = str;
      localasyd.jdField_a_of_type_Long = parambadq.jdField_a_of_type_Int;
      localasyd.jdField_c_of_type_Boolean = true;
      return localasyd;
    }
    return null;
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    return c(((badj)paramQQAppInterface.getManager(346)).a(paramString1, paramString2));
  }
  ...
  public static ArrayList<bfvv> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    paramString = ((badj)paramQQAppInterface.getManager(346)).a(paramString);
    ...
    {
      badq localbadq = (badq)paramString.next();
      bfvv localbfvv = new bfvv();
      localbfvv.jdField_a_of_type_JavaLangString = localbadq.b;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, NavBarAIO paramNavBarAIO, ImageView paramImageView1, ImageView paramImageView2, boolean paramBoolean)
  {
    ...
    ((badj)paramQQAppInterface.getManager(346)).a(paramString, paramQQAppInterface.getCurrentAccountUin(), new badn(paramNavBarAIO, paramImageView1, paramImageView2, paramBoolean, paramQQAppInterface, paramString, paramActivity));
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    return !((bamk)paramQQAppInterface.getManager(203)).b(paramMessageRecord.senderuin);
  }
  ...
  public static String b(List<badq> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      return "";
    }
    ...
    while (i < paramList.size())
    {
      localStringBuilder.append(((badq)paramList.get(i)).jdField_a_of_type_Int);
      if (i != paramList.size() - 1) {
        localStringBuilder.append("|");
      }
      i += 1;
  ...
  public static String c(List<badq> paramList)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (paramList.hasNext()) {
        localStringBuilder.append(((badq)paramList.next()).jdField_a_of_type_JavaLangString);
      }
    }
    return localStringBuilder.toString();
  }
