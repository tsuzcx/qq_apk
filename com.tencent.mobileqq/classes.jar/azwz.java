  ...
  extends azut
{
  ...
  public azwz(Collection<azus> paramCollection)
  {
  ...
  {
    return aepi.a(5.0F, paramResources);
  }
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    int n = localResources.getDimensionPixelSize(2131298817);
    int i1 = localResources.getDimensionPixelSize(2131298818);
    int i = aepi.a(5.0F, localResources);
    ...
    for (int k = 6;; k = 10)
    {
      ...
      if ((paramView != null) && ((paramView instanceof LinearLayout)))
      {
        ...
        if (j < k)
        {
          localObject2 = (azus)((ArrayList)localObject1).get(j);
          ...
          localView = ((azus)localObject2).a(paramContext, paramView.getChildAt(j), paramBundle);
          if (localView != null) {}
        }
        else
        {
      ...
      for (int j = a(paramContext, k) + i;; j = i)
      {
        ...
        i = j;
        break;
        m = aepi.a(10.0F, localResources);
        LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, -2);
        if (j > 0) {
          localLayoutParams.topMargin = a(localResources, j, (azus)localObject2);
        }
        ...
        if (j < k)
        {
          ...
          localView = ((azus)localObject2).a(paramContext, null, paramBundle);
          if (localView == null) {
            break label197;
          }
          m = aepi.a(10.0F, localResources);
