  ...
  implements Manager
{
  ...
  public azwz(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Azxb = new azxb(this, null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Azxb);
    this.jdField_a_of_type_Azxa = new azxa(this, null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Azxa);
    this.jdField_a_of_type_Azxc = new azxc(this, null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Azxc);
  ...
  private void a(int paramInt, Object paramObject, boolean paramBoolean, Object... paramVarArgs)
  {
    ...
    Object localObject;
    boolean bool1;
    if (((paramObject instanceof azwv)) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      localObject = (azwv)paramObject;
      if ((TextUtils.isEmpty(((azwv)localObject).a)) || (!((azwv)localObject).a.equals((String)paramVarArgs[0]))) {
        break label272;
      }
      bool1 = true;
    }
    for (;;)
    {
      ...
      return;
      if (((paramObject instanceof azwu)) && (paramVarArgs != null) && (paramVarArgs.length > 1))
      {
        localObject = (azwu)paramObject;
        bool1 = bool2;
        if (!TextUtils.isEmpty(((azwu)localObject).a))
        {
          bool1 = bool2;
          if (((azwu)localObject).a.equals((String)paramVarArgs[1])) {
            bool1 = true;
          }
        }
      }
      ...
      {
        if (((paramObject instanceof azww)) && (paramVarArgs != null) && (paramVarArgs.length > 1))
        {
          localObject = (azww)paramObject;
          if ((!TextUtils.isEmpty(((azww)localObject).a)) && (((azww)localObject).a.equals((String)paramVarArgs[1])))
          {
            bool1 = true;
            continue;
          }
  ...
  public String a(FaceInfo paramFaceInfo)
  {
    ...
    if (azzu.a()) {
      localStringBuilder.append(ajed.bC);
    }
    for (;;)
    {
    ...
    if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0)) {
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if (localIterator.hasNext()) {
          a(paramInt, (azwt)localIterator.next(), paramBoolean, paramVarArgs);
        }
      }
    }
  }
  ...
  public void a(FaceInfo paramFaceInfo)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 220	azwz:jdField_a_of_type_ComTencentMobileqqAppNearByFaceDownloader	Lcom/tencent/mobileqq/app/NearByFaceDownloader;
    //   6: astore_2
    //   7: aload_2
    //   8: ifnonnull +18 -> 26
    //   11: aload_0
    ...
    //   15: dup
    //   16: aload_0
    //   17: getfield 39	azwz:jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface	Lcom/tencent/mobileqq/nearby/NearbyAppInterface;
    ...
    //   23: putfield 220	azwz:jdField_a_of_type_ComTencentMobileqqAppNearByFaceDownloader	Lcom/tencent/mobileqq/app/NearByFaceDownloader;
    //   26: aload_0
    //   27: getfield 220	azwz:jdField_a_of_type_ComTencentMobileqqAppNearByFaceDownloader	Lcom/tencent/mobileqq/app/NearByFaceDownloader;
    //   30: ifnull +11 -> 41
    //   33: aload_0
    //   34: getfield 220	azwz:jdField_a_of_type_ComTencentMobileqqAppNearByFaceDownloader	Lcom/tencent/mobileqq/app/NearByFaceDownloader;
    //   37: aload_1
  ...
  public void a(Object paramObject)
  {
    ...
    {
      return;
      if ((paramObject instanceof azwt)) {
        synchronized (this.jdField_a_of_type_JavaUtilList)
        {
          if (!this.jdField_a_of_type_JavaUtilList.contains(paramObject)) {
            this.jdField_a_of_type_JavaUtilList.add((azwt)paramObject);
          }
          return;
        }
      }
      if ((paramObject instanceof azws)) {
        synchronized (this.b)
        {
          if (!this.b.contains(paramObject)) {
            this.b.add((azws)paramObject);
          }
          return;
        }
      }
    } while (!(paramObject instanceof azwx));
    synchronized (this.c)
    {
      if (!this.c.contains(paramObject)) {
        this.c.add((azwx)paramObject);
      }
      return;
    }
  }
  ...
  public final void b(int paramInt, boolean paramBoolean, Object... paramVarArgs)
  {
    if ((this.b != null) && (this.b.size() > 0)) {
      synchronized (this.b)
      {
        ...
        if (localIterator.hasNext()) {
          a(paramInt, (azws)localIterator.next(), paramBoolean, paramVarArgs);
        }
      }
    }
  }
  ...
  public final void c(int paramInt, boolean paramBoolean, Object... paramVarArgs)
  {
    if ((this.c != null) && (this.c.size() > 0)) {
      synchronized (this.c)
      {
        ...
        if (localIterator.hasNext()) {
          a(paramInt, (azwx)localIterator.next(), paramBoolean, paramVarArgs);
        }
      }
    }
  }
  ...
  public void onDestroy()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Azxb);
      this.b.clear();
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Azxa);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Azxc);
    }
  }
}
