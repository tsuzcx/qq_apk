  ...
  implements amhp
{
  ...
  private amhr(amhd paramamhd)
  {
    b();
    SharedPreferences localSharedPreferences = paramamhd.a.getApp().getSharedPreferences("apollo_sp" + paramamhd.a.c(), 0);
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.content = anni.a(2131699271);
    this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem.show_counts = 1;
    this.jdField_a_of_type_Amhd.c(this.jdField_a_of_type_ComTencentMobileqqDrawerPushItem);
    a(true);
  }
  ...
  private void a(java.util.Map<java.lang.String, java.lang.String> paramMap, int paramInt, java.lang.String paramString)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: getstatic 152	amhq:jdField_a_of_type_Boolean	Z
    //   5: ifne +30 -> 35
    //   8: ldc 154
    //   10: iconst_1
    //   11: iconst_2
    ...
    //   20: dup
    //   21: iconst_1
    //   22: getstatic 152	amhq:jdField_a_of_type_Boolean	Z
    ...
    //   34: return
    //   35: aload_0
    //   36: getfield 19	amhr:jdField_a_of_type_Amhd	Lamhd;
    //   39: getfield 29	amhd:a	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   57: aload_0
    //   58: getfield 19	amhr:jdField_a_of_type_Amhd	Lamhd;
    //   61: getfield 29	amhd:a	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   315: istore 4
    //   317: aload_0
    //   318: getfield 19	amhr:jdField_a_of_type_Amhd	Lamhd;
    //   321: aload 7
    //   323: invokevirtual 137	amhd:c	(Lcom/tencent/mobileqq/DrawerPushItem;)V
    //   326: aload 6
    ...
    //   347: aload_0
    //   348: iconst_1
    //   349: invokevirtual 230	amhr:b	(Z)V
    //   352: aload_0
    //   353: getfield 232	amhr:e	Z
    //   356: ifeq +32 -> 388
    //   359: aload_0
    //   360: getfield 19	amhr:jdField_a_of_type_Amhd	Lamhd;
    //   363: getfield 29	amhd:a	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   366: sipush 211
    //   369: invokevirtual 236	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   372: checkcast 238	amgz
    //   375: getfield 241	amgz:a	Lamzs;
    //   378: aload_0
    //   379: getfield 19	amhr:jdField_a_of_type_Amhd	Lamhd;
    //   382: getfield 29	amhd:a	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   385: invokevirtual 244	amzs:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   388: ldc 154
    //   390: iconst_1
    //   391: iconst_4
  ...
  private void b()
  {
    this.b = amhd.a(this.jdField_a_of_type_Amhd.a);
    this.jdField_a_of_type_Int = amhd.a(this.jdField_a_of_type_Amhd.a);
  }
  ...
  private void c(boolean paramBoolean)
  {
    ...
    //   2: aload_0
    //   3: iload_1
    //   4: putfield 232	amhr:e	Z
    //   7: iload_1
    //   8: ifeq +10 -> 18
    //   11: aload_0
    //   12: invokespecial 24	amhr:b	()V
    //   15: aload_0
    //   16: monitorexit
    //   17: return
    //   18: aload_0
    //   19: getfield 91	amhr:jdField_a_of_type_ComTencentMobileqqDrawerPushItem	Lcom/tencent/mobileqq/DrawerPushItem;
    //   22: ifnull -7 -> 15
    //   25: aload_0
    //   26: getfield 19	amhr:jdField_a_of_type_Amhd	Lamhd;
    //   29: aload_0
    //   30: getfield 91	amhr:jdField_a_of_type_ComTencentMobileqqDrawerPushItem	Lcom/tencent/mobileqq/DrawerPushItem;
    //   33: invokevirtual 268	amhd:a	(Lcom/tencent/mobileqq/DrawerPushItem;)V
    //   36: aload_0
    //   37: aconst_null
    //   38: putfield 91	amhr:jdField_a_of_type_ComTencentMobileqqDrawerPushItem	Lcom/tencent/mobileqq/DrawerPushItem;
    //   41: goto -26 -> 15
    //   44: astore_2
    //   45: aload_0
    //   46: monitorexit
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      this.c = paramBoolean;
      SharedPreferences.Editor localEditor = this.jdField_a_of_type_Amhd.a.getApp().getSharedPreferences("apollo_sp" + this.jdField_a_of_type_Amhd.a.c(), 0).edit();
      if (paramBoolean) {
        i = 1;
      }
  ...
  public boolean a(MessageForApollo paramMessageForApollo)
  {
    ...
    try
    {
      if (amhq.jdField_a_of_type_Boolean)
      {
        bool1 = bool2;
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          if (this.b)
          {
            ...
            {
              bool1 = bool2;
              if (!amzu.jdField_a_of_type_Boolean)
              {
                bool1 = bool2;
                if (!paramMessageForApollo.isSend())
                {
                  ...
                  if (paramMessageForApollo.is3dAction())
                  {
                    ...
                    this.jdField_a_of_type_Amhd.a.getApp().getSharedPreferences("apollo_sp" + this.jdField_a_of_type_Amhd.a.c(), 0).edit().putInt("key_panel_meet_3d_action", 1).commit();
                    a();
                    ((amgz)this.jdField_a_of_type_Amhd.a.getManager(211)).a.a(this.jdField_a_of_type_Amhd.a);
  ...
  public boolean b()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 74	amhr:d	Z
    //   6: ifeq +17 -> 23
    //   9: getstatic 271	amzu:jdField_a_of_type_Boolean	Z
    //   12: istore_1
    //   13: iload_1
    //   14: ifne +9 -> 23
    //   17: iconst_1
