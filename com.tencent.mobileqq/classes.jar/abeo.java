...
public class abeo
{
  public static AppRuntime a(BaseApplicationImpl paramBaseApplicationImpl, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        paramBaseApplicationImpl = blsb.b(paramBaseApplicationImpl, "qzone");
        paramBaseApplicationImpl.setAsToolRuntime();
        return paramBaseApplicationImpl;
      }
      if (paramString.equals(str + ":qzonevideo")) {
        return blsb.e(paramBaseApplicationImpl, "qzonevideo");
      }
      if (paramString.equals(str + ":qzonelive")) {
        return blsb.c(paramBaseApplicationImpl, "qzonelive");
      }
      if (paramString.equals(str + ":picture")) {
        return blsb.d(paramBaseApplicationImpl, "picture");
      }
      ...
      if (paramString.equals(str + ":photoedit"))
      {
        ...
        bcst.a(paramBaseApplicationImpl);
        return paramBaseApplicationImpl;
      }
      ...
      {
        paramBaseApplicationImpl = bmyh.a(paramBaseApplicationImpl);
        bcst.a(paramBaseApplicationImpl);
        return paramBaseApplicationImpl;
      }
      if (paramString.equals(str + ":qwallet"))
      {
        ...
        bcst.a((PluginRuntime)paramBaseApplicationImpl);
        return paramBaseApplicationImpl;
      }
      if (paramString.equals(str + ":qqfav")) {
        return bljn.a(paramBaseApplicationImpl);
      }
      if (paramString.equals(str + ":qlink")) {
        return blhv.a(paramBaseApplicationImpl, "qlink");
      }
      ...
      try
      {
        ...
        if (paramString.equals(str + ":dataline")) {
          return bliw.a(paramBaseApplicationImpl, "dataline");
        }
        if (paramString.equals(str + ":smartdevice")) {
          return bmqo.a(paramBaseApplicationImpl, "smartdevice");
        }
        ...
        {
          paramBaseApplicationImpl = bmra.a(paramBaseApplicationImpl, "troop_member_card_plugin.apk");
          bcst.a((PluginRuntime)paramBaseApplicationImpl);
          return paramBaseApplicationImpl;
        }
        if (paramString.equals(str + ":troopmanage"))
        {
          paramBaseApplicationImpl = bmra.a(paramBaseApplicationImpl, "troop_manage_plugin.apk");
          bcst.a((PluginRuntime)paramBaseApplicationImpl);
          return paramBaseApplicationImpl;
        }
        ...
        if (paramString.equals(str + ":groupvideo")) {
          return bldj.a(paramBaseApplicationImpl, "groupvideo");
        }
