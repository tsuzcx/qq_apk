...
public class auog
{
  ...
  {
    return bhmh.a(paramLong, paramInt);
  }
  
  public static String a(Context paramContext)
  {
    paramContext = new File(bhjx.a(paramContext) + "thumbnails/");
  ...
  public static boolean a(File paramFile1, File paramFile2)
  {
    ...
    //   7: istore_2
    //   8: aload_0
    //   9: invokevirtual 240	java/io/File:isFile	()Z
    //   12: ifeq +89 -> 101
    //   15: aload_1
    //   16: invokevirtual 18	java/io/File:exists	()Z
    //   19: ifeq +8 -> 27
    //   22: aload_1
    //   23: invokevirtual 233	java/io/File:delete	()Z
    //   26: pop
    //   27: new 205	java/io/FileOutputStream
    //   30: dup
    //   31: aload_1
    //   32: invokespecial 242	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   35: astore 4
    ...
    //   54: aload 5
    //   56: aload 6
    //   58: invokevirtual 249	java/io/FileInputStream:read	([B)I
    //   61: istore_3
    //   62: iload_3
    //   63: iconst_m1
    ...
    //   83: ifnull +8 -> 91
    //   86: aload 4
    //   88: invokevirtual 254	java/io/FileOutputStream:close	()V
    //   91: aload 5
    //   93: ifnull +8 -> 101
    //   96: aload 5
    //   98: invokevirtual 255	java/io/FileInputStream:close	()V
    //   101: aload_0
    //   102: invokevirtual 73	java/io/File:isDirectory	()Z
    //   105: ifeq +135 -> 240
    //   108: aload_0
    //   109: invokevirtual 159	java/io/File:listFiles	()[Ljava/io/File;
    //   112: astore_0
    //   113: aload_1
    //   114: invokevirtual 258	java/io/File:mkdir	()Z
    //   117: pop
    //   118: iload_2
    //   119: aload_0
    //   120: arraylength
    ...
    //   125: iload_2
    //   126: aaload
    //   127: invokevirtual 262	java/io/File:getAbsoluteFile	()Ljava/io/File;
    ...
    //   141: aload_1
    //   142: invokevirtual 262	java/io/File:getAbsoluteFile	()Ljava/io/File;
    //   145: invokevirtual 265	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   148: getstatic 154	java/io/File:separator	Ljava/lang/String;
    //   151: invokevirtual 97	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   154: aload_0
    //   155: iload_2
    //   156: aaload
    //   157: invokevirtual 67	java/io/File:getName	()Ljava/lang/String;
    ...
    //   169: invokestatic 267	auog:a	(Ljava/io/File;Ljava/io/File;)Z
    //   172: pop
    //   173: iload_2
    //   174: iconst_1
    //   175: iadd
    ...
    //   177: goto -59 -> 118
    //   180: aload 4
    //   182: invokevirtual 268	java/io/FileOutputStream:flush	()V
    //   185: aload 4
    //   187: ifnull +8 -> 195
    //   190: aload 4
    //   192: invokevirtual 254	java/io/FileOutputStream:close	()V
    //   195: aload 5
    //   197: ifnull -96 -> 101
    //   200: aload 5
    //   202: invokevirtual 255	java/io/FileInputStream:close	()V
    //   205: goto -104 -> 101
    //   208: astore 4
    //   210: goto -109 -> 101
    //   213: astore_0
    ...
    //   222: ifnull +8 -> 230
    //   225: aload 4
    //   227: invokevirtual 254	java/io/FileOutputStream:close	()V
    //   230: aload_1
    //   231: ifnull +7 -> 238
    //   234: aload_1
    //   235: invokevirtual 255	java/io/FileInputStream:close	()V
    //   238: aload_0
    //   239: athrow
    //   240: iconst_1
    //   241: ireturn
