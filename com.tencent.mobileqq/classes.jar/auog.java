  ...
  implements Handler.Callback, URLDrawable.URLDrawableListener
{
  ...
  WeakReference<auoh> jdField_a_of_type_MqqUtilWeakReference;
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    if ((i > 0) && (j > 0))
    {
      ...
      {
        paramURLDrawable = (auoh)this.jdField_a_of_type_MqqUtilWeakReference.get();
