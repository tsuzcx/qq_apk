  ...
  implements Animation.AnimationListener
{
  ...
  public void onAnimationEnd(Animation paramAnimation)
  {
    ...
    for (;;)
    {
      return;
      label247:
      bchj localbchj = (bchj)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(133);
      String str = this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a;
      if (!TextUtils.isEmpty(str))
      {
        TroopAioTopADInfo localTroopAioTopADInfo = localbchj.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
        Object localObject;
        if (localTroopAioTopADInfo != null)
        {
          ...
          localObject = bdds.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Context)this.a.jdField_a_of_type_JavaLangRefWeakReference.get(), paramAnimation);
          if (localObject == null) {
            break label439;
          }
          ((bddb)localObject).c();
        ...
        for (;;)
        {
          azmj.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "notice_center", "Clk_Promote", 0, 0, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, localTroopAioTopADInfo.adId + "", "", "");
          localbchj.a(str);
          this.a.d = false;
          return;
          label430:
        ...
        {
          if ((this.a.jdField_a_of_type_AndroidViewView != null) && (this.a.jdField_a_of_type_Bblx != null))
          {
            ...
            if ((this.a.c) && (this.a.jdField_a_of_type_AndroidViewView != null) && ((this.a.jdField_a_of_type_AndroidViewView instanceof TroopAioFeedsCenterView)))
            {
              ...
              this.a.jdField_a_of_type_Bbnl.b();
            }
          }
