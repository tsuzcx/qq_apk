  ...
  extends lgq
{
  ...
  public lgi(int paramInt1, int paramInt2)
  {
    super(2);
  ...
  protected Frame a(List<lgu> paramList, long paramLong)
  {
    ...
    Frame localFrame = ((lgu)paramList.get(0)).a;
    a(this.jdField_a_of_type_ArrayOfFloat, localFrame.width, localFrame.height);
    this.jdField_a_of_type_Lgj.addParam(new UniformParam.Float4fParam("offset", this.jdField_a_of_type_ArrayOfFloat[0], this.jdField_a_of_type_ArrayOfFloat[1], this.jdField_a_of_type_ArrayOfFloat[2], this.jdField_a_of_type_ArrayOfFloat[3]));
    if (paramList.size() > 1)
    {
      paramList = ((lgu)paramList.get(1)).a;
      a(this.jdField_b_of_type_ArrayOfFloat, paramList.width, paramList.height);
      this.jdField_a_of_type_Lgj.addParam(new UniformParam.TextureParam("inputImageTexture1", paramList.getTextureId(), 33985));
      this.jdField_a_of_type_Lgj.addParam(new UniformParam.Float4fParam("offset1", this.jdField_b_of_type_ArrayOfFloat[0], this.jdField_b_of_type_ArrayOfFloat[1], this.jdField_b_of_type_ArrayOfFloat[2], this.jdField_b_of_type_ArrayOfFloat[3]));
    }
    for (;;)
    {
      return this.jdField_a_of_type_Lgj.RenderProcess(localFrame.getTextureId(), this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      this.jdField_a_of_type_Lgj.addParam(new UniformParam.TextureParam("inputImageTexture1", -1, 33985));
    }
  }
  
  protected void a()
  {
    this.jdField_a_of_type_Lgj = new lgj(this);
    QLog.d(this.jdField_a_of_type_JavaLangString, 1, "onInit: create filter#" + Integer.toHexString(this.jdField_a_of_type_Lgj.hashCode()));
    this.jdField_a_of_type_Lgj.setPositions(AEOpenRenderConfig.ORIGIN_POSITION_COORDS, true);
    this.jdField_a_of_type_Lgj.setTexCords(AEOpenRenderConfig.ORIGIN_TEX_COORDS, true);
    this.jdField_a_of_type_Lgj.ApplyGLSLFilter();
  }
  ...
  protected void b()
  {
    ...
    {
      this.jdField_a_of_type_Lgj.clearGLSLSelf();
      QLog.d(this.jdField_a_of_type_JavaLangString, 1, "onDestroy: filter#" + Integer.toHexString(this.jdField_a_of_type_Lgj.hashCode()));
      this.jdField_a_of_type_Lgj = null;
    }
  }
}
