...
{
  public bbkf(TroopBarReplyActivity paramTroopBarReplyActivity) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject)) {
          paramBundle = this.a.getString(2131696747, new Object[] { Integer.valueOf(paramInt) });
        }
      }
      catch (Exception paramBundle)
      {
        Object localObject;
        paramBundle = this.a.getString(2131696747, new Object[] { Integer.valueOf(9992) });
        continue;
        paramBundle = this.a.getString(2131696747, new Object[] { Integer.valueOf(9991) });
        continue;
      }
      ...
      if (!TextUtils.isEmpty(bcmc.a(this.a.jdField_a_of_type_ComTencentMobileqqTroopWidgetXEditTextExWithListener))) {
