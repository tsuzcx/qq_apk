  ...
  extends aqkn
{
  ...
  protected void a(boolean paramBoolean, String paramString, IntimateInfo paramIntimateInfo)
  {
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("intimate_relationship", 2, "onGetIntimateInfo, mViewDelegate == null:" + acwl.b(this.a));
      }
    } while (acwl.b(this.a));
    while ((TextUtils.isEmpty(paramString)) || (!paramString.equalsIgnoreCase(this.a.jdField_a_of_type_JavaLangString)))
    {
      ...
      return;
      if (QLog.isColorLevel()) {
        QLog.d("intimate_relationship", 2, "onGetIntimateInfo, mode: " + this.a.jdField_a_of_type_Asrs.a());
      }
    }
    if (paramBoolean)
    {
      paramString = acwl.a(this.a).obtainMessage();
      paramString.what = 0;
      paramString.obj = paramIntimateInfo;
      acwl.a(this.a).removeMessages(0);
      acwl.a(this.a).sendMessage(paramString);
      return;
    }
    paramString = acwl.a(this.a).obtainMessage();
    paramString.what = 1;
    paramString.obj = this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131693622);
    acwl.a(this.a).sendMessage(paramString);
  }
  ...
  protected void a(boolean paramBoolean1, String paramString, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      Message localMessage = acwl.a(this.a).obtainMessage();
      if (paramBoolean2)
      {
        this.a.d();
        return;
      ...
      acwl.a(this.a).sendMessage(localMessage);
      return;
    }
    paramString = acwl.a(this.a).obtainMessage();
    paramString.what = 5;
  ...
  protected void a(boolean paramBoolean, HashMap<Long, IntimateInfo> paramHashMap, Object paramObject)
  {
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("intimate_relationship", 2, "onGetGroupIntimateInfos, mViewDelegate == null : " + acwl.b(this.a));
      }
    } while (acwl.b(this.a));
    paramObject = null;
    ...
    for (paramHashMap = (IntimateInfo)paramHashMap.get(Long.valueOf(l1));; paramHashMap = paramObject)
    {
      ...
      paramObject = acwl.a(this.a).obtainMessage();
      paramObject.what = 0;
      paramObject.obj = paramHashMap;
      acwl.a(this.a).removeMessages(0);
      acwl.a(this.a).sendMessage(paramObject);
      return;
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  protected void a(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      acwl.a(this.a).removeMessages(7);
      acwl.a(this.a).sendMessage(localMessage);
      return;
    }
    paramArrayOfObject = acwl.a(this.a).obtainMessage();
    paramArrayOfObject.what = 8;
    paramArrayOfObject.obj = null;
    acwl.a(this.a).sendMessage(paramArrayOfObject);
  }
}
