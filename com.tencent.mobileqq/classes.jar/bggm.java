...
public class bggm
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "[PhotoAlbum]" + bggm.class.getSimpleName();
  ...
  public static Rect a(View paramView)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23) {
      try
      {
        paramView = bgfg.a(paramView, "getRootWindowInsets", false, null, null);
        QZLog.d(jdField_a_of_type_JavaLangString, 1, new Object[] { "insets:", paramView });
        Object localObject3 = bgfg.a(paramView, "getDisplayCutout", false, null, null);
        if (localObject3 == null)
        {
          QZLog.d(jdField_a_of_type_JavaLangString, 1, "displayCutout == null");
          return localRect;
        }
        paramView = bgfg.a(localObject3, "getSafeInsetTop", false, null, null);
        Object localObject1 = bgfg.a(localObject3, "getSafeInsetBottom", false, null, null);
        Object localObject2 = bgfg.a(localObject3, "getSafeInsetLeft", false, null, null);
        localObject3 = bgfg.a(localObject3, "getSafeInsetRight", false, null, null);
  ...
  public static boolean b(Context paramContext)
  {
    try
    {
      paramContext = bgfg.a("android.util.FtFeature", "isFeatureSupport", false, bggp.a().a(new Class[] { Integer.TYPE }), new Object[] { Integer.valueOf(32) });
  ...
  public static boolean e(Context paramContext)
  {
    try
    {
      paramContext = bgfg.a("smartisanos.api.DisplayUtilsSmt", "isFeatureSupport", false, bggp.a().a(new Class[] { Integer.TYPE }), new Object[] { Integer.valueOf(1) });
      if ((paramContext instanceof Boolean))
      {
        boolean bool = ((Boolean)paramContext).booleanValue();
        return bool;
