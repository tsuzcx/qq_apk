...
public class lla
{
      ...
      try
      {
        if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 0)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            localObject2 = localObject1;
            if (ldc.a().b((String)localObject3) == null)
            {
              localObject2 = localObject1;
    ...
    for (;;)
    {
      ...
      if (c.equals(paramString))
      {
        ...
        if ((j == 1) || (j == 3000))
        {
          ...
          label155:
          paramIntent = ldc.a(i, paramString, new int[0]);
      ...
      do
      {
        for (;;)
        {
          ...
          paramString = ldc.a(i, String.valueOf(l), new int[0]);
      ...
      for (;;)
      {
        paramString = ldc.a(i, (String)localObject2, new int[0]);
        localObject1 = paramString;
        if (localStringBuilder == null) {
          break;
        }
  ...
  public boolean a(BaseActivity paramBaseActivity)
  {
    ...
    lgf locallgf = ldc.a().a();
    if (locallgf != null) {}
    for (Object localObject1 = locallgf.c;; localObject1 = null)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
      for (Intent localIntent = b(locallgf.c);; localIntent = null)
      {
        label74:
        boolean bool1;
        if (localIntent != null)
