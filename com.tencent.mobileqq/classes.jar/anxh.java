...
public class anxh
  implements apfg
{
  public anxh(FilePreviewActivity paramFilePreviewActivity) {}
  ...
  public void openFile(String paramString1, String paramString2, long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        babr.a(this.a, 233, this.a.getString(2131653045), "是否下载文件:\n" + paramString1 + "(" + apdh.a(paramLong) + ")", new anxi(this, paramString2, (aome)localObject2, (Bundle)localObject3), new anxj(this)).show();
        return;
      ...
      localObject1 = localObject2;
    } while (!apdh.b(((FileManagerEntity)localObject3).getFilePath()));
    paramString1 = new apcj();
    paramString1.jdField_b_of_type_JavaLangString = "file_viewer_in";
    paramString1.jdField_a_of_type_Int = 73;
    paramString1.c = apdh.a(((FileManagerEntity)localObject3).fileName);
    paramString1.jdField_a_of_type_Long = ((FileManagerEntity)localObject3).fileSize;
    apci.a(this.a.app.getCurrentAccountUin(), paramString1);
    apci.a("0X8004AE4");
