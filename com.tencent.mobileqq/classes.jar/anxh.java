...
public class anxh
{
  ...
  private static float a(Context paramContext)
  {
    ...
    float f2 = Float.valueOf(apdt.a(paramContext, "key_font_level", String.valueOf(16.0F))).floatValue();
    float f1;
    if (f2 >= 13.92F)
    {
      f1 = f2;
  ...
  private static void a(Context paramContext, float paramFloat)
  {
    ...
    apdt.a(paramContext, "key_font_level", String.valueOf(paramFloat));
  }
