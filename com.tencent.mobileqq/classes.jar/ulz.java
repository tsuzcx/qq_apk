...
public class ulz
  implements Runnable
{
  public ulz(PlusPanel paramPlusPanel, int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString) {}
  ...
  public void run()
  {
    ...
    Object localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityAioPlusPanel.jdField_a_of_type_ComTencentMobileqqActivityAioPanelAdapter.a(2130838007);
    ...
    if (localObject3 != null)
    {
      ...
      localTextView.setBackgroundResource(2130838062);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        localImageView.setBackgroundResource(2130838061);
