...
public abstract class alkd
{
  ...
  public alkd(int paramInt)
  {
    this.jdField_c_of_type_JavaLangString = alkh.jdField_a_of_type_JavaLangString;
    ...
    this.jdField_j_of_type_JavaLangString = alkh.jdField_b_of_type_JavaLangString;
    this.jdField_k_of_type_JavaLangString = alkh.jdField_c_of_type_JavaLangString;
    this.jdField_l_of_type_JavaLangString = alkh.jdField_d_of_type_JavaLangString;
    this.jdField_a_of_type_JavaLangString = "precision mediump float;\nuniform mat4 uSTMatrix;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nuniform mat4 uMVPMatrix;\nvoid main() {\n   gl_Position = uMVPMatrix * aPosition;\n   vTextureCoord = (uSTMatrix * aTextureCoord).xy;\n}";
    this.o = paramInt;
  }
  
  private final int a(alkg paramalkg, boolean paramBoolean)
  {
    int i1 = 0;
    a(paramalkg);
    if (this.jdField_a_of_type_Alke != null) {
      this.jdField_a_of_type_Alke.a();
    }
    if (this.n == 1) {
      this.jdField_a_of_type_Aljz.a(this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
    }
    for (;;)
    {
      GLES20.glBindTexture(3553, 0);
      GLES20.glBindFramebuffer(36160, 0);
      alkh.a("keyingHandleAfter");
      if (paramBoolean) {
        i1 = this.jdField_a_of_type_Alka.a();
      }
      return i1;
      this.jdField_a_of_type_Alkj.a();
    }
  }
  
  private final void a(alkg paramalkg, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_Alka.a(paramInt1, paramInt2);
    ...
    for (;;)
    {
      ...
      if (this.m != -1) {
        GLES20.glUniform4f(this.m, paramalkg.jdField_a_of_type_Float, paramalkg.jdField_b_of_type_Float, paramalkg.jdField_c_of_type_Float, 1.0F);
      }
      alkh.a("keyingHandleBefore");
      return;
      this.jdField_a_of_type_Alkj.a(this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
    }
  }
  
  public final int a(int[] paramArrayOfInt, alkg paramalkg, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    return a(paramArrayOfInt, paramalkg, paramArrayOfFloat1, paramArrayOfFloat2, false, 0, 0);
  }
  
  public final int a(int[] paramArrayOfInt, alkg paramalkg, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    if (paramArrayOfInt == null) {
      throw new IllegalArgumentException("textureIds can not be null!");
    }
    a(paramalkg, paramArrayOfFloat1, paramArrayOfFloat2, paramBoolean, paramInt1, paramInt2);
    switch (this.o)
    {
    }
    for (;;)
    {
      alkh.a("keyingTexture");
      return a(paramalkg, paramBoolean);
  ...
  protected String a()
  {
    this.jdField_c_of_type_JavaLangString = alkh.a(this.o);
  ...
  public void a(String paramString1, String paramString2, String paramString3, alke paramalke)
  {
    ...
    this.jdField_a_of_type_Alke = paramalke;
  }
  ...
  public void b()
  {
    ...
    } while (this.jdField_a_of_type_Alka == null);
    this.jdField_a_of_type_Alka.a();
    this.jdField_a_of_type_Alka = null;
  }
}
