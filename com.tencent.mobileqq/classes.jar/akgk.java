  ...
  extends Handler
{
  ...
  public akgk(SendPhotoActivity paramSendPhotoActivity)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      return;
      localSendPhotoActivity.a(2131694295);
      return;
      if (localSendPhotoActivity.jdField_a_of_type_AndroidOsHandler.hasMessages(2))
      {
        ayxi.b(SendPhotoActivity.jdField_a_of_type_JavaLangString, "handleMessage", "remove delayed Message:MSG_CANCLE_PROGRESS");
      ...
      for (boolean bool2 = true;; bool2 = false)
      {
        ...
        ((Intent)localObject2).putExtra(bgkb.h, 2);
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          ayxi.a(SendPhotoActivity.jdField_a_of_type_JavaLangString, "handleMessage print CompressInfo", "info:" + localObject3);
      ...
      ayxi.a(SendPhotoActivity.jdField_a_of_type_JavaLangString, "CompressLog", "compress startTime = " + localSendPhotoActivity.b + "ns,finishTime = " + l1 + "ns,duration = " + l2 + "ms,count = " + i + ",isShowing = " + bool1);
      akgm.a(l2, i, bool1);
      localSendPhotoActivity.app.a().a(l1);
      ayxi.a(SendPhotoActivity.jdField_a_of_type_JavaLangString, "TimeCompare", "CompressFinish Time = " + l1 + "ns");
      ...
      ayzh.a(BaseApplication.getContext(), paramMessage);
      return;
      if (QLog.isColorLevel()) {
