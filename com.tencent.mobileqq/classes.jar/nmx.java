...
public class nmx
{
  public static String a = nmx.class.getSimpleName();
  
  public static View a(Context paramContext, ViewGroup paramViewGroup, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    paramContext = bdyk.a(paramContext, paramViewGroup, paramInt2);
    paramViewGroup = (bdym)paramContext.getTag();
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((oidb_0x935.RgroupInfo)localObject).rpt_group_label.has()) {
          paramRecommendTroopItem.labelList = amzp.a(((oidb_0x935.RgroupInfo)localObject).rpt_group_label.get());
        }
  ...
  public static void a(View paramView, Context paramContext, ShowExternalTroop paramShowExternalTroop)
  {
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      ...
      bdyk.a(paramView, localGroupInfo, paramContext, false);
    }
  }
  ...
  {
    paramContext = bdyk.a(paramContext, paramViewGroup, paramInt2, 2131561418);
    paramViewGroup = (bdym)paramContext.getTag();
    paramViewGroup.a.setMaxLabelCount(paramInt1);
    paramViewGroup.a.setmIsNeedPriority(paramBoolean);
    paramViewGroup.b = 1;
