...
{
  public afdk(ApolloItemBuilder paramApolloItemBuilder) {}
  
  public void onClick(View paramView)
  {
    Object localObject = (afdm)aekt.a(paramView);
    paramView = (akji)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
    localObject = (MessageForApollo)((afdm)localObject).a;
    if (localObject == null)
    {
      QLog.e("ApolloItemBuilder", 1, "errInfo->mr is null.");
      return;
    }
    ApolloActionData localApolloActionData = ((aleh)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).b(((MessageForApollo)localObject).mApolloMessage.id);
