  ...
  extends afdd
{
  ...
  public afdk(QQAppInterface paramQQAppInterface, Context paramContext, XListView paramXListView, afdg paramafdg, int paramInt, String paramString)
  {
  ...
  protected afcy a()
  {
    return new affx(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (bool2 = bool1;; bool2 = true)
    {
      if (bool2)
      {
        SosoInterface.SosoLbsInfo localSosoLbsInfo = akuf.a("recommend_troop");
        if (QLog.isColorLevel()) {
          QLog.i("ac_ft.AddContactFindTroopRTLW", 2, "getRecommendTroopList  >= M, info = " + localSosoLbsInfo);
        }
        if (localSosoLbsInfo == null) {
          akuf.a(new afdl(this, "recommend_troop", localakhp, paramBoolean));
        }
      }
      else
      {
      ...
      localakhp.a(1, this.jdField_b_of_type_Int, 25, paramBoolean, a());
      return;
      localakhp.a(this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Int, 25, paramBoolean);
      return;
      bool1 = true;
      break;
    }
  ...
  protected void a(boolean paramBoolean1, int paramInt1, int paramInt2, boolean paramBoolean2, ArrayList<RecommendTroopItem> paramArrayList, boolean paramBoolean3)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Afdm != null) {
        this.jdField_a_of_type_Afdm.a(paramBoolean1, i);
      }
      return;
      label358:
