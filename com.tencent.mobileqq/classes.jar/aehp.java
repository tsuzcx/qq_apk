  ...
  implements Runnable
{
  ...
  public aehp(ChatBackgroundManager paramChatBackgroundManager, String paramString, Bitmap paramBitmap, boolean paramBoolean, ChatBackgroundManager.BgThemeColorExtractListener paramBgThemeColorExtractListener)
  {
  ...
  public void run()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqModelChatBackgroundManager.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.runOnUiThread(new aehq(this, bool, localVector));
      return;
