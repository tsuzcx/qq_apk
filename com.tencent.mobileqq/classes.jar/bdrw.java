...
public class bdrw
{
  ...
  private static final bdrw jdField_a_of_type_Bdrw = new bdrw();
  ...
  {
    if ((!jdField_a_of_type_Bdrw.jdField_a_of_type_Boolean) && (jdField_a_of_type_Bdrw.jdField_b_of_type_Boolean))
    {
    ...
    for (;;)
    {
      return jdField_a_of_type_Bdrw;
      label33:
      if (jdField_a_of_type_Bdrw.a()) {
        jdField_a_of_type_Bdrw.b();
      }
    }
  }
  ...
  {
    jdField_a_of_type_Bdrw.jdField_b_of_type_Boolean = false;
    jdField_a_of_type_Bdrw.jdField_a_of_type_Boolean = false;
  }
  ...
  {
    return (jdField_a_of_type_Bdrw.jdField_a_of_type_Boolean) && (paramDrawable != null) && (jdField_a_of_type_Bdrw.jdField_a_of_type_JavaLangClass != null) && (jdField_a_of_type_Bdrw.jdField_a_of_type_JavaLangClass.isAssignableFrom(paramDrawable.getClass()));
  }
  ...
  {
    return (jdField_a_of_type_Bdrw.jdField_a_of_type_Boolean) && (paramDrawable != null) && (jdField_a_of_type_Bdrw.jdField_b_of_type_JavaLangClass != null) && (jdField_a_of_type_Bdrw.jdField_b_of_type_JavaLangClass.isAssignableFrom(paramDrawable.getClass()));
  }
  
  public static boolean c(Drawable paramDrawable)
  {
    return (jdField_a_of_type_Bdrw.jdField_a_of_type_Boolean) && (paramDrawable != null) && (jdField_a_of_type_Bdrw.jdField_c_of_type_JavaLangClass != null) && (jdField_a_of_type_Bdrw.jdField_c_of_type_JavaLangClass.isAssignableFrom(paramDrawable.getClass()));
  }
  ...
  public Drawable a(String paramString)
  {
    if ((this.jdField_a_of_type_Boolean) && (new File(paramString).exists())) {
      try
      {
        ...
        bdry.a("videodrawable-sucess", (int)(System.currentTimeMillis() - l));
        return paramString;
      }
      catch (Exception paramString)
      {
        bdry.a(paramString);
        bdry.a("videodrawable-error", paramString.getMessage());
      }
    }
    return null;
  }
  ...
  public Drawable a(String paramString, Handler paramHandler, boolean paramBoolean)
  {
    if ((this.jdField_a_of_type_Boolean) && (new File(paramString).exists())) {
      try
      {
        ...
        bdry.a("autoetc-sucess", (int)(System.currentTimeMillis() - l));
        return paramString;
      }
      catch (Exception paramString)
      {
        bdry.a(paramString);
        bdry.a("autoetc-error", paramString.getMessage());
      }
    }
    return null;
  }
    ...
    for (;;)
    {
      try
      {
        ...
        catch (Exception paramString1)
        {
          bdry.a(paramString1);
          a();
          bdry.a("init-error", paramString1.getMessage());
        }
      }
      finally {}
      File localFile1;
      ...
      label298:
      this.jdField_a_of_type_DalvikSystemDexClassLoader = new DexClassLoader(localFile1.getAbsolutePath(), paramString2.getAbsolutePath(), paramString1.getAbsolutePath(), bdrw.class.getClassLoader());
      try
      {
        a("com.tencent.android.gldrawable.utils.Logger").getMethod("setLogger", new Class[] { Handler.Callback.class }).invoke(null, new Object[] { new bdrx(this) });
