  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof RelativeLayout)))
    {
      ...
      if (paramContext != null)
      {
        ...
        paramBundle.rightMargin = AIOUtils.dp2px(7.5F, localResources);
        if (paramView.findViewById(1) == null) {
          break label873;
        }
        paramBundle.addRule(1, 1);
        paramContext.setPadding(AIOUtils.dp2px(7.5F, localResources), 0, 0, 0);
        label130:
    ...
    {
      a(paramView);
      paramView.setPadding(AIOUtils.dp2px(11.0F, localResources), 0, AIOUtils.dp2px(11.0F, localResources), 0);
      return paramView;
      label175:
      paramView = (bdnu)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      ...
      ((bdsv)paramView).c("28");
      ((bdsv)paramView).a(true);
      if (this.p != 0) {
        ((bdsv)paramView).a(a(), this.p);
      }
      for (;;)
      {
        ...
        paramView.setLayoutParams((ViewGroup.LayoutParams)localObject);
        break;
        ((bdsv)paramView).b("black");
      }
      localRelativeLayout = new RelativeLayout(paramContext);
      localRelativeLayout.setLayoutParams(new RelativeLayout.LayoutParams(-1, AIOUtils.dp2px(40.0F, localResources)));
      i = 0;
      paramView = localRelativeLayout;
      if (i >= j) {
        break label67;
      ...
      if ("picture".equals(localObject))
      {
        ...
        paramView.setId(1);
        localObject = new RelativeLayout.LayoutParams(AIOUtils.dp2px(40.0F, localResources), AIOUtils.dp2px(30.0F, localResources));
        ((RelativeLayout.LayoutParams)localObject).addRule(9, -1);
        ((RelativeLayout.LayoutParams)localObject).addRule(15, -1);
      ...
      for (;;)
      {
        ...
        int m = AIOUtils.dp2px(89.5F, localResources);
