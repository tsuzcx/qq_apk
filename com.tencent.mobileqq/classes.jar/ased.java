...
public abstract class ased
  extends asdn
{
  public ased(String paramString, QQAppInterface paramQQAppInterface)
  {
  ...
  {
    return (llk.f() > 2) || ((a(paramContext, "traeimp-armeabi")) && (a(paramContext, "TcVpxDec-armeabi")) && (a(paramContext, "TcVpxEnc-armeabi")));
  }
  ...
  public void a(String paramString)
  {
    ...
    if (localObject1 != null)
    {
      ...
      String str1 = bjtz.a(paramString);
    ...
    try
    {
      bhmi.a(paramString, AVSoUtils.b(), false);
