...
public class aylb
  extends aylc
{
  public aylb(KDSearchResultFragment paramKDSearchResultFragment, Context paramContext, Activity paramActivity, AppInterface paramAppInterface, TouchWebView paramTouchWebView)
  {
      ...
      if (i + 1 < localObject1.length)
      {
        if (("p".equals(localObject1[i])) && (!TextUtils.isEmpty(localObject1[(i + 1)]))) {
          try
          {
            ...
            localObject2 = ayvm.a(str);
            if (TextUtils.isEmpty((CharSequence)localObject2)) {
              break label240;
            }
            localObject1 = bhsz.a(str, "searchbox", "native");
