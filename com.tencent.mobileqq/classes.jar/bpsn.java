...
public class bpsn
{
  ...
  public static String a(List<bpsn> paramList)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    paramList = paramList.iterator();
    while (paramList.hasNext()) {
      localStringBuilder.append(((bpsn)paramList.next()).a()).append(";");
    }
    return localStringBuilder.toString();
  }
  
  public static List<bpsn> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      break;
      label56:
      bpsn localbpsn = new bpsn();
      localbpsn.a(localCharSequence);
      localArrayList.add(localbpsn);
    }
  }
