...
public class apwt
{
  ...
  public apwt(int paramInt1, int paramInt2, int paramInt3)
  {
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_c_of_type_JavaLangString = "";
  ...
  public apwt(int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, apxz paramapxz, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2, double paramDouble, String[] paramArrayOfString, apwu paramapwu1, int paramInt5, int paramInt6, apwu paramapwu2, List<Pair<apwu, apwu>> paramList, HashMap<String, String> paramHashMap)
  {
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_c_of_type_JavaLangString = "";
    ...
    this.jdField_a_of_type_Apxz = paramapxz;
    ...
    this.jdField_a_of_type_Apwu = paramapwu1;
    this.jdField_b_of_type_Apwu = paramapwu2;
  ...
  private Drawable a(Context paramContext, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      paramInt1 = bgjc.a(localDrawable) + bgjc.a(paramContext);
  ...
  private Drawable a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2, Drawable paramDrawable)
  {
    ...
    {
      paramQQAppInterface = new apym(paramQQAppInterface.getApp().getResources(), this.jdField_a_of_type_AndroidGraphicsNinePatch, this.jdField_b_of_type_AndroidGraphicsNinePatch, this.jdField_a_of_type_Int);
      if (!paramBoolean1)
      {
        paramBoolean1 = true;
  ...
  private Pair<apwu, apwu> a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      } while (!paramString.equals(((apwu)localPair.first).jdField_b_of_type_JavaLangString));
    }
  ...
  public Drawable a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, View paramView, String paramString, int paramInt)
  {
    ...
    for (Object localObject2 = a(paramQQAppInterface, paramBoolean1, paramBoolean3, null);; localObject2 = null)
    {
      ...
      int j;
      if (((localObject2 instanceof apym)) && (!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString)))
      {
        if ((this.jdField_a_of_type_Apxz == null) || (paramView == null)) {
          break label375;
        }
        j = paramView.getWidth();
        if (this.jdField_a_of_type_Apxz.jdField_c_of_type_Int == 0) {
          ((apym)localObject2).a(true, this.jdField_e_of_type_JavaLangString, this.jdField_a_of_type_Apxz.jdField_a_of_type_ArrayOfInt, this.jdField_a_of_type_Apxz.jdField_a_of_type_JavaLangString);
        }
      }
      else if (((localObject2 instanceof apym)) && (paramBoolean2) && (!paramBoolean3) && (paramInt > 0))
      {
        paramString = paramString + "_" + paramInt;
        localObject1 = (apym)localObject2;
        if (paramBoolean1) {
          break label398;
        }
      }
      ...
      {
        ((apym)localObject1).a(paramQQAppInterface, paramString, paramBoolean1);
        ...
        if (i > this.jdField_a_of_type_Apxz.jdField_c_of_type_Int)
        {
          ((apym)localObject2).a(true, this.jdField_e_of_type_JavaLangString, this.jdField_a_of_type_Apxz.jdField_a_of_type_ArrayOfInt, this.jdField_a_of_type_Apxz.jdField_a_of_type_JavaLangString);
          break;
        }
        ((apym)localObject2).a(false, null, null, null);
        break;
        label375:
        if (!(localObject2 instanceof apym)) {
          break;
        }
        ((apym)localObject2).a(false, null, null, null);
        break;
  ...
  {
    apxz localapxz = this.jdField_a_of_type_Apxz;
    if (!paramBoolean4) {
      this.jdField_a_of_type_Apxz = null;
    }
    paramQQAppInterface = a(paramQQAppInterface, paramBoolean1, paramBoolean2, paramBoolean3, paramView, "", 0);
    this.jdField_a_of_type_Apxz = localapxz;
    return paramQQAppInterface;
  }
  
  public Pair<apwu, apwu> a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    for (paramQQAppInterface = "null";; paramQQAppInterface = "first:" + ((Pair)localObject1).first + ",second:" + ((Pair)localObject1).second)
    {
      ...
      return localObject1;
      if (((apwq)localObject2).a == null) {
        break;
      }
      paramQQAppInterface = ((apwq)localObject2).a.jdField_b_of_type_JavaLangString;
      break label102;
      if (((apwq)localObject2).b == null) {
        break;
      }
      paramQQAppInterface = ((apwq)localObject2).b.jdField_b_of_type_JavaLangString;
      break label102;
      paramQQAppInterface = "width";
      if (((apwq)localObject2).c == null) {
        break label102;
      }
      paramQQAppInterface = ((apwq)localObject2).c.jdField_b_of_type_JavaLangString;
      break label102;
      ...
      break label102;
      if (((apwq)localObject2).d == null) {
        break;
      }
      paramQQAppInterface = ((apwq)localObject2).d.jdField_b_of_type_JavaLangString;
      break label102;
      if (((apwq)localObject2).e == null) {
        break;
      }
      paramQQAppInterface = ((apwq)localObject2).e.jdField_b_of_type_JavaLangString;
      break label102;
    }
  }
