...
public class agle
{
  ...
  public static final agle a(TroopClipPic paramTroopClipPic, Set<String> paramSet)
  {
    agle localagle = new agle();
    localagle.jdField_c_of_type_JavaLangString = paramTroopClipPic.id;
    localagle.jdField_d_of_type_JavaLangString = paramTroopClipPic.clipInfo;
    localagle.jdField_d_of_type_Int = paramTroopClipPic.type;
    localagle.jdField_b_of_type_Int = 1;
    if (paramSet != null) {
      localagle.jdField_c_of_type_Boolean = paramSet.contains(paramTroopClipPic.id);
    }
    return localagle;
  }
  
  public static final boolean a(List<agle> paramList1, List<agle> paramList2)
  {
    boolean bool2 = false;
    boolean bool1;
    ...
    for (;;)
    {
      ...
      bool1 = bool2;
      if (!((agle)paramList1.get(i)).equals(paramList2.get(i))) {
        break;
      }
      i += 1;
    }
  ...
  {
    if ((paramObject == null) || (!(paramObject instanceof agle))) {}
    do
    {
      return false;
      paramObject = (agle)paramObject;
    } while ((!bbbr.a(this.jdField_c_of_type_JavaLangString, paramObject.jdField_c_of_type_JavaLangString)) || (!bbbr.a(this.jdField_b_of_type_JavaLangString, paramObject.jdField_b_of_type_JavaLangString)) || (this.jdField_b_of_type_Int != paramObject.jdField_b_of_type_Int) || (this.jdField_a_of_type_Boolean != paramObject.jdField_a_of_type_Boolean) || (this.jdField_c_of_type_Boolean != paramObject.jdField_c_of_type_Boolean) || (this.jdField_d_of_type_Boolean != paramObject.jdField_d_of_type_Boolean) || (!bbbr.a(this.jdField_d_of_type_JavaLangString, paramObject.jdField_d_of_type_JavaLangString)) || (this.jdField_d_of_type_Int != paramObject.jdField_d_of_type_Int) || (this.jdField_a_of_type_Long != paramObject.jdField_a_of_type_Long));
    return true;
  }
