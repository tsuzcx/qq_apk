  ...
  extends agkr
{
  ...
  public agle(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    if (i > 0)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[3] = this.jdField_a_of_type_ComTencentWidgetListView.getResources().getDrawable(2130837982);
      ...
      this.jdField_a_of_type_AndroidViewView = new aglj(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      this.jdField_b_of_type_AndroidViewView = new aglj(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      ...
      if (a(this.jdField_a_of_type_Long))
      {
        ...
        ((AnimatorSet)localObject3).addListener(new aglf(this));
    ...
    for (;;)
    {
      ...
      paramVarArgs.setAnimationListener(new aglh(this));
      paramVarArgs = new agli(this);
      paramVarArgs.setDuration(1000L);
      paramVarArgs.setFillAfter(true);
