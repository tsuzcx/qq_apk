  ...
  extends BaseAdapter
{
  ...
  public baal(List<ParagraphInfo> paramList, Set<Integer> paramSet)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    Object localObject1 = (CheckBox)localView.findViewById(2131364190);
    paramView = (TextView)localView.findViewById(2131378112);
    ...
    ((SpannableString)localObject2).setSpan(new banw(paramViewGroup.getContext(), paramViewGroup.getContext().getResources().getColor(2131166927), 17, 4, 3, 12, Color.parseColor("#777777"), (String)localObject1), 0, ((String)localObject1).length(), 33);
