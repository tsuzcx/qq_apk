...
{
  public ahux(NewFlowCameraActivity paramNewFlowCameraActivity) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("tencent.video.q2v.startUploadPTV".equals(paramContext))
    {
      ...
      case 1: 
        ...
        {
          str = "";
          if (this.a.jdField_a_of_type_Ahvz != null) {
            str = this.a.jdField_a_of_type_Ahvz.a();
          }
    ...
    for (;;)
    {
      ...
      {
        ahtz.a("", paramContext, str, "", NewFlowCameraActivity.a(this.a), "");
        if (QLog.isColorLevel()) {
      ...
      if (i == 2)
      {
        ...
        if (bool)
        {
          ...
          axqy.b(null, "dc00898", "", "", "0X8007BB6", "0X8007BB6", 0, 0, "", "", "", "");
