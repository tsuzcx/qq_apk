...
public class aftx
{
  private afub jdField_a_of_type_Afub = new afty(this);
  ...
  public aftx(Context paramContext, String paramString)
  {
  ...
  public void a(afuc paramafuc)
  {
    this.jdField_a_of_type_Afuc = paramafuc;
  }
  ...
  public void a(Context paramContext, ArrayList<IntimateInfo.MemoryDayInfo> paramArrayList)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout != null)
    {
      ...
      while (i < localArrayList.size())
      {
        ...
        localObject = new aftz(this, paramContext);
        if (localObject != null)
        {
          ((aftz)localObject).a(paramArrayList);
          ((aftz)localObject).a(this.jdField_a_of_type_Afub);
          if (((aftz)localObject).a() != null) {
            this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(((aftz)localObject).a());
          }
        }
        i += 1;
        continue;
