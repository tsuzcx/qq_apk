...
public class bcvm
{
  ...
  private static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, bcvx parambcvx, int paramInt)
  {
    paramActivity = new FreeWifiHelper.5(paramActivity, paramString1, paramString2, paramString3, paramString4, new bcvq(paramInt, paramActivity, parambcvx), new bcvr(parambcvx, paramInt), new bcvs(parambcvx, paramInt), paramInt);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = bcwc.a(localBaseApplication, str);
        if (QLog.isColorLevel()) {
      ...
      return;
      long l = bcwc.c(localBaseApplication, str);
    ...
    Object localObject = new akjs(paramQQAppInterface);
    akjt localakjt = new akjt(paramQQAppInterface);
    localakjt.a(new bcvo(paramQQAppInterface, localakjt));
    paramQQAppInterface.addObserver(localakjt);
    ((akjs)localObject).a(2);
    bcwc.c(localBaseApplication, str, System.currentTimeMillis());
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, ConfigurationService.Config paramConfig)
  {
    ...
    int j = bbjn.a(paramQQAppInterface.getApp(), "wifi_connect_config_version", str);
    if (QLog.isColorLevel()) {
    ...
    if (i != j)
    {
      bbjn.a(paramQQAppInterface.getApp(), "wifi_connect_config_version", str, i);
      ...
      if (!TextUtils.isEmpty(paramConfig))
      {
        ...
        try
        {
          ...
          {
            e = bool;
            bbjn.a(paramQQAppInterface.getApp(), paramQQAppInterface.c(), c, d, e);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    try
    {
      if (((d) || (e)) && (Conversation.b > 0L))
      {
        ...
        long l2 = bcwc.a((Context)localObject, str);
        long l3 = bcwc.b((Context)localObject, str) * 60 * 60 * 1000L;
        if (QLog.isColorLevel()) {
        ...
        bcwc.a((Context)localObject, str, l1);
        akjs localakjs = new akjs(paramQQAppInterface);
        akjt localakjt = new akjt(paramQQAppInterface);
        localakjt.a(new bcvn((Context)localObject, str, paramQQAppInterface, localakjt));
        paramQQAppInterface.addObserver(localakjt);
        localakjs.a(1);
      }
    }
  ...
  public static boolean a(Activity paramActivity, int paramInt, bcvx parambcvx)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        str1 = paramActivity.getString(2131692718);
        str2 = paramActivity.getString(2131692721);
        i = 1;
      }
      while (i != 0)
      {
        String str5 = paramActivity.getString(2131692724);
        String str4 = bcwc.a(paramActivity);
        String str3 = str4;
        if (TextUtils.isEmpty(str4)) {
          str3 = paramActivity.getString(2131692717);
        }
        QLog.i("WifiSdk", 2, "shouldOverrideDialog btn1Text: " + str3);
        a(paramActivity, str5, str1, str3, str2, parambcvx, paramInt);
        return false;
        ...
        {
          str1 = paramActivity.getString(2131692675);
          str2 = paramActivity.getString(2131692723);
          i = 1;
        }
        else
  ...
  public static boolean a(Context paramContext)
  {
    ...
    try
    {
      ...
      if (!TMSDKWifiManager.init(paramContext.getApplicationContext(), new TMSDKCustomConfig().setCustomToast(new bcvw()).setCustomInstaller(new bcvv()).setCustomThreadPool(new bcvu()).setCustomReporter(new bcvt()))) {
        bool = true;
      }
      b = bool;
      WifiSDKUIApi.init(new bcvz(), new bcwa());
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      str = paramQQAppInterface.getCurrentAccountUin();
      localBaseApplication = paramQQAppInterface.getApp();
      long l = bcwc.b(localBaseApplication, str);
      if ((l == -1L) || (System.currentTimeMillis() - l >= 86400000L)) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    akjs localakjs = new akjs(paramQQAppInterface);
    akjt localakjt = new akjt(paramQQAppInterface);
    localakjt.a(new bcvp(paramQQAppInterface, localakjt));
    paramQQAppInterface.addObserver(localakjt);
    localakjs.a(3);
    bcwc.b(localBaseApplication, str, System.currentTimeMillis());
  }
  ...
  public static void c(Context paramContext, int paramInt)
  {
    ...
    bcwb localbcwb = bcwb.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
    if (QLog.isColorLevel()) {
      QLog.i("WifiSdk", 2, "dialog click, jumpType: " + localbcwb.jdField_a_of_type_Int + " jumpUrl: " + localbcwb.jdField_a_of_type_JavaLangString);
    }
    if (WifiSDKUIApi.isWiFiManagerExist())
    {
      if (localbcwb.jdField_a_of_type_Int == 4)
      {
    ...
    switch (localbcwb.jdField_a_of_type_Int)
    {
    case 4: 
    default: 
      a(paramContext, paramInt);
      ...
      return;
    case 1: 
      a(paramContext, localbcwb.jdField_a_of_type_JavaLangString);
