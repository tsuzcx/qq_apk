...
public class waw
{
  private static boolean a(int paramInt1, int paramInt2, way paramway1, way paramway2)
  {
    if (!c(paramInt1, paramInt2, paramway1, paramway2)) {
      return b(paramInt1, paramInt2, paramway1, paramway2);
    }
    return true;
  }
  ...
  private static boolean a(SlideItemInfo paramSlideItemInfo)
  {
    ...
    //   259: astore 17
    //   261: aload 17
    //   263: invokestatic 83	apvd:a	(Ljava/lang/String;)Z
    //   266: ifeq +9 -> 275
    //   269: aload 17
    //   271: invokestatic 85	apvd:c	(Ljava/lang/String;)Z
    //   274: pop
    ...
    //   525: dup
    //   526: aconst_null
    //   527: invokespecial 117	way:<init>	(Lwax;)V
    //   530: astore 19
    //   532: new 114	way
    //   535: dup
    //   536: aconst_null
    //   537: invokespecial 117	way:<init>	(Lwax;)V
    //   540: astore 18
    //   542: ldc 118
    //   544: aload_0
    ...
    //   558: aload 18
    //   560: iconst_0
    //   561: putfield 126	way:jdField_a_of_type_Int	I
    //   564: aload 18
    //   566: iload_3
    //   567: newarray byte
    //   569: putfield 129	way:jdField_a_of_type_ArrayOfByte	[B
    //   572: aload 18
    //   574: iload_3
    //   575: putfield 131	way:jdField_b_of_type_Int	I
    ...
    //   697: iconst_0
    //   698: iload 4
    //   700: invokevirtual 156	way:a	([BII)V
    //   703: aload_0
    //   704: getfield 30	com/tencent/biz/qqstory/takevideo/slideshow/SlideItemInfo:jdField_c_of_type_Int	I
    //   707: ldc 31
    //   709: aload 19
    //   711: aload 18
    //   713: invokestatic 158	waw:a	(IILway;Lway;)Z
    //   716: ifeq +288 -> 1004
    //   719: aload 14
    //   721: aload 18
    //   723: getfield 129	way:jdField_a_of_type_ArrayOfByte	[B
    //   726: aload 18
    //   728: getfield 126	way:jdField_a_of_type_Int	I
    //   731: aload 18
    //   733: getfield 131	way:jdField_b_of_type_Int	I
    ...
    //   802: iconst_0
    //   803: iload_3
    //   804: invokevirtual 156	way:a	([BII)V
    //   807: aload_0
    //   808: getfield 30	com/tencent/biz/qqstory/takevideo/slideshow/SlideItemInfo:jdField_c_of_type_Int	I
    //   811: ldc 31
    //   813: aload 19
    //   815: aload 18
    //   817: invokestatic 158	waw:a	(IILway;Lway;)Z
    //   820: ifeq +184 -> 1004
    //   823: aload 14
    //   825: aload 18
    //   827: getfield 129	way:jdField_a_of_type_ArrayOfByte	[B
    //   830: aload 18
    //   832: getfield 126	way:jdField_a_of_type_Int	I
    //   835: aload 18
    //   837: getfield 131	way:jdField_b_of_type_Int	I
    ...
    //   520	225	16	arrayOfByte	byte[]
    //   755	117	16	localException3	java.lang.Exception
    //   958	6	16	localObject4	Object
    //   979	9	16	localException4	java.lang.Exception
    //   259	624	17	str	java.lang.String
    //   540	296	18	localway1	way
    //   530	284	19	localway2	way
    // Exception table:
    //   from	to	target	type
  ...
  /* Error */
  private static boolean b(int paramInt1, int paramInt2, way paramway1, way paramway2)
  {
    // Byte code:
    //   0: aload_2
    //   1: getfield 131	way:jdField_b_of_type_Int	I
    //   4: aload_2
    //   5: getfield 126	way:jdField_a_of_type_Int	I
    //   8: isub
    //   9: istore 4
    //   11: new 170	java/io/ByteArrayInputStream
    //   14: dup
    //   15: aload_2
    //   16: getfield 129	way:jdField_a_of_type_ArrayOfByte	[B
    //   19: aload_2
    //   20: getfield 126	way:jdField_a_of_type_Int	I
    //   23: aload_2
    //   24: getfield 131	way:jdField_b_of_type_Int	I
    ...
    //   60: iconst_0
    //   61: iconst_1
    //   62: invokespecial 185	wbc:<init>	(Ljava/io/InputStream;Ljava/io/OutputStream;IIIIIIDIZ)V
    //   65: pop
    //   66: iload 4
    //   68: i2f
    //   69: fconst_1
    ...
    //   79: aload_3
    //   80: iconst_0
    //   81: putfield 126	way:jdField_a_of_type_Int	I
    //   84: aload_3
    //   85: aload_2
    //   86: invokevirtual 189	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   89: putfield 129	way:jdField_a_of_type_ArrayOfByte	[B
    //   92: aload_3
    //   93: aload_2
    //   94: invokevirtual 193	java/io/ByteArrayOutputStream:size	()I
    //   97: putfield 131	way:jdField_b_of_type_Int	I
    //   100: aload_3
    //   101: getfield 129	way:jdField_a_of_type_ArrayOfByte	[B
    //   104: arraylength
    //   105: aload_3
    //   106: getfield 131	way:jdField_b_of_type_Int	I
    ...
    //   173: aload_3
    //   174: getfield 131	way:jdField_b_of_type_Int	I
    ...
    //   0	256	2	paramway1	way
    //   0	256	3	paramway2	way
    //   9	190	4	i	int
    //   43	145	5	l1	long
    //   141	45	7	l2	long
  ...
  private static boolean c(int paramInt1, int paramInt2, way paramway1, way paramway2)
  {
    if (d(paramInt1, paramInt2, paramway1, paramway2)) {
      return true;
    }
    try
    {
      int i = paramway1.jdField_b_of_type_Int - paramway1.jdField_a_of_type_Int;
      int j = (int)(i * 1.0F / paramInt1 * paramInt2);
      long l1 = System.currentTimeMillis();
      paramInt1 = AudioResample.nativeResample(paramInt1, paramInt2, paramway1.jdField_a_of_type_ArrayOfByte, paramway1.jdField_b_of_type_Int, paramway2.jdField_a_of_type_ArrayOfByte, paramway2.jdField_a_of_type_ArrayOfByte.length, -1);
      ...
      if (paramInt1 > 0)
      {
        paramway2.jdField_a_of_type_Int = 0;
        paramway2.jdField_b_of_type_Int = (paramInt1 * 2);
        return true;
      }
    }
    catch (UnsatisfiedLinkError paramway1)
    {
      paramway1.printStackTrace();
    }
    return false;
  }
  
  private static boolean d(int paramInt1, int paramInt2, way paramway1, way paramway2)
  {
    if ((paramInt1 == 48000) && (paramInt2 == 44100))
    {
      float f = (paramInt1 - paramInt2) * 1.0F / paramInt1;
      int k = paramway1.jdField_b_of_type_Int - paramway1.jdField_a_of_type_Int;
      int m = k / 2;
      int n = (int)(f * m);
      int i1 = (m - n) / n;
      long l1 = System.currentTimeMillis();
      ...
      if (paramInt2 < m)
      {
        if ((paramInt1 != i1) || (i >= n))
        {
          paramway2.jdField_a_of_type_ArrayOfByte[(j * 2)] = paramway1.jdField_a_of_type_ArrayOfByte[(paramInt2 * 2)];
          paramway2.jdField_a_of_type_ArrayOfByte[(j * 2 + 1)] = paramway1.jdField_a_of_type_ArrayOfByte[(paramInt2 * 2 + 1)];
          j += 1;
          paramInt1 += 1;
        }
        for (;;)
      ...
      long l2 = System.currentTimeMillis();
      paramway2.jdField_a_of_type_Int = 0;
      paramway2.jdField_b_of_type_Int = (j * 2);
      if (QLog.isColorLevel()) {
