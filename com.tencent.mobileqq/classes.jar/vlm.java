...
public class vlm
{
  ...
  public static long a(String paramString)
  {
    ...
    {
      urk.c("Q.qqstory:Utils", paramString, "", new Object[0]);
    }
    return -1L;
  }
  ...
  public static void a(Context paramContext, File paramFile)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        urk.b("Q.qqstory:Utils", "exception", localException);
      }
    }
  }
  ...
  {
    urk.d("Q.qqstory:Utils", "delete " + paramFile);
    if (paramFile.isFile()) {
      paramFile.delete();
    }
  ...
  public static void a(String paramString)
  {
    ...
    {
      a(paramString);
      urk.d("Q.qqstory:Utils", "make flag file %b", new Object[] { Boolean.valueOf(bace.a(str, String.valueOf(System.currentTimeMillis()))) });
      return;
    }
    urk.d("Q.qqstory:Utils", "flag file exist");
  }
  
  public static void a(String paramString, boolean paramBoolean)
  {
    urk.d("Q.qqstory:Utils", "delete %s", new Object[] { paramString });
    bace.a(paramString, paramBoolean);
  }
  
  public static boolean a()
  {
    long l = a();
    urk.b("Q.qqstory:Utils", "free spac:" + l / 1024L / 1024L + "MB--" + l);
    return l < 52428800L;
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    urk.d("Q.qqstory:Utils", "low capacity!");
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    urk.c("Q.qqstory:Utils", "saveVideoToAlbum: " + bool);
  ...
  public static boolean a(String paramString)
  {
    ...
    {
      urk.d("Q.qqstory:Utils", "mkdirs failed, path:%s", new Object[] { paramString });
      return false;
    }
    return true;
  }
  ...
  {
    return bace.c(paramString1, paramString2);
  }
  ...
  {
    paramString = bace.a(paramString + "/" + "dont_delete.txt");
    if (paramString == null) {
      return 0L;
    }
    try
    ...
    {
      urk.b("Q.qqstory:Utils", "exception", paramString);
    }
    return 0L;
  }
  ...
  {
    return bace.b(paramString1, paramString2);
  }
  ...
  {
    return bace.d(paramString1, paramString2);
  }
  
  public static boolean d(String paramString)
  {
    bace.a(paramString);
    urk.d("Q.qqstory:Utils", "removeAllFiles " + paramString);
    return true;
  }
  ...
  public static boolean f(String paramString)
  {
    ...
    {
      urk.d("Q.qqstory:Utils", "save from: delete path null");
      return false;
    }
    bace.d(paramString);
    urk.d("Q.qqstory:Utils", "deleteFile %s", new Object[] { paramString });
    return true;
  }
  ...
  public static boolean g(String paramString)
  {
    ...
    bace.d(paramString);
    urk.d("Q.qqstory:Utils", "tryDeleteFile %s", new Object[] { paramString });
    return true;
  }
}
