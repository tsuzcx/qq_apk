...
public class aloy
{
  ...
  protected static Intent a(Context paramContext, String paramString1, boolean paramBoolean, long paramLong, MessageForArkApp paramMessageForArkApp, String paramString2, int paramInt, String paramString3, String paramString4)
  {
    ...
    if (!TextUtils.isEmpty(paramString3))
    {
      ...
      if (paramString1 != null)
      {
        ...
        if (paramString1 != null)
        {
          ...
          localIntent.putExtra("h5_ark_url_web_sender_uin", adlj.c);
          if (bool2) {
            localIntent.putExtra("puin", adlj.c);
          }
          QLog.d("ArkApp", 1, new Object[] { "ArkSafe.UrlCheck.launchQQBrowser,appname=", paramString3, ", enableCheck=", Boolean.valueOf(paramBoolean), ", appEnableCheck=", Boolean.valueOf(bool1), ", isPublicAccount=", Boolean.valueOf(bool2), ", senderUin=", adlj.c, ", mUrlChecker=", paramString1.toString() });
          alvj.a().a(new alpa());
        }
      }
    }
    paramString1 = amqq.b(186).a();
    if (!TextUtils.isEmpty(paramString1)) {
    ...
    if (paramMessageForArkApp != null)
    {
      ...
      if (paramString1 != null)
      {
        ...
        altc.a(a(), paramString1.appName, "AIOArkSdkCardClick", 1, 0, 0L, 0L, 0L, paramString1.appView, "");
      }
    }
    for (;;)
    {
      ...
      if (paramString1.from == 1) {
        altc.a(a(), paramString1.appName, "AIOArkMapCardClick ", 1, 0, 0L, 0L, 0L, paramString1.appView, "");
      }
    }
  }
  ...
  public static String a()
  {
    ...
    if (localQQAppInterface != null) {
      return ((askn)localQQAppInterface.getManager(11)).a().nationCode;
    }
    return "";
  }
  ...
  public static String a(boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      localObject = ((askn)((QQAppInterface)localObject).getManager(11)).a();
  ...
  public static void a(ark.ModuleRegister paramModuleRegister, ark.Application paramApplication)
  {
    ...
    for (long l = 1L;; l = 0L)
    {
      ...
      for (localObject1 = ((ArkAppCenter)localObject1).a();; localObject1 = null)
      {
        ...
        ((List)localObject2).add(new alpe(paramApplication, l));
        ((List)localObject2).add(new alng(paramApplication, l));
        if (1 == BaseApplicationImpl.sProcessId)
        {
          ((List)localObject2).add(new aloa(paramApplication, l));
          ((List)localObject2).add(new alqk(paramApplication, l));
        }
        if (l == 0L) {
          ((List)localObject2).add(new alpt(paramApplication, l));
        }
        paramApplication = ((List)localObject2).iterator();
        while (paramApplication.hasNext())
        {
          localObject2 = (alpc)paramApplication.next();
          if (localObject1 != null) {
            ((alpc)localObject2).a((List)alqx.a.get(((alpc)localObject2).GetTypeName()));
          }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, alpb paramalpb)
  {
    if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString3)) && (a() != null)) {
      ArkAppMgr.getInstance().getAppPathByNameTimeout(3000L, paramString1, paramString2, "0.0.0.1", null, new aloz(paramString1, paramString3, paramalpb));
    }
  }
  ...
  public static boolean a(String paramString1, int paramInt, String paramString2)
  {
    ...
    if (((localObject2 instanceof FragmentActivity)) && (!TextUtils.isEmpty(paramString1)))
    {
      ...
      if ((!(localObject3 instanceof aert)) || (!"biz_src_ads".equals("biz_src_jc_ark"))) {
        break label847;
      }
      localObject1 = sgg.b(((BaseChatPie)localObject3).a.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      if (alqa.a(paramString1, null, null, paramInt, paramString2))
      {
        altc.a(null, paramString2, "FullScreenOrH5ShowForAI", 0, 0, 0L, 0L, 0L, "", "");
        Log.d("ark.OpenUrl ", paramString1);
        altc.a(null, paramString2, "FullScreenOrH5Show", 0, 0, 0L, 0L, 0L, "", "");
        return true;
      }
      int j;
      int i;
      ...
      if ((paramString1.startsWith("http://")) || (paramString1.startsWith("https://")))
      {
        ...
        if (localObject3 != null)
        {
          ...
          QLog.e("ArkApp", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.http appName=", paramString2, ",url=", nau.b(paramString1, new String[0]), ", isValid set=true" });
          paramInt = 1;
          i = 2;
        }
      }
      ...
      for (;;)
      {
        alwg.b(paramString2, paramString1, j, i, adlj.c);
        if (paramInt == 0)
        {
          QLog.d("ArkApp", 1, new Object[] { "ArkSafe.OpenUrl check url invalid!, url=", nau.b(paramString1, new String[0]), ", app=", paramString2 });
          return false;
          label463:
          paramInt = 0;
          break label256;
        ...
        localObject1 = bbex.a(a(), (Context)localObject2, paramString1);
        if (localObject1 == null) {
          break;
        }
        ...
        if (localObject2 != null)
        {
          ...
          QLog.e("ArkApp", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.jump appName=", paramString2, ",url=", nau.b(paramString1, new String[0]), ", isValid set=true" });
          paramInt = 1;
          i = 2;
        }
        for (;;)
        {
          ...
          QLog.e("ArkApp", 1, new Object[] { "ArkSafe.OpenUrl check url invalid, url=", nau.b(paramString1, new String[0]), ", app=", paramString2 });
          break;
        }
      }
      label640:
