...
public class beuo
{
  ...
  static
  {
    jdField_d_of_type_JavaLangString = anni.a(2131713980);
  }
    ...
    while (this.jdField_a_of_type_JavaLangString.indexOf('[') > 0)
    {
      ...
      if ((i < this.jdField_a_of_type_JavaLangString.length() - 1) && (this.jdField_a_of_type_JavaLangString.charAt(i + 1) == '('))
      {
        ...
        if (m > 0)
        {
          ...
          beup localbeup = new beup();
          localbeup.jdField_a_of_type_Int = k;
          localbeup.jdField_b_of_type_Int = (i + 1);
          localbeup.jdField_a_of_type_JavaLangString = str;
          this.jdField_a_of_type_JavaUtilArrayList.add(localbeup);
        }
      }
    }
  }
