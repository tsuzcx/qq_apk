...
public class aqxj
{
  ...
  private static Map<String, aqxk> jdField_b_of_type_JavaUtilMap = new HashMap();
  ...
  {
    aqxk localaqxk = new aqxk();
    localaqxk.jdField_a_of_type_JavaLangString = paramString;
    localaqxk.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    jdField_b_of_type_JavaUtilMap.put(paramString, localaqxk);
  }
  ...
  private static boolean a(long paramLong)
  {
    ...
    {
      armz.a(0, String.format(BaseApplicationImpl.getApplication().getResources().getString(2131692742), new Object[] { Integer.valueOf(jdField_c_of_type_Int) }), 0);
      return false;
    }
    if ((jdField_a_of_type_Long > 0L) && (d() + paramLong > jdField_a_of_type_Long))
    {
      String str = BaseApplicationImpl.getApplication().getResources().getString(2131692749);
      armz.a(0, str + arof.a(jdField_a_of_type_Long), 0);
      return false;
    }
    return true;
  }
  ...
  public static boolean b()
  {
    ...
    while (localIterator.hasNext())
    {
      str = arof.a(((FileInfo)localIterator.next()).d());
      if ((str == null) || (str.length() == 0)) {
        return false;
      }
      str = str.toLowerCase();
      if (!badt.jdField_a_of_type_JavaLangString.contains(str)) {
        return false;
      }
    }
    ...
    while (localIterator.hasNext())
    {
      str = arof.a(((FileManagerEntity)localIterator.next()).fileName);
      if ((str == null) || (str.length() == 0)) {
        return false;
      }
      str = str.toLowerCase();
  ...
  {
    paramFileInfo = arof.a(paramFileInfo.d());
    if ((paramFileInfo == null) || (paramFileInfo.length() == 0)) {}
    do
    {
      return false;
      paramFileInfo = paramFileInfo.toLowerCase();
    } while (!badt.jdField_a_of_type_JavaLangString.contains(paramFileInfo));
    return true;
  }
  ...
  public static boolean b(FileManagerEntity paramFileManagerEntity)
  {
    ...
    } while (!badt.jdField_a_of_type_JavaLangString.contains(paramFileManagerEntity));
    return true;
  }
  ...
  public static long c()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (armf.a(localFileManagerEntity).a(false)) {
        l += arof.a(localFileManagerEntity.getFilePath());
      }
    }
    return l;
  }
