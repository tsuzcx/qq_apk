  ...
  extends axuq
{
  ...
  private TextViewWrapLayout a(Context paramContext)
  {
    ...
    if (!TextUtils.isEmpty(this.c)) {
      paramContext.setBackgroundResource(2130839169);
    }
    d(paramContext);
    return paramContext;
  }
  ...
  private void a(Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    int m = localResources.getDimensionPixelSize(2131298789);
    int n = localResources.getDimensionPixelSize(2131298790);
    int i = actj.a(5.0F, localResources);
    if (a(1)) {}
  ...
  private void b(Context paramContext, ViewGroup paramViewGroup)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      int i = actj.a(11.0F, paramContext);
      int j = actj.a(14.0F, paramContext);
      paramViewGroup.setPadding(j, i, j, actj.a(12.0F, paramContext));
    }
  }
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    {
      Object localObject11 = (axup)((Iterator)localObject10).next();
      if ((localObject11 instanceof axws))
      {
        localObject11 = (axws)localObject11;
        if (((axws)localObject11).p == axws.o) {
          ((axws)localObject11).p = axws.m;
        }
      }
    }
    if ((paramView != null) && ((paramView instanceof TextViewWrapLayout)))
    {
      ...
      localObject4 = (axup)((Iterator)localObject9).next();
      ((axup)localObject4).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
      localObject5 = ((axup)localObject4).jdField_a_of_type_JavaLangString;
      if ((("picture".equals(localObject5)) || ("vote".equals(localObject5)) || ("video".equals(localObject5))) && (localObject3 == null)) {
        localObject3 = ((axup)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131367947), paramBundle);
      }
    }
    for (;;)
    {
      ...
      if (("title".equals(localObject5)) && (localObject2 == null))
      {
        ...
        localObject2 = (TextView)((axup)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131378383), paramBundle);
      }
      else if (localObject1 == null)
      {
        if (("summary".equals(localObject5)) || ("timer".equals(localObject5)))
        {
          localObject1 = (TextView)((axup)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131378365), paramBundle);
        }
        else if ("checklist".equals(localObject5))
        {
          paramView = (LinearLayout)((axup)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131378092), paramBundle);
          continue;
          ...
          {
            localObject5 = (axup)((Iterator)localObject10).next();
            ((axup)localObject5).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
            localObject6 = ((axup)localObject5).jdField_a_of_type_JavaLangString;
            if ((("picture".equals(localObject6)) || ("vote".equals(localObject6)) || ("video".equals(localObject6))) && (localObject3 == null)) {
              localObject3 = ((axup)localObject5).a(paramContext, null, paramBundle);
            }
          }
          for (;;)
          {
            ...
            if (("title".equals(localObject6)) && (localObject2 == null))
            {
              ...
              localObject2 = (TextView)((axup)localObject5).a(paramContext, null, paramBundle);
            }
            else if (localObject1 == null)
            {
              if (("summary".equals(localObject6)) || ("timer".equals(localObject6)))
              {
                localObject1 = (TextView)((axup)localObject5).a(paramContext, null, paramBundle);
              }
              else if ("checklist".equals(localObject6))
              {
                paramView = (LinearLayout)((axup)localObject5).a(paramContext, null, paramBundle);
                continue;
                ...
                if ((this.k == 1) || (this.k == 3)) {
                  if (this.k == 1)
                  {
                    localObject2 = new RelativeLayout.LayoutParams(actj.a(50.0F, (Resources)localObject9), actj.a(50.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).topMargin = actj.a(3.0F, (Resources)localObject9);
                    ...
                    ((RelativeLayout.LayoutParams)localObject10).topMargin = actj.a(12.0F, (Resources)localObject9);
                    ...
                    ((RelativeLayout.LayoutParams)localObject10).leftMargin = actj.a(10.0F, (Resources)localObject9);
                    ...
                    if (localObject6 != null)
                    {
                      ...
                      i = k;
                      if ((paramContext instanceof axzj))
                      {
                        paramContext = (axzj)paramContext;
                        i = k;
                        if (paramContext != null)
                        {
                          if (TextUtils.isEmpty(paramContext.b())) {
                    ...
                    if (!(paramContext instanceof ayab)) {
                      break label1809;
                    }
                    paramContext = ((ayab)paramContext).jdField_a_of_type_JavaUtilArrayList;
                ...
                for (;;)
                {
                  ...
                  for (;;)
                  {
                    ...
                    return localObject4;
                    localObject2 = new RelativeLayout.LayoutParams(actj.a(115.0F, (Resources)localObject9), actj.a(70.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).topMargin = actj.a(3.0F, (Resources)localObject9);
                    break label819;
                    label1399:
                    ((RelativeLayout.LayoutParams)localObject10).topMargin = actj.a(7.0F, (Resources)localObject9);
                    ((RelativeLayout.LayoutParams)localObject7).topMargin = 0;
                    break label881;
                    if (!this.jdField_a_of_type_Boolean)
                    {
                      if (localObject1 != null) {
                        ((TextView)localObject1).setLineSpacing(actj.a(1.0F, (Resources)localObject9), 1.0F);
                      }
                      localObject2 = new RelativeLayout.LayoutParams(actj.a(50.0F, (Resources)localObject9), actj.a(50.0F, (Resources)localObject9));
                      ((RelativeLayout.LayoutParams)localObject2).topMargin = actj.a(7.0F, (Resources)localObject9);
                      ((RelativeLayout.LayoutParams)localObject2).leftMargin = actj.a(10.0F, (Resources)localObject9);
                      ((RelativeLayout.LayoutParams)localObject2).addRule(3, ((TextView)localObject5).getId());
                      ((RelativeLayout.LayoutParams)localObject2).addRule(11);
                      ((RelativeLayout.LayoutParams)localObject7).topMargin = actj.a(5.0F, (Resources)localObject9);
                    ...
                    localObject2 = new RelativeLayout.LayoutParams(actj.a(32.0F, (Resources)localObject9), actj.a(32.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).leftMargin = actj.a(6.0F, (Resources)localObject9);
                    ((RelativeLayout.LayoutParams)localObject2).addRule(11);
