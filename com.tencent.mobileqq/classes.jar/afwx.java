...
public class afwx
  implements Manager
{
  private static int[] jdField_a_of_type_ArrayOfInt = { -1034, -2015, -2060, -2062, -2061, -7007, -2074, -7009, -7010, -7011, -7012, -2077 };
  ...
  public afwx(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a()
  {
    ...
    if (localObject1 != null) {
      c(String.format("init.beancurd table count = %d", new Object[] { Integer.valueOf(((List)localObject1).size()) }));
    }
    ...
    {
      c(String.format("init: has BeancurdMsg  size = %d ", new Object[] { Integer.valueOf(((List)localObject1).size()) }));
      Iterator localIterator = ((List)localObject1).iterator();
      localObject1 = localObject2;
      if (localIterator.hasNext())
      {
        localBeancurdMsg = (BeancurdMsg)localIterator.next();
        c(" the table pending show msg :" + localBeancurdMsg);
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2, long paramLong)
  {
    paramString1 = a(paramString1, paramInt1, paramInt2, paramString2, paramLong);
    paramString1.isread = true;
    if (!anqc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, false)) {
  ...
  {
    paramString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramString, paramInt1, new int[] { a(paramInt2) });
    if (paramString != null)
    {
  ...
  private boolean b(BeancurdMsg paramBeancurdMsg)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createEntityManager().persistOrReplace(localBeancurdMsg1);
      return true;
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", str, str, 0, 0, "", Integer.toString(paramInt2), "", "");
      return;
      str = "0x8009431";
      continue;
      str = "0x8009432";
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramString)
      {
        ...
        c("parseConfig.error:" + paramString.getMessage());
        return;
      }
    }
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            catch (Exception localException)
            {
              for (;;)
              {
                c("trigger 2 mPriorityMap null..." + localException.getMessage());
              }
            }
          ...
          c(String.format("triggerInsert: best beancurd id = %d ", new Object[] { Integer.valueOf(((BeancurdMsg)localObject1).busiid) }));
          ...
          long l = ((BeancurdMsg)localObject1).msgTime;
          if (localMessageRecord == null)
          {
            if (bool) {
            ...
            a(paramString, paramInt, i, (String)localObject2, l);
            bool = true;
          }
          for (;;)
          {
            ...
            break;
            if ((localMessageRecord.msgtype == a(i)) || (((BeancurdMsg)localObject1).ispush))
            {
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (localMap != null)
    {
      ...
      if (localBeancurdMsg != null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createEntityManager().remove(localBeancurdMsg);
      }
    }
  }
  ...
  public boolean a(BeancurdMsg paramBeancurdMsg)
  {
    for (;;)
    {
      ...
      else
      {
        ...
        int k = a(j);
        c(String.format("receiveBeancurd: lastBeanMsgType = %d,newBeanMsgType= %d ", new Object[] { Integer.valueOf(i), Integer.valueOf(k) }));
        if ((i == k) || (bool1))
        {
  ...
  public boolean a(List<MessageRecord> paramList, boolean paramBoolean)
  {
    ...
    {
      i = 0;
      if ((i >= Math.min(j, k)) || (c(((MessageRecord)paramList.get(k - i - 1)).msgtype) > 0))
      {
        if (i >= Math.min(j, k)) {
          break label178;
        }
