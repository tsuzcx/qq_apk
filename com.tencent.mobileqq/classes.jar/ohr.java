...
{
  private static ohr jdField_a_of_type_Ohr;
  private BackgroundColorSpan jdField_a_of_type_AndroidTextStyleBackgroundColorSpan;
  
  public static ohr a()
  {
    if (jdField_a_of_type_Ohr == null) {
      jdField_a_of_type_Ohr = new ohr();
    }
    return jdField_a_of_type_Ohr;
  }
  ...
  public boolean onTouchEvent(TextView paramTextView, Spannable paramSpannable, MotionEvent paramMotionEvent)
  {
    ...
    if ((i == 1) || (i == 0) || (i == 2) || (i == 3))
    {
      ...
      if ((paramTextView.getTag(2131374825) != null) && ((paramTextView.getTag(2131374825) instanceof Boolean)) && (((Boolean)paramTextView.getTag(2131374825)).booleanValue()))
      {
        ...
        {
          return true;
          ((LinearLayout)paramTextView.getParent()).setBackgroundDrawable(paramTextView.getResources().getDrawable(2130848377));
          continue;
          ((LinearLayout)paramTextView.getParent()).setBackgroundDrawable(paramTextView.getResources().getDrawable(2130848379));
        }
      }
    }
    return false;
