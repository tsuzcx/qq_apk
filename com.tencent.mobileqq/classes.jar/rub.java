  ...
  extends LinearLayout
{
  ...
  public rub(TabLayoutCompat paramTabLayoutCompat, Context paramContext)
  {
    super(paramContext);
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      while ((i != k) || (j != m))
      {
        ...
        ((ValueAnimator)localObject).addUpdateListener(new ruc(this, i, k, j, m));
        ((ValueAnimator)localObject).addListener(new rud(this, paramInt1));
