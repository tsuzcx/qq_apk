public class belh
{
  ...
  void a(String paramString)
  {
    ...
    this.b = beks.a(paramString.substring(this.jdField_a_of_type_Int, this.jdField_a_of_type_Int + j));
    ...
    int k = beks.a(paramString.substring(this.jdField_a_of_type_Int, this.jdField_a_of_type_Int + j));
    this.jdField_a_of_type_Int = (j + this.jdField_a_of_type_Int);
    this.c = (i * k + this.b);
  }
}
