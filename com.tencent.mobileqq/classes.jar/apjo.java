  ...
  implements DialogInterface.OnDismissListener, View.OnClickListener
{
  ...
  baim jdField_a_of_type_Baim = new apjp(this);
  ...
  public apjo(@NonNull Context paramContext)
  {
  ...
  {
    Object localObject = new apjv(this);
    ...
    if ((paramContext instanceof QQAppInterface))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setCallBack((anhs)localObject);
  ...
  public apjo a(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new apjw(this, paramOnClickListener));
    return this;
  }
  ...
  public void a(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetEditText != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new apju(this, paramInt));
    }
  }
  ...
  public apjo b(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
    ...
    this.rBtn.setOnClickListener(new apjq(this, paramOnClickListener));
    return this;
  }
  
  public void b(int paramInt)
  {
    this.jdField_a_of_type_ComTencentWidgetMaxHeightRelativelayout.setMaxHeight(aciy.a(paramInt, getContext().getResources()));
  }
  ...
  public void onClick(View paramView)
  {
    if (paramView.getId() == 2131299981)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setMinimumHeight(baik.a(0));
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetMaxHeightRelativelayout = ((MaxHeightRelativelayout)findViewById(2131309613));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131312715));
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131302577));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131299575);
    ...
    a(this.jdField_a_of_type_AndroidContentResResources.getInteger(2131361802));
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new apjr(this));
    ...
    this.jdField_b_of_type_Int = this.jdField_a_of_type_Baik.a();
    this.jdField_b_of_type_Int = baik.a(this.jdField_b_of_type_Int);
    setOnDismissListener(this);
    a((Context)localObject);
    this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setDispatchKeyEventListener(new apjs(this));
    localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131309891);
    if ((localObject instanceof ScrollView)) {
      this.jdField_a_of_type_AndroidWidgetScrollView = ((ScrollView)localObject);
    }
    this.jdField_a_of_type_AndroidViewView.getViewTreeObserver().addOnGlobalLayoutListener(new apjt(this));
  }
}
