...
{
  xmn(xml paramxml, long paramLong, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.has())
        {
          ...
          if (!TextUtils.isEmpty(paramBundle))
          {
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.delayms.has())
            {
              ...
              this.jdField_a_of_type_Xml.e.put(paramBundle, Integer.valueOf(2147483647));
              if (QLog.isColorLevel()) {
            ...
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.packagesize.has())
            {
              ...
              this.jdField_a_of_type_Xml.b.put(paramBundle, Long.valueOf(l1));
              if (QLog.isColorLevel()) {
        ...
        xml.a(this.jdField_a_of_type_Xml, this.jdField_a_of_type_JavaLangString, l2, paramInt);
        ...
        arpd.d = System.currentTimeMillis();
        l1 = arpd.d - arpd.jdField_a_of_type_Long;
        long l3 = arpd.b - arpd.jdField_a_of_type_Long;
        long l4 = arpd.c - arpd.b;
        long l5 = arpd.d - arpd.c;
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Xml.callJs((String)localObject1, new String[] { ((JSONObject)localObject2).toString() });
        try
        {
          ...
          localObject3 = this.jdField_a_of_type_Xml.mRuntime.a().getCurrentAccountUin();
          ...
          localObject1 = axrn.a(this.jdField_a_of_type_Xml.mRuntime.a());
          if (0L != l6) {
            break;
          }
          paramBoolean = true;
          label1110:
          ((axrn)localObject1).a((String)localObject3, paramBundle, paramBoolean, l1, 0L, (HashMap)localObject2, "", false);
          return;
        }
      ...
      return;
      label1197:
      this.jdField_a_of_type_Xml.e.put(paramBundle, Integer.valueOf((int)l1));
      continue;
      label1218:
      xml.a(this.jdField_a_of_type_Xml, this.jdField_a_of_type_JavaLangString, paramInt);
      continue;
      label1233:
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject3)) {
        xml.b(this.jdField_a_of_type_Xml, (String)localObject3, paramInt);
      }
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", ajya.a(2131714346));
    }
    for (;;)
    {
      label1431:
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", ajya.a(2131714352));
      break;
      label1510:
      label1511:
      do
      {
        ((JSONObject)localObject2).put("ssoRet", 255);
        ((JSONObject)localObject2).put("businessRet", 0);
        ((JSONObject)localObject2).put("msg", ajya.a(2131714351));
        break;
        paramBoolean = false;
        break label1110;
        return;
