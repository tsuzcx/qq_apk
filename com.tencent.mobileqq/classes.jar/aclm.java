  ...
  implements aclj
{
  ...
  private void a(GdtAd paramGdtAd)
  {
    ...
    localachu.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(2);
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localachu);
  }
  ...
  private void b(GdtAd paramGdtAd)
  {
    ...
    achu localachu = new achu();
    localachu.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(1);
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localachu);
  }
  ...
  private void c(GdtAd paramGdtAd)
  {
    ...
    achu localachu = new achu();
    localachu.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(5);
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localachu);
  }
  ...
  private void d(GdtAd paramGdtAd)
  {
    ...
    achu localachu = new achu();
    localachu.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(6);
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localachu);
  }
  ...
  private void f(GdtAd paramGdtAd)
  {
    ...
    achu localachu = new achu();
    localachu.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(3);
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localachu.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localachu);
  }
