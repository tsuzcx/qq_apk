  ...
  implements Animatable
{
  ...
  Property<bqwo, Float> jdField_a_of_type_AndroidUtilProperty = new bqwp(this, Float.class, "backScale");
  private String jdField_a_of_type_JavaLangString;
  private boolean jdField_a_of_type_Boolean;
  private float jdField_b_of_type_Float;
  private int jdField_b_of_type_Int = 0;
  Property<bqwo, Integer> jdField_b_of_type_AndroidUtilProperty = new bqwq(this, Integer.class, "backAlpha");
    ...
    for (;;)
    {
      ...
      try
      {
        if ("1/4".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841491);
        }
        if ("1/2".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841490);
        }
        if ("1x".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841492);
        }
        if ("2x".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841493);
        }
        if ("4x".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841494);
        }
        if (PickerContainer.jdField_a_of_type_JavaLangString.equals(paramString))
        {
          paramString = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841495);
          return paramString;
        }
      }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bqwr(this));
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bqws(this));
