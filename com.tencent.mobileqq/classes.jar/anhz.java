  ...
  implements FaceDecodeTask.DecodeCompletionListener, FaceDownloader.FaceDownloadListener
{
  ...
  public anhz(NearbyAppInterface paramNearbyAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface = paramNearbyAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceDownloader = ((anho)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(216)).a();
  ...
  public Bitmap getBitmapFromCache(int paramInt1, String paramString, int paramInt2, byte paramByte, int paramInt3)
  {
    ...
    Bitmap localBitmap = ((anho)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(216)).a(paramString);
    awkj.a(4, "Q.qqhead.NearbyFaceDecoder", "getBitmapFromcache", new Object[] { paramString, localBitmap });
    return localBitmap;
  }
  ...
  public void onDecodeTaskCompletedNeedDownload(AppInterface paramAppInterface, FaceInfo paramFaceInfo)
  {
    ...
    do
    {
      ...
      if ((paramFaceInfo.jdField_a_of_type_Int == 32) && (paramFaceInfo.jdField_a_of_type_AvatarInfoQQHeadInfo == null) && ((FaceInfo)this.mInProgress.get(paramFaceInfo.b()) != null)) {
        ((anhm)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.a(4)).a(paramFaceInfo);
      }
  ...
  public void runNextTask()
  {
    ...
    awkj.a("Q.qqhead.NearbyFaceDecoder", new Object[] { "runNextTask", localThrowable1, localObject1 });
  }
