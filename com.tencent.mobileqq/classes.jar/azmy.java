  ...
  implements anil
{
  ...
  public azmy(AbsProfileHeaderView paramAbsProfileHeaderView)
  {
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    if ((paramBoolean) && (paramInt == 66) && ((paramObject instanceof Set)))
    {
      ...
      if ((localAbsProfileHeaderView != null) && (paramObject.contains(localAbsProfileHeaderView.jdField_a_of_type_Azfe.a.a)))
      {
        localAbsProfileHeaderView.b(localAbsProfileHeaderView.jdField_a_of_type_Azfe, false);
