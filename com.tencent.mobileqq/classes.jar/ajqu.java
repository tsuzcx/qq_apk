...
public class ajqu
  implements ajrf
{
  public ajqu(ApolloPanel paramApolloPanel) {}
  ...
  public ajrn a(int paramInt)
  {
    ...
    {
    default: 
      return new ajqe(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    case 0: 
      return new ajqe(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    case 2: 
      return new ajpa(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    case 100: 
    ...
    return new ajri(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
  }
  ...
  public void a(List<ajrn> paramList, List<ApolloActionPackage> paramList1, boolean paramBoolean)
  {
    ...
    int m;
    int k;
    if ((localObject1 != null) && (((aiwo)localObject1).jdField_a_of_type_Int > 0) && (!paramList.isEmpty()))
    {
      i = 0;
      if (i < paramList.size())
      {
        localObject2 = (ajrn)paramList.get(i);
        if ((localObject2 instanceof ajpl))
        {
          ApolloPanel.jdField_a_of_type_Int = i;
          if (QLog.isColorLevel()) {
            QLog.d("ApolloPanel", 2, new Object[] { "[initPanelData] checkGameTab jumpGameId:", Integer.valueOf(((aiwo)localObject1).jdField_a_of_type_Int), ",gameTabIndex:" + ApolloPanel.jdField_a_of_type_Int });
          }
          ((ajpl)localObject2).a((aiwo)localObject1);
    ...
    for (;;)
    {
      ...
      if (k == 0)
      {
        ...
        if (!paramBoolean)
        {
          ...
          if (((airx)this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).o)
          {
