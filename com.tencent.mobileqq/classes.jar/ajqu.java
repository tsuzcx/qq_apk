...
{
  public ajqu(TroopTopicMgr paramTroopTopicMgr, TroopTopicDetailInfo paramTroopTopicDetailInfo, MessageForTroopTopic paramMessageForTroopTopic) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (i == 0)
        {
          ...
          ThreadManager.post(new ajqv(this, paramBundle), 8, null, false);
