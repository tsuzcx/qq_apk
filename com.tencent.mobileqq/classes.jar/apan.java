  ...
  implements apat, bbmw
{
  ...
  private apan(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, String paramString3)
  {
  ...
  public static apan a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, String paramString3)
  {
    ...
    return new apan(paramQQAppInterface, paramLong1, paramInt1, paramInt2, paramString1, paramString2, paramLong2, paramBoolean, paramString3);
  }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      if (localDataInputStream.readInt() != 0) {
        this.jdField_a_of_type_Apas.a(9001, "httpServer retCode!=0");
      }
    }
    catch (IOException localIOException)
    {
      for (;;)
      {
        ...
        this.jdField_a_of_type_Apas.a(9001, "httpServer flag!=0 flag!=1");
        try
        {
    ...
    if (i == 0)
    {
      ...
      l2 = i;
      this.jdField_a_of_type_Apas.a(l1 << 32 | l2, null);
    }
    for (;;)
    {
      try
  ...
  public void a()
  {
    ...
    {
      a().a(this.jdField_a_of_type_Bbmu);
  ...
  public boolean a(String paramString, long paramLong, byte[] paramArrayOfByte)
  {
    ...
    this.jdField_a_of_type_Bbmu = new bbmu(paramString, paramArrayOfByte, this);
    ...
    this.jdField_a_of_type_Bbmu.a("Net-type", paramArrayOfByte);
    this.jdField_a_of_type_Bbmu.b("POST");
    this.jdField_a_of_type_Bbmu.b(1);
    if (this.jdField_a_of_type_Apas != null) {
      this.jdField_a_of_type_Apas.a(this.jdField_a_of_type_Bbmu);
    }
    this.jdField_a_of_type_Bbmu.jdField_b_of_type_Int = this.jdField_b_of_type_Int;
    this.jdField_a_of_type_Bbmu.c = this.jdField_a_of_type_Int;
    this.jdField_a_of_type_Bbmu.jdField_a_of_type_JavaLangString = String.valueOf(this.jdField_a_of_type_Long);
    paramArrayOfByte = "";
    if (paramString != null) {
    ...
    {
      this.jdField_a_of_type_Bbmu.j = true;
      this.jdField_a_of_type_Bbmu.k = apaq.a(paramString);
      this.jdField_a_of_type_Bbmu.e = this.jdField_a_of_type_JavaLangString;
    }
    this.jdField_a_of_type_Bbmu.jdField_a_of_type_Ayui = apug.a();
    a().a(this.jdField_a_of_type_Bbmu);
    return true;
  }
  ...
  public void b(bbmu parambbmu1, bbmu parambbmu2)
  {
    ...
    this.jdField_a_of_type_Apas.a(0, "null", "null");
  }
}
