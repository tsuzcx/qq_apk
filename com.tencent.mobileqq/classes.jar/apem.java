...
public class apem
  implements Handler.Callback, View.OnTouchListener, apbz, apcf, aped, ARNativeBridge.ARWorldCupCallback
{
  public volatile int a;
  volatile long jdField_a_of_type_Long = -1L;
  private Context jdField_a_of_type_AndroidContentContext;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private apby jdField_a_of_type_Apby = new apby(this, 1);
  private apca jdField_a_of_type_Apca;
  ...
  private aqdo jdField_a_of_type_Aqdo = new apen(this);
  public bkyc a;
  ...
  public apem(apef paramapef, apeo paramapeo)
  {
    this.jdField_a_of_type_Int = 0;
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Apef = paramapef;
    this.jdField_a_of_type_Apeo = paramapeo;
    this.jdField_a_of_type_AndroidContentContext = this.jdField_a_of_type_Apef.a();
    this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge = ((ARNativeBridge)paramapef.a(0));
    this.jdField_a_of_type_Apce = ((apce)paramapef.a(8));
    boolean bool = apfg.a();
    if (this.jdField_a_of_type_Boolean)
    {
      paramapef = this.jdField_a_of_type_AndroidContentContext;
      if (!bool) {
        break label269;
      }
    }
    ...
    for (int k = 5;; k = 4)
    {
      this.jdField_a_of_type_Aqdk = new aqdk(paramapef, k);
      this.jdField_d_of_type_Int = 1;
      this.jdField_a_of_type_Bkyc = new bkyc(ThreadManager.getSubThreadLooper(), this);
      this.jdField_c_of_type_Boolean = apfg.jdField_a_of_type_Boolean;
      ...
      paramapef = this.jdField_a_of_type_Apeo.a();
      if (!TextUtils.isEmpty(paramapef))
      {
        paramapef = SuperPlayerFactory.createVideoInfoForUrl(paramapef, 101, MD5Utils.toMD5(paramapef));
        this.h = this.jdField_a_of_type_ComTencentSuperplayerApiISPlayerPreDownloader.startPreDownload(paramapef, 3000L, 1000L);
      }
  ...
  private void a(int paramInt)
  {
    ...
    case 6: 
      do
      {
        ...
        return;
        this.jdField_a_of_type_Apef.a(new ARTransferPromotionRenderable.11(this));
  ...
  private void a(int paramInt1, String paramString, boolean paramBoolean1, int paramInt2, boolean paramBoolean2)
  {
    ...
    for (int k = m;; k = 0)
    {
      if ((localFile.exists()) || (k != 0))
      {
        ...
        this.jdField_a_of_type_Apby.a(paramString, 123456L, paramBoolean1, paramInt2, paramBoolean2);
      }
      return;
    }
  }
  ...
  private void a(float[] arg1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3, float[] paramArrayOfFloat4, float[] paramArrayOfFloat5)
  {
    ...
    if (this.jdField_e_of_type_Boolean)
    {
      ...
      if (k >= 1)
      {
        ...
        this.jdField_a_of_type_Apce.b(true);
        ??? = this.jdField_a_of_type_Apce;
        this.jdField_a_of_type_Apce.getClass();
        ???.c(6);
  ...
  {
    if (this.jdField_a_of_type_Apjc == null) {}
    while ((!this.jdField_a_of_type_Apjc.a()) || (this.jdField_a_of_type_Apef.a() == null)) {
      return false;
    }
    paramArrayOfFloat = new float[4];
    float[] arrayOfFloat = new float[3];
    int k = this.jdField_a_of_type_Apef.a().a();
    FloatBuffer localFloatBuffer = this.jdField_a_of_type_Apjc.a(k, paramArrayOfFloat, arrayOfFloat);
    if ((k == -1) || (localFloatBuffer == null))
    {
      a(-1.0F, -1.0F, -1.0F);
      return false;
    }
    this.jdField_a_of_type_Apef.a().a(k);
    this.jdField_a_of_type_Apef.a().a(localFloatBuffer, this.jdField_a_of_type_Apjc.a());
  ...
  private void i()
  {
    if (this.jdField_a_of_type_Apjc != null)
    {
      ...
      apoo.a().e();
      this.jdField_a_of_type_Apjc.a(this.jdField_f_of_type_Int, this.jdField_g_of_type_Int);
      this.jdField_a_of_type_Apjc.c();
    }
  }
  
  private void j()
  {
    if ((this.jdField_a_of_type_Bkyc != null) && (!this.jdField_a_of_type_Bkyc.hasMessages(1105))) {
      this.jdField_a_of_type_Bkyc.sendEmptyMessageDelayed(1105, 200L);
    }
  ...
  private void k()
  {
    ...
    {
      this.jdField_a_of_type_Bkyc.removeMessages(1105);
      this.jdField_a_of_type_Apce.a(false, "");
    }
  ...
  public String a()
  {
    return this.jdField_a_of_type_Apeo.jdField_a_of_type_JavaLangString;
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Apce.f();
    this.jdField_a_of_type_Apce.a(false, "");
    bdla.b(null, "CliOper", "", "", "0X80098C8", "0X80098C8", 0, 0, this.jdField_a_of_type_Apeo.jdField_a_of_type_JavaLangString, "0", "0", "");
  ...
  {
    a((float[])paramapel.a("TARGET_SIZE"), (float[])paramapel.a("POSE"), (float[])paramapel.a("CAMERA_MATRIX"), (float[])paramapel.a("CAMERA_POSITION"), paramapel.a);
  }
  ...
  public int b()
  {
    return this.jdField_a_of_type_Apeo.jdField_a_of_type_Int;
  }
  
  public String b()
  {
    return this.jdField_a_of_type_Apeo.c;
  }
  ...
  public int c()
  {
    return this.jdField_a_of_type_Apeo.jdField_b_of_type_Int;
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Apce.a(this);
    if (!this.jdField_a_of_type_Apeo.jdField_a_of_type_JavaLangBoolean.booleanValue()) {
      this.jdField_a_of_type_Apce.e();
    }
    if ((this.jdField_a_of_type_Aqdk != null) && (this.jdField_a_of_type_Boolean)) {
      QLog.d("ARTransferPromotionRenderable", 2, String.format("setNativeState start sensor result=%s", new Object[] { Boolean.valueOf(this.jdField_a_of_type_Aqdk.a(this.jdField_a_of_type_Aqdo)) }));
    }
  }
  
  public boolean c()
  {
    return !this.jdField_a_of_type_Apeo.jdField_a_of_type_JavaLangBoolean.booleanValue();
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Bkyc != null) {
      this.jdField_a_of_type_Bkyc.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    }
    ...
    if (this.jdField_a_of_type_Apef != null) {
      this.jdField_a_of_type_Apef.a(local7);
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if ((this.jdField_a_of_type_Apby != null) && (this.jdField_a_of_type_Apby.a()) && (this.jdField_a_of_type_Apcg != null))
    {
      long l = this.jdField_a_of_type_Apby.a();
      paramMessage = this.jdField_a_of_type_Apcg.a(l);
    ...
    for (;;)
    {
      ...
      return false;
      label98:
      this.jdField_a_of_type_Apce.a(true, paramMessage.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    if (this.jdField_b_of_type_Int == 4)
    {
      ...
      if ((this.jdField_a_of_type_Apef != null) && (this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge != null)) {
        this.jdField_a_of_type_Apef.a(new ARTransferPromotionRenderable.17(this, paramView));
      }
