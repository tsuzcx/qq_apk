        ...
        try
        {
          ...
          for (;;)
          {
            ...
            case 1: 
              ...
              break;
            case 2: 
              localActivity.overridePendingTransition(2130772292, 0);
              return;
              j = 0;
              break label75;
            }
    ...
    if ("gift".equals(paramString2))
    {
      ...
      do
      {
        ...
        if (("close".equals(paramString3)) && (paramVarArgs.length == 1)) {
          try
          {
            ...
            sendRemoteReq(apic.a("close_version", paramJsBridgeListener, this.mOnRemoteResp.key, paramString1), false, false);
            return true;
          }
        ...
        if ("isFlowerVisible".equals(paramString3)) {
          try
          {
            ...
            paramString1 = new Bundle();
            sendRemoteReq(apic.a("getFlowerVisibility", paramJsBridgeListener, this.mOnRemoteResp.key, paramString1), false, false);
            return true;
          }
      ...
      for (;;)
      {
        try
        {
          ...
          paramJsBridgeListener = paramString1;
          sendRemoteReq(apic.a("setFlowerVisibility", paramString1, this.mOnRemoteResp.key, paramString2), false, false);
          return true;
        }
