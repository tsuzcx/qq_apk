...
public class yib
{
  ...
  private vme jdField_a_of_type_Vme = new vme();
  ArrayList<bgrl> b;
  private ArrayList<yir> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  
  static
  {
    jdField_a_of_type_JavaLangString = BaseApplicationImpl.sApplication.getFilesDir() + File.separator + "blessVoiceChange.json";
    jdField_b_of_type_JavaLangString = AppConstants.SDCARD_PATH + "voiceChange/bless/";
    jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    a();
  }
  
  public yib(EditVideoMusic paramEditVideoMusic, EditVideoParams paramEditVideoParams, Handler paramHandler)
  {
  ...
  private boolean a()
  {
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList == null)
    {
      ...
      if (i < ListenChangeVoicePanel.jdField_a_of_type_ArrayOfInt.length)
      {
        ...
        for (j = 0;; j = 2)
        {
          ((ArrayList)localObject1).add(new bgrl(k, (String)localObject4, (String)localObject5, 0, j, 1, new bgrm(ListenChangeVoicePanel.jdField_b_of_type_ArrayOfInt[i], null, null, null)));
          i += 1;
          break;
        }
      }
    ...
    if (localObject1 == null)
    {
      ...
      {
        localObject1 = (bgrl)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject1 != null) {
          ((bgrl)localObject1).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return false;
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        localObject4 = (bgrl)localIterator.next();
        if (localArrayList.contains(Integer.valueOf(((bgrl)localObject4).jdField_a_of_type_Int))) {
          continue;
        }
        ((bgrl)localObject4).jdField_b_of_type_Int = 0;
        continue;
      ...
      {
        localObject5 = (bgrl)((Iterator)localObject4).next();
        if (!localArrayList.contains(Integer.valueOf(((bgrl)localObject5).jdField_a_of_type_Int))) {
          ((bgrl)localObject5).jdField_b_of_type_Int = 0;
        }
      }
      label929:
      j += 1;
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList != null)
    {
      localObject3 = (bgrl)this.jdField_b_of_type_JavaUtilArrayList.get(j);
      label956:
      ...
      else
      {
        ...
        if (k != 0)
        {
          ...
          {
            j = k;
            if (bges.a(((JSONObject)localObject4).getString("QQVersion"), "8.4.8"))
            {
              k = 0;
              j = k;
              if (QLog.isColorLevel())
        ...
        if (j == 0)
        {
          ((bgrl)localObject3).jdField_b_of_type_Int = j;
        }
        else
        {
          ...
          for (;;)
          {
            ...
            ((bgrl)localObject3).d = 1;
            ((bgrl)localObject3).c = 0;
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("name"))) {
              break label1364;
            }
            localObject4 = ((bgrl)localObject3).jdField_a_of_type_JavaLangString;
            label1225:
            ((bgrl)localObject3).jdField_a_of_type_JavaLangString = ((String)localObject4);
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("description"))) {
              break label1377;
            }
            localObject4 = ((bgrl)localObject3).jdField_b_of_type_JavaLangString;
            label1253:
            ((bgrl)localObject3).jdField_b_of_type_JavaLangString = ((String)localObject4);
            ((bgrl)localObject3).jdField_a_of_type_Bgrm.jdField_a_of_type_JavaLangString = ((String)localObject5);
            break label1632;
            localObject5 = bgcw.jdField_b_of_type_JavaLangString + (String)localObject5;
    ...
    for (int j = ((JSONObject)localObject4).getInt("tag");; j = 0)
    {
      ...
      if (localArrayList.size() > 0)
      {
        ...
        {
          localObject4 = (bgrl)((Iterator)localObject3).next();
          if (!localArrayList.contains(Integer.valueOf(((bgrl)localObject4).jdField_a_of_type_Int))) {
            ((bgrl)localObject4).jdField_b_of_type_Int = 0;
          }
        }
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject3 = (bgrl)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject3 != null) {
          ((bgrl)localObject3).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return true;
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject4 = (bgrl)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject4 != null) {
          ((bgrl)localObject4).jdField_b_of_type_Int = 0;
        }
        i += 1;
  ...
  private void d()
  {
    ...
    new yic(this, this.jdField_a_of_type_Vme, l).executeOnExecutor(Bosses.get().getExecutor(16), new vwz[] { new vwz(str1, str2, null) });
  }
  ...
  public void a(yir paramyir)
  {
    ...
    if (a((Object[])localObject2))
    {
      ...
      if (!localFile.exists()) {
        FileUtils.copyFile(new File((String)localObject1), localFile);
      }
      localObject2 = new bgrk((String)localObject2, i, 64000, 2, paramyir.c);
      bgrn.a(BaseApplicationImpl.getContext(), (bgrk)localObject2, jdField_c_of_type_JavaLangString, new yid(paramyir, (String)localObject1), new bgrp(false, false, false, true, true, null));
      localObject1 = new Properties();
      ((Properties)localObject1).setProperty("bless_param_voice_id", "" + paramyir.c);
      ahuz.a("bless_event_voice_click", (Properties)localObject1);
    }
  }
  ...
  {
    String str = "";
    Object localObject = new File(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEditSource.getSourcePath());
    if ((((File)localObject).exists()) && (((File)localObject).isDirectory()))
    {
      ...
      if (arrayOfString != null)
      {
        ...
        for (;;)
        {
          ...
          {
            str = this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.mEditSource.getSourcePath() + File.separator + (String)localObject;
            bool1 = true;
          }
          i += 1;
        }
  ...
  protected void b()
  {
    ...
    if (a((Object[])localObject))
    {
      ...
      if (localFile.exists()) {
        FileUtils.copyFile(localFile, new File((String)localObject));
      }
    }
  }
  ...
  public void c()
  {
    ...
    synchronized (this.jdField_c_of_type_JavaUtilArrayList)
    {
      ...
      {
        bgrl localbgrl = (bgrl)localIterator.next();
        if (localbgrl.jdField_b_of_type_Int == 2)
        {
          yir localyir = new yir(4, localbgrl.jdField_a_of_type_JavaLangString, localbgrl.jdField_a_of_type_Bgrm.jdField_a_of_type_Int, localbgrl.jdField_a_of_type_Int);
          if ((localbgrl.jdField_a_of_type_Bgrm.jdField_a_of_type_Int == 0) && (!TextUtils.isEmpty(localbgrl.jdField_a_of_type_Bgrm.jdField_a_of_type_JavaLangString))) {
            localyir.g = (jdField_b_of_type_JavaLangString + localbgrl.jdField_a_of_type_Bgrm.jdField_a_of_type_JavaLangString.substring(localbgrl.jdField_a_of_type_Bgrm.jdField_a_of_type_JavaLangString.lastIndexOf("/") + 1));
          }
          this.jdField_c_of_type_JavaUtilArrayList.add(localyir);
        }
      }
    }
