...
public class bcmb
{
  ...
  protected static Map<String, bcqd> a;
  protected amdu a;
  ...
  public bcmb(String paramString, Class<? extends bcqd> paramClass, amdu paramamdu)
  {
    this.jdField_a_of_type_JavaLangString = "0x6ff0072";
    this.jdField_a_of_type_Amdu = paramamdu;
    this.f = paramString;
    if (jdField_a_of_type_JavaUtilMap == null) {
      jdField_a_of_type_JavaUtilMap = new HashMap();
    }
    if ((bcqd)jdField_a_of_type_JavaUtilMap.get(paramString) == null)
    {
      paramClass = bcqc.a(paramClass);
  ...
  {
    return ((bcqd)jdField_a_of_type_JavaUtilMap.get(this.f)).a();
  }
  ...
  public List<String> a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    boolean bool2 = alue.a().a();
    int i = NetConnInfoCenter.getActiveNetIpFamily(true);
    Object localObject = baxv.a();
    ((baxv)localObject).b();
    if (i == 3)
    {
      String str = ((baxv)localObject).a(0, bool2);
      ...
      {
        localObject = ((baxv)localObject).a(0, bool1);
  ...
  {
    ThreadManager.executeOnNetWorkThread(new TroopAvatarManger.1(this, paramAppInterface, paramString1, paramString3, paramString2, (bcqd)jdField_a_of_type_JavaUtilMap.get(this.f), paramClass, paramArrayList, paramHashMap));
  }
  
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Amdu != null) {
      this.jdField_a_of_type_Amdu.e(paramString);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Amdu != null) {
      this.jdField_a_of_type_Amdu.a(paramString, paramInt, paramArrayList);
    }
  }
  
  public void a(Observer paramObserver)
  {
    ((bcqd)jdField_a_of_type_JavaUtilMap.get(this.f)).addObserver(paramObserver);
  }
  
  public void b(Observer paramObserver)
  {
    ((bcqd)jdField_a_of_type_JavaUtilMap.get(this.f)).a(paramObserver);
  }
}
