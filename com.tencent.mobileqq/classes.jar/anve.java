  ...
  implements Manager
{
  ...
  private anvj jdField_a_of_type_Anvj;
  private anyu jdField_a_of_type_Anyu = new anvg(this);
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfInt = new int[] { 2130845897, 2130844933, 2130844933, 2130844933, 2130845655, 2130845655, 2130845915, 2130845915, 2130845439, 2130845439, 2130845439, 2130845897, 2130845897, 2130845716, 2130845897 };
  ...
  public anve(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(int paramInt, boolean paramBoolean)
  {
    ...
    if (paramInt == 1)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        {
          bool = true;
          QLog.d("ConditionSearch.Manager", 2, bool + " | isNetAvaiable = " + bhnv.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()));
        }
      }
      else
      {
        ...
        localObject = ((bezv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(193)).a(this.jdField_a_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("ConditionSearch.Manager", 2, "update, find task=" + localObject);
        }
        if ((localObject != null) && ((localObject instanceof anvh))) {
          ((anvh)localObject).realStart();
        }
      }
    }
    label246:
    while (paramInt != 2)
    {
      ...
      if (!bhnv.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
        return 2;
      }
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        localObject = (anvl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(4);
        ((anvl)localObject).a(null, new GetResourceReqInfo[] { ((anvl)localObject).e() });
        return 0;
      }
    }
    label264:
  ...
  public List<BaseAddress> a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqConditionsearchDataAddressData != null)
    {
      ...
      Collections.sort(localArrayList, new anvf(this));
    }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Anvj != null) {
      this.jdField_a_of_type_Anvj.a();
    }
  }
  ...
  public void a(anvj paramanvj)
  {
    this.jdField_a_of_type_Anvj = paramanvj;
  }
  ...
  public void a(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      paramGetResourceRespInfo = new anvh(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, paramGetResourceRespInfo, localFile);
      ...
      bool = ((bezv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(193)).a(10023, "prd", (String)localObject, 0, (String)localObject, localFile.getAbsolutePath(), 2, 0, false, paramGetResourceRespInfo);
      if (QLog.isColorLevel()) {
  ...
  void a(boolean paramBoolean1, List<CondFitUser> paramList, boolean paramBoolean2, int paramInt)
  {
    ...
    if (this.jdField_b_of_type_JavaUtilLinkedList != null)
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        ((anvk)((Iterator)localObject).next()).a(paramBoolean1, paramList, paramBoolean2, paramInt);
      }
    }
  }
  ...
  public int[] a()
  {
    ...
    {
      localCard = ((anyw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      if (localCard == null) {
        break label357;
      }
  ...
  public String c(String paramString)
  {
    ...
    {
      String[] arrayOfString = bhsr.a(paramString, '-');
      str = paramString;
      if (arrayOfString.length >= 2)
      {
  ...
  {
    if ((paramObject instanceof anvi))
    {
    ...
    do
    {
      this.jdField_a_of_type_JavaUtilLinkedList.add((anvi)paramObject);
      do
      {
        return;
      } while (!(paramObject instanceof anvk));
      if (this.jdField_b_of_type_JavaUtilLinkedList == null) {
    ...
    this.jdField_b_of_type_JavaUtilLinkedList.add((anvk)paramObject);
  }
  ...
  public int d()
  {
    if (this.jdField_g_of_type_Boolean)
    {
      Card localCard = ((anyw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      if (localCard == null) {
        break label134;
      }
      if (localCard.shGender != 0) {
  ...
  public void d(Object paramObject)
  {
    ...
    while ((!(paramObject instanceof anvk)) || (this.jdField_b_of_type_JavaUtilLinkedList == null)) {
      return;
    }
