  ...
  implements Manager
{
  ...
  aoog jdField_a_of_type_Aoog = new oem(this);
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = antf.ba + ".shop_assit/image/";
  ...
  public oek(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new oel(this);
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      this.jdField_a_of_type_Oen = new oen(this);
      return;
    }
  }
  ...
  public static Drawable a(Context paramContext)
  {
    ...
    {
      Object localObject1 = paramContext.getResources().getDrawable(2130839512);
      ...
      catch (MalformedURLException localMalformedURLException)
      {
        ...
        return paramContext.getResources().getDrawable(2130847042);
      }
    }
    return paramContext.getResources().getDrawable(2130847042);
  }
  ...
  public static String a(String paramString1, String paramString2, QQAppInterface paramQQAppInterface)
  {
    ...
    for (paramString1 = "&g_tk=";; paramString1 = "?g_tk=")
    {
      ...
      localStringBuilder.append(String.valueOf(bguq.b(paramQQAppInterface)));
      return localStringBuilder.toString();
    }
  }
  
  public static qq_ad_get.QQAdGetRsp.AdInfo a(bdol parambdol)
  {
    qq_ad_get.QQAdGetRsp.AdInfo localAdInfo = new qq_ad_get.QQAdGetRsp.AdInfo();
    if (parambdol == null) {
      return localAdInfo;
    }
    if (!bhsr.a(parambdol.X)) {
      if (QLog.isColorLevel()) {
        QLog.i("EcShopAssistantManager", 2, "adinfo<<<<<<<<<<<<<" + parambdol.X);
      }
    }
    for (;;)
    {
      try
      {
        parambdol = (qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(acvb.a(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(parambdol.X)));
        return parambdol;
      }
      catch (JSONException parambdol)
      {
        parambdol.printStackTrace();
        parambdol = localAdInfo;
        continue;
      }
      Object localObject1 = new qq_ad_get.QQAdGetRsp.AdInfo.DisplayInfo.AdvertiserInfo();
      if (!bhsr.a(parambdol.r)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.DisplayInfo.AdvertiserInfo)localObject1).advertiser_id.set(Long.parseLong(parambdol.r));
      }
      if (!bhsr.a(parambdol.N)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.DisplayInfo.AdvertiserInfo)localObject1).corporate_image_name.set(parambdol.N);
      }
      if (!bhsr.a(parambdol.O)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.DisplayInfo.AdvertiserInfo)localObject1).corporate_logo.set(parambdol.O);
      }
      Object localObject2 = new qq_ad_get.QQAdGetRsp.AdInfo.DisplayInfo.VideoInfo();
      if (!bhsr.a(parambdol.F)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.DisplayInfo.VideoInfo)localObject2).video_url.set(parambdol.F);
      }
      ((qq_ad_get.QQAdGetRsp.AdInfo.DisplayInfo.VideoInfo)localObject2).media_duration.set(parambdol.i);
      ((qq_ad_get.QQAdGetRsp.AdInfo.DisplayInfo.VideoInfo)localObject2).video_file_size.set(parambdol.j);
      if (!bhsr.a(parambdol.U)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.DisplayInfo.VideoInfo)localObject2).tencent_video_id.set(parambdol.U);
      }
      ...
      localDisplayInfo.mini_program_type.set(parambdol.f);
      localObject2 = new qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.TraceInfo();
      if (!bhsr.a(parambdol.s)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.TraceInfo)localObject2).aid.set(Long.parseLong(parambdol.s));
      }
      if (!bhsr.a(parambdol.D)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.TraceInfo)localObject2).traceid.set(parambdol.D);
      }
      if (!bhsr.a(parambdol.E)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.TraceInfo)localObject2).via.set(parambdol.E);
      }
      if (!bhsr.a(parambdol.A)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.TraceInfo)localObject2).product_id.set(parambdol.A);
      }
      if (!bhsr.a(parambdol.z)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.TraceInfo)localObject2).noco_id.set(Long.parseLong(parambdol.z));
      }
      if (!bhsr.a(parambdol.V)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.TraceInfo)localObject2).view_id.set(parambdol.V);
      }
      localObject1 = new qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo();
      if (!bhsr.a(parambdol.q)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo)localObject1).exposure_url.set(parambdol.q);
      }
      if (!bhsr.a(parambdol.B)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo)localObject1).click_url.set(parambdol.B);
      }
      if (!bhsr.a(parambdol.w)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo)localObject1).effect_url.set(parambdol.w);
      }
      if (!bhsr.a(parambdol.y)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo)localObject1).landing_page_report_url.set(parambdol.y);
      }
      ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo)localObject1).trace_info.set((MessageMicro)localObject2);
      if (!bhsr.a(parambdol.P)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo)localObject1).negative_feedback_url.set(parambdol.P);
      }
      localObject2 = new qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.ThirdPartyMonitorUrls();
      if (!bhsr.a(parambdol.K)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.ThirdPartyMonitorUrls)localObject2).api_click_monitor_url.set(Arrays.asList(parambdol.K.split("\\|")));
      }
      if (!bhsr.a(parambdol.L)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.ThirdPartyMonitorUrls)localObject2).api_exposure_monitor_url.set(Arrays.asList(parambdol.L.split("\\|")));
      }
      if (!bhsr.a(parambdol.R)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.ThirdPartyMonitorUrls)localObject2).sdk_click_monitor_url.set(Arrays.asList(parambdol.R.split("\\|")));
      }
      if (!bhsr.a(parambdol.Q)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo.ThirdPartyMonitorUrls)localObject2).sdk_exposure_monitor_url.set(Arrays.asList(parambdol.Q.split("\\|")));
      }
      ...
      if (!bhsr.a(parambdol.x)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.DestInfo)localObject2).landing_page.set(parambdol.x);
      }
      if (!bhsr.a(parambdol.u)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.DestInfo)localObject2).canvas_json.set(parambdol.u);
      }
      ((qq_ad_get.QQAdGetRsp.AdInfo.DestInfo)localObject2).dest_type.set(parambdol.jdField_d_of_type_Int);
      if (!bhsr.a(parambdol.S)) {
        ((qq_ad_get.QQAdGetRsp.AdInfo.DestInfo)localObject2).universal_link.set(parambdol.S);
      }
      qq_ad_get.QQAdGetRsp.AdInfo.AppInfo localAppInfo = new qq_ad_get.QQAdGetRsp.AdInfo.AppInfo();
      if (!bhsr.a(parambdol.H)) {
        localAppInfo.customized_invoke_url.set(parambdol.H);
      }
      if (!bhsr.a(parambdol.t)) {
        localAppInfo.pkg_download_schema.set(parambdol.t);
      }
      if (!bhsr.a(parambdol.G)) {
        localAppInfo.app_name.set(parambdol.G);
      }
      if (!bhsr.a(parambdol.I)) {
        localAppInfo.app_package_name.set(parambdol.I);
      }
      if (!bhsr.a(parambdol.J)) {
        localAppInfo.pkg_url.set(parambdol.J);
      }
      if (!bhsr.a(parambdol.A)) {
        localAppInfo.android_app_id.set(parambdol.A);
      }
      if (!bhsr.a(parambdol.C)) {
        localAppInfo.channel_id.set(parambdol.C);
      }
      localAppInfo.app_score_num.set(parambdol.k);
      localAppInfo.download_num.set(parambdol.l);
      localAdInfo.product_type.set(parambdol.e);
      ...
      if (!bhsr.a(parambdol.T)) {
        localAdInfo.ext_json.set(parambdol.T);
      }
      parambdol = localAdInfo;
    }
  }
  ...
  public static qq_ad_get.QQAdGetRsp.AdInfo a(MessageRecord paramMessageRecord)
  {
      ...
      if ((paramMessageRecord instanceof StructMsgForGeneralShare))
      {
        ...
        if (paramMessageRecord != null)
        {
          ...
          if (!paramMessageRecord.isEmpty())
          {
            ...
            {
              localObject1 = (bdol)((Iterator)localObject2).next();
              if ((localObject1 instanceof bdsg))
              {
                localObject1 = ((bdsg)localObject1).a;
                ...
                do
                {
                  ...
                  localbdol = (bdol)((Iterator)localObject1).next();
                } while (!(localbdol instanceof bdts));
                paramMessageRecord = a(localbdol);
              }
            }
          }
        }
    ...
    {
      break;
      if ((localObject1 instanceof bdsi))
      {
        localObject1 = a((bdsi)localObject1);
        label167:
        do
        {
          return localObject1;
        ...
        catch (Exception paramMessageRecord)
        {
          try
          {
            ...
            if (localObject2 != null)
            {
              ...
              return (qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(acvb.a(new qq_ad_get.QQAdGetRsp.AdInfo(), localObject2));
            }
            ...
            if (localObject2 != null)
            {
              ((qq_ad_get.QQAdGetRsp.AdInfo)localObject1).report_info.thirdparty_monitor_urls.api_click_monitor_url.set(ofe.a(((JSONObject)localObject2).optJSONArray("api_click_monitor_url")));
              ((qq_ad_get.QQAdGetRsp.AdInfo)localObject1).report_info.thirdparty_monitor_urls.api_exposure_monitor_url.set(ofe.a(((JSONObject)localObject2).optJSONArray("api_exposure_monitor_url")));
              ((qq_ad_get.QQAdGetRsp.AdInfo)localObject1).report_info.thirdparty_monitor_urls.sdk_click_monitor_url.set(ofe.a(((JSONObject)localObject2).optJSONArray("sdk_click_monitor_url")));
              ((qq_ad_get.QQAdGetRsp.AdInfo)localObject1).report_info.thirdparty_monitor_urls.sdk_exposure_monitor_url.set(ofe.a(((JSONObject)localObject2).optJSONArray("sdk_exposure_monitor_url")));
            }
            ((qq_ad_get.QQAdGetRsp.AdInfo)localObject1).report_info.trace_info.view_id.set(paramMessageRecord.optString("view_id"));
  ...
  private boolean a(long paramLong)
  {
    ...
    {
      localObject2 = (RecentUser)((apaw)localObject1).findRecentUserByUin(antf.ae, 7120);
    ...
    for (;;)
    {
      ...
      break;
      localObject2 = (RecentUser)((apaw)localObject1).findRecentUser(antf.ae, 7120);
      if (localObject2 != null) {
  ...
  private void g()
  {
    ...
    //   3: astore 5
    //   5: aload_0
    //   6: getfield 162	oek:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   9: invokevirtual 1026	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/mobileqq/data/QQEntityManagerFactory;
    //   12: invokevirtual 1032	com/tencent/mobileqq/data/QQEntityManagerFactory:createEntityManager	()Lcom/tencent/mobileqq/persistence/EntityManager;
    //   15: astore_3
    //   16: aload_3
    //   17: ldc_w 885
    //   20: iconst_0
    ...
    //   25: ldc_w 1034
    //   28: aconst_null
    //   29: invokevirtual 1038	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   32: astore_2
    ...
    //   58: aload 4
    //   60: iload_1
    //   61: invokevirtual 1043	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   64: invokevirtual 75	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   67: invokestatic 901	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   70: aload_0
    //   71: getfield 129	oek:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   74: astore 4
    //   76: aload 4
    //   78: monitorenter
    //   79: aload_0
    //   80: aload_2
    //   81: putfield 173	oek:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   84: aload_0
    //   85: getfield 173	oek:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   88: ifnonnull +16 -> 104
    //   91: aload_0
    //   92: new 720	java/util/ArrayList
    //   95: dup
    //   96: bipush 16
    //   98: invokespecial 1045	java/util/ArrayList:<init>	(I)V
    //   101: putfield 173	oek:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   104: aload 4
    //   106: monitorexit
    //   107: aload_0
    //   108: getfield 171	oek:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   111: astore_2
    //   112: aload_2
    //   113: monitorenter
    //   114: aload_0
    //   115: getfield 171	oek:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   118: invokeinterface 1048 1 0
    //   123: aload_0
    //   124: getfield 173	oek:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   127: invokeinterface 704 1 0
    //   132: astore 4
    //   134: aload 4
    //   136: invokeinterface 709 1 0
    //   141: ifeq +120 -> 261
    //   144: aload 4
    //   146: invokeinterface 713 1 0
    //   151: checkcast 885	com/tencent/biz/pubaccount/ecshopassit/EcShopData
    //   154: astore 5
    //   156: aload_0
    //   157: getfield 171	oek:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   160: aload 5
    //   162: getfield 1051	com/tencent/biz/pubaccount/ecshopassit/EcShopData:mUin	Ljava/lang/String;
    //   165: aload 5
    //   167: invokeinterface 1055 3 0
    //   172: pop
    //   173: goto -39 -> 134
    //   176: astore 4
    //   178: aload_2
    ...
    //   204: aload 4
    //   206: invokevirtual 1060	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   215: invokestatic 1062	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   218: aload_3
    //   219: ifnull +7 -> 226
    //   222: aload_3
    //   223: invokevirtual 1065	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   226: return
    //   227: aload_2
    //   228: invokeinterface 1068 1 0
    //   233: istore_1
    //   234: goto -180 -> 54
    //   237: astore_2
    //   238: aload 4
    ...
    //   251: ifnull +8 -> 259
    //   254: aload 4
    //   256: invokevirtual 1065	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   259: aload_3
    //   260: athrow
    //   261: aload_2
    //   262: monitorexit
    ...
    //   264: ifnull -38 -> 226
    //   267: aload_3
    //   268: invokevirtual 1065	com/tencent/mobileqq/persistence/EntityManager:close	()V
    //   271: return
    //   272: astore_3
    //   273: aload_2
    //   274: astore 4
  ...
  public int a()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      n = tzq.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((EcShopData)localObject1).mUin);
    ...
    for (Object localObject1 = ((QQMessageFacade)localObject2).a(((EcShopData)localObject1).mUin, n);; localObject1 = null)
    {
      if (localObject1 != null)
      {
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        if (localObject2 != null) {
          m += ((adab)localObject2).a(((QQMessageFacade.Message)localObject1).frienduin, ((QQMessageFacade.Message)localObject1).istroop);
        }
      }
      for (;;)
      {
  ...
  public String a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        localObject1 = str;
        if ((localaody != null) && (!alok.a(paramQQAppInterface))) {
          break label109;
        }
      }
    }
    for (;;)
    {
      try
      {
        localObject1 = localaody.a(paramString, true);
        if (localObject1 == null) {
          break label124;
        }
        ...
        paramQQAppInterface = tzq.a(paramQQAppInterface, paramString);
        if (paramQQAppInterface == null) {
          break label121;
        }
      ...
      {
        localObject2 = localaody.b(paramString);
        continue;
      }
      label109:
      Object localObject2 = localaody.b(paramString);
      continue;
      label119:
      return localObject2;
      label121:
  ...
  public void a(long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      Object localObject2 = (RecentUser)((apaw)localObject1).findRecentUserByUin(antf.ae, 7120);
      if (((RecentUser)localObject2).lastmsgtime < paramLong) {
        ((RecentUser)localObject2).lastmsgtime = paramLong;
      }
      ((RecentUser)localObject2).lastmsgdrafttime = ((RecentUser)localObject2).lastmsgtime;
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        if (paramInt >= 0)
        {
          ...
          paramContext = "1";
          label374:
          str = blhn.a(str, "has_reddot", paramContext);
          if (localObject != null) {
            break label708;
          }
          paramContext = "0";
          label394:
          localObject = blhn.a(str, "gender", paramContext);
          ...
          if (!TextUtils.isEmpty(localSharedPreferences.getString("PUSH_JUMP_URL", ""))) {
            paramContext = blhn.a((String)localObject, "jumpUrl", localSharedPreferences.getString("PUSH_JUMP_URL", ""));
          }
        ...
        {
          paramContext = blhn.a(blhn.a(paramContext, "type", (String)localObject), "taskType", String.valueOf(localSharedPreferences.getInt("PUSH_TASK_TYPE", 0)));
          ...
          paramContext = (RecentUser)paramContext.findRecentUser(antf.ae, 7120);
          bool2 = bool1;
          if (paramContext == null) {
            break label255;
          }
          paramContext = alni.a(paramContext.uin, paramContext.getType());
          paramContext = alni.a().a(paramContext);
          bool2 = bool1;
          if (paramContext == null) {
            break label255;
          }
  ...
  public void a(bdol parambdol, Activity paramActivity)
  {
    if (parambdol == null) {
      return;
    }
    try
    {
      GdtAd localGdtAd = new GdtAd(a(parambdol));
      ...
      localParams.jdField_a_of_type_Boolean = "1".equals(parambdol.Y);
      ...
      parambdol = paramActivity;
      if (paramActivity == null) {
        parambdol = new Bundle();
      }
      parambdol.putString("big_brother_ref_source_key", "biz_src_gzh_qqgw");
      localParams.jdField_a_of_type_AndroidOsBundle = parambdol;
      GdtHandler.a(localParams);
      return;
    }
    catch (Throwable parambdol)
    {
      QLog.e("EcShopAssistantManager", 1, "enterGDTVideoActivity throw an exception: " + parambdol);
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        this.jdField_a_of_type_JavaUtilSet = bhsj.a((SharedPreferences)localObject2, "ec_shop_assist_new_unread_list", null);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    if ((??? != null) && (((List)???).size() > 0))
    {
      ...
      while (((Iterator)???).hasNext())
      {
        ...
        if ((((RecentUser)localObject4).getType() == 1008) && (tug.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((RecentUser)localObject4).uin)) && (!((RecentUser)localObject4).shouldShowInRecentList(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)))
        {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
      {
        ...
        while (((Iterator)localObject4).hasNext())
        {
          ...
          if ((!tug.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((EcShopData)localObject5).mUin)) && (!((EcShopData)localObject5).mUin.equalsIgnoreCase(jdField_g_of_type_JavaLangString)))
          {
    ...
    if (((ArrayList)localObject1).size() > 0)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        {
          localObject4 = (aody)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56);
          if ((localObject4 != null) && (((aody)localObject4).c(((EcShopData)localObject2).mUin) != null))
          {
  ...
  public boolean a(bdol parambdol, Activity paramActivity)
  {
    if (parambdol == null) {
      return false;
    }
    if (((parambdol.a instanceof AbsShareMsg)) && (((AbsShareMsg)parambdol.a).mStructMsgItemLists != null))
    {
      Object localObject = (bdol)((AbsShareMsg)parambdol.a).mStructMsgItemLists.get(0);
      try
      {
        if (((localObject instanceof bdom)) && (((bdol)localObject).jdField_c_of_type_Int == 1))
        {
          GdtAd localGdtAd = new GdtAd(a((bdol)localObject));
          ...
          ((GdtHandler.Params)localObject).jdField_a_of_type_Boolean = "1".equals(parambdol.Y);
          ((GdtHandler.Params)localObject).jdField_b_of_type_Boolean = true;
          ...
          parambdol.putString("big_brother_ref_source_key", "biz_src_gzh_qqgw");
          ((GdtHandler.Params)localObject).jdField_a_of_type_AndroidOsBundle = parambdol;
  ...
  {
    return ((jdField_b_of_type_JavaUtilList != null) && (jdField_b_of_type_JavaUtilList.contains(paramString))) || (tug.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString));
  }
  ...
  public void c()
  {
    ...
    if (localbihz != null)
    {
      Object localObject2 = asfa.a("VIP_shop_assit_cfg", "https://imgcache.qq.com/zzapp/qqshop/banner/qqshop_shopinghelper_conf.json");
      if (localbihz.a((String)localObject2) == null)
      {
        ...
        if (((File)localObject1).exists())
        {
          ...
          ((bihu)localObject2).i = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getLong("last_modified_time", 0L);
          if (Long.valueOf(l1).longValue() != ((bihu)localObject2).i) {
            ((bihu)localObject2).m = true;
          }
        }
        ((bihu)localObject2).j = true;
        ((bihu)localObject2).p = false;
        localObject1 = new Bundle();
        localbihz.a((bihu)localObject2, this.jdField_a_of_type_Oen, (Bundle)localObject1);
      }
    }
  }
  ...
  public void d()
  {
    for (;;)
    {
      try
      {
        ...
        if ((1008 == localRecentUser.getType()) && (tug.e(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin)))
        {
  ...
  void f()
  {
    ...
    {
      m = 0;
      localObject2 = (aody)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56);
      ...
      {
        if ((l2 <= i1) || (l2 >= i2) || (((aody)localObject2).a(Long.valueOf(l1)))) {
          break label571;
        }
    ...
    {
      if (((l2 < i1) || (l2 > i2) || (((aody)localObject2).a(Long.valueOf(l1)))) && (localObject1 != null))
      {
      ...
      if (localObject1 != null)
      {
        ...
        break label314;
        ((ofe)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(88)).a(134246436, null, null, null, null, this.jdField_b_of_type_Long, false);
        return;
      }
      m = 0;
      break;
  ...
  public void onDestroy()
  {
    try
    {
      ...
      this.jdField_a_of_type_Oen = null;
      return;
    }
    catch (Exception localException)
    {
