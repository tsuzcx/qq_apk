...
public class snf
{
  ...
  public static stLinkStragegyArgs a()
  {
    ...
    localstLinkStragegyArgs.hasInstalledWeish = vzz.a(BaseApplicationImpl.getApplication().getApplicationContext());
  ...
  private static boolean a(String paramString1, String paramString2, int paramInt)
  {
    ...
    boolean bool = bhno.a(System.currentTimeMillis(), l);
    if (!bool) {
  ...
  private static String h()
  {
    ...
    if (localAppRuntime != null)
    {
      ...
      if (!TextUtils.isEmpty(localAppRuntime.getAccount())) {
        str1 = bdhu.a(localAppRuntime.getAccount());
      }
    }
    return str1 + "_" + str3;
  }
