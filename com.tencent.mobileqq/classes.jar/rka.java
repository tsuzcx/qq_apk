...
{
  public rka(AssociatedAccountManageActivity paramAssociatedAccountManageActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      paramView.setContentDescription(this.a.getString(2131437112));
      return;
    ...
    paramView.setContentDescription(this.a.getString(2131437113));
    return;
    AssociatedAccountManageActivity.a(this.a).a();
    ...
    {
      paramView.setContentDescription(this.a.getString(2131437112));
      AssociatedAccountManageActivity.a(this.a).setContentDescription(this.a.getString(2131437113));
    }
    if ((localView1 instanceof ShaderAnimLayout)) {
      ((ShaderAnimLayout)localView1).b();
    }
