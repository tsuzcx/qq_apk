...
public class rka
{
      ...
      try
      {
        ...
        else
        {
          ...
          if (paramArticleSummary.msg_video_data.has())
          {
            ...
            localObject2 = new qnu();
            localWeiShiVideoArticleInfo.videoData = ((qnu)localObject2);
            if (((Readinjoy.VideoData)localObject1).uint32_busi_type.has()) {
              ((qnu)localObject2).jdField_a_of_type_Int = ((Readinjoy.VideoData)localObject1).uint32_busi_type.get();
            }
            if (((Readinjoy.VideoData)localObject1).uint32_duration.has()) {
              ((qnu)localObject2).jdField_b_of_type_Int = ((Readinjoy.VideoData)localObject1).uint32_duration.get();
            }
            if (((Readinjoy.VideoData)localObject1).uint32_width.has()) {
              ((qnu)localObject2).c = ((Readinjoy.VideoData)localObject1).uint32_width.get();
            }
            if (((Readinjoy.VideoData)localObject1).uint32_height.has()) {
              ((qnu)localObject2).d = ((Readinjoy.VideoData)localObject1).uint32_height.get();
            }
            if (((Readinjoy.VideoData)localObject1).bytes_vid.has()) {
              ((qnu)localObject2).jdField_a_of_type_JavaLangString = ((Readinjoy.VideoData)localObject1).bytes_vid.get().toStringUtf8();
            }
            if (((Readinjoy.VideoData)localObject1).uint32_file_size.has()) {
              ((qnu)localObject2).e = ((Readinjoy.VideoData)localObject1).uint32_file_size.get();
            }
            if (((Readinjoy.VideoData)localObject1).bytes_video_url.has()) {
              ((qnu)localObject2).jdField_b_of_type_JavaLangString = ((Readinjoy.VideoData)localObject1).bytes_video_url.get().toStringUtf8();
            }
          }
  ...
  public static WeiShiVideoArticleInfo a(oidb_cmd0xbed.ArticleSummary paramArticleSummary, int paramInt1, int paramInt2)
  {
    ...
    if (paramArticleSummary != null)
    {
      ...
      for (;;)
      {
          ...
          else
          {
            ...
            if (paramArticleSummary.msg_video_data.has())
            {
              ...
              if (((oidb_cmd0xbed.VideoData)localObject1).uint32_busi_type.has()) {
                ((qnu)localObject2).jdField_a_of_type_Int = ((oidb_cmd0xbed.VideoData)localObject1).uint32_busi_type.get();
              }
              if (((oidb_cmd0xbed.VideoData)localObject1).uint32_duration.has()) {
                ((qnu)localObject2).jdField_b_of_type_Int = ((oidb_cmd0xbed.VideoData)localObject1).uint32_duration.get();
              }
              if (((oidb_cmd0xbed.VideoData)localObject1).uint32_width.has()) {
                ((qnu)localObject2).c = ((oidb_cmd0xbed.VideoData)localObject1).uint32_width.get();
              }
              if (((oidb_cmd0xbed.VideoData)localObject1).uint32_height.has()) {
                ((qnu)localObject2).d = ((oidb_cmd0xbed.VideoData)localObject1).uint32_height.get();
              }
              if (((oidb_cmd0xbed.VideoData)localObject1).bytes_vid.has()) {
                ((qnu)localObject2).jdField_a_of_type_JavaLangString = ((oidb_cmd0xbed.VideoData)localObject1).bytes_vid.get().toStringUtf8();
              }
              if (((oidb_cmd0xbed.VideoData)localObject1).uint32_file_size.has()) {
                ((qnu)localObject2).e = ((oidb_cmd0xbed.VideoData)localObject1).uint32_file_size.get();
              }
              if (((oidb_cmd0xbed.VideoData)localObject1).bytes_video_url.has()) {
                ((qnu)localObject2).jdField_b_of_type_JavaLangString = ((oidb_cmd0xbed.VideoData)localObject1).bytes_video_url.get().toStringUtf8();
              }
            }
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.e("VideoProtoHelper", 0, "cmd0xbedToWeiShiVideoArticleInfo error:" + ors.a(paramArticleSummary));
          }
        }
        bool = false;
      }
  ...
  public static Readinjoy.ArticleSummary a(BaseVideoArticleInfo paramBaseVideoArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable paramBaseVideoArticleInfo)
      {
        ...
        QLog.e("VideoProtoHelper", 0, "videoArticleinfoCovert2LocalPB error:" + ors.a(paramBaseVideoArticleInfo));
      }
  ...
  public static Readinjoy.VideoData a(qnu paramqnu)
  {
    Object localObject;
    if (paramqnu == null) {
      localObject = null;
    ...
    do
    {
      ...
      localVideoData.uint32_busi_type.set(paramqnu.jdField_a_of_type_Int);
      localVideoData.uint32_duration.set(paramqnu.jdField_b_of_type_Int);
      localVideoData.uint32_width.set(paramqnu.c);
      localVideoData.uint32_height.set(paramqnu.d);
      if (!TextUtils.isEmpty(paramqnu.jdField_a_of_type_JavaLangString)) {
        localVideoData.bytes_vid.set(ByteStringMicro.copyFromUtf8(paramqnu.jdField_a_of_type_JavaLangString));
      }
      localVideoData.uint32_file_size.set(paramqnu.e);
      localObject = localVideoData;
    } while (TextUtils.isEmpty(paramqnu.jdField_b_of_type_JavaLangString));
    localVideoData.bytes_video_url.set(ByteStringMicro.copyFromUtf8(paramqnu.jdField_b_of_type_JavaLangString));
    return localVideoData;
  }
  
  public static qnu a(Readinjoy.VideoData paramVideoData)
  {
    ...
    do
    {
      ...
      if (paramVideoData.uint32_busi_type.has()) {
        localqnu.jdField_a_of_type_Int = paramVideoData.uint32_busi_type.get();
      }
      if (paramVideoData.uint32_duration.has()) {
        localqnu.jdField_b_of_type_Int = paramVideoData.uint32_duration.get();
      }
      if (paramVideoData.uint32_width.has()) {
        localqnu.c = paramVideoData.uint32_width.get();
      }
      if (paramVideoData.uint32_height.has()) {
        localqnu.d = paramVideoData.uint32_height.get();
      }
      if (paramVideoData.bytes_vid.has()) {
        localqnu.jdField_a_of_type_JavaLangString = paramVideoData.bytes_vid.get().toStringUtf8();
      }
      if (paramVideoData.uint32_file_size.has()) {
        localqnu.e = paramVideoData.uint32_file_size.get();
      }
      localObject = localqnu;
    } while (!paramVideoData.bytes_video_url.has());
    localqnu.jdField_b_of_type_JavaLangString = paramVideoData.bytes_video_url.get().toStringUtf8();
    return localqnu;
  }
}
