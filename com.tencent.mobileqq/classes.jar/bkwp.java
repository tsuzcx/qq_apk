...
{
  bkwp(bkwo parambkwo, ChannelProxy.AuthListResult paramAuthListResult) {}
  ...
  public void onCmdListener(boolean paramBoolean, JSONObject paramJSONObject)
  {
    ...
    do
    {
      ...
      while (paramJSONObject.hasNext())
      {
        ...
        localArrayList2.add(bkwo.a(this.jdField_a_of_type_Bkwo, (INTERFACE.StUserSettingInfo)localObject));
      }
