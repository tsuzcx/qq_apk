...
public abstract class aabp<E>
  extends aabs<E>
  implements aabo, Application.ActivityLifecycleCallbacks
{
  private static final String TAG = aabp.class.getSimpleName();
  ...
  private aabj mBlockMerger;
  private final RecyclerView.AdapterDataObserver mDataSetObserver = new aabq(this);
  private final Handler mHandler = new Handler(Looper.getMainLooper());
  protected boolean mHasInitialized;
  private Bundle mInitData;
  protected aafz mInteractor;
  protected boolean mIsDestroyed;
  private final aabu mLoadInfo = new aabu();
  private aabr mOnLoadDataDelegate;
  private int mPositionOffsetStart;
  private String mUniqueKey = String.valueOf(hashCode());
  private int mViewTypeOffsetStart;
  
  public aabp(Bundle paramBundle)
  {
    this.mInitData = paramBundle;
    setHasStableIds(true);
  }
  
  private void _loadData(aabu paramaabu)
  {
    if (this.mOnLoadDataDelegate != null)
    {
      this.mOnLoadDataDelegate.a(paramaabu, this);
      return;
    }
    loadData(paramaabu);
  }
  ...
  {
    if ((this.mDataList != null) && (!blgn.a(paramInt, this.mDataList))) {
  ...
  public aabr getOnLoadDataDelegate()
  {
  ...
  public aabn getShareData(String paramString)
  {
  ...
  public <T extends aabb> T getViewModel(Class<T> paramClass)
  {
  ...
  public abstract void loadData(aabu paramaabu);
  
  public void loadMoreData(aabu paramaabu)
  {
    if (this.mOnLoadDataDelegate != null)
    {
      this.mOnLoadDataDelegate.a(paramaabu, this);
  ...
  public void setBlockMerger(aabj paramaabj)
  {
    this.mBlockMerger = paramaabj;
  }
  ...
  {
    this.mInteractor = paramaafz;
  }
  
  public void setOnLoadDataDelegate(aabr paramaabr)
  {
    this.mOnLoadDataDelegate = paramaabr;
  }
  
  public void setShareData(String paramString, aabn paramaabn)
  {
    if (this.mBlockMerger != null) {
      this.mBlockMerger.a(paramString, paramaabn);
    }
  }
