  ...
  extends anud
{
  ...
  public ayxr(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(int paramInt, Intent paramIntent, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      for (paramIntent = Integer.toString(j);; paramIntent = i + "_" + j)
      {
        ...
        bdmc.a(this.mApp.getApplication()).a(this.app.getCurrentAccountUin(), "ocrTextSearch", bool, l, 0L, paramArrayOfByte, "");
        if (QLog.isColorLevel()) {
  ...
  private void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      Object localObject4 = besx.a().b(l1);
      Object localObject5 = besx.a().a(l1);
      ...
      try
      {
        ...
        ((beum)localObject1).jdField_a_of_type_ArrayOfByte = ((byte[])localObject5);
        ((beum)localObject1).jdField_a_of_type_Beuq = new ayxs(this, paramIntent, (byte[])localObject2, (String)localObject3);
        ((beum)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject4);
        ((beum)localObject1).jdField_a_of_type_Int = 1;
        ((beum)localObject1).e = 57;
        ((beum)localObject1).jdField_a_of_type_JavaUtilHashMap.put("Accept-Encoding", "identity");
        ((beum)localObject1).jdField_b_of_type_Int = 2;
        ((beum)localObject1).c = 15000L;
        ((beum)localObject1).f = true;
        ((beum)localObject1).g = true;
        ((beum)localObject1).jdField_b_of_type_JavaLangString = "sslv6.htdata.qq.com";
        paramIntent = BaseApplicationImpl.sApplication.getRuntime();
        if ((paramIntent instanceof AppInterface))
        {
          ((AppInterface)paramIntent).getNetEngine(0).a((bevl)localObject1);
          if (QLog.isColorLevel()) {
