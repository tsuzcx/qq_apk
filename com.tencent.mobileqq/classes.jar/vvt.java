  ...
  implements vvv
{
  ...
  public vvt(AppInterface paramAppInterface, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public void a(@NonNull ArrayList<vvw> paramArrayList, @NonNull Context paramContext)
  {
    ...
    if (this.jdField_a_of_type_Boolean) {
      paramArrayList.add(new vvw(paramContext.getResources().getDrawable(2130845877), 1, 0));
    }
      ...
      if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
      {
        ...
        if (bool)
        {
          ...
          if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
          {
            ...
            do
            {
              localObject4 = localvvw1;
              localObject5 = localObject2;
              localObject6 = localObject3;
              localObject7 = localvvw2;
            ...
            {
              localObject4 = new vvw(paramContext.getResources().getDrawable(2130844246), 2, i);
    ...
    for (;;)
    {
      ...
      {
        localvvw1 = new vvw(paramContext.getResources().getDrawable(2130844247), 2, i);
      ...
      {
        localObject4 = new vvw(paramContext.getResources().getDrawable(2130844248), 2, i);
        localObject3 = localObject1;
        localObject1 = localObject2;
      ...
      {
        localObject4 = new vvw(paramContext.getResources().getDrawable(2130844245), 2, i);
        localObject1 = localObject2;
        localObject2 = localObject3;
        localObject3 = localObject4;
      }
      ...
      {
        localvvw2 = new vvw(paramContext.getResources().getDrawable(2130844244), 2, i);
        localObject4 = localObject1;
        localObject1 = localObject2;
        localObject2 = localObject3;
        localObject3 = localObject4;
        ...
        paramArrayList.add(new vvw(paramContext.getResources().getDrawable(2130845869), 0, -1));
        int k = 0;
