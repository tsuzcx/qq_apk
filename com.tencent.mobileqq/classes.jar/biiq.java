...
public class biiq
{
  ...
  public int a;
  final biih jdField_a_of_type_Biih = new biih(new biir(this));
  public boolean a;
  public int b = 0;
  ...
  public int a(Bundle paramBundle)
  {
    ...
    for (boolean bool = BaseApplicationImpl.sApplication.getSharedPreferences("sp_x5_config_" + (String)localObject, 4).getBoolean("key_x5_init_sub_thread", true);; bool = true)
    {
      ...
      biis.b();
      bihv.X = System.currentTimeMillis() - l;
      QLog.i("WebLog_SwiftWebAccelerator", 1, "initX5Environment on main thread, cost " + bihv.X + "ms.");
      return 1;
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    if (Looper.getMainLooper() == Looper.myLooper())
    {
      if (!this.jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Biih.b();
        this.jdField_a_of_type_Biih.a(localBundle);
  ...
  public int b(Bundle paramBundle)
  {
    ...
    bihv.Y = System.currentTimeMillis() - l;
    QLog.i("WebLog_SwiftWebAccelerator", 1, "doMainStep_CreateWebView:create webview cost " + bihv.Y + "ms.");
    return 1;
  }
  ...
  public int c(Bundle paramBundle)
  {
    ...
    bihv.Z = System.currentTimeMillis() - l;
    QLog.i("WebLog_SwiftWebAccelerator", 1, "tendocpreload doMainStep_WarnUpWebView:load " + paramBundle + ", cost " + bihv.Z + "ms.");
    return 1;
  }
  ...
  public int e(Bundle paramBundle)
  {
    ...
    if (WebAccelerateHelper.preloadBrowserView == null)
    {
      ...
      bihv.aa = System.currentTimeMillis() - l;
      QLog.i("WebLog_SwiftWebAccelerator", 1, "doMainStep_CreateBrowserView, cost = " + bihv.aa + "ms.");
      return 1;
    }
    return 0;
  }
