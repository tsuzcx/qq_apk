...
public class apdj
{
  ...
  public apdj(QQAppInterface paramQQAppInterface)
  {
  ...
  private String a(String paramString1, String paramString2, int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      localPair = bicy.a(paramString2, paramInt, paramBoolean);
      localFile = new File(bicy.b(), Long.toString(((Long)localPair.second).longValue()));
    ...
    paramString1 = new apdu(this, paramString1, paramInt, paramObject);
    bidy.a().a((String)((Pair)localPair.first).first, paramString2, (String)((Pair)localPair.first).second, paramString1);
    return null;
  }
  
  private void a(WeiyunPB.AioPicAndVideoCopyToWeiyunMsgReq paramAioPicAndVideoCopyToWeiyunMsgReq, apdx paramapdx)
  {
    bici.a();
    bidq.a(paramAioPicAndVideoCopyToWeiyunMsgReq, new apdt(this, paramapdx));
  }
  
  private void b()
  {
    if (!bifj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
    {
      if (NetworkUtils.isWifiAvailable(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
      {
        this.c = true;
        bifj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), new apdv(this));
      }
      return;
    }
    this.b = true;
    bick.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), true);
    WeiyunTransmissionGlobal.getInstance().getUploadManager().loadLibFromPath(bifj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()).getAbsolutePath());
  }
  
  public apec a(FileManagerEntity paramFileManagerEntity, Object paramObject, biel parambiel)
  {
    ...
    do
    {
      ...
      localPair = aovy.a(paramFileManagerEntity.WeiYunFileId);
      if (localPair != null) {
        break;
      }
    ...
    if (paramFileManagerEntity.nWeiYunSrcType == 2) {
      paramFileManagerEntity = bidy.a().a(paramFileManagerEntity.strLargeThumPath, paramFileManagerEntity.strThumbPath, paramFileManagerEntity.WeiYunDirKey, paramFileManagerEntity.WeiYunFileId, parambiel);
    }
    label285:
    for (;;)
    {
      return new apec(paramFileManagerEntity, paramObject, false, null, parambiel);
      paramFileManagerEntity = bick.a(paramFileManagerEntity.WeiYunFileId, paramFileManagerEntity.fileName, paramFileManagerEntity.strFileSHA, paramFileManagerEntity.fileSize, 0, paramFileManagerEntity.WeiYunDirKey, paramFileManagerEntity.strLargeThumPath);
      if (paramFileManagerEntity == null) {}
      for (paramFileManagerEntity = null;; paramFileManagerEntity = bidy.a().a(paramFileManagerEntity, bicy.a(), true, parambiel))
      {
  ...
  public apec a(String paramString, Object paramObject, UploadManager.IUploadStatusListener paramIUploadStatusListener)
  {
    if ((!this.b) && (!this.c)) {
      b();
    }
    ...
    paramString = bick.b(paramString, UploadFile.createUploadBatch(1, null), 1);
    if (paramString == null) {}
    ...
    label134:
    return new apec(paramString, paramObject, true, paramIUploadStatusListener, null);
  }
  ...
  public FileManagerEntity a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    localFileManagerEntity.peerNick = apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, null, paramFileManagerEntity.peerType);
    ...
    for (localFileManagerEntity.selfUin = paramFileManagerEntity.peerUin;; localFileManagerEntity.selfUin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount())
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "insertWeiYun2OfflineEntity FileManagerEntity:" + apue.a(localFileManagerEntity));
      }
  ...
  public FileManagerEntity a(FileManagerEntity paramFileManagerEntity, String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.e("WeiYunLogicCenter<FileAssistant>", 2, "insertWeiYun2OfflineEntity : entity is null, peerUin[" + apue.e(paramString2) + "], peerType[" + paramInt + "]");
      }
      return null;
    }
    FileManagerEntity localFileManagerEntity = new FileManagerEntity();
    ...
    localFileManagerEntity.peerNick = apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2, null, paramInt);
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramString2, paramFileManagerEntity, true, localFileManagerEntity.fileName, localFileManagerEntity.fileSize, true, paramInt, str, localFileManagerEntity.msgSeq, localFileManagerEntity.msgSeq, null, 2, l, localFileManagerEntity.msgUid, -1L, awzw.a());
      if (QLog.isColorLevel()) {
        QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "insertWeiYun2OfflineEntity peerType[" + paramInt + "],FileManagerEntity:" + apue.a(localFileManagerEntity));
      }
      return localFileManagerEntity;
      if (paramInt == 1006)
      {
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    bidq.a(localCrossBidProxyOfflineFileGetListMsgReq, new apdp(this, paramInt1));
  }
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      bidq.a(localLibInfoListGetMsgReq, new apdk(this, paramString1));
      return;
      if (this.jdField_a_of_type_JavaUtilLinkedHashMap != null) {
        break label165;
      }
  ...
  public void a(ChatMessage paramChatMessage, apdx paramapdx)
  {
    ...
    for (;;)
    {
      ...
      a(localAioPicAndVideoCopyToWeiyunMsgReq, paramapdx);
      return;
  ...
  public void a(FileManagerEntity paramFileManagerEntity, int paramInt, boolean paramBoolean)
  {
    if (paramFileManagerEntity == null)
    {
      ...
      apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0L, "actFileWy2Of", 0L, "", "", "", "", 9006L, "entity is null", 0L, 0L, 0L, "", "", 0, "", null);
      apue.a();
      return;
    }
    ...
    if (!bbev.d(BaseApplication.getContext()))
    {
      ...
      apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.nSessionId, "actFileWy2Of", 0L, "", paramFileManagerEntity.peerUin, "", "", 9004L, "Error_No_Network", 0L, 0L, 0L, "", "", 0, "", null);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(paramFileManagerEntity);
      return;
    }
    QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "=_= ^ [CS Send]sendWyFile2QqOffline, peerUin[" + apue.e(paramFileManagerEntity.peerUin) + "peerType[" + paramInt + "]], WeiYunFileId[" + paramFileManagerEntity.WeiYunFileId + "], fileName[" + paramFileManagerEntity.fileName + "], fileSize[" + paramFileManagerEntity.fileSize + "], nWeiYunSrcType[" + paramFileManagerEntity.nWeiYunSrcType + "]");
    ...
    try
    {
      ...
      if ((localaser != null) && (localaser.a(paramFileManagerEntity.peerUin)))
      {
        apue.a(ajyc.a(2131716922));
        paramFileManagerEntity.status = 0;
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(false, 3, null);
    ...
    if (paramFileManagerEntity.strFileSHA != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_sha.set(bifn.a(paramFileManagerEntity.strFileSHA));
    }
    if (paramFileManagerEntity.strFileMd5 != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_md5.set(bifn.a(paramFileManagerEntity.strFileMd5));
    }
    for (;;)
    {
      ...
      if (paramFileManagerEntity.WeiYunDirKey != null) {
        localCrossBidProxyCopyFileToOtherBidMsgReq.src_pdir_key.set(bifn.a(paramFileManagerEntity.WeiYunDirKey));
      }
      ...
      if (paramFileManagerEntity.tmpSessionType > 0L)
      {
        ...
        paramFileManagerEntity.tmpSessionSig = apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.peerUin, (int)paramFileManagerEntity.tmpSessionType);
      ...
      bidq.a(localCrossBidProxyCopyFileToOtherBidMsgReq, new apdq(this, paramFileManagerEntity, paramInt));
      ...
      break;
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_md5.set(bifn.a(""));
    }
  }
  
  public void a(FileManagerEntity paramFileManagerEntity, long paramLong, String paramString, boolean paramBoolean1, boolean paramBoolean2, apdx paramapdx)
  {
    if (!bbev.d(BaseApplication.getContext()))
    {
      if (paramapdx != null) {
    ...
    do
    {
      ...
      if (paramBoolean2)
      {
        i = 1;
        paramString.set(i);
        i = apue.a(paramFileManagerEntity);
        if (i != 2) {
          break label249;
        }
        ...
        if (!TextUtils.isEmpty(paramFileManagerEntity.WeiYunDirKey)) {
          localWeiyunShareAddFromMobileQQMsgReq.file.pdir_key.set(bifn.a(paramFileManagerEntity.WeiYunDirKey));
        }
      }
      for (;;)
      {
        for (;;)
        {
          bidq.a(localWeiyunShareAddFromMobileQQMsgReq, new apdm(this, paramapdx));
          return;
          i = 0;
          break label147;
          if (i == 1)
          ...
          try
          {
            paramFileManagerEntity = bakj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity);
  ...
  public void a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    do
    {
      ...
      localazqt = localTroopFileTransferManager.a(paramFileManagerEntity.WeiYunFileId, paramFileManagerEntity.fileName, paramFileManagerEntity.getFilePath(), paramFileManagerEntity.fileSize, 25, i, 8888L);
    } while (localazqt == null);
    int j = apue.a(localazqt.jdField_a_of_type_JavaLangString);
    Object localObject;
    TroopFileTransferManager.Item localItem;
    if ((apvb.a(localazqt.jdField_a_of_type_JavaLangString)) && ((j == 0) || (j == 2))) {
      if (j == 0)
      {
        localObject = new BitmapFactory.Options();
        ((BitmapFactory.Options)localObject).inJustDecodeBounds = true;
        BitmapFactory.decodeFile(localazqt.jdField_a_of_type_JavaLangString, (BitmapFactory.Options)localObject);
        bakj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, localazqt.g, localazqt.c, localazqt.jdField_a_of_type_JavaUtilUUID.toString(), i, Long.toString(localazqt.b), paramFileManagerEntity.nSessionId, ((BitmapFactory.Options)localObject).outWidth, ((BitmapFactory.Options)localObject).outHeight);
        localItem = localTroopFileTransferManager.a(localazqt.jdField_a_of_type_JavaUtilUUID);
        if (localItem != null)
        {
    ...
    for (;;)
    {
      ...
      paramFileManagerEntity.status = 0;
      paramFileManagerEntity.isReaded = false;
      localTroopFileTransferManager.a(localazqt.jdField_a_of_type_JavaUtilUUID, -1, null, ajyc.a(2131716920));
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      if (j == 2)
      {
        localObject = ShortVideoUtils.a(localazqt.jdField_a_of_type_JavaLangString);
        bakj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, localazqt.g, localazqt.c, localazqt.jdField_a_of_type_JavaUtilUUID.toString(), i, Long.toString(localazqt.b), paramFileManagerEntity.nSessionId, localObject[0], localObject[1], localObject[2]);
        localItem = localTroopFileTransferManager.a(localazqt.jdField_a_of_type_JavaUtilUUID);
        if (localItem != null)
        {
          ...
          continue;
          bakj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramFileManagerEntity.fileName, paramFileManagerEntity.fileSize, localazqt.jdField_a_of_type_JavaUtilUUID.toString(), i, Long.toString(8888L), paramFileManagerEntity.nSessionId);
        }
      }
    }
    label443:
    if (QLog.isColorLevel()) {
      QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "sendWeiYun2Troop, peerUin[" + apue.e(paramFileManagerEntity.peerUin) + "], WeiYunFileId[" + paramFileManagerEntity.WeiYunFileId + "], fileName[" + paramFileManagerEntity.fileName + "], fileSize[" + paramFileManagerEntity.fileSize + "], nWeiYunSrcType[" + paramFileManagerEntity.nWeiYunSrcType + "]");
    }
    paramFileManagerEntity.fProgress = 0.0F;
    long l2 = 0L;
    try
    {
      ...
      if (paramFileManagerEntity.strFileSHA != null) {
        paramString.file_sha.set(bifn.a(paramFileManagerEntity.strFileSHA));
      }
      if (paramFileManagerEntity.strFileMd5 != null) {
        paramString.file_md5.set(bifn.a(paramFileManagerEntity.strFileMd5));
      }
      if (paramFileManagerEntity.WeiYunFileId != null) {
        paramString.src_file_id.set(paramFileManagerEntity.WeiYunFileId);
      }
      if (paramFileManagerEntity.WeiYunDirKey != null) {
        paramString.src_pdir_key.set(bifn.a(paramFileManagerEntity.WeiYunDirKey));
      }
      ...
      bidq.a(paramString, new apdr(this, localTroopFileTransferManager, localazqt, paramFileManagerEntity));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramFileManagerEntity.nSessionId);
      return;
    }
  ...
  public void a(WeiYunFileInfo paramWeiYunFileInfo)
  {
    ...
    apeh.a(paramWeiYunFileInfo.jdField_a_of_type_JavaLangString, paramWeiYunFileInfo);
    ...
    if (paramWeiYunFileInfo.b != null) {
      ((WeiyunPB.DiskSimpleFileItem)localObject).pdir_key.set(bifn.a(paramWeiYunFileInfo.b));
    }
    ...
    bidq.a((WeiyunPB.DiskDirFileBatchDeleteExMsgReq)localObject, new apdw(this, paramWeiYunFileInfo));
  }
  
  public void a(WeiYunFileInfo paramWeiYunFileInfo, apdx paramapdx)
  {
    ...
    do
    {
      ...
      } while (paramapdx == null);
      paramapdx.a(-1, "no_network");
      return;
    ...
    paramapdx.a(-2, "no_weiyunid_or_filename");
    return;
    WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgReq localCrossBidProxyCopyFileToOtherBidMsgReq = new WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgReq();
    ...
    if (paramWeiYunFileInfo.j != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_sha.set(bifn.a(paramWeiYunFileInfo.j));
    }
    if (paramWeiYunFileInfo.i != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_md5.set(bifn.a(paramWeiYunFileInfo.i));
    }
    for (;;)
    {
      ...
      if (paramWeiYunFileInfo.b != null) {
        localCrossBidProxyCopyFileToOtherBidMsgReq.src_pdir_key.set(bifn.a(paramWeiYunFileInfo.b));
      }
      localCrossBidProxyCopyFileToOtherBidMsgReq.src_bid.set(25);
      localCrossBidProxyCopyFileToOtherBidMsgReq.src_uin.set(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin());
      localCrossBidProxyCopyFileToOtherBidMsgReq.src_group.set(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin());
      ...
      localCrossBidProxyCopyFileToOtherBidMsgReq.user_type.set(0);
      bidq.a(localCrossBidProxyCopyFileToOtherBidMsgReq, new apds(this, paramapdx));
      return;
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_md5.set(bifn.a(""));
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    if (!bbev.d(BaseApplication.getContext()))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(false, 45, new Object[] { Integer.valueOf(0), BaseApplication.getContext().getString(2131694607) });
      return;
    }
    ...
    bidq.a(localPwdVerifyMsgReq, new apdo(this));
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(false, 278, new Object[] { Integer.valueOf(1810001), ajyc.a(2131716923), "", "", "", "", Integer.valueOf(0) });
      return;
    }
    ...
    localDiskFileDocDownloadAbsMsgReq.pdir_key.set(bifn.a(paramString2));
    bidq.a(localDiskFileDocDownloadAbsMsgReq, new apdl(this));
  }
  
  public void a(List<MessageForPic> paramList, List<MessageForShortVideo> paramList1, apdx paramapdx)
  {
    WeiyunPB.AioPicAndVideoCopyToWeiyunMsgReq localAioPicAndVideoCopyToWeiyunMsgReq = new WeiyunPB.AioPicAndVideoCopyToWeiyunMsgReq();
