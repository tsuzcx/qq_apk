  ...
  implements alkr
{
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString)
  {
    ...
    label58:
    label68:
    for (String str = alpo.a(2131711344);; str = alpo.a(2131711342))
    {
      bfhq.a().a(paramString + str + alpo.a(2131711345));
      return;
      paramString = alpo.a(2131711343);
      break;
    }
  }
              ...
              do
              {
                do
                {
                  ...
                  if (localObject2 != null)
                  {
                    ...
                    localObject1 = ((usd)localObject3).b(((UserInfo)localObject2).uid);
                  ...
                  for (paramInt = i;; paramInt = 0)
                  {
                    ...
                    ((usd)localObject3).a(paramObject);
                  ...
                  if (paramBoolean)
                  {
                    Bosses.get().postJob(new uho(this, "QQStoryObserver", paramObject, (Boolean)localObject1, paramBoolean, paramInt));
                    return;
                  }
                  localObject1 = ((usd)urr.a(2)).b(paramObject);
                  if (localObject1 != null)
                  {
