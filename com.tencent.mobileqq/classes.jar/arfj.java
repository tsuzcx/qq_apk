...
public class arfj
{
  private void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Boolean localBoolean = (Boolean)bmhv.a("local_kd_tab_has_set");
    boolean bool3 = TextUtils.equals("1", paramString);
    bmhv.a(paramQQAppInterface, "remote_kd_tab_switch", Boolean.valueOf(bool3));
    boolean bool2;
  ...
  public void a(aqxa[] paramArrayOfaqxa)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        int j = 0;
        if (j < paramArrayOfaqxa.length)
        {
          if (TextUtils.isEmpty(paramArrayOfaqxa[j].a))
          {
          ...
          try
          {
            str2 = paramArrayOfaqxa[j].a.trim();
            ...
            bmhv.c(localQQAppInterface, str1);
            continue;
            if (!QLog.isColorLevel()) {
              continue;
            }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e("ReadinjoyCommonConfProcessor", 2, "received readinjoy cropandgroup config error,cmd : 92" + paramArrayOfaqxa.toString());
        }
      }
      if (TextUtils.equals((CharSequence)localObject2, "feeds_group"))
      {
        bmhv.a(localQQAppInterface, str1);
      }
      else if (TextUtils.equals((CharSequence)localObject2, "remind_only_wifi"))
      {
        bmhv.b(localQQAppInterface, str1);
      }
      ...
      {
        bmhv.d(localQQAppInterface, TextUtils.equals(str1, "1"));
      }
      else
      {
        ...
        else
        {
          ...
          if (TextUtils.equals((CharSequence)localObject2, "socializeWebUrl"))
          {
            ...
            if (localObject1 != null)
            {
              if (((Node)localObject1).getNodeType() == 1)
              {
                ...
                if (!bmhv.a((String)localObject2)) {
                  break label640;
                }
                bmhv.a(localQQAppInterface, (String)localObject2, (String)localObject3);
              }
              for (;;)
              {
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_report_tt"))
          {
            ...
            if (TextUtils.equals((CharSequence)localObject1, "1")) {
              bmhv.k(localQQAppInterface, true);
            } else {
              bmhv.k(localQQAppInterface, false);
            }
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_report_user_apps_switch"))
          {
            ...
            bmhv.a("kandian_report_user_apps_switch", localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "maintab_reddot_times"))
          {
            ...
            bmhv.h(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "maintab_reddot_feeds"))
          {
            ...
            bmhv.i(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "feedsbackWebUrl"))
          {
            bmhv.b(localQQAppInterface, (String)localObject2, (String)localObject1);
            if (QLog.isColorLevel()) {
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsSwitch"))
          {
            ...
            bmhv.j(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsName"))
          {
            ...
            bmhv.d(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsWebUrl"))
          {
            ...
            bmhv.e(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "badgeNumber"))
          {
            ...
            bmhv.x(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_word_count"))
          {
            ...
            bmhv.f(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "new_channel_style"))
          {
            ...
            bmhv.k(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_time"))
          {
            ...
            bmhv.a(localQQAppInterface, Long.valueOf((String)localObject1).longValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds"))
          {
            ...
            bmhv.y(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_time_weishi"))
          {
            ...
            bmhv.b(localQQAppInterface, Long.valueOf((String)localObject1).longValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds_weishi"))
          {
            ...
            bmhv.z(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandianWebPreLoadData"))
          {
            ...
            if (TextUtils.equals((CharSequence)localObject1, "1")) {
              bmhv.p(localQQAppInterface, true);
            } else {
              bmhv.p(localQQAppInterface, false);
            }
          }
          else if ((TextUtils.equals((CharSequence)localObject2, "ExitAIO_Android_Uin")) && (localObject1 != null))
          {
            ...
            if (localObject1.length >= 2) {
              bmhv.b(Integer.valueOf(localObject1[0]).intValue(), Integer.valueOf(localObject1[1]).intValue());
            }
          }
          ...
          {
            bmhv.a(localQQAppInterface, "remote_kd_tab_type", localObject1);
            ...
            if (!bool)
            {
              bmhv.a(localQQAppInterface, "local_kd_tab_type", localObject1);
          ...
          {
            bmhv.G(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "topic_card_jump"))
          {
            bmhv.a(localQQAppInterface, "kd_topic_recommend_card_jump_switch", Boolean.valueOf(((String)localObject1).equals("1")));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "topic_card_jump_url"))
          {
            bmhv.a(localQQAppInterface, "kd_topic_recommend_card_jump_url", localObject1);
          }
          ...
          else if ((TextUtils.equals((CharSequence)localObject2, "KW")) && (!TextUtils.isEmpty((CharSequence)localObject1)))
          {
            ...
            pkh.a("kandian_aio_sp_word", localObject2, true);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_gif_switch"))
          {
            ...
            bmhv.h(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "ugc_gif_switch"))
          {
            ...
            bmhv.i(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_at_switch"))
          {
            ...
            bmhv.n(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "UGC_at_switch"))
          {
            ...
            bmhv.m(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_at_switch"))
          {
            ...
            bmhv.v(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_profile_switch"))
          {
            ...
            bmhv.o(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_BiuMsg"))
          {
            ...
            bmhv.b(TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_InteractiveMsg"))
          {
            ...
            bmhv.c(TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_SubscribeMsg"))
          {
            ...
            bmhv.d((String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "nw_support"))
          {
            bmhv.q(localQQAppInterface, TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "nw_preload"))
          {
            bmhv.r(localQQAppInterface, TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "arkapp_enable_switch"))
          {
            ...
            bmhv.b(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "exposure_strengthen"))
          {
            bmhv.s(localQQAppInterface, "1".equals(localObject1));
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "diandian_publish_switch_new"))
          {
            ...
            bmhv.p(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_publish_switch_new"))
          {
            ...
            bmhv.q(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_QA_square_autoTimeval"))
          {
            ...
            bmhv.r(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "WXShareFromKandian_Switch"))
          {
            ...
            bmhv.s(localQQAppInterface, (String)localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "zhitu"))
          {
            ...
            bmhv.j(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_biu_switch"))
          {
            ...
            bmhv.t(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "native_comment_biu"))
          {
            ...
            bmhv.u(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_short_video_width_height_ratio"))
          {
            ...
            bmhv.b(localQQAppInterface, Float.valueOf((String)localObject1).floatValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_short_video_max_duration_limit"))
          {
            ...
            bmhv.v(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "record_duration_count"))
          {
            ...
            bmhv.g(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandiansettings"))
          {
            ...
            bmhv.C(localQQAppInterface, str2);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "is_show_weishi_entrance"))
          {
            ...
            bmhv.C(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "is_jump_to_video_content"))
          {
            ...
            bmhv.K(localQQAppInterface, (String)localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "ReadInJoy_Red_Pnt_Push_Article_Preload_Switch"))
          {
            ...
            bmhv.l(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "video_switch"))
          {
            ...
            try
            {
              ...
              bool = true;
              label4506:
              bmhv.a("sp_key_readinjoy_video_entrance_reddot_button_switch", Boolean.valueOf(bool));
            }
          ...
          else
          {
            ...
            if (bool)
            {
              try
              {
                bmhv.a("sp_key_readinjoy_video_entrance_reddot_button_color", Integer.valueOf(Color.parseColor(localNumberFormatException1)));
              }
            ...
            {
              bmhv.a("sp_key_readinjoy_video_entrance_reddot_expire_time_list", localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "ReadInJoy_guanzhu_Auto_Refresh_Time_Duration"))
            {
              ...
              bmhv.a("sp_key_kandian_subscribe_auto_refresh_config", Integer.valueOf(i));
            ...
            else if (TextUtils.equals((CharSequence)localObject2, "weishi_with_channel_discovery_switch"))
            {
              ...
              bmhv.e(localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "ugc_upload_lbs_switch"))
            {
              i = Integer.parseInt(localIllegalArgumentException);
              bmhv.a(oyn.READINJOY_UGC_LBS, Integer.valueOf(i));
            }
            else if (TextUtils.equals((CharSequence)localObject2, "local_record_time_weishi_recommend"))
            {
              ...
              bmhv.b(localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds_counts_weishi_recommend"))
            {
              ...
              bmhv.c(localIllegalArgumentException);
            }
            else
            {
              ...
              bmhv.a("should_request_aladdin_config", Boolean.valueOf(TextUtils.equals("1", localIllegalArgumentException)));
            }
          }
        }
      }
    ...
    for (;;)
    {
      for (;;)
      {
        for (;;)
        {
          for (;;)
          {
            for (;;)
            {
              for (;;)
              {
                for (;;)
                {
                  for (;;)
                  {
                    for (;;)
                    {
                      try
                      {
                        ...
                        bool = true;
                        bmhv.a("sp_key_create_topic_switch", Boolean.valueOf(bool));
                      }
                      ...
                      {
                        bmhv.a("readinjoy_coin_item_jump_url", localIllegalArgumentException);
                        if (!QLog.isColorLevel()) {
                          break;
                        }
                      ...
                      {
                        bmhv.a("readinjoy_coin_item_title", localIllegalArgumentException);
                        if (!QLog.isColorLevel()) {
                          break;
                        }
                    ...
                    {
                      bmhv.a("kandianreport_ON", Integer.valueOf(Integer.parseInt(localNumberFormatException2)));
                      break;
                    }
                  ...
                  {
                    bmhv.a("kandian_daily_fast_web_bottom_share", localException3);
                    break;
                  }
                  ...
                  try
                  {
                    bmhv.f(Integer.parseInt(localException3));
                  }
                ...
                try
                {
                  bmhv.g(Integer.parseInt(localException4));
                }
              ...
              try
              {
                bmhv.h(Integer.parseInt(localException5));
              }
            ...
            try
            {
              ...
              bmhv.a("readinjoy_video_ff_probesize", Long.valueOf(Long.parseLong(localException6)));
            }
          ...
          try
          {
            ...
            bmhv.a("readinjoy_video_is_ff_probelist_switch", Integer.valueOf(Integer.parseInt(localException7)));
          }
        ...
        try
        {
          ...
          bmhv.a("readinjoy_video_is_download_async_io", Integer.valueOf(Integer.parseInt(localException8)));
        }
      ...
      {
        bmhv.a("kandian_daily_wrapper_alpha", localException9);
        break;
      }
      if (TextUtils.equals((CharSequence)localObject2, "kandian_daily_wrapper_default_text"))
      {
        bmhv.a("kandian_daily_wrapper_default_text", localException9);
        break;
      }
      if (TextUtils.equals((CharSequence)localObject2, "kandian_daily_wrapper_drag_text"))
      {
        bmhv.a("kandian_daily_wrapper_drag_text", localException9);
        break;
      }
      ...
      bmhv.a("kandian_video_extract_frame", localException9);
      break;
      label6363:
