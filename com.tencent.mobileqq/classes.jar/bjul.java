  ...
  implements bjmq
{
  ...
  private String a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString)) {
      return bjtn.a(paramString, 200, 200, true);
    }
    return "";
  }
  ...
  private void a(String paramString, Bundle paramBundle, bjup parambjup)
  {
    Bundle localBundle;
    if ((paramBundle != null) && (parambjup != null))
    {
    ...
    try
    {
      parambjup.a(paramBundle, localBundle);
      if (paramString != null) {
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.callJs(paramString, new String[] { paramBundle.toString() });
      }
      return;
    }
    catch (Throwable parambjup)
    {
      for (;;)
      {
        QLog.e("QzoneRecommedPhotoJsPlugin", 1, "onCallJsBridge.setData error", parambjup);
      }
    }
  }
  ...
  private void a(String paramString1, String paramString2, Runnable paramRunnable, boolean paramBoolean)
  {
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bjux.class).post(paramRunnable);
      return;
    }
  ...
  private void b(String paramString)
  {
    try
    {
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getHandler(bjux.class).post(new QzoneRecommedPhotoJsPlugin.2(this));
      }
      return;
    }
  ...
  private void c(String paramString)
  {
    try
    {
      ...
      bizm.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), bizt.a(), localIntent, 0);
      return;
    }
    catch (Exception paramString)
    {
