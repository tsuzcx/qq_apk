...
public class adfd
  extends alrl
{
  private adfd(JoinDiscussionActivity paramJoinDiscussionActivity) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, RespGetDiscussInfo paramRespGetDiscussInfo)
  {
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        if (((Iterator)localObject3).hasNext())
        {
          ...
          for (;;)
          {
            ...
            {
              localObject2 = ((alto)this.a.app.getManager(51)).b(((DiscussionMemberInfo)localObject1).memberUin);
        ...
        while (paramInt < this.a.jdField_b_of_type_Int)
        {
          ...
          if (bdbk.a(this.a.app, 1, (String)localObject2) != null)
          {
      ...
      this.a.c = bdgc.a(this.a.app, this.a.d, String.valueOf(this.a.jdField_a_of_type_Long), l | 0x20000000, paramRespGetDiscussInfo.Name, localHashMap);
  ...
  protected void a(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      azqs.b(this.a.app, "CliOper", "", this.a.app.getCurrentAccountUin(), "discuss", "discuss_QR_join", 0, 0, "", "", "", "");
      this.a.stopTitleProgress();
    ...
    {
      if (paramInt != 0) {
        QQToast.a(this.a, alud.a(2131706267), 0).b(this.a.getTitleBarHeight());
      }
      Intent localIntent = aepi.a(new Intent(this.a, SplashActivity.class), null);
  ...
  protected void c(boolean paramBoolean, String paramString)
  {
    if (paramBoolean)
    {
      ...
      this.a.jdField_a_of_type_Alri.c(this.a.jdField_a_of_type_JavaLangString);
      return;
    }
    this.a.a(0, -161);
  }
