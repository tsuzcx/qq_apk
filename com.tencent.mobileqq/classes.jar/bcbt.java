  ...
  extends aber
{
  ...
  {
    paramFromServiceMsg = blsz.a(paramFromServiceMsg.getWupBuffer());
  ...
  {
    paramFromServiceMsg = blsa.a(paramFromServiceMsg.getWupBuffer());
    if (QLog.isColorLevel()) {
  ...
  private byte[] b(ToServiceMsg paramToServiceMsg)
  {
    ...
    return bguc.a(localUniPacket.encode());
  }
  
  private Object c(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    paramFromServiceMsg = blry.a(paramFromServiceMsg.getWupBuffer());
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          ...
          l3 = l1;
          return new blsz(l3, l2, localInteger.intValue()).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          l2 = Long.parseLong(paramToServiceMsg.getUin());
          l3 = l1;
          return new blry(l3, l2, str1, localLong).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          l2 = Long.parseLong(paramToServiceMsg.getUin());
          l3 = l1;
          return new blsa(l3, l2, str1).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
