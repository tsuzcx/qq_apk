  ...
  extends VideoLayerUIBase
{
  ...
  public loz(VideoAppInterface paramVideoAppInterface, Context paramContext, View paramView, lpa paramlpa)
  {
    super(paramVideoAppInterface, paramContext, paramView);
    this.jdField_a_of_type_Lpa = paramlpa;
    this.t = 2;
    this.jdField_a_of_type_Lyf = lyf.a(paramContext, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvVideoController.a().K, true);
    n();
    m();
    l();
    r();
  ...
  private void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      this.jdField_a_of_type_ArrayOfLtl[0].a(Boolean.valueOf(true));
      this.jdField_a_of_type_ArrayOfLtl[1].a(Boolean.valueOf(true));
      this.jdField_a_of_type_ArrayOfLtl[2].a(Boolean.valueOf(true));
      this.jdField_a_of_type_ArrayOfLtl[3].a(Boolean.valueOf(true));
      this.jdField_a_of_type_ArrayOfLtl[4].a(Boolean.valueOf(true));
      if ((!this.jdField_a_of_type_ArrayOfLtl[0].f()) || ((this.u != 0) && (this.u != 180)) || (this.jdField_a_of_type_ArrayOfLtl[0].k())) {
        break label208;
      }
      if (this.u != 0) {
        break label181;
      }
      this.jdField_a_of_type_ArrayOfLtl[0].a(0, 0, 0, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131166520));
    }
    for (;;)
    {
      this.jdField_a_of_type_Lyf.a(this.jdField_a_of_type_ComTencentAvVideoController.a(), this.jdField_a_of_type_ArrayOfLtl, paramInt1, paramInt2, paramBoolean, this.u, this.o);
      return;
      label181:
      this.jdField_a_of_type_ArrayOfLtl[0].a(0, this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131166520), 0, 0);
      continue;
      label208:
      this.jdField_a_of_type_ArrayOfLtl[0].a(paramInt3, paramInt3, paramInt3, paramInt3);
    }
  }
  ...
  private int i()
  {
    int j = 0;
    int m;
    for (int k = 0; j < this.jdField_a_of_type_ArrayOfLtl.length; k = m)
    {
      ltl localltl = this.jdField_a_of_type_ArrayOfLtl[j];
      String str = (String)localltl.a(0);
      m = k;
      if (localltl.a() == 0)
      {
        m = k;
  ...
  private void i(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      m = this.jdField_a_of_type_ArrayOfLtl[0].f();
      float f2 = this.jdField_a_of_type_ArrayOfLtl[0].d();
      n = this.jdField_a_of_type_ArrayOfLtl[0].g();
      boolean bool2 = this.jdField_a_of_type_ArrayOfLtl[0].i();
      ...
      if (i1 == 4)
      {
        localObject1 = this.jdField_a_of_type_ArrayOfLtl[0].a();
        k = m;
        f1 = f2;
        j = n;
        bool1 = bool2;
    ...
    int m = paramInt;
    while (m < this.jdField_a_of_type_ArrayOfLtl.length) {
      if ((m < this.jdField_a_of_type_ArrayOfLtl.length - 1) && (this.jdField_a_of_type_ArrayOfLtl[(m + 1)].a() == 0))
      {
        n = this.jdField_a_of_type_ArrayOfLtl[m].d();
        int i2 = this.jdField_a_of_type_ArrayOfLtl[(m + 1)].d();
        this.jdField_a_of_type_ArrayOfLtl[m].c(i2);
        this.jdField_a_of_type_ArrayOfLtl[(m + 1)].c(n);
        localObject2 = this.jdField_a_of_type_ArrayOfLtl[m];
        this.jdField_a_of_type_ArrayOfLtl[m] = this.jdField_a_of_type_ArrayOfLtl[(m + 1)];
        this.jdField_a_of_type_ArrayOfLtl[(m + 1)] = localObject2;
        m += 1;
      }
      else
      {
        ...
        u_();
        ((ltl)localObject2).b(null);
        ((ltl)localObject2).m(true);
        ((ltl)localObject2).k(false);
        ((ltl)localObject2).g(false);
        ((ltl)localObject2).l(true);
        ((ltl)localObject2).a(null, 0);
        ((ltl)localObject2).a("");
      }
    }
    u();
    if (paramInt == 0)
    {
      ...
      this.jdField_a_of_type_ArrayOfLtl[0].k(k);
      this.jdField_a_of_type_ArrayOfLtl[0].a(f1);
      this.jdField_a_of_type_ArrayOfLtl[0].j(j);
      this.jdField_a_of_type_ArrayOfLtl[0].j(bool1);
      if (i1 == 4) {
        this.jdField_a_of_type_ArrayOfLtl[0].a((ImageView.ScaleType)localObject1);
      }
    }
    c(false);
  }
  ...
  private int j()
  {
    ...
    int j = 0;
    while (j < this.jdField_a_of_type_ArrayOfLtl.length)
    {
      ltl localltl = this.jdField_a_of_type_ArrayOfLtl[j];
      String str2 = (String)localltl.a(0);
      if ((localltl.a() == 0) && (!TextUtils.isEmpty(str2)) && (!str2.equals(str1))) {
        return j;
      }
      j += 1;
    }
  ...
  private void t()
  {
    if (this.jdField_a_of_type_ArrayOfLtl != null)
    {
      ...
      while (j < this.jdField_a_of_type_ArrayOfLtl.length)
      {
        this.jdField_a_of_type_ArrayOfLtl[j].c(-1);
        j += 1;
      }
    }
  }
  ...
  private void u()
  {
    if (this.jdField_a_of_type_ArrayOfLtl[0].a() == 0)
    {
      String str1 = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin();
      String str2 = (String)this.jdField_a_of_type_ArrayOfLtl[0].a(0);
  ...
  void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController.a().d == 4) {
      ...
      else
      {
        ...
        {
          this.jdField_a_of_type_ArrayOfLtl[paramInt1].j(false);
          paramInt1 += 1;
        }
      }
    }
  ...
  void a(String paramString, int paramInt, Bitmap paramBitmap, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (k < 0)
    {
      ...
      if (k >= 0)
      {
        localltl = this.jdField_a_of_type_ArrayOfLtl[k];
        localltl.a(0);
        u_();
        u();
        localltl.a(0, paramString);
        localltl.a(1, Integer.valueOf(paramInt));
        localltl.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin());
        String str = VideoLayerUI.a(paramString, paramInt);
        a(str, null);
        a(str, localltl.a());
        long l = AudioHelper.b();
        QLog.w("SmallScreenVideoLayerUI", 1, "setGlRender[setBackground], key[" + str + "], index[" + k + "], seq[" + l + "], " + localltl.c());
        boolean bool1 = bool2;
        if (paramString != null)
        {
          bool1 = bool2;
    ...
    if (j >= 0)
    {
      localltl = this.jdField_a_of_type_ArrayOfLtl[j];
  ...
  void a(String paramString1, int paramInt1, String paramString2, float paramFloat, int paramInt2)
  {
    ...
    if (j >= 0)
    {
      paramString1 = this.jdField_a_of_type_ArrayOfLtl[j];
      paramString1.a(0);
      u_();
      u();
  ...
  void a(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    label130:
    while (lie.a(this.jdField_a_of_type_AndroidContentContext) == 1) {
      return;
    }
    ...
    if (paramBoolean1)
    {
      ...
      if (j < 0)
      {
        ...
        localObject = this.jdField_a_of_type_ArrayOfLtl[j];
        ((ltl)localObject).a(paramString, paramInt);
        ((ltl)localObject).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin());
      }
    }
    for (;;)
    {
      try
      {
        a(str, ((ltl)localObject).a());
        QLog.w("SmallScreenVideoLayerUI", 1, "setGlRender[RemoteHasVideo_1], key[" + str + "], index[" + j + "], " + ((ltl)localObject).c());
        ...
        if (paramString != null)
        {
          ...
          paramString.a(l, this.jdField_a_of_type_Lyf.b());
          paramString.k(true);
          paramString.a(0);
          u_();
          if (this.jdField_a_of_type_ComTencentAvVideoController.a().d != 4) {
      ...
      paramString = this.jdField_a_of_type_ArrayOfLtl[j];
      a(str, paramString.a());
  ...
  public void a(Observable paramObservable, Object paramObject)
  {
    ...
    case 6005: 
      ...
      {
        return;
      } while (((lsa)lru.a(paramObservable)).a != 2);
      return;
    }
    o();
  ...
  boolean a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (lie.a(this.jdField_a_of_type_AndroidContentContext) == 1) {
      return false;
    }
    int j;
    String str1;
    ...
    if (paramBoolean1)
    {
      ...
      if (j < 0)
      {
        ...
        if (k >= 0)
        {
          localObject3 = this.jdField_a_of_type_ArrayOfLtl[k];
          ((ltl)localObject3).a(0, str2);
          ((ltl)localObject3).a(1, Integer.valueOf(1));
          ((ltl)localObject3).a(str2);
        }
        try
        {
          GraphicRenderMgr.getInstance().setAccountUin(str2);
          a(str1, ((ltl)localObject3).a());
        ...
        QLog.w("SmallScreenVideoLayerUI", 1, "setGlRender[LocalHasVideo_1], key[" + str1 + "], index[" + k + "], log[" + localObject1 + "], " + ((ltl)localObject3).c());
    ...
    for (;;)
    {
      ...
      return true;
      localObject3 = this.jdField_a_of_type_ArrayOfLtl[j];
      a(str1, ((ltl)localObject3).a());
      QLog.w("SmallScreenVideoLayerUI", 1, "setGlRender[LocalHasVideo_2], key[" + str1 + "], index[" + j + "], " + ((ltl)localObject3).c());
      this.jdField_a_of_type_ComTencentAvVideoController.a(l, this.jdField_a_of_type_ComTencentAvVideoController.a().d, false, false);
      label567:
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.w("SmallScreenVideoLayerUI", 1, "layoutVideoView, virtical[" + paramBoolean + "], sessionType[" + localkvq.d + "], width[" + j + "], height[" + k + "]");
    }
    this.jdField_a_of_type_ArrayOfLtl[0].a(0, 0, 0, 0);
    this.jdField_a_of_type_ArrayOfLtl[0].b(0, 0, j, k);
    ...
    if (a(localkvq))
    {
      ...
      {
        paramBoolean = bool;
        locallyf.a(arrayOfltl, j, k, m, n, i1, paramBoolean);
        kyy.b(k, j);
      }
    }
    for (;;)
  ...
  {
    super.g(paramInt);
    if (this.jdField_a_of_type_Lyf.a() != paramInt)
    {
      this.jdField_a_of_type_Lyf = lyf.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramInt, true);
      c(true);
      paramInt = 0;
      while (paramInt < this.jdField_a_of_type_ArrayOfLtl.length)
      {
        this.jdField_a_of_type_ArrayOfLtl[paramInt].e(this.jdField_a_of_type_Lyf.b());
        a(-1049L, this.jdField_a_of_type_ArrayOfLtl[paramInt]);
        paramInt += 1;
      }
    }
  }
  ...
  {
    this.jdField_a_of_type_Lyf.a(this.jdField_a_of_type_ArrayOfLtl, b(), c(), paramInt, this.n, this.o);
  }
  ...
  public void n()
  {
    ...
    while (j < this.jdField_a_of_type_ArrayOfLtl.length)
    {
      this.jdField_a_of_type_ArrayOfLtl[j].n(true);
      j += 1;
    }
  }
  ...
  void u_()
  {
    ...
    if (this.i != j)
    {
      ...
      if (this.jdField_a_of_type_Lpa != null) {
        this.jdField_a_of_type_Lpa.a(this.i);
      }
    }
  }
}
