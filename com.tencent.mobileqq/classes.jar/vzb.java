  ...
  implements View.OnTouchListener
{
  ...
  public static final int[] c = { 2130843834, 2130843837 };
  public static final int[] d = { 2131377153, 2131377154 };
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 2131363603, 2131363604 };
    jdField_b_of_type_ArrayOfInt = new int[] { 2130843833, 2130843836 };
  }
  
  public vzb(vze paramvze, View paramView, int paramInt)
  {
  ...
  public void a(CharSequence paramCharSequence)
  {
    ...
    for (CharSequence localCharSequence = this.jdField_a_of_type_AndroidWidgetTextView.getHint();; localCharSequence = paramCharSequence)
    {
      ...
      if (this.jdField_b_of_type_AndroidWidgetTextView.getVisibility() == 0)
      {
        ...
        k = vzo.a(this.jdField_a_of_type_AndroidWidgetTextView.getContext(), 72.5F);
      ...
      for (;;)
      {
        ...
        break;
        label201:
        k = vzo.a(this.jdField_a_of_type_AndroidWidgetTextView.getContext(), 84.0F);
      ...
      if ((n <= k) || (i == arrayOfFloat1.length - 1))
      {
        ...
        veg.a("Q.qqstory.widget.PollWidgetUtils", "text size = %s", Float.valueOf(arrayOfFloat1[i]));
      }
      for (;;)
      {
        paramCharSequence = vyt.a(this.jdField_a_of_type_AndroidWidgetTextView, 2);
        this.jdField_a_of_type_AndroidWidgetTextView.setText(paramCharSequence);
  ...
  public void a(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130843781);
      return;
    }
  ...
  {
    if ((a()) || (this.jdField_a_of_type_Vyy == null) || (!this.jdField_a_of_type_Vze.a())) {
