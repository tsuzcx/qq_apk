...
public class lpb
{
  ...
  public boolean a(lao paramlao)
  {
    try
    {
      this.jdField_a_of_type_Int = paramlao.a(jdField_a_of_type_JavaLangString, 0);
      this.jdField_b_of_type_Int = paramlao.a(jdField_b_of_type_JavaLangString, 0);
      this.jdField_c_of_type_Int = paramlao.a(jdField_c_of_type_JavaLangString, -1);
      this.jdField_d_of_type_Int = paramlao.a(jdField_d_of_type_JavaLangString, 0);
      this.jdField_e_of_type_Int = paramlao.a(jdField_e_of_type_JavaLangString, 0);
      if (QLog.isColorLevel()) {
