  ...
  implements anui
{
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString)
  {
    ...
    label58:
    label68:
    for (String str = anzj.a(2131709841);; str = anzj.a(2131709839))
    {
      bjuh.a().a(paramString + str + anzj.a(2131709842));
      return;
      paramString = anzj.a(2131709840);
      break;
    }
  }
              ...
              do
              {
                do
                {
                  ...
                  if (localObject2 != null)
                  {
                    ...
                    localObject1 = ((wtt)localObject3).b(((UserInfo)localObject2).uid);
                  ...
                  for (paramInt = i;; paramInt = 0)
                  {
                    ...
                    ((wtt)localObject3).a(paramObject);
                  ...
                  if (paramBoolean)
                  {
                    Bosses.get().postJob(new wje(this, "QQStoryObserver", paramObject, (Boolean)localObject1, paramBoolean, paramInt));
                    return;
                  }
                  localObject1 = ((wtt)wth.a(2)).b(paramObject);
                  if (localObject1 != null)
                  {
