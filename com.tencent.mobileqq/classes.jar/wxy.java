  ...
  implements wxw
{
  ...
  wyw jdField_a_of_type_Wyw = null;
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            this.jdField_a_of_type_Wxu.b(paramString, (String)localObject);
            return;
          }
        }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("anonymousNickChanged".equals(paramString3)) {
      try
      {
        ...
        this.jdField_a_of_type_Wxu.a(paramString1, l, i, paramString2, j, paramString3, this);
        return true;
      }
    ...
    for (;;)
    {
      ...
      if ("cleanDynamicRedPoint".equals(paramString3)) {
        try
        {
          ...
          this.jdField_a_of_type_Wxu.c(paramJsBridgeListener, this);
          return true;
        }
        catch (JSONException paramJsBridgeListener)
        {
      ...
      else if ("getTroopBarPublishInfo".equals(paramString3))
      {
        try
        {
          ...
          this.jdField_a_of_type_Wxu.a(new wxz(this, paramJsBridgeListener));
        }
        catch (JSONException paramJsBridgeListener)
        {
          paramJsBridgeListener.printStackTrace();
      ...
      else
      {
        if (("createVideoAndSend".equals(paramString3)) || ("prepareVideoResources".equals(paramString3))) {
          try
          {
            ...
            if (this.jdField_a_of_type_Wyw == null) {
              this.jdField_a_of_type_Wyw = new wyw((BaseActivity)this.mRuntime.a());
            }
            localObject2 = this.jdField_a_of_type_Wyw;
            localObject2.getClass();
            localObject2 = new wzg((wyw)localObject2);
            ((wzg)localObject2).jdField_a_of_type_JavaLangString = paramString1;
            ((wzg)localObject2).b = ((String)localObject1);
            ((wzg)localObject2).c = paramString2;
            ((wzg)localObject2).jdField_a_of_type_Int = i;
            i = 0;
            while (i < paramVarArgs.length())
            {
              paramString1 = paramVarArgs.getString(i);
              ((wzg)localObject2).jdField_a_of_type_JavaUtilArrayList.add(paramString1);
              i += 1;
            }
            if ("createVideoAndSend".equals(paramString3)) {
              this.jdField_a_of_type_Wyw.a((wzg)localObject2, new wya(this, paramJsBridgeListener));
            } else {
              this.jdField_a_of_type_Wyw.a((wzg)localObject2, new wyb(this, paramJsBridgeListener));
            }
          }
        ...
        else if (("enableShortVideoPublish".equals(paramString3)) && (paramVarArgs.length == 1))
        {
          try
          {
            ...
            paramJsBridgeListener.put("enableShortVideoPublish", avtc.a());
            if (QLog.isColorLevel()) {
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Wyw = null;
  }
}
