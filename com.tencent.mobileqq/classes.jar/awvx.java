...
public class awvx
{
  ...
  {
    Object localObject = (anaw)ampl.a().a(456);
    if (localObject != null) {
      switch (paramInt)
      {
      }
    }
    for (localObject = null;; localObject = ((anaw)localObject).a())
    {
  ...
  public static String a(String paramString)
  {
    ...
    return localBaseApplicationImpl.getSharedPreferences("SearchConfigUtils_Switch" + localBaseApplicationImpl.getRuntime().getAccount(), 4).getString(paramString + str, ajya.a(2131713631));
  }
  ...
  {
    anap localanap = (anap)ampl.a().a(433);
    if (localanap != null) {}
    boolean bool;
    switch (paramInt)
    {
  ...
  {
    anan localanan = (anan)ampl.a().a(434);
    if (localanan != null) {}
    boolean bool;
    switch (paramInt)
    {
  ...
  {
    anaw localanaw = (anaw)ampl.a().a(456);
    if (localanaw != null) {
      switch (paramInt)
      {
      }
    }
    for (boolean bool = false;; bool = localanaw.a())
    {
      if (QLog.isColorLevel()) {
