  ...
  extends Observable
{
  ...
  public beaw(QQAppInterface paramQQAppInterface, Long paramLong)
  {
    this.jdField_a_of_type_JavaUtilList = Collections.synchronizedList(new ArrayList());
    this.jdField_a_of_type_AndroidOsHandler = new beax(this, Looper.getMainLooper());
    this.jdField_a_of_type_Bezd = new beay(this);
    this.jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaLangLong = paramLong;
  }
  
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, int paramInt, bezd parambezd)
  {
    ...
    try
    {
      ...
      if (paramQQAppInterface != null)
      {
        ...
        new bezc(paramQQAppInterface, "GET", parambezd, paramInt, null, true).execute(new HashMap[] { localObject2 });
    ...
    for (;;)
    {
      ...
      else
      {
        try
        {
          ...
          {
            localTroopFeedItem.tag = amtj.a(2131714328);
            ...
            localObject = new ByteArrayInputStream(bciq.a(localTroopNotificationCache.xmlBytes, i));
            localbeaz = new beaz(this);
            SAXParserFactory.newInstance().newSAXParser().parse((InputStream)localObject, localbeaz);
            ((InputStream)localObject).close();
            if (localTroopNotificationCache.serviceID == 20)
            {
              localTroopFeedItem.title = localbeaz.jdField_a_of_type_JavaLangString;
              localTroopFeedItem.content = "";
              localTroopFeedItem.picPath = localbeaz.jdField_b_of_type_JavaLangString;
              localTroopFeedItem.linkUrl = localbeaz.jdField_d_of_type_JavaLangString;
          ...
          for (;;)
          {
            localTroopFeedItem.tag = amtj.a(2131714329);
            localTroopFeedItem.type = 133;
            break;
            localTroopFeedItem.title = localTroopNotificationCache.title;
            localTroopFeedItem.content = localbeaz.jdField_c_of_type_JavaLangString;
            break label282;
            i = 0;
            break;
            i = 0;
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      new bezc("https://web.qun.qq.com/cgi-bin/announce/get_feed", "GET", this.jdField_a_of_type_Bezd, paramInt, null, true).execute(new HashMap[] { localObject1 });
  ...
  public void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
    ((HashMap)localObject1).put("CONTEXT", MobileQQ.getContext());
    new bezc("https://web.qun.qq.com/cgi-bin/announce/get_t_list", "GET", this.jdField_a_of_type_Bezd, paramInt, null, true).execute(new HashMap[] { localObject1 });
    if (QLog.isColorLevel()) {
