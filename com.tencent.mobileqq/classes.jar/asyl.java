...
public class asyl
{
  ...
  {
    Object localObject5 = bbcz.m(paramQQAppInterface, paramString1);
    ...
    if (QLog.isColorLevel()) {
      QLog.d("FriendReactive", 2, "addHotFriendAIOGrayTips type=" + paramInt1 + "level=" + paramInt2 + "flag=" + paramInt3 + "IsDisableInteractive=" + localajxl.q + "prelevel=" + paramInt4);
    }
    Object localObject2;
    label251:
    int k;
      ...
      case 1: 
        for (;;)
        {
          ...
          default: 
            ...
            localObject2 = new amzn();
            if (!bool) {
              break label4818;
            }
            bool = ((amzn)localObject2).jdField_a_of_type_Boolean;
            if (!bool) {
              break label4815;
            }
            paramString2 = paramString2 + ((amzn)localObject2).jdField_a_of_type_JavaLangString;
            ...
            localObject4 = asyj.a(paramQQAppInterface, (String)localObject4, (String)localObject5, localajxl);
            localObject6 = asyj.a(paramQQAppInterface, (String)((List)localObject4).get(0), paramString1);
            paramString2 = (String)((List)localObject6).get(0);
            ((List)localObject4).remove(0);
            ((List)localObject6).remove(0);
            if ((k != 0) && (!aiiz.a(paramString1, paramQQAppInterface))) {
              ((bbrd)paramQQAppInterface.a(71)).b(paramString1, k);
            }
            if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (n != 0)) {
              ((bbrd)paramQQAppInterface.a(71)).b(paramString1, n, (String)asyj.a(paramQQAppInterface, (String)asyj.a(paramQQAppInterface, (String)localObject1, (String)localObject5, localajxl).get(0), paramString1).get(0));
            }
            if (paramInt3 != 1) {
              break label3738;
            }
            paramInt5 = 2097153;
            localObject1 = new aqvb(paramString1, paramString1, paramString2, 0, -5040, paramInt5, awzy.a());
            ...
            while (paramInt5 < ((List)localObject6).size())
            {
              ...
              if (!TextUtils.isEmpty(str))
              {
                ...
                if (k >= 0) {
                  ((aqvb)localObject1).a(k, str.length() + k, (Bundle)localObject5);
                }
                if (QLog.isColorLevel()) {
        ...
        if (TextUtils.isEmpty(paramString2)) {
          localObject1 = asyj.a(paramQQAppInterface.getApp(), 65);
        }
        break;
      }
    }
    for (;;)
    {
      ...
      break label1008;
      if (TextUtils.isEmpty(paramString2)) {
        localObject1 = asyj.a(paramQQAppInterface.getApp(), 68);
      }
      k = 10;
      j = 38;
      localObject2 = localObject1;
      ...
      case 1: 
        if (TextUtils.isEmpty(paramString2)) {
          localObject1 = asyj.a(paramQQAppInterface.getApp(), 71);
        }
      case 2: 
        label4874:
        for (;;)
        {
          ...
          break label1204;
          if (TextUtils.isEmpty(paramString2)) {
            localObject1 = asyj.a(paramQQAppInterface.getApp(), 72);
          }
          k = 10;
          j = 40;
          localObject2 = localObject1;
          ...
          case 0: 
            if (paramInt4 == 1)
            {
              ...
              localObject1 = asyj.a(paramQQAppInterface.getApp(), 69);
            }
            label3738:
            label4895:
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                {
                  if (TextUtils.isEmpty(paramString2)) {
                    localObject1 = asyj.a(paramQQAppInterface.getApp(), 70);
                  }
                  i = 10;
                  localObject2 = localObject1;
                }
              ...
              localObject2 = localObject1;
              break;
              paramInt4 = localajxl.e;
              paramInt4 = localajxl.f;
              if (paramInt2 == 1)
              {
                if (paramInt3 == 1)
                {
                  paramString2 = asyj.a(paramQQAppInterface.getApp(), 21);
                  paramInt4 = 0;
                  i = 5;
                  j = 1;
                  localObject1 = "";
                ...
                paramString2 = asyj.a(paramQQAppInterface.getApp(), 24);
                paramInt4 = 0;
                i1 = 8;
                j = i;
                localObject1 = "";
              ...
              if (paramInt2 == 2)
              {
                paramString2 = asyj.a(paramQQAppInterface.getApp(), 42);
                paramInt4 = 0;
                i = 6;
                j = 2;
                localObject1 = "";
              ...
              paramString2 = asyj.a(paramQQAppInterface.getApp(), 27);
              paramInt4 = 0;
              i1 = 7;
              j = i;
              localObject1 = "";
              ...
              i = i1;
              break label323;
              paramInt4 = localajxl.jdField_a_of_type_Int;
              paramInt4 = localajxl.b;
              if (paramInt2 == 1)
              {
                if (paramInt3 == 1)
                {
                  paramString2 = asyj.a(paramQQAppInterface.getApp(), 20);
                ...
                paramString2 = asyj.a(paramQQAppInterface.getApp(), 23);
                paramInt4 = VipUtils.a(paramQQAppInterface, paramString1, 0);
                if (paramInt4 == 2) {
                  paramInt4 = 29;
                }
              ...
              if (paramInt2 == 2)
              {
                paramString2 = asyj.a(paramQQAppInterface.getApp(), 41);
                paramInt4 = VipUtils.a(paramQQAppInterface, paramString1, 0);
                if (paramInt4 == 2) {
                  paramInt4 = 29;
                }
              ...
              paramString2 = asyj.a(paramQQAppInterface.getApp(), 26);
              paramInt4 = 0;
              i1 = 3;
              j = i;
              localObject1 = "";
              ...
              if (paramInt2 == 1)
              {
                if (paramInt3 == 1)
                {
                  paramString2 = asyj.a(paramQQAppInterface.getApp(), 22);
              ...
              if (paramInt2 == 2)
              {
                paramString2 = asyj.a(paramQQAppInterface.getApp(), 43);
                paramInt4 = VipUtils.a(paramQQAppInterface, paramString1, 1);
                if (paramInt4 == 2) {
                  paramInt4 = 33;
                }
              ...
              if (paramInt4 == 1)
              {
                paramString2 = asyj.a(paramQQAppInterface.getApp(), 28);
                paramInt4 = 0;
                i1 = 11;
                j = i;
                localObject1 = "";
              ...
              paramString2 = asyj.a(paramQQAppInterface.getApp(), 25);
              paramInt4 = 0;
              i1 = 12;
              j = i;
              localObject1 = "";
              ...
              for (;;)
              {
                ...
                if (n > 0)
                {
                  axqy.b(paramQQAppInterface, "dc00898", "", "", "0X8009500", "0X8009500", n, 0, "", "", "", "");
                  ...
                  if (paramInt3 == 1)
                  {
                    if (paramInt2 == 1)
                    {
                      localObject1 = asyj.a(paramQQAppInterface.getApp(), 78);
                      paramInt4 = VipUtils.a(paramQQAppInterface, paramString1, 1);
                      if (paramInt4 == 2) {
                        paramInt4 = 31;
                      }
                    ...
                    if (paramInt2 == 2)
                    {
                      if (paramInt4 == 0)
                      {
                        localObject1 = asyj.a(paramQQAppInterface.getApp(), 80);
                        paramInt4 = 0;
                        paramString2 = "";
                        i = 0;
                        j = 2097153;
                      ...
                      if (paramInt4 == 1)
                      {
                        localObject1 = asyj.a(paramQQAppInterface.getApp(), 79);
                        paramInt4 = 0;
                        paramString2 = "";
                        i = 0;
                        j = 2097153;
                  ...
                  else if (paramInt3 == 2)
                  {
                    if (paramInt2 == 0)
                    {
                      if (paramInt4 == 1)
                      {
                        localObject1 = asyj.a(paramQQAppInterface.getApp(), 81);
                        paramInt4 = 0;
                        paramString2 = "";
                        i = 0;
                        j = 2097153;
                      ...
                      if (paramInt4 == 2)
                      {
                        localObject1 = asyj.a(paramQQAppInterface.getApp(), 83);
                        paramInt4 = 0;
                        paramString2 = "";
                        i = 0;
                        j = 2097153;
                    ...
                    {
                      localObject1 = asyj.a(paramQQAppInterface.getApp(), 82);
                      paramInt4 = 0;
                      paramString2 = "";
                      i = 0;
                      j = 2097153;
              ...
              for (i = 1;; i = 0)
              {
                if (paramInt2 == 0)
                {
                  paramString2 = asyj.a(paramQQAppInterface.getApp(), 84);
                  paramInt4 = 7;
                  label3315:
                  if (i == 0) {
                    break label4874;
                ...
                for (;;)
                {
                  ...
                  if (paramInt2 == 1)
                  {
                    paramString2 = asyj.a(paramQQAppInterface.getApp(), 85);
                    paramInt4 = 9;
                    break label3315;
                  }
                  paramString2 = "";
                  ...
                  if (paramInt3 == 4)
                  {
                    ...
                    paramString2 = asyj.a(paramQQAppInterface.getApp(), 86);
                    if (paramInt4 == 0) {
                      break label4859;
                    }
                    localObject1 = "";
                  ...
                  for (;;)
                  {
                    ...
                    if (paramInt3 == 5)
                    {
                      if (paramInt2 > 0)
                      {
                        if (paramInt2 == 2)
                        {
                          paramString2 = asyj.a(paramQQAppInterface.getApp(), 88);
                          paramInt4 = 11;
                        }
                        for (;;)
                        {
                          ...
                          if (paramInt2 == 1)
                          {
                            paramString2 = asyj.a(paramQQAppInterface.getApp(), 87);
                            paramInt4 = 10;
                          }
                          else
                          {
                    ...
                    else
                    {
                      if (paramInt3 == 6)
                      {
                        ...
                        localObject1 = asyj.a(paramQQAppInterface.getApp(), 88);
                        paramInt4 = 1;
                        paramString2 = "";
                        i = 0;
                        j = 2097155;
                    ...
                    if ((localObject4 != null) && (((List)localObject4).size() > 0))
                    {
                      ...
                      while (paramInt5 < ((List)localObject4).size())
                      {
                        ...
                        if (!TextUtils.isEmpty((CharSequence)localObject6))
                        {
                          ...
                          if (k >= 0) {
                            ((aqvb)localObject1).a(k, ((String)localObject6).length() + k, (Bundle)localObject5);
                          }
                          if (QLog.isColorLevel()) {
                    ...
                    for (;;)
                    {
                      ((Bundle)localObject4).putString("key_action_DATA", String.format(((amzn)localObject2).b, new Object[] { paramString1, Integer.valueOf(paramInt5) }));
                      paramInt2 = paramString2.length() - ((amzn)localObject2).jdField_a_of_type_JavaLangString.length();
                      if (paramInt2 >= 0)
                      {
                        ((aqvb)localObject1).a(paramInt2, paramString2.length(), (Bundle)localObject4);
                        axqy.b(paramQQAppInterface, "dc00898", "", "", "qq_vip", "0X8009CA5", paramInt5, 0, "", "", "", "");
                      }
                      ...
                      try
                      {
                        ...
                        if (paramInt2 >= 0) {
                          ((aqvb)localObject1).a(paramInt2, paramString2.length(), (Bundle)localObject2);
                        }
                      }
                      ...
                      while (((Iterator)localObject4).hasNext())
                      {
                        ...
                        if ((!TextUtils.isEmpty((CharSequence)localObject5)) && (!TextUtils.isEmpty(str)))
                        {
                          ...
                          if (paramInt2 >= 0) {
                            ((aqvb)localObject1).a(paramInt2, ((String)localObject5).length() + paramInt2, (Bundle)localObject6);
                          }
                          if (QLog.isColorLevel()) {
                    ...
                    do
                    {
                      ...
                      if (!TextUtils.isEmpty(paramString2))
                      {
                        ...
                        if (paramInt4 != 0) {
                          localajxl.f(paramString1);
                        }
                      }
                    } while (paramInt1 == 6);
                    axqy.b(paramQQAppInterface, "dc00898", "", "", "0X8007779", "0X8007779", i, 0, "", "", "", "");
                    return;
                    label4815:
                    break label393;
                    label4818:
  ...
  private static void a(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, long paramLong1, long paramLong2)
  {
    ...
    try
    {
      localObject2 = bbcz.m(paramQQAppInterface, paramString1);
    ...
    Object localObject2 = amrx.a().b("" + paramInt2);
    paramString2 = (String)localObject2;
    if (localObject2 == null) {
      paramString2 = new amrw().b("0");
    }
    ...
    for (;;)
    {
      localObject2 = new aqvb(paramString1, paramString1, (String)localObject1, 0, paramInt1, 655384, awzy.a());
      ...
      if (paramInt1 >= 0) {
        ((aqvb)localObject2).a(paramInt1, ((String)localObject1).length(), localBundle);
      }
      paramString2 = new MessageForUniteGrayTip();
      paramString2.hasRead = 0;
      paramString2.subType = 9;
      paramString2.initGrayTipMsg(paramQQAppInterface, (aqvb)localObject2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, submsgtype0xc7.HotFriendNotify paramHotFriendNotify, akqm paramakqm)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramHotFriendNotify != null)
    {
      ...
      str1 = bbcz.m(paramQQAppInterface, (String)localObject1);
      i = 1;
      if (paramHotFriendNotify.bytes_wildcard_wording.has())
      {
        localObject3 = asyj.a(paramQQAppInterface, paramHotFriendNotify.bytes_wildcard_wording.get().toStringUtf8(), str1, localajxl);
        localObject4 = asyj.a(paramQQAppInterface, (String)((List)localObject3).get(0), (String)localObject1);
        str1 = (String)((List)localObject4).get(0);
        ((List)localObject3).remove(0);
        ((List)localObject4).remove(0);
        localObject2 = new aqvb((String)localObject1, (String)localObject1, str1, 0, -5040, 2097153, awzy.a());
        if ((localObject4 != null) && (((List)localObject4).size() > 0))
        {
          i = 0;
        ...
        {
          Collections.sort((List)localObject3, new asym());
    ...
    for (;;)
    {
      ...
      for (int k = 1;; k = 0)
      {
        ...
        if (!paramHotFriendNotify.uint32_notify_type.has())
        {
          ...
          paramakqm = localajxl.a(String.valueOf(l2));
          if (paramakqm != null) {
            break label2382;
          }
          paramakqm = new ExtensionInfo();
          paramakqm.uin = String.valueOf(l2);
        }
        for (;;)
        {
          ...
          {
            j = i;
            if (paramakqm.lastGrayPushTime == l1)
            {
              j = i;
              if (l1 != -1L)
              {
          ...
          if (paramHotFriendNotify.uint32_chat_hot_level.has())
          {
            ...
            k = paramakqm.chatHotLevel;
            paramakqm.chatHotLevel = i;
          ...
          if (paramHotFriendNotify.uint32_key_trans_flag.has())
          {
            ...
            {
              bool2 = true;
              paramakqm.loverTransFlag = bool2;
              ((StringBuilder)localObject3).append(", loverTransFlag=").append(paramakqm.loverTransFlag);
            }
          }
          else
          {
            ...
            {
              i = paramakqm.newBestIntimacyType;
              k = paramHotFriendNotify.uint32_boat_level.get();
              paramakqm.newBestIntimacyType = k;
          ...
          for (;;)
          {
            ...
            if (paramHotFriendNotify.uint64_last_praise_time.has())
            {
              ...
              paramakqm.lastpraiseTime = (86400L * l1 - 28800L);
            ...
            if (paramHotFriendNotify.uint64_last_chat_time.has())
            {
              ...
              paramakqm.lastChatTime = (86400L * l1 - 28800L);
            ...
            if (paramHotFriendNotify.uint64_last_key_time.has())
            {
              ...
              paramakqm.loverLastChatTime = (86400L * l1 - 28800L);
            ...
            {
              i = paramakqm.bestIntimacyType;
              k = paramHotFriendNotify.uint32_close_level.get();
              paramakqm.bestIntimacyType = k;
          ...
          asyj.a(paramQQAppInterface, paramakqm, (submsgtype0xc7.FriendShipFlagNotify)paramHotFriendNotify.msg_friendship_flag_notify.get());
          return;
          if (!QLog.isColorLevel()) {
            break;
          }
