  ...
  implements asyj
{
  ...
  public void a(DownloaderTask paramDownloaderTask)
  {
    ...
    if (asyk.a(this.a) != null) {
      asyk.a(this.a).deleteTask(paramDownloaderTask, false);
    }
    if ((asyk.a(this.a) != null) && (asyk.a(this.a).containsKey(paramDownloaderTask.getUrl())) && (asyk.a(this.a).get(paramDownloaderTask.getUrl()) != null)) {
      ((asyi)asyk.a(this.a).get(paramDownloaderTask.getUrl())).a();
    }
    asyk.a(this.a, paramDownloaderTask.getUrl());
  }
  ...
  public void c(DownloaderTask paramDownloaderTask)
  {
    ...
    if ((asyk.a(this.a) != null) && (asyk.a(this.a).containsKey(paramDownloaderTask.getUrl())) && (asyk.a(this.a).get(paramDownloaderTask.getUrl()) != null)) {
      ((asyi)asyk.a(this.a).get(paramDownloaderTask.getUrl())).a(paramDownloaderTask.getFailCode(), paramDownloaderTask.getFailCode(), "failed");
    }
    asyk.a(this.a, paramDownloaderTask.getUrl());
  }
  ...
  public void f(DownloaderTask paramDownloaderTask)
  {
    ...
    if ((asyk.a(this.a) != null) && (asyk.a(this.a).containsKey(paramDownloaderTask.getUrl())) && (asyk.a(this.a).get(paramDownloaderTask.getUrl()) != null)) {
      ((asyi)asyk.a(this.a).get(paramDownloaderTask.getUrl())).a(paramDownloaderTask.getReceivedLength(), paramDownloaderTask.getTotalLength(), paramDownloaderTask.getPercentage());
    }
  }
}
