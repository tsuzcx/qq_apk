  ...
  implements atrb
{
  ...
  public adfa(NewAuthDevUgFragment paramNewAuthDevUgFragment)
  {
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString1 = pco.a();
        if ((!bdee.h(localNewAuthDevUgFragment.getActivity())) && (paramString1 != null)) {
        ...
        int i = apwu.a().a(NewAuthDevUgFragment.a(localNewAuthDevUgFragment).getAppInterface(), NewAuthDevUgFragment.a(localNewAuthDevUgFragment), paramString1);
        if (i != 0)
        {
