...
public class alvi
  ...
  implements alvq
{
  private static volatile alvi jdField_a_of_type_Alvi;
  public static boolean a;
  private List<alvk> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public static alvi a()
  {
    ...
    {
      if (jdField_a_of_type_Alvi == null) {
        jdField_a_of_type_Alvi = new alvi();
      }
      return jdField_a_of_type_Alvi;
    }
    finally {}
  }
  ...
  public static void a()
  {
    ...
    {
      QIPCClientHelper.getInstance().register(localalvi);
  ...
  public Bundle a(String paramString, Bundle paramBundle)
  {
    ...
    if ("qipc_action_get_barrage".equals(paramString))
    {
      ...
      localObject = alvg.a().a(l2, l1);
      localObject = alvg.a().a((String)localObject);
      if (localObject == null) {
        break label243;
      }
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (bool) {
        QLog.d("DanmuDataIPCClient", 2, new Object[] { "peak listSize:", Integer.valueOf(((alvh)localObject).d.size()), ", fullList:", ((alvh)localObject).d.toString() });
      }
      paramBundle.putBoolean("key_barrage_is_update", bool);
      paramBundle.putLong("key_barrage_req_time", System.currentTimeMillis());
      QIPCClientHelper.getInstance().getClient().callServer("DanmuDataIPCServer", "qipc_action_get_barrage", paramBundle, new alvj(this));
  ...
  {
    if ((paramalvk != null) && (!this.jdField_a_of_type_JavaUtilList.contains(paramalvk))) {
      this.jdField_a_of_type_JavaUtilList.add(paramalvk);
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if (paramBundle.containsKey("key_barrage_req_time"))
    {
      ...
      awrn.a(BaseApplication.getContext()).a(null, "DanmuPullCost", false, 0L, 0L, (HashMap)localObject1, null);
      if (QLog.isColorLevel()) {
    ...
    if ((localObject1 != null) && (!((ArrayList)localObject1).isEmpty()))
    {
      ...
      j = 1;
      localObject3 = alvg.a().a(l2, l1);
      paramBundle = alvg.a().a((String)localObject3);
      if (paramBundle != null) {
        break label649;
      }
      paramBundle = alvg.a().b((String)localObject3);
    }
    label516:
    label649:
    for (;;)
    {
      if ((bool) && ((i != 0) || (j != 0)))
      {
        ...
        localObject2 = new alvf(l2, l1, k, true);
        paramBundle.a((List)localObject1).b((List)localObject3).a((alvf)localObject2).a(null).a();
      }
      if ((bool) && (paramBundle != null) && (!paramBundle.d.isEmpty()))
      {
        localObject1 = this.jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject1).hasNext()) {
          ((alvk)((Iterator)localObject1).next()).a(l1, String.valueOf(l2), m, paramBundle.d);
        }
      }
      if (QLog.isColorLevel()) {
  ...
  public void b(alvk paramalvk)
  {
    if ((paramalvk != null) && (this.jdField_a_of_type_JavaUtilList.contains(paramalvk))) {
      this.jdField_a_of_type_JavaUtilList.remove(paramalvk);
    }
  }
    ...
    for (;;)
    {
      ...
      if ("qipc_action_send_barrage".equals(paramString))
      {
        ...
        while (localIterator.hasNext()) {
          ((alvk)localIterator.next()).a(l, paramBundle, paramString);
        }
      }
    }
  }
