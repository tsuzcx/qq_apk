  ...
  public leg b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = new leg(this);
        i = this.a.dequeueOutputBuffer(((leg)localObject1).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo, jdField_c_of_type_Int);
        switch (i)
        {
        case -3: 
          if (i < 0) {
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_e_of_type_JavaLangString, 2, "dequeueOutputBuffer ok,index = " + i + ",BufferInfo[flags = " + ((leg)localObject1).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.flags + ",offset=" + ((leg)localObject1).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.offset + ",size= " + ((leg)localObject1).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.size + ",TimeUs=" + ((leg)localObject1).jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.presentationTimeUs + "]");
          }
          if (Build.VERSION.SDK_INT > 20) {
            break label404;
          }
          ((leg)localObject1).jdField_a_of_type_JavaNioByteBuffer = this.jdField_b_of_type_ArrayOfJavaNioByteBuffer[i];
          ((leg)localObject1).jdField_a_of_type_Int = i;
          ((leg)localObject1).jdField_a_of_type_AndroidMediaMediaFormat = this.jdField_b_of_type_AndroidMediaMediaFormat;
          continue;
          if (QLog.isColorLevel()) {
          ...
          ((leg)localObject1).jdField_a_of_type_Int = -3;
        }
      }
      finally {}
      ((leg)localObject1).jdField_a_of_type_Int = -2;
