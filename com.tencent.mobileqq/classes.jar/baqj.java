  ...
  implements baqx
{
  ...
  public baqj(baqg parambaqg, WheelPickerLayout paramWheelPickerLayout)
  {
    ...
    if (i >= baqg.a(parambaqg))
    {
      paramWheelPickerLayout.add(5, 1);
      paramWheelPickerLayout.set(11, baqg.b(parambaqg));
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramWheelPickerLayout.add(12, baqg.c(parambaqg) - i % baqg.c(parambaqg));
      }
    }
  }
  ...
  private String b(int paramInt)
  {
    ...
    default: 
      return "";
    case 1: 
      return ajya.a(2131715707);
    case 2: 
      return ajya.a(2131715720);
    case 3: 
      return ajya.a(2131715711);
    case 4: 
      return ajya.a(2131715705);
    case 5: 
      return ajya.a(2131715703);
    case 6: 
      return ajya.a(2131715719);
    }
    return ajya.a(2131715721);
  }
  ...
  public int a(int paramInt)
  {
    ...
    default: 
      return 0;
    case 0: 
      return baqg.d(this.jdField_a_of_type_Baqg);
    case 1: 
      paramInt = a(new int[] { this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout.a(0) }).get(11);
      return baqg.a(this.jdField_a_of_type_Baqg) - paramInt + 1;
    }
    return (60 - a(new int[] { this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout.a(0), this.jdField_a_of_type_ComTencentMobileqqTroopWidgetWheelPickerLayout.a(1) }).get(12)) / baqg.c(this.jdField_a_of_type_Baqg);
  }
  ...
  public int a(Calendar paramCalendar, int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = (int)((paramCalendar.get(12) - l) / baqg.c(this.jdField_a_of_type_Baqg));
    if (paramInt1 > 0) {
      return paramInt1;
    }
    return 0;
  ...
  public Calendar a(int... paramVarArgs)
  {
    ...
    if (paramVarArgs[0] > 0)
    {
      ...
      localCalendar.set(11, baqg.b(this.jdField_a_of_type_Baqg));
    ...
    if (paramVarArgs.length > 2) {
      localCalendar.add(12, paramVarArgs[2] * baqg.c(this.jdField_a_of_type_Baqg));
    }
  ...
  public int[] a(long paramLong)
  {
    ...
    arrayOfInt[2] = ((localCalendar1.get(12) - localCalendar2.get(12)) / baqg.c(this.jdField_a_of_type_Baqg));
    return arrayOfInt;
  }
}
