  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      {
        return;
        localadcg = (adcg)paramView;
        paramView = adcg.a(localadcg);
        if (!TextUtils.isEmpty(paramView)) {
          break;
        }
        Log.i("AutoVideoItemBuilder", "onClick: empty schema");
        paramView = bade.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.a.jdField_a_of_type_AndroidContentContext, paramView);
        if (paramView != null) {
          paramView.c();
        }
      } while (!(localadcg.a instanceof MessageForStructing));
      paramView = (MessageForStructing)localadcg.a;
    ...
    if (paramView.getVideoItem() != null)
    {
      ...
      awqx.b(null, "dc00898", "", this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "auth_aio", "clk_content", 0, 0, "", "", this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d, paramView);
      return;
      if ((!paramView.contains("&width=")) && (!paramView.contains("?width=")))
      {
        ...
        paramView = paramView + "?width=" + localadcg.e + "&height=" + localadcg.f;
      }
    }
    label275:
    label308:
    ...
    for (;;)
    {
      ...
      {
        if (i != 0) {}
        for (Object localObject = paramView + "&width=" + localadcg.e;; localObject = paramView)
        {
          paramView = (View)localObject;
          if (j == 0) {
            break label275;
          }
          paramView = (String)localObject + "&height=" + localadcg.f;
          break label275;
