...
public class lga
{
  ...
  public lga(VideoAppInterface paramVideoAppInterface)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Long = mqg.a().n;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          str2 = locallid.e;
          i = locallid.E;
          j = locallid.jdField_d_of_type_Int;
          bool1 = locallid.M;
          bool2 = locallid.O;
          bool3 = locallid.g;
  ...
  public void a()
  {
    ...
    {
      lgb.a(true, System.currentTimeMillis() - this.jdField_b_of_type_Long);
      ...
      {
        localObject = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a();
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(((lid)localObject).jdField_i_of_type_Int, ((lid)localObject).jdField_d_of_type_JavaLangString, ((lid)localObject).f);
      }
    }
    a(true);
    d();
  ...
  public void a(int paramInt)
  {
    ...
    {
      this.d = false;
      lgb.a(paramInt, System.currentTimeMillis() - this.jdField_c_of_type_Long);
    }
    a(false);
    f();
  }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject3 = lfb.a(j, (String)localObject1, new int[0]);
        localObject3 = lfb.a().a((String)localObject3, false);
        ((lid)localObject3).jdField_i_of_type_Int = 0;
        ((lid)localObject3).jdField_d_of_type_JavaLangString = ((String)localObject1);
        ((lid)localObject3).e = ((String)localObject2);
        ((lid)localObject3).E = j;
        ((lid)localObject3).ah = true;
        ((lid)localObject3).jdField_i_of_type_Long = l2;
        ((lid)localObject3).a(l3, "recoverLastCallIfNeed", 1);
        ((lid)localObject3).R = true;
        ((lid)localObject3).M = bool1;
        ((lid)localObject3).g = bool3;
        ...
        if (mbt.f())
        {
          mbt.a(l3, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp(), false, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), false);
          localObject1 = ((VideoController)localObject2).a;
          if (localObject1 != null) {
            ((mwk)localObject1).a("DEVICE_SPEAKERPHONE;DEVICE_EARPHONE;DEVICE_BLUETOOTHHEADSET;DEVICE_WIREDHEADSET;");
          }
          this.jdField_c_of_type_Boolean = true;
          this.jdField_b_of_type_Long = System.currentTimeMillis();
          this.e = bool2;
          lgb.a(paramInt, paramLong, this.jdField_c_of_type_Boolean);
          return;
        }
      }
      catch (Throwable localThrowable)
      ...
      mbt.a(0L, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 2);
      continue;
      label588:
