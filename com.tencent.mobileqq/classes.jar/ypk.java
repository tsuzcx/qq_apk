...
public class ypk
{
  ...
  public static int a(String paramString, int paramInt)
  {
    ...
    {
      yny.d("GdtUIUtils", "getColor error", paramString);
    }
    return paramInt;
  }
  ...
  public static Drawable a(@ColorInt int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      localPaintDrawable.setShaderFactory(new ypl(f1, f3, f2, f4, arrayOfInt));
  ...
  public static void a(Activity paramActivity)
  {
    ...
    {
      a(paramActivity);
      yny.a("GdtMvViewController", "enableNotch && updateLiuhaiTopHeight 0");
    }
  }
  ...
  public static boolean a(Activity paramActivity)
  {
    ...
    yny.a("GdtMvViewController", "hasTopLiuHai  " + bjeh.a);
    return bjeh.a;
  }
  ...
  private static int b(Activity paramActivity)
  {
    ...
    if (i > 27) {
      return bjeh.a(paramActivity);
    }
    return bjeh.b(paramActivity);
  }
  ...
  public static int b(Context paramContext)
  {
    ...
    {
      yny.d("GdtUIUtils", "getScreenWidth error");
      return -2147483648;
    }
  ...
  public static int d(Context paramContext)
  {
    ...
    while ((paramContext.getResources() == null) || (paramContext.getResources().getDisplayMetrics() == null))
    {
      yny.d("GdtUIUtils", "getScreenHeight error");
      return -2147483648;
    }
