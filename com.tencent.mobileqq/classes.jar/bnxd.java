...
public class bnxd
{
  ...
  public static Drawable a(int paramInt1, int paramInt2, bnxh parambnxh)
  {
    if (a.containsKey(Integer.valueOf(paramInt1))) {
      return bnxe.a().a("https://qzonestyle.gtimg.cn/qzone/qzact/act/external/qzone_vip_icon/qzone_yellow_icon_v8.zip", paramInt2, (String)a.get(Integer.valueOf(paramInt1)), parambnxh);
    }
    switch (paramInt1)
    {
    default: 
    ...
    return BaseApplicationImpl.getContext().getResources().getDrawable(2130849318);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, bnxh parambnxh)
  {
    return a(paramString, paramInt1, paramInt2, paramInt3, parambnxh, 0);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, bnxh parambnxh, int paramInt4)
  {
    switch (paramInt4)
    {
    }
    ...
    {
      return null;
      bnxe.a().a(paramString, paramInt1, "border", parambnxh);
      continue;
      switch (paramInt3)
      {
      }
    }
    return bnxe.a().a(paramString, paramInt1, "head", parambnxh);
    return bnxe.a().a(paramString, paramInt1, "bottom_lv" + paramInt2, parambnxh);
    return bnxe.a().a(paramString, paramInt1, "right", parambnxh);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4, bnxh parambnxh)
  {
    String str = a(paramInt1, paramInt3, paramBoolean, paramInt4);
    if (!TextUtils.isEmpty(str)) {
      return bnxe.a().a(paramString, paramInt2, str, true, parambnxh);
    }
    return null;
  }
