  ...
  implements asvu
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new adnt(this);
  private WeakReference<ImageView> jdField_a_of_type_JavaLangRefWeakReference;
  private View.OnClickListener b = new adnu(this);
  
  public adns(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
  ...
  private void a(View paramView, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject6 = paramView.findViewById(2131368967);
        ...
        localObject2 = (ImageView)((View)localObject6).findViewById(2131368044);
        localObject3 = (ImageView)((View)localObject6).findViewById(2131368045);
        ((TextView)((View)localObject6).findViewById(2131378515)).setText((CharSequence)localObject4);
        ...
        ((ImageView)localObject3).setImageDrawable(baxt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, String.valueOf(l)));
        bool2 = axmt.b();
        if (!bool1) {
          break label947;
        }
      ...
      paramView = ((ViewStub)paramView.findViewById(2131379238)).inflate();
      paramString = (TextView)paramView.findViewById(2131378512);
      ...
      return;
      label377:
      localObject4 = baxt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
      Object localObject6 = baxt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, String.valueOf(l));
    ...
    break label882;
    label443:
    paramString.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166861));
    return;
    label460:
    Object localObject2 = ((ViewStub)paramView.findViewById(2131379236)).inflate();
    Object localObject3 = (URLImageView)((View)localObject2).findViewById(2131368046);
    Object localObject4 = (TextView)((View)localObject2).findViewById(2131378514);
    paramView = (TextView)((View)localObject2).findViewById(2131378513);
    ...
    if (TextUtils.isEmpty((CharSequence)localObject5))
    {
      ...
      ((GradientDrawable)localObject1).setColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165766));
      ...
      i = actn.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ...
    for (;;)
    {
      try
      {
        paramString = URLDrawable.getDrawable(aysr.a(paramString), (URLDrawable.URLDrawableOptions)localObject5);
        paramView = paramString;
        paramString.setTag(bavi.b(i, i, (int)f));
        paramView = paramString;
        ...
        if (j == 100)
        {
          paramView = (ImageView)((View)localObject2).findViewById(2131368049);
      ...
      break label1002;
      ((TextView)localObject4).setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166861));
      return;
      label882:
      do
      {
        ((TextView)((ViewStub)paramView.findViewById(2131379238)).inflate().findViewById(2131378512)).setText(ajyc.a(2131702212));
        return;
  ...
  protected View a(MessageRecord paramMessageRecord, actr paramactr, View paramView, LinearLayout paramLinearLayout, acxn paramacxn)
  {
    ...
    if (paramView == null)
    {
      paramactr = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560690, null);
      a(paramactr, paramMessageRecord.msg);
    }
