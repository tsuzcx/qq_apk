  ...
  implements Handler.Callback, INetEngine.IBreakDownFix, INetEngine.INetEngineListener, HttpEngineTask.IHttpEngineTask
{
  ...
  private HashMap<String, blwo> b;
  private HashMap<String, HttpEngineTask> c;
  
  public blwm(Context paramContext, QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(NetReq paramNetReq, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 > 0)
    {
      paramNetReq = (blwo)this.b.get(str);
      if (paramNetReq == null) {
        break label95;
      }
    }
    label95:
    for (paramNetReq = blwo.a(paramNetReq);; paramNetReq = null)
    {
      if (paramNetReq != null) {
  ...
  private void a(NetResp paramNetResp)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      blwo localblwo = (blwo)this.b.remove(str);
      if (localblwo != null)
      {
        if (blwo.a(localblwo) != null) {
          ((PreDownloadController)localObject).preDownloadSuccess(blwo.a(localblwo).mReqUrl, paramNetResp.mTotalFileLen);
        }
        localObject = blwo.a(localblwo);
        a(str, paramNetResp);
  ...
  private void a(String paramString, HttpNetReq paramHttpNetReq, blwp paramblwp, AbsPreDownloadTask paramAbsPreDownloadTask)
  {
    if (paramblwp != null) {
      paramblwp.c(paramString);
    }
    ...
    try
    {
      ...
      localObject = new blwo(null);
      blwo.a((blwo)localObject, paramHttpNetReq);
      blwo.a((blwo)localObject, paramblwp);
      blwo.a((blwo)localObject, paramAbsPreDownloadTask);
  ...
  private void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject = (blwo)this.b.remove(paramString);
        ...
        if ((localObject != null) || (localHttpEngineTask != null))
        {
          if (localObject != null)
          {
            if (blwo.a((blwo)localObject) != null) {
              this.jdField_a_of_type_ComTencentMobileqqTransfilePredownloadPreDownloadController.cancelPreDownload(blwo.a((blwo)localObject).mReqUrl);
            }
          }
          else
          {
            ...
            localObject = blwo.a((blwo)localObject);
            if (localObject != null) {
              ((blwp)localObject).d(paramString);
            }
            c(paramString);
          }
        }
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getNetEngine(0).cancelReq(blwo.a((blwo)localObject));
      continue;
      label185:
      Object localObject = (blwp)localHttpEngineTask.userData;
    }
  }
  ...
  public void a(PluginInfo paramPluginInfo, blwp paramblwp, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((float)(paramPluginInfo.mLength * 1.75D) > FileUtils.getAvailableInnernalMemorySize())
        {
          ...
          paramblwp.b(paramPluginInfo.mID);
          return;
        }
      }
      finally
    ...
    for (;;)
    {
      try
      {
        ...
        ((HttpEngineTask)localObject1).userData = paramblwp;
      ...
      a(paramPluginInfo.mID, (HttpNetReq)localObject2, paramblwp, null);
  ...
  public void onPreDownloadStart(HttpEngineTask paramHttpEngineTask)
  {
    ...
    a((String)paramHttpEngineTask.httpReq.getUserData(), paramHttpEngineTask.httpReq, (blwp)paramHttpEngineTask.userData, paramHttpEngineTask);
  }
