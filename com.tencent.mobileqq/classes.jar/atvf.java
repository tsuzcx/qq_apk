  ...
  extends atve
{
  ...
  public atvf(Reader paramReader, int paramInt)
  {
  ...
  public final atvc a()
  {
    ...
    for (;;)
    {
      ...
      return new atvc(new String(this.jdField_a_of_type_ArrayOfChar, 0, k), n, k + n, this.jdField_a_of_type_JavaLangString);
      label700:
      m = i1;
    }
  }
