...
public class ajdp
{
  ...
  public static RecentBaseData a(RecentUser paramRecentUser, QQAppInterface paramQQAppInterface, Context paramContext, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        {
          ajfw.a(paramQQAppInterface.getApp(), false, paramRecentUser);
      ...
      continue;
      if (TextUtils.equals(paramRecentUser.uin, aljq.az))
      {
        localObject1 = localObject3;
  ...
  public static void a(List<RecentUser> paramList, QQAppInterface paramQQAppInterface, Context paramContext, List<RecentBaseData> paramList1, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        bhxr.a(((RecentUser)localObject2).uin);
        String str = ajeu.a(((RecentUser)localObject2).uin, ((RecentUser)localObject2).getType());
        Object localObject1 = ajeu.a().a(str);
        if (localObject1 == null)
        {
        ...
        else
        {
          ...
          {
            ajfw.a(paramContext, false, paramList);
