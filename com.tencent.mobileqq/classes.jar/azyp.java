  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof RelativeLayout)))
    {
      ...
      if (paramContext != null)
      {
        ...
        paramBundle.rightMargin = aepi.a(7.5F, localResources);
        if (paramView.findViewById(1) == null) {
          break label873;
        }
        paramBundle.addRule(1, 1);
        paramContext.setPadding(aepi.a(7.5F, localResources), 0, 0, 0);
        label130:
    ...
    {
      a(paramView);
      paramView.setPadding(aepi.a(11.0F, localResources), 0, aepi.a(11.0F, localResources), 0);
      return paramView;
      label175:
      paramView = (azus)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      ...
      ((azzm)paramView).c("28");
      ((azzm)paramView).a(true);
      if (this.l != 0) {
        ((azzm)paramView).a(a(), this.l);
      }
      for (;;)
      {
        ...
        paramView.setLayoutParams((ViewGroup.LayoutParams)localObject);
        break;
        ((azzm)paramView).b("black");
      }
      localRelativeLayout = new RelativeLayout(paramContext);
      localRelativeLayout.setLayoutParams(new RelativeLayout.LayoutParams(-1, aepi.a(40.0F, localResources)));
      i = 0;
      paramView = localRelativeLayout;
      if (i >= j) {
        break label67;
      ...
      if ("picture".equals(localObject))
      {
        ...
        paramView.setId(1);
        localObject = new RelativeLayout.LayoutParams(aepi.a(40.0F, localResources), aepi.a(30.0F, localResources));
        ((RelativeLayout.LayoutParams)localObject).addRule(9, -1);
        ((RelativeLayout.LayoutParams)localObject).addRule(15, -1);
      ...
      for (;;)
      {
        ...
        int m = aepi.a(89.5F, localResources);
