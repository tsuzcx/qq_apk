  ...
  implements Handler.Callback, back
{
  ...
  private volatile WeakReference<azyr> jdField_b_of_type_MqqUtilWeakReference;
  ...
  public void a(Setting paramSetting)
  {
    ...
    for (;;)
    {
      ...
      paramSetting = "";
      break;
      localObject = azyk.b(paramSetting.uin);
      ...
      if (HttpDownloadUtil.a(a(), new anff(MsfSdkUtils.insertMtype("friendlist", paramSetting), localFile2, 0), this) == 0) {
        bool1 = true;
      }
      boolean bool2;
      if (bool1)
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (paramMessage = (Drawable)paramMessage.obj;; paramMessage = null)
    {
      ...
      {
        localazyr = (azyr)this.jdField_b_of_type_MqqUtilWeakReference.get();
        if (localazyr != null)
        {
      ...
      {
        localazyr.a(str, bool, paramMessage);
