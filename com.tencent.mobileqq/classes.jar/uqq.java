...
public final class uqq
  implements Runnable
{
  public uqq(QQAppInterface paramQQAppInterface, Context paramContext, ApolloFavActionData paramApolloFavActionData, SessionInfo paramSessionInfo) {}
  ...
  public void run()
  {
    ...
    do
    {
      do
      {
        ...
        ApolloItemBuilder.a(this.jdField_a_of_type_AndroidContentContext.getString(2131438174), 1, this.jdField_a_of_type_AndroidContentContext);
      ...
      ApolloItemBuilder.a(this.jdField_a_of_type_AndroidContentContext.getString(2131438175), 1, this.jdField_a_of_type_AndroidContentContext);
    } while (!QLog.isColorLevel());
    ...
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
        ApolloItemBuilder.a(this.jdField_a_of_type_AndroidContentContext.getString(2131438176), 1, this.jdField_a_of_type_AndroidContentContext);
      ...
      ApolloItemBuilder.a(this.jdField_a_of_type_AndroidContentContext.getString(2131438173), 2, this.jdField_a_of_type_AndroidContentContext);
