...
public class ont
{
  public static int a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (onk.d(paramBaseArticleInfo)) {
      return 3;
    }
    if (onk.a(paramBaseArticleInfo)) {
      return 2;
    }
    return 0;
  }
  ...
  public static Intent a(Context paramContext, ArticleInfo paramArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      paramContext.putExtra("req_create_time", onj.a(paramArticleInfo.mTime));
  ...
  {
    // Byte code:
    //   0: invokestatic 213	onk:a	()Lmqq/app/AppRuntime;
  ...
  public static Intent b(Context paramContext, ArticleInfo paramArticleInfo)
  {
    if (onk.a(paramArticleInfo.mArticleContentUrl, paramArticleInfo.mChannelID, paramArticleInfo))
    {
      ...
      if (localObject1 != null) {
        ((pai)localObject1).a(paramArticleInfo.mArticleContentUrl, String.valueOf(paramArticleInfo.innerUniqueID), paramArticleInfo.mSubscribeID, 1, null);
      }
    ...
    if (rap.b(paramArticleInfo))
    {
      ...
      if (!rap.f(paramArticleInfo)) {
        localObject1 = ((qdv)paramArticleInfo.mSocialFeedInfo.a.a.get(0)).b;
      }
    }
    ...
    else
    {
      ...
      localBundle.putBoolean("preload_tool_white_list", onk.f());
      ...
      if ((bbdj.b(ajsf.cG + paramContext)) && (PreloadManager.a().b(paramContext) != null))
      {
        ...
        if (!osj.a().a(paramArticleInfo.mArticleID))
        {
          ...
          {
            ThreadManager.post(new ReadinjoyJumpUtils.1(paramArticleInfo, (sex)paramContext.get(0)), 5, null, false);
            if (paramContext.size() <= 1) {
              break label742;
            }
            localBundle.putString("preload_iamge_url", ((sex)paramContext.get(1)).a);
          }
        }
      }
    }
    for (;;)
    {
      ...
      paramContext = paramArticleInfo.a(paramContext);
      if ((paramContext != null) && (paramContext.size() > 0)) {
        localBundle.putString("preload_iamge_url", ((sex)paramContext.get(0)).a);
      } else {
        localBundle.putString("preload_iamge_url", null);
      }
    }
