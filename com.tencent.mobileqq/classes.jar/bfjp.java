...
public class bfjp
  implements bcrz
{
  public bfjp(TroopInteractGiftAnimationController.1.1 param1, int paramInt1, int paramInt2, String paramString, JSONObject paramJSONObject1, int paramInt3, JSONObject paramJSONObject2) {}
  ...
  public void a()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopInteractGiftAnimationController$1$1.a.this$0.a.a(str, new bfjq(this));
      return;
