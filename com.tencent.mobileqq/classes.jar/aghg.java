...
public class aghg
{
  private static aghg jdField_a_of_type_Aghg;
  public static String a;
  private static final String jdField_b_of_type_JavaLangString = aljq.cP + "icons/";
  private static final String jdField_c_of_type_JavaLangString = aljq.cP + "zip/";
  private static final String jdField_d_of_type_JavaLangString = alpo.a(2131710233);
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString2.mkdirs();
        paramString1 = new bdvv(paramString1, new File(jdField_c_of_type_JavaLangString + "android_qim_theme_icons.zip"));
  ...
  {
    if (jdField_a_of_type_Aghg == null) {
      jdField_a_of_type_Aghg = new aghg();
    }
    return jdField_a_of_type_Aghg;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    //   11: getstatic 49	aghg:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   58: ifeq -22 -> 36
    //   61: getstatic 45	aghg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   64: invokestatic 143	bdcs:b	(Ljava/lang/String;)V
    //   67: aload_2
    //   68: getstatic 45	aghg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
  ...
  public void a(ArrayList<aghh> paramArrayList, ArrayList<int[]> paramArrayList1)
  {
  ...
  {
    if ((!paramBoolean) && ((!(paramObject instanceof afyl)) || ((paramObject instanceof afyu)))) {}
    do
    {
      return false;
        ...
        if (localBitmap != null)
        {
          ...
          if (localObject2 == null)
          {
            ...
            if (localBitmap != null)
            {
              ...
              {
                localObject2 = bdda.a(jdField_b_of_type_JavaLangString + "qim_title_immersive_bar.png", (BitmapFactory.Options)localObject3);
                localObject1 = localBitmap;
                if (localObject2 != null)
                {
                  ...
                  if (localObject2 == null)
                  {
                    localObject1 = bdda.a(jdField_b_of_type_JavaLangString + "aio_qim_user_online_title_icon.png", (BitmapFactory.Options)localObject3);
