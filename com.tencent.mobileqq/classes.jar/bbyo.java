...
public class bbyo
{
  ...
  private WeakReference<bbyp> jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(null);
  private String b;
  private String c = "android";
  private String d = "8.2.8";
  ...
  public bbyo(String paramString, int paramInt, bbyp parambbyp)
  {
    this.b = paramString;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambbyp);
  }
  ...
  private bbyg a()
  {
    try
    {
      ...
      if (i == 200)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            ...
            if (localObject != null) {
              return new bbyg((JSONObject)localObject);
            }
          }
        }
      }
      else
      {
        ...
        localObject = new bbyg();
        ((bbyg)localObject).jdField_a_of_type_Int = i;
        return localObject;
      }
    }
  ...
  private void a(bbyg parambbyg)
  {
    if ((parambbyg != null) && (QLog.isColorLevel())) {
      QLog.i("GetRegisterLiangHaoList", 2, "onResponse " + parambbyg);
    }
    ...
    if (parambbyg != null)
    {
      i = parambbyg.jdField_a_of_type_Int;
    ...
    {
      localaxrl.a(null, "reg_lh_get_list", bool, l1 - l2, 0L, (HashMap)localObject, "", true);
      localObject = (bbyp)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localObject != null) {
        break label143;
      }
      return;
    ...
    label143:
    ThreadManagerV2.getUIHandlerV2().post(new GetRegisterLiangHaoList.2(this, parambbyg, (bbyp)localObject));
  }
  ...
  private String b()
  {
    ...
    try
    {
      this.jdField_a_of_type_JavaLangString = bfmw.a("ecd027");
