...
{
  private int jdField_a_of_type_Int = boec.jdField_a_of_type_Int;
  private bpos jdField_a_of_type_Bpos;
  private bpot jdField_a_of_type_Bpot;
  private brjn jdField_a_of_type_Brjn = new brjn();
  private MusicItemInfo jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo;
  private HashMap<Integer, bpot> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private List<bpou> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private ConcurrentHashMap<String, bihu> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  /* Error */
  private bpot a(MusicItemInfo paramMusicItemInfo)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   9: if_icmpne +62 -> 71
    //   12: aload_0
    //   13: getfield 44	bpoz:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   16: iconst_1
    ...
    //   33: new 73	bpot
    //   36: dup
    //   37: invokespecial 74	bpot:<init>	()V
    //   40: astore_2
    //   41: aload_2
    //   42: aload_0
    //   43: getfield 49	bpoz:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   46: invokevirtual 77	bpot:a	(Ljava/util/List;)V
    //   49: aload_0
    //   50: getfield 44	bpoz:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   53: iconst_1
    ...
    //   62: aload_2
    //   63: aload_1
    //   64: invokevirtual 84	bpot:a	(Lcom/tencent/mobileqq/richmedia/capture/data/MusicItemInfo;)V
    //   67: aload_0
    //   68: monitorexit
    //   69: aload_2
    //   70: areturn
    ...
    //   76: if_icmpne -9 -> 67
    //   79: aload_0
    //   80: getfield 44	bpoz:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   83: iconst_2
    ...
    //   108: aload_2
    //   109: aload_0
    //   110: getfield 49	bpoz:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   113: invokevirtual 77	bpot:a	(Ljava/util/List;)V
    //   116: aload_0
    //   117: getfield 44	bpoz:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   120: iconst_2
    ...
    //   129: aload_2
    //   130: aload_1
    //   131: invokevirtual 84	bpot:a	(Lcom/tencent/mobileqq/richmedia/capture/data/MusicItemInfo;)V
    //   134: goto -67 -> 67
    //   137: astore_1
    //   138: aload_0
    //   139: monitorexit
  ...
  {
    if ((this.jdField_a_of_type_Bpos != null) && (!this.jdField_a_of_type_Boolean) && ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo == null) || (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.isMute() != paramMusicItemInfo.isMute()))) {
      this.jdField_a_of_type_Bpos.a(paramMusicItemInfo.isMute());
    }
  }
  
  private void g()
  {
    if (this.jdField_a_of_type_Bpot != null)
    {
      f();
      this.jdField_a_of_type_Bpot.a();
    }
  }
  ...
  public int a()
  {
    int i = -1;
    if (a()) {
      i = this.jdField_a_of_type_Bpot.a();
    }
    return i;
  }
  ...
  {
    if (this.jdField_a_of_type_Bpos != null) {
      this.jdField_a_of_type_Bpos.a(true);
    }
    a(-1, -1, paramInt);
  }
  ...
  {
    if (this.jdField_a_of_type_Bpot != null) {
      this.jdField_a_of_type_Bpot.a(paramLong);
    }
  }
  
  public void a(bpos parambpos)
  {
    this.jdField_a_of_type_Bpos = parambpos;
    if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo != null) && (this.jdField_a_of_type_Bpos != null)) {
      this.jdField_a_of_type_Bpos.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.isMute());
    }
  }
  
  public void a(bpou parambpou)
  {
    if ((parambpou == null) || (this.jdField_a_of_type_JavaUtilList == null)) {
    ...
    {
      return;
      if (!this.jdField_a_of_type_JavaUtilList.contains(parambpou)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("QimMusicPlayer", 2, "addMusicPlayerSceneListener mListeners has listener");
    return;
    this.jdField_a_of_type_JavaUtilList.add(parambpou);
  }
  ...
  public void a(MusicItemInfo paramMusicItemInfo)
  {
    ...
    {
      localObject = (bihu)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramMusicItemInfo.getLocalPath());
      if (localObject != null) {
        QQMusicDownloader.a((bihu)localObject);
      }
    }
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Bpot != null) && (this.jdField_a_of_type_Bpot.a());
  }
  
  public boolean a(int paramInt1, int paramInt2, int paramInt3)
  {
    MusicItemInfo localMusicItemInfo = ((QIMMusicConfigManager)bplq.a(2)).a(paramInt1, paramInt2);
  ...
  public boolean a(MusicItemInfo paramMusicItemInfo)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((bpou)localIterator.next()).a(paramMusicItemInfo);
      }
    }
    e();
    ...
    this.jdField_a_of_type_Bpot = a(paramMusicItemInfo);
    return true;
  }
  ...
  public boolean a(MusicItemInfo paramMusicItemInfo, bpor parambpor)
  {
    String str;
    ...
    if (!this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(str))
    {
      ...
      parambpor = new bpoy(this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap, this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap, parambpor);
      bihu localbihu = QQMusicDownloader.a(paramMusicItemInfo.mUrl, str, parambpor);
      if (localbihu != null)
      {
        this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(str, localbihu);
        QQMusicDownloader.a(localbihu, parambpor);
  ...
  public boolean a(MusicItemInfo paramMusicItemInfo, boolean paramBoolean, int paramInt)
  {
    ...
    if (!b(paramMusicItemInfo)) {}
    while ((bczv.a().b()) || (c(paramMusicItemInfo))) {
      return false;
    }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Bpos = null;
    this.jdField_a_of_type_JavaUtilList.clear();
    this.jdField_a_of_type_JavaUtilList = null;
    this.jdField_a_of_type_Bpot = null;
    this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilHashMap.values().iterator();
    while (localIterator.hasNext()) {
      ((bpot)localIterator.next()).f();
    }
    this.jdField_a_of_type_JavaUtilHashMap.clear();
    this.jdField_a_of_type_JavaUtilHashMap = null;
    this.jdField_a_of_type_Brjn.a();
    this.jdField_a_of_type_Brjn = null;
  }
  ...
  public void b(int paramInt)
  {
    ...
    while (this.jdField_a_of_type_Bpot == null) {
      return;
    }
    this.jdField_a_of_type_Bpot.c();
  }
  
  public void b(bpou parambpou)
  {
    if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.contains(parambpou))) {
      this.jdField_a_of_type_JavaUtilList.remove(parambpou);
    }
  }
  ...
  public boolean b(MusicItemInfo paramMusicItemInfo)
  {
    ...
    while (((paramMusicItemInfo.mType == 5) || (paramMusicItemInfo.mType == 1)) && (!bhmi.b(paramMusicItemInfo.getLocalPath()))) {
      return false;
    }
    return true;
  }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Bpot != null)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo != null) && (this.jdField_a_of_type_JavaUtilList != null))
      {
        Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
        while (localIterator.hasNext()) {
          ((bpou)localIterator.next()).a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo);
        }
      }
      this.jdField_a_of_type_Bpot.b();
      f();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bpot != null) {
      this.jdField_a_of_type_Bpot.jdField_a_of_type_Int = paramInt;
    }
  }
  ...
  public boolean c()
  {
    ...
    int i = j;
    if (j == boec.jdField_a_of_type_Int) {
      i = boec.a();
    }
    QQFilterRenderManager localQQFilterRenderManager = boec.a(i);
  ...
  public void f()
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (this.jdField_a_of_type_Brjn == null);
        int j = this.jdField_a_of_type_Int;
        int i = j;
        if (j == boec.jdField_a_of_type_Int) {
          i = boec.a();
        }
        localQQFilterRenderManager = boec.a(i);
        if ((localMusicItemInfo.needPlay()) && (c()))
        {
          if (a()) {}
          for (i = a() - localMusicItemInfo.musicStart;; i = 0)
          {
            this.jdField_a_of_type_Brjn.a(localMusicItemInfo, i);
            if (localQQFilterRenderManager == null) {
              break;
            }
  ...
  public float getCurrentMusicGain()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          if ((this.jdField_a_of_type_Brjn != null) && (localMusicItemInfo.needPlay()) && (a()))
          {
            float f = this.jdField_a_of_type_Brjn.a(a() - localMusicItemInfo.musicStart);
            return f;
          }
        }
