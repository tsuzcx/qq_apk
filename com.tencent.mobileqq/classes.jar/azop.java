  ...
  implements View.OnClickListener
{
  ...
  public azop()
  {
    ...
    this.jdField_a_of_type_Ajxj = new azos(this, null);
  }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    mxf.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new azoq(this, paramLong), localReqBody.toByteArray(), "OidbSvc.0x487_0", 1159, paramInt);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      {
        Object localObject2 = (auko)((Iterator)localObject1).next();
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, Observer paramObserver, SessionInfo paramSessionInfo, RelativeLayout paramRelativeLayout, acup paramacup, ChatXListView paramChatXListView)
  {
    ...
    this.d = paramContext.getResources().getColor(2131166135);
    this.e = paramContext.getResources().getColor(2131166136);
  ...
  public void b()
  {
    ...
    if (this.jdField_c_of_type_AndroidViewView == null) {
      this.jdField_c_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560289, null);
    }
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_c_of_type_AndroidViewView) == -1)
    {
      localObject = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject).topMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
      ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131372955);
      ((RelativeLayout.LayoutParams)localObject).addRule(11);
      ((RelativeLayout.LayoutParams)localObject).height = baxn.a(this.jdField_a_of_type_AndroidContentContext, 41.0F);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131377717));
    ...
    ((LinearLayout.LayoutParams)localObject).leftMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 4.0F);
    ((LinearLayout.LayoutParams)localObject).rightMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
    int i = baxn.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
    ...
    if (ThemeUtil.isInNightMode(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130849564);
    }
    for (;;)
    {
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843067);
      ...
      return;
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130849565);
    }
  }
  ...
  public void c()
  {
    ...
    ImageView localImageView = (ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131377716);
    localImageView.setVisibility(0);
    LinearLayout.LayoutParams localLayoutParams = (LinearLayout.LayoutParams)localImageView.getLayoutParams();
    localLayoutParams.height = -2;
    localLayoutParams.width = -2;
    localLayoutParams.leftMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 3.0F);
    localLayoutParams.rightMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 8.0F);
    Drawable localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843068);
    localLayoutParams.leftMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 11.0F);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131697928);
  }
  ...
  public void e()
  {
    ...
    {
      axqy.b(localQQAppInterface, "P_CliOper", "Grp_public", "", "oper", str1, 0, 0, "", "", "", str2);
      return;
