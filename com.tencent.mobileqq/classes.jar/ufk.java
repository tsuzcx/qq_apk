...
{
  public ufk(VisitorsActivity paramVisitorsActivity) {}
      ...
      for (;;)
      {
        if (i < paramInt2)
        {
          ...
          if ((localObject != null) && ((localObject instanceof ufl)))
          {
            ...
            if ((((ufl)localObject).a == paramInt1) && (((ufl)localObject).e != null)) {
              VisitorsActivity.a(this.a, ((ufl)localObject).e, paramInt1);
            }
          }
          i += 1;
          continue;
