...
public class ahjk
  implements bbiy, bbja
{
  private static ahjk jdField_a_of_type_Ahjk;
  public int a;
  ...
  public WeakReference<ahjs> a;
  public HashMap<MessageForPtt, MessageForQQWalletMsg> a;
  public Map<MessageForPtt, ahju> a;
  ...
  public static ahjk a()
  {
    try
    {
      if (jdField_a_of_type_Ahjk == null) {
        jdField_a_of_type_Ahjk = new ahjk();
      }
      ahjk localahjk = jdField_a_of_type_Ahjk;
      return localahjk;
    }
    finally {}
  }
  
  private ahjt a(byte[] paramArrayOfByte)
  {
    boolean bool = true;
    ahjt localahjt = new ahjt();
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length == 0)) {
      return localahjt;
    }
    ahjj.a().a();
    if (ahjj.a().a(paramArrayOfByte, paramArrayOfByte.length) == 1) {}
    for (;;)
    {
      localahjt.jdField_a_of_type_Boolean = bool;
      localahjt.jdField_a_of_type_Float = ahjj.a().a();
      localahjt.jdField_a_of_type_JavaLangString = a(localahjt.jdField_a_of_type_Float);
      ahjj.a().b();
  ...
  private ahjt a(byte[] paramArrayOfByte, MessageForQQWalletMsg paramMessageForQQWalletMsg)
  {
  ...
  private void a(int paramInt1, long paramLong, int paramInt2, MessageForQQWalletMsg paramMessageForQQWalletMsg, float paramFloat)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (ahjj.a().a(localQQAppInterface)) {
        paramInt1 = 1;
      } else {
        paramInt1 = 0;
      }
  ...
  {
    ahjs localahjs = (ahjs)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((localahjs != null) && (!localahjs.c())) {
      localahjs.a(paramInt, paramString);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(MessageRecord paramMessageRecord, long paramLong, byte[] paramArrayOfByte, String paramString)
  {
    ...
    try
    {
      MessageForPtt localMessageForPtt = aanz.a(ahiw.a(), paramMessageRecord.getLocalFilePath(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, -2, paramMessageRecord.voiceType);
      if (localMessageForPtt != null)
      {
        this.jdField_a_of_type_JavaUtilMap.put(localMessageForPtt, new ahju(paramMessageRecord, paramLong, paramArrayOfByte, paramString));
        paramArrayOfByte = new QQRecorder.RecorderParam(bbjg.jdField_b_of_type_Int, 16000, 1);
        if (a(this.jdField_a_of_type_ArrayOfByte, this.jdField_a_of_type_JavaLangString, paramMessageRecord.getLocalFilePath(), paramArrayOfByte))
        {
          ...
          if ((paramString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (localMessageForPtt != null))
          {
            ...
            paramArrayOfByte = (ahjs)this.jdField_a_of_type_JavaLangRefWeakReference.get();
  ...
  public static void a(String paramString, MessageForPtt paramMessageForPtt, aypg paramaypg)
  {
    b(paramString, paramMessageForPtt);
    if (paramaypg != null)
    {
      if (!(paramaypg instanceof aypp)) {
        break label38;
      }
      paramString = ((aypp)paramaypg).a();
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (!(paramaypg instanceof ayrf)) {
            break;
          }
          paramString = ((ayrf)paramaypg).a(paramMessageForPtt);
        } while ((paramString == null) || (paramMessageForPtt == null));
        paramMessageForPtt.richText = paramString;
        return;
      } while (!(paramaypg instanceof ayrj));
      paramString = ((ayrj)paramaypg).a(paramMessageForPtt);
    } while ((paramString == null) || (paramMessageForPtt == null));
    paramMessageForPtt.richText = paramString;
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (!((File)localObject).exists())
        {
          ...
          localmna = new mna(paramRecorderParam.jdField_a_of_type_Int, 16, 1);
          localmna.a(new ahjl(this));
          l = System.currentTimeMillis();
        }
        try
        {
          localmna.a(paramString1, str);
          if (QLog.isColorLevel()) {
          ...
          avbt.a(paramString2);
          paramRecorderParam = bbjg.a(paramRecorderParam.jdField_c_of_type_Int, paramRecorderParam.jdField_a_of_type_Int);
          avbt.a(paramString2, paramRecorderParam, paramRecorderParam.length);
          ...
          avbt.a(paramString2, ((avcu)localObject).jdField_a_of_type_ArrayOfByte, ((avcu)localObject).jdField_a_of_type_Int);
        }
  ...
  public int a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    paramString = (ahjs)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (paramString != null) {
  ...
  public String a(float paramFloat)
  {
    ...
    {
      localObject1 = (agzd)((QQAppInterface)localObject1).getManager(245);
      if (localObject1 != null)
      {
        localObject1 = ((agzd)localObject1).a("voice_pwd", new String[] { "scoreIdMap" });
        if (localObject1 == null) {}
      }
    }
    int i;
  ...
  public void a(ahjr paramahjr)
  {
    Object localObject = ahiw.a();
    if ((localObject == null) || (paramahjr == null)) {}
    do
    {
      return;
      localObject = ((TicketManager)((QQAppInterface)localObject).getManager(2)).GetSkey(((QQAppInterface)localObject).getCurrentAccountUin(), 16L, new ahjq(this, paramahjr));
    } while ((localObject == null) || (((Ticket)localObject)._sig == null) || (((Ticket)localObject)._sig.length == 0));
    paramahjr.a(new String(((Ticket)localObject)._sig));
  }
  
  public void a(ahjs paramahjs)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramahjs);
  }
  ...
  public void a(SessionInfo paramSessionInfo, MessageForQQWalletMsg paramMessageForQQWalletMsg, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      i = aelp.a(paramMessageForQQWalletMsg.messageType);
      str1 = paramString;
      if (TextUtils.isEmpty(paramString)) {
      ...
      localRecorderParam = new QQRecorder.RecorderParam(bbjg.jdField_b_of_type_Int, 16000, 1);
      if (!bbdx.a())
      {
        b(2131694694);
        c("no sdcard");
    ...
    boolean bool2 = true;
    long l1 = agxa.a(localQQAppInterface.getCurrentAccountUin(), "voice_recognieze_in_phone", 0L);
    ...
    if ((!this.jdField_c_of_type_Boolean) && (!bool1)) {
      a(2, agxa.a(localQQAppInterface.getCurrentAccountUin(), "voice_recognieze_in_phone_tips", BaseApplicationImpl.getContext().getResources().getString(2131695644)));
    }
    if (paramBoolean)
    {
    ...
    for (;;)
    {
      ...
      do
      {
        str1 = ayph.a(localQQAppInterface.getCurrentAccountUin(), null, 2, null, false);
        ...
        paramSessionInfo = aanz.a(localQQAppInterface, paramString, paramSessionInfo, -2, localRecorderParam.jdField_c_of_type_Int);
  ...
  public void a(MessageRecord paramMessageRecord, akat paramakat, long paramLong, byte[] paramArrayOfByte, String paramString, aypg paramaypg)
  {
    QQAppInterface localQQAppInterface;
    Object localObject1;
    Object localObject2;
    ...
    {
      localQQAppInterface = ahiw.a();
      localObject1 = (ahjs)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      i = 0;
      if (localObject1 != null) {
        i = localObject1.hashCode();
      }
      if ((localQQAppInterface == null) || (paramMessageRecord == null) || (!(paramMessageRecord instanceof MessageForPtt)) || (localObject1 == null) || (((ahjs)localObject1).c()) || (this.jdField_b_of_type_Boolean) || (i != this.jdField_a_of_type_Int)) {
        return;
      }
      ...
      if (i == 1)
      {
        paramMessageRecord = (ahjs)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        ...
        localQQAppInterface.a().a((MessageRecord)localObject2, paramakat);
        return;
      }
      if (i != 2) {
        break label307;
    ...
    for (;;)
    {
      a(new ahjm(this, localQQAppInterface, (MessageForQQWalletMsg)localObject1, i, paramLong, paramArrayOfByte, paramString, (MessageForPtt)localObject2, paramaypg, paramakat));
      return;
    ...
    if (i == 3)
    {
      ...
      {
        paramMessageRecord = (MessageForPtt)paramMessageRecord;
        localObject2 = (ahju)this.jdField_a_of_type_JavaUtilMap.get(paramMessageRecord);
        ...
        for (;;)
        {
          a(new ahjo(this, localMessageForQQWalletMsg, localQQAppInterface, i, (ahju)localObject2, paramLong, paramArrayOfByte, paramString, (MessageForQQWalletMsg)localObject1, paramMessageRecord, paramaypg, paramakat));
          return;
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    byte[] arrayOfByte = bbjg.a(paramRecorderParam.jdField_c_of_type_Int, paramRecorderParam.jdField_a_of_type_Int);
    avbt.a(paramString);
    avbt.a(paramString, arrayOfByte, arrayOfByte.length);
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam, double paramDouble)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      bool = ((ahjt)localObject2).jdField_a_of_type_Boolean;
      if (bool) {
        b(((ahjt)localObject2).jdField_a_of_type_JavaLangString, (MessageRecord)localObject1);
      }
      localObject2 = (ahjs)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((localObject2 == null) || (((ahjs)localObject2).c()) || (bool)) {
        break label679;
      }
      ((ahjs)localObject2).a(false, "");
      break label679;
      localObject2 = (MessageForQQWalletMsg)this.jdField_a_of_type_JavaUtilHashMap.get(localObject1);
      ...
      j = aelp.a(((MessageForQQWalletMsg)localObject2).messageType);
      if (j == 8) {
        if (((MessageForQQWalletMsg)localObject2).mQQWalletRedPacketMsg.elem.songFlag == 0) {
          if (this.jdField_d_of_type_Int == -1) {
            if (!ahiw.a(BaseApplicationImpl.getContext())) {
              break label682;
            }
          }
        }
  ...
  public void b(int paramInt)
  {
    ...
    localQQAppInterface.runOnUiThread(new VoiceRedPacketHelper.1(this, localBaseApplication, paramInt, localBaseApplication.getResources().getDimensionPixelSize(2131298865)));
  }
  
  public void b(avct paramavct, avcu paramavcu)
  {
    if (((paramavct instanceof WechatNsWrapper)) && (this.jdField_a_of_type_JavaIoByteArrayOutputStream != null) && (paramavcu != null) && (this.jdField_d_of_type_Boolean)) {
      this.jdField_a_of_type_JavaIoByteArrayOutputStream.write(paramavcu.jdField_a_of_type_ArrayOfByte, 0, paramavcu.jdField_a_of_type_Int);
    }
  }
