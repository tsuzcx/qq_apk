...
{
  amgy(amgw paramamgw, Oidb_0x5d0.RspBody paramRspBody, String paramString1, String paramString2, int paramInt1, int paramInt2) {}
  ...
  protected ArrayList<String> a(Void... paramVarArgs)
  {
    ...
    //   11: astore_1
    //   12: aload_0
    //   13: getfield 17	amgy:jdField_a_of_type_TencentImOidbCmd0x5d0Oidb_0x5d0$RspBody	Ltencent/im/oidb/cmd0x5d0/Oidb_0x5d0$RspBody;
  ...
  protected void a(ArrayList<String> paramArrayList)
  {
    if (paramArrayList != null) {
      azyl.a(amgw.a(this.jdField_a_of_type_Amgw), this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, paramArrayList, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
    }
  }
}
