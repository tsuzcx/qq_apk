...
public class bjcf
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, bjch parambjch)
  {
    paramQQAppInterface = a(paramQQAppInterface, paramString, new bjcg(parambjch, paramString));
    if (!bdnn.a(paramQQAppInterface))
    {
      if (parambjch != null)
      {
        ...
        parambjch.a(0, new String[] { paramQQAppInterface });
      }
      return;
    }
