  ...
  implements Handler.Callback, Manager
{
  ...
  public String a;
  private Vector<WeakReference<akok>> jdField_a_of_type_JavaUtilVector = new Vector();
  private boolean jdField_a_of_type_Boolean;
  private Handler b;
  
  public aknw(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_JavaLangString = aknk.a();
    this.jdField_a_of_type_Atmp = this.jdField_a_of_type_ComTencentCommonAppAppInterface.getEntityManagerFactory().createEntityManager();
    ThreadManager.post(new ArResourceManager.1(this), 8, null, true);
    this.jdField_a_of_type_Akns = new akns(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this);
  }
  ...
  public ArDownloadInfo a(String paramString)
  {
    ...
    //   16: areturn
    //   17: aload_0
    //   18: getfield 102	aknw:jdField_a_of_type_Atmp	Latmp;
    //   21: ldc 167
    //   23: aload_1
    //   24: invokevirtual 172	atmp:a	(Ljava/lang/Class;Ljava/lang/String;)Latmo;
    ...
    //   54: aload_3
    //   55: invokevirtual 177	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    for (;;)
    {
      try
      {
        if (paramInt2 < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          {
            ((akok)((WeakReference)localObject1).get()).a(paramInt1);
          }
        }
        else
        {
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          {
            ((akok)((WeakReference)localObject1).get()).a(paramLong1, paramLong2);
          }
        }
        else
        {
  ...
  public void a(akok paramakok)
  {
    if (paramakok != null) {
      this.jdField_a_of_type_JavaUtilVector.add(new WeakReference(paramakok));
    }
  }
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          ((akok)((WeakReference)localObject2).get()).a(paramArConfigInfo);
          break label600;
        }
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          ((akok)((WeakReference)localObject).get()).a(paramArEffectConfig);
          break label134;
        }
        return;
      }
  ...
  public void a(ArDownloadInfo paramArDownloadInfo)
  {
    ...
    //   8: return
    //   9: aload_0
    //   10: getfield 102	aknw:jdField_a_of_type_Atmp	Latmp;
    //   13: invokevirtual 388	atmp:a	()Latmr;
    //   16: astore_2
    //   17: aload_2
    //   18: invokevirtual 391	atmr:a	()V
    //   21: aload_0
    //   22: getfield 102	aknw:jdField_a_of_type_Atmp	Latmp;
    //   25: aload_1
    //   26: invokevirtual 394	atmp:b	(Latmo;)V
    //   29: aload_2
    //   30: invokevirtual 396	atmr:c	()V
    //   33: aload_2
    //   34: invokevirtual 397	atmr:b	()V
    //   37: goto -31 -> 6
    //   40: astore_1
    //   41: aload_0
    //   42: monitorexit
    ...
    //   49: ifeq +7 -> 56
    //   52: aload_1
    //   53: invokevirtual 400	java/lang/Exception:printStackTrace	()V
    //   56: aload_2
    //   57: invokevirtual 397	atmr:b	()V
    //   60: goto -54 -> 6
    //   63: astore_1
    //   64: aload_2
    //   65: invokevirtual 397	atmr:b	()V
    //   68: aload_1
    //   69: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    for (;;)
    {
      ...
      {
        paramString.a();
        this.jdField_a_of_type_Atmp.a(localArDownloadInfo);
        paramString.c();
        paramString.b();
        continue;
        label133:
  ...
  public boolean a()
  {
    boolean bool1 = false;
    boolean bool2 = true;
    if (this.jdField_a_of_type_Aknl == null) {}
    for (int i = 3; i == 1; i = this.jdField_a_of_type_Aknl.a) {
      return true;
    }
  ...
  public boolean a(ArConfigInfo paramArConfigInfo)
  {
    ...
    //   24: aload_1
    //   25: invokevirtual 177	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    ...
    //   34: aload_1
    //   35: aload_0
    //   36: getfield 34	aknw:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   39: invokevirtual 182	com/tencent/common/app/AppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   42: invokestatic 467	com/tencent/mobileqq/ar/aidl/ArConfigInfo:saveArConfigToFile	(Lcom/tencent/mobileqq/ar/aidl/ArConfigInfo;Ljava/lang/String;)Z
    //   45: ifeq +14 -> 59
    //   48: aload_0
    //   49: aload_1
    //   50: putfield 131	aknw:jdField_a_of_type_ComTencentMobileqqArAidlArConfigInfo	Lcom/tencent/mobileqq/ar/aidl/ArConfigInfo;
    //   53: iconst_1
    //   54: istore_2
    //   55: aload_0
    //   56: monitorexit
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      {
        return bool1;
        i = this.jdField_a_of_type_Aknl.b;
        break;
        j = this.jdField_a_of_type_Aknl.c;
        break label55;
      }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqArAidlArEffectConfig != null)
    {
      ...
      akiq.a().a(this.jdField_a_of_type_ComTencentMobileqqArAidlArEffectConfig);
    }
    ArEffectConfig.a();
  }
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          else if (((WeakReference)localObject).get() == paramakok)
          {
  ...
  public void b(ArConfigInfo paramArConfigInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    for (;;)
    {
      try
      {
        ...
        if (!badq.d(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp()))
        {
          if (!QLog.isColorLevel()) {
            continue;
          }
  ...
  {
    if (this.jdField_a_of_type_Aknl == null) {}
    for (int i = 1; i == 1; i = this.jdField_a_of_type_Aknl.e) {
      return true;
    }
    return false;
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Aknl == null)
    {
      this.jdField_a_of_type_Aknl = new aknl();
    ...
    try
    {
      ...
      this.jdField_a_of_type_Aknl.a = Integer.valueOf(localObject[4]).intValue();
      this.jdField_a_of_type_Aknl.b = Integer.valueOf(localObject[5]).intValue();
      this.jdField_a_of_type_Aknl.c = Integer.valueOf(localObject[6]).intValue();
      this.jdField_a_of_type_Aknl.jdField_d_of_type_Int = Integer.valueOf(localObject[7]).intValue();
      this.jdField_a_of_type_Aknl.e = Integer.valueOf(localObject[8]).intValue();
      i = 0;
    }
    catch (Exception localException)
    {
    ...
    if (i != 0)
    {
      this.jdField_a_of_type_Aknl.a = 3;
      this.jdField_a_of_type_Aknl.b = 3;
      this.jdField_a_of_type_Aknl.c = 1000;
      this.jdField_a_of_type_Aknl.jdField_d_of_type_Int = 1;
      this.jdField_a_of_type_Aknl.e = 1;
    }
    if (this.jdField_a_of_type_Aknl.jdField_d_of_type_Int == 1)
    {
      atiu.a(bool);
      if (QLog.isColorLevel()) {
        QLog.d("ArConfig_ArResourceManager", 2, "loadDPCConfig|dpc:" + this.jdField_a_of_type_Aknl.toString());
      }
      return;
    }
  }
  ...
  public int d()
  {
    ...
    return this.jdField_a_of_type_Aknl.a;
  }
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          {
            ((akok)((WeakReference)localObject1).get()).b();
          }
        }
        else
        {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      aknk.b(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), bool1, i);
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        for (paramMessage = "1";; paramMessage = "0")
        {
          ...
          awrn.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), "olympic_ar_native_so_report", bool1, 0L, 0L, (HashMap)localObject, null);
        ...
        for (;;)
        {
          try
          {
            ...
            if (bace.a(((ArCloudConfigInfo)localObject).jdField_a_of_type_ComTencentMobileqqArModelArFeatureInfo.c)) {
              break label432;
            }
            bool1 = false;
            aknk.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), bool1, bool2);
          ...
          {
            bool1 = bace.a(((ArCloudConfigInfo)localObject).jdField_a_of_type_ComTencentMobileqqArModelArModelResource.f);
            if (!bool1)
            {
              bool1 = true;
              bool2 = false;
