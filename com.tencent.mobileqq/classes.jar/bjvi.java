...
public class bjvi
{
  ...
  {
    bjtx.c("AppUpdate", "httpRequest >>> " + paramString1.toString());
    try
    {
    ...
    catch (JSONException paramContext)
    {
      ...
      for (;;)
      {
        bjtx.c("AppUpdate", "httpRequest JSONException", paramContext);
        return;
        i = 0;
        continue;
        paramString1 = "0";
      ...
      bjtx.c("AppUpdate", "use supportEtag");
      if (paramBoolean) {
        break label548;
      }
      ...
      bjtx.c("AppUpdate", "execute asyncTask url >>> " + str2 + " methodName " + str3);
      a(new bjus(str2, str3, new bjvj(paramContext, paramWebView, str1, str4, str5, paramBoolean)), localBundle);
      return;
    }
    catch (Exception paramContext)
    {
      bjtx.c("AppUpdate", "httpRequest Exception", paramContext);
    }
    localBundle = new Bundle();
    localBundle.putString("platform", bjjo.a().g());
    localBundle.putString("keystr", bjjo.a().a());
    localBundle.putString("uin", paramString2);
    localBundle.putString("resolution", bjve.e());
    localBundle.putString("keytype", "256");
    if (bjva.a(paramContext))
    {
      paramString1 = "1";
      ...
      while (paramString2.hasNext())
      {
        ...
        bjtx.c("AppUpdate", "key = " + (String)localObject1 + " value = " + localObject2.toString());
  ...
  @TargetApi(11)
  protected static void a(bjus parambjus, Bundle paramBundle)
  {
