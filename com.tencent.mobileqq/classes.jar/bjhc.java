...
{
  bjhe jdField_a_of_type_Bjhe = new bjhe();
  private volatile boolean jdField_a_of_type_Boolean = true;
  
  public bjhc()
  {
    this.jdField_a_of_type_Bjhe.a();
  }
  ...
  {
    return bdgk.b(BaseApplication.getContext());
  }
  ...
  {
    boolean bool = this.jdField_a_of_type_Bjhe.a(paramString);
  ...
  public void registerNetworkStateObserver(UploadConfiguration.NetworkStateObserver paramNetworkStateObserver)
  {
    ...
    cooperation.qzone.util.NetworkState.addListener(new bjhd(this, paramNetworkStateObserver));
  }
}
