  ...
  extends BaseAdapter
{
  ...
  private bjhd jdField_a_of_type_Bjhd;
  ...
  public bjhc(Context paramContext, List<ShareActionSheetBuilder.ActionSheetItem> paramList, ShareActionSheetV2 paramShareActionSheetV2)
  {
  ...
  private static void a(int paramInt, String paramString, ImageView paramImageView, bhsc parambhsc, bjhc parambjhc, ShareActionSheetV2 paramShareActionSheetV2)
  {
    ...
    while (paramInt != -1)
    {
      ...
      aqgi localaqgi = (aqgi)ShareActionSheetV2.a(paramShareActionSheetV2).get(paramInt);
      parambjhc = localaqgi;
      if (localaqgi == null)
      {
        parambjhc = new aqgi(paramShareActionSheetV2.a, paramInt);
        if (!bdgb.a()) {
          break label278;
        }
      }
      for (byte b = 1;; b = 3)
      {
        parambjhc.a(b);
        parambjhc.a();
        ShareActionSheetV2.a(paramShareActionSheetV2).put(paramInt, parambjhc);
        paramImageView.setTag(paramString);
        parambjhc.a(ShareActionSheetV2.a(paramShareActionSheetV2));
        paramString = parambjhc.a(paramString, true);
        if (paramString == null) {
          break;
        }
        parambhsc.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.iconDrawable = new BitmapDrawable(paramString);
        b(parambhsc);
        return;
        paramInt = 1;
        break label90;
        if ((TextUtils.isEmpty(parambhsc.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.argus)) || (!parambhsc.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.argus.contains("isNewTroop=1"))) {
          break label284;
        }
        paramInt = 113;
        break label90;
  ...
  private void a(bhsc parambhsc)
  {
    if (parambhsc.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.action == 72) {
      a(parambhsc.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.uinType, parambhsc.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.uin, parambhsc.jdField_a_of_type_AndroidWidgetImageView, parambhsc, this, this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheetV2);
    }
  }
  
  private static void b(bhsc parambhsc)
  {
    if (parambhsc.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.iconDrawable != null)
    {
      if (Build.VERSION.SDK_INT >= 16)
      {
        parambhsc.jdField_a_of_type_AndroidWidgetImageView.setBackground(parambhsc.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.iconDrawable);
        return;
      }
      parambhsc.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(parambhsc.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.iconDrawable);
      return;
    }
    parambhsc.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(parambhsc.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.icon);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (this.jdField_a_of_type_Bjhd == null) {
      this.jdField_a_of_type_Bjhd = new bjhd(paramViewGroup.getContext());
    }
    View localView;
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558934, paramViewGroup, false);
      paramView = new bhsc();
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131377494));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131377495));
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (bhsc)paramView.getTag();
      localView = paramView;
      paramView = (View)localObject;
    }
    localView.setId(paramView.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.id);
    float f = this.jdField_a_of_type_AndroidContentResResources.getDimension(2131296740);
    paramView.jdField_a_of_type_AndroidWidgetTextView.getPaint().setTextSize(this.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131298940));
    ...
    if (paramView.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.enable)
    {
      ...
      localObject = this.jdField_a_of_type_Bjhd.a((Drawable)localObject, i, j);
      if (!paramView.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder$ActionSheetItem.enable) {
        break label503;
      }
      Drawable localDrawable = bjhd.a(this.jdField_a_of_type_Bjhd, (Drawable)localObject);
      localObject = this.jdField_a_of_type_Bjhd.a((Drawable)localObject, localDrawable);
    ...
    for (;;)
    {
      ...
      break label371;
      label503:
      localObject = bjhd.b(this.jdField_a_of_type_Bjhd, (Drawable)localObject);
      paramView.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      break label451;
      label526:
