  ...
  implements Manager
{
  ...
  protected int a;
  protected Handler a;
  protected ArrayMap<Long, ArrayList<bglr>> a;
  private anvi jdField_a_of_type_Anvi;
  protected AppInterface a;
  protected String a;
  public WeakReference<bgmb> a;
  protected ArrayList<String> a;
  protected HashMap<Long, MessageForUniteGrayTip> a;
  protected List<bgmc> a;
  public boolean a;
  protected ArrayMap<Long, ArrayList<bglr>> b;
  public String b;
  ...
  public bgls(AppInterface paramAppInterface)
  {
    ...
    this.jdField_c_of_type_JavaUtilList.add(anvx.a(2131715123));
    this.jdField_d_of_type_JavaUtilList.add(anvx.a(2131715109));
  ...
  private void a(QQAppInterface paramQQAppInterface)
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilArrayList == null)
      {
        ...
        this.jdField_a_of_type_JavaUtilArrayList = bghs.a(paramQQAppInterface);
        if (this.jdField_a_of_type_JavaUtilArrayList == null) {
  ...
  public static void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      Object localObject = bhfp.d.matcher(paramMessageRecord.msg);
  ...
  private void a(MessageRecord paramMessageRecord, String paramString1, String paramString2, String paramString3)
  {
    ...
    b(Long.parseLong(paramMessageRecord.frienduin), Long.parseLong(paramString1), paramString3, new bglx(this, paramString3));
  }
  ...
  private void a(String paramString)
  {
    ...
    bhhr.c(localQQAppInterface.getApplication(), localQQAppInterface.getCurrentUin(), paramString, false);
  }
  ...
  {
    bdla.b(null, "dc00899", "Grp_robot", "", paramString1, paramString2, 0, 0, paramString3, paramString4, paramString5, paramString6);
  }
  ...
  public static boolean a(TextView paramTextView, MessageRecord paramMessageRecord)
  {
    ...
    if (!TextUtils.isEmpty(str1))
    {
      ...
      String str2 = anvx.a(2131715111);
      SpannableString localSpannableString = new SpannableString(str2);
      localSpannableString.setSpan(new bglu(str1, paramMessageRecord), 0, str2.length(), 33);
  ...
  public static String b(MessageRecord paramMessageRecord)
  {
    if (b(paramMessageRecord))
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty(paramMessageRecord))) {
        return paramMessageRecord + anvx.a(2131715119);
      }
    }
    return null;
  }
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Anvi != null) || (this.jdField_a_of_type_ComTencentCommonAppAppInterface == null) || (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface))) {
      return;
    }
    this.jdField_a_of_type_Anvi = new bglv(this);
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_Anvi != null) && (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null))
    {
  ...
  private void d()
  {
    Object localObject1 = bhhr.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
    if (!TextUtils.isEmpty((CharSequence)localObject1)) {
      try
      {
        ...
        localObject2 = bhhr.g(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
      }
    ...
    try
    {
      ...
      if (localObject2 != null) {
        a(((armb)localObject2).a(), ((armb)localObject2).a());
      }
      return;
    }
  ...
  public bglq a(long paramLong)
  {
    bglq localbglq = new bglq();
    localbglq.jdField_a_of_type_JavaUtilArrayList = a(paramLong);
    localbglq.b = b(paramLong);
    localbglq.jdField_a_of_type_Int = a(paramLong);
    return localbglq;
  }
  ...
  public ArrayList<bglr> a(long paramLong)
  {
    ...
    if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap != null) {
      synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
      {
        if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap.containsKey(Long.valueOf(paramLong)))
        {
          ...
          while (localIterator.hasNext())
          {
            bglr localbglr = (bglr)localIterator.next();
            if (localbglr.a()) {
              localArrayList.add(localbglr);
            }
          }
        }
      }
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, bgma parambgma)
  {
    ...
    ntb.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bgly(this, parambgma), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void a(int paramInt, long paramLong1, long paramLong2, String paramString, bgma parambgma)
  {
    cmd0x934.ReqBody localReqBody = new cmd0x934.ReqBody();
    ...
    localReqBody.robot_uin.set(paramLong2);
    ntb.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bglz(this, parambgma), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void a(long paramLong, int paramInt, bgma parambgma)
  {
    a(4, 0L, paramLong, paramInt, parambgma);
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    if (localMessageForUniteGrayTip != null)
    {
      ...
      avia.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, localMessageForUniteGrayTip);
    }
  }
      ...
      for (;;)
      {
        synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
        {
          if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap.containsKey(Long.valueOf(paramLong1)))
          {
            ...
            bglr localbglr = (bglr)((Iterator)localObject1).next();
            if (localbglr.a() != paramLong2) {
              continue;
            }
            ...
            if (!localbglr.a())
            {
              localObject1 = localObject4;
              if (paramInt == 1) {
                localObject1 = localbglr;
              }
            }
            localbglr.a(paramInt);
            if (localObject1 != null)
            {
              localArrayList.remove(localObject1);
              localArrayList.add(0, localObject1);
              if (QLog.isColorLevel()) {
                QLog.d("TroopRobotManager", 2, "onSetTroopRobot move position " + ((bglr)localObject1).a());
              }
            }
          }
          return;
  ...
  public void a(long paramLong1, long paramLong2, int paramInt, bgma parambgma)
  {
    a(1, paramLong1, paramLong2, paramInt, parambgma);
  }
  
  public void a(long paramLong1, long paramLong2, String paramString, bgma parambgma)
  {
    a(3, paramLong1, paramLong2, paramString, parambgma);
  }
  
  public void a(long paramLong, String paramString, bgma parambgma)
  {
    a(Long.valueOf("1").longValue(), paramLong, paramString, parambgma);
  }
  
  public void a(long paramLong, ArrayList<bglr> paramArrayList)
  {
  ...
  public void a(long paramLong, ArrayList<bglr> arg3, int paramInt)
  {
    StringBuilder localStringBuilder;
    if (QLog.isColorLevel())
    {
  ...
  public void a(Context paramContext, BaseChatPie paramBaseChatPie, QQAppInterface paramQQAppInterface, EditText paramEditText, SessionInfo paramSessionInfo, ChatMessage paramChatMessage, String paramString)
  {
    ...
    paramEditText = bgcz.a(paramQQAppInterface, paramContext, paramSessionInfo.curFriendUin, paramChatMessage.senderuin, str, false, paramEditText, true, true);
    paramContext = new ArrayList();
    paramEditText = bgcz.a(paramEditText, paramContext);
    ...
    try
    {
      ...
      new bdlf(paramQQAppInterface).a("dc00899").b("Grp_robot").c("sub_page").d("next_msg_clk").a(new String[] { paramChatMessage.frienduin, paramSessionInfo }).a();
      return;
    }
  ...
  public void a(bgmb parambgmb)
  {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambgmb);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, ArrayList<String> paramArrayList)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      localArrayList = bghs.b(paramQQAppInterface);
      if (localArrayList == null)
      {
        ...
        if ((paramArrayList == null) || (paramArrayList.size() == 0))
        {
          ...
          bghs.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilArrayList);
          bghs.a(paramQQAppInterface, false);
    ...
    for (;;)
    {
      ...
      {
        bghs.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilArrayList);
        bghs.b(paramQQAppInterface, localArrayList);
        if (paramArrayList.size() <= 0) {
          break label392;
        }
        bghs.a(paramQQAppInterface, true);
        bghs.c(paramQQAppInterface, true);
        break label392;
        break;
        i -= 1;
        break label182;
    ...
    try
    {
      ...
      if (paramRobot.uin_range.has())
      {
        ...
        while ((i < paramRobot.uin_range.size()) && (i < 5))
        {
          ...
          bgmc localbgmc = new bgmc();
          localbgmc.a = localUinRange.start_uin.get();
          localbgmc.b = localUinRange.end_uin.get();
          this.jdField_a_of_type_JavaUtilList.add(localbgmc);
          i += 1;
        }
      }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      b(Long.parseLong(paramString1), Long.parseLong(paramString2), paramString3, new bglw(this, paramString3));
      a();
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    if (localJSONArray != null) {
      bhhr.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), localJSONArray.toString());
    }
    paramJSONObject = paramJSONObject.optJSONObject("robot_voice_tail");
    if (paramJSONObject != null) {
      bhhr.g(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramJSONObject.toString());
    }
    d();
  }
  ...
  public boolean a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      {
        bgmc localbgmc = (bgmc)this.jdField_a_of_type_JavaUtilList.get(i);
        if ((localbgmc != null) && (paramLong >= localbgmc.a) && (paramLong <= localbgmc.b)) {
          bool1 = true;
        }
      }
      else
  ...
  public boolean a(Context paramContext, String paramString, long paramLong)
  {
    if (a(paramLong))
    {
      bghs.a(paramContext, paramString, String.valueOf(paramLong));
      return true;
    }
    return false;
  }
  ...
  {
    boolean bool2 = false;
    if (!bghs.d(paramQQAppInterface, paramString2))
    {
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
        ...
        if (a(((MessageForText.AtTroopMemberInfo)localObject).uin))
        {
          ...
          for (;;)
          {
            ...
            if (str2.equals(((String)this.jdField_c_of_type_JavaUtilList.get(j)).replace("$ROBOTNICK$", str1)))
            {
              ...
              bdla.b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, "dc00899", "Grp_robot", "", "msg", "conti_dialog_msg", 0, 0, paramMessageRecord.frienduin, this.jdField_a_of_type_JavaLangString, (String)this.jdField_c_of_type_JavaUtilList.get(i), "");
              return true;
            }
            j += 1;
          }
    ...
    while (i < this.jdField_b_of_type_JavaUtilList.size())
    {
      ...
      for (localObject = "";; localObject = ((String)localObject).toUpperCase().replaceAll(" ", ""))
      {
        ...
        bdla.b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, "dc00899", "Grp_robot", "", "msg", "keyword_msg", 0, 0, paramMessageRecord.frienduin, this.jdField_a_of_type_JavaLangString, (String)this.jdField_b_of_type_JavaUtilList.get(i), "");
        return true;
      }
      i += 1;
    }
  ...
  public ArrayList<bglr> b(long paramLong)
  {
    ArrayList localArrayList = new ArrayList(0);
    if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap != null) {
      synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
  ...
  public void b(int paramInt, long paramLong1, long paramLong2, String paramString, bgma parambgma)
  {
    cmd0x934.ReqBody localReqBody = new cmd0x934.ReqBody();
    localReqBody.cmd.set(paramInt, true);
    localReqBody.group_id.set(paramLong1, true);
    localReqBody.keyword.set(paramString, true);
    localReqBody.robot_uin.set(paramLong2);
    ntb.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bglt(this, parambgma), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void b(long paramLong1, long paramLong2, String paramString, bgma parambgma)
  {
    b(2, paramLong1, paramLong2, paramString, parambgma);
  }
  
  public void b(long paramLong, String paramString, bgma parambgma)
  {
    b(2, Long.valueOf("1").longValue(), paramLong, paramString, parambgma);
  }
