...
public class afod
  extends Handler
{
  public afod(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        if ((ChatHistoryTroopMemberFragment.b(this.a)) && (ChatHistoryTroopMemberFragment.d(this.a)))
        {
          ...
          paramMessage.obj = this.a.jdField_a_of_type_Afow.a();
          ChatHistoryTroopMemberFragment.a(this.a, paramMessage);
        }
        return;
        this.a.y();
        ...
        {
          if (this.a.jdField_a_of_type_Afow.b != null) {
            this.a.jdField_a_of_type_Afow.b.clear();
          }
        ...
        bbmy.a(this.a.getActivity(), this.a.getString(2131625923), 0).b(this.a.jdField_b_of_type_AndroidViewView.getHeight());
        ChatHistoryTroopMemberFragment.a(this.a);
        return;
        if ((this.a.jdField_c_of_type_AndroidAppDialog != null) && (this.a.jdField_c_of_type_AndroidAppDialog.isShowing())) {
          this.a.jdField_c_of_type_AndroidAppDialog.dismiss();
        }
        bbmy.a(this.a.getActivity(), this.a.getString(2131625922), 0).b(this.a.jdField_b_of_type_AndroidViewView.getHeight());
        return;
      ...
      return;
    } while (this.a.jdField_a_of_type_Afow == null);
    this.a.jdField_a_of_type_Afow.a();
    return;
    ...
    for (this.a.o = "0"; this.a.jdField_a_of_type_Afow != null; this.a.o = "1")
    {
      label1154:
      this.a.jdField_a_of_type_Afow.a();
      return;
