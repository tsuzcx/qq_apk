...
public class bbbd
  extends Handler
{
  public bbbd(AbsPublishActivity paramAbsPublishActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              this.a.requestPermissions(new bbbe(this), 1, new String[] { "android.permission.RECORD_AUDIO" });
              return;
            }
            ...
            if (this.a.q != null)
            {
              ...
              bcht.a(this.a.o, this.a.p, "Clk_record", this.a.q, this.a.jdField_b_of_type_JavaLangString, "", "");
            }
            adky.a(this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, paramMessage, PublicTransFragmentActivity.class, AudioRecordFragment.class, 1003);
            return;
          } while (!this.a.a(4));
          return;
          ...
          this.a.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130843160);
          this.a.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(this.a.getString(2131696718));
          this.a.jdField_a_of_type_AndroidViewViewGroup.setVisibility(8);
          bhoc.b(this.a.jdField_b_of_type_ComTencentMobileqqTribeViewTEditText);
    ...
    if (this.a.jdField_a_of_type_JavaUtilArrayList.size() > 0)
    {
      ...
      paramMessage = this.a.jdField_a_of_type_Bbel;
      if (this.a.jdField_a_of_type_JavaUtilArrayList.size() < 9) {
        bool = true;
      }
    ...
    this.a.jdField_a_of_type_Bbel.a(false, true);
    this.a.jdField_a_of_type_ComTencentMobileqqTroopDataAudioInfo = null;
    this.a.a(0);
