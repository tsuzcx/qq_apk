...
public class awjc
{
  ...
  private akiy jdField_a_of_type_Akiy;
  private akiz jdField_a_of_type_Akiz = new awjd(this);
  ...
  private void a()
  {
    ...
    if (localQQAppInterface != null) {
      localQQAppInterface.removeObserver(this.jdField_a_of_type_Akiz);
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, ChatMessage paramChatMessage)
  {
    ...
    if (this.jdField_a_of_type_Akiy == null) {
      this.jdField_a_of_type_Akiy = ((akiy)paramQQAppInterface.a(152));
    }
    ...
    for (this.c = paramChatMessage.senderuin;; this.c = paramChatMessage.frienduin)
    {
      ...
      paramQQAppInterface.addObserver(this.jdField_a_of_type_Akiz);
      paramQQAppInterface = (ajtk)paramQQAppInterface.a(2);
      if (paramQQAppInterface != null) {
        paramQQAppInterface.a(paramString, this.c, 1, 0L, (byte)1, 0L, 0L, null, "", 8192L, 10004, null, (byte)0);
      }
      try
      {
        this.jdField_a_of_type_Bcpq = new bcpq(paramContext);
        this.jdField_a_of_type_Bcpq.e(17);
        this.jdField_a_of_type_Bcpq.a(null);
        this.jdField_a_of_type_Bcpq.f(2130839144);
        if (this.jdField_a_of_type_Bcpq.getWindow() != null) {
          this.jdField_a_of_type_Bcpq.getWindow().setDimAmount(0.0F);
        }
        this.jdField_a_of_type_Bcpq.setOnDismissListener(new awjg(this));
      ...
      this.jdField_a_of_type_Akiy.a(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, 20, awiu.a(this.jdField_a_of_type_ArrayOfLong), null, null, 0, 0.0D, 0.0D, null, "{ \"search_by_id_only\": 1 }");
      return;
    }
  }
}
