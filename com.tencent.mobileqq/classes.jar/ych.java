...
public class ych
  extends Handler
{
  public ych(SpecailCareListActivity paramSpecailCareListActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      return;
      this.a.jdField_a_of_type_ComTencentWidgetXListView.springBackOverScrollHeaderView();
      QQToast.a(BaseApplication.getContext(), 1, 2131434794, 0).b(this.a.getTitleBarHeight());
      return;
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.c(2131436879);
