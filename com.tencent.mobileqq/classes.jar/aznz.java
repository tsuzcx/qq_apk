...
class aznz
  extends Handler
{
  public aznz(Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    {
      if (azny.a() == null) {
        azny.a(bduw.a(Environment.getExternalStorageDirectory().getPath() + "/tencent/msflogs/" + "com.tencent.mobileqq".replace(".", File.separator) + "/battery/"));
      }
      azny.b(azny.a() + azny.b() + "_" + azny.a() + ".log");
      azny.c(azny.a() + azny.b() + "_" + azny.a() + ".rpt");
      paramMessage = new File(azny.a());
      Object localObject1 = new File(azny.c());
      localObject3 = new File(azny.d());
      try
      {
        ...
        azny.a(new BufferedWriter(new FileWriter((File)localObject1), 8192));
        ((File)localObject3).createNewFile();
        azny.b(new BufferedWriter(new FileWriter((File)localObject3), 8192));
        localObject1 = null;
        ...
        azny.b(new Object[] { "header", localObject3, AppSetting.g(), "pub", localObject1, Build.MANUFACTURER, Build.MODEL, Integer.valueOf(Build.VERSION.SDK_INT), Long.valueOf(azny.a()), "1.3" });
        return;
      }
    ...
    else
    {
      ...
      {
        if (azny.a() == null) {
          azny.a(bduw.a(Environment.getExternalStorageDirectory().getPath() + "/tencent/msflogs/com/tencent/mobileqq/battery/"));
        }
        label830:
        for (;;)
        {
          try
          {
            localObject2 = new File(azny.a()).listFiles();
            ...
            try
            {
              long l = azny.a((File)localObject3);
