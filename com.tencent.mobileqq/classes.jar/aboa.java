  ...
  extends abnx
{
  ...
  public aboa(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
    super(paramQQAppInterface, paramMessageHandler);
    this.jdField_a_of_type_JavaUtilComparator = new aboc(this);
  }
  ...
  private boolean c(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord instanceof MessageForArkApp))
    {
      ...
      {
        bool1 = bool2;
        if (anhp.a(paramMessageRecord.ark_app_message.appName)) {
          bool1 = true;
        }
      }
    }
  ...
  protected TroopMemberInfo a(msg_comm.Msg paramMsg, ArrayList<MessageRecord> paramArrayList, ayvz paramayvz, boolean paramBoolean, bbku parambbku)
  {
    long l5;
    Object localObject7;
    long l6;
    ...
    try
    {
      ...
      if ((paramayvz == null) || (paramMsg == null) || (paramArrayList == null)) {
        break label8064;
      }
      ...
      if (paramayvz.c == 1026)
      {
        l3 = bdal.a(((msg_comm.MsgHead)localObject7).msg_seq.get());
        l2 = bdal.a(((msg_comm.MsgHead)localObject7).msg_time.get());
      }
      ...
      localObject2 = ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, String.valueOf(l6), String.valueOf(l6));
    ...
    {
      ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, (List)localObject3, paramMsg, paramayvz.e, l2, false);
      localObject2 = null;
      l1 = 0L;
    }
    label284:
    ...
    for (;;)
    {
      ...
      if ((((List)localObject3).size() == 0) && (k > 1))
      {
        ...
        localObject4 = (MessageForText)ayvw.a(-1000);
      ...
      if (localIterator.hasNext())
      {
        ...
        localMessageRecord.istroop = paramayvz.c;
        localMessageRecord.senderuin = String.valueOf(l6);
        localMessageRecord.frienduin = String.valueOf(paramayvz.e);
        ...
        if (((msg_comm.MsgHead)localObject7).msg_flag.has())
        {
          ...
          if ((((msg_comm.MsgHead)localObject7).msg_flag.get() & 1L) == 1L)
          {
            ...
            {
              b2 = 1;
              localbbku.c.a(l3, localMessageRecord.uniseq);
              b1 = b2;
              if (QLog.isColorLevel())
              {
        ...
        if ((localMessageRecord.istroop == 1) && (bdsn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(localMessageRecord.msg, localMessageRecord.frienduin))) {
          localbbku.b.a(l3, localMessageRecord.uniseq);
        }
        if (((localMessageRecord instanceof MessageForTroopConfess)) && (((MessageForTroopConfess)localMessageRecord).isToSelf)) {
          localbbku.d.a(l3, localMessageRecord.uniseq);
        }
        if (a(localMessageRecord)) {
          localbbku.g.a(l3, localMessageRecord.uniseq);
        }
        if (b(localMessageRecord)) {
          localbbku.s.a(l3, localMessageRecord.uniseq);
        }
        if (c(localMessageRecord)) {
          localbbku.w.a(l3, localMessageRecord.uniseq);
        }
        Object localObject9;
        if (((paramayvz.c == 1) || (paramayvz.c == 1026)) && (localObject2 != null))
        {
          ...
          for (;;)
          {
            if (((Iterator)localObject4).hasNext())
            {
              ...
              if ((((im_msg_body.Elem)localObject6).general_flags.has()) && (((im_msg_body.Elem)localObject6).general_flags.bytes_pb_reserve.has()))
              {
                ...
                {
                  localbbku.x.a(l3, localMessageRecord.uniseq);
                  if (QLog.isColorLevel())
                  {
                    ...
                    l1 = ayvy.a(((im_msg_body.Attr)((im_msg_body.RichText)localObject4).attr.get()).random.get());
                    localObject2 = ((im_msg_body.RichText)localObject4).elems.get();
                    if (((im_msg_body.RichText)localObject4).ptt.has())
                    {
                      ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, (List)localObject3);
                      break;
                    }
                    localbbku.jdField_a_of_type_JavaLangString = String.valueOf(paramayvz.e);
                    localbbku.jdField_a_of_type_Int = paramayvz.c;
                    ayvu.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, (List)localObject3, paramMsg, false, false, localbbku);
                    break;
                  }
                }
              }
        ...
        if (localMessageRecord.msgtype == -1049)
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(((MessageForReplyText)localObject4).mSourceMsgInfo.mSourceMsgSenderUin + ""))) {
            localbbku.l.a(l3, localMessageRecord.uniseq);
          }
        }
        if (localMessageRecord.msgtype == -5015) {
          localbbku.v.a(l3, localMessageRecord.uniseq);
        }
        if (localMessageRecord.msgtype == -2058) {
          EmojiStickerManager.a(localMessageRecord, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        }
        if (((localMessageRecord.msgtype != -2058) || (parambbku.t.a != -1L) || (parambbku.t.b != -1L)) || (localMessageRecord.msgtype == -1035))
        {
        ...
        if ((localMessageRecord.msgtype == -2035) || (localMessageRecord.msgtype == -2038))
        {
          ...
          localObject6 = bdbt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageForDeliverGiftTips)localObject4).istroop, ((MessageForDeliverGiftTips)localObject4).frienduin, ((MessageForDeliverGiftTips)localObject4).senderuin);
          ...
          if (!((MessageForDeliverGiftTips)localObject4).isFromNearby)
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject6))
            {
              ...
              localbbku.h.a(l3, localMessageRecord.uniseq);
            }
            localObject6 = (bcfr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(223);
            if (localObject6 != null) {
              ((bcfr)localObject6).b((MessageForDeliverGiftTips)localObject4);
            }
          }
        }
        if (auqm.a(localMessageRecord))
        {
        ...
        {
          localObject4 = azqu.a(localMessageRecord.msgData);
          if ((localObject4 instanceof StructMsgForGeneralShare))
          {
            ...
            localObject9 = new abnu(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            localObject6 = ((abnu)localObject9).jdField_a_of_type_Amjk;
            localObject9 = ((abnu)localObject9).jdField_a_of_type_JavaUtilMap;
            localObject6 = ((amjk)localObject6).a((String)localObject4, 1);
            TroopManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord.frienduin, StructMsgForGeneralShare.eventId, localMessageRecord.shmsgseq, new abob(this, false, localbbku, l3, l8, (RecentUser)localObject6, (String)localObject4, localMessageRecord, (Map)localObject9));
          }
        }
        if ((localMessageRecord instanceof MessageForTroopFile)) {
          localbbku.n.a(l3, localMessageRecord.uniseq);
        }
        if (bcic.a(localMessageRecord)) {
          localbbku.j.a(l3, localMessageRecord.uniseq);
        }
        if ((localMessageRecord.msgtype == -5008) && ((localMessageRecord instanceof MessageForArkApp)))
        {
          ...
          if ((((MessageForArkApp)localObject4).ark_app_message != null) && (((MessageForArkApp)localObject4).ark_app_message.appName.equals("com.tencent.mannounce"))) {
            localbbku.q.a(l3, localMessageRecord.uniseq);
          }
        }
        ...
        if (localMessageRecord.msgtype == -2039)
        {
          ...
          localObject10 = (akji)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
          localObject4 = null;
          if (QLog.isColorLevel()) {
          ...
          {
            localObject11 = ((akji)localObject10).b(((MessageForApollo)localObject6).senderuin);
            if (QLog.isColorLevel()) {
          ...
          {
            localObject11 = ((akji)localObject10).b(((MessageForApollo)localObject6).mApolloMessage.peer_uin + "");
            if (QLog.isColorLevel()) {
          ...
          if (((ArrayList)localObject9).size() > 0) {
            ((akji)localObject10).b((List)localObject9);
          }
          if (QLog.isColorLevel()) {
          ...
          {
            i1 = ((akji)localObject10).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
            localObject4 = "";
        ...
        for (;;)
        {
          ...
          VipUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "cmshow", "Apollo", "rev_action", String.valueOf(localMessageRecord.senderuin), n, ((MessageForApollo)localObject6).msgType, new String[] { localObject4, Integer.toString(i1), Integer.toString(akji.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)), String.valueOf(System.currentTimeMillis() / 1000L) });
          if (parambbku != null)
          {
            if (localbbku.f.a != -1L) {
              localbbku.f.b = localMessageRecord.uniseq;
            }
            if (localbbku.jdField_a_of_type_Bbkv.a != -1L) {
              localbbku.jdField_a_of_type_Bbkv.b = localMessageRecord.uniseq;
            }
            if ((l3 > this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(String.valueOf(paramayvz.e), paramayvz.c)) && (localbbku.a()))
            {
              parambbku.a(localbbku);
              localMessageRecord.mMessageInfo = localbbku;
            }
          }
          if (((paramayvz.c != 1) && (paramayvz.c != 1026) && (paramayvz.c != 3000)) || (localObject2 == null) || (TextUtils.equals(localMessageRecord.selfuin, localMessageRecord.senderuin))) {
            break label3777;
          }
          i = 0;
          localObject4 = ((List)localObject2).iterator();
          ...
          localbbku.i.a(l3, localMessageRecord.uniseq);
          break;
          ...
          localbbku.i.a(l3, localMessageRecord.uniseq);
          break label1754;
          if ((localObject4 != null) && (((StructMsgForGeneralShare)localObject4).mMsgServiceID == 19) && (!((StructMsgForGeneralShare)localObject4).mMsgBrief.startsWith(alpo.a(2131701394))) && (!((StructMsgForGeneralShare)localObject4).mMsgBrief.equals(alpo.a(2131701388))))
          {
            localbbku.o.a(l3, localMessageRecord.uniseq);
            break label1911;
          }
          if ((localObject4 != null) && (((StructMsgForGeneralShare)localObject4).mMsgServiceID == 106))
          {
            ...
            localbbku.jdField_a_of_type_Bbkv.a(l3, localMessageRecord.uniseq);
            break label1911;
          }
          if ((localObject4 == null) || (((StructMsgForGeneralShare)localObject4).mMsgServiceID != 107)) {
            break label1911;
          }
          localbbku.u.a(l3, localMessageRecord.uniseq);
          break label1911;
        ...
        else
        {
          ...
          if (localObject2 != null)
          {
            ...
            localObject9 = bcie.a(((im_msg_body.Elem)localObject9).group_business_msg);
            bcid.a(localMessageRecord, (bcie)localObject9);
            ...
            {
              azmj.b((QQAppInterface)localObject10, "P_CliOper", "Grp_AIO", "", "five_m", "revice_msg", 0, 0, (String)localObject3, localMessageRecord.msgtype + "", ((bcie)localObject9).c, "");
              localObject3 = localObject5;
              if (!QLog.isColorLevel()) {
                break;
              }
      ...
      else
      {
        ...
        i1 = -100;
        i5 = -100;
        if ((paramayvz.c == 1) || (paramayvz.c == 1026))
        {
          double d = -100.0D;
          i = -1;
                  ...
                  case 1: 
                    ...
                    do
                    {
                      ...
                      if (((im_msg_body.Elem)localObject6).general_flags.bytes_pb_reserve.has())
                      {
                        ...
                        parambbku.mergeFrom(((im_msg_body.Elem)localObject6).general_flags.bytes_pb_reserve.get().toByteArray());
                        if (parambbku.uint32_rich_card_name_ver.has()) {
                          parambbku.uint32_rich_card_name_ver.get();
                        }
                        if (!parambbku.uint32_nearby_charm_level.has()) {
                          break label8229;
                        }
                        i2 = parambbku.uint32_nearby_charm_level.get();
                        if (!parambbku.uint32_global_group_level.has()) {
                          break label8236;
                        }
                        i6 = parambbku.uint32_global_group_level.get();
                        if (!parambbku.uint32_vip_type.has()) {
                          break label8243;
                        }
                        i1 = parambbku.uint32_vip_type.get();
                        if (!parambbku.uint32_vip_level.has()) {
                          break label8249;
                        }
                        i5 = parambbku.uint32_vip_level.get();
                        i7 = VipUtils.c(i5);
                        if (parambbku.uint32_user_bigclub_flag.has()) {
                          j = parambbku.uint32_user_bigclub_flag.get();
                        }
                        if (parambbku.uint32_user_bigclub_level.has()) {
                          k = parambbku.uint32_user_bigclub_level.get();
                        }
                        if (parambbku.uint32_nameplate.has()) {
                          m = parambbku.uint32_nameplate.get();
                        }
                        if (parambbku.uint32_req_is_bigclub_hidden.has()) {
                          n = parambbku.uint32_req_is_bigclub_hidden.get();
                        }
                        i8 = n;
                        i5 = j;
                        if (j != 0)
                        {
                          i8 = n;
                          i5 = j;
                          if (parambbku.uint32_nameplate_vip_type.has())
                          {
                            i8 = n;
                            i5 = j;
                            if (parambbku.uint32_gray_name_plate.has())
                            {
                              i5 = parambbku.uint32_nameplate_vip_type.get();
                              localObject7 = bdko.a(i5);
                              if ((!bdkn.a(i5)) || (((bdko)localObject7).b())) {
                                break label8255;
                              }
                              i5 = 1;
                              if ((parambbku.uint32_gray_name_plate.get() != 0) || (i5 != 0)) {
                                break label8113;
                              }
                              i8 = n;
                              i5 = j;
                        ...
                        i9 = i;
                        if (parambbku.uint32_title_id.has())
                        {
                          j = parambbku.uint32_title_id.get();
                          if (j > 0) {
                            i = j;
                          }
                          i9 = i;
                        ...
                        if ((paramayvz.c == 1) && (parambbku.uint32_group_member_flag_ex2.has()))
                        {
                          i = parambbku.uint32_group_member_flag_ex2.get();
                          amez.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l1, i);
                        }
                        if ((paramayvz.c == 1) && (parambbku.uint32_group_ringtone_id.has()) && (parambbku.uint32_group_ringtone_id.get() > 0))
                        {
                          i = parambbku.uint32_group_ringtone_id.get();
                          amez.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l1, i);
                        }
                        ...
                        if ((paramayvz.c == 1) && (parambbku.uint32_custom_featureid.has()) && (localObject7 != null) && (parambbku.uint32_custom_featureid.get() == 19713))
                        {
                          if (QLog.isColorLevel()) {
                        ...
                        if (!parambbku.bytes_hudong_mark.has()) {
                          break label8261;
                        }
                        parambbku = parambbku.bytes_hudong_mark.get().toByteArray();
                        parambbku = bcbx.a(parambbku);
                        ((bcbt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(346)).a(String.valueOf(l1), String.valueOf(l6), parambbku);
                        i2 = i7;
                        i6 = k;
                        i7 = m;
                      }
                      ...
                      localObject7 = ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).b(parambbku);
                      if (localObject7 == null) {
                        break label8119;
                      }
                      l8 = ((im_msg_body.Elem)localObject6).general_flags.uint64_group_rank_seq.get();
                      if (QLog.isColorLevel()) {
                        QLog.d("Q.getTroopMemberLevelInfo", 2, "onNewMsg: troopUin=" + parambbku + ", serverRankSeq=" + l8 + ", localRankSeq=" + ((TroopInfo)localObject7).dwGroupLevelSeq + ", isSyncMsgFinish=" + bool1);
                      }
                      if (l8 <= ((TroopInfo)localObject7).dwGroupLevelSeq) {
                        break label8119;
                      }
                      ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).c(parambbku, false);
                      break label8119;
                      bool5 = bool1;
                    ...
                    if (((im_msg_body.Elem)localObject6).general_flags.uint32_to_uin_flag.get() == 2)
                    {
                      ...
                      if (QLog.isColorLevel())
                      {
                        QLog.d("Q.getTroopMemberLevelInfo", 2, "onNewMsg: troopUin=" + parambbku + ", isSyncMsgFinish=" + bool1);
                        break label8119;
                        if ((((im_msg_body.Elem)localObject6).extra_info.has()) && (((im_msg_body.Elem)localObject6).extra_info.uint32_flags.has()))
                        {
                          ...
                          if (bool1)
                          {
                            ...
                            parambbku = ((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(60)).a(l1 + "");
                            localObject6 = l6 + "";
                            if ((parambbku == null) || (parambbku.adminUins.contains(localObject6))) {
                              break label8273;
                            }
                            parambbku.adminUins.add(localObject6);
                            break label8273;
                          }
                        }
                        else if (((im_msg_body.Elem)localObject6).pub_group.has())
                        {
                          ...
                          if (QLog.isColorLevel())
                          {
                            ...
                            parambbku = ((im_msg_body.PubGroup)((im_msg_body.Elem)localObject6).pub_group.get()).bytes_nickname.get().toStringUtf8();
                            label6345:
                            QLog.d("Q.msg.BaseMessageProcessorForTroopAndDisc", 2, "decodeSinglePbMsg_GroupDis,receive  pub_group,bytes_nickname = " + parambbku);
                            i4 = k;
                            i5 = j;
                            i6 = i1;
                            i7 = 1;
                          ...
                          if (((im_msg_body.Elem)localObject6).elem_flags2.has())
                          {
                            ...
                            if (((im_msg_body.ElemFlags2)((im_msg_body.Elem)localObject6).elem_flags2.get()).uint32_longtitude.has())
                            {
                              ...
                              if (((im_msg_body.ElemFlags2)((im_msg_body.Elem)localObject6).elem_flags2.get()).uint32_latitude.has())
                              {
                                ...
                                label6677:
                                parambbku = String.valueOf(l1);
                                paramayvz = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                                localObject2 = paramayvz.b(parambbku);
                                if (QLog.isColorLevel()) {
                                ...
                                if ((!bool1) && (localObject2 == null))
                                {
                                  ...
                                  ((TroopInfo)localObject2).troopuin = parambbku;
                                  paramayvz.b((TroopInfo)localObject2);
                                  ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).j(parambbku);
                                }
                                localObject2 = String.valueOf(l6);
                                i3 = ((msg_comm.GroupInfo)localObject5).group_level.get();
                                localObject6 = bdnm.a(((msg_comm.GroupInfo)localObject5).group_card.get());
                                ...
                                paramayvz = paramArrayList.iterator();
                                while (paramayvz.hasNext()) {
                                  ((MessageRecord)paramayvz.next()).isOpenTroopMessage = true;
                                }
                                paramayvz = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                                if ((paramayvz == null) || (paramayvz.f(parambbku))) {
                                  break label8359;
                                }
                                paramayvz = (alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
                                if (paramayvz == null) {
                                  break label8359;
                                }
                                paramayvz.f(parambbku, false);
                                break label8359;
                                label7020:
                                if (i2 != -100)
                                {
                                  paramayvz = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                                  if (paramayvz != null) {
                                    paramayvz.a(parambbku, (String)localObject2, i2);
                                  }
                                }
                                if (paramBoolean) {
                                  paramayvz = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                                ...
                                {
                                case 1: 
                                  paramayvz.a(parambbku, (String)localObject2, (String)localObject6, i, null, null, 0, 1, 100, l3, b2, 0L, d, null, -100, j, k, m, n, i1, i5);
                                case 2: 
                                  for (;;)
                                  {
                                    label7096:
                                    paramayvz.a(parambbku, (String)localObject2, (String)localObject3);
                                    paramayvz = null;
                                    label7149:
                                    ...
                                    localObject2 = (bcic)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(132);
                                    if (((bcic)localObject2).a(parambbku)) {
                                      break label8400;
                                    }
                                    if (!((bcic)localObject2).b(parambbku)) {
                                      break label7595;
                                    }
                                    ...
                                    i2 = i;
                                    if (!bcic.a((MessageRecord)localObject3)) {
                                      break label8393;
                                    }
                                    ...
                                    paramayvz.a(parambbku, (String)localObject2, (String)localObject6, i, null, null, 0, 1, 100, l3, b2, 0L, d, null, -100, j, k, m, n, i1, i5);
                                    continue;
                                    paramayvz.a(parambbku, (String)localObject2, "", i, (String)localObject6, null, 0, 1, 100, l3, b2, 0L, d, null, -100, j, k, m, n, i1, i5);
                                  }
                                  paramayvz = new TroopMemberInfo();
                                  paramayvz.troopuin = parambbku;
                                  paramayvz.memberuin = ((String)localObject2);
                                  switch (i6)
                                  {
                                  case 2: 
                                    label7400:
                                    localObject3 = bdnm.b((String)localObject6);
                                    paramayvz.troopColorNick = ((String)localObject6);
                                    paramayvz.troopnick = ((String)localObject3);
                                    for (;;)
                                    {
                                      paramayvz.level = i;
                                      paramayvz.realLevel = i3;
                                      paramayvz.sex = 1;
                                      paramayvz.age = 0;
                                      paramayvz.distance = 100;
                                      paramayvz.msgseq = l3;
                                      if (b2 != 1) {
                                        break label8387;
                                      }
                                      paramBoolean = true;
                                      label7462:
                                      paramayvz.isTroopFollowed = paramBoolean;
                                      paramayvz.distanceToSelf = d;
                                      paramayvz.distanceToSelfUpdateTimeStamp = System.currentTimeMillis();
                                      break;
                                      paramayvz.troopnick = "";
                                      paramayvz.friendnick = ((String)localObject6);
                                    }
                                    i2 = i;
                                    if (i == 0)
                                    {
                                      ((bcic)localObject2).a(parambbku, ((MessageRecord)localObject3).uniseq);
                                      i2 = 1;
                                    }
                                    if (QLog.isColorLevel()) {
                                      QLog.d("TroopBindPublicAccountMgr.redDot", 2, "decodePBAccountMSg:" + parambbku + "," + ((MessageRecord)localObject3).uniseq + "," + ((MessageRecord)localObject3).shmsgseq);
                                    }
                                    ((bcic)localObject2).c(parambbku);
                                    break label8393;
                                    label7595:
                                    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b(parambbku) != 3) {
                                      break label8400;
                                    }
                                    if (QLog.isColorLevel()) {
                                      QLog.d(".troop.closeRcvMsgTmp", 2, "Shield troop recv msg:" + parambbku);
                                    }
                                    ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(parambbku, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 0, 0);
                                    break label8400;
                                  }
                                  break;
                                }
    ...
    for (;;)
    {
      ...
      while (paramMsg.hasNext())
      {
        ...
        Object localObject1;
        paramArrayList.vipBubbleID = alxl.a((int)localObject1, i);
      ...
      bhof.a().g(System.currentTimeMillis() - l5);
      return paramayvz;
      label8020:
      label8027:
      label8030:
  ...
  protected void a(MessageRecord paramMessageRecord)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramMessageRecord))
    {
      ...
      if (abot.q(paramMessageRecord.msgtype))
      {
        ...
        localalsj.b = 1000;
        localalsj.c = 0;
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().notifyUI(5006, true, new Object[] { Long.valueOf(paramMessageRecord.uniseq), localalsj });
      }
    }
  }
}
