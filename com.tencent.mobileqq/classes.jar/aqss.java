...
public class aqss
{
  ...
  public static int a()
  {
    int j = amvg.a().jdField_b_of_type_Int;
    int i = j;
    if (j == 0) {
  ...
  public static String a()
  {
    String str2 = amvg.a().jdField_a_of_type_JavaLangString;
    String str1 = str2;
  ...
  {
    biby.a();
    biby.a().b(paramWadlParams);
  }
  
  public static boolean a()
  {
    amvf localamvf = amvg.a();
    if ((localamvf != null) && (localamvf.jdField_a_of_type_Int > 0))
    {
      if (QLog.isColorLevel()) {
  ...
  {
    boolean bool2 = false;
    Object localObject = amvg.a();
    boolean bool1 = bool2;
    if (localObject != null)
    {
      bool1 = bool2;
      if (((amvf)localObject).c > 0)
      {
        localObject = ((amvf)localObject).jdField_a_of_type_JavaLangString;
        bool1 = bool2;
        if (!TextUtils.isEmpty((CharSequence)localObject))
        {
          bool1 = bool2;
          if (bfng.a((String)localObject)) {
            bool1 = true;
          }
        }
      }
