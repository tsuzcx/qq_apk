...
class ubs
  implements azrg
{
  ubs(ubr paramubr, MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface, aocj paramaocj, boolean paramBoolean) {}
  ...
  public void b(azrh paramazrh)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForStructing))
        {
          ...
          localObject1 = bcrw.a(localMessageForStructing);
          if (localObject1 == null) {
            break label283;
          }
          localObject2 = ((im_msg_body.RichText)localObject1).elems.get();
          if (QLog.isColorLevel()) {
            QLog.d("ShareStructLongMessageManager", 2, "current uid is" + paramazrh.c);
          }
          ...
          {
            ((im_msg_body.Elem)localObject3).rich_msg.bytes_msg_resid.set(ByteStringMicro.copyFrom(paramazrh.c.getBytes()));
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("ShareStructLongMessageManager", 2, "upload  msg pack failed, catch exception", paramazrh);
        }
        this.jdField_a_of_type_Ubr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
      }
    ...
    {
      label283:
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, this.jdField_a_of_type_Aocj, this.jdField_a_of_type_Boolean);
      return;
      label306:
      ...
      if ((localObject1 != null) && (ubr.b(localMessageForStructing.structingMsg)))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          {
            ((im_msg_body.Elem)localObject2).rich_msg.bytes_msg_resid.set(ByteStringMicro.copyFrom(paramazrh.c.getBytes()));
    ...
    label541:
    if (QLog.isColorLevel()) {
      QLog.d("ShareStructLongMessageManager", 2, "upload  msg pack failed, result.errStr=" + paramazrh.b + ",result.errStr=" + paramazrh.jdField_a_of_type_JavaLangString);
    }
    this.jdField_a_of_type_Ubr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
  }
}
