...
class aong
  extends QIPCModule
{
  public aong(aonf paramaonf, String paramString)
  {
    super(paramString);
  }
  ...
  {
    bcds.c("WeiyunDownloadServiceIPC", "onCall action|" + paramString + " params|" + paramBundle + " callbackId|" + paramInt);
    Object localObject;
    ...
    if (paramBundle == null)
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        aonf.a = (String)localObject;
      }
      if (!TextUtils.isEmpty(paramString))
      {
        localQQAppInterface = aonf.a(this.a);
        if (localQQAppInterface != null) {
          break label103;
        }
        bcds.c("WeiyunDownloadServiceIPC", "onCall action but appInterface is null");
      }
    }
    label103:
    do
    {
      do
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          bcds.c("WeiyunDownloadServiceIPC", "onCall action but file_id is null");
          return null;
        }
      ...
      localObject = apck.a(paramBundle);
      ...
      aonf.a(this.a).put(paramString, Long.valueOf(((FileManagerEntity)localObject).nSessionId));
      if (apck.b(((FileManagerEntity)localObject).getFilePath()))
      {
        ...
        QIPCServerHelper.getInstance().callClient(aonf.a, "Module_WeiyunDownloadClient", "WeiyunDownloadClientIPC_Action__Suc", paramString, null);
        paramString = new Bundle();
        paramString.putString("taskId", ((FileManagerEntity)localObject).miniAppDownloadId);
        paramString.putInt("retCode", 1);
        paramString.putString("retMsg", "");
        QIPCServerHelper.getInstance().callClient(aonf.a, "Module_WeiyunDownloadClient", "WeiyunDownloadClientIPC_Action__Complete", paramString, null);
        return null;
      }
    ...
    localQQAppInterface.a().a(((Long)aonf.a(this.a).get(paramString)).longValue());
    return null;
  }
}
