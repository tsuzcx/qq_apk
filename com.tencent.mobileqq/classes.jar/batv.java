public class batv
{
  ...
  {
    return bauj.a(paramString1, paramLong, paramInt1, paramBoolean, paramString2, paramString3, paramString4, paramString5, paramString6, paramString7, paramString8, paramInt2, paramInt3);
  }
          ...
          catch (Exception localException3)
          {
            try
            {
              for (;;)
              {
                ...
                {
                  localObject = new bard();
                  ((bard)localObject).a(paramString);
