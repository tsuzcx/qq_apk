...
public class gg
  extends Observable
{
  private static gg jdField_a_of_type_Gg;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  public HandlerThread a;
  private ETEngine jdField_a_of_type_ComEtrumpMixlayoutETEngine;
  private EIPCResultCallback jdField_a_of_type_EipcEIPCResultCallback = new gh(this);
  private ConcurrentHashMap<Integer, gb> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private ETEngine jdField_b_of_type_ComEtrumpMixlayoutETEngine;
  private EIPCResultCallback jdField_b_of_type_EipcEIPCResultCallback = new gi(this);
  ...
  public static gg a()
  {
    try
    {
      if (jdField_a_of_type_Gg == null) {
        jdField_a_of_type_Gg = new gg();
      }
      gg localgg = jdField_a_of_type_Gg;
      return localgg;
    }
    finally {}
  }
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    //   8: iconst_1
    //   9: iload_1
    //   10: invokespecial 132	gg:a	(IZ)Z
    //   13: ifeq +77 -> 90
    //   16: aload_0
    //   17: invokestatic 137	com/etrump/mixlayout/ETEngine:getInstance	()Lcom/etrump/mixlayout/ETEngine;
    //   20: putfield 139	gg:jdField_a_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   23: aload_0
    //   24: invokestatic 142	com/etrump/mixlayout/ETEngine:getInstanceForAnimation	()Lcom/etrump/mixlayout/ETEngine;
    //   27: putfield 144	gg:jdField_b_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    ...
    //   39: istore_2
    //   40: aload_0
    //   41: getfield 139	gg:jdField_a_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   44: iconst_5
    //   45: ldc 151
    ...
    //   56: ifeq +22 -> 78
    //   59: aload_0
    //   60: getfield 144	gg:jdField_b_of_type_ComEtrumpMixlayoutETEngine	Lcom/etrump/mixlayout/ETEngine;
    //   63: iconst_3
    //   64: ldc 156
    ...
    //   79: istore_2
    //   80: aload_0
    //   81: getfield 27	gg:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   84: iload_1
  ...
  {
    int i = 1;
    gb localgb = (gb)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt1));
    boolean bool;
    if (localgb == null)
    {
      bool = gc.a(paramInt1, paramInt2);
      localObject = gc.a(paramInt1, paramInt2);
      if (!bool)
      {
        Bundle localBundle = new Bundle();
        localBundle.putInt("id", paramInt1);
        localBundle.putInt("font_type", paramInt2);
        QIPCClientHelper.getInstance().callServer("VasFontIPCModule", gm.c, localBundle, this.jdField_a_of_type_EipcEIPCResultCallback);
      }
      switch (paramInt2)
      {
      }
    ...
    do
    {
      do
      {
        ...
        while (i != 0)
        {
          localObject = new gb(paramInt1, paramInt2, (String)localObject);
          this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt1), localObject);
          return localObject;
          i = 0;
        }
      } while (!bool);
      localgb = new gb(paramInt1, paramInt2, (String)localObject);
      localgb.a = Typeface.createFromFile((String)localObject);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt1), localgb);
      return localgb;
    ...
    Object localObject = new gb(paramInt1, 4, (String)localObject);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt1), localObject);
    return localObject;
  }
}
