  ...
  extends BaseAdapter
{
  ...
  private svn(JobSelectionActivity paramJobSelectionActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivityJobSelectionActivity.getLayoutInflater().inflate(2130970368, paramViewGroup, false);
      paramView = new svo(null);
      ...
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131362754));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131370251));
      localView.setTag(paramView);
    }
    paramView = (svo)localView.getTag();
    int i = paramInt;
    if (!JobSelectionActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityJobSelectionActivity)) {
      i = paramInt + 1;
    }
