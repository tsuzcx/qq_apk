...
public class svn
{
  private static String jdField_a_of_type_JavaLangString = bigv.a(Environment.getExternalStorageDirectory().getAbsolutePath() + "/tencent/MobileQQ/pddata/" + "proteus/");
  ...
  public svn(String paramString1, String paramString2)
  {
  ...
  private File a(String paramString1, String paramString2)
  {
    ...
    //   36: aload_0
    //   37: invokespecial 68	svn:a	()Ljava/lang/String;
    ...
    //   65: invokestatic 81	svq:a	(Ljava/io/File;)Z
    //   68: pop
    //   69: aload 6
    ...
    //   125: aload_1
    //   126: aload_3
    //   127: invokestatic 115	svq:a	(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    //   130: pop2
    //   131: aload_1
    //   132: invokestatic 118	svq:a	(Ljava/io/Closeable;)V
    //   135: aload_3
    //   136: invokestatic 118	svq:a	(Ljava/io/Closeable;)V
    //   139: aload 6
    //   141: areturn
    //   142: astore 6
    //   144: aconst_null
    ...
    //   181: aload_1
    //   182: invokestatic 118	svq:a	(Ljava/io/Closeable;)V
    //   185: aload_3
    //   186: invokestatic 118	svq:a	(Ljava/io/Closeable;)V
    //   189: aconst_null
    //   190: areturn
    //   191: astore_1
    //   192: aconst_null
    ...
    //   196: astore_3
    //   197: aload 5
    //   199: invokestatic 118	svq:a	(Ljava/io/Closeable;)V
    //   202: aload_3
    //   203: invokestatic 118	svq:a	(Ljava/io/Closeable;)V
    //   206: aload_1
    //   207: athrow
    //   208: astore_1
    //   209: aconst_null
  ...
  private String a()
  {
    return jdField_a_of_type_JavaLangString + ozs.a() + "/" + this.c + "/" + "styles";
  }
  
  private boolean a()
  {
    if (this.d == null) {}
    while (!this.d.equals(ozs.a())) {
      return true;
    }
    return false;
  }
  ...
  public svo a(boolean paramBoolean)
  {
    Object localObject3;
    Object localObject1;
    if ((paramBoolean) && (this.jdField_a_of_type_Boolean) && (!a()))
    {
      localObject3 = svo.a(this.jdField_b_of_type_JavaLangString, false);
    ...
    {
      this.d = ozs.a();
      localObject1 = new svo();
      ((svo)localObject1).a(svf.a());
      ((svo)localObject1).b(this.jdField_b_of_type_JavaLangString);
      ((svo)localObject1).a(3);
      l = System.currentTimeMillis();
      for (;;)
      {
        try
        {
          localObject3 = new svk(a());
          localObject4 = ((svi)localObject3).a();
        ...
        catch (OutOfMemoryError localOutOfMemoryError)
        {
          ...
          svo localsvo = null;
          return localsvo;
          Object localObject5 = svr.a((InputStream)localObject5);
          a(localsvo, new JSONObject((String)localObject5), false);
        ...
        if (localIterator.hasNext())
        {
          ...
          try
          {
            ...
            localObject5 = ((svi)localObject3).a((String)localObject4);
  ...
  public void a(svo paramsvo, JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramsvo.a(str1, str2, (String)localJSONObject.keys().next());
      localProteusParser.createViewTemplate(paramsvo, localJSONObject, null);
