...
{
  public static int a;
  private static bdqe jdField_a_of_type_Bdqe;
  ...
  private void a()
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        try
        {
          this.jdField_a_of_type_JavaLangObject = bdqk.a("android.telephony.MSimTelephonyManager", "getDefault", null, null);
          this.jdField_b_of_type_JavaLangObject = bdqk.a("android.telephony.MSimSmsManager", "getDefault", null, null);
          return;
        }
        ...
        try
        {
          this.jdField_a_of_type_ArrayOfT[0] = u.a(bdql.a("isms"));
          this.jdField_a_of_type_ArrayOfT[1] = u.a(bdql.a("isms2"));
          if (this.jdField_a_of_type_ArrayOfAndroidTelephonyTelephonyManager == null)
          {
            ...
            this.jdField_a_of_type_ArrayOfAndroidTelephonyTelephonyManager[0] = ((TelephonyManager)bdqk.a("android.telephony.TelephonyManager", "getDefault"));
            this.jdField_a_of_type_ArrayOfAndroidTelephonyTelephonyManager[1] = ((TelephonyManager)bdqk.a("android.telephony.TelephonyManager", "getSecondary"));
            return;
          }
        }
  ...
  public int a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramInt = ((Integer)bdqk.a(this.jdField_a_of_type_JavaLangObject, "getSimState", new Object[] { Integer.valueOf(paramInt) })).intValue();
        return paramInt;
      }
      catch (Exception localException1)
      {
      ...
      try
      {
        ...
        {
          paramInt = ((Integer)bdqk.a(localObject, "getIccState", new Object[] { Integer.valueOf(paramInt) })).intValue();
          return paramInt;
        }
      }
      catch (Exception localException2)
