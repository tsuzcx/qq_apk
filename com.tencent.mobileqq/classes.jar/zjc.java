...
{
  static final String jdField_a_of_type_JavaLangString = wjz.a("StoryGroupSvc.do_group_video_forward");
  public int a;
  public Handler a;
  anqd jdField_a_of_type_Anqd = new zje(this);
  public QQAppInterface a;
  public MessageForTroopStory a;
  nit jdField_a_of_type_Nit = new zjd(this);
  protected boolean a;
  public int b;
  public String b;
  public int c;
  ...
  private zjc(QQAppInterface paramQQAppInterface, Bundle paramBundle, SessionInfo paramSessionInfo)
  {
  ...
  private zjc(QQAppInterface paramQQAppInterface, MessageForTroopStory paramMessageForTroopStory)
  {
  ...
  public static zjc a(QQAppInterface paramQQAppInterface, Bundle paramBundle, SessionInfo paramSessionInfo)
  {
    try
    {
      paramQQAppInterface = new zjc(paramQQAppInterface, paramBundle, paramSessionInfo);
  ...
  public static zjc a(QQAppInterface paramQQAppInterface, MessageForTroopStory paramMessageForTroopStory)
  {
    return new zjc(paramQQAppInterface, paramMessageForTroopStory);
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        nir.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Nit, localReqGroupVideoForward.toByteArray(), jdField_a_of_type_JavaLangString);
        return;
      }
  ...
  public void c()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopStory, this.jdField_a_of_type_Anqd);
  }
