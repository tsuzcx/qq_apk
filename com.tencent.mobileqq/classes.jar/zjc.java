...
public class zjc
{
  ...
  private static final Property<ImageView, Matrix> jdField_a_of_type_AndroidUtilProperty = new zjg(Matrix.class, "animatedTransform");
  ...
  private zjb jdField_a_of_type_Zjb;
  private zjj jdField_a_of_type_Zjj;
  private zjk jdField_a_of_type_Zjk;
  private int jdField_b_of_type_Int;
  private ImageView jdField_b_of_type_AndroidWidgetImageView;
  private int c;
  private int d;
  
  public zjc(Bundle paramBundle, zjk paramzjk)
  {
    if ((paramBundle == null) || (paramzjk == null)) {
      return;
    }
    this.jdField_a_of_type_Zjk = paramzjk;
    a(paramBundle);
    a();
    b();
    c();
      ...
      for (;;)
      {
        try
        {
          ...
          if (Build.VERSION.SDK_INT >= 16)
          {
            ...
            localBundle.putString("bundle_key_source_image_param", new zjj((String)localObject, paramInt1, paramInt2).a());
  ...
  private void a()
  {
    if ((this.jdField_a_of_type_Zjb != null) && (this.jdField_a_of_type_Zjb.a())) {
      return;
    }
  ...
  {
    if (this.jdField_a_of_type_Zjb != null) {
      this.jdField_a_of_type_Zjb.a(2);
    }
    ...
    ((ObjectAnimator)localObject1).addListener(new zje(this, paramInt4, paramInt3, paramInt1, paramInt2));
    ...
    localObject2 = ObjectAnimator.ofObject(this.jdField_a_of_type_AndroidWidgetImageView, jdField_a_of_type_AndroidUtilProperty, new zjh(), new Matrix[] { localObject2, localObject3 });
    ...
    this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new zjf(this));
  ...
  {
    this.jdField_a_of_type_Zjb = new zjb();
    ...
    this.jdField_a_of_type_Zjj = new zjj();
    this.jdField_a_of_type_Zjj.a(str);
    this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Zjj.jdField_a_of_type_JavaLangString;
    this.jdField_a_of_type_JavaIoFile = new File(this.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_Int = this.jdField_a_of_type_Zjj.jdField_a_of_type_Int;
    this.jdField_b_of_type_Int = this.jdField_a_of_type_Zjj.jdField_b_of_type_Int;
  ...
  private void c()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetFrameLayout != null)
      {
        ...
        localLayoutParams.topMargin = this.jdField_a_of_type_Zjk.a();
    ...
    } while (this.jdField_a_of_type_Zjb == null);
    this.jdField_a_of_type_Zjb.a(1);
  }
  
  private void d()
  {
    int[] arrayOfInt = this.jdField_a_of_type_Zjk.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
  ...
  private void e()
  {
    if ((this.jdField_a_of_type_Zjb == null) || (!this.jdField_a_of_type_Zjb.b())) {
      QLog.d("TransitionAnimHelper", 1, "initImageEnterAnimation error!");
    }
    while (this.jdField_b_of_type_AndroidWidgetImageView == null) {
      return;
    }
    this.jdField_b_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnPreDrawListener(new zjd(this));
  }
  ...
  {
    if (this.jdField_a_of_type_Zjb != null) {
      this.jdField_a_of_type_Zjb.a(paramzjl);
    }
  }
}
