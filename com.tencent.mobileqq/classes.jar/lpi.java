  ...
  implements lpg
{
  ...
  private final lqj jdField_a_of_type_Lqj;
  ...
  public lpi(Context paramContext, lqj paramlqj)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Lqj = paramlqj;
  ...
  private void a(int paramInt, PendantItem paramPendantItem, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      b(paramInt);
      this.jdField_a_of_type_Lqj.a(paramPendantItem.getGestureType());
      return;
    }
  ...
  public int a(int paramInt, boolean paramBoolean1, lpx paramlpx, boolean paramBoolean2)
  {
    boolean bool = false;
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager == null) {
      return paramInt;
    ...
    if ((this.jdField_a_of_type_ComTencentAekitApiStandardFilterAESticker != null) || (this.jdField_b_of_type_Boolean))
    {
      ...
      lqi.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.hasAEDetectorInited());
    }
    for (;;)
    {
      paramBoolean1 = bool;
      ...
      paramlpx.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.getFaceAttr(), (float)this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.getWindowScale(), paramBoolean2);
      return i;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null) && (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.cameraInterFace == null)) {
        this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.cameraInterFace = lil.a();
      }
      return;
      label69:
  ...
  public void a(PendantItem paramPendantItem, VideoMaterial paramVideoMaterial)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((lqi.a(this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem, paramPendantItem)) && (this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial == paramVideoMaterial));
  ...
  {
    if (!lqi.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc, paramFilterDesc))
    {
  ...
  public void a(lpu paramlpu, lpx paramlpx)
  {
    String str2 = "";
    String str1 = "";
    if (this.jdField_a_of_type_ComTencentAvBusinessManagerPendantPendantItem != null)
    ...
    {
      boolean bool2 = lil.a().b();
      if ((liq.a(this.jdField_a_of_type_ComTencentTtpicOpenapiModelVideoMaterial)) && (!bool2)) {
        bool1 = false;
      }
      for (;;)
      {
        this.jdField_a_of_type_Lqj.a(paramlpu, paramlpx.jdField_a_of_type_Int, this.jdField_a_of_type_Boolean, bool1, str1, str2);
        return;
      }
    }
  }
  ...
  public boolean a(lpn paramlpn)
  {
    boolean bool = false;
    if (paramlpn != null) {}
    for (int i = paramlpn.a("BEAUTY_SKIN");; i = 0)
    {
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null)
    {
      ...
      lcg.c("AEFilterOldWrapper", "mQQFilterRenderManager surfaceChange" + str);
    }
  }
