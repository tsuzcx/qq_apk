  ...
  implements View.OnClickListener
{
  ...
  public beep(Context paramContext, View.OnClickListener paramOnClickListener)
  {
  ...
  private void a(AsyncImageView paramAsyncImageView, GroupPadTemplateInfo paramGroupPadTemplateInfo)
  {
    ...
    {
      Drawable localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840334);
      if (!bkyp.a(paramGroupPadTemplateInfo.mobThumbUrl)) {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramGroupPadTemplateInfo != null)
          {
            ...
            paramGroupPadTemplateInfo.setDownloadListener(new beeq(this, str));
    ...
    paramAsyncImageView.setImageResource(2130840334);
  }
  ...
  public GroupPadTemplateInfo a()
  {
    ...
    localGroupPadTemplateInfo.templateName = this.jdField_a_of_type_AndroidContentContext.getString(2131692973);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559292, null);
      paramView = new beer(this);
      paramView.jdField_a_of_type_Int = jdField_b_of_type_Int;
      paramView.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)localView.findViewById(2131367905));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131367901));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131367899));
    ...
    for (;;)
    {
      ...
      return localView;
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559291, null);
      paramView = new beer(this);
      paramView.jdField_a_of_type_Int = jdField_a_of_type_Int;
      paramView.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)localView.findViewById(2131367904));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131367903));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131367898));
      paramView.jdField_a_of_type_ComTencentMobileqqTeamworkforgroupGroupPadTemplateInfo = localGroupPadTemplateInfo;
      localView.setTag(paramView);
      localView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      break;
      ...
      paramView.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setImageResource(2130840336);
      break label141;
      label316:
      paramView.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setImageResource(2130840334);
