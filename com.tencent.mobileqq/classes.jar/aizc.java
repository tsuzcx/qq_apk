...
public class aizc
{
  ...
  public static String a(String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      ...
      str2 = paramArrayOfString[argh.a(paramArrayOfString.length)];
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          ((JSONObject)localObject).put("atlas", aiwi.a(paramInt + "/role", 1));
          ((JSONObject)localObject).put("json", aiwi.a(paramInt + "/role", 1));
          continue;
      ...
      localJSONObject2.put("atlas", aiwi.a(localInteger + "/dress", 2));
      localJSONObject2.put("json", aiwi.a(localInteger + "/dress", 2));
    }
    localJSONObject1.put("dressPath", localException1);
    return localJSONObject1;
  }
  
  public static void a(int paramInt1, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt2, String paramString3, aizi paramaizi)
  {
    aifg localaifg = (aifg)paramQQAppInterface.getManager(153);
    Object localObject = localaifg.b(paramString1);
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (localObject.length > 0))
      {
        ...
        if (paramInt2 < j)
        {
          aiju localaiju = localObject[paramInt2];
          i = localaiju.jdField_b_of_type_Int;
          int[] arrayOfInt = localaiju.a();
          if ((aiwi.a(paramString1, localaiju.jdField_a_of_type_Int, arrayOfInt, paramQQAppInterface, new aizg(paramaizi, paramInt1, paramQQAppInterface, paramString2, paramString3, localaiju, arrayOfInt))) && (localaiju.jdField_a_of_type_Int != 0))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloGameBasicEventUtil", 2, "valid role and dress RSC.");
            }
            if (paramaizi != null) {
              paramaizi.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, localaiju.jdField_a_of_type_Int, arrayOfInt, 3);
            }
          }
        }
      }
      ...
      for (;;)
      {
        ...
        if (paramaizi != null)
        {
          ...
          {
            paramInt2 = 2;
            paramaizi.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, paramInt2, aitw.a(paramInt2), 1);
          }
        }
        else
        {
          aifg.a(paramQQAppInterface, paramString1, "apllo_game");
          paramQQAppInterface = (ajjj)paramQQAppInterface.getManager(51);
          if ((paramQQAppInterface == null) || (paramQQAppInterface.b(paramString1))) {
            continue;
          }
          paramQQAppInterface = localaifg.b(paramString1);
        ...
        for (long l = paramQQAppInterface.apolloUpdateTime;; l = 0L)
        {
          ...
          paramaizi.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, 1, aitw.a(1), 1);
          break label282;
        }
      }
    }
  ...
  public static void a(int paramInt, String paramString, Activity paramActivity)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localajdd = new ajdd();
        localObject1 = aing.a(paramInt);
        if (localObject1 != null)
        {
          localObject1 = ((aipj)localObject1).a();
          if ((localObject1 != null) && (((CmGameStartChecker.StartCheckParam)localObject1).game != null))
          {
            localajdd.jdField_b_of_type_Int = ((CmGameStartChecker.StartCheckParam)localObject1).game.actionId;
            localajdd.jdField_b_of_type_JavaLangString = ((CmGameStartChecker.StartCheckParam)localObject1).game.name;
          }
        }
        if (localajdd.jdField_b_of_type_Int <= 0) {
          localajdd.jdField_b_of_type_Int = 439;
        }
        localajdd.jdField_a_of_type_Int = paramInt;
        localajdd.jdField_a_of_type_JavaLangString = ajjy.a(2131634571);
        localajdd.jdField_c_of_type_Int = i;
        ...
        ((JSONObject)localObject1).put("xyRootSrc", ailn.a(paramInt));
        i = paramString.optInt("activityId");
        int j = paramString.optInt("reqCode");
        localObject2 = aing.a(paramInt);
        if (localObject2 != null)
        {
          ((aipj)localObject2).jdField_b_of_type_Int = i;
          ((aipj)localObject2).jdField_c_of_type_Int = j;
        }
        localajdd.jdField_c_of_type_JavaLangString = ((JSONObject)localObject1).toString();
        if (localajdd.jdField_c_of_type_JavaLangString.length() >= 500)
        {
          QLog.w("cmgame.sendmsg", 1, "extendInfo is too long, len:" + localajdd.jdField_c_of_type_JavaLangString.length() + ",content:" + localajdd.jdField_c_of_type_JavaLangString);
          return;
        }
      }
      ...
      Object localObject1 = aipq.a();
      if ((localObject1 != null) && (((aipq)localObject1).a != null) && (0L != l)) {
        ((aipq)localObject1).a.roomId = l;
      }
      if (i == 0)
      {
        paramString.put("msgType", 4);
        aioy.a("cs.send_game_msg.local", paramString.toString(), true, null, paramInt);
        return;
      }
    } while (1 != i);
    a(localajdd, paramActivity, 3);
  }
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject1 = (aifg)paramQQAppInterface.getManager(153);
    Object localObject2 = aifg.jdField_c_of_type_JavaLangString;
    localObject1 = aifg.jdField_b_of_type_JavaLangString;
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        a(paramLong, paramQQAppInterface, paramString2, "", 1, paramString1, new aizd());
        return;
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, String paramString3, aizh paramaizh)
  {
    aifg localaifg = (aifg)paramQQAppInterface.getManager(153);
    Object localObject = localaifg.b(paramString1);
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (localObject.length > 0))
      {
        ...
        if (paramInt < j)
        {
          aiju localaiju = localObject[paramInt];
          i = localaiju.jdField_b_of_type_Int;
          int[] arrayOfInt = localaiju.a();
          if ((aiwi.a(paramString1, localaiju.jdField_a_of_type_Int, arrayOfInt, paramQQAppInterface, new aizf(paramaizh, paramLong, paramQQAppInterface, paramString2, paramString3, localaiju, arrayOfInt))) && (localaiju.jdField_a_of_type_Int != 0))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloGameBasicEventUtil", 2, "valid role and dress RSC.");
            }
            if (paramaizh != null) {
              paramaizh.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, localaiju.jdField_a_of_type_Int, arrayOfInt, 3);
            }
          }
        }
      }
      ...
      for (;;)
      {
        ...
        if (paramaizh != null)
        {
          ...
          {
            paramInt = 2;
            paramaizh.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, paramInt, aitw.a(paramInt), 1);
          }
        }
        else
        {
        ...
        for (paramLong = paramQQAppInterface.apolloUpdateTime;; paramLong = 0L)
        {
          ...
          paramaizh.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, 1, aitw.a(1), 1);
          break label285;
        }
      }
    }
  ...
  public static void a(ajdd paramajdd, Activity paramActivity, int paramInt)
  {
    if (paramajdd == null)
    {
    ...
    localBundle.putInt("forward.apollo.gameid", paramajdd.jdField_a_of_type_Int);
    localBundle.putInt("forward.apollo.gameMode", paramajdd.jdField_c_of_type_Int);
    localBundle.putInt("forward_type", 34);
    if (QLog.isColorLevel()) {
      QLog.d("ApolloGameBasicEventUtil", 2, "[forwardGameMsg] gameId:" + paramajdd.jdField_a_of_type_Int + ";fromtype:" + paramInt);
    }
    if (paramInt == 2)
    {
      localIntent.putExtras(localBundle);
      aphp.a(paramActivity, localIntent, 99999);
      return;
    }
    localBundle.putInt("forward.apollo.actionid", paramajdd.jdField_b_of_type_Int);
    localBundle.putLong("forward.apollo.roomid", paramajdd.jdField_a_of_type_Long);
    localBundle.putString("forward.apollo.gamename", paramajdd.jdField_b_of_type_JavaLangString);
    localBundle.putString("forward.apollo.actionname", paramajdd.jdField_a_of_type_JavaLangString);
    localBundle.putInt("forward.apollo.msgtype", paramajdd.d);
    localBundle.putString("forward.apollo.sharejson", paramajdd.jdField_c_of_type_JavaLangString);
    localIntent.putExtras(localBundle);
    aphp.a(paramActivity, localIntent, 20180426);
  }
    ...
    if (localJSONObject1.has("param"))
    {
      ...
      if (localJSONObject2 != null)
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          paramString = befm.a(paramString, str, localJSONObject2.getString(str));
        }
      }
    }
    for (;;)
    ...
    for (;;)
    {
      try
      {
        ...
        if (((JSONObject)localObject).has("r5"))
        {
          ...
          bajr.a(null, "cmshow", "Apollo", paramAppInterface, i, j, new String[] { paramString, str1, str2, localObject });
          return;
        }
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localajdd = new ajdd();
        ApolloGameData localApolloGameData = ((aiyu)localObject).a(k);
        paramString = ajjy.a(2131634553);
        if ((localApolloGameData != null) && (!TextUtils.isEmpty(localApolloGameData.name)))
        {
          ...
          localajdd.jdField_a_of_type_JavaLangString = paramString;
          localajdd.jdField_b_of_type_Int = i;
          localajdd.jdField_c_of_type_Int = j;
          localajdd.jdField_a_of_type_Long = l;
          localajdd.jdField_a_of_type_Int = k;
      ...
      localajdd.jdField_b_of_type_JavaLangString = ajjy.a(2131634572);
      int i = 0;
      continue;
      localajdd.d = 3;
      continue;
      ...
      ApolloGameUtil.a(paramQQAppInterface, localajdd, paramString.a());
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          QLog.i("ApolloGameBasicEventUtil", 1, "pass uin.");
          a(paramInt, paramQQAppInterface, paramString2, str, 1, paramString1, new aize(i));
          return;
        }
      }
      catch (Exception paramQQAppInterface)
  ...
  public static boolean a(Context paramContext, String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 2)
      {
        ...
        String str = String.format("https://cmshow.qq.com/apollo/html/game-platform/buy-props.html?_wv=3&adtag=inside_game&gameId=%s&gameOrientation=%s&itemList=%s", new Object[] { Integer.valueOf(localaipj.a()), Integer.valueOf(i), URLEncoder.encode(paramString.optString("itemList"), "UTF-8") });
        ...
        bajr.a(null, "cmshow", "Apollo", "open_webpage", 0, 0, new String[] { localaipj.a().mGameName });
        if (QLog.isColorLevel())
        {
          ...
          bajr.a(null, "cmshow", "Apollo", "open_webpage", 1, 0, new String[] { localaipj.a().mGameName });
        }
      }
      else
      {
  ...
  private static String b()
  {
    ...
    {
      if ((ajjy.a(2131634580).equals(str)) || (str.contains(ajjy.a(2131634565)))) {
        return a(b);
      }
      if ((ajjy.a(2131634578).equals(str)) || (str.contains(ajjy.a(2131634539)))) {
        return a(c);
      }
      if ((ajjy.a(2131634551).equals(str)) || (str.contains(ajjy.a(2131634545)))) {
  ...
  public static void b(long paramLong, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    paramString = b(aifg.jdField_c_of_type_JavaLangString.getBytes(), paramString.getBytes());
    try
    {
    ...
    if (localJSONObject.has("param"))
    {
      ...
      if (localJSONObject != null)
      {
        ...
        for (;;)
        {
          ...
          paramString = befm.a(paramString, str, localJSONObject.getString(str));
        }
      }
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      ((ngh)paramQQAppInterface.a(88)).a(i, paramString, str1, str2, str3, l1, l2, l3, l4, bool);
      return;
    }
    catch (Exception paramQQAppInterface)
    {
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    int j = badq.b(paramQQAppInterface.getApp());
    long l1 = 0L;
    label199:
    label204:
    label210:
