...
public class aapa
{
  ...
  public static int a(String paramString, int paramInt)
  {
    ...
    {
      aanp.d("GdtUIUtils", "getColor error", paramString);
    }
    return paramInt;
  }
  ...
  public static Drawable a(@ColorInt int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      localPaintDrawable.setShaderFactory(new aapb(f1, f3, f2, f4, arrayOfInt));
  ...
  public static void a(Activity paramActivity)
  {
    ...
    {
      a(paramActivity);
      aanp.a("GdtMvViewController", "enableNotch && updateLiuhaiTopHeight 0");
    }
  }
  ...
  public static boolean a(Activity paramActivity)
  {
    ...
    aanp.a("GdtMvViewController", "hasTopLiuHai  " + bngs.a);
    return bngs.a;
  }
  ...
  private static int b(Activity paramActivity)
  {
    ...
    if (i > 27) {
      return bngs.a(paramActivity);
    }
    return bngs.b(paramActivity);
  }
  ...
  public static int b(Context paramContext)
  {
    ...
    while ((paramContext.getResources() == null) || (paramContext.getResources().getDisplayMetrics() == null))
    {
      aanp.d("GdtUIUtils", "getScreenWidth error");
      return -2147483648;
    }
  ...
  public static int d(Context paramContext)
  {
    ...
    while ((paramContext.getResources() == null) || (paramContext.getResources().getDisplayMetrics() == null))
    {
      aanp.d("GdtUIUtils", "getScreenHeight error");
      return -2147483648;
    }
