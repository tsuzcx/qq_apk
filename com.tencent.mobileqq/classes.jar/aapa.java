...
public class aapa
  extends RecyclerView.Adapter<aapd>
  implements Handler.Callback
{
  ...
  public aapd a(ViewGroup paramViewGroup, int paramInt)
  {
    return new aapd(this, LayoutInflater.from(paramViewGroup.getContext()).inflate(2131563044, null));
  }
  ...
  public void a(aaoz paramaaoz)
  {
    this.jdField_a_of_type_Aaoz = paramaaoz;
  }
  
  public void a(aapd paramaapd, int paramInt)
  {
    if (a() == 0) {}
    int i;
    label31:
    ...
    do
    {
      EventCollector.getInstance().onRecyclerBindViewHolder(paramaapd, paramInt, getItemId(paramInt));
      return;
      if (paramInt >= a()) {
        break;
      }
    ...
    for (;;)
    {
      UIUtils.setRoundCornerViewByURL(aapd.a(paramaapd), localVsMusicItemInfo.mAlbumUrl, UIUtils.dip2px(paramaapd.itemView.getContext(), 60.0F), UIUtils.dip2px(paramaapd.itemView.getContext(), 60.0F), UIUtils.dip2px(paramaapd.itemView.getContext(), 30.0F), paramaapd.itemView.getContext().getResources().getDrawable(2130838938), null);
      paramaapd.itemView.setOnClickListener(new aapb(this, paramInt, localVsMusicItemInfo));
      break;
      i = a(paramInt);
      break label31;
      paramaapd.b(false);
  ...
  {
    VSNetworkHelper.getInstance().sendRequest(new BatchGetMusicInfoRequest(paramArrayList), new aapc(this, paramBoolean));
  }
  ...
  public void onAttachedToRecyclerView(RecyclerView paramRecyclerView)
  {
    ...
    this.jdField_a_of_type_Aaop = this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewSmartMusicRecyclerView.a();
  }
