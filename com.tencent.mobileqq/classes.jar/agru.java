  ...
  extends BaseBubbleBuilder
{
  ...
  protected final int c = 2131379161;
  protected final int d = 2131379157;
  protected final int e = 2131379160;
  protected final int f = 2131379159;
  protected final int g = 2131379156;
  protected final int h = 2131379158;
  protected int i;
  protected int j;
  protected int k;
  protected int l;
  ...
  public agru(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new agrv(this);
  ...
  {
    paramaezf = (agrw)paramaezf;
    paramBaseChatItemLayout = (MessageForTroopFee)paramChatMessage;
    if ((paramaezf.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (paramaezf.jdField_a_of_type_Long == paramChatMessage.uniseq)) {
      return paramaezf.jdField_a_of_type_AndroidWidgetRelativeLayout;
    }
    ...
    {
      paramaezf.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView);
      paramaezf.b = paramChatMessage.frienduin;
      paramaezf.jdField_a_of_type_Long = paramChatMessage.uniseq;
      paramView = (TextView)paramaezf.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379160);
      TextView localTextView1 = (TextView)paramaezf.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379159);
      ImageView localImageView = (ImageView)paramaezf.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379157);
      TextView localTextView2 = (TextView)paramaezf.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379158);
      localQQWalletTransferBubbleView = (QQWalletTransferBubbleView)paramaezf.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131379161);
      ...
      localImageView.setImageResource(2130847158);
    ...
    {
      localQQWalletTransferBubbleView.setBubbleBackground(2130847156, i1, bool);
      paramaezf.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(paramBaseChatItemLayout.title + paramBaseChatItemLayout.summary + paramBaseChatItemLayout.source);
      ...
      return paramaezf.jdField_a_of_type_AndroidWidgetRelativeLayout;
      paramaezf.jdField_a_of_type_AndroidWidgetRelativeLayout = a(this.jdField_a_of_type_AndroidContentContext);
      break;
      label378:
      if (f1 <= this.m * 14) {
        break label210;
  ...
  protected RelativeLayout a(Context paramContext)
  {
    ...
    ((QQWalletTransferBubbleView)localObject1).setId(2131379161);
    ...
    ((ImageView)localObject2).setId(2131379157);
    ((QQWalletTransferBubbleView)localObject1).addView((View)localObject2);
    localObject2 = new LinearLayout(paramContext);
    localObject3 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject3).addRule(0, 2131379157);
    ...
    ((TextView)localObject3).setId(2131379160);
    ...
    ((TextView)localObject3).setId(2131379159);
    ((LinearLayout)localObject2).addView((View)localObject3);
    ((QQWalletTransferBubbleView)localObject1).addView((View)localObject2);
    localRelativeLayout.addView((View)localObject1);
    localObject1 = new RelativeLayout(paramContext);
    localObject2 = new RelativeLayout.LayoutParams(this.i, -2);
    ((RelativeLayout.LayoutParams)localObject2).addRule(3, 2131379161);
    ((RelativeLayout)localObject1).setLayoutParams((ViewGroup.LayoutParams)localObject2);
    ((RelativeLayout)localObject1).setBackgroundResource(2130847157);
    ((RelativeLayout)localObject1).setId(2131379156);
