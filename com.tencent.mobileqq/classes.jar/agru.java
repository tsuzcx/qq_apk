...
public class agru
  implements Runnable
{
  public agru(RedTouchWebviewHandler paramRedTouchWebviewHandler, String paramString, long paramLong) {}
        ...
        for (;;)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouchWebviewHandler.mRuntime != null)
          {
            ...
            if (localObject8 != null) {
              ((Activity)localObject8).runOnUiThread(new agrv(this, (String)localObject4, localJSONObject, (BusinessInfoCheckUpdate.AppInfo)localObject5, j, i, (ArrayList)localObject7, (String)localObject1, (String)localObject3));
            }
          }
          return;
          j = n;
