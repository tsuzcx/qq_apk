...
public class bnit
{
  ...
  public bnit(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Bniy = new bniy();
  ...
  protected View a()
  {
    ...
    this.jdField_a_of_type_Bniy.a((RelativeLayout)localView.findViewById(2131362143));
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        if (j != 0)
        {
          localObject4 = (GridView)localView.findViewById(2131367298);
        ...
        for (;;)
        {
          ...
          ((GridView)localObject4).setAdapter(new bniv(this.jdField_a_of_type_AndroidContentContext, (List)localObject1));
          ...
          if (k != 0)
          {
            localObject1 = (GridView)localView.findViewById(2131367299);
            if (Build.VERSION.SDK_INT >= 9) {
          ...
          for (;;)
          {
            ...
            ((GridView)localObject1).setNumColumns(i);
            ((GridView)localObject1).setAdapter(new bniv(this.jdField_a_of_type_AndroidContentContext, (List)localObject2));
            ...
            ((TextView)localObject1).setOnClickListener(new bniu(this));
            if (j == 0) {
