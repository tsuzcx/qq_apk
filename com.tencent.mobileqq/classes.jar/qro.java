...
public class qro
  extends qrf
{
  public qro(Context paramContext, aobu paramaobu, snh paramsnh)
  {
  ...
  public qqt d()
  {
    ...
    if ((this.jdField_a_of_type_Qqs != null) && ((this.jdField_a_of_type_Qqs instanceof ComponentContentBig)))
    {
      ...
      if ((this.jdField_a_of_type_Qqs instanceof ComponentContentBigImageVideo)) {
        localLinearLayout3.setOnClickListener(new qrp(this));
      }
      localLinearLayout2.setOnTouchListener(new qrq(this, localLinearLayout3));
      pez.a(localLinearLayout3, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130842990));
      localLinearLayout2.addView(localLinearLayout3);
      localLinearLayout2.setDuplicateParentStateEnabled(true);
      localLinearLayout2.setOnTouchListener(new qrr(this, localLinearLayout2));
      localLinearLayout1.setOnTouchListener(new qrs(this, localLinearLayout2, localLinearLayout3));
    }
    localLinearLayout2.setOnClickListener(new qrt(this));
