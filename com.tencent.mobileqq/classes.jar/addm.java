  ...
  implements View.OnClickListener
{
  ...
  {
    localMessageForDeviceSingleStruct = (MessageForDeviceSingleStruct)aciy.a(paramView);
    ...
    do
    {
      ...
      if ((TextUtils.isEmpty(localMessageForDeviceSingleStruct.strMediaFileName)) && (localMessageForDeviceSingleStruct.nMediaChannelType == 2) && (!TextUtils.isEmpty(localMessageForDeviceSingleStruct.strMediaKey))) {
        localMessageForDeviceSingleStruct.strMediaFileName = (bcdu.d(localMessageForDeviceSingleStruct.strMediaKey) + localMessageForDeviceSingleStruct.strMediaKey.substring(localMessageForDeviceSingleStruct.strMediaKey.lastIndexOf(".")));
      }
      localDeviceInfo = ((xrh)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(localMessageForDeviceSingleStruct.senderuin));
    ...
    for (;;)
    {
      ...
      catch (JSONException paramView)
      {
        ...
        continue;
        Object localObject = bade.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_AndroidContentContext, localMessageForDeviceSingleStruct.url);
        if ((localObject == null) || (!"openLightApp".equals(((bacn)localObject).b)) || (!"url".equals(((bacn)localObject).c))) {
          continue;
        }
        Bundle localBundle = new Bundle();
        localBundle.putString("param_meta_data", paramView);
        ydt.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_AndroidContentContext, localDeviceInfo, ((bacn)localObject).b("url_prefix"), localBundle);
        continue;
        if ((i == 0) || (TextUtils.isEmpty(localMessageForDeviceSingleStruct.faceRect)) || (!addl.a(this.a, localMessageForDeviceSingleStruct.faceRect)) || (TextUtils.isEmpty(localMessageForDeviceSingleStruct.strCoverPath))) {
          continue;
        }
        ...
        bgnd.a().a((Activity)this.a.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), (Intent)localObject, "com.tencent.device.face.FaceRegisterActivity", -1, null, SmartDevicePluginProxyActivity.class);
        continue;
        paramView = localMessageForDeviceSingleStruct.strCoverPath;
        continue;
        if ((bace.b(localMessageForDeviceSingleStruct.strMediaPath)) || (!badq.b(bbtm.a().a()))) {
          continue;
        }
        paramView = this.a.jdField_a_of_type_AndroidContentContext.getString(2131627035);
        localObject = this.a.jdField_a_of_type_AndroidContentContext.getString(2131627037);
        apbx.a(this.a.jdField_a_of_type_AndroidContentContext, paramView, (CharSequence)localObject, new addn(this, localMessageForDeviceSingleStruct));
        continue;
        addl.a(this.a, localMessageForDeviceSingleStruct);
        continue;
        i = 3;
        continue;
      }
      ...
      bgnd.a().a((Activity)this.a.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), (Intent)localObject, "com.tencent.device.lightapp.DeviceWebViewActivity", -1, null, SmartDevicePluginProxyActivity.class);
      ...
      yds.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l, "Usr_AIO_ReceiveMsg_Click", i, 0, j);
      return;
      i = 0;
      continue;
      paramView = localMessageForDeviceSingleStruct.strCoverPath;
