...
public class avrg
  implements agin
{
  private static final String jdField_a_of_type_JavaLangString = avrg.class.getSimpleName();
  private int jdField_a_of_type_Int;
  public long a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new avrh(this);
  private avrj jdField_a_of_type_Avrj;
  ...
  public avrg(BaseChatPie paramBaseChatPie)
  {
  ...
  private avrk a()
  {
    if (this.jdField_a_of_type_Avrk == null)
    {
      Manager localManager = this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app.getManager(QQManagerFactory.AIO_INPUT_STATUS_MANAGER);
      if ((localManager instanceof avrk)) {
        this.jdField_a_of_type_Avrk = ((avrk)localManager);
      }
    }
    return this.jdField_a_of_type_Avrk;
  }
  
  private boolean a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie != null) && ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof aici))) {
      return c();
    }
    return b();
  }
  ...
  private void b(int paramInt)
  {
    ...
    try
    {
      ...
      avrf localavrf = (avrf)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app.getBusinessHandler(BusinessHandlerFactory.INPUT_STATUS_HANDLER);
      if (localavrf != null) {
        localavrf.a(paramInt, l);
      }
      return;
    }
  ...
  private boolean c()
  {
    try
    {
      ...
      if (localavre != null)
      {
        boolean bool = localavre.jdField_b_of_type_Boolean;
        return bool;
      }
    }
    catch (Exception localException)
  ...
  public void a(int paramInt)
  {
    ...
    case 8: 
      do
      {
        ...
        if (this.jdField_a_of_type_Avrj == null) {
          this.jdField_a_of_type_Avrj = new avri(this, null);
        }
        this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app.addObserver(this.jdField_a_of_type_Avrj);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app.removeObserver(this.jdField_a_of_type_Avrj);
    }
    if (this.jdField_a_of_type_AndroidOsHandler != null)
    {
