...
public class avrg
{
  ...
  /* Error */
  public static avrg a(String paramString)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: new 2	avrg
    //   6: dup
    //   7: invokespecial 19	avrg:<init>	()V
    //   10: astore_3
    ...
    //   27: putfield 32	avrg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   30: aload_3
    //   31: aload_0
    //   32: ldc 34
    //   34: invokevirtual 30	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   37: putfield 36	avrg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   40: aload_3
    //   41: aload_0
    //   42: ldc 38
    //   44: invokevirtual 30	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   47: putfield 40	avrg:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   50: aload_0
    //   51: ldc 42
    ...
    //   66: putfield 51	avrg:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   69: aload_3
    //   70: astore_0
    //   71: aload 4
    //   73: ifnull +725 -> 798
    ...
    //   170: iconst_2
    //   171: newarray int
    //   173: putfield 92	avrh:jdField_a_of_type_ArrayOfInt	[I
    //   176: aload 6
    //   178: ifnull +36 -> 214
    //   181: aload 6
    ...
    //   190: aload_0
    //   191: getfield 92	avrh:jdField_a_of_type_ArrayOfInt	[I
    //   194: iconst_0
    //   195: aload 6
    //   197: iconst_0
    ...
    //   201: iastore
    //   202: aload_0
    //   203: getfield 92	avrh:jdField_a_of_type_ArrayOfInt	[I
    //   206: iconst_1
    //   207: aload 6
    //   209: iconst_1
    ...
    //   222: putfield 97	avrh:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   225: aload 5
    //   227: ldc 99
    ...
    //   258: new 101	avri
    //   261: dup
    //   262: invokespecial 102	avri:<init>	()V
    //   265: astore 7
    //   267: aload 7
    //   269: aload 8
    //   271: ldc 104
    //   273: invokevirtual 30	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   276: putfield 105	avri:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   279: aload 7
    //   281: aload 8
    //   283: ldc 107
    //   285: invokevirtual 70	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   288: putfield 108	avri:jdField_a_of_type_Int	I
    //   291: aload 7
    //   293: iconst_2
    //   294: newarray int
    //   296: putfield 110	avri:jdField_b_of_type_ArrayOfInt	[I
    //   299: aload 8
    //   301: ldc 112
    ...
    //   322: aload 7
    //   324: getfield 110	avri:jdField_b_of_type_ArrayOfInt	[I
    //   327: iconst_0
    //   328: aload 9
    //   330: iconst_0
    ...
    //   334: iastore
    //   335: aload 7
    //   337: getfield 110	avri:jdField_b_of_type_ArrayOfInt	[I
    //   340: iconst_1
    //   341: aload 9
    //   343: iconst_1
    ...
    //   350: iconst_2
    //   351: newarray int
    //   353: putfield 113	avri:jdField_a_of_type_ArrayOfInt	[I
    //   356: aload 8
    //   358: ldc 115
    ...
    //   379: aload 7
    //   381: getfield 113	avri:jdField_a_of_type_ArrayOfInt	[I
    //   384: iconst_0
    //   385: aload 8
    //   387: iconst_0
    ...
    //   391: iastore
    //   392: aload 7
    //   394: getfield 113	avri:jdField_a_of_type_ArrayOfInt	[I
    //   397: iconst_1
    //   398: aload 8
    //   400: iconst_1
    ...
    //   404: iastore
    //   405: aload_0
    //   406: getfield 97	avrh:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   409: aload 7
    ...
    //   432: putfield 123	avrh:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   435: aload 5
    //   437: ldc 125
    ...
    //   592: aload 6
    //   594: getfield 153	avrj:jdField_c_of_type_ArrayOfInt	[I
    //   597: iconst_0
    //   598: aload 8
    //   600: iconst_0
    ...
    //   604: iastore
    //   605: aload 6
    //   607: getfield 153	avrj:jdField_c_of_type_ArrayOfInt	[I
    //   610: iconst_1
    //   611: aload 8
    //   613: iconst_1
    ...
    //   620: iconst_2
    //   621: newarray int
    //   623: putfield 156	avrj:jdField_a_of_type_ArrayOfInt	[I
    //   626: aload 7
    //   628: ldc 158
    ...
    //   649: aload 6
    //   651: getfield 156	avrj:jdField_a_of_type_ArrayOfInt	[I
    //   654: iconst_0
    //   655: aload 8
    //   657: iconst_0
    ...
    //   661: iastore
    //   662: aload 6
    //   664: getfield 156	avrj:jdField_a_of_type_ArrayOfInt	[I
    //   667: iconst_1
    //   668: aload 8
    //   670: iconst_1
    ...
    //   700: iconst_4
    //   701: newarray int
    //   703: putfield 161	avrj:jdField_b_of_type_ArrayOfInt	[I
    //   706: aload 6
    //   708: getfield 161	avrj:jdField_b_of_type_ArrayOfInt	[I
    //   711: iconst_0
    //   712: aload 7
    //   714: iconst_0
    ...
    //   718: iastore
    //   719: aload 6
    //   721: getfield 161	avrj:jdField_b_of_type_ArrayOfInt	[I
    //   724: iconst_1
    //   725: aload 7
    //   727: iconst_1
    ...
    //   731: iastore
    //   732: aload 6
    //   734: getfield 161	avrj:jdField_b_of_type_ArrayOfInt	[I
    //   737: iconst_2
    //   738: aload 7
    //   740: iconst_2
    ...
    //   744: iastore
    //   745: aload 6
    //   747: getfield 161	avrj:jdField_b_of_type_ArrayOfInt	[I
    //   750: iconst_3
    //   751: aload 7
    //   753: iconst_3
    ...
    //   757: iastore
    //   758: aload_0
    //   759: getfield 123	avrh:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   762: aload 6
    ...
    //   774: goto -323 -> 451
    //   777: aload_3
    //   778: getfield 51	avrg:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   781: aload_0
