...
public class bpao
{
  public static void a(Activity paramActivity)
  {
    ...
    {
      bpam.d("PicChooseJumpUtil", "activity is null.");
      return;
    }
    ...
    localIntent.putExtra("VIDEO_STORY_JUMP_TO_TYPE", born.b(paramActivity.getIntent()));
    localIntent.putExtra("VIDEO_STORY_FROM_TYPE", born.a(paramActivity.getIntent()));
  ...
  {
    bpam.b("PicChooseJumpUtil", "[jumpForAECircle] Start");
    bpam.a("PicChooseJumpUtil", "[AE Profiler] jumpForAECircle Start");
