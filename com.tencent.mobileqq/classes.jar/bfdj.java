...
public class bfdj
  extends bfjg
{
  public static final bfjh<bfdj> a;
  public int a;
  public String a;
  ...
  static
  {
    jdField_a_of_type_Bfjh = new bfdk();
  }
  ...
  public static final List<bfdj> a(JSONObject paramJSONObject)
  {
    ...
    while (i < n)
    {
      ...
      if (j < i1)
      {
        ...
        for (localObject = ((JSONObject)localObject).getString("label");; localObject = null)
        {
          ...
          localFriend.jdField_b_of_type_JavaLangString = bfhm.a(paramJSONObject);
          localFriend.jdField_c_of_type_JavaLangString = bfhm.a((String)localObject);
      ...
      paramJSONObject = new bfdj();
      paramJSONObject.jdField_a_of_type_Int = i;
      paramJSONObject.jdField_a_of_type_JavaLangString = bfhm.a(localJSONObject.getString("label"));
  ...
  public static final List<bfdj> b(JSONObject paramJSONObject)
  {
    ...
    bfdj localbfdj = new bfdj();
    localbfdj.jdField_a_of_type_Int = 0;
    localbfdj.jdField_a_of_type_JavaLangString = alpo.a(2131705251);
    localbfdj.jdField_a_of_type_JavaUtilList = localArrayList2;
    localArrayList1.add(localbfdj);
    int j = 0;
    int i = 1;
    while (j < m)
    {
      ...
      while (k < i2)
      {
        ...
        else
        {
          ...
          for (String str1 = localJSONObject2.getString("remark");; str1 = null)
          {
            ...
            localFriend.jdField_b_of_type_JavaLangString = bfhm.a((String)localObject);
            localFriend.jdField_c_of_type_JavaLangString = bfhm.a(str1);
      ...
      Object localObject = new bfdj();
      ((bfdj)localObject).jdField_a_of_type_Int = i;
      ((bfdj)localObject).jdField_a_of_type_JavaLangString = bfhm.a(localJSONObject1.getString("groupname"));
      ((bfdj)localObject).jdField_a_of_type_JavaUtilList = localArrayList3;
    ...
    if (localArrayList2.size() == 0)
    {
      ...
      {
        paramJSONObject = (bfdj)localArrayList1.get(i);
  ...
  public static final List<bfdj> c(JSONObject paramJSONObject)
  {
    JSONArray localJSONArray1 = paramJSONObject.getJSONArray("qqlist");
    int m = localJSONArray1.length();
    int n = paramJSONObject.optInt("app_tid", -1);
    ...
    ArrayList localArrayList2 = new ArrayList();
    bfdj localbfdj2 = new bfdj();
    localbfdj2.jdField_a_of_type_Int = 0;
    localbfdj2.jdField_a_of_type_JavaLangString = alpo.a(2131705250);
    localbfdj2.jdField_a_of_type_JavaUtilList = localArrayList2;
    localArrayList1.add(localbfdj2);
    int i = 0;
    bfdj localbfdj1 = null;
    int j = 1;
    if (i < m)
    {
      ...
      if (alpo.a(2131705249).equals(localJSONObject1.getString("label")))
      {
        localbfdj1 = new bfdj();
        localbfdj1.jdField_a_of_type_Int = 0;
        localbfdj1.jdField_a_of_type_JavaLangString = bfhm.a(localJSONObject1.getString("label"));
        localbfdj1.jdField_a_of_type_JavaUtilList = localArrayList3;
      }
      for (;;)
      {
        i += 1;
        ...
        ((bfdj)localObject).jdField_a_of_type_Int = j;
        ((bfdj)localObject).jdField_a_of_type_JavaLangString = bfhm.a(localJSONObject1.getString("label"));
        ((bfdj)localObject).jdField_a_of_type_JavaUtilList = localArrayList3;
        localArrayList1.add(localObject);
        j += 1;
      }
    ...
    if (paramJSONObject.getInt("only") == 1)
    {
      ...
      paramJSONObject.add(localbfdj2);
      return paramJSONObject;
    }
    if (localArrayList2.size() == 0)
    {
      if ((localbfdj1 == null) || (localbfdj1.jdField_a_of_type_JavaUtilList == null) || (localbfdj1.jdField_a_of_type_JavaUtilList.size() <= 0)) {
        break label493;
      }
      localArrayList1.remove(0);
      localArrayList1.add(0, localbfdj1);
    }
    for (;;)
    {
      return localArrayList1;
