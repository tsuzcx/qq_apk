  ...
  implements View.OnClickListener
{
  ...
  public xiv(Activity paramActivity, xix paramxix)
  {
  ...
  private void a(View paramView)
  {
    ...
    localObjectAnimator1.setInterpolator(new xia(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    localObjectAnimator2.setInterpolator(new xia(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    localObjectAnimator3.setInterpolator(new xia(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    paramView.setInterpolator(new xia(0.33F, 0.0F, 0.67F, 1.0F));
  ...
  private void f()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131373808);
    this.jdField_a_of_type_AndroidViewView.setVisibility(0);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131373804);
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView = ((RecyclerView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373810));
      ...
      this.jdField_a_of_type_Xij = new xij(this.jdField_a_of_type_AndroidViewView.getContext(), this, this.jdField_a_of_type_Xix);
      this.jdField_a_of_type_Xij.a(xir.a().a());
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Xij);
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getRecycledViewPool().setMaxRecycledViews(this.jdField_a_of_type_Xij.getItemViewType(0), 10);
      this.jdField_a_of_type_Xij.a(new xiw(this));
      new bhzk(new xiq(this.jdField_a_of_type_Xij)).attachToRecyclerView(this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373811));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373812));
      this.c = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373803));
      this.c.setOnClickListener(this);
      this.d = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373802));
      ...
      if (a())
      {
        ...
        xir.a().a(this.jdField_a_of_type_Int);
      }
      return;
      i = 0;
      break;
  ...
  public String a()
  {
    if (this.jdField_a_of_type_Xij != null) {
      return this.jdField_a_of_type_Xij.a();
    }
    return "";
  }
  ...
  public void a()
  {
    ...
    for (int i1 = localList.size();; i1 = 0)
    {
      ...
      if (i1 > 0)
      {
        ...
        {
          this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167061));
          this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167061));
          if (this.d.getVisibility() != 0)
          {
            localObject = xir.a().a().iterator();
            i = 0;
            j = 0;
            i2 = 0;
            if (((Iterator)localObject).hasNext())
      ...
      for (;;)
      {
        ...
        if (localSlideItemInfo.jdField_b_of_type_Int == 0)
        {
          ...
          if (m != 0)
          {
            ...
            localObject = "0";
            wta.a("pic_choose", "exp_autoCut", i3, 0, new String[] { localObject, i2 + "", j + "", i + "" });
            this.d.setVisibility(0);
            if (k == 0) {
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131699902, new Object[] { Integer.valueOf(this.jdField_a_of_type_Int / 1000) }));
            }
            this.jdField_a_of_type_AndroidWidgetTextView.setText(xiu.a(l));
          ...
          {
            if (this.jdField_a_of_type_Xij != null) {
              this.jdField_a_of_type_Xij.a(localList);
            }
            return;
            i3 = 1;
            break;
            ...
            if (n != 0)
            {
              this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131166811));
              this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167062));
            }
            for (;;)
            {
              this.d.setVisibility(8);
              break;
              this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167192));
            ...
            if (n != 0)
            {
              ...
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131699904));
            }
            for (;;)
            {
              ...
              break label674;
              label753:
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131699903));
            }
            bool = false;
            break label511;
            if (m == 0)
  ...
  {
    if (this.jdField_a_of_type_Xij != null) {
      this.jdField_a_of_type_Xij.a(paramInt);
    }
  }
  
  public void b()
  {
    List localList = xir.a().a();
    if ((this.jdField_a_of_type_AndroidSupportV7WidgetLinearLayoutManager != null) && (this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView != null))
    {
      ...
      while (i <= j)
      {
        ...
        if (localObject != null)
        {
          ...
          if ((localObject instanceof xim))
          {
            SlideItemInfo localSlideItemInfo1 = (SlideItemInfo)((xim)localObject).a.getTag();
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131376780: 
      ...
      i = xir.a().a().indexOf(paramView);
      if ((this.jdField_a_of_type_Xix != null) && (paramView != null)) {
        this.jdField_a_of_type_Xix.c_(paramView.jdField_b_of_type_JavaLangString);
      }
      a(i);
      return;
    case 2131373803: 
      if ((this.jdField_a_of_type_AndroidAppActivity instanceof NewPhotoListActivity))
      {
        ...
        if (this.jdField_a_of_type_Xix != null) {
          this.jdField_a_of_type_Xix.a();
        }
        paramView = xir.a().a();
        if ((paramView.size() >= 1) && (paramView.size() <= 10) && (((SlideItemInfo)paramView.get(0)).a() <= 20999L)) {
          xir.a().a(this.jdField_a_of_type_AndroidAppActivity, null, 2);
        }
      }
      for (;;)
      {
        try
        {
          ...
          wta.a("pic_fictitious", "clk_next", this.jdField_a_of_type_AndroidAppActivity.getIntent(), new String[0]);
          if ((!xir.a().a()) || (this.jdField_a_of_type_AndroidAppActivity == null)) {
            break;
          }
          wta.a("video_edit_new", "change_pic", this.jdField_a_of_type_AndroidAppActivity.getIntent(), new String[0]);
          return;
        }
        ...
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, bhop.a(paramView));
        return;
        i = 1;
        break label104;
        label310:
    ...
    for (;;)
    {
      ...
      if (localSlideItemInfo.jdField_b_of_type_Int == 0)
      {
        ...
        {
          wta.a("pic_choose", "clk_autoCut", n, 0, new String[] { paramView, k + "", j + "", i + "" });
          xir.a().i();
          return;
          m = 0;
          break;
