...
public class apnc
{
  ...
  public apnc(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRunnable = new EPRecommendTask.1(this);
    this.jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new apnd(this);
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramQQAppInterface);
  }
  
  public static attz a(JSONObject paramJSONObject)
  {
  ...
  public apnc a(String paramString1, String paramString2)
  {
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    } while (localSharedPreferences.getInt("magic_promotion_old_ver_" + apgj.a(), -1) >= paramJSONObject.jdField_b_of_type_Int);
    localSharedPreferences.edit().putBoolean("magic_promotion_is_new_content_" + apgj.a(), true).commit();
    localSharedPreferences.edit().putInt("magic_promotion_old_ver_" + apgj.a(), paramJSONObject.jdField_b_of_type_Int).commit();
  }
}
