  ...
  extends VideoCombineHelper.Task
{
  ...
  public oxe(VideoCombineHelper paramVideoCombineHelper, VideoCombineHelper.TaskListener paramTaskListener, String paramString1, List paramList, String paramString2, String paramString3)
  {
    super(paramVideoCombineHelper, paramTaskListener, paramString1);
    this.jdField_a_of_type_JavaLangString = paramString2;
    this.b = paramString3;
    this.jdField_a_of_type_JavaUtilList = paramList;
    this.jdField_a_of_type_ComTencentBizTroopVideoCombineHelper$Task = new oxp(paramVideoCombineHelper, paramTaskListener, paramString1);
  }
  ...
  public File a(File paramFile, String paramString, VideoCombineHelper.Callback paramCallback)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentBizTroopVideoCombineHelper.jdField_a_of_type_ComTencentBizQqstoryUtilsFfmpegFFmpeg.a(str2, paramFile.getAbsolutePath(), str3, i, j, new oxl(this, paramCallback, str3));
    }
  ...
  public void a()
  {
    ...
    a(this.jdField_a_of_type_JavaUtilList, str, new oxf(this, localCombineParams));
  }
  ...
  public void a(List paramList, String paramString, VideoCombineHelper.Callback paramCallback)
  {
    ...
    try
    {
      ...
      a(this.jdField_a_of_type_JavaUtilList, paramList.getAbsolutePath(), new oxj(this, l, paramCallback, paramList));
      return;
    }
  ...
  public void a(List paramList, String paramString, oxo paramoxo)
  {
    ...
    if (i < paramList.size())
    {
      ...
      for (;;)
      {
        ...
        ((FFmpegCommandUnit)localObject4).jdField_a_of_type_ComTencentBizQqstoryUtilsFfmpegFFmpegExecuteResponseCallback = new oxk(this, paramoxo);
    ...
    paramString.jdField_a_of_type_ComTencentBizQqstoryUtilsFfmpegFFmpegExecuteResponseCallback = paramoxo;
