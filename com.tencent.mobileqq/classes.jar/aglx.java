...
public class aglx
  implements agll, Handler.Callback, View.OnClickListener, View.OnTouchListener
{
  ...
  anvi jdField_a_of_type_Anvi = new aglz(this);
  private auzb jdField_a_of_type_Auzb;
  auzh jdField_a_of_type_Auzh = new agmb(this);
  axge jdField_a_of_type_Axge;
  private bisl jdField_a_of_type_Bisl;
  public QQAppInterface a;
  FaceDecoder.DecodeTaskCompletionListener jdField_a_of_type_ComTencentMobileqqAppFaceFaceDecoder$DecodeTaskCompletionListener = new agma(this);
  ...
  public aglx(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, Context paramContext, String paramString)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity = paramFragmentActivity;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaLangString = paramString;
    paramQQAppInterface = LayoutInflater.from(paramContext).inflate(2131559336, null);
    this.jdField_a_of_type_AndroidViewView = paramQQAppInterface.findViewById(2131376967);
    this.jdField_b_of_type_AndroidViewView = paramQQAppInterface.findViewById(2131379104);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramQQAppInterface.findViewById(2131363329));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramQQAppInterface.findViewById(2131379065));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramQQAppInterface.findViewById(2131377336));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramQQAppInterface.findViewById(2131367379));
    this.jdField_c_of_type_AndroidViewView = paramQQAppInterface.findViewById(2131365013);
    this.jdField_d_of_type_AndroidViewView = paramQQAppInterface.findViewById(2131365017);
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramQQAppInterface.findViewById(2131365016));
    this.jdField_e_of_type_AndroidViewView = paramQQAppInterface.findViewById(2131376292);
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramQQAppInterface.findViewById(2131376290));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramQQAppInterface.findViewById(2131376291));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramQQAppInterface.findViewById(2131376293));
    this.g = paramQQAppInterface.findViewById(2131366004);
    this.jdField_f_of_type_AndroidViewView = paramQQAppInterface.findViewById(2131367365);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramQQAppInterface.findViewById(2131367359));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramQQAppInterface.findViewById(2131362169));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)paramQQAppInterface.findViewById(2131381328));
    this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView = ((BounceScrollView)paramQQAppInterface.findViewById(2131377142));
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(anvx.a(2131713950));
      this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(anvx.a(2131713948));
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(anvx.a(2131713951));
    }
  ...
  private void a(IntimateInfo paramIntimateInfo)
  {
    ...
    {
      localObject3 = this.jdField_a_of_type_Axge.a();
      ...
      localObject1 = "";
      localObject2 = this.jdField_a_of_type_Axge.a();
      if (localObject2 != null) {
        localObject1 = ((axfy)localObject2).b();
      }
    ...
    if ((paramIntimateInfo.commonTroopInfoList != null) && (paramIntimateInfo.commonTroopInfoList.size() > 0))
    {
      ...
      if ((localObject1 != null) && (!TextUtils.isEmpty(((IntimateInfo.CommonTroopInfo)localObject1).troopUin)))
      {
        ...
        {
          bdla.b(null, "dc00898", "", "", "0X800A21B ", "0X800A21B ", 0, 0, "", "", "", "");
        ...
        if (this.jdField_a_of_type_Axge != null) {
          paramIntimateInfo = this.jdField_a_of_type_Axge.a();
        }
        if (paramIntimateInfo != null) {
          break label818;
        }
    ...
    for (;;)
    {
      localObject1 = (TextView)paramIntimateInfo.findViewById(2131379102);
      localObject4 = (TextView)paramIntimateInfo.findViewById(2131378985);
      ...
      if (((IntimateInfo.DNAInfo)localObject3).viceTitle != null)
      {
        ...
        if (!TextUtils.isEmpty(((IntimateInfo.DNAInfo)localObject3).linkWording))
        {
          ...
          ((SpannableString)localObject1).setSpan(new agly(this, (IntimateInfo.DNAInfo)localObject3), j, k, 33);
      ...
      for (;;)
      {
        ...
        while (i < j)
        {
          ...
          this.jdField_a_of_type_Axge.a(this.jdField_a_of_type_AndroidWidgetLinearLayout, (View)localObject1);
          i += 1;
        }
        break label391;
        ((TextView)localObject4).setText((CharSequence)localObject1);
  ...
  private void f()
  {
    ...
    for (String str = ""; (!TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) && (str.equals(this.jdField_c_of_type_JavaLangString)); str = arav.a().jdField_c_of_type_JavaLangString) {
      return;
    }
    Object localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840517);
  ...
  private void g()
  {
    ...
    if ((this.jdField_a_of_type_AndroidWidgetButton != null) && (this.jdField_f_of_type_AndroidWidgetTextView != null))
    {
      ...
      if (!localanvk.b(this.jdField_a_of_type_JavaLangString)) {
        break label78;
      }
    ...
    for (;;)
    {
      ...
      return;
      label78:
      if (!localanvk.d(this.jdField_a_of_type_JavaLangString))
      {
        this.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
        this.jdField_f_of_type_AndroidWidgetTextView.setVisibility(8);
        if (this.jdField_b_of_type_Boolean)
        {
          bdla.b(null, "dc00898", "", "", "0X800A218 ", "0X800A218 ", 0, 0, "", "", "", "");
      ...
      else
      {
        ...
        if (ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null)) {
          this.jdField_f_of_type_AndroidWidgetTextView.setBackgroundResource(2130840502);
        } else {
          this.jdField_f_of_type_AndroidWidgetTextView.setBackgroundResource(2130840503);
        }
      }
    }
  }
  ...
  public void a(axge paramaxge)
  {
    ...
    if (this.jdField_a_of_type_Axge != null) {
      this.jdField_a_of_type_Axge.c(this.jdField_a_of_type_AndroidWidgetButton);
    }
    ...
    for (;;)
    {
      ...
      catch (NumberFormatException localNumberFormatException1)
      {
        try
        {
          ...
          this.jdField_a_of_type_Auzb.a(l1, (ArrayList)localObject, null);
          if (QLog.isColorLevel()) {
      ...
      ((Message)localObject).obj = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131718971);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Axge != null) && (this.jdField_a_of_type_Axge.a() == 1)) {
        bdla.b(null, "dc00898", "", "", "0X800A214", "0X800A214", 2, 0, "", "", "", "");
      }
      bdla.b(null, "dc00898", "", "", "0X800A219 ", "0X800A219 ", 0, 0, "", "", "", "");
    ...
    Object localObject2 = this.jdField_a_of_type_Axge.a();
    if (localObject2 != null) {}
    for (localObject1 = ((axfy)localObject2).b();; localObject1 = ((TroopManager)localObject1).b(str, this.jdField_a_of_type_JavaLangString))
    {
      localObject2 = localObject1;
      ...
      bdla.b(null, "dc00898", "", "", "0X800A21A ", "0X800A21A ", this.jdField_a_of_type_Int, 0, "", "", "", "");
      ...
      localObject1 = this.jdField_a_of_type_Axge.a();
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
        azry.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (String)localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 0, -1);
        break;
      }
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
        azry.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (String)localObject1, this.jdField_a_of_type_JavaLangString, 0, -1);
        break;
      }
      QLog.e("intimate_relationship", 2, "open troop member card troop uin empty");
      break;
