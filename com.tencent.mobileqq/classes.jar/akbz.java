  ...
  implements Comparator<PhoneContact>
{
  ...
  public akbz(int[] paramArrayOfInt, Set<String> paramSet, ajxl paramajxl)
  {
    this.jdField_a_of_type_ArrayOfInt = paramArrayOfInt;
    this.jdField_a_of_type_JavaUtilSet = paramSet;
    this.jdField_a_of_type_Ajxl = paramajxl;
  }
  
  private int a(PhoneContact paramPhoneContact)
  {
    int j = bbcz.a(paramPhoneContact.detalStatusFlag, paramPhoneContact.iTermType);
    if ((j != 6) && (j != 0)) {}
  ...
  private int c(PhoneContact paramPhoneContact1, PhoneContact paramPhoneContact2)
  {
    ...
    boolean bool1 = this.jdField_a_of_type_Ajxl.a(paramPhoneContact1.unifiedCode, true);
    boolean bool2 = this.jdField_a_of_type_Ajxl.a(paramPhoneContact2.unifiedCode, true);
    if (bool1) {}
    for (;;)
    {
      return i;
