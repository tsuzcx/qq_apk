  ...
  extends bmrj
{
  ...
  public bmrt(@NonNull String paramString)
  {
    super(paramString);
  ...
  public int a(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return ((bmrv)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_Int;
    }
    return 0;
  }
  ...
  public int a(String paramString)
  {
    if ((!bdje.a(paramString)) && (this.jdField_a_of_type_JavaUtilList != null))
    {
      ...
      {
        bmrv localbmrv = (bmrv)localIterator.next();
        if (paramString.equals(localbmrv.jdField_a_of_type_JavaLangString)) {
          return localbmrv.jdField_a_of_type_Int;
        }
      }
    }
    return 0;
  ...
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return ((bmrv)this.jdField_a_of_type_JavaUtilList.get(paramInt)).b;
    }
    return null;
  }
  ...
  public List<bmrv> a()
  {
    ...
    {
      File[] arrayOfFile = ((File)localObject).listFiles(new bmru(this));
      if (arrayOfFile != null)
      {
    ...
    for (;;)
    {
      ...
      {
        localArrayList.add(new bmrv(str, localFile1.toURI().toString(), i, (String)localObject));
        j += 1;
        break;
        if (!str.endsWith(".gif")) {
          break label293;
  ...
  public void a(List<bmrv> paramList)
  {
    if (paramList == null) {
      return;
    }
  ...
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return ((bmrv)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_c_of_type_JavaLangString;
    }
    return null;
  }
