...
public class bfoi
{
  ...
  public bfoi(AbsSpinner paramAbsSpinner) {}
  ...
  public void b()
  {
    ...
    if (i < j)
    {
      ...
      if ((localView == null) || (!(localView.getTag(2131366898) instanceof Boolean))) {
        break label94;
      }
    }
    label94:
    for (boolean bool = ((Boolean)localView.getTag(2131366898)).booleanValue();; bool = true)
    {
