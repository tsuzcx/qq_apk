  ...
  implements Manager
{
  ...
  public bfoi(QQAppInterface paramQQAppInterface)
  {
  ...
  private ayjw a(String paramString)
  {
    paramString = new ayjw(paramString, 16);
    paramString.setSpan(new ForegroundColorSpan(BaseApplicationImpl.context.getResources().getColor(2131166132)), 0, paramString.length(), 33);
    return paramString;
  }
  
  public static bfoi a()
  {
    return a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
  }
  
  public static bfoi a(QQAppInterface paramQQAppInterface)
  {
    return (bfoi)paramQQAppInterface.getManager(313);
  }
  ...
  public static boolean a(int paramInt)
  {
    ...
    if ((paramInt == 0) || (paramInt == 1) || (paramInt == 3000) || (paramInt == 1009) || (paramInt == 1001) || (paramInt == 10002) || (paramInt == 10004) || (paramInt == 1003) || (paramInt == 1004) || (paramInt == 1005) || (paramInt == 1020) || (paramInt == 1000) || (paramInt == 1023) || (paramInt == 1024) || (paramInt == 1025)) {}
  ...
  public String a(String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if (aiiz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.frienduin)) {
      str = ajya.a(2131707647) + paramString;
    }
    return str;
  }
  ...
  public void a(QQMessageFacade.Message paramMessage, Intent paramIntent, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((a(paramMessage.frienduin, paramMessage.senderuin)) && (paramMessage.istroop == 1))
    {
      ...
      paramSpannableStringBuilder.append(new ayjw("[" + paramIntent + "]", 16));
      paramSpannableStringBuilder.append(a(ajya.a(2131707646)));
      paramSpannableStringBuilder.append(new ayjw(paramMessage.nickName, 16));
    }
  }
  
  public void a(QQMessageFacade.Message paramMessage, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((aiiz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin)) && (paramMessage.istroop == 0)) {
      paramSpannableStringBuilder.append(a(ajya.a(2131707648)));
    }
  }
  ...
  public String b(String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if ((bool) || ((localObject != null) && (((Boolean)localObject).booleanValue())))
    {
      ...
      localObject = ajya.a(2131707649) + paramString;
    }
    do
    {
      do
    ...
    return localResources.getString(2131699611) + paramString;
  }
  
  public void b()
  {
    ((ajti)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).j();
  }
  ...
  {
    return aiiz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin);
  }
