...
public final class amlp
  implements amlm, Handler.Callback, bfka, bfki, bfli
{
  private static amlp jdField_a_of_type_Amlp;
  private int jdField_a_of_type_Int;
  private amll jdField_a_of_type_Amll;
  private amlq jdField_a_of_type_Amlq;
  ...
  private final ArrayList<amls> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  public boolean a;
  ...
  private int a(int paramInt1, int paramInt2)
  {
    ...
    String str;
    Bundle localBundle;
    if ((this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper != null) && (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amlu != null) && (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amlu.jdField_a_of_type_JavaLangString != null))
    {
      str = this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amlu.jdField_a_of_type_JavaLangString;
      localBundle = new Bundle();
      localBundle.putString(bfjy.b, "100686848");
      localBundle.putString(bfjy.j, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.strNewSoftwareURL);
      localBundle.putString(bfjy.f, this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName());
      localBundle.putInt(bfjy.k, paramInt1);
      if (paramInt1 == 12) {
        localBundle.putBoolean(bfjy.o, true);
      }
      localBundle.putString(bfjy.i, "ANDROIDQQ.QQUPDATE");
      localBundle.putString(bfjy.l, str);
      if (paramInt2 == 0) {
        break label319;
      }
      localBundle.putString(bfjy.m, "_100686848");
    ...
    {
      localBundle.putString(bfjy.jdField_c_of_type_JavaLangString, "6633");
      localBundle.putInt(bfjy.e, this.jdField_a_of_type_Int);
      localBundle.putBoolean(bfjy.g, true);
      localBundle.putBoolean(bfjy.h, true);
      localBundle.putInt(bfjy.n, 1);
      localBundle.putInt(bfjy.A, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.bGray);
      bfju.a(BaseActivity.sTopActivity, localBundle, "biz_src_jc_update", this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail, i);
      return 0;
      str = "新版手Q";
      break;
      label319:
  ...
  {
    if (jdField_a_of_type_Amlp == null) {
      jdField_a_of_type_Amlp = new amlp();
    }
    return jdField_a_of_type_Amlp;
  }
  ...
  public static String a()
  {
    ...
    if (localObject != null)
    {
      localObject = ((amlp)localObject).jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper;
      str1 = str2;
      if (localObject != null)
      {
        str1 = str2;
  ...
  {
    return bhos.a(paramString, "nt", amlo.a());
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo != null)) {
        if ((((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iUpgradeType > 0) && (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.bNewSwitch == 1))
        {
          ...
          if (allq.a(paramQQAppInterface, ((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iNewTimeStamp)) {
            break label96;
          }
          bool1 = bool2;
        }
    ...
    for (;;)
    {
      bool2 = bool1;
      if (!bool1) {
        bool2 = ((atwc)paramQQAppInterface.getManager(244)).a();
      }
      return bool2;
      bool1 = false;
      break;
  ...
  private void b(int paramInt)
  {
    try
    {
      allq localallq = (allq)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getRuntime()).a(4);
      ...
      localallq.a(str, paramInt, this.jdField_a_of_type_JavaLangString);
      return;
    }
    finally
    {
  ...
  private void c(int paramInt)
  {
    ...
    do
    {
      ...
      localamlr = (amlr)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localamlr == null);
    if (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo != null) {
      localamlr.a(paramInt, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper, this);
    }
  ...
  private void d(int paramInt)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      if (localIterator.hasNext()) {
        ((amls)localIterator.next()).a(paramInt, this);
      }
    }
  }
  ...
  private void g()
  {
    try
    {
      if (!a())
      {
        this.jdField_a_of_type_Amlq = new amlq(this);
        this.jdField_a_of_type_Amlq.a();
      }
      return;
    }
    finally
  ...
  private void h()
  {
    try
    {
      if (a())
      {
        this.jdField_a_of_type_Amlq.b();
        this.jdField_a_of_type_Amlq = null;
      }
      return;
    }
    finally
  ...
  private void i()
  {
    ...
    azmj.b((QQAppInterface)localObject, "CliOper", "", "", "0X800716C", "0X800716C", 0, 0, "", "", "", "");
    int i = 0;
    this.jdField_a_of_type_Boolean = false;
    if (bdee.h(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl)) {
      i = 1;
    }
    ...
    azmz.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", true, 0L, 0L, (HashMap)localObject, "", true);
  }
  ...
  private void k()
  {
    try
    {
      ...
      if (this.d)
      {
        ...
        {
          bfju.b(this.jdField_a_of_type_Amll);
  ...
  public void a()
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo != null) && (this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo.jdField_c_of_type_Int == 1))
      {
        ...
        allq.b(localQQAppInterface, false);
        d(false);
        return;
      }
    } while (this.b);
    b(allq.a(localQQAppInterface, false));
  }
  ...
  public void a(int paramInt)
  {
    ...
    {
      azmz.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeWritten", bool, 0L, 0L, localHashMap, "", true);
      return;
    }
  }
  ...
  public void a(amls paramamls)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(paramamls)) {
        this.jdField_a_of_type_JavaUtilArrayList.add(paramamls);
      }
      return;
    }
  }
  ...
  {
    String str = allq.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl);
  ...
  public void a(String paramString)
  {
    ...
    b(this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amlu.jdField_a_of_type_Int);
  }
  ...
  public void a(ArrayList<ApkUpdateDetail> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      {
        if (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amlu.jdField_a_of_type_Int == paramArrayList.versioncode) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Amll == null)
        {
          ...
          this.jdField_a_of_type_Amll = new amll(paramString2, this);
          bfju.a(this.jdField_a_of_type_Amll);
      ...
      if (i != 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amlu = null;
        c(-1);
      }
    }
  }
  ...
  boolean a()
  {
    return this.jdField_a_of_type_Amlq != null;
  }
  ...
  public boolean a(UpgradeInfo paramUpgradeInfo, amlr paramamlr)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amlu = allq.a(paramUpgradeInfo);
    if ((paramamlr == null) || (paramUpgradeInfo == null)) {
      return false;
    }
    ...
    j();
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramamlr);
    if (QLog.isColorLevel()) {
      QLog.d("UpgradeController", 2, "handleUpgradeInfo packageName = " + this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName() + ", bGray = " + paramUpgradeInfo.bGray + ", versioncode = " + this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amlu.jdField_a_of_type_Int);
    }
    paramUpgradeInfo = new ApkUpdateParam(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName(), paramUpgradeInfo.bGray, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Amlu.jdField_a_of_type_Int);
    paramamlr = new ArrayList();
    paramamlr.add(paramUpgradeInfo);
    bflh.a().b(paramamlr);
    return true;
  }
  ...
  public void b(amls paramamls)
  {
    ...
    {
      if (this.jdField_a_of_type_JavaUtilArrayList.contains(paramamls)) {
        this.jdField_a_of_type_JavaUtilArrayList.remove(paramamls);
      }
      return;
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    allq.b(localQQAppInterface, paramBoolean);
    if (paramBoolean)
    {
      g();
      return;
  ...
  public void c()
  {
    ...
    //   18: aload_0
    //   19: getfield 243	amlp:b	Z
    //   22: ifeq +21 -> 43
    //   25: aload_0
    //   26: iconst_0
    //   27: putfield 243	amlp:b	Z
    //   30: aload_0
    //   31: invokevirtual 760	amlp:e	()V
    //   34: aload_0
    //   35: invokespecial 762	amlp:h	()V
    //   38: ldc 138
    //   40: invokestatic 764	bfju:a	(Ljava/lang/String;)V
    //   43: aload_0
    //   44: monitorexit
    //   45: return
    //   46: astore_1
  ...
  public void onDownloadError(DownloadInfo paramDownloadInfo, int paramInt1, String paramString, int paramInt2)
  {
    ...
    azmz.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", false, 0L, 0L, paramDownloadInfo, "", true);
  }
  ...
  public void onDownloadFinish(DownloadInfo paramDownloadInfo)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
      ...
      {
        paramDownloadInfo = bfkb.a().a(paramDownloadInfo);
        localObject1 = localObject2;
    ...
    for (;;)
    {
      int k = aowf.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl);
      ...
      for (i = 101;; i = 9527)
      {
        ...
        azmz.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", false, 0L, 0L, (HashMap)localObject1, "", true);
        if (bool) {
          break;
        }
        this.jdField_a_of_type_Bhow.sendEmptyMessage(0);
        return;
