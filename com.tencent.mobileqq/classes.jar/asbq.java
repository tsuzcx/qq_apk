  ...
  implements asbh
{
  ...
  public asbq(String paramString)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramString.getDrawable(2130838001);
      this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = paramString.getDrawable(2130843701);
      return;
    }
  ...
  private void a()
  {
    ...
    try
    {
      ...
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = localResources.getDrawable(2130847098);
      this.d = localResources.getDrawable(2130847099);
  ...
  public static void a(URLDrawable paramURLDrawable)
  {
    ...
    if (paramURLDrawable != null)
    {
      ...
      if ((localObject != null) && ((localObject instanceof GifDrawable)))
      {
        ...
        if ((localObject == null) || (!(localObject instanceof asdg))) {
          break label72;
        }
        ((asdg)localObject).b();
        ((asdg)localObject).a();
    ...
    do
    {
      ...
      {
        return;
      } while ((localObject == null) || (!(localObject instanceof asdh)));
      ((asdh)localObject).b();
      ((asdh)localObject).a();
      paramURLDrawable.invalidateSelf();
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    ...
    if (paramEmoticon.isNewSoundEmoticon()) {
      awmr.a(paramQQAppInterface, "0X800A932", paramSessionInfo.jdField_a_of_type_Int, paramEmoticon.epId);
    }
  ...
  private void a(QQAppInterface paramQQAppInterface, URL paramURL, EmoticonPackage paramEmoticonPackage, boolean paramBoolean, URLDrawable paramURLDrawable)
  {
    if (paramQQAppInterface != null)
    {
      ...
      if ((paramEmoticonPackage == null) && (!paramBoolean) && (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null) && (!(paramURLDrawable.getCurrDrawable() instanceof ApngDrawable)))
      {
        ...
        paramQQAppInterface.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, new asbr(this, paramURL));
      }
    }
  }
  ...
  public static void b(URLDrawable paramURLDrawable)
  {
    if (paramURLDrawable != null)
    {
      ...
      if ((paramURLDrawable != null) && ((paramURLDrawable instanceof GifDrawable)))
      {
        ...
        if ((paramURLDrawable == null) || (!(paramURLDrawable instanceof asdg))) {
          break label61;
        }
        ((asdg)paramURLDrawable).b();
        if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        return;
      } while ((paramURLDrawable == null) || (!(paramURLDrawable instanceof asdh)));
      ((asdh)paramURLDrawable).b();
    } while (!QLog.isColorLevel());
    QLog.d("PicEmoticonInfo", 2, "soundgif stopSoundDrawablePlay stop");
  }
  ...
  {
    adrm.a(paramQQAppInterface, paramContext, paramSessionInfo, paramEmoticon, paramStickerInfo);
    paramSessionInfo = "";
    int m = -1;
    ...
    bcst.b(paramQQAppInterface, "CliOper", "", "", "ep_mall", "0X80057A9", 0, 0, paramEmoticon.epId, "", paramContext, paramEmoticon.eId);
  }
  ...
  private static void d(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    ...
    bcst.b(paramQQAppInterface, "CliOper", "", "", "MbFasong", "MbIDDianji", 0, 0, paramEmoticon.epId, "", "", "");
    ((awmr)paramQQAppInterface.getManager(14)).a(paramEmoticon.epId, -1, new asbu(paramContext, paramQQAppInterface, paramEmoticon, localarup, paramSessionInfo, paramStickerInfo));
  }
  ...
  private static void e(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, Emoticon paramEmoticon, EmojiStickerManager.StickerInfo paramStickerInfo)
  {
    ...
    bcst.b(paramQQAppInterface, "CliOper", "", "", "ep_mall", "0X800579D", 0, 0, paramEmoticon.epId, "", "", "");
    localObject = (arup)paramQQAppInterface.getManager(43);
    ((awmr)paramQQAppInterface.getManager(14)).a(paramEmoticon.epId, 0, new asbw(paramContext, paramQQAppInterface, paramEmoticon, (arup)localObject, paramSessionInfo));
    c(paramQQAppInterface, paramContext, paramSessionInfo, paramEmoticon, paramStickerInfo);
  }
  ...
  public URLDrawable a()
  {
    ...
    {
      return localObject1;
      String str = arze.q.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      localObject1 = localObject4;
      if (str == null) {
        continue;
      }
  ...
  public URLDrawable a(String paramString, boolean paramBoolean1, boolean paramBoolean2, ahcu paramahcu)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null) {}
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramahcu != null)
        {
          localObject1 = paramahcu.e.getDrawable();
          paramahcu = BaseApplicationImpl.getApplication().waitAppRuntime(null);
          if ((paramahcu instanceof QQAppInterface))
          {
            paramahcu = (QQAppInterface)paramahcu;
            ...
            if (paramahcu != null)
            {
              localObject1 = (awmr)paramahcu.getManager(14);
              if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null)
              {
                localObject1 = ((awmr)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, 0);
      ...
      catch (MalformedURLException paramString)
      {
        for (;;)
        {
          ...
          continue;
          a(paramahcu, paramString, (EmoticonPackage)localObject1, paramBoolean1, (URLDrawable)localObject2);
          continue;
          paramBoolean1 = false;
          continue;
  ...
  public URLDrawable a(String paramString, boolean paramBoolean1, boolean paramBoolean2, ahcu paramahcu, int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null) {}
    for (;;)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo, boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      ...
      {
        return;
        paramEditText = (arup)paramQQAppInterface.getManager(43);
        if ((this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.jobType != 2) || (!paramBoolean) || ((!(paramContext instanceof SplashActivity)) && (!(paramContext instanceof ChatActivity))) || (!awgs.a())) {
          break label226;
        }
        if (paramEditText.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, Boolean.valueOf(false))) {
          break;
        }
        ChatActivityUtils.a(paramContext, 2131689909, 0);
        paramQQAppInterface = paramQQAppInterface.getHandler(ChatActivity.class);
      } while (paramQQAppInterface == null);
      paramQQAppInterface.obtainMessage(10).sendToTarget();
      paramQQAppInterface.obtainMessage(21).sendToTarget();
      return;
      paramInt = awgb.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, 0);
      if (QLog.isColorLevel()) {
        QLog.d("PicEmoticonInfo", 2, "forward,【maxInt:】" + paramInt);
      }
      paramInt = awfd.a(paramInt);
      ((awmr)paramQQAppInterface.getManager(14)).a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, new asbs(this, paramQQAppInterface, paramInt, paramContext, paramSessionInfo));
      return;
      ...
      for (;;)
      {
        adrm.a(paramQQAppInterface, paramContext, paramSessionInfo, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, paramInt);
        return;
        if (QLog.isColorLevel()) {
  ...
  public boolean d()
  {
    ...
    Object localObject = arze.s.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      {
        localObject = arze.o.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
        if (localObject == null) {
          break label165;
        }
        localObject = new File((String)localObject);
  ...
  public boolean e()
  {
    ...
    {
      localObject = arze.p.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      label52:
      if (localObject == null) {
        break label112;
      }
    ...
    {
      return bool;
      localObject = arze.q.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId).replace("[eId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
      break label52;
      label112:
      break;
      label114:
