...
{
  public aevm(NearbyProfileEditTribePanel paramNearbyProfileEditTribePanel, int paramInt) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Int != 0) {
      localActionSheet.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyProfileEditTribePanel.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getString(2131437400));
    }
    ...
    localActionSheet.a(new aevn(this, paramView, localPicInfo, localActionSheet));
