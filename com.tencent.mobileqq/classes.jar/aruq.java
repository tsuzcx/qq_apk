  ...
  implements DialogInterface.OnClickListener
{
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      break;
      arum.a(this.a, "user_click", "more_about", "share", "success");
      continue;
      arum.a(this.a, "user_click", "custom_button", "share_QQ", "success");
      continue;
      arum.a(this.a, "user_click", "more_button", "share_QQ", "success");
    }
    label267:
    if (this.a.f())
    {
      if ((arum.a(this.a) != null) && (!arum.a(this.a).isEmpty()))
      {
        paramDialogInterface = arum.a(this.a).iterator();
        while (paramDialogInterface.hasNext())
        {
          localObject1 = (ResultRecord)paramDialogInterface.next();
          if (((ResultRecord)localObject1).b == 6000) {
            this.a.b(aruc.f.intValue());
          } else if (((ResultRecord)localObject1).b == 6003) {
            this.a.b(aruc.k.intValue());
          }
        }
        if ((arum.b(this.a) == null) || (arum.b(this.a).isEmpty()))
        {
        ...
        this.a.jdField_a_of_type_AndroidOsBundle.putParcelableArrayList("forward_multi_target", arum.b(this.a));
        this.a.jdField_a_of_type_AndroidContentIntent.putParcelableArrayListExtra("forward_multi_target", arum.b(this.a));
      }
      this.a.d();
      if (this.a.c) {}
      for (;;)
      {
        if ((this.a.jdField_a_of_type_AndroidOsBundle != null) && (this.a.jdField_a_of_type_AndroidOsBundle.getBoolean("k_forward_show_direct_share_tips", false))) {
          azmj.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A4A2", "0X800A4A2", 0, 0, "0", "", "", "");
        }
        arum.b(this.a);
    ...
    if (((bcjl)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a((String)localObject2, true).a)
    {
      QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131697832, 0).b(this.a.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298914));
      return;
    }
    bool1 = false;
    ...
    if (this.a.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("forward_source_from_shoot_quick", false))
    {
      ...
      if (i == 21)
      {
        ...
        label948:
        azmj.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", paramDialogInterface, paramDialogInterface, 0, 0, "", "", "", "");
      }
    }
    else
    {
    ...
    for (;;)
    {
      ...
      catch (Throwable paramDialogInterface)
      {
        ...
        continue;
        if (i != aruc.j.intValue()) {
          continue;
        }
        this.a.y();
        continue;
        if (i != aruc.m.intValue()) {
          continue;
        }
        this.a.z();
        continue;
        if (i != aruc.e.intValue()) {
          continue;
        }
        paramDialogInterface = null;
        if (!(this.a.jdField_a_of_type_Bdfq instanceof bdgl)) {
          continue;
        }
        paramDialogInterface = ((bdgl)this.a.jdField_a_of_type_Bdfq).a();
      ...
      if ((this.a.jdField_a_of_type_AndroidOsBundle != null) && (this.a.jdField_a_of_type_AndroidOsBundle.getBoolean("forward_report_confirm")))
      {
        ...
        azmj.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", paramDialogInterface, paramDialogInterface, 0, 0, (String)localObject1, "", "", "");
      }
      bool1 = false;
      if (this.a.jdField_a_of_type_AndroidOsBundle != null)
      {
      ...
      if ((this.a.jdField_a_of_type_AndroidOsBundle != null) && (!bool1))
      {
        ...
        if (localObject2 != null)
        {
          ...
          if (paramDialogInterface != null)
          {
            localObject3 = azqu.a(paramDialogInterface);
            if (localObject3 != null)
            {
              localObject1 = this.a.jdField_a_of_type_AndroidOsBundle.getString("uin");
              paramDialogInterface = (DialogInterface)localObject1;
      ...
      if (this.a.c) {
        bfdq.a().a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "", String.valueOf(str1), "1000", "50", "0", false);
      }
      ...
      if ((this.a.jdField_a_of_type_AndroidOsBundle != null) && (this.a.jdField_a_of_type_AndroidOsBundle.getBoolean("KEY_FROM_OCR", false))) {
        azmj.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009C8E", "0X8009C8E", 0, 0, "", "", "", "");
      }
      ...
      azmj.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009C85", "0X8009C85", 0, 0, "", "", "", "");
      break;
      if (i != 1) {
        break label948;
      }
