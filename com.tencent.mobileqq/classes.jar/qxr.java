  ...
  implements Cloneable
{
  ...
  public SpannableStringBuilder a(int paramInt, ArticleInfo paramArticleInfo, String paramString, pql parampql)
  {
    return SocializeFeedsInfo.a(paramInt, paramArticleInfo, paramString, parampql, this.jdField_a_of_type_JavaUtilList);
  }
  
  public SpannableStringBuilder a(ArticleInfo paramArticleInfo, String paramString, pql parampql)
  {
    return SocializeFeedsInfo.a(paramArticleInfo, paramString, parampql, this.jdField_a_of_type_JavaUtilList);
  }
  ...
  public qxr a()
  {
    try
    {
      qxr localqxr = (qxr)super.clone();
      try
      {
        localqxr.jdField_a_of_type_JavaUtilList = new ArrayList();
        ...
        while (localIterator.hasNext())
        {
          ...
          localqxr.jdField_a_of_type_JavaUtilList.add(localBiuCommentInfo.a());
        }
        return localqxr;
      }
