  ...
  extends bcvs
{
  ...
  List<bcvs> jdField_a_of_type_JavaUtilList = null;
  ...
  private View a(View paramView)
  {
    ...
    ((ImageView)localObject).setImageResource(2130844433);
    int i = afur.a(9.0F, paramView.getResources());
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(afur.a(8.0F, paramView.getResources()), i);
    localLayoutParams.leftMargin = afur.a(24.0F, paramView.getResources());
    localLayoutParams.rightMargin = afur.a(4.0F, paramView.getResources());
    localLinearLayout.addView((View)localObject, localLayoutParams);
    paramView.setPadding(0, 0, 0, 0);
    localObject = paramView.findViewById(2131379927);
    if (localObject != null) {
  ...
  private void a(Resources paramResources, ImageView paramImageView)
  {
    ...
    {
      paramImageView.setBackgroundResource(2130844432);
      return;
    }
    paramImageView.setBackgroundResource(2130844431);
  }
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localObject2 = (bcvs)this.jdField_a_of_type_JavaUtilList.get(i);
      paramView = ((bcvs)localObject2).jdField_a_of_type_JavaLangString;
      if (!"summary".equals(paramView)) {
        break label334;
      }
      paramView = new LinearLayout(paramContext);
      paramView.setId(2131377931);
      paramView.setOrientation(0);
      localObject1 = new LinearLayout.LayoutParams(-1, afur.a(42.0F, localResources));
      ((LinearLayout.LayoutParams)localObject1).leftMargin = afur.a(13.0F, localResources);
      ((LinearLayout.LayoutParams)localObject1).rightMargin = afur.a(13.0F, localResources);
      ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
      localObject3 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377932);
      ...
      ((ImageView)localObject1).setId(2131377930);
    ...
    do
    {
      for (;;)
      {
        ...
        paramView = ((bcvs)localObject2).a(paramContext, null, paramBundle);
        ...
        ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
        ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
        localObject2 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377932);
    ...
    label430:
    Object localObject1 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377932);
    paramView = (View)localObject1;
    if (localObject1 == null)
    {
      paramView = new LinearLayout(paramContext);
      paramView.setOrientation(1);
      paramView.setId(2131377932);
      if (!this.jdField_a_of_type_Boolean) {
        break label646;
      }
    ...
    for (;;)
    {
      ...
      paramView.setBackgroundColor(localResources.getColor(2131167152));
      ((LinearLayout.LayoutParams)localObject1).leftMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).rightMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
      this.jdField_a_of_type_AndroidViewViewGroup.addView(paramView, (ViewGroup.LayoutParams)localObject1);
      localObject3 = ((bcvs)localObject2).a(paramContext, null, paramBundle);
      ...
      localObject2 = new LinearLayout.LayoutParams(-1, afur.a(48.0F, localResources));
      ((LinearLayout.LayoutParams)localObject2).gravity = 16;
      paramView.addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
      this.o += 1;
      break;
  ...
  public void a()
  {
    ...
    {
      return;
      localLinearLayout = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377932);
    } while (localLinearLayout == null);
    localLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Boolean = false;
    a(this.jdField_a_of_type_AndroidContentContext.getResources(), (ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377930));
  }
  ...
  public boolean a(bcxj parambcxj)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_JavaLangString = parambcxj.a("url");
      this.o = 0;
      Object localObject = parambcxj.a("expand");
      if ((localObject != null) && (((String)localObject).toLowerCase().equals("true"))) {
        this.jdField_a_of_type_Boolean = true;
      }
      localObject = parambcxj.a("animation");
      if ((localObject != null) && (((String)localObject).toLowerCase().equals("false"))) {
        this.jdField_b_of_type_Boolean = false;
      }
      localObject = parambcxj.a("duration");
      if (localObject != null) {}
      try
      {
        this.jdField_c_of_type_Long = Long.parseLong((String)localObject);
        label157:
        if ((parambcxj.jdField_a_of_type_JavaUtilList != null) && (parambcxj.a() > 0))
        {
          Iterator localIterator = parambcxj.jdField_a_of_type_JavaUtilList.iterator();
          localObject = null;
          if (localIterator.hasNext())
          {
            bcxj localbcxj = (bcxj)localIterator.next();
            if (("summary".equals(localbcxj.jdField_b_of_type_JavaLangString)) || ("hr".equals(localbcxj.jdField_b_of_type_JavaLangString))) {
              parambcxj = bcwc.a(localbcxj.jdField_b_of_type_JavaLangString);
            }
            do
            {
              localObject = parambcxj;
              if (parambcxj == null) {
                break;
              }
              localObject = parambcxj;
              if (!parambcxj.a(localbcxj)) {
                break;
              }
              a(parambcxj);
              localObject = parambcxj;
              break;
              parambcxj = (bcxj)localObject;
            } while (!"item".equals(localbcxj.jdField_b_of_type_JavaLangString));
            parambcxj = localbcxj.a("layout");
            try
            {
              if (!TextUtils.isEmpty(parambcxj)) {}
              for (int i = Integer.parseInt(parambcxj);; i = 0)
              {
                parambcxj = bcwc.a(i);
                this.o += 1;
                break;
  ...
  public void b()
  {
    ...
    {
      return;
      localObject1 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377932);
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      if (this.jdField_b_of_type_Boolean)
      {
        localObject2 = new bcwz((ViewGroup)localObject1);
        ((bcwz)localObject2).setDuration(this.jdField_c_of_type_Long);
        ((bcwz)localObject2).setInterpolator(new DecelerateInterpolator());
      ...
      for (;;)
      {
        ...
        localObject2 = (bjhb)((QQAppInterface)localObject3).a(85);
        localObject3 = new StringBuilder();
        ((StringBuilder)localObject3).append(this.d).append("&expand=").append(this.jdField_a_of_type_Boolean);
        ((bjhb)localObject2).a(((StringBuilder)localObject3).toString(), 1, false, 0.0D, 0.0D, (String)localObject1, 1, "", "", "");
        return;
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      localObject2 = new bcwy((ViewGroup)localObject1);
      ((bcwy)localObject2).setDuration(this.jdField_c_of_type_Long);
      ((bcwy)localObject2).setInterpolator(new AccelerateInterpolator());
      ((LinearLayout)localObject1).startAnimation((Animation)localObject2);
    }
    for (;;)
    {
