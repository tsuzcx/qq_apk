...
public class arhk
{
  ...
  public String a;
  List<arhr> jdField_a_of_type_JavaUtilList = new ArrayList();
  public boolean a;
  public byte[] a;
  public String b;
  public boolean b;
  ...
  void a(AppInterface paramAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localJSONObject.put("openid", this.jdField_a_of_type_Arek.a().jdField_b_of_type_JavaLangString);
        localJSONObject.put("accesstoken", this.jdField_a_of_type_Arek.a().jdField_a_of_type_JavaLangString);
  ...
  public void a(AppInterface paramAppInterface, arhs paramarhs)
  {
    if (!bbkb.d(paramAppInterface.getApp().getApplicationContext())) {
      return;
    }
    if (this.jdField_a_of_type_Long == 0L)
    {
      b(paramAppInterface);
      paramAppInterface = new arho(this, paramAppInterface, paramarhs);
      this.jdField_a_of_type_JavaUtilList.add(paramAppInterface);
      return;
    }
    b(paramAppInterface, paramarhs);
  }
  ...
  public void a(AppInterface paramAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Long == 0L)
      {
        this.jdField_a_of_type_JavaUtilList.add(new arhl(this, paramAppInterface));
        b(paramAppInterface);
        return;
      }
    }
  ...
  public void b(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Arek.a(paramAppInterface, "", paramAppInterface.getApplication(), "101462571", new arhm(this, paramAppInterface));
  }
  
  void b(AppInterface paramAppInterface, arhs paramarhs)
  {
    if (this.jdField_a_of_type_Boolean) {
      return;
    }
    ...
    localObject = new NewIntent(paramAppInterface.getApplication(), mxe.class);
    ((NewIntent)localObject).putExtra("cmd", this.f + ".0x2791_0x1");
    ((NewIntent)localObject).putExtra("data", localiLiveRequest.toByteArray());
    ((NewIntent)localObject).setObserver(new arhp(this, paramarhs));
  ...
  public void b(AppInterface paramAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      paramString.put("openid", this.jdField_a_of_type_Arek.a().jdField_b_of_type_JavaLangString);
      paramString.put("accesstoken", this.jdField_a_of_type_Arek.a().jdField_a_of_type_JavaLangString);
  ...
  public void c(AppInterface paramAppInterface)
  {
    ...
    ((NewIntent)localObject).putExtra("data", localiLiveRequest.toByteArray());
    ((NewIntent)localObject).setObserver(new arhq(this));
    paramAppInterface.startServlet((NewIntent)localObject);
  }
}
