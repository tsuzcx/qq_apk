...
public class anuq
  implements alfq
{
  public anuq(FrameHelperActivity paramFrameHelperActivity) {}
  ...
  public void a(int paramInt)
  {
    ...
    alfq[] arrayOfalfq = this.a.jdField_a_of_type_ArrayOfAlfq;
    int j = arrayOfalfq.length;
    while (i < j)
    {
      alfq localalfq = arrayOfalfq[i];
      if (localalfq != null) {
        localalfq.a(paramInt);
      }
      i += 1;
    }
    this.a.d(true);
  ...
  public void a(int paramInt, float paramFloat)
  {
    ...
    if ((!this.a.getActivity().isFinishing()) && (FrameHelperActivity.a(this.a) != null) && (bkxw.a()))
    {
      localObject1 = FrameHelperActivity.a(this.a).a(bkxw.a);
      if (localObject1 != null) {
        ((blgc)localObject1).c();
      }
    }
    if (Build.VERSION.SDK_INT >= 11) {}
    Object localObject1 = this.a.jdField_a_of_type_ArrayOfAlfq;
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      if (Build.VERSION.SDK_INT < 11) {}
      localObject1 = this.a.jdField_a_of_type_ArrayOfAlfq;
      int j = localObject1.length;
      int i = 0;
      while (i < j)
      {
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    while (i < j)
    {
      alfq localalfq = arrayOfalfq[i];
      if (localalfq != null) {
        localalfq.a(paramInt, paramBoolean);
      }
      i += 1;
    }
    if (paramBoolean) {
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (this.a.jdField_a_of_type_AndroidViewViewGroup != null) {
      ((ImageView)this.a.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131380504)).setImageResource(0);
    }
    Object localObject1 = this.a.jdField_a_of_type_ArrayOfAlfq;
    int j = localObject1.length;
    int i = 0;
    ...
    this.a.d(false);
    localObject1 = (QQAppInterface)pkh.a();
    if (localObject1 != null) {
