...
public final class aaoc
{
  ...
  public static void a(Context paramContext, aaoe paramaaoe, int paramInt, long paramLong)
  {
    paramaaoe = a(paramContext, 1059, new GdtAd(paramaaoe.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp$AdInfo), paramaaoe.jdField_a_of_type_Int, paramaaoe.jdField_b_of_type_Int, null);
    if (paramInt == 0)
    {
      paramaaoe.internalErrorCode = 0;
      paramaaoe.errorCode1 = paramInt;
      if (paramLong == -2147483648L) {
        break label120;
      }
    }
    ...
    {
      paramaaoe.duration = paramLong;
      AdAnalysis.INSTANCE.handleAsync(new WeakReference(paramContext), new AdAnalysisEvent(paramaaoe, 102));
      return;
      if (paramInt == 1)
      {
        paramaaoe.internalErrorCode = 2;
        break;
      }
      if (paramInt == 2)
      {
        paramaaoe.internalErrorCode = 4;
        break;
      }
      paramaaoe.internalErrorCode = 0;
      break;
  ...
  public static void a(Context paramContext, aaoe paramaaoe, String paramString)
  {
    paramaaoe = a(paramContext, 1056, new GdtAd(paramaaoe.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp$AdInfo), paramaaoe.jdField_a_of_type_Int, paramaaoe.jdField_b_of_type_Int, paramString);
    AdAnalysis.INSTANCE.handleAsync(new WeakReference(paramContext), new AdAnalysisEvent(paramaaoe, 102));
  }
  
  public static void a(Context paramContext, aaoe paramaaoe, String paramString, int paramInt)
  {
    paramaaoe = a(paramContext, 1060, new GdtAd(paramaaoe.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp$AdInfo), paramaaoe.jdField_a_of_type_Int, paramaaoe.jdField_b_of_type_Int, paramString);
    paramaaoe.httpErrorCode = paramInt;
    if (paramaaoe.httpErrorCode == 200) {
      paramaaoe.internalErrorCode = 0;
    }
    for (;;)
    {
      AdAnalysis.INSTANCE.handleAsync(new WeakReference(paramContext), new AdAnalysisEvent(paramaaoe, 102));
      return;
      if (paramaaoe.httpErrorCode == -1) {
        paramaaoe.internalErrorCode = 3;
      } else {
        paramaaoe.internalErrorCode = 5;
      }
    }
  }
  
  public static void a(Context paramContext, aaoe paramaaoe, String paramString, int paramInt, long paramLong)
  {
    paramaaoe = a(paramContext, 1057, new GdtAd(paramaaoe.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp$AdInfo), paramaaoe.jdField_a_of_type_Int, paramaaoe.jdField_b_of_type_Int, paramString);
    paramaaoe.httpErrorCode = paramInt;
    if (paramaaoe.httpErrorCode == 200) {
      paramaaoe.internalErrorCode = 0;
    }
