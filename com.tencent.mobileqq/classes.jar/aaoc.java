...
public class aaoc
  implements bfph
{
  public aaoc(ChatActivityFacade.18 param18) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    {
    default: 
      if ((aanz.b != null) && (aanz.b.isShowing())) {
        aanz.b.dismiss();
      }
      return;
    }
    ...
    for (;;)
    {
      if (paramInt < aanz.a.size())
      {
        paramView = (ChatMessage)aanz.a.get(paramInt);
        if (paramView.msgtype == -2005)
        {
          localObject = apug.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForFile)paramView);
    ...
    if (BaseChatItemLayout.a)
    {
      ...
      if (paramView.a.jdField_a_of_type_Int == 1008)
      {
        ...
        axqy.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", paramView.a.jdField_a_of_type_JavaLangString, "0X80064FA", "0X80064FA", 0, 0, (String)localObject, "", "", "");
      }
    }
    ...
    {
      if (aanz.a.size() == 1) {
        ((FragmentActivity)this.a.jdField_a_of_type_AndroidContentContext).getChatFragment().a().a((ChatMessage)aanz.a.get(0));
      }
      for (;;)
      {
        ajey.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "del_multi_msg");
        return;
        ((FragmentActivity)this.a.jdField_a_of_type_AndroidContentContext).getChatFragment().a().a(aanz.a);
      }
    }
    paramInt = 0;
    while (paramInt < aanz.a.size())
    {
      aanz.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)aanz.a.get(paramInt));
      paramInt += 1;
    }
    this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(aanz.a, false);
  }
}
