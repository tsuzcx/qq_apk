  ...
  implements rkk, rkm
{
  ...
  private void a(Container paramContainer, RecommendAdData paramRecommendAdData)
  {
    ...
    {
      return;
      if (nmf.a(BaseApplicationImpl.getContext(), paramRecommendAdData.p)) {
      ...
      for (;;)
      {
        ...
        paramContainer.getComLayoutParams().mLayoutMarginLeft = actn.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        return;
  ...
  public rkj a(Context paramContext, BaseData paramBaseData, ViewGroup paramViewGroup)
  {
    ...
    return new rle(this, paramViewGroup, localProteusItemData);
  }
