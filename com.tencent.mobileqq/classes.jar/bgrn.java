...
public class bgrn
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bgro(this);
  protected Handler a;
  ...
  public bgrn(QQBrowserActivity paramQQBrowserActivity)
  {
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.b() != null)
        {
          ...
          if (paramView != null)
          {
            Object localObject = paramView.getTag(2131308843);
            if ((localObject == null) || (!((Boolean)localObject).booleanValue())) {
              break label119;
            }
            i = 1;
            paramView.setTag(2131308840, Boolean.TRUE);
            if (i != 0)
            {
  ...
  {
    View localView = this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.findViewById(2131299146);
    if (localView == null) {
      return;
    }
    if (!paramBoolean)
