  ...
  extends pqj
{
  ...
  public ppd(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qfo paramqfo, Handler paramHandler)
  {
  ...
  public static JSONObject a()
  {
    ...
    localJSONObject.put("ad_code", apch.b());
    localJSONObject.put("city_name", apch.c() + " " + apch.a());
  ...
  private void c()
  {
    ...
    localReqBody.uint32_network_type.set(pon.b());
    try
    {
    ...
    a(qfq.a("OidbSvc.0xcba", 3258, 0, localReqBody.toByteArray()));
  }
  
  private void d()
  {
    String str = (String)bnrf.a("sp_key_daily_dynamic_header_data", "");
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int i = ozk.a(paramToServiceMsg, paramFromServiceMsg, paramObject, localRspBody, false);
    ...
    if (i == 0)
    {
      if ((localRspBody.rspChannelArticle.has()) && (localRspBody.rspChannelArticle.get() != null))
      {
        ...
        if ((paramToServiceMsg.bytes_nearby_cookie.has()) && (paramToServiceMsg.bytes_nearby_cookie.get() != null))
        {
          ...
          bnrf.a("sp_key_daily_dynamic_header_data", paramToServiceMsg);
          a(paramToServiceMsg);
        }
      }
      return;
    }
    bnrf.a("sp_key_daily_dynamic_header_data", "");
