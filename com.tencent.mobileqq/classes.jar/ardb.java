  ...
  implements azwh
{
  ...
  public ardb(QQAppInterface paramQQAppInterface, Context paramContext, HorizontalListView paramHorizontalListView, HeadSetView paramHeadSetView)
  {
  ...
  {
    this.jdField_a_of_type_Arbp = paramarbp;
  ...
  public int getCount()
  {
    if (this.jdField_a_of_type_Arbp == null) {
      return 0;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131493602, null);
      paramViewGroup = new ardd(paramView);
    ...
    for (;;)
    {
      paramView.setOnClickListener(new ardc(this, str));
      Bitmap localBitmap2 = this.jdField_a_of_type_Arbp.a(paramViewGroup.jdField_a_of_type_JavaLangString);
      Bitmap localBitmap1 = localBitmap2;
      if (localBitmap2 == null) {
        localBitmap1 = bacm.a();
      }
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(localBitmap1);
      arcl.a(paramView, babh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, 0) + "正在共享位置");
      return paramView;
      paramViewGroup = (ardd)paramView.getTag();
      paramViewGroup.jdField_a_of_type_JavaLangString = str;
    }
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        if (!(localObject instanceof ardd)) {
          break label87;
        }
        localObject = (ardd)localObject;
        if ((paramString == null) || (!paramString.equals(((ardd)localObject).jdField_a_of_type_JavaLangString))) {
          break label87;
        }
        if (paramBitmap != null)
        {
          paramString = this.jdField_a_of_type_Arbp.a(paramString);
          if (paramString != null) {
            ((ardd)localObject).jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(paramString);
          }
        }
      }
      return;
