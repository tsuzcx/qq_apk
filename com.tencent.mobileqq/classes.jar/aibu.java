  ...
  implements SVHwDataSource, SVHwOutputNotify, Runnable
{
  ...
  private aibw jdField_a_of_type_Aibw = new aibw(this);
  aibx jdField_a_of_type_Aibx = new aibx(this);
  private aiby jdField_a_of_type_Aiby = new aiby(this);
  ...
  public aibu(SVHwEncoder paramSVHwEncoder, String paramString, SVHwOutputNotify paramSVHwOutputNotify, SVHwDataSource paramSVHwDataSource, boolean paramBoolean, int paramInt)
  {
  ...
  int a()
  {
    ...
    this.jdField_a_of_type_Aibw.c = this.jdField_a_of_type_Aibw.a();
    if (!bool) {
      return -2;
    }
    return 0;
  ...
  int a(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (paramBoolean)
      {
        this.jdField_a_of_type_Aibw.d = this.jdField_a_of_type_Aibw.a();
        if (!bool) {
          i1 = -3;
        }
        return i1;
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        boolean bool = false;
        continue;
        this.jdField_a_of_type_Aibw.i = this.jdField_a_of_type_Aibw.a();
      }
    }
  }
  ...
  long a()
  {
    ...
    {
      return l1;
      l2 = this.jdField_a_of_type_Aibw.b();
      l1 = l2;
  ...
  void a(boolean paramBoolean)
  {
    try
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Aibw.f = this.jdField_a_of_type_Aibw.a();
        return;
        this.jdField_a_of_type_Aibw.i = this.jdField_a_of_type_Aibw.a();
      }
      this.jdField_a_of_type_Aibw.k = this.jdField_a_of_type_Aibw.a();
    }
    catch (Exception localException)
    {
      localException.printStackTrace();
  ...
  boolean a(boolean paramBoolean)
  {
    ...
    //   3: istore_3
    //   4: aload_0
    //   5: getfield 46	aibu:jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwEncoder	Lcom/tencent/mobileqq/shortvideo/hwcodec/SVHwEncoder;
    //   8: ldc_w 452
    ...
    //   24: aload_0
    //   25: getfield 455	aibu:jdField_a_of_type_Boolean	Z
    ...
    //   53: aload_0
    //   54: getfield 455	aibu:jdField_a_of_type_Boolean	Z
    //   57: ifeq +98 -> 155
    //   60: aload_0
    //   61: iconst_0
    //   62: putfield 455	aibu:jdField_a_of_type_Boolean	Z
    //   65: aload_0
    //   66: iconst_m1
    //   67: putfield 57	aibu:jdField_b_of_type_Int	I
    //   70: aload_0
    //   71: iconst_m1
    //   72: putfield 59	aibu:jdField_c_of_type_Int	I
    //   75: iload_1
    //   76: ifeq +90 -> 166
    //   79: aload_0
    //   80: getfield 461	aibu:jdField_a_of_type_AndroidMediaMediaMuxer	Landroid/media/MediaMuxer;
    //   83: invokevirtual 466	android/media/MediaMuxer:stop	()V
    //   86: aload_0
    //   87: getfield 46	aibu:jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwEncoder	Lcom/tencent/mobileqq/shortvideo/hwcodec/SVHwEncoder;
    //   90: ldc_w 452
    ...
    //   106: aload_0
    //   107: getfield 455	aibu:jdField_a_of_type_Boolean	Z
    ...
    //   136: ifeq +52 -> 188
    //   139: aload_0
    //   140: getfield 461	aibu:jdField_a_of_type_AndroidMediaMediaMuxer	Landroid/media/MediaMuxer;
    //   143: invokevirtual 471	android/media/MediaMuxer:release	()V
    //   146: iload_3
    //   147: istore_1
    //   148: aload_0
    //   149: aconst_null
    //   150: putfield 461	aibu:jdField_a_of_type_AndroidMediaMediaMuxer	Landroid/media/MediaMuxer;
    //   153: iload_1
    //   154: istore_2
    //   155: iload_2
    //   156: ireturn
    ...
    //   165: ireturn
    //   166: aload_0
    //   167: getfield 461	aibu:jdField_a_of_type_AndroidMediaMediaMuxer	Landroid/media/MediaMuxer;
    ...
    //   185: goto -37 -> 148
    //   188: aload_0
    //   189: getfield 461	aibu:jdField_a_of_type_AndroidMediaMediaMuxer	Landroid/media/MediaMuxer;
  ...
  int b()
  {
    ...
    for (boolean bool1 = this.jdField_b_of_type_ComTencentMobileqqShortvideoHwcodecSVHwCodec.a(this.jdField_d_of_type_AndroidMediaMediaFormat, this.jdField_c_of_type_JavaLangString);; bool1 = false)
    {
      ...
      this.jdField_a_of_type_Aibw.h = this.jdField_a_of_type_Aibw.a();
      if (!bool2) {
        return -8;
      }
      return 0;
  ...
  long b()
  {
    ...
    {
      return l1;
      l2 = this.jdField_a_of_type_Aibw.c();
      l1 = l2;
    } while (l2 <= this.jdField_n_of_type_Int);
    return this.jdField_n_of_type_Int;
  }
  ...
  int c()
  {
    ...
    this.jdField_a_of_type_Aibw.b = this.jdField_a_of_type_Aibw.a();
    if (i1 != 0) {}
    int i2;
    do
    {
      ...
      this.jdField_a_of_type_Aibw.g = this.jdField_a_of_type_Aibw.a();
      i1 = i2;
    } while (i2 == 0);
    return i2;
  }
  ...
  void d()
  {
    if ((this.jdField_f_of_type_Int == 1) && (!SVHwEncoder.b(this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwEncoder)) && (!this.jdField_m_of_type_Boolean) && (this.jdField_h_of_type_Int >= 1))
    {
      ...
      new aibv(this).execute(new Void[0]);
      this.jdField_m_of_type_Boolean = true;
      this.jdField_a_of_type_Aibw.m = this.jdField_a_of_type_Aibw.a();
    }
  }
  ...
  void e()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aibw.l = this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwThumbGen.jdField_a_of_type_Long;
      this.o = true;
      return;
      label163:
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (SVHwEncoder.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwEncoder))
        {
          ...
          a(false);
          k();
          this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwEncoder.a("hw_video_time_used_msg", "HwTimeUsed_End=" + this.jdField_a_of_type_Aibw.toString());
        ...
        for (;;)
        {
          for (;;)
          {
            ...
            for (;;)
            {
              ...
              catch (IllegalStateException localIllegalStateException1)
              {
                for (;;)
                {
                  ...
                  try
                  {
                    ...
                    bool1 = this.jdField_a_of_type_Aiby.c();
                    this.jdField_a_of_type_Aiby.a();
                    if (bool1) {
                      break label3920;
                    }
              ...
              {
                localaibx1 = this.jdField_a_of_type_Aibx;
                localaibx1.jdField_a_of_type_Int += 1;
                this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwEncoder.a("hw_intel_x86__err_msg", "INFO_TRY_AGAIN_LATER: buffer = null mVideoBuferErrCount=" + this.jdField_a_of_type_Aibx.jdField_a_of_type_Int);
                if (this.jdField_a_of_type_Aibx.jdField_a_of_type_Int < 3) {
                  continue;
                }
              ...
              this.jdField_a_of_type_Aibx.jdField_a_of_type_Int = 0;
              localObject3 = localaibx1;
              if (SVHwEncoder.b(this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwEncoder))
              {
                localObject3 = localaibx1;
              ...
              for (;;)
              {
                try
                {
                  ...
                  this.jdField_a_of_type_Aibw.a(true);
              ...
              if (localBufferData.jdField_a_of_type_JavaNioByteBuffer == null)
              {
                localaibx2 = this.jdField_a_of_type_Aibx;
                localaibx2.jdField_b_of_type_Int += 1;
                this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwEncoder.a("hw_intel_x86__err_msg", "INFO_TRY_AGAIN_LATER: buffer=null mAudioBuferErrCount=" + this.jdField_a_of_type_Aibx.jdField_b_of_type_Int);
                if (this.jdField_a_of_type_Aibx.jdField_b_of_type_Int < 3) {
                  continue;
                }
              ...
              this.jdField_a_of_type_Aibx.jdField_b_of_type_Int = 0;
              localObject3 = localaibx2;
              if (SVHwEncoder.b(this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwEncoder))
              {
                localObject3 = localaibx2;
                if (this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwDataSource != null) {
              ...
              for (;;)
              {
                try
                {
                  ...
                  this.jdField_a_of_type_Aibw.a(false);
                  if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwDataSource != null) || (((SVHwEncoder.HwFrame)localObject3).jdField_a_of_type_Int != ((SVHwEncoder.HwFrame)localObject3).jdField_b_of_type_Int)) {
                    break label1020;
                  }
                  this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwEncoder.a(SVHwEncoder.b(this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwEncoder));
              ...
              else if (i1 == -2)
              {
                ...
                this.jdField_a_of_type_Aiby.a(this.jdField_a_of_type_AndroidMediaMediaFormat);
              ...
              else
              {
                ...
                {
                  this.jdField_a_of_type_Aibw.b(true);
                  ...
                  {
                    this.jdField_a_of_type_Aiby.jdField_a_of_type_Boolean = true;
                    if (this.jdField_j_of_type_Int == 0) {
                      this.jdField_a_of_type_Aiby.jdField_c_of_type_Boolean = true;
                    }
                  }
                  if (this.jdField_j_of_type_Int == 0)
                  {
                    ...
                    this.jdField_a_of_type_Aiby.jdField_b_of_type_Boolean = true;
                  }
                  label3262:
                  ...
                  this.jdField_a_of_type_Aiby.a(((MediaCodec.BufferInfo)localObject3).presentationTimeUs, true);
                  this.jdField_a_of_type_Aibw.a();
                }
                for (;;)
                {
                  try
                  {
                    ...
                    this.jdField_a_of_type_Aibw.c(true);
                  ...
                  this.jdField_a_of_type_Aiby.jdField_b_of_type_Boolean = false;
                  break label3262;
                  break;
                  label3455:
                ...
                else if (i1 == -2)
                {
                  ...
                  this.jdField_a_of_type_Aiby.b(this.jdField_b_of_type_AndroidMediaMediaFormat);
            ...
            if (((MediaCodec.BufferInfo)localObject3).size != 0)
            {
              this.jdField_a_of_type_Aibw.b(false);
              ...
              if (!this.jdField_a_of_type_Aiby.a(((MediaCodec.BufferInfo)localObject3).presentationTimeUs, false)) {
                this.jdField_a_of_type_Aibw.a();
              }
            }
            for (;;)
            {
              try
              {
                ...
                this.jdField_a_of_type_Aibw.c(false);
                if ((((MediaCodec.BufferInfo)localObject3).flags & 0x4) != 0)
                {
                  this.jdField_e_of_type_Boolean = true;
            ...
            for (;;)
            {
              ...
              a(true);
              a(false);
              this.jdField_a_of_type_ComTencentMobileqqShortvideoHwcodecSVHwEncoder.a("hw_video_time_used_msg", "HwTimeUsed=" + this.jdField_a_of_type_Aibw.toString());
              a();
            ...
            if (this.jdField_k_of_type_Boolean)
            {
              ...
              if ((bool2) && (bool1))
              {
                ...
                this.jdField_k_of_type_Boolean = false;
                this.jdField_a_of_type_Aiby.a("releaseMuxer[mEnableEncode=true]");
            ...
            try
            {
              ...
              this.jdField_a_of_type_Aibw.n = this.jdField_a_of_type_Aibw.a();
              if (this.jdField_a_of_type_Int != 0)
              {
                b(this.jdField_a_of_type_Int, 0);
                break label367;
            ...
            catch (IOException localIOException)
            {
              ...
              this.jdField_a_of_type_Aibw.o = this.jdField_a_of_type_Aibw.a();
              ...
              this.jdField_a_of_type_Aibw.p = this.jdField_a_of_type_Aibw.a();
