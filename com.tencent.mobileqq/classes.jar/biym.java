  ...
  extends Dialog
{
  ...
  public biym(@NonNull Context paramContext)
  {
  ...
  private void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)paramContext.findViewById(2131365465));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131365467));
    this.b = ((TextView)paramContext.findViewById(2131363851));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramContext.findViewById(2131364610));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramContext.findViewById(2131363683));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new biyn(this));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new biyo(this));
    this.b.setOnClickListener(new biyp(this));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new biyq(this));
