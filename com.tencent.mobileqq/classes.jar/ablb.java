  ...
  implements Handler.Callback
{
  ...
  private abld jdField_a_of_type_Abld;
  ...
  private abld jdField_b_of_type_Abld;
  private ImageSwitcher jdField_b_of_type_AndroidWidgetImageSwitcher;
  private boolean jdField_b_of_type_Boolean;
  private abld c;
  private abld d;
  
  public ablb(ImageSwitcher paramImageSwitcher1, ImageSwitcher paramImageSwitcher2, ImageView paramImageView, MqqHandler paramMqqHandler, QQAppInterface paramQQAppInterface)
  {
  ...
  private abld a(String paramString)
  {
    if (this.d != null)
    {
  ...
  private String a(int paramInt)
  {
    ...
    case 3: 
    default: 
      return ajya.a(2131706014);
    case 0: 
      return ajya.a(2131706016);
    case 1: 
      return ajya.a(2131706018);
    case 2: 
      return ajya.a(2131706017);
    }
    return ajya.a(2131706019);
  }
  ...
  private boolean b()
  {
    ...
    if ((this.jdField_a_of_type_Int >= this.jdField_a_of_type_JavaUtilArrayList.size()) || ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_JavaUtilArrayList.size() == 2)) || ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Int >= this.jdField_a_of_type_JavaUtilArrayList.size() - 1))) {
      if ((this.d != null) && (this.jdField_b_of_type_Int != 4))
      {
        ...
        this.c = this.d;
        this.d = null;
        this.jdField_b_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.c.jdField_a_of_type_Bayh);
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.d.jdField_a_of_type_Bayh);
        this.jdField_a_of_type_Abld = this.jdField_b_of_type_Abld;
        this.jdField_b_of_type_Abld = this.d;
        this.d = null;
      }
    }
    for (;;)
    {
      ...
      return true;
      label287:
      this.c = abld.a(str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      break;
      label302:
      ...
      this.jdField_b_of_type_Abld = abld.a(str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.jdField_b_of_type_Abld.jdField_a_of_type_Bayh);
      continue;
      label478:
      this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.d.jdField_a_of_type_Bayh);
      this.jdField_a_of_type_Abld = this.jdField_b_of_type_Abld;
      ...
      this.d = null;
      if (QLog.isColorLevel()) {
        QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "isPlayFinished play one" + this.jdField_b_of_type_Abld.jdField_a_of_type_JavaLangString);
      }
    }
    label553:
    return false;
  ...
  private void f()
  {
    if ((this.jdField_a_of_type_Abld != null) && (!this.jdField_a_of_type_Abld.a()))
    {
      this.jdField_a_of_type_Abld.a();
      this.jdField_a_of_type_Abld = null;
    }
    if ((this.jdField_b_of_type_Abld != null) && (!this.jdField_b_of_type_Abld.a()))
    {
      this.jdField_b_of_type_Abld.a();
      this.jdField_b_of_type_Abld = null;
    }
    if ((this.c != null) && (!this.c.a()))
    {
      this.c.a();
  ...
  void a()
  {
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilArrayList.size() > 1) && (this.jdField_a_of_type_Int > 0))
        {
          ...
          this.jdField_b_of_type_Abld = this.c;
          this.c = null;
          localObject = this.jdField_b_of_type_Abld.a();
          this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable((Drawable)localObject);
          if (QLog.isColorLevel()) {
            QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "play two" + this.jdField_b_of_type_Abld.jdField_a_of_type_JavaLangString);
          }
          this.c = a((String)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int + 1));
          if (this.c == null) {
            this.c = abld.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int + 1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          ...
          this.d = abld.a((String)localObject, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          return;
        }
      }
      catch (Throwable localThrowable)
      {
        ...
        bhph.a(localThrowable, ajya.a(2131706015));
        return;
      }
      g();
      continue;
      ...
      if (!this.c.a())
      {
        ...
        continue;
        label541:
        if ((this.jdField_b_of_type_Abld == null) || ((!this.jdField_b_of_type_Abld.a()) && (!this.jdField_b_of_type_Abld.jdField_a_of_type_JavaLangString.equals(localThrowable))))
        {
          this.jdField_b_of_type_Abld = abld.a(localThrowable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          continue;
          label587:
          this.jdField_b_of_type_Abld = a(localThrowable);
          if (this.jdField_b_of_type_Abld == null) {
            this.jdField_b_of_type_Abld = abld.a(localThrowable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          bayh localbayh = this.jdField_b_of_type_Abld.a();
          if (localbayh != null)
          {
            this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(localbayh);
            if (QLog.isColorLevel()) {
              QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "play one" + this.jdField_b_of_type_Abld.jdField_a_of_type_JavaLangString);
            }
          }
        }
      }
    ...
    {
      this.d = abld.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(0), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (this.jdField_a_of_type_Boolean)
      {
        this.c = abld.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        return;
        label772:
        if (QLog.isColorLevel())
        {
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 1))
    {
      ...
      this.d = abld.a(paramArrayList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  void a(boolean paramBoolean)
  {
    ...
    localAlphaAnimation1.setAnimationListener(new ablc(this, paramBoolean));
