  ...
  implements BusinessObserver
{
  ...
  private String d = ajya.a(2131705899);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1)) {
          paramVarArgs = xkn.c((String)localObject1, xkn.b(1));
        }
  ...
  private void b(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramVarArgs))
        {
          paramVarArgs = xkn.c(paramVarArgs, xkn.b(1));
      ...
      catch (JSONException paramVarArgs)
      {
        ...
        Object localObject = new NewIntent(this.mRuntime.a(), arpk.class);
        ...
        axqy.b(null, "dc00898", "", "", "0x800A851", "0x800A851", 2, 0, "", "", "", "");
        return;
      }
      catch (JsonORM.JsonParseException paramVarArgs)
      {
  ...
  public void callJs(String paramString, String... paramVarArgs)
  {
    if ((paramString != null) && (this.b != null) && (paramString.equals(this.b))) {
      axqy.b(null, "dc00898", "", "", "0x800A851", "0x800A851", 4, 0, "", "", "", "");
    }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("jubao".equals(paramString2))
    {
      if ("selectMsgs".equalsIgnoreCase(paramString3))
      {
        if ((paramVarArgs != null) && (paramVarArgs.length > 0))
        {
          ...
          a(paramVarArgs);
          axqy.b(null, "dc00898", "", "", "0x800A851", "0x800A851", 0, 0, "" + 0, "", "", "");
        }
        return true;
      }
    ...
    for (int i = 0;; i = 1)
    {
      axqy.b(null, "dc00898", "", "", "0x800A851", "0x800A851", 1, 0, "" + i, "", "", "");
      return true;
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    int j = 1;
    int i = 0;
    axqy.b(null, "dc00898", "", "", "0x800A851", "0x800A851", 3, 0, "", "", "", "");
    String str;
    if (paramInt == 0)
    {
      str = "";
    ...
    for (;;)
    {
      ...
      j = i;
      i = paramInt;
      axqy.b(null, "dc00898", "", "", "0x800A851", "0x800A851", 2, 0, "" + j, "" + i, "", "");
      return;
      label226:
      if (paramBundle != null)
      {
