...
public class tli
  implements View.OnClickListener, tds
{
  public static int a;
  ...
  public tli(Context paramContext, ViewGroup paramViewGroup)
  {
    this.jdField_a_of_type_Aogk = new tlj(this);
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new tlm(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewViewGroup = paramViewGroup;
    this.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131380147));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131380146));
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363494));
    ...
    try
    {
      ...
      if (paramViewGroup != null) {
        bbzh.jdField_b_of_type_JavaLangString = paramViewGroup.getString("SBWord_Source", "Hot_word");
      }
  ...
  private static void a(String paramString1, String paramString2)
  {
    ...
    olh.a(null, "", paramString1, paramString1, 0, 0, str, "", "", paramString2, false);
  }
  
  private void f()
  {
    VideoReport.setElementId(this.jdField_a_of_type_AndroidViewViewGroup, "search_box_button");
    VideoReport.setElementParams(this.jdField_a_of_type_AndroidViewViewGroup, new pti().a("14").a().b("search_box").c("click_search_box").a());
  ...
  protected void a()
  {
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131718388);
      this.jdField_b_of_type_AndroidWidgetTextView.setText(2131718388);
    }
  }
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (!bbzh.a((QQAppInterface)localObject1))
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131718388);
      this.jdField_b_of_type_AndroidWidgetTextView.setText(2131718388);
      return;
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.showType == 3)
    {
      ...
      {
        i = 1;
        bool = bbzh.a((QQAppInterface)localObject1, (String)localObject2, i);
    ...
    else
    {
      ...
      bcjs.a(null, new ReportModelDC02528().module("search_box").action("exp_default_word").ver2(bcjs.a(25)).ver4(this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.title).ver7(bbzh.jdField_b_of_type_JavaLangString));
      new aogi((QQAppInterface)localObject1).b((QQAppInterface)localObject1, "exp_default_word", "search_box", bcjs.a(25), this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.sAppend, this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.title, bbzh.jdField_b_of_type_JavaLangString);
      if ((paramInt1 != -1) && (paramInt2 != -1))
      {
        ...
        localObject1 = "1";
        label446:
        bcjs.a(null, ((ReportModelDC02528)localObject2).ver1((String)localObject1).obj3(paramInt2 + ""));
        localObject2 = pqf.a();
      }
    }
    for (;;)
    {
      try
      {
        ((pqg)localObject2).a("channelid", paramInt2 + "");
        if (paramInt1 != 0) {
          continue;
        }
        localObject1 = "1";
        ((pqg)localObject2).a("refresh_way", (String)localObject1);
      }
      ...
      a("0X800A4C5", ((pqg)localObject2).a());
      ...
      if (paramBoolean)
      {
        ...
        ((ObjectAnimator)localObject2).addListener(new tll(this));
        break label311;
      }
      a();
      break label311;
  ...
  protected void b()
  {
    ...
    this.jdField_a_of_type_ComTencentImageURLImageView.setVisibility(8);
    bbyv.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentImageURLImageView, this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.imgUrl, this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.imgBgUrl, localtlk);
    bbzh.a(localQQAppInterface, BaseApplicationImpl.getContext(), this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.detailText, 0);
    bcjs.a(null, new ReportModelDC02528().module("search_light").action("exp_search_light").ver2(bcjs.a(25)).ver4(this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.detailText).ver7(bbzh.jdField_b_of_type_JavaLangString));
    new aogi(localQQAppInterface).b(localQQAppInterface, "exp_search_light", "search_light", bcjs.a(25), this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.sAppend, this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.detailText, bbzh.jdField_b_of_type_JavaLangString);
  }
  
  public void b(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel = new HotWordSearchEntryDataModel(localQQAppInterface, bbzh.b(), 10, false);
  ...
  public void c()
  {
    ...
    for (;;)
    {
      ...
      QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      new aogi(localQQAppInterface).a(localQQAppInterface, 10);
    }
  }
  ...
  public void e()
  {
    this.jdField_b_of_type_Boolean = false;
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    localQQAppInterface.removeObserver(this.jdField_a_of_type_Aogk);
    this.jdField_a_of_type_AndroidContentContext.unregisterReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver);
    this.jdField_a_of_type_Boolean = true;
    bhhr.a(localQQAppInterface.getCurrentAccountUin(), 10, 0);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem == null)
    {
      localObject1 = "";
      label119:
      bcjs.a(localQQAppInterface, ((ReportModelDC02528)localObject2).ver4((String)localObject1).ver7("{experiment_id:" + bcjs.jdField_b_of_type_JavaLangString + ",source:" + bbzh.jdField_b_of_type_JavaLangString + "}"));
      bcjs.a(null, 0, 25, "0X8009D15", 0, 0, null, null);
      aogi localaogi = new aogi(localQQAppInterface);
      String str = bcjs.a(25);
      if (this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem != null) {
        break label334;
      }
      localObject1 = "";
      ...
      localObject2 = "";
      label224:
      localaogi.b(localQQAppInterface, "clk_default_word", "search_box", str, (String)localObject1, (String)localObject2, "{experiment_id:" + bcjs.jdField_b_of_type_JavaLangString + ",source:" + bbzh.jdField_b_of_type_JavaLangString + "}");
      this.jdField_b_of_type_Int = 1;
