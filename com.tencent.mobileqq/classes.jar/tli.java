...
public final class tli
  extends tks
{
  public static final tlj a = new tlj(null);
  
  public tli(@NotNull BridgeModule paramBridgeModule)
  {
  ...
  private final void a(JSONObject paramJSONObject, String paramString)
  {
    if (paramJSONObject != null)
    {
      ...
      if ((paramString instanceof QQAppInterface))
      {
        ...
        ((aupc)paramString).a(paramJSONObject);
      }
    }
  }
  ...
  public void a()
  {
    a("openRoom", (Function2)new NowLiveBridgeInvokeHandler.register.1((tli)this));
    a("preload", (Function2)new NowLiveBridgeInvokeHandler.register.2((tli)this));
  }
}
