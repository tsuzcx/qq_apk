...
public abstract class uev
{
  ...
  protected String a;
  private List<uew> jdField_a_of_type_JavaUtilList;
  ...
  public uev(uez paramuez, boolean paramBoolean, int paramInt, uex paramuex)
  {
    this.jdField_a_of_type_JavaLangString = uev.class.getSimpleName();
    this.jdField_a_of_type_JavaLangString = getClass().getSimpleName();
    if ((paramuez == null) || (paramInt == -1)) {
      throw new IllegalArgumentException("no track specified");
    }
    this.jdField_a_of_type_Uez = paramuez;
    this.e = paramBoolean;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidMediaMediaFormat = paramuez.a(this.jdField_a_of_type_Int);
  ...
  public final uew a()
  {
    ...
    for (;;)
    {
      ...
      if (i >= 0)
      {
        ...
        uew localuew = (uew)this.jdField_a_of_type_JavaUtilList.get(0);
        localuew.jdField_a_of_type_Int = i;
        localuew.jdField_a_of_type_JavaNioByteBuffer = ((ByteBuffer)localObject);
        localuew.jdField_a_of_type_Long = this.jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo.presentationTimeUs;
        localuew.jdField_a_of_type_Boolean = this.jdField_b_of_type_Boolean;
        if (this.d)
        {
          this.d = false;
          localuew.jdField_b_of_type_Boolean = true;
        }
        if (localuew.jdField_a_of_type_Boolean)
        {
          Log.d(this.jdField_a_of_type_JavaLangString, "EOS output");
          return localuew;
        }
        this.jdField_a_of_type_Long = localuew.jdField_a_of_type_Long;
        return localuew;
      }
      if (i == -3)
      {
  ...
  protected uew a(ufc paramufc, long paramLong, uez paramuez, MediaCodec paramMediaCodec)
  {
    ...
    Log.d(this.jdField_a_of_type_JavaLangString, "extractor current position: " + paramuez.a());
    paramuez.a(paramLong, paramufc.a());
    Log.d(this.jdField_a_of_type_JavaLangString, "extractor new position:     " + paramuez.a());
    this.jdField_a_of_type_Boolean = false;
    this.jdField_b_of_type_Boolean = false;
    paramMediaCodec.flush();
    if (paramuez.c())
  ...
  public final uew a(boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  protected final void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaFormat = this.jdField_a_of_type_Uez.a(this.jdField_a_of_type_Int);
      ...
      {
        this.jdField_a_of_type_JavaUtilList.add(new uew());
        i += 1;
      }
  ...
  public final void a(ufc paramufc, long paramLong)
  {
    this.jdField_a_of_type_Long = -9223372036854775808L;
    this.jdField_a_of_type_Uew = a(paramufc, paramLong, this.jdField_a_of_type_Uez, this.jdField_a_of_type_AndroidMediaMediaCodec);
  }
  ...
  public final boolean a(boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return false;
          if ((this.jdField_a_of_type_Uez.b() == -1) || (this.jdField_a_of_type_Uez.b() == this.jdField_a_of_type_Int)) {
            break;
          }
        } while (!paramBoolean);
        return this.jdField_a_of_type_Uez.a();
      ...
      if (!this.jdField_a_of_type_Uez.c()) {
        break;
      }
      this.c = true;
      this.jdField_a_of_type_AndroidMediaMediaCodec.queueInputBuffer(k, 0, 0, 0L, 4);
    } while ((this.jdField_a_of_type_Uez.b() <= -1L) || (this.jdField_a_of_type_Uex == null));
    this.jdField_a_of_type_Uex.a(this);
    return false;
    if ((this.jdField_a_of_type_Uez.b() > -1L) && (this.jdField_a_of_type_Uex != null)) {
      this.jdField_a_of_type_Uex.a(this);
    }
    int i = this.jdField_a_of_type_Uez.a((ByteBuffer)localObject, 0);
    if (i < 0)
    {
    ...
    for (;;)
    {
      ...
      return paramBoolean;
      l = this.jdField_a_of_type_Uez.a();
      paramBoolean = true;
      break;
      label265:
      j = 0;
  ...
  public long b()
  {
    return this.jdField_a_of_type_Uez.b();
  }
  ...
  public final void b()
  {
    ...
    for (;;)
    {
      int i = this.jdField_a_of_type_Uez.b();
  ...
  public void b(uew paramuew)
  {
    this.jdField_a_of_type_AndroidMediaMediaCodec.releaseOutputBuffer(paramuew.jdField_a_of_type_Int, false);
    c(paramuew);
  }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Uew != null) {
      a(this.jdField_a_of_type_Uew, 0L);
    }
  }
  
  protected final void c(uew paramuew)
  {
    paramuew.a();
    this.jdField_a_of_type_JavaUtilList.add(paramuew);
  }
