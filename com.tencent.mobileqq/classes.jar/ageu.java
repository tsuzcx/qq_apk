...
public class ageu
{
  ...
  public static final Point a(Activity paramActivity, int paramInt)
  {
    ...
    for (int i = localDisplayMetrics.widthPixels;; i = localDisplayMetrics.heightPixels) {
      ...
      {
      default: 
        paramInt = i - aciy.a(65.0F, paramActivity.getResources());
  ...
  public static String a()
  {
    ...
    localStringBuilder.append(ajed.cR).append("tmp").append("/").append(System.currentTimeMillis()).append("_photo.tmp");
  ...
  {
    if (paramInt == 0) {
      return paramContext.getString(2131653474);
    }
    if (paramInt == 1) {
      return paramContext.getString(2131630685);
    }
    if (paramInt == 2) {
      return paramContext.getString(2131630684);
    }
    if (paramInt == 3) {
      return paramContext.getString(2131630686);
    }
    if (paramInt == 5) {
      return paramContext.getString(2131630683);
    }
    if (paramInt == 100) {
      return paramContext.getString(2131630667);
    }
    if (paramInt == 101) {
      return paramContext.getString(2131630668);
    }
    if (paramInt == 102) {
      return paramContext.getString(2131630665);
    }
    if (paramInt == 103) {
      return paramContext.getString(2131630669);
    }
    if (paramInt == 1793) {
      return paramContext.getString(2131627874);
    }
    return paramContext.getString(2131630682);
  }
  
  public static String a(List<afzi> paramList, TroopInfo paramTroopInfo)
  {
    String str = afzi.a;
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localTroopClipPic.type == 1) {
        ...
        paramList.add(afzi.a(localTroopClipPic, paramTroopInfo.mTroopVerifyingPics));
      }
    }
    if (com.tencent.TMG.utils.QLog.isColorLevel()) {
  ...
  public static URL a(String paramString)
  {
    ...
    do
    {
      ...
      try
      {
        paramString = axsk.a(paramString);
        return paramString;
      }
  ...
  public static void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    URL localURL = a(azge.b(azge.a(str, paramString2, 1)));
    if (localURL != null)
    {
      paramInt = a(paramString1, axoa.d(localURL.toString()));
      if (com.tencent.TMG.utils.QLog.isColorLevel()) {
        com.tencent.TMG.utils.QLog.d("TroopPhotoUtil", 0, "cacheFileFromLocal origin photo,result:" + paramInt);
      }
    }
    paramString2 = a(azge.a(azge.a(str, paramString2, 1)));
    if (paramString2 != null)
    {
      paramInt = b(paramString1, axoa.d(paramString2.toString()));
      if (com.tencent.TMG.utils.QLog.isColorLevel()) {
  ...
  public static final void a(Rect paramRect, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if ((paramString.length == 4) && (attn.a(paramString[0])) && (attn.a(paramString[1])) && (attn.a(paramString[2])) && (attn.a(paramString[3])))
      {
  ...
  public static int b(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      BitmapFactory.Options localOptions = bacm.a(((File)localObject).getPath(), 100);
      try
      {
        localObject = bacm.a(((File)localObject).getPath(), localOptions);
      ...
      try
      {
        int i = azlj.a(paramString1);
        paramString1 = (String)localObject;
        if (i != 0) {
          paramString1 = bacm.b((Bitmap)localObject, i);
        }
        if (paramString1 != null)
        {
          bacm.a(paramString1, paramString2);
          return 0;
        }
      }
