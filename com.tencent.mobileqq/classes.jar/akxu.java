...
class akxu
  implements abwu
{
  akxu(akxp paramakxp, String paramString, long paramLong) {}
  ...
  public void onSuccess(JSONObject paramJSONObject)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject1 = akwd.a(akxp.a(this.jdField_a_of_type_Akxp));
          if (localObject1 == null)
          {
            QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[getUserInfo], launcher is null, mGameId:" + akxp.a(this.jdField_a_of_type_Akxp));
            return;
          }
          localObject1 = ((akyg)localObject1).a();
          localObject2 = new akup(paramJSONObject.optString("avatarUrl"), paramJSONObject.optString("nickName"), ((CmGameInitParams)localObject1).openId);
          akxp.a(this.jdField_a_of_type_Akxp).put(((CmGameInitParams)localObject1).openId, localObject2);
      ...
      if ("cs.get_app_friends.local".equals(this.jdField_a_of_type_JavaLangString))
      {
        ...
        if ((paramJSONObject != null) && (paramJSONObject.length() != 0))
        {
          ...
          while (i < j)
          {
            ...
            localObject3 = new akup(((JSONObject)localObject2).optString("avatarUrl"), ((JSONObject)localObject2).optString("nickName"), (String)localObject3);
            akxp.a(this.jdField_a_of_type_Akxp).put(((JSONObject)localObject2).optString("openid"), localObject3);
