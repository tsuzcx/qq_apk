  ...
  implements INetEngine.INetEngineListener
{
  ...
  public akxu(int paramInt1, BigDataHandler paramBigDataHandler, byte[] paramArrayOfByte, int paramInt2, Object paramObject)
  {
  ...
  public void a(NetResp paramNetResp)
  {
    ...
    if ((paramNetResp == null) || (paramNetResp.jdField_a_of_type_Int != 0))
    {
      ...
      label130:
      for (i = paramNetResp.jdField_a_of_type_Int;; i = 0)
      {
    ...
    try
    {
      localObject2 = paramNetResp.jdField_a_of_type_ArrayOfByte;
