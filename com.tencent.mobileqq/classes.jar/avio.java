  ...
  implements avhe
{
  ...
  public avio(avil paramavil, String paramString, IVPluginInfo paramIVPluginInfo, InstalledPlugin paramInstalledPlugin, boolean paramBoolean, long paramLong)
  {
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      avil.a(this.jdField_a_of_type_Avil).a(5, new Object[] { "" });
      return;
    }
    if (paramBoolean1) {}
  ...
  public void a(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean) {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_a_of_type_AndroidOsBundle = avil.a(this.jdField_a_of_type_Avil).a().a.getExtras();
        ...
        i = 1;
        label182:
        yqu.a(str, "getLoginKey", i, (int)l1, new String[] { avil.c(this.jdField_a_of_type_Avil), paramInt + "", paramString, "8.4.1" });
        paramString = avil.a(this.jdField_a_of_type_Avil).opName(avil.a(this.jdField_a_of_type_Avil)).opType("getLoginKey");
        if (!paramBoolean) {
          break label446;
        }
      }
    ...
    for (int i = j;; i = 0)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_a_of_type_AndroidOsBundle = avlj.a(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo, avil.a(this.jdField_a_of_type_Avil));
      ...
      for (;;)
      {
        Toast.makeText(avil.a(this.jdField_a_of_type_Avil), anni.a(2131704423) + paramInt, 0).show();
        break;
        if ("Od".equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_a_of_type_JavaLangString)) {
          avjb.a("2691712");
        }
      }
      l1 = avil.b(this.jdField_a_of_type_Avil);
      break label99;
      str = "group_video";
      break label175;
      i = 0;
