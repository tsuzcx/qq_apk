  ...
  extends aubd
{
  ...
  public aubp(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (bhjr.a()) {}
    for (long l = bhjr.a() * 1024L; this.jdField_a_of_type_Aube.d > l; l = bhjr.b() * 1024L) {
      return true;
    }
    return false;
  }
  ...
  public void a()
  {
    this.jdField_a_of_type_Aube.jdField_a_of_type_Long = 5L;
    this.jdField_a_of_type_Long = 3L;
    this.jdField_a_of_type_Aube.jdField_b_of_type_Long = 9004L;
    a(false);
  }
  ...
  public void a(int paramInt1, int paramInt2, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    localaube.jdField_b_of_type_Int = this.jdField_a_of_type_Aube.jdField_b_of_type_Int;
    localaube.jdField_a_of_type_Int = this.jdField_a_of_type_Aube.jdField_a_of_type_Int;
    localaube.c = this.jdField_a_of_type_Aube.c;
    localaube.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Aube.jdField_a_of_type_JavaLangString;
    localaube.d = this.jdField_a_of_type_Aube.d;
    localaube.jdField_a_of_type_Long = paramInt1;
    localaube.jdField_b_of_type_Long = paramInt2;
    HashMap localHashMap = new HashMap();
    localHashMap.put("param_V6SelectType", String.valueOf(this.jdField_a_of_type_Int));
    if (paramExcitingTransferOneSlotComplete != null) {
      localHashMap.put("param_ipAddrType", String.valueOf(auoo.b(paramExcitingTransferOneSlotComplete.m_strIp)));
    }
    for (;;)
    {
      localHashMap.put("param_stackType", String.valueOf(auoo.b()));
      localHashMap.put("param_loginType", String.valueOf(auoo.c()));
      localHashMap.put("param_ishttps", String.valueOf(this.c));
      super.a(localaube, paramExcitingTransferOneSlotComplete, localHashMap);
      return;
  ...
  protected HashMap<String, String> b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo != null)
    {
      ...
      localHashMap.put("param_FailCode", String.valueOf(a(this.jdField_a_of_type_Aube.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo.m_nSrvReturnCode)));
      ...
      localHashMap.put("param_ipStackType", String.valueOf(auoo.a()));
    ...
    for (;;)
    {
      ...
      localHashMap.put("param_fsizeo", String.valueOf(this.jdField_a_of_type_Aube.d));
      localHashMap.put("param_PeerUin", String.valueOf(this.jdField_a_of_type_Aube.c));
      ...
      continue;
      localHashMap.put("param_FailCode", String.valueOf(this.jdField_a_of_type_Aube.jdField_b_of_type_Long));
    }
  }
  
  public void b()
  {
    this.jdField_a_of_type_Aube.jdField_a_of_type_Long = 1L;
    if (this.jdField_a_of_type_Boolean) {}
    for (this.jdField_a_of_type_Long = 3L;; this.jdField_a_of_type_Long = 2L)
    {
      this.jdField_a_of_type_Aube.jdField_b_of_type_Long = 9037L;
      a(false);
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Aube.jdField_a_of_type_Long = 2L;
    this.jdField_a_of_type_Long = 2L;
    this.jdField_a_of_type_Aube.jdField_b_of_type_Long = paramLong;
    a(false);
  }
