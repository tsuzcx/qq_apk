...
public class abpc
{
  ...
  private URLDrawable a(Context paramContext, String paramString)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = paramContext.getDrawable(2130845375);
    localURLDrawableOptions.mFailedDrawable = paramContext.getDrawable(2130845375);
    paramString = URLDrawable.getDrawable(paramString, localURLDrawableOptions);
    int i = AIOUtils.dp2px(50.0F, paramContext);
    paramString.setTag(bfol.b(i, i, AIOUtils.dp2px(12.0F, paramContext)));
    paramString.setDecodeHandler(bfol.c);
    return paramString;
  }
  
  private boolean a(abop paramabop)
  {
    paramabop = paramabop.a();
    return (paramabop.productType == 12) || (paramabop.productType == 19);
  }
  ...
  public Drawable a(Context paramContext, GdtMotiveVideoPageData paramGdtMotiveVideoPageData)
  {
    if ((paramGdtMotiveVideoPageData == null) || (TextUtils.isEmpty(paramGdtMotiveVideoPageData.bannerLogo))) {
      return paramContext.getResources().getDrawable(2130845375);
    }
  ...
  public String a(Context paramContext, abop paramabop)
  {
    String str2 = amtj.a(2131704329);
    GdtMotiveVideoPageData localGdtMotiveVideoPageData = paramabop.a();
    Object localObject = paramabop.a();
    String str1 = str2;
    if (localObject != null)
    {
      str1 = str2;
      if (!((qq_ad_get.QQAdGetRsp.AdInfo)localObject).display_info.button_info.get().isEmpty())
      {
        ...
        {
          str1 = str2;
          if (obb.a(paramContext, (String)localObject))
          {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject3))
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            paramWebView.evaluateJavascript(((StringBuffer)localObject1).toString(), new abpd(this));
            return;
          }
        }
      }
