  ...
  extends kwt
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new kym(this);
  Handler jdField_a_of_type_AndroidOsHandler;
  HandlerThread jdField_a_of_type_AndroidOsHandlerThread = new HandlerThread("VideoNodeReportThread");
  public List<kyn> a;
  
  public kyl(VideoAppInterface paramVideoAppInterface)
  {
  ...
  private void b(long paramLong1, int paramInt, long paramLong2)
  {
    ...
    {
      localObject1 = new kyn();
      ((kyn)localObject1).a = paramLong1;
    ...
    if (((kyn)localObject1).a == localkvq.b()) {
      ((kyn)localObject1).a(localkvq, (String)localObject2);
    }
    localObject2 = ((kyn)localObject1).a();
    localObject1 = ((kyn)localObject1).a(paramInt, paramLong2);
  ...
  private void c(long paramLong)
  {
    ...
    localEditor.commit();
    krx.d("VideoNodeReporter", "removeSpSessionRecord,roomId = " + paramLong);
  }
  
  kyn a(long paramLong)
  {
  ...
  protected void a()
  {
    krx.d("VideoNodeReporter", "onCreate ");
    c();
  }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    {
      krx.d("VideoNodeReporter", " report error 0: " + paramInt + "|" + this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      return;
    }
    if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.e)
    {
      krx.d("VideoNodeReporter", " report error 1 ,exit has been called,node = " + paramInt);
      return;
    }
  ...
  public void a(long paramLong1, int paramInt, long paramLong2)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentAvAppVideoAppInterface == null) || (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a() == null) || (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a() == null))
    {
      krx.d("VideoNodeReporter", " reportByRoomId error 0: " + paramInt + "|" + this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      return;
    }
    if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.e)
    {
      krx.d("VideoNodeReporter", " reportByRoomId error 1 ,exit has been called,node = " + paramInt);
      return;
    }
    if (paramLong1 == 0L)
    {
  ...
  {
    krx.d("VideoNodeReporter", " onSessionStatusChanged :" + paramInt + ",para = " + paramString2);
    switch (paramInt)
    {
    case 2: 
    case 3: 
    ...
    if (this.jdField_a_of_type_JavaUtilList.size() > 0)
    {
      ...
      while (paramString1.hasNext()) {
        ((kyn)paramString1.next()).b = System.currentTimeMillis();
      }
    }
  ...
  public void b()
  {
    try
    {
      ...
      long l1 = babp.a(Process.myPid()) / 1024L / 1024L;
