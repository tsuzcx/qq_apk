...
public class xus
{
  ...
  public xus(@NonNull QQAppInterface paramQQAppInterface)
  {
  ...
  public Intent a(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, Intent paramIntent)
  {
    ...
    Object localObject1 = (bbbq)this.a.getManager(QQManagerFactory.MGR_RED_TOUCH);
    Object localObject2 = ((bbbq)localObject1).a("103100.103500.103501");
    ...
    for (;;)
    {
      ...
      {
        ((bbbq)localObject1).b("103100.103500.103501");
      ...
      for (;;)
      {
        ...
        boolean bool2 = bdee.a(this.a, BaseApplicationImpl.getContext());
        localObject1 = aftr.a(vzh.e);
        localObject2 = new File(AppConstants.SDCARD_IMG_CAMERA);
        if (!((File)localObject2).exists()) {
          ((File)localObject2).mkdirs();
        }
        return wei.a(paramContext, paramBoolean2, paramIntent, paramBoolean1, bool1, bool2, (String)localObject1, this.a.getAccount());
        paramBoolean1 = false;
        break;
      }
      paramBoolean1 = false;
