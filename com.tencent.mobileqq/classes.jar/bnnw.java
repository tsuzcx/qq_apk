  ...
  implements Handler.Callback
{
  ...
  private bnof a()
  {
    bnof localbnof = this.jdField_a_of_type_Bnnx.a.b();
    if (localbnof != null) {
      return localbnof;
    }
    localbnof = this.jdField_a_of_type_Bnnx.a.a();
    if (localbnof != null)
    {
      this.jdField_a_of_type_Bnnz.a(localbnof.jdField_a_of_type_Int, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      return localbnof;
    }
    return null;
  }
  ...
  {
    this.jdField_a_of_type_Bnny.jdField_a_of_type_Int = paramAVIOStruct.pFrameIndex;
    paramAVIOStruct.pFrameIndex = 0;
    this.jdField_a_of_type_Bnny.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Bnny.jdField_b_of_type_Int = 0;
    bneh.a("handleMessage:writeVideoFrame[false]  mThumbPicControl.mSendThumbOKIndex=" + this.jdField_a_of_type_Bnny.jdField_a_of_type_Int);
  }
  ...
  private boolean a()
  {
    boolean bool2 = true;
    bool1 = false;
    synchronized (bnnx.a(this.jdField_a_of_type_Bnnx))
    {
      Object localObject2 = bnnx.a(this.jdField_a_of_type_Bnnx);
  ...
  private void f()
  {
    if (this.jdField_a_of_type_Bnnz != null) {
      this.jdField_a_of_type_Bnnz.c();
    }
    this.jdField_a_of_type_Bnnz = null;
    a();
  ...
  {
    b(false);
    bnbe.a("destroy OffScreenGLSurface");
  }
  
  public void a(int paramInt1, int paramInt2, bncz parambncz)
  {
    this.jdField_c_of_type_Int = paramInt1;
    this.jdField_d_of_type_Int = paramInt2;
    this.jdField_a_of_type_Int = parambncz.jdField_c_of_type_Int;
    this.jdField_b_of_type_Int = parambncz.jdField_d_of_type_Int;
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_DovComTencentMobileqqShortvideoUtilOffScreenInputSurface != null)
    {
      if (paramBoolean)
      {
        this.jdField_a_of_type_Bnnz = new bnnz();
        this.jdField_a_of_type_Bnnz.a(false, false);
        b();
      }
      bnnl.b();
      return;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == -16716524)
    {
      ...
      a(paramMessage.arg1, paramMessage.arg2, (bncz)paramMessage.obj);
      this.h = true;
      if (this.i)
      {
        a(a());
        bnbe.a("SETPREVIEW OffScreenGLSurface");
      }
    }
    do
    {
      do
      {
        ...
        bnbe.a("RANDER_DATA_INIT OffScreenGLSurface");
        return true;
        if (paramMessage.what != -16716522) {
          break;
        }
        d();
        this.jdField_a_of_type_Bnnx.a();
        this.jdField_a_of_type_Bnnx.a = null;
        this.jdField_a_of_type_Bnny.jdField_b_of_type_Int = 0;
        this.jdField_a_of_type_Bnny.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_Bnny.jdField_a_of_type_Int = -1;
        f();
      } while (!QLog.isColorLevel());
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("CAMERA_OPENGL_RANDER_DATA");; localStringBuilder = null)
    {
      ...
      if (j != 0)
      {
        bneh.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
        return true;
      }
      if (this.jdField_a_of_type_Bnnz != null) {
        bnnl.a(PtvFilterUtils.a() / 1000L);
      }
      Object localObject;
      ...
      for (;;)
      {
        ...
        bnnl.d((PtvFilterUtils.a() - l) / 1000L);
        ...
        if (this.jdField_a_of_type_Bnnz != null)
        {
          if (this.jdField_a_of_type_Bnnx.a == null)
          {
            bneh.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
            return true;
            ...
            localObject = ((bnmv)paramMessage.obj).jdField_a_of_type_ArrayOfByte;
            continue;
          }
          l = PtvFilterUtils.a();
          bnof localbnof = a();
          if (localbnof != null)
          {
            this.jdField_a_of_type_Bnnz.a(localbnof.jdField_a_of_type_Int);
            if ((QLog.isColorLevel()) && (localStringBuilder != null))
            {
              localStringBuilder.append("bind t=").append(localbnof.jdField_a_of_type_Int).append("|");
            ...
            for (boolean bool1 = true;; bool1 = false)
            {
              ...
              localAVIOStruct = ((bnmv)paramMessage.obj).jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct;
            ...
            {
              this.jdField_a_of_type_Bnny.jdField_a_of_type_Boolean = true;
              localObject = localAVIOStruct;
            }
            label752:
            ...
            localbnof.a(j, localObject, bool1);
            localbnof.d();
            bool1 = this.jdField_a_of_type_Bnnx.a.a();
            if ((QLog.isColorLevel()) && (localStringBuilder != null))
            {
              localStringBuilder.append("write ns=").append(this.jdField_a_of_type_Bnny.jdField_a_of_type_Boolean).append("|");
            ...
            if (!bool1)
            {
              if (this.jdField_a_of_type_Bnny.jdField_a_of_type_Boolean) {
                a((AVIOStruct)localObject);
              }
              localbnof.a();
            }
            label905:
            bnnl.c((PtvFilterUtils.a() - l) / 1000L);
          }
        }
        for (;;)
        {
          ...
          break label752;
          bneh.a("handleMessage:byteBufferProcessFrame: no texture");
          break label905;
          bneh.a("handleMessage:byteBufferProcessFrame  framebuffer=null");
        }
        label1133:
        localObject = null;
      }
