  ...
  extends MSFServlet
{
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), azia.class);
    localNewIntent.putExtra("param_request_type", 1);
    localNewIntent.putExtra("param_constellation", paramString);
    localNewIntent.putExtra("param_today_date", azla.b());
    localNewIntent.putExtra("param_tomorrow_date", azla.c());
  ...
  private void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   206: astore 7
    //   208: aload_0
    //   209: invokevirtual 150	azia:getAppRuntime	()Lmqq/app/AppRuntime;
    ...
    //   242: aload_2
    //   243: iload_3
    //   244: invokestatic 160	azla:a	(Lcom/tencent/mobileqq/app/QQAppInterface;I)V
    //   247: aload 8
    ...
    //   416: astore 13
    //   418: aload_2
    //   419: invokestatic 202	azla:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)Ljava/lang/String;
    //   422: astore 15
    //   424: aload 7
    //   426: aload 15
    ...
    //   506: ifeq +57 -> 563
    //   509: aload 8
    //   511: checkcast 225	anyw
    //   514: astore 17
    //   516: aload 17
    //   518: aload_2
    //   519: invokevirtual 228	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   522: invokevirtual 231	anyw:d	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Friends;
    //   525: astore 18
    //   527: aload 18
    //   529: aload 12
    ...
    //   548: aload 18
    //   550: invokestatic 41	azla:b	()Ljava/lang/String;
    //   553: putfield 246	com/tencent/mobileqq/data/Friends:constellationDateStr	Ljava/lang/String;
    //   556: aload 17
    //   558: aload 18
    //   560: invokevirtual 249	anyw:a	(Lcom/tencent/mobileqq/data/Friends;)V
    //   563: aload_2
    //   564: iload_3
    //   565: invokestatic 160	azla:a	(Lcom/tencent/mobileqq/app/QQAppInterface;I)V
    //   568: aload_2
    //   569: aload 7
    //   571: invokestatic 252	azla:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)V
    //   574: aload_2
    //   575: aload 14
    //   577: invokestatic 254	azla:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)V
    //   580: aload 8
    //   582: instanceof 225
    //   585: ifeq +189 -> 774
    //   588: aload 8
    //   590: checkcast 225	anyw
    //   593: astore 11
    //   595: aload 11
    //   597: aload_2
    //   598: invokevirtual 228	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   601: invokevirtual 231	anyw:d	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Friends;
    //   604: astore 12
    //   606: aload 12
    ...
    //   634: new 265	azkz
    //   637: dup
    //   638: invokespecial 266	azkz:<init>	()V
    //   641: aload 7
    //   643: invokevirtual 269	azkz:a	(Ljava/lang/String;)Lazkz;
    //   646: invokevirtual 271	azkz:a	()Ljava/lang/String;
    //   649: astore 7
    //   651: new 265	azkz
    //   654: dup
    //   655: invokespecial 266	azkz:<init>	()V
    //   658: aload 13
    //   660: invokevirtual 269	azkz:a	(Ljava/lang/String;)Lazkz;
    //   663: invokevirtual 271	azkz:a	()Ljava/lang/String;
    //   666: astore 13
    //   668: aload 7
    ...
    //   746: aload 11
    //   748: aload 12
    //   750: invokevirtual 249	anyw:a	(Lcom/tencent/mobileqq/data/Friends;)V
    //   753: aload_2
    //   754: invokevirtual 290	com/tencent/mobileqq/app/QQAppInterface:getExtOnlineStatus	()J
    //   757: ldc2_w 291
    //   760: lcmp
    //   761: ifne +13 -> 774
    //   764: getstatic 297	azlb:a	Lazlb;
    //   767: aload_2
    //   768: sipush 1040
    //   771: invokevirtual 298	azlb:a	(Lcom/tencent/mobileqq/app/QQAppInterface;I)V
    //   774: aload 8
    //   776: instanceof 225
    //   779: ifeq +76 -> 855
    //   782: aload_2
    ...
    //   787: invokestatic 301	azla:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   790: astore 7
    //   792: aload 7
    //   794: ldc_w 303
    ...
    //   863: aload 9
    //   865: ldc_w 320
    //   868: invokevirtual 324	azia:notifyObserver	(Landroid/content/Intent;IZLandroid/os/Bundle;Ljava/lang/Class;)V
    //   871: return
    //   872: astore 7
    //   874: aconst_null
    //   875: astore_2
