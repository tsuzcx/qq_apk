...
public class ajts
  extends ajtb
{
  bbwt jdField_a_of_type_Bbwt = new ajtt(this);
  private bbww jdField_a_of_type_Bbww;
  public QQAppInterface a;
  
  public ajts(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    ((askf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(paramString, paramInt1, "", paramInt2, 0);
    if (QLog.isColorLevel()) {
      QLog.d("ClubContentUpdateHandler", 2, "small emotion has update info.");
    }
    bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), "small_emosm_update_flag" + paramString, paramInt1);
  }
  
  private void a(int paramInt, bboi parambboi)
  {
    if (Math.abs(paramInt - bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), parambboi.d)) > 5)
    {
      if (QLog.isColorLevel()) {
        QLog.i("ClubContentUpdateHandler", 2, "New version json found!");
      }
      if (this.jdField_a_of_type_Bbww == null) {
        this.jdField_a_of_type_Bbww = ((bbww)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47));
      }
      File localFile = new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext().getFilesDir(), parambboi.a);
      Bundle localBundle = new Bundle();
      localBundle.putInt("version", paramInt);
      localBundle.putString("json_name", parambboi.d);
      parambboi = new bbwu(parambboi.b, localFile);
      this.jdField_a_of_type_Bbww.a(1).a(parambboi, this.jdField_a_of_type_Bbwt, localBundle);
    }
  }
  ...
  private void a(String paramString1, int paramInt1, String paramString2, int paramInt2, Map<String, Integer> paramMap, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (!paramString1.equals(bboe.a.e)) {
            break;
          }
          if (QLog.isColorLevel()) {
            QLog.d("ClubContentUpdateHandler", 2, "func updateEmojiJson, sEPPromotionTask!");
          }
          paramInt2 = bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), bboe.a.d);
        } while (paramInt1 <= paramInt2);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
        bboe.a(MobileQQ.getContext(), bboe.a.d, paramInt2);
        ...
        ((ajvn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(12)).a();
      ...
      } while (!anzr.a(paramInt2));
      ((askf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).b(paramString1.replace("_json", "").trim(), paramInt1, paramString2, paramInt2, 0);
      return;
      if (QLog.isColorLevel()) {
        QLog.d("ClubContentUpdateHandler", 2, "func updateEmojiJson, update emoji package!");
      }
      ((askf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(paramString1, paramInt1, paramString2, paramInt2, 0);
  ...
  private boolean a(int paramInt, bboi parambboi, boolean paramBoolean)
  {
    int i = bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), parambboi.d);
    if (QLog.isColorLevel()) {
      QLog.d("ClubContentUpdateHandler", 2, "updateResJson name = " + parambboi.e + " localVersion = " + i + " version = " + paramInt);
    }
    if (paramInt > i)
    {
      bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, parambboi, paramInt, paramBoolean);
      return true;
    }
    return false;
  }
  ...
  private void g(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    while (paramRspAppInfo.hasNext())
    {
      ...
      if (!str1.equals(bboe.b.e)) {}
    }
  }
  
  protected ClubContentUpdateInfoPb.ReqAppInfo a()
  {
    Object localObject = ((askf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(0);
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localEmoticonPackage.jobType == 4) && (localEmoticonPackage.status == 2) && (!anzr.b(localEmoticonPackage.updateFlag)))
        {
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo a(bboi parambboi, int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    ClubContentUpdateInfoPb.ReqItemInfo localReqItemInfo = new ClubContentUpdateInfoPb.ReqItemInfo();
    localReqItemInfo.str_name.set(parambboi.e);
    localReqItemInfo.uint_version.set(bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), parambboi.d));
    localArrayList.add(localReqItemInfo);
    parambboi = new ClubContentUpdateInfoPb.ReqAppInfo();
    parambboi.uint_appid.set(paramInt);
    parambboi.rpt_msg_reqiteminfo.set(localArrayList);
    parambboi.setHasFlag(true);
    return parambboi;
  }
  ...
  public void a()
  {
    ...
    localArrayList.add(b(bboe.c, 7));
    localArrayList.add(a(bboe.e, 105));
    localArrayList.add(b(bboe.f, 11));
    localArrayList.add(b(bboe.h, 113));
    localArrayList.add(b(bboe.i, 5));
  ...
  public void a(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      if (bboe.a(paramContext, bboe.e.d) != i)
      {
        a(i, bboe.e);
        return;
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    //   115: return
    //   116: getstatic 531	bboe:e	Lbboi;
    //   119: getfield 297	bboi:e	Ljava/lang/String;
    //   122: aload 9
    //   124: invokevirtual 302	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   127: ifeq +1276 -> 1403
    //   130: aload_0
    //   131: iload 4
    //   133: getstatic 531	bboe:e	Lbboi;
    //   136: invokespecial 593	ajts:a	(ILbboi;)V
    //   139: goto +1264 -> 1403
    //   142: aload_1
    ...
    //   169: invokestatic 89	bboe:a	(Landroid/content/Context;Ljava/lang/String;)I
    //   172: istore 5
    ...
    //   239: iconst_1
    //   240: aload 9
    //   242: invokespecial 616	ajts:a	(IILjava/lang/String;)V
    //   245: goto -129 -> 116
    ...
    //   278: iconst_1
    //   279: invokespecial 623	ajts:a	(Ljava/lang/String;ILjava/lang/String;ILjava/util/Map;Z)V
    //   282: goto -166 -> 116
    //   285: getstatic 527	bboe:c	Lbboi;
    //   288: getfield 297	bboi:e	Ljava/lang/String;
    //   291: aload 9
    //   293: invokevirtual 302	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   296: ifeq -180 -> 116
    //   299: aload_0
    //   300: iload 4
    //   302: getstatic 527	bboe:c	Lbboi;
    //   305: iconst_1
    //   306: invokespecial 307	ajts:a	(ILbboi;Z)Z
    //   309: pop
    //   310: goto -194 -> 116
    //   313: ldc 44
    //   315: iconst_1
    ...
    //   385: invokevirtual 634	airx:b	(Ljava/lang/String;)I
    ...
    //   403: aload 9
    //   405: iload 4
    //   407: invokevirtual 641	ajts:a	(Ljava/lang/String;I)V
    //   410: goto -294 -> 116
    //   413: ldc 44
    //   415: iconst_1
    //   416: ldc_w 643
    ...
    //   465: iload 4
    //   467: iconst_0
    //   468: invokestatic 650	ajjr:a	(Lajjr;Lcom/tencent/common/app/AppInterface;IZ)V
    //   471: goto -355 -> 116
    //   474: ldc 44
    //   476: iconst_1
    ...
    //   546: invokevirtual 634	airx:b	(Ljava/lang/String;)I
    ...
    //   561: iconst_1
    //   562: iload 5
    //   564: invokevirtual 657	airx:a	(II)J
    //   567: ldc2_w 658
    //   570: ldiv
    //   571: lstore 6
    //   573: lload 6
    ...
    //   592: iconst_m1
    //   593: iconst_1
    //   594: invokestatic 664	ajhu:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Lajic;I[IIIZ)V
    //   597: ldc 44
    //   599: iconst_1
    ...
    //   756: invokevirtual 634	airx:b	(Ljava/lang/String;)I
    ...
    //   771: iconst_2
    //   772: iload 5
    //   774: invokevirtual 657	airx:a	(II)J
    //   777: ldc2_w 658
    //   780: ldiv
    //   781: lstore 6
    //   783: lload 6
    ...
    //   808: iconst_m1
    //   809: iconst_1
    //   810: invokestatic 678	ajhu:b	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Lajic;I[IIIZ)V
    //   813: ldc 44
    //   815: iconst_1
    ...
    //   885: goto -769 -> 116
    //   888: invokestatic 686	akvi:a	()Ljava/lang/String;
    //   891: aload 9
    ...
    //   933: invokevirtual 634	airx:b	(Ljava/lang/String;)I
    //   936: if_icmpne +131 -> 1067
    //   939: aload_1
    //   940: bipush 115
    //   942: invokevirtual 319	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   945: checkcast 684	akvi
    //   948: ifnull -832 -> 116
    //   951: invokestatic 688	akvi:b	()J
    //   954: lstore 6
    //   956: lload 6
    //   958: iload 4
    //   960: i2l
    ...
    //   972: getstatic 693	ajms:av	Ljava/lang/String;
    ...
    //   1008: aload_1
    //   1009: aload 10
    //   1011: getstatic 701	ajms:at	Ljava/lang/String;
    //   1014: aload 11
    //   1016: new 703	akvk
    //   1019: dup
    //   1020: invokespecial 704	akvk:<init>	()V
    //   1023: invokestatic 707	ajhu:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Lbbwt;)V
    //   1026: ldc 44
    //   1028: iconst_1
    ...
    //   1076: goto -960 -> 116
    //   1079: getstatic 479	bboe:b	Lbboi;
    //   1082: getfield 297	bboi:e	Ljava/lang/String;
    //   1085: aload 9
    ...
    //   1108: goto -992 -> 116
    //   1111: getstatic 539	bboe:h	Lbboi;
    //   1114: getfield 297	bboi:e	Ljava/lang/String;
    //   1117: aload 9
    ...
    //   1140: aload_0
    //   1141: iload 4
    //   1143: getstatic 539	bboe:h	Lbboi;
    //   1146: iconst_1
    //   1147: invokespecial 307	ajts:a	(ILbboi;Z)Z
    //   1150: pop
    //   1151: goto -1035 -> 116
    //   1154: getstatic 541	bboe:i	Lbboi;
    //   1157: getfield 297	bboi:e	Ljava/lang/String;
    //   1160: aload 9
    ...
    //   1183: aload_0
    //   1184: iload 4
    //   1186: getstatic 541	bboe:i	Lbboi;
    //   1189: iconst_1
    //   1190: invokespecial 307	ajts:a	(ILbboi;Z)Z
    //   1193: pop
    //   1194: goto -1078 -> 116
    ...
    //   361	199	10	localairx1	airx
    //   638	27	10	localException2	Exception
    //   732	38	10	localairx2	airx
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo b()
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localEmoticonPackage.jobType == 0) && (localEmoticonPackage.status == 2) && (!anzr.b(localEmoticonPackage.updateFlag)))
        {
    ...
    for (;;)
    {
      ...
      ((ClubContentUpdateInfoPb.ReqItemInfo)localObject).str_name.set(bboe.d.e);
      ((ClubContentUpdateInfoPb.ReqItemInfo)localObject).uint_version.set(bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), bboe.d.d));
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo b(bboi parambboi, int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    ClubContentUpdateInfoPb.ReqItemInfo localReqItemInfo = new ClubContentUpdateInfoPb.ReqItemInfo();
    localReqItemInfo.str_name.set(parambboi.e);
  ...
  protected void b(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((str1.equals(bboe.e.e)) && (i > bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), bboe.e.d))) {
        a(i, bboe.e);
      }
    }
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo c()
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localEmoticonPackage.jobType == 3) && (localEmoticonPackage.status == 2) && (!anzr.b(localEmoticonPackage.updateFlag)))
        {
          localReqItemInfo = new ClubContentUpdateInfoPb.ReqItemInfo();
          localReqItemInfo.str_name.set(localEmoticonPackage.epId);
          localReqItemInfo.uint_version.set(localEmoticonPackage.localVersion);
  ...
  protected void c(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    while (paramRspAppInfo.hasNext())
    {
      ...
      if (!TextUtils.isEmpty(str1))
      {
        ...
        if (str1.equals(bboe.c.e))
        {
          if (i > bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), bboe.c.d)) {
            bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bboe.c, i, false);
          }
        }
        else if (str1.equals(bboe.f.e))
        {
          if (i > bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), bboe.f.d)) {
            bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bboe.f, i, false);
          }
        }
        else if (str1.equals(bboe.i.e))
        {
          j = bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), bboe.i.d);
          if (QLog.isColorLevel()) {
            QLog.d("ClubContentUpdateHandler", 2, "FontInfoList_json remoteVersion = " + i + " localVersion = " + j);
          }
          if (i > j) {
            bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, bboe.i, i, false);
          }
        }
      }
    }
  ...
  protected void d(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    while (paramRspAppInfo.hasNext())
    {
      ...
      int i = localRspItemInfo.uint_version.get();
      int j = localRspItemInfo.uint_update_flag.get();
      int k = bboe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), "small_emosm_update_flag" + str);
      if (QLog.isColorLevel()) {
