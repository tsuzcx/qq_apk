...
public class adgc
  extends aofu
{
  public adgc(AddFriendVerifyActivity paramAddFriendVerifyActivity) {}
  ...
  public void onJoinTroopSecurityTips(boolean paramBoolean, String paramString, int paramInt, long paramLong)
  {
    ...
    bfxi.a(this.a.app, paramInt, paramLong, this.a.getActivity());
  }
  ...
  {
    if (!bhbx.a(String.valueOf(paramLong), this.a.jdField_a_of_type_JavaLangString)) {}
    label262:
    do
    {
      do
      ...
      paramTroopInfo = this.a.getString(2131697285, new Object[] { this.a.app.getCurrentNickname() }) + paramTroopInfo;
  ...
  public void onQueryJoinTroopWhetherHighRisk(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if (paramInt != 0)
    {
      ...
      case 2: 
        ...
        this.a.e.setVisibility(8);
        bdla.b(null, "dc00898", "", "", "0X800B5B2", "0X800B5B2", 0, 0, "", "", "", "");
        return;
      }
      this.a.f.setVisibility(8);
  ...
  protected void onSetTroopShowExternalStatus(boolean paramBoolean, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (!paramBoolean)
    {
      QQToast.a(this.a, this.a.getString(2131695927), 0).b(this.a.getTitleBarHeight());
  ...
  protected void onTroopManagerSuccess(int paramInt1, int paramInt2, String paramString)
  {
    ...
    default: 
      AddFriendVerifyActivity.b(this.a, 1002);
      this.a.jdField_a_of_type_Bisl.dismiss();
      QQToast.a(this.a, 1, 2131718059, 1).b(this.a.getTitleBarHeight());
    case -2: 
      do
      {
        return;
      ...
      ((aoep)this.a.app.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER)).b(Long.parseLong(this.a.jdField_a_of_type_JavaLangString), Long.parseLong(this.a.app.getAccount()));
    ...
    case 1: 
      ...
      for (;;)
      {
        try
        {
          ...
          avzm.a("closeJoinWebView", null, paramString, null);
          return;
        }
    ...
    AddFriendVerifyActivity.b(this.a, 1002);
    this.a.jdField_a_of_type_Bisl.dismiss();
    QQToast.a(this.a, 1, 2131719621, 1).b(this.a.getTitleBarHeight());
  }
}
