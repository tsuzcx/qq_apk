  ...
  implements bpec
{
  ...
  public bpei(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  private Bitmap a(Context paramContext, Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      label26:
      int k = bppn.jdField_a_of_type_Int;
      if (j <= k) {
        break label226;
      }
      i = (int)(i * k / j);
    ...
    for (;;)
    {
      ...
      {
        localObject = bheg.a(paramContext, bheg.c(paramBitmap), 0.4F, 25.0F);
      ...
      for (;;)
      {
        paramContext = zdr.a(zdr.a(paramContext, i, j, true), paramBitmap);
  ...
  public boolean a(String paramString, long paramLong1, long paramLong2, int paramInt, bpej parambpej)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambpej);
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Bppu != null) {
      this.jdField_a_of_type_Bppu.a();
    }
  }
}
