...
class akfe
  extends akuo
{
  akfe(akfc paramakfc, int paramInt, boolean paramBoolean1, boolean paramBoolean2, long paramLong, boolean paramBoolean3, boolean paramBoolean4, String paramString)
  {
  ...
  public void onLocationFinish(int paramInt, SosoInterface.SosoLbsInfo paramSosoLbsInfo)
  {
    ...
    if ((paramSosoLbsInfo != null) && (paramSosoLbsInfo.a != null))
    {
      ...
      paramSosoLbsInfo.bytes_client_version.set(ByteStringMicro.copyFromUtf8("8.3.0"));
