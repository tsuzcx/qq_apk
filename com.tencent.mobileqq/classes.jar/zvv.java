...
public class zvv
  extends ajjh
{
  public zvv(AccountManageActivity paramAccountManageActivity) {}
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    Object localObject2 = (axat)this.a.app.getManager(61);
    Object localObject1 = "";
    int i = ((axat)localObject2).a();
    if (i == 0)
    {
      label43:
      ...
      if ((i > j) && (this.a.jdField_a_of_type_JavaUtilList.get(j) != null) && (paramString.equals(((SimpleAccount)this.a.jdField_a_of_type_JavaUtilList.get(j)).getUin())))
      {
        localObject1 = (TextView)this.a.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(j).findViewById(2131304981);
        localObject2 = (TextView)this.a.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(j).findViewById(2131296287);
        ((TextView)localObject1).setText(babh.h(this.a.app, paramString));
    ...
    {
      SubAccountInfo localSubAccountInfo = ((axat)localObject2).a("sub.uin.default");
      if (localSubAccountInfo == null) {
        break label437;
      }
      localObject2 = babh.c(this.a.app, localSubAccountInfo.subuin, false);
    ...
    {
      break label43;
      localObject1 = i + ajjy.a(2131633952);
      break label43;
      j += 1;
      break label112;
      i = 0;
