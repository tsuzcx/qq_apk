...
public final class bbcm
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = ajsd.aW + "avatarPendantIcons";
  ...
  public static String a(File paramFile)
  {
    ...
    try
    {
      paramFile = new String(bbdx.a(paramFile));
  ...
  {
    return ajsd.bP + "font_info/" + paramString + File.separator + paramString + ".ttf";
  }
  
  public static void a()
  {
    File localFile = new File(ajsd.aW + "avatarPendantDefaultHead");
    if (!localFile.exists()) {
      localFile.mkdir();
    }
    localFile = new File(ajsd.bP);
    if (!localFile.exists()) {
      localFile.mkdir();
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, aqyf paramaqyf)
  {
    if ((paramContext == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      paramQQAppInterface.a(-1, new bbcn(paramaqyf));
      return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, boolean paramBoolean, ProfileActivity.AllInOne paramAllInOne)
  {
    ...
    if (paramAllInOne != null)
    {
      ...
      axbv localaxbv = (axbv)paramQQAppInterface.getManager(12);
      i = localaxbv.a("100005.100006");
      if ((i == 1) || (i == 0))
      {
        if (QLog.isColorLevel()) {
        ...
        localavps = (avps)paramQQAppInterface.getManager(36);
        localavps.b("100005.100006");
        if (localaxbv.a("100005.100003") == -1) {
          break label445;
        }
        j = 1;
        if (localaxbv.a("100005.100002") == -1) {
          break label451;
        }
        k = 1;
        if (localaxbv.a("100005.100001") == -1) {
          break label457;
        }
        m = 1;
        if (localaxbv.a("100005.100018") == -1) {
          break label463;
        }
        n = 1;
        if (localaxbv.a("100005.100020") == -1) {
          break label469;
        }
        i1 = 1;
        if (localaxbv.a("100005.100021") == -1) {
          break label475;
        }
        i2 = 1;
        label202:
        if (!((ho)paramQQAppInterface.getManager(42)).jdField_a_of_type_Boolean) {
          break label495;
        }
        if (localaxbv.a("100005.100011") == -1) {
          break label481;
        }
        i = 1;
      }
    ...
    for (;;)
    {
      ...
      if (paramAllInOne == null)
      {
        ...
        localIntent.putExtra("url", bbqd.a(paramContext, "pendant", ""));
      ...
      for (i = 40202;; i = 40201)
      {
        ...
        axqy.b(paramQQAppInterface, "CliOper", "", "", "PendantMarket", "OtherEntrance", 0, 0, "", "", "", "");
        return;
  ...
  {
    ((bbrd)paramQQAppInterface.a(71)).a(new String[] { paramString }, new int[] { 27235 });
  }
  ...
  public static String b(long paramLong, int paramInt)
  {
    ...
    localStringBuilder.append(ajsd.bP).append(paramLong).append(File.separator);
    switch (paramInt)
    {
    }
    for (;;)
  ...
  {
    return ajsd.bP + "font_info/" + paramString + "/";
  }
  ...
  public static boolean b(String paramString)
  {
    ...
    return new File(ajsd.bP + "sticker_info", paramString).exists();
  }
  ...
  public static String c(long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      return anqz.a("VIP_avatar", localStringBuilder.toString());
      localStringBuilder.append("aio_50.png");
      continue;
      localStringBuilder.append("aio_file.zip");
      continue;
  ...
  {
    return ajsd.bP + "sticker_info/" + paramString + ".png";
  }
}
