...
public class bbcm
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, List<cmd0x777.AddFrdInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (k > 0)
        {
          QQToast.a(BaseApplication.getContext(), 0, anvx.a(2131700564), 0).a();
        ...
        for (;;)
        {
          ...
          QQToast.a(BaseApplication.getContext(), 0, anvx.a(2131700567), 0).a();
          break label353;
          label465:
          break;
          label467:
        ...
        for (;;)
        {
          paramList = bhdj.a(paramActivity, String.format(Locale.getDefault(), anvx.a(2131700571), new Object[] { paramList }), 0, 0, null, null);
          paramList.setPositiveButton(2131694399, new bbcn());
          if ((paramActivity != null) && (!paramActivity.isFinishing())) {
            paramList.show();
          }
          bdla.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "frd_select", "notAdd_exp", 0, 0, paramString, String.valueOf(j), "", "");
          return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    bgqt.a(paramQQAppInterface, true, localTroopInfo);
    Object localObject1 = paramQQAppInterface.getMessageFacade().getAIOList(paramString1, 1);
    long l1;
    label109:
    long l2;
    int j;
    ...
    if ((localObject1 != null) && (!((List)localObject1).isEmpty()))
    {
      ...
      i = 1;
      localObject1 = String.format(Locale.getDefault(), anvx.a(2131700565), new Object[] { paramString3, Integer.valueOf(paramInt2) });
      if (paramInt2 != 1) {
        break label746;
      }
      paramString3 = String.format(Locale.getDefault(), anvx.a(2131700568), new Object[] { paramString3 });
      paramInt2 = 1;
    }
    for (;;)
    {
      ...
      if (paramInt1 == 0)
      {
        paramString3 = paramString3 + anvx.a(2131700572);
        localObject1 = anvx.a(2131700569);
        i = paramString3.indexOf((String)localObject1);
        j = ((String)localObject1).length();
        localObject1 = new avhz(paramString1, paramString1, paramString3, 1, -5020, 135178, l2);
        ((avhz)localObject1).jdField_c_of_type_JavaLangString = paramString3;
        ...
        ((avhz)localObject1).a(i, i + j, paramString3);
        ...
        label349:
        ((avhz)localObject1).d = paramString3;
        localObject3 = new MessageForUniteGrayTip();
        ((MessageForUniteGrayTip)localObject3).initGrayTipMsg(paramQQAppInterface, (avhz)localObject1);
      ...
      {
        bdla.b(paramQQAppInterface, "dc00899", "Grp_addFrd", "", "Grp_AIO", (String)localObject2, 0, 0, paramString1, (String)localObject1, "", paramString3);
        if (!QLog.isDevelopLevel()) {
          break;
        }
        ...
        break label109;
        label619:
        paramString3 = String.format(Locale.getDefault(), anvx.a(2131700570), new Object[] { Integer.valueOf(paramInt2) });
        i = j;
        ...
        paramString3 = String.format(Locale.getDefault(), anvx.a(2131700566), new Object[] { paramString2 });
        paramInt2 = 0;
        break label188;
        paramString3 = paramString3 + anvx.a(2131700563);
        break label218;
        paramString3 = "";
        break label349;
      }
  ...
  private void b(FriendListHandler paramFriendListHandler)
  {
    ...
    anvk localanvk = (anvk)paramFriendListHandler.app.getManager(QQManagerFactory.FRIENDS_MANAGER);
    ...
    for (boolean bool2 = true;; bool2 = bool1)
    {
      if (localAddFrdInfo.uint32_send_req_flag.get() == 1)
      {
        ...
        localanvk.a(Long.toString(localAddFrdInfo.uint64_uin.get()), false);
        bool1 = bool2;
        break label92;
  ...
  public void a(FriendListHandler paramFriendListHandler)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (anvk)paramFriendListHandler.app.getManager(QQManagerFactory.FRIENDS_MANAGER);
      ...
      if (i > 0)
      {
        ...
        if (i >= 0)
        {
          ...
          ((anvk)localObject).a(Long.toString(l1), true);
          i -= 1;
        }
        else
        {
