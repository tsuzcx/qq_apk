...
{
  public bnwp(AEVideoShelfEditFragment paramAEVideoShelfEditFragment) {}
  ...
  protected void a(Void paramVoid)
  {
    ...
    {
      bnzb.c("AEVideoShelfEditFrag", "init NodeGroup Error!");
      return;
    }
    ...
    AEVideoShelfEditFragment.a(this.a, new bnxy(this.a.getActivity(), paramVoid, AEVideoShelfEditFragment.a(this.a).getVideoWidth(), AEVideoShelfEditFragment.a(this.a).getVideoHeight()));
