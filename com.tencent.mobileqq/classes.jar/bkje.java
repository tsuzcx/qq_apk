...
public final class bkje
{
  ...
  public static bkkl a(String paramString1, String paramString2, String paramString3, long paramLong, int paramInt, String paramString4, String paramString5)
  {
    ...
    for (;;)
    {
      return bkkl.a(10, paramString1, paramString2, paramString3, paramLong, paramInt, BaseApplicationImpl.getApplication().getRuntime().getAccount(), paramString4, paramString5);
    }
  }
  ...
  private static String a()
  {
    if (jdField_a_of_type_JavaLangString == null) {
      jdField_a_of_type_JavaLangString = "V1_AND_WY_VersionName_" + baws.a() + "_ChannelId_" + "B";
    }
  ...
  public static void a(Application paramApplication, boolean paramBoolean)
  {
    ...
    WeiyunTransmissionGlobal.AppInfo localAppInfo = new WeiyunTransmissionGlobal.AppInfo(a(), 1000269, "mobileqq", baws.a(), 0, "unknown");
    ...
    {
      localWeiyunTransmissionGlobal.initTransmission(localAppInfo, paramApplication, new bkjk(str), bkmj.a());
      ...
      AppNetConnInfo.registerNetChangeReceiver(null, new bkjf());
      bkks.a().a(new bkjg(), paramApplication);
      bkks.a().a(new bkji());
      WeiyunTransmissionGlobal.getInstance().getUploadManager().addGlobalObserver(new bkjj());
