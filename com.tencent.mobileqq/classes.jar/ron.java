  ...
  implements Cloneable
{
  ...
  public static ron a(articlesummary.ArkAppFeedsInfo paramArkAppFeedsInfo)
  {
    ...
    if (paramArkAppFeedsInfo.uint64_feeds_id.has())
    {
      ...
      label103:
      localron.jdField_a_of_type_JavaLangString = str;
    ...
    {
      localron.f = paramArkAppFeedsInfo;
      if (QLog.isColorLevel()) {
        QLog.d("ArkAppFeedsInfo", 2, new Object[] { "mFeedsId: ", Long.valueOf(localron.jdField_a_of_type_Long), ", mFeedsStyle: ", Integer.valueOf(localron.jdField_a_of_type_Int), ", appName: ", localron.jdField_a_of_type_JavaLangString, ", appView: ", localron.b, ", appMinVersion: ", localron.e, ", metaList: ", localron.f });
      }
      return localron;
      l = 0L;
      break;
