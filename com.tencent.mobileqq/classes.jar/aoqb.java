  ...
  implements aoqp
{
  ...
  protected aoqb(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, ayui paramayui)
  {
    super(paramLong, paramItem, paramBundle, paramayui);
  }
  
  public static ayul a(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, ayui paramayui)
  {
    if (paramLong == 0L)
    {
      aysb.a("ExcitingTransfer.TroopFileUploadWorker", aysb.jdField_a_of_type_Int, "getWoker. troopuin=0");
      return null;
    }
    if (paramItem == null)
    {
      aysb.a("ExcitingTransfer.TroopFileUploadWorker", aysb.jdField_a_of_type_Int, "getWoker. item=null");
      return null;
    }
    if (paramItem.Id == null) {
      aysb.a("ExcitingTransfer.TroopFileUploadWorker", aysb.jdField_a_of_type_Int, "getWoker. item.id=null");
    }
    return new aoqb(paramLong, paramItem, paramBundle, paramayui);
  }
  ...
  private ExcitingTransferUploadResultRp a()
  {
    ...
    if (this.jdField_a_of_type_Aytw != null)
    {
      ...
      if ((this.jdField_a_of_type_Aytw instanceof aoqm)) {
        localObject1 = ((aoqm)this.jdField_a_of_type_Aytw).a();
      }
    }
    return localObject1;
  }
  ...
  private void c(int paramInt)
  {
    ...
    aoqa localaoqa = new aoqa(ayrz.a());
    localaoqa.a(paramInt);
    if (localObject != null) {
      if (((ExcitingTransferUploadResultRp)localObject).m_nResult == 0L)
      {
        bool1 = bool2;
        localaoqa.a((ExcitingTransferUploadResultRp)localObject);
        localaoqa.c(this.jdField_a_of_type_Long);
        localObject = apck.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
        localaoqa.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, (String)localObject, this.jdField_c_of_type_Long);
        localaoqa.c(this.jdField_a_of_type_Ayrn.jdField_a_of_type_Boolean);
        long l = System.currentTimeMillis() - this.jdField_a_of_type_Ayrn.jdField_d_of_type_Long;
        if (l <= 0L) {
          break label339;
        }
        localaoqa.b(l);
        label143:
        l = this.jdField_a_of_type_Ayrn.g;
        if (l <= 0L) {
          break label348;
        }
        localaoqa.a(l);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Ayrn.jdField_a_of_type_Long > 0L) {
        ((ExcitingTransferUploadResultRp)localObject).m_u64StartSize = this.jdField_a_of_type_Ayrn.jdField_a_of_type_Long;
      }
      if (this.jdField_a_of_type_Ayrn.jdField_b_of_type_Long > 0L) {
        ((ExcitingTransferUploadResultRp)localObject).m_u64TransferSize = this.jdField_a_of_type_Ayrn.jdField_b_of_type_Long;
      }
      float f;
  ...
  private void o()
  {
    ...
    localaoqa.a(33);
    localaoqa.c(this.jdField_a_of_type_Long);
    Object localObject = apck.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
    localaoqa.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, (String)localObject, this.jdField_c_of_type_Long);
    localaoqa.c(false);
    long l = System.currentTimeMillis() - this.jdField_a_of_type_Ayrn.jdField_d_of_type_Long;
    label119:
  ...
  protected aytw a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    ...
    this.jdField_c_of_type_Long = apck.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
    ...
    paramString = new aoqo(localArrayList1, localArrayList2, paramBoolean2, paramString, null);
    paramQQAppInterface = aoqm.a(paramQQAppInterface, paramLong, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, localaoqn, paramString);
    if (paramQQAppInterface != null)
    {
      ((aoqm)paramQQAppInterface).a(this);
  ...
  public void a(int paramInt, ExcitingTransferUploaderRp paramExcitingTransferUploaderRp)
  {
    ...
    if (paramInt != 0)
    {
      ...
      this.jdField_a_of_type_Ayrn.e = 0;
      this.jdField_a_of_type_Ayrn.f = 0;
      n();
      this.jdField_a_of_type_Ayrn.c = 0;
      this.jdField_a_of_type_Ayrn.jdField_d_of_type_Int = 0;
    }
    if (paramExcitingTransferUploaderRp != null)
    {
      aoqc localaoqc = new aoqc(ayrz.a());
      localaoqc.c(this.jdField_a_of_type_Long);
      String str = apck.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.LocalFile);
      localaoqc.a(paramInt);
      localaoqc.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin, this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, str, this.jdField_c_of_type_Long);
      localaoqc.a(paramExcitingTransferUploaderRp);
      if (paramInt == 0) {}
      for (;;)
      {
        localaoqc.a(bool);
  ...
  protected void c()
  {
    ...
    if (b())
    {
      if ((this.jdField_a_of_type_Ayrn.c == 8) || (this.jdField_a_of_type_Ayrn.c == 11) || (this.jdField_a_of_type_Ayrn.c == 12)) {
        o();
      }
    }
    else {
    ...
    for (;;)
    {
      c(j);
      return;
      j = this.jdField_a_of_type_Ayrn.jdField_d_of_type_Int;
      int i = j;
      if (j == 0) {
        i = this.jdField_a_of_type_Ayrn.c;
      }
      j = i;
      if (this.g != 0L) {
        j = d(i);
