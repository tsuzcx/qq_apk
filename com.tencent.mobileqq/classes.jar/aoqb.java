...
public class aoqb
{
  ...
  public aoqb(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong, boolean paramBoolean, int paramInt2, int paramInt3)
  {
    ...
    this.jdField_a_of_type_JavaUtilSet = amjp.a(paramQQAppInterface);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Anyw.b(this.jdField_a_of_type_JavaUtilArrayList);
    ((bhzq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(this.jdField_a_of_type_JavaUtilArrayList);
    this.jdField_a_of_type_Anyw.a(this.d, this.jdField_a_of_type_Long, this.jdField_a_of_type_Boolean);
    ...
    for (;;)
    {
      amjp.a(this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      amjp.b(this.jdField_b_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      amjp.a(this.jdField_a_of_type_JavaUtilMap, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      amjp.c(this.jdField_c_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return;
      if (QLog.isColorLevel()) {
  ...
  {
    Object localObject2 = this.jdField_a_of_type_Anyw.a(String.valueOf(paramFriends.uin));
    ...
    for (;;)
    {
      ...
      boolean bool3 = aopz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFriendInfo.vecRing, (ExtensionInfo)localObject1, paramFriends, this.jdField_a_of_type_JavaUtilSet, this.jdField_a_of_type_JavaUtilList, this.jdField_b_of_type_JavaUtilList, this.jdField_a_of_type_JavaUtilMap, this.jdField_c_of_type_JavaUtilList, this.jdField_b_of_type_JavaUtilMap, (SpecialCareInfo)localObject2, this.jdField_a_of_type_Long);
      if (((SpecialCareInfo)localObject2).globalSwitch != 0) {
        this.d.add(localObject2);
      }
      boolean bool4 = bool2 | bool3 | axtm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFriends, (ExtensionInfo)localObject1, paramFriendInfo.vecIntimateInfo);
      bool3 = bool4;
      if (this.jdField_b_of_type_Int == 0) {
        bool3 = aghw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Anyw, paramFriends, (ExtensionInfo)localObject1, paramFriends.uin, paramFriendInfo.vecExtSnsFrdData) | bool4;
      }
      bool4 = bool3;
      if (this.jdField_c_of_type_Int == 0) {
        bool4 = bool3 | axsk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Anyw, paramFriends, (ExtensionInfo)localObject1, paramFriends.uin, paramFriendInfo.vecMutualMarkData);
      }
      if (QLog.isColorLevel())
      {
