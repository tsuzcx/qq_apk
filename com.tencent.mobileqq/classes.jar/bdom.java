  ...
  extends bdol
{
  ...
  protected bdom(Collection<bdol> paramCollection)
  {
    this.jdField_a_of_type_JavaLangString = "item";
  ...
  public void a(View paramView)
  {
    ...
    case 1: 
      ...
      return;
    case 2: 
      paramView.setBackgroundResource(2130838311);
      return;
    }
  ...
  {
    if (((parambdol instanceof bdon)) && (!b())) {
      ((bdon)parambdol).ac = null;
    }
  ...
  public void a(AbsShareMsg paramAbsShareMsg)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext()) {
      ((bdol)localIterator.next()).a(paramAbsShareMsg);
    }
  }
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    for (;;)
    {
      label182:
      str = b();
      if ((str != null) && (localObject != null) && ((localObject instanceof bdqo)))
      {
        if ((!str.endsWith("Layout4")) && (!str.endsWith("Layout2")) && (!str.endsWith("Layout9"))) {
          break label350;
        }
        ((bdqo)localObject).t = bdqo.jdField_q_of_type_Int;
      }
      int j;
      for (;;)
      {
        if (localObject != null)
        {
          ((bdol)localObject).jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg = this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg;
          ((bdol)localObject).a(paramObjectInput);
          a((bdol)localObject);
        }
        k += 1;
        break;
        localObject = bdov.a(str);
        j = i;
        if ("button".equals(str))
        {
          ((bdol)localObject).aa = String.valueOf(i);
          ((bdol)localObject).ab = this.ab;
          j = i + 1;
        }
        if ((localObject == null) || (!bdom.class.isInstance(localObject))) {
          break label1041;
        }
        ...
        if (str.endsWith("Layout3")) {
          ((bdqo)localObject).t = bdqo.jdField_r_of_type_Int;
        }
      }
  ...
  public void a(String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    a(new bdqo(paramString1, paramString3));
  ...
  {
    this.jdField_o_of_type_Int = paramInt;
    a(new bdqo(paramString1, paramString4));
    a(new StructMsgItemTitle(paramString2));
    a(new bdtj(paramString3));
  }
  ...
  public void a(XmlSerializer paramXmlSerializer)
  {
    ...
    for (Object localObject = "0";; localObject = String.valueOf(this.jdField_r_of_type_Int))
    {
      ...
      localObject = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject).hasNext()) {
        ((bdol)((Iterator)localObject).next()).a(paramXmlSerializer);
      }
    }
  ...
  public boolean a(bdqc parambdqc)
  {
    ...
    {
      return bool1;
      this.jdField_c_of_type_JavaLangString = parambdqc.a("action");
      this.jdField_d_of_type_JavaLangString = parambdqc.a("actionData");
      this.jdField_e_of_type_JavaLangString = parambdqc.a("a_actionData");
      this.jdField_f_of_type_JavaLangString = parambdqc.a("i_actionData");
      this.b = parambdqc.a("url");
      this.jdField_g_of_type_JavaLangString = parambdqc.a("brief");
      this.jdField_q_of_type_JavaLangString = parambdqc.a("apurl");
      Object localObject1 = parambdqc.a("flag");
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
      try
      {
        this.jdField_m_of_type_Int = Integer.parseInt((String)localObject1);
        localObject1 = parambdqc.a("mode");
        if (TextUtils.isEmpty((CharSequence)localObject1)) {}
      }
      catch (NumberFormatException localNumberFormatException11)
      {
        ...
        catch (NumberFormatException localNumberFormatException11)
        {
          try
          {
            ...
            {
              this.jdField_h_of_type_JavaLangString = parambdqc.a("businessData");
              this.jdField_i_of_type_JavaLangString = parambdqc.a("commonData");
              this.jdField_j_of_type_JavaLangString = parambdqc.a("index");
              this.jdField_k_of_type_JavaLangString = parambdqc.a("index_name");
              this.jdField_l_of_type_JavaLangString = parambdqc.a("index_type");
              this.jdField_o_of_type_JavaLangString = parambdqc.a("canvas");
              this.jdField_m_of_type_JavaLangString = parambdqc.a("rurl");
              this.jdField_p_of_type_JavaLangString = parambdqc.a("disType");
              this.n = parambdqc.a("tid");
              if (this.jdField_a_of_type_Int > 10)
              {
                localObject1 = parambdqc.a;
                if (localObject1 != null)
                {
                  localObject3 = ((bdqc)localObject1).a("action_type");
          ...
          catch (IllegalArgumentException localNumberFormatException11)
          {
            try
            {
              ...
              localObject3 = ((bdqc)localObject1).a("dest_type");
              if (TextUtils.isEmpty((CharSequence)localObject3)) {}
            }
            catch (NumberFormatException localNumberFormatException11)
            {
              try
              {
                ...
                localObject3 = ((bdqc)localObject1).a("product_type");
                if (TextUtils.isEmpty((CharSequence)localObject3)) {}
              }
              catch (NumberFormatException localNumberFormatException11)
              {
                try
                {
                  ...
                  this.jdField_r_of_type_JavaLangString = ((bdqc)localObject1).a("advertiser_id");
                  this.s = ((bdqc)localObject1).a("aid");
                  this.t = ((bdqc)localObject1).a("app_download_schema");
                  this.u = ((bdqc)localObject1).a("canvas_json");
                  this.v = ((bdqc)localObject1).a("customized_invoke_url");
                  this.w = ((bdqc)localObject1).a("effect_url");
                  this.x = ((bdqc)localObject1).a("landing_page");
                  this.y = ((bdqc)localObject1).a("landing_page_report_url");
                  this.z = ((bdqc)localObject1).a("noco_id");
                  this.A = ((bdqc)localObject1).a("product_id");
                  this.B = ((bdqc)localObject1).a("rl");
                  this.C = ((bdqc)localObject1).a("subordinate_product_id");
                  this.D = ((bdqc)localObject1).a("traceid");
                  this.E = ((bdqc)localObject1).a("via");
                  this.F = ((bdqc)localObject1).a("video_url");
                  this.G = ((bdqc)localObject1).a("appname");
                  this.H = ((bdqc)localObject1).a("customized_invoke_url");
                  this.I = ((bdqc)localObject1).a("pkg_name");
                  this.J = ((bdqc)localObject1).a("pkgurl");
                  this.jdField_q_of_type_JavaLangString = ((bdqc)localObject1).a("apurl");
                  if (this.jdField_a_of_type_Int > 11)
                  {
                    localObject1 = parambdqc.a;
                    if (localObject1 != null)
                    {
                      this.K = ((bdqc)localObject1).a("api_click_monitor_url");
                      this.L = ((bdqc)localObject1).a("api_exposure_monitor_url");
                      this.M = ((bdqc)localObject1).a("trace_info_aid");
                    }
                  }
                  if (this.jdField_a_of_type_Int > 12)
                  {
                    ...
                    if (localObject1 != null)
                    {
                      this.N = ((bdqc)localObject1).a("corporate_image_name");
                      this.O = ((bdqc)localObject1).a("corporate_logo");
                    }
                  }
                  if (this.jdField_a_of_type_Int > 13)
                  {
                    localObject1 = parambdqc.a.a("mini_program_type");
                    if (TextUtils.isEmpty((CharSequence)localObject1)) {}
                  }
                }
                catch (NumberFormatException localNumberFormatException11)
                {
                  try
                  {
                    ...
                    if (this.jdField_a_of_type_Int > 14)
                    {
                      ...
                      if (localObject1 != null)
                      {
                        localObject3 = ((bdqc)localObject1).a("tab_id");
                  ...
                  catch (NumberFormatException localNumberFormatException11)
                  {
                    try
                    {
                      ...
                      localObject1 = ((bdqc)localObject1).a("is_hidden");
                    ...
                    catch (NumberFormatException localNumberFormatException11)
                    {
                      try
                      {
                        ...
                        {
                          localObject1 = parambdqc.a;
                          this.P = ((bdqc)localObject1).a("negative_feedback_url");
                          this.Q = ((bdqc)localObject1).a("sdk_exposure_monitor_url");
                          this.R = ((bdqc)localObject1).a("sdk_click_monitor_url");
                          localObject3 = ((bdqc)localObject1).a("media_duration");
                          if (bhsr.a((String)localObject3)) {}
                        }
                      }
                      catch (NumberFormatException localNumberFormatException11)
                      {
                        try
                        {
                          ...
                          localObject3 = ((bdqc)localObject1).a("video_file_size");
                          if (bhsr.a((String)localObject3)) {}
                        }
                        catch (NumberFormatException localNumberFormatException11)
                        {
                          try
                          {
                            ...
                            localObject3 = ((bdqc)localObject1).a("app_score_num");
                            if (bhsr.a((String)localObject3)) {}
                          }
                          catch (NumberFormatException localNumberFormatException11)
                          {
                            try
                            {
                              ...
                              localObject3 = ((bdqc)localObject1).a("download_num");
                              if (bhsr.a((String)localObject3)) {}
                            }
                            catch (NumberFormatException localNumberFormatException11)
                            {
                              try
                              {
                                for (;;)
                                {
                                  ...
                                  this.S = ((bdqc)localObject1).a("universal_link");
                                  this.T = ((bdqc)localObject1).a("sdk_data");
                                  this.U = ((bdqc)localObject1).a("tencent_video_id");
                                  this.V = ((bdqc)localObject1).a("view_id");
                                  if (this.jdField_a_of_type_Int > 16) {
                                    this.W = parambdqc.a.a("qgg_ext");
                                  }
                                  if (this.jdField_a_of_type_Int > 17)
                                  {
                                    localObject1 = parambdqc.a;
                                    this.X = ((bdqc)localObject1).a("adInfo");
                                    this.Y = ((bdqc)localObject1).a("is_report_click");
                                  }
                                  int k = parambdqc.a();
                                  int i = 0;
                                  for (;;)
                              ...
                              catch (NumberFormatException localNumberFormatException12)
                              {
                                ...
                                for (Object localObject2 = localNumberFormatException12.a("layout");; localObject2 = bdov.a(localNumberFormatException12.b))
                                {
                                  try
                                  {
                                    ...
                                    {
                                      localObject2 = bdov.a(j);
                                      bool1 = bool2;
                                      if (localObject2 == null) {
                                        break;
                                      }
                                      bool1 = bool2;
                                      if (!((bdol)localObject2).a(localNumberFormatException12)) {
                                        break;
                                      }
                                      a((bdol)localObject2);
                                      break label1126;
  ...
  public void b(View paramView)
  {
    if (!TextUtils.isEmpty(this.b))
    {
      ...
      default: 
        ...
        localObject = paramView.findViewById(2131368493);
    ...
    do
    {
      ...
      paramView.setBackgroundResource(2130838310);
      break;
      paramView = paramView.findViewById(2131378089);
  ...
  public void c(View paramView)
  {
    ...
    for (;;)
    {
      ...
      paramView.setPadding(i, j, k, m);
      return;
      paramView.setBackgroundResource(2130838324);
      continue;
      paramView.setBackgroundResource(2130838327);
      continue;
      paramView.setBackgroundResource(2130838323);
      continue;
  ...
  protected void d(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        if (!TextUtils.isEmpty(this.b))
        {
          this.jdField_q_of_type_Int = 2130838314;
          break;
        }
        this.jdField_q_of_type_Int = 2130838328;
        break;
        if (!TextUtils.isEmpty(this.b))
        {
          this.jdField_q_of_type_Int = 2130838315;
          break;
        }
        this.jdField_q_of_type_Int = 2130838329;
        break;
        paramView.setBackgroundResource(2130838313);
        return;
      ...
      float f3 = i;
      float f4 = i;
      localStateListDrawable = bdqf.a(paramView.getResources(), this.jdField_p_of_type_Int, new float[] { f1, f2, f3, f4, 0.0F, 0.0F, 0.0F, 0.0F });
