...
public class lhh
{
  ...
  public lhh(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public void a()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Lhi == null)
      {
        ...
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().registerReceiver(this.jdField_a_of_type_Lhi, (IntentFilter)localObject);
      }
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_JavaLangObject = mtp.a(localDexClassLoader, "com.tencent.av.camera2.CameraManagerWrapper");
    ...
    mtp.a(localDexClassLoader, localObject, "registerAvailabilityCb", new Class[] { Context.class, String.class, Handler.class }, new Object[] { localContext, str, null });
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().unregisterReceiver(this.jdField_a_of_type_Lhi);
        ...
        mtp.a(mtp.a(), this.jdField_a_of_type_JavaLangObject, "unRegisterAvailabilityCb", null, null);
        return;
      }
