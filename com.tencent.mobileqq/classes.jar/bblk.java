...
public class bblk
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    paramString = paramQQAppInterface.getMessageFacade().getMsgList(paramString, 0);
    int i = j;
    if (paramString != null)
    {
      i = j;
      ...
      {
        i = j;
        if (abwz.a((MessageRecord)paramString.get(paramString.size() - 1), localMessageRecord, false))
        {
