...
public class ajce
{
  ...
  public static ajce a(oidb_0xe3b.RecommendPerson paramRecommendPerson)
  {
    int j = -1;
    ajce localajce = new ajce();
    localajce.jdField_a_of_type_JavaLangString = String.valueOf(paramRecommendPerson.uint64_uin.get());
    Object localObject;
    label74:
    int i;
    label98:
    ...
    for (paramRecommendPerson = localLabel.bytes_name.get().toStringUtf8();; paramRecommendPerson = "")
    {
      ...
      localajce.jdField_a_of_type_JavaUtilArrayList.add(localRecommendLabel);
      break label173;
      localObject = "";
      break;
      localObject = "";
