  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public avrb(Context paramContext, oeq paramoeq)
  {
  ...
  private void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    QZoneShareManager.shareToQzone(paramContext, String.valueOf(bizw.a().a()), localQZoneShareData, null, 1003);
    bdla.b(null, "dc00898", "", this.jdField_a_of_type_Oeq.a.a, "0X80092A4", "0X80092A4", 0, 0, this.jdField_a_of_type_Oeq.a.c, "", "", this.jdField_a_of_type_Oeq.a.b);
  }
  ...
  private void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    if (a(paramContext, paramInt))
    {
      ...
      if (jdField_a_of_type_ComTencentImageURLDrawable.getStatus() == 1) {
        a(paramContext, paramString1, paramString2, axxe.a(jdField_a_of_type_ComTencentImageURLDrawable), paramString3, paramInt);
      }
    }
    else
    {
    ...
    jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new avrc(this, paramContext, paramString1, paramString2, paramString3, paramInt));
    jdField_a_of_type_ComTencentImageURLDrawable.startDownload();
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, Bitmap paramBitmap, String paramString4, int paramInt)
  {
    ...
    if (paramInt == 1001)
    {
      ...
      bdla.b(null, "dc00898", "", this.jdField_a_of_type_Oeq.a.a, "0X80092A3", "0X80092A3", 0, 0, this.jdField_a_of_type_Oeq.a.c, "", "", this.jdField_a_of_type_Oeq.a.b);
    }
    while (paramInt != 1002) {
      return;
    }
    WXShareHelper.a().a(paramString1, paramString2, paramBitmap, paramString3, paramString4);
    bdla.b(null, "dc00898", "", this.jdField_a_of_type_Oeq.a.a, "0X80092A5", "0X80092A5", 0, 0, this.jdField_a_of_type_Oeq.a.c, "", "", this.jdField_a_of_type_Oeq.a.b);
  }
  
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    paramString4 = new bdnr(StructMsgForGeneralShare.class).c(127).b(12345).e(paramString4).a(anvx.a(2131705222) + paramString3).a();
    Object localObject = this.jdField_a_of_type_Oeq.a.v;
    String str = this.jdField_a_of_type_Oeq.a.w;
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      paramString4.mSourceName = this.jdField_a_of_type_Oeq.a.v;
      if (!TextUtils.isEmpty(str)) {
        paramString4.mSourceIcon = this.jdField_a_of_type_Oeq.a.w;
      }
    }
    paramString4.mContentLayout = 2;
    localObject = bdoe.a(2);
    ((bdnv)localObject).a(paramString1, paramString2, paramString3);
    paramString4.addItem((bdnu)localObject);
    ...
    aupt.a((Activity)this.jdField_a_of_type_AndroidContentContext, paramString1, 1000);
    bdla.b(null, "dc00898", "", this.jdField_a_of_type_Oeq.a.a, "0X80092A2", "0X80092A2", 0, 0, this.jdField_a_of_type_Oeq.a.c, "", "", this.jdField_a_of_type_Oeq.a.b);
  }
  ...
  private boolean a(Context paramContext, int paramInt)
  {
    ...
    {
      QQToast.a(paramContext, 2131694143, 0).a();
      return false;
    }
    if (!WXShareHelper.a().b())
    {
      QQToast.a(paramContext, 2131720176, 0).a();
      return false;
    }
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext, 1, 2131694255, 1).a();
      return false;
    }
    return true;
  }
  ...
  private boolean a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      if (!bool) {
        QQToast.a(paramContext, 2131717292, 0).a();
      }
      return bool;
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a()
  {
    ...
    localArrayList.add(a(2131696130, 2130839146, true, 2, ""));
    localArrayList.add(a(2131696143, 2130839147, true, 3, ""));
    localArrayList.add(a(2131696150, 2130839150, true, 9, ""));
    localArrayList.add(a(2131696133, 2130839144, true, 10, ""));
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if (QLog.isColorLevel())
    {
      if ("onshare_ItemClick mAdItem " + this.jdField_a_of_type_Oeq == null)
      {
        localObject1 = " null";
    ...
    else
    {
      ...
      if ((localObject4 != null) && (this.jdField_a_of_type_Oeq != null)) {
        break label87;
      }
    }
    label87:
    ...
    do
    {
      ...
      return;
      localObject1 = this.jdField_a_of_type_Oeq.toString();
      break;
      str2 = this.jdField_a_of_type_Oeq.a.x;
      localObject2 = this.jdField_a_of_type_Oeq.a.t;
      localObject3 = this.jdField_a_of_type_Oeq.a.s;
      String str1 = this.jdField_a_of_type_Oeq.a.u;
      localObject1 = localObject2;
      if (TextUtils.isEmpty((CharSequence)localObject2)) {
        localObject1 = this.jdField_a_of_type_Oeq.e;
      }
      localObject2 = localObject3;
      if (TextUtils.isEmpty((CharSequence)localObject3)) {
        localObject2 = this.jdField_a_of_type_Oeq.d;
      }
      localObject3 = str1;
      if (TextUtils.isEmpty(str1)) {
        localObject3 = this.jdField_a_of_type_Oeq.f;
      }
