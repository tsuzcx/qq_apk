...
public class bmpo
{
  public static Intent a(String paramString1, String paramString2, bnck parambnck, String paramString3, String paramString4)
  {
    Intent localIntent = new Intent();
    localIntent.putExtra("uin", parambnck.jdField_a_of_type_JavaLangString);
    localIntent.putExtra("troop_uin", parambnck.b);
    localIntent.putExtra("uintype", parambnck.jdField_a_of_type_Int);
    localIntent.putExtra("from_uin_type", parambnck.jdField_a_of_type_Int);
    ...
    paramString3 = bdhe.a(arrr.d(paramString2));
    ...
    parambnck.g = str;
    parambnck = new bnsg();
    int i = bnsf.a(paramString1, parambnck);
    if (i != 0)
    {
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, boolean paramBoolean, int paramInt, String paramString3)
  {
    ...
    String str2 = bdhe.a(arrr.d(paramString1));
    if (str2 == null)
    {
      QLog.e("ShortVideoForwardManager", 1, "video file md5 compute fail");
      return;
    }
    String str1 = bdhe.a(arrr.d(paramString2));
    if (str1 == null)
    {
      QLog.e("ShortVideoForwardManager", 1, "thumb file md5 compute fail");
      return;
    ...
    int i = bnsf.a(paramString1, localbnsg);
    if (i != 0)
    {
      QLog.e("ShortVideoForwardManager", 1, new Object[] { "video file getRotationDegree fail, code:", Integer.valueOf(i) });
      return;
    ...
    if (TextUtils.isEmpty(paramString3))
    {
      ...
      {
        localIntent.putExtra("qq_camera_scheme", bnld.a(paramString1));
        localIntent.putExtra("widgetinfo", paramString1);
        paramString1 = paramActivity.getIntent().getStringExtra("key_camera_material_name");
        bljn.b("ShortVideoForwardManager", "gotoForwardShortVideoUI---activity=" + paramActivity + ", takeSameName=" + paramString1);
        if (TextUtils.isEmpty(paramString1)) {
          break label628;
        }
    ...
    if (((paramActivity instanceof PublicFragmentActivityForPeak)) || ((paramActivity instanceof QQBrowserActivity)))
    {
      ...
      for (;;)
      {
        if (paramActivity.getIntent() == null)
        {
          ...
          paramString3 = "";
          label691:
          bljn.b("ShortVideoForwardManager", "gotoForwardShortVideoUI---activity=" + paramActivity + ", takeSameName=" + paramString3);
        }
        try
        {
          if (paramString2.startsWith("http"))
          {
            ...
            localIntent.putExtra("qq_camera_scheme", bnld.a(paramString2));
            if (!TextUtils.isEmpty(paramString3))
            {
        ...
        catch (UnsupportedEncodingException paramString1)
        {
          for (;;)
          {
            ...
            continue;
            if ((!bdnn.a(paramString2)) && (!bdnn.a(paramString1)))
            {
  ...
  public static void a(Activity paramActivity, String paramString1, boolean paramBoolean1, boolean paramBoolean2, String paramString2, String paramString3)
  {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      ...
      if ((paramActivity != null) && (paramActivity.getIntent() != null))
      {
        ...
        if (paramString2 != null)
        {
          ...
          bljn.b("ShortVideoForwardManager", "gotoForwardPicUI---activity=" + paramActivity + ", takeSameName=" + paramString2);
          if (TextUtils.isEmpty(paramString2)) {
            break label485;
          }
    ...
    for (;;)
    {
      ...
      aryv.a(paramActivity, "caller_aecamera", localIntent, 21, 100200);
      return;
      if (!paramBoolean2) {
        break;
      }
      localIntent.putExtra("forward_summary_extra", alud.a(2131714434));
      break;
      label485:
      localIntent.putExtra("qq_camera_top_title", "魔法视频");
    }
    label500:
    aryv.a(paramActivity, localIntent, 21, 100200);
  }
}
