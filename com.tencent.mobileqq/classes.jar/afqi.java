...
class afqi
  implements beir
{
  afqi(afqh paramafqh, boolean paramBoolean) {}
  ...
  public void a(View paramView)
  {
    ...
    if ((paramView instanceof AnimationTextView))
    {
      ...
      f1 = ((AnimationTextView)localObject).touchL - afqh.a();
      f2 = ((AnimationTextView)localObject).touchT;
      f3 = afqh.b();
      if (this.jdField_a_of_type_Boolean) {
        f1 = ((AnimationTextView)localObject).touchL - afqh.c();
      }
    ...
    for (int i = k;; i = -1)
    {
      ...
      {
        apro.a((bain[])localObject, f1, f2 - f3, bool2, i, j, this.jdField_a_of_type_Afqh.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Afqh.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (Activity)this.jdField_a_of_type_Afqh.jdField_a_of_type_AndroidContentContext, bool1);
        return;
        label314:
        bool2 = false;
        break;
