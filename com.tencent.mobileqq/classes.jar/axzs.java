  ...
  extends axxs
{
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          {
            label221:
            paramaxtc = (axzl)localaxyv.jdField_a_of_type_JavaUtilList.get(0);
            try
            {
              ...
              paramaxtc.jdField_a_of_type_JavaLangString = ((PttShortVideo.PttShortVideoUploadResp)localObject).str_fileid.get();
              paramaxtc.jdField_a_of_type_Int = ((PttShortVideo.PttShortVideoUploadResp)localObject).uint32_is_hot_file.get();
              paramaxtc.jdField_b_of_type_Int = ((PttShortVideo.PttShortVideoUploadResp)localObject).uint32_long_video_carry_watch_point_type.get();
  ...
  public void a(axyg paramaxyg)
  {
    ...
    if ((paramaxyg != null) && (paramaxyg.jdField_a_of_type_JavaUtilList != null) && (paramaxyg.jdField_a_of_type_ComTencentMobileqqTransfileProtoReqManager != null))
    {
      ...
      localaxtb.jdField_a_of_type_JavaLangString = "PttCenterSvr.ShortVideoUpReq";
    }
    for (;;)
    {
      ...
      if ((1 == localaxyr.f) || (3000 == localaxyr.f)) {
        localaxtb.jdField_a_of_type_JavaLangString = "PttCenterSvr.GroupShortVideoUpReq";
      } else {
        localaxtb.jdField_a_of_type_JavaLangString = "PttCenterSvr.ShortVideoUpReq";
      }
    }
  ...
  byte[] a(List<axyr> paramList)
  {
    ...
    if (paramList.size() == 1)
    {
      paramList = (axyu)paramList.get(0);
  ...
  void b(axyg paramaxyg)
  {
    ...
    {
      axzl localaxzl = new axzl();
      localaxyv.jdField_a_of_type_JavaUtilList.add(i, localaxzl);
      i += 1;
    }
  }
}
