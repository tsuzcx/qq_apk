  ...
  extends axup
{
  ...
  String am;
  String an;
  private View.OnClickListener b = new axzt(this);
  public boolean b;
  public long c;
  public boolean c;
  boolean d;
  ...
  public axzs()
  {
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new axzw(this);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new axzx(this);
    this.jdField_a_of_type_JavaLangString = "video";
    this.jdField_a_of_type_Int = 14;
  }
  
  public axzs(String paramString1, int paramInt1, String paramString2, String paramString3, String paramString4, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, String paramString5, String paramString6, String paramString7, int paramInt7, long paramLong)
  {
    this.jdField_c_of_type_Boolean = true;
    this.jdField_d_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new axzw(this);
  ...
  public axzs(String paramString1, String paramString2, boolean paramBoolean)
  {
    this.jdField_c_of_type_Boolean = true;
    this.jdField_d_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new axzw(this);
  ...
  private void a(Context paramContext)
  {
    ...
    do
    {
      ...
      paramContext = axut.a(b());
    } while (TextUtils.isEmpty(paramContext));
    axqy.b(null, "CliOper", "", "", "0X8005F58", "0X8005F58", 0, 0, "", "", paramContext, "");
  }
  ...
  private void a(Context paramContext, View paramView)
  {
    if (this.k == 1)
    {
      if ((paramView instanceof AnyScaleTypeImageView)) {
        ((AnyScaleTypeImageView)paramView).setImageResource(2130839138);
      }
      if (this.jdField_a_of_type_Ayaa == null) {
        this.jdField_a_of_type_Ayaa = new ayaa(this);
      }
  ...
  private void a(Context paramContext, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(b()))
    {
      ...
      if (!TextUtils.isEmpty(paramContext)) {
        axqy.b(null, "CliOper", "", "", "0X8005F57", "0X8005F57", 0, 0, "", "", paramContext, "");
      }
    }
  }
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (this.Y = localBundle.getString("VIDEO_PUB_ACCOUNT_NAME");; this.Y = String.valueOf(((StructMsgForGeneralShare)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg).mSourceName))
    {
      ...
      if (paramView.getTag(2131376579) != null)
      {
        paramContext = paramView.getTag(2131376579);
        if ((paramContext instanceof axzz))
        {
          paramContext = (axzz)paramContext;
    ...
    paramBundle.setId(2131376579);
    paramBundle.setScaleType(ImageView.ScaleType.CENTER_CROP);
    paramBundle.setContentDescription(((Resources)localObject1).getText(2131719812));
    ...
    if (bool1)
    {
      ...
      if (this.n >= this.o)
      {
        ...
        ((ImageView)localObject2).setImageResource(2130842640);
        ((ImageView)localObject2).setVisibility(8);
        i = actj.a(62.0F, (Resources)localObject1);
        if (bool1) {
          i = actj.a(50.0F, (Resources)localObject1);
        }
        localObject3 = new RelativeLayout.LayoutParams(i, i);
        ((RelativeLayout.LayoutParams)localObject3).addRule(13);
        if (bool1)
        {
          i = actj.a(10.0F, (Resources)localObject1) / 2;
        ...
        ((RelativeLayout.LayoutParams)localObject4).addRule(5, 2131376579);
        ((RelativeLayout.LayoutParams)localObject4).addRule(7, 2131376579);
        ((RelativeLayout.LayoutParams)localObject4).addRule(8, 2131376579);
        if (!bool1) {
          break label1361;
        }
        i = actj.a(7.0F, (Resources)localObject1);
        if (!bool1) {
          break label1429;
        }
        ...
        j = actj.a(10.0F, (Resources)localObject1) + i;
        i1 = i;
      }
    }
    for (;;)
    {
      ...
      ((TextView)localObject4).setId(2131376578);
      ...
      if (bool1)
      {
        ...
        ((LinearLayout.LayoutParams)localObject5).rightMargin = actj.a(7.0F, (Resources)localObject1);
        ...
        localObject5 = new axzz();
        ((axzz)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView = paramBundle;
        ((axzz)localObject5).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject4);
        ((axzz)localObject5).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localObject2);
        ((axzz)localObject5).b = ((TextView)localObject1);
        ((axzz)localObject5).jdField_a_of_type_AndroidViewView = ((View)localObject3);
        paramView.setTag(2131376579, localObject5);
        paramView.setTag(this);
        ((axzz)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView.a(this, (axzz)localObject5);
        boolean bool2 = axuk.a().a(paramContext, 3, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.uinType);
        if (QLog.isColorLevel()) {
        ...
        ((axzz)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView.d();
      }
      for (;;)
      {
        if (this.m > 0) {
          ((axzz)localObject5).b.setText(ShortVideoUtils.a(this.m * 1000));
        }
        if (!TextUtils.isEmpty(this.ak)) {
          paramView.setTag(2131376585, this.ak);
        }
        ...
        break label547;
        label1361:
        i = actj.a(12.0F, (Resources)localObject1);
        break label628;
        label1374:
        i1 = actj.a(10.0F, (Resources)localObject1) + i;
        j = i;
        break label680;
        ...
        break label823;
        label1418:
        ((axzz)localObject5).jdField_a_of_type_ComTencentMobileqqWidgetPAVideoView.f();
      }
      label1429:
      j = i;
      i1 = i;
  ...
  protected void a(Context paramContext, StructMsgForGeneralShare paramStructMsgForGeneralShare, long paramLong)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        if ((qvk.a(paramContext)) || ((localQQAppInterface != null) && (localQQAppInterface.c())))
        {
      ...
      for (String str = paramStructMsgForGeneralShare.mCreateTime.substring(0, paramStructMsgForGeneralShare.mCreateTime.indexOf(" "));; str = paramStructMsgForGeneralShare.mCreateTime)
      {
        ...
        if (!bool1)
        {
          ...
          {
            onu.a();
            localBundle.putString("VIDEO_THIRD_URL", onu.a(this.V));
          }
        }
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message != null)) {
          axqy.b(null, "dc00899", "Pb_account_lifeservice", this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message.frienduin, "0X8006830", "0X8006830", 0, 0, this.U, "" + this.r, "" + this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.msgId, "");
        }
        ...
        if ((Aladdin.getConfig(261).getIntegerFromString("enable_floating_layer_style", 0) == 1) && (bhwf.b(paramContext, this.Z))) {
          break;
        }
        bool1 = false;
        try
        {
          boolean bool2 = ope.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), Integer.valueOf(localBundle.getString("VIDEO_WIDTH")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_HEIGHT")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_TIME")).intValue());
          bool1 = bool2;
        }
  ...
  public boolean a(axwg paramaxwg)
  {
    ...
    for (;;)
    {
      ...
      String str1 = paramaxwg.a("load");
      this.U = paramaxwg.a("vInfo");
      this.V = paramaxwg.a("tInfo");
      String str2 = paramaxwg.a("preTime");
      if (str2 != null) {}
      try
      {
        this.m = Integer.valueOf(str2).intValue();
        label81:
        str2 = paramaxwg.a("preWidth");
        if (str2 == null) {}
      }
            ...
            try
            {
              ...
              catch (RuntimeException localNumberFormatException4)
              {
                try
                {
                  ...
                  label199:
                  this.Z = paramaxwg.a("aID");
                  this.ak = paramaxwg.a("jumpUrl");
                  this.jdField_d_of_type_Boolean = "1".equals(paramaxwg.a("isJump2Web"));
                  str1 = paramaxwg.a("preStartPosi");
                  if (!TextUtils.isEmpty(str1)) {}
                  try
                  {
                    this.l = Integer.valueOf(str1).intValue();
                    this.al = paramaxwg.a("apurl");
                    this.am = paramaxwg.a("rl");
                    this.an = paramaxwg.a("disType");
                    str1 = paramaxwg.a("feedId");
                    if (TextUtils.isEmpty(str1)) {}
                  }
                  catch (Exception localNumberFormatException4)
                  {
                        ...
                        catch (NumberFormatException localNumberFormatException4)
                        {
                          ...
                          catch (NumberFormatException localNumberFormatException4)
                          {
                            try
                            {
                              ...
                              this.r = paramaxwg.a("advertiser_id");
                              this.s = paramaxwg.a("aid");
                              this.t = paramaxwg.a("app_download_schema");
                              this.u = paramaxwg.a("canvas_json");
                              this.v = paramaxwg.a("customized_invoke_url");
                              this.w = paramaxwg.a("effect_url");
                              this.x = paramaxwg.a("landing_page");
                              this.y = paramaxwg.a("landing_page_report_url");
                              this.z = paramaxwg.a("noco_id");
                              this.A = paramaxwg.a("product_id");
                              this.C = paramaxwg.a("subordinate_product_id");
                              this.D = paramaxwg.a("traceid");
                              this.E = paramaxwg.a("via");
                              this.F = paramaxwg.a("video_url");
                              this.G = paramaxwg.a("appname");
                              this.H = paramaxwg.a("customized_invoke_url");
                              this.I = paramaxwg.a("pkg_name");
                              this.J = paramaxwg.a("pkgurl");
                              this.B = paramaxwg.a("rl");
                              this.q = paramaxwg.a("apurl");
                              this.N = paramaxwg.a("corporate_image_name");
                              this.O = paramaxwg.a("corporate_logo");
                              if (this.jdField_a_of_type_Int >= 14)
                              {
                                str1 = paramaxwg.a("mini_program_type");
                                if (TextUtils.isEmpty(str1)) {}
                              }
                            }
                            catch (NumberFormatException localNumberFormatException4)
                                ...
                                try
                                {
                                  for (;;)
                                  {
                                    for (;;)
                                    {
                                      ...
                                      paramaxwg = paramaxwg.a("is_hidden");
                                      if (bbkk.a(paramaxwg)) {
                                        break;
                                      }
                                      try
                                      {
                                        this.h = Integer.parseInt(paramaxwg);
                                        return true;
                                      }
  ...
  protected View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (paramBundle.getBoolean("has_cnr"))
    {
      ...
      for (;;)
      {
        paramView.setImageResource(2130844582);
        paramView.setTag(this);
        try
        {
          localObject2 = new axuv(-16777216, j, j, i);
          if (TextUtils.isEmpty(this.S))
          {
            ...
            paramView.setContentDescription(((Resources)localObject1).getString(2131694747));
            paramView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            paramView.setContentDescription(((Resources)localObject1).getText(2131719812));
            localObject1 = paramView;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBundle.getBoolean("has_cnr")) {
          localURLDrawable.setDecodeHandler(new axzy(this, i, j, j));
        }
        if ((ayoi.b(this.S)) || (!aywm.a(paramContext))) {
          break label402;
        }
