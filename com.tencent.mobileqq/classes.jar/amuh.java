...
public class amuh
{
  ...
  public amuh(amug paramamug)
  {
    this.jdField_a_of_type_Amug = paramamug;
  }
  
  private amuj a(QQAppInterface paramQQAppInterface, String paramString)
  {
    int j = 0;
    ...
    {
      localObject1 = (amhd)paramQQAppInterface.getManager(153);
      localObject2 = ((amhd)localObject1).a(paramQQAppInterface, paramString);
    ...
    for (;;)
    {
      try
      {
        ...
        {
          i = j;
          localObject2 = new amuj();
          localObject3 = ((JSONArray)localObject3).getJSONObject(i);
          ((amuj)localObject2).jdField_b_of_type_Int = ((JSONObject)localObject3).getInt("type");
          ((amuj)localObject2).jdField_a_of_type_Int = ((JSONObject)localObject3).getInt("id");
          localObject3 = ((amhd)localObject1).b(paramString);
          if (localObject3 == null) {
            return null;
          }
          if ((((amuj)localObject2).jdField_b_of_type_Int == 4) && (!((ApolloBaseInfo)localObject3).hasPet))
          {
            ((ApolloBaseInfo)localObject3).appearAction = null;
            ((amhd)localObject1).a((ApolloBaseInfo)localObject3);
            return null;
          }
          if (QLog.isColorLevel()) {
            QLog.d("cmshow_scripted_SpriteRscBuilder", 2, new Object[] { "[hasAppearAction] index:", Integer.valueOf(i), ",id:", Integer.valueOf(((amuj)localObject2).jdField_a_of_type_Int), ",standType:", Integer.valueOf(((amuj)localObject2).jdField_b_of_type_Int) });
          }
          if (((amuj)localObject2).jdField_a_of_type_Int <= 0)
          {
            QLog.e("cmshow_scripted_SpriteRscBuilder", 1, new Object[] { "appearAction not correct,actionId:", Integer.valueOf(((amuj)localObject2).jdField_a_of_type_Int) });
            return null;
          }
          if (!ApolloUtil.a(((amuj)localObject2).jdField_a_of_type_Int, 0))
          {
            if (QLog.isColorLevel()) {
              QLog.i("cmshow_scripted_SpriteRscBuilder", 2, "hasAppearAction isActionResDone is false.");
            }
            paramString = new ApolloActionData();
            paramString.actionId = ((amuj)localObject2).jdField_a_of_type_Int;
            localObject1 = ApolloUtil.a(paramString, 5);
            amxb.a(paramQQAppInterface, ApolloUtil.a(paramString, 4), (String)localObject1);
            return null;
          }
  ...
  private SpriteTaskParam a(amuj paramamuj)
  {
    ...
    do
    {
      ...
      localSpriteTaskParam.f = paramamuj.jdField_a_of_type_Int;
      localSpriteTaskParam.k = 12;
      localSpriteTaskParam.g = 5;
      localSpriteTaskParam.jdField_a_of_type_Long = 1000000L;
    } while (paramamuj.jdField_b_of_type_Int != 4);
  ...
  private String a(int paramInt)
  {
    ...
    paramInt = ((amhd)this.jdField_a_of_type_Amug.a().getManager(153)).a(paramInt);
    if ((paramInt != -1) && (!ApolloUtil.a(paramInt, 0)))
    {
      ...
      amxb.a(this.jdField_a_of_type_Amug.a(), (String)localObject, str);
    }
    for (;;)
    {
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    boolean bool1 = ((amhd)paramQQAppInterface.getManager(153)).b(paramString);
    boolean bool2 = paramString.equals(paramQQAppInterface.getCurrentAccountUin());
    int i = amuo.a(paramInt, bool2, bool1, 1, paramBoolean);
    if (QLog.isColorLevel()) {
    ...
    return amzq.a(paramInt, i, amhd.a(paramQQAppInterface, paramString));
  }
  ...
  public static String a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    return amzq.a(paramInt1, i, paramInt2);
  }
  ...
  public static String a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    return amzq.a(paramInt1, paramInt2, paramInt3);
  }
  ...
  {
    if ((paramSpriteTaskParam == null) || (this.jdField_a_of_type_Amug == null)) {
      return null;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        JSONObject localJSONObject2 = a(paramSpriteTaskParam.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Amug, paramSpriteTaskParam, true, false);
        if ((this.jdField_a_of_type_Amug.jdField_a_of_type_Int == 0) || (paramSpriteTaskParam.e == 1))
        {
          localJSONObject1 = a(paramSpriteTaskParam.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Amug, paramSpriteTaskParam, false, false);
          if (localJSONObject2 != null)
          {
            localJSONArray.put(localJSONObject2);
            JSONObject localJSONObject3 = a(paramSpriteTaskParam.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Amug, true);
          ...
          if (localJSONObject1 != null)
          {
            ...
            paramSpriteTaskParam = a(paramSpriteTaskParam.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Amug, false);
  ...
  public static JSONArray a(QQAppInterface paramQQAppInterface, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ancd localancd = (ancd)paramQQAppInterface.getManager(155);
        int i = 0;
        j = 0;
        if (j < localJSONArray2.length())
        {
          ...
          else
          {
            ...
            bool1 = ((amhd)localObject).a(paramJSONObject, 4, null);
            if (!QLog.isColorLevel()) {
              break label514;
            }
            ...
            String[] arrayOfString = amzq.a(1, k, 0, true);
            ((JSONObject)localObject).put("actionId", k);
            ((JSONObject)localObject).put("actionPath", amzq.a(arrayOfString[0], 3));
            if (paramJSONObject.personNum == 1) {
              ((JSONObject)localObject).put("peerPath", amzq.a(amzq.a(1, k, 0, false)[0], 3));
            }
  ...
  private JSONObject a(int paramInt1, int paramInt2)
  {
    try
    {
      ...
      ((SpriteTaskParam)localObject).h = this.jdField_a_of_type_Amug.jdField_a_of_type_Int;
      ((SpriteTaskParam)localObject).jdField_c_of_type_Int = 1;
      if (!a((SpriteTaskParam)localObject)) {
        return null;
      }
      localObject = ((ancd)this.jdField_a_of_type_Amug.a().getManager(155)).a(paramInt1);
      if (localObject == null) {
        return null;
      }
      localJSONObject.put("actionId", paramInt1);
      localJSONObject.put("action", amzq.a(paramInt1, paramInt2, true, this.jdField_a_of_type_Amug.a())[0]);
      if (((ApolloActionData)localObject).personNum == 1) {
        localJSONObject.put("actionPeer", amzq.a(paramInt1, paramInt2, false, this.jdField_a_of_type_Amug.a())[0]);
      }
      if (this.jdField_a_of_type_Amug.jdField_a_of_type_Int == 0)
      {
        localJSONObject.put("actionDis", ((ApolloActionData)localObject).actionMoveDis * (float)bgln.j() / 7.0F / 368.0F);
        localJSONObject.put("actionPeerDis", ((ApolloActionData)localObject).peerMoveDis * (float)bgln.j() / 7.0F / 368.0F);
      }
      else
      {
  ...
  private JSONObject a(String paramString, amug paramamug, SpriteTaskParam paramSpriteTaskParam, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localJSONObject = a(paramString, paramamug, amuo.a(paramString, paramSpriteTaskParam, paramamug, paramBoolean1), (String)localObject);
        if (!a(paramSpriteTaskParam)) {
          return localJSONObject;
        }
        j = amhd.a(paramamug.a(), paramString);
        int k = ((Integer)amzq.a(paramString, j, paramamug.a(), true)[0]).intValue();
        localObject = paramString;
        if (amhd.b(paramamug.a(), paramString, false) == 0)
        {
          localObject = paramString;
          if (paramamug.g())
          {
            if (!b(paramamug.a(), paramString)) {
              break label528;
            }
            paramString = "-2";
            break label520;
        ...
        paramString = amzq.a((String)localObject, paramamug.a(), true);
        ...
        {
          localJSONObject.put("text", amuo.a(bgku.encodeToString(paramSpriteTaskParam.jdField_c_of_type_JavaLangString.getBytes("utf-8"), 0)));
          if (paramSpriteTaskParam.jdField_b_of_type_Boolean) {
            continue;
          }
          localJSONObject.put("bubbleType", 0);
          if ((j == 1) && (paramSpriteTaskParam.f > ancb.jdField_a_of_type_Int) && (amhd.a(paramamug.a())))
          {
            i = 2;
        ...
        else
        {
          ...
          paramString = amzq.a(n, i1, i, paramBoolean1, j);
          if (paramString == null) {
            break label535;
          }
        ...
        if ((j != 2) || (paramSpriteTaskParam.f >= ancb.jdField_a_of_type_Int)) {
          break label513;
        }
        i = 1;
        continue;
      ...
      label403:
      if ((paramamug.jdField_a_of_type_Int == 0) && (!paramBoolean1) && (!paramBoolean2)) {
        break;
      }
      label430:
      paramamug = paramString[0];
      paramString = paramamug;
      if (8 == paramSpriteTaskParam.jdField_c_of_type_Int)
      {
        ...
        if (!TextUtils.isEmpty(paramSpriteTaskParam.jdField_d_of_type_JavaLangString))
        {
          ...
          if (!TextUtils.isEmpty(paramSpriteTaskParam)) {
            paramString = paramamug + paramSpriteTaskParam;
          }
        }
      }
  ...
  private JSONObject a(String paramString1, amug paramamug, boolean paramBoolean, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        amzq.a(paramString1, paramamug.a(), localJSONObject, paramString2);
        if ((amhd.b(paramamug.a(), paramString1, false) == 0) && (paramamug.g()))
        {
          if (!b(paramamug.a(), paramString1)) {
            break label474;
          }
          paramString2 = "-2";
          paramString2 = amzq.a(paramString2, paramamug.a(), true);
          if ((paramString2 == null) || (paramString2.length != 2))
          {
            amuo.a(301, new Object[] { "roleInfos is null" });
            return null;
          }
          ...
          {
            amuo.a(301, new Object[] { "dressInfo is null" });
            return null;
          }
          JSONArray localJSONArray = new JSONArray();
          ...
          if (i < k)
          {
            localJSONArray.put(amzq.a(1, Integer.valueOf(paramString2[i]).intValue()));
            i += 1;
            continue;
          }
          localJSONObject.put("dress", localJSONArray);
          localJSONObject.put("role", amzq.a(0, j));
          if (((paramamug.jdField_a_of_type_Int == 1) || (paramamug.jdField_a_of_type_Int == 3000)) && (!"-1".equals(paramString1)) && (!"-2".equals(paramString1)))
          {
            localJSONObject.put("nameplate", a(paramamug.a(), paramString1, j, paramBoolean));
            paramString2 = paramamug.jdField_b_of_type_JavaLangString;
            if ((TextUtils.isEmpty(paramString2)) || (!paramString2.equals(paramString1))) {
              continue;
            }
            paramString1 = anni.a(2131713015);
            if (!TextUtils.isEmpty(paramString1)) {
              localJSONObject.put("nickname", amuo.a(bgku.encodeToString(paramString1.getBytes("utf-8"), 0)));
            }
          }
          if (this.jdField_a_of_type_Amug.jdField_a_of_type_Amlw == null) {
            break;
          }
          localJSONObject.put("scale", this.jdField_a_of_type_Amug.jdField_a_of_type_Amlw.jdField_a_of_type_Float);
          localJSONObject.put("xPos", this.jdField_a_of_type_Amug.jdField_a_of_type_Amlw.b);
          localJSONObject.put("yPos", this.jdField_a_of_type_Amug.jdField_a_of_type_Amlw.c);
          break;
          paramString1 = amuo.a(paramamug.a(), paramamug.jdField_a_of_type_Int, paramString1, paramamug.jdField_a_of_type_JavaLangString, true);
          continue;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, int[] paramArrayOfInt, ancr paramancr)
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        ancm.a(-1L, paramQQAppInterface, paramString, "", 0, "", paramancr);
        return;
        i = 0;
        for (;;)
        {
      ...
      paramancr.a(-1L, paramQQAppInterface, paramString, "", "", paramInt, paramArrayOfInt, 10);
      return;
      label156:
      i = 0;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, amxn paramamxn)
  {
    int i;
    if (!ApolloUtil.d(paramString))
    {
      ...
      amxb.a(paramQQAppInterface, paramString, paramamxn);
    }
    label25:
    while (paramamxn == null)
    {
      return;
      i = 0;
      break;
  ...
  private JSONArray b(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localancd = (ancd)this.jdField_a_of_type_Amug.a().getManager(155);
        i = 0;
        k = 0;
        j = -1;
        if (k < paramSpriteTaskParam.size())
        {
          ...
          Object localObject = localancd.a(m);
          if (localObject != null)
          {
      ...
      catch (Throwable paramSpriteTaskParam)
      {
        ...
        if (-1 != j)
        {
          paramSpriteTaskParam = localancd.a(j);
        ...
        if (i != 0) {
          aoph.a(this.jdField_a_of_type_Amug.a(), 1);
        }
        return localJSONArray;
      }
      finally
  ...
  private JSONObject b(String paramString, amug paramamug, boolean paramBoolean)
  {
    return a(paramString, paramamug, paramBoolean, null);
  }
  
  public static void b(QQAppInterface paramQQAppInterface, String paramString, int paramInt, int[] paramArrayOfInt, ancr paramancr)
  {
    int k = 0;
    if (paramArrayOfInt == null) {}
    do
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          c(paramQQAppInterface, paramString, paramInt, paramArrayOfInt, paramancr);
          return;
        }
        i += 1;
      }
    } while (paramancr == null);
    paramancr.a(-1L, paramQQAppInterface, paramString, "", "", paramInt, paramArrayOfInt, 10);
  }
  ...
  private JSONArray c(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    //   1: ifnull +10 -> 11
    //   4: aload_0
    //   5: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   8: ifnonnull +7 -> 15
    //   11: aconst_null
    //   12: astore_1
    //   13: aload_1
    ...
    //   26: astore 6
    //   28: aload_0
    //   29: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   32: getfield 373	amug:jdField_a_of_type_Int	I
    //   35: ifne +163 -> 198
    //   38: aload_0
    //   39: aload_0
    //   40: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   43: getfield 591	amug:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   46: aload_0
    //   47: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   50: iconst_1
    //   51: invokespecial 715	amuh:b	(Ljava/lang/String;Lamug;Z)Lorg/json/JSONObject;
    //   54: astore_1
    //   55: aload_0
    //   56: aload_0
    //   57: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   60: getfield 616	amug:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   63: aload_0
    //   64: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   67: iconst_0
    //   68: invokespecial 715	amuh:b	(Ljava/lang/String;Lamug;Z)Lorg/json/JSONObject;
    //   71: astore 7
    //   73: aload_0
    //   74: aload_0
    //   75: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   78: getfield 591	amug:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   81: aload_0
    //   82: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   85: iconst_1
    //   86: invokevirtual 383	amuh:a	(Ljava/lang/String;Lamug;Z)Lorg/json/JSONObject;
    //   89: astore 8
    //   91: aload_0
    //   92: aload_0
    //   93: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   96: getfield 616	amug:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   99: aload_0
    //   100: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   103: iconst_0
    //   104: invokevirtual 383	amuh:a	(Ljava/lang/String;Lamug;Z)Lorg/json/JSONObject;
    //   107: astore 9
    //   109: aload 8
    //   111: ifnull +13 -> 124
    //   114: aload_1
    ...
    //   191: aastore
    //   192: invokestatic 143	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   195: aload 6
    //   197: areturn
    //   198: aload_0
    //   199: aload_1
    ...
    //   203: aload_0
    //   204: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   207: iconst_1
    //   208: invokespecial 715	amuh:b	(Ljava/lang/String;Lamug;Z)Lorg/json/JSONObject;
    //   211: astore_1
    //   212: aload_0
    //   213: aload_0
    //   214: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   217: getfield 591	amug:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   220: aload_0
    //   221: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   224: iconst_1
    //   225: invokevirtual 383	amuh:a	(Ljava/lang/String;Lamug;Z)Lorg/json/JSONObject;
    //   228: astore 7
    //   230: aload 7
    //   232: ifnull +13 -> 245
    //   235: aload_1
    ...
    //   259: ldc_w 719
    //   262: aload_1
    //   263: invokestatic 182	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   266: invokestatic 366	java/lang/System:currentTimeMillis	()J
    //   269: lstore 4
    //   271: invokestatic 128	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   274: ifeq +29 -> 303
    //   277: ldc 130
    //   279: iconst_2
    //   280: iconst_2
    ...
    //   299: aastore
    //   300: invokestatic 143	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   303: aconst_null
    //   304: areturn
    //   305: astore_1
    //   306: invokestatic 366	java/lang/System:currentTimeMillis	()J
    //   309: lstore 4
    //   311: invokestatic 128	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   314: ifeq +29 -> 343
    //   317: ldc 130
    //   319: iconst_2
    //   320: iconst_2
    ...
    //   339: aastore
    //   340: invokestatic 143	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   343: aload_1
    //   344: athrow
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString, int paramInt, int[] paramArrayOfInt, ancr paramancr)
  {
    if ((amzq.a(paramString, paramInt, paramArrayOfInt, paramQQAppInterface, new amui(paramancr, paramQQAppInterface, paramInt, paramArrayOfInt))) && (paramancr != null)) {
      paramancr.a(-1L, paramQQAppInterface, paramString, "", "", paramInt, paramArrayOfInt, 22);
    }
  }
  ...
  public Pair<String, Integer> a(String paramString)
  {
    ...
    if ((amhd.a(this.jdField_a_of_type_Amug.a(), paramString) != 2) && (a(this.jdField_a_of_type_Amug.a(), paramString)))
    {
      localStringBuilder = new StringBuilder();
      localStringBuilder.append(this.jdField_b_of_type_Int).append("/action/action");
      SharedPreferences localSharedPreferences = this.jdField_a_of_type_Amug.a().getApp().getSharedPreferences("apollo_sp", 0);
      if (!localSharedPreferences.getBoolean("stand_type_" + this.jdField_a_of_type_Int, false)) {}
      switch (this.jdField_a_of_type_Int)
      {
      default: 
        localObject = null;
        amtx localamtx = amuo.a(this.jdField_a_of_type_Amug.a());
        if ((!TextUtils.isEmpty((CharSequence)localObject)) && (localamtx != null)) {
          localamtx.a(paramString, (String)localObject);
        }
        ...
        if (this.jdField_a_of_type_Amug.jdField_a_of_type_Int == 3000)
        {
          label297:
    ...
    for (i = 7;; i = 0)
    {
      ...
      localObject = anni.a(2131713019);
      break;
      localObject = anni.a(2131713023);
      break;
      localObject = anni.a(2131713017);
      break;
      i = this.jdField_a_of_type_Amug.jdField_a_of_type_Int;
      break label297;
      return localObject;
    }
  }
  ...
  public String a()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Amug.jdField_a_of_type_Int == 0)
      {
        localJSONObject2 = b(this.jdField_a_of_type_Amug.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Amug, true);
        localJSONObject3 = b(this.jdField_a_of_type_Amug.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Amug, false);
        JSONObject localJSONObject4;
        if (amhd.a(this.jdField_a_of_type_Amug.a(), this.jdField_a_of_type_Amug.jdField_b_of_type_JavaLangString) != 2)
        {
          localJSONObject4 = a(this.jdField_a_of_type_Amug.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Amug, true);
          if (localJSONObject4 != null) {
            localJSONObject2.put("pet", localJSONObject4);
          }
        }
        if (amhd.a(this.jdField_a_of_type_Amug.a(), this.jdField_a_of_type_Amug.jdField_a_of_type_JavaLangString) != 2)
        {
          localJSONObject4 = a(this.jdField_a_of_type_Amug.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Amug, false);
          if (localJSONObject4 != null) {
      ...
      for (;;)
      {
        ...
        if (amhd.a(this.jdField_a_of_type_Amug.a(), this.jdField_a_of_type_Amug.jdField_b_of_type_JavaLangString) != 2)
        {
          localJSONObject3 = a(this.jdField_a_of_type_Amug.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Amug, true);
          if (localJSONObject3 != null) {
            localJSONObject2.put("pet", localJSONObject3);
          }
        }
  ...
  {
    int i = 0;
    if ((this.jdField_a_of_type_Amug == null) || (this.jdField_a_of_type_Amug.a() == null) || (TextUtils.isEmpty(paramString))) {
      return null;
    }
    ...
    localObject = (amhd)this.jdField_a_of_type_Amug.a().getManager(153);
    if (TextUtils.isEmpty(((amhd)localObject).j)) {
      return null;
    }
    for (;;)
    {
      try
      {
        JSONArray localJSONArray = new JSONArray(((amhd)localObject).j);
        ...
        if (i < j)
        {
          ...
          ((amhd)localObject).a(paramString, 4);
        }
      }
      catch (Exception paramString)
      {
  ...
  public String a(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    for (;;)
    {
      try
      {
        JSONObject localJSONObject = new JSONObject();
        int i;
        if (this.jdField_a_of_type_Amug.e == 0)
        {
          localObject = ApolloActionData.getModelString(paramSpriteTaskParam.f);
          ...
          if (!amuo.a(this.jdField_a_of_type_Amug.a())) {
            break label349;
          }
          i = 1;
        ...
        else
        {
          ...
          localObject = amzq.a(paramSpriteTaskParam.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Amug.a());
          continue;
        }
  ...
  {
    JSONArray localJSONArray = new JSONArray();
    if ((this.jdField_a_of_type_Amug == null) || (this.jdField_a_of_type_Amug.a() == null) || (paramJSONArray == null)) {
      return localJSONArray;
    }
    StringBuilder localStringBuilder = new StringBuilder();
    ...
    for (;;)
    {
      try
      {
        ...
        if ((paramSpriteTaskParam.k == 12) && (paramSpriteTaskParam.f > 0))
        {
          ...
          {
            localObject1 = ((String)localObject2).substring(ancb.jdField_d_of_type_JavaLangString.length());
            continue;
          }
        }
        else
        {
          localObject2 = (amhd)this.jdField_a_of_type_Amug.a().getManager(153);
          ApolloActionData localApolloActionData = ((ancd)this.jdField_a_of_type_Amug.a().getManager(155)).a(paramSpriteTaskParam.f);
          if ((localApolloActionData != null) && (localApolloActionData.hasSound))
          {
            localObject1 = ancb.jdField_d_of_type_JavaLangString + paramSpriteTaskParam.f + "/" + "music.amr";
            if (new File((String)localObject1).exists()) {
              break label377;
            }
            ((amhd)localObject2).a(localApolloActionData, 4, null);
            continue;
          }
          if (paramSpriteTaskParam.i > 0)
          {
            localObject2 = amxb.b(paramSpriteTaskParam.i);
            localObject1 = localObject2;
            if (new File((String)localObject2).exists()) {
              continue;
            }
            amxb.a(this.jdField_a_of_type_Amug.a(), null, paramSpriteTaskParam.i, false);
            localObject1 = localObject2;
            continue;
          }
          return null;
  ...
  /* Error */
  public JSONObject a(String paramString, amug paramamug, boolean paramBoolean)
  {
    // Byte code:
    ...
    //   61: aload 13
    //   63: aload_1
    //   64: invokevirtual 109	amhd:b	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   67: astore 16
    //   69: aload 16
    //   71: ifnonnull +5 -> 76
    //   74: aconst_null
    ...
    //   90: istore 8
    //   92: aload 16
    //   94: invokevirtual 898	com/tencent/mobileqq/data/ApolloBaseInfo:getApolloPetDress	()Lamls;
    //   97: astore 17
    //   99: aload 17
    //   101: ifnull +988 -> 1089
    //   104: iload 5
    ...
    //   118: istore 8
    //   120: aload 16
    //   122: getfield 115	com/tencent/mobileqq/data/ApolloBaseInfo:hasPet	Z
    //   125: ifeq +964 -> 1089
    //   128: iload 5
    //   130: istore 9
    //   132: iload 11
    ...
    //   142: istore 8
    //   144: aload 17
    //   146: getfield 903	amls:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   149: ifnull +940 -> 1089
    //   152: iload 5
    //   154: istore 9
    //   156: iload 11
    ...
    //   166: istore 8
    //   168: aload 17
    //   170: getfield 903	amls:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    ...
    //   200: iconst_0
    //   201: aload 17
    //   203: getfield 906	amls:jdField_a_of_type_Int	I
    //   206: invokestatic 582	amzq:a	(II)Ljava/lang/String;
    ...
    //   233: iconst_1
    //   234: aload 17
    //   236: getfield 906	amls:jdField_a_of_type_Int	I
    ...
    //   260: istore 10
    //   262: aload 17
    //   264: getfield 906	amls:jdField_a_of_type_Int	I
    //   267: istore 4
    //   269: iload 4
    //   271: istore 9
    //   273: iload 6
    ...
    //   283: istore 8
    //   285: aload 17
    //   287: getfield 903	amls:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    ...
    //   311: istore 8
    //   313: aload 17
    //   315: getfield 903	amls:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    ...
    //   485: iconst_1
    //   486: iload 9
    //   488: invokestatic 582	amzq:a	(II)Ljava/lang/String;
    ...
    //   521: aload 15
    //   523: iload 9
    //   525: invokestatic 136	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    ...
    //   566: ldc_w 308
    //   569: aload 17
    //   571: getfield 906	amls:jdField_a_of_type_Int	I
    ...
    //   586: aload_0
    //   587: aload 17
    //   589: getfield 906	amls:jdField_a_of_type_Int	I
    //   592: ldc_w 940
    //   595: invokevirtual 942	amuh:a	(ILjava/lang/String;)Ljava/lang/String;
    //   598: astore 18
    //   600: iload 5
    //   602: istore 6
    //   604: iload 5
    ...
    //   608: aload_0
    //   609: aload 17
    //   611: getfield 906	amls:jdField_a_of_type_Int	I
    //   614: ldc_w 944
    //   617: invokevirtual 942	amuh:a	(ILjava/lang/String;)Ljava/lang/String;
    //   620: astore 19
    //   622: iload 5
    //   624: istore 6
    //   626: iload 5
    ...
    //   700: aload_0
    //   701: aload 17
    //   703: getfield 906	amls:jdField_a_of_type_Int	I
    //   706: invokespecial 949	amuh:a	(I)Ljava/lang/String;
    //   709: astore 18
    //   711: iload 5
    //   713: istore 6
    //   715: iload 5
    ...
    //   804: iconst_0
    //   805: invokestatic 540	bgku:encodeToString	([BI)Ljava/lang/String;
    //   808: invokestatic 542	amuo:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   825: ldc_w 588
    //   828: aload 13
    //   830: getfield 796	amhd:j	Ljava/lang/String;
    //   833: aload 17
    //   835: getfield 906	amls:jdField_a_of_type_Int	I
    //   838: iload_3
    //   839: invokestatic 956	amuh:a	(Ljava/lang/String;IZ)Ljava/lang/String;
    ...
    //   852: istore 7
    //   854: aload_0
    //   855: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   858: getfield 601	amug:jdField_a_of_type_Amlw	Lamlw;
    //   861: ifnull +87 -> 948
    //   864: iload 5
    //   866: istore 6
    //   868: iload 5
    ...
    //   874: ldc_w 603
    //   877: aload_0
    //   878: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   881: getfield 601	amug:jdField_a_of_type_Amlw	Lamlw;
    //   884: getfield 607	amlw:jdField_a_of_type_Float	F
    //   887: f2d
    ...
    //   902: ldc_w 609
    //   905: aload_0
    //   906: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   909: getfield 601	amug:jdField_a_of_type_Amlw	Lamlw;
    //   912: getfield 611	amlw:b	F
    //   915: f2d
    ...
    //   930: ldc_w 613
    //   933: aload_0
    //   934: getfield 43	amuh:jdField_a_of_type_Amug	Lamug;
    //   937: getfield 601	amug:jdField_a_of_type_Amlw	Lamlw;
    //   940: getfield 615	amlw:c	F
    //   943: f2d
    ...
    //   959: ifnull +484 -> 1443
    //   962: aload_2
    //   963: invokevirtual 234	amug:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   966: ifnull +477 -> 1443
    //   969: ldc 242
    //   971: iconst_1
    ...
    //   1063: goto -110 -> 953
    //   1066: aload_2
    //   1067: invokevirtual 234	amug:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1070: aload_1
    //   1071: aload 13
    //   1073: invokevirtual 963	amhd:a	()Lamxk;
    //   1076: iload 4
    //   1078: aload 16
    //   1080: iconst_m1
    //   1081: iconst_m1
    //   1082: iconst_1
    //   1083: invokestatic 966	amxb:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Lamxk;I[IIIZ)V
    //   1086: aload 14
    //   1088: areturn
    //   1089: aconst_null
    //   1090: areturn
    ...
    //   1128: aload_2
    //   1129: invokevirtual 234	amug:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1223: goto -34 -> 1189
    //   1226: aload_2
    //   1227: invokevirtual 234	amug:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1230: aload_1
    //   1231: aload 13
    //   1233: invokevirtual 963	amhd:a	()Lamxk;
    //   1236: iload 4
    //   1238: aload 14
    //   1240: iconst_m1
    //   1241: iconst_m1
    //   1242: iconst_1
    //   1243: invokestatic 966	amxb:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Lamxk;I[IIIZ)V
    //   1246: aconst_null
    //   1247: areturn
    //   1248: astore 14
    //   1250: aconst_null
    ...
    //   1273: aload_2
    //   1274: invokevirtual 234	amug:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   1368: goto -34 -> 1334
    //   1371: aload_2
    //   1372: invokevirtual 234	amug:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1375: aload_1
    //   1376: aload 13
    //   1378: invokevirtual 963	amhd:a	()Lamxk;
    //   1381: iload 4
    //   1383: aload 16
    //   1385: iconst_m1
    //   1386: iconst_m1
    //   1387: iconst_1
    //   1388: invokestatic 966	amxb:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Lamxk;I[IIIZ)V
    //   1391: aload 14
    //   1393: athrow
    //   1394: astore 14
    //   1396: iload 7
  ...
  public void a(List<String> paramList)
  {
    ...
    do
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        paramList = a(this.jdField_a_of_type_Amug.a(), str);
        if (str.equals(this.jdField_a_of_type_Amug.jdField_b_of_type_JavaLangString)) {}
      ...
      amuo.a(this.jdField_a_of_type_Amug, (List)localObject3);
    } while (localObject1 == null);
    Object localObject2 = this.jdField_a_of_type_Amug.a().getApp().getSharedPreferences("apollo_sp", 0);
    if (!((SharedPreferences)localObject2).getBoolean("stand_type_" + ((amuj)localObject1).jdField_b_of_type_Int, false)) {}
    switch (((amuj)localObject1).jdField_b_of_type_Int)
    {
    default: 
      paramList = null;
      localObject3 = amuo.a(this.jdField_a_of_type_Amug.a());
      if ((!TextUtils.isEmpty(paramList)) && (localObject3 != null)) {
        ((amtx)localObject3).a(this.jdField_a_of_type_Amug.jdField_b_of_type_JavaLangString, paramList);
      }
      ((SharedPreferences)localObject2).edit().putBoolean("stand_type_" + ((amuj)localObject1).jdField_b_of_type_Int, true).commit();
      if (this.jdField_a_of_type_Amug.jdField_a_of_type_Int != 3000) {
        break;
      }
    }
    for (int i = 2;; i = this.jdField_a_of_type_Amug.jdField_a_of_type_Int)
    {
      VipUtils.a(null, "cmshow", "Apollo", "appearanceaction", i, ((amuj)localObject1).jdField_b_of_type_Int, new String[] { String.valueOf(((amuj)localObject1).jdField_a_of_type_Int) });
      return;
      paramList = anni.a(2131713018);
      break;
      paramList = anni.a(2131713014);
      break;
      paramList = anni.a(2131713021);
      break;
    }
  }
  ...
  {
    if ((paramSpriteTaskParam == null) || (this.jdField_a_of_type_Amug == null) || (this.jdField_a_of_type_Amug.a() == null)) {
      return false;
    }
    ...
    if (paramSpriteTaskParam.k == 6)
    {
      ...
      {
        amxb.a(this.jdField_a_of_type_Amug.a(), ApolloUtil.c(paramSpriteTaskParam.f) + "/d.zip", ApolloUtil.d(paramSpriteTaskParam.f));
        return false;
      }
    }
    else if (paramSpriteTaskParam.k == 12)
    {
      if (!ApolloUtil.a(paramSpriteTaskParam.f, 0))
      {
        ...
        localObject = ApolloUtil.a((ApolloActionData)localObject, 4);
        amxb.a(this.jdField_a_of_type_Amug.a(), (String)localObject, paramSpriteTaskParam);
        return false;
      }
    }
    else if ((paramSpriteTaskParam.k == 11) || (paramSpriteTaskParam.k == 7))
    {
      paramSpriteTaskParam = amzq.a(paramSpriteTaskParam.k, paramSpriteTaskParam.f, 0, true);
      ...
      {
        amxb.a(this.jdField_a_of_type_Amug.a(), this.jdField_a_of_type_Amug.a().getCurrentAccountUin(), null, 0, null, -1, -1, true);
        return false;
      }
    }
    return true;
  ...
  boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (int j = ((Integer)jdField_a_of_type_JavaUtilMap.get(paramString)).intValue();; j = 0)
    {
      ...
      if ((this.jdField_a_of_type_Int == 4) && (!((amhd)paramQQAppInterface.getManager(153)).b(paramString).hasPet))
      {
        a(paramString);
        return false;
      }
      ...
      if (!ApolloUtil.a(this.jdField_b_of_type_Int, 0))
      {
        ...
        amxb.a(paramQQAppInterface, ApolloUtil.a(paramString, 4), (String)localObject);
        return false;
      }
  ...
  public boolean b(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    long l1 = System.currentTimeMillis();
    amhd localamhd = (amhd)this.jdField_a_of_type_Amug.a().getManager(153);
    ApolloActionData localApolloActionData = ((ancd)this.jdField_a_of_type_Amug.a().getManager(155)).a(paramSpriteTaskParam.f);
    ...
    {
      Object localObject = ((amul)this.jdField_a_of_type_Amug.a().getManager(249)).a();
      if (!bool1)
      {
        if (localObject != null) {
          ((SpriteUIHandler)localObject).a(0, 0, paramSpriteTaskParam.jdField_a_of_type_Long);
        }
        bool1 = localamhd.a(localApolloActionData, 4, null);
        if (localObject != null) {
          if (!bool1) {
            break label694;
          }
