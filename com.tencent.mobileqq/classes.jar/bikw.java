  ...
  implements QGBitmapLoader.QGBitmapLoaderImpl
{
  ...
  public android.graphics.Bitmap load(java.lang.String paramString)
  {
    ...
    //   48: monitorenter
    //   49: aload_1
    //   50: invokestatic 61	bfuj:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   53: astore_2
    //   54: aload_2
    //   55: ifnull +15 -> 70
    //   58: aload_2
    ...
    //   96: invokespecial 88	uet:<init>	(Lcom/tencent/common/app/BaseApplicationImpl;)V
    //   99: astore 4
    ...
    //   129: dup
    //   130: aload_0
    //   131: invokespecial 104	bikx:<init>	(Lbikw;)V
    //   134: invokevirtual 108	uet:loadImageFile	(Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/io/File;
    //   137: astore_3
    //   138: aload_3
    //   139: astore 8
    //   141: aload_3
    ...
    //   233: astore 7
    //   235: aload_1
    //   236: invokestatic 72	com/tencent/biz/common/util/HttpUtil:isValidUrl	(Ljava/lang/String;)Z
    //   239: ifeq +78 -> 317
    //   242: aload 6
    //   244: astore_2
    //   245: aload 6
    ...
    //   285: bipush 100
    //   287: aload 8
    //   289: invokestatic 143	bfvo:a	(Landroid/graphics/Bitmap;ILjava/io/File;)Z
    //   292: pop
    //   293: aload 6
    //   295: astore_3
    //   296: aload 6
    ...
    //   368: ifnull +10 -> 378
    //   371: aload_3
    //   372: invokevirtual 150	java/io/InputStream:close	()V
    //   375: aload 4
    //   377: astore_2
    //   378: ldc 56
    //   380: monitorenter
    ...
    //   392: aload_1
    //   393: aload_2
    //   394: invokestatic 153	bfuj:a	(Ljava/lang/String;Landroid/graphics/Bitmap;)V
    //   397: ldc 56
    //   399: monitorexit
    //   400: aload_2
    //   401: areturn
    ...
    //   437: invokestatic 157	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   440: aconst_null
    //   441: areturn
    //   442: new 121	java/io/File
    //   445: dup
    //   446: aload_1
    //   447: invokespecial 158	java/io/File:<init>	(Ljava/lang/String;)V
    //   450: astore 8
    //   452: goto -282 -> 170
    //   455: aload_2
    //   456: astore_3
    ...
    //   463: aload 10
    //   465: astore 7
    //   467: getstatic 164	com/tencent/qg/sdk/QGRenderer:assetManager	Landroid/content/res/AssetManager;
    //   470: aload_1
    //   471: invokevirtual 170	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   474: astore 6
    //   476: aload 6
    //   478: astore_3
    //   479: aload_3
    //   480: astore 7
    //   482: aload_3
    //   483: invokestatic 174	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    //   486: astore 4
    //   488: goto -124 -> 364
    //   491: astore_2
    //   492: aload_2
    //   493: invokevirtual 177	java/io/IOException:printStackTrace	()V
    //   496: aload 4
    //   498: astore_2
    //   499: goto -121 -> 378
    //   502: astore 5
    ...
    //   524: ifnull -146 -> 378
    //   527: aload 4
    //   529: invokevirtual 150	java/io/InputStream:close	()V
    //   532: aload_3
    //   533: astore_2
    //   534: goto -156 -> 378
    //   537: astore_2
    //   538: aload_2
    //   539: invokevirtual 177	java/io/IOException:printStackTrace	()V
    //   542: aload_3
    //   543: astore_2
    //   544: goto -166 -> 378
    //   547: astore 5
    ...
    //   572: ifnull -194 -> 378
    //   575: aload 4
    //   577: invokevirtual 150	java/io/InputStream:close	()V
    //   580: aload_3
    //   581: astore_2
    //   582: goto -204 -> 378
    //   585: astore_2
    //   586: aload_2
    //   587: invokevirtual 177	java/io/IOException:printStackTrace	()V
    //   590: aload_3
    //   591: astore_2
    //   592: goto -214 -> 378
    //   595: astore_2
    ...
    //   620: astore_2
    //   621: aload 5
    //   623: invokevirtual 177	java/io/IOException:printStackTrace	()V
    //   626: aload_3
    //   627: astore_2
    //   628: aload 4
    //   630: ifnull -252 -> 378
    //   633: aload 4
    //   635: invokevirtual 150	java/io/InputStream:close	()V
    //   638: aload_3
    //   639: astore_2
    //   640: goto -262 -> 378
    //   643: astore_2
    //   644: aload_2
    //   645: invokevirtual 177	java/io/IOException:printStackTrace	()V
    //   648: aload_3
    //   649: astore_2
    //   650: goto -272 -> 378
    //   653: astore_1
    ...
    //   656: ifnull +8 -> 664
    //   659: aload 7
    //   661: invokevirtual 150	java/io/InputStream:close	()V
    //   664: aload_1
    //   665: athrow
    //   666: astore_2
    //   667: aload_2
    //   668: invokevirtual 177	java/io/IOException:printStackTrace	()V
    //   671: goto -7 -> 664
    //   674: astore_1
    //   675: aload_2
    //   676: astore 7
