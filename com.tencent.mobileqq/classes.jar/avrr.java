  ...
  extends aogx
{
  ...
  public void b(boolean paramBoolean, Object paramObject)
  {
    ...
    Object localObject = avrl.a(localContext);
    if ((localObject != null) && (((bjbs)localObject).isShowing())) {
      ((bjbs)localObject).dismiss();
    }
    label124:
    int j;
    if ((paramBoolean) && ((paramObject instanceof Object[])))
    {
      ...
      if (arrayOfObject.length >= 5)
      {
        ...
        for (paramObject = (String)arrayOfObject[3];; paramObject = null)
        {
          ...
          avrl.a(localContext, (byte[])localObject, j);
          avrl.b.set(false);
          return;
          i = -1;
          break;
    ...
    {
    default: 
      QQToast.a(localContext, 1, anzj.a(2131704373), 0).a();
      avrl.b.set(false);
      return;
    case 1: 
      label234:
      ...
      ((Bundle)localObject).putInt("key_hiboom_type", avrl.a(j));
      paramObject = new Intent();
      paramObject.putExtras((Bundle)localObject);
      auxu.a((Activity)localContext, paramObject, 21);
      return;
    }
    if ((localContext instanceof FragmentActivity))
    {
      ...
      if ((((FragmentActivity)localObject).getChatFragment() != null) && (((FragmentActivity)localObject).getChatFragment().a() != null))
      {
        ...
        ((avrl)((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(219)).a((BaseChatPie)localObject, paramObject, j, avrl.a(j));
  ...
  public void c(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        if (localObject.length >= 5)
        {
          ...
          for (localObject = (String)localObject[4];; localObject = null)
          {
            ...
            avrl.a(localContext, paramObject, j);
            avrl.b.set(false);
            return;
            i = -1;
            break label102;
          ...
          if (paramBoolean)
          {
            if ((localContext instanceof FragmentActivity))
            {
              ...
              if ((paramObject.getChatFragment() != null) && (paramObject.getChatFragment().a() != null))
              {
                ...
                ((avrl)paramObject.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(219)).a(paramObject, (String)localObject, j, avrl.a(j));
                paramObject.aB();
          ...
          ((aogu)((QQAppInterface)paramObject).a(13)).b();
          return;
        }
        paramBoolean = false;
      }
      while (paramBoolean)
      {
        QQToast.a(localContext, 1, anzj.a(2131704370), 0).a();
        avrl.b.set(false);
        return;
