...
public class avrr
{
  ...
  public avrr(String paramString, int paramInt, avrq paramavrq)
  {
  ...
  private boolean b()
  {
    return (c()) && (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) && (this.jdField_a_of_type_Avrq != null);
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_JavaLangString = (this.jdField_b_of_type_JavaLangString + axlv.a() + ".pcm");
  ...
  public void b()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Avrq.b(this.jdField_a_of_type_JavaLangString);
      return;
    }
    catch (IOException localIOException)
    {
