  ...
  extends ClickableSpan
{
  ...
  public arut(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString, int paramInt4, MessageForNearbyMarketGrayTips paramMessageForNearbyMarketGrayTips)
  {
  ...
  public void a(String paramString)
  {
    ...
    if (localQQAppInterface != null)
    {
      ...
      if (((String)localObject).contains("sign=xxx"))
      {
        ...
        paramString = ((String)localObject).replace("sign=xxx", "sign=" + bhbx.a(localQQAppInterface.getMsgCache().n(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.frienduin)));
      }
    ...
    for (;;)
    {
      ...
      if (((String)localObject).equals("https://imgcache.qq.com/club/client/flower/release/html/index.html"))
      {
        ...
        localObject = bhbx.a(localQQAppInterface.getMsgCache().n(paramString));
        localObject = String.format("https://imgcache.qq.com/club/client/flower/release/html/index.html?strangerUin=%s&sign=%s&sourceType=%d&ADTAG=%s&groupCode=%s&_wv=2147347&_bid=2050", new Object[] { axqj.a(paramString), ((String)localObject).toLowerCase(), Integer.valueOf(1), "aio.plus.s", "" });
        paramString = (String)localObject;
      ...
      {
        paramString = ((String)localObject).replace("sign=xxx", "sign=" + bhbx.a(localQQAppInterface.getMsgCache().q(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.frienduin)));
        break;
      }
      paramString = (String)localObject;
      ...
      paramString = ((String)localObject).replace("sign=xxx", "sign=" + bhbx.a(localQQAppInterface.getMsgCache().k(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.frienduin)));
      break;
      label472:
      localObject = paramString;
      if (1010 == this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.istroop) {
  ...
  public void b(String paramString)
  {
    ...
    Object localObject = bhey.a((QQAppInterface)localObject, localContext, paramString);
    if (localObject != null)
    {
      ((bheh)localObject).a();
      return;
  ...
  public void c(String paramString)
  {
    ...
    return;
    ((axpy)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.NEARBY_RELEVANT_HANDLER)).a("tag_nearby_chat", paramString, null);
  ...
  public void onClick(View paramView)
  {
    ...
    if (localQQAppInterface != null)
    {
      bdla.b(localQQAppInterface, "CliOper", "", "", "0X800524C", "0X800524C", 0, 0, String.valueOf(this.c), "", "", "");
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.AioType == 0)
      {
        paramView = "0";
        bdla.b(localQQAppInterface, "dc00899", "grp_lbs", "", "tmp_grey", "clk_link", 0, 0, paramView, "", "", "");
      }
    }
    else
    {
    ...
    do
    {
      ...
      if (axno.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips, "isFaceScoreSecondMember"))
      {
        paramView = "2";
        if (!axno.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips, "isFaceScoreSpecialLike")) {
          break label343;
        }
      }
      for (String str = "2";; str = "1")
      {
        axno.a("clk_hi", this.jdField_a_of_type_ComTencentMobileqqDataMessageForNearbyMarketGrayTips.frienduin, new String[] { paramView, "", "", str });
