  ...
  public void callback(long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, VasQuickUpdateManager paramVasQuickUpdateManager)
  {
    if ((paramLong == 1000L) && (paramString1.startsWith("signature.item.")))
    {
      ...
      if (TextUtils.isDigitsOnly(paramString2))
      {
        ...
        if (gh.a(this.a).containsKey(Integer.valueOf(paramInt2)))
        {
          int i = ((Integer)gh.a(this.a).get(Integer.valueOf(paramInt2))).intValue();
          ...
          gh.a(this.a).remove(Integer.valueOf(paramInt2));
        }
      }
    }
    if (gh.b(this.a).containsKey(paramString1))
    {
      paramString2 = new Bundle();
    ...
    for (paramInt1 = 0;; paramInt1 = -1)
    {
      ...
      paramString2 = EIPCResult.createResult(0, paramString2);
      paramInt1 = ((Integer)gh.b(this.a).get(paramString1)).intValue();
      this.a.callbackResult(paramInt1, paramString2);
      gh.b(this.a).remove(paramString1);
      return;
