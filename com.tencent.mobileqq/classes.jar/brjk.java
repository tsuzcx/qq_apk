...
public class brjk
{
  ...
  public static String a(List<brjk> paramList)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    paramList = paramList.iterator();
    while (paramList.hasNext()) {
      localStringBuilder.append(((brjk)paramList.next()).a()).append(";");
    }
    return localStringBuilder.toString();
  }
  
  public static List<brjk> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      break;
      label56:
      brjk localbrjk = new brjk();
      localbrjk.a(localCharSequence);
      localArrayList.add(localbrjk);
    }
  }
