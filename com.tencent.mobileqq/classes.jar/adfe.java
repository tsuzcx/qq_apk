  ...
  implements adpy
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new adfr(this, null);
  baox jdField_a_of_type_Baox = new adfj(this);
  ...
  VasQuickUpdateManager.CallBacker jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new adfv(this);
  Runnable jdField_a_of_type_JavaLangRunnable = null;
  private float jdField_b_of_type_Float = 1.0F;
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new adfu(this);
  ...
  public adfe(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
  ...
  private int a(adfq paramadfq)
  {
    switch (((MessageForPoke)paramadfq.jdField_a_of_type_ComTencentMobileqqDataChatMessage).interactType)
    {
    default: 
      return awmc.a(paramadfq.jdField_a_of_type_Float * 100.0F);
    case 0: 
    case 1: 
      if (paramadfq.jdField_a_of_type_Float == 2.0F) {
        return awmc.a(150.0F * paramadfq.jdField_a_of_type_Float);
      }
      return awmc.a(paramadfq.jdField_a_of_type_Float * 100.0F);
    case 2: 
      return awmc.a(280.0F * paramadfq.jdField_a_of_type_Float);
    case 3: 
      return awmc.a(90.0F * paramadfq.jdField_a_of_type_Float);
    case 4: 
      return awmc.a(paramadfq.jdField_a_of_type_Float * 100.0F);
    case 6: 
      return 0;
    }
    return awmc.a(230.0F * paramadfq.jdField_a_of_type_Float);
  }
  ...
  public static AnimationSet a(Context paramContext, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      i = aciy.a(22.0F, paramContext.getResources());
      j = aciy.a(30.0F, paramContext.getResources());
      if (!paramBoolean) {
        break label184;
      }
    ...
    for (;;)
    {
      ...
      j = aciy.a(20.0F, paramContext.getResources());
      break;
      label184:
      paramContext = new int[4];
      paramContext[0] = i;
  ...
  private void a(long paramLong, MessageForPoke paramMessageForPoke)
  {
    if (this.jdField_a_of_type_AndroidUtilLruCache == null) {
      this.jdField_a_of_type_AndroidUtilLruCache = new adff(this, jdField_e_of_type_Int);
    }
    this.jdField_a_of_type_AndroidUtilLruCache.put(Long.valueOf(paramLong), paramMessageForPoke);
  }
  
  private void a(adfq paramadfq, MessageForPoke paramMessageForPoke)
  {
    RelativeLayout.LayoutParams localLayoutParams1 = (RelativeLayout.LayoutParams)paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getLayoutParams();
    Object localObject1 = (RelativeLayout.LayoutParams)((ViewGroup)paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getParent()).getLayoutParams();
    RelativeLayout.LayoutParams localLayoutParams2 = (RelativeLayout.LayoutParams)paramadfq.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
    Object localObject2 = (RelativeLayout.LayoutParams)paramadfq.jdField_a_of_type_AndroidWidgetImageView.getLayoutParams();
    Object localObject3 = (RelativeLayout.LayoutParams)paramadfq.jdField_c_of_type_AndroidWidgetImageView.getLayoutParams();
    Object localObject4 = (RelativeLayout.LayoutParams)paramadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.getLayoutParams();
    RelativeLayout.LayoutParams localLayoutParams3 = (RelativeLayout.LayoutParams)paramadfq.jdField_c_of_type_AndroidViewView.getLayoutParams();
    paramadfq.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
    paramadfq.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    paramadfq.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
    paramadfq.jdField_c_of_type_AndroidViewView.setVisibility(8);
    int i;
    label415:
    label480:
    int j;
    ...
    {
    default: 
      paramadfq.jdField_a_of_type_Float = this.jdField_b_of_type_Float;
      f();
      if (126 != paramMessageForPoke.interactType) {
        break label1328;
      }
      localLayoutParams1.height = awmc.a(70.0F);
      localLayoutParams1.topMargin = awmc.a(10.0F);
      localLayoutParams1.bottomMargin = awmc.a(10.0F);
      ((RelativeLayout.LayoutParams)localObject2).width = awmc.a(70.0F);
      ((RelativeLayout.LayoutParams)localObject2).height = awmc.a(70.0F);
      paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setScaleType(ImageView.ScaleType.FIT_CENTER);
      paramadfq.jdField_a_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
      ((RelativeLayout.LayoutParams)localObject1).height = awmc.a(90.0F);
      localLayoutParams2.leftMargin = 0;
      localLayoutParams2.rightMargin = 0;
      localLayoutParams2.width = awmc.a(90.0F);
      localLayoutParams2.height = awmc.a(90.0F);
      if ((this.jdField_c_of_type_JavaUtilMap != null) && (!this.jdField_c_of_type_JavaUtilMap.isEmpty()) && (this.jdField_c_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramMessageForPoke.subId))))
      {
        ...
        if ((4 == i) || (5 == i))
        {
          localObject1 = bacm.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838050);
          localObject4 = bacm.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838051);
          localObject1 = bees.a(this.jdField_a_of_type_AndroidContentContext.getResources(), (Bitmap)localObject1, (Bitmap)localObject4);
          paramadfq.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject1);
        }
      }
      else
      {
        ...
        paramadfq.jdField_a_of_type_AndroidWidgetImageView.setScaleX(1.0F);
        paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setScaleX(1.0F);
        ((RelativeLayout.LayoutParams)localObject2).leftMargin = awmc.a(20.0F);
        ((RelativeLayout.LayoutParams)localObject2).rightMargin = 0;
        ((RelativeLayout.LayoutParams)localObject2).topMargin = awmc.a(10.0F);
        ((RelativeLayout.LayoutParams)localObject2).bottomMargin = 0;
        localObject2 = new File(adll.e + paramMessageForPoke.subId + "/pressed.png");
        localObject3 = URLDrawable.URLDrawableOptions.obtain();
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846301);
        ...
        localObject3 = new File(adll.e + paramMessageForPoke.subId + "/normal.png");
        ...
        ((URLDrawable)localObject1).setURLDrawableListener(new adfo(this, (StateListDrawable)localObject3));
        if ((((URLDrawable)localObject1).getStatus() == 2) || (((URLDrawable)localObject1).getStatus() == 3)) {
          ((URLDrawable)localObject1).restartDownload();
        }
        paramadfq.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject3);
        if (adll.a("bubble", paramMessageForPoke.subId)) {
          break label1098;
        }
        i = 1;
        label774:
        if (adll.a("/normal.png", paramMessageForPoke.subId)) {
          break label1103;
        }
        j = 1;
        label790:
        ...
        if (!adll.a.contains(Integer.valueOf(paramMessageForPoke.subId))) {
          break label1120;
        }
        if ((!adll.c.contains(Integer.valueOf(paramMessageForPoke.subId))) && (!adll.d.contains(Integer.valueOf(paramMessageForPoke.subId)))) {
          break label1109;
        }
        paramadfq.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      }
      break;
    }
    for (;;)
    {
      paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable((Drawable)localObject1);
      paramadfq.jdField_a_of_type_AndroidWidgetRelativeLayout.setLayoutParams(localLayoutParams2);
      paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setLayoutParams(localLayoutParams1);
      paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.removeAllAnimatorListener();
      paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.addAnimatorListener(new adfp(this, paramadfq, paramMessageForPoke));
      return;
      ...
      break;
      localObject1 = bacm.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838048);
      localObject4 = bacm.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838049);
      localObject1 = bees.a(this.jdField_a_of_type_AndroidContentContext.getResources(), (Bitmap)localObject1, (Bitmap)localObject4);
      break label415;
      label992:
      paramadfq.jdField_a_of_type_AndroidWidgetImageView.setScaleX(-1.0F);
      paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setScaleX(-1.0F);
      ((RelativeLayout.LayoutParams)localObject2).rightMargin = awmc.a(20.0F);
      ((RelativeLayout.LayoutParams)localObject2).leftMargin = 0;
      ((RelativeLayout.LayoutParams)localObject2).topMargin = awmc.a(10.0F);
      ((RelativeLayout.LayoutParams)localObject2).bottomMargin = 0;
      ((RelativeLayout.LayoutParams)localObject3).leftMargin = (((RelativeLayout.LayoutParams)localObject2).width + awmc.a(10.0F) - awmc.a(6.0F));
      ((RelativeLayout.LayoutParams)localObject3).topMargin = ((int)(awmc.a(80.0F) * paramadfq.jdField_a_of_type_Float - awmc.a(34.0F)));
      break label480;
      label1098:
      i = 0;
      break label774;
      ...
      break label790;
      label1109:
      paramadfq.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      continue;
      label1120:
      adll.a.add(Integer.valueOf(paramMessageForPoke.subId));
      adll.c.add(Integer.valueOf(paramMessageForPoke.subId));
      adll.d.add(Integer.valueOf(paramMessageForPoke.subId));
      paramadfq.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
    ...
    label1328:
    localLayoutParams1.height = awmc.a(90.0F * paramadfq.jdField_a_of_type_Float);
    localLayoutParams1.width = a(paramadfq);
    localLayoutParams1.topMargin = awmc.a(0.0F);
    localLayoutParams1.bottomMargin = awmc.a(0.0F);
    ((RelativeLayout.LayoutParams)localObject4).height = awmc.a(90.0F * paramadfq.jdField_a_of_type_Float);
    localLayoutParams2.width = awmc.a(90.0F * paramadfq.jdField_a_of_type_Float);
    localLayoutParams2.height = awmc.a(90.0F * paramadfq.jdField_a_of_type_Float);
    localLayoutParams3.width = awmc.a(90.0F * paramadfq.jdField_a_of_type_Float);
    localLayoutParams3.height = awmc.a(90.0F * paramadfq.jdField_a_of_type_Float);
    ((RelativeLayout.LayoutParams)localObject2).width = awmc.a(80.0F * paramadfq.jdField_a_of_type_Float);
    ((RelativeLayout.LayoutParams)localObject2).height = awmc.a(70.0F * paramadfq.jdField_a_of_type_Float);
    ((RelativeLayout.LayoutParams)localObject2).topMargin = awmc.a(10.0F * paramadfq.jdField_a_of_type_Float);
    ((RelativeLayout.LayoutParams)localObject2).bottomMargin = awmc.a(10.0F * paramadfq.jdField_a_of_type_Float);
    ((RelativeLayout.LayoutParams)localObject1).height = awmc.a(90.0F * paramadfq.jdField_a_of_type_Float);
    ((RelativeLayout.LayoutParams)localObject2).leftMargin = 0;
    ((RelativeLayout.LayoutParams)localObject2).rightMargin = 0;
    paramadfq.jdField_a_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
    paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setScaleType(ImageView.ScaleType.CENTER_CROP);
    paramadfq.jdField_a_of_type_AndroidWidgetImageView.setScaleX(1.0F);
    paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setScaleX(1.0F);
    localObject1 = bacm.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838048);
    localObject4 = bacm.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838049);
    ...
    {
      localLayoutParams2.rightMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131165217);
      localLayoutParams2.leftMargin = 0;
    }
    for (;;)
    {
      localObject1 = adll.a(paramMessageForPoke.interactType, paramMessageForPoke.isSend(), this.jdField_a_of_type_AndroidContentContext.getResources());
      paramadfq.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject1);
      paramadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a(paramMessageForPoke, paramadfq.jdField_a_of_type_Float);
      break;
      if ((paramadfq.jdField_b_of_type_Int == f) && (!paramMessageForPoke.isSend()) && (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) && (!b(paramMessageForPoke)))
      {
        paramadfq.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
        if (!paramMessageForPoke.hasQuickBackShowed)
        {
          paramMessageForPoke.hasQuickBackShowed = true;
          awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X8008912", "0X8008912", 0, 0, "", "", "", "");
        }
      }
      for (;;)
      {
        localLayoutParams2.leftMargin = awmc.a(10.0F * paramadfq.jdField_a_of_type_Float);
        localLayoutParams2.rightMargin = 0;
        ...
        default: 
          break;
        case 0: 
          ((RelativeLayout.LayoutParams)localObject3).leftMargin = (((RelativeLayout.LayoutParams)localObject2).width + localLayoutParams2.leftMargin - awmc.a(6.0F));
          ((RelativeLayout.LayoutParams)localObject3).topMargin = ((int)(awmc.a(80.0F) * paramadfq.jdField_a_of_type_Float - awmc.a(34.0F)));
          break;
          paramadfq.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
        }
      }
      ((RelativeLayout.LayoutParams)localObject3).leftMargin = (((RelativeLayout.LayoutParams)localObject2).width + localLayoutParams2.leftMargin - awmc.a(6.0F) - awmc.a(10.0F));
      ((RelativeLayout.LayoutParams)localObject3).topMargin = ((int)(awmc.a(80.0F) * paramadfq.jdField_a_of_type_Float - awmc.a(35.0F)));
      continue;
      ((RelativeLayout.LayoutParams)localObject3).leftMargin = (((RelativeLayout.LayoutParams)localObject2).width + localLayoutParams2.leftMargin - awmc.a(6.0F) - awmc.a(20.0F));
      ((RelativeLayout.LayoutParams)localObject3).topMargin = ((int)(awmc.a(80.0F) * paramadfq.jdField_a_of_type_Float - awmc.a(36.0F)));
      continue;
      ((RelativeLayout.LayoutParams)localObject3).leftMargin = (((RelativeLayout.LayoutParams)localObject2).width + localLayoutParams2.leftMargin - awmc.a(6.0F) - awmc.a(40.0F));
      ((RelativeLayout.LayoutParams)localObject3).topMargin = ((int)(awmc.a(80.0F) * paramadfq.jdField_a_of_type_Float - awmc.a(38.0F)));
    }
  }
  ...
  private void a(Context paramContext)
  {
    if (jdField_e_of_type_Int == 0) {
      jdField_e_of_type_Int = (paramContext.getResources().getDisplayMetrics().heightPixels - awmc.a(50.0F) * 2) / awmc.a(90.0F);
    }
    if (jdField_e_of_type_Int <= 0) {
  ...
  private String b(ChatMessage paramChatMessage)
  {
    ...
    for (paramChatMessage = ajjy.a(2131639490);; paramChatMessage = paramChatMessage.msg.substring(1, paramChatMessage.msg.length() - 1)) {
      try
      {
  ...
  private void b(adfq paramadfq, MessageForPoke paramMessageForPoke)
  {
    boolean bool2 = true;
    boolean bool1 = true;
    ...
    {
      paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.clearAnimation();
      paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setVisibility(8);
      paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(null);
      paramadfq.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      if ((paramadfq.jdField_b_of_type_Int == f) && (!paramMessageForPoke.isSend()) && (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) && (!b(paramMessageForPoke)))
      {
        paramadfq.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
        paramadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.clearAnimation();
        if (paramadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a())
        {
          localUnlimitedBladeWorks = paramadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks;
          if (paramMessageForPoke.isSend()) {
            break label193;
          }
          label149:
        ...
        paramadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
        if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if (PokeBigResHandler.jdField_a_of_type_Boolean)
      {
        ...
        {
          bool1 = true;
          localUnlimitedBladeWorks.a(localContext, bool1, adll.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface), paramadfq.jdField_a_of_type_Float);
        }
      }
      else
      {
        ...
        paramadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(0);
        paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.clearAnimation();
        paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setVisibility(8);
        paramadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(null);
        paramadfq.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
        paramadfq.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
        paramadfq.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
        localUnlimitedBladeWorks = paramadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks;
        if (paramMessageForPoke.isSend()) {
          break label398;
        }
        ...
        paramadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setEndListener(new adfh(this, paramadfq, paramMessageForPoke));
        localUnlimitedBladeWorks = paramadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks;
        if (paramMessageForPoke.isSend()) {
          break label403;
        }
      ...
      {
        localUnlimitedBladeWorks.a(paramMessageForPoke, bool1, paramadfq.jdField_a_of_type_Float);
        if (!QLog.isColorLevel()) {
          break;
        }
    ...
    paramadfq.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
    paramadfq.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
    paramadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setEndListener(new adfi(this, paramadfq, paramMessageForPoke));
    if (QLog.isColorLevel()) {
      QLog.i("fangdazhao", 2, "[start]");
    }
    paramadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.c();
  ...
  private void b(Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.addAnimatorListener(new adfk(this));
    paramContext = new RelativeLayout.LayoutParams(1, 1);
    ViewGroup localViewGroup = (ViewGroup)((ViewGroup)((Activity)this.jdField_a_of_type_AndroidContentContext).getWindow().getDecorView()).getChildAt(0).findViewById(2131296648);
    ...
    this.jdField_b_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new adfl(this);
    e();
    if (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) {
      this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Baox);
    }
  }
  ...
  private String c(ChatMessage paramChatMessage)
  {
    ...
    if (TextUtils.isEmpty(paramChatMessage.msg)) {}
    for (paramChatMessage = ajjy.a(2131639489);; paramChatMessage = paramChatMessage.msg.substring(1, paramChatMessage.msg.length() - 1)) {
      try
      {
        Integer.parseInt(paramChatMessage);
  ...
  private void f()
  {
    List localList;
    int i;
    if ((this.jdField_a_of_type_AndroidWidgetBaseAdapter != null) && ((this.jdField_a_of_type_AndroidWidgetBaseAdapter instanceof acka)))
    {
      localList = ((acka)this.jdField_a_of_type_AndroidWidgetBaseAdapter).a();
      if (localList != null) {
        i = localList.size() - 1;
      }
    }
  ...
  public View a(ChatMessage paramChatMessage, acju paramacju, View paramView, BaseChatItemLayout paramBaseChatItemLayout, acmv paramacmv)
  {
    ...
    if (paramView == null)
    {
      ...
      paramacju.setId(2131309736);
      paramView = new RelativeLayout((Context)localObject1);
      Object localObject4 = new DiniFlyAnimationView((Context)localObject1);
      localadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView = ((DiniFlyAnimationView)localObject4);
      ...
      ((ImageView)localObject3).setId(2131307774);
      paramView = bacm.a(((Context)localObject1).getResources(), 2130838048);
      Object localObject2 = bacm.a(((Context)localObject1).getResources(), 2130838049);
      ((ImageView)localObject3).setImageDrawable(bees.a(((Context)localObject1).getResources(), paramView, (Bitmap)localObject2));
      localadfq.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)localObject3);
      paramacju.addView((View)localObject3);
      UnlimitedBladeWorks localUnlimitedBladeWorks = new UnlimitedBladeWorks((Context)localObject1);
      localadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks = localUnlimitedBladeWorks;
      paramacju.addView(localUnlimitedBladeWorks);
      RelativeLayout localRelativeLayout = new RelativeLayout((Context)localObject1);
      localRelativeLayout.setId(2131306139);
      ImageView localImageView = new ImageView((Context)localObject1);
      localadfq.jdField_a_of_type_AndroidWidgetImageView = localImageView;
      ...
      ((ProgressBar)localObject2).setIndeterminateDrawable(((Context)localObject1).getResources().getDrawable(2130839117));
      localadfq.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)localObject2);
      localRelativeLayout.addView((View)localObject2);
      paramView = new ImageView((Context)localObject1);
      paramView.setId(2131311040);
      paramView.setImageResource(2130846302);
      localadfq.jdField_b_of_type_AndroidWidgetImageView = paramView;
      localRelativeLayout.addView(paramView);
      localadfq.jdField_a_of_type_AndroidWidgetRelativeLayout = localRelativeLayout;
      paramacju.addView(localRelativeLayout);
      View localView = new View((Context)localObject1);
      paramacju.addView(localView);
      localadfq.jdField_c_of_type_AndroidViewView = localView;
      localObject4 = (RelativeLayout.LayoutParams)((DiniFlyAnimationView)localObject4).getLayoutParams();
      ((RelativeLayout.LayoutParams)localObject4).height = awmc.a(90.0F);
      ...
      ((RelativeLayout.LayoutParams)localObject4).height = awmc.a(40.0F);
      ((RelativeLayout.LayoutParams)localObject4).width = awmc.a(40.0F);
      ((ImageView)localObject3).setPadding(awmc.a(6.0F), awmc.a(6.0F), awmc.a(6.0F), awmc.a(6.0F));
      ...
      ((RelativeLayout.LayoutParams)localObject3).height = awmc.a(90.0F);
      ...
      ((RelativeLayout.LayoutParams)localObject3).width = awmc.a(90.0F);
      ((RelativeLayout.LayoutParams)localObject3).height = awmc.a(90.0F);
      ((RelativeLayout.LayoutParams)localObject3).addRule(12, -1);
      localObject3 = (RelativeLayout.LayoutParams)localImageView.getLayoutParams();
      ((RelativeLayout.LayoutParams)localObject3).topMargin = ((Context)localObject1).getResources().getDimensionPixelSize(2131165217);
      ((RelativeLayout.LayoutParams)localObject3).bottomMargin = ((Context)localObject1).getResources().getDimensionPixelSize(2131165217);
      ((RelativeLayout.LayoutParams)localObject3).height = awmc.a(70.0F);
      ((RelativeLayout.LayoutParams)localObject3).width = awmc.a(80.0F);
      ...
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = awmc.a(10.0F);
      ...
      paramView.bottomMargin = awmc.a(10.0F);
    }
    if (QLog.isColorLevel()) {
      QLog.d("GivingHeart", 2, "[getBubbleView]set Holder's contentView");
    }
    paramacju.setTag(localadfq);
    a(localadfq, paramBaseChatItemLayout);
    localadfq.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(this.jdField_b_of_type_AndroidViewView$OnClickListener);
    ...
    localadfq.jdField_c_of_type_AndroidWidgetImageView.setContentDescription(c(paramChatMessage));
    if (jdField_e_of_type_Boolean)
    {
      if ((localadfq.jdField_b_of_type_JavaLangStringBuilder != null) && (localadfq.jdField_b_of_type_JavaLangStringBuilder.length() > 0)) {
        localadfq.jdField_b_of_type_JavaLangStringBuilder.setLength(0);
      }
      paramacju.setContentDescription(b(paramChatMessage));
    }
    return paramacju;
  }
  ...
  public void a()
  {
    ...
    if (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) {
      this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Baox);
    }
    aciy.jdField_a_of_type_Int = 0;
  }
  ...
  public void a(adfq paramadfq)
  {
    if (paramadfq != null)
    {
      paramadfq.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      paramadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
      if ((paramadfq.jdField_b_of_type_Int != f) || (paramadfq.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend()) || ((this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) || (b(paramadfq.jdField_a_of_type_ComTencentMobileqqDataChatMessage))) {
        break label106;
      }
      paramadfq.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
    }
    ...
    {
      paramadfq.jdField_c_of_type_AndroidViewView.setVisibility(8);
      if (!((MessageForPoke)paramadfq.jdField_a_of_type_ComTencentMobileqqDataChatMessage).isPlayed) {
        ((MessageForPoke)paramadfq.jdField_a_of_type_ComTencentMobileqqDataChatMessage).setPlayed(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      return;
      label106:
      paramadfq.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
  ...
  public void a(ChatMessage paramChatMessage, Context paramContext, BaseChatItemLayout paramBaseChatItemLayout, acju paramacju, int paramInt1, int paramInt2)
  {
    ...
    if (aciy.jdField_b_of_type_Int > 0)
    {
      localMessageForPoke.setPlayed(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      localMessageForPoke.mFrameState.c = true;
    ...
    if (126 == localMessageForPoke.interactType)
    {
      ...
      if ((!localMessageForPoke.isSend()) && (localadfq.jdField_b_of_type_Int == f) && (localMessageForPoke.isPlayed) && (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) && (!b(localMessageForPoke))) {
        localadfq.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      if ((!localMessageForPoke.isPlayed) && (!localadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.isAnimating()))
      {
        if (aisl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).d != 1) {
          break label345;
        }
        paramInt1 = 0;
        if (paramInt1 != 0)
        {
          aisc.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "vas_poke", true);
          if (QLog.isColorLevel()) {
            QLog.i("GivingHeart.sprite", 2, "hide sprite (normal) in play.");
          }
        }
        adll.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramContext, localadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView, localadfq, localMessageForPoke.subId, "bubble");
      }
    }
    label345:
    label378:
    ...
    do
    {
      ...
      do
      {
        ...
        if (localMessageForPoke.isSend())
        {
          ...
          localObject = (RelativeLayout.LayoutParams)paramacju.a.getLayoutParams();
        ...
        for (;;)
        {
          paramacju.a.setLayoutParams((ViewGroup.LayoutParams)localObject);
        ...
        if (QLog.isColorLevel()) {
          QLog.d("PokeMsg", 2, "Strength holder = " + localadfq.jdField_a_of_type_Float);
        }
        ...
        paramChatMessage = ((FitSystemWindowsRelativeLayout)((ViewGroup)((Activity)this.jdField_a_of_type_AndroidContentContext).getWindow().getDecorView()).getChildAt(0).findViewById(2131296648)).a();
      ...
      aciy.jdField_a_of_type_Int += 1;
      paramChatMessage.a(localadfq, adll.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      return;
      paramChatMessage = paramChatMessage.a();
      if (localadfq.jdField_a_of_type_ComTencentMobileqqDataChatMessage == paramChatMessage)
      {
      ...
      if (SixCombolEffectView.jdField_a_of_type_Int > 0)
      {
        paramChatMessage = ((FitSystemWindowsRelativeLayout)((ViewGroup)((Activity)this.jdField_a_of_type_AndroidContentContext).getWindow().getDecorView()).getChildAt(0).findViewById(2131296648)).a().a();
        if ((paramChatMessage != null) && (localadfq.jdField_a_of_type_ComTencentMobileqqDataChatMessage == paramChatMessage))
        {
          switch (SixCombolEffectView.jdField_a_of_type_Int)
          {
          default: 
      ...
      if (localMessageForPoke.interactType == 6)
      {
        b(localadfq, localMessageForPoke);
        return;
      }
      localadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
      if ((localMessageForPoke.isPlayed) && (!localMessageForPoke.mFrameState.jdField_a_of_type_Boolean) && (!this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a().a.containsKey(Long.valueOf(localMessageForPoke.uniseq))))
      {
        ...
        localadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(null);
        localadfq.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
        if ((localadfq.jdField_b_of_type_Int == f) && (!localMessageForPoke.isSend()) && (localMessageForPoke.interactType != 126) && (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) && (!b(localMessageForPoke))) {
          localadfq.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        for (;;)
        {
      ...
      paramInt1 = 0;
      paramacju = a(localMessageForPoke.interactType);
      switch (localMessageForPoke.interactType)
      {
      default: 
        paramContext = adlh.jdField_a_of_type_JavaLangString + "/chuo_icon/chuo_icon_";
      ...
      for (;;)
      {
        try
        {
          paramContext = bacm.a(PokeBigResHandler.b + "/chuo_caidan/chuo_caidan_" + "01.png", paramContext);
          paramContext = new CustomFrameAnimationDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramContext, adlh.a().a(), localMessageForPoke.mFrameState, paramacju, adll.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface));
          a(paramContext);
          paramContext.a(1);
          if (!paramChatMessage.isSend())
          {
          ...
          localadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.clearAnimation();
          localadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
          localadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(paramContext);
          paramContext.a(new adfm(this, localadfq, localMessageForPoke));
          paramContext.d();
          if (!QLog.isColorLevel()) {
            break;
          }
          ...
          continue;
          paramContext = adlh.jdField_a_of_type_JavaLangString + "/dazhao_icon/dazhao_icon_";
        }
        ...
        paramContext = bacm.a(this.jdField_a_of_type_AndroidContentContext.getResources(), 2130838528);
        paramContext = new CustomFrameAnimationDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramContext, adlh.a().a(), localMessageForPoke.mFrameState, paramacju, adll.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface));
        b(paramContext);
        continue;
        ...
        try
        {
          paramBaseChatItemLayout = bacm.a(paramContext + "01.png", (BitmapFactory.Options)localObject);
          paramBaseChatItemLayout = new CustomFrameAnimationDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), paramBaseChatItemLayout, adlh.a().a(), localMessageForPoke.mFrameState, paramacju, adll.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface));
        ...
        if (localMessageForPoke.mFrameState.jdField_a_of_type_Boolean)
        {
          try
          {
            paramContext = bacm.a(paramBaseChatItemLayout.a(localMessageForPoke.mFrameState.jdField_a_of_type_Int).jdField_a_of_type_JavaLangString, (BitmapFactory.Options)localObject);
      ...
      if (localMessageForPoke.mFrameState.c)
      {
        ...
        localadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(null);
        localadfq.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
        if ((localadfq.jdField_b_of_type_Int == f) && (!localMessageForPoke.isSend()) && (!(this.jdField_a_of_type_AndroidContentContext instanceof ChatHistoryActivity)) && (!b(localMessageForPoke))) {
          localadfq.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        for (;;)
        {
    ...
    localadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.clearAnimation();
    localadfq.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setVisibility(8);
    paramContext.a(new adfn(this, localadfq, localMessageForPoke));
    localadfq.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageDrawable(paramContext);
    paramContext.c();
