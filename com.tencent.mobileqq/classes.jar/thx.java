...
{
  public thx(KdLottieView paramKdLottieView, String paramString, VLottie.IVLottieLoadListener paramIVLottieLoadListener) {}
  ...
  public void onHttpFinish(HttpResponse paramHttpResponse)
  {
    ...
    try
    {
      if (paramHttpResponse.originalData != null)
      {
        ...
        bool1 = true;
        LottieComposition.Factory.fromJson(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaLottieKdLottieView.getContext().getResources(), paramHttpResponse, new thy(this));
      }
