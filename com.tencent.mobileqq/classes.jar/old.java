...
public class old
{
  ...
  public static int a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      paramInt2 = i;
    } while (!onh.a(paramInt1));
    return 3;
  }
  
  public static String a()
  {
    return (int)Math.ceil(Float.valueOf((float)bbdh.d()).floatValue() / 1024.0F / 1024.0F / 1024.0F) + "";
  }
  
  public static String a(Context paramContext)
  {
    paramContext = bbdh.a(paramContext).a;
  ...
  public static String a(Context paramContext, long paramLong1, int paramInt1, long paramLong2, long paramLong3, int paramInt2, String paramString1, String paramString2, int paramInt3, int paramInt4, String paramString3)
  {
    ...
    try
    {
      ...
      localJSONObject.put("version", npu.a);
  ...
  public static JSONObject a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, ArticleInfo paramArticleInfo)
  {
    ...
    try
    {
      ...
      localJSONObject.put("rowkey", shu.a(paramArticleInfo));
  ...
  public static void a(int paramInt1, long paramLong, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, String paramString1, String paramString2)
  {
    ...
    localGallerySocialReported.client_ver.set(ByteStringMicro.copyFromUtf8("8.3.0"));
  ...
  public static void a(int paramInt1, long paramLong1, int paramInt2, int paramInt3, long paramLong2, int paramInt4, String paramString1, String paramString2)
  {
    ...
    if (!TextUtils.isEmpty("8.3.0")) {
      localGalleryExpReported.client_ver.set(ByteStringMicro.copyFromUtf8("8.3.0"));
    }
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, String paramString, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramContext = a(paramContext, onh.a() + "", i, paramArticleInfo.mArticleID, 0, paramArticleInfo.innerUniqueID, paramArticleInfo.galleryReprotExdData, a(onh.a(paramArticleInfo)), 0, (int)paramArticleInfo.mChannelID, paramJSONObject);
        nol.a(null, "" + paramArticleInfo.publishUin, paramString, paramString, 0, 0, "", paramArticleInfo.mArticleID + "", paramArticleInfo.mAlgorithmID + "", paramContext, false);
        return;
      }
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, ram paramram)
  {
    if ((onh.d(paramArticleInfo)) || (onh.d(paramArticleInfo)) || (onh.b(paramArticleInfo)))
    {
      paramContext = a(paramContext, onh.a() + "", ComponentContentGalleryBiu.a(paramArticleInfo, paramram), paramArticleInfo.mArticleID, paramram.a().indexOf(paramArticleInfo), paramArticleInfo.innerUniqueID, paramArticleInfo.galleryReprotExdData, a(onh.a(paramArticleInfo)), 0, (int)paramArticleInfo.mChannelID, null);
      nol.a(null, "" + paramArticleInfo.publishUin, "0X8008E2F", "0X8008E2F", 0, 0, "", paramArticleInfo.mArticleID + "", paramArticleInfo.mAlgorithmID + "", paramContext, false);
    }
  }
  ...
  public static void a(Context paramContext, String paramString, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      nol.a(null, "", paramString, paramString, 0, 0, "", "", "", localJSONObject.toString(), false);
      return;
    }
    catch (JSONException paramContext)
    {
  ...
  public static void a(olf paramolf)
  {
    nol.a(null, paramolf.a, paramolf.b, paramolf.c, 0, 0, "", paramolf.e, paramolf.f, paramolf.g, false);
  }
  ...
  public static String b()
  {
    ...
    if (!a)
    {
      ...
      a = true;
      SosoInterface.a(new ole(3, true, true, 300000L, false, false, "GalleryReportedUtils"));
    }
    return "";
  }
}
