...
public class rzi
  extends Handler
{
  private rzi(ViolaVideoView paramViolaVideoView) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  ViolaVideoView.a(this.a).setBackgroundDrawable(ViolaVideoView.a(this.a, 2130842637));
        ...
        ViolaVideoView.b(this.a).setVisibility(8);
        ViolaVideoView.b(this.a).setText("");
      } while ((ViolaVideoView.c(this.a).getVisibility() != 0) || (!bbev.b(this.a.getContext())));
      ViolaVideoView.a(this.a).setVisibility(0);
      ViolaVideoView.c(this.a).setVisibility(8);
      return;
    } while (ViolaVideoView.a(this.a).a() == null);
    ViolaVideoView.a(this.a).clearAnimation();
    ViolaVideoView.a(this.a).setBackgroundDrawable(ViolaVideoView.a(this.a, 2130847677));
    ViolaVideoView.b(this.a).setVisibility(0);
    ViolaVideoView.b(this.a).setVisibility(0);
