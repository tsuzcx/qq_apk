...
public class xrg
{
  ...
  public static long a(String paramString)
  {
    ...
    {
      wxe.c("Q.qqstory:Utils", paramString, "", new Object[0]);
    }
    return -1L;
  }
  ...
  public static void a(Context paramContext, File paramFile)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        wxe.b("Q.qqstory:Utils", "exception", localException);
      }
    }
  }
  ...
  {
    wxe.d("Q.qqstory:Utils", "delete " + paramFile);
    if (paramFile.isFile()) {
      paramFile.delete();
    }
  ...
  public static void a(String paramString)
  {
    ...
    {
      a(paramString);
      wxe.d("Q.qqstory:Utils", "make flag file %b", new Object[] { Boolean.valueOf(bdhb.a(str, String.valueOf(System.currentTimeMillis()))) });
      return;
    }
    wxe.d("Q.qqstory:Utils", "flag file exist");
  }
  
  public static void a(String paramString, boolean paramBoolean)
  {
    wxe.d("Q.qqstory:Utils", "delete %s", new Object[] { paramString });
    bdhb.a(paramString, paramBoolean);
  }
  
  public static boolean a()
  {
    long l = a();
    wxe.b("Q.qqstory:Utils", "free spac:" + l / 1024L / 1024L + "MB--" + l);
    return l < 52428800L;
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    wxe.d("Q.qqstory:Utils", "low capacity!");
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    wxe.c("Q.qqstory:Utils", "saveVideoToAlbum: " + bool);
  ...
  public static boolean a(String paramString)
  {
    ...
    {
      wxe.d("Q.qqstory:Utils", "mkdirs failed, path:%s", new Object[] { paramString });
      return false;
    }
    return true;
  }
  ...
  {
    return bdhb.c(paramString1, paramString2);
  }
  ...
  {
    paramString = bdhb.a(paramString + "/" + "dont_delete.txt");
    if (paramString == null) {
      return 0L;
    }
    try
    ...
    {
      wxe.b("Q.qqstory:Utils", "exception", paramString);
    }
    return 0L;
  }
  ...
  {
    return bdhb.d(paramString1, paramString2);
  }
  
  public static boolean d(String paramString)
  {
    bdhb.a(paramString);
    wxe.d("Q.qqstory:Utils", "removeAllFiles " + paramString);
    return true;
  }
  ...
  public static boolean f(String paramString)
  {
    ...
    {
      wxe.d("Q.qqstory:Utils", "save from: delete path null");
      return false;
    }
    bdhb.d(paramString);
    wxe.d("Q.qqstory:Utils", "deleteFile %s", new Object[] { paramString });
    return true;
  }
  ...
  public static boolean g(String paramString)
  {
    ...
    bdhb.d(paramString);
    wxe.d("Q.qqstory:Utils", "tryDeleteFile %s", new Object[] { paramString });
    return true;
  }
}
