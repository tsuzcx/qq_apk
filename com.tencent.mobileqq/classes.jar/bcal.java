  ...
  implements bcba
{
  ...
  {
    Object localObject2 = paramQQAppInterface.a().b(anhk.ad, 0);
        ...
        for (;;)
        {
          ...
          if (paramArrayOfByte.hasNext())
          {
            ...
            if ((localObject2 instanceof MessageForActivateFriends))
            {
              ...
              paramQQAppInterface.a().b(anhk.ad, 0, ((MessageForActivateFriends)localObject2).uniseq);
              continue;
              return false;
            }
          }
    ...
    do
    {
      ...
      ((MessageForActivateFriends)localObject2).msg = anyr.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
      ...
      break label851;
      bcst.b(paramQQAppInterface, "CliOper", "", "", (String)localObject1, (String)localObject2, localanyr.a, 0, "", "", "", "");
    ...
    if (QLog.isColorLevel())
    {
      ...
      if (j == 2)
      {
        ...
        if (((List)localObject2).size() > 0)
        {
          ...
          localMessageForActivateFriends.msg = anyr.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
          label620:
      ...
      else
      {
        ...
        if (((List)localObject2).size() > 0)
        {
          ...
          localMessageForActivateFriends.msgData = ((SubMsgType0x76.MsgBody)localObject1).toByteArray();
          localMessageForActivateFriends.msg = anyr.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
          bcst.b(paramQQAppInterface, "dc00898", "", "", "0X8007AD4", "0X8007AD4", (int)((SubMsgType0x76.OneMemorialDayInfo)localObject2).uint32_type.get(), 0, "", "", "", "");
        }
        else
        {
          if (!QLog.isColorLevel()) {
  ...
  public void a(msg_comm.MsgType0x210 paramMsgType0x210, msg_comm.Msg paramMsg, List<MessageRecord> paramList, bbyn parambbyn, MessageHandler paramMessageHandler)
  {
    ...
    bbzf.a(paramMessageHandler, l2, i, l3, j);
  }
}
