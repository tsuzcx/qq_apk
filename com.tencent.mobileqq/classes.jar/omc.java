...
public class omc
  ...
  implements oma
{
  private static omc jdField_a_of_type_Omc = new omc();
  ...
  public omc()
  {
    super(null, null, null, pdc.a(), null);
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      QLog.d("gifvideo.KandianShortContentGifStrategy", 1, new Object[] { "convertVidToUrl resp result code ", Integer.valueOf(obr.a(paramToServiceMsg, paramFromServiceMsg, paramObject, (MessageMicro)localObject1, bool)) });
      ...
      for (paramFromServiceMsg = paramObject.toString();; paramFromServiceMsg = "null")
      {
        ...
        while (paramObject.hasNext())
        {
          ...
          if (localObject2 != null)
          {
            ...
            ocs localocs = new ocs();
            localocs.b = ((content_vidurl_svr.UrlInfo)localObject2).vid.get();
            localocs.jdField_a_of_type_JavaLangString = ((content_vidurl_svr.UrlInfo)localObject2).url.get();
            ocm.a(localocs);
          }
        }
      ...
      paramToServiceMsg = (omb)a(Integer.valueOf(((Integer)paramToServiceMsg.getAttribute("vidToUrlSeq")).intValue()));
  ...
  {
    a(new String[] { paramString }, paramomb);
  }
  
  public void a(String[] paramArrayOfString, omb paramomb)
  {
    if ((paramArrayOfString != null) && (paramArrayOfString.length > 0))
    {
      content_vidurl_svr.GetVid2UrlsReq localGetVid2UrlsReq = new content_vidurl_svr.GetVid2UrlsReq();
      Object localObject = babp.c();
      ...
      localObject = oly.a(BaseApplicationImpl.getContext());
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
      ...
      localObject = pde.a("OidbSvc.0xda2", 3490, 0, ((oidb_cmd0xda2.ReqBody)localObject).toByteArray());
