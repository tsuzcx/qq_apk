  ...
  extends agdk
{
  ...
  public agfg(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, int paramInt)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = getLayoutInflater().inflate(2131561471, this.jdField_a_of_type_ComTencentWidgetXListView, false);
    ...
    this.jdField_a_of_type_AndroidViewView.findViewById(2131375054).setVisibility(0);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131371996).setVisibility(8);
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370443)).setText(this.jdField_a_of_type_AndroidContentContext.getString(2131719088));
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new agfh(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new agfi(this));
  }
  
  private void f()
  {
    this.jdField_b_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131365764));
    ...
    this.jdField_b_of_type_AndroidWidgetEditText.setOnEditorActionListener(localagdl);
    this.jdField_b_of_type_AndroidWidgetEditText.setOnKeyListener(localagdl);
  ...
  private void g()
  {
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new agfk(this));
    Button localButton = (Button)findViewById(2131363480);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new agfl(this));
  }
  ...
  protected void a()
  {
    ...
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A174", "0X800A174", this.jdField_b_of_type_Int, 0, "", "", "s_qq_history_tab", "");
  }
