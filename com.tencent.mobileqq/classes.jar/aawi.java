...
import com.tencent.mobileqq.activity.Conversation.27.1;
import com.tencent.mobileqq.activity.Conversation.27.2;
import com.tencent.mobileqq.activity.Conversation.27.3;
import com.tencent.mobileqq.activity.Conversation.27.4;
import com.tencent.mobileqq.activity.Conversation.27.5;
...
public class aawi
  extends ajxl
{
  public aawi(Conversation paramConversation) {}
  ...
  protected void onCancelMayKnowRecommend(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      akac localakac = (akac)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
      ArrayList localArrayList = localakac.c();
      if (localakac.a(paramString)) {
  ...
  protected void onGetGenralSettings(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      localObject1 = null;
      asfb.a().i(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localObject1 != null) {
        break label176;
      }
    }
    for (;;)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          if (localObject1 != null) {
            ((aktg)localObject1).b(localRecentUser);
          }
          ahpf.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, 1);
    ...
    label186:
    this.a.a(9, ajsf.C, 5000);
    this.a.a(9, ajsf.aK, 5001);
    if (QLog.isColorLevel()) {
  ...
  protected void onGetMayKnowRecommend(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      if (!bool)
      {
        paramBundle = (akac)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
        if (!paramBundle.b()) {
          break label103;
        }
        paramBundle.c();
  ...
  protected void onGetStoreFace(boolean paramBoolean, HashSet<String> paramHashSet)
  {
    ...
    this.a.a(new Conversation.27.3(this, paramHashSet));
  }
  ...
  protected void onHideConversationMayKnowRecommend(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      paramObject = (akac)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
      paramObject.e();
      this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(1009);
    ...
    bcpw.a(BaseApplication.getContext(), ajyc.a(2131702591), 0).a();
    paramBoolean = ((akac)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159)).b("sp_mayknow_ml_s_a_vl");
    paramObject = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    if (paramBoolean) {}
    for (;;)
    {
  ...
  protected void onMayknowStateChanged(boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (((akac)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159)).b("sp_mayknow_ml_s_a_vl")))
    {
      this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(1009);
      this.a.jdField_a_of_type_MqqOsMqqHandler.removeCallbacks(this.a.jdField_a_of_type_JavaLangRunnable);
      this.a.jdField_a_of_type_MqqOsMqqHandler.postDelayed(this.a.jdField_a_of_type_JavaLangRunnable, 1600L);
  ...
  protected void onSetGenralSettingsTroopFilter(boolean paramBoolean, Map<String, Integer> paramMap)
  {
    ...
    if (localObject == null)
    {
      ...
      asfb.a().a(str, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    for (;;)
    {
      ...
      try
      {
        RecentUser localRecentUser = ((aktg)localObject).b(str, 1);
      ...
      break;
      label315:
      asfb.a().c(str, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    label333:
    this.a.a(9, ajsf.C, 5000);
    this.a.a(9, ajsf.aK, 5001);
  ...
  protected void onUpdateCustomHead(boolean paramBoolean, String paramString)
  {
    ...
    if (!bbbd.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
    {
      this.a.a(new Conversation.27.2(this, paramString));
      return;
    }
    this.a.jdField_a_of_type_ComTencentMobileqqAppFrameHelperActivity.a.sendEmptyMessage(3);
  }
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {}
    while (bbbd.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount())) {
      return;
    }
    this.a.a(0L);
  }
  ...
  protected void onUpdateFriendList(boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((paramBoolean1) && (paramBoolean2))
    {
      ...
      this.a.a(0L);
      this.a.a(new Conversation.27.1(this));
    }
  }
  ...
  protected void onUpdateHotFriendLevel(boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    if (paramBoolean) {
      this.a.a(new Conversation.27.5(this, paramArrayList));
    }
  }
  ...
  {
    if (paramBoolean) {
      this.a.a(new Conversation.27.4(this, paramString));
    }
  }
}
