  ...
  extends AbstractImageAdapter
{
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((paramURLDrawable.getStatus() == 1) && (AbsDownloader.hasFile(str)))
      {
        ...
        if ((paramURLDrawable != null) && (paramURLDrawable.exists())) {
          paramView.setTag(2131296389, Integer.valueOf(bheg.d(paramURLDrawable.getAbsolutePath())));
        }
      }
      return;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    aawh localaawh = (aawh)getItem(paramInt);
    if (localaawh != null)
    {
      localObject = a(localaawh.a(), paramViewGroup);
      if (localObject != null) {
        break label198;
      }
      localObject = (URLDrawable)localaawh.b();
    }
    label198:
    for (;;)
    {
      ...
      if ((localObject != null) && (((URLDrawable)localObject).getStatus() != 1) && (((URLDrawable)localObject).getStatus() != 4) && (((URLDrawable)localObject).getStatus() != 2))
      {
        ...
        paramView.setURLDrawableDownListener(new aawj(this, paramInt, paramViewGroup));
        a(paramInt, i / 100);
      }
