  ...
  public FastWebArticleInfo a(Parcel paramParcel)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      while (i < k)
      {
        ...
        localtge.jdField_a_of_type_JavaLangString = paramParcel.readString();
        localtge.jdField_a_of_type_Long = paramParcel.readLong();
        localtge.jdField_b_of_type_JavaLangString = paramParcel.readString();
        ((List)localObject).add(localtge);
        i += 1;
      }
      bool1 = false;
      break;
    ...
    for (localFastWebArticleInfo.jdField_a_of_type_JavaUtilList = ((List)localObject);; localFastWebArticleInfo.jdField_a_of_type_JavaUtilList = null)
    {
      ...
      {
        localObject = new tgj();
        ((tgj)localObject).jdField_a_of_type_JavaLangString = paramParcel.readString();
        ((tgj)localObject).jdField_b_of_type_JavaLangString = paramParcel.readString();
        ((tgj)localObject).jdField_a_of_type_Float = paramParcel.readFloat();
        ((tgj)localObject).jdField_c_of_type_JavaLangString = paramParcel.readString();
        ((tgj)localObject).jdField_a_of_type_Int = paramParcel.readInt();
        i += 1;
      }
    }
