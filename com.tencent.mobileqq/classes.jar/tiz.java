...
public class tiz
  extends tiv
{
  public tiz(ViewGroup paramViewGroup, int paramInt)
  {
  ...
  protected void a(ShareGroupItem paramShareGroupItem)
  {
    ...
    {
      str = ajya.a(2131713941);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(str);
      localObject = (uks)tcz.a(24);
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(((uks)localObject).a());
    }
    label116:
    do
    {
      ...
      break label91;
      localObject = ((uks)localObject).a(paramShareGroupItem.headerUnionIdList, str);
  ...
  public void a(tff paramtff)
  {
    ...
    ShareGroupItem localShareGroupItem = ((umv)tcz.a(7)).a(paramtff.a);
    a(localShareGroupItem);
    if (localShareGroupItem == null) {
      new tjt(paramtff.a, String.valueOf(System.currentTimeMillis())).a();
    }
    if (QLog.isColorLevel()) {
      QLog.e("zivonchen", 2, "ShareGroupViewHolder groupItem = " + localShareGroupItem + ", unionId = " + paramtff.a);
    }
  }
}
