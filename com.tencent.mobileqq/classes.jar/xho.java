...
public class xho
{
  public static SpannableStringBuilder a(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, xhq paramxhq)
  {
    if (paramCommentEntry.commentType == 1) {
      return c(paramCommentLikeFeedItem, paramCommentEntry, paramxhq);
    }
    if (paramCommentEntry.commentType == 2) {
      return d(paramCommentLikeFeedItem, paramCommentEntry, paramxhq);
    }
    if (paramCommentEntry.commentType == 5) {
      return c(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramxhq);
    }
    if (paramCommentEntry.commentType == 4) {
      return a(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramxhq, true);
    }
    return a(paramCommentLikeFeedItem, paramCommentEntry, paramxhq);
  }
  
  private static SpannableStringBuilder a(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, xhq paramxhq, boolean paramBoolean)
  {
    paramContext = ((vvj)vux.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    label125:
    label511:
    for (paramCommentLikeFeedItem = bblk.b(paramCommentEntry.content);; paramCommentLikeFeedItem = null)
    {
      String str1;
      String str2;
      if (paramBoolean)
      {
        paramContext = amtj.a(2131713329);
        if (i == 0) {
          break label403;
        }
        str1 = "V";
      ...
      for (paramCommentLikeFeedItem = new QQTextBuilder(str2 + paramContext + ": " + paramCommentLikeFeedItem, 3, 16);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + paramContext + ": " + str6))
      {
        for (;;)
        {
          ...
          if (paramBoolean)
          {
            ...
            a(paramCommentLikeFeedItem, 0, k, paramxhq, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
            j = str4.length() + k;
            i = j;
            if (k != j)
            {
          ...
          catch (Exception paramContext)
          {
            ...
            a(paramCommentLikeFeedItem, paramCommentLikeFeedItem.length() - "I".length(), paramCommentLikeFeedItem.length(), 2130846372, 15, 15, 3);
            return paramCommentLikeFeedItem;
          }
        }
        paramContext = amtj.a(2131713332);
        break label84;
        str1 = "";
        break label93;
        str2 = "";
  ...
  private static SpannableStringBuilder a(@NonNull CommentEntry paramCommentEntry)
  {
    ...
    String str1 = null;
    if (com.tencent.mobileqq.text.TextUtils.hasSysEmotion(paramCommentEntry.content)) {
      str1 = bblk.b(paramCommentEntry.content);
    }
    String str3 = amtj.a(2131713330);
    if (str1 != null) {}
  ...
  private static SpannableStringBuilder a(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, xhq paramxhq)
  {
    Object localObject1 = (vvj)vux.a(2);
    Object localObject3 = ((vvj)localObject1).c(paramCommentEntry.authorUnionId);
    ...
    {
      localObject2 = ((vvj)localObject1).c(paramCommentEntry.replierUnionId);
    ...
    for (paramCommentLikeFeedItem = (CommentLikeFeedItem)localObject2;; paramCommentLikeFeedItem = null)
    {
      ...
      if (!android.text.TextUtils.isEmpty(str4))
      {
        ...
        if (com.tencent.mobileqq.text.TextUtils.hasSysEmotion(paramCommentEntry.content)) {
          paramCommentLikeFeedItem = bblk.b(paramCommentEntry.content);
        }
        str6 = amtj.a(2131713335);
        if (i == 0) {
          break label415;
        }
        localObject2 = "V";
      ...
      for (paramCommentLikeFeedItem = new QQTextBuilder(str2 + (String)localObject2 + str3 + ": " + paramCommentLikeFeedItem, 3, 16);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + (String)localObject2 + str3 + ": " + str7))
      {
        ...
        a(paramCommentLikeFeedItem, 0, i, paramxhq, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
        j = str3.length() + i;
        paramxhq = paramCommentLikeFeedItem;
        if (i != j)
        {
          b(paramCommentLikeFeedItem, i, j, -4473925);
          paramxhq = paramCommentLikeFeedItem;
        ...
        {
          paramxhq.append(" ");
          paramCommentLikeFeedItem = amtj.a(2131713334);
          i = paramxhq.length();
          j = paramCommentLikeFeedItem.length();
          paramxhq.append(paramCommentLikeFeedItem);
          b(paramxhq, i, j + i, -48606);
          i = paramxhq.length();
          j = "[icon]  ".length();
          paramxhq.append("[icon]  ");
          a(paramxhq, i, j + i, 2130848568);
        }
        return paramxhq;
        i = 0;
        break;
      ...
      for (paramCommentLikeFeedItem = new QQTextBuilder(str2 + (String)localObject2 + str3 + str6 + str1 + (String)localObject3 + (String)localObject1 + ": " + paramCommentLikeFeedItem, 3, 14);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + (String)localObject2 + str3 + str6 + str1 + (String)localObject3 + (String)localObject1 + ": " + str7))
      {
        ...
        a(paramCommentLikeFeedItem, i - str1.length(), j, paramxhq, paramCommentEntry.replierUnionId, paramCommentEntry.replierRole);
  ...
  public static SpannableStringBuilder a(CommentLikeFeedItem paramCommentLikeFeedItem, List<LikeEntry> paramList, xhq paramxhq)
  {
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder();
    String str1 = paramCommentLikeFeedItem.feedId + "_" + paramList.hashCode();
    Object localObject = vst.a().a(str1);
    ...
    for (paramCommentLikeFeedItem = paramCommentLikeFeedItem.qq;; paramCommentLikeFeedItem = null)
    {
      ...
      for (;;)
      {
        if (j < paramList.size())
        {
          ...
          localObject = ((vvj)vux.a(2)).c(localLikeEntry.unionId);
          ...
          for (localObject = "";; localObject = ", ")
          {
            ...
            a(localSpannableStringBuilder, m, n, paramxhq, localLikeEntry.unionId);
            break;
            k = 0;
            break label220;
            localObject = "";
      ...
      if (i != 0) {
        vst.a().a(str1, localSpannableStringBuilder);
      }
  ...
  private static String a(CommentLikeFeedItem paramCommentLikeFeedItem, QQUserUIItem paramQQUserUIItem)
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        return ((vvf)vux.a(23)).a(paramQQUserUIItem, paramCommentLikeFeedItem, false, false);
        i = 0;
        break;
      }
      return wkp.a(paramQQUserUIItem);
      label93:
      paramCommentLikeFeedItem = null;
      continue;
      paramCommentLikeFeedItem = null;
  ...
  {
    paramString1 = ((vvj)vux.a(2)).c(paramString1);
    if (paramBoolean) {
      return ((vvf)vux.a(23)).a(paramString1, paramString3, false, false);
    }
    return wkp.a(paramString1);
  }
  ...
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt6 == 0) {
        ...
        localObject = new ysi((Drawable)localObject);
      } else {
        localObject = new ytn((Drawable)localObject);
      }
    }
  }
  
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, xhq paramxhq, String paramString)
  {
    a(paramSpannableStringBuilder, paramInt1, paramInt2, paramxhq, paramString, 0);
  }
  
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, xhq paramxhq, String paramString, int paramInt3)
  {
    paramSpannableStringBuilder.setSpan(new xhp(paramxhq, paramString, paramInt3), paramInt1, paramInt2, 33);
  }
  ...
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, String paramString, int paramInt1, int paramInt2)
  {
    ...
    paramSpannableStringBuilder.setSpan(new ytn(paramString), paramInt1, paramInt2, 33);
  }
  
  public static SpannableStringBuilder b(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, xhq paramxhq)
  {
    if (paramCommentEntry.commentType == 1) {
    ...
    if (paramCommentEntry.commentType == 4) {
      return a(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramxhq, false);
    }
    return b(paramCommentLikeFeedItem, paramCommentEntry, paramxhq);
  }
  
  private static SpannableStringBuilder b(@NonNull CommentEntry paramCommentEntry)
  {
    String str = amtj.a(2131713331);
    ...
    default: 
      return paramCommentEntry;
    case 1: 
      a(paramCommentEntry, j, k, 2130844479, 37, 16);
      return paramCommentEntry;
    case 2: 
      a(paramCommentEntry, j, k, 2130844481, 37, 16);
      return paramCommentEntry;
    case 3: 
      a(paramCommentEntry, j, k, 2130844480, 37, 16);
      return paramCommentEntry;
    case 4: 
      a(paramCommentEntry, j, k, 2130844478, 37, 16);
      return paramCommentEntry;
    }
    a(paramCommentEntry, j, k, 2130844477, 37, 16);
    return paramCommentEntry;
  }
  
  private static SpannableStringBuilder b(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, xhq paramxhq)
  {
    String str1 = null;
    Object localObject1 = (vvj)vux.a(2);
    Object localObject2;
    ...
    for (;;)
    {
      ...
      for (paramCommentLikeFeedItem = new QQTextBuilder(str3 + (String)localObject1 + str1 + (String)localObject2 + ": " + paramCommentLikeFeedItem, 3, 14);; paramCommentLikeFeedItem = new SpannableStringBuilder(str3 + (String)localObject1 + str1 + (String)localObject2 + ": " + str4))
      {
        ...
        a(paramCommentLikeFeedItem, i - ((String)localObject1).length(), j, paramxhq, paramCommentEntry.replierUnionId, paramCommentEntry.replierRole);
  ...
  private static SpannableStringBuilder c(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, xhq paramxhq)
  {
    paramContext = ((vvj)vux.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!android.text.TextUtils.isEmpty(str3))
    {
      ...
      paramContext = amtj.a(2131713324);
      label100:
      if (i == 0) {
        break label370;
      }
    ...
    for (paramCommentLikeFeedItem = "V";; paramCommentLikeFeedItem = "")
    {
      ...
      a(localSpannableStringBuilder, 0, i, paramxhq, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      j = i + str2.length();
      if (i != j) {
      ...
      j = "A".length() + i;
      if (i != j) {
        a(localSpannableStringBuilder, i, j, 2130846372, 15, 15, 3);
      }
      return localSpannableStringBuilder;
      i = 0;
      break;
      paramContext = " @" + paramContext + amtj.a(2131713324);
      break label100;
    }
  }
  ...
  private static SpannableStringBuilder c(@NonNull CommentEntry paramCommentEntry)
  {
    ...
    for (paramCommentEntry = amtj.a(2131713328);; paramCommentEntry = "@" + paramCommentEntry + amtj.a(2131713326))
    {
      ...
      int j = "A".length() + i;
      if (i != j) {
        a(localSpannableStringBuilder, i, j, 2130846372, 15, 15);
      }
      return localSpannableStringBuilder;
    }
  }
  
  private static SpannableStringBuilder c(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, xhq paramxhq)
  {
    Object localObject = ((vvj)vux.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!android.text.TextUtils.isEmpty(str3))
    {
      ...
      localObject = null;
      if (com.tencent.mobileqq.text.TextUtils.hasSysEmotion(paramCommentEntry.content)) {
        localObject = bblk.b(paramCommentEntry.content);
      }
      str4 = amtj.a(2131713327);
      if (i == 0) {
        break label272;
      }
    ...
    for (localObject = new QQTextBuilder(str1 + paramCommentLikeFeedItem + str2 + str4 + ": " + (String)localObject, 3, 16);; localObject = new SpannableStringBuilder(str1 + paramCommentLikeFeedItem + str2 + str4 + ": " + str5))
    {
      ...
      a((SpannableStringBuilder)localObject, 0, i, paramxhq, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      j = str2.length() + i;
      if (i != j) {
  ...
  private static SpannableStringBuilder d(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, xhq paramxhq)
  {
    Object localObject = ((vvj)vux.a(2)).c(paramCommentEntry.authorUnionId);
    String str1 = a(paramCommentLikeFeedItem, (QQUserUIItem)localObject);
    String str2 = a(paramCommentEntry.authorRole, (QQUserUIItem)localObject);
    ...
    for (paramCommentLikeFeedItem = "V";; paramCommentLikeFeedItem = "")
    {
      ...
      a(localSpannableStringBuilder, 0, j, paramxhq, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      k = str2.length() + j;
      if (j != k) {
    ...
    a(localSpannableStringBuilder, j, k, 2130844479, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130844481, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130844480, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130844478, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130844477, 37, 16, 3);
    return localSpannableStringBuilder;
  }
}
