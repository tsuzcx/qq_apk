...
public class amoo
  implements anca, SurfaceTexture.OnFrameAvailableListener, TVK_IMediaPlayer.OnCompletionListener, TVK_IMediaPlayer.OnDownloadCallbackListener, TVK_IMediaPlayer.OnErrorListener, TVK_IMediaPlayer.OnSeekCompleteListener, TVK_IMediaPlayer.OnVideoPreparedListener
{
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private amop jdField_a_of_type_Amop;
  private amrk jdField_a_of_type_Amrk = new amrk(0);
  ...
  public amoo(amop paramamop, int paramInt)
  {
  ...
  private void e()
  {
    ...
    if ((localTVK_IProxyFactory != null) && (this.jdField_a_of_type_AndroidGraphicsSurfaceTexture == null))
    {
      ...
      if (this.jdField_a_of_type_Anbz != null) {
        this.jdField_a_of_type_Anbz.a(null);
      }
      if (this.jdField_a_of_type_Anbz == null) {
      ...
      {
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer = localTVK_IProxyFactory.createMediaPlayer(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Anbz);
  ...
  public void a(String paramString, long paramLong, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    label197:
    localTVK_PlayerVideoInfo.setConfigMap("file_dir", anby.a(paramString));
    if (this.jdField_b_of_type_Boolean) {}
    for (localObject = "true";; localObject = "false")
    {
      ...
      localTVK_PlayerVideoInfo.setVid(bfhi.d(paramString));
  ...
  public void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Amop != null) {
      this.jdField_a_of_type_Amop.a(paramArrayOfByte1);
    }
  }
  ...
  public void onCompletion(TVK_IMediaPlayer paramTVK_IMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Amop != null) {
      this.jdField_a_of_type_Amop.a(paramTVK_IMediaPlayer);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Amop != null) {
      this.jdField_a_of_type_Amop.a(this.jdField_a_of_type_JavaLangRunnable);
    }
  }
