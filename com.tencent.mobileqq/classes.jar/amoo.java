  ...
  extends BusinessHandler
{
  ...
  amoo(QQAppInterface paramQQAppInterface)
  {
  ...
  private int a(int paramInt)
  {
    ...
    tmp6_5[0] = 2131695623;
    int[] tmp11_6 = tmp6_5;
    tmp11_6[1] = 2131695619;
    int[] tmp16_11 = tmp11_6;
    tmp16_11[2] = 2131695615;
    int[] tmp21_16 = tmp16_11;
    tmp21_16[3] = 2131695618;
    int[] tmp26_21 = tmp21_16;
    tmp26_21[4] = 2131695622;
    int[] tmp31_26 = tmp26_21;
    tmp31_26[5] = 2131695620;
    int[] tmp36_31 = tmp31_26;
    tmp36_31[6] = 2131695625;
    int[] tmp42_36 = tmp36_31;
    tmp42_36[7] = 2131695617;
    int[] tmp48_42 = tmp42_36;
    tmp48_42[8] = 2131695624;
    int[] tmp54_48 = tmp48_42;
    tmp54_48[9] = 2131695616;
    int[] tmp60_54 = tmp54_48;
    tmp60_54[10] = 2131695621;
    tmp60_54;
  ...
  private void a(ToServiceMsg paramToServiceMsg, String paramString1, int paramInt, boolean paramBoolean, String paramString2, Object paramObject, oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        ...
        if (i == 1224)
        {
          bfyz.j(this.app.getApplication().getApplicationContext(), this.app.getCurrentAccountUin(), paramString1);
  ...
  private void a(cmd0x874.RspBody paramRspBody)
  {
    ...
    localObject2 = (anca)this.app.getBusinessHandler(20);
    if (localObject2 != null) {
      ((anca)localObject2).j(((TroopInfo)localObject1).troopuin);
    }
    localObject2 = (bdzw)this.app.getManager(32);
    if (localObject2 != null) {
      ((bdzw)localObject2).a(this.app, ((TroopInfo)localObject1).troopuin);
    }
    ...
    ((amrb)localObject1).jdField_a_of_type_JavaUtilMap.put(str, new String[] { paramRspBody, this.app.getCurrentAccountUin() });
    ((amrb)localObject1).jdField_a_of_type_JavaUtilSet.add(paramRspBody);
    notifyUI(41, true, new Object[] { Integer.valueOf(2131695623), str, paramRspBody, Boolean.valueOf(true) });
  }
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      try
      {
        paramToServiceMsg = bezf.a(l, paramFromServiceMsg.opt_msg_record.get().toByteArray(), paramFromServiceMsg.uint32_cur_cnt.get());
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = (amzp)this.app.getManager(22);
    if (paramFromServiceMsg.getResultCode() != 1000)
    {
  ...
  private void k(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramToServiceMsg = bfdg.a(this.app, i, l1, l2, l3, paramFromServiceMsg, j, paramToServiceMsg);
      } while ((TextUtils.isEmpty(str)) || (paramToServiceMsg == null));
      short s = (short)paramToServiceMsg.length;
      if ("OidbSvc.0x852_35".equals(str))
      {
        bfdg.a(this.app, i, l1, l2, s, paramToServiceMsg, l3, paramFromServiceMsg, j);
        return;
      }
      if ("OidbSvc.0x852_48".equals(str))
      {
        bfdg.a(this.app, i, l1, l2, s, paramToServiceMsg, (short)k, bool);
        return;
      }
    } while (!"OidbSvc.0x8ca_2".equals(str));
    ((anca)this.app.getBusinessHandler(20)).a(this.app, "" + l1, paramToServiceMsg, i);
  }
  ...
  private void l(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = (byte[])paramObject;
    bfdg.a(this.app, i, l1, l2, l3, paramFromServiceMsg, j, paramToServiceMsg);
  }
  ...
  private void m(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramToServiceMsg = (byte[])paramObject;
        paramToServiceMsg = bfdg.a(this.app, l1, l2, paramToServiceMsg, j, i, bool);
  ...
  {
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null)) {
      notifyUI(41, false, new Object[] { Integer.valueOf(2131695616) });
    }
  ...
  private void p(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      if (i == 2)
      {
        ((bfbz)this.app.getManager(48)).a(paramToServiceMsg, paramFromServiceMsg, paramObject);
        return;
      }
      if (i == 3)
      {
  ...
  private void r(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (i != 0)
      {
        ...
        if (i == 1328) {
          paramToServiceMsg[2] = amtj.a(2131700303);
        }
  ...
  public void a(String paramString1, int paramInt, @Nullable String paramString2)
  {
    ...
    if (bfyz.a(this.app.getApplication(), this.app.getCurrentAccountUin()).contains(str))
    {
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    if (i == 0)
    {
      QQToast.a(BaseApplication.getContext(), 2131695597, 0).b(BaseApplication.getContext().getResources().getDimensionPixelSize(2131299076));
      return false;
    }
