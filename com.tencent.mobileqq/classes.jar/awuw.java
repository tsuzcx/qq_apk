...
public class awuw
{
  public static awwc a(awwc paramawwc)
  {
    for (paramawwc = paramawwc.a(); (paramawwc != null) && (paramawwc.jdField_a_of_type_Int != 1); paramawwc = paramawwc.a()) {}
    return paramawwc;
  }
  ...
  public static AbsStructMsg a()
  {
    ...
    localStructMsgForGeneralShare.mMsgBrief = ajjy.a(2131648806);
    ...
    awuv.a(0).a(new StructMsgItemTitle(""));
  ...
  public static AbsStructMsg a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong, byte[] paramArrayOfByte, int paramInt2)
  {
    ...
    if ((paramArrayOfByte != null) && ((paramArrayOfByte instanceof AbsShareMsg)))
    {
      ...
      if ((l1 == 23L) && ((paramInt1 == 82) || (paramInt1 == 43))) {
        awqx.b(paramQQAppInterface, "P_CliOper", "Grp_AIO", paramQQAppInterface.getCurrentAccountUin(), "AIOchat", "appear_obj", 0, 0, String.valueOf(paramLong), String.valueOf(l1), String.valueOf(l2), "");
      }
      if (l1 == 52L)
      {
        paramQQAppInterface = new StringBuilder("rec flower msg,");
        paramQQAppInterface.append(awwx.a(paramArrayOfByte));
  ...
  public static AbsStructMsg a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    //   93: astore_3
    //   94: aload_3
    //   95: invokestatic 250	awuw:a	(Ljava/lang/String;)Z
    //   98: istore_2
    //   99: aload_3
    //   100: aload_0
    //   101: iload_2
    //   102: invokestatic 255	axjs:a	(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    //   105: invokestatic 258	awuw:a	(Ljava/lang/String;)Ljava/lang/String;
    //   108: astore_3
    ...
    //   153: new 270	awwd
    //   156: dup
    //   157: invokespecial 271	awwd:<init>	()V
    //   160: astore 4
    //   162: aload 4
    //   164: aload_0
    //   165: invokevirtual 273	awwd:a	(Ljava/lang/String;)V
    //   168: aload 4
    //   170: iload_2
    //   171: invokevirtual 276	awwd:a	(Z)V
    ...
    //   192: aload 4
    //   194: invokevirtual 297	awwd:a	()Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   197: astore_3
    //   198: aload_3
    //   199: astore_0
    //   200: aload_3
  ...
  public static String a(awwc paramawwc)
  {
    if (paramawwc.jdField_a_of_type_Int == 3) {}
    Object localObject;
    for (paramawwc = paramawwc.jdField_a_of_type_JavaLangString;; paramawwc = ((StringBuilder)localObject).toString())
    {
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          if (localawwc.jdField_a_of_type_Int == 3) {
            ((StringBuilder)localObject).append(localawwc.jdField_a_of_type_JavaLangString);
          }
        }
      }
    }
  ...
  public static final String a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = aciy.a().append(paramString);
        i = 0;
        k = 0;
