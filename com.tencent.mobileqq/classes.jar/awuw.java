  ...
  extends aupb
{
  protected void a(boolean paramBoolean, long paramLong, ArrayList<Long> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      if ((paramLong == awus.a(this.a)) && (awus.d(this.a) != null)) {
        if (paramArrayList != null) {
          synchronized (awus.a(this.a))
          {
            awus.a(this.a).put(Long.valueOf(paramLong), (ArrayList)paramArrayList.clone());
          }
        }
      }
      synchronized (awus.d(this.a))
      {
        localObject2 = (WeakReference)awus.d(this.a).get(Long.valueOf(paramLong));
        if (localObject2 != null)
        {
          ??? = (awuv)((WeakReference)localObject2).get();
          if (??? != null)
          {
            if (paramBoolean) {
              break;
            }
            awus.a(this.a, paramLong, (awuv)???);
          }
        }
        return;
        label200:
    ...
    ((awuv)???).a(paramLong, paramArrayList);
  }
  ...
  protected void a(boolean paramBoolean, HashMap<Long, IntimateInfo> paramHashMap, Object arg3)
  {
    ...
    for (paramHashMap = paramHashMap.size() + paramHashMap.toString();; paramHashMap = "null")
    {
      ...
      synchronized (awus.e(this.a))
      {
        ...
        awus.e(this.a).remove(localObject2);
      }
    }
    label387:
    label393:
    ...
    {
      label297:
      if ((l2 == awus.a(this.a)) && (awus.f(this.a) != null)) {}
      synchronized (awus.f(this.a))
      {
        ??? = (WeakReference)awus.f(this.a).get(Long.valueOf(l2));
        if (??? != null)
        {
          ??? = (awut)((WeakReference)???).get();
          if (??? != null) {
            awus.a(this.a, l2, paramHashMap, ???);
          }
        }
        return;
      }
