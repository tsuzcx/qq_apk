  ...
  implements Manager
{
  ...
  public vzt(QQAppInterface paramQQAppInterface)
  {
  ...
  @NonNull
  public static vzt a(QQAppInterface paramQQAppInterface)
  {
    return (vzt)paramQQAppInterface.getManager(QQManagerFactory.QQ_STORY_FEED_MANAGER);
  }
  ...
  public void a(ConfigurationService.Config paramConfig)
  {
    ...
    int j = bhhr.aE(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    String str;
    if (i != j)
    {
    ...
    {
      return;
      bhhr.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramConfig.version.get(), str);
      try
      {
        b(str);
        return;
  ...
  public void a(@NonNull MessageForQQStoryFeed paramMessageForQQStoryFeed)
  {
    ...
    ykv.a("aio_msg", "aio_push", 0, 0, new String[] { paramMessageForQQStoryFeed.frienduin });
    ...
    Object localObject = localafqy.a(paramMessageForQQStoryFeed.frienduin, 0, 5);
    int i;
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      bhhr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), paramMessageForQQStoryFeed.frienduin, i);
      return;
