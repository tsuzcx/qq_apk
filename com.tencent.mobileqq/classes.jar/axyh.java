...
public class axyh
{
  ...
  public axyh(axuq paramaxuq, Context paramContext, int paramInt)
  {
  ...
  private TextView a(String paramString, View paramView, boolean paramBoolean)
  {
    ...
    if (paramView == null)
    {
      ...
      int i = actj.a(12.5F, localResources);
  ...
  public static boolean a(axuq paramaxuq, int paramInt)
  {
    ...
    label14:
    String str;
    if (paramaxuq.hasNext())
    {
      str = ((axup)paramaxuq.next()).a;
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localObject1 = (FrameLayout)localLinearLayout.findViewById(2131376660);
      if (localObject1 == null) {
        break label381;
      }
      localObject2 = this.jdField_a_of_type_Axuq.a.iterator();
      paramView = null;
      if (((Iterator)localObject2).hasNext())
      {
        axup localaxup = (axup)((Iterator)localObject2).next();
        String str = localaxup.a;
        if ("title".equals(str)) {
          paramView = ((StructMsgItemTitle)localaxup).b();
        }
        for (;;)
        {
          break;
          if ("picture".equals(str)) {
            this.jdField_a_of_type_AndroidViewView = a(localaxup, (View)localObject1, paramBundle);
          }
        }
      }
      ...
      paramBundle = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376673);
    ...
    for (;;)
    {
      if (localLinearLayout == null)
      {
        ...
        localLinearLayout.setId(2131376674);
      }
      for (;;)
      {
        localObject1 = this.jdField_a_of_type_Axuq.a.iterator();
        label331:
        if (((Iterator)localObject1).hasNext())
        {
          paramContext = (axup)((Iterator)localObject1).next();
        ...
        for (;;)
        {
          ...
          if ((!TextUtils.isEmpty(paramView)) && (paramView.trim().length() > 0))
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setId(2131376676);
  ...
  public View a(axup paramaxup, View paramView, Bundle paramBundle)
  {
    ...
    {
      PAImageView localPAImageView = (PAImageView)paramaxup;
      localPAImageView.setUseRadiusRound(true, localResources.getDimensionPixelSize(2131296351));
      localPAImageView.setTag(2131372109, Integer.valueOf(1));
    }
