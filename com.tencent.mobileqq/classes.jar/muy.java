...
public class muy
{
  static muy jdField_a_of_type_Muy;
  ...
  private mvc jdField_a_of_type_Mvc;
  mvg jdField_a_of_type_Mvg = null;
  boolean jdField_a_of_type_Boolean = false;
  String jdField_b_of_type_JavaLangString = null;
  public WeakReference<Button> b;
  private boolean jdField_b_of_type_Boolean;
  public WeakReference<mvh> c;
  private boolean c;
  public int d;
  private boolean d;
  ...
  public muy(Context paramContext, VideoController paramVideoController, Button paramButton)
  {
    ...
    b(paramButton);
    this.jdField_a_of_type_Mvg = new mvg(this);
    c();
  ...
  private Drawable a(Resources paramResources, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        paramResources = msf.a(paramResources, 2130842079, false);
      }
      else
      {
        paramResources = mux.a(paramResources, 2130842028, 2131165991);
        continue;
        if (paramBoolean)
        {
          paramResources = msf.a(paramResources, 2130842078, false);
        }
        else
        {
          paramResources = mux.a(paramResources, 2130842027, 2131165991);
          continue;
          if (paramBoolean)
          {
            paramResources = msf.a(paramResources, 2130842026);
          }
          else
          {
            paramResources = mux.a(paramResources, 2130842301, 2131166028);
            continue;
            if (paramBoolean)
            {
              paramResources = msf.a(paramResources, 2130842030);
            }
            else
            {
              paramResources = mux.a(paramResources, 2130842308, 2131166028);
              continue;
              if (paramBoolean)
              {
                paramResources = msf.a(paramResources, 2130842029);
              }
              else
              {
                paramResources = mux.a(paramResources, 2130842303, 2131166028);
                continue;
                if (paramBoolean) {
                  paramResources = msf.a(paramResources, 2130842078, false);
                } else {
                  paramResources = mux.a(paramResources, 2130842306, 2131166028);
                }
              }
            }
          }
  ...
  public static muy a()
  {
    try
    {
      muy localmuy = jdField_a_of_type_Muy;
      return localmuy;
    }
    finally
    {
  ...
  public static muy a(Context paramContext, VideoController paramVideoController)
  {
    if (jdField_a_of_type_Muy == null) {}
    try
    {
      if (jdField_a_of_type_Muy == null) {
        jdField_a_of_type_Muy = new muy(paramContext, paramVideoController, null);
      }
      return jdField_a_of_type_Muy;
    }
    finally {}
  }
  ...
  private void a(String[] paramArrayOfString)
  {
    ...
    for (this.jdField_e_of_type_Boolean = Arrays.asList(paramArrayOfString).contains("DEVICE_BLUETOOTHHEADSET");; this.jdField_e_of_type_Boolean = false)
    {
      if ((this.jdField_e_of_type_Boolean != bool) && (this.jdField_e_of_type_Boolean))
      {
        ...
        bdla.b(null, "CliOper", "", "", "0X8008D1D", "0X8008D1D", 0, 0, "", "", "", "");
      }
      return;
    }
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131694753), true);
          String str = paramVideoAppInterface.getCurrentAccountUin();
          if (str != null) {
            bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131694753) + str, true);
          }
          bool2 = bool1;
        } while (bhcl.a() == 0);
        bool2 = bool1;
      ...
      bool2 = bool1;
    } while (mtj.e(paramVideoAppInterface.getApp()));
    return true;
  }
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              if (paramVideoAppInterface.getCurrentAccountUin() != null)
              {
                ...
                bool1 = bool2;
                if (str != null) {
                  bool1 = localSharedPreferences.getBoolean(paramVideoAppInterface.getApp().getString(2131694752) + str, true);
                }
              }
              bool2 = bool1;
            } while (bhcl.a() == 0);
          ...
          bool2 = bool1;
        } while (mtj.b(paramVideoAppInterface.getApp()));
        bool2 = bool1;
      } while (mtj.d(paramVideoAppInterface.getApp()));
      bool2 = bool1;
    } while (mtj.e(paramVideoAppInterface.getApp()));
    return true;
  }
  ...
  public int a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentSharpJniTraeAudioSession == null) {
      this.jdField_a_of_type_ComTencentSharpJniTraeAudioSession = new TraeAudioSession((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_a_of_type_Mvg);
    }
  ...
  public void a(int paramInt)
  {
    ...
    {
      long l = AudioHelper.b();
      QLog.w("TraeSessionHelper", 1, "pressHandFreeBtn, isSpeakerOn[" + ((lfe)localObject2).P + "], seq[" + l + "]", (Throwable)localObject1);
      Object localObject3 = ((lfe)localObject2).a;
      ...
      if (localObject3 != null) {
        if ((this.jdField_e_of_type_Boolean) && (mtr.a()))
        {
          if (this.jdField_b_of_type_JavaLangRefWeakReference == null) {
            break label717;
          }
      ...
      for (;;)
      {
        ...
        localObject3 = new mve((String[])localObject3);
        if (!TextUtils.isEmpty(((lfe)localObject2).r)) {
          ((mve)localObject3).a(((lfe)localObject2).r);
        }
        localObject2 = (bkzi)bkzz.a((Context)localObject1, null);
        ((bkzi)localObject2).a(2131695363);
        ListView localListView = new ListView((Context)localObject1);
        if (this.jdField_a_of_type_Mvc == null) {
          this.jdField_a_of_type_Mvc = new mvc((Context)localObject1, (mve)localObject3);
        }
        for (;;)
        {
          localListView.setAdapter(this.jdField_a_of_type_Mvc);
          ...
          localListView.setOnItemClickListener(new muz(this, localButton, l, (bkzi)localObject2));
          ((bkzi)localObject2).a(localListView);
          ((bkzi)localObject2).c(2131690697);
          ((bkzi)localObject2).a(new mva(this));
          ((bkzi)localObject2).setOnShowListener(new mvb(this));
          ((bkzi)localObject2).show();
          return;
          this.jdField_a_of_type_Mvc.a((Context)localObject1, (mve)localObject3);
        }
        int k;
        if (((lfe)localObject2).P)
        {
          int i = 0;
          do
          {
  ...
  public void a(long paramLong, lfe paramlfe)
  {
    if (paramlfe == null) {
      if (QLog.isColorLevel()) {
    ...
    if (QLog.isColorLevel()) {
      QLog.w("TraeSessionHelper", 1, "switchButton_handFree, isSpeakerOn[" + paramlfe.P + "], seq[" + paramLong + "]");
    }
  ...
  public boolean a(long paramLong, VideoAppInterface paramVideoAppInterface, int paramInt1, int paramInt2, MediaPlayer.OnCompletionListener paramOnCompletionListener)
  {
    if ((b(paramVideoAppInterface)) && (a(paramVideoAppInterface.getApp().getApplicationContext())))
    {
      ...
      for (;;)
      {
        ...
        bhcl.a(paramInt1, paramInt2, paramOnCompletionListener);
      }
    }
    return false;
  }
