  ...
  extends WebViewPlugin
{
  ...
  private aphy jdField_a_of_type_Aphy = new zbf(this);
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    if (localaklc.a(paramString)) {
      localaklc.a(paramString, null, -1001, paramInt);
    }
  ...
  private void a(String paramString, long paramLong, int paramInt)
  {
    ...
    aklc localaklc = aklc.a();
    if (localaklc.a(paramString)) {
      localaklc.a(paramString, null, -1002, paramInt);
    }
    while (!QLog.isColorLevel()) {
      return;
    }
  ...
  private void b(String paramString, int paramInt)
  {
    ...
    aklc localaklc = aklc.a();
    if (localaklc.a(paramString)) {
      localaklc.a(paramString, null, 1000, paramInt);
    }
    while (!QLog.isColorLevel()) {
      return;
    }
      ...
      try
      {
        ...
        if (localJSONObject.has("timeout"))
        {
          ...
          if (TextUtils.isEmpty(str1))
          {
            ...
            paramString1.put("msg", alpo.a(2131714720));
          ...
          if (l2 > 0L)
          {
            ...
            if (l3 > l2)
            {
              ...
              paramString1.put("businessRet", 0);
              paramString1.put("msg", alpo.a(2131714728));
              super.callJs(paramString2, new String[] { paramString1.toString() });
              if (!QLog.isColorLevel()) {
                break;
              }
          ...
          if (this.d.containsKey(str1))
          {
            ...
            if (((Long)((Pair)localObject).first).longValue() != l2)
            {
              ...
              if ((this.mRuntime.a() == null) || (!albo.a().a(this.mRuntime.a().getUrl(), paramString1, this.mRuntime.a(), this))) {
                continue;
              }
              if (!QLog.isColorLevel()) {
                break;
            ...
            paramString1.put("businessRet", 0);
            paramString1.put("msg", alpo.a(2131714717));
            super.callJs(paramString2, new String[] { paramString1.toString() });
            if (!QLog.isColorLevel()) {
              break;
            }
          ...
          localObject = new NewIntent(this.mRuntime.a().getApplicationContext(), atfx.class);
          ...
          ((NewIntent)localObject).setObserver(new zbg(this, System.currentTimeMillis(), str1));
          if (QLog.isColorLevel()) {
  ...
  protected void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramString2.setObserver(new zbh(this, str1, str3));
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    do
    {
      ...
      atfx.jdField_a_of_type_Long = System.currentTimeMillis();
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramString1.optInt("follow") == 1)
        {
          ...
          paramJsBridgeListener = apic.a("ipc_cmd_certified_account_web_plugin_follow", null, this.jdField_a_of_type_Aphy.key, paramString2);
