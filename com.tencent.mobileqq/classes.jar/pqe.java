...
import com.tencent.biz.pubaccount.readinjoy.decoupling.uilayer.framewrok.report.RIJStatisticCollectorReport.1;
import com.tencent.biz.pubaccount.readinjoy.decoupling.uilayer.framewrok.report.RIJStatisticCollectorReport.2;
import com.tencent.biz.pubaccount.readinjoy.decoupling.uilayer.framewrok.report.RIJStatisticCollectorReport.3;
import com.tencent.biz.pubaccount.readinjoy.decoupling.uilayer.framewrok.report.RIJStatisticCollectorReport.4;
...
public class pqe
{
  public static void a(int paramInt, long paramLong, spk paramspk, BaseArticleInfo paramBaseArticleInfo, boolean paramBoolean)
  {
    suu localsuu = new suu("", "", "", "").a(paramInt).b(paramLong);
    if (paramspk != null) {
      localsuu.e(paramspk.jdField_g_of_type_Long).c(paramspk.jdField_g_of_type_Int);
    }
    if (paramBaseArticleInfo != null) {
      localsuu.h(paramBaseArticleInfo.innerUniqueID).E(pqw.a(paramBaseArticleInfo));
    }
    if (paramBoolean) {}
    for (paramspk = "1";; paramspk = "0")
    {
      olh.a(null, "", "0X8007DBB", "0X8007DBB", 0, 0, paramspk, "", "", localsuu.a().a(), false);
      return;
    }
  }
  ...
  {
    paramHashMap.put("param_networkDetail", Integer.toString(pkh.a(paramContext)));
    ThreadManager.post(new RIJStatisticCollectorReport.1(paramHashMap, paramBoolean, paramContext, paramString), 5, null, true);
  }
  
  public static void a(String paramString, rot paramrot, suu paramsuu)
  {
    ...
    {
      return;
      l = paramrot.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mArticleID;
      localObject1 = qwx.a(l);
    } while (localObject1 == null);
    paramsuu = new suu(paramsuu.a().a());
    ...
    if (((Iterator)localObject1).hasNext())
    {
      ...
      if ((localArticleInfo != null) && (localArticleInfo.mProteusTemplateBean != null))
      {
        ...
        if ((localObject2 != null) && (((Map)localObject2).entrySet() != null))
        {
          ...
          while ((localObject2 != null) && (((Iterator)localObject2).hasNext()))
          {
            ...
            paramsuu.a((String)localEntry.getKey(), localEntry.getValue().toString());
          }
        }
      ...
      for (;;)
      {
        olh.a(null, "CliOper", "", paramrot.d, paramString, paramString, 0, 0, Long.toString(paramrot.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mFeedId), Long.toString(paramrot.jdField_a_of_type_JavaLangLong.longValue()), Integer.toString(paramrot.b), paramsuu.a().a(), false);
        break;
  ...
  public static void a(AppRuntime paramAppRuntime, boolean paramBoolean, long paramLong, HashMap<String, String> paramHashMap)
  {
    ...
    StatisticCollector.getInstance(paramAppRuntime.getApplication()).collectPerformance(pkh.a(), "actKandianRefreshSuccAndCost", paramBoolean, paramLong, 0L, paramHashMap, null);
  }
