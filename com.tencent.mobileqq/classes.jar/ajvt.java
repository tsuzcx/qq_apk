  ...
  extends amgf
{
  public int a;
  public String a;
  public LinkedHashMap<String, List<ajvr>> a;
  public List<ajvr> a;
  public int[] a;
  public String[] a;
  public int b;
  ...
  public ajvt(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 1) || (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 11)) {
      paramChatHistoryTroopMemberFragment = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131691734);
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 5) {
        paramChatHistoryTroopMemberFragment = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131696041);
      } else {
        paramChatHistoryTroopMemberFragment = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719686);
      }
    }
  }
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        ((TextView)paramView).setText(this.jdField_a_of_type_ArrayOfJavaLangString[paramInt] + this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720184, new Object[] { Integer.valueOf(localList.size()) }));
  ...
  public Object[] a()
  {
    ...
    Object localObject6 = (bgls)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.TROOP_ROBOT_MANAGER);
    Object localObject9;
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)
      {
        ...
        localajvr = (ajvr)localIterator.next();
        if (((bgls)localObject6).b(localajvr.jdField_a_of_type_JavaLangString))
        {
          ...
          ((List)localObject8).add(localajvr);
        }
      }
      ...
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_n_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_n_of_type_JavaLangString.contains(localajvr.jdField_a_of_type_JavaLangString))) {
          localArrayList2.add(localajvr);
        }
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_JavaLangString.contains(localajvr.jdField_a_of_type_JavaLangString)) && (!this.jdField_a_of_type_JavaUtilList.contains(localajvr))) {
          this.jdField_a_of_type_JavaUtilList.add(localajvr);
        }
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_JavaUtilArrayList.contains(localajvr.jdField_a_of_type_JavaLangString)) && (!this.jdField_a_of_type_JavaUtilList.contains(localajvr)))
        {
          this.jdField_a_of_type_JavaUtilList.add(localajvr);
          this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_JavaUtilArrayList.remove(localajvr.jdField_a_of_type_JavaLangString);
        }
      }
      ...
      {
        if ((!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && ((localajvr.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_JavaUtilList.contains(localajvr.jdField_a_of_type_JavaLangString)))) {
          ((List)localObject9).add(localajvr);
        }
        if ((!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && (localajvr.jdField_b_of_type_Boolean)) {
          localArrayList1.add(localajvr);
        }
        if ((!localajvr.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (localajvr.jdField_d_of_type_Long == 1L)) {
          ((List)localObject10).add(localajvr);
        }
      }
      if (((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f.equals(localajvr.jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString.contains(localajvr.jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && ((localajvr.jdField_b_of_type_Int == 332) || (localajvr.jdField_b_of_type_Int == 333))))
      {
        ((List)localObject7).add(localajvr);
        if (QLog.isColorLevel()) {
          QLog.d("zivonchen", 2, "constructHashStruct uin = " + localajvr.jdField_a_of_type_JavaLangString + ", name = " + localajvr.jdField_g_of_type_JavaLangString + ", level = " + localajvr.jdField_b_of_type_Int);
        }
      }
      else if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 5) && (!TextUtils.isEmpty(localajvr.u)))
      {
        ((List)localObject7).add(localajvr);
      }
      else
      {
        if (localajvr.jdField_c_of_type_JavaLangString == null) {
          break label4292;
        }
        if (localajvr.jdField_c_of_type_JavaLangString.length() == 0) {
          break label4292;
        }
        for (;;)
        {
          ...
          ((List)localObject1.get(localObject4)).add(localajvr);
          break;
          localObject3 = localajvr.jdField_c_of_type_JavaLangString.substring(0, 1);
        }
      }
    }
    localObject6 = new ajvu(0, true);
    ...
    else
    {
      for (;;)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.h) {
          localObject1.remove(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131718955));
        }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 21)
        {
          this.jdField_a_of_type_Int = 0;
          Collections.sort((List)localObject7, (Comparator)localObject6);
          ((LinkedHashMap)localObject4).put(anvx.a(2131701091), this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList);
          break label4323;
        }
        if ((((List)localObject9).size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 12))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131718955), localObject9);
        }
        if ((localArrayList1.size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 3))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719661), localArrayList1);
        }
        if ((((List)localObject10).size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 3))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131691276), localObject10);
        }
        if (((List)localObject7).size() > 0)
        {
          Collections.sort((List)localObject7, (Comparator)localObject6);
        ...
        for (localObject3 = ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment);; localObject3 = this.jdField_a_of_type_JavaLangString)
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719688), localObject8);
          break label4330;
          if (c1 > 'Z') {
            break;
          }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 2)
        {
          ...
          {
            localObject7 = (ajvr)((Iterator)localObject6).next();
            if (TextUtils.isEmpty(((ajvr)localObject7).r)) {
              ((ajvr)localObject7).r = a((String[])localObject4, ((ajvr)localObject7).jdField_b_of_type_Long, (Calendar)localObject3);
            }
            if (localObject1.get(((ajvr)localObject7).r) == null) {
              localObject1.put(((ajvr)localObject7).r, new ArrayList());
            }
            ((List)localObject1.get(((ajvr)localObject7).r)).add(localObject7);
          }
          ...
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject1.get(localObject4[i]), new ajvu(2, false));
        ...
        else if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 6)
        {
          ...
          {
            localObject6 = (ajvr)((Iterator)localObject4).next();
            if (TextUtils.isEmpty(((ajvr)localObject6).r))
            {
              if (((ajvr)localObject6).jdField_b_of_type_Long == 0L) {
                ((ajvr)localObject6).jdField_b_of_type_Long = ((ajvr)localObject6).jdField_a_of_type_Long;
              }
              ((ajvr)localObject6).r = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.a(((ajvr)localObject6).jdField_b_of_type_Long, (Calendar)localObject3, ChatHistoryTroopMemberFragment.d(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment), ChatHistoryTroopMemberFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment));
            }
            if (localObject2.get(((ajvr)localObject6).r) == null) {
              localObject2.put(((ajvr)localObject6).r, new ArrayList());
            }
            if (!TextUtils.isEmpty(((ajvr)localObject6).r)) {
              ((List)localObject2.get(((ajvr)localObject6).r)).add(localObject6);
            }
          }
          localObject3 = new LinkedHashMap();
          ...
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject2.get(ChatHistoryTroopMemberFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment).get(i)), new ajvu(2, false));
        ...
        else
        {
          ...
          {
            localObject7 = (ajvr)((Iterator)localObject6).next();
            if (TextUtils.isEmpty(((ajvr)localObject7).q)) {
              ((ajvr)localObject7).q = b((String[])localObject4, ((ajvr)localObject7).jdField_a_of_type_Long, (Calendar)localObject3);
            }
            if (localObject2.get(((ajvr)localObject7).q) == null) {
              localObject2.put(((ajvr)localObject7).q, new ArrayList());
            }
            ((List)localObject2.get(((ajvr)localObject7).q)).add(localObject7);
          }
          localObject3 = new LinkedHashMap();
          i = localObject4.length - 1;
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject2.get(localObject4[i]), new ajvu(3, false));
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 1)
      {
        ...
        {
          localObject10 = (ajvr)((Iterator)localObject9).next();
          if (((bgls)localObject6).b(((ajvr)localObject10).jdField_a_of_type_JavaLangString))
          {
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 5) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 2) && (!ChatHistoryTroopMemberFragment.f(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment))) {
              if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.contains(((ajvr)localObject10).jdField_a_of_type_JavaLangString)))
              {
                ((List)localObject3).add(localObject10);
                ((ajvr)localObject10).jdField_d_of_type_Boolean = true;
              }
              else
              {
                ((List)localObject8).add(localObject10);
                ((ajvr)localObject10).jdField_d_of_type_Boolean = false;
              }
            }
          }
          else if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.contains(((ajvr)localObject10).jdField_a_of_type_JavaLangString)))
          {
            ((ajvr)localObject10).jdField_d_of_type_Boolean = true;
            if (((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f.equals(((ajvr)localObject10).jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString.contains(((ajvr)localObject10).jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && ((((ajvr)localObject10).jdField_b_of_type_Int == 332) || (((ajvr)localObject10).jdField_b_of_type_Int == 333)))) {
        ...
        localObject2.clear();
        Collections.sort((List)localObject3, new ajvu(1, false));
        if (((List)localObject3).size() > 0) {
          localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719688), localObject3);
        }
        if (((List)localObject4).size() > 0)
        {
          Collections.sort((List)localObject4, new ajvu(1, false));
        ...
        for (localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131694424);; localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131694423))
        {
          localObject2.put(localObject3, localObject4);
          Collections.sort((List)localObject7, new ajvu(1, false));
          if (((List)localObject7).size() > 0) {
            localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719684), localObject7);
          }
          Collections.sort((List)localObject8, new ajvu(1, false));
          if (((List)localObject8).size() <= 0) {
            break;
          }
          localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719683), localObject8);
          break;
        }
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 7)
      {
        ...
        while (i < j)
        {
          localObject9 = (ajvr)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.get(i);
          ((ajvr)localObject9).jdField_m_of_type_Int = 0;
          ((HashMap)localObject8).put(((ajvr)localObject9).jdField_a_of_type_JavaLangString, localObject9);
          i += 1;
        }
        if (ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (ajvr)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
        ...
        if (ChatHistoryTroopMemberFragment.b(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (ajvr)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.b(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
            if (localObject9 == null) {
              break label4375;
            }
        ...
        if (ChatHistoryTroopMemberFragment.c(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (ajvr)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.c(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
            if (localObject9 == null) {
              break label4382;
            }
        ...
        Collections.sort((List)localObject3, new ajvu(2, true));
        if (!((List)localObject3).isEmpty()) {
          localObject2.put(anvx.a(2131701104), localObject3);
        }
        if (!((List)localObject4).isEmpty()) {
          localObject2.put(anvx.a(2131701164), localObject4);
        }
        if (!((List)localObject6).isEmpty()) {
          localObject2.put(anvx.a(2131701130), localObject6);
        }
        Collections.sort((List)localObject7, new ajvu(2, true));
        if (((List)localObject7).isEmpty()) {
          break label4389;
        }
        localObject2.put(anvx.a(2131701089), localObject7);
        break label4389;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 8)
      {
        ...
        {
          localObject8 = (ajvr)((Iterator)localObject7).next();
          localObject9 = (oidb_0xa2a.UserInfo)((HashMap)localObject6).get(((ajvr)localObject8).jdField_a_of_type_JavaLangString);
          if (localObject9 != null)
          {
            ((List)localObject3).add(localObject8);
            ((ajvr)localObject8).n = ((oidb_0xa2a.UserInfo)localObject9).score.get();
          }
          else
          {
        ...
        if (((List)localObject3).size() > 0)
        {
          Collections.sort((List)localObject3, new ajvu(8, false));
          localObject2.put(anvx.a(2131701126), localObject3);
        }
        if (((List)localObject4).size() <= 0) {
          break label4392;
        }
        Collections.sort((List)localObject4, new ajvu(8, false));
        localObject2.put(anvx.a(2131701119), localObject4);
        break label4392;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 4)
      {
        ...
        localObject6 = anvx.a(2131701095);
        localObject7 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject7).hasNext())
        {
          localObject8 = (ajvr)((Iterator)localObject7).next();
          j = ((ajvr)localObject8).jdField_b_of_type_Int;
          i = j;
          if (j >= 10000) {
            i = ((ajvr)localObject8).jdField_b_of_type_Int - 10000;
          }
          if ((i >= 321) && (i <= 327))
          {
    ...
    for (;;)
    {
      if (i >= 0)
      {
        ...
        {
          Collections.sort((List)((LinkedHashMap)localObject3).get(localObject4[i]), new ajvu(0, false));
      ...
      else
      {
        if (((LinkedHashMap)localObject3).get(localObject6) != null)
        {
          Collections.sort((List)((LinkedHashMap)localObject3).get(localObject6), new ajvu(0, false));
  ...
  public Object getItem(int paramInt)
  {
    ...
    int i = -(i + 1) - 1;
    return (ajvr)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public int getItemViewType(int paramInt)
  {
    if (ChatHistoryTroopMemberFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment))
    {
      ...
      {
        i = -(i + 1) - 1;
        ajvr localajvr = (ajvr)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
        if ((TextUtils.isEmpty(localajvr.jdField_m_of_type_JavaLangString)) && (!TextUtils.isEmpty(localajvr.p)) && (!TextUtils.isEmpty(localajvr.jdField_g_of_type_JavaLangString)) && (!localajvr.jdField_g_of_type_JavaLangString.equals(localajvr.p))) {
          return 1;
        }
      }
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      if (i == 0)
      {
        ...
        localObject1 = localObject2;
        label83:
        ((ajvy)localObject1).jdField_a_of_type_JavaLangString = "";
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 9) {
          break label307;
        }
        localObject2 = (ajvr)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.get(paramInt);
        ((ajvy)localObject1).g.setTag(((ajvr)localObject2).jdField_a_of_type_JavaLangString);
        ((ajvy)localObject1).jdField_b_of_type_AndroidViewView.setTag(((ajvr)localObject2).jdField_a_of_type_JavaLangString);
        ((ajvy)localObject1).jdField_a_of_type_AndroidViewView.setTag(((ajvr)localObject2).jdField_a_of_type_JavaLangString);
        ((ajvy)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setTag(Integer.valueOf(paramInt));
        this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.a((ajvy)localObject1, (ajvr)localObject2, a(((ajvr)localObject2).jdField_a_of_type_JavaLangString, 2), false, false);
        label195:
        if ((((ajvy)localObject1).jdField_e_of_type_AndroidViewView != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_ComTencentMobileqqWidgetIndexView != null))
        {
          ...
          ((ajvy)localObject1).jdField_e_of_type_AndroidViewView.setVisibility(0);
        }
      }
    }
    for (;;)
    {
      ...
      {
        j = -(j + 1) - 1;
        localObject2 = (ajvr)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[j])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[j] - 1);
        ((ajvy)localObject1).g.setTag(((ajvr)localObject2).jdField_a_of_type_JavaLangString);
        ((ajvy)localObject1).jdField_b_of_type_AndroidViewView.setTag(((ajvr)localObject2).jdField_a_of_type_JavaLangString);
        ((ajvy)localObject1).jdField_a_of_type_AndroidViewView.setTag(((ajvr)localObject2).jdField_a_of_type_JavaLangString);
        ((ajvy)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setTag(Integer.valueOf(paramInt));
        Object localObject3;
        if (((ajvr)localObject2).jdField_c_of_type_Boolean)
        {
          localObject3 = new begq(((ajvr)localObject2).jdField_b_of_type_JavaLangString, 16).a();
          ((ajvy)localObject1).jdField_e_of_type_AndroidWidgetTextView.setText((CharSequence)localObject3);
          bhmb.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, ((ajvy)localObject1).jdField_e_of_type_AndroidWidgetTextView, (Spannable)localObject3);
          ((ajvy)localObject1).c.setImageResource(2130839629);
          ((ajvy)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setOnClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.c);
        ...
        for (;;)
        {
          ...
          ((ajvy)localObject1).f.setVisibility(8);
          break;
          localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment;
          Bitmap localBitmap = a(((ajvr)localObject2).jdField_a_of_type_JavaLangString, 2);
          if (i == 1) {}
          for (;;)
          {
            ((ChatHistoryTroopMemberFragment)localObject3).a((ajvy)localObject1, (ajvr)localObject2, localBitmap, false, bool);
            break;
            bool = false;
          }
          label605:
        ...
        i = VipUtils.d(2);
        ((ajvy)localObject1).jdField_e_of_type_AndroidWidgetTextView.setMaxWidth(i);
        ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, ((ajvy)localObject1).jdField_e_of_type_AndroidWidgetTextView, ((ajvy)localObject1).d, ((ajvr)localObject2).jdField_a_of_type_JavaLangString, i);
        break label195;
      }
      ((ajvy)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.b(false);
      ((ajvy)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setVisibility(8);
      ((ajvy)localObject1).jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      ((ajvy)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      ((ajvy)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setOnClickListener(null);
      ((ajvy)localObject1).g.setTag("");
      ((ajvy)localObject1).jdField_b_of_type_AndroidViewView.setTag("");
      ((ajvy)localObject1).jdField_a_of_type_AndroidViewView.setTag("");
      ((ajvy)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setTag(Integer.valueOf(-1));
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 9) || (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 19))
      {
        ((ajvy)localObject1).jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
        label826:
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 12)
        {
          ...
          {
            localObject2 = (ajvr)((List)localObject2).get(i);
            if (!this.jdField_a_of_type_JavaUtilList.contains(localObject2)) {
              break label1081;
            }
            ((ajvy)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      ...
      for (;;)
      {
        ((ajvy)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setContentDescription("");
        break;
        ((ajvy)localObject1).jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
        localObject2 = (List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[j]);
        if (localObject2 == null) {
          break label826;
        }
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719688).equals(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j])))
        {
          ((ajvy)localObject1).jdField_b_of_type_AndroidWidgetTextView.setText(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j]));
          break label826;
        }
        ((ajvy)localObject1).jdField_b_of_type_AndroidWidgetTextView.setText(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j]) + this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720184, new Object[] { Integer.valueOf(((List)localObject2).size()) }));
        break label826;
        label1081:
        ((ajvy)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      label1094:
      ((ajvy)localObject1).jdField_e_of_type_AndroidViewView.setVisibility(8);
    }
  }
