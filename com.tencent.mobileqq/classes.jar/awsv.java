  ...
  implements QLog.ILogCallback
{
  ...
  public awsv(awso paramawso, String paramString)
  {
  ...
  public void e()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaUtilMap)
      {
        ...
        awso.b(this.jdField_b_of_type_Awso, new String[] { "fg30LogCount", "|", String.valueOf(i) });
        ...
        if (localIterator1.hasNext())
        {
          ...
          awso.b(this.jdField_b_of_type_Awso, new String[] { "fg30LogAlarm", "|", str, "|", localStringBuilder.toString() });
        }
      }
  ...
  public void f()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaUtilMap)
      {
        ...
        awso.b(this.jdField_b_of_type_Awso, new String[] { "bg5LogCount", "|", String.valueOf(i) });
        ...
        if (localIterator1.hasNext())
        {
          ...
          awso.b(this.jdField_b_of_type_Awso, new String[] { "bg5LogAlarm", "|", str, "|", localStringBuilder.toString() });
        }
      }
      this.jdField_c_of_type_JavaUtilMap.clear();
      return;
  ...
  public void onWriteLog(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Awtf.a(paramString1 + "|" + paramString2);
    ...
    for (;;)
    {
      ...
      awso.a(this.jdField_b_of_type_Awso, new String[] { "log|", ((StringBuilder)localObject).toString() });
      paramString2 = this.jdField_b_of_type_Awso;
      if (i > this.jdField_c_of_type_Int) {}
      for (int j = 1;; j = 0)
      {
        awso.a(paramString2, 2, 0, j, ajjy.a(2131635286) + paramString1, "2秒钟日志打印次数：" + i);
        return;
      }
      if ((awso.a(this.jdField_b_of_type_Awso) == null) || (!QLog.isColorLevel())) {
        break;
      }
      awso.a(this.jdField_b_of_type_Awso, "No high frequnecy log in last 2seconds");
      return;
    }
  }
