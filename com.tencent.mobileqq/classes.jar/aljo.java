...
public class aljo
{
  private static final String jdField_a_of_type_JavaLangString = aljo.class.getSimpleName();
  ...
  private void b()
  {
    ...
    Collections.sort((List)localObject1, new aljp(this));
    label176:
  ...
  public int a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    catch (Throwable localThrowable)
    {
      ...
      if (((aloz)paramQQAppInterface.getManager(51)).b(paramString))
      {
        b(paramString);
        return 1;
      }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 32	aljo:jdField_a_of_type_Boolean	Z
    //   6: istore 6
    //   8: iload 6
    //   10: ifne +198 -> 208
    //   13: aload_1
    ...
    //   26: putfield 225	aljo:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    //   29: aload_0
    //   30: invokevirtual 73	aljo:a	()Landroid/content/SharedPreferences;
    //   33: astore_1
    //   34: aload_1
    //   35: ifnonnull +64 -> 99
    //   38: aconst_null
    ...
    //   177: ifle +95 -> 272
    //   180: aload_0
    //   181: getfield 43	aljo:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   184: aload 9
    //   186: lload 7
    ...
    //   203: aload_0
    //   204: iconst_1
    //   205: putfield 32	aljo:jdField_a_of_type_Boolean	Z
    //   208: aload_0
    //   209: monitorexit
    //   210: return
    //   211: astore 9
    ...
    //   230: ifeq -27 -> 203
    //   233: getstatic 24	aljo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   236: iconst_2
    //   237: ldc_w 279
    //   240: iconst_2
    ...
    //   249: iconst_1
    //   250: aload_0
    //   251: getfield 43	aljo:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
