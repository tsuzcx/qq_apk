...
public class aljo
  extends aljh
  implements aljn, asjr
{
  public static boolean d = true;
  int jdField_a_of_type_Int;
  long jdField_a_of_type_Long;
  aljj jdField_a_of_type_Aljj;
  public aljp a;
  Context jdField_a_of_type_AndroidContentContext;
  Rect jdField_a_of_type_AndroidGraphicsRect;
  Handler jdField_a_of_type_AndroidOsHandler;
  asjn jdField_a_of_type_Asjn;
  ...
  public aljo(Handler paramHandler, Context paramContext)
  {
  ...
  private boolean b(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramArrayOfByte = this.jdField_a_of_type_Aljj.a(paramArrayOfByte, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, 0);
      bool2 = aljj.a(paramArrayOfByte);
      ...
      bool1 = bool2;
    } while (this.jdField_a_of_type_Aljp == null);
    this.jdField_a_of_type_Aljp.a(bool2, paramArrayOfByte, paramBoolean);
    return bool2;
  }
  ...
  public int a()
  {
    ...
    this.jdField_a_of_type_Aljj.a(this);
    this.jdField_a_of_type_Aljj.a(this);
    this.jdField_a_of_type_Aljj.a(this.jdField_a_of_type_AndroidContentContext, hashCode(), "MiniRecog");
    this.jdField_c_of_type_Int = asjl.a();
  ...
  {
    boolean bool1 = this.jdField_a_of_type_Aljj.b();
    ...
    catch (Throwable paramArrayOfByte)
    {
      ...
      try
      {
        ...
        bool1 = bool2;
        bool2 = this.jdField_a_of_type_Aljj.a(paramRect, this.jdField_a_of_type_Long);
        bool3 = bool2;
        if (!bool2)
        {
          bool1 = bool2;
  ...
  public Bitmap a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    Object localObject1;
    if ((AppSetting.jdField_b_of_type_Boolean) && (bfni.h()))
    {
      if (this.jdField_a_of_type_Asjn == null) {
        this.jdField_a_of_type_Asjn = new asjn(BaseApplication.getContext());
      }
      localObject1 = this.jdField_a_of_type_Asjn.a(paramArrayOfByte, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
    }
    for (;;)
    {
      return localObject1;
      ...
      try
      {
        ...
        localObject1 = localObject2;
        if (aljj.a(this.jdField_a_of_type_ArrayOfInt, paramArrayOfByte, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int) != 0) {
          continue;
        }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Aljj.c(this);
      this.jdField_a_of_type_Aljj.b(this);
      this.jdField_a_of_type_Aljj.a(hashCode(), "MiniRecog");
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    aljv.d(this.jdField_c_of_type_Int, (int)l);
  }
  ...
  {
    this.jdField_a_of_type_Aljp = ((aljp)paramalji);
  }
  ...
  public void a(List<aljf> paramList, long paramLong)
  {
    ...
    {
      if ((((aljf)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect.width() > 0) && (((aljf)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect.height() > 0))
      {
        Rect localRect = new Rect(((aljf)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect);
        localRect.offset(this.jdField_a_of_type_AndroidGraphicsRect.left, this.jdField_a_of_type_AndroidGraphicsRect.top);
        aljf localaljf = new aljf();
        localaljf.jdField_a_of_type_AndroidGraphicsRect.set(localRect);
        localaljf.jdField_a_of_type_Int = ((aljf)paramList.get(i)).jdField_a_of_type_Int;
        localaljf.jdField_a_of_type_Float = ((aljf)paramList.get(i)).jdField_a_of_type_Float;
        localArrayList.add(localaljf);
      }
      i += 1;
    }
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Aljj.b()) && (this.jdField_c_of_type_Boolean) && (!this.jdField_b_of_type_Boolean);
  }
