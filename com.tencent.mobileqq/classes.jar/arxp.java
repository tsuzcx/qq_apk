...
{
  public arxp(BaseMsgBoxActivity paramBaseMsgBoxActivity) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      if ((!this.a.a()) && (this.a.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout.a() == -1) && (paramMessage.obj != null))
      {
        ...
        this.a.jdField_a_of_type_Algc.a(paramMessage);
        this.a.jdField_a_of_type_JavaUtilList.clear();
        this.a.jdField_a_of_type_JavaUtilList.addAll(paramMessage);
        this.a.b();
        int j = this.a.a(paramMessage);
        axqc.a(this.a.app.getCurrentAccountUin(), "nearby_msg_tab_last_num", Integer.valueOf(j));
        Object localObject;
