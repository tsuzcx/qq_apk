  ...
  extends bqgi
{
  ...
  public bqgy(@NonNull bqyq parambqyq)
  {
    super(parambqyq);
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)LayoutInflater.from(a()).inflate(2131562331, localRelativeLayout, false));
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, agej.a(40.0F, a()));
    LinearLayout localLinearLayout = this.jdField_a_of_type_AndroidWidgetLinearLayout;
    if (this.jdField_a_of_type_Bqyq.l)
    {
      i = 0;
    ...
    label120:
    for (int i = LiuHaiUtils.e + agej.a(40.0F, a());; i = agej.a(100.0F, a()))
    {
  ...
  private void j()
  {
    if ((this.jdField_a_of_type_Long < 0L) && (this.jdField_a_of_type_Bqyq.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer != null) && (this.jdField_a_of_type_Bqyq.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer.a() != null))
    {
      this.jdField_a_of_type_Long = this.jdField_a_of_type_Bqyq.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer.a().mDuration;
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer = this.jdField_a_of_type_Bqyq.jdField_a_of_type_DovComTencentBizQqstoryTakevideoHWEditLocalVideoPlayer;
    ...
    this.jdField_a_of_type_AndroidWidgetImageButton.setImageResource(2130847694);
  ...
  public void a()
  {
    super.a();
    d();
    this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewRotationSeekBar = ((RotationSeekBar)a(2131365799));
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)a(2131365800));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131365801));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131365798));
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new bqgz(this));
