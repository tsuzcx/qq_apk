...
{
  asfb(asey paramasey, bcqf parambcqf, WtloginHelper paramWtloginHelper, Bundle paramBundle) {}
  
  public void OnException(ErrMsg paramErrMsg, int paramInt, WUserSigInfo paramWUserSigInfo)
  {
    if (QLog.isColorLevel()) {
      QLog.d(asey.a, 2, "jumpTimLogin OnException=" + paramErrMsg + ", cmd=" + paramInt);
    }
    if ((this.jdField_a_of_type_Bcqf != null) && (this.jdField_a_of_type_Bcqf.isShowing())) {
      this.jdField_a_of_type_Bcqf.dismiss();
    }
    bcql.a(asey.a(this.jdField_a_of_type_Asey).getApp(), 1, 2131720253, 0).a();
  }
  
  public void onGetA1WithA1(String paramString, long paramLong1, int paramInt1, long paramLong2, byte[] paramArrayOfByte1, long paramLong3, long paramLong4, long paramLong5, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, WUserSigInfo paramWUserSigInfo, WFastLoginInfo paramWFastLoginInfo, int paramInt2, ErrMsg paramErrMsg)
  {
    if (QLog.isColorLevel()) {
      QLog.d(asey.a, 2, "jumpTimLogin onGetA1WithA1 ret=" + paramInt2);
    }
    if ((this.jdField_a_of_type_Bcqf != null) && (this.jdField_a_of_type_Bcqf.isShowing())) {
      this.jdField_a_of_type_Bcqf.dismiss();
    }
    ...
    if (QLog.isColorLevel()) {
      QLog.d(asey.a, 2, "jumpTimLogin call TIM JumpActivity");
    }
    ...
    asey.a(this.jdField_a_of_type_Asey).getApp().startActivity(paramArrayOfByte1);
  }
}
