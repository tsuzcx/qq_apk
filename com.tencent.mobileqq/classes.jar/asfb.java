...
public class asfb
{
  ...
  public static asfb a()
  {
    try
    {
      if (jdField_a_of_type_Asfb == null) {
        jdField_a_of_type_Asfb = new asfb();
      }
      asfb localasfb = jdField_a_of_type_Asfb;
      return localasfb;
    }
    finally {}
  }
  
  private TroopAssistantData a(aukn paramaukn, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      ...
      paramaukn = localTroopAssistantData;
  ...
  {
    jdField_a_of_type_Asfb = null;
  }
  
  /* Error */
  private void a(aukn arg1)
  {
    // Byte code:
    //   0: aload_1
    //   1: ldc 64
    ...
    //   8: ldc 93
    //   10: aconst_null
    //   11: invokevirtual 98	aukn:a	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   14: astore_2
    //   15: aload_2
    //   16: ifnull +198 -> 214
    //   19: aload_2
    ...
    //   32: dup
    //   33: aload_0
    //   34: invokespecial 109	asfc:<init>	(Lasfb;)V
    ...
    //   76: aload_0
    //   77: getfield 38	asfb:jdField_b_of_type_JavaLangObject	Ljava/lang/Object;
    //   80: astore_1
    //   81: aload_1
    //   82: monitorenter
    //   83: aload_0
    //   84: aload_2
    //   85: putfield 145	asfb:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   88: aload_0
    //   89: getfield 145	asfb:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   92: ifnonnull +16 -> 108
    //   95: aload_0
    ...
    //   105: putfield 145	asfb:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   108: aload_1
    //   109: monitorexit
    //   110: aload_0
    //   111: getfield 47	asfb:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   114: astore_1
    //   115: aload_1
    //   116: monitorenter
    //   117: aload_0
    //   118: getfield 47	asfb:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   121: invokeinterface 153 1 0
    //   126: aload_0
    //   127: getfield 145	asfb:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   154: astore_3
    //   155: aload_0
    //   156: getfield 47	asfb:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   159: aload_3
  ...
  private void a(aukn paramaukn, TroopAssistantData paramTroopAssistantData)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        ...
        ThreadManager.post(new TroopAssistantManager.4(this, paramTroopAssistantData, paramaukn), 8, null, false);
        return;
        paramaukn = finally;
        throw paramaukn;
        i += 1;
  ...
  private boolean a(aukn paramaukn, String paramString)
  {
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
    ...
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      ...
      if (paramString != null)
      {
        ThreadManager.post(new TroopAssistantManager.3(this, paramaukn, paramString), 8, null, false);
        return true;
        paramaukn = finally;
        throw paramaukn;
      }
  ...
  private boolean a(QQAppInterface paramQQAppInterface, int paramInt, long paramLong)
  {
    ...
    case 2: 
      if (bool)
      {
        localObject = localaktg.a(ajsf.C, 5000);
        ((RecentUser)localObject).uin = ajsf.C;
    ...
    for (;;)
    {
      ...
      if (paramInt != 3)
      {
        paramQQAppInterface = localaktg.b(ajsf.C, 5000);
        if (paramQQAppInterface != null) {
          localaktg.b(paramQQAppInterface);
        }
      }
    }
  }
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_JavaUtilSet != null)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if ((!TextUtils.isEmpty(str)) && (!adie.a(str, 1, paramQQAppInterface))) {
              i += 1;
            }
          }
          else
      ...
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if (adie.a(localTroopAssistantData.troopUin, 1, paramQQAppInterface)) {
              continue;
            }
  ...
  public void a(aukn paramaukn, QQAppInterface paramQQAppInterface)
  {
    try
    {
      a(paramQQAppInterface);
      aktg localaktg = paramQQAppInterface.a().a();
      Object localObject2 = localaktg.a(false);
      ...
      if (((List)localObject1).size() > 0)
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          localObject3 = a(paramaukn, paramQQAppInterface, ((RecentUser)localObject2).uin);
          ...
          {
            a(paramaukn, (TroopAssistantData)localObject3);
  ...
  public void a(QQAppInterface paramQQAppInterface, mxm parammxm)
  {
    ThreadManager.post(new TroopAssistantManager.2(this, paramQQAppInterface, parammxm), 8, null, true);
  }
  ...
  public void a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    ...
    a(paramMessageRecord, paramMessageRecord.frienduin, paramMessageRecord.time, localaukn, paramQQAppInterface);
    localaukn.a();
  }
  
  public void a(MessageRecord paramMessageRecord, String paramString, long paramLong, aukn paramaukn, QQAppInterface paramQQAppInterface)
  {
    TroopAssistantData localTroopAssistantData = a(paramaukn, paramQQAppInterface, paramString);
    ...
    for (localTroopAssistantData.lastmsgtime = paramMessageRecord.time;; localTroopAssistantData.lastmsgtime = paramLong)
    {
      ...
      a(paramaukn, localTroopAssistantData);
  ...
  public void a(String paramString, long paramLong, aukn paramaukn, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      a(paramQQAppInterface, 0, paramLong);
      return;
      localTroopAssistantData = a(paramaukn, paramQQAppInterface, paramString);
      break;
      label94:
      a(paramaukn, localTroopAssistantData);
    }
  ...
  public void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    aukn localaukn = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    aktg localaktg = paramQQAppInterface.a().a();
    RecentUser localRecentUser = localaktg.b(paramString, 1);
    QQMessageFacade.Message localMessage;
    if (localRecentUser != null)
    {
      paramString = a(localaukn, paramQQAppInterface, paramString);
    ...
    for (paramString.lastmsgtime = localMessage.time;; paramString.lastmsgtime = localRecentUser.lastmsgtime)
    {
      ...
      a(localaukn, paramString);
      e(paramString.troopUin, paramQQAppInterface);
      ahnn.a().a(localRecentUser.uin + "-" + localRecentUser.getType());
      if ((!(localRecentUser.msg instanceof ahqa)) && (!(localRecentUser.msg instanceof ahqr)) && (!(localRecentUser.msg instanceof ahqd)) && (!(localRecentUser.msg instanceof ahqj)) && (!(localRecentUser.msg instanceof ahpz)) && (!(localRecentUser.msg instanceof bhxj)) && (!(localRecentUser.msg instanceof ahqo)) && (!(localRecentUser.msg instanceof ahqi)) && (!(localRecentUser.msg instanceof ahql))) {
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_JavaUtilSet = bbjo.a((SharedPreferences)localObject2, "troop_assis_new_unread_list", null);
      if (this.jdField_a_of_type_JavaUtilSet == null)
      {
        this.jdField_a_of_type_JavaUtilSet = new HashSet();
  ...
  public void c(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      {
        localObject = localaukn;
        RecentUser localRecentUser = localaktg.a(String.valueOf(localTroopAssistantData.troopUin), 1);
        localObject = localaukn;
  ...
  public void i(QQAppInterface paramQQAppInterface)
  {
    ...
    if (((ArrayList)localObject3).size() > 0)
    {
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        localObject5 = a(localaukn, paramQQAppInterface, ((RecentUser)???).uin);
        ...
        {
          a(localaukn, (TroopAssistantData)localObject5);
          ((aktg)localObject1).b((RecentUser)???);
    ...
    if (((ArrayList)localObject2).size() > 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        ??? = ((aktg)localObject1).a(((TroopAssistantData)localObject3).troopUin, 1);
        ...
        if (a(localaukn, ((TroopAssistantData)localObject3).troopUin))
        {
          ((aktg)localObject1).a((RecentUser)???);
  ...
  public void k(QQAppInterface paramQQAppInterface)
  {
    try
    {
      ...
      {
        localaukn = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
        a().a(localaukn, paramQQAppInterface);
        localaukn.a();
      }
      c(paramQQAppInterface);
      if (asfd.a().a(paramQQAppInterface) == true)
      {
        localaukn = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
        asfd.a().a(localaukn, paramQQAppInterface);
        localaukn.a();
      }
      return;
    }
