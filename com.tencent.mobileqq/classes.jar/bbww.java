  ...
  implements bbvg
{
  ...
  public bbww(View paramView)
  {
    this.b = paramView;
    a();
  }
  
  public bbww(ViewGroup paramViewGroup, int paramInt)
  {
  ...
  public View a(int paramInt)
  {
    ...
    return this.b.findViewById(2131377062);
  }
  ...
  protected void a()
  {
    View localView = this.b.findViewById(2131378776);
    if (localView != null)
    {
      this.h = ((TextView)localView);
      this.h.setEditableFactory(bdod.a);
    }
    localView = this.b.findViewById(2131378008);
    if (localView != null) {
      this.i = ((TextView)localView);
    }
    localView = this.b.findViewById(2131365369);
    if (localView != null) {
      this.j = ((TextView)localView);
    }
    localView = this.b.findViewById(2131366587);
    if (localView != null) {
      this.k = ((TextView)localView);
    }
    localView = this.b.findViewById(2131368246);
    if (localView != null) {
    ...
    for (;;)
    {
      localView = this.b.findViewById(2131376523);
      if (localView != null) {
        this.f = ((ImageView)localView);
      }
      this.jdField_c_of_type_AndroidViewView = this.b.findViewById(2131365606);
      this.d = this.b.findViewById(2131376536);
      b();
      return;
