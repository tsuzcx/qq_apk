  ...
  extends berl
{
  ...
  aocj jdField_a_of_type_Aocj = new besd(this);
  protected beyb a;
  ...
  private berr e;
  protected byte[] e;
  private berr jdField_f_of_type_Berr = new berr();
  private byte[] jdField_f_of_type_ArrayOfByte;
  private boolean jdField_g_of_type_Boolean;
  private byte[] jdField_g_of_type_ArrayOfByte;
  
  public besa(beyb parambeyb, beyg parambeyg)
  {
    super(parambeyb, parambeyg);
    this.jdField_e_of_type_Berr = new berr();
    ...
    this.jdField_a_of_type_Bete.jdField_a_of_type_Int = 0;
    this.jdField_a_of_type_Bete.q = this.jdField_a_of_type_Beyg.jdField_c_of_type_JavaLangString;
    this.jdField_a_of_type_Bete.jdField_h_of_type_Int = 0;
    this.jdField_a_of_type_Bete.jdField_a_of_type_Boolean = true;
    ...
    {
      this.jdField_g_of_type_Boolean = ((MessageForPic)this.jdField_a_of_type_Beyg.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).isStoryPhoto;
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (this.jdField_a_of_type_Bete.jdField_h_of_type_JavaLangString != null) {
            ((im_msg_body.NotOnlineImage)localObject3).download_path.set(ByteStringMicro.copyFromUtf8(this.jdField_a_of_type_Bete.jdField_h_of_type_JavaLangString));
          }
          if (this.jdField_a_of_type_Bete.jdField_g_of_type_JavaLangString != null) {
            ((im_msg_body.NotOnlineImage)localObject3).res_id.set(ByteStringMicro.copyFromUtf8(this.jdField_a_of_type_Bete.jdField_g_of_type_JavaLangString));
          }
          ...
          ((im_msg_body.NotOnlineImage)localObject3).pic_width.set(this.jdField_d_of_type_Int);
          Object localObject1 = ((im_msg_body.NotOnlineImage)localObject3).original;
          if (!this.jdField_n_of_type_Boolean) {
            break label820;
          }
          ((PBUInt32Field)localObject1).set(i);
          Object localObject4 = this.jdField_a_of_type_Beyg.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
          Object localObject5;
          ...
          else
          {
            ...
            if (QLog.isColorLevel()) {
              b("busiTypeStat", "uiBusiType:" + this.jdField_a_of_type_Beyg.jdField_e_of_type_Int + " protoBusiType:" + ((im_msg_body.NotOnlineImage)localObject3).biz_type.get());
            }
            localObject1 = new im_msg_body.Elem();
            if (!anxg.a((MessageRecord)localObject4)) {
              break label778;
            }
            ...
            ((im_msg_body.Text)localObject1).str.set(ByteStringMicro.copyFromUtf8(anzj.a(2131700208)));
            ...
            localObject5 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_Beyg.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Beyg.jdField_a_of_type_Int, this.jdField_a_of_type_Beyg.jdField_a_of_type_Long);
            ...
            ((bdqr)localObject4).ae = this.jdField_c_of_type_JavaLangString;
            if (this.jdField_f_of_type_JavaLangString != null) {
              break label798;
            }
            localObject1 = this.jdField_l_of_type_JavaLangString;
            ((bdqr)localObject4).ad = ((String)localObject1);
            ((bdqr)localObject4).d = this.jdField_q_of_type_Long;
            ((bdqr)localObject4).jdField_e_of_type_Long = ((MessageRecord)localObject5).time;
            if (!aics.b(localStructMsgForImageShare.mMsgActionData)) {
              break label806;
            }
            localObject5 = ((bdqr)localObject4).ac;
            ((bdqr)localObject4).ac = "";
            localObject1 = ((MessageForStructing)localObject3).structingMsg.getXmlBytes();
            ((bdqr)localObject4).ac = ((String)localObject5);
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      catch (InvalidProtocolBufferMicroException paramArrayOfByte)
      {
        ...
        this.jdField_a_of_type_Bete.jdField_g_of_type_JavaLangString = paramArrayOfByte;
        this.jdField_f_of_type_JavaLangString = paramArrayOfByte;
        this.jdField_a_of_type_Bete.jdField_h_of_type_JavaLangString = paramArrayOfByte;
  ...
  private void v()
  {
    this.jdField_a_of_type_Beyb.a.post(new C2CPicUploadProcessor.2(this));
  }
  
  private void w()
  {
    this.jdField_a_of_type_Bete.jdField_a_of_type_Betf.a();
    this.jdField_a_of_type_Bete.jdField_b_of_type_Betf.a();
    ...
    localbete.jdField_g_of_type_Long = l;
    this.jdField_k_of_type_Long = l;
    this.jdField_a_of_type_Bete.jdField_h_of_type_Long = 0L;
  }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      localObject2 = this.jdField_e_of_type_Berr.a(21) + ";" + this.jdField_f_of_type_Berr.a(22);
      if (QLog.isColorLevel())
      {
        ...
        QLog.d("C2CPicUploadProcessor", 2, "<BDH_LOG> mStepUrl: " + this.jdField_a_of_type_Berr.toString() + ";mStepTrans: " + this.jdField_b_of_type_Berr.toString() + ";mStepMsg: " + this.jdField_c_of_type_Berr.toString() + ";mStepTransPre: " + this.jdField_e_of_type_Berr.toString() + ";mStepTransLeft: " + this.jdField_f_of_type_Berr.toString() + ";");
      }
      String str;
      if (!paramBoolean)
      {
      ...
      if (paramBoolean)
      {
        ...
        Log.i("AutoMonitor", "SendC2CPic, cost=" + (this.jdField_b_of_type_Berr.jdField_b_of_type_Long - this.jdField_b_of_type_Berr.jdField_a_of_type_Long) / 1000000L);
  ...
  protected void a(boolean paramBoolean, long paramLong1, long paramLong2)
  {
    if (paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_Beyg.jdField_j_of_type_Boolean)
      {
        ...
        akrx.a(l, this.jdField_q_of_type_Long, this.jdField_f_of_type_Boolean, d);
        if ((d >= 0.0D) && (d <= 1.0D)) {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("C2CPicUploadProcessor", 2, "doReport ,mStartTime = " + this.jdField_k_of_type_Long + ",mEnterAioTime = " + this.jdField_u_of_type_Long + ",finishTime  = " + paramLong2 + ", aioDuration = " + l + ", duration = " + paramLong1 + "processor:" + this + ",mUiRequest.myPresendInvalid = " + this.jdField_a_of_type_Beyg.jdField_k_of_type_Boolean + ",Percent = " + d);
        }
      }
      b(true, paramLong1);
      ...
      bdmc.a(BaseApplication.getContext()).a(null, c(), true, paramLong1, this.jdField_q_of_type_Long, localHashMap, "");
    }
    for (;;)
    {
      m();
  ...
  protected byte[] a()
  {
    this.jdField_f_of_type_ArrayOfByte = SessionInfo.getInstance(this.jdField_a_of_type_Beyg.jdField_b_of_type_JavaLangString).getSessionKey();
    ...
    do
    {
      ...
      {
        return null;
        this.jdField_g_of_type_ArrayOfByte = SessionInfo.getInstance(this.jdField_a_of_type_Beyg.jdField_b_of_type_JavaLangString).getHttpconn_sig_session();
        if ((this.jdField_g_of_type_ArrayOfByte == null) || (this.jdField_g_of_type_ArrayOfByte.length == 0))
        {
          ...
          try
          {
            l1 = Long.valueOf(this.jdField_a_of_type_Beyg.jdField_b_of_type_JavaLangString).longValue();
            localObject2 = this.jdField_a_of_type_Beyg.jdField_c_of_type_JavaLangString;
  ...
  public int b()
  {
    if (this.jdField_m_of_type_Boolean)
    {
      ...
      w();
      this.jdField_a_of_type_Beyb.a.post(new C2CPicUploadProcessor.5(this));
    }
    return 0;
  }
  ...
  protected void b(bfau parambfau, bfbj parambfbj)
  {
    ...
    if (parambfbj != null)
    {
      ...
      if (i < parambfbj.jdField_a_of_type_JavaUtilList.size())
      {
        ...
        if (parambfau.jdField_a_of_type_Boolean)
        {
          ...
          str = parambfau.jdField_a_of_type_JavaLangString;
          localbete.jdField_g_of_type_JavaLangString = str;
          this.jdField_f_of_type_JavaLangString = str;
          localbete = this.jdField_a_of_type_Bete;
          parambfau = parambfau.jdField_b_of_type_JavaLangString;
          localbete.jdField_h_of_type_JavaLangString = parambfau;
          this.jdField_l_of_type_JavaLangString = parambfau;
    ...
    do
    {
      ...
      if (!this.jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_f_of_type_JavaLangString = str;
        localbete = this.jdField_a_of_type_Bete;
        str = parambfau.jdField_b_of_type_JavaLangString;
        localbete.jdField_h_of_type_JavaLangString = str;
        this.jdField_l_of_type_JavaLangString = str;
      }
      for (;;)
      {
        this.jdField_m_of_type_JavaLangString = parambfau.jdField_c_of_type_JavaLangString;
        ...
        this.jdField_f_of_type_Berr.a();
        break;
        this.jdField_b_of_type_Berr.jdField_a_of_type_Long = 0L;
        this.jdField_b_of_type_Berr.a();
      }
      s();
      break;
      d("<BDH_LOG> onBusiProtoResp() error : " + parambfau.jdField_c_of_type_Int + " ,select HTTP channel");
      this.w = 2;
    } while ((this.jdField_a_of_type_Boolean) && (this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction.isFinish.get()) && (this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction.isSuccess.get()));
    label425:
    label432:
  ...
  protected byte[] b()
  {
    ...
    case 2: 
      ...
      localObject = this.jdField_a_of_type_Beyg.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
      ...
      localPicInfoExt.uint32_pic_width.set(this.jdField_d_of_type_Int);
  ...
  public int c()
  {
    ...
    localObject = this.jdField_a_of_type_Beyg.jdField_i_of_type_JavaLangString;
  ...
  protected void f()
  {
    ...
    if (this.jdField_a_of_type_Beyg.jdField_a_of_type_Int == 1006)
    {
      ...
      localbfbd.b = this.jdField_n_of_type_Boolean;
  ...
  public void s()
  {
    ...
    besb localbesb = new besb(this, SystemClock.uptimeMillis());
    if (this.jdField_a_of_type_Boolean) {}
    for (this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 4, this.jdField_a_of_type_Beyg.jdField_i_of_type_JavaLangString, (int)this.jdField_r_of_type_Long, this.jdField_a_of_type_ArrayOfByte, this.jdField_b_of_type_ArrayOfByte, localbesb, this.jdField_a_of_type_Int, this.jdField_e_of_type_ArrayOfByte, this.jdField_a_of_type_ComTencentMobileqqHighwayProtocolCSDataHighwayHead$LoginSigHead);; this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1, this.jdField_a_of_type_Beyg.jdField_i_of_type_JavaLangString, (int)this.jdField_r_of_type_Long, (byte[])localObject, this.jdField_b_of_type_ArrayOfByte, localbesb))
    {
      localObject = new besc(this);
  ...
  void t()
  {
    ...
    if ((!this.jdField_c_of_type_Boolean) || (this.jdField_a_of_type_Beyg.jdField_j_of_type_Boolean))
    {
      ...
      if ((this.jdField_a_of_type_Beyg.jdField_j_of_type_Boolean) && (this.jdField_f_of_type_Boolean)) {
