  ...
  extends afor
{
  ...
  public ahbw(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new ahbx(this);
  }
  
  private void a(MessageForPubAccount paramMessageForPubAccount, ahby paramahby, long paramLong, String paramString)
  {
    if ((paramahby == null) || (paramMessageForPubAccount == null)) {}
    do
    {
      return;
      if (paramLong > 0L) {
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", paramMessageForPubAccount.frienduin, "mp_msg_sys_14", "msg_click", 0, 1, 0, Long.toString(paramLong), "", "", "");
      }
      onq localonq = (onq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.EC_SHOP_ASSISTANT_MANAGER);
      ...
      if ((localonq != null) && (localook != null) && (localonq.a(paramMessageForPubAccount.senderuin))) {
        localook.a(false, paramMessageForPubAccount, paramahby.d + 1, paramString);
      }
    ...
    aanb.a(paramMessageForPubAccount.frienduin, "auth_aio", "clk_content", 0, 0, new String[] { "", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendNick, ((PAMessage.Item)paramMessageForPubAccount.mPAMessage.items.get(0)).title });
  }
  
  private void a(PAMessage.Item paramItem, ahby paramahby, String paramString, long paramLong)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      bheh localbheh = bhey.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString);
      int i;
      if (localbheh == null) {
        if (paramItem.appId != 0L)
        {
          ...
          if (ahbz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramItem.nativeJumpString, paramItem.appId, paramString)) {
            break label132;
          }
          ahbz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramahby.jdField_a_of_type_JavaLangString, paramahby.jdField_b_of_type_JavaLangString, paramahby.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendNick, paramLong);
        }
      }
      for (;;)
      {
  ...
  protected View a(MessageRecord paramMessageRecord, afos paramafos, View paramView, LinearLayout paramLinearLayout, aftk paramaftk)
  {
    ...
    {
      paramafos = new TextView(this.jdField_a_of_type_AndroidContentContext);
      paramafos.setText(localPAMessage.grayTips);
      paramafos.setGravity(17);
      paramafos.setSingleLine();
      paramafos.setEllipsize(TextUtils.TruncateAt.MIDDLE);
      ...
      paramafos.setLayoutParams((ViewGroup.LayoutParams)localObject1);
      paramafos.setBackgroundResource(2130844727);
      paramafos.setPadding(DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 9.0F), DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 4.0F), DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 9.0F), DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 4.0F));
      paramafos.setTextColor(-1);
      paramafos.setTextSize(12.0F);
      localViewGroup.addView(paramafos);
    }
    int i = 0;
    label376:
    Object localObject2;
    ...
    {
      localObject1 = new ahby(this);
      PAMessage.Item localItem = (PAMessage.Item)localArrayList.get(i);
      ((ahby)localObject1).jdField_b_of_type_Int = 5;
      ((ahby)localObject1).jdField_c_of_type_JavaLangString = localItem.url;
      ((ahby)localObject1).jdField_c_of_type_Int = localPAMessage.type;
      ((ahby)localObject1).jdField_b_of_type_JavaLangString = localItem.actionUrl;
      ((ahby)localObject1).jdField_a_of_type_JavaLangString = localItem.nativeJumpString;
      ((ahby)localObject1).jdField_a_of_type_Long = paramLinearLayout.uniseq;
      ((ahby)localObject1).d = i;
      Object localObject3;
      int j;
      if (i == 0)
      {
        paramafos = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558872, null);
        localObject3 = (TextView)paramafos.findViewById(2131372359);
        localObject2 = (ImageView)paramafos.findViewById(2131372358);
        ...
        String str = nwo.c(localItem.title);
      ...
      for (;;)
      {
        try
        {
          ...
          ((ImageView)localObject2).setImageDrawable(URLDrawable.getDrawable(usq.a(localItem.cover, 0), (URLDrawable.URLDrawableOptions)localObject3));
        }
        ...
        {
          paramafos = new ImageView(this.jdField_a_of_type_AndroidContentContext);
          ...
          paramafos.setLayoutParams((ViewGroup.LayoutParams)localObject2);
          paramafos.setBackgroundResource(2131165938);
          localViewGroup.addView(paramafos);
          paramafos = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558870, null);
          break label376;
        }
        if (i != 1)
        {
        ...
        paramafos = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558871, null);
        break label376;
        j = 2130842702;
        break label481;
    ...
    paramView.setBackgroundResource(2130838354);
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER) != null) && (((aoan)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.PUBLICACCOUNTDATA_MANAGER)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo)) && (paramLinearLayout.mPAMessage.items != null) && (paramLinearLayout.mPAMessage.items.size() > 0)) {
      aanb.a(paramLinearLayout.frienduin, "auth_aio", "exp", 0, 0, new String[] { "", "1", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendNick, ((PAMessage.Item)paramLinearLayout.mPAMessage.items.get(0)).title });
    }
    return paramView;
  }
