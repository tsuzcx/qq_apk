...
public class amcg
  extends anvi
{
  public amcg(QQSpecialFriendSettingActivity paramQQSpecialFriendSettingActivity) {}
  ...
  protected void onSetSpecialCareSwitchesOfAPerson(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    label233:
    for (int i = 2131692038;; i = 2131698882)
    {
      paramArrayOfObject.arg2 = i;
      this.a.a.sendMessage(paramArrayOfObject);
      if ((!paramBoolean) || (j != 0)) {
      ...
      paramArrayOfObject.putExtra("selfSet_leftViewText", this.a.getString(2131694948));
