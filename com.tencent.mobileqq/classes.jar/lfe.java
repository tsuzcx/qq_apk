...
public class lfe
{
  ...
  private List<lff> jdField_a_of_type_JavaUtilList;
  ...
  public lfe(@NonNull VideoAppInterface paramVideoAppInterface, String paramString)
  {
  ...
  private void a(long paramLong, Map<String, Integer> paramMap)
  {
    ...
    this.jdField_a_of_type_JavaUtilList.add(new lff(a(), a(paramMap, "summary.total-pss"), a(paramMap, "summary.java-heap"), a(paramMap, "summary.native-heap"), a(paramMap, "summary.code"), a(paramMap, "summary.graphics"), paramLong));
  }
  ...
  private void c()
  {
    ...
    if (j >= 4)
    {
      l1 = ((lff)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_a_of_type_Long;
      l2 = ((lff)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_a_of_type_Long;
      l3 = ((lff)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_b_of_type_Long;
      l4 = ((lff)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_b_of_type_Long;
      l5 = ((lff)this.jdField_a_of_type_JavaUtilList.get(j - 1 - 1)).jdField_c_of_type_Long;
      l6 = ((lff)this.jdField_a_of_type_JavaUtilList.get(1)).jdField_c_of_type_Long;
      i = 1;
      if (i >= j - 1 - 1) {
        break label1067;
      }
      localObject3 = (lff)this.jdField_a_of_type_JavaUtilList.get(i);
      locallff = (lff)this.jdField_a_of_type_JavaUtilList.get(i + 1);
      if ((((lff)localObject3).jdField_a_of_type_Int != 0) && (((lff)localObject3).jdField_a_of_type_Int != locallff.jdField_a_of_type_Int))
      {
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (i == 0)
      {
        ...
        for (;;)
        {
          if (((Iterator)localObject3).hasNext())
          {
            ...
            continue;
            this.jdField_c_of_type_Int = locallff.jdField_a_of_type_Int;
            if ((!((lff)localObject3).a()) || (!locallff.a())) {
              if (QLog.isColorLevel()) {
      ...
      do
      {
        ...
        {
          return;
          d1 = locallff.f - ((lff)localObject3).f;
          d2 = locallff.jdField_a_of_type_Long - ((lff)localObject3).jdField_a_of_type_Long;
          d3 = locallff.jdField_b_of_type_Long - ((lff)localObject3).jdField_b_of_type_Long;
          double d4 = locallff.jdField_c_of_type_Long - ((lff)localObject3).jdField_c_of_type_Long;
          if (d1 <= 0.0D)
          {
            if (QLog.isColorLevel()) {
