...
{
  public lfe(ReadInJoyFeedsActivity paramReadInJoyFeedsActivity, KandianMergeManager paramKandianMergeManager) {}
  ...
  public void a(PopupMenuDialog.MenuItem paramMenuItem)
  {
    ...
    case 8: 
      do
      {
        ...
        return;
        ThreadManager.postImmediately(new lff(this), null, true);
