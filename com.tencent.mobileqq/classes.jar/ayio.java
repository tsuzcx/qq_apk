  ...
  implements ayjk
{
  ...
  public ayio(ahea paramahea, List<ayjl> paramList, String paramString)
  {
  ...
  public String a()
  {
    if (UniteSearchActivity.d == 12) {
      return alpo.a(2131705727) + swy.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), BaseApplicationImpl.getContext());
    }
    return alpo.a(2131705726);
  }
  ...
  {
    ayrd.a(this.jdField_a_of_type_JavaLangString, 90, 0, paramView);
