  ...
  extends BaseChatPie
{
  ...
  public ahdq(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
  ...
  private void b()
  {
    ...
    for (;;)
    {
      ...
      if (i != 0) {
        if (this.a == null)
        {
          this.a = LayoutInflater.from(this.mContext).inflate(2131558586, null);
          if (this.a != null)
          {
            localAnyScaleTypeImageView = (AnyScaleTypeImageView)this.a.findViewById(2131366058);
      ...
      try
      {
        ...
        localObject = (TextView)this.a.findViewById(2131366074);
        if (localObject != null) {
  ...
  public void updateSession_updateTitleRightView()
  {
    ...
    this.mCustomTitleView.setRight1Icon(2130840508, 2130840508);
  }
