...
public class vcm
  extends wco<oidb_0x791.RedDotInfo>
  implements View.OnClickListener
{
  ...
  public View a(int paramInt, vap paramvap, ViewGroup paramViewGroup)
  {
    ...
    {
      paramvap.a(2131377315).setVisibility(8);
      paramvap.a().setLayoutParams(new AbsListView.LayoutParams(-1, 0));
      return paramvap.a();
    }
    paramInt = vzl.a(paramvap.a().getContext(), 52.0F);
    paramvap.a(2131377315).setVisibility(0);
    paramvap.a().setLayoutParams(new AbsListView.LayoutParams(-1, paramInt));
    paramvap.a().setVisibility(0);
    ImageView localImageView = (ImageView)paramvap.a(2131367679);
    ...
    for (;;)
    {
      ...
      localImageView.setImageDrawable(localDrawable);
      TextView localTextView = (TextView)paramvap.a(2131364691);
      StringBuilder localStringBuilder = new StringBuilder();
      if (this.jdField_a_of_type_Int > 99) {}
      for (paramViewGroup = "99+";; paramViewGroup = Integer.valueOf(this.jdField_a_of_type_Int))
      {
        localTextView.setText(paramViewGroup + ajya.a(2131706650));
  ...
  {
    paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561299, paramViewGroup, false);
  ...
  public void a(ImageView paramImageView)
  {
    ...
    QQStoryContext.a();
    mxf.a(QQStoryContext.a(), new vcn(this, paramImageView), localReqStoryMessageList.toByteArray(), sxm.a("StorySvc.get_710_message_list"));
  }
  ...
  protected void c()
  {
    ...
    {
      a(((mxu)localQQAppInterface.getManager(70)).a(52));
      return;
    }
    ved.e("Q.qqstory.home.MessageNotifySegment", "Get the QQAppInterface is null,we dont know the red point state");
  }
  ...
  public void onClick(View paramView)
  {
    ...
    paramView = ((tdl)tcz.a(2)).b(QQStoryContext.a().b());
    ...
    for (int i = 1;; i = 2)
    {
      vei.a("play_video", "clk_grey", i, 0, new String[] { "", "", "", "" });
      return;
      i = 0;
      break;
    }
