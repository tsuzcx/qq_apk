...
public class aroj
{
  ...
  public static void a(Activity paramActivity, arhg paramarhg, String paramString, EditExtendFriendInfo.SchoolInfo paramSchoolInfo)
  {
    ...
    paramString = String.format(paramActivity.getString(2131698132), new Object[] { paramString });
    bfur.a(paramActivity, 230).setMessage(paramString).setPositiveButton(paramActivity.getString(2131698133), new arol(paramarhg, paramSchoolInfo)).setNegativeButton(paramActivity.getString(2131690624), new arok()).show();
  }
