...
{
  private static yoi jdField_a_of_type_Yoi = new yoi();
  ...
  public static yoi a()
  {
    try
    {
      yoi localyoi = jdField_a_of_type_Yoi;
      return localyoi;
    }
    finally
    {
  ...
  {
    yny.a("GdtImpressionPolicy", "report view: " + paramView.hashCode());
    GdtAd localGdtAd = a(paramView);
    if (localGdtAd == null)
    {
      yny.a("GdtImpressionPolicy", "break: statistics == null");
      return;
    }
    if (localGdtAd.reportState == 2)
    {
      yny.a("GdtImpressionPolicy", "break: already report " + localGdtAd.getTraceId());
      return;
    }
    if (!a(paramView))
    {
      yny.a("GdtImpressionPolicy", "break: isVisibleAreaSatisfied not");
      return;
    }
    ...
    if (!b(paramView))
    {
      yny.a("GdtImpressionPolicy", "inCountingMap not " + localGdtAd.getTraceId());
  ...
  {
    yny.a("GdtImpressionPolicy", "handleMessage : ");
    ...
    for (;;)
    {
      ...
      if (paramMessage.get() != null)
      {
        ...
        {
          yny.a("GdtImpressionPolicy", "break: statistics.reportState != 1 " + localGdtAd.getTraceId());
        }
        else if (!a(paramMessage))
        {
          yny.a("GdtImpressionPolicy", "break: isVisibleAreaSatisfied not " + localGdtAd.getTraceId());
          localGdtAd.reportState = -1;
        }
        else if (!b(paramMessage))
        {
          yny.a("GdtImpressionPolicy", "break: inCountingMap not " + localGdtAd.getTraceId());
        }
        else
        {
          localObject = paramMessage.getTag(2131313370);
          if (localObject == null)
          {
            yny.a("GdtImpressionPolicy", "break: o2 == null " + localGdtAd.getTraceId());
          }
          else if (!(localObject instanceof yoj))
          {
            yny.a("GdtImpressionPolicy", "break: o2 instanceof ReportListener not " + localGdtAd.getTraceId());
          }
          else
          {
            ...
            yny.a("GdtImpressionPolicy", "break: already reported " + localGdtAd.getTraceId());
          }
        }
      }
    }
    ((yoj)localObject).reportImpression(paramMessage);
    localGdtAd.reportState = 2;
    a(localGdtAd.getTraceId(), true);
    yny.a("GdtImpressionPolicy", "report " + localGdtAd.getTraceId());
