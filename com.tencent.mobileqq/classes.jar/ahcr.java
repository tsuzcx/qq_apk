  ...
  implements Manager
{
  ...
  private ahdm jdField_a_of_type_Ahdm;
  ...
  private ConcurrentHashMap<String, beae> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private volatile boolean jdField_a_of_type_Boolean;
  private ahdm jdField_b_of_type_Ahdm;
  ...
  public ahcr(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRunnable = new BlessManager.1(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface = alof.aX + jdField_a_of_type_JavaLangString;
  ...
  private void a(amnz paramamnz)
  {
    RecentUser localRecentUser = paramamnz.a(alof.au, 9003);
    long l = NetConnInfoCenter.getServerTime();
    localRecentUser.uin = alof.au;
  ...
  private void a(amnz paramamnz, RecentUser paramRecentUser)
  {
    paramamnz.b(paramRecentUser);
    a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
      ...
      for (;;)
      {
        if (m < arrayOfString.length) {
          ...
          else
          {
            ...
            {
              localObject = bflr.b(arrayOfString[m]);
              j = 1;
  ...
  private void a(BlessTask paramBlessTask, ArrayList<BlessPtvModule> paramArrayList, ArrayList<BlessWording> paramArrayList1)
  {
    ...
    for (;;)
    {
      ...
      {
        localawgh.a();
        localawgf.a(BlessTask.class);
        if (paramBlessTask != null) {
          localawgf.b(paramBlessTask);
        }
        localawgf.a(BlessPtvModule.class);
        if (paramArrayList != null)
        {
          paramBlessTask = paramArrayList.iterator();
          if (paramBlessTask.hasNext())
          {
            localawgf.b((BlessPtvModule)paramBlessTask.next());
            continue;
          }
        }
      }
      catch (Exception paramBlessTask)
      {
        ...
        localawgh.b();
        return;
        localawgf.a(BlessWording.class);
        if (paramArrayList1 != null)
        {
          paramBlessTask = paramArrayList1.iterator();
          if (paramBlessTask.hasNext())
          {
            localawgf.b((BlessWording)paramBlessTask.next());
            continue;
          }
        }
      }
  ...
  private void a(String paramString, BlessTask paramBlessTask, ArrayList<BlessPtvModule> paramArrayList, ArrayList<BlessWording> paramArrayList1)
  {
    ...
    this.jdField_a_of_type_Ahdm.b();
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences();
    ahdm.a((SharedPreferences)localObject1, this.jdField_a_of_type_Ahdm, 1);
  ...
  {
    if (bdin.a(BaseApplicationImpl.getApplication()) == 0) {
      if (QLog.isColorLevel()) {
    ...
    {
      return;
      localbeae = (beae)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
      if (localbeae == null) {
        break label147;
      }
      if ((localbeae.a() != 2) && (localbeae.a() != 3)) {
        break;
      }
    ...
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString2, localbeae);
    localbeaj.a(localbeae, new ahcs(this, paramString2, paramString1), null);
  }
  ...
  private void a(ArrayList<BlessPtvModule> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bdhb.a(this.jdField_b_of_type_JavaLangString + str1);
        if (!QLog.isColorLevel()) {
          break;
        }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if (i != 0)
        {
          ...
          if ((bhtb.d()) && (!new File((String)localObject1).exists()))
          {
            k();
            if (QLog.isColorLevel()) {
  ...
  private void d(boolean paramBoolean)
  {
    ...
    RecentUser localRecentUser = localamnz.b(alof.au, 9003);
    int i;
    label78:
    Object localObject;
  ...
  private void h()
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences();
    this.jdField_a_of_type_Ahdm = ahdm.a((SharedPreferences)localObject1, 1);
    this.jdField_b_of_type_Ahdm = ahdm.a((SharedPreferences)localObject1, 2);
    Object localObject3 = bdnf.a((SharedPreferences)localObject1, "bless_uin_to_send", null);
    ...
    label198:
    label212:
    for (localObject1 = localObject2;; localObject1 = Integer.valueOf(this.jdField_b_of_type_Ahdm.a()))
    {
      ...
      break label112;
      localObject1 = Integer.valueOf(this.jdField_a_of_type_Ahdm.a());
      break label133;
    }
  }
  ...
  private void i()
  {
    ...
    Object localObject2 = (ArrayList)((awgf)localObject1).a(BlessTask.class, new BlessTask().getTableName(), false, null, null, null, null, null, null);
    if ((localObject2 != null) && (((ArrayList)localObject2).size() > 0)) {
      this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask = ((BlessTask)((ArrayList)localObject2).get(0));
    }
    this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)((awgf)localObject1).a(BlessPtvModule.class, new BlessPtvModule().getTableName(), false, null, null, null, null, null, null));
    this.jdField_b_of_type_JavaUtilArrayList = ((ArrayList)((awgf)localObject1).a(BlessWording.class, new BlessWording().getTableName(), false, null, null, null, null, null, null));
    ((awgf)localObject1).a();
    if (QLog.isColorLevel())
    {
  ...
  private void k()
  {
    if ((bhtb.d()) && (!this.jdField_a_of_type_Boolean)) {
  ...
  public acjq a(int paramInt1, int paramInt2)
  {
    acjq localacjq = new acjq();
    localacjq.jdField_a_of_type_Int = 0;
    if (paramInt1 == 2) {
      localacjq.jdField_b_of_type_Int = 1;
    }
    for (;;)
    {
      localacjq.jdField_b_of_type_Long = paramInt2;
      return localacjq;
      if (paramInt1 == 3) {
        localacjq.jdField_b_of_type_Int = 4;
      } else {
        localacjq.jdField_b_of_type_Int = 0;
      }
    }
  }
  ...
  public Drawable a()
  {
    Object localObject2 = BaseApplication.getContext().getResources().getDrawable(2130838617);
    boolean bool = azmk.a();
    Object localObject3;
    Object localObject1;
    int i;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.recentHeadImgUrl != null))
    {
      if ((this.jdField_b_of_type_AndroidGraphicsDrawableDrawable == null) || (this.jdField_d_of_type_Boolean != bool))
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          i = aepi.a(50.0F, BaseApplication.getContext().getResources());
  ...
  public String a(String paramString1, String paramString2)
  {
    ...
    return paramString1 + bdfr.encodeToString(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentNickname().getBytes(), 2);
  }
  ...
  public void a(Context paramContext)
  {
    ...
    aemu.a(paramContext, localIntent, str);
  }
  ...
  public void a(ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        this.jdField_a_of_type_Ahdm.a(str);
      }
      ahdm.a(localSharedPreferences, this.jdField_a_of_type_Ahdm, 1);
    }
    while (paramInt != 2) {
      return;
    }
    ...
    {
      str = (String)paramArrayList.next();
      this.jdField_b_of_type_Ahdm.a(str);
    }
    ahdm.a(localSharedPreferences, this.jdField_b_of_type_Ahdm, 2);
  }
  ...
  public void a(List<String> paramList)
  {
    ...
    bdnf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().edit(), "bless_uin_to_send", paramList.toArray()).commit();
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().b(alof.au, 9003) != null;
  }
  
  public boolean a(String paramString)
  {
    this.jdField_a_of_type_Ahdm.a();
    return this.jdField_a_of_type_Ahdm.a(paramString);
  }
  ...
  {
    this.jdField_c_of_type_JavaUtilArrayList.clear();
    bdnf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().edit(), "bless_uin_to_send", new String[0]).commit();
  }
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        while ((this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.unread != -1) || (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.videoPlayed))
        {
          ...
          {
            localawgh.a();
            localawgf.a(this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask);
            localawgh.c();
          }
  ...
  {
    this.jdField_b_of_type_Ahdm.a();
    return this.jdField_b_of_type_Ahdm.a(paramString);
  }
  ...
  {
    this.jdField_a_of_type_Ahdm.a();
    return c() - this.jdField_a_of_type_Ahdm.a();
  }
  ...
  public int f()
  {
    ...
    int i = j;
    if (j > 0) {
      i = j - this.jdField_a_of_type_Ahdm.b();
    }
    return i;
  }
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask == null) {}
    while ((!bhtb.d()) || (this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessTask.videoPlayed) || (!d()) || (!i())) {
      return false;
    }
    return true;
  }
  ...
  {
    this.jdField_b_of_type_Ahdm.a();
    return i() - this.jdField_b_of_type_Ahdm.a();
  }
  ...
  public int k()
  {
    ...
    int i = j;
    if (j > 0) {
      i = j - this.jdField_b_of_type_Ahdm.b();
    }
    return i;
  }
  ...
  {
    Object localObject = (beag)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47);
    if (localObject != null)
    {
      localObject = ((beag)localObject).a(1);
      if (localObject != null) {
        ((beaj)localObject).a(true, null);
      }
    }
    ThreadManager.getSubThreadHandler().removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
  }
