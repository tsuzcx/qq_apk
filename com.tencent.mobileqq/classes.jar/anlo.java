  ...
  implements angm
{
  ...
  anga jdField_a_of_type_Anga;
  private boolean b;
  private boolean c;
  
  public anlo(anga paramanga)
  {
  ...
  private void b()
  {
    ...
    do
    {
      ...
      localamst = (amst)((QQAppInterface)localObject).getManager(211);
      localamsx = (amsx)((QQAppInterface)localObject).getManager(153);
      localObject = null;
      if (localamst.jdField_a_of_type_Anlm != null) {
        localObject = localamst.jdField_a_of_type_Anlm.a();
      }
    ...
    localamsx.a((DrawerPushItem)localObject);
    localamst.jdField_a_of_type_Anlm.a();
  }
  ...
  public void a()
  {
    ...
    {
      amst localamst = (amst)this.jdField_a_of_type_Anga.a().getManager(211);
      localamst.jdField_a_of_type_Int = -1;
      localamst.a(-1, -1);
    }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      b();
      return;
      QQAppInterface localQQAppInterface = this.jdField_a_of_type_Anga.a();
      if ((localQQAppInterface != null) && (this.jdField_a_of_type_Anga.a() != null) && (angi.a(localQQAppInterface) != null))
      {
  ...
  public boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localamst.jdField_a_of_type_Anlm != null) {}
    for (DrawerPushItem localDrawerPushItem = localamst.jdField_a_of_type_Anlm.a();; localDrawerPushItem = null)
    {
      if ((localDrawerPushItem != null) && (localDrawerPushItem.msg_type != 7) && (localamst.jdField_a_of_type_Anlm.a(paramQQAppInterface, this.jdField_a_of_type_Anga.jdField_a_of_type_Int)))
      {
        if (localDrawerPushItem.reddotGameId > 0)
        {
          localamst.jdField_a_of_type_Int = localDrawerPushItem.reddotGameId;
          localamst.a(localDrawerPushItem.reddotGameId, 3);
          VipUtils.a(paramQQAppInterface, "cmshow", "Apollo", "aio_msg_display", ApolloUtil.b(this.jdField_a_of_type_Anga.jdField_a_of_type_Int), 3, new String[] { String.valueOf(localDrawerPushItem.reddotGameId), String.valueOf(localDrawerPushItem.reddotRedId) });
          if (QLog.isColorLevel()) {
  ...
  public boolean b(QQAppInterface paramQQAppInterface)
  {
    ...
    amst localamst = (amst)paramQQAppInterface.getManager(211);
    if (localamst.jdField_a_of_type_Anlm != null) {}
    for (Object localObject = localamst.jdField_a_of_type_Anlm.a();; localObject = null)
    {
      boolean bool1 = bool2;
      if (localObject != null)
      {
        ...
        if (((DrawerPushItem)localObject).msg_type == 7)
        {
          ...
          bool1 = bool2;
          if (localamst.jdField_a_of_type_Anlm.a(paramQQAppInterface, this.jdField_a_of_type_Anga.jdField_a_of_type_Int))
          {
            if (localObject != null) {
              ((amsx)localObject).o = true;
            }
            VipUtils.a(null, "cmshow", "Apollo", "peoplebubble", ApolloUtil.b(this.jdField_a_of_type_Anga.jdField_a_of_type_Int), 0, new String[] { String.valueOf(1) });
            bool1 = true;
          }
        }
      }
