  ...
  extends anus
{
  ...
  aybg jdField_a_of_type_Aybg = null;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  
  public anlo(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
    super(paramQQAppInterface, paramProxyManager);
  }
  
  private long a(@NonNull HashMap<String, String> paramHashMap, bdyi parambdyi, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead, long paramLong1, long paramLong2, int paramInt, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    if ((bblk.c(paramInt)) || (paramInt == 208)) {
      a(paramHashMap, parambdyi, paramMsg, paramMsgHead, paramLong1, paramMessageHandler, paramArrayList);
    }
    do
    {
      return paramLong2;
      if ((paramInt == 82) || (paramInt == 43))
      {
        ...
        c(paramHashMap, parambdyi, paramMsg, paramMsgHead, paramLong1, paramMessageHandler, paramArrayList);
        return paramLong2;
      }
    } while ((paramInt != 83) && (paramInt != 42));
    paramLong2 = paramMsgHead.discuss_info.discuss_uin.get();
    b(paramHashMap, parambdyi, paramMsg, paramMsgHead, paramLong1, paramMessageHandler, paramArrayList);
    return paramLong2;
  }
  ...
  private MessageRecord a(MessageRecord paramMessageRecord1, msg_comm.MsgHead paramMsgHead, ArrayList<MessageRecord> paramArrayList, int paramInt, MessageRecord paramMessageRecord2)
  {
    ...
    if (!azux.a(paramMessageRecord1))
    {
      localMessageRecord = paramMessageRecord2;
      if (!awct.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)paramMessageRecord2))
      {
        localMessageRecord = paramMessageRecord2;
        if (!(paramMessageRecord2 instanceof MessageForArkApp))
        {
          ...
          localMessageRecord = bbli.a(-1000);
  ...
  private String a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, bdyi parambdyi, msg_comm.MsgHead paramMsgHead, long paramLong, int paramInt, String paramString, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      parambdyi = paramString;
      if (paramMsgHead.from_nick.has())
      {
        parambdyi = paramString;
        if (paramHashMap != null)
        {
          parambdyi = paramMsgHead.from_nick.get();
  ...
  private String a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bdyi parambdyi, msg_comm.MsgHead paramMsgHead, long paramLong, String paramString, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
  ...
  private String a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, msg_comm.MsgHead paramMsgHead, long paramLong, String paramString, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList, bdyi parambdyi)
  {
            ...
            if (paramHashMap.anon_group_msg.has())
            {
              ...
              for (;;)
              {
                try
                {
                  ...
                  paramHashMap = "";
                  paramMessageHandler.saveExtInfoToExtStr("anonymous", nmy.a(i, paramMsg, paramHashMap, j, k, paramMsgHead));
  ...
  {
    im_msg_body.RichText localRichText = bblf.a(paramMessageForStructing);
    try
    {
      ...
      else
      {
        ...
        for (Object localObject = localArrayList;; localObject = null)
        {
          ...
          while (paramMessageForStructing.hasNext())
          {
            ...
            if (awct.a((ChatMessage)localObject))
            {
              if (QLog.isColorLevel()) {
  ...
  private void a(MessageRecord paramMessageRecord, msg_comm.Msg paramMsg, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    ...
    new bblz().a(paramMessageHandler, paramMsg, paramArrayList, null);
  }
  ...
  private void a(@NonNull HashMap<String, String> paramHashMap, bdyi parambdyi, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead, long paramLong, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    int i = paramMsgHead.c2c_cmd.get();
    if ((i == 175) || (i == 11))
    {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    } while (!aszt.a(paramQQAppInterface, (MessageForFile)paramChatMessage).sendCloudUnsuccessful());
    return false;
    return false;
  }
  ...
  private void b(MessageForStructing paramMessageForStructing, HashMap<String, ArrayList<MessageRecord>> paramHashMap, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramMessageForStructing.hasNext())
      {
        ...
        if (!awct.a((ChatMessage)localMessageRecord1)) {
          continue;
        }
        if (paramInt != 2) {
          break label214;
        }
        MessageRecord localMessageRecord2 = a(localMessageRecord1, awck.jdField_a_of_type_JavaLangString, false);
  ...
  private void b(@NonNull HashMap<String, String> paramHashMap, bdyi parambdyi, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead, long paramLong, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerEngine().a().b(paramArrayList, paramMsg)) {
      bblf.a(paramMessageHandler, paramArrayList, paramMsg, false, false, parambdyi);
    }
  ...
  private im_msg_body.RichText c(MessageRecord paramMessageRecord)
  {
    if (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("sens_msg_source_msg_info"))) {
      return bblf.a(paramMessageRecord);
    }
    return bblf.a((MessageForText)paramMessageRecord);
  }
  
  private void c(@NonNull HashMap<String, String> paramHashMap, bdyi parambdyi, msg_comm.Msg paramMsg, msg_comm.MsgHead paramMsgHead, long paramLong, MessageHandler paramMessageHandler, ArrayList<MessageRecord> paramArrayList)
  {
    if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerEngine().a().a(paramArrayList, paramMsg)) {
      bblf.a(paramMessageHandler, paramArrayList, paramMsg, false, false, parambdyi);
    }
  ...
  public ArrayList<MessageRecord> a(MessageRecord paramMessageRecord, ArrayList<? extends MessageRecord> paramArrayList, ProxyListener paramProxyListener, boolean paramBoolean1, boolean paramBoolean2, ArrayList<MessageRecord> paramArrayList1)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (paramBoolean2)
      {
          ...
          else if (localMessageRecord.msgtype == -1035)
          {
            ...
            if (((MessageForMixedMsg)localObject1).getReplyMessage(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) != null)
            {
              ...
              if ((localObject1 != null) && (localObject2 != null)) {
                ataw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageForReplyText)localObject1).getSourceMessage(), ((MessageForReplyText)localObject2).getSourceMessage());
              }
            }
          }
        ...
        if ((nmy.a(paramArrayList)) && (nmy.b(paramArrayList))) {
      ...
      ataw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, paramArrayList);
  ...
  public ArrayList<MessageRecord> a(msg_comm.Msg paramMsg, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bdyi parambdyi)
  {
    ...
    long l6 = bblf.a(localMessageHandler, paramMsg, String.valueOf(l2), String.valueOf(l2));
    ArrayList localArrayList = new ArrayList();
    long l1;
    if (((bblk.c(j)) || (j == 208) || (j == 529)) && (localMsgHead.c2c_cmd.has()))
    {
      paramHashMap = a(paramMsg, paramHashMap, parambdyi, localMsgHead, l2, j, str, localMessageHandler, localArrayList, paramMessageRecord);
      l1 = l2;
    }
    for (;;)
    {
      int i = 0;
      int k = bblf.a(paramMsg);
      ...
      for (;;)
      {
        ...
        parambdyi = a(paramMessageRecord, localMsgHead, localArrayList, i, (MessageRecord)paramMsg.next());
        i += 1;
        parambdyi.time = l4;
        parambdyi.shmsgseq = l3;
        parambdyi.msgUid = l5;
        parambdyi.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
        parambdyi.senderuin = String.valueOf(l2);
        parambdyi.frienduin = String.valueOf(l1);
        parambdyi.vipBubbleDiyTextId = k;
        parambdyi.vipBubbleID = anaj.a((int)l6, k);
        awct.a(parambdyi, paramHashMap, paramMessageRecord);
        if ((j == 82) || (j == 43))
        {
          parambdyi.istroop = 1;
          continue;
          if (((j == 82) || (j == 43)) && (localMsgHead.group_info.has()))
          {
            ...
            paramHashMap = a(paramMsg, paramHashMap, paramMessageRecord, localMsgHead, l2, str, localMessageHandler, localArrayList, parambdyi);
            break;
          }
          ...
          paramHashMap = a(paramMsg, paramHashMap, paramMessageRecord, parambdyi, localMsgHead, l2, str, localMessageHandler, localArrayList);
          break;
        }
        if ((j == 83) || (j == 42)) {
          parambdyi.istroop = 3000;
        } else {
          parambdyi.istroop = 0;
        }
      }
      label567:
      amwh.a(localArrayList);
      return localArrayList;
      label575:
      l1 = l2;
      paramHashMap = str;
  ...
  public ArrayList<MessageRecord> a(@NonNull byte[] paramArrayOfByte, @NonNull HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bdyi parambdyi)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        MessageHandler localMessageHandler = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgHandler();
        long l5 = bblf.a(localMessageHandler, (msg_comm.Msg)localObject3, String.valueOf(l1), String.valueOf(l1));
        localObject2 = new ArrayList();
        long l6 = a(paramHashMap, parambdyi, (msg_comm.Msg)localObject3, (msg_comm.MsgHead)localObject4, l1, l1, j, localMessageHandler, (ArrayList)localObject2);
        a(paramMessageRecord, (msg_comm.Msg)localObject3, localMessageHandler, (ArrayList)localObject2);
        int k = bblf.a((msg_comm.Msg)localObject3);
        ...
        ((MessageRecord)localObject4).vipBubbleID = anaj.a((int)l5, k);
        if ((j == 82) || (j == 43))
        {
  ...
  public HashMap<String, ArrayList<MessageRecord>> a(MessageRecord paramMessageRecord, HashMap<String, ArrayList<MessageRecord>> paramHashMap, ProxyListener paramProxyListener, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      {
        return localHashMap;
        if (awct.a((ChatMessage)paramMessageRecord)) {
          break;
        }
      } while (!QLog.isColorLevel());
  ...
  public HashMap<String, ArrayList<MessageRecord>> a(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap, MessageRecord paramMessageRecord, bdyi parambdyi)
  {
    ...
    try
    {
      ...
      if (paramArrayOfByte.msg.has())
      {
        ...
        {
          localObject3 = a((msg_comm.Msg)paramArrayOfByte.msg.get(i), paramHashMap, paramMessageRecord, parambdyi);
    ...
    if (!a(paramMessageRecord, (HashMap)localObject1, null))
    {
      ...
      if (i < paramArrayOfByte.pbItemList.size())
      {
        ...
        try
        {
          ...
          {
            ArrayList localArrayList = a((msg_comm.Msg)((msg_transmit.PbMultiMsgNew)localObject3).msg.get(j), paramHashMap, paramMessageRecord, parambdyi);
  ...
  public msg_comm.MsgHead a(MessageRecord paramMessageRecord, HashMap<String, String> paramHashMap, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    localMsgHead.from_uin.set(Long.valueOf(abwz.c(paramMessageRecord)).longValue());
    ...
    if (paramBoolean1)
    {
      ...
      String str = abwz.c(paramMessageRecord);
      ...
      awct.a("step:packPb.getMsgHead.nickName = %s", new Object[] { localObject1 });
  ...
  public im_msg_body.MsgBody a(MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        localRichText = bblf.a((MessageForReplyText)paramMessageRecord);
      }
      ...
      {
        localRichText = bblf.a((MessageForPic)paramMessageRecord);
      }
      else if (paramMessageRecord.msgtype == -5008)
      {
        localRichText = bblf.a((MessageForArkApp)paramMessageRecord, true);
      }
      else if (paramMessageRecord.msgtype == -5016)
      {
        localRichText = bblf.c((MessageForArkBabyqReply)paramMessageRecord, true);
      }
      else if (paramMessageRecord.msgtype == -5017)
      {
        localRichText = bblf.b((MessageForArkApp)paramMessageRecord, true);
      }
      else if (paramMessageRecord.msgtype == -5014)
      {
        localRichText = bblf.d((MessageForHiBoom)paramMessageRecord);
      }
      ...
      {
        localRichText = bblf.a((MessageForMixedMsg)paramMessageRecord);
      }
      else if (paramMessageRecord.msgtype == -1051)
      {
        localRichText = bblf.a((MessageForLongTextMsg)paramMessageRecord, false);
      }
    ...
    for (;;)
    {
      ...
      if ((paramHashMap != null) && (paramHashMap.size() > 0))
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          if (!awct.a((ChatMessage)paramHashMap)) {
            break label610;
          }
          paramHashMap = a(paramHashMap, awck.jdField_b_of_type_JavaLangString, false);
        }
      }
      for (;;)
      {
