...
public final class lyu
  implements lyz
{
  public lyu(String paramString1, QQAppInterface paramQQAppInterface, String paramString2, int paramInt, long paramLong, WeakReference paramWeakReference) {}
  ...
  {
    if (paramInt3 == 2) {
      msc.a(paramInt1, paramInt2, this.jdField_a_of_type_Int, this.b);
    }
