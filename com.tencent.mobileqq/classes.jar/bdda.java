...
public class bdda
{
  ...
  public static bdda a(boolean paramBoolean, TianShuAccess.GetAdsRsp paramGetAdsRsp)
  {
  ...
  public static List<bdda> a(boolean paramBoolean, TianShuAccess.GetAdsRsp paramGetAdsRsp, int paramInt)
  {
    int i = 0;
    if ((!paramBoolean) || (paramGetAdsRsp == null)) {
      return null;
    ...
    for (;;)
    {
      ...
      if (paramInt < paramGetAdsRsp.value.lst.size())
      {
        ...
        localObject3 = new bdda();
        ((bdda)localObject3).jdField_a_of_type_JavaLangString = ((String)((Map)localObject2).get("type"));
        ((bdda)localObject3).c = ((String)((Map)localObject2).get("pic"));
        ((bdda)localObject3).b = ((String)((Map)localObject2).get("url"));
        ((bdda)localObject3).jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem = ((TianShuAccess.AdItem)paramGetAdsRsp.value.lst.get(paramInt));
        if (!TextUtils.isEmpty(((bdda)localObject3).c)) {}
      }
      else
      {
        return localObject1;
      ...
      URLDrawable.getDrawable(((bdda)localObject3).c, (URLDrawable.URLDrawableOptions)localObject2).startDownload();
      blbw.a().a(((bdda)localObject3).jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem);
