...
public class apjw
  extends apih
{
  private apkc jdField_a_of_type_Apkc;
  ...
  apjw(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    QLog.i("ArkApp.downloadyyb.module", 1, "init");
    bisa.a();
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadListener = new apjy(this);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramInt < i)
        {
          ...
          localObject1 = bisa.a().b(((DownloadInfo)localObject1).jdField_d_of_type_JavaLangString);
      ...
      if (localArrayList.size() > 0)
      {
        ...
        while (paramInt < localArrayList.size())
        {
          ...
          boolean bool = bgnw.a(paramJSONArray, ((DownloadInfo)localObject2).jdField_e_of_type_JavaLangString);
  ...
  private void a(DownloadInfo paramDownloadInfo, int paramInt)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      bisa.a().b(paramDownloadInfo);
      return;
      bisa.a().a(paramDownloadInfo.jdField_d_of_type_JavaLangString);
      return;
      bisa.a().a(paramDownloadInfo.jdField_d_of_type_JavaLangString, true);
      return;
      ...
      biuh.a("305", paramDownloadInfo.jdField_h_of_type_JavaLangString, paramDownloadInfo.jdField_c_of_type_JavaLangString, paramDownloadInfo.o);
  ...
  private void a(DownloadInfo paramDownloadInfo, boolean paramBoolean, int paramInt)
  {
    ...
    boolean bool1 = bist.d(localBaseActivity);
    boolean bool2 = bist.c(localBaseActivity);
    int i = j;
    if (paramDownloadInfo != null) {
  ...
  private void a(String paramString, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    //   37: ldc_w 277
    //   40: aload 19
    //   42: getstatic 281	bivp:I	Ljava/lang/String;
    //   45: invokevirtual 72	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   48: invokestatic 237	biuh:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   87: aload 19
    //   89: getstatic 287	bivp:j	Ljava/lang/String;
    ...
    //   279: astore 17
    //   281: aload 19
    //   283: getstatic 354	bivp:K	Ljava/lang/String;
    //   286: ldc_w 348
    ...
    //   306: astore 12
    //   308: aload 19
    //   310: getstatic 361	bivp:r	Ljava/lang/String;
    //   313: invokevirtual 87	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   316: invokestatic 329	apjw:a	(I)Z
    //   319: istore 8
    //   321: aload 19
    //   323: ldc_w 363
    ...
    //   445: astore 29
    //   447: aload_0
    //   448: getfield 373	apjw:jdField_a_of_type_Biqv	Lbiqv;
    ...
    //   461: aload 24
    //   463: iload_3
    //   464: invokespecial 378	biqv:<init>	(Ljava/lang/String;Ljava/lang/String;I)V
    //   467: putfield 373	apjw:jdField_a_of_type_Biqv	Lbiqv;
    //   470: invokestatic 29	bisa:a	()Lbisa;
    //   473: aload 22
    //   475: invokevirtual 133	bisa:b	(Ljava/lang/String;)Lcom/tencent/open/downloadnew/DownloadInfo;
    //   478: astore 13
    //   480: aload 13
    //   482: astore_1
    //   483: aload 13
    ...
    //   571: aload_1
    //   572: aload 19
    //   574: getstatic 403	bivp:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   583: aload_1
    //   584: aload 19
    //   586: getstatic 406	bivp:G	Ljava/lang/String;
    ...
    //   658: istore 7
    //   660: sipush 380
    //   663: invokestatic 441	aqmv:b	(I)Laqmp;
    //   666: invokevirtual 446	aqmp:a	()Laqmu;
    //   669: astore 12
    //   671: iload 7
    //   673: istore 6
    //   675: aload 12
    ...
    //   682: istore 6
    //   684: aload 12
    //   686: invokevirtual 451	aqmu:a	()Laqno;
    //   689: ifnull +44 -> 733
    //   692: aload 12
    //   694: invokevirtual 451	aqmu:a	()Laqno;
    //   697: astore 12
    //   699: iload 7
    //   701: istore 6
    //   703: aload 12
    //   705: getfield 455	aqno:c	Ljava/util/ArrayList;
    //   708: ifnull +25 -> 733
    //   711: iload 7
    //   713: istore 6
    //   715: aload 12
    //   717: getfield 455	aqno:c	Ljava/util/ArrayList;
    //   720: aload_0
    //   721: getfield 148	apjw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   748: iconst_1
    //   749: aload_0
    //   750: getfield 148	apjw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   753: aastore
    //   754: dup
    //   755: iconst_2
    //   756: ldc_w 464
    ...
    //   808: iload 6
    //   810: ifeq +120 -> 930
    //   813: invokestatic 484	apqq:a	()Lapqq;
    //   816: aload_0
    //   817: getfield 148	apjw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   820: aload 16
    //   822: aload 14
    //   824: aload 15
    //   826: new 486	apjz
    ...
    //   836: iload 8
    //   838: iload_3
    //   839: invokespecial 489	apjz:<init>	(Lapjw;Ljava/lang/String;Ljava/lang/String;Lcom/tencent/open/downloadnew/DownloadInfo;ZI)V
    //   842: invokevirtual 492	apqq:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)V
    //   845: aload_2
    //   846: iconst_1
    ...
    //   877: goto -569 -> 308
    //   880: aload_0
    //   881: getfield 373	apjw:jdField_a_of_type_Biqv	Lbiqv;
    //   884: aload 16
    //   886: aload 24
    //   888: iload_3
    //   889: invokevirtual 495	biqv:a	(Ljava/lang/String;Ljava/lang/String;I)Z
    //   892: ifeq -422 -> 470
    //   895: ldc 16
    //   897: iconst_1
    //   898: ldc_w 497
    ...
    //   932: iload 8
    //   934: iload_3
    //   935: invokespecial 198	apjw:a	(Lcom/tencent/open/downloadnew/DownloadInfo;ZI)V
    //   938: goto -93 -> 845
    //   941: astore 13
    //   943: goto -348 -> 595
  ...
  public void Destruct()
  {
    ...
    this.jdField_a_of_type_Apkc = null;
  ...
  {
    if (!apgt.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.YYB_DOWNLOAD"))
    {
    ...
    do
    {
      ...
      {
        if (this.jdField_a_of_type_Apkc == null)
        {
    ...
    if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1))
    {
      ...
      this.jdField_a_of_type_Apkc = new apjx(this);
