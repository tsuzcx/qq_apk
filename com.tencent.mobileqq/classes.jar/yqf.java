...
public class yqf
{
  ...
  public yqf(BaseChatPie paramBaseChatPie, PlusPanel paramPlusPanel)
  {
  ...
  public yqv a()
  {
    return this.jdField_a_of_type_Yqv;
  }
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel != null) && (this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.a()))
    {
      ...
      akwk.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "GiftPanel_flower", false);
    }
  }
  
  public void a(int paramInt)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioPlusPanel == null) || (paramInt != this.jdField_a_of_type_ComTencentMobileqqActivityAioPlusPanel.a) || (this.jdField_a_of_type_Yqv == null)) {
      return;
    }
    long l1 = System.currentTimeMillis();
    long l2 = this.jdField_a_of_type_Yqv.jdField_a_of_type_Long;
    if ((this.jdField_a_of_type_Yqv.jdField_a_of_type_Boolean) && (l1 >= this.jdField_a_of_type_Yqv.jdField_a_of_type_Long) && (l1 <= l2 + 2592000000L) && (!((bcju)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(113)).a())) {}
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Yqv != null))
    {
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    akwk.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "GiftPanel_flower", true);
    ...
    {
      label175:
      this.jdField_a_of_type_Yqv = yqv.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, i, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.b);
      label219:
      label233:
      Object localObject2;
      if (this.jdField_a_of_type_Yqv != null)
      {
        this.jdField_a_of_type_ComTencentBizTroopgiftTroopGiftPanel.setGiftData(this.jdField_a_of_type_Yqv, true);
        a(paramInt, i);
      ...
      for (localObject1 = "#878B99";; localObject1 = "#000000")
      {
        ...
        return;
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agkt))
        {
        ...
        if (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agqq)) {
          break;
        }
