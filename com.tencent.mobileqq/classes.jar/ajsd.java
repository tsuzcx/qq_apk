...
public abstract interface ajsd
{
  ...
  static
  {
    ...
    bh = bbvj.a(aV + "/Tencent/QQ_Favorite/");
    bi = bbvj.a(aV + "/Tencent/QQ_CameraEmo/");
    bj = aV + "/DCIM/Camera/";
    bk = bbvj.a(aV + "/Tencent/QQ_Collection/");
    bl = bbvj.a(aV + "/Tencent/QQfile_recv/");
    bm = bl + ".thumbnails/";
    bn = bl + ".tmp/";
    bo = bl + ".trooptmp/";
    bp = aV + "/Tencent/QQ_Secretfile/";
    bq = bbvj.a(aV + "/Tencent/QQ_Video/");
    br = aV + "/Tencent/QQfile_share/";
    bs = aV + "/Tencent/QQHomework_recv/";
    bt = aV + "/Tencent/QQHomework_attach/";
    bu = aW + "Troop_reward/";
    bv = bbvj.a(aW + "ar_cloud_img/");
    bw = bbvj.a(aW + "ar_cloud_marker_feature/");
    bx = bbvj.a(aW + "ar_cloud_marker_config/");
    by = bbvj.a(aW + "ar_cloud_marker_model/");
    bz = bbvj.a(aW + "ARRelationShip/");
    bA = bbvj.a(aW + "ar_cloud_transfer/");
    bB = bbvj.a(aW + "qqmusic/");
    bC = aW + "pe";
    bD = aW + "poke";
    bE = aW + "newpoke";
    ...
    for (String str = aW;; str = "/sdcard/Android/data/com.tencent.mobileqq/files/Tencent/MobileQQ/")
    {
      ...
      bM = bG + "_dhd/";
      bN = bG + "_SSOhd/";
      bO = bbvj.a(bF + ".starHead/");
      bP = bbvj.a(bF + ".pendant/");
      bQ = aW + ".secmsgPic/";
      bR = bbvj.a(aW + ".emotionsm/");
      bS = aW + ".emoQFace/";
      bT = bbvj.a(aW + ".diy/");
      bU = bbvj.a(aW + ".indivAnim/");
      bV = bbvj.a(new StringBuilder().append(aW).append("pddata/vas/").toString()) + "individual_sign/";
      bW = bV + "stickers/";
      ...
      ca = aW + "device/";
      cb = aW + "location/";
      cc = bbvj.a(aW + "system_background/");
      ...
      cj = cc + "resource/";
      ck = aW + "turnbrand/";
      cl = bbvj.a(aW + "Scribble/");
      cm = bbvj.a(aW + ".profilecard" + "/");
      cn = aW + "card/";
      co = aW + "card/starfans/";
      ...
      cF = cE + "animation/";
      cG = bbvj.a(cx + "preload/");
      cH = bbvj.a(cx + "preimg/");
      cI = aV + "/DCIM/Video/";
      cJ = aV + ajya.a(2131700613);
      cK = aV + ajya.a(2131700614);
      cL = aV + "/Camera/Video/";
