  ...
  extends BaseAdapter
{
  ...
  public ajsd(QQAppInterface paramQQAppInterface, Context paramContext, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, ChatHistoryC2CLinkFragment paramChatHistoryC2CLinkFragment, ajwf paramajwf)
  {
    ...
    this.jdField_a_of_type_Ajwf = paramajwf;
    this.jdField_a_of_type_JavaTextSimpleDateFormat = new SimpleDateFormat("M月d日");
    this.jdField_a_of_type_Anvk = ((anvk)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.getActivity().app.getManager(QQManagerFactory.FRIENDS_MANAGER));
  }
        ...
        if ((paramAbsShareMsg instanceof StructMsgForGeneralShare))
        {
          ...
          if (paramAbsShareMsg.mStructMsgItemLists != null)
          {
            ...
            if (!paramAbsShareMsg.mStructMsgItemLists.isEmpty())
            {
              ...
              if (((bdnv)localObject2).jdField_a_of_type_JavaUtilArrayList == null) {
                break label248;
              }
              localObject1 = paramAbsShareMsg;
              if (((bdnv)localObject2).jdField_a_of_type_JavaUtilArrayList.isEmpty()) {
                break label248;
              }
              localObject2 = ((bdnv)localObject2).jdField_a_of_type_JavaUtilArrayList.iterator();
              localObject1 = paramAbsShareMsg;
              label176:
              do
              {
                ...
                paramAbsShareMsg = (bdnu)((Iterator)localObject2).next();
                if (!paramString.equals("cover")) {
                  break label206;
                }
  ...
  private void a(ajsi paramajsi, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          a(ajsi.a(paramajsi), (String)localObject);
          i = 1;
          if (i == 0) {
            ajsi.a(paramajsi).setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130850492));
          }
          str1 = a(ajwg.a(paramMessageRecord));
          if (!(paramMessageRecord instanceof MessageForArkApp)) {
            break label300;
          }
          str2 = ((MessageForArkApp)paramMessageRecord).getTitle();
          localTextView = ajsi.a(paramajsi);
          localObject = str2;
          ...
          ajsi.b(paramajsi).setText((CharSequence)localObject);
          ajsi.c(paramajsi).setText(ContactUtils.getFriendShowName(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.getActivity().app, paramMessageRecord.senderuin));
          ajsi.a(paramajsi).setOnClickListener(new ajsf(this, str1, paramajsi, paramMessageRecord));
          if (!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.c) {
            break label312;
          }
          ajsi.a(paramajsi).setVisibility(0);
          bool = this.jdField_a_of_type_Ajwf.a(paramMessageRecord);
          ajsi.a(paramajsi).setChecked(bool);
          paramMessageRecord = (LinearLayout.LayoutParams)ajsi.a(paramajsi).getLayoutParams();
          ...
          ajsi.a(paramajsi).setLayoutParams(paramMessageRecord);
          return;
        }
      ...
      continue;
      label300:
      ajsi.a(paramajsi).setText(str1);
      continue;
      label312:
      ajsi.a(paramajsi).setVisibility(8);
      paramMessageRecord = (LinearLayout.LayoutParams)ajsi.a(paramajsi).getLayoutParams();
  ...
  public static void a(ImageView paramImageView, String paramString)
  {
    ...
    Drawable localDrawable = localBaseApplication.getResources().getDrawable(2130850492);
    ...
    try
    {
      ...
      paramString.setTag(bgxc.b(localLayoutParams.width, localLayoutParams.height, UIUtils.dip2px(localBaseApplication, 6.0F)));
  ...
  private void a(String paramString)
  {
    ...
    if (bool2)
    {
      ...
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AC87", "0X800AC87", 5, 0, "1", "2", "", "");
    }
    for (;;)
    {
      ...
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AC87", "0X800AC87", 5, 0, "1", "1", "", "");
    }
  }
  ...
  public void a(URLImageView paramURLImageView, AbsShareMsg paramAbsShareMsg)
  {
    ...
    for (paramAbsShareMsg = Uri.fromFile(new File((String)localObject1)).toString();; paramAbsShareMsg = (AbsShareMsg)localObject1)
    {
      ...
      paramAbsShareMsg.setTag(bgxc.b(((ViewGroup.LayoutParams)localObject1).width, ((ViewGroup.LayoutParams)localObject1).height, UIUtils.dip2px(this.jdField_a_of_type_AndroidContentContext, 6.0F)));
      paramAbsShareMsg.setDecodeHandler(bgxc.j);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localObject2 instanceof MessageForStructing))
    {
      ...
      if ((paramView != null) && ((paramView.getTag() instanceof ajsh)))
      {
        localObject1 = (ajsh)paramView.getTag();
        ((ajsh)localObject1).jdField_a_of_type_JavaLangObject = localObject2;
        ((ajsh)localObject1).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.d;
        if (!(localObject2 instanceof MessageForStructing)) {
          break label402;
        }
        ...
        if ((((MessageForStructing)localObject2).structingMsg != null) && ((((MessageForStructing)localObject2).structingMsg instanceof AbsShareMsg)))
        {
          ...
          a(((ajsh)localObject1).jdField_a_of_type_ComTencentImageURLImageView, (AbsShareMsg)localObject3);
          ((ajsh)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(a((AbsShareMsg)localObject3, "title"));
          ...
          ((ajsh)localObject1).b.setText((CharSequence)localObject3);
          ...
          ((ajsh)localObject1).c.setText((CharSequence)localObject3);
        }
        label207:
        if (!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.c) {
          break label425;
        }
        ((ajsh)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(0);
        ((ajsh)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setChecked(this.jdField_a_of_type_Ajwf.a(localObject2));
      }
      for (;;)
      {
        EventCollector.getInstance().onListGetView(paramInt, paramView, paramViewGroup, getItemId(paramInt));
        return paramView;
        localObject1 = new ajsh(this);
        paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131558917, null);
        ((ajsh)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131376269));
        ((ajsh)localObject1).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131378122));
        ((ajsh)localObject1).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131378120));
        ((ajsh)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363771));
        ((ajsh)localObject1).b = ((TextView)paramView.findViewById(2131371658));
        ((ajsh)localObject1).c = ((TextView)paramView.findViewById(2131365410));
        paramView.setTag(localObject1);
        ((ajsh)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(localObject1);
        ((ajsh)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        break;
        label402:
        ((ajsh)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText("");
        ((ajsh)localObject1).b.setText("");
        break label207;
        label425:
        ((ajsh)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(8);
      }
    }
    ...
    {
      if ((paramView != null) && ((paramView.getTag() instanceof ajsi))) {
        localObject1 = (ajsi)paramView.getTag();
      }
      for (;;)
      {
        a((ajsi)localObject1, (MessageRecord)localObject2);
        break;
        paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558856, null);
        localObject1 = new ajsi(this, paramView);
        paramView.setTag(localObject1);
      }
    }
    ...
    {
      if ((paramView == null) || (!(paramView.getTag() instanceof ajsg))) {
        break label633;
      }
      localObject1 = (ajsg)paramView.getTag();
      label576:
      localObject3 = ((ajsg)localObject1).jdField_a_of_type_AndroidWidgetCheckBox;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      ((ajsg)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText((String)localObject2);
      localObject1 = paramView;
      paramView = (View)localObject1;
      break;
      label633:
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558855, null);
      localObject1 = new ajsg();
      ((ajsg)localObject1).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131369395));
      ((ajsg)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378820));
      paramView.setTag(localObject1);
      paramView.setOnClickListener(new ajse(this, (ajsg)localObject1));
      break label576;
    }
  }
}
