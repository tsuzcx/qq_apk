...
public class wyl
{
  ...
  public wyl(long paramLong1, long paramLong2)
  {
  ...
  private boolean a()
  {
    try
    {
      ...
      this.jdField_a_of_type_Wyq = new wyq(null, "MediaCodecGLFrameFetcher");
    }
    ...
    this.jdField_a_of_type_Wyq.b(new MediaCodecGLFrameFetcher.2(this));
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_Wyp = new wyp();
    this.jdField_a_of_type_Wyp.a(true);
    this.jdField_a_of_type_Wyp.a();
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Wyp.a());
    this.f = wyk.a(this.c, this.d);
  }
  
  private void d()
  {
    f();
    this.jdField_a_of_type_Wyq.b(new MediaCodecGLFrameFetcher.3(this));
  }
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture.setOnFrameAvailableListener(new wym(this));
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Wyq.b(new MediaCodecGLFrameFetcher.1(this));
      this.jdField_a_of_type_Wyq.a();
      this.jdField_a_of_type_Wyq = null;
    }
    h();
