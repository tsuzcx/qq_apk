  ...
  implements Manager
{
  ...
  public afnl(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(AcsMsg paramAcsMsg)
  {
      ...
      do
      {
        for (;;)
        {
          ...
          try
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.d("ActivateFriends.Manager", 2, "setAlarmTimer at " + afmj.a(l, "yyyyMMdd HH:mm:ss") + " msg: " + (String)localObject1 + " alarmId: " + i);
            }
            ...
            ((Intent)localObject2).putExtra("msg_id", afmn.a(paramAcsMsg));
    ...
    QLog.d("ActivateFriends.Manager", 2, "has already setAlarmTimer at " + afmj.a(l, "yyyyMMdd HH:mm:ss"));
  }
