...
public class ywq
  extends Handler
{
  public ywq(QRLoginAuthActivity paramQRLoginAuthActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramMessage)
      {
        ...
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(this.a.getString(2131716174, new Object[] { this.a.e }));
        if (TextUtils.isEmpty(this.a.f)) {
          this.a.f = this.a.getString(2131719379);
        }
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(this.a.getString(2131716180, new Object[] { this.a.f }));
        if (!this.a.jdField_a_of_type_Boolean) {
          break label730;
        }
      }
      this.a.jdField_b_of_type_AndroidWidgetButton.setVisibility(0);
      bcef.b(null, "dc00898", "", "", "0X800A46D", "0X800A46D", yyg.a(this.a.jdField_b_of_type_Int), 0, "", "", "", "");
      return;
      if (k == 32) {
        i = j;
      }
      for (;;)
      {
        ...
        for (;;)
        {
          try
          {
            ...
            if (this.a.jdField_a_of_type_Bhht.isShowing()) {
