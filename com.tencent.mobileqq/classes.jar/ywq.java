  ...
  extends PublicBaseFragment
{
  ...
  protected ywq()
  {
    ...
    this.jdField_a_of_type_Ytb = new ywt(this);
  }
  
  public static void a(Activity paramActivity, JSONObject paramJSONObject, Class<? extends ywq> paramClass)
  {
    if ((paramActivity == null) || (paramJSONObject == null))
    {
      yxs.b("GdtBaseBannerFragment", "start error");
      return;
    }
    yxs.b("GdtBaseBannerFragment", "start");
    ...
    abtu.a(paramActivity, paramJSONObject, PublicFragmentActivityForTool.class, paramClass);
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      paramBundle = (qq_ad_get.QQAdGet)qq_ad_get.QQAdGet.class.cast(yxr.a(new qq_ad_get.QQAdGet(), paramBundle));
    ...
    catch (JSONException paramLayoutInflater)
    {
      for (;;)
      {
        yxs.d("GdtBaseBannerFragment", "createParams error", paramLayoutInflater);
      }
    }
    paramLayoutInflater = new Button(getActivity());
    paramLayoutInflater.setText("load");
    paramLayoutInflater.setOnClickListener(new ywr(this));
    paramViewGroup = new Button(getActivity());
    paramViewGroup.setText("show");
    paramViewGroup.setOnClickListener(new yws(this));
