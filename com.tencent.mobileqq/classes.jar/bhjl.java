...
public class bhjl
{
  ...
  public static int a;
  private static bhjq jdField_a_of_type_Bhjq;
  ...
  private static final String c = anzj.a(2131713507);
  
  static
  {
    jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(false);
    jdField_a_of_type_Bhjq = new bhjq();
  ...
  public static String a(Context paramContext, Uri paramUri, String paramString1, String paramString2)
  {
    ...
    //   28: aload_2
    //   29: aload_3
    //   30: invokestatic 149	bhjl:a	(Landroid/content/Context;Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
  ...
  public static void a(Context paramContext, bhjo parambhjo, agjk paramagjk)
  {
    jdField_a_of_type_Bhjq.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    jdField_a_of_type_Bhjq.jdField_a_of_type_Agjk = paramagjk;
    parambhjo.a(paramagjk);
    parambhjo.a(new bhjn());
  }
  ...
  {
    if ((paramSessionInfo.jdField_a_of_type_Int != 1) && (paramSessionInfo.jdField_a_of_type_Int != 3000) && (paramSessionInfo.jdField_a_of_type_Int != 0) && (!adak.e(paramSessionInfo.jdField_a_of_type_Int)))
    {
    ...
    paramViewGroup.setOnDragListener(new bhjm(localImageView, localColorDrawable1, paramViewGroup, localColorDrawable2, paramContext, paramQQAppInterface, paramSessionInfo));
  }
  ...
  private static bhjp b(Context paramContext, aggl paramaggl)
  {
    long l = 0L;
    Object localObject1;
    if ((paramaggl instanceof ahos))
    {
      localObject1 = auoo.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramaggl.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
      l = bhmi.a((String)localObject1);
      paramaggl = paramaggl.jdField_a_of_type_AndroidViewView;
    }
    for (;;)
    {
      label76:
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1))
      {
        ...
        if ((paramaggl instanceof ahou))
        {
          localObject1 = auoo.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramaggl.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
          l = bhmi.a((String)localObject1);
          paramaggl = ((ahou)paramaggl).a;
          continue;
        }
        if ((paramaggl instanceof ahbj))
        {
          localObject2 = (MessageForPic)paramaggl.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject3 = ((MessageForPic)localObject2).getBiggestFilePath();
          String str = aunj.a((String)localObject3);
          int i = bmgb.a((String)localObject3);
          localObject1 = ".jpg";
          if (i == 1001) {
            localObject1 = ".png";
          }
          for (;;)
          {
            ...
            if ((!bhmi.d(((MessageForPic)localObject2).getBiggestFilePath(), (String)localObject1)) || (TextUtils.isEmpty(str))) {
              break label76;
            }
            l = ((MessageForPic)localObject2).size;
            paramaggl = ((ahbj)paramaggl).a;
            break;
            if (i == 1005) {
              localObject1 = ".bmp";
            } else if (i == 2000) {
        ...
        if ((paramaggl instanceof ahrh))
        {
          localObject2 = (MessageForShortVideo)paramaggl.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject1 = ShortVideoUtils.a((MessageForShortVideo)localObject2, "mp4");
          l = ((MessageForShortVideo)localObject2).videoFileSize;
          paramaggl = ((ahrh)paramaggl).a;
          continue;
        }
        if ((paramaggl instanceof ahrx))
        {
          localObject2 = (MessageForShortVideo)paramaggl.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject1 = ShortVideoUtils.a((MessageForShortVideo)localObject2, "mp4");
          l = ((MessageForShortVideo)localObject2).videoFileSize;
          paramaggl = ((ahrx)paramaggl).a;
        }
      }
      else
      {
        ...
        return new bhjp((File)localObject2, paramaggl, ClipData.newUri(paramContext.getContentResolver(), "uri", (Uri)localObject1));
      }
      paramaggl = null;
      localObject1 = null;
    }
  ...
  private static boolean b(DragEvent paramDragEvent, ImageView paramImageView, ColorDrawable paramColorDrawable1, ViewGroup paramViewGroup, ColorDrawable paramColorDrawable2, Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    paramImageView = new ReportProgressDialog(paramContext, 2131755824);
    paramImageView.setCancelable(true);
    paramImageView.setContentView(2131559572);
    ((TextView)paramImageView.findViewById(2131372578)).setText(anzj.a(2131713506));
