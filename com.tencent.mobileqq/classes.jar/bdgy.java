  ...
  implements Handler.Callback
{
  ...
  public static bdgy a()
  {
    ...
    localbdgy.a(0);
    bdjn.b(0, localbdgy, jdField_b_of_type_ArrayOfInt).step();
    ...
    try
    {
      ...
      jdField_a_of_type_Boolean = false;
      bdjn.b(13, localbdgy, null).step();
      if (BaseApplicationImpl.sProcessId == 2)
      {
        bdjn.b(11, localbdgy, null).step();
        bdjn.b(40, localbdgy, null).step();
        ThreadManager.post(bdjn.b(0, localbdgy, jdField_l_of_type_ArrayOfInt), 10, null, false);
        bdjn.b(0, localbdgy, jdField_k_of_type_ArrayOfInt).step();
      }
      for (;;)
      {
        return null;
        ...
        {
          bdjn.b(0, localbdgy, r).step();
        }
        else if ((BaseApplicationImpl.sProcessId == 5) || (BaseApplicationImpl.sProcessId == 7))
        {
          bdjn.b(11, localbdgy, null).step();
          bdjn.b(8, localbdgy, null).step();
          bdjn.b(0, localbdgy, jdField_i_of_type_ArrayOfInt).step();
          bdjn.b(12, localbdgy, null).step();
          bdjn.b(47, localbdgy, null).step();
          if (BaseApplicationImpl.sProcessId == 7) {
            bdjn.b(49, localbdgy, null).step();
          }
        }
        ...
        else if (!BaseApplicationImpl.processName.endsWith(":qqfav"))
        {
          ...
          {
            ThreadManager.excute(bdjn.b(0, localbdgy, jdField_a_of_type_ArrayOfInt), 16, null, false);
          }
          else
          {
      ...
      if (BaseApplicationImpl.processName.endsWith(":troopbar"))
      {
        bdjn.b(12, localbdgy, null).step();
        bdjn.b(11, localbdgy, null).step();
        bdjn.b(14, localbdgy, null).step();
      }
      for (;;)
      {
        if (BaseApplicationImpl.processName.endsWith(":troophomework")) {
          bdjn.b(38, localbdgy, null).step();
        }
        if (!BaseApplicationImpl.processName.endsWith(":live")) {
          break;
        }
        bdjn.b(48, localbdgy, null).step();
        break;
        bdjn.b(0, localbdgy, jdField_j_of_type_ArrayOfInt).step();
      }
    }
        ...
        if (!str1.isEmpty())
        {
          ...
          if (arrayOfString.length > 0)
          {
            ...
            if (i1 < i3)
            {
              ...
              aohp.jdField_a_of_type_JavaUtilSet.add(Integer.valueOf(Integer.parseInt(str2)));
              i1 += 1;
              continue;
            }
          }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ThreadManager.getSubThreadHandler().postAtFrontOfQueue(bdjn.b(10, this, null));
      if (jdField_a_of_type_Int == 1) {
        ThreadManager.getSubThreadHandler().post(bdjn.b(22, this, null));
      }
    }
  ...
  private void a(int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt)
  {
    ...
    paramArrayOfInt1 = bdjn.b(0, this, paramArrayOfInt1);
    if (paramArrayOfInt2 != null)
    {
      this.jdField_f_of_type_Int = 2;
      this.jdField_g_of_type_Int = paramInt;
      paramArrayOfInt1.setResultListener(this.jdField_b_of_type_AndroidOsHandler, 10);
      paramArrayOfInt2 = bdjn.b(0, this, paramArrayOfInt2);
  ...
  private void b(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {
      localTextView.setText(2131693289);
    }
    for (;;)
    {
      ...
      return;
      localTextView.setText(anvx.a(2131713731));
    }
  }
  ...
  public void a(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission == null) {
        this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission = ((CheckPermission)bdjn.b(3, this, null));
      }
    ...
    if (this.jdField_e_of_type_Int == 2)
    {
      if (1 == BaseApplicationImpl.sProcessId) {
        ThreadManager.getFileThreadHandler().postDelayed(bdjn.b(14, this, null), 1000L);
      }
      a(11, 1, 5L);
      a(3);
    }
    ...
    for (paramObject = (AppActivity)paramObject;; paramObject = null)
    {
      ...
      if (paramObject == null)
      {
        ...
        if (this.jdField_e_of_type_Int == 1)
        {
          ...
          {
            paramObject = o;
            bdjn.b(0, this, paramObject).step();
            aauu.f();
        ...
        for (;;)
        {
          ...
          if (this.jdField_e_of_type_Int == 2)
          {
            bdjn.b(0, this, jdField_m_of_type_ArrayOfInt).step();
            a(101);
          }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramIntent = (SetSplash)bdjn.b(2, this, null);
          paramIntent.step();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      for (;;)
      {
        return true;
        a(4, 0, 300L);
        bool1 = bdjn.b(13, this, null).step();
        ...
        if (this.jdField_a_of_type_MqqAppAppActivity != null)
        {
          ...
          if (this.jdField_a_of_type_MqqAppAppActivity != null)
          {
            bhht.a(this.jdField_a_of_type_MqqAppAppActivity, "com.tencent.mobileqq.activity.MainActivity");
            bhht.a(this.jdField_a_of_type_MqqAppAppActivity, SplashActivity.class.getName());
            return true;
            ...
            this.jdField_a_of_type_Bdgz.a(this);
            if (this.jdField_a_of_type_Long > 0L) {
      ...
      bdjn.b(29, this, null).step();
      return true;
    } while (this.jdField_a_of_type_Bdgz.jdField_a_of_type_Boolean);
