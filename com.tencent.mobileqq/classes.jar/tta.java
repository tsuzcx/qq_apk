...
{
  public tta(SoundAndVibrateActivity paramSoundAndVibrateActivity) {}
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      SoundAndVibrateActivity.a(this.a).setBackgroundResource(2130838635);
    ...
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
        SoundAndVibrateActivity.b(this.a).setBackgroundResource(2130838623);
        SoundAndVibrateActivity.b(this.a).setVisibility(0);
      }
      if (k == 2131230720)
      {
        SoundAndVibrateActivity.b(this.a).setRightIcon(this.a.getResources().getDrawable(2130846279));
        ...
        if (AppSetting.b)
        {
          SoundAndVibrateActivity.b(this.a).setContentDescription(this.a.getString(2131435242) + this.a.getString(2131437129));
          SoundAndVibrateActivity.c(this.a).setContentDescription(this.a.getString(2131435243) + this.a.getString(2131437130));
          SoundAndVibrateActivity.d(this.a).setContentDescription(this.a.getString(2131435244) + this.a.getString(2131437130));
          SoundAndVibrateActivity.e(this.a).setContentDescription(this.a.getString(2131435245) + this.a.getString(2131437130));
        }
        if (this.a.app.a() != 0) {
          break label1252;
        }
      ...
      for (i = j;; i = 0)
      {
        ...
        if (k == 2131230721)
        {
          ...
          SoundAndVibrateActivity.c(this.a).setRightIcon(this.a.getResources().getDrawable(2130846279));
          SoundAndVibrateActivity.d(this.a).setRightIcon(null);
          SoundAndVibrateActivity.e(this.a).setRightIcon(null);
          ...
          SoundAndVibrateActivity.b(this.a).setContentDescription(this.a.getString(2131435242) + this.a.getString(2131437130));
          SoundAndVibrateActivity.c(this.a).setContentDescription(this.a.getString(2131435243) + this.a.getString(2131437129));
          SoundAndVibrateActivity.d(this.a).setContentDescription(this.a.getString(2131435244) + this.a.getString(2131437130));
          SoundAndVibrateActivity.e(this.a).setContentDescription(this.a.getString(2131435245) + this.a.getString(2131437130));
          break;
        }
        if (k == SoundAndVibrateActivity.jdField_a_of_type_Int)
        {
          SoundAndVibrateActivity.b(this.a).setRightIcon(null);
          SoundAndVibrateActivity.c(this.a).setRightIcon(null);
          SoundAndVibrateActivity.d(this.a).setRightIcon(this.a.getResources().getDrawable(2130846279));
          SoundAndVibrateActivity.e(this.a).setRightIcon(null);
          ...
          SoundAndVibrateActivity.b(this.a).setContentDescription(this.a.getString(2131435242) + this.a.getString(2131437130));
          SoundAndVibrateActivity.c(this.a).setContentDescription(this.a.getString(2131435243) + this.a.getString(2131437130));
          SoundAndVibrateActivity.d(this.a).setContentDescription(this.a.getString(2131435244) + this.a.getString(2131437129));
          SoundAndVibrateActivity.e(this.a).setContentDescription(this.a.getString(2131435245) + this.a.getString(2131437130));
          break;
        }
        ...
        SoundAndVibrateActivity.c(this.a).setRightIcon(null);
        SoundAndVibrateActivity.d(this.a).setRightIcon(null);
        SoundAndVibrateActivity.e(this.a).setRightIcon(this.a.getResources().getDrawable(2130846279));
        ...
        SoundAndVibrateActivity.c(this.a).setContentDescription(this.a.getString(2131435243) + this.a.getString(2131437130));
        SoundAndVibrateActivity.d(this.a).setContentDescription(this.a.getString(2131435244) + this.a.getString(2131437130));
        SoundAndVibrateActivity.e(this.a).setContentDescription(this.a.getString(2131435245) + this.a.getString(2131437129));
        break;
        label1252:
        this.a.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setChecked(true);
        break label423;
        SoundAndVibrateActivity.a(this.a).setBackgroundResource(2130838623);
