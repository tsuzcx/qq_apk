...
public class apab
{
  ...
  private apab(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList)
  {
  ...
  private apab(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, long paramLong)
  {
  ...
  private apab(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2)
  {
    this(paramQQAppInterface, paramList);
  ...
  public static apab a(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, long paramLong)
  {
    return new apab(paramQQAppInterface, paramList, paramLong);
  }
  
  public static apab a(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2)
  {
    return new apab(paramQQAppInterface, paramList, paramString1, paramString2, paramString3, paramString4, paramInt1, paramInt2);
  }
  ...
  public apab a(String paramString)
  {
  ...
  public apab a(String paramString, Uri paramUri)
  {
    this.jdField_a_of_type_AndroidContentContentValues.clear();
    this.jdField_a_of_type_AndroidContentContentValues.put("data1", paramString);
    a(paramUri);
  ...
  public apab b(String paramString)
  {
    this.jdField_a_of_type_AndroidContentContentValues.clear();
    ...
    this.jdField_a_of_type_AndroidContentContentValues.put("data3", alud.a(2131702906));
    a();
    return this;
  }
}
