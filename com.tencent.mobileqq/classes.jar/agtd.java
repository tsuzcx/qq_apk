...
{
  public agtd(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
  ...
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    case 2131367094: 
      ...
      yns.a(localMessageForTroopStory, paramContext);
  ...
  {
    if ((paramaglx != null) && ((paramaglx.jdField_a_of_type_ComTencentMobileqqDataChatMessage instanceof MessageForTroopStory)))
    {
      localObject = (MessageForTroopStory)paramaglx.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
    ...
    {
      return;
      if ((!paramaglx.jdField_a_of_type_Boolean) && (ShortVideoUtils.ShortVideoPlayConfig.sAutoPlayInAIO))
      {
        a(paramaglx, ((MessageForTroopStory)localObject).thumbUrl, ((MessageForTroopStory)localObject).storyId, ((MessageForTroopStory)localObject).uniseq, true);
        return;
      }
    ...
    if (((MessageForTroopStory)localObject).istroop == 1)
    {
      ...
      wmu.a(this.jdField_b_of_type_AndroidContentContext, (OpenPlayerBuilder.Data)localObject, paramaglx.jdField_a_of_type_ComTencentMobileqqActivityAioItemQQStoryItemBuilder$StoryChatVideoView);
      return;
    }
    Object localObject = new OpenPlayerBuilder(new VidListPlayInfo(((MessageForTroopStory)localObject).storyId), 1007);
    wmu.a(this.jdField_b_of_type_AndroidContentContext, ((OpenPlayerBuilder)localObject).a(), paramaglx.jdField_a_of_type_ComTencentMobileqqActivityAioItemQQStoryItemBuilder$StoryChatVideoView);
  }
  ...
  public void a(aglx paramaglx, long paramLong, int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    ...
    if ((paramaglx.jdField_a_of_type_ComTencentMobileqqDataChatMessage.istroop == 1) && ((paramaglx.jdField_a_of_type_ComTencentMobileqqDataChatMessage instanceof MessageForTroopStory)) && (!bfth.a().a(paramaglx.jdField_a_of_type_ComTencentMobileqqDataChatMessage, "aio_msg|play_msg_obj")))
    {
      bfth.a().a(paramaglx.jdField_a_of_type_ComTencentMobileqqDataChatMessage, "aio_msg|play_msg_obj");
      xwa.a("aio_msg", "play_msg_obj", 0, 0, new String[] { "", "", "", ((MessageForTroopStory)paramaglx.jdField_a_of_type_ComTencentMobileqqDataChatMessage).storyId });
    }
  }
  
  public void a(View paramView)
  {
    paramView = (MessageForTroopStory)((aglx)AIOUtils.getHolder(paramView)).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
    ...
    localbjnw.a(new agte(this, paramView, localbjnw));
    localbjnw.show();
  }
  ...
  public void a(ViewGroup paramViewGroup, ChatMessage paramChatMessage)
  {
    ...
    if (TextUtils.isEmpty(paramChatMessage.sourceName))
    {
      if (localaglx.jdField_a_of_type_AndroidWidgetFrameLayout != null) {
        localaglx.jdField_a_of_type_AndroidWidgetFrameLayout.setVisibility(8);
      }
      localaglx.b.setVisibility(8);
      ...
      a(localaglx.jdField_a_of_type_ComTencentMobileqqActivityAioItemQQStoryItemBuilder$StoryChatVideoView, paramChatMessage.thumbUrl, this.c, this.d, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    ...
    do
    {
      ...
      paramViewGroup = (FrameLayout.LayoutParams)localaglx.c.getLayoutParams();
      if (bool) {}
      for (paramViewGroup.leftMargin = BaseChatItemLayout.k;; paramViewGroup.leftMargin = (DisplayUtil.dip2px(this.jdField_b_of_type_AndroidContentContext, localaglx.jdField_a_of_type_ComTencentMobileqqActivityAioItemQQStoryItemBuilder$StoryChatVideoView.a) + BaseChatItemLayout.j))
      {
        localaglx.c.setLayoutParams(paramViewGroup);
        localaglx.c.setText(paramChatMessage.sourceName);
        localaglx.jdField_a_of_type_AndroidWidgetFrameLayout.setVisibility(0);
        break;
      }
    ...
    localaglx.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setImageDrawable(null);
    a(localaglx.jdField_a_of_type_ComTencentMobileqqActivityAioItemQQStoryItemBuilder$StoryChatVideoView, paramChatMessage.thumbUrl, this.c, this.d, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
    a(localaglx, paramChatMessage.thumbUrl, paramChatMessage.storyId, paramChatMessage.uniseq, false);
    localaglx.jdField_a_of_type_ComTencentMobileqqActivityAioItemQQStoryItemBuilder$StoryChatVideoView.setTag(Long.valueOf(paramChatMessage.uniseq));
  }
  ...
  public bgbb[] a(View paramView)
  {
    ...
    paramView = (aglx)AIOUtils.getHolder(paramView);
  ...
  public void b(aglx paramaglx)
  {
    try
    {
      paramaglx = (MessageForTroopStory)paramaglx.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
      if (QLog.isColorLevel()) {
        QLog.d("Q.qqstory.share", 2, "storyMsg onSourceOnClick:" + paramaglx.toString() + ", sourceType = " + paramaglx.sourceActionData + ", sourceActionData = " + paramaglx.sourceActionData);
      }
      if ("plugin".equals(paramaglx.sourceActionType))
      {
        paramaglx = bfwg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_AndroidContentContext, paramaglx.sourceActionData);
        if (paramaglx != null) {
          paramaglx.a();
        }
      }
    ...
    catch (Exception paramaglx)
    {
      ...
      QLog.w("Q.qqstory.share", 2, "storyMsg onSourceOnClick exp:", paramaglx);
    }
  }
}
