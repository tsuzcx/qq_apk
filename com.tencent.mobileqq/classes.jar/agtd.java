  ...
  implements Manager
{
  ...
  public agtd(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Agtb = ((agtb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(341));
  }
  ...
  public static boolean a(String paramString)
  {
    ...
    Object localObject1 = (agtd)((QQAppInterface)localObject1).getManager(343);
    if ((localObject1 == null) || (((agtd)localObject1).a() == null))
    {
      localObject1 = null;
    ...
    {
      return bool;
      localObject1 = ((agtd)localObject1).a().activityPrefix;
      break;
    }
  }
  ...
  {
    if ((baip.a(paramString)) || (paramString.length() < 2) || (paramArrayList == null) || (paramArrayList.isEmpty())) {
      return false;
    }
  ...
  public int a()
  {
    if (this.jdField_a_of_type_Agtb != null) {
      return this.jdField_a_of_type_Agtb.b();
    }
    return 0;
  }
  ...
  public long a(long paramLong)
  {
    ...
    {
      Object localObject = (agti)alzw.a().a(540);
      if ((localObject == null) || (((agti)localObject).jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat == null) || (((agti)localObject).jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.size() == 0))
      {
      ...
      int i = ((agti)localObject).jdField_a_of_type_Int;
      int j = i;
      if (i <= 0) {
        j = 60;
      }
      SparseArrayCompat localSparseArrayCompat = ((agti)localObject).jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat;
  ...
  public SpringFestivalRedpacketConfBean.HtmlOfflineCheckConfig a()
  {
    if (this.jdField_a_of_type_Agtb != null)
    {
      SpringFestivalRedpacketConfBean localSpringFestivalRedpacketConfBean = this.jdField_a_of_type_Agtb.a();
  ...
  {
    return (SpringFestivalRedpakcetPreviewConfBean)alzw.a().a(548);
  }
  ...
  public String a()
  {
    if (this.jdField_a_of_type_Agtb != null)
    {
      Object localObject = this.jdField_a_of_type_Agtb.a();
      if (localObject != null)
      {
  ...
  {
    if (this.jdField_a_of_type_Agtb != null) {
      return this.jdField_a_of_type_Agtb.a();
    }
    return -1;
  }
