  ...
  implements afqw
{
  ...
  static
  {
    ...
    c = (int)(localDisplayMetrics.widthPixels - bhdz.a(localBaseApplication, 40.0F) * 2.0F - BaseChatItemLayout.t - BaseChatItemLayout.u - i * 2 - bhdz.a(localBaseApplication, 10.0F));
    if (c > 640) {
      c = 640;
    }
    d = c * 9 / 16;
  ...
  {
    if (paramInt1 == 0) {
      return new asbe(BaseApplicationImpl.getApplication().getResources(), null, paramInt2, paramInt3, -921103);
    }
    Object localObject;
    if (paramInt1 == 1) {
    ...
    for (;;)
    {
      if ((localObject instanceof SkinnableBitmapDrawable))
      {
        ...
        return new asbe(BaseApplicationImpl.getApplication().getResources(), (Bitmap)localObject, paramInt2, paramInt3, -921103);
        if (paramInt1 == 2) {
  ...
  /* Error */
  public static Drawable a(Context paramContext, bfjs parambfjs, MessageForTroopFile paramMessageForTroopFile)
  {
    // Byte code:
    //   0: aload_1
    //   1: getfield 126	bfjs:d	Ljava/lang/String;
    //   4: astore 8
    //   6: aload_1
    //   7: getfield 128	bfjs:a	Ljava/lang/String;
    //   10: ifnull +80 -> 90
    //   13: aload_1
    //   14: getfield 128	bfjs:a	Ljava/lang/String;
    //   17: astore_2
    //   18: aload_2
    ...
    //   62: ifeq +730 -> 792
    //   65: getstatic 30	ahkv:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   68: aload 8
    ...
    //   93: goto -75 -> 18
    //   96: aload_1
    //   97: getfield 128	bfjs:a	Ljava/lang/String;
    //   100: ifnull +692 -> 792
    //   103: new 163	java/io/File
    //   106: dup
    //   107: aload_1
    //   108: getfield 128	bfjs:a	Ljava/lang/String;
    ...
    //   129: invokestatic 183	ahkv:a	(II)[I
    //   132: astore_2
    //   133: aload_0
    //   134: aload_2
    //   135: iconst_0
    ...
    //   192: astore_0
    //   193: getstatic 30	ahkv:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   196: aload 8
    //   198: aload_0
    ...
    //   222: astore_2
    //   223: getstatic 30	ahkv:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   226: aload 8
    ...
    //   267: aload_0
    //   268: invokestatic 225	bheg:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   271: pop
    //   272: aload_0
    ...
    //   320: iload 5
    //   322: iload 4
    //   324: invokestatic 183	ahkv:a	(II)[I
    //   327: astore_0
    //   328: aload_0
    //   329: iconst_0
    //   330: iaload
    ...
    //   494: iload 4
    //   496: iload 5
    //   498: invokestatic 279	bheg:b	(Landroid/graphics/Bitmap;FII)Landroid/graphics/Bitmap;
    ...
    //   512: aload_1
    //   513: astore_0
    //   514: getstatic 30	ahkv:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   517: aload 8
    //   519: aload 9
    ...
    //   576: invokestatic 299	ahkv:a	(III)Landroid/graphics/drawable/Drawable;
    //   579: astore_0
    //   580: aload_0
    //   581: areturn
    //   582: astore_0
    ...
    //   586: iload 4
    //   588: iload 5
    //   590: invokestatic 299	ahkv:a	(III)Landroid/graphics/drawable/Drawable;
    //   593: astore_2
    ...
    //   655: iload 4
    //   657: iload 5
    //   659: invokestatic 299	ahkv:a	(III)Landroid/graphics/drawable/Drawable;
    //   662: astore 8
    //   664: aload_1
    //   665: astore_0
  ...
  {
    return auea.a(((MessageForTroopFile)paramChatMessage).fileName) == 0;
  }
  
  public static boolean c(ChatMessage paramChatMessage)
  {
    paramChatMessage = (MessageForTroopFile)paramChatMessage;
    return ((paramChatMessage.width == 0) || (paramChatMessage.height != 0)) || (auea.a(paramChatMessage.fileName) == 2);
  }
  ...
  public View a(int paramInt1, int paramInt2, ChatMessage paramChatMessage, View paramView, ViewGroup paramViewGroup, aftk paramaftk)
  {
    ...
    this.jdField_a_of_type_Atfn.a(paramViewGroup, paramView, paramChatMessage);
    return paramView;
  }
  
  public View a(ViewGroup paramViewGroup, ChatMessage paramChatMessage)
  {
    ahkw localahkw = (ahkw)paramViewGroup.getTag();
    if (localahkw.jdField_c_of_type_AndroidViewView != null) {
      localahkw.jdField_c_of_type_AndroidViewView.setVisibility(0);
    }
    if (localahkw.jdField_d_of_type_AndroidViewView != null) {
      localahkw.jdField_d_of_type_AndroidViewView.setVisibility(8);
    }
    if (localahkw.jdField_a_of_type_AndroidViewView != null)
    {
      ViewGroup.LayoutParams localLayoutParams = localahkw.jdField_a_of_type_AndroidViewView.getLayoutParams();
      localLayoutParams.width = BaseChatItemLayout.z;
      localLayoutParams.height = -2;
      localahkw.jdField_a_of_type_AndroidViewView.setLayoutParams(localLayoutParams);
    }
    for (;;)
    {
      a(localahkw, paramViewGroup, paramChatMessage);
      if (jdField_e_of_type_Boolean) {}
      try
      {
        localahkw.jdField_b_of_type_JavaLangStringBuilder.append(localahkw.jdField_a_of_type_AndroidWidgetTextView.getText()).append(" ");
        localahkw.jdField_b_of_type_JavaLangStringBuilder.append(localahkw.jdField_b_of_type_AndroidWidgetTextView.getText());
        localahkw.jdField_b_of_type_JavaLangStringBuilder.append(localahkw.jdField_c_of_type_AndroidWidgetTextView.getText());
        localahkw.jdField_b_of_type_JavaLangStringBuilder.append("按钮");
        paramViewGroup.setContentDescription(localahkw.jdField_b_of_type_JavaLangStringBuilder.toString());
  ...
  {
    paramChatMessage = (ahkw)paramafqr;
  ...
  protected MessageForTroopFile a(View paramView)
  {
    ...
    if (paramView.a.isMultiMsg) {
      return (MessageForTroopFile)auea.a(paramView.a);
    }
  ...
  public String a(ChatMessage paramChatMessage)
  {
    if (bhfj.a(paramChatMessage.issend)) {
      return anvx.a(2131714679);
    }
    return anvx.a(2131714683);
  }
  
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage) {}
  
  public void a(ahkw paramahkw, ViewGroup paramViewGroup, ChatMessage paramChatMessage)
  {
    if (paramahkw.jdField_d_of_type_AndroidWidgetTextView == null)
    {
      paramahkw.jdField_d_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
      paramahkw.jdField_d_of_type_AndroidWidgetTextView.setBackgroundResource(2130842656);
      paramahkw.jdField_d_of_type_AndroidWidgetTextView.setTextSize(1, 12.0F);
      paramahkw.jdField_d_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167363));
      paramahkw.jdField_d_of_type_AndroidWidgetTextView.setText(2131696949);
      paramahkw.jdField_d_of_type_AndroidWidgetTextView.setSingleLine();
      paramahkw.jdField_d_of_type_AndroidWidgetTextView.setGravity(16);
      paramahkw.jdField_d_of_type_AndroidWidgetTextView.setPadding(DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 5.0F), 0, DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 5.0F), 0);
      paramahkw.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      ...
      paramViewGroup.addView(paramahkw.jdField_d_of_type_AndroidWidgetTextView, localLayoutParams);
    }
    paramahkw.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
    if (paramChatMessage.isSend())
    {
      paramViewGroup = (RelativeLayout.LayoutParams)paramahkw.jdField_d_of_type_AndroidWidgetTextView.getLayoutParams();
      ...
      paramahkw.jdField_d_of_type_AndroidWidgetTextView.setLayoutParams(paramViewGroup);
      return;
    }
    paramViewGroup = (RelativeLayout.LayoutParams)paramahkw.jdField_d_of_type_AndroidWidgetTextView.getLayoutParams();
  ...
  void a(View paramView, boolean paramBoolean)
  {
    ...
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_files", "", "AIOchat", "Clk_filesbubble", 0, 0, paramView.frienduin + "", "", "", "");
    bfjs localbfjs = bgke.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForTroopFile);
    if (localbfjs.b == 12) {
      bgjc.a(localActivity, String.format(localActivity.getString(2131697057), new Object[] { bgke.a(localbfjs.g) }), 1);
    }
    do
    {
      return;
    ...
    aufd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramView, l, localbfjs, localMessageForTroopFile.senderuin, localMessageForTroopFile.lastTime, 3, 3, null, false, false);
  }
  ...
  public void a(ChatMessage paramChatMessage, Context paramContext, BaseChatItemLayout paramBaseChatItemLayout, afqr paramafqr, int paramInt1, int paramInt2)
  {
    ...
    boolean bool1 = b(paramChatMessage);
    boolean bool2 = c(paramChatMessage);
    if ((!bool1) && (!bool2) && (paramafqr.jdField_a_of_type_AndroidViewView != null))
    {
      if (paramChatMessage.isSend()) {
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      else if (!ahkw.class.isInstance(localObject))
      {
        QLog.e("TroopFileItemBuilder", 1, "item click holder tag class[" + localObject.getClass().getName() + "] is not Holder");
      }
      else
      {
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A68A", "0X800A68A", 0, 0, "4", "", "", "");
        localObject = (ahkw)localObject;
        localObject = a(paramView);
        if ((!b((ChatMessage)localObject)) && (!c((ChatMessage)localObject)) && ((!((MessageForTroopFile)localObject).isMultiMsg) || (auea.a((ChatMessage)localObject, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext))))
        {
          a(paramView, false);
