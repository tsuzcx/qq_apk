...
public class oqi
{
  ...
  public static boolean a(Context paramContext)
  {
    ...
    for (int j = 1;; j = 0)
    {
      if ((i == 0) || (j == 0) || (!bgnt.g(paramContext))) {
        break label45;
      }
      return true;
      i = 0;
  ...
  public static boolean a(AdvertisementInfo paramAdvertisementInfo, ProteusBannerVideoItemData paramProteusBannerVideoItemData, Context paramContext, int paramInt)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        paramAdvertisementInfo = pha.d();
        if (QLog.isColorLevel()) {
          QLog.d("ReadInJoyAdSwitchUtil", 2, " isADVideoAutoPlayFlag adFlag = " + paramInt + " kandianVideoAutoPlaySetting = " + paramAdvertisementInfo);
        }
        if (pha.e.equals(paramAdvertisementInfo)) {
          break;
        }
        if (!pha.c.equals(paramAdvertisementInfo)) {
          break label184;
        }
        if (paramInt == 0) {
          break;
        }
        if ((paramInt != 1) || (paramContext == null) || ((!rvr.a(paramContext)) && (!a(paramContext)))) {
          break label166;
        }
        return true;
        if (paramInt == 2)
      ...
      if ((paramInt == 2) && (paramContext != null) && (bgnt.g(paramContext))) {
        return true;
      }
    } while ((!pha.d.equals(paramAdvertisementInfo)) || (paramInt == 0));
    if ((paramInt == 1) && (paramContext != null) && ((rvr.a(paramContext)) || (a(paramContext)))) {
      return true;
    }
    if ((paramInt == 2) && (paramContext != null) && (rvr.a(paramContext))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
  ...
  public static boolean d(VideoAdInfo paramVideoAdInfo)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      oqh.a("isADVideoDownloadProgress", bool);
      if (i != 1) {
        break;
      }
      return true;
