  ...
  extends aksu
{
  ...
  public aslw(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public static MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte)
  {
    ...
    if (((Long)((Pair)localObject2).first).longValue() != 4294967295L)
    {
      ...
      if (((!axau.c(k)) && (k != 208) && (k != 529)) || (!paramArrayOfByte.c2c_cmd.has())) {
        break label554;
      }
    ...
    for (;;)
    {
      ...
      {
        axaq.a(localMessageHandler, localArrayList, localMsg);
        break label1259;
        int m = axaq.a(localMsg);
        ...
        if (paramArrayOfByte.hasNext())
        {
          ...
          Object localObject1;
          ((MessageRecord)localObject2).vipBubbleID = akfv.a((int)localObject1, m);
          ...
          axaq.a(localMessageHandler, localArrayList, localMsg, true, false, null);
          continue;
          label554:
          ...
          if (!paramQQAppInterface.a().a().a(localArrayList, localMsg)) {
            axaq.a(localMessageHandler, localArrayList, localMsg, false, false, null);
          }
                ...
                if (((im_msg_body.Elem)localObject2).anon_group_msg.has())
                {
                  ...
                  for (;;)
                  {
                    try
                    {
                      ...
                      {
                        localObject2 = "";
                        localMessageRecord.saveExtInfoToExtStr("anonymous", myb.a(i, paramArrayOfByte, (String)localObject2, j, m, str));
          ...
          axaq.a(localMessageHandler, localMsg, localArrayList);
          break label1296;
          label972:
    ...
    for (;;)
    {
      ...
      do
      {
        if (ajsd.z.equals(Long.valueOf(l3)))
        {
          ((MessageRecord)localObject2).istroop = 6000;
          break label452;
        }
        if (ajsd.A.equals(Long.valueOf(l3)))
        {
        ...
        break label452;
        akas.a(localArrayList);
        if (localArrayList.size() > 0) {
          return (MessageRecord)localArrayList.get(0);
        }
        asoi.a("MsgBackup_msgproxy", "transToMessageRecord failed.........", new Object[0]);
        return null;
        break label303;
        break label303;
        do
  ...
  public static msg_comm.MsgHead a(MessageRecord paramMessageRecord, long paramLong)
  {
    ...
    Object localObject = akpx.c(paramMessageRecord);
    for (;;)
    {
      try
      {
  ...
  public static im_msg_body.MsgBody a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    if ((paramMessageRecord.msgtype == -1000) || (paramMessageRecord.msgtype == -10000)) {
      if (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("sens_msg_source_msg_info"))) {
        paramQQAppInterface = axaq.a(paramMessageRecord);
      }
    }
    label965:
    for (;;)
    {
      if ((paramQQAppInterface != null) && (!paramQQAppInterface.elems.isEmpty()))
      {
        ...
        if (myb.a(paramMessageRecord))
        {
          ...
          ((im_msg_body.AnonymousGroupMsg)localObject2).uint32_flags.set(localmyc.jdField_a_of_type_Int);
          if (!TextUtils.isEmpty(localmyc.jdField_a_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject2).str_anon_id.set(ByteStringMicro.copyFrom(localmyc.jdField_a_of_type_JavaLangString.getBytes()));
          }
          if (!TextUtils.isEmpty(localmyc.jdField_b_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject2).str_anon_nick.set(ByteStringMicro.copyFrom(localmyc.jdField_b_of_type_JavaLangString.getBytes()));
          }
          ((im_msg_body.AnonymousGroupMsg)localObject2).uint32_head_portrait.set(localmyc.jdField_b_of_type_Int);
          ((im_msg_body.AnonymousGroupMsg)localObject2).uint32_expire_time.set(localmyc.jdField_c_of_type_Int);
          if (!TextUtils.isEmpty(localmyc.jdField_c_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject2).str_rank_color.set(ByteStringMicro.copyFrom(localmyc.jdField_c_of_type_JavaLangString.getBytes()));
          }
        ...
        paramQQAppInterface = axaq.a((MessageForText)paramMessageRecord);
        continue;
        if (paramMessageRecord.msgtype == -1049)
        {
          paramQQAppInterface = axaq.a((MessageForReplyText)paramMessageRecord);
          continue;
        }
        ...
        {
          paramQQAppInterface = axaq.a((MessageForQQStoryComment)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2000)
        {
          paramQQAppInterface = axaq.a((MessageForPic)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -5008)
        {
          paramQQAppInterface = axaq.a((MessageForArkApp)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5016)
        {
          paramQQAppInterface = axaq.c((MessageForArkBabyqReply)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5017)
        {
          paramQQAppInterface = axaq.b((MessageForArkApp)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5013)
        {
          paramQQAppInterface = axaq.c((MessageForArkFlashChat)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -5014)
        {
          paramQQAppInterface = axaq.d((MessageForHiBoom)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2011)
        {
          paramQQAppInterface = axaq.a((MessageForStructing)paramMessageRecord);
        ...
        if (paramMessageRecord.msgtype == -1035)
        {
          ...
          while (i < k)
          {
            ...
            {
              localObject1 = axaq.a((MessageForText)localObject1);
        ...
        {
          paramQQAppInterface = axaq.a((MessageForLongTextMsg)paramMessageRecord, false);
          continue;
        }
        ...
        else
        {
          ...
          {
            paramQQAppInterface = axaq.a((MessageForMarketFace)paramMessageRecord);
            continue;
          }
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    catch (Throwable paramQQAppInterface)
    {
      for (;;)
      {
        ...
        axpu.a(paramQQAppInterface, "MsgBackup_msgproxy,mr = " + paramMessageRecord.getClass().getSimpleName());
        paramQQAppInterface = null;
      }
  ...
  public MessageRecord a(@NonNull MsgBackupMsgEntity paramMsgBackupMsgEntity)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject4 = new azml();
        ((azml)localObject4).jdField_a_of_type_Int = asoi.c(paramMsgBackupMsgEntity.chatType);
        localMessageHandler = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        localObject5 = axaq.a(localMessageHandler, localMsg, String.valueOf(l5), String.valueOf(l4));
        if (((Long)((Pair)localObject5).first).longValue() != 4294967295L)
        {
          l1 = ((Long)((Pair)localObject5).first).longValue();
          break label1564;
          localObject5 = new ArrayList();
          if (((!axau.c(i1)) && (i1 != 208) && (i1 != 529)) || (!((msg_comm.MsgHead)localObject2).c2c_cmd.has())) {
            break label827;
          }
          ...
          if (i1 == 208)
          {
            axaq.a(localMessageHandler, (List)localObject5, localMsg);
            l1 = l3;
          }
          int m = 0;
          int i2 = axaq.a(localMsg);
          ...
          Object localObject1;
          ((MessageRecord)localObject4).vipBubbleID = akfv.a((int)localObject1, i2);
      ...
      axaq.a(localMessageHandler, (List)localObject5, localMsg, true, false, (azml)localObject4);
      continue;
      label827:
      ...
      if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((ArrayList)localObject5, localMsg)) {
        axaq.a(localMessageHandler, (List)localObject5, localMsg, false, false, (azml)localObject4);
      }
            ...
            if (((im_msg_body.Elem)localObject4).anon_group_msg.has())
            {
              ...
              for (;;)
              {
                try
                {
                  ...
                  {
                    localObject4 = "";
                    localMessageRecord.saveExtInfoToExtStr("anonymous", myb.a(i, (String)localObject2, (String)localObject4, j, k, str));
                    localMessageRecord.extLong |= 0x3;
                  }
                  else
                  {
      ...
      axaq.a(localMessageHandler, localMsg, (List)localObject5);
      break label1603;
    ...
    for (;;)
    {
      ...
      do
      {
        if (ajsd.z.equals(Long.valueOf(l5))) {
  ...
  public MsgBackupMsgEntity a(@NonNull MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      {
        asoi.a("transBackupEntity error,mr = %s ", paramMessageRecord.toString(), new Object[0]);
        return null;
      }
    }
    catch (Throwable localThrowable)
    {
      ...
      {
        QLog.e("MsgBackup_msgproxy", 1, "transToBackupEntity,getMsgBody error mr = " + paramMessageRecord.getClass().getSimpleName());
        axpu.a(localThrowable, "MsgBackup_msgproxy,mr = " + paramMessageRecord.getClass().getSimpleName());
        localObject2 = null;
      }
      localMsg.msg_head.set(localMsgHead);
      ...
      ((MsgBackupMsgEntity)localObject2).chatType = asoi.b(paramMessageRecord.istroop);
      ((MsgBackupMsgEntity)localObject2).msgType = asoi.a(paramMessageRecord.msgtype);
    ...
    if (paramMessageRecord.istroop == 3000)
    {
      ...
      paramMessageRecord = asll.a(i);
      if (paramMessageRecord != null) {
        break label402;
      }
      paramMessageRecord = localMsg.toByteArray();
      asll.a(paramMessageRecord);
    }
    label363:
    ...
    {
      return localObject2;
      i = axau.b(paramMessageRecord.msgUid);
