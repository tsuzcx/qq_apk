...
public class albx
{
  public static int a(String paramString)
  {
    try
    {
      int i = albz.a("arfeature", "v8.0.0", albz.b("arfeature", "v8.0.0", "arfeature"), paramString);
      return i;
    }
    finally
    {
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        albz.a("arfeature", "v8.0.0", "arfeature", paramString2);
        try
        {
          albv.a(paramString1, albz.a("arfeature", "v8.0.0", albz.b("arfeature", "v8.0.0", "arfeature")));
          paramString2 = albz.a("arfeature", "v8.0.0", albz.b("arfeature", "v8.0.0", "arfeature")) + File.separator + "md5_config.xml";
        ...
        catch (IOException paramString2)
        {
          ...
          String str;
          i = -6;
          bbdx.a(albz.a("arfeature", "v8.0.0", albz.b("arfeature", "v8.0.0", "arfeature")), false);
      ...
      try
      {
        ...
        {
          paramString1 = albz.a("arfeature", "v8.0.0", albz.b("arfeature", "v8.0.0", "arfeature")) + File.separator + (String)((Map.Entry)localObject).getKey() + ".so";
          albz.a("arfeature", "v8.0.0", "libARFeature", (String)((Map.Entry)localObject).getValue());
        }
  ...
  {
    return new File(albz.a("arfeature", "v8.0.0", albz.b("arfeature", "v8.0.0", "arfeature")) + File.separator + "libARFeature" + ".so").exists();
  }
}
