  ...
  extends mns
{
  ...
  public mnu(SharedPreferences paramSharedPreferences, mns parammns)
  {
    super(paramSharedPreferences, parammns);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(50);
    this.jdField_a_of_type_AndroidOsHandler = new mnv(this, Looper.getMainLooper());
  }
  ...
  public int a(String paramString1, String paramString2)
  {
    if (!a())
    {
      int i = this.jdField_a_of_type_Mns.a(paramString1, paramString2);
      if ((a(i)) || (!b(i))) {
        return i;
      }
    }
    ...
    do
    {
      ...
      while (!((Iterator)localObject).hasNext())
      {
        do
        {
          ...
          } while (!mkw.b((String)localObject, str));
    ...
    } while (!mkw.b((String)((Iterator)localObject).next(), paramString2));
    return a(true, false);
  ...
  {
    if (!a()) {
      return this.jdField_a_of_type_Mns.a();
    }
  ...
  public String a(android.content.SharedPreferences.Editor paramEditor, String paramString)
  {
    ...
    //   244: aload_0
    //   245: getfield 32	mnu:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   248: aload_2
    ...
    //   667: pop
    //   668: getstatic 302	mkw:a	[Ljava/lang/String;
    //   671: astore 11
    //   673: aload 11
    //   675: arraylength
    //   676: istore 4
  ...
  public JSONArray a(String paramString)
  {
    Object localObject1;
    if (!a()) {
      localObject1 = this.jdField_a_of_type_Mns.a(paramString);
    }
    do
    {
      for (;;)
  ...
  public JSONObject a()
  {
    ...
    if (!a()) {
      localJSONObject = this.jdField_a_of_type_Mns.a();
    }
    String str;
    do
    {
  ...
  public boolean a()
  {
    ((mnt)this.jdField_a_of_type_Mns).b();
    return !this.jdField_a_of_type_Mns.a();
  }
  ...
  {
    if (!a()) {
      return this.jdField_a_of_type_Mns.b();
    }
  ...
  {
    if (!a()) {
      return this.jdField_a_of_type_Mns.c();
    }
