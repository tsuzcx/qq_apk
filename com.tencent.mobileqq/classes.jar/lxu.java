...
public class lxu
  extends lwz
{
  public lxu(QQServiceForAV paramQQServiceForAV) {}
  ...
  private void a(IBinder paramIBinder)
  {
    ...
    {
      lbd.g("QQServiceForAV", "linkToVideoProcessDeath");
      QQServiceForAV.jdField_a_of_type_AndroidOsIBinder = paramIBinder;
    }
    try
    {
      QQServiceForAV.jdField_a_of_type_AndroidOsIBinder.linkToDeath(new lxw(this), 0);
      return;
    }
    catch (RemoteException paramIBinder)
    {
      QQServiceForAV.jdField_a_of_type_AndroidOsIBinder = null;
      lbd.h("QQServiceForAV", "linkToVideoProcessDeath exception msg = " + paramIBinder.getMessage());
    }
  }
  
  public int a()
  {
    return ((awyz)((QQAppInterface)this.a.a()).getManager(QQManagerFactory.CONTACT_MANAGER)).d();
  }
  ...
  public int a(int paramInt, String paramString)
  {
    ...
    {
      int i = bhfy.a(localQQAppInterface, bool, paramString);
  ...
  {
    paramString = ((antp)((QQAppInterface)this.a.a()).getManager(QQManagerFactory.DISCUSSION_MANAGER)).a(paramString);
    long l = 0L;
    if (paramString != null) {
  ...
  public Bitmap a(int paramInt, String paramString1, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      if (paramString2 == null)
      {
        ...
        localQQAppInterface.addObserver(this.a.jdField_a_of_type_Anvi);
      }
      if ((paramString2 == null) && (paramBoolean2))
      {
        ...
        if (paramInt == 1)
        {
          ...
          continue;
          paramString2 = (BitmapDrawable)((antl)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DISCUSSION_HANDLER)).a(paramString1, false);
          if (paramString2 == null) {
            break label581;
          }
      ...
      for (;;)
      {
        ...
        break;
        paramString2 = ((abgm)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(Long.parseLong(paramString1));
        paramString2 = DeviceHeadMgr.getInstance().getDeviceHeadByPID(paramString2.productId);
        break;
        Object localObject = (awyz)localQQAppInterface.getManager(QQManagerFactory.CONTACT_MANAGER);
        if ((localObject != null) && (paramString2 != null)) {}
        for (localObject = ((awyz)localObject).c(paramString2);; localObject = null)
        {
          if (QLog.isColorLevel()) {
          ...
          break;
          paramString2 = baor.a(localQQAppInterface, paramString2);
          break;
          if (paramInt == 3000) {
            return bheg.h();
          }
  ...
  public Bundle a(int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, Bundle paramBundle, ResultReceiver paramResultReceiver)
  {
    ...
    case 4: 
      for (;;)
      {
        ...
        bool1 = bhfy.a("GetInviteFlag", paramResultReceiver, paramArrayOfByte);
        bhfy.a("GetInviteFlag", paramResultReceiver, paramArrayOfByte);
        paramBundle.putBoolean("enableInvite", bool1);
        return paramBundle;
        bhgf.a((QQAppInterface)this.a.a(), paramBundle);
      }
    case 5: 
      return bhgf.a((QQAppInterface)this.a.a(), paramBundle);
    case 6: 
      return bhfy.a((QQAppInterface)this.a.a(), paramBundle.getString("uin"));
    }
    paramArrayOfByte = paramBundle.getString("red_touch_app_id");
    paramBundle.putParcelable("red_touch_red_app_info", bbbt.a(((bbbq)((QQAppInterface)this.a.a()).getManager(QQManagerFactory.MGR_RED_TOUCH)).a(paramArrayOfByte)));
    return paramBundle;
  }
  ...
  public String a(int paramInt, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        if (paramInt == 26)
        {
          paramString1 = baor.a(localQQAppInterface, paramString2);
        }
        else if (paramInt == 25)
        {
        ...
        else if (paramInt == 1)
        {
          if (!TextUtils.isEmpty(paramString2)) {
            paramString1 = ContactUtils.getTroopMemberName(localQQAppInterface, str1, paramString2);
          } else {
            paramString1 = ContactUtils.getTroopName(localQQAppInterface, str1, false);
          }
        }
        else
        {
          ...
          paramString1 = ((abgm)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(Long.parseLong(str1));
          if (paramString1 == null) {
            break label465;
          }
          paramString1 = absz.a(paramString1);
        }
      }
      int i = ContactUtils.getEntry(paramInt);
      if (i == -1) {}
      for (paramString1 = ContactUtils.getNickName(localQQAppInterface, str1, paramInt);; paramString1 = ContactUtils.getDisplayName(localQQAppInterface, str1, paramString2, i, 0))
      {
        ...
        {
          str2 = ContactUtils.getBuddyName(localQQAppInterface, str1, true);
        }
        paramString1 = str2;
        ...
        localObject = (anvk)localQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER);
        str2 = paramString1;
        if (localObject != null)
        {
          localObject = ((anvk)localObject).e(str1);
          str2 = paramString1;
          if (localObject != null) {
            str2 = ContactUtils.getFriendName((Friends)localObject);
          }
        }
        if (!str1.equals(str2))
        {
  ...
  String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    {
      localObject1 = (awyz)paramQQAppInterface.getManager(QQManagerFactory.CONTACT_MANAGER);
      if (localObject1 != null) {}
      for (localObject1 = ((awyz)localObject1).c(str);; localObject1 = null)
      {
        if (localObject1 != null)
        {
        ...
        localObject1 = ContactUtils.getUinByPhoneNum(paramQQAppInterface, str);
        ...
        for (;;)
        {
          ...
          if (paramString1 != null)
          {
            ContactUtils.addUinByPhoneNum(paramQQAppInterface, str, paramString1);
            localObject2 = paramString1;
          }
          if (localObject2 != null)
          {
            paramString1 = (anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER);
            if (paramString1 == null) {
              break label261;
            }
          }
          ...
          {
            if (paramString1 != null) {}
            for (paramString1 = ContactUtils.getFriendName(paramString1);; paramString1 = null)
            {
              if ((paramString1 == null) || (paramString1.equals(localObject2)))
              {
                ...
                paramQQAppInterface.addObserver(this.a.jdField_a_of_type_Anvi);
                paramString1.getFriendInfo((String)localObject2);
                return str;
                label249:
                paramString1 = null;
                break label122;
  ...
  public String a(String paramString)
  {
    ...
    awyz localawyz = (awyz)((QQAppInterface)this.a.a()).getManager(QQManagerFactory.CONTACT_MANAGER);
    if (localawyz == null)
    {
      if (QLog.isColorLevel()) {
  ...
  {
    Object localObject = (asbm)QQServiceForAV.d(this.a).getManager(QQManagerFactory.EARLY_DOWNLOAD_MANAGER);
    if (localObject != null)
    {
      localObject = (ascm)((asbm)localObject).a("qq.android.qav.video");
      if (localObject != null) {
        ((ascm)localObject).a(false);
      }
    }
  }
  ...
  public void a(int paramInt1, long paramLong, int paramInt2, int paramInt3)
  {
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        localQQAppInterface.addObserver(this.a.jdField_a_of_type_Aofu);
        localaoep.a(paramInt1, paramLong);
        return;
      }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    localQQAppInterface1.getMessageFacade().addObserver(this.a);
    if (QLog.isColorLevel()) {
  ...
  {
    ((QQAppInterface)this.a.a()).getAVNotifyCenter().b(paramLong);
  }
  ...
  public void a(long paramLong, String paramString, int paramInt)
  {
    ...
    if (localaoep != null) {
      try
      {
        localaoep.a(paramLong, Long.parseLong(paramString), paramInt);
        return;
      }
  ...
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)this.a.a();
    axqt localaxqt = (axqt)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.NEARBY_CARD_HANDLER);
    localQQAppInterface.addObserver(this.a.jdField_a_of_type_Axqx);
    localaxqt.a(paramString);
  }
  
  public void a(String paramString, int paramInt1, int paramInt2, byte[] paramArrayOfByte)
  {
    ntb.a((QQAppInterface)this.a.a(), new lxv(this, paramString, paramInt2), paramArrayOfByte, paramString, paramInt1, paramInt2);
  }
  
  public void a(String paramString, long paramLong)
  {
    Object localObject = (bggl)((QQAppInterface)this.a.a()).getManager(QQManagerFactory.AIO_ANIMATION_MANAGER);
    if (localObject != null) {
      ((bggl)localObject).a(paramString);
    }
    if ((paramLong > 0L) && ((QQServiceForAV.h(this.a) instanceof QQAppInterface)))
    {
      ...
      localSessionInfo.curFriendUin = paramString;
      localSessionInfo.curType = 1;
      admh.a((QQAppInterface)localObject, localSessionInfo);
    }
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    paramString2.getMessageFacade().addAndSendMessage(localMessageRecord, null);
  }
  ...
  public void a(lwm paramlwm)
  {
    ((lui)QQServiceForAV.b(this.a).getManager(QQManagerFactory.AV_REDPACKET_CONFIG_MGR)).b(paramlwm);
  }
  
  public void a(lwv paramlwv)
  {
    if (paramlwv != null) {
      this.a.jdField_a_of_type_AndroidOsRemoteCallbackList.unregister(paramlwv);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(lwv paramlwv, String paramString)
  {
    if (paramlwv != null)
    {
      this.a.jdField_a_of_type_AndroidOsRemoteCallbackList.register(paramlwv, paramString);
      if (QLog.isColorLevel()) {
        QLog.d("QQServiceForAV", 2, "registerCallback");
      }
      a(paramlwv.asBinder());
      paramlwv = (QQAppInterface)this.a.a();
      paramlwv.mQQServiceRef = null;
      paramlwv.mQQServiceRef = new WeakReference(this.a);
    }
  }
  ...
  public void a(lxb paramlxb)
  {
    ...
    localObject = (anrz)QQServiceForAV.a(this.a).getManager(QQManagerFactory.CONDITION_SEARCH_MANAGER);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQServiceForAV", 2, "getAddressConfig for IQQServiceLocationCallback");
      }
      if (((anrz)localObject).a() == 1)
      {
        if (((anrz)localObject).a(((anrz)localObject).a(), true) == 0)
        {
          if (QQServiceForAV.a(this.a) == null) {
            QQServiceForAV.a(this.a, new lxr(this, (anrz)localObject, paramlxb));
          }
          for (;;)
          {
            ((anrz)localObject).c(QQServiceForAV.a(this.a));
            return;
            QQServiceForAV.a(this.a).a(paramlxb);
          }
        }
        if (QLog.isColorLevel()) {
  ...
  public void a(boolean paramBoolean, lxb paramlxb)
  {
    int i;
    if (paramBoolean) {
      i = 0;
    ...
    try
    {
      for (;;)
      {
        paramlxb.a(i, "admin_region_config");
        return;
        i = -26;
      }
    }
    catch (RemoteException paramlxb)
    {
      while (!QLog.isColorLevel()) {}
      QLog.e("QQServiceForAV", 2, "Call onGetAddressConfig fail", paramlxb);
    }
  }
  ...
  public void a(long[] paramArrayOfLong, String paramString)
  {
    ...
    if (localaoep != null) {
      try
      {
        localaoep.a(paramArrayOfLong, Long.parseLong(paramString));
        return;
      }
  ...
  public boolean a(int paramInt)
  {
    ...
    {
      QQAppInterface localQQAppInterface = (QQAppInterface)this.a.a();
      QQServiceForAV.a(this.a, new mxi(localQQAppInterface));
    }
  ...
  public boolean a(long paramLong)
  {
    ...
    if (localaoep != null) {
      try
      {
        ...
        localQQAppInterface.addObserver(this.a.jdField_a_of_type_Aofu);
        localaoep.a(paramLong, 0L, 2, 0, 0);
        return true;
      }
      catch (Exception localException)
      {
  ...
  {
    return ((anvk)((QQAppInterface)this.a.a()).getManager(QQManagerFactory.FRIENDS_MANAGER)).b(paramString);
  }
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    if (localaoep != null) {
      try
      {
        localaoep.f(paramString, paramBoolean);
        return true;
      }
  ...
  String b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if ((localawyz != null) && (paramString2 != null)) {}
    for (paramString2 = localawyz.c(paramString2);; paramString2 = null)
    {
      if (QLog.isColorLevel()) {
      ...
      paramString2 = ((bapa)paramQQAppInterface.getManager(QQManagerFactory.QCALLCARD_MANAGER)).a(paramString1);
      paramQQAppInterface = (baox)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.QCALLCARD_HANDLER);
      paramQQAppInterface.a(paramString1);
      paramQQAppInterface.a(this.a.jdField_a_of_type_Baoy);
  ...
  public void b(lwm paramlwm)
  {
    ((lui)QQServiceForAV.c(this.a).getManager(QQManagerFactory.AV_REDPACKET_CONFIG_MGR)).a(paramlwm);
  }
  
  public void b(lxb paramlxb)
  {
    if (paramlxb == null) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        if (QQServiceForAV.a(this.a) == null) {
          QQServiceForAV.a(this.a, new lxs());
        }
        QQServiceForAV.a(this.a).a(paramlxb);
        if (QQServiceForAV.a(this.a).a() == 1)
        {
          localQQAppInterface.addObserver(QQServiceForAV.a(this.a));
          ((anxi)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.LBS_HANDLER)).b();
          return;
        }
      } while (!QLog.isColorLevel());
      ...
      try
      {
        paramlxb.a(false, null);
        return;
      }
      catch (RemoteException paramlxb) {}
    } while (!QLog.isColorLevel());
    QLog.e("QQServiceForAV", 2, "Call getUserCurrentLocation fail", paramlxb);
  }
  
  public void b(boolean paramBoolean)
  {
    SharedPreferences localSharedPreferences = bhhr.a(((QQAppInterface)this.a.a()).getApplication().getApplicationContext());
  ...
  public boolean b(String paramString, int paramInt)
  {
    ...
    {
      this.a.jdField_a_of_type_ComTencentMobileqqAppFaceFaceDecoder = new FaceDecoder(localQQAppInterface.getApp().getApplicationContext(), localQQAppInterface);
      this.a.jdField_a_of_type_ComTencentMobileqqAppFaceFaceDecoder.setDecodeTaskCompletionListener(this.a.jdField_a_of_type_ComTencentMobileqqAppFaceFaceDecoder$DecodeTaskCompletionListener);
    }
    if (paramInt == 25) {
      return this.a.jdField_a_of_type_ComTencentMobileqqAppFaceFaceDecoder.requestDecodeQCallFace(paramString, 16, true, false);
    }
    return this.a.jdField_a_of_type_ComTencentMobileqqAppFaceFaceDecoder.requestDecodeStrangeFace(paramString, 200, true, false);
  }
  
  public long[] b(String paramString)
  {
    bggl localbggl = (bggl)((QQAppInterface)this.a.a()).getManager(QQManagerFactory.AIO_ANIMATION_MANAGER);
    if (localbggl != null) {
      return localbggl.a(paramString);
    }
    return null;
  }
  ...
  public String c(String paramString)
  {
    ...
    QQAppInterface localQQAppInterface = (QQAppInterface)this.a.a();
    paramString = ((awyz)QQServiceForAV.e(this.a).getManager(QQManagerFactory.CONTACT_MANAGER)).b(paramString);
    if (paramString == null) {
      return null;
    }
  ...
  public boolean c(String paramString)
  {
    ...
    try
    {
      ...
      bgkf localbgkf = (bgkf)((QQAppInterface)QQServiceForAV.l(this.a)).getManager(QQManagerFactory.TROOP_GAG_MANAGER);
      boolean bool1 = localbgkf.a(paramString, localQQAppInterface.getCurrentAccountUin());
      boolean bool2 = localbgkf.a(paramString);
      boolean bool3 = localbgkf.b(paramString);
      paramString = localbgkf.a(paramString);
  ...
  public String d(String paramString)
  {
    ...
    localObject2 = ((anvk)QQServiceForAV.f(this.a).getManager(QQManagerFactory.FRIENDS_MANAGER)).b(paramString);
    if (localObject2 != null)
    {
    ...
    for (localObject1 = (String)((BusinessCard)localObject1).mobilesNum.get(0);; localObject1 = null)
    {
      ...
      localObject3 = (PhoneContactManagerImp)QQServiceForAV.g(this.a).getManager(QQManagerFactory.CONTACT_MANAGER);
  ...
  {
    ((bbbq)((QQAppInterface)this.a.a()).getManager(QQManagerFactory.MGR_RED_TOUCH)).b(paramString);
  }
  ...
  public boolean d()
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)this.a.a();
    if (QQServiceForAV.a(this.a) == null) {
      QQServiceForAV.a(this.a, new lxf(localQQAppInterface));
    }
    boolean bool = bdee.a(localQQAppInterface, localQQAppInterface.getApplication().getApplicationContext(), QQServiceForAV.a(this.a));
    if (QLog.isColorLevel()) {
  ...
  {
    bbbq localbbbq = (bbbq)((QQAppInterface)this.a.a()).getManager(QQManagerFactory.MGR_RED_TOUCH);
    localbbbq.b(localbbbq.a(paramString), "");
  }
  
  public boolean e()
  {
    if (QQServiceForAV.a(this.a) == null) {
      QQServiceForAV.a(this.a, new lxt(this.a));
    }
    bnku.a().a(bnkt.c, QQServiceForAV.a(this.a), false);
    if (QLog.isDevelopLevel()) {
  ...
  public boolean i()
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)this.a.a();
    ncz localncz = null;
    if (localQQAppInterface.isCreateManager(QQManagerFactory.AV_GAME_MANAGER)) {
      localncz = (ncz)localQQAppInterface.getManager(QQManagerFactory.AV_GAME_MANAGER);
    }
    if (localncz != null) {}
    for (boolean bool = localncz.a();; bool = false)
    {
      if (QLog.isColorLevel()) {
        QLog.i("QQServiceForAV", 2, "isInAVGameRoom, isAvGameRoomExist[" + bool + "], avGameManager[" + localncz + "]");
      }
      return bool;
    }
  }
