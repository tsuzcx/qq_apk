...
public class rox
  implements View.OnClickListener, rhp
{
  ...
  public rox(Context paramContext, ViewGroup paramViewGroup)
  {
    this.jdField_a_of_type_Akjc = new roy(this);
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new rpa(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewViewGroup = paramViewGroup;
    this.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378336));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378335));
    ...
    try
    {
      ...
      ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).addObserver(this.jdField_a_of_type_Akjc);
      b(false, -1, -1);
  ...
  private static void a(String paramString1, String paramString2)
  {
    ...
    noo.a(null, "", paramString1, paramString1, 0, 0, str, "", "", paramString2, false);
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      return;
      if (!TextUtils.isEmpty(amvm.a().jdField_a_of_type_JavaLangString))
      {
        a(false, -1, -1);
        QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        if (this.jdField_a_of_type_Akja == null) {
          this.jdField_a_of_type_Akja = new akja(localQQAppInterface);
        }
        this.jdField_a_of_type_Akja.a(localQQAppInterface, 10);
      }
    }
  }
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131719099);
    ...
    do
    {
      ...
      localObject1 = awvv.a("kFTSReadInJoySearchPlaceholderPrefix");
      if (!paramBoolean) {
        break;
      }
      ...
      ((ObjectAnimator)localObject2).addListener(new roz(this, (String)localObject1));
      jdField_a_of_type_Int += 1;
      awso.a(null, new ReportModelDC02528().module("hot_list").action("exp_default_word").ver2(awso.a(25)).ver4(this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.title));
      localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      if (this.jdField_a_of_type_Akja == null) {
        this.jdField_a_of_type_Akja = new akja((QQAppInterface)localObject1);
      }
      this.jdField_a_of_type_Akja.a((QQAppInterface)localObject1, "exp_default_word", this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$HotSearchItem.title, awso.a(25), null);
    ...
    if (paramInt1 == 0)
    {
      localObject1 = "1";
      label476:
      awso.a(null, ((ReportModelDC02528)localObject2).ver1((String)localObject1).obj3(paramInt2 + ""));
      localObject2 = onk.a();
    }
    try
    {
      ((onr)localObject2).a("channelid", paramInt2 + "");
      if (paramInt1 != 0) {
        break label743;
      }
      localObject1 = "1";
      label551:
      ((onr)localObject2).a("refresh_way", (String)localObject1);
    }
    ...
    a("0X800A4C5", ((onr)localObject2).a());
  ...
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    amvl localamvl = amvm.a();
    this.jdField_a_of_type_Akja = null;
    if (!TextUtils.isEmpty(localamvl.jdField_a_of_type_JavaLangString))
    {
  ...
  {
    this.jdField_b_of_type_Boolean = false;
    ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).removeObserver(this.jdField_a_of_type_Akjc);
  ...
  public void onClick(View paramView)
  {
    ...
    for (paramView = this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchEntryDataModel$GIFInfo;; paramView = null)
    {
      ...
      {
        awso.a(localQQAppInterface, localReportModelDC02528.ver1(paramView).ver7("{experiment_id:" + awso.jdField_b_of_type_JavaLangString + "}"));
        awso.a(null, 0, 25, "0X8009D15", 0, 0, null, null);
        return;
      }
    }
  }
