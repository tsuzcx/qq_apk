  ...
  implements azcq
{
  ...
  axiy(SVHwEncoder paramSVHwEncoder, SessionInfo paramSessionInfo, int paramInt)
  {
  ...
  {
    azds.z = this.jdField_c_of_type_Int;
    azds.y = this.jdField_b_of_type_Int;
    Object localObject = new EncodeThread(null, new axiz(Looper.getMainLooper()), paramString, null, null);
    ((EncodeThread)localObject).run();
    localObject = ((EncodeThread)localObject).jdField_a_of_type_JavaLangString;
    bddw.a(this.jdField_a_of_type_JavaLangString, "CompoundProcessor.compressYUV2MP4", "[peak] videoFileDir = " + paramString + ",videoPath = " + (String)localObject + ",CodecParam.mRecordFrames = " + azds.z + ",CodecParam.mRecordTime = " + azds.y);
    return localObject;
  }
  
  public void a()
  {
    bddw.a(this.jdField_a_of_type_JavaLangString, "CompoundProcessor.cancelEncode", "[peak]  CompoundProcessor");
  ...
  public void a(int paramInt)
  {
    try
    {
      bddw.a(this.jdField_a_of_type_JavaLangString, "CompoundProcessor.rollBack", "[peak] delReason = " + paramInt);
      a(1, paramInt);
      a();
      return;
    }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 1) {
      localaxje.a().a(this.jdField_a_of_type_JavaLangString);
    }
    localaxje.a(101, paramInt1, localBundle);
    bddw.a(this.jdField_a_of_type_JavaLangString, "CompoundProcessor.cancelPreupload", "[peak] cancelType  = " + paramInt1 + ",cancleReason = " + paramInt2);
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    localaxje.a(100, -1, localBundle);
    bddw.a(this.jdField_a_of_type_JavaLangString, "segment", "CompoundProcessor.svSegmentOK [peak] index = " + paramInt1 + ",path = " + paramString + ",width = " + paramInt2 + ",height = " + paramInt3);
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, long paramLong, int paramInt3, boolean paramBoolean)
  {
    for (;;)
    {
      try
      {
        ...
        {
          bddw.a(this.jdField_a_of_type_JavaLangString, "CompoundProcessor.notifySendBtnClicked", "already notified ,return ");
          return;
        }
        ...
        {
          a(121);
          bddw.a(this.jdField_a_of_type_JavaLangString, "CompoundProcessor.notifySendBtnClicked", "[peak] Thumb not ready,rollback ");
          paramString = axje.a();
      ...
      bddw.a(this.jdField_a_of_type_JavaLangString, "CompoundProcessor.notifySendBtnClicked ", "[peak] thumb existed");
    }
  }
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    try
    {
      ...
      localBundle.putParcelable("PhotoConst.SEND_SESSION_INFO", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
      localaxje.a(104, -1, localBundle);
      bddw.a(this.jdField_a_of_type_JavaLangString, "CompoundProcessor.svThumbOK", "[peak] path = " + paramString1 + ",width = " + paramInt1 + ",height = " + paramInt2 + ",md5 = " + paramString2);
      return;
    }
    finally {}
  }
  ...
  public void a(String paramString, int paramInt, long paramLong)
  {
    ...
    localaxje.a(103, -1, localBundle);
    bddw.a(this.jdField_a_of_type_JavaLangString, "clicomp", "CompoundProcessor.svMergeOK[peak] path = " + paramString + ",totalTime = " + paramInt);
  }
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 68	axiy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   6: ldc_w 321
    ...
    //   39: invokestatic 122	bddw:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   42: aload_0
    //   43: getfield 235	axiy:jdField_a_of_type_Boolean	Z
    //   46: ifne +26 -> 72
    //   49: aload_0
    //   50: iconst_1
    //   51: bipush 120
    //   53: invokevirtual 165	axiy:a	(II)V
    //   56: aload_0
    //   57: getfield 68	axiy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   60: ldc_w 321
    //   63: ldc_w 327
    //   66: invokestatic 122	bddw:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   69: aload_0
    //   70: monitorexit
    //   71: return
    //   72: iload_1
    ...
    //   84: iconst_2
    //   85: bipush 122
    //   87: invokevirtual 165	axiy:a	(II)V
    //   90: aload_0
    //   91: getfield 68	axiy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   94: ldc_w 321
    //   97: ldc_w 329
    //   100: invokestatic 122	bddw:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   103: aload_0
    //   104: getfield 307	axiy:jdField_c_of_type_Boolean	Z
    //   107: ifne -38 -> 69
    //   110: new 331	com/tencent/mobileqq/richmedia/CompoundProcessor$1
    //   113: dup
    //   114: aload_0
    //   115: invokespecial 334	com/tencent/mobileqq/richmedia/CompoundProcessor$1:<init>	(Laxiy;)V
    //   118: bipush 8
    //   120: aconst_null
    //   121: iconst_1
  ...
  public void c()
  {
    ...
    Bundle localBundle = new Bundle();
    localBundle.putString("vidoe_record_uniseq", this.jdField_a_of_type_JavaLangString);
    localaxje.a(102, -1, localBundle);
    bddw.a(this.jdField_a_of_type_JavaLangString, "CompoundProcessor.svEncodeEnd ", "[peak]all encode end");
  }
}
