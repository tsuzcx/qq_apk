...
final class aqki
{
  public static final aqjy a(String paramString, Object paramObject)
  {
    return a(paramString, new Object[] { paramObject });
  }
  
  public static final aqjy a(String paramString, Object paramObject1, Object paramObject2)
  {
    return a(paramString, new Object[] { paramObject1, paramObject2 });
  }
  
  public static final aqjy a(String paramString, Object[] paramArrayOfObject)
  {
  ...
  public static final aqjy a(String paramString, Object[] paramArrayOfObject, Throwable paramThrowable)
  {
    int j = 0;
    if (paramString == null) {
      return new aqjy(null, paramArrayOfObject, paramThrowable);
    }
    if (paramArrayOfObject == null) {
      return new aqjy(paramString);
    }
    ...
    if (j < paramArrayOfObject.length)
    {
      ...
      {
        if (i == 0) {
          return new aqjy(paramString, paramArrayOfObject, paramThrowable);
        }
        localStringBuilder.append(paramString, i, paramString.length());
        return new aqjy(localStringBuilder.toString(), paramArrayOfObject, paramThrowable);
      }
      if (a(paramString, k)) {
        if (!b(paramString, k))
        {
