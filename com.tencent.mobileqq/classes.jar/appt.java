  ...
  extends WebViewPlugin
{
  ...
  protected void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_AndroidAppDialog == null)
    {
      ...
      localTextView4.setOnClickListener(new appu(this));
      localTextView3.setOnClickListener(new appv(this));
  ...
  protected boolean a(String paramString)
  {
    ...
    do
    {
      ...
      if (localObject2 != null) {
        localObject1 = ((WebViewFragment)localObject2).getUrlFromIntent();
      }
      ...
      for (;;)
      {
        ...
        for (i = j;; i = 1)
        {
          ...
          if (((String)localObject1).equals("ask"))
          {
            ...
            a(paramString.getString(2131690119));
  ...
  protected void b()
  {
    ...
    QQToast.a(localActivity, anni.a(2131699524), 0).a();
  }
