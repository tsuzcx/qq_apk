  ...
  extends BusinessHandler
{
  ...
  public aqll(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      if (((oidb_0xeb5.RspBody)localObject).cache_ts.has())
      {
        ...
        aqlp.a(this.app).a(Long.valueOf(l2), Long.valueOf(System.currentTimeMillis() / 1000L + i));
        ...
        label224:
        aqlp.a(this.app).a(String.valueOf(l2), k);
      ...
      for (;;)
      {
        ...
        if (((oidb_0xeb5.App)localObject).appid.has())
        {
          ...
          label652:
          localaqlb.jdField_a_of_type_JavaLangString = paramToServiceMsg;
          if (!localLabel.text_color.has()) {
            break label818;
          }
          paramToServiceMsg = localLabel.text_color.get();
          label678:
          localaqlb.jdField_c_of_type_JavaLangString = paramToServiceMsg;
        ...
        {
          localaqlb.b = paramToServiceMsg;
          localaqla.jdField_a_of_type_JavaUtilArrayList.add(localaqlb);
          break label601;
          i = 0;
          break;
          label730:
        ...
        label832:
        localaqla.jdField_d_of_type_Int = ((oidb_0xeb5.App)localObject).jump_type.get();
        paramFromServiceMsg.add(localaqla);
      }
      label857:
      aqlp.a(this.a).a(Long.valueOf(l2), paramFromServiceMsg);
      if (paramFromServiceMsg.size() > j) {
        aqlp.a(this.a).a(String.valueOf(l2), paramFromServiceMsg.subList(j, paramFromServiceMsg.size()));
      }
      label913:
      if (QLog.isColorLevel()) {
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      {
        bool2 = bool3;
        aqlr.a(paramToServiceMsg, bool2);
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (bool2 = true;; bool2 = false)
    {
      ...
      bool2 = bool3;
      aqlr.a(paramToServiceMsg, bool2, str);
  ...
  {
    aqlp.a(this.app).a(Long.valueOf(paramLong), Long.valueOf(0L));
  ...
  public void a(long paramLong1, long paramLong2, boolean paramBoolean)
  {
    try
    {
      ...
      if (paramBoolean) {
        aqlp.a(this.app).a(Long.valueOf(paramLong1), Long.valueOf(0L));
      }
      aqlr.a(this.a, paramBoolean, String.valueOf(paramLong1));
