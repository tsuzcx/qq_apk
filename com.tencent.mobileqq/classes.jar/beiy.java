...
public class beiy
  extends azel
{
  public beiy(TroopAvatarWallPreviewActivity paramTroopAvatarWallPreviewActivity) {}
  ...
  public void a(boolean paramBoolean, String paramString, long paramLong1, long paramLong2)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((this.a.jdField_a_of_type_Int < 0) || (this.a.jdField_a_of_type_Int > this.a.jdField_a_of_type_Bfwr.getCount() - 1) || (this.a.jdField_b_of_type_JavaUtilArrayList == null) || (this.a.jdField_a_of_type_Int > this.a.jdField_b_of_type_JavaUtilArrayList.size() - 1));
    ...
    if (paramBoolean) {}
    for (paramString = this.a.getResources().getString(2131692408);; paramString = this.a.getResources().getString(2131691326))
    {
      ...
      if (this.a.jdField_a_of_type_Int >= this.a.jdField_a_of_type_Bfwr.getCount())
      {
        paramString = this.a;
      ...
      this.a.jdField_a_of_type_Bfwr.notifyDataSetChanged();
      return;
    }
  }
}
