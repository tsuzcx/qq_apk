...
public class bepi
{
  ...
  private void e()
  {
    ...
    if ((this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_b_of_type_AndroidViewView != null) && (this.jdField_b_of_type_AndroidViewView.getWidth() > 0) && (this.jdField_b_of_type_AndroidViewView.getHeight() > 0))
    {
      ...
      if (this.jdField_a_of_type_Bepk != null) {
        this.jdField_a_of_type_Bepk.a((Bundle)localObject3);
      }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bepk != null) {
        this.jdField_a_of_type_Bepk.b((Bundle)localObject3);
      }
  ...
  public bepi a(View paramView)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    return this;
  }
  
  public bepi a(bepk parambepk)
  {
  ...
  public boolean b()
  {
    ...
    if (this.jdField_a_of_type_Bepj != null) {
      bool = this.jdField_a_of_type_Bepj.a();
    }
    for (;;)
    {
