...
public class aoqx
{
  private static aoqx jdField_a_of_type_Aoqx = new aoqx();
  ...
  private aoqx()
  {
    ...
    if (!AppSetting.f().equals(localObject2))
    {
      ...
      bgsg.a((SharedPreferences.Editor)localObject2);
  ...
  public static aoqx a()
  {
    return jdField_a_of_type_Aoqx;
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Boolean)
        {
          ...
          bgsg.a((SharedPreferences.Editor)localObject1);
          this.jdField_d_of_type_Int = 0;
          bool2 = bool1;
          continue;
        }
