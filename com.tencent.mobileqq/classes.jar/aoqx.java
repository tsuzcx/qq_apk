...
public class aoqx
{
  ...
  public aoqx(QQAppInterface paramQQAppInterface, FriendListHandler paramFriendListHandler)
  {
  ...
  {
    ((anyw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(paramFriends);
  }
  ...
  public void a(Friends paramFriends, FriendInfo paramFriendInfo)
  {
    ...
    Object localObject2 = ((anyw)localObject1).e(paramFriends.uin);
    ...
    localObject1 = ((anyw)localObject1).e(paramFriends.uin);
    ...
    if (localObject1 != null)
    {
      ...
      label354:
      paramFriends.qqVipInfo = aopy.a((VipBaseInfo)localObject2, j, i);
      localObject2 = paramFriendInfo.oVipInfo;
      ...
      label391:
      paramFriends.superQqInfo = aopy.a((VipBaseInfo)localObject2, j, i);
      localObject2 = paramFriendInfo.oVipInfo;
      ...
      label428:
      paramFriends.superVipInfo = aopy.a((VipBaseInfo)localObject2, j, i);
      localObject2 = paramFriendInfo.oVipInfo;
      ...
      label465:
      paramFriends.bigClubInfo = aopy.a((VipBaseInfo)localObject2, j, i);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((!TextUtils.isEmpty(paramFriends.uin)) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c().equals(paramFriends.uin))) {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("sp_plate_of_king", 0).edit().putBoolean("plate_of_king_display_switch_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramFriends.namePlateOfKingDanDisplatSwitch).apply();
      }
      if (localObject1 != null)
      {
      ...
      bkgt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFriends);
      return;
