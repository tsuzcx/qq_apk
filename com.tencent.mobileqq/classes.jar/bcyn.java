  ...
  extends FaceDecodeTask
{
  ...
  public bcyn(NearbyAppInterface paramNearbyAppInterface, FaceInfo paramFaceInfo, bcwp parambcwp)
  {
    super(paramNearbyAppInterface, paramFaceInfo, parambcwp);
  ...
  public void a()
  {
    ...
    do
    {
      for (;;)
      {
        try
        {
          bcxl localbcxl = (bcxl)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(216);
          if (!localbcxl.a(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo))
          {
            bool = true;
            ...
            if (this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_AvatarInfoQQHeadInfo != null) {
              localbcxl.a(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo);
            }
        ...
        else
        {
          ...
          localObject3 = (anpx)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(180);
          if (!((anpx)localObject3).a(((anpx)localObject3).a(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_b_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_JavaLangString), (Setting)localObject2, this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_Int)) {
            continue;
          }
          if (QLog.isColorLevel()) {
    ...
    if (Math.abs(System.currentTimeMillis() - ((Setting)localObject2).updateTimestamp) > 86400000L)
    {
      ...
      ((alnk)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.a(4)).a(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo);
    }
    localObject2 = new bcwd();
    localObject3 = new BitmapFactory.Options();
    ((BitmapFactory.Options)localObject3).inPreferredConfig = bcwn.a;
    i = 0;
    do
    {
      bcwc.a(localException3.a(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo), (BitmapFactory.Options)localObject3, (bcwd)localObject2);
      if (((bcwd)localObject2).jdField_a_of_type_Int == 1)
      {
      ...
      i += 1;
    } while ((i < 2) && (((bcwd)localObject2).jdField_a_of_type_Int == 1));
    if ((QLog.isColorLevel()) || (((bcwd)localObject2).jdField_a_of_type_Int != 0)) {
      QLog.i("Q.qqhead.NearByFaceDecodeTask", 1, "doDecodeBitmap decode bitmap.faceInfo=" + this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo + ",result=" + ((bcwd)localObject2).jdField_a_of_type_Int + ", bmp=" + ((bcwd)localObject2).jdField_a_of_type_AndroidGraphicsBitmap);
    }
    if (((bcwd)localObject2).jdField_a_of_type_AndroidGraphicsBitmap != null) {}
    switch (this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.c)
    {
    case 2: 
    case 1: 
    case 3: 
      for (((bcwd)localObject2).jdField_a_of_type_AndroidGraphicsBitmap = bdda.c(((bcwd)localObject2).jdField_a_of_type_AndroidGraphicsBitmap, 50, 50);; ((bcwd)localObject2).jdField_a_of_type_AndroidGraphicsBitmap = bdda.a(((bcwd)localObject2).jdField_a_of_type_AndroidGraphicsBitmap, 50, 50))
      {
        for (;;)
        {
          for (;;)
          {
            this.jdField_a_of_type_AndroidGraphicsBitmap = ((bcwd)localObject2).jdField_a_of_type_AndroidGraphicsBitmap;
            localException3.a(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.a(), ((bcwd)localObject2).jdField_a_of_type_AndroidGraphicsBitmap, (byte)1);
