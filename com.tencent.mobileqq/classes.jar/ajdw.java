...
public class ajdw
  implements Runnable
{
  public ajdw(AvatarWallViewPagerAdapter paramAvatarWallViewPagerAdapter, URLImageView paramURLImageView, String paramString) {}
  ...
  public void run()
  {
    ...
    ((Activity)localObject).runOnUiThread(new ajdx(this, localSetting));
  }
}
