  ...
  implements wja
{
  ...
  private void a(CardItem paramCardItem)
  {
    ...
    try
    {
      ...
      while (paramCardItem.hasNext())
      {
        ...
        ykq.a(this.jdField_a_of_type_JavaLangString, "update db cardId=%s id=%d", localCardEntry2.cardId, Long.valueOf(localCardEntry2.getId()));
      }
    }
    finally
    {
  ...
  public void a(String paramString, wuv paramwuv)
  {
    EntityManager localEntityManager = a().a().createEntityManager();
    localEntityManager.getTransaction().begin();
    try
    {
      if (paramwuv.jdField_b_of_type_JavaUtilList.size() == paramwuv.jdField_a_of_type_JavaUtilList.size())
      {
        ...
        localDiscoverBannerVideoEntry.totalCount = paramwuv.jdField_b_of_type_Int;
        paramString = new ArrayList(paramwuv.jdField_b_of_type_JavaUtilList.size());
        int i = 0;
        while (i < paramwuv.jdField_b_of_type_JavaUtilList.size())
        {
          DiscoverBannerVideoEntry.BannerInfo localBannerInfo = new DiscoverBannerVideoEntry.BannerInfo();
          localBannerInfo.b = ((String)paramwuv.jdField_b_of_type_JavaUtilList.get(i));
          localBannerInfo.jdField_a_of_type_JavaLangString = ((String)paramwuv.jdField_a_of_type_JavaUtilList.get(i));
          paramString.add(localBannerInfo);
          i += 1;
        }
        localDiscoverBannerVideoEntry.bannerInfoList = paramString;
        localDiscoverBannerVideoEntry.nextCookie = paramwuv.jdField_a_of_type_JavaLangString;
