...
public class shq
{
  ...
  public static GdtHandler.Params a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, ram paramram, int paramInt, boolean paramBoolean, nxz paramnxz)
  {
    return a(paramContext, paramAdvertisementInfo, paramram, paramInt, paramBoolean, true, false, paramnxz);
  }
  
  public static GdtHandler.Params a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, ram paramram, int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, nxz paramnxz)
  {
    ...
    if (paramram != null) {
      localParams.jdField_a_of_type_Long = paramram.a();
    }
    ...
    if ((paramInt != 3) && (paramInt != 4) && (paramAdvertisementInfo.mAdJumpMode != 6) && (!paramBoolean3) && (paramInt != 2000001))
    {
      ...
      if (paramnxz != null) {
        a(localParams, paramnxz.jdField_a_of_type_Boolean, paramAdvertisementInfo, paramContext);
      }
    }
    localParams.jdField_b_of_type_JavaLangClass = ReadInJoyForCanvasFragment.class;
    if ((paramnxz != null) && (paramnxz.jdField_b_of_type_Boolean)) {
    ...
    a(localParams, paramAdvertisementInfo, paramnxz);
    return localParams;
  }
  ...
  /* Error */
  private static nya a(AdvertisementInfo paramAdvertisementInfo)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    ...
    //   3: ifnull +142 -> 145
    //   6: aload_0
    //   7: getfield 262	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Lnye;
    //   10: ifnull +135 -> 145
    //   13: aload_0
    //   14: getfield 262	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Lnye;
    //   17: getfield 267	nye:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   20: ifnull +125 -> 145
    //   23: aload_0
    //   24: getfield 262	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Lnye;
    //   27: getfield 267	nye:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   45: if_icmpne +20 -> 65
    //   48: aload_0
    //   49: getfield 262	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Lnye;
    //   52: getfield 267	nye:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   55: iconst_0
    //   56: invokeinterface 277 2 0
    //   61: checkcast 279	nya
    //   64: astore_1
    //   65: aload_0
    ...
    //   71: if_icmpne +72 -> 143
    //   74: aload_0
    //   75: getfield 262	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Lnye;
    //   78: getfield 267	nye:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   81: iconst_1
    //   82: invokeinterface 277 2 0
    //   87: checkcast 279	nya
    //   90: astore_2
    //   91: aload_2
    //   92: areturn
    //   93: astore_1
  ...
  private static nym a(ram paramram, String paramString)
  {
    ReadInJoyXListView localReadInJoyXListView = (ReadInJoyXListView)paramram.a();
    int j = localReadInJoyXListView.getFirstVisiblePosition();
    int i = Math.max(localReadInJoyXListView.getHeaderViewsCount(), j);
    int k;
    if (i < paramram.a().size() + localReadInJoyXListView.getHeaderViewsCount())
    {
      k = i - localReadInJoyXListView.getHeaderViewsCount();
      BaseArticleInfo localBaseArticleInfo = paramram.b(k);
      if ((66 == paramram.getItemViewType(k)) && (localBaseArticleInfo != null) && (TextUtils.equals(localBaseArticleInfo.getInnerUniqueID(), paramString)))
      {
        int m = i - j;
        if ((m >= 0) && (m < localReadInJoyXListView.getChildCount())) {
          paramram = localReadInJoyXListView.getChildAt(i - j);
        }
      }
    }
    for (;;)
    {
      if ((paramram != null) && ((paramram.getTag() instanceof nym)))
      {
        return (nym)paramram.getTag();
        if ((k >= 0) && (k < paramram.a().size())) {
          paramram = paramram.getView(k, null, localReadInJoyXListView);
        }
      }
      else
      {
  ...
  public static qq_ad_get.QQAdGetRsp.AdInfo a(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    //   358: astore_1
    //   359: aload_0
    //   360: getfield 262	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Lnye;
    //   363: ifnull +23 -> 386
    //   366: aload_2
    //   367: astore_1
    //   368: aload_0
    //   369: getfield 262	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Lnye;
    //   372: getfield 522	nye:h	I
    //   375: ldc_w 523
    //   378: if_icmpne +8 -> 386
    //   381: aload_2
    //   382: invokestatic 525	shq:a	(Ljava/lang/String;)Ljava/lang/String;
    //   385: astore_1
    //   386: aload 6
    ...
    //   600: aload_0
    //   601: invokestatic 594	oar:h	(Lcom/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo;)Z
    //   604: ifeq +38 -> 642
    //   607: aload_0
    //   608: getfield 262	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Lnye;
    //   611: getfield 267	nye:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   614: ifnull +28 -> 642
    //   617: aload_0
    //   618: getfield 262	com/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo:mAdvertisementExtInfo	Lnye;
    //   621: getfield 267	nye:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   624: invokeinterface 273 1 0
    //   629: iconst_2
    //   630: if_icmplt +12 -> 642
    //   633: aload_0
    //   634: invokestatic 596	shq:a	(Lcom/tencent/biz/pubaccount/readinjoy/struct/AdvertisementInfo;)Lnya;
    //   637: astore_1
    //   638: aload_1
    ...
    //   943: goto -348 -> 595
    //   946: aload_1
    //   947: getfield 679	nya:b	Ljava/lang/String;
    ...
    //   983: aload_1
    //   984: getfield 680	nya:a	Ljava/lang/String;
  ...
  public static void a(int paramInt, GdtHandler.Params paramParams, long paramLong)
  {
    ...
    do
    {
      ...
      if ((paramParams == null) || (paramLong == -2147483648L))
      {
        yxp.d("ReadinJoyActionUtil", " enterTimeMillis:" + paramLong + " gdtParams:" + paramParams);
        return;
      }
    } while ((paramInt != 0) && (paramInt != 3) && (paramInt != 56) && (paramInt != 2));
    long l = SystemClock.elapsedRealtime();
    yxp.b("ReadinJoyActionUtil", String.format("leave %d", new Object[] { Long.valueOf(l) }));
    if (paramLong == -2147483648L) {
      yxp.d("ReadinJoyActionUtil", "leave error");
    }
    paramLong = l - paramLong;
    yxp.b("ReadinJoyActionUtil", String.format("dwell %d", new Object[] { Long.valueOf(paramLong) }));
    yxu localyxu = new yxu();
    localyxu.jdField_a_of_type_ComTencentGdtadAditemGdtAd = paramParams.jdField_a_of_type_ComTencentGdtadAditemGdtAd;
  ...
  private static void a(Activity paramActivity, AdvertisementInfo paramAdvertisementInfo, ram paramram, int paramInt, boolean paramBoolean)
  {
    if ((paramram != null) && (paramBoolean)) {
    ...
    if (paramram != null) {
      localBundle.putLong("param_ad_app_info_video_playposition", paramram.a());
    }
    a(paramActivity);
    ReadInJoyNativeAdAppFragment.a(paramActivity, ReadInJoyNativeAdAppFragment.class, localBundle);
  }
  
  public static void a(Activity paramActivity, AdvertisementInfo paramAdvertisementInfo, ram paramram, int paramInt, boolean paramBoolean, nxz paramnxz)
  {
    paramnxz = a(paramActivity, paramAdvertisementInfo, paramram, paramInt, paramBoolean, paramnxz);
    if (((paramAdvertisementInfo instanceof AdvertisementInfo)) && (paramnxz != null))
    {
      paramnxz.d = true;
      paramnxz.jdField_c_of_type_Boolean = true;
      if (a(paramnxz, paramActivity, paramAdvertisementInfo)) {
        return;
      }
    }
    ...
    paramnxz = new qq_ad_get.QQAdGetRsp.AdInfo.ReportInfo();
    paramnxz.exposure_url.set(paramAdvertisementInfo.mAdApurl);
    paramnxz.click_url.set(paramAdvertisementInfo.mAdRl);
    paramnxz.trace_info.set((MessageMicro)localObject);
    localObject = new qq_ad_get.QQAdGetRsp.AdInfo();
    ((qq_ad_get.QQAdGetRsp.AdInfo)localObject).report_info.set(paramnxz);
    ...
    paramnxz = (nxz)localObject;
    if (AdvertisementInfo.isAppAdvertisementInfo(paramAdvertisementInfo))
    {
      paramnxz = Uri.parse((String)localObject).buildUpon();
      if ((bbfj.b(BaseApplicationImpl.getApplication()) != 1) || (paramInt == 0)) {
        break label354;
      }
      paramnxz.appendQueryParameter("autodownload", "1");
    }
    for (;;)
    {
      paramnxz = paramnxz.toString();
      ...
      ((GdtVideoCeilingData)localObject).setWebUrl(paramnxz);
      ...
      a(paramActivity, paramAdvertisementInfo, paramram, 0, null);
      return;
      label354:
      paramnxz.appendQueryParameter("autodownload", "0");
    }
    a(paramActivity, paramAdvertisementInfo, paramram, 0, false);
    return;
    label378:
    if (paramInt == 5)
    {
      b(paramActivity, paramAdvertisementInfo, paramram, 0, false);
      return;
    }
  ...
  public static void a(Activity paramActivity, AdvertisementInfo paramAdvertisementInfo, ram paramram, int paramInt, boolean paramBoolean1, boolean paramBoolean2, nxz paramnxz)
  {
    Object localObject = a(paramActivity, paramAdvertisementInfo, paramram, paramInt, paramBoolean1, paramnxz);
  ...
  {
    Object localObject2 = onh.c(paramArticleInfo);
    int i;
    int j;
    label32:
    int k;
    ...
    if (paramArticleInfo.hasChannelInfo())
    {
      ...
      nol.a(null, "CliOper", "", "", "0X80066FA", "0X80066FA", 0, 0, "", Long.toString(paramArticleInfo.mArticleID), Integer.toString(paramArticleInfo.mStrategyId), onh.b(paramArticleInfo.mAlgorithmID, onh.a(paramArticleInfo), paramInt, i), false);
      nol.a("0X80066FA", "", "", Long.toString(paramArticleInfo.mArticleID), Integer.toString(paramArticleInfo.mStrategyId), onh.b(paramArticleInfo.mAlgorithmID, onh.a(paramArticleInfo), paramInt, i));
      localObject3 = shu.b(paramArticleInfo.mChannelID);
      if ((!ram.i(paramArticleInfo)) && (!ram.a(paramArticleInfo)) && (!ram.j(paramArticleInfo)) && (!ram.k(paramArticleInfo))) {
        break label635;
      }
      nol.a(null, "CliOper", "", String.valueOf(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qda.jdField_a_of_type_Long), (String)localObject3, (String)localObject3, 0, 0, Long.toString(paramArticleInfo.mFeedId), paramArticleInfo.businessId + "", Integer.toString(paramArticleInfo.mStrategyId), onh.a(paramArticleInfo.mAlgorithmID, onh.a(paramArticleInfo), paramInt, i, j, bbfj.h(paramActivity), String.valueOf(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qci.jdField_a_of_type_Long), paramArticleInfo.mStrCircleId, paramArticleInfo.innerUniqueID, onh.e(paramArticleInfo), k, paramArticleInfo), false);
    }
    Object localObject1;
    for (;;)
    {
      nol.a((String)localObject3, paramArticleInfo.mSubscribeID, Long.toString(paramArticleInfo.mFeedId), Long.toString(paramArticleInfo.mArticleID), Integer.toString(paramArticleInfo.mStrategyId), onh.a(paramArticleInfo.mAlgorithmID, onh.a(paramArticleInfo), paramInt, i, j, bbfj.h(paramActivity), (String)localObject2, paramArticleInfo.mStrCircleId, paramArticleInfo.innerUniqueID, onh.e(paramArticleInfo), k, paramArticleInfo));
      paramram = new ArrayList();
      ...
      ((qbz)localObject2).jdField_b_of_type_Int = paramArticleInfo.mSocialFeedInfo.d;
      ...
      break label45;
      label635:
      localObject1 = onh.a(paramArticleInfo.mAlgorithmID, onh.a(paramArticleInfo), paramInt, i, j, bbfj.h(paramActivity), (String)localObject2, paramArticleInfo.mStrCircleId, paramArticleInfo.innerUniqueID, onh.e(paramArticleInfo), k, paramArticleInfo);
      paramram = (ram)localObject1;
      if (paramInt == 0) {
        paramram = npu.a(k, (String)npu.a.get(ReadInJoyChannelActivity.class), (String)localObject1);
      }
      nol.a(null, "CliOper", "", paramArticleInfo.mSubscribeID, (String)localObject3, (String)localObject3, 0, 0, Long.toString(paramArticleInfo.mFeedId), Long.toString(paramArticleInfo.mArticleID), Integer.toString(paramArticleInfo.mStrategyId), paramram, false);
    }
    label746:
    ((ReportInfo)localObject1).mFeedsReportData = ((qbz)localObject2);
    label753:
    paramram.add(localObject1);
    osg.a().a(paramram);
    if ((paramArticleInfo instanceof AdvertisementInfo))
    {
      if (paramArticleInfo.mChannelID == 56L) {
        nmc.a(new nyd().a(paramActivity).a(nmc.jdField_a_of_type_Int).b(nmc.U).a((AdvertisementInfo)paramArticleInfo).d(((AdvertisementInfo)paramArticleInfo).clickPos).a());
      }
    }
    else {
      return;
    }
    if ((oar.m((AdvertisementInfo)paramArticleInfo)) && (oat.jdField_b_of_type_Boolean)) {
      paramInt = nmc.an;
    }
    for (;;)
    {
      nmc.a(new nyd().a(paramActivity).a(nmc.jdField_a_of_type_Int).b(paramInt).a((AdvertisementInfo)paramArticleInfo).d(((AdvertisementInfo)paramArticleInfo).clickPos).a());
      return;
      if (a((AdvertisementInfo)paramArticleInfo, paramInt)) {
        paramInt = nmc.R;
      } else if (onh.a(paramArticleInfo)) {
        paramInt = nmc.Q;
      } else {
        paramInt = nmc.L;
      }
  ...
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, ram paramram, int paramInt, nxz paramnxz)
  {
    ...
    if (AdvertisementInfo.isAdvertisementInfo(paramArticleInfo))
    {
      ...
      localParams = a(paramActivity, (AdvertisementInfo)paramArticleInfo, paramram, paramInt, true, paramnxz);
      if (!a(localParams, paramActivity, (AdvertisementInfo)paramArticleInfo))
      {
        paramnxz = paramArticleInfo.mArticleContentUrl;
        if ((!AdvertisementInfo.isAdvertisementInfo(paramArticleInfo)) || (!oar.h((AdvertisementInfo)paramArticleInfo))) {
          break label366;
        }
        paramram = a((AdvertisementInfo)paramArticleInfo);
        if (paramram == null) {
          break label372;
        }
      }
    ...
    label366:
    label372:
    for (paramram = paramram.a;; paramram = "")
    {
      if (!TextUtils.isEmpty(paramram)) {}
      for (;;)
      {
        paramnxz = paramram;
        if (AdvertisementInfo.isAppAdvertisementInfo(paramArticleInfo))
        {
          paramnxz = paramram;
          if (bbfj.h(null)) {
            if (!paramram.contains("?")) {
              break label342;
            }
          }
        }
        for (paramArticleInfo = paramram + "&";; paramArticleInfo = paramram + "?")
        {
          paramnxz = paramArticleInfo + "acttype=42";
          a(paramActivity);
          ...
          paramArticleInfo.putExtra("url", paramnxz);
  ...
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, ram paramram, int paramInt, boolean paramBoolean, nxz paramnxz)
  {
    ...
    case 6: 
    case 7: 
      a(paramActivity, paramArticleInfo, paramram, paramInt, paramnxz);
      return;
    case 2: 
      a(paramActivity, (AdvertisementInfo)paramArticleInfo, paramram, paramInt, paramBoolean, paramnxz);
      return;
    case 4: 
      ...
      a(paramActivity, (AdvertisementInfo)paramArticleInfo, paramram, paramInt, true);
      return;
    case 3: 
      a(paramActivity, (AdvertisementInfo)paramArticleInfo, null, paramInt, paramBoolean, paramnxz);
      a(paramActivity, paramArticleInfo, paramram, paramInt);
      osg.a().a(paramArticleInfo.mArticleID, System.currentTimeMillis());
      paramram.notifyDataSetChanged();
      return;
    }
    b(paramActivity, (AdvertisementInfo)paramArticleInfo, paramram, paramInt, true);
  }
  
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, ram paramram, int paramInt, boolean paramBoolean1, boolean paramBoolean2, nxz paramnxz)
  {
    if ((!AdvertisementInfo.isAdvertisementInfo(paramArticleInfo)) || (!(paramArticleInfo instanceof AdvertisementInfo))) {
      return;
    }
    ...
    for (;;)
    {
      ...
      case 7: 
        ...
        return;
      case 2: 
        a(paramActivity, (AdvertisementInfo)paramArticleInfo, paramram, paramInt, paramBoolean1, paramnxz);
        return;
      case 4: 
        if (TextUtils.isEmpty(((AdvertisementInfo)paramArticleInfo).mAdAppJson))
        {
          a(paramActivity, paramArticleInfo, paramram, paramInt, null);
          return;
        }
        a(paramActivity, (AdvertisementInfo)paramArticleInfo, paramram, paramInt, true);
        return;
      case 3: 
        paramnxz.jdField_a_of_type_Boolean = a(paramArticleInfo, paramram);
        int i = ((AdvertisementInfo)paramArticleInfo).clickPos;
        a(paramActivity, (AdvertisementInfo)paramArticleInfo, paramram, paramInt, paramBoolean1, paramBoolean2, paramnxz);
  ...
  public static void a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, ram paramram, int paramInt, boolean paramBoolean, nxz paramnxz)
  {
    a(paramContext, paramAdvertisementInfo, paramram, paramInt, paramBoolean, paramnxz);
    a(paramContext, paramAdvertisementInfo, paramInt);
  }
  
  public static void a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, ram paramram, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    a(paramContext, paramAdvertisementInfo, paramram, paramInt, paramBoolean1, paramBoolean2);
    a(paramContext, paramAdvertisementInfo, paramInt);
  }
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      } while ((oar.h((AdvertisementInfo)paramArticleInfo)) && (((AdvertisementInfo)paramArticleInfo).isClickFromPkFragment));
      if (a((AdvertisementInfo)paramArticleInfo, paramInt)) {
        i = nmc.R;
      } else if (onh.a(paramArticleInfo)) {
        i = nmc.Q;
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, int paramInt1, int paramInt2)
  {
    if ((paramArticleInfo instanceof AdvertisementInfo))
    {
      nmc.a(new nyd().a(paramContext).a(nmc.jdField_a_of_type_Int).b(paramInt2).a((AdvertisementInfo)paramArticleInfo).e(new JSONObject()).a());
  ...
  {
    if ((paramram != null) && (paramArticleInfo != null) && ((paramArticleInfo instanceof AdvertisementInfo)) && ((paramContext instanceof Activity)))
    {
      paramram.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params = a(paramContext, (AdvertisementInfo)paramArticleInfo, paramram, paramInt, false, null);
      if (paramram.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params == null) {
        break label57;
      }
    }
    label57:
    ...
    {
      paramram.jdField_a_of_type_Long = l;
      return;
    }
  }
  ...
  public static void a(ViewBase paramViewBase1, ViewBase paramViewBase2, Activity paramActivity, ArticleInfo paramArticleInfo, ram paramram, int paramInt1, int paramInt2)
  {
    if ((paramViewBase2 == null) || (paramActivity == null) || (paramArticleInfo == null)) {}
    while (!(paramArticleInfo instanceof AdvertisementInfo)) {
      return;
    }
    paramViewBase2.setOnClickListener(new shr(paramArticleInfo, paramActivity, paramram, paramInt1, paramInt2, paramViewBase1));
  }
  
  public static void a(GdtHandler.Params paramParams, AdvertisementInfo paramAdvertisementInfo, nxz paramnxz)
  {
    if ((paramParams != null) && (paramParams.jdField_a_of_type_ComTencentGdtadAditemGdtAd != null) && (paramnxz != null) && (paramAdvertisementInfo != null) && ((AdvertisementInfo.isAppAdvertisementInfo(paramAdvertisementInfo)) || (paramAdvertisementInfo.isGameAdSource())) && (!TextUtils.isEmpty(paramParams.jdField_a_of_type_ComTencentGdtadAditemGdtAd.getUrlForLandingPage()))) {}
    try
    {
      Object localObject = Uri.parse(paramParams.jdField_a_of_type_ComTencentGdtadAditemGdtAd.getUrlForLandingPage()).buildUpon();
      if ((bbfj.b(BaseApplicationImpl.getContext())) && (oaq.a(paramAdvertisementInfo.mAdExtInfo)) && (paramnxz.jdField_c_of_type_Boolean))
      {
        int i = 0;
      ...
      if ((paramParams.jdField_a_of_type_Boolean) && (!a(paramParams)))
      {
        ...
        if ((bbfj.b(BaseApplicationImpl.getContext())) && (oaq.a(paramAdvertisementInfo.mAdExtInfo)) && (paramnxz.jdField_c_of_type_Boolean) && (((Uri.Builder)localObject).build().getQueryParameter("_autodownload") == null))
        {
  ...
  {
    if (((paramBoolean) && (AdvertisementInfo.isAppAdvertisementInfo(paramAdvertisementInfo)) && (!oar.d(paramAdvertisementInfo))) || ((paramBoolean) && ((paramAdvertisementInfo.mAdProductType == 1000) || (paramAdvertisementInfo.mAdProductType == 25)) && (TextUtils.isEmpty(paramAdvertisementInfo.mAdCustomizedInvokeUrl))) || (!paramBoolean))
    {
  ...
  public static void a(qlp paramqlp)
  {
    a(3, paramqlp.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params, paramqlp.jdField_a_of_type_Long);
    paramqlp.jdField_a_of_type_Long = -2147483648L;
    paramqlp.jdField_a_of_type_ComTencentGdtadAditemGdtHandler$Params = null;
  }
  ...
  public static boolean a(Context paramContext, AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    while (!oar.n(paramAdvertisementInfo)) {
      return false;
    }
    onh.e(paramContext, paramAdvertisementInfo.mAdLandingPage);
    return true;
  }
  
  public static boolean a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, ram paramram, int paramInt, boolean paramBoolean)
  {
    paramram = a(paramContext, paramAdvertisementInfo, paramram, paramInt, paramBoolean, null);
    if (paramram == null) {
      return false;
    }
    return b(paramram, paramContext, paramAdvertisementInfo);
  }
  
  public static boolean a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, ram paramram, int paramInt, boolean paramBoolean, nxz paramnxz)
  {
    paramram = a(paramContext, paramAdvertisementInfo, paramram, paramInt, paramBoolean, paramnxz);
    if (paramram == null) {
      return false;
    }
    return b(paramram, paramContext, paramAdvertisementInfo);
  ...
  public static boolean a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, ram paramram, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    paramram = a(paramContext, paramAdvertisementInfo, paramram, paramInt, paramBoolean1, null);
    if (paramram == null) {
      return false;
    }
    paramram.f = paramBoolean2;
    return b(paramram, paramContext, paramAdvertisementInfo);
  }
  ...
  public static boolean a(Context paramContext, AdData paramAdData, AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    while (!oai.a(paramAdData)) {
      return false;
    }
    a(paramContext);
    oar.b(paramAdvertisementInfo);
    oai.a(paramContext, paramAdData);
    paramContext = (QQAppInterface)onh.a();
    nmc.a(new nyd().a(paramContext).a(BaseApplication.getContext()).a(nmc.jdField_a_of_type_Int).b(nmc.ac).a(paramAdvertisementInfo).d(nmc.a(paramAdData)).a());
    return true;
  }
  ...
  public static boolean a(AdvertisementInfo paramAdvertisementInfo, int paramInt)
  {
    ...
    if ((paramInt == 2) || (paramInt == 5) || (paramInt == 3) || (paramInt == 56) || (paramInt == 4) || (paramInt == 2000001) || ((oar.a(paramInt)) && (!a(paramAdvertisementInfo.mAdJumpMode)) && (jdField_a_of_type_JavaUtilArrayList.contains(Integer.valueOf(paramAdvertisementInfo.mAdProductType))))) {
      return true;
    }
  ...
  public static boolean a(ArticleInfo paramArticleInfo, ViewBase paramViewBase, Activity paramActivity, int paramInt, qtr paramqtr, AdvertisementInfo paramAdvertisementInfo)
  {
    Object localObject1;
    Object localObject2;
    if ((paramAdvertisementInfo.mImaxShowAdType == 1001) || (paramAdvertisementInfo.mImaxShowAdType == 1002))
    {
      ...
      if (paramAdvertisementInfo.mImaxShowAdType == 1001)
      {
        ...
        if ((localObject1 != null) && (((ViewBase)localObject1).getNativeView() != null) && (((ViewBase)localObject1).getNativeView().getVisibility() == 0))
        {
          ...
          a(paramActivity, paramArticleInfo, paramInt, nmc.ag);
          return true;
        }
      }
      localObject1 = null;
    ...
    for (;;)
    {
      ...
      paramqtr = paramViewBase.getNativeView();
      if (localObject1 != null) {
        if ((localObject1 instanceof NativeReadInjoyImageView))
        {
          ...
          paramqtr = (qtr)localObject1;
        }
      }
      for (;;)
      {
        paramqtr.getLocationOnScreen((int[])localObject2);
        ...
        int k = paramqtr.getWidth();
        int m = paramqtr.getHeight();
        paramViewBase = new owm();
  ...
  public static boolean a(ArticleInfo paramArticleInfo, ram paramram)
  {
    if ((paramram != null) && (paramram.a() != null) && (paramram.a().b()) && (paramram.a().a() != null))
    {
      paramram = paramram.a().a();
      if ((paramram.jdField_b_of_type_Boolean) && (paramram.a != null) && (AdvertisementInfo.isAdvertisementInfo(paramram.a)))
      {
        paramram = (AdvertisementInfo)paramram.a;
        if ((!TextUtils.isEmpty(paramram.mAdTraceId)) && ((paramArticleInfo instanceof AdvertisementInfo)) && (paramram.mAdTraceId.equals(((AdvertisementInfo)paramArticleInfo).mAdTraceId))) {
          return true;
        }
      }
    }
  ...
  private static void b(Activity paramActivity, AdvertisementInfo paramAdvertisementInfo, ram paramram, int paramInt, boolean paramBoolean)
  {
    if ((paramram != null) && (paramBoolean)) {
      a(paramActivity, paramAdvertisementInfo, paramInt);
    }
    Bundle localBundle = new Bundle();
    okx.a(localBundle, paramAdvertisementInfo);
    long l2 = 0L;
    long l1 = l2;
    if (paramram != null)
    {
      ...
      {
        l1 = l2;
        if (paramram.a().a() != null)
        {
          l1 = l2;
          if (paramram.a().a().c == paramAdvertisementInfo.mArticleID) {
            l1 = paramram.a();
          }
        }
      }
  ...
  private static void b(Context paramContext, ArticleInfo paramArticleInfo, int paramInt)
  {
    ...
    for (int j = 0;; j = 1)
    {
      String str1 = onh.c(paramArticleInfo);
      String str2 = shu.b(paramInt);
      nol.a(null, "CliOper", "", paramArticleInfo.mSubscribeID, str2, str2, 0, 0, Long.toString(paramArticleInfo.mFeedId), Long.toString(paramArticleInfo.mArticleID), Integer.toString(paramArticleInfo.mStrategyId), onh.a(paramArticleInfo.mAlgorithmID, onh.a(paramArticleInfo), paramInt, i, j, bbfj.h(paramContext), str1, paramArticleInfo.mStrCircleId, paramArticleInfo.innerUniqueID, onh.e(paramArticleInfo), paramArticleInfo), false);
      return;
      i = 0;
      break;
    }
  ...
  public static boolean b(Context paramContext, AdvertisementInfo paramAdvertisementInfo, ram paramram, int paramInt, boolean paramBoolean)
  {
    paramContext = a(paramContext, paramAdvertisementInfo, paramram, paramInt, paramBoolean, false, false, null);
    if (paramContext == null) {
      return false;
    }
  ...
  public static boolean b(Context paramContext, AdvertisementInfo paramAdvertisementInfo, ram paramram, int paramInt, boolean paramBoolean, nxz paramnxz)
  {
    if (oar.n(paramAdvertisementInfo))
    {
  ...
  private static boolean b(Context paramContext, ram paramram, ArticleInfo paramArticleInfo)
  {
    if ((paramram == null) || (paramram.a() != 0)) {}
    nym localnym;
    do
    {
      do
      ...
      onh.a(paramArticleInfo);
      paramArticleInfo.innerUniqueID = a(paramArticleInfo, "landing_page_rowkey");
      localnym = a(paramram, paramArticleInfo.innerUniqueID);
    } while (localnym == null);
    a(paramContext, paramArticleInfo, paramram.a());
    paramram.a(localnym.a(), paramArticleInfo);
    return true;
  }
  ...
  public static boolean c(Context paramContext, AdvertisementInfo paramAdvertisementInfo, ram paramram, int paramInt, boolean paramBoolean, nxz paramnxz)
  {
    paramram = a(paramContext, paramAdvertisementInfo, paramram, paramInt, paramBoolean, false, false, paramnxz);
    if (paramram == null) {
      return false;
    }
    if (paramnxz == null)
    {
      paramram.d = false;
      paramram.jdField_c_of_type_Boolean = false;
    }
    return b(paramram, paramContext, paramAdvertisementInfo);
  }
}
