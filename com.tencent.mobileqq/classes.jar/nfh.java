  ...
  implements View.OnClickListener, bkhe
{
  ...
  private mwq jdField_a_of_type_Mwq = new nfi(this);
  ...
  public nfh(Activity paramActivity, QQAppInterface paramQQAppInterface, SwipListView paramSwipListView, View paramView, String paramString)
  {
    ...
    this.b = this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131296558);
    this.c = this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131296557);
    e();
    a(this);
  }
  ...
  private void f()
  {
    ...
    this.d = this.e;
    this.jdField_a_of_type_Boolean = true;
    localmwd.a(this.jdField_a_of_type_JavaLangString, this.d);
  }
  ...
  public void d()
  {
    ...
    if (localmwd != null) {
      localmwd.a(this.jdField_a_of_type_JavaLangString, 0);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131558735, null);
      paramView = new nfk();
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363182));
      paramView.b = ((TextView)localView.findViewById(2131363183));
      paramView.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131363181));
      localView.setTag(paramView);
      localView.setOnClickListener(this);
      localView.setOnTouchListener(new nfj(this));
      localObject1 = new GradientDrawable();
      ((GradientDrawable)localObject1).setCornerRadius(bgtn.a(5.0F));
      ((GradientDrawable)localObject1).setColor(-7510273);
      ((GradientDrawable)localObject1).setShape(0);
      localObject2 = new GradientDrawable();
      ((GradientDrawable)localObject2).setCornerRadius(bgtn.a(5.0F));
    ...
    {
      localObject2 = new StringBuilder(nfx.a(((RoomInfo)localObject1).id));
      if (((StringBuilder)localObject2).length() == 9)
      {
        ((StringBuilder)localObject2).insert(6, "-");
        ((StringBuilder)localObject2).insert(3, "-");
      }
      localObject2 = this.jdField_a_of_type_AndroidAppActivity.getString(2131690336) + " " + ((StringBuilder)localObject2).toString();
      paramView.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
      localObject2 = String.format(this.jdField_a_of_type_AndroidAppActivity.getString(2131690335), new Object[] { Integer.valueOf(((RoomInfo)localObject1).players.size()) });
      ...
      localView.setLayoutParams(new AbsListView.LayoutParams(-1, bgtn.a(80.0F)));
      EventCollector.getInstance().onListGetView(paramInt, localView, paramViewGroup, getItemId(paramInt));
      return localView;
      localObject1 = (nfk)paramView.getTag();
      localView = paramView;
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      return;
    } while (!(localObject instanceof nfk));
    localObject = ((nfk)localObject).jdField_a_of_type_ComTencentAvgameGamelogicDataRoomInfo;
    mwd localmwd = (mwd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(373);
    if (localmwd != null) {
      localmwd.a(this.jdField_a_of_type_AndroidAppActivity, 5, String.valueOf(((RoomInfo)localObject).id), this.jdField_a_of_type_JavaLangString);
    }
    if (this.jdField_a_of_type_JavaLangString != null) {}
    for (localObject = this.jdField_a_of_type_JavaLangString;; localObject = "")
    {
      bcst.b(null, "dc00898", "", "", "0X800B01C", "0X800B01C", 0, 0, "", "", (String)localObject, "");
      break;
    }
  }
