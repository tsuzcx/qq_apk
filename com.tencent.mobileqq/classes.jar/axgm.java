  ...
  implements Handler.Callback
{
  ...
  private axgn jdField_a_of_type_Axgn;
  private int b;
  private int c;
  
  public axgm(int paramInt1, int paramInt2)
  {
  ...
  private boolean a(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Axgn != null) {
        this.jdField_a_of_type_Axgn.a(this.jdField_a_of_type_Axgn, bool2, i * j, this.c);
      }
      this.c += 1;
      return true;
      label179:
  ...
  public void a(axgn paramaxgn)
  {
    this.jdField_a_of_type_Axgn = paramaxgn;
  }
