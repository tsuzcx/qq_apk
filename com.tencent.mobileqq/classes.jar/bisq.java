...
public class bisq
{
  ...
  public bisq(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private void a(Activity paramActivity, int paramInt, String paramString, yas paramyas)
  {
    if (paramActivity == null) {
      return;
    }
    String str = alud.a(2131711094);
    if (1 == paramInt) {
      paramString = str + alud.a(2131711097) + paramString + alud.a(2131711092);
    }
    for (;;)
    {
      bdgm.a(paramActivity, 230, paramActivity.getString(2131698688), paramString, 2131698682, 2131698682, new bisz(this, paramyas), null).show();
      return;
      if (2 == paramInt) {
        paramString = str + alud.a(2131711096) + paramString + alud.a(2131711091);
      } else {
        paramString = alud.a(2131711093);
      }
    }
  }
  ...
  public static void a(Context paramContext, int paramInt, Bundle paramBundle)
  {
    if (paramContext == null)
    {
      ...
      Toast.makeText(BaseApplication.getContext(), alud.a(2131711095), 0).show();
      return;
    }
    ...
    if ((paramContext instanceof zcm)) {
  ...
  private void h()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 161	bisq:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +6 -> 14
    //   11: aload_0
    ...
    //   30: putfield 161	bisq:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   33: aload_0
    //   34: getfield 161	bisq:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   37: new 170	cooperation/qlink/QQProxyForQlink$9
    //   40: dup
    //   41: aload_0
    //   42: invokespecial 172	cooperation/qlink/QQProxyForQlink$9:<init>	(Lbisq;)V
    //   45: lconst_0
    //   46: ldc2_w 173
  ...
  private void j()
  {
    ...
    {
      this.jdField_b_of_type_AndroidContentBroadcastReceiver = new bisr(this);
  ...
  private void l()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 223	bisq:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   8: ifnonnull +58 -> 66
    //   11: aload_0
    //   12: new 225	biss
    //   15: dup
    //   16: aload_0
    //   17: invokespecial 226	biss:<init>	(Lbisq;)V
    //   20: putfield 223	bisq:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   37: aload_0
    //   38: getfield 28	bisq:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   41: ifnull +11 -> 52
    //   44: aload_0
    //   45: getfield 28	bisq:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   56: aload_1
    //   57: aload_0
    //   58: getfield 223	bisq:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   61: aload_2
    ...
    //   77: aload_0
    //   78: aconst_null
    //   79: putfield 223	bisq:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   82: goto -16 -> 66
    //   85: astore_1
    //   86: aload_0
    //   87: monitorexit
  ...
  private void m()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 223	bisq:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   6: ifnull +28 -> 34
    //   9: aload_0
    //   10: getfield 28	bisq:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13: ifnull +13 -> 26
    //   16: aload_0
    //   17: getfield 28	bisq:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   44: aload_0
    //   45: getfield 223	bisq:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   51: aload_0
    //   52: aconst_null
    //   53: putfield 223	bisq:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   56: goto -22 -> 34
    //   59: astore_1
    //   60: aload_0
    //   61: monitorexit
  ...
  public void a(Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener1, DialogInterface.OnClickListener paramOnClickListener2, DialogInterface.OnClickListener paramOnClickListener3, String paramString)
  {
    ...
    {
      return;
      String str2 = bdgc.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin);
      String str1;
      if (str2 != null)
      {
        str1 = str2;
      ...
      {
        a("0X8004854", 1);
        paramOnClickListener3 = paramActivity.getResources().getString(2131698728) + str1 + paramActivity.getResources().getString(2131698729);
        ...
        {
          this.jdField_a_of_type_Bdjz = bdgm.a(paramActivity, 230, paramActivity.getResources().getString(2131698689), paramOnClickListener3, paramActivity.getResources().getString(2131698730), paramActivity.getResources().getString(2131698730), paramOnClickListener2, null);
          label194:
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Bdjz.setOnDismissListener(new bisw(this));
        return;
        label224:
        str1 = this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin;
        break;
        this.jdField_a_of_type_Bdjz = bdgm.a(paramActivity, 230, paramActivity.getResources().getString(2131698689), paramOnClickListener3, paramActivity.getResources().getString(2131698730), paramActivity.getResources().getString(2131698731), paramOnClickListener1, paramOnClickListener2);
        break label194;
        if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode == 2)
        {
          a("0X8004856", 1);
          paramOnClickListener1 = str1 + paramActivity.getResources().getString(2131698727);
          this.jdField_a_of_type_Bdjz = bdgm.a(paramActivity, 230, paramActivity.getResources().getString(2131698689), paramOnClickListener1, paramActivity.getResources().getString(2131698726), paramActivity.getResources().getString(2131698726), paramOnClickListener3, null);
          this.jdField_a_of_type_Bdjz.show();
        }
  ...
  public void a(Activity paramActivity, ArrayList<String> paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean, String paramString)
  {
    ...
    paramActivity.finish();
    return;
    a(paramActivity, new bist(this, paramArrayList, paramActivity, paramInt1, paramBoolean), new bisu(this), new bisv(this), paramString);
  }
  ...
  public void a(QlAndQQInterface.InsertFMFileInfo paramInsertFMFileInfo)
  {
    ...
    String str = arrr.a(paramInsertFMFileInfo.filePath);
    long l1 = arrr.a(paramInsertFMFileInfo.filePath);
    long l2 = azaf.a(-1000).uniseq;
    ...
    localFileManagerEntity.nFileType = arrr.a(paramInsertFMFileInfo.filePath);
    ...
    if (localalto.e(String.valueOf(localFileManagerEntity.peerUin)) != null)
    {
      localFileManagerEntity.peerType = 0;
      localFileManagerEntity.peerNick = arrr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInsertFMFileInfo.uin, null, 0);
      localFileManagerEntity.status = 1;
      if ((!localalto.b(paramInsertFMFileInfo.uin)) && (!paramInsertFMFileInfo.bSend)) {
        break label356;
      }
      localFileManagerEntity.nOpType = 0;
      localFileManagerEntity.bSend = true;
      bays.a(paramInsertFMFileInfo.filePath, 0L, 0, true);
    ...
    for (;;)
    {
      ...
      bays.a(paramInsertFMFileInfo.filePath, l1, 0, false, null);
      barl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), str, 0, null);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localFileManagerEntity);
    }
  }
  ...
  {
    String str = bdgc.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
    alto localalto = (alto)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", paramString, paramString, 0, paramInt, 0, "", "", "", "");
  }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean, long paramLong1, long paramLong2, HashMap<String, String> paramHashMap)
  {
    ...
    biti.a(paramString1, paramString2, paramBoolean, paramLong1, paramLong2, paramHashMap);
  }
  
  public void a(AppActivity paramAppActivity, String paramString, yas paramyas)
  {
    if ((paramAppActivity == null) || (paramString == null)) {
      return;
    }
    bitd localbitd = bitc.a(paramString);
    if (localbitd == null)
    {
      bdgm.a(paramAppActivity, 230, paramAppActivity.getString(2131698688), paramAppActivity.getString(2131698708), 2131698682, 2131698682, new bisx(this, paramyas), null).show();
      return;
    }
    if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mWorking)
    {
      a(paramAppActivity, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerNick, paramyas);
      return;
    }
    ...
    paramyas = new Bundle();
    paramyas.putString("url", paramString);
    paramyas.putString("key", localbitd.a);
    paramyas.putString("peerUin", localbitd.b);
    paramyas.putString("peerNick", localbitd.c);
    paramyas.putString("peerOS", localbitd.d);
    paramyas.putString("apSSID", localbitd.e);
    paramyas.putString("preSharedKey", localbitd.f);
    paramyas.putBoolean("fromqlink", bool);
    paramString = paramAppActivity.getIntent().getStringExtra("subfrom");
    if (paramString != null) {
      paramyas.putString("subfrom", paramString);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    a(paramAppActivity, 11, paramyas);
    paramAppActivity.finish();
  }
  
  public void a(AppActivity paramAppActivity, yas paramyas)
  {
    if (paramAppActivity == null) {
      return;
    }
    bdgm.a(paramAppActivity, 230, paramAppActivity.getString(2131698706), paramAppActivity.getString(2131698707), 2131698682, 2131698682, new bisy(this, paramyas), null).show();
  }
  ...
  public boolean a(String paramString, List<String> paramList)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      localSendFileInfo.sessionid = arrr.a().longValue();
      localSendFileInfo.filePath = paramList;
      localSendFileInfo.fileSize = arrr.a(paramList);
  ...
  {
    if (1 == paramInt) {
      arrr.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext());
    }
  }
