  ...
  implements TroopPhotoController.OnGotoBigPicListener
{
  ...
  public void gotoBigPic(Bundle paramBundle)
  {
    ...
    localIntent.setClass(bewm.a(this.a), TroopAvatarWallEditActivity.class);
    localBundle.putInt("index", 0);
    localBundle.putString("troop_uin", bewm.a(this.a).troopUin);
    localBundle.putLong("troop_flag_ext", bewm.a(this.a).dwGroupFlagExt);
    localBundle.putBoolean("isUseClassAvatar", bewm.a(this.a).isUseClassAvatar);
    ...
    if (!localBundle.getBoolean("IS_COVER"))
    {
      ...
      paramBundle = (ArrayList)bewm.a(this.a);
      label165:
      if (!bool) {
        break label246;
      }
    ...
    for (;;)
    {
      ...
      bewm.a(this.a).startActivityForResult(localIntent, i);
      return;
      i = 0;
      break;
      label232:
      paramBundle = (ArrayList)bewm.b(this.a);
      break label165;
      label246:
