  ...
  implements View.OnClickListener, AdapterView.OnItemClickListener
{
  ...
  public avij(int paramInt, boolean paramBoolean)
  {
    super(paramInt);
    ...
    for (String str1 = this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchSpecialDataModel.a.title;; str1 = "")
    {
      ...
      for (String str2 = "hotword";; str2 = "title")
      {
        ...
        for (;;)
        {
          ...
          avwf.a("hot_list", "clk_hot_event_list", new String[] { str5, str1, str3, str2 });
          paramString = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
          avsv.a(null, new ReportModelDC02528().module("hot_list").action("clk_hot_event_list").ver2(str5).ver3(str1).ver4(str3).ver5(str2).ver7(localJSONObject.toString()).session_id(paramString.getCurrentAccountUin() + this.jdField_a_of_type_Long));
          return;
  ...
  public View a(Context paramContext, QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    for (paramViewGroup = ((BaseActivity)paramContext).getAppRuntime();; paramViewGroup = null)
    {
      ...
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131495011, null);
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131303232);
      this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131301788));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131301810));
      this.jdField_b_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131303445));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131304777));
      boolean bool = ThemeUtil.isInNightMode(BaseApplicationImpl.getApplication().getRuntime());
      this.jdField_a_of_type_AndroidWidgetGridView = ((GridView)this.jdField_a_of_type_AndroidViewView.findViewById(2131301679));
      this.jdField_a_of_type_Avil = new avil(this, paramContext, LayoutInflater.from(paramContext));
      this.jdField_a_of_type_AndroidWidgetGridView.setAdapter(this.jdField_a_of_type_Avil);
      this.jdField_a_of_type_AndroidWidgetGridView.setOnItemClickListener(this);
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131305951));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131303958));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
      if (bool)
      {
        this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2131101189);
        this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2131101188);
      }
  ...
  public void a(GridView paramGridView)
  {
    ...
    ((ViewGroup.LayoutParams)localObject).height = (aciy.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) + j);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    if (TextUtils.isEmpty(paramString1))
    {
      if (this.jdField_a_of_type_Int == 10) {
        str = avwc.a(paramString2, 5, "kandian_hotword");
      }
    }
    else
    {
      ...
      paramString1 = bade.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, str);
    ...
    while (!QLog.isColorLevel())
    {
      ...
      {
        return;
        str = avwc.a(paramString2, 5, "hotword");
        break;
  ...
  {
    HotWordSearchSpecialDataModel localHotWordSearchSpecialDataModel = (HotWordSearchSpecialDataModel)paramavpu;
    ...
    if ((localHotWordSearchSpecialDataModel.a.topicItems != null) && (localHotWordSearchSpecialDataModel.a.topicItems.size() > 0))
    {
      ...
      this.jdField_a_of_type_Avil.a(localHotWordSearchSpecialDataModel.a.topicItems);
      a(this.jdField_a_of_type_AndroidWidgetGridView);
      this.jdField_a_of_type_Avil.notifyDataSetChanged();
      ...
      label159:
      paramavpu = new ColorDrawable();
      if (!ThemeUtil.isInNightMode(BaseApplicationImpl.getApplication().getRuntime())) {
        break label601;
      }
      paramavpu.setColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131101514));
      label196:
      if (TextUtils.isEmpty(localHotWordSearchSpecialDataModel.a.leftIconUrl)) {
        break label621;
      }
      localObject1 = URLDrawable.URLDrawableOptions.obtain();
      ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = paramavpu;
      ((URLDrawable.URLDrawableOptions)localObject1).mFailedDrawable = paramavpu;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject3 = (SquareImageView)((View)localObject1).findViewById(2131302252);
        TextView localTextView = (TextView)((View)localObject1).findViewById(2131299450);
        j = (vms.a(this.jdField_a_of_type_AndroidContentContext) - vms.a(this.jdField_a_of_type_AndroidContentContext, 59.0F)) / 4;
        int m = j * 60 / 79;
        ...
        localURLDrawableOptions.mLoadingDrawable = paramavpu;
        localURLDrawableOptions.mFailedDrawable = paramavpu;
        ...
        ((View)localObject1).setVisibility(0);
        ((View)localObject1).setOnClickListener(new avik(this, (HotWordSearchSpecialDataModel.TopicImage)localObject2));
        i += 1;
      }
      ...
      break label159;
      label601:
      paramavpu.setColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131101513));
      break label196;
      label621:
    ...
    else
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = paramavpu;
      ((URLDrawable.URLDrawableOptions)localObject1).mFailedDrawable = paramavpu;
      paramavpu = URLDrawable.getDrawable(localHotWordSearchSpecialDataModel.a.iconUrl, (URLDrawable.URLDrawableOptions)localObject1);
      this.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(paramavpu);
    ...
    for (;;)
    {
      try
      {
        paramavpu = (Boolean)SearchEntryFragment.a.get(Integer.valueOf(5));
        if ((paramavpu != null) && (paramavpu.booleanValue())) {
          break;
        }
        if (this.jdField_a_of_type_Int == 3)
        {
          i = 21;
          localObject1 = avsv.a(i);
        ...
        avwf.a("hot_list", "exp_hot_event_list", new String[] { localObject1, localHotWordSearchSpecialDataModel.a.title, ((StringBuilder)localObject2).toString() });
        SearchEntryFragment.a.put(Integer.valueOf(5), Boolean.valueOf(true));
        localObject3 = new JSONObject();
      }
      catch (Exception paramavpu) {}
      try
      {
        ...
        paramavpu = "word";
        ((JSONObject)localObject3).put("template", paramavpu);
      }
      catch (JSONException paramavpu)
      {
        QLog.e("Q.uniteSearch.HotWordSearchSpecialEntryModel", 2, "e = " + paramavpu);
        continue;
      }
      paramavpu = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      avsv.a(null, new ReportModelDC02528().module("hot_list").action("exp_hot_event_list").ver2((String)localObject1).ver3(localHotWordSearchSpecialDataModel.a.title).ver4(((StringBuilder)localObject2).toString()).ver7(((JSONObject)localObject3).toString()).session_id(paramavpu.getCurrentAccountUin() + this.jdField_a_of_type_Long));
      return;
  ...
  public void onClick(View paramView)
  {
    ...
    a(true, "");
    ((ajrt)((QQAppInterface)obz.a()).getManager(299)).a(this.jdField_a_of_type_ComTencentMobileqqSearchModelHotWordSearchSpecialDataModel.a.title);
  }
  
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    if (paramInt < this.jdField_a_of_type_Avil.a().size())
    {
      paramAdapterView = (HotWordSearchSpecialDataModel.TopicItem)this.jdField_a_of_type_Avil.a().get(paramInt);
      if (!TextUtils.isEmpty(paramAdapterView.title))
      {
        ...
        ((ajrt)((QQAppInterface)obz.a()).getManager(299)).a(paramAdapterView.title);
      }
    }
  }
}
