  ...
  extends bhmn
{
    ...
    for (;;)
    {
      try
      {
        ...
        if (k >= 0)
        {
          ...
          i = j;
          if (TextUtils.isEmpty(paramai.a())) {
            break;
          }
          bhmm localbhmm = a(10);
          i = j;
          ...
          i = j;
          if (!paramai.a().equals(localbhmm.a())) {
            break;
          }
          localbhmm.a(true);
          return 0;
      ...
      {
        QZLog.e("UniKingCardHelper/SimManager", "initAllDataByAIDL 1 error:" + paramai.getMessage());
      }
      return -3;
      label156:
      i += 1;
  ...
  protected int c(Context paramContext, int[] paramArrayOfInt)
  {
    ...
    //   0: aload_1
    //   1: ldc 109
    //   3: invokevirtual 115	android/content/Context:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   6: checkcast 117	android/telephony/TelephonyManager
    //   9: astore 7
    //   11: aload 7
    ...
    //   21: aconst_null
    //   22: astore_1
    //   23: getstatic 16	bhmp:c	I
    //   26: iconst_m1
    //   27: if_icmpeq +10 -> 37
    //   30: getstatic 16	bhmp:c	I
    //   33: iconst_1
    //   34: if_icmpne +35 -> 69
    //   37: aload 5
    //   39: astore_1
    ...
    //   42: ldc 143
    //   44: iconst_1
    //   45: anewarray 125	java/lang/Class
    //   48: dup
    //   49: iconst_0
    //   50: getstatic 129	java/lang/Integer:TYPE	Ljava/lang/Class;
    //   53: aastore
    //   54: invokevirtual 133	java/lang/Class:getDeclaredMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   57: astore 5
    //   59: aload 5
    //   61: astore_1
    //   62: iconst_1
    //   63: putstatic 16	bhmp:c	I
    //   66: aload 5
    //   68: astore_1
    //   69: getstatic 16	bhmp:c	I
    //   72: iconst_m1
    //   73: if_icmpeq +10 -> 83
    //   76: getstatic 16	bhmp:c	I
    //   79: iconst_2
    //   80: if_icmpne +330 -> 410
    //   83: aload 8
    //   85: ldc 143
    //   87: iconst_1
    //   88: anewarray 125	java/lang/Class
    //   91: dup
    //   92: iconst_0
    //   93: getstatic 134	java/lang/Long:TYPE	Ljava/lang/Class;
    //   96: aastore
    //   97: invokevirtual 133	java/lang/Class:getDeclaredMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   100: astore 5
    //   102: iconst_2
    //   103: putstatic 16	bhmp:c	I
    //   106: aload 5
    //   108: astore_1
    //   109: iconst_0
    //   110: istore_3
    //   111: getstatic 16	bhmp:c	I
    //   114: iconst_m1
    ...
    //   121: aload_1
    //   122: astore 5
    //   124: getstatic 16	bhmp:c	I
    //   127: iconst_3
    //   128: if_icmpne +29 -> 157
    //   131: aload 8
    //   133: ldc 145
    //   135: iconst_1
    //   136: anewarray 125	java/lang/Class
    //   139: dup
    //   140: iconst_0
    //   141: getstatic 129	java/lang/Integer:TYPE	Ljava/lang/Class;
    //   144: aastore
    //   145: invokevirtual 133	java/lang/Class:getDeclaredMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   148: astore 5
    //   150: iconst_3
    //   151: putstatic 16	bhmp:c	I
    //   154: iconst_1
    //   155: istore 4
    //   157: getstatic 16	bhmp:c	I
    //   160: iconst_m1
    //   161: if_icmpeq +10 -> 171
    //   164: getstatic 16	bhmp:c	I
    //   167: iconst_4
    //   168: if_icmpne +233 -> 401
    //   171: aload 8
    //   173: ldc 145
    //   175: iconst_1
    //   176: anewarray 125	java/lang/Class
    //   179: dup
    //   180: iconst_0
    //   181: getstatic 134	java/lang/Long:TYPE	Ljava/lang/Class;
    //   184: aastore
    //   185: invokevirtual 133	java/lang/Class:getDeclaredMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   188: astore_1
    //   189: iconst_4
    //   190: putstatic 16	bhmp:c	I
    //   193: iconst_0
    //   194: istore_3
    //   195: getstatic 16	bhmp:c	I
    //   198: iconst_m1
    //   199: if_icmpeq +7 -> 206
    //   202: aload_1
    ...
    //   216: dup
    //   217: invokespecial 90	java/lang/StringBuilder:<init>	()V
    //   220: ldc 147
    ...
    //   233: invokevirtual 100	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   236: invokestatic 106	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   239: goto -170 -> 69
    //   242: astore 5
    //   244: iconst_1
    //   245: istore_3
    //   246: ldc 87
    //   248: new 89	java/lang/StringBuilder
    //   251: dup
    ...
    //   260: aload 5
    //   262: invokevirtual 99	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   271: invokestatic 106	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   274: goto -163 -> 111
    //   277: astore 6
    //   279: ldc 87
    ...
    //   293: aload 6
    //   295: invokevirtual 99	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   304: invokestatic 106	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   307: iload_3
    //   308: istore 4
    //   310: aload_1
    //   311: astore 5
    ...
    //   337: ldc 153
    //   339: invokevirtual 96	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   342: aload 5
    //   344: invokevirtual 99	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   347: invokevirtual 96	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   350: invokevirtual 100	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   353: invokestatic 106	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   356: goto -161 -> 195
    //   359: aload_0
    //   360: iconst_3
    //   361: aload 7
    ...
    //   364: aload_1
    //   365: iload_3
    //   366: invokevirtual 141	bhmp:a	(ILandroid/telephony/TelephonyManager;[ILjava/lang/reflect/Method;Z)I
    //   369: ireturn
    //   370: astore 5
    //   372: iconst_0
    //   373: istore_3
