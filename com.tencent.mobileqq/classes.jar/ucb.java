...
public class ucb
{
  ...
  public static DownloadInfo a(String paramString)
  {
    ...
    try
    {
      ...
      for (int i = TMAssistantDownloadConst.SHOW_NOTIFICATION_TRUE;; i = TMAssistantDownloadConst.SHOW_NOTIFICATION_FALSE)
      {
        ...
        localDownloadInfo.m = pha.f(40677);
  ...
  public static void b(Context paramContext, String paramString)
  {
    ...
    if (a != null)
    {
      ...
      paramContext.setMessage(anni.a(2131714891));
      paramContext.setNegativeButton(anni.a(2131714879), new ucd()).setPositiveButton(anni.a(2131714835), new ucc());
      paramContext.show();
      return;
    }
