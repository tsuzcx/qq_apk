  ...
  extends FacePreloadBaseAdapter
{
  ...
  public ucb(TroopTransferActivity paramTroopTransferActivity, List paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityTroopTransferActivity.getLayoutInflater().inflate(2130971516, paramViewGroup, false);
      ...
      ((TextView)paramView.findViewById(2131363532)).setText("");
