...
public class osp
{
  ...
  {
    long l = ((Long)bkwm.a("family_comment_card_hide_timestamp", Long.valueOf(-1L))).longValue();
    if (l == -1L)
    {
  ...
  public ReadInJoyCommentListFragment a(String paramString, ote paramote, ost paramost)
  {
    ...
    try
    {
      ...
      localReadInJoyCommentListFragment.a(paramote);
      localReadInJoyCommentListFragment.a(paramost);
