...
public class osp
{
  public static String a(ArticleInfo paramArticleInfo)
  {
    ...
    if (((sel.g(paramArticleInfo)) || (sel.i(paramArticleInfo))) && (paramArticleInfo.mSocialFeedInfo != null)) {
      return String.valueOf(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxt.jdField_a_of_type_Long);
    }
  ...
  {
    return oyu.g + bhkv.encodeToString(paramString.getBytes(), 2);
  }
  ...
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, CommentInfo paramCommentInfo, int paramInt1, String paramString1, String paramString2, boolean paramBoolean1, String paramString3, boolean paramBoolean2, osq paramosq, int paramInt2)
  {
    ...
    afez.a(paramActivity, localIntent, PublicTransFragmentActivity.class, ReadInJoyCommentComponentFragment.class, 117);
    if (paramosq != null) {
      paramosq.a();
    }
  }
  
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, BaseCommentData paramBaseCommentData, int paramInt1, String paramString1, String paramString2, boolean paramBoolean, osq paramosq, int paramInt2)
  {
    a(paramActivity, paramArticleInfo, paramBaseCommentData, paramInt1, paramString1, paramString2, paramBoolean, paramosq, paramInt2, true);
  }
  
  public static void a(Activity paramActivity, ArticleInfo paramArticleInfo, BaseCommentData paramBaseCommentData, int paramInt1, String paramString1, String paramString2, boolean paramBoolean1, osq paramosq, int paramInt2, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      if (paramBaseCommentData != null)
      {
        ...
        if ((paramBaseCommentData != null) && (paramBaseCommentData.mediaDataList != null) && (paramBaseCommentData.mediaDataList.size() > 0) && (((oto)paramBaseCommentData.mediaDataList.get(0)).e != 0)) {
      ...
      if (paramInt1 == 2) {
        localIntent.putExtra("comment_is_show_pic", pbb.a());
      }
  ...
  public static void a(ArticleInfo paramArticleInfo, CommentInfo paramCommentInfo, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramArticleInfo = pfa.a().a((int)paramArticleInfo.mChannelID, l);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Intent paramIntent, int paramInt)
  {
    if (paramIntent == null)
    {
      QQToast.a(BaseApplication.getContext(), 1, BaseApplication.getContext().getString(2131717056), 0).a();
    ...
    {
      otv.a(localArticleInfo, 0).b(paramQQAppInterface);
      otv.a(localArticleInfo);
      return;
    }
    pfa.a().a(localArticleInfo, paramQQAppInterface);
  }
  ...
  public static void a(String paramString, Context paramContext)
  {
    ...
    {
      return;
      paramString = oyu.g + bhkv.encodeToString(paramString.getBytes(), 2);
      ozs.a(paramContext, paramString);
    } while (!QLog.isColorLevel());
    QLog.d("ReadInJoyCommentUtils", 2, "personal url =" + paramString);
  }
  
  public static void a(String paramString, ArticleInfo paramArticleInfo, paa parampaa)
  {
    ocd.a(null, a(paramArticleInfo), paramString, paramString, 0, 0, String.valueOf(paramArticleInfo.mArticleID), String.valueOf(paramArticleInfo.mStrategyId), paramArticleInfo.innerUniqueID, parampaa.a(), false);
  }
    ...
    if (paramContext.hasPrimaryClip())
    {
      ...
      if ((localClipData != null) && (localClipData.getItemCount() > 0))
      {
        ...
        if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.getText())))
        {
          ...
          paramString = new begp(bcsa.b(paramString), 7, 18).toString();
  ...
  public static boolean a(ArticleInfo paramArticleInfo, String paramString)
  {
    ...
    localSocializeFeedsInfo.jdField_a_of_type_Qxr = new qxr();
    ...
    try
    {
      ...
      {
        localSocializeFeedsInfo.jdField_a_of_type_Qxr.b = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr.b;
        localSocializeFeedsInfo.jdField_a_of_type_Qxr.jdField_a_of_type_JavaLangLong = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxr.jdField_a_of_type_JavaLangLong;
      }
      ...
      if (i < paramString.length())
      {
        ...
        {
          localObject = new osx((String)localObject, l, paramString.getJSONObject(i).optString("biu_info_comment"));
          ((osx)localObject).jdField_a_of_type_Int = paramString.getJSONObject(i).optInt("biu_optype");
          ((osx)localObject).jdField_a_of_type_JavaLangCharSequence = paramString.getJSONObject(i).optString("biu_nickname");
    ...
    while (((Iterator)localObject).hasNext()) {
      paramString.append(((osx)((Iterator)localObject).next()).toString()).append("\n");
    }
    ...
    if ((paramArticleInfo != null) && (localArrayList.size() > 0))
    {
      ...
      for (;;)
      {
        ...
        {
          localObject = (osx)localArrayList.get(i);
          SocializeFeedsInfo.BiuCommentInfo localBiuCommentInfo = new SocializeFeedsInfo.BiuCommentInfo();
          try
          {
            localBiuCommentInfo.jdField_a_of_type_JavaLangLong = Long.valueOf(((osx)localObject).jdField_a_of_type_JavaLangString);
            if (((osx)localObject).b == null)
            {
              paramString = "";
              localBiuCommentInfo.jdField_a_of_type_JavaLangString = paramString;
              localBiuCommentInfo.c = ((osx)localObject).jdField_a_of_type_Int;
              localBiuCommentInfo.b = Long.valueOf(((osx)localObject).jdField_a_of_type_Long);
              localSocializeFeedsInfo.jdField_a_of_type_Qxr.jdField_a_of_type_JavaUtilList.add(localBiuCommentInfo);
              i += 1;
            }
          }
          catch (Exception paramString)
          {
            for (;;)
            {
              ...
              continue;
              paramString = ((osx)localObject).b.toString();
            }
          }
        }
      }
      pfa.a().a(ozs.a(), paramArticleInfo.mFeedId, localSocializeFeedsInfo.jdField_a_of_type_Qxr, 0L, ((osx)localArrayList.get(0)).b.toString(), paramArticleInfo.mArticleID, paramArticleInfo.mRecommendSeq, j, paramArticleInfo.innerUniqueID, k, paramArticleInfo);
    }
    return true;
  }
