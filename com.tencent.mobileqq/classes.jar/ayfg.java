...
public abstract class ayfg<M extends ayji, V extends ayrs>
  extends ayff<M, V>
{
  ...
  private List<ayjo> jdField_a_of_type_JavaUtilList;
  ...
  public ayfg(ListView paramListView, bcws parambcws, FullMessageSearchResult.SearchResultItem paramSearchResultItem, String paramString, QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      AbsStructMsg localAbsStructMsg = azqu.a(paramMessageRecord.msgData);
      ...
      try
      {
        ...
        if (j + 50 < this.jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult$SearchResultItem.secondPageMessageUniseq.size())
        {
          ...
          if (j < i)
          {
            ...
            this.jdField_a_of_type_JavaUtilList.add(new ayjo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult$SearchResultItem.user, localMessageRecord));
            break label177;
          }
        }
        else
