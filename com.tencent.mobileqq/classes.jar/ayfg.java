...
{
  ayfg(ayfe paramayfe, TicketManager paramTicketManager, ReSendCmd paramReSendCmd) {}
  ...
  public void Done(Ticket paramTicket)
  {
    ...
    for (;;)
    {
      ...
      paramTicket = this.jdField_a_of_type_MqqManagerTicketManager.getSkey(this.jdField_a_of_type_Ayfe.mApp.getCurrentAccountUin());
      if ((!TextUtils.isEmpty(paramTicket)) && (paramTicket.length() > 0))
      {
        ayfe.b(this.jdField_a_of_type_Ayfe, 0);
