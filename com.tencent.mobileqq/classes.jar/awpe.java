...
public class awpe
  extends RecyclerView.Adapter<awpf>
  implements aobv
{
  ...
  public awpe(Context paramContext, QQAppInterface paramQQAppInterface, RecyclerView paramRecyclerView)
  {
  ...
  private void a(awpf paramawpf, int paramInt, Drawable paramDrawable)
  {
    boolean bool = true;
    ...
    if ((localRecentBaseData instanceof MsgBackupMsgUserData))
    {
      ...
      if (this.jdField_a_of_type_Alby != null) {
        paramDrawable = this.jdField_a_of_type_Alby.a(localRecentBaseData);
      }
      if (!a(localRecentBaseData)) {
        break label233;
      }
      localQQAppInterface = ((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app;
      int j = ((Integer)alby.a(localQQAppInterface, localRecentBaseData.getRecentUserType(), localRecentBaseData.getRecentUserUin()).first).intValue();
      int i = j;
      if (j == 103) {
        i = 1;
      }
      RecentDynamicAvatarView localRecentDynamicAvatarView = paramawpf.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView;
    ...
    for (;;)
    {
      paramawpf.jdField_a_of_type_ComTencentWidgetRecentDynamicAvatarView.setImageDrawable(paramDrawable);
      paramawpf.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setText(localRecentBaseData.mTitleName);
      awpf.a(paramawpf).setChecked(((Boolean)this.jdField_a_of_type_AndroidUtilSparseArray.valueAt(paramInt)).booleanValue());
      if (AppSetting.c) {
        paramawpf.jdField_a_of_type_AndroidViewView.setContentDescription(localMsgBackupMsgUserData.name);
      }
      return;
      label224:
      break;
  ...
  private void b(awpf paramawpf, int paramInt, Drawable paramDrawable)
  {
    ...
    } while ((paramawpf == null) || (localRecentBaseData == null));
    Drawable localDrawable = paramDrawable;
    if (paramDrawable == null)
    {
      int i = localRecentBaseData.getRecentUserType();
      localDrawable = this.jdField_a_of_type_Alby.a(i, localRecentBaseData.getRecentUserUin());
    }
    a(paramawpf, paramInt, localDrawable);
  }
  
  public awpf a(ViewGroup paramViewGroup, int paramInt)
  {
    return new awpf(this, this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562782, paramViewGroup, false), this.jdField_a_of_type_Awpg);
  }
  ...
  public void a(awpf paramawpf, int paramInt)
  {
    a(paramawpf, paramInt, null);
    EventCollector.getInstance().onRecyclerBindViewHolder(paramawpf, paramInt, getItemId(paramInt));
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String arg3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        paramBitmap = (awpf)this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getChildViewHolder(paramBitmap);
        ...
        j = ((Integer)alby.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, j, ((RecentBaseData)localObject).getRecentUserUin()).first).intValue();
        if (j == -2147483648) {
          break label438;
        }
