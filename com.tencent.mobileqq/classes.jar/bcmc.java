...
public class bcmc
  extends bcgw
{
  public final ArrayList<bcgw> a;
  public boolean a;
  public int o = AIOUtils.dp2px(2.5F, BaseApplicationImpl.getContext().getResources());
  public int p = this.o;
  private int q;
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      if ((paramView != null) && ((paramView instanceof ViewGroup)))
      {
        ...
        localObject = (bcgw)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if ((localObject instanceof bclw))
        {
          localbclw = (bclw)localObject;
          localView = localbclw.a(paramContext, null, paramBundle);
      ...
      {
        ((TextView)localView).setGravity(localbclw.p);
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    while (i < j)
    {
      ...
      {
        localObject = bchg.a((String)localObject);
        if (localObject != null)
        {
  ...
  {
    boolean bool2 = false;
    Object localObject1 = parambcin.a("mode");
    if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
    boolean bool1;
    try
    {
      this.q = Integer.valueOf((String)localObject1).intValue();
      localObject1 = parambcin.a("margin");
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
    ...
    catch (NumberFormatException localNumberFormatException1)
    {
      try
      {
        do
        {
          ...
          this.o = AIOUtils.dp2px(Float.valueOf(localObject1[0]).floatValue(), (Resources)localObject2);
          this.p = AIOUtils.dp2px(Float.valueOf(localObject1[1]).floatValue(), (Resources)localObject2);
          localObject1 = parambcin.a("hidden");
          ...
          while (i < parambcin.a())
          {
            localObject1 = parambcin.a(i);
            if ((localObject1 != null) && ("td".equals(((bcin)localObject1).b)))
            {
              localObject2 = bchg.a(((bcin)localObject1).b);
              bool1 = bool2;
              if (localObject2 == null) {
                return bool1;
              }
              bool1 = bool2;
              if (!((bcgw)localObject2).a((bcin)localObject1)) {
                return bool1;
              }
              a((bcgw)localObject2);
            }
