  ...
  implements Manager
{
  ...
  static
  {
    ...
    String[] arrayOfString1 = { "4GC2CBigPicNotSupportCount", "4GDiscussionBigPicNotSupportCount", "4GGroupBigPicNotSupportCount", "4GDigitalGroupBigPicNotSupportCount" };
    String[] arrayOfString2 = { "XGC2CBigPicNotSupportCount", "XGDiscussionBigPicNotSupportCount", "XGGroupBigPicNotSupportCount", "XGDigitalGroupBigPicNotSupportCount" };
  ...
  @TargetApi(9)
  public azqq(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      bdmc.a(BaseApplication.getContext()).a(str, "PicStatisticsManagerUploadPic", false, 0L, 0L, localHashMap1, "");
    ...
    for (;;)
    {
      bdmc.a(BaseApplication.getContext()).a(str, "PicStatisticsManagerDownloadPic", false, 0L, 0L, localHashMap2, "");
      b();
      return;
      str = null;
      break;
      label280:
      bdmc.a(BaseApplication.getContext()).a(str, "PicStatisticsManagerPredownloadThumbPic", false, 0L, 0L, a(l), "");
      l1 = this.jdField_a_of_type_AndroidContentSharedPreferences.getLong("PicStatisticsManagerPredownloadCountWifi", 0L);
      ...
      if (l1 + l4 > 0L) {
        bdmc.a(BaseApplication.getContext()).a(str, "PicStatisticsManagerPredownloadDataWifi", false, 0L, 0L, a(i), "");
      }
      if (l3 + l6 > 0L) {
        bdmc.a(BaseApplication.getContext()).a(str, "PicStatisticsManagerPredownloadData4g", false, 0L, 0L, a(j), "");
      }
      if (l2 + l5 > 0L) {
        bdmc.a(BaseApplication.getContext()).a(str, "PicStatisticsManagerPredownloadDataXg", false, 0L, 0L, a(k), "");
      }
      if (l4 + l5 > 0L)
      {
        bdmc.a(BaseApplication.getContext()).a(str, "PicStatisticsManagerDiffSizePicPreviewC2C", false, 0L, 0L, a(jdField_c_of_type_JavaUtilList), "");
        bdmc.a(BaseApplication.getContext()).a(str, "PicStatisticsManagerDiffSizePicPreviewGroup", false, 0L, 0L, a(jdField_d_of_type_JavaUtilList), "");
        bdmc.a(BaseApplication.getContext()).a(str, "PicStatisticsManagerDiffSizePicPreviewC2CDynamic", false, 0L, 0L, a(e), "");
        bdmc.a(BaseApplication.getContext()).a(str, "PicStatisticsManagerDiffSizePicPreviewGroupDynamic", false, 0L, 0L, a(f), "");
      }
      if (l4 > 0L) {
        bdmc.a(BaseApplication.getContext()).a(str, "PicStatisticsManagerPredownloadMissPriorityWifi", false, 0L, 0L, a(g), "");
      }
      if (l5 <= 0L) {
        break label115;
      }
      bdmc.a(BaseApplication.getContext()).a(str, "PicStatisticsManagerPredownloadMissPriorityXG", false, 0L, 0L, a(h), "");
      break label115;
      label693:
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();; str = null)
    {
      ...
      bdmc.a(BaseApplication.getContext()).a(str, "PicStatisticsManagerPredownloadMissReasonGrayForWifi", false, 0L, 0L, localHashMap, "");
      return;
    }
    bdmc.a(BaseApplication.getContext()).a(str, "PicStatisticsManagerPredownloadMissReasonGrayForXG", false, 0L, 0L, localHashMap, "");
  }
  ...
  public void b(MessageForPic paramMessageForPic)
  {
    ...
    int n;
    String str1;
    if (azqi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPic.istroop, paramMessageForPic.frienduin) == 3)
    {
      m = 1;
      n = bbkh.a(l1, l2);
      if (n != 0) {
    ...
    {
      str2 = str1;
      if (bmgb.a(paramMessageForPic.imageType)) {
        str2 = str1 + "Dynamic";
      }
