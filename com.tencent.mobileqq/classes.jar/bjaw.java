...
public class bjaw
{
  ...
  public static void a(long paramLong, Activity paramActivity, String paramString, bjay parambjay)
  {
    ...
    bjax localbjax2 = b();
    if (QLog.isColorLevel()) {
      QLog.d("QZoneVideoCommonUtils", 2, "support record=" + localbjax1.a() + ", support trim=" + localbjax2.a());
    }
    if ((!localbjax1.a()) && (!localbjax2.a()))
    {
      if (localbjax1.b()) {}
      for (paramString = localbjax1.a();; paramString = null)
      {
        String str;
        if (paramString != null)
        {
        ...
        {
          str = paramActivity.getString(2131718638);
        }
        if (parambjay != null) {
          parambjay.onFail(paramActivity, str);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.w("QZoneVideoCommonUtils", 2, "qzone video is not supported, recordSupport tips=" + localbjax1.a() + ",trimSupport tips=" + localbjax2.a() + ",show tips=" + str);
        return;
      }
    }
    a(paramLong, paramActivity, localbjax1.a(), localbjax2.a(), paramString);
    PerfTracer.traceEnd("Video_component_pre_launch");
  }
  
  public static void a(long paramLong, Activity paramActivity, String paramString, bjay parambjay, Bundle paramBundle)
  {
    PerfTracer.traceStart("Video_component_pre_launch");
    if (paramActivity == null)
    {
    ...
    if ((!localbjax1.a()) && (!localbjax2.a()))
    {
      ...
      for (paramString = localbjax1.a();; paramString = null)
      {
        ...
        {
          paramBundle = paramActivity.getString(2131718638);
        }
        if (parambjay != null) {
          parambjay.onFail(paramActivity, paramBundle);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.w("QZoneVideoCommonUtils", 2, "qzone video is not supported, recordSupport tips=" + localbjax1.a() + ",trimSupport tips=" + localbjax2.a() + ",show tips=" + paramBundle);
        return;
      }
    }
