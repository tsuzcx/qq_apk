  ...
  public void a(boolean paramBoolean)
  {
    if ((this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem != null))
    {
      ...
      if (this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130843607);
      }
    }
    else
    {
    ...
    this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130843641);
    return;
    label45:
    if (this.jdField_a_of_type_Boolean)
    {
    ...
    this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130843638);
  }
}
