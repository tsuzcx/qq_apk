  ...
  implements Manager
{
  ...
  public bkgt(AppInterface paramAppInterface)
  {
  ...
  {
    String str = bhlg.m(paramQQAppInterface, paramString);
    if ((TextUtils.isEmpty(str)) || (str.equals(paramString)))
    {
      paramQQAppInterface = ((bkgt)paramQQAppInterface.getManager(165)).a(String.valueOf(paramString));
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool1)
        {
          ...
          localbkgt.a(localBmqqAccountType);
          if (!bool1) {
            continue;
          }
          QidianExternalInfo localQidianExternalInfo = localbkgt.a(paramString);
          paramString = localbkgt.a(paramString);
          if ((localQidianExternalInfo != null) && (paramString != null)) {
            continue;
          }
          if (blho.a()) {
            ThreadManager.post(new QidianManager.10(localbkgt, paramQQAppInterface, localBmqqAccountType), 5, null, true);
          }
        }
        else
        {
        ...
        localbkgt.b(paramQQAppInterface.getApp().getBaseContext(), localBmqqAccountType);
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    try
    {
      ...
      if (!nmd.a(paramString1)) {
        return;
      }
      ((bkgt)paramQQAppInterface.getManager(165)).h.put(paramString1, paramString2);
      return;
    }
    catch (Exception paramQQAppInterface) {}
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Friends[] paramArrayOfFriends)
  {
    ...
    {
      localbkgt = (bkgt)paramQQAppInterface.getManager(165);
      if (blho.a()) {
        ThreadManager.postImmediately(new QidianManager.9(localbkgt, paramQQAppInterface, paramArrayOfFriends), null, false);
      }
    }
    else
    {
    ...
    localbkgt.b(paramQQAppInterface, paramArrayOfFriends);
  }
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    if ((!TextUtils.isEmpty(paramString1)) && (paramString1.contains("isNeedReply=")) && (paramString1.contains("QidianKfUin=")))
    {
      ...
      if (bool2)
      {
        ...
        SosoInterface.a(new bkgu(this, 1, true, true, 0L, true, false, "QidianManager", paramString1, paramInt1, str3, paramInt2, str2, str1, paramString2));
      }
    }
    label364:
    while (!QLog.isColorLevel())
  ...
  {
    boolean bool2 = true;
    paramQQAppInterface = (bkgt)paramQQAppInterface.getManager(165);
    boolean bool1 = bool2;
    if (paramFriends != null)
    {
      bool1 = bool2;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    return ((((bkgt)paramQQAppInterface.getManager(165)).a(paramMessageRecord.frienduin)) || (paramMessageRecord.istroop == 1024)) && (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("is_eman_sc_message")));
  }
  
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    return ((bkgt)paramQQAppInterface.getManager(165)).e(paramString);
  }
  
  private boolean a(String paramString, int paramInt)
  {
    Object localObject = (anyw)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(51);
    if (localObject != null)
    {
      localObject = ((anyw)localObject).b(paramString);
  ...
  private void b(QQAppInterface paramQQAppInterface, Friends[] paramArrayOfFriends)
  {
    ...
    //   36: pop2
    //   37: aload 10
    //   39: invokestatic 338	nmd:a	(Ljava/lang/String;)Z
    //   42: ifne +4 -> 46
    //   45: return
    //   46: iload 5
    //   48: invokestatic 341	bkgt:b	(I)Z
    //   51: istore 6
    //   53: iload 5
    //   55: invokestatic 343	bkgt:a	(I)Z
    //   58: istore 7
    //   60: iload 5
    //   62: invokestatic 345	bkgt:c	(I)Z
    //   65: istore 8
    //   67: iload 6
    //   69: ifne +60 -> 129
    //   72: iload 7
    ...
    //   155: aload_0
    //   156: aload 10
    //   158: invokevirtual 591	bkgt:a	(Ljava/lang/String;)I
    //   161: aload 9
    //   163: invokevirtual 595	com/tencent/qidian/data/BmqqAccountType:getAccountType	()I
    //   166: if_icmpeq +119 -> 285
    //   169: aload_0
    //   170: getfield 50	bkgt:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   173: aload 10
    //   175: aload 9
    ...
    //   194: aload_0
    //   195: aload 10
    //   197: invokevirtual 126	bkgt:a	(Ljava/lang/String;)Lcom/tencent/qidian/data/QidianExternalInfo;
    //   200: astore 11
    //   202: aload_0
    //   203: aload 10
    //   205: invokevirtual 364	bkgt:a	(Ljava/lang/String;)Lcom/tencent/qidian/data/QidianProfileUiInfo;
    //   208: astore 10
    //   210: aload 11
    //   212: ifnull +8 -> 220
    //   215: aload 10
    ...
    //   228: aload 9
    //   230: invokevirtual 385	bkgt:b	(Landroid/content/Context;Lcom/tencent/qidian/data/BmqqAccountType;)Z
    //   233: pop
    //   234: goto +51 -> 285
    //   237: astore_1
    //   238: aload_1
  ...
  {
    return ((bkgt)paramQQAppInterface.getManager(165)).f(paramString);
  }
  ...
  public int a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (nok.b(paramQQAppInterface, paramString, 0)) {
        return 3;
      }
    } while (a(paramString));
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      return String.format(paramContext.getString(2131697843), new Object[] { paramString });
    }
    return paramContext.getString(2131697842);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localObject2 = bdow.a(paramString.getBytes(), 0);
    ...
    for (;;)
    {
      ...
      if (aoci.a(paramQQAppInterface, paramString, false)) {
        break;
      }
  ...
  {
    ((bkib)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(paramString1, paramInt1, paramBoolean, 0.0D, 0.0D, paramString2, paramInt2, paramString3, paramString4, paramString5);
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ((bkib)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(paramString1, paramString2, paramString3);
      return;
  ...
  {
    if ((!nmd.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (nmd.a(null, paramString))) {
      ((anum)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(2)).a(paramString, paramBoolean);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    while (localIterator.hasNext()) {
      ((bkgv)localIterator.next()).a(paramBoolean);
    }
  }
      ...
      try
      {
        ...
        if (nmd.a(paramContext))
        {
          ...
          default: 
            return false;
          case 1: 
            ((bkib)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).b(l);
            return true;
          }
          ((bkib)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).d(l);
          return true;
        }
      }
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      Long.parseLong(paramString);
      if (!nmd.a(paramString)) {}
      while ((nmd.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (!nmd.a(null, paramString))) {
        return false;
      }
  ...
  {
    ((anum)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(2)).d(paramString);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (nmd.a(paramContext))
        {
          ...
          case 0: 
          case 2: 
            ((nma)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(37)).a(paramContext);
            return true;
          case 1: 
            ((bkib)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(l);
            return true;
          }
          ((bkib)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).c(l);
          return true;
        }
      }
      catch (Exception paramContext) {}
