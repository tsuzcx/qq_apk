  ...
  extends amiz
{
  ...
  public amjd(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public static boolean a(ProxyManager paramProxyManager, String paramString)
  {
    ...
    {
      amjh localamjh = (amjh)paramProxyManager.next();
      if ((String.valueOf(0).equals(localamjh.jdField_a_of_type_JavaLangString)) && (localamjh.jdField_a_of_type_Int == 0) && (localamjh.jdField_b_of_type_JavaLangString.equals(paramString)) && ((localamjh.jdField_b_of_type_Int == 1) || (localamjh.jdField_b_of_type_Int == 2) || (localamjh.jdField_b_of_type_Int == 0))) {
        return true;
      }
    }
    return false;
  ...
  private long c(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 142	amjd:a	()V
    //   6: aload_1
    //   7: aload_0
    //   8: getfield 144	amjd:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    ...
    //   19: aload_0
    //   20: getfield 144	amjd:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   23: aload_1
    ...
    //   27: astore 4
    //   29: aload_0
    //   30: invokespecial 175	amjd:f	()V
    //   33: aload_0
    //   34: getfield 29	amjd:b	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   37: ifnull +17 -> 54
    //   40: aload 4
    //   42: ifnonnull +21 -> 63
    //   45: aload_0
    //   46: getfield 29	amjd:b	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   49: aload_1
    ...
    //   62: lreturn
    //   63: aload_0
    //   64: getfield 29	amjd:b	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   67: aload 4
  ...
  private void e(long paramLong)
  {
    ...
    localObject = arni.a(localDataLineMsgRecord);
    ...
    if (!localDataLineMsgRecord.isSend()) {
      ((FileManagerEntity)localObject).srvTime = (ayvc.a() * 1000L);
    }
  ...
  public DataLineMsgRecord a()
  {
    ...
    //   3: invokevirtual 142	amjd:a	()V
    //   6: aload_0
    //   7: getfield 144	amjd:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   10: astore_1
    //   11: aload_1
    //   12: ifnonnull +9 -> 21
    //   15: aconst_null
    ...
    //   20: areturn
    //   21: aload_0
    //   22: getfield 144	amjd:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   25: aload_0
    //   26: getfield 144	amjd:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    ...
    for (;;)
    {
      try
      {
        ...
        if (a(this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager, this.jdField_a_of_type_JavaLangString)) {
          this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(localawbw);
        }
        ThreadManager.post(new DataLineMsgProxy.1(this, localawbw, (String)localObject1), 5, null, true);
        Object localObject3 = localawbw.a(DataLineMsgRecord.class, a(-1L, 15), null);
        localObject1 = localObject3;
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          if ((str != null) && (str.contains("/Tencent/QQfile_recv/"))) {
            ((DataLineMsgRecord)localObject3).path = bduw.a(str);
          }
          str = ((DataLineMsgRecord)localObject3).thumbPath;
          if ((str != null) && (str.contains("/Tencent/QQfile_recv/"))) {
            ((DataLineMsgRecord)localObject3).thumbPath = bduw.a(str);
          }
  ...
  public void a(int paramInt, amje paramamje)
  {
    ...
    ThreadManager.post(new DataLineMsgProxy.13(this, l1, paramInt, paramamje), 8, null, true);
  }
  ...
  public void a(awbv paramawbv, amji paramamji)
  {
    ...
    if (Thread.currentThread() == localLooper.getThread())
    {
      paramawbv = ((DataLineMsgRecord)paramawbv).clone();
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(String.valueOf(0), 0, this.jdField_a_of_type_JavaLangString, paramawbv, 0, paramamji);
      return;
    }
    new Handler(localLooper).post(new DataLineMsgProxy.2(this, paramawbv, paramamji, localew));
    localew.a(-1L);
  }
  ...
  public void a(String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString, amji paramamji)
  {
    ...
    new Handler(localLooper).post(new DataLineMsgProxy.3(this, paramString1, paramContentValues, paramString2, paramArrayOfString, paramamji));
  }
  ...
  public void a(String paramString1, String paramString2, String[] paramArrayOfString, amji paramamji)
  {
    ...
    new Handler(localLooper).post(new DataLineMsgProxy.4(this, paramString1, paramString2, paramArrayOfString, paramamji));
  }
