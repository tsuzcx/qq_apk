...
public class aqnd
{
  ...
  public String a;
  List<aqnk> jdField_a_of_type_JavaUtilList = new ArrayList();
  public boolean a;
  public byte[] a;
  public String b;
  public boolean b;
  ...
  void a(AppInterface paramAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localJSONObject.put("openid", this.jdField_a_of_type_Aqkd.a().jdField_b_of_type_JavaLangString);
        localJSONObject.put("accesstoken", this.jdField_a_of_type_Aqkd.a().jdField_a_of_type_JavaLangString);
  ...
  public void a(AppInterface paramAppInterface, aqnl paramaqnl)
  {
    if (!baig.d(paramAppInterface.getApp().getApplicationContext())) {
      return;
    }
    if (this.jdField_a_of_type_Long == 0L)
    {
      b(paramAppInterface);
      paramAppInterface = new aqnh(this, paramAppInterface, paramaqnl);
      this.jdField_a_of_type_JavaUtilList.add(paramAppInterface);
      return;
    }
    b(paramAppInterface, paramaqnl);
  }
  ...
  public void a(AppInterface paramAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Long == 0L)
      {
        this.jdField_a_of_type_JavaUtilList.add(new aqne(this, paramAppInterface));
        b(paramAppInterface);
        return;
      }
    }
  ...
  public void b(AppInterface paramAppInterface)
  {
    ...
    if (this.jdField_a_of_type_Aqkd == null) {
      this.jdField_a_of_type_Aqkd = new aqkd();
    }
    this.jdField_a_of_type_Aqkd.a(paramAppInterface, "", paramAppInterface.getApplication(), "101462571", new aqnf(this, paramAppInterface));
  }
  
  void b(AppInterface paramAppInterface, aqnl paramaqnl)
  {
    if (this.jdField_a_of_type_Boolean) {
      return;
    }
    ...
    localObject = new NewIntent(paramAppInterface.getApplication(), mmi.class);
    ((NewIntent)localObject).putExtra("cmd", this.f + ".0x2791_0x1");
    ((NewIntent)localObject).putExtra("data", localiLiveRequest.toByteArray());
    ((NewIntent)localObject).setObserver(new aqni(this, paramaqnl));
  ...
  public void b(AppInterface paramAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      paramString.put("openid", this.jdField_a_of_type_Aqkd.a().jdField_b_of_type_JavaLangString);
      paramString.put("accesstoken", this.jdField_a_of_type_Aqkd.a().jdField_a_of_type_JavaLangString);
  ...
  public void c(AppInterface paramAppInterface)
  {
    ...
    ((NewIntent)localObject).putExtra("data", localiLiveRequest.toByteArray());
    ((NewIntent)localObject).setObserver(new aqnj(this));
    paramAppInterface.startServlet((NewIntent)localObject);
  }
}
