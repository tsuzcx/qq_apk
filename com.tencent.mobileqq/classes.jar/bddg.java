...
public final class bddg
{
  ...
  public static <T extends bddf> T a(int paramInt1, int paramInt2, String paramString)
  {
    if (paramInt1 == 2) {
  ...
  public static String a(@NonNull String paramString, @NonNull Bundle paramBundle)
  {
    ...
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_TROOP_UIN"))
    {
      ...
      localObject = bjnd.a(paramString, "troopuin", (String)localObject);
    }
    ...
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_OWNER_UIN"))
    {
      ...
      paramString = bjnd.a((String)localObject, "troopowneruin", paramString);
    }
    localObject = paramString;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_IS_OWNER")) {
      localObject = bjnd.a(paramString, "isowner", paramBundle.getBoolean("TOGETHER_BUNDLE_KEY_IS_OWNER", false) + "");
    }
    paramString = (String)localObject;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_IS_ADMIN")) {
      paramString = bjnd.a((String)localObject, "isadmin", paramBundle.getBoolean("TOGETHER_BUNDLE_KEY_IS_ADMIN", false) + "");
    }
    localObject = paramString;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_OPEN_STATUS")) {
      localObject = bjnd.a(paramString, "isopen", paramBundle.getBoolean("TOGETHER_BUNDLE_KEY_OPEN_STATUS", false) + "");
    }
    paramString = (String)localObject;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_FROM_TYPE")) {
      paramString = bjnd.a((String)localObject, "from", paramBundle.getInt("TOGETHER_BUNDLE_KEY_FROM_TYPE", 0) + "");
    }
    if (QLog.isColorLevel()) {
      ...
      catch (Throwable localThrowable)
      {
        try
        {
          ...
          catch (Exception localException1)
          {
            ...
            bdct.a(localBaseActivity.app).a(localBaseActivity, paramInt, i, paramMap1, l1, 8, (Bundle)localObject2);
            return;
          }
          if (((i != 2) && (i != 1)) || (l1 == 0L))
          {
  ...
  public static void a(@NonNull Context paramContext, int paramInt1, @NonNull String paramString1, @Nullable String paramString2, @NonNull Bundle paramBundle, int paramInt2)
  {
    ...
    {
    default: 
      QQToast.a(paramContext, 0, 2131719605, 0).a();
      return;
    case 1: 
  ...
  public static void a(@NonNull QQAppInterface paramQQAppInterface, @NonNull bddf parambddf, boolean paramBoolean)
  {
    a(paramQQAppInterface, parambddf.d + "_" + parambddf.jdField_e_of_type_Int + "_" + parambddf.jdField_e_of_type_JavaLangString, paramBoolean, true);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 2)
      {
        ...
        paramString = ((amsw)localObject).a(paramString, false);
        if (paramString != null)
        {
          bool = paramString.isTogetherBusinessOpen(paramInt2);
          paramString.setTogetherBusiness(paramBoolean, paramInt2);
          ((amsw)localObject).a(paramString);
          if (QLog.isColorLevel()) {
            QLog.i("TogetherUtils", 2, "setBusinessTogetherOpen troopinfo saved, last=" + bool);
          }
          i = j;
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      {
        bcef.b(null, "dc00899", "Grp_AIO", "", "video_tab", paramString1, 0, 0, paramString2, "", "", "");
        return;
      }
    }
  }
  
  public static boolean a(Intent paramIntent, bddf parambddf, boolean paramBoolean)
  {
    if (!paramBoolean) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      return false;
      if ((parambddf.g == 1) && (parambddf.h != 2)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("TogetherUtils", 2, new Object[] { "invokeJoinDialog togetherSession.status=", Integer.valueOf(parambddf.g), " togetherSession.userState=", Integer.valueOf(parambddf.h) });
    return false;
    return true;
  }
  
  public static boolean a(@NonNull QQAppInterface paramQQAppInterface, @NonNull bddf parambddf)
  {
    return a(paramQQAppInterface, parambddf.d + "_" + parambddf.jdField_e_of_type_Int + "_" + parambddf.jdField_e_of_type_JavaLangString, true, true);
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      paramQQAppInterface = localamsw.a(paramString, false);
      paramString = localamsw.b(paramString);
  ...
  public static boolean a(ChatMessage paramChatMessage)
  {
    ...
    try
    {
      ...
      paramChatMessage = aoqp.a(paramChatMessage).get("type");
  ...
  public static String b(@NonNull String paramString, @NonNull Bundle paramBundle)
  {
    ...
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_C2C_FRIEND_OPENID")) {
      str = bjnd.a(paramString, "friend_user_openid", paramBundle.getString("TOGETHER_BUNDLE_KEY_C2C_FRIEND_OPENID"));
    }
    paramString = str;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_OPEN_STATUS")) {
      paramString = bjnd.a(str, "isopen", paramBundle.getBoolean("TOGETHER_BUNDLE_KEY_OPEN_STATUS") + "");
    }
    str = paramString;
    if (paramBundle.containsKey("TOGETHER_BUNDLE_KEY_FROM_TYPE")) {
      str = bjnd.a(paramString, "from", paramBundle.getInt("TOGETHER_BUNDLE_KEY_FROM_TYPE") + "");
    }
    if (QLog.isColorLevel()) {
