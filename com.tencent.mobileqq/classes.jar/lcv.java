...
public class lcv
{
  ...
  public lcv(VideoAppInterface paramVideoAppInterface)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Long = mnr.a().n;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          lez locallez = ((VideoController)localObject1).a();
          str1 = locallez.jdField_d_of_type_JavaLangString;
          str2 = locallez.e;
          i = locallez.F;
          j = locallez.jdField_d_of_type_Int;
          bool1 = locallez.N;
          bool2 = locallez.P;
          bool3 = locallez.g;
  ...
  public void a()
  {
    ...
    {
      lcw.a(true, System.currentTimeMillis() - this.jdField_b_of_type_Long);
      ...
      {
        localObject = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a();
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(((lez)localObject).j, ((lez)localObject).jdField_d_of_type_JavaLangString, ((lez)localObject).f);
      }
    }
    a(true);
    d();
  ...
  public void a(int paramInt)
  {
    ...
    {
      this.d = false;
      lcw.a(paramInt, System.currentTimeMillis() - this.jdField_c_of_type_Long);
    }
    a(false);
    f();
  }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ((lez)localObject3).j = 0;
        ((lez)localObject3).jdField_d_of_type_JavaLangString = ((String)localObject1);
        ((lez)localObject3).e = ((String)localObject2);
        ((lez)localObject3).F = j;
        ((lez)localObject3).ai = true;
        ((lez)localObject3).i = l2;
        ((lez)localObject3).a(l3, "recoverLastCallIfNeed", 1);
        ((lez)localObject3).S = true;
        ((lez)localObject3).N = bool1;
        ((lez)localObject3).g = bool3;
        ...
        if (lzb.f())
        {
          lzb.a(l3, 1, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp(), false, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), false);
          localObject1 = ((VideoController)localObject2).a;
          if (localObject1 != null) {
            ((mua)localObject1).a("DEVICE_SPEAKERPHONE;DEVICE_EARPHONE;DEVICE_BLUETOOTHHEADSET;DEVICE_WIREDHEADSET;");
          }
          this.jdField_c_of_type_Boolean = true;
          this.jdField_b_of_type_Long = System.currentTimeMillis();
          this.e = bool2;
          lcw.a(paramInt, paramLong, this.jdField_c_of_type_Boolean);
          return;
        }
      }
      catch (Throwable localThrowable)
      ...
      lzb.a(0L, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 2);
      continue;
      label589:
