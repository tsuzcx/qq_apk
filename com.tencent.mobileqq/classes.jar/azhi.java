  ...
  extends OGAbstractDao
{
  ...
  public Entity cursor2Entity(Entity paramEntity, Cursor paramCursor, boolean paramBoolean, NoColumnErrorHandler paramNoColumnErrorHandler)
  {
    ...
    if (i == -1)
    {
      ...
      paramNoColumnErrorHandler.handleNoColumnError(new NoColumnError("infoSeq", Long.TYPE));
      label438:
      ...
      paramNoColumnErrorHandler.handleNoColumnError(new NoColumnError("inheritOwnerUin", String.class));
      label506:
      i = paramCursor.getColumnIndex("discussionName");
      if (i != -1) {
        break label1090;
      }
      paramNoColumnErrorHandler.handleNoColumnError(new NoColumnError("discussionName", String.class));
      label540:
      i = paramCursor.getColumnIndex("createTime");
      if (i != -1) {
        break label1105;
      }
      paramNoColumnErrorHandler.handleNoColumnError(new NoColumnError("createTime", Long.TYPE));
      label575:
      ...
      paramNoColumnErrorHandler.handleNoColumnError(new NoColumnError("faceUinSet", String.class));
      label644:
      i = paramCursor.getColumnIndex("DiscussionFlag");
      if (i != -1) {
        break label1150;
      }
      paramNoColumnErrorHandler.handleNoColumnError(new NoColumnError("DiscussionFlag", Long.TYPE));
      label679:
      ...
      paramNoColumnErrorHandler.handleNoColumnError(new NoColumnError("mOrigin", Long.TYPE));
      label783:
      i = paramCursor.getColumnIndex("mOriginExtra");
      if (i != -1) {
        break label1210;
      }
      paramNoColumnErrorHandler.handleNoColumnError(new NoColumnError("mOriginExtra", Long.TYPE));
      label818:
      i = paramCursor.getColumnIndex("mSelfRight");
      if (i != -1) {
        break label1225;
      }
      paramNoColumnErrorHandler.handleNoColumnError(new NoColumnError("mSelfRight", Integer.TYPE));
      label853:
      i = paramCursor.getColumnIndex("groupCode");
      if (i != -1) {
        break label1240;
      }
      paramNoColumnErrorHandler.handleNoColumnError(new NoColumnError("groupCode", Long.TYPE));
      label888:
      i = paramCursor.getColumnIndex("groupUin");
      if (i != -1) {
        break label1255;
      }
      paramNoColumnErrorHandler.handleNoColumnError(new NoColumnError("groupUin", Long.TYPE));
      label923:
      i = paramCursor.getColumnIndex("hasCollect");
      if (i != -1) {
        break label1270;
      }
      paramNoColumnErrorHandler.handleNoColumnError(new NoColumnError("hasCollect", Boolean.TYPE));
      i = paramCursor.getColumnIndex("createFrom");
      if (i != -1) {
        break label1298;
      }
      paramNoColumnErrorHandler.handleNoColumnError(new NoColumnError("createFrom", Integer.TYPE));
    }
    for (;;)
    {
      ...
      paramNoColumnErrorHandler.handleNoColumnError(new NoColumnError("uiControlFlag", Long.TYPE));
      return paramEntity;
