...
public final class bblj
{
  ...
  public static int a()
  {
    ...
    if (!TextUtils.isEmpty(bbbm.a("ro.build.version.opporom"))) {
      return 3;
    }
    if (!TextUtils.isEmpty(bbbm.a("ro.vivo.os.version"))) {
      return 4;
    }
    return 0;
  }
  ...
  public static void a()
  {
    ...
    if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface))
    {
      ...
      aqxj localaqxj = (aqxj)((QQAppInterface)localObject).getManager(219);
      if (localaqxj != null) {
        localaqxj.d();
      }
  ...
  public static void a(Activity paramActivity, AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, Bundle paramBundle)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      {
        localObject1 = bbqd.a("signatureEntrance");
        str1 = str2;
      }
    ...
    for (;;)
    {
      ...
      localObject1 = bbqd.a("signatureDIYEntrance");
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      {
        if (i != 0) {
          ((avps)paramQQAppInterface.getManager(36)).b("100005");
        }
        return;
        i = 0;
        break;
    ...
    for (BubbleManager localBubbleManager = (BubbleManager)paramQQAppInterface.getManager(44);; localBubbleManager = null)
    {
      if ((paramXListView != null) && (localBubbleManager != null))
      {
        ...
        while (i >= 0)
        {
          ...
          {
            acuj localacuj = (acuj)actj.a((View)localObject);
            localObject = actj.a((View)localObject);
            if ((localObject != null) && (((ChatMessage)localObject).needVipBubble()) && (localacuj != null) && (localacuj.a != null) && (localacuj.a.jdField_a_of_type_Int == amcg.a.jdField_a_of_type_Int) && (localBubbleManager.a(akfv.a(((ChatMessage)localObject).vipBubbleID)))) {
              return true;
            }
            if ((localObject != null) && (((ho)paramQQAppInterface.getManager(42)).a(localacuj, (ChatMessage)localObject))) {
              return true;
            }
          }
          else if ((localObject != null) && ((actj.a((View)localObject) instanceof adys)))
          {
            return true;
          }
          i -= 1;
