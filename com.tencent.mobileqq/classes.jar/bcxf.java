  ...
  implements bcwz
{
  ...
  private bcxg jdField_a_of_type_Bcxg;
  
  public bcxf(bcxa parambcxa)
  {
    bcwx localbcwx = parambcxa.a;
    if (localbcwx != null) {
      localbcwx.setNetTransportEventListener("sig_check", this);
    }
    this.jdField_a_of_type_Bcxa = parambcxa;
  }
  
  public void a(bcxg parambcxg)
  {
    this.jdField_a_of_type_Bcxg = parambcxg;
  }
  ...
  public void a(Object paramObject1, Object paramObject2)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return;
          } while (this.jdField_a_of_type_Bcxa == null);
          paramObject1 = this.jdField_a_of_type_Bcxa.a;
    ...
    try
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Bcxg.a(paramObject1.toString());
        return;
      }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        l2 = l1;
        continue;
        localObject2 = this.jdField_a_of_type_Bcxa.a;
        if (localObject2 == null) {
          continue;
        }
        localObject1 = paramString.toByteArray();
        localObject4 = ((bcwx)localObject2).getCodec("sig_check");
        paramString = (String)localObject1;
        if (localObject4 != null) {
          paramString = ((bcwy)localObject4).encode(localObject1);
        }
        ((bcwx)localObject2).send(paramString);
        return;
      }
      try
      {
