  ...
  implements Handler.Callback
{
  ...
  Comparator<lkb> jdField_a_of_type_JavaUtilComparator = new lka(this);
  private final ConcurrentHashMap<ChatRoomInfo, ConcurrentLinkedQueue<lkb>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  public ljz(VideoAppInterface paramVideoAppInterface)
  {
  ...
  {
    Object localObject1 = lcb.a().a();
    int i = ((lff)localObject1).e();
    long l5 = ((lff)localObject1).a();
    long l3 = ((lff)localObject1).b();
    long l4 = ((lff)localObject1).f();
    long l2 = l4;
    long l1 = l3;
    Object localObject2;
    if (i == paramRoomKey.type.get())
    {
      ...
      if (l5 == paramRoomKey.id.get())
      {
        ...
        if (localObject2 != null) {
          ((VideoController)localObject2).a("pushMsg", (lff)localObject1);
        }
        l1 = ((lff)localObject1).b();
        l2 = ((lff)localObject1).f();
      }
    }
    if ((i == paramRoomKey.type.get()) && (l5 == paramRoomKey.id.get()) && (l1 == paramRoomKey.room_id.get()) && (l2 == paramRoomKey.create_ts.get())) {}
    for (localObject1 = a((lff)localObject1);; localObject1 = null)
    {
  ...
  private ConcurrentLinkedQueue<lkb> a(ChatRoomInfo paramChatRoomInfo)
  {
  ...
  private void a(lkb paramlkb)
  {
    if ((paramlkb == null) || (paramlkb.jdField_a_of_type_ComTencentAvChatroomChatRoomInfo == null)) {}
    ChatRoomInfo localChatRoomInfo;
    do
    {
      return;
      localChatRoomInfo = paramlkb.jdField_a_of_type_ComTencentAvChatroomChatRoomInfo;
      long l1 = 0L;
      try
      {
      ...
      l2 = AudioHelper.b();
      if (QLog.isColorLevel()) {
        QLog.i("ChatRoomMng", 2, "sendMsg, seq[" + l2 + "], room[" + localChatRoomInfo + "], msg[" + paramlkb + "]");
      }
      paramlkb.a();
      ...
      localMsg.msg.set(paramlkb.jdField_a_of_type_JavaLangString);
      localMsg.uin.set(l1);
      ...
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication(), ldd.class);
      ...
      ((NewIntent)localObject).putExtra("localSeq", paramlkb.jdField_b_of_type_Long);
      muk.a((Intent)localObject, l2);
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.startServlet((NewIntent)localObject);
    } while (paramlkb.e != lkb.jdField_a_of_type_Int);
    a(1, localChatRoomInfo);
  }
  
  private void b(lkb paramlkb)
  {
    if (!this.jdField_a_of_type_AndroidOsHandler.hasMessages(2, paramlkb))
    {
      Message localMessage = Message.obtain();
      localMessage.what = 2;
      localMessage.obj = paramlkb;
      this.jdField_a_of_type_AndroidOsHandler.sendMessage(localMessage);
    }
  }
  ...
  public ChatRoomInfo a(lff paramlff)
  {
    ChatRoomInfo localChatRoomInfo = a(paramlff, true);
    Object localObject;
    ...
    for (;;)
    {
      ...
      if ((QLog.isDevelopLevel()) && (paramlff != null)) {
        QLog.i("ChatRoomMng", 4, "enterChatRoom, SessionType[" + paramlff.jdField_d_of_type_Int + "], relationType[" + paramlff.F + "], relationId[" + paramlff.g + "], peerUin[" + paramlff.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlff.f + "], isDoubleVideoMeeting[" + paramlff.J + "], room[" + localChatRoomInfo + "]");
      }
      return localChatRoomInfo;
      label189:
  ...
  public ChatRoomInfo a(lff paramlff, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (localChatRoomInfo2 == null)
      {
        ...
        if (paramBoolean)
        {
          ...
          {
            QLog.i("ChatRoomMng", 4, "getRoomInfo, SessionType[" + paramlff.jdField_d_of_type_Int + "], relationType[" + paramlff.F + "], relationId[" + paramlff.g + "], peerUin[" + paramlff.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlff.f + "], isDoubleVideoMeeting[" + paramlff.J + "], type[" + i + "], roomID[" + l2 + "], id[" + l5 + "], createTime[" + l1 + "], room[" + localChatRoomInfo1 + "]");
            localObject = localChatRoomInfo1;
          }
        }
      }
  ...
  public lkb a(ChatRoomInfo paramChatRoomInfo, long paramLong)
  {
    if (paramChatRoomInfo == null) {
      return null;
    }
    ...
    if ((paramChatRoomInfo != null) && (paramChatRoomInfo.size() > 0))
    {
      ...
      do
      {
        ...
        paramChatRoomInfo = (lkb)localIterator.next();
          ...
          do
          {
            do
            {
              do
              {
                ...
                for (;;)
                {
                  ...
                  catch (InvalidProtocolBufferMicroException paramArrayOfByte)
                  {
                    try
                    {
                      ...
                      ((lkb)localObject2).a(lkb.jdField_b_of_type_Int);
                      b((lkb)localObject2);
                      if (!((lkb)localObject2).b()) {
                        break;
                      }
                ...
                ((lkb)localObject2).jdField_d_of_type_Long = l1;
                ((lkb)localObject2).a(lkb.jdField_c_of_type_Int);
                b((lkb)localObject2);
              ...
              } while ((((ChatRoomInfo)localObject1).jdField_b_of_type_Boolean) || (TextUtils.isEmpty(((lkb)localObject2).jdField_a_of_type_JavaLangString)) || (((lkb)localObject2).jdField_a_of_type_JavaLangString.indexOf('\024') < 0));
              lkd.a("0X800A8D5");
  ...
  public void a(VideoController paramVideoController, lff paramlff)
  {
    ChatRoomInfo localChatRoomInfo2 = a(paramlff, false);
    boolean bool = paramVideoController.a("onSwitchTerminalSuccess", paramlff);
    ChatRoomInfo localChatRoomInfo1 = a(paramlff, false);
    paramVideoController = localChatRoomInfo1;
    if (localChatRoomInfo1 == null) {
      paramVideoController = a(paramlff);
    }
    if (paramVideoController != null)
    {
      ...
      paramlff = Message.obtain();
      paramlff.obj = paramVideoController;
      paramlff.what = 3;
      this.jdField_a_of_type_AndroidOsHandler.sendMessage(paramlff);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(ChatRoomInfo paramChatRoomInfo, String paramString, long paramLong)
  {
    ...
    paramString = new lkb(paramChatRoomInfo, l1, paramString, paramLong, -9223372036854775808L, lkb.jdField_a_of_type_Int);
    a(paramChatRoomInfo).add(paramString);
    a(paramString);
  }
  
  public void a(ChatRoomInfo paramChatRoomInfo, List<lkb> paramList)
  {
  ...
  public void a(ChatRoomInfo paramChatRoomInfo, chatroom_sso.Msg paramMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        locallkb = (lkb)localIterator.next();
        if (locallkb != null) {
          if (locallkb.a(paramMsg))
          {
            bool = true;
            locallkb.jdField_c_of_type_Long = paramMsg.msg_time.get();
            locallkb.a(lkb.jdField_d_of_type_Int);
          }
        }
      }
    }
    for (;;)
    {
      ...
      {
        bool = true;
        ((lkb)localObject).jdField_d_of_type_Long = paramMsg.msg_id.get();
        ((lkb)localObject).jdField_c_of_type_Long = paramMsg.msg_time.get();
        ((lkb)localObject).a(lkb.jdField_d_of_type_Int);
        label140:
        if (!bool)
        {
          localObject = new lkb(paramChatRoomInfo, paramMsg.uin.get(), paramMsg.msg.get(), paramMsg.msg_time.get(), paramMsg.msg_id.get(), lkb.jdField_d_of_type_Int);
        ...
        else
        {
          ...
          return;
          if ((locallkb.jdField_d_of_type_Long != -9223372036854775808L) || (locallkb.jdField_a_of_type_Long != l) || (!TextUtils.equals(locallkb.jdField_a_of_type_JavaLangString, paramMsg.msg.get()))) {
            break label329;
          }
          localObject = locallkb;
        }
      }
      label320:
      label329:
  ...
  {
    ChatRoomInfo localChatRoomInfo = a(paramlff, false);
    a(localChatRoomInfo);
    if ((QLog.isDevelopLevel()) && (paramlff != null)) {
      QLog.i("ChatRoomMng", 4, "quitChatRoom, SessionType[" + paramlff.jdField_d_of_type_Int + "], relationType[" + paramlff.F + "], relationId[" + paramlff.g + "], peerUin[" + paramlff.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlff.f + "], isDoubleVideoMeeting[" + paramlff.J + "], room[" + localChatRoomInfo + "]");
    }
  }
  
  public void a(lkc paramlkc)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ChatRoomMng", 2, "addObserver, observer[" + paramlkc + "]");
    }
    if ((paramlkc != null) && (!this.b.contains(paramlkc))) {
      this.b.add(paramlkc);
    }
  }
  ...
  public void b(ChatRoomInfo paramChatRoomInfo)
  {
    ...
    muk.a((Intent)localObject, l);
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.startServlet((NewIntent)localObject);
  }
  
  public void b(lkc paramlkc)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ChatRoomMng", 2, "removeObserver, observer[" + paramlkc + "]");
    }
    if (paramlkc != null) {
      this.b.remove(paramlkc);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == 1)
    {
      ...
      while (localIterator.hasNext())
      {
        locallkc = (lkc)localIterator.next();
        if (locallkc != null) {
          locallkc.a(i, paramMessage);
        }
      }
    }
    if (paramMessage.what == 2)
    {
      paramMessage = (lkb)paramMessage.obj;
      localIterator = this.b.iterator();
      while (localIterator.hasNext())
      {
        locallkc = (lkc)localIterator.next();
        if (locallkc != null) {
          locallkc.a(paramMessage);
        }
      }
    }
