  ...
  extends ahzi
{
  public int a;
  public String a;
  public LinkedHashMap<String, List<acam>> a;
  public List<acam> a;
  public int[] a;
  public String[] a;
  public int b;
  ...
  public acao(TroopMemberListActivity paramTroopMemberListActivity)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_d_of_type_Int == 1) || (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_d_of_type_Int == 11)) {
      paramTroopMemberListActivity = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131626267);
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_d_of_type_Int == 5) {
        paramTroopMemberListActivity = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131630891);
      } else {
        paramTroopMemberListActivity = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131654653);
      }
    }
  }
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        ((TextView)paramView).setText(this.jdField_a_of_type_ArrayOfJavaLangString[paramInt] + this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131655018, new Object[] { Integer.valueOf(localList.size()) }));
  ...
  public Object[] a()
  {
    ...
    Object localObject6 = (azks)this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.app.getManager(203);
    Object localObject9;
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity)
      {
        ...
        localacam = (acam)localIterator.next();
        if (((azks)localObject6).b(localacam.jdField_a_of_type_JavaLangString))
        {
          ...
          ((List)localObject8).add(localacam);
        }
      }
      ...
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_m_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_m_of_type_JavaLangString.contains(localacam.jdField_a_of_type_JavaLangString))) {
          localArrayList2.add(localacam);
        }
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.l != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.l.contains(localacam.jdField_a_of_type_JavaLangString)) && (!this.jdField_a_of_type_JavaUtilList.contains(localacam))) {
          this.jdField_a_of_type_JavaUtilList.add(localacam);
        }
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_b_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_b_of_type_JavaUtilArrayList.contains(localacam.jdField_a_of_type_JavaLangString)) && (!this.jdField_a_of_type_JavaUtilList.contains(localacam)))
        {
          this.jdField_a_of_type_JavaUtilList.add(localacam);
          this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_b_of_type_JavaUtilArrayList.remove(localacam.jdField_a_of_type_JavaLangString);
        }
      }
      ...
      {
        if ((!this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_b_of_type_Boolean) && ((localacam.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_d_of_type_JavaUtilList.contains(localacam.jdField_a_of_type_JavaLangString)))) {
          ((List)localObject9).add(localacam);
        }
        if ((!this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_b_of_type_Boolean) && (localacam.jdField_b_of_type_Boolean)) {
          localArrayList1.add(localacam);
        }
        if ((!localacam.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.app.getCurrentAccountUin())) && (localacam.jdField_d_of_type_Long == 1L)) {
          ((List)localObject10).add(localacam);
        }
      }
      if (((this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_e_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_e_of_type_JavaLangString.equals(localacam.jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.f != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.f.contains(localacam.jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_b_of_type_Boolean) && ((localacam.jdField_a_of_type_Int == 332) || (localacam.jdField_a_of_type_Int == 333))))
      {
        ((List)localObject7).add(localacam);
        if (QLog.isColorLevel()) {
          QLog.d("zivonchen", 2, "constructHashStruct uin = " + localacam.jdField_a_of_type_JavaLangString + ", name = " + localacam.g + ", level = " + localacam.jdField_a_of_type_Int);
        }
      }
      else if ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_d_of_type_Int == 5) && (!TextUtils.isEmpty(localacam.u)))
      {
        ((List)localObject7).add(localacam);
      }
      else
      {
        if (localacam.jdField_c_of_type_JavaLangString == null) {
          break label4524;
        }
        if (localacam.jdField_c_of_type_JavaLangString.length() == 0) {
          break label4524;
        }
        for (;;)
        {
          ...
          ((List)localObject1.get(localObject4)).add(localacam);
          break;
          localObject3 = localacam.jdField_c_of_type_JavaLangString.substring(0, 1);
        }
      }
    }
    localObject6 = new acap(0, true);
    ...
    else
    {
      for (;;)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_e_of_type_Boolean) {
          localObject1.remove(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131653834));
        }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_d_of_type_Int == 21)
        {
          this.jdField_a_of_type_Int = 0;
          Collections.sort((List)localObject7, (Comparator)localObject6);
          ((LinkedHashMap)localObject4).put(ajjy.a(2131649792), this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_a_of_type_JavaUtilList);
          break label4555;
        }
        if ((((List)localObject9).size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_d_of_type_Int != 12))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131653834), localObject9);
        }
        if ((localArrayList1.size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_d_of_type_Int != 3))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131654639), localArrayList1);
        }
        if ((((List)localObject10).size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_d_of_type_Int != 3))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131625743), localObject10);
        }
        if (((List)localObject7).size() > 0)
        {
          Collections.sort((List)localObject7, (Comparator)localObject6);
        ...
        for (localObject3 = TroopMemberListActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity);; localObject3 = this.jdField_a_of_type_JavaLangString)
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131654655), localObject8);
          break label4562;
          if (c1 > 'Z') {
            break;
          }
        ...
        {
          localObject4 = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getResources().getStringArray(2130903138);
          ...
          {
            localObject7 = (acam)((Iterator)localObject6).next();
            if (TextUtils.isEmpty(((acam)localObject7).r)) {
              ((acam)localObject7).r = a((String[])localObject4, ((acam)localObject7).jdField_b_of_type_Long, (Calendar)localObject3);
            }
            if (localObject1.get(((acam)localObject7).r) == null) {
              localObject1.put(((acam)localObject7).r, new ArrayList());
            }
            ((List)localObject1.get(((acam)localObject7).r)).add(localObject7);
          }
          ...
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject1.get(localObject4[i]), new acap(2, false));
        ...
        else if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_m_of_type_Int == 6)
        {
          ...
          {
            localObject6 = (acam)((Iterator)localObject4).next();
            if (TextUtils.isEmpty(((acam)localObject6).r))
            {
              if (((acam)localObject6).jdField_b_of_type_Long == 0L) {
                ((acam)localObject6).jdField_b_of_type_Long = ((acam)localObject6).jdField_a_of_type_Long;
              }
              ((acam)localObject6).r = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.a(((acam)localObject6).jdField_b_of_type_Long, (Calendar)localObject3, TroopMemberListActivity.d(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity), TroopMemberListActivity.e(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity));
            }
            if (localObject2.get(((acam)localObject6).r) == null) {
              localObject2.put(((acam)localObject6).r, new ArrayList());
            }
            if (!TextUtils.isEmpty(((acam)localObject6).r)) {
              ((List)localObject2.get(((acam)localObject6).r)).add(localObject6);
            }
          }
          localObject3 = new LinkedHashMap();
          ...
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject2.get(TroopMemberListActivity.e(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity).get(i)), new acap(2, false));
        ...
        else
        {
          ...
          localObject4 = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getResources().getStringArray(2130903139);
          localObject3 = Calendar.getInstance();
          ((Calendar)localObject3).setTimeInMillis(NetConnInfoCenter.getServerTime() * 1000L);
          localObject6 = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_a_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject6).hasNext())
          {
            localObject7 = (acam)((Iterator)localObject6).next();
            if (TextUtils.isEmpty(((acam)localObject7).q)) {
              ((acam)localObject7).q = b((String[])localObject4, ((acam)localObject7).jdField_a_of_type_Long, (Calendar)localObject3);
            }
            if (localObject2.get(((acam)localObject7).q) == null) {
              localObject2.put(((acam)localObject7).q, new ArrayList());
            }
            ((List)localObject2.get(((acam)localObject7).q)).add(localObject7);
          }
          localObject3 = new LinkedHashMap();
          i = localObject4.length - 1;
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject2.get(localObject4[i]), new acap(3, false));
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_m_of_type_Int == 1)
      {
        ...
        {
          localObject10 = (acam)((Iterator)localObject9).next();
          if (((azks)localObject6).b(((acam)localObject10).jdField_a_of_type_JavaLangString))
          {
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_d_of_type_Int != 5) && (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_d_of_type_Int != 2) && (!TroopMemberListActivity.f(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity))) {
              if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.contains(((acam)localObject10).jdField_a_of_type_JavaLangString)))
              {
                ((List)localObject3).add(localObject10);
                ((acam)localObject10).jdField_d_of_type_Boolean = true;
              }
              else
              {
                ((List)localObject8).add(localObject10);
                ((acam)localObject10).jdField_d_of_type_Boolean = false;
              }
            }
          }
          else if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.contains(((acam)localObject10).jdField_a_of_type_JavaLangString)))
          {
            ((acam)localObject10).jdField_d_of_type_Boolean = true;
            if (((this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_e_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_e_of_type_JavaLangString.equals(((acam)localObject10).jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.f != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.f.contains(((acam)localObject10).jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_b_of_type_Boolean) && ((((acam)localObject10).jdField_a_of_type_Int == 332) || (((acam)localObject10).jdField_a_of_type_Int == 333)))) {
        ...
        localObject2.clear();
        Collections.sort((List)localObject3, new acap(1, false));
        if (((List)localObject3).size() > 0) {
          localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131654655), localObject3);
        }
        if (((List)localObject4).size() > 0)
        {
          Collections.sort((List)localObject4, new acap(1, false));
        ...
        for (localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131629182);; localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131629181))
        {
          localObject2.put(localObject3, localObject4);
          Collections.sort((List)localObject7, new acap(1, false));
          if (((List)localObject7).size() > 0) {
            localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131654651), localObject7);
          }
          Collections.sort((List)localObject8, new acap(1, false));
          if (((List)localObject8).size() <= 0) {
            break;
          }
          localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131654650), localObject8);
          break;
        }
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_m_of_type_Int == 7)
      {
        ...
        while (i < j)
        {
          localObject9 = (acam)this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_a_of_type_JavaUtilList.get(i);
          ((acam)localObject9).k = 0;
          ((HashMap)localObject8).put(((acam)localObject9).jdField_a_of_type_JavaLangString, localObject9);
          i += 1;
        }
        if (TroopMemberListActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity) != null)
        {
          ...
          {
            localObject9 = (acam)((HashMap)localObject8).remove(String.valueOf(TroopMemberListActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity)[i]));
        ...
        if (TroopMemberListActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity) != null)
        {
          ...
          {
            localObject9 = (acam)((HashMap)localObject8).remove(String.valueOf(TroopMemberListActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity)[i]));
            if (localObject9 == null) {
              break label4607;
            }
        ...
        if (TroopMemberListActivity.c(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity) != null)
        {
          ...
          {
            localObject9 = (acam)((HashMap)localObject8).remove(String.valueOf(TroopMemberListActivity.c(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity)[i]));
            if (localObject9 == null) {
              break label4614;
            }
        ...
        Collections.sort((List)localObject3, new acap(2, true));
        if (!((List)localObject3).isEmpty()) {
          localObject2.put(ajjy.a(2131649825), localObject3);
        }
        if (!((List)localObject4).isEmpty()) {
          localObject2.put(ajjy.a(2131649799), localObject4);
        }
        if (!((List)localObject6).isEmpty()) {
          localObject2.put(ajjy.a(2131649844), localObject6);
        }
        Collections.sort((List)localObject7, new acap(2, true));
        if (((List)localObject7).isEmpty()) {
          break label4621;
        }
        localObject2.put(ajjy.a(2131649791), localObject7);
        break label4621;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_m_of_type_Int == 8)
      {
        ...
        {
          localObject8 = (acam)((Iterator)localObject7).next();
          localObject9 = (oidb_0xa2a.UserInfo)((HashMap)localObject6).get(((acam)localObject8).jdField_a_of_type_JavaLangString);
          if (localObject9 != null)
          {
            ((List)localObject3).add(localObject8);
            ((acam)localObject8).l = ((oidb_0xa2a.UserInfo)localObject9).score.get();
          }
          else
          {
        ...
        if (((List)localObject3).size() > 0)
        {
          Collections.sort((List)localObject3, new acap(8, false));
          localObject2.put(ajjy.a(2131649805), localObject3);
        }
        if (((List)localObject4).size() <= 0) {
          break label4624;
        }
        Collections.sort((List)localObject4, new acap(8, false));
        localObject2.put(ajjy.a(2131649859), localObject4);
        break label4624;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_m_of_type_Int == 4)
      {
        localObject3 = new LinkedHashMap();
        localObject4 = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getResources().getStringArray(2130903133);
        localObject6 = ajjy.a(2131649793);
        localObject7 = this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject7).hasNext())
        {
          localObject8 = (acam)((Iterator)localObject7).next();
          j = ((acam)localObject8).jdField_a_of_type_Int;
          i = j;
          if (j >= 10000) {
            i = ((acam)localObject8).jdField_a_of_type_Int - 10000;
          }
          if ((i >= 321) && (i <= 327))
          {
    ...
    for (;;)
    {
      if (i >= 0)
      {
        ...
        {
          Collections.sort((List)((LinkedHashMap)localObject3).get(localObject4[i]), new acap(0, false));
      ...
      else
      {
        if (((LinkedHashMap)localObject3).get(localObject6) != null)
        {
          Collections.sort((List)((LinkedHashMap)localObject3).get(localObject6), new acap(0, false));
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_m_of_type_Int == 5)
        {
          ...
          {
            localObject8 = (acam)((Iterator)localObject7).next();
            if (!((azks)localObject6).b(((acam)localObject8).jdField_a_of_type_JavaLangString)) {
              if ((this.jdField_d_of_type_JavaUtilList != null) && (this.jdField_d_of_type_JavaUtilList.contains(((acam)localObject8).jdField_a_of_type_JavaLangString)))
              {
                ((acam)localObject8).jdField_d_of_type_Boolean = true;
                ((List)localObject3).add(localObject8);
              }
              else
              {
                ((acam)localObject8).jdField_d_of_type_Boolean = false;
                ((List)localObject4).add(localObject8);
              }
            }
          }
          localObject2.clear();
          Collections.sort((List)localObject3, new acap(0, false));
          if (((List)localObject3).size() > 0) {
            localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131654565), localObject3);
          }
          Collections.sort((List)localObject4, new acap(0, false));
          if (((List)localObject4).size() > 0) {
            localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131654564), localObject4);
          }
        }
        break label976;
        label4297:
  ...
  public Object getItem(int paramInt)
  {
    ...
    int i = -(i + 1) - 1;
    return (acam)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public int getItemViewType(int paramInt)
  {
    if (TroopMemberListActivity.e(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity))
    {
      ...
      {
        i = -(i + 1) - 1;
        acam localacam = (acam)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
        if ((TextUtils.isEmpty(localacam.jdField_m_of_type_JavaLangString)) && (!TextUtils.isEmpty(localacam.p)) && (!TextUtils.isEmpty(localacam.g)) && (!localacam.g.equals(localacam.p))) {
          return 1;
        }
      }
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      if (i == 0)
      {
        ...
        localObject1 = (acam)this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_a_of_type_JavaUtilList.get(paramInt);
        paramViewGroup.g.setTag(((acam)localObject1).jdField_a_of_type_JavaLangString);
        paramViewGroup.jdField_b_of_type_AndroidViewView.setTag(((acam)localObject1).jdField_a_of_type_JavaLangString);
        paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(((acam)localObject1).jdField_a_of_type_JavaLangString);
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setTag(Integer.valueOf(paramInt));
        this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.a(paramViewGroup, (acam)localObject1, a(((acam)localObject1).jdField_a_of_type_JavaLangString, 2), false, false);
      }
    }
    label253:
    int j;
    for (;;)
    {
      ...
      j = -(j + 1) - 1;
      localObject1 = (acam)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[j])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[j] - 1);
      paramViewGroup.g.setTag(((acam)localObject1).jdField_a_of_type_JavaLangString);
      paramViewGroup.jdField_b_of_type_AndroidViewView.setTag(((acam)localObject1).jdField_a_of_type_JavaLangString);
      paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(((acam)localObject1).jdField_a_of_type_JavaLangString);
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setTag(Integer.valueOf(paramInt));
      Object localObject2;
      if (((acam)localObject1).jdField_c_of_type_Boolean)
      {
        localObject2 = new axjq(((acam)localObject1).jdField_b_of_type_JavaLangString, 16).a();
        paramViewGroup.jdField_e_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
        bami.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.app, paramViewGroup.jdField_e_of_type_AndroidWidgetTextView, (Spannable)localObject2);
      ...
      for (;;)
      {
        ...
        Bitmap localBitmap = a(((acam)localObject1).jdField_a_of_type_JavaLangString, 2);
        if (i == 1) {}
        for (;;)
        {
          ((TroopMemberListActivity)localObject2).a(paramViewGroup, (acam)localObject1, localBitmap, false, bool);
          break;
          bool = false;
        }
        label564:
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_a_of_type_Ajdy.a(paramViewGroup, (acam)localObject1);
        if (paramViewGroup.f.getVisibility() == 0)
        {
          paramInt = bajr.d(2);
          paramViewGroup.jdField_e_of_type_AndroidWidgetTextView.setMaxWidth(paramInt);
          TroopMemberListActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.app, paramViewGroup.jdField_e_of_type_AndroidWidgetTextView, paramViewGroup.d, ((acam)localObject1).jdField_a_of_type_JavaLangString, paramInt);
        }
      }
    }
    label649:
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_d_of_type_Int == 9) || (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_d_of_type_Int == 19))
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.jdField_d_of_type_Int == 12)
      {
        ...
        {
          localObject1 = (acam)((List)localObject1).get(paramInt);
          if (!this.jdField_a_of_type_JavaUtilList.contains(localObject1)) {
            break label1012;
          }
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131654655).equals(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j])))
      {
      ...
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setText(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j]) + this.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity.getString(2131655018, new Object[] { Integer.valueOf(((List)localObject1).size()) }));
      break label766;
      label1012:
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
    }
