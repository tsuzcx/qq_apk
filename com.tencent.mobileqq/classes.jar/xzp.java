  ...
  implements Runnable
{
  ...
  public xzp(BaseActivity paramBaseActivity, Intent paramIntent)
  {
  ...
  public void run()
  {
    ...
    if (FileUtils.b(str))
    {
      ...
      if (((URLDrawable)localObject).getStatus() == 1) {
        this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new xzq(this));
      }
    }
    do
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new xzr(this));
      return;
      if (QLog.isColorLevel()) {
        QLog.e("SendVideoActivity", 2, "#SendTask# run(): thumb not exist, path=" + str);
      }
    } while (this.jdField_a_of_type_Boolean);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new xzs(this));
  }
}
