  ...
  implements ViewBase.OnClickListener
{
  ...
  public qrm(ArticleInfo paramArticleInfo, Context paramContext, int paramInt)
  {
  ...
  private void a()
  {
    ...
    ReadInJoyUserInfoModule.a(Long.valueOf(str).longValue(), new qrn(this, localQQAppInterface, str));
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      bool = true;
      localqro = new qro(this, paramBoolean);
      if (!paramBoolean) {
        break label71;
      }
    }
    ...
    for (int i = 1;; i = 2)
    {
      localqia.a(paramQQAppInterface, paramString1, bool, paramString2, localqro, i);
      d();
      return;
      bool = false;
      break;
  ...
  private void c()
  {
    ...
    for (String str = "0X800941D";; str = "0X80080EC")
    {
      ...
      {
        str = String.valueOf(localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqy.jdField_a_of_type_Long);
        ReadInJoyUserInfoModule.a(Long.valueOf(str).longValue(), new qrp(this, localQQAppInterface, str));
      }
      d();
      return;
    }
  ...
  public void onClick(ViewBase paramViewBase)
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo != null)
    {
      ...
      uvs.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, uvs.e);
    ...
    for (;;)
    {
      ukj.a(paramViewBase, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, true);
      return;
      label156:
      c();
    }
