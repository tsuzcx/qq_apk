  ...
  extends c
{
  ...
  public byte[] a(int paramInt, byte[] paramArrayOfByte, long paramLong)
  {
    ...
    util.int64_to_buf32(arrayOfByte1, paramInt, paramLong);
    paramArrayOfByte = new tlv_t544().get_common_tlv544(this.b, 0L, 0L, arrayOfByte1);
    byte[] arrayOfByte2 = new byte[this.d + paramArrayOfByte.length];
    System.arraycopy(arrayOfByte1, 0, arrayOfByte2, paramInt + 4, arrayOfByte1.length);
