...
public class d
{
    ...
    try
    {
      ...
      try
      {
        ...
        if (200 == i)
        {
          ...
          if (a(((d.c)localObject2).b, ((d.c)localObject2).c, ((d.c)localObject2).d))
          {
  ...
  public d.c a(String paramString)
  {
    try
    {
      ...
      try
      {
        ...
        if (paramString != null) {
          return new d.c(i, paramString.optInt("KeyVer", 0), paramString.optString("PubKey"), paramString.optString("PubKeySign"));
        }
  ...
  public void b()
  {
    new Thread(new d.a(), "PubKeyRotater").start();
  }
  ...
  public Pair<String, Integer> c()
  {
    try
    {
      ...
      if (!a(((d.c)localObject).b, ((d.c)localObject).c, ((d.c)localObject).d))
      {
        util.LOGI("[pubkey]syncGetPubKey key sign not right");
        return null;
      }
      localObject = new Pair(((d.c)localObject).c, Integer.valueOf(((d.c)localObject).b));
      return localObject;
    }
    catch (Throwable localThrowable)
    {
