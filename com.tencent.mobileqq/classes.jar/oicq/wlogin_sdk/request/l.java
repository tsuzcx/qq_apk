  ...
  extends oicq_request
{
  ...
  public int a(long paramLong1, long paramLong2, long paramLong3, int paramInt1, int paramInt2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt3, int paramInt4, long[] paramArrayOfLong, byte[] paramArrayOfByte3, long paramLong4, long paramLong5, long paramLong6, byte[] paramArrayOfByte4, byte[] paramArrayOfByte5, WUserSigInfo paramWUserSigInfo)
  {
    ...
    for (;;)
    {
      byte[] arrayOfByte = a(paramLong1, paramLong2, paramLong3, k, paramInt2, paramArrayOfByte1, paramArrayOfByte2, paramInt3, paramInt4, paramArrayOfLong, t.ac, paramArrayOfByte3, paramLong4, paramLong5, paramLong6, paramArrayOfByte4, paramArrayOfByte5);
  ...
  public byte[] a(long paramLong1, long paramLong2, long paramLong3, int paramInt1, int paramInt2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt3, int paramInt4, long[] paramArrayOfLong, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4, long paramLong4, long paramLong5, long paramLong6, byte[] paramArrayOfByte5, byte[] paramArrayOfByte6)
  {
    ...
    localObject10 = ((tlv_t145)localObject10).get_tlv_145(t.A);
    ...
    localObject17 = ((tlv_t177)localObject17).get_tlv_177(1585297161L, "6.0.0.2424");
    ...
    for (paramInt1 = 11;; paramInt1 = 10)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          {
            paramArrayOfByte3 = ((tlv_t172)localObject20).get_tlv_172(this.x.r);
            paramInt1 += 1;
          }
          for (;;)
          {
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                for (;;)
                {
                  ...
                  for (;;)
                  {
                    localObject19 = ((tlv_t109)localObject19).get_tlv_109(t.O);
                    ...
                    localObject11 = ((tlv_t128)localObject11).get_tlv_128(t.U, t.V, t.W, 0, t.I, t.A, t.P);
                    ...
                    paramArrayOfByte5 = localtlv_t153.get_tlv_153(t.aa);
                    ...
                    paramInt1 += 1;
                    paramArrayOfByte5 = localtlv_t544.get_tlv_544(this.a, paramLong1, t.A.length, t.A, "6.0.0.2424".length(), "6.0.0.2424", this.u);
