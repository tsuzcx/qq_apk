  ...
  extends oicq_request
{
  ...
  public int a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, long[] paramArrayOfLong, WUserSigInfo paramWUserSigInfo)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        byte[] arrayOfByte1 = t.am;
        int i = 0;
        for (;;)
        {
          byte[] arrayOfByte2 = a(localtlv_t104.get_data(), paramArrayOfByte, ((tlv_t105)localObject).get_sign(), paramInt1, paramInt2, paramArrayOfLong, arrayOfByte1);
  ...
  public byte[] a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt1, int paramInt2, long[] paramArrayOfLong, byte[] paramArrayOfByte4)
  {
    ...
    {
      paramArrayOfByte2 = new byte[paramArrayOfByte1.length + localObject1.length + localObject2.length + paramArrayOfLong.length + paramArrayOfByte4.length];
      ...
      return b(paramArrayOfByte2, this.u, 5);
    }
  }
}
