  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (WtloginHelper.access$1300(this.this$1.this$0, this.this$1.mUserSigInfo))
    {
      WtloginHelper.HelperThread localHelperThread = this.this$1;
      localHelperThread.mUserAccount = localHelperThread.mUserSigInfo.uin;
    }
    if (this.this$1.mST == null)
    {
      WtloginHelper.access$200(this.this$1.mHelper).OnCheckSMSAndGetSt(this.this$1.mUserAccount, this.this$1.mUserInput, this.this$1.mUserSigInfo, this.val$ret, (ErrMsg)localObject);
      return;
    }
    WtloginHelper.access$200(this.this$1.mHelper).OnCheckSMSAndGetSt(this.this$1.mUserAccount, this.this$1.mUserInput, this.this$1.mUserSigInfo, this.this$1.mST, this.val$ret, (ErrMsg)localObject);
  }
}
