  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    WtloginHelper.access$100(this.this$1.mHelper).OnRefreshSMSVerifyLoginCode(this.this$1.mUserAccount, localasync_context._smslogin_msg, localasync_context._smslogin_msgcnt, localasync_context._smslogin_timelimit, this.this$1.mUserSigInfo, this.val$ret, localErrMsg);
  }
}
