...
public class h
{
  ...
  byte[] a(int paramInt)
  {
    Object localObject1 = ByteBuffer.allocate("6.0.0.2463".length() + 24 + 2 + 2 + 1 + 4);
    ...
    ((ByteBuffer)localObject1).putShort((short)"6.0.0.2463".length());
    ((ByteBuffer)localObject1).put("6.0.0.2463".getBytes());
  ...
  int b(int paramInt)
  {
    ...
    //   7: aload_0
    //   8: iload_1
    //   9: invokevirtual 246	oicq/wlogin_sdk/request/h:a	(I)[B
    //   12: astore 4
    //   14: aload_3
    //   15: astore_2
    ...
    //   203: i2l
    //   204: invokestatic 318	oicq/wlogin_sdk/request/i:a	(Ljava/net/HttpURLConnection;J)Z
    //   207: ifne +46 -> 253
    //   210: ldc_w 320
    ...
    //   443: invokevirtual 362	oicq/wlogin_sdk/request/h:a	([B)I
    //   446: sipush -1000
