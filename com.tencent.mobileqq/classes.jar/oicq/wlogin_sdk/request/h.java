...
public class h
{
  ...
  byte[] a(int paramInt)
  {
    Object localObject1 = ByteBuffer.allocate("6.0.0.2436".length() + 24 + 2 + 2 + 1 + 4);
    ...
    ((ByteBuffer)localObject1).putShort((short)"6.0.0.2436".length());
    ((ByteBuffer)localObject1).put("6.0.0.2436".getBytes());
