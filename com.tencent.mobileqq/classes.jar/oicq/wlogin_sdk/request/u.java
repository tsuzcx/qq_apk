  ...
  extends oicq_request
{
  ...
  public byte[] a(Map<Integer, tlv_t> paramMap)
  {
    ...
    for (;;)
    {
      ...
      localStringBuilder.append(",apk_id=").append(new String(t.F));
      break label176;
      localObject1 = new tlv_t145().get_tlv_145(t.B);
      localStringBuilder.append(",guid=").append(new String(t.B));
      break label176;
      ...
      localStringBuilder.append(",_productType=").append(t.aA);
      break label176;
      m = j;
      k = i;
      if (paramMap != null)
