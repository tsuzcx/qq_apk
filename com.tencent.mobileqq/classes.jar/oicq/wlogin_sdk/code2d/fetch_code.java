      ...
      if (i != 17)
      {
        if (i != 22)
        {
          if (i != 27)
          {
            if (i != 29)
            {
              ...
              else
              {
                ...
                ((StringBuilder)localObject2).append(new String(t.L));
                ((StringBuilder)localObject2).append(" sim info ");
                ((StringBuilder)localObject2).append(new String(t.D));
                ((StringBuilder)localObject2).append(" apn ");
                ((StringBuilder)localObject2).append(new String(t.G));
                util.LOGI(((StringBuilder)localObject2).toString(), "");
                util.int8_to_buf((byte[])localObject1, 0, t.ab);
                int n = fill_staff((byte[])localObject1, t.L, 1);
                n = fill_staff((byte[])localObject1, t.K, n);
                util.int16_to_buf((byte[])localObject1, n, t.E);
                n = fill_staff((byte[])localObject1, t.D, n + 2);
                n = fill_staff((byte[])localObject1, new byte[0], n);
                fill_staff((byte[])localObject1, t.G, n);
              }
              break label697;
            }
            else
          ...
          else
          {
            ...
            util.int32_to_buf((byte[])localObject2, 0, ((fetch_code.QRCodeCustom)localObject1).Micro);
            util.int32_to_buf((byte[])localObject2, 4, ((fetch_code.QRCodeCustom)localObject1).Version);
            util.int32_to_buf((byte[])localObject2, 8, ((fetch_code.QRCodeCustom)localObject1).Size);
            util.int32_to_buf((byte[])localObject2, 12, ((fetch_code.QRCodeCustom)localObject1).Margin);
            util.int32_to_buf((byte[])localObject2, 16, ((fetch_code.QRCodeCustom)localObject1).Dpi);
            util.int32_to_buf((byte[])localObject2, 20, ((fetch_code.QRCodeCustom)localObject1).EcLevel);
            util.int32_to_buf((byte[])localObject2, 24, ((fetch_code.QRCodeCustom)localObject1).Hint);
