  ...
  extends tlv_t
{
  ...
  public byte[] get_tlv_108(byte[] paramArrayOfByte)
  {
    ...
    this._t108_body_len = arrayOfByte.length;
    paramArrayOfByte = new byte[this._t108_body_len];
    System.arraycopy(arrayOfByte, 0, paramArrayOfByte, 0, arrayOfByte.length);
    fill_head(this._cmd);
    fill_body(paramArrayOfByte, this._t108_body_len);
    set_length();
    return get_buf();
  }
}
