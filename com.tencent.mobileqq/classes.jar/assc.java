  ...
  extends GestureDetector
{
  ...
  Animator.AnimatorListener jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new assd(this);
  Context jdField_a_of_type_AndroidContentContext;
  Rect jdField_a_of_type_AndroidGraphicsRect;
  View jdField_a_of_type_AndroidViewView;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  assg jdField_a_of_type_Assg = new assg(this, null);
  ...
  public assc(Context paramContext, GestureDetector.SimpleOnGestureListener paramSimpleOnGestureListener, BaseChatPie paramBaseChatPie)
  {
    ...
    else
    {
      ...
      this.jdField_j_of_type_Int = paramContext.getResources().getDimensionPixelOffset(2131299011);
    ...
    for (int i1 = 0;; i1 = ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      if (!(paramBaseChatPie instanceof aijc)) {
        break;
      }
  ...
  private String a(asrv paramasrv)
  {
    if (paramasrv.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null)
    {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) {
      try
      {
        int i1 = Integer.parseInt(paramasrv.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
        int i2 = Integer.parseInt(paramasrv.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId);
        paramasrv = asfa.a(i2, i1);
        EmoticonPackage localEmoticonPackage = ((axfj)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(String.valueOf(i2));
        char[] arrayOfChar = new char[5];
        arrayOfChar[0] = '\024';
        arrayOfChar[1] = paramasrv[3];
        arrayOfChar[2] = paramasrv[2];
        arrayOfChar[3] = paramasrv[1];
        arrayOfChar[4] = paramasrv[0];
        if ((localEmoticonPackage != null) && (localEmoticonPackage.isAPNG == 2)) {
          arrayOfChar[1] = 'ǿ';
        }
        paramasrv = new StringBuilder(String.valueOf(arrayOfChar));
        EmojiStickerManager.a(paramasrv);
        return paramasrv.toString();
      }
  ...
  private void e()
  {
    ...
    bhlq.a(this.jdField_a_of_type_AndroidContentContext, 230).setTitle(anzj.a(2131713190)).setMessage(anzj.a(2131713183)).setPositiveButton(anzj.a(2131713189), new assf(this)).setNegativeButton("取消", new asse(this)).show();
    int i1;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
    {
  ...
  void a(float paramFloat1, float paramFloat2)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView != null))
    {
      ...
      localViewPropertyAnimator.setListener(this.jdField_a_of_type_Assg);
  ...
  void a(View paramView, boolean paramBoolean)
  {
    ...
    if (paramView != null)
    {
      localaqkt = (aqkt)paramView.getTag(2131363997);
      localObject = (ChatMessage)paramView.getTag(2131364467);
      bool = false;
      if (localObject != null) {
      ...
      if (localaqkt != null)
      {
        ...
        ((aqmm)localObject).b(paramBoolean);
      }
    }
    label77:
    ...
    {
      if (bool) {}
      for (i1 = 2130850000;; i1 = 2130849824)
      {
        ...
        localaqkt.a(paramView, (Drawable)localObject);
        return;
      }
    }
    if (bool) {}
    for (int i1 = 2130850001;; i1 = 2130849825)
    {
      localObject = ((Resources)localObject).getDrawable(i1);
      break label112;
      break;
  ...
  void a(String paramString)
  {
    ...
    QQToast.a(this.jdField_a_of_type_AndroidContentContext, paramString, 0).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299011));
  }
  ...
  boolean a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout != null)
    {
      ...
      while (i1 >= 0)
      {
        ...
        if (((View)localObject).getId() == 2131374223)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.findViewById(2131362358));
          this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.findViewById(2131362357));
          localObject = this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getTag();
          double d1;
          if (((localObject instanceof asre)) || ((localObject instanceof Emoticon)) || ((localObject instanceof asqn)))
          {
            this.s = 1;
          ...
          {
            return true;
            if ((!(localObject instanceof assj)) && (!(localObject instanceof asrv))) {
              break;
            }
            this.s = 0;
            ...
            this.jdField_h_of_type_Int = ((int)(this.jdField_g_of_type_Float * 41.0F));
            this.jdField_i_of_type_Int = ((int)(this.jdField_g_of_type_Float * 41.0F));
            break;
            label316:
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
    {
      ...
      {
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131374258);
    ...
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131374257);
      if (localObject1 != null) {
        return ((View)localObject1).onTouchEvent(paramMotionEvent);
      }
    }
    ...
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131374260);
      if (localObject1 != null) {
        return ((View)localObject1).onTouchEvent(paramMotionEvent);
      }
    }
      ...
      if (a())
      {
        ...
        if ((b(paramMotionEvent.getRawX(), paramMotionEvent.getRawY())) || (!this.jdField_d_of_type_Boolean))
        {
          ...
          for (;;)
          {
            ...
            if ((this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getTag(2131374259) instanceof Integer)) {
              i1 = ((Integer)this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getTag(2131374259)).intValue();
            }
            ...
            {
              localObject1 = (assj)localObject1;
              if (((assj)localObject1).jdField_a_of_type_Int == 1)
              {
                this.t = 2;
                break label1625;
              }
              if (((assj)localObject1).jdField_a_of_type_Int != 2) {
                break label1625;
              }
              this.t = 3;
              break label1625;
            ...
            if (!(localObject1 instanceof asqn)) {
              break label1625;
            }
            this.t = 5;
            break label1625;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        Object localObject4;
        asqn localasqn;
        if ((paramMotionEvent instanceof asre))
        {
          localObject1 = (asre)paramMotionEvent;
          localObject2 = null;
          localObject4 = null;
          localObject3 = null;
          localasqn = null;
        ...
        for (;;)
        {
          ...
          label2644:
          View localView;
          if ((!EmojiStickerManager.f) && (bhmi.a() > 1.048576E+008F))
          {
            i1 = 1;
            paramMotionEvent = null;
            if ((localObject1 == null) || (((asre)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon == null)) {
              break label3289;
            }
            if (i1 == 0) {
              break label3272;
            }
            paramMotionEvent = ((asre)localObject1).a("fromAIO", true, false, null, (int)(this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getWidth() * this.jdField_b_of_type_Double), (int)(this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getHeight() * this.jdField_b_of_type_Double));
            ...
            if ((localView == null) || (localView.getId() != 2131364423)) {
              break label7552;
            }
            ...
            localObject6 = (ChatMessage)localView.getTag(2131364467);
          ...
          for (;;)
          {
            ...
            if (i2 != 0)
            {
              ...
              if ((paramMotionEvent instanceof assj))
              {
                localObject4 = (assj)paramMotionEvent;
                localObject2 = null;
                localObject3 = null;
                localasqn = null;
                localObject1 = null;
              ...
              if ((paramMotionEvent instanceof asrv))
              {
                localObject2 = (asrv)paramMotionEvent;
                localObject4 = null;
                localObject3 = null;
                localasqn = null;
                localObject1 = null;
              ...
              if (!(paramMotionEvent instanceof asqn)) {
                break label7724;
              }
              localasqn = (asqn)paramMotionEvent;
              localObject2 = null;
              localObject4 = null;
              localObject3 = null;
              localObject1 = null;
              ...
              break label2644;
              label3272:
              paramMotionEvent = ((asre)localObject1).a(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
              break label2704;
              label3289:
              if (localObject4 != null)
              {
                paramMotionEvent = ((assj)localObject4).b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
                break label2704;
              }
              ...
              if (localObject2 != null)
              {
                paramMotionEvent = ((asrv)localObject2).b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
                break label2704;
              }
              if (localasqn == null) {
                break label2704;
              }
              paramMotionEvent = localasqn.b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float, 0, 0);
              break label2704;
            ...
            for (;;)
            {
              if ((localObject6 != null) && (((ChatMessage)localObject6).extraflag != 32772) && (((ChatMessage)localObject6).extraflag != 32768) && (bool3) && (bool4) && (((ChatMessage)localObject6).msgtype != -2009) && (((ChatMessage)localObject6).msgtype != -2016) && (!(localObject6 instanceof MessageForLongMsg)) && (!(localObject6 instanceof MessageForLongTextMsg)) && (bool2) && (i5 != 0) && (i4 == 0) && (i3 == 0) && (i1 == 0))
              {
                ...
                if ((localObject1 != null) && (((asre)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon != null))
                {
                  localObject5 = ((asre)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId;
                  if (f2 - i16 + this.r <= i8) {
                    break label4509;
                  }
                ...
                for (;;)
                {
                  ...
                  if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (localObject5 != null))
                  {
                    ...
                    if (bool1)
                    {
                      ...
                      if (localObject1 != null)
                      {
                        ((asre)localObject1).jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerInfo = ((EmojiStickerManager.StickerInfo)localObject6);
                        ((ChatMessage)localObject5).stickerHidden = false;
                        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a((asmu)localObject1);
                      }
                      do
                      {
                        for (;;)
                        {
                          ...
                          if (localObject3 != null)
                          {
                            aean.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (Emoticon)localObject3, (EmojiStickerManager.StickerInfo)localObject6);
                          }
                          else
                          {
                            if (localObject4 != null)
                            {
                              if (((assj)localObject4).jdField_a_of_type_Int == 1) {}
                              for (paramMotionEvent = behh.b(((assj)localObject4).jdField_b_of_type_Int);; paramMotionEvent = behh.a(((assj)localObject4).jdField_b_of_type_Int))
                              {
                            ...
                            paramMotionEvent = a((asrv)localObject2);
                            this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(paramMotionEvent, (EmojiStickerManager.StickerInfo)localObject6);
                          }
                        }
                      } while (localasqn == null);
                      ...
                      localObject5 = localasqn.e;
                      if (!TextUtils.isEmpty(localasqn.d)) {}
                      for (bool1 = true;; bool1 = false)
                      {
                        aean.a(paramMotionEvent, (Context)localObject2, (SessionInfo)localObject4, (String)localObject5, true, bool1, localasqn.d, (EmojiStickerManager.StickerInfo)localObject6);
                        break;
                      }
                      label5860:
                      ...
                      a(String.format(anzj.a(2131713192), new Object[] { Integer.valueOf(EmojiStickerManager.jdField_e_of_type_Int) }));
                        ...
                        if (i1 == 2)
                        {
                          ...
                          if ((localObject1 instanceof FragmentActivity))
                          {
                            ...
                            if (((FragmentActivity)localObject1).getChatFragment() != null)
                            {
                              ...
                              if ((((localObject1 instanceof aihd)) || ((localObject1 instanceof aijm)) || ((localObject1 instanceof aijc))) && (EmojiStickerManager.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 0))
                              {
