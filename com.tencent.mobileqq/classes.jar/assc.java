...
public class assc
  implements Handler.Callback, View.OnClickListener, bbnt
{
  public static Boolean a;
  public static WeakReference<assc> a;
  ...
  public assc(String paramString, View paramView, int paramInt)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.e = paramInt;
    paramString = (BounceScrollView)paramView.findViewById(2131297855);
    if (paramString != null) {
      paramString.setScrollListener(new bbns(this, paramString.getContext()));
    }
    int i = asvw.jdField_a_of_type_ArrayOfInt.length;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_ArrayOfAndroidViewView = new View[i];
    paramInt = 0;
    while (paramInt < i)
    {
      this.jdField_a_of_type_ArrayOfAndroidViewView[paramInt] = paramView.findViewById(asvw.jdField_a_of_type_ArrayOfInt[paramInt]);
      paramInt += 1;
    }
  ...
  {
    if (asfl.a()) {
      asfl.a("InterestGuide", "MSG_CHECK_INTEREST", new Object[] { Integer.valueOf(paramMessage.what), Integer.valueOf(this.d), Integer.valueOf(this.e), Integer.valueOf(this.jdField_a_of_type_AndroidViewView.getMeasuredHeight()) });
    }
    ...
    if ((paramMessage.what == 0) && (this.d == 0) && (this.e != 1) && (this.jdField_a_of_type_AndroidViewView.getMeasuredHeight() > 0))
    {
      ...
      k = 0;
      localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131309688);
      if (localObject != null)
      {
        ((View)localObject).getLocationInWindow(this.jdField_a_of_type_ArrayOfInt);
        paramMessage = ((View)localObject).findViewById(2131311626);
        localObject = ((View)localObject).findViewById(2131303326);
      ...
      tmp268_267[0] = 2131297808;
      Message tmp273_268 = tmp268_267;
      tmp273_268[1] = 2131305075;
      Message tmp278_273 = tmp273_268;
      tmp278_273[2] = 2131302006;
      tmp278_273;
      i = this.c;
      m = 0;
      if (m < paramMessage.length)
      {
        ...
        if ((localObject != null) && (((View)localObject).getVisibility() == 0))
        {
          ...
          if (asfl.a())
          {
            asfl.a("InterestGuide", "checkShowGuide_bottom", new Object[] { Integer.valueOf(m), Integer.valueOf(this.jdField_a_of_type_ArrayOfInt[0]), Integer.valueOf(this.jdField_a_of_type_ArrayOfInt[1]), Integer.valueOf(((View)localObject).getMeasuredHeight()) });
            n = j;
          }
        }
        for (;;)
        {
          ...
          if (asfl.a())
          {
            asfl.a("InterestGuide", "checkShowGuide_bottom", new Object[] { Integer.valueOf(m), localObject });
            n = i;
          }
        }
      }
      ...
      if (asfl.a()) {
        asfl.a("InterestGuide", "checkShowGuide", new Object[] { Integer.valueOf(this.b), Integer.valueOf(this.c), Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(k), Integer.valueOf(i) });
      }
      localObject = null;
      i = 0;
      ...
      if (paramMessage != null)
      {
        ...
        if (m > 0)
        {
          ...
          paramMessage = LayoutInflater.from(localContext).inflate(2131495280, null);
          ((Button)paramMessage.findViewById(2131297884)).setOnClickListener(this);
        }
      }
    }
    for (;;)
    {
      ...
      if (asfl.a()) {
        asfl.a("InterestGuide", "checkShowGuide", new Object[] { Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(m) });
      }
      ...
      return true;
      label1003:
      paramMessage = LayoutInflater.from(localContext).inflate(2131495281, null);
      ((Button)paramMessage.findViewById(2131297884)).setOnClickListener(this);
      break;
      label1032:
      paramMessage = new View(localContext);
  ...
  public void onClick(View paramView)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetPopupWindow.dismiss();
      paramView = (BounceScrollView)this.jdField_a_of_type_AndroidViewView.findViewById(2131297855);
      if (paramView != null) {
