...
{
  private afgs jdField_a_of_type_Afgs;
  ...
  public afft(Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_Afgs = new afgs(paramContext);
    this.jdField_a_of_type_Afgs.a(new affu(this));
  }
  ...
  {
    this.jdField_a_of_type_JavaLangString = awfx.a(paramQQAppInterface).a(this.jdField_b_of_type_JavaLangString, this.c);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable.setImageAssetDelegate(new affw(this));
    }
    try
    {
      ...
      LottieComposition.Factory.fromInputStream(a(), paramQQAppInterface, new affx(this));
      return;
    }
  ...
  public void a(afge paramafge)
  {
    ...
    if (awfx.a(localQQAppInterface).a(this.jdField_b_of_type_JavaLangString, this.c))
    {
      a(localQQAppInterface);
      paramafge.a(true);
      return;
    }
    awfx.a(localQQAppInterface).a(this.jdField_b_of_type_JavaLangString, this.c, new affv(this, paramafge));
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Afgs != null)
    {
      this.jdField_a_of_type_Afgs.b();
      this.jdField_a_of_type_Afgs.c();
    }
    a(8);
    super.b();
  }
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_Afgs != null) && (this.jdField_a_of_type_Afgs.a())) {
      this.jdField_a_of_type_Afgs.d();
    }
