...
public class bfuj
{
  ...
  public static syk a(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    ...
    {
      paramString = BaseApplicationImpl.sImageCache.get(paramString);
      if ((paramString instanceof syk)) {
        return (syk)paramString;
      }
    }
    return null;
  }
  ...
  public static void a(String paramString, syk paramsyk)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramsyk == null)) {}
    while (BaseApplicationImpl.sImageCache == null) {
      return;
    }
    BaseApplicationImpl.sImageCache.put(paramString, paramsyk);
  }
}
