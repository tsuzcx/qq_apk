...
public class bfuj
  implements bhqd
{
  public bfuj(QidianProfileCardActivity paramQidianProfileCardActivity, String paramString) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        if (this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity.jdField_a_of_type_Bfua.d(this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity.jdField_a_of_type_Awmk.a.jdField_a_of_type_JavaLangString)) {
