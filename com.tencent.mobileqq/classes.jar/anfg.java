...
public class anfg
{
  ...
  public anfg(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRunnable = new EPRecommendTask.1(this);
    this.jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new anfh(this);
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramQQAppInterface);
  }
  
  public static argv a(JSONObject paramJSONObject)
  {
  ...
  public anfg a(String paramString1, String paramString2)
  {
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    } while (localSharedPreferences.getInt("magic_promotion_old_ver_" + amyp.a(), -1) >= paramJSONObject.jdField_b_of_type_Int);
    localSharedPreferences.edit().putBoolean("magic_promotion_is_new_content_" + amyp.a(), true).commit();
    localSharedPreferences.edit().putInt("magic_promotion_old_ver_" + amyp.a(), paramJSONObject.jdField_b_of_type_Int).commit();
  }
}
