  ...
  implements sfi
{
  ...
  public bhib(CaptureModeController paramCaptureModeController)
  {
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Sez != null)
      {
        if (!paramBoolean) {
          break;
        }
        this.jdField_a_of_type_Sez.b();
      }
      return;
    ...
    this.jdField_a_of_type_Sez.c();
  }
  
  public void b()
  {
    this.jdField_a_of_type_Bhdi.K();
  }
  ...
  public void g()
  {
    ...
    if (this.jdField_b_of_type_Int == 10002)
    {
      ...
      localscu.c();
      if (localscu.a(this.jdField_a_of_type_AndroidViewView.getContext()))
      {
        ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131298324)).inflate();
        this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131298323);
        if (this.jdField_b_of_type_AndroidViewView != null)
        {
          urk.b("SlidesMode", "init album gallery view part success");
          this.jdField_a_of_type_Sez = new sez(this.jdField_a_of_type_DovComQqImCaptureModeCaptureModeController.a(), this.jdField_b_of_type_AndroidViewView, this);
        }
      }
    }
    if (this.jdField_b_of_type_AndroidViewView == null)
    {
      ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131310482)).inflate();
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131310481);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131310480).setOnClickListener(this);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131298114).setOnClickListener(this);
    }
    this.jdField_b_of_type_AndroidViewView.setOnTouchListener(new bhic(this));
  }
  ...
  protected void h()
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Sez.a(localBundle);
      return;
      try
      {
        label144:
      ...
      {
        urk.c("SlidesMode", "format albumId error : %s", localNumberFormatException);
      }
    }
  }
  ...
  protected void i()
  {
    if (this.jdField_b_of_type_AndroidAnimationAnimator == null)
    {
      ...
      this.jdField_b_of_type_AndroidAnimationAnimator.addListener(new bhid(this));
    }
