...
public class bhib
{
  ...
  public static Bitmap a(int paramInt, Bitmap.Config paramConfig, Bitmap[] paramArrayOfBitmap)
  {
    ...
    Object localObject = new bhid[j];
    i = 0;
    while (i < j)
    {
      localObject[i] = new bhid(null);
      i += 1;
    }
  ...
  public static Bitmap a(int paramInt, Bitmap[] paramArrayOfBitmap)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        arrayOfbhid = new bhid[i];
        j = 0;
        while (j < i)
        {
          arrayOfbhid[j] = new bhid(null);
          j += 1;
        }
        ...
        arrayOfbhid[0].a = 0;
        arrayOfbhid[0].b = 0;
        arrayOfbhid[0].c = (paramInt / 2 - 1);
        arrayOfbhid[0].d = paramInt;
        arrayOfbhid[0].e = 1;
        arrayOfbhid[1].a = (paramInt / 2 + 1);
        arrayOfbhid[1].b = 0;
        arrayOfbhid[1].c = paramInt;
        arrayOfbhid[1].d = paramInt;
        arrayOfbhid[1].e = 1;
        paramInt = 0;
    ...
    if (arrayOfbhid[paramInt].e == 1) {
      localRect.set(j / 4, 0, j / 4 * 3, k);
    }
    for (;;)
    {
      localRectF.set(arrayOfbhid[paramInt].a, arrayOfbhid[paramInt].b, arrayOfbhid[paramInt].c, arrayOfbhid[paramInt].d);
      ...
      if (i == 3)
      {
        ...
        arrayOfbhid[1].b = 0;
        arrayOfbhid[1].c = paramInt;
        arrayOfbhid[1].d = (paramInt / 2 - 1);
        arrayOfbhid[1].e = 2;
        arrayOfbhid[2].a = (paramInt / 2 + 1);
        arrayOfbhid[2].b = (paramInt / 2 + 1);
        arrayOfbhid[2].c = paramInt;
        arrayOfbhid[2].d = paramInt;
        arrayOfbhid[2].e = 2;
        break;
      }
      if (i < 4) {
      ...
      arrayOfbhid[2].e = 2;
      arrayOfbhid[3].a = 0;
      arrayOfbhid[3].b = (paramInt / 2 + 1);
      arrayOfbhid[3].c = (paramInt / 2 - 1);
      arrayOfbhid[3].d = paramInt;
      arrayOfbhid[3].e = 2;
      break;
