...
public class lsh
{
  ...
  public lsh(Context paramContext)
  {
    this.jdField_a_of_type_Met = new met();
      ...
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        if (this.jdField_a_of_type_JavaUtilList.size() > 0)
        {
          ...
          if (i < j) {
            try
            {
              boolean bool = ((lss)this.jdField_a_of_type_JavaUtilList.get(i)).a(paramLong);
              if (!bool) {
                break label101;
              }
              i -= 1;
  ...
  public void a(Bitmap paramBitmap)
  {
    ...
    if (paramBitmap != null)
    {
      this.jdField_a_of_type_Lrw = new lrx(paramBitmap);
  ...
  public void a(lqt paramlqt)
  {
    ...
    lss locallss = null;
    if (this.jdField_a_of_type_JavaUtilList.size() > 0) {
      locallss = (lss)this.jdField_a_of_type_JavaUtilList.get(0);
    }
    if ((locallss != null) && (locallss.a()))
    {
      paramlqt.a(locallss.a(), locallss.b(), locallss.c());
      float f1 = this.e;
      f1 = this.jdField_f_of_type_Float;
      f1 = this.jdField_g_of_type_Float;
      if ((locallss != null) && (locallss.b()))
      {
        f1 = locallss.d();
        float f2 = locallss.e();
      ...
      if ((locallss == null) || (!locallss.c())) {
        break label268;
      }
      paramlqt.a(locallss.f(), 1.0F, 0.0F, 0.0F);
      paramlqt.a(locallss.g(), 0.0F, 1.0F, 0.0F);
      paramlqt.a(locallss.h(), 0.0F, 0.0F, 1.0F);
    }
    for (;;)
    {
      c(paramlqt);
      ...
      paramlqt.c();
      return;
      paramlqt.a(i, j, this.jdField_a_of_type_Float);
      break;
      label268:
      if (this.jdField_b_of_type_Float != 0.0F) {
        paramlqt.a(this.jdField_b_of_type_Float, 1.0F, 0.0F, 0.0F);
      }
      if (this.jdField_c_of_type_Float != 0.0F) {
        paramlqt.a(this.jdField_c_of_type_Float, 0.0F, 1.0F, 0.0F);
      }
      if (this.d != 0.0F) {
        paramlqt.a(this.d, 0.0F, 0.0F, 1.0F);
      }
    }
  }
  ...
  public void a(lrx paramlrx)
  {
    ...
    if (paramlrx != null)
    {
      this.jdField_a_of_type_Lrw = paramlrx;
      this.jdField_f_of_type_Int = 0;
    }
  }
  
  public void a(lsi paramlsi)
  {
    this.jdField_a_of_type_Lsi = paramlsi;
  }
  
  protected void a(lsj paramlsj)
  {
    this.jdField_a_of_type_Lsj = paramlsj;
  }
  ...
  public void a(lss paramlss)
  {
    ...
    try
    {
      paramlss.a(this);
      paramlss.a();
      this.jdField_a_of_type_JavaUtilList.add(paramlss);
      b();
      return;
    }
    finally {}
  ...
  {
    if (this.jdField_b_of_type_Lrw == null) {
      return;
    }
    int i = b();
    int j = c();
    ...
    paramlqt.a(2);
    this.jdField_b_of_type_Lrw.a(paramlqt, i2, i3, i - k - m, j - n - i1);
    paramlqt.c();
  }
  ...
  {
    if ((a() == 0) && (this.jdField_a_of_type_Lsi != null) && (this.jdField_a_of_type_Lsi.a(this, paramMotionEvent))) {
      return true;
    }
  ...
  public void c(int paramInt)
  {
    if (this.h != paramInt)
    {
      ...
      if (this.jdField_a_of_type_Lsj != null) {
        this.jdField_a_of_type_Lsj.a(this, paramInt, i);
      }
    }
  }
  ...
  protected void c(lqt paramlqt)
  {
    if (this.jdField_a_of_type_Lrw != null)
    {
      i = b();
      j = c();
      this.jdField_a_of_type_Lrw.a(paramlqt, 0, 0, i, j);
      return;
    }
    int i = b();
    int j = c();
    paramlqt.a(0.0F, 0.0F, i, j, this.jdField_g_of_type_Int);
  }
  ...
  public void e(int paramInt)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Lrw = locallsa;
      this.jdField_f_of_type_Int = paramInt;
      return;
      locallsa = new lsa((Context)localObject, paramInt);
    }
  }
  ...
  protected void finalize()
  {
    try
    {
      if (this.jdField_b_of_type_Lrw != null)
      {
        this.jdField_b_of_type_Lrw.a();
        this.jdField_b_of_type_Lrw = null;
      }
      if (this.jdField_a_of_type_Lrw != null)
      {
        this.jdField_a_of_type_Lrw.a();
