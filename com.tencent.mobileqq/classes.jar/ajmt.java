...
public class ajmt
{
  ...
  protected static String a(String paramString)
  {
    ...
    return paramString.replace("[client]", "androidQQ").replace("[version]", "8.2.8.4440").replace("[platformId]", "2").replace("[device]", Build.DEVICE).replace("[system]", Build.VERSION.RELEASE).replace("[systemInt]", Integer.toString(Build.VERSION.SDK_INT));
  }
  ...
  public static void a(String paramString)
  {
    ...
    {
      return;
      ajmu.ah = a(paramString);
    } while (!QLog.isColorLevel());
    QLog.d("ApolloConfigUtils", 2, "sApolloStoreUrl = " + ajmu.ah);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject1 != null)
        {
          ...
          bbjn.k((Context)localObject2, Integer.parseInt(paramString));
          ...
          bbjn.l((Context)localObject2, Integer.parseInt((String)localObject3));
        }
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (i < paramString.length())
        {
          ...
          if (!a("8.2.8", ((JSONObject)localObject3).optString("minVersion"), ((JSONObject)localObject3).optString("maxVersion"))) {
            break label1447;
          }
        ...
        if (((JSONObject)localObject1).has("freqConfig"))
        {
          ...
          if (paramString != null)
          {
            ...
            if (nqx.jdField_a_of_type_Int < i) {
              nqx.jdField_a_of_type_Int = i;
            }
          }
        }
        ...
        if (((JSONObject)localObject1).has("gameConfig"))
        {
          ...
          if ((paramString != null) && (paramString.has("aio")))
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject1)) {
              ajmu.aD = (String)localObject1;
            }
            if (!TextUtils.isEmpty((CharSequence)localObject2)) {
              ajmu.aE = ((String)localObject2).trim();
            }
            if (!TextUtils.isEmpty((CharSequence)localObject3)) {
              ajmu.aF = ((String)localObject3).trim();
            }
          }
        }
        if (airz.a.get()) {
        ...
        paramString = (airz)paramQQAppInterface.getManager(153);
        airz.a.set(true);
        paramString.h();
        return;
        label1447:
                          ...
                          do
                          {
                            do
                            {
                              do
                              {
                                ...
                                ajmu.ai = a(paramString2);
                              } while (!QLog.isColorLevel());
                              QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloStoreInteractUrl=", ajmu.ai });
                              return;
                            ...
                            ajmu.aj = a(paramString2);
                          } while (!QLog.isColorLevel());
                          QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloNewStoreUrl=", ajmu.aj });
                          return;
                          if (!"game_center".equals(paramString1)) {
                            break;
                          }
                        } while (TextUtils.isEmpty(paramString2));
                        ajmu.ak = a(paramString2);
                      } while (!QLog.isColorLevel());
                      QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloGameCenterUrl=", ajmu.ak });
                      return;
                      if (!"new_interact".equals(paramString1)) {
                        break;
                      }
                    } while (TextUtils.isEmpty(paramString2));
                    ajmu.al = a(paramString2);
                  } while (!QLog.isColorLevel());
                  QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloNewInteractUrl=", ajmu.al });
                  return;
                  if (!"game_city".equals(paramString1)) {
                    break;
                  }
                } while (TextUtils.isEmpty(paramString2));
                ajmu.am = a(paramString2);
              } while (!QLog.isColorLevel());
              QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloGameCityUrl=", ajmu.am });
              return;
              if ("apollo_drawer_game_box_lottie".equals(paramString1))
              {
                ajmu.ar = paramString2;
                return;
              }
      ...
      try
      {
        ...
        if (paramJSONObject != null)
        {
          ...
          if (i < paramJSONObject.length())
          {
            ...
            if (!a("8.2.8", localJSONObject.optString("minVersion"), localJSONObject.optString("maxVersion"))) {
              continue;
            }
      ...
      try
      {
        ...
        if (localJSONArray != null)
        {
          ...
          if (i < localJSONArray.length())
          {
            ...
            if (a("8.2.8", str1, str2))
            {
              if (!TextUtils.isEmpty((CharSequence)localObject2))
              {
                ajmu.at = (String)localObject2;
                ajmu.au = localJSONObject.optString("id");
                ajmu.av = ajmu.jdField_a_of_type_JavaLangString + "/script/" + ajmu.au + "/";
                if (paramBoolean)
                {
              ...
              if (QLog.isColorLevel())
              {
                QLog.d("ApolloConfigUtils", 2, new Object[] { "parseBaseScriptConfig: localversion target.url=" + (String)localObject2, ",scriptId:", ajmu.au, ",isUpdate:", Boolean.valueOf(paramBoolean) });
                localObject3 = localObject1;
              }
            }
            else
            {
              ...
              if (a("8.2.8", str1) < 0)
              {
                ...
                if (a((String)localObject1, str1) < 0)
                {
                  if (!TextUtils.isEmpty((CharSequence)localObject2))
                  {
                    ajmu.aw = (String)localObject2;
                    ajmu.ax = localJSONObject.optString("id");
                    ajmu.ay = ajmu.jdField_a_of_type_JavaLangString + "/script/" + ajmu.ax + "/";
                  }
                  if (QLog.isColorLevel()) {
                    QLog.d("ApolloConfigUtils", 2, "parseBaseScriptConfig: newestMinVersion=" + str1 + " target.url=" + (String)localObject2 + ", id=" + ajmu.ax);
                  }
                  localObject3 = str1;
                }
              }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localApolloPreDownloadData.resId = bfjx.b(localApolloPreDownloadData.url);
          ...
          if ((!TextUtils.isEmpty(localApolloPreDownloadData.minVer)) && (!TextUtils.isEmpty(localApolloPreDownloadData.maxVer)) && (!a("8.2.8", localApolloPreDownloadData.minVer, localApolloPreDownloadData.maxVer))) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        aizk.a(jdField_a_of_type_OrgJsonJSONArray);
        ...
        if (localJSONObject2 != null)
        {
          aixt.a("aio.enter.bg", localJSONObject2.optString("entranceBkgUrl"));
          ...
          else
          {
            ...
            aixt.a("aio.enter", paramQQAppInterface);
            aixt.a("aio.enter.name", localJSONObject2.optString("entranceName"));
          }
        }
        else
        {
