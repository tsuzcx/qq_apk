...
{
  public belc(TroopBarReplyActivity paramTroopBarReplyActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.k) {
        bfqu.a("reply_page", "fail", this.a.o, "4", "", "");
      }
      return;
      ...
      if (!TextUtils.isEmpty(bfqu.a(this.a.jdField_a_of_type_ComTencentMobileqqTroopWidgetXEditTextExWithListener))) {
      ...
      if (this.a.k) {
        bfqu.a("reply_page", "suc", this.a.o, "", ((StringBuffer)localObject).toString(), "");
      }
      paramBundle = this.a.getString(2131695572, new Object[] { Integer.valueOf(9992) });
    }
  }
