  ...
  extends XBaseAdapter
{
  ...
  public zsq(QIMUndecideNotifyDialog paramQIMUndecideNotifyDialog, Context paramContext, QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Int = paramContext.getResources().getDimensionPixelOffset(2131559464);
    this.b = paramContext.getResources().getDimensionPixelOffset(2131559465);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130970086, null);
      paramViewGroup = new zss(this.jdField_a_of_type_ComTencentMobileqqAppQimQIMUndecideNotifyDialog);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368457));
      paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131368959));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363369));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131368958));
      paramViewGroup.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131368960));
    ...
    for (;;)
    {
      ...
      while (paramInt < localQIMNotifyAddFriend.videoInfos.size())
      {
        ...
        localURLImageView.setOnClickListener(new zsr(this, (ArrayList)localObject1, paramInt));
      ...
      paramViewGroup = (zss)paramView.getTag();
      break;
      label458:
