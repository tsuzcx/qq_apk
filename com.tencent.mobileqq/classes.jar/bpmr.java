...
public abstract class bpmr
{
  public int a;
  protected SegmentKeeper a;
  public Object a;
  public ArrayList<bpms> a;
  public int b;
  protected int c;
  
  public bpmr(Object paramObject)
  {
  ...
  public void a()
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      if (localIterator.hasNext()) {
        ((bpms)localIterator.next()).a(this);
      }
    }
  }
  ...
  public void a(int paramInt)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      if (localIterator.hasNext()) {
        ((bpms)localIterator.next()).a(this, paramInt);
      }
    }
  }
  ...
  public void a(bpms parambpms)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(parambpms)) {
        this.jdField_a_of_type_JavaUtilArrayList.add(parambpms);
      }
      return;
    }
  }
  ...
  public void b()
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      if (localIterator.hasNext()) {
        ((bpms)localIterator.next()).b(this);
      }
    }
  }
