...
public class bfzs
{
  ...
  public WXVadData a(byte[] paramArrayOfByte)
  {
    ...
    {
      azeu.a("VadHelper", "vadOnlineProcess isError ");
      return null;
    }
  ...
  public java.util.List<com.wx.voice.vad.WXVadSeg> a(java.lang.String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 27	bfzs:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   4: invokevirtual 137	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   7: ifne +10 -> 17
    //   10: aload_0
    //   11: getfield 107	bfzs:jdField_a_of_type_Boolean	Z
    //   14: ifeq +5 -> 19
    //   17: aconst_null
    //   18: areturn
    //   19: aload_0
    //   20: getfield 27	bfzs:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   23: iconst_1
    ...
    //   112: astore_1
    //   113: aload_0
    //   114: getfield 124	bfzs:jdField_a_of_type_ComWxVoiceVadWXVad	Lcom/wx/voice/vad/WXVad;
    //   117: aload 5
    //   119: aload 5
    //   121: arraylength
    //   122: i2l
    ...
    //   158: astore_1
    //   159: aload_0
    //   160: getfield 124	bfzs:jdField_a_of_type_ComWxVoiceVadWXVad	Lcom/wx/voice/vad/WXVad;
    //   163: invokevirtual 188	com/wx/voice/vad/WXVad:Reset	()I
    //   166: pop
    //   167: aload 4
    //   169: astore_1
    //   170: aload_0
    //   171: getfield 27	bfzs:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   174: iconst_0
    ...
    //   209: astore_1
    //   210: aload_0
    //   211: getfield 27	bfzs:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   214: iconst_0
  ...
  public boolean a(byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    {
      azeu.a("VadHelper", "vadSession, input empty, skipped");
      return true;
    }
    ...
    if (paramBoolean)
    {
      ...
      azeu.a("VadHelper", "vadSession online RET_STATE:" + paramArrayOfByte.RET_STATE);
    ...
    for (;;)
    {
      ...
      azeu.a("VadHelper", "vadSession offline RET_STATE:" + paramArrayOfByte.RET_STATE);
      paramBoolean = bool2;
  ...
  public void c()
  {
    ...
    if (1 == this.jdField_a_of_type_ComWxVoiceVadWXVad.Init(a()))
    {
      ...
      azeu.a("VadHelper", "WXVad Error reading configure");
    }
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Boolean = true;
      azeu.a("VadHelper", "WXVad Error reading blocksize");
      return;
      azeu.a("VadHelper", "WXVad Success init");
    }
    azeu.a("VadHelper", "WXVad success get blocksize ：" + localWXVadData.blocksize);
  }
