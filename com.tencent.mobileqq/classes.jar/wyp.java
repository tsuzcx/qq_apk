...
public class wyp
  extends QIPCModule
{
  private static wyp a;
  public long a;
  public SparseArray<baml> a;
  public String a;
  public wyr a;
  public String b;
  ...
  public static String a()
  {
    ...
    if (localObject2 != null)
    {
      ...
      {
        JSONObject localJSONObject = ((wyk)((Iterator)localObject2).next()).a();
  ...
  public static wyp a()
  {
    if (jdField_a_of_type_Wyp == null) {}
    try
    {
      if (jdField_a_of_type_Wyp == null) {
        jdField_a_of_type_Wyp = new wyp();
      }
      return jdField_a_of_type_Wyp;
    }
    finally {}
  }
  ...
  public baml a()
  {
    ...
    localbaub.e = false;
    return new baml(((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(), localbaub, this.jdField_a_of_type_JavaLangString);
  }
  ...
  public void a()
  {
    ...
    {
      ((baml)this.jdField_a_of_type_AndroidUtilSparseArray.valueAt(i)).a();
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      if ("action_get_art_filter_path".equals(paramString))
      {
          ...
          if (this.jdField_a_of_type_AndroidUtilSparseArray.get(i) == null)
          {
            ...
            for (bool1 = false;; bool1 = bool2)
            {
              if (this.jdField_a_of_type_Wyr == null) {
                this.jdField_a_of_type_Wyr = wyr.a(str, l1);
              }
              paramBundle = a();
              paramBundle.a("current_TaskCount", String.valueOf(this.jdField_a_of_type_AndroidUtilSparseArray.size()));
              paramBundle.a(paramInt, i, paramString, j, this.jdField_a_of_type_Wyr, bool1);
        ...
        else
        {
          ...
          paramBundle = a();
          this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramBundle);
          paramBundle.a(paramInt, i, paramString, j, this.jdField_a_of_type_Wyr, true);
        }
      }
      else if ("action_cancel_art_filter_task".equals(paramString))
      {
        ...
        {
          ((baml)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt)).a();
      ...
      else if ("action_exit_art_filter".equals(paramString))
      {
        a(true);
        a();
        this.jdField_a_of_type_Wyr = null;
      }
    }
  }
}
