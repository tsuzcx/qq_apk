  ...
  extends BaseAdapter
{
  ...
  public ammo(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
  }
  
  private ammq a(String paramString, Context paramContext)
  {
    int i = 0;
  ...
  private ColorStateList a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    return new ColorStateList(new int[][] { arrayOfInt1, arrayOfInt2, { 16842910 }, { 16842908 }, arrayOfInt3, new int[0] }, new int[] { paramInt2, paramInt3, paramInt1, paramInt3, paramInt4, paramInt1 });
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        int i = Color.parseColor(((ammq)localObject).a);
        int j = Color.parseColor(((ammq)localObject).b);
      ...
      return localView;
      localObject = (ammr)paramView.getTag();
      localView = paramView;
