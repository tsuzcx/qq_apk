  ...
  implements aplh
{
  ...
  public apll(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
  ...
  public void a(apab paramapab)
  {
    ...
    {
      a(true);
      paramapab.a(-6101, BaseApplication.getContext().getResources().getString(2131692888));
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.bSend, false, new aplm(this, paramapab));
  }
  ...
  public String b()
  {
    return apti.a().c() + bfkp.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid);
  }
