...
{
  public lxx(ReadInJoyDeliverUGCActivity paramReadInJoyDeliverUGCActivity) {}
  ...
  public void a(int paramInt1, long paramLong, String paramString1, int paramInt2, String paramString2)
  {
    ...
    if (paramInt1 == 0)
    {
      ReadInJoyDeliverUGCActivity.c(this.a, 2, this.a.getString(2131438865));
    ...
    if (paramInt1 == 33)
    {
      ReadInJoyDeliverUGCActivity.d(this.a, 1, this.a.getString(2131438851));
      return;
    }
    ReadInJoyDeliverUGCActivity.e(this.a, 1, this.a.getString(2131438866));
  }
}
