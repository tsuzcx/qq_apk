...
public class bnrj
{
  public static void a(Activity paramActivity)
  {
    ...
    {
      bnrh.d("PicChooseJumpUtil", "activity is null.");
      return;
    }
    ...
    localIntent.putExtra("VIDEO_STORY_JUMP_TO_TYPE", bnlb.b(paramActivity.getIntent()));
    localIntent.putExtra("VIDEO_STORY_FROM_TYPE", bnlb.a(paramActivity.getIntent()));
  ...
  {
    bnrh.b("PicChooseJumpUtil", "[jumpForAECircle] Start");
    bnrh.a("PicChooseJumpUtil", "[AE Profiler] jumpForAECircle Start");
    ...
    bnrh.d("PicChooseJumpUtil", "jumpForAECircle activity is not Activity");
  }
