...
public class afxp
  extends afwf
  implements afth, View.OnClickListener
{
  int jdField_a_of_type_Int;
  afyj jdField_a_of_type_Afyj;
  ...
  public afxp(FragmentActivity paramFragmentActivity)
  {
  ...
  public int a()
  {
    return this.jdField_a_of_type_Afyj.jdField_a_of_type_ArrayOfInt[this.jdField_a_of_type_Int];
  }
  ...
  {
    super.a();
    a(2131368429).setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131368457));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    this.jdField_a_of_type_ComTencentWidgetFadeIconImageView = ((FadeIconImageView)a(2131368428));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator = ((SimpleSlidingIndicator)a(2131376283));
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQViewPager = ((QQViewPager)a(2131364065));
    this.jdField_a_of_type_Afyj = new afyj();
    int[] arrayOfInt1 = a();
    int[] arrayOfInt2 = b();
    if ((arrayOfInt1 != null) && (arrayOfInt2 != null))
    {
      this.jdField_a_of_type_Afyj.a(a(), arrayOfInt1, arrayOfInt2);
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Afyj.jdField_a_of_type_ArrayOfJavaLangString, arrayOfInt1);
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setOnTabListener(this);
    this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryViewPagerAdapter = new ChatHistoryViewPagerAdapter(a(), a(), this, this.jdField_a_of_type_Afyj, this.jdField_a_of_type_JavaLangString);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQViewPager.setOnPageChangeListener(new afxq(this));
    c(0);
  }
  ...
  public void a(int paramInt)
  {
    ...
    case 1602: 
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131690000);
      this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.setVisibility(8);
      this.c = 1;
      return;
    }
  ...
  public void e()
  {
    if (this.c == 2)
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131690000);
      this.c = 1;
      if (this.jdField_a_of_type_Afyi != null) {
        this.jdField_a_of_type_Afyi.c();
      }
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      this.c = 1;
      return;
    } while (this.jdField_a_of_type_Afyi == null);
    this.jdField_a_of_type_Afyi.a();
  }
}
