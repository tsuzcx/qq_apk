...
public class bnhv
  ...
  implements Handler.Callback, bjvm, bnmn
{
  private float jdField_a_of_type_Float;
  public int a;
  Context jdField_a_of_type_AndroidContentContext;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bnhx(this);
  public View a;
  public ViewGroup a;
  ...
  public boolean a;
  private InputFilter[] jdField_a_of_type_ArrayOfAndroidTextInputFilter = { new bnij(20) };
  ...
  private int j = 580;
  private int k;
  private int l = bmwl.jdField_b_of_type_Int;
  private int m;
  private int n;
  
  public bnhv(Context paramContext, boolean paramBoolean)
  {
    super(paramContext, 2131755182);
    this.jdField_b_of_type_Int = -1;
    this.jdField_c_of_type_Int = bnsd.a(false);
    this.jdField_a_of_type_Bnhf = new bnhf();
  ...
  private void a()
  {
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(getContext()).inflate(2131559114, null));
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new bnii(this, null);
    this.jdField_a_of_type_AndroidViewViewGroup.getViewTreeObserver().addOnGlobalLayoutListener(new bnih(this, null));
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout = ((FitSystemWindowsRelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131376702));
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout.setFitsSystemWindows(true);
    this.jdField_a_of_type_ComTencentWidgetFitSystemWindowsRelativeLayout.setOnTouchListener(new bnhw(this));
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378450);
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiPanelEditTextPanel = ((EditTextPanel)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365931).findViewById(2131372212));
    ...
    this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView = ((PressScaleTextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378422));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378423));
    if (this.jdField_d_of_type_Boolean)
    {
      this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      this.jdField_a_of_type_DovComQqImCaptureViewPressScaleTextView.setOnClickListener(new bnhy(this));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new bnhz(this));
    }
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView = ((EditTextPreView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131378462));
    this.jdField_a_of_type_DovComQqImCaptureTextEditTextPreView.setOnClickListener(new bnia(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusableInTouchMode(true);
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusable(true);
    this.jdField_a_of_type_AndroidWidgetEditText.setOnFocusChangeListener(new bnib(this));
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a(this.jdField_a_of_type_AndroidWidgetEditText);
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new bnic(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new bnid(this));
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout = ((HorizontalSelectColorLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131371733));
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setStrokeStrategy(new bnsd(), false, 0);
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.setOnStrokeSelectedListener(new bnie(this));
  }
  ...
  private void b()
  {
    ...
    {
      localLayoutParams.height = bnnl.b(getContext());
      if (LiuHaiUtils.f())
      {
  ...
  private void c()
  {
    ...
    getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new bnif(this));
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 34)
    {
      ...
      {
        int i1 = this.jdField_a_of_type_Bmvk.a(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem);
  ...
  public void a(bmvk parambmvk)
  {
    this.jdField_a_of_type_Bmvk = parambmvk;
  }
  
  public void a(bnig parambnig)
  {
  ...
  public void a(DynamicTextConfigManager.DynamicTextConfigBean paramDynamicTextConfigBean, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem != null) && (this.jdField_a_of_type_AndroidWidgetEditText != null) && (paramDynamicTextConfigBean != null))
    {
      ...
      paramDynamicTextConfigBean = this.jdField_a_of_type_Bmvk.a(paramDynamicTextConfigBean.text_id, (List)localObject);
      ...
      if (!(paramDynamicTextConfigBean instanceof bmwl)) {
        break label391;
      }
      ((bmwl)paramDynamicTextConfigBean).a(this.jdField_c_of_type_Int);
      ...
      if (!this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a().equals(bmvk.a(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.c(), this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.b()))) {
        break label427;
      }
    ...
    for (;;)
    {
      ...
      return;
      label357:
      localObject = bmvk.a(bmvk.a(paramDynamicTextConfigBean.text_id), this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem);
  ...
  public void a(DynamicTextItem paramDynamicTextItem, int paramInt)
  {
    ...
    xvv.b("EditTextDialog", "setTextInfo:" + paramDynamicTextItem + " index:" + paramInt + " text:" + str1);
    this.jdField_a_of_type_Bnhf.jdField_a_of_type_JavaLangString = str1;
    this.jdField_a_of_type_AndroidWidgetEditText.setText(this.jdField_a_of_type_Bnhf.jdField_a_of_type_JavaLangString);
    if (this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.c() != 0)
    {
      if (this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem.a() == null) {
        this.jdField_a_of_type_AndroidWidgetEditText.setFilters(this.jdField_a_of_type_ArrayOfAndroidTextInputFilter);
    ...
    for (;;)
    {
      paramInt = this.jdField_a_of_type_Bmvk.a(paramDynamicTextItem);
      ...
      if (!(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem instanceof bmwl)) {
        break label494;
      }
      paramDynamicTextItem = (bmwl)this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextItem;
  ...
  public int c()
  {
    ...
    xvv.b("EditTextDialog", "getPreViewCenterX:" + i1);
    return i1;
  }
  ...
  public int d()
  {
    ...
    xvv.b("EditTextDialog", "getPreViewCenterY()=" + i1);
    return i1;
  }
