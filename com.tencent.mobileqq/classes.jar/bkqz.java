  ...
  implements ShareProxy
{
  ...
  {
    a(paramMiniAppInfo, paramInt, paramString1, paramString2, ImageUtil.drawableToBitmap(paramActivity.getResources().getDrawable(2130848424)), paramString3);
  }
  ...
  private void a(String paramString, URLDrawable.URLDrawableListener paramURLDrawableListener)
  {
    ...
    if (paramURLDrawableListener != null)
    {
      ...
      ykq.b("ShareProxyImpl", "URLDrawable's status is SUCCESSED.");
    ...
    for (;;)
    {
      ...
      return;
      label44:
      ykq.b("ShareProxyImpl", "start load URLDrawable.");
    }
  }
  ...
  public void a(InnerShareData paramInnerShareData)
  {
    ...
    bkra localbkra = new bkra(this, paramInnerShareData);
    Object localObject;
