  ...
  implements waj
{
  ...
  bkqz(bkqw parambkqw, PublishVideoEntry paramPublishVideoEntry, String paramString1, String paramString2)
  {
  ...
  public void onFinish(boolean paramBoolean)
  {
    ...
    ((HashMap)localObject).put("generate_video_cost", this.jdField_a_of_type_Bkqw.a + "");
    ((HashMap)localObject).put("watermark_cost", d + "");
    axrn.a(BaseApplication.getContext()).a(null, "qq_ptv_save_time", true, 0L, 0L, (HashMap)localObject, null);
    bbdx.d(this.jdField_a_of_type_JavaLangString);
    SaveVideoActivity.a(false);
    int i;
    Intent localIntent;
    if (bkqw.a(this.jdField_a_of_type_Bkqw).get() != null)
    {
      localObject = (Activity)bkqw.a(this.jdField_a_of_type_Bkqw).get();
      if (bkqw.b(this.jdField_a_of_type_Bkqw).get() != null) {
        SaveVideoActivity.a((AppInterface)bkqw.b(this.jdField_a_of_type_Bkqw).get(), this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry);
      }
      if (!paramBoolean) {
        break label340;
      }
      i = bkqw.b(this.jdField_a_of_type_Bkqw, -1);
      if (!birt.e(((Activity)localObject).getIntent())) {
        break label353;
      }
    ...
    bkqw.a(this.jdField_a_of_type_Bkqw, bkqw.a(this.jdField_a_of_type_Bkqw));
  }
  ...
  public void onSuccess(String paramString)
  {
    ...
    vyf.a(BaseApplication.getContext(), new File(this.b));
    bbdx.d(new File(this.jdField_a_of_type_JavaLangString).getParent());
  }
}
