...
public class pqv
{
  public static Intent a(Intent paramIntent, ArticleInfo paramArticleInfo, int paramInt1, String paramString1, long paramLong, String paramString2, int paramInt2, int paramInt3)
  {
    ...
    if (localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw == null) {
    ...
    localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.jdField_a_of_type_JavaUtilList.add(paramArticleInfo);
  ...
  public static ArticleInfo a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          paramString = new String(bhcu.decode((String)localObject3, 0));
        }
        ...
        try
        {
          localObject3 = new String(bhcu.decode((String)localObject1, 0));
          l6 = l7;
          l5 = l3;
          l4 = l2;
        }
      ...
      try
      {
        ...
        localObject3 = new String(bhcu.decode(((JSONObject)localObject5).optString("accountDesc"), 0));
        ...
        localArticleInfo.mSocialFeedInfo = new SocializeFeedsInfo();
        localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw = new rqw();
        localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.jdField_a_of_type_JavaLangLong = Long.valueOf(l8);
        localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.b = Long.valueOf(l1);
        localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.jdField_a_of_type_JavaUtilList = new ArrayList();
        if (paramString == null) {
          break label897;
        }
      ...
      try
      {
        ...
        ((SocializeFeedsInfo.BiuCommentInfo)localObject2).mOrigBiuComment = new String(bhcu.decode(((SocializeFeedsInfo.BiuCommentInfo)localObject2).mOrigBiuComment, 0));
      ...
      localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqw.jdField_a_of_type_JavaUtilList.add(localObject2);
      i += 1;
      continue;
    ...
    if ((paramString != null) && ((j == 4) || (j == 5) || ((j == 1) && ((l1 == 4L) || (l1 == 5L)))))
    {
      ...
      {
        localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Rqw = new rqw();
        localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Rqw.jdField_a_of_type_JavaUtilList = new ArrayList();
        i = 0;
        for (;;)
        {
          ...
          try
          {
            ...
            ((SocializeFeedsInfo.BiuCommentInfo)localObject5).mOrigBiuComment = new String(bhcu.decode(((SocializeFeedsInfo.BiuCommentInfo)localObject5).mOrigBiuComment, 0));
          ...
          localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Rqw.jdField_a_of_type_JavaUtilList.add(localObject5);
          i += 1;
        }
      }
      label1231:
      localArticleInfo.mTitle = new String(bhcu.decode((String)localObject2, 0));
      localArticleInfo.mSummary = "";
      if ((j != 3) && (j != 2)) {
        break label1571;
      }
      localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
      localObject1 = new rrr();
      paramString = paramString.optJSONArray("ugcPicInfo");
      if ((paramString != null) && (paramString.length() > 0))
      {
        ((rrr)localObject1).c = paramString.getJSONObject(0).optString("ugcPicUrl");
        localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_JavaUtilArrayList.add(localObject1);
      }
    }
    for (;;)
    {
      localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_Int = j;
      localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.jdField_a_of_type_JavaLangString = localArticleInfo.mTitle;
      ...
      if (paramString != null)
      {
        ((rrs)localObject2).d = paramString.optString("ugcVideoCoverUrl");
        ((rrs)localObject2).a = paramString.optInt("ugcVideoDuration");
        ((rrs)localObject2).e = ((String)localObject1);
        localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.b.add(localObject2);
        continue;
        if (j == 1) {
