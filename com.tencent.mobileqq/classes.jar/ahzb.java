  ...
  implements aysa
{
  ...
  public ahzb(int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  private boolean a()
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        String str = bbdj.d((String)localEntry.getValue());
        i += 1;
  ...
  private boolean b()
  {
    try
    {
      this.jdField_a_of_type_Int = ahzd.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl, this.b, this.jdField_a_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
        QLog.i("RDBaseDataManager", 2, "local sp config version is : " + this.jdField_a_of_type_Int);
      }
      boolean bool = ahzd.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl, this.b, this.jdField_a_of_type_JavaLangString, new ahzc(this));
      if (!bool)
      {
        this.jdField_c_of_type_Int = 0;
  ...
  public int a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localahyr.jdField_a_of_type_Int = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.addAndGet(1);
    localahyr.b = paramString4;
    localahyr.jdField_a_of_type_JavaLangString = paramString3;
    try
    {
      paramString3 = new ayrv();
      ...
      paramString3.a(localahyr);
      paramString3.jdField_a_of_type_Aysa = this;
      paramString3.jdField_c_of_type_Int = bbev.a(aysy.a().a());
      lcm.a().a(paramString3);
      if (QLog.isColorLevel()) {
        QLog.i("RDBaseDataManager", 2, "startDownload, url: " + paramString1 + " ; path:" + paramString2);
      }
      return localahyr.jdField_a_of_type_Int;
    }
    catch (Exception paramString3)
    {
      for (;;)
      {
        localahyr.jdField_a_of_type_Int = -1;
  ...
  {
    int j = 0;
    if ((paramaysx == null) || (paramaysx.jdField_a_of_type_Aysw == null))
    {
      QLog.e("RDBaseDataManager", 2, "onResp  param error!");
      return;
    }
    ahyr localahyr = (ahyr)paramaysx.jdField_a_of_type_Aysw.a();
    if (QLog.isColorLevel()) {
      QLog.i("RDBaseDataManager", 2, "onResp  ID:" + localahyr.jdField_a_of_type_Int + "  result:" + paramaysx.jdField_a_of_type_Int);
    }
    if (paramaysx.jdField_a_of_type_Int != 0)
    {
      ThreadManager.getUIHandler().post(new RDBaseDataManager.2(this, localahyr));
      return;
    }
    int i;
    if (!TextUtils.isEmpty(paramaysx.jdField_a_of_type_Aysw.jdField_c_of_type_JavaLangString))
    {
      i = j;
      if (!TextUtils.isEmpty(localahyr.jdField_a_of_type_JavaLangString))
      {
        String str = bbdj.c(paramaysx.jdField_a_of_type_Aysw.jdField_c_of_type_JavaLangString);
        if (localahyr.jdField_a_of_type_JavaLangString.equalsIgnoreCase(str)) {
          i = j;
        }
      }
      else
      {
        j = i;
        if (TextUtils.isEmpty(localahyr.b)) {}
      }
    }
    for (;;)
    {
      try
      {
        bbdj.a(paramaysx.jdField_a_of_type_Aysw.jdField_c_of_type_JavaLangString, localahyr.b, false);
        j = i;
      }
      catch (Exception localException)
      {
      ...
      ThreadManager.getUIHandler().post(new RDBaseDataManager.3(this, localahyr, j, paramaysx));
      return;
      i = 1;
      break;
      j = 1;
  ...
  public void onUpdateProgeress(aysw paramaysw, long paramLong1, long paramLong2)
  {
    ...
    paramaysw = (ahyr)paramaysw.a();
    ThreadManager.getUIHandler().post(new RDBaseDataManager.4(this, paramaysw, paramLong1, paramLong2));
  }
}
