...
public abstract class zzj
{
  ...
  public static zzj b(String paramString, zzk paramzzk)
  {
    String str = paramzzk.f;
    if (str.equals("Native"))
    {
      paramString = zze.a(paramString, paramzzk);
      if (paramString == null) {
        return null;
      }
    }
    ...
    {
      zyz.a("KingKongPatchInfo", "Unsupported patch type : " + str);
      return null;
    }
    if ((!paramString.c.equals(paramzzk.jdField_a_of_type_JavaLangString)) || (!paramString.d.equals(paramzzk.b)) || (!paramString.e.equals(paramzzk.f)) || (!paramString.e.equals("Native")))
    {
      zyz.a("KingKongPatchInfo", "Patch name, version or type mismatch : " + paramString.c + ", " + paramString.d + ", " + paramString.e);
      return null;
    }
    paramString.jdField_a_of_type_Zzk = paramzzk;
    return paramString;
  }
