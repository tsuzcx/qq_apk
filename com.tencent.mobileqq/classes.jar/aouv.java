...
class aouv
  implements azgl
{
  aouv(aous paramaous, List paramList, String paramString1, FileManagerEntity paramFileManagerEntity, boolean paramBoolean1, String paramString2, boolean paramBoolean2, String paramString3, String paramString4, short paramShort, String paramString5, int paramInt, String paramString6, wlx paramwlx) {}
      ...
      if ((paramJSONObject != null) && (!paramJSONObject.isNull("files")))
      {
        ...
        if (paramInt < paramBundle.length())
        {
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_Aous.a.a().a(localFileManagerEntity);
            this.jdField_a_of_type_JavaUtilList.add(localaoys);
            paramInt += 1;
            break;
