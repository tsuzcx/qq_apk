  ...
  extends bdnv
{
  ...
  private void a(Context paramContext, Resources paramResources, RelativeLayout paramRelativeLayout, View paramView, LinearLayout paramLinearLayout, TextView paramTextView1, TextView paramTextView2)
  {
    ...
    paramResources.setId(2131377867);
    paramView = new ImageView(paramContext);
    paramView.setImageResource(2130850496);
    ...
    paramTextView2.setId(2131377868);
    ...
    paramResources.addRule(3, 2131377867);
    ...
    paramResources.setId(2131377869);
    paramResources.setImageResource(2130850498);
    paramView = new RelativeLayout.LayoutParams(-2, -2);
    paramView.addRule(14);
    paramView.addRule(3, 2131377868);
    paramRelativeLayout.addView(paramResources, paramView);
    paramResources = new RelativeLayout(paramContext);
    paramView = new ImageView(paramContext);
    paramView.setId(2131377871);
    paramView.setImageResource(2130850499);
    ...
    paramContext.setImageResource(2130850495);
    paramView = new RelativeLayout.LayoutParams(-2, -2);
    paramView.addRule(15);
    paramView.addRule(0, 2131377871);
    ...
    paramContext.addRule(1, 2131377871);
    ...
    paramContext.addRule(3, 2131377869);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      paramView = (bdnu)localIterator.next();
      localObject5 = paramView.a;
      if ((!"type".equals(localObject5)) || (!(paramView instanceof bdtd))) {
        break label264;
      }
      j = ((bdtd)paramView).o;
      i = j;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          if (("head".equals(localObject5)) && ((paramView instanceof bdpq)) && (localObject2 == null))
          {
            ((bdpq)paramView).o = i;
            ...
            continue;
            label532:
            paramView = new bdsj(paramContext.getString(2131718927)).a(paramContext, null, null);
            ...
            paramBundle = (TextView)paramView.findViewById(2131378152);
            ...
            if (i == 4)
            {
              ...
              paramBundle.setText(anvx.a(2131713996));
              return localLinearLayout;
            }
            ...
            paramBundle.setImageResource(2130850489);
            ...
            paramContext = new ImageView(paramContext);
            paramContext.setImageResource(2130850490);
            paramBundle = new RelativeLayout.LayoutParams(-2, -2);
