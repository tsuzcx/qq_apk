  ...
  extends AccountObserver
{
  ...
  public void onGetQuickRegisterAccount(boolean paramBoolean, int paramInt, String paramString1, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    if (!paramBoolean) {
      try
      {
        ...
        if (TextUtils.isEmpty(paramString1)) {
          paramString2 = this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.getString(2131651340);
        }
    ...
    if (paramInt == 0)
    {
      auqt.a(this.a, paramString1);
      auqt.b(this.a, paramString2);
      if ((TextUtils.isEmpty(auqt.a(this.a))) || (TextUtils.isEmpty(auqt.b(this.a))))
      {
      ...
      paramString1.putExtra("uin", auqt.a(this.a));
      paramString1.putExtra("key_register_password", auqt.c(this.a));
      ...
      {
        auqt.a(this.a, paramString1, false);
        return;
      }
  ...
  public void onRegisterCommitPassResp(boolean paramBoolean, int paramInt, String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    try
    {
      ...
      if (paramBoolean)
      {
        ...
        localObject = "";
        awqx.a(localQQAppInterface, "new_reg", "setting_page_yes", "result", "", 1, "", str, "", (String)localObject, "", "", "", "", "");
        this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.c();
        if (paramBoolean) {
          break label179;
        }
        ...
        if (TextUtils.isEmpty(paramArrayOfByte2)) {
          paramString = this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.getString(2131651340);
        }
    ...
    catch (UnsupportedEncodingException paramArrayOfByte2)
    {
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        auqt.a(this.a, paramString);
        auqt.a(this.a, paramArrayOfByte1);
        if (!TextUtils.isEmpty(auqt.a(this.a))) {
          break;
        }
        this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131651340, 1);
        return;
      }
      if ((auqt.a(this.a) == null) || (auqt.a(this.a).length == 0))
      {
        this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131651340, 1);
        return;
      }
