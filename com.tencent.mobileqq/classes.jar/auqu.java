...
public class auqu
  implements aumh, Manager
{
  QQAppInterface a;
  
  public auqu(QQAppInterface paramQQAppInterface)
  {
    this.a = paramQQAppInterface;
  }
  
  public static Bundle a(IVPluginInfo paramIVPluginInfo, aumd paramaumd)
  {
    int m = 0;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject2 = (amsw)((AppRuntime)localObject1).getManager(51);
        localObject3 = ((amsw)localObject2).e(str2);
        ...
        localObject3 = ((amsw)localObject2).b(str2);
        if (localObject3 == null) {
          break label452;
        }
      ...
      localBundle.putString("payToken", paramaumd.a().c);
