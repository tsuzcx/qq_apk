...
public class auqu
  ...
  implements Handler.Callback, bmxp
{
  ...
  public auqu(Context paramContext, QQAppInterface paramQQAppInterface, QQGamePubAccountFragment paramQQGamePubAccountFragment)
  {
  ...
  public void a()
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559199, null, false);
    localRelativeLayout.setLayoutParams(new RecyclerView.LayoutParams(-1, 0));
    this.jdField_a_of_type_Aurl = new aurl(localRelativeLayout, this.jdField_a_of_type_AndroidContentContext);
  ...
  {
    this.jdField_a_of_type_AndroidAppDialog = new ReportDialog(this.jdField_a_of_type_AndroidContentContext, 2131755265);
    Object localObject = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559206, null);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(afur.a(280.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), -1);
    ((ImageView)((View)localObject).findViewById(2131368499)).setImageDrawable(URLDrawable.getDrawable("https://cmshow.gtimg.cn/client/gameCenter/gameCenter_popView_card@2x.png"));
    TextView localTextView1 = (TextView)((View)localObject).findViewById(2131379975);
    if ((!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString3)))
    {
      localTextView1.setText(paramString2);
      localTextView1.setTextColor(auud.a(-16733441, 1593879295));
      ...
      paramString2 = (CheckBox)((View)localObject).findViewById(2131364456);
      TextView localTextView2 = (TextView)((View)localObject).findViewById(2131379566);
      TextView localTextView3 = (TextView)((View)localObject).findViewById(2131379729);
      localTextView3.setTextColor(auud.a(-16733441, 1593879295));
      ...
      paramString2.setOnCheckedChangeListener(new auqx(this, paramString1));
      localTextView2.setOnClickListener(new auqy(this, paramString4));
      localTextView1.setOnClickListener(new auqz(this, paramString4, paramString3));
      localTextView3.setOnClickListener(new aura(this, paramString4, paramJSONObject, (String)localObject));
      this.jdField_a_of_type_AndroidAppDialog.show();
      paramString1 = new HashMap();
      aceh.a(paramString1, paramString4);
    ...
    for (;;)
    {
      ...
      aceh.a(ampj.a(), "769", "205710", a().gameAppId, "76905", "1", "160", paramString1);
      return;
      localTextView1.setText(anni.a(2131709089));
      break;
      label410:
  ...
  {
    b();
    this.jdField_a_of_type_AndroidWidgetFrameLayout$LayoutParams.topMargin = afur.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ...
    if (paramBoolean1)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131709073));
      return;
    }
    if (paramBoolean2)
    {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131709075));
  }
  ...
  public void b()
  {
    if (this.jdField_b_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      ((FrameLayout.LayoutParams)localObject2).leftMargin = afur.a(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      this.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131709076));
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847160);
      ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847160);
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      localObject3 = new LinearLayout.LayoutParams(afur.a(15.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), afur.a(15.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      localFrameLayout.setLayoutParams(new RecyclerView.LayoutParams(-1, afur.a(120.0F, this.jdField_a_of_type_AndroidContentContext.getResources())));
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131709066));
      ...
      ((LinearLayout.LayoutParams)localObject3).leftMargin = afur.a(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      this.jdField_c_of_type_AndroidWidgetTextView.setText(anni.a(2131709091));
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.clearAnimation();
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131709083));
  ...
  {
    bmxq.a().b(this);
    if (this.jdField_a_of_type_Bmxe != null) {
      bmxh.b(this.jdField_a_of_type_Bmxe);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(anni.a(2131709084));
      return false;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
  ...
  {
    if (a(paramInt)) {
      if ((paramViewHolder instanceof aurl)) {
        ((aurl)paramViewHolder).a(this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFeedsItemData$TopCardInfo, this);
      }
    }
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            if ((!(paramViewHolder instanceof aurd)) && (!(paramViewHolder instanceof aurb))) {
              break;
            }
          ...
          {
            localObject2 = (aurd)paramViewHolder;
            ((aurd)localObject2).a(this, (FeedsItemData)localObject1, paramInt);
            ((aurd)localObject2).d.setTag(a().gameAppId);
            localObject2 = new HashMap();
            aceh.a((Map)localObject2, ((FeedsItemData)localObject1).msgId);
            ...
            {
              aceh.a(ampj.a(), "769", "205021", (String)localObject1, "76902", "1", "160", (Map)localObject2);
              break;
            }
          }
        } while (((FeedsItemData)localObject1).type != 4);
        ((aurb)paramViewHolder).a(this, (FeedsItemData)localObject1, paramInt);
        localObject2 = new HashMap();
        aceh.a((Map)localObject2, ((FeedsItemData)localObject1).msgId);
        ((Map)localObject2).put(Integer.valueOf(2), ((FeedsItemData)localObject1).msgId);
        ((Map)localObject2).put(Integer.valueOf(4), "8");
      ...
      } while (!(paramViewHolder instanceof ausb));
      localObject1 = a(paramInt);
    } while (localObject1 == null);
    ((ausb)paramViewHolder).a((FeedsItemData)localObject1);
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    if (this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null)
    {
      if (paramInt == this.jdField_a_of_type_Int) {
        return this.jdField_a_of_type_Aurl;
      }
      return new auqv(this, (View)this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null) {
      return new auqw(this, (View)this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (paramInt == 4)
    {
      ...
      ((LinearLayout)localObject1).setPadding(afur.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, afur.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      ((TextView)localObject3).setId(2131378776);
      ((TextView)localObject3).setEllipsize(TextUtils.TruncateAt.END);
      Object localObject4 = new RelativeLayout.LayoutParams(-1, afur.a(45.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((RelativeLayout.LayoutParams)localObject4).setMargins(afur.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), afur.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), afur.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      ((TextView)localObject4).setId(2131363032);
      ((TextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      ((TextView)localObject4).setMaxWidth(afur.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      RelativeLayout.LayoutParams localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.setMargins(afur.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), afur.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, afur.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams2.addRule(3, 2131378776);
      ((RelativeLayout)localObject2).addView((View)localObject4, localLayoutParams2);
      localObject4 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ((TextView)localObject4).setTextColor(-6052957);
      ((TextView)localObject4).setTextSize(12.0F);
      ((TextView)localObject4).setMaxLines(1);
      ((TextView)localObject4).setId(2131371889);
      ((TextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.leftMargin = afur.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      localLayoutParams2.addRule(6, 2131363032);
      localLayoutParams2.addRule(1, 2131363032);
      ((RelativeLayout)localObject2).addView((View)localObject4, localLayoutParams2);
      localObject4 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ((TextView)localObject4).setTextColor(-6052957);
      ((TextView)localObject4).setTextSize(10.0F);
      ((TextView)localObject4).setMaxLines(1);
      ((TextView)localObject4).setId(2131367323);
      ((TextView)localObject4).setBackgroundColor(1270796256);
      ((TextView)localObject4).setPadding(afur.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), afur.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), afur.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), afur.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((TextView)localObject3).setEllipsize(TextUtils.TruncateAt.END);
      localObject3 = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject3).setMargins(0, afur.a(-1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), afur.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ((RelativeLayout.LayoutParams)localObject3).addRule(6, 2131363032);
      ...
      ((CornerImageView)localObject2).setId(2131368378);
      localLayoutParams = new LinearLayout.LayoutParams(0, afur.a(71.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams.weight = 3.0F;
      localLayoutParams.gravity = 16;
      ((LinearLayout)localObject1).addView((View)localObject2, localLayoutParams);
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      localObject1 = new ImageView(this.jdField_a_of_type_AndroidContentContext);
      localLayoutParams1 = new RelativeLayout.LayoutParams(-1, afur.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((ImageView)localObject1).setImageDrawable(new ColorDrawable(-263173));
      ((ImageView)localObject1).setId(2131365590);
      ((ImageView)localObject1).setPadding(afur.a(25.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, 0, 0);
      localLayoutParams1.rightMargin = afur.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      return new aurb(paramViewGroup);
    }
    if ((paramInt == 5) || (paramInt == 7) || (paramInt == 6)) {
      return ausg.a(this.jdField_a_of_type_AndroidContentContext, paramInt, paramViewGroup);
    }
    return new aurd(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559198, paramViewGroup, false));
  }
  
  public void onViewDetachedFromWindow(RecyclerView.ViewHolder paramViewHolder)
  {
    super.onViewDetachedFromWindow(paramViewHolder);
    if ((paramViewHolder instanceof aurd))
    {
      paramViewHolder = (aurd)paramViewHolder;
      if ((paramViewHolder.a != null) && (ausy.a().a() == paramViewHolder.a))
      {
        paramViewHolder.a.i();
        paramViewHolder.a.l();
      }
