...
public class avlb
  extends Observable
  implements aaam, Handler.Callback, Observer
{
  ...
  public static avlb a()
  {
    if (jdField_a_of_type_Avlb == null) {}
    try
    {
      if (jdField_a_of_type_Avlb == null) {
        jdField_a_of_type_Avlb = new avlb();
      }
      return jdField_a_of_type_Avlb;
    }
    finally {}
  }
  ...
  public void a()
  {
    ...
    label61:
    while ((!((GameArkView)localObject).a()) || (!avme.a(((GameArkView)localObject).a()))) {
      return;
    }
    try
    {
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    try
    {
      if ((paramObject instanceof alhy))
      {
        paramObservable = ((alhy)paramObject).jdField_a_of_type_JavaLangString;
        String str = ((alhy)paramObject).b;
        paramObject = ((alhy)paramObject).c;
