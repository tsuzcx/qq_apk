...
public class akxz
  implements alll, SurfaceTexture.OnFrameAvailableListener, TVK_IMediaPlayer.OnCompletionListener, TVK_IMediaPlayer.OnDownloadCallbackListener, TVK_IMediaPlayer.OnErrorListener, TVK_IMediaPlayer.OnSeekCompleteListener, TVK_IMediaPlayer.OnVideoPreparedListener
{
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private akya jdField_a_of_type_Akya;
  private alav jdField_a_of_type_Alav = new alav(0);
  ...
  public akxz(akya paramakya, int paramInt)
  {
    this.jdField_a_of_type_Akya = paramakya;
  ...
  private void e()
  {
    ...
    if ((localTVK_IProxyFactory != null) && (this.jdField_a_of_type_AndroidGraphicsSurfaceTexture == null))
    {
      ...
      if (this.jdField_a_of_type_Allk != null) {
        this.jdField_a_of_type_Allk.a(null);
      }
      if (this.jdField_a_of_type_Allk == null) {
      ...
      {
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer = localTVK_IProxyFactory.createMediaPlayer(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Allk);
  ...
  public void a(String paramString, long paramLong, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    label197:
    localTVK_PlayerVideoInfo.setConfigMap("file_dir", allj.a(paramString));
    if (this.jdField_b_of_type_Boolean) {}
    for (localObject = "true";; localObject = "false")
    {
      ...
      localTVK_PlayerVideoInfo.setVid(bdhv.d(paramString));
  ...
  public void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Akya != null) {
      this.jdField_a_of_type_Akya.a(paramArrayOfByte1);
    }
  }
  ...
  public void onCompletion(TVK_IMediaPlayer paramTVK_IMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Akya != null) {
      this.jdField_a_of_type_Akya.a(paramTVK_IMediaPlayer);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Akya != null) {
      this.jdField_a_of_type_Akya.a(this.jdField_a_of_type_JavaLangRunnable);
    }
  }
