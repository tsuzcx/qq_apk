      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          if ((!Modifier.isStatic(k)) || (!Modifier.isFinal(k)))
          {
            ...
            localObject4 = (arlx)localField.getAnnotation(arlx.class);
            if (localObject4 != null) {
              paramClass = ((arlx)localObject4).a();
            }
  ...
  public static <T> JSONObject a(T paramT)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        Object localObject2 = (arlx)((Field)localObject1).getAnnotation(arlx.class);
        if (localObject2 != null)
        {
          localObject2 = ((arlx)localObject2).a();
