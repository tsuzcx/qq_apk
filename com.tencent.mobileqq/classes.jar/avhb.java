  ...
  implements Handler.Callback, Manager
{
  ...
  public avhb(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Avhc = new avhc(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  }
  
  private void a(avha paramavha)
  {
    int i = this.jdField_a_of_type_Avhc.a(paramavha);
  ...
  private void b(avha paramavha)
  {
    ThreadManager.post(new ScribbleDownloader.1(this, paramavha), 5, null, false);
  }
  
  private void d()
  {
    if (this.jdField_a_of_type_Avhc.a() < 2)
    {
      avha localavha = this.jdField_a_of_type_Avhc.a();
      if (localavha == null)
      {
  ...
  {
    int i = this.jdField_a_of_type_Avhc.a(paramMessageForScribble);
  ...
  public void a(MessageForScribble paramMessageForScribble)
  {
    ...
    if (a())
    {
      a(new avha(paramMessageForScribble, 200));
      return;
    }
  ...
  public void b(MessageForScribble paramMessageForScribble)
  {
    ...
    a(new avha(paramMessageForScribble, 201));
  }
