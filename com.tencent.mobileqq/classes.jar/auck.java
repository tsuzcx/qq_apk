...
public class auck
{
  ...
  /* Error */
  public static aucm a(String paramString)
  {
    // Byte code:
    //   0: lconst_0
    //   1: lstore_1
    ...
    //   25: aconst_null
    //   26: lconst_0
    //   27: invokespecial 215	aucm:<init>	(Ljava/lang/String;J)V
    //   30: areturn
    ...
    //   332: astore 14
    //   334: aload 11
    //   336: invokestatic 257	auck:a	(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    //   339: astore 15
    //   341: aload 15
    //   343: astore 10
    //   345: lload_1
    ...
    //   585: aload 10
    //   587: lload_1
    //   588: invokespecial 215	aucm:<init>	(Ljava/lang/String;J)V
    //   591: areturn
    //   592: astore 13
    //   594: lconst_0
    //   595: lstore_3
  ...
  public static void a(String paramString, aucn paramaucn)
  {
    atvy.a().execute(new UniformDownloadUtil.2(paramString, paramaucn));
  }
  
  public static void a(String paramString, auco paramauco)
  {
    ThreadManager.getSubThreadHandler().post(new UniformDownloadUtil.1(paramString, paramauco));
  }
  
  public static void a(String paramString1, String paramString2)
  {
    a(paramString1, new aucl(paramString1, paramString2));
  }
  
  public static boolean a(String paramString)
  {
    return (paramString != null) && (atwl.a(paramString).equalsIgnoreCase(".apk"));
  }
  
  public static void b(String paramString1, String paramString2)
  {
    QLog.i("UniformDownloadUtil", 1, "[UniformDL] >>>openFileWithOtherApp. localPath:" + paramString1);
    if ((paramString1 == null) || (!atwl.a(paramString1)))
    {
      QLog.e("UniformDownloadUtil", 1, "[UniformDL] openFileWithOtherApp. file is not existed. localPath:" + paramString1);
      return;
    }
    BaseApplication localBaseApplication = BaseApplication.getContext();
    String str = beas.a(localBaseApplication, paramString1);
