  ...
  implements azgl, sse
{
  ...
  WeakReference<bign> jdField_a_of_type_MqqUtilWeakReference;
  ssf jdField_a_of_type_Ssf = null;
  double jdField_b_of_type_Double = 0.0D;
  ArrayList<TroopBarPOI> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  
  public bhkq(bhkt parambhkt)
  {
  ...
  public bign a()
  {
    if (this.jdField_a_of_type_MqqUtilWeakReference != null) {
      return (bign)this.jdField_a_of_type_MqqUtilWeakReference.get();
    }
    return null;
  }
  ...
  public void a()
  {
    urk.b("FacePoiManager", "requestPoiList");
  ...
  {
    urk.b("FacePoiManager", "onPOIListRequestResult.");
    ...
    if ((paramInt == 0) && (paramssf != null)) {
      if (!paramssf.a())
      {
        ...
        if ((this.jdField_a_of_type_Ssf != null) && (this.jdField_a_of_type_Ssf.b())) {
        ...
        urk.a("FacePoiManager", "onPOIListRequestResult, CurrentPOIList : %s , CurrentPOI : %s .", this.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI);
        this.jdField_a_of_type_Bhkt.a(true, bool, this.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI);
      }
    }
    for (;;)
    {
      ...
      bool = false;
      break;
      this.jdField_a_of_type_Bhkt.a(false, false, null, null);
    }
  }
  
  public void a(bign parambign, String paramString)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(parambign);
  ...
  {
    urk.b("FacePoiManager", "requestSosoPoi");
    this.jdField_a_of_type_Bhkt.a(2, new String[0]);
    new auua(paramActivity, new bhkr(this, paramBoolean)).a();
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Akgd != null)
    {
      ...
      this.jdField_a_of_type_Akgd = null;
  ...
  public void c()
  {
    if (this.jdField_a_of_type_MqqUtilWeakReference != null)
    {
      bign localbign = (bign)this.jdField_a_of_type_MqqUtilWeakReference.get();
      if (localbign != null) {
        localbign.a();
      }
    }
