  ...
  extends vhp
{
  ...
  private void b(int paramInt)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("EditPicActivity.EditPicPartManager", 2, "reset2Camera begin " + this.jdField_a_of_type_Vja.getActivity() + " new path " + str);
    }
    PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_Vja.a()).edit().putString("edit_pic_new_path", str).commit();
    Intent localIntent;
    if (paramInt == 101)
    {
    ...
    try
    {
      bcpw.a(localActivity, ajyc.a(2131703680), 0).a();
  ...
  private void w()
  {
    ...
    localvsd.b = vst.a(2);
    localvsd.jdField_a_of_type_Vsh = new vsh(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a());
    localvsd.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064 = new LpReportInfo_pf00064();
    localvsd.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.actionType = 615;
    localvsd.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.subactionType = 8;
    ...
    if (this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 3)
    {
      ...
      int i = 0;
      while (i < localvsd.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.size())
      {
        ((StringBuilder)localObject).append((String)localvsd.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.get(i) + ",");
        i += 1;
      }
      if (((StringBuilder)localObject).length() > 0) {
        ((StringBuilder)localObject).deleteCharAt(((StringBuilder)localObject).length() - 1);
      }
      localvsd.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves5 = ((StringBuilder)localObject).toString();
      LpReportManager.getInstance().reportToPF00064(localvsd.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064, true, false);
    }
    vem.b("0X80076EA");
    veg.d("EditPicActivity.EditPicPartManager", "PUBLISH start ...");
    this.jdField_a_of_type_Vja.a(ajyc.a(2131703679), false, 500L);
    Stream.of(localvsd).map(new vsf((veu)a(veu.class), null)).map(new ThreadOffFunction("EditPicActivity.EditPicPartManager", 2)).map(new vsr(vfk.jdField_a_of_type_JavaLangString + "qq_pic_merged_" + System.currentTimeMillis() + ".jpg")).map(new UIThreadOffFunction(this)).subscribe(new vfn(this, localvsd));
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt1 == 1000) && (paramInt2 != -1) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
    {
      ...
      vyi.b(BaseApplication.getContext(), new File(this.jdField_a_of_type_JavaLangString));
  ...
  void a(Activity paramActivity, int paramInt, Intent paramIntent)
  {
    ...
    default: 
      ...
      this.jdField_a_of_type_Vja.a(-1, null, 2130772028, 0);
    case 101: 
    case 104: 
      do
      {
  ...
  protected void a(@NonNull EditVideoParams paramEditVideoParams)
  {
    ...
    Object localObject = new vgb(this, paramEditVideoParams.b);
    this.jdField_a_of_type_Vgb = ((vgb)localObject);
    localArrayList.add(localObject);
    localObject = new vgd(this, paramEditVideoParams.b);
    ...
    {
      localObject = new vez(this);
      this.jdField_a_of_type_Vez = ((vez)localObject);
      localArrayList.add(localObject);
    }
    a(localArrayList);
  ...
  public void b()
  {
    Object localObject = this.jdField_a_of_type_Vja.getActivity().getIntent();
    ...
    if ((i == 103) && (i == 103))
    {
      ...
      axqw.b(null, "dc00898", "", "", "0X80072C5", "0X80072C5", 0, 0, (String)localObject, "" + j, "", "");
      if (bool) {
        axqw.b(null, "dc00898", "", "", "0X80083B2", "0X80083B2", 0, 0, (String)localObject, "" + j, "", "");
      }
      vem.b("0X80075E8");
    }
    for (;;)
    {
      ...
      break;
      label379:
      axqw.b(null, "dc00898", "", "", "0X80072C4", "0X80072C4", 0, 0, (String)localObject, "" + j, "", "");
    }
  }
  ...
  protected void c()
  {
    ...
    if (i != -1)
    {
      ...
      bbdr.a(this.jdField_a_of_type_Vja.a(), this.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a());
      ...
      if (i == 103)
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Vja.a(0, localIntent, 2130772028, 0);
          return;
          localObject = "1";
          break;
          label264:
