...
public class bbos
  implements Manager
{
  private static bbow jdField_a_of_type_Bbow = new bbow(null);
  public static final String a;
  public static AtomicBoolean a;
  public Handler a;
  private anwl jdField_a_of_type_Anwl = new bbou(this);
  public bboz a;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private VasQuickUpdateManager.CallBacker jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new bbov(this);
  private Vector<Integer> jdField_a_of_type_JavaUtilVector = new Vector();
  public ConcurrentHashMap<Integer, bboy> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = bbvj.a(ajsd.aW + ".CorlorNick/");
    jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  }
  
  public bbos(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Bboz = new bboz(this);
  }
  
  public static int a(List<bckp> paramList, Paint paramPaint, Rect paramRect)
  {
    ...
    {
      bckp localbckp = (bckp)paramList.next();
      switch (localbckp.c)
      {
      }
      for (;;)
      {
        break;
        int j = (int)Math.ceil(paramPaint.measureText(localbckp.jdField_a_of_type_JavaLangString));
        paramPaint.getTextBounds(localbckp.jdField_a_of_type_JavaLangString, 0, localbckp.jdField_a_of_type_JavaLangString.length(), localRect);
        paramRect.bottom = Math.max(paramRect.bottom, localRect.height());
        i += j;
        continue;
        i += ((aykr)localbckp.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
        paramRect.bottom = Math.max(paramRect.bottom, ((aykr)localbckp.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().height());
      }
    }
    paramRect.left = 0;
    paramRect.right = i;
  ...
  public static bbos a(QQAppInterface paramQQAppInterface)
  {
    return ((bbrg)paramQQAppInterface.getManager(235)).a;
  }
  
  private bboy a(File paramFile, int paramInt)
  {
    int i = 0;
    paramFile = bbdx.a(paramFile, -1);
    try
    {
      ...
      if ((paramFile != null) && (paramFile.length() > 0))
      {
        ...
        localbboy.jdField_a_of_type_Int = ((JSONObject)localObject).optInt("type");
        if (localbboy.jdField_a_of_type_Int == 5)
        {
          ...
          localbboy.jdField_a_of_type_AndroidGraphicsBitmap = bbef.a((String)localObject, null);
          return localbboy;
        }
        localbboy.b = ((JSONObject)localObject).optInt("orientation");
        paramFile = ((JSONObject)localObject).optJSONArray("colors");
        if ((paramFile != null) && (paramFile.length() > 0))
        {
          localbboy.jdField_a_of_type_ArrayOfInt = new int[paramFile.length()];
          paramInt = 0;
          while (paramInt < paramFile.length())
          {
            String str = paramFile.getString(paramInt);
            localbboy.jdField_a_of_type_ArrayOfInt[paramInt] = Color.parseColor(str);
            paramInt += 1;
          }
        }
        if ((localbboy.jdField_a_of_type_Int != 1) && (localbboy.jdField_a_of_type_Int != 2))
        {
          paramFile = localbboy;
          if (localbboy.jdField_a_of_type_Int != 3) {
            return paramFile;
          }
        }
        ...
        localbboy.jdField_a_of_type_ArrayOfFloat = new float[((JSONArray)localObject).length()];
        paramInt = i;
        for (;;)
        {
          paramFile = localbboy;
          ...
          if (TextUtils.isDigitsOnly(paramFile))
          {
            ...
            localbboy.jdField_a_of_type_ArrayOfFloat[paramInt] = (i / 100.0F);
          }
          paramInt += 1;
        }
      }
  ...
  public static CharSequence a(MessageRecord paramMessageRecord, MsgSummary paramMsgSummary)
  {
    ...
    {
      if (!TextUtils.isEmpty(paramMsgSummary.strPrefix)) {
        localSpannableString = new ayjw(paramMsgSummary.strPrefix, 16).a();
      }
      ...
      paramMsgSummary.strContent = new aykk((CharSequence)localObject, 5, 16);
  ...
  public static CharSequence a(String paramString, MessageRecord paramMessageRecord, int paramInt1, int paramInt2)
  {
    ...
    {
      str = paramMessageRecord.getExtInfoFromExtStr(axaf.i);
      ...
      str = bafy.a(localMessageForReplyText.mSourceMsgInfo.mSourceMsgSenderUin, str);
    }
    label71:
    for (;;)
    {
      return a(paramString, str, paramInt1, paramMessageRecord, paramInt2);
      return new aykk(paramString, paramInt2, paramInt1, paramMessageRecord);
    }
  }
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      ...
      if ((paramString2 != null) && (paramString2.size() > 0))
      {
        ...
        while (i < paramString2.size())
        {
          ...
          {
            bbox localbbox = new bbox(null);
            localbbox.jdField_a_of_type_Int = localAtTroopMemberInfo.startPos;
            ...
            {
              localbbox.b = j;
              localbbox.jdField_a_of_type_AndroidTextSpannableString = new ayjw(paramString1.subSequence(localbbox.jdField_a_of_type_Int, localbbox.b), paramInt1).a();
              ((ArrayList)localObject).add(localbbox);
              break;
        ...
        {
          paramString2 = (bbox[])((ArrayList)localObject).toArray(new bbox[((ArrayList)localObject).size()]);
          Arrays.sort(paramString2, jdField_a_of_type_Bbow);
          localObject = new SpannableStringBuilder();
          ...
          if (i < m)
          {
            ...
            if (localAtTroopMemberInfo.jdField_a_of_type_Int >= j) {
              ((SpannableStringBuilder)localObject).append(new aykk(paramString1.subSequence(j, localAtTroopMemberInfo.b), paramInt2, paramInt1, paramMessageRecord));
            }
            for (;;)
            {
          ...
          if (j < paramString1.length()) {
            ((SpannableStringBuilder)localObject).append(new aykk(paramString1.subSequence(j, paramString1.length()), paramInt2, paramInt1, paramMessageRecord));
          }
          return localObject;
        }
      }
    }
    return new aykk(paramString1, paramInt2, paramInt1, paramMessageRecord);
  }
  
  public static String a(bbol parambbol)
  {
    int j = 0;
    char[] arrayOfChar = new char[7];
    arrayOfChar[0] = '<';
    arrayOfChar[1] = '%';
    arrayOfChar[2] = ((char)(parambbol.b >>> 24 & 0xFF));
    arrayOfChar[3] = ((char)(parambbol.b >>> 16 & 0xFF));
    arrayOfChar[4] = ((char)(parambbol.b >>> 8 & 0xFF));
    arrayOfChar[5] = ((char)(parambbol.b & 0xFF));
    arrayOfChar[6] = '>';
    int i = j;
  ...
  public static List<bckp> a(int paramInt1, String paramString, Paint paramPaint, bckq parambckq, int paramInt2)
  {
    Object localObject = new ArrayList();
    ArrayList localArrayList = new ArrayList();
    ColorClearableEditText.a((List)localObject, parambckq, new ayjw(paramString, paramInt2).a());
    int i = (int)Math.ceil(paramPaint.measureText("..."));
    paramString = ((ArrayList)localObject).iterator();
    paramInt2 = 0;
    if (paramString.hasNext())
    {
      parambckq = (bckp)paramString.next();
      switch (parambckq.c)
      {
      }
      for (;;)
      {
        break;
        localObject = aybs.a(paramInt1 - paramInt2, parambckq.jdField_a_of_type_JavaLangString, paramPaint);
        int j;
        if (((String)localObject).equals(parambckq.jdField_a_of_type_JavaLangString))
        {
          j = (int)Math.ceil(paramPaint.measureText(parambckq.jdField_a_of_type_JavaLangString));
          localArrayList.add(parambckq);
          paramInt2 += j;
        }
        else
        {
          parambckq.jdField_a_of_type_JavaLangString = ((String)localObject);
          localArrayList.add(parambckq);
          return localArrayList;
          j = ((aykr)parambckq.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
          if (j > paramInt1 - paramInt2 - i)
          {
            localArrayList.add(new bckp(1, parambckq.jdField_a_of_type_Int, parambckq.b, "...", null));
            return localArrayList;
          }
          localArrayList.add(parambckq);
          paramInt2 += j;
  ...
  public static void a(aocg paramaocg, QQAppInterface paramQQAppInterface, EditText paramEditText)
  {
    if (paramaocg.a == null)
    {
    ...
    try
    {
      ...
      ((askf)paramQQAppInterface.getManager(14)).a(String.valueOf(j), new bbot(j, i, paramEditText));
      return;
    }
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              return;
              paramSpannable = (bbpl[])paramSpannable.getSpans(0, paramSpannable.length(), bbpl.class);
    ...
    if ((paramDraftTextInfo != null) && (!TextUtils.isEmpty(paramDraftTextInfo.mAtInfoStr)) && (!TextUtils.isEmpty(paramString1)))
    {
      ...
      if (paramDraftTextInfo != null)
      {
        ...
        while (paramDraftTextInfo.hasNext())
        {
          ...
          {
            SpannableString localSpannableString = bafv.a(paramQQAppInterface, paramBaseActivity, paramString2, Long.toString(localAtTroopMemberInfo.uin), paramString1.substring(localAtTroopMemberInfo.startPos + 1, localAtTroopMemberInfo.startPos + localAtTroopMemberInfo.textLen), false, paramXEditTextEx, true);
            if (localSpannableString != null) {
  ...
  public Shader a(int paramInt1, List<bckp> paramList, float paramFloat1, float paramFloat2, Rect paramRect, Paint paramPaint, int paramInt2, int paramInt3)
  {
    bboy localbboy = a(paramInt1);
    if (localbboy != null) {}
    float f1;
    float f2;
    label90:
    ...
    Object localObject3;
    bckp localbckp;
    switch (localbboy.jdField_a_of_type_Int)
    {
    default: 
      return null;
    case 1: 
      ...
      {
        return new LinearGradient(f1, f2, paramFloat1, paramFloat2, localbboy.jdField_a_of_type_ArrayOfInt, localbboy.jdField_a_of_type_ArrayOfFloat, Shader.TileMode.CLAMP);
    ...
    case 2: 
      ...
      {
        localbckp = (bckp)paramList.get(paramInt2);
        switch (localbckp.c)
        {
        default: 
          paramInt2 += 1;
        ...
        case 1: 
          ...
          paramPaint.getTextBounds(localbckp.jdField_a_of_type_JavaLangString, 0, localbckp.jdField_a_of_type_JavaLangString.length(), (Rect)localObject3);
    ...
    {
      paramInt3 = 0;
      if (paramInt3 < localbckp.jdField_a_of_type_JavaLangString.length())
      {
        float f5 = paramPaint.measureText(localbckp.jdField_a_of_type_JavaLangString, paramInt3, paramInt3 + 1);
        if (localbboy.b == 1)
        {
        ...
        {
          paramRect.setShader(new LinearGradient(paramFloat2, f1, f2, f3, localbboy.jdField_a_of_type_ArrayOfInt, localbboy.jdField_a_of_type_ArrayOfFloat, Shader.TileMode.CLAMP));
      ...
      break label324;
      paramFloat1 += ((aykr)localbckp.jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
      break label324;
      return new BitmapShader((Bitmap)localObject1, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
      return new RadialGradient(paramRect.width() / 2 + paramFloat1, paramRect.height() / 2 + paramFloat2, paramRect.width() / 2, localbboy.jdField_a_of_type_ArrayOfInt, localbboy.jdField_a_of_type_ArrayOfFloat, Shader.TileMode.CLAMP);
      ...
      {
        localObject3 = (bckp)paramList.get(paramInt2);
        ...
        for (;;)
        {
          ...
          break;
          int i = 0;
          while (i < ((bckp)localObject3).jdField_a_of_type_JavaLangString.length())
          {
            paramFloat2 = paramPaint.measureText(((bckp)localObject3).jdField_a_of_type_JavaLangString, i, i + 1);
            ((Paint)localObject2).setColor(localbboy.jdField_a_of_type_ArrayOfInt[(paramInt1 % localbboy.jdField_a_of_type_ArrayOfInt.length)]);
          ...
          continue;
          paramFloat1 += ((aykr)((bckp)localObject3).jdField_a_of_type_AndroidTextStyleCharacterStyle).a().getBounds().width();
        }
      }
      return new BitmapShader(paramRect, Shader.TileMode.REPEAT, Shader.TileMode.REPEAT);
      if (localbboy.jdField_a_of_type_AndroidGraphicsBitmap == null) {
        break;
      }
      paramList = Bitmap.createBitmap(paramInt2, paramInt3, Bitmap.Config.ARGB_8888);
      localObject1 = new Canvas(paramList);
      paramInt1 = localbboy.jdField_a_of_type_AndroidGraphicsBitmap.getWidth();
      localObject2 = new Rect();
      localObject3 = new Rect(0, 0, paramInt1, localbboy.jdField_a_of_type_AndroidGraphicsBitmap.getHeight());
      for (paramFloat1 = 0.0F; paramFloat1 < paramRect.width(); paramFloat1 += paramInt1)
      {
        ...
        ((Canvas)localObject1).drawBitmap(localbboy.jdField_a_of_type_AndroidGraphicsBitmap, (Rect)localObject3, (Rect)localObject2, paramPaint);
      }
      return new BitmapShader(paramList, Shader.TileMode.REPEAT, Shader.TileMode.REPEAT);
    }
  }
  
  public bboy a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Integer.valueOf(paramInt))) {
      return (bboy)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
    }
    a(paramInt);
    return null;
  }
