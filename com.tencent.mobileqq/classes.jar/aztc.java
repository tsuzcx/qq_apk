...
public class aztc
  implements View.OnTouchListener, aztl, Manager
{
  public static final float a;
  private static aztc jdField_a_of_type_Aztc;
  private Bitmap jdField_a_of_type_AndroidGraphicsBitmap;
  private FrameLayout jdField_a_of_type_AndroidWidgetFrameLayout;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private aztg jdField_a_of_type_Aztg;
  private azth jdField_a_of_type_Azth = new azth(this, Looper.getMainLooper());
  ...
  private HashMap<String, aqdq> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public static aztc a()
  {
    if (jdField_a_of_type_Aztc == null) {}
    try
    {
      if (jdField_a_of_type_Aztc == null) {
        jdField_a_of_type_Aztc = new aztc();
      }
      return jdField_a_of_type_Aztc;
    }
    finally {}
  }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Azth.hasMessages(paramInt1)) {
      this.jdField_a_of_type_Azth.removeMessages(paramInt1);
    }
    this.jdField_a_of_type_Azth.sendEmptyMessageDelayed(paramInt1, paramInt2);
  }
  
  private void a(aqdp paramaqdp, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      break;
      label65:
      if ((paramaqdp.jdField_a_of_type_Int != 1) || (paramaqdp.jdField_a_of_type_JavaUtilArrayList == null)) {
        break label146;
      }
      paramaqdp = paramaqdp.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (paramaqdp.hasNext())
      {
        localObject = (aqdq)paramaqdp.next();
        if ((localObject != null) && (!TextUtils.isEmpty(paramString1)) && (paramString1.equalsIgnoreCase(((aqdq)localObject).jdField_a_of_type_JavaLangString))) {
    ...
    QLog.i("VipAR", 1, "checkARGift not AR gift switch = " + paramaqdp.jdField_a_of_type_Int + " configlist == null " + paramaqdp.jdField_a_of_type_JavaUtilArrayList);
  }
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      while (i < 9)
      {
        if (this.jdField_a_of_type_Azth.hasMessages(i)) {
          this.jdField_a_of_type_Azth.removeMessages(i);
        }
        i += 1;
      }
    }
  ...
  private void e()
  {
    ...
    String str = QzoneZipCacheHelper.getBasePath("aio_lottie_gift", String.valueOf(this.jdField_a_of_type_Aztg.d.hashCode())) + ".zip";
    if (QLog.isColorLevel()) {
      QLog.i("QzoneGiftManager", 2, " preloadLottieZip local path = " + str + " zipUrl = " + this.jdField_a_of_type_Aztg.d);
    }
    this.jdField_a_of_type_ComTencentComponentNetworkDownloaderDownloader.download(this.jdField_a_of_type_Aztg.d, str, new aztd(this));
  }
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.addAnimatorListener(new azte(this));
  }
  ...
  private void h()
  {
    ...
    g();
    String str = QzoneZipCacheHelper.getBasePath("aio_lottie_gift", String.valueOf(this.jdField_a_of_type_Aztg.d.hashCode())) + ".zip";
    this.jdField_a_of_type_ComTencentMobileqqVipDiyCommonDIYLottieLoader.fromNetworkWithCacheBitmap(this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView, this.jdField_a_of_type_Aztg.d, str, true);
    a(1);
  }
  ...
  private void i()
  {
    ...
    if (a())
    {
      this.jdField_a_of_type_Azth.sendEmptyMessage(7);
      return;
    }
    a(2);
  }
  ...
  private void o()
  {
    ...
    localObjectAnimator.addListener(new aztf(this));
    localObjectAnimator.start();
  }
  ...
  public aqdq a(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          paramString = (aqdq)localEntry.getValue();
          return paramString;
        }
      }
    }
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_Aztg == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Aztg.b)) || (TextUtils.isEmpty(this.jdField_a_of_type_Aztg.c)))
    {
      QLog.e("QzoneGiftManager", 1, "onSuccess show fail : data = null ");
      return;
    }
    this.jdField_a_of_type_CooperationQzoneZipanimateZipAnimationDrawable = a(this.jdField_a_of_type_Aztg.jdField_a_of_type_JavaLangString, 10);
    this.jdField_b_of_type_CooperationQzoneZipanimateZipAnimationDrawable = a(this.jdField_a_of_type_Aztg.b, 10);
    if (this.jdField_b_of_type_CooperationQzoneZipanimateZipAnimationDrawable != null)
    {
    ...
    String str = azti.a(this.jdField_a_of_type_Aztg.c, "qzone_aio_gift");
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Aztg = aztg.a(paramString);
    if (a())
    {
      e();
      return;
    ...
    {
      azti.a(null, this.jdField_a_of_type_Aztg.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Aztg.b, this.jdField_a_of_type_Aztg.c);
      return;
    }
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Aztg != null) && (this.jdField_a_of_type_Aztg.jdField_a_of_type_Int == 1) && (!TextUtils.isEmpty(this.jdField_a_of_type_Aztg.d));
  }
  ...
  public void b()
  {
    ...
    QLog.e("QzoneGiftManager", 1, "onFail show fail mGiftData = " + this.jdField_a_of_type_Aztg.toString());
  }
  ...
  public void b(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Aztg != null)
    {
      azti.a(this, this.jdField_a_of_type_Aztg.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Aztg.b, this.jdField_a_of_type_Aztg.c);
      return;
    }
    QLog.e("QzoneGiftManager", 1, "preloadGiftData error with data = null");
  }
