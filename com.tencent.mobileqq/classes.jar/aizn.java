...
public class aizn
  implements DialogInterface.OnDismissListener, Handler.Callback, AdapterView.OnItemClickListener, begw
{
  ...
  public aizn(Context paramContext, AppInterface paramAppInterface)
  {
    try
    {
  ...
  private int a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.f = (ajjy.a(2131634557) + this.jdField_a_of_type_JavaLangString);
  ...
  private void b()
  {
    ...
    for (localObject = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localObject = null)
    {
      ...
      {
        if ((localObject != null) && (localAppInterface != null) && (bfqn.a(localAppInterface, (Context)localObject, localBundle, null)))
        {
          localObject = a();
          if (localObject != null) {
            break label172;
        ...
        {
          bajr.a(a(), "cmshow", "Apollo", "share_url_succeed", i, 1, new String[] { Integer.toString(this.jdField_a_of_type_Int) });
          return;
        }
      }
    }
  ...
  private void c()
  {
    Object localObject1 = new awui(StructMsgForGeneralShare.class).c(96).a(this.f).e(this.c).a(ajjy.a(2131634585), null).b("web", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326").a();
    Object localObject2 = awuv.a(2);
    ((awum)localObject2).a(this.d, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString);
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      ...
      if (localObject1 != null) {
        aphp.a((Activity)localObject1, (Intent)localObject2, 14002);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    for (paramString = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; paramString = null)
    {
      ...
      {
        bajr.a(a(), "cmshow", "Apollo", "share_panel_open", i, 0, new String[] { Integer.toString(this.jdField_a_of_type_Int) });
        return;
      }
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (Activity localActivity = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localActivity = null)
    {
      ...
      {
        localbehb = new behb(localActivity);
        localbehb.a(localArrayList);
      }
      if ((this.jdField_a_of_type_Begr == null) && (localActivity != null))
      {
        ...
        this.jdField_a_of_type_Begr = behb.a(localActivity, localbehb, new aizo(this, paramString), this, this, false);
      }
      if ((this.jdField_a_of_type_Begr == null) || (this.jdField_a_of_type_Begr.isShowing())) {
        break;
      }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localBundle.putString("summary", ajjy.a(2131634542));
        ...
        bfqn.a((AppInterface)localObject, paramMessage, localBundle, this, 15);
        return false;
      }
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      {
        bajr.a(a(), "cmshow", "Apollo", "send_game_share", i, paramInt, new String[] { Integer.toString(this.jdField_a_of_type_Int) });
        return;
        if (paramLong == 0L)
        {
          c();
