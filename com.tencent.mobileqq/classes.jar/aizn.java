  ...
  extends BaseAdapter
{
  ...
  public aizn(aizm paramaizm, Context paramContext)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    if (paramaizm != null)
    {
      this.jdField_a_of_type_JavaUtilList = paramaizm.b;
      this.b = paramaizm.c;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramViewGroup = new aizo(this);
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558788, null);
      paramView.setPadding(0, 0, 0, 0);
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView = ((CornerImageView)paramView.findViewById(2131368572));
      paramViewGroup.b = ((CornerImageView)paramView.findViewById(2131368573));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378179));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368574));
      float f = muc.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
      ...
      ((URLDrawable.URLDrawableOptions)localObject2).mRequestWidth = ((int)muc.a(this.jdField_a_of_type_AndroidContentContext, 103.0F));
      ((URLDrawable.URLDrawableOptions)localObject2).mRequestHeight = ((int)muc.a(this.jdField_a_of_type_AndroidContentContext, 58.0F));
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (aizo)paramView.getTag();
      break;
      label333:
