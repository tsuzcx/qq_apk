...
{
  public static final String a = bduw.a(aljq.aX + "hotpic/");
  ...
  {
    paramString = new bdvv(paramString.replaceFirst("https", "http"), paramFile);
    paramString.e = 20000;
    paramString.n = true;
    paramString.b = 2;
    return bdvx.a(paramString, null, null);
  }
  ...
  public File loadImageFile(DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    if (j == 0)
    {
      str = awiz.a(localFile1.getAbsolutePath());
