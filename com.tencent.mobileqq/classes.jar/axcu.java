  ...
  extends MSFServlet
{
  ...
  private void a(VideoCallMsg paramVideoCallMsg)
  {
    ...
    {
      lcl.d("VideoConfigServlet", "handleVideoConfigMessage error videoMsg = null");
      return;
    }
    int[] arrayOfInt;
    int i;
    ...
    {
      arrayOfInt = llq.a(paramVideoCallMsg.vMsg);
      if (arrayOfInt != null)
      {
        i = arrayOfInt[0];
        j = arrayOfInt[1];
        ...
        bool1 = true;
        label61:
        AudioHelper.a(0, new bbbq(i, j, bool1));
        i = arrayOfInt[3];
        j = arrayOfInt[4];
        if (arrayOfInt[5] != 1) {
          break label289;
        ...
        bool1 = true;
        label97:
        AudioHelper.a(1, new bbbq(i, j, bool1));
        i = arrayOfInt[6];
        j = arrayOfInt[7];
        if (arrayOfInt[8] != 1) {
          break label295;
    ...
    {
      AudioHelper.a(2, new bbbq(i, j, bool1));
      i = arrayOfInt[9];
      j = arrayOfInt[10];
      bool1 = bool2;
      if (arrayOfInt[11] == 1) {
      ...
      AudioHelper.a(3, new bbbq(i, j, bool1));
      bool1 = llq.a(String.valueOf(AppSetting.a()), getAppRuntime().getApplication(), paramVideoCallMsg.vMsg);
    ...
    do
    {
      do
      {
        ...
        try
        {
          ...
          {
            lcl.c("VideoConfigServlet", "cmd0xa02 onReceive uint32_result = " + paramFromServiceMsg.uint32_result.get());
            return;
          }
        }
      ...
      lcl.c("VideoConfigServlet", "cmd0xa02 onReceive list = " + paramIntent.toString());
      new ArrayList();
      paramIntent = msp.a(paramIntent);
      paramFromServiceMsg = (QQAppInterface)getAppRuntime();
    } while (paramFromServiceMsg == null);
    paramFromServiceMsg.a().b(paramIntent);
    return;
    lcl.c("VideoConfigServlet", "cmd0xa02 onReceive not success!");
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    bbmj.a((byte[])localObject1, 0, paramIntent.length + 4);
    bbmj.a((byte[])localObject1, 4, paramIntent, paramIntent.length);
    paramPacket.setSSOCommand("OidbSvc.0xa02");
    paramPacket.putSendData((byte[])localObject1);
    lcl.c("VideoConfigServlet", "cmd0xa02 onSend");
    return;
    ...
    paramIntent.vMsg = llq.a(paramIntent.lUin, String.valueOf(AppSetting.a()), getAppRuntime().getApplication());
