...
public class avqj
{
  ...
  avql jdField_a_of_type_Avql = avql.jdField_a_of_type_Avql;
  String jdField_a_of_type_JavaLangString = "";
  boolean jdField_a_of_type_Boolean = false;
  avql jdField_b_of_type_Avql = avql.jdField_a_of_type_Avql;
  String jdField_b_of_type_JavaLangString = "";
  boolean jdField_b_of_type_Boolean = false;
  avql jdField_c_of_type_Avql = avql.jdField_a_of_type_Avql;
  boolean jdField_c_of_type_Boolean = false;
  avql d = avql.jdField_a_of_type_Avql;
  avql e = avql.jdField_a_of_type_Avql;
  avql f = avql.jdField_a_of_type_Avql;
  avql g = avql.jdField_a_of_type_Avql;
  avql h = avql.jdField_a_of_type_Avql;
  avql i = avql.jdField_a_of_type_Avql;
  avql j = avql.jdField_a_of_type_Avql;
  ...
  private avql a(JSONObject paramJSONObject)
  {
    boolean bool = true;
    if (paramJSONObject == null) {
      return avql.jdField_a_of_type_Avql;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        paramJSONObject = new avql(bool, localSimpleDateFormat.parse(str), localSimpleDateFormat.parse(paramJSONObject));
  ...
  private void b()
  {
    this.jdField_a_of_type_Avql = avql.jdField_a_of_type_Avql;
    this.jdField_b_of_type_Avql = avql.jdField_a_of_type_Avql;
    this.jdField_c_of_type_Avql = avql.jdField_a_of_type_Avql;
    this.d = avql.jdField_a_of_type_Avql;
    this.e = avql.jdField_a_of_type_Avql;
    this.f = avql.jdField_a_of_type_Avql;
    this.g = avql.jdField_a_of_type_Avql;
    this.h = avql.jdField_a_of_type_Avql;
    this.i = avql.jdField_a_of_type_Avql;
    this.j = avql.jdField_a_of_type_Avql;
  ...
  public void a(ConfigurationService.Config paramConfig)
  {
    ...
    if (m != k)
    {
      paramConfig = arry.b(paramConfig, m, paramConfig.type.get());
      a(paramConfig);
      b(paramConfig);
    }
  ...
  void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Avql = a(paramString.optJSONObject("webview_menu"));
        this.jdField_b_of_type_Avql = a(paramString.optJSONObject("webview_launch_app"));
        this.jdField_c_of_type_Avql = a(paramString.optJSONObject("scan_qrcode"));
        ...
        if (paramString.optInt("need_report_system_share_info_new") == 1)
        {
          ...
          JefsClass.getInstance().a(this.jdField_b_of_type_Avql.a(), paramString);
        }
      }
