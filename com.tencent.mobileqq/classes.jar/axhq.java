...
public class axhq
{
  ...
  public static String a(String paramString)
  {
    ...
    //   19	211	1	l	long
    //   15	345	3	localObject1	Object
    //   368	1	3	localException	Exception
    //   11	320	4	localObject2	Object
    //   4	272	5	localFileInputStream	java.io.FileInputStream
    //   7	281	6	str1	String
  ...
  public static ArrayList<axho> a()
  {
    int i = 0;
    ArrayList localArrayList = new ArrayList();
    Object localObject1 = BaseApplicationImpl.getApplication().getRuntime();
    Object localObject2 = (String)awka.a(((AppRuntime)localObject1).getAccount(), "key_nearby_publish_menu", "");
    if (!TextUtils.isEmpty((String)awka.a(((AppRuntime)localObject1).getAccount(), "cike_guide_content", ""))) {}
      ...
      for (;;)
      {
        try
        {
          ...
          if (i < ((JSONArray)localObject1).length())
          {
            ...
            axho localaxho2 = new axho();
            localaxho2.jdField_a_of_type_Int = ((JSONObject)localObject2).optInt("id");
            if ((!bool) && (localaxho2.jdField_a_of_type_Int != 1) && (localaxho2.jdField_a_of_type_Int != 2)) {
              break label337;
            }
            localaxho2.jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("icon");
            localaxho2.jdField_b_of_type_JavaLangString = ((JSONObject)localObject2).optString("title");
            localaxho2.c = ((JSONObject)localObject2).optString("subTitle");
            localaxho2.d = ((JSONObject)localObject2).optString("jumpUrl");
            localArrayList.add(localaxho2);
          }
        }
        catch (Exception localException)
        {
          ...
          {
            axho localaxho1 = new axho();
            localaxho1.jdField_a_of_type_Int = 1;
            localaxho1.jdField_b_of_type_Int = 2130841374;
            localaxho1.jdField_b_of_type_JavaLangString = amtj.a(2131706496);
            localArrayList.add(localaxho1);
            localaxho1 = new axho();
            localaxho1.jdField_a_of_type_Int = 2;
            localaxho1.jdField_b_of_type_Int = 2130841373;
            localaxho1.jdField_b_of_type_JavaLangString = amtj.a(2131706497);
            localArrayList.add(localaxho1);
          }
  ...
  public static void a(Context paramContext, axho paramaxho, String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyPublishMenuHelper", 2, "handleMenuItemClick：id=" + paramaxho.jdField_a_of_type_Int);
    }
    switch (paramaxho.jdField_a_of_type_Int)
    {
    default: 
      a(paramContext, paramaxho.d);
      return;
    case 1: 
      a(paramContext);
      return;
  ...
  {
    awhj localawhj = awhj.a(paramContext, BaseApplicationImpl.getApplication().getRuntime().getAccount(), 0);
    if (localawhj != null)
    {
      if (awhj.a(paramContext))
      {
        a(paramContext, localawhj.d);
        return;
      }
      localawhj.f = a(paramString1, paramString2);
      paramContext = new axhh(paramContext);
      paramContext.a(localawhj);
      paramContext.show();
      return;
    }
  ...
  {
    new bcek(null).a("dc00899").b("grp_lbs").c(paramString1).d(paramString2).a();
  }
  ...
  protected static void b(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      {
        QQToast.a(paramContext, 2131717955, 0).a();
        if (QLog.isColorLevel()) {
      ...
      else
      {
        ...
        for (localObject1 = (AppActivity)paramContext;; localObject2 = null)
        {
          ...
          if ((Build.VERSION.SDK_INT >= 23) && (((AppActivity)localObject1).checkSelfPermission("android.permission.CAMERA") != 0))
          {
            ...
            ((AppActivity)localObject1).requestPermissions(new axhr(paramContext, str, (AppActivity)localObject1, localIntent), 1, new String[] { "android.permission.CAMERA" });
          }
          for (int i = 1;; i = 0) {
            for (;;)
            {
              ...
              catch (Exception localException)
              {
                ...
                QQToast.a(paramContext, 2131690618, 0).a();
                return;
              }
            }
          }
  ...
  {
    bhht localbhht = new bhht(paramContext, paramContext.getResources().getDimensionPixelSize(2131299076));
    localbhht.c(2131693585);
    ThreadManager.post(new NearbyPublishMenuHelper.2(localbhht, paramString2, paramContext, paramString1), 5, null, true);
  }
  ...
  public static void b(String paramString1, String paramString2)
  {
    ...
    //   63: aload_0
    //   64: invokevirtual 563	com/tencent/common/app/BaseApplicationImpl:deleteFile	(Ljava/lang/String;)Z
    //   67: pop
    //   68: iconst_0
    //   69: ifeq +11 -> 80
    ...
    //   107: aload_0
    //   108: iconst_0
    //   109: invokevirtual 567	com/tencent/common/app/BaseApplicationImpl:openFileOutput	(Ljava/lang/String;I)Ljava/io/FileOutputStream;
    //   112: astore_0
    //   113: aload_0
    //   114: astore 5
    //   116: aload_0
    ...
    //   119: aload_0
    //   120: aload_1
    //   121: invokevirtual 571	java/lang/String:getBytes	()[B
    //   124: invokevirtual 576	java/io/FileOutputStream:write	([B)V
    //   127: aload_0
    //   128: astore 5
    //   130: aload_0
    //   131: astore 4
    //   133: aload_0
    //   134: invokevirtual 579	java/io/FileOutputStream:flush	()V
    //   137: aload_0
    //   138: astore 5
    //   140: aload_0
    //   141: astore 4
    ...
    //   172: aload_1
    //   173: invokevirtual 582	java/lang/String:length	()I
    ...
    //   186: ifnull -106 -> 80
    //   189: aload_0
    //   190: invokevirtual 583	java/io/FileOutputStream:close	()V
    //   193: goto -113 -> 80
    //   196: astore_0
    //   197: goto -117 -> 80
    //   200: astore_0
    ...
    //   236: ifnull -156 -> 80
    //   239: aload 5
    //   241: invokevirtual 583	java/io/FileOutputStream:close	()V
    //   244: goto -164 -> 80
    //   247: astore_0
    //   248: goto -168 -> 80
    //   251: astore_0
    ...
    //   254: ifnull +8 -> 262
    //   257: aload 4
    //   259: invokevirtual 583	java/io/FileOutputStream:close	()V
    //   262: aload_0
    //   263: athrow
    //   264: astore_0
    //   265: ldc 2
    ...
    //   7	90	6	localObject3	Object
    //   4	97	7	localObject4	Object
    // Exception table:
    //   from	to	target	type
