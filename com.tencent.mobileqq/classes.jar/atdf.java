  ...
  extends WebViewPlugin
{
  ...
  private static final String e = alpo.a(2131706084);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alpo.a(2131706080);
    jdField_b_of_type_JavaLangString = alpo.a(2131706079);
    d = alpo.a(2131706085);
    jdField_c_of_type_JavaLangString = alpo.a(2131706088);
  }
  ...
  private void a()
  {
    ...
    {
      b();
      assx.a(this.jdField_a_of_type_AndroidAppActivity, this.g, this.k, this.m, this.jdField_a_of_type_Long, new atdg(this));
      return;
    }
      ...
      for (;;)
      {
        ...
        try
        {
          if (paramIntent.hasExtra("data"))
          {
            ...
            localJSONObject.put("errMsg", paramIntent.getString("errMsg", alpo.a(2131706087)));
            localJSONObject.put("idKey", paramIntent.getString("idKey"));
            localJSONObject.put("allResults", localObject1);
          }
          for (;;)
          {
            azmj.b(null, "dc00898", "", "", "0X8009862", "0X8009862", 0, 0, this.jdField_c_of_type_Int + "", "", this.jdField_b_of_type_Int + "", paramInt + "");
            if (QLog.isColorLevel()) {
            ...
            else
            {
              ...
              localJSONObject.put("errMsg", alpo.a(2131706086));
              localJSONObject.put("allResults", localObject1);
              paramInt = 299;
            }
          }
