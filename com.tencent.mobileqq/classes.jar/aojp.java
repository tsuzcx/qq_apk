  ...
  implements aojv, baky
{
  ...
  private aojp(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, String paramString3)
  {
  ...
  public static aojp a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, String paramString3)
  {
    ...
    return new aojp(paramQQAppInterface, paramLong1, paramInt1, paramInt2, paramString1, paramString2, paramLong2, paramBoolean, paramString3);
  }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      if (localDataInputStream.readInt() != 0) {
        this.jdField_a_of_type_Aoju.a(9001, "httpServer retCode!=0");
      }
    }
    catch (IOException localIOException)
    {
      for (;;)
      {
        ...
        this.jdField_a_of_type_Aoju.a(9001, "httpServer flag!=0 flag!=1");
        try
        {
    ...
    if (i == 0)
    {
      ...
      l2 = i;
      this.jdField_a_of_type_Aoju.a(l1 << 32 | l2, null);
    }
    for (;;)
    {
      try
  ...
  public void a()
  {
    ...
    {
      a().a(this.jdField_a_of_type_Bakw);
  ...
  public boolean a(String paramString, long paramLong, byte[] paramArrayOfByte)
  {
    ...
    this.jdField_a_of_type_Bakw = new bakw(paramString, paramArrayOfByte, this);
    ...
    this.jdField_a_of_type_Bakw.a("Net-type", paramArrayOfByte);
    this.jdField_a_of_type_Bakw.b("POST");
    this.jdField_a_of_type_Bakw.b(1);
    if (this.jdField_a_of_type_Aoju != null) {
      this.jdField_a_of_type_Aoju.a(this.jdField_a_of_type_Bakw);
    }
    this.jdField_a_of_type_Bakw.jdField_b_of_type_Int = this.jdField_b_of_type_Int;
    this.jdField_a_of_type_Bakw.c = this.jdField_a_of_type_Int;
    this.jdField_a_of_type_Bakw.jdField_a_of_type_JavaLangString = String.valueOf(this.jdField_a_of_type_Long);
    paramArrayOfByte = "";
    if (paramString != null) {
    ...
    {
      this.jdField_a_of_type_Bakw.j = true;
      this.jdField_a_of_type_Bakw.k = aojs.a(paramString);
      this.jdField_a_of_type_Bakw.e = this.jdField_a_of_type_JavaLangString;
    }
    this.jdField_a_of_type_Bakw.jdField_a_of_type_Axtz = apck.a();
    a().a(this.jdField_a_of_type_Bakw);
    return true;
  }
  ...
  public void b(bakw parambakw1, bakw parambakw2)
  {
    ...
    this.jdField_a_of_type_Aoju.a(0, "null", "null");
  }
}
