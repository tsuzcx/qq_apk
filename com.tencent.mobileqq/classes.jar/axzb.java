  ...
  extends axun
{
  ...
  public axzb()
  {
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new axzc(this);
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new axzd(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramBundle = paramBundle.getDrawable(2130841296);
        if (TextUtils.isEmpty(this.S))
        {
          ...
          paramView.setContentDescription(paramBundle.getString(2131694746));
          paramView.setDisplayRuleDef(bckq.a);
          paramView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
          paramView.setContentDescription(paramBundle.getText(2131719801));
        }
      }
  ...
  public boolean a(axwe paramaxwe)
  {
    ...
    this.U = paramaxwe.a("video_info");
    this.j = paramaxwe.a("index");
    this.k = paramaxwe.a("index_name");
    this.l = paramaxwe.a("index_type");
    return true;
  }
}
