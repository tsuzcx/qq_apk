...
public class azml
{
  ...
  {
    return a(paramContext, paramViewGroup, paramInt, 2131562449);
  }
  ...
  public static View a(Context paramContext, ViewGroup paramViewGroup, int paramInt1, int paramInt2)
  {
    ...
    paramViewGroup = new azmn();
    paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramContext.findViewById(2131377799));
    paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131377864));
    paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131377755));
    paramViewGroup.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopLabelLayout = ((TroopLabelLayout)paramContext.findViewById(2131377827));
    paramViewGroup.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopLabelLayout.setLabelType(paramInt1);
    paramViewGroup.jdField_b_of_type_ComTencentMobileqqTroopWidgetTroopLabelLayout = ((TroopLabelLayout)paramContext.findViewById(2131377828));
    paramViewGroup.jdField_b_of_type_ComTencentMobileqqTroopWidgetTroopLabelLayout.setLabelType(2);
    paramViewGroup.e = ((TextView)paramContext.findViewById(2131365259));
    ...
    paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramContext.findViewById(2131375418));
    ...
    paramViewGroup.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramContext.findViewById(2131376737));
  ...
  {
    azmn localazmn = (azmn)paramView.getTag();
    localazmn.jdField_a_of_type_JavaLangString = String.valueOf(paramGroupInfo.lCode);
    localazmn.jdField_a_of_type_AndroidWidgetTextView.setText(paramGroupInfo.strName);
    localazmn.jdField_a_of_type_AndroidWidgetTextView.setTextColor(paramContext.getResources().getColor(2131166861));
    Object localObject1;
    Object localObject2;
    int i;
    if ((paramBoolean2) && (paramGroupInfo.labels != null))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (((GroupLabel)localObject2).type == 2001L)
        {
          ...
          localazmn.jdField_a_of_type_AndroidWidgetTextView.setTextColor(i);
        }
      }
    }
    if ((paramBoolean1) || (paramBoolean3)) {
      localazmn.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
    }
    if (paramBoolean3) {
      localazmn.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
    }
    localazmn.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
    if (TextUtils.isEmpty(paramGroupInfo.strIntro))
    {
      localazmn.jdField_c_of_type_AndroidWidgetTextView.setText(2131696445);
      localazmn.jdField_a_of_type_NearbyGroupGroupInfo = paramGroupInfo;
      if ((paramGroupInfo.labels != null) && (paramGroupInfo.labels.size() != 0)) {
        break label718;
      }
      if ((localazmn.jdField_a_of_type_JavaUtilArrayList == null) || (localazmn.jdField_a_of_type_JavaUtilArrayList.size() == 0))
      {
        ...
        localazmn.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)localObject1);
      }
      ((GroupLabel)localazmn.jdField_a_of_type_JavaUtilArrayList.get(0)).strWording = (paramGroupInfo.iMemberCnt + "");
      paramGroupInfo.labels = localazmn.jdField_a_of_type_JavaUtilArrayList;
      a(paramContext, localazmn, paramGroupInfo);
      ...
      localazmn.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      localazmn.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130843232);
      label435:
      if ((paramGroupInfo.dwExtFlag & 1L) == 0L) {
        break label825;
      }
      localazmn.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130841987);
      localazmn.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
    }
    label718:
    for (;;)
    {
      ...
      if (a)
      {
        ...
        paramContext = paramGroupInfo.iMemberCnt + ajyc.a(2131707379);
        ...
        for (;;)
        {
          if (i < j)
          {
            ...
            if (localazmn.jdField_b_of_type_Int == 1) {
              i -= actn.a(110.0F, paramContext.getResources());
            }
            for (;;)
            {
              localObject1 = nam.b(nam.c(paramGroupInfo.strIntro));
              TextUtils.ellipsize((CharSequence)localObject1, localazmn.jdField_c_of_type_AndroidWidgetTextView.getPaint(), i, TextUtils.TruncateAt.END, false, new azmm(localazmn, (String)localObject1));
              break;
              i = (i - actn.a(137.0F, paramContext.getResources())) * 2;
            }
            if ((a(paramContext, localazmn, paramGroupInfo)) || (!QLog.isColorLevel())) {
              break;
            }
            ...
            localazmn.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
            break label435;
            localazmn.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
            break label435;
            localazmn.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
            break label466;
          }
        }
    ...
    for (;;)
    {
      label812:
      label825:
      localazmn.jdField_b_of_type_AndroidWidgetTextView.setContentDescription(paramContext);
  ...
  protected static boolean a(Context paramContext, azmn paramazmn, GroupInfo paramGroupInfo)
  {
    if ((paramContext == null) || (paramazmn == null) || (paramGroupInfo == null) || (paramGroupInfo.labels == null) || (paramGroupInfo.labels.size() == 0)) {
      return false;
    }
    paramazmn.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
    paramazmn.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopLabelLayout.setVisibility(0);
    paramContext = paramGroupInfo.labels;
    paramazmn.jdField_b_of_type_ComTencentMobileqqTroopWidgetTroopLabelLayout.a(paramContext);
    return paramazmn.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopLabelLayout.a(paramContext);
  }
}
