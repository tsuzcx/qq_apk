...
public class oag
{
  ...
  private static final Map<Integer, owa> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  {
    beoj.a("getProteusSeparatorMarginLeftPx");
    if ((jdField_a_of_type_Double > 0.0D) && (paramTemplateBean != null))
    {
      rdg localrdg = rdg.a("default_feeds", false);
      if ((localrdg != null) && (!localrdg.a(paramTemplateBean)))
      {
        beoj.a();
  ...
  {
    beoj.a("getProteusSeparatorHeightPx");
    if ((jdField_a_of_type_Int > 0) && (paramTemplateBean != null))
    {
      localrdg = rdg.a("default_feeds", false);
      if ((localrdg != null) && (!localrdg.a(paramTemplateBean)))
      {
        beoj.a();
        oxz.a("ProteusSupportUtil", "[getProteusSeparatorHeightPx] SeparatorHeight : " + jdField_a_of_type_Int);
    ...
    if (localrdg != null) {
      paramTemplateBean = localrdg.getTemplate("ReadInjoy_triple_img_cell");
    }
    if ((paramTemplateBean != null) && (paramTemplateBean.getViewBean() != null)) {}
    for (;;)
    {
      try
      {
        ...
        oxz.a("ProteusSupportUtil", "[getProteusSeparatorHeightPx] getSeparatorHeightPx");
      }
      catch (Exception paramTemplateBean)
      {
        paramTemplateBean.printStackTrace();
  ...
  {
    if (oya.a()) {
      oya.a("ProteusSupportUtil", "[getView] " + paramBaseArticleInfo + " adapterViewType: " + paramInt);
    }
    long l1 = System.currentTimeMillis();
    beoj.a("ProteusSupportUtil.getView");
    Object localObject1 = null;
    beoj.a("ProteusSupportUtil#getView#getTemplateBean");
    ...
    if (localTemplateBean != null)
    {
      ...
      beoj.a(localObject1 + "#inflate");
      localObject2 = paramVafContext.getViewFactory().inflate(paramVafContext, localTemplateBean);
      oxz.a("ProteusSupportUtil", "[getView] inflate");
      beoj.a();
      if (localObject2 != null)
      {
        beoj.a(localObject1 + "#setBackgroundDrawable");
        if ((!obz.q()) || (!bgmq.k())) {
          break label400;
        }
        paramInt = 1;
        ...
        beoj.a();
        oxz.a("ProteusSupportUtil", "[getView]  add Container ");
      }
      if (QLog.isColorLevel()) {
        oya.a((View)localObject2, "ProteusSupportUtil");
      }
    ...
    {
      rnr.a("ProteusSupportUtil", paramVafContext, "ProteusSupportUtil.getView", l2 - l1);
      beoj.a();
      return paramBaseArticleInfo;
      oxz.a("ProteusSupportUtil", "[getView]  new proteusItemView ");
  ...
  public static TemplateBean a(VafContext paramVafContext, int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    //   4: ldc 132
    //   6: iconst_0
    //   7: invokestatic 137	rdg:a	(Ljava/lang/String;Z)Lrdg;
    //   10: astore 4
    //   12: aload 4
    ...
    //   83: invokevirtual 140	rdg:a	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)Z
    //   86: ifne +8 -> 94
    //   89: aload_2
    ...
    //   145: aload 4
    //   147: aload_0
    //   148: invokevirtual 418	rdg:getTemplateBean	(Lorg/json/JSONObject;)Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;
    //   151: astore 4
    //   153: aload 4
    //   155: astore_3
    //   156: aload_2
    ...
    //   369: invokestatic 446	otc:a	(Lcom/tencent/biz/pubaccount/readinjoy/struct/BaseArticleInfo;)Lorg/json/JSONObject;
    //   372: astore_0
    //   373: goto -250 -> 123
    //   376: aload_2
    //   377: invokestatic 449	otg:a	(Lcom/tencent/biz/pubaccount/readinjoy/struct/BaseArticleInfo;)Lorg/json/JSONObject;
    //   380: astore_0
    //   381: goto -258 -> 123
    //   384: aload_2
    //   385: invokestatic 452	otf:a	(Lcom/tencent/biz/pubaccount/readinjoy/struct/BaseArticleInfo;)Lorg/json/JSONObject;
    //   388: astore_0
    //   389: goto -266 -> 123
    //   392: aload_2
    //   393: invokestatic 455	ost:a	(Lcom/tencent/biz/pubaccount/readinjoy/struct/BaseArticleInfo;)Lorg/json/JSONObject;
    //   396: astore_0
    //   397: goto -274 -> 123
    //   400: aload_2
    //   401: invokestatic 458	ote:a	(Lcom/tencent/biz/pubaccount/readinjoy/struct/BaseArticleInfo;)Lorg/json/JSONObject;
    //   404: astore_0
    //   405: goto -282 -> 123
    //   408: aload_2
    //   409: invokestatic 461	oso:a	(Lcom/tencent/biz/pubaccount/readinjoy/struct/BaseArticleInfo;)Lorg/json/JSONObject;
    //   412: astore_0
    //   413: goto -290 -> 123
    //   416: aload_2
    //   417: invokestatic 464	osz:a	(Lcom/tencent/biz/pubaccount/readinjoy/struct/BaseArticleInfo;)Lorg/json/JSONObject;
    //   420: astore_0
    //   421: goto -298 -> 123
    //   424: aload_2
    //   425: invokestatic 467	otd:a	(Lcom/tencent/biz/pubaccount/readinjoy/struct/BaseArticleInfo;)Lorg/json/JSONObject;
    //   428: astore_0
    //   429: goto -306 -> 123
    //   432: aload_2
    //   433: invokestatic 470	oti:a	(Lcom/tencent/biz/pubaccount/readinjoy/struct/BaseArticleInfo;)Lorg/json/JSONObject;
    //   436: astore_0
    //   437: goto -314 -> 123
    //   440: aload_2
    //   441: invokestatic 473	oth:a	(Lcom/tencent/biz/pubaccount/readinjoy/struct/BaseArticleInfo;)Lorg/json/JSONObject;
    //   444: astore_0
    //   445: goto -322 -> 123
    //   448: aload_2
    //   449: invokestatic 476	otj:a	(Lcom/tencent/biz/pubaccount/readinjoy/struct/BaseArticleInfo;)Lorg/json/JSONObject;
    //   452: astore_0
    //   453: goto -330 -> 123
    //   456: aconst_null
    //   457: astore_3
  ...
  {
    String str = null;
    if (!pol.a(paramBaseArticleInfo))
    {
      QLog.d("ProteusSupportUtil", 1, "UGRuleManager getUGSchema is not ugCard");
      return null;
    }
    int i = poi.jdField_a_of_type_Int;
    poi localpoi = poi.a();
    boolean bool = localpoi.a(paramBaseArticleInfo, true, i);
    if (bool)
    {
      str = localpoi.a(paramBaseArticleInfo, i, null, null);
      QLog.d("ProteusSupportUtil", 1, "UGRuleManager getUGSchema ugUrl is " + str);
    }
    localpoi.a(paramBaseArticleInfo, bool, true, i);
    return str;
  }
  
  private static void a()
  {
    oxz.a("ProteusSupportUtil", "resetProteusSeparatorHeightPx ");
    QLog.d("TemplateFactory", 4, "resetProteusSeparatorHeightPx");
    jdField_a_of_type_Int = 0;
  }
  
  public static void a(int paramInt, Container paramContainer, VafContext paramVafContext, azwg paramazwg, qoe paramqoe, opw paramopw, BaseArticleInfo paramBaseArticleInfo)
  {
    ViewFactory.findClickableViewListener(paramContainer.getVirtualView(), new oal(paramInt, paramContainer, paramopw, paramVafContext, paramazwg, paramqoe, paramBaseArticleInfo));
  }
  
  private static void a(int paramInt1, Container paramContainer, opw paramopw, int paramInt2)
  {
    beoj.a("ProteusSupportUtil.bindView");
    if (paramContainer == null)
    {
      beoj.a();
      return;
    }
    oxz.a("ProteusSupportUtil", "[bindView]");
    Object localObject = (owa)jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt1));
    if (localObject != null)
    {
      ((owa)localObject).a(paramInt1, paramContainer, paramopw, paramInt2);
      beoj.a();
    }
    for (;;)
    {
      ...
      default: 
        break;
      case 10: 
        localObject = (oyf)paramContainer.findViewBaseByName("id_info_avator");
        if (localObject != null) {
          ((oyf)localObject).a(paramopw);
        }
        localObject = (pav)paramContainer.findViewBaseByName("id_summary");
        if (localObject != null) {
          ((pav)localObject).a(paramopw);
        }
        localObject = (oyh)paramContainer.findViewBaseByName("id_biu_comment");
        if (localObject != null) {
          ((oyh)localObject).a(paramopw);
        }
        paramContainer = (oyj)paramContainer.findViewBaseByName("id_corner_text_image");
        if (paramContainer != null) {
      ...
      case 42: 
        ...
        paramContainer = (oyp)paramContainer.findViewBaseByName("id_multi_image");
        if (paramContainer != null) {
          paramContainer.a(paramopw.a());
        }
        break;
      }
    }
  ...
  private static void a(int paramInt, owa paramowa)
  {
    if (paramowa == null) {
      throw new NullPointerException();
    }
    jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), paramowa);
  }
  
  public static void a(ProteusItemView paramProteusItemView, int paramInt1, BaseArticleInfo paramBaseArticleInfo, VafContext paramVafContext, azwg paramazwg, qoe paramqoe, opw paramopw, int paramInt2, String paramString)
  {
    if (oya.a())
    {
      oya.a("ProteusSupportUtil", "[bindData]  adapterViewType: " + paramInt1 + "  reportViewType: " + obz.a(paramBaseArticleInfo));
      oya.a("ProteusSupportUtil", "[bindData] " + paramBaseArticleInfo);
    }
    oxz.a("ProteusSupportUtil", "[bindData] adapterViewType: " + paramInt1);
    beoj.a("ProteusSupportUtil.bindData");
    long l1 = System.currentTimeMillis();
    ...
    else
    {
      ...
      oxz.a("ProteusSupportUtil", "[bindData] trigger re-inflation, adapterViewType: " + paramInt1 + " new id: " + i + " old id: " + j);
      paramString = paramVafContext.getViewFactory().inflate(paramVafContext, localTemplateBean);
      if (paramString != null)
      {
        paramString.setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841186));
        paramProteusItemView.d();
        paramProteusItemView.a(paramString);
        oya.a(paramString.getVirtualView(), "ProteusSupportUtil");
        oya.a(paramString, "ProteusSupportUtil");
      }
    ...
    paramProteusItemView.setModel(paramopw, paramqoe.a());
    beoj.a("ProteusSupportUtil.bindDataImpl");
    label452:
    long l2;
    if (localTemplateBean != null)
    {
      ...
      beoj.a();
      a(paramInt1, (Container)localObject, paramopw, paramInt2);
      a(paramInt1, (Container)localObject, paramVafContext, paramazwg, paramqoe, paramopw, paramBaseArticleInfo);
      beoj.a("ProteusSupportUtil.configDivider");
      a(paramopw, paramVafContext);
      a((Container)localObject, paramopw, localTemplateBean);
      beoj.a();
      l2 = System.currentTimeMillis();
      if (localTemplateBean == null) {
        break label562;
    ...
    {
      rnr.a("ProteusSupportUtil", paramProteusItemView, " ProteusSupportUtil.bindData", l2 - l1);
      beoj.a();
      return;
      i = -1;
      break;
  ...
  {
    a(null, qoe.c(paramArticleInfo), paramArticleInfo);
  }
  ...
  public static void a(BaseArticleInfo paramBaseArticleInfo, TemplateBean paramTemplateBean, ViewBase paramViewBase)
  {
    ...
    String str = rvf.b(paramBaseArticleInfo.mChannelID);
    ...
    rsk.a((ArticleInfo)paramBaseArticleInfo, str, str, (int)paramBaseArticleInfo.mChannelID, localHashMap);
    rsk.a(paramTemplateBean);
    ...
    if (paramTemplateBean != null)
    {
      ...
      while (paramTemplateBean.hasNext())
      {
        ...
        if (!TextUtils.equals(paramViewBase, paramString)) {
          localocg.b(paramViewBase, localObject.toString());
        }
      }
    }
    ndn.a(null, "CliOper", "", "", str, str, 0, 0, "", "", "", localocg.a(), false);
  }
  
  public static void a(Container paramContainer, TemplateBean paramTemplateBean1, TemplateBean paramTemplateBean2)
  {
    beoj.a("ProteusSupportUtil.bindDynamicValueWithoutRecursion");
    long l1 = System.currentTimeMillis();
    ...
    {
      oxz.a("ProteusSupportUtil", "[bindDynamicValueWithoutRecursion] map");
      ...
      if (localIterator.hasNext())
      {
        ...
        if ("[ " + paramTemplateBean2 != null)
        {
          ...
          beoj.a("bindDynamicValueWithoutRecursion.bindDynamicVal.check");
      ...
      oxz.a("ProteusSupportUtil", "[bindDynamicValueWithoutRecursion] recur");
      if (localHashSet != null)
      {
      ...
      if (paramTemplateBean2 != null)
      {
        ...
        rnr.a("ProteusSupportUtil", paramContainer, "bindDynamicValueWithoutRecursion", System.currentTimeMillis() - l1);
  ...
  {
    ViewFactory.findClickableViewListener(paramContainer.getVirtualView(), new oah(paramVafContext, paramTemplateBean));
  }
  
  public static void a(Container paramContainer, opw paramopw, TemplateBean paramTemplateBean)
  {
    if (nzu.a(paramContainer, paramopw)) {
      return;
    }
    ...
    {
      beoj.a("configDivider.FollowFeeds");
    ...
    for (;;)
    {
      ...
      paramopw = localViewBase1.getComLayoutParams();
      if (paramopw.mLayoutHeight >= 0) {
        paramopw.mLayoutHeight = (i - m + paramopw.mLayoutHeight);
      }
      paramopw = localViewBase1.getComLayoutParams();
      paramContainer.setLayoutParams(new RelativeLayout.LayoutParams(paramopw.mLayoutWidth, paramopw.mLayoutHeight));
      return;
      if (odm.c((int)localArticleInfo.mChannelID))
      {
        beoj.a("configDivider.DailyFeeds");
        paramopw = paramopw.b();
        j = 0;
        k = 0;
        i = k;
        ...
        {
          i = k;
          if (paramopw.mProteusTemplateBean != null)
          {
            if (paramopw.mProteusTemplateBean.getDataAttribute(null, "position_jump") == null) {
              break label344;
            }
            i = 1;
          }
      ...
      else if ((a(paramopw.b())) || (a(paramopw)))
      {
        i = 0;
        localParams.mLayoutMarginLeft = 0;
        localParams.mLayoutMarginRight = 0;
      ...
      {
        beoj.a("configDivider.normal");
        beoj.a("configDivider.normal.getProteusSeparatorHeightPx");
        i = a(paramTemplateBean);
        beoj.a();
        beoj.a("configDivider.normal.getProteusSeparatorMarginLeftPx");
  ...
  {
    paramVafContext.setTemplateFactory(rdg.a(paramString, true));
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyLikeButton", new ozp());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyAvatarView", new oyg());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyVariableImageContentView", new oyq());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoySummaryView", new paw());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyCommentView", new oye());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyBiuCommentView", new oyi());
    paramVafContext.getViewFactory().registerViewBuilder("CornerTextImageView", new oyk());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyMiddleBodyView", new ozu());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyUsersCommentView", new pay());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyFriendsBiu", new ozf());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyQARichView", new NativeText.Builder());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyBiuButton", new oza());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyCoordinateView", new ozd());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoySocializeRecommendFollowView", new pag());
    paramVafContext.getViewFactory().registerViewBuilder("UILabel", new pau());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInjoyAsynImageView", new paq());
    paramVafContext.getViewFactory().registerViewBuilder("UIImageView", new paq());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInjoyAsynImageIcon", new pao());
    paramVafContext.getViewFactory().registerViewBuilder("ProteusCollectionView", new pch());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyAdVideoGuide", new oyx());
    paramVafContext.getViewFactory().registerViewBuilder("PTSAvatarView", new nyz());
    paramVafContext.getViewFactory().registerViewBuilder("QQAvatarView", new nyz());
    paramVafContext.getViewFactory().registerViewBuilder("QQRIJCommentEmotioinLabel", new nzb());
    paramVafContext.getViewFactory().registerViewBuilder("QQRIJCommentLikeButton", new nzd());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyExposeReplyCommentView", new nzf());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyAwesomeCommentView", new oyz());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyAdDownloadView", new nqw());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyAdLocationView", new oyv());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyIconText", new nrm());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInjoyDoubleImageView", new nrt());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInjoyTripleImageInteractView", new nrv());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyAdInnerOperateView", new nqy());
    paramVafContext.getViewFactory().registerViewBuilder("ReadinjoyNativeArticleAdDownloadView", new nsa());
    paramVafContext.getViewFactory().registerViewBuilder("ProteusTickerView", new oys());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInjoyShareView", new ozw());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInjoyApngImageView", new pam());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyAdBrandOptimizationView", new nqu());
    a();
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyArticleBottomVideoView", new nrh());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyVideoView", new pak());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyGifView", new ozh());
    paramVafContext.getViewFactory().registerViewBuilder("ProteusMarqueeLabel", new NativeText.Builder());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyLinkClickableLabel", new pau());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyLottieView", new ozs());
    paramVafContext.getViewFactory().registerViewBuilder("FusionBiuButton", new oyo());
    paramVafContext.getViewFactory().registerViewBuilder("ReadInJoyLikeBiuFusionFloatView", new ozl());
  }
  ...
  public static void a(ViewBase paramViewBase, ViewBean paramViewBean)
  {
    if (paramViewBase != null)
    {
      ...
      oxz.a("ProteusSupportUtil", "[bindDynamicValue]");
    }
  }
  
  private static void a(opw paramopw, VafContext paramVafContext)
  {
    Object localObject = paramopw.a();
    if (localObject != null)
    {
      localObject = ((qoe)localObject).b(paramopw.g() + 1);
      if ((localObject != null) && (((BaseArticleInfo)localObject).mProteusTemplateBean == null))
      {
        ...
        ((BaseArticleInfo)localObject).mProteusTemplateBean = a(paramVafContext, paramopw.b(), (BaseArticleInfo)localObject);
      }
    }
  }
  ...
  public static boolean a(ArticleInfo paramArticleInfo)
  {
    // Byte code:
    //   0: ldc_w 1213
    //   3: invokestatic 128	beoj:a	(Ljava/lang/String;)V
    //   6: aload_0
    //   7: ifnull +154 -> 161
    //   10: aload_0
    //   11: getfield 1216	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo:proteusItemsData	Ljava/lang/String;
    //   14: invokestatic 703	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   17: ifne +144 -> 161
    //   20: aload_0
    //   21: getfield 1219	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo:mFeedType	I
    //   24: bipush 29
    //   26: if_icmpeq +8 -> 34
    //   29: invokestatic 142	beoj:a	()V
    //   32: iconst_0
    //   33: ireturn
    //   34: new 430	org/json/JSONObject
    //   37: dup
    //   38: aload_0
    //   39: getfield 1216	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo:proteusItemsData	Ljava/lang/String;
    //   42: invokespecial 1221	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   45: astore_0
    //   46: aload_0
    //   47: invokevirtual 1224	org/json/JSONObject:keys	()Ljava/util/Iterator;
    //   50: astore_2
    //   51: aload_2
    ...
    //   70: aload_0
    //   71: aload_3
    //   72: invokevirtual 1228	org/json/JSONObject:opt	(Ljava/lang/String;)Ljava/lang/Object;
    //   75: astore 4
    //   77: ldc_w 1230
    //   80: aload_3
    //   81: invokevirtual 1231	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   84: ifeq -33 -> 51
    //   87: ldc 206
    //   89: iconst_1
    //   90: iconst_2
    ...
    //   108: invokestatic 142	beoj:a	()V
    //   111: ldc_w 1235
    //   114: aload 4
    //   116: invokestatic 1238	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   119: invokevirtual 1231	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   122: ifne +19 -> 141
    //   125: ldc_w 1240
    //   128: aload 4
    //   130: invokestatic 1238	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   133: invokevirtual 1231	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   136: istore_1
    //   137: iload_1
    //   138: ifeq +7 -> 145
    //   141: iconst_1
    ...
    //   154: ldc_w 1242
    //   157: aload_0
    //   158: invokestatic 1244	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   161: invokestatic 142	beoj:a	()V
    //   164: iconst_0
    //   165: ireturn
    //   166: astore_0
    //   167: ldc 206
    ...
    //   170: ldc_w 1246
    //   173: aload_0
    //   174: invokestatic 1244	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   177: goto -16 -> 161
    // Local variable table:
    //   start	length	slot	name	signature
      ...
      try
      {
        ...
        while (i < j)
        {
          ...
          if ((localObject instanceof NativeLayoutImpl))
          {
            ...
            {
              ndn.a(obz.a(), "CliOper", "", "", "0X8009AC1", "0X8009AC1", 0, 0, "", "", "", "", false);
              oya.a(paramContainer.getVirtualView(), "ProteusSupportUtil");
              oya.a(paramContainer, "ProteusSupportUtil");
  ...
  {
    paramString = rdg.a(paramString, true);
  ...
  public static boolean a(opw paramopw)
  {
    if (paramopw != null) {
      try
      {
        ...
        {
          paramopw = paramopw.b();
          if ((paramopw != null) && (AdvertisementInfo.isAdvertisementInfo(paramopw)))
          {
            paramopw = ((AdvertisementInfo)paramopw).mAdExtInfo;
            if (paramopw != null)
            {
              i = new JSONObject(paramopw).optInt("is_video_new");
              return i == 1;
            }
          }
        }
      ...
      {
        QLog.d("ProteusSupportUtil", 1, "isNextCardAdBigImgOrAdVideo JSONException, e = ", paramopw);
      }
    }
    return false;
  }
  ...
  private static int b(TemplateBean paramTemplateBean)
  {
    if ((paramTemplateBean != null) && (paramTemplateBean.getViewBean() != null)) {
      try
      {
        ...
        oxz.a("ProteusSupportUtil", "[getSepatatorHeight] getSepatatorHeight");
  ...
  private static void b(ViewBean paramViewBean)
  {
    ...
    try
    {
      ...
      {
        String str = (String)localIterator.next();
        localocg.b(str, localJSONObject.get(str).toString());
      }
      ndn.a(null, "CliOper", "", "", paramViewBean, paramViewBean, 0, 0, "", "", "", localocg.a(), false);
    }
  ...
  {
    paramString = rdg.a(paramString, false);
