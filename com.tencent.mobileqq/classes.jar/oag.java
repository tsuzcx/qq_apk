...
public class oag
{
  ...
  private static JSONObject a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      localJSONObject1.put("statistics_data_report", oar.a(paramContext, paramAdvertisementInfo, localJSONObject2).toString());
  ...
  private static void a(Activity paramActivity, int paramInt, VideoAdInfo paramVideoAdInfo)
  {
    ...
    AdvertisementInfo localAdvertisementInfo = nmc.a(paramVideoAdInfo);
    ...
    {
      a(paramActivity, paramVideoAdInfo, localAdvertisementInfo, nmc.P, 0, paramInt);
      return;
    }
    a(paramActivity, paramVideoAdInfo, localAdvertisementInfo, nmc.N, 0, paramInt);
  }
  ...
  public static void a(Activity paramActivity, int paramInt, boolean paramBoolean)
  {
    ...
    AdvertisementInfo localAdvertisementInfo = nmc.a(localVideoAdInfo);
    if (QLog.isColorLevel()) {
  ...
  private static void a(Activity paramActivity, VideoAdInfo paramVideoAdInfo, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    nmc.a(new nyd().a(paramActivity).a(nmc.A).b(paramInt1).a(paramAdvertisementInfo).a(paramVideoAdInfo).e(a(paramActivity, paramAdvertisementInfo, paramInt2, paramInt3)).a());
  }
  ...
  private void a(Activity paramActivity, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    nmc.a(new nyd().a(paramActivity).a(nmc.A).b(paramInt1).a(paramAdvertisementInfo).e(a(paramActivity, paramAdvertisementInfo, paramInt2, paramInt3)).a());
  }
  ...
  {
    boolean bool = "1".equals(bhvy.a("readinjjoy_ad_supplement_config"));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject1 != null) && (((Long)localObject1).longValue() != 0L))
        {
          ...
          AdvertisementInfo localAdvertisementInfo = nmc.a((VideoAdInfo)localObject2);
          if (((VideoAdInfo)localObject2).jdField_c_of_type_Boolean) {
            a(paramActivity, (VideoAdInfo)localObject2, localAdvertisementInfo, nmc.P, (int)(System.currentTimeMillis() - ((Long)localObject1).longValue()), 50);
          } else {
            a(paramActivity, (VideoAdInfo)localObject2, localAdvertisementInfo, nmc.N, (int)(System.currentTimeMillis() - ((Long)localObject1).longValue()), 50);
          }
        }
      }
    }
  ...
  public void a(ram paramram, Activity paramActivity)
  {
    if ((paramram == null) || (paramActivity == null) || (this.jdField_c_of_type_Boolean)) {}
    ReadInJoyXListView localReadInJoyXListView;
    List localList;
    do
    {
      return;
      localReadInJoyXListView = (ReadInJoyXListView)paramram.a();
      localList = paramram.a();
      i = paramram.a();
    } while ((localReadInJoyXListView == null) || (localList == null) || (!oar.a(i)));
    c();
    ...
    if (i <= m)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        paramram = (BaseArticleInfo)localList.get(i - k);
        if (AdvertisementInfo.isAdvertisementInfo(paramram)) {
          a(localReadInJoyXListView, j, m, i, (AdvertisementInfo)paramram, paramActivity);
        }
      }
    }
    a(paramActivity);
