...
public class aaxk
{
  ...
  public aaxk(String paramString, int paramInt1, int paramInt2, int paramInt3, long paramLong, boolean paramBoolean, int paramInt4)
  {
  ...
  @TargetApi(17)
  @RequiresApi(api=17)
  public void a(List<Bitmap> paramList, aaxe paramaaxe)
  {
    aaxf localaaxf = new aaxf(0, "success");
    this.jdField_a_of_type_Batx = new batx();
    batj localbatj = new batj(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_Int, this.jdField_a_of_type_Int, this.c, 1, false, 0);
    ...
    this.jdField_a_of_type_Batx.a(localbatj, new aaxl(this, paramList, paramaaxe, localaaxf));
    try
    {
      try
      {
