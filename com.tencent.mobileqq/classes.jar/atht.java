...
public class atht
{
  ...
  public static atwv a(List<ilive_feeds_read.TopicCfg> paramList, atwv paramatwv)
  {
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      paramList = (ilive_feeds_read.TopicCfg)paramList.get(0);
      paramatwv.a = new atht();
      paramatwv.a.d(paramList.jump_url.get());
      paramatwv.a.b(paramList.topic_name.get());
      paramatwv.a.a(paramList.topic_desc.get());
      paramatwv.a.b(paramList.topic_parti_num.get());
      paramatwv.a.c(paramList.topic_pic_url.get());
      paramatwv.a.a(paramList.topic_tag.get());
      paramatwv.a.c(paramList.topic_type.get());
    }
    return paramatwv;
  }
