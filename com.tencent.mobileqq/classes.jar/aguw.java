  ...
  implements agve
{
  ...
  public aguw(QQAppInterface paramQQAppInterface, agwa paramagwa, Activity paramActivity, SessionInfo paramSessionInfo, aelz paramaelz)
  {
  ...
  {
    paramVarArgs = ayvw.a(-1016);
    long l = ayvc.a();
    String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
    paramVarArgs.init(str, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131691891), l, -1017, 3000, l);
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            ...
            localObject1 = aouu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if (((aouu)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 2))
            {
              if (!QLog.isColorLevel()) {
                break;
              }
            ...
            localList = this.jdField_a_of_type_Aelz.a();
            if (localList == null)
            {
              if (!QLog.isColorLevel()) {
                break;
            ...
            if (!bdee.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
            {
              if (!QLog.isColorLevel()) {
                break;
              }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((paramInt >= 5) && (i >= 2))
        {
          ...
          ((aouu)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 2);
        ...
        for (;;)
        {
          try
          {
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8003F01", "0X8003F01", 0, 0, "", "", "", "");
