...
public class mik
{
  private static BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mil();
  static String jdField_a_of_type_JavaLangString = "actAVGSensorCaseReport";
  int jdField_a_of_type_Int = 0;
  private long jdField_a_of_type_Long;
  ArrayList<mim> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  mim jdField_a_of_type_Mim = null;
  ...
  private void a(int paramInt, ArrayList<mim> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          mim localmim = (mim)paramArrayList.next();
          JSONObject localJSONObject = new JSONObject();
          localJSONObject.put("i", localmim.jdField_a_of_type_Int);
          localJSONObject.put("off", localmim.jdField_a_of_type_Long);
          localJSONObject.put("on", localmim.jdField_b_of_type_Long);
          localJSONObject.put("why", localmim.jdField_c_of_type_Long);
  ...
  void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt, boolean paramBoolean4, VideoController paramVideoController)
  {
    ...
    long l = System.currentTimeMillis();
    paramVideoController = this.jdField_a_of_type_Mim;
    this.jdField_a_of_type_Mim = null;
    if (paramVideoController != null)
    {
  ...
  void c()
  {
    this.jdField_a_of_type_Mim = new mim(this);
    this.jdField_a_of_type_Mim.jdField_a_of_type_Int = this.h;
    this.h += 1;
    this.jdField_a_of_type_Mim.jdField_a_of_type_Long = System.currentTimeMillis();
    this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Mim);
  }
