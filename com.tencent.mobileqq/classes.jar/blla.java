...
public class blla
{
  ...
  static
  {
    ...
    for (;;)
    {
      ...
      {
        if (blla.class.getName().equals(arrayOfStackTraceElement[i].getClassName())) {
  ...
  public blla a(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    return this;
  }
  
  public blla a(String paramString1, int paramInt, String paramString2)
  {
  ...
  public blla b(String paramString1, int paramInt, String paramString2)
  {
    a(paramString1, paramInt, 4, paramString2, this.b);
    return this;
  }
  
  public blla c(String paramString1, int paramInt, String paramString2)
  {
