...
public class akni
  extends akmj
{
  akni(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  private void a(LocalMediaInfo paramLocalMediaInfo, Bundle paramBundle)
  {
    ...
    bpij.a(this.mActivity, paramLocalMediaInfo.path, paramLocalMediaInfo, 0, (int)paramLocalMediaInfo.mDuration, i, 10023, 0, null, null, false, 11, 14, paramBundle);
  }
  ...
  private void g(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if ((paramLocalMediaInfo == null) || (TextUtils.isEmpty(paramLocalMediaInfo.path)) || (this.mActivity == null) || (((NewPhotoListActivity)this.mActivity).getIntent() == null))
    {
      ...
      {
        paramLocalMediaInfo = "";
        bnrh.d("PhotoListLogicAECamera", paramLocalMediaInfo);
      }
    }
    do
    {
      ...
      break;
      g();
      if (!bnlb.a(((NewPhotoListActivity)this.mActivity).getIntent()))
      {
      ...
      localObject = aanc.a().a(paramLocalMediaInfo.path, "2");
    } while (TextUtils.isEmpty((CharSequence)localObject));
    BitmapFactory.Options localOptions = new BitmapFactory.Options();
    localOptions.inJustDecodeBounds = true;
    bgyo.a(paramLocalMediaInfo.path, localOptions);
    ...
    aanc.a().a(paramLocalMediaInfo.path, (String)localObject, "2", j, i, false, 0, new aknm(this, (String)localObject, paramLocalMediaInfo));
  }
  ...
  public void caseSingleModeImage(View paramView, int paramInt)
  {
    ...
    {
      bnrh.d("PhotoListLogicAECamera", "mActivity is null");
      return;
    }
    ...
    MediaScanner.getInstance(BaseApplicationImpl.getContext()).queryMediaInfoAsync(new aknj(this), paramView);
  }
  ...
  public void caseVideo(View paramView, int paramInt)
  {
    ...
    if (paramView == null)
    {
      bnrh.d("PhotoListLogicAECamera", "photoInfo is null.");
      return;
    }
    ...
    ((NewPhotoListActivity)this.mActivity).showProgressDialog();
    g();
    MediaScanner.getInstance(BaseApplicationImpl.getContext()).queryMediaInfoAsync(new aknk(this, localIntent, localArrayList), paramView);
  }
