...
public class oqz
{
  private static final Map<Integer, php> a = new HashMap();
  ...
  {
    bfwu.a("ProteusSupportUtilDynamic.getView");
    ...
    {
      localContainer.setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841262));
  ...
  private static TemplateBean a(int paramInt, BaseArticleInfo paramBaseArticleInfo, String paramString)
  {
    ...
    //   96: aload_2
    //   97: iconst_1
    //   98: invokestatic 150	rpr:a	(Ljava/lang/String;Z)Lrpr;
    //   101: astore_1
    //   102: aload_1
    //   103: ifnull +12 -> 115
    //   106: aload_1
    //   107: aload 4
    //   109: invokevirtual 154	rpr:getTemplateBean	(Lorg/json/JSONObject;)Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;
    //   112: astore_1
    //   113: aload_1
    //   114: areturn
    //   115: aconst_null
  ...
  private static TemplateBean a(VafContext paramVafContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        paramVafContext = paramVafContext.getTemplateBean(localpdm.a(paramString1).a());
  ...
  private static void a(int paramInt, php paramphp)
  {
    ...
    a.put(Integer.valueOf(paramInt), paramphp);
  }
  ...
  {
    bfwu.a("ProteusSupportUtilDynamic.bindData");
    ...
    paramProteusItemView.setTag(2131374825, paramString);
    bfwu.a("ProteusSupportUtilDynamic.bindDataImpl");
    if (paramString != null) {
      olo.a(paramProteusItemView, localTemplateBean, paramString);
    }
    bfwu.a();
    olo.a(paramProteusItemView, paramVafContext, paramString);
    bfwu.a();
  }
