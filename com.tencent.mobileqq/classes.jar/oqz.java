...
public class oqz
  extends orj
{
  public oqz(ReadInJoyCGIDynamicChannelFragment paramReadInJoyCGIDynamicChannelFragment) {}
  ...
  public void a(int paramInt, boolean paramBoolean1, boolean paramBoolean2, List<DynamicChannelDataModel> paramList)
  {
    ...
    label175:
    for (String str = String.format(this.a.getResources().getString(2131718327), new Object[] { Integer.valueOf(i) });; str = this.a.getResources().getString(2131718326))
    {
