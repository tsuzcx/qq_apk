...
class askw
  extends mmm
{
  askw(askv paramaskv, askt paramaskt) {}
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null))
    {
      ...
      if (paramArrayOfByte.lists.has())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (!askv.a(this.jdField_a_of_type_Askv).contains(Long.valueOf(localComment.comment_id.get()))) {
            askv.a(this.jdField_a_of_type_Askv).add(Long.valueOf(localComment.comment_id.get()));
          }
      ...
      this.jdField_a_of_type_Askt.a(paramBundle);
      return;
    }
