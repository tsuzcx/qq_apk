...
public final class uts
  implements Runnable
{
  public uts(QQAppInterface paramQQAppInterface, Context paramContext, ApolloFavActionData paramApolloFavActionData, SessionInfo paramSessionInfo) {}
  ...
  public void run()
  {
    ...
    do
    {
      do
      {
        ...
        ApolloItemBuilder.a(this.jdField_a_of_type_AndroidContentContext.getString(2131438192), 1, this.jdField_a_of_type_AndroidContentContext);
      ...
      ApolloItemBuilder.a(this.jdField_a_of_type_AndroidContentContext.getString(2131438193), 1, this.jdField_a_of_type_AndroidContentContext);
    } while (!QLog.isColorLevel());
    ...
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
        ApolloItemBuilder.a(this.jdField_a_of_type_AndroidContentContext.getString(2131438194), 1, this.jdField_a_of_type_AndroidContentContext);
      ...
      ApolloItemBuilder.a(this.jdField_a_of_type_AndroidContentContext.getString(2131438191), 2, this.jdField_a_of_type_AndroidContentContext);
