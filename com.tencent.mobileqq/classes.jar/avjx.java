...
public class avjx
{
  ...
  public final ArrayList<avjs> a;
  public final int b;
  public avjw b;
  public final int c;
  private final int d;
  
  public avjx(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, ArrayList<avjs> paramArrayList)
  {
  ...
  public avjx(String paramString, int paramInt1, int paramInt2, ArrayList<avjs> paramArrayList)
  {
    this.jdField_a_of_type_Avjw = new avjw();
    this.jdField_b_of_type_Avjw = new avjw();
    this.jdField_a_of_type_Int = paramInt1;
  ...
  public long a()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
      return ((avjs)this.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_Long;
    }
    return 0L;
  }
  ...
  public void a(Canvas paramCanvas, int paramInt1, int paramInt2, Paint paramPaint1, Paint paramPaint2, Bitmap paramBitmap1, Bitmap paramBitmap2, int paramInt3)
  {
    ...
    if ((this.jdField_a_of_type_Avjw != null) && (this.jdField_a_of_type_Avjw.a != null) && (!this.jdField_a_of_type_Avjw.a.isRecycled()))
    {
      paramBitmap1 = new Rect(paramInt1 - this.jdField_a_of_type_Avjw.c - this.jdField_a_of_type_Avjw.a.getWidth(), (int)(paramInt2 - paramPaint1.getTextSize()), paramInt1 - this.jdField_a_of_type_Avjw.c, (int)(this.jdField_a_of_type_Avjw.a.getHeight() + paramInt2 - paramPaint1.getTextSize()));
      paramCanvas.drawBitmap(this.jdField_a_of_type_Avjw.a, null, paramBitmap1, null);
    }
  ...
  public void a(Canvas paramCanvas, int paramInt1, int paramInt2, Paint paramPaint1, Paint paramPaint2, Paint paramPaint3, int paramInt3, float paramFloat1, float paramFloat2, int[] paramArrayOfInt, float[] paramArrayOfFloat)
  {
    ...
    if (paramInt3 > 0)
    {
      paramArrayOfInt = (avjs)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt3 - 1);
    ...
    paramPaint2 = (avjs)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt3);
    ...
    for (paramPaint2 = this.jdField_a_of_type_JavaLangString.substring(paramPaint2.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString.length());; paramPaint2 = this.jdField_a_of_type_JavaLangString.substring(paramPaint2.jdField_a_of_type_Int, paramPaint2.jdField_b_of_type_Int))
    {
      ...
      if (paramInt3 < this.jdField_a_of_type_JavaUtilArrayList.size() - 1)
      {
        paramPaint2 = (avjs)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt3 + 1);
  ...
  public long b()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      avjs localavjs = (avjs)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_JavaUtilArrayList.size() - 1);
      long l = localavjs.jdField_a_of_type_Long;
      return localavjs.jdField_b_of_type_Long + l;
    }
    return 0L;
  }
}
