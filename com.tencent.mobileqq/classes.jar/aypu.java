...
public class aypu
{
  ...
  {
    // Byte code:
    //   0: new 48	java/util/zip/GZIPInputStream
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 50	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   8: astore_3
    //   9: aload_3
    //   10: astore_0
    //   11: sipush 1024
    ...
    //   23: iconst_0
    //   24: sipush 1024
    //   27: invokevirtual 54	java/util/zip/GZIPInputStream:read	([BII)I
    //   30: istore_2
    //   31: iload_2
    //   32: iconst_m1
    //   33: if_icmpeq +74 -> 107
    ...
    //   41: iconst_0
    //   42: iload_2
    //   43: invokevirtual 60	java/io/OutputStream:write	([BII)V
    //   46: goto -28 -> 18
    //   49: astore_0
    //   50: aload_3
    //   51: astore_1
    ...
    //   79: aload_3
    //   80: invokevirtual 37	java/io/IOException:getMessage	()Ljava/lang/String;
    //   83: invokevirtual 33	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   86: invokevirtual 40	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   89: invokestatic 44	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   92: aload_1
    //   93: astore_0
    //   94: aload_3
    //   95: athrow
    ...
    //   100: astore_0
    //   101: aload_1
    //   102: invokestatic 64	aypu:a	(Ljava/io/InputStream;)V
    //   105: aload_0
    //   106: athrow
    //   107: aload_3
    //   108: invokestatic 64	aypu:a	(Ljava/io/InputStream;)V
    //   111: return
    //   112: astore_0
    //   113: aconst_null
    //   114: astore_1
