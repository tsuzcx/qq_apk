...
public class aypu
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, TextView paramTextView, @NonNull Friends paramFriends, int paramInt)
  {
    ...
    if (paramInt == 2)
    {
      ...
      paramQQAppInterface = aqgv.a(paramTextView.getPaint(), paramFriends, bgtn.a(200.0F));
    }
  ...
  public static void a(aytf paramaytf, View paramView)
  {
    ...
    if ((paramView instanceof Integer))
    {
      ...
      if (i == 2)
      {
        paramaytf = paramaytf.c().iterator();
        while (paramaytf.hasNext()) {
          aypy.a("0X800AF40", ((Integer)paramaytf.next()).intValue(), "2");
        }
      }
      if (i == 1)
      {
        paramaytf = paramaytf.c().iterator();
        while (paramaytf.hasNext()) {
          aypy.a("0X800B00F", ((Integer)paramaytf.next()).intValue(), "2");
        }
      }
    }
  }
  ...
  private static void a(Friends paramFriends)
  {
    ...
    do
    {
      ...
      QLog.d("OnlineStatusUtil", 2, new Object[] { "resetExtOnlineBusinessInfo: invoked. [constellation] 切换账号场景，后台会清空ext info，需要在上线时拉取并上报 reset all trend info ", " friend: ", paramFriends.uin });
      return;
  ...
  private static void a(Friends paramFriends1, byte[] paramArrayOfByte, @Nullable Friends paramFriends2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("OnlineStatusUtil", 2, new Object[] { "parseExtOnlineBusinessInfo: invoked. ", aysh.a(paramFriends1) });
        }
        return;
      }
  ...
  public static boolean a()
  {
    ...
    return (localaqqh != null) && (localaqqh.a != null) && (a(localaqqh.a.a));
  }
  ...
  public static boolean a(int paramInt, Resources paramResources)
  {
    ...
    if (paramInt < 7)
    {
      ...
      i = 2;
      label36:
      i = afur.a(i * 64 + 62, paramResources);
      if (afur.a(64.0F, paramResources) * paramInt <= j - i) {
        break label114;
      }
    }
    label109:
  ...
  public static boolean a(aypi paramaypi)
  {
    if (paramaypi == null) {}
    while ((paramaypi.jdField_a_of_type_Long != 40001L) || (TextUtils.isEmpty(paramaypi.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(paramaypi.b))) {
      return false;
    }
    return true;
  }
  ...
  public static String b(Friends paramFriends)
  {
    ...
    if (i == 4)
    {
      ...
      {
        if (!((QQAppInterface)localObject1).a(paramFriends)) {
          break label181;
        }
        localObject1 = bglf.a();
      }
    ...
    for (;;)
    {
      Object localObject2 = bgxp.a().a();
      for (;;)
      {
        try
        {
          if ((!TextUtils.isEmpty((CharSequence)localObject2)) || (paramFriends == null) || (i != 4)) {
            break label176;
          }
        ...
        try
        {
          if (TextUtils.isEmpty(paramFriends)) {
            localObject2 = BaseApplicationImpl.getContext().getString(2131718211);
          }
        ...
        if (bglf.a(paramFriends)) {
          break label181;
        }
        localObject1 = bglf.c(paramFriends.getNetWorkType());
        break;
        label170:
        return localObject2;
        label176:
  ...
  public static boolean b(aypi paramaypi)
  {
    if (paramaypi == null) {}
    while ((paramaypi.jdField_a_of_type_Long != 40001L) || (TextUtils.isEmpty(paramaypi.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(paramaypi.b)) || (TextUtils.isEmpty(paramaypi.c))) {
      return false;
    }
    return true;
  }
  ...
  {
    String str = aysh.b(paramFriends);
    if (QLog.isColorLevel()) {
