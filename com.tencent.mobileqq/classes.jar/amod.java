...
public class amod
{
  ...
  public ArrayList<amob> f = new ArrayList();
  ...
  private Rect a()
  {
    ...
    {
      return localObject;
      Collections.sort(this.jdField_b_of_type_JavaUtilArrayList, new amoe(this));
      localRect = (Rect)this.jdField_b_of_type_JavaUtilArrayList.get(amoa.jdField_a_of_type_JavaUtilRandom.nextInt(Math.min(this.jdField_b_of_type_JavaUtilArrayList.size(), 3)));
  ...
  private Rect a(amoi paramamoi, Rect paramRect, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    int j = paramamoi.c;
    int i = j;
    if (paramamoi.jdField_a_of_type_Int >= 1) {
      i = Math.max(24, (int)(j * (0.95F - amoa.jdField_a_of_type_JavaUtilRandom.nextInt(10) / 100.0F))) / 4 * 4;
    }
    ...
    if (n < 10)
    {
      ...
      if (m >= 24)
      {
        k = (int)(m * paramamoi.jdField_a_of_type_Float);
        localObject1 = localObject2;
        i = j;
        if (paramInt1 * paramInt2 >= m * k)
        {
          localObject3 = paramamoi.jdField_a_of_type_JavaUtilSet.iterator();
          i = j;
          localObject1 = localObject2;
          label142:
    ...
    for (;;)
    {
      if (paramRect == null)
      {
        ...
        m = Math.max(24, (int)(m * (0.95F - amoa.jdField_a_of_type_JavaUtilRandom.nextInt(6) / 100.0F))) / 4 * 4;
        n += 1;
      ...
      {
        paramamoi = new amob(paramamoi, -1, paramRect, m, true, i);
        a(paramamoi, paramRect);
        this.f.add(paramamoi);
        return paramRect;
      }
      return null;
      label324:
  ...
  private Rect a(Rect paramRect)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        k = amoa.jdField_a_of_type_JavaUtilRandom.nextInt(this.jdField_a_of_type_JavaUtilArrayList.size());
        if (k != 0)
        {
          localObject = (amoi)this.jdField_a_of_type_JavaUtilArrayList.get(0);
        ...
        do
        {
          ...
          localRect = a((amoi)((Iterator)localObject).next(), paramRect, m, n, i, j);
    ...
    for (;;)
    {
      ...
      if (localRect.top == paramRect.bottom)
      {
        ...
        if (paramRect.width() < paramRect.height())
        {
          ...
          j = k;
          break;
          k = amoa.jdField_a_of_type_JavaUtilRandom.nextInt(Math.min(this.jdField_a_of_type_JavaUtilArrayList.size(), 3));
          break label136;
          return null;
        }
        bool = false;
  ...
  private Rect a(Rect paramRect, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8)
  {
    if ((paramInt4 <= paramInt2) && (paramInt3 <= paramInt1)) {
      if (paramRect.width() - paramInt3 >= amoa.jdField_a_of_type_Int + 8) {}
    }
    for (;;)
    {
      if (paramRect.height() - paramInt4 < amoa.jdField_a_of_type_Int + 8) {}
      for (;;)
      {
  ...
  private Rect a(Rect paramRect, boolean paramBoolean)
  {
    ...
    {
      amob localamob = (amob)localIterator.next();
      int i = localamob.jdField_a_of_type_AndroidGraphicsRect.width();
      int j = localamob.jdField_a_of_type_AndroidGraphicsRect.height();
      if (((paramBoolean) || (k * 5 < i * j) || (k <= 576)) && (a(paramRect, localamob.jdField_a_of_type_AndroidGraphicsRect)))
      {
        localamob.jdField_a_of_type_AndroidGraphicsRect.union(paramRect);
        a(localamob, localamob.jdField_a_of_type_AndroidGraphicsRect);
        return paramRect;
      }
      if (paramBoolean)
      {
        ...
        j = 0;
        if ((localRect.left <= localamob.jdField_a_of_type_AndroidGraphicsRect.left) && (localRect.right >= localamob.jdField_a_of_type_AndroidGraphicsRect.right))
        {
          localRect.left = localamob.jdField_a_of_type_AndroidGraphicsRect.left;
          localRect.right = localamob.jdField_a_of_type_AndroidGraphicsRect.right;
          i = 1;
        }
        while ((i != 0) && (a(localRect, localamob.jdField_a_of_type_AndroidGraphicsRect)))
        {
          localamob.jdField_a_of_type_AndroidGraphicsRect.union(localRect);
          a(localamob, localamob.jdField_a_of_type_AndroidGraphicsRect);
          return localRect;
          i = j;
          if (paramRect.top <= localamob.jdField_a_of_type_AndroidGraphicsRect.top)
          {
            i = j;
            if (paramRect.bottom >= localamob.jdField_a_of_type_AndroidGraphicsRect.bottom)
            {
              localRect.top = localamob.jdField_a_of_type_AndroidGraphicsRect.top;
              localRect.bottom = localamob.jdField_a_of_type_AndroidGraphicsRect.bottom;
              i = 1;
            }
          }
        }
  ...
  private void a(amob paramamob, Rect paramRect)
  {
    paramamob.jdField_a_of_type_JavaUtilArrayList.clear();
    int i4 = paramamob.e;
    int i5 = paramamob.b;
    float f2 = paramamob.jdField_a_of_type_Amoi.jdField_a_of_type_Float;
    int i3 = 0;
    int i;
    label75:
    int j;
    ...
    for (int m = j;; m = j)
    {
      ...
      for (;;)
      {
        ...
        {
          float f1 = 0.0F;
          i2 = paramamob.jdField_a_of_type_Amoi.b / i4;
          ...
          if (i2 <= 1)
          {
            ...
            i = Math.max(m, 0);
            Math.max(k, 0);
            bool = amoa.jdField_a_of_type_JavaUtilRandom.nextBoolean();
            f1 = i + paramRect.top;
            i = 0;
          }
          for (;;)
          {
            ...
            if (k < i2)
            {
              ...
              for (j = i;; j = i4 + i)
              {
                localObject1 = (Pair)paramamob.jdField_a_of_type_Amoi.jdField_a_of_type_JavaUtilArrayList.get(j);
                j = Math.round(f2);
                m = Math.round(f1);
                float f5 = i5;
                localObject2 = new amoc(new Rect(j, m, Math.round(((Float)((Pair)localObject1).second).floatValue() * f5 + f2), Math.round(i5 + f1)), (String)((Pair)localObject1).first);
                paramamob.jdField_a_of_type_JavaUtilArrayList.add(localObject2);
                f5 = i5;
  ...
  private void a(ArrayList<amoi> paramArrayList, boolean paramBoolean)
  {
    Collections.sort(paramArrayList, new amoh(this, paramBoolean, paramArrayList));
  }
  ...
  private boolean a(amoi paramamoi, Rect paramRect, int paramInt)
  {
    Iterator localIterator = paramamoi.jdField_a_of_type_JavaUtilSet.iterator();
    while (localIterator.hasNext())
    {
      Integer localInteger = (Integer)localIterator.next();
      if (((paramRect.width() + 8) * localInteger.intValue() >= paramamoi.jdField_a_of_type_Float * paramInt) && (paramRect.height() + 8 >= localInteger.intValue() * paramInt)) {
        return true;
      }
    }
    return false;
  ...
  private boolean a(Rect paramRect1, Rect paramRect2, int paramInt)
  {
    ...
    while (localIterator.hasNext()) {
      if (a((amoi)localIterator.next(), paramRect1, paramInt)) {
        return true;
      }
    }
  ...
  private void c()
  {
    ...
    if ((this.jdField_b_of_type_JavaUtilArrayList.size() > 0) && (i2 < 200))
    {
      ...
      while (i3 < i4)
      {
        ...
        localObject3 = localObject1;
        i1 = i;
        if (localRect.width() >= amoa.jdField_a_of_type_Int)
        {
          if (localRect.height() < amoa.jdField_a_of_type_Int)
          {
            i1 = i;
            localObject3 = localObject1;
            n = j;
        ...
        {
          localObject3 = (amoi)localIterator1.next();
          Iterator localIterator2 = ((amoi)localObject3).jdField_a_of_type_JavaUtilSet.iterator();
          i1 = i;
          localObject2 = localObject1;
          n = j;
          m = k;
          ...
          if (localIterator2.hasNext())
          {
            ...
            if ((localRect.width() * ((Integer)localObject1).intValue() < ((amoi)localObject3).jdField_a_of_type_Float * amoa.jdField_a_of_type_Int) || (localRect.height() < amoa.jdField_a_of_type_Int * ((Integer)localObject1).intValue())) {
              break label639;
            }
            float f1 = ((amoi)localObject3).jdField_a_of_type_Float / ((Integer)localObject1).intValue();
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localRect = a(localObject2, localObject2.width(), localObject2.height(), (int)(k * ((amoi)localObject1).jdField_a_of_type_Float / j), k * j, -1, -1, k, amoa.jdField_a_of_type_Int);
        if (localRect == null) {
          break;
        }
        a(localObject2, localRect, true);
        localObject1 = new amob((amoi)localObject1, -1, localRect, k, false, j);
        a((amob)localObject1, localRect);
  ...
  public ArrayList<amob> a(ArrayList<amoi> paramArrayList, Rect paramRect, ArrayList<Rect> paramArrayList1)
  {
    a();
    ...
    for (int i = 1;; i = 0)
    {
      ...
      else
      {
        ...
        paramRect = (amoi)paramArrayList.next();
        paramRect.a();
        if (paramRect.b == 13) {
          break label365;
        }
