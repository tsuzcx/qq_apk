...
public class amod
  extends QIPCModule
{
  private static volatile amod jdField_a_of_type_Amod;
  aymg jdField_a_of_type_Aymg = new aymg();
  private CardObserver jdField_a_of_type_ComTencentMobileqqAppCardObserver = new amoe(this);
  ...
  public amod(String paramString)
  {
    super(paramString);
    this.jdField_a_of_type_Aymg.jdField_a_of_type_ArrayOfJavaLangString = new String[7];
  }
  
  public static amod a()
  {
    if (jdField_a_of_type_Amod == null) {}
    try
    {
      if (jdField_a_of_type_Amod == null) {
        jdField_a_of_type_Amod = new amod("BabyQIPCModule");
      }
      return jdField_a_of_type_Amod;
    }
    finally {}
  }
  ...
  {
    amov localamov = (amov)paramQQAppInterface.getBusinessHandler(2);
    int i;
    int j;
    label78:
    boolean bool;
    label230:
    long l;
    if ((localamov != null) && (this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqDataCard != null) && (NetworkUtil.isNetSupport(BaseApplication.getContext()))) {
      if (this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqDataCard.bAvailVoteCnt <= 0)
      {
        i = 1;
        if ((this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqDataCard.bHaveVotedCnt > 0) || (this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqDataCard.bAvailVoteCnt > 0)) {
          break label372;
        }
        j = 1;
        if ((i != 0) || (j != 0)) {
        ...
        localamov.a(Long.valueOf(paramQQAppInterface.getCurrentAccountUin()).longValue(), Long.valueOf(this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a).longValue(), this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqDataCard.vCookies, this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqDataCard.favoriteSource, 1, 0);
        bool = ((awiz)paramQQAppInterface.getManager(207)).c(Long.valueOf(this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqDataCard.uin).longValue());
        ...
        i = 3;
        bcef.b(paramQQAppInterface, "CliOper", "", "", "P_prof", "Prof_good", 1, 1, i, Integer.toString(ProfileActivity.a(this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.h)), String.valueOf(1), paramQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqDataCard.uin);
        l = 0L;
      }
    }
    for (;;)
    {
      QLog.i("BabyQIPCModule", 1, "babyqWeb vote, card.bAvailVoteCnt = " + this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqDataCard.bAvailVoteCnt + ",card.bHaveVotedCnt = " + this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqDataCard.bHaveVotedCnt + ",card.strVoteLimitedNotice = " + this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqDataCard.strVoteLimitedNotice);
  ...
  EIPCResult a(QQAppInterface paramQQAppInterface, Bundle paramBundle, String paramString1, int paramInt, String paramString2)
  {
    ...
    label74:
    for (paramQQAppInterface = null;; paramQQAppInterface = paramQQAppInterface.e(this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a))
    {
      if (paramQQAppInterface != null)
      {
        paramBundle.putString("friendUin", this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a);
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get("setFriendGrouping") != null)
    {
      ...
      if ((this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne != null) && (ProfileActivity.AllInOne.b(this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne)))
      {
        localBundle.putString("key_method_action", "setFriendGrouping");
        localBundle.putString("web_js_call_back_id", (String)localObject1);
        localObject2 = (amsw)((QQAppInterface)localObject2).getManager(51);
        ...
        {
          localObject1 = ((amsw)localObject2).a(String.valueOf(((Friends)localObject1).groupid));
          if (localObject1 != null) {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        ...
        int i;
        return;
        Object localObject1 = ((amsw)localObject2).e(this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a);
      }
    }
    QLog.d("BabyQIPCModule", 2, "babyqWeb callWebJSHandledSetGroup");
  }
  ...
  EIPCResult b(QQAppInterface paramQQAppInterface, Bundle paramBundle)
  {
    ...
    {
      ((FriendListHandler)paramQQAppInterface.getBusinessHandler(1)).delFriend(this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a, (byte)2);
      MqqHandler localMqqHandler = paramQQAppInterface.getHandler(ChatActivity.class);
      if (localMqqHandler != null) {
        localMqqHandler.sendMessage(localMqqHandler.obtainMessage(16711681, this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a));
      }
      localMqqHandler = paramQQAppInterface.getHandler(ChatSettingActivity.class);
      if (localMqqHandler != null) {
        localMqqHandler.sendMessage(localMqqHandler.obtainMessage(16711681, this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a));
      }
      bcef.b(paramQQAppInterface, "dc00898", "", "", "0X8007FDF", "0X8007FDF", 0, 0, "", "", "", "");
      return EIPCResult.createSuccessResult(paramBundle);
    }
  ...
  public void b()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqDataCard = bfrj.a(localQQAppInterface, AppConstants.BABY_Q_UIN);
      this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqDataCard = this.jdField_a_of_type_ComTencentMobileqqDataCard;
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqDataCard != null) && (localObject != null)) {
      if (!((amsw)localObject).b(this.jdField_a_of_type_ComTencentMobileqqDataCard.uin)) {
        break label154;
      }
    }
    amov localamov;
    ...
    {
      this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne = ((ProfileActivity.AllInOne)localObject);
      localamov = (amov)localQQAppInterface.getBusinessHandler(2);
      if (localamov != null) {
        break;
      }
      return;
    ...
    localamov.a(localQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_ComTencentMobileqqDataCard.uin, 1, 0L, (byte)1, 0L, 0L, new byte[] { 0 }, "", l, 10004, new byte[] { 0 }, (byte)1);
    localamov.v();
  }
  ...
  EIPCResult c(QQAppInterface paramQQAppInterface, Bundle paramBundle)
  {
    ...
    label104:
    for (paramQQAppInterface = null;; paramQQAppInterface = localamsw.e(this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a))
    {
      if (paramQQAppInterface != null)
      {
        paramQQAppInterface = localamsw.a(String.valueOf(paramQQAppInterface.groupid));
        if (paramQQAppInterface != null)
        {
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    {
      paramString = (amsw)localQQAppInterface.getManager(51);
      if (paramString == null) {
        break label567;
      }
    }
    ...
    for (boolean bool = paramString.b(AppConstants.BABY_Q_UIN);; bool = false)
    {
      ...
      if (paramString.equals("addFriend")) {
        bcef.b(localQQAppInterface, "dc00898", "", "", "0X8008274", "0X8008274", 0, 0, "", "", "", "");
      }
      do
      {
        return null;
        ...
        {
          localBundle.putParcelable("key_parcel_allinone", this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne);
          return EIPCResult.createSuccessResult(localBundle);
        }
        ...
        if (paramString.equals("reportFriend"))
        {
          ...
          try
          {
            localBundle.putString("key_report_msg", aabc.a(localQQAppInterface, this.jdField_a_of_type_Aymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a, "", 21001, null));
            return EIPCResult.createSuccessResult(localBundle);
          }
      ...
      if (paramBundle != null)
      {
        ...
        paramString = (amov)localQQAppInterface.getBusinessHandler(2);
        if (l != 1L) {
          break label561;
        }
      }
