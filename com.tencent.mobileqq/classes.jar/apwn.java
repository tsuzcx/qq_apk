  ...
  extends apvx
{
  ...
  protected agzq a;
  private WeakReference<bhpc> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public apwn(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    this.jdField_a_of_type_Agzq = new agzq(this.jdField_a_of_type_JavaLangString, 30000L);
  }
  ...
  private void a(long paramLong1, String paramString, long paramLong2, long paramLong3, int paramInt)
  {
    ...
    apxv.a(paramLong2, paramLong3, new apwt(this, paramLong1));
  }
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    bicz.a(a(), paramString);
    if (paramString.equals("NavigateTo"))
    {
      paramString = a();
      if ((paramString != null) && (paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1)) {
        apxt.a(paramString, paramArrayOfVariantWrapper[0].GetString(), true, 0L, null, null, 3, this.jdField_a_of_type_JavaLangString, null);
      }
      return true;
    }
    ...
    if (localObject5 != null)
    {
      ...
      localObject4 = tzq.b(((BaseChatPie)localObject3).a.jdField_a_of_type_JavaLangString);
      ...
      paramArrayOfVariantWrapper = (agyw)agyw.a(paramArrayOfVariantWrapper).get();
      if ((paramArrayOfVariantWrapper == null) || (!(paramArrayOfVariantWrapper instanceof agyv))) {
        break label7591;
      }
      localMessageForArkApp = (MessageForArkApp)((agyv)paramArrayOfVariantWrapper).jdField_a_of_type_JavaLangRefWeakReference.get();
      label397:
      if (!apxc.a(paramString, (String)localObject1, (JSONObject)localObject5, this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString)) {
        break label590;
      }
      aqca.a(null, this.jdField_a_of_type_JavaLangString, "FullScreenOrH5ShowForAI", 0, 0, 0L, 0L, 0L, "", "");
      ...
      else
      {
        ...
        {
          l1 = nzv.a(localMessageForArkApp.ark_app_message.getAppIdFromMeta(), 0L);
          if (l1 != 0L) {
            break label581;
          }
          paramArrayOfVariantWrapper = "";
          label501:
          bdll.b(null, "dc00898", "", "", "0X800A86C", "0X800A86C", 0, 0, paramArrayOfVariantWrapper, "", "", "");
          paramArrayOfVariantWrapper = paramString;
        }
      }
    }
    ...
    for (;;)
    {
      ...
      aqca.a(null, this.jdField_a_of_type_JavaLangString, "FullScreenOrH5Show", 0, 0, 0L, 0L, 0L, "", "");
      return true;
      ...
      {
        if (!apuj.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.BROWSER"))
        {
        ...
        for (bool1 = true;; bool1 = false)
        {
          ...
          QLog.e("ArkApp.ArkAppQQModule", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.http appName=", this.jdField_a_of_type_JavaLangString, ",url=", noe.b(paramString, new String[0]), ", isValid set=true" });
          i = 1;
          j = 2;
          label847:
          aqfh.b(this.jdField_a_of_type_JavaLangString, paramString, k, j, agyw.c);
          aqca.b(a(), this.jdField_a_of_type_JavaLangString, paramString, 2);
          if (i != 0) {
            break label933;
          }
          QLog.d("ArkApp.ArkAppQQModule", 1, new Object[] { "ArkSafe.OpenUrl check url invalid!, url=", noe.b(paramString, new String[0]), ", app=", this.jdField_a_of_type_JavaLangString });
          return false;
          i = 0;
          break;
        }
        ...
        for (;;)
        {
          ...
          catch (JSONException paramArrayOfVariantWrapper)
          {
            ...
            paramArrayOfVariantWrapper = String.valueOf(l1);
            continue;
            apxt.a(localActivity, paramString, true, 0L, null, (String)localObject2, 0, this.jdField_a_of_type_JavaLangString, (String)localObject4);
            continue;
          }
          if (!(localObject3 instanceof ainh)) {
            continue;
          ...
          l1 = nzv.a(localMessageForArkApp.ark_app_message.getAppIdFromMeta(), 0L);
          apxt.a(localActivity, paramString, true, l1, localMessageForArkApp, (String)localObject2, 0, this.jdField_a_of_type_JavaLangString, (String)localObject4);
          ...
          if (localMessageForArkApp.buildTypeAndTitle().isSdkShare)
          {
            ...
            paramArrayOfVariantWrapper = "";
            bdll.b(null, "dc00898", "", "", "0X800A869", "0X800A869", 0, 0, paramArrayOfVariantWrapper, "", "", "");
          }
          paramArrayOfVariantWrapper = paramString;
          break;
          paramVariantWrapper = paramString + "&" + paramArrayOfVariantWrapper;
      ...
      if (this.jdField_a_of_type_Long == 0L)
      {
        paramVariantWrapper = bhni.a(a(), localActivity, paramString);
        paramArrayOfVariantWrapper = paramString;
        if (paramVariantWrapper != null)
        {
          ...
          for (bool1 = true;; bool1 = false)
          {
            ...
            QLog.e("ArkApp.ArkAppQQModule", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.jump appName=", this.jdField_a_of_type_JavaLangString, ",url=", noe.b(paramString, new String[0]), ", isValid set=true" });
            i = 1;
            j = 2;
            aqfh.b(this.jdField_a_of_type_JavaLangString, paramString, k, j, agyw.c);
            if (i == 0) {
          ...
          label1645:
          QLog.e("ArkApp.ArkAppQQModule", 1, new Object[] { "ArkSafe.OpenUrl check url invalid, url=", noe.b(paramString, new String[0]), ", app=", this.jdField_a_of_type_JavaLangString });
          paramArrayOfVariantWrapper = paramString;
        }
      }
    }
    if (paramString.equals("OpenVideo"))
    {
      ...
      try
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) && ((((String)localObject1).equalsIgnoreCase("http")) || (((String)localObject1).equalsIgnoreCase("https"))))
        {
          ...
          paramVariantWrapper.SetBool(true);
          apxt.a(paramString, paramArrayOfVariantWrapper);
          aqca.a(a(), this.jdField_a_of_type_JavaLangString, "AIOArkOpenVideo", 1, 0, 0L, 0L, 0L, paramArrayOfVariantWrapper, "");
        }
        return true;
      }
    ...
    if (paramString.equals("Report"))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          bdll.b(paramString, "CliOper", "", "", "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), paramVariantWrapper, paramArrayOfVariantWrapper, "");
          aqca.a(paramString, this.jdField_a_of_type_JavaLangString, paramArrayOfVariantWrapper, i);
          return true;
        }
        catch (Exception paramVariantWrapper)
        {
          bdll.b(paramString, "CliOper", "", "", "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), "0", paramArrayOfVariantWrapper, "");
          continue;
        }
        label2068:
        bdll.b(paramString, "CliOper", "", "", "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), "0", paramArrayOfVariantWrapper, "");
    ...
    if (paramString.equals("ReportEx"))
    {
      ...
      if (paramVariantWrapper.equals("898")) {
        try
        {
          ...
          bdll.b(null, "dc00898", "", (String)localObject1, paramArrayOfVariantWrapper, paramVariantWrapper, i, j, k, Integer.toString(m), Integer.toString(n), (String)localObject2, (String)localObject3);
          return true;
        }
        catch (JSONException paramArrayOfVariantWrapper)
        {
    ...
    {
      paramArrayOfVariantWrapper = bhlo.c();
    ...
    if (paramString.equals("GetNickName"))
    {
      ...
      for (paramString = paramArrayOfVariantWrapper[0].GetString();; paramString = ((QQAppInterface)localObject2).getCurrentAccountUin())
      {
        ...
        {
          localObject1 = null;
          if (!TextUtils.isEmpty(agyw.jdField_a_of_type_JavaLangString)) {
            localObject1 = bhlg.h((QQAppInterface)localObject2, agyw.jdField_a_of_type_JavaLangString, paramString);
          }
          ...
          {
            localObject1 = bhlg.q((QQAppInterface)localObject2, paramString);
            paramArrayOfVariantWrapper = (ark.VariantWrapper[])localObject1;
            if (TextUtils.isEmpty((CharSequence)localObject1)) {
              paramArrayOfVariantWrapper = bhlg.a((QQAppInterface)localObject2, paramString, 0);
            }
          }
      ...
      label2843:
      paramString = apxv.a(paramString);
    ...
    if (paramString.equals("GetContainerInfo"))
    {
      ...
      if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1) && (paramArrayOfVariantWrapper[0].IsView()))
      {
        ...
        paramString = (agyw)agyw.a(paramString).get();
        if ((paramString == null) || (!(paramString instanceof agyv))) {
          break label7564;
        }
        paramArrayOfVariantWrapper = ((agyv)paramString).a();
        paramString = paramArrayOfVariantWrapper;
        if (paramArrayOfVariantWrapper == null) {
          paramString = a();
        }
    ...
    else
    {
      ...
      {
        paramVariantWrapper.CreateObject("DataRequest", new ahak(a(), this.jdField_a_of_type_JavaLangString));
        return true;
      }
      if (paramString.equals("GetPerformance"))
      {
        ...
        for (;;)
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            paramArrayOfVariantWrapper = agyv.a(paramString);
      ...
      {
        if ((this.jdField_a_of_type_Agzq == null) || (paramArrayOfVariantWrapper == null) || (paramArrayOfVariantWrapper.length < 1) || (paramArrayOfVariantWrapper[0] == null) || (!paramArrayOfVariantWrapper[0].IsFunction())) {
          return false;
        }
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Agzq.b(new apwo(this, l1));
        return true;
      }
      if (paramString.equals("WatchPosition"))
      {
        ...
        l1 = a(paramArrayOfVariantWrapper[0].Copy());
        this.jdField_a_of_type_Agzq.a(new apwq(this, l1));
        return true;
      }
      ...
      if (paramString.equals("GetCurrentAddress"))
      {
        ...
        l1 = a(paramArrayOfVariantWrapper[0].Copy());
        this.jdField_a_of_type_Agzq.a(new apwu(this, l1), true);
        return true;
      }
      if (paramString.equals("SendMessage"))
      {
        ...
        do
        {
          try
          {
            ...
            if (TextUtils.isEmpty(((ArkAppMessage)localObject2).promptText)) {
              ((ArkAppMessage)localObject2).promptText = String.format(anzj.a(2131699557), new Object[] { ((ArkAppMessage)localObject2).appDesc });
            }
            ...
            if (bool1)
            {
              if (paramString != null)
              {
                aean.b(a(), paramString, (ArkAppMessage)localObject2);
                if (QLog.isColorLevel()) {
        ...
        if (bool1)
        {
          ...
          paramString = bcry.a(a(), a().c(), paramString.jdField_a_of_type_JavaLangString, paramString.b, paramString.jdField_a_of_type_Int, (byte)1, (byte)0, (short)0, paramVariantWrapper);
      ...
      else
      {
        if (paramString.equals("GetPskeyAsync"))
        {
          ...
          apxv.a(paramArrayOfVariantWrapper[0].GetString(), new apwv(this, a(paramArrayOfVariantWrapper[1].Copy())));
          return true;
        }
        if (paramString.equals("Login"))
        {
          if (!apuj.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.LOGIN"))
          {
          ...
          for (;;)
          {
            try
            {
              ...
              if (paramString == null)
              {
                ...
                apvy.a(paramString, this.jdField_a_of_type_JavaLangString, "ark_authority_api_login", BaseApplicationImpl.getContext().getString(2131690097), new apww(this, l2, paramString, l1));
                return true;
              }
            }
        ...
        {
          if (!apuj.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.USER_INFORMATION"))
          {
          ...
          {
            apvy.a(paramString, this.jdField_a_of_type_JavaLangString, "ark_authority_api_user_info", BaseApplicationImpl.getContext().getString(2131690098), new apwx(this, l1, paramString));
            return true;
          }
        }
        if (paramString.equals("TestGetJson")) {
        ...
        {
          if (!apuj.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.OPENVIEW")) {
            return false;
          }
        ...
        {
          if (!apuj.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.SHARE")) {
            return false;
          }
        ...
        {
          if (!apuj.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.STATUSBAR")) {
            return false;
          }
        ...
        if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length == 1))
        {
          ...
          if (paramString != null) {
            for (;;)
            {
              ...
              localObject1 = arca.b(380).a();
              paramArrayOfVariantWrapper = "";
              paramString = paramArrayOfVariantWrapper;
              if (localObject1 != null)
              {
                paramString = paramArrayOfVariantWrapper;
                if (((arbz)localObject1).a() != null) {
                  paramString = ((arbz)localObject1).a().b;
                }
              }
              localObject1 = a();
              paramArrayOfVariantWrapper = paramString;
              if (TextUtils.isEmpty(paramString))
              {
                paramArrayOfVariantWrapper = paramString;
                if (localObject1 != null) {
                  paramArrayOfVariantWrapper = ((Activity)localObject1).getString(2131690134);
                }
              }
      ...
      else if (paramString.equals("GetNickNameByView"))
      {
        ...
        if (localObject2 != null)
        {
          ...
          if (l2 != 0L)
          {
            ...
            paramString = (agyw)agyw.a(paramString).get();
            if (!(paramString instanceof agyv)) {
              break label7530;
            }
            paramArrayOfVariantWrapper = ((agyv)paramString).a();
            paramString = paramArrayOfVariantWrapper;
          ...
          while (!TextUtils.isEmpty((CharSequence)localObject1))
          {
            ...
            paramArrayOfVariantWrapper = bhlg.a((QQAppInterface)localObject2, paramArrayOfVariantWrapper, ((String)localObject1).equals(((QQAppInterface)localObject2).c()), (String)localObject1);
            if (paramArrayOfVariantWrapper != null)
            {
              paramString = paramArrayOfVariantWrapper;
            ...
            {
              paramArrayOfVariantWrapper = bhlg.q((QQAppInterface)localObject2, (String)localObject1);
              paramString = paramArrayOfVariantWrapper;
              if (TextUtils.isEmpty(paramArrayOfVariantWrapper)) {
                paramString = bhlg.a((QQAppInterface)localObject2, (String)localObject1, 0);
              }
            }
            paramVariantWrapper.SetString(paramString);
        ...
        else
        {
          ...
          paramVariantWrapper.SetString(apxv.a(paramString, l2));
          return true;
        }
      }
      else
      {
        if (paramString.equals("GetAppInfo"))
        {
          ...
          try
          {
            ...
            ((JSONObject)localObject1).put("name", BaseApplicationImpl.getApplication().getString(2131690062));
            paramArrayOfVariantWrapper = bhlo.c();
            paramString = paramArrayOfVariantWrapper;
            if (TextUtils.isEmpty(paramArrayOfVariantWrapper)) {
              paramString = "8.4.5";
        ...
        if (paramString.equals("SubscribePublicAccount"))
        {
          ...
          try
          {
            ...
            if ((int)paramArrayOfVariantWrapper[1].GetDouble() == 0) {
              aank.a(BaseApplicationImpl.getContext(), paramString, new apwr(this, l1));
            } else {
              aank.c(BaseApplicationImpl.getContext(), paramString, new apws(this, l1));
            }
          }
          catch (Exception paramString)
          {
  ...
  public void a(List<apzv> paramList)
  {
    super.a(paramList);
    a("OpenUrl", 1L, 500L);
  ...
  protected apwd[] a()
  {
    return new apwd[] { new apxa(null), new apwz(null), new apwy(null) };
  }
}
