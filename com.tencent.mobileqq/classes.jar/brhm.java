...
public class brhm
{
  private static brhm jdField_a_of_type_Brhm;
  ...
  public static brhm a()
  {
    if (jdField_a_of_type_Brhm == null) {}
    try
    {
      if (jdField_a_of_type_Brhm == null) {
        jdField_a_of_type_Brhm = new brhm();
      }
      return jdField_a_of_type_Brhm;
    }
    finally {}
  }
        ...
        if (localObject != null)
        {
          ...
          if (k > 0)
          {
            ...
            while (i < k)
            {
              ...
              {
                zqd.jdField_a_of_type_JavaLangString = localJSONObject1.getString("downloadInfo");
                if (QLog.isColorLevel()) {
                  QLog.e(jdField_a_of_type_JavaLangString, 2, "QIMBeautyManager WeishiGuideUtils.DOWNLOAD_JSON=  " + zqd.jdField_a_of_type_JavaLangString);
                }
              }
              i += 1;
            }
