  ...
  implements ayll
{
  ...
  public static ayll asInterface(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.mobileqq.theme.IDownloadListener");
    if ((localIInterface != null) && ((localIInterface instanceof ayll))) {
      return (ayll)localIInterface;
    }
    return new ayln(paramIBinder);
  }
