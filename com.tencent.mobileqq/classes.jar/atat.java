  ...
  implements Manager
{
  ...
  ajuc jdField_a_of_type_Ajuc;
  akav jdField_a_of_type_Akav = new atav(this);
  akgi jdField_a_of_type_Akgi = new atau(this);
  aszg jdField_a_of_type_Aszg;
  protected baxk a;
  bayr jdField_a_of_type_Bayr;
  bays jdField_a_of_type_Bays;
  public QQAppInterface a;
  public ArrayList<String> a;
  protected HashSet<String> a;
  List<atgf> jdField_a_of_type_JavaUtilList = new ArrayList();
  MqqHandler jdField_a_of_type_MqqOsMqqHandler;
  int jdField_b_of_type_Int = -2147483648;
  List<atgf> jdField_b_of_type_JavaUtilList = new ArrayList();
  MqqHandler jdField_b_of_type_MqqOsMqqHandler;
  
  public atat(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(String paramString)
  {
    if (QLog.isColorLevel()) {
      atbp.a("delAccountRecord", new Object[] { paramString });
    }
    ...
    atbg.a(paramString, "history_valid", Boolean.valueOf(false));
  }
  ...
  public Message a(Context arg1, Message paramMessage)
  {
    ...
    case 4143: 
      ...
      localObject = ((alyz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(180)).b(i, (String)localObject);
      if (localObject == null) {
        return null;
      }
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Baxk == null)
      {
        ...
        this.jdField_a_of_type_Baxk.a(new atax(this));
      }
      localObject = this.jdField_a_of_type_Baxk.a(i, paramMessage, 200);
      if (localObject == null) {
        synchronized (this.jdField_a_of_type_JavaUtilHashSet)
        {
          this.jdField_a_of_type_JavaUtilHashSet.add(paramMessage);
          this.jdField_a_of_type_Baxk.a(paramMessage, i, true);
          return null;
        }
      }
  ...
  public aszg a()
  {
    try
    {
      if (this.jdField_a_of_type_Aszg == null) {
        this.jdField_a_of_type_Aszg = new aszg();
      }
      aszg localaszg = this.jdField_a_of_type_Aszg;
      return localaszg;
    }
    finally {}
  }
  
  public bayr a(boolean paramBoolean)
  {
    try
    {
      if ((this.jdField_a_of_type_Bayr == null) && (paramBoolean)) {
        this.jdField_a_of_type_Bayr = new bayr(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      bayr localbayr = this.jdField_a_of_type_Bayr;
      return localbayr;
    }
    finally {}
  }
  ...
  public bays a()
  {
    try
    {
      if (this.jdField_a_of_type_Bays == null) {
        this.jdField_a_of_type_Bays = new bays(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      bays localbays = this.jdField_a_of_type_Bays;
      return localbays;
    }
    finally {}
  }
  ...
  public String a()
  {
    ...
    if (TextUtils.isEmpty(str)) {
      localObject = BaseApplication.getContext().getResources().getString(2131698888);
    }
    return localObject;
  }
  ...
  public String a(String paramString)
  {
    ...
    for (;;)
    {
      localObject = str;
      if (str == null) {
        localObject = BaseApplication.getContext().getResources().getString(2131698738);
      }
      return ((String)localObject).replace("%", paramString);
      anmg.b("getFirstAIOTips", new Object[] { "datingConfig is null" });
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        atbp.a("realHasUnreadMsg", new Object[] { Integer.valueOf(paramInt), Boolean.valueOf(ConnectNearbyProcService.a()) });
      }
      return;
      atas.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), 3);
      atay localatay = new atay(this, paramInt);
      localatay.a = true;
      a(localatay);
    }
  }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    try
    {
      ...
      {
        localObject = (atgf)this.jdField_a_of_type_JavaUtilList.get(i);
        this.jdField_a_of_type_MqqOsMqqHandler.post(new NearbyProxy.5(this, (atgf)localObject, paramInt, paramVarArgs));
        i += 1;
      }
      if (paramInt == 4124)
      {
        ...
        {
          atgf localatgf = (atgf)((Iterator)localObject).next();
          if ((localatgf != null) && (localatgf.a)) {
    ...
    try
    {
      ...
      {
        localObject = (atgf)this.jdField_b_of_type_JavaUtilList.get(i);
        this.jdField_b_of_type_MqqOsMqqHandler.post(new NearbyProxy.6(this, (atgf)localObject, paramInt, paramVarArgs));
        i += 1;
      }
      if (paramInt == 4124)
      {
        ...
        {
          localObject = (atgf)paramVarArgs.next();
          if ((localObject != null) && (((atgf)localObject).a)) {
            paramVarArgs.remove();
          }
        }
      }
  ...
  public void a(atgf paramatgf)
  {
    a(paramatgf, false);
  }
  
  public void a(atgf paramatgf, boolean paramBoolean)
  {
    if (paramatgf == null) {
      return;
    }
    if (paramBoolean) {
      ...
      {
        if (!this.jdField_b_of_type_JavaUtilList.contains(paramatgf)) {
          this.jdField_b_of_type_JavaUtilList.add(paramatgf);
        }
        return;
      }
    }
    ...
    {
      if (!this.jdField_a_of_type_JavaUtilList.contains(paramatgf)) {
        this.jdField_a_of_type_JavaUtilList.add(paramatgf);
      }
      return;
    }
  }
  ...
  public void a(String paramString, Oidb_0x686.NearbyRankConfig paramNearbyRankConfig, Oidb_0x686.NearbyFeedConfig paramNearbyFeedConfig, Oidb_0x686.CharmEvent paramCharmEvent, Oidb_0x686.NearbyCharmNotify paramNearbyCharmNotify)
  {
    ...
    aszd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramCharmEvent, paramNearbyCharmNotify);
    int i;
  ...
  {
    atbp.a("Q.nearby", "updateNearbyCard", new Object[] { paramRspBody });
    ...
    do
    {
      ...
      for (paramRspBody = paramRspBody.rpt_msg_tags.get();; paramRspBody = null)
      {
        ...
        {
          localObject2 = atfk.a((appoint_define.InterestTag)paramRspBody.get(i));
      ...
      localaukn = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()).createEntityManager();
      Object localObject2 = (NearbyPeopleCard)localaukn.a(NearbyPeopleCard.class, "uin=?", new String[] { this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() });
  ...
  public void a(SubMsgType0x27.AppointmentNotify paramAppointmentNotify)
  {
    ...
    for (boolean bool = b();; bool = true)
    {
      ...
      {
        atbp.a("hasOnLinePush", new Object[] { Boolean.valueOf(bool), Integer.valueOf(paramAppointmentNotify.uint32_notifytype.get()), Boolean.valueOf(ConnectNearbyProcService.a()) });
        return;
        label97:
        atas.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), 4);
        ataz localataz = new ataz(this, paramAppointmentNotify);
        localataz.a = true;
        a(localataz);
      }
      break;
  ...
  public void a(boolean paramBoolean)
  {
    boolean bool = false;
    int i = 1;
    anmg.b("setNearbyDatingMsg", new Object[] { Boolean.valueOf(paramBoolean), Integer.valueOf(this.jdField_a_of_type_Int) });
    if ((this.jdField_a_of_type_Int == 1) || (this.jdField_a_of_type_Int == 3)) {
      bool = true;
    }
    if ((this.jdField_a_of_type_Int == 0) || (bool != paramBoolean)) {
      atbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "dating_recv_msg", Boolean.valueOf(paramBoolean));
    }
    if (paramBoolean) {}
    for (;;)
    {
  ...
  public boolean a()
  {
    if (this.jdField_a_of_type_Int == 0) {
      if (!atbg.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
        break label45;
      }
    }
    label45:
  ...
  public Object[] a(Context paramContext, int paramInt, Object... paramVarArgs)
  {
    ...
    //   301: iconst_0
    //   302: aload_0
    //   303: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   306: bipush 71
    //   308: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   311: checkcast 662	anme
    //   314: invokevirtual 665	anme:a	()Lannc;
    //   317: aload_3
    //   318: iconst_0
    //   319: aaload
    ...
    //   341: invokevirtual 673	annc:a	(Ljava/lang/String;IZ)Ljava/lang/String;
    //   344: aastore
    //   345: areturn
    //   346: aload_0
    //   347: iconst_0
    //   348: aload_3
    //   349: invokevirtual 675	atat:a	(Z[Ljava/lang/Object;)V
    //   352: aconst_null
    //   353: areturn
    //   354: aload_0
    //   355: iconst_1
    //   356: aload_3
    //   357: invokevirtual 675	atat:a	(Z[Ljava/lang/Object;)V
    //   360: aconst_null
    //   361: areturn
    //   362: new 677	com/tencent/mobileqq/nearby/NearbyProxy$1
    //   365: dup
    //   366: aload_0
    //   367: invokespecial 678	com/tencent/mobileqq/nearby/NearbyProxy$1:<init>	(Latat;)V
    //   370: aconst_null
    //   371: iconst_1
    ...
    //   386: iconst_0
    //   387: aload_0
    //   388: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   391: bipush 36
    //   393: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   396: checkcast 684	avpq
    //   399: aload_3
    //   400: iconst_0
    //   401: aaload
    //   402: checkcast 403	java/lang/String
    //   405: invokevirtual 687	avpq:a	(Ljava/lang/String;)Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo;
    ...
    //   472: istore 4
    //   474: aload_0
    //   475: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   478: aload_3
    //   479: iconst_0
    //   480: aaload
    ...
    //   517: invokestatic 698	atyq:a	(Lcom/tencent/common/app/AppInterface;IILjava/lang/String;Ljava/lang/String;Z)Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$AppInfo;
    //   520: astore_1
    //   521: iload 4
    //   523: ifeq -239 -> 284
    //   526: iconst_1
    ...
    //   554: iconst_0
    //   555: aload_0
    //   556: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   559: aload_1
    //   560: invokestatic 703	ahpf:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Z
    ...
    //   617: istore 5
    //   619: aload_0
    //   620: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   623: aload_1
    //   624: aload 6
    //   626: iload_2
    //   627: iload 4
    //   629: iload 5
    //   631: invokestatic 708	akoj:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;IZZ)V
    //   634: aconst_null
    //   635: areturn
    //   636: aload_3
    //   637: ifnull -353 -> 284
    ...
    //   664: istore_2
    //   665: aload_0
    //   666: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   669: aload_1
    //   670: aload 6
    //   672: iload_2
    //   673: invokestatic 711	akoj:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;I)V
    //   676: aconst_null
    //   677: areturn
    //   678: aload_3
    //   679: ifnull +9 -> 688
    ...
    //   699: areturn
    //   700: aload_0
    //   701: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   704: aload_0
    //   705: getfield 59	atat:jdField_a_of_type_Akav	Lakav;
    //   708: invokevirtual 715	com/tencent/mobileqq/app/QQAppInterface:addObserver	(Lajtg;)V
    //   711: aload_0
    //   712: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   715: iconst_0
    //   716: invokevirtual 718	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtd;
    ...
    //   777: areturn
    //   778: aload_0
    //   779: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   782: aload_0
    //   783: getfield 59	atat:jdField_a_of_type_Akav	Lakav;
    //   786: invokevirtual 715	com/tencent/mobileqq/app/QQAppInterface:addObserver	(Lajtg;)V
    //   789: aload_0
    //   790: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   793: iconst_0
    //   794: invokevirtual 718	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtd;
    ...
    //   837: iconst_0
    //   838: aload_0
    //   839: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   842: bipush 16
    //   844: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   847: checkcast 731	aser
    //   850: aload_3
    //   851: iconst_0
    //   852: aaload
    //   853: checkcast 403	java/lang/String
    //   856: invokevirtual 733	aser:a	(Ljava/lang/String;)Z
    ...
    //   943: pop
    //   944: aload_0
    //   945: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   948: aload 7
    //   950: aload 6
    //   952: aload_1
    //   953: invokestatic 530	aszd:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ltencent/im/oidb/cmd0x686/Oidb_0x686$CharmEvent;Ltencent/im/oidb/cmd0x686/Oidb_0x686$NearbyCharmNotify;)V
    //   956: aconst_null
    //   957: areturn
    //   958: astore_1
    //   959: aconst_null
    ...
    //   1001: aload_0
    //   1002: aload_1
    //   1003: invokevirtual 746	atat:a	(Ltencent/im/oidb/cmd0x9c7/cmd0x9c7$RspBody;)V
    //   1006: aconst_null
    //   1007: areturn
    //   1008: astore_3
    //   1009: aconst_null
    ...
    //   1052: aload_0
    //   1053: iload 4
    //   1055: invokevirtual 757	atat:a	(Z)V
    //   1058: aconst_null
    //   1059: areturn
    //   1060: aload_0
    //   1061: getfield 358	atat:jdField_a_of_type_Aszg	Laszg;
    //   1064: ifnull -780 -> 284
    //   1067: aload_0
    //   1068: getfield 358	atat:jdField_a_of_type_Aszg	Laszg;
    //   1071: invokevirtual 759	aszg:a	()V
    //   1074: aconst_null
    //   1075: areturn
    //   1076: aload_3
    //   1077: ifnull -793 -> 284
    ...
    //   1127: pop
    //   1128: aload_0
    //   1129: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1132: bipush 106
    //   1134: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1137: checkcast 527	aszd
    //   1140: astore_3
    //   1141: aload_3
    //   1142: ifnull -858 -> 284
    //   1145: aload_3
    //   1146: aload_1
    //   1147: invokevirtual 766	aszd:a	(Ltencent/im/oidb/cmd0x8dd/oidb_0x8dd$SelfInfo;)V
    //   1150: aconst_null
    //   1151: areturn
    //   1152: astore_1
    //   1153: aload_1
    ...
    //   1158: areturn
    //   1159: aload_0
    //   1160: getfield 768	atat:jdField_a_of_type_Ajty	Lajty;
    //   1163: ifnonnull +19 -> 1182
    //   1166: aload_0
    //   1167: aload_0
    //   1168: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1171: bipush 59
    //   1173: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1176: checkcast 770	ajty
    //   1179: putfield 768	atat:jdField_a_of_type_Ajty	Lajty;
    //   1182: aload_0
    //   1183: new 772	ataw
    //   1186: dup
    //   1187: aload_0
    //   1188: invokespecial 773	ataw:<init>	(Latat;)V
    //   1191: putfield 775	atat:jdField_a_of_type_Ajuc	Lajuc;
    //   1194: aload_0
    //   1195: getfield 768	atat:jdField_a_of_type_Ajty	Lajty;
    //   1198: aload_0
    //   1199: invokevirtual 778	ajty:a	(Ljava/lang/Object;)V
    //   1202: aload_0
    //   1203: getfield 768	atat:jdField_a_of_type_Ajty	Lajty;
    //   1206: aload_0
    //   1207: getfield 775	atat:jdField_a_of_type_Ajuc	Lajuc;
    //   1210: invokevirtual 780	ajty:c	(Ljava/lang/Object;)V
    //   1213: aconst_null
    //   1214: areturn
    //   1215: aload_3
    //   1216: ifnull -932 -> 284
    ...
    //   1231: astore_1
    //   1232: aload_0
    //   1233: getfield 768	atat:jdField_a_of_type_Ajty	Lajty;
    //   1236: ifnull +25 -> 1261
    //   1239: iconst_1
    ...
    //   1244: iconst_0
    //   1245: aload_0
    //   1246: getfield 768	atat:jdField_a_of_type_Ajty	Lajty;
    //   1249: aload_1
    //   1250: ldc_w 782
    //   1253: invokevirtual 786	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   1256: invokevirtual 789	ajty:a	([Ljava/lang/String;)[Ljava/lang/String;
    //   1259: aastore
    //   1260: areturn
    //   1261: aload_0
    //   1262: getfield 768	atat:jdField_a_of_type_Ajty	Lajty;
    //   1265: ifnull -981 -> 284
    //   1268: aload_0
    //   1269: getfield 768	atat:jdField_a_of_type_Ajty	Lajty;
    //   1272: aload_0
    //   1273: invokevirtual 791	ajty:b	(Ljava/lang/Object;)V
    //   1276: aload_0
    //   1277: getfield 775	atat:jdField_a_of_type_Ajuc	Lajuc;
    //   1280: ifnull -996 -> 284
    //   1283: aload_0
    //   1284: getfield 768	atat:jdField_a_of_type_Ajty	Lajty;
    //   1287: aload_0
    //   1288: getfield 775	atat:jdField_a_of_type_Ajuc	Lajuc;
    //   1291: invokevirtual 793	ajty:d	(Ljava/lang/Object;)V
    //   1294: aconst_null
    //   1295: areturn
    //   1296: aload_0
    //   1297: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1300: bipush 106
    //   1302: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1305: checkcast 527	aszd
    //   1308: iconst_1
    //   1309: putfield 794	aszd:a	Z
    //   1312: aconst_null
    //   1313: areturn
    //   1314: aload_3
    ...
    //   1324: aload_0
    //   1325: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1328: sipush 160
    //   1331: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1334: checkcast 796	atxb
    //   1337: aload_3
    //   1338: iconst_0
    //   1339: aaload
    //   1340: checkcast 424	java/lang/Integer
    //   1343: invokevirtual 648	java/lang/Integer:intValue	()I
    //   1346: invokevirtual 799	atxb:a	(I)Lcom/tencent/mobileqq/nearby/redtouch/RedTouchItem;
    //   1349: astore_1
    //   1350: aload_1
    ...
    //   1496: astore_1
    //   1497: aload_0
    //   1498: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1501: sipush 180
    //   1504: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1507: checkcast 303	alyz
    //   1510: aload_1
    //   1511: invokevirtual 840	alyz:a	([B)V
    ...
    //   1542: astore_1
    //   1543: aload_0
    //   1544: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1547: bipush 106
    //   1549: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1552: checkcast 527	aszd
    //   1555: getfield 845	aszd:d	Ljava/util/concurrent/ConcurrentHashMap;
    //   1558: aload_1
    //   1559: iconst_1
    ...
    //   1631: dup
    //   1632: aload_0
    //   1633: invokespecial 871	com/tencent/mobileqq/nearby/NearbyProxy$3:<init>	(Latat;)V
    ...
    //   1658: aload_0
    //   1659: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1662: bipush 51
    //   1664: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1667: checkcast 876	ajxn
    //   1670: astore_1
    //   1671: aload_1
    ...
    //   1696: aload_1
    //   1697: aload_0
    //   1698: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1701: invokevirtual 598	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   1704: invokevirtual 890	ajxn:b	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Card;
    //   1707: astore_1
    //   1708: goto -31 -> 1677
    //   1711: aload_3
    //   1712: iconst_0
    ...
    //   1717: astore_1
    //   1718: aload_0
    //   1719: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1722: bipush 70
    //   1724: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1727: checkcast 892	mxx
    //   1730: astore_3
    //   1731: aload_1
    ...
    //   1816: goto -18 -> 1798
    //   1819: aload_3
    //   1820: invokevirtual 898	mxx:a	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo;
    //   1823: astore_1
    //   1824: goto -26 -> 1798
    //   1827: aload_3
    //   1828: invokevirtual 900	mxx:b	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo;
    //   1831: astore_1
    //   1832: goto -34 -> 1798
    //   1835: aconst_null
    //   1836: astore_1
    ...
    //   1842: goto -44 -> 1798
    //   1845: aload_3
    //   1846: invokevirtual 902	mxx:c	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo;
    //   1849: astore_1
    //   1850: goto -52 -> 1798
    //   1853: aload_3
    //   1854: invokevirtual 903	mxx:a	()Z
    //   1857: ifeq +14 -> 1871
    ...
    //   1873: goto -75 -> 1798
    //   1876: aload_3
    //   1877: invokevirtual 907	mxx:h	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo;
    //   1880: astore_1
    //   1881: goto -83 -> 1798
    //   1884: aload_3
    //   1885: invokevirtual 910	mxx:g	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo;
    //   1888: astore_1
    //   1889: goto -91 -> 1798
    //   1892: aconst_null
    //   1893: astore_1
    //   1894: goto -96 -> 1798
    //   1897: aload_3
    //   1898: invokevirtual 912	mxx:e	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$RedTypeInfo;
    //   1901: astore_1
    //   1902: goto -104 -> 1798
    //   1905: aload_3
    //   1906: iconst_0
    ...
    //   1911: astore_1
    //   1912: aload_0
    //   1913: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1916: bipush 70
    //   1918: invokevirtual 301	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   1921: checkcast 892	mxx
    //   1924: aload_1
    //   1925: invokevirtual 648	java/lang/Integer:intValue	()I
    //   1928: invokevirtual 914	mxx:a	(I)V
    //   1931: aconst_null
    //   1932: areturn
    //   1933: aload_3
    //   1934: iconst_0
    ...
    //   1945: iconst_0
    //   1946: aload_0
    //   1947: getfield 61	atat:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   1950: aload_1
  ...
  public void b()
  {
    ...
    {
      if (QLog.isColorLevel()) {
        atbp.a("hasUnreadMsg", new Object[] { Boolean.valueOf(ConnectNearbyProcService.a()) });
      }
      return;
  ...
  public boolean b()
  {
    if (this.jdField_b_of_type_Int == -2147483648) {
      if (!atbg.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
        break label39;
      }
    }
    label39:
