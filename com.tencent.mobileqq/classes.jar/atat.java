  ...
  extends atbl
{
  ...
  atat(atan paramatan, MessageRecord paramMessageRecord)
  {
    super(paramatan);
  ...
  void a(String paramString, int paramInt, atbj paramatbj)
  {
    ...
    atan.a(this.jdField_a_of_type_Atan).a().a().a(paramString, paramInt, this.b, this.c, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, 102, new atau(this, paramString, paramatbj));
  }
}
