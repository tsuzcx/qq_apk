...
{
  public sot(DiscussionInfoCardActivity paramDiscussionInfoCardActivity) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong1, String paramString1, String paramString2, long paramLong2)
  {
    ...
    if (!paramBoolean)
    {
      ...
      for (;;)
      {
        this.a.a(2130838748, paramString1);
        return;
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong, ArrayList paramArrayList)
  {
    if ((paramBoolean) && (paramLong == Long.valueOf(DiscussionInfoCardActivity.a(this.a)).longValue()))
    {
      ...
      this.a.a(2, this.a.getString(2131435298));
    }
  }
  ...
  protected void a(boolean paramBoolean, Long paramLong)
  {
    ...
    if ((paramBoolean) && (paramLong != null) && (String.valueOf(paramLong).equals(DiscussionInfoCardActivity.a(this.a))))
    {
      ...
      if (!this.a.isFinishing())
      {
        ...
        {
          this.a.jdField_a_of_type_AndroidAppDialog = DialogUtil.b(this.a, 230, this.a.getString(2131435968), this.a.getString(2131435969), 2131433029, 2131436340, new sou(this), null);
  ...
  protected void a(boolean paramBoolean, Long paramLong1, Long paramLong2)
  {
    ...
    QQToast.a(this.a, 1, this.a.getString(2131434010), 0).b(this.a.getTitleBarHeight());
  }
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    if (DiscussionInfoCardActivity.a(this.a).equals(paramString))
    {
      ...
      {
        DiscussionInfoCardActivity.a(this.a).a(this.a.getString(2131435295));
        DiscussionInfoCardActivity.a(this.a).d(2130838759);
    ...
    DiscussionInfoCardActivity.a(this.a).a(this.a.getString(2131435296));
    DiscussionInfoCardActivity.a(this.a).d(2130838759);
    DiscussionInfoCardActivity.a(this.a).b(false);
    this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessageDelayed(17, 1500L);
  }
  ...
  protected void a(Object[] paramArrayOfObject)
  {
    ...
    if ((paramArrayOfObject == null) || (paramArrayOfObject.trim().equals(""))) {
      paramArrayOfObject = this.a.getString(2131435304);
    }
    for (;;)
    {
      ...
      {
        if ((10001 == i) || (10002 == i)) {
          DialogUtil.a(this.a, 230, null, paramArrayOfObject, new sov(this, str), null).show();
        }
      }
      else {
        return;
  ...
  protected void b(boolean paramBoolean, String paramString)
  {
    if (DiscussionInfoCardActivity.a(this.a).equals(paramString))
    {
      ...
      if ((DiscussionInfoCardActivity.a(this.a) != null) && (DiscussionInfoCardActivity.a(this.a).isShowing()) && (!this.a.isFinishing()))
      {
        DiscussionInfoCardActivity.a(this.a).a(this.a.getString(2131435302));
        DiscussionInfoCardActivity.a(this.a).d(2130838759);
        DiscussionInfoCardActivity.a(this.a).b(false);
    ...
    DiscussionInfoCardActivity.a(this.a).a(this.a.getString(2131435303));
    DiscussionInfoCardActivity.a(this.a).d(2130838748);
    DiscussionInfoCardActivity.a(this.a).b(false);
    this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessageDelayed(17, 1500L);
  }
}
