  ...
  implements Manager
{
  ...
  public bbbq(AppInterface paramAppInterface)
  {
  ...
  private void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      setChanged();
      if (i != 0) {
        aocj.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface);
      }
      return;
      ...
      try
      {
        ...
        if ((localTimeRspBody != null) && (localTimeRspBody.rptMsgAppInfo.has()))
        {
          ...
          if (i < localTimeRspBody.rptMsgAppInfo.size())
          {
            ...
            localObject = (bcvc)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.GAMECENTER_MANAGER);
            if (localObject != null) {
              ((bcvc)localObject).a(paramString);
            }
          }
        }
        b(localTimeRspBody);
    ...
    for (QQAppInterface localQQAppInterface = (QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface;; localQQAppInterface = null)
    {
      ...
      for (;;)
      {
        ...
        catch (Exception paramArrayOfByte)
        {
          ...
          {
            ((aocj)localQQAppInterface.getBusinessHandler(BusinessHandlerFactory.REDPOINT_HANDER)).a(true, true, paramInt);
            return;
          }
  ...
  private void b(BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    for (int i = 1;; i = 2)
    {
      bdla.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00899", "Grp_tribe", "", "dynamic", "Clk_tribe", 0, 0, i + "", "", "", "");
      ...
      a(qxp.a("OidbSvc.0xd40_0", 3392, 0, paramAppInfo.toByteArray()));
      return;
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((j != 0) && (k > 0))
        {
          ...
          a((long[])localObject2, "QQCircleRedCircle", new bbbr(this, paramOnGetQQCircleNumRedMsgListener, m));
          return m;
        }
        if (paramOnGetQQCircleNumRedMsgListener == null) {
          break label375;
  ...
  public BusinessInfoCheckUpdate.RedTypeInfo a(int paramInt, String paramString, List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      if ((!a(paramInt, localList2, localAppInfo)) && ((TextUtils.isEmpty(paramString)) || (localAppInfo.id_list.get().contains(Long.valueOf(paramString)))))
      {
        ...
        if ((localRedTypeInfo != null) && ((localAppInfo.uiAppId.get() != 100510) || (localRedTypeInfo.red_type.get() != 5) || (a(localAppInfo))))
        {
          if (localObject1 != null)
          {
            localObject2 = localObject1;
  ...
  public BusinessInfoCheckUpdate.RedTypeInfo a(QQAppInterface paramQQAppInterface, boolean paramBoolean, Map<Long, LebaPluginInfo> paramMap)
  {
    ...
    for (;;)
    {
      ...
      else if (!anxo.a(paramQQAppInterface, localAppInfo.uiAppId.get(), paramBoolean, paramMap))
      {
    ...
    if (paramArrayOfByte != null) {
      try
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          if ((a(localNumRedBusiInfo)) && (bbbt.a(localNumRedBusiInfo))) {
  ...
  public void a(long[] paramArrayOfLong, String paramString, bbbk parambbbk)
  {
    ((bbbl)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.NUMREDMSG_MANAGER)).a(paramArrayOfLong, paramString, parambbbk);
  }
  ...
  public boolean a(BusinessInfoCheckUpdate.TimeRspBody paramTimeRspBody)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 38	bbbq:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   4: invokevirtual 192	com/tencent/common/app/AppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   7: astore 5
    //   9: aload_0
    //   10: getfield 36	bbbq:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   13: astore 4
    //   15: aload 4
    //   17: monitorenter
    //   18: aload_1
    //   19: invokevirtual 1258	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody:toByteArray	()[B
    //   22: astore 6
    //   24: aload 4
    //   26: monitorexit
    //   27: getstatic 31	bbbq:jdField_b_of_type_JavaLangObject	Ljava/lang/Object;
    //   30: astore 4
    //   32: aload 4
    //   34: monitorenter
    //   35: getstatic 26	bbbq:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   38: invokevirtual 1261	java/util/concurrent/atomic/AtomicInteger:incrementAndGet	()I
    //   41: istore_2
    //   42: new 823	java/io/File
    //   45: dup
    //   46: aload_0
    //   47: getfield 38	bbbq:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   50: invokevirtual 826	com/tencent/common/app/AppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   53: invokevirtual 832	mqq/app/MobileQQ:getFilesDir	()Ljava/io/File;
    ...
    //   77: invokespecial 837	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   80: invokevirtual 1264	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   83: aload 6
    //   85: iconst_0
    //   86: invokestatic 1268	com/tencent/mobileqq/utils/FileUtils:pushData2File	(Ljava/lang/String;[BZ)Z
    //   89: istore_3
    //   90: iload_3
    //   91: ifeq +89 -> 180
    //   94: getstatic 1271	bcvc:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   97: aload 5
    //   99: iconst_0
    //   100: invokestatic 1276	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   103: invokevirtual 1279	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   106: pop
    //   107: aload 4
    //   109: monitorexit
    //   110: aload_0
    //   111: getfield 36	bbbq:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   114: astore 4
    //   116: aload 4
    //   118: monitorenter
    //   119: iload_3
    //   120: ifeq +18 -> 138
    //   123: iload_2
    //   124: getstatic 26	bbbq:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   127: invokevirtual 1280	java/util/concurrent/atomic/AtomicInteger:get	()I
    //   130: if_icmpne +8 -> 138
    //   133: aload_0
    //   134: aload_1
    //   135: invokespecial 1282	bbbq:c	(Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;)V
    //   138: aload 4
    //   140: monitorexit
    //   141: iload_3
    //   142: ireturn
  ...
  public boolean b(int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 36	bbbq:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   4: astore_3
    //   5: aload_3
    //   6: monitorenter
    //   7: iload_1
    ...
    //   14: ireturn
    //   15: aload_0
    //   16: invokevirtual 83	bbbq:a	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;
    //   19: astore 4
    //   21: aload 4
    //   23: ifnonnull +7 -> 30
    //   26: aload_3
    ...
    //   85: if_icmpne -31 -> 54
    //   88: aload 5
    //   90: getfield 1367	com/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$NumRedInfo:flag	Lcom/tencent/mobileqq/pb/PBBoolField;
    //   93: invokevirtual 716	com/tencent/mobileqq/pb/PBBoolField:get	()Z
    //   96: istore_2
    //   97: aload_3
    //   98: monitorexit
    //   99: iload_2
