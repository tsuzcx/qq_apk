...
public class azfl
{
  ...
  @SuppressLint({"NewApi"})
  public static void a(View paramView, String paramString1, azfl paramazfl, String paramString2)
  {
    if ((paramView == null) || (paramazfl == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (a(paramazfl.jdField_o_of_type_Long))) {}
    do
    {
      do
      {
          ...
          do
          {
            do
            {
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                          do
                          {
                              ...
                              do
                              {
                                do
                                {
                                  do
                                  {
                                    ...
                                    {
                                      return;
                                      paramazfl = paramazfl.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
                                    } while (paramazfl == null);
                                    if ((!paramString1.equalsIgnoreCase("color")) || (!(paramView instanceof TextView))) {
                                      break;
                                    }
                                    paramView = (TextView)paramView;
                                    if ((paramazfl instanceof ColorStateList))
                                    {
                                      paramView.setTextColor((ColorStateList)paramazfl);
                                      return;
                                    }
                                  } while (!(paramazfl instanceof String));
                                  paramString1 = (String)paramazfl;
                            ...
                            if ((paramazfl instanceof Drawable))
                            {
                              paramString1 = ((Drawable)paramazfl).getConstantState().newDrawable();
                              paramazfl = new Rect();
                              paramString1.getPadding(paramazfl);
                              int i1 = paramView.getPaddingTop();
                              int i2 = paramazfl.top;
                              int i3 = paramView.getPaddingLeft();
                              int i4 = paramazfl.left;
                              int i5 = paramView.getPaddingRight();
                              int i6 = paramazfl.right;
                              int i7 = paramView.getPaddingBottom();
                              int i8 = paramazfl.bottom;
                              paramazfl = paramView.findViewById(2131374279);
                              if (Build.VERSION.SDK_INT >= 16)
                              {
                                paramView.setBackground(paramString1);
                                if (paramazfl != null) {
                                  paramazfl.setBackground(paramString1);
                                }
                              }
                              for (;;)
                              {
                                ...
                                if (paramazfl != null) {
                                  paramazfl.setBackgroundDrawable(paramString1);
                                }
                              }
                            }
                          } while (!(paramazfl instanceof String));
                      ...
                      } while (!(paramazfl instanceof Drawable));
                      paramView = (TextView)paramView;
                    } while (!(paramazfl instanceof Drawable));
                    paramView.setCompoundDrawablesWithIntrinsicBounds(((Drawable)paramazfl).getConstantState().newDrawable(), null, null, null);
                    return;
                ...
                paramView.setCompoundDrawablesWithIntrinsicBounds(null, null, ((Drawable)paramazfl).getConstantState().newDrawable(), null);
                return;
            ...
            paramView.setImageDrawable(((Drawable)paramazfl).getConstantState().newDrawable());
            return;
        ...
        paramView.setContentBackground(((Drawable)paramazfl).getConstantState().newDrawable());
        return;
        if ((!paramString1.equalsIgnoreCase("apngDrawable")) || (!(paramView instanceof ImageView))) {
          break;
        }
      } while (!(paramazfl instanceof Drawable));
      ((ImageView)paramView).setImageDrawable((Drawable)paramazfl);
      return;
    } while ((!paramString1.equalsIgnoreCase("shimmer_mask")) || (!(paramView instanceof ShimmerLinearLayout)) || (!(paramazfl instanceof BitmapDrawable)));
    paramString1 = (BitmapDrawable)paramazfl;
    paramazfl = (ShimmerLinearLayout)paramView;
  ...
  public Drawable a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject3 = bghy.a(paramQQAppInterface, -1L);
        localObject1 = str;
  ...
  public JSONObject a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    //   6: ldc_w 772
    //   9: astore 5
    //   11: invokestatic 519	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   14: ifeq +31 -> 45
    //   17: ldc_w 521
    //   20: iconst_2
    //   21: new 523	java/lang/StringBuilder
    //   24: dup
    //   25: invokespecial 524	java/lang/StringBuilder:<init>	()V
    //   28: ldc_w 774
    //   31: invokevirtual 530	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   34: aload 5
    //   36: invokevirtual 530	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   39: invokevirtual 533	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   42: invokestatic 536	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   45: lload_2
    //   46: lconst_1
    //   47: lcmp
    //   48: ifne +23 -> 71
    //   51: getstatic 776	azfl:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   54: ifnull +17 -> 71
    //   57: getstatic 776	azfl:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   60: astore_1
    //   61: aload_1
    //   62: areturn
    //   63: ldc_w 778
    ...
    //   73: lcmp
    //   74: ifeq +13 -> 87
    //   77: getstatic 780	azfl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   80: ifnull +7 -> 87
    //   83: getstatic 780	azfl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   86: areturn
    //   87: invokestatic 519	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   90: ifeq +31 -> 121
    //   93: ldc_w 521
    //   96: iconst_2
    //   97: new 523	java/lang/StringBuilder
    //   100: dup
    //   101: invokespecial 524	java/lang/StringBuilder:<init>	()V
    //   104: ldc_w 782
    //   107: invokevirtual 530	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   110: aload 5
    //   112: invokevirtual 530	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   115: invokevirtual 533	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   118: invokestatic 536	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   121: aload_1
    //   122: ldc2_w 549
    //   125: invokestatic 555	bghy:a	(Lcom/tencent/mobileqq/app/QQAppInterface;J)Ljava/lang/String;
    //   128: astore_1
    //   129: aload_1
    //   130: ifnull +142 -> 272
    //   133: aload_1
    //   134: invokevirtual 450	java/lang/String:length	()I
    //   137: ifle +135 -> 272
    //   140: new 523	java/lang/StringBuilder
    //   143: dup
    //   144: invokespecial 524	java/lang/StringBuilder:<init>	()V
    //   147: aload_1
    //   148: invokevirtual 530	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   151: getstatic 560	java/io/File:separator	Ljava/lang/String;
    //   154: invokevirtual 530	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   157: aload 5
    //   159: invokevirtual 530	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   162: invokevirtual 533	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   165: astore_1
    //   166: new 557	java/io/File
    //   169: dup
    //   170: aload_1
    //   171: invokespecial 783	java/io/File:<init>	(Ljava/lang/String;)V
    //   174: astore_1
    //   175: aload_1
    //   176: invokevirtual 786	java/io/File:exists	()Z
    //   179: ifeq +239 -> 418
    //   182: new 627	java/io/FileInputStream
    //   185: dup
    //   186: aload_1
    //   187: invokespecial 789	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   190: astore 5
    //   192: aload 5
    //   194: astore_1
    //   195: new 791	java/io/ByteArrayOutputStream
    //   198: dup
    //   199: invokespecial 792	java/io/ByteArrayOutputStream:<init>	()V
    //   202: astore 6
    //   204: aload 5
    //   206: astore_1
    //   207: sipush 4096
    ...
    //   221: iconst_0
    //   222: sipush 4096
    //   225: invokevirtual 798	java/io/InputStream:read	([BII)I
    //   228: istore 4
    //   230: iload 4
    //   232: iconst_m1
    ...
    //   243: iconst_0
    //   244: iload 4
    //   246: invokevirtual 802	java/io/ByteArrayOutputStream:write	([BII)V
    //   249: goto -35 -> 214
    //   252: astore 6
    //   254: aload 5
    //   256: astore_1
    //   257: aload 6
    //   259: invokevirtual 803	java/lang/Exception:printStackTrace	()V
    //   262: aload 5
    //   264: ifnull +8 -> 272
    //   267: aload 5
    //   269: invokevirtual 804	java/io/InputStream:close	()V
    //   272: aconst_null
    //   273: areturn
    //   274: aload 5
    //   276: astore_1
    ...
    //   280: dup
    //   281: aload 6
    //   283: invokevirtual 807	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   286: ldc_w 809
    //   289: invokespecial 812	java/lang/String:<init>	([BLjava/lang/String;)V
    //   292: astore 7
    //   294: aload 5
    //   296: astore 6
    //   298: aload 7
    ...
    //   309: astore_1
    //   310: aload 7
    //   312: invokevirtual 450	java/lang/String:length	()I
    //   315: ifle +106 -> 421
    //   318: lload_2
    //   319: lconst_1
    //   320: lcmp
    ...
    //   324: aload 5
    //   326: astore_1
    //   327: new 442	org/json/JSONObject
    //   330: dup
    //   331: aload 7
    //   333: invokespecial 813	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   336: putstatic 776	azfl:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   339: aload 5
    //   341: astore_1
    //   342: getstatic 776	azfl:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   345: astore 6
    //   347: aload 6
    //   349: astore_1
    //   350: aload 5
    //   352: ifnull -291 -> 61
    //   355: aload 5
    //   357: invokevirtual 804	java/io/InputStream:close	()V
    //   360: aload 6
    //   362: areturn
    //   363: astore_1
    //   364: aload_1
    //   365: invokevirtual 274	java/io/IOException:printStackTrace	()V
    //   368: aload 6
    //   370: areturn
    //   371: aload 5
    //   373: astore_1
    //   374: new 442	org/json/JSONObject
    //   377: dup
    //   378: aload 7
    //   380: invokespecial 813	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   383: putstatic 780	azfl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   386: aload 5
    //   388: astore_1
    //   389: getstatic 780	azfl:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   392: astore 6
    //   394: aload 6
    //   396: astore_1
    //   397: aload 5
    //   399: ifnull -338 -> 61
    //   402: aload 5
    //   404: invokevirtual 804	java/io/InputStream:close	()V
    //   407: aload 6
    //   409: areturn
    //   410: astore_1
    //   411: aload_1
    //   412: invokevirtual 274	java/io/IOException:printStackTrace	()V
    //   415: aload 6
    //   417: areturn
    //   418: aconst_null
    //   419: astore 6
    ...
    //   423: ifnull -151 -> 272
    //   426: aload 6
    //   428: invokevirtual 804	java/io/InputStream:close	()V
    //   431: goto -159 -> 272
    //   434: astore_1
    //   435: aload_1
    //   436: invokevirtual 274	java/io/IOException:printStackTrace	()V
    //   439: goto -167 -> 272
    //   442: astore_1
    //   443: aload_1
    //   444: invokevirtual 274	java/io/IOException:printStackTrace	()V
    //   447: goto -175 -> 272
    //   450: astore 5
    //   452: aconst_null
    //   453: astore_1
    ...
    //   455: ifnull +7 -> 462
    //   458: aload_1
    //   459: invokevirtual 804	java/io/InputStream:close	()V
    //   462: aload 5
    //   464: athrow
    //   465: astore_1
    //   466: aload_1
    //   467: invokevirtual 274	java/io/IOException:printStackTrace	()V
    //   470: goto -8 -> 462
    //   473: astore 5
    //   475: goto -21 -> 454
    //   478: astore 6
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        catch (Exception paramQQAppInterface)
        {
          ...
          if (!azgp.a(paramQQAppInterface)) {
            continue;
          }
          str1 = azgs.a(paramQQAppInterface.getApp());
          localObject2 = VasApngUtil.getOptimizedApngDrawable(str1 + "logo.png", "-wzry-card-logo-", a(paramQQAppInterface, str1 + "logo.png", true, true), new int[] { 7 }, "-wzry-card-logo-", null);
