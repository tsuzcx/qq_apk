...
public class aknq
{
  ...
  private Comparator<CmGamePushItem> jdField_a_of_type_JavaUtilComparator = new aknr(this);
  ...
  private void a(CmGamePushItem paramCmGamePushItem1, CmGamePushItem paramCmGamePushItem2)
  {
    ...
    do
    {
      ...
      localawbw = ((QQAppInterface)localObject).getEntityManagerFactory().createEntityManager();
    } while (localawbw == null);
    localObject = localawbw.a();
    ((awby)localObject).a();
    ...
    for (;;)
    {
      try
      {
        localawbw.b(paramCmGamePushItem2);
        localawbw.a(paramCmGamePushItem1);
        ((awby)localObject).c();
        return;
      }
  ...
  private void a(List<CmGamePushItem> paramList)
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 18	aknq:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   18: astore_2
    //   19: aload_2
    //   20: monitorenter
    //   21: aload_0
    //   22: getfield 23	aknq:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: aload_1
    ...
    //   33: monitorexit
    //   34: aload_0
    //   35: getfield 43	aknq:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   46: ifnull -33 -> 13
    //   49: aload_2
    //   50: invokevirtual 55	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   53: invokevirtual 61	awbx:createEntityManager	()Lawbw;
    //   56: astore_3
    //   57: aload_3
    //   58: ifnull -45 -> 13
    //   61: aload_3
    //   62: invokevirtual 66	awbw:a	()Lawby;
    //   65: astore_2
    //   66: aload_2
    //   67: invokevirtual 70	awby:a	()V
    //   70: aload_1
    ...
    //   96: invokevirtual 74	awbw:b	(Lawbv;)Z
    //   99: pop
    //   100: goto -23 -> 77
    //   103: astore_1
    ...
    //   128: athrow
    //   129: aload_2
    //   130: invokevirtual 80	awby:c	()V
    //   133: aload_2
    //   134: invokevirtual 82	awby:b	()V
    //   137: return
    //   138: astore_1
    //   139: aload_2
    //   140: invokevirtual 82	awby:b	()V
    //   143: aload_1
    //   144: athrow
  ...
  public void a(CmGamePushItem paramCmGamePushItem)
  {
    ...
    if ((localObject1 != null) && (paramCmGamePushItem.msg_type == 1)) {
      ((axho)((QQAppInterface)localObject1).getManager(36)).c(String.valueOf("103100.103200.103240.103248"));
    }
