  ...
  extends LruCache
{
  ...
  public amed(String paramString, int paramInt)
  {
    super(paramInt);
  ...
  private void a(amei paramamei)
  {
    ...
    if ((this.jdField_a_of_type_JavaIoFile.exists()) && (this.jdField_a_of_type_JavaIoFile.isFile()))
    {
      ...
      new ameh(this.jdField_a_of_type_JavaIoFile, paramamei).a();
      if (i != 0)
      {
        CommTvRpt.a(2, 2);
        this.jdField_a_of_type_JavaIoFile.delete();
  ...
  private boolean a()
  {
    ...
    new ameh(this.jdField_b_of_type_JavaIoFile, new ameg(this, this.jdField_a_of_type_JavaIoFile)).a();
    return true;
  }
  
  private ICloudAVEngine.ResultBundle b(String paramString)
  {
    paramString = new amef(this, paramString);
    a(paramString);
