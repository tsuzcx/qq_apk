...
public class amfi
  implements Handler.Callback, aofq, Manager
{
  public static final String a;
  public static boolean a;
  private float jdField_a_of_type_Float = 7.0F;
  public int a;
  alox jdField_a_of_type_Alox = new amfj(this);
  private amab jdField_a_of_type_Amab = new amfk(this);
  private bhoe jdField_a_of_type_Bhoe = new bhoe(ThreadManager.getFileThreadLooper(), this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private final Object jdField_a_of_type_JavaLangObject = new Object();
  private WeakReference<amfm> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  private WeakReference<amfh> jdField_b_of_type_JavaLangRefWeakReference;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alpo.a(2131706072);
  }
  
  public amfi(QQAppInterface paramQQAppInterface)
  {
  ...
  private Object[] a(boolean paramBoolean, String paramString)
  {
    ...
    if (!paramBoolean) {
      localObject2 = bdiv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), "breaking_ice_config");
    }
    i2 = i3;
    m = n;
    k = i1;
  ...
  private void f()
  {
    ...
    Object localObject1 = bdcs.a(String.format("%s_%s", new Object[] { "break_ice_map", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bdcs.a(String.format("%s_%s", new Object[] { "entered_c2c", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bdcs.a(String.format("%s_%s", new Object[] { "entered_troop", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bdcs.a(String.format("%s_%s", new Object[] { "entered_match_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
  ...
  private void g()
  {
    ...
    bdcs.a(String.format("%s_%s", new Object[] { "break_ice_map", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localConcurrentHashMap);
  }
    ...
    if (localTroopInfo.wMemberNum < this.jdField_b_of_type_Int)
    {
      ...
      if ((localObject2 == null) || (((List)localObject2).size() <= 1))
      {
        ...
        for (i = 0;; i = ((List)localObject2).size())
        {
          ...
          ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).o(paramString);
          return;
        }
      }
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if ((TextUtils.isEmpty(str2)) || (str2.equals(str1)) || (((aloz)localObject1).b(str2))) {
          break label318;
        }
        i += 1;
      }
  ...
  public void a(amfh paramamfh)
  {
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramamfh);
  }
  
  public void a(amfm paramamfm)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramamfm);
  }
  
  public void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString, aofp paramaofp)
  {
    if ((paramaofp != null) && ("breaking_ice_config".equals(paramString)))
    {
      if (!this.jdField_b_of_type_Boolean) {
        f();
      }
      paramQQAppInterface = a(true, paramaofp.jdField_a_of_type_JavaLangString);
      ...
      if ((bool1 != this.jdField_c_of_type_Boolean) || (bool2 != this.jdField_d_of_type_Boolean))
      {
        ...
        if (a(this.jdField_c_of_type_Boolean, this.jdField_d_of_type_Boolean, paramQQAppInterface))
        {
          ...
          if (this.jdField_a_of_type_Bhoe.hasMessages(1)) {
            this.jdField_a_of_type_Bhoe.removeMessages(1);
          }
          this.jdField_a_of_type_Bhoe.sendEmptyMessage(1);
        }
      }
      if (QLog.isColorLevel())
      {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = ((aloz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      ...
      for (;;)
      {
        ...
        paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), agul.class);
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      return;
      Object localObject = ((aloz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString);
      boolean bool;
      int i;
      if ((localObject != null) && (((Friends)localObject).isFriend()))
      {
        ...
        {
          localObject = (amfm)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localObject != null) {
            ((amfm)localObject).a(paramString, false);
          }
        }
        if (this.jdField_a_of_type_Bhoe.hasMessages(1)) {
          this.jdField_a_of_type_Bhoe.removeMessages(1);
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("IceBreak.HotPic", 2, bhop.a(paramArrayOfByte));
        return;
        ...
        while (i < paramArrayOfByte.size())
        {
          ...
          localagua.a(localImgInfo.bytes_img_word.get().toStringUtf8());
          ...
          ((List)localObject).add(localagua);
          i += 1;
        }
  ...
  public void b()
  {
    ...
    bdcs.a(String.format("%s_%s", new Object[] { "entered_c2c", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  
  public void b(amfm paramamfm)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() == paramamfm)) {
  ...
  public void c()
  {
    ...
    bdcs.a(String.format("%s_%s", new Object[] { "entered_troop", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public void d()
  {
    ...
    bdcs.a(String.format("%s_%s", new Object[] { "entered_match_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public boolean d(String paramString)
  {
    ...
    if (localObject != null)
    {
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        amfm localamfm = (amfm)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localamfm != null) {
          localamfm.b(paramString, false);
        }
      }
      if (this.jdField_a_of_type_Bhoe.hasMessages(1)) {
        this.jdField_a_of_type_Bhoe.removeMessages(1);
  ...
  public boolean e(String paramString)
  {
    ...
    if (bool2)
    {
      paramString = ((aloz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString);
  ...
  public void h(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (((apwx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(264)).d()) {
            break;
          }
      ...
      localamfm = (amfm)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localamfm == null);
    localamfm.a(paramString, false);
  }
  ...
  {
    if (!agug.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b()) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if ((localTroopMemberInfo == null) || (localTroopMemberInfo.last_active_time == localTroopMemberInfo.join_time))
      {
        ...
        this.jdField_d_of_type_JavaLangString = paramString;
        ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(Long.valueOf(paramString).longValue(), Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue(), true);
        return;
      }
