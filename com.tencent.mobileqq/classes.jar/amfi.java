...
public class amfi
{
  private void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Boolean localBoolean = (Boolean)bgmq.a("local_kd_tab_has_set");
    boolean bool3 = TextUtils.equals("1", paramString);
    bgmq.a(paramQQAppInterface, "remote_kd_tab_switch", Boolean.valueOf(bool3));
    boolean bool2;
  ...
  public void a(alzs[] paramArrayOfalzs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        int j = 0;
        if (j < paramArrayOfalzs.length)
        {
          if (TextUtils.isEmpty(paramArrayOfalzs[j].a))
          {
          ...
          try
          {
            str2 = paramArrayOfalzs[j].a.trim();
            ...
            bgmq.c(localQQAppInterface, str1);
            continue;
            if (!QLog.isColorLevel()) {
              continue;
            }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e("ReadinjoyCommonConfProcessor", 2, "received readinjoy cropandgroup config error,cmd : 92" + paramArrayOfalzs.toString());
        }
      }
      if (TextUtils.equals((CharSequence)localObject2, "feeds_group"))
      {
        bgmq.a(localQQAppInterface, str1);
      }
      else if (TextUtils.equals((CharSequence)localObject2, "remind_only_wifi"))
      {
        bgmq.b(localQQAppInterface, str1);
      }
      ...
      {
        bgmq.d(localQQAppInterface, TextUtils.equals(str1, "1"));
      }
      else
      {
        ...
        else
        {
          ...
          if (TextUtils.equals((CharSequence)localObject2, "socializeWebUrl"))
          {
            ...
            if (localObject1 != null)
            {
              if (((Node)localObject1).getNodeType() == 1)
              {
                ...
                if (!bgmq.a((String)localObject2)) {
                  break label641;
                }
                bgmq.a(localQQAppInterface, (String)localObject2, (String)localObject3);
              }
              for (;;)
              {
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_report_tt"))
          {
            ...
            if (TextUtils.equals((CharSequence)localObject1, "1")) {
              bgmq.j(localQQAppInterface, true);
            } else {
              bgmq.j(localQQAppInterface, false);
            }
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_report_user_apps_switch"))
          {
            ...
            bgmq.a("kandian_report_user_apps_switch", localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "maintab_reddot_times"))
          {
            ...
            bgmq.h(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "maintab_reddot_feeds"))
          {
            ...
            bgmq.i(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "feedsbackWebUrl"))
          {
            bgmq.b(localQQAppInterface, (String)localObject2, (String)localObject1);
            if (QLog.isColorLevel()) {
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsSwitch"))
          {
            ...
            bgmq.k(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsName"))
          {
            ...
            bgmq.d(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biufeedsWebUrl"))
          {
            ...
            bgmq.e(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "badgeNumber"))
          {
            ...
            bgmq.z(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_word_count"))
          {
            ...
            bgmq.f(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "new_channel_style"))
          {
            ...
            bgmq.l(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_time"))
          {
            ...
            bgmq.b(localQQAppInterface, Long.valueOf((String)localObject1).longValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds"))
          {
            ...
            bgmq.A(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_time_weishi"))
          {
            ...
            bgmq.c(localQQAppInterface, Long.valueOf((String)localObject1).longValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds_weishi"))
          {
            ...
            bgmq.B(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandianWebPreLoadData"))
          {
            ...
            if (TextUtils.equals((CharSequence)localObject1, "1")) {
              bgmq.o(localQQAppInterface, true);
            } else {
              bgmq.o(localQQAppInterface, false);
            }
          }
          else if ((TextUtils.equals((CharSequence)localObject2, "ExitAIO_Android_Uin")) && (localObject1 != null))
          {
            ...
            if (localObject1.length >= 2) {
              bgmq.b(Integer.valueOf(localObject1[0]).intValue(), Integer.valueOf(localObject1[1]).intValue());
            }
          }
          ...
          {
            bgmq.a(localQQAppInterface, "remote_kd_tab_type", localObject1);
            localObject2 = bgmq.a("local_kd_tab_has_set");
            ...
            if (!bool)
            {
              bgmq.a(localQQAppInterface, "local_kd_tab_type", localObject1);
          ...
          {
            bgmq.H(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "topic_card_jump"))
          {
            bgmq.a(localQQAppInterface, "kd_topic_recommend_card_jump_switch", Boolean.valueOf(((String)localObject1).equals("1")));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "topic_card_jump_url"))
          {
            bgmq.a(localQQAppInterface, "kd_topic_recommend_card_jump_url", localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_word_count"))
          {
            ...
            bgmq.g(localQQAppInterface, (String)localObject1);
          }
          else if ((TextUtils.equals((CharSequence)localObject2, "KW")) && (!TextUtils.isEmpty((CharSequence)localObject1)))
          {
            ...
            obz.a("kandian_aio_sp_word", localObject2, true);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "ugc_gif_switch"))
          {
            ...
            bgmq.i(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_at_switch"))
          {
            ...
            bgmq.n(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "UGC_at_switch"))
          {
            ...
            bgmq.m(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_at_switch"))
          {
            ...
            bgmq.v(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "biu_profile_switch"))
          {
            ...
            bgmq.o(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_BiuMsg"))
          {
            ...
            bgmq.c(TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_InteractiveMsg"))
          {
            ...
            bgmq.d(TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "IconMerge_SubscribeMsg"))
          {
            ...
            bgmq.e((String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "nw_support"))
          {
            bgmq.p(localQQAppInterface, TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "nw_preload"))
          {
            bgmq.q(localQQAppInterface, TextUtils.equals((CharSequence)localObject1, "1"));
          }
          else if (TextUtils.equals((CharSequence)localObject2, "arkapp_enable_switch"))
          {
            ...
            bgmq.b(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "exposure_strengthen"))
          {
            bgmq.r(localQQAppInterface, "1".equals(localObject1));
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "diandian_publish_switch_new"))
          {
            ...
            bgmq.p(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandian_publish_switch_new"))
          {
            ...
            bgmq.q(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_QA_square_autoTimeval"))
          {
            ...
            bgmq.r(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "WXShareFromKandian_Switch"))
          {
            ...
            bgmq.s(localQQAppInterface, (String)localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "zhitu"))
          {
            ...
            bgmq.j(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "comment_biu_switch"))
          {
            ...
            bgmq.t(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "native_comment_biu"))
          {
            ...
            bgmq.u(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_short_video_width_height_ratio"))
          {
            ...
            bgmq.b(localQQAppInterface, Float.valueOf((String)localObject1).floatValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "readinjoy_short_video_max_duration_limit"))
          {
            ...
            bgmq.w(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "record_duration_count"))
          {
            ...
            bgmq.g(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "kandiansettings"))
          {
            ...
            bgmq.D(localQQAppInterface, str2);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "ReadInJoy_Message_Auto_Refresh_Time_Duration"))
          {
            ...
            bgmq.K(localQQAppInterface, (String)localObject1);
          }
          else if (TextUtils.equals((CharSequence)localObject2, "is_show_weishi_entrance"))
          {
            ...
            bgmq.E(localQQAppInterface, Integer.valueOf((String)localObject1).intValue());
          }
          else if (TextUtils.equals((CharSequence)localObject2, "is_jump_to_video_content"))
          {
            ...
            bgmq.L(localQQAppInterface, (String)localObject1);
          }
          ...
          else if (TextUtils.equals((CharSequence)localObject2, "video_switch"))
          {
            ...
            try
            {
              ...
              bool = true;
              label4507:
              bgmq.a("sp_key_readinjoy_video_entrance_reddot_button_switch", Boolean.valueOf(bool));
            }
          ...
          else
          {
            ...
            if (bool)
            {
              try
              {
                bgmq.a("sp_key_readinjoy_video_entrance_reddot_button_color", Integer.valueOf(Color.parseColor(localNumberFormatException1)));
              }
            ...
            {
              bgmq.a("sp_key_readinjoy_video_entrance_reddot_expire_time_list", localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "ReadInJoy_guanzhu_Auto_Refresh_Time_Duration"))
            {
              ...
              bgmq.a("sp_key_kandian_subscribe_auto_refresh_config", Integer.valueOf(i));
            ...
            else if (TextUtils.equals((CharSequence)localObject2, "weishi_with_channel_discovery_switch"))
            {
              ...
              bgmq.f(localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "ugc_upload_lbs_switch"))
            {
              i = Integer.parseInt(localIllegalArgumentException);
              bgmq.a(nts.READINJOY_UGC_LBS, Integer.valueOf(i));
            }
            else if (TextUtils.equals((CharSequence)localObject2, "local_record_time_weishi_recommend"))
            {
              ...
              bgmq.c(localIllegalArgumentException);
            }
            else if (TextUtils.equals((CharSequence)localObject2, "local_record_feeds_counts_weishi_recommend"))
            {
              ...
              bgmq.d(localIllegalArgumentException);
            }
            else
            {
              ...
              bgmq.a("should_request_aladdin_config", Boolean.valueOf(TextUtils.equals("1", localIllegalArgumentException)));
            }
          }
        }
      }
    ...
    for (;;)
    {
      for (;;)
      {
        for (;;)
        {
          for (;;)
          {
            for (;;)
            {
              for (;;)
              {
                for (;;)
                {
                  for (;;)
                  {
                    for (;;)
                    {
                      try
                      {
                        ...
                        bool = true;
                        bgmq.a("sp_key_create_topic_switch", Boolean.valueOf(bool));
                      }
                      ...
                      {
                        bgmq.a("readinjoy_coin_item_jump_url", localIllegalArgumentException);
                        if (!QLog.isColorLevel()) {
                          break;
                        }
                      ...
                      {
                        bgmq.a("readinjoy_coin_item_title", localIllegalArgumentException);
                        if (!QLog.isColorLevel()) {
                          break;
                        }
                    ...
                    {
                      bgmq.a("kandianreport_ON", Integer.valueOf(Integer.parseInt(localNumberFormatException2)));
                      break;
                    }
                  ...
                  {
                    bgmq.a("kandian_daily_fast_web_bottom_share", localException3);
                    break;
                  }
                  ...
                  try
                  {
                    bgmq.g(Integer.parseInt(localException3));
                  }
                ...
                try
                {
                  bgmq.h(Integer.parseInt(localException4));
                }
              ...
              try
              {
                bgmq.i(Integer.parseInt(localException5));
              }
            ...
            try
            {
              ...
              bgmq.a("readinjoy_video_ff_probesize", Long.valueOf(Long.parseLong(localException6)));
            }
          ...
          try
          {
            ...
            bgmq.a("readinjoy_video_is_ff_probelist_switch", Integer.valueOf(Integer.parseInt(localException7)));
          }
        ...
        try
        {
          ...
          bgmq.a("readinjoy_video_is_download_async_io", Integer.valueOf(Integer.parseInt(localException8)));
        }
      ...
      {
        bgmq.a("kandian_daily_wrapper_alpha", localException9);
        break;
      }
      if (TextUtils.equals((CharSequence)localObject2, "kandian_daily_wrapper_default_text"))
      {
        bgmq.a("kandian_daily_wrapper_default_text", localException9);
        break;
      }
      if (TextUtils.equals((CharSequence)localObject2, "kandian_daily_wrapper_drag_text"))
      {
        bgmq.a("kandian_daily_wrapper_drag_text", localException9);
        break;
      }
      ...
      bgmq.a("kandian_video_extract_frame", localException9);
      break;
      label6385:
