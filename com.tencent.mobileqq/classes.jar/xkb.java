  ...
  extends WebViewPlugin
{
  ...
  private SparseArray<WeakReference<xkd>> jdField_a_of_type_AndroidUtilSparseArray;
  ...
  xkd a(int paramInt)
  {
    ...
    Object localObject = new xkd(this, null);
    ((xkd)localObject).jdField_a_of_type_Int = paramInt;
    localObject = new WeakReference(localObject);
    this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localObject);
    return (xkd)((WeakReference)localObject).get();
  }
  ...
  boolean a(int paramInt)
  {
    ...
    localObject = (xkd)((WeakReference)localObject).get();
    if (localObject == null) {
      return false;
    }
    try
  ...
  public void onDestroy()
  {
    ...
    if ((this.jdField_a_of_type_AndroidUtilSparseArray != null) && (this.jdField_a_of_type_AndroidUtilSparseArray.size() > 0))
    {
      ...
      {
        xkd localxkd = (xkd)((WeakReference)this.jdField_a_of_type_AndroidUtilSparseArray.get(i)).get();
        if (localxkd != null) {
          a(localxkd.jdField_a_of_type_Int);
        }
        i += 1;
      }
    }
