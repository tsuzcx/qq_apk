  ...
  extends CameraCaptureSession.CaptureCallback
{
  ...
  private void a(CaptureResult paramCaptureResult, CaptureRequest paramCaptureRequest)
  {
    ...
    if ((!(paramCaptureRequest instanceof bdbo)) || (((bdbo)paramCaptureRequest).jdField_a_of_type_Boolean))
    {
    ...
    a(true, (bdbo)paramCaptureRequest);
  }
  
  private void a(boolean paramBoolean, bdbo parambdbo)
  {
    Camera2Control.d(this.a, false);
    ...
    try
    {
      ...
      for (CaptureRequest localCaptureRequest = Camera2Control.a(this.a).buildCaptureRequest(Camera2Control.a(this.a));; localCaptureRequest = Camera2Control.a(this.a).build())
      {
        ...
        if ((parambdbo.jdField_a_of_type_Bczk.a == null) || (parambdbo.jdField_a_of_type_Boolean)) {
          break;
        }
        parambdbo.jdField_a_of_type_Boolean = true;
        parambdbo.jdField_a_of_type_Bczk.a.a(1, paramBoolean);
        return;
      }
      return;
    }
    ...
    {
      bczm.a(2, "[Camera2] mAfCaptureCallback e:" + parambdbo);
    }
  }
  ...
  public void onCaptureFailed(@NonNull CameraCaptureSession paramCameraCaptureSession, @NonNull CaptureRequest paramCaptureRequest, @NonNull CaptureFailure paramCaptureFailure)
  {
    ...
    if ((!(paramCameraCaptureSession instanceof bdbo)) || (((bdbo)paramCameraCaptureSession).jdField_a_of_type_Boolean))
    {
      bczm.a(1, "[Camera2] mAfCaptureCallback handled!");
      Camera2Control.d(this.a, false);
      return;
    }
    a(false, (bdbo)paramCameraCaptureSession);
  }
