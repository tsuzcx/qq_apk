...
public class yex
{
  ...
  public static int a(View paramView)
  {
    ...
    ykq.b("Q.qqstory.home.StoryListUtils", "getDistanceToCenterY=" + i);
    return i;
  }
  
  public static Bitmap a(Drawable paramDrawable, int paramInt1, int paramInt2, Map<String, Bitmap> paramMap, yej paramyej)
  {
    ...
    for (Bitmap localBitmap = (Bitmap)paramMap.get("w=" + paramInt1 + "h=" + paramInt2);; localBitmap = null)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            yew.b("Q.qqstory.home.StoryListUtils", new Object[] { "drawable2Bitmap need create width=", Integer.valueOf(paramInt1), ",height=", Integer.valueOf(paramInt2) });
          ...
          ykq.a("Q.qqstory.home.StoryListUtils", "drawable2Bitmap:width=%d,height=%d,cost time=%d", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(System.currentTimeMillis() - l));
          paramDrawable = (Drawable)localObject;
          if (paramyej == null) {
            break;
          }
          return paramyej.a((Bitmap)localObject);
        }
        catch (OutOfMemoryError paramDrawable)
        {
          label347:
          ykq.e("Q.qqstory.home.StoryListUtils", "drawable2Bitmap out off memory width=" + paramInt1 + ",height=" + paramInt2);
          return null;
        }
      }
  ...
  public static String a(int paramInt, boolean paramBoolean)
  {
    ...
    default: 
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = anvx.a(2131713834);
      }
      break;
    }
    do
    {
      return localObject2;
      localObject1 = anvx.a(2131713835);
      break;
      localObject1 = anvx.a(2131713833);
      break;
      localObject1 = anvx.a(2131713862);
      break;
      localObject1 = anvx.a(2131713826);
      break;
      localObject1 = anvx.a(2131713823);
      break;
      localObject1 = anvx.a(2131713859);
      break;
      localObject1 = anvx.a(2131713837);
      break;
      localObject1 = anvx.a(2131713827);
      break;
      localObject1 = anvx.a(2131713848);
      break;
      localObject1 = anvx.a(2131713849);
      break;
      localObject1 = anvx.a(2131713864);
      break;
      localObject1 = anvx.a(2131713844);
      break;
      localObject1 = anvx.a(2131713863);
      break;
      localObject1 = anvx.a(2131713857);
      break;
      localObject1 = anvx.a(2131713842);
      break;
      localObject1 = anvx.a(2131713841);
      break;
      localObject1 = anvx.a(2131713831);
      break;
      localObject1 = anvx.a(2131713858);
      break;
      localObject1 = anvx.a(2131713822);
      break;
      localObject1 = anvx.a(2131713828);
      break;
      localObject1 = anvx.a(2131713836);
      break;
      localObject1 = anvx.a(2131713845);
      break;
      localObject1 = anvx.a(2131713856);
      break;
      localObject1 = anvx.a(2131713840);
      break;
      localObject1 = anvx.a(2131713853);
      break;
      localObject1 = anvx.a(2131713824);
      break;
      localObject2 = localObject1;
    } while (!paramBoolean);
    return anvx.a(2131713846) + (String)localObject1;
  }
  ...
  {
    Object localObject = ((vzv)paramQQAppInterface.getManager(QQManagerFactory.QQSTORY_MANAGER)).a(false);
  ...
  public static void a(ArrayList<String> paramArrayList)
  {
    ...
    ykq.b("Q.qqstory.home.StoryListUtils", "reportShieldFriendStory:" + paramArrayList.size());
    yfh localyfh = new yfh();
    localyfh.a = paramArrayList;
    wad.a().dispatch(localyfh);
  }
  ...
  public static int b(View paramView)
  {
    ...
    ykq.b("Q.qqstory.home.StoryListUtils", "getDistanceToTop=" + i);
    return i;
  }
  ...
  public static String b(long paramLong)
  {
    ...
    if (m == i3) {
      return String.format(Locale.getDefault(), anvx.a(2131713843), new Object[] { Integer.valueOf(n), Integer.valueOf(i1) });
    }
    localCalendar.setTimeInMillis(paramLong);
    localCalendar.add(6, 1);
    if (localCalendar.get(6) == i3) {
      return String.format(Locale.getDefault(), anvx.a(2131713832), new Object[] { Integer.valueOf(n), Integer.valueOf(i1) });
    }
    if (i != i2) {
  ...
  public static int c(View paramView)
  {
    ...
    int i = Math.min(Math.abs(j - arrayOfInt[1]), Math.abs(j - (arrayOfInt[1] + i)));
    ykq.b("Q.qqstory.home.StoryListUtils", "getDistanceToBottom=" + i);
    return i;
  }
}
