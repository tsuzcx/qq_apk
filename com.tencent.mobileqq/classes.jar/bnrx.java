...
{
  public bnrx(AEPituCameraCaptureButtonLayout paramAEPituCameraCaptureButtonLayout) {}
  
  public void onAnimationCancel(Animator paramAnimator)
  {
    bnrh.b("CameraCaptureLayout", "scaleAnimator cancel!");
  }
  
  public void onAnimationEnd(Animator paramAnimator)
  {
    bnrh.b("CameraCaptureLayout", "scaleAnimator end, shortVideoShot:" + this.a.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get() + ", mActionUpAnimator:" + this.a.b.get());
    if (!this.a.b.get())
    {
  ...
  {
    bnrh.b("CameraCaptureLayout", "scaleAnimator start!");
