  ...
  implements aabg<QCircleReportBean>
{
  ...
  protected void assembleFromReportData()
  {
    ...
    } while ((localObject == null) || (((QCircleInitBean)localObject).getFromReportBean() == null) || (this.mReportBean == null));
    this.mReportBean.assembleFromReportData(((QCircleInitBean)localObject).getFromReportBean());
  }
