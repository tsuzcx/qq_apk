...
public class ahsv
{
  ...
  public static ahsv a()
  {
    ...
    {
      ahsv localahsv1 = (ahsv)jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.poll();
      ??? = localahsv1;
      if (localahsv1 != null) {}
    }
    return localahsv2;
    ...
    try
    {
      ...
      synchronized (jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue)
      {
        if (!jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.isEmpty()) {
          ((ahsv)jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.poll()).c();
        }
      }
    }
    finally {}
  ...
  protected void finalize()
  {
    ...
    //   4: aload_0
    //   5: getfield 62	ahsv:jdField_a_of_type_Int	I
    //   8: ifeq +10 -> 18
    //   11: ldc 72
    //   13: ldc 134
    ...
    //   19: astore_1
    //   20: aload_0
    //   21: getfield 62	ahsv:jdField_a_of_type_Int	I
    //   24: ifeq -6 -> 18
    //   27: ldc 72
    //   29: ldc 134
    ...
    //   35: astore_1
    //   36: aload_0
    //   37: getfield 62	ahsv:jdField_a_of_type_Int	I
    //   40: ifeq +10 -> 50
    //   43: ldc 72
    //   45: ldc 134
