...
public abstract class arku
{
  public static final String a;
  public static final String b = aufb.jdField_a_of_type_JavaLangString + "file/";
  protected QQAppInterface a;
  
  static
  {
    jdField_a_of_type_JavaLangString = aufb.jdField_a_of_type_JavaLangString + "fileThumb/";
  }
  ...
  protected MsgBackupResEntity a(MessageRecord paramMessageRecord, int paramInt, String paramString)
  {
    ...
    aufh.a(paramMessageRecord, localMsgBackupResEntity);
    localMsgBackupResEntity.extraDataStr = a(arni.a((ChatMessage)paramMessageRecord), paramInt);
    ...
    if (bdcs.b(paramString)) {
      localMsgBackupResEntity.fileSize = bdcs.a(paramString);
    }
    ...
    if (paramMessageRecord.isMultiMsg)
    {
      ...
      if ((!TextUtils.isEmpty(paramMsgBackupResEntity)) && (!TextUtils.isEmpty(str)) && (paramMsgBackupResEntity.equals(str)))
      {
        if (QLog.isDebugVersion()) {
          QLog.i("FileMsgBackupHandler<QFile>", 1, "isResourceRelateToMsg: multi msg match res. fileId[" + str + "] " + aroo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord));
        }
        return true;
      }
      return false;
