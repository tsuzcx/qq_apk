...
{
  public zsv(DeviceMsgSettingActivity paramDeviceMsgSettingActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      ...
      bfhq.a().a(this.a.getString(2131719823));
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = (zsw)paramBundle.next();
        if (((zsw)localObject).a == j) {
          if (this.a.jdField_a_of_type_AndroidWidgetCompoundButton.isChecked())
          {
            paramInt = 1;
            ((zsw)localObject).b = paramInt;
          }
          else
          {
            paramInt = 0;
    ...
    aabm.a(paramBundle, l, "Usr_MsgMgr_Setting", paramInt, 0, Integer.parseInt(this.a.b));
    return;
    label280:
    ...
    for (paramBoolean = bool2;; paramBoolean = false)
    {
      ...
      bfhg.a("DeviceMsgSettingActivity", "msg:" + paramBundle.optString("msg"));
      bfhq.a().a(this.a.getString(2131719823));
      return;
    }
  }
