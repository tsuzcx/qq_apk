...
class zsv
  extends mmn
{
  zsv(zsu paramzsu, ztg paramztg, JSONObject paramJSONObject, zrt paramzrt) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.i(zsu.a, 2, "onResult appid=" + zsu.a(this.jdField_a_of_type_Zsu).a + ", openid=" + this.jdField_a_of_type_Ztg.a + ", openkey=" + this.jdField_a_of_type_Ztg.b + ", code=" + paramInt + ", req param=" + this.jdField_a_of_type_OrgJsonJSONObject);
    }
    if ((paramInt != 0) || (paramArrayOfByte == null))
    {
      zva.a(this.jdField_a_of_type_Zrt, paramInt, "getRankingList result error, try again");
      return;
    }
    ...
    if (paramArrayOfByte != null)
    {
      ...
      try
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.e(zsu.a, 2, localJSONException.getMessage(), localJSONException);
          }
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e(zsu.a, 2, paramArrayOfByte.getMessage(), paramArrayOfByte);
        }
      }
      QLog.i(zsu.a, 2, "result is, " + paramBundle.toString());
