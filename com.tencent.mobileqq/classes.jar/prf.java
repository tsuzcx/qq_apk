...
public class prf
  extends prd
{
  public prf(Context paramContext, baxk parambaxk, rap paramrap)
  {
  ...
  public pqt d()
  {
    ...
    if ((this.jdField_a_of_type_Pqs != null) && ((this.jdField_a_of_type_Pqs instanceof ComponentContentBig)) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null))
    {
      ...
      ((ComponentContentBig)this.jdField_a_of_type_Pqs).setId(1);
      ((ComponentContentBig)this.jdField_a_of_type_Pqs).setLayoutParams(localLayoutParams);
      localLinearLayout3.addView((ComponentContentBig)this.jdField_a_of_type_Pqs);
      ...
      localLinearLayout3.setOnClickListener(new prg(this, localLinearLayout1, localLinearLayout3, localLinearLayout2));
      localLinearLayout3.setDuplicateParentStateEnabled(true);
      localLinearLayout3.setOnTouchListener(new prh(this, localLinearLayout3));
      localLinearLayout2.setOnTouchListener(new pri(this, localLinearLayout3));
      ...
      localLinearLayout2.setOnTouchListener(new prj(this, localLinearLayout2));
      localLinearLayout1.setOnTouchListener(new prk(this, localLinearLayout2, localLinearLayout3));
    }
    localLinearLayout2.setOnClickListener(new prl(this));
