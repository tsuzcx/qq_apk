...
public class bocy
{
  ...
  private bocx jdField_a_of_type_Bocx = new bocz(this);
  ...
  public float a(int paramInt)
  {
    ...
    if ((this.b) && (this.jdField_a_of_type_Bocw != null) && (this.jdField_a_of_type_Bocw.jdField_a_of_type_Boolean) && (paramInt >= this.jdField_a_of_type_Int)) {
      return this.jdField_a_of_type_Bocw.a(paramInt - this.jdField_a_of_type_Int);
    }
    return -1.0F;
  }
