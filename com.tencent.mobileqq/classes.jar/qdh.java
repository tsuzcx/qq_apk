  ...
  extends niv
{
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (paramInt == 0)
    {
      paramInt = this.jdField_a_of_type_Rfu.d;
      if (this.jdField_a_of_type_Int == 1) {
        paramInt += 1;
      }
      for (;;)
      {
        pmk.a().a(this.jdField_a_of_type_Rfu.jdField_a_of_type_Int, this.jdField_a_of_type_Int, paramInt);
    ...
    QLog.e("ColumnTwoVideoProteusItem", 1, "ColumnTwoVideoProteusItem subscribe column fail. columnId:" + this.jdField_a_of_type_Rfu.jdField_a_of_type_Int + " subscribeAction:" + this.jdField_a_of_type_Int);
  }
}
