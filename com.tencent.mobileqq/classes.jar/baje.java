...
public class baje
{
  ...
  protected static Map<String, banh> a;
  protected akhp a;
  ...
  public baje(String paramString, Class<? extends banh> paramClass, akhp paramakhp)
  {
    this.jdField_a_of_type_JavaLangString = "0x6ff0072";
    this.jdField_a_of_type_Akhp = paramakhp;
    this.f = paramString;
    if (jdField_a_of_type_JavaUtilMap == null) {
      jdField_a_of_type_JavaUtilMap = new HashMap();
    }
    if ((banh)jdField_a_of_type_JavaUtilMap.get(paramString) == null)
    {
      paramClass = bang.a(paramClass);
  ...
  {
    return ((banh)jdField_a_of_type_JavaUtilMap.get(this.f)).a();
  }
  ...
  public List<String> a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    boolean bool2 = ajyb.a().a();
    int i = NetConnInfoCenter.getActiveNetIpFamily(true);
    Object localObject = ayvn.a();
    ((ayvn)localObject).b();
    if (i == 3)
    {
      String str = ((ayvn)localObject).a(0, bool2);
      ...
      {
        localObject = ((ayvn)localObject).a(0, bool1);
  ...
  {
    ThreadManager.executeOnNetWorkThread(new TroopAvatarManger.1(this, paramAppInterface, paramString1, paramString3, paramString2, (banh)jdField_a_of_type_JavaUtilMap.get(this.f), paramClass, paramArrayList, paramHashMap));
  }
  
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Akhp != null) {
      this.jdField_a_of_type_Akhp.e(paramString);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Akhp != null) {
      this.jdField_a_of_type_Akhp.a(paramString, paramInt, paramArrayList);
    }
  }
  
  public void a(Observer paramObserver)
  {
    ((banh)jdField_a_of_type_JavaUtilMap.get(this.f)).addObserver(paramObserver);
  }
  
  public void b(Observer paramObserver)
  {
    ((banh)jdField_a_of_type_JavaUtilMap.get(this.f)).a(paramObserver);
  }
}
