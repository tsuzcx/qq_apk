  ...
  implements Manager
{
  ...
  private ofg jdField_a_of_type_Ofg;
  ...
  public ofd(QQAppInterface paramQQAppInterface)
  {
  ...
  private opx a()
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      return (opx)((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getManager(QQManagerFactory.PUBLIC_ACCOUNT_ENTITY_HELPER);
    }
    return null;
  }
  ...
  private void b()
  {
    ...
    if (localTVK_IProxyFactory != null)
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setPreloadCallback(new ofh(this, null));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setOnPreLoadCompleteCallback(new ofi(this, null));
    }
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_UserInfo = new TVK_UserInfo(b(), "");
    this.jdField_a_of_type_Ofg = new ofg(this, this);
    AppNetConnInfo.registerConnectionChangeReceiver(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Ofg);
  ...
  public void a(oeq paramoeq)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        c("handlePreloadTaskFromMessage msgid:" + paramoeq.c + ", vid:" + localoer.b);
        if (!TextUtils.isEmpty(localoer.b))
        {
          ...
          localPAAdPreloadTask.mMsgId = paramoeq.c;
          ...
          if (paramoeq.jdField_a_of_type_Long > 0L)
          {
            ...
            c("handlePreloadTaskFromMessage msgid:" + paramoeq.c + ", vid:" + localoer.b + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label309:
      c("handlePreloadTaskFromMessage msgid:" + paramoeq.c + ", vid:" + localoer.b + ", exist in queue, ignore");
    }
  }
  
  public void a(oeq paramoeq, int paramInt)
  {
    Object localObject = this.jdField_a_of_type_JavaLangObject;
    if (paramoeq != null) {}
    for (;;)
    {
      ...
      try
      {
        if ((paramoeq.jdField_a_of_type_Oes == null) || (paramoeq.jdField_a_of_type_JavaUtilArrayList == null) || (paramoeq.jdField_a_of_type_JavaUtilArrayList.size() <= paramInt))
        {
          c("handlePreloadTaskFromPlay invalid item");
          return;
        }
        str = ((oer)paramoeq.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).b;
        c("handlePreloadTaskFromPlay msgid:" + paramoeq.c + ", index:" + paramInt + ", vid:" + str);
        if (!TextUtils.isEmpty(str))
        {
          PAAdPreloadTask localPAAdPreloadTask = new PAAdPreloadTask();
          localPAAdPreloadTask.mUserUin = b();
          ...
          if (paramoeq.jdField_a_of_type_Long > 0L)
          {
            ...
            localPAAdPreloadTask.mExpireTime = (localPAAdPreloadTask.mReceiveTime + jdField_a_of_type_JavaLangLong.longValue());
            localPAAdPreloadTask.mPreloadState = 1;
            localPAAdPreloadTask.mNetworkType = paramoeq.jdField_a_of_type_Oes.e;
            this.c.add(localPAAdPreloadTask);
            ThreadManager.executeOnNetWorkThread(new AdvertisementVideoPreloadManager.9(this));
            c("handlePreloadTaskFromPlay msgid:" + paramoeq.c + ", index:" + paramInt + ", vid:" + str + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label317:
      c("handlePreloadTaskFromPlay msgid:" + paramoeq.c + ", index:" + paramInt + ", vid:" + str + ", exist in queue, ignore");
    }
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Ofg != null)
    {
      this.jdField_a_of_type_Ofg.a();
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Ofg);
      this.jdField_a_of_type_Ofg = null;
    }
