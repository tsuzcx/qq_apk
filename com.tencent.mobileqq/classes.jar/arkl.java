...
public class arkl
  extends QIPCModule
{
  private static volatile arkl a;
  
  public arkl(String paramString)
  {
    super(paramString);
  }
  ...
  public static arkl a()
  {
    ...
    {
      if (a == null) {
        a = new arkl("TogetherBusinessIPCModule");
      }
      return a;
    }
    finally {}
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("action_open_identify".equals(paramString)) {
      TogetherBusinessServlet.a("QQAIOMediaSvc.open_identify", (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramBundle, new arkm(this, paramInt));
    }
    do
    {
      boolean bool2;
      do
      {
        do
        {
          ...
          {
            TogetherBusinessServlet.a("QQAIOMediaSvc.open_start", (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramBundle, new arkm(this, paramInt));
            return null;
          }
        ...
        arkn.a(bool1, paramString, paramInt, bool2);
        if (QLog.isColorLevel()) {
          QLog.d("TogetherBusinessIPCModule", 2, "ACTION_SET_FLOATING " + " isShow=" + bool1 + " uin=" + paramString + " sessionType=" + paramInt + " refresh=" + bool2);
        }
      } while (!bool2);
      paramBundle = (ayna)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(339);
