...
public abstract class baqs
{
  int jdField_a_of_type_Int;
  baqp jdField_a_of_type_Baqp;
  ...
  public baqs(baqp parambaqp, int paramInt)
  {
    this.jdField_a_of_type_ComTencentMobileqqHighwayApiITransactionCallback = new baqt(this);
