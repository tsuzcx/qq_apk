...
public class mvz
  extends muq
{
  public mvz(Context paramContext, ArrayList<nbu> paramArrayList, mua parammua, String paramString1, String paramString2)
  {
  ...
  public static View a(Context paramContext, View paramView, ViewGroup paramViewGroup, nbt paramnbt, int paramInt, mua parammua, String paramString1, String paramString2)
  {
    ...
    if (paramnbt.size() % 2 != 0)
    {
      paramnbt.remove(paramnbt.size() - 1);
    ...
    for (;;)
    {
      ...
      if ((paramViewGroup == null) || (!(paramViewGroup instanceof mvz)) || (!((mvz)paramViewGroup).a(paramnbt))) {
        break label162;
      }
      paramContext = paramView;
      if (!QLog.isDevelopLevel()) {
    ...
    paramContext = new mvz(paramContext, paramnbt, parammua, paramString1, paramString2);
  ...
  private void a(LinearLayout paramLinearLayout)
  {
    ...
    int m = aciy.a(2.0F, (Resources)localObject1);
    int n = (((Resources)localObject1).getDisplayMetrics().widthPixels - m) / 2;
    int i1 = aciy.a(125.0F, (Resources)localObject1);
    int i = 0;
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      for (;;)
      {
        localObject2 = (nbu)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        ...
        ((URLImageView)localObject1).setBackgroundDrawable(URLDrawable.getDrawable(((nbu)localObject2).e, null, null, true));
        ...
        ((RelativeLayout.LayoutParams)localObject3).setMargins(aciy.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, aciy.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
        ((TextView)localObject1).setLayoutParams((ViewGroup.LayoutParams)localObject3);
        ((TextView)localObject1).setGravity(17);
        ((TextView)localObject1).setText(((nbu)localObject2).a);
