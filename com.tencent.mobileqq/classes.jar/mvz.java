...
public class mvz
{
  ...
  public mvz(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_ComTencentAvVideoEffectCoreQqavimageQQAVImageFilter = new mwb();
  ...
  mwa a(QQAVImageFilter paramQQAVImageFilter, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (paramQQAVImageFilter != null)
    {
      ...
      return new mwa(this, paramInt3, paramInt4);
    }
    return new mwa(this, paramInt1, paramInt2);
  }
