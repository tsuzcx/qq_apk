...
public class blnk
{
  private static blnk jdField_a_of_type_Blnk;
  private OnPluginInstallListener.Stub jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener$Stub = new blnl(this);
  ...
  private int a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      blpu.e("QRPluginManager", "PluginManager is NOT ready");
      return 0;
    }
    paramQQAppInterface = paramQQAppInterface.a("qqreaderplugin.apk");
    if (paramQQAppInterface == null)
    {
      blpu.e("QRPluginManager", "ReaderPlugin is NOT found");
      return 0;
    }
    return paramQQAppInterface.mState;
  }
  
  public static blnk a()
  {
    if (jdField_a_of_type_Blnk == null) {}
    try
    {
      if (jdField_a_of_type_Blnk == null) {
        jdField_a_of_type_Blnk = new blnk();
      }
      return jdField_a_of_type_Blnk;
    }
    finally {}
  }
  ...
  private void b()
  {
    if (BaseApplicationImpl.sProcessId != 1) {
      blpu.a("QRPluginManager", "checkMainProcess: 老插件的加载逻辑必须在主进程调用");
    }
  }
  ...
  {
    bcst.b(paramQQAppInterface, "P_CliOper", "VIP_QQREADER", "", "0X800604D", "0X800604D", 1, paramInt, "", "", "", "");
  }
  
  private void c(Context paramContext)
  {
    blpu.e("QRPluginManager", "load plugin start");
    ...
    blfh.b(paramContext, localblfq);
    blpu.e("QRPluginManager", "load plugin end");
  }
  ...
  private void d(Context paramContext)
  {
    ...
    blnh.a(paramContext, localIntent, "com.qqreader.pureader.EmptyActivity", new blnm(this));
  }
  
  public void a()
  {
    b();
    ((blfh)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(27)).a("qqreaderplugin.apk");
  }
  ...
  public void a(Context paramContext, int paramInt)
  {
    ...
    blpu.c("QRPluginManager", "launchPlugin: plugin state=" + i + ", launchType=" + paramInt);
    if (i == 4)
    {
    ...
    ((blfh)localQQAppInterface.getManager(27)).installPlugin("qqreaderplugin.apk", this.jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener$Stub);
  }
