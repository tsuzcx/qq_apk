...
public class qas
  extends pxl
{
  public qas(Context paramContext, bcws parambcws, rqj paramrqj)
  {
  ...
  public pxl d()
  {
    ...
    if ((this.jdField_a_of_type_Pxk != null) && ((this.jdField_a_of_type_Pxk instanceof ComponentContentBig)) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null))
    {
      ...
      ((LinearLayout.LayoutParams)localObject).setMargins(0, aekt.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, aekt.a(6.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      localLinearLayout2.setBackgroundResource(2130842499);
