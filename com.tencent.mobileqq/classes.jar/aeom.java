...
public class aeom
  extends andd
{
  public aeom(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  protected void onGetTroopFeeMemberList(boolean paramBoolean, List<cmd0x406.GroupFeeMember> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localaeox.a = (localGroupFeeMember.uint64_uin.get() + "");
      localaeox.jdField_b_of_type_JavaLangString = localGroupFeeMember.string_nick_name.get();
      if (this.a.jdField_a_of_type_Azwa != null) {
        this.a.jdField_a_of_type_Azwa.a(localaeox);
      }
      localArrayList.add(localaeox);
    }
  ...
  {
    if (!bftf.a(String.valueOf(paramLong1), this.a.jdField_b_of_type_JavaLangString)) {}
    do
    {
      return;
      if (QLog.isColorLevel())
  ...
  protected void onOIDB0X899_1_Ret(boolean paramBoolean, long paramLong1, int paramInt1, List<oidb_0x899.memberlist> paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo != null) && (this.a.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.isHomeworkTroop()))
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.troopowneruin != null) {
        this.a.jdField_e_of_type_JavaLangString = this.a.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.troopowneruin;
      }
      this.a.f = TroopUtils.getTroopAdministrator(this.a.app, this.a.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo, paramList, false);
      paramList = this.a;
