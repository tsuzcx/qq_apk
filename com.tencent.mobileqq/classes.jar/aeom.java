...
public class aeom
{
  private static final String jdField_a_of_type_JavaLangString = aeom.class.getSimpleName();
  private static final byte[] jdField_a_of_type_ArrayOfByte = new byte[0];
  private aeoj jdField_a_of_type_Aeoj;
  private SharedPreferences jdField_a_of_type_AndroidContentSharedPreferences;
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  public aeom(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) {
      this.jdField_a_of_type_Aeoj = ((aeoj)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(321));
    }
  ...
  private void a(File paramFile)
  {
    ...
    if (paramFile.length > 0)
    {
      ...
      if ((localObject != null) && (((File)localObject).isFile()) && (((File)localObject).exists()))
      {
        ...
        if (bdhb.d(paramFile[0].getAbsolutePath())) {
  ...
  private File[] a(File paramFile)
  {
    ...
    Arrays.sort(paramFile, new aeon(this));
    return paramFile;
  }
  ...
  private void b(AcsMsg paramAcsMsg)
  {
    if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) && (paramAcsMsg != null))
    {
      ...
      this.jdField_a_of_type_Aeoj.a(paramAcsMsg.hashCode());
    }
    while ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface))
    {
      ...
      localQQAppInterface.a().b(alof.ad, 9002, paramAcsMsg.msg_id.hashCode());
  ...
  {
    paramFile = paramFile.listFiles(new aeoo(this));
  ...
  public List<AcsMsg> a()
  {
    ...
    if (arrayOfFile.length > 0)
    {
      ...
      while (i < j)
      {
        ...
        if ((localObject != null) && (((File)localObject).isFile()) && (((File)localObject).exists()) && (aeno.a(a((File)localObject))))
        {
          localObject = a((File)localObject);
  ...
  public void a(AcsMsg paramAcsMsg)
  {
    ...
    //   8: return
    //   9: aload_0
    //   10: getfield 39	aeom:jdField_a_of_type_Aeoj	Laeoj;
    //   13: ifnonnull +20 -> 33
    //   16: aload_0
    //   17: aload_0
    //   18: getfield 29	aeom:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   21: sipush 321
    //   24: invokevirtual 35	com/tencent/common/app/AppInterface:getManager	(I)Lmqq/manager/Manager;
    //   27: checkcast 37	aeoj
    //   30: putfield 39	aeom:jdField_a_of_type_Aeoj	Laeoj;
    //   33: aload_0
    //   34: getfield 39	aeom:jdField_a_of_type_Aeoj	Laeoj;
    //   37: ifnull +35 -> 72
    //   40: aload_0
    //   41: getfield 39	aeom:jdField_a_of_type_Aeoj	Laeoj;
    //   44: aload_1
    //   45: invokevirtual 314	aeoj:a	(LWallet/AcsMsg;)V
    //   48: new 316	com/tencent/mobileqq/activity/activateFriend/biz/ReminderDataManager$1
    //   51: dup
    //   52: aload_0
    //   53: aload_1
    //   54: invokespecial 318	com/tencent/mobileqq/activity/activateFriend/biz/ReminderDataManager$1:<init>	(Laeom;LWallet/AcsMsg;)V
    //   57: bipush 64
    //   59: aconst_null
    //   60: iconst_1
    ...
    //   71: athrow
    //   72: aload_1
    //   73: invokestatic 319	ajem:a	(LWallet/AcsMsg;)V
    //   76: goto -28 -> 48
    //   79: astore_2
    //   80: aload_2
  ...
  public void a(String paramString, aeoq paramaeoq)
  {
    try
    {
      ThreadManagerV2.excute(new ReminderDataManager.5(this, paramString, paramaeoq), 64, null, true);
      return;
    }
    finally
    {
  ...
  public void a(String paramString, aeor paramaeor)
  {
    try
    {
      aeol.b(paramString, new aeop(this, paramaeor));
      return;
    }
