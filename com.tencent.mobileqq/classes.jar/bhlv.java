...
{
  private static final int jdField_b_of_type_Int = aciy.a(20.0F, BaseApplicationImpl.getContext().getResources());
  private static final int c = aciy.a(12.0F, BaseApplicationImpl.getContext().getResources());
  ...
  public bhlv(int paramInt, List<String> paramList, Typeface paramTypeface, Bitmap paramBitmap)
  {
    super(paramInt, paramList);
    this.jdField_a_of_type_AndroidTextTextPaint.setAntiAlias(true);
    this.jdField_a_of_type_AndroidTextTextPaint.setTypeface(paramTypeface);
    this.jdField_a_of_type_AndroidTextTextPaint.setTextSize(aciy.a(20.0F, BaseApplicationImpl.getContext().getResources()));
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    int j = (int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(ajjy.a(2131635423));
    this.jdField_a_of_type_AndroidTextStaticLayout = bhno.a(paramString, 0, paramString.length(), this.jdField_a_of_type_AndroidTextTextPaint, j, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, 3);
    ...
    urk.b("BubbleTextItem", "set text " + paramString + " max " + j + " tw " + f1 + " th " + f2);
  }
