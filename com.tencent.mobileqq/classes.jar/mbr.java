...
public class mbr
  extends ankx
{
  public mbr(ConferenceFlyTicketActivity paramConferenceFlyTicketActivity) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong1, String paramString1, String paramString2, long paramLong2)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        this.a.jdField_a_of_type_Mbs = new mbs(this.a);
        paramString1 = new ArrayList();
        mun localmun = new mun();
        localmun.jdField_a_of_type_JavaLangString = ("https://pubacc.mobile.qq.com/mqqweb-rtx2qq/mqqweb/createConfCallback?feedkey=" + this.a.b);
        ...
        localmun.jdField_a_of_type_JavaLangString = (localmun.jdField_a_of_type_JavaLangString + "&ret=0&ticket=" + this.a.d);
        paramString1.add(localmun);
        this.a.jdField_a_of_type_Mbs.execute(new ArrayList[] { paramString1 });
      }
      return;
    }
    this.a.jdField_a_of_type_Anks.c(paramLong2);
    this.a.a(1, paramInt);
  }
  ...
  protected void a(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (!TextUtils.isEmpty(this.a.h)) {
        ((anks)this.a.app.a(6)).a(paramLong);
      }
      return;
    }
    this.a.a(1, paramInt);
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      {
        this.a.c();
        AudioHelper.b(anni.a(2131701186));
        ((anks)this.a.app.a(6)).a(l);
        return;
      }
      this.a.finish();
      return;
