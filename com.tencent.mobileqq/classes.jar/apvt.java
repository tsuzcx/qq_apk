...
public class apvt
{
  ...
  public static apvt a(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      try
      {
        paramString = new apvt().a(new JSONObject(paramString));
        return paramString;
      }
    ...
    paramString = new apvt();
    paramString.jdField_a_of_type_Boolean = true;
    return paramString;
  }
  
  private apvt a(JSONObject paramJSONObject)
  {
