...
{
  private aauu(GdtVideoCommonView paramGdtVideoCommonView) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (GdtVideoCommonView.d(this.a))
    {
      ...
      aase.a("GdtVideoCommonView", "SilentModeReceiver first auto called! so skip!");
    }
    ...
    aase.a("GdtVideoCommonView", "system context mode: " + i);
    switch (i)
    {
    default: 
      this.a.b = true;
