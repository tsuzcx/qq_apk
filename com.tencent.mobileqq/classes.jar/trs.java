...
{
  public trs(SubLoginActivity paramSubLoginActivity) {}
  ...
  protected void onGetKeyBack(String paramString1, String paramString2, String paramString3)
  {
    ...
    else
    {
      ...
      this.a.c();
      this.a.b(this.a.getString(2131436339));
      this.a.runOnUiThread(new trv(this));
    }
    for (;;)
    {
      return;
  ...
  protected void onLoginFailed(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      {
        this.a.c();
        this.a.runOnUiThread(new tru(this));
        if (TextUtils.isEmpty(paramString4))
        {
          this.a.b(this.a.getString(2131433196));
          return;
  ...
  public void onLoginSuccess(String paramString1, String paramString2, String paramString3)
  {
    ...
    ThreadManager.post(new trt(this, paramString2), 8, null, true);
  }
