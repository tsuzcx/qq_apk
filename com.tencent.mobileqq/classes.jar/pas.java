...
public class pas
{
  ...
  {
    int i = bfyz.O(BaseApplicationImpl.getApplication(), pay.a());
    int j = a();
  ...
  private static void a(SharedPreferences paramSharedPreferences)
  {
    ...
    {
      List localList = rgp.a(paramSharedPreferences.getAll().keySet(), new pat());
  ...
  public static void d()
  {
    ...
    if (localObject != null)
    {
      ...
      if (((SharedPreferences.Editor)localObject).commit())
      {
        ...
        localObject = bkwm.a(pay.a(), false, true);
        if (localObject == null) {
          break label138;
        }
        localObject = ((SharedPreferences)localObject).edit();
  ...
  public static void e()
  {
    ...
    try
    {
      EntityManagerFactory localEntityManagerFactory = pkm.a().a();
  ...
  private static void g()
  {
    ...
    SettingCloneUtil.writeValue(BaseApplicationImpl.getApplication(), pay.a(), null, "qqsetting_kandian_download_pic_flag", false);
  ...
  private static void h()
  {
    ...
    Object localObject = new File(bhwr.e());
    ...
    try
    {
      localObject = (ran)pay.a().getManager(271);
      if (localObject != null)
      {
        ((ran)localObject).b();
  ...
  private static void j()
  {
    ...
    try
    {
      Object localObject = ((QQAppInterface)pay.a()).getMessageFacade();
      ...
      localObject = bkwm.a((QQAppInterface)pay.a(), 1);
      if (localObject != null)
      {
