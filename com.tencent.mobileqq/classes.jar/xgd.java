  ...
  implements xge
{
  ...
  public xgd(Context paramContext)
  {
    this.jdField_a_of_type_Xgf = new xgf(paramContext, "config_db", null, 15);
  }
  ...
  public int a(Uri paramUri, String paramString, ContentValues[] paramArrayOfContentValues)
  {
    ...
    //   17: lstore 7
    //   19: aload_0
    //   20: getfield 31	xgd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   44: astore 11
    //   46: aload_0
    //   47: getfield 31	xgd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   50: aload_2
    //   51: ldc 55
    //   53: aload 11
    ...
    //   119: aload_0
    //   120: getfield 31	xgd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   123: invokevirtual 94	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   126: aload_0
    //   127: invokevirtual 41	xgd:a	()V
    //   130: iload 4
    //   132: ireturn
    //   133: iload 5
    //   135: iconst_1
    ...
    //   145: goto -112 -> 33
    //   148: aload_0
    //   149: getfield 31	xgd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   214: aload_0
    //   215: getfield 31	xgd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   218: invokevirtual 94	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   221: goto -95 -> 126
    //   224: astore_1
    //   225: aload_0
    //   226: getfield 31	xgd:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
  ...
  public boolean a()
  {
    ...
    try
    {
      this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase = this.jdField_a_of_type_Xgf.getWritableDatabase();
      if (this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase != null)
      {
        bool1 = bool2;
        if (this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase.isOpen()) {}
  ...
  public boolean b()
  {
    ...
    try
    {
      this.jdField_b_of_type_AndroidDatabaseSqliteSQLiteDatabase = this.jdField_a_of_type_Xgf.getReadableDatabase();
      if (this.jdField_b_of_type_AndroidDatabaseSqliteSQLiteDatabase != null)
      {
        bool1 = bool2;
        if (this.jdField_b_of_type_AndroidDatabaseSqliteSQLiteDatabase.isOpen()) {}
