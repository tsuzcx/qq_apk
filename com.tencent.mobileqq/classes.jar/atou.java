  ...
  extends atnt
{
  ...
  protected void a(int paramInt, String paramString)
  {
    ...
    atno.b(this.jdField_a_of_type_Atno, 10, 12);
    atno.c(this.jdField_a_of_type_Atno, 10, 12);
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_Atno.jdField_a_of_type_Long + "] state change :(" + this.jdField_a_of_type_Atnt.a() + "->StateExcepInvalidWhenPause)");
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    atno.b(this.jdField_a_of_type_Atno, 10, 10);
    atno.c(this.jdField_a_of_type_Atno, 10, 10);
    ...
    this.jdField_a_of_type_Atnt = new atnx(this.jdField_a_of_type_Atno);
  ...
  protected void b()
  {
    ...
    atno.b(this.jdField_a_of_type_Atno, 10, 9);
    atno.c(this.jdField_a_of_type_Atno, 10, 9);
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_Atno.jdField_a_of_type_Long + "] state change :(" + this.jdField_a_of_type_Atnt.a() + "->StateCancelUploadWhenPause)");
