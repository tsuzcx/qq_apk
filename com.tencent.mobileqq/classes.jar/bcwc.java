...
public class bcwc
{
  private static final SparseArray<Class<? extends bcvt>> jdField_a_of_type_AndroidUtilSparseArray;
  private static HashMap<String, Class<? extends bcvs>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  
  static
  {
    jdField_a_of_type_JavaUtilHashMap.put("pavideo", bdak.class);
    jdField_a_of_type_JavaUtilHashMap.put("video", bdaz.class);
    jdField_a_of_type_JavaUtilHashMap.put("picture", bcxv.class);
    jdField_a_of_type_JavaUtilHashMap.put("title", StructMsgItemTitle.class);
    jdField_a_of_type_JavaUtilHashMap.put("summary", bdaq.class);
    jdField_a_of_type_JavaUtilHashMap.put("timer", bdau.class);
    jdField_a_of_type_JavaUtilHashMap.put("hr", bcxx.class);
    jdField_a_of_type_JavaUtilHashMap.put("image", bcxy.class);
    jdField_a_of_type_JavaUtilHashMap.put("more", bdae.class);
    jdField_a_of_type_JavaUtilHashMap.put("progress", bdao.class);
    jdField_a_of_type_JavaUtilHashMap.put("checklist", bdbi.class);
    jdField_a_of_type_JavaUtilHashMap.put("vote", bdbk.class);
    jdField_a_of_type_JavaUtilHashMap.put("price", bdan.class);
    jdField_a_of_type_JavaUtilHashMap.put("button", bcxp.class);
    jdField_a_of_type_JavaUtilHashMap.put("remark", bdap.class);
    jdField_a_of_type_JavaUtilHashMap.put("paaudio", bdaf.class);
    jdField_a_of_type_JavaUtilHashMap.put("textButton", bdas.class);
    jdField_a_of_type_JavaUtilHashMap.put("content", bcxu.class);
    jdField_a_of_type_JavaUtilHashMap.put("tips", bcxh.class);
    jdField_a_of_type_JavaUtilHashMap.put("live", bcxb.class);
    jdField_a_of_type_JavaUtilHashMap.put("tr", bdax.class);
    jdField_a_of_type_JavaUtilHashMap.put("td", bdar.class);
    jdField_a_of_type_JavaUtilHashMap.put("head", bcxo.class);
    jdField_a_of_type_JavaUtilHashMap.put("type", bday.class);
    jdField_a_of_type_JavaUtilHashMap.put("tag", bcxf.class);
    jdField_a_of_type_JavaUtilHashMap.put("taglist", bcxg.class);
    jdField_a_of_type_JavaUtilHashMap.put("group", bcwv.class);
    jdField_a_of_type_JavaUtilHashMap.put("groupitem", bcwx.class);
    jdField_a_of_type_JavaUtilHashMap.put("voice", bcxi.class);
    jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
    jdField_a_of_type_AndroidUtilSparseArray.append(0, bczv.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(1, bcxz.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(2, bcyl.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(3, bczf.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(4, bczm.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(5, bczn.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(6, bczp.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(7, bczr.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(8, bczt.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(9, bczu.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(10, bcya.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(11, bcyc.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(12, bcye.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(18, bcyi.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(19, bcyk.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(20, bcym.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(21, bcyp.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(22, bcyq.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(23, bcyr.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(24, bcyt.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(25, bcyw.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(26, bcyx.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(27, bcyy.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(28, bcyz.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(29, bczc.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(30, bczg.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(31, bczi.class);
  }
  
  public static bcvs a(String paramString)
  {
    return a(paramString, 0);
  }
  
  /* Error */
  public static bcvs a(String paramString, int paramInt)
  {
    // Byte code:
    //   0: ldc 212
    //   2: aload_0
    ...
    //   6: ifne +72 -> 78
    //   9: getstatic 18	bcwc:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   12: aload_0
    ...
    //   76: aload_3
    //   77: areturn
    //   78: getstatic 143	bcwc:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   81: iload_1
  ...
  /* Error */
  public static bcvt a(int paramInt)
  {
    // Byte code:
    //   0: getstatic 143	bcwc:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   3: iload_0
