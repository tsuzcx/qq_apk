  ...
  extends DynamicDrawableSpan
{
  ...
  private bevt(Context paramContext, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, int paramInt, Paint paramPaint, View.OnClickListener paramOnClickListener)
  {
    super(0);
  ...
  public static bevt a(QQAppInterface paramQQAppInterface, Context paramContext, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, int paramInt, Paint paramPaint, View.OnClickListener paramOnClickListener)
  {
    ...
    return new bevt(paramContext, paramSourceMsgInfo, paramInt, paramPaint, paramOnClickListener);
  }
  ...
  private void a(Paint paramPaint)
  {
    ...
    do
    {
      do
      {
        ...
        paramPaint.append(bgdk.a(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, ChatTextSizeSettingActivity.a(), null, 7));
        localObject = new TextView(this.jdField_a_of_type_AndroidContentContext);
        ((TextView)localObject).setSingleLine();
        ((TextView)localObject).setEllipsize(TextUtils.TruncateAt.END);
        ((TextView)localObject).setBackgroundDrawable(((TextView)localObject).getResources().getDrawable(2130838295));
        ((TextView)localObject).setGravity(16);
        i = ((TextView)localObject).getResources().getColor(2131167112);
        ...
        i = (int)bfvh.a(this.jdField_a_of_type_AndroidContentContext, 6.0F);
        j = (int)bfvh.a(this.jdField_a_of_type_AndroidContentContext, 23.0F);
