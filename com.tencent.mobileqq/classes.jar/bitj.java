  ...
  extends Drawable
{
  ...
  public bitj(Bitmap paramBitmap)
  {
  ...
  {
    if ((paramDrawable == null) || ((paramDrawable instanceof bitj))) {}
    Object localObject;
    do
    {
    ...
    return new bitj((Bitmap)localObject);
  }
  
  public static bitj a(Bitmap paramBitmap)
  {
    if (paramBitmap != null) {
      return new bitj(paramBitmap);
    }
    return null;
  }
  ...
  {
    float f1 = 0.0F;
    switch (bitk.a[this.jdField_a_of_type_AndroidWidgetImageView$ScaleType.ordinal()])
    {
    case 4: 
    default: 
      this.d.set(this.c);
  ...
  public bitj a(float paramFloat)
  {
  ...
  public bitj a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    int j = 1;
  ...
  public bitj a(ColorStateList paramColorStateList)
  {
  ...
  public bitj a(Shader.TileMode paramTileMode)
  {
  ...
  public bitj a(ImageView.ScaleType paramScaleType)
  {
  ...
  public bitj a(boolean paramBoolean)
  {
    this.jdField_b_of_type_Boolean = paramBoolean;
    return this;
  }
  
  public bitj b(Shader.TileMode paramTileMode)
  {
