  ...
  extends amiz
{
  ...
  public aucv(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public static MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte)
  {
    ...
    if (((Long)((Pair)localObject2).first).longValue() != 4294967295L)
    {
      ...
      if (((!ayvy.c(k)) && (k != 208) && (k != 529)) || (!paramArrayOfByte.c2c_cmd.has())) {
        break label554;
      }
    ...
    for (;;)
    {
      ...
      {
        ayvu.a(localMessageHandler, localArrayList, localMsg);
        break label1259;
        int m = ayvu.a(localMsg);
        ...
        if (paramArrayOfByte.hasNext())
        {
          ...
          Object localObject1;
          ((MessageRecord)localObject2).vipBubbleID = alxl.a((int)localObject1, m);
          ...
          ayvu.a(localMessageHandler, localArrayList, localMsg, true, false, null);
          continue;
          label554:
          ...
          if (!paramQQAppInterface.a().a().a(localArrayList, localMsg)) {
            ayvu.a(localMessageHandler, localArrayList, localMsg, false, false, null);
          }
          ...
          ayvu.a(localMessageHandler, localMsg, localArrayList);
          break label1296;
          label972:
    ...
    for (;;)
    {
      ...
      do
      {
        if (aljq.z.equals(Long.valueOf(l3)))
        {
          ((MessageRecord)localObject2).istroop = 6000;
          break label452;
        }
        if (aljq.A.equals(Long.valueOf(l3)))
        {
        ...
        break label452;
        alsh.a(localArrayList);
        if (localArrayList.size() > 0) {
          return (MessageRecord)localArrayList.get(0);
        }
        aufh.a("MsgBackup_msgproxy", "transToMessageRecord failed.........", new Object[0]);
        return null;
        break label303;
        break label303;
        do
  ...
  public static msg_comm.MsgHead a(MessageRecord paramMessageRecord, long paramLong)
  {
    ...
    Object localObject = abot.c(paramMessageRecord);
    for (;;)
    {
      try
      {
  ...
  public static im_msg_body.MsgBody a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    if ((paramMessageRecord.msgtype == -1000) || (paramMessageRecord.msgtype == -10000)) {
      if (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("sens_msg_source_msg_info"))) {
        paramQQAppInterface = ayvu.a(paramMessageRecord);
      }
    }
    label965:
    for (;;)
    {
      if ((paramQQAppInterface != null) && (!paramQQAppInterface.elems.isEmpty()))
      {
        ...
        paramQQAppInterface = ayvu.a((MessageForText)paramMessageRecord);
        continue;
        if (paramMessageRecord.msgtype == -1049)
        {
          paramQQAppInterface = ayvu.a((MessageForReplyText)paramMessageRecord);
          continue;
        }
        ...
        {
          paramQQAppInterface = ayvu.a((MessageForQQStoryComment)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2000)
        {
          paramQQAppInterface = ayvu.a((MessageForPic)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -5008)
        {
          paramQQAppInterface = ayvu.a((MessageForArkApp)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5016)
        {
          paramQQAppInterface = ayvu.c((MessageForArkBabyqReply)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5017)
        {
          paramQQAppInterface = ayvu.b((MessageForArkApp)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5013)
        {
          paramQQAppInterface = ayvu.c((MessageForArkFlashChat)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -5014)
        {
          paramQQAppInterface = ayvu.d((MessageForHiBoom)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2011)
        {
          paramQQAppInterface = ayvu.a((MessageForStructing)paramMessageRecord);
        ...
        if (paramMessageRecord.msgtype == -1035)
        {
          ...
          while (i < k)
          {
            ...
            {
              localObject1 = ayvu.a((MessageForText)localObject1);
        ...
        {
          paramQQAppInterface = ayvu.a((MessageForLongTextMsg)paramMessageRecord, false);
          continue;
        }
        ...
        else
        {
          ...
          {
            paramQQAppInterface = ayvu.a((MessageForMarketFace)paramMessageRecord);
            continue;
          }
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    catch (Throwable paramQQAppInterface)
    {
      for (;;)
      {
        ...
        azlf.a(paramQQAppInterface, "MsgBackup_msgproxy,mr = " + paramMessageRecord.getClass().getSimpleName());
        paramQQAppInterface = null;
      }
  ...
  public MessageRecord a(@NonNull MsgBackupMsgEntity paramMsgBackupMsgEntity)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject4 = new bbku();
        ((bbku)localObject4).jdField_a_of_type_Int = aufh.c(paramMsgBackupMsgEntity.chatType);
        localMessageHandler = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        localObject5 = ayvu.a(localMessageHandler, localMsg, String.valueOf(l5), String.valueOf(l4));
        if (((Long)((Pair)localObject5).first).longValue() != 4294967295L)
        {
          l1 = ((Long)((Pair)localObject5).first).longValue();
          break label1546;
          localObject5 = new ArrayList();
          if (((!ayvy.c(i1)) && (i1 != 208) && (i1 != 529)) || (!((msg_comm.MsgHead)localObject2).c2c_cmd.has())) {
            break label809;
          }
          ...
          if (i1 == 208)
          {
            ayvu.a(localMessageHandler, (List)localObject5, localMsg);
            l1 = l3;
          }
          int m = 0;
          int i2 = ayvu.a(localMsg);
          ...
          Object localObject1;
          ((MessageRecord)localObject4).vipBubbleID = alxl.a((int)localObject1, i2);
      ...
      ayvu.a(localMessageHandler, (List)localObject5, localMsg, true, false, (bbku)localObject4);
      continue;
      label809:
      ...
      if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((ArrayList)localObject5, localMsg)) {
        ayvu.a(localMessageHandler, (List)localObject5, localMsg, false, false, (bbku)localObject4);
      }
      ...
      ayvu.a(localMessageHandler, localMsg, (List)localObject5);
      break label1585;
    ...
    for (;;)
    {
      ...
      do
      {
        if (aljq.z.equals(Long.valueOf(l5))) {
  ...
  public MsgBackupMsgEntity a(@NonNull MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      {
        aufh.a("transBackupEntity error,mr = %s ", paramMessageRecord.toString(), new Object[0]);
        return null;
      }
    }
    catch (Throwable localThrowable)
    {
      ...
      {
        QLog.e("MsgBackup_msgproxy", 1, "transToBackupEntity,getMsgBody error mr = " + paramMessageRecord.getClass().getSimpleName());
        azlf.a(localThrowable, "MsgBackup_msgproxy,mr = " + paramMessageRecord.getClass().getSimpleName());
        localObject2 = null;
      }
      localMsg.msg_head.set(localMsgHead);
      ...
      ((MsgBackupMsgEntity)localObject2).chatType = aufh.b(paramMessageRecord.istroop);
      ((MsgBackupMsgEntity)localObject2).msgType = aufh.a(paramMessageRecord.msgtype);
    ...
    if (paramMessageRecord.istroop == 3000)
    {
      ...
      paramMessageRecord = auck.a(i);
      if (paramMessageRecord != null) {
        break label402;
      }
      paramMessageRecord = localMsg.toByteArray();
      auck.a(paramMessageRecord);
    }
    label363:
    ...
    {
      return localObject2;
      i = ayvy.b(paramMessageRecord.msgUid);
