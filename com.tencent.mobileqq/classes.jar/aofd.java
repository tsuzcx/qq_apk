  ...
  extends acvo
{
  ...
  public aofd(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private MessageRecord a(MsgInfo paramMsgInfo, long paramLong)
  {
    ...
    long l1 = bgva.a((byte[])localObject6, 0);
    byte b = localObject6[4];
    Object localObject5 = new ArrayList();
    Object localObject4 = (anks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
    Object localObject1 = (anmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
    Object localObject7 = (ankw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
    ...
    case 9: 
      do
      {
        ...
        {
          return null;
          paramLong = bgva.a((byte[])localObject6, 5);
          l2 = bgva.a((byte[])localObject6, 9);
          ...
          ((anks)localObject4).a(l1);
          i = ((ankw)localObject7).a(l1 + "");
        } while (((ankw)localObject7).a(String.valueOf(l1), String.valueOf(l2)));
        if (QLog.isColorLevel()) {
        ...
        if ((TextUtils.isEmpty((CharSequence)localObject1)) || (bglf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1))))
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.DiscMsgPc.discuss", 2, "coptype 2 server memberName empty");
          }
          localObject1 = bglf.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), (String)localObject6);
        }
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691631, new Object[] { localObject1 });
        ((List)localObject5).add(localObject6);
        ((anks)localObject4).a(l1, (String)localObject6, (List)localObject5, 10009);
        if (((String)localObject6).equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
        {
          ((ankw)localObject7).a(String.valueOf(l1), String.valueOf(l3));
          a(b, l1, l3);
          ((anks)localObject4).a(String.valueOf(l1));
          return null;
        }
        ((anks)localObject4).a(l1);
        ((ankw)localObject7).a(String.valueOf(l1), String.valueOf(l3));
        ...
        l2 = bgva.a((byte[])localObject6, 5);
        k = bgva.a((byte[])localObject6, 13);
        localObject3 = new ArrayList();
        j = 15;
        for (i = 1; i < k + 1; i = (short)(i + 1))
        {
          localObject7 = (String)((ArrayList)localObject1).get(i);
          l3 = bgva.a((byte[])localObject6, j);
          j += 4;
          ((List)localObject5).add(String.valueOf(l3));
          ((ArrayList)localObject3).add(new Pair(String.valueOf(l3), localObject7));
        }
        localObject6 = new ankv();
        ((ankv)localObject6).jdField_b_of_type_Int = ((ArrayList)localObject1).size();
        ((ankv)localObject6).jdField_a_of_type_JavaLangString = String.valueOf(l1);
        ((anks)localObject4).a((ankv)localObject6);
        ((anks)localObject4).a(l1, String.valueOf(l2), (List)localObject5, 10004);
        ...
        if ((RecentUser)((aong)localObject6).findRecentUser(Long.toString(l1), 3000) != null)
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.DiscMsgPc.discuss", 2, "handleDiscussionMemchangeMsg ru alreadyintab");
          }
          if (bglf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1)))
          {
        ...
        localObject5 = (RecentUser)((aong)localObject6).findRecentUserByUin(Long.toString(l1), 3000);
        aldk.a((RecentUser)localObject5, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a());
        ...
        ((aong)localObject6).saveRecentUser((BaseRecentUser)localObject5);
        if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          ...
          if (TextUtils.equals((CharSequence)localObject6, String.valueOf(l2)))
          {
            ...
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Multi_call", "Show_discuss_tips", 0, 0, "", "", "", "");
          }
          else
          {
            b((Pair)localObject4, paramMsgInfo, (ArrayList)localObject3, paramLong, String.valueOf(l1), b, true);
        ...
        l2 = bgva.a((byte[])localObject6, 5);
        l3 = bgva.a((byte[])localObject6, 9);
        bgva.a((byte[])localObject6, 13);
        i = bgva.a((byte[])localObject6, 17);
        localObject1 = new byte[i];
        bgva.b((byte[])localObject6, 19, (byte[])localObject1, i);
        ...
        if (l2 == paramLong)
        {
          localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691595, new Object[] { localObject5 });
          ((anks)localObject4).a(String.valueOf(l1), (String)localObject5);
          a(paramMsgInfo, paramLong, l1, l2, (String)localObject1);
          return null;
        }
        localObject3 = "";
        localObject1 = ((ankw)localObject7).a(String.valueOf(l1));
        if ((localObject1 != null) && (((DiscussionInfo)localObject1).isDiscussHrMeeting())) {
          localObject1 = bgoo.a((ankw)localObject7, ((DiscussionInfo)localObject1).uin, String.valueOf(l2));
        }
        for (;;)
        {
          ...
          if (TextUtils.isEmpty((CharSequence)localObject1))
          {
            ...
            localObject3 = bglf.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), String.valueOf(l2));
          }
          localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691596, new Object[] { localObject3, localObject5 });
          break;
          localObject1 = localObject3;
          if (paramMsgInfo.vNickName != null)
          {
      ...
      } while (bgva.a((byte[])localObject6, 5) == 0);
      k = bgva.a((byte[])localObject6, 7);
      localObject4 = new ArrayList();
      i = 9;
      j = 0;
      while (j < k)
      {
        l3 = bgva.a((byte[])localObject6, i);
        localObject3 = "";
        localObject1 = localObject3;
        if (paramMsgInfo.vNickName != null)
        {
      ...
      j = bgva.a((byte[])localObject6, i);
      localObject1 = new byte[j];
      bgva.b((byte[])localObject6, i + 2, (byte[])localObject1, j);
    ...
    case 22: 
      l3 = bgva.a((byte[])localObject6, 5);
      bgva.a((byte[])localObject6, 9);
      l4 = bgva.a((byte[])localObject6, 13);
      l5 = bgva.a((byte[])localObject6, 17);
      if (l5 == 0L) {
        break;
      }
    }
    for (int i = 1;; i = 0)
    {
      ...
      default: 
        ...
        if ((RecentUser)((aong)localObject1).findRecentUser(Long.toString(l1), 3000) != null) {
          return null;
        }
        break;
      case 0: 
      ...
      case 2: 
        ...
        localObject1 = new ankv();
        ((ankv)localObject1).jdField_b_of_type_Int = k;
        ((ankv)localObject1).jdField_a_of_type_JavaLangString = String.valueOf(l1);
        ((anks)localObject4).a((ankv)localObject1);
        ...
        for (i = 1;; i = 0)
        {
          ...
          while (i < k)
          {
            String str = String.valueOf(bgva.a((byte[])localObject6, j));
            localObject3 = "";
            localObject1 = localObject3;
            if (paramMsgInfo.vNickName != null)
            {
        ...
        for (;;)
        {
          ((anks)localObject4).a(l1, String.valueOf(l3), (List)localObject5, i);
          if (this.jdField_a_of_type_AndroidOsHandler == null) {
            this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper());
          }
      ...
      localObject3 = (RecentUser)((aong)localObject1).findRecentUserByUin(Long.toString(l1), 3000);
      ...
      ((aong)localObject1).saveRecentUser((BaseRecentUser)localObject3);
      return null;
      i = localObject6.length - 5;
      localObject1 = new byte[i];
      bgva.b((byte[])localObject6, 5, (byte[])localObject1, i);
      localObject3 = new oidb_0x858.NotifyMsgBody();
      paramMsgInfo = (MessageForQQWalletTips)bbzh.a(-2029);
      try
      {
        ...
        paramMsgInfo.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), l2 + "", "", "[QQWallet Tips]", bbyp.a(), -2029, 3000, bbyp.a());
      ...
      return null;
      bgva.a((byte[])localObject6, 5);
      bgva.a((byte[])localObject6, 9);
      i = localObject6[13];
      return null;
      l3 = bgva.a((byte[])localObject6, 5);
      l4 = bgva.a((byte[])localObject6, 9);
      i = bgva.a(localObject6[13]);
      bgva.a((byte[])localObject6, 14, i);
      i += 14;
      k = bgva.a((byte[])localObject6, i);
      j = i + 2;
      Object localObject2 = new HashSet();
      i = 0;
      while (i < k)
      {
        l5 = bgva.a((byte[])localObject6, j);
        j += 4;
      ...
      localObject3 = (anks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
      ...
      if (((HashSet)localObject2).contains(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
      {
        ...
        for (;;)
        {
          ((anks)localObject3).a(l1, String.valueOf(l3), (List)localObject5, 10005);
          return null;
          ((anks)localObject3).a((String)localObject4);
          a(paramMsgInfo, paramLong, l2, l2, anni.a(2131702121));
        }
      }
      ((anks)localObject3).a((String)localObject4, (HashSet)localObject2);
      if (Long.getLong((String)localObject4) != null) {}
      for (paramLong = Long.getLong((String)localObject4).longValue();; paramLong = 0L)
      {
        ((anks)localObject3).a(paramLong);
        break;
      }
      l4 = bgva.a((byte[])localObject6, 5);
      l3 = bgva.a((byte[])localObject6, 9);
      if (QLog.isColorLevel()) {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        localObject2 = bglf.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), (String)localObject7);
      }
      for (;;)
      {
        k = bgva.a((byte[])localObject6, 13);
        ...
        if (((HashSet)localObject8).size() > 0)
        {
          ...
          while (((Iterator)localObject6).hasNext())
          {
            ...
            ((StringBuffer)localObject3).append(bglf.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), (String)localObject9)).append("、");
          }
        }
        ...
        {
          localObject6 = (anks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
          ((anks)localObject6).a(l1, (String)localObject7, (List)localObject5, 10005);
          localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691628, new Object[] { localObject3 });
          if (((HashSet)localObject8).contains(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
          {
            ...
            ((anks)localObject6).a(String.valueOf(l1));
            a(paramMsgInfo, paramLong, l2, l2, anni.a(2131702120));
            return null;
          }
          localObject2 = (String)localObject2 + anni.a(2131702119) + (String)localObject3;
          ((anks)localObject6).a(String.valueOf(l1), (HashSet)localObject8);
          ((anks)localObject4).a(l1);
          a(paramMsgInfo, paramLong, l2, l2, (String)localObject2);
          return null;
          i = (int)bgva.a((byte[])localObject6, 5);
          paramMsgInfo = new byte[i];
          bgva.b((byte[])localObject6, 9, paramMsgInfo, i);
          ...
          try
          {
            ...
            case 2: 
              ...
              if (((ankw)localObject7).jdField_a_of_type_JavaUtilMap != null)
              {
                ((ankw)localObject7).jdField_a_of_type_JavaUtilMap.put(localObject3, new String[] { localObject2, paramMsgInfo });
                ((ankw)localObject7).jdField_a_of_type_JavaUtilSet.add(localObject2);
              }
              if (QLog.isColorLevel()) {
              ...
              ((anks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).a(String.valueOf(l1));
              if ((BaseActivity.sTopActivity instanceof SplashActivity)) {}
              ((anie)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).notifyUI(41, true, new Object[] { Integer.valueOf(2131695441), localObject3, localObject2, Boolean.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c().equals(paramMsgInfo)) });
            }
          }
  ...
  private MessageRecord a(MsgInfo paramMsgInfo, SvcReqPushMsg paramSvcReqPushMsg)
  {
    ...
    if ((paramMsgInfo != null) && (!anqc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMsgInfo, true))) {
      return paramMsgInfo;
    }
    return null;
  }
  ...
  private void a(MsgInfo paramMsgInfo, long paramLong1, long paramLong2, long paramLong3, String paramString)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.DiscMsgPc", 2, "----------handleC2COnlinePushMsgResp after analysis friendUin: " + paramLong2 + " msgType: " + -1004 + " friendType: " + 3000 + " shMsgSeq: " + paramMsgInfo.shMsgSeq + " msgContent: " + bgjw.a(paramString));
    }
  ...
  private void a(Pair<Long, String> paramPair1, MsgInfo paramMsgInfo, long paramLong1, long paramLong2, long paramLong3, byte paramByte, long paramLong4, Pair<Long, String> paramPair2)
  {
    ...
    if (TextUtils.isEmpty(paramPair1))
    {
      ...
      paramPair1 = bglf.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong2), String.valueOf(l1));
    }
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(str))
      {
        ...
        paramPair2 = bglf.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong2), String.valueOf(l2));
      }
      if (bglf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong2))) {
        paramPair1 = bglf.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong2), String.valueOf(l1));
      }
      if (paramLong4 == 0L) {
        paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691629, new Object[] { paramPair1 });
      }
      for (;;)
      {
        ...
        return;
        if (paramLong4 == 1L) {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691630, new Object[] { paramPair1, paramPair2 });
        } else if (paramLong4 == 2L) {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691982, new Object[] { paramPair1 });
        } else {
          paramPair1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691625, new Object[] { paramPair1 });
        }
      }
    }
  }
  ...
  private void a(Pair<Long, String> paramPair, MsgInfo paramMsgInfo, ArrayList<Pair<String, String>> paramArrayList, long paramLong1, String paramString, byte paramByte, long paramLong2, boolean paramBoolean)
  {
    ...
    if (m > 50)
    {
      ...
      paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691634);
    ...
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(paramPair)) && (!bglf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString))) {
        break label133;
      }
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.DiscMsgPc.discuss", 2, "showWelcomeTips server name empty cOpType:" + paramByte);
      }
      paramPair = bglf.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, (String)localObject);
      break label133;
      label242:
      localStringBuffer.append("、" + paramPair);
    }
    ...
    Object localObject = bbzh.a(i);
    paramPair = "";
    if (paramByte == 11) {
      paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691632);
    }
    if (paramByte == 22)
    {
      if (paramLong2 == 0L) {
      ...
      for (;;)
      {
        ...
        return;
        if (paramLong2 == 1L) {
          paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691633);
        } else if (paramLong2 == 2L) {
          paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691983, new Object[] { localStringBuffer.toString() });
        }
      }
    }
    if (l == paramLong1)
    {
      ...
      paramPair = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691613);
    }
    for (;;)
    {
      paramPair = paramPair + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691625, new Object[] { localStringBuffer.toString() });
      break;
      j = 0;
      break label644;
      label721:
      ...
      if (TextUtils.isEmpty(str))
      {
        ...
        paramPair = bglf.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, String.valueOf(l));
      }
      if (bglf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString)) {
        paramPair = bglf.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, String.valueOf(l));
      }
      paramPair = paramPair + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691612);
      continue;
      label841:
      paramPair = "";
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    bgva.b(paramArrayOfByte, paramInt, paramMessageRecord, i);
  ...
  private void a(ToServiceMsg paramToServiceMsg, ArrayList<msg_comm.Msg> paramArrayList, msg_svc.PbGetDiscussMsgResp paramPbGetDiscussMsgResp)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        paramToServiceMsg = (anks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
        ...
        while (j < k)
        {
          ...
          if ((paramArrayList instanceof MessageForMarketFace)) {
            awmq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMarketFace)paramArrayList);
          }
          j += 1;
        }
        j = 0;
        ...
        if (paramToServiceMsg.size() > 0)
        {
          ...
          paramArrayList = (acvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(3000);
          ...
          bool2 = anqc.a(paramToServiceMsg);
          j = acwh.a(paramToServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      for (boolean bool1 = bool2;; bool1 = false)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(bool1)) && (!acwh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, 3000)))
        {
          bool1 = true;
          ...
          ((bgzk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(paramToServiceMsg);
        }
        for (;;)
        {
          if ((i != 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(str) == 1))
          {
            ...
            if (paramToServiceMsg != null)
            {
              ...
              ((acvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(3000)).b(str, 3000, l1);
            }
          }
          return;
          bool1 = false;
  ...
  private void a(ToServiceMsg paramToServiceMsg, ArrayList<msg_comm.Msg> paramArrayList, msg_svc.PbGetDiscussMsgResp paramPbGetDiscussMsgResp, String paramString)
  {
    ...
    for (paramArrayList = ((msg_comm.DiscussInfo)localObject3).discuss_remark.get().toByteArray();; paramArrayList = null)
    {
      for (;;)
      {
        ...
        bbzk localbbzk = new bbzk();
        localbbzk.jdField_e_of_type_Long = l5;
        localbbzk.jdField_e_of_type_Int = 3000;
        localbbzk.f = m;
        ...
        try
        {
          a((msg_comm.Msg)localObject2, localArrayList3, localbbzk, true, localbepr);
          ...
          anqc.a((List)localObject3);
          localArrayList1.addAll((Collection)localObject3);
          anqc.a("Q.msg.DiscMsgPc", paramString, l3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), String.valueOf(l5));
          if ((paramArrayList == null) || (paramArrayList.length <= 0)) {
            break;
          }
          localObject3 = String.valueOf(l1);
          localObject2 = bgmj.a(paramArrayList) + ":" + (String)localObject3;
          if (((HashSet)localObject1).contains(localObject2)) {
            break;
          }
          paramArrayList = ((ankw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramArrayList, String.valueOf(l5), (String)localObject3, false);
          if (paramArrayList == null) {
            break;
          }
      ...
      if (localArrayList2.size() > 0) {
        ((ankw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).b(localArrayList2);
      }
      paramArrayList = (anks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
      ...
      ((awne)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(paramArrayList + "&" + 3000, localbepr);
      paramArrayList = new ArrayList();
      if (paramToServiceMsg != null)
      {
      ...
      ((bgzk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(localArrayList1);
      return;
    }
  }
  ...
  {
    MessageRecord localMessageRecord = bbzh.a(-1016);
    long l = bbyp.a();
    if ((paramArrayList != null) && (paramArrayList.size() > 1))
    {
      ...
      localMessageRecord.init(paramString2, paramString1, paramString3, paramArrayList + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131693863), l, -1016, 3000, l);
  ...
  private void a(ArrayList<msg_comm.Msg> paramArrayList, ArrayList<MessageRecord> paramArrayList1)
  {
    ...
    for (paramArrayList = ((msg_comm.DiscussInfo)localObject2).discuss_remark.get().toByteArray();; paramArrayList = null)
    {
      ...
      ArrayList localArrayList2 = new ArrayList();
      bbzk localbbzk = new bbzk();
      localbbzk.jdField_e_of_type_Long = l1;
      localbbzk.jdField_e_of_type_Int = 3000;
      localbbzk.f = m;
      ...
      for (;;)
      {
        try
        {
          a(localMsg, localArrayList2, localbbzk, true, (bepr)localObject1);
          if (!QLog.isColorLevel()) {
            break label1003;
          }
        ...
        catch (Exception localException)
        {
          ...
          if ((paramArrayList != null) && (paramArrayList.length > 0))
          {
            ...
            String str = bgmj.a(paramArrayList) + ":" + (String)localObject1;
            if (!localHashSet.contains(str))
            {
              paramArrayList = ((ankw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramArrayList, String.valueOf(l1), (String)localObject1, false);
              if (paramArrayList != null)
              {
        ...
        if (localArrayList1.size() > 0) {
          ((ankw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).b(localArrayList1);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
    ...
    for (localObject1 = ((msg_comm.DiscussInfo)localObject2).discuss_remark.get().toByteArray();; localObject1 = null)
    {
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          paramFromServiceMsg.append(" fromUin:").append(l1).append(" toUin").append(l4).append(" msgTime:").append(m).append(" msgSeq:").append(l5).append(" msgUid:").append(l6).append(" userActive:").append(n).append(" fromInstid:").append(i1).append(" disUin:").append(l2).append(" disType:").append(i2).append(" disSeq:").append(l7).append(" remarkSender:").append(bgmj.a((byte[])localObject1)).append(" divSeq:").append(k).append(" pkgIndex:").append(j).append(" pkgNum:").append(i).append(" hasShare:").append(paramMsg.appshare_info.has());
          QLog.d("Q.msg.DiscMsgPc", 2, paramFromServiceMsg.toString());
        }
        ((anks)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).a(l2, l1);
        ((anmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a(l1);
        paramFromServiceMsg = (ankw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
        localObject2 = new bbzk();
        ((bbzk)localObject2).jdField_e_of_type_Long = l2;
        ((bbzk)localObject2).jdField_e_of_type_Int = 3000;
        ((bbzk)localObject2).f = i2;
          ...
          if (i < j)
          {
            ...
            if ((((MessageRecord)localObject5).senderuin != null) && (((MessageRecord)localObject5).senderuin.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())))
            {
              ...
              if (localObject6 != null)
              {
                ...
                bmvi.a().a(((MessageRecord)localObject6).getExtInfoFromExtStr("report_key_bytes_oac_msg_extend"));
                ...
                agjf.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageRecord)localObject6).uniseq);
              }
            }
            for (;;)
            {
              ...
              if ((i == 0) && (localObject1 != null) && (localObject1.length > 0))
              {
                ...
                localObject6 = bgmj.a((byte[])localObject1) + ":" + str;
        ...
        if (paramFromServiceMsg.size() > 0)
        {
          ...
          boolean bool2 = anqc.a(paramFromServiceMsg);
          i = acwh.a(paramFromServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          ...
          if ((!this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(bool2)) || (acwh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, Long.toString(l2), 3000))) {
            break label1838;
          }
        }
        for (boolean bool1 = true;; bool1 = false)
        {
          ...
          ((bgzk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(paramMsg);
          return;
        }
        i = 0;
        j = 0;
  ...
  private boolean a(long paramLong1, long paramLong2, short paramShort)
  {
    ...
    //   37: astore 7
    //   39: aload_0
    //   40: getfield 24	aofd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   43: invokevirtual 1020	com/tencent/mobileqq/app/QQAppInterface:a	()Lbbyp;
    //   46: invokevirtual 1606	bbyp:a	()Ljava/util/ArrayList;
    //   49: aload 7
    ...
    //   98: ireturn
    //   99: aload_0
    //   100: getfield 24	aofd:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   103: invokevirtual 1020	com/tencent/mobileqq/app/QQAppInterface:a	()Lbbyp;
    //   106: aload 7
    //   108: invokevirtual 1612	bbyp:a	(Ljava/lang/String;)V
    //   111: iconst_0
    //   112: istore 6
    //   114: goto -20 -> 94
    //   117: astore 7
  ...
  public static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (paramInt == 11)
      {
        ...
        ((amgz)paramQQAppInterface.getManager(211)).a(0, 3000, Long.toString(l), paramArrayOfByte);
        return;
      }
      if (paramInt == 12)
      {
        ...
        ((amhy)paramQQAppInterface.getManager(227)).a(3000, paramArrayOfByte);
        return;
      }
    }
    catch (Exception paramQQAppInterface)
    ...
    if (paramInt == 13)
    {
      ...
      if (paramArrayOfByte.opt_msg_goldtips.has())
      {
        ...
        if ((paramQQAppInterface.type.has()) && (paramQQAppInterface.type.get() == 3)) {
          akrp.a(3000, null, (oidb_0x858.GoldMsgTipsElem)paramArrayOfByte.opt_msg_goldtips.get());
        }
      }
    }
  }
      ...
      if ((paramInt == 9) && (paramArrayOfByte.opt_msg_obj_update.has()))
      {
        ...
        if (paramMessageRecord.bytes_ext_msg.has())
        {
          ...
          try
          {
            ...
            ((auwj)paramQQAppInterface.getManager(156)).a(paramArrayOfByte, false);
            return;
          }
  ...
  public acwn a(int paramInt, MsgInfo paramMsgInfo, SvcReqPushMsg paramSvcReqPushMsg)
  {
    ...
    for (;;)
    {
      ...
      if ((paramMsgInfo != null) && (paramSvcReqPushMsg != null)) {
        return new acwn(a(paramMsgInfo, paramSvcReqPushMsg), false);
      }
  ...
  public List<MessageRecord> a(msg_comm.Msg paramMsg, bbzk parambbzk)
  {
    ...
    try
    {
      a(paramMsg, localArrayList1, parambbzk, true, localbepr);
      long l = paramMsg.msg_head.discuss_info.discuss_uin.get();
      ((awne)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(String.valueOf(l) + "&" + 3000, localbepr);
