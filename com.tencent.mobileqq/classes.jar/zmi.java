...
public class zmi
{
  ...
  public static zmj a(Object paramObject)
  {
    int k = 1;
    String str1 = "1";
    String str3 = "";
    ...
    for (int i = 2;; i = 1)
    {
      ...
      j = 1;
      if (bgsp.a(paramObject))
      {
        paramObject = "weishi://camera?logsour=3006";
        i = k;
        label105:
        localzmj = new zmj();
        localzmj.jdField_a_of_type_JavaLangString = str1;
        localzmj.jdField_b_of_type_JavaLangString = str3;
        localzmj.jdField_c_of_type_JavaLangString = str2;
        localzmj.jdField_a_of_type_Int = i;
        localzmj.e = str4;
        localzmj.f = paramObject;
        localzmj.g = ((String)localObject);
        localzmj.jdField_b_of_type_Int = j;
        if (i == 2)
        {
          localzmj.jdField_d_of_type_JavaLangString = "DOV";
          return localzmj;
          str1 = "11";
          str3 = ((QIMFilterCategoryItem)localObject).jdField_b_of_type_JavaLangString;
          paramObject = ((QIMFilterCategoryItem)localObject).h;
        ...
        for (i = 2;; i = 1)
        {
          ...
          if ((paramObject instanceof QIMBeautyItem))
          {
            ...
            for (i = 2;; i = 1)
            {
              ...
              break;
              localzmj.jdField_d_of_type_JavaLangString = anni.a(2131715574);
              return localzmj;
              break label105;
            }
          }
  ...
  public static zol a(Context paramContext, Object paramObject)
  {
    zmj localzmj = a(paramObject);
    if (localzmj == null) {
      return null;
    }
    String str1 = localzmj.jdField_a_of_type_JavaLangString;
    String str2 = localzmj.jdField_b_of_type_JavaLangString;
    String str3 = localzmj.f;
    int j = localzmj.jdField_a_of_type_Int;
    String str4 = localzmj.e;
    int k = localzmj.jdField_b_of_type_Int;
    int i;
    int m;
    ...
    for (;;)
    {
      ...
      if (j == 2)
      {
        if (bgnw.a(paramContext, "com.tencent.qim"))
        {
          bcst.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 1, str4, "dov", "", "");
          bgnw.a(paramContext, "com.tencent.qim", null);
        }
        for (;;)
        {
          return null;
          ...
          break label117;
          bcst.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 0, str4, "dov", "", "");
          xfv.a(paramContext);
        }
      }
      label174:
      ...
      {
        bcst.b(null, "dc00898", "", "", "weishi_share_shoot", (String)localObject, k, 0, "", "", "", "");
        bcst.b(null, "dc00899", "grp_story", "", "weishi_share", localzmj.g, 0, 0, str1, str2, "", "");
        if (!a(paramContext)) {
          break;
        }
        bcst.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 1, str4, "weishi", "", "");
        bcst.b(null, "dc00899", "grp_story", "", "weishi_share", "clk_ws", 0, 1, str1, str2, "", "");
      ...
      bcst.b(null, "dc00899", "grp_story", "", "app_share", "clk_entry", i, 0, str4, "weishi", "", "");
      localObject = localzmj.jdField_c_of_type_JavaLangString;
      bcst.b(null, "dc00899", "grp_story", "", "weishi_share", "clk_ws", 0, 2, str1, str2, "", "");
      paramContext = new zol(paramContext, 2131756035, paramObject);
  ...
  {
    if (!zky.b(paramContext))
    {
      QQToast.a(paramContext, anni.a(2131715576), 0).a();
      return;
    }
    bqgb.a().a();
    ...
    {
      yqp.d("WeishiGuideUtils", "get null info");
      return;
    }
  ...
  public static void a(Object paramObject)
  {
    ...
    bcst.b(null, "dc00898", "", "", "weishi_share_shoot", "story_entry_exp", j, 0, "", "", "", "");
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    return bkgu.a(paramContext, "com.tencent.weishi");
  }
}
