...
public class lfi
{
  ...
  public lfi(VideoAppInterface paramVideoAppInterface)
  {
  ...
  void a(int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      axrn.a(BaseApplicationImpl.getApplication()).a(null, "av_qua_low_memory", true, 0L, 0L, (HashMap)localObject1, "", true);
      ...
      {
        String str3 = ((lga)localObject2).d;
        localObject2 = ((lga)localObject2).c;
      ...
      axpy.a(null, "dc02660", (String)localObject1);
      return;
    }
  ...
  public void b()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_AndroidContentComponentCallbacks == null)
      {
        this.jdField_a_of_type_AndroidContentComponentCallbacks = new lfj(this);
