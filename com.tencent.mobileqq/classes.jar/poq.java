...
public class poq
{
  ...
  private static String[] jdField_a_of_type_ArrayOfJavaLangString = { ajya.a(2131712821), ajya.a(2131713135), ajya.a(2131712807), ajya.a(2131712854), ajya.a(2131712814), ajya.a(2131713142), ajya.a(2131712996), ajya.a(2131713071), ajya.a(2131712941), ajya.a(2131712764) };
  ...
  public static ArticleInfo a(articlesummary.ArticleSummary paramArticleSummary, int paramInt1, int paramInt2, ArticleInfo paramArticleInfo)
  {
      ...
      catch (Exception paramArticleInfo)
      {
        ...
        catch (InvalidProtocolBufferMicroException paramArticleInfo)
        {
          ...
          if (paramArticleSummary.msg_pack_info.has())
          {
            ...
            localArticleInfo.mPolymericInfo = qbs.a(localArticleInfo.mPackInfoObj);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localArticleInfo.mNewPolymericInfo = qbn.a((articlesummary.NewPackInfo)paramArticleSummary.msg_new_pack_info.get());
          if ((localArticleInfo.mTopicRecommendFeedsInfo != null) && (localArticleInfo.mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList != null) && (localArticleInfo.mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
            localArticleInfo.businessId = ((qds)localArticleInfo.mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_Int;
          }
        }
        ...
        if (paramArticleSummary.recommend_info.has()) {
          localArticleInfo.mRecommendFollowInfos = qbx.a((articlesummary.RecommendFollowInfos)paramArticleSummary.recommend_info.get());
        }
        if (paramArticleSummary.hot_word_info.has()) {
          localArticleInfo.hotWordInfo = qbc.a((articlesummary.HotWordInfo)paramArticleSummary.hot_word_info.get());
        }
        ...
        else
        {
          ...
          if ((paramArticleSummary.msg_feeds_info.has()) && (paramArticleSummary.msg_feeds_info.msg_aggregated_list.has()))
          {
            ...
            localArticleInfo.mExtraBiuBriefInfo = qav.a(paramArticleInfo);
          ...
          if (paramArticleSummary.awesome_comment_icon.has())
          {
            ...
            qam.a(localArticleInfo, (articlesummary.AwesomeCommentInfo)paramArticleSummary.awesome_comment_icon.get());
          }
          if (paramArticleSummary.msg_family_comment_info.has())
          {
            ...
            localObject1 = new qax();
            if (paramArticleInfo.icon_url.has()) {
              ((qax)localObject1).jdField_a_of_type_JavaLangString = paramArticleInfo.icon_url.get().toStringUtf8();
            }
            if (paramArticleInfo.jump_url.has()) {
              ((qax)localObject1).jdField_b_of_type_JavaLangString = paramArticleInfo.jump_url.get().toStringUtf8();
            }
            if (paramArticleInfo.medal_urls_width.has()) {
              ((qax)localObject1).jdField_a_of_type_Int = paramArticleInfo.medal_urls_width.get();
            }
            if (paramArticleInfo.medal_urls_height.has()) {
              ((qax)localObject1).jdField_b_of_type_Int = paramArticleInfo.medal_urls_height.get();
            }
            localArticleInfo.familyCommentInfo = ((qax)localObject1);
          ...
          if ((paramArticleSummary.video_multi_column_info.has()) && (paramArticleSummary.video_multi_column_info.get() != null))
          {
            ...
            localArticleInfo.multiVideoColumnInfo = qbm.a((articlesummary.VideoColumnInfo)paramArticleSummary.video_multi_column_info.get());
            if (QLog.isColorLevel()) {
          ...
          {
            localArticleInfo.scripCmsInfo = qcb.a((articlesummary.ScripCmsInfo)paramArticleSummary.msg_scrip_cms_info.get());
            ...
            pcb.a(BaseApplicationImpl.getApplication(), paramArticleInfo, pcb.a(BaseApplicationImpl.getApplication(), paramArticleInfo) + 1);
            if (QLog.isColorLevel()) {
          ...
          if ((paramArticleSummary.msg_kd_live_info.has()) && (paramArticleSummary.msg_kd_live_info.get() != null))
          {
            ...
            localArticleInfo.mKdLiveInfo = qbf.a((articlesummary.KdLiveInfo)paramArticleSummary.msg_kd_live_info.get());
            if (QLog.isColorLevel()) {
  ...
  public static ChannelCoverInfo a(oidb_cmd0x69f.ChannelInfo paramChannelInfo, int paramInt)
  {
    ...
    //   0: iconst_1
    //   1: istore_3
    //   2: new 1268	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo
    //   5: dup
    //   6: invokespecial 1269	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:<init>	()V
    //   9: astore 4
    //   11: aload_0
    //   12: getfield 1272	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_channel_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   15: invokevirtual 164	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   18: ifeq +15 -> 33
    //   21: aload 4
    //   23: aload_0
    //   24: getfield 1272	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_channel_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   27: invokevirtual 167	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   30: putfield 1275	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverId	I
    //   33: aload_0
    //   34: getfield 1276	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_name	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   37: invokevirtual 115	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   40: ifeq +28 -> 68
    //   43: aload_0
    //   44: getfield 1276	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_name	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   47: invokevirtual 118	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   50: ifnull +18 -> 68
    //   53: aload 4
    //   55: aload_0
    //   56: getfield 1276	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_name	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   65: putfield 1279	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverName	Ljava/lang/String;
    //   68: aload_0
    //   69: getfield 1282	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:enum_channel_cover_style	Lcom/tencent/mobileqq/pb/PBEnumField;
    //   72: invokevirtual 598	com/tencent/mobileqq/pb/PBEnumField:has	()Z
    //   75: ifeq +15 -> 90
    //   78: aload 4
    //   80: aload_0
    //   81: getfield 1282	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:enum_channel_cover_style	Lcom/tencent/mobileqq/pb/PBEnumField;
    //   84: invokevirtual 510	com/tencent/mobileqq/pb/PBEnumField:get	()I
    //   87: putfield 1285	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverStyle	I
    //   90: aload_0
    //   91: getfield 1288	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_wording	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   94: invokevirtual 115	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   97: ifeq +38 -> 135
    //   100: aload_0
    //   101: getfield 1288	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_wording	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   115: dup
    //   116: aload_0
    //   117: getfield 1288	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_wording	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   126: ldc_w 1290
    //   129: invokespecial 1293	java/lang/String:<init>	([BLjava/lang/String;)V
    //   132: putfield 1296	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverSummary	Ljava/lang/String;
    //   135: aload_0
    //   136: getfield 1299	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_spec	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   139: invokevirtual 115	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   142: ifeq +82 -> 224
    //   145: aload_0
    //   146: getfield 1299	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_spec	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   160: dup
    //   161: aload_0
    //   162: getfield 1299	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_spec	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   171: ldc_w 1290
    //   174: invokespecial 1293	java/lang/String:<init>	([BLjava/lang/String;)V
    //   177: putfield 1302	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverSpec	Ljava/lang/String;
    //   180: new 260	org/json/JSONObject
    //   183: dup
    //   184: aload 4
    //   186: getfield 1302	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverSpec	Ljava/lang/String;
    //   189: invokespecial 263	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   192: ldc_w 1304
    //   195: invokevirtual 1307	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   198: astore 5
    //   200: aload 5
    ...
    //   208: aload 4
    //   210: iconst_1
    //   211: putfield 1310	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:hasFilterColor	Z
    //   214: aload 4
    //   216: aload 5
    //   218: invokestatic 1315	android/graphics/Color:parseColor	(Ljava/lang/String;)I
    //   221: putfield 1317	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:filterColor	I
    //   224: aload_0
    //   225: getfield 1320	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_jump_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   228: invokevirtual 115	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   231: ifeq +448 -> 679
    //   234: aload_0
    //   235: getfield 1320	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_jump_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   249: dup
    //   250: aload_0
    //   251: getfield 1320	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_jump_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   260: ldc_w 1290
    //   263: invokespecial 1293	java/lang/String:<init>	([BLjava/lang/String;)V
    //   266: putfield 1323	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelJumpUrl	Ljava/lang/String;
    //   269: aload 4
    //   271: iconst_1
    //   272: putfield 1326	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mColumnType	I
    //   275: aload_0
    //   276: getfield 1329	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_picurl	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   279: invokevirtual 115	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   282: ifeq +38 -> 320
    //   285: aload_0
    //   286: getfield 1329	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_picurl	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   300: dup
    //   301: aload_0
    //   302: getfield 1329	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_channel_cover_picurl	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   311: ldc_w 1290
    //   314: invokespecial 1293	java/lang/String:<init>	([BLjava/lang/String;)V
    //   317: putfield 1332	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverPicUrl	Ljava/lang/String;
    //   320: aload_0
    //   321: getfield 1335	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_is_followed	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   324: invokevirtual 164	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   327: ifeq +15 -> 342
    //   330: aload 4
    //   332: aload_0
    //   333: getfield 1335	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_is_followed	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   336: invokevirtual 167	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   339: putfield 1338	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mFollowType	I
    //   342: aload_0
    //   343: getfield 1341	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:enum_column_type	Lcom/tencent/mobileqq/pb/PBEnumField;
    //   346: invokevirtual 598	com/tencent/mobileqq/pb/PBEnumField:has	()Z
    //   349: ifeq +15 -> 364
    //   352: aload 4
    //   354: aload_0
    //   355: getfield 1341	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:enum_column_type	Lcom/tencent/mobileqq/pb/PBEnumField;
    //   358: invokevirtual 510	com/tencent/mobileqq/pb/PBEnumField:get	()I
    //   361: putfield 1326	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mColumnType	I
    //   364: aload_0
    //   365: getfield 1345	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:msg_rich_tips	Ltencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips;
    //   368: invokevirtual 1348	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:has	()Z
    //   371: ifeq +389 -> 760
    //   374: aload_0
    //   375: getfield 1345	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:msg_rich_tips	Ltencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips;
    //   378: invokevirtual 1349	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   381: ifnull +379 -> 760
    //   384: aload_0
    //   385: getfield 1345	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:msg_rich_tips	Ltencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips;
    //   388: invokevirtual 1349	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   391: checkcast 1347	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips
    //   394: astore 5
    //   396: aload 5
    //   398: getfield 1352	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:uint32_tips_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   401: invokevirtual 164	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   404: ifeq +16 -> 420
    //   407: aload 4
    //   409: aload 5
    //   411: getfield 1352	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:uint32_tips_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   414: invokevirtual 167	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   417: putfield 1355	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mTipsType	I
    //   420: aload 5
    //   422: getfield 1358	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:bytes_tips_text	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   425: invokevirtual 115	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   428: ifeq +40 -> 468
    //   431: aload 5
    //   433: getfield 1358	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:bytes_tips_text	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   447: dup
    //   448: aload 5
    //   450: getfield 1358	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:bytes_tips_text	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   459: ldc_w 1290
    //   462: invokespecial 1293	java/lang/String:<init>	([BLjava/lang/String;)V
    //   465: putfield 1361	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mTipsText	Ljava/lang/String;
    //   468: aload 5
    //   470: getfield 1364	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:uint32_latest_sticky_time	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   473: invokevirtual 164	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   476: ifeq +17 -> 493
    //   479: aload 4
    //   481: aload 5
    //   483: getfield 1364	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$RichTips:uint32_latest_sticky_time	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   486: invokevirtual 167	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   489: i2l
    //   490: putfield 1367	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mUpdateTime	J
    //   493: invokestatic 1372	osg:a	()Losg;
    //   496: iload_1
    //   497: invokevirtual 1375	osg:a	(I)Ljava/util/List;
    //   500: checkcast 415	java/util/ArrayList
    //   503: astore 5
    //   505: aload 5
    //   507: ifnull +253 -> 760
    //   510: aload 5
    //   512: invokevirtual 1376	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   515: astore 5
    //   517: aload 5
    ...
    //   534: checkcast 1268	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo
    //   537: astore 6
    //   539: aload 6
    //   541: getfield 1275	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverId	I
    //   544: aload 4
    //   546: getfield 1275	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelCoverId	I
    //   549: if_icmpne -32 -> 517
    //   552: aload 4
    //   554: aload 6
    //   556: getfield 1379	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mPreUpdateTime	J
    //   559: putfield 1379	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mPreUpdateTime	J
    //   562: goto -45 -> 517
    //   565: astore 5
    //   567: ldc_w 1381
    //   570: iconst_1
    ...
    //   584: aload 5
    //   586: invokevirtual 1384	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   620: aload 5
    //   622: invokevirtual 1384	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   656: aload 5
    //   658: invokevirtual 1384	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   670: aload 4
    //   672: iconst_0
    //   673: putfield 1326	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mColumnType	I
    //   676: goto -401 -> 275
    //   679: aload 4
    //   681: iconst_0
    //   682: putfield 1326	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mColumnType	I
    //   685: goto -410 -> 275
    //   688: astore 5
    //   690: ldc_w 1381
    //   693: iconst_1
    ...
    //   707: aload 5
    //   709: invokevirtual 1384	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   743: aload 6
    //   745: invokevirtual 1384	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   757: goto -289 -> 468
    //   760: aload_0
    //   761: getfield 1393	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_icon_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   764: invokevirtual 115	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   767: ifeq +38 -> 805
    //   770: aload_0
    //   771: getfield 1393	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_icon_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   785: dup
    //   786: aload_0
    //   787: getfield 1393	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_icon_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   796: ldc_w 1290
    //   799: invokespecial 1293	java/lang/String:<init>	([BLjava/lang/String;)V
    //   802: putfield 1396	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mIconUrl	Ljava/lang/String;
    //   805: aload_0
    //   806: getfield 1399	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_fonts_color	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   809: invokevirtual 164	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   812: ifeq +25 -> 837
    //   815: aload_0
    //   816: getfield 1399	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_fonts_color	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   819: invokevirtual 167	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   822: ifeq +15 -> 837
    //   825: aload 4
    //   827: aload_0
    //   828: getfield 1399	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_fonts_color	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   831: invokevirtual 167	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   834: putfield 1402	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mFontColor	I
    //   837: aload_0
    //   838: getfield 1405	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_frame_color	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   841: invokevirtual 164	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   844: ifeq +25 -> 869
    //   847: aload_0
    //   848: getfield 1405	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_frame_color	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   851: invokevirtual 167	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   854: ifeq +15 -> 869
    //   857: aload 4
    //   859: aload_0
    //   860: getfield 1405	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_frame_color	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   863: invokevirtual 167	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   866: putfield 1408	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mFrameColor	I
    //   869: aload 4
    //   871: iload_1
    //   872: putfield 1411	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelId	I
    //   875: aload_0
    //   876: getfield 1414	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint64_channel_cover_article_id	Lcom/tencent/mobileqq/pb/PBUInt64Field;
    //   879: invokevirtual 101	com/tencent/mobileqq/pb/PBUInt64Field:has	()Z
    //   882: ifeq +15 -> 897
    //   885: aload 4
    //   887: aload_0
    //   888: getfield 1414	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint64_channel_cover_article_id	Lcom/tencent/mobileqq/pb/PBUInt64Field;
    //   891: invokevirtual 105	com/tencent/mobileqq/pb/PBUInt64Field:get	()J
    //   894: putfield 1417	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mArticleId	J
    //   897: aload_0
    //   898: getfield 1418	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_channel_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   901: invokevirtual 164	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   904: ifeq +15 -> 919
    //   907: aload 4
    //   909: aload_0
    //   910: getfield 1418	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_channel_type	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   913: invokevirtual 167	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   916: putfield 1421	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mChannelType	I
    //   919: aload_0
    //   920: getfield 1424	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_is_topic	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   923: invokevirtual 164	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   926: ifeq +21 -> 947
    //   929: aload_0
    //   930: getfield 1424	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_is_topic	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    ...
    //   941: aload 4
    //   943: iload_2
    //   944: putfield 1427	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:mIsTopic	Z
    //   947: aload_0
    //   948: getfield 1430	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_is_external_expose	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   951: invokevirtual 164	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   954: ifeq +22 -> 976
    //   957: aload_0
    //   958: getfield 1430	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_is_external_expose	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    ...
    //   970: aload 4
    //   972: iload_2
    //   973: putfield 1433	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:isExternalExposure	Z
    //   976: aload_0
    //   977: getfield 1436	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_is_external_bg_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   980: invokevirtual 115	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   983: ifeq +18 -> 1001
    //   986: aload 4
    //   988: aload_0
    //   989: getfield 1436	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:bytes_is_external_bg_url	Lcom/tencent/mobileqq/pb/PBBytesField;
    ...
    //   998: putfield 1439	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:externalExposureBackgroundUrl	Ljava/lang/String;
    //   1001: aload_0
    //   1002: getfield 1442	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_has_recommend	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   1005: invokevirtual 164	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   1008: ifeq +22 -> 1030
    //   1011: aload_0
    //   1012: getfield 1442	tencent/im/oidb/cmd0x69f/oidb_cmd0x69f$ChannelInfo:uint32_has_recommend	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    ...
    //   1024: aload 4
    //   1026: iload_2
    //   1027: putfield 1445	com/tencent/biz/pubaccount/readinjoy/struct/ChannelCoverInfo:isExternalExposurePersist	Z
    //   1030: aload 4
    //   1032: areturn
    //   1033: astore 5
    //   1035: ldc_w 1381
    ...
    //   1052: aload 5
    //   1054: invokevirtual 1384	java/lang/Exception:toString	()Ljava/lang/String;
  ...
  public static void a(ArticleInfo paramArticleInfo, articlesummary.FeedsInfo paramFeedsInfo)
  {
    ...
    if (((!paramFeedsInfo.msg_pos_ad_info.has()) || (paramFeedsInfo.msg_pos_ad_info.get() == null)) || ((paramFeedsInfo.msg_topic_recommend_feeds_info.has()) && (paramFeedsInfo.msg_topic_recommend_feeds_info.get() != null)))
    {
      ...
      paramArticleInfo.mTopicRecommendFeedsInfo = qdq.a((articlesummary.TopicRecommendFeedsInfo)localObject);
    ...
    for (long l = paramArticleInfo.mTopicRecommendFeedsInfo.jdField_a_of_type_Long;; l = 0L)
    {
      ...
      paramArticleInfo.mArkAppFeedsInfo = qak.a(paramFeedsInfo);
  ...
  private static void a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    rpu.a(str, String.valueOf(paramTabChannelCoverInfo.bid));
    rpu.b(str);
    try
    {
  ...
  public static void a(List<ArticleInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      paramList = paramList.iterator();
      while (paramList.hasNext()) {
        onh.a((ArticleInfo)paramList.next());
      }
    }
  }
  ...
  public static List<qau> c(List<oidb_cmd0x46f.DislikeResult> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if ((paramList == null) || (paramList.size() == 0)) {
      return localArrayList;
    ...
    while (paramList.hasNext())
    {
      ...
      qau localqau = new qau();
      if (localDislikeResult.uint64_articleid.has()) {
        localqau.jdField_a_of_type_Long = localDislikeResult.uint64_articleid.get();
      }
      if (localDislikeResult.uint32_result.has()) {
        localqau.jdField_a_of_type_Int = localDislikeResult.uint32_result.get();
      }
      if (localDislikeResult.str_message.has()) {
        localqau.jdField_a_of_type_JavaLangString = localDislikeResult.str_message.get();
      }
      localArrayList.add(localqau);
    }
    return localArrayList;
  }
