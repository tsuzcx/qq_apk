...
public class qfc
  implements spd
{
  public qfc(ReadInJoyDeliverVideoActivity paramReadInJoyDeliverVideoActivity) {}
  ...
  public void a(URL paramURL, rpg paramrpg)
  {
    ...
    ReadInJoyDeliverVideoActivity.c(this.a, ShortVideoPreviewActivity.a(paramrpg.a()));
    if (QLog.isColorLevel()) {
