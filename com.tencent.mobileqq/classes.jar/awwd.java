...
public class awwd
{
  ...
  {
    int i = ((Integer)paramView.getTag(2131379214)).intValue();
    Object localObject;
    View localView;
    ...
    if ((paramView instanceof LinearLayout))
    {
      ...
      paramView.removeView(paramView.findViewById(2131373142));
      paramView.removeView(paramView.findViewById(2131373143));
      if (paramView.getChildCount() == 1)
      {
        ...
        int j = ((Context)localObject).getResources().getDimensionPixelSize(2131298279);
        k = ((Context)localObject).getResources().getDimensionPixelSize(2131298280);
        switch (paramInt2)
        {
        default: 
    ...
    for (;;)
    {
      if (awou.a(paramInt3))
      {
        localObject = new awxa((Context)localObject, paramInt3).a();
        ((View)localObject).setId(2131373143);
      ...
      if (((paramInt2 == 0) || (paramInt1 == 1)) && (paramBoolean1) && (i != 1))
      {
        ...
        ((View)localObject).setId(2131373142);
        ((View)localObject).setLayoutParams(new LinearLayout.LayoutParams(-1, paramView.getContext().getResources().getDimensionPixelSize(2131298273)));
        paramView.addView((View)localObject, 0);
  ...
  public static void a(awoi paramawoi, int paramInt1, int paramInt2)
  {
    int j = 1;
    int i = j;
    if (paramInt1 > 1)
