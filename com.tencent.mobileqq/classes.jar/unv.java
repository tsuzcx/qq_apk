...
public class unv
{
  ...
  public unv(Activity paramActivity, unw paramunw)
  {
  ...
  public static void a(Activity paramActivity, Intent paramIntent)
  {
    ...
    sxp.a(paramActivity, i, paramIntent);
  }
  ...
  public static void c(Activity paramActivity, Intent paramIntent)
  {
    ...
    {
      veg.e("Q.qqstory.home.QQStoryHomeJumpHelper", "handleOpenTagAction parm error");
      return;
    }
    ttl.a(paramActivity, str, paramIntent);
  }
  
  public static void d(Activity paramActivity, Intent paramIntent)
  {
    paramIntent = (String)((tcv)tdc.a(10)).b("mainHallConfig", "");
    if (!TextUtils.isEmpty(paramIntent)) {}
    for (;;)
    {
      try
      {
        ...
        veg.d("Q.qqstory.home.QQStoryHomeJumpHelper", "square config not ready , use default config instead");
        return;
      }
      catch (Exception paramIntent)
      {
        veg.d("Q.qqstory.home.QQStoryHomeJumpHelper", "analyze config error , error :%s", new Object[] { paramIntent.getMessage() });
      }
      paramIntent = "";
    }
  ...
  private void e(Intent paramIntent)
  {
    ...
    bbds.a(QQStoryContext.a(), this.jdField_a_of_type_AndroidAppActivity, paramIntent, str);
  }
  ...
  private void h(Intent paramIntent)
  {
    ...
    sxp.a(this.jdField_a_of_type_AndroidAppActivity, 23, str);
  }
  ...
  {
    veg.b("Q.qqstory.home.QQStoryHomeJumpHelper", "handleAction=" + paramInt);
    switch (paramInt)
    {
    case 3: 
    default: 
    ...
    case 1: 
      ...
      this.jdField_a_of_type_Unw.a(false, true, 16, null);
      return true;
    case 2: 
      a(paramIntent);
      return true;
  ...
  protected void c(Intent paramIntent)
  {
    ...
    if (paramIntent == null)
    {
      veg.e("Q.qqstory.home.QQStoryHomeJumpHelper", "handle open play list error , no play info !");
      return;
    }
    tvf.a(this.jdField_a_of_type_AndroidAppActivity, paramIntent, 31, null);
  }
