...
public class bdzt
{
  ...
  public static HashMap<Integer, bdzv> a;
  public static volatile boolean a;
  public static WebViewPluginEngine b;
  public static HashMap<Integer, bdzv> b;
  ...
  public static void a()
  {
    if (System.currentTimeMillis() - jdField_a_of_type_Long > 3600000L)
    {
      ...
      {
        localbdzv = (bdzv)localIterator.next();
        localHashMap = new HashMap(4);
        localHashMap.put("type", String.valueOf(localbdzv.a));
        localHashMap.put("totalNum", String.valueOf(localbdzv.b));
        localHashMap.put("hasProc", String.valueOf(localbdzv.c));
        localHashMap.put("noProc", String.valueOf(localbdzv.d));
        azmz.a(BaseApplicationImpl.getApplication().getApplicationContext()).a(null, "actPreloadWebview", true, 0L, 0L, localHashMap, null);
      }
      ...
      while (localIterator.hasNext())
      {
        ...
        localHashMap.put("hasProc", String.valueOf(localbdzv.c));
        localHashMap.put("noProc", String.valueOf(localbdzv.d));
        azmz.a(BaseApplicationImpl.getApplication().getApplicationContext()).a(null, "actJumpWebview", true, 0L, 0L, localHashMap, null);
      }
  ...
  {
    int j = 0;
    Object localObject = (aoob)aogj.a().a(158);
    if ((localObject != null) && (((aoob)localObject).b == 1)) {
      return;
    }
    ...
    localObject = new bdzv(paramInt);
    if (jdField_a_of_type_JavaUtilHashMap.containsKey(Integer.valueOf(paramInt))) {
      localObject = (bdzv)jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt));
    }
    ((bdzv)localObject).b += 1;
    int k = ((bdzv)localObject).c;
    if (bool)
    {
      i = 1;
      label184:
      ((bdzv)localObject).c = (i + k);
      k = ((bdzv)localObject).d;
      if (!bool) {
        break label244;
      }
    }
