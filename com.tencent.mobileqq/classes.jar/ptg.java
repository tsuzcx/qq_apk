...
class ptg
  extends nmc
{
  ptg(ptf paramptf, pti parampti) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.d(ptf.a, 2, "getAtlasFavoriteStatus onResult, errorCode=" + paramInt);
    }
    ...
    for (;;)
    {
      ...
      catch (Exception paramArrayOfByte)
      {
        if (this.jdField_a_of_type_Pti != null) {
          this.jdField_a_of_type_Pti.a(false, null, false, null);
        }
        QLog.e(ptf.a, 1, "getAtlasFavoriteStatus onResult(), exception=" + paramArrayOfByte.toString());
      }
      boolean bool = false;
      continue;
      label242:
      if (this.jdField_a_of_type_Pti != null) {
        this.jdField_a_of_type_Pti.a(true, paramBundle, bool, localArrayList);
      }
    }
  }
}
