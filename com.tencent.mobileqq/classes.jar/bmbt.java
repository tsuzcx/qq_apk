  ...
  implements View.OnClickListener
{
  ...
  bmbv jdField_a_of_type_Bmbv = null;
  ...
  public bmbt(Activity paramActivity, bmbv parambmbv, int paramInt1, int paramInt2, AppRuntime paramAppRuntime)
  {
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_a_of_type_Bmbv = parambmbv;
    this.jdField_b_of_type_Int = paramInt2;
    this.jdField_a_of_type_MqqAppAppRuntime = paramAppRuntime;
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet == null)
    {
      parambmbv = new ShareActionSheetV2.Param();
      parambmbv.context = paramActivity;
      this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet = ShareActionSheetFactory.create(parambmbv);
      this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setActionSheetTitle(paramActivity.getString(2131692686));
      this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setItemClickListenerV2(new bmbu(this));
    }
    b();
  }
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Bmbv != null) {
      b(this.jdField_a_of_type_Bmbv.a());
    }
  }
  ...
  private void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Bmbv != null)
    {
      localObject1 = this.jdField_a_of_type_Bmbv.a();
  ...
  protected void a(int paramInt, ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem)
  {
    ...
    case 72: 
      ...
      this.jdField_a_of_type_Bmbv.a(localBundle);
      return;
    case 26: 
      this.jdField_a_of_type_Bmbv.g();
      return;
    case 39: 
      this.jdField_a_of_type_Bmbv.f();
      return;
    case 130: 
      this.jdField_a_of_type_Bmbv.h();
      return;
    case 131: 
      this.jdField_a_of_type_Bmbv.n();
      return;
    case 94: 
      this.jdField_a_of_type_Bmbv.a();
      return;
    case 129: 
      this.jdField_a_of_type_Bmbv.b();
      return;
    case 70: 
      this.jdField_a_of_type_Bmbv.c();
      return;
    case 82: 
      this.jdField_a_of_type_Bmbv.d();
      return;
    case 55: 
      this.jdField_a_of_type_Bmbv.j();
      return;
    case 52: 
      this.jdField_a_of_type_Bmbv.i();
      return;
    case 56: 
      this.jdField_a_of_type_Bmbv.k();
      return;
    }
    this.jdField_a_of_type_Bmbv.m();
  }
