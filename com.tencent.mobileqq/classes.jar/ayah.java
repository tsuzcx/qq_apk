  ...
  implements Handler.Callback, Manager, BusinessObserver
{
  ...
  private ConcurrentHashMap<Long, ayak> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private int b = -1;
  ...
  public ayah(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(MessageForPtt paramMessageForPtt, int paramInt)
  {
    if (paramMessageForPtt != null)
    {
      ...
      paramMessageForPtt.sttText = ajyc.a(2131714618);
      ...
      axrl.a(BaseApplication.getContext()).a(null, "ptttotextSuc", false, 0L, 0L, localHashMap, null);
    }
    try
    {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    return ((ayah)paramQQAppInterface.getManager(17)).a();
  }
  ...
  public void a(int paramInt)
  {
    ...
    try
    {
      ...
      localHashMap.put("appversion", "8.2.8");
      localaxrl.a("", "PttSttEntryChange", false, 0L, 0L, localHashMap, "");
      return;
    }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayOfByte != null)
      {
        ...
        localObject = (ayak)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(localLong);
        paramArrayOfByte = (byte[])localObject;
        if (localObject == null)
        {
          paramArrayOfByte = new ayak(null);
  ...
  public Long b(MessageForPtt paramMessageForPtt, int paramInt)
  {
    ...
    {
      if (!bbjw.a(paramMessageForPtt.urlAtServer)) {
        break label160;
      }
      QLog.e("", 1, new Object[] { "stt err, c2c no fileID ", paramMessageForPtt });
      a(paramMessageForPtt, 2003);
      if (this.jdField_a_of_type_Ayaj != null) {
        this.jdField_a_of_type_Ayaj.a(false, paramMessageForPtt);
      }
    }
    for (;;)
    {
      return localLong;
      if (bbjw.a(paramMessageForPtt.md5))
      {
      ...
      {
        label160:
        Object localObject = amyv.c();
        boolean bool = bbwv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "have_add_ptt_svip_gray_msg", false);
        if ((((amyu)localObject).jdField_a_of_type_Int == 2) && (!bool) && (VipUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (adwv.d))
        {
          localObject = new aquz(paramMessageForPtt.frienduin, paramMessageForPtt.selfuin, ajyc.a(2131714619), paramMessageForPtt.istroop, -5020, 655392, paramMessageForPtt.time);
          ...
          bbwv.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "have_add_ptt_svip_gray_msg", true);
        ...
        while (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(localLong))
        {
          ...
          ayal.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPtt, localLong, paramInt);
          return localLong;
          if (QLog.isColorLevel()) {
            QLog.d("Q.stt", 1, "stage2 first translate It is need add gray msg and insert falied:conf.stage == " + ((amyu)localObject).jdField_a_of_type_Int + " && " + bool);
          }
        }
      }
    }
  ...
  public boolean b(MessageForPtt paramMessageForPtt)
  {
    ...
    {
      return true;
      bbfm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (QLog.isColorLevel()) {
        QLog.d("Q.stt", 2, "needAuotoChange AutoChangeFlag=" + adwv.d + " AutoChangeSetTime=" + adwv.jdField_a_of_type_Long + " isTranslating=" + a(paramMessageForPtt) + "mPtt.msgTime=" + paramMessageForPtt.msgTime + " mPtt.time=" + paramMessageForPtt.time + " mPtt.sttAbility=" + paramMessageForPtt.sttAbility + " isRedPackPTT=" + ahjm.a(paramMessageForPtt));
      }
    } while ((!a(paramMessageForPtt)) && (!ahjm.a(paramMessageForPtt)) && (adwv.d) && ((adwv.jdField_a_of_type_Long < paramMessageForPtt.msgTime) || (adwv.jdField_a_of_type_Long < paramMessageForPtt.time)) && (paramMessageForPtt.voiceChangeFlag != 1) && ((paramMessageForPtt.sttAbility == 1) || (paramMessageForPtt.sttAbility == 3)));
    return false;
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (MessageForPtt localMessageForPtt = (MessageForPtt)this.jdField_a_of_type_JavaUtilHashMap.remove(paramMessage.obj);; localMessageForPtt = null)
    {
      ...
      if ((localMessageForPtt != null) && (this.jdField_a_of_type_Ayaj != null))
      {
        a(localMessageForPtt, 2002);
        this.jdField_a_of_type_Ayaj.a(false, localMessageForPtt);
      }
      return true;
      ...
      for (localMessageForPtt = (MessageForPtt)this.jdField_a_of_type_JavaUtilHashMap.remove(Long.valueOf(l));; localMessageForPtt = null)
      {
        ...
        axrl.a(BaseApplication.getContext()).a(null, "ptttotextSuc", true, 0L, 0L, localHashMap, null);
        ...
        if (QLog.isColorLevel()) {
          QLog.d("PttItemBuilder", 2, "ptt convert to text success,seq is:" + localMessageForPtt.uniseq + ",sttAbility is:" + localMessageForPtt.sttAbility + ",sttText is:" + bbbd.a(localMessageForPtt.sttText));
        }
        if (this.jdField_a_of_type_Ayaj == null) {
          break;
        }
        this.jdField_a_of_type_Ayaj.a(true, localMessageForPtt);
        return true;
      }
    }
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Ayaj = null;
  }
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Ayaj == null);
      this.jdField_a_of_type_Ayaj.a(false, paramBundle);
      return;
    } while (!QLog.isColorLevel());
