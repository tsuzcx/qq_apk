...
public class bjls
{
  ...
  public static String a(boolean paramBoolean)
  {
    try
    {
      ...
      if (paramBoolean)
      {
        ...
        localObject2 = bjkj.b(localContext);
      ...
      for (int i = 1;; i = 0)
      {
        ...
        localStringBuilder.append("wifi=").append(bjkj.e(localContext));
  ...
  public static String e()
  {
    ...
    WindowManager localWindowManager = (WindowManager)bizw.a().a().getSystemService("window");
  ...
  public static String f()
  {
    ...
    {
      bjko.c("getLocation", "getLocation>>>", localException);
    }
    return "";
  }
  ...
  public static String h()
  {
    ...
    try
    {
      localJSONObject.put("qua", bizw.a().f());
      localJSONObject.put("longitude", f());
      localJSONObject.put("platform", bizw.a().g());
      localJSONObject.put("uin", bizw.a().a());
      localJSONObject.put("imei", c());
      localJSONObject.put("imei", c());
      localJSONObject.put("resolution", e());
      localJSONObject.put("network", bjkj.a(bizw.a().a()));
      ...
      localJSONObject.put("qua", bizw.a().f());
      localJSONObject.put("qz_ver", bizw.a().c());
      localJSONObject.put("imsi", d());
      localJSONObject.put("androidID", Settings.Secure.getString(bizw.a().a().getContentResolver(), "android_id"));
      localJSONObject.put("os_api_level", Build.VERSION.SDK_INT);
      localJSONObject.put("sdkVersionCode", 1);
      localJSONObject.put("QVersionCode", bizw.a().a());
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        bjko.e("getMobileInfo", "gather mobile info exception.");
      }
    }
  }
}
