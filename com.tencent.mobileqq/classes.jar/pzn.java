...
{
  public pzn(DeviceMsgHandle paramDeviceMsgHandle) {}
                      ...
                      else
                      {
                        if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_OnMiniFileTransferComplete"))
                        {
                          ...
                          if ((l1 != 0L) && (this.a.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Long.valueOf(l1))))
                          {
                            ...
                            paramContext.msg = (ContactUtils.b(this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramContext.senderuin, true) + ": " + this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437813));
                            paramContext.serial();
                            this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramContext.frienduin, paramContext.istroop, paramContext.uniseq, paramContext.msgData);
                        ...
                        if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_DeviceVasFlagChange"))
                        {
                          ...
                          if (paramIntent != null)
                          {
                            ...
                            {
                              paramIntent = this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131435602).split(":")[0];
                              paramContext = paramIntent;
                            ...
                            if ((i == 1) && (((DeviceInfo)localObject2).isAdmin != 1))
                            {
                              ...
                              paramContext = paramContext + this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437829);
                            ...
                            if ((i == 0) && (((DeviceInfo)localObject2).isAdmin != 1))
                            {
                              ...
                              paramContext = paramContext + this.a.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131437830);
