...
{
  private bdpj jdField_a_of_type_Bdpj = new bako(this);
  ...
  public void loadConfig(Resources paramResources, String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 256	bakn:clear	()V
    //   4: aload_0
    //   5: aload_2
    //   6: putfield 66	bakn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   9: getstatic 261	bdsh:a	Lbdsh;
    //   12: invokestatic 264	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   15: ldc_w 266
    //   18: invokevirtual 270	bdsh:getSavePath	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   21: astore_1
    //   22: aload_1
    //   23: invokestatic 40	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   26: ifne +17 -> 43
    //   29: new 272	java/io/File
    //   32: dup
    //   33: aload_1
    //   34: invokespecial 273	java/io/File:<init>	(Ljava/lang/String;)V
    //   37: invokevirtual 276	java/io/File:exists	()Z
    //   40: ifne +29 -> 69
    //   43: invokestatic 216	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   46: ifeq +12 -> 58
    //   49: ldc 218
    //   51: iconst_2
    //   52: ldc_w 278
    //   55: invokestatic 243	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   58: getstatic 283	bdsi:a	Lbdsi;
    //   61: aload_0
    //   62: getfield 30	bakn:jdField_a_of_type_Bdpj	Lbdpj;
    //   65: invokevirtual 286	bdsi:a	(Lbdpj;)V
    //   68: return
    //   69: invokestatic 216	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   72: ifeq +29 -> 101
    //   75: ldc 218
    //   77: iconst_2
    //   78: new 92	java/lang/StringBuilder
    //   81: dup
    //   82: invokespecial 93	java/lang/StringBuilder:<init>	()V
    //   85: ldc_w 288
    ...
    //   98: invokestatic 243	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   101: aload_2
    ...
    //   112: ifne +285 -> 397
    //   115: new 290	java/io/InputStreamReader
    //   118: dup
    //   119: new 292	java/io/FileInputStream
    //   122: dup
    //   123: new 272	java/io/File
    //   126: dup
    //   127: aload_1
    //   128: invokespecial 273	java/io/File:<init>	(Ljava/lang/String;)V
    //   131: invokespecial 295	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   134: invokespecial 298	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   137: astore 4
    //   139: aload 4
    //   141: astore_1
    //   142: new 300	java/io/BufferedReader
    //   145: dup
    //   146: aload 4
    //   148: invokespecial 303	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   151: astore 5
    //   153: aload 4
    //   155: astore_1
    ...
    //   167: astore_1
    //   168: aload 5
    //   170: invokevirtual 306	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   173: astore 7
    //   175: aload 7
    //   177: ifnull +55 -> 232
    //   180: aload 4
    ...
    //   212: invokestatic 310	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   215: aload_2
    //   216: ifnull +181 -> 397
    //   219: aload_2
    //   220: invokevirtual 313	java/io/InputStreamReader:close	()V
    //   223: return
    //   224: astore_1
    //   225: return
    //   226: astore_1
    //   227: aload_1
    //   228: invokevirtual 314	java/lang/Exception:printStackTrace	()V
    //   231: return
    //   232: ldc 180
    //   234: astore 5
    //   236: aload 4
    //   238: astore_1
    //   239: new 272	java/io/File
    //   242: dup
    //   243: aload_2
    //   244: invokespecial 273	java/io/File:<init>	(Ljava/lang/String;)V
    //   247: astore_2
    //   248: aload 4
    //   250: astore_1
    //   251: aload 6
    //   253: invokevirtual 103	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   256: astore 6
    //   258: aload 4
    //   260: astore_1
    //   261: aload_2
    //   262: invokevirtual 276	java/io/File:exists	()Z
    //   265: ifeq +57 -> 322
    //   268: aload 4
    //   270: astore_1
    //   271: aload_2
    //   272: invokevirtual 317	java/io/File:isFile	()Z
    //   275: ifeq +47 -> 322
    //   278: aload 4
    //   280: astore_1
    //   281: aload_2
    //   282: invokestatic 322	bdcs:a	(Ljava/io/File;)Ljava/lang/String;
    //   285: astore_2
    //   286: aload 4
    //   288: astore_1
    //   289: aload 6
    ...
    //   311: ifnull +86 -> 397
    //   314: aload 4
    //   316: invokevirtual 313	java/io/InputStreamReader:close	()V
    //   319: return
    //   320: astore_1
    //   321: return
    //   322: aload 4
    ...
    //   327: iconst_1
    //   328: ldc_w 324
    //   331: invokestatic 326	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   334: aload 5
    //   336: astore_2
    //   337: goto -51 -> 286
    //   340: astore 4
    ...
    //   348: ifnull +7 -> 355
    //   351: aload_2
    //   352: invokevirtual 313	java/io/InputStreamReader:close	()V
    //   355: aload_1
    //   356: athrow
    //   357: aload 4
    //   359: astore_1
    ...
    //   361: aload 6
    //   363: aload_2
    //   364: invokevirtual 328	bakn:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   367: aload 4
    //   369: ifnull +28 -> 397
    //   372: aload 4
    //   374: invokevirtual 313	java/io/InputStreamReader:close	()V
    //   377: return
    //   378: astore_1
    //   379: return
    //   380: astore_2
