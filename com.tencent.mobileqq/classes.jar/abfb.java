  ...
  extends QZipFile
{
  ...
  public abfb(File paramFile1, File paramFile2, ZipFile paramZipFile)
  {
    super(paramFile1);
  ...
  public void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 33	abfb:jdField_a_of_type_Boolean	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 19	abfb:jdField_a_of_type_JavaUtilZipZipFile	Ljava/util/zip/ZipFile;
    ...
    //   32: aload_2
    //   33: aload_0
    //   34: getfield 19	abfb:jdField_a_of_type_JavaUtilZipZipFile	Ljava/util/zip/ZipFile;
  ...
  public boolean a()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 33	abfb:jdField_a_of_type_Boolean	Z
    //   8: istore_2
    //   9: iload_2
    //   10: ifeq +9 -> 19
    //   13: iconst_0
    ...
    //   18: ireturn
    //   19: aload_0
    //   20: getfield 19	abfb:jdField_a_of_type_JavaUtilZipZipFile	Ljava/util/zip/ZipFile;
    //   23: ifnull +15 -> 38
    //   26: aload_0
    //   27: getfield 19	abfb:jdField_a_of_type_JavaUtilZipZipFile	Ljava/util/zip/ZipFile;
    //   30: invokevirtual 104	java/util/zip/ZipFile:close	()V
    //   33: aload_0
    //   34: aconst_null
    //   35: putfield 19	abfb:jdField_a_of_type_JavaUtilZipZipFile	Ljava/util/zip/ZipFile;
    //   38: aload_0
    //   39: iconst_1
    //   40: putfield 33	abfb:jdField_a_of_type_Boolean	Z
    //   43: goto -28 -> 15
    //   46: astore_3
    //   47: aload_0
    //   48: monitorexit
  ...
  public java.util.Enumeration<? extends ZipEntry> entries()
  {
    ...
    //   15: dup
    //   16: aload_0
    //   17: getfield 17	abfb:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   20: invokespecial 15	com/tencent/commonsdk/zip/QZipFile:<init>	(Ljava/io/File;)V
    //   23: putfield 19	abfb:jdField_a_of_type_JavaUtilZipZipFile	Ljava/util/zip/ZipFile;
    //   26: aload_0
    //   27: iconst_0
    //   28: putfield 33	abfb:jdField_a_of_type_Boolean	Z
    //   31: aload_0
    //   32: getfield 19	abfb:jdField_a_of_type_JavaUtilZipZipFile	Ljava/util/zip/ZipFile;
