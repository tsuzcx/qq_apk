  ...
  implements View.OnClickListener, View.OnFocusChangeListener
{
  ...
  public ocd(VafContext paramVafContext)
  {
  ...
  private void a()
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null))
    {
      ...
      this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131365766));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378360));
  ...
  private void b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdDataProteusInnerData.a != null)
    {
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdDataProteusInnerData.a.b)) {
        this.jdField_a_of_type_AndroidWidgetEditText.setHint(oap.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdDataProteusInnerData.a.b, 32));
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdDataProteusInnerData.a.c)) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(oap.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdDataProteusInnerData.a.c, 8));
      }
    }
  ...
  public void onClick(View paramView)
  {
    ...
    for (boolean bool = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdDataProteusInnerData.a.jdField_a_of_type_JavaUtilRegexPattern.matcher(str).matches();; bool = true)
    {
      if (bool)
      {
        bcql.a(paramView.getContext(), -1, ajya.a(2131712914), 0).b(((BaseActivity)paramView.getContext()).getTitleBarHeight());
      ...
      str = ajya.a(2131712940);
      bcql.a(paramView.getContext(), 1, str, 0).b(((BaseActivity)paramView.getContext()).getTitleBarHeight());
      return;
    }
  }
  ...
  public void onFocusChange(View paramView, boolean paramBoolean)
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (paramBoolean))
    {
      ...
      oap.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdDataProteusInnerData, 39);
    }
  }
