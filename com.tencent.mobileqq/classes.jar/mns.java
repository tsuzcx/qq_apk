...
public class mns
{
      ...
      do
      {
        ...
        if (j == -2)
        {
          ...
          if ((!this.jdField_c_of_type_Boolean) && ((this.jdField_b_of_type_Boolean) || (this.jdField_d_of_type_Boolean)))
          {
            ...
            if (this.jdField_a_of_type_Mnx.a != null) {
              this.jdField_a_of_type_Mnx.a.j();
            }
          }
  ...
  protected void a(mnj parammnj, boolean paramBoolean)
  {
    if (AudioHelper.f()) {
      QLog.w("QavRecordEncoder", 1, "handleAudioFrame, frame[" + parammnj + "], endOfStream[" + paramBoolean + "], mNoAudio[" + this.jdField_d_of_type_Boolean + "]");
    }
    if (this.jdField_d_of_type_Boolean) {
      return;
    }
    this.jdField_a_of_type_JavaNioByteBuffer.clear();
    this.jdField_a_of_type_JavaNioByteBuffer.put(parammnj.a);
    this.jdField_a_of_type_JavaNioByteBuffer.position(parammnj.a.length);
    ...
    if (j >= 0)
    {
      ...
      this.jdField_b_of_type_AndroidMediaMediaCodec.queueInputBuffer(j, 0, parammnj.a.length, parammnj.jdField_b_of_type_Long, 0);
      if (QLog.isColorLevel()) {
        QLog.d("QavRecordEncoder", 2, "encode, write to codec, size=" + parammnj.a.length);
      }
      label217:
      parammnj = this.jdField_b_of_type_AndroidMediaMediaCodec.getOutputBuffers();
      i = 0;
    }
    for (;;)
    {
  ...
  public void a(byte[] paramArrayOfByte, long paramLong)
  {
    ...
    paramArrayOfByte = new mnj(paramArrayOfByte, l);
  ...
  public void b()
  {
    ...
    long l = this.jdField_a_of_type_Long;
    this.jdField_a_of_type_Long = (1L + l);
    mnj localmnj = new mnj(new byte[0], l);
    localmnj.jdField_b_of_type_Long = this.jdField_b_of_type_Long;
    a(localmnj, true);
    a(true);
    c();
    if (this.jdField_a_of_type_JavaNioByteBuffer != null)
