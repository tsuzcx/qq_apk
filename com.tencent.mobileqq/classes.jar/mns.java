  ...
  implements ViewPager.OnPageChangeListener
{
  ...
  public mns(EffectCycleViewPager paramEffectCycleViewPager, ViewPager.OnPageChangeListener paramOnPageChangeListener, int paramInt)
  {
  ...
  public void onPageScrollStateChanged(int paramInt)
  {
    if (paramInt == 0)
    {
      ...
      lbd.f("EffectCycleViewPager", "onPageScrollStateChanged 00:1");
    ...
    for (;;)
    {
      ...
      {
        lbd.f("EffectCycleViewPager", "onPageScrollStateChanged 11:" + (this.jdField_a_of_type_ComTencentAvUiFunchatFilterEffectCycleViewPager.a.getCount() - 2));
