...
{
  public mns(VideoLayerUI paramVideoLayerUI) {}
  
  public boolean onDoubleTap(MotionEvent arg1)
  {
    int i;
    int j;
    if ((this.a.q == 0) && ((this.a.o == 0) || (this.a.n == 0)) && (2 == this.a.jdField_a_of_type_ArrayOfMgp[0].h()) && (!VideoLayerUIBase.b(this.a.jdField_a_of_type_ComTencentAvVideoController.a())))
    {
      i = (int)???.getX();
      j = (int)???.getY();
      float f = this.a.jdField_a_of_type_ArrayOfMgp[0].c();
      ??? = this.a;
      ???.p += 1;
      if (this.a.p % 2 == 1)
      {
        f = this.a.jdField_a_of_type_ArrayOfMgp[0].b() / f;
        this.a.jdField_a_of_type_ArrayOfMgp[0].a(f, i, j);
      }
      for (;;)
      {
        return true;
        f = this.a.jdField_a_of_type_ArrayOfMgp[0].a() / f;
        i = this.a.jdField_a_of_type_ArrayOfMgp[0].b() / 2;
        j = this.a.jdField_a_of_type_ArrayOfMgp[0].c() / 2;
        this.a.jdField_a_of_type_ArrayOfMgp[0].a(f, i, j);
        this.a.jdField_a_of_type_ArrayOfMgp[0].a(i, j, true);
      }
    }
    if ((this.a.jdField_a_of_type_Mll != null) && (this.a.jdField_a_of_type_Mll.a() == 3))
    {
      Object localObject1;
      Object localObject3;
      if (QLog.isColorLevel())
      {
        ...
        localObject3 = this.a.jdField_a_of_type_ArrayOfMgp;
        if (this.a.q >= 0) {
          break label420;
        }
      }
      ...
      for (i = 0;; i = this.a.q)
      {
        ...
        if ((VideoLayerUI.c(this.a)) && (this.a.q != -1) && (this.a.q < this.a.jdField_a_of_type_ArrayOfMgp.length) && (this.a.jdField_a_of_type_ArrayOfMgp[this.a.q].a() != 1) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.size() > 0)) {
          break;
        }
        return true;
      }
      if (this.a.q != 0)
      {
        long l = Long.parseLong(this.a.jdField_a_of_type_ArrayOfMgp[this.a.q].b());
        j = this.a.jdField_a_of_type_ArrayOfMgp[this.a.q].h();
        localObject1 = (lqq)this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.get(0);
        i = 0;
        if (i < this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.size())
        {
          localObject3 = (lqq)this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.get(i);
          if ((l != ((lqq)localObject3).jdField_a_of_type_Long) || (j != ((lqq)localObject3).jdField_a_of_type_Int)) {
            break label759;
          }
          ((lqq)localObject1).jdField_a_of_type_Boolean = false;
          ((lqq)localObject3).jdField_a_of_type_Boolean = true;
      ...
      for (;;)
      {
        ...
        i += 1;
        break;
        if ((this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.size() > 0) && (!((lqq)this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.get(0)).jdField_a_of_type_Boolean))
        {
          ((lqq)this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.get(0)).jdField_a_of_type_Boolean = true;
          if (QLog.isColorLevel()) {
    ...
    if ((this.a.jdField_a_of_type_Mll != null) && (this.a.jdField_a_of_type_Mll.a() == 4))
    {
  ...
  public boolean onFling(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
    ...
    if ((localAVActivity == null) || (localAVActivity.jdField_a_of_type_ComTencentAvUiVideoControlUI == null) || (localAVActivity.jdField_a_of_type_ComTencentAvUiVideoControlUI.a() == null) || (localAVActivity.jdField_a_of_type_Mpe == null)) {
      return false;
    }
    ...
    float f1;
    float f2;
    if (!localAVActivity.jdField_a_of_type_Mpe.a())
    {
      i = 1;
      lid locallid = localAVActivity.jdField_a_of_type_ComTencentAvVideoController.a();
      ...
      if ((!this.a.jdField_a_of_type_ArrayOfMgp[0].b) && (!this.a.jdField_a_of_type_ArrayOfMgp[1].b)) {
        break label619;
      }
      k = 1;
      if ((j == 0) || (!bool1) || (k == 0)) {
    ...
    else
    {
      ...
      localAVActivity.jdField_a_of_type_Mpe.c(1);
      lmv.a("0X800A8D2");
    }
    for (;;)
    {
      ...
      if ((bool1) && (j != 0))
      {
        ...
        localAVActivity.jdField_a_of_type_Mpe.a(2);
        if (!bool8) {
  ...
  public boolean onSingleTapConfirmed(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
            ...
            do
            {
              do
              {
                ...
                do
                {
                  ...
                  bool1 = bool2;
                } while (!this.a.jdField_a_of_type_Mll.a());
                this.a.a(0, this.a.q);
                return true;
                if (!bool3) {
                  break;
                ...
                bool1 = bool2;
              } while (this.a.jdField_a_of_type_ArrayOfMgp == null);
              bool1 = bool2;
            } while (this.a.q <= 0);
            bool1 = bool2;
          } while (this.a.q >= this.a.jdField_a_of_type_ArrayOfMgp.length);
          if (!this.a.jdField_a_of_type_Mll.a()) {
            break;
          }
          localObject = this.a.jdField_a_of_type_ArrayOfMgp[0];
          paramMotionEvent = this.a.jdField_a_of_type_ArrayOfMgp[this.a.q];
          bool1 = bool2;
        } while (localObject == null);
        bool1 = bool2;
      } while (paramMotionEvent == null);
      String str = ((mgp)localObject).b();
      int i = Integer.valueOf(((mgp)localObject).h()).intValue();
      ...
      return true;
      bool1 = bool2;
    } while (this.a.jdField_a_of_type_Mll.a() != 3);
    this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new Object[] { Integer.valueOf(110), Long.valueOf(l) });
    return true;
    this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(new Object[] { Integer.valueOf(110), Long.valueOf(l) });
    return true;
