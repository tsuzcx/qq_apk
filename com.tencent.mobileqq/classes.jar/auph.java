...
class auph
  extends awkg
{
  auph(aupg paramaupg, int paramInt1, MessageRecord paramMessageRecord, ArrayList paramArrayList, QQAppInterface paramQQAppInterface, String paramString, int paramInt2, HashMap paramHashMap) {}
  
  private boolean a(MessageForPic paramMessageForPic, awjm paramawjm)
  {
    im_msg_body.RichText localRichText = new im_msg_body.RichText();
    im_msg_body.Elem localElem = new im_msg_body.Elem();
    Object localObject = "";
    if (paramawjm.jdField_a_of_type_JavaLangObject != null) {
      if ((paramawjm.jdField_a_of_type_JavaLangObject instanceof im_msg_body.NotOnlineImage))
      {
        localElem.not_online_image.set((im_msg_body.NotOnlineImage)paramawjm.jdField_a_of_type_JavaLangObject);
        ...
        if ((paramawjm.b) || (this.jdField_a_of_type_Int == 5))
        {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int != 5)
      {
        ...
        paramMessageForPic.md5 = bdhb.c(aupg.jdField_a_of_type_JavaLangString);
      }
      ...
      for (;;)
      {
        ...
        break;
        if ((paramawjm.jdField_a_of_type_JavaLangObject instanceof im_msg_body.CustomFace))
        {
          localElem.custom_face.set((im_msg_body.CustomFace)paramawjm.jdField_a_of_type_JavaLangObject);
          if (paramMessageForPic.picExtraData != null)
          {
        ...
        if (QLog.isColorLevel()) {
          QLog.e("MultiMsg_TAG", 2, "WTF, picResult.mExtraObj is " + paramawjm.jdField_a_of_type_JavaLangObject.getClass().getSimpleName());
        }
        label612:
        i = 0;
        break label285;
  ...
  private boolean a(ArrayList<awjm> paramArrayList)
  {
    int j = 0;
    int i = 0;
    boolean bool1 = true;
    ...
    if (m < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      if ((i >= paramArrayList.size()) || ((!((awjm)paramArrayList.get(i)).b) && (this.jdField_a_of_type_Int != 5))) {
        break label989;
      }
      j = 1;
    }
    ...
    for (;;)
    {
      if ((localObject1 instanceof MessageForPic))
      {
        ...
        if (!a((MessageForPic)localObject1, (awjm)paramArrayList.get(i))) {
          bool1 = false;
        }
        i += 1;
        m += 1;
      ...
      if ((localObject1 instanceof MessageForMixedMsg))
      {
        ...
        if (((MessageForMixedMsg)localObject1).msgElemList != null)
        {
          ...
          if (!a((MessageForPic)localObject2, (awjm)paramArrayList.get(i))) {
            bool1 = false;
          }
          i += 1;
        }
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if (!a((MessageForPic)localObject3, (awjm)paramArrayList.get(i))) {
              bool1 = false;
            }
            i += 1;
          }
          for (;;)
          {
            ...
            if ((localObject1 instanceof MessageForStructing))
            {
              ...
              if ((localObject2 != null) && ((localObject2 instanceof StructMsgForImageShare)))
              {
                ...
                if ((localObject3 != null) && (((azwy)localObject3).a != null))
                {
                  MessageForPic localMessageForPic = ((azwy)localObject3).a;
                  if (QLog.isColorLevel()) {
                    QLog.d("MultiMsg_TAG", 2, "updateMessageForPic for MessageForPic, MsgIndex[" + m + "], resultIndex[" + i + "]");
                  }
                  ...
                  if (!a(localMessageForPic, (awjm)paramArrayList.get(i))) {
                    bool1 = false;
                  }
                  for (;;)
                  {
                    i += 1;
                    break;
                    ((azwy)localObject3).T = localMessageForPic.uuid;
                    ((azwy)localObject3).U = localMessageForPic.md5;
                    ((azwy)localObject3).S = localMessageForPic.path;
                  ...
                  if (j != 0)
                  {
                    if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isReMultiMsg) {
                      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800662B", "0X800662B", 0, 1, 0, "", "", "", "");
                    }
                    if (QLog.isColorLevel()) {
                  ...
                  if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isReMultiMsg) {
                    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800662A", "0X800662A", 0, 1, 0, "", "", "", "");
                  }
                  return bool1;
                }
              }
  ...
  public void a(int paramInt, ArrayList<awjm> paramArrayList)
  {
    ...
    if ((paramInt == 0) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      aupg.a(this.jdField_a_of_type_Aupg, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq, 1);
      label110:
      if ((this.jdField_a_of_type_Int == 5) || (aupg.c(this.jdField_a_of_type_Aupg) != 0)) {
        break label201;
      }
      aupg.a(this.jdField_a_of_type_Aupg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.b, this.jdField_a_of_type_JavaUtilHashMap, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, null, this.jdField_a_of_type_JavaUtilArrayList, bool1, this.jdField_a_of_type_Int);
    }
    label190:
    label201:
    while ((this.jdField_a_of_type_Int != 5) || (!aupg.a(this.jdField_a_of_type_Aupg, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq)))
    {
      return;
      bool1 = bool2;
      if (!QLog.isColorLevel()) {
      ...
      bool1 = bool2;
      break;
      aupg.a(this.jdField_a_of_type_Aupg, 1);
      break label110;
    }
    if (bool1)
    {
    ...
    aupg.a(this.jdField_a_of_type_Aupg, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.b);
  }
}
