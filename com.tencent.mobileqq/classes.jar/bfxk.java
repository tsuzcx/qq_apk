...
public class bfxk
{
  private static bfxk jdField_a_of_type_Bfxk;
  private bfxe jdField_a_of_type_Bfxe = new bfxe();
  private bfxi jdField_a_of_type_Bfxi = new bfxi();
  
  public static bfxk a()
  {
    try
    {
      if (jdField_a_of_type_Bfxk == null) {
        jdField_a_of_type_Bfxk = new bfxk();
      }
      bfxk localbfxk = jdField_a_of_type_Bfxk;
      return localbfxk;
    }
    finally {}
  }
  ...
  public static final void a(TroopFileTransferManager.Item paramItem, int paramInt)
  {
    ...
    for (paramItem = paramItem.Id.toString();; paramItem = "")
    {
      ...
      bfvr.c("TroopFileThumbnailMgr", bfvr.a, "[" + paramItem + "] setGettingStatus. ");
      return;
      if (paramInt == 640)
      {
  ...
  public static final boolean a(long paramLong, TroopFileTransferManager.Item paramItem, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        break;
        if ((paramInt == 383) && (bhmi.b(paramString)))
        {
      ...
      if (localVFSFile.exists())
      {
        ...
        if (paramItem.origLastModifyTime != 0L)
        {
          ...
          if (paramItem.origLastModifyTime != l)
          {
            ...
            {
              i = j;
              if (this.jdField_a_of_type_Bfxe.a(paramLong, paramItem, paramInt) == 0) {
                i = 1;
              }
            }
          }
        ...
        if (i == 0) {
          this.jdField_a_of_type_Bfxi.a(paramLong, paramItem, paramInt, null);
        }
        return;
      }
    }
    if ((paramInt == 383) && (auog.b(str)))
    {
      this.jdField_a_of_type_Bfxi.a(paramLong, paramItem, paramInt, str);
      return;
    }
    this.jdField_a_of_type_Bfxe.a(paramLong, paramItem, paramInt);
  }
  ...
  public static final void b(TroopFileTransferManager.Item paramItem, int paramInt)
  {
    ...
    {
      paramItem = paramItem + "_" + paramInt;
      bfvr.c("TroopFileThumbnailMgr", bfvr.a, "[" + paramItem + "] setStopGetStatus. ");
      return;
      if (paramInt == 640)
      {
  ...
  public void a()
  {
    bfvr.c("TroopFileThumbnailMgr", bfvr.a, "init");
    this.jdField_a_of_type_Bfxi.a();
    this.jdField_a_of_type_Bfxe.a();
  }
  ...
  public void a(long paramLong, TroopFileTransferManager.Item paramItem, int paramInt)
  {
    ...
    bfvh.a(new TroopFileThumbnailMgr.2(this, paramItem, paramLong, paramInt), false);
    return;
    if (a(paramLong, paramItem, paramInt))
    {
      paramItem.StatusUpdateTimeMs = 0L;
      bfva.b(paramLong, paramItem);
      return;
    }
    bfvh.a(new TroopFileThumbnailMgr.3(this, paramLong, paramItem, paramInt), false);
  }
  
  public void b()
  {
    bfvr.c("TroopFileThumbnailMgr", bfvr.a, "release");
    if (Build.VERSION.SDK_INT == 19)
    {
      this.jdField_a_of_type_Bfxi.b();
      this.jdField_a_of_type_Bfxe.b();
      return;
    }
    bfvh.a(new TroopFileThumbnailMgr.1(this), true);
  }
}
