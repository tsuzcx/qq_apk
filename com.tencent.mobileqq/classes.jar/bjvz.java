...
{
  protected static HashMap<Long, bjvz> a;
  protected int a;
  protected Context a;
  protected String a;
  ...
  protected bjvz(Context paramContext, String paramString, SQLiteDatabase.CursorFactory paramCursorFactory, int paramInt)
  {
  ...
  public static bjvz a(Context paramContext, long paramLong)
  {
    try
    {
      bjvz localbjvz2 = (bjvz)jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
      bjvz localbjvz1 = localbjvz2;
      if (localbjvz2 == null)
      {
        localbjvz1 = new bjvz(paramContext, bjtz.b(String.valueOf(paramLong) + "_opensdk"), null, 74);
        jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), localbjvz1);
      }
      return localbjvz1;
    }
    finally {}
  ...
  public SQLiteDatabase getWritableDatabase()
  {
    ...
    //   12: astore_2
    //   13: aload_0
    //   14: getfield 103	bjvz:jdField_a_of_type_Boolean	Z
    //   17: ifeq +29 -> 46
    //   20: aload_1
    //   21: ifnull +7 -> 28
    //   24: aload_1
    ...
    //   39: aload_0
    //   40: iconst_0
    //   41: putfield 103	bjvz:jdField_a_of_type_Boolean	Z
    //   44: aload_1
    //   45: astore_2
    //   46: aload_0
    //   47: monitorexit
    ...
    //   63: astore_2
    //   64: aload_0
    //   65: getfield 103	bjvz:jdField_a_of_type_Boolean	Z
    //   68: ifeq -22 -> 46
    //   71: aload_0
    //   72: iconst_0
    //   73: putfield 103	bjvz:jdField_a_of_type_Boolean	Z
    //   76: aload_1
    //   77: astore_2
    //   78: goto -32 -> 46
    //   81: astore_1
    ...
    //   86: astore_2
    //   87: aload_0
    //   88: getfield 103	bjvz:jdField_a_of_type_Boolean	Z
    //   91: ifeq +29 -> 120
    //   94: iconst_0
    //   95: ifeq +11 -> 106
    ...
    //   105: athrow
    //   106: aload_0
    //   107: invokevirtual 110	bjvz:a	()V
    //   110: aload_0
    ...
    //   115: aload_0
    //   116: iconst_0
    //   117: putfield 103	bjvz:jdField_a_of_type_Boolean	Z
    //   120: aload_2
    //   121: athrow
    //   122: astore_2
    //   123: goto -84 -> 39
