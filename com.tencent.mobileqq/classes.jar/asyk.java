...
public class asyk
{
  public static asyk a;
  private int jdField_a_of_type_Int;
  private asyh jdField_a_of_type_Asyh;
  private asyj jdField_a_of_type_Asyj = new asyl(this);
  private Downloader jdField_a_of_type_ComTencentHlyybDownloaderDownloader;
  private HashMap<String, asyi> jdField_a_of_type_JavaUtilHashMap;
  Map<String, asym> jdField_a_of_type_JavaUtilMap = new HashMap();
  private boolean jdField_a_of_type_Boolean;
  
  static
  {
    jdField_a_of_type_Asyk = new asyk();
  }
  ...
  private void b(String paramString)
  {
    try
    {
      ...
      if (this.jdField_a_of_type_JavaUtilMap.size() > 0)
      {
        ...
        {
          asym localasym = (asym)((Map.Entry)paramString.next()).getValue();
          if (localasym != null)
          {
            QLog.d("DownloadManager_Now_for_qq", 1, String.format("removeNowDownloadTask next task url=%s", new Object[] { localasym.b }));
            b(localasym);
          }
        }
      }
  ...
  private void c(asym paramasym)
  {
    DownloaderTask localDownloaderTask = this.jdField_a_of_type_ComTencentHlyybDownloaderDownloader.createNewTask(paramasym.b, paramasym.g, paramasym.h, this.jdField_a_of_type_Asyh);
    localDownloaderTask.setCategory(DownloaderTaskCategory.Cate_CustomMass1);
    localDownloaderTask.setAppScene(paramasym.d);
    if (!TextUtils.isEmpty(paramasym.e)) {
      localDownloaderTask.setApkId(paramasym.e);
    }
    localDownloaderTask.setNotUseTempFile();
    paramasym.a(localDownloaderTask);
  }
  
  public void a()
  {
    if (this.jdField_a_of_type_Asyh != null)
    {
      this.jdField_a_of_type_Asyh.a();
      this.jdField_a_of_type_Asyh = null;
    }
  ...
  public void a(Context paramContext)
  {
    ...
    b(paramContext);
    this.jdField_a_of_type_Asyh = new asyh(this.jdField_a_of_type_Asyj);
  }
  
  /* Error */
  public void a(asym paramasym)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   12: iconst_0
    //   13: aload_1
    //   14: getfield 160	asym:b	Ljava/lang/String;
    //   17: aastore
    //   18: dup
    //   19: iconst_1
    //   20: aload_0
    //   21: getfield 29	asyk:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   39: aload_0
    //   40: getfield 29	asyk:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   43: invokeinterface 141 1 0
    //   48: ifne +26 -> 74
    //   51: aload_0
    //   52: getfield 29	asyk:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   55: aload_1
    //   56: getfield 160	asym:b	Ljava/lang/String;
    //   59: aload_1
    //   60: invokeinterface 239 3 0
    //   65: pop
    //   66: aload_0
    //   67: aload_1
    //   68: invokevirtual 163	asyk:b	(Lasym;)V
    //   71: aload_0
    //   72: monitorexit
    //   73: return
    //   74: aload_0
    //   75: getfield 29	asyk:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   78: aload_1
    //   79: getfield 160	asym:b	Ljava/lang/String;
    //   82: aload_1
  ...
  public void a(String paramString, asyi paramasyi)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap == null) {
      this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    }
    this.jdField_a_of_type_JavaUtilHashMap.put(paramString, paramasyi);
  }
  ...
  public void b(asym paramasym)
  {
    DownloaderTask localDownloaderTask = a(paramasym.b);
    try
    {
      str = paramasym.b;
      if (TextUtils.isEmpty(str))
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(str))) {
          ((asyi)this.jdField_a_of_type_JavaUtilHashMap.get(str)).a(-1000, -1, "url is invalid");
        }
      }
      else if ((localDownloaderTask == null) || (!str.equals(localDownloaderTask.getUrl())))
      {
        QLog.i("DownloadManager_Now_for_qq", 4, "startDownload: url is changed, thread = " + Thread.currentThread().getId() + "," + str + "path = " + paramasym.h);
        if (localDownloaderTask != null) {}
        c(paramasym);
        this.jdField_a_of_type_ComTencentHlyybDownloaderDownloader.addNewTask(paramasym.a());
    ...
    catch (Exception localException)
    {
      ...
      if (this.jdField_a_of_type_Int < 3)
      {
        ...
        {
          if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(str))) {
            ((asyi)this.jdField_a_of_type_JavaUtilHashMap.get(str)).a();
          }
