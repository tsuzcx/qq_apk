...
public class ailz
  implements ailn, Handler.Callback
{
  ...
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = new bgli(ThreadManager.getSubThreadLooper(), this);
  private int b;
  
  public ailz(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, aimj paramaimj)
  {
  ...
  {
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800524B", "0X800524B", 0, 0, String.valueOf(paramInt), "", "", "");
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    if (this.b == 0) {}
    for (String str = "0";; str = "1")
    {
      bcst.b(localQQAppInterface, "dc00899", "grp_lbs", "", "tmp_grey", "exp_oper", 0, 0, str, "", "", "");
      return this.jdField_a_of_type_Aimj.a(this, paramVarArgs);
    }
  }
  ...
  public MessageRecord a(Object... paramVarArgs)
  {
    ...
    for (paramVarArgs = paramVarArgs[0].toString();; paramVarArgs = null)
    {
      ...
      {
        MessageRecord localMessageRecord = bbzh.a(-2027);
        long l = bbyp.a();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return false;
            if ((this.jdField_a_of_type_ComTencentMobileqqAppNearbyGrayTipsManager.a()) && (!this.jdField_a_of_type_ComTencentMobileqqAppNearbyGrayTipsManager.a(bbyp.a() * 1000L))) {
              break;
            }
            return false;
            l1 = bbyp.a() * 1000L;
        ...
        } while (bbzj.a(paramMessage.msgtype));
      ...
      while (!TextUtils.isEmpty(paramMessage))
      {
        ...
        if (localGrayTipsConfig.sceneId == 4)
        {
          ...
          else
          {
            ...
            paramMessage.text = anni.a(2131705991);
            paramMessage.highlightText = anni.a(2131705990);
          }
      ...
      if (!bgnr.b(((ChatMessage)localObject).issend)) {
        break label1201;
      }
    ...
    } while (bgnr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (QQMessageFacade.Message)localObject));
    ...
    if (paramMessage != null)
    {
      ...
      if (bbzj.a(((ChatMessage)paramMessage.next()).msgtype)) {
        break label1348;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      for (paramMessage = this.jdField_a_of_type_ComTencentMobileqqAppNearbyGrayTipsManager.c(this.b, this.jdField_a_of_type_Int, l1);; paramMessage = null)
      {
        ...
        if (bbzj.a(((ChatMessage)localObject).msgtype)) {
          break;
        }
