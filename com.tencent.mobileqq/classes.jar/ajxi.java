  ...
  extends ajwv
{
  ...
  public ajxg a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ajxm(this);
  ...
  private List<ajyc> jdField_b_of_type_JavaUtilList = new ArrayList();
  ...
  public ajxi(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new ajxj(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131368135)).setOnClickListener(new ajxk(this));
    Button localButton = (Button)findViewById(2131363719);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new ajxl(this));
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Ajxg = new ajxg(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Bkfv, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ajxg);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new ajxn(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new ajxo(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new ajxp(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemLongClickListener(new ajxq(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Ajxg.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    if ((this.jdField_b_of_type_Boolean) && (AppNetConnInfo.isNetSupport()))
    {
      ...
      a(5, null);
      b(1);
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FCB", "0X8005FCB", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FCA", "0X8005FCA", 0, 0, "", "", "", "");
      return;
      this.jdField_b_of_type_Int = 0;
      this.jdField_a_of_type_Ajxg.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
      if (this.jdField_b_of_type_Boolean) {
        a(3, this.jdField_a_of_type_AndroidContentContext.getString(2131717632));
      } else {
        a(0, null);
      }
    }
  ...
  public void b(int paramInt)
  {
    ...
    Object localObject2 = (anqg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(92);
    Object localObject1 = ((anqg)localObject2).c();
    long l2;
    int j;
    int k;
    ...
    {
      l2 = ((Long)((anqg)localObject2).a((Calendar)localObject1).second).longValue();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(anni.a(2131700091));
      ...
      {
        this.jdField_a_of_type_Ajxg.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_d_of_type_Boolean, 0);
        this.jdField_a_of_type_Ajxg.notifyDataSetChanged();
      }
      if (this.jdField_a_of_type_Ajxg.getCount() == 0) {
        a(4, null);
      }
      for (;;)
      {
      ...
      if ((l == this.jdField_a_of_type_Long) && (this.jdField_a_of_type_JavaLangString.equals(localObject1)))
      {
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_Ajxg.a(this.jdField_a_of_type_JavaUtilList, 4, this.jdField_d_of_type_Boolean, 0);
          this.jdField_a_of_type_Ajxg.notifyDataSetChanged();
        }
        ...
        if ((this.jdField_a_of_type_Long == l) && (this.jdField_a_of_type_JavaLangString.equals(localObject1)))
        {
          ...
          {
            localObject1 = new ajyc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)paramMessage.get(i));
            this.jdField_a_of_type_JavaUtilList.add(localObject1);
            this.jdField_a_of_type_JavaUtilSet.add(Long.valueOf(((ajyc)localObject1).a.shmsgseq));
            i += 1;
          }
          ...
          this.jdField_a_of_type_Ajxg.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long);
          bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FC2", "0X8005FC2", 0, 0, "", "", "", "");
          continue;
          label1637:
          if (QLog.isColorLevel()) {
          ...
          if (this.e) {
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FCC", "0X8005FCC", 0, (int)(System.currentTimeMillis() - this.jdField_a_of_type_Long), "", "", "", "");
          }
          this.jdField_a_of_type_Ajxg.a(this.jdField_a_of_type_JavaUtilList, 4, this.jdField_d_of_type_Boolean, 1);
          this.jdField_a_of_type_Ajxg.notifyDataSetChanged();
          this.jdField_a_of_type_JavaUtilList.clear();
          continue;
          paramMessage = (HashMap)paramMessage.obj;
          ...
          if ((l == this.jdField_a_of_type_Long) && (this.jdField_a_of_type_JavaLangString.equals(localObject1)))
          {
            bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FC6", "0X8005FC6", 0, (int)(System.currentTimeMillis() - this.jdField_a_of_type_Long), "", "", "", "");
            this.jdField_c_of_type_Boolean = false;
            this.jdField_b_of_type_AndroidViewView.setVisibility(8);
            this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
            this.jdField_a_of_type_Ajxg.a(this.jdField_a_of_type_JavaUtilList, this.jdField_d_of_type_Boolean);
            if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_Ajxg.getCount() < 20))
            {
              this.jdField_c_of_type_AndroidWidgetTextView.setText(anni.a(2131700093));
              this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131372927).setVisibility(8);
              this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
              this.jdField_b_of_type_AndroidViewView.setVisibility(0);
            }
            ...
            if ((l == this.jdField_a_of_type_Long) && (this.jdField_a_of_type_JavaLangString.equals(paramMessage)))
            {
              ...
              this.jdField_b_of_type_AndroidViewView.setVisibility(8);
              this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
              this.jdField_a_of_type_Ajxg.a((List)localObject1, this.jdField_d_of_type_Boolean);
              this.jdField_a_of_type_Ajxg.notifyDataSetChanged();
              this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ajxg);
              this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
              this.jdField_a_of_type_JavaUtilList.clear();
