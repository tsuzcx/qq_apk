  ...
  extends MiniAppProxy
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper(), new bjea(this));
  private MiniAppConfig jdField_a_of_type_ComTencentMobileqqMiniApkgMiniAppConfig;
  private DownloadListener jdField_a_of_type_ComTencentOpenDownloadnewDownloadListener = new bjdy(this);
  ...
  private void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localBundle.putString(bibw.jdField_b_of_type_JavaLangString, paramString1);
  ...
  {
    paramIMiniAppContext.performAction(new bjeb());
  ...
  private void a(IMiniAppContext paramIMiniAppContext, String paramString)
  {
    ...
    MiniAppConfig localMiniAppConfig = bjeo.a(paramIMiniAppContext.getMiniAppInfo());
  ...
  private void a(MiniAppInfo paramMiniAppInfo)
  {
    ...
    QIPCClientHelper.getInstance().callServer("MiniAppTransferModule", "sync_mini_app_data", localBundle, new bjed(this, paramMiniAppInfo));
  }
  ...
  private void b(MiniAppInfo paramMiniAppInfo)
  {
    ...
    MiniAppCmdUtil.getInstance().setUserAppTop(paramMiniAppInfo.appId, paramMiniAppInfo.topType, paramMiniAppInfo.verType, null, new bjee(this, paramMiniAppInfo));
  }
  ...
  private void c(IMiniAppContext paramIMiniAppContext)
  {
    ...
    ((IActivityResultManager)localObject).addActivityResultListener(new bjec(this, (IActivityResultManager)localObject, paramIMiniAppContext));
  ...
  private void e(IMiniAppContext paramIMiniAppContext)
  {
    ...
    localObject = "https://tucao.qq.com/qq_miniprogram/tucao?appid=" + localMiniAppInfo.appId + "&openid=" + MainPageFragment.getUin() + "&avatar=" + paramIMiniAppContext + amtj.a(2131700499);
    ...
    paramIMiniAppContext = bjeo.a(localMiniAppInfo);
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      ((Intent)localObject2).putExtra("key_mini_app_config", bjeo.a((MiniAppInfo)localObject1));
      ...
      ((IActivityResultManager)localObject1).addActivityResultListener(new bjeh(this, (IActivityResultManager)localObject1));
      ...
      if ((localObject2 instanceof bjfh))
      {
        localObject2 = ((bjfh)localObject2).a();
        if ((!bool4) && (localObject2 != null))
        {
          i = a((apkn)localObject2);
          continue;
  ...
  {
    bjfx.a((Activity)paramContext, paramMiniAppInfo, new bjdv(this, paramAsyncResult));
    return true;
  }
  ...
  public void b(IMiniAppContext paramIMiniAppContext)
  {
    ...
    QIPCClientHelper.getInstance().callServer("MiniAppTransferModule", "query_mini_app_data", localBundle, new bjeg(this, localMiniAppInfo));
  }
  ...
  public boolean chooseLocation(Context paramContext, AsyncResult paramAsyncResult)
  {
    ...
    localIActivityResultManager.addActivityResultListener(new bjdx(this, paramAsyncResult, localIActivityResultManager));
  ...
  public boolean downloadApp(Context paramContext, MiniAppInfo paramMiniAppInfo, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqMiniApkgMiniAppConfig = bjeo.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo);
  ...
  public boolean enterQRCode(Context paramContext, boolean paramBoolean, AsyncResult paramAsyncResult)
  {
    ...
    if (!aklx.a(localBaseActivity))
    {
      paramAsyncResult.onReceiveResult(false, null);
      return true;
    }
    paramContext = new Intent((BaseActivity)paramContext, ScannerActivity.class);
    paramContext.putExtra("leftViewText", localBaseActivity.getString(2131690599));
    paramContext.putExtra("selfSet_leftViewText", localBaseActivity.getString(2131690599));
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bjdu(this, paramAsyncResult);
  ...
  {
    IActivityResultManager localIActivityResultManager = AppLoaderFactory.g().getMiniAppEnv().getActivityResultManager();
    localIActivityResultManager.addActivityResultListener(new bjdz(this, localIActivityResultManager, paramIAppUpdateListener));
  ...
  public boolean getLocation(Context paramContext, String paramString, boolean paramBoolean, AsyncResult paramAsyncResult)
  {
    ...
    {
      SosoInterface.startLocation(new bjdw(this, 0, true, true, 5000L, false, false, "miniApp", bool, paramBoolean, paramAsyncResult));
      return true;
    }
  }
  ...
  {
    bftt.a(paramContext, paramBoolean);
  }
  ...
  public void setDrawableCallback(Drawable paramDrawable, MiniAppProxy.IDrawableLoadedCallBack paramIDrawableLoadedCallBack)
  {
    if ((paramDrawable != null) && ((paramDrawable instanceof URLDrawable))) {
      ((URLDrawable)paramDrawable).setURLDrawableListener(new bjef(this, paramIDrawableLoadedCallBack));
    }
  }
