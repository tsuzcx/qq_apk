...
{
  public alzh(AppInterface paramAppInterface)
  {
  ...
  public void a(int paramInt, String paramString, ArrayList<alyp> paramArrayList)
  {
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      {
        alyp localalyp = (alyp)paramArrayList.next();
        STCommon.STLocalCVerInfo localSTLocalCVerInfo = new STCommon.STLocalCVerInfo();
        localSTLocalCVerInfo.busId.set(localalyp.jdField_a_of_type_Int);
        localSTLocalCVerInfo.itemId.set(localalyp.jdField_a_of_type_JavaLangString);
        localSTLocalCVerInfo.localVer.set(localalyp.jdField_b_of_type_Int);
    ...
    paramArrayList = new NewIntent(this.mApp.getApp(), alzi.class);
  ...
  public void a(ReportInfoManager.ReportChannlInfo paramReportChannlInfo)
  {
    ...
    try
    {
      ...
      paramReportChannlInfo = new NewIntent(this.mApp.getApp(), alzi.class);
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, long paramLong1, String paramString2, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    try
    {
      ...
      paramString2 = new NewIntent(this.mApp.getApp(), alzi.class);
  ...
  public void a(String paramString, int paramInt, long paramLong)
  {
    ...
    try
    {
      ...
      localObject = new NewIntent(this.mApp.getApp(), alzi.class);
      ...
      if (("apollo_game_av.get_usraccinfo".equals(paramString)) && (paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()))
      {
        ...
        try
        {
          ...
          if ((paramArrayOfByte != null) && (paramArrayOfByte.size() > 0))
          {
            ...
            paramIntent = alvx.a(paramIntent.getIntExtra("gameId", -1));
            if (paramIntent != null)
            {
  ...
  public void a(String paramString1, String paramString2, long paramLong, int paramInt, boolean paramBoolean, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        paramArrayOfByte = new NewIntent(this.mApp.getApp(), alzi.class);
  ...
  public void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        ((alyy)localObject1).c(paramFromServiceMsg.getResultCode(), paramIntent);
        return;
      }
    }
    ...
    {
      ((alyy)localObject1).c(paramArrayOfByte.subCode.get(), paramIntent);
      return;
    }
    Object localObject2 = new alyx();
    if (paramArrayOfByte.updateFlag.get() == 1)
    {
      bool = true;
      ((alyx)localObject2).jdField_a_of_type_Boolean = bool;
    ...
    {
      ((alyx)localObject2).jdField_b_of_type_Boolean = bool;
      ((alyx)localObject2).jdField_a_of_type_Int = paramArrayOfByte.svrVer.get();
      ((alyx)localObject2).jdField_b_of_type_Int = i;
      ((alyx)localObject2).jdField_d_of_type_JavaLangString = paramArrayOfByte.url.get();
      ((alyx)localObject2).c = paramArrayOfByte.md5.get();
      ((alyx)localObject2).jdField_a_of_type_ArrayOfByte = paramArrayOfByte.patchContent.get().toByteArray();
      ((alyx)localObject2).e = paramArrayOfByte.patchUrl.get();
      ((alyx)localObject2).jdField_b_of_type_Long = paramArrayOfByte.packageSize.get();
      ((alyx)localObject2).jdField_a_of_type_Long = paramArrayOfByte.tipsSize.get();
      ((alyx)localObject2).jdField_a_of_type_JavaLangString = paramArrayOfByte.itemId.get();
      ((alyx)localObject2).jdField_b_of_type_JavaLangString = paramIntent;
      ((alyx)localObject2).jdField_d_of_type_Int = 1;
      ((alyy)localObject1).a((alyx)localObject2);
      return;
      bool = false;
      break;
    }
  ...
  public void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((localalyh == null) || (localalyh.a() == null))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          if (i < paramFromServiceMsg.length())
          {
            ...
            localObject1 = new aluj(((JSONObject)localObject1).optString("icon"), (String)localObject2, paramArrayOfByte);
            localalyh.a().updateUserInfo((aluj)localObject1);
            if (j == alxh.jdField_a_of_type_Int) {
              localalyh.a().getOpenApiHead(l, paramArrayOfByte);
            } else if (j == alxh.jdField_b_of_type_Int) {
              localalyh.a().getOpenApiNick(l, paramArrayOfByte);
            }
          }
        }
      }
      ...
      for (;;)
      {
        try
        {
          ...
          localalyh.a().nativeOpenApiGetHeadCallBack(l, paramFromServiceMsg.getString(0), -1, 0, 0, null);
        ...
        localalyh.a().callbackFromRequest(l, 0, "cs.preload_userInfoList.local", paramFromServiceMsg.toString());
        return;
        if (j == alxh.jdField_a_of_type_Int)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localalyh.a().nativeOpenApiGetHeadCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), 0, 0, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_HEAD error openid=" + paramIntent.getString(0));
          return;
        }
        if (j == alxh.jdField_b_of_type_Int)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localalyh.a().nativeOpenApiGetNickCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), null);
        ...
        localalyh.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), "cs.preload_userInfoList.local", paramIntent.toString());
        ...
        {
          paramFromServiceMsg = new JSONObject(str).optJSONArray("uidList");
          localalyh.a().nativeOpenApiGetNickCallBack(l, paramFromServiceMsg.getString(0), -1, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_NICK error openid=" + paramFromServiceMsg.getString(0));
        }
        else if (j == alxh.c)
        {
          localalyh.a().callbackFromRequest(l, -1, "cs.preload_userInfoList.local", "{}");
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_PRELOAD error ");
        }
      }
      label859:
  ...
  public void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        do
        {
          for (;;)
          {
            ...
            try
            {
              ...
              if (i == 4)
              {
                localalyh.a().callbackFromRequest(l, (int)localUniSsoServerRsp.ret.get(), str3, paramArrayOfByte);
                return;
              }
            }
            catch (Throwable paramArrayOfByte)
            {
              ...
              try
              {
                ...
                if (i == 4)
                {
                  localalyh.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), paramIntent, "{}");
                  return;
                }
              }
        ...
        paramArrayOfByte = alvx.a(localJSONObject1.optInt("gameId"));
    ...
    localalyh.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), str3, "{}");
  }
