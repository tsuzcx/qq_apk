  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_Aist != null) {
        this.a.jdField_a_of_type_Aist.a(0);
      }
      long l = System.currentTimeMillis();
      if (ajae.a(aghr.jdField_a_of_type_Long, l))
      {
        aghr.jdField_a_of_type_Long = l;
        int m = bixy.a(paramView.getTag(2131377371), 0);
        ...
        {
          QLog.i(aghr.jdField_a_of_type_JavaLangString, 2, "error, qqWalletMsg: " + localMessageForQQWalletMsg + ", sessionInfo: " + this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
          return;
        }
        ...
        for (;;)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d(aghr.jdField_a_of_type_JavaLangString, 2, "elem.actionsPriority: " + ((QQWalletTransferMsgElem)localObject1).actionsPriority);
          }
          int i;
          if (TextUtils.isEmpty(((QQWalletTransferMsgElem)localObject1).actionsPriority))
          {
            ajae.b(paramView.getContext(), ((QQWalletTransferMsgElem)localObject1).linkUrl);
            return;
          ...
          for (;;)
          {
            if ((localMessageForQQWalletMsg.fromHBList != 1) && ((localMessageForQQWalletMsg.istroop == 1) || (localMessageForQQWalletMsg.istroop == 3000)) && (localMessageForQQWalletMsg.mQQWalletRedPacketMsg != null)) {
              aivh.a(localMessageForQQWalletMsg.frienduin, localMessageForQQWalletMsg.istroop, localMessageForQQWalletMsg.mQQWalletRedPacketMsg.redPacketId);
            }
            ...
            localMessageForQQWalletMsg.msgData = localMessageForQQWalletMsg.getBytes();
            this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, localMessageForQQWalletMsg.uniseq, localMessageForQQWalletMsg.msgData);
            azmj.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "transferaccountmsg", "show", 0, 0, "" + localMessageForQQWalletMsg.mQQWalletRedPacketMsg.templateId, "", "", "");
            if ((((QQWalletTransferMsgElem)localObject4).skinId > 0) && ((localMessageForQQWalletMsg.messageType == 2) || (localMessageForQQWalletMsg.messageType == 3))) {
              azmj.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "wrap.aio.click", 0, 0, "" + ((QQWalletTransferMsgElem)localObject4).skinId, "", "", "");
            }
            localObject3 = localObject1;
            localObject1 = localObject4;
            break label314;
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                try
                {
                  ...
                  if (k == 1)
                  {
                    if (!ajae.b(paramView.getContext(), ((QQWalletTransferMsgElem)localObject1).linkUrl)) {
                      break label1081;
                    }
                    if (!QLog.isColorLevel()) {
                      break;
                    }
                    QLog.d(aghr.jdField_a_of_type_JavaLangString, 2, "start browser...");
                    return;
                  }
                }
                catch (Exception localException)
                {
                  ...
                  for (;;)
                  {
                    ...
                    if (QLog.isColorLevel())
                    {
                      QLog.d(aghr.jdField_a_of_type_JavaLangString, 2, "QQWalletMsgItemBuilder failed to convert String:" + localObject4[j] + " to Interger,", localException);
                      k = i;
                    }
                  }
                  if (k == 2)
                  {
                    String str = bixy.a(((QQWalletTransferMsgElem)localObject1).jumpUrl, aghr.a(this.a, m), true);
                    if (!ajae.a(paramView.getContext(), str)) {
                      break label1081;
                    }
                    if (!QLog.isColorLevel()) {
                      break;
                    }
                    QLog.d(aghr.jdField_a_of_type_JavaLangString, 2, "do jump action...");
                    return;
                  }
                  if ((k == 3) && (aghr.a(this.a, paramView.getContext(), (QQWalletTransferMsgElem)localObject1, (String)localObject2, localObject3, localMessageForQQWalletMsg, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo)))
                  {
                    if (!QLog.isColorLevel()) {
                      break;
                    }
                    QLog.d(aghr.jdField_a_of_type_JavaLangString, 2, "do wallet action...");
                    return;
                  }
                  i = -1;
                }
