...
public class kuy
{
  ...
  public kuy(VideoAppInterface paramVideoAppInterface)
  {
  ...
  void a(int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      awrn.a(BaseApplicationImpl.getApplication()).a(null, "av_qua_low_memory", true, 0L, 0L, (HashMap)localObject1, "", true);
      ...
      {
        String str3 = ((kvq)localObject2).d;
        localObject2 = ((kvq)localObject2).c;
      ...
      awpy.a(null, "dc02660", (String)localObject1);
      return;
    }
  ...
  public void b()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_AndroidContentComponentCallbacks == null)
      {
        this.jdField_a_of_type_AndroidContentComponentCallbacks = new kuz(this);
