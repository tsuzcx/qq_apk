...
public class anww
{
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bhsi.a(BaseApplicationImpl.getContext(), paramInt, j, k, m, (String)localObject1, (String)localObject3, paramString);
        if (QLog.isColorLevel()) {
  ...
  private static boolean a(String paramString1, String paramString2)
  {
    ...
    //   8: istore 8
    //   10: aload_0
    //   11: invokestatic 261	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   14: ifne +14 -> 28
    //   17: aload_1
    ...
    //   28: iload 8
    //   30: ireturn
    //   31: new 73	java/io/File
    //   34: dup
    //   35: aload_0
    //   36: invokespecial 81	java/io/File:<init>	(Ljava/lang/String;)V
    //   39: invokevirtual 84	java/io/File:exists	()Z
    //   42: ifne +31 -> 73
    //   45: ldc 25
    //   47: iconst_1
    //   48: ldc_w 263
    //   51: invokestatic 31	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   54: iload 7
    //   56: istore 8
    //   58: iconst_0
    //   59: ifeq -31 -> 28
    //   62: new 265	java/lang/NullPointerException
    //   65: dup
    //   66: invokespecial 266	java/lang/NullPointerException:<init>	()V
    //   69: athrow
    //   70: astore_0
    //   71: iconst_0
    //   72: ireturn
    ...
    //   76: dup
    //   77: aload_1
    //   78: invokespecial 81	java/io/File:<init>	(Ljava/lang/String;)V
    //   81: astore 10
    //   83: aload 10
    //   85: invokevirtual 84	java/io/File:exists	()Z
    //   88: ifeq +11 -> 99
    //   91: aload 10
    //   93: invokevirtual 133	java/io/File:isDirectory	()Z
    //   96: ifne +31 -> 127
    //   99: ldc 25
    //   101: iconst_1
    //   102: ldc_w 268
    //   105: invokestatic 31	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   108: iload 7
    //   110: istore 8
    //   112: iconst_0
    //   113: ifeq -85 -> 28
    //   116: new 265	java/lang/NullPointerException
    //   119: dup
    //   120: invokespecial 266	java/lang/NullPointerException:<init>	()V
    //   123: athrow
    //   124: astore_0
    //   125: iconst_0
    //   126: ireturn
    //   127: aload 10
    //   129: invokevirtual 137	java/io/File:listFiles	()[Ljava/io/File;
    //   132: astore 11
    //   134: aload 11
    //   136: arraylength
    //   137: istore_3
    ...
    //   151: ldc 25
    //   153: iconst_1
    //   154: new 33	java/lang/StringBuilder
    //   157: dup
    //   158: invokespecial 37	java/lang/StringBuilder:<init>	()V
    //   161: ldc_w 270
    //   164: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   167: aload 10
    //   169: invokevirtual 273	java/io/File:getName	()Ljava/lang/String;
    ...
    //   178: invokestatic 31	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   181: iload_2
    //   182: iconst_1
    //   183: iadd
    //   184: istore_2
    ...
    //   194: dup
    //   195: invokespecial 37	java/lang/StringBuilder:<init>	()V
    //   198: ldc_w 275
    //   201: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   204: aload 11
    //   206: arraylength
    //   207: invokevirtual 46	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   210: invokevirtual 50	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   213: invokestatic 31	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   216: aload 11
    //   218: arraylength
    //   219: ifgt +31 -> 250
    //   222: ldc 25
    //   224: iconst_1
    //   225: ldc_w 277
    //   228: invokestatic 31	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   231: iload 7
    //   233: istore 8
    //   235: iconst_0
    //   236: ifeq -208 -> 28
    //   239: new 265	java/lang/NullPointerException
    //   242: dup
    //   243: invokespecial 266	java/lang/NullPointerException:<init>	()V
    //   246: athrow
    //   247: astore_0
    //   248: iconst_0
    //   249: ireturn
    ...
    //   263: dup
    //   264: invokespecial 37	java/lang/StringBuilder:<init>	()V
    //   267: ldc_w 279
    //   270: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   273: iload 4
    //   275: invokevirtual 46	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   278: invokevirtual 50	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   281: invokestatic 31	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   284: new 281	java/io/BufferedReader
    //   287: dup
    //   288: new 283	java/io/InputStreamReader
    //   291: dup
    //   292: new 285	java/io/FileInputStream
    //   295: dup
    //   296: aload_0
    //   297: invokespecial 286	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   300: invokespecial 289	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   303: invokespecial 292	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   306: astore 11
    //   308: iconst_0
    //   309: istore_2
    //   310: aload 11
    //   312: astore_0
    //   313: aload 11
    //   315: invokevirtual 295	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   318: astore 10
    //   320: aload 10
    //   322: ifnull +467 -> 789
    //   325: aload 11
    ...
    //   328: ldc 25
    //   330: iconst_1
    //   331: new 33	java/lang/StringBuilder
    //   334: dup
    //   335: invokespecial 37	java/lang/StringBuilder:<init>	()V
    //   338: ldc_w 297
    //   341: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   344: aload 10
    //   346: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   349: invokevirtual 50	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   352: invokestatic 31	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   355: aload 11
    //   357: astore_0
    //   358: aload 10
    //   360: invokevirtual 300	java/lang/String:length	()I
    //   363: istore_3
    //   364: iload_3
    //   365: iconst_5
    ...
    //   383: iconst_1
    //   384: ldc_w 302
    //   387: invokestatic 31	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   390: iload 9
    //   392: istore 7
    //   394: iload 7
    //   396: istore 8
    ...
    //   400: ifnull -372 -> 28
    //   403: aload 11
    //   405: invokevirtual 305	java/io/BufferedReader:close	()V
    //   408: iload 7
    //   410: ireturn
    //   411: astore_0
    //   412: iload 7
    ...
    //   418: aload 10
    //   420: ldc_w 307
    //   423: invokevirtual 311	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   426: astore 10
    //   428: aload 11
    //   430: astore_0
    //   431: aload 10
    ...
    //   450: dup
    //   451: invokespecial 37	java/lang/StringBuilder:<init>	()V
    //   454: aload_1
    //   455: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   458: ldc 215
    //   460: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   463: aload 10
    //   465: iconst_0
    //   466: aaload
    //   467: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   470: invokevirtual 50	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   473: astore 12
    //   475: aload 11
    //   477: astore_0
    //   478: ldc 25
    ...
    //   484: dup
    //   485: invokespecial 37	java/lang/StringBuilder:<init>	()V
    //   488: ldc_w 313
    ...
    //   499: invokevirtual 50	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   502: invokestatic 31	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   505: aload 11
    //   507: astore_0
    //   508: new 73	java/io/File
    //   511: dup
    //   512: aload 12
    //   514: invokespecial 81	java/io/File:<init>	(Ljava/lang/String;)V
    //   517: astore 12
    //   519: aload 11
    //   521: astore_0
    //   522: aload 12
    //   524: invokevirtual 84	java/io/File:exists	()Z
    //   527: ifne +21 -> 548
    //   530: aload 11
    //   532: astore_0
    //   533: ldc 25
    //   535: iconst_1
    //   536: ldc_w 315
    //   539: invokestatic 31	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   542: iconst_0
    //   543: istore 7
    //   545: goto -173 -> 372
    //   548: aload 11
    //   550: astore_0
    //   551: aload 12
    //   553: invokestatic 245	oicq/wlogin_sdk/tools/MD5:getFileMD5	(Ljava/io/File;)Ljava/lang/String;
    //   556: astore 12
    //   558: aload 12
    //   560: ifnull +91 -> 651
    //   563: aload 11
    //   565: astore_0
    //   566: aload 12
    //   568: invokevirtual 300	java/lang/String:length	()I
    //   571: aload 10
    //   573: iconst_1
    //   574: aaload
    //   575: invokevirtual 300	java/lang/String:length	()I
    //   578: if_icmpeq +73 -> 651
    //   581: aload 11
    //   583: astore_0
    //   584: aload 12
    //   586: invokevirtual 300	java/lang/String:length	()I
    //   589: istore 6
    //   591: aload 11
    //   593: astore_0
    //   594: aload 10
    //   596: iconst_1
    //   597: aaload
    //   598: invokevirtual 300	java/lang/String:length	()I
    //   601: istore 5
    //   603: iconst_0
    //   604: istore_3
    //   605: iload_3
    ...
    //   617: aload 10
    //   619: iconst_1
    //   620: new 33	java/lang/StringBuilder
    //   623: dup
    //   624: invokespecial 37	java/lang/StringBuilder:<init>	()V
    //   627: ldc_w 317
    //   630: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   633: aload 10
    //   635: iconst_1
    //   636: aaload
    //   637: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   640: invokevirtual 50	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   643: aastore
    //   644: iload_3
    //   645: iconst_1
    //   646: iadd
    ...
    //   663: iconst_1
    //   664: aaload
    //   665: invokevirtual 249	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   668: istore 7
    //   670: iload 7
    //   672: ifne +9 -> 681
    //   675: iconst_0
    ...
    //   697: ldc 25
    //   699: iconst_1
    //   700: new 33	java/lang/StringBuilder
    //   703: dup
    //   704: invokespecial 37	java/lang/StringBuilder:<init>	()V
    //   707: ldc_w 319
    //   710: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   713: aload 10
    //   715: invokevirtual 236	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   718: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   721: invokevirtual 50	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   724: invokestatic 239	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   727: iload 7
    //   729: istore 8
    //   731: aload_1
    //   732: ifnull -704 -> 28
    //   735: aload_1
    //   736: invokevirtual 305	java/io/BufferedReader:close	()V
    //   739: iload 7
    //   741: ireturn
    //   742: astore_0
    //   743: iload 7
    ...
    //   750: ifnull +7 -> 757
    //   753: aload_0
    //   754: invokevirtual 305	java/io/BufferedReader:close	()V
    //   757: aload_1
    //   758: athrow
    //   759: astore_0
    //   760: goto -3 -> 757
  ...
  public static boolean a(String paramString1, String paramString2, File paramFile)
  {
    ...
    if (!bnjl.b(paramFile, paramString2))
    {
