...
public class qva
  implements View.OnClickListener, bfos, qjw, qoa, qtu
{
  protected int a;
  private Activity jdField_a_of_type_AndroidAppActivity;
  private Handler jdField_a_of_type_AndroidOsHandler = new qvb(this);
  ...
  private SeekBar.OnSeekBarChangeListener jdField_a_of_type_AndroidWidgetSeekBar$OnSeekBarChangeListener = new qve(this);
  ...
  private ArrayList<qvg> jdField_a_of_type_JavaUtilArrayList = new ArrayList(10);
  private List<qvf> jdField_a_of_type_JavaUtilList;
  ...
  private qvg jdField_a_of_type_Qvg;
  private qyv jdField_a_of_type_Qyv;
  ...
  public qva(FrameLayout paramFrameLayout, ReadInJoyBaseListView paramReadInJoyBaseListView, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_Qyv = new qyv(this.jdField_a_of_type_AndroidWidgetFrameLayout, this);
    this.jdField_a_of_type_Qtl = new qtl(paramActivity, this.jdField_a_of_type_AndroidWidgetFrameLayout, new qvc(this));
    this.jdField_a_of_type_Qju = new qju(this.jdField_a_of_type_AndroidAppActivity, this);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListView.setScrollEventCallback(new qvd(this));
  ...
  private void B()
  {
    ...
    {
      Object localObject = this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo;
      if (localObject != null)
      {
        localObject = new qzb(null, this.jdField_a_of_type_Qtv.k, ((BaseArticleInfo)localObject).mVideoVid, ((BaseArticleInfo)localObject).getInnerUniqueID()).a((int)((BaseArticleInfo)localObject).mChannelID).a().a();
        nol.a(null, "", "0X8009505", "0X8009505", 0, 0, "", this.jdField_a_of_type_Qtl.a(), "", (String)localObject, false);
      }
    }
  }
  ...
  private void C()
  {
    ...
    if (this.jdField_a_of_type_Qtr != null) {
      n = (int)(this.jdField_a_of_type_Qtr.a() / 1000L);
    }
  ...
  {
    int i1 = 0;
    if ((this.jdField_a_of_type_Qtv == null) || (this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo == null) || (this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mVideoDownloadBarInfo == null)) {
      if (QLog.isColorLevel()) {
        QLog.e("Q.readinjoy.video.VideoUIManager", 2, "checkIfHasDownloadInfo(), mVideoDownloadBarInfo == null, mPlayingVideoParam:" + this.jdField_a_of_type_Qtv);
      }
    }
    int n;
    label244:
    do
    {
      do
      {
        ...
        {
          return;
          this.jdField_a_of_type_TencentImOidbArticlesummaryArticlesummary$VideoDownloadBarInfo = this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mVideoDownloadBarInfo;
          n = i1;
  ...
  private void F()
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Qtr.a() / 1000L < this.jdField_a_of_type_TencentImOidbArticlesummaryArticlesummary$VideoDownloadBarInfo.uint32_appear_time.get());
      if ((!c()) && (!b()) && (this.jdField_a_of_type_Qtr.a() == 3)) {
        break;
      }
    } while (!QLog.isColorLevel());
  ...
  private void G()
  {
    ...
    {
      this.jdField_b_of_type_AndroidViewView = ((ViewStub)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131365338)).inflate();
      this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView = ((KandianUrlImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131362668));
      this.jdField_i_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131362669));
  ...
  private void H()
  {
    ...
    if ((this.jdField_a_of_type_TencentImOidbArticlesummaryArticlesummary$VideoDownloadBarInfo.msg_url_jump_info.has()) && (this.jdField_a_of_type_TencentImOidbArticlesummaryArticlesummary$VideoDownloadBarInfo.msg_url_jump_info.get() != null))
    {
      ...
      if (onh.a(((articlesummary.UrlJumpInfo)localObject).bytes_jump_url)) {
        onh.a(this.jdField_a_of_type_AndroidAppActivity, onh.a(((articlesummary.UrlJumpInfo)localObject).bytes_jump_url));
      }
      this.jdField_g_of_type_Boolean = true;
      if ((this.jdField_a_of_type_Qtv != null) && (this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo != null))
      {
        localObject = "";
        if (this.jdField_k_of_type_Int != 1) {
          break label329;
    ...
    for (;;)
    {
      qzb localqzb = new qzb("", this.jdField_a_of_type_Qtv.k, this.jdField_a_of_type_Qtv.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.innerUniqueID);
      localqzb.a((int)this.jdField_a_of_type_Qtv.jdField_b_of_type_Long);
      if ((this.jdField_a_of_type_TencentImOidbArticlesummaryArticlesummary$VideoDownloadBarInfo != null) && (this.jdField_a_of_type_TencentImOidbArticlesummaryArticlesummary$VideoDownloadBarInfo.msg_url_jump_info.has()) && (this.jdField_a_of_type_TencentImOidbArticlesummaryArticlesummary$VideoDownloadBarInfo.msg_url_jump_info.get() != null)) {
        localqzb.a(onh.a(((articlesummary.UrlJumpInfo)this.jdField_a_of_type_TencentImOidbArticlesummaryArticlesummary$VideoDownloadBarInfo.msg_url_jump_info.get()).bytes_common_data));
      }
      nol.a(null, "", (String)localObject, (String)localObject, 0, 0, "3", "", "", localqzb.a().a(), false);
      return;
      label247:
      if (((articlesummary.UrlJumpInfo)localObject).uint32_jump_type.get() != 2) {
        break;
      }
      if ((onh.a(((articlesummary.UrlJumpInfo)localObject).bytes_jump_bundle)) && (bbfr.a(this.jdField_a_of_type_AndroidAppActivity, onh.a(((articlesummary.UrlJumpInfo)localObject).bytes_jump_bundle))))
      {
        qoi.a(this.jdField_a_of_type_AndroidAppActivity, onh.a(((articlesummary.UrlJumpInfo)localObject).bytes_jump_schema));
        break;
      }
      if (!onh.a(((articlesummary.UrlJumpInfo)localObject).bytes_jump_url)) {
        break;
  ...
  private void I()
  {
    ...
    {
      this.jdField_c_of_type_AndroidViewView = ((ViewStub)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131365339)).inflate();
      this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView = ((KandianUrlImageView)this.jdField_c_of_type_AndroidViewView.findViewById(2131362668));
      this.jdField_j_of_type_AndroidWidgetTextView = ((TextView)this.jdField_c_of_type_AndroidViewView.findViewById(2131362669));
      this.jdField_k_of_type_AndroidWidgetTextView = ((TextView)this.jdField_c_of_type_AndroidViewView.findViewById(2131375122));
      this.l = ((TextView)this.jdField_c_of_type_AndroidViewView.findViewById(2131365357));
      this.jdField_k_of_type_AndroidWidgetTextView.setOnClickListener(this);
      this.l.setOnClickListener(this);
      int n = baxn.a(this.jdField_a_of_type_AndroidAppActivity, 16.0F);
      localObject1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130842579);
      ...
      localObject1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130842500);
      ((Drawable)localObject1).setBounds(0, 0, n, n);
  ...
  private void K()
  {
    ...
    if ((qoi.d()) && (!TextUtils.isEmpty(this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mVideoLogoUrl)))
    {
      Object localObject1 = this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mVideoLogoUrl;
      for (;;)
      {
        try
        {
          ...
          {
            localObject1 = oqb.a((String)localObject1);
            ((oqb)localObject1).setRepeatCount(0);
            this.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable((Drawable)localObject1);
            ((oqb)localObject1).playAnimation();
        ...
        localURLDrawableOptions.mLoadingDrawable = new anoz(0, 50, 150);
  ...
  private static Drawable a(Context paramContext, boolean paramBoolean)
  {
    int i1;
    if (paramBoolean) {
      i1 = baxn.a(paramContext, 12.0F);
    }
    for (int n = baxn.a(paramContext, 60.0F);; n = baxn.a(paramContext, 28.0F))
    {
      return new anpa(-2565928, i1, n, n);
      i1 = baxn.a(paramContext, 6.0F);
    }
  }
  
  private String a()
  {
    if ((this.jdField_a_of_type_TencentImOidbArticlesummaryArticlesummary$VideoDownloadBarInfo != null) && (onh.a(this.jdField_a_of_type_TencentImOidbArticlesummaryArticlesummary$VideoDownloadBarInfo.bytes_icon_url))) {
      return onh.a(this.jdField_a_of_type_TencentImOidbArticlesummaryArticlesummary$VideoDownloadBarInfo.bytes_icon_url);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(ImageView paramImageView)
  {
    ...
    if (qvk.a().c())
    {
      ...
      paramImageView.setContentDescription(ajya.a(2131716434));
      return;
    }
    paramImageView.setImageResource(2130842484);
    paramImageView.setContentDescription(ajya.a(2131716439));
  }
  
  private void a(KandianUrlImageView paramKandianUrlImageView, URL paramURL)
  {
    omr.a(paramKandianUrlImageView, paramURL, this.jdField_a_of_type_AndroidAppActivity, false);
  }
  
  private void a(boolean paramBoolean, qtv paramqtv1, qtv paramqtv2)
  {
    if (QLog.isColorLevel()) {
      QLog.i("Q.readinjoy.video.VideoUIManager", 2, "onScreenChange   isFullScreen:" + paramBoolean + "  enterPlayParam:" + paramqtv1 + "   exitPlayParam:" + paramqtv2);
    }
    Object localObject;
    if (paramBoolean)
    {
      localObject = this.jdField_a_of_type_Qtl;
      int n = ram.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListView, paramqtv1);
      this.jdField_c_of_type_Int = n;
      ((qtl)localObject).a(paramqtv1, n);
      p();
    ...
    else
    {
      for (;;)
      {
        ...
        qvf localqvf = (qvf)((Iterator)localObject).next();
        if (localqvf != null)
        {
          if (paramBoolean)
          {
          ...
          localqvf.a(paramqtv1, paramqtv2);
        }
      }
    }
  }
  ...
  private String b()
  {
    if ((this.jdField_a_of_type_TencentImOidbArticlesummaryArticlesummary$VideoDownloadBarInfo != null) && (onh.a(this.jdField_a_of_type_TencentImOidbArticlesummaryArticlesummary$VideoDownloadBarInfo.bytes_icon_text))) {
      return onh.a(this.jdField_a_of_type_TencentImOidbArticlesummaryArticlesummary$VideoDownloadBarInfo.bytes_icon_text);
    }
    if (QLog.isColorLevel()) {
  ...
  private void c(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_b_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130841323));
      return;
    }
    this.jdField_b_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130841324));
  }
  ...
  private void d(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      localLayoutParams.width = baxn.a(this.jdField_a_of_type_AndroidAppActivity, 91.0F);
      localLayoutParams.height = baxn.a(this.jdField_a_of_type_AndroidAppActivity, 28.0F);
      localLayoutParams.rightMargin = baxn.a(this.jdField_a_of_type_AndroidAppActivity, 16.0F);
    }
    for (localLayoutParams.topMargin = baxn.a(this.jdField_a_of_type_AndroidAppActivity, 16.0F);; localLayoutParams.topMargin = baxn.a(this.jdField_a_of_type_AndroidAppActivity, 8.0F))
    {
      this.jdField_a_of_type_ComTencentImageURLImageView.setLayoutParams(localLayoutParams);
      return;
      localLayoutParams.width = baxn.a(this.jdField_a_of_type_AndroidAppActivity, 78.0F);
      localLayoutParams.height = baxn.a(this.jdField_a_of_type_AndroidAppActivity, 24.0F);
      localLayoutParams.rightMargin = baxn.a(this.jdField_a_of_type_AndroidAppActivity, 8.0F);
    }
  }
  
  private boolean d()
  {
    return this.jdField_a_of_type_Qyv.a();
  }
  ...
  private void f(int paramInt)
  {
    if (this.jdField_d_of_type_AndroidWidgetTextView.getVisibility() == 0) {
      qoi.a(this.jdField_d_of_type_AndroidWidgetTextView, 8, 300);
    }
    this.jdField_a_of_type_AndroidOsHandler.removeMessages(103);
    this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
    switch (paramInt)
    ...
    do
    {
      ...
      {
        return;
        this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130842640));
        this.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(1));
      } while (e());
      qoi.a(this.jdField_a_of_type_AndroidWidgetImageView, 0, 300);
      return;
  ...
  private void h(int paramInt)
  {
    ...
    if (this.jdField_e_of_type_AndroidWidgetImageView.getVisibility() != 0)
    {
      ...
      this.jdField_e_of_type_AndroidWidgetImageView.setImageResource(2130842594);
    }
    if (paramInt == 0) {
  ...
  private void i(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      nol.a(null, "", str, str, 0, 0, "3", "", "", localqzb.a().a(), false);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  private void l()
  {
    qkr.jdField_c_of_type_Boolean = false;
  ...
  private void m()
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewVideoViewGroup = ((VideoViewGroup)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131379015));
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131369580));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131365420));
    ...
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131369814));
    ...
    this.jdField_g_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131365422));
    ...
    this.jdField_f_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131379135));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131379134));
    this.jdField_e_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131379132));
    this.jdField_f_of_type_AndroidWidgetImageView.setOnClickListener(this);
    this.jdField_d_of_type_AndroidWidgetImageView.setOnClickListener(this);
    vzl.a(this.jdField_f_of_type_AndroidWidgetImageView, 10, 10, 10, 10);
    vzl.a(this.jdField_d_of_type_AndroidWidgetImageView, 20, 20, 20, 20);
    qvk.a().a(this.jdField_f_of_type_AndroidWidgetImageView);
    qvk.a().a(this.jdField_d_of_type_AndroidWidgetImageView);
  ...
  private void n()
  {
    ...
    ((RoundAngleFrameLayout)this.jdField_a_of_type_AndroidWidgetFrameLayout).setRaduis(this.jdField_a_of_type_Qtv.o, this.jdField_a_of_type_Qtv.p, this.jdField_a_of_type_Qtv.q, this.jdField_a_of_type_Qtv.r);
  }
  ...
  private void q()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mTitle);
    this.jdField_h_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mTitle);
    ...
    if (this.jdField_a_of_type_Qtv.jdField_b_of_type_Boolean) {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    }
    if (this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mVideoPlayCount == 0)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_g_of_type_AndroidWidgetTextView.setText(omr.a(this.jdField_a_of_type_Qtv.jdField_b_of_type_Int));
      oye.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView, this.jdField_a_of_type_Qtv);
      a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView, this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.getVideoCoverUrlWithSmartCut(false));
      if (this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mXGFileSize > 0L) {
        break label412;
      }
      this.jdField_d_of_type_AndroidWidgetTextView.setText(ajya.a(2131716432));
      label220:
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsGestureLayout.setChannelID(this.jdField_a_of_type_Qtv.jdField_b_of_type_Long);
    ...
    {
      d();
      this.jdField_b_of_type_AndroidWidgetSeekBar.setMax(this.jdField_a_of_type_Qtv.jdField_b_of_type_Int);
      this.jdField_a_of_type_AndroidWidgetSeekBar.setMax(this.jdField_a_of_type_Qtv.jdField_b_of_type_Int);
      z();
      e(this.jdField_a_of_type_Qtv.n);
      p();
      this.jdField_a_of_type_AndroidWidgetFrameLayout.setVisibility(0);
      return;
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_c_of_type_AndroidWidgetTextView.setText(qoi.c(this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mVideoPlayCount) + ajya.a(2131716433));
      break;
      label412:
      this.jdField_d_of_type_AndroidWidgetTextView.setText(qoi.b(this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mXGFileSize) + ajya.a(2131716436));
      break label220;
      label457:
      this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      Drawable localDrawable = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130842577);
      this.jdField_d_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(localDrawable, null, null, null);
      this.jdField_d_of_type_AndroidWidgetTextView.setCompoundDrawablePadding(actj.a(6.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
      this.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
      if (bbwq.a() == 1) {
        this.jdField_d_of_type_AndroidWidgetTextView.setText(ajya.a(2131716431));
      }
    }
  }
  ...
  private void r()
  {
    this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewVideoViewGroup = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewVideoViewGroup;
  }
  ...
  private void t()
  {
    ...
    if (localObject != null)
    {
      localObject = ((qtv)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo;
      if (localObject != null)
      {
        str1 = new qzb(null, ((BaseArticleInfo)localObject).getSubscribeUin(), ((BaseArticleInfo)localObject).mVideoVid, ((BaseArticleInfo)localObject).getInnerUniqueID(), this.jdField_a_of_type_Qtr.a(), ((BaseArticleInfo)localObject).getVideoDuration() * 1000L).a((int)((BaseArticleInfo)localObject).mChannelID).a().a();
    ...
    {
      nol.a(null, str2, "0X8007411", "0X8007411", 0, 0, "0", "", (String)localObject, str1, false);
      return;
    }
  }
  ...
  private void u()
  {
    ...
    {
      return;
      if (this.jdField_a_of_type_Qtv.jdField_a_of_type_AndroidViewView != null) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    String str;
    if (bbwq.a() == 1) {
      str = ajya.a(2131716435);
    }
    for (;;)
    {
      int[] arrayOfInt = new int[2];
      this.jdField_a_of_type_Qtv.jdField_a_of_type_AndroidViewView.getLocationOnScreen(arrayOfInt);
      int n = arrayOfInt[1] - ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidAppActivity);
      n = (n + (this.jdField_a_of_type_Qtv.jdField_a_of_type_AndroidViewView.getHeight() + n) - baxn.a(this.jdField_a_of_type_AndroidAppActivity, 40.0F)) / 2;
      qoi.a(this.jdField_a_of_type_AndroidAppActivity, str, n);
      return;
      if (this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mXGFileSize > 0L) {
        str = ajya.a(2131716430) + qoi.b(this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mXGFileSize);
      } else {
        str = ajya.a(2131716429);
      }
    }
  }
  ...
  private void w()
  {
    ...
    this.jdField_a_of_type_Qyv.b();
    this.jdField_b_of_type_AndroidWidgetSeekBar.setVisibility(0);
  }
  
  private void x()
  {
    qoi.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, 8, 300);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
    qoi.a(this.jdField_a_of_type_AndroidWidgetImageView, 8, 300);
    if (a()) {
      this.jdField_b_of_type_AndroidWidgetSeekBar.setVisibility(8);
    }
    for (;;)
  ...
  {
    if (this.jdField_a_of_type_Qtr != null) {}
    for (int n = (int)(this.jdField_a_of_type_Qtr.a() / 1000L);; n = 0)
    {
      nzh.a(n, this.jdField_a_of_type_Qtr);
      ...
      if (this.jdField_f_of_type_AndroidWidgetTextView.getVisibility() == 0) {
        this.jdField_f_of_type_AndroidWidgetTextView.setText(omr.a(n));
      }
      if ((this.jdField_a_of_type_Qvg != null) && (this.jdField_a_of_type_Qtv != null) && (this.jdField_a_of_type_Qtr != null)) {
        this.jdField_a_of_type_Qvg.a(this.jdField_a_of_type_Qtr.a(), (int)this.jdField_a_of_type_Qtr.a(), this.jdField_a_of_type_Qtv.jdField_b_of_type_Int * 1000);
      }
      if ((this.jdField_a_of_type_Qtv != null) && (this.jdField_a_of_type_Qtr != null))
      {
        Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
        while (localIterator.hasNext()) {
          ((qvg)localIterator.next()).a(this.jdField_a_of_type_Qtr.a(), (int)this.jdField_a_of_type_Qtr.a(), this.jdField_a_of_type_Qtv.jdField_b_of_type_Int * 1000);
        }
      }
      return;
    }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        return;
        n = this.jdField_a_of_type_Qtr.a();
        if ((n != 0) && (n != 1) && (n != 7) && (n != 2) && (n != 4)) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.e("Q.readinjoy.video.VideoUIManager", 2, "innerEnterFullScreen => playState=" + qtx.a(n) + ", illegal state just ignore fullscreen.");
      return;
    } while (this.jdField_b_of_type_Boolean);
    this.jdField_b_of_type_Boolean = true;
    a(true, this.jdField_a_of_type_Qtr.a(), null);
    c(true);
    this.jdField_i_of_type_Int = this.jdField_a_of_type_Qtr.b();
    if ((paramBoolean) && (omr.a(this.jdField_a_of_type_Qtv))) {
      if (this.jdField_a_of_type_Qju.a(false)) {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_AndroidWidgetFrameLayout != null) && ((this.jdField_a_of_type_AndroidWidgetFrameLayout.getParent() instanceof ViewGroup)))
      {
        ...
        ((IVideoViewBase)this.jdField_a_of_type_Qtv.jdField_b_of_type_AndroidViewView).doCacheSurfaceTexture();
        this.jdField_a_of_type_AndroidViewViewGroup.removeView(this.jdField_a_of_type_AndroidWidgetFrameLayout);
        ((IVideoViewBase)this.jdField_a_of_type_Qtv.jdField_b_of_type_AndroidViewView).doRecoverSurfaceTexture();
      ...
      if (QLog.isColorLevel()) {
        QLog.d("Q.readinjoy.video.VideoUIManager", 2, "FullScreen => mOriginalWidth=" + this.jdField_g_of_type_Int + ", mOriginalHeight=" + this.jdField_h_of_type_Int + ", playState=" + qtx.a(n) + "，userClickEnter:" + paramBoolean);
      }
      s();
      this.jdField_a_of_type_AndroidWidgetFrameLayout.setTranslationY(0.0F);
      t();
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        i();
      } while (!this.jdField_a_of_type_Qtr.d());
  ...
  public void a(AbsListView paramAbsListView)
  {
    ...
    do
    {
      ...
      i2 = this.jdField_a_of_type_Qtr.a().jdField_a_of_type_Int;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Q.readinjoy.video.VideoUIManager", 2, "triggerVideoRecycleCheck => stop video，playParam:" + this.jdField_a_of_type_Qtr.a());
    }
    this.jdField_a_of_type_Qtr.b(10);
  }
  
  public void a(qto paramqto)
  {
    this.jdField_a_of_type_Qtl.a(paramqto);
  }
  ...
  public void a(qtr paramqtr)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsGestureLayout.setChannelID(this.jdField_a_of_type_Qtr.c());
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsGestureLayout.setVideoPlayManager(paramqtr);
    this.jdField_a_of_type_Qtl.a(paramqtr);
  }
  
  public void a(qtv paramqtv)
  {
    this.jdField_a_of_type_Qtv = paramqtv;
    if (QLog.isColorLevel()) {
      QLog.d("Q.readinjoy.video.VideoUIManager", 2, "playVideo(): videoPlayParam=" + paramqtv);
    }
    if ((this.jdField_a_of_type_Qtv != null) && (this.jdField_a_of_type_Qtv.jdField_b_of_type_Boolean))
    {
      a(false);
  ...
  {
    if ((this.jdField_a_of_type_Qtv == null) || (paramqtv == null) || (this.jdField_a_of_type_Qtv != paramqtv)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                  ...
                  } while ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListView.getFirstVisiblePosition() != 0) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListView.getChildAt(1) == null) || (!(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListView.getChildAt(1).getTag() instanceof oyl)));
                  paramqtv = (oyl)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyBaseListView.getChildAt(1).getTag();
                } while ((paramqtv == null) || (paramqtv.jdField_g_of_type_AndroidWidgetTextView == null) || (paramqtv.jdField_a_of_type_Int != 0));
                this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(8);
                paramqtv.jdField_g_of_type_AndroidWidgetTextView.setVisibility(8);
              } while (!QLog.isColorLevel());
              ...
              if (paramInt1 == 2)
              {
                ...
                for (;;)
                {
                  this.jdField_a_of_type_Qtv.jdField_b_of_type_AndroidViewView.setBackgroundColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131165275));
                  A();
                  this.jdField_a_of_type_AndroidOsHandler.removeMessages(100);
                  this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(100, 3000L);
                  if ((bbfj.b(this.jdField_a_of_type_AndroidAppActivity)) && (!this.jdField_d_of_type_Boolean))
                  {
                    u();
                    this.jdField_d_of_type_Boolean = true;
                  }
                  a(this.jdField_f_of_type_AndroidWidgetImageView);
                  if ((this.jdField_a_of_type_Qtv.jdField_b_of_type_Boolean) && (this.jdField_f_of_type_AndroidWidgetImageView != null)) {
                    this.jdField_f_of_type_AndroidWidgetImageView.setVisibility(8);
                  }
                  E();
                  K();
                  return;
                  qoi.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView, 8, 300);
                }
              }
              if (paramInt1 == 4)
              {
            ...
            w();
          } while (!bbfj.b(this.jdField_a_of_type_AndroidAppActivity));
          u();
          return;
        } while (!this.jdField_a_of_type_Qtv.jdField_b_of_type_Boolean);
        this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        return;
        if (paramInt2 == 4)
      ...
      paramqtv = (int[])paramObject;
      a(1, qtx.a(paramqtv[0], paramqtv[1]), ajya.a(2131716438));
      return;
    } while (paramInt2 != 7);
    if ((!omr.a(paramqtv)) && (this.jdField_a_of_type_Qtl.a()) && (this.jdField_a_of_type_Qtv.jdField_c_of_type_Boolean))
    {
      this.jdField_a_of_type_Qtl.a(paramqtv);
      return;
    }
    if (this.jdField_k_of_type_Int == 2)
    {
      qkr.jdField_c_of_type_Boolean = true;
      i(2);
  ...
  public void a(qvf paramqvf)
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilList.contains(paramqvf)) {
      this.jdField_a_of_type_JavaUtilList.add(paramqvf);
    }
  }
  
  public void a(qvg paramqvg)
  {
    this.jdField_a_of_type_Qvg = paramqvg;
  }
  
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Qju != null) {
      this.jdField_a_of_type_Qju.a(paramBoolean);
    }
    if ((this.jdField_a_of_type_Qju != null) && (this.jdField_a_of_type_Qtv != null) && (this.jdField_a_of_type_Qtv.jdField_b_of_type_Boolean))
    {
      this.jdField_a_of_type_Qju.a(false);
      this.jdField_c_of_type_Boolean = false;
    }
  }
  ...
  public void b(qvg paramqvg)
  {
    this.jdField_a_of_type_JavaUtilArrayList.add(paramqvg);
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (this.jdField_c_of_type_Boolean) {
      this.jdField_a_of_type_Qju.a(true);
    }
    this.jdField_a_of_type_Qtr.a(this.jdField_i_of_type_Int);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundColor(0);
    if ((this.jdField_a_of_type_Qtl.a() != null) && ((this.jdField_a_of_type_Qtl.a() instanceof qtv))) {
      a(false, (qtv)this.jdField_a_of_type_Qtl.a(), this.jdField_a_of_type_Qtv);
    }
    d(false);
    if (paramBoolean) {
      B();
  ...
  {
    if ((paramView.getTag() == null) || (!(paramView.getTag() instanceof oyi))) {}
    do
    {
      oyi localoyi;
      do
        ...
        do
        {
          do
          {
            do
            {
              return;
              n = this.jdField_a_of_type_Qtr.a();
              localoyi = (oyi)paramView.getTag();
              if (QLog.isColorLevel()) {
                QLog.d("Q.readinjoy.video.VideoUIManager", 2, "handleItemClick():  playState=" + qtx.a(n) + ", view id: " + qoi.a(paramView));
              }
              if ((n != 7) || (!f())) {
                break;
              }
            ...
            if (!qkr.a().a()) {
              qvk.a().a(false, "noAutoPlayClickVideoInReadInjoy", 1);
            }
            this.jdField_a_of_type_Qtr.a(localoyi.a());
            paramView = localoyi.a().jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo;
          } while ((paramView == null) || (paramView.mChannelID != 56L) || (!AdvertisementInfo.isAdvertisementInfo(paramView)));
          ((AdvertisementInfo)paramView).adbt = ((int)localoyi.a().jdField_d_of_type_Long);
          ((AdvertisementInfo)paramView).adpa = 1;
          ((AdvertisementInfo)paramView).adpb = 2;
          nmc.a(new nyd().a(this.jdField_a_of_type_AndroidAppActivity).a(nmc.jdField_f_of_type_Int).b(nmc.M).a((AdvertisementInfo)paramView).a(nmc.a(((AdvertisementInfo)paramView).adbt, 0, ((AdvertisementInfo)paramView).getAdbf(), 0, 1, 2, paramView.mVideoDuration, nmc.aF, 0)).a());
          return;
          if (this.jdField_a_of_type_Qtr.b() != localoyi.a().jdField_c_of_type_Long) {
            break;
          }
        } while (n == 1);
        if ((n != 5) || (!d())) {
      ...
      {
        nmc.a(new nyd().a(this.jdField_a_of_type_AndroidAppActivity).a(nmc.jdField_f_of_type_Int).b(nmc.M).a((AdvertisementInfo)paramView).a(nmc.a(0, 0, 1, 0, 1, 2, paramView.mVideoDuration, nmc.aF, 0)).a());
  ...
  public void c(qvg paramqvg)
  {
    this.jdField_a_of_type_JavaUtilArrayList.remove(paramqvg);
  }
  ...
  public void d()
  {
    ...
    float f1 = bbdh.a(this.jdField_a_of_type_AndroidAppActivity);
    if (this.jdField_a_of_type_Qtv.jdField_b_of_type_Boolean) {
      if (this.jdField_a_of_type_Qtv.l > 0) {
        f1 = this.jdField_a_of_type_Qtv.l;
      }
    }
    float f2;
    for (;;)
    {
      f2 = f1 * omr.a(this.jdField_a_of_type_Qtv.jdField_c_of_type_Int, this.jdField_a_of_type_Qtv.jdField_d_of_type_Int);
      if (!this.jdField_a_of_type_Qtl.a()) {
        break;
      }
      ...
      return;
      continue;
      f1 = omr.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Qtv);
    }
    Object localObject;
    ...
    {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewVideoViewGroup.a(true);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewVideoViewGroup.setCustomSize(1.0F, omr.a(this.jdField_a_of_type_Qtv.jdField_c_of_type_Int, this.jdField_a_of_type_Qtv.jdField_d_of_type_Int));
      return;
  ...
  {
    if ((this.jdField_b_of_type_AndroidWidgetSeekBar == null) || (this.jdField_a_of_type_Qtv == null)) {
      return;
    }
    qvk.a().a(paramInt);
    paramInt = (int)(qvk.a().a() * this.jdField_a_of_type_Qtv.jdField_b_of_type_Int);
    if (c())
    {
      h(paramInt);
      return;
  ...
  public void e()
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((this.jdField_b_of_type_Boolean) || (this.jdField_a_of_type_Qtv == null) || (this.jdField_a_of_type_Qtv.jdField_a_of_type_AndroidViewView == null));
      ...
      this.jdField_a_of_type_Qtv.jdField_a_of_type_AndroidViewView.getLocationOnScreen(this.jdField_a_of_type_ArrayOfInt);
    ...
    amet.f(this.jdField_a_of_type_AndroidWidgetFrameLayout, n);
  }
  ...
  public void h()
  {
    ...
    if (a())
    {
      ...
      f(1);
      label69:
      this.jdField_a_of_type_Qyv.a();
      qoi.a(this.jdField_b_of_type_AndroidWidgetRelativeLayout, 0, 300);
      if (!this.jdField_a_of_type_Boolean)
      {
        vzl.a(this.jdField_b_of_type_AndroidWidgetImageView, 10, 10, 10, 10);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.getVisibility() != 0) {
        qoi.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0, 300);
      }
      this.jdField_e_of_type_AndroidWidgetImageView.setVisibility(8);
  ...
  public void i()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
    qoi.a(this.jdField_a_of_type_AndroidWidgetImageView, 8, 300);
    qoi.a(this.jdField_b_of_type_AndroidWidgetRelativeLayout, 8, 300);
    if ((a()) || (7 == this.jdField_a_of_type_Qtr.a())) {
      this.jdField_b_of_type_AndroidWidgetSeekBar.setVisibility(8);
    }
    for (;;)
    {
  ...
  public void j()
  {
    a(0, ajya.a(2131716440), qoi.b(this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.mXGFileSize) + ajya.a(2131716437));
  }
  ...
  public void k()
  {
    if (this.jdField_a_of_type_Qtl != null)
    {
      ...
      this.jdField_a_of_type_Qtl = null;
    }
    ...
    if (this.jdField_a_of_type_Qju != null)
    {
      ...
      this.jdField_a_of_type_Qju = null;
    }
    this.jdField_c_of_type_Boolean = false;
  ...
  {
    int n = 0;
    int i1 = this.jdField_a_of_type_Qtr.a();
    if (QLog.isColorLevel()) {
      QLog.d("Q.readinjoy.video.VideoUIManager", 2, "onClick(): current playState=" + qtx.a(i1) + ", view id: " + qoi.a(paramView));
    }
    ...
    do
    {
      do
      {
        ...
        do
        {
          do
          {
            ...
            if (paramView.getId() == 2131371103)
            {
              ...
              for (;;)
              {
                ...
                continue;
                this.jdField_a_of_type_Qtr.e(true);
              }
            }
          ...
          } while ((this.jdField_a_of_type_Qtr.a() != 6) || (this.jdField_a_of_type_Qtv == null));
          qyw.b(this.jdField_a_of_type_Qtv.a(), 3);
          ...
          if ((paramView.getId() != 2131379134) && (paramView.getId() != 2131379135)) {
            break label469;
          }
          if (qvk.a().c()) {
            break label456;
          ...
          bool = true;
          qvk.a().a(bool, "user click audio btn", 1);
        } while ((this.jdField_a_of_type_Qtv == null) || (this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo == null));
        qzb localqzb = new qzb("", this.jdField_a_of_type_Qtv.k, this.jdField_a_of_type_Qtv.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.innerUniqueID);
        localqzb.a((int)this.jdField_a_of_type_Qtv.jdField_b_of_type_Long);
        if (bool) {}
        for (paramView = "1";; paramView = "0")
        {
          localqzb.a("status", paramView);
          nol.a(null, "", "0X8009BD6", "0X8009BD6", 0, 0, "3", "", "", localqzb.a().a(), false);
          return;
          bool = false;
          break;
        }
        if (paramView.getId() != 2131375122) {
          break label595;
        }
        this.jdField_a_of_type_Qyv.a();
        this.jdField_a_of_type_Qtr.a(this.jdField_a_of_type_Qtv);
      } while ((this.jdField_a_of_type_Qtv == null) || (this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo == null));
      paramView = new qzb("", this.jdField_a_of_type_Qtv.k, this.jdField_a_of_type_Qtv.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo.innerUniqueID);
      paramView.a((int)this.jdField_a_of_type_Qtv.jdField_b_of_type_Long);
      nol.a(null, "", "0X8009BC8", "0X8009BC8", 0, 0, "3", "", "", paramView.a().a(), false);
      return;
      if ((paramView.getId() == 2131365357) || (paramView.getId() == 2131365363))
      {
        H();
        return;
      }
    } while ((paramView.getId() != 2131379039) || (this.jdField_a_of_type_Qtv == null) || (this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo == null));
    label595:
    if (a()) {
      b(false);
    }
    this.jdField_a_of_type_AndroidOsHandler.post(new VideoUIManager.9(this));
    qyw.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Qtv.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo, this.jdField_a_of_type_Qtr.a(this.jdField_a_of_type_Qtv.a()), 3, 0);
    qyw.a(this.jdField_a_of_type_Qtv.a(), 3, 0);
  }
