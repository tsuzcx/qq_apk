...
public class bdjs<T>
  extends Animation
{
  static final bdjz jdField_a_of_type_Bdjz = new bdjt();
  static final bdjz b;
  static final bdjz c;
  static final bdjz d;
  static final bdjz e = new bdjx();
  ...
  static
  {
    jdField_b_of_type_Bdjz = new bdju();
    jdField_c_of_type_Bdjz = new bdjv();
    jdField_d_of_type_Bdjz = new bdjw();
  }
  
  public bdjs(T paramT1, T paramT2, bdjy<T> parambdjy)
  {
    this(paramT1, paramT2, parambdjy, false, false, null);
  }
  
  public bdjs(T paramT1, T paramT2, bdjy<T> parambdjy, boolean paramBoolean1, boolean paramBoolean2)
  {
    this(paramT1, paramT2, parambdjy, paramBoolean1, paramBoolean2, null);
  }
  
  public bdjs(T paramT1, T paramT2, bdjy<T> parambdjy, boolean paramBoolean1, boolean paramBoolean2, bdjz<T> parambdjz)
  {
    ...
    for (;;)
    {
      ...
      {
        this.f = jdField_a_of_type_Bdjz;
      }
      else if (Float.class == localClass)
      {
        this.f = jdField_b_of_type_Bdjz;
      }
      else if (Rect.class == localClass)
      {
        this.f = jdField_c_of_type_Bdjz;
      }
      else if (Point.class == localClass)
      {
        this.f = jdField_d_of_type_Bdjz;
      }
      else
      {
  ...
  public void a(bdjy<T> parambdjy)
  {
    this.jdField_a_of_type_Bdjy = parambdjy;
  }
  ...
  protected void applyTransformation(float paramFloat, Transformation paramTransformation)
  {
    if (this.jdField_a_of_type_Bdjy != null) {
      this.jdField_a_of_type_Bdjy.a(this, paramFloat, this.f.a(paramFloat, this.jdField_a_of_type_JavaLangObject, this.jdField_b_of_type_JavaLangObject), paramTransformation);
    }
  }
