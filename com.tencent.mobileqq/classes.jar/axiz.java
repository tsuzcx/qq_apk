  ...
  extends axic
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anvx.a(2131715674);
  }
  
  public axiz(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private void a(HashMap<String, ArrayList<MessageRecord>> paramHashMap, ArrayList<MessageForShortVideo> paramArrayList, ArrayList<bcxd> paramArrayList1, bcxr parambcxr, axiu paramaxiu, axif paramaxif)
  {
    bcxr localbcxr = parambcxr;
    if (parambcxr == null) {
      localbcxr = bcwz.a(5, 5);
    }
    localbcxr.a(paramArrayList1);
    localbcxr.a(new axja(this, paramArrayList, paramHashMap, paramaxif, paramaxiu));
  ...
  public void a(axiu paramaxiu, HashMap<String, ArrayList<MessageRecord>> paramHashMap, axif paramaxif)
  {
    ...
    for (;;)
    {
      bcxd localbcxd = bcwz.a(5, localObject2, (bcxr)localObject1);
      if (localbcxd != null)
      {
        localArrayList1.add(localbcxd);
      ...
      if ((localArrayList1.size() > 0) && (localArrayList2.size() > 0))
      {
        ...
        a(paramHashMap, localArrayList2, localArrayList1, (bcxr)localObject2, paramaxiu, paramaxif);
        return;
      }
      paramaxif.a(0, 8, paramaxiu);
      return;
    }
  }
}
