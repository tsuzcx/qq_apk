...
public class avgg
  implements azla
{
  public avgg(RobotChatPanelLayout paramRobotChatPanelLayout, long paramLong, int paramInt, String paramString, azna paramazna) {}
  ...
  public void a(int paramInt, cmd0x934.RspBody paramRspBody)
  {
    ...
    {
      this.jdField_a_of_type_Azna.a(bool1, this.jdField_a_of_type_JavaLangString);
      if (!QLog.isColorLevel()) {
        break;
      }
