...
{
  public avvx(OCRResultActivity paramOCRResultActivity, EditText paramEditText) {}
  ...
  public boolean onActionItemClicked(ActionMode paramActionMode, MenuItem paramMenuItem)
  {
    if (paramMenuItem.getItemId() == 2131371337)
    {
      ...
      if (TextUtils.isEmpty(paramActionMode)) {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqOcrOCRResultActivity, 1, alud.a(2131708212), 0).a();
      }
    }
    else
    {
