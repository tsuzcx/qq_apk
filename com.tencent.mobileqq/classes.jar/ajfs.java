...
public class ajfs
  extends ajfb
{
  batl jdField_a_of_type_Batl = new ajft(this);
  ...
  {
    ((arnz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(paramString, paramInt1, "", paramInt2, 0);
    if (QLog.isColorLevel()) {
      QLog.d("ClubContentUpdateHandler", 2, "small emotion has update info.");
    }
    balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), "small_emosm_update_flag" + paramString, paramInt1);
  }
  
  private void a(int paramInt, baly parambaly)
  {
    if (Math.abs(paramInt - balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), parambaly.d)) > 5)
    {
      if (QLog.isColorLevel()) {
        QLog.i("ClubContentUpdateHandler", 2, "New version json found!");
      }
      if (this.jdField_a_of_type_Bato == null) {
        this.jdField_a_of_type_Bato = ((bato)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47));
      }
      File localFile = new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext().getFilesDir(), parambaly.a);
      Bundle localBundle = new Bundle();
      localBundle.putInt("version", paramInt);
      localBundle.putString("json_name", parambaly.d);
      parambaly = new batm(parambaly.b, localFile);
      this.jdField_a_of_type_Bato.a(1).a(parambaly, this.jdField_a_of_type_Batl, localBundle);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      localReqBody.str_clientver.set("8.2.6.4370");
  ...
  private void a(String paramString1, int paramInt1, String paramString2, int paramInt2, Map<String, Integer> paramMap, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (!paramString1.equals(balu.a.e)) {
            break;
          }
          if (QLog.isColorLevel()) {
            QLog.d("ClubContentUpdateHandler", 2, "func updateEmojiJson, sEPPromotionTask!");
          }
          paramInt2 = balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), balu.a.d);
        } while (paramInt1 <= paramInt2);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
        balu.a(MobileQQ.getContext(), balu.a.d, paramInt2);
        ...
        ((ajhm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(12)).a();
      ...
      } while (!anjd.a(paramInt2));
      ((arnz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).b(paramString1.replace("_json", "").trim(), paramInt1, paramString2, paramInt2, 0);
      return;
      if (QLog.isColorLevel()) {
        QLog.d("ClubContentUpdateHandler", 2, "func updateEmojiJson, update emoji package!");
      }
      ((arnz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(paramString1, paramInt1, paramString2, paramInt2, 0);
  ...
  private boolean a(int paramInt, baly parambaly, boolean paramBoolean)
  {
    int i = balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), parambaly.d);
    if (QLog.isColorLevel()) {
      QLog.d("ClubContentUpdateHandler", 2, "updateResJson name = " + parambaly.e + " localVersion = " + i + " version = " + paramInt);
    }
    if (paramInt > i)
    {
      balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, parambaly, paramInt, paramBoolean);
      return true;
    }
    return false;
  }
  ...
  private void g(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    while (paramRspAppInfo.hasNext())
    {
      ...
      if (!str1.equals(balu.b.e)) {}
    }
  }
  
  protected ClubContentUpdateInfoPb.ReqAppInfo a()
  {
    Object localObject = ((arnz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(0);
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localEmoticonPackage.jobType == 4) && (localEmoticonPackage.status == 2) && (!anjd.b(localEmoticonPackage.updateFlag)))
        {
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo a(baly parambaly, int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    ClubContentUpdateInfoPb.ReqItemInfo localReqItemInfo = new ClubContentUpdateInfoPb.ReqItemInfo();
    localReqItemInfo.str_name.set(parambaly.e);
    localReqItemInfo.uint_version.set(balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), parambaly.d));
    localArrayList.add(localReqItemInfo);
    parambaly = new ClubContentUpdateInfoPb.ReqAppInfo();
    parambaly.uint_appid.set(paramInt);
    parambaly.rpt_msg_reqiteminfo.set(localArrayList);
    parambaly.setHasFlag(true);
    return parambaly;
  }
  ...
  public void a()
  {
    ...
    localArrayList.add(b(balu.c, 7));
    localArrayList.add(a(balu.e, 105));
    localArrayList.add(b(balu.f, 11));
    localArrayList.add(b(balu.h, 113));
    localArrayList.add(b(balu.i, 5));
  ...
  public void a(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      if (balu.a(paramContext, balu.e.d) != i)
      {
        a(i, balu.e);
        return;
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    //   115: return
    //   116: getstatic 531	balu:e	Lbaly;
    //   119: getfield 297	baly:e	Ljava/lang/String;
    //   122: aload 9
    //   124: invokevirtual 302	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   127: ifeq +1276 -> 1403
    //   130: aload_0
    //   131: iload 4
    //   133: getstatic 531	balu:e	Lbaly;
    //   136: invokespecial 593	ajfs:a	(ILbaly;)V
    //   139: goto +1264 -> 1403
    //   142: aload_1
    ...
    //   169: invokestatic 89	balu:a	(Landroid/content/Context;Ljava/lang/String;)I
    //   172: istore 5
    ...
    //   239: iconst_1
    //   240: aload 9
    //   242: invokespecial 616	ajfs:a	(IILjava/lang/String;)V
    //   245: goto -129 -> 116
    ...
    //   278: iconst_1
    //   279: invokespecial 623	ajfs:a	(Ljava/lang/String;ILjava/lang/String;ILjava/util/Map;Z)V
    //   282: goto -166 -> 116
    //   285: getstatic 527	balu:c	Lbaly;
    //   288: getfield 297	baly:e	Ljava/lang/String;
    //   291: aload 9
    //   293: invokevirtual 302	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   296: ifeq -180 -> 116
    //   299: aload_0
    //   300: iload 4
    //   302: getstatic 527	balu:c	Lbaly;
    //   305: iconst_1
    //   306: invokespecial 307	ajfs:a	(ILbaly;Z)Z
    //   309: pop
    //   310: goto -194 -> 116
    //   313: ldc 44
    //   315: iconst_1
    ...
    //   385: invokevirtual 634	aifg:b	(Ljava/lang/String;)I
    ...
    //   403: aload 9
    //   405: iload 4
    //   407: invokevirtual 641	ajfs:a	(Ljava/lang/String;I)V
    //   410: goto -294 -> 116
    //   413: ldc 44
    //   415: iconst_1
    //   416: ldc_w 643
    ...
    //   465: iload 4
    //   467: iconst_0
    //   468: invokestatic 650	aivr:a	(Laivr;Lcom/tencent/common/app/AppInterface;IZ)V
    //   471: goto -355 -> 116
    //   474: ldc 44
    //   476: iconst_1
    ...
    //   546: invokevirtual 634	aifg:b	(Ljava/lang/String;)I
    ...
    //   561: iconst_1
    //   562: iload 5
    //   564: invokevirtual 657	aifg:a	(II)J
    //   567: ldc2_w 658
    //   570: ldiv
    //   571: lstore 6
    //   573: lload 6
    ...
    //   592: iconst_m1
    //   593: iconst_1
    //   594: invokestatic 664	aitw:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Laiud;I[IIIZ)V
    //   597: ldc 44
    //   599: iconst_1
    ...
    //   756: invokevirtual 634	aifg:b	(Ljava/lang/String;)I
    ...
    //   771: iconst_2
    //   772: iload 5
    //   774: invokevirtual 657	aifg:a	(II)J
    //   777: ldc2_w 658
    //   780: ldiv
    //   781: lstore 6
    //   783: lload 6
    ...
    //   808: iconst_m1
    //   809: iconst_1
    //   810: invokestatic 678	aitw:b	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Laiud;I[IIIZ)V
    //   813: ldc 44
    //   815: iconst_1
    ...
    //   885: goto -769 -> 116
    //   888: invokestatic 686	akgx:a	()Ljava/lang/String;
    //   891: aload 9
    ...
    //   933: invokevirtual 634	aifg:b	(Ljava/lang/String;)I
    //   936: if_icmpne +131 -> 1067
    //   939: aload_1
    //   940: bipush 115
    //   942: invokevirtual 319	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajfb;
    //   945: checkcast 684	akgx
    //   948: ifnull -832 -> 116
    //   951: invokestatic 688	akgx:b	()J
    //   954: lstore 6
    //   956: lload 6
    //   958: iload 4
    //   960: i2l
    ...
    //   972: getstatic 693	aiys:av	Ljava/lang/String;
    ...
    //   1008: aload_1
    //   1009: aload 10
    //   1011: getstatic 701	aiys:at	Ljava/lang/String;
    //   1014: aload 11
    //   1016: new 703	akgz
    //   1019: dup
    //   1020: invokespecial 704	akgz:<init>	()V
    //   1023: invokestatic 707	aitw:a	(Lcom/tencent/common/app/AppInterface;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Lbatl;)V
    //   1026: ldc 44
    //   1028: iconst_1
    ...
    //   1076: goto -960 -> 116
    //   1079: getstatic 479	balu:b	Lbaly;
    //   1082: getfield 297	baly:e	Ljava/lang/String;
    //   1085: aload 9
    ...
    //   1108: goto -992 -> 116
    //   1111: getstatic 539	balu:h	Lbaly;
    //   1114: getfield 297	baly:e	Ljava/lang/String;
    //   1117: aload 9
    ...
    //   1140: aload_0
    //   1141: iload 4
    //   1143: getstatic 539	balu:h	Lbaly;
    //   1146: iconst_1
    //   1147: invokespecial 307	ajfs:a	(ILbaly;Z)Z
    //   1150: pop
    //   1151: goto -1035 -> 116
    //   1154: getstatic 541	balu:i	Lbaly;
    //   1157: getfield 297	baly:e	Ljava/lang/String;
    //   1160: aload 9
    ...
    //   1183: aload_0
    //   1184: iload 4
    //   1186: getstatic 541	balu:i	Lbaly;
    //   1189: iconst_1
    //   1190: invokespecial 307	ajfs:a	(ILbaly;Z)Z
    //   1193: pop
    //   1194: goto -1078 -> 116
    ...
    //   361	199	10	localaifg1	aifg
    //   638	27	10	localException2	Exception
    //   732	38	10	localaifg2	aifg
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo b()
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localEmoticonPackage.jobType == 0) && (localEmoticonPackage.status == 2) && (!anjd.b(localEmoticonPackage.updateFlag)))
        {
    ...
    for (;;)
    {
      ...
      ((ClubContentUpdateInfoPb.ReqItemInfo)localObject).str_name.set(balu.d.e);
      ((ClubContentUpdateInfoPb.ReqItemInfo)localObject).uint_version.set(balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), balu.d.d));
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo b(baly parambaly, int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    ClubContentUpdateInfoPb.ReqItemInfo localReqItemInfo = new ClubContentUpdateInfoPb.ReqItemInfo();
    localReqItemInfo.str_name.set(parambaly.e);
  ...
  protected void b(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((str1.equals(balu.e.e)) && (i > balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), balu.e.d))) {
        a(i, balu.e);
      }
    }
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo c()
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localEmoticonPackage.jobType == 3) && (localEmoticonPackage.status == 2) && (!anjd.b(localEmoticonPackage.updateFlag)))
        {
          localReqItemInfo = new ClubContentUpdateInfoPb.ReqItemInfo();
          localReqItemInfo.str_name.set(localEmoticonPackage.epId);
          localReqItemInfo.uint_version.set(localEmoticonPackage.localVersion);
  ...
  protected void c(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    while (paramRspAppInfo.hasNext())
    {
      ...
      if (!TextUtils.isEmpty(str1))
      {
        ...
        if (str1.equals(balu.c.e))
        {
          if (i > balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), balu.c.d)) {
            balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, balu.c, i, false);
          }
        }
        else if (str1.equals(balu.f.e))
        {
          if (i > balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), balu.f.d)) {
            balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, balu.f, i, false);
          }
        }
        else if (str1.equals(balu.i.e))
        {
          j = balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), balu.i.d);
          if (QLog.isColorLevel()) {
            QLog.d("ClubContentUpdateHandler", 2, "FontInfoList_json remoteVersion = " + i + " localVersion = " + j);
          }
          if (i > j) {
            balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, balu.i, i, false);
          }
        }
      }
    }
  ...
  protected void d(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    while (paramRspAppInfo.hasNext())
    {
      ...
      int i = localRspItemInfo.uint_version.get();
      int j = localRspItemInfo.uint_update_flag.get();
      int k = balu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext(), "small_emosm_update_flag" + str);
      if (QLog.isColorLevel()) {
