...
{
  bohw(bohv parambohv, Context paramContext) {}
  
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    this.jdField_a_of_type_Bohv.b(this.jdField_a_of_type_Bohv.a.a);
    this.jdField_a_of_type_Bohv.a = null;
    if (paramInt == 1)
    {
      this.jdField_a_of_type_Bohv.c = true;
