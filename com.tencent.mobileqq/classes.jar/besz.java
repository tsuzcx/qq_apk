...
class besz
{
  ...
  {
    if (!besx.a(this.jdField_a_of_type_Besx).a()) {}
    for (int i = 2;; i = 5)
    {
      if (paramArrayOfInt != null)
      {
  ...
  FileStorageServerListInfo a()
  {
    ...
    ArrayList localArrayList = besx.c(this.jdField_a_of_type_Besx, 16);
    ...
    if (localArrayList != null)
    {
      ...
      if (localArrayList.size() > 0)
      {
        int i = b(besx.a(this.jdField_a_of_type_Besx).a(besx.a(this.jdField_a_of_type_Besx).b()));
        localObject1 = localObject2;
        if (i > -1)
        {
          localObject1 = localObject2;
  ...
  {
    Object localObject2 = null;
    ArrayList localArrayList = besx.c(this.jdField_a_of_type_Besx, paramInt);
    Object localObject1 = localObject2;
    if (localArrayList != null)
    {
      localObject1 = localObject2;
  ...
  void a(FileStoragePushFSSvcList paramFileStoragePushFSSvcList)
  {
    ...
    if (paramFileStoragePushFSSvcList != null)
    {
      ...
      if (i <= 10)
      {
        paramFileStoragePushFSSvcList = besx.a(this.jdField_a_of_type_Besx, besx.a(this.jdField_a_of_type_Besx, i));
        if (paramFileStoragePushFSSvcList != null) {}
      ...
      if (i <= 15)
      {
        paramFileStoragePushFSSvcList = besx.b(this.jdField_a_of_type_Besx, besx.b(this.jdField_a_of_type_Besx, i));
        if (paramFileStoragePushFSSvcList != null) {}
        for (j = paramFileStoragePushFSSvcList.size();; j = 0)
        {
          this.jdField_a_of_type_Array2dOfInt[i] = new int[j];
      ...
      paramFileStoragePushFSSvcList = besx.b(this.jdField_a_of_type_Besx, besx.b(this.jdField_a_of_type_Besx, 17));
      i = k;
      if (paramFileStoragePushFSSvcList != null) {
    ...
    besx.a(this.jdField_a_of_type_Besx).a();
  }
