  ...
  implements aofd
{
  ...
  public static aofd a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.mobileqq.ar.aidl.IArFaceCallback");
    if ((localIInterface != null) && ((localIInterface instanceof aofd))) {
      return (aofd)localIInterface;
    }
    return new aoff(paramIBinder);
  }
