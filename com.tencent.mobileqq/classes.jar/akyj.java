  ...
  implements akud, Manager
{
  ...
  public akyl a(String paramString)
  {
    akyl localakyl = this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedQWRedConfig.getShowInfoByPath(paramString);
    if (QLog.isColorLevel()) {
      QLog.d("QWalletRedManager", 2, "getShowInfo path=" + paramString + ",res=" + localakyl);
    }
    return localakyl;
  }
  ...
  public void a(String paramString)
  {
    ...
    if (paramString.size() > 0)
    {
      ...
      akra.a(RedInfoSyncReq.createReq(paramString), new akyk(this));
    }
    if (localList.size() > 0) {
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletRedQWRedConfig.parseConfig(paramaktx);
  }
  ...
  {
    aktz localaktz = (aktz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.QWALLET_CONFIG_MANAGER);
    if (localaktz != null) {
      localaktz.d("redPoint", this);
    }
  }
}
