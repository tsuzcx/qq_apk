  ...
  implements Manager
{
  ...
  private altm jdField_a_of_type_Altm = new alqa(this);
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfInt = new int[] { 2130845485, 2130844525, 2130844525, 2130844525, 2130845244, 2130845244, 2130845502, 2130845502, 2130845026, 2130845026, 2130845026, 2130845485, 2130845485, 2130845305, 2130845485 };
  ...
  public alpy(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(int paramInt, boolean paramBoolean)
  {
    ...
    if (paramInt == 1)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        {
          bool = true;
          QLog.d("ConditionSearch.Manager", 2, bool + " | isNetAvaiable = " + bdin.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()));
        }
      }
      else
      {
        ...
        localObject = ((bbaa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(193)).a(this.jdField_a_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("ConditionSearch.Manager", 2, "update, find task=" + localObject);
        }
        if ((localObject != null) && ((localObject instanceof alqb))) {
          ((alqb)localObject).realStart();
        }
      }
    }
    label246:
    while (paramInt != 2)
    {
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        localObject = (alqf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(4);
        ((alqf)localObject).a(null, new GetResourceReqInfo[] { ((alqf)localObject).e() });
        return 0;
      }
    }
    label264:
  ...
  public List<BaseAddress> a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqConditionsearchDataAddressData != null)
    {
      ...
      Collections.sort(localArrayList, new alpz(this));
    }
  ...
  public void a(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      paramGetResourceRespInfo = new alqb(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, paramGetResourceRespInfo, localFile);
      ...
      bool = ((bbaa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(193)).a(10023, "prd", (String)localObject, 0, (String)localObject, localFile.getAbsolutePath(), 2, 0, false, paramGetResourceRespInfo);
      if (QLog.isColorLevel()) {
  ...
  void a(boolean paramBoolean1, List<CondFitUser> paramList, boolean paramBoolean2, int paramInt)
  {
    ...
    if (this.jdField_b_of_type_JavaUtilLinkedList != null)
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        ((alqe)((Iterator)localObject).next()).a(paramBoolean1, paramList, paramBoolean2, paramInt);
      }
    }
  }
  ...
  public String c(String paramString)
  {
    ...
    {
      String[] arrayOfString = bdnn.a(paramString, '-');
      str = paramString;
      if (arrayOfString.length >= 2)
      {
  ...
  public void c(Object paramObject)
  {
    ...
    do
    {
      this.jdField_a_of_type_JavaUtilLinkedList.add((alqc)paramObject);
      do
      {
        return;
      } while (!(paramObject instanceof alqe));
      if (this.jdField_b_of_type_JavaUtilLinkedList == null) {
    ...
    this.jdField_b_of_type_JavaUtilLinkedList.add((alqe)paramObject);
  }
  ...
  public int d()
  {
    if (this.jdField_g_of_type_Boolean)
    {
      Card localCard = ((alto)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      if (localCard == null) {
        break label134;
      }
      if (localCard.shGender != 0) {
  ...
  public void d(Object paramObject)
  {
    ...
    while ((!(paramObject instanceof alqe)) || (this.jdField_b_of_type_JavaUtilLinkedList == null)) {
      return;
    }
