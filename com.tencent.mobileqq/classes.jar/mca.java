...
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mcb(this);
  private Context jdField_a_of_type_AndroidContentContext;
  private boolean jdField_a_of_type_Boolean;
  private long[] jdField_a_of_type_ArrayOfLong;
  private boolean b;
  
  public mca(Context paramContext)
  {
  ...
  private void a(View paramView)
  {
    ...
    ((Activity)localObject).findViewById(2131373270).setVisibility(0);
    paramView = (TextView)((Activity)localObject).findViewById(2131373272);
    localObject = (TextView)((Activity)localObject).findViewById(2131373271);
    ...
    String str1 = lkq.a(this.jdField_a_of_type_AndroidContentContext);
    str2 = str2 + "\n----------\n";
    str1 = str2 + a(str1);
    paramView.setText(i + "|" + lvm.a().a("load"));
  ...
  {
    Object localObject = (Activity)this.jdField_a_of_type_AndroidContentContext;
    View localView = ((Activity)localObject).findViewById(2131373269);
    if (localView != null)
    {
      localView.setOnClickListener(this);
      localView.setVisibility(0);
    }
    localView = ((Activity)localObject).findViewById(2131373271);
    if (localView != null) {
      localView.setOnClickListener(this);
    }
    localObject = ((Activity)localObject).findViewById(2131373270);
    if (localObject != null) {
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ArrayOfLong[0] >= SystemClock.uptimeMillis() - 2000L)
      {
        a(paramView);
        continue;
        ((Activity)this.jdField_a_of_type_AndroidContentContext).findViewById(2131373270).setVisibility(8);
      }
    }
  }
}
