...
public class abwj
  extends Handler
{
  public abwj(QQSettingMe paramQQSettingMe, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if ((QQSettingMe.a(this.a) != null) && (QQSettingMe.a(this.a).payHide == 1))
    {
      ...
      akjo.a(this.a.a.c(), QQSettingMe.a(this.a));
      sendEmptyMessage(2);
    }
    bbwv.a(this.a.a, "last_pull_pay_rule", 0L);
    paramMessage = ((TicketManager)this.a.a.getManager(2)).getSkey(this.a.a.getCurrentAccountUin());
    ((akjo)this.a.a.a(27)).a(paramMessage, this.a.a.c());
  }
}
