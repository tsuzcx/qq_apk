...
public class abwj
  extends ajuc
{
  public abwj(TroopDisbandActivity paramTroopDisbandActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 9)
    {
      ...
      if (paramInt2 == 8)
      {
        ...
        localObject = babr.a(this.a, 230);
        ((bafb)localObject).setTitle(this.a.getString(2131630726));
        ((bafb)localObject).setMessage(this.a.getString(2131630727));
        ((bafb)localObject).setNegativeButton(this.a.getString(2131630758), new abwk(this, (bafb)localObject));
        ((bafb)localObject).setPositiveButton(this.a.getString(2131653656), new abwl(this, (bafb)localObject));
    ...
    this.a.jdField_a_of_type_Bbmv.b(2, 2131626626, 1500);
  }
  
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    if (!azzz.a(paramString, this.a.jdField_a_of_type_JavaLangString)) {}
    while (paramInt1 != 9) {
      return;
    }
    paramString = this.a;
    ...
    if (paramInt2 == 0)
    {
      ...
      paramString.putExtra("fin_tip_msg", this.a.getString(2131626629));
  ...
  {
    if (!azzz.a(String.valueOf(paramLong1), this.a.jdField_a_of_type_JavaLangString)) {}
    Object localObject;
    label132:
    label190:
    label320:
    ...
    do
    {
      do
      {
        ...
        case 4: 
          if (paramBoolean)
          {
            ...
            } while ((this.a.jdField_a_of_type_JavaUtilArrayList.contains(localObject)) || (localObject == null) || ("".equals(((String)localObject).trim())) || (azzz.a(this.a.d, localObject)));
          ...
          paramList = (ajtg)this.a.app.a(20);
      ...
      paramList.putExtra("leftViewText", this.a.getString(2131651477));
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_Bbmv.b(2, 2131654543, 1500);
        return;
      }
      paramList = this.a;
      paramList.jdField_b_of_type_Int &= 0xFFFFFFFD;
      ...
      this.a.jdField_a_of_type_Bbmv.b(2, 2131654538, 1500);
      return;
    } while (!paramBoolean);
    label418:
    if (paramList == null)
    ...
    for (paramString = null;; paramString = paramString.b(this.a.jdField_a_of_type_JavaLangString))
    {
      ...
      this.a.jdField_a_of_type_Abwn.b(paramList);
      return;
      paramInt1 = paramList.size();
      break;
    }
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (azzz.a(paramString, this.a.jdField_a_of_type_JavaLangString)))
    {
      paramString = (TroopManager)this.a.app.getManager(52);
  ...
  protected void b(boolean paramBoolean, ArrayList<TroopInfo> paramArrayList)
  {
    ...
    label56:
    while (!azzz.a(localTroopInfo.troopuin, this.a.jdField_a_of_type_JavaLangString))
    {
      i += 1;
      break label21;
      break;
