  ...
  extends BaseAdapter
{
  ...
  public boolean a;
  int[] jdField_a_of_type_ArrayOfInt = { 2130844517, 2130844518, 2130844519 };
  String jdField_b_of_type_JavaLangString;
  int[] jdField_b_of_type_ArrayOfInt = { 2130844514, 2130844515, 2130844516 };
  
  public ablk(LikeRankingListActivity paramLikeRankingListActivity)
  {
    this.jdField_a_of_type_Boolean = false;
    this.jdField_b_of_type_JavaLangString = paramLikeRankingListActivity.getString(2131720346);
    this.jdField_a_of_type_JavaLangString = paramLikeRankingListActivity.getString(2131693812);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqActivityLikeRankingListActivity).inflate(2131560822, null);
      paramView = new ablm(this);
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131378302));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131368662));
      ...
      paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131378266));
      paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131378388));
      paramView.d = ((TextView)paramViewGroup.findViewById(2131378239));
      paramView.jdField_a_of_type_AndroidViewView = paramViewGroup.findViewById(2131365269);
      ...
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131369481));
      paramViewGroup.setTag(paramView);
      break;
      localLikeRankingInfo = a(paramInt);
    } while (localLikeRankingInfo == null);
    ablm localablm = (ablm)paramViewGroup.getTag();
    localablm.jdField_a_of_type_AndroidWidgetTextView.setText(String.valueOf(paramInt));
    String str;
    ...
    {
      localablm.jdField_a_of_type_AndroidViewView.setVisibility(0);
      str = String.valueOf(localLikeRankingInfo.uin);
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityLikeRankingListActivity.jdField_a_of_type_Ajxn.e(str);
      if (paramView == null) {
        break label634;
      }
      localablm.jdField_b_of_type_AndroidWidgetTextView.setText(paramView.getFriendNick());
      localObject = this.jdField_a_of_type_ComTencentMobileqqActivityLikeRankingListActivity.jdField_a_of_type_Baxk.a(1, str);
      paramView = (View)localObject;
      if (localObject == null)
      {
        if (!this.jdField_a_of_type_ComTencentMobileqqActivityLikeRankingListActivity.jdField_a_of_type_Baxk.a()) {
          this.jdField_a_of_type_ComTencentMobileqqActivityLikeRankingListActivity.jdField_a_of_type_Baxk.a(str, 1, true);
        }
        paramView = bbdr.a();
      }
      localablm.jdField_c_of_type_AndroidWidgetImageView.setImageBitmap(paramView);
      label462:
      switch (localLikeRankingInfo.rankingNum)
      {
      default: 
        if (localLikeRankingInfo.rankingNum < 1) {
          localablm.jdField_a_of_type_AndroidWidgetTextView.setText("-");
        }
        break;
      }
    }
    for (;;)
    {
      localablm.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      localablm.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      for (;;)
      {
        ...
        localablm.d.setText(paramView);
        localablm.jdField_c_of_type_AndroidWidgetTextView.setText(String.format(Locale.CHINA, this.jdField_b_of_type_JavaLangString, new Object[] { Integer.valueOf(localLikeRankingInfo.totalLikeCount) }));
        return paramViewGroup;
        localablm.jdField_a_of_type_AndroidViewView.setVisibility(8);
        break;
        label634:
        localablm.jdField_b_of_type_AndroidWidgetTextView.setText(str);
        localablm.jdField_c_of_type_AndroidWidgetImageView.setImageBitmap(bbdr.a());
        break label462;
        localablm.jdField_a_of_type_AndroidWidgetTextView.setText(String.valueOf(localLikeRankingInfo.rankingNum));
        localablm.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        localablm.jdField_b_of_type_AndroidWidgetImageView.setImageResource(this.jdField_b_of_type_ArrayOfInt[(localLikeRankingInfo.rankingNum - 1)]);
        localablm.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      localablm.jdField_a_of_type_AndroidWidgetTextView.setText(String.valueOf(localLikeRankingInfo.rankingNum));
    }
    paramView = (abll)paramViewGroup.getTag();
