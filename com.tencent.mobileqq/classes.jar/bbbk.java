  ...
  extends AccountObserver
{
  ...
  public void onGetQuickRegisterAccount(boolean paramBoolean, int paramInt, String paramString1, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    if (!paramBoolean) {
      try
      {
        ...
        if (TextUtils.isEmpty(paramString1)) {
          paramString2 = this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.getString(2131715879);
        }
    ...
    if (paramInt == 0)
    {
      bbbj.a(this.a, paramString1);
      bbbj.b(this.a, paramString2);
      if ((TextUtils.isEmpty(bbbj.a(this.a))) || (TextUtils.isEmpty(bbbj.b(this.a))))
      {
      ...
      paramString1.putExtra("uin", bbbj.a(this.a));
      paramString1.putExtra("key_register_password", bbbj.c(this.a));
      ...
      {
        bbbj.a(this.a, paramString1, false);
        return;
      }
  ...
  public void onRegisterCommitPassResp(boolean paramBoolean, int paramInt, String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          paramArrayOfByte2 = this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.getString(2131715879);
          ...
          if (paramBoolean)
          {
            ...
            localObject2 = "";
            bdll.a(localQQAppInterface, "new_reg", "setting_page_yes", "result", "", 1, "", (String)localObject1, "", (String)localObject2, "", "", "", "", "");
            this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.c();
            if (paramBoolean) {
              continue;
            }
      ...
      catch (UnsupportedEncodingException paramArrayOfByte2)
      {
        ...
        else
        {
          ...
          bbbj.a(this.a, paramString);
          bbbj.a(this.a, paramArrayOfByte1);
          bbbj.b(this.a, paramArrayOfByte3);
          if (!TextUtils.isEmpty(bbbj.a(this.a))) {
            continue;
          }
          this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(paramArrayOfByte2, 1);
          return;
        ...
        paramBoolean = false;
        continue;
        if ((bbbj.a(this.a) == null) || (bbbj.a(this.a).length == 0))
        {
          this.a.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(paramArrayOfByte2, 1);
          return;
        }
