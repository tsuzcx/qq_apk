  ...
  implements LayeredSocketFactory
{
  ...
  public axvl(String paramString)
  {
  ...
  public Socket createSocket(Socket paramSocket, String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      axrg.a(i + 4, paramString, paramInt, this.jdField_a_of_type_JavaLangString);
      paramSocket.close();
    ...
    axrg.a(i, paramString, paramInt, this.jdField_a_of_type_JavaLangString);
    return paramSocket;
  }
