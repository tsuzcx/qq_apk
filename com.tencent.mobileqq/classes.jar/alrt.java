  ...
  implements alvl
{
  ...
  private alrz jdField_a_of_type_Alrz = new alrv(this);
  private alsa jdField_a_of_type_Alsa;
  private alsb jdField_a_of_type_Alsb;
  Context jdField_a_of_type_AndroidContentContext;
  Handler jdField_a_of_type_AndroidOsHandler = new Handler(new alru(this));
  private bcws jdField_a_of_type_Bcws = new alrw(this);
  ...
  HorizontalListView.OnScrollStateChangedListener jdField_a_of_type_ComTencentWidgetHorizontalListView$OnScrollStateChangedListener = new alrx(this);
  ...
  public alrt(AppInterface paramAppInterface, Context paramContext, ArrayList<PtvTemplateManager.PtvTemplateInfo> paramArrayList, int paramInt, HorizontalListView paramHorizontalListView, FSurfaceViewLayout paramFSurfaceViewLayout)
  {
    ...
    alvi.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface).a(this);
  }
  ...
  public void a(alsa paramalsa)
  {
    this.jdField_a_of_type_Alsa = paramalsa;
  }
  
  public void a(alsb paramalsb)
  {
    this.jdField_a_of_type_Alsb = paramalsb;
  }
  ...
  public void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Alsb != null) {
        this.jdField_a_of_type_Alsb.c(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.type);
      }
    ...
    alvi.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo);
    ...
    {
      alpt.a("", "0X80075BA", paramPtvTemplateInfo, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id, "", "");
      if (!this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.hasGesture()) {
        break;
      }
      alpt.a("", "0X80083AE", paramPtvTemplateInfo, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id, "", "");
      return;
      ...
      this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo, this.jdField_a_of_type_Bcws);
  ...
  public void a(String paramString)
  {
    ...
    alvi.a("lbsUpdateFilter", String.format("currentPath=%s,name=%s", new Object[] { "" + this.jdField_a_of_type_JavaLangString, "" + paramString }), null);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localObject != null) && ("-1".equals(((PtvTemplateManager.PtvTemplateInfo)localObject).id)))
    {
    ...
    for (;;)
    {
      ...
      return localObject;
      if ((localObject == null) || (!"-2".equals(((PtvTemplateManager.PtvTemplateInfo)localObject).id))) {
        break;
      }
      localObject = new View(this.jdField_a_of_type_AndroidContentContext);
    ...
    for (;;)
    {
      ((PtvTemplateItemView)localObject).a(paramInt, (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt), this.jdField_a_of_type_Alrz);
      break;
