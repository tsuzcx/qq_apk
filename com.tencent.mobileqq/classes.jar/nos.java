  ...
  implements bbnm
{
  ...
  public nos(QQAppInterface paramQQAppInterface)
  {
  ...
  public ReqItem a(int paramInt)
  {
    ...
    BnrReport.BNRConfigMsg localBNRConfigMsg = nor.a(this.a.getCurrentAccountUin());
    if (localBNRConfigMsg != null) {
      localReqItem.vecParam = bgau.a(localBNRConfigMsg.toByteArray());
    }
    nor.a = true;
    return localReqItem;
  }
  ...
  public void a(RespItem paramRespItem)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        nor.a((BnrReport.BNReportConfigRsp)localBNRConfigMsg.msg_rsp_body.get());
        nor.a(this.a, 74);
        nor.a = false;
        return;
      }
