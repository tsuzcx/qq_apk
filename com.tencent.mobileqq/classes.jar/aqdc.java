...
public class aqdc
{
  private static aqdc jdField_a_of_type_Aqdc;
  private static final byte[] jdField_a_of_type_ArrayOfByte = new byte[0];
  private static final byte[] jdField_b_of_type_ArrayOfByte = new byte[0];
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new aqdd(this);
  private Point jdField_a_of_type_AndroidGraphicsPoint = new Point();
  private Set<String> jdField_a_of_type_JavaUtilSet = new HashSet();
  private WeakReference<aqce> jdField_a_of_type_MqqUtilWeakReference;
  private boolean jdField_a_of_type_Boolean = true;
  private WeakReference<aqfx> jdField_b_of_type_MqqUtilWeakReference;
  private boolean jdField_b_of_type_Boolean = true;
  
  public static aqdc a()
  {
    if (jdField_a_of_type_Aqdc == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Aqdc == null)
      {
        jdField_a_of_type_Aqdc = new aqdc();
        if (QLog.isColorLevel()) {
          QLog.d("ColorNoteQIPCModule", 2, "create ColorNoteQIPCModule");
        }
      }
      return jdField_a_of_type_Aqdc;
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ColorNoteQIPCModule", 2, "[updateColorNoteSet] " + aqda.a());
    }
    if (paramInt2 == 2) {
      return;
    }
  ...
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramaqce);
  }
  
  public void a(aqfx paramaqfx)
  {
    this.jdField_b_of_type_MqqUtilWeakReference = new WeakReference(paramaqfx);
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ColorNoteQIPCModule", 2, "[setSyncState] " + aqda.a());
    }
  }
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ColorNoteQIPCModule", 2, "[setCanAddColorNote] " + aqda.a());
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ColorNoteQIPCModule", 2, "[getCanAddColorNote] " + aqda.a());
    }
