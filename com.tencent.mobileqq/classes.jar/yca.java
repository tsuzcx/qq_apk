...
{
  public yca(QQSpecialFriendSettingActivity paramQQSpecialFriendSettingActivity) {}
  ...
  protected void onSetSpecialCareSwitchesOfAPerson(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    label223:
    for (int i = 2131435269;; i = 2131436884)
    {
      paramArrayOfObject.arg2 = i;
      this.a.a.sendMessage(paramArrayOfObject);
      if ((!paramBoolean) || (j != 0)) {
      ...
      paramArrayOfObject.putExtra("selfSet_leftViewText", this.a.getString(2131437753));
