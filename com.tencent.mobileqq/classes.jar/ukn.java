  ...
  implements View.OnClickListener, OnLongClickAndTouchListener, BubblePopupWindow.OnDismissListener
{
  ...
  private ukn(ChatHistoryAdapterForC2C paramChatHistoryAdapterForC2C) {}
    ...
    for (;;)
    {
      ...
      if (i == 2131375613)
      {
        ...
        if (paramView != null) {
          ...
          QQToast.a(BaseApplicationImpl.getApplication(), 1, BaseApplicationImpl.getApplication().getString(2131439139), 0).b(BaseApplicationImpl.getApplication().getResources().getDimensionPixelSize(2131558448));
        }
      }
    }
  }
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    ((QQCustomMenu)localObject2).a(2131375567, this.jdField_a_of_type_ComTencentMobileqqActivityAioChatHistoryAdapterForC2C.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131433638), 2130838309);
    ...
    if ((i == -2014) || (i == -2005))
    {
      ...
      if ((localObject3 != null) && (((FileManagerEntity)localObject3).status != 16) && (this.d) && (TeamWorkUtils.a(((FileManagerEntity)localObject3).strFilePath, ((FileManagerEntity)localObject3).fileName)))
      {
        ...
        ((QQCustomMenu)localObject2).a(2131375613, this.jdField_a_of_type_ComTencentMobileqqActivityAioChatHistoryAdapterForC2C.jdField_a_of_type_AndroidContentContext.getString(2131439136), 2130838322);
      }
    }
      ...
      do
      {
        ...
        if ((localObject2 instanceof StructingMsgItemBuilder.StructingMsgViewHolder))
        {
          ...
          else
          {
            ...
            ((StructingMsgItemBuilder.StructingMsgViewHolder)localObject4).jdField_a_of_type_AndroidViewView.setBackgroundResource(2130845786);
          }
          for (;;)
          {
            ...
            break label585;
            break;
            ((StructingMsgItemBuilder.StructingMsgViewHolder)localObject4).jdField_a_of_type_AndroidViewView.setBackgroundResource(2130845622);
            continue;
