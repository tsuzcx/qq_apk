...
public class bkvx
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, bkvz parambkvz)
  {
    paramQQAppInterface = a(paramQQAppInterface, paramString, new bkvy(parambkvz, paramString));
    if (!StringUtil.isEmpty(paramQQAppInterface))
    {
      if (parambkvz != null)
      {
        ...
        parambkvz.a(0, new String[] { paramQQAppInterface });
      }
      return;
    }
