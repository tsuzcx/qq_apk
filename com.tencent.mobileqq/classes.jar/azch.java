...
public class azch
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, TextView paramTextView, @NonNull Friends paramFriends, int paramInt)
  {
    ...
    if (paramInt == 2)
    {
      ...
      paramQQAppInterface = aqsl.a(paramTextView.getPaint(), paramFriends, ViewUtils.dip2px(200.0F));
    }
  ...
  public static void a(azfk paramazfk, View paramView)
  {
    ...
    if ((paramView instanceof Integer))
    {
      ...
      if (i == 2)
      {
        paramazfk = paramazfk.c().iterator();
        while (paramazfk.hasNext()) {
          azcl.a("0X800AF40", ((Integer)paramazfk.next()).intValue(), "2");
        }
      }
      if (i == 1)
      {
        paramazfk = paramazfk.c().iterator();
        while (paramazfk.hasNext()) {
          azcl.a("0X800B00F", ((Integer)paramazfk.next()).intValue(), "2");
        }
      }
    }
  }
  ...
  private static void a(Friends paramFriends1, byte[] paramArrayOfByte, @Nullable Friends paramFriends2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("OnlineStatusUtil", 2, new Object[] { "parseExtOnlineBusinessInfo: invoked. ", azeu.a(paramFriends1) });
        }
        return;
      }
  ...
  public static boolean a()
  {
    ...
    return (localarci != null) && (localarci.a != null) && (a(localarci.a.a));
  }
  ...
  public static boolean a(azbu paramazbu)
  {
    if (paramazbu == null) {}
    while ((paramazbu.a != 40001L) || (TextUtils.isEmpty(paramazbu.b)) || (TextUtils.isEmpty(paramazbu.c))) {
      return false;
    }
    return true;
  }
      ...
      for (;;)
      {
        ...
        try
        {
          if (TextUtils.isEmpty(paramFriends)) {
            localObject2 = BaseApplicationImpl.getContext().getString(2131718977);
          }
  ...
  public static boolean b(azbu paramazbu)
  {
    if (paramazbu == null) {}
    while ((paramazbu.a != 40001L) || (TextUtils.isEmpty(paramazbu.b)) || (TextUtils.isEmpty(paramazbu.c)) || (TextUtils.isEmpty(paramazbu.d))) {
      return false;
    }
    return true;
  }
  ...
  {
    String str = azeu.b(paramFriends);
    if (QLog.isColorLevel()) {
