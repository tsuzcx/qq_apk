...
public class amfy
{
  private static amfy jdField_a_of_type_Amfy;
  private static boolean jdField_a_of_type_Boolean;
  private amfn jdField_a_of_type_Amfn = new amfn(this);
  private final LRULinkedHashMap<String, amga> jdField_a_of_type_ComTencentUtilLRULinkedHashMap = new LRULinkedHashMap(128);
  ...
  private amfw a(CustomWebView paramCustomWebView)
  {
  ...
  public static amfy a()
  {
    try
    {
      if (jdField_a_of_type_Amfy == null) {
        jdField_a_of_type_Amfy = new amfy();
      }
      amfy localamfy = jdField_a_of_type_Amfy;
      return localamfy;
    }
    finally {}
  }
  ...
  {
    return jdField_a_of_type_Amfy != null;
  }
  ...
  private String b(String paramString)
  {
    ...
    do
    {
      ...
      str = this.jdField_a_of_type_Amfn.a(paramString);
      localObject = str;
  ...
  public WebResourceResponse a(String paramString1, String paramString2)
  {
    ...
    if ((paramString1.contains("http://cmshow.qq.com/get_thunder_data?cmd=")) || (paramString1.contains("https://cmshow.qq.com/get_thunder_data?cmd=")))
    {
      ...
      if (!this.jdField_a_of_type_Amfn.a(paramString2, paramString1))
      {
        if (QLog.isColorLevel()) {
      ...
      paramString2 = amfn.a(paramString2, paramString1);
      localObject = (amga)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramString2);
      if (localObject != null) {
        if (amga.a((amga)localObject))
        {
          if (((amga)localObject).a(paramString1))
          {
            if (QLog.isColorLevel()) {
              QLog.d("apollo_client_ApolloWebDataHandler", 2, "getApolloCmdResource, webSSOTask.isValid true, webSSOTask=" + localObject);
            }
            if (amga.a((amga)localObject) != null)
            {
              amga.a((amga)localObject).c = System.currentTimeMillis();
              amga.a((amga)localObject).d = System.currentTimeMillis();
            }
            paramString1 = new WebResourceResponse("text/plain", "utf-8", amey.a(amga.a((amga)localObject).toString()));
      ...
      for (;;)
      {
        return new WebResourceResponse("text/plain", "utf-8", new amgc(null, null, null));
        if (QLog.isColorLevel()) {
  ...
  {
    if (this.jdField_a_of_type_Amfn != null) {
      return this.jdField_a_of_type_Amfn.a(paramString);
    }
    return null;
  }
  
  public void a(Context paramContext, String paramString1, String paramString2, AppInterface paramAppInterface, amgb paramamgb)
  {
    if ((TextUtils.isEmpty(paramString1)) || (this.jdField_a_of_type_Amfn == null)) {}
    for (;;)
    {
      return;
      ...
      {
        this.jdField_a_of_type_Amfn.a(paramAppInterface);
        Object localObject1 = this.jdField_a_of_type_Amfn.a(paramString1);
        ...
        else
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            String str = amfn.a(paramString1, (String)localObject2);
            amga localamga = (amga)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(str);
            if ((localamga != null) && (localamga.a((String)localObject2)))
            {
              if (QLog.isColorLevel()) {
                QLog.d("apollo_client_ApolloWebDataHandler", 2, "preloadSSOCmd, apolloClientId:" + paramString1 + " mPreloadSSOCmds.has WebSSOTask:" + localamga);
              }
            }
            else
            {
              this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.remove(str);
              localamga = new amga(paramamgb, str, (String)localObject2);
              this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.put(str, localamga);
              localObject2 = this.jdField_a_of_type_Amfn.a(paramString2, paramString1, (String)localObject2, paramAppInterface);
              if (QLog.isColorLevel()) {
              ...
              if (localObject2 != null) {
                localamga.a(paramContext, paramString2, (JSONObject)localObject2, paramAppInterface);
              }
            }
          }
        }
  ...
  public boolean a(String paramString)
  {
    ...
    } while (this.jdField_a_of_type_Amfn == null);
    return this.jdField_a_of_type_Amfn.a(paramString);
  }
  ...
  public boolean a(String paramString1, String paramString2, AppInterface paramAppInterface, WebViewPlugin paramWebViewPlugin)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        amfw localamfw = a(paramWebViewPlugin.mRuntime.a());
        if (localamfw == null)
        {
          if (!QLog.isColorLevel()) {
            break label737;
        ...
        if (!this.jdField_a_of_type_Amfn.a(str3, str2))
        {
          if (!QLog.isColorLevel()) {
            break label739;
          }
        ...
        str3 = amfn.a(str3, str2);
        paramString2 = (amga)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(str3);
        if (paramString2 != null)
        {
          if (amga.a(paramString2))
          {
            if (paramString2.a(str2))
            {
              ...
              if (amga.a(paramString2) != null)
              {
                amga.a(paramString2).c = System.currentTimeMillis();
                amga.a(paramString2).d = System.currentTimeMillis();
              }
              paramWebViewPlugin.callJs(str1, new String[] { amga.a(paramString2).toString() });
            ...
            if (localamfw != null)
            {
              paramString2 = localamfw.a();
              paramString2.c = System.currentTimeMillis();
              paramString2 = new amga(paramString2, str3, str2);
              paramString2.a(new amfz(this, str1, paramWebViewPlugin));
  ...
  public boolean b(String paramString1, String paramString2)
  {
    ...
    amey.a(amey.d(amey.e(str)), paramString2);
    if (QLog.isColorLevel()) {
