...
public class antn
  implements afal, Handler.Callback, antj
{
  ...
  private beld jdField_a_of_type_Beld = new anto(this);
  ...
  public antn(BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, new bhwv());
  ...
  {
    float f1 = 0.0F;
    float f2 = (Math.abs(paramFloat) - (BaseChatItemLayout.U + BaseChatItemLayout.V)) / aekt.a(20.0F, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources());
    if (f2 < 0.0F) {}
    for (;;)
    {
  ...
  private int a()
  {
    return aekt.a(59.0F, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources());
  }
  ...
  private int a(ChatMessage paramChatMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        paramChatMessage = new baig(((MessageForText)paramChatMessage).sb, 8);
        if ((paramChatMessage.a != null) && (paramChatMessage.a.length > 0))
        {
          ...
          while (i < j)
          {
            if ((paramChatMessage[i] instanceof baio)) {
              return 7;
            }
            i += 1;
          }
  ...
  private void a(float paramFloat1, float paramFloat2)
  {
    ...
    if ((f1 > this.jdField_a_of_type_Int) || (paramFloat2 > this.jdField_a_of_type_Int))
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getAdapter() instanceof bhtf))
      {
        ListAdapter localListAdapter = ((bhtf)this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getAdapter()).getWrappedAdapter();
        if ((localListAdapter instanceof aelz)) {
          ((aelz)localListAdapter).d();
        }
      }
  ...
  private void a(MotionEvent paramMotionEvent)
  {
    ...
    if (((localView instanceof BaseChatItemLayout)) && (a(((BaseChatItemLayout)localView).findViewById(2131364171), paramMotionEvent)))
    {
      this.jdField_a_of_type_AndroidViewView = localView;
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131364194);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(View paramView, int paramInt)
  {
    ...
    if (!this.jdField_d_of_type_Boolean) {
      if (paramInt >= i)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new antp(this));
  ...
  private void b()
  {
    if (!b())
    {
      ...
      if (localObject != null)
      {
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A92F", "0X800A92F", a((ChatMessage)localObject), b((ChatMessage)localObject), "", "", "", "");
        ...
        if ((localObject instanceof MessageForStructing))
        {
          ...
          if ((((MessageForStructing)localObject).structingMsg != null) && (((MessageForStructing)localObject).structingMsg.mMsgServiceID == 81) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)) {
            wta.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, (MessageForStructing)localObject, "reply");
          }
        }
      }
    }
  ...
  private void b(int paramInt)
  {
    ...
    if (paramInt >= a())
    {
      ...
      {
        bool = bcys.b(BaseApplicationImpl.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  private boolean b()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) && (((bcjl)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true).jdField_a_of_type_Boolean))
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131697832, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298914));
      return true;
    }
    return false;
  }
  ...
  private int c()
  {
    return aekt.a(89.0F, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources());
  }
  ...
  private boolean c()
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Antq != null) && (antq.a(this.jdField_a_of_type_Antq, localChatMessage))) {
        return antq.b(this.jdField_a_of_type_Antq, localChatMessage);
      }
  ...
  private boolean c(MotionEvent paramMotionEvent)
  {
    ...
    if (k < this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getWidth() - BaseChatItemLayout.i - aekt.a(5.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext.getResources()) - BaseChatItemLayout.Q) {}
    for (int i = 1; i != 0; i = 0)
    {
      i = j;
      ...
      boolean bool = a(((BaseChatItemLayout)localView).findViewById(2131364171), paramMotionEvent);
      if (QLog.isColorLevel()) {
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      if (((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agld)) || ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof TroopChatPie)) || ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agkt))) {
        bool = true;
      }
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        this.jdField_a_of_type_Antq = new antq(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null);
      }
  ...
  public void a(View paramView)
  {
    ...
    {
      paramView = (aelt)paramView.getTag();
