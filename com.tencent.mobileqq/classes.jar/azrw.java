  ...
  extends azqj
{
  ...
  public azrw(String paramString)
  {
    this(paramString, "tag");
  }
  
  public azrw(String paramString1, String paramString2)
  {
    this.a = paramString2;
    this.X = paramString1;
  }
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      paramBundle = (URLImageView)paramView.findViewById(2131368113);
      paramContext = (TextView)paramView.findViewById(2131378967);
    }
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject = new ColorDrawable(2131167138);
        ...
        catch (Exception paramBundle)
        {
          try
          {
            for (;;)
            {
              ...
              paramView.setMinimumHeight(aekt.a(14.0F, (Resources)localObject));
              paramView.setLayoutParams(new LinearLayout.LayoutParams(-2, -1));
              paramView.setGravity(16);
              paramView.setPadding(aekt.a(5.0F, (Resources)localObject), aekt.a(2.0F, (Resources)localObject), aekt.a(5.0F, (Resources)localObject), aekt.a(2.0F, (Resources)localObject));
              paramBundle = new URLImageView(paramContext);
              paramBundle.setScaleType(ImageView.ScaleType.CENTER_CROP);
              LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(aekt.a(9.0F, (Resources)localObject), aekt.a(9.0F, (Resources)localObject));
              paramBundle.setId(2131368113);
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    this.W = ayvy.a(paramObjectInput.readUTF(), false);
  ...
  public boolean a(azsa paramazsa)
  {
    ...
    {
      return true;
      this.U = paramazsa.a("color");
      this.V = paramazsa.a("style");
      this.W = paramazsa.a("size");
      this.X = ayvy.a(azqu.a(paramazsa), false);
      this.S = paramazsa.a("bgColor");
      this.T = paramazsa.a("icon");
      paramazsa = paramazsa.a("radius");
      try
      {
        this.l = Integer.valueOf(paramazsa).intValue();
        return true;
      }
      catch (NumberFormatException paramazsa) {}
    } while (!QLog.isColorLevel());
    QLog.e("Q..troop.faceScore.StructMsgItemTag", 2, "StructMsgItemTag fromXml radius is not a integer value.", paramazsa);
    return true;
  }
