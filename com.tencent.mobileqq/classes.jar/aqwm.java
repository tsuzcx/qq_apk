...
public class aqwm
  implements aqwv<BubbleRecommendRsp>
{
  public int a()
  {
    return 4;
  ...
  {
    return bbpp.a(paramContext, "bubble", "mvip.gongneng.android.bubble.index_dynamic_tab");
  }
  
  public String a(FontBubble paramFontBubble)
  {
    return bbpp.a("bubblePreview").replace("[id]", Integer.toString(paramFontBubble.bubbleId));
  }
  
  public List<FontBubble> a(QQAppInterface paramQQAppInterface, BubbleRecommendRsp paramBubbleRecommendRsp)
  {
    int j = 0;
    paramQQAppInterface = ((ajxn)paramQQAppInterface.getManager(51)).a(paramQQAppInterface.getAccount());
    int i;
