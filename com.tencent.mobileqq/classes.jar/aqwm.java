  ...
  implements IHttpCommunicatorListener
{
  ...
  public aqwm(Context paramContext, String paramString)
  {
  ...
  public static ResourcePluginInfo a(EntityManager paramEntityManager, boolean paramBoolean, GetResourceRespInfoV2 paramGetResourceRespInfoV2)
  {
    ...
    if (paramBoolean)
    {
      ...
      localObject = aqwo.a(paramGetResourceRespInfoV2.strResConf);
      if (localObject == null) {
        break label413;
      }
  ...
  private void a(arpo paramarpo, DataInputStream paramDataInputStream)
  {
    paramarpo.a(paramDataInputStream);
  }
  ...
  public void a()
  {
    ...
    //   7: istore_2
    //   8: aload_0
    //   9: getfield 110	aqwm:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   12: ifnull +392 -> 404
    //   15: aload_0
    //   16: getfield 110	aqwm:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   19: invokevirtual 85	java/io/File:exists	()Z
    //   22: ifeq +382 -> 404
    //   25: aload_0
    //   26: getfield 110	aqwm:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   29: invokevirtual 309	java/io/File:canRead	()Z
    //   32: ifeq +372 -> 404
    //   35: aload_0
    //   36: getfield 110	aqwm:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   50: dup
    //   51: aload_0
    //   52: getfield 110	aqwm:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    ...
    //   105: istore_1
    //   106: iload_1
    //   107: getstatic 334	aqwk:a	[Larpo;
    //   110: arraylength
    //   111: if_icmpge +70 -> 181
    //   114: getstatic 334	aqwk:a	[Larpo;
    //   117: iload_1
    //   118: aaload
    //   119: astore 5
    //   121: aload_0
    //   122: aload 5
    //   124: aload 6
    //   126: invokespecial 336	aqwm:a	(Larpo;Ljava/io/DataInputStream;)V
    //   129: aload 5
    //   131: getfield 338	arpo:a	B
    //   134: iconst_1
    //   135: if_icmpeq +11 -> 146
    //   138: aload 5
    //   140: getfield 338	arpo:a	B
    //   143: ifne +16 -> 159
    //   146: aload 5
    //   148: invokevirtual 340	arpo:a	()Z
    //   151: ifeq +8 -> 159
    //   154: aload 5
    //   156: invokevirtual 342	arpo:a	()V
    //   159: iload_1
    //   160: iconst_1
    //   161: iadd
    //   162: istore_1
    ...
    //   220: istore_1
    //   221: iload_1
    //   222: getstatic 334	aqwk:a	[Larpo;
    //   225: arraylength
    //   226: if_icmpge +141 -> 367
    //   229: getstatic 334	aqwk:a	[Larpo;
    //   232: iload_1
    //   233: aaload
    //   234: invokevirtual 342	arpo:a	()V
    //   237: iload_1
    //   238: iconst_1
    //   239: iadd
    //   240: istore_1
  ...
  public void a(arpo paramarpo, DataOutputStream paramDataOutputStream)
  {
    paramarpo.a(paramDataOutputStream);
  }
  
  public boolean a()
  {
    boolean bool = true;
    switch (this.jdField_a_of_type_Aqwn.a)
    {
    default: 
      bool = false;
    }
  ...
  public void c()
  {
    ...
    //   9: dup
    //   10: aload_0
    //   11: getfield 92	aqwm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   14: invokespecial 81	java/io/File:<init>	(Ljava/lang/String;)V
    //   17: putfield 110	aqwm:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   20: aload_0
    //   21: getfield 110	aqwm:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   24: invokevirtual 85	java/io/File:exists	()Z
    //   27: ifne +11 -> 38
    //   30: aload_0
    //   31: getfield 110	aqwm:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   34: invokevirtual 113	java/io/File:createNewFile	()Z
    //   37: pop
    //   38: aload_0
    //   39: getfield 110	aqwm:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   42: ifnull +92 -> 134
    //   45: aload_0
    //   46: getfield 110	aqwm:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   49: invokevirtual 85	java/io/File:exists	()Z
    //   52: ifeq +82 -> 134
    //   55: new 358	java/io/BufferedOutputStream
    //   58: dup
    //   59: new 360	java/io/FileOutputStream
    //   62: dup
    //   63: aload_0
    //   64: getfield 110	aqwm:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   67: invokespecial 361	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   70: invokespecial 364	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   73: astore_2
    //   74: new 366	java/io/DataOutputStream
    //   77: dup
    //   78: aload_2
    //   79: invokespecial 367	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   82: astore_3
    //   83: iconst_0
    //   84: istore_1
    //   85: iload_1
    //   86: getstatic 334	aqwk:a	[Larpo;
    //   89: arraylength
    //   90: if_icmpge +28 -> 118
    //   93: aload_0
    //   94: getstatic 334	aqwk:a	[Larpo;
    //   97: iload_1
    //   98: aaload
    //   99: aload_3
    //   100: invokevirtual 369	aqwm:a	(Larpo;Ljava/io/DataOutputStream;)V
    //   103: iload_1
    //   104: iconst_1
    //   105: iadd
    //   106: istore_1
    ...
    //   119: ifnull +7 -> 126
    //   122: aload_2
    //   123: invokevirtual 370	java/io/BufferedOutputStream:close	()V
    //   126: aload_3
    //   127: ifnull +7 -> 134
    //   130: aload_3
    //   131: invokevirtual 371	java/io/DataOutputStream:close	()V
    //   134: return
    //   135: astore_2
    //   136: aconst_null
    //   137: astore_2
    ...
    //   139: ifnull +7 -> 146
    //   142: aload_3
    //   143: invokevirtual 370	java/io/BufferedOutputStream:close	()V
    //   146: aload_2
    //   147: ifnull +7 -> 154
    //   150: aload_2
    //   151: invokevirtual 371	java/io/DataOutputStream:close	()V
    //   154: aload_0
    //   155: getfield 110	aqwm:jdField_a_of_type_JavaIoFile	Ljava/io/File;
    //   158: invokevirtual 355	java/io/File:delete	()Z
    //   161: pop
    //   162: return
    //   163: astore_3
    //   164: aconst_null
    ...
    //   167: ifnull +7 -> 174
    //   170: aload_2
    //   171: invokevirtual 370	java/io/BufferedOutputStream:close	()V
    //   174: aload 4
    //   176: ifnull +8 -> 184
    //   179: aload 4
    //   181: invokevirtual 371	java/io/DataOutputStream:close	()V
    //   184: aload_3
    //   185: athrow
    //   186: astore_2
    //   187: goto -61 -> 126
  ...
  public void d()
  {
    ...
    Object localObject = aqwk.a();
    if (localObject != null)
    {
      localObject = ((ArrayList)localObject).iterator();
      while (((Iterator)localObject).hasNext()) {
        ((aqwl)((Iterator)localObject).next()).a();
      }
    }
  }
  ...
  public void decode(HttpMsg arg1, HttpMsg paramHttpMsg2)
  {
    ...
    try
    {
      synchronized (this.jdField_a_of_type_ArrayOfInt)
      {
        ...
        aqwo.a(paramHttpMsg2, new aqwp(), this.b);
        a();
        d();
        return;
      }
