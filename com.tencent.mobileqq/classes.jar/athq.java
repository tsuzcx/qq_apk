...
public class athq
  implements aupa
{
  public athq(FilePreviewActivity paramFilePreviewActivity) {}
  ...
  public void openFile(String paramString1, String paramString2, long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        bhlq.a(this.a, 233, this.a.getString(2131717565), "是否下载文件:\n" + paramString1 + "(" + auog.a(paramLong) + ")", new athr(this, paramString2, (aure)localObject2, (Bundle)localObject3), new aths(this)).show();
        return;
      ...
      localObject1 = localObject2;
    } while (!auog.b(((FileManagerEntity)localObject3).getFilePath()));
    paramString1 = new auni();
    paramString1.jdField_b_of_type_JavaLangString = "file_viewer_in";
    paramString1.jdField_a_of_type_Int = 73;
    paramString1.c = auog.a(((FileManagerEntity)localObject3).fileName);
    paramString1.jdField_a_of_type_Long = ((FileManagerEntity)localObject3).fileSize;
    aunh.a(this.a.app.getCurrentAccountUin(), paramString1);
    aunh.a("0X8004AE4");
