  ...
  extends bark
{
  ...
  public bavb(bard parambard, bayk parambayk)
  {
    ...
    this.jdField_a_of_type_Bass.jdField_a_of_type_JavaLangString = parambayk.a();
  }
  
  private boolean a()
  {
    if (QLog.isColorLevel()) {
      QLog.i("NearbyPeoplePhotoUploadProcessor", 2, "personality_label start uniseq:" + this.jdField_a_of_type_Bayk.jdField_a_of_type_Long + " src:" + this.jdField_a_of_type_Bayk.i);
    }
    Object localObject = new CompressInfo(this.jdField_a_of_type_Bayk.i, 0);
    ...
    do
    {
      ...
      bayk localbayk = this.jdField_a_of_type_Bayk;
      localObject = ((CompressInfo)localObject).e;
      localbayk.i = ((String)localObject);
      localbass.jdField_c_of_type_JavaLangString = ((String)localObject);
    } while (c() != 0);
    return false;
  }
  ...
  {
    if (paramLong1 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 1, this.jdField_a_of_type_Bass.b, this.jdField_a_of_type_Bayk.jdField_a_of_type_Int, paramLong1);
    }
    if (paramLong2 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 1, this.jdField_a_of_type_Bass.b, this.jdField_a_of_type_Bayk.jdField_a_of_type_Int, paramLong2);
    }
    if (paramLong3 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 0, this.jdField_a_of_type_Bass.b, this.jdField_a_of_type_Bayk.jdField_a_of_type_Int, paramLong3);
    }
    if (paramLong4 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 0, this.jdField_a_of_type_Bass.b, this.jdField_a_of_type_Bayk.jdField_a_of_type_Int, paramLong4);
    }
  }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.m = (i | j);
      str1 = "";
      if ((this.jdField_a_of_type_Bass.b != 8) && (this.jdField_a_of_type_Bass.b != 64)) {
        break label185;
      }
      ...
      azri.a(BaseApplication.getContext()).a(null, str1, true, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    for (;;)
    {
      l();
      ...
      break;
      label185:
      if (this.jdField_a_of_type_Bass.b == 21)
      {
        str1 = "actFreshNewsPicUpload";
        break label98;
      }
      if (this.jdField_a_of_type_Bass.b == 22)
      {
        str1 = "actFriendAvatarUpload";
        break label98;
      }
      if (this.jdField_a_of_type_Bass.b == 34)
      {
        str1 = "C2BUploadFile";
        break label98;
      }
      if (this.jdField_a_of_type_Bass.b == 35)
      {
        str1 = "actProfileCoverPicUpload";
        break label98;
      }
      if ((this.jdField_a_of_type_Bass.b == 36) || (this.jdField_a_of_type_Bass.b == 37) || (this.jdField_a_of_type_Bass.b == 38) || (this.jdField_a_of_type_Bass.b == 48))
      {
        str1 = "actBaseDynamicAvatarUpload";
        break label98;
      }
      if ((this.jdField_a_of_type_Bass.b == 39) || (this.jdField_a_of_type_Bass.b == 40) || (this.jdField_a_of_type_Bass.b == 41))
      {
        str1 = "actNearbyDynamicAvatarUpload";
        break label98;
      }
      if ((this.jdField_a_of_type_Bass.b == 50) || (this.jdField_a_of_type_Bass.b == 51))
      {
        str1 = "actHongbaoStarPhotoUpload";
        break label98;
      }
      if (this.jdField_a_of_type_Bass.b == 56)
      {
        str1 = "actPersonalityLabelPhotoUpload";
        break label98;
      }
      if (this.jdField_a_of_type_Bass.b != 23) {
        break label98;
      }
      str1 = "actExtendFriendSoundUpload";
      break label98;
      label430:
      str2 = bdqa.a(this.jdField_b_of_type_ArrayOfByte);
      break label136;
      label442:
      ...
      azri.a(BaseApplication.getContext()).a(null, str1, false, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
  ...
  public void aN_()
  {
    ...
    bavc localbavc = new bavc(this, SystemClock.uptimeMillis());
    if ((this.jdField_a_of_type_Bass.b == 8) || (this.jdField_a_of_type_Bass.b == 64)) {
      i = 3;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), i, this.jdField_a_of_type_Bayk.i, (int)this.r, this.jdField_a_of_type_ArrayOfByte, localbavc, this.jdField_a_of_type_Bass.jdField_a_of_type_ArrayOfByte, false);
        ...
        if (QLog.isColorLevel()) {
          QLog.i("NearbyPeoplePhotoUploadProcessor", 2, "<BDH_LOG> Transaction submit RetCode:" + j + " T_ID:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.getTransationId() + " UniSeq:" + this.jdField_a_of_type_Bayk.jdField_a_of_type_Long + " MD5:" + this.jdField_c_of_type_JavaLangString + " uuid:" + this.jdField_l_of_type_JavaLangString + " Path:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.filePath + " Cmd:" + i);
        }
        if (j != 0)
        {
      ...
      if (this.jdField_a_of_type_Bass.b == 21) {
        i = 6;
      } else if (this.jdField_a_of_type_Bass.b == 22) {
        i = 5;
      } else if (this.jdField_a_of_type_Bass.b == 34) {
        i = 13;
      } else if (this.jdField_a_of_type_Bass.b != 35) {
        if ((this.jdField_a_of_type_Bass.b == 36) || (this.jdField_a_of_type_Bass.b == 37) || (this.jdField_a_of_type_Bass.b == 38))
        {
          i = 23;
        }
        else if ((this.jdField_a_of_type_Bass.b == 39) || (this.jdField_a_of_type_Bass.b == 40) || (this.jdField_a_of_type_Bass.b == 41))
        {
          i = 22;
        }
        else if (this.jdField_a_of_type_Bass.b == 48)
        {
          i = 24;
        }
        else if (this.jdField_a_of_type_Bass.b == 23)
        {
          i = 59;
          ...
          this.jdField_a_of_type_Bass.jdField_a_of_type_ArrayOfByte = localCommFileExtReq.toByteArray();
        }
        else if ((this.jdField_a_of_type_Bass.b == 50) || (this.jdField_a_of_type_Bass.b == 51))
        {
          i = 35;
        }
        else if (this.jdField_a_of_type_Bass.b == 56)
        {
          i = 39;
        }
        else
  ...
  public void aP_()
  {
    ...
    if ((this.jdField_a_of_type_Bass.b == 56) && (a())) {
      return;
    }
