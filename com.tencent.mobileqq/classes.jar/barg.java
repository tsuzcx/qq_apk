...
public abstract class barg
{
  int jdField_a_of_type_Int;
  bard jdField_a_of_type_Bard;
  ...
  public barg(bard parambard, int paramInt)
  {
    this.jdField_a_of_type_ComTencentMobileqqHighwayApiITransactionCallback = new barh(this);
