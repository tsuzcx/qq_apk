...
public class bcwr
{
  ...
  static boolean a(AppInterface paramAppInterface, ShortVideoResourceManager.SVConfigItem paramSVConfigItem)
  {
    ...
    {
      return true;
      QmcfManager.getInstance().setQmcfMobileNotSupport(bdcx.a);
      return false;
  ...
  static boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    if (localFile.exists())
    {
      if ((a().equals(paramString1)) && (bcwi.a(paramQQAppInterface, "artfilter_config_file")))
      {
    ...
    try
    {
      ...
      bool1 = bcwi.a(paramQQAppInterface, "artfilter_config_file");
