  ...
  extends akbr
{
  ...
  public akcc a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new akci(this);
  ...
  private List<akcy> jdField_b_of_type_JavaUtilList = new ArrayList();
  ...
  public akce(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new akcf(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131368378)).setOnClickListener(new akcg(this));
    Button localButton = (Button)findViewById(2131363845);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new akch(this));
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Akcc = new akcc(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Bkyc, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Akcc);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new akcj(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new akck(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new akcl(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemLongClickListener(new akcm(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Akcc.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    if ((this.jdField_b_of_type_Boolean) && (AppNetConnInfo.isNetSupport()))
    {
      ...
      a(5, null);
      b(1);
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FCB", "0X8005FCB", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FCA", "0X8005FCA", 0, 0, "", "", "", "");
      return;
      this.jdField_b_of_type_Int = 0;
      this.jdField_a_of_type_Akcc.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
      if (this.jdField_b_of_type_Boolean) {
        a(3, this.jdField_a_of_type_AndroidContentContext.getString(2131718386));
      } else {
        a(0, null);
      }
    }
  ...
  public void b(int paramInt)
  {
    ...
    localArrayList.add(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin);
    ...
    Object localObject2 = (anzc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MESSAGE_ROAM_MANAGER);
    Object localObject1 = ((anzc)localObject2).c();
    long l2;
    int j;
    int k;
    ...
    {
      l2 = ((Long)((anzc)localObject2).a((Calendar)localObject1).second).longValue();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(anvx.a(2131700784));
      ...
      {
        this.jdField_a_of_type_Akcc.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_d_of_type_Boolean, 0);
        this.jdField_a_of_type_Akcc.notifyDataSetChanged();
      }
      if (this.jdField_a_of_type_Akcc.getCount() == 0) {
        a(4, null);
      }
      for (;;)
      {
      ...
      if ((l == this.jdField_a_of_type_Long) && (this.jdField_a_of_type_JavaLangString.equals(localObject1)))
      {
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_Akcc.a(this.jdField_a_of_type_JavaUtilList, 4, this.jdField_d_of_type_Boolean, 0);
          this.jdField_a_of_type_Akcc.notifyDataSetChanged();
        }
        ...
        if ((this.jdField_a_of_type_Long == l) && (this.jdField_a_of_type_JavaLangString.equals(localObject1)))
        {
          ...
          {
            localObject1 = new akcy(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)paramMessage.get(i));
            this.jdField_a_of_type_JavaUtilList.add(localObject1);
            this.jdField_a_of_type_JavaUtilSet.add(Long.valueOf(((akcy)localObject1).a.shmsgseq));
            i += 1;
          }
          ...
          this.jdField_a_of_type_Akcc.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long);
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FC2", "0X8005FC2", 0, 0, "", "", "", "");
          continue;
          label1637:
          if (QLog.isColorLevel()) {
          ...
          if (this.e) {
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FCC", "0X8005FCC", 0, (int)(System.currentTimeMillis() - this.jdField_a_of_type_Long), "", "", "", "");
          }
          this.jdField_a_of_type_Akcc.a(this.jdField_a_of_type_JavaUtilList, 4, this.jdField_d_of_type_Boolean, 1);
          this.jdField_a_of_type_Akcc.notifyDataSetChanged();
          this.jdField_a_of_type_JavaUtilList.clear();
          continue;
          paramMessage = (HashMap)paramMessage.obj;
          ...
          if ((l == this.jdField_a_of_type_Long) && (this.jdField_a_of_type_JavaLangString.equals(localObject1)))
          {
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005FC6", "0X8005FC6", 0, (int)(System.currentTimeMillis() - this.jdField_a_of_type_Long), "", "", "", "");
            this.jdField_c_of_type_Boolean = false;
            this.jdField_b_of_type_AndroidViewView.setVisibility(8);
            this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
            this.jdField_a_of_type_Akcc.a(this.jdField_a_of_type_JavaUtilList, this.jdField_d_of_type_Boolean);
            if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_Akcc.getCount() < 20))
            {
              this.jdField_c_of_type_AndroidWidgetTextView.setText(anvx.a(2131700786));
              this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131373220).setVisibility(8);
              this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
              this.jdField_b_of_type_AndroidViewView.setVisibility(0);
            }
            ...
            if ((l == this.jdField_a_of_type_Long) && (this.jdField_a_of_type_JavaLangString.equals(paramMessage)))
            {
              ...
              this.jdField_b_of_type_AndroidViewView.setVisibility(8);
              this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
              this.jdField_a_of_type_Akcc.a((List)localObject1, this.jdField_d_of_type_Boolean);
              this.jdField_a_of_type_Akcc.notifyDataSetChanged();
              this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Akcc);
              this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
              this.jdField_a_of_type_JavaUtilList.clear();
