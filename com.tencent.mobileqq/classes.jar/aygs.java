  ...
  implements aygm
{
  ...
  public aygs(Context paramContext)
  {
  ...
  {
    this.jdField_a_of_type_Aygn = paramaygn;
  }
  
  public void a(aygo paramaygo)
  {
    this.jdField_a_of_type_Aygo = paramaygo;
  }
  
  public void a(aygp paramaygp)
  {
    this.jdField_a_of_type_Aygp = paramaygp;
  }
  
  public void a(aygq paramaygq)
  {
    this.jdField_a_of_type_Aygq = paramaygq;
  }
  
  public void a(aygr paramaygr)
  {
    this.jdField_a_of_type_Aygr = paramaygr;
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong)
  {
    ...
    do
    {
      ...
      String str = wkq.a(paramString1, 0);
      this.b = paramString2;
      this.c = paramString3;
      ...
      if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null)
      {
        ...
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnCompletionListener(new aygt(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnErrorListener(new aygu(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnInfoListener(new aygv(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoPreparedListener(new aygw(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnDownloadCallback(new aygx(this, paramString2, paramString1, paramString3));
      }
      paramString1 = a(str, paramString2, paramLong);
      paramString1.setConfigMap("keep_last_frame", "true");
      if ((!TextUtils.isEmpty(paramString2)) && (wkr.a(new File(paramString2))))
      {
    ...
    {
      Bosses.get().postJob(new aygy(this, "VideoViewTVKImpl", paramString3, paramString1));
      return;
    }
