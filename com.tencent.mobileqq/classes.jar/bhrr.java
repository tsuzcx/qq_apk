  ...
  extends bhgj
{
  ...
  public bhrr(DeviceFriendListOpenFrame paramDeviceFriendListOpenFrame)
  {
  ...
  protected void a()
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame.jdField_a_of_type_Bhvo.a();
    bhzm.c(DeviceFriendListOpenFrame.jdField_a_of_type_JavaLangString, "-->start constructHashStruct()");
    ...
    bhzm.c(DeviceFriendListOpenFrame.jdField_a_of_type_JavaLangString, "-->end constructHashStruct()");
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562780, paramViewGroup, false);
      paramView = new bhrs();
      paramView.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localView.findViewById(2131376577));
      paramView.c = ((TextView)localView.findViewById(2131379673));
      ...
      paramView.d = ((TextView)localView.findViewById(2131371615));
      ...
      if (!this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame.jdField_a_of_type_Bhvo.a(((Friend)localObject).jdField_a_of_type_JavaLangString)) {
        break label416;
      }
      ...
      if ((((Friend)localObject).d == null) || ("".equals(((Friend)localObject).d))) {
        ((Friend)localObject).d = bhvv.a(this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a(), ((Friend)localObject).jdField_a_of_type_JavaLangString);
      }
      ...
      localBitmap = bhvs.a().a(((Friend)localObject).d);
      if (localBitmap != null) {
        break label438;
      }
      paramView.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840312);
      bhvs.a().a(((Friend)localObject).d, this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame);
      label347:
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (bhrs)paramView.getTag();
      localView = paramView;
