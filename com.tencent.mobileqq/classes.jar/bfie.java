  ...
  extends bfgj
{
  ...
  public bfie(BaseActivity paramBaseActivity, Bundle paramBundle)
  {
  ...
  protected void a(String paramString)
  {
    ...
    try
    {
      ...
      paramString = new NewIntent(this.jdField_a_of_type_AndroidContentContext, nkl.class);
      ...
      paramString.setObserver(new bfif(this));
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppRuntime().startServlet(paramString);
      return;
    }
    catch (Exception paramString)
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, 2131695614, 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
  ...
  public void dismiss()
  {
    ...
    {
      bgqv.a("two_comment", "un", this.d, str, "", "");
