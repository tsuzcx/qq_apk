  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        break label552;
        ChatActivityUtils.a(this.jdField_a_of_type_AndroidContentContext, 2131434811, 1);
        break label552;
        label878:
        i = 100;
        break label641;
