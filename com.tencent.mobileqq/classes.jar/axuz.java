...
public class axuz
{
  private static final SparseArray<Class<? extends axuq>> jdField_a_of_type_AndroidUtilSparseArray;
  private static HashMap<String, Class<? extends axup>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  
  static
  {
    jdField_a_of_type_JavaUtilHashMap.put("pavideo", axzd.class);
    jdField_a_of_type_JavaUtilHashMap.put("video", axzs.class);
    jdField_a_of_type_JavaUtilHashMap.put("picture", axws.class);
    jdField_a_of_type_JavaUtilHashMap.put("title", StructMsgItemTitle.class);
    jdField_a_of_type_JavaUtilHashMap.put("summary", axzj.class);
    jdField_a_of_type_JavaUtilHashMap.put("timer", axzn.class);
    jdField_a_of_type_JavaUtilHashMap.put("hr", axwu.class);
    jdField_a_of_type_JavaUtilHashMap.put("image", axwv.class);
    jdField_a_of_type_JavaUtilHashMap.put("more", axyx.class);
    jdField_a_of_type_JavaUtilHashMap.put("progress", axzh.class);
    jdField_a_of_type_JavaUtilHashMap.put("checklist", ayab.class);
    jdField_a_of_type_JavaUtilHashMap.put("vote", ayad.class);
    jdField_a_of_type_JavaUtilHashMap.put("price", axzg.class);
    jdField_a_of_type_JavaUtilHashMap.put("button", axwm.class);
    jdField_a_of_type_JavaUtilHashMap.put("remark", axzi.class);
    jdField_a_of_type_JavaUtilHashMap.put("paaudio", axyy.class);
    jdField_a_of_type_JavaUtilHashMap.put("textButton", axzl.class);
    jdField_a_of_type_JavaUtilHashMap.put("content", axwr.class);
    jdField_a_of_type_JavaUtilHashMap.put("tips", axwe.class);
    jdField_a_of_type_JavaUtilHashMap.put("live", axvy.class);
    jdField_a_of_type_JavaUtilHashMap.put("tr", axzq.class);
    jdField_a_of_type_JavaUtilHashMap.put("td", axzk.class);
    jdField_a_of_type_JavaUtilHashMap.put("head", axwl.class);
    jdField_a_of_type_JavaUtilHashMap.put("type", axzr.class);
    jdField_a_of_type_JavaUtilHashMap.put("tag", axwc.class);
    jdField_a_of_type_JavaUtilHashMap.put("taglist", axwd.class);
    jdField_a_of_type_JavaUtilHashMap.put("group", axvs.class);
    jdField_a_of_type_JavaUtilHashMap.put("groupitem", axvu.class);
    jdField_a_of_type_JavaUtilHashMap.put("voice", axwf.class);
    jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
    jdField_a_of_type_AndroidUtilSparseArray.append(0, axyo.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(1, axww.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(2, axxi.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(3, axyc.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(4, axyf.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(5, axyg.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(6, axyi.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(7, axyk.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(8, axym.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(9, axyn.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(10, axwx.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(11, axwz.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(12, axxb.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(18, axxf.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(19, axxh.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(20, axxj.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(21, axxm.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(22, axxn.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(23, axxo.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(24, axxq.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(25, axxt.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(26, axxu.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(27, axxv.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(28, axxw.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(29, axxz.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(30, axyd.class);
  }
  
  public static axup a(String paramString)
  {
    return a(paramString, 0);
  }
  
  /* Error */
  public static axup a(String paramString, int paramInt)
  {
    // Byte code:
    //   0: ldc 210
    //   2: aload_0
    ...
    //   6: ifne +72 -> 78
    //   9: getstatic 18	axuz:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   12: aload_0
    ...
    //   76: aload_3
    //   77: areturn
    //   78: getstatic 143	axuz:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   81: iload_1
  ...
  /* Error */
  public static axuq a(int paramInt)
  {
    // Byte code:
    //   0: getstatic 143	axuz:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   3: iload_0
