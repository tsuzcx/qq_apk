  ...
  implements txi
{
  ...
  final txi jdField_a_of_type_Txi;
  int b = -1;
  int c = -1;
  
  public twq(txi paramtxi)
  {
    this.jdField_a_of_type_Txi = paramtxi;
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_Txi.a(this.b, this.c);
      continue;
      this.jdField_a_of_type_Txi.b(this.b, this.c);
      continue;
      this.jdField_a_of_type_Txi.a(this.b, this.c, this.jdField_a_of_type_JavaLangObject);
    }
  }
  ...
  {
    a();
    this.jdField_a_of_type_Txi.c(paramInt1, paramInt2);
  }
}
