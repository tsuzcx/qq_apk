...
public final class nsg
{
  private final int a()
  {
    ...
    nsf.a(QzoneConfig.getInstance().getConfig("OfficialAccount", "OfficialAccountReportTimeLimit", 3000));
    return nsf.a();
  }
  ...
  private final void a(String paramString1, String paramString2, CharSequence paramCharSequence, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if (paramString2 != null) {
      ((Map)localHashMap).put("tianshu_transfer", ((nsg)this).a(paramString2));
    }
    ...
    ((nsg)this).a("gouwu_list", "expo", paramString1, (Map)localHashMap);
  }
  ...
  private final void a(String paramString1, String paramString2, CharSequence paramCharSequence, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    ((Map)localHashMap).put("reddot_num", String.valueOf(paramInt2));
    ((nsg)this).a("msg_list", "expo", paramString1, (Map)localHashMap);
  }
  ...
  private final void a(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    ((nsg)this).a("gzh_aio", "expo", paramString1, (Map)localHashMap);
  }
  ...
  private final void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (paramString4 != null) {
      ((Map)localHashMap).put("tianshu_transfer", ((nsg)this).a(paramString4));
    }
    ((nsg)this).a("gzh_aio", "click", paramString3, (Map)localHashMap);
  }
  ...
  private final void a(String paramString1, String paramString2, String paramString3, Map<String, String> paramMap)
  {
    try
    {
      ...
      ((nsg)this).a(paramString3, localHashMap);
    }
  ...
  private final int b()
  {
    ...
    nsf.b(QzoneConfig.getInstance().getConfig("OfficialAccount", "OfficialAccountReportAioListExpoInitTimeLimit", 12000));
    return nsf.b();
  }
  ...
  private final void b(String paramString1, String paramString2, CharSequence paramCharSequence, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    ((Map)localHashMap).put("reddot_num", String.valueOf(paramInt2));
    a((nsg)this, "gouwu_list", "click", paramString1, null, 8, null);
  }
  ...
  private final void b(String paramString1, String paramString2, CharSequence paramCharSequence, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    ((Map)localHashMap).put("reddot_num", String.valueOf(paramInt2));
    ((nsg)this).a("msg_list", "click", paramString1, (Map)localHashMap);
  }
  ...
  private final void c(String paramString1, String paramString2, CharSequence paramCharSequence, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    ((Map)localHashMap).put("reddot_num", String.valueOf(paramInt2));
    ((nsg)this).a("dingyue_list", "expo", paramString1, (Map)localHashMap);
  }
  ...
  private final void d(String paramString1, String paramString2, CharSequence paramCharSequence, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    ((Map)localHashMap).put("reddot_num", String.valueOf(paramInt2));
    a((nsg)this, "dingyue_list", "click", paramString1, null, 8, null);
  }
  
  private final void k(String paramString)
  {
    a((nsg)this, "lockscreen_push", "expo", paramString, null, 8, null);
  }
  ...
  private final void l(String paramString)
  {
    ...
    if (l1 > ((nsg)this).a() + l2)
    {
      a((nsg)this, "lockscreen_push", "click", paramString, null, 8, null);
      nsf.c(SystemClock.elapsedRealtime());
    }
  }
  ...
  public final void a()
  {
    nsf.a(SystemClock.elapsedRealtime());
  }
  ...
  public final void a(@Nullable bcgw parambcgw, @Nullable String paramString)
  {
    if (parambcgw != null) {}
    try
    {
      ((nsg)this).a(parambcgw.aa, parambcgw.b, parambcgw.ab, paramString);
      return;
    }
    catch (Exception parambcgw)
    {
      QLog.e("OfficialAccountReporter", 2, (Throwable)parambcgw, new Object[0]);
    }
  }
  ...
  public final void a(@Nullable RecentBaseData paramRecentBaseData)
  {
    if (paramRecentBaseData != null)
    {
      ...
      try
      {
        ...
        if (nsf.a().contains(Integer.valueOf(i))) {
          return;
        }
        if (!((nsg)this).a()) {
          return;
        }
        nsf.a().add(Integer.valueOf(i));
        if ((paramRecentBaseData instanceof RecentItemPublicAccountChatMsgData))
        {
          ...
          String str = ((nsg)this).a(((QQMessageFacade.Message)localObject1).extStr, "public_account_msg_id");
          i = ((QQMessageFacade.Message)localObject1).msgtype;
          int j = paramRecentBaseData.mUnreadNum;
          ((nsg)this).a((String)localObject2, ((RecentItemPublicAccountChatMsgData)paramRecentBaseData).mReportKeyBytesOacMsgxtend, localCharSequence, str, i, j);
          return;
        }
      }
      ...
      if ((paramRecentBaseData instanceof RecentItemServiceAccountFolderData))
      {
        ...
        ((nsg)this).c((String)localObject1, ((RecentItemServiceAccountFolderData)paramRecentBaseData).mReportKeyBytesOacMsgxtend, (CharSequence)localObject2, 0L, 0, i);
        return;
      }
      if ((paramRecentBaseData instanceof RecentItemEcShopAssitant))
      {
        ...
        localObject2 = paramRecentBaseData.mLastMsg;
        i = paramRecentBaseData.mUnreadNum;
        ((nsg)this).a((String)localObject1, null, (CharSequence)localObject2, 0L, 0, i);
      }
    }
  }
  ...
  public final void a(@Nullable MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        String str3 = ((nsg)this).a(paramMessageRecord.extStr, "public_account_msg_id");
        int j = paramMessageRecord.msgtype;
        if ((i == 1008) || (i == 7230) || (i == 7120))
        {
          ((nsg)this).a(str1, str2, str3, j);
          return;
        }
      }
  ...
  public final void a(@Nullable Object paramObject)
  {
    ...
    try
    {
      ...
      if ((paramObject instanceof RecentItemPublicAccountChatMsgData))
      {
        ...
        ((nsg)this).b((String)localObject2, (String)localObject3, localCharSequence, str, i, j);
        return;
      }
      if ((paramObject instanceof RecentItemServiceAccountFolderData))
      {
        ...
        ((nsg)this).d((String)localObject1, (String)localObject2, (CharSequence)localObject3, 0L, 0, i);
        return;
      }
    }
    ...
    if ((paramObject instanceof RecentItemEcShopAssitant))
    {
      ...
      ((nsg)this).b((String)localObject1, null, (CharSequence)localObject2, 0L, 0, i);
    }
  }
  ...
  public final void a(@Nullable String paramString)
  {
    try
    {
      ...
      {
        HashMap localHashMap = new HashMap();
        ((Map)localHashMap).put("duration_ms", String.valueOf(SystemClock.elapsedRealtime() - nsf.a()));
        ((nsg)this).a("gzh_aio", "stay", paramString, (Map)localHashMap);
      }
      nsf.a(0L);
      return;
    }
  ...
  public final void a(@Nullable String paramString1, int paramInt, @Nullable String paramString2)
  {
    try
    {
      ...
      ((nsg)this).a("gzh_menu", "expo", paramString1, (Map)localHashMap);
      return;
    }
    catch (Exception paramString1)
    {
      ...
      try
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if ((localMessageRecord.istroop == 1008) || (localMessageRecord.istroop == 7230) || (localMessageRecord.istroop == 7120))
          {
            ...
            ((Map)localHashMap).put("tianshu_transfer", ((nsg)this).a(str3));
            ((nsg)this).a("gzh_msg", "accept", str1, (Map)localHashMap);
          }
        }
        return;
      }
  ...
  public final void b()
  {
    nsf.b(SystemClock.elapsedRealtime());
  }
  ...
  public final void b(@Nullable String paramString)
  {
    try
    {
      ...
      {
        HashMap localHashMap = new HashMap();
        ((Map)localHashMap).put("duration_ms", String.valueOf(SystemClock.elapsedRealtime() - nsf.b()));
        ((nsg)this).a("gzh_article", "stay", paramString, (Map)localHashMap);
      }
      nsf.b(0L);
      return;
    }
  ...
  public final void b(@Nullable String paramString1, int paramInt, @Nullable String paramString2)
  {
    try
    {
      ...
      ((nsg)this).a("gzh_menu", "click", paramString1, (Map)localHashMap);
      return;
    }
    catch (Exception paramString1)
    {
  ...
  public final void c()
  {
    try
    {
      ...
      {
        nsf.a().clear();
        nsf.d(SystemClock.elapsedRealtime());
        QLog.d("OfficialAccountReporter", 2, "refreshAioExpoRecord " + (nsf.e() - l1));
        return;
      }
    }
    catch (Exception localException)
  ...
  public final void c(@Nullable String paramString)
  {
    try
    {
      a((nsg)this, "gzh_profile", "expo", paramString, null, 8, null);
      return;
    }
    catch (Exception paramString)
    {
  ...
  public final void c(@Nullable String paramString1, int paramInt, @Nullable String paramString2)
  {
    try
    {
      ...
      long l1 = SystemClock.elapsedRealtime();
      Object localObject = (Long)nsf.a().get(Integer.valueOf(i));
      if (localObject != null)
      {
      ...
      ((nsg)this).a("gzh_profile_menu", "expo", paramString1, (Map)localObject);
      ((Map)nsf.a()).put(Integer.valueOf(i), Long.valueOf(SystemClock.elapsedRealtime()));
      return;
    }
    catch (Exception paramString1)
    {
  ...
  public final void d(@Nullable String paramString)
  {
    try
    {
      a((nsg)this, "gzh_profile_follow", "click", paramString, null, 8, null);
      return;
    }
    catch (Exception paramString)
    {
  ...
  public final void d(@Nullable String paramString1, int paramInt, @Nullable String paramString2)
  {
    try
    {
      ...
      ((nsg)this).a("gzh_profile_menu", "click", paramString1, (Map)localHashMap);
      return;
    }
    catch (Exception paramString1)
    {
  ...
  public final void e(@Nullable String paramString)
  {
    try
    {
      a((nsg)this, "gzh_profile_unfollow", "click", paramString, null, 8, null);
      return;
    }
    catch (Exception paramString)
    {
  ...
  public final void f(@Nullable String paramString)
  {
    try
    {
      a((nsg)this, "gzh_sub_profile", "click", paramString, null, 8, null);
      return;
    }
    catch (Exception paramString)
    {
  ...
  public final void g(@Nullable String paramString)
  {
    try
    {
      a((nsg)this, "gzh_profile_dots", "click", paramString, null, 8, null);
      return;
    }
    catch (Exception paramString)
    {
  ...
  public final void h(@Nullable String paramString)
  {
    try
    {
      a((nsg)this, "gzh_profile_aio_entrance", "click", paramString, null, 8, null);
      return;
    }
    catch (Exception paramString)
    {
  ...
  public final void i(@Nullable String paramString)
  {
    try
    {
      a((nsg)this, "gzh_msg_setting_open", "click", paramString, null, 8, null);
      return;
    }
    catch (Exception paramString)
    {
  ...
  public final void j(@Nullable String paramString)
  {
    try
    {
      a((nsg)this, "gzh_msg_setting_close", "click", paramString, null, 8, null);
      return;
    }
    catch (Exception paramString)
    {
