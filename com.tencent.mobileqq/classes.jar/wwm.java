  ...
  implements wwn
{
  ...
  public wwm(@NonNull wwe paramwwe)
  {
    super(paramwwe);
  }
  ...
  private int a()
  {
    int i = ((Integer)((urk)urr.a(10)).b("key_last_used_permission", Integer.valueOf(10000))).intValue();
    wsv.a("Q.qqstory.publish.edit.EditVideoPermission", "get default permission from local. type is %d.", Integer.valueOf(i));
    return i;
  }
  ...
  private void b(int paramInt)
  {
    ...
    default: 
      ...
      paramInt = 1;
      switch (this.jdField_a_of_type_Wwe.a.b())
      {
      case 2: 
      default: 
        wsv.e("Q.qqstory.publish.edit.EditVideoPermission", "unKnown entrance:%s", new Object[] { Integer.valueOf(this.jdField_a_of_type_Wwe.a.b()) });
        i = 99;
      }
      break;
    }
  ...
  private void g()
  {
    ...
    {
    default: 
      this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131699888));
      return;
    case 10004: 
      this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131699896));
      return;
    case 10000: 
      this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131699888));
      return;
    case 10001: 
      this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131699892));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetTextView.setText(a(2131699897));
  }
  
  public void a()
  {
    super.a();
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131371689));
    this.jdField_a_of_type_ComTencentMobileqqTroopWidgetRedDotImageView = ((RedDotImageView)a(2131371697));
  ...
  public void a(int paramInt, @NonNull xgs paramxgs)
  {
    ...
    try
    {
      for (;;)
      {
        ...
        wsv.b("Q.qqstory.publish.edit.EditVideoPermission", "permissionType:" + i);
        wsv.b("Q.qqstory.publish.edit.EditVideoPermission", "permissionUinList:" + localObject.toString());
        ...
        paramxgs.a.readerConfBytes = localVideoReaderConf.toByteArray();
        if ((paramInt == 0) && (this.jdField_b_of_type_Int != this.jdField_a_of_type_Int))
        {
          wsv.b("Q.qqstory.publish.edit.EditVideoPermission", "user has changed permission during editing session. default permission is %d, new permission is %d.", Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(this.jdField_b_of_type_Int));
    ...
    catch (NumberFormatException localNumberFormatException)
    {
      for (;;)
      {
        wsv.e("Q.qqstory.publish.edit.EditVideoPermission", "MyUin , can't format uin:%s", new Object[] { this.jdField_a_of_type_JavaLangString });
      }
    }
  }
  ...
  public void af_()
  {
    wsv.b("Q.qqstory.publish.edit.EditVideoPermission", "onStop, set jump flag false.");
