...
public class vfh
{
  ...
  public vfh(EditVideoParams paramEditVideoParams)
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("enable_flow_decode", Boolean.valueOf(auxw.b));
  }
