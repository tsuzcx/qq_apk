...
{
  public atbq(NearbyUtils.1 param1) {}
    ...
    if (paramBoolean) {
        ...
        if (paramBundle != null)
        {
          ...
          else
          {
            ...
            try
            {
              ...
              this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().h(this.a.jdField_a_of_type_JavaLangString, bbca.decode(paramBundle, 0));
              return;
            }
      ...
      catch (Exception paramBundle)
      {
        if (QLog.isColorLevel())
        {
          ...
          return;
          label283:
          this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().i(this.a.jdField_a_of_type_JavaLangString, bbca.decode(paramBundle, 0));
        }
      }
    }
  }
