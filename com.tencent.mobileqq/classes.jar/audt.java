...
{
  private amwl jdField_a_of_type_Amwl = new audw(this);
  ...
  public audt(QQAppInterface paramQQAppInterface)
  {
  ...
  public static audt a(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    QQToast.a(paramContext, 0, amtj.a(2131703799), 2000).a();
    int j;
    if (this.b != null)
    {
    ...
    for (int i = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.fontId;; i = this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble.bubbleId)
    {
      ...
      this.b = null;
      this.jdField_a_of_type_Aufk = null;
      return;
    }
  }
  ...
  private void a(BaseChatPie paramBaseChatPie)
  {
    ...
    do
    {
      ...
      paramBaseChatPie.setSendTextMsgParams(localacwc);
      localacwc.i = paramBaseChatPie.isSendToRobotServer;
      paramBaseChatPie.isSendToRobotServer = false;
      this.jdField_a_of_type_ArrayOfLong = acvv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseChatPie.getActivity(), paramBaseChatPie.getSessionInfo(), str, new ArrayList(), localacwc);
  ...
  private void a(BaseChatPie paramBaseChatPie, long paramLong, int paramInt)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject2)) {
      localObject1 = amtj.a(2131703800);
    }
    ...
    bfur.a(paramBaseChatPie.getActivity(), 230, (String)localObject1, (CharSequence)localObject2, amtj.a(2131703801), (String)localObject3, new audu(this, paramBaseChatPie, str), new audv(this)).show();
  }
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        if (this.jdField_a_of_type_Aufk != null) {
          this.jdField_a_of_type_Aufk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        }
      }
      return;
      label59:
  ...
  public void a(BaseChatPie paramBaseChatPie, Bundle paramBundle)
  {
    ...
    if (this.b != null)
    {
      ...
      this.b = new aufk(this.b.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
  ...
  public void a(BaseChatPie paramBaseChatPie, boolean paramBoolean, SetFontBubbleRsp paramSetFontBubbleRsp, int paramInt)
  {
    if ((paramBoolean) && (paramSetFontBubbleRsp.stRet != null) && (paramSetFontBubbleRsp.stRet.ret == 0))
    {
      ...
      if ((this.jdField_a_of_type_Aufk != null) && (this.jdField_a_of_type_Aufk.jdField_a_of_type_Int == paramInt))
      {
        if ((paramSetFontBubbleRsp.stFontRsp.authRet != 0) || (paramSetFontBubbleRsp.stBubbleRsp.authRet != 0)) {
          QLog.e("FontBubbleManager", 1, "onSetFontBubble failed," + " fontAuth:" + paramSetFontBubbleRsp.stFontRsp.authRet + " bubbleAuth:" + paramSetFontBubbleRsp.stBubbleRsp.authRet + this.jdField_a_of_type_Aufk.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
        }
        for (;;)
        {
          this.jdField_a_of_type_Aufk = null;
          return;
          if (QLog.isColorLevel()) {
            QLog.d("FontBubbleManager", 2, "onSetFontBubble mRestore success: " + this.jdField_a_of_type_Aufk.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
          }
        }
      }
    ...
    if ((this.jdField_a_of_type_Aufk != null) && (this.jdField_a_of_type_Aufk.jdField_a_of_type_Int == paramInt)) {
      QLog.e("FontBubbleManager", 1, "restore failed: " + this.jdField_a_of_type_Aufk.jdField_a_of_type_ComTencentMobileqqHiboomFontBubble);
    }
    a(paramBaseChatPie.getActivity());
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 1000: 
      ...
      this.jdField_a_of_type_Aufk = new aufk((FontBubble)paramMessage[0]);
      this.b = new aufk((FontBubble)paramMessage[1]);
      this.b.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return true;
    }
