...
class tyt
  implements Runnable
{
  tyt(typ paramtyp, List paramList) {}
  
  public void run()
  {
    Object localObject1 = (TroopManager)this.jdField_a_of_type_Typ.a.app.getManager(51);
    TroopInfo localTroopInfo = ((TroopManager)localObject1).a(this.jdField_a_of_type_Typ.a.b);
    ...
    for (int i = 0;; i = this.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      localObject1 = (TroopHandler)this.jdField_a_of_type_Typ.a.app.a(20);
      if (localObject1 == null) {
        break;
      }
      try
      {
        ((TroopHandler)localObject1).a(Long.parseLong(this.jdField_a_of_type_Typ.a.b), 0L, 2, 0, 0);
        return;
      }
