  ...
  implements avuf, bkqu
{
  ...
  private biim jdField_a_of_type_Biim = (biim)this.jdField_a_of_type_Biwb.a(65537, new Object[0]);
  private bikb jdField_a_of_type_Bikb;
  private bikn jdField_a_of_type_Bikn = new bikq();
  ...
  private AtomicReference<avuf> jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference = new AtomicReference();
  ...
  public biku(Activity paramActivity, View paramView, biwb parambiwb)
  {
  ...
  private void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131716414) + paramString + ajyc.a(2131716413));
    ...
    for (;;)
    {
      ...
      localAlphaAnimation1.setAnimationListener(new bilc(this, localAlphaAnimation2));
      localAlphaAnimation2.setAnimationListener(new bikw(this));
      return;
      label423:
      paramString = null;
    }
  ...
  private void a(AEMaterialPanel paramAEMaterialPanel)
  {
    ...
    {
      int i = vzo.c(localActivity);
      this.jdField_b_of_type_AndroidViewView.post(new VideoStoryAIScenePart.18(this, paramAEMaterialPanel, i));
    }
  }
  
  private void a(AtomicReference<avuf> paramAtomicReference, AEFilterManager paramAEFilterManager)
  {
    if (paramAtomicReference.get() == null) {
      aune.a("Q.videostory", "Q.videostory.capture", "requestAIScene()", "sceneCallback is null");
    }
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            ((avuf)paramAtomicReference.get()).a("mQQFilterRenderManager is null");
            return;
            aune.a("Q.videostory", "Q.videostory.capture", "requestAIScene()", "start");
        ...
        if (localObject2 != null)
        {
          ...
          while (((Iterator)localObject2).hasNext())
          {
            ...
            localObject3 = new biko();
            ((biko)localObject3).jdField_b_of_type_Int = ((int)(f3 - f4));
            ((biko)localObject3).jdField_a_of_type_Int = ((int)(f1 - f2));
        ...
        try
        {
          ...
          this.jdField_a_of_type_Bikn.a((Bitmap)localObject2, (ArrayList)localObject1, new bikx(this, paramAtomicReference));
          return;
        }
        catch (Exception paramAEFilterManager) {}
      } while ((avuf)paramAtomicReference.get() == null);
      ((avuf)paramAtomicReference.get()).a(paramAEFilterManager.toString());
      return;
    } while ((avuf)paramAtomicReference.get() == null);
    ((avuf)paramAtomicReference.get()).a("no bitmap");
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      xhe.a("mystatus_shoot", "cam_reverse", 0, 0, new String[0]);
      return;
      label66:
      if (!paramBoolean) {
  ...
  private void k()
  {
    ...
    for (;;)
    {
      ...
      localMarginLayoutParams.bottomMargin -= axli.a(i);
  ...
  private void l()
  {
    ((biiw)biix.a(this.jdField_a_of_type_Biim).a(biiw.class)).b.a(this.jdField_a_of_type_Biim, new bikz(this));
    ((bivy)biix.a(this.jdField_a_of_type_Biim).a(bivy.class)).a().a(this.jdField_a_of_type_Biim, new bila(this));
  }
  
  private void m()
  {
    if (bizj.a().a("ai_guide_shown", false, 0)) {
      return;
    }
    String str2 = bihz.d;
    String str1 = null;
  ...
  protected void a()
  {
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131362214);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362218));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362217));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362215));
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131362216);
    ...
    a(this);
    this.jdField_a_of_type_DovComQqImAeCameraCoreAECameraGLSurfaceView.setSceneListener(new bikv(this));
    this.jdField_a_of_type_AndroidOsHandler = new biky(this, Looper.getMainLooper());
    k();
  }
  ...
  public void a(int paramInt, QIMFilterCategoryItem paramQIMFilterCategoryItem)
  {
    ...
    if (paramQIMFilterCategoryItem != null)
    {
      ...
      aune.a("Q.videostory", "Q.videostory.capture", "onFilterSelect", str);
      if (paramInt != 0) {
        a(null);
      }
    ...
    for (;;)
    {
      ...
      xhe.a("mystatus_shoot", "filter_change", 0, 0, new String[0]);
      return;
      str = "no filter";
      break;
      label102:
  ...
  public void a(int paramInt, String paramString, boolean paramBoolean)
  {
    if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_AndroidWidgetTextView.getVisibility() == 0) && (!this.jdField_a_of_type_Boolean) && (!this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()))
    {
      ...
      localAnimationSet.setAnimationListener(new bilb(this, paramBoolean, paramInt, paramString));
    }
  }
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.set(paramavuf);
  }
  ...
  public void a(bikt parambikt)
  {
    ...
    if ((parambikt.jdField_a_of_type_Int == -1) || ((this.jdField_a_of_type_Biim != null) && (!this.jdField_a_of_type_Biim.b())))
    {
      e();
      return;
    }
    Object localObject2 = parambikt.b;
    Object localObject1 = bkqo.a().c(0);
    Bundle localBundle;
    bjbk localbjbk;
    if (localObject1 != null)
    {
      ...
      aune.a("Q.videostory", "Q.videostory.capture", "onAISceneSuccess", (String)localObject2 + " " + (String)localObject1);
      localBundle = new Bundle();
      localBundle.putInt("apply_source", bjbk.jdField_a_of_type_Int);
      ...
      parambikt = new ArrayList();
      e();
    }
    for (;;)
    {
      aune.a("Q.videostory", "Q.videostory.capture", "onAISceneSuccess", "filterLister is empty:" + parambikt.size());
      return;
      localObject1 = "";
      break;
      label236:
      localObject1 = localbjbk.a().c;
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        if (localQIMFilterCategoryItem.b.equals(localObject2))
        {
          ...
          ((Bundle)localObject3).putString("sceneName", parambikt.jdField_a_of_type_JavaLangString);
          ((Bundle)localObject3).putInt("sceneLvOne", parambikt.jdField_a_of_type_Int);
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_AndroidViewView.postDelayed(new VideoStoryAIScenePart.13(this, localQIMFilterCategoryItem, localbjbk, localBundle), 500L);
            parambikt = (bikt)localObject1;
            break;
          }
          label412:
          e();
  ...
  public void a(String paramString)
  {
    ...
    aune.a("Q.videostory", "Q.videostory.capture", "onAISceneFail", paramString);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131716394));
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    a();
    if (this.jdField_a_of_type_AndroidViewAnimationAnimationSet != null) {
