...
public abstract class bjjo
  extends bjlc
{
  private final RecyclerView.OnScrollListener jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$OnScrollListener = new bjjp(this);
  ...
  {
    return new bjjq(this, this.jdField_a_of_type_DovComQqImCaptureViewSpeedFlexibleRecyclerView.getContext());
  }
