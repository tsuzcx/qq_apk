...
public class bjjo
{
  ...
  public static bjjo a()
  {
    try
    {
      if (jdField_a_of_type_Bjjo == null) {
        jdField_a_of_type_Bjjo = new bjjo();
      }
      bjjo localbjjo = jdField_a_of_type_Bjjo;
      return localbjjo;
    }
    finally {}
  }
  ...
  public long a()
  {
    try
    {
      ...
      bjtx.b("CommonDataAdapter", "get uin from app runtim succ:" + this.jdField_a_of_type_Long);
      label46:
  ...
  protected void a()
  {
    ...
    {
      bjtx.e("AppUpdate", "getPackageInfo NameNotFoundException : " + localNameNotFoundException.toString());
      return;
    }
    catch (Exception localException)
    {
      bjtx.e("AppUpdate", "getPackageInfo exception : " + localException.toString());
    }
  }
  ...
  public void a(String paramString, Context paramContext, WebView paramWebView)
  {
    try
    {
      ...
      localJSONObject2.put("imei", bjve.c());
      localJSONObject2.put("imsi", bjve.d());
      localJSONObject2.put("mac_addr", bjve.a());
      localJSONObject2.put("model_info", Build.MODEL);
      localJSONObject2.put("network_type", bjts.a(a().a()));
      localJSONObject2.put("network_operater", "");
      localJSONObject2.put("location", bjve.f());
    ...
    {
      bjtx.e("AppUpdate", "getUpdateApp parse H5 params error : " + localJSONException.toString());
      if (!paramContext.getSharedPreferences("appcenter_app_report", 0).getBoolean("is_app_last_fullReport_success", false))
      {
        bjtx.c("AppUpdate", "getUpdateApp will do full report");
        bjvh.a(paramContext, paramString, paramWebView, String.valueOf(a().a()), false);
        return;
      ...
      {
        bjtx.c("AppUpdate", "getUpdateApp will do incremental report");
        bjvh.a(paramContext, null, 0, paramString, paramWebView, String.valueOf(a().a()));
        return;
      }
      bjtx.c("AppUpdate", "getUpdateApp will get update app directly");
      bjvi.a(paramContext, paramWebView, paramString, true, String.valueOf(a().a()));
    }
  }
