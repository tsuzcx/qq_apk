...
public abstract class blkm
  extends Binder
  implements blkl
{
  public static blkl a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.uodis.opendevice.aidl.OpenDeviceIdentifierService");
    if ((localIInterface != null) && ((localIInterface instanceof blkl))) {
      return (blkl)localIInterface;
    }
    return new blkn(paramIBinder);
  }
