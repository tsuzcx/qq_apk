  ...
  implements View.OnClickListener
{
  ...
  public qrg(Context paramContext, FaceDecoder paramFaceDecoder, slt paramslt)
  {
  ...
  private TextView a(int paramInt)
  {
    ...
    localTextView.setId(2131375925);
    localTextView.setTextSize(2, 11.0F);
    localTextView.setGravity(17);
    localTextView.setText(amtj.a(2131703572));
    ...
    if (paramInt == 0)
    {
      ...
      localTextView.setBackgroundResource(2130849338);
      return localTextView;
    }
    localTextView.setTextColor(-89258);
    localTextView.setBackgroundResource(2130849339);
    return localTextView;
  }
  ...
  public qpk d()
  {
    ...
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560247, localRelativeLayout, true);
    this.jdField_d_of_type_AndroidViewView = localView.findViewById(2131369769);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131372729));
    this.jdField_b_of_type_AndroidViewView = localView.findViewById(2131376544);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView = ((KandianUrlImageView)localView.findViewById(2131369207));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131379877));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131379757));
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131369264));
    ...
    this.jdField_c_of_type_AndroidWidgetTextView.setId(2131375918);
    ((FrameLayout)localView.findViewById(2131366772)).addView(this.jdField_c_of_type_AndroidWidgetTextView, localLayoutParams);
    this.jdField_a_of_type_ComTencentImageURLImageView.setOnClickListener(this);
    this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131370115));
    this.jdField_c_of_type_AndroidViewView = localView.findViewById(2131380785);
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363677));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)localView.findViewById(2131366779));
    this.jdField_b_of_type_AndroidWidgetFrameLayout = ((FrameLayout)localView.findViewById(2131366778));
  ...
  public qpk o()
  {
    ...
    {
      localpvc = (pvc)this.jdField_a_of_type_JavaLangObject;
    ...
    if (localArticleInfo.mVideoCoverUrl != null)
    {
      ...
      pai.a((KandianUrlImageView)localObject2, (URL)localObject1, this.jdField_a_of_type_AndroidContentContext, true);
      if (jdField_a_of_type_AndroidGraphicsDrawableDrawable == null) {
        jdField_a_of_type_AndroidGraphicsDrawableDrawable = bfvo.b();
      }
    ...
    for (;;)
    {
      ...
      if (localpvc.e() == 0)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundColor(this.jdField_a_of_type_AndroidWidgetLinearLayout.getResources().getColor(2131167337));
        return this;
        ...
        localObject1 = pay.a(localArticleInfo.mFirstPagePicUrl);
        break;
    ...
    for (;;)
    {
      ...
      return this;
      label766:
      this.jdField_b_of_type_AndroidWidgetTextView.setText(rwv.c(localArticleInfo.mVideoPlayCount));
