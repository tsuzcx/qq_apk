...
public class bfgp
  implements Manager
{
  private bfgz jdField_a_of_type_Bfgz;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private EntityManager jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager;
  private boolean jdField_a_of_type_Boolean;
  
  public bfgp(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = paramQQAppInterface.a().createEntityManager();
    this.jdField_a_of_type_Bfgz = new bfgz();
    ThreadManager.getSubThreadHandler().post(new TroopHonorManager.1(this));
  }
  
  public List<bfgy> a(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    paramString = bfgt.a(paramString);
    if ((paramString != null) && (paramString.size() > 0))
    {
      ...
      while (paramString.hasNext())
      {
        ...
        localObject = this.jdField_a_of_type_Bfgz.a(((Integer)localObject).intValue());
        if (localObject != null) {
  ...
  public List<bfgy> a(String paramString1, String paramString2)
  {
    if (!b(paramString1)) {
      return null;
    }
  ...
  public void a(bfgz parambfgz, boolean paramBoolean)
  {
    if (parambfgz == null) {}
    for (;;)
    {
      ...
      else
      {
        ...
        this.jdField_a_of_type_Bfgz = parambfgz;
        if (QLog.isColorLevel()) {
          QLog.d("TroopHonor.manager", 2, String.format("updateConfig, isInit: %s, config: %s", new Object[] { Boolean.valueOf(paramBoolean), parambfgz }));
        }
        if (!paramBoolean) {
          ((anwd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).notifyUI(80, true, null);
        }
      }
    }
  }
  
  public void a(String paramString1, String paramString2, bfgs parambfgs)
  {
    ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).a(paramString1, paramString2, new bfgq(this, paramString1, paramString2, parambfgs));
  }
      ...
      try
      {
        ...
        if ((paramArrayOfByte != null) && (paramArrayOfByte.size() > 0))
        {
          ...
          if (((Iterator)localObject).hasNext())
          {
            ...
            a(paramString, str, bfgt.a(paramArrayOfByte));
            if ((!TextUtils.isEmpty(str)) && (str.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))) {
              ((anwd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).notifyUI(80, true, new Object[] { paramString, str });
            }
            if (!QLog.isColorLevel()) {
              continue;
            }
  ...
  {
    if ((this.jdField_a_of_type_Bfgz != null) && (this.jdField_a_of_type_Bfgz.jdField_a_of_type_Boolean)) {}
    for (int i = 1;; i = 0)
    {
      TroopManager localTroopManager = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
      if (i == 0)
  ...
  public void b(String paramString1, String paramString2, bfgs parambfgs)
  {
    if ((!b(paramString1)) && (parambfgs != null))
    {
      parambfgs.a(null);
      return;
    }
    ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).a(paramString1, paramString2, new bfgr(this, paramString1, paramString2, parambfgs));
  }
