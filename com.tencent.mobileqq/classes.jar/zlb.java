...
public class zlb
  extends antq
{
  public zlb(QRDisplayActivity paramQRDisplayActivity) {}
  ...
  protected void onGetFlyTicket(boolean paramBoolean, int paramInt, long paramLong1, String paramString1, String paramString2, long paramLong2)
  {
    ...
    Object localObject = this.a.jdField_a_of_type_Antl.a(this.a.jdField_c_of_type_JavaLangString, true);
    ...
    localObject = znl.a(paramString2, -1);
    if (localObject != null)
    {
      ((TextView)this.a.findViewById(2131373879)).setText(paramString2);
  ...
  protected void onUpdateDiscussionFaceIcon(boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    if (paramBoolean1)
    {
      paramString = ((antl)this.a.app.getBusinessHandler(BusinessHandlerFactory.DISCUSSION_HANDLER)).a(paramString, true);
