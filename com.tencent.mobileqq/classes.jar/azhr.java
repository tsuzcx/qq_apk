  ...
  implements anil, awyi
{
  ...
  public azhr(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Avut.jdField_b_of_type_Boolean = true;
    paramQQAppInterface.removeObserver(this.jdField_a_of_type_Avtk);
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    bdpg.a().a(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout, paramString, j);
  ...
  {
    new bhhm("VIP.ProfileMusicBoxServer.ProfileMusicBoxObj", "ProfileMusicBox.getMusicList").a("getMusicList", new GetMusicListReq(paramLong, "", 100L, new SourceInfo(3, "8.4.1"), 0), new GetMusicListRsp(), this, false);
  }
  ...
  {
    new bhhm("VIP.ProfileMusicBoxServer.ProfileMusicBoxObj", "ProfileMusicBox.getQzoneMusicInfo").a("getQzoneMusicInfo", new GetQzoneMusicInfoReq(paramLong, paramArrayList, new SourceInfo(3, "8.4.1")), new GetQzoneMusicInfoRsp(), new azhs(this), false);
  }
  ...
  public void a(Context paramContext, SongInfo paramSongInfo)
  {
    ...
    {
      return;
      new Intent(paramContext, QQBrowserActivity.class).putExtra("url", bkgj.a(aqyb.a().jdField_b_of_type_JavaLangString, "uin", String.valueOf(this.jdField_a_of_type_Long)));
  ...
  public void a(SongInfo paramSongInfo)
  {
    ...
    this.jdField_a_of_type_Avut.jdField_a_of_type_JavaLangString = paramSongInfo.e;
    if (a()) {
  ...
  public void a(String paramString)
  {
    ...
    if (localavuv != null)
    {
      this.jdField_a_of_type_Avut.jdField_a_of_type_Int = localavuv.a().jdField_a_of_type_Int;
      this.jdField_a_of_type_Avut.jdField_b_of_type_Int = localavuv.a().jdField_b_of_type_Int;
      this.jdField_a_of_type_Avut.jdField_a_of_type_Boolean = localavuv.a().jdField_a_of_type_Boolean;
      if (localavuv.a()) {
        localavuv.b(localavuv.a().e, localavuv.a().jdField_b_of_type_JavaLangString);
      }
    }
    if (QLog.isColorLevel()) {
      QLog.d("ProfileMusicBoxController", 2, "showLyrics");
    }
    if ((TextUtils.isEmpty(paramString)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Avut.jdField_b_of_type_JavaLangString)))
    {
      super.a(j, this.jdField_a_of_type_Avut.jdField_b_of_type_JavaLangString);
      return;
    }
  ...
  public void c()
  {
    azhq.b(this.jdField_a_of_type_ComTencentMobileqqListentogetherLyricsFloatIconLayout.getContext(), this.jdField_a_of_type_Avut.jdField_b_of_type_JavaLangString);
    String str;
    if (this.i)
    {
      str = "";
    ...
    for (int k = 1;; k = 2)
    {
      bcst.b(null, "dc00898", "", str, "qq_vip", "0X800A7DF", k, 0, "", "", "", "");
      return;
  ...
  public void d()
  {
    ...
    for (int k = 1;; k = 2)
    {
      bcst.b(null, "dc00898", "", str, "qq_vip", "0X800A7E0", k, 0, "", "", "", "");
      return;
      str = String.valueOf(this.jdField_a_of_type_Long);
      break;
    }
  ...
  public void e()
  {
    ...
    this.jdField_a_of_type_Azht = null;
    super.e();
    bdpg.a().b();
  }
  ...
  public void j()
  {
    super.b(j, this.jdField_a_of_type_Avut.jdField_b_of_type_JavaLangString);
    this.jdField_a_of_type_Avut.e = 0;
    b(j, this.jdField_a_of_type_Avut.jdField_b_of_type_JavaLangString, true);
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      avuv localavuv = ListenTogetherManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a();
      if (localavuv != null)
      {
        localavuv.a().jdField_a_of_type_Int = this.jdField_a_of_type_Avut.jdField_a_of_type_Int;
        localavuv.a().jdField_b_of_type_Int = this.jdField_a_of_type_Avut.jdField_b_of_type_Int;
        localavuv.a().jdField_a_of_type_Boolean = this.jdField_a_of_type_Avut.jdField_a_of_type_Boolean;
      }
      if (QLog.isColorLevel()) {
  ...
  public void m()
  {
    ...
    if ((localavuv != null) && (!ListenTogetherManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b())) {
      localJSONObject = new JSONObject();
    }
    try
    {
      localJSONObject.put("type", "musicboxResume");
      localJSONObject.put("uin", localavuv.a().jdField_b_of_type_JavaLangString);
      localJSONObject.put("uinType", localavuv.a().e);
  ...
  public void onPlaySongChanged(SongInfo paramSongInfo)
  {
    ...
    if (paramSongInfo.jdField_b_of_type_Int == 10)
    {
      if (this.jdField_a_of_type_Azht != null) {
        this.jdField_a_of_type_Azht.a(paramSongInfo, this.h);
      }
      n();
      if (QLog.isColorLevel()) {
  ...
  public void onPlayStateChanged(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        if (this.jdField_a_of_type_Azht != null) {
          this.jdField_a_of_type_Azht.a((SongInfo)localObject, true);
        }
      ...
      else
      {
        ...
        continue;
        if (this.jdField_a_of_type_Azht != null) {
          this.jdField_a_of_type_Azht.a(2);
        }
        d(false);
        this.h = false;
        ...
        for (;;)
        {
          bcst.b(null, "dc00898", "", String.valueOf(l), "qq_vip", (String)localObject, k, 0, String.valueOf((System.currentTimeMillis() - this.jdField_b_of_type_Long) / 1000L), "", "", "");
          break;
