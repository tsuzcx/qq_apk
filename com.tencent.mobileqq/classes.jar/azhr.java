...
public class azhr
  extends ajuc
{
  public azhr(TroopBatchAddFriendMgr paramTroopBatchAddFriendMgr) {}
  ...
  protected void a(String paramString, boolean paramBoolean, List<TroopMemberInfo> paramList, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    {
      QLog.i("troopBatchAddFrd.TroopBatchAddFriendMgr", 2, String.format("onUpdateTroopGetMemberList suc_troopUin_type_ts=%d_%s_%d_%d", new Object[] { Integer.valueOf(paramInt1), paramString, Integer.valueOf(paramInt2), Long.valueOf(paramLong) }));
      if (paramList.longValue() != paramLong) {
        break;
      }
      ...
      String str = String.format(Locale.getDefault(), "%s_%s_%s", new Object[] { "sp_baf_data_check_flag_members", this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString });
      paramList.edit().putLong(str, paramLong).apply();
