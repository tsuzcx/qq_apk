...
public class aymp
{
  ...
  public aymp(Application paramApplication)
  {
  ...
  private Bundle a(Application paramApplication)
  {
    ...
    localBundle.putString("network", String.valueOf(aymt.a(paramApplication)));
    localBundle.putString("imei", this.b);
    return localBundle;
  }
  
  public aymp a(double paramDouble)
  {
    return a("res1", paramDouble);
  }
  
  public aymp a(String paramString)
  {
    this.jdField_a_of_type_AndroidOsBundle.putString("uin", paramString);
    return this;
  }
  
  public aymp a(String paramString, double paramDouble)
  {
    this.jdField_a_of_type_AndroidOsBundle.putString(paramString, String.valueOf(paramDouble));
    return this;
  }
  
  public aymp a(String paramString1, String paramString2)
  {
  ...
  public void a()
  {
    aymr.a.a(this.jdField_a_of_type_AndroidOsBundle);
  }
  
  public aymp b(String paramString)
  {
    this.jdField_a_of_type_AndroidOsBundle.putString("module", paramString);
    return this;
  }
  
  public aymp c(String paramString)
  {
    this.jdField_a_of_type_AndroidOsBundle.putString("action", paramString);
    return this;
  }
  
  public aymp d(String paramString)
  {
    return a("extcol1", paramString);
  }
  
  public aymp e(String paramString)
  {
    return a("extcol2", paramString);
  }
  
  public aymp f(String paramString)
  {
    return a("extcol3", paramString);
  }
  
  public aymp g(String paramString)
  {
