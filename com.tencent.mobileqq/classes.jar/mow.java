...
public class mow
  implements mot
{
  private static HashMap<String, mor> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private ITMAssistantDownloadClientListener jdField_a_of_type_ComTencentTmdownloaderITMAssistantDownloadClientListener = new mox(this);
  ...
  public void a(Context paramContext, String paramString1, String paramString2, String paramString3, moc parammoc, Map<String, String> paramMap)
  {
    if (parammoc == null) {
      return;
    }
    if (paramContext == null)
    {
      parammoc.loaded(paramString1, 11);
      return;
    }
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString3)))
    {
      parammoc.loaded(paramString1, 12);
      return;
    }
    if (AppNetConnInfo.getRecentNetworkInfo() == null)
    {
      parammoc.loaded(paramString1, 10);
      return;
    }
    Object localObject = new File(paramString3.substring(0, paramString3.lastIndexOf("/")));
    if ((!((File)localObject).exists()) && (!((File)localObject).mkdirs()))
    {
      parammoc.loaded(paramString1, 13);
      return;
    }
    localObject = Md5Utils.getMD5(paramString1);
    paramString2 = new mor((String)localObject, paramString3, paramString2, parammoc);
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          try
          {
            ...
            bcct.a(paramContext, paramString3);
            return;
          }
  ...
  public void a(Context paramContext, String paramString1, String paramString2, moc parammoc)
  {
    a(paramContext, paramString1, "0", paramString2, parammoc, null);
  }
  
  public void a(TMAssistantDownloadClient paramTMAssistantDownloadClient, mor parammor, String paramString)
  {
    ...
    try
    {
      ...
      for (paramTMAssistantDownloadClient = localObject;; paramTMAssistantDownloadClient = paramTMAssistantDownloadClient.mSavePath)
      {
        ...
        a(parammor.jdField_a_of_type_Moc, paramString, parammor.c, 14, "get current download path fail after download");
        return;
      }
    ...
    {
      a(parammor.jdField_a_of_type_Moc, paramString, parammor.c, 15, "cannot get current file after download");
      return;
    }
    if (!bace.d(localTMAssistantDownloadClient, parammor.b))
    {
      a(parammor.jdField_a_of_type_Moc, paramString, parammor.c, 16, "rename file fail after download");
      paramTMAssistantDownloadClient.delete();
      return;
    }
    a(parammor.jdField_a_of_type_Moc, paramString, parammor.c, 0, "offline zip download success");
  }
  ...
  public void a(moc parammoc, String paramString1, String paramString2, int paramInt, String paramString3)
  {
    if (QLog.isColorLevel()) {
      QLog.d("OfflineDownload", 2, paramString3 + ", bid: " + paramString2 + ", errCode: " + paramInt);
    }
    if ((parammoc != null) && (paramInt >= 0)) {
      parammoc.loaded(paramString1, paramInt);
    }
