  ...
  implements View.OnClickListener, FaceDecoder.DecodeTaskCompletionListener
{
  ...
  public axhu(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561223, null);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131373198));
    ...
    this.jdField_a_of_type_Baoy = ((baoy)((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app.getManager(15));
    ...
    {
      paramContext = paramContext.getString("key_nearbyrecommender_title", this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131694052));
  ...
  public static void a(VipBaseInfo paramVipBaseInfo, ImageView paramImageView, SingleLineTextView paramSingleLineTextView)
  {
    ...
    paramSingleLineTextView.setTextColor(paramSingleLineTextView.getResources().getColorStateList(2131167079));
    ...
    if ((paramVipBaseInfo != null) && (paramVipBaseInfo.mOpenInfo != null))
    {
      ...
      paramSingleLineTextView.setTextColor(paramSingleLineTextView.getResources().getColorStateList(2131167154));
    }
    label84:
    do
    {
  ...
  {
    bhji localbhji = new bhji(this.jdField_a_of_type_AndroidContentContext.getResources(), this.jdField_a_of_type_Baoy.a(paramInt, 200), false, false);
    if (this.c == 0) {
      this.c = ((int)(paramSingleLineTextView.getTextSize() * 1.1F + 0.5F));
    }
    localbhji.setBounds(0, 0, this.c, this.c);
    paramSingleLineTextView.setCompoundDrawablesWithIntrinsicBounds(localbhji, null);
  }
  ...
  {
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559494, null);
      ...
      if (paramRespEncounterInfo.tiny_id > 0L)
      {
        ...
        if (paramRespEncounterInfo == null)
        {
          ...
          if (this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable == null) {
            this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = ((BitmapDrawable)bfvo.a());
          }
  ...
  public void a(View paramView, RespEncounterInfo paramRespEncounterInfo)
  {
    ...
    SingleLineTextView localSingleLineTextView1 = (SingleLineTextView)paramView.findViewById(2131378368);
    Object localObject4 = (ImageView)paramView.findViewById(2131363063);
    ImageView localImageView5 = (ImageView)paramView.findViewById(2131368614);
    Object localObject1 = (TextView)paramView.findViewById(2131378438);
    ImageView localImageView2 = (ImageView)paramView.findViewById(2131380891);
    SingleLineTextView localSingleLineTextView2 = (SingleLineTextView)paramView.findViewById(2131365356);
    Object localObject2 = (SingleLineTextView)paramView.findViewById(2131378647);
    Object localObject3 = paramView.findViewById(2131369356);
    TextView localTextView = (TextView)paramView.findViewById(2131371739);
    ImageView localImageView3 = (ImageView)paramView.findViewById(2131372449);
    ImageView localImageView4 = (ImageView)paramView.findViewById(2131364393);
    LinearLayout localLinearLayout = (LinearLayout)paramView.findViewById(2131376977);
    View localView = paramView.findViewById(2131369437);
    paramView = (SingleLineTextView)paramView.findViewById(2131368734);
    this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167079);
    label222:
    int i;
    if (!TextUtils.isEmpty(paramRespEncounterInfo.strNick))
    {
      ...
      localImageView5.setBackgroundResource(2130845799);
      localObject4 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845402);
      ...
      ((TextView)localObject1).setText(amtj.a(2131700855));
      label311:
    ...
    for (;;)
    {
      ...
      default: 
        ...
        if (paramRespEncounterInfo.constellation == 0)
        {
          ...
          {
          default: 
            localImageView4.setImageResource(2130845321);
            if (AppSetting.c) {
              localImageView4.setContentDescription(amtj.a(2131700857));
            }
            label713:
            if (paramRespEncounterInfo.watch_color == 0)
            {
      ...
      for (;;)
      {
        ...
        localObject4 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845402);
        ((TextView)localObject1).setBackgroundDrawable(TroopUtils.getTroopLevelBgDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), -17883, (Drawable)localObject4));
        ((TextView)localObject1).setText(amtj.a(2131700858));
        break label311;
        label860:
        ...
        break label548;
        ((StringBuilder)localObject1).append(" ").append(bfrj.a(paramRespEncounterInfo.constellation));
        break label581;
        label980:
        ((StringBuilder)localObject1).append(" ").append(bfre.e[paramRespEncounterInfo.profession_id]);
        break label597;
        label1003:
        paramView.setVisibility(8);
        break label636;
        localImageView4.setImageResource(2130845323);
        break label696;
        localImageView4.setImageResource(2130845324);
        break label696;
        localImageView4.setImageResource(2130845325);
        break label696;
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject1 = (amsw)((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app.getManager(51);
    if (localObject1 != null) {}
    for (boolean bool = ((amsw)localObject1).b(Long.toString(((RespEncounterInfo)localObject2).lEctID));; bool = false)
    {
      ...
      if (bool)
      {
        ...
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131694033);
        if (!"0".equals(String.valueOf(((RespEncounterInfo)localObject2).cSex))) {
          break label299;
        }
      }
      label299:
      for (localObject1 = String.format((String)localObject1, new Object[] { amtj.a(2131700856) });; localObject1 = String.format((String)localObject1, new Object[] { amtj.a(2131700854) }))
      {
        axhv.a(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app, Long.toString(((RespEncounterInfo)localObject2).lEctID), Long.toString(((RespEncounterInfo)localObject2).lEctID), (String)localObject1, 1001, true, true);
        ...
        localObject2 = axhv.a(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app);
        bcef.b(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).app, "CliOper", "", "", "0X80055FC", "0X80055FC", 0, 0, localObject2[0], (String)localObject1, "", "");
