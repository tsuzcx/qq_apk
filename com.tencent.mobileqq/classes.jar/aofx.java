...
class aofx
  extends Handler
{
  aofx(aofw paramaofw, Looper paramLooper, QQAppInterface paramQQAppInterface)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 1001: 
      ...
      i = paramMessage.arg1;
      this.jdField_a_of_type_Aofw.a(paramMessage.what, i, paramMessage.arg2);
      return;
    case 1000: 
      if (QLog.isColorLevel()) {
    ...
    case 1005: 
      ...
      i = paramMessage.arg1;
      this.jdField_a_of_type_Aofw.a(paramMessage.what, i, paramMessage.arg2);
      this.jdField_a_of_type_Aofw.a.remove(i);
      return;
    case 1004: 
      if (QLog.isColorLevel()) {
        QLog.d("UploadPhoto", 2, "Get Message no task. clientKey= " + paramMessage.arg1 + " arg2=" + paramMessage.arg2);
      }
      this.jdField_a_of_type_Aofw.a(paramMessage.what, paramMessage.arg1, paramMessage.arg2);
      this.jdField_a_of_type_Aofw.a.clear();
      return;
    }
    paramMessage = (Object[])paramMessage.obj;
    int i = ((Integer)paramMessage[0]).intValue();
    aogb localaogb = (aogb)paramMessage[1];
    int j = ((Integer)paramMessage[2]).intValue();
    int k = ((Integer)paramMessage[3]).intValue();
    this.jdField_a_of_type_Aofw.a(localaogb.jdField_a_of_type_Long, j, k);
    this.jdField_a_of_type_Aofw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, localaogb.jdField_a_of_type_JavaLangString, localaogb.jdField_a_of_type_Long, j, k);
  }
}
