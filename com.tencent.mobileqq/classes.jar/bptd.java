...
public class bptd
{
  ...
  private bptg jdField_a_of_type_Bptg = new bptg(null);
  private String jdField_a_of_type_JavaLangString;
  private int jdField_b_of_type_Int;
  private MediaExtractor jdField_b_of_type_AndroidMediaMediaExtractor;
  private String jdField_b_of_type_JavaLangString;
  
  public bptd(String paramString1, String paramString2)
  {
  ...
  {
    int i = 0;
    this.jdField_a_of_type_Bptg.jdField_a_of_type_JavaNioByteBuffer.position(0);
    if (this.jdField_a_of_type_AndroidMediaMediaExtractor.readSampleData(this.jdField_a_of_type_Bptg.jdField_a_of_type_JavaNioByteBuffer, 0) <= 0)
    {
      a();
      i = -5;
    }
    do
    {
      return i;
      this.jdField_a_of_type_Bptg.jdField_a_of_type_JavaNioByteBuffer.position(0);
    } while (this.jdField_b_of_type_AndroidMediaMediaExtractor.readSampleData(this.jdField_a_of_type_Bptg.jdField_a_of_type_JavaNioByteBuffer, 0) > 0);
    a();
    return -6;
  }
  ...
  private static int a(List<String> paramList)
  {
    ...
    //   21: invokestatic 99	bptc:a	(Landroid/content/Context;)Ljava/lang/String;
    //   24: astore 4
    ...
    //   72: aconst_null
    //   73: invokestatic 131	bptd:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   76: aload_0
    //   77: iconst_0
    //   78: aload 4
    ...
    //   125: invokestatic 145	bptc:b	(Landroid/content/Context;)Ljava/lang/String;
    //   128: invokeinterface 148 2 0
    //   133: pop
    //   134: new 150	bptf
    //   137: dup
    //   138: aconst_null
    //   139: invokespecial 151	bptf:<init>	(Lbpte;)V
    //   142: astore 4
    ...
    //   177: aload 4
    //   179: aload_0
    //   180: putfield 171	bptf:a	Ljava/lang/Process;
    //   183: aload 4
    //   185: invokevirtual 172	bptf:a	()V
    //   188: aload_0
    ...
    //   221: aconst_null
    //   222: invokestatic 131	bptd:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   225: aload 4
    //   227: invokevirtual 187	bptf:b	()V
    //   230: iload_2
    //   231: istore_1
    //   232: aload_0
    //   233: ifnull -217 -> 16
    ...
    //   246: ldc 192
    //   248: aload_0
    //   249: invokestatic 131	bptd:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   252: bipush 245
    //   254: ireturn
    //   255: astore 5
    //   257: ldc 192
    //   259: aload 5
    //   261: invokestatic 131	bptd:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   264: goto -71 -> 193
  ...
  {
    int j = new bptd(paramString1, paramString2).a(null, paramInt);
    int i;
    if ((j == -2) || (j == -4) || (j == -6)) {
  ...
  private static int c(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    //   3: invokestatic 99	bptc:a	(Landroid/content/Context;)Ljava/lang/String;
    //   6: astore 6
    ...
    //   56: aconst_null
    //   57: invokestatic 131	bptd:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   60: aload_0
    //   61: iload_3
    //   62: invokestatic 322	bptd:b	(Ljava/lang/String;I)I
    //   65: pop
    ...
    //   219: invokestatic 145	bptc:b	(Landroid/content/Context;)Ljava/lang/String;
    //   222: invokeinterface 148 2 0
    //   227: pop
    //   228: new 150	bptf
    //   231: dup
    //   232: aconst_null
    //   233: invokespecial 151	bptf:<init>	(Lbpte;)V
    //   236: astore_0
    ...
    //   267: aload_0
    //   268: aload_1
    //   269: putfield 171	bptf:a	Ljava/lang/Process;
    //   272: aload_0
    //   273: invokevirtual 172	bptf:a	()V
    //   276: aload_1
    ...
    //   330: aconst_null
    //   331: invokestatic 131	bptd:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   334: aload_0
    //   335: invokevirtual 187	bptf:b	()V
    //   338: aload_1
    //   339: ifnull +7 -> 346
    //   342: aload_1
    ...
    //   352: ldc 192
    //   354: aload_0
    //   355: invokestatic 131	bptd:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   358: bipush 245
    //   360: ireturn
    //   361: astore 5
    //   363: ldc 192
    //   365: aload 5
    //   367: invokestatic 131	bptd:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   370: goto -89 -> 281
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public int a(String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Bptg.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      j = a();
      i = j;
    } while (j != 0);
    if (!a(paramString))
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bptg.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidMediaMediaMuxer.addTrack(localMediaFormat);
      this.jdField_a_of_type_Bptg.jdField_b_of_type_Int = this.jdField_a_of_type_AndroidMediaMediaMuxer.addTrack((MediaFormat)localObject);
      return j;
    }
