...
public class aszh
{
  ...
  aszk jdField_a_of_type_Aszk = new aszk(this);
  List<aszl> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private void a(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    {
      aszl localaszl = (aszl)localIterator.next();
      if (localaszl != null) {
        localaszl.a(paramString, paramBoolean, paramInt);
      }
    }
  ...
  public aszk a()
  {
    return this.jdField_a_of_type_Aszk;
  }
  
  public void a()
  {
    this.jdField_a_of_type_Aszk = new aszk(this);
  }
  
  public void a(AppInterface paramAppInterface, String paramString1, Context paramContext, String paramString2, aszl paramaszl)
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Aszk.b))
    {
      if (paramaszl != null) {
        paramaszl.a(paramString1, true, 0);
      }
      return;
    }
    aszj localaszj = new aszj(this, paramaszl, paramString1);
    ...
    paramString2 = bfms.a(paramContext);
    ...
    for (;;)
    {
      ...
      paramContext = new NewIntent(paramContext, mzx.class);
      ...
      try
      {
        ...
        paramContext.setObserver(localaszj);
      ...
      catch (Exception paramString2)
      {
        for (;;)
        {
          paramaszl.a(paramString1, false, -10001);
        }
      }
    }
  }
  
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, aszl paramaszl, boolean paramBoolean, String paramString5)
  {
    QLog.i("XProxy", 2, "开始拉取A1，uin = " + paramString1 + " appid = " + paramString4);
    if ((this.jdField_a_of_type_Aszk.a != null) && (!paramBoolean) && (System.currentTimeMillis() - this.jdField_a_of_type_Long < 43200000L))
    {
      if (paramaszl != null) {
        paramaszl.a(paramString2, true, 0);
      }
      return true;
    }
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramaszl);
      return true;
    }
    ...
    for (;;)
    {
      this.jdField_a_of_type_OicqWlogin_sdkRequestWtloginHelper.SetListener(new aszi(this, paramString2));
      this.jdField_a_of_type_JavaUtilList.add(paramaszl);
      ...
      {
        paramString5 = bdhe.a(paramString5);
      }
    }
  }
}
