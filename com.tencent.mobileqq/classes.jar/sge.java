...
public class sge
{
  ...
  public sge(String paramString1, String paramString2)
  {
  ...
  private File a(String paramString1, String paramString2)
  {
    ...
    //   36: aload_0
    //   37: invokespecial 68	sge:a	()Ljava/lang/String;
    ...
    //   65: invokestatic 81	sgh:a	(Ljava/io/File;)Z
    //   68: pop
    //   69: aload 6
    ...
    //   125: aload_1
    //   126: aload_3
    //   127: invokestatic 115	sgh:a	(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    //   130: pop2
    //   131: aload_1
    //   132: invokestatic 118	sgh:a	(Ljava/io/Closeable;)V
    //   135: aload_3
    //   136: invokestatic 118	sgh:a	(Ljava/io/Closeable;)V
    //   139: aload 6
    //   141: areturn
    //   142: astore 6
    //   144: aconst_null
    ...
    //   181: aload_1
    //   182: invokestatic 118	sgh:a	(Ljava/io/Closeable;)V
    //   185: aload_3
    //   186: invokestatic 118	sgh:a	(Ljava/io/Closeable;)V
    //   189: aconst_null
    //   190: areturn
    //   191: astore_1
    //   192: aconst_null
    ...
    //   196: astore_3
    //   197: aload 5
    //   199: invokestatic 118	sgh:a	(Ljava/io/Closeable;)V
    //   202: aload_3
    //   203: invokestatic 118	sgh:a	(Ljava/io/Closeable;)V
    //   206: aload_1
    //   207: athrow
    //   208: astore_1
    //   209: aconst_null
  ...
  private String a()
  {
    return jdField_a_of_type_JavaLangString + ors.a() + "/" + this.c + "/" + "styles";
  }
  
  private boolean a()
  {
    if (this.d == null) {}
    while (!this.d.equals(ors.a())) {
      return true;
    }
    return false;
  }
  ...
  public sgf a(boolean paramBoolean)
  {
    Object localObject3;
    Object localObject1;
    if ((paramBoolean) && (this.jdField_a_of_type_Boolean) && (!a()))
    {
      localObject3 = sgf.a(this.jdField_b_of_type_JavaLangString, false);
    ...
    {
      this.d = ors.a();
      localObject1 = new sgf();
      ((sgf)localObject1).a(sfw.a());
      ((sgf)localObject1).b(this.jdField_b_of_type_JavaLangString);
      ((sgf)localObject1).a(3);
      l = System.currentTimeMillis();
      for (;;)
      {
        try
        {
          localObject3 = new sgb(a());
          localObject4 = ((sfz)localObject3).a();
        ...
        catch (OutOfMemoryError localOutOfMemoryError)
        {
          ...
          sgf localsgf = null;
          return localsgf;
          Object localObject5 = sgi.a((InputStream)localObject5);
          a(localsgf, new JSONObject((String)localObject5), false);
        ...
        if (localIterator.hasNext())
        {
          ...
          try
          {
            ...
            localObject5 = ((sfz)localObject3).a((String)localObject4);
  ...
  public void a(sgf paramsgf, JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramsgf.a(str1, str2, (String)localJSONObject.keys().next());
      localProteusParser.createViewTemplate(paramsgf, localJSONObject, null);
