...
public class nlt
  implements bdld, bich
{
  public Context a;
  protected Handler a;
  protected List<qjc> a;
  protected Handler b;
  protected List<qjc> b;
  
  public nlt(Context paramContext)
  {
  ...
  private void a(Activity paramActivity, qjc paramqjc)
  {
    ...
    if ((TextUtils.isEmpty(paramqjc.jdField_c_of_type_JavaLangString)) && (!TextUtils.isEmpty(paramqjc.jdField_b_of_type_JavaLangString))) {
      paramqjc.jdField_c_of_type_JavaLangString = a(paramqjc.jdField_b_of_type_JavaLangString, 0);
    }
    if (TextUtils.isEmpty(paramqjc.jdField_c_of_type_JavaLangString))
    {
      if (paramqjc.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) {
        i = paramqjc.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.progress;
      }
      for (;;)
      {
        a(paramqjc, 6, i);
        return;
        if (paramqjc.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataAdData != null) {
          i = paramqjc.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataAdData.j;
        } else if (paramqjc.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$GameAdComData != null) {
          i = paramqjc.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$GameAdComData.jdField_c_of_type_Int;
        }
      }
    }
    String str1 = paramqjc.d;
    String str2 = paramqjc.jdField_a_of_type_JavaLangString;
    String str3 = paramqjc.jdField_c_of_type_JavaLangString;
    String str4 = paramqjc.e;
    if ((TextUtils.isEmpty(str1)) || (TextUtils.isEmpty(str2)) || (TextUtils.isEmpty(str3)) || (TextUtils.isEmpty(str4)))
    {
      ...
      for (;;)
      {
        ...
        {
          i = j;
          if (paramqjc.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$GameAdComData != null) {
            i = paramqjc.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$GameAdComData.jdField_c_of_type_Int;
          }
        }
      }
    ...
    localBundle.putString(bdlb.l, str4);
    ...
    localBundle.putBoolean(bdlb.J, false);
    localBundle.putString("sendTime", "_" + GlobalUtil.calcMD5AsString(str3));
    if (!TextUtils.isEmpty(paramqjc.f)) {
      localBundle.putString(bdlb.i, paramqjc.f);
    }
    if (QLog.isColorLevel()) {
      QLog.d("ADBaseAppDownloadManager", 2, "startRealDownload pkg:" + str1 + ", appid:" + str2 + ", name:" + str4 + ", url:" + str3);
    }
    if (this.jdField_a_of_type_JavaUtilList.contains(paramqjc)) {
      this.jdField_a_of_type_JavaUtilList.remove(paramqjc);
    }
    this.jdField_a_of_type_JavaUtilList.add(paramqjc);
    bdho.a().a(paramActivity, localBundle, "biz_src_feeds_kandianads", null, 0);
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    do
    {
      ...
      {
        return false;
        paramContext = bdhk.a().c(paramString);
  ...
  public static boolean a(Context paramContext, qjc paramqjc)
  {
    ...
    QLog.d("ADBaseAppDownloadManager", 2, "isPkgExist(" + bool1 + ") pkg:" + str1 + ", appid:" + str2 + ", path:" + paramqjc);
    return bool1;
  ...
  public static boolean a(qjc paramqjc, int paramInt)
  {
    do
    {
      try
      {
        if (!paramqjc.jdField_a_of_type_Boolean) {
          break;
        }
        if (!TextUtils.isEmpty(paramqjc.i)) {
          continue;
        }
        if (TextUtils.isEmpty(paramqjc.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataAdData.Q)) {
          break;
        }
      }
      catch (Exception paramqjc)
      {
        return false;
      }
      if (TextUtils.isEmpty(paramqjc.i)) {}
      for (paramqjc = paramqjc.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataAdData.Q; new File(paramqjc).exists(); paramqjc = paramqjc.i) {
        return true;
      }
  ...
  {
    if (paramqjc.jdField_a_of_type_CooperationWadlIpcWadlParams == null) {
      paramqjc.jdField_a_of_type_CooperationWadlIpcWadlParams = a(paramqjc);
    }
    a(paramqjc);
    bicp.a().a(paramqjc.jdField_a_of_type_CooperationWadlIpcWadlParams);
    if (this.jdField_a_of_type_JavaUtilList.contains(paramqjc)) {
      this.jdField_a_of_type_JavaUtilList.remove(paramqjc);
    }
    this.jdField_a_of_type_JavaUtilList.add(paramqjc);
  ...
  protected WadlParams a(qjc paramqjc)
  {
    WadlParams localWadlParams = new WadlParams(paramqjc.jdField_a_of_type_JavaLangString, paramqjc.d);
    localWadlParams.jdField_c_of_type_Int = 7;
    localWadlParams.jdField_b_of_type_Int = 2;
    localWadlParams.o = (paramqjc.g + "@" + paramqjc.h);
    localWadlParams.jdField_b_of_type_JavaLangString = paramqjc.jdField_c_of_type_JavaLangString;
    localWadlParams.k = paramqjc.e;
  ...
  protected String a(String paramString, int paramInt)
  {
    ...
    //   171: invokevirtual 423	nlt:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   174: astore_1
    //   175: aload_1
    ...
    //   191: invokevirtual 429	nlt:a	(Lorg/json/JSONObject;)Ljava/lang/String;
    //   194: astore_1
    //   195: aload_1
    //   196: astore 4
    //   198: aload_3
  ...
  protected void a(qjc paramqjc) {}
  
  public void a(qjc paramqjc, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ADBaseAppDownloadManager", 2, "startDownload " + paramqjc.d + " progress " + paramInt);
    }
    paramqjc.jdField_a_of_type_Int = 3;
    bdhk.a().a(this);
    a((Activity)this.jdField_a_of_type_AndroidContentContext, paramqjc);
  }
  
  public void a(qjc paramqjc, int paramInt1, int paramInt2) {}
  
  public void a(qjc paramqjc, boolean paramBoolean)
  {
    if ((paramBoolean) && (paramqjc.jdField_a_of_type_CooperationWadlIpcWadlParams == null)) {
      paramqjc.jdField_a_of_type_CooperationWadlIpcWadlParams = a(paramqjc);
    }
    if ((paramqjc.jdField_a_of_type_Boolean) && (paramqjc.jdField_a_of_type_CooperationWadlIpcWadlParams != null)) {
      bicp.a().a(0, paramqjc.jdField_a_of_type_JavaLangString);
    }
    do
    {
      return;
      d(paramqjc);
      paramqjc = paramqjc.jdField_c_of_type_JavaLangString;
    } while (TextUtils.isEmpty(paramqjc));
    bdhk.a().a(paramqjc);
  }
  ...
  {
    if (paramqjc != null) {
      ThreadManager.excute(new ADBaseAppDownloadManager.1(this, paramqjc), 128, null, true);
    }
    return false;
  }
  ...
  public void b(qjc paramqjc)
  {
    ...
    localArrayList.add(paramqjc.jdField_a_of_type_JavaLangString);
    if (!this.jdField_b_of_type_JavaUtilList.contains(paramqjc))
    {
      this.jdField_b_of_type_JavaUtilList.clear();
      this.jdField_b_of_type_JavaUtilList.add(paramqjc);
    }
  ...
  {
    ThreadManager.executeOnSubThread(new ADBaseAppDownloadManager.2(this, paramqjc, paramInt));
  }
  
  public boolean b(qjc paramqjc)
  {
    return true;
  }
  ...
  {
    if ((TextUtils.isEmpty(paramqjc.jdField_c_of_type_JavaLangString)) && (this.jdField_a_of_type_JavaUtilList.size() > 0) && (paramqjc.b()))
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        qjc localqjc = (qjc)localIterator.next();
        if ((localqjc.b()) && (!TextUtils.isEmpty(localqjc.jdField_c_of_type_JavaLangString)) && (paramqjc.a(localqjc))) {
          paramqjc.jdField_c_of_type_JavaLangString = localqjc.jdField_c_of_type_JavaLangString;
        }
      }
    }
  }
  
  public void e(qjc paramqjc)
  {
    if (paramqjc.jdField_a_of_type_CooperationWadlIpcWadlParams == null) {
      paramqjc.jdField_a_of_type_CooperationWadlIpcWadlParams = a(paramqjc);
    }
    bicp.a().b(paramqjc.jdField_a_of_type_CooperationWadlIpcWadlParams);
  }
  ...
  public void onQueryCallback(ArrayList<WadlResult> paramArrayList)
  {
    ...
    {
      a(new WadlResult(((qjc)paramArrayList.next()).jdField_a_of_type_CooperationWadlIpcWadlParams), 8);
      continue;
