  ...
  implements Handler.Callback
{
  ...
  public static azjg a()
  {
    if (QLog.isColorLevel()) {
      QLog.i("AutoMonitor", 2, "onApplicationCreate ");
    }
    azjg localazjg = new azjg();
    localazjg.a(0);
    azkw.b(0, localazjg, jdField_b_of_type_ArrayOfInt).step();
    ...
    jdField_a_of_type_Boolean = false;
    azkw.b(12, localazjg, null).step();
    if (BaseApplicationImpl.sProcessId == 2)
    {
      azkw.b(10, localazjg, null).step();
      azkw.b(39, localazjg, null).step();
      ThreadManager.post(azkw.b(0, localazjg, l), 10, null, false);
      azkw.b(0, localazjg, jdField_k_of_type_ArrayOfInt).step();
    }
    for (;;)
    {
      return null;
      ...
      {
        azkw.b(0, localazjg, r).step();
      }
      else if ((BaseApplicationImpl.sProcessId == 5) || (BaseApplicationImpl.sProcessId == 7))
      {
        azkw.b(10, localazjg, null).step();
        azkw.b(7, localazjg, null).step();
        azkw.b(0, localazjg, jdField_i_of_type_ArrayOfInt).step();
        azkw.b(11, localazjg, null).step();
        azkw.b(46, localazjg, null).step();
        if (BaseApplicationImpl.sProcessId == 7) {
          azkw.b(48, localazjg, null).step();
        }
      }
      ...
      else if (!BaseApplicationImpl.processName.endsWith(":qqfav"))
      {
        ...
        {
          ThreadManager.excute(azkw.b(0, localazjg, jdField_a_of_type_ArrayOfInt), 16, null, false);
        }
        else
        {
    ...
    if (BaseApplicationImpl.processName.endsWith(":troopbar"))
    {
      azkw.b(11, localazjg, null).step();
      azkw.b(10, localazjg, null).step();
      azkw.b(13, localazjg, null).step();
    }
    for (;;)
    {
      if (BaseApplicationImpl.processName.endsWith(":troophomework")) {
        azkw.b(37, localazjg, null).step();
      }
      if (!BaseApplicationImpl.processName.endsWith(":live")) {
        break;
      }
      azkw.b(47, localazjg, null).step();
      break;
      azkw.b(0, localazjg, jdField_j_of_type_ArrayOfInt).step();
    }
  }
        ...
        if (!str1.isEmpty())
        {
          ...
          if (arrayOfString.length > 0)
          {
            ...
            if (i1 < i3)
            {
              ...
              amcr.jdField_a_of_type_JavaUtilSet.add(Integer.valueOf(Integer.parseInt(str2)));
              i1 += 1;
              continue;
            }
          }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ThreadManager.getSubThreadHandler().postAtFrontOfQueue(azkw.b(9, this, null));
      if (jdField_a_of_type_Int == 1) {
        ThreadManager.getSubThreadHandler().post(azkw.b(21, this, null));
      }
    }
    ...
    if (paramBoolean)
    {
      ...
      if ((BaseApplicationImpl.sShowTime <= 0L) || (!bdee.g(BaseApplicationImpl.sApplication))) {
        break label314;
      }
    }
    label314:
  ...
  private void a(int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt)
  {
    ...
    paramArrayOfInt1 = azkw.b(0, this, paramArrayOfInt1);
    if (paramArrayOfInt2 != null)
    {
      this.jdField_f_of_type_Int = 2;
      this.jdField_g_of_type_Int = paramInt;
      paramArrayOfInt1.setResultListener(this.jdField_b_of_type_AndroidOsHandler, 10);
      paramArrayOfInt2 = azkw.b(0, this, paramArrayOfInt2);
  ...
  private void b(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {
      localTextView.setText(2131693683);
    }
    for (;;)
    {
      ...
      return;
      localTextView.setText(alpo.a(2131714730));
    }
  }
  ...
  public void a(azjh paramazjh)
  {
    this.jdField_a_of_type_Azjh = paramazjh;
  }
  ...
  public void a(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission == null) {
        this.jdField_a_of_type_ComTencentMobileqqStartupStepCheckPermission = ((CheckPermission)azkw.b(3, this, null));
      }
    ...
    if (this.jdField_e_of_type_Int == 2)
    {
      if (1 == BaseApplicationImpl.sProcessId) {
        ThreadManager.getFileThreadHandler().postDelayed(azkw.b(13, this, null), 1000L);
      }
      a(11, 1, 5L);
      a(3);
    }
    ...
    for (paramObject = (AppActivity)paramObject;; paramObject = null)
    {
      ...
      if (paramObject == null)
      {
        ...
        if (this.jdField_e_of_type_Int == 1)
        {
          ...
          {
            paramObject = o;
            azkw.b(0, this, paramObject).step();
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramIntent = (SetSplash)azkw.b(2, this, null);
          paramIntent.step();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      for (;;)
      {
        return true;
        a(4, 0, 300L);
        bool1 = azkw.b(12, this, null).step();
        ...
        if (this.jdField_a_of_type_MqqAppAppActivity != null)
        {
          ...
          if (this.jdField_a_of_type_MqqAppAppActivity != null)
          {
            bdix.a(this.jdField_a_of_type_MqqAppAppActivity, "com.tencent.mobileqq.activity.MainActivity");
            bdix.a(this.jdField_a_of_type_MqqAppAppActivity, SplashActivity.class.getName());
            return true;
            ...
            this.jdField_a_of_type_Azjh.a(this);
            if (this.jdField_a_of_type_Long > 0L) {
      ...
      azkw.b(28, this, null).step();
      return true;
    } while (this.jdField_a_of_type_Azjh.jdField_a_of_type_Boolean);
