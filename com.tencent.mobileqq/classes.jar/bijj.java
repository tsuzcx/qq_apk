  ...
  extends AccountObserver
{
  ...
  bijj(Intent paramIntent, String paramString, bijl parambijl)
  {
  ...
  public void onRegisterCommitPassRespWithLhSig(boolean paramBoolean, int paramInt, String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString = BaseApplicationImpl.getContext().getString(2131715879);
        ...
        if (QLog.isDevelopLevel()) {
          bijm.a("LHLoginMng -- onRegisterCommitPassRespWithLhSig", localIntent);
        }
        if (this.jdField_a_of_type_Bijl != null) {
          this.jdField_a_of_type_Bijl.a(localIntent, paramBoolean, this.jdField_a_of_type_JavaLangString, paramArrayOfByte3, paramString);
        }
