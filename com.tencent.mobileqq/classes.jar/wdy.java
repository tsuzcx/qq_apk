  ...
  extends wdw
{
  ...
  public wdy(PublishVideoEntry paramPublishVideoEntry)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Wlh = a().getLinkInfo();
  ...
  public wdy(StoryVideoItem paramStoryVideoItem)
  {
    ...
    this.jdField_a_of_type_Wlh = wlh.a(paramStoryVideoItem.mLinkInfoJson);
  ...
  private int a()
  {
    ...
    if ((arrayOfByte != null) && (arrayOfByte.length > 0))
    {
      ...
      try
      {
        ...
        int i1 = new vzs(localAppInterface, localVideoReaderConf).jdField_a_of_type_Int;
        return i1;
      }
  ...
  private zbe a()
  {
    ...
    if ((localObject != null) && (localObject.length > 0))
    {
      ...
      try
      {
        ...
        localObject = new zbe(localTagInfoBase);
        return localObject;
      }
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
      {
  ...
  public StoryVideoItem a()
  {
    ...
    if (TextUtils.isEmpty(localStoryVideoItem.mPublishDate)) {
      localStoryVideoItem.mPublishDate = yck.a().format(new Date(this.jdField_d_of_type_Long));
    }
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      if (this.jdField_a_of_type_Wlh != null) {
        localStoryVideoItem.mLinkInfoJson = this.jdField_a_of_type_Wlh.a(false);
      }
      localStoryVideoItem.mGameInfoJson = a().getStringExtra("game", null);
      localStoryVideoItem.mGameInfo = wlf.a(localStoryVideoItem.mGameInfoJson);
  ...
  public GeneralFeedItem a()
  {
    ...
    String str2 = localyck.a(QQStoryContext.a().b(), str3);
    ykq.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "find true feedId:%s", str2);
    String str1 = str2;
    if (TextUtils.isEmpty(str2))
    {
      str1 = VideoListFeedItem.makeFakeFeedId(QQStoryContext.a().b(), str3);
      ykq.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "make fake feedId:%s", str1);
    }
    this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem = ((GeneralFeedItem)localyck.a(str1));
    if (this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem == null)
    {
      this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem = GeneralFeedItem.createFakeFeedItem(str3);
      localyck.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem);
      ykq.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "save fake item %s", this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem.feedId);
    }
    return this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem;
  }
  ...
  public wlj a()
  {
    ...
    if ((this.jdField_a_of_type_Wlj == null) && (a().spreadGroupBytes != null) && (a().spreadGroupBytes.length > 0)) {
      localVideoSpreadGroupList = new qqstory_struct.VideoSpreadGroupList();
    }
    try
    {
      localVideoSpreadGroupList.mergeFrom(a().spreadGroupBytes);
      this.jdField_a_of_type_Wlj = new wlj(localVideoSpreadGroupList);
    ...
    catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
    {
      for (;;)
      {
        ykq.b("Q.qqstory.publish.upload:StoryVideoUploadManager", "decode spread group fail", localInvalidProtocolBufferMicroException);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    ((yck)wjs.a(11)).a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelGeneralFeedItem);
  }
