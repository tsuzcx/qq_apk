  ...
  extends MessageMicro<HightlightParam>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 50, 56, 66, 74, 82 }, new String[] { "start", "end", "uin", "needUpdateNick", "actionType", "icon", "textColor", "mMsgActionData", "mMsg_A_ActionData", "iconAlt" }, new Object[] { localInteger, localInteger, Long.valueOf(0L), localInteger, localInteger, "", localInteger, "", "", "" }, HightlightParam.class);
  }
}
