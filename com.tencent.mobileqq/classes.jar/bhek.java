...
{
  public static final bhek a = new bhek();
  ...
  public final Integer a(@NotNull String paramString)
  {
    ...
    if ((!TextUtils.isEmpty((CharSequence)paramString)) && (StringsKt.contains$default((CharSequence)paramString, (CharSequence)"?", false, 2, null)))
    {
      ...
      paramString = biqd.a(((String[])paramString)[1]);
  ...
  public final void a(@NotNull GetWatchWordShareRsp paramGetWatchWordShareRsp)
  {
    ...
    localObject = new bheo((ViewGroup)localObject, str1, str2, (Function1)new VasWatchWord.showContentDialog.jumpDialog.1(paramGetWatchWordShareRsp, i));
    str1 = paramGetWatchWordShareRsp.itemmsg;
    Intrinsics.checkExpressionValueIsNotNull(str1, "rsp.itemmsg");
    ((bheo)localObject).a(str1);
    ...
    ((bheo)localObject).a(j, paramGetWatchWordShareRsp);
    ((bheo)localObject).a();
    bcst.b(null, "dc00898", "", "", "qq_vip", "0X800AF79", i, 0, "", "", "", "");
  }
  ...
  public final void a(@Nullable Context paramContext, @NotNull String paramString)
  {
    ...
    paramString = biqd.a(((String[])paramContext)[1]);
    ...
    bcst.b(null, "dc00898", "", "", "qq_vip", "0X800AF78", Integer.parseInt(paramString), 0, paramContext, "", "", "");
    Object localObject = bhcy.a(bhda.class);
    if (localObject == null) {
      throw new TypeCastException("null cannot be cast to non-null type com.tencent.mobileqq.vas.remote.IWatchWordProtocol");
    }
    ((bhcx)localObject).a(paramString, paramContext, null, -1, (EIPCResultCallback)new bhen(paramString, paramContext));
  }
  ...
  public final void c(@NotNull Context paramContext, @NotNull String paramString)
  {
    ...
    bglp.a(paramContext, 230, paramContext.getString(2131719123), (CharSequence)paramString, null, paramContext.getString(2131719122), (DialogInterface.OnClickListener)new bgmc(), null).show();
  }
}
