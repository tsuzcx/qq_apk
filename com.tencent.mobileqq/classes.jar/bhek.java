  ...
  extends QIMEffectCameraCaptureUnit
{
  ...
  public bhek(bhzc parambhzc, bhzb parambhzb)
  {
    super(parambhzc, parambhzb);
    this.jdField_a_of_type_Bhyu = new bhyu(10004, 8, 2);
  ...
  private void b(Activity paramActivity)
  {
    ...
    bfpr.c(paramActivity, localAppRuntime.getAccount(), localIntent, -1);
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!(localObject1 instanceof ahhl)) {
          break label564;
        }
        localObject1 = (ahhl)localObject1;
        ((ahhl)localObject1).c_((String)localObject2);
        ...
        bhez.a(this.jdField_a_of_type_Bhzc.a(), paramIntent, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult, this.jdField_a_of_type_Bhzb, null, (ahhl)localObject1, (String)localObject2, 1, null, bool, null, false);
      ...
      {
        bhez.a(this.jdField_a_of_type_Bhzc.a(), paramIntent, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView$VideoCaptureResult, this.jdField_a_of_type_Bhzb, new bhel(this, localActivity, paramIntent));
        continue;
        if ((paramInt2 == -1) && (paramIntent != null))
        {
          localObject1 = this.jdField_a_of_type_Bhzc.a();
          paramInt1 = paramIntent.getIntExtra("forward_to_someplace_from_shoot_quick", 0);
          if (paramInt1 == 1002)
          {
        ...
        if ((bool) || (paramIntent != null) || (!(this.jdField_a_of_type_Bhzc.a() instanceof SplashActivity))) {
          break;
        }
        if (this.jdField_a_of_type_Bhff != null)
        {
  ...
  {
    super.a(paramauuy);
    bhyv localbhyv = new bhyx(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a()).a(2).b(101).a();
  ...
  public void a(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    bhyy localbhyy = new bhza().a(101).b(2).a();
