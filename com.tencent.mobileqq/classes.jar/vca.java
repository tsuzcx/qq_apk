  ...
  extends vbx
{
  ...
  public vca(@NonNull String paramString)
  {
    super(paramString);
  ...
  public String a(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return ((vcb)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaLangString;
    }
  ...
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return ((vcb)this.jdField_a_of_type_JavaUtilList.get(paramInt)).b;
    }
