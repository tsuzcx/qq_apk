...
public class ajlp
{
  private static ajlp jdField_a_of_type_Ajlp;
  private ajlr jdField_a_of_type_Ajlr = new ajlr(this, null);
  private ajlt jdField_a_of_type_Ajlt;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(new ajlq(this));
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  private ajlp(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.registObserver(this.jdField_a_of_type_Ajlr);
    }
  }
  
  public static ajlp a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Ajlp == null) {
      jdField_a_of_type_Ajlp = new ajlp(paramAppInterface);
    }
    return jdField_a_of_type_Ajlp;
  }
  ...
  public static void a()
  {
    if (jdField_a_of_type_Ajlp != null)
    {
      jdField_a_of_type_Ajlp.b();
      jdField_a_of_type_Ajlp = null;
    }
  }
  ...
  private void a(boolean paramBoolean, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Ajlt != null)
    {
      Object localObject = paramArrayList;
      if (paramArrayList == null) {
        localObject = new ArrayList(1);
      }
      this.jdField_a_of_type_Ajlt.a(paramInt, paramBoolean, (ArrayList)localObject);
    }
  }
  ...
  private void b()
  {
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.unRegistObserver(this.jdField_a_of_type_Ajlr);
      this.jdField_a_of_type_ComTencentCommonAppAppInterface = null;
    }
    this.jdField_a_of_type_Ajlt = null;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool2)
        {
          ...
          SosoInterface.a(new ajls(this, 0, true, true, 30000L, false, false, "NewFlowCameraActivity", paramInt));
        }
        if (this.jdField_a_of_type_Ajlt != null) {
          this.jdField_a_of_type_Ajlt.a(paramInt, bool2);
        }
        return;
      }
  ...
  {
    this.jdField_a_of_type_Ajlt = paramajlt;
  }
}
