...
{
  public vjp(AIOGalleryScene paramAIOGalleryScene, ActionSheet paramActionSheet, AIOFilePicData paramAIOFilePicData, File paramFile) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    if (paramView.equals(AIOGalleryScene.af(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryScene).getResources().getString(2131435854))) {
    ...
    for (;;)
    {
      ...
      else if (paramView.equals(AIOGalleryScene.ao(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryScene).getResources().getString(2131435860)))
      {
      ...
      else if (paramView.equals(AIOGalleryScene.aq(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryScene).getResources().getString(2131435858)))
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryScene.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoIAIOImageProvider.asBinder().pingBinder()) {
      ...
      else if (paramView.equals(AIOGalleryScene.ar(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryScene).getResources().getString(2131435865)))
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryScene.s();
      }
      else if (paramView.equals(AIOGalleryScene.as(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryScene).getResources().getString(2131435866)))
      {
      ...
      else if (paramView.equals(AIOGalleryScene.au(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryScene).getResources().getString(2131435857)))
      {
