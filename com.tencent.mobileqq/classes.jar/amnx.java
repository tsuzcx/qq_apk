  ...
  extends WebViewPlugin
{
  ...
  private final BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new amny(this);
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  private EIPCResultCallback jdField_a_of_type_EipcEIPCResultCallback = new amnz(this);
  ...
  private void c(Bundle paramBundle)
  {
    ...
    if (paramBundle.isSuccess())
    {
      ...
      localaymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne = paramBundle;
      localaymg.jdField_a_of_type_ComTencentMobileqqDataCard = new Card();
      localaymg.jdField_a_of_type_ComTencentMobileqqDataCard.uin = AppConstants.BABY_Q_UIN;
      FriendProfileCardActivity.a(this.mRuntime.a(), localaymg, AppConstants.BABY_Q_UIN, 0, paramBundle.h);
    }
  }
  ...
  {
    amod.a().a(paramString, paramBundle, this.jdField_a_of_type_EipcEIPCResultCallback);
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (paramString3.equals("reportFriend"))
    {
      ...
      if (paramJsBridgeListener.isSuccess())
      {
        ...
        aabc.a((BaseActivity)this.mRuntime.a(), AppConstants.BABY_Q_UIN, null, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), 21001, paramJsBridgeListener);
      }
      return true;
    }
