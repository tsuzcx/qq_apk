...
{
  public yfp(PhoneContactSelectActivity paramPhoneContactSelectActivity) {}
  
  public void onClick(View paramView)
  {
    if (!NetworkUtil.d(this.a))
    {
      QQToast.a(this.a, this.a.getString(2131433023), 0).b(this.a.c.getHeight());
      return;
    }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        {
          paramView = this.a.app.getApplication().getResources().getString(2131438431);
          localObject = this.a.app.getApplication().getResources().getString(2131438432);
          ...
          for (;;)
          {
            DialogUtil.a(this.a, 230, "确认呼叫方式", paramView, (String)localObject, "取消", "呼叫", null, new yfq(this, localPstnManager), new yfr(this)).show();
            return;
            paramView = str2;
            break;
            label369:
        ...
        if (this.a.e == 1005)
        {
          DialogUtil.a(this.a, 230, this.a.getResources().getString(2131429579), this.a.getResources().getString(2131429580), this.a.getResources().getString(2131429581), this.a.getResources().getString(2131429582), new yfs(this), new yft(this)).show();
          return;
        }
        this.a.a();
        return;
