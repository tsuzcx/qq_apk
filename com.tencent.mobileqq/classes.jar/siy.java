  ...
  implements View.OnClickListener
{
  ...
  private siy(Context paramContext, int paramInt1, int paramInt2)
  {
    this(paramContext, 2131755901, paramInt1, paramInt2);
  }
  
  private siy(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      snb.b("RichBlockDialog", 2, "ScrollMoreDialog() window == null.");
      return;
    }
    paramContext = paramContext.getAttributes();
    if (paramContext == null)
    {
      snb.b("RichBlockDialog", 2, "ScrollMoreDialog() params == null.");
      return;
    }
  ...
  private void a(int paramInt)
  {
    ...
    {
      snb.a("RichBlockDialog", 1, "点击时间小于1.5秒，不做响应");
      return;
    }
    ...
    {
      smp.c(112, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.type, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.windowsid);
      smn.a(112, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.windowsid);
      ...
      snf.a(this.jdField_a_of_type_AndroidContentContext, (String)localObject2, str, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.type, new siz(this, (Context)localObject1));
    }
    e();
  }
  ...
  private void a(URLDrawable paramURLDrawable, String paramString, ImageView paramImageView)
  {
    ...
    for (;;)
    {
      ...
      show();
      smp.c(6, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.type, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.windowsid);
      smn.a(6, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.windowsid);
      WSPublicAccReport.getInstance().reportExposeRichBlockPop(this.jdField_a_of_type_UserGrowthStPopWindowsConfig.windowsid);
      a();
      snb.a("813", "onLoadSuccessed - " + paramString);
      return;
      label275:
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2131562208, null, false);
    setContentView(this.jdField_a_of_type_AndroidViewView);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374651));
    this.jdField_a_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.FIT_XY);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374655));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374652));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374654));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374653));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374649));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374648));
    this.f = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374656));
  ...
  private void d()
  {
    if ((this.jdField_a_of_type_UserGrowthStPopWindowsConfig != null) && (this.jdField_a_of_type_UserGrowthStPopWindowsConfig.type != 1))
    {
      ...
      snb.a("weishi-813", "展示图片");
      return;
    }
    snb.a("weishi-813", "展示红包");
  }
  ...
  public void a(stGlobalConfig paramstGlobalConfig)
  {
    ...
    if (paramstGlobalConfig != null)
    {
      ...
      snb.a("weishi-813", "阻断页rich化 type是：" + paramstGlobalConfig.type);
    }
    for (;;)
    {
      d();
      ...
      break;
      label117:
      snb.a("weishi-813", "阻断页rich化 windowsConfig为null");
      continue;
      label129:
      snb.c("weishi-813", "瀑布流阻断页rich化 windowsConfig size为0");
    }
  }
  ...
  public void a(Context paramContext, int paramInt)
  {
    ...
    {
      snb.a("RichBlockDialog", "813不支持瀑布流红包和动图弹窗");
      return;
    }
    if (!TextUtils.isEmpty(this.jdField_a_of_type_UserGrowthStPopWindowsConfig.bg_img_url))
    {
      paramContext = getContext().getResources().getDrawable(2130841259);
      a(this.jdField_a_of_type_AndroidWidgetImageView, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.bg_img_url, paramContext, paramContext, ajya.a(2131713455));
      return;
    }
    e();
  }
  ...
  public void a(ImageView paramImageView, String paramString1, Drawable paramDrawable1, Drawable paramDrawable2, String paramString2)
  {
    ...
    paramString1.setURLDrawableListener(new sja(this, paramString2, paramImageView));
  ...
  public void dismiss()
  {
    snb.b("RichBlockDialog", 2, "dismiss()");
    try
    {
      this.jdField_a_of_type_Boolean = false;
      super.dismiss();
    ...
    {
      snb.d("RichBlockDialog", 2, localException.getLocalizedMessage());
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    smp.c(117, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.type, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.windowsid);
    smn.a(117, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, this.jdField_a_of_type_UserGrowthStPopWindowsConfig.windowsid);
    ...
    return;
    snb.a("weishi-813", "点击了图片 背景图");
    a(2);
  }
  
  public void show()
  {
    snb.b("RichBlockDialog", 2, "show()");
    try
    {
      super.show();
