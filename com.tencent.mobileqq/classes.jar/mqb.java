...
public class mqb
{
  ...
  public static Intent a(Context paramContext, Intent paramIntent, String paramString, boolean paramBoolean1, int paramInt1, boolean paramBoolean2, int paramInt2)
  {
    try
    {
      bool = ((bcpn)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(165)).c(paramString, false);
      if (bool) {
        if (paramIntent == null)
        {
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      ...
      {
        paramQQAppInterface = ((ajjj)paramQQAppInterface.getManager(51)).b(paramString);
        if (paramQQAppInterface == null) {
          break label189;
        }
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        ...
        if (paramQQAppInterface != null)
        {
          paramQQAppInterface = ((ajhq)paramQQAppInterface).a(paramString);
          if (paramQQAppInterface != null) {
  ...
  private static void a(int paramInt, bbms parambbms)
  {
    b(paramInt, parambbms);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      if ((lbk.c()) && (lbk.d()))
      {
        ...
        localbegr.a(new mqe(localbegr, paramQQAppInterface, paramContext, paramSessionInfo));
        localbegr.show();
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    if (bcpn.b(paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString)) {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        localObject = ((ajoy)localObject).c(paramSessionInfo.jdField_a_of_type_JavaLangString);
        if (localObject == null)
        {
          localObject = (ajhq)paramQQAppInterface.getManager(69);
          if (localObject != null)
          {
            localObject = ((ajhq)localObject).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
            if (localObject == null)
            {
              if (QLog.isDevelopLevel()) {
              ...
              if ((paramContext instanceof Activity)) {
                localbbms = new bbms(paramContext, paramContext.getResources().getDimensionPixelSize(2131167766));
              }
              if (localbbms != null) {
              ...
              localObject = new NewIntent(paramContext.getApplicationContext(), mmi.class);
      ...
      try
      {
        ...
        ((NewIntent)localObject).setObserver(new mqc(paramContext, paramQQAppInterface, localbbms, paramSessionInfo, paramString));
        ...
        return;
        a(paramContext, 2131629887);
        awqx.b(paramQQAppInterface, "CliOper", "", "", "0X80049DF", "GetDetailFalse", 0, 0, "", "", "", "");
        return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt, BusinessObserver paramBusinessObserver)
  {
    ...
    {
      paramContext = new NewIntent(paramContext.getApplicationContext(), mmi.class);
  ...
  {
    if ((paramQQAppInterface != null) && (mnz.a(paramString)) && (mnz.b(paramString)))
    {
  ...
  public static String b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      str = bcpn.a(paramQQAppInterface, paramString);
    }
    label25:
    do
    {
  ...
  private static void b(int paramInt, bbms parambbms)
  {
    if (parambbms != null)
    {
      parambbms.c(paramInt);
      parambbms.show();
    }
  }
  
  private static void b(bbms parambbms)
  {
  ...
  private static void b(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, PublicAccountInfo paramPublicAccountInfo, EqqDetail paramEqqDetail, String paramString)
  {
    ...
    for (;;)
    {
      if (bool)
      {
        ...
        if ((paramContext instanceof Activity)) {
          paramPublicAccountInfo = new bbms(paramContext, paramContext.getResources().getDimensionPixelSize(2131167766));
        }
        if (paramPublicAccountInfo != null) {
          paramPublicAccountInfo.setCanceledOnTouchOutside(true);
        }
        NewIntent localNewIntent = new NewIntent(paramContext.getApplicationContext(), ndt.class);
        ...
        localNewIntent.setObserver(new mqd(paramContext, paramQQAppInterface, paramPublicAccountInfo, paramEqqDetail, paramSessionInfo, paramString));
        paramQQAppInterface.startServlet(localNewIntent);
      }
      try
      {
        if (((paramContext instanceof Activity)) && (!((Activity)paramContext).isFinishing())) {
          a(2131629938, paramPublicAccountInfo);
        }
        label257:
        if (QLog.isColorLevel()) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2)
  {
    ...
    {
      new bbne(paramContext).a(2131627817, paramContext.getResources().getDimensionPixelSize(2131167766), 0, 1);
      return;
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, EqqDetail paramEqqDetail)
  {
    ...
    ajhq localajhq = (ajhq)paramQQAppInterface.getManager(69);
    if (localajhq != null) {
      localajhq.a(paramEqqDetail);
    }
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    for (boolean bool1 = false;; bool1 = false)
    {
      ...
      if ((localObject != null) && (((ajhq)localObject).a(paramString) != null))
      {
        if (QLog.isColorLevel()) {
  ...
  private static void c(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    {
      if (i == 0) {
        awqx.b(paramQQAppInterface, "CliOper", "", "", "0X8004628", "0X8004628", 0, 0, "", "", "", "");
      }
      if (paramSessionInfo.jdField_a_of_type_Int != 1008) {
        paramSessionInfo.jdField_a_of_type_Int = 1024;
      }
      acnc.a(paramQQAppInterface, paramContext, paramSessionInfo, true, paramString, null);
      return;
    }
  }
  ...
  {
    if (!((ajjj)paramQQAppInterface.getManager(51)).b(paramString2)) {}
    for (;;)
    {
      return;
      try
      {
        ...
        {
          ((bcqv)paramQQAppInterface.a(85)).a(Long.valueOf(paramString1).longValue(), Long.valueOf(paramString2).longValue());
          return;
        }
      }
      catch (Exception paramQQAppInterface)
  ...
  private static boolean c(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if (paramInt == 1024)
    {
      ...
      {
        if (((ajoy)localManager).c(paramString) != null) {}
        for (bool1 = true;; bool1 = true)
        {
          ...
          if (((ajhq)paramQQAppInterface).a(paramString) == null) {
            break label157;
          }
        }
        label157:
