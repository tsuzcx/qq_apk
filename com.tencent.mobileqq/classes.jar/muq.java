  ...
  extends BusinessHandler
{
  ...
  public muq(QQAppInterface paramQQAppInterface)
  {
  ...
  private msg_svc.PbSendMsgReq a(int paramInt1, String paramString, bbln parambbln, long paramLong1, int paramInt2, long paramLong2)
  {
    return bblf.a(this.app, paramInt1, paramString, parambbln, paramLong1, paramInt2);
  }
  ...
  public ToServiceMsg a(long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    paramLong1 = aszt.b();
    long l = aszt.a();
    Object localObject = new bbln();
    ((bbln)localObject).jdField_a_of_type_Int = paramInt2;
    ((bbln)localObject).jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    paramString = a(13, paramString, (bbln)localObject, l, bblk.b(paramLong1), paramLong2);
