...
public class bizk
  implements bizg, bizi
{
  private static int jdField_a_of_type_Int = 1;
  private bizh jdField_a_of_type_Bizh;
  private String jdField_a_of_type_JavaLangString;
  private Map<Integer, bizl> jdField_a_of_type_JavaUtilMap;
  private int b;
  private int c = 65535;
  private int d = 0;
  
  public bizk(bizh parambizh)
  {
    bize localbize = parambizh.jdField_a_of_type_Bize;
    if (localbize != null) {
      localbize.setNetTransportEventListener("intchk", this);
    }
  ...
  private intchk.AppInfo a()
  {
    ...
    String str = this.jdField_a_of_type_Bizh.jdField_a_of_type_AndroidContentContext.getPackageName();
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      ...
      switch (bizo.a(this.jdField_a_of_type_Bizh.jdField_a_of_type_AndroidContentContext))
      {
      default: 
        i = 5;
      }
    ...
    for (;;)
    {
      str = bizo.a(this.jdField_a_of_type_Bizh.jdField_a_of_type_AndroidContentContext);
      int j = i;
      if (str != null)
      {
        j = i;
            ...
            for (i = paramRspBody.uint32_intchk_id.get();; i = 0)
            {
              ...
              for (int j = paramRspBody.uint32_check_item_id.get();; j = 0)
              {
                ...
                for (int k = paramRspBody.uint32_check_type.get();; k = 1)
                {
                  ...
                  localObject2 = this.jdField_a_of_type_Bizh.jdField_a_of_type_Bize;
                  if (localObject2 == null) {
                    break;
                  }
                  Object localObject1 = paramRspBody.toByteArray();
                  localObject3 = ((bize)localObject2).getCodec("intchk");
                  paramRspBody = (intchk.RspBody)localObject1;
                  if (localObject3 != null) {
                    paramRspBody = ((bizf)localObject3).encode(localObject1);
                  }
                  ((bize)localObject2).send(paramRspBody);
                  return;
                }
              }
            }
  ...
  private void c(String paramString)
  {
    ...
    //   1: astore_2
    //   2: aload_1
    //   3: invokevirtual 268	java/lang/String:trim	()Ljava/lang/String;
    //   6: invokestatic 92	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   9: ifeq +4 -> 13
    //   12: return
    //   13: invokestatic 316	javax/xml/parsers/DocumentBuilderFactory:newInstance	()Ljavax/xml/parsers/DocumentBuilderFactory;
    //   16: astore_3
    //   17: aload_3
    //   18: invokevirtual 320	javax/xml/parsers/DocumentBuilderFactory:newDocumentBuilder	()Ljavax/xml/parsers/DocumentBuilder;
    //   21: new 322	java/io/ByteArrayInputStream
    //   24: dup
    //   25: aload_1
    //   26: invokevirtual 325	java/lang/String:getBytes	()[B
    //   29: invokespecial 328	java/io/ByteArrayInputStream:<init>	([B)V
    //   32: invokevirtual 334	javax/xml/parsers/DocumentBuilder:parse	(Ljava/io/InputStream;)Lorg/w3c/dom/Document;
    //   35: invokeinterface 340 1 0
    //   40: astore_3
    //   41: aload_0
    //   42: iconst_0
    //   43: putfield 29	bizk:c	I
    //   46: aload_3
    //   47: ldc_w 342
    //   50: invokeinterface 348 2 0
    //   55: astore_1
    //   56: aload_1
    //   57: invokevirtual 268	java/lang/String:trim	()Ljava/lang/String;
    //   60: invokevirtual 351	java/lang/String:length	()I
    //   63: ifle +11 -> 74
    //   66: aload_0
    //   67: aload_1
    //   68: invokestatic 357	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   71: putfield 29	bizk:c	I
    //   74: aload_0
    //   75: getfield 29	bizk:c	I
    //   78: tableswitch	default:+345 -> 423, 1:+26->104, 2:+161->239, 3:+216->294
    //   105: getfield 359	bizk:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   108: ifnull -96 -> 12
    //   111: aload_0
    //   112: getfield 359	bizk:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   115: iconst_1
    //   116: invokestatic 363	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   119: invokeinterface 369 2 0
    //   124: ifeq +294 -> 418
    //   127: aload_0
    //   128: getfield 359	bizk:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   131: iconst_1
    //   132: invokestatic 363	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   135: invokeinterface 371 2 0
    //   140: checkcast 373	bizl
    //   143: astore_1
    //   144: aload_1
    //   145: ifnull -133 -> 12
    ...
    //   236: goto -29 -> 207
    //   239: aload_0
    //   240: getfield 359	bizk:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   243: ifnull -231 -> 12
    //   246: aload_2
    //   247: astore_1
    //   248: aload_0
    //   249: getfield 359	bizk:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   252: iconst_2
    //   253: invokestatic 363	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   256: invokeinterface 369 2 0
    //   261: ifeq +20 -> 281
    //   264: aload_0
    //   265: getfield 359	bizk:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   268: iconst_2
    //   269: invokestatic 363	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   272: invokeinterface 371 2 0
    //   277: checkcast 373	bizl
    //   280: astore_1
    //   281: aload_1
    //   282: ifnull -270 -> 12
    //   285: aload_1
    ...
    //   293: return
    //   294: aload_0
    //   295: getfield 359	bizk:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   298: ifnull -286 -> 12
    //   301: aload_0
    //   302: getfield 359	bizk:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   305: iconst_3
    //   306: invokestatic 363	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   309: invokeinterface 369 2 0
    //   314: ifeq +99 -> 413
    //   317: aload_0
    //   318: getfield 359	bizk:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   321: iconst_3
    //   322: invokestatic 363	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   325: invokeinterface 371 2 0
    //   330: checkcast 373	bizl
    //   333: astore_1
    //   334: aload_1
    //   335: ifnull -323 -> 12
    //   338: aload_3
    ...
    //   364: checkcast 344	org/w3c/dom/Element
    //   367: ldc_w 436
    //   370: invokeinterface 348 2 0
    //   375: astore_3
  ...
  public void a(int paramInt, bizl parambizl)
  {
    if (parambizl == null) {
      return;
    }
    ...
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), parambizl);
  }
  ...
  public void a(Object paramObject1, Object paramObject2)
  {
    ...
    {
      Object localObject = this.jdField_a_of_type_Bizh.jdField_a_of_type_Bize;
      if (localObject != null)
      {
        paramObject1 = null;
        localObject = ((bize)localObject).getCodec("intchk");
        if (localObject != null) {
          paramObject1 = (byte[])((bizf)localObject).decode(paramObject2);
        }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString.has("strike_result"))
        {
          ...
          if (this.jdField_a_of_type_Bizh != null)
          {
            bize localbize = this.jdField_a_of_type_Bizh.jdField_a_of_type_Bize;
            if (localbize != null)
            {
              localObject = paramString.toByteArray();
              bizf localbizf = localbize.getCodec("intchk");
              paramString = (String)localObject;
              if (localbizf != null) {
                paramString = localbizf.encode(localObject);
              }
              localbize.send(paramString);
              return;
            }
          }
        }
