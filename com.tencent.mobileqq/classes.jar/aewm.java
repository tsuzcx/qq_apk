  ...
  implements Handler.Callback
{
  ...
  private aewo jdField_a_of_type_Aewo;
  ...
  private aewo jdField_b_of_type_Aewo;
  private ImageSwitcher jdField_b_of_type_AndroidWidgetImageSwitcher;
  private boolean jdField_b_of_type_Boolean;
  private aewo c;
  private aewo d;
  
  public aewm(ImageSwitcher paramImageSwitcher1, ImageSwitcher paramImageSwitcher2, ImageView paramImageView, MqqHandler paramMqqHandler, QQAppInterface paramQQAppInterface)
  {
  ...
  private aewo a(String paramString)
  {
    if (this.d != null)
    {
  ...
  private String a(int paramInt)
  {
    ...
    case 3: 
    default: 
      return anzj.a(2131704916);
    case 0: 
      return anzj.a(2131704918);
    case 1: 
      return anzj.a(2131704920);
    case 2: 
      return anzj.a(2131704919);
    }
    return anzj.a(2131704921);
  }
  ...
  private boolean b()
  {
    ...
    if ((this.jdField_a_of_type_Int >= this.jdField_a_of_type_JavaUtilArrayList.size()) || ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_JavaUtilArrayList.size() == 2)) || ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Int >= this.jdField_a_of_type_JavaUtilArrayList.size() - 1))) {
      if ((this.d != null) && (this.jdField_b_of_type_Int != 4))
      {
        ...
        this.c = this.d;
        this.d = null;
        this.jdField_b_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.c.jdField_a_of_type_Aoot);
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.d.jdField_a_of_type_Aoot);
        this.jdField_a_of_type_Aewo = this.jdField_b_of_type_Aewo;
        this.jdField_b_of_type_Aewo = this.d;
        this.d = null;
      }
    }
    for (;;)
    {
      ...
      return true;
      label287:
      this.c = aewo.a(str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      break;
      label302:
      ...
      this.jdField_b_of_type_Aewo = aewo.a(str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.jdField_b_of_type_Aewo.jdField_a_of_type_Aoot);
      continue;
      label478:
      this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.d.jdField_a_of_type_Aoot);
      this.jdField_a_of_type_Aewo = this.jdField_b_of_type_Aewo;
      ...
      this.d = null;
      if (QLog.isColorLevel()) {
        QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "isPlayFinished play one" + this.jdField_b_of_type_Aewo.jdField_a_of_type_JavaLangString);
      }
    }
    label553:
    return false;
  ...
  private void f()
  {
    if ((this.jdField_a_of_type_Aewo != null) && (!this.jdField_a_of_type_Aewo.a()))
    {
      this.jdField_a_of_type_Aewo.a();
      this.jdField_a_of_type_Aewo = null;
    }
    if ((this.jdField_b_of_type_Aewo != null) && (!this.jdField_b_of_type_Aewo.a()))
    {
      this.jdField_b_of_type_Aewo.a();
      this.jdField_b_of_type_Aewo = null;
    }
    if ((this.c != null) && (!this.c.a()))
    {
      this.c.a();
  ...
  void a()
  {
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilArrayList.size() > 1) && (this.jdField_a_of_type_Int > 0))
        {
          ...
          this.jdField_b_of_type_Aewo = this.c;
          this.c = null;
          localObject = this.jdField_b_of_type_Aewo.a();
          this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable((Drawable)localObject);
          if (QLog.isColorLevel()) {
            QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "play two" + this.jdField_b_of_type_Aewo.jdField_a_of_type_JavaLangString);
          }
          this.c = a((String)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int + 1));
          if (this.c == null) {
            this.c = aewo.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int + 1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          ...
          this.d = aewo.a((String)localObject, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          return;
        }
      }
      catch (Throwable localThrowable)
      {
        ...
        bnkm.a(localThrowable, anzj.a(2131704917));
        return;
      }
      g();
      continue;
      ...
      if (!this.c.a())
      {
        ...
        continue;
        label541:
        if ((this.jdField_b_of_type_Aewo == null) || ((!this.jdField_b_of_type_Aewo.a()) && (!this.jdField_b_of_type_Aewo.jdField_a_of_type_JavaLangString.equals(localThrowable))))
        {
          this.jdField_b_of_type_Aewo = aewo.a(localThrowable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          continue;
          label587:
          this.jdField_b_of_type_Aewo = a(localThrowable);
          if (this.jdField_b_of_type_Aewo == null) {
            this.jdField_b_of_type_Aewo = aewo.a(localThrowable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          aoot localaoot = this.jdField_b_of_type_Aewo.a();
          if (localaoot != null)
          {
            this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(localaoot);
            if (QLog.isColorLevel()) {
              QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "play one" + this.jdField_b_of_type_Aewo.jdField_a_of_type_JavaLangString);
            }
          }
        }
      }
    ...
    {
      this.d = aewo.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(0), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (this.jdField_a_of_type_Boolean)
      {
        this.c = aewo.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        return;
        label772:
        if (QLog.isColorLevel())
        {
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 1))
    {
      ...
      this.d = aewo.a(paramArrayList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  void a(boolean paramBoolean)
  {
    ...
    localAlphaAnimation1.setAnimationListener(new aewn(this, paramBoolean));
