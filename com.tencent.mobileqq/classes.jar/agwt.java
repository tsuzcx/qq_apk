...
public class agwt
  implements abtd, alxc
{
  private final agwx jdField_a_of_type_Agwx = new agwx(null);
  private alxa jdField_a_of_type_Alxa;
  private amcd jdField_a_of_type_Amcd = new agwu(this);
  ...
  private final agwx jdField_b_of_type_Agwx = new agwx(null);
  private boolean jdField_b_of_type_Boolean;
  private final agwx jdField_c_of_type_Agwx = new agwx(null);
  private boolean jdField_c_of_type_Boolean;
  private final agwx jdField_d_of_type_Agwx = new agwx(null);
  private boolean jdField_d_of_type_Boolean;
  private final agwx jdField_e_of_type_Agwx = new agwx(null);
  private boolean jdField_e_of_type_Boolean;
  private final agwx jdField_f_of_type_Agwx = new agwx(null);
  private boolean jdField_f_of_type_Boolean;
  private boolean g;
  
  public agwt(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString)
  {
  ...
  private Calendar a()
  {
    return this.jdField_a_of_type_Alxa.a();
  }
  ...
  private List<ChatMessage> a(int paramInt)
  {
    ...
    {
      localObject = this.jdField_a_of_type_Alxa.a();
      if (localObject != null) {
        break label87;
      }
    }
    ...
    if (this.jdField_a_of_type_Alxa.a() == null)
    {
      QLog.e("C2CMsgRoamProxy", 1, "current page date is null, show roam flag: " + this.jdField_a_of_type_Alxa.e());
      return null;
    }
    Object localObject = this.jdField_a_of_type_Alxa.a(paramInt);
    if ((localObject != null) && (((RoamMessagePreloadInfo)localObject).curday != null))
    {
      l1 = SystemClock.uptimeMillis();
      this.jdField_a_of_type_Agwx.a();
      this.jdField_a_of_type_Alxa.a(((RoamMessagePreloadInfo)localObject).curday, null, false, false);
      if (QLog.isColorLevel()) {
        QLog.d("C2CMsgRoamProxy", 2, "getHistorySig wait");
      }
      this.jdField_a_of_type_Agwx.a(30000L);
    ...
    for (;;)
    {
      this.jdField_a_of_type_JavaUtilCalendar = this.jdField_a_of_type_Alxa.a();
    ...
    for (;;)
    {
      ...
      while (localIterator1.hasNext())
      {
        ...
        while (localIterator2.hasNext())
        {
          ...
          if (abti.a(localMessageRecord, localChatMessage, true)) {
            localArrayList.add(localChatMessage);
          }
        }
      }
      ((List)localObject).removeAll(localArrayList);
      if ((((List)localObject).size() > 0) && (paramMessageRecord != null) && (aspz.a(paramMessageRecord)) && (((ChatMessage)((List)localObject).get(0)).time >= paramMessageRecord.time))
      {
        if (QLog.isColorLevel()) {
  ...
  private void a(int paramInt)
  {
    ...
    RoamDate localRoamDate = this.jdField_a_of_type_Alxa.a().a(this.jdField_a_of_type_JavaLangString, localCalendar.get(1), localCalendar.get(2) + 1);
  ...
  {
    paramQQAppInterface = (alxa)paramQQAppInterface.getManager(92);
  ...
  {
    this.jdField_a_of_type_Alxa.a(paramCalendar.get(1), paramCalendar.get(2), paramCalendar.get(5));
    this.jdField_a_of_type_JavaUtilCalendar = this.jdField_a_of_type_Alxa.a();
  }
    ...
    if ((!this.jdField_a_of_type_Boolean) || (paramBoolean)) {
      try
      {
        if ((!this.jdField_a_of_type_Boolean) || (paramBoolean))
        {
          ...
          this.jdField_a_of_type_Alxa = ((alxa)((QQAppInterface)localObject1).getManager(92));
          this.jdField_a_of_type_Alxa.a(this.jdField_a_of_type_JavaLangString, false);
          localObject1 = Calendar.getInstance();
          ((Calendar)localObject1).setTimeInMillis(NetConnInfoCenter.getServerTimeMillis());
          this.jdField_a_of_type_Alxa.a(((Calendar)localObject1).get(1), ((Calendar)localObject1).get(2), ((Calendar)localObject1).get(5));
          this.jdField_a_of_type_JavaUtilCalendar = this.jdField_a_of_type_Alxa.a();
  ...
  {
    int j = this.jdField_a_of_type_Alxa.b();
    ...
    {
      this.jdField_f_of_type_Agwx.a();
      ((AccountManager)localObject2).refreshDA2(((QQAppInterface)localObject1).getCurrentAccountUin(), new agww(this));
      this.jdField_f_of_type_Agwx.a(30000L);
      return;
    }
    this.g = false;
    return;
  ...
  private void b(boolean paramBoolean)
  {
    ...
    long l1 = SystemClock.uptimeMillis();
    this.jdField_b_of_type_Agwx.a();
    this.jdField_a_of_type_Alxa.a(paramBoolean);
    this.jdField_b_of_type_Agwx.a(30000L);
    a(3);
    long l2 = SystemClock.uptimeMillis();
    if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Alxa.c(this.jdField_c_of_type_Boolean);
  }
  ...
  private boolean b()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        b();
        l1 = SystemClock.uptimeMillis();
        bool3 = bdin.d(BaseApplication.getContext());
        c();
        bool4 = this.jdField_a_of_type_Alxa.h();
        bool1 = bool2;
      } while (!bool3);
      bool1 = bool2;
    } while (!bool4);
  ...
  private void c()
  {
    if (this.jdField_a_of_type_Alxa.i()) {}
    long l1;
    long l2;
    do
    {
      ...
      l1 = SystemClock.uptimeMillis();
      ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).addObserver(this.jdField_a_of_type_Amcd);
      bdug localbdug = (bdug)localQQAppInterface.a(71);
      this.jdField_c_of_type_Agwx.a();
      localbdug.a(new String[] { localQQAppInterface.getCurrentAccountUin() }, new int[] { 42255 });
      this.jdField_c_of_type_Agwx.a();
  ...
  private void c(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_c_of_type_Boolean = false;
        break;
        QQToast.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131693128), 0).a();
      }
      this.jdField_c_of_type_Boolean = false;
      continue;
  ...
  private void c(boolean paramBoolean)
  {
    ...
    this.jdField_e_of_type_Agwx.a();
    int[] arrayOfInt = new int[1];
    DevlockInfo[] arrayOfDevlockInfo = new DevlockInfo[1];
    aqbd.a().a(localQQAppInterface, localQQAppInterface.getCurrentAccountUin(), new agwv(this, l, arrayOfInt, arrayOfDevlockInfo));
    this.jdField_e_of_type_Agwx.a(30000L);
  ...
  private boolean d()
  {
    ...
    localObject = (amrg)((QQAppInterface)localObject).a(59);
    if (localObject != null)
    {
      long l1 = SystemClock.uptimeMillis();
      this.jdField_d_of_type_Agwx.a();
      ((amrg)localObject).a();
      this.jdField_d_of_type_Agwx.a(30000L);
      long l2 = SystemClock.uptimeMillis();
      if (QLog.isColorLevel()) {
  ...
  private void e(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    localObject = (alxa)((QQAppInterface)localObject).getManager(92);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (i == 0) {
        ((alxa)localObject).a(localCalendar, false);
      }
      switch (paramInt1)
      {
      case 3: 
    ...
    for (;;)
    {
      ((alxa)localObject).e();
      return;
      paramObject = ((alxa)localObject).a();
      if (paramObject != null) {
        QQToast.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131693130, new Object[] { Integer.valueOf(paramObject.get(2) + 1), Integer.valueOf(paramObject.get(5)) }), 0).a();
      }
    }
    ((alxa)localObject).e();
  }
  ...
  private boolean e()
  {
    Object localObject2 = this.jdField_a_of_type_Alxa.c();
    ...
    if (this.jdField_a_of_type_Alxa.b() == null)
    {
      QLog.e("C2CMsgRoamProxy", 1, "can not get first page date, roam flag: " + this.jdField_a_of_type_Alxa.e());
      return true;
    }
    long l = this.jdField_a_of_type_Alxa.b().getTimeInMillis();
    while (((Calendar)localObject1).getTimeInMillis() >= l)
    {
      int i = ((Calendar)localObject1).get(5);
      localObject2 = this.jdField_a_of_type_Alxa.a().a(this.jdField_a_of_type_JavaLangString, ((Calendar)localObject1).get(1), ((Calendar)localObject1).get(2) + 1);
      if (localObject2 == null)
      {
        if (QLog.isColorLevel()) {
      ...
      {
        this.jdField_a_of_type_Alxa.a(((Calendar)localObject1).get(1), ((Calendar)localObject1).get(2), i);
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Alxa != null)
    {
      ...
      ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).removeObserver(this.jdField_a_of_type_Amcd);
    }
  ...
  public boolean a(String paramString, int paramInt1, int paramInt2, abts paramabts, ArrayList<MessageRecord> paramArrayList, MessageRecord paramMessageRecord, long paramLong)
  {
    ...
    if (paramMessageRecord == null)
    {
      ...
      if ((paramMessageRecord != null) && ((this.jdField_a_of_type_Alxa == null) || (!this.jdField_a_of_type_Alxa.e()) || (this.jdField_a_of_type_Alxa.a() != null))) {
        break label116;
      }
    }
    label116:
    ...
    if ((paramMessageRecord != null) && (i == 2))
    {
      ...
      if (a() == null)
      {
        ...
        paramabts = this.jdField_a_of_type_Alxa.d;
        a(true);
        if (paramabts == null) {
          break label219;
        }
    ...
    {
      long l3 = paramabts.getTimeInMillis() / 1000L;
