  ...
  implements Animatable
{
  ...
  Property<bqvy, Integer> jdField_a_of_type_AndroidUtilProperty = new bqvz(this, Integer.class, "backAlpha");
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bqwa(this));
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bqwb(this));
