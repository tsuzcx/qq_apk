  ...
  extends almx
{
  ...
  private Map<Long, ArrayList<almw>> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private Map<Integer, LinkedList<almw>> jdField_b_of_type_JavaUtilMap = new HashMap();
  private int jdField_c_of_type_Int = 92;
  private alnn jdField_c_of_type_Alnn;
  private int jdField_d_of_type_Int = 136;
  private alnn jdField_d_of_type_Alnn;
  private int e = 5;
  private int f = 15;
  private int g = 25;
  private int h = 6;
  ...
  private void a(long paramLong1, long paramLong2, long paramLong3, String paramString, ArrayList<almw> paramArrayList, int paramInt1, float paramFloat1, int paramInt2, float paramFloat2)
  {
    ...
    float f2 = (int)a(true);
    paramString = new almw(paramLong1, a(paramLong2), a(), b(), paramFloat2, d(), paramString, paramFloat1, paramInt1, f2, f1, -1.0F, this.jdField_c_of_type_Int, this.e, this.jdField_a_of_type_AndroidGraphicsTypeface);
  ...
  private float c()
  {
    if (this.jdField_d_of_type_Alnn == null) {
      this.jdField_d_of_type_Alnn = new alnn(this.h, 2);
    }
    int i = this.jdField_d_of_type_Alnn.a();
  ...
  private int f()
  {
    ...
    if (this.jdField_c_of_type_Alnn == null) {
      this.jdField_c_of_type_Alnn = new alnn(this.jdField_b_of_type_JavaUtilArrayList.size(), 1);
    }
  ...
  private int g()
  {
    ...
    if (this.jdField_b_of_type_Alnn == null) {
      this.jdField_b_of_type_Alnn = new alnn(this.jdField_a_of_type_JavaUtilArrayList.size(), 2);
    }
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        while (((Iterator)localObject).hasNext()) {
          ((almw)((Iterator)localObject).next()).a(paramWordingItem.jdField_a_of_type_JavaLangString);
        }
        break;
        if (QLog.isColorLevel()) {
  ...
  public boolean a(Canvas paramCanvas, RenderBuffer paramRenderBuffer, long paramLong1, long paramLong2)
  {
    ...
    {
      if (((almw)((Iterator)localObject2).next()).a(2) > paramLong1) {
        break label500;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = (almw)((Iterator)localObject1).next();
        if (((almw)localObject2).a(2) == paramLong1) {
          ((almw)localObject2).a(6, a(true));
        }
        int j = 1;
        if ((((almw)localObject2).a(6) > a(true)) || (((almw)localObject2).a(6) + ((almw)localObject2).a(3) < 0.0F) || (((almw)localObject2).a(2) > paramLong1))
        {
          int k = 0;
          j = k;
          if (QLog.isColorLevel())
          {
            QLog.d("BaseAnimDrawer", 2, "barrage invisible: posx:" + ((almw)localObject2).a(6) + "  width:" + ((almw)localObject2).a(3) + "  index:" + ((almw)localObject2).a(2) + " curindex:" + paramLong1);
            j = k;
          }
        }
        if ((j == 0) && (((almw)localObject2).a(6) < 0.0F))
        {
          if (i > 1)
          {
            ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_JavaUtilMap.get(Long.valueOf(((almw)localObject2).a(1)));
            if (localArrayList != null)
            {
              localArrayList.remove(localObject2);
              if (localArrayList.size() == 0) {
                this.jdField_a_of_type_JavaUtilMap.remove(Long.valueOf(((almw)localObject2).a(1)));
              }
            }
        ...
        else if (((almw)localObject2).a(2) <= paramLong1)
        {
          if (!c()) {
            ((almw)localObject2).a();
          }
          if (paramCanvas != null) {
            ((almw)localObject2).a(paramCanvas);
          }
          if (paramRenderBuffer != null) {
            ((almw)localObject2).a(paramRenderBuffer);
          }
          bool2 = true;
        }
      }
