  ...
  implements alms
{
  ...
  public almu(JSONObject paramJSONObject, Bundle paramBundle, WeakReference<MessengerService> paramWeakReference)
  {
  ...
  public void invalidateSelf()
  {
    ...
    float f = bfua.a(localTextPaint, localRect, (String)localObject4);
    try
    {
      i = Color.parseColor((String)localObject1);
      if (n == 1)
      {
        localObject3 = almr.a().a(this, (String)localObject4, m, n, f, i, j, k, localTextPaint);
      ...
      try
      {
        do
        {
          ...
          for (;;)
          {
            ...
            localObject3 = bfuc.encodeToString(((ByteArrayOutputStream)localObject4).toByteArray(), 2);
          ...
          localObject2 = almr.a().a(this, m, n);
