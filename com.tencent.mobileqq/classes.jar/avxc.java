  ...
  implements Handler.Callback, EIPCResultCallback
{
  ...
  @RequiresApi(api=18)
  public avxc(QQIdentiferActivity paramQQIdentiferActivity, int paramInt)
  {
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity = paramQQIdentiferActivity;
    this.jdField_a_of_type_Avxd = avxd.a(paramInt, paramQQIdentiferActivity.getIntent(), paramQQIdentiferActivity);
  ...
  public static boolean a()
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!a("new_qq_android_native_short_new_other_", bhsi.b())) && (b())) {
      return false;
    }
    bhsi.c("");
    bhsi.b(0);
  ...
  {
    String str = a();
    File localFile = new File(bork.a(borf.c) + "libYTCommon.so");
    ...
    if ((a("new_qq_android_native_short_new_other_", bhsi.b())) || (b(borf.jdField_b_of_type_Borf.jdField_b_of_type_JavaLangString, bork.a(borf.jdField_b_of_type_Borf.jdField_a_of_type_Int))))
    {
    ...
    QLog.d("qq_Identification.Helper", 1, new Object[] { "preCheck is pass, so version is ", Integer.valueOf(bhsi.b()), " current bits is : ", Integer.valueOf(b()) });
  ...
  public void b()
  {
    ...
    {
      jdField_a_of_type_Boolean = this.jdField_a_of_type_Avxd.a(bork.a(borf.c), avxd.b);
      jdField_a_of_type_Boolean &= this.jdField_a_of_type_Avxd.a(this.jdField_a_of_type_JavaLangString + "identification/so/", avxd.a);
    }
    int i;
    if (jdField_a_of_type_Boolean)
    {
    ...
    for (;;)
    {
      ...
      return;
      i = this.jdField_a_of_type_Avxd.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity, this.jdField_a_of_type_JavaLangString);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 0)
    {
      ...
      if (paramMessage.arg1 == 0)
      {
        ...
        this.jdField_a_of_type_Avxd.a(true, this.jdField_a_of_type_ComTencentMobileqqActivityQQIdentiferActivity);
      }
      if (paramMessage.arg1 != 0) {
        break label238;
      }
