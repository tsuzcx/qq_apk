...
public class aenn
  extends aniz
{
  public aenn(LikeRankingListActivity paramLikeRankingListActivity) {}
  ...
  protected void onReqLikeRankingListResult(boolean paramBoolean1, String paramString, List<LikeRankingInfo> paramList, int paramInt, boolean paramBoolean2)
  {
    ...
    else
    {
      ...
      this.a.jdField_a_of_type_Anpb.a(paramList, paramInt, paramBoolean2);
      if ((!paramBoolean2) || (paramList.size() != 0)) {
        break label258;
      }
      this.a.e.setVisibility(0);
      label165:
      this.a.jdField_a_of_type_Aeno.a(paramList, true);
    ...
    for (;;)
    {
      ...
      label284:
      this.a.a(null);
      this.a.jdField_a_of_type_Aeno.a = false;
      this.a.jdField_a_of_type_Aeno.notifyDataSetChanged();
      if (this.a.jdField_a_of_type_Aeno.getCount() <= 1) {
        this.a.e.setVisibility(0);
      }
    }
    label341:
    this.a.jdField_a_of_type_Aeno.a = false;
    this.a.jdField_a_of_type_Aeno.notifyDataSetChanged();
    QQToast.a(BaseApplication.getContext(), 1, anni.a(2131704905), 0).a();
  }
}
