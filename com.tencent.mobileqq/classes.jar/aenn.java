...
public class aenn
  implements aenz, View.OnClickListener, azwh
{
  ...
  public aenn(BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie = paramBaseChatPie;
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap(3);
    this.jdField_a_of_type_Azwg = new azwg(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, (AppInterface)BaseApplicationImpl.getApplication().getRuntime());
  ...
  private void a()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetQQBlurView = ((QQBlurView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131307249));
  ...
  private void a(String paramString, ImageView paramImageView)
  {
    ...
    this.jdField_a_of_type_Azwg.a(paramString, 200, true);
  }
  
  private void b()
  {
    View localView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131307255);
    ImageView localImageView = (ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131307248);
    if (beog.a())
    {
  ...
  private void b(boolean paramBoolean, String paramString, int paramInt, List<String> paramList)
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)View.inflate((Context)localObject, 2131495059, null));
      this.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(this);
    }
    this.jdField_a_of_type_AndroidViewViewGroup.setClickable(true);
    this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131307251).setVisibility(8);
    this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131307252).setVisibility(8);
    this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131307253).setVisibility(8);
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131307250);
    ...
    if (paramBoolean)
    {
      paramString = "你" + ((Activity)localObject).getString(2131630646);
      localTextView.setText(paramString);
      if (!this.jdField_a_of_type_Boolean)
      {
        awqx.b(null, "CliOper", "", "", "0X800A767", "0X800A767", 1, 0, "", "0", "0", "");
        this.jdField_a_of_type_Boolean = true;
      }
      arcl.a(this.jdField_a_of_type_AndroidViewViewGroup, paramString);
      if ((paramList.size() > 0) && (!TextUtils.isEmpty((CharSequence)paramList.get(0)))) {
        a((String)paramList.get(0), (ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131307251));
      }
      if ((paramList.size() > 1) && (!TextUtils.isEmpty((CharSequence)paramList.get(1)))) {
        a((String)paramList.get(1), (ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131307252));
      }
      if ((paramList.size() > 2) && (!TextUtils.isEmpty((CharSequence)paramList.get(2)))) {
        a((String)paramList.get(2), (ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131307253));
      }
      this.jdField_a_of_type_AndroidViewViewGroup.addOnAttachStateChangeListener(new aeno(this));
      b();
      return;
    }
    if (paramInt == 1) {}
    for (localObject = ((Activity)localObject).getString(2131630646);; localObject = String.format(((Activity)localObject).getString(2131630645), new Object[] { Integer.valueOf(paramInt) }))
    {
      String str = paramString + (String)localObject;
      arcl.a(paramString, (String)localObject, localTextView);
      if (!this.jdField_a_of_type_Boolean)
      {
        awqx.b(null, "CliOper", "", "", "0X800A767", "0X800A767", 2, 0, "", "0", "0", "");
        this.jdField_a_of_type_Boolean = true;
      }
      arcl.a(this.jdField_a_of_type_AndroidViewViewGroup, str + " 点击加入位置共享");
      break;
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    awqx.b(null, "CliOper", "", "", "0X800A768", "0X800A768", 0, 0, "", "0", "0", "");
  }
