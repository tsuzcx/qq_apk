  ...
  extends bjsi
{
  ...
  public void a()
  {
    try
    {
      ...
      anaa.a().a();
      amqf.a(this.a).clear();
      ampj.a().callbackFromRequest(amqf.a(this.a), 0, "cs.audioRoom_exit.local", localJSONObject.toString());
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    try
    {
      ...
      ampj.a().callbackFromRequest(amqf.a(this.a), paramInt, "cs.audioRoom_init.local", paramString.toString());
      return;
    }
  ...
  public void a(int paramInt, String[] paramArrayOfString)
  {
    ...
    try
    {
      ...
      localJSONObject1.put("lState", amqf.a(this.a));
      localJSONObject1.put("eventId", paramInt);
      localArrayList = new ArrayList();
      localJSONArray1 = new JSONArray();
      localJSONArray2 = new JSONArray();
      ampj.a();
      localamry = ampj.a(amqf.a(this.a));
      if (localamry != null) {
        break label488;
      }
      return;
    ...
    {
      localObject = localamry.b(paramArrayOfString[i]);
    ...
    else
    {
      if (localJSONArray1.length() > 0)
      {
        ...
        ampj.a().callbackFromRequest(amqf.a(this.a), 0, "cs.audioRoom_update_userinfo.local", ((JSONObject)localObject).toString());
      }
      if (localArrayList.size() > 0)
      {
        localJSONObject1.put("identifierList", localJSONArray2.toString());
        if (localamry != null) {
          localamry.a(1, null, localArrayList, 8, amqf.a(this.a), false, localJSONObject1.toString(), "");
        }
      }
    ...
    for (;;)
    {
      if (i < amqf.a(this.a).size())
      {
        if (((String)amqf.a(this.a).get(i)).equals(paramArrayOfString[paramInt])) {
          i = 1;
        }
      }
      else
      {
        for (;;)
        {
          if (i == 0)
          {
            amqf.a(this.a).add(paramArrayOfString[paramInt]);
            break label510;
            if (amqf.a(this.a))
            {
              paramArrayOfString = (CmGameAppInterface)ampj.a();
              amqf.a(this.a, (String[])amqf.a(this.a).toArray(new String[amqf.a(this.a).size()]), paramArrayOfString.getCurrentAccountUin());
              return;
              i = 0;
            }
            else
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    try
    {
      ...
      ampj.a().callbackFromRequest(amqf.a(this.a), paramInt, "cs.audioRoom_set_mic.local", localJSONObject.toString());
      return;
    }
    catch (Exception localException)
    {
  ...
  public void b(boolean paramBoolean, int paramInt)
  {
    try
    {
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("res", paramInt);
      ampj.a().callbackFromRequest(amqf.a(this.a), paramInt, "cs.audioRoom_set_speaker.local", localJSONObject.toString());
      return;
    }
    catch (Exception localException)
    {
  ...
  public void c(int paramInt, String paramString)
  {
    try
    {
      ...
      ampj.a().callbackFromRequest(amqf.a(this.a), 0, "cs.audioRoom_disconnect.local", paramString.toString());
      return;
    }
    catch (Exception paramString)
    {
