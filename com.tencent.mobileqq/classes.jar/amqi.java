  ...
  implements Handler.Callback
{
  ...
  private void b()
  {
    ...
    try
    {
      ...
      {
        this.jdField_a_of_type_Amqj.c();
        this.jdField_a_of_type_Amqj = null;
      }
      return;
    }
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Amqj != null) {
          this.jdField_a_of_type_Amqj.a(2);
        }
      }
    }
  }
  ...
  private void b(long paramLong)
  {
    ...
    catch (Exception localException)
    {
      ...
      } while (this.jdField_a_of_type_Amqj == null);
      this.jdField_a_of_type_Amqj.a(4);
    }
  }
  ...
  private void b(byte[] paramArrayOfByte, long paramLong)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      this.jdField_a_of_type_Amqj.a(3);
    }
  }
  ...
  public void a(axqz paramaxqz, amqj paramamqj)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqArARRecordVideoEncoderCore.a(paramaxqz, paramamqj);
      if (this.jdField_a_of_type_Amqj != null) {
        this.jdField_a_of_type_Amqj.a();
      }
      return;
    }
    catch (Exception paramaxqz)
    {
      for (;;)
      {
        QLog.e("VideoEncoder", 1, "startRecording start encoder fail.", paramaxqz);
        if (this.jdField_a_of_type_Amqj != null) {
          this.jdField_a_of_type_Amqj.a(1);
        }
      }
    }
  }
