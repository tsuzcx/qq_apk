...
public class bdkg
{
  protected static bdkg a;
  protected String a;
  protected ArrayList<bdkc> a;
  public volatile boolean a;
  protected ArrayList<bdkc> b = new ArrayList();
  ...
  public static bdkg a()
  {
    try
    {
      if (jdField_a_of_type_Bdkg == null) {
        jdField_a_of_type_Bdkg = new bdkg();
      }
      bdkg localbdkg = jdField_a_of_type_Bdkg;
      return localbdkg;
    }
    finally {}
  }
  ...
  protected String a(ArrayList<bdkc> paramArrayList1, ArrayList<bdkc> paramArrayList2)
  {
    ...
    if (paramArrayList1 != null)
    {
      ...
      {
        bdkc localbdkc = (bdkc)paramArrayList1.next();
        localStringBuilder.append(localbdkc.jdField_a_of_type_JavaLangString + "_" + localbdkc.b + "_" + localbdkc.c + "_" + localbdkc.a() + "_" + localbdkc.g);
        if (!TextUtils.isEmpty(localbdkc.h)) {
          localStringBuilder.append("_" + localbdkc.h);
        }
        if (!TextUtils.isEmpty(localbdkc.i)) {
          localStringBuilder.append("_" + localbdkc.i);
        }
        if (!TextUtils.isEmpty(localbdkc.j)) {
          localStringBuilder.append("_" + localbdkc.j);
        }
        if (!TextUtils.isEmpty(localbdkc.k)) {
          localStringBuilder.append("_" + localbdkc.k);
        }
        if (!TextUtils.isEmpty(localbdkc.l)) {
          localStringBuilder.append("_" + localbdkc.l);
        }
    ...
    if (paramArrayList2 != null)
    {
      ...
      while (paramArrayList1.hasNext())
      {
        paramArrayList2 = (bdkc)paramArrayList1.next();
  ...
  public void a(bdkc parambdkc, Bundle paramBundle, boolean paramBoolean)
  {
    a(String.valueOf(bcyb.a().a()), parambdkc, paramBundle, paramBoolean);
  }
  ...
  public void a(String paramString, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        bdii.b("viareport", "database empty");
        return;
      }
      this.jdField_a_of_type_Boolean = true;
    }
    localBundle.putString("uin", paramString);
    localBundle.putString("platform", bcyb.a().g());
    localBundle.putString("action", "100");
    localBundle.putString("imei", bdjp.c());
    localBundle.putString("resolution", bdjp.e());
    localBundle.putString("network", bdid.a(bcyb.a().a()));
    localBundle.putString("wifimac", bdjp.a());
    localBundle.putString("mobile_pf", "1");
    localBundle.putString("os_ver", Build.VERSION.RELEASE);
    localBundle.putString("lang", bdjp.b());
    ...
    localBundle.putString("city", bdjp.g());
    localBundle.putString("longitude", bdjp.f());
    localBundle.putString("ret_code", "0");
    localBundle.putString("qua", bcyb.a().f());
    localBundle.putString("qz_ver", bcyb.a().c());
    localBundle.putString("ext", bcyb.a().h());
    if (paramBundle != null) {
  ...
  public void a(String paramString, bdkc parambdkc, Bundle paramBundle, boolean paramBoolean)
  {
    ThreadManager.executeOnNetWorkThread(new ReportManager.1(this, paramBoolean, parambdkc, paramBundle, paramString));
  }
  ...
  protected void a(String paramString1, String paramString2, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    //   28: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   31: iconst_0
    //   32: istore 6
    //   34: iconst_0
    //   35: istore 5
    ...
    //   62: aload_2
    //   63: aload_3
    //   64: invokestatic 311	com/tencent/open/base/http/HttpBaseUtil:a	(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Lbdiz;
    //   67: astore 23
    //   69: lload 11
    //   71: lstore 19
    //   73: aload 23
    //   75: getfield 314	bdiz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   104: lstore 19
    //   106: aload 23
    //   108: getfield 314	bdiz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   134: lstore 13
    //   136: aload 23
    //   138: getfield 328	bdiz:jdField_a_of_type_Long	J
    //   141: lstore 11
    //   143: lload 11
    //   145: lstore 19
    //   147: lload 11
    ...
    //   229: invokestatic 339	bdii:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   232: aload_0
    //   233: iload 7
    //   235: invokevirtual 342	bdkg:a	(I)Z
    //   238: ifeq +30 -> 268
    //   241: invokestatic 347	bdka:a	()Lbdka;
    //   244: ldc_w 349
    //   247: lload 15
    //   249: lload 11
    //   251: lload 13
    //   253: iload 7
    //   255: invokestatic 118	bcyb:a	()Lbcyb;
    //   258: invokevirtual 121	bcyb:a	()J
    //   261: ldc_w 351
    //   264: aconst_null
    //   265: invokevirtual 354	bdka:a	(Ljava/lang/String;JJJIJLjava/lang/String;Ljava/lang/String;)V
    //   268: iload 6
    //   270: iconst_1
    //   271: if_icmpne +710 -> 981
    //   274: ldc_w 356
    //   277: ldc_w 358
    //   280: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   283: iload 4
    //   285: ifeq +25 -> 310
    //   288: ldc 151
    //   290: ldc_w 360
    //   293: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   296: aload_0
    //   297: iconst_0
    //   298: putfield 160	bdkg:jdField_a_of_type_Boolean	Z
    //   301: iload 6
    //   303: ifeq +7 -> 310
    //   306: aload_0
    //   307: invokevirtual 362	bdkg:a	()V
    //   310: return
    //   311: astore 24
    //   313: bipush 252
    //   315: istore 6
    ...
    //   371: invokestatic 367	bdii:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   374: goto -208 -> 166
    //   377: astore 23
    //   379: iload 5
    //   381: istore 6
    ...
    //   428: invokestatic 367	bdii:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   431: goto -265 -> 166
    //   434: astore 23
    //   436: iload 5
    //   438: istore 6
    ...
    //   480: invokestatic 367	bdii:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   483: goto -317 -> 166
    //   486: astore_1
    //   487: ldc 151
    ...
    //   512: invokestatic 367	bdii:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   515: aload_0
    //   516: iconst_0
    //   517: putfield 160	bdkg:jdField_a_of_type_Boolean	Z
    //   520: return
    //   521: astore_1
    //   522: aload_1
    ...
    //   539: aload_0
    //   540: iload 5
    //   542: invokevirtual 342	bdkg:a	(I)Z
    //   545: ifeq +30 -> 575
    //   548: invokestatic 347	bdka:a	()Lbdka;
    //   551: ldc_w 349
    //   554: lload 15
    //   556: lload 19
    //   558: lload 17
    //   560: iload 5
    //   562: invokestatic 118	bcyb:a	()Lbcyb;
    //   565: invokevirtual 121	bcyb:a	()J
    //   568: ldc_w 351
    //   571: aconst_null
    //   572: invokevirtual 354	bdka:a	(Ljava/lang/String;JJJIJLjava/lang/String;Ljava/lang/String;)V
    //   575: ldc 151
    ...
    //   600: invokestatic 367	bdii:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   603: aload_0
    //   604: iconst_0
    //   605: putfield 160	bdkg:jdField_a_of_type_Boolean	Z
    //   608: return
    //   609: astore_2
    //   610: ldc 151
    ...
    //   635: invokestatic 367	bdii:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   638: goto -63 -> 575
    //   641: astore 23
    //   643: iload 5
    //   645: istore 6
    ...
    //   655: lstore 13
    //   657: aload 23
    //   659: invokestatic 390	bdjd:a	(Ljava/io/IOException;)I
    //   662: istore 7
    //   664: ldc 151
    ...
    //   690: invokestatic 367	bdii:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   693: goto -527 -> 166
    //   696: astore 23
    //   698: iload 5
    //   700: istore 6
    ...
    //   740: invokestatic 367	bdii:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   743: aload_0
    //   744: iconst_0
    //   745: putfield 160	bdkg:jdField_a_of_type_Boolean	Z
    //   748: return
    //   749: aload 23
    //   751: instanceof 288
    //   754: ifeq +125 -> 879
    ...
    //   775: aload_0
    //   776: iload 5
    //   778: invokevirtual 342	bdkg:a	(I)Z
    //   781: ifeq +30 -> 811
    //   784: invokestatic 347	bdka:a	()Lbdka;
    //   787: ldc_w 349
    //   790: lload 15
    //   792: lload 11
    //   794: lload 17
    //   796: iload 5
    //   798: invokestatic 118	bcyb:a	()Lbcyb;
    //   801: invokevirtual 121	bcyb:a	()J
    //   804: ldc_w 351
    //   807: aconst_null
    //   808: invokevirtual 354	bdka:a	(Ljava/lang/String;JJJIJLjava/lang/String;Ljava/lang/String;)V
    //   811: ldc 151
    ...
    //   837: invokestatic 367	bdii:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   840: aload_0
    //   841: iconst_0
    //   842: putfield 160	bdkg:jdField_a_of_type_Boolean	Z
    //   845: return
    //   846: astore_1
    //   847: ldc 151
    ...
    //   873: invokestatic 367	bdii:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   876: goto -65 -> 811
    //   879: aload 23
    //   881: instanceof 290
    //   884: ifeq +51 -> 935
    ...
    //   898: invokestatic 390	bdjd:a	(Ljava/io/IOException;)I
    //   901: istore 7
    //   903: ldc 151
    ...
    //   929: invokestatic 367	bdii:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   932: goto -766 -> 166
    //   935: lconst_0
    //   936: lstore 11
    //   938: lconst_0
    ...
    //   971: invokestatic 367	bdii:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   974: iload 8
    //   976: istore 5
    //   978: goto -812 -> 166
    //   981: ldc_w 356
    //   984: ldc_w 395
    //   987: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   990: iload 4
    //   992: ifeq -709 -> 283
    //   995: invokestatic 400	bdkf:a	()Lbdkf;
    //   998: aload_0
    //   999: getfield 26	bdkg:b	Ljava/util/ArrayList;
    //   1002: invokevirtual 403	bdkf:a	(Ljava/util/ArrayList;)I
    //   1005: pop
    //   1006: invokestatic 400	bdkf:a	()Lbdkf;
    //   1009: aload_0
    //   1010: getfield 24	bdkg:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   1013: invokevirtual 403	bdkf:a	(Ljava/util/ArrayList;)I
    //   1016: pop
    //   1017: goto -734 -> 283
    //   1020: astore 23
    //   1022: lload 13
  ...
  public boolean a()
  {
    ...
    //   42: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   45: invokestatic 415	bdke:b	()J
    //   48: lstore 5
    //   50: ldc 151
    ...
    //   73: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   76: lload_3
    //   77: lload_1
    //   78: lsub
    //   79: lload 5
    ...
    //   89: ldc_w 356
    //   92: ldc_w 421
    //   95: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   98: iconst_0
    //   99: istore 7
    //   101: aload_0
    //   102: monitorexit
    ...
    //   105: ireturn
    //   106: lload_3
    //   107: invokestatic 424	bdke:a	(J)V
    //   110: ldc_w 356
    //   113: ldc_w 426
    //   116: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   119: iconst_1
    //   120: istore 7
    //   122: goto -21 -> 101
    //   125: astore 8
  ...
  protected boolean a(int paramInt)
  {
    ...
    //   29: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   48: ldc_w 439
    //   51: ldc_w 441
    //   54: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   57: iconst_1
    //   58: istore_2
    //   59: aload_0
    //   60: monitorexit
    ...
    //   63: ldc_w 439
    //   66: ldc_w 443
    //   69: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   72: iconst_0
    //   73: istore_2
    //   74: goto -15 -> 59
    //   77: astore_3
  ...
  public boolean a(String paramString)
  {
    ...
    //   25: invokevirtual 80	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   28: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   31: invokestatic 400	bdkf:a	()Lbdkf;
    //   34: aload_1
    //   35: invokevirtual 449	bdkf:a	(Ljava/lang/String;)I
    //   38: iload_2
    //   39: if_icmplt +18 -> 57
    //   42: ldc_w 356
    //   45: ldc_w 451
    //   48: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   51: iconst_1
    //   52: istore_3
    //   53: aload_0
    //   54: monitorexit
    ...
    //   57: ldc_w 356
    //   60: ldc_w 453
    //   63: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   66: iconst_0
    //   67: istore_3
    //   68: goto -15 -> 53
    //   71: astore_1
  ...
  protected boolean a(String paramString, Bundle paramBundle)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokestatic 400	bdkf:a	()Lbdkf;
    //   6: aload_1
    //   7: invokevirtual 456	bdkf:a	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   10: putfield 24	bdkg:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   13: invokestatic 400	bdkf:a	()Lbdkf;
    //   16: ldc_w 458
    //   19: aload_1
    //   20: invokevirtual 461	bdkf:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   23: pop
    //   24: aload_0
    //   25: invokestatic 400	bdkf:a	()Lbdkf;
    //   28: aload_1
    //   29: invokevirtual 463	bdkf:b	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   32: putfield 26	bdkg:b	Ljava/util/ArrayList;
    //   35: invokestatic 400	bdkf:a	()Lbdkf;
    //   38: ldc_w 465
    //   41: aload_1
    //   42: invokevirtual 461	bdkf:a	(Ljava/lang/String;Ljava/lang/String;)I
    //   45: pop
    //   46: aload_0
    //   47: aload_0
    //   48: getfield 24	bdkg:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   51: aload_0
    //   52: getfield 26	bdkg:b	Ljava/util/ArrayList;
    //   55: invokevirtual 467	bdkg:a	(Ljava/util/ArrayList;Ljava/util/ArrayList;)Ljava/lang/String;
    //   58: astore_1
    //   59: ldc 151
    ...
    //   81: invokestatic 158	bdii:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   84: aload_2
    //   85: ldc_w 471
    //   88: aload_1
  ...
  public boolean b(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_1
    //   3: invokestatic 472	bdke:a	(Ljava/lang/String;)I
    //   6: istore_2
    //   7: ldc 151
    //   9: new 43	java/lang/StringBuilder
    //   12: dup
