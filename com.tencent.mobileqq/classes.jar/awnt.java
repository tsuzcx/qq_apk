  ...
  implements ViewPager.OnPageChangeListener
{
  ...
  public awnt(VipProfileCardPreviewActivity paramVipProfileCardPreviewActivity) {}
  ...
  public void onPageSelected(int paramInt)
  {
    ...
    if (((awms)this.jdField_a_of_type_ComTencentMobileqqProfileVipProfileCardPreviewActivity.jdField_a_of_type_JavaUtilList.get(paramInt)).a.o == awmr.h)
    {
      if (QLog.isColorLevel()) {
        QLog.d("ProfileCard.VipProfileCardPreviewActivity", 2, "report shopping template = " + paramInt);
      }
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqProfileVipProfileCardPreviewActivity.app, "CliOper", "", "", "Shop_Malltemplate", "0X8005B93", 0, 0, "", "", "", "");
    }
