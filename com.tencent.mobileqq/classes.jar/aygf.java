...
public class aygf
{
  private static ayfv jdField_a_of_type_Ayfv;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j < k)
        {
          ...
          else if ((localRecentBaseData.a() == 6000) && (TextUtils.equals(localRecentBaseData.a(), alof.z)))
          {
            localArrayList.add(localRecentBaseData);
            i = j;
          }
        ...
        else
        {
          if ((localArrayList.size() == 0) || (i == -1))
          {
            ...
            paramList = ajie.a(new RecentUser(alof.z, 6000), paramQQAppInterface, paramActivity);
            if (paramList != null)
            {
              paramList.mTitleName = paramActivity.getResources().getString(2131694083);
              localArrayList.add(paramList);
            }
          }
          Collections.sort(localArrayList, new ajif(paramQQAppInterface));
  ...
  {
    ayfv localayfv2 = (ayfv)aoks.a().a(485);
    ayfv localayfv1 = localayfv2;
    if (localayfv2 == null)
    {
      localayfv2 = new ayfv();
      localayfv1 = localayfv2;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ScreenShotHelper", 2, "ScreenShotConfigData switch isOpened = " + localayfv1);
    }
    jdField_a_of_type_Ayfv = localayfv1;
  }
  ...
  public static void a(Activity paramActivity)
  {
    ...
    paramActivity = ((ViewGroup)paramActivity.getWindow().getDecorView().getRootView()).findViewById(2131376186);
  ...
  public static void a(Activity paramActivity, Handler paramHandler)
  {
    ...
    View localView = ((ViewGroup)paramActivity.getWindow().getDecorView().getRootView()).findViewById(2131376186);
    if (localView != null)
    {
  ...
  public static void a(Activity paramActivity, String paramString, Handler paramHandler)
  {
    ...
    Object localObject1 = localViewGroup.findViewById(2131376186);
    int k = bdoo.b(79.0F);
    ...
    for (;;)
    {
      ...
      {
        localObject3 = View.inflate(paramActivity, 2131562579, null);
        localImageView = (ImageView)((View)localObject3).findViewById(2131376189);
      ...
      for (;;)
      {
        try
        {
          paramActivity.getResources().getDrawable(2130840158);
          ...
          ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = bayu.b();
  ...
  public static void a(Context paramContext, android.net.Uri paramUri, View paramView1, View paramView2, boolean paramBoolean)
  {
    ...
    //   23: iconst_3
    //   24: aload 9
    //   26: invokestatic 520	yak:a	(Landroid/net/Uri;Landroid/content/Context;ILandroid/util/SparseArray;)I
    //   29: istore 6
    //   31: iload 6
    //   33: invokestatic 523	yak:b	(I)Z
    //   36: ifeq +262 -> 298
    ...
    //   109: istore 5
    //   111: iload 6
    //   113: invokestatic 541	yak:a	(I)Z
    //   116: ifeq -106 -> 10
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    {
      localObject = ((ViewGroup)((Activity)paramContext).getWindow().getDecorView().getRootView()).findViewById(2131376186);
      if (localObject != null) {
          ...
          if (localQQAppInterface.a().a())
          {
            ...
            if (localQQAppInterface.a().a() != null)
            {
              ...
              if (localQQAppInterface.a().a().size() > 0)
              {
                ...
                adpn.a(paramString, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class, 9011);
                i = 1;
              }
            }
          }
    ...
    if (((paramContext instanceof QQBrowserActivity)) && (a((QQBrowserActivity)paramContext)))
    {
      ...
      adpn.a((QQBrowserActivity)paramContext, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class, 11);
    }
    while (i != 0) {
      return;
    }
    adpn.a(paramContext, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class);
  }
  ...
  public static void a(ayfv paramayfv)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ScreenShotHelper", 2, "onConfUpdate : " + paramayfv);
    }
    if (paramayfv != null) {
      jdField_a_of_type_Boolean = paramayfv.a();
    }
  }
  ...
  public static boolean a()
  {
    ...
    b = true;
    a();
    jdField_a_of_type_Boolean = jdField_a_of_type_Ayfv.a();
    if (QLog.isColorLevel()) {
  ...
  private static boolean a(QQBrowserActivity paramQQBrowserActivity)
  {
    ...
    return paramQQBrowserActivity.getSupportFragmentManager().findFragmentById(2131364785) instanceof WebViewFragment;
  }
