...
public class aygf
{
  ...
  public aygf(AppInterface paramAppInterface, Activity paramActivity, bccj parambccj, Intent paramIntent, boolean paramBoolean)
  {
  ...
  {
    aygg localaygg = new aygg(this);
    paramTouchWebView.setWebChromeClient(localaygg);
    this.jdField_a_of_type_Nke = localaygg;
  }
  ...
  public TouchWebView a(AppInterface paramAppInterface, Activity paramActivity, Intent paramIntent, boolean paramBoolean)
  {
    ...
    Object localObject2;
    if (aygb.a(paramActivity, paramIntent.getStringExtra("url")))
    {
      localObject2 = aygb.a(paramActivity);
    ...
    for (;;)
    {
      ...
      if (localObject2 == null)
      {
        ...
        String str2 = a(this.jdField_a_of_type_Bccj);
        if (((TouchWebView)localObject1).getX5WebViewExtension() == null) {
          break label891;
        }
        paramBoolean = true;
        QLog.i("WebLog_WebViewWrapper", 1, bcgc.a(str1, str2, paramBoolean));
        localObject3 = new StringBuilder();
        str1 = localWebSettings.getUserAgentString();
        str2 = a(this.jdField_a_of_type_Bccj);
        if (((TouchWebView)localObject1).getX5WebViewExtension() == null) {
          break label897;
        }
        paramBoolean = true;
        localWebSettings.setUserAgentString(bcgc.a(str1, str2, paramBoolean) + (String)localObject2);
      ...
      try
      {
        ...
        this.jdField_a_of_type_Aoyb = new aoyb(paramAppInterface, paramActivity, (TouchWebView)localObject1);
        this.jdField_a_of_type_Aoyb.a(paramBoolean);
        ((TouchWebView)localObject1).setDownloadListener(this.jdField_a_of_type_Aoyb);
        CookieSyncManager.createInstance(paramAppInterface.getApplication().getApplicationContext());
        if (((TouchWebView)localObject1).getX5WebViewExtension() != null)
        {
          ((TouchWebView)localObject1).getX5WebViewExtension().setWebViewClientExtension(new aygj(this, (TouchWebView)localObject1, this.jdField_a_of_type_Bccj));
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("WebLog_WebViewWrapper", 2, new Object[] { "sReportPerformance:", Boolean.valueOf(bcfa.x), " cost:", Long.valueOf(bcgb.a) });
          }
          return localObject1;
          ...
          paramAppInterface.put("coreInit", String.valueOf(bcgb.a));
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Boolean) {
          aygc.a().a(this.jdField_a_of_type_ComTencentBizUiTouchWebView);
        }
        for (;;)
        {
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {}
    for (Object localObject = new aygh(this);; localObject = new aygi(this))
    {
