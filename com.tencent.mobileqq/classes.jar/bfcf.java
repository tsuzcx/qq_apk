...
public class bfcf
{
  private static volatile bfcf jdField_a_of_type_Bfcf;
  public static boolean a;
  private long jdField_a_of_type_Long;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<View> jdField_a_of_type_JavaLangRefWeakReference;
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new bfch(this);
  ...
  public static bfcf a()
  {
    if (jdField_a_of_type_Bfcf == null) {}
    try
    {
      if (jdField_a_of_type_Bfcf == null) {
        jdField_a_of_type_Bfcf = new bfcf();
      }
      return jdField_a_of_type_Bfcf;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    {
      if (i != 0) {
        QIPCServerHelper.getInstance().register(new bfcg(this, "QR_LOGIN_QIPC_MODULE_NAME"));
      }
      return;
      i = 0;
    }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    for (paramArrayOfByte = new String(paramArrayOfByte);; paramArrayOfByte = alpo.a(2131711569))
    {
  ...
  public void a(Bundle paramBundle, boolean paramBoolean)
  {
    ...
    if ((!TextUtils.isEmpty("")) && (!"".equals(localObject1)))
    {
      ...
      localByteBuffer.put(arrayOfByte);
      arrayOfByte = localByteBuffer.array();
      ((ArrayList)localObject2).add(bdcv.a((byte[])localObject3));
      ((ArrayList)localObject2).add(bdcv.a(arrayOfByte));
    ...
    for (int i = 1;; i = 0)
    {
      ...
      ((ArrayList)localObject2).add(bdcv.a(((ByteBuffer)localObject3).array()));
