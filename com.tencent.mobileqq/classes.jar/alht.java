...
class alht
  extends Handler
{
  alht(alhs paramalhs, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message arg1)
  {
    ...
    case 1: 
      synchronized (alhs.a())
      {
        ...
        if ((ReportInfo)alhs.a(this.a).get(Long.valueOf(localReportHeader.seqno)) != null)
        {
          if (QLog.isColorLevel()) {
      ...
      if (localObject5 != null)
      {
        ...
        alhs.a(this.a).add(localObject5);
      }
      alhs.a(this.a).put(Long.valueOf(localObject1.seqno), localReportInfo);
      alhs.b(this.a).add(localObject1);
      alhs.a().notify();
      return;
    case 2: 
      for (;;)
      {
        synchronized (alhs.a())
        {
          ...
          localObject5 = (ReportInfo)alhs.a(this.a).get(Long.valueOf(l));
          if (localObject5 != null) {
            break;
          }
          if (QLog.isColorLevel())
    ...
    case 3: 
      for (;;)
      {
        synchronized (alhs.a())
        {
          ...
          localObject4 = (ReportInfo)alhs.a(this.a).get(Long.valueOf(l));
      ...
      else
      {
        ...
        alhs.a(this.a).add(???);
        alhs.b(this.a, 5);
        localObject4 = alhs.b(this.a).obtainMessage();
        if (localObject4 != null)
        {
          ((Message)localObject4).arg1 = 5;
          ((Message)localObject4).obj = new Object[] { Long.valueOf(l), ??? };
          alhs.b(this.a).sendMessageDelayed((Message)localObject4, 10000L);
        }
        return;
      }
      break;
    ...
    for (??? = ???.step;; ??? = ".")
    {
      ...
      synchronized (alhs.a())
      {
        ...
        if ((ReportInfo)alhs.a(this.a).get(Long.valueOf(((ReportHeader)???).seqno)) != null)
        {
          if (QLog.isColorLevel()) {
      ...
      localReportInfo.body.reportItems.add(localObject5);
      alhs.a(this.a).put(Long.valueOf(localObject3.seqno), localReportInfo);
      alhs.b(this.a).add(localObject3);
      alhs.a(this.a).add(localObject5);
      alhs.a(this.a, 1);
      return;
      ??? = ".";
