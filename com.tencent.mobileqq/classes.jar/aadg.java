  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      if (((File)localObject1).exists())
      {
        ...
        Object localObject4 = FileUtils.calcMd5(paramString);
        localObject1 = localObject2;
        if (l1 > 0L)
        {
          localObject1 = localObject2;
          if (!TextUtils.isEmpty((CharSequence)localObject4)) {
            localObject1 = HttpUtil.queryImageByIP(NetworkUtil.toDirectIpUrl(String.format(Locale.getDefault(), "https://cgi.connect.qq.com/qqconnectopen/query_share_image?key=%s&size=%d&short_url=0", new Object[] { localObject4, Long.valueOf(l1) }), 1007), str2, str3);
          }
        }
        ...
        if (QLog.isColorLevel()) {
          QLog.d(aadf.jdField_a_of_type_JavaLangString, 2, "queryImage, ret=" + ((Pair)localObject1).first + ",cost=" + l1 + ",url=" + (String)((Pair)localObject1).second);
        }
        ...
        bhvw.a().a((Bundle)localObject2, "", str2, false);
        m = 1;
        ...
        paramString.putString("intext_3", "" + bhwc.b(this.a.a.jdField_a_of_type_Int));
        paramString.putString("intext_2", "" + j);
        paramString.putString("stringext_1", this.a.a.jdField_a_of_type_JavaLangString);
        bhvw.a().a(paramString, "", this.a.a.this$0.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
        if (QLog.isColorLevel()) {
          QLog.e("shareWebPage", 2, "WebView screenshot END. thumb=" + this.a.a.this$0.i);
        }
        aadf.a(this.a.a.this$0, this.a.a.jdField_a_of_type_JavaLangString, this.a.a.jdField_a_of_type_Int, this.a.a.jdField_a_of_type_Boolean);
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          paramString.putString("stringext_1", this.a.a.jdField_a_of_type_JavaLangString);
          bhvw.a().a(paramString, "", str2, false);
          l1 = System.currentTimeMillis();
          str1 = HttpUtil.uploadImageWithHttps(NetworkUtil.toDirectIpUrl("https://cgi.connect.qq.com/qqconnectopen/upload_share_image", 1007), "cgi.connect.qq.com", str2, str3, null, (Map)localObject3, (Map)localObject2, false);
          paramString = str1;
          if (str1 == null) {
          ...
          for (;;)
          {
            ...
            if (QLog.isColorLevel())
            {
              QLog.d(aadf.jdField_a_of_type_JavaLangString, 2, paramString.getMessage());
              i = j;
              k = m;
              continue;
              i = 1;
