  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    else if (System.currentTimeMillis() - LocalMultiProcConfig.getLong(BaseApplicationImpl.getContext().getString(2131434191) + this.a.a.getAccount(), 0L) > 86400000L)
    {
      localObject1 = new HashMap();
      if (!LocalMultiProcConfig.getBool(BaseApplicationImpl.getContext().getString(2131434190) + this.a.a.getAccount(), true)) {
        break label624;
      }
    ...
    for (;;)
    {
      ...
      LocalMultiProcConfig.putLong(BaseApplicationImpl.getContext().getString(2131434191) + this.a.a.getAccount(), System.currentTimeMillis());
      return;
