  ...
  extends PopupWindow
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new blmo(this);
  View jdField_a_of_type_AndroidViewView;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  LinearLayout jdField_a_of_type_AndroidWidgetLinearLayout;
  blmq jdField_a_of_type_Blmq;
  blmr jdField_a_of_type_Blmr = new blmp(this);
  ...
  public blmm(@NonNull Context paramContext)
  {
    super(paramContext);
    ...
    this.jdField_b_of_type_JavaLangString = anzj.a(2131704817);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560234, null);
  ...
  private void a(Object paramObject, boolean paramBoolean)
  {
    ...
    ocd.a(null, "", "0X8009990", "0X8009990", 0, 0, String.valueOf(this.r), "", this.jdField_c_of_type_JavaLangString, localJSONObject.toString(), false);
  }
  ...
  private void e()
  {
    ...
    {
      if (i1 <= 1) {
        ((View)this.jdField_f_of_type_JavaUtilArrayList.get(0)).setBackgroundResource(2130842912);
      }
    }
    else {
      return;
    }
    ((View)this.jdField_f_of_type_JavaUtilArrayList.get(0)).setBackgroundResource(2130842914);
    ((View)this.jdField_f_of_type_JavaUtilArrayList.get(i1 - 1)).setBackgroundResource(2130842913);
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, ArrayList<DislikeInfo> paramArrayList, String paramString)
  {
    ...
    for (paramInt1 = paramArrayList.size();; paramInt1 = 0)
    {
      ...
      paramArrayList = new DislikeInfo();
      paramArrayList.jdField_a_of_type_JavaLangString = BaseApplicationImpl.getContext().getString(2131717169);
      paramArrayList.jdField_a_of_type_Int = 8;
      paramArrayList.jdField_b_of_type_JavaLangString = "";
      this.jdField_e_of_type_JavaUtilArrayList.add(paramArrayList);
      a(this.jdField_a_of_type_JavaUtilArrayList, this.jdField_b_of_type_AndroidViewView, 2130841658, anzj.a(2131704823), true);
      a(this.jdField_b_of_type_JavaUtilArrayList, this.jdField_c_of_type_AndroidViewView, 2130841662, anzj.a(2131704833), true);
      a(this.jdField_c_of_type_JavaUtilArrayList, this.jdField_d_of_type_AndroidViewView, 2130841651, a(this.jdField_c_of_type_JavaUtilArrayList), false);
      a(this.jdField_d_of_type_JavaUtilArrayList, this.jdField_e_of_type_AndroidViewView, 2130841655, anzj.a(2131704829), false);
      a(this.jdField_e_of_type_JavaUtilArrayList, this.jdField_f_of_type_AndroidViewView, 2130841650, BaseApplicationImpl.getContext().getString(2131717169), false);
      a();
  ...
  {
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131371710);
    this.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131371706);
    this.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131371712);
    this.jdField_e_of_type_AndroidViewView = paramView.findViewById(2131371709);
    this.jdField_f_of_type_AndroidViewView = paramView.findViewById(2131371708);
    ...
    ((ImageView)paramView.findViewById(2131366686).findViewById(2131369836)).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.i = ((int)bhlo.i());
    this.j = ((int)bhlo.j());
    ...
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(1L), anzj.a(2131704830));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(2L), anzj.a(2131704828));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(3L), anzj.a(2131704819));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(4L), anzj.a(2131704820));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(5L), anzj.a(2131704825));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(6L), anzj.a(2131704824));
    this.m = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131298689));
    this.jdField_e_of_type_AndroidViewView.findViewById(2131377371).setVisibility(4);
    setBackgroundDrawable(new ColorDrawable());
    setOnDismissListener(new blmn(this));
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
  }
  
  public void a(View paramView, blmq paramblmq)
  {
    if (isShowing()) {
      dismiss();
    }
    this.jdField_a_of_type_Blmq = paramblmq;
    paramblmq = new int[2];
    try
    {
      bool = a(paramView, paramblmq);
      if (bool)
      {
        showAtLocation(paramView, 51, paramblmq[0], paramblmq[1]);
        a(0.8F);
        a(this);
      }
      return;
  ...
  protected void a(ArrayList<DislikeInfo> paramArrayList, View paramView, int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    if (!paramArrayList.isEmpty())
    {
      ...
      {
        ((TextView)paramView.findViewById(2131368993)).setText(paramString);
        localTextView = (TextView)paramView.findViewById(2131368989);
        localImageView = (ImageView)paramView.findViewById(2131368977);
        ((ImageView)paramView.findViewById(2131368913)).setImageResource(paramInt);
        paramString = "";
        if (!paramBoolean) {
          break label150;
        }
  ...
  public void a(pqk parampqk, ArrayList<DislikeInfo> paramArrayList)
  {
    int i2 = 0;
    String str = null;
    if (parampqk != null) {}
    for (;;)
    {
      try
      {
        i1 = parampqk.jdField_b_of_type_Int;
        i2 = parampqk.jdField_a_of_type_Int;
        parampqk = parampqk.a();
        int i3 = ozs.a(parampqk);
        str = "";
        if (parampqk != null) {
          str = parampqk.innerUniqueID;
        }
        a(i1, i2, i3, paramArrayList, str);
        return;
      }
      catch (Exception parampqk)
      {
        return;
      }
      int i1 = 0;
  ...
  protected void c(View paramView)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Blmq == null);
      paramView = paramView.getTag();
    } while (!(paramView instanceof DislikeInfo));
    ArrayList localArrayList = new ArrayList();
    localArrayList.add((DislikeInfo)paramView);
    this.jdField_a_of_type_Blmq.a(null, this.o, localArrayList, null);
  }
