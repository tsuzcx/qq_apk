...
public class axux
{
  private static final SparseArray<Class<? extends axuo>> jdField_a_of_type_AndroidUtilSparseArray;
  private static HashMap<String, Class<? extends axun>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  
  static
  {
    jdField_a_of_type_JavaUtilHashMap.put("pavideo", axzb.class);
    jdField_a_of_type_JavaUtilHashMap.put("video", axzq.class);
    jdField_a_of_type_JavaUtilHashMap.put("picture", axwq.class);
    jdField_a_of_type_JavaUtilHashMap.put("title", StructMsgItemTitle.class);
    jdField_a_of_type_JavaUtilHashMap.put("summary", axzh.class);
    jdField_a_of_type_JavaUtilHashMap.put("timer", axzl.class);
    jdField_a_of_type_JavaUtilHashMap.put("hr", axws.class);
    jdField_a_of_type_JavaUtilHashMap.put("image", axwt.class);
    jdField_a_of_type_JavaUtilHashMap.put("more", axyv.class);
    jdField_a_of_type_JavaUtilHashMap.put("progress", axzf.class);
    jdField_a_of_type_JavaUtilHashMap.put("checklist", axzz.class);
    jdField_a_of_type_JavaUtilHashMap.put("vote", ayab.class);
    jdField_a_of_type_JavaUtilHashMap.put("price", axze.class);
    jdField_a_of_type_JavaUtilHashMap.put("button", axwk.class);
    jdField_a_of_type_JavaUtilHashMap.put("remark", axzg.class);
    jdField_a_of_type_JavaUtilHashMap.put("paaudio", axyw.class);
    jdField_a_of_type_JavaUtilHashMap.put("textButton", axzj.class);
    jdField_a_of_type_JavaUtilHashMap.put("content", axwp.class);
    jdField_a_of_type_JavaUtilHashMap.put("tips", axwc.class);
    jdField_a_of_type_JavaUtilHashMap.put("live", axvw.class);
    jdField_a_of_type_JavaUtilHashMap.put("tr", axzo.class);
    jdField_a_of_type_JavaUtilHashMap.put("td", axzi.class);
    jdField_a_of_type_JavaUtilHashMap.put("head", axwj.class);
    jdField_a_of_type_JavaUtilHashMap.put("type", axzp.class);
    jdField_a_of_type_JavaUtilHashMap.put("tag", axwa.class);
    jdField_a_of_type_JavaUtilHashMap.put("taglist", axwb.class);
    jdField_a_of_type_JavaUtilHashMap.put("group", axvq.class);
    jdField_a_of_type_JavaUtilHashMap.put("groupitem", axvs.class);
    jdField_a_of_type_JavaUtilHashMap.put("voice", axwd.class);
    jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
    jdField_a_of_type_AndroidUtilSparseArray.append(0, axym.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(1, axwu.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(2, axxg.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(3, axya.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(4, axyd.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(5, axye.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(6, axyg.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(7, axyi.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(8, axyk.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(9, axyl.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(10, axwv.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(11, axwx.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(12, axwz.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(18, axxd.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(19, axxf.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(20, axxh.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(21, axxk.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(22, axxl.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(23, axxm.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(24, axxo.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(25, axxr.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(26, axxs.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(27, axxt.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(28, axxu.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(29, axxx.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(30, axyb.class);
  }
  
  public static axun a(String paramString)
  {
    return a(paramString, 0);
  }
  
  /* Error */
  public static axun a(String paramString, int paramInt)
  {
    // Byte code:
    //   0: ldc 210
    //   2: aload_0
    ...
    //   6: ifne +72 -> 78
    //   9: getstatic 18	axux:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   12: aload_0
    ...
    //   76: aload_3
    //   77: areturn
    //   78: getstatic 143	axux:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   81: iload_1
  ...
  /* Error */
  public static axuo a(int paramInt)
  {
    // Byte code:
    //   0: getstatic 143	axux:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   3: iload_0
