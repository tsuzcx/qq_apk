  ...
  implements Handler.Callback
{
  ...
  public nrk(Context paramContext, nmq paramnmq)
  {
    super(paramContext);
    ...
    paramContext = nnm.b().a();
    if (paramContext != null) {
      paramContext.a(this.jdField_a_of_type_Nnt);
    }
    paramContext = nqt.a();
    if (paramContext != null)
    {
  ...
  private boolean l()
  {
    Player localPlayer = nfc.a().a().b();
    if (localPlayer != null) {
      return nfc.a().a().getAccount().equals(localPlayer.uin);
    }
    return false;
  }
  ...
  public void a()
  {
    if (m())
    {
      ...
      bjuc.c(this.jdField_a_of_type_JavaLangString, "onSelfGuessActionStart " + bool + " " + this.jdField_b_of_type_Long + " " + localGameRecordInfo);
  ...
  public void a(View paramView)
  {
    ...
    {
      boolean bool = d();
      bjuc.c(this.jdField_a_of_type_JavaLangString, "onTopicViewDismiss " + bool);
      a(null, 0, 0, 0, 0);
    }
  }
  ...
  public void b()
  {
    ...
    {
      boolean bool = d();
      bjuc.c(this.jdField_a_of_type_JavaLangString, "onSelfGuessActionEnd " + bool);
      this.jdField_a_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(2);
    }
  }
  ...
  public void e()
  {
    bjuc.c(this.jdField_a_of_type_JavaLangString, "onGameOver ");
    if (m())
    {
      this.jdField_a_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return true;
          bjuc.c(this.jdField_a_of_type_JavaLangString, "start record come." + d());
        } while (d());
        this.jdField_a_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
        ...
        for (;;)
        {
          if (!f())
          {
            bjuc.c(this.jdField_a_of_type_JavaLangString, "start record but camera close");
            a(true);
        ...
        this.jdField_a_of_type_AndroidOsHandler.removeMessages(3);
        return true;
        bjuc.c(this.jdField_a_of_type_JavaLangString, "render no camera come." + f() + d());
        if (f())
        {
          this.jdField_a_of_type_AndroidOsHandler.removeMessages(3);
          return true;
        ...
        if (d())
        {
          if ((this.jdField_a_of_type_Mou != null) && (this.jdField_a_of_type_Mou.a())) {}
          for (boolean bool1 = true;; bool1 = false)
          {
            ...
            {
              bool2 = bool3;
              if (this.jdField_a_of_type_Mou.b()) {
                bool2 = true;
              }
            }
            bjuc.c(this.jdField_a_of_type_JavaLangString, "render no camera ." + bool1 + " " + bool2);
        ...
        bjuc.c(this.jdField_a_of_type_JavaLangString, "render no camera ." + this.jdField_d_of_type_Boolean);
      } while ((!this.jdField_d_of_type_Boolean) || (this.jdField_a_of_type_Nmq == null) || (this.jdField_a_of_type_Nmq.a() == null));
      this.jdField_a_of_type_Nmq.a().requestRender();
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(3, 50L);
      return true;
  ...
  public void l()
  {
    ...
    super.l();
    r();
    AVGameCameraAssistant localAVGameCameraAssistant = nnm.b().a();
