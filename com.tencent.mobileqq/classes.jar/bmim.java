...
public class bmim
{
  ...
  public bmim(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private void a(Activity paramActivity, int paramInt, String paramString, zyf paramzyf)
  {
    if (paramActivity == null) {
      return;
    }
    String str = anzj.a(2131709579);
    if (1 == paramInt) {
      paramString = str + anzj.a(2131709582) + paramString + anzj.a(2131709577);
    }
    for (;;)
    {
      bhlq.a(paramActivity, 230, paramActivity.getString(2131697628), paramString, 2131697622, 2131697622, new bmiv(this, paramzyf), null).show();
      return;
      if (2 == paramInt) {
        paramString = str + anzj.a(2131709581) + paramString + anzj.a(2131709576);
      } else {
        paramString = anzj.a(2131709578);
      }
    }
  }
  ...
  public static void a(Context paramContext, int paramInt, Bundle paramBundle)
  {
    if (paramContext == null)
    {
      ...
      Toast.makeText(BaseApplication.getContext(), anzj.a(2131709580), 0).show();
      return;
    }
    ...
    if ((paramContext instanceof abdi)) {
  ...
  private void h()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 161	bmim:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +6 -> 14
    //   11: aload_0
    ...
    //   30: putfield 161	bmim:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   33: aload_0
    //   34: getfield 161	bmim:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   37: new 170	cooperation/qlink/QQProxyForQlink$9
    //   40: dup
    //   41: aload_0
    //   42: invokespecial 172	cooperation/qlink/QQProxyForQlink$9:<init>	(Lbmim;)V
    //   45: lconst_0
    //   46: ldc2_w 173
  ...
  private void j()
  {
    ...
    {
      this.jdField_b_of_type_AndroidContentBroadcastReceiver = new bmin(this);
  ...
  private void l()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 223	bmim:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   8: ifnonnull +58 -> 66
    //   11: aload_0
    //   12: new 225	bmio
    //   15: dup
    //   16: aload_0
    //   17: invokespecial 226	bmio:<init>	(Lbmim;)V
    //   20: putfield 223	bmim:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   37: aload_0
    //   38: getfield 28	bmim:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   41: ifnull +11 -> 52
    //   44: aload_0
    //   45: getfield 28	bmim:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   56: aload_1
    //   57: aload_0
    //   58: getfield 223	bmim:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   61: aload_2
    ...
    //   77: aload_0
    //   78: aconst_null
    //   79: putfield 223	bmim:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   82: goto -16 -> 66
    //   85: astore_1
    //   86: aload_0
    //   87: monitorexit
  ...
  private void m()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 223	bmim:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   6: ifnull +28 -> 34
    //   9: aload_0
    //   10: getfield 28	bmim:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13: ifnull +13 -> 26
    //   16: aload_0
    //   17: getfield 28	bmim:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   44: aload_0
    //   45: getfield 223	bmim:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   51: aload_0
    //   52: aconst_null
    //   53: putfield 223	bmim:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   56: goto -22 -> 34
    //   59: astore_1
    //   60: aload_0
    //   61: monitorexit
  ...
  public void a(Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener1, DialogInterface.OnClickListener paramOnClickListener2, DialogInterface.OnClickListener paramOnClickListener3, String paramString)
  {
    ...
    {
      return;
      String str2 = bhlg.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin);
      String str1;
      if (str2 != null)
      {
        str1 = str2;
      ...
      {
        a("0X8004854", 1);
        paramOnClickListener3 = paramActivity.getResources().getString(2131697668) + str1 + paramActivity.getResources().getString(2131697669);
        ...
        {
          this.jdField_a_of_type_Bhpc = bhlq.a(paramActivity, 230, paramActivity.getResources().getString(2131697629), paramOnClickListener3, paramActivity.getResources().getString(2131697670), paramActivity.getResources().getString(2131697670), paramOnClickListener2, null);
          label194:
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Bhpc.setOnDismissListener(new bmis(this));
        return;
        label224:
        str1 = this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin;
        break;
        this.jdField_a_of_type_Bhpc = bhlq.a(paramActivity, 230, paramActivity.getResources().getString(2131697629), paramOnClickListener3, paramActivity.getResources().getString(2131697670), paramActivity.getResources().getString(2131697671), paramOnClickListener1, paramOnClickListener2);
        break label194;
        if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode == 2)
        {
          a("0X8004856", 1);
          paramOnClickListener1 = str1 + paramActivity.getResources().getString(2131697667);
          this.jdField_a_of_type_Bhpc = bhlq.a(paramActivity, 230, paramActivity.getResources().getString(2131697629), paramOnClickListener1, paramActivity.getResources().getString(2131697666), paramActivity.getResources().getString(2131697666), paramOnClickListener3, null);
          this.jdField_a_of_type_Bhpc.show();
        }
  ...
  public void a(Activity paramActivity, ArrayList<String> paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean, String paramString)
  {
    ...
    paramActivity.finish();
    return;
    a(paramActivity, new bmip(this, paramArrayList, paramActivity, paramInt1, paramBoolean), new bmiq(this), new bmir(this), paramString);
  }
  ...
  public void a(QlAndQQInterface.InsertFMFileInfo paramInsertFMFileInfo)
  {
    ...
    String str = aunj.a(paramInsertFMFileInfo.filePath);
    long l1 = aunj.a(paramInsertFMFileInfo.filePath);
    long l2 = bcry.a(-1000).uniseq;
    ...
    localFileManagerEntity.nFileType = aunj.a(paramInsertFMFileInfo.filePath);
    ...
    if (localanyw.e(String.valueOf(localFileManagerEntity.peerUin)) != null)
    {
      localFileManagerEntity.peerType = 0;
      localFileManagerEntity.peerNick = aunj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInsertFMFileInfo.uin, null, 0);
      localFileManagerEntity.status = 1;
      if ((!localanyw.b(paramInsertFMFileInfo.uin)) && (!paramInsertFMFileInfo.bSend)) {
        break label356;
      }
      localFileManagerEntity.nOpType = 0;
      localFileManagerEntity.bSend = true;
      beyo.a(paramInsertFMFileInfo.filePath, 0L, 0, true);
    ...
    for (;;)
    {
      ...
      beyo.a(paramInsertFMFileInfo.filePath, l1, 0, false, null);
      berv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), str, 0, null);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localFileManagerEntity);
    }
  }
  ...
  {
    String str = bhlg.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
    anyw localanyw = (anyw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", paramString, paramString, 0, paramInt, 0, "", "", "", "");
  }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean, long paramLong1, long paramLong2, HashMap<String, String> paramHashMap)
  {
    ...
    bmja.a(paramString1, paramString2, paramBoolean, paramLong1, paramLong2, paramHashMap);
  }
  
  public void a(AppActivity paramAppActivity, String paramString, zyf paramzyf)
  {
    if ((paramAppActivity == null) || (paramString == null)) {
      return;
    }
    bmiz localbmiz = bmiy.a(paramString);
    if (localbmiz == null)
    {
      bhlq.a(paramAppActivity, 230, paramAppActivity.getString(2131697628), paramAppActivity.getString(2131697648), 2131697622, 2131697622, new bmit(this, paramzyf), null).show();
      return;
    }
    if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mWorking)
    {
      a(paramAppActivity, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerNick, paramzyf);
      return;
    }
    ...
    paramzyf = new Bundle();
    paramzyf.putString("url", paramString);
    paramzyf.putString("key", localbmiz.a);
    paramzyf.putString("peerUin", localbmiz.b);
    paramzyf.putString("peerNick", localbmiz.c);
    paramzyf.putString("peerOS", localbmiz.d);
    paramzyf.putString("apSSID", localbmiz.e);
    paramzyf.putString("preSharedKey", localbmiz.f);
    paramzyf.putBoolean("fromqlink", bool);
    paramString = paramAppActivity.getIntent().getStringExtra("subfrom");
    if (paramString != null) {
      paramzyf.putString("subfrom", paramString);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    a(paramAppActivity, 11, paramzyf);
    paramAppActivity.finish();
  }
  
  public void a(AppActivity paramAppActivity, zyf paramzyf)
  {
    if (paramAppActivity == null) {
      return;
    }
    bhlq.a(paramAppActivity, 230, paramAppActivity.getString(2131697646), paramAppActivity.getString(2131697647), 2131697622, 2131697622, new bmiu(this, paramzyf), null).show();
  }
  ...
  public boolean a(String paramString, List<String> paramList)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      localSendFileInfo.sessionid = aunj.a().longValue();
      localSendFileInfo.filePath = paramList;
      localSendFileInfo.fileSize = aunj.a(paramList);
  ...
  {
    if (1 == paramInt) {
      aunj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext());
    }
  }
