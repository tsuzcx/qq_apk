...
public class qeb
{
  ...
  private void a()
  {
    ...
    if ((this.jdField_a_of_type_Int != a()) || (qdz.a().a))
    {
    ...
    for (;;)
    {
      ...
      if ((localObject1 != null) && (((List)localObject1).size() > 0))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          {
            localObject2 = algs.a(((RecentUser)localObject2).uin, ((RecentUser)localObject2).getType());
            localObject2 = algs.a().a((String)localObject2);
  ...
  private void h()
  {
    ...
    {
      return;
      localObject1 = (List)((antp)localObject1).a().clone();
      if ((localObject1 != null) && (((List)localObject1).size() > 0))
      {
        localObject1 = ((List)localObject1).iterator();
        while (((Iterator)localObject1).hasNext())
  ...
  private void i()
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if (localObject2 != null)
      {
        ...
        ArrayList localArrayList = localanvk.a(String.valueOf(((Groups)localObject2).group_id));
        if ((localArrayList != null) && (localArrayList.size() > 0))
        {
          ...
          while (((Iterator)localObject3).hasNext())
          {
            ...
            if (localEntity != null)
            {
              ...
              if (localanvk.a(localFriends.uin) != null) {
