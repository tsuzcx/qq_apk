  ...
  implements qdy
{
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      try
      {
        localpzf.a(str1).d(paramBaseArticleInfo, str2).i(paramBaseArticleInfo).q(paramBaseArticleInfo);
        return localpzf.a();
      }
      ...
      try
      {
        localpzf.a("ReadInjoy_QA_NoImage_cell");
      }
      catch (JSONException paramBaseArticleInfo)
      {
        paramBaseArticleInfo.printStackTrace();
  ...
  public void a(int paramInt1, Container paramContainer, pvc parampvc, int paramInt2)
  {
    ...
    if ((localObject == null) || (parampvc == null) || (parampvc.a() == null)) {}
    ...
    boolean bool = pkm.a().a(parampvc.a().mArticleID);
