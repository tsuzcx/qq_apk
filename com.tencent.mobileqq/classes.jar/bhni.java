...
public class bhni
{
  private static bhni jdField_a_of_type_Bhni;
  ...
  public static bhni a()
  {
    try
    {
      if (jdField_a_of_type_Bhni == null) {
        jdField_a_of_type_Bhni = new bhni();
      }
      bhni localbhni = jdField_a_of_type_Bhni;
      return localbhni;
    }
    finally {}
  }
  ...
  public void a(String paramString1, String paramString2, Downloader.DownloadListener paramDownloadListener)
  {
    ...
    paramDownloadListener = new bhnj(this, paramString2, paramDownloadListener, paramString1);
    paramString2 = jdField_a_of_type_JavaIoFile.getAbsolutePath() + "/tmp" + paramString2;
    this.jdField_a_of_type_Bhaa.a(paramString1, paramString2, paramDownloadListener);
  }
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    if (localFile.length() == a(paramString)) {
      if (paramBoolean)
      {
        String str1 = bdhv.a(b(paramString));
  ...
  public void b()
  {
    QzoneModuleManager.getInstance().downloadModule("pictureMarkerSo.zip", new bhnk(this));
  }
  ...
  public void c()
  {
    QzoneModuleManager.getInstance().downloadModule("libandroidndkbeauty.so", new bhnl(this));
  }
}
