  ...
  implements bdko
{
  ...
  protected String a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, String paramString3, int paramInt4, int paramInt5)
  {
    ...
    catch (JSONException paramString1)
    {
      for (;;)
      {
        bdht.c("WebViewDownloadListener", "getCallBackJsonObject >>> ", paramString1);
      }
    }
  }
  ...
  {
    bdiz localbdiz = bdiz.a();
    for (;;)
    {
      int i;
      try
      {
        int j = localbdiz.a().size();
        i = 0;
        if (i < j)
        {
          Object localObject = (bdiy)localbdiz.a().get(i);
          ...
          if (localWebView != null) {
            if (TextUtils.isEmpty(((bdiy)localObject).getJsCallbackMethod()))
            {
              ...
              bdht.a("WebViewDownloadListener", " commonJsCallBack >>> " + (String)localObject);
      ...
      {
        bdht.c("WebViewDownloadListener", "doJsCallback >>> ", paramString);
      }
      i += 1;
    }
  }
