...
public class lwj
  extends lwr
{
  private lwj(AVServiceForQQ paramAVServiceForQQ) {}
  ...
  public int a(long paramLong, int paramInt)
  {
    ...
    if (this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)
    {
      ...
      if (((ldw)((Iterator)localObject).next()).c != 1) {
        break label123;
      }
      paramInt += 1;
    }
  ...
  public void a(long paramLong, String paramString)
  {
    ...
    AVServiceForQQ.a(this.a, mtt.a());
    AVServiceForQQ.a(this.a).a(null);
    AVServiceForQQ.a(this.a).c();
    AVServiceForQQ.a(this.a).d();
    if ((ldc.a().a().jdField_a_of_type_Lgh.jdField_a_of_type_Int == 3) && ((paramLong == -1L) || (paramLong == ldc.a().a().jdField_a_of_type_Lgh.jdField_a_of_type_Long)))
    {
    ...
    for (;;)
    {
      ...
      localVideoController.a().jdField_a_of_type_Lgg.b = paramString;
      localVideoController.a().az = true;
      return;
      this.a.b = ldc.a(AVServiceForQQ.a(this.a), String.valueOf(paramLong), new int[0]);
      ldc.a().a(this.a.b, false);
      ...
      AVServiceForQQ.a(this.a).a();
      if (ldc.a().b(this.a.b).jdField_g_of_type_Boolean)
      {
        localVideoController.a("enterRoom", ldc.a().b(this.a.b).jdField_a_of_type_Lgh.jdField_a_of_type_Long, false, false);
        break label344;
      }
      localVideoController.a("enterRoom", ldc.a().b(this.a.b).jdField_a_of_type_Lgh.jdField_a_of_type_Long, true, false);
      break label344;
      label567:
  ...
  public void c()
  {
    ...
    for (;;)
    {
      ...
      lcl.c(this.a.jdField_a_of_type_JavaLangString, "DataReport onClose: ");
      lhv.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      ljv.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      liw.a(this.a.jdField_a_of_type_JavaLangString, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      mcc.b(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin());
