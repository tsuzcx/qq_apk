...
public class ubn
{
  ...
  public ubn(@NonNull Activity paramActivity, @NonNull RMVideoStateMgr paramRMVideoStateMgr, @NonNull Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_Boolean = paramIntent.getBooleanExtra("extra_now_tab", skt.a(2131034115).booleanValue());
    ...
    if ((paramIntent.getIntExtra("edit_video_type", 0) == 10002) && (this.jdField_a_of_type_Long > 0L)) {
      urp.b("take_video", "video_startup", 0, 0, new String[] { "", String.valueOf(SystemClock.uptimeMillis() - this.jdField_a_of_type_Long), String.valueOf(this.jdField_b_of_type_Int) });
    }
    urk.a("QQStoryTakeVideoHelper", "default label:%s", this.jdField_a_of_type_JavaLangString);
  }
  ...
  private void a(PublishParam paramPublishParam, String paramString, int paramInt)
  {
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      if (sku.a())
      {
        StoryTransitionActivity.a(this.jdField_a_of_type_AndroidAppActivity, uaw.class.getName(), null);
  ...
  private boolean a()
  {
    ...
    {
      urk.e("QQStoryTakeVideoHelper", "check manifest's existance error. directory is null.");
      return false;
    }
    return bace.a(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_JavaLangString + File.separator + "manifest.ini");
  }
  
  public String a()
  {
    return (String)((spz)sqg.a(10)).b("StorySvc.get_photography_guide.word", ajjy.a(2131645263));
  }
  
  public String a(String paramString)
  {
    Object localObject = (spz)sqg.a(10);
    int i = ((Integer)((spz)localObject).b("StoryVideoWidth", Integer.valueOf(-1))).intValue();
    int j = ((Integer)((spz)localObject).b("StoryVideoHeight", Integer.valueOf(-1))).intValue();
    int k = ((Integer)((spz)localObject).b("StoryVideoMaxrate", Integer.valueOf(-1))).intValue();
    int m = ((Integer)((spz)localObject).b("StoryVideoMinrate", Integer.valueOf(-1))).intValue();
    String str = (String)((spz)localObject).b("StoryVideoKey", "960*720#600#1000;640*480#450#750");
    urk.b("QQStoryTakeVideoHelper", "setupStoryVideoConfig : key = " + str + " width = " + i + " height = " + j + " maxrate = " + k + " minrate = " + m);
    if ((i == -1) && (j == -1) && (k == -1) && (m == -1) && ((str == null) || (str.isEmpty()) || (str.equals("-1")))) {
      urk.b("QQStoryTakeVideoHelper", "setupStoryVideoConfig : no configs");
    }
    label390:
    ...
    urk.d("QQStoryTakeVideoHelper", "setupStoryVideoConfig(): newConfig = " + paramString);
    return paramString;
  }
  
  public void a()
  {
    ulw.a(new ubq(this, (spz)sqg.a(10)));
  }
  
  public void a(Intent paramIntent, @NonNull ImageView paramImageView)
  {
    urk.b("QQStoryTakeVideoHelper", "preview confirm");
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        urk.b("QQStoryTakeVideoHelper", "preview confirm takephoto ");
      ...
      if (!a())
      {
        urk.d("QQStoryTakeVideoHelper", "manifest file doesn't exist. generate again before publishing.");
        a(new ubo(this, localPublishParam, str, i));
        return;
      }
      urk.c("QQStoryTakeVideoHelper", "manifest file already exists. start publishing.");
      a(localPublishParam, str, i);
      return;
    }
  ...
  public void a(ubr paramubr)
  {
    this.jdField_a_of_type_Int = 1;
    Stream.of(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr).map(new ThreadOffFunction("QQStoryTakeVideoHelper", 2)).map(new vfq()).subscribe(new ubp(this, paramubr));
  }
