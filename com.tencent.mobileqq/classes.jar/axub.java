...
public class axub
{
  ...
  private static HashMap<String, axuc> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public static axuh a(String paramString)
  {
    ...
    localaxuh.jdField_a_of_type_JavaLangString = paramString[0];
    if (paramString.length == 2)
    {
      localaxuh.jdField_a_of_type_Int = Integer.valueOf(paramString[1]).intValue();
      return localaxuh;
    }
    localaxuh.jdField_a_of_type_Int = 80;
    return localaxuh;
  }
  ...
  public static String a()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 107	axub:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   6: ifnull +12 -> 18
    //   9: getstatic 107	axub:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   12: astore_0
    //   13: ldc 2
    //   15: monitorexit
    //   16: aload_0
    //   17: areturn
    //   18: ldc 109
    //   20: putstatic 107	axub:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   69: putstatic 107	axub:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   72: getstatic 107	axub:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   75: astore_0
    //   76: goto -63 -> 13
    //   79: astore_0
    //   80: ldc 109
    //   82: putstatic 107	axub:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   85: aload_0
    ...
    synchronized (jdField_a_of_type_JavaUtilHashMap)
    {
      ...
      if ((paramInt2 < 2) || (jdField_a_of_type_JavaUtilRandom.nextInt(paramInt2) == 1) || (b())) {
        synchronized (jdField_a_of_type_JavaUtilHashMap)
        {
          ...
          jdField_a_of_type_JavaUtilHashMap.put(paramString, new axuc(paramInt1, paramArrayOfString));
  ...
  public static void a(String paramString1, boolean paramBoolean, String paramString2)
  {
    synchronized (jdField_a_of_type_JavaUtilHashMap)
    {
      if (jdField_a_of_type_JavaUtilHashMap.containsKey(paramString1))
      {
        ...
        axuc localaxuc = (axuc)jdField_a_of_type_JavaUtilHashMap.remove(paramString1);
        if (localaxuc != null)
        {
          ...
          if (paramString1 != null)
          {
            ...
            QLog.endColorLog(localaxuc.jdField_a_of_type_ArrayOfJavaLangString, localaxuc.jdField_a_of_type_Int, paramBoolean, paramString2, str, paramString1);
          }
        }
  ...
  private static boolean b()
  {
    ...
    {
      String str = bahj.a(ServerConfigManager.ConfigType.app, "active_log_upload");
