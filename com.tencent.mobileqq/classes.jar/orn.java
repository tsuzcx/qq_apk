  ...
  implements pwk
{
  ...
  private orq jdField_a_of_type_Orq = new orq();
  private Map<Integer, List<orp>> b = new HashMap();
  private Map<String, List<Double>> c = new HashMap();
  
  private orn()
  {
    pwf.a(this);
    bmie.a().a(this.jdField_a_of_type_Orq);
  }
  ...
  private JSONObject a()
  {
    ...
    localJSONObject.put("cpu_type", DeviceInfoUtil.getCpuType());
    localJSONObject.put("cpu_frequency", DeviceInfoUtil.getCpuFrequency());
    localJSONObject.put("cache_memory", DeviceInfoUtil.getSystemTotalMemory());
    localJSONObject.put("device_model", DeviceInfoUtil.getDeviceModel());
    localJSONObject.put("os_version", DeviceInfoUtil.getDeviceOSVersion());
    if (NetworkState.isWifiConn()) {}
    for (int i = 1;; i = 2)
    {
      localJSONObject.put("network_type", i);
      localJSONObject.put("package_name", "8.4.10.4875");
  ...
  {
    boolean bool = ((Boolean)bmhv.a("sp_key_readinjoy_feeds_drop_frame_switch", Boolean.valueOf(true))).booleanValue();
    QLog.d("ReadInJoyDropFrameHelper", 1, "ReadInJoyDropFrameHelper | Report enable :" + bool);
    return bool;
  }
  
  public void a(int paramInt, orp paramorp)
  {
    if (this.b != null) {
    ...
    {
      if (!((List)localObject).contains(paramorp)) {
        ((List)localObject).add(paramorp);
      }
  ...
  public void b(int paramInt, orp paramorp)
  {
    if ((this.b != null) && (this.b.get(Integer.valueOf(paramInt)) != null)) {
      ((List)this.b.get(Integer.valueOf(paramInt))).remove(paramorp);
    }
  }
