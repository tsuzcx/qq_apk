...
public class bjdq
{
  private static bjdu jdField_a_of_type_Bjdu;
  private static Object jdField_a_of_type_JavaLangObject;
  private static String jdField_a_of_type_JavaLangString = "";
  private static final HashMap<String, bjds> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public static bjds a()
  {
    return a("audio", 104857600, 41943040);
  }
  
  public static bjds a(String paramString, int paramInt1, int paramInt2)
  {
    boolean bool = true;
    ...
    for (;;)
    {
      ...
      {
        bjds localbjds2 = (bjds)jdField_a_of_type_JavaUtilHashMap.get(paramString);
        bjds localbjds1 = localbjds2;
        if (localbjds2 == null)
        {
          localbjds1 = new bjds(paramString, 1, paramInt1, paramInt2);
          localbjds1.a(a());
          jdField_a_of_type_JavaUtilHashMap.put(paramString, localbjds1);
        }
        return localbjds1;
      }
      bool = false;
  ...
  public static bjdu a()
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Bjdu == null) {
        jdField_a_of_type_Bjdu = new bjdu(new bjdr());
      }
      return jdField_a_of_type_Bjdu;
    }
  }
  ...
  static void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      jdField_b_of_type_JavaLangString = bjea.jdField_b_of_type_JavaLangString;
    }
  }
  ...
  {
    Object localObject = bjea.jdField_b_of_type_JavaLangString;
    if (localObject != null)
    {
  ...
  {
    return bduw.a(aljq.bd + UUID.randomUUID().toString() + ".jpg");
  }
