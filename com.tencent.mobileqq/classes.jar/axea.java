...
public class axea
{
  public static bbms a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    axem localaxem = (axem)paramQQAppInterface.a(120);
    if ((paramContext == null) || (localaxem == null) || (paramTeamWorkFileImportInfo == null) || (paramTeamWorkFileImportInfo.jdField_a_of_type_Int != 1)) {
      return null;
    }
  ...
  public static bbms a(QQAppInterface paramQQAppInterface, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, Context paramContext, String paramString)
  {
    paramQQAppInterface = (axem)paramQQAppInterface.a(120);
  ...
  public static bbms a(QQAppInterface paramQQAppInterface, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, Context paramContext, String paramString1, String paramString2, boolean paramBoolean)
  {
    axem localaxem = (axem)paramQQAppInterface.a(120);
    if ((localaxem == null) || (paramTeamWorkFileImportInfo == null) || (TextUtils.isEmpty(paramString2))) {}
    do
    {
      return null;
      paramTeamWorkFileImportInfo.jdField_e_of_type_Boolean = true;
      if (paramString2.equals(paramContext.getString(2131654242))) {}
      ...
      {
        localaxem.a(paramTeamWorkFileImportInfo, paramBoolean);
        if ((localaxem.a(paramTeamWorkFileImportInfo)) || (!TextUtils.isEmpty(localaxem.a(paramTeamWorkFileImportInfo))) || (!paramTeamWorkFileImportInfo.jdField_d_of_type_Boolean)) {
          break;
        }
        localaxem.a(paramTeamWorkFileImportInfo);
        a(paramContext, paramTeamWorkFileImportInfo, null);
        return null;
      }
      if ((localaxem.a(paramTeamWorkFileImportInfo)) && (paramTeamWorkFileImportInfo.jdField_d_of_type_Boolean))
      {
        a(paramContext, paramTeamWorkFileImportInfo, null);
        return null;
      }
      if ((!TextUtils.isEmpty(localaxem.a(paramTeamWorkFileImportInfo))) && (paramTeamWorkFileImportInfo.jdField_d_of_type_Boolean))
      {
        paramQQAppInterface = new Bundle();
        paramQQAppInterface.putString("url", localaxem.a(paramTeamWorkFileImportInfo));
  ...
  public static void a(int paramInt1, int paramInt2)
  {
    ...
    {
      awqx.b(null, "dc00898", "", "", str, str, paramInt2, 0, "", "", "", "");
      do
      {
        return;
      } while (paramInt1 != 1);
  ...
  public static void a(Context paramContext, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, String paramString)
  {
    ...
    if (paramTeamWorkFileImportInfo != null) {
      if (paramTeamWorkFileImportInfo.jdField_d_of_type_Int == 1)
      {
        ...
        i = 0;
        j = i;
        if (axfs.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramTeamWorkFileImportInfo.jdField_d_of_type_Int))) {
          paramString.putExtra("tdsourcetag", (String)axfs.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramTeamWorkFileImportInfo.jdField_d_of_type_Int)));
        }
      }
    }
    for (int j = i;; j = 0)
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, axee paramaxee)
  {
    ...
    do
    {
      ...
      paramQQAppInterface = a(paramQQAppInterface, paramTeamWorkFileImportInfo, paramContext, paramString, paramContext.getString(2131654242), true);
    } while (paramaxee == null);
    paramaxee.a(paramQQAppInterface);
    return;
    ...
    if (paramTeamWorkFileImportInfo.c())
    {
      str3 = paramContext.getString(2131626395);
      str2 = paramContext.getString(2131626391);
    }
    for (String str1 = paramContext.getString(2131626393);; str1 = paramContext.getString(2131626392))
    {
      localbegr.a(2131626396);
      localbegr.b(str3);
      localbegr.a(str2, 5);
      localbegr.a(str1, 5);
      localbegr.c(2131625035);
      localbegr.a(new axeb(paramTeamWorkFileImportInfo, localbegr, paramQQAppInterface, paramContext, paramString, paramaxee));
      localbegr.show();
      if (!paramTeamWorkFileImportInfo.c()) {
        break;
      }
      axhg.a(paramQQAppInterface, "0X8009ED0");
      return;
      str3 = paramContext.getString(2131626394);
      str2 = paramContext.getString(2131626389);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, Context paramContext, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      return;
      String str1 = String.format(paramContext.getString(2131654271), new Object[] { paramString2 });
      int k = amlh.a().a();
      int m = amlh.a().b();
      int j = 1;
      int i;
      if (!bady.b(paramQQAppInterface.getApp(), "com.tencent.tim", "775E696D09856872FDD8AB4F3F06B1E0"))
      {
        paramString2 = String.format(paramContext.getString(2131654271), new Object[] { paramString2 });
      ...
      for (;;)
      {
        for (;;)
        {
          paramContext.putString("teamworkUrl", localaxem.a(paramTeamWorkFileImportInfo));
          ...
          ((ariu)paramQQAppInterface.getManager(242)).a(paramContext);
          return;
          String str2 = bady.a(paramQQAppInterface.getApp(), "com.tencent.tim");
          if (QLog.isColorLevel()) {
          ...
          try
          {
            ...
            paramString2 = paramContext.getString(2131654350);
            i = 0;
          }
      ...
      label399:
      paramQQAppInterface = babr.a(paramContext, 0);
      paramQQAppInterface.setMessage(paramString2);
      paramQQAppInterface.setPositiveButton(paramContext.getString(2131626337), new axec(paramContext, paramString1));
      paramQQAppInterface.setNegativeButton(paramContext.getString(2131627735), new axed(paramQQAppInterface));
      try
      {
  ...
  public static void a(TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    for (;;)
    {
      ...
      for (localObject = (QQAppInterface)localObject;; localObject = null)
      {
        ...
        localObject = (axem)((QQAppInterface)localObject).a(120);
        if (localObject == null) {
          break;
        }
        paramTeamWorkFileImportInfo.g = 7;
        ((axem)localObject).a(paramTeamWorkFileImportInfo);
        return;
      }
    }
  }
  ...
  public static void a(TeamWorkFileImportInfo paramTeamWorkFileImportInfo, String paramString)
  {
    ...
    do
    {
      ...
      axem localaxem = (axem)localQQAppInterface.a(120);
      if ((!localaxem.a(paramTeamWorkFileImportInfo)) && (TextUtils.isEmpty(localaxem.a(paramTeamWorkFileImportInfo))))
      {
      ...
      if (paramTeamWorkFileImportInfo.c())
      {
        ...
        localaxem.c(paramTeamWorkFileImportInfo);
        localaxem.e(paramTeamWorkFileImportInfo);
        paramTeamWorkFileImportInfo.g = 1;
        localaxem.a(paramTeamWorkFileImportInfo);
        return;
      }
    ...
    } while (!paramTeamWorkFileImportInfo.c());
    axhg.a(localQQAppInterface, "0X8009ECF");
  }
  ...
  public static boolean a(TeamWorkFileImportInfo paramTeamWorkFileImportInfo, Context paramContext, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    {
      bbmy.a(paramContext, ajjy.a(2131648984), 1).b(BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131167766));
      return false;
    }
    if (paramInt == 9) {
    ...
    if (!TextUtils.isEmpty(localaxem.a(paramTeamWorkFileImportInfo))) {
      paramQQAppInterface = localaxem.a(paramTeamWorkFileImportInfo);
    }
    if (!localaxem.a(paramTeamWorkFileImportInfo)) {
      localaxem.a(paramTeamWorkFileImportInfo);
    }
  ...
  {
    return (!TextUtils.isEmpty(paramString)) && (ammr.a(Uri.parse(paramString).getHost()));
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      paramString1 = anah.a("ipc_cmd_convert_team_work_url_2_doc", "", -1, paramString1);
  ...
  {
    if (paramTeamWorkFileImportInfo == null) {}
    while ((paramTeamWorkFileImportInfo.c()) || ((paramTeamWorkFileImportInfo.h != 2) && (paramTeamWorkFileImportInfo.h != 1))) {
      return false;
    }
    return true;
  }
  ...
  private static boolean b(String paramString)
  {
    ...
    paramString = (String)axfs.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (paramString == null) {
      return false;
    }
    amga localamga = (amga)alzw.a().a(418);
    if (localamga == null) {
      return false;
    }
    paramString = (amgb)localamga.a().get(paramString);
    if (paramString == null) {
      return false;
    }
