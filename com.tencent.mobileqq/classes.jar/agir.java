  ...
  extends BaseChatPie
{
  ...
  public agir(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      if (i != 0) {
        if (this.o == null)
        {
          ...
          if (this.o != null)
          {
            localAnyScaleTypeImageView = (AnyScaleTypeImageView)this.o.findViewById(2131365738);
      ...
      try
      {
        ...
        localObject = (TextView)this.o.findViewById(2131365755);
        if (localObject != null) {
  ...
  {
    super.W();
    if ((this.jdField_a_of_type_Aelz == null) || (this.jdField_a_of_type_Aelz.getCount() < 1))
    {
      bs();
      return;
    }
  ...
  {
    super.z();
    this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setRight1Icon(2130840280, 2130840280);
  }
}
