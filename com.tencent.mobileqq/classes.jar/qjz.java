  ...
  implements qjw
{
  ...
  private Map<String, qka> jdField_a_of_type_JavaUtilMap = new HashMap();
  private final int b;
  private final int c;
  ...
  private int a(qka paramqka, String paramString1, String paramString2)
  {
    try
    {
      ...
      int i = j;
      if (j == 0) {
        i = paramqka.jdField_c_of_type_Int;
      }
  ...
  public static long a(int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        if (otf.b(paramInt))
        {
          Object localObject = osk.a(String.valueOf(paramInt));
          if (localObject == null) {
            break label235;
          }
  ...
  private qka a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramString2 = (qka)this.jdField_a_of_type_JavaUtilMap.get(str);
      paramString1 = paramString2;
    } while (paramString2 != null);
    paramString1 = new qka(this);
  ...
  public static void a(int paramInt)
  {
    ...
    {
      g = paramInt;
      osk localosk2 = osk.a(String.valueOf(paramInt));
      osk localosk1 = localosk2;
      if (localosk2 == null)
      {
        localosk1 = new osk();
        osk.a(String.valueOf(paramInt), localosk1);
      }
  ...
  private void a(List<ArticleInfo> paramList, qka paramqka, qkc paramqkc)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      ArticleInfo localArticleInfo = (ArticleInfo)paramList.next();
      if (paramqka.jdField_a_of_type_JavaLangString.equals(a(localArticleInfo))) {
        paramqkc.jdField_a_of_type_JavaUtilList.add(localArticleInfo.innerUniqueID);
      }
      if ((localArticleInfo.mSubArtilceList != null) && (localArticleInfo.mSubArtilceList.size() > 0)) {
        a(localArticleInfo.mSubArtilceList, paramqka, paramqkc);
      }
    }
  }
  
  private void a(qka paramqka, String paramString1, String paramString2)
  {
    try
    {
      Object localObject = (String)bjxj.a(jdField_b_of_type_JavaLangString, "");
      ...
      {
        i += 1;
        paramqka.jdField_c_of_type_Int = i;
    ...
    catch (JSONException paramqka)
    {
      paramqka.printStackTrace();
      return;
    }
  }
  
  private void a(qkb paramqkb)
  {
    if ((paramqkb != null) && (paramqkb.jdField_a_of_type_JavaUtilList.size() > 0))
    {
      Iterator localIterator = paramqkb.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        ...
        if (localBackOffGroupInfo.bytes_back_off_group.has()) {
          a(localBackOffGroupInfo, paramqkb.b);
        }
      }
    }
  }
  ...
  private void a(oidb_cmd0x68b.BackOffGroupInfo paramBackOffGroupInfo, List<ArticleInfo> paramList)
  {
    ...
    do
    {
      ...
      localqka = a(paramBackOffGroupInfo.bytes_back_off_group.get().toStringUtf8(), String.valueOf(l));
    } while (localqka == null);
    localqka.jdField_a_of_type_JavaLangString = paramBackOffGroupInfo.bytes_back_off_group.get().toStringUtf8();
    if (paramBackOffGroupInfo.uint32_max_evoke_count.has()) {}
    for (int i = paramBackOffGroupInfo.uint32_max_evoke_count.get();; i = 0)
    {
      localqka.jdField_a_of_type_Int = i;
      i = j;
      if (paramBackOffGroupInfo.uint32_max_fresh_evoke_count.has()) {
        i = paramBackOffGroupInfo.uint32_max_fresh_evoke_count.get();
      }
      localqka.jdField_b_of_type_Int = i;
      paramBackOffGroupInfo = new qkc(this);
      a(paramList, localqka, paramBackOffGroupInfo);
      localqka.a(paramBackOffGroupInfo);
      return;
    }
  }
  ...
  public static void b(int paramInt)
  {
    if ((paramInt == 0) || (otf.b(paramInt)))
    {
      osk localosk = osk.a(String.valueOf(paramInt));
      if ((localosk != null) && (localosk.a()))
      {
        c(paramInt);
        localosk.b();
        localosk.c();
  ...
  public void a(BaseArticleInfo paramBaseArticleInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (j != 0)
    {
      ...
      swt.a(paramBaseArticleInfo, i);
    }
  }
  
  public void a(Object paramObject)
  {
    if (!(paramObject instanceof qkb)) {
      return;
    }
  ...
  public boolean a(BaseArticleInfo paramBaseArticleInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      qka localqka = a(str2, String.valueOf(paramBaseArticleInfo.mChannelID));
      if (localqka == null)
      {
      ...
      localqka.jdField_c_of_type_Int = a(localqka, str2, String.valueOf(paramBaseArticleInfo.mChannelID));
      QLog.d(jdField_d_of_type_JavaLangString, 1, "judgeHitRule backOffGroup.clickTime is " + localqka.jdField_c_of_type_Int + " backOffGroup.maxEvokeCount is " + localqka.jdField_a_of_type_Int + " groupid is " + localqka.jdField_a_of_type_JavaLangString);
      if (localqka.jdField_c_of_type_Int >= localqka.jdField_a_of_type_Int)
      {
        QLog.d(jdField_d_of_type_JavaLangString, 1, "judgeHitRule over groupClick");
        return false;
      }
      Iterator localIterator = localqka.jdField_a_of_type_JavaUtilDeque.iterator();
      qkc localqkc;
      do
      {
        bool1 = bool2;
        ...
        localqkc = (qkc)localIterator.next();
      } while (!localqkc.jdField_a_of_type_JavaUtilList.contains(str1));
      QLog.d(jdField_d_of_type_JavaLangString, 1, "judgeHitRule freshInfo.clickTime is " + localqkc.jdField_a_of_type_Int + " backOffGroup.maxFreshEvokeCount is " + localqka.jdField_b_of_type_Int);
      bool1 = bool2;
      if (localqkc.jdField_a_of_type_Int >= localqka.jdField_b_of_type_Int) {
        break;
      }
      if ((paramBoolean) && (!TextUtils.isEmpty(a(paramBaseArticleInfo, null, null))))
      {
        localqkc.jdField_a_of_type_Int += 1;
        a(localqka, str2, String.valueOf(paramBaseArticleInfo.mChannelID));
      }
      return true;
    }
  }
