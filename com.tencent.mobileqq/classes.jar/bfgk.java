  ...
  implements View.OnClickListener, Animation.AnimationListener
{
  ...
  private void a(TroopAIONotifyItem paramTroopAIONotifyItem)
  {
    ...
    Object localObject1 = (URLThemeImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379393);
    for (;;)
    {
      try
      {
        ...
        ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379396)).setText(paramTroopAIONotifyItem.title);
        localObject1 = (TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379395);
        ((TextView)localObject1).setText(paramTroopAIONotifyItem.summary);
        if (!TextUtils.isEmpty(paramTroopAIONotifyItem.summary)) {
          break label223;
        }
        ((TextView)localObject1).setVisibility(8);
        ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379392)).setBackgroundResource(2130850744);
        if (!ThemeUtil.isInNightMode(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
          break label231;
        }
        this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130850742);
        return;
      }
    ...
    label231:
    this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130850743);
  }
    ...
    if ((this.jdField_c_of_type_AndroidViewView.getVisibility() == 8) && (this.jdField_b_of_type_AndroidViewView != null) && (this.jdField_a_of_type_AndroidViewAnimationAnimation != null))
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
      {
        ...
        if ((localTroopAIONotifyItem != null) && (localTroopAIONotifyItem.hideMode == 1)) {
          bgif.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localTroopAIONotifyItem);
        }
        if ((localTroopAIONotifyItem == null) || (localTroopAIONotifyItem.type != 1)) {
          break label182;
        }
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_AIO", "", "notice_center_new", "exp_notice", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "", "" + localTroopAIONotifyItem.appId, "");
      }
    }
    for (;;)
    {
      ...
      if ((localTroopAIONotifyItem != null) && (localTroopAIONotifyItem.type == 2)) {
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_AIO", "", "notice_center_new", "exp_oper_notice", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "", "" + localTroopAIONotifyItem.appId, "");
      }
    }
  }
  ...
  public void a(List<TroopAIONotifyItem> paramList)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_c_of_type_AndroidViewView) == -1)
    {
      ...
      paramList.topMargin = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 18.0F);
  ...
  public void onClick(View paramView)
  {
    ...
    {
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_AIO", "", "notice_center_new", "clk_notice", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "", "" + localTroopAIONotifyItem.appId, "");
      label167:
      ...
      uuc.a(localIntent, localTroopAIONotifyItem.url);
    ...
    for (;;)
    {
      ...
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_AIO", "", "notice_center_new", "clk_oper_notice", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "", "" + localTroopAIONotifyItem.appId, "");
      break label167;
      label310:
      if (localTroopAIONotifyItem.url.startsWith("mqqapi")) {
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface instanceof QQAppInterface)) {
          bhey.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, localTroopAIONotifyItem.url).a();
        } else {
