  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      notifyObserver(paramIntent, j, bool1, localBundle, boqp.class);
      return;
      ...
      if (((MqqLbsPack.RspGetPOIList)localObject).msg_head.has())
      {
        ...
        if (k != 0) {
          boqr.a("actLbsSendPoiListFailure", k);
        }
        for (;;)
        {
          if (QLog.isColorLevel()) {
          ...
          break;
          boqr.a("actLbsSendPoiListFailure");
        }
        ...
        if (((MqqLbsPack.RspOpenLBSRPReport)localObject).msg_head.has())
        {
          ...
          if (paramFromServiceMsg != null)
          {
            ...
            if (((MqqLbsPack.RspGetLBSPID)localObject).msg_head.has())
            {
              ...
              boqr.a("actLbsSendGetPidFailure");
            }
            for (;;)
            {
              localBundle.putInt("key_receive_result", k);
              ...
              break;
              boqr.a("actLbsSendGetPidFailure", k);
            }
            ...
            default: 
              break;
            case 1: 
              boqr.a("actLbsSendPoiListFailure", -10006);
              break;
            case 2: 
              break;
            case 3: 
              boqr.a("actLbsSendGetPidFailure", -10006);
              break;
            case 4: 
              if (QLog.isColorLevel())
              {
