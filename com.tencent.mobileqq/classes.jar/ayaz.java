...
{
  private static ayaz jdField_a_of_type_Ayaz;
  ayax jdField_a_of_type_Ayax;
  boolean jdField_a_of_type_Boolean;
  
  public static MovementMethod a()
  {
    if (jdField_a_of_type_Ayaz == null) {
      jdField_a_of_type_Ayaz = new ayaz();
    }
    return jdField_a_of_type_Ayaz;
  }
  ...
  public boolean onTouchEvent(TextView paramTextView, Spannable paramSpannable, MotionEvent paramMotionEvent)
  {
    ...
    if ((i == 1) || (i == 0) || (i == 3))
    {
      ...
      localObject = (ayax[])paramSpannable.getSpans(j, j, ayax.class);
      ...
      if (localObject.length != 0)
      {
        ...
        if (i == 1)
        {
          ...
          {
            this.jdField_a_of_type_Ayax.a(paramTextView, false);
        ...
        for (;;)
        {
          ...
          if (i == 0)
          {
            ...
            this.jdField_a_of_type_Ayax = paramSpannable;
          }
          else if ((i == 3) && (this.jdField_a_of_type_Ayax != null))
          {
            this.jdField_a_of_type_Ayax.a(paramTextView, false);
            this.jdField_a_of_type_Ayax = null;
          }
