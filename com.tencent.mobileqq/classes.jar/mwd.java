  ...
  implements Manager
{
  ...
  private mwq jdField_a_of_type_Mwq = new mwe(this);
  mzn jdField_a_of_type_Mzn;
  ndn jdField_a_of_type_Ndn = null;
  
  public mwd(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Ndn = new ndn(paramQQAppInterface);
    this.jdField_a_of_type_Ndn.a();
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Mwq);
  }
  ...
  private void a(Activity paramActivity, int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    ...
    bcst.b(null, "dc00898", "", "", "0X800B077", "0X800B077", 0, 0, "", "", "", "");
    paramActivity = bglp.a(paramActivity, 230, paramActivity.getString(2131690384), paramActivity.getString(2131690383), paramActivity.getString(2131698208), paramActivity.getString(2131698210), new mwj(this, paramString2, paramActivity, paramInt1, paramString1, paramInt2), new mwl(this));
  ...
  {
    String str = paramActivity.getString(2131690240);
    if (!paramBoolean) {
      str = paramActivity.getString(2131690287);
    }
    ...
    if (localbgpa != null)
    {
      ...
      localbgpa.setPositiveButton(2131690361, paramActivity);
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getBaseContext(), 2131690358, 0).a();
    ...
    do
    {
      ...
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getBaseContext(), 2131690210, 1).a();
    ...
    QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getBaseContext(), 2131698033, 1).a();
  ...
  private boolean b()
  {
    ...
    return ((anjo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(4)).c();
  }
  
  private boolean b(Activity paramActivity, boolean paramBoolean, String paramString)
  {
    if (!nga.b()) {
      nga.a(paramActivity, paramActivity.getString(2131690247));
    }
    do
    {
      return false;
      if (!bgnt.a())
      {
        nga.a(paramActivity, paramActivity.getString(2131690307));
        return false;
      }
  ...
  public mzn a()
  {
    if (this.jdField_a_of_type_Mzn == null) {
      this.jdField_a_of_type_Mzn = new mzn(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    return this.jdField_a_of_type_Mzn;
  }
  ...
  public void a(Activity paramActivity)
  {
    ...
    for (;;)
    {
      label89:
      if ((i != 0) && (k != 0)) {
        localObject1 = paramActivity.getResources().getString(2131690319);
      }
      for (;;)
      {
        localObject2 = new mwi(this, paramActivity);
        bglp.a(paramActivity, null, (String)localObject1, (DialogInterface.OnClickListener)localObject2, (DialogInterface.OnClickListener)localObject2, null);
        return;
        localObject1 = null;
        break label37;
        label141:
        ...
        if (i != 0) {
          localObject1 = paramActivity.getResources().getString(2131690318);
        } else {
          localObject1 = paramActivity.getResources().getString(2131690317);
        }
      }
      label236:
      i = 1;
  ...
  public void a(Activity paramActivity, int paramInt1, String paramString, int paramInt2)
  {
    ...
    do
    {
      ...
      nfu.a().a("param_StepEntrance");
    } while (!nga.a(paramActivity, new mwf(this, paramActivity, paramInt1, paramString, paramInt2)));
    c();
  ...
  public void a(Activity paramActivity, int paramInt, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      {
        QQToast.a(paramActivity, 2131690363, 0).a();
      ...
      nfu.a().a("param_StepEntrance");
    } while (!nga.a(paramActivity, new mwg(this, paramActivity, paramInt, paramString1, paramString2)));
    c();
  ...
  {
    mwn localmwn = (mwn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(178);
    if (localmwn != null)
    {
      localmwn.a(paramLong1, paramLong2, paramString1, paramInt1, paramString2, paramInt2, paramLong3);
      return true;
    }
    return false;
  }
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    if (localmwn != null)
    {
      localmwn.a(paramString, paramInt, 10);
      return true;
    }
    return false;
  }
  ...
  public boolean a(String paramString, long paramLong)
  {
    ...
    if (localmwn != null)
    {
      localmwn.a(paramString, paramLong);
      return true;
    }
    return false;
  }
