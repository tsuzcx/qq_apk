...
{
  zbg(zbe paramzbe, long paramLong, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.has())
        {
          ...
          if (!TextUtils.isEmpty(paramBundle))
          {
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.delayms.has())
            {
              ...
              this.jdField_a_of_type_Zbe.e.put(paramBundle, Integer.valueOf(2147483647));
              if (QLog.isColorLevel()) {
            ...
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.packagesize.has())
            {
              ...
              this.jdField_a_of_type_Zbe.b.put(paramBundle, Long.valueOf(l1));
              if (QLog.isColorLevel()) {
        ...
        zbe.a(this.jdField_a_of_type_Zbe, this.jdField_a_of_type_JavaLangString, l2, paramInt);
        ...
        atfx.d = System.currentTimeMillis();
        l1 = atfx.d - atfx.jdField_a_of_type_Long;
        long l3 = atfx.b - atfx.jdField_a_of_type_Long;
        long l4 = atfx.c - atfx.b;
        long l5 = atfx.d - atfx.c;
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Zbe.callJs((String)localObject1, new String[] { ((JSONObject)localObject2).toString() });
        try
        {
          ...
          localObject3 = this.jdField_a_of_type_Zbe.mRuntime.a().getCurrentAccountUin();
          ...
          localObject1 = azmz.a(this.jdField_a_of_type_Zbe.mRuntime.a());
          if (0L != l6) {
            break;
          }
          paramBoolean = true;
          label1110:
          ((azmz)localObject1).a((String)localObject3, paramBundle, paramBoolean, l1, 0L, (HashMap)localObject2, "", false);
          return;
        }
      ...
      return;
      label1197:
      this.jdField_a_of_type_Zbe.e.put(paramBundle, Integer.valueOf((int)l1));
      continue;
      label1218:
      zbe.a(this.jdField_a_of_type_Zbe, this.jdField_a_of_type_JavaLangString, paramInt);
      continue;
      label1233:
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject3)) {
        zbe.b(this.jdField_a_of_type_Zbe, (String)localObject3, paramInt);
      }
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", alpo.a(2131714718));
    }
    for (;;)
    {
      label1431:
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", alpo.a(2131714724));
      break;
      label1510:
      label1511:
      do
      {
        ((JSONObject)localObject2).put("ssoRet", 255);
        ((JSONObject)localObject2).put("businessRet", 0);
        ((JSONObject)localObject2).put("msg", alpo.a(2131714723));
        break;
        paramBoolean = false;
        break label1110;
        return;
