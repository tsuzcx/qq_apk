  ...
  extends DataSetObserver
{
  ...
  public void onChanged()
  {
    ...
    if ((6000 == k) && (TextUtils.equals(ajsd.z, str)) && (ForwardRecentActivity.a(this.a) != null))
    {
    ...
    if (i < j)
    {
      ...
      if ((localObject2 instanceof aimy)) {
        break label227;
      }
    }
    label227:
    do
    {
      ...
      break label197;
      break;
      localObject2 = (aimy)localObject2;
    } while ((((aimy)localObject2).a == null) || (!TextUtils.equals(((aimy)localObject2).a.uin, str)) || (k != ((aimy)localObject2).a.getType()));
