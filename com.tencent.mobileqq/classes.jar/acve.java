...
public class acve
{
  public static acvd a(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if (TextUtils.isEmpty(paramContext))
        {
          ...
          if (i < paramContext.length())
          {
            ...
            paramString.add(new acvd(localJSONObject));
            break label130;
          }
        }
        else
      ...
      catch (JSONException paramContext)
      {
        ...
        if (paramString.size() > 1) {
          Collections.sort(paramString, new acvf());
        }
        if (paramString.size() > 0) {
          return (acvd)paramString.get(0);
        }
        return null;
      }
      label125:
    ...
    for (;;)
    {
      try
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject))
        {
          ...
          ((JSONArray)localObject).put(new JSONObject(paramacvd.e()));
      ...
      {
        localObject = new acvd(((JSONArray)localObject).getJSONObject(0));
        if (localObject != null)
        {
          int j = ((acvd)localObject).a();
          int k = paramacvd.a();
          if (j >= k) {}
        }
        else
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(paramString))
        {
          ...
          localObject3 = new acvd((JSONObject)localObject2).a();
