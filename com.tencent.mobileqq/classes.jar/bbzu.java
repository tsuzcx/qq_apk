  ...
  extends bbzz
{
  ...
  public String a;
  public URL a;
  public ConcurrentHashMap<String, bjyu> a;
  public int b;
  protected String b;
  public String c;
  public int d;
  ...
  public bbzu(String paramString)
  {
    b(paramString);
    a();
  ...
  public bbzu(JSONObject paramJSONObject)
  {
    a(paramJSONObject);
    this.jdField_d_of_type_JavaLangString = String.valueOf(hashCode());
  }
  ...
  public static String b()
  {
    ...
    {
      localVFSFile.mkdirs();
      bdcs.c(TroopHWJsPlugin.jdField_a_of_type_JavaLangString + ".nomedia");
    }
  ...
  public bjyu a(String paramString1, String paramString2)
  {
    ...
    {
      paramString2 = new bjyu(vhj.a(), paramString1, paramString2);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString1, paramString2);
      return paramString2;
    }
    return (bjyu)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString1);
  }
  ...
  public Stream<bbzu> a(XMediaEditor paramXMediaEditor)
  {
    ...
    if (!arof.b(this.jdField_c_of_type_JavaLangString)) {
      localObject1 = ((Stream)localObject2).map(new bbzv(this.jdField_d_of_type_Int));
    }
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      localObject1 = ((Stream)localObject1).map(new bbzw(0, paramXMediaEditor, paramXMediaEditor.a("troopuin")));
    }
    for (;;)
    {
      localObject2 = paramXMediaEditor.findViewHolderForLayoutPosition(this.jdField_c_of_type_Int);
      if ((localObject2 instanceof bcav))
      {
        localObject2 = (bcav)localObject2;
        if (this.jdField_d_of_type_JavaLangString.equals(((bcav)localObject2).a.getTag())) {
          ((bcar)((bbzl)paramXMediaEditor.getAdapter()).a.a(1)).a((bcav)localObject2, this, 0);
        }
      }
