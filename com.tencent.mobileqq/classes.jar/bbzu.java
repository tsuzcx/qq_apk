...
public class bbzu
  implements bbzr
{
  private void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, bbyn parambbyn, List<MessageRecord> paramList)
  {
    ...
    do
    {
      ...
      do
      {
            ...
            if (QLog.isColorLevel())
            {
              ...
              for (;;)
              {
                try
                {
                  ...
                  paramMessageHandler.app.a().a(String.valueOf(parambbyn.e), k, i, paramMsg);
                  return;
                }
              ...
              if (paramMsg.msg_progress_notify.has())
              {
                ...
                for (j = paramMsg.uint32_average_speed.get();; j = 0)
                {
                  ...
                  paramMessageHandler.app.a().a(String.valueOf(parambbyn.e), k, i, j);
                  return;
                  if (!QLog.isColorLevel()) {
                    break;
                  }
              ...
              if (QLog.isColorLevel())
              {
                ...
                if (QLog.isColorLevel())
                {
                  ...
                  if (parambbyn.jdField_d_of_type_Boolean)
                  {
                    ...
                    paramMessageHandler.frienduin = Long.toString(parambbyn.e);
                  ...
                  paramMessageHandler.app.a().a(paramMessageHandler, paramList, paramMsg, localNotOnlineFile, String.valueOf(parambbyn.e), parambbyn.jdField_a_of_type_Boolean, parambbyn.b, parambbyn.jdField_d_of_type_Long, parambbyn.jdField_a_of_type_Int, (hummer_resv_21.FileImgInfo)localObject1, (hummer_resv_21.ResvAttr)localObject2);
                  return;
                  if (QLog.isColorLevel()) {
                  ...
                  try
                  {
                    ...
                    if (!parambbyn.jdField_d_of_type_Boolean)
                    {
                      ((anjx)paramMessageHandler.app.a(8)).a(paramMsg, paramList);
                      return;
                    }
                  }
                  catch (InvalidProtocolBufferMicroException paramMessageHandler) {}
        ...
        try
        {
          ...
          if (paramMsg != null)
          {
            athc.a(String.valueOf(l1), paramMsg);
            parambbyn = paramList;
          }
        }
        ...
        paramMessageHandler.app.a().a(l1, i, l2, l3, parambbyn, (byte[])localObject1);
        return;
        if (QLog.isColorLevel()) {
          QLog.d("MsgType0x211Decoder", 2, "<dataline printer> message come: cmd[0x211, 0x9]");
        }
        parambbyn = new C2CType0x211_SubC2CType0x9.MsgBody();
        try
        {
          parambbyn = (C2CType0x211_SubC2CType0x9.MsgBody)parambbyn.mergeFrom((byte[])localObject1);
          ((anjx)paramMessageHandler.app.a(8)).a(paramMsg, parambbyn);
          return;
        }
        catch (InvalidProtocolBufferMicroException paramMessageHandler) {}
      } while (!QLog.isColorLevel());
      ...
      ((abqn)paramMessageHandler.app.a(51)).a(l1, l2, i, l3, j, "im_push.msg_push", (byte[])localObject1);
    } while (!QLog.isColorLevel());
  ...
  private void b(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, bbyn parambbyn)
  {
    int i;
    if ((paramMsg.msg_head.c2c_cmd.get() == 6) || (paramMsg.msg_head.c2c_tmp_msg_head.has()))
    {
      i = 1;
      if (i != 0) {
        new bcab().a(paramMessageHandler, paramMsg, paramList, parambbyn);
      }
      if (!paramMsg.msg_head.c2c_tmp_msg_head.has())
      {
        paramMessageHandler = (anmw)paramMessageHandler.app.getManager(51);
        if (!nki.a(BaseApplicationImpl.getContext(), String.valueOf(((msg_comm.MsgHead)paramMsg.msg_head.get()).from_uin.get()))) {
          break label146;
        }
    ...
    label146:
    while ((!nki.a(BaseApplicationImpl.getContext(), String.valueOf(((msg_comm.MsgHead)paramMsg.msg_head.get()).to_uin.get()))) || (paramMessageHandler.b(String.valueOf(((msg_comm.MsgHead)paramMsg.msg_head.get()).to_uin.get()))))
    {
      return;
      i = 0;
      break;
  ...
  {
    b(paramMessageHandler, paramMsg, paramList, parambbyn);
    a(paramMessageHandler, paramMsg, parambbyn, paramList);
  }
}
