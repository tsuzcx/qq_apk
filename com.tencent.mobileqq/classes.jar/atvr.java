...
public class atvr
  extends alpq
{
  public atvr(LoginWelcomeManager paramLoginWelcomeManager) {}
  ...
  protected void onCardDownload(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        amdu localamdu = (amdu)LoginWelcomeManager.a(this.a).a(20);
        paramObject = localamdu.a((Card)paramObject);
        localamdu.a(str, paramObject, 1, null, (String)localObject, localamdu.a(paramObject, l1, l2), null);
