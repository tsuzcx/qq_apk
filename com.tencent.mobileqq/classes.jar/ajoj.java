...
public class ajoj
{
  ...
  private ajgs jdField_a_of_type_Ajgs = new ajok(this);
  ...
  public ajoj(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a()
  {
    ...
    if (aken.a((ProxyManager)localObject2, "mr_dataline_printer")) {
      ((ProxyManager)localObject2).a((atmp)localObject1);
    }
    long l = 2147483647L;
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0) {
      l = ((PrinterItemMsgRecord)this.jdField_a_of_type_JavaUtilArrayList.get(0)).msgId;
    }
    localObject2 = ((atmp)localObject1).a(PrinterItemMsgRecord.class, "select * from mr_dataline_printer where msgid<? order by msgid desc limit 5", new String[] { String.valueOf(l) });
    ((atmp)localObject1).a();
  ...
  {
    if (!ajgm.a(paramSession, "printer")) {}
    Object localObject;
    do
    {
      do
      {
        ...
        ((PrinterItemMsgRecord)localObject).time = awao.a();
  ...
  public void a(ajgm paramajgm)
  {
    Object localObject = (ajrc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(10);
    if ((((ajrc)localObject).a() == 0) || (((ajrc)localObject).e() != 1))
    {
      paramajgm.a(12, false, null);
      if (this.jdField_a_of_type_JavaUtilHashMap.size() > 0)
      {
        localObject = new Timer();
        ((Timer)localObject).schedule(new PrinterHandler.1(this, paramajgm, (Timer)localObject), 5000L);
      }
    }
  }
  
  public void a(ajgm paramajgm, msg_comm.Msg paramMsg, C2CType0x211_SubC2CType0x9.MsgBody paramMsgBody)
  {
    boolean bool = false;
    int j;
    int i;
    ...
    case 2: 
      do
      {
        ...
        paramMsg = (ajom)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(74);
        paramMsg.a(false);
      ...
      if ((((ajrc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(10)).a() != 0) && (this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0)) {
        paramMsg.a(true);
      }
      paramajgm.a(12, false, null);
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004022", "0X8004022", 0, 0, "", "", "", "");
      return;
    case 3: 
      j = -1;
    ...
    for (;;)
    {
      ...
      paramajgm.a(18, bool, Long.valueOf(l));
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004021", "0X8004021", (int)l, i, "", "", "", "");
      return;
      ...
      else
      {
        ...
        paramajgm.notifyUI(19, true, new Object[] { Long.valueOf(paramMsg.uint64_printer_din.get()), paramMsg.str_printer_qr_pic_url.get(), paramMsg.str_printer_qr_open_url.get(), paramMsg.str_printer_tip_url.get() });
        return;
      }
      label579:
      l = 0L;
  ...
  public void a(BaseActivity paramBaseActivity, String paramString)
  {
    if (apck.a())
    {
      if (bace.a(paramString) > aonj.a())
      {
        apbx.a(paramBaseActivity, 2131627035, 2131627040, new ajol(this, paramBaseActivity, paramString));
        return;
      }
      ...
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004059", "0X8004059", 0, 0, "", "", "", "");
      return;
    }
  ...
  public void a(PrinterItemMsgRecord paramPrinterItemMsgRecord)
  {
    ...
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004021", "0X8004021", (int)paramPrinterItemMsgRecord.uSessionID, -2, "", "", "", "");
  ...
  public String[] a()
  {
    if ((((ajom)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(74)).a()) && (this.b != null))
    {
