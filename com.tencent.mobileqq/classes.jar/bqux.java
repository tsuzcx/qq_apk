...
public class bqux
{
  ...
  public bqux(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bquy(this, Looper.getMainLooper());
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bquz(this);
  ...
  protected Bitmap a(Bitmap paramBitmap)
  {
    ...
    return bhmq.a(paramBitmap, i, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
  }
  ...
  public Drawable a(String paramString, int paramInt1, int paramInt2)
  {
    if (TextUtils.isEmpty(paramString))
    {
      yuk.e("Q.qqstory.record.StoryFaceDrawableFactory", "getStoryFaceDrawable uin is null!");
      return null;
    }
    ...
    {
      localzrx = (zrx)this.jdField_a_of_type_AndroidSupportV4UtilLruCache.get(paramString);
      if (localzrx != null)
      {
        yuk.c("Q.qqstory.record.StoryFaceDrawableFactory", "getStoryFaceDrawable, hit cache:" + paramString);
        return localzrx;
      }
    }
    yuk.c("Q.qqstory.record.StoryFaceDrawableFactory", "getStoryFaceDrawable, not in cache:" + paramString);
    zrx localzrx = new zrx(paramInt1, paramInt2);
    this.jdField_a_of_type_AndroidSupportV4UtilLruCache.put(paramString, localzrx);
  ...
  public void a()
  {
    yuk.c("Q.qqstory.record.StoryFaceDrawableFactory", "onDestory");
    try
    {
    ...
    {
      yuk.e("Q.qqstory.record.StoryFaceDrawableFactory", "onDestory:" + localException.toString());
    }
  }
  
  public void a(bqva parambqva)
  {
    this.jdField_a_of_type_Bqva = parambqva;
  }
  
  protected void a(String paramString)
  {
    yuk.b("Q.qqstory.record.StoryFaceDrawableFactory", "sendQQHeadRequest uin:%s.", paramString);
