...
public class amjx
  implements Handler.Callback, aojz, Manager
{
  public static final String a;
  public static boolean a;
  private float jdField_a_of_type_Float = 7.0F;
  public int a;
  altm jdField_a_of_type_Altm = new amjy(this);
  private ameq jdField_a_of_type_Ameq = new amjz(this);
  private bhsl jdField_a_of_type_Bhsl = new bhsl(ThreadManager.getFileThreadLooper(), this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private final Object jdField_a_of_type_JavaLangObject = new Object();
  private WeakReference<amkb> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  private WeakReference<amjw> jdField_b_of_type_JavaLangRefWeakReference;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alud.a(2131706084);
  }
  
  public amjx(QQAppInterface paramQQAppInterface)
  {
  ...
  private Object[] a(boolean paramBoolean, String paramString)
  {
    ...
    if (!paramBoolean) {
      localObject2 = bdne.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), "breaking_ice_config");
    }
    i2 = i3;
    m = n;
    k = i1;
  ...
  private void f()
  {
    ...
    Object localObject1 = bdhb.a(String.format("%s_%s", new Object[] { "break_ice_map", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bdhb.a(String.format("%s_%s", new Object[] { "entered_c2c", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bdhb.a(String.format("%s_%s", new Object[] { "entered_troop", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
    ??? = bdhb.a(String.format("%s_%s", new Object[] { "entered_match_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }));
  ...
  private void g()
  {
    ...
    bdhb.a(String.format("%s_%s", new Object[] { "break_ice_map", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localConcurrentHashMap);
  }
    ...
    if (localTroopInfo.wMemberNum < this.jdField_b_of_type_Int)
    {
      ...
      if ((localObject2 == null) || (((List)localObject2).size() <= 1))
      {
        ...
        for (i = 0;; i = ((List)localObject2).size())
        {
          ...
          ((amdu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).o(paramString);
          return;
        }
      }
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if ((TextUtils.isEmpty(str2)) || (str2.equals(str1)) || (((alto)localObject1).b(str2))) {
          break label318;
        }
        i += 1;
      }
  ...
  public void a(amjw paramamjw)
  {
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramamjw);
  }
  
  public void a(amkb paramamkb)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramamkb);
  }
  
  public void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString, aojy paramaojy)
  {
    if ((paramaojy != null) && ("breaking_ice_config".equals(paramString)))
    {
      if (!this.jdField_b_of_type_Boolean) {
        f();
      }
      paramQQAppInterface = a(true, paramaojy.jdField_a_of_type_JavaLangString);
      ...
      if ((bool1 != this.jdField_c_of_type_Boolean) || (bool2 != this.jdField_d_of_type_Boolean))
      {
        ...
        if (a(this.jdField_c_of_type_Boolean, this.jdField_d_of_type_Boolean, paramQQAppInterface))
        {
          ...
          if (this.jdField_a_of_type_Bhsl.hasMessages(1)) {
            this.jdField_a_of_type_Bhsl.removeMessages(1);
          }
          this.jdField_a_of_type_Bhsl.sendEmptyMessage(1);
        }
      }
      if (QLog.isColorLevel())
      {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = ((alto)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      ...
      for (;;)
      {
        ...
        paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), agza.class);
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    {
      return;
      Object localObject = ((alto)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString);
      boolean bool;
      int i;
      if ((localObject != null) && (((Friends)localObject).isFriend()))
      {
        ...
        {
          localObject = (amkb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localObject != null) {
            ((amkb)localObject).a(paramString, false);
          }
        }
        if (this.jdField_a_of_type_Bhsl.hasMessages(1)) {
          this.jdField_a_of_type_Bhsl.removeMessages(1);
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("IceBreak.HotPic", 2, bhsw.a(paramArrayOfByte));
        return;
        ...
        while (i < paramArrayOfByte.size())
        {
          ...
          localagyp.e(i);
          localagyp.a(localImgInfo.uint64_img_size.get());
          localagyp.a(localImgInfo.uint32_img_width.get());
          localagyp.b(localImgInfo.uint32_img_height.get());
          localagyp.d(localImgInfo.bytes_img_md5.get().toStringUtf8());
          localagyp.b(localImgInfo.bytes_img_down_url.get().toStringUtf8());
          localagyp.a(localImgInfo.bytes_img_word.get().toStringUtf8());
          localagyp.b(localImgInfo.uint64_thumb_size.get());
          localagyp.d(localImgInfo.uint32_thumb_img_height.get());
          localagyp.c(localImgInfo.uint32_thumb_img_width.get());
          localagyp.c(localImgInfo.bytes_thumb_down_url.get().toStringUtf8());
          localagyp.e(localImgInfo.bytes_thumb_img_md5.get().toStringUtf8());
          ((List)localObject).add(localagyp);
          i += 1;
        }
  ...
  public void b()
  {
    ...
    bdhb.a(String.format("%s_%s", new Object[] { "entered_c2c", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  
  public void b(amkb paramamkb)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() == paramamkb)) {
  ...
  public void c()
  {
    ...
    bdhb.a(String.format("%s_%s", new Object[] { "entered_troop", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public void d()
  {
    ...
    bdhb.a(String.format("%s_%s", new Object[] { "entered_match_chat", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }), localHashSet);
  }
  ...
  public boolean d(String paramString)
  {
    ...
    if (localObject != null)
    {
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        amkb localamkb = (amkb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localamkb != null) {
          localamkb.b(paramString, false);
        }
      }
      if (this.jdField_a_of_type_Bhsl.hasMessages(1)) {
        this.jdField_a_of_type_Bhsl.removeMessages(1);
  ...
  public boolean e(String paramString)
  {
    ...
    if (bool2)
    {
      paramString = ((alto)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).e(paramString);
  ...
  public void h(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (((aqbg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(264)).d()) {
            break;
          }
      ...
      localamkb = (amkb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localamkb == null);
    localamkb.a(paramString, false);
  }
  ...
  {
    if (!agyv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b()) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if ((localTroopMemberInfo == null) || (localTroopMemberInfo.last_active_time == localTroopMemberInfo.join_time))
      {
        ...
        this.jdField_d_of_type_JavaLangString = paramString;
        ((amdu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(Long.valueOf(paramString).longValue(), Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue(), true);
        return;
      }
