  ...
  extends SimManager
{
    ...
    for (;;)
    {
      try
      {
        ...
        if (k >= 0)
        {
          ...
          i = j;
          if (TextUtils.isEmpty(paramISub.a())) {
            break;
          }
          SimInfo localSimInfo = a(10);
          i = j;
          if (localSimInfo == null) {
            break;
          }
          i = j;
          if (!paramISub.a().equals(localSimInfo.a())) {
            break;
          }
          localSimInfo.a(true);
          return 0;
  ...
  protected int b(Context paramContext, int[] paramArrayOfInt)
  {
    ...
    try
    {
      localObject = localClass.getDeclaredMethod("getLine1NumberForSubscriber", new Class[] { Integer.TYPE });
      paramContext = (Context)localObject;
      b = 1;
      paramContext = (Context)localObject;
    }
    catch (Throwable localThrowable1)
    {
      for (;;)
      {
        try
        {
          localObject = localClass.getDeclaredMethod("getLine1Number", new Class[] { Long.TYPE });
          paramContext = (Context)localObject;
          bool2 = false;
          bool1 = false;
        }
        ...
        localThrowable1 = localThrowable1;
        QZLog.e("UniKingCardHelper/SimManager", "initAllPhoneNum  1 error:" + localThrowable1.getMessage());
      }
    }
    boolean bool2 = true;
    boolean bool1 = true;
    ...
    try
    {
      localObject = localClass.getDeclaredMethod("getLine1NumberForSubscriber", new Class[] { Long.TYPE });
      bool1 = false;
      bool2 = false;
      paramContext = (Context)localObject;
      b = 2;
    ...
    catch (Throwable localThrowable2)
    {
      for (;;)
      {
        QZLog.e("UniKingCardHelper/SimManager", "initAllPhoneNum 2 error:" + localThrowable2.getMessage());
    ...
    try
    {
      localObject = localClass.getDeclaredMethod("getLine1Number", new Class[] { Integer.TYPE });
      bool1 = true;
      bool2 = true;
      paramContext = (Context)localObject;
      b = 21;
    ...
    catch (Throwable localThrowable3)
    {
      for (;;)
      {
        QZLog.e("UniKingCardHelper/SimManager", "initAllPhoneNum 3 error:" + localThrowable3.getMessage());
        bool2 = bool1;
        continue;
        QZLog.e("UniKingCardHelper/SimManager", "initAllPhoneNum 4 error:" + localThrowable4.getMessage());
      }
    }
    if ((b == -1) || (b == 22)) {}
    for (;;)
    {
      ...
      label389:
      return a(2, localTelephonyManager, paramArrayOfInt, paramContext, bool1);
      bool1 = bool2;
    }
  }
  ...
  protected int c(Context paramContext, int[] paramArrayOfInt)
  {
    ...
    //   21: aconst_null
    //   22: astore_1
    //   23: getstatic 16	amjx:c	I
    //   26: iconst_m1
    //   27: if_icmpeq +10 -> 37
    //   30: getstatic 16	amjx:c	I
    //   33: iconst_1
    //   34: if_icmpne +35 -> 69
    //   37: aload 5
    //   39: astore_1
    ...
    //   61: astore_1
    //   62: iconst_1
    //   63: putstatic 16	amjx:c	I
    //   66: aload 5
    //   68: astore_1
    //   69: getstatic 16	amjx:c	I
    //   72: iconst_m1
    //   73: if_icmpeq +10 -> 83
    //   76: getstatic 16	amjx:c	I
    //   79: iconst_2
    ...
    //   100: astore 5
    //   102: iconst_2
    //   103: putstatic 16	amjx:c	I
    //   106: aload 5
    //   108: astore_1
    //   109: iconst_0
    //   110: istore_3
    //   111: getstatic 16	amjx:c	I
    //   114: iconst_m1
    ...
    //   148: astore 5
    //   150: iconst_3
    //   151: putstatic 16	amjx:c	I
    //   154: iconst_1
    //   155: istore 4
    //   157: getstatic 16	amjx:c	I
    //   160: iconst_m1
    //   161: if_icmpeq +10 -> 171
    //   164: getstatic 16	amjx:c	I
    //   167: iconst_4
    ...
    //   188: astore_1
    //   189: iconst_4
    //   190: putstatic 16	amjx:c	I
    //   193: iconst_0
    //   194: istore_3
    //   195: getstatic 16	amjx:c	I
    //   198: iconst_m1
    //   199: if_icmpeq +7 -> 206
    //   202: aload_1
    ...
    //   364: aload_1
    //   365: iload_3
    //   366: invokevirtual 110	amjx:a	(ILandroid/telephony/TelephonyManager;[ILjava/lang/reflect/Method;Z)I
    //   369: ireturn
    //   370: astore 5
    //   372: iconst_0
    //   373: istore_3
