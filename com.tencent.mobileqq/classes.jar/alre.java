  ...
  extends ambr
{
  ...
  public alre(ContactsInnerFrame paramContactsInnerFrame, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    int i = Arrays.binarySearch(this.jdField_a_of_type_ArrayOfInt, paramInt);
    if (paramView == null) {
      paramView = also.a(paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater, 2131562867);
    }
    for (;;)
    {
      ...
      if (i < 0)
      {
        ...
        also.a(this, localalso, localPhoneContact2);
        if (i - 1 < 0)
        {
          localObject = null;
          ...
          localalso.d.setText(localPhoneContact2.mobileNo);
          label192:
          localalso.b.setText(localPhoneContact2.name);
          if (!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(localalso.jdField_a_of_type_JavaLangString)) {
            break label415;
          }
          ...
          localalso.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(false);
          label275:
          if ((AppSetting.c) && (localalso.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
          {
            ...
            paramView.setContentDescription(localPhoneContact2.name + anni.a(2131701356));
          }
          label333:
          localalso.jdField_a_of_type_ComTencentMobileqqDataPhoneContact = localPhoneContact2;
      ...
      for (;;)
      {
        ...
        break label275;
        label439:
        paramView.setContentDescription(localPhoneContact2.name + anni.a(2131701328));
        break label333;
