...
class vzv
  implements vzt
{
  vzv(vzu paramvzu, List paramList, Bitmap[] paramArrayOfBitmap, Handler paramHandler) {}
  
  public void a(String paramString, Bitmap paramBitmap)
  {
    int i = this.jdField_a_of_type_JavaUtilList.indexOf(paramString);
    vzb.b(vzu.a(this.jdField_a_of_type_Vzu), "bitmap download success index=%d, url=%s", Integer.valueOf(i), paramString);
  ...
  {
    int i = this.jdField_a_of_type_JavaUtilList.indexOf(paramString);
    vzb.c(vzu.a(this.jdField_a_of_type_Vzu), "bitmap download failed index=%s, error=%s", Integer.valueOf(i), paramThrowable);
