  ...
  implements Manager, wef
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = weg.a("StorySvc.video_config_get");
    jdField_b_of_type_JavaLangString = weg.a("StorySvc.video_config_set");
    jdField_c_of_type_JavaLangString = weg.a("StorySvc.video_get_user_mask_list");
    jdField_d_of_type_JavaLangString = weg.a("StorySvc.video_set_user_mask");
    jdField_e_of_type_JavaLangString = weg.a("StorySvc.video_get_user_mask_states");
    jdField_f_of_type_JavaLangString = weg.a("StorySvc.video_show_video_list");
  }
  
  public vzv(AppInterface paramAppInterface)
  {
  ...
  public List<QQStoryUserInfo> a(boolean paramBoolean)
  {
    ...
    {
      Bosses.get().postJob(new vzw(this, "QQStoryManager", paramBoolean));
      return localList;
  ...
  public void a()
  {
    ...
    b(bhhr.h(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin()));
    this.jdField_a_of_type_Wie = new wie(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
  }
