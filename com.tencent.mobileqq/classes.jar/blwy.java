...
public class blwy
{
  ...
  private blwz jdField_a_of_type_Blwz;
  ...
  public Frame a(Frame paramFrame, int paramInt1, int paramInt2, List<List<PointF>> paramList, List<float[]> paramList1)
  {
    ...
    for (;;)
    {
      if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Blwz != null))
      {
        GLES20.glEnable(3042);
        GLES20.glBlendFunc(770, 771);
        float f1 = -1.0F + this.jdField_a_of_type_Blwz.jdField_a_of_type_Float * 2.0F;
        float f2 = -1.0F + this.jdField_a_of_type_Blwz.b * 2.0F;
        float f3 = this.jdField_a_of_type_Blwz.c * 2.0F + f1;
        float f4 = this.jdField_a_of_type_Blwz.d * 2.0F + f2;
        this.jdField_a_of_type_ComTencentFilterBaseFilter.setPositions(new float[] { f1, f2, f1, f4, f3, f4, f3, f2 });
        this.jdField_a_of_type_ComTencentFilterBaseFilter.RenderProcess(this.jdField_a_of_type_Blwz.jdField_a_of_type_Int, paramFrame.width, paramFrame.height, -1, 0.0D, paramFrame);
  ...
  {
    this.jdField_a_of_type_Blwz = new blwz(this);
    blxf localblxf = new blxf((int)(320.0F * paramFloat3), (int)(320.0F * paramFloat4));
    localblxf.a(paramString1);
    localblxf.a(paramInt1);
    localblxf.b(paramString2);
    localblxf.c(paramString3);
    localblxf.a(paramInt2);
    localblxf.d(paramString4);
    localblxf.a();
    paramString1 = localblxf.a();
    this.jdField_a_of_type_Blwz.jdField_a_of_type_Int = RendererUtils.createTexture(paramString1);
    localblxf.b();
    this.jdField_a_of_type_Blwz.jdField_a_of_type_Float = paramFloat1;
    this.jdField_a_of_type_Blwz.b = paramFloat2;
    this.jdField_a_of_type_Blwz.c = paramFloat3;
    this.jdField_a_of_type_Blwz.d = paramFloat4;
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Blwz != null)
    {
      int[] arrayOfInt = new int[1];
      arrayOfInt[0] = this.jdField_a_of_type_Blwz.jdField_a_of_type_Int;
