  ...
  implements View.OnClickListener
{
  ...
  public vpq(Context paramContext)
  {
    super(paramContext);
  }
  
  public vpq(Context paramContext, WSVerticalPageFragment paramWSVerticalPageFragment)
  {
    this(paramContext);
  ...
  protected void b()
  {
    vmp.a("GdtAdWSVerticalItemTopController", "onUpdateUI hashcode******************************" + hashCode() + ",position:" + a());
    vpj localvpj = (vpj)a();
    if (localvpj == null) {}
    while (!(localvpj.a() instanceof stSimpleMetaFeed)) {
      return;
  ...
  protected void e()
  {
    ...
    this.b = a(2131376968);
    this.jdField_a_of_type_ComTencentBizPubaccountWeishi_newViewRoundImageView = ((RoundImageView)a(2131367578));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131367581));
  ...
  public void onClick(View paramView)
  {
    ...
    {
      vmp.b("GdtAdWSVerticalItemTopController", "跳转到广告落地页");
      ...
      if (this.jdField_a_of_type_ComTencentAdTangramUtilAdExposureChecker$ExposureCallback == null) {
        this.jdField_a_of_type_ComTencentAdTangramUtilAdExposureChecker$ExposureCallback = new vpr(this);
      }
      ...
      if ((this.jdField_a_of_type_Vnw != null) && (this.jdField_a_of_type_Vnw.a() != null))
      {
        ...
        if ((localObject != null) && (((vrn)localObject).a != null) && (a() != null) && (((vpj)a()).a() != null))
        {
          vpk.a(a(), this.jdField_a_of_type_UserGrowthStSimpleMetaFeed, jdField_a_of_type_ComTencentGdtadAditemGdtAppReceiver, ((vrn)localObject).a, false);
