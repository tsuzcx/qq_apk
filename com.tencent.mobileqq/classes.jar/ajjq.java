...
public class ajjq
  extends anmu
{
  public ajjq(RecommendFriendFragment paramRecommendFriendFragment) {}
  ...
  protected void onMayknowStateChanged(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      if (this.a.jdField_a_of_type_Ajjr != null) {
        this.a.jdField_a_of_type_Ajjr.notifyDataSetChanged();
      }
