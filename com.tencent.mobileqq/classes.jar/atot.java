  ...
  extends atcb
{
  ...
  protected void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, String paramString)
  {
    ...
    do
    {
      ...
      str = bbjw.a(paramString, "<head>", "</head>");
      paramString = bbjw.a(paramString, "<body>", "</body>");
    } while (!this.a.isResume());
    bbio.a(this.a, str, paramString, paramInt3 - paramInt1).show();
  }
  ...
  public void a(boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3, byte[] paramArrayOfByte, String paramString)
  {
    ...
    anmg.c("profileCard", new Object[] { ((StringBuilder)localObject).toString() });
    localObject = this.a;
    ...
    if (paramBoolean1) {
      if (paramBoolean2)
      {
        anmg.c(NearbyPeopleProfileActivity.class.getSimpleName(), new Object[] { "onGetShowLoveLimit , can chat, someting is wrong" });
    ...
    for (;;)
    {
      ...
      if (paramBoolean3)
      {
        if (NearbyPeopleProfileActivity.a(this.a) != null)
        {
          ...
          bazo.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne);
          QLog.d("Q.nearby_people_card.", 1, "ShowLoveEditorActivity 已在725下架");
        }
      }
      else
      {
        anmg.c(NearbyPeopleProfileActivity.class.getSimpleName(), new Object[] { "cant show love, wording is " + paramString });
        paramArrayOfByte = paramString;
        if (TextUtils.isEmpty(paramString)) {
          paramArrayOfByte = ((Activity)localObject).getResources().getString(2131699335);
        }
        anmg.a(this.a, paramArrayOfByte);
        continue;
        anmg.a((Activity)localObject, ((Activity)localObject).getString(2131699334));
      }
    }
  }
  ...
  protected void a(boolean paramBoolean1, NearbyPeopleCard paramNearbyPeopleCard, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        ((atah)this.a.app.getManager(207)).a(paramNearbyPeopleCard.uin, false);
  ...
  public void a(boolean paramBoolean1, NearbyPeopleCard paramNearbyPeopleCard, boolean paramBoolean2, String paramString)
  {
    ...
    if (paramBoolean1)
    {
      ...
      if (this.a.t)
      {
        this.a.jdField_a_of_type_Atbx.a(true);
        this.a.t = false;
      }
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    if (paramBoolean)
    {
      paramString = (atah)this.a.app.getManager(207);
      if (NearbyPeopleProfileActivity.a(this.a) != null) {
    ...
    return;
    label157:
    this.a.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new atou(this, paramString));
  ...
  {
    if ((NearbyPeopleProfileActivity.a(this.a) == null) || (TextUtils.isEmpty(NearbyPeopleProfileActivity.a(this.a).uin)) || (TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString1)) || (bbbd.a(paramString2, paramString1))) {}
    do
    {
      do
      {
        return;
      } while ((!bbbd.a(paramString2, NearbyPeopleProfileActivity.a(this.a).uin)) || (!bbbd.a(paramString1, this.a.app.getCurrentAccountUin())));
      if (!paramBoolean)
      {
        this.a.b(this.a.getResources().getString(2131693542));
  ...
  public void a(boolean paramBoolean, String paramString1, List<atfk> paramList, String paramString2, int paramInt1, int paramInt2)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      this.a.a();
      this.a.a(2, ajyc.a(2131707239));
      return;
    }
    this.a.a();
    this.a.a(1, ajyc.a(2131707230) + paramString2);
  }
  ...
  protected void a(boolean paramBoolean, UpdatePhotoList.HeadInfo paramHeadInfo)
  {
    ...
    if (this.a.jdField_a_of_type_Long > 0L) {
      bazj.a(this.a.jdField_a_of_type_Atbx, this.a.app, this.a.jdField_a_of_type_Long, null, this.a.jdField_d_of_type_Int, arrayOfByte, l, true, this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Long, NearbyPeopleProfileActivity.a(this.a.j), NearbyPeopleProfileActivity.a(this.a), NearbyPeopleProfileActivity.a(this.a));
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      return;
      if (!bbjw.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString)) {
        bazj.a(this.a.jdField_a_of_type_Atbx, this.a.app, 0L, this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString, this.a.jdField_d_of_type_Int, arrayOfByte, l, true, this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Long, NearbyPeopleProfileActivity.a(this.a.j), NearbyPeopleProfileActivity.a(this.a), NearbyPeopleProfileActivity.a(this.a));
      }
    }
  }
}
