  ...
  implements GLSurfaceView.Renderer
{
  ...
  public Bitmap a(Bitmap paramBitmap, long paramLong)
  {
    ...
    Object localObject = bppt.a(0);
    QQFilterRenderManager localQQFilterRenderManager = bmvb.a(bmvb.c);
    if (localQQFilterRenderManager != null)
    {
      ...
      this.jdField_a_of_type_Bprr = new bprr(localQQFilterRenderManager.getBusinessOperation().getCurrentAVFilterIdList(), localMusicItemInfo, this.b, this.c, null);
      this.jdField_a_of_type_Bprr.a(true);
      if ((this.jdField_a_of_type_Bprr == null) || (localObject == null)) {
        break label210;
      }
    }
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Bprr.a(this.b, this.c);
      ...
      try
      {
        ...
        this.jdField_a_of_type_Bprr = null;
        return localObject;
      }
  ...
  public Bitmap a(Bitmap paramBitmap, GPUBaseFilter paramGPUBaseFilter)
  {
    ...
    if ((this.jdField_a_of_type_Bprr != null) && (this.jdField_a_of_type_Bprr.jdField_a_of_type_Boolean)) {}
    for (int i = 30;; i = 2)
    {
      int j = 0;
      while (j < i)
  ...
  public Bitmap a(Bitmap paramBitmap, List<FilterDesc> paramList, bppu parambppu)
  {
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter = parambppu.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter;
    this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = parambppu.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager;
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null) && (this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter != null) && (paramList != null))
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
      int i = 5;
      if (parambppu.jdField_a_of_type_Boolean)
      {
        parambppu.jdField_a_of_type_Boolean = false;
        i = 20;
      }
      int j = 0;
      while (j < i)
  ...
  {
    GPUBaseFilter localGPUBaseFilter = bppt.a(0);
  ...
  {
    if (Build.VERSION.SDK_INT >= 17) {
      this.jdField_a_of_type_Bbmk = new bbmk(EGL14.EGL_NO_CONTEXT, 1);
    }
    d(paramInt1, paramInt2);
  }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter = bppt.a(0);
    this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = bmvb.b();
    ...
    for (;;)
    {
      ...
      for (localObject = this.jdField_a_of_type_AndroidGraphicsBitmap;; localObject = paramGL10)
      {
        ...
        if (this.jdField_a_of_type_Bprr != null) {
          this.jdField_a_of_type_Int = this.jdField_a_of_type_Bprr.a(this.b, this.c, this.jdField_a_of_type_Int, this.jdField_a_of_type_Long);
        }
        if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null)
        {
