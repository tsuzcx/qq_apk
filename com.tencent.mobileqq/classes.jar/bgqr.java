...
public class bgqr
{
  ...
  static
  {
    ...
    for (;;)
    {
      ...
      {
        if (bgqr.class.getName().equals(arrayOfStackTraceElement[i].getClassName())) {
  ...
  public bgqr a(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    return this;
  }
  
  public bgqr a(String paramString1, int paramInt, String paramString2)
  {
  ...
  public bgqr b(String paramString1, int paramInt, String paramString2)
  {
    a(paramString1, paramInt, 4, paramString2, this.b);
    return this;
  }
  
  public bgqr c(String paramString1, int paramInt, String paramString2)
  {
