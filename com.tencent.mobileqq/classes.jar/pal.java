  ...
  implements pln
{
  ...
  private static pal jdField_a_of_type_Pal;
  ...
  private Map<Pair<Long, Pair<View, BaseArticleInfo>>, Long> jdField_a_of_type_JavaUtilMap = new TreeMap(new pam(this));
  ...
  static
  {
    ...
    jdField_b_of_type_JavaUtilMap = new TreeMap(new pan());
  }
  ...
  {
    return pgb.a(paramArticleInfo, paramInt);
  }
  ...
  private static String a(ArticleInfo paramArticleInfo, int paramInt)
  {
    ...
    for (paramInt = 1; (!ozp.a(i1)) && (paramInt == 0); paramInt = 0) {
      return "";
    }
    if (paramInt == 0) {}
  ...
  public static List<BaseArticleInfo> a(String paramString)
  {
    ...
    catch (JSONException paramString)
    {
      for (;;)
      {
        ...
        if (i2 == 1)
        {
          ...
          localObject1 = qlh.a((articlesummary.ArticleSummary)((oidb_cmd0x68b.RspGetFollowTabFeeds)localObject3).msg_article_summary.get(), 70, 0, null);
              ...
              if (((articlesummary.FeedsInfo)((articlesummary.ArticleSummary)localObject3).msg_feeds_info.get()).msg_pos_ad_info.has())
              {
                ...
                if (localObject2 != null)
                {
                  ...
                  if (((articlesummary.PosAdInfo)localObject2).int32_ret.get() == 0)
                  {
                    ...
                    qlh.a((articlesummary.ArticleSummary)localObject3, 0, 0, paramString);
    ...
    if ((localIterator != null) && (localIterator.hasNext()))
    {
      ...
      for (;;)
      {
        localObject2 = bfuc.decode(paramString.getBytes(), 0);
        i2 = localObject2[0];
        localObject1 = null;
        if (i2 != 0) {
          break;
        ...
        paramString = qlh.a(paramString, 0, 0, null);
  ...
  public static pal a()
  {
    if (jdField_a_of_type_Pal == null) {}
    try
    {
      if (jdField_a_of_type_Pal == null) {
        jdField_a_of_type_Pal = new pal();
      }
      return jdField_a_of_type_Pal;
    }
    finally {}
  }
  ...
  private void a(List<BaseArticleInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        {
          localBaseArticleInfo.articleViewModel = tfp.a(localBaseArticleInfo);
  ...
  {
    paramArticleInfo = slt.a(paramArticleInfo, paramInt);
  ...
  private static String c(String paramString)
  {
    ...
    if ((paramString != null) && (Integer.parseInt(paramString.getString(d)) > 0))
    {
      ...
      bkwm.a(d, Integer.valueOf(jdField_a_of_type_Int));
  ...
  private void c()
  {
    jdField_a_of_type_Int = ((Integer)bkwm.a(d, Integer.valueOf(0))).intValue();
    QLog.d(jdField_b_of_type_JavaLangString, 2, "local version " + jdField_a_of_type_Int);
    try
    {
      jdField_a_of_type_OrgJsonJSONObject = new JSONObject((String)bkwm.a(f, ""));
      jdField_b_of_type_OrgJsonJSONObject = new JSONObject((String)bkwm.a(g, ""));
      jdField_c_of_type_OrgJsonJSONObject = new JSONObject((String)bkwm.a(e, ""));
      return;
    }
  ...
  private static void e()
  {
    ...
    {
      return;
      bkwm.a(f, jdField_a_of_type_OrgJsonJSONObject.toString());
    } while ((jdField_c_of_type_OrgJsonJSONObject == null) || (jdField_c_of_type_OrgJsonJSONObject.length() == 0));
    bkwm.a(e, jdField_c_of_type_OrgJsonJSONObject.toString());
  }
  
  private static String f()
  {
    Object localObject2 = pem.a();
    if (localObject2 == null)
    {
    ...
    if (localObject1 != null)
    {
      ...
      localObject2 = new pao((TicketManager)localObject1, (QQAppInterface)localObject2);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i1 < i2)
        {
          ...
          localObject = new String(bfuc.encode(arrayOfByte, 0));
  ...
  public void a(pap parampap)
  {
    this.jdField_a_of_type_Pap = parampap;
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (a(str))
        {
          ...
          paramArticleSummary = new String(bfuc.encode(paramArticleInfo, 0));
          if (jdField_c_of_type_OrgJsonJSONObject != null)
          {
  ...
  public void b()
  {
    this.jdField_a_of_type_Pap = null;
  }
