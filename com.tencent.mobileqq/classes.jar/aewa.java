  ...
  implements Manager
{
  ...
  public aewa(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(AcsMsg paramAcsMsg)
  {
      ...
      do
      {
        for (;;)
        {
          ...
          try
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.d("ActivateFriends.Manager", 2, "setAlarmTimer at " + aeuy.a(l, "yyyyMMdd HH:mm:ss") + " msg: " + (String)localObject1 + " alarmId: " + i);
            }
            ...
            ((Intent)localObject2).putExtra("msg_id", aevc.a(paramAcsMsg));
    ...
    QLog.d("ActivateFriends.Manager", 2, "has already setAlarmTimer at " + aeuy.a(l, "yyyyMMdd HH:mm:ss"));
  }
