...
public class aoqj
  implements aoqf, aoqg, Manager
{
  private long jdField_a_of_type_Long;
  private ahtp jdField_a_of_type_Ahtp;
  private aoqc jdField_a_of_type_Aoqc;
  private aoqh jdField_a_of_type_Aoqh;
  private aoqk jdField_a_of_type_Aoqk;
  public PeakAppInterface a;
  private HashMap<String, String> jdField_a_of_type_JavaUtilHashMap;
  private List<aoqb> jdField_a_of_type_JavaUtilList;
  ...
  private long a(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return l3;
          ConcurrentHashMap localConcurrentHashMap = this.jdField_a_of_type_Aoqc.a();
          ...
          if (localObject != null)
          {
            ...
            if (((List)localObject).size() > 0)
            {
              ...
              for (;;)
              {
                ...
                aoqe localaoqe = (aoqe)localConcurrentHashMap.get(str);
                l2 = l1;
                if (localaoqe != null)
                {
                  l2 = l1 + localaoqe.jdField_a_of_type_Long;
                  localaoqe.b += 1;
                  this.jdField_a_of_type_Aoqc.a(str, localaoqe);
                }
                l1 = l2;
              }
            }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else if (aoqm.c(i))
        {
          paramList = azhh.a(paramList);
          if (paramList != null) {
            paramList = aufd.a(this.jdField_a_of_type_ComTencentMobileqqAppPeakAppInterface, paramList);
          }
        }
        else if (aoqm.d(i))
        {
        ...
        {
          paramList = azhh.a(paramList);
          if ((paramList != null) && ((paramList instanceof MessageForStructing)) && (axiv.a((MessageForStructing)paramList))) {
            b(paramString, this.jdField_a_of_type_Aoqk.c(MessageRecord.class, "select * from mr_multimessage where msgseq=?", "mr_multimessage", "msgseq=?", new String[] { String.valueOf(paramList.uniseq) }));
          }
        }
        paramList = "";
        continue;
  ...
  private String a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      continue;
      str1 = this.jdField_a_of_type_Aoqk.a(paramMessageRecord.frienduin);
      continue;
      if (this.jdField_a_of_type_Ahtp != null)
      {
        str1 = this.jdField_a_of_type_Ahtp.a(paramMessageRecord.senderuin, paramMessageRecord.frienduin);
        continue;
        str1 = this.jdField_a_of_type_Aoqk.a(paramMessageRecord.senderuin, paramMessageRecord.frienduin);
      }
    }
  }
  ...
  private boolean a(aoqb paramaoqb)
  {
    if ((paramaoqb == null) || (this.jdField_a_of_type_Ahtp == null)) {}
    String str;
    do
    {
      return true;
      str = MessageRecord.getTableName(paramaoqb.jdField_a_of_type_JavaLangString, paramaoqb.jdField_a_of_type_Int);
    } while (TextUtils.isEmpty(str));
    b(str);
    if (this.jdField_a_of_type_Ahtp != null) {
      this.jdField_a_of_type_Ahtp.b(paramaoqb.jdField_a_of_type_JavaLangString, paramaoqb.jdField_a_of_type_Int);
    }
    a(str);
    return true;
  }
    ...
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null))
    {
      ...
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          aoqe localaoqe = (aoqe)localConcurrentHashMap.get(str1);
          if (localaoqe != null)
          {
            localaoqe.b -= 1;
            if (localaoqe.b == 0)
            {
              String str2 = this.jdField_a_of_type_Aoqc.a(localaoqe);
              if (!TextUtils.isEmpty(str2))
              {
                this.jdField_a_of_type_Long += localaoqe.jdField_a_of_type_Long;
                paramString.add(str2);
              }
              this.jdField_a_of_type_Aoqc.a(str1);
            }
            else
            {
              this.jdField_a_of_type_Aoqc.a(str1, localaoqe);
            }
          }
        }
        this.jdField_a_of_type_Aoqc.a(paramString);
      }
    }
  }
  ...
  private boolean b()
  {
    return (this.jdField_a_of_type_Aoqc != null) && (this.jdField_a_of_type_Aoqc.a());
  }
  
  private void c()
  {
    this.jdField_a_of_type_Aoqk = new aoqk();
    AppInterface localAppInterface = this.jdField_a_of_type_Aoqk.a();
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_Aoqk.a(this);
    this.jdField_a_of_type_Aoqc = new aoqc(this);
  }
  ...
  private void f()
  {
    ...
    Object localObject = this.jdField_a_of_type_Aoqk.a();
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      b(str1, this.jdField_a_of_type_Aoqk.a(MessageRecord.class, str2, str1, null, null));
    }
    this.jdField_b_of_type_Boolean = true;
    if (QLog.isColorLevel()) {
  ...
  private void g()
  {
    ...
    Object localObject = this.jdField_a_of_type_Aoqk.b();
    if ((localObject == null) || (((ArrayList)localObject).size() == 0))
    {
      if (QLog.isColorLevel()) {
    ...
    while (((Iterator)localObject).hasNext())
    {
      String str1 = (String)((Iterator)localObject).next();
      String str2 = String.format("select * from %s", new Object[] { str1 });
      b(str1, this.jdField_a_of_type_Aoqk.b(MessageRecord.class, str2, str1, null, null));
    }
    this.c = true;
    if (QLog.isColorLevel()) {
  ...
  private void h()
  {
    if ((a()) && (b()))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localaoqb.jdField_a_of_type_JavaLangString = ((MessageRecord)localObject).frienduin;
          localaoqb.jdField_b_of_type_JavaLangString = a((MessageRecord)localObject);
          localaoqb.jdField_a_of_type_Int = ((MessageRecord)localObject).istroop;
          localaoqb.jdField_b_of_type_Long = ((MessageRecord)localObject).time;
          localaoqb.jdField_a_of_type_Long = a(MessageRecord.getTableName(localaoqb.jdField_a_of_type_JavaLangString, ((MessageRecord)localObject).istroop));
          if ((localaoqb.jdField_a_of_type_Long > 0L) && (this.jdField_a_of_type_JavaUtilList != null))
          {
            localaoqb.c = aoqd.a(localaoqb.jdField_a_of_type_Long);
            this.jdField_a_of_type_JavaUtilList.add(localaoqb);
          }
        }
      }
      ...
      if (this.jdField_a_of_type_Aoqh != null)
      {
        a(1);
        if (QLog.isColorLevel()) {
          QLog.e("MessageCleanManager", 2, "conformAllData onLoadFinish");
        }
        this.jdField_a_of_type_Aoqh.a(this.jdField_a_of_type_JavaUtilList);
      }
    }
    for (;;)
    {
  ...
  private void i()
  {
    ...
    if (this.jdField_a_of_type_Aoqc != null) {
      this.jdField_a_of_type_Aoqc.b();
    }
  }
  ...
  public List<aoqb> a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilList != null) {
      Collections.sort(this.jdField_a_of_type_JavaUtilList, new aoqa(paramInt));
    }
    return this.jdField_a_of_type_JavaUtilList;
  }
  
  public List<aoqb> a(List<aoqb> paramList)
  {
    if ((paramList == null) || (paramList.isEmpty()) || (this.jdField_a_of_type_Ahtp == null)) {
      return this.jdField_a_of_type_JavaUtilList;
    }
    if (QLog.isColorLevel()) {
    ...
    {
      aoqb localaoqb = (aoqb)paramList.next();
      if (this.jdField_a_of_type_JavaUtilList != null) {
        this.jdField_a_of_type_JavaUtilList.remove(localaoqb);
      }
    }
    return this.jdField_a_of_type_JavaUtilList;
  }
  ...
  public void a(aoqh paramaoqh)
  {
    this.jdField_a_of_type_Aoqh = paramaoqh;
  }
  ...
  public void b()
  {
    ...
    } while (this.jdField_a_of_type_Aoqh == null);
    if (QLog.isColorLevel()) {
  ...
  {
    i();
    this.jdField_a_of_type_Aoqh = null;
    this.jdField_a_of_type_Ahtp = null;
  }
}
