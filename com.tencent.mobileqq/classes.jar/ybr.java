...
public class ybr
{
  public static void a(Activity paramActivity)
  {
    ...
    while (lko.b(BaseApplicationImpl.getContext())) {
      return;
    }
    if (!bbbd.a())
    {
    ...
    Object localObject = ajsf.aW + "shortvideo/" + System.currentTimeMillis() + ".mp4";
      ...
      do
      {
        ...
        if ((localMessageRecord instanceof MessageForDevShortVideo))
        {
          ...
          if (!paramSession.bSend) {
            if (paramSession.actionInfo.strServiceName.equalsIgnoreCase(yeu.e))
            {
              Object localObject3 = new ybq();
              ((ybq)localObject3).a = paramSession.strFilePathSrc;
              ((ybq)localObject3).a();
              ((MessageForDevShortVideo)localObject2).md5 = ((ybq)localObject3).jdField_c_of_type_JavaLangString;
              ((MessageForDevShortVideo)localObject2).videoFileTime = ((int)(((ybq)localObject3).jdField_b_of_type_Long / 1000L));
              ((MessageForDevShortVideo)localObject2).thumbWidth = ((ybq)localObject3).jdField_b_of_type_Int;
              ((MessageForDevShortVideo)localObject2).thumbHeight = ((ybq)localObject3).jdField_c_of_type_Int;
              ((MessageForDevShortVideo)localObject2).thumbMD5 = ((ybq)localObject3).e;
              if (!paramBoolean) {
                break label282;
              }
              ...
              bbdj.b(paramSession.strFilePathSrc, (String)localObject3);
            }
          }
          for (;;)
          {
