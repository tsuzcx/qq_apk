...
class abth
  extends nac
{
  abth(abtg paramabtg, abts paramabts, JSONObject paramJSONObject, absf paramabsf) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.i(abtg.a, 2, "onResult appid=" + abtg.a(this.jdField_a_of_type_Abtg).a + ", openid=" + this.jdField_a_of_type_Abts.a + ", openkey=" + this.jdField_a_of_type_Abts.b + ", code=" + paramInt + ", req param=" + this.jdField_a_of_type_OrgJsonJSONObject);
    }
    if ((paramInt != 0) || (paramArrayOfByte == null))
    {
      abvm.a(this.jdField_a_of_type_Absf, paramInt, "getRankingList result error, try again");
      return;
    }
    ...
    catch (InvalidProtocolBufferMicroException paramBundle)
    {
      ...
      abvm.a(this.jdField_a_of_type_Absf, -1, "parse result error, try again");
    }
    if (paramArrayOfByte != null)
    {
      ...
      try
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.e(abtg.a, 2, localJSONException.getMessage(), localJSONException);
          }
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e(abtg.a, 2, paramArrayOfByte.getMessage(), paramArrayOfByte);
        }
      }
      QLog.i(abtg.a, 2, "result is, " + paramBundle.toString());
      abvm.a(this.jdField_a_of_type_Absf, paramBundle);
      return;
    }
  }
}
