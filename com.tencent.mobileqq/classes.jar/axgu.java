  ...
  implements Manager
{
  ...
  private axgy jdField_a_of_type_Axgy;
  private axgz jdField_a_of_type_Axgz;
  private axha jdField_a_of_type_Axha;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private HashMap<Long, WeakReference<axgx>> jdField_a_of_type_JavaUtilHashMap = new HashMap(5);
  private boolean jdField_a_of_type_Boolean = true;
  private HashMap<Long, WeakReference<axgv>> b = new HashMap(20);
  private HashMap<Long, Boolean> c = new HashMap(200);
  private HashMap<Long, WeakReference<axgw>> d = new HashMap(5);
  private HashMap<Long, ArrayList<Long>> e = new HashMap(5);
  private HashMap<Long, ArrayList<Long>> f = new HashMap(5);
  
  public axgu(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Auzd = ((auzd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.INTIMATE_INFO_MANAGER));
  }
  ...
  private ArrayList<Long> a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 58	axgu:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   20: aload_0
    //   21: getfield 58	axgu:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
  ...
  private void a(long paramLong, axgx paramaxgx)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.3(this, paramLong, paramaxgx));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, axgv paramaxgv)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.2(this, paramLong, paramArrayList, paramaxgv));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, axgw paramaxgw)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.1(this, paramArrayList, paramLong, paramaxgw));
  }
  ...
  public IntimateInfo a(long paramLong1, long paramLong2)
  {
    ...
    if (localIntimateInfo2 == null)
    {
      ...
      localIntimateInfo2 = this.jdField_a_of_type_Auzd.a(str);
  ...
  public void a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Axgy != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Axgy);
      this.jdField_a_of_type_Axgy = null;
    }
    if (this.jdField_a_of_type_Axgz != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Axgz);
      this.jdField_a_of_type_Axgz = null;
    }
    if (this.jdField_a_of_type_Axha != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Axha);
      this.jdField_a_of_type_Axha = null;
    }
  ...
  public void a(Context paramContext, long paramLong, ArrayList<Long> arg4, axgv paramaxgv)
  {
    if (QLog.isColorLevel())
    {
    ...
    for (Object localObject1 = ???.toString();; localObject1 = "null")
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramaxgv != null) && (??? != null))
      {
        if (NetworkUtil.isNetSupport(paramContext)) {
          break;
        }
        a(paramLong, ???, paramaxgv);
      }
      return;
    }
    ...
    a(paramLong, ???, paramaxgv);
    paramaxgv = new WeakReference(paramaxgv);
    synchronized (this.b)
    {
      this.b.put(Long.valueOf(paramLong), paramaxgv);
      ??? = new HashMap(5);
      ???.put("alreadyRequest", localObject1);
      ???.put("notRequest", paramContext);
      paramaxgv = new ArrayList(1);
      paramaxgv.add(Long.valueOf(paramLong));
      ???.put("groupUin", paramaxgv);
      ((auzb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.INTIMATE_INFO_HANDLER)).a(paramLong, paramContext, ???);
      return;
    }
  }
  
  public void a(Context arg1, long paramLong, ArrayList<Long> paramArrayList, axgw paramaxgw)
  {
    Object localObject2;
    if (QLog.isColorLevel())
    {
    ...
    {
      QLog.d("MultiCardManager", 2, (String)localObject1);
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramaxgw != null) && (paramArrayList != null))
      {
        if (NetworkUtil.isNetSupport(???)) {
          break;
        }
        a(paramLong, paramArrayList, paramaxgw);
      }
      return;
    }
    synchronized (this.e)
    ...
    for (;;)
    {
      ...
      paramArrayList = new WeakReference(paramaxgw);
      synchronized (this.d)
      {
        this.d.put(Long.valueOf(paramLong), paramArrayList);
        ((aoep)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.TROOP_HANDLER)).a(false, paramLong + "", "0", 9);
        return;
        label318:
  ...
  public void a(String paramString, IntimateInfo paramIntimateInfo)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Auzd.a(paramString, paramIntimateInfo);
