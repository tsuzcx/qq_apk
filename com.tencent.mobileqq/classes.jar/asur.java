  ...
  extends DialogFromBottom
{
  ...
  private adlk jdField_a_of_type_Adlk;
  private asut jdField_a_of_type_Asut;
  private int b;
  private int c;
  private int d;
  ...
  static
  {
    jdField_a_of_type_Asus = new asus(null);
  }
  
  public asur(@NotNull Context paramContext, int paramInt, @Nullable asut paramasut)
  {
    super(paramContext);
    this.jdField_a_of_type_Asut = paramasut;
    this.d = paramInt;
  ...
  {
    Object localObject1 = LayoutInflater.from(paramContext).inflate(2131561111, null);
    if (localObject1 == null) {
      throw new TypeCastException("null cannot be cast to non-null type android.widget.LinearLayout");
    }
    localObject1 = (LinearLayout)localObject1;
    this.jdField_a_of_type_Adlk = new adlk(paramContext, paramInt, true);
    Object localObject2 = this.jdField_a_of_type_Adlk;
    if (localObject2 == null) {
      Intrinsics.throwNpe();
    }
    ((adlk)localObject2).a((adlm)new asuu(this));
    localObject2 = this.jdField_a_of_type_Adlk;
    if (localObject2 == null) {
      Intrinsics.throwNpe();
    }
    localObject2 = ((adlk)localObject2).a();
    ...
    ((ImageView)((LinearLayout)localObject1).findViewById(2131362985)).setOnClickListener((View.OnClickListener)new asuv(this));
    setOnCancelListener((DialogInterface.OnCancelListener)asuw.a);
    ((Button)((LinearLayout)localObject1).findViewById(2131365067)).setOnClickListener((View.OnClickListener)new asux(this));
  }
}
