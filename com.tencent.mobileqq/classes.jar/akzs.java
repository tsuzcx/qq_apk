  ...
  implements Handler.Callback
{
  ...
  private void b()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Akzt != null) {
          this.jdField_a_of_type_Akzt.a(2);
        }
      }
    }
  }
  ...
  private void b(long paramLong)
  {
    ...
    catch (Exception localException)
    {
      ...
      this.jdField_a_of_type_Akzt.a(4);
    }
  }
  ...
  private void b(byte[] paramArrayOfByte, long paramLong)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      this.jdField_a_of_type_Akzt.a(3);
    }
  }
  ...
  public void a(avza paramavza, akzt paramakzt)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqArARRecordVideoEncoderCore.a(paramavza, paramakzt);
      if (this.jdField_a_of_type_Akzt != null) {
        this.jdField_a_of_type_Akzt.a();
      }
      return;
    }
    catch (Exception paramavza)
    {
      for (;;)
      {
        QLog.e("VideoEncoder", 1, "startRecording start encoder fail.", paramavza);
        if (this.jdField_a_of_type_Akzt != null) {
          this.jdField_a_of_type_Akzt.a(1);
        }
      }
    }
  }
