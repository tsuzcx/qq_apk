...
public class akzs
  implements akmo, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, Handler.Callback, View.OnClickListener, TouchWebView.OnScrollChangedListener
{
  public float a;
  ...
  private alab jdField_a_of_type_Alab;
  ...
  public akzs(RelativeLayout paramRelativeLayout, alab paramalab)
  {
    this.jdField_a_of_type_Alab = paramalab;
    ...
    paramalab = new RelativeLayout.LayoutParams(100, 100);
    this.jdField_a_of_type_Akmm = new akzt(this);
    this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRender().setRenderCallback(this.jdField_a_of_type_Akmm);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView, paramalab);
    this.jdField_e_of_type_Float = (alnq.a() / 16.0F);
    if (this.jdField_e_of_type_Float != 0.0F) {
      this.jdField_d_of_type_Float = (bdcb.a() / this.jdField_e_of_type_Float);
    }
    if (this.jdField_d_of_type_Float == 0.0F) {
      this.jdField_d_of_type_Float = bdcb.a();
    }
    ...
    this.jdField_a_of_type_Akzx = new akzx();
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = new RelativeLayout(paramRelativeLayout);
    paramalab = new ImageView(paramRelativeLayout);
    paramalab.setImageResource(2130839224);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(13, -1);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.addView(paramalab, localLayoutParams);
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundResource(2130838501);
  ...
  private String b(int paramInt, boolean paramBoolean, ApolloWebAvatarParam paramApolloWebAvatarParam)
  {
    ...
    if (!albu.a(paramApolloWebAvatarParam.uin, paramApolloWebAvatarParam.roleId, paramApolloWebAvatarParam.dressIds, null))
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), alpo.a(2131700946), 0).a();
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        if ((paramApolloWebAvatarParam.tapRectWidth > 0) && (paramApolloWebAvatarParam.tapRectHeight > 0))
        {
          ...
          this.jdField_a_of_type_Bhow.sendEmptyMessageDelayed(23, 500L);
          ...
          ((RelativeLayout.LayoutParams)???).topMargin = ((int)(paramApolloWebAvatarParam.y * this.jdField_d_of_type_Float - (float)bdcb.j() * this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.rate));
          ((RelativeLayout.LayoutParams)???).rightMargin = ((int)((float)bdcb.i() - this.jdField_d_of_type_Float * paramApolloWebAvatarParam.x - ((RelativeLayout.LayoutParams)???).width - ApolloUtil.a(68.0F, this.jdField_d_of_type_Float) * this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.rate / 0.289F));
          ...
          this.jdField_a_of_type_Bhow.sendMessage(paramApolloWebAvatarParam);
  ...
  private void e()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) {
          if (this.jdField_i_of_type_Int == 0) {
            ...
            for (;;)
            {
              if (!new File(akzg.b(this.jdField_i_of_type_Int)).exists()) {
                break label395;
              }
              this.jdField_a_of_type_Bhow.sendEmptyMessageDelayed(24, (int)(this.jdField_f_of_type_Float * 1000.0F));
              return;
              k = 0;
              break;
              m = 0;
      ...
      if ((!TextUtils.isEmpty(albv.a().jdField_a_of_type_JavaLangString)) && ("interactive".equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.tab)))
      {
        this.jdField_a_of_type_Bhow.sendEmptyMessageDelayed(24, 0L);
        return;
      }
    ...
    for (int m = 1;; m = 0)
    {
      ...
      if ((!akzg.a(this.jdField_c_of_type_Int)) || (m != 0) || (k != 0) || (n == 0)) {
        break;
      }
      try
      {
        bdaz.a(BaseApplicationImpl.getContext(), true);
        this.jdField_a_of_type_AndroidMediaMediaPlayer.reset();
        this.jdField_a_of_type_AndroidMediaMediaPlayer.setDataSource(alef.jdField_d_of_type_JavaLangString + this.jdField_c_of_type_Int + "/" + "music.amr");
  ...
  private void f()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Bhow != null) {
        this.jdField_a_of_type_Bhow.removeMessages(24);
      }
      return;
    }
  ...
  public String a()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null))
    {
      ...
      String[] arrayOfString = albu.a(10, -1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
      if ((arrayOfString.length > 0) && (!TextUtils.isEmpty(arrayOfString[0])) && (arrayOfString[0].length() - "action".length() > 0)) {}
      albv.a().jdField_a_of_type_JavaLangString = arrayOfString[0].substring(0, arrayOfString[0].length() - "action".length());
    ...
    this.jdField_a_of_type_Bhow.sendEmptyMessageDelayed(22, 100L);
    return a(alpo.a(2131700934));
  }
  ...
  public String a(int paramInt, boolean paramBoolean, ApolloWebAvatarParam paramApolloWebAvatarParam)
  {
    ...
    if (!albu.a(paramApolloWebAvatarParam.uin, paramApolloWebAvatarParam.roleId, paramApolloWebAvatarParam.dressIds, null))
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), alpo.a(2131700933), 0).a();
      return a("dresses is not download!");
    }
    if ((!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString)) && (!this.jdField_e_of_type_JavaLangString.equals(paramApolloWebAvatarParam.tab)))
    {
      ...
      this.jdField_a_of_type_Bhow.postDelayed(new ApolloViewController.2(this, paramInt, paramBoolean, paramApolloWebAvatarParam), 100L);
    }
    for (;;)
    {
      return b("initAvatar成功");
  ...
  public String a(akzw paramakzw)
  {
    if (this.j)
    {
      ...
      return a(alpo.a(2131700939));
    }
    if (paramakzw == null) {
      return a("actionData is null");
    }
    if (paramakzw.jdField_a_of_type_Int > 1) {}
    for (this.jdField_a_of_type_Akzw = paramakzw; (paramakzw.jdField_c_of_type_Int == 1) && (!TextUtils.isEmpty(paramakzw.jdField_b_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (!paramakzw.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)); this.jdField_a_of_type_Akzw = null) {
      return a(alpo.a(2131700944));
    }
    if ((TextUtils.isEmpty(paramakzw.jdField_b_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)) {
      paramakzw.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId;
    }
    if (TextUtils.isEmpty(paramakzw.jdField_b_of_type_JavaLangString)) {
      return a("未传apolloId");
    }
    if (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramakzw.jdField_b_of_type_JavaLangString)) {
      return a(alpo.a(2131700942));
    }
    Object localObject1 = (ApolloWebAvatarParam)this.jdField_a_of_type_JavaUtilHashMap.get(paramakzw.jdField_b_of_type_JavaLangString);
    if (localObject1 == null) {
      return a(alpo.a(2131700928));
    }
    int m = 0;
    int k = m;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
    {
      k = m;
      if (paramakzw.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)) {
        k = 1;
      }
    }
    if ((k != 0) && (!albu.a(((ApolloWebAvatarParam)localObject1).uin, ((ApolloWebAvatarParam)localObject1).roleId, ((ApolloWebAvatarParam)localObject1).dressIds, null)))
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), alpo.a(2131700929), 0).a();
      return a(alpo.a(2131700940));
    }
    if (!ApolloUtil.a(paramakzw.jdField_b_of_type_Int, paramakzw.jdField_c_of_type_Int))
    {
      if (k != 0) {
        QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), alpo.a(2131700947), 0).a();
      }
      return a(alpo.a(2131700930));
    }
    ...
    {
      if (k != 0) {
        QQToast.a(BaseApplicationImpl.getContext(), alpo.a(2131700945), 0).a();
      }
      return a(alpo.a(2131700935));
    }
    if (k != 0) {
      f();
    }
    this.jdField_i_of_type_Int = paramakzw.m;
    this.jdField_f_of_type_Float = paramakzw.jdField_a_of_type_Float;
    boolean bool;
    label556:
    label616:
    float f1;
    ...
    if (paramakzw.l == 0)
    {
      ...
      this.jdField_h_of_type_Boolean = paramakzw.jdField_a_of_type_Boolean;
      if ((this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (paramakzw.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId))) {
        this.jdField_c_of_type_Int = paramakzw.jdField_b_of_type_Int;
      }
      this.jdField_b_of_type_Boolean = true;
      this.jdField_a_of_type_AndroidWidgetFrameLayout.setVisibility(8);
      this.jdField_a_of_type_Bhow.removeMessages(16);
      this.jdField_f_of_type_Int = paramakzw.jdField_i_of_type_Int;
      this.jdField_d_of_type_JavaLangString = paramakzw.jdField_a_of_type_JavaLangString;
      this.jdField_g_of_type_Int = paramakzw.k;
      if (paramakzw.j != 1) {
        break label1141;
      }
      bool = true;
      this.jdField_f_of_type_Boolean = bool;
      if ((!paramakzw.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Akzx != null)) {
        this.jdField_a_of_type_Akzx.a();
      }
      if ((!TextUtils.isEmpty(paramakzw.jdField_a_of_type_JavaLangString)) && (!paramakzw.jdField_a_of_type_Boolean)) {
        break label1147;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView.setVisibility(8);
      }
      if (paramakzw.jdField_d_of_type_Int != 0) {
        break label1518;
      }
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.setVisibility(0);
      ...
      if (this.jdField_a_of_type_Int != paramakzw.jdField_c_of_type_Int)
      {
        ...
        if (paramakzw.jdField_c_of_type_Int != 1) {
          break label1218;
        }
        if (ApolloUtil.d(this.jdField_f_of_type_Int))
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, akzg.a(this.jdField_f_of_type_Int), null);
      ...
      if (!paramakzw.jdField_a_of_type_Boolean) {
        break label1277;
      }
      this.jdField_a_of_type_Akzx.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView, paramakzw.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, paramakzw.jdField_c_of_type_Int);
      this.jdField_a_of_type_Akzx.a(paramakzw.jdField_b_of_type_Float);
      this.jdField_a_of_type_Int = paramakzw.jdField_c_of_type_Int;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      if (TextUtils.isEmpty(paramakzw.jdField_a_of_type_JavaLangString)) {
        break label1496;
      }
      if (paramakzw.k != 1) {
        break label1453;
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView != null)
      {
        ...
        n = (int)((float)bdcb.j() * ((ApolloWebAvatarParam)localObject1).rate * 1.14F);
        ...
        label1086:
        if (!paramakzw.jdField_a_of_type_Boolean) {
          aknm.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getWidth(), n, this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView, BaseApplicationImpl.getContext(), "", paramakzw.jdField_a_of_type_JavaLangString, true);
        }
      }
    }
    for (;;)
    {
      ...
      localObject2 = albu.a(13, paramakzw.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, true);
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, ((ApolloWebAvatarParam)localObject1).apolloId, paramakzw.jdField_b_of_type_Int, 0, localObject2[0], localObject2[1]);
      if (paramakzw.jdField_c_of_type_Int != 1) {
        break label890;
      }
      localObject2 = albu.a(13, paramakzw.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, false);
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, paramakzw.jdField_b_of_type_Int, 0, localObject2[0], localObject2[1]);
      break label890;
      label1384:
      ...
      break label1086;
      label1453:
      albv.a().jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(8);
    ...
    if ((!this.jdField_c_of_type_Boolean) || (this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView == null))
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.init(new akzu(this, (DisplayMetrics)localObject1, paramakzw));
      if (this.jdField_b_of_type_Akmm == null) {
        this.jdField_b_of_type_Akmm = new akzv(this);
      }
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRender().setRenderCallback(this.jdField_b_of_type_Akmm);
      label1745:
      this.jdField_a_of_type_Int = 1;
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.stopLoopDelayed(50L);
      this.jdField_a_of_type_Bhow.removeMessages(15);
      localObject2 = this.jdField_b_of_type_AndroidWidgetTextView;
      if (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
        break label1995;
      }
      localObject1 = alpo.a(2131700948);
      label1800:
      ...
      label1836:
      if ((paramakzw.jdField_h_of_type_Int != 1) && (paramakzw.jdField_e_of_type_Int > 0)) {
        break label2016;
      }
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setTag(Integer.valueOf(paramakzw.jdField_b_of_type_Int));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(Integer.valueOf(paramakzw.jdField_b_of_type_Int));
      break;
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      localObject1 = this.jdField_a_of_type_Bhow.obtainMessage(19, paramakzw.jdField_c_of_type_Int, paramakzw.jdField_b_of_type_Int);
      if (paramakzw.jdField_a_of_type_Boolean) {
        ((Message)localObject1).obj = Float.valueOf(paramakzw.jdField_b_of_type_Float);
      }
      this.jdField_a_of_type_Bhow.sendMessageDelayed((Message)localObject1, 100L);
      break label1745;
      label1995:
      ...
      ApolloUtil.a(this.jdField_b_of_type_AndroidWidgetImageView, paramakzw.jdField_e_of_type_Int);
      if (!bool) {
  ...
  public String a(ArrayList<ApolloWebAvatarParam> paramArrayList)
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if (!albu.a(localApolloWebAvatarParam.uin, localApolloWebAvatarParam.roleId, localApolloWebAvatarParam.dressIds, null))
      {
        QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), alpo.a(2131700931), 0).a();
        return a("dresses is not download!");
      }
    }
  ...
  public String a(int[] paramArrayOfInt)
  {
    if (this.j)
    {
      ...
      return a(alpo.a(2131700941));
    }
    if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam == null) {
      return a(alpo.a(2131700932));
    }
    if (!albu.a(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.uin, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, paramArrayOfInt, null))
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), alpo.a(2131700949), 0).a();
      return a(alpo.a(2131700938));
    }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getColor(2131166817));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(4);
      Object localObject1 = new RelativeLayout.LayoutParams(-2, (int)((float)bdcb.j() * 0.6F));
      ((RelativeLayout.LayoutParams)localObject1).addRule(13, -1);
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = ApolloUtil.a(25.0F, this.jdField_d_of_type_Float);
      ((RelativeLayout.LayoutParams)localObject1).rightMargin = ApolloUtil.a(25.0F, this.jdField_d_of_type_Float);
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)((View)localObject2).findViewById(2131363847));
      ...
      ((ImageView)localObject1).setBackgroundResource(2130838342);
  ...
  {
    this.jdField_a_of_type_Bhow.removeMessages(23);
    this.jdField_b_of_type_Int = paramInt;
    if (this.jdField_g_of_type_Boolean)
    {
      this.jdField_a_of_type_Bhow.removeMessages(16);
      this.jdField_a_of_type_Bhow.sendEmptyMessageDelayed(16, 3000L);
    }
    label218:
    label250:
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
      {
        if ("mall".equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.tab)) {
          ...
          {
            this.jdField_a_of_type_JavaLangString = alpo.a(2131700951);
            if (this.jdField_h_of_type_Int == 1) {
              this.jdField_a_of_type_JavaLangString = akzg.a(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId);
            }
            ...
            this.jdField_a_of_type_Bhow.sendEmptyMessage(17);
          }
        }
        for (;;)
        {
          ...
          {
            this.jdField_a_of_type_JavaLangString = alpo.a(2131700936);
            break;
          }
  ...
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramakmo);
  }
  
  public void a(Activity paramActivity, AppInterface paramAppInterface, String paramString1, String paramString2)
  {
    c(false);
    this.jdField_a_of_type_Bhow.postDelayed(new ApolloViewController.3(this, paramActivity, paramAppInterface, paramString1, paramString2), 500L);
  }
  ...
  public void c(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = 1;
      this.jdField_a_of_type_Bhow.obtainMessage(18).sendToTarget();
      return;
      label79:
  ...
  public boolean handleMessage(Message arg1)
  {
    ...
    case 27: 
      do
      {
        do
        {
          do
          {
            for (;;)
            {
              ...
              if ((this.jdField_a_of_type_AndroidMediaAudioManager != null) && (this.jdField_a_of_type_AndroidMediaAudioManager.getRingerMode() == 1))
              {
                ...
                n = 1;
                if ((!new File(akzg.b(this.jdField_i_of_type_Int)).exists()) || (m != 0) || (k != 0) || (n == 0)) {}
              }
              try
              {
                bdaz.a(BaseApplicationImpl.getContext(), true);
                this.jdField_a_of_type_AndroidMediaMediaPlayer.reset();
                this.jdField_a_of_type_AndroidMediaMediaPlayer.setDataSource(akzg.b(this.jdField_i_of_type_Int));
                this.jdField_a_of_type_AndroidMediaMediaPlayer.prepare();
                this.jdField_a_of_type_AndroidMediaMediaPlayer.start();
                if (!TextUtils.isEmpty(albv.a().jdField_a_of_type_JavaLangString))
                {
                  ??? = albv.a().jdField_a_of_type_JavaLangString;
                  if (???.startsWith("def"))
                  {
                    ??? = alef.jdField_c_of_type_JavaLangString + "/" + ???;
                    albv.a().jdField_a_of_type_JavaLangString = "";
                    ??? = ApolloUtil.a(???, "amr");
                    if (??? == null) {}
                  }
              ...
              catch (Throwable ???)
              {
                try
                {
                  ...
                  ??? = alef.jdField_a_of_type_JavaLangString + "/" + ???;
                }
                catch (IOException ???)
                {
                  for (;;)
          ...
          ??? = albu.a(4, -1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
          ...
          this.jdField_a_of_type_Bhow.sendEmptyMessage(18);
          return true;
        ...
        if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_Int != 0))
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId, akzg.a, null);
          }
        }
        for (;;)
        {
          synchronized (this.jdField_a_of_type_JavaUtilHashMap)
          {
            ...
            if ((???.arg1 > 0) && (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString)) && (this.jdField_f_of_type_Boolean) && (this.jdField_g_of_type_Int == 0))
            {
              ...
              this.jdField_b_of_type_Boolean = false;
              if (this.jdField_a_of_type_Alab != null) {
                this.jdField_a_of_type_Alab.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView);
              }
              a(false);
              ...
              this.jdField_a_of_type_Bhow.sendEmptyMessageDelayed(21, 100L);
              return false;
              if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
              {
              ...
              for (;;)
              {
                synchronized (this.jdField_a_of_type_JavaUtilHashMap)
                {
                  for (;;)
                  {
                    ...
                    {
                      ???.a(1, localApolloWebAvatarParam.apolloId, akzg.a, null);
                      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
                      {
      ...
      if (!TextUtils.isEmpty((CharSequence)???))
      {
        if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)) {
          synchronized (this.jdField_a_of_type_JavaUtilHashMap)
          {
            if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(???))
            {
              ...
              if (localApolloWebAvatarParam != null)
              {
                ...
                if (??? != null)
                {
                  ...
                  ((akkw)???).a(1, localApolloWebAvatarParam.apolloId, localApolloWebAvatarParam.roleId, ApolloUtil.a(localApolloWebAvatarParam.rate), localApolloWebAvatarParam.x, this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight() / this.jdField_d_of_type_Float - localApolloWebAvatarParam.y);
                  if (localApolloWebAvatarParam.roleId != 0) {
                    break label1995;
                  }
                  ((akkw)???).a(1, localApolloWebAvatarParam.apolloId, akzg.a, null);
                }
              }
            }
            ...
            ((akkw)???).a(1, localApolloWebAvatarParam.apolloId, localApolloWebAvatarParam.dressIds, null);
          }
        }
    ...
    case 19: 
      ...
      {
        f2 = 77.0F;
        f4 = (float)(Math.max(bdcb.h(), bdcb.g()) / 7L) / 368.0F;
        ??? = ???.obj;
    ...
    for (int k = 1;; k = 0)
    {
      ...
      {
        f1 = 330.0F * f4 / bdcb.jdField_a_of_type_Float / 2.0F;
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, akzg.a(this.jdField_f_of_type_Int), null);
        ??? = albu.a(13, n, this.jdField_f_of_type_Int, false);
        if (k != 0)
        {
          this.jdField_a_of_type_Akzx.a(this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView, n, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, m);
          this.jdField_a_of_type_Akzx.a(f3);
        }
      }
      for (;;)
      {
        ...
        ??? = albu.a(13, n, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
          ...
          if (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString))
          {
            if (this.jdField_g_of_type_Int == 1)
            {
              ...
              if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != ???)
              {
                ...
                ???.bottomMargin = (aekt.a(f2, this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources()) + (this.jdField_a_of_type_AndroidWidgetRelativeLayout.getHeight() - this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight()) / 2);
              ...
              aknm.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getWidth(), k, this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView, BaseApplicationImpl.getContext(), "", this.jdField_d_of_type_JavaLangString, true);
              return true;
              f2 = 42.0F;
              break;
            ...
            albv.a().jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId, "Bubble");
        return true;
        if ((this.jdField_a_of_type_Akzw == null) || (this.jdField_a_of_type_Akzw.jdField_a_of_type_Int <= 0)) {
          break;
        }
        ??? = this.jdField_a_of_type_Akzw;
        ???.jdField_a_of_type_Int -= 1;
        a(this.jdField_a_of_type_Akzw);
        return false;
        label2851:
        return true;
        f1 = 0.0F;
  ...
  public void onClick(View paramView)
  {
    ...
    {
      this.jdField_a_of_type_Bhow.sendEmptyMessage(15);
      f();
    }
    ...
    f();
    if ((this.jdField_a_of_type_Alab != null) && ((paramView.getTag() instanceof Integer))) {
      this.jdField_a_of_type_Alab.a(((Integer)paramView.getTag()).intValue());
    }
    this.jdField_a_of_type_Bhow.sendEmptyMessage(15);
  }
  ...
  public void onNotifyLongTouch(String paramString)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((akmo)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onNotifyLongTouch(paramString);
    }
  }
  ...
  public void onNotifyStatusChanged(int paramInt, String paramString)
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((akmo)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onNotifyStatusChanged(paramInt, paramString);
    }
  }
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Bhow.sendEmptyMessage(18);
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((akmo)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onSurfaceReady(paramInt1, paramInt2);
    }
  }
}
