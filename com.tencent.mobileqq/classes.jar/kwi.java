  ...
  extends ajfb
{
  ...
  private kwg jdField_a_of_type_Kwg = kwg.a();
  private kwk jdField_a_of_type_Kwk = kwk.a();
  private boolean jdField_a_of_type_Boolean;
  
  public kwi(AppInterface paramAppInterface)
  {
  ...
  public String a()
  {
    return String.valueOf(this.jdField_a_of_type_Kwk.jdField_a_of_type_Long);
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong, String paramString3)
  {
    ...
    for (Object localObject1 = "0";; localObject1 = paramString3)
    {
      ...
      localObject2 = this.jdField_a_of_type_Kwg;
      localToServiceMsg.putWupBuffer(kwg.a(localInfoHead.toByteArray(), ((AudioTransClientTransInfo.InfoReqBody)localObject1).toByteArray()));
      boolean bool = badq.g(this.mApp.getApplication().getApplicationContext());
      if (bool) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, com.tencent.qphone.base.remote.FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   4: ifeq +641 -> 645
    //   7: aload_0
    //   8: getfield 28	kwi:jdField_a_of_type_Kwg	Lkwg;
    //   11: astore_1
    //   12: aload_2
    //   13: invokevirtual 266	com/tencent/qphone/base/remote/FromServiceMsg:getWupBuffer	()[B
    //   16: invokestatic 269	kwg:a	([B)Lkwh;
    //   19: astore_2
    //   20: aload_2
    //   21: getfield 274	kwh:a	[B
    //   24: astore_1
    //   25: aload_2
    //   26: getfield 276	kwh:b	[B
    //   29: astore_2
    ...
    //   101: astore_2
    //   102: aload_0
    //   103: getfield 35	kwi:jdField_a_of_type_Kwk	Lkwk;
    //   106: aload_2
    ...
    //   113: putfield 308	kwk:jdField_a_of_type_Int	I
    //   116: aload_0
    //   117: getfield 35	kwi:jdField_a_of_type_Kwk	Lkwk;
    //   120: aload_2
    ...
    //   127: putfield 313	kwk:b	I
    //   130: aload_0
    //   131: getfield 35	kwi:jdField_a_of_type_Kwk	Lkwk;
    //   134: aload_1
    ...
    //   147: putfield 40	kwk:jdField_a_of_type_Long	J
    //   150: aload_2
    ...
    //   157: astore_1
    //   158: aload_0
    //   159: getfield 35	kwi:jdField_a_of_type_Kwk	Lkwk;
    //   162: new 332	java/util/ArrayList
    //   165: dup
    //   166: invokespecial 333	java/util/ArrayList:<init>	()V
    //   169: putfield 336	kwk:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   172: aload_0
    //   173: invokevirtual 338	kwi:b	()Z
    //   176: istore 5
    //   178: ldc 212
    //   180: iconst_1
    ...
    //   205: aload_0
    //   206: getfield 35	kwi:jdField_a_of_type_Kwk	Lkwk;
    ...
    //   229: aload_0
    //   230: getfield 48	kwi:jdField_a_of_type_Boolean	Z
    ...
    //   325: aload_0
    //   326: getfield 35	kwi:jdField_a_of_type_Kwk	Lkwk;
    //   329: getfield 336	kwk:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   332: aload_3
    ...
    //   352: astore_3
    //   353: aload_0
    //   354: getfield 28	kwi:jdField_a_of_type_Kwg	Lkwg;
    //   357: astore 6
    //   359: aload_3
    //   360: aload_2
    ...
    //   367: invokestatic 405	kwg:a	(I)Ljava/lang/String;
    ...
    //   411: astore_3
    //   412: aload_0
    //   413: getfield 28	kwi:jdField_a_of_type_Kwg	Lkwg;
    //   416: astore 6
    //   418: ldc 212
    //   420: iconst_2
    //   421: aload_3
    ...
    //   429: invokestatic 405	kwg:a	(I)Ljava/lang/String;
    ...
    //   490: goto -340 -> 150
    //   493: aload_0
    //   494: getfield 82	kwi:mApp	Lcom/tencent/common/app/AppInterface;
    //   497: iconst_0
    //   498: invokevirtual 430	com/tencent/common/app/AppInterface:getBusinessHandler	(I)Ljava/lang/Object;
    //   501: checkcast 432	kwl
    //   504: iload 4
    //   506: i2l
    //   507: iconst_1
    //   508: aload_0
    //   509: getfield 35	kwi:jdField_a_of_type_Kwk	Lkwk;
    //   512: getfield 336	kwk:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   515: aload_0
    //   516: getfield 35	kwi:jdField_a_of_type_Kwk	Lkwk;
    //   519: getfield 40	kwk:jdField_a_of_type_Long	J
    //   522: invokevirtual 435	kwl:a	(JZLjava/util/List;J)V
    //   525: aload_0
    //   526: iconst_1
    //   527: putfield 48	kwi:jdField_a_of_type_Boolean	Z
    //   530: iload 5
    //   532: ifeq -54 -> 478
    //   535: aload_0
    //   536: iload 4
    //   538: i2l
    //   539: aload_0
    //   540: getfield 35	kwi:jdField_a_of_type_Kwk	Lkwk;
    //   543: getfield 40	kwk:jdField_a_of_type_Long	J
    //   546: invokevirtual 437	kwi:a	(JJ)V
    //   549: return
    //   550: aload_2
