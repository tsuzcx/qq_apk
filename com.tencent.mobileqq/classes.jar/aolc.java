...
public class aolc
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new aolh(this);
  ...
  private boolean a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131560747, null));
      ...
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131560764, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367377));
  ...
  private void b(ArrayList<String> paramArrayList)
  {
    ...
    if (localQQAppInterface != null)
    {
      ...
      baxt.a(localQQAppInterface, 1, paramArrayList, 4, (Drawable)localObject, (Drawable)localObject);
    }
  ...
  void b()
  {
    ...
    for (int i = actn.a(2.0F, ((Context)localObject2).getResources());; i = actn.a(1.0F, ((Context)localObject2).getResources()))
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setPadding(i, i, i, i);
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130844309);
      ...
      try
      {
        ...
        ((ScaleAnimation)localObject1).setAnimationListener(new aold(this));
  ...
  void c()
  {
    ...
    for (;;)
    {
      ...
      localObject3 = new aolf(this, (AnimatorSet)localObject1);
