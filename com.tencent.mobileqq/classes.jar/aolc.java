  ...
  extends MSFServlet
{
  private void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    aold localaold = (aold)getAppRuntime().getManager(85);
    ...
    for (;;)
    {
      ...
      localaold.a(paramFromServiceMsg, 2);
      label648:
      localBundle.putInt("key_rt_type", i);
      notifyObserver(paramIntent, 113, true, localBundle, aole.class);
      return;
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), aolc.class);
            ...
            if (localObject != null)
            {
              ...
              if ((i == 0) && (((oidb_sso.OIDBSSOPkg)localObject).bytes_bodybuffer.has()) && (((oidb_sso.OIDBSSOPkg)localObject).bytes_bodybuffer.get() != null))
              {
                ...
                try
                {
                  ...
                  paramIntent = (aold)getAppRuntime().getManager(85);
  ...
  public void a(Intent paramIntent, Packet paramPacket)
  {
    ...
    if (bool2)
    {
      ...
      localReqHelloType.string_qua.set(bmsw.a());
    ...
    for (int i = j;; i = 0)
    {
      ...
      ((cmd0x7c9.ReqBody)localObject).string_qua.set(bmsw.a());
      paramIntent = new oidb_sso.OIDBSSOPkg();
