  ...
  implements bgtp
{
  ...
  private bkub jdField_a_of_type_Bkub = new bkub(this);
  private JsBridgeListener jdField_a_of_type_ComTencentMobileqqWebviewSwiftJsBridgeListener;
  private ReaderJsCallback jdField_a_of_type_CooperationQqreaderProxyReaderJsCallback = new bktz(this);
  ...
  private void a(JsBridgeListener paramJsBridgeListener, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramJsBridgeListener))
    {
      ...
      paramString.put("graylevel", bktp.a());
      paramString.put("is_update_newstyle", bktp.a());
  ...
  private void b(String paramString)
  {
    ...
    localIntent.putExtras(bksr.a(localIntent, 2));
  ...
  private void b(String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    if (bksw.a().a())
    {
      bkvd.e("ReaderJsPlugin", "pluginHandleJS ->  handleJsCall");
      a(paramString1, paramString2, paramString3, paramVarArgs);
      return;
    }
    bkvd.e("ReaderJsPlugin", "js plugin is not ready...");
    ...
    this.jdField_a_of_type_Bkub.a(paramString1, paramString2, paramString3, paramVarArgs);
  }
  ...
  public bkty a(Handler paramHandler)
  {
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    this.b = paramString2;
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new bkua(this));
  }
  ...
  void a(String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      bkvd.d("ReaderJsPlugin", "create a new js plugin");
      this.jdField_a_of_type_CooperationQqreaderProxyReaderJsPluginProxy = bksw.a().a(this.jdField_a_of_type_CooperationQqreaderProxyReaderJsCallback);
    }
    if (this.jdField_a_of_type_CooperationQqreaderProxyReaderJsPluginProxy != null)
    {
      ...
      bkvd.d("ReaderJsPlugin", "create a new js ,method=" + paramString3);
    }
    do
    {
      return;
      bkvd.a("ReaderJsPlugin", "handleJsCall mJsPlugin is null!");
  ...
  {
    bkvd.e("ReaderJsPlugin", "handleJsRequest, url=" + paramString1 + " ,pakName=" + paramString2 + " ,method=" + paramString3);
    ...
    else if ("JSContent".equals(paramString2))
    {
      if ("registerWebSearch".equals(paramString3))
      {
        ...
        catch (JSONException paramJsBridgeListener)
        {
          for (;;)
          {
            bkvd.a("ReaderJsPlugin", "Failed to parse json str,json=" + paramVarArgs[0]);
          }
        }
      }
      ...
      if ("JSbookshelf".equals(paramString2))
      {
        if ("getGrayUpdateData".equals(paramString3))
        {
          ...
          catch (Exception paramJsBridgeListener)
          {
            for (;;)
            {
              bkvd.e("ReaderJsPlugin", paramJsBridgeListener.getMessage());
            }
          }
        }
