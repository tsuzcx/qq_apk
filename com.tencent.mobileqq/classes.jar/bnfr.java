...
public class bnfr
{
        ...
        if (paramInt4 == 10004)
        {
          ...
          if ((TextUtils.isEmpty(paramLocalMediaInfo.path)) || (paramLocalMediaInfo.path.equalsIgnoreCase("null")))
          {
            ...
            if (paramInt7 == 11)
            {
              bool2 = false;
              bool1 = false;
              localObject = bben.a(paramActivity.getIntent().getExtras());
              if (localObject == null) {
                break label1531;
              }
            ...
            break label1734;
            label639:
            if (blat.a(paramActivity.getIntent(), paramInt7)) {
              break label1757;
            }
            if (!blat.c(paramActivity.getIntent())) {
              break label1764;
            }
            break label1757;
            label664:
            ...
            paramString1.f = paramActivity.getIntent().getIntExtra("VIDEO_STORY_FROM_TYPE", blat.a.a());
            if (paramActivity.getIntent().getBooleanExtra("is_video_forward", false)) {
              paramString1.e = 4;
            }
            if (l4 != 0L) {
            ...
            if ((paramInt1 / paramInt2 >= azkz.jdField_a_of_type_Int / azkz.jdField_b_of_type_Int) && (!paramActivity.getIntent().getBooleanExtra("is_video_forward", false)))
            {
              paramString1.a.putBoolean("extra_is_fit_center", true);
              if (xsv.a(paramInt1, paramInt2, azkz.jdField_a_of_type_Int, azkz.jdField_b_of_type_Int)) {
            ...
            paramLocalMediaInfo.putExtra("VIDEO_STORY_FROM_TYPE", blat.a(paramActivity.getIntent()));
            if (paramInt7 == 14)
            {
              paramLocalMediaInfo.putExtra("VIDEO_STORY_JUMP_TO_TYPE", blat.b(paramActivity.getIntent()));
              paramLocalMediaInfo.putExtra("VIDEO_STORY_MEDIA_TYPE", blat.c(paramActivity.getIntent()));
            }
            if (paramBundle != null) {
  ...
  public static boolean a()
  {
    ...
    if (localuvt == null)
    {
      wxe.e("Q.qqstory.publish.QQStoryFlowCallback", "StoryConfigManager(CONFIG_MANAGER) is null!");
      return false;
    }
    int i = localuvt.b();
    if (i == h) {
    ...
    jdField_a_of_type_Int = ((Integer)localuvt.b("localUploadVideoSizeLimit", Integer.valueOf(jdField_a_of_type_Int))).intValue();
    jdField_b_of_type_Int = ((Integer)localuvt.b("localUploadVideoMinResolutionLimit", Integer.valueOf(jdField_b_of_type_Int))).intValue();
    c = ((Integer)localuvt.b("localUploadVideoDurationLimit", Integer.valueOf(c))).intValue();
    e = ((Integer)localuvt.b("localUploadVideoRatioLimit", Integer.valueOf(e))).intValue();
    f = ((Integer)localuvt.b("localUploadImageSizeLimit", Integer.valueOf(f))).intValue();
    g = ((Integer)localuvt.b("localUploadImageMinResolutionLimit", Integer.valueOf(g))).intValue();
    jdField_a_of_type_Float = e / 10000 / 1000.0F;
    jdField_b_of_type_Float = e % 10000 / 1000.0F;
    wxe.d("Q.qqstory.publish.QQStoryFlowCallback", "Update Limit Config %d|%d|%d|%d|%d|%d", new Object[] { Integer.valueOf(jdField_a_of_type_Int), Integer.valueOf(jdField_b_of_type_Int), Integer.valueOf(c), Integer.valueOf(e), Integer.valueOf(f), Integer.valueOf(g) });
    wxe.d("Q.qqstory.publish.QQStoryFlowCallback", "Update Limit Config from %d to %d", new Object[] { Integer.valueOf(h), Integer.valueOf(i) });
    h = localuvt.b();
    return true;
  }
  ...
  public static boolean a(Activity paramActivity, Intent paramIntent, int paramInt)
  {
    ...
    if (localLocalMediaInfo == null) {
      throw new IllegalArgumentException(alud.a(2131711275));
    }
  ...
  public static boolean a(@NonNull Activity paramActivity, @NonNull LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (paramLocalMediaInfo.mMimeType.contains("video")) {
      if (paramLocalMediaInfo.mDuration > c)
      {
        ...
        wxe.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
        j = 4;
        k = 5;
        i = 1;
      }
    ...
    for (;;)
    {
      wxj.b("upload_local_video", "choose_media_info", 0, j, new String[] { a(paramLocalMediaInfo) });
      if (i != 0)
      {
        String str1 = String.valueOf(1);
        label200:
        wxj.a("video_shoot", "chose_video", 0, 0, new String[] { str1, String.valueOf(k), String.valueOf(f1) });
        if ((i != 0) && (paramLocalMediaInfo.mDuration >= 20500L)) {
          wxj.a("video_shoot", "local_over", 0, 0, new String[0]);
        }
        if (paramLocalMediaInfo.addedDate == 0L)
        {
          ...
          i = 0;
          label307:
          wxj.b("upload_local_video", "media_info_missing", 0, i, new String[] { a(paramLocalMediaInfo) });
        }
        if (localObject != null) {
      ...
      for (;;)
      {
        ...
        {
          localObject = QQToast.a(paramActivity, 1, alud.a(2131711265), 0);
          wxe.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 1;
          j = 1;
          i = 1;
        ...
        {
          localObject = QQToast.a(paramActivity, 1, alud.a(2131711253), 0);
          wxe.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 3;
          j = 2;
          i = 1;
        ...
        if ((f1 < 0.4F) || (f1 > 2.2F))
        {
          localObject = QQToast.a(paramActivity, 1, alud.a(2131711258), 0);
          wxe.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          j = 3;
          i = 1;
          break;
        ...
        localObject = QQToast.a(paramActivity, 1, alud.a(2131711244), 0);
        wxe.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
        j = 6;
        k = 8;
        i = 1;
        ...
        {
          localObject = QQToast.a(paramActivity, 1, alud.a(2131711260), 0);
          wxe.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 1;
          j = 1;
          i = 0;
        ...
        {
          localObject = QQToast.a(paramActivity, 1, alud.a(2131711259), 0);
          wxe.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 3;
          j = 2;
          i = 0;
        ...
        localObject = QQToast.a(paramActivity, 1, alud.a(2131711257), 0);
        wxe.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
        j = 3;
        i = 0;
        break;
