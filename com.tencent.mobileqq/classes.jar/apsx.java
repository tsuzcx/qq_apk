...
public class apsx
{
  ...
  private Map<Integer, apsz> jdField_a_of_type_JavaUtilMap;
  private AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger;
  
  public apsx(Activity paramActivity)
  {
  ...
  public int a(String paramString1, String paramString2)
  {
    ...
    localapsz.jdField_a_of_type_JavaLangString = paramString1;
    localapsz.b = paramString2;
    localapsz.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
    if (this.jdField_a_of_type_JavaUtilMap != null) {
      this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(this.jdField_a_of_type_Int), localapsz);
    }
    if (QLog.isColorLevel()) {
  ...
  public boolean a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilMap != null)
    {
      if ((apsz)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt)) != null) {}
  ...
  void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidAppProgressDialog.setOnDismissListener(new apsy(this));
