...
public class aqpe
{
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    String str = "switcher_in_assistant_" + paramQQAppInterface.c();
    localEditor.putBoolean("has_set_switcher_in_assistant_" + paramQQAppInterface.c(), true);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    ExtensionInfo localExtensionInfo = localanyw.a(paramString, true);
  ...
  {
    aqow localaqow = aqox.a();
    if (QLog.isColorLevel()) {
      QLog.d("C2CShortcutBarSwitcher", 2, new Object[] { "isKuoLieEnable() isKuoLieEnable = ", Boolean.valueOf(localaqow.b()) });
    }
    return localaqow.b();
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    String str = "switcher_in_assistant_" + paramQQAppInterface.c();
    if (localSharedPreferences.getBoolean("has_set_switcher_in_assistant_" + paramQQAppInterface.c(), false)) {}
    for (boolean bool = localSharedPreferences.getBoolean(str, true);; bool = aqox.a().a())
    {
      if (QLog.isColorLevel()) {
  ...
  {
    paramQQAppInterface = ((anyw)paramQQAppInterface.getManager(51)).a(paramString, true);
  ...
  public static boolean b()
  {
    aqow localaqow = aqox.a();
    if (QLog.isColorLevel()) {
      QLog.d("C2CShortcutBarSwitcher", 2, new Object[] { "isShowGlobalEntrance() isShowAssistantEntrance = ", Boolean.valueOf(localaqow.a()) });
    }
    return localaqow.a();
  }
