...
public class phd
  extends pez
{
  public phd(Context paramContext, azwg paramazwg, qoe paramqoe)
  {
  ...
  public pez a()
  {
    ...
    return c(this.jdField_a_of_type_Qoe, this.jdField_a_of_type_Azwg).q().l().n().h().j();
  }
  ...
  public pez d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null)
    {
      ...
      localRelativeLayout2.setLayoutParams(new LinearLayout.LayoutParams(-1, aciy.a(86.0F, this.jdField_a_of_type_AndroidContentContext.getResources())));
      ...
      localRelativeLayout2.setOnClickListener(new phe(this));
