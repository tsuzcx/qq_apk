...
public class bepc
{
  ...
  public bepc(String paramString, int paramInt, long paramLong)
  {
  ...
  public static bepc a(JSONObject paramJSONObject)
  {
    ...
    for (int i = -1;; i = bfgh.a(paramJSONObject)) {
      return new bepc(str, i, l);
    }
  }
