...
public class bhfy
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (k - 10 < c())
    {
      ...
      {
        paramString = (bgls)paramQQAppInterface.getManager(QQManagerFactory.TROOP_ROBOT_MANAGER);
        localObject2 = (bjxa)paramQQAppInterface.getManager(QQManagerFactory.QIDIAN_MANAGER);
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if ((paramString.b(((TroopMemberInfo)localObject1).memberuin)) || (((bjxa)localObject2).f(((TroopMemberInfo)localObject1).memberuin))) {
  ...
  public static int a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    return ((antp)paramQQAppInterface.getManager(QQManagerFactory.DISCUSSION_MANAGER)).a(paramString);
  }
  ...
  public static Bundle a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject = (bgkf)paramQQAppInterface.getManager(QQManagerFactory.TROOP_GAG_MANAGER);
    boolean bool3 = ((bgkf)localObject).a(paramString, paramQQAppInterface.getCurrentAccountUin());
    boolean bool4 = ((bgkf)localObject).a(paramString);
    boolean bool5 = ((bgkf)localObject).b(paramString);
    paramQQAppInterface = ((bgkf)localObject).a(paramString);
    int j = 0;
    boolean bool2 = false;
    int i;
    boolean bool1;
  ...
  public static bhgb a()
  {
    if (a == null) {}
    try
    {
      if (a == null) {
        a = bhgb.a(lbt.b(276).a);
      }
      return a;
    }
    finally {}
  ...
  {
    paramString = bhgb.a(paramString);
    try
    {
      a = paramString;
      return;
  ...
  public static void a(String paramString1, QQAppInterface paramQQAppInterface, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramQQAppInterface.addObserver(new bhfz(l, paramString1, paramQQAppInterface, str));
        localaoep.b(l, 480, 0);
        ...
        {
          paramQQAppInterface.addObserver(new bhga(str, paramQQAppInterface, paramString1));
          localaoep.j(str);
        }
  ...
  {
    paramQQAppInterface = (bgkf)paramQQAppInterface.getManager(QQManagerFactory.TROOP_GAG_MANAGER);
    ...
    {
      AudioHelper.a(anvx.a(2131708376));
      return true;
    }
    return bool1;
  }
  ...
  public static boolean a(String paramString1, QQAppInterface paramQQAppInterface, String paramString2)
  {
    ...
    if (localTroopInfo != null)
    {
      ...
      bool1 = true;
      str = anvx.a(2131708373);
      label92:
      if ((!bool1) || (!localTroopInfo.isAdmin())) {
        break label737;
      }
      str = str + anvx.a(2131708378);
    }
    label159:
    label211:
    label599:
    ...
    for (boolean bool5 = false;; bool5 = bool1)
    {
      ...
      for (;;)
      {
        ...
        {
          bool1 = false;
          paramQQAppInterface = ((bgkf)paramQQAppInterface.getManager(QQManagerFactory.TROOP_GAG_MANAGER)).a(paramString2);
