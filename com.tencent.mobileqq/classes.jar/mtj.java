...
public class mtj
{
  private static BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mtk();
  static String jdField_a_of_type_JavaLangString = "actAVGSensorCaseReport";
  int jdField_a_of_type_Int = 0;
  private long jdField_a_of_type_Long;
  ArrayList<mtl> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  mtl jdField_a_of_type_Mtl = null;
  ...
  private void a(int paramInt, ArrayList<mtl> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          mtl localmtl = (mtl)paramArrayList.next();
          JSONObject localJSONObject = new JSONObject();
          localJSONObject.put("i", localmtl.jdField_a_of_type_Int);
          localJSONObject.put("off", localmtl.jdField_a_of_type_Long);
          localJSONObject.put("on", localmtl.jdField_b_of_type_Long);
          localJSONObject.put("why", localmtl.jdField_c_of_type_Long);
      ...
      catch (JSONException paramArrayList)
      {
        ...
        for (localObject1 = "JSONException. ";; localObject1 = ((JSONObject)localObject1).toString())
        {
          ...
          this.jdField_a_of_type_Mtl = null;
          if (paramInt == 1) {
            break;
          }
  ...
  void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt, boolean paramBoolean4, VideoController paramVideoController)
  {
    ...
    long l = System.currentTimeMillis();
    paramVideoController = this.jdField_a_of_type_Mtl;
    this.jdField_a_of_type_Mtl = null;
    if (paramVideoController != null)
    {
  ...
  void c()
  {
    this.jdField_a_of_type_Mtl = new mtl(this);
    this.jdField_a_of_type_Mtl.jdField_a_of_type_Int = this.h;
    this.h += 1;
    this.jdField_a_of_type_Mtl.jdField_a_of_type_Long = System.currentTimeMillis();
    this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Mtl);
  }
