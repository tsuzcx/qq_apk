  ...
  implements pbm
{
  ...
  private static Map<String, pdv> jdField_a_of_type_JavaUtilMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private bkyb<Pair<String, BaseCommentData>> jdField_a_of_type_Bkyb = new bkyb();
  ...
  private pfk jdField_a_of_type_Pfk = new pfk();
  private pfn jdField_a_of_type_Pfn;
  private pfq jdField_a_of_type_Pfq = new pfq();
  ...
  private List<pfh> jdField_e_of_type_JavaUtilList = new ArrayList();
  ...
  private pdv(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = "";
    paramString = pnn.a();
    if (paramString != null)
    {
      this.jdField_a_of_type_Pfi = ((pvp)paramString.getManager(QQManagerFactory.READINJOY_LOGIC_MANAGER)).a().a();
      this.jdField_a_of_type_Pfi.a(this);
    }
    this.jdField_a_of_type_Pfn = new pfn();
    this.jdField_a_of_type_Pfn.a(this);
    a(this.jdField_a_of_type_Pfq);
  }
  ...
  private List<pdp> a(int paramInt, List<BaseCommentData> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      localArrayList.add(new pdp(paramInt, a(localBaseCommentData), localBaseCommentData, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
    }
    return localArrayList;
  }
  
  private List<pdp> a(boolean paramBoolean, BaseCommentData paramBaseCommentData, List<SubCommentData> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramBoolean)
    {
      localArrayList.add(new pdp(0, paramBaseCommentData, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
      localArrayList.add(new pdp(3, paramBaseCommentData, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
    }
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      if (paramBaseCommentData.hasNext())
      {
        ...
        for (int i = 4;; i = 0)
        {
          localArrayList.add(new pdp(i, paramList, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
          break;
        }
      }
    }
  ...
  public static pdv a(ArticleInfo paramArticleInfo)
  {
    if (paramArticleInfo == null) {
      return null;
    }
    return (pdv)jdField_a_of_type_JavaUtilMap.get(paramArticleInfo.innerUniqueID);
  }
  
  public static pdv a(ArticleInfo paramArticleInfo, int paramInt)
  {
    if (paramArticleInfo == null) {
      localObject = null;
    }
    ...
    {
      return localObject;
      localpdv = (pdv)jdField_a_of_type_JavaUtilMap.get(paramArticleInfo.innerUniqueID);
      localObject = localpdv;
    } while (localpdv != null);
    Object localObject = new pdv(paramArticleInfo.innerUniqueID);
    ((pdv)localObject).b(paramArticleInfo);
    ((pdv)localObject).jdField_a_of_type_Int = paramInt;
    if (paramInt == 1)
    {
      ((pdv)localObject).jdField_a_of_type_JavaLangString = (paramArticleInfo.mArticleID + "");
      ((pdv)localObject).g = (paramArticleInfo.mArticleID + "");
    }
    for (;;)
    {
      jdField_a_of_type_JavaUtilMap.put(paramArticleInfo.innerUniqueID, localObject);
      ((pdv)localObject).h = paramArticleInfo.innerUniqueID;
      ...
      return localObject;
      ((pdv)localObject).jdField_a_of_type_JavaLangString = paramArticleInfo.innerUniqueID;
      ((pdv)localObject).h = paramArticleInfo.innerUniqueID;
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Pfi == null) || (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
    {
      a(new pdz(this, paramInt));
      return;
    }
    ...
    this.jdField_a_of_type_Pfi.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.innerUniqueID, paramString1, paramString2, this.jdField_c_of_type_JavaLangString, 10, this.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataCommonCommentData);
  }
  ...
  public static void a(ArticleInfo paramArticleInfo)
  {
    ...
    {
      return;
      paramArticleInfo = (pdv)jdField_a_of_type_JavaUtilMap.remove(paramArticleInfo.innerUniqueID);
  ...
  public static void a(ArticleInfo paramArticleInfo, int paramInt)
  {
    ...
    if (paramInt == 6)
    {
      paramArticleInfo = (pdv)jdField_a_of_type_JavaUtilMap.get(paramArticleInfo.innerUniqueID);
      if (paramArticleInfo != null) {
        paramArticleInfo.u();
      }
  ...
  private void a(List<pfh> paramList, boolean paramBoolean, pfe parampfe)
  {
    int i = 0;
    if (i < paramList.size())
    {
      pfh localpfh = (pfh)paramList.get(i);
      if (paramBoolean) {
        ThreadManager.getUIHandler().post(new ReadInJoyCommentDataManager.35(this, parampfe, localpfh));
      }
      for (;;)
      {
        i += 1;
  ...
  private void a(pfe parampfe)
  {
    a(parampfe, true);
  }
  
  private void a(pfe parampfe, boolean paramBoolean)
  {
    if ((!this.jdField_e_of_type_JavaUtilList.isEmpty()) && (parampfe != null)) {
      a(this.jdField_e_of_type_JavaUtilList, paramBoolean, parampfe);
    }
    ArrayList localArrayList = new ArrayList();
    if (pac.a().a() != null) {
      localArrayList.addAll(pac.a().a());
    }
    if ((localArrayList != null) && (parampfe != null)) {
      a(localArrayList, paramBoolean, parampfe);
    }
  }
  ...
  {
    if ((paramList == null) || (this.jdField_a_of_type_Pff == null) || (!this.jdField_a_of_type_Pff.jdField_b_of_type_Boolean) || (this.jdField_a_of_type_Pff.jdField_a_of_type_JavaLangString == null)) {
      return false;
    }
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      ...
      if ((localCommentData != null) && (this.jdField_a_of_type_Pff.jdField_a_of_type_JavaLangString.equals(localCommentData.commentId)))
      {
  ...
  private List<pdp> b(int paramInt, List<String> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    ...
    while (paramList.hasNext())
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (this.jdField_b_of_type_JavaUtilMap.get(str) != null)) {
        localArrayList.add(new pdp(paramInt, a((BaseCommentData)this.jdField_b_of_type_JavaUtilMap.get(str)), (BaseCommentData)this.jdField_b_of_type_JavaUtilMap.get(str), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
      }
    }
    return localArrayList;
  }
  ...
  private void j(int paramInt)
  {
    ...
    for (Object localObject1 = "";; localObject1 = this.jdField_d_of_type_JavaLangString)
    {
      ...
      if (paramInt == 1)
      {
        ...
        {
          localObject1 = localObject2;
          if (this.jdField_a_of_type_Pff.jdField_a_of_type_Boolean) {
            localObject1 = this.jdField_a_of_type_Pff.jdField_a_of_type_JavaLangString;
          }
        }
      }
  ...
  private void l(int paramInt)
  {
    ...
    for (String str = "";; str = this.jdField_f_of_type_JavaLangString)
    {
      ...
      this.jdField_a_of_type_Pfi.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.innerUniqueID, this.jdField_f_of_type_JavaLangString, 10, this.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentDataCommonCommentData);
      return;
    }
  }
  ...
  public BaseCommentData a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 1)
    {
      ...
      ((BaseCommentData)localObject1).uin = pkh.a();
      ((BaseCommentData)localObject1).homepage = pqx.a(((BaseCommentData)localObject1).uin);
    ...
    for (;;)
    {
      try
      {
        ...
        ((BaseCommentData)localObject1).commentContent = new String(bhcu.decode(paramString.getString("comment"), 0));
        localObject2 = paramString.optJSONArray("linkList");
        if (localObject2 != null)
        {
          localObject3 = new pew(this).getType();
        ...
        if (paramInt == 2)
        {
          ...
          if (paramString.optBoolean("isSecondReply", false))
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject3))
            {
              ...
              ((SubCommentData)localObject2).repliedUserHomePage = pqx.a((String)localObject3);
  ...
  public List<pdp> a()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList.size() > 0)
    {
      ...
      while (i < this.jdField_a_of_type_JavaUtilList.size())
      {
        ...
        if ((localCommentData != null) && ((!localCommentData.isFamilyTopEntry()) || ((localCommentData.isFamilyTopEntry()) && (!pap.a())))) {
          localArrayList2.add(localCommentData);
        }
        i += 1;
      }
      if ((localArrayList2.size() > 0) && (this.jdField_f_of_type_Boolean)) {
        localArrayList1.add(new pdp(1, null, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
      }
  ...
  public List<pdp> a(int paramInt)
  {
  ...
  public List<pdp> a(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    paramString = (BaseCommentData)this.jdField_b_of_type_JavaUtilMap.get(paramString);
    if (paramString == null) {
    ...
    localArrayList.add(new pdp(0, paramString, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
    localArrayList.add(new pdp(3, paramString, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
    return localArrayList;
  }
  
  public pff a()
  {
    return this.jdField_a_of_type_Pff;
  }
  
  public pfk a()
  {
    return this.jdField_a_of_type_Pfk;
  }
  
  public pfq a()
  {
    return this.jdField_a_of_type_Pfq;
  }
  
  public void a(int paramInt)
  {
    a(new pex(this, paramInt));
  }
  
  public void a(int paramInt, String paramString, pfl parampfl, pfm parampfm)
  {
    boolean bool2 = true;
    boolean bool3 = TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString);
    pfl localpfl = parampfl;
    if (parampfl == null) {
      localpfl = new pfl();
    }
    if (parampfm == null) {
    ...
    if (paramInt == 0)
    {
      this.jdField_b_of_type_Boolean = localpfl.jdField_a_of_type_Boolean;
      this.jdField_c_of_type_JavaLangString = localpfl.jdField_a_of_type_JavaLangString;
      if (localpfl.jdField_b_of_type_JavaUtilList == null) {
        break label343;
      }
      parampfl = localpfl.jdField_b_of_type_JavaUtilList.iterator();
      while (parampfl.hasNext())
      {
        parampfm = (SubCommentData)parampfl.next();
        if (parampfm != null)
        {
          if (TextUtils.isEmpty(parampfm.parentCommentId)) {
            parampfm.parentCommentId = paramString;
          }
          this.jdField_b_of_type_JavaUtilMap.put(parampfm.commentId, parampfm);
          this.jdField_c_of_type_JavaUtilList.add(parampfm.commentId);
        }
      }
      parampfl = a(bool3, (BaseCommentData)this.jdField_b_of_type_JavaUtilMap.get(paramString), localpfl.jdField_b_of_type_JavaUtilList);
      bool1 = true;
    }
    for (;;)
    {
      if (QLog.isColorLevel())
      {
        ...
        paramInt = localpfl.jdField_b_of_type_JavaUtilList.size();
        label212:
        if ((localpfl == null) || (!localpfl.jdField_a_of_type_Boolean)) {
          break label337;
        }
      }
      for (;;)
      {
        ...
        a(new peq(this, bool3, bool1, parampfl));
        return;
        parampfl = null;
        bool1 = false;
        break;
  ...
  public void a(int paramInt, pfl parampfl1, pfl parampfl2, pfm parampfm)
  {
    boolean bool1;
    boolean bool2;
    Object localObject;
    ...
    if (paramInt == 0)
    {
      ...
      if (bool1)
      {
        this.jdField_c_of_type_Boolean = parampfl1.jdField_a_of_type_Boolean;
        this.jdField_d_of_type_Boolean = ((pfl)localObject).jdField_a_of_type_Boolean;
        if (((pfl)localObject).jdField_a_of_type_JavaUtilList == null) {
          break label496;
        }
        l = ((pfl)localObject).jdField_a_of_type_JavaUtilList.size();
        this.jdField_c_of_type_Long = l;
        this.jdField_d_of_type_JavaLangString = parampfl1.jdField_a_of_type_JavaLangString;
        this.jdField_e_of_type_JavaLangString = ((pfl)localObject).jdField_a_of_type_JavaLangString;
        a(this.h, parampfl2.jdField_a_of_type_Boolean);
        this.jdField_a_of_type_Pfk = parampfl2.jdField_a_of_type_Pfk;
        c(((pfl)localObject).jdField_a_of_type_JavaUtilList, parampfl1.jdField_a_of_type_JavaUtilList);
      }
      if (!bool2) {
        break label523;
      }
      if (parampfl2.jdField_a_of_type_Long > 0L) {
        this.jdField_b_of_type_Long = parampfl2.jdField_a_of_type_Long;
      }
      this.jdField_a_of_type_Long = parampfl2.jdField_b_of_type_Long;
      if ((this.jdField_a_of_type_Pff != null) && (this.jdField_a_of_type_Pff.jdField_b_of_type_Boolean))
      {
        if (!a(((pfl)localObject).jdField_a_of_type_JavaUtilList)) {
          a(new pee(this));
        }
        this.jdField_a_of_type_Pff.jdField_b_of_type_Boolean = false;
      }
      paramInt = 3;
      List localList = a(3);
      if (localList != null)
      ...
      label287:
      if (!((pfl)localObject).a()) {
        break label511;
      }
      i = ((pfl)localObject).jdField_a_of_type_JavaUtilList.size();
      label307:
    ...
    label517:
    for (int j = parampfl1.jdField_a_of_type_JavaUtilList.size();; j = 0)
    {
      ...
      a(new pef(this, bool1, parampfm, bool2, paramInt));
      if (this.jdField_a_of_type_Pff != null) {
        this.jdField_a_of_type_Pff.a(false);
      }
      this.jdField_a_of_type_Pfq.a(parampfl2.jdField_a_of_type_Int);
      this.jdField_a_of_type_Pfq.a(parampfl2.jdField_a_of_type_JavaLangString);
      return;
      bool1 = false;
      break;
      label496:
    ...
    label523:
    if (parampfl1 != null) {}
    for (parampfl1 = a(2, new ArrayList(parampfl1.jdField_a_of_type_JavaUtilList));; parampfl1 = new ArrayList())
    {
      bool2 = this.jdField_a_of_type_Boolean;
      QLog.d("ReadInJoyCommentDataManager", 1, new Object[] { "onLoadMoreComment, ret : ", Boolean.valueOf(bool1), ", size : ", Integer.valueOf(parampfl1.size()), ", hasNext : ", Boolean.valueOf(bool2) });
      a(new peh(this, bool1, parampfl1));
      return;
    }
  }
  
  public void a(int paramInt, pfl parampfl, pfm parampfm, CommentData paramCommentData)
  {
    boolean bool2 = TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString);
    paramCommentData = parampfl;
    if (parampfl == null) {
      paramCommentData = new pfl();
    }
    parampfl = parampfm;
    if (parampfm == null) {
      parampfl = new pfm();
    ...
    if (paramInt == 0)
    {
      ...
      if (parampfl.jdField_a_of_type_Long > 0L) {
        this.jdField_b_of_type_Long = parampfl.jdField_a_of_type_Long;
      }
      parampfl = b();
      parampfm = new StringBuilder().append(", new size : ");
    ...
    label228:
    if (paramCommentData.jdField_a_of_type_JavaUtilList != null) {}
    for (parampfl = a(2, new ArrayList(paramCommentData.jdField_a_of_type_JavaUtilList));; parampfl = new ArrayList())
    {
      bool2 = this.jdField_c_of_type_Boolean;
      QLog.d("ReadInJoyCommentDataManager", 2, new Object[] { "onLoadMoreNewComment, ret : ", Boolean.valueOf(bool1), ", size : ", Integer.valueOf(parampfl.size()), ", hasNext : ", Boolean.valueOf(bool2) });
      a(new pej(this, bool1, parampfl, bool2));
      return;
    }
  }
  ...
  public void a(long paramLong, boolean paramBoolean, int paramInt1, String paramString, int paramInt2)
  {
    ...
    Pair localPair = (Pair)this.jdField_a_of_type_Bkyb.a(paramLong);
    if (localPair == null) {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Bkyb.b(paramLong);
      if (paramBoolean)
      {
        pbq.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, (String)localPair.first);
        a(localBaseCommentData, paramString, paramInt2);
        return;
      }
      if ((localBaseCommentData instanceof CommentData))
      {
        a(new peu(this, paramInt2));
        return;
      }
  ...
  public void a(BaseCommentData paramBaseCommentData, String paramString, int paramInt)
  {
    ...
    if ((paramBaseCommentData instanceof CommentData)) {
      if (paramInt == 6)
      {
        ...
        if (this.jdField_d_of_type_JavaUtilList.size() == 0)
        {
          ...
          a(new pey(this, new pdp(i, 0, paramBaseCommentData, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo), bool, paramInt));
        }
      }
    }
    label344:
    ...
    a(paramString, 1);
    a(new pez(this, paramBaseCommentData));
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    this.jdField_a_of_type_Pfn.a(paramString, 1, paramInt, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
  }
    ...
    while (paramBoolean1)
    {
      ...
      else
      {
        ...
        for (paramBoolean1 = bool;; paramBoolean1 = false)
        {
          ...
          paramInt = 2131718091;
          a(new pfc(this, a()));
          QQToast.a(BaseApplicationImpl.context, 2, anvx.a(paramInt), 0).a();
          return;
        }
        this.jdField_a_of_type_JavaUtilList.remove(paramString);
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      pvm.a().a(this);
      pvj.a().a(localCommentReportInfo);
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      ...
      {
        a(new pfb(this, a()));
        QQToast.a(BaseApplicationImpl.context, 2, anvx.a(2131718086), 0).a();
        return;
    ...
    if (paramBoolean2) {}
    for (paramString = anvx.a(2131718085);; paramString = anvx.a(2131718084))
    {
  ...
  public void a(pdp parampdp)
  {
    ...
    do
    {
      ...
      if (this.jdField_b_of_type_JavaUtilMap != null) {
        this.jdField_b_of_type_JavaUtilMap.remove(parampdp);
      }
      parampdp = parampdp.commentId;
      if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.contains(parampdp)))
      {
        this.jdField_a_of_type_JavaUtilList.remove(parampdp);
        a(new pdw(this));
      }
      if ((this.jdField_b_of_type_JavaUtilList != null) && (this.jdField_b_of_type_JavaUtilList.contains(parampdp)))
      {
        this.jdField_b_of_type_JavaUtilList.remove(parampdp);
        a(new peg(this));
      }
    } while ((this.jdField_d_of_type_JavaUtilList == null) || (!this.jdField_d_of_type_JavaUtilList.contains(parampdp)));
    this.jdField_d_of_type_JavaUtilList.remove(parampdp);
    a(new per(this));
  }
  
  public void a(pdp parampdp, int paramInt)
  {
    if ((this.jdField_a_of_type_Pfn == null) || (parampdp == null) || (parampdp.a == null)) {
      return;
    }
    ...
    a(new pea(this, localBaseCommentData.getCommentLevel(), parampdp, paramInt), false);
    this.jdField_a_of_type_Pfn.a(localBaseCommentData, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
  }
  
  public void a(pff parampff)
  {
    if ("setCommentAnchor | commentid : " + parampff != null) {}
    for (String str = parampff.jdField_a_of_type_JavaLangString;; str = "")
    {
      QLog.d("ReadInJoyCommentDataManager", 1, str);
      this.jdField_a_of_type_Pff = parampff;
      return;
    }
  }
  ...
  public void a(pfh parampfh)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 91	pdv:jdField_e_of_type_JavaUtilList	Ljava/util/List;
    //   6: aload_1
    //   7: invokeinterface 322 2 0
    //   12: istore_2
    //   13: iload_2
    //   14: ifeq +6 -> 20
    //   17: aload_0
    ...
    //   19: return
    //   20: aload_0
    //   21: getfield 91	pdv:jdField_e_of_type_JavaUtilList	Ljava/util/List;
    //   24: aload_1
  ...
  {
    if (paramBoolean) {
      QQToast.a(BaseApplicationImpl.getContext(), 2, anvx.a(2131712501), 0).a();
    }
    for (;;)
    {
      ...
      return;
      QQToast.a(BaseApplicationImpl.getContext(), 1, anvx.a(2131699133), 0).a();
    }
  }
  ...
  public void a(boolean paramBoolean, BaseCommentData paramBaseCommentData, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        QQToast.a(BaseApplication.getContext(), 2, anvx.a(2131712412), 0).a();
      ...
      {
        pvm.a().a(true, this.jdField_a_of_type_JavaLangString, paramBaseCommentData.commentId, "onCommentDelete", paramString.getInt("seq"), i);
        return;
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt1, int paramInt2)
  {
    ...
    a(new pet(this, paramBoolean, paramString, paramInt1, paramInt2));
    Object localObject = BaseActivity.sTopActivity;
    if (localObject != null)
    {
      localObject = ((Activity)localObject).getIntent().getBundleExtra("bundle");
      if (localObject != null) {
        pvm.a().a(paramBoolean, this.jdField_a_of_type_JavaLangString, paramString, String.valueOf(paramInt2), "onCommentLike", ((Bundle)localObject).getInt("seq"));
      }
    }
  }
  
  public void a(boolean paramBoolean1, pdp parampdp, int paramInt, String paramString, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      ...
      a(paramString);
      b(paramString);
      a(new pes(this, paramString.getCommentLevel(), parampdp, paramInt), false);
      return;
    }
    ...
    label151:
    for (parampdp = anvx.a(2131718079);; parampdp = anvx.a(2131718078))
    {
      QQToast.a(paramString, paramInt, parampdp, 0).a();
      return;
      paramInt = 1;
      break;
    }
  ...
  public boolean a(pfh parampfh)
  {
    try
    {
      boolean bool = this.jdField_e_of_type_JavaUtilList.remove(parampfh);
      return bool;
    }
    finally
    {
    ...
    if (this.jdField_b_of_type_JavaUtilList.size() > 0)
    {
      ...
      if (i < this.jdField_b_of_type_JavaUtilList.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          if ((!localCommentData.isFamilyTopEntry()) || ((localCommentData.isFamilyTopEntry()) && (!pap.a()))) {
            localArrayList2.add(localCommentData);
          }
        }
      }
      if ((localArrayList2.size() > 0) && (this.jdField_f_of_type_Boolean)) {
        localArrayList1.add(new pdp(2, null, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
      }
  ...
  public List<pdp> b(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    for (String str = "";; str = this.jdField_b_of_type_JavaLangString)
    {
      ...
      if ((paramInt2 != 1) || (this.jdField_a_of_type_Pff == null) || (!this.jdField_a_of_type_Pff.jdField_a_of_type_Boolean)) {
        break;
      }
      ThreadManager.executeOnSubThread(new ReadInJoyCommentDataManager.5(this, this.jdField_a_of_type_Pff.jdField_a_of_type_JavaLangString));
      return;
    }
    if (paramInt1 == 6)
    {
  ...
  public void b(int paramInt, pfl parampfl, pfm parampfm, CommentData paramCommentData)
  {
    ...
    if (paramInt == 0)
    {
      ...
      a(this.h, parampfl.jdField_a_of_type_Boolean);
    ...
    while (bool2) {
      ...
      else
      {
        ...
        if (paramCommentData.jdField_a_of_type_JavaUtilList != null)
        {
          ...
          label239:
          parampfm = new StringBuilder().append(", hot size : ");
          if (paramCommentData.jdField_a_of_type_JavaUtilList == null) {
            break label377;
          }
        }
    ...
    if (paramCommentData.jdField_a_of_type_JavaUtilList != null) {}
    for (parampfl = a(1, new ArrayList(paramCommentData.jdField_a_of_type_JavaUtilList));; parampfl = new ArrayList())
    {
      bool2 = this.jdField_d_of_type_Boolean;
      QLog.d("ReadInJoyCommentDataManager", 2, new Object[] { "onLoadMoreHotComment, ret : ", Boolean.valueOf(bool1), ", size : ", Integer.valueOf(parampfl.size()), ", hasNext : ", Boolean.valueOf(bool2) });
      a(new pen(this, bool1, parampfl, bool2));
      return;
    }
  }
  ...
  public void b(ArticleInfo paramArticleInfo)
  {
    ...
    this.jdField_a_of_type_Pfq.a(paramArticleInfo);
  }
  ...
  public void b(String paramString, int paramInt)
  {
    ...
    for (int i = 1;; i = -1)
    {
      ...
      this.jdField_a_of_type_Pfn.a(paramString, 0, paramInt, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
      return;
    }
  }
  ...
  public void b(String paramString, boolean paramBoolean)
  {
    ...
    {
      paramString.a(i);
      pgv.a.a(paramString, this);
      return;
    }
  }
  
  public void b(pdp parampdp, int paramInt)
  {
    if ((parampdp == null) || (parampdp.a == null)) {
      return;
    }
    QLog.d("ReadInJoyCommentDataManager", 1, "authorDeleteComment | " + parampdp.a);
    pgv.a.a(this.jdField_a_of_type_Int, parampdp, paramInt, this);
  }
  ...
  public void c(int paramInt, pfl parampfl, pfm parampfm, CommentData paramCommentData)
  {
    paramCommentData = parampfl;
    if (parampfl == null) {
      paramCommentData = new pfl();
    ...
    if (paramInt == 0)
    {
      ...
      l = parampfl.jdField_a_of_type_Long;
      label107:
      this.jdField_d_of_type_Long = l;
      parampfl = new StringBuilder();
    ...
    label247:
    if (paramCommentData != null) {}
    for (parampfl = a(4, new ArrayList(paramCommentData.jdField_a_of_type_JavaUtilList));; parampfl = new ArrayList())
    {
      QLog.d("ReadInJoyCommentDataManager", 1, new Object[] { "onLoadMoreFamilyComment, ret : ", Boolean.valueOf(bool1), ", size : ", Integer.valueOf(parampfl.size()), ", hasNext : ", Boolean.valueOf(this.jdField_e_of_type_Boolean) });
      a(new pep(this, bool1, parampfl));
      return;
    }
  }
  ...
  public void c(String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      long l = pgv.a.a(localSubCommentCreateData, new peb(this), paramString, paramInt, false);
      if (l != -1L) {
        this.jdField_a_of_type_Bkyb.b(l, new Pair(paramString, localSubCommentData));
      }
  ...
  public void d(String paramString)
  {
    ...
    pgv.a.a(localFirstCommentCreateData, new ped(this), paramString, 2, true);
  }
  ...
  public void d(String paramString, int paramInt)
  {
    ...
    localFirstCommentCreateData.a(localBaseCommentData.commentContent);
    localFirstCommentCreateData.a(localBaseCommentData.commentLinkDataList);
    long l = pgv.a.a(localFirstCommentCreateData, new pec(this), paramString, paramInt, false);
    if (l != -1L) {
      this.jdField_a_of_type_Bkyb.b(l, new Pair(paramString, localBaseCommentData));
    }
