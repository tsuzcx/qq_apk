...
public class bnxm
  extends PopupWindow
{
  private static final Drawable jdField_a_of_type_AndroidGraphicsDrawableDrawable = a(2130850808);
  ...
  private static final Drawable jdField_b_of_type_AndroidGraphicsDrawableDrawable = a(2130850809);
  ...
  private View.OnKeyListener jdField_a_of_type_AndroidViewView$OnKeyListener = new bnxp(this);
  private View.OnTouchListener jdField_a_of_type_AndroidViewView$OnTouchListener = new bnxq(this);
  private ListView jdField_a_of_type_AndroidWidgetListView;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private bnxr jdField_a_of_type_Bnxr;
  private Spring jdField_a_of_type_ComTencentComponentAnimationReboundSpring;
  public ArrayList<bnxs> a;
  ...
  public bnxm(Activity paramActivity)
  {
    super(paramActivity);
  ...
  private void a(int paramInt)
  {
    ...
    bhtq.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, jdField_c_of_type_AndroidGraphicsDrawableDrawable);
  ...
  private int c()
  {
    ...
    return bhtq.b() - localRect.height();
  }
  ...
  private void f()
  {
    ...
    setWidth(-1);
    setHeight(-1);
    this.jdField_a_of_type_ComTencentComponentAnimationReboundSpring = SpringSystem.create().createSpring().setSpringConfig(jdField_a_of_type_ComTencentComponentAnimationReboundSpringConfig).addListener(new bnxn(this));
    this.jdField_a_of_type_Bnxr = new bnxr(this, this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131365777));
    ...
    this.jdField_a_of_type_AndroidWidgetListView.setAdapter(this.jdField_a_of_type_Bnxr);
    this.jdField_a_of_type_AndroidWidgetListView.setOnTouchListener(new bnxo(this));
  }
  ...
  private void h()
  {
    ...
    for (;;)
    {
      ...
      bhtq.b(this.jdField_a_of_type_AndroidWidgetListView, f3);
      bhtq.c(this.jdField_a_of_type_AndroidWidgetListView, f3);
      if (this.jdField_c_of_type_Boolean)
      {
        bhtq.e(this.jdField_a_of_type_AndroidWidgetListView, 0.0F);
        bhtq.d(this.jdField_a_of_type_AndroidWidgetListView, this.jdField_c_of_type_Int);
      }
      for (;;)
      {
        ...
        f3 = f2;
        break;
        bhtq.e(this.jdField_a_of_type_AndroidWidgetListView, this.d);
        bhtq.d(this.jdField_a_of_type_AndroidWidgetListView, this.jdField_c_of_type_Int);
      }
      label221:
      break;
  ...
  public void a()
  {
    ...
    a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0.0F);
    bhtq.a(this.jdField_a_of_type_AndroidWidgetListView, jdField_a_of_type_AndroidGraphicsDrawableDrawable);
  ...
  public void a(bnxs parambnxs)
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (parambnxs != null)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(parambnxs);
    }
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = bhtq.a() - this.jdField_a_of_type_AndroidWidgetRelativeLayout.getPaddingRight() * 2;
    ...
    localLayoutParams1.topMargin = (paramInt2 - i - bhtq.b(5.0F));
  ...
  public int b()
  {
    ...
    {
      i = bhtq.b() - this.jdField_a_of_type_AndroidWidgetRelativeLayout.getHeight();
      if (i > bhtq.b(25.0F)) {}
    }
    int j;
    do
  ...
  public void b()
  {
    ...
    a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, 0.0F);
    bhtq.a(this.jdField_a_of_type_AndroidWidgetListView, jdField_b_of_type_AndroidGraphicsDrawableDrawable);
    if (this.jdField_a_of_type_AndroidWidgetListView != null) {
      this.jdField_a_of_type_AndroidWidgetListView.setPadding(this.jdField_a_of_type_AndroidWidgetListView.getPaddingLeft(), this.jdField_a_of_type_AndroidWidgetListView.getPaddingTop() + bhtq.b(9.0F), this.jdField_a_of_type_AndroidWidgetListView.getPaddingRight(), this.jdField_a_of_type_AndroidWidgetListView.getPaddingBottom());
    }
    super.showAtLocation(a(), 17, 0, 0);
    c();
  }
  ...
  public void e()
  {
    int i = 0;
    int j = 0;
    while (i < this.jdField_a_of_type_Bnxr.getCount())
    {
      View localView = this.jdField_a_of_type_Bnxr.getView(i, null, this.jdField_a_of_type_AndroidWidgetListView);
      localView.measure(View.MeasureSpec.makeMeasureSpec(0, 0), View.MeasureSpec.makeMeasureSpec(0, 0));
      j += localView.getMeasuredHeight();
      i += 1;
    }
    this.jdField_b_of_type_Int = (bhtq.b(9.0F) + j);
  }
}
