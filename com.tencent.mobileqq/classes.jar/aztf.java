...
public class aztf
{
  private akim jdField_a_of_type_Akim = new aztg(this);
  public Context a;
  public Handler a;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  public String a;
  
  public aztf(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, Handler paramHandler)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      ((akhq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(true, this.jdField_a_of_type_JavaLangString, str, 5);
      if (l1 == 0L)
      {
