  ...
  implements Handler.Callback, Manager
{
  ...
  public avnp(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (int i = 1;; i = 0)
        {
          ...
          if (!bjnn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim"))
          {
            if (!QLog.isColorLevel()) {
              break;
            }
  ...
  private void b()
  {
    ...
    localObject2 = amtj.a(2131714014);
    str4 = "登录TIM";
    str2 = amtj.a(2131714013);
    ...
    bfur.a(BaseActivity.sTopActivity, 230, str5, str6, (String)localObject3, (String)localObject1, new avnq(this), new avnr(this)).show();
    bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80085D9", "0X80085D9", 0, 0, "", "", "", "");
  }
  ...
  {
    if (!bfwv.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim", "775E696D09856872FDD8AB4F3F06B1E0"))
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131718944, 0).a();
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "jumpTimLogin tim not install ");
      }
      return;
    }
    String str = bfwv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim");
    int i = aqjv.a().b();
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        localbhht = new bhht(BaseActivity.sTopActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getDimensionPixelOffset(2131299076));
        localbhht.a(amtj.a(2131714012));
        localbhht.show();
        ...
        localWtloginHelper.SetListener(new avns(this, localbhht, localWtloginHelper, paramBundle));
        paramBundle = util.getPkgSigFromApkName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim");
        i = localWtloginHelper.GetA1WithA1(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), 16L, 16L, "com.tencent.tim".getBytes(), 1L, 16L, 16L, "8.4.8".getBytes(), paramBundle, new WUserSigInfo(), new WFastLoginInfo());
      }
      if (i == -1001) {
        break;
      }
      ...
      if ((localbhht != null) && (localbhht.isShowing())) {
        localbhht.dismiss();
      }
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131718943, 0).a();
      return;
    } while (j >= i);
    QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131718945, 0).a();
  }
