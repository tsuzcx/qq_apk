  ...
  implements aeyb, aeyv
{
  ...
  public aeyq(QQAppInterface paramQQAppInterface, aeyx paramaeyx, Context paramContext, XPanelContainer paramXPanelContainer, List<QQOperationViopTipTask> paramList, SessionInfo paramSessionInfo, acut paramacut)
  {
  ...
  private void b(QQOperationViopTipTask paramQQOperationViopTipTask)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aeyx.a(this, new Object[] { paramQQOperationViopTipTask });
      return;
      i = 0;
    }
  }
  ...
  public View a(Object... paramVarArgs)
  {
    if ((paramVarArgs[0] instanceof QQOperationViopTipTask))
    {
      ...
      View localView = LayoutInflater.from((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).inflate(2131560632, null);
      TextView localTextView = (TextView)localView.findViewById(2131372957);
      Button localButton = (Button)localView.findViewById(2131372954);
      localTextView.setText(paramVarArgs.adwords);
      localButton.setText(paramVarArgs.clickableWord);
      localButton.setOnClickListener(new aeyr(this, paramVarArgs));
      return localView;
    }
    return null;
  }
  ...
  public MessageRecord a(Object... paramVarArgs)
  {
    ...
    {
      paramVarArgs = (QQOperationViopTipTask)paramVarArgs[0];
      MessageRecord localMessageRecord = axaq.a(-1041);
      long l = awzw.a();
  ...
  {
    andi localandi = andi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    ...
    for (;;)
    {
      ...
      if (paramList.hasNext())
      {
        ...
        localQQOperationViopTipTask = localandi.a(i);
      ...
      for (;;)
      {
        ...
        if ((!localQQOperationViopTipTask.isGryTipsTask()) || (localandi.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 2))) {
          break;
        }
