...
public class aqvi
  implements amak
{
  public aqvi(JefsClass paramJefsClass, WeakReference paramWeakReference, JefsClass.CancelableRunnable paramCancelableRunnable, int paramInt, String paramString) {}
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = bbdj.a(paramString, 0, null, "即将离开QQ\n打开其他应用", paramString.getString(2131690596), paramString.getString(2131720896), new aqvj(this), new aqvk(this));
      ...
      if ((paramString instanceof BasePluginActivity))
      {
        ...
        if (BaseApplicationImpl.sProcessId != 1)
        {
          if (JefsClass.a(this.jdField_a_of_type_ComTencentMobileqqHaoliyouJefsClass) == null) {
            JefsClass.a(this.jdField_a_of_type_ComTencentMobileqqHaoliyouJefsClass, new aqvr(this.jdField_a_of_type_ComTencentMobileqqHaoliyouJefsClass, null));
          }
        ...
        abtq.a(paramString, PublicTransFragmentActivity.class, JumpConfirmFragment.class);
        QLog.i("TeleScreen|JefsClass", 1, "leave QQ jump other app , act == null && act.isFinishing() == true");
        return;
        amau.a().a(this.jdField_a_of_type_Int, -2);
        return;
        label491:
        paramString = null;
      }
