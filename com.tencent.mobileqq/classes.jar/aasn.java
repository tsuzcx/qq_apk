...
{
  private static aasn jdField_a_of_type_Aasn = new aasn();
  ...
  public static aasn a()
  {
    try
    {
      aasn localaasn = jdField_a_of_type_Aasn;
      return localaasn;
    }
    finally
    {
  ...
  {
    aase.a("GdtImpressionPolicy", "report view: " + paramView.hashCode());
    GdtAd localGdtAd = a(paramView);
    if (localGdtAd == null)
    {
      aase.a("GdtImpressionPolicy", "break: statistics == null");
      return;
    }
    if (localGdtAd.reportState == 2)
    {
      aase.a("GdtImpressionPolicy", "break: already report " + localGdtAd.getTraceId());
      return;
    }
    if (!a(paramView))
    {
      aase.a("GdtImpressionPolicy", "break: isVisibleAreaSatisfied not");
      return;
    }
    ...
    if (!b(paramView))
    {
      aase.a("GdtImpressionPolicy", "inCountingMap not " + localGdtAd.getTraceId());
  ...
  {
    aase.a("GdtImpressionPolicy", "handleMessage : ");
    ...
    for (;;)
    {
      ...
      if (paramMessage.get() != null)
      {
        ...
        {
          aase.a("GdtImpressionPolicy", "break: statistics.reportState != 1 " + localGdtAd.getTraceId());
        }
        else if (!a(paramMessage))
        {
          aase.a("GdtImpressionPolicy", "break: isVisibleAreaSatisfied not " + localGdtAd.getTraceId());
          localGdtAd.reportState = -1;
        }
        else if (!b(paramMessage))
        {
          aase.a("GdtImpressionPolicy", "break: inCountingMap not " + localGdtAd.getTraceId());
        }
        else
        {
          localObject = paramMessage.getTag(2131379968);
          if (localObject == null)
          {
            aase.a("GdtImpressionPolicy", "break: o2 == null " + localGdtAd.getTraceId());
          }
          else if (!(localObject instanceof aaso))
          {
            aase.a("GdtImpressionPolicy", "break: o2 instanceof ReportListener not " + localGdtAd.getTraceId());
          }
          else
          {
            ...
            aase.a("GdtImpressionPolicy", "break: already reported " + localGdtAd.getTraceId());
          }
        }
      }
    }
    ((aaso)localObject).reportImpression(paramMessage);
    localGdtAd.reportState = 2;
    a(localGdtAd.getTraceId(), true);
    aase.a("GdtImpressionPolicy", "report " + localGdtAd.getTraceId());
