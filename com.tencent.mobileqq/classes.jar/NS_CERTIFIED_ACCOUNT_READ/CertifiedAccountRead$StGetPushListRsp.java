  ...
  extends MessageMicro<StGetPushListRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32 }, new String[] { "extInfo", "vecPushFeed", "totalNum", "isFinish" }, new Object[] { null, null, localInteger, localInteger }, StGetPushListRsp.class);
  }
}
