  ...
  extends MessageMicro<StGetCommentListRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32 }, new String[] { "extInfo", "vecComment", "totalNum", "isFinish" }, new Object[] { null, null, localInteger, localInteger }, StGetCommentListRsp.class);
  }
}
