  ...
  extends MessageMicro<StGetAioMsgListRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 24, 32 }, new String[] { "extInfo", "vecAioMsg", "totalNum", "isFinish" }, new Object[] { null, null, localInteger, localInteger }, StGetAioMsgListRsp.class);
  }
}
