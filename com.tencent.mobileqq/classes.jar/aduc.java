...
{
  public aduc(DevlockPushActivity paramDevlockPushActivity) {}
  ...
  public void onCheckDevLockStatus(WUserSigInfo paramWUserSigInfo, DevlockInfo paramDevlockInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    if (((this.a.jdField_a_of_type_Bisl == null) || (!this.a.jdField_a_of_type_Bisl.isShowing())) && (paramInt == 0) && (paramDevlockInfo != null))
    {
      this.a.jdField_a_of_type_OicqWlogin_sdkDevicelockDevlockInfo = paramDevlockInfo;
      aslf.a().a(this.a.jdField_a_of_type_OicqWlogin_sdkDevicelockDevlockInfo.TransferInfo);
      return;
    }
    this.a.b();
    ...
    paramDevlockInfo = this.a.getString(2131691966);
