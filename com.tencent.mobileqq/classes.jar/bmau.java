...
{
  public bmau(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, oidb_cmd0xd68.RspBody paramRspBody)
  {
    ...
    agfe.a().a(this.app, paramToServiceMsg.msgSeq);
  ...
  private void b(ToServiceMsg paramToServiceMsg, oidb_cmd0xd68.RspBody paramRspBody)
  {
    ...
    auea.b(paramToServiceMsg.nSessionId);
    ...
    for (;;)
    {
      ...
      paramRspBody = new audz();
      paramRspBody.b = "send_file_suc";
      paramRspBody.a = 1;
      audy.a(this.app.getCurrentAccountUin(), paramRspBody);
      auea.a(this.app, paramToServiceMsg);
      return;
  ...
  private void c(ToServiceMsg paramToServiceMsg, oidb_cmd0xd68.RspBody paramRspBody)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramToServiceMsg = (ansr)this.app.getBusinessHandler(BusinessHandlerFactory.DATALINE_HANDLER);
