  ...
  extends whu
{
  ...
  public wge(wfy paramwfy, String paramString, int paramInt)
  {
    this.jdField_a_of_type_JavaLangString = weg.a("StorySvc.get_comment_list");
    this.b = paramString;
  ...
  public whv a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new wgf(this.jdField_a_of_type_Wfy, localRspGetCommentList);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ykq.d("Q.qqstory:GetCommentListRequest", "" + paramArrayOfByte);
    }
    return null;
  }
