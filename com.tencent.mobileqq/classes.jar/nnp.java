  ...
  extends alko
{
  ...
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {}
    while (this.jdField_a_of_type_Nnr != null) {
      return;
    }
    this.jdField_a_of_type_Nnr = new nnq(this);
    this.mApp.addObserver(this.jdField_a_of_type_Nnr);
  ...
  {
    super.onDestroy();
    this.mApp.removeObserver(this.jdField_a_of_type_Nnr);
  }
