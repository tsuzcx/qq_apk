...
public class nnp
{
  ...
  {
    if (this.jdField_a_of_type_Nns != null) {
      this.jdField_a_of_type_Nns.a(paramArrayList);
    }
  }
  ...
  private void a(List<Long> paramList)
  {
    ...
    ((NewIntent)localObject).setObserver(new nnr(this));
  ...
  {
    if (this.jdField_a_of_type_Nns != null) {
      this.jdField_a_of_type_Nns.a();
    }
  }
  
  public void a()
  {
    this.jdField_a_of_type_Nns = null;
    this.jdField_a_of_type_Boolean = true;
  }
  
  public boolean a(String paramString, nns paramnns)
  {
    return a(paramString, paramnns, false);
  }
  
  public boolean a(String paramString, nns paramnns, boolean paramBoolean)
  {
    this.jdField_a_of_type_Nns = paramnns;
    paramnns = new oidb_0x8cf.ReqBody();
    try
    {
      paramnns.opt_uint64_groupcode.set(Long.parseLong(paramString));
      paramnns.opt_uint32_need_mobile_sysapps.set(1);
      paramString = new oidb_sso.OIDBSSOPkg();
      paramString.uint32_command.set(2255);
      paramString.uint32_service_type.set(6);
      paramString.bytes_bodybuffer.set(ByteStringMicro.copyFrom(paramnns.toByteArray()));
      paramnns = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), niq.class);
      paramnns.putExtra("cmd", "OidbSvc.0x8cf_6");
      paramnns.putExtra("data", paramString.toByteArray());
      paramnns.setObserver(new nnq(this, paramBoolean));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet(paramnns);
      return true;
    }
    catch (NumberFormatException paramnns)
    {
