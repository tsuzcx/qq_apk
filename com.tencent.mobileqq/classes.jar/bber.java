  ...
  implements Handler.Callback, Manager
{
  ...
  public bber(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bbes = new bbes(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  }
  
  private void a(bbeq parambbeq)
  {
    int i = this.jdField_a_of_type_Bbes.a(parambbeq);
  ...
  private void b(bbeq parambbeq)
  {
    ThreadManager.post(new ScribbleDownloader.1(this, parambbeq), 5, null, false);
  }
  
  private void d()
  {
    if (this.jdField_a_of_type_Bbes.a() < 2)
    {
      bbeq localbbeq = this.jdField_a_of_type_Bbes.a();
      if (localbbeq == null)
      {
  ...
  {
    int i = this.jdField_a_of_type_Bbes.a(paramMessageForScribble);
  ...
  public void a(MessageForScribble paramMessageForScribble)
  {
    ...
    if (a())
    {
      a(new bbeq(paramMessageForScribble, 200));
      return;
    }
  ...
  public void b(MessageForScribble paramMessageForScribble)
  {
    ...
    a(new bbeq(paramMessageForScribble, 201));
  }
