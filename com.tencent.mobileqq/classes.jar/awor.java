...
public class awor
  implements awoq
{
  static beup jdField_a_of_type_Beup = new awou();
  private static File jdField_a_of_type_JavaIoFile;
  private static Comparator<File> jdField_a_of_type_JavaUtilComparator = new awos();
  private beuo jdField_a_of_type_Beuo;
  private beuq jdField_a_of_type_Beuq = new awot(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private ConcurrentHashMap<String, List<awov>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private ConcurrentHashMap<String, beum> b;
  
  public awor(QQAppInterface paramQQAppInterface)
  {
  ...
  public static String a(String paramString)
  {
    ...
    {
      jdField_a_of_type_JavaIoFile = new File(awlp.jdField_a_of_type_JavaLangString);
    ...
    return new File(awlp.jdField_a_of_type_JavaLangString, bjtz.d(paramString)).getAbsolutePath();
  }
  ...
  private void a(MusicInfo paramMusicInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        i = awlq.a().jdField_a_of_type_Int;
        if (i <= 0)
        {
          ...
          if (paramMusicInfo.b.size() > 0)
          {
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              if (!TextUtils.isEmpty(str)) {
                ((List)localObject1).add(new awov(paramMusicInfo.jdField_a_of_type_JavaLangString, str));
              }
            }
          }
        }
    ...
    for (;;)
    {
      ...
      {
        localObject2 = (awov)localIterator.next();
        if (((awov)localObject2).jdField_a_of_type_Int == 1)
        {
          bool = true;
          break label583;
        }
      ...
      for (;;)
      {
        ...
        break;
        if ((((awov)localObject2).jdField_a_of_type_Int == 0) && (localObject1 == null))
        {
          localObject1 = localObject2;
          break label595;
        }
        do
        {
          ...
          ((beum)localObject2).jdField_a_of_type_Beuq = this.jdField_a_of_type_Beuq;
          ((beum)localObject2).jdField_a_of_type_JavaLangString = ((awov)localObject1).b;
          ((beum)localObject2).jdField_a_of_type_Int = 0;
          ((beum)localObject2).c = ((awov)localObject1).d;
          ((beum)localObject2).d = 1;
          ((beum)localObject2).a(new Object[] { paramMusicInfo, localObject1 });
          ((beum)localObject2).jdField_a_of_type_Beup = jdField_a_of_type_Beup;
          this.jdField_a_of_type_Beuo.a((bevl)localObject2);
          ((awov)localObject1).jdField_a_of_type_Int = 1;
          break;
          break label595;
          bool = false;
          localObject1 = localObject2;
  ...
  {
    int i = bjjh.a(BaseApplicationImpl.getContext());
    boolean bool;
    if (paramInt == 0) {
      bool = true;
    }
  ...
  public static void b()
  {
    ...
    Object localObject1 = new File(awlp.jdField_a_of_type_JavaLangString);
  ...
  private boolean b(int paramInt)
  {
    ...
    File localFile1 = new File(awlp.jdField_a_of_type_JavaLangString);
    Object localObject;
    int i;
  ...
  private void c()
  {
    try
    {
      ...
      {
        Object localObject2 = (bevl)((Map.Entry)localIterator.next()).getValue();
        this.jdField_a_of_type_Beuo.b((bevl)localObject2);
        if ((localObject2 instanceof beum))
        {
          localObject2 = (beum)localObject2;
          if (QLog.isColorLevel()) {
            QLog.d("ListenTogether.downloader", 2, String.format("cancelAllRequests, cancel req url: %s", new Object[] { ((beum)localObject2).jdField_a_of_type_JavaLangString }));
          }
        }
      }
      if (!QLog.isColorLevel()) {
  ...
  public void a(String paramString)
  {
    ...
    //   20: return
    //   21: aload_0
    //   22: getfield 59	awor:b	Ljava/util/concurrent/ConcurrentHashMap;
    //   25: aload_1
    //   26: invokevirtual 356	java/util/concurrent/ConcurrentHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   29: checkcast 343	bevl
    //   32: astore_2
    //   33: aload_2
    //   34: ifnull +13 -> 47
    //   37: aload_0
    //   38: getfield 52	awor:jdField_a_of_type_Beuo	Lbeuo;
    //   41: aload_2
    //   42: invokeinterface 345 2 0
    //   47: aload_0
    //   48: getfield 57	awor:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   51: aload_1
    //   52: invokevirtual 356	java/util/concurrent/ConcurrentHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   55: pop
