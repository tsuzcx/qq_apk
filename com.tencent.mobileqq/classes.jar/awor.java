  ...
  implements Manager
{
  ...
  private final List<awos> jdField_a_of_type_JavaUtilList = new ArrayList();
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler;
  private boolean[] jdField_a_of_type_ArrayOfBoolean;
  private final List<awos> jdField_b_of_type_JavaUtilList = new ArrayList();
  private MqqHandler jdField_b_of_type_MqqOsMqqHandler;
  
  public awor(NearbyAppInterface paramNearbyAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface = paramNearbyAppInterface;
    this.jdField_a_of_type_Awot = new awot(paramNearbyAppInterface, this);
  ...
  {
    return this.jdField_a_of_type_Awot.a(paramInt);
  }
  
  private Message b(Message paramMessage)
  {
    return this.jdField_a_of_type_Awot.a(paramMessage);
  }
  
  private Object[] b(int paramInt, Object... paramVarArgs)
  {
    return this.jdField_a_of_type_Awot.a(paramInt, paramVarArgs);
  }
  
  public int a()
  {
    Object[] arrayOfObject = this.jdField_a_of_type_Awot.a(4156);
  ...
  public Message a(Message paramMessage)
  {
    ...
    ((anho)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(216)).a(FaceInfo.a(i, (String)localObject, j, 3, 0));
    return null;
  }
  
  public axgd a()
  {
    axgd localaxgd = new axgd();
    Object[] arrayOfObject = b(4165, new Object[] { Integer.valueOf(0) });
    if (arrayOfObject != null) {}
    try
    {
      localaxgd.jdField_a_of_type_Int = ((Integer)arrayOfObject[0]).intValue();
      localaxgd.b = ((Integer)arrayOfObject[1]).intValue();
      localaxgd.c = ((Integer)arrayOfObject[2]).intValue();
      localaxgd.d = ((Integer)arrayOfObject[3]).intValue();
      return localaxgd;
    }
    catch (Exception localException)
    {
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    //   1: istore 4
    //   3: aload_0
    //   4: getfield 28	awor:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   7: astore 5
    //   9: aload 5
    //   11: monitorenter
    //   12: iconst_0
    ...
    //   14: iload_3
    //   15: aload_0
    //   16: getfield 28	awor:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   19: invokeinterface 292 1 0
    //   24: if_icmpge +45 -> 69
    //   27: aload_0
    //   28: getfield 28	awor:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   31: iload_3
    //   32: invokeinterface 295 2 0
    //   37: checkcast 297	awos
    //   40: astore 6
    //   42: aload_0
    //   43: getfield 45	awor:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   46: new 299	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$1
    //   49: dup
    //   50: aload_0
    //   51: aload 6
    //   53: iload_1
    //   54: aload_2
    //   55: invokespecial 302	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$1:<init>	(Lawor;Lawos;I[Ljava/lang/Object;)V
    //   58: invokevirtual 308	mqq/os/MqqHandler:post	(Ljava/lang/Runnable;)Z
    //   61: pop
    //   62: iload_3
    //   63: iconst_1
    //   64: iadd
    ...
    //   71: monitorexit
    //   72: aload_0
    //   73: getfield 26	awor:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   76: astore 5
    //   78: aload 5
    //   80: monitorenter
    //   81: iload 4
    ...
    //   84: iload_3
    //   85: aload_0
    //   86: getfield 26	awor:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   89: invokeinterface 292 1 0
    //   94: if_icmpge +51 -> 145
    //   97: aload_0
    //   98: getfield 26	awor:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   101: iload_3
    //   102: invokeinterface 295 2 0
    //   107: checkcast 297	awos
    //   110: astore 6
    //   112: aload_0
    //   113: getfield 50	awor:jdField_b_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   116: new 310	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$2
    //   119: dup
    //   120: aload_0
    //   121: aload 6
    //   123: iload_1
    //   124: aload_2
    //   125: invokespecial 311	com/tencent/mobileqq/nearby/ipc/NearbyProcManager$2:<init>	(Lawor;Lawos;I[Ljava/lang/Object;)V
    //   128: invokevirtual 308	mqq/os/MqqHandler:post	(Ljava/lang/Runnable;)Z
    //   131: pop
    //   132: iload_3
    //   133: iconst_1
    //   134: iadd
  ...
  public void a(awos paramawos, boolean paramBoolean)
  {
    if (paramawos == null) {
      return;
    }
    if (paramBoolean) {
      ...
      {
        if (!this.jdField_a_of_type_JavaUtilList.contains(paramawos)) {
          this.jdField_a_of_type_JavaUtilList.add(paramawos);
        }
        return;
      }
    }
    ...
    {
      if (!this.jdField_b_of_type_JavaUtilList.contains(paramawos)) {
        this.jdField_b_of_type_JavaUtilList.add(paramawos);
      }
      return;
    }
  }
  ...
  public void a(oidb_0x8dd.SelfInfo paramSelfInfo)
  {
    ...
    try
    {
      ...
      {
        localObject1 = localObject2;
        awkj.a("Q.nearby", "updateSelfCard", new Object[] { paramSelfInfo, localObject1 });
        return;
      }
    }
    catch (Exception localException)
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Awot.a();
  }
  ...
  public boolean a(int paramInt, boolean paramBoolean)
  {
    boolean bool1 = false;
    Object localObject = null;
    SharedPreferences localSharedPreferences = awka.a("nearby_event_file", this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getAccount(), 4);
      ...
      for (;;)
      {
        for (;;)
        {
          try
          {
            ...
            if (QLog.isColorLevel()) {
              awkj.a("onGetMyTabConfig", new Object[] { Boolean.valueOf(bool2), Integer.valueOf(paramInt), Boolean.valueOf(paramBoolean) });
            }
            return bool1;
          }
          ...
          catch (Exception localException)
          {
            ...
            {
              localException.printStackTrace();
              awkj.a("onGetMyTabConfig", new Object[] { "save config", Integer.valueOf(paramInt), localException.toString() });
            }
            bool1 = true;
          }
        }
  ...
  public Object[] a(int paramInt, Object... paramVarArgs)
  {
    ...
    case 4146: 
      do
      {
        do
        {
          do
          {
            do
            {
              for (;;)
              {
                ...
                if ((paramVarArgs != null) && (paramVarArgs.length == 1) && ((paramVarArgs[0] instanceof Integer)))
                {
                  ...
                  if (QLog.isColorLevel())
                  {
                    awkj.a("MSG_NOTIFY_HAS_UNREAD_MSG", new Object[] { Integer.valueOf(paramInt) });
                    return null;
                        ...
                        if ((paramVarArgs != null) && (paramVarArgs.length == 2))
                        {
                          ...
                          if ((paramVarArgs != null) && (paramVarArgs.length == 1))
                          {
                            ...
                            if ((paramVarArgs != null) && (paramVarArgs.length == 1))
                            {
                              a(4116, paramVarArgs);
                              return null;
                              axhw.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface, 0, true);
                              return null;
            ...
            return null;
            ((aptt)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(210)).a();
            return null;
        ...
        try
        {
          ...
          ((awjy)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(219)).a(l, paramInt, i, j);
          return null;
        }
        catch (Exception paramVarArgs)
        {
      ...
      ((amxd)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.a(3)).a(paramInt, i);
      return null;
    case 4159: 
      a(4159, new Object[0]);
      return null;
  ...
  public axgd b()
  {
    ...
    try
    {
      ...
      localaxgd.c = ((Integer)arrayOfObject[2]).intValue();
      localaxgd.d = ((Integer)arrayOfObject[3]).intValue();
      localaxgd.jdField_a_of_type_JavaLangString = ((String)arrayOfObject[4]);
      return localaxgd;
    }
    catch (Exception localException)
    {
  ...
  public void b(awos paramawos)
  {
    ...
    {
      if (this.jdField_b_of_type_JavaUtilList.contains(paramawos)) {
        this.jdField_b_of_type_JavaUtilList.remove(paramawos);
      }
    }
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      if (this.jdField_a_of_type_JavaUtilList.contains(paramawos)) {
        this.jdField_a_of_type_JavaUtilList.remove(paramawos);
      }
      return;
      paramawos = finally;
      throw paramawos;
  ...
  {
    b();
    this.jdField_a_of_type_Awot = null;
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
