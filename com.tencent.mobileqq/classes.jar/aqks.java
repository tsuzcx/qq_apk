...
public class aqks
  extends anud
{
  public aqks(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  public void a(List<String> paramList, anui paramanui)
  {
    ...
    do
    {
      ...
      localBubble_Req_Comm.mqqver.set("8.4.5");
    ...
    paramanui = super.createToServiceMsg("bubble.1", paramanui);
      ...
      do
      {
        ...
        catch (Exception paramFromServiceMsg)
        {
          ...
          if ((paramFromServiceMsg.rspcmd_0x01.has()) && (paramFromServiceMsg.rspcmd_0x01.user_text_info.has()))
          {
            ...
            aqkr.a().a(this.app, true, paramFromServiceMsg);
