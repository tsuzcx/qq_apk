...
public class xse
  implements Runnable
{
  public xse(LoginView paramLoginView, String paramString, QQProgressDialog paramQQProgressDialog) {}
  ...
  public void run()
  {
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityRegisterGuideLoginLoginView.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null) {
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterGuideLoginLoginView.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new xsf(this));
      }
      return;
      i = 0;
    }
