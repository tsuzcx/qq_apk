  ...
  public boolean notify(String paramString1, String paramString2, String paramString3)
  {
    ...
    if (paramString2.equals("ad_c2s_report")) {
      try
      {
        ...
        abrs.a(paramString1.getInt("op"), 0, (qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(abrk.a(new qq_ad_get.QQAdGetRsp.AdInfo(), paramString1.getJSONObject("adInfo"))));
