...
public class qbj
{
  ...
  private static qbj a(String paramString, int paramInt)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    return a(bbmj.a(paramString), paramInt);
  }
  
  private static qbj a(qbj paramqbj)
  {
    SharedPreferences localSharedPreferences = bhvh.a(onk.a(), true, false);
    if ((localSharedPreferences == null) || (paramqbj == null)) {
      return paramqbj;
    }
    paramqbj.jdField_d_of_type_Long = localSharedPreferences.getLong("kandian_push_0x210_c5_msg_time", 0L);
    return paramqbj;
  }
  
  public static qbj a(byte[] paramArrayOfByte)
  {
    return a(paramArrayOfByte, 1);
  }
  
  public static qbj a(byte[] paramArrayOfByte, int paramInt)
  {
    int i1 = 0;
    qbj localqbj = new qbj();
    for (;;)
    {
      try
      {
        submsgtype0xc5.MsgBody localMsgBody = new submsgtype0xc5.MsgBody();
        localMsgBody.mergeFrom(paramArrayOfByte);
        localqbj.jdField_a_of_type_Int = paramInt;
        localqbj.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
        localqbj.jdField_b_of_type_Int = localMsgBody.uint32_source.get();
        if (QLog.isColorLevel()) {
          QLog.d("KandianOx210MsgInfo", 2, "receive push 0xc5, bid = " + localqbj.jdField_b_of_type_Int);
        }
        localqbj.jdField_c_of_type_Int = localMsgBody.uint32_bid.get();
        if (QLog.isColorLevel()) {
          QLog.d("KandianOx210MsgInfo", 2, "receive push 0xc5, realbid = " + localqbj.jdField_c_of_type_Int);
        }
        localqbj.jdField_a_of_type_Long = localMsgBody.uint64_article_id.get();
        localqbj.jdField_b_of_type_Long = localMsgBody.uint64_seq.get();
        if (localMsgBody.bytes_diandian_cookie.has()) {
          localqbj.jdField_c_of_type_JavaLangString = localMsgBody.bytes_diandian_cookie.get().toStringUtf8();
        }
        if ((localMsgBody.msg_notify_infos.has()) && (localMsgBody.msg_notify_infos.get() != null) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get() != null))
        {
          ...
          {
            localqbj.jdField_a_of_type_JavaUtilArrayList.clear();
            ...
            if (paramInt < paramArrayOfByte.size())
            {
              ...
              localqbj.jdField_a_of_type_JavaUtilArrayList.add(localObject2);
              paramInt += 1;
              continue;
            }
          }
          ...
          if (((submsgtype0xc5.StyleSheet)localObject1).uint32_show_folder.has())
          {
            ...
            localqbj.jdField_e_of_type_Int = paramInt;
            ...
            localqbj.jdField_g_of_type_Int = paramInt;
            ...
            localqbj.jdField_a_of_type_JavaLangString = paramArrayOfByte;
            ...
            localqbj.jdField_b_of_type_JavaLangString = paramArrayOfByte;
            if (((!((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.has()) || (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.get() == null)) && (localqbj.jdField_a_of_type_JavaUtilArrayList.size() == 0)) {
              return null;
            }
            if (((!((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.has()) || (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.StyleSheet)localObject1).get()).msg_tip_body.get() == null)) && (localqbj.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
              return localqbj;
            ...
            if (((submsgtype0xc5.StyleSheet)localObject1).uint32_show_lock_screen.has())
            {
              ...
              localqbj.jdField_f_of_type_Int = paramInt;
              paramInt = i1;
              ...
              localqbj.jdField_h_of_type_Int = paramInt;
              if (((submsgtype0xc5.TipsBody)localObject2).uint64_uin.has())
              {
                ...
                localqbj.jdField_e_of_type_Long = l1;
                ...
                localqbj.jdField_e_of_type_JavaLangString = paramArrayOfByte;
                ...
                localqbj.jdField_d_of_type_JavaLangString = paramArrayOfByte;
                ...
                localqbj.jdField_f_of_type_JavaLangString = paramArrayOfByte;
                ...
                localqbj.jdField_g_of_type_JavaLangString = paramArrayOfByte;
                if ((localMsgBody.msg_notify_infos.has()) && (localMsgBody.msg_notify_infos.get() != null) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get() != null) && (((submsgtype0xc5.StyleSheet)((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get()).msg_type.has())) {
                  localqbj.i = ((submsgtype0xc5.StyleSheet)((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_style_sheet.get()).msg_type.get();
                }
                if ((((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_bb_info.has()) && (((submsgtype0xc5.NotifyBody)localMsgBody.msg_notify_infos.get()).msg_bb_info.get() != null))
                {
                  ...
                  localqbj.jdField_c_of_type_Long = paramArrayOfByte.uint64_bb_uin.get();
                  localqbj.jdField_d_of_type_Int = paramArrayOfByte.uint32_src.get();
                }
                localqbj.jdField_h_of_type_JavaLangString = localMsgBody.str_msgid.get();
                return localqbj;
              }
            }
            else
  ...
  public static qbj b()
  {
    return a(a(bhvh.a(onk.a(), true, false).getString("kandian_push_0x210_msg_for_follow", ""), 1));
  }
  ...
  public static qbj c()
  {
    return a(a(bhvh.a(onk.a(), true, false).getString("kandian_push_0x210_msg_for_follow_show_in_folder", ""), 1));
  }
  ...
  public String a()
  {
    return bbmj.a(this.jdField_a_of_type_ArrayOfByte);
  }
