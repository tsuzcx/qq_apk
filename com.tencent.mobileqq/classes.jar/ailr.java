...
public class ailr
  implements ailq, Handler.Callback
{
  int jdField_a_of_type_Int = DisplayUtil.dip2px(BaseApplicationImpl.getContext(), 50.0F);
  private afoi jdField_a_of_type_Afoi;
  private ailp jdField_a_of_type_Ailp;
  Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new ails(this);
  ...
  private ArrayList<ailt> jdField_a_of_type_JavaUtilArrayList;
  public List<QQOperationViopTipTask> a;
  private Observer jdField_a_of_type_JavaUtilObserver;
  protected final MqqHandler a;
  int jdField_b_of_type_Int = DisplayUtil.dip2px(BaseApplicationImpl.getContext(), 30.0F);
  Animation jdField_b_of_type_AndroidViewAnimationAnimation;
  ImageView jdField_b_of_type_AndroidWidgetImageView;
  RelativeLayout jdField_b_of_type_AndroidWidgetRelativeLayout;
  Animation c;
  
  public ailr(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, afoi paramafoi, XPanelContainer paramXPanelContainer, List<QQOperationViopTipTask> paramList)
  {
    this.jdField_a_of_type_MqqOsMqqHandler = new bkyc(Looper.getMainLooper(), this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = paramSessionInfo;
    this.jdField_a_of_type_Afoi = paramafoi;
  ...
  private RelativeLayout a()
  {
    ...
    //   3: ldc 95
    //   5: aconst_null
    //   6: invokestatic 101	android/view/View:inflate	(Landroid/content/Context;ILandroid/view/ViewGroup;)Landroid/view/View;
    //   9: checkcast 103	android/widget/RelativeLayout
    //   12: astore_1
    //   13: aload_0
    //   14: aload_1
    //   15: ldc 104
    //   17: invokevirtual 108	android/widget/RelativeLayout:findViewById	(I)Landroid/view/View;
    //   20: checkcast 110	com/tencent/image/URLImageView
    //   23: putfield 112	ailr:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   26: aload_1
    //   27: astore_2
    //   28: new 114	java/io/File
    //   31: dup
    //   32: getstatic 120	onq:h	Ljava/lang/String;
    //   35: invokespecial 123	java/io/File:<init>	(Ljava/lang/String;)V
    //   38: invokevirtual 127	java/io/File:exists	()Z
    //   41: ifeq +62 -> 103
    //   44: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   47: ifeq +11 -> 58
    //   50: ldc 134
    //   52: iconst_2
    //   53: ldc 136
    //   55: invokestatic 140	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   58: new 142	java/net/URL
    //   61: dup
    //   62: new 144	java/lang/StringBuilder
    //   65: dup
    ...
    //   74: getstatic 120	onq:h	Ljava/lang/String;
    //   77: invokevirtual 151	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   80: invokevirtual 155	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   83: invokespecial 156	java/net/URL:<init>	(Ljava/lang/String;)V
    //   86: invokestatic 162	com/tencent/image/URLDrawable$URLDrawableOptions:obtain	()Lcom/tencent/image/URLDrawable$URLDrawableOptions;
    //   89: invokestatic 168	com/tencent/image/URLDrawable:getDrawable	(Ljava/net/URL;Lcom/tencent/image/URLDrawable$URLDrawableOptions;)Lcom/tencent/image/URLDrawable;
    //   92: astore_2
    //   93: aload_0
    //   94: getfield 112	ailr:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   97: aload_2
    //   98: invokevirtual 172	com/tencent/image/URLImageView:setImageDrawable	(Landroid/graphics/drawable/Drawable;)V
    //   101: aload_1
    //   102: astore_2
    //   103: aload_2
    //   104: areturn
    ...
    //   107: astore_1
    //   108: aload_3
    //   109: invokevirtual 175	java/net/MalformedURLException:printStackTrace	()V
    //   112: aload_1
    //   113: astore_2
    //   114: invokestatic 132	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   117: ifeq -14 -> 103
    //   120: ldc 134
    //   122: iconst_2
    //   123: new 144	java/lang/StringBuilder
    //   126: dup
    //   127: invokespecial 145	java/lang/StringBuilder:<init>	()V
    //   130: ldc 177
    //   132: invokevirtual 151	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   135: aload_3
    //   136: invokevirtual 180	java/net/MalformedURLException:getMessage	()Ljava/lang/String;
    //   139: invokevirtual 151	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   142: invokevirtual 155	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   145: invokestatic 140	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   148: aload_1
    //   149: areturn
    //   150: astore_1
    //   151: aconst_null
  ...
  private boolean a(ailt paramailt)
  {
    boolean bool3 = false;
    Object localObject1 = a(paramailt.b());
    int i = -1;
    int[] arrayOfInt = paramailt.a();
    boolean bool1;
    if (arrayOfInt != null)
    {
      if (this.jdField_a_of_type_Ailp != null) {
        i = this.jdField_a_of_type_Ailp.b();
      }
      boolean bool2 = true;
      int j = 0;
    ...
    for (;;)
    {
      if ((bool1) && ((paramailt instanceof ailp)) && (this.jdField_a_of_type_Ailp != null) && (this.jdField_a_of_type_Ailp.a() > ((ailp)paramailt).a()))
      {
  ...
  {
    if (this.jdField_a_of_type_Ailp != null) {
      return this.jdField_a_of_type_Ailp.b();
    }
    return -1;
  }
  ...
  public ailp a()
  {
    return this.jdField_a_of_type_Ailp;
  }
  ...
  public void a()
  {
    if (Thread.currentThread() == Looper.getMainLooper().getThread())
    {
      if (this.jdField_a_of_type_Afoi != null) {
        this.jdField_a_of_type_Afoi.a(this.jdField_a_of_type_Ailp);
      }
      this.jdField_a_of_type_Ailp = null;
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((ailt)localIterator.next()).a(paramInt, paramVarArgs);
      }
    }
  }
  
  public void a(ailt paramailt)
  {
    if (paramailt == null) {}
    do
    {
    ...
    } while (this.jdField_a_of_type_JavaUtilArrayList.contains(paramailt));
    this.jdField_a_of_type_JavaUtilArrayList.add(paramailt);
  }
  ...
  public void a(View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setId(2131368282);
    }
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(paramOnClickListener);
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout == null) {
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentWidgetXPanelContainer.findViewById(2131364488));
    }
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368282) == null) {
  ...
  public boolean a(aikq paramaikq, Object... paramVarArgs)
  {
    if (paramaikq != null)
    {
      if (a(paramaikq)) {
    ...
    {
      return false;
      paramVarArgs = paramaikq.a(paramVarArgs);
      if (paramVarArgs != null)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().addMessage(paramVarArgs, paramVarArgs.selfuin);
        if (QLog.isColorLevel()) {
          QLog.d("TipsManager", 2, "showGrayTips() success: from " + a(paramaikq.b()));
        }
        return true;
      }
    } while (!QLog.isColorLevel());
    QLog.d("TipsManager", 2, "showGrayTips() failure: MessageRecord null, from " + a(paramaikq.b()));
    return false;
  }
  
  public boolean a(ailp paramailp, Object... paramVarArgs)
  {
    if (AIOUtils.isForbidTipsShow) {}
    label140:
    do
    {
      do
      ...
      if (Thread.currentThread() == Looper.getMainLooper().getThread())
      {
        paramVarArgs = paramailp.a(paramVarArgs);
        this.jdField_a_of_type_Afoi.a(paramVarArgs, this.jdField_a_of_type_Ailp, paramailp);
        this.jdField_a_of_type_Ailp = paramailp;
      }
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TipsManager", 2, "showTipsBar() success: from " + a(paramailp.b()));
        }
        return true;
        paramVarArgs = new TipsManager.1(this, paramailp, paramVarArgs);
  ...
  public void c()
  {
    ...
    View localView1 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131379397);
    View localView2 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131379391);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        int k = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131299080);
        if (i == -1) {
        ...
        for (i = j + k;; i = j)
        {
          ...
          localLayoutParams.rightMargin = DisplayUtil.dip2px(BaseApplicationImpl.getContext(), 40.0F);
  ...
  public void d()
  {
    ...
    try
    {
      if ((this.jdField_b_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368282) != null))
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(null);
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
        this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367065));
        this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367066));
