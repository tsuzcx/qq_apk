  ...
  implements HookMethodCallback
{
  ...
  public ailr(BatteryStatsImpl paramBatteryStatsImpl, String paramString)
  {
  ...
  private final void a(ailt paramailt, int paramInt)
  {
    Bundle localBundle = new Bundle();
    localBundle.putInt("key_action", paramInt);
    localBundle.putString("key_stack", paramailt.c);
    localBundle.putString("key_tag", paramailt.b);
    if (paramInt == 9) {
      localBundle.putLong("key_duration", SystemClock.uptimeMillis() - paramailt.jdField_a_of_type_Long);
    }
  ...
  private final void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject3 = (ails)((Iterator)localObject2).next();
          j = ((ails)localObject3).jdField_a_of_type_JavaUtilHashSet.size();
          localObject3 = ((ails)localObject3).jdField_a_of_type_JavaUtilHashSet.iterator();
        ...
        localObject3 = (ails)localHashMap1.get(str);
        StringBuilder localStringBuilder = BatteryLog.a();
        localObject2 = ((ails)localObject3).jdField_a_of_type_JavaUtilHashSet.iterator();
        i = 0;
        if (((Iterator)localObject2).hasNext())
        {
          ...
          i += 1;
          if (i >= ((ails)localObject3).jdField_a_of_type_JavaUtilHashSet.size()) {
            break label450;
          }
        ...
        if (paramBoolean)
        {
          ...
          if (((ails)localObject3).jdField_a_of_type_JavaLangString != null) {
            break label417;
          }
          localObject3 = "";
      ...
      continue;
      label417:
      Object localObject3 = ((ails)localObject3).jdField_a_of_type_JavaLangString.replace("|", "_");
      continue;
      label434:
      localObject1.clear();
      return;
    ...
    do
    {
      ...
      if (i == 9) {
        synchronized (this.jdField_b_of_type_JavaUtilHashMap)
        {
          if (this.jdField_b_of_type_Boolean)
          {
            localObject1 = (ails)this.jdField_b_of_type_JavaUtilHashMap.get(str);
            paramBundle = (Bundle)localObject1;
            if (localObject1 == null)
            {
              paramBundle = new ails(this, null);
          ...
          if ((this.jdField_c_of_type_Boolean) && (this.jdField_d_of_type_Boolean))
          {
            localObject1 = (ails)this.jdField_c_of_type_JavaUtilHashMap.get(str);
            paramBundle = (Bundle)localObject1;
            if (localObject1 == null)
            {
              paramBundle = new ails(this, null);
  ...
  public void afterHookedMethod(MethodHookParam paramMethodHookParam)
  {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          synchronized (this.jdField_a_of_type_JavaUtilHashMap)
          {
            ...
            localailt = (ailt)this.jdField_a_of_type_JavaUtilHashMap.get(localWeakReference);
            if (localWeakReference.get() != paramMethodHookParam.thisObject) {
              break label235;
            }
            BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "wf_rl|", localailt.jdField_a_of_type_JavaLangString, "|", str });
            if (!((WifiManager.WifiLock)paramMethodHookParam.thisObject).isHeld())
            {
              BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "wf_time|", localailt.jdField_a_of_type_JavaLangString, "|", String.valueOf(SystemClock.uptimeMillis() - localailt.jdField_a_of_type_Long) });
        ...
        {
          BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "wf_alarm|", localailt.jdField_a_of_type_JavaLangString });
          ((Iterator)localObject2).remove();
          a(localailt, 10);
        }
      }
    ...
    Object localObject2 = new ailt(this, null);
    ((ailt)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(localObject2.hashCode());
    ((ailt)localObject2).c = str;
    if ((paramMethodHookParam.args != null) && (paramMethodHookParam.args.length == 2)) {}
    for (((ailt)localObject2).b = ((String)paramMethodHookParam.args[1]);; ((ailt)localObject2).b = ((String)paramMethodHookParam.args[0])) {
      do
      {
        ...
        BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "wf_new|", ((ailt)localObject2).jdField_a_of_type_JavaLangString, "|0|", String.valueOf(paramMethodHookParam.args[0]) });
        return;
      } while ((paramMethodHookParam.args == null) || (paramMethodHookParam.args.length != 1));
    }
    BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "wf_new|", ((ailt)localObject2).jdField_a_of_type_JavaLangString, "|", String.valueOf(paramMethodHookParam.args[0]), "|", String.valueOf(paramMethodHookParam.args[1]) });
  }
  ...
  public void beforeHookedMethod(MethodHookParam paramMethodHookParam)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        if (localWeakReference.get() == paramMethodHookParam.thisObject)
        {
          BatteryStatsImpl.a(this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryBatteryStatsImpl, new String[] { "wf_ac|", localailt.jdField_a_of_type_JavaLangString, "|", str });
          if (((WifiManager.WifiLock)paramMethodHookParam.thisObject).isHeld()) {
            continue;
          }
          localailt.jdField_a_of_type_Long = SystemClock.uptimeMillis();
        }
      }
      if (localWeakReference.get() == null)
      {
