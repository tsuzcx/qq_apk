...
public class aseh
{
  ...
  public static aseh a(JSONObject paramJSONObject)
  {
    if (paramJSONObject != null) {
      for (;;)
      {
        try
        {
          localObject = new aseh();
          try
          {
            if (paramJSONObject.has("tip"))
            {
              ((aseh)localObject).a = paramJSONObject.getString("tip");
              if (!paramJSONObject.has("key_word")) {
                continue;
              }
              ((aseh)localObject).b = paramJSONObject.getString("key_word");
              if (!paramJSONObject.has("jump_url")) {
                continue;
              }
              ((aseh)localObject).c = paramJSONObject.getString("jump_url");
              return localObject;
            }
            ((aseh)localObject).a = "";
            continue;
