...
{
  public alla(Context paramContext)
  {
    this.jdField_a_of_type_JavaLangString = anvx.a(2131699025);
  ...
  {
    if ((paramObject instanceof alla))
    {
      paramObject = (alla)paramObject;
      paramObject.jdField_a_of_type_Bffm.a(parambffl.jdField_a_of_type_Bffm);
      return paramObject;
    }
    paramObject = new alla(BaseApplication.getContext());
