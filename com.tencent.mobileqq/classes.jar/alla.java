  ...
  implements alfn, aljd, aljp
{
  ...
  private void a()
  {
    ...
    float f1 = this.jdField_e_of_type_Int / alls.jdField_a_of_type_Int;
    float f2 = this.jdField_d_of_type_Int / alls.jdField_b_of_type_Int;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QRSession", 2, String.format("initScanRect [mScanRect,qRRecogRect,qRRecogRectExt,rotateQRRecogRectExt]=[%s, %s, %s, %s] [w,h]=[%d,%d]", new Object[] { this.jdField_a_of_type_AndroidGraphicsRect.toShortString(), localRect1.toShortString(), localRect2.toShortString(), localRect4.toShortString(), Integer.valueOf(alls.jdField_a_of_type_Int), Integer.valueOf(alls.jdField_b_of_type_Int) }));
    }
  ...
  private void a(Rect paramRect1, Rect paramRect2, boolean paramBoolean)
  {
    ...
    if ((localRect.width() > 0) && (localRect.height() > 0))
    {
      ...
      float f1 = alls.jdField_a_of_type_Int / this.jdField_e_of_type_Int;
      float f2 = alls.jdField_b_of_type_Int / this.jdField_d_of_type_Int;
      if (QLog.isColorLevel()) {
        QLog.i("QRSession", 2, String.format("getScreenRect [%.2f,%.2f, %d,%d,%d,%d]", new Object[] { Float.valueOf(f1), Float.valueOf(f2), Integer.valueOf(alls.jdField_a_of_type_Int), Integer.valueOf(alls.jdField_b_of_type_Int), Integer.valueOf(this.jdField_e_of_type_Int), Integer.valueOf(this.jdField_d_of_type_Int) }));
      }
  ...
  private void a(List<aljf> paramList)
  {
    if (paramList.size() <= 0) {
      return;
    }
    if (this.jdField_e_of_type_Long > 0L)
    {
      ...
      aljv.f(this.jdField_a_of_type_Aljo.b(), (int)(l1 - l2));
    }
    Object localObject;
    int i;
    if (QLog.isColorLevel())
    {
      ...
      {
        ((StringBuilder)localObject).append(((aljf)paramList.get(i)).toString()).append("\n");
        i += 1;
      }
    ...
    if (a(this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int))
    {
      ...
      if (i < paramList.size())
      {
        localObject = (aljf)paramList.get(i);
        bool8 = bool6;
        bool9 = bool5;
        bool10 = bool7;
        bool11 = bool2;
        if (((aljf)localObject).jdField_a_of_type_AndroidGraphicsRect.width() > 0)
        {
          bool8 = bool6;
          bool9 = bool5;
          bool10 = bool7;
          bool11 = bool2;
          if (((aljf)localObject).jdField_a_of_type_AndroidGraphicsRect.height() > 0)
          {
            localRect = ((aljf)localObject).jdField_a_of_type_AndroidGraphicsRect;
            if (((aljf)localObject).jdField_a_of_type_Int == 2)
            {
              bool6 = true;
              bool7 = a(localRect);
              bool4 = bool6;
    ...
    for (;;)
    {
      ...
      try
      {
        if (((aljf)paramList.get(0)).jdField_a_of_type_AndroidGraphicsRect.width() <= 0) {
          break label1041;
        }
        f2 = f4;
        f1 = f3;
        if (((aljf)paramList.get(0)).jdField_a_of_type_AndroidGraphicsRect.height() <= 0) {
          break label1041;
        }
        ...
        f4 = ((aljf)paramList.get(0)).jdField_a_of_type_AndroidGraphicsRect.width() / this.jdField_c_of_type_AndroidGraphicsRect.width();
        f3 = ((aljf)paramList.get(0)).jdField_a_of_type_AndroidGraphicsRect.height() / this.jdField_c_of_type_AndroidGraphicsRect.height();
        if ((f4 >= 0.7F) || (f3 >= 0.7F)) {
          break label1029;
        }
        bool5 = true;
        ...
        paramList = new Rect(((aljf)paramList.get(0)).jdField_a_of_type_AndroidGraphicsRect);
      ...
      return;
      if (((aljf)localObject).jdField_a_of_type_Int == 1)
      {
        bool5 = true;
        bool8 = b(localRect);
        bool4 = bool6;
      ...
      bool3 = bool5;
      bool1 = bool7;
      if (((aljf)localObject).jdField_a_of_type_Int != 3) {
        break label324;
      }
      bool8 = b(localRect);
      bool4 = bool6;
  ...
  private boolean a(int paramInt1, int paramInt2)
  {
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      if ((this.jdField_a_of_type_Aljd != null) && (this.jdField_a_of_type_Int == 2) && (i >= 0)) {
        this.jdField_a_of_type_Aljd.a(i);
      }
      return bool1;
    }
  }
  ...
  private boolean a(Rect paramRect)
  {
    try
    {
      boolean bool = this.jdField_a_of_type_Aljo.a(this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, paramRect.left, paramRect.top, paramRect.width(), paramRect.height(), true);
      return bool;
    }
  ...
  private boolean b(Rect paramRect)
  {
    ...
    if (ImgProcessScan.gray_rotate_crop_sub(this.jdField_c_of_type_ArrayOfByte, arrayOfInt, this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, paramRect.left, paramRect.top, paramRect.width(), paramRect.height(), 90, 0) == 0) {
      bool = this.jdField_a_of_type_Aljx.a(this.jdField_c_of_type_ArrayOfByte, arrayOfInt[0], arrayOfInt[1], true);
    }
    return bool;
  }
  ...
  private void d()
  {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder("doRecognizeInternal ");; localStringBuilder = null)
    {
      ...
      if (a(this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int))
      {
        ...
        bool1 = this.jdField_a_of_type_Aljo.a();
        ...
        if (ImgProcessScan.gray_rotate_crop_sub(this.jdField_b_of_type_ArrayOfByte, arrayOfInt, this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, i, j, k, m, 90, 0) == 0)
        {
          ...
          boolean bool4 = this.jdField_a_of_type_Aljx.a(this.jdField_b_of_type_ArrayOfByte, i, j, false);
          long l3 = System.currentTimeMillis();
          if ((bool4) || (!this.jdField_a_of_type_Aljo.a(this.jdField_b_of_type_ArrayOfByte, i, j, false))) {
            break label468;
          }
          bool2 = true;
      ...
      for (;;)
      {
        ...
        break label289;
        label480:
        this.jdField_d_of_type_Long = this.jdField_a_of_type_Aljo.a(this.jdField_a_of_type_ArrayOfByte, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, this.jdField_d_of_type_AndroidGraphicsRect);
        this.jdField_f_of_type_Int = 0;
  ...
  {
    if (this.jdField_a_of_type_Aljp != null) {
      this.jdField_a_of_type_Aljp.a(paramLong);
    }
  }
  
  public void a(aljd paramaljd, aljp paramaljp)
  {
    this.jdField_a_of_type_Aljd = paramaljd;
    this.jdField_a_of_type_Aljp = paramaljp;
  }
  ...
  public void a(Context paramContext, AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new allb(this, this.jdField_a_of_type_AndroidOsHandlerThread.getLooper());
    this.jdField_a_of_type_Aljx = new aljx(this.jdField_a_of_type_AndroidOsHandler);
    this.jdField_a_of_type_Aljx.a(this);
    this.jdField_a_of_type_Aljo = new aljo(this.jdField_a_of_type_AndroidOsHandler, paramContext);
    this.jdField_a_of_type_Aljo.a(this);
    this.jdField_a_of_type_Long = 250L;
    if (aldn.a().jdField_a_of_type_Boolean) {
      this.jdField_a_of_type_Long = 120L;
    }
    this.jdField_c_of_type_Int = aldn.a().jdField_c_of_type_Int;
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    int i = 2;
    this.jdField_e_of_type_Long = 0L;
    if ((this.jdField_a_of_type_Aljd != null) && (this.jdField_a_of_type_Int == 2) && (!this.jdField_f_of_type_Boolean)) {
      this.jdField_a_of_type_Aljd.a(paramString1.toString(), paramString2.toString(), paramBoolean);
    }
    if (paramBoolean) {}
    for (;;)
    {
  ...
  {
    if ((this.jdField_a_of_type_Aljp != null) && (!this.jdField_f_of_type_Boolean) && (this.jdField_a_of_type_Int == 2) && (paramLong == this.jdField_d_of_type_Long))
    {
      ...
      while (i < paramList.size())
      {
        aljf localaljf1 = new aljf();
        aljf localaljf2 = new aljf();
        localaljf1.jdField_a_of_type_Int = ((aljf)paramList.get(i)).jdField_a_of_type_Int;
        localaljf2.jdField_a_of_type_Int = ((aljf)paramList.get(i)).jdField_a_of_type_Int;
        localaljf1.jdField_a_of_type_Float = ((aljf)paramList.get(i)).jdField_a_of_type_Float;
        localaljf2.jdField_a_of_type_Float = ((aljf)paramList.get(i)).jdField_a_of_type_Float;
        localaljf1.jdField_a_of_type_AndroidGraphicsRect = ((aljf)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect;
        Rect localRect = ((aljf)paramList.get(i)).jdField_a_of_type_AndroidGraphicsRect;
        if ((localRect.width() > 0) && (localRect.height() > 0)) {
          a(localRect, localaljf2.jdField_a_of_type_AndroidGraphicsRect, true);
        }
        localArrayList1.add(localaljf1);
        localArrayList2.add(localaljf2);
        i += 1;
      }
      if (this.jdField_a_of_type_Aljp != null) {
        this.jdField_a_of_type_Aljp.a(localArrayList2, paramLong);
      }
      a(localArrayList1);
    }
    ...
    {
      this.jdField_a_of_type_AndroidOsHandler.removeMessages(102);
      aljv.a((int)(System.currentTimeMillis() - paramLong), 2);
    }
  }
  ...
  {
    int i;
    if ((this.jdField_a_of_type_Aljo != null) && (this.jdField_a_of_type_Aljo.b()))
    {
      i = 1;
      if (QLog.isColorLevel()) {
        if (i == 0) {
    ...
    for (int j = 1;; j = 0)
    {
      ...
      if ((this.jdField_a_of_type_Aljd != null) && (this.jdField_a_of_type_Int == 2))
      {
        ...
        this.jdField_a_of_type_Aljd.a(paramBoolean, paramFloat);
      }
      return;
      i = 0;
      break;
  ...
  public void a(boolean paramBoolean1, String paramString, boolean paramBoolean2)
  {
    ...
    if ((this.jdField_a_of_type_Aljp != null) && (this.jdField_a_of_type_Int == 2) && (!this.jdField_f_of_type_Boolean)) {
      this.jdField_a_of_type_Aljp.a(paramBoolean1, paramString, paramBoolean2);
    }
    int i;
    if (paramBoolean1)
    {
  ...
  public boolean a(byte[] paramArrayOfByte)
  {
    if (this.jdField_a_of_type_Int == 2)
    {
      a(paramArrayOfByte, alkv.a().a(), alkv.a().b(), this.jdField_d_of_type_Boolean);
      if (aljv.a()) {
        aljv.b();
      }
    }
