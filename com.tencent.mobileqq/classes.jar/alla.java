  ...
  extends axvs
{
  ...
  public alla(QQAppInterface paramQQAppInterface, SelectCoverActivity paramSelectCoverActivity)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    {
      return;
      localObject = (axqf)paramMessage.obj;
      ...
      default: 
        return;
      case 1003: 
        if (((axqf)localObject).b == 48)
        {
          paramMessage = ((axsm)((axqf)localObject).a).a;
          if (QLog.isColorLevel()) {
            QLog.i("SelectCoverActivity", 2, "mPhotoUploadHandler.handleMessage(), static avatar upload success. photoId = " + paramMessage);
          }
          paramMessage = (ajfi)localQQAppInterface.a(2);
          if (paramMessage != null) {
            paramMessage.a(true, localQQAppInterface.getCurrentAccountUin(), 0);
          }
          azyk.a(null);
          if (((Integer)asfc.a(localQQAppInterface.getAccount(), "qq_avatar_type", Integer.valueOf(-1))).intValue() != 1) {
            asfc.a(localQQAppInterface.getAccount(), "qq_avatar_type", Integer.valueOf(1));
          }
          if (localSelectCoverActivity.jdField_d_of_type_Int != 3)
          {
            ...
            {
              paramMessage = "1";
              awqx.b(localQQAppInterface, "dc00898", "", "", "0X800711D", "0X800711D", 0, 0, String.valueOf(i), (String)localObject, str, paramMessage);
            }
          }
          else
          {
          ...
          for (;;)
          {
            ...
            if (localSelectCoverActivity.jdField_d_of_type_Int == 3)
            {
              ...
              awqx.b(localQQAppInterface, "dc00898", "", "", "0X8009DFA", "0X8009DFA", 0, 0, (String)localObject, "", "", "");
        ...
        if (((axqf)localObject).b == 36)
        {
          paramMessage = ((axsm)((axqf)localObject).a).b;
          if (QLog.isColorLevel()) {
