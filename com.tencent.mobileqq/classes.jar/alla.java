...
public final class alla
  implements Runnable
{
  public alla(String paramString1, String paramString2, Activity paramActivity, boolean paramBoolean) {}
  ...
  public void run()
  {
    if (MyAppApi.a().b())
    {
      ...
      for (localObject = "";; localObject = this.jdField_a_of_type_JavaLangString)
      {
        ...
        ThreadManager.getSubThreadHandler().post(new allb(this, localBundle));
        return;
      }
    }
