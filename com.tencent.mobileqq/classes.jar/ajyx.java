  ...
  extends ajwv
{
  ...
  public ajuv a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ajzb(this);
  ...
  public ajyx(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new ajyy(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131368135)).setOnClickListener(new ajyz(this));
    Button localButton = (Button)findViewById(2131363719);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new ajza(this));
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Ajuv = new ajuv(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Bkfv, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ajuv);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new ajzc(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new ajzd(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new ajze(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemLongClickListener(new ajzf(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Ajuv.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Ajuv.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.jdField_c_of_type_AndroidWidgetTextView.setText(anni.a(2131713856));
        ...
        {
          this.jdField_a_of_type_Ajuv.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_d_of_type_Boolean, 0);
          this.jdField_a_of_type_Ajuv.notifyDataSetChanged();
        }
        if (this.jdField_a_of_type_Ajuv.getCount() == 0) {
          a(4, null);
        }
        for (;;)
        {
      ...
      this.jdField_a_of_type_Ajuv.a(this.jdField_a_of_type_JavaUtilList, this.jdField_d_of_type_Boolean);
      if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_Ajuv.getCount() < 20))
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(anni.a(2131713858));
        this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131372927).setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
      }
    ...
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Ajuv.a((List)localObject, this.jdField_d_of_type_Boolean);
    this.jdField_a_of_type_Ajuv.notifyDataSetChanged();
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ajuv);
    this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
    this.jdField_a_of_type_JavaUtilList.clear();
