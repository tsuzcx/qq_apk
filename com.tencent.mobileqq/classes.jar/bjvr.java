...
public class bjvr
{
  ...
  private bjvr(Context paramContext)
  {
  ...
  public bjvq a()
  {
    try
    {
      int i = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 300.0F);
      int j = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 120.0F);
      LinearLayout localLinearLayout = new LinearLayout(this.jdField_a_of_type_AndroidContentContext);
      localLinearLayout.setOrientation(0);
      localLinearLayout.setPadding(DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 10.0F), DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 8.0F), DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 10.0F), DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 8.0F));
      ...
      for (localObject = new KandianTextView(this.jdField_a_of_type_AndroidContentContext);; localObject = new TextView(this.jdField_a_of_type_AndroidContentContext))
      {
        ...
        localObject = new bjvq(this.jdField_a_of_type_AndroidContentContext, localLinearLayout.getMeasuredWidth(), this.e);
        ((bjvq)localObject).d(this.jdField_b_of_type_Int);
        ((bjvq)localObject).a(this.jdField_b_of_type_AndroidGraphicsDrawableDrawable);
        ((bjvq)localObject).b(this.jdField_c_of_type_AndroidGraphicsDrawableDrawable);
        ((bjvq)localObject).e(this.jdField_c_of_type_Int);
        ((bjvq)localObject).setContentView(localLinearLayout);
        ((bjvq)localObject).a(83);
        if (!this.jdField_a_of_type_Boolean) {
          ((bjvq)localObject).setOutsideTouchable(false);
        }
        ((bjvq)localObject).b(DisplayUtil.dip2px(this.jdField_a_of_type_AndroidContentContext, 6.0F));
        bjvq.a((bjvq)localObject, this.d);
        return localObject;
      }
      return null;
    }
  ...
  public bjvr a(float paramFloat)
  {
    this.jdField_a_of_type_Float = paramFloat;
    return this;
  }
  
  public bjvr a(int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
    return this;
  }
  
  public bjvr a(Drawable paramDrawable)
  {
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = paramDrawable;
    return this;
  }
  
  public bjvr a(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    return this;
  }
  
  public bjvr a(boolean paramBoolean)
  {
    this.jdField_b_of_type_Boolean = paramBoolean;
    return this;
  }
  
  public bjvr b(int paramInt)
  {
    this.d = paramInt;
    return this;
  }
  
  public bjvr b(Drawable paramDrawable)
  {
    this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = paramDrawable;
    return this;
  }
  
  public bjvr c(int paramInt)
  {
    this.e = paramInt;
    return this;
  }
  
  public bjvr c(Drawable paramDrawable)
  {
