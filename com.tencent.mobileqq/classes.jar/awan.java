...
import com.tencent.mobileqq.intervideo.groupvideo.cschannel.ODCsChannel.1;
import com.tencent.mobileqq.intervideo.groupvideo.cschannel.ODCsChannel.4;
...
public class awan
{
  ...
  public awan(QQAppInterface paramQQAppInterface, long paramLong)
  {
    this(paramQQAppInterface, paramLong, "OnlineDating", "Group");
  }
  
  public awan(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2)
  {
  ...
  private CommProtocolProto.commRequest a(int paramInt)
  {
    ...
    localcommRequest.network.set(awar.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()));
    ...
    localcommRequest.client_release.set("8.4.5");
  ...
  private void a(int paramInt, CommProtocolProto.commResponse paramcommResponse, Bundle paramBundle, awaq paramawaq)
  {
    ...
    for (paramcommResponse = "null";; paramcommResponse = paramBundle.toString())
    {
      ...
      if (paramawaq != null)
      {
        ...
        paramawaq.a(paramInt, (byte[])localObject, paramBundle);
      }
      return;
    ...
    label287:
    ThreadManager.getUIHandler().post(new ODCsChannel.4(this, paramawaq, paramInt, (byte[])localObject, paramBundle));
  }
  ...
  private void b(int paramInt1, byte[] paramArrayOfByte, boolean paramBoolean, int paramInt2, awaq paramawaq)
  {
    ThreadManagerV2.excute(new ODCsChannel.1(this, paramInt2, paramInt1, paramArrayOfByte, paramBoolean, paramawaq), 128, null, true);
  }
  ...
  private void c(int paramInt1, byte[] paramArrayOfByte, boolean paramBoolean, int paramInt2, awaq paramawaq)
  {
    ...
    nkm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new awap(this, paramInt2, paramInt1, paramBoolean, paramawaq), localcommRequest.toByteArray(), this.jdField_a_of_type_JavaLangString + "." + localcommRequest.cmd);
  }
  
  public void a(int paramInt1, byte[] paramArrayOfByte, int paramInt2, awaq paramawaq)
  {
    paramArrayOfByte = new CommonUserProto.LoginCheckReq();
    paramArrayOfByte.group_code.set(this.jdField_b_of_type_Long);
    paramArrayOfByte.refresh.set(false);
    paramArrayOfByte.is_test.set(true);
    CommProtocolProto.commRequest localcommRequest = a(10401);
    localcommRequest.body.set(ByteStringMicro.copyFrom(paramArrayOfByte.toByteArray()));
    nkm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new awao(this, paramInt2, paramInt1, paramawaq), localcommRequest.toByteArray(), this.jdField_a_of_type_JavaLangString + "." + 10401);
  }
  
  public void a(int paramInt1, byte[] paramArrayOfByte, boolean paramBoolean, int paramInt2, awaq paramawaq)
  {
    if (this.jdField_a_of_type_AndroidOsBundle == null)
    {
      b(paramInt1, paramArrayOfByte, paramBoolean, paramInt2, paramawaq);
      return;
    }
    if ((this.jdField_a_of_type_ComTencentJungleVideohubProtoCommonUserProto$LoginCheckRsp == null) && (paramBoolean))
    {
      a(paramInt1, paramArrayOfByte, paramInt2, paramawaq);
      return;
    }
    c(paramInt1, paramArrayOfByte, paramBoolean, paramInt2, paramawaq);
  }
  
  public void a(int paramInt, byte[] paramArrayOfByte, boolean paramBoolean, awaq paramawaq)
  {
    a(paramInt, paramArrayOfByte, paramBoolean, 0, paramawaq);
  }
}
