...
public final class apsh
  implements apkh, apki, apkj, SDKInitListener
{
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private Activity jdField_a_of_type_AndroidAppActivity;
  private apkr jdField_a_of_type_Apkr;
  private apsi jdField_a_of_type_Apsi;
  ...
  public apsh(Activity paramActivity, apkr paramapkr)
  {
  ...
  private void j()
  {
    ...
    while ((this.jdField_b_of_type_Boolean) || (this.jdField_d_of_type_Boolean) || (this.jdField_a_of_type_Apsi == null)) {
      return;
    }
  ...
  private void k()
  {
    ...
    if (this.jdField_a_of_type_Apsi != null) {
      this.jdField_a_of_type_Apsi.a(k / 2);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Apsj != null) {
        this.jdField_a_of_type_Apsj.a((this.jdField_c_of_type_Int + this.jdField_d_of_type_Int) / 2);
      }
      return;
  ...
  public void a(long paramLong, apsi paramapsi, apsj paramapsj)
  {
    if (paramLong == 0L) {
      return;
    }
  ...
  public void a(apsk paramapsk)
  {
    this.jdField_a_of_type_Apsk = paramapsk;
  }
  ...
  public void a(ARCommonConfigInfo paramARCommonConfigInfo)
  {
    ...
    if (this.jdField_a_of_type_Apsk != null) {
      this.jdField_a_of_type_Apsk.a(paramARCommonConfigInfo);
    }
    this.i = true;
  }
  ...
  public void c(int paramInt)
  {
    ...
    try
    {
      this.jdField_a_of_type_Apkr.b(paramInt);
      return;
    }
  ...
  public void e()
  {
    ...
    a(this.jdField_a_of_type_Long, this.jdField_a_of_type_Apsi, this.jdField_a_of_type_Apsj);
  }
  
  public void f()
  {
    this.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_Apsi = null;
  ...
  public void g()
  {
    try
    {
      this.jdField_a_of_type_Boolean = this.jdField_a_of_type_Apkr.b();
      if (!this.jdField_a_of_type_Boolean)
      {
        this.jdField_b_of_type_Boolean = true;
        this.jdField_a_of_type_Apkr.c();
      }
      for (;;)
      {
  ...
  public void h()
  {
    this.jdField_c_of_type_Boolean = bapg.a();
  ...
  public void i()
  {
    ...
    {
      this.h = true;
      this.jdField_a_of_type_Apkr.a(1);
      this.e = apjz.a();
      if (this.e) {
        break label154;
      }
      this.g = true;
      this.jdField_a_of_type_Apkr.a(0);
  ...
  public void k_(int paramInt)
  {
    ...
    for (;;)
    {
      if ((this.e) && (this.f) && (this.jdField_a_of_type_Apsj != null)) {
        this.jdField_a_of_type_Apsj.a();
      }
      return;
      this.e = true;
      this.g = false;
