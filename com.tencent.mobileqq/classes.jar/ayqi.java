...
public class ayqi
  extends ayoh
{
  public ayqi(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    if ((j != 0) && (bbev.g(this.a.getApplicationContext())))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        new ayrn().a(paramOutputStream, paramDownloadParams, paramURLDrawableHandler);
        paramOutputStream.close();
        paramURLDrawableHandler = new File(str3);
        localFile = new File(str1);
        if (!paramURLDrawableHandler.renameTo(localFile))
        {
          bbdj.a(paramURLDrawableHandler, localFile);
          paramURLDrawableHandler.delete();
        }
        bgpr.a(this.a.waitAppRuntime(null), false, new File(str1).length());
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    for (;;)
    {
      ...
      if (5 == apue.a(paramFile.getName()))
      {
        localObject = aptw.a(this.a, paramFile.getPath());
        if (localObject != null)
        {
