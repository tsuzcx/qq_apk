...
public class ueo
  extends Handler
{
  public ueo(VisitorsActivity paramVisitorsActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      ...
      this.a.jdField_a_of_type_ComTencentWidgetXListView.springBackOverScrollHeaderView();
      this.a.jdField_b_of_type_ComTencentWidgetXListView.springBackOverScrollHeaderView();
      this.a.a(1, this.a.getString(2131434794));
      return;
    case 3: 
      if (this.a.jdField_h_of_type_Int == 0) {
        this.a.jdField_a_of_type_Ufo.notifyDataSetChanged();
      }
      for (;;)
      {
        this.a.e = SystemClock.uptimeMillis();
        return;
        this.a.jdField_b_of_type_Ufo.notifyDataSetChanged();
      }
    case 5: 
      ...
      if ((paramMessage instanceof Object[]))
      {
        ...
        this.a.jdField_a_of_type_Ufo.a(this.a.jdField_a_of_type_JavaUtilArrayList);
        if (QLog.isColorLevel()) {
          QLog.d("VisitorsActivity", 2, "setDataSet favor UI_ONINIT");
        }
        this.a.jdField_b_of_type_Ufo.a(this.a.jdField_b_of_type_JavaUtilArrayList);
        this.a.jdField_a_of_type_Ufo.notifyDataSetChanged();
        this.a.jdField_b_of_type_Ufo.notifyDataSetChanged();
      }
            ...
            if (localObject.length == 2)
            {
              ...
              if (i1 >= i2)
              {
                ...
                if (i1 <= i3)
                {
                  ...
                  {
                    paramMessage = (TextView)paramMessage.findViewById(2131364846);
                    j = m;
                    if (paramMessage != null)
                    {
