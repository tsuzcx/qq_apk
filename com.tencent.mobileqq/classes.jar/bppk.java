  ...
  extends bpoz
{
  ...
  private bppl jdField_a_of_type_Bppl;
  ...
  public bppk(Context paramContext, String paramString)
  {
  ...
  private void d()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Bppl.sendEmptyMessageDelayed(0, 40L);
      localBitmap = null;
  ...
  public Bitmap a()
  {
    ...
    ArrayList localArrayList = this.jdField_a_of_type_Bpon.a(this.jdField_a_of_type_Bpon.a());
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Bppl != null) {
      this.jdField_a_of_type_Bppl.removeCallbacksAndMessages(null);
    }
  }
  ...
  protected void b()
  {
    this.jdField_a_of_type_Bppl = new bppl(new WeakReference(this));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder = new booa(this.jdField_b_of_type_JavaLangString);
        ...
        this.k = this.jdField_a_of_type_Bpon.a("offsetX", 0L, 650L, (int)(-i1 * 0.3D), 0, new bppi());
        this.l = this.jdField_a_of_type_Bpon.a("offsetX", 100L, 650L, (int)(-i1 * 0.3D), 0, new bppi());
        this.m = this.jdField_a_of_type_Bpon.a("offsetX", 200L, 650L, (int)(-i1 * 0.3D), 0, new bppi());
        this.n = this.jdField_a_of_type_Bpon.a("alpha", 0L, 370L, 0, 255, new zfu(0.33F, 0.0F, 0.67F, 1.0F));
        this.o = this.jdField_a_of_type_Bpon.a("alpha", 100L, 370L, 0, 255, new zfu(0.33F, 0.0F, 0.67F, 1.0F));
        this.p = this.jdField_a_of_type_Bpon.a("alpha", 200L, 370L, 0, 255, new zfu(0.33F, 0.0F, 0.67F, 1.0F));
        return;
      }
  ...
  protected void c()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder != null) && (this.jdField_b_of_type_Boolean)) {
      this.jdField_a_of_type_Bppl.sendEmptyMessage(0);
    }
  }
