...
public class aqfu
  extends Handler
{
  public aqfu(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      ...
      return;
    case 3: 
      this.a.jdField_a_of_type_Aqfv.a(1, false);
      return;
    case 4: 
      i = paramMessage.arg1;
      k = paramMessage.arg2;
    ...
    for (;;)
    {
      ...
      if (k == 1)
      {
        paramMessage = (aqgp)paramMessage.obj;
        if (paramMessage.a)
        {
          i = 2;
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        {
          this.a.jdField_a_of_type_Aqfv.c();
          bool1 = true;
        }
        for (;;)
        {
          ...
          this.a.jdField_a_of_type_Aqfv.a(paramMessage, ((Boolean)localObject).booleanValue(), i, bool2, bool1);
          ...
          paramMessage = (aqgn)paramMessage.obj;
          if (this.a.b == 0)
          {
          ...
          for (;;)
          {
            ...
            this.a.jdField_c_of_type_JavaUtilHashMap.put(paramMessage.e, Integer.valueOf(i));
            break label444;
            if (this.a.jdField_a_of_type_Alqx == null) {
              break;
            }
            this.a.jdField_a_of_type_Alqx.a(this.a.app.getCurrentAccountUin(), true);
            ...
            paramMessage = this.a.getResources().getString(2131692346);
            QQToast.a(this.a, 0, paramMessage, 0).b(this.a.getTitleBarHeight());
            return;
            this.a.a();
            return;
            this.a.jdField_a_of_type_Aqfv.b();
            return;
            this.a.f();
            return;
            Face2FaceAddFriendActivity.a(this.a, (aqgn)paramMessage.obj);
            return;
            Face2FaceAddFriendActivity.a(this.a, paramMessage.arg1);
            return;
            this.a.a((aqgk)paramMessage.obj);
            return;
            paramMessage = this.a.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
            while (paramMessage.hasNext())
            {
              localObject = (aqgn)paramMessage.next();
              if ((((aqgn)localObject).a == 1) && (Face2FaceAddFriendActivity.a(this.a, ((aqgn)localObject).e))) {
                Face2FaceAddFriendActivity.a(this.a, ((aqgn)localObject).a);
              } else if ((((aqgn)localObject).a == 2) && (this.a.a(((aqgn)localObject).e))) {
                Face2FaceAddFriendActivity.a(this.a, ((aqgn)localObject).a);
              }
            }
            long l = this.a.o;
            paramMessage = new aqgo(l + 2396794490L + "", "Member " + this.a.o, 1, 1, "");
            localObject = this.a;
            ...
            return;
            if (!(paramMessage.obj instanceof aqgo)) {
              break;
            }
            paramMessage = (aqgo)paramMessage.obj;
            this.a.a(paramMessage);
            return;
            if (!(paramMessage.obj instanceof aqgo)) {
              break;
            }
            this.a.jdField_a_of_type_JavaUtilArrayList.add((aqgo)paramMessage.obj);
            return;
            if (!(paramMessage.obj instanceof aqgo)) {
              break;
            }
            Face2FaceAddFriendActivity.a(this.a).a((aqgo)paramMessage.obj);
            return;
