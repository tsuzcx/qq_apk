...
public class ackk
  extends MqqHandler
{
  public ackk(ChatSettingActivity paramChatSettingActivity) {}
        ...
        do
        {
          do
          {
            ...
            if ((ChatSettingActivity.a(this.a) != 1001) && (ChatSettingActivity.a(this.a) != 10002)) {
              ...
              {
                paramMessage = (atvt)this.a.app.getManager(16);
            ...
            for (;;)
            {
              ...
              return;
              paramMessage = bdbt.e(this.a.app, ChatSettingActivity.c(this.a));
              ...
              bool1 = false;
              break label308;
              paramMessage = (aloz)this.a.app.getManager(51);
              if (paramMessage != null)
              {
