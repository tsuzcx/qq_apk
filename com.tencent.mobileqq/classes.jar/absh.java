...
public class absh
{
  ...
  private absk a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (!bcfn.b())
    {
      abrl.a("GdtAidHelper", "only arm support taid");
      return new absk("", "", -2147483647, 0L, null);
    }
    boolean bool = false;
    abrl.a("GdtAidHelper", "getAidTicket start , businessId -> " + paramString + ", useCache -> " + paramBoolean1 + ", needVerifyBusinessId -> " + paramBoolean2 + "， TuringVersion : " + TuringFdService.getVersionInfo());
    if (paramBoolean2) {
      bool = a(paramString);
    }
    paramString = BaseApplicationImpl.getContext().getApplicationContext();
    if (!this.jdField_a_of_type_Boolean) {
      abrl.a("GdtAidHelper", "getAidTicket init TuringSDK");
    }
    int j;
    long l;
    for (;;)
    {
      ...
      catch (Throwable paramString)
      {
        try
        {
          ...
          bcef.b(null, "dc00898", "", "", "0X800A5B3", "0X800A5B3", 0, 0, "", "", "", "");
          str1 = paramString.getAIDTicket();
          str2 = paramString.getTAIDTicket();
          abrl.a("GdtAidHelper", "getAidTicket aid ticket ->" + str1 + ", taidTicket -> " + str2);
          return new absk(paramString.getAIDTicket(), paramString.getTAIDTicket(), 0, l, null);
        }
        catch (Throwable paramString)
        {
          QLog.e("GdtAidHelper", 1, paramString, new Object[] { "Turing get aid crash" + TuringFdService.getVersionInfo() });
          return new absk("", "", -2147483645, 0L, paramString, null);
        }
        paramString = paramString;
        QLog.e("GdtAidHelper", 1, paramString, new Object[] { "Turing init crash fail" });
        return new absk("", "", -2147483646, 0L, paramString, null);
      }
      continue;
      label361:
      i = 0;
    ...
    abrl.a("GdtAidHelper", "getAidTicket business id not verify, error code return only : error code-> " + i);
    return new absk("", "", i, l, null);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        catch (IOException localIOException)
        {
          ...
          bcdn.a("GdtAidHelper", "business id verify fail, please check the business id");
          return bool;
