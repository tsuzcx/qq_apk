  ...
  extends aksv
{
  ...
  public aksz(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public static boolean a(ProxyManager paramProxyManager, String paramString)
  {
    ...
    {
      aktd localaktd = (aktd)paramProxyManager.next();
      if ((String.valueOf(0).equals(localaktd.jdField_a_of_type_JavaLangString)) && (localaktd.jdField_a_of_type_Int == 0) && (localaktd.jdField_b_of_type_JavaLangString.equals(paramString)) && ((localaktd.jdField_b_of_type_Int == 1) || (localaktd.jdField_b_of_type_Int == 2) || (localaktd.jdField_b_of_type_Int == 0))) {
        return true;
      }
    }
    return false;
  ...
  private long c(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 142	aksz:a	()V
    //   6: aload_1
    //   7: aload_0
    //   8: getfield 144	aksz:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    ...
    //   19: aload_0
    //   20: getfield 144	aksz:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   23: aload_1
    ...
    //   27: astore 4
    //   29: aload_0
    //   30: invokespecial 175	aksz:f	()V
    //   33: aload_0
    //   34: getfield 29	aksz:b	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   37: ifnull +17 -> 54
    //   40: aload 4
    //   42: ifnonnull +21 -> 63
    //   45: aload_0
    //   46: getfield 29	aksz:b	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   49: aload_1
    ...
    //   62: lreturn
    //   63: aload_0
    //   64: getfield 29	aksz:b	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   67: aload 4
  ...
  private void e(long paramLong)
  {
    ...
    localObject = apue.a(localDataLineMsgRecord);
    ...
    if (!localDataLineMsgRecord.isSend()) {
      ((FileManagerEntity)localObject).srvTime = (awzw.a() * 1000L);
    }
  ...
  public DataLineMsgRecord a()
  {
    ...
    //   3: invokevirtual 142	aksz:a	()V
    //   6: aload_0
    //   7: getfield 144	aksz:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   10: astore_1
    //   11: aload_1
    //   12: ifnonnull +9 -> 21
    //   15: aconst_null
    ...
    //   20: areturn
    //   21: aload_0
    //   22: getfield 144	aksz:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    //   25: aload_0
    //   26: getfield 144	aksz:jdField_a_of_type_ComTencentMobileqqDataDataLineMsgSetList	Lcom/tencent/mobileqq/data/DataLineMsgSetList;
    ...
    for (;;)
    {
      try
      {
        ...
        if (a(this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager, this.jdField_a_of_type_JavaLangString)) {
          this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(localaukn);
        }
        ThreadManager.post(new DataLineMsgProxy.1(this, localaukn, (String)localObject1), 5, null, true);
        Object localObject3 = localaukn.a(DataLineMsgRecord.class, a(-1L, 15), null);
        localObject1 = localObject3;
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          if ((str != null) && (str.contains("/Tencent/QQfile_recv/"))) {
            ((DataLineMsgRecord)localObject3).path = bbuv.a(str);
          }
          str = ((DataLineMsgRecord)localObject3).thumbPath;
          if ((str != null) && (str.contains("/Tencent/QQfile_recv/"))) {
            ((DataLineMsgRecord)localObject3).thumbPath = bbuv.a(str);
          }
  ...
  public void a(int paramInt, akta paramakta)
  {
    long l2 = 0L;
    long l1 = l2;
    if (this.b != null)
    ...
    ThreadManager.post(new DataLineMsgProxy.13(this, l1, paramInt, paramakta), 8, null, true);
  }
  ...
  public void a(aukm paramaukm, akte paramakte)
  {
    ...
    if (Thread.currentThread() == localLooper.getThread())
    {
      paramaukm = ((DataLineMsgRecord)paramaukm).clone();
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.a(String.valueOf(0), 0, this.jdField_a_of_type_JavaLangString, paramaukm, 0, paramakte);
      return;
    }
    new Handler(localLooper).post(new DataLineMsgProxy.2(this, paramaukm, paramakte, localgn));
    localgn.a(-1L);
  }
  ...
  public void a(String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString, akte paramakte)
  {
    ...
    new Handler(localLooper).post(new DataLineMsgProxy.3(this, paramString1, paramContentValues, paramString2, paramArrayOfString, paramakte));
  }
  ...
  public void a(String paramString1, String paramString2, String[] paramArrayOfString, akte paramakte)
  {
    ...
    new Handler(localLooper).post(new DataLineMsgProxy.4(this, paramString1, paramString2, paramArrayOfString, paramakte));
  }
