...
public class mjg
{
  ...
  {
    int i = aciy.a(paramFloat, paramContext.getResources());
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            {
              return localObject2;
              Object localObject3 = ((ajjj)paramQQAppInterface.getManager(51)).b(paramString);
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      if ((k > 0) || (j > 0) || (i > 0))
      {
        paramString = str;
        if (k > 0) {
          paramString = str + k + ajjy.a(2131650072);
        }
        str = paramString;
        if (j > 0) {
          str = paramString + j + ajjy.a(2131650071);
        }
        paramString = str;
        if (i > 0) {
          paramString = str + i + ajjy.a(2131650070);
        }
        return paramString;
        if (arrayOfString.length == 2)
        {
  ...
  public static void a()
  {
    ...
    baig.a(BaseApplicationImpl.getApplication().getSharedPreferences("UITools", 4).edit().putBoolean("has_show_svip_dialog", false));
  }
  ...
  public static void a(int paramInt)
  {
    ...
    for (;;)
    {
      baig.a(BaseApplicationImpl.getApplication().getSharedPreferences("UITools", 4).edit().putInt(str, 0));
      return;
  ...
  public static void a(Activity paramActivity)
  {
    ...
    Intent localIntent;
    if (lor.a(paramActivity, "miui.intent.action.APP_PERM_EDITOR"))
    {
    ...
    for (;;)
    {
      ...
      if (!bool1)
      {
        i = j;
        bool2 = bool1;
        if (lor.a(paramActivity, "com.meizu.safe.security.SHOW_APPSEC"))
        {
      ...
      if (!bool2)
      {
        j = i;
        bool1 = bool2;
        if (lor.a(paramActivity, "huawei.intent.action.NOTIFICATIONMANAGER"))
        {
          i = 3;
      ...
      if ((!bool2) && (lor.a(paramActivity, "android.settings.action.MANAGE_OVERLAY_PERMISSION")))
      {
        i = 5;
  ...
  public static void a(Context paramContext)
  {
    ...
    {
      paramContext = baig.a(paramContext);
  ...
  public static void a(View paramView, String paramString, int paramInt)
  {
    if (jdField_a_of_type_Boolean)
    {
      ...
      if (paramInt == 2) {
        str = paramString.replace(paramView.getResources().getString(2131629998), ajjy.a(2131650073));
      }
      if (QLog.isColorLevel()) {
  ...
  {
    return (lor.a(paramActivity, "miui.intent.action.APP_PERM_EDITOR")) || (lor.a(paramActivity, "com.meizu.safe.security.SHOW_APPSEC")) || (lor.a(paramActivity, "huawei.intent.action.NOTIFICATIONMANAGER")) || (lor.a(paramActivity, "android.settings.action.MANAGE_OVERLAY_PERMISSION"));
  }
