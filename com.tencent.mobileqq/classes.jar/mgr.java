  ...
  extends BaseAdapter
{
  ...
  public ArrayList<mhr> a;
  mgx jdField_a_of_type_Mgx;
  mgy jdField_a_of_type_Mgy;
  private mhp jdField_a_of_type_Mhp = new mgv(this);
  private mhq jdField_a_of_type_Mhq = new mgw(this);
  ...
  public mgr(AppInterface paramAppInterface, Context paramContext, ArrayList<mhr> paramArrayList, HorizontalListView paramHorizontalListView)
  {
    this(paramAppInterface, paramContext, paramArrayList, paramHorizontalListView, 6.25F);
  }
  
  public mgr(AppInterface paramAppInterface, Context paramContext, ArrayList<mhr> paramArrayList, HorizontalListView paramHorizontalListView, float paramFloat)
  {
    ...
    if (this.jdField_a_of_type_Float < 6.0F) {
      jdField_c_of_type_Int = this.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131297603);
    }
    if (QLog.isDevelopLevel()) {
      QLog.i("QAVPtvTemplateAdapter", 4, "init, w[" + jdField_a_of_type_Int + "], h[" + jdField_c_of_type_Int + "], half[" + jdField_b_of_type_Int + "]");
    }
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.addOnLayoutChangeListener(new mgs(this));
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setOnScrollStateChangedListener(new mgt(this));
  ...
  public mhr a()
  {
    ...
    return (mhr)this.jdField_a_of_type_JavaUtilArrayList.get(this.e);
  }
  
  public mhr a(int paramInt)
  {
    if ((paramInt < 0) || (paramInt >= this.jdField_a_of_type_JavaUtilArrayList.size())) {
      return null;
    }
    return (mhr)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
  }
  ...
  protected void a(long paramLong, int paramInt)
  {
    ...
    {
      return;
      localmhr = (mhr)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
      if ((TextUtils.isEmpty(localmhr.jdField_a_of_type_JavaLangString)) || (localmhr.jdField_a_of_type_JavaLangString.equals("0")))
      {
        a(paramLong, localmhr);
        return;
      }
      if (localmhr.jdField_a_of_type_Boolean)
      {
        a(paramLong, localmhr);
        return;
      }
    } while ((localmhr.jdField_b_of_type_Boolean) || (TextUtils.isEmpty(localmhr.jdField_a_of_type_JavaLangString)));
    if (this.jdField_a_of_type_Mgy != null)
    {
      this.jdField_a_of_type_Mgy.startDownloadTemplate(this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramLong, localmhr, this.jdField_a_of_type_Mhq);
      localmhr.jdField_b_of_type_Boolean = true;
      return;
    }
  ...
  public void a(long paramLong, mhr parammhr)
  {
    ...
    while ((!TextUtils.isEmpty(parammhr.jdField_a_of_type_JavaLangString)) && (!parammhr.jdField_a_of_type_JavaLangString.equals("0")) && (!parammhr.jdField_a_of_type_Boolean)) {
      return;
    }
    this.jdField_a_of_type_Mgx.a(paramLong, parammhr);
  }
  
  void a(View paramView, mhr parammhr, int paramInt)
  {
    if (paramView == null) {}
    do
    {
      return;
      paramView = paramView.findViewById(2131373288);
    } while ((paramView == null) || (parammhr == null));
    paramView.setContentDescription(parammhr.d);
    ViewCompat.setAccessibilityDelegate(paramView, new mgu(this, paramInt));
  }
  ...
  public void a(ArrayList<mhr> paramArrayList)
  {
  ...
  public void a(mgx parammgx)
  {
    this.jdField_a_of_type_Mgx = parammgx;
  }
  
  public void a(mgy parammgy)
  {
  ...
  public void b(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      label134:
      label145:
      if ((localmhr1 == null) && (paramInt == 101))
      {
        ...
        if ((j < k) && (j < m))
        {
          localmhr2 = (mhr)this.jdField_a_of_type_JavaUtilArrayList.get(j);
          if ((localmhr2 != null) && (localmhr2.jdField_a_of_type_JavaLangString.equals(paramString)))
          {
            i = j;
            localmhr1 = localmhr2;
            if (localmhr1 != null) {
      ...
      for (;;)
      {
        if (localmhr1 != null)
        {
          if (QLog.isColorLevel()) {
            QLog.i("PtvTemplateManager", 2, String.format("onProgressUpdate, index[%s], [%s][%s], progress[%s]", new Object[] { Integer.valueOf(i), localmhr1.jdField_a_of_type_JavaLangString, localmhr1.c, Integer.valueOf(paramInt) }));
          }
          if (paramInt != -1) {
            break label364;
          }
          localmhr1.jdField_b_of_type_Boolean = false;
        }
        for (;;)
        {
          if (localObject != null) {
          ...
          return;
          localmhr1 = (mhr)this.jdField_a_of_type_JavaUtilArrayList.get(i);
          if ((localmhr1 == null) || (!localmhr1.jdField_a_of_type_JavaLangString.equals(paramString))) {
            break;
          }
          ...
          {
            localmhr1.jdField_b_of_type_Boolean = false;
            localmhr1.jdField_a_of_type_Boolean = true;
          }
          else
          {
            i = paramInt;
            ...
            localmhr1.jdField_b_of_type_Boolean = true;
            paramInt = i;
          }
        }
        label407:
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      return localObject1;
      if (!"-1".equals(localmhr.jdField_a_of_type_JavaLangString)) {
        break;
      }
      ...
      {
        localObject1 = localObject2;
        if (paramView.getId() == Integer.valueOf(localmhr.jdField_a_of_type_JavaLangString).intValue()) {
          localObject1 = paramView;
        }
      }
      ...
      if (localObject2 == null)
      {
        ...
        ((View)localObject1).setId(Integer.valueOf(localmhr.jdField_a_of_type_JavaLangString).intValue());
    ...
    if (!(paramView instanceof QavListItemBase)) {
      if (localmhr.jdField_a_of_type_Int == 2)
      {
    ...
    for (;;)
    {
      ((QavListItemBase)localObject1).a(paramInt, bool, this.jdField_b_of_type_Boolean, localmhr, this.jdField_a_of_type_Mhp);
      a((View)localObject1, localmhr, paramInt);
      break;
      ...
      if (this.jdField_a_of_type_Float < 6.0F)
      {
        localObject2 = ((QavPtvTemplateItemView)localObject1).findViewById(2131373454);
