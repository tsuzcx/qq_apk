  ...
  implements syk, syp
{
  ...
  private tbe jdField_a_of_type_Tbe = new tbe();
  ...
  private void a(Container paramContainer, RecommendAdData paramRecommendAdData)
  {
    ...
    {
      return;
      if (nxw.a(BaseApplicationImpl.getContext(), paramRecommendAdData.p)) {
      ...
      for (;;)
      {
        ...
        paramContainer.getComLayoutParams().mLayoutMarginLeft = afur.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        return;
  ...
  public syj a(Context paramContext, BaseData paramBaseData, ViewGroup paramViewGroup)
  {
    ...
    return new szg(this, paramViewGroup, localProteusItemData);
  }
