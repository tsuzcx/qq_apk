...
class rvr
  implements atqq
{
  rvr(rvq paramrvq, MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface, ajmm paramajmm, boolean paramBoolean) {}
  ...
  public void b(atqr paramatqr)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForStructing))
        {
          ...
          localObject1 = awbg.a(localMessageForStructing);
          if (localObject1 == null) {
            break label283;
          }
          localObject2 = ((im_msg_body.RichText)localObject1).elems.get();
          if (QLog.isColorLevel()) {
            QLog.d("ShareStructLongMessageManager", 2, "current uid is" + paramatqr.c);
          }
          ...
          {
            ((im_msg_body.Elem)localObject3).rich_msg.bytes_msg_resid.set(ByteStringMicro.copyFrom(paramatqr.c.getBytes()));
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("ShareStructLongMessageManager", 2, "upload  msg pack failed, catch exception", paramatqr);
        }
        this.jdField_a_of_type_Rvq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
      }
    ...
    {
      label283:
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, this.jdField_a_of_type_Ajmm, this.jdField_a_of_type_Boolean);
      return;
      label306:
      ...
      if ((localObject1 != null) && (rvq.b(localMessageForStructing.structingMsg)))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          {
            ((im_msg_body.Elem)localObject2).rich_msg.bytes_msg_resid.set(ByteStringMicro.copyFrom(paramatqr.c.getBytes()));
    ...
    label541:
    if (QLog.isColorLevel()) {
      QLog.d("ShareStructLongMessageManager", 2, "upload  msg pack failed, result.errStr=" + paramatqr.b + ",result.errStr=" + paramatqr.jdField_a_of_type_JavaLangString);
    }
    this.jdField_a_of_type_Rvq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
  }
}
