...
public class bjcm
{
  ...
  public static void a(Bundle paramBundle, bjcn parambjcn)
  {
    ArrayList localArrayList = new ArrayList();
    for (Object localObject = parambjcn.getClass(); localObject != null; localObject = ((Class)localObject).getSuperclass()) {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (str2.equals("String")) {
            ((Field)localObject).set(parambjcn, str3);
          }
        }
