...
public class bjcm
  implements bdza, bdzj
{
  private static bjcm jdField_a_of_type_Bjcm;
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  public bdzb a;
  private bjss jdField_a_of_type_Bjss;
  private String jdField_a_of_type_JavaLangString = mwk.a(BaseApplicationImpl.getContext());
  ...
  public static bjcm a()
  {
    if (jdField_a_of_type_Bjcm == null) {}
    try
    {
      if (jdField_a_of_type_Bjcm == null) {
        jdField_a_of_type_Bjcm = new bjcm();
      }
      return jdField_a_of_type_Bjcm;
    }
    finally {}
  }
  ...
  public void a(int paramInt)
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      this.jdField_a_of_type_JavaLangString = mwk.a(BaseApplicationImpl.getContext());
      if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
      {
        QIPCClientHelper.getInstance().getClient().callServer("QzoneIPCModule", "startDownloadVoicechangeSo", null);
        QQToast.a(BaseApplicationImpl.getContext(), alpo.a(2131713660), 1);
      }
    }
    while (this.jdField_a_of_type_Bdzb == null) {
      return;
    }
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Bdzb.f = paramInt;
    bdze.b(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Bdzb, this.jdField_a_of_type_JavaLangString, this);
  }
  ...
  public void a(Intent paramIntent, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_Bdzb = new bdzb(this.jdField_b_of_type_JavaLangString, i, j, k, 0);
      switch (paramInt)
      {
      default: 
        return;
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    try
    {
      ...
      this.jdField_a_of_type_Bjss.a(this.c, localStringBuilder.toString());
      return;
    }
  ...
  public void a(String paramString, int paramInt, bjss parambjss)
  {
  ...
  public void a(String paramString, bjss parambjss)
  {
  ...
  public void b(String paramString, int paramInt, bjss parambjss)
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      this.jdField_a_of_type_JavaLangString = mwk.a(BaseApplicationImpl.getContext());
      ...
      {
        QIPCClientHelper.getInstance().getClient().callServer("QzoneIPCModule", "startDownloadVoicechangeSo", null);
        QQToast.a(BaseApplicationImpl.getContext(), alpo.a(2131713661), 1);
      }
      return;
    }
    QZLog.d("RecordAndChangeVoiceService", 2, "getMoodVoiceData callback" + paramString + " voiceID " + paramInt);
    this.c = paramString;
    this.jdField_a_of_type_Bjss = parambjss;
    bdze.a(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Bdzb, this.jdField_a_of_type_JavaLangString, this);
    bdze.a(this.jdField_b_of_type_JavaLangString, this);
  }
  ...
  public void e()
  {
    ...
    this.c = null;
    this.jdField_a_of_type_Bdzb = null;
    this.jdField_a_of_type_Long = -1L;
    this.jdField_b_of_type_Long = -1L;
    this.jdField_a_of_type_Int = -1;
    this.jdField_a_of_type_Bjss = null;
  }
}
