  ...
  extends Animation
{
  ...
  private bjcn jdField_a_of_type_Bjcn;
  private final boolean jdField_a_of_type_Boolean;
  private final float b;
  private final float c;
  
  public bjcm(float paramFloat1, float paramFloat2, boolean paramBoolean, int paramInt)
  {
  ...
  public void a(bjcn parambjcn)
  {
    this.jdField_a_of_type_Bjcn = parambjcn;
  }
  
  protected void applyTransformation(float paramFloat, Transformation paramTransformation)
  {
    int i = 1;
    if (this.jdField_a_of_type_Bjcn != null) {
      this.jdField_a_of_type_Bjcn.a(paramFloat);
    }
    float f1;
    float f2;
