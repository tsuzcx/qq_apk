...
public class prt
{
  public static boolean a(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        localObject = ((pks)localObject).a().b();
  ...
  public static boolean a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    if (("2".equals(str1)) && (!TextUtils.isEmpty(str2))) {
      if (prw.a(paramContext, paramString))
      {
  ...
  private static boolean b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (i < localList.size())
      {
        localrcp = (rcp)localList.get(i);
        j = 0;
      }
      while (j < localrcp.a.size())
      {
        if (paramInt == ((TabChannelCoverInfo)localrcp.a.get(j)).mChannelCoverId)
        {
          bool1 = true;
          return bool1;
        }
  ...
  private static boolean c(int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        localObject = (rcp)((List)localObject).get(0);
        i = 0;
      }
    }
    for (;;)
    {
      bool1 = bool2;
      if (i < ((rcp)localObject).a.size())
      {
        if (paramInt == ((TabChannelCoverInfo)((rcp)localObject).a.get(i)).mChannelCoverId) {
          bool1 = true;
        }
      }
      else {
