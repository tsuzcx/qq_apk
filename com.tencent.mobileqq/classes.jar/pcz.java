...
public class pcz
{
  ...
  public static long a(poz parampoz)
  {
    if (!a())
    {
    ...
    QLog.d("FeedsPreloadHelper", 1, new Object[] { "updateRequestVersionAndGet, channelID = ", Integer.valueOf(parampoz.b), ", beginSeq = ", Long.valueOf(parampoz.a) });
    if ((parampoz.b == 0) && (parampoz.a == -1L))
    {
  ...
  public static void a()
  {
    ...
    bhvh.a("sp_key_readinjoy_feeds_preload_last_enter_kd_millisecond", Long.valueOf(l));
  }
  ...
  public static boolean a()
  {
    ...
    if (!((Boolean)bhvh.a("sp_key_readinjoy_feeds_preload_switch", Boolean.valueOf(false))).booleanValue())
    {
  ...
  public static boolean a(poz parampoz)
  {
    if ((parampoz != null) && (a()) && (parampoz.b == 0) && (parampoz.a == -1L))
    {
  ...
  public static boolean a(boolean paramBoolean)
  {
    ...
    long l1 = ((Long)bhvh.a("sp_key_readinjoy_feeds_preload_last_enter_kd_millisecond", Long.valueOf(-1L))).longValue();
    if (l1 == -1L)
    {
    ...
    long l3 = ((Long)bhvh.a("sp_key_readinjoy_feeds_preload_last_enter_kd_day", Long.valueOf(90L))).longValue();
    ...
    l2 = ((Long)bhvh.a("sp_key_readinjoy_feeds_preload_last_preload_millisecond", Long.valueOf(-1L))).longValue();
    if (l2 != -1L)
    {
      l3 = System.currentTimeMillis();
      l1 = ((Long)bhvh.a("sp_key_readinjoy_feeds_preload_interval", Long.valueOf(30L))).longValue();
      l2 = (l3 - l2) / 1000L / 60L;
  ...
  public static void b()
  {
    ...
    bhvh.a("sp_key_readinjoy_feeds_preload_last_preload_millisecond", Long.valueOf(l));
  }
  ...
  public static boolean b(poz parampoz)
  {
    if (parampoz != null)
    {
      if ((parampoz.i & 0x100) != 0) {}
