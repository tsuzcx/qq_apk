...
public class vkd
  extends MqqHandler
{
  public vkd(AIOGalleryScene paramAIOGalleryScene) {}
        ...
        do
        {
          do
          {
            do
            {
              ...
              {
                return;
                QQToast.a(AIOGalleryScene.d(this.a), 2131437344, 0).a();
                return;
                String str = AIOGalleryScene.e(this.a).getString(2131437345);
            ...
            paramMessage = DialogUtil.b(AIOGalleryScene.h(this.a), 232, AIOGalleryScene.i(this.a).getResources().getString(2131437372), AIOGalleryScene.j(this.a).getResources().getString(2131437373), 2131437374, 2131434570, new vke(this, paramMessage), new vkf(this));
            try
            {
              paramMessage.show();
              return;
