  ...
  implements alzn<String>
{
  ...
  public static nfj a()
  {
    nfj localnfj = new nfj();
    localnfj.jdField_a_of_type_JavaLangString = rsp.jdField_d_of_type_JavaLangString;
    localnfj.jdField_b_of_type_JavaLangString = rsp.jdField_e_of_type_JavaLangString;
    localnfj.jdField_b_of_type_Boolean = rsp.jdField_a_of_type_Boolean;
    localnfj.jdField_c_of_type_Boolean = rsp.p;
    localnfj.jdField_a_of_type_Boolean = rsp.jdField_b_of_type_Boolean;
    localnfj.jdField_d_of_type_Boolean = rsp.jdField_e_of_type_Boolean;
    localnfj.jdField_e_of_type_Boolean = rsp.jdField_f_of_type_Boolean;
    localnfj.jdField_f_of_type_Boolean = rsp.jdField_g_of_type_Boolean;
    localnfj.jdField_g_of_type_Boolean = rsp.jdField_h_of_type_Boolean;
    localnfj.jdField_h_of_type_Boolean = rsp.jdField_i_of_type_Boolean;
    localnfj.jdField_i_of_type_Boolean = rsp.l;
    localnfj.j = rsp.j;
    localnfj.jdField_c_of_type_JavaLangString = rsp.jdField_f_of_type_JavaLangString;
    localnfj.jdField_a_of_type_Long = rsp.jdField_a_of_type_Long;
    localnfj.k = rsp.m;
    localnfj.jdField_a_of_type_Int = rsp.jdField_b_of_type_Int;
    localnfj.jdField_d_of_type_JavaLangString = rsp.jdField_i_of_type_JavaLangString;
    localnfj.l = rsp.n;
    localnfj.m = rsp.jdField_c_of_type_Boolean;
    localnfj.n = rsp.o;
    localnfj.jdField_a_of_type_JavaUtilArrayList = rsp.jdField_a_of_type_JavaUtilArrayList;
    localnfj.jdField_b_of_type_Int = rsp.jdField_c_of_type_Int;
    localnfj.jdField_c_of_type_Int = rsp.jdField_d_of_type_Int;
    localnfj.jdField_d_of_type_Int = rsp.jdField_e_of_type_Int;
    localnfj.o = rsp.k;
    Object localObject = rsp.jdField_g_of_type_JavaLangString;
    localnfj.jdField_e_of_type_JavaLangString = ((String)localObject);
    localnfj.jdField_f_of_type_JavaLangString = rsp.jdField_h_of_type_JavaLangString;
    try
    {
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if (((JSONObject)localObject).has("useNewLogic")) {
          b(localnfj, (JSONObject)localObject);
        }
        if (((JSONObject)localObject).has("releaseServiceMinMem")) {
          a(localnfj, (JSONObject)localObject);
        }
      }
      return localnfj;
    }
  ...
  private nfj a(nfj paramnfj, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString.has("service_folder_name")) {
          this.jdField_a_of_type_JavaLangString = paramnfj.jdField_a_of_type_JavaLangString;
        }
        if (paramString.has("service_folder_icon")) {
          this.jdField_b_of_type_JavaLangString = paramnfj.jdField_b_of_type_JavaLangString;
        }
        if (paramString.has("service_folder_redspots")) {
          this.jdField_a_of_type_Boolean = paramnfj.jdField_a_of_type_Boolean;
        }
        if (paramString.has("service_folder_delete")) {
          this.jdField_b_of_type_Boolean = paramnfj.jdField_b_of_type_Boolean;
        }
        if (paramString.has("ServiceFolder_RedClean_After_Enter")) {
          this.jdField_c_of_type_Boolean = paramnfj.jdField_c_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload")) {
          this.jdField_d_of_type_Boolean = paramnfj.jdField_d_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_wifi")) {
          this.jdField_e_of_type_Boolean = paramnfj.jdField_e_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_4G")) {
          this.jdField_f_of_type_Boolean = paramnfj.jdField_f_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_3G")) {
          this.jdField_g_of_type_Boolean = paramnfj.jdField_g_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_2G")) {
          this.jdField_h_of_type_Boolean = paramnfj.jdField_h_of_type_Boolean;
        }
        if (paramString.has("pub_account_bottom_bar")) {
          this.jdField_i_of_type_Boolean = paramnfj.jdField_i_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_image_preload")) {
          this.j = paramnfj.j;
        }
        if (paramString.has("kandian_feeds_fling_LToR_host")) {
          this.jdField_c_of_type_JavaLangString = paramnfj.jdField_c_of_type_JavaLangString;
        }
        if (paramString.has("kandian_ad_background_showtime")) {
          this.jdField_a_of_type_Long = paramnfj.jdField_a_of_type_Long;
        }
        ...
        {
          this.jdField_a_of_type_Int = paramnfj.jdField_a_of_type_Int;
          this.jdField_d_of_type_JavaLangString = paramnfj.jdField_d_of_type_JavaLangString;
        }
        ...
        if ((i1 != 0) && (paramString.has("host_white_list"))) {
          this.jdField_a_of_type_JavaUtilArrayList = paramnfj.jdField_a_of_type_JavaUtilArrayList;
        }
        if (paramString.has("album_predown_enable")) {
          this.jdField_b_of_type_Int = paramnfj.jdField_b_of_type_Int;
        }
        if (paramString.has("album_predown_photo_rule")) {
          this.jdField_c_of_type_Int = paramnfj.jdField_c_of_type_Int;
        }
        if (paramString.has("album_predown_slide_photocounts")) {
          this.jdField_d_of_type_Int = paramnfj.jdField_d_of_type_Int;
        }
        ...
        {
          this.jdField_e_of_type_JavaLangString = paramnfj.jdField_e_of_type_JavaLangString;
          this.p = paramnfj.p;
          this.jdField_e_of_type_Int = paramnfj.jdField_e_of_type_Int;
          this.jdField_f_of_type_Int = paramnfj.jdField_f_of_type_Int;
          this.jdField_g_of_type_Int = paramnfj.jdField_g_of_type_Int;
          this.jdField_h_of_type_Int = paramnfj.jdField_h_of_type_Int;
        }
        if (paramString.has("releaseServiceMinMem"))
        {
          this.jdField_f_of_type_JavaLangString = paramnfj.jdField_f_of_type_JavaLangString;
          this.jdField_i_of_type_Int = paramnfj.jdField_i_of_type_Int;
          return this;
        }
      }
      catch (JSONException paramnfj)
      {
        paramnfj.printStackTrace();
      }
    }
    return this;
  }
  
  public static nfj a(alzs[] paramArrayOfalzs)
  {
    Object localObject1 = new nfj();
    ...
    if (paramArrayOfalzs != null)
    {
      ...
      if (paramArrayOfalzs.length > 0)
      {
        ...
        for (;;)
        {
          if (i1 >= paramArrayOfalzs.length) {
            break label94;
          }
          str = paramArrayOfalzs[i1].jdField_a_of_type_JavaLangString;
          try
          {
            localObject2 = ((nfj)localObject1).a((nfj)amaf.a(str, nfj.class), str);
  ...
  private static void a(nfj paramnfj, JSONObject paramJSONObject)
  {
    paramnfj.jdField_i_of_type_Int = paramJSONObject.optInt("releaseServiceMinMem", 80);
  }
  ...
  private static void b(nfj paramnfj, JSONObject paramJSONObject)
  {
    paramnfj.p = paramJSONObject.optBoolean("useNewLogic", false);
    paramnfj.jdField_e_of_type_Int = paramJSONObject.optInt("minTotalMem", 1024);
    paramnfj.jdField_f_of_type_Int = paramJSONObject.optInt("minAvailableMem", 100);
    paramnfj.jdField_g_of_type_Int = paramJSONObject.optInt("minCpuNum", 2);
    paramnfj.jdField_h_of_type_Int = paramJSONObject.optInt("minCpuFreq", 1000);
  }
  ...
  public void b()
  {
    rsp.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    rsp.jdField_e_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
    rsp.jdField_a_of_type_Boolean = this.jdField_b_of_type_Boolean;
    rsp.p = this.jdField_c_of_type_Boolean;
    rsp.jdField_b_of_type_Boolean = this.jdField_a_of_type_Boolean;
    rsp.jdField_e_of_type_Boolean = this.jdField_d_of_type_Boolean;
    rsp.jdField_f_of_type_Boolean = this.jdField_e_of_type_Boolean;
    rsp.jdField_g_of_type_Boolean = this.jdField_f_of_type_Boolean;
    rsp.jdField_h_of_type_Boolean = this.jdField_g_of_type_Boolean;
    rsp.jdField_i_of_type_Boolean = this.jdField_h_of_type_Boolean;
    rsp.l = this.jdField_i_of_type_Boolean;
    rsp.j = this.j;
    rsp.jdField_f_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
    rsp.jdField_a_of_type_Long = this.jdField_a_of_type_Long;
    rsp.m = this.k;
    rsp.jdField_b_of_type_Int = this.jdField_a_of_type_Int;
    rsp.jdField_i_of_type_JavaLangString = this.jdField_d_of_type_JavaLangString;
    rsp.n = this.l;
    rsp.jdField_c_of_type_Boolean = this.m;
    rsp.o = this.n;
    rsp.jdField_a_of_type_JavaUtilArrayList = this.jdField_a_of_type_JavaUtilArrayList;
    rsp.jdField_c_of_type_Int = this.jdField_b_of_type_Int;
    rsp.jdField_d_of_type_Int = this.jdField_c_of_type_Int;
    rsp.jdField_e_of_type_Int = this.jdField_d_of_type_Int;
    rsp.k = this.o;
    rsp.jdField_g_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
    rsp.jdField_h_of_type_JavaLangString = this.jdField_f_of_type_JavaLangString;
  }
  ...
  public void c()
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      rsp.b((QQAppInterface)localAppRuntime);
    }
  }
}
