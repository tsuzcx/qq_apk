...
public class nfj
{
  ...
  public Activity a;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new nfo(this);
  ...
  void a(nmu paramnmu)
  {
    if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null)
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoPreparedListener(new nfk(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnCompletionListener(new nfl(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnErrorListener(new nfm(this));
    }
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
        ...
        if (paramnmu.a != null)
        {
          ...
          if (paramnmu.a.size() != 0) {
            localObject1 = ((nmv)paramnmu.a.get(0)).j;
          }
        }
        if ((localObject1 != null) && (!TextUtils.isEmpty((CharSequence)localObject1)))
        {
          ...
          paramnmu = new HashMap();
          paramnmu.put("shouq_bus_type", "bus_type_account_detail");
          this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_PlayerVideoInfo.setReportInfoMap(paramnmu);
  ...
  public void a(nmu paramnmu, FrameLayout paramFrameLayout)
  {
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null)
    {
      ...
      this.jdField_a_of_type_Nfp.f();
    }
    label86:
    while (!paramBoolean) {
      return;
    }
    this.jdField_a_of_type_Nfp.g();
  }
