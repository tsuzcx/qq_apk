  ...
  extends alpd
{
  ...
  private alwx jdField_a_of_type_Alwx = new alza(this);
  private ambs jdField_a_of_type_Ambs = new alzb(this);
  ...
  public alyz(QQAppInterface paramQQAppInterface)
  {
    ...
    this.app.addObserver(this.jdField_a_of_type_Ambs);
    a();
  }
  ...
  private ToServiceMsg a(boolean paramBoolean, long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    paramString = azad.a(this.app, 13, paramString, localazak, paramLong2, azah.b(paramLong1));
  ...
  public void a()
  {
    Object localObject1 = (ambq)this.app.a(10);
    if ((((ambq)localObject1).a() != 0) && (((ambq)localObject1).e() == 1))
    {
