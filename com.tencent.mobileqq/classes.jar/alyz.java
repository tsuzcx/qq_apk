...
public class alyz
{
  ...
  private ServerConfigObserver jdField_a_of_type_MqqObserverServerConfigObserver = new alza(this);
  private boolean jdField_a_of_type_Boolean = true;
  private boolean b;
  
  public alyz(QQAppInterface paramQQAppInterface)
  {
  ...
  private Hashtable<String, ResourcePluginInfo> a()
  {
    ...
    localResourcePluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131626771);
    ...
    localResourcePluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131633314);
    localResourcePluginInfo.strResURL = "";
    localResourcePluginInfo.sResSubType = 2;
    localResourcePluginInfo.cCanChangeState = 0;
    localResourcePluginInfo.cDefaultState = 0;
    ...
    localResourcePluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131627633);
    ...
    localResourcePluginInfo.strResName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131626790);
    localResourcePluginInfo.strResDesc = "";
    localResourcePluginInfo.strResURL = "";
    localResourcePluginInfo.sResSubType = 2;
    localResourcePluginInfo.cCanChangeState = 0;
  ...
  {
    alyz localalyz = paramQQAppInterface.a();
    Object localObject2 = paramResourcePluginInfo.strGotoUrl;
    Object localObject1 = "version=8.2.6.4370&appid=" + AppSetting.a() + "&QUA=" + bfpr.a();
    Object localObject3;
    ...
    {
      localObject3 = (String)localObject1 + "&adtag=4370";
    }
    if (paramResourcePluginInfo.strPkgName.equals("com.tencent.Feedback_5_8"))
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (paramResourcePluginInfo.isNew == 0)
          {
            ...
            ThreadManager.post(new AboutConfig.3(localalyz, paramResourcePluginInfo), 8, null, false);
          }
          return;
  ...
  public void a(ResourcePluginInfo paramResourcePluginInfo)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 39	alyz:jdField_a_of_type_JavaUtilHashtable	Ljava/util/Hashtable;
    //   4: ifnull +76 -> 80
    //   7: aload_1
    //   8: ifnull +72 -> 80
    //   11: aload_0
    //   12: getfield 39	alyz:jdField_a_of_type_JavaUtilHashtable	Ljava/util/Hashtable;
    //   15: aload_1
    ...
    //   22: ifeq +58 -> 80
    //   25: aload_0
    //   26: getfield 39	alyz:jdField_a_of_type_JavaUtilHashtable	Ljava/util/Hashtable;
    //   29: aload_1
    ...
    //   56: aload_0
    //   57: getfield 29	alyz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   60: invokevirtual 518	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Latmq;
    //   63: invokevirtual 524	atmq:createEntityManager	()Latmp;
    //   66: astore_1
    //   67: aload_1
    //   68: aload_2
    //   69: invokestatic 528	com/tencent/mobileqq/data/ResourcePluginInfo:persistOrReplace	(Latmp;Lcom/tencent/mobileqq/data/ResourcePluginInfo;)V
    //   72: aload_1
    //   73: ifnull +7 -> 80
    //   76: aload_1
    //   77: invokevirtual 532	atmp:a	()V
    //   80: return
    //   81: astore_2
    //   82: aload_1
    //   83: ifnull -3 -> 80
    //   86: aload_1
    //   87: invokevirtual 532	atmp:a	()V
    //   90: return
    //   91: astore_2
    //   92: aload_1
    //   93: ifnull +7 -> 100
    //   96: aload_1
    //   97: invokevirtual 532	atmp:a	()V
    //   100: aload_2
    //   101: athrow
