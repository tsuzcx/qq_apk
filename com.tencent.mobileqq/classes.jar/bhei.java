  ...
  extends bjyh
{
  ...
  protected void i(boolean paramBoolean, HashMap<String, Object> paramHashMap)
  {
    ...
    do
    {
      do
      {
        ...
        this.jdField_a_of_type_Bheh.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Bheh.jdField_a_of_type_Bjyh);
      } while (!paramBoolean);
      ...
      localIntent.setComponent(new ComponentName(this.jdField_a_of_type_Bheh.jdField_a_of_type_AndroidContentContext, ChatActivity.class));
    ...
    if (i == 1) {
      if (((anvk)this.jdField_a_of_type_Bheh.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).b((String)localObject))
      {
        localIntent.putExtra("uintype", 0);
        localIntent.putExtra("uinname", ContactUtils.getFriendNickName(this.jdField_a_of_type_Bheh.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bheh.jdField_a_of_type_AndroidContentContext.startActivity(localIntent);
      return;
      localIntent.setComponent(new ComponentName(this.jdField_a_of_type_Bheh.jdField_a_of_type_AndroidContentContext, SplashActivity.class));
  ...
  protected void j(boolean paramBoolean, HashMap<String, Object> paramHashMap)
  {
    ...
    for (int i = ((Integer)paramHashMap.get("key_aio_type")).intValue();; i = 2)
    {
      ...
      if ((TextUtils.isEmpty(paramHashMap)) || (paramHashMap.equals("NO")))
      {
        ...
        if (!((anvk)this.jdField_a_of_type_Bheh.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER)).b(str2)) {
          break label277;
        }
        localIntent.putExtra("uintype", 0);
        localIntent.putExtra("uinname", ContactUtils.getFriendNickName(this.jdField_a_of_type_Bheh.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str2));
        if (QLog.isColorLevel()) {
  ...
  protected void k(boolean paramBoolean, HashMap<String, Object> paramHashMap)
  {
    ...
    if ((paramBoolean) && (paramHashMap != null))
    {
      ...
      this.jdField_a_of_type_Bheh.jdField_a_of_type_JavaUtilHashMap.put("uin", paramHashMap);
      if (this.jdField_a_of_type_Bheh.jdField_a_of_type_JavaUtilHashMap.containsKey("isPrivate")) {
        this.jdField_a_of_type_Bheh.jdField_a_of_type_JavaUtilHashMap.remove("isPrivate");
      }
      bheh.d(this.jdField_a_of_type_Bheh);
      return;
    }
    QQToast.a(BaseApplicationImpl.getContext(), 1, BaseApplicationImpl.getContext().getString(2131718057), 0).a();
  }
}
