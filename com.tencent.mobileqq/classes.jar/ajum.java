  ...
  implements LiteTransferListenerCallback, LiteTransferOperatorCallback
{
  ...
  private akat jdField_a_of_type_Akat = new ajur(this);
  public akcs a;
  ...
  public ew a;
  public String a;
  private ArrayList<awyw> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  protected HashMap<Long, awyv> a;
  ...
  ajum(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Akcs = new akcs(paramQQAppInterface);
    ...
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new ajun(this);
    this.jdField_b_of_type_AndroidContentBroadcastReceiver = new ajup(this, paramQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new ajuq(this);
    ...
    this.jdField_a_of_type_Bgpj = new bgpj(paramQQAppInterface);
    f();
    g();
  ...
  private ToServiceMsg a(boolean paramBoolean, long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2, int paramInt4)
  {
    ...
    paramString = a(13, paramString, localaxax, l, axau.b(paramLong1), paramLong2);
  ...
  private msg_svc.PbSendMsgReq a(int paramInt1, String paramString, axax paramaxax, long paramLong1, int paramInt2, long paramLong2)
  {
    return axaq.a(this.app, paramInt1, paramString, paramaxax, paramLong1, paramInt2);
  }
  ...
  private void a(int paramInt, long paramLong, String paramString)
  {
    ...
    localDataLineMsgRecord.md5 = bbea.a(paramString);
    if ((QLog.isDevelopLevel()) && (localDataLineMsgRecord.md5 != null)) {
      QLog.d("DataLineHandler", 4, "SessionUpdateType_FileMD5, uSessionID[" + paramLong + "], strValuebuf[" + paramString + "], strMD5MR[" + bbea.a(localDataLineMsgRecord.md5) + "], strMD5Notify" + paramString);
    }
    this.app.a().a(i).a(localDataLineMsgRecord.msgId, localDataLineMsgRecord.serverPath, localDataLineMsgRecord.md5);
  }
  ...
  private void a(int paramInt1, DataLineMsgRecord paramDataLineMsgRecord, int paramInt2)
  {
    ...
    if (paramDataLineMsgRecord.isSend())
    {
      if (paramInt2 == 2)
      {
        ...
        axqy.b(this.app, "CliOper", "", "", "0X8006223", "0X8006223", 0, 0, "", "", "", "");
        return;
      }
      if ((paramInt2 == 32) || (paramInt2 == 11) || (paramInt2 == 8))
      {
        ...
        axqy.b(this.app, "CliOper", "", "", "0X8006224", "0X8006224", 0, 0, "", "", "", "");
        return;
      }
      paramDataLineMsgRecord.fileMsgStatus = 0L;
      this.app.a().a(paramInt1).c(paramDataLineMsgRecord.msgId);
    ...
    if (paramInt2 == 2)
    {
      ...
      axqy.b(this.app, "CliOper", "", "", "0X8006226", "0X8006226", 0, 0, "", "", "", "");
      return;
    }
    if ((paramInt2 == 32) || (paramInt2 == 11) || (paramInt2 == 8))
    {
      ...
      this.app.a().a(paramInt1).c(paramDataLineMsgRecord.msgId);
      this.app.a().a(paramInt1).b(paramDataLineMsgRecord.msgId);
      axqy.b(this.app, "CliOper", "", "", "0X8006227", "0X8006227", 0, 0, "", "", "", "");
      return;
    }
  ...
  private void a(long paramLong, int paramInt)
  {
    ...
    do
    {
      ...
      {
        ((ayhj)this.app.getManager(305)).a(localDataLineMsgRecord, i);
        return;
      }
    ...
    do
    {
      for (;;)
      {
        ...
        if (localFile.exists()) {
          try
          {
            String str = apug.a(paramString);
            Object localObject = MediaStore.Images.Media.EXTERNAL_CONTENT_URI;
            localObject = ayxo.a(paramContext, str);
  ...
  private void a(DataLineMsgRecord paramDataLineMsgRecord, WeiYunFileInfo paramWeiYunFileInfo)
  {
    ...
    this.app.a().a().a(paramWeiYunFileInfo, new ajuo(this, l));
  }
  
  private void a(ToServiceMsg paramToServiceMsg)
  {
    NewIntent localNewIntent = new NewIntent(this.app.getApplication(), ajuu.class);
  ...
  private boolean a(awyw paramawyw)
  {
    int j = 0;
    int i = 0;
    StringBuffer localStringBuffer = new StringBuffer();
    int m = paramawyw.a(localStringBuffer);
    if (m == -1) {
      return false;
    }
    int k;
        ...
        if (localStringBuffer.charAt(i) == '\024')
        {
          ...
          if (i < localStringBuffer.length() - 1)
          {
            ...
            if (k >= 0)
            {
              ...
              if (k < axau.a.length)
              {
                localStringBuffer.setCharAt(i + 1, (char)axau.a[k]);
                j = i + 1;
              }
            }
          }
    ...
    paramawyw.a(a(paramawyw.a().longValue(), 1001, paramawyw.a(), m, localStringBuffer.toString().getBytes()));
    return true;
  }
  ...
  private void b(List<SubMsgType0x7.MsgBody.MoloNotify> paramList)
  {
    ...
    for (;;)
    {
      ...
      localDataLineMsgRecord.fileMsgStatus = 1L;
      bool = bbfj.h(BaseApplication.getContext());
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    paramToServiceMsg.path = (ajsd.bl + paramToServiceMsg.filename);
  ...
  private void d(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (bbdx.b(paramDataLineMsgRecord.thumbPath));
      str = apug.a(str, 384, 384);
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size()) {
      if (!((awyw)this.jdField_a_of_type_JavaUtilArrayList.get(i)).a().equals(paramToServiceMsg)) {}
    }
    for (paramToServiceMsg = (awyw)this.jdField_a_of_type_JavaUtilArrayList.get(i);; paramToServiceMsg = null)
    {
      if (paramToServiceMsg == null) {}
      do
      {
  ...
  public void GetThumbFilePath(int paramInt, Session paramSession)
  {
    ...
    Object localObject = (akfl)this.app.a(10);
    if ((localObject != null) && (((akfl)localObject).a() == 0))
    {
  ...
  public boolean OnQueryAutoDownload(long paramLong, byte paramByte)
  {
    ...
    if (paramByte == 2)
    {
      boolean bool1 = bbfj.h(BaseApplication.getContext());
  ...
  public void OnSessionNew(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo)
  {
    if (paramSession.bSend)
    {
      axqy.b(this.app, "CliOper", "", "", "0X8006222", "0X8006222", 0, 0, "", "", "", "");
      if ((paramSession.actionInfo != null) && (paramSession.actionInfo.strServiceName != null) && (paramSession.actionInfo.strServiceName.length() != 0)) {
        break label210;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      a(paramSession);
      return;
      axqy.b(this.app, "CliOper", "", "", "0X8006225", "0X8006225", 0, 0, "", "", "", "");
      break;
      label199:
  ...
  public bgpj a()
  {
    return this.jdField_a_of_type_Bgpj;
  }
  ...
  public Session a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      if ((QLog.isDevelopLevel()) && (localDataLineMsgRecord.md5 != null)) {
        QLog.d("DataLineHandler", 4, "getSessionFromMsgRecord, uSessionID[" + localDataLineMsgRecord.sessionid + "], strMR[" + bbea.a(localDataLineMsgRecord.md5) + "], filesize[" + localDataLineMsgRecord.filesize);
      }
  ...
  public ToServiceMsg a(long paramLong, MsgCSBody0x345 paramMsgCSBody0x345)
  {
    ...
    for (localObject = arrayOfByte;; localObject = createToServiceMsg("GTalkFileAppSvr.CMD_DISCUSS_FILE", null))
    {
      ...
      if (localObject != null)
      {
        ...
        bbmx.a(arrayOfByte, 0, paramMsgCSBody0x345.length + 4);
        bbmx.a(arrayOfByte, 4, paramMsgCSBody0x345, paramMsgCSBody0x345.length);
  ...
  public ToServiceMsg a(long paramLong, MsgCSBody0x346 paramMsgCSBody0x346)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bbmx.a((byte[])localObject2, 0, paramMsgCSBody0x346.length + 4);
        bbmx.a((byte[])localObject2, 4, paramMsgCSBody0x346, paramMsgCSBody0x346.length);
        paramMsgCSBody0x346 = (MsgCSBody0x346)localObject1;
  ...
  public Long a(String paramString, int paramInt)
  {
    ...
    localDataLineMsgRecord.issuc = false;
    ((akfv)this.app.a(13)).a(localDataLineMsgRecord);
    ...
    localDataLineMsgRecord.issuc = true;
    paramString = new awyw(paramString, localLong, localDataLineMsgRecord);
    if (!a(paramString)) {
      return Long.valueOf(0L);
    }
  ...
  protected void a(long paramLong1, long paramLong2, SubMsgType0x7.MsgBody.GenericSubCmd paramGenericSubCmd, SubMsgType0x7.MsgBody.MsgHeader paramMsgHeader)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        case 1: 
          ...
          default: 
            ...
            {
              localawyv = new awyv(Long.valueOf(paramGenericSubCmd.uint32_size.get()), Long.valueOf(l));
              this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), localawyv);
            ...
            {
              localawyv = (awyv)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(l));
              continue;
            }
            if (!paramGenericSubCmd.uint32_index.has()) {
              break label697;
            }
            localawyv.a(paramGenericSubCmd.uint32_index.get(), paramMsgHeader);
            if (!localawyv.a()) {
              break label697;
            }
            ...
            if (i == 1)
            {
              paramGenericSubCmd = localawyv.a();
              i = 0;
              if (i < ayjy.a.length)
              {
                paramMsgHeader = paramGenericSubCmd;
                if (paramGenericSubCmd.indexOf('\024' + ayjy.a[i]) == -1) {
                  break label714;
                }
                paramMsgHeader = paramGenericSubCmd.replace('\024' + ayjy.a[i], "\024" + (char)i);
                break label714;
              }
              ...
              h();
              a(8, true, new Object[] { Integer.valueOf((int)paramLong1), localawyv.a(), Long.valueOf(((DataLineMsgRecord)localObject1).sessionid) });
              return;
            }
            break;
          }
      ...
      ((DataLineMsgRecord)localObject1).msg = localawyv.a();
      continue;
      askx.a().a(paramGenericSubCmd);
      return;
      label691:
      break label705;
      label694:
  ...
  public void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    {
      localDataLineMsgRecord.thumbPath = apvd.a(apvd.a(this.app.getApplication()), apug.a(paramFileManagerEntity.strThumbPath));
      bbdx.d(paramFileManagerEntity.strThumbPath, localDataLineMsgRecord.thumbPath);
    }
    ...
    Object localObject = (ajum)this.app.a(8);
    localDataLineMsgRecord.sessionid = ((ajum)localObject).a(0, 0).longValue();
    localDataLineMsgRecord.msg = "";
    localDataLineMsgRecord.issend = 1;
    localDataLineMsgRecord.isread = true;
    localDataLineMsgRecord.issuc = false;
    ...
    ((ajum)localObject).a(7, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf((byte)b(localDataLineMsgRecord.msgtype)), Boolean.valueOf(false), Boolean.valueOf(false), Long.valueOf(localDataLineMsgRecord.filesize) });
  ...
  public void a(WeiYunFileInfo paramWeiYunFileInfo)
  {
    ...
    localDataLineMsgRecord.sessionid = localajum.a(0, 0).longValue();
    localDataLineMsgRecord.msg = "";
    localDataLineMsgRecord.issend = 1;
    localDataLineMsgRecord.isread = true;
    localDataLineMsgRecord.issuc = false;
    ...
    this.app.a().a(DataLineMsgRecord.getDevTypeBySeId(localDataLineMsgRecord.sessionid)).a(localDataLineMsgRecord, true);
    localajum.a(7, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf((byte)b(localDataLineMsgRecord.msgtype)), Boolean.valueOf(false), Boolean.valueOf(false), Long.valueOf(localDataLineMsgRecord.filesize) });
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.getServiceCmd().equals("MessageSvc.PbSendMsg"))
    {
      ...
      askx.a().a(paramToServiceMsg, paramFromServiceMsg, paramObject);
    }
    label72:
  ...
  {
    this.jdField_a_of_type_Bgpj.a(paramMsg);
  }
  
  public void a(msg_comm.Msg paramMsg, SubMsgType0x7.MsgBody paramMsgBody)
  {
    this.jdField_a_of_type_Bgpj.a(paramMsg, paramMsgBody);
    DataLineMsgRecord localDataLineMsgRecord;
    try
    {
      localDataLineMsgRecord = new DataLineMsgRecord();
    ...
    localObject = (akfl)this.app.a(10);
    if ((localObject != null) && (((akfl)localObject).d() != 1)) {
      ((akfl)localObject).e(1);
    }
  ...
  public void a(msg_comm.Msg paramMsg, C2CType0x211_SubC2CType0x9.MsgBody paramMsgBody)
  {
    ...
    this.jdField_a_of_type_Akcs.a(this, paramMsg, paramMsgBody);
  }
  ...
  public boolean a(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    for (;;)
    {
      ...
      bbmx.a(arrayOfByte, 0, localObject2.length + 4);
      bbmx.a(arrayOfByte, 4, (byte[])localObject2, localObject2.length);
      if (localObject1 != null)
      {
  ...
  public boolean a(List<Long> paramList)
  {
    ...
    if (TextUtils.isEmpty(localDataLineMsgRecord.path)) {
      localDataLineMsgRecord.path = (ajsd.bl + "/" + localDataLineMsgRecord.filename);
    }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    bbmx.a(arrayOfByte, 0, paramFromServiceMsg.getWupBuffer(), 4, j);
    label390:
  ...
  public void d()
  {
    long l = this.app.a().a(String.valueOf(ajsd.z), 6000).time;
    ...
    if ((l != 0L) && (l != this.jdField_c_of_type_Long))
    {
      ...
      ((akov)this.app.a().a("c2c_processor")).a(localArrayList);
      this.jdField_c_of_type_Long = l;
    }
    l = this.app.a().a(String.valueOf(ajsd.A), 6003).time;
  ...
  public void onDestroy()
  {
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        if ((this.app != null) && (this.app.getApp() != null) && (this.jdField_a_of_type_Akat != null))
        {
        ...
        this.jdField_a_of_type_Bgpj.a();
        this.jdField_a_of_type_Es.a();
        this.jdField_a_of_type_Akcs.a();
  ...
  {
    this.jdField_a_of_type_Bgpj.a(paramToServiceMsg, paramFromServiceMsg, (byte[])paramObject);
