...
public class aenf
  extends aodj
{
  public aenf(PhoneUnityPhoneLoginActivity paramPhoneUnityPhoneLoginActivity) {}
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 39)
    {
      bdla.b(this.a.app, "CliOper", "", "", "0X8005BFD", "0X8005BFD", 0, 0, "", "", "", "");
      bhdj.a(this.a, 230, this.a.getString(2131694549), this.a.getString(2131694548), null, this.a.getString(2131691969), new aeng(this), null).show();
      return;
    }
  ...
  public void b(int paramInt, String paramString)
  {
    ...
    String str;
    if (paramInt == 36) {
      str = this.a.getString(2131694553);
    }
    for (;;)
    {
      QQToast.a(this.a, str, 0).b(this.a.getTitleBarHeight());
      ...
      str = paramString;
      if (TextUtils.isEmpty(paramString)) {
        str = this.a.getString(2131694552);
      }
    }
  }
}
