...
{
  ayfh(ayfg paramayfg, TicketManager paramTicketManager, ReSendCmd paramReSendCmd) {}
  ...
  public void Done(Ticket paramTicket)
  {
    ...
    for (;;)
    {
      ...
      paramTicket = this.jdField_a_of_type_MqqManagerTicketManager.getPskey(this.jdField_a_of_type_Ayfg.mApp.getCurrentAccountUin(), "docs.qq.com");
      if ((!TextUtils.isEmpty(paramTicket)) && (paramTicket.length() > 0))
      {
        ayfg.a(this.jdField_a_of_type_Ayfg, 0);
