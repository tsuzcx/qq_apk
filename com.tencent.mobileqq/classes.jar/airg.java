...
public class airg
  implements adae, aoco
{
  private final airk jdField_a_of_type_Airk = new airk(null);
  private Activity jdField_a_of_type_AndroidAppActivity;
  private aocm jdField_a_of_type_Aocm;
  private aogx jdField_a_of_type_Aogx = new airh(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private String jdField_a_of_type_JavaLangString;
  private Calendar jdField_a_of_type_JavaUtilCalendar;
  private List<ChatMessage> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean;
  private final airk jdField_b_of_type_Airk = new airk(null);
  private boolean jdField_b_of_type_Boolean;
  private final airk jdField_c_of_type_Airk = new airk(null);
  private boolean jdField_c_of_type_Boolean;
  private final airk jdField_d_of_type_Airk = new airk(null);
  private boolean jdField_d_of_type_Boolean;
  private final airk jdField_e_of_type_Airk = new airk(null);
  private boolean jdField_e_of_type_Boolean;
  private final airk jdField_f_of_type_Airk = new airk(null);
  private boolean jdField_f_of_type_Boolean;
  private boolean g;
  
  public airg(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString)
  {
  ...
  private Calendar a()
  {
    return this.jdField_a_of_type_Aocm.a();
  }
  ...
  private List<ChatMessage> a(int paramInt)
  {
    ...
    {
      localObject = this.jdField_a_of_type_Aocm.a();
      if (localObject != null) {
        break label87;
      }
    }
    ...
    if (this.jdField_a_of_type_Aocm.a() == null)
    {
      QLog.e("C2CMsgRoamProxy", 1, "current page date is null, show roam flag: " + this.jdField_a_of_type_Aocm.e());
      return null;
    }
    Object localObject = this.jdField_a_of_type_Aocm.a(paramInt);
    if ((localObject != null) && (((RoamMessagePreloadInfo)localObject).curday != null))
    {
      l1 = SystemClock.uptimeMillis();
      this.jdField_a_of_type_Airk.a();
      this.jdField_a_of_type_Aocm.a(((RoamMessagePreloadInfo)localObject).curday, null, false, false);
      if (QLog.isColorLevel()) {
        QLog.d("C2CMsgRoamProxy", 2, "getHistorySig wait");
      }
      this.jdField_a_of_type_Airk.a(30000L);
    ...
    for (;;)
    {
      this.jdField_a_of_type_JavaUtilCalendar = this.jdField_a_of_type_Aocm.a();
    ...
    for (;;)
    {
      ...
      while (localIterator1.hasNext())
      {
        ...
        while (localIterator2.hasNext())
        {
          ...
          if (adak.a(localMessageRecord, localChatMessage, true)) {
            localArrayList.add(localChatMessage);
          }
        }
      }
      ((List)localObject).removeAll(localArrayList);
      if ((((List)localObject).size() > 0) && (paramMessageRecord != null) && (avpe.a(paramMessageRecord)) && (((ChatMessage)((List)localObject).get(0)).time >= paramMessageRecord.time))
      {
        if (QLog.isColorLevel()) {
  ...
  private void a(int paramInt)
  {
    ...
    RoamDate localRoamDate = this.jdField_a_of_type_Aocm.a().a(this.jdField_a_of_type_JavaLangString, localCalendar.get(1), localCalendar.get(2) + 1);
  ...
  {
    paramQQAppInterface = (aocm)paramQQAppInterface.getManager(92);
  ...
  private void a(String paramString, int paramInt1, ArrayList<MessageRecord> paramArrayList, int paramInt2, long paramLong, Calendar paramCalendar)
  {
    ...
    for (long l1 = ((MessageRecord)paramArrayList.get(0)).time;; l1 = paramLong)
    {
      ...
      {
        paramString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(paramInt1).a(paramString, paramInt1, l1, paramInt2, String.format(Locale.getDefault(), "time>=%d", new Object[] { Long.valueOf(l2) }));
  ...
  {
    this.jdField_a_of_type_Aocm.a(paramCalendar.get(1), paramCalendar.get(2), paramCalendar.get(5));
    this.jdField_a_of_type_JavaUtilCalendar = this.jdField_a_of_type_Aocm.a();
  }
    ...
    if ((!this.jdField_a_of_type_Boolean) || (paramBoolean)) {
      try
      {
        if ((!this.jdField_a_of_type_Boolean) || (paramBoolean))
        {
          ...
          this.jdField_a_of_type_Aocm = ((aocm)((QQAppInterface)localObject1).getManager(92));
          this.jdField_a_of_type_Aocm.a(this.jdField_a_of_type_JavaLangString, false);
          localObject1 = Calendar.getInstance();
          ((Calendar)localObject1).setTimeInMillis(NetConnInfoCenter.getServerTimeMillis());
          this.jdField_a_of_type_Aocm.a(((Calendar)localObject1).get(1), ((Calendar)localObject1).get(2), ((Calendar)localObject1).get(5));
          this.jdField_a_of_type_JavaUtilCalendar = this.jdField_a_of_type_Aocm.a();
  ...
  {
    int j = this.jdField_a_of_type_Aocm.b();
    boolean bool = this.jdField_a_of_type_Aocm.g();
    Object localObject1;
    int i;
    if (QLog.isColorLevel())
    {
      localObject1 = this.jdField_a_of_type_Aocm.b();
    ...
    if (this.jdField_a_of_type_Aocm.b() != null)
    {
      this.g = true;
      return;
    }
    ...
    {
      this.jdField_f_of_type_Airk.a();
      ((AccountManager)localObject2).refreshDA2(((QQAppInterface)localObject1).getCurrentAccountUin(), new airj(this));
      this.jdField_f_of_type_Airk.a(30000L);
      return;
    }
    this.g = false;
    return;
  ...
  private boolean a()
  {
    ...
    boolean bool1 = bhnv.d(BaseApplication.getContext());
    c();
    boolean bool2 = this.jdField_a_of_type_Aocm.h();
    if ((!bool1) || (!bool2)) {
      return false;
    }
    if (!this.jdField_a_of_type_Aocm.f())
    {
      d();
      if (this.jdField_a_of_type_Aocm.f()) {
        c(false);
  ...
  private void b()
  {
    try
    {
      ...
      {
        this.jdField_a_of_type_Aocm.b(hashCode());
        this.jdField_a_of_type_Aocm.a(this);
  ...
  private void b(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Aocm.c(true);
    long l1 = SystemClock.uptimeMillis();
    this.jdField_b_of_type_Airk.a();
    this.jdField_a_of_type_Aocm.a(paramBoolean);
    this.jdField_b_of_type_Airk.a(30000L);
    a(3);
    long l2 = SystemClock.uptimeMillis();
    if (QLog.isColorLevel()) {
      QLog.d("C2CMsgRoamProxy", 2, "getRoamMessageTimeLineSync cost: " + (l2 - l1) + ", result: " + this.jdField_c_of_type_Boolean);
    }
    this.jdField_a_of_type_Aocm.f();
    this.jdField_a_of_type_Aocm.c(this.jdField_c_of_type_Boolean);
  }
  ...
  private boolean b()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        b();
        l1 = SystemClock.uptimeMillis();
        bool3 = bhnv.d(BaseApplication.getContext());
        c();
        bool4 = this.jdField_a_of_type_Aocm.h();
        bool1 = bool2;
      } while (!bool3);
      bool1 = bool2;
    } while (!bool4);
  ...
  private void c()
  {
    if (this.jdField_a_of_type_Aocm.i()) {}
    long l1;
    long l2;
    do
    {
      ...
      l1 = SystemClock.uptimeMillis();
      ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).addObserver(this.jdField_a_of_type_Aogx);
      VasExtensionHandler localVasExtensionHandler = (VasExtensionHandler)localQQAppInterface.a(71);
      this.jdField_c_of_type_Airk.a();
      localVasExtensionHandler.a(new String[] { localQQAppInterface.getCurrentAccountUin() }, new int[] { 42255 });
      this.jdField_c_of_type_Airk.a();
  ...
  private void c(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_c_of_type_Boolean = false;
        break;
        QQToast.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131692664), 0).a();
      }
      this.jdField_c_of_type_Boolean = false;
      continue;
  ...
  private void c(boolean paramBoolean)
  {
    ...
    this.jdField_e_of_type_Airk.a();
    int[] arrayOfInt = new int[1];
    DevlockInfo[] arrayOfDevlockInfo = new DevlockInfo[1];
    asvf.a().a(localQQAppInterface, localQQAppInterface.getCurrentAccountUin(), new airi(this, l, arrayOfInt, arrayOfDevlockInfo));
    this.jdField_e_of_type_Airk.a(30000L);
  ...
  private boolean d()
  {
    ...
    localObject = (apdn)((QQAppInterface)localObject).a(59);
    if (localObject != null)
    {
      long l1 = SystemClock.uptimeMillis();
      this.jdField_d_of_type_Airk.a();
      ((apdn)localObject).a();
      this.jdField_d_of_type_Airk.a(30000L);
      long l2 = SystemClock.uptimeMillis();
      if (QLog.isColorLevel()) {
  ...
  private void e(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    if (localObject == null)
    {
      ...
      this.jdField_a_of_type_Airk.b();
      return;
    }
    localObject = (aocm)((QQAppInterface)localObject).getManager(92);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (i == 0) {
        ((aocm)localObject).a(localCalendar, false);
      }
      switch (paramInt1)
      {
      case 3: 
    ...
    for (;;)
    {
      ((aocm)localObject).e();
      return;
      paramObject = ((aocm)localObject).a();
      if (paramObject != null) {
        QQToast.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131692666, new Object[] { Integer.valueOf(paramObject.get(2) + 1), Integer.valueOf(paramObject.get(5)) }), 0).a();
      }
    }
    ((aocm)localObject).e();
  }
  ...
  private boolean e()
  {
    Object localObject2 = this.jdField_a_of_type_Aocm.c();
    ...
    if (this.jdField_a_of_type_Aocm.b() == null)
    {
      QLog.e("C2CMsgRoamProxy", 1, "can not get first page date, roam flag: " + this.jdField_a_of_type_Aocm.e());
      return true;
    }
    long l = this.jdField_a_of_type_Aocm.b().getTimeInMillis();
    while (((Calendar)localObject1).getTimeInMillis() >= l)
    {
      int i = ((Calendar)localObject1).get(5);
      localObject2 = this.jdField_a_of_type_Aocm.a().a(this.jdField_a_of_type_JavaLangString, ((Calendar)localObject1).get(1), ((Calendar)localObject1).get(2) + 1);
      if (localObject2 == null)
      {
        if (QLog.isColorLevel()) {
      ...
      {
        this.jdField_a_of_type_Aocm.a(((Calendar)localObject1).get(1), ((Calendar)localObject1).get(2), i);
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Aocm.q();
      this.jdField_a_of_type_Aocm.a(hashCode());
      this.jdField_a_of_type_Aocm.b(this);
      ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).removeObserver(this.jdField_a_of_type_Aogx);
    }
  ...
  public boolean a(String paramString, int paramInt1, int paramInt2, aday paramaday, ArrayList<MessageRecord> paramArrayList, MessageRecord paramMessageRecord, long paramLong)
  {
    ...
    if (paramMessageRecord == null)
    {
      ...
      if ((paramMessageRecord != null) && ((this.jdField_a_of_type_Aocm == null) || (!this.jdField_a_of_type_Aocm.e()) || (this.jdField_a_of_type_Aocm.a() != null))) {
        break label116;
      }
    }
    label116:
    for (boolean bool = true;; bool = false)
    {
      a(bool);
      b();
      if (this.jdField_a_of_type_Aocm.h()) {
        break label122;
      }
    ...
    if (a() == null)
    {
      ...
      paramaday = this.jdField_a_of_type_Aocm.d;
      a(true);
      if (paramaday == null) {
        break label203;
      }
    ...
    if ((paramMessageRecord != null) && (i == 2)) {
      a(paramString, paramInt1, paramArrayList, paramInt2 - j, l, paramaday);
    }
