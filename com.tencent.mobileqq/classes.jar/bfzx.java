...
public class bfzx<T extends RecyclerView.Adapter>
  extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
  ...
  public bfzx(T paramT)
  {
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$Adapter = paramT;
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$Adapter.registerAdapterDataObserver(new bfzy(this));
  }
  ...
  public bfzx a(bgab parambgab)
  {
    this.jdField_a_of_type_Bgab = parambgab;
    return this;
  }
  ...
  protected void a(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    if (this.jdField_a_of_type_Bgac != null) {
      this.jdField_a_of_type_Bgac.a(paramViewHolder, paramInt);
    }
  }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    if (c(paramInt))
    {
      ...
      return new bfzz(this, (View)this.jdField_a_of_type_JavaUtilList.get(paramInt));
    }
    if (d(paramInt))
    {
      paramInt = Math.abs(paramInt + 2000);
      return new bgaa(this, (View)this.b.get(paramInt));
    }
  ...
  public void onViewAttachedToWindow(RecyclerView.ViewHolder paramViewHolder)
  {
    ...
    if ((this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$Adapter != null) && ((paramViewHolder instanceof bfzf))) {
