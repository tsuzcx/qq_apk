  ...
  implements pme
{
  ...
  private ViewPager.OnPageChangeListener jdField_a_of_type_AndroidSupportV4ViewViewPager$OnPageChangeListener = new ogn(this);
  ...
  private Map<Integer, rev> jdField_a_of_type_JavaUtilMap = new HashMap();
  private ogo jdField_a_of_type_Ogo;
  private pmh jdField_a_of_type_Pmh;
  private pmn jdField_a_of_type_Pmn = new ogm(this);
  private pnh jdField_a_of_type_Pnh = new ogl(this);
  ...
  static
  {
    ...
    jdField_b_of_type_Int = bgtn.b(0.0F);
    jdField_c_of_type_Int = bgtn.b(0.0F);
    jdField_a_of_type_Long = bmqa.g(pha.a());
  }
  
  public ogh(Context paramContext, View paramView, ReadInJoyChannelViewPager paramReadInJoyChannelViewPager)
  {
    ...
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout = ((TabLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131378217));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131369189));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131369263));
  ...
  private void a(int paramInt1, float paramFloat, int paramInt2)
  {
    ...
    {
      localView2 = localViewGroup.findViewById(2131368840);
      paramInt2 = 0;
      if (paramInt1 != i - 1) {
        break label273;
      }
  ...
  public static void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    try
    {
      paramString = new phi().b().f().a(paramInt1).b(paramInt2 + 1).d(paramString);
      if (paramInt1 == 41695)
      {
        localObject = pmh.a().a();
        if (localObject != null)
  ...
  private void a(View paramView1, View paramView2)
  {
    ...
    paramView1 = (TextView)paramView1.findViewById(2131379957);
    paramView2 = (TextView)paramView2.findViewById(2131379957);
    a(paramView1);
    b(paramView2);
  }
  ...
  {
    paramTextView.setTextColor(paramTextView.getResources().getColor(2131166879));
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    oat.a(null, "", paramString1, paramString1, 0, 0, paramString2, "", "", paramString3, false);
  }
  ...
  private void a(List<TabChannelCoverInfo> paramList)
  {
    ...
    if (this.jdField_a_of_type_Ogo != null)
    {
      ...
      this.jdField_a_of_type_Ogo.a(paramList);
    }
  ...
  private void a(Map<Integer, rev> paramMap)
  {
    if (paramMap != null)
    {
      ...
      if (paramMap.hasNext())
      {
        ...
        int j = ovs.jdField_b_of_type_Int;
        ...
        for (int i = localrev.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructTabChannelCoverInfo.redPoint.jdField_a_of_type_Int + 1;; i = 0)
        {
          ovs.a("0X8009495", localTabChannelCoverInfo, j, i, localrev.l);
          break;
        }
      }
    }
  ...
  {
    paramTextView.setTextColor(paramTextView.getResources().getColor(2131166880));
  ...
  private void b(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    KandianSubscribeManager localKandianSubscribeManager = (KandianSubscribeManager)pha.a().getManager(280);
    rhy localrhy = new rhy();
    localrhy.jdField_a_of_type_Long = 0L;
    localrhy.b = 9223372036854775807L;
    localrhy.jdField_a_of_type_Boolean = localKandianSubscribeManager.a();
    paramTabChannelCoverInfo.redPoint = localrhy;
    a(paramTabChannelCoverInfo);
  }
  
  private void b(List<TabChannelCoverInfo> paramList)
  {
    List localList = this.jdField_a_of_type_Pmh.a();
    if ((localList != null) && (localList.size() > 0))
    {
      ((rex)localList.get(0)).jdField_a_of_type_JavaUtilList = paramList;
      this.jdField_a_of_type_Pmh.a(localList, 1, true);
    }
  ...
  private int d()
  {
    List localList = this.jdField_a_of_type_Pmh.b();
    int k;
    if ((localList == null) || (localList.size() == 0))
    {
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_Sta = new sta(this.jdField_b_of_type_AndroidViewView.getContext(), this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentBizWidgetsTabLayout, this);
    this.jdField_a_of_type_JavaUtilMap.clear();
    this.jdField_a_of_type_Sta.a(this.jdField_a_of_type_JavaUtilMap);
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout.setAdapter(this.jdField_a_of_type_Sta);
    ...
    pnc.a(this.jdField_a_of_type_Pnh);
  }
  ...
  private void h()
  {
    Object localObject = (pmm)pha.a().getManager(163);
    List localList;
    if (localObject != null)
    {
  ...
  private void i()
  {
    if (pih.a())
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849398);
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842879);
  }
  
  private void j()
  {
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new ogi(this));
  }
  ...
  private void m()
  {
    ...
    int k = (int)(bgln.m() - i) / 2 - bgtn.a(12.0F);
    i = 200;
    ...
    if (this.jdField_a_of_type_Bkle == null) {
      this.jdField_a_of_type_Bkle = new ogk(this);
    }
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout.setOnScrollStateChangedListener(this.jdField_a_of_type_Bkle);
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        a("0X8009B94", "", new phi().a("source", "302").a(((TabChannelCoverInfo)localObject).mChannelCoverId).b("style", 0).a());
        if (b() == paramInt)
        {
      ...
      catch (JSONException localJSONException1)
      {
        try
        {
          a("0X8009665", "", pha.a().a(((TabChannelCoverInfo)localObject).mChannelCoverId).m(ReadInJoyChannelPanelFragment.a((ChannelCoverInfo)localObject)).n(ReadInJoyChannelPanelFragment.a((TabChannelCoverInfo)localObject)).a());
          boolean bool = bmqa.z();
          if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
  ...
  public void a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = (pmm)pha.a().getManager(163);
      } while (localObject == null);
      localObject = ((pmm)localObject).a();
    } while (localObject == null);
    if (pha.k())
    {
      ((pmh)localObject).a(paramTabChannelCoverInfo);
      return;
    }
    pha.b().post(new ReadInJoyChannelViewPagerController.3(this, (pmh)localObject, paramTabChannelCoverInfo));
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (i > 0)
      {
        ...
        this.jdField_a_of_type_Pmh.a(localTabChannelCoverInfo.mChannelCoverId, 5, false, false);
        i -= 1;
      }
      this.jdField_a_of_type_Sta.notifyDataSetChanged();
    }
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Pnh != null) {
  ...
  public void z_()
  {
    ...
    rhy localrhy = new rhy();
    localrhy.jdField_a_of_type_Boolean = true;
    localrhy.jdField_a_of_type_Long = 0L;
    localrhy.b = 9223372036854775807L;
    localTabChannelCoverInfo.redPoint = localrhy;
    a(localTabChannelCoverInfo);
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout.a();
  }
}
