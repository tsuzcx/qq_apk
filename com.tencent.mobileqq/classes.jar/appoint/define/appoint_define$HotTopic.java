  ...
  extends MessageMicro<HotTopic>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 48, 58, 66, 74 }, new String[] { "uint64_id", "str_title", "uint64_topic_type", "uint64_total", "uint64_times", "uint64_history_times", "str_bg_url", "str_url", "str_extra_info" }, new Object[] { localLong, "", localLong, localLong, localLong, localLong, "", "", "" }, HotTopic.class);
  }
}
