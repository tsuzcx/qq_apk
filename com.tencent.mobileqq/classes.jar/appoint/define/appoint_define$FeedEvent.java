  ...
  extends MessageMicro<FeedEvent>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 50, 58, 64 }, new String[] { "uint64_event_id", "uint32_time", "uint32_eventtype", "msg_user_info", "msg_feed_info", "str_event_tips", "msg_comment", "uint64_cancel_event_id" }, new Object[] { localLong, localInteger, localInteger, null, null, "", null, localLong }, FeedEvent.class);
  }
}
