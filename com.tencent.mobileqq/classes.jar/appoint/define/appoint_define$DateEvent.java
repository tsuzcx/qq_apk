  ...
  extends MessageMicro<DateEvent>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42, 48, 58, 66, 72 }, new String[] { "uint64_event_id", "uint32_time", "uint32_type", "msg_user_info", "msg_date_info", "uint32_attend_idx", "str_event_tips", "msg_comment", "uint64_cancel_event_id" }, new Object[] { localLong, localInteger, localInteger, null, null, localInteger, "", null, localLong }, DateEvent.class);
  }
}
