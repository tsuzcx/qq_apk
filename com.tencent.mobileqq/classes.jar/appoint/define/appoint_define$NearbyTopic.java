  ...
  extends MessageMicro<NearbyTopic>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 32, 40, 48, 56, 66, 74, 82, 88, 96, 104, 112, 120, 128, 136, 146 }, new String[] { "uint64_topic_id", "str_topic", "str_foreword", "uint32_create_time", "uint32_update_time", "uint32_hot_flag", "uint32_button_style", "str_button_src", "str_background_src", "str_attendee_info", "uint32_index", "uint32_publish_scope", "uint32_effective_time", "uint32_expiation_time", "uint32_pushed_usr_count", "uint32_timerange_left", "uint32_timerange_right", "str_area" }, new Object[] { Long.valueOf(0L), "", "", localInteger, localInteger, localInteger, localInteger, "", "", "", localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, localInteger, "" }, NearbyTopic.class);
  }
}
