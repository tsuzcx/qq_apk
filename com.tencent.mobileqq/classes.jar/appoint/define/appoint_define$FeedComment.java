  ...
  extends MessageMicro<FeedComment>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 32, 50, 56, 66, 72 }, new String[] { "str_comment_id", "str_feed_id", "msg_publisher_info", "uint32_time", "msg_reply_info", "uint32_flag", "msg_content", "uint32_hot" }, new Object[] { "", "", null, localInteger, null, localInteger, null, localInteger }, FeedComment.class);
  }
}
