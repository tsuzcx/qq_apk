  ...
  extends TableLayout
{
  ...
  public qlo(Context paramContext, GdtCanvasFormTableData paramGdtCanvasFormTableData, WeakReference paramWeakReference)
  {
    super(paramContext);
  ...
  private void b()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new qlp(this);
