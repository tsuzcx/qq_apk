  ...
  implements bdwa, INetInfoHandler
{
  ...
  public akkh(AppRuntime paramAppRuntime, bdvz parambdvz)
  {
    ...
    try
    {
      if (!this.jdField_a_of_type_JavaUtilLinkedList.isEmpty())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloQueue_Downloader", 2, "getTask | " + paramString + " task find =" + localbdvv);
            }
            return localbdvv;
          }
        }
  ...
  public void a()
  {
    for (;;)
    {
      try
      {
        synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
        {
          ...
          if ((!localbdvv2.a()) && (l > localbdvv2.c + localbdvv2.d))
          {
            ...
            QLog.d("ApolloQueue_Downloader", 2, "remove task[" + localbdvv2.jdField_a_of_type_JavaLangString + "], isCancal=" + localbdvv2.b() + ", timeOut=" + bool);
          }
        }
        bool = false;
      }
      ...
      for (;;)
      {
        ...
        return;
        label288:
        ThreadManager.postDownLoadTask(new ApolloQueueDownloader.1(this, localbdvv1), 2, null, false);
  ...
  public void a(bdvv parambdvv)
  {
    ...
    try
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("ApolloQueue_Downloader", 2, "removeTask | task=" + parambdvv);
        }
        parambdvv.i();
  ...
  public void a(bdvv parambdvv, bdvu arg2, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
      {
        ...
        if (paramBundle == null)
        {
          ...
          if (parambdvv.b)
          {
            ...
            if ((parambdvv.jdField_a_of_type_JavaUtilList != null) && (parambdvv.jdField_a_of_type_JavaUtilList.size() != 0)) {
              break label328;
            }
            ??? = null;
            if (QLog.isColorLevel()) {
              QLog.d("ApolloQueue_Downloader", 2, new Object[] { "startDownload | task=" + parambdvv.jdField_a_of_type_JavaLangString, ", url:", ??? });
            }
            a();
            return;
          }
      ...
      if ((parambdvv.b) && (!paramBundle.a()) && (this.jdField_a_of_type_JavaUtilLinkedList.remove(paramBundle)))
      {
        ...
        continue;
        label328:
        ??? = (String)parambdvv.jdField_a_of_type_JavaUtilList.get(0);
      }
    }
  }
