...
{
  actg jdField_a_of_type_Actg = actg.a();
  ...
  public arlg(Activity paramActivity, String paramString1, String paramString2, MiniMsgUserParam paramMiniMsgUserParam)
  {
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = View.inflate(this.jdField_a_of_type_AndroidAppActivity.getApplicationContext(), 2131562608, null);
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
      String str = bahv.a("", this.jdField_a_of_type_JavaLangString, 0);
      ayoi.a(str);
      Object localObject2 = (RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131370257);
      URLImageView localURLImageView = (URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370258);
      Object localObject1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370259);
      ...
      localLayoutParams.leftMargin = bbll.b(4.0F);
      ...
      if (AppSetting.d) {
        baww.b(this.jdField_a_of_type_AndroidViewView, false);
      }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniMsgUserParam != null)
    {
      ...
      {
        aggg localaggg = MiniMsgIPCClient.getInstance().getBusinessInfo(this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniMsgUserParam.businessName);
        if (localaggg != null)
        {
          int[] arrayOfInt = ((agge)this.jdField_a_of_type_ComTencentMobileqqActivityMiniaioMiniMsgUserParam.unreadCallback).a();
          if (arrayOfInt != null)
          {
            localaggg.c = arrayOfInt[0];
            localaggg.d = arrayOfInt[1];
          }
        }
      }
      MiniMsgIPCClient.getInstance();
