  ...
  extends Dialog
{
  ...
  private bfnx(bfoa parambfoa)
  {
    super(bfoa.a(parambfoa), 2131689776);
    Object localObject3 = new LinearLayout(bfoa.a(parambfoa));
    ((LinearLayout)localObject3).setOrientation(1);
    ((LinearLayout)localObject3).setBackgroundColor(-1);
    ((LinearLayout)localObject3).setBackgroundDrawable(bfnm.a(-1, azvv.a(bfoa.a(parambfoa), 4.0F)));
    int i = azvv.a(bfoa.a(parambfoa), 25.0F);
    ...
    ((LinearLayout.LayoutParams)localObject4).setMargins(azvv.a(bfoa.a(parambfoa), 30.0F), 0, azvv.a(bfoa.a(parambfoa), 30.0F), 0);
    TextView localTextView = new TextView(bfoa.a(parambfoa));
    ...
    localObject1 = new TextView(bfoa.a(parambfoa));
    Object localObject2 = new LinearLayout.LayoutParams(-2, -2);
    ((LinearLayout.LayoutParams)localObject2).setMargins(azvv.a(bfoa.a(parambfoa), 16.5F), 0, 0, azvv.a(bfoa.a(parambfoa), 18.5F));
    ((TextView)localObject1).setTextColor(-16777216);
    ((LinearLayout)localObject3).addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
    Object localObject5 = new LinearLayout(bfoa.a(parambfoa));
    ...
    ((LinearLayout.LayoutParams)localObject6).setMargins(azvv.a(bfoa.a(parambfoa), -5.0F), 0, azvv.a(bfoa.a(parambfoa), -5.0F), 0);
    localObject2 = new Button(bfoa.a(parambfoa));
    ((Button)localObject2).setBackgroundDrawable(bfnm.a(-13544, azvv.a(bfoa.a(parambfoa), 3.0F)));
    i = azvv.a(bfoa.a(parambfoa), 9.0F);
    ((Button)localObject2).setPadding(0, i, 0, i);
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(0, -2, 1.0F);
    localLayoutParams.setMargins(azvv.a(bfoa.a(parambfoa), 5.0F), 0, azvv.a(bfoa.a(parambfoa), 5.0F), 0);
    ...
    Button localButton = new Button(bfoa.a(parambfoa));
    localButton.setBackgroundDrawable(bfnm.a(-1121584, azvv.a(bfoa.a(parambfoa), 3.0F)));
    ...
    this.jdField_a_of_type_Boolean = bfoa.a(parambfoa);
    localObject3 = bfoa.a(parambfoa);
    localObject4 = bfoa.b(parambfoa);
    localObject5 = bfoa.c(parambfoa);
    localObject6 = bfoa.d(parambfoa);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = bfoa.a(parambfoa);
    this.b = bfoa.b(parambfoa);
    boolean bool1 = bfoa.b(parambfoa);
    boolean bool2 = bfoa.c(parambfoa);
    if (!TextUtils.isEmpty((CharSequence)localObject3))
    {
      ...
      ((Button)localObject2).setOnClickListener(new bfny(this));
      label665:
      ...
      localButton.setOnClickListener(new bfnz(this));
    }
    for (;;)
    {
      setCancelable(bool1);
