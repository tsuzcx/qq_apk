  ...
  extends xfp
{
  ...
  private static ConcurrentHashMap<String, batt> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private static final String[] jdField_a_of_type_ArrayOfJavaLangString = { "GroupCare", "FriendClone", "groupnick", "profilelogic", "Face", "RoamWrap", "FontBubbleRecommend", "QCUniBusinessLogin", "ProfileMusicBox" };
  
  public static void a(batt parambatt)
  {
    jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(parambatt.a(), parambatt);
  }
  
  public static void b(batt parambatt)
  {
    jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(parambatt.a());
  }
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    else
    {
      ...
      {
        paramToServiceMsg = ((batt)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramToServiceMsg.getServiceCmd())).a(paramToServiceMsg, paramFromServiceMsg, localUniPacket);
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    Object localObject = (batt)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramToServiceMsg.getServiceCmd());
    int i = jdField_a_of_type_Int;
    jdField_a_of_type_Int = i + 1;
    ((batt)localObject).a(paramToServiceMsg, paramUniPacket, i);
    return true;
  }
