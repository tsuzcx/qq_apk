  ...
  extends ProxyWebViewClientExtension
{
  ...
  public bhom(bhoi parambhoi, TouchWebView paramTouchWebView, bhnj parambhnj)
  {
  ...
  public void onFakeLoginRecognised(Bundle paramBundle)
  {
    ...
    paramBundle = "";
    String str1 = "";
    if (this.jdField_a_of_type_Bhoi.jdField_a_of_type_ComTencentBizUiTouchWebView != null)
    {
      paramBundle = this.jdField_a_of_type_Bhoi.jdField_a_of_type_ComTencentBizUiTouchWebView.getOriginalUrl();
      str1 = this.jdField_a_of_type_Bhoi.jdField_a_of_type_ComTencentBizUiTouchWebView.getUrl();
      bhqc.a(paramBundle, str1, localStringBuilder.toString(), str2, bool2, bool3, bool1);
    }
    String str3;
    if (((localObject != null) && (((ArrayList)localObject).size() > 0)) || (bool1) || (!TextUtils.isEmpty(str2)))
    {
      str3 = this.jdField_a_of_type_Bhoi.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin();
      if (this.jdField_a_of_type_Bhoi.jdField_a_of_type_ComTencentBizUiTouchWebView == null) {
        break label321;
      }
    }
    label321:
    for (Object localObject = this.jdField_a_of_type_Bhoi.jdField_a_of_type_ComTencentBizUiTouchWebView.getTitle();; localObject = "")
    {
      bhqc.a(paramBundle, str1, (String)localObject, str3);
  ...
  public Object onMiscCallBack(String paramString, Bundle paramBundle)
  {
    if (this.jdField_a_of_type_Bhnj != null) {
      return this.jdField_a_of_type_Bhnj.handlerMiscCallback(paramString, paramBundle);
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_Bhnj != null) {
      this.jdField_a_of_type_Bhnj.handlePreloadCallback(paramInt, paramString);
    }
  }
  ...
  public void onUrlChange(String paramString1, String paramString2)
  {
    ...
    if (this.jdField_a_of_type_Bhnj != null) {
      this.jdField_a_of_type_Bhnj.onUrlChange(paramString1, paramString2);
    }
  }
