...
public class bhom
{
  ...
  private List<bhon> jdField_a_of_type_JavaUtilList;
  ...
  private Pair<Integer, List<bhon>> a(String paramString, int paramInt)
  {
    Object localObject = null;
    byte[] arrayOfByte = new bhph().a(paramString, null, 1);
  ...
  /* Error */
  private Pair<Integer, List<bhon>> a(byte[] paramArrayOfByte, int paramInt)
  {
    // Byte code:
    ...
    //   42: aload_0
    //   43: aload 7
    //   45: invokespecial 155	bhom:a	(Lorg/w3c/dom/Element;)I
    //   48: istore_3
    //   49: iload_3
    //   50: ifeq +8 -> 58
    //   53: iload_3
    ...
    //   208: aload_0
    //   209: aload 8
    //   211: invokespecial 172	bhom:a	(Lorg/w3c/dom/Node;)Lbhon;
    //   214: astore 8
    //   216: aload 8
    //   218: ifnull +127 -> 345
    //   221: aload 5
  ...
  private bhon a(Node paramNode)
  {
    ...
    do
    {
      for (;;)
      {
          ...
          else
          {
            ...
            if (str != null)
            {
              ...
              if (localObject != null) {
                ...
                {
                  localbhon.jdField_a_of_type_Int = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("type"))
                {
                  localbhon.jdField_b_of_type_Int = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("flags"))
                {
                  localbhon.c = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("path"))
                {
                  localbhon.jdField_b_of_type_JavaLangString = ((String)localObject);
                  i = k + 1;
                }
                else
                {
                  ...
                  {
                    localbhon.jdField_a_of_type_JavaLangString = ((String)localObject);
                    i = k + 1;
                  }
                }
              }
        ...
        localbhon.jdField_a_of_type_AndroidOsBundle = a(paramNode);
        return localbhon;
        j += 1;
        k = i;
      }
  ...
  private String a()
  {
    return bhms.a() + File.separator + "QSec.dat";
  }
  ...
  private boolean a(String paramString, int paramInt, List<bhon> paramList)
  {
    paramList = a(paramInt, paramList);
    if (paramList == null) {
      return false;
    }
    return new bhph().a(paramString, paramList, null, 1);
  }
  
  /* Error */
  private byte[] a(int paramInt, List<bhon> paramList)
  {
    // Byte code:
    ...
    //   132: ldc 182
    //   134: aload 6
    //   136: getfield 183	bhon:jdField_a_of_type_Int	I
    ...
    //   154: ldc 185
    //   156: aload 6
    //   158: getfield 188	bhon:jdField_b_of_type_Int	I
    ...
    //   198: ldc 200
    //   200: aload 6
    //   202: getfield 202	bhon:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   217: ldc 195
    //   219: aload 6
    //   221: getfield 198	bhon:jdField_b_of_type_JavaLangString	Ljava/lang/String;
  ...
  private bhon b(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      bhon localbhon = (bhon)localIterator.next();
      if (localbhon.jdField_a_of_type_Int == paramInt) {
        return localbhon;
      }
    }
    return null;
  ...
  {
    bhon localbhon = b(paramInt);
    if (localbhon == null) {}
    do
    {
      return;
      this.jdField_a_of_type_JavaUtilList.remove(localbhon);
    } while (!paramBoolean);
  ...
  public boolean a(bhon parambhon, boolean paramBoolean)
  {
    if (a(parambhon.jdField_a_of_type_Int)) {
      return false;
    }
    this.jdField_a_of_type_JavaUtilList.add(parambhon);
    if (paramBoolean) {
      return a();
    }
    return true;
