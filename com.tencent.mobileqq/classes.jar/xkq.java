...
public class xkq
{
  ...
  public static Bundle a(SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      localBundle = a(paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_Int);
  ...
  public static String a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, String paramString12, String paramString13, String paramString14, Bundle paramBundle)
  {
    ...
    localStringBuilder.append("&version=").append("8.2.8");
    ...
    if (!TextUtils.isEmpty(paramString6))
    {
      ...
      paramString4 = a(paramString8, true);
      paramString6 = a(paramString9, true);
      paramString7 = a(paramString10, true);
      paramString8 = a(paramString11, true);
      paramString9 = a(paramString12, true);
      paramString10 = a(paramString13, true);
    ...
    for (;;)
    {
      try
      {
        paramBaseActivity = HttpBaseUtil.a("http://jubao.qq.com/uniform_impeach/impeach_cryptokey", "GET", new Bundle()).jdField_a_of_type_JavaLangString;
        if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        paramBaseActivity.append("android").append("_").append("8.2.8").append("_").append(paramInt).append("_").append(paramString2);
        paramString2 = paramBaseActivity.toString();
        paramString11 = bdhv.d(paramString2).toUpperCase();
        if (QLog.isColorLevel()) {
        ...
        paramBaseActivity.append(paramString5).append("_").append(a(paramString3, false)).append("_").append(a(paramString4, false)).append("_").append(a(paramString6, false)).append("_").append(a(paramString7, false)).append("_").append(a(paramString8, false)).append("_").append(a(paramString9, false)).append("_").append(a(paramString10, false)).append("_").append(paramString11);
      ...
      break label138;
      localStringBuilder.append("&user_input_param=").append(a(paramString14, true));
      continue;
      label992:
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, Bundle paramBundle)
  {
    ...
    for (int i = paramBundle.getInt("chattype");; i = -1)
    {
      ...
      for (;;)
      {
        paramQQAppInterface = paramQQAppInterface.a().a(paramBundle, i, j);
        if (QLog.isColorLevel()) {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (paramList != null)
      {
        ...
        for (;;)
        {
          ...
          {
            paramList = new ayki(paramList.msg, 3).a();
            localObject2 = "1";
            i = 0;
            break label391;
          }
  ...
  public static void a(BaseActivity paramBaseActivity, long paramLong, String paramString1, String paramString2, int paramInt, String paramString3, Bundle paramBundle)
  {
    ...
    bcpq localbcpq = new bcpq(paramBaseActivity, paramBaseActivity.getTitleBarHeight());
    try
    {
      localbcpq.show();
      if (paramLong <= 0L)
      {
        ...
        ((aszj)paramBaseActivity.getAppInterface().getManager(204)).a(Long.parseLong(paramString1), new xkr(paramBaseActivity, paramString1, paramString2, paramInt, paramString3, localbcpq, paramBundle, paramLong));
        return;
      }
    }
    catch (Exception localException)
    {
      ...
      b(paramBaseActivity, String.valueOf(paramLong), paramString1, paramString2, c(paramInt), b(paramInt, paramString3), localbcpq, paramBundle);
    }
  }
  ...
  public static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt, String paramString6, Bundle paramBundle)
  {
    ...
    {
      localbcpq.show();
      ThreadManager.excute(new NewReportPlugin.3(paramInt, paramBaseActivity, paramString1, paramString4, paramBundle, paramString2, paramString3, paramString5, paramString6, localbcpq), 16, null, false);
      return;
    }
    catch (Exception localException)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        paramString1.putExtra("url", "http://jubao.qq.com/cn/jubao");
  ...
  public static String b(String paramString1, String paramString2)
  {
    ...
    try
    {
      str = bbbd.a(a(paramString1.getBytes("utf-8"), paramString2, 1));
      return str;
    }
  ...
  private static void b(BaseActivity paramBaseActivity, int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    label90:
    if ((paramInt == 1034) || (paramInt == 1033) || (paramInt == 1037) || (paramInt == 1044))
    {
  ...
  private static void b(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, bcpq parambcpq, Bundle paramBundle)
  {
    ThreadManager.excute(new NewReportPlugin.2(paramBundle, paramString4, paramInt, paramBaseActivity, paramString2, paramString3, paramString1, parambcpq), 16, null, false);
  }
  ...
  public static String c(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        paramString1 = bbbd.a(paramString1);
