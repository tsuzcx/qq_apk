  ...
  implements bazg
{
  ...
  public android.graphics.Bitmap getBitmap(java.net.URL paramURL)
  {
    ...
    //   105: aload_1
    //   106: invokestatic 79	bdhj:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   109: astore_1
    //   110: aload_1
    ...
    //   306: invokestatic 136	bayu:a	(Ljava/lang/String;)I
    //   309: istore_3
    //   310: iload_3
    //   311: ifne +30 -> 341
    //   314: aload_1
    //   315: invokevirtual 142	android/graphics/Bitmap:getWidth	()I
    //   318: aload 7
    ...
    //   327: astore 6
    //   329: aload_1
    //   330: invokevirtual 145	android/graphics/Bitmap:getHeight	()I
    //   333: aload 7
    //   335: getfield 56	com/tencent/mobileqq/activity/photo/LocalMediaInfo:thumbWidth	I
    //   338: if_icmpeq -204 -> 134
    //   341: aload_1
    //   342: invokevirtual 142	android/graphics/Bitmap:getWidth	()I
    //   345: istore 4
    //   347: aload_1
    //   348: invokevirtual 145	android/graphics/Bitmap:getHeight	()I
    //   351: istore 5
    //   353: new 95	android/graphics/Rect
    //   356: dup
    //   357: invokespecial 146	android/graphics/Rect:<init>	()V
    //   360: astore 6
    //   362: new 148	android/graphics/RectF
    //   365: dup
    //   366: fconst_0
    //   367: fconst_0
    //   368: aload 7
    ...
    //   379: i2f
    //   380: invokespecial 151	android/graphics/RectF:<init>	(FFFF)V
    //   383: astore 8
    //   385: iload 4
    //   387: iload 5
    ...
    //   413: iconst_0
    //   414: iadd
    //   415: invokevirtual 154	android/graphics/Rect:set	(IIII)V
    //   418: aload 7
    ...
    //   431: invokestatic 158	android/graphics/Bitmap:createBitmap	(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    //   434: astore 9
    //   436: new 160	android/graphics/Canvas
    //   439: dup
    //   440: aload 9
    //   442: invokespecial 163	android/graphics/Canvas:<init>	(Landroid/graphics/Bitmap;)V
    //   445: astore 10
    //   447: iload_3
    //   448: ifeq +26 -> 474
    //   451: aload 10
    ...
    //   469: fconst_2
    //   470: fdiv
    //   471: invokevirtual 167	android/graphics/Canvas:rotate	(FFF)V
    //   474: aload 10
    //   476: aload_1
    //   477: aload 6
    //   479: aload 8
    //   481: new 169	android/graphics/Paint
    //   484: dup
    //   485: bipush 6
    //   487: invokespecial 172	android/graphics/Paint:<init>	(I)V
    //   490: invokevirtual 176	android/graphics/Canvas:drawBitmap	(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    //   493: aload 9
    //   495: ifnull -196 -> 299
    //   498: aload_1
    //   499: invokevirtual 177	android/graphics/Bitmap:recycle	()V
    //   502: aload 9
    //   504: areturn
    //   505: iload 5
    //   507: iload 4
    ...
    //   525: iload 5
    //   527: iadd
    //   528: invokevirtual 154	android/graphics/Rect:set	(IIII)V
    //   531: goto -113 -> 418
    //   534: astore 6
    //   536: goto -260 -> 276
    //   539: astore 6
