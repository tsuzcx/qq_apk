...
public class aioy
{
  ...
  public static int a(long paramLong, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    int i = -1;
    aipj localaipj = aing.b(paramLong);
    if (localaipj != null) {
      i = localaipj.a();
    }
  ...
  private static boolean a(long paramLong, String paramString1, String paramString2, boolean paramBoolean, int paramInt)
  {
    if (paramString1.equals("cs.check_pubAccount_state.local")) {
      a(paramString1, paramString2, paramBoolean, new aioz(paramLong), paramInt);
    }
    label199:
    do
    {
      ...
      do
      {
        do
        {
          ...
          {
            a(paramString1, paramString2, paramBoolean, new aipa(paramLong), paramInt);
            return false;
          }
          if (!paramString1.equals("cs.get_dress_path.local")) {
            break label199;
          }
          localObject2 = new aipb(paramLong, paramString1);
          try
          {
            aipj localaipj = aing.b(paramLong);
            str = paramString2;
            if (localaipj != null)
            {
              ...
              {
                localJSONObject.put("gameId", localaipj.a());
        ...
        Object localObject1 = new aipc(paramLong);
  ...
  public static boolean a(long paramLong, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localaipx != null)
        {
          paramBoolean = localaipx.a(paramLong, paramBoolean, paramString1, paramString2);
          return paramBoolean;
        }
      }
