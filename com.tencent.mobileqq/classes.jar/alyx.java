...
public class alyx
{
  public static final String a = ajjy.a(2131649484);
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          String[] arrayOfString = bade.a(localObject2[i], "=");
          ...
          localObject2 = new String(baaw.decode(arrayOfString[1], 0));
          localObject1 = localObject2;
          if (!((String)localObject2).contains("&gc=")) {
            localObject1 = String.format("%s&gc=%s", new Object[] { localObject2, asfj.a(paramString2) });
          }
          paramString2 = baaw.encodeToString(((String)localObject1).getBytes(), 2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString1, int paramInt2, String paramString2, String paramString3)
  {
    for (;;)
    {
      try
      {
        localObject = ((alxy)paramQQAppInterface.getManager(269)).b();
        if (localObject != null) {
          continue;
        }
      ...
      localStringBuilder.append("&").append("quin").append("=").append(asfj.a(paramString1));
      localStringBuilder.append("&").append("topicId").append("=").append(paramInt2);
      localStringBuilder.append("&").append("sUin").append("=").append(asfj.a(paramString2));
      localStringBuilder.append("&").append("rUin").append("=").append(asfj.a(paramString3));
      ...
      return;
      localObject = ((alxu)localObject).o;
      continue;
      str = "aio_card_insert";
    }
  }
          ...
          for (;;)
          {
            ...
            catch (InvalidProtocolBufferMicroException paramStringBuilder)
            {
              try
              {
                ...
                paramList = (MessageForTroopConfess)awbi.a(-2067);
  ...
  public static Object[] a(String paramString)
  {
    ...
    for (Object localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();; localObject1 = null)
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (localObject2 != null) {
          if (azzz.a(str, ((TroopInfo)localObject2).troopowneruin))
          {
            i = 2;
      ...
      for (;;)
      {
        ...
        if (localObject1 != null)
        {
          paramString = ((atmp)localObject1).a(TroopMemberInfo.class, false, "troopuin=? ", new String[] { paramString }, null, null, null, null);
          ((atmp)localObject1).a();
        }
        for (;;)
        {
          ...
          if (paramString != null)
          {
            ...
            for (;;)
            {
              ...
              if (azzz.d(((TroopMemberInfo)localObject1).memberuin)) {
  ...
  {
    boolean bool2 = false;
    paramMessageRecord = azhy.a(paramMessageRecord);
    boolean bool1 = bool2;
