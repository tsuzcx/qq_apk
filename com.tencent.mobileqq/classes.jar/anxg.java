...
public class anxg
  implements anil, BusinessObserver
{
  ...
  private void I(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    a(paramBoolean, paramInt, localArrayList);
  ...
  private void O(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    a(paramBoolean, (bgbv)paramObject);
  }
  ...
  private void Q(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if ((paramObject instanceof Object[]))
    {
      ...
      if (paramObject.length > 0) {
        localObject1 = (beyq)paramObject[0];
      }
    }
    a(paramBoolean, (beyq)localObject1);
  }
  ...
  private void au(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    paramObject = (Object[])paramObject;
    b(paramBoolean, ((Long)paramObject[0]).longValue(), ((Integer)paramObject[1]).intValue());
  }
  ...
  private void bg(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    a(paramBoolean, ((Integer)paramObject[0]).intValue(), ((Long)paramObject[1]).longValue(), (bftv)paramObject[2]);
  }
  ...
  private void bj(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    {
      c(str1, str2, (String)localObject);
      return;
    }
  ...
  private void by(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    h(paramBoolean, (String)paramObject[0]);
  }
  ...
  private void bz(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    b((String)paramObject[0], ((Boolean)paramObject[1]).booleanValue());
  }
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong, bftv parambftv) {}
  ...
  protected void a(boolean paramBoolean1, String paramString1, ArrayList<ajce> paramArrayList, byte[] paramArrayOfByte, boolean paramBoolean2, String paramString2) {}
  ...
  protected void d(boolean paramBoolean, ArrayList<aius> paramArrayList) {}
