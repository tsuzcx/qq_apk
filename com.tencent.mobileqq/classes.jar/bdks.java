  ...
  implements Manager
{
  ...
  public long a;
  private bdkk jdField_a_of_type_Bdkk;
  private bdkq jdField_a_of_type_Bdkq;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private List<MessageRecord> jdField_a_of_type_JavaUtilList = new ArrayList();
  
  public bdks(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Bdkq = new bdkq(paramQQAppInterface);
  }
  
  private void a(DataLineMsgRecord paramDataLineMsgRecord, String paramString1, String paramString2, String paramString3, araj paramaraj)
  {
    if (!this.jdField_a_of_type_Bdkq.a())
    {
    ...
    this.jdField_a_of_type_Bdkq.a(paramDataLineMsgRecord);
    new Handler(ThreadManager.getSubThreadLooper()).postDelayed(new DataLineMessageSpreadManager.2(this, paramDataLineMsgRecord, paramString1, paramaraj, paramString2, paramString3), 1000L);
  }
  
  private boolean a(DataLineMsgRecord paramDataLineMsgRecord)
  {
    int i = this.jdField_a_of_type_Bdkq.a();
    int j = arak.a().a();
    if (j == 0) {
      if (QLog.isColorLevel()) {
  ...
  {
    this.jdField_a_of_type_Bdkq.a(paramarah);
  }
  ...
  public void a(DataLineMsgRecord paramDataLineMsgRecord, Context paramContext)
  {
    ...
    catch (Exception paramDataLineMsgRecord)
    {
      ...
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80098F8", "0X80098F8", 0, 0, "", "", "", "");
      ...
      bdho.a(paramDataLineMsgRecord, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 6, i);
    }
  }
  ...
  public void a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    {
      QLog.e("DataLineMessageSpreadManager", 1, atvo.a());
      return;
    }
    if (QLog.isColorLevel()) {
