...
{
  public bddx(SwitchAccountActivity paramSwitchAccountActivity) {}
  ...
  public void onFailed(String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      bdka.a().a("agent_login", this.a.jdField_a_of_type_Long, 0L, 0L, paramInt1, Long.parseLong(paramString), "1000069", "ret: " + paramInt2 + " | error: " + str);
      if (paramInt2 == -1000) {
      ...
      {
        paramInt1 = paramBundle.getInt("code");
        QLog.d("SwitchAccountActivity", 1, "rec | cmd: g_t_n_p | uin : *" + bdfb.a(paramString) + " | ret : " + paramInt2 + " - error: " + str + " | code: " + paramInt1);
        return;
        ...
        else
        {
          ...
          {
            localObject3 = this.a.getString(2131720661);
          }
  ...
  public void onGetTicketNoPasswd(String paramString, byte[] paramArrayOfByte, int paramInt, Bundle paramBundle)
  {
    ...
    QLog.d("SwitchAccountActivity", 1, "rec | cmd: g_t_n_p | uin : *" + bdfb.a(paramString) + " | ret : success | code: " + paramInt);
    try
    {
      bdka.a().a("agent_login", this.a.jdField_a_of_type_Long, 0L, 0L, 0, Long.parseLong(paramString), "1000069", null);
      return;
    }
  ...
  public void onUserCancel(String paramString, int paramInt, Bundle paramBundle)
  {
    this.a.e();
    paramInt = paramBundle.getInt("code");
    QLog.d("SwitchAccountActivity", 1, "rec | cmd: g_t_n_p | uin : *" + bdfb.a(paramString) + " | ret : on_user_cancel | code: " + paramInt);
  }
}
