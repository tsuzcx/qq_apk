...
public class baww
{
  ...
  public static void a(View paramView, baxb parambaxb)
  {
    paramView.setAccessibilityDelegate(new bawz(parambaxb));
  }
  ...
  public static void a(View paramView, CharSequence paramCharSequence, String paramString)
  {
    if (Build.VERSION.SDK_INT >= 14) {
      paramView.setAccessibilityDelegate(new baxa(paramCharSequence, paramString));
    }
  }
  ...
  public static void a(EditText paramEditText, String paramString)
  {
    if ((AppSetting.d) && (Build.VERSION.SDK_INT >= 14))
    {
      ...
      paramEditText.setAccessibilityDelegate(new bawx());
    }
  }
  ...
  public static void b(View paramView)
  {
    ...
    if ((localAccessibilityManager != null) && (Build.VERSION.SDK_INT >= 14) && (localAccessibilityManager.isEnabled()))
    {
      ...
      paramView.setAccessibilityDelegate(new bawy());
    }
  }
