  ...
  implements Manager
{
  ...
  public balh(AppInterface paramAppInterface)
  {
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, oidb_0x6b6.SendFlowerReq paramSendFlowerReq, oidb_0x6b6.ThrowFlowerReq paramThrowFlowerReq, long paramLong, balg parambalg)
  {
    if (parambalg == null)
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6b6. callback=" + parambalg);
      }
      label37:
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          if (myb.a().a(paramString2))
          {
            paramThrowFlowerReq = new oidb_0x6b6.AnonymousGroupMsg();
            paramString2 = myb.a().a(paramString2);
          ...
          if ((paramInt3 >= 4) && (System.currentTimeMillis() - ateo.jdField_a_of_type_Long < 600000L))
          {
            paramString2 = new oidb_0x6b6.GPSInfo();
            paramString2.int32_gps_type.set(1, true);
            paramString2.int64_longitude.set(ateo.jdField_a_of_type_ArrayOfLong[0], true);
            paramString2.int64_latitude.set(ateo.jdField_a_of_type_ArrayOfLong[1], true);
          ...
          mxf.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bali(this, parambalg), localReqBody.toByteArray(), paramString1 + "_" + paramInt2, paramInt1, paramInt2, paramString2, paramLong);
          return;
          if (paramInt2 != 11) {
            continue;
          }
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, oidb_0x6c3.GetStockReq paramGetStockReq, oidb_0x6c3.GetExtraDataReq paramGetExtraDataReq, long paramLong, balg parambalg)
  {
    if (parambalg == null)
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6c3. troopUin is null. callback=" + parambalg);
      }
      return;
    }
    ...
    for (paramGetStockReq = paramGetStockReq.getSkey(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());; paramGetStockReq = "")
    {
      ...
      mxf.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new balk(this, parambalg), localReqBody.toByteArray(), paramString1 + "_" + paramInt4, paramInt1, paramInt4, paramGetStockReq, paramLong);
      return;
    }
  }
  
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, long paramLong, balg parambalg)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (parambalg == null))
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6c2. troopUin=" + paramString1 + " giftBagID=" + paramString2 + " callback=" + parambalg);
      }
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          mxf.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new balm(this, parambalg, paramString1, paramString2), localReqBody.toByteArray(), "OidbSvc.0x6c2_" + paramInt3, 1730, paramInt3, (Bundle)localObject, paramLong);
          return;
        }
      }
  ...
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, balg parambalg)
  {
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      mxf.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new baln(this, parambalg), paramString1.toByteArray(), "OidbSvc.0x962_" + paramInt3, 2402, 1, paramString2, 500L);
      return;
    }
  ...
  private void b(balg parambalg)
  {
    ...
    mxf.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new balj(this, parambalg), localReqBody.toByteArray(), "OidbSvc.0xcd1_0", 3281, 0, null, 0L);
  }
  
  private void b(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, long paramLong, balg parambalg)
  {
    if ((TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString3)) || (parambalg == null))
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6b5. troopUin=" + paramString2 + " giftBagID=" + paramString3 + " callback=" + parambalg);
      }
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        paramInt2 = 1;
        mxf.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new ball(this, parambalg, paramString2, paramString3), localReqBody.toByteArray(), paramString1 + "_" + paramInt2, paramInt1, paramInt2, (Bundle)localObject, paramLong);
        return;
      }
      catch (NumberFormatException paramString1) {}
      if (!QLog.isColorLevel()) {
  ...
  public TroopGiftBagInfo a(String paramString1, String paramString2, balg parambalg)
  {
    ...
    TroopGiftBagInfo localTroopGiftBagInfo = (TroopGiftBagInfo)this.jdField_a_of_type_Aukp.a(TroopGiftBagInfo.class, paramString2);
    ...
    a(paramString1, paramString2, 0, 0, 1000L, parambalg);
    return null;
  }
  ...
  public void a(int paramInt, balg parambalg)
  {
    if (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
      return;
    }
    ...
    mxf.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new balp(this, parambalg), localReqBody.toByteArray(), "OidbSvc.0x9e9_0", 2537, 0);
  }
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, int paramInt6, int paramInt7, balg parambalg)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramInt3, paramString2, paramInt4, 0, null, localThrowFlowerReq, 0L, parambalg);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, long paramLong, int paramInt6, int paramInt7, int paramInt8, int paramInt9, balg parambalg, int paramInt10)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramInt3, paramString2, paramInt4, paramInt9, localSendFlowerReq, null, 0L, parambalg);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, int paramInt5, balg parambalg)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, null, localGetExtraDataReq, 0L, parambalg);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, balg parambalg)
  {
    a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, false, false, parambalg);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2, balg parambalg)
  {
    if (QLog.isColorLevel()) {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, localGetStockReq, null, 0L, parambalg);
      return;
    }
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, long paramLong, balg parambalg)
  {
    if (QLog.isColorLevel()) {
      QLog.e(".troop.send_gift .troop.send_gift", 2, "grabGift. troopUin:" + paramString2 + " bagID:" + paramString3);
    }
    b(paramString1, paramInt1, paramInt2, paramString2, paramString3, paramLong, parambalg);
  }
  
  public void a(String paramString, balg parambalg)
  {
    try
    {
      ...
      mxf.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new balq(this, parambalg), paramString.toByteArray(), "OidbSvc.0xa48_1", 2632, 1, new Bundle(), 6000L);
      return;
    }
    catch (Exception paramString)
    {
      parambalg.a(-1, "troop uin error");
    }
  }
  
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, long paramLong, balg parambalg)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramString2, paramInt1, paramInt2, 0, paramLong, parambalg);
  }
  
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, balg parambalg)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "reportInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, paramInt2, paramInt1, 3, parambalg);
  }
  
  public void a(String paramString1, String paramString2, int paramInt, balg parambalg)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "chechInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, 0, paramInt, 1, parambalg);
  }
  
  public void a(xcb paramxcb, int paramInt, String paramString, long paramLong, balg parambalg)
  {
    if ((paramxcb == null) || (parambalg == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localReqBody.product_id.set(paramxcb.jdField_a_of_type_Int, true);
      localReqBody.amount.set(paramxcb.f, true);
      ...
      try
      {
        ...
        mxf.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new balo(this, parambalg, paramxcb), localReqBody.toByteArray(), "OidbSvc.0xdad_" + paramInt, 3501, paramInt, paramString, 0L);
        return;
      }
      catch (NumberFormatException paramxcb) {}
    } while (!QLog.isColorLevel());
  ...
  {
    if ((this.jdField_a_of_type_Aukp == null) || (paramauko == null)) {}
    do
    {
      do
      {
  ...
  public void b(String paramString1, String paramString2, int paramInt, balg parambalg)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "startInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, 0, paramInt, 2, parambalg);
  }
