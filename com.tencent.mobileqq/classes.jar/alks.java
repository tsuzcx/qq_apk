...
public class alks
  extends ally<CameraEmotionData>
{
  private ConcurrentHashMap<Integer, CameraEmotionData> a = new ConcurrentHashMap();
  
  public alks(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          ((apjf)this.app.getManager(334)).a(localCameraEmotionData);
          ...
          paramToServiceMsg = azmz.a(BaseApplication.getContext());
          if (i != 0) {
            break label656;
          }
          bool = true;
  ...
  private void a(List<CameraEmotionRoaming_sso.ImgInfo> paramList, List<alkt> paramList1, List<String> paramList2)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (!bdje.a(str4))
      {
        ...
        paramList = "";
        label146:
        localalkt.b = paramList;
        if (str2 != null) {
          break label262;
        }
        paramList = "";
        label160:
        localalkt.c = paramList;
        if (str3 != null) {
          break label268;
        }
      }
  ...
  public void a()
  {
    ...
    String str = ((apjf)this.app.getManager(334)).a();
    ...
    localReqBody.bytes_version.set(ByteStringMicro.copyFrom("8.3.3".getBytes()));
  ...
  public void a(CameraEmotionData paramCameraEmotionData, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    ((CameraEmotionRoaming_sso.ReqBody)localObject2).bytes_version.set(ByteStringMicro.copyFrom("8.3.3".getBytes()));
  ...
  public void a(CameraEmotionData paramCameraEmotionData, boolean paramBoolean)
  {
    ...
    for (Object localObject1 = "";; localObject1 = paramCameraEmotionData.templateId)
    {
      ...
      ((CameraEmotionRoaming_sso.ReqBody)localObject1).bytes_version.set(ByteStringMicro.copyFrom("8.3.3".getBytes()));
  ...
  public void a(List<String> paramList, boolean paramBoolean)
  {
    ...
    paramList.bytes_version.set(ByteStringMicro.copyFrom("8.3.3".getBytes()));
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    case 3: 
      if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
      {
        ...
        for (paramToServiceMsg = "null";; paramToServiceMsg = Integer.valueOf(paramFromServiceMsg.getResultCode()))
        {
          ...
          aube.e(String.valueOf(paramFromServiceMsg.getResultCode()), 2);
          return;
        }
        aube.d("3002", 2);
        return;
    ...
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      ...
      for (paramToServiceMsg = "null";; paramToServiceMsg = Integer.valueOf(paramFromServiceMsg.getResultCode()))
      {
        ...
        aube.d(String.valueOf(paramFromServiceMsg.getResultCode()), 2);
        return;
      }
      aube.d("3003", 2);
      return;
