  ...
  extends aelz
{
  ...
  private aemg jdField_a_of_type_Aemg = new aemg(this, null);
  public Calendar a;
  Context b;
  public Calendar b;
  
  public aemd(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner, BaseChatPie paramBaseChatPie, aemf paramaemf)
  {
    super(paramQQAppInterface, paramContext, paramSessionInfo, paramAIOAnimationConatiner, paramBaseChatPie);
    this.jdField_a_of_type_Int = -1;
    this.jdField_b_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Aemf = paramaemf;
  }
  ...
  public int a(List<ChatMessage> paramList, int paramInt1, Calendar paramCalendar1, Calendar paramCalendar2, int paramInt2, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      if (i < this.jdField_a_of_type_JavaUtilList.size())
      {
        ...
        boolean bool2 = ayvy.b(paramCalendar1.msgtype);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramView = localaemj.a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Aemg);
    if (paramView != null) {
    ...
    for (;;)
    {
      ...
      {
        if ((localaemj instanceof ApolloItemBuilder))
        {
        ...
        else if ((localaemj instanceof afdb))
        {
          ((afdb)localaemj).a(false);
        }
      }
