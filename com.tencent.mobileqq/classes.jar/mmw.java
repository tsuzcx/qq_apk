...
public class mmw
  implements Handler.Callback, ViewTreeObserver.OnGlobalLayoutListener, asmr
{
  private final int jdField_a_of_type_Int = 2130842137;
  ...
  private final blhq jdField_a_of_type_Blhq = new blhq(Looper.getMainLooper(), this);
  private VideoChatRoomListView jdField_a_of_type_ComTencentAvUiChatroomVideoChatRoomListView;
  private final String jdField_a_of_type_JavaLangString = BaseApplication.getContext().getString(2131694863);
  private mnd jdField_a_of_type_Mnd;
  public boolean a;
  private final int jdField_b_of_type_Int = 2130842139;
  private final String jdField_b_of_type_JavaLangString = BaseApplication.getContext().getString(2131694866);
  private int c = 0;
  private int d = 0;
  private int e = -1;
  private int f = -1;
  
  private mmw(Activity paramActivity)
  {
  ...
  public static mmw a(Activity paramActivity)
  {
    return new mmw(paramActivity);
  }
  ...
  private void a(int paramInt, long paramLong)
  {
    if (this.d != paramInt)
    {
      ...
      this.d = paramInt;
      if (this.jdField_a_of_type_Mnd != null) {
        this.jdField_a_of_type_Mnd.a(this.d, paramLong);
      }
    }
  }
  ...
  private void g()
  {
    ...
    if ((localObject instanceof begz))
    {
      localbegz = (begz)localObject;
      localObject = null;
    }
    for (;;)
    {
      if (localbegz != null) {
        localObject = lkd.a(localbegz);
      }
      this.jdField_a_of_type_AndroidWidgetEditText.setText("");
      if ((this.jdField_a_of_type_Mnd != null) && (!TextUtils.isEmpty((CharSequence)localObject))) {
        this.jdField_a_of_type_Mnd.a((String)localObject);
      }
      return;
      localObject = localObject.toString();
      if (behh.a((String)localObject)) {
        localbegz = new begz((CharSequence)localObject, 3, 16);
      }
    }
  }
  ...
  private void h()
  {
    ...
    if (this.jdField_a_of_type_Blhq.hasMessages(2)) {
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842139);
    if (c())
    {
      a(5, l);
      f();
      ...
      localMessage.arg1 = 0;
      localMessage.arg2 = 0;
      this.jdField_a_of_type_Blhq.sendMessageDelayed(localMessage, 100L);
      return;
    }
    i();
  }
  ...
  private void i()
  {
    long l = AudioHelper.b();
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842139);
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_b_of_type_JavaLangString);
  ...
  private void j()
  {
    ...
    {
      if (this.jdField_a_of_type_Mnd != null) {
        this.jdField_a_of_type_Mnd.a(j, i, this.d, l);
      }
      return;
      i = 2;
      break;
  ...
  public mmw a(ViewGroup paramViewGroup)
  {
    this.jdField_a_of_type_AndroidViewViewGroup = paramViewGroup;
    return this;
  }
  
  public mmw a(EditText paramEditText)
  {
    this.jdField_a_of_type_AndroidWidgetEditText = paramEditText;
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusable(true);
    this.jdField_a_of_type_AndroidWidgetEditText.setFocusableInTouchMode(true);
    this.jdField_a_of_type_AndroidWidgetEditText.requestFocus();
    this.jdField_a_of_type_AndroidWidgetEditText.setEditableFactory(begz.a(16));
    this.jdField_a_of_type_AndroidWidgetEditText.setOnClickListener(new mmx(this));
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new mmy(this));
    this.jdField_a_of_type_AndroidWidgetEditText.setOnKeyListener(new mmz(this));
    ViewCompat.setAccessibilityDelegate(this.jdField_a_of_type_AndroidWidgetEditText, new mna(this));
    return this;
  }
  
  public mmw a(ImageView paramImageView)
  {
    this.jdField_a_of_type_AndroidWidgetImageView = paramImageView;
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842137);
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new mnb(this));
    return this;
  }
  
  public mmw a(VideoChatRoomListView paramVideoChatRoomListView)
  {
    this.jdField_a_of_type_ComTencentAvUiChatroomVideoChatRoomListView = paramVideoChatRoomListView;
    this.jdField_a_of_type_ComTencentAvUiChatroomVideoChatRoomListView.setOnDispatchTouchEventResponseListener(new mnc(this));
    return this;
  }
  
  public mmw a(mnd parammnd)
  {
    this.jdField_a_of_type_Mnd = parammnd;
    return this;
  }
  ...
  public void a(asmu paramasmu)
  {
    if ((paramasmu instanceof assj)) {
      ((assj)paramasmu).a(null, this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidWidgetEditText, null);
    }
  }
