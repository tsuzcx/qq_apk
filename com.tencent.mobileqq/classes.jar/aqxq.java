  ...
  implements View.OnClickListener
{
  ...
  public aqxq(HiBoomPanelView paramHiBoomPanelView, View paramView, boolean paramBoolean)
  {
    super(paramView);
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqHiboomSectorProgressView.getVisibility() == 0) {
      if (!this.jdField_a_of_type_ComTencentMobileqqHiboomSectorProgressView.a())
      {
        ...
        i = this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.jdField_a_of_type_Aqxp.a(this.jdField_a_of_type_Int);
        aqxh.a.a(i);
      }
    }
    do
    {
      ...
      do
      {
        ...
        {
          switch (this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.jdField_a_of_type_Aqxp.a(this.jdField_a_of_type_Int))
          {
          default: 
            return;
          }
          ...
          for (paramView = "0";; paramView = "1")
          {
            ...
            paramView = bbpp.a(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.getContext(), "font", "mvip.gexinghua.mobile.font.client_tab_store") + "&haibao=1";
      ...
      return;
      if (aqxh.b.compareAndSet(false, true))
      {
        paramView = (akfw)this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a.a(13);
        localObject = (aqxh)this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a.getManager(219);
        i = this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.jdField_a_of_type_Aqxp.a(this.jdField_a_of_type_Int);
        if (QLog.isColorLevel()) {
          QLog.d("HiBoomFont.HiBoomPanelView", 2, "onClick hiboomid = " + i);
        }
        if (((aqxh)localObject).c.contains(Integer.valueOf(i))) {
          paramView.a(i, true, this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomTextView.a());
        }
        for (;;)
        {
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a, "CliOper", "", "", "0X80094D7", "0X80094D7", 0, 0, "", "", "", "");
          return;
