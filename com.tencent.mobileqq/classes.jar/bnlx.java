  ...
  extends bnqb
{
  ...
  private static final String[] jdField_a_of_type_ArrayOfJavaLangString = { anvx.a(2131689787), anvx.a(2131689788), anvx.a(2131689789) };
  ...
  private void a()
  {
    ...
    this.jdField_b_of_type_AndroidViewAnimationAnimation.setAnimationListener(new bnly(this));
  ...
  private void a(Runnable paramRunnable)
  {
    ...
    localAnimationSet.setAnimationListener(new bnlz(this, paramRunnable));
  ...
  private void b()
  {
    ...
    localAnimationSet.addAnimation(localScaleAnimation);
    localAnimationSet.addAnimation(localTranslateAnimation);
    localAnimationSet.setAnimationListener(new bnma(this));
    this.jdField_a_of_type_AndroidViewView.startAnimation(localAnimationSet);
  }
  ...
  {
    if (!this.jdField_b_of_type_Boolean) {}
    while (bnqu.a().a("has_enter_aio_gif", false, 0)) {
      return false;
    }
    return true;
  }
  ...
  private void c()
  {
    ...
    bnqu.a().a("has_enter_aio_gif", true, 0);
  }
  ...
  {
    this.jdField_b_of_type_AndroidViewView = this.mRootView.findViewById(2131366963);
    this.jdField_a_of_type_AndroidViewView = this.mRootView.findViewById(2131367719);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367720));
  }
