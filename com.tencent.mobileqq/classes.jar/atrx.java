  ...
  implements atsd
{
  ...
  protected atrx(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, bfne parambfne)
  {
  ...
  private atry a()
  {
    atry localatry = new atry(this);
    if ((this.jdField_a_of_type_Bfmx != null) && ((this.jdField_a_of_type_Bfmx instanceof atsc)))
    {
      atsc localatsc = (atsc)this.jdField_a_of_type_Bfmx;
      localatry.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo = localatsc.a();
      localatry.jdField_a_of_type_Int = localatsc.a();
    }
    return localatry;
  }
  
  public static bfnc a(long paramLong, TroopFileTransferManager.Item paramItem, Bundle paramBundle, bfne parambfne)
  {
    if (paramLong == 0L)
    {
      bfmf.a("ExcitingTransfer.ExtfGroupDownloadWorker", bfmf.jdField_a_of_type_Int, "getWoker. troopuin=0");
      return null;
    }
    if (paramItem == null)
    {
      bfmf.a("ExcitingTransfer.ExtfGroupDownloadWorker", bfmf.jdField_a_of_type_Int, "getWoker. item=null");
      return null;
    }
    if (paramItem.Id == null)
    {
      bfmf.a("ExcitingTransfer.ExtfGroupDownloadWorker", bfmf.jdField_a_of_type_Int, "getWoker. item.id=null");
      return null;
    }
    return new atrx(paramLong, paramItem, paramBundle, parambfne);
  }
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramInt1 == 0)
    {
      bool = true;
      localatry = a();
      localatrw = new atrw(bfmd.a());
      localObject = auea.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName);
      localatrw.a(paramInt1, paramInt2, (String)localObject, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin);
      ...
      localatrw.c(this.g);
      label100:
      if ((localatry == null) || (localatry.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo == null)) {
        break label208;
      }
      localatrw.a(localatry.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo);
    }
    for (;;)
    {
      localatrw.a(this.jdField_a_of_type_Long);
      localatrw.a(this.jdField_b_of_type_Int);
      if ((localatry != null) && (localatry.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo != null)) {
        localatrw.b(aufd.b(localatry.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo.m_strLastServerHost));
      }
      localatrw.a(this.jdField_d_of_type_Boolean);
      localatrw.b(bool);
      return;
      bool = false;
      break;
      ...
      if (this.jdField_a_of_type_Bflq.jdField_a_of_type_Long > 0L) {
        ((ExcitingTransferDownloadCompletedInfo)localObject).m_uStartSize = this.jdField_a_of_type_Bflq.jdField_a_of_type_Long;
      }
      if (this.jdField_a_of_type_Bflq.jdField_b_of_type_Long > 0L) {
        ((ExcitingTransferDownloadCompletedInfo)localObject).m_uDownloadedSize = this.jdField_a_of_type_Bflq.jdField_b_of_type_Long;
      }
      if (paramInt3 != 0) {
        ((ExcitingTransferDownloadCompletedInfo)localObject).m_nSrvReturnCode = paramInt3;
      }
      localatrw.a((ExcitingTransferDownloadCompletedInfo)localObject);
    }
  }
  ...
  private void n()
  {
    ...
    atrw localatrw = new atrw(bfmd.a());
    Object localObject = auea.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName);
    localatrw.a(1, i, (String)localObject, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin);
    if ((this.f > 0L) && (this.g >= this.f))
    {
      localatrw.b(this.f);
      localatrw.c(this.g);
  ...
  protected int a()
  {
    if (b())
    {
      ...
      return aufd.b(this.jdField_a_of_type_Bfmx.e());
    }
    return super.a();
  }
  ...
  protected bfmx a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, boolean paramBoolean, String paramString3)
  {
    ...
    if (auea.b(paramString1)) {
      this.jdField_a_of_type_Boolean = true;
    }
    atsb localatsb = new atsb();
    localatsb.a(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal);
    localatsb.b(paramString2);
    localatsb.c(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.cookieValue);
    int i = 80;
    localatsb.a(paramBoolean);
    localatsb.d(paramString3);
    if (paramBoolean) {
      i = 443;
    }
    ...
    if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.DownloadDNS))
    {
      ...
      if (atlb.a().a(paramQQAppInterface, 3))
      {
        ...
        Object localObject = new atlc(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.DownloadDNS, i);
        localObject = atlb.a().a(paramQQAppInterface, (atlc)localObject, 3);
        if ((localObject != null) && (!((atle)localObject).a()))
        {
          ...
          i = ((atle)localObject).jdField_a_of_type_JavaUtilList.size() - 1;
          while (i >= 0)
          {
            paramString3 = (atld)((atle)localObject).jdField_a_of_type_JavaUtilList.get(i);
            paramString2.add(0, new ExcitingTransferHostInfo(paramString3.a(), paramString3.jdField_a_of_type_Int));
            i -= 1;
          }
          this.jdField_b_of_type_Int = 2;
          if (((atle)localObject).jdField_a_of_type_Int == 1) {
    ...
    for (;;)
    {
      localatsb.a(paramString2);
      paramQQAppInterface = atsc.a(paramQQAppInterface, paramLong, this.jdField_b_of_type_Long, paramString1, localatsb);
      if (paramQQAppInterface == null) {
        break;
      }
      ((atsc)paramQQAppInterface).a(this);
  ...
  public void a(int paramInt, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    for (int i = paramExcitingTransferOneSlotComplete.m_SrvRetCode;; i = 0)
    {
      ...
      if (paramInt != 0)
      {
        ...
        this.jdField_a_of_type_Bflq.d = 0;
        if (paramExcitingTransferOneSlotComplete == null) {
          break label222;
        }
        localatrz = new atrz(bfmd.a());
        localatrz.a(this.jdField_a_of_type_Long);
        str = auea.f(this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName);
        i = j(paramInt);
        if (i != 3) {
          break label207;
        }
      ...
      for (;;)
      {
        localatrz.a(paramInt, i, str, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal, this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.troopuin);
        localatrz.a(paramExcitingTransferOneSlotComplete);
        localatrz.a(this.jdField_b_of_type_Int);
        localatrz.b(aufd.b(paramExcitingTransferOneSlotComplete.m_strIp));
        localatrz.a(this.jdField_d_of_type_Boolean);
        localatrz.a();
        return;
        this.jdField_a_of_type_Bflq.jdField_c_of_type_Int = 0;
        this.jdField_a_of_type_Bflq.d = 0;
  ...
  public void a(String paramString)
  {
    if (b())
    {
      ...
      {
        bfmf.a("ExcitingTransfer.ExtfGroupDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "]  onDownloadSuccess but file is not exsited." + paramString);
        a(7, 706);
      ...
      do
      {
        ...
        {
          bfmf.a("ExcitingTransfer.ExtfGroupDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "]  file size check fail. filesize:" + this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.ProgressTotal + " transSize:" + l);
          a(7, 704);
        ...
        bfmf.c("ExcitingTransfer.ExtfGroupDownloadWorker", bfmf.jdField_a_of_type_Int, "[" + this.jdField_a_of_type_JavaLangString + "] onDownlaodSuc  mFilePath:" + paramString);
  ...
  protected void b()
  {
    ...
    if ((localatry != null) && (localatry.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo != null))
    {
      j = j(localatry.jdField_a_of_type_Int);
      i = 4;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        a(m, j, n);
        return;
        j = this.jdField_a_of_type_Bflq.d;
        i = j;
        if (j == 0) {
        ...
        if (this.jdField_c_of_type_Long == 0L)
        {
          k = d(this.jdField_a_of_type_Bflq.jdField_c_of_type_Int, this.jdField_a_of_type_Bflq.d);
          if (!this.jdField_c_of_type_Boolean) {
            break label220;
          }
          n = this.jdField_a_of_type_Bflq.d;
          i = 2;
          j = 7;
          k = 0;
          break;
  ...
  protected void c()
  {
    ...
    if (b())
    {
      ...
      if ((localatry != null) && (localatry.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo != null))
      {
        this.jdField_a_of_type_Bflq.jdField_a_of_type_Long = localatry.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo.m_uStartSize;
        this.jdField_a_of_type_Bflq.jdField_b_of_type_Long = localatry.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo.m_uDownloadedSize;
        this.jdField_a_of_type_Bflq.jdField_c_of_type_Long = localatry.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo.m_uTotalTimes;
        if ((this.jdField_a_of_type_Bflq.jdField_b_of_type_Long <= 0L) || (this.jdField_a_of_type_Bflq.jdField_c_of_type_Long <= 0L)) {
          break label139;
        }
        f = (float)this.jdField_a_of_type_Bflq.jdField_c_of_type_Long / 1000.0F;
      }
    }
    label139:
    for (this.jdField_a_of_type_Bflq.jdField_e_of_type_Long = (((float)this.jdField_a_of_type_Bflq.jdField_b_of_type_Long / f));; this.jdField_a_of_type_Bflq.jdField_e_of_type_Long = 0L)
    {
      super.c();
      if (b()) {
        a(0, 0, 0);
