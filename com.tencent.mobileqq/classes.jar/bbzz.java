  ...
  implements bbzr
{
  public void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, bbyn parambbyn)
  {
    ...
    do
    {
      ...
      QLog.e("SharpVideoDecoder", 2, "<---decodeC2CMsgPkg_SharpVideo return null:,isReaded:" + parambbyn.jdField_a_of_type_Boolean + "syncOther:" + parambbyn.f + ",isSharpRequest" + bool);
      return;
      if (bool)
      {
    ...
    if (l5 >= 60L)
    {
      ...
      if (bool)
      {
        ...
        parambbyn = new hd_video_2.MsgBody();
        k = -1;
        i1 = 0;
        i2 = 0;
        i = 0;
      ...
      for (;;)
      {
        try
        {
          parambbyn.mergeFrom(arrayOfByte2);
          j = i2;
          m = k;
          n = parambbyn.msg_invite_body.uint32_new_business_flag.get();
          j = i2;
          m = n;
          if (!parambbyn.msg_invite_body.msg_temp_session.has()) {
            continue;
          }
          k = i1;
          j = i2;
          m = n;
          if (parambbyn.msg_invite_body.msg_temp_session.uint32_relationship_type.has())
          {
            j = i2;
            m = n;
            i1 = VideoController.a(parambbyn.msg_invite_body.msg_temp_session.uint32_relationship_type.get(), false, 1);
            if (i1 != -1) {
              i = i1;
            }
            k = i;
