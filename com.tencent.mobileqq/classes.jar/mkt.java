...
class mkt
  implements Runnable
{
  mkt(mks parammks, oidb_0x5bd.GuideInfo paramGuideInfo1, oidb_0x5bd.RefreshInfo paramRefreshInfo, oidb_0x5bd.SkinInfo paramSkinInfo, oidb_0x5bd.GuideInfo paramGuideInfo2) {}
  
  public void run()
  {
    int j = (int)(System.currentTimeMillis() / 1000L);
    Object localObject2 = (ReadInJoyOperationManager)this.jdField_a_of_type_Mks.a.a.getManager(270);
    Object localObject1;
    Object localObject4;
    int i;
    if (this.jdField_a_of_type_TencentImOidbCmd0x5bdOidb_0x5bd$GuideInfo.has())
    {
      ...
      localObject3 = this.jdField_a_of_type_Mks.a.a.getEntityManagerFactory().createEntityManager();
      ...
      this.jdField_a_of_type_Mks.a.a(270, "operation_guide", (BaseResData)localObject3);
      ReadinjoyTabFrame.b(this.jdField_a_of_type_Mks.a, true);
    }
    for (;;)
    {
      i += 1;
      ...
      break;
      label271:
      if ((j <= ((BaseResData)localObject3).endTime) && (NetworkUtil.h(this.jdField_a_of_type_Mks.a.a()))) {
    ...
    label317:
    Object localObject3 = (ReadInJoyRefreshManager)this.jdField_a_of_type_Mks.a.a.getManager(269);
    if (this.jdField_a_of_type_TencentImOidbCmd0x5bdOidb_0x5bd$RefreshInfo.has())
    {
      ...
      localObject2 = ((ReadInJoyRefreshManager)localObject3).a(this.jdField_a_of_type_Mks.a.a());
      if (QLog.isColorLevel()) {
      ...
      {
        SharedPreUtils.v(this.jdField_a_of_type_Mks.a.a(), this.jdField_a_of_type_Mks.a.a.getCurrentAccountUin(), null);
      ...
      localObject3 = (ReadInJoySkinManager)this.jdField_a_of_type_Mks.a.a.getManager(260);
      if ((ReadinjoyTabFrame.a(this.jdField_a_of_type_Mks.a)) || (localObject4 == null) || (j < ((GuideData)localObject4).beginTime) || (j > ((GuideData)localObject4).endTime)) {
        break label809;
      }
      this.jdField_a_of_type_Mks.a.a(260, "", (BaseResData)localObject4);
      label599:
      localObject4 = ((ReadInJoySkinManager)localObject3).a(this.jdField_a_of_type_Mks.a.a());
      if ((localObject1 != null) || (((ReadInJoySkinManager)localObject3).a() != 1)) {
        break label861;
      }
      ReadinjoyTabFrame.a(this.jdField_a_of_type_Mks.a, ((ReadInJoySkinManager)localObject3).a());
      SharedPreUtils.u(this.jdField_a_of_type_Mks.a.a(), this.jdField_a_of_type_Mks.a.a.getCurrentAccountUin(), null);
      if ((localObject2 != null) && (j <= ((RefreshData)localObject2).endTime))
      {
        ((RefreshData)localObject2).isShown = true;
        SharedPreUtils.v(this.jdField_a_of_type_Mks.a.a(), this.jdField_a_of_type_Mks.a.a.getCurrentAccountUin(), ((RefreshData)localObject2).toJson().toString());
      }
    }
    label732:
    label861:
    while ((localObject1 == null) || (localObject4 == null) || (!((SkinData)localObject4).id.equals(((SkinData)localObject1).id)) || (((SkinData)localObject4).seq == ((SkinData)localObject1).seq))
    {
      ...
      localObject1 = null;
      break label480;
      if ((localObject4 == null) || (j > ((GuideData)localObject4).endTime) || (!NetworkUtil.h(this.jdField_a_of_type_Mks.a.a()))) {
        break label599;
      }
    ...
    label804:
    label809:
    SharedPreUtils.u(this.jdField_a_of_type_Mks.a.a(), this.jdField_a_of_type_Mks.a.a.getCurrentAccountUin(), ((SkinData)localObject1).toJson().toString());
    if (((SkinData)localObject1).id.equals(((ReadInJoySkinManager)localObject3).a()))
    {
      ReadinjoyTabFrame.a(this.jdField_a_of_type_Mks.a, ((SkinData)localObject1).id);
      return;
    }
