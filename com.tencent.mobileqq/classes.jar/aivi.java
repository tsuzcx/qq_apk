...
public class aivi
  extends atbh
{
  public aivi(ChatHistoryBaseTenDocFragment paramChatHistoryBaseTenDocFragment) {}
  ...
  public void a(View paramView)
  {
    ...
    TencentDocItem localTencentDocItem = ((aivf)paramView.getTag()).a;
    if (this.a.c)
    {
      this.a.jdField_a_of_type_Ajaq.a(localTencentDocItem);
      ChatHistoryBaseTenDocFragment.a(this.a).notifyDataSetChanged();
      return;
    }
    paramView = "unknown";
    if (asle.b(localTencentDocItem.mUrl)) {
      paramView = "doc";
    }
    for (;;)
    {
      ...
      bcef.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A16B", "0X800A16B", ChatHistoryBaseTenDocFragment.a(this.a), 0, "", "", "s_qq_history_tab", paramView);
      return;
      if (asle.e(localTencentDocItem.mUrl)) {
        paramView = "form";
      } else if (asle.d(localTencentDocItem.mUrl)) {
        paramView = "ppt";
      } else if (asle.c(localTencentDocItem.mUrl)) {
        paramView = "sheet";
      }
    }
  }
