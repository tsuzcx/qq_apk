  ...
  implements bewq
{
  ...
  private bewx jdField_a_of_type_Bewx;
  
  public beww(bewr parambewr)
  {
    bewo localbewo = parambewr.a;
    if (localbewo != null) {
      localbewo.setNetTransportEventListener("sig_check", this);
    }
    this.jdField_a_of_type_Bewr = parambewr;
  }
  
  public void a(bewx parambewx)
  {
    this.jdField_a_of_type_Bewx = parambewx;
  }
  
  public void a(Object paramObject1, Object paramObject2)
  {
    if (this.jdField_a_of_type_Bewx == null) {}
    label7:
    do
    {
      do
      {
        do
        {
          ...
          {
            return;
          } while (this.jdField_a_of_type_Bewr == null);
          paramObject1 = this.jdField_a_of_type_Bewr.a;
    ...
    try
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Bewx.a(paramObject1.toString());
        return;
      }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        l2 = l1;
        continue;
        localObject2 = this.jdField_a_of_type_Bewr.a;
        if (localObject2 == null) {
          continue;
        }
        localObject1 = paramString.toByteArray();
        localObject4 = ((bewo)localObject2).getCodec("sig_check");
        paramString = (String)localObject1;
        if (localObject4 != null) {
          paramString = ((bewp)localObject4).encode(localObject1);
        }
        ((bewo)localObject2).send(paramString);
        return;
      }
      try
      {
