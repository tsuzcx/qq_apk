  ...
  extends QIMEffectCameraCaptureUnit
{
  ...
  public bheu(bhzc parambhzc, bhzb parambhzb)
  {
    super(parambhzc, parambhzb);
    this.jdField_a_of_type_Bhyu = new bhyu(10012, 105, 11);
  ...
  public View a()
  {
    ...
    Object localObject1 = aybu.a(this.jdField_a_of_type_Bhzc.a().getIntent().getExtras());
    ...
    localObject1 = this.jdField_a_of_type_Bhzc.a().getIntent().getExtras();
    try
    {
      ...
      this.jdField_a_of_type_Bhzc.a().getIntent().putExtras((Bundle)localObject1);
    }
  ...
  protected auuv a()
  {
    ...
    if (awje.r > 2000000)
    {
      localauuv.j(2000000);
      awje.r = 2000000;
      urk.b("QIMTribeEffectsCameraCaptureUnit", "maxrate:" + awje.r);
    }
    localauuv.b(false);
    return localauuv;
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    {
      return;
      if (paramInt1 != ayac.jdField_a_of_type_Int) {
        break label87;
      }
      if (paramInt2 != -1) {
        break;
    ...
    if ((paramInt1 == 10012) && (paramInt2 == -1))
    {
      ...
      localActivity.startActivityForResult(localIntent, ayac.jdField_a_of_type_Int);
      return;
    }
    urk.d("QIMTribeEffectsCameraCaptureUnit", "onActivityResult, requestCode=%d, resultCode=%d, data=%s", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), paramIntent });
  }
  ...
  protected void y()
  {
    ThreadManager.post(new QIMTribeEffectsCameraCaptureUnit.1(this, this.jdField_a_of_type_Bhzc.a()), 5, null, true);
  }
}
