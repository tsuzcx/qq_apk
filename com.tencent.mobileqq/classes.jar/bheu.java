  ...
  extends anvi
{
  ...
  public bheu(bheh parambheh1, bheh parambheh2)
  {
    this.b = parambheh2;
  }
  ...
  protected void onUpdateCustomHead(boolean paramBoolean, String paramString)
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilHashtable.size() == 0) {
        this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.a.jdField_a_of_type_Bheu);
      }
      Object localObject = Uri.parse(bheh.a(this.a) + "&uin=" + paramString);
