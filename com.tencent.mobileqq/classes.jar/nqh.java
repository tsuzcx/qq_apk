  ...
  implements ampc<String>
{
  ...
  public static nqh a()
  {
    ...
    localnqh.jdField_a_of_type_JavaLangString = sfe.jdField_d_of_type_JavaLangString;
    localnqh.jdField_b_of_type_JavaLangString = sfe.jdField_e_of_type_JavaLangString;
    localnqh.jdField_b_of_type_Boolean = sfe.jdField_a_of_type_Boolean;
    localnqh.jdField_c_of_type_Boolean = sfe.p;
    localnqh.jdField_a_of_type_Boolean = sfe.jdField_b_of_type_Boolean;
    localnqh.jdField_d_of_type_Boolean = sfe.jdField_e_of_type_Boolean;
    localnqh.jdField_e_of_type_Boolean = sfe.jdField_f_of_type_Boolean;
    localnqh.jdField_f_of_type_Boolean = sfe.jdField_g_of_type_Boolean;
    localnqh.jdField_g_of_type_Boolean = sfe.jdField_h_of_type_Boolean;
    localnqh.jdField_h_of_type_Boolean = sfe.jdField_i_of_type_Boolean;
    localnqh.jdField_i_of_type_Boolean = sfe.l;
    localnqh.j = sfe.j;
    localnqh.jdField_c_of_type_JavaLangString = sfe.jdField_f_of_type_JavaLangString;
    localnqh.jdField_a_of_type_Long = sfe.jdField_a_of_type_Long;
    localnqh.k = sfe.m;
    localnqh.jdField_a_of_type_Int = sfe.jdField_b_of_type_Int;
    localnqh.jdField_d_of_type_JavaLangString = sfe.jdField_i_of_type_JavaLangString;
    localnqh.l = sfe.n;
    localnqh.m = sfe.jdField_c_of_type_Boolean;
    localnqh.n = sfe.o;
    localnqh.jdField_a_of_type_JavaUtilArrayList = sfe.jdField_a_of_type_JavaUtilArrayList;
    localnqh.jdField_b_of_type_Int = sfe.jdField_c_of_type_Int;
    localnqh.jdField_c_of_type_Int = sfe.jdField_d_of_type_Int;
    localnqh.jdField_d_of_type_Int = sfe.jdField_e_of_type_Int;
    localnqh.o = sfe.k;
    Object localObject = sfe.jdField_g_of_type_JavaLangString;
    localnqh.jdField_e_of_type_JavaLangString = ((String)localObject);
    localnqh.jdField_f_of_type_JavaLangString = sfe.jdField_h_of_type_JavaLangString;
    try
    {
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if (((JSONObject)localObject).has("useNewLogic")) {
          b(localnqh, (JSONObject)localObject);
        }
        if (((JSONObject)localObject).has("releaseServiceMinMem")) {
          a(localnqh, (JSONObject)localObject);
        }
      }
      return localnqh;
    }
  ...
  private nqh a(nqh paramnqh, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString.has("service_folder_name")) {
          this.jdField_a_of_type_JavaLangString = paramnqh.jdField_a_of_type_JavaLangString;
        }
        if (paramString.has("service_folder_icon")) {
          this.jdField_b_of_type_JavaLangString = paramnqh.jdField_b_of_type_JavaLangString;
        }
        if (paramString.has("service_folder_redspots")) {
          this.jdField_a_of_type_Boolean = paramnqh.jdField_a_of_type_Boolean;
        }
        if (paramString.has("service_folder_delete")) {
          this.jdField_b_of_type_Boolean = paramnqh.jdField_b_of_type_Boolean;
        }
        if (paramString.has("ServiceFolder_RedClean_After_Enter")) {
          this.jdField_c_of_type_Boolean = paramnqh.jdField_c_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload")) {
          this.jdField_d_of_type_Boolean = paramnqh.jdField_d_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_wifi")) {
          this.jdField_e_of_type_Boolean = paramnqh.jdField_e_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_4G")) {
          this.jdField_f_of_type_Boolean = paramnqh.jdField_f_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_3G")) {
          this.jdField_g_of_type_Boolean = paramnqh.jdField_g_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_2G")) {
          this.jdField_h_of_type_Boolean = paramnqh.jdField_h_of_type_Boolean;
        }
        if (paramString.has("pub_account_bottom_bar")) {
          this.jdField_i_of_type_Boolean = paramnqh.jdField_i_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_image_preload")) {
          this.j = paramnqh.j;
        }
        if (paramString.has("kandian_feeds_fling_LToR_host")) {
          this.jdField_c_of_type_JavaLangString = paramnqh.jdField_c_of_type_JavaLangString;
        }
        if (paramString.has("kandian_ad_background_showtime")) {
          this.jdField_a_of_type_Long = paramnqh.jdField_a_of_type_Long;
        }
        ...
        {
          this.jdField_a_of_type_Int = paramnqh.jdField_a_of_type_Int;
          this.jdField_d_of_type_JavaLangString = paramnqh.jdField_d_of_type_JavaLangString;
        }
        ...
        if ((i1 != 0) && (paramString.has("host_white_list"))) {
          this.jdField_a_of_type_JavaUtilArrayList = paramnqh.jdField_a_of_type_JavaUtilArrayList;
        }
        if (paramString.has("album_predown_enable")) {
          this.jdField_b_of_type_Int = paramnqh.jdField_b_of_type_Int;
        }
        if (paramString.has("album_predown_photo_rule")) {
          this.jdField_c_of_type_Int = paramnqh.jdField_c_of_type_Int;
        }
        if (paramString.has("album_predown_slide_photocounts")) {
          this.jdField_d_of_type_Int = paramnqh.jdField_d_of_type_Int;
        }
        ...
        {
          this.jdField_e_of_type_JavaLangString = paramnqh.jdField_e_of_type_JavaLangString;
          this.p = paramnqh.p;
          this.jdField_e_of_type_Int = paramnqh.jdField_e_of_type_Int;
          this.jdField_f_of_type_Int = paramnqh.jdField_f_of_type_Int;
          this.jdField_g_of_type_Int = paramnqh.jdField_g_of_type_Int;
          this.jdField_h_of_type_Int = paramnqh.jdField_h_of_type_Int;
        }
        if (paramString.has("releaseServiceMinMem"))
        {
          this.jdField_f_of_type_JavaLangString = paramnqh.jdField_f_of_type_JavaLangString;
          this.jdField_i_of_type_Int = paramnqh.jdField_i_of_type_Int;
          return this;
        }
      }
      catch (JSONException paramnqh)
      {
        paramnqh.printStackTrace();
      }
    }
    return this;
  }
  
  public static nqh a(amph[] paramArrayOfamph)
  {
    Object localObject1 = new nqh();
    ...
    if (paramArrayOfamph != null)
    {
      ...
      if (paramArrayOfamph.length > 0)
      {
        ...
        for (;;)
        {
          if (i1 >= paramArrayOfamph.length) {
            break label94;
          }
          str = paramArrayOfamph[i1].jdField_a_of_type_JavaLangString;
          try
          {
            localObject2 = ((nqh)localObject1).a((nqh)ampv.a(str, nqh.class), str);
  ...
  private static void a(nqh paramnqh, JSONObject paramJSONObject)
  {
    paramnqh.jdField_i_of_type_Int = paramJSONObject.optInt("releaseServiceMinMem", 80);
  }
  ...
  private static void b(nqh paramnqh, JSONObject paramJSONObject)
  {
    paramnqh.p = paramJSONObject.optBoolean("useNewLogic", false);
    paramnqh.jdField_e_of_type_Int = paramJSONObject.optInt("minTotalMem", 1024);
    paramnqh.jdField_f_of_type_Int = paramJSONObject.optInt("minAvailableMem", 100);
    paramnqh.jdField_g_of_type_Int = paramJSONObject.optInt("minCpuNum", 2);
    paramnqh.jdField_h_of_type_Int = paramJSONObject.optInt("minCpuFreq", 1000);
  }
  ...
  public void b()
  {
    sfe.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    sfe.jdField_e_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
    sfe.jdField_a_of_type_Boolean = this.jdField_b_of_type_Boolean;
    sfe.p = this.jdField_c_of_type_Boolean;
    sfe.jdField_b_of_type_Boolean = this.jdField_a_of_type_Boolean;
    sfe.jdField_e_of_type_Boolean = this.jdField_d_of_type_Boolean;
    sfe.jdField_f_of_type_Boolean = this.jdField_e_of_type_Boolean;
    sfe.jdField_g_of_type_Boolean = this.jdField_f_of_type_Boolean;
    sfe.jdField_h_of_type_Boolean = this.jdField_g_of_type_Boolean;
    sfe.jdField_i_of_type_Boolean = this.jdField_h_of_type_Boolean;
    sfe.l = this.jdField_i_of_type_Boolean;
    sfe.j = this.j;
    sfe.jdField_f_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
    sfe.jdField_a_of_type_Long = this.jdField_a_of_type_Long;
    sfe.m = this.k;
    sfe.jdField_b_of_type_Int = this.jdField_a_of_type_Int;
    sfe.jdField_i_of_type_JavaLangString = this.jdField_d_of_type_JavaLangString;
    sfe.n = this.l;
    sfe.jdField_c_of_type_Boolean = this.m;
    sfe.o = this.n;
    sfe.jdField_a_of_type_JavaUtilArrayList = this.jdField_a_of_type_JavaUtilArrayList;
    sfe.jdField_c_of_type_Int = this.jdField_b_of_type_Int;
    sfe.jdField_d_of_type_Int = this.jdField_c_of_type_Int;
    sfe.jdField_e_of_type_Int = this.jdField_d_of_type_Int;
    sfe.k = this.o;
    sfe.jdField_g_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
    sfe.jdField_h_of_type_JavaLangString = this.jdField_f_of_type_JavaLangString;
  }
  ...
  public void c()
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      sfe.b((QQAppInterface)localAppRuntime);
    }
  }
}
