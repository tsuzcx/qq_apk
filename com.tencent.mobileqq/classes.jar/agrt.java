  ...
  implements bixm
{
  ...
  private MessageQueue.IdleHandler jdField_a_of_type_AndroidOsMessageQueue$IdleHandler = new agru(this);
  public FragmentActivity a;
  private View jdField_a_of_type_AndroidViewView;
  public ViewGroup a;
  private bixm jdField_a_of_type_Bixm = new agrw(this);
  ...
  public agrt(BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetDrawerFrame.setDrawerCallbacks(this.jdField_a_of_type_Bixm);
    m();
  ...
  {
    boolean bool = true;
    if ((ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, null)) || (bdgb.b())) {
      bool = false;
    }
    return bool;
  }
  ...
  private void m()
  {
    ...
    if (localNavBarAIO != null) {
      localNavBarAIO.addOnLayoutChangeListener(new agrv(this, localNavBarAIO));
    }
  }
