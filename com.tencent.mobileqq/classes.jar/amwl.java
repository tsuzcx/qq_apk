  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramArrayOfByte.append(amwo.b(amwo.a(localRspBody.interact_info.interact_word.bytes_buluo_word.get().toStringUtf8())));
      ...
      {
        paramArrayOfByte.append(amwo.a((appoint_define.RichText)localRspBody.interact_info.interact_word.rich_fresh_word.get(), 14));
      }
      else
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            {
              paramArrayOfByte.append(amwo.a((appoint_define.RichText)localRspBody.follow_info.follow_word.rich_fresh_word.get(), 14));
            }
            else
            {
