...
public abstract class apod
  extends apoj
{
  private Context jdField_a_of_type_AndroidContentContext;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public apod(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  public boolean b()
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (l > 0L) && (l > ((aows)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(317)).a(bahk.a(str)).b)) {
      return true;
    }
    return l > 1048576L;
  }
