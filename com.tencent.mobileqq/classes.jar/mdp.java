...
public class mdp
  extends lee
{
  public mdp(DoubleVideoMeetingCtrlUI paramDoubleVideoMeetingCtrlUI) {}
      ...
      case 90: 
        if (paramLong3 == 3L) {
          if (this.a.jdField_a_of_type_ComTencentAvUiQavPanel != null)
          {
            ...
            this.a.jdField_a_of_type_ComTencentAvUiQavPanel.setViewVisibility(2131373771, 0);
          }
        }
        break;
      case 96: 
        for (;;)
        {
          if ((!locallfe.j) || (this.a.c))
          {
            this.a.c = false;
            this.a.j(paramLong1);
            paramInt1 = locallfe.a(this.a.jdField_b_of_type_Long, 1);
            boolean bool = false;
            if (paramInt1 != -1) {
              bool = ((lob)locallfe.c.get(paramInt1)).a;
            }
          ...
          return;
          if ((paramLong3 != 1L) || (locallfe.ap)) {
            break;
          }
          this.a.e("onGaOperationResult->REQUEST_VIDEO_SUC");
          this.a.a(paramLong1, locallfe.c);
          return;
          this.a.jdField_a_of_type_ComTencentAvUiQavPanel.setViewVisibility(2131373771, 8);
        }
      }
  ...
  protected void c(long paramLong, int paramInt)
  {
    ...
    if ((paramInt != -1) && (((lob)this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.get(paramInt)).a))
    {
  ...
  protected void d(long paramLong1, long paramLong2)
  {
    ...
    lfe locallfe = this.a.jdField_a_of_type_ComTencentAvVideoController.a();
    if ((paramLong2 == this.a.jdField_a_of_type_Long) && (locallfe.g == paramLong2)) {
      this.a.a(paramLong1, locallfe, 3);
    }
  }
}
