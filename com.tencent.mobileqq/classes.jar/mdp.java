...
{
  public mdp(GAudioMembersCtrlActivity paramGAudioMembersCtrlActivity, bkho parambkho) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvUiGAudioMembersCtrlActivity.a.a().W) {
      if (this.jdField_a_of_type_ComTencentAvUiGAudioMembersCtrlActivity.a.a().j == 1) {
        bcst.b(null, "CliOper", "", "", "0X8005C28", "0X8005C28", 0, 0, "", "", "", "");
      }
    }
    for (;;)
    {
      ...
      try
      {
        ...
        bcst.b(null, "CliOper", "", "", "0X8005C23", "0X8005C23", 0, 0, "", "", "", "");
        continue;
        if (this.jdField_a_of_type_ComTencentAvUiGAudioMembersCtrlActivity.a.a().j == 1)
        {
          bcst.b(null, "CliOper", "", "", "0X8005C27", "0X8005C27", 0, 0, "", "", "", "");
          continue;
        }
        if (this.jdField_a_of_type_ComTencentAvUiGAudioMembersCtrlActivity.a.a().j != 3000) {
          continue;
        }
        bcst.b(null, "CliOper", "", "", "0X8005C22", "0X8005C22", 0, 0, "", "", "", "");
      }
