...
public class bati
{
  ...
  public static batj a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    batj localbatj = new batj();
    localbatj.jdField_a_of_type_JavaLangString = a(paramString);
    String str;
    if (!localSharedPreferences.getBoolean("guideEnable", false))
    {
      ...
      localbatj.jdField_a_of_type_Int = 4;
      switch (localbatj.jdField_a_of_type_Int)
      {
      case 3: 
      default: 
        str = "P3";
    ...
    for (;;)
    {
      ...
      if (localSharedPreferences.getInt("guideToastOpen", 0) == 1)
      {
        ...
        for (;;)
        {
          ...
          bbmy.a(BaseApplicationImpl.getContext(), 2, str, i * 1000).a();
          localbatj.jdField_a_of_type_Int = 1;
          break;
          label258:
      ...
      if (localSharedPreferences.getInt("guidePopupOpen", 0) == 1)
      {
        ...
        if ((i == 0) || (i == 1))
        {
          ...
          {
            localbatj.jdField_a_of_type_Int = 3;
          ...
          for (str = "lastTipTime_";; str = "lastDialogTime_")
          {
            ...
            if (localbatj.jdField_a_of_type_Int == 4) {
              break;
            }
            localSharedPreferences.edit().putLong(str, l).commit();
            break;
            localbatj.jdField_a_of_type_Int = 2;
            break label365;
          }
        }
        localbatj.jdField_a_of_type_Int = 4;
  ...
  public static void a(TrafficResultInfo paramTrafficResultInfo, Bundle paramBundle)
  {
    ...
    boolean bool1 = paramBundle.getBoolean(ajve.h);
    boolean bool3 = paramBundle.getBoolean(ajve.i);
    String str2 = paramBundle.getString(ajve.j);
    String str1 = paramBundle.getString(ajve.k);
  ...
  public static boolean a(Activity paramActivity, int paramInt, batk parambatk, String paramString)
  {
    boolean bool = true;
    ...
    {
      return bool;
      localbatj = a(paramString, false, true);
      if (QLog.isColorLevel()) {
        QLog.i("CUKingCardHelper", 2, "shouldOverrideDialog, popUpType: " + localbatj.jdField_a_of_type_Int);
      }
    } while (localbatj.jdField_a_of_type_Int == 4);
    if (localbatj.jdField_a_of_type_Int == 1)
    {
      if (parambatk != null) {
        parambatk.callback(2);
      }
      return false;
    }
    new bath(paramActivity, parambatk, paramInt, paramString, localbatj.jdField_a_of_type_Int).show();
    return false;
  }
