...
public class awml
{
  ...
  private Map<Integer, awmm> e = new ConcurrentHashMap();
  ...
  public awml(AppInterface paramAppInterface)
  {
  ...
  {
    return aljq.cn + "defaultCard" + File.separator + paramString + ".json";
  }
  ...
  {
    return bcyw.c(paramContext) + paramLong + ".zip";
  }
  ...
  public awmm a(int paramInt, boolean paramBoolean)
  {
    try
    {
      awmm localawmm = (awmm)this.e.get(Integer.valueOf(paramInt));
      if (localawmm == null)
      {
        localawmm = new awmm(this, paramInt);
        this.e.put(Integer.valueOf(paramInt), localawmm);
      }
      for (;;)
      {
        Object localObject2;
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        ...
        try
        {
          bdcs.a(paramQQAppInterface.getAbsolutePath(), paramString1, false);
          ...
          if (paramString2.exists())
          {
            ...
            bdcs.a(paramString2.getAbsolutePath(), str, false);
