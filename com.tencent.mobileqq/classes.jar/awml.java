...
public class awml
{
  ...
  public static String a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      if (paramInt3 == 3) {
        return anzj.a(2131693264);
      }
      if (paramInt3 == 2) {
        return anzj.a(2131693273);
      }
      if (paramInt3 == 1) {
        return anzj.a(2131693285);
      }
      return anzj.a(2131693281);
    }
    if (paramInt2 > 1) {
      return paramInt2 + anzj.a(2131693279);
    }
    if (paramInt2 == 1) {
      return paramInt2 + anzj.a(2131693295);
    }
    return anzj.a(2131693281);
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2)
  {
    ...
    if (paramInt == 2) {
      str = bhlg.a(paramQQAppInterface, paramString2);
    }
    for (;;)
    {
      ...
      break;
      if (paramInt == 1) {
        str = bhlg.h(paramQQAppInterface, paramString1, paramString2);
      }
    }
  }
  ...
  public static void a(Activity paramActivity, int paramInt, String paramString)
  {
    ...
    localIntent.putExtra("url", blhn.a(blhn.a(blhn.a(blhn.a(QzoneConfig.getInstance().getConfig("H5Url", "YQHMusicPersonalPlayerUrl", "https://zb.vip.qq.com/v2/musicTheme"), "uin", paramString), "uinType", String.valueOf(paramInt)), "type", "2"), "_wv", "5123"));
    paramActivity.startActivity(localIntent);
    bdll.b(null, "dc00898", "", "", "qq_vip", "0X800A5C2", 1, 0, "", "", VipUtils.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()), "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, int paramInt, String paramString)
  {
    ...
    paramQQAppInterface.putExtra("url", blhn.a(blhn.a(blhn.a(blhn.a("https://web.qun.qq.com/qunmusic/listener", "uin", paramString), "uinType", String.valueOf(paramInt)), "_wwv", "128"), "_wv", "2"));
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString, int paramInt2)
  {
    ...
    for (boolean bool = ((TroopInfo)localObject).isAdmin();; bool = false)
    {
      if (!bool)
      {
        ...
        {
          QQToast.a(BaseApplication.getContext(), 2131693276, 0).a();
          return;
        }
  ...
  {
    if (bejx.a(paramQQAppInterface).a(paramContext, 1, paramString, paramInt2)) {
      return;
    }
    Intent localIntent = new Intent(paramContext, QQBrowserActivity.class);
    String str2 = blhn.a("https://web.qun.qq.com/qunmusic/index", "uin", paramString);
    ...
    if (!TextUtils.isEmpty(str3)) {
      str1 = blhn.a(str2, "themeId", str3);
    }
    str2 = blhn.a(str1, "uinType", String.valueOf(paramInt1));
    if (bool)
    {
      str1 = "1";
      str2 = blhn.a(blhn.a(blhn.a(str2, "showlrc", str1), "_wv", "2"), "_wwv", "128");
      if (!localListenTogetherManager.b(paramInt1, paramString)) {
        break label260;
      }
      str1 = "1";
      label160:
      str2 = blhn.a(blhn.a(str2, "isJoin", str1), "from", String.valueOf(paramInt2));
    ...
    for (str1 = "1";; str1 = "0")
    {
      localIntent.putExtra("url", blhn.a(str2, "isNew", str1));
