...
{
  public akmp(QuickLoginAuthorityActivity paramQuickLoginAuthorityActivity) {}
  ...
  public void onFailed(String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    if (paramBundle == null) {}
    for (paramBundle = this.a.getString(2131435593);; paramBundle = paramBundle.getMessage())
    {
