...
public class akmp
  extends bdqc
{
  public akmp(SettingMeApolloViewController paramSettingMeApolloViewController) {}
  ...
  protected void onGetExploreMsg(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean) {
      try
      {
        ...
        localObject = new akox(localQQAppInterface, (JSONObject)localObject, localQQSettingMe);
        this.a.jdField_a_of_type_Akot.a((akov)localObject);
        if ((localQQSettingMe.a()) && (SettingMeApolloViewController.a(this.a) > 0)) {
          this.a.jdField_a_of_type_Akot.a(SettingMeApolloViewController.a(this.a), localViewGroup.getContext(), localQQAppInterface, this.a.jdField_a_of_type_Int);
        }
