...
public class auoo
{
  ...
  public static Intent a(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity)
  {
    ...
    paramActivity.putExtra("forward_text", anzj.a(2131708591) + aunj.d(paramFileManagerEntity.fileName) + anzj.a(2131708603) + auog.a(paramFileManagerEntity.fileSize) + "。");
    paramActivity.putExtra("k_favorites", aunj.c(paramFileManagerEntity));
    if ((!auog.b(paramFileManagerEntity.getFilePath())) && ((paramFileManagerEntity.getCloudType() == 6) || (paramFileManagerEntity.getCloudType() == 7)) && (paramFileManagerEntity.nFileType == 0)) {
      paramActivity.putExtra("forward_type", 0);
    }
  ...
  public static Intent a(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
    ...
    bftf localbftf = bgsk.a(paramQQAppInterface, localFileManagerEntity);
    ...
    if (!TextUtils.isEmpty(localFileManagerEntity.getFilePath())) {
      localForwardFileInfo.a(localbftf.jdField_a_of_type_JavaLangString);
    }
    localForwardFileInfo.d(localbftf.g);
    localForwardFileInfo.d(localbftf.jdField_c_of_type_Long);
    localForwardFileInfo.a(localFileManagerEntity.TroopUin);
    paramFileManagerEntity = localbftf.d;
    paramQQAppInterface = paramFileManagerEntity;
    if (TextUtils.isEmpty(paramFileManagerEntity)) {
      paramQQAppInterface = localbftf.jdField_c_of_type_JavaLangString;
    }
    ...
    for (;;)
    {
      ...
      paramFileManagerEntity.putExtra("forward_text", localbftf.g);
      paramFileManagerEntity.putExtra("forward_from_troop_file", true);
      return paramFileManagerEntity;
      if (localbftf.jdField_a_of_type_JavaUtilUUID != null) {
        localForwardFileInfo.e(localbftf.jdField_a_of_type_JavaUtilUUID.toString());
      }
  ...
  public static SpannableString a(String paramString1, String paramString2, aunx paramaunx)
  {
    ...
    for (int i = Color.parseColor("#A3CCEF");; i = j)
    {
      ...
      paramString1.setSpan(new aupd(new auop(paramaunx), paramString2), k, k + m, 33);
      return paramString1;
    }
  }
  
  public static bftf a(QQAppInterface paramQQAppInterface, long paramLong, bfrs parambfrs)
  {
    bftf localbftf2 = TroopFileTransferManager.a(paramQQAppInterface, paramLong).a(parambfrs.b);
    bftf localbftf1 = localbftf2;
    if (localbftf2 == null)
    {
      localbftf1 = bgsk.a(paramQQAppInterface, paramLong, parambfrs.jdField_a_of_type_JavaUtilUUID.toString(), parambfrs.b, parambfrs.jdField_c_of_type_JavaLangString, parambfrs.jdField_a_of_type_Long, parambfrs.jdField_a_of_type_Int);
  ...
  public static String a(Context paramContext, int paramInt1, int paramInt2, TextView paramTextView1, TextView paramTextView2, String paramString1, String paramString2)
  {
    ...
    int i = agej.a(7.0F, paramContext.getResources());
    int j = (int)paramTextView2.measureText(paramString2);
    int k = agej.a(15.0F, paramContext.getResources());
    switch (paramInt1)
    {
    case 1: 
    default: 
  ...
  public static String a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      if (localStringBuilder.length() > 0) {
        localStringBuilder.append(paramContext.getString(2131692144));
      }
  ...
  public static String a(Bitmap paramBitmap)
  {
    ...
    localFile = new File(aumo.a().b() + ".video_frame/");
    bhmi.a(localFile.getAbsolutePath());
    localFile.mkdirs();
    localFile = new File(localFile.getAbsolutePath(), System.currentTimeMillis() + ".jpg");
    try
    {
      bhmq.a(paramBitmap, localFile);
  ...
  private static String a(AppInterface paramAppInterface, MessageForTroopFile paramMessageForTroopFile)
  {
    ...
    for (;;)
    {
      if ((!TextUtils.isEmpty((CharSequence)localObject)) && (aunj.b((String)localObject)))
      {
        if (QLog.isDebugVersion()) {
      ...
      str1 = str1 + bhml.a(paramAppInterface.getBytes()) + ".tmp";
      if (auog.a(str1) > 0L) {
        localObject = str1;
      }
      for (;;)
      {
        if (aunj.b((String)localObject))
        {
          if (QLog.isDebugVersion()) {
        ...
        paramAppInterface = aumo.a().c() + blev.a(paramAppInterface);
        if (!aunj.b(paramAppInterface)) {
          break;
        }
        if (QLog.isDebugVersion()) {
  ...
  {
    Object localObject = (bgsl)paramQQAppInterface.getManager(48);
    if (localObject != null)
    {
      if (((bgsl)localObject).a(String.valueOf(paramLong1), String.valueOf(paramLong2))) {
        return anzj.a(2131708592);
      }
      localObject = ((bgsl)localObject).a(String.valueOf(paramLong1));
      paramQQAppInterface = (TroopManager)paramQQAppInterface.getManager(52);
      if ((localObject != null) && (((bgss)localObject).jdField_a_of_type_Long != 0L))
      {
        if (paramQQAppInterface != null)
        {
  ...
  public static void a(Context paramContext, Rect paramRect, ChatMessage paramChatMessage, SessionInfo paramSessionInfo, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, MessageForReplyText paramMessageForReplyText)
  {
    ...
    for (;;)
    {
      ...
      paramBoolean1 = ayxt.a(BaseApplicationImpl.sApplication.getRuntime().getAccount(), 1);
      localBundle.putBoolean("extra.OCR", paramBoolean1);
      if (paramBoolean1)
      {
        paramMessageForReplyText = ayxt.a(BaseApplicationImpl.sApplication.getRuntime().getAccount());
      ...
      try
      {
        ...
        if ((paramChatMessage instanceof MessageForFile))
        {
          if ((paramContext instanceof SplashActivity))
          {
            ...
            bmgb.a(paramContext, localBundle, new AIOImageProviderService(paramRect, paramChatMessage.frienduin, paramChatMessage.istroop, paramChatMessage), aicv.a(paramChatMessage, paramMessageForReplyText), -1, i);
            return;
          }
        ...
        {
          localBundle.putBoolean("extra.ENTER_NEW_GALLERY", true);
          bmgb.a(paramContext, localBundle, new AIOImageProviderService(paramRect, paramChatMessage.frienduin, paramChatMessage.istroop, paramChatMessage), aicv.a(paramChatMessage, paramMessageForReplyText), -1, paramSessionInfo.c);
          return;
        }
      }
  ...
  public static void a(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, aunx paramaunx)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty(paramString2))) {
      if (paramTextView.getWidth() == 0) {
        paramTextView.post(new QFileUtils.2(paramContext, paramTextView, paramString1, paramString2, paramString3, paramString4, paramString5, paramBoolean, paramaunx));
      }
    }
    while (TextUtils.isEmpty(str.replace(" ", "")))
    {
      return;
      b(paramContext, paramTextView, paramString1, paramString2, paramString3, paramString4, paramString5, paramBoolean, paramaunx);
      return;
    }
  ...
  public static void a(Context paramContext, String paramString, auez paramauez)
  {
    if (!bhmi.b(paramString)) {
      return;
    }
    ThreadManagerV2.executeOnSubThread(new QFileUtils.5(paramContext, paramString, paramauez));
  }
  ...
  {
    if (bhnv.a(paramActivity) == 0)
    {
      bgri.a(paramActivity, paramActivity.getString(2131696937));
      return;
    }
    ...
    auxu.a(paramActivity, paramQQAppInterface, ForwardRecentTranslucentActivity.class, 103);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong1, String paramString1, String paramString2, String paramString3, long paramLong2, int paramInt)
  {
    ...
    {
      return;
      paramString2 = bgsk.a(paramQQAppInterface, paramLong1, paramString1, paramString2, paramString3, paramLong2, paramInt);
    } while (paramString2 == null);
    paramString1 = new Bundle();
    paramString1.putInt("dataline_forward_type", 100);
    if (bhmi.b(paramString2.jdField_a_of_type_JavaLangString)) {
      paramString1.putString("dataline_forward_path", paramString2.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      paramQQAppInterface = (anvu)paramQQAppInterface.a(8);
      paramString2 = new auow(paramContext);
      paramInt = paramQQAppInterface.a().b(antf.z, paramString1, paramString2);
      if ((paramString2.a) && (paramInt != 0)) {
        break;
      }
      dc.b(paramContext, paramInt);
      return;
      paramString3 = aunj.a(paramString2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ChatMessage paramChatMessage, long paramLong1, bftf parambftf, String paramString, long paramLong2, int paramInt1, int paramInt2, Rect paramRect, boolean paramBoolean1, boolean paramBoolean2)
  {
    a(paramQQAppInterface, paramContext, paramSessionInfo, paramChatMessage, paramLong1, parambftf, paramString, paramLong2, paramInt1, paramInt2, paramRect, paramBoolean1, paramBoolean2, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ChatMessage paramChatMessage, long paramLong1, bftf parambftf, String paramString, long paramLong2, int paramInt1, int paramInt2, Rect paramRect, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (;;)
    {
      parambftf = new auhx(paramQQAppInterface, paramContext, paramLong1, parambftf, paramInt1);
      parambftf.a(paramLong2);
      parambftf.a(paramString);
      parambftf.a(paramSessionInfo);
      parambftf.a(paramChatMessage);
      parambftf.a(paramBoolean1);
      parambftf.b(paramBoolean3);
      ...
      paramContext = new auht(paramContext, parambftf);
  ...
  {
    paramQQAppInterface = new auhr(paramQQAppInterface, paramContext, paramFileManagerEntity, paramInt2);
    new Bundle();
    ...
    paramQQAppInterface = new auht(paramContext, paramQQAppInterface);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, FileManagerEntity paramFileManagerEntity)
  {
    ...
    do
    {
      ...
      paramFileManagerEntity = (anvu)paramQQAppInterface.a(8);
      localauou = new auou(paramContext);
      i = paramFileManagerEntity.a().b(antf.z, localBundle, localauou);
    } while ((localauou.a) && (i != 0));
    dc.b(paramContext, i);
    bdll.b(paramQQAppInterface, "CliOper", "", "", "0X800644B", "0X800644B", 0, 0, "6", "", "", "");
  }
  ...
  {
    if ((paramMessageRecord1 == null) || (!aunj.a(paramMessageRecord1))) {}
    int i;
    do
    {
      String str;
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<bfrs> paramList, Activity paramActivity, long paramLong)
  {
    ...
    {
      bftf localbftf = a(paramQQAppInterface, paramLong, (bfrs)paramList.next());
      FileManagerEntity localFileManagerEntity = aunj.a(localbftf);
      localFileManagerEntity.status = 2;
      ...
      if (!TextUtils.isEmpty(localbftf.jdField_c_of_type_JavaLangString))
      {
        localForwardFileInfo.f(localbftf.jdField_c_of_type_JavaLangString);
        label209:
        localForwardFileInfo.d(1);
        localForwardFileInfo.a(3);
        if (!bhmi.b(localbftf.jdField_a_of_type_JavaLangString)) {
          break label295;
        }
        localArrayList2.add(Uri.parse(localbftf.jdField_a_of_type_JavaLangString));
      }
      for (;;)
      {
        long l2 = localbftf.jdField_c_of_type_Long;
        localArrayList1.add(localForwardFileInfo);
        l1 = l2 + l1;
        break;
        if (TextUtils.isEmpty(localbftf.d)) {
          break label209;
        }
        localForwardFileInfo.f(localbftf.d);
        break label209;
        label295:
    ...
    paramQQAppInterface = anzj.a(2131708593);
    if (localArrayList1.size() == 1) {
      paramQQAppInterface = anzj.a(2131708601) + aunj.d(((ForwardFileInfo)localArrayList1.get(0)).d()) + anzj.a(2131708602) + auog.a(((ForwardFileInfo)localArrayList1.get(0)).d()) + "。";
    }
    for (;;)
    {
      paramList.putExtra("forward_text", paramQQAppInterface);
      paramList.putExtra("k_favorites", false);
      auxu.a(paramActivity, paramList, 103);
      return;
      if (localArrayList1.size() > 1) {
        paramQQAppInterface = anzj.a(2131708597) + aunj.d(((ForwardFileInfo)localArrayList1.get(0)).d()) + anzj.a(2131708596) + localArrayList1.size() + anzj.a(2131708599) + auog.a(l1) + "。";
      }
    }
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    String str1 = aunj.a(paramString);
    String str2 = bezl.a(paramContext, str1);
  ...
  public static boolean a(Context paramContext, String paramString, Uri paramUri)
  {
    ...
    //   10: istore 4
    //   12: aload_1
    //   13: invokestatic 763	bhmi:b	(Ljava/lang/String;)Z
    //   16: ifne +10 -> 26
    //   19: iload 4
    //   21: istore 5
    //   23: iload 5
    ...
    //   35: istore 5
    //   37: aload_0
    //   38: invokevirtual 1314	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   41: aload_2
    //   42: ldc_w 1330
    //   45: invokevirtual 1334	android/content/ContentResolver:openFileDescriptor	(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    //   48: astore_2
    //   49: aload_2
    //   50: ifnonnull +64 -> 114
    //   53: iconst_0
    //   54: ifeq +11 -> 65
    //   57: new 1336	java/lang/NullPointerException
    //   60: dup
    //   61: invokespecial 1337	java/lang/NullPointerException:<init>	()V
    //   64: athrow
    //   65: iconst_0
    //   66: ifeq +11 -> 77
    //   69: new 1336	java/lang/NullPointerException
    //   72: dup
    //   73: invokespecial 1337	java/lang/NullPointerException:<init>	()V
    //   76: athrow
    //   77: iload 4
    //   79: istore 5
    //   81: aload_2
    //   82: ifnull -59 -> 23
    //   85: aload_2
    //   86: invokevirtual 1342	android/os/ParcelFileDescriptor:close	()V
    //   89: iconst_0
    //   90: ireturn
    //   91: astore_0
    //   92: aload_0
    //   93: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   96: iconst_0
    //   97: ireturn
    //   98: astore_0
    //   99: aload_0
    //   100: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   103: goto -38 -> 65
    //   106: astore_0
    //   107: aload_0
    //   108: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   111: goto -34 -> 77
    //   114: new 1344	java/io/FileOutputStream
    //   117: dup
    //   118: aload_2
    //   119: invokevirtual 1348	android/os/ParcelFileDescriptor:getFileDescriptor	()Ljava/io/FileDescriptor;
    //   122: invokespecial 1351	java/io/FileOutputStream:<init>	(Ljava/io/FileDescriptor;)V
    //   125: astore 7
    //   127: new 1353	java/io/FileInputStream
    //   130: dup
    //   131: aload_1
    //   132: invokespecial 1354	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   135: astore_0
    //   136: invokestatic 1360	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   139: sipush 4096
    //   142: invokevirtual 1364	com/tencent/commonsdk/pool/ByteArrayPool:getBuf	(I)[B
    //   145: astore_1
    //   146: aload_0
    //   147: aload_1
    //   148: invokevirtual 1368	java/io/FileInputStream:read	([B)I
    //   151: istore_3
    //   152: iload_3
    //   153: iconst_m1
    ...
    //   160: iconst_0
    //   161: iload_3
    //   162: invokevirtual 1372	java/io/FileOutputStream:write	([BII)V
    //   165: goto -19 -> 146
    //   168: astore 8
    //   170: aload_0
    //   171: astore_1
    ...
    //   180: astore_1
    //   181: aload_1
    //   182: invokevirtual 1373	java/lang/Exception:printStackTrace	()V
    //   185: aload 7
    //   187: ifnull +8 -> 195
    //   190: aload 7
    //   192: invokevirtual 1374	java/io/FileInputStream:close	()V
    //   195: aload_0
    //   196: ifnull +7 -> 203
    //   199: aload_0
    //   200: invokevirtual 1375	java/io/FileOutputStream:close	()V
    //   203: iload 4
    //   205: istore 5
    //   207: aload_2
    //   208: ifnull -185 -> 23
    //   211: aload_2
    //   212: invokevirtual 1342	android/os/ParcelFileDescriptor:close	()V
    //   215: iconst_0
    //   216: ireturn
    //   217: astore_0
    //   218: aload_0
    //   219: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   222: iconst_0
    //   223: ireturn
    //   224: invokestatic 1360	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   227: aload_1
    //   228: invokevirtual 1379	com/tencent/commonsdk/pool/ByteArrayPool:returnBuf	([B)V
    //   231: aload 7
    //   233: invokevirtual 1382	java/io/FileOutputStream:flush	()V
    //   236: iload 5
    //   238: istore 4
    //   240: aload_0
    //   241: ifnull +11 -> 252
    //   244: aload_0
    //   245: invokevirtual 1374	java/io/FileInputStream:close	()V
    //   248: iload 5
    //   250: istore 4
    //   252: aload 7
    //   254: ifnull +8 -> 262
    //   257: aload 7
    //   259: invokevirtual 1375	java/io/FileOutputStream:close	()V
    //   262: iload 4
    //   264: istore 5
    //   266: aload_2
    //   267: ifnull -244 -> 23
    //   270: aload_2
    //   271: invokevirtual 1342	android/os/ParcelFileDescriptor:close	()V
    //   274: iload 4
    //   276: ireturn
    //   277: astore_0
    //   278: aload_0
    //   279: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   282: iload 4
    //   284: ireturn
    //   285: astore_0
    //   286: aload_0
    //   287: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   290: iconst_0
    //   291: istore 4
    //   293: goto -41 -> 252
    //   296: astore_0
    //   297: aload_0
    //   298: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   301: iload 6
    //   303: istore 4
    //   305: goto -43 -> 262
    //   308: astore_1
    //   309: aload_1
    //   310: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   313: goto -118 -> 195
    //   316: astore_0
    //   317: aload_0
    //   318: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   321: goto -118 -> 203
    //   324: astore_0
    //   325: aconst_null
    //   326: astore_2
    ...
    //   331: ifnull +8 -> 339
    //   334: aload 8
    //   336: invokevirtual 1374	java/io/FileInputStream:close	()V
    //   339: aload_1
    //   340: ifnull +7 -> 347
    //   343: aload_1
    //   344: invokevirtual 1375	java/io/FileOutputStream:close	()V
    //   347: aload_2
    //   348: ifnull +7 -> 355
    //   351: aload_2
    //   352: invokevirtual 1342	android/os/ParcelFileDescriptor:close	()V
    //   355: aload_0
    //   356: athrow
    //   357: astore 7
    //   359: aload 7
    //   361: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   364: goto -25 -> 339
    //   367: astore_1
    //   368: aload_1
    //   369: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   372: goto -25 -> 347
    //   375: astore_1
    //   376: aload_1
    //   377: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   380: goto -25 -> 355
    //   383: astore_0
    //   384: aconst_null
    //   385: astore_1
    ...
    //   357	59	7	localIOException	IOException
  ...
  public static boolean a(Context paramContext, boolean paramBoolean, auoj paramauoj)
  {
    int j = 2;
    boolean bool1;
    ...
    do
    {
      ...
      i = 3;
      bool2 = bihq.a(localActivity, i, new auoq(paramauoj), "");
      bool1 = bool2;
    } while (!bool2);
    ...
    for (int i = j;; i = 1)
    {
      return bjhk.a(paramContext, i, new auor(paramauoj));
      i = 2;
      break;
    }
  }
  ...
  private static boolean a(File paramFile1, File paramFile2)
  {
    ...
    //   1: astore 5
    //   3: aload_0
    //   4: invokevirtual 1431	java/io/File:isFile	()Z
    //   7: ifeq +12 -> 19
    //   10: aload_0
    //   11: invokevirtual 471	java/io/File:exists	()Z
    //   14: istore_3
    //   15: iload_3
    //   16: ifne +43 -> 59
    //   19: iconst_0
    //   20: ifeq +11 -> 31
    //   23: new 1336	java/lang/NullPointerException
    //   26: dup
    //   27: invokespecial 1337	java/lang/NullPointerException:<init>	()V
    //   30: athrow
    //   31: iconst_0
    //   32: ifeq +11 -> 43
    //   35: new 1336	java/lang/NullPointerException
    //   38: dup
    //   39: invokespecial 1337	java/lang/NullPointerException:<init>	()V
    //   42: athrow
    //   43: iconst_0
    //   44: ireturn
    //   45: astore_0
    //   46: aload_0
    //   47: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   50: iconst_0
    //   51: ireturn
    //   52: astore_0
    //   53: aload_0
    //   54: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   57: iconst_0
    //   58: ireturn
    //   59: new 1344	java/io/FileOutputStream
    //   62: dup
    //   63: aload_1
    //   64: invokespecial 1434	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   67: astore 4
    //   69: new 1353	java/io/FileInputStream
    //   72: dup
    //   73: aload_0
    //   74: invokespecial 1435	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   77: astore_0
    //   78: invokestatic 1360	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   81: sipush 4096
    //   84: invokevirtual 1364	com/tencent/commonsdk/pool/ByteArrayPool:getBuf	(I)[B
    //   87: astore_1
    //   88: aload_0
    //   89: aload_1
    //   90: invokevirtual 1368	java/io/FileInputStream:read	([B)I
    //   93: istore_2
    //   94: iload_2
    //   95: iconst_m1
    //   96: if_icmpeq +53 -> 149
    ...
    //   102: iconst_0
    //   103: iload_2
    //   104: invokevirtual 1372	java/io/FileOutputStream:write	([BII)V
    //   107: goto -19 -> 88
    //   110: astore 5
    //   112: aload 4
    //   114: astore_1
    ...
    //   117: astore 4
    //   119: aload 4
    //   121: invokevirtual 1373	java/lang/Exception:printStackTrace	()V
    //   124: aload_0
    //   125: ifnull +7 -> 132
    //   128: aload_0
    //   129: invokevirtual 1374	java/io/FileInputStream:close	()V
    //   132: aload_1
    //   133: ifnull -90 -> 43
    //   136: aload_1
    //   137: invokevirtual 1375	java/io/FileOutputStream:close	()V
    //   140: iconst_0
    //   141: ireturn
    //   142: astore_0
    //   143: aload_0
    //   144: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   147: iconst_0
    //   148: ireturn
    //   149: invokestatic 1360	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   152: aload_1
    //   153: invokevirtual 1379	com/tencent/commonsdk/pool/ByteArrayPool:returnBuf	([B)V
    //   156: aload 4
    //   158: invokevirtual 1382	java/io/FileOutputStream:flush	()V
    //   161: aload_0
    //   162: ifnull +7 -> 169
    //   165: aload_0
    //   166: invokevirtual 1374	java/io/FileInputStream:close	()V
    //   169: aload 4
    //   171: ifnull +8 -> 179
    //   174: aload 4
    //   176: invokevirtual 1375	java/io/FileOutputStream:close	()V
    //   179: iconst_1
    //   180: ireturn
    //   181: astore_0
    //   182: aload_0
    //   183: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   186: iconst_0
    //   187: ireturn
    //   188: astore_0
    //   189: aload_0
    //   190: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   193: iconst_0
    //   194: ireturn
    //   195: astore_0
    //   196: aload_0
    //   197: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   200: iconst_0
    //   201: ireturn
    //   202: astore_1
    //   203: aconst_null
    ...
    //   209: ifnull +7 -> 216
    //   212: aload_0
    //   213: invokevirtual 1374	java/io/FileInputStream:close	()V
    //   216: aload 4
    //   218: ifnull +8 -> 226
    //   221: aload 4
    //   223: invokevirtual 1375	java/io/FileOutputStream:close	()V
    //   226: aload_1
    //   227: athrow
    //   228: astore_0
    //   229: aload_0
    //   230: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   233: iconst_0
    //   234: ireturn
    //   235: astore_0
    //   236: aload_0
    //   237: invokevirtual 500	java/io/IOException:printStackTrace	()V
    //   240: iconst_0
    //   241: ireturn
    //   242: astore_1
    //   243: aconst_null
  ...
  public static int b(String paramString)
  {
    ...
    } while ((TextUtils.isEmpty(paramString)) || (!beus.b(paramString)));
    return 2;
  }
  ...
  public static String b(long paramLong)
  {
    ...
    if (paramLong > 1048576L)
    {
      ...
      return anzj.a(2131708595) + str + "MB/s";
    }
    if (paramLong > 1024L)
    {
      f = (float)paramLong / 1024.0F;
      str = new DecimalFormat("0.00").format(f);
      return anzj.a(2131708594) + str + "KB/s";
    }
    return anzj.a(2131708600) + paramLong + "KB/s";
  }
  
  public static void b(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, aunx paramaunx)
  {
    String str = a(paramContext, paramString1, paramString2, paramString3, paramString4);
    paramString2 = aunj.a(paramTextView, 2, paramString5 + str, paramString2);
    if (!TextUtils.isEmpty(paramString2))
    {
      paramContext = a(paramContext, paramString1, paramString2, paramString3, paramString4);
      paramContext = aunj.a(paramTextView, paramString5 + paramContext);
      paramString1 = a(paramContext, paramString2, anzj.a(2131708598));
      if (paramBoolean) {
        paramContext = a(paramContext, paramString1, paramaunx);
      }
    }
    for (;;)
    {
      if (arol.c().a())
      {
        ...
        arol.c().a(paramContext, paramString4, paramString1);
      }
  ...
  public static void b(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity, boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    {
      aumw.a(paramActivity, 2131692326, 2131692331, new auos(paramActivity, paramQQAppInterface));
      return;
    }
    auxu.a(paramActivity, paramQQAppInterface, ForwardRecentTranslucentActivity.class, 103);
  }
  ...
  {
    if ((paramMessageRecord1 == null) || (!aunj.a(paramMessageRecord1))) {}
    while ((paramMessageRecord2 == null) || (!aunj.a(paramMessageRecord2))) {
      return;
    }
  ...
  public static boolean b(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      bhmq.a(paramContext, (String)localObject);
      return true;
      if (i == 2)
      {
        long l = ShortVideoUtils.a((String)localObject);
        localContentValues.put("datetaken", Long.valueOf(System.currentTimeMillis()));
        localContentValues.put("duration", Long.valueOf(l));
  ...
  {
    if (paramFileManagerEntity == null) {}
    while ((6 != paramFileManagerEntity.getCloudType()) || (auog.b(paramFileManagerEntity.getFilePath()))) {
      return false;
    }
    return true;
  }
  ...
  {
    if (aunj.a(paramString) <= 10485760L) {
      return true;
    }
    aumw.a(paramContext, "", 2131697486, new auot(paramContext, paramString));
    return false;
  }
}
