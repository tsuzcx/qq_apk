...
public class auoo
{
  ...
  WeakReference<bavr> jdField_a_of_type_MqqUtilWeakReference;
  boolean jdField_a_of_type_Boolean = false;
  ArrayList<auos> b = new ArrayList();
  ...
  private void a(String paramString1, String arg2, boolean paramBoolean, auot paramauot)
  {
    ...
    synchronized (this.b)
    {
      ...
      while (i >= 0)
      {
        paramauot = (auos)this.b.get(i);
        if ((paramauot != null) && (TextUtils.equals(paramString1, paramauot.jdField_a_of_type_JavaLangString)))
        {
          if (paramauot.jdField_a_of_type_Auot != null) {
            paramauot.jdField_a_of_type_Auot.a(paramBoolean);
          }
          this.b.remove(i);
        }
        i -= 1;
  ...
  public void a(QQAppInterface arg1, int paramInt, String paramString1, String paramString2, String paramString3, String[] paramArrayOfString, auot paramauot)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ZipResourcesDownloader", 2, String.format("downloadResource url=%s md5=%s callback=%s", new Object[] { paramString2, paramString3, paramauot }));
    }
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_MqqUtilWeakReference != null) {
          localObject1 = (bavr)this.jdField_a_of_type_MqqUtilWeakReference.get();
        }
        localObject2 = localObject1;
        if (localObject1 == null)
        {
          localObject2 = (bavr)???.getManager(193);
        ...
        if (localObject2 != null)
        {
          ...
          synchronized (this.jdField_a_of_type_JavaUtilArrayList)
          {
            ...
            if (i != 0)
            {
              ...
              synchronized (this.b)
              {
                this.b.add(new auos(this, paramString2, paramauot));
                return;
              }
            }
          }
      ...
      ??? = new baps();
      ((baps)???).jdField_a_of_type_Bapx = new auop(this);
      ((baps)???).jdField_a_of_type_JavaLangString = paramString2;
      ((baps)???).jdField_a_of_type_Int = 0;
      ((baps)???).c = ((String)localObject1);
      ((baps)???).e = 0;
      ((baps)???).jdField_a_of_type_Bapw = new auoq(this);
      ((bavr)localObject2).a(paramInt, paramString1, paramString3, 0, paramString2, (String)localObject1, 2, 0, false, new bavp(???, paramString3, new auor(this, paramString3, paramArrayOfString, paramauot), (baps)???));
      synchronized (this.jdField_a_of_type_JavaUtilArrayList)
      {
