  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("goShare".equals(paramString3))
    {
      ...
      try
      {
        ...
        {
          bcec.a().a(this.mRuntime.a().getString(2131654817));
          return true;
        }
      }
      catch (JSONException paramJsBridgeListener)
      {
        bcec.a().a(this.mRuntime.a().getString(2131624725));
        return true;
      }
    ...
    try
    {
      bcds.c(this.TAG, "doReport");
      paramJsBridgeListener = new JSONObject(paramVarArgs[0]);
      yds.a(null, paramJsBridgeListener.optString("actionName"), paramJsBridgeListener.optInt("fromType"), paramJsBridgeListener.optInt("actionResult"), paramJsBridgeListener.optInt("ext2"));
      return true;
    }
    catch (JSONException paramJsBridgeListener)
    {
    ...
    try
    {
      paramString1 = new String(baaw.decode(paramString1, 0));
    ...
    if ("jumpPublicDevice".equals(paramString3)) {
      try
      {
        bcds.c(this.TAG, "METHOD_JUMP_PUBLICDEVICE");
