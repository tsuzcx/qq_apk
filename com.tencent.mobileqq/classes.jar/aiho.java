...
public class aiho
  extends awdn
{
  private aiho(ContactListView paramContactListView) {}
  ...
  {
    if ((!paramBoolean) || (!bdee.d(this.a.getContext())))
    {
      this.a.i();
      this.a.g();
    }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (!paramBoolean1)
    {
      this.a.i();
      this.a.g();
      if (((i == 0) || (i == 7)) && ((this.a.jdField_a_of_type_Int != 2) || (!(this.a.jdField_a_of_type_Arum instanceof arzs))) && (this.a.b == 0)) {
        this.a.a(2131719221, 3000L);
      }
    }
    do
    {
