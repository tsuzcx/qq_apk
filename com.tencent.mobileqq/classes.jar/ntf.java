...
{
  public ntf(AccountDetailActivity paramAccountDetailActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (!paramBoolean) {
      if (this.a.jdField_c_of_type_Boolean)
      {
        ...
        this.a.jdField_a_of_type_Npm.b(false);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        break;
        label339:
        paramBoolean = tzo.a(arrayOfByte, localGetPublicAccountDetailInfoResponse, paramBundle);
      }
      label351:
