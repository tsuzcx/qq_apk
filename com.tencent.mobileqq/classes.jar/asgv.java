...
{
  private static asgv jdField_a_of_type_Asgv;
  private static boolean b;
  private int jdField_a_of_type_Int = 1;
  private asgt jdField_a_of_type_Asgt = new asgt();
  ...
  public static asgv a()
  {
    try
    {
      if (jdField_a_of_type_Asgv == null)
      {
        jdField_a_of_type_Asgv = new asgv();
        jdField_a_of_type_Asgv.a();
      }
      asgv localasgv = jdField_a_of_type_Asgv;
      return localasgv;
    }
    finally {}
  }
  
  private asgx a(String paramString, int paramInt)
  {
    ...
    try
    {
      if ((paramString.contains("[")) && (paramString.contains("]")))
      {
        ...
        if (j > i) {
          return new asgx(paramString.substring(i, j + 1), paramInt);
        }
    ...
    if (i >= 0) {
      return new asgx(paramString.substring(0, i), paramInt);
    }
    asgx localasgx = new asgx(paramString, paramInt);
    return localasgx;
  }
  ...
  private List<asgx> a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
  ...
  private void a(List<asgx> paramList, List<String> paramList1, int paramInt1, int paramInt2)
  {
  ...
  public static void a(List<asgx> paramList, List<String> paramList1, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (i >= 0)
    {
      localasgx = (asgx)paramList.get(i);
      if ((localasgx != null) && (!TextUtils.isEmpty(localasgx.jdField_a_of_type_JavaLangString)))
      {
        if (!paramBoolean1) {
          break label108;
        }
        ...
        if (!TextUtils.isEmpty(localasgx.a())) {
          paramList1.add(0, localasgx.a());
        }
      }
    }
    for (;;)
    {
      ...
      break;
      label93:
      paramList1.add(0, localasgx.jdField_a_of_type_JavaLangString);
      continue;
      label108:
      if (paramBoolean2)
      {
        if (!TextUtils.isEmpty(localasgx.a())) {
          paramList1.add(0, localasgx.a() + ":" + localasgx.jdField_a_of_type_Int);
        }
      }
      else {
        paramList1.add(0, localasgx.jdField_a_of_type_JavaLangString + ":" + localasgx.jdField_a_of_type_Int);
      }
    }
  }
  ...
  public asgy a(QQAppInterface paramQQAppInterface, asgw paramasgw, int paramInt)
  {
    if (paramasgw == null) {
      return null;
    }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        QLog.i("FileIPv6StrateyController<FileAssistant>", 1, "[IPv6-File] getIPlistForV6Domain on enable IPV6. busType:" + paramInt + " ipv6Domain:" + paramasgw.jdField_a_of_type_JavaLangString + " port:" + paramasgw.jdField_a_of_type_Int + " stacktype:" + ataw.a() + " isV6Login:" + g() + " stratey:" + a(paramQQAppInterface));
        if (1 != ataw.a()) {
          break;
        }
        return null;
      ...
      if (3 == ataw.a())
      {
        paramQQAppInterface = a(paramQQAppInterface, paramasgw.jdField_a_of_type_JavaLangString, paramasgw.jdField_a_of_type_Int, paramInt, true);
        localObject = new asgy();
        if ((paramQQAppInterface != null) && (paramQQAppInterface.size() > 0))
        {
          ((asgy)localObject).jdField_a_of_type_Int = 2;
          ((asgy)localObject).jdField_a_of_type_JavaUtilList = paramQQAppInterface;
          return localObject;
        }
        b();
        ((asgy)localObject).jdField_a_of_type_Int = 1;
        ((asgy)localObject).jdField_a_of_type_JavaUtilList.add(new asgx(paramasgw.jdField_a_of_type_JavaLangString, paramasgw.jdField_a_of_type_Int));
        return localObject;
      }
      if (2 == ataw.a())
      {
        ...
        {
          localObject = a(paramQQAppInterface, paramasgw.jdField_a_of_type_JavaLangString, paramasgw.jdField_a_of_type_Int, paramInt, false);
          localasgy = new asgy();
          if ((localObject == null) || (((List)localObject).size() == 0))
          {
            b();
            localasgy.jdField_a_of_type_Int = 1;
            localasgy.jdField_a_of_type_JavaUtilList.add(new asgx(paramasgw.jdField_a_of_type_JavaLangString, paramasgw.jdField_a_of_type_Int));
            return localasgy;
          }
          if (this.jdField_a_of_type_Asgt.a(paramasgw))
          {
            localasgy.jdField_a_of_type_Int = 2;
            localasgy.jdField_a_of_type_JavaUtilList = ((List)localObject);
            return localasgy;
          }
          this.jdField_a_of_type_Asgt.a(paramQQAppInterface, paramasgw, (asgx)((List)localObject).get(0));
          return null;
        }
  ...
  public List<ExcitingTransferHostInfo> a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    {
      return null;
      QLog.i("FileIPv6StrateyController<FileAssistant>", 1, "[IPv6-File] getIPV6listForExcitingUpload on enable IPV6. busType:" + paramInt + " stacktype:" + ataw.a() + " isV6Login:" + g() + " stratey:" + a((QQAppInterface)localObject));
      if (1 == ataw.a()) {
        paramInt = 0;
      }
      for (;;)
  ...
  public List<String> a(QQAppInterface paramQQAppInterface, int paramInt, List<String> paramList)
  {
    ...
    {
      return null;
      QLog.i("FileIPv6StrateyController<FileAssistant>", 1, "[IPv6-File] getIPV6listForMediaPlatfrom on enable IPV6. busType:" + paramInt + " stacktype:" + ataw.a() + " isV6Login:" + g() + " stratey:" + a((QQAppInterface)localObject));
  ...
  public boolean a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    paramQQAppInterface = (aser)localQQAppInterface.getManager(317);
    if (paramQQAppInterface == null) {
      return false;
    }
    if (paramInt == 1) {
