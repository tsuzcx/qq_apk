...
public class avvt
{
  ...
  {
    this.jdField_a_of_type_Float = paramavvt.jdField_a_of_type_Float;
    this.b = paramavvt.b;
    this.c = paramavvt.c;
    this.d = paramavvt.d;
    this.jdField_a_of_type_AndroidGraphicsMatrix.set(paramavvt.jdField_a_of_type_AndroidGraphicsMatrix);
  }
