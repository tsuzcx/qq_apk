  ...
  implements SoLoadReport
{
  ...
  private void a(boolean paramBoolean, int paramInt, HashMap<String, String> paramHashMap)
  {
    ...
    if (paramBoolean)
    {
      localaxrl.a("", "loadSoNew", false, 0L, 0L, paramHashMap, "");
      return;
    }
    localaxrl.a("", "loadSoOld", false, 0L, 0L, paramHashMap, "");
  }
  ...
  public void reportThrowable(Throwable paramThrowable, String paramString)
  {
    ...
    axrl.a(BaseApplicationImpl.getContext()).a("", "SoCountLimit", false, 0L, 0L, a(paramString, 0L), "");
  }
}
