...
public class ausi
{
  ...
  public ausi(String paramString, int paramInt, aush paramaush)
  {
  ...
  private boolean b()
  {
    return (c()) && (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) && (this.jdField_a_of_type_Aush != null);
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_JavaLangString = (this.jdField_b_of_type_JavaLangString + awmp.a() + ".pcm");
  ...
  public void b()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Aush.b(this.jdField_a_of_type_JavaLangString);
      return;
    }
    catch (IOException localIOException)
    {
