...
public abstract class akvs
{
  ...
  public akvs(int paramInt)
  {
    this.jdField_c_of_type_JavaLangString = akvw.jdField_a_of_type_JavaLangString;
    ...
    this.jdField_j_of_type_JavaLangString = akvw.jdField_b_of_type_JavaLangString;
    this.jdField_k_of_type_JavaLangString = akvw.jdField_c_of_type_JavaLangString;
    this.jdField_l_of_type_JavaLangString = akvw.jdField_d_of_type_JavaLangString;
    this.jdField_a_of_type_JavaLangString = "precision mediump float;\nuniform mat4 uSTMatrix;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nuniform mat4 uMVPMatrix;\nvoid main() {\n   gl_Position = uMVPMatrix * aPosition;\n   vTextureCoord = (uSTMatrix * aTextureCoord).xy;\n}";
    this.o = paramInt;
  }
  
  private final int a(akvv paramakvv, boolean paramBoolean)
  {
    int i1 = 0;
    a(paramakvv);
    if (this.jdField_a_of_type_Akvt != null) {
      this.jdField_a_of_type_Akvt.a();
    }
    if (this.n == 1) {
      this.jdField_a_of_type_Akvo.a(this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
    }
    for (;;)
    {
      GLES20.glBindTexture(3553, 0);
      GLES20.glBindFramebuffer(36160, 0);
      akvw.a("keyingHandleAfter");
      if (paramBoolean) {
        i1 = this.jdField_a_of_type_Akvp.a();
      }
      return i1;
      this.jdField_a_of_type_Akvy.a();
    }
  }
  
  private final void a(akvv paramakvv, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_Akvp.a(paramInt1, paramInt2);
    ...
    for (;;)
    {
      ...
      if (this.m != -1) {
        GLES20.glUniform4f(this.m, paramakvv.jdField_a_of_type_Float, paramakvv.jdField_b_of_type_Float, paramakvv.jdField_c_of_type_Float, 1.0F);
      }
      akvw.a("keyingHandleBefore");
      return;
      this.jdField_a_of_type_Akvy.a(this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
    }
  }
  
  public final int a(int[] paramArrayOfInt, akvv paramakvv, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    return a(paramArrayOfInt, paramakvv, paramArrayOfFloat1, paramArrayOfFloat2, false, 0, 0);
  }
  
  public final int a(int[] paramArrayOfInt, akvv paramakvv, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    if (paramArrayOfInt == null) {
      throw new IllegalArgumentException("textureIds can not be null!");
    }
    a(paramakvv, paramArrayOfFloat1, paramArrayOfFloat2, paramBoolean, paramInt1, paramInt2);
    switch (this.o)
    {
    }
    for (;;)
    {
      akvw.a("keyingTexture");
      return a(paramakvv, paramBoolean);
  ...
  protected String a()
  {
    this.jdField_c_of_type_JavaLangString = akvw.a(this.o);
  ...
  public void a(String paramString1, String paramString2, String paramString3, akvt paramakvt)
  {
    ...
    this.jdField_a_of_type_Akvt = paramakvt;
  }
  ...
  public void b()
  {
    ...
    } while (this.jdField_a_of_type_Akvp == null);
    this.jdField_a_of_type_Akvp.a();
    this.jdField_a_of_type_Akvp = null;
  }
}
