  ...
  implements Runnable
{
  ...
  public ycd(yce paramyce, int paramInt)
  {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramyce);
    try
    {
    ...
    catch (OutOfMemoryError paramyce)
    {
      for (;;)
      {
    ...
    catch (Exception paramyce)
    {
      for (;;)
      {
        paramyce.printStackTrace();
        QLog.e("EncodeRunnable", 2, "DataPipe exception!!" + paramyce);
      }
      if (paramInt != 0)
      {
  ...
  private void a(SilkCodecWrapper paramSilkCodecWrapper, NoiseDetector paramNoiseDetector)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        i = 0;
        yby localyby = new yby(this.g / 10 * 15);
        l2 = 0L;
        j = 0;
            ...
            if (m >= 0)
            {
              ...
              if (m < 8820 - k)
              {
                ...
                if (paramNoiseDetector.a(arrayOfShort1, 0, 4410))
                {
                  ...
                  short[] arrayOfShort2 = localyby.a();
                  localyby.a();
                ...
                localyby.a(arrayOfShort1, 0, 4410);
                l1 = l2;
                break label916;
                j = k / 2;
                i = 0;
        ...
        if (paramSilkCodecWrapper != null)
        {
          ...
          if (paramInt1 < paramSilkCodecWrapper.jdField_a_of_type_Int)
          {
            ...
            else
            {
              ...
              {
                paramArrayOfByte = (yce)this.jdField_a_of_type_JavaLangRefWeakReference.get();
                if (paramArrayOfByte != null) {
  ...
  public void run()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 99	ycd:jdField_a_of_type_ComTencentMobileqqActivityRichmediaSubtitlesRDDataPipe	Lcom/tencent/mobileqq/activity/richmedia/subtitles/RDDataPipe;
    //   4: ifnonnull +23 -> 27
    ...
    //   64: aload_0
    //   65: getfield 60	ycd:jdField_a_of_type_ComTencentMobileqqActivityRichmediaSubtitlesNoiseDetector	Lcom/tencent/mobileqq/activity/richmedia/subtitles/NoiseDetector;
    //   68: aload_0
    //   69: getfield 53	ycd:g	I
    ...
    //   80: aload_0
    //   81: getfield 50	ycd:jdField_b_of_type_Boolean	Z
    //   84: ifne +67 -> 151
    //   87: aload_1
    //   88: ifnull +7 -> 95
    //   91: aload_1
    ...
    //   146: aload_0
    //   147: invokespecial 337	ycd:b	()V
    //   150: return
    //   151: aload_0
    //   152: aload_1
    //   153: aload_0
    //   154: getfield 60	ycd:jdField_a_of_type_ComTencentMobileqqActivityRichmediaSubtitlesNoiseDetector	Lcom/tencent/mobileqq/activity/richmedia/subtitles/NoiseDetector;
    //   157: invokespecial 365	ycd:a	(Lcom/tencent/mobileqq/utils/SilkCodecWrapper;Lcom/tencent/mobileqq/activity/richmedia/subtitles/NoiseDetector;)V
    //   160: goto -73 -> 87
    //   163: astore_1
    //   164: aload_1
