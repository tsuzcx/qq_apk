  ...
  extends aktq
{
  ...
  akwf(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
  ...
  public void initData(Intent paramIntent)
  {
    ...
    ((aktm)this.mOtherCommonData).a(this.jdField_a_of_type_Boolean, this.mPhotoCommonData);
  }
  ...
  public void onMagicStickClick(View paramView, int paramInt1, Bundle paramBundle, int paramInt2, Intent paramIntent)
  {
    ...
    if ((this.jdField_a_of_type_Aktn.jdField_a_of_type_JavaLangString != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
    {
