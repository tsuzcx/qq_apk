...
public class agqe
  extends ayvz
{
  public agqe(SendWebPicActivity paramSendWebPicActivity) {}
  
  public void handleMessage(Message paramMessage)
  {
    ayqm localayqm = (ayqm)paramMessage.obj;
    if ((localayqm == null) || (localayqm.b != 24) || (localayqm.c != 51)) {}
    do
    {
      do
      {
        return;
      } while (localayqm.f.equals(SendWebPicActivity.a(this.a)));
    ...
    try
    {
      ...
      SendWebPicActivity.a(this.a, localayqm.f);
    ...
    if (QLog.isColorLevel()) {
      QLog.d("SendWebPicActivity", 2, "mPicTransProcessorHandler send error:" + localayqm.g);
    }
