  ...
  extends bhhp
{
  ...
  public bhho(boolean paramBoolean)
  {
    super(paramBoolean);
  ...
  {
    this.d = 0.5228754F;
    ArrayList localArrayList = bhou.a().a(this.jdField_f_of_type_Float, false);
    if (this.jdField_a_of_type_Boolean) {}
    for (Object localObject = bhou.a().a(this.jdField_f_of_type_Float, true);; localObject = null)
    {
  ...
  public void c()
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Bhhi.a(this.d);
        this.jdField_a_of_type_Bhhi.a(this.jdField_b_of_type_Float, this.jdField_c_of_type_Float);
      }
      ...
      if ((this.jdField_a_of_type_Bhhq != null) && (this.d != 1.0F)) {
        this.jdField_a_of_type_Bhhq.a((int)this.jdField_f_of_type_Float - i, -this.jdField_b_of_type_Float, -this.jdField_c_of_type_Float, this.d);
      }
      return;
      if (this.jdField_b_of_type_Float >= -this.jdField_g_of_type_Float) {
        break;
  ...
  public void d()
  {
    ...
    {
      int i = 0;
      while (i < this.jdField_a_of_type_Bhht.size())
      {
        bhhu localbhhu = (bhhu)this.jdField_a_of_type_Bhht.valueAt(i);
        int j = localbhhu.a();
        if (j > 0)
        {
          GLES20.glBindTexture(3553, j);
          j = c();
          GLES20.glDrawArrays(4, ((int)(this.jdField_f_of_type_Float / 10.0F) - 1 - localbhhu.b()) * 6 + j, 6);
        }
        i += 1;
      }
    }
