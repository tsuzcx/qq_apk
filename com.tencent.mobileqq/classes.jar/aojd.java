...
public class aojd
  extends aojs
{
  public aojd(TroopManager paramTroopManager) {}
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    aoip localaoip = (aoip)this.a.a.a(20);
    for (;;)
    {
      synchronized (this.a)
      {
        if (TroopManager.a(this.a) == null)
        {
          ...
          localaoip.a(true, paramString, ((TroopInfo)localObject2).troopcode, 9);
          return;
        }
      }
      TroopManager.a(this.a).add(localObject2);
  ...
  protected void a(String paramString, boolean paramBoolean, List<TroopMemberInfo> paramList, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    do
    {
      ...
      localaoip.a(true, localTroopInfo.troopuin, localTroopInfo.troopcode, 4);
  ...
  protected void d()
  {
    synchronized (this.a)
    {
      ...
      if (TroopManager.a(this.a).size() > 0)
      {
        ...
        ((aoip)this.a.a.a(20)).a(true, ((TroopInfo)???).troopuin, ((TroopInfo)???).troopcode, 4);
        return;
      }
    }
    synchronized (this.a)
  ...
  protected void f(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (!TextUtils.isEmpty(paramString))) {
      ((aoip)this.a.a.a(20)).j(paramString);
    }
  }
}
