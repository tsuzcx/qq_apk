...
{
  public aemn(EditInfoActivity paramEditInfoActivity) {}
  
  public void onClick(View paramView)
  {
    Object localObject1 = this.a.a.getText();
    if (localObject1 != null) {}
    for (localObject1 = new begp(localObject1.toString(), 3);; localObject1 = null)
    {
      Object localObject2;
      if (localObject1 == null)
      {
      ...
      for (;;)
      {
        ...
        return;
        localObject2 = ((begp)localObject1).toString();
        break;
        label100:
        localObject1 = ((begp)localObject1).c();
        break label43;
        label108:
        ...
        else if ((localObject1 == null) || (((String)localObject1).length() == 0))
        {
          if (((String)localObject1).length() == 0) {
            QQToast.a(this.a, this.a.getString(2131693061), 0).b(this.a.getTitleBarHeight());
          }
        }
        ...
        if (this.a.d == 3)
        {
          ...
          {
            QQToast.a(this.a, this.a.getString(2131693060), 0).b(this.a.getTitleBarHeight());
            continue;
          }
        }
      ...
      {
        localaemx = new aemx(null);
        if (EditInfoActivity.a(this.a, localaemx))
        {
          this.a.b(true);
          ...
          } while (((biwb)((Iterator)localObject2).next()).c != 1);
        }
      }
      for (int i = 1;; i = 0)
      {
        if (i == 0)
        {
          QQToast.a(this.a, anzj.a(2131702518), 0).b(this.a.getTitleBarHeight());
          break;
        }
        ...
        {
          QQToast.a(this.a, this.a.getString(2131693004), 0).b(this.a.getTitleBarHeight());
          break;
        }
        ...
        localObject3 = (aoip)this.a.app.a(20);
        if ((localObject3 != null) && (!TextUtils.isEmpty(this.a.jdField_e_of_type_JavaLangString)))
        {
          this.a.b(true);
          ((aoip)localObject3).a(this.a.jdField_e_of_type_JavaLangString, (ArrayList)localObject1, (ArrayList)localObject2);
        }
        ...
        {
          this.a.j = true;
          bdll.b(this.a.app, "P_CliOper", "Grp_manage", "", "modify_name", "complete", 0, 0, this.a.jdField_e_of_type_JavaLangString, i + "", "" + this.a.d, "");
          break;
