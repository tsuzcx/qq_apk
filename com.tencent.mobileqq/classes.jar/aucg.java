...
public class aucg
{
  ...
  public static aubx a(String paramString)
  {
        ...
        try
        {
          ...
          if (i < j)
          {
            ...
            if (((String)localObject1).equals("align")) {
              ((auby)localObject3).a(1, localObject4);
            }
            i += 1;
            continue;
          }
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        break label1175;
                        localObject5 = localObject1;
                        bool = a(paramString, (auby)localObject3, localXmlPullParser);
                        localObject4 = paramString;
                        localObject3 = paramString;
                        paramString = (String)localObject1;
                        localObject1 = localObject3;
                        ...
                        {
                          localObject5 = localObject1;
                          if (((auby)localObject4).a())
                          {
                            localObject5 = localObject1;
                            if (!TextUtils.isEmpty((CharSequence)localObject3))
                            {
                              localObject5 = localObject1;
                              ((auby)localObject4).a(2, localObject3);
                              localObject3 = paramString;
                              paramString = (String)localObject1;
                              localObject1 = localObject3;
                              break label1137;
  ...
  public static MessageForUniteGrayTip a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, long paramLong1, String paramString2, long paramLong2, long paramLong3, byte[] paramArrayOfByte)
  {
    ...
    {
      return null;
      localaucf = new aucf(paramString1, paramQQAppInterface.getCurrentAccountUin(), "", paramInt1, paramInt2, 655397, paramLong1);
      localObject1 = paramString2.a();
    } while (localObject1 == null);
    paramString2 = "";
    HashMap localHashMap = ((auby)localObject1).a();
    ...
    {
      break;
      a(paramQQAppInterface, localaucf, (auby)localObject1, paramInt1, paramString1);
      localObject1 = new MessageForUniteGrayTip();
      ((MessageForUniteGrayTip)localObject1).initGrayTipMsg(paramQQAppInterface, localaucf);
  ...
  private static void a(QQAppInterface paramQQAppInterface, aucf paramaucf, auby paramauby, int paramInt, String paramString)
  {
    if (paramaucf.jdField_a_of_type_JavaUtilArrayList != null) {
      paramaucf.jdField_a_of_type_JavaUtilArrayList.clear();
    }
    StringBuilder localStringBuilder = new StringBuilder();
    Iterator localIterator1 = paramauby.jdField_a_of_type_JavaUtilArrayList.iterator();
    Object localObject1;
    Object localObject2;
    Object localObject3;
    int j;
    ...
    for (;;)
    {
      ...
      {
        paramauby = (auby)localIterator1.next();
        Object localObject4;
        switch (paramauby.jdField_a_of_type_Int)
        {
        default: 
          break;
        case 2: 
          paramauby = paramauby.a();
          localObject1 = paramauby.keySet().iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (Integer)((Iterator)localObject1).next();
            localObject3 = paramauby.get(localObject2);
        ...
        case 3: 
          ...
          if (((Iterator)localObject2).hasNext())
          {
            ...
            {
              localObject3 = (String)paramauby.get(localObject3);
          ...
          paramaucf.a(j, i, (Bundle)localObject1);
          break;
        case 4: 
          localObject5 = paramauby.a();
          ...
          if (localIterator2.hasNext())
          {
            ...
            if (((Integer)localObject3).intValue() == 6)
            {
              ...
              localObject1 = paramauby;
              paramauby = (auby)localObject3;
            }
            for (;;)
            {
              localObject3 = localObject2;
              localObject2 = paramauby;
              paramauby = (auby)localObject1;
              localObject1 = localObject3;
              break;
          ...
          {
            paramauby = amtj.a(2131714911);
            if (TextUtils.equals("1", (CharSequence)localObject2)) {
              paramauby = BaseApplicationImpl.getContext().getString(2131692668);
            }
          }
          for (;;)
          {
            if (QLog.isColorLevel()) {
              QLog.e(jdField_a_of_type_JavaLangString, 2, "parseUniteGrayTipsContent name : " + paramauby);
            }
            localStringBuilder.append(paramauby);
            paramauby.length();
            break;
            if (abwz.d(paramInt)) {
              paramauby = ContactUtils.getFriendDisplayName(paramQQAppInterface, (String)localObject1);
            } else if (abwz.a(paramInt)) {
              paramauby = ContactUtils.getTroopMemberName(paramQQAppInterface, paramString, (String)localObject1);
            }
          }
        case 5: 
          localObject2 = paramauby.a();
          ...
          if (((Iterator)localObject4).hasNext())
          {
            ...
            {
              paramauby = (String)((HashMap)localObject2).get(localObject5);
              i = "icon".length();
              ((Bundle)localObject3).putString("image_resource", paramauby);
              paramauby = "icon";
              i += j;
            }
          }
    ...
    for (;;)
    {
      ...
      if (((Integer)localObject5).intValue() == 10)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          for (;;)
          {
            paramaucf.a(j, i, (Bundle)localObject3);
            break;
            localStringBuilder.append((String)localObject1);
          }
          paramaucf.jdField_c_of_type_JavaLangString = localStringBuilder.toString();
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForUniteGrayTip paramMessageForUniteGrayTip)
  {
    ...
    aucf localaucf = paramMessageForUniteGrayTip.tipParam;
    Object localObject = paramMessageForUniteGrayTip.getExtInfoFromExtStr("bytes_content");
    if ((localaucf != null) && (localaucf.jdField_b_of_type_Int == 655397) && (!TextUtils.isEmpty((CharSequence)localObject))) {}
    try
    {
      localObject = a((String)localObject);
      if (localObject != null) {
        a(paramQQAppInterface, localaucf, ((aubx)localObject).a(), paramMessageForUniteGrayTip.istroop, paramMessageForUniteGrayTip.frienduin);
      }
      paramMessageForUniteGrayTip.msg = localaucf.jdField_c_of_type_JavaLangString;
      paramMessageForUniteGrayTip.entity = ((aubx)localObject);
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForUniteGrayTip paramMessageForUniteGrayTip, List<MessageRecord> paramList, int paramInt, String paramString, aucf paramaucf)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((localMessageRecord.msgtype != -1000) && (localMessageRecord.msgtype != -1051)) || (!bfwr.a(localMessageRecord.issend)))
      {
        if (QLog.isColorLevel()) {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          if (paramInt == 1)
          {
            paramList = localMessageRecord.getExtInfoFromExtStr(bbkv.i);
            label243:
          ...
          else
          {
            try
            {
              ...
              paramList = localMessageRecord.getExtInfoFromExtStr(bbkv.j);
            }
    ...
    for (;;)
    {
      try
      {
        ...
        paramList.put(bbkv.k, localObject);
        paramList.put(bbkv.l, paramInt);
      ...
      if ((localStringBuilder != null) && (localStringBuilder.length() > 0))
      {
        ...
        localObject = BaseApplicationImpl.getApplication().getString(2131693969);
        paramString = paramString.concat(" ");
        j = paramString.length();
        k = ((String)localObject).length() + j;
        paramString = paramString.concat((String)localObject);
        paramaucf.jdField_c_of_type_JavaLangString = paramString;
        ...
        paramaucf.a(j, k, (Bundle)localObject);
        if (QLog.isColorLevel())
        {
          if (paramMessageForUniteGrayTip.editMsgData != null)
          {
            ...
            paramaucf = jdField_a_of_type_JavaLangString;
            ...
            QLog.d(paramaucf, 2, new Object[] { "revoke msg beding edit,time=", Long.valueOf(l1), ",wording=", paramString, ",msguid=", Long.valueOf(l2), ",uniseq=", Long.valueOf(l3), ",start =", Integer.valueOf(j), ",end=", Integer.valueOf(k), ",msgDta[0-2]=", paramList, ",msgGray.editMsgData.length=", Integer.valueOf(paramMessageForUniteGrayTip.editMsgData.length()), ",atString=", localJSONArray.toString() });
          }
        }
        else {
          bcef.b(paramQQAppInterface, "dc00898", "", "", "0X8008E55", "0X8008E55", 0, 0, "", "", "", "");
        }
      }
      label873:
      while (!QLog.isColorLevel()) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong1, long paramLong2, byte[] paramArrayOfByte)
  {
    ...
    //   3: ifeq +46 -> 49
    //   6: getstatic 16	aucg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   9: iconst_2
    //   10: ldc_w 680
    //   13: iconst_4
    ...
    //   42: aastore
    //   43: invokestatic 684	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   46: invokestatic 53	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   49: lload_3
    //   50: lload 5
    //   52: invokestatic 689	bepv:a	(JJ)Z
    //   55: ifeq +123 -> 178
    //   58: aload 7
    //   60: ifnull +25 -> 85
    //   63: iload_2
    ...
    //   68: aload_0
    //   69: sipush 346
    //   72: invokevirtual 596	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   75: checkcast 691	bepr
    //   78: aload_1
    //   79: aload 7
    //   81: iconst_1
    //   82: invokevirtual 694	bepr:a	(Ljava/lang/String;[BI)V
    //   85: ldc2_w 695
    //   88: lload 5
    //   90: lcmp
    //   91: ifne +178 -> 269
    ...
    //   110: new 698	tencent/im/oidb/cmd0x857/TroopTips0x857$GrayData
    //   113: dup
    //   114: invokespecial 699	tencent/im/oidb/cmd0x857/TroopTips0x857$GrayData:<init>	()V
    //   117: astore 8
    //   119: aload 8
    //   121: aload 7
    //   123: invokevirtual 703	tencent/im/oidb/cmd0x857/TroopTips0x857$GrayData:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   126: pop
    //   127: aload 8
    //   129: getfield 706	tencent/im/oidb/cmd0x857/TroopTips0x857$GrayData:all_read	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   132: invokevirtual 630	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   135: ifeq +319 -> 454
    //   138: aload 8
    //   140: getfield 706	tencent/im/oidb/cmd0x857/TroopTips0x857$GrayData:all_read	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   143: invokevirtual 632	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   146: i2l
    //   147: lstore_3
    //   148: ldc 181
    //   150: astore_0
    //   151: aload 8
    //   153: getfield 710	tencent/im/oidb/cmd0x857/TroopTips0x857$GrayData:feed_id	Lcom/tencent/mobileqq/pb/PBStringField;
    //   156: invokevirtual 713	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   159: ifeq +12 -> 171
    //   162: aload 8
    //   164: getfield 710	tencent/im/oidb/cmd0x857/TroopTips0x857$GrayData:feed_id	Lcom/tencent/mobileqq/pb/PBStringField;
    //   167: invokevirtual 715	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   170: astore_0
    //   171: lconst_0
    //   172: lload_3
    //   173: lcmp
    ...
    //   197: aload_0
    //   198: bipush 52
    //   200: invokevirtual 596	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   203: checkcast 598	com/tencent/mobileqq/app/TroopManager
    //   206: astore_0
    //   207: aload_0
    //   208: ifnull -123 -> 85
    //   211: aload_0
    ...
    //   213: aload 7
    //   215: iconst_1
    //   216: invokevirtual 718	com/tencent/mobileqq/app/TroopManager:a	(Ljava/lang/String;[BI)V
    //   219: goto -134 -> 85
    //   222: new 515	org/json/JSONObject
    //   225: dup
    //   226: invokespecial 516	org/json/JSONObject:<init>	()V
    //   229: astore 8
    //   231: aload 8
    //   233: ldc_w 720
    //   236: aload_0
    //   237: invokevirtual 522	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   240: pop
    //   241: aload 8
    //   243: ldc_w 722
    //   246: aload_1
    //   247: invokevirtual 522	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   250: pop
    //   251: ldc_w 724
    //   254: ldc_w 726
    //   257: aload 8
    //   259: invokevirtual 727	org/json/JSONObject:toString	()Ljava/lang/String;
    //   262: ldc_w 729
    //   265: invokestatic 734	com/tencent/mobileqq/ark/ArkAppCenter:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    //   268: pop
    //   269: ldc2_w 735
    //   272: lload 5
    //   274: lcmp
    ...
    //   278: aload 7
    //   280: ifnull -103 -> 177
    //   283: new 738	tencent/im/oidb/cmd0xe3e/oidb_0xe3e$ResvAttr
    //   286: dup
    //   287: invokespecial 739	tencent/im/oidb/cmd0xe3e/oidb_0xe3e$ResvAttr:<init>	()V
    //   290: astore_0
    //   291: aload_0
    //   292: aload 7
    //   294: invokevirtual 740	tencent/im/oidb/cmd0xe3e/oidb_0xe3e$ResvAttr:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   297: pop
    //   298: iconst_0
    //   299: istore_2
    //   300: aload_0
    //   301: getfield 743	tencent/im/oidb/cmd0xe3e/oidb_0xe3e$ResvAttr:uint32_gray_tips_from	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   304: invokevirtual 630	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   307: ifeq +11 -> 318
    //   310: aload_0
    //   311: getfield 743	tencent/im/oidb/cmd0xe3e/oidb_0xe3e$ResvAttr:uint32_gray_tips_from	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   314: invokevirtual 632	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   317: istore_2
    //   318: iconst_1
    //   319: iload_2
    ...
    //   345: ldc 181
    //   347: ldc 181
    //   349: invokestatic 587	bcef:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   352: return
    //   353: astore_0
    //   354: aload_0
    //   355: invokevirtual 748	com/tencent/mobileqq/pb/InvalidProtocolBufferMicroException:printStackTrace	()V
    //   358: getstatic 16	aucg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   361: iconst_1
    //   362: ldc_w 750
    //   365: aload_0
    //   366: invokestatic 512	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   369: return
    //   370: astore_0
    //   371: getstatic 16	aucg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   374: iconst_1
    //   375: ldc_w 752
    //   378: aload_0
    //   379: invokestatic 162	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   382: goto -131 -> 251
    //   385: astore_0
    //   386: aload_0
    //   387: invokevirtual 748	com/tencent/mobileqq/pb/InvalidProtocolBufferMicroException:printStackTrace	()V
    //   390: getstatic 16	aucg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   393: iconst_1
    //   394: ldc_w 750
    //   397: aload_0
    //   398: invokestatic 512	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   401: goto -132 -> 269
    //   404: astore_0
    //   405: getstatic 16	aucg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   408: iconst_1
    //   409: ldc_w 754
    //   412: aload_0
    //   413: invokestatic 162	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   416: goto -147 -> 269
    //   419: iconst_2
    //   420: iload_2
    ...
    //   446: ldc 181
    //   448: ldc 181
    //   450: invokestatic 587	bcef:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   453: return
    //   454: lconst_0
    //   455: lstore_3
    //   456: goto -308 -> 148
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, long paramLong1, long paramLong2, msg_comm.MsgHead paramMsgHead)
  {
    ...
    Object localObject = (anca)paramQQAppInterface.getBusinessHandler(20);
    if (paramArrayOfByte == null)
    {
      ...
      ((anca)localObject).j(paramArrayOfByte.troopuin);
      ((anca)localObject).a(1, amoo.a(paramArrayOfByte.troopuin), 0L, 2, 0, 0, true);
    }
    for (;;)
    {
      ((anca)localObject).a(paramArrayOfByte.troopuin, Boolean.valueOf(false));
      if (QLog.isColorLevel()) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, MsgInfo paramMsgInfo)
  {
    ...
    azdh.a().a(localMsgBody, paramMsgInfo, paramQQAppInterface);
  }
  ...
  private static boolean a(auby paramauby1, auby paramauby2, XmlPullParser paramXmlPullParser)
  {
    paramauby1.a(paramauby2);
    int j = paramXmlPullParser.getAttributeCount();
    int i = 0;
    if (i < j)
    {
      paramauby2 = paramXmlPullParser.getAttributeName(i);
      String str = paramXmlPullParser.getAttributeValue(i);
      if (paramauby2.equals("txt")) {
        paramauby1.a(2, str);
      }
      for (;;)
      {
        i += 1;
        break;
        if (paramauby2.equals("jp"))
        {
          paramauby1.a(4, str);
        }
        else if (paramauby2.equals("uin"))
        {
          paramauby1.a(6, str);
        }
        else if (paramauby2.equals("nm"))
        {
          paramauby1.a(7, str);
        }
        else if (paramauby2.equals("tp"))
        {
          paramauby1.a(9, str);
        }
        else if (paramauby2.equals("si"))
        {
          paramauby1.a(3, str);
        }
        else if (paramauby2.equals("col"))
        {
          paramauby1.a(5, str);
        }
        else if (paramauby2.equals("src"))
        {
          paramauby1.a(8, str);
        }
        else if (paramauby2.equals("align"))
        {
          paramauby1.a(1, str);
        }
        else
        {
          if (!paramauby2.equals("alt")) {
            break label247;
          }
          paramauby1.a(10, str);
        }
      ...
      label247:
      if (QLog.isColorLevel()) {
        QLog.i(jdField_a_of_type_JavaLangString, 2, "parseXML, illegel field: " + paramauby2);
      }
      return false;
    }
    return true;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageForUniteGrayTip paramMessageForUniteGrayTip)
  {
    ...
    do
    {
      ...
      {
        return false;
        if (((paramMessageForUniteGrayTip.tipParam.jdField_a_of_type_Boolean) || (abwz.h(paramMessageForUniteGrayTip.msgtype))) && ((paramMessageForUniteGrayTip.tipParam.jdField_c_of_type_Boolean) || (abwz.i(paramMessageForUniteGrayTip.msgtype)))) {
          break;
        }
      } while (!QLog.isColorLevel());
    ...
    if (paramMessageForUniteGrayTip != null)
    {
      ...
      if (paramMessageForUniteGrayTip.editState == 1)
      {
        ...
        else
        {
          ...
          StringBuilder localStringBuilder = new StringBuilder();
          String str = " " + BaseApplicationImpl.getApplication().getString(2131693969);
          ...
          if ((b != null) && (paramMessageForUniteGrayTip.uniseq == b.uniseq)) {
            bcef.b(paramQQAppInterface, "dc00898", "", "", "0X8008E55", "0X8008E55", 1, 0, "", "", "", "");
          }
          if ((b != null) && (paramMessageForUniteGrayTip.uniseq == b.uniseq)) {
            b = null;
          }
    ...
    do
    {
      do
      {
        do
        {
          ...
          bool1 = bool2;
          if (bepv.a(paramLong1, paramLong2)) {
            if (!bbyp.b())
            {
              bool1 = bool2;
      ...
      paramQQAppInterface = (affk)apub.a().a(609);
      bool2 = bool1;
  ...
  private static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, MsgInfo paramMsgInfo)
  {
    ...
    for (int i = 1;; i = 2)
    {
      bcef.b(paramQQAppInterface, "CliOper", "", "", "0X800A560", "0X800A560", i, 0, "" + l2, "" + l1, "", "");
