  ...
  extends anii
{
  ...
  public static void a(int paramInt1, int paramInt2, String paramString, int paramInt3, BaseActivity paramBaseActivity)
  {
    ...
    Object localObject1 = bgyg.a(paramBaseActivity, "theme", "mvip.gongneng.android.theme.index_dynamic_tab");
  ...
  private void a(int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, ThemeAuth.DiyThemeDetail paramDiyThemeDetail)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramString1))
      {
        ...
        if (paramInt1 == 2) {
          afxa.a(localMobileQQ, this.app.getAccount(), null, str2);
        }
      }
  ...
  private void a(int paramInt, String paramString1, String paramString2, ThemeAuth.SubCmd0x1RspAuth paramSubCmd0x1RspAuth)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      try
      {
        paramString1 = new bdps().a(paramString1).a(this.mApp.getApplication());
        bgmg.a(paramString1, true);
    ...
    {
      if (bool) {
        bcst.b(null, "CliOper", "", "", "theme", "0X8007234", 0, 0, String.valueOf(i), "", "", "");
      }
      paramSubCmd0x1RspAuth = paramString2;
      if (TextUtils.isEmpty(paramString2)) {
        paramSubCmd0x1RspAuth = anni.a(2131713605);
      }
      ...
      for (;;)
      {
        ...
        {
          afxa.a(this.mApp.getApplication(), this.app.getAccount(), null, "null");
  ...
  private void a(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      QLog.d("Theme.ThemeHandler", 1, "Theme Auth themeId=" + str1 + ",version=" + "20000000" + ", userThemeId=" + str3 + ",currentThemeResPath=" + str2 + ", usr=" + bdol.a(this.mApp.getAccount(), 2) + ", oldTime=" + l1);
      if ("1000".equals(str1)) {
        break label967;
      }
    ...
    do
    {
      ...
      i = 1;
      bdpt.a(null, "theme_detail", "205", 157, j, i, str1, "20000000", "1", "");
      return;
      ...
      ((ThemeAuth.ReqBody)localObject3).str_qq_version.set("8.4.1.4680");
      ((ThemeAuth.ReqBody)localObject3).uint32_qq_version.set(Integer.parseInt("4680"));
    ...
    for (int i = 1;; i = -1)
    {
      bdpt.a(null, "theme_sp_speed", "204", 153, -1, i, String.valueOf(l2 - l1), "6653", "read", "");
      if ((paramBundle.isDirectory()) && (localObject1 != null))
      {
        ...
        bdpt.a(this.app, "theme_detail", "204", 157, bgnt.a(null), 101, str1, "665", String.valueOf(i), String.valueOf(((ThemeUtil.ThemeInfo)localObject1).fileNum));
        break;
        label967:
  ...
  private void a(ThemeAuth.RspBody paramRspBody)
  {
    ...
    if (i == 0)
    {
      ...
      bcst.b(this.app, "CliOper", "", "", "0X8005B9E", "0X8005B9E", 0, 0, "", "", "", "");
      localMessage = new Message();
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, ThemeAuth.RspBody paramRspBody, boolean paramBoolean)
  {
    ...
    for (paramToServiceMsg = paramToServiceMsg.str_diy_theme_err_msg.get();; paramToServiceMsg = str)
    {
      ...
      if ((this.jdField_a_of_type_Bdqf != null) && (this.jdField_a_of_type_AndroidOsBundle != null)) {
        break;
      }
      QLog.e("Theme.ThemeHandler", 1, "handleThemeAuth Set result:null == service || null == reqbundle, result:" + i);
      this.jdField_a_of_type_AndroidOsBundle = null;
      this.jdField_a_of_type_Bdqf = null;
      return true;
    ...
    if ((!TextUtils.isEmpty(paramRspBody)) && (paramRspBody.equals(this.jdField_a_of_type_AndroidOsBundle.getString("themeId"))))
    {
      ...
      paramToServiceMsg = this.jdField_a_of_type_Bdqf;
      if (i == 0)
      {
        i = 4;
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    {
      if (!bdoq.a(paramString1, paramString2)) {
        a(paramString1, paramString2);
      }
      while (ThemeUtil.isFixTheme(paramString1)) {
        return;
      }
      bdpw.a(this.app, paramString1, "20000000");
      return;
    }
    a(paramString1, paramString2);
  }
  ...
  public void a()
  {
    ...
    else
    {
      ...
      QLog.d("Theme.ThemeHandler", 1, "sendThemeAuth init: , skThemeId:" + ((Bundle)localObject4).getString("themeId") + ", skVersion:" + ((Bundle)localObject4).getString("version") + ", qqVersion:" + "8.4.1");
      ...
      if (bcnj.a((String)localObject2))
      {
        localObject3 = bdpw.a(this.app).getString("themeID");
    ...
    for (;;)
    {
      ...
      ((Bundle)localObject4).putString("themePath", new bdps().a().d());
    }
    label565:
    Object localObject2 = new bdps().a((String)localObject3);
    ((VasQuickUpdateManager)this.app.getManager(184)).queryItemVersion(3, ((bdps)localObject2).b(), true, false, 0L, new anvu(this, (bdps)localObject2, localMobileQQ, (Bundle)localObject4));
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      return;
      label110:
      ThemeSwitcher.a(paramString1, paramString2, new anvt(this));
    }
  }
  
  /* Error */
  public void a(String paramString1, String paramString2, String paramString3, Bundle paramBundle, bdqf parambdqf)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 7
    ...
    //   86: aload_0
    //   87: aload 5
    //   89: putfield 843	anvs:jdField_a_of_type_Bdqf	Lbdqf;
    //   92: aload_0
    //   93: aload 4
    //   95: putfield 845	anvs:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    ...
    //   362: ldc_w 700
    //   365: aload_0
    //   366: getfield 57	anvs:mApp	Lcom/tencent/common/app/AppInterface;
    ...
    //   387: aload_0
    //   388: aload_2
    //   389: invokespecial 727	anii:sendPbReq	(Lcom/tencent/qphone/base/remote/ToServiceMsg;)V
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString1.str_qq_version.set("8.4.1.4680");
        paramString1.uint32_qq_version.set(Integer.parseInt("4680"));
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, com.tencent.qphone.base.remote.FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   50: checkcast 1253	[B
    //   53: checkcast 1253	[B
    //   56: invokestatic 1258	bgva:a	([B)Ljava/lang/String;
    ...
    //   139: aload_1
    //   140: iload 4
    //   142: invokespecial 1268	anvs:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;I)I
    //   145: istore 5
    //   147: ldc 136
    //   149: iconst_1
    ...
    //   170: invokestatic 1258	bgva:a	([B)Ljava/lang/String;
    ...
    //   338: aload_0
    //   339: getfield 323	anvs:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   342: ldc_w 1283
    //   345: iload 4
    ...
    //   355: aconst_null
    //   356: fconst_0
    //   357: invokestatic 1288	bgzu:a	(Lmqq/app/AppRuntime;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;F)V
    ...
    //   386: invokestatic 1293	bctj:a	(Landroid/content/Context;)Lbctj;
    //   389: ldc_w 287
    //   392: ldc_w 1283
    //   395: iconst_0
    //   396: lconst_0
    ...
    //   402: ldc_w 287
    //   405: iconst_1
    //   406: invokevirtual 1298	bctj:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   409: aload_0
    //   410: getfield 323	anvs:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   413: ldc_w 665
    //   416: ldc_w 741
    //   419: sipush 157
    //   422: aconst_null
    //   423: invokestatic 663	bgnt:a	(Landroid/content/Context;)I
    //   426: iconst_0
    //   427: iload 4
    //   429: isub
    //   430: aload_3
    ...
    //   433: ldc_w 402
    //   436: ldc_w 287
    //   439: invokestatic 672	bdpt:a	(Lmqq/app/AppRuntime;Ljava/lang/String;Ljava/lang/String;IIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   485: pop
    //   486: aload_0
    //   487: getfield 57	anvs:mApp	Lcom/tencent/common/app/AppInterface;
    //   490: invokevirtual 247	com/tencent/common/app/AppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   493: invokestatic 1293	bctj:a	(Landroid/content/Context;)Lbctj;
    //   496: astore 10
    //   498: aload_0
    //   499: getfield 57	anvs:mApp	Lcom/tencent/common/app/AppInterface;
    ...
    //   528: ldc_w 287
    //   531: iconst_0
    //   532: invokevirtual 1298	bctj:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   535: iload 4
    //   537: iconst_1
    ...
    //   561: aload_0
    //   562: getfield 57	anvs:mApp	Lcom/tencent/common/app/AppInterface;
    ...
    //   588: pop
    //   589: aload_0
    //   590: getfield 57	anvs:mApp	Lcom/tencent/common/app/AppInterface;
    //   593: ldc_w 356
    //   596: ldc_w 338
    ...
    //   666: aload_1
    //   667: aload_2
    //   668: invokespecial 1320	anvs:a	(ILjava/lang/String;Ljava/lang/String;Lcom/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth;)V
    //   671: return
    //   672: astore_1
    //   673: ldc 136
    //   675: iconst_1
    ...
    //   794: aload_3
    //   795: aload 8
    //   797: invokespecial 1328	anvs:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth;Ljava/lang/String;Ljava/lang/String;)Z
    //   800: ifeq -787 -> 13
    //   803: return
    //   804: ldc 136
    //   806: iconst_1
    ...
    //   833: aconst_null
    //   834: iconst_1
    //   835: invokevirtual 1006	anvs:a	(Ljava/lang/String;Ljava/lang/String;Z)V
    //   838: return
    //   839: iconst_2
    //   840: iload 5
    ...
    //   845: aload_0
    //   846: aload 7
    //   848: invokespecial 1332	anvs:a	(Lcom/tencent/pb/theme/ThemeAuth$RspBody;)V
    //   851: return
    //   852: iconst_3
    //   853: iload 5
    ...
    //   860: aload 7
    //   862: iload 6
    //   864: invokespecial 1334	anvs:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/pb/theme/ThemeAuth$RspBody;Z)Z
    //   867: ifeq -854 -> 13
    //   870: return
    //   871: ldc 136
    //   873: iconst_1
