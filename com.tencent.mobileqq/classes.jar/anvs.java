...
public final class anvs
  extends Animation
{
  static final WeakHashMap<View, anvs> jdField_a_of_type_JavaUtilWeakHashMap;
  ...
  public static anvs a(View paramView)
  {
    anvs localanvs2 = (anvs)jdField_a_of_type_JavaUtilWeakHashMap.get(paramView);
    anvs localanvs1;
    if (localanvs2 != null)
    {
      localanvs1 = localanvs2;
      if (localanvs2 == paramView.getAnimation()) {}
    }
    else
    {
      localanvs1 = new anvs(paramView);
      jdField_a_of_type_JavaUtilWeakHashMap.put(paramView, localanvs1);
    }
    return localanvs1;
  }
