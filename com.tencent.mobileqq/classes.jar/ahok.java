  ...
  implements View.OnClickListener
{
  ...
  public ahok(BaseActivity paramBaseActivity)
  {
  ...
  public static void a(Intent paramIntent, FrameHelperActivity paramFrameHelperActivity)
  {
    ...
    ahpf.a(paramFrameHelperActivity, paramIntent);
  }
  ...
  public static boolean a(BaseActivity paramBaseActivity)
  {
    ...
    {
      bcpw.a(paramBaseActivity, ajyc.a(2131713200), 0).a();
      return false;
    }
    return true;
  }
  ...
  private void n()
  {
    if (!VideoEnvironment.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app)) {
      bbcv.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230).setMessage(ajyc.a(2131713202)).setPositiveButton(2131694793, new ahoo(this)).show();
    }
    do
    {
      return;
  ...
  public bfuf a(int[] paramArrayOfInt)
  {
    bfuf localbfuf = new bfuf();
    localbfuf.jdField_a_of_type_Int = paramArrayOfInt[0];
    localbfuf.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(paramArrayOfInt[0]);
    localbfuf.c = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(paramArrayOfInt[0]);
    localbfuf.b = paramArrayOfInt[1];
    return localbfuf;
  }
  ...
  public void a()
  {
    ...
    Object localObject;
    if (aojo.c(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app))
    {
      this.jdField_d_of_type_Boolean = true;
      localObject = a(j);
      this.jdField_a_of_type_JavaLangString = aojo.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
      {
        ((bfuf)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
        ((bfuf)localObject).c = this.jdField_a_of_type_JavaLangString;
      }
    ...
    for (;;)
    {
      ...
      localObject = amtc.a();
      if ((localObject != null) && (((amtb)localObject).c())) {
      ...
      if ((agxc.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getCurrentAccountUin(), "F2FRedpackEntry", false)) && (c()))
      {
        this.jdField_a_of_type_JavaUtilList.add(a(g));
        this.jdField_e_of_type_Boolean = true;
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "hongbaocaidan.show", 0, 0, "", "", "", "");
      }
      if (AudioHelper.d()) {
      ...
      this.jdField_a_of_type_Bfuc = bfuc.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_JavaUtilList, new ahol(this), new ahom(this));
      return;
  ...
  protected void a(int paramInt)
  {
    ...
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "CliOper", "", "", "0X8005ED3", "0X8005ED3", 0, 0, "", "", "", "");
  }
  
  public void a(View paramView, int paramInt1, int paramInt2)
  {
    if ((this.jdField_a_of_type_Bfuc != null) && (this.jdField_a_of_type_Bfuc.jdField_a_of_type_Boolean)) {
    ...
    for (;;)
    {
      ...
      {
        paramView = (LinearLayout)this.jdField_a_of_type_Bfuc.getContentView().findViewById(2131364692);
        paramInt1 = 0;
        label76:
        if (paramInt1 < paramView.getChildCount()) {
          try
          {
            ...
            if (((bfuf)((View)localObject).getTag()).jdField_a_of_type_Int == 2131691263)
            {
            ...
            for (;;)
            {
              ...
              {
                localObject = aojo.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
              ...
              if (((this.jdField_d_of_type_Boolean) && (!aojo.c(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app))) || ((!this.jdField_d_of_type_Boolean) && (aojo.c(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app)))) {
                this.jdField_a_of_type_Boolean = true;
              }
              ...
              if (((this.jdField_e_of_type_Boolean) && (!agxc.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getCurrentAccountUin(), "F2FRedpackEntry", false))) || ((!this.jdField_e_of_type_Boolean) && (agxc.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getCurrentAccountUin(), "F2FRedpackEntry", false))))
              {
                a();
              ...
              if (agxc.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getCurrentAccountUin()))
              {
              ...
              if (((bfuf)((View)localObject).getTag()).jdField_a_of_type_Int != 2131691280) {
                break label576;
              }
          ...
          catch (Exception localException)
          {
            for (;;)
            {
              ...
              continue;
              if (((bfuf)localException.getTag()).jdField_a_of_type_Int == 2131691269)
              {
                this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localException.findViewById(2131377197));
    ...
    {
      paramView = ((avpq)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(36)).a("101210.101211");
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      bihe.a(BaseApplicationImpl.getContext(), "peak_preload_plus_panel");
      b();
      if (this.jdField_d_of_type_Boolean) {
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00898", "", "", "0X800A69B", "0X800A69B", 0, 0, "", "", "", "");
      }
      return;
    }
  }
  ...
  public bfuf b(int[] paramArrayOfInt)
  {
    bfuf localbfuf = new bfuf();
    localbfuf.jdField_a_of_type_Int = paramArrayOfInt[0];
    localbfuf.c = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(paramArrayOfInt[0]);
    ...
    {
      localbfuf.jdField_a_of_type_JavaLangString = localDItemInfo.showName;
      localbfuf.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = localDItemInfo.drawable;
      return localbfuf;
    }
    localbfuf.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getString(paramArrayOfInt[0]);
    localbfuf.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = null;
    return localbfuf;
  }
  ...
  protected void c()
  {
    ...
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "CliOper", "", "", "0X8004077", "0X8004077", 0, 0, "", "", "", "");
  }
  ...
  protected void d()
  {
    ...
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "CliOper", "", "", "0X8004839", "0X8004839", 0, 0, "", "", "", "");
    try
    {
      ((avpq)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(36)).b(String.valueOf("101210.101211"));
      return;
    }
    catch (Exception localException) {}
  }
  ...
  protected void f()
  {
    bgmt.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 8, null);
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "CliOper", "", "", "0X80053AD", "0X80053AD", 0, 0, "", "", "", "");
  }
  ...
  protected void g()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.startActivity(localIntent);
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "jiahao.hongbao.click", 0, 0, "", "", "", "");
  }
  ...
  protected void h()
  {
    ...
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "CliOper", "", "", "0X8004074", "0X8004074", 0, 0, "", "", "", "");
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00899", "Grp_create", "", "msg_page", "exp_creategrp", 0, 0, "", "", "", "");
  }
  
  protected void i()
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "CliOper", "", "", "0X800780A", "0X800780A", 0, 0, "", "", "", "");
    vel.a("plus_shoot", "clk_entry", 0, 0, new String[] { "", "", "", "" });
    vel.a("plus_shoot", "exp_shoot", 0, 0, new String[] { "", "", "", "" });
  ...
  {
    if (!VideoEnvironment.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app)) {
      bbcv.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 230).setMessage(ajyc.a(2131713203)).setPositiveButton(2131694793, new ahon(this)).show();
    }
  }
  ...
  protected void k()
  {
    ...
    {
      return;
      boolean bool = axgm.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
      RecentDanceConfigMgr.a("showDanceCategoryPanel: videoUsable=" + bool);
      avtb.h();
      localObject = bifx.a(null, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getClass().getName(), 10004, 8, ((RecentDanceConfigMgr.DItemInfo)localObject).unfold, ((RecentDanceConfigMgr.DItemInfo)localObject).categoryID, ((RecentDanceConfigMgr.DItemInfo)localObject).itemID);
      vwm.a().a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (Bundle)localObject, 9010);
  ...
  protected void m()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null) && (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app != null))
    {
      ...
      axqw.b(null, "dc00898", "", "", "0X800A68C", "0X800A68C", 4, 0, "", "", "", "");
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00898", "", "", "0X800A69C", "0X800A69C", 0, 0, "", "", "", "");
      return;
    }
