  ...
  implements aukb
{
  ...
  private static final String e = amtj.a(2131704834);
  private static final String f = amtj.a(2131690110);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = amtj.a(2131704830);
    jdField_b_of_type_JavaLangString = amtj.a(2131704829);
    d = amtj.a(2131704835);
    jdField_c_of_type_JavaLangString = amtj.a(2131704838);
  }
      ...
      for (;;)
      {
        ...
        try
        {
          if (paramIntent.hasExtra("data"))
          {
            ...
            localJSONObject.put("errMsg", paramIntent.getString("errMsg", amtj.a(2131704837)));
            localJSONObject.put("idKey", paramIntent.getString("idKey"));
            localJSONObject.put("allResults", localObject1);
          }
          for (;;)
          {
            bcef.b(null, "dc00898", "", "", "0X8009862", "0X8009862", 0, 0, this.jdField_c_of_type_Int + "", "", this.jdField_b_of_type_Int + "", paramInt + "");
            if (QLog.isColorLevel()) {
            ...
            else
            {
              ...
              localJSONObject.put("errMsg", amtj.a(2131704836));
              localJSONObject.put("allResults", localObject1);
              paramInt = 299;
            }
          }
  ...
  private void a(aujs paramaujs)
  {
    paramaujs = paramaujs.a();
    if (paramaujs != null) {
      paramaujs.a(this);
    }
    QLog.d("IdentificationApiPlugin", 1, "doFaceVerify");
    if (((paramaujs instanceof aukq)) || ("identify".equals(this.l)))
    {
      e();
      if (!(paramaujs instanceof aukq)) {}
    }
    try
    {
      paramaujs = new JSONObject();
      paramaujs.put("ret", 219);
      paramaujs.put("errMsg", f);
      a(paramaujs);
      return;
    }
    catch (JSONException paramaujs)
    {
      QLog.e("IdentificationApiPlugin", 1, new Object[] { "RET_CODE_AREA_NOT_SUPPORT error : ", paramaujs.getMessage() });
    }
  }
  ...
  private void c()
  {
    if (aujs.d.contains(this.l))
    {
      aujv.a(this.jdField_a_of_type_AndroidAppActivity, this.h, this.l, this.n, this.jdField_a_of_type_Long, this.jdField_b_of_type_Int, new autu(this));
      return;
    }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    } while (!aujs.a.contains(paramString3));
    ...
    try
    {
      ...
      d();
      paramJsBridgeListener = aujs.a();
      paramJsBridgeListener.a(i1, this.n, paramString3, new autt(this, paramJsBridgeListener));
      return true;
    }
