...
public final class bnzb
{
  ...
  public static boag a(String paramString1, String paramString2, String paramString3, long paramLong, int paramInt, String paramString4, String paramString5)
  {
    ...
    for (;;)
    {
      return boag.a(10, paramString1, paramString2, paramString3, paramLong, paramInt, BaseApplicationImpl.getApplication().getRuntime().getAccount(), paramString4, paramString5);
    }
  }
  ...
  private static String a()
  {
    if (jdField_a_of_type_JavaLangString == null) {
      jdField_a_of_type_JavaLangString = "V1_AND_WY_VersionName_" + bews.a() + "_ChannelId_" + "B";
    }
  ...
  public static void a(Application paramApplication, boolean paramBoolean)
  {
    ...
    WeiyunTransmissionGlobal.AppInfo localAppInfo = new WeiyunTransmissionGlobal.AppInfo(a(), 1000269, "mobileqq", bews.a(), 0, "unknown");
    ...
    {
      localWeiyunTransmissionGlobal.initTransmission(localAppInfo, paramApplication, new bnzh(str), boce.a());
      ...
      AppNetConnInfo.registerNetChangeReceiver(null, new bnzc());
      boan.a().a(new bnzd(), paramApplication);
      boan.a().a(new bnzf());
      WeiyunTransmissionGlobal.getInstance().getUploadManager().addGlobalObserver(new bnzg());
