...
public class aojf
  extends aoeu
{
  public aojf(ExtendFriendLimitChatMatchFragment paramExtendFriendLimitChatMatchFragment) {}
  
  protected void a(int paramInt)
  {
    asfj.a(this.a.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch, ExtendFriendLimitChatMatchFragment.a(this.a).app);
  }
  ...
  protected void a(boolean paramBoolean1, ArrayList<aogi> paramArrayList, boolean paramBoolean2, int paramInt, ArrayList<String> paramArrayList1)
  {
    ...
    if (paramBoolean1)
    {
      if (paramInt <= 0)
      {
        ...
        {
          if (this.a.jdField_a_of_type_Aolc == null) {
            break label260;
          }
          this.a.jdField_a_of_type_Aolc.a(paramArrayList1);
        }
      }
      for (;;)
      {
        ...
        paramArrayList1 = new aolr();
        paramArrayList1.a(paramArrayList);
        paramInt = 0;
        while (paramInt < paramArrayList.size())
        {
          localObject = (aogi)paramArrayList.get(paramInt);
          if (!TextUtils.isEmpty(((aogi)localObject).a)) {
            ExtendFriendLimitChatMatchFragment.a(this.a, ExtendFriendLimitChatMatchFragment.a(this.a) + ((aogi)localObject).a + ";");
          }
          paramInt += 1;
        }
        Object localObject = paramInt + BaseApplication.getContext().getResources().getString(2131698987);
