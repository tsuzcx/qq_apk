  ...
  extends ReportDialog
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131374441));
    ...
    ((RelativeLayout)findViewById(2131374440)).setOnClickListener(new zoe(this));
    ...
    for (;;)
    {
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(new zoh(this));
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      break;
      label207:
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      if (this.jdField_a_of_type_AndroidWidgetTextView.getPaint().measureText(this.jdField_a_of_type_JavaLangString) > zlx.a(getContext(), 280.0F)) {
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new zof(this));
      break label160;
      label335:
      ...
      if (this.jdField_b_of_type_AndroidViewView$OnClickListener != null) {
        ...
        this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(new zog(this));
      }
    }
  }
}
