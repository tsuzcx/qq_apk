...
public class psv
  extends pqq
{
  public psv(Context paramContext, baxy parambaxy, ram paramram)
  {
  ...
  public pqq a()
  {
    ...
    return c(this.jdField_a_of_type_Ram, this.jdField_a_of_type_Baxy).q().l().n().h().j();
  }
  ...
  public pqq d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null)
    {
      ...
      localRelativeLayout2.setLayoutParams(new LinearLayout.LayoutParams(-1, actj.a(86.0F, this.jdField_a_of_type_AndroidContentContext.getResources())));
      ...
      localRelativeLayout2.setBackgroundResource(2130842330);
      localRelativeLayout2.setOnClickListener(new psw(this));
