...
public class psv
{
  ...
  public static long a(qft paramqft)
  {
    if (!a())
    {
    ...
    QLog.d("FeedsPreloadHelper", 1, new Object[] { "updateRequestVersionAndGet, channelID = ", Integer.valueOf(paramqft.b), ", beginSeq = ", Long.valueOf(paramqft.a) });
    if ((paramqft.b == 0) && (paramqft.a == -1L))
    {
  ...
  public static void a()
  {
    ...
    bnrf.a("sp_key_readinjoy_feeds_preload_last_enter_kd_millisecond", Long.valueOf(l));
  }
  ...
  public static boolean a()
  {
    ...
    if (!((Boolean)bnrf.a("sp_key_readinjoy_feeds_preload_switch", Boolean.valueOf(false))).booleanValue())
    {
  ...
  public static boolean a(qft paramqft)
  {
    if ((paramqft != null) && (a()) && (paramqft.b == 0) && (paramqft.a == -1L))
    {
  ...
  public static boolean a(boolean paramBoolean)
  {
    ...
    long l1 = ((Long)bnrf.a("sp_key_readinjoy_feeds_preload_last_enter_kd_millisecond", Long.valueOf(-1L))).longValue();
    if (l1 == -1L)
    {
    ...
    long l3 = ((Long)bnrf.a("sp_key_readinjoy_feeds_preload_last_enter_kd_day", Long.valueOf(90L))).longValue();
    ...
    l2 = ((Long)bnrf.a("sp_key_readinjoy_feeds_preload_last_preload_millisecond", Long.valueOf(-1L))).longValue();
    if (l2 != -1L)
    {
      l3 = System.currentTimeMillis();
      l1 = ((Long)bnrf.a("sp_key_readinjoy_feeds_preload_interval", Long.valueOf(30L))).longValue();
      l2 = (l3 - l2) / 1000L / 60L;
  ...
  public static void b()
  {
    ...
    bnrf.a("sp_key_readinjoy_feeds_preload_last_preload_millisecond", Long.valueOf(l));
  }
  ...
  public static boolean b(qft paramqft)
  {
    if (paramqft != null)
    {
      if ((paramqft.i & 0x100) != 0) {}
