  ...
  implements bbtg
{
  ...
  public zpx(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localObject2 = zpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationInfo().sourceDir);
    ...
    for (int i = 0;; i = 1)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject1 = new bbta(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), (bbsx)localObject1);
          if (localObject1 == null) {
            break;
          }
          localObject1 = (bbtf)((bbta)localObject1).a("sig_check");
          if (localObject1 == null) {
            break;
          }
          ((bbtf)localObject1).a(this);
          ((bbtf)localObject1).a(((JSONObject)localObject4).toString());
          return;
        }
