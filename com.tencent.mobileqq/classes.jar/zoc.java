...
public class zoc
{
  ...
  public static Bitmap a(int paramInt1, int paramInt2, Bitmap.Config paramConfig, boolean paramBoolean)
  {
    ...
    {
      yuk.c("BitmapUtils", "OutOfMemoryError", paramConfig);
      wjj.a().dispatch(new zoe());
    }
    return null;
  }
  ...
  public static Bitmap a(Bitmap paramBitmap, int paramInt)
  {
    ...
    if (paramInt % 360 != 0)
    {
      yuk.d("BitmapUtils", "generateOrientation begin!");
      ...
      yuk.d("BitmapUtils", "generateOrientation end, cost:" + (System.currentTimeMillis() - l) / 1000.0D);
      return paramBitmap;
    }
  ...
  public static Bitmap a(Bitmap paramBitmap1, Bitmap paramBitmap2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        yuk.c("BitmapUtils", paramBitmap1.getMessage(), paramBitmap1);
      }
    }
    return null;
  }
  ...
  public static Bitmap a(String paramString)
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: invokestatic 270	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: ifeq +7 -> 13
    //   9: aload_2
    //   10: astore_1
    //   11: aload_1
    //   12: areturn
    //   13: new 272	java/io/BufferedInputStream
    //   16: dup
    //   17: new 274	java/io/FileInputStream
    //   20: dup
    //   21: aload_0
    //   22: invokespecial 277	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   25: invokespecial 280	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   28: astore_0
    //   29: aload_0
    //   30: astore_1
    //   31: aload_0
    //   32: invokestatic 286	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    //   35: astore_3
    //   36: aload_3
    //   37: astore_2
    //   38: aload_2
    ...
    //   41: ifnull -30 -> 11
    //   44: aload_0
    //   45: invokevirtual 289	java/io/BufferedInputStream:close	()V
    //   48: aload_2
    //   49: areturn
    //   50: astore_0
    //   51: ldc 28
    //   53: ldc_w 291
    //   56: aload_0
    //   57: invokestatic 36	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   60: aload_2
    //   61: areturn
    //   62: astore_2
    //   63: aconst_null
    ...
    //   69: ldc_w 293
    //   72: aload_2
    //   73: invokestatic 36	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   76: aload_0
    //   77: astore_1
    //   78: aload_2
    //   79: athrow
    ...
    //   82: ifnull +7 -> 89
    //   85: aload_1
    //   86: invokevirtual 289	java/io/BufferedInputStream:close	()V
    //   89: aload_0
    //   90: athrow
    //   91: astore_1
    //   92: aconst_null
    ...
    //   96: ldc_w 295
    //   99: aload_1
    //   100: invokestatic 36	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   103: aload_2
    //   104: astore_1
    //   105: aload_0
    //   106: ifnull -95 -> 11
    ...
    //   118: ldc_w 291
    //   121: aload_0
    //   122: invokestatic 36	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   125: aconst_null
    //   126: areturn
    //   127: astore_1
    //   128: ldc 28
    //   130: ldc_w 291
    //   133: aload_1
    //   134: invokestatic 36	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   137: goto -48 -> 89
    //   140: astore_0
    //   141: aconst_null
    //   142: astore_1
  ...
  /* Error */
  public static Bitmap a(String paramString, zod paramzod)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 6
    ...
    //   12: aload_0
    //   13: ifnonnull +14 -> 27
    //   16: new 298	java/lang/IllegalArgumentException
    //   19: dup
    //   20: ldc_w 300
    //   23: invokespecial 301	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   26: athrow
    //   27: new 303	java/io/DataInputStream
    //   30: dup
    //   31: new 274	java/io/FileInputStream
    //   34: dup
    //   35: new 305	java/io/File
    //   38: dup
    //   39: aload_0
    //   40: invokespecial 306	java/io/File:<init>	(Ljava/lang/String;)V
    //   43: invokespecial 309	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   46: invokespecial 310	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   49: astore 8
    //   51: aload 5
    //   53: astore 6
    //   55: aload 9
    ...
    //   60: astore 7
    //   62: aload 8
    //   64: invokevirtual 313	java/io/DataInputStream:readInt	()I
    //   67: istore_2
    //   68: aload 5
    //   70: astore 6
    //   72: aload 9
    ...
    //   77: astore 7
    //   79: aload 8
    //   81: invokevirtual 313	java/io/DataInputStream:readInt	()I
    //   84: pop
    //   85: iload_2
    //   86: sipush 187
    ...
    //   101: astore 7
    //   103: aload 8
    //   105: invokevirtual 316	java/io/DataInputStream:readBoolean	()Z
    //   108: pop
    //   109: aload 5
    //   111: astore 6
    //   113: aload 9
    ...
    //   116: aload 8
    //   118: astore 7
    //   120: invokestatic 320	android/graphics/Bitmap$Config:values	()[Landroid/graphics/Bitmap$Config;
    //   123: aload 8
    //   125: invokevirtual 313	java/io/DataInputStream:readInt	()I
    //   128: aaload
    //   129: astore 10
    //   131: aload 5
    //   133: astore 6
    ...
    //   140: astore 7
    //   142: aload 8
    //   144: invokevirtual 313	java/io/DataInputStream:readInt	()I
    //   147: istore_2
    //   148: aload 5
    //   150: astore 6
    //   152: aload 9
    ...
    //   157: astore 7
    //   159: aload 8
    //   161: invokevirtual 313	java/io/DataInputStream:readInt	()I
    //   164: istore_3
    //   165: aload 5
    //   167: astore 6
    //   169: aload 9
    ...
    //   174: astore 7
    //   176: aload 8
    //   178: invokevirtual 313	java/io/DataInputStream:readInt	()I
    //   181: pop
    //   182: aload 5
    //   184: astore 6
    //   186: aload 9
    ...
    //   191: astore 7
    //   193: aload 8
    //   195: invokevirtual 313	java/io/DataInputStream:readInt	()I
    //   198: pop
    //   199: aload 5
    //   201: astore 6
    //   203: aload 9
    ...
    //   208: astore 7
    //   210: aload 8
    //   212: invokevirtual 313	java/io/DataInputStream:readInt	()I
    //   215: istore 4
    //   217: aload_1
    //   218: ifnull +110 -> 328
    //   221: aload 5
    ...
    //   232: aload_1
    //   233: iload 4
    //   235: invokevirtual 325	zod:a	(I)[B
    //   238: astore 5
    //   240: aload 5
    //   242: astore 6
    //   244: aload 5
    ...
    //   251: aload 8
    //   253: aload 5
    //   255: invokevirtual 329	java/io/DataInputStream:read	([B)I
    //   258: pop
    //   259: aload 5
    //   261: astore 6
    //   263: aload 5
    ...
    //   290: aload 9
    //   292: aload 5
    //   294: invokestatic 335	java/nio/ByteBuffer:wrap	([B)Ljava/nio/ByteBuffer;
    //   297: invokevirtual 339	android/graphics/Bitmap:copyPixelsFromBuffer	(Ljava/nio/Buffer;)V
    //   300: aload_1
    //   301: ifnull +14 -> 315
    //   304: aload 5
    //   306: ifnull +9 -> 315
    //   309: aload_1
    //   310: aload 5
    //   312: invokevirtual 342	zod:a	([B)V
    //   315: aload 8
    //   317: ifnull +8 -> 325
    //   320: aload 8
    //   322: invokevirtual 343	java/io/DataInputStream:close	()V
    //   325: aload 9
    //   327: areturn
    //   328: aload 5
    //   330: astore 6
    ...
    //   355: aload 8
    //   357: astore 7
    //   359: new 264	java/io/IOException
    //   362: dup
    ...
    //   376: iload_2
    //   377: invokevirtual 348	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   380: invokevirtual 135	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   383: invokespecial 349	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   386: athrow
    //   387: astore 5
    //   389: aload 8
    //   391: astore 7
    //   393: aload 6
    //   395: astore_0
    //   396: new 264	java/io/IOException
    //   399: dup
    //   400: ldc_w 351
    //   403: aload 5
    //   405: invokespecial 354	java/io/IOException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   408: athrow
    //   409: astore 6
    //   411: aload_0
    //   412: astore 5
    ...
    //   426: aload_1
    //   427: aload 5
    //   429: invokevirtual 342	zod:a	([B)V
    //   432: aload 7
    //   434: ifnull +8 -> 442
    //   437: aload 7
    //   439: invokevirtual 343	java/io/DataInputStream:close	()V
    //   442: aload_0
    //   443: athrow
    //   444: astore_0
    //   445: aconst_null
  ...
  @TargetApi(12)
  public static void a(Bitmap paramBitmap, String paramString, zod paramzod)
  {
    try
    {
      b(paramBitmap, paramString, paramzod);
      return;
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      yuk.c("BitmapUtils", "serializeBitmapToFile failed", localOutOfMemoryError);
  ...
  public static boolean a(Bitmap paramBitmap, Bitmap.CompressFormat paramCompressFormat, int paramInt, String paramString)
  {
    ...
    //   26: aconst_null
    //   27: astore 6
    //   29: new 305	java/io/File
    //   32: dup
    //   33: aload_3
    //   34: invokespecial 306	java/io/File:<init>	(Ljava/lang/String;)V
    //   37: astore 9
    //   39: aload 5
    //   41: astore_3
    //   42: aload 9
    ...
    //   64: ldc 28
    //   66: ldc_w 451
    //   69: invokestatic 454	yuk:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   72: aconst_null
    //   73: invokestatic 459	zop:a	(Ljava/io/Closeable;)V
    //   76: iconst_0
    //   77: ireturn
    //   78: aload 5
    //   80: astore_3
    ...
    //   110: ifeq +10 -> 120
    //   113: aload 5
    //   115: invokestatic 459	zop:a	(Ljava/io/Closeable;)V
    //   118: iconst_0
    //   119: ireturn
    //   120: aload_0
    //   121: aload_1
    ...
    //   131: ldc 28
    //   133: ldc_w 473
    //   136: invokestatic 454	yuk:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   139: aload 5
    //   141: invokestatic 459	zop:a	(Ljava/io/Closeable;)V
    //   144: iconst_0
    //   145: ireturn
    //   146: aload 5
    //   148: invokestatic 459	zop:a	(Ljava/io/Closeable;)V
    //   151: iconst_1
    //   152: ireturn
    //   153: astore_1
    //   154: aload 6
    ...
    //   165: aload_1
    //   166: invokestatic 36	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   169: aload_0
    //   170: invokestatic 459	zop:a	(Ljava/io/Closeable;)V
    //   173: iconst_0
    //   174: ireturn
    //   175: astore_1
    //   176: aload 7
    ...
    //   187: aload_1
    //   188: invokestatic 36	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   191: aload_0
    //   192: invokestatic 459	zop:a	(Ljava/io/Closeable;)V
    //   195: iconst_0
    //   196: ireturn
    //   197: astore_1
    //   198: aload 8
    ...
    //   209: aload_1
    //   210: invokestatic 36	yuk:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   213: aload_0
    //   214: invokestatic 459	zop:a	(Ljava/io/Closeable;)V
    //   217: iconst_0
    //   218: ireturn
    //   219: astore_0
    //   220: aload_3
    //   221: invokestatic 459	zop:a	(Ljava/io/Closeable;)V
    //   224: aload_0
    //   225: athrow
    //   226: astore_0
    //   227: aload 5
  ...
  public static boolean a(String paramString)
  {
    if (paramString != null) {
      ...
      {
        yuk.c("BitmapUtils", "convertBitmapBinFileToPng failed", paramString);
      }
    }
    return false;
  }
  ...
  public static Bitmap b(Bitmap paramBitmap, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      yuk.c("BitmapUtils", "resizeAndFillBitmapEdge srcWidth=%s, srcHeight=%s, targetWidth=%s, targetHeight=%s, destRect=%s", new Object[] { Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), localObject1 });
  ...
  /* Error */
  @TargetApi(12)
  public static void b(Bitmap paramBitmap, String paramString, zod paramzod)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_3
    ...
    //   27: aload_1
    //   28: ifnonnull +14 -> 42
    //   31: new 298	java/lang/IllegalArgumentException
    //   34: dup
    //   35: ldc_w 528
    //   38: invokespecial 301	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   41: athrow
    //   42: new 530	java/io/DataOutputStream
    //   45: dup
    //   46: new 463	java/io/FileOutputStream
    //   49: dup
    //   50: new 305	java/io/File
    //   53: dup
    //   54: aload_1
    //   55: invokespecial 306	java/io/File:<init>	(Ljava/lang/String;)V
    ...
    //   164: invokevirtual 325	zod:a	(I)[B
    //   167: astore_3
    //   168: aload_3
    //   169: astore_1
    //   170: aload_0
    //   171: aload_3
    //   172: invokestatic 335	java/nio/ByteBuffer:wrap	([B)Ljava/nio/ByteBuffer;
    ...
    //   213: aload_2
    //   214: aload_3
    //   215: invokevirtual 342	zod:a	([B)V
    //   218: aload 4
    //   220: ifnull +8 -> 228
    //   223: aload 4
    ...
    //   255: aload_2
    //   256: aload_1
    //   257: invokevirtual 342	zod:a	([B)V
    //   260: aload_3
    //   261: ifnull +7 -> 268
    //   264: aload_3
  ...
  public static Bitmap c(Bitmap paramBitmap, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (f2 == f1)
    {
      yuk.b("BitmapUtils", "fillBackground. no need to resize");
      return paramBitmap;
    }
    if (f1 > f2)
    {
