  ...
  implements View.OnClickListener
{
  ...
  public bbwj(Context paramContext)
  {
  ...
  private void b(String paramString)
  {
    ...
    afsd.a(this.jdField_a_of_type_AndroidContentContext, localIntent, paramString);
  }
  ...
  void a(View paramView)
  {
    if (paramView != null)
    {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368142));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363369));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371544));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365377));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370457));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[0] = ((TextView)paramView.findViewById(2131364005));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[1] = ((TextView)paramView.findViewById(2131364006));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[2] = ((TextView)paramView.findViewById(2131364007));
      this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131363370);
      this.jdField_a_of_type_ArrayOfAndroidViewView[0] = paramView.findViewById(2131363549);
      this.jdField_a_of_type_ArrayOfAndroidViewView[1] = paramView.findViewById(2131363551);
      this.jdField_a_of_type_ArrayOfAndroidViewView[2] = paramView.findViewById(2131363550);
      this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131364008);
      if ((this.jdField_a_of_type_AndroidWidgetImageView instanceof ThemeImageView)) {
        ((ThemeImageView)this.jdField_a_of_type_AndroidWidgetImageView).setMaskShape(bkpg.jdField_c_of_type_Int);
      }
      if ((this.jdField_b_of_type_AndroidWidgetImageView instanceof ThemeImageView)) {
        ((ThemeImageView)this.jdField_b_of_type_AndroidWidgetImageView).setMaskShape(bkpg.jdField_c_of_type_Int);
      }
      this.jdField_b_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnGlobalLayoutListener(new bbwk(this));
      paramView.setOnClickListener(new bbwl(this));
    }
  }
  ...
  void b()
  {
    ...
    if (this.jdField_b_of_type_JavaLangString != null)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidViewView[i].setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166924));
    }
    for (;;)
    {
      i += 1;
    ...
    label363:
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new bbwm(this));
  }
  ...
  public void onClick(View paramView)
  {
    ...
    default: 
      ...
      {
        bbrf.a(null, this.jdField_c_of_type_Int, 0, "0X8009D2D", this.jdField_b_of_type_Int, i, this.g);
        label81:
        if (str != null)
        {
          if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      i = 3;
      break;
      bbrf.a(null, this.jdField_c_of_type_Int, 0, "0X8009D41", this.jdField_b_of_type_Int, i, this.g);
      break label81;
      label210:
      bgmp localbgmp = bgng.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_AndroidContentContext, str);
      if (localbgmp != null)
      {
        localbgmp.a();
      }
