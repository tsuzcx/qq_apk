...
public class mcp
  extends ldy
{
  public mcp(DoubleVideoMeetingCtrlUI paramDoubleVideoMeetingCtrlUI) {}
      ...
      case 90: 
        if (paramLong3 == 3L) {
          if (this.a.jdField_a_of_type_ComTencentAvUiQavPanel != null)
          {
            ...
            this.a.jdField_a_of_type_ComTencentAvUiQavPanel.setViewVisibility(2131373518, 0);
          }
        }
        break;
      case 96: 
        for (;;)
        {
          if ((!localley.j) || (this.a.c))
          {
            this.a.c = false;
            this.a.i(paramLong1);
            paramInt1 = localley.a(this.a.jdField_b_of_type_Long, 1);
            boolean bool = false;
            if (paramInt1 != -1) {
              bool = ((lnn)localley.c.get(paramInt1)).a;
            }
          ...
          return;
          if ((paramLong3 != 1L) || (localley.ap)) {
            break;
          }
          this.a.e("onGaOperationResult->REQUEST_VIDEO_SUC");
          this.a.a(paramLong1, localley.c);
          return;
          this.a.jdField_a_of_type_ComTencentAvUiQavPanel.setViewVisibility(2131373518, 8);
        }
      }
  ...
  protected void c(long paramLong, int paramInt)
  {
    ...
    if ((paramInt != -1) && (((lnn)this.a.jdField_a_of_type_ComTencentAvVideoController.a().c.get(paramInt)).a))
    {
  ...
  protected void d(long paramLong1, long paramLong2)
  {
    ...
    ley localley = this.a.jdField_a_of_type_ComTencentAvVideoController.a();
    if ((paramLong2 == this.a.jdField_a_of_type_Long) && (localley.g == paramLong2)) {
      this.a.a(paramLong1, localley, 3);
    }
  }
}
