...
public class bixn
{
  ...
  public bixn(ReaderTabBarView paramReaderTabBarView, int paramInt1, String paramString, boolean paramBoolean, int paramInt2, RedTouchUI paramRedTouchUI)
  {
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          catch (NumberFormatException localNumberFormatException)
          {
            for (;;)
            {
              bixe.a("ReaderTabBarView", localNumberFormatException.getMessage());
              continue;
              paramBoolean = false;
            }
          }
        ...
        catch (JSONException localJSONException)
        {
          for (;;)
          {
            bixe.a("ReaderTabBarView", localJSONException.getMessage());
          }
        }
