...
public class snu
{
  private static final String jdField_a_of_type_JavaLangString = snu.class.getSimpleName();
  ...
  public snu(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_b_of_type_JavaLangString = pkh.a();
  }
  ...
  public boolean a(VideoInfo.ECommerceEntranceInfo paramECommerceEntranceInfo)
  {
    ...
    try
    {
      boolean bool = bmhv.y(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (!bool) {
        bmhv.a(this.jdField_b_of_type_JavaLangString + paramECommerceEntranceInfo.g, Integer.valueOf(0));
      }
      if (bool) {}
      for (int i = ((Integer)bmhv.a(this.jdField_b_of_type_JavaLangString + paramECommerceEntranceInfo.g, Integer.valueOf(0))).intValue();; i = 0)
      {
