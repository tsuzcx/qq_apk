...
public class anvn
  extends anii
{
  public anvn(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramToServiceMsg != null)
    {
      ...
      try
      {
        localbdei.jdField_a_of_type_Int = 1000;
        notifyUI(0, false, localbdei);
        if (!QLog.isColorLevel()) {
          break label1697;
        }
      ...
      localbdei.jdField_b_of_type_JavaLangString = str3;
      localbdei.c = str1;
      if (i == 1000)
      {
        ...
        catch (InvalidProtocolBufferMicroException paramObject)
        {
          for (;;)
          {
            ...
            bctj.a(BaseApplication.getContext()).a(this.app.getCurrentAccountUin(), "actSBDBindProtol", false, 0L, 0L, paramToServiceMsg, "");
            localbdei.jdField_a_of_type_Int = 1001;
            notifyUI(0, false, localbdei);
            if (!QLog.isColorLevel()) {
              break label1697;
            }
            ...
            catch (InvalidProtocolBufferMicroException paramObject)
            {
              ...
              localbdei.jdField_b_of_type_Int = i;
              if (!QLog.isColorLevel()) {
                break label819;
              }
              ...
              bctj.a(BaseApplication.getContext()).a(this.app.getCurrentAccountUin(), "actSBDBindProtol", true, 0L, 0L, paramFromServiceMsg, "");
              try
              {
                localbdei.jdField_a_of_type_Int = 0;
                paramFromServiceMsg = (bdeh)this.app.getManager(61);
                paramToServiceMsg = paramToServiceMsg.extraData.getString("subaccount_a2");
                if (paramFromServiceMsg != null)
                {
                  paramFromServiceMsg.a(localbdei);
                  paramFromServiceMsg.a(str1, 1);
                  paramFromServiceMsg.a(str1, paramToServiceMsg, true);
                }
                bddy.a(this.app, (byte)1, str1);
                bddy.b(this.app, false, str1);
                bddy.a(this.app, str1, false);
                paramToServiceMsg = (aqtu)aqlk.a().a(607);
                if ((paramToServiceMsg != null) && (!paramToServiceMsg.a)) {
                  bdeg.a(this.app, str1);
                }
                if (AccountManageActivity.class.getSimpleName().equals(str2)) {
                  bcst.b(this.app, "CliOper", "", "", "0X8004003", "0X8004003", 0, 0, "", "", "", "");
                }
                bool1 = true;
              }
              catch (Exception paramToServiceMsg)
        ...
        if (paramFromServiceMsg == null)
        {
          ...
          paramFromServiceMsg.put("fail_location", "bindhandle");
          bctj.a(BaseApplication.getContext()).a(this.app.getCurrentAccountUin(), "actSBDBindProtol", false, 0L, 0L, paramFromServiceMsg, "");
          bool2 = bool1;
          if (QLog.isColorLevel())
          {
    ...
    {
      label373:
      notifyUI(0, bool1, localbdei);
      return;
      label398:
      label625:
      bctj.a(BaseApplication.getContext()).a(this.app.getCurrentAccountUin(), "actSBDBindProtol", bool1, 0L, 0L, paramToServiceMsg, "");
      label515:
      label771:
      label819:
      label1130:
      localbdei.jdField_a_of_type_JavaLangString = paramFromServiceMsg.str_errmsg.get();
      label1053:
      switch (i)
      {
      }
      for (;;)
      {
        ...
        {
          localbdei.jdField_a_of_type_Int = 1004;
          this.app.updateSubAccountLogin(localbdei.c, false);
          if (!QLog.isColorLevel()) {
            break label1779;
          }
          QLog.d("SUB_ACCOUNT", 2, "handlerBindSubAccount() ERRORTYPE_SUBACCOUNT_A2_ERROR");
          break label1779;
          localbdei.jdField_a_of_type_Int = 1002;
          if (!QLog.isColorLevel()) {
            break label1440;
          }
          ...
          bool1 = false;
          break label373;
          localbdei.jdField_a_of_type_Int = 1003;
          if (!QLog.isColorLevel()) {
            break label1440;
          }
        ...
        {
          localbdei.jdField_a_of_type_Int = 1005;
          if (!QLog.isColorLevel()) {
            break label1779;
          }
        ...
        do
        {
          for (;;)
          {
            if (i == 1221)
            {
              localbdei.jdField_a_of_type_Int = 1011;
              if (!QLog.isColorLevel()) {
                break label1440;
              }
            ...
            try
            {
              ...
              paramToServiceMsg.put("fail_location", "bindhandle");
              bctj.a(BaseApplication.getContext()).a(this.app.getCurrentAccountUin(), "actSBDBindProtol", false, 0L, 0L, paramToServiceMsg, "");
              localbdei.jdField_a_of_type_Int = 1007;
              bool2 = bool3;
              if (!QLog.isColorLevel()) {
                break;
              }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramToServiceMsg != null)
    {
      ...
      try
      {
        ...
        bctj.a(BaseApplication.getContext()).a(this.app.getCurrentAccountUin(), "actSBUnbindProtol", false, 0L, 0L, paramToServiceMsg, "");
        localbdei.jdField_a_of_type_Int = 1000;
        notifyUI(1, false, localbdei);
        if (!QLog.isColorLevel()) {
          break label1496;
        }
      ...
      i = paramFromServiceMsg.getResultCode();
      localbdei.jdField_b_of_type_JavaLangString = str2;
      localbdei.c = str1;
      if (i == 1000)
      {
        ...
        catch (InvalidProtocolBufferMicroException paramFromServiceMsg)
        {
          ...
          catch (InvalidProtocolBufferMicroException paramFromServiceMsg)
          {
            ...
            localbdei.jdField_b_of_type_Int = i;
            localbdei.jdField_a_of_type_JavaLangString = paramToServiceMsg.str_errmsg.get();
            if (!QLog.isColorLevel()) {
              break label1497;
            }
          }
        ...
        if (paramToServiceMsg == null)
        {
          ...
          bctj.a(BaseApplication.getContext()).a(this.app.getCurrentAccountUin(), "actSBUnbindProtol", false, 0L, 0L, paramFromServiceMsg, "");
          bool2 = bool1;
          if (QLog.isColorLevel())
          {
      ...
      for (;;)
      {
        for (;;)
        {
          for (;;)
          {
            ...
            paramToServiceMsg.put("fail_location", "SubBind");
            bctj.a(BaseApplication.getContext()).a(this.app.getCurrentAccountUin(), "actSBUnbindProtol", true, 0L, 0L, paramToServiceMsg, "");
            bool1 = true;
            try
            {
              localbdei.jdField_a_of_type_Int = 0;
              bddy.a(this.app, str1);
            }
            catch (Exception paramToServiceMsg)
            {
              bool1 = true;
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      paramToServiceMsg.put("fail_location", "SubBind");
      bctj.a(BaseApplication.getContext()).a(this.app.getCurrentAccountUin(), "actSBGetbindProtol", false, 0L, 0L, paramToServiceMsg, "");
      localbdei.jdField_a_of_type_Int = 1000;
      notifyUI(2, false, localbdei);
      if (!QLog.isColorLevel()) {
        break label2103;
      }
    ...
    localbdei.jdField_b_of_type_JavaLangString = paramToServiceMsg.getUin();
    boolean bool1;
    int j;
    boolean bool2;
    if (i == 1000)
    {
      ...
      if (paramToServiceMsg == null)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          paramFromServiceMsg.put("fail_step", "exception");
          paramFromServiceMsg.put("fail_location", "SubBind");
          bctj.a(BaseApplication.getContext()).a(this.app.getCurrentAccountUin(), "actSBGetbindProtol", false, 0L, 0L, paramFromServiceMsg, "");
          paramToServiceMsg.printStackTrace();
          j = i;
          bool2 = bool1;
          if (QLog.isColorLevel())
      ...
      else
      {
        ...
        if ((i == 1200) || (i == 1214) || (i == 1215) || (i == 1218) || (i == 1232) || (i == 1233) || (i == 1240) || (i == 1241) || (i == 1242))
        {
          ...
          paramFromServiceMsg.put("fail_location", "SubBind");
          bctj.a(BaseApplication.getContext()).a(this.app.getCurrentAccountUin(), "actSBGetbindProtol", true, 0L, 0L, paramFromServiceMsg, "");
          paramFromServiceMsg = (bdeh)this.app.getManager(61);
    ...
    for (;;)
    {
      ...
      {
        localbdei.jdField_a_of_type_Int = 0;
        localbdei.a(paramToServiceMsg, paramObject);
        paramObject = localbdei.b();
        if ((paramObject != null) && (paramObject.size() > 0))
        {
          paramToServiceMsg = (bddy)this.app.getManager(62);
        ...
        if (localbdei.c())
        {
          ...
          paramObject = localbdei.jdField_a_of_type_JavaUtilArrayList.iterator();
          i = 1;
        }
        try
        {
          if (paramObject.hasNext())
          {
            ...
            bool1 = false;
            localObject = bddy.a(this.app, str);
            if (localObject != null) {
        ...
        try
        {
          localObject = bdei.a(localbdei);
          ((bdei)localObject).c = str;
          this.app.getSubAccountKey(this.app.getAccount(), ((bdei)localObject).c, new anvo(this, (bdei)localObject, paramFromServiceMsg, bool2));
          i = 0;
        }
        catch (Exception paramToServiceMsg)
        {
        ...
        if (paramFromServiceMsg.a(str, 2))
        {
          ...
          if (j != 0)
          {
            ...
            this.app.a().a(new String[] { anhk.x, str });
          }
          if (QLog.isColorLevel()) {
        ...
        localbdei.jdField_a_of_type_Int = 1008;
        bddy.a(this.app, "sub.uin.all");
        i = 1;
        bool1 = true;
        continue;
        localbdei.jdField_a_of_type_Int = 1000;
        localbdei.jdField_b_of_type_Boolean = true;
        if (!QLog.isColorLevel()) {
          break label2128;
        }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      localObject1 = bgva.a(paramString2);
