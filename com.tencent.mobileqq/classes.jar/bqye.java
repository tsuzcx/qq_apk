  ...
  implements View.OnClickListener
{
  ...
  public bqye(@NonNull bqyq parambqyq)
  {
    super(parambqyq);
  ...
  private boolean a(String paramString)
  {
    try
    {
      ...
      this.jdField_a_of_type_Bqyq.jdField_d_of_type_Int = paramString.jdField_a_of_type_Int;
      this.jdField_a_of_type_Bqyq.jdField_e_of_type_Int = paramString.b;
      this.jdField_a_of_type_Bqyq.jdField_d_of_type_JavaLangString = paramString.jdField_a_of_type_JavaLangString;
      int i = this.jdField_a_of_type_Bqyq.jdField_d_of_type_Int;
      if (i > 0) {
        return true;
      }
    }
  ...
  private void j()
  {
    RelativeLayout localRelativeLayout1 = (RelativeLayout)a(2131365887);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)LayoutInflater.from(a()).inflate(2131562330, localRelativeLayout1, false));
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, agej.a(50.0F, a()));
    RelativeLayout localRelativeLayout2 = this.jdField_a_of_type_AndroidWidgetRelativeLayout;
    if (this.jdField_a_of_type_Bqyq.i)
    {
      i = 0;
    ...
    label110:
    for (int i = LiuHaiUtils.jdField_e_of_type_Int;; i = agej.a(60.0F, a()))
    {
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText.setTextEffect(this.jdField_a_of_type_Bqyq.jdField_e_of_type_JavaLangString);
    String str = bmyy.a(this.jdField_a_of_type_Bqyq.jdField_d_of_type_Int, null, null, null);
    if (TextUtils.isEmpty(str)) {
      this.jdField_a_of_type_Bqyq.jdField_d_of_type_Int = -1;
    }
    for (;;)
    {
  ...
  public void a()
  {
    ...
    if (!this.jdField_a_of_type_Bqyq.k) {
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
    }
    if ((this.jdField_a_of_type_Bqyq.h) || (this.jdField_a_of_type_Bqyq.j))
    {
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetCheckBox.setOnCheckedChangeListener(new bqyf(this));
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      if (paramIntent != null)
      {
        ...
        if (paramIntent.containsKey("permission_code")) {
          this.jdField_a_of_type_Bqyq.jdField_c_of_type_Int = paramIntent.getInt("permission_code");
        }
        if (paramIntent.containsKey("uin_list"))
        {
          if (this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaUtilArrayList == null) {
            this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
          }
          this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaUtilArrayList.clear();
          localObject = paramIntent.getStringArrayList("uin_list");
          if (localObject != null) {
            this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaUtilArrayList.addAll((Collection)localObject);
          }
        }
        if (a(this.jdField_a_of_type_Bqyq.jdField_c_of_type_Int))
        {
          this.jdField_a_of_type_Bqyq.b = paramIntent.getString("key_setting_raw_json");
          this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaLangString = paramIntent.getString("key_selected_tag");
        }
        if (zkg.a().b() == 22) {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Bqyq.jdField_a_of_type_AndroidViewView != null) {
        this.jdField_a_of_type_Bqyq.jdField_a_of_type_AndroidViewView.setVisibility(8);
      }
      this.jdField_a_of_type_Bqgk.a(Message.obtain(null, 22));
    ...
    if (localBundle.containsKey("contentIntentKey"))
    {
      ...
      this.jdField_a_of_type_Bqyq.jdField_c_of_type_JavaLangString = paramIntent;
      if (zkg.a().b() == 22) {
    ...
    this.jdField_a_of_type_Bqyq.jdField_d_of_type_Int = localBundle.getInt("extra_key_font_id", -1);
    this.jdField_a_of_type_Bqyq.jdField_e_of_type_Int = localBundle.getInt("extra_key_font_format_type");
    this.jdField_a_of_type_Bqyq.jdField_d_of_type_JavaLangString = localBundle.getString("extra_key_font_url");
    this.jdField_a_of_type_Bqyq.f = localBundle.getInt("extra_key_super_font_id", -1);
    this.jdField_a_of_type_Bqyq.jdField_e_of_type_JavaLangString = localBundle.getString("extra_key_super_font_info");
    k();
  }
  ...
  public void a_(int paramInt, Object paramObject)
  {
    ...
    {
      if ((this.jdField_a_of_type_Bqyq.i) && (!this.jdField_a_of_type_Boolean)) {}
  ...
  public void d()
  {
    this.jdField_a_of_type_JavaLangString = bnpv.a(this.jdField_a_of_type_Bqyq.jdField_c_of_type_Int);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        this.jdField_a_of_type_Bqyq.c(3004);
        localObject2 = new Bundle();
        ((Bundle)localObject2).putInt("permission_code", this.jdField_a_of_type_Bqyq.jdField_c_of_type_Int);
        if ((this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          ((Bundle)localObject2).putStringArrayList("uin_list", this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaUtilArrayList);
          localObject3 = new ArrayList(this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaUtilArrayList.size());
          localObject4 = this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaUtilArrayList.iterator();
        ...
        if ((a(this.jdField_a_of_type_Bqyq.jdField_c_of_type_Int)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Bqyq.b))) {
          ((Bundle)localObject2).putString("key_setting_raw_json", this.jdField_a_of_type_Bqyq.b);
        }
        if (zkg.a().b() == 22)
        {
        ...
        bmtd.a((BaseActivity)this.jdField_a_of_type_Bqhs, (String)localObject1, 1, (Bundle)localObject2, "");
      }
    } while (i != 2131366835);
    this.jdField_a_of_type_Bqyq.c(3001);
    Object localObject2 = bmtk.a();
    Object localObject3 = new Bundle();
    ((Bundle)localObject3).putInt("permission_code", this.jdField_a_of_type_Bqyq.jdField_c_of_type_Int);
    if ((this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      ((Bundle)localObject3).putStringArrayList("uin_list", this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaUtilArrayList);
      localObject1 = new ArrayList(this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaUtilArrayList.size());
      localObject4 = this.jdField_a_of_type_Bqyq.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject4).hasNext()) {
    ...
    if ((a(this.jdField_a_of_type_Bqyq.jdField_c_of_type_Int)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Bqyq.b))) {
      ((Bundle)localObject3).putString("key_setting_raw_json", this.jdField_a_of_type_Bqyq.b);
    }
    ((Bundle)localObject3).putBoolean("is_need_auto_close_from_pri", true);
    if (this.jdField_a_of_type_Bqyq.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_Bqyq.jdField_a_of_type_AndroidViewView.setVisibility(0);
    }
    Object localObject1 = "";
    if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText != null) {
    ...
    this.jdField_a_of_type_Bqgk.a(Message.obtain(null, 21));
    BaseActivity localBaseActivity = (BaseActivity)this.jdField_a_of_type_Bqhs;
    if (this.jdField_a_of_type_Bqyq.h) {}
    for (int i = 0;; i = 1)
    {
      bmtd.a(localBaseActivity, (bmtk)localObject2, 1009, "", (String)localObject1, "", "", 0, i, 1, 0, 0, 0, "", 10000, (Bundle)localObject3, this.jdField_a_of_type_Bqyq.h, this.jdField_a_of_type_Bqyq.g, this.jdField_a_of_type_Bqyq.jdField_d_of_type_Int, this.jdField_a_of_type_Bqyq.f, false, (Bundle)localObject4);
      break;
    }
  }
}
