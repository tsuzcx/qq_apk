  ...
  implements View.OnClickListener
{
  ...
  {
    Object localObject4 = (aagz)paramView.getTag();
    Object localObject1;
    if (((aagz)localObject4).a.jdField_a_of_type_Boolean)
    {
      ...
      ((Intent)localObject1).putExtra("filepath", this.a.e + ((aagz)localObject4).a.jdField_a_of_type_JavaLangString);
      ((Intent)localObject1).putExtra("filename", "" + ((aagz)localObject4).a.jdField_a_of_type_JavaLangString);
      ((Intent)localObject1).putExtra("nSessionId", this.a.jdField_b_of_type_Long);
      ((Intent)localObject1).putExtra("isHttps", aagx.a(this.a));
      if (!TextUtils.isEmpty(aagx.a(this.a))) {
        ((Intent)localObject1).putExtra("httpsDomain", aagx.a(this.a));
      }
      ((Intent)localObject1).putExtra("httpsPort", aagx.a(this.a));
    ...
    for (;;)
    {
      ...
      localForwardFileInfo.b(((aagz)localObject4).a.jdField_b_of_type_Long);
      localForwardFileInfo.d(((aagz)localObject4).a.jdField_a_of_type_JavaLangString);
      localForwardFileInfo.d(((aagz)localObject4).a.jdField_a_of_type_Long);
      ...
      if (this.a.jdField_a_of_type_Long == 0L)
      {
        ...
        Object localObject5 = ((QQAppInterface)localObject3).getFileManagerDataCenter().b(((aagz)localObject4).a.jdField_b_of_type_Long);
        ...
        {
          ((aagz)localObject4).a.jdField_b_of_type_Long = ((FileManagerEntity)localObject1).nSessionId;
          ((FileManagerEntity)localObject1).isZipInnerFile = true;
        }
        localForwardFileInfo.b(((aagz)localObject4).a.jdField_b_of_type_Long);
        if (localForwardFileInfo.d() == 0L)
        {
          audr.a(anvx.a(2131716399));
        }
        else
        {
          ...
          {
            auao localauao = (auao)((Iterator)localObject5).next();
            if ((auea.a(localauao.jdField_a_of_type_JavaLangString) == 0) && (localauao.jdField_a_of_type_Long != 0L))
            {
              FileManagerEntity localFileManagerEntity = ((QQAppInterface)localObject3).getFileManagerDataCenter().b(localauao.jdField_b_of_type_Long);
              ...
              if (localObject1 != null)
              {
                ...
                localauao.jdField_b_of_type_Long = ((FileManagerEntity)localObject1).nSessionId;
              }
              ((ArrayList)localObject4).add(Long.valueOf(localauao.jdField_b_of_type_Long));
            }
          }
      ...
      else
      {
        ...
        {
          localObject3 = (auao)((Iterator)localObject2).next();
          if (auea.a(((auao)localObject3).jdField_a_of_type_JavaLangString) == 0) {
            ((ArrayList)localObject1).add(Long.valueOf(((auao)localObject3).jdField_b_of_type_Long));
          }
        }
