...
public final class tip
  implements Runnable
{
  public tip(QQAppInterface paramQQAppInterface, String paramString) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.d() == 1)
    {
      ...
      if (!SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131434219), "qqsetting_notify_blncontrol_key", true)) {
        break label517;
      }
      i = 1;
      label231:
      localHashMap.put("Led_blinking", Integer.valueOf(i));
      if (!SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131435419), "qqsetting_receivemsg_whenexit_key", true)) {
        break label522;
      }
      i = 1;
      label276:
      localHashMap.put("Logout_msg", Integer.valueOf(i));
      if (!SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131434223), "qqsetting_notify_myfeedpush_key", true)) {
        break label527;
      }
      i = 1;
      label321:
