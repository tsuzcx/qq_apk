  ...
  extends ValueAnimator
{
  ...
  private zri(View paramView, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    setObjectValues(new Object[] { new zrl(paramFloat1, paramFloat2, paramFloat3), new zrl(paramFloat4, paramFloat5, paramFloat6) });
    setEvaluator(new zrm(null));
    this.jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new zrj(this, a(paramView));
  ...
  public static zri a(View paramView, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2)
  {
    return new zri(paramView, paramInt1, paramInt2, paramFloat1, paramInt1, paramInt2, paramFloat2);
  }
