  ...
  extends akie
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new akil(this);
  ...
  public akih(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new akii(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131368209)).setOnClickListener(new akij(this));
    Button localButton = (Button)findViewById(2131363745);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new akik(this));
  }
  ...
  private void h()
  {
    ...
    this.d = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131371882));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131371433));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131717755));
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_Akig = new akig(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Blha, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Akig);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new akim(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new akin(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new akio(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Akig.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Akig.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
    a(0, null);
  }
  
  public void a(List<Object> paramList)
  {
    this.jdField_a_of_type_Akig.a(paramList);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.jdField_b_of_type_AndroidWidgetTextView.setText(anzj.a(2131700188));
        ...
        {
          this.jdField_a_of_type_Akig.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_c_of_type_Boolean, 0);
          this.jdField_a_of_type_Akig.notifyDataSetChanged();
        }
        if (this.jdField_a_of_type_Akig.getCount() == 0) {
          a(4, null);
        }
        for (;;)
        {
      ...
      this.jdField_a_of_type_Akig.a(this.jdField_a_of_type_JavaUtilList, this.jdField_c_of_type_Boolean);
      if ((this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Akig.getCount() < 20))
      {
        this.jdField_b_of_type_AndroidWidgetTextView.setText(anzj.a(2131700191));
        this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131373040).setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
      }
    ...
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Akig.a((List)localObject, this.jdField_c_of_type_Boolean);
    this.jdField_a_of_type_Akig.notifyDataSetChanged();
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Akig);
    this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
    this.jdField_a_of_type_JavaUtilList.clear();
