...
public class akoc
{
  private static akoc jdField_a_of_type_Akoc;
  ...
  private akoc()
  {
    ...
    for (;;)
    {
      ...
      if ((Math.abs(l2 - l1) > 86400000L) && (this.b > 2))
      {
        ...
        axrl.a(BaseApplicationImpl.getApplication()).a(null, "ProcReporter", true, 0L, this.b, (HashMap)localObject2, null);
        this.b = 0;
  ...
  {
    if (jdField_a_of_type_Akoc == null) {}
    try
    {
      if (jdField_a_of_type_Akoc == null) {
        jdField_a_of_type_Akoc = new akoc();
      }
      return jdField_a_of_type_Akoc;
    }
    finally {}
  }
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      axrl.a(BaseApplicationImpl.getApplication()).a(null, "ProcKillFailed", true, 0L, 0L, localHashMap, null);
