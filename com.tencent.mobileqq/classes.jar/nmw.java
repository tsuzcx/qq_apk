  ...
  implements Manager
{
  ...
  public nmw(AppInterface paramAppInterface)
  {
  ...
  private boolean a(troopviewInfo.RspBody paramRspBody)
  {
    ...
    return FileUtils.pushData2File(new File(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApplication().getFilesDir(), "AddContactTroopManage" + this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin()).getAbsolutePath(), paramRspBody.toByteArray(), false);
  }
  ...
  private troopviewInfo.RspBody b()
  {
    ...
    //   3: dup
    //   4: aload_0
    //   5: getfield 21	nmw:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    ...
    //   26: aload_0
    //   27: getfield 21	nmw:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    ...
    //   42: invokestatic 98	com/tencent/mobileqq/utils/FileUtils:fileToBytes	(Ljava/io/File;)[B
    //   45: astore_2
    //   46: new 40	tencent/im/troop_view/troopviewInfo$RspBody
    //   49: dup
    //   50: invokespecial 99	tencent/im/troop_view/troopviewInfo$RspBody:<init>	()V
    //   53: astore_1
    //   54: aload_2
    //   55: ifnull +9 -> 64
    //   58: aload_1
    //   59: aload_2
    //   60: invokevirtual 103	tencent/im/troop_view/troopviewInfo$RspBody:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   63: pop
    //   64: aload_1
    //   65: areturn
    //   66: astore_2
    ...
    //   68: astore_1
    //   69: aload_2
    //   70: invokevirtual 106	com/tencent/mobileqq/pb/InvalidProtocolBufferMicroException:printStackTrace	()V
    //   73: aload_1
    //   74: areturn
    //   75: astore_2
    //   76: aconst_null
    //   77: astore_1
    //   78: aload_2
    //   79: invokevirtual 107	java/lang/NullPointerException:printStackTrace	()V
    //   82: aload_1
    //   83: areturn
    //   84: astore_2
    //   85: goto -7 -> 78
