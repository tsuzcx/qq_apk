  ...
  extends awum
{
  private StateListDrawable a(Resources paramResources, int paramInt, float[] paramArrayOfFloat)
  {
    ...
    if (k < arrayOfGradientDrawable.length)
    {
      ...
      for (;;)
      {
        k += 1;
        break;
        arrayOfGradientDrawable[k].setCornerRadius(aciy.a(4.0F, paramResources));
      }
    }
  ...
  public void a(View paramView)
  {
    ...
    int i = aciy.a(4.0F, paramView.getResources());
    ...
    for (;;)
    {
      localObject1 = a(paramView.getResources(), this.j, (float[])localObject1);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof RelativeLayout)))
    {
      ...
      if (paramContext != null)
      {
        ...
        paramBundle.rightMargin = aciy.a(7.5F, localResources);
        if (paramView.findViewById(1) == null) {
          break label873;
        }
        paramBundle.addRule(1, 1);
        paramContext.setPadding(aciy.a(7.5F, localResources), 0, 0, 0);
        label130:
    ...
    {
      a(paramView);
      paramView.setPadding(aciy.a(11.0F, localResources), 0, aciy.a(11.0F, localResources), 0);
      return paramView;
      label175:
      paramView = (awul)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      ...
      ((awzf)paramView).c("28");
      ((awzf)paramView).a(true);
      if (this.j != 0) {
        ((awzf)paramView).a(a(), this.j);
      }
      for (;;)
      {
        ...
        paramView.setLayoutParams((ViewGroup.LayoutParams)localObject);
        break;
        ((awzf)paramView).b("black");
      }
      localRelativeLayout = new RelativeLayout(paramContext);
      localRelativeLayout.setLayoutParams(new RelativeLayout.LayoutParams(-1, aciy.a(40.0F, localResources)));
      i = 0;
      paramView = localRelativeLayout;
      if (i >= j) {
        break label67;
      ...
      if ("picture".equals(localObject))
      {
        ...
        paramView.setId(1);
        localObject = new RelativeLayout.LayoutParams(aciy.a(40.0F, localResources), aciy.a(30.0F, localResources));
        ((RelativeLayout.LayoutParams)localObject).addRule(9, -1);
        ((RelativeLayout.LayoutParams)localObject).addRule(15, -1);
      ...
      for (;;)
      {
        ...
        int m = aciy.a(89.5F, localResources);
