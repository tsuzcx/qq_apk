  ...
  extends anud
{
  ...
  public asif(QQAppInterface paramQQAppInterface)
  {
  ...
  public static MqqComicHeadPb.ComicReqHead a(AppInterface paramAppInterface, String paramString1, long paramLong, String paramString2)
  {
    ...
    if (TextUtils.isEmpty("8.4.5"))
    {
      ...
      localComicReqHead.net.set(nnr.a());
    ...
    for (paramLong = Long.valueOf(paramAppInterface.getCurrentAccountUin()).longValue();; paramLong = 0L)
    {
      ...
      paramAppInterface = bmbt.a(paramAppInterface.getApp());
  ...
  public static byte[] a(MqqComicHeadPb.ComicReqHead paramComicReqHead, MessageMicro paramMessageMicro)
  {
    ...
    try
    {
      ...
      bhvd.a(arrayOfByte, 0, i);
      bhvd.a(arrayOfByte, 4, paramComicReqHead, paramComicReqHead.length);
      bhvd.a(arrayOfByte, i, j);
      bhvd.a(arrayOfByte, i + 4, paramMessageMicro, paramMessageMicro.length);
      return arrayOfByte;
    }
  ...
  public void a(ToServiceMsg paramToServiceMsg, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    try
    {
      ...
      bhvd.a(arrayOfByte, 0, paramToServiceMsg, j + 8, arrayOfByte.length);
      ...
      if ((localSetMyComicFavorEmotIconsReqBody != null) && (localSetMyComicFavorEmotIconsReqBody.reqs != null))
      {
        ...
        ((asig)this.app.getManager(141)).b(paramToServiceMsg);
  ...
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (paramArrayOfByte != null) {
        ...
        {
          localObject = (asig)this.app.getManager(141);
          if (localObject != null)
          {
            paramInt = 0;
            while (paramInt < paramArrayOfByte.rsps.size())
            {
              ...
              ((asig)localObject).a(localVipComicFavorEmoStructMsgInfo);
              paramInt += 1;
            }
          }
        }
  ...
  public void c(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if ((paramArrayOfByte != null) && (paramArrayOfByte.maintab.has())) {
      bmbh.b(paramArrayOfByte.maintab.get());
    }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (!paramFromServiceMsg.isSuccess())
      {
        ...
        {
          bjqh.a().a(str, l2, l3, l1, paramFromServiceMsg.getBusinessFailCode(), Long.valueOf(this.app.getCurrentAccountUin()).longValue(), jdField_a_of_type_JavaLangString, paramToServiceMsg, false);
          return;
      ...
      bhvd.a(paramObject, 0, (byte[])localObject, 4, paramObject.length);
      ...
      try
      {
        ...
        if (j == 0)
        {
          ...
          bhvd.a(paramFromServiceMsg, 0, (byte[])localObject, i + 4, paramFromServiceMsg.length);
          paramObject = "";
          if (!"GetMyComicFavorEmotIcons".equals(str)) {
            break label483;
          }
          ...
          bjqh.a().a("GetMyComicFavorEmotIcons", l2, l3, l1, j, Long.valueOf(this.app.getCurrentAccountUin()).longValue(), jdField_a_of_type_JavaLangString, paramToServiceMsg, false);
          return;
        }
      }
