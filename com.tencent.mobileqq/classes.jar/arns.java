  ...
  implements atqq
{
  ...
  public arns(MessageForMixedMsg paramMessageForMixedMsg, Map<String, Integer> paramMap, String paramString, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
  ...
  public void b(atqr paramatqr)
  {
    ...
    if (paramatqr.jdField_b_of_type_Int == 0)
    {
      ...
      if ((localObject instanceof MessageForPic))
      {
        ...
        ((MessageForPic)localObject).md5 = paramatqr.d;
        ((MessageForPic)localObject).uuid = paramatqr.c;
        ((MessageForPic)localObject).size = paramatqr.jdField_a_of_type_Long;
        ((MessageForPic)localObject).groupFileID = paramatqr.jdField_b_of_type_Long;
      ...
      if (this.jdField_a_of_type_JavaUtilMap.size() == 0)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg.istroop == 1)
        {
          ...
          while (((Iterator)localObject).hasNext())
          {
            ...
            mnf.a().a(localMessageRecord);
          }
        }
        arno.a(this.jdField_a_of_type_Arno, this.jdField_a_of_type_Arno.a, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg.frienduin, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg.istroop, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, true);
      }
    }
    for (;;)
    {
      ...
      {
        localObject = new ErrorMessage(paramatqr.jdField_b_of_type_Int, paramatqr.jdField_a_of_type_JavaLangString);
        QLog.d("zivonchen", 2, "reqUploadMultiPics UiCallBack success result = " + paramatqr + ", error = " + localObject);
      }
      return;
      arno.a(this.jdField_a_of_type_Arno, this.jdField_a_of_type_ComTencentMobileqqDataMessageForMixedMsg, false, "send Msg fail: " + paramatqr);
    }
  }
}
