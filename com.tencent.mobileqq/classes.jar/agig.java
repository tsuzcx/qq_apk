...
public class agig
  implements bfos
{
  public agig(AvatarPendantActivity paramAvatarPendantActivity) {}
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (!this.b.jdField_a_of_type_Ailf.a) {
        break;
      }
    ...
    URLDrawable.resume();
    this.b.jdField_a_of_type_Ailf.notifyDataSetChanged();
    return;
    label127:
    URLDrawable.pause();
    this.b.jdField_a_of_type_Ailf.a = true;
  }
}
