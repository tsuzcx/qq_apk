  ...
  extends aggm
{
  ...
  private agig(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  public static aggh b(NewPhotoListActivity paramNewPhotoListActivity)
  {
    ...
    {
      if ((jdField_a_of_type_Aggh == null) || (jdField_a_of_type_Aggh.jdField_a_of_type_MqqUtilWeakReference.get() != paramNewPhotoListActivity)) {
        jdField_a_of_type_Aggh = new agig(paramNewPhotoListActivity);
      }
  ...
  protected List<LocalMediaInfo> a()
  {
    ...
    Object localObject1 = bgwg.a(((NewPhotoListActivity)localObject2).getApplicationContext(), this.jdField_a_of_type_Aggf.jdField_a_of_type_JavaLangString, "pref_select_album");
    List localList;
    if (!TextUtils.isEmpty((CharSequence)localObject1))
    {
      localList = bgwg.a((String)localObject1);
    ...
    for (;;)
    {
      localList = baaf.a((Context)localObject2, 1000, (List)localObject1, this.jdField_a_of_type_Aggg.a);
      badi.a("PEAK", "getAlbumMedias");
      if (localList == null)
      {
      ...
      {
        i = 0;
        if (i < this.jdField_a_of_type_Aggf.jdField_a_of_type_JavaUtilArrayList.size())
        {
          localObject1 = (String)this.jdField_a_of_type_Aggf.jdField_a_of_type_JavaUtilArrayList.get(i);
          if (TextUtils.isEmpty((CharSequence)localObject1))
          {
          ...
          for (;;)
          {
            ...
            if (!new File((String)localObject1).exists()) {
              if ((((String)localObject1).startsWith("http")) && (this.jdField_a_of_type_Aggf.jdField_c_of_type_JavaUtilHashMap != null))
              {
                j = i;
                if (this.jdField_a_of_type_Aggf.jdField_c_of_type_JavaUtilHashMap.containsKey(localObject1)) {}
              }
              else
              {
                ...
                if (!this.jdField_a_of_type_Aggf.a())
                {
                  ...
                  if (this.jdField_a_of_type_Aggg.w)
                  {
                    ...
                    {
                      j = i;
                      if (!this.jdField_a_of_type_Aggf.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject1)) {}
                    }
                  }
                }
                else
  ...
  protected void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((localNewPhotoListActivity != null) && (!localNewPhotoListActivity.isFinishing()) && (paramInt1 == 100010))
    {
      ...
      baaf.a(localNewPhotoListActivity, false, false);
    }
    for (;;)
    {
      ...
      return;
      label103:
      localArrayList = this.jdField_a_of_type_Aggf.jdField_a_of_type_JavaUtilArrayList;
      break;
      label115:
      d();
  ...
  protected void a(Intent paramIntent)
  {
    ...
    localObject = bgwg.a(((NewPhotoListActivity)localObject).getApplicationContext(), this.jdField_a_of_type_Aggf.jdField_a_of_type_JavaLangString, "pref_select_album");
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      localObject = bgwg.a((String)localObject);
      if ((localObject != null) && (!((List)localObject).isEmpty())) {
        this.jdField_a_of_type_Aggf.jdField_c_of_type_JavaLangString = ((String)((List)localObject).get(0));
      }
    }
    this.jdField_a_of_type_Aggg.m = false;
  ...
  protected void c()
  {
    ...
    {
      return;
      View localView = localNewPhotoListActivity.findViewById(2131302804);
      if (localView != null) {
        localView.setContentDescription(localNewPhotoListActivity.getString(2131655013));
      }
  ...
  protected void e()
  {
    ...
    {
      awrn.a(localNewPhotoListActivity).a(null, "sendAlbumRecent", true, 0L, 0L, null, "");
      if (this.jdField_a_of_type_Aggf.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ageh.a(localNewPhotoListActivity.getIntent(), this.jdField_a_of_type_Aggf.jdField_a_of_type_JavaUtilArrayList.size());
        ageh.a(localNewPhotoListActivity.getIntent(), this.jdField_a_of_type_Aggf.jdField_a_of_type_JavaUtilArrayList.size(), this.jdField_a_of_type_Aggg.e);
      }
    ...
    label265:
    for (ArrayList localArrayList = new ArrayList(0);; localArrayList = this.jdField_a_of_type_Aggf.jdField_a_of_type_JavaUtilArrayList)
    {
      localIntent.putStringArrayListExtra("PhotoConst.SELECTED_PATHS", localArrayList);
      localNewPhotoListActivity.setResult(-1, localIntent);
      localNewPhotoListActivity.finish();
      ...
      {
        awrn.a(localNewPhotoListActivity).a(null, "sendAlbumRecent", false, 0L, 0L, null, "");
        break;
      }
      awrn.a(localNewPhotoListActivity).a(null, "sendAlbumOther", true, 0L, 0L, null, "");
      break;
    }
  }
}
