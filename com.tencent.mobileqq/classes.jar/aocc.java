  ...
  extends aoce
{
  ...
  public aocc(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong1, long paramLong2, aocf paramaocf)
  {
    super(paramString, paramInt1, paramInt2, paramInt3, paramInt4, paramLong1, paramLong2, paramaocf);
    ...
    for (;;)
    {
      ...
      catch (IOException localIOException)
      {
        try
        {
          ...
          this.jdField_a_of_type_Aocd = new aocd(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
          this.jdField_a_of_type_AndroidMediaMediaCodec.configure(localMediaFormat, this.jdField_a_of_type_Aocd.a(), null, 0);
          return true;
        }
  ...
  public void run()
  {
    ...
    //   15: aload_0
    //   16: invokevirtual 306	aocc:b	()V
    //   19: aload_0
    //   20: invokespecial 308	aocc:b	()Z
    //   23: ifne +19 -> 42
    ...
    //   64: return
    //   65: aload_0
    //   66: invokespecial 316	aocc:a	()I
    //   69: istore_2
    //   70: aload_0
    //   71: iconst_m1
    //   72: putfield 88	aocc:jdField_e_of_type_Int	I
    //   75: aload_0
    //   76: getfield 28	aocc:jdField_a_of_type_AndroidMediaMediaExtractor	Landroid/media/MediaExtractor;
    //   79: lconst_0
    //   80: iconst_0
    ...
    //   119: ifne +121 -> 240
    //   122: aload_0
    //   123: invokevirtual 320	aocc:a	()Z
    //   126: ifne +114 -> 240
    //   129: aload_0
    //   130: getfield 32	aocc:jdField_e_of_type_Long	J
    //   133: lconst_0
    //   134: lcmp
    //   135: ifge +15 -> 150
    //   138: aload_0
    //   139: aload_0
    //   140: invokevirtual 90	aocc:a	()J
    //   143: putfield 32	aocc:jdField_e_of_type_Long	J
    //   146: iload_2
    //   147: ifne +160 -> 307
    //   150: aload_0
    //   151: getfield 265	aocc:jdField_b_of_type_Boolean	Z
    //   154: ifne +8 -> 162
    //   157: aload_0
    //   158: invokespecial 322	aocc:d	()Z
    //   161: pop
    //   162: aload_0
    //   163: getfield 284	aocc:jdField_c_of_type_Boolean	Z
    //   166: ifne +67 -> 233
    //   169: aload_0
    //   170: invokespecial 324	aocc:e	()Z
    //   173: istore_3
    //   174: iload_3
    //   175: ifeq +58 -> 233
    //   178: iconst_2
    ...
    //   181: ifle +10 -> 191
    //   184: aload_0
    //   185: getfield 194	aocc:jdField_a_of_type_Aocd	Laocd;
    //   188: invokevirtual 326	aocd:c	()V
    //   191: aload_0
    //   192: getfield 194	aocc:jdField_a_of_type_Aocd	Laocd;
    //   195: iconst_0
    //   196: invokevirtual 329	aocd:a	(Z)V
    //   199: aload_0
    //   200: aload_0
    //   201: getfield 194	aocc:jdField_a_of_type_Aocd	Laocd;
    //   204: invokevirtual 332	aocd:a	()Landroid/graphics/Bitmap;
    //   207: invokevirtual 335	aocc:a	(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   210: astore 4
    //   212: aload_0
    //   213: aload_0
    //   214: getfield 88	aocc:jdField_e_of_type_Int	I
    //   217: aload_0
    //   218: getfield 241	aocc:jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo	Landroid/media/MediaCodec$BufferInfo;
    //   221: getfield 287	android/media/MediaCodec$BufferInfo:presentationTimeUs	J
    //   224: ldc2_w 336
    //   227: ldiv
    //   228: aload 4
    //   230: invokevirtual 340	aocc:a	(IJLandroid/graphics/Bitmap;)V
    //   233: aload_0
    //   234: getfield 284	aocc:jdField_c_of_type_Boolean	Z
    //   237: ifeq -121 -> 116
    //   240: aload_0
    //   241: getfield 183	aocc:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   244: invokevirtual 343	android/media/MediaCodec:stop	()V
    //   247: aload_0
    //   248: getfield 183	aocc:jdField_a_of_type_AndroidMediaMediaCodec	Landroid/media/MediaCodec;
    //   251: invokevirtual 346	android/media/MediaCodec:release	()V
    //   254: aload_0
    //   255: getfield 28	aocc:jdField_a_of_type_AndroidMediaMediaExtractor	Landroid/media/MediaExtractor;
    //   258: invokevirtual 347	android/media/MediaExtractor:release	()V
    //   261: aload_0
    //   262: getfield 194	aocc:jdField_a_of_type_Aocd	Laocd;
    //   265: invokevirtual 349	aocd:a	()V
    //   268: aload_0
    //   269: aconst_null
    //   270: putfield 241	aocc:jdField_a_of_type_AndroidMediaMediaCodec$BufferInfo	Landroid/media/MediaCodec$BufferInfo;
    //   273: aload_0
    //   274: aconst_null
    //   275: putfield 231	aocc:jdField_a_of_type_ArrayOfJavaNioByteBuffer	[Ljava/nio/ByteBuffer;
    //   278: aload_0
    //   279: aconst_null
    //   280: putfield 236	aocc:jdField_b_of_type_ArrayOfJavaNioByteBuffer	[Ljava/nio/ByteBuffer;
    //   283: aload_0
    //   284: aload_0
    //   285: getfield 284	aocc:jdField_c_of_type_Boolean	Z
    //   288: invokevirtual 350	aocc:a	(Z)V
    ...
    //   312: aload_0
    //   313: getfield 88	aocc:jdField_e_of_type_Int	I
    //   316: iflt -166 -> 150
    //   319: aload_0
    //   320: getfield 88	aocc:jdField_e_of_type_Int	I
    //   323: aload_0
    //   324: getfield 37	aocc:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   327: invokevirtual 73	java/util/ArrayList:size	()I
    //   330: if_icmpge -180 -> 150
    //   333: aload_0
    //   334: getfield 37	aocc:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   337: aload_0
    //   338: getfield 88	aocc:jdField_e_of_type_Int	I
    ...
    //   355: aload_0
    //   356: aload_0
    //   357: getfield 37	aocc:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   360: aload_0
    //   361: getfield 88	aocc:jdField_e_of_type_Int	I
    ...
    //   373: putfield 32	aocc:jdField_e_of_type_Long	J
    //   376: aload_0
    //   377: getfield 28	aocc:jdField_a_of_type_AndroidMediaMediaExtractor	Landroid/media/MediaExtractor;
    //   380: aload_0
    //   381: getfield 32	aocc:jdField_e_of_type_Long	J
    //   384: iconst_0
    //   385: invokevirtual 66	android/media/MediaExtractor:seekTo	(JI)V
    //   388: aload_0
    //   389: aload_0
    //   390: getfield 28	aocc:jdField_a_of_type_AndroidMediaMediaExtractor	Landroid/media/MediaExtractor;
    //   393: invokevirtual 70	android/media/MediaExtractor:getSampleTime	()J
    //   396: putfield 257	aocc:d	J
    ...
    //   421: aload_0
    //   422: getfield 32	aocc:jdField_e_of_type_Long	J
    ...
    //   447: aload_0
    //   448: iconst_0
    //   449: putfield 265	aocc:jdField_b_of_type_Boolean	Z
    //   452: aload_0
    //   453: iconst_0
    //   454: putfield 284	aocc:jdField_c_of_type_Boolean	Z
    //   457: goto -307 -> 150
    //   460: aload_0
    //   461: getfield 28	aocc:jdField_a_of_type_AndroidMediaMediaExtractor	Landroid/media/MediaExtractor;
    //   464: aload_0
    //   465: getfield 32	aocc:jdField_e_of_type_Long	J
    //   468: iconst_0
    //   469: invokevirtual 66	android/media/MediaExtractor:seekTo	(JI)V
    //   472: aload_0
    //   473: aload_0
    //   474: getfield 28	aocc:jdField_a_of_type_AndroidMediaMediaExtractor	Landroid/media/MediaExtractor;
    //   477: invokevirtual 70	android/media/MediaExtractor:getSampleTime	()J
    //   480: putfield 257	aocc:d	J
    ...
    //   505: aload_0
    //   506: getfield 32	aocc:jdField_e_of_type_Long	J
    ...
    //   531: aload_0
    //   532: iconst_0
    //   533: putfield 265	aocc:jdField_b_of_type_Boolean	Z
    //   536: aload_0
    //   537: iconst_0
    //   538: putfield 284	aocc:jdField_c_of_type_Boolean	Z
    //   541: goto -391 -> 150
    //   544: astore 4
    //   546: aload 4
    ...
    //   612: aload_0
    //   613: iconst_4
    //   614: invokevirtual 206	aocc:a	(I)V
    //   617: ldc 47
    //   619: iconst_2
    //   620: ldc_w 364
    //   623: aload 4
