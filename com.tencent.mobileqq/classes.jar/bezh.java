...
public class bezh
{
  ...
  public bezh a()
  {
    bezh localbezh = new bezh();
    localbezh.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.putAll(this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap);
    return localbezh;
  }
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    bezd.a = a("mod", paramJSONObject.optString("from", bezd.a));
    bezd.d = a("land_page", paramJSONObject.optString("land_page_id", bezd.d));
    bezd.b = a("obj_ownerid", paramJSONObject.optString("obj_ownerid", bezd.b));
    bezd.e = a("obj_pos", paramJSONObject.optString("pos", ""));
    bezd.f = a("detailpage_from", bezd.a(paramJSONObject.optString("detailpage_from"), paramJSONObject.optString("prepage")));
    bezd.g = a("algo_id", paramJSONObject.optString("algo_id", "0"));
  }
