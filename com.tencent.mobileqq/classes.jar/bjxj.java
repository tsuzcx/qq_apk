...
public class bjxj
  extends bjxl
  implements bjtj, IEventReceiver
{
  ...
  public bjxj(@NonNull bjxn parambjxn)
  {
    super(parambjxn);
  }
  ...
  private void b(long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_AndroidOsHandler != null)
    {
      ...
      if (localObject != null)
      {
        ...
        ((bjxx)localObject).b(paramLong, paramBoolean1);
      }
    }
    for (;;)
    {
      ...
      if (localObject != null) {
        ((bjtk)localObject).a(paramLong);
      }
      return;
      label340:
      ((bjxx)localObject).a(paramLong, paramBoolean1);
    }
  }
  ...
  public void a()
  {
    ...
    {
      long l = ((EditLocalVideoSource)this.jdField_a_of_type_Bjxn.a.a).a * -1;
  ...
  public void b()
  {
    Object localObject = (bjxx)a(bjxx.class);
    if (localObject != null) {
      ((bjxx)localObject).k();
    }
    localObject = (bjtk)a(bjtk.class);
    if (localObject != null) {
      ((bjtk)localObject).ab_();
    }
  }
  ...
  public boolean h_()
  {
    ...
    bjxx localbjxx = (bjxx)a(bjxx.class);
    if (localbjxx != null) {
      this.jdField_b_of_type_Boolean = localbjxx.a(this.c);
    }
