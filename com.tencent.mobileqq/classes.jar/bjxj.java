...
public class bjxj
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alpo.a(2131713403);
  ...
  public static aovj a(QQAppInterface paramQQAppInterface)
  {
    ...
    else
    {
      ...
      aiab.a().a(paramQQAppInterface.getApplication().getApplicationContext(), paramQQAppInterface);
      localObject = aiab.a().a();
    }
    if (localObject != null)
    {
      ...
      {
        localObject = (aovj)paramQQAppInterface.next();
        if ((localObject != null) && (((aovj)localObject).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo != null) && (((aovj)localObject).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.uiResId == 1130L)) {
          return localObject;
        }
      }
    }
  ...
  public static bjxl a(Node paramNode)
  {
    bjxl localbjxl = new bjxl();
    if (TextUtils.equals("setting", paramNode.getNodeName()))
    {
      ...
      if (paramNode != null)
      {
        ...
        for (;;)
        {
          try
          {
            localbjxl.jdField_a_of_type_Int = Integer.parseInt(str2);
          ...
          if (TextUtils.equals(localNumberFormatException1, "title")) {
            localbjxl.jdField_a_of_type_JavaLangString = str2;
          } else if (TextUtils.equals(localNumberFormatException1, "hidden")) {
            try
            {
              localbjxl.jdField_b_of_type_Int = Integer.parseInt(str2);
            }
  ...
  public static bjxm a(Node paramNode)
  {
    bjxm localbjxm = new bjxm();
    if (TextUtils.equals("setting", paramNode.getNodeName()))
    {
      paramNode = paramNode.getFirstChild();
      if (paramNode != null)
      {
        ...
        if (paramNode.getNodeType() == 1)
        {
          ...
          localbjxm.jdField_a_of_type_JavaLangString = str2;
        }
        for (;;)
        {
          paramNode = paramNode.getNextSibling();
          ...
          {
            localbjxm.jdField_b_of_type_JavaLangString = str2;
          }
          else if (TextUtils.equals(str1, "id"))
          {
            try
            {
              localbjxm.jdField_a_of_type_Int = Integer.parseInt(str2);
            }
  ...
  public static bjxn a(AppRuntime paramAppRuntime)
  {
    paramAppRuntime = a(paramAppRuntime, true, true);
    if (paramAppRuntime == null) {
      ...
      try
      {
        ...
        if (((Node)localObject).getNodeType() == 1)
        {
          ...
          if (TextUtils.equals("video_width", str1)) {
            localbjxn.jdField_b_of_type_Int = Integer.parseInt(str2);
          }
        }
        else
        {
        ...
        localbjxn.jdField_b_of_type_Float = Float.parseFloat(str2);
        continue;
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      if (TextUtils.equals((CharSequence)localObject, "double_video")) {
        for (localObject = localNode.getFirstChild(); localObject != null; localObject = ((Node)localObject).getNextSibling()) {
          if (((Node)localObject).getNodeType() == 1)
          {
            ...
            str2 = ((Node)localObject).getFirstChild().getNodeValue();
            if (TextUtils.equals("aspect_ratio", str1)) {
              localbjxn.jdField_a_of_type_Float = Float.parseFloat(str2);
            }
          }
        }
      }
      if (TextUtils.equals((CharSequence)localObject, "is_play_button_show")) {
        localbjxn.jdField_a_of_type_Boolean = str1.equals("1");
      }
      for (;;)
      {
        label445:
        ...
        if (TextUtils.equals((CharSequence)localObject, "title_label_number_of_lines")) {
          localbjxn.jdField_a_of_type_Int = Integer.parseInt(str1);
        } else if (TextUtils.equals((CharSequence)localObject, "title_hidden")) {
          localbjxn.jdField_b_of_type_Boolean = str1.equals("0");
        } else if (TextUtils.equals((CharSequence)localObject, "play_and_comment_hidden")) {
          localbjxn.jdField_c_of_type_Boolean = str1.equals("0");
        }
      }
      label527:
  ...
  public static String a(long paramLong1, long paramLong2, String paramString1, String paramString2)
  {
    ...
    if ((paramLong1 >= 10000L) && (paramLong1 < paramLong2))
    {
      ...
      if (Math.round(d1) - d1 == 0.0D) {
        return String.valueOf(d1) + alpo.a(2131713321);
      }
      return String.valueOf(d1) + alpo.a(2131713121);
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    //   2: monitorenter
    //   3: iload_1
    //   4: putstatic 1366	bjxj:jdField_b_of_type_Boolean	Z
    //   7: aload_0
    //   8: iconst_1
    //   9: invokestatic 602	bjxj:a	(Lcom/tencent/mobileqq/app/QQAppInterface;I)Landroid/content/SharedPreferences;
    //   12: astore_2
    //   13: aload_2
    //   14: ifnonnull +7 -> 21
    //   17: ldc 2
    ...
    //   39: aload_2
    //   40: iconst_1
    //   41: invokestatic 245	bjxj:a	(Landroid/content/SharedPreferences$Editor;Z)V
    //   44: aload_0
    //   45: iload_1
  ...
  public static boolean a(AppRuntime paramAppRuntime, String paramString)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        azmz.a(paramAppRuntime.getApplication()).a(null, "actionReadInJoyArkConfig", true, 0L, 0L, localHashMap, null);
        return true;
  ...
  public static String b(int paramInt)
  {
    ...
    if (paramInt < 99989500)
    {
      if (paramInt % 10000 < 500) {
        return paramInt / 10000 + alpo.a(2131713249);
      }
      int i1 = paramInt;
      if (paramInt % 500 == 0) {
        i1 = paramInt + 1;
      ...
      if (i1 % 10000 > 9500) {
        return (i1 + 500) / 10000 + alpo.a(2131713405);
      }
  ...
  public static List<bjxl> b(AppRuntime paramAppRuntime)
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject = a(paramAppRuntime, true, true);
    if (localObject == null) {
  ...
  public static List<bjxm> c(AppRuntime paramAppRuntime)
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject = a(paramAppRuntime, true, true);
    if (localObject == null) {
  ...
  public static void f()
  {
    ...
    {
      Aladdin.initialize(Aladdin.InitParams.newBuilder().withUserId(ors.a()).withAppVersion("8.3.3").withContext(BaseApplicationImpl.getContext()).withExecutor(osw.a).withRequestHandler(new ost()).withLogger(new osr()).withAppFlavorId(AppSetting.a() + "").build());
