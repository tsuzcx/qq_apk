  ...
  extends DynamicTextItem
{
  ...
  public blxv(int paramInt, @NonNull List<String> paramList, Typeface paramTypeface, List<Bitmap> paramList1)
  {
    ...
    this.jdField_a_of_type_AndroidTextTextPaint.setTextSize(aepi.a(9.0F, this.jdField_a_of_type_AndroidContentResResources));
    this.g = this.jdField_a_of_type_AndroidTextTextPaint.getFontMetricsInt(null);
    if (this.jdField_b_of_type_Int <= 0)
    {
      this.jdField_b_of_type_Int += this.g;
      this.jdField_b_of_type_Int += aepi.a(3.0F, this.jdField_a_of_type_AndroidContentResResources);
    ...
    {
      this.c += this.g;
      this.c += aepi.a(3.0F, this.jdField_a_of_type_AndroidContentResResources);
      paramInt = this.c;
      this.c = (((Bitmap)this.jdField_a_of_type_JavaUtilList.get(1)).getHeight() + paramInt);
    }
    if (this.h <= 0) {
      this.h = aepi.a(2.0F, this.jdField_a_of_type_AndroidContentResResources);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      ...
      paramInt = blyt.a(this.jdField_a_of_type_JavaLangString);
      if (paramInt >= 5) {
        break label184;
      }
      this.f = 1;
      ...
      if (paramInt > 1) {
        this.d += (paramInt - 1) * aepi.a(9.0F, this.jdField_a_of_type_AndroidContentResResources);
      }
    ...
    label184:
    this.d = (((Bitmap)this.jdField_a_of_type_JavaUtilList.get(1)).getWidth() * 5 + aepi.a(9.0F, this.jdField_a_of_type_AndroidContentResResources) * 4);
    this.f = (paramInt / 5);
    if (paramInt % 5 > 0) {
      this.f += 1;
    }
    this.e = ((this.f - 1) * this.c + (this.f - 1) * aepi.a(15.0F, this.jdField_a_of_type_AndroidContentResResources));
    int i = this.e;
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    float f1;
    int i8;
    if (blyt.a(this.jdField_a_of_type_JavaLangString) < 5)
    {
      j = 1;
      if (j == 0) {
        break label284;
      ...
      i5 = aepi.a(9.0F, this.jdField_a_of_type_AndroidContentResResources);
      i6 = aepi.a(15.0F, this.jdField_a_of_type_AndroidContentResResources);
      i7 = aepi.a(3.0F, this.jdField_a_of_type_AndroidContentResResources);
      if (j == 0) {
        break label326;
      }
      ...
      i1 = aepi.a(40.0F, this.jdField_a_of_type_AndroidContentResResources);
      f1 = aepi.a(9.0F, this.jdField_a_of_type_AndroidContentResResources);
    ...
    for (;;)
    {
      ...
      break label115;
      label335:
      i1 = aepi.a(36.0F, this.jdField_a_of_type_AndroidContentResResources);
      break label131;
      label349:
      paramCanvas.save();
      int i2 = 0;
      ...
      while (i2 < this.f)
      {
        ...
        if ((this.jdField_a_of_type_Boolean) && (i2 == this.f - 1))
        {
          ...
          int i9 = blyt.a(this.jdField_a_of_type_JavaLangString.charAt(i));
          if (i9 != 2) {
            break label696;
          }
