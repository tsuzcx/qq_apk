...
public class avxo
{
  private static volatile avxo jdField_a_of_type_Avxo;
  private long jdField_a_of_type_Long;
  private avxs jdField_a_of_type_Avxs;
  private bifq jdField_a_of_type_Bifq;
  ...
  private WeakReference<avxr> jdField_a_of_type_MqqUtilWeakReference;
  ...
  private int a(Context paramContext, float paramFloat)
  {
    ...
    for (int i = 1;; i = 2)
    {
      localObject = ((FloatingScreenParams.FloatingBuilder)localObject).setShapeType(i).setCanMove(true).setCanZoom(false).setRatio(paramFloat).setFloatingCenterX(300).setFloatingCenterY(-680).build();
      ...
      avxi.a(paramContext, 4, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin());
      return i;
    }
    this.jdField_b_of_type_MqqUtilWeakReference = new WeakReference(localFloatingScreenManager.setFloatingVideoListener(new avxp(this), 2));
    localFloatingScreenManager.setWindowClickListener(2, new avxq(this, paramContext));
    return 0;
  }
  
  public static avxo a()
  {
    if (jdField_a_of_type_Avxo == null) {}
    try
    {
      if (jdField_a_of_type_Avxo == null) {
        jdField_a_of_type_Avxo = new avxo();
      }
      return jdField_a_of_type_Avxo;
    }
    finally {}
  }
  ...
  public int a(Context paramContext, @Nonnull WatchTogetherFloatingData paramWatchTogetherFloatingData)
  {
    ...
    {
      QQToast.a(BaseApplicationImpl.getContext(), 2131694255, 0).a();
    ...
    this.jdField_a_of_type_Bifq = new bifq(localIntent, paramContext);
    this.jdField_a_of_type_Bifq.a();
    avxi.a(true, paramWatchTogetherFloatingData.getCurUin(), paramWatchTogetherFloatingData.getCurType(), true);
  ...
  public void a(avxr paramavxr)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramavxr);
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null)) {
        ((avxr)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(paramInt2);
      }
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData = null;
    this.jdField_b_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData = null;
    if (this.jdField_a_of_type_Bifq != null)
    {
      this.jdField_a_of_type_Bifq.e();
      this.jdField_a_of_type_Bifq.c();
      this.jdField_a_of_type_Bifq = null;
    }
    ...
    avxi.a(false, paramString, paramInt, paramBoolean);
    if (this.jdField_a_of_type_Avxs != null)
    {
      awvk.a().a(this.jdField_a_of_type_Avxs);
      this.jdField_a_of_type_Avxs = null;
    }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    avxr localavxr = (avxr)this.jdField_a_of_type_MqqUtilWeakReference.get();
    if (paramBoolean) {}
    for (int i = 1;; i = 2)
    {
      localavxr.b(i);
  ...
  public boolean a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingView == null) || (this.jdField_a_of_type_Bifq == null)) {}
    TouchWebView localTouchWebView;
    do
    {
      return false;
      localTouchWebView = this.jdField_a_of_type_Bifq.a;
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      bdla.b(null, "dc00899", "Grp_AIO", "", "video_tab", "clk_refresh_error", 0, 0, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin(), "", "", "");
      return;
      if (QLog.isColorLevel()) {
      ...
      if (paramInt == 1)
      {
        ...
        if (this.jdField_a_of_type_Avxs == null)
        {
          this.jdField_a_of_type_Avxs = new avxs(this.jdField_b_of_type_MqqUtilWeakReference);
          awvk.a().a(1, this.jdField_a_of_type_Avxs);
          return;
        }
        this.jdField_a_of_type_Avxs.a(this.jdField_b_of_type_MqqUtilWeakReference);
        return;
      }
    } while (paramInt != 2);
    bdla.b(null, "dc00899", "Grp_AIO", "", "video_tab", "clk_refresh_error", 0, 0, this.jdField_a_of_type_ComTencentMobileqqIntervideoYiqikanWatchTogetherFloatingData.getCurUin(), "", "", "");
  ...
  public void b(avxr paramavxr)
  {
    if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() == paramavxr)) {
