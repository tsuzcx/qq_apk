...
public class nev
{
  ...
  public nev(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(ArrayList<TroopAppInfo> paramArrayList)
  {
    if (this.jdField_a_of_type_Ney != null) {
      this.jdField_a_of_type_Ney.a(paramArrayList);
    }
  }
  ...
  private void a(List<Long> paramList)
  {
    ...
    ((NewIntent)localObject).setObserver(new nex(this));
  ...
  public boolean a(String paramString, ney paramney)
  {
    return a(paramString, paramney, false);
  }
  
  public boolean a(String paramString, ney paramney, boolean paramBoolean)
  {
    this.jdField_a_of_type_Ney = paramney;
    paramney = new oidb_0x8cf.ReqBody();
    try
    {
      paramney.opt_uint64_groupcode.set(Long.parseLong(paramString));
      paramney.opt_uint32_need_mobile_sysapps.set(1);
      paramString = new oidb_sso.OIDBSSOPkg();
      paramString.uint32_command.set(2255);
      paramString.uint32_service_type.set(6);
      paramString.bytes_bodybuffer.set(ByteStringMicro.copyFrom(paramney.toByteArray()));
      paramney = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), mzx.class);
      paramney.putExtra("cmd", "OidbSvc.0x8cf_6");
      paramney.putExtra("data", paramString.toByteArray());
      paramney.setObserver(new new(this, paramBoolean));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet(paramney);
      return true;
    }
    catch (NumberFormatException paramney)
    {
