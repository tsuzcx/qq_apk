...
{
  public bpbb(EditProviderPart.2 param2) {}
  
  @TargetApi(16)
  public void onGlobalLayout()
  {
    if ((this.a.this$0.jdField_a_of_type_Bpfx == null) || (bpaz.a(this.a.this$0) == null))
    {
    ...
    Object localObject = bpaz.a(this.a.this$0).getViewTreeObserver();
    if (((ViewTreeObserver)localObject).isAlive()) {
      ((ViewTreeObserver)localObject).removeOnGlobalLayoutListener(this);
    }
    localObject = this.a.this$0.jdField_a_of_type_Bpep.a();
    if (localObject != null)
    {
      int i = ((View)localObject).getLeft();
      int j = ((View)localObject).getWidth() / 2;
      int k = bpaz.a(this.a.this$0).getWidth() / 2;
      bpaz.a(this.a.this$0).setX(j + i - k);
    }
    localObject = (GridView)this.a.this$0.a(2131379107);
    ...
    bokm localbokm = new bokm(this.a.this$0.a(), this.a.this$0.b());
    localbokm.a = true;
    localbokm.a(this.a.a);
    ((GridView)localObject).setAdapter(localbokm);
    ((GridView)localObject).setOnItemClickListener(new bpbc(this, localbokm));
  }
}
