  ...
  extends BaseBubbleBuilder
{
  ...
  protected HashMap<String, SparseArray<WeakReference<adya>>> a;
  protected float b;
  final String b;
  ...
  protected String d;
  protected final int e = 2131373637;
  protected final int f = 2131373644;
  protected final int g = 2131373636;
  protected final int h = 2131373635;
  protected final int i = 2131373639;
  protected int j;
  protected int k;
  protected int l;
  protected int m;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = adxx.class.getSimpleName();
  }
  
  public adxx(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_c_of_type_Int = 2131373620;
    this.jdField_d_of_type_Int = 2131373649;
    this.jdField_b_of_type_JavaLangString = "pay";
    this.jdField_d_of_type_JavaLangString = "";
    this.jdField_b_of_type_Float = 1.0F;
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new adxy(this);
    this.jdField_a_of_type_Ahbg = new adxz(this);
    this.jdField_d_of_type_JavaLangString = paramContext.getString(2131717325);
  ...
  private RelativeLayout a(adya paramadya, Context paramContext)
  {
    ...
    localQQWalletTransferBubbleView.setId(2131373620);
    ...
    ((TextView)localObject1).setId(2131373637);
    ...
    localTextView.setId(2131373644);
    ...
    ((RelativeLayout.LayoutParams)localObject3).addRule(3, 2131373620);
    ((QQWalletTransferBubbleView)localObject2).setLayoutParams((ViewGroup.LayoutParams)localObject3);
    ((QQWalletTransferBubbleView)localObject2).setBackgroundResource(2130846324);
    ((QQWalletTransferBubbleView)localObject2).setId(2131373636);
    ...
    paramContext.setId(2131373635);
    ((QQWalletTransferBubbleView)localObject2).addView(paramContext);
    localRelativeLayout.addView((View)localObject2);
    paramadya.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject1);
    paramadya.jdField_b_of_type_AndroidWidgetTextView = localTextView;
    paramadya.jdField_a_of_type_AndroidWidgetImageView = localImageView;
    paramadya.c = paramContext;
    paramadya.jdField_a_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView = ((QQWalletTransferBubbleView)localObject2);
    paramadya.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView = localQQWalletTransferBubbleView;
  ...
  private void a(adya paramadya, MessageForQQWalletMsg paramMessageForQQWalletMsg, QQWalletTransferMsgElem paramQQWalletTransferMsgElem, boolean paramBoolean, acxn paramacxn)
  {
    if (paramMessageForQQWalletMsg.messageType == 16) {}
    for (int i1 = 1;; i1 = 0)
    {
      a(paramadya.jdField_a_of_type_AndroidWidgetTextView, paramQQWalletTransferMsgElem.title);
      paramadya.jdField_a_of_type_AndroidWidgetTextView.setTextColor(paramQQWalletTransferMsgElem.titleColor);
      paramadya.jdField_b_of_type_AndroidWidgetTextView.setText(paramQQWalletTransferMsgElem.subTitle);
      paramadya.jdField_b_of_type_AndroidWidgetTextView.setTextColor(paramQQWalletTransferMsgElem.subtitleColor);
      paramadya.c.setText(paramQQWalletTransferMsgElem.content);
      if (i1 != 0)
      {
        ...
        if (!TextUtils.isEmpty(paramQQWalletTransferMsgElem.iconUrl)) {
          localObject = aywk.a(paramQQWalletTransferMsgElem.iconUrl, (int)bbdh.a(this.jdField_a_of_type_AndroidContentContext, this.k), (int)bbdh.a(this.jdField_a_of_type_AndroidContentContext, this.k), null, null);
        }
        paramadya.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      }
      if (ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().waitAppRuntime(null), false, null))
      {
        paramadya.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleNightBackground(2130846323, Color.parseColor("#FF19BAFF"), paramBoolean);
        paramadya.jdField_a_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130846324, Color.parseColor("#A4A5A8"), paramBoolean);
        paramadya.jdField_a_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#B2B2B2"));
        paramadya.jdField_b_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#B2B2B2"));
        paramadya.c.setTextColor(Color.parseColor("#5D616B"));
      }
      for (;;)
      {
        paramadya.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(paramQQWalletTransferMsgElem.title + paramQQWalletTransferMsgElem.subTitle + this.jdField_d_of_type_JavaLangString);
        paramadya.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        paramadya.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnLongClickListener(paramacxn);
        paramadya.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnTouchListener(paramacxn);
        if (i1 != 0) {
          a(paramadya, paramMessageForQQWalletMsg, paramQQWalletTransferMsgElem);
        }
        return;
        if (axmt.b())
        {
          paramadya.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130846323, Color.parseColor("#FF19BAFF"), paramBoolean);
          paramadya.jdField_a_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130846324, Color.parseColor("#FFECEDF2"), paramBoolean);
          paramadya.c.setTextColor(Color.parseColor("#FF878B99"));
        }
        else
        {
          paramadya.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130846323, paramQQWalletTransferMsgElem.background, paramBoolean);
          if (paramQQWalletTransferMsgElem.contentBgColor != 0) {
            paramadya.jdField_a_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView.setBubbleBackground(2130846324, paramQQWalletTransferMsgElem.contentBgColor, paramBoolean);
          }
          if (paramQQWalletTransferMsgElem.contentColor != 0) {
            paramadya.c.setTextColor(paramQQWalletTransferMsgElem.contentColor);
          }
        }
      }
    }
  ...
  private boolean a(Context paramContext, String paramString1, String paramString2, String paramString3, MessageForQQWalletMsg paramMessageForQQWalletMsg, SessionInfo paramSessionInfo)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        try
        {
          paramString1 = adxx.class.getClassLoader();
  ...
  {
    adya localadya = (adya)paramacun;
    paramacun = null;
    if ((paramChatMessage instanceof MessageForQQWalletMsg)) {
      paramacun = (MessageForQQWalletMsg)paramChatMessage;
    }
    if ((paramacun == null) || (paramacun.mQQWalletTransferMsg == null)) {
      return null;
    }
    if ((localadya.jdField_a_of_type_AndroidWidgetRelativeLayout == null) || ((localadya.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (localadya.jdField_a_of_type_Long != paramChatMessage.uniseq)))
    {
      localadya.jdField_a_of_type_AndroidWidgetRelativeLayout = a(localadya, this.jdField_a_of_type_AndroidContentContext);
      paramBaseChatItemLayout.addView(a(this.jdField_a_of_type_AndroidContentContext));
    }
    localadya.jdField_a_of_type_Long = paramChatMessage.uniseq;
    paramView = paramacun.mQQWalletTransferMsg.elem;
    if (paramView == null) {
      return localadya.jdField_a_of_type_AndroidWidgetRelativeLayout;
    }
    boolean bool;
    if (!paramChatMessage.isSend())
    {
      bool = true;
      a(localadya, paramacun, paramView, bool, paramacxn);
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "transferaccountmsg", "show", 0, 0, "" + paramacun.mQQWalletTransferMsg.templateId, "", "", "");
      paramChatMessage = (TextView)paramBaseChatItemLayout.findViewById(2131373639);
    ...
    for (;;)
    {
      if (paramacun.messageType == 16)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.registObserver(this.jdField_a_of_type_Ahbg);
        if (!TextUtils.isEmpty(paramacun.mQQWalletTransferMsg.listId))
        {
          paramView = (SparseArray)this.jdField_a_of_type_JavaUtilHashMap.get(paramacun.mQQWalletTransferMsg.listId);
          paramChatMessage = paramView;
          if (paramView == null)
          {
            paramChatMessage = new SparseArray();
            this.jdField_a_of_type_JavaUtilHashMap.put(paramacun.mQQWalletTransferMsg.listId, paramChatMessage);
          }
          paramChatMessage.put((int)paramacun.uniseq, new WeakReference(localadya));
        }
      }
      return localadya.jdField_a_of_type_AndroidWidgetRelativeLayout;
      bool = false;
  ...
  public void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.unRegistObserver(this.jdField_a_of_type_Ahbg);
  ...
  protected void a(adya paramadya, MessageForQQWalletMsg paramMessageForQQWalletMsg, QQWalletTransferMsgElem paramQQWalletTransferMsgElem)
  {
    int i2;
    boolean bool;
    if (paramMessageForQQWalletMsg.messageType == 16)
    {
      ...
      paramQQWalletTransferMsgElem = BaseApplicationImpl.getContext().getString(2131717318);
      i1 = 2130846301;
      a(paramadya.jdField_a_of_type_AndroidWidgetTextView, paramQQWalletTransferMsgElem);
      if ((i1 != 0) && (paramadya.jdField_a_of_type_AndroidWidgetImageView != null))
      {
        paramQQWalletTransferMsgElem = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(i1);
        paramadya.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(paramQQWalletTransferMsgElem);
      }
      if (paramadya.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView != null)
      {
        paramadya = paramadya.jdField_b_of_type_ComTencentMobileqqActivityQwalletQQWalletTransferBubbleView;
        if (paramMessageForQQWalletMsg.isSend()) {
          break label337;
        }
        bool = true;
        label120:
        paramadya.setBubbleBackground(2130846323, i2, bool);
      }
    }
    return;
    label132:
    paramQQWalletTransferMsgElem = ahbe.a(1, paramMessageForQQWalletMsg.mQQWalletTransferMsg.listId, paramMessageForQQWalletMsg);
    ...
    for (int i1 = paramQQWalletTransferMsgElem.a("state", -1);; i1 = -1)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          paramQQWalletTransferMsgElem = BaseApplicationImpl.getContext().getString(2131717324);
          i1 = 2130846302;
          i2 = -7676215;
        }
      ...
      if (i1 == 2)
      {
        paramQQWalletTransferMsgElem = BaseApplicationImpl.getContext().getString(2131717319);
        i1 = 2130846299;
        i2 = -7676215;
        break;
      }
      if (i1 == 3)
      {
        paramQQWalletTransferMsgElem = BaseApplicationImpl.getContext().getString(2131717321);
        i1 = 2130846299;
        i2 = -7676215;
        break;
      }
      if (paramMessageForQQWalletMsg.isSend())
      {
        paramQQWalletTransferMsgElem = BaseApplicationImpl.getContext().getString(2131717322);
        i1 = 2130846300;
        break;
      }
      paramQQWalletTransferMsgElem = BaseApplicationImpl.getContext().getString(2131717320);
      i1 = 2130846300;
      break;
      label337:
      bool = false;
