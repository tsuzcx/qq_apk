  ...
  implements View.OnClickListener
{
  ...
  public aweg(Context paramContext)
  {
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      paramQQAppInterface = bhey.a(paramQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString1);
  ...
  private void a(String paramString1, String paramString2, String paramString3, List<String> paramList, int paramInt)
  {
    ...
    for (paramList = (String)paramList.get(0);; paramList = null)
    {
      if ("url".equals(paramString2))
      {
        ...
        paramString2 = awds.a("banner_exp");
      ...
      paramString2 = awds.a("banner_clk");
      paramString2.jdField_b_of_type_Int = i;
      paramString2.a = paramString3;
      paramString2.jdField_b_of_type_JavaLangString = paramList;
      paramString2.e = paramString1;
  ...
  {
    ((LebaRoundLayout)paramView.findViewById(2131364100)).jdField_a_of_type_Int = ViewUtils.dip2px(16.0F);
    Object localObject = (LinearLayout)paramView.findViewById(2131370386);
    if (ThemeUtil.isNowThemeIsNight(paramAppRuntime, false, null))
    {
      ((LinearLayout)localObject).setBackgroundResource(2130840549);
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localRedTypeInfo.red_type.get() == 5) || (localRedTypeInfo.red_type.get() == 4)) {
          try
          {
            ...
            localJSONObject.put("cr", String.format("#%06X", new Object[] { Integer.valueOf(0xFFFFFF & this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167033)) }));
      ...
      ((LinearLayout)localObject).setBackgroundResource(2130839458);
      break;
      label257:
      ...
      break label61;
      label279:
      paramView = paramView.findViewById(2131370301);
      paramView = new RedTouch(this.jdField_a_of_type_AndroidContentContext, paramView).d(ViewUtils.dpToPx(5.0F)).c(ViewUtils.dpToPx(1.0F)).b(19).a();
    ...
    if ((!this.jdField_a_of_type_JavaUtilHashSet.contains(Integer.valueOf(paramAppInfo.uiAppId.get()))) && (paramAppInfo.iNewFlag.get() != 0))
    {
      ...
      ((bbbq)paramAppRuntime.getManager(QQManagerFactory.MGR_RED_TOUCH)).a(paramAppInfo.uiAppId.get(), 30);
    ...
    try
    {
      ...
      if (AppSetting.c) {
        bgyd.a(paramView, paramView.a(), Button.class.getName());
      }
      return;
    }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        bbbq localbbbq = (bbbq)localAppRuntime.getManager(QQManagerFactory.MGR_RED_TOUCH);
        if (localbbbq != null)
        {
          Object localObject1 = localbbbq.a(0, "100000");
