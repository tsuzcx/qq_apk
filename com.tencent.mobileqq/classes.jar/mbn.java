...
public abstract class mbn
{
  ...
  public lez a;
  lmv jdField_a_of_type_Lmv = new mbo(this);
  public mkk a;
  ...
  public void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Mkk != null) {}
    for (TextView localTextView = this.jdField_a_of_type_Mkk.a();; localTextView = null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentAvGaudioBaseGaInvite$GetGaFaceRunnable == null) {
        this.jdField_a_of_type_ComTencentAvGaudioBaseGaInvite$GetGaFaceRunnable = new BaseGaInvite.GetGaFaceRunnable(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, this.jdField_a_of_type_Long, this.jdField_b_of_type_Long, this.jdField_a_of_type_Lmv);
      }
  ...
  void a(boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "refreshUI, isMultiCall[" + mqu.b(this.jdField_b_of_type_Int) + "], multiIncomingCall[" + paramBoolean + "], mUinType[" + this.jdField_b_of_type_Int + "], mIsAudioMode[" + this.jdField_a_of_type_Boolean + "]");
    }
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Mkk == null)
      {
        this.jdField_a_of_type_Mkk = new mkk(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getApplicationContext());
        this.jdField_a_of_type_Mkk.a(this.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_b_of_type_JavaLangString);
        localObject = new Date();
        localObject = new SimpleDateFormat("HH:mm").format((Date)localObject);
        this.jdField_a_of_type_Mkk.b((String)localObject);
        this.jdField_a_of_type_Mkk.a(this.jdField_a_of_type_Boolean, mqu.b(this.jdField_b_of_type_Int), paramBoolean);
        if (mqu.b(this.jdField_b_of_type_Int)) {
      ...
      if (this.jdField_a_of_type_Lez != null)
      {
        ...
        if (this.jdField_a_of_type_Lez.A == 1)
        {
          ...
          if (this.jdField_b_of_type_Int == 9500)
          {
            ...
            {
              localObject = this.jdField_a_of_type_Lez.p;
              i = 0;
            }
          }
        }
      ...
      {
        if (this.jdField_a_of_type_Lez != null) {
          this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Lez.a();
        }
        if (QLog.isColorLevel()) {
