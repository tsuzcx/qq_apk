...
public class zvt
  implements bliz
{
  public zvt(QRCardActivity paramQRCardActivity, boolean[] paramArrayOfBoolean, String paramString1, Context paramContext, String paramString2) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ArrayOfBoolean[0] == 1)
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Blir.dismiss();
          return;
          paramView = this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.app.getAccount();
          localObject = (String)this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Zyw.f.get(this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.k);
          if (!TextUtils.isEmpty(paramView))
          {
            ...
            paramView = (String)this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Zyw.f.get(this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.k);
      ...
      if (this.jdField_a_of_type_ArrayOfBoolean[2] == 1)
      {
        ...
        if (!this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Zyw.c.isEmpty()) {
          paramView.putAll(this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Zyw.c);
        }
        if (!this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Zyw.f.isEmpty()) {
          paramView.putAll(this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Zyw.f);
        }
        if (this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Zyw.e != null) {
          paramView.putAll(this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Zyw.e);
        }
        if (!this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Zyw.d.isEmpty()) {
          paramView.putAll(this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Zyw.d);
        }
        switch (paramInt)
        {
        }
