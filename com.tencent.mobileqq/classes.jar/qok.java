...
public class qok
{
  ...
  private static volatile qok jdField_a_of_type_Qok;
  private volatile boolean jdField_a_of_type_Boolean;
  private final String b = nku.a("4044") + "4044";
  private final String c = BaseApplicationImpl.getApplication().getFilesDir().getParent() + "/txlib/" + "readinjoy_pts_jsc";
  
  public static qok a()
  {
    if (jdField_a_of_type_Qok == null) {}
    try
    {
      if (jdField_a_of_type_Qok == null) {
        jdField_a_of_type_Qok = new qok();
      }
      return jdField_a_of_type_Qok;
    }
    finally {}
  }
  ...
  private boolean b()
  {
    ...
    boolean bool1 = bgmg.a(this.c + "/" + "libjsc.so");
    boolean bool2 = qom.a((String)localObject);
    jdField_a_of_type_JavaLangString = qom.b((String)localObject);
