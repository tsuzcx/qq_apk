...
public class azun
  extends RecyclerView.Adapter<azuv>
{
  ...
  public azuu a;
  private URLDrawable.URLDrawableListener jdField_a_of_type_ComTencentImageURLDrawable$URLDrawableListener = new azut(this);
  ...
  public azun(Context paramContext, ArrayList<UniBusiSimpleItemDetail> paramArrayList)
  {
    this.jdField_a_of_type_Azuu = new azup(this);
  ...
  {
    String str3 = anvx.a(2131704151);
    String str2 = anvx.a(2131719332);
    String str1 = str2;
    if (!TextUtils.isEmpty(paramString2))
    {
      str1 = str2;
      if (paramString2.contains("svip")) {
        str1 = anvx.a(2131719331);
      }
    }
    bhdj.a(paramContext, 230, str3, paramString3, anvx.a(2131704152), str1, new azuq(this, paramContext, paramString1, paramString2, paramString4), new azur(this)).show();
  }
  ...
  public Drawable a(Context paramContext, Drawable paramDrawable, boolean paramBoolean)
  {
    ...
    return new LayerDrawable(new Drawable[] { paramDrawable, paramContext.getResources().getDrawable(2130850332) });
  }
  ...
  public Drawable a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    return new LayerDrawable(new Drawable[] { paramString, paramContext.getResources().getDrawable(2130850332) });
  }
  
  public azuv a(ViewGroup paramViewGroup, int paramInt)
  {
    paramViewGroup = new azuv(this, View.inflate(paramViewGroup.getContext(), 2131561439, null));
    if (paramInt == 1)
    {
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_QCUniBusiSimpleItemDetail != null) && (this.jdField_a_of_type_Boolean))
    {
      ...
      a(this.jdField_a_of_type_Int, this.jdField_a_of_type_QCUniBusiSimpleItemDetail.itemId, this.jdField_a_of_type_QCUniBusiSimpleItemDetail.feeType, this.jdField_a_of_type_Azuu);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, azuu paramazuu)
  {
    if ((a(paramInt3)) && (paramazuu != null))
    {
      paramazuu.a(true, null);
      return;
    }
    new bhyv("QC.UniBusinessUserInfoServer.UniBusinessUserInfoObj", "QcUniBusinessUserInfo.UniBusiGetOneItemWithCheck", "stReq", "stRsp").a("UniBusiGetOneItemWithCheck", new UniBusiGetOneItemWithCheckReq(bhyv.a(), paramInt1, paramInt2), new UniBusiGetOneItemWithCheckRsp(), new azus(this, paramazuu), false);
  }
  ...
  public void a(azum paramazum)
  {
    this.jdField_a_of_type_Azum = paramazum;
  }
  
  public void a(azuv paramazuv, int paramInt)
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_JavaUtilArrayList.get(paramInt) == null))
    {
      EventCollector.getInstance().onRecyclerBindViewHolder(paramazuv, paramInt, getItemId(paramInt));
      return;
    }
    ...
    paramazuv.jdField_a_of_type_AndroidWidgetTextView.setText(localUniBusiSimpleItemDetail.name);
    boolean bool;
    label72:
    int i;
    if (this.b == localUniBusiSimpleItemDetail.itemId)
    {
      ...
      paramazuv.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetRoundRelativeLayout.setBackgroundDrawable(a(paramazuv.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetRoundRelativeLayout.getContext(), localUniBusiSimpleItemDetail.itemBgColor, bool));
      i = (ScreenUtil.getRealWidth(paramazuv.itemView.getContext()) - ScreenUtil.dip2px(96.0F)) / 3;
      Object localObject = paramazuv.jdField_a_of_type_AndroidWidgetImageView.getLayoutParams();
      ((ViewGroup.LayoutParams)localObject).width = i;
      ((ViewGroup.LayoutParams)localObject).height = ((int)(i * 0.57F));
      paramazuv.jdField_a_of_type_AndroidWidgetImageView.setLayoutParams((ViewGroup.LayoutParams)localObject);
      paramazuv.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(a(String.valueOf(localUniBusiSimpleItemDetail.itemId), localUniBusiSimpleItemDetail.image));
    }
    for (;;)
    {
      a(paramazuv.jdField_a_of_type_AndroidWidgetTextView, localUniBusiSimpleItemDetail.feeType);
      paramazuv.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetRoundRelativeLayout.setOnClickListener(new azuo(this, localUniBusiSimpleItemDetail));
      break;
      bool = false;
      break label72;
      label308:
      ...
      break label86;
      label313:
      paramazuv.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetRoundRelativeLayout.setBackgroundDrawable(a(paramazuv.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetRoundRelativeLayout.getContext(), a(String.valueOf(localUniBusiSimpleItemDetail.itemId), localUniBusiSimpleItemDetail.image), bool));
    }
  }
    ...
    for (;;)
    {
      ...
      else
      {
        if (this.jdField_a_of_type_QCUniBusiSimpleItemDetail != null)
        {
          ...
          a(this.jdField_a_of_type_Int, this.jdField_a_of_type_QCUniBusiSimpleItemDetail.itemId, -1, this.jdField_a_of_type_Azuu);
        }
        this.d = 0;
        return;
        this.jdField_a_of_type_JavaUtilArrayList = paramArrayList;
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Azum != null)
    {
      ...
      this.jdField_a_of_type_Azum.b(this.jdField_a_of_type_QCUniBusiSimpleItemDetail.itemId, i);
    }
    label60:
    ...
    this.jdField_a_of_type_Azum.a(this.jdField_a_of_type_QCUniBusiSimpleItemDetail.itemId, i);
  }
