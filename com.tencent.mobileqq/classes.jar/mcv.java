...
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mcw(this);
  private Context jdField_a_of_type_AndroidContentContext;
  private boolean jdField_a_of_type_Boolean;
  private long[] jdField_a_of_type_ArrayOfLong;
  private boolean b;
  
  public mcv(Context paramContext)
  {
  ...
  private void a(View paramView)
  {
    ...
    ((Activity)localObject).findViewById(2131373483).setVisibility(0);
    paramView = (TextView)((Activity)localObject).findViewById(2131373485);
    localObject = (TextView)((Activity)localObject).findViewById(2131373484);
    ...
    String str1 = llc.a(this.jdField_a_of_type_AndroidContentContext);
    str2 = str2 + "\n----------\n";
    str1 = str2 + a(str1);
    paramView.setText(i + "|" + lvz.a().a("load"));
  ...
  {
    Object localObject = (Activity)this.jdField_a_of_type_AndroidContentContext;
    View localView = ((Activity)localObject).findViewById(2131373482);
    if (localView != null)
    {
      localView.setOnClickListener(this);
      localView.setVisibility(0);
    }
    localView = ((Activity)localObject).findViewById(2131373484);
    if (localView != null) {
      localView.setOnClickListener(this);
    }
    localObject = ((Activity)localObject).findViewById(2131373483);
    if (localObject != null) {
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ArrayOfLong[0] >= SystemClock.uptimeMillis() - 2000L)
      {
        a(paramView);
        continue;
        ((Activity)this.jdField_a_of_type_AndroidContentContext).findViewById(2131373483).setVisibility(8);
      }
    }
  }
}
