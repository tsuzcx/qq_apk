...
public class azle
{
  ...
  private volatile azlh jdField_a_of_type_Azlh;
  ...
  private void a(boolean paramBoolean)
  {
    try
    {
      if (this.jdField_a_of_type_Azlh != null)
      {
        ...
        localObject1 = new azld((LatLng)localObject1, this.jdField_a_of_type_ComTencentMapGeolocationTencentLocation.getProvider(), this.jdField_a_of_type_ComTencentMapGeolocationTencentLocation.getAccuracy(), this.jdField_a_of_type_ComTencentMapGeolocationTencentLocation.getTime());
        if (QLog.isColorLevel()) {
          QLog.e("LocationHandler", 2, "[status][loc] notifyLocationUpdate location: " + localObject1);
        }
        this.jdField_a_of_type_Azlh.a((azld)localObject1, Double.valueOf(this.jdField_a_of_type_Double), paramBoolean);
      }
      return;
    }
    finally {}
  ...
  public void a(long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_ComTencentMapGeolocationTencentLocationListener = new azlf(this, local1, localMqqHandler);
    this.jdField_a_of_type_ComTencentMapGeolocationTencentDirectionListener = new azlg(this);
    ...
    if (i != 0)
    {
      ...
      if (this.jdField_a_of_type_Azlh != null) {
        this.jdField_a_of_type_Azlh.a(i);
      }
    }
    if (paramBoolean2)
    {
  ...
  public void b(azlh paramazlh)
  {
    try
    {
      if (QLog.isColorLevel()) {
        QLog.d("LocationHandler", 2, "removeLocationListener: invoked. listener: " + paramazlh + " mLocationListener: " + this.jdField_a_of_type_Azlh);
      }
      if (paramazlh == this.jdField_a_of_type_Azlh) {
