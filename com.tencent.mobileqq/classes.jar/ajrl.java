  ...
  extends BaseAdapter
{
  ...
  public ajrl(Context paramContext)
  {
  ...
  public Drawable a(ApolloActionPackage paramApolloActionPackage)
  {
    ...
    {
      localURLDrawable2 = ajhs.a("" + paramApolloActionPackage.mIconSelectedUrl.hashCode(), null, paramApolloActionPackage.mIconSelectedUrl, true);
    ...
    for (URLDrawable localURLDrawable1 = localURLDrawable2;; localURLDrawable1 = null)
    {
      ...
      {
        paramApolloActionPackage = ajhs.a("" + paramApolloActionPackage.mIconUnselectedUrl.hashCode(), null, paramApolloActionPackage.mIconUnselectedUrl, true);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup = new ajrm(this);
      paramViewGroup.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131376789));
      ...
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131376786);
      paramViewGroup.jdField_a_of_type_AndroidViewView.setBackgroundColor(this.jdField_a_of_type_Int);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376787));
    ...
    for (int i = 0;; i = 4)
    {
      ...
      return paramView;
      paramViewGroup = (ajrm)paramView.getTag();
      break;
    }
    label233:
