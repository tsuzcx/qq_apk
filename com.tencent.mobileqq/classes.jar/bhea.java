  ...
  implements Manager
{
  ...
  public bhea(QQAppInterface paramQQAppInterface)
  {
    this.a = paramQQAppInterface;
  }
  
  public static bhea a(QQAppInterface paramQQAppInterface)
  {
    return (bhea)paramQQAppInterface.getManager(189);
  }
  ...
  public boolean a(UpgradeDetailWrapper paramUpgradeDetailWrapper)
  {
    ...
    {
      return false;
      i = bhsi.aO(this.a.getApp(), this.a.c());
      ...
      l1 = bhsi.k(this.a.getApp(), this.a.c());
  ...
  public boolean b(UpgradeDetailWrapper paramUpgradeDetailWrapper)
  {
    ...
    {
      return false;
      i = bhsi.aP(this.a.getApp(), this.a.c());
      ...
      l1 = bhsi.l(this.a.getApp(), this.a.c());
      l2 = System.currentTimeMillis();
      if (QLog.isColorLevel()) {
