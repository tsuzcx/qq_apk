  ...
  extends bdfq
{
  ...
  private afdw jdField_a_of_type_Afdw = new bdfm(this);
  private ArkViewImplement.LoadCallback jdField_a_of_type_ComTencentArkArkViewImplement$LoadCallback = new bdfn(this);
  ...
  public bdfl(Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
  }
  
  private afdt a(bdfo parambdfo)
  {
    this.jdField_a_of_type_Afdt = new afds();
    ...
    if (QLog.isDebugVersion()) {
      QLog.d("QQCustomArkDialog", 4, "w=" + i + ",h=" + j + ", appName:" + parambdfo.jdField_a_of_type_JavaLangString);
    }
    this.jdField_a_of_type_Afdt.a(parambdfo.jdField_a_of_type_JavaLangString, parambdfo.b, parambdfo.c, parambdfo.d, parambdfo.jdField_a_of_type_Float, parambdfo.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    if ((this.e != 0) && (this.f != 0)) {
      this.jdField_a_of_type_Afdt.setFixSize(this.e, this.f);
    }
    for (;;)
    {
      anft.a = false;
      return this.jdField_a_of_type_Afdt;
      this.jdField_a_of_type_Afdt.setFixSize(this.d, this.g);
      this.jdField_a_of_type_Afdt.setMaxSize(this.d, this.jdField_a_of_type_Int);
      this.jdField_a_of_type_Afdt.setMinSize(this.b, this.c);
    }
  }
  ...
  {
    paramBundle = a(new bdfo(paramBundle));
