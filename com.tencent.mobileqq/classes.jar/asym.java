...
public class asym
{
  ...
  public asym(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localExtensionInfo = localajxn.a(paramString, true);
        bool1 = localajxn.a(false);
      } while ((bool1) || (localExtensionInfo == null));
      i = asyh.a(6, paramString, localExtensionInfo, bool1);
      j = asyh.a(5, paramString, localExtensionInfo, bool1);
      l1 = localExtensionInfo.lastFriendshipTime;
      l2 = localExtensionInfo.lastChatTime;
      int k = asyh.b();
      bool1 = asyh.a(k, l2 * 1000L);
      bool2 = asyh.a(k, l1 * 1000L);
    ...
    if (bbkb.c(l2) == 2131720335)
    {
      bool1 = true;
      label279:
      if (bbkb.c(l3) != 2131720335) {
        break label507;
      }
      bool2 = true;
      label292:
