...
public class azvy
{
  private static volatile azvy jdField_a_of_type_Azvy;
  ...
  private Vector<azwa> jdField_a_of_type_JavaUtilVector = new Vector();
  ...
  public static azvy a()
  {
    if (jdField_a_of_type_Azvy == null) {}
    try
    {
      if (jdField_a_of_type_Azvy == null) {
        jdField_a_of_type_Azvy = new azvy();
      }
      return jdField_a_of_type_Azvy;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    if (Build.VERSION.SDK_INT > 16)
    {
      if (this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback == null) {
        this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback = new azvz(this);
      }
  ...
  private void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          ((azwa)this.jdField_a_of_type_JavaUtilVector.get(i)).onInfo(this.jdField_a_of_type_Long, d);
          i += 1;
        }
      }
      finally {}
  ...
  public void a(azwa paramazwa)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (!this.jdField_a_of_type_JavaUtilVector.contains(paramazwa)) {
        this.jdField_a_of_type_JavaUtilVector.add(paramazwa);
      }
  ...
  public void b(azwa paramazwa)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilVector.contains(paramazwa)) {
        this.jdField_a_of_type_JavaUtilVector.remove(paramazwa);
      }
      if (this.jdField_a_of_type_JavaUtilVector.size() <= 0) {
        b();
      }
