  ...
  extends ProxyWebViewClientExtension
{
  ...
  public becz(becv parambecv, TouchWebView paramTouchWebView, beby parambeby)
  {
  ...
  public void onFakeLoginRecognised(Bundle paramBundle)
  {
    ...
    paramBundle = "";
    String str1 = "";
    if (this.jdField_a_of_type_Becv.jdField_a_of_type_ComTencentBizUiTouchWebView != null)
    {
      paramBundle = this.jdField_a_of_type_Becv.jdField_a_of_type_ComTencentBizUiTouchWebView.getOriginalUrl();
      str1 = this.jdField_a_of_type_Becv.jdField_a_of_type_ComTencentBizUiTouchWebView.getUrl();
      beep.a(paramBundle, str1, localStringBuilder.toString(), str2, bool2, bool3, bool1);
    }
    String str3;
    if (((localObject != null) && (((ArrayList)localObject).size() > 0)) || (bool1) || (!TextUtils.isEmpty(str2)))
    {
      str3 = this.jdField_a_of_type_Becv.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin();
      if (this.jdField_a_of_type_Becv.jdField_a_of_type_ComTencentBizUiTouchWebView == null) {
        break label321;
      }
    }
    label321:
    for (Object localObject = this.jdField_a_of_type_Becv.jdField_a_of_type_ComTencentBizUiTouchWebView.getTitle();; localObject = "")
    {
      beep.a(paramBundle, str1, (String)localObject, str3);
  ...
  public Object onMiscCallBack(String paramString, Bundle paramBundle)
  {
    if (this.jdField_a_of_type_Beby != null) {
      return this.jdField_a_of_type_Beby.a(paramString, paramBundle);
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_Beby != null) {
      this.jdField_a_of_type_Beby.a(paramInt, paramString);
    }
  }
  ...
  public void onUrlChange(String paramString1, String paramString2)
  {
    ...
    if (this.jdField_a_of_type_Beby != null) {
      this.jdField_a_of_type_Beby.b(paramString1, paramString2);
    }
  }
