...
public class akwy
  implements bdbc
{
  altm jdField_a_of_type_Altm = new akwz(this);
  ...
  public akwy(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    do
    {
      ...
      default: 
        return;
      case 1: 
        localObject = bdgc.c((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), paramString, true);
        if ((!bckq.b((String)localObject)) || (!((String)localObject).equals(paramString))) {
          break label147;
        }
    ...
    akvv.a().callbackResult(paramInt1, paramString);
    return;
    Object localObject = this.jdField_a_of_type_Bdbb.a(1, String.valueOf(paramString), 0, (byte)1);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Bdbb.a(paramString, 200, false, 1, true, (byte)0, 1);
  }
