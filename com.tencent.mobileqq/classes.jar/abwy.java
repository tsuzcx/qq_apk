...
public class abwy
  implements aikw
{
  public abwy(QQSettingMe paramQQSettingMe) {}
  ...
  public void a(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    return;
    this.a.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.requestPermissions(new abwz(this), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
