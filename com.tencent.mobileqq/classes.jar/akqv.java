...
public class akqv
  extends akoj
{
  public akqv(QQAppInterface paramQQAppInterface, QQMessageFacade paramQQMessageFacade)
  {
  ...
  public void a(String paramString, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2)
  {
    ...
    do
    {
      do
      {
        ...
        paramString = (ayax)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(61);
      ...
      {
        localakpb.a((String)localObject1, paramInt1, l, paramBoolean1, paramBoolean2);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramString, paramInt1) > 0)
      {
        ...
        {
          ((akpb)localObject2).a(paramString, paramInt1, l, paramBoolean1, paramBoolean2);
