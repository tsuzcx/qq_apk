  ...
  extends oqg
{
  ...
  public opg(AppInterface paramAppInterface, atmp paramatmp, ExecutorService paramExecutorService, pdc parampdc, Handler paramHandler)
  {
  ...
  static JSONObject a(boolean paramBoolean)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      localJSONObject2.put("ad_code", akfu.b());
      localJSONObject2.put("city_name", akfu.a());
  ...
  private void c()
  {
    ...
    localReqBody.uint32_network_type.set(ooq.b());
    try
    {
    ...
    a(pde.a("OidbSvc.0xcba", 3258, 0, localReqBody.toByteArray()));
  }
  
  private void d()
  {
    String str = (String)bgmq.a("sp_key_daily_dynamic_header_data", "");
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int i = obr.a(paramToServiceMsg, paramFromServiceMsg, paramObject, localRspBody, false);
    ...
    if (i == 0)
    {
      if ((localRspBody.rspChannelArticle.has()) && (localRspBody.rspChannelArticle.get() != null))
      {
        ...
        if ((paramToServiceMsg.bytes_nearby_cookie.has()) && (paramToServiceMsg.bytes_nearby_cookie.get() != null))
        {
          ...
          bgmq.a("sp_key_daily_dynamic_header_data", paramToServiceMsg);
          a(paramToServiceMsg);
        }
      }
      return;
    }
    bgmq.a("sp_key_daily_dynamic_header_data", "");
