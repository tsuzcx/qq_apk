...
public class opg
{
  public static int a(long paramLong)
  {
    ...
    if (localAppRuntime != null) {
      i = opl.a(localAppRuntime, "open_minus_view_cnt_" + paramLong + "_" + a(localAppRuntime));
    }
    return i;
  }
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      paramQQAppInterface = opf.a(paramQQAppInterface, paramString, "maxShowCount");
  ...
  public static bdnu a(MessageRecord paramMessageRecord)
  {
    if ((paramMessageRecord instanceof MessageForStructing))
    {
      ...
      if ((paramMessageRecord instanceof StructMsgForGeneralShare))
      {
        ...
        if ((paramMessageRecord.mStructMsgItemLists != null) && (paramMessageRecord.mStructMsgItemLists.size() > 0)) {
          return (bdnu)paramMessageRecord.mStructMsgItemLists.get(0);
        }
      }
    }
    return null;
      ...
      while (i >= 0)
      {
        ...
        if (localObject != null)
        {
          if (QLog.isColorLevel()) {
            QLog.i("Ecshop_EcshopUtils", 2, "mGdtActionType " + ((bdnu)localObject).c);
          }
          if ((((bdnu)localObject).c != 1) || (!(((bdnu)localObject).a instanceof StructMsgForGeneralShare))) {}
        }
        else
        {
          do
  ...
  public static String a()
  {
    ...
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if (localAppRuntime != null) {
      str = opl.a(localAppRuntime, "qgg_msg_summary_" + a(localAppRuntime));
    }
    return str;
  }
  ...
  {
    int i = 0;
    String str1 = paramContext.getString(2131718212);
    String str2 = paramContext.getString(2131718210);
    String str3 = paramContext.getString(2131718214);
    String str4 = paramContext.getString(2131718215);
    String str5 = paramContext.getString(2131718213);
    String str6 = paramContext.getString(2131718207);
    paramContext = paramContext.getString(2131718211);
  ...
  {
    bdnu localbdnu = a(paramMessageRecord);
    if (localbdnu != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i("Ecshop_EcshopUtils", 2, "mGdtActionType " + localbdnu.c);
      }
      if (localbdnu.c == 0) {
        return "";
      }
      return String.valueOf(localbdnu.c);
    }
  ...
  public static ArrayList<oon> a(List<qq_ad.QQAdGetRsp.RedPointInfo> paramList)
  {
    ...
    while (paramList.hasNext()) {
      localArrayList.add(new oon().a((qq_ad.QQAdGetRsp.RedPointInfo)paramList.next()));
    }
    return localArrayList;
  }
  ...
  public static Map<String, String> a(String paramString)
  {
    ...
    Object localObject = bmkb.a(paramString);
    if (localObject == null) {
      return new HashMap();
    }
  ...
  public static void a(long paramLong)
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if (localAppRuntime != null) {
      opl.a(localAppRuntime, "open_minus_view_cnt_" + paramLong + "_" + a(localAppRuntime));
    }
  }
  ...
  public static void a(long paramLong, int paramInt)
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if (localAppRuntime != null) {
      opl.a(localAppRuntime, "open_minus_view_cnt_" + paramLong + "_" + a(localAppRuntime), paramInt);
    }
  }
  ...
  private static void a(String paramString)
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if (localAppRuntime != null) {
      opl.a(localAppRuntime, "qgg_msg_summary_" + a(localAppRuntime), paramString);
    }
  }
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    a(BaseApplicationImpl.getApplication().getString(2131691814));
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    try
    {
      ...
      int j = a(paramQQAppInterface, opf.b(paramQQAppInterface, b(localMessageRecord)));
      if (i >= j) {
        return true;
      }
    }
  ...
  public static String b()
  {
    ...
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if (localAppRuntime != null) {
      str = opl.a(localAppRuntime, "qgg_msg_id_" + a(localAppRuntime));
    }
    return str;
  }
  ...
  private static void b(String paramString)
  {
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if (localAppRuntime != null) {
      opl.a(localAppRuntime, "qgg_msg_id_" + a(localAppRuntime), paramString);
    }
  }
