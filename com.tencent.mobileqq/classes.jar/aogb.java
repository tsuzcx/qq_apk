  ...
  extends aogx
{
  ...
  aogb(aofz paramaofz, MessageRecord paramMessageRecord)
  {
    super(paramaofz);
  ...
  void a(String paramString, int paramInt, aogv paramaogv)
  {
    ...
    aodq localaodq = aofz.a(this.jdField_a_of_type_Aofz).a().a();
    if (QLog.isColorLevel()) {
      QLog.i("FileMultiMsgManager<FileAssistant>", 1, "start forwardOfflineFileToX[" + this.jdField_a_of_type_JavaLangString + "]");
    }
    localaodq.a(paramString, paramInt, this.b, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, 3, new aogc(this, paramString, paramaogv));
  }
}
