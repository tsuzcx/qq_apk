...
public class adut
  extends antq
{
  public adut(DiscussionInfoCardActivity paramDiscussionInfoCardActivity) {}
  ...
  protected void onChangeDiscussionName(boolean paramBoolean, String paramString)
  {
    if (DiscussionInfoCardActivity.a(this.a).equals(paramString))
    {
      ...
      {
        DiscussionInfoCardActivity.a(this.a).a(this.a.getString(2131690751));
        DiscussionInfoCardActivity.a(this.a).d(2130839651);
    ...
    DiscussionInfoCardActivity.a(this.a).a(this.a.getString(2131690749));
    DiscussionInfoCardActivity.a(this.a).d(2130839651);
    DiscussionInfoCardActivity.a(this.a).b(false);
    this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessageDelayed(17, 1500L);
  }
  ...
  protected void onCollectDiscussion(boolean paramBoolean, Long paramLong)
  {
    ...
    {
      bdla.b(this.a.app, "CliOper", "", "", "discuss", "discuss_common", 0, 0, "", "", "", "");
      if (!this.a.isFinishing())
      {
        ...
        {
          this.a.jdField_a_of_type_AndroidAppDialog = bhdj.a(this.a, 230, this.a.getString(2131694172), this.a.getString(2131694171), 2131690697, 2131719059, new aduu(this), null);
  ...
  protected void onGetFlyTicket(boolean paramBoolean, int paramInt, long paramLong1, String paramString1, String paramString2, long paramLong2)
  {
    ...
    if (!paramBoolean)
    {
      ...
      {
      default: 
        paramString1 = anvx.a(2131702831);
      }
      for (;;)
      {
        this.a.a(2130839636, paramString1);
        return;
        paramString1 = anvx.a(2131702846);
        continue;
        paramString1 = anvx.a(2131702842);
      }
    }
  ...
  protected void onHeaderFailed(Object[] paramArrayOfObject)
  {
    ...
    if ((paramArrayOfObject == null) || (paramArrayOfObject.trim().equals(""))) {
      paramArrayOfObject = this.a.getString(2131693023);
    }
    for (;;)
    {
      ...
      {
        if ((10001 == i) || (10002 == i)) {
          bhdj.a(this.a, 230, null, paramArrayOfObject, new aduv(this, str), null).show();
        }
      }
      else {
        return;
  ...
  protected void onKickoutDiscussionMember(boolean paramBoolean, Long paramLong1, Long paramLong2)
  {
    ...
    QQToast.a(this.a, 1, this.a.getString(2131691746), 0).b(this.a.getTitleBarHeight());
  }
  ...
  protected void onQuitDiscussion(boolean paramBoolean, String paramString)
  {
    if (DiscussionInfoCardActivity.a(this.a).equals(paramString))
    {
      ...
      if ((DiscussionInfoCardActivity.a(this.a) != null) && (DiscussionInfoCardActivity.a(this.a).isShowing()) && (!this.a.isFinishing()))
      {
        DiscussionInfoCardActivity.a(this.a).a(this.a.getString(2131692038));
        DiscussionInfoCardActivity.a(this.a).d(2130839651);
        DiscussionInfoCardActivity.a(this.a).b(false);
    ...
    DiscussionInfoCardActivity.a(this.a).a(this.a.getString(2131692035));
    DiscussionInfoCardActivity.a(this.a).d(2130839636);
    DiscussionInfoCardActivity.a(this.a).b(false);
    this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessageDelayed(17, 1500L);
  }
