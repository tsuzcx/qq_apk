...
public class bbxg
{
  private static bbww jdField_a_of_type_Bbww;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j < k)
        {
          ...
          else if ((localRecentBaseData.getRecentUserType() == 6000) && (TextUtils.equals(localRecentBaseData.getRecentUserUin(), antf.z)))
          {
            localArrayList.add(localRecentBaseData);
            i = j;
          }
        ...
        else
        {
          if ((localArrayList.size() == 0) || (i == -1))
          {
            ...
            paramList = almc.a(new RecentUser(antf.z, 6000), paramQQAppInterface, paramActivity);
            if (paramList != null)
            {
              paramList.mTitleName = paramActivity.getResources().getString(2131693391);
              localArrayList.add(paramList);
            }
          }
          Collections.sort(localArrayList, new alme(paramQQAppInterface));
  ...
  {
    bbww localbbww2 = (bbww)aran.a().a(485);
    bbww localbbww1 = localbbww2;
    if (localbbww2 == null)
    {
      localbbww2 = new bbww();
      localbbww1 = localbbww2;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ScreenShotHelper", 2, "ScreenShotConfigData switch isOpened = " + localbbww1);
    }
    jdField_a_of_type_Bbww = localbbww1;
  }
  ...
  public static void a(Activity paramActivity)
  {
    ...
    paramActivity = ((ViewGroup)paramActivity.getWindow().getDecorView().getRootView()).findViewById(2131377096);
  ...
  public static void a(Activity paramActivity, Handler paramHandler)
  {
    ...
    View localView = ((ViewGroup)paramActivity.getWindow().getDecorView().getRootView()).findViewById(2131377096);
    if (localView != null)
    {
  ...
  public static void a(Activity paramActivity, String paramString, Handler paramHandler)
  {
    ...
    Object localObject1 = localViewGroup.findViewById(2131377096);
    int k = bhtq.b(79.0F);
    ...
    for (;;)
    {
      ...
      {
        localObject3 = View.inflate(paramActivity, 2131562851, null);
        localImageView = (ImageView)((View)localObject3).findViewById(2131377099);
      ...
      for (;;)
      {
        try
        {
          paramActivity.getResources().getDrawable(2130840347);
          ...
          ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = beyq.b();
  ...
  public static void a(Context paramContext, android.net.Uri paramUri, View paramView1, View paramView2, boolean paramBoolean)
  {
    ...
    //   23: iconst_3
    //   24: aload 9
    //   26: invokestatic 522	zxx:a	(Landroid/net/Uri;Landroid/content/Context;ILandroid/util/SparseArray;)I
    //   29: istore 6
    //   31: iload 6
    //   33: invokestatic 525	zxx:b	(I)Z
    //   36: ifeq +262 -> 298
    ...
    //   109: istore 5
    //   111: iload 6
    //   113: invokestatic 543	zxx:a	(I)Z
    //   116: ifeq -106 -> 10
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    {
      localObject = ((ViewGroup)((Activity)paramContext).getWindow().getDecorView().getRootView()).findViewById(2131377096);
      if (localObject != null) {
          ...
          if (localQQAppInterface.a().a())
          {
            ...
            if (localQQAppInterface.a().a() != null)
            {
              ...
              if (localQQAppInterface.a().a().size() > 0)
              {
                ...
                afez.a(paramString, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class, 9011);
                i = 1;
              }
            }
          }
    ...
    if (((paramContext instanceof QQBrowserActivity)) && (a((QQBrowserActivity)paramContext)))
    {
      ...
      afez.a((QQBrowserActivity)paramContext, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class, 11);
    }
    while (i != 0) {
      return;
    }
    afez.a(paramContext, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class);
  }
  ...
  public static void a(bbww parambbww)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ScreenShotHelper", 2, "onConfUpdate : " + parambbww);
    }
    if (parambbww != null) {
      jdField_a_of_type_Boolean = parambbww.a();
    }
  }
  ...
  public static boolean a()
  {
    ...
    b = true;
    a();
    jdField_a_of_type_Boolean = jdField_a_of_type_Bbww.a();
    if (QLog.isColorLevel()) {
  ...
  private static boolean a(QQBrowserActivity paramQQBrowserActivity)
  {
    ...
    return paramQQBrowserActivity.getSupportFragmentManager().findFragmentById(2131365060) instanceof WebViewFragment;
  }
