...
public final class raw
{
  ...
  private final rau jdField_a_of_type_Rau;
  ...
  static
  {
    jdField_a_of_type_Ray = new ray(null);
  }
  
  public raw(@NotNull ViewGroup paramViewGroup, @NotNull rau paramrau)
  {
    this.jdField_b_of_type_AndroidViewViewGroup = paramViewGroup;
    this.jdField_a_of_type_Rau = paramrau;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_b_of_type_AndroidViewView = LayoutInflater.from(this.jdField_b_of_type_AndroidViewViewGroup.getContext()).inflate(2131562747, this.jdField_b_of_type_AndroidViewViewGroup, false);
    paramViewGroup = this.jdField_b_of_type_AndroidViewView;
    if (paramViewGroup != null)
    {
      paramViewGroup = paramViewGroup.findViewById(2131373406);
      this.jdField_a_of_type_AndroidViewView = paramViewGroup;
      paramViewGroup = this.jdField_a_of_type_AndroidViewView;
      if (paramViewGroup == null) {
        break label310;
      }
      paramViewGroup = (ImageView)paramViewGroup.findViewById(2131373400);
      label104:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131373410);
      label128:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131373404);
      label152:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131365459);
      label176:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131373408);
      label200:
      ...
      paramViewGroup = (ImageView)paramViewGroup.findViewById(2131364714);
      label224:
      ...
      paramViewGroup = (TextView)paramViewGroup.findViewById(2131373405);
      label248:
    ...
    label340:
    label345:
    for (paramViewGroup = (ViewGroup)paramViewGroup.findViewById(2131373403);; paramViewGroup = null)
    {
      this.jdField_a_of_type_AndroidViewViewGroup = paramViewGroup;
      this.jdField_a_of_type_Pvq = ((pvq)new rax(this));
      b();
      c();
      a();
      return;
  ...
  private final void a()
  {
    ...
    if (localView != null) {
      localView.addOnAttachStateChangeListener((View.OnAttachStateChangeListener)new raz(this));
    }
  }
  ...
  private final void a(boolean paramBoolean, Function0<Unit> paramFunction0)
  {
    ...
    for (AlphaAnimation localAlphaAnimation = new AlphaAnimation(0.0F, 1.0F);; localAlphaAnimation = new AlphaAnimation(1.0F, 0.0F))
    {
      ...
      localAnimationSet.setAnimationListener((Animation.AnimationListener)new rbf(paramFunction0));
  ...
  private final void b()
  {
    ...
    {
      if (((CharSequence)this.jdField_a_of_type_Rau.a()).length() == 0)
      {
        i = 1;
        if (i == 0) {
          break label599;
    ...
    else
    {
      ...
      if (localObject1 != null) {
        ((RelativeLayout.LayoutParams)localObject1).bottomMargin = this.jdField_a_of_type_Rau.b();
      }
      localObject1 = this.c;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)rao.a.a().a());
      }
      if (this.jdField_a_of_type_Rau.a() != 1) {
        break label615;
      }
      localObject1 = this.d;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)rao.a.a().b());
      }
      ...
      localObject1 = this.e;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)rao.a.a().c());
      }
      ...
      label266:
      if (!this.jdField_a_of_type_Rau.a()) {
        break label763;
      }
      localObject1 = this.c;
      if (localObject1 != null) {
        ((TextView)localObject1).setCompoundDrawablesWithIntrinsicBounds(2130849445, 0, 0, 0);
      }
      localObject1 = this.jdField_a_of_type_AndroidViewView;
      if (localObject1 != null) {
      ...
      if (localObject2 != null)
      {
        ...
        localObject1 = ((Resources)localObject1).getDrawable(2130849441);
        label352:
      ...
      if (localObject2 != null)
      {
        ...
        localObject1 = ((Resources)localObject1).getDrawable(2130849447);
        label433:
      ...
      if (localObject2 != null)
      {
        ...
        if (localObject4 != null)
        {
          ...
          localObject1 = localObject3;
          if (localObject4 != null) {
            localObject1 = ((Resources)localObject4).getDrawable(2130849443);
          }
        }
        ((TextView)localObject2).setBackgroundDrawable((Drawable)localObject1);
      }
      ...
      if (localObject1 != null)
      {
        localObject1 = ((View)localObject1).findViewById(2131371992);
        if (localObject1 != null) {
          if (!this.jdField_a_of_type_Rau.b()) {
            break label1060;
          }
        }
      }
    ...
    for (int i = 0;; i = 8)
    {
      ...
      break;
      label599:
      localObject1 = this.jdField_a_of_type_Rau.a();
      break label79;
      label610:
      localObject1 = null;
      break label106;
      label615:
      if (this.jdField_a_of_type_Rau.a() != 2) {
        break label266;
      }
      localObject1 = this.jdField_b_of_type_AndroidWidgetImageView;
      if (localObject1 != null) {
      ...
      localObject1 = this.d;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)rao.a.a().d());
      }
      localObject1 = this.jdField_a_of_type_AndroidWidgetTextView;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)rao.a.a().e());
      }
      localObject1 = this.jdField_b_of_type_AndroidWidgetTextView;
      if (localObject1 == null) {
        break label266;
      }
      ((TextView)localObject1).setText((CharSequence)rao.a.a().f());
      break label266;
      label748:
      localObject1 = null;
      break label352;
      ...
      localObject1 = this.c;
      if (localObject1 != null) {
        ((TextView)localObject1).setCompoundDrawablesWithIntrinsicBounds(2130849446, 0, 0, 0);
      }
      localObject1 = this.jdField_a_of_type_AndroidViewView;
      if (localObject1 != null) {
      ...
      if (localObject2 != null)
      {
        ...
        if (localObject1 != null)
        {
          ...
          if (localObject1 != null)
          {
            localObject1 = ((Resources)localObject1).getDrawable(2130849442);
            label839:
            ((ImageView)localObject2).setImageDrawable((Drawable)localObject1);
          }
        }
      ...
      for (localObject1 = ((Resources)localObject1).getDrawable(2130849437);; localObject1 = null)
      {
        ((TextView)localObject2).setBackgroundDrawable((Drawable)localObject1);
        localObject2 = this.jdField_a_of_type_AndroidWidgetTextView;
        if (localObject2 != null)
        {
          ...
          if (localObject3 != null)
          {
            ...
            localObject1 = localObject4;
            if (localObject3 != null) {
              localObject1 = ((Resources)localObject3).getDrawable(2130849438);
            }
          }
          ((TextView)localObject2).setBackgroundDrawable((Drawable)localObject1);
        }
  ...
  private final void c()
  {
    ...
    if (localObject != null) {
      ((TextView)localObject).setOnClickListener((View.OnClickListener)new rba(this));
    }
    localObject = this.jdField_b_of_type_AndroidWidgetTextView;
    if (localObject != null) {
      ((TextView)localObject).setOnClickListener((View.OnClickListener)new rbb(this));
    }
    localObject = this.jdField_b_of_type_AndroidWidgetImageView;
    if (localObject != null) {
      ((ImageView)localObject).setOnClickListener((View.OnClickListener)new rbc(this));
    }
    localObject = this.e;
    if (localObject != null) {
      ((TextView)localObject).setOnClickListener((View.OnClickListener)new rbd(this));
    }
    localObject = this.c;
    if (localObject != null) {
      ((TextView)localObject).setOnClickListener((View.OnClickListener)new rbe(this));
    }
  }
  ...
  public final void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed((Runnable)new RIJPushNotifyDialog.show.1(this), rao.a.a().a());
  }
