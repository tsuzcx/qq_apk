  ...
  implements baxa, INetEventHandler
{
  ...
  ajmm jdField_a_of_type_Ajmm = new axph(this);
  ...
  public axpg(axvo paramaxvo, axvt paramaxvt)
  {
    ...
    this.jdField_a_of_type_Bess = aucr.a();
  ...
  private axyq a()
  {
    ...
    localaxyq.jdField_e_of_type_JavaLangString = this.jdField_a_of_type_Axvt.jdField_d_of_type_JavaLangString;
    ...
    {
      localaxyq.jdField_c_of_type_Int = localMessageForPtt.voiceType;
      localaxyq.jdField_a_of_type_Int = localMessageForPtt.voiceLength;
      localaxyq.jdField_e_of_type_Int = localMessageForPtt.autoToText;
    }
  ...
  public static byte[] a(MessageForPtt paramMessageForPtt)
  {
    ...
    localReserveStruct.uint32_redpack_type.set(agwx.a(paramMessageForPtt));
    ...
    paramMessageForPtt = agwx.a(paramMessageForPtt);
  ...
  protected axro a(byte[] paramArrayOfByte)
  {
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 89	axpg:jdField_a_of_type_Axvt	Laxvt;
    //   6: iconst_1
    //   7: putfield 364	axvt:l	Z
    //   10: aload_0
    //   11: getfield 89	axpg:jdField_a_of_type_Axvt	Laxvt;
    //   14: getfield 124	axvt:jdField_a_of_type_ComTencentMobileqqDataMessageRecord	Lcom/tencent/mobileqq/data/MessageRecord;
    ...
    //   31: aload_0
    //   32: getfield 366	axpg:jdField_a_of_type_Boolean	Z
    //   35: ifne +18 -> 53
    //   38: aload_0
    //   39: invokespecial 368	axpg:d	()I
    //   42: ifne +8 -> 50
    //   45: aload_0
    //   46: iconst_0
    //   47: invokespecial 370	axpg:b	(Z)V
    //   50: aload_0
    //   51: monitorexit
    //   52: return
    //   53: aload_0
    //   54: invokespecial 368	axpg:d	()I
    //   57: ifne -7 -> 50
    //   60: aload_0
    //   61: iconst_1
    //   62: invokespecial 370	axpg:b	(Z)V
    //   65: goto -15 -> 50
    //   68: astore_1
    //   69: aload_0
    //   70: monitorexit
  ...
  {
    aucr.a(this.jdField_a_of_type_Bess);
    ...
    if (paramBoolean)
    {
      ...
      if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null)) {
        this.jdField_a_of_type_JavaUtilHashMap.put("param_pttOpt", String.valueOf(aucp.a((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get())));
      }
      ...
      axte.a(paramBoolean, this.jdField_a_of_type_Axvt.jdField_a_of_type_Int, l2, this.q);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Axvt.jdField_i_of_type_JavaLangString))
      {
        localObject1 = (MessageForPtt)this.jdField_a_of_type_Axvt.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
        localObject2 = this.jdField_a_of_type_Axvt.jdField_i_of_type_JavaLangString;
        ...
        l1 = 0L;
        label447:
        axte.a((String)localObject2, true, paramBoolean, i, l1);
      }
      if (!paramBoolean) {
        break label539;
      }
      awrn.a(BaseApplication.getContext()).a(null, b(), true, l2, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    for (;;)
    {
      b(paramBoolean, l2);
      ...
      awrn.a(BaseApplication.getContext()).a(null, b(), false, l2, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
  ...
  {
    super.aU_();
    if (!this.jdField_a_of_type_Axvt.l)
    {
  ...
  protected im_msg_body.RichText b()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Axvt.jdField_a_of_type_Int == 0)
      {
        ...
        ((im_msg_body.Ptt)localObject1).uint64_src_uin.set(Long.parseLong(this.jdField_a_of_type_Axvt.jdField_b_of_type_JavaLangString));
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          localObject2 = (axuh)this.jdField_a_of_type_JavaUtilArrayList.get(0);
          ((im_msg_body.Ptt)localObject1).uint32_server_ip.set(axqw.a(((axuh)localObject2).jdField_a_of_type_JavaLangString));
          ((im_msg_body.Ptt)localObject1).uint32_server_port.set(((axuh)localObject2).jdField_a_of_type_Int);
        }
        localObject2 = new im_msg_body.Elem();
        Object localObject3 = new im_msg_body.ElemFlags2();
        if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null))
        {
          i = awbk.a((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get(), ((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get()).getCurrentAccountUin());
        ...
        localObject3 = b((MessageForPtt)this.jdField_a_of_type_Axvt.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
      ...
      if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null))
      {
        ...
        i = awbk.a((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get(), (String)localObject2);
        ((im_msg_body.TmpPtt)localObject1).uint32_user_type.set(i);
      }
      ((im_msg_body.TmpPtt)localObject1).uint64_ptt_times.set(QQRecorder.a(this.jdField_a_of_type_Axvt.jdField_a_of_type_ComTencentMobileqqDataMessageRecord));
      if (this.jdField_a_of_type_Axvt.jdField_a_of_type_Int == 1008) {
        ((im_msg_body.TmpPtt)localObject1).uint32_busi_type.set(3);
      }
      Object localObject2 = a((MessageForPtt)this.jdField_a_of_type_Axvt.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
  ...
  void d()
  {
    ...
    if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null) && (this.jdField_a_of_type_Axvt.jdField_n_of_type_Boolean)) {
      audi.a((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(a());
    }
  }
  ...
  public void d(boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        localMessageRecord = ((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get()).a().a(this.jdField_a_of_type_Axvt.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Axvt.jdField_a_of_type_Int, this.jdField_a_of_type_Axvt.jdField_a_of_type_Long);
      ...
      if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null)) {
        ((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get()).a().a(this.jdField_a_of_type_Axvt.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Axvt.jdField_a_of_type_Int, localMessageRecord.uniseq, localMessageForPtt.msgData);
      }
    } while ((this.jdField_a_of_type_MqqUtilWeakReference == null) || (this.jdField_a_of_type_MqqUtilWeakReference.get() == null) || (localMessageRecord == null) || (!(localMessageRecord instanceof MessageForPtt)) || (!((axaf)((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get()).getManager(17)).b((MessageForPtt)localMessageRecord)));
    awqx.b(null, "dc00898", "", "", "0X8009DF6", "0X8009DF6", 0, 0, "", "", "", "");
    ((axac)((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get()).getManager(17)).a((MessageForPtt)localMessageRecord, 2);
  }
  ...
  void f()
  {
    ...
    do
    {
      ...
      if (localObject1 == null)
      {
        a(9360, "constructpberror", null, this.jdField_c_of_type_Axow);
        d();
        return;
      }
      if (this.jdField_a_of_type_Axvt.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) {
    ...
    if (agwx.a(localMessageRecord))
    {
      localObject2 = agwx.a();
      ajmm localajmm = this.jdField_a_of_type_Ajmm;
      byte[] arrayOfByte = this.jdField_a_of_type_ArrayOfByte;
      if (this.f == null) {}
      for (localObject1 = this.jdField_k_of_type_JavaLangString;; localObject1 = this.f)
      {
        ((agwx)localObject2).a(localMessageRecord, localajmm, 0L, arrayOfByte, (String)localObject1, this);
        return;
      }
    }
    ((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get()).a().b(localMessageRecord, this.jdField_a_of_type_Ajmm);
  }
  ...
  public void g()
  {
    ...
    do
    {
      ...
      try
      {
        localObject2 = localaxyq.jdField_d_of_type_JavaLangString;
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          {
            continue;
            localException.str_dst_phonenum.set(localaxyq.jdField_d_of_type_JavaLangString);
            i = 102;
            continue;
            i = 104;
            continue;
      ...
      ((cmd0x346.ExtensionReq)localObject1).uint32_ptt_format.set(localaxyq.jdField_c_of_type_Int);
      ((cmd0x346.ExtensionReq)localObject1).uint32_ptt_time.set(localaxyq.jdField_a_of_type_Int);
      j = axxs.a();
      ((cmd0x346.ExtensionReq)localObject1).uint32_net_type.set(j);
      ((cmd0x346.ExtensionReq)localObject1).uint32_voice_type.set(localaxyq.jdField_d_of_type_Int);
      if (QLog.isColorLevel())
      {
