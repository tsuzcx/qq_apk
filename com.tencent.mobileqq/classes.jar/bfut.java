...
public class bfut
{
  ...
  public bfut(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.b = paramInt1;
    this.c = paramInt2;
    this.d = paramInt3;
  ...
  public void a(Canvas paramCanvas, Paint paramPaint, bfuo parambfuo)
  {
    ...
    paramPaint.setColor(parambfuo.b);
    paramPaint.setStrokeWidth(parambfuo.e);
    paramCanvas.drawLine(this.b, this.d, this.c, this.d, paramPaint);
    parambfuo = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (parambfuo.hasNext())
    {
      Point localPoint = (Point)parambfuo.next();
