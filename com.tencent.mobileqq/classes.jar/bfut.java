  ...
  implements bfuv
{
  ...
  public bfut(JSONObject paramJSONObject)
  {
  ...
  public static JSONObject a(bfut parambfut)
  {
    JSONObject localJSONObject = new JSONObject().put("type", "recite").put("troop_uin", parambfut.jdField_f_of_type_JavaLangString).put("subtype", 1).put("title", parambfut.jdField_b_of_type_JavaLangString).put("desc", parambfut.c).put("kid", parambfut.jdField_a_of_type_JavaLangString).put("error_count", parambfut.jdField_d_of_type_Int).put("remind_count", parambfut.jdField_e_of_type_Int).put("waste_time", parambfut.jdField_a_of_type_Long).put("grade", parambfut.jdField_f_of_type_Int).put("lyric", parambfut.jdField_g_of_type_JavaLangString);
    if (!TextUtils.isEmpty(parambfut.jdField_e_of_type_JavaLangString)) {
      localJSONObject.put("file_url", parambfut.jdField_e_of_type_JavaLangString);
    }
    if (!TextUtils.isEmpty(parambfut.jdField_d_of_type_JavaLangString)) {
      localJSONObject.put("file_path", parambfut.jdField_d_of_type_JavaLangString);
    }
    if (parambfut.jdField_a_of_type_JavaUtilList != null) {
      localJSONObject.put("pid_list", new JSONArray(parambfut.jdField_a_of_type_JavaUtilList));
    }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder(anvx.a(2131705168)).append(paramString2);
    if ((paramList != null) && (!paramList.isEmpty())) {
      localStringBuilder.append(bftx.a(paramList));
    }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder(anvx.a(2131705170)).append(paramString2);
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    if (this.jdField_a_of_type_Bmjg != null)
    {
      ...
      this.jdField_a_of_type_Bmjg = null;
    }
