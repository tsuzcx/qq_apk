  ...
  implements View.OnClickListener, Observer
{
  ...
  public wzw(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, bado parambado, String paramString)
  {
    super(paramBaseActivity, 2131755791);
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_a_of_type_AndroidOsHandler = new wzy(this);
    ...
    if (((paramBaseActivity instanceof SplashActivity)) || ((paramBaseActivity instanceof ChatActivity)))
    {
      ...
      paramBaseActivity = (askq)paramQQAppInterface.getManager(37);
    }
    try
    {
      this.jdField_a_of_type_Azpa = paramBaseActivity.a(Long.valueOf(Long.parseLong(paramString)), true);
      this.jdField_b_of_type_JavaLangString = paramString;
      if (a()) {
        this.jdField_e_of_type_Boolean = true;
      }
      setOnDismissListener(new wzx(this));
  ...
  public static String a(long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    try
    {
      ...
      catch (Exception localException2)
      {
        ...
        paramLong = 1L;
        return paramLong + ajyc.a(2131715675);
        if (paramLong >= l3) {
          break label446;
        }
        ...
        return ajyc.a(2131715676) + " " + ((SimpleDateFormat)localObject4).format(localDate);
        return ajyc.a(2131715678);
        if (!paramBoolean3) {
          break label409;
        }
        return ajyc.a(2131715679) + ((SimpleDateFormat)localObject4).format(localDate);
        paramLong = ((float)paramLong / (float)l2 + 0.5D);
        return paramLong + ajyc.a(2131715677);
        ...
        return ajyc.a(2131715671) + " " + ((SimpleDateFormat)localObject4).format(localDate);
        return ajyc.a(2131715674);
        ...
        return ajyc.a(2131715672) + " " + ((SimpleDateFormat)localObject4).format(localDate);
        return ajyc.a(2131715682);
  ...
  private boolean a(JSONObject paramJSONObject, int paramInt)
  {
    ...
    while (this.jdField_a_of_type_Azpe == null)
    {
      dismiss();
      return false;
      label52:
      QLog.d("TroopTipsPopWindow", 2, "initNorNoticeView mTroopNotify" + this.jdField_a_of_type_Azpe.toString());
    }
    this.jdField_a_of_type_Azpe.jdField_a_of_type_Int = paramInt;
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Azpe.f)) {
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
    }
    this.jdField_b_of_type_AndroidWidgetTextView.setText(new ayki(Html.fromHtml(this.jdField_a_of_type_Azpe.jdField_c_of_type_JavaLangString), 8));
    this.jdField_e_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Azpe.jdField_b_of_type_Int + ajyc.a(2131715673));
    this.jdField_d_of_type_AndroidWidgetTextView.setText(a(this.jdField_a_of_type_Azpe.jdField_a_of_type_Long));
    this.jdField_a_of_type_Boolean = this.jdField_a_of_type_Azpe.jdField_a_of_type_Boolean;
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_b_of_type_AndroidWidgetButton.setVisibility(0);
      this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_bulletin", "", "grp_card", "exp", 0, 0, this.jdField_b_of_type_JavaLangString, "", "", "");
      if (this.jdField_a_of_type_Azpe.jdField_c_of_type_Boolean)
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131697884);
        this.jdField_a_of_type_AndroidWidgetButton.setText(2131697873);
        this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131697873));
      }
      this.jdField_d_of_type_AndroidWidgetTextView.getViewTreeObserver().addOnGlobalLayoutListener(new xaa(this));
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Azpe.d)) {
        c(this.jdField_a_of_type_Azpe.d);
      }
      if (AppSetting.d) {
        this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131697882, new Object[] { Html.fromHtml(this.jdField_a_of_type_Azpe.jdField_b_of_type_JavaLangString).toString(), this.jdField_a_of_type_Azpe.h, a(this.jdField_a_of_type_Azpe.jdField_a_of_type_Long, true, true, false), Html.fromHtml(this.jdField_a_of_type_Azpe.jdField_c_of_type_JavaLangString).toString() });
      }
      if ((this.jdField_a_of_type_Azpa == null) || (this.jdField_a_of_type_Azpa.jdField_a_of_type_Int != 1)) {
        break label469;
      }
      b();
    }
  ...
  private void c(String paramString)
  {
    ...
    j = (int)(localDisplayMetrics.widthPixels - bbdh.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 60.0F));
    int k = (int)bbdh.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 150.0F);
    ...
    catch (MalformedURLException localMalformedURLException)
    {
      for (;;)
      {
        ...
        j = (int)(f1 / f2 * f3);
        continue;
        paramString.setURLDrawableListener(new xab(this, localDisplayMetrics));
        continue;
        j = 0;
      }
    }
    ...
    if (paramString.getStatus() == 1)
    {
      ...
      if (f1 > bbdh.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 150.0F))
      {
        j = (int)bbdh.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 150.0F);
        if (j > 0)
        {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131697877));
        return;
      }
    }
  }
  ...
  void a()
  {
    ...
    ((ViewGroup.LayoutParams)localObject2).width = ((int)(((DisplayMetrics)localObject1).widthPixels - bbdh.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 30.0F)));
    ...
    int j = (int)bbdh.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 10.0F);
    ((WindowManager.LayoutParams)localObject2).width = ((int)(((DisplayMetrics)localObject1).widthPixels - bbdh.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 30.0F)));
    this.jdField_a_of_type_AndroidViewView.getViewTreeObserver().addOnGlobalLayoutListener(new xac(this, j));
    if ((!this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.isFinishing()) && (!this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.D())) {
      super.show();
    }
    a("exp_bulletin");
    if (this.jdField_a_of_type_Azpe.jdField_a_of_type_Int == 2) {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_bulletin", "", "AIOchat", "notice_exp", 0, 0, this.jdField_b_of_type_JavaLangString, "", "", "");
    }
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Azpe.f)) {
      a("exp_vid");
    }
    for (;;)
    {
      try
      {
        localObject1 = (ayki)this.jdField_b_of_type_AndroidWidgetTextView.getText();
        localObject1 = (aykq[])((ayki)localObject1).getSpans(0, ((ayki)localObject1).length(), aykq.class);
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (this.f) {
            bbbb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_JavaLangString, "Grp_notice", "AioNotice_Show", 0, 0, new String[] { this.jdField_b_of_type_JavaLangString, "", "", "" });
          }
          switch (paramInt)
          {
          default: 
        ...
        } while (this.jdField_a_of_type_Azpa == null);
        localbalp = balq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_JavaLangString);
      } while (localbalp == null);
      if (localbalp.jdField_a_of_type_Int != 1) {
        break;
      }
      if (QLog.isColorLevel()) {
        QLog.d("TroopTipsPopWindow", 2, "show. TYPE_TROOP_NOTICE, type = 1");
      }
      this.jdField_a_of_type_Azpa.a(1007, localbalp.jdField_a_of_type_JavaLangString);
      return;
    } while (this.jdField_a_of_type_Azpa == null);
    if (QLog.isColorLevel()) {
      QLog.d("TroopTipsPopWindow", 2, "show. GET_NEW_GUIDE_NOTICE_REQUEST_CODE");
    }
    this.jdField_a_of_type_Azpa.b(1003);
    return;
    if (localbalp.jdField_a_of_type_Int == 2)
    {
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Azpa.b(1004);
  }
  ...
  public void a(azpf paramazpf)
  {
    if ((paramazpf != null) && (!TextUtils.isEmpty(paramazpf.jdField_c_of_type_JavaLangString)) && (!TextUtils.isEmpty(paramazpf.jdField_b_of_type_JavaLangString)))
    {
      ...
      localObject = URLDrawable.getDrawable(paramazpf.jdField_c_of_type_JavaLangString, (URLDrawable.URLDrawableOptions)localObject);
      this.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable((Drawable)localObject);
      this.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(new xad(this));
      this.jdField_a_of_type_ComTencentImageURLImageView.setOnClickListener(new xae(this, paramazpf));
      return;
    }
  ...
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_bulletin", "", "bulletin_popUp", paramString, 0, 0, this.jdField_b_of_type_JavaLangString, "" + this.jdField_a_of_type_Azpe.jdField_a_of_type_Int, "", "");
  }
  ...
  public boolean a()
  {
    long l = (bbct.d() * 3L + bbct.e() * 7L) / 10L;
    if (l < 3136512L)
    {
      hide();
    ...
    try
    {
      ...
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131364709);
      this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131377400);
      this.jdField_d_of_type_AndroidViewView.setOnClickListener(this);
      this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView = ((BounceScrollView)this.jdField_a_of_type_AndroidViewView.findViewById(2131375652));
      if (Build.VERSION.SDK_INT > 8) {
        this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView.setOverScrollMode(2);
      }
      this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView.setOnScrollChangedListener(new wzz(this));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370942));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131364269));
      this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131370354));
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setEditableFactory(ayks.a);
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131697881));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379031));
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131367983);
      this.jdField_e_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131377867);
      this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_e_of_type_AndroidViewView.findViewById(2131377866));
  ...
  public void b()
  {
    azpa.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, new xaf(this));
  }
  ...
  public void dismiss()
  {
    ...
    if (localbagr != null) {}
    for (boolean bool = localbagr.a(this.jdField_b_of_type_JavaLangString);; bool = false)
    {
  ...
  public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent paramAccessibilityEvent)
  {
    ...
    {
      bawi.a(this.jdField_a_of_type_AndroidViewView, this.jdField_a_of_type_JavaLangString);
      this.i = true;
    }
    return true;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (Object localObject1 = "" + ((TroopInfo)localObject1).dwGroupClassExt;; localObject1 = "")
    {
      ...
      ((Intent)localObject2).putExtra("title", getContext().getResources().getString(2131697815));
      ...
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_bulletin", "", "grp_card", "clk", 0, 0, this.jdField_b_of_type_JavaLangString, "", "", "");
      paramView = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      localObject2 = this.jdField_b_of_type_JavaLangString;
      if (this.jdField_a_of_type_Azpe.jdField_c_of_type_Boolean) {}
      for (int j = 2;; j = 1)
      {
        axqw.b(paramView, "dc00898", "", "", "0X800AACA", "0X800AACA", 0, 0, (String)localObject2, (String)localObject1, String.valueOf(j), "");
        dismiss();
        return;
      }
      ...
      ((Intent)localObject2).putExtra("url", "http://web.qun.qq.com/mannounce/detail.html?_bid=148&_wv=1031#fid=" + this.jdField_a_of_type_Azpe.i + "&gc=" + this.jdField_b_of_type_JavaLangString);
      ...
      if (this.jdField_a_of_type_Azpe.jdField_c_of_type_Boolean)
      {
        ...
        if (this.g)
        {
          j = 2;
          label599:
          axqw.b((QQAppInterface)localObject1, "dc00898", "", "", "0X800AAC9", "0X800AAC9", 0, 0, (String)localObject2, paramView, "", String.valueOf(j));
        }
      }
      for (;;)
      {
        ...
        j = 1;
        break label599;
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AAC8", "0X800AAC8", 0, 0, this.jdField_b_of_type_JavaLangString, paramView, "", "");
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Azpe.f))
      {
        paramView = new Intent(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, QQBrowserActivity.class);
        paramView.putExtra("url", this.jdField_a_of_type_Azpe.f);
        paramView.putExtra("webStyle", "noBottomBar");
        this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.startActivity(paramView);
        a("clk_vid");
        return;
      }
      if (TextUtils.isEmpty(this.jdField_a_of_type_Azpe.e)) {
        break;
      }
      localObject2 = new ArrayList();
      localObject1 = this.jdField_a_of_type_Azpe.e;
      try
      {
      ...
      badh.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 0, (ArrayList)localObject2, true, "", -1);
      a("clk_pic");
      return;
    }
  }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            if (this.jdField_a_of_type_Azpa.jdField_a_of_type_OrgJsonJSONObject != null)
            {
              a(this.jdField_a_of_type_Azpa.jdField_a_of_type_OrgJsonJSONObject, 2, false);
              return;
            }
          } while (!QLog.isColorLevel());
          ...
          {
            a(this.jdField_a_of_type_Azpa.b, 1, false);
            return;
          }
        } while (!QLog.isColorLevel());
        ...
        if (this.jdField_a_of_type_Azpa.b != null)
        {
          a(this.jdField_a_of_type_Azpa.b, 1, true);
          return;
        }
      } while (!QLog.isColorLevel());
      QLog.d("TroopTipsPopWindow", 2, "mNewNorNotice = null!");
    ...
    balq.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_JavaLangString);
  }
}
