...
public class aewt
{
  private static aewt jdField_a_of_type_Aewt;
  ...
  private Map<Integer, aewu> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  private int a(int paramInt, boolean paramBoolean)
  {
    ...
    aewu localaewu = (aewu)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    if (localaewu != null)
    {
      Object localObject = localaewu.jdField_a_of_type_JavaLangRefWeakReference;
      if (localObject != null)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            if ((!((DoodleMsgLayout)localObject).b()) && (this.jdField_a_of_type_Long != localaewu.jdField_b_of_type_Long) && (((DoodleMsgLayout)localObject).a()))
            {
              if (paramBoolean)
              {
                a((DoodleMsgLayout)localObject, false);
                if (localaewu.jdField_b_of_type_Long == this.jdField_c_of_type_Long) {
            ...
            if (QLog.isColorLevel()) {
              QLog.d(jdField_a_of_type_JavaLangString, 2, "checkPlayable: can not play:" + localaewu.jdField_a_of_type_Long + "uniID:" + localaewu.jdField_b_of_type_Long + " mPlayedID:" + this.jdField_a_of_type_Long);
            }
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_a_of_type_JavaLangString, 2, "checkPlayable: invisible MsgID:" + localaewu.jdField_a_of_type_Long + "uniID:" + localaewu.jdField_b_of_type_Long);
          }
        }
      }
    }
  ...
  public static aewt a()
  {
    try
    {
      if (jdField_a_of_type_Aewt == null) {
        jdField_a_of_type_Aewt = new aewt();
      }
      return jdField_a_of_type_Aewt;
    }
    finally {}
  }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        aewu localaewu = (aewu)((Map.Entry)localIterator.next()).getValue();
        if ((localaewu == null) || (localaewu.jdField_a_of_type_Int < paramInt1) || (localaewu.jdField_a_of_type_Int > paramInt2)) {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        Object localObject = (aewu)localIterator.next();
        if ((localObject != null) && (((aewu)localObject).jdField_a_of_type_Int >= this.d) && (((aewu)localObject).jdField_a_of_type_Int <= this.e))
        {
          localObject = ((aewu)localObject).jdField_a_of_type_JavaLangRefWeakReference;
          if (localObject != null)
          {
            localObject = (DoodleMsgLayout)((WeakReference)localObject).get();
            if (localObject != null) {
  ...
  private void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      do
      {
        do
        {
          ...
          aewu localaewu = (aewu)((Iterator)localObject).next();
          if (localaewu.jdField_b_of_type_Long != this.jdField_c_of_type_Long) {
            break;
          }
          localObject = localaewu.jdField_a_of_type_JavaLangRefWeakReference;
    ...
    for (;;)
    {
      ...
      break;
      label135:
      localObject = (aewu)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(i));
      if ((localObject != null) && ((((aewu)localObject).jdField_a_of_type_Long > this.jdField_b_of_type_Long) || (((aewu)localObject).jdField_b_of_type_Long == this.jdField_c_of_type_Long)))
      {
        localObject = ((aewu)localObject).jdField_a_of_type_JavaLangRefWeakReference;
        if (localObject != null)
        {
  ...
  public static void b()
  {
    try
    {
      if (jdField_a_of_type_Aewt != null)
      {
        jdField_a_of_type_Aewt.a();
        jdField_a_of_type_Aewt = null;
      }
      return;
    }
    finally {}
  ...
  public void a(long paramLong1, long paramLong2, int paramInt, DoodleMsgLayout paramDoodleMsgLayout)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), new aewu(this, paramLong1, paramLong2, paramInt, paramDoodleMsgLayout));
    boolean bool;
    if (this.jdField_a_of_type_Int != 0)
    {
      bool = true;
  ...
  public void a(DoodleMsgLayout paramDoodleMsgLayout, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          aewu localaewu = (aewu)((Iterator)localObject).next();
          if ((localaewu.jdField_a_of_type_JavaLangRefWeakReference != null) && (localaewu.jdField_a_of_type_JavaLangRefWeakReference.get() == paramDoodleMsgLayout))
          {
            this.jdField_a_of_type_Long = localaewu.jdField_b_of_type_Long;
            if (QLog.isColorLevel()) {
