  ...
  extends xeh
{
  ...
  public xdw(DoodleView paramDoodleView)
  {
  ...
  private void b()
  {
    ...
    if (bnle.b()) {
      this.jdField_c_of_type_Int = bnle.jdField_a_of_type_Int;
    }
    this.d = localDisplayMetrics.heightPixels;
    if (bnle.b()) {
      this.d = (localDisplayMetrics.heightPixels - bnle.e);
    }
    ...
    this.jdField_a_of_type_Xip.b(0.5F);
  }
