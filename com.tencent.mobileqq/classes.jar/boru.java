  ...
  extends botu
{
  ...
  public boru(@NonNull botw parambotw)
  {
    super(parambotw);
  }
  ...
  public Bitmap a(String paramString)
  {
    ...
    DisplayMetrics localDisplayMetrics = this.jdField_a_of_type_Bouo.getActivity().getResources().getDisplayMetrics();
    ...
    try
    {
      localObject = bheg.a(paramString, (BitmapFactory.Options)localObject);
      if (localObject == null)
      {
    ...
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      ...
      for (;;)
      {
        ykq.e("EditJumpToPtu", "decodeoom");
        localBitmap = null;
      }
      ykq.b("EditJumpToPtu", "sampleSize" + i + " w " + localBitmap.getWidth() + " h " + localBitmap.getHeight());
      ...
      if (i != 0)
      {
        ...
        if (i % 90 == 0)
        {
          ykq.b("EditJumpToPtu", "has exif rotate" + i);
      ...
      this.jdField_a_of_type_Borv.obtainMessage(2, paramString).sendToTarget();
    }
    return paramString;
  }
  ...
  {
    super.a();
    this.jdField_a_of_type_Borv = new borv(this);
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (!botw.a(this.jdField_a_of_type_Botw.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.c, 131072)) {
    ...
    if (paramInt1 == 100)
    {
      ...
      localObject = this.jdField_a_of_type_Botw.a().getActivity();
      if (localObject != null) {}
    }
    else
    {
    ...
    ((bohj)bogd.a(5)).a[a()].c((Activity)localObject);
    if (this.jdField_a_of_type_Botw.jdField_a_of_type_AndroidOsBundle != null) {
      this.jdField_a_of_type_Botw.jdField_a_of_type_AndroidOsBundle.clear();
    }
    for (;;)
    {
      try
      {
        ...
        ykq.b("EditJumpToPtu", "onActivityResult PI_TU, new path " + paramIntent);
      ...
      label205:
      ykq.b("EditJumpToPtu", "onActivityResult cancel ");
    }
  }
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    ykw.b("0X80080E2", ykw.a);
    if (a(this.jdField_a_of_type_Bouo.a()))
    {
      ThreadManager.post(new EditJumpToPtu.1(this), 5, null, true);
      a(anvx.a(2131703120));
      return;
    }
    ykw.b("0X80080E4", ykw.a);
    ...
    this.jdField_a_of_type_Bouo.getActivity().startActivityForResult(localIntent, 101);
  }
  
  void a(String paramString)
  {
    if (this.jdField_a_of_type_Bisl == null) {
      this.jdField_a_of_type_Bisl = new bisl(a(), a().getDimensionPixelSize(2131299080));
    }
  ...
  {
    if (bkyz.a(paramContext, "com.tencent.ttpic")) {
      try
      {
        int i = bkyz.a(paramContext, "com.tencent.ttpic");
        if (i >= 490) {
          return true;
        }
      }
  ...
  {
    DoodleLayout localDoodleLayout = this.jdField_a_of_type_Botw.jdField_a_of_type_Botf.a();
    if (localDoodleLayout != null)
    {
      Bitmap localBitmap3 = localDoodleLayout.a(0, false);
      Bitmap localBitmap2 = this.jdField_a_of_type_Botw.a();
      ...
      {
        localBitmap1 = zdr.c(localBitmap2, localBitmap3);
        localDoodleLayout.a(localBitmap3);
      }
      return zdr.a(localBitmap1, paramString);
    }
    return false;
  }
