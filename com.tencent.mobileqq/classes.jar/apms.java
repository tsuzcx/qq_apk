...
public class apms
{
  ...
  apms(QQAppInterface paramQQAppInterface)
  {
  ...
  public static String a()
  {
    ...
    Iterator localIterator = ((aqnh)localObject1).a.iterator();
    while (localIterator.hasNext())
    {
      Object localObject2 = (aqnr)localIterator.next();
      if (localObject2 != null)
      {
        aqnq localaqnq = ((aqnr)localObject2).jdField_a_of_type_Aqnq;
        if (localaqnq != null)
        {
          localObject2 = ((aqnr)localObject2).jdField_a_of_type_Aqnt;
          if ((localObject2 != null) && (a(localaqnq)))
          {
            localObject2 = b((aqnt)localObject2);
            if (localObject2 != null)
            {
              ArkAppCenter.c("ArkApp.Dict.Update", String.format("getEffectDictIdentifier, use condition dict, dict-id=%s, condition=%s", new Object[] { localObject2, localaqnq.toString() }));
              return localObject2;
            }
          }
        }
    ...
    localObject1 = b((aqnt)localObject1);
  ...
  {
    return apmp.a(paramString) + "/WordData";
  }
  ...
  private static Map<String, apnc> a(aqnt paramaqnt)
  {
    if (paramaqnt == null) {
      return new HashMap();
    }
    Object localObject = paramaqnt.jdField_b_of_type_JavaUtilArrayList;
    if (localObject == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "getDictInfoFromConfig, 'word_dict_list' field not found");
      return new HashMap();
    }
    paramaqnt = new HashMap();
    localObject = ((ArrayList)localObject).iterator();
    while (((Iterator)localObject).hasNext())
    {
      apnc localapnc = (apnc)((Iterator)localObject).next();
      if (localapnc != null) {
        paramaqnt.put(localapnc.a, localapnc);
      }
    }
    return paramaqnt;
  }
  
  private void a(aqnt paramaqnt1, aqnt paramaqnt2, apne paramapne)
  {
    if (paramaqnt2 == null)
    {
    ...
    for (;;)
    {
      ...
      Object localObject = a(paramaqnt2);
      ...
      paramaqnt2 = b(paramaqnt1);
      paramaqnt1 = a(paramaqnt1);
      apng localapng = new apng(null);
      localapng.jdField_a_of_type_Int = ((Map)localObject).size();
      localapng.jdField_a_of_type_Boolean = true;
      localObject = ((Map)localObject).values().iterator();
      while (((Iterator)localObject).hasNext())
      {
        apnc localapnc = (apnc)((Iterator)localObject).next();
        a(str2, paramaqnt2, (apnc)paramaqnt1.get(localapnc.a), localapnc, new apmu(this, localapng, localapnc, str2, paramapne, str1));
      }
    }
  }
  
  private void a(String paramString, apnc paramapnc, apne paramapne)
  {
    a(paramapnc.a, paramapnc.jdField_b_of_type_JavaLangString, new apmz(this, paramapnc, paramString, paramapne));
  }
  
  private void a(String paramString1, String paramString2, apnc paramapnc1, apnc paramapnc2, apne paramapne)
  {
    boolean bool = false;
    if (!a(paramString2, paramapnc1)) {
      paramapnc1 = null;
    }
    for (;;)
    {
      if (paramapnc1 == null)
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, local not exists, full update, name=%s", new Object[] { paramapnc2.a }));
        a(paramString1, paramapnc2, new apmv(this, paramapnc2, paramapne));
        return;
      }
      if (paramapnc1.d.equals(paramapnc2.d))
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, file not change, copy from origin, name=%s", new Object[] { paramapnc2.a }));
        paramString2 = b(paramString2, paramapnc1.a);
        paramString1 = String.format("%s/%s", new Object[] { paramString1, paramapnc2.a });
        if (bgmg.d(paramString2, paramString1)) {
          break label281;
        }
      ...
      for (;;)
      {
        paramapne.a(bool);
        return;
        if ((paramapnc2.b()) && (paramapnc1.d.equals(paramapnc2.g)))
        {
          ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, incremental update, name=%s", new Object[] { paramapnc2.a }));
          b(paramString1, paramString2, paramapnc1, paramapnc2, new apmw(this, paramapnc2, paramapne, paramString1));
          return;
        }
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("updateDict, full update, name=%s", new Object[] { paramapnc2.a }));
        a(paramString1, paramapnc2, new apmy(this, paramapne));
        return;
        label281:
        bool = true;
      }
  ...
  private void a(String paramString1, String paramString2, apnd paramapnd)
  {
    apnf localapnf = new apnf(null);
    ...
    beaw localbeaw = (beaw)localQQAppInterface.getManager(193);
    localapnf.jdField_a_of_type_JavaLangRefWeakReference = new java.lang.ref.WeakReference(localbeaw);
    paramapnd = new ArkAiDictUpdateMgr.8(this, paramString2, localapnf, paramapnd);
    if (localQQAppInterface == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "downloadDictFile, qq app interface is null, return");
      return;
    }
    localapnf.jdField_a_of_type_Boolean = localbeaw.a();
    if (localapnf.jdField_a_of_type_Boolean)
    {
      localbeaw.a(10022, "prd", paramString1, 0, paramString2, "", 1, 0, false, new beax(localQQAppInterface, paramString1, paramapnd, 10000L));
      return;
    }
    paramapnd.run();
  ...
  private static boolean a(aqnq paramaqnq)
  {
    if (paramaqnq == null) {}
    for (;;)
    {
      return false;
      paramaqnq = paramaqnq.a;
      String[] arrayOfString = paramaqnq.split("-");
      if (arrayOfString.length == 2) {
        ...
        {
          ArkAppCenter.c("ArkApp.Dict.Update", String.format(Locale.CHINA, "isDictConditionEffect, invalid date, date=%s", new Object[] { paramaqnq }));
        }
      }
    }
    return false;
  ...
  private boolean a(aqnt paramaqnt)
  {
    if (paramaqnt == null)
    {
    ...
    String str = b(paramaqnt);
    paramaqnt = a(paramaqnt);
    if (paramaqnt == null)
    {
      ArkAppCenter.c("ArkApp.Dict.Update", "checkLocalDictIntegrity, local dict list is empty");
      return true;
    }
    Iterator localIterator = paramaqnt.values().iterator();
    do
    {
      if (!localIterator.hasNext()) {
        break;
      }
    } while (a(str, (apnc)localIterator.next()));
    for (int i = 1;; i = 0)
    {
      if (i == 0)
      {
      ...
      ArkAppCenter.c("ArkApp.Dict.Update", String.format(Locale.CHINA, "checkLocalDictIntegrity, %d of %d files need update", new Object[] { Integer.valueOf(i), Integer.valueOf(paramaqnt.size()) }));
      return false;
    }
  }
  
  private static boolean a(String paramString, apnc paramapnc)
  {
    if (paramapnc == null) {}
    while (!b(b(paramString, paramapnc.a), paramapnc.d)) {
      return false;
    }
    return true;
  }
  ...
  private static String b(aqnt paramaqnt)
  {
    if (paramaqnt == null) {}
    String str;
    do
    {
      return null;
      str = paramaqnt.c;
      paramaqnt = paramaqnt.jdField_b_of_type_JavaLangString;
    } while ((TextUtils.isEmpty(str)) || (TextUtils.isEmpty(paramaqnt)));
    return String.format("%s-%s", new Object[] { str, paramaqnt });
  }
  ...
  private static Map<String, aqnt> b(aqnh paramaqnh)
  {
    ...
    Object localObject1 = b(paramaqnh);
    if (localObject1 != null) {
      localHashMap.put(localObject1, paramaqnh);
    }
    paramaqnh = paramaqnh.a.iterator();
    while (paramaqnh.hasNext())
    {
      Object localObject2 = (aqnr)paramaqnh.next();
      if (localObject2 != null)
      {
        localObject1 = ((aqnr)localObject2).jdField_a_of_type_Aqnq;
        localObject2 = ((aqnr)localObject2).jdField_a_of_type_Aqnt;
        if ((localObject1 != null) && (localObject2 != null))
        {
          localObject1 = b((aqnt)localObject2);
          if (localObject1 != null) {
  ...
  private void b(String paramString1, String paramString2, apnc paramapnc1, apnc paramapnc2, apne paramapne)
  {
    a(paramapnc2.a, paramapnc2.e, new apna(this, paramapnc2, paramString2, paramapnc1, paramString1, paramapne));
  }
  
  private static boolean b(aqnt paramaqnt)
  {
    if (paramaqnt == null) {
      return false;
    }
    paramaqnt = paramaqnt.e;
    if ((TextUtils.isEmpty(paramaqnt)) || (paramaqnt.equalsIgnoreCase("wifi")))
    {
      if ((AppNetConnInfo.isNetSupport()) && (AppNetConnInfo.isWifiConn()))
      {
        ArkAppCenter.c("ArkApp.Dict.Update", String.format("getNetType, invalid dict info, netType=%s", new Object[] { paramaqnt }));
        return true;
      }
  ...
  private static boolean b(String paramString1, String paramString2)
  {
    ...
    //   80: invokestatic 521	apms:a	([B)Ljava/lang/String;
    //   83: aload_1
  ...
  private static aqnh c()
  {
    ...
    try
    {
      localObject = (aqnh)aqlu.a(localObject, aqnh.class);
      return localObject;
    }
  ...
  private static void c(aqnh paramaqnh)
  {
    if (paramaqnh == null)
    {
  ...
  private static aqnh d()
  {
    aqmq localaqmq = aqmv.b(170).a();
    if (localaqmq == null)
    {
  ...
  private static void d(aqnh paramaqnh)
  {
    if (paramaqnh == null) {
