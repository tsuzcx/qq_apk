...
class ajbt
  implements aabi
{
  ajbt(ajbo paramajbo, String paramString, long paramLong) {}
  ...
  public void onSuccess(JSONObject paramJSONObject)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject1 = ajac.a(ajbo.a(this.jdField_a_of_type_Ajbo));
          if (localObject1 == null)
          {
            QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[getUserInfo], launcher is null, mGameId:" + ajbo.a(this.jdField_a_of_type_Ajbo));
            return;
          }
          localObject1 = ((ajcf)localObject1).a();
          localObject2 = new aiyo(paramJSONObject.optString("avatarUrl"), paramJSONObject.optString("nickName"), ((CmGameInitParams)localObject1).openId);
          ajbo.a(this.jdField_a_of_type_Ajbo).put(((CmGameInitParams)localObject1).openId, localObject2);
      ...
      if ("cs.get_app_friends.local".equals(this.jdField_a_of_type_JavaLangString))
      {
        ...
        if ((paramJSONObject != null) && (paramJSONObject.length() != 0))
        {
          ...
          while (i < j)
          {
            ...
            localObject3 = new aiyo(((JSONObject)localObject2).optString("avatarUrl"), ((JSONObject)localObject2).optString("nickName"), (String)localObject3);
            ajbo.a(this.jdField_a_of_type_Ajbo).put(((JSONObject)localObject2).optString("openid"), localObject3);
