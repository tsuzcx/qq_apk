...
public class atwj
{
  ...
  public static String a(long paramLong)
  {
    ...
    if (l2 < 600000L) {
      return ajyc.a(2131707219);
    }
    if (l2 < 3600000L) {
      return l2 / 60L / 1000L + 1L + ajyc.a(2131707212);
    }
    if ((l2 < 21600000L) && (k == i)) {
      return l2 / 60L / 60L / 1000L + ajyc.a(2131707206);
    }
    if ((l2 < 86400000L) && (k == i))
    {
    ...
    {
      localSimpleDateFormat.applyPattern("HH:mm");
      return ajyc.a(2131707217) + localSimpleDateFormat.format(localCalendar.getTime());
    }
    if (m == j)
    {
