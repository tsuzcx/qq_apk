  ...
  extends rxy
{
  ...
  public ViewGroup j;
  TextView j;
  ViewGroup jdField_k_of_type_AndroidViewViewGroup;
  TextView jdField_k_of_type_AndroidWidgetTextView;
  ViewGroup l;
  
  public rxv(View paramView)
  {
    super(paramView, 2);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsGradientMaskView = ((VideoFeedsGradientMaskView)paramView.findViewById(2131368643));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsTopicViewGroup = ((VideoFeedsTopicViewGroup)paramView.findViewById(2131380735));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367891));
    this.jdField_b_of_type_AndroidViewView = VideoFeedsAccessibilityHelper.a(paramView);
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131363223));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380730));
    this.f = ((ImageView)paramView.findViewById(2131370303));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramView.findViewById(2131367886));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131380659);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRedpacketWidgetRIJRedPacketPopupView = ((RIJRedPacketPopupView)paramView.findViewById(2131380656));
    this.i = ((ViewGroup)paramView.findViewById(2131380632));
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)paramView.findViewById(2131380671));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367887));
    if (Aladdin.getConfig(327).getIntegerFromString("is_show_your_follow", 0) == 1) {
      this.k = ((TextView)paramView.findViewById(2131380666));
    }
