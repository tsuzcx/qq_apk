...
public class bbln
  implements Manager
{
  public final SparseArray<bble> a;
  public QQAppInterface a;
  protected final List<String> a;
  protected final Map<String, bbld> a;
  protected boolean a;
  public final SparseArray<TroopAioKeywordTipInfo> b;
  public final List<String> b;
  protected boolean b;
  
  public bbln(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<Integer> a(MessageRecord arg1)
  {
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject1)) {
      ...
      {
        localObject1 = (bbld)this.jdField_a_of_type_JavaUtilMap.get(localObject1);
        if (localObject1 != null)
        {
          localObject1 = ((bbld)localObject1).jdField_a_of_type_JavaUtilList;
          return localObject1;
        }
      }
    }
  ...
  private void a(MessageRecord paramMessageRecord, TroopAioKeywordTipInfo paramTroopAioKeywordTipInfo, bblq parambblq)
  {
    if (parambblq != null) {
      ThreadManager.getUIHandler().post(new TroopAioKeywordTipManager.5(this, parambblq, paramMessageRecord, paramTroopAioKeywordTipInfo));
    }
  }
  
  private void a(Integer paramInteger, MessageRecord paramMessageRecord, bblq parambblq)
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(paramInteger);
    ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(localArrayList, new bblp(this, paramMessageRecord, parambblq));
  }
  ...
  private boolean a(Integer paramInteger, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    {
      localObject1 = (bble)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInteger.intValue());
      if (localObject1 == null) {
        return false;
      }
    }
    synchronized (this.jdField_b_of_type_JavaUtilList)
    {
      ...
      {
        this.jdField_b_of_type_JavaUtilList.addAll(bblc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      ...
      if ((((bble)localObject1).b > NetConnInfoCenter.getServerTime()) || (((bble)localObject1).c < NetConnInfoCenter.getServerTime()))
      {
        if (QLog.isColorLevel()) {
          QLog.i("TroopAioKeywordTipManager", 2, "isSupportedRuleId, not support timelimit, currentTime=" + NetConnInfoCenter.getServerTime() + ",ruleInfo.startTime =" + ((bble)localObject1).b + ",ruleInfo.endTime=" + ((bble)localObject1).c);
        }
        return false;
      }
    }
    if ((((bble)localObject1).d & paramInt) == 0)
    {
      if (QLog.isColorLevel()) {
        QLog.i("TroopAioKeywordTipManager", 2, "isSupportedRuleId, not support positionFlag, ruleInfo.positionFlag=" + ((bble)localObject1).d + ", curInvokeType=" + paramInt);
      }
      return false;
    }
    if ((((bble)localObject1).jdField_a_of_type_JavaUtilList != null) && (((bble)localObject1).jdField_a_of_type_JavaUtilList.size() > 0))
    {
      if (QLog.isColorLevel()) {
      ...
      if (!((bble)localObject1).jdField_a_of_type_JavaUtilList.contains(Integer.valueOf((int)paramInteger.dwGroupClassExt)))
      {
        if (QLog.isColorLevel())
        {
          paramMessageRecord = new StringBuilder();
          paramMessageRecord.append("[");
          localObject1 = ((bble)localObject1).jdField_a_of_type_JavaUtilList.iterator();
  ...
  public void a()
  {
    try
    {
      ...
      {
        oidb_0x496.AioKeyword localAioKeyword = bblc.a();
        a(bblc.a(localAioKeyword), bblc.b(localAioKeyword));
      }
      return;
    }
    finally
  ...
  public void a(List<bbld> arg1, List<bble> paramList1)
  {
    if (??? != null)
    {
      Object localObject2;
      try
      {
        synchronized (this.jdField_a_of_type_JavaUtilList)
        {
          ...
          {
            bbld localbbld = (bbld)((Iterator)localObject2).next();
            this.jdField_a_of_type_JavaUtilList.add(localbbld.jdField_a_of_type_JavaLangString.toLowerCase());
          }
        }
      }
      finally {}
      synchronized (this.jdField_a_of_type_JavaUtilMap)
      {
        ...
        if (???.hasNext())
        {
          localObject2 = (bbld)???.next();
          this.jdField_a_of_type_JavaUtilMap.put(((bbld)localObject2).jdField_a_of_type_JavaLangString.toLowerCase(), localObject2);
        }
      }
    }
    if (paramList1 != null) {
      synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
      {
        ...
        {
          ??? = (bble)paramList1.next();
          this.jdField_a_of_type_AndroidUtilSparseArray.put(((bble)???).jdField_a_of_type_Int, ???);
        }
      }
    }
  ...
  public void a(List<MessageRecord> paramList, List<String> paramList1, int paramInt, bblq parambblq)
  {
    ThreadManager.post(new TroopAioKeywordTipManager.3(this, paramList, paramList1, paramInt, parambblq), 8, null, true);
  }
