  ...
  implements View.OnClickListener, View.OnFocusChangeListener
{
  ...
  public tzc(VafContext paramVafContext)
  {
  ...
  private void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getSystemService("layout_inflater")).inflate(2131560051, null);
      this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131366183));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379850));
  ...
  private void b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusInnerData.a != null)
    {
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusInnerData.a.b)) {
        this.jdField_a_of_type_AndroidWidgetEditText.setHint(two.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusInnerData.a.b, 32));
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusInnerData.a.c)) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(two.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusInnerData.a.c, 8));
      }
    }
  ...
  public void onClick(View paramView)
  {
    ...
    for (boolean bool = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusInnerData.a.jdField_a_of_type_JavaUtilRegexPattern.matcher(str1).matches();; bool = true)
    {
      for (;;)
      {
        ...
        QQToast.a(paramView.getContext(), -1, amtj.a(2131712018), 0).b(((BaseActivity)paramView.getContext()).getTitleBarHeight());
  ...
  public void onFocusChange(View paramView, boolean paramBoolean)
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (paramBoolean))
    {
      ...
      two.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdAdDataProteusInnerData, 39);
    }
  }
