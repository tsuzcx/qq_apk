...
public class ahry
{
  ...
  {
    SpannableString localSpannableString = new SpannableString(amtj.a(2131715863) + this.jdField_a_of_type_JavaLangString);
  ...
  public void a(QQAppInterface paramQQAppInterface, ColorStateList paramColorStateList, ahrz paramahrz)
  {
    this.jdField_a_of_type_AndroidContentResColorStateList = paramColorStateList;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaUtilTimer = new Timer();
    this.jdField_a_of_type_Ahrz = paramahrz;
  }
