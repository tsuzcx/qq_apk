...
public class mgj
  extends lee
{
  public mgj(MultiVideoCtrlLayerUIBase paramMultiVideoCtrlLayerUIBase) {}
  ...
  protected void a(long paramLong1, int paramInt1, long paramLong2, long paramLong3, long paramLong4, int paramInt2)
  {
    ...
    {
      this.a.jdField_b_of_type_Mcx.update(null, new Object[] { Integer.valueOf(105), Boolean.valueOf(bool), Long.valueOf(paramLong1) });
      this.a.D(paramLong1);
      ...
      for (;;)
      {
        ...
        if (paramLong3 == 2L)
        {
          mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1029);
        }
        else if (paramLong3 == 4L)
        {
          if ((paramLong2 == this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getLongAccountUin()) && (!this.a.jdField_a_of_type_ComTencentAvVideoController.a().j))
          {
            ...
            mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1031);
          }
          for (;;)
          {
            ...
            bdla.b(null, "CliOper", "", "", "0X8004CFD", "0X8004CFD", 0, 0, "", "", "", "");
            break;
            paramInt1 = 0;
            break label485;
            if (QLog.isColorLevel()) {
        ...
        else if (paramLong3 == 8L)
        {
          ...
          {
            MultiVideoCtrlLayerUIBase.a(this.a, false);
            mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695460));
          }
        }
        else if ((paramLong3 == 9L) && (MultiVideoCtrlLayerUIBase.a(this.a)))
        {
          MultiVideoCtrlLayerUIBase.a(this.a, false);
          mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695461));
        }
      }
      this.a.v(paramLong3);
      return;
  ...
  protected void a(long paramLong1, long paramLong2, long paramLong3, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.a.jdField_b_of_type_Mcx.update(null, new Object[] { Integer.valueOf(104), localArrayList });
      if (paramInt == 2)
      {
        this.a.i(1036);
  ...
  protected void a(long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      if ((this.a.jdField_a_of_type_ComTencentAvVideoController.a() != null) && (this.a.jdField_a_of_type_ComTencentAvVideoController.a().H != 1))
      {
        ...
        str = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695298);
        float f = msg.a(str, this.a.jdField_e_of_type_AndroidWidgetTextView.getPaint());
        f = Math.min(this.a.jdField_a_of_type_AndroidContentResResources.getDisplayMetrics().widthPixels - f - this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131297937) * 2, this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131297159));
        msg.b(localStringBuilder, (String)localObject, this.a.jdField_e_of_type_AndroidWidgetTextView.getPaint(), f);
        localStringBuilder.append(str);
      }
      mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, localStringBuilder.toString());
    ...
    for (int i = 1;; i = 0)
    {
      ((lfe)localObject).e("setRoomMicOff", i);
      return;
      ...
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695295));
      break;
    }
  }
  ...
  protected void a(ArrayList<Long> paramArrayList, int paramInt)
  {
    if (paramInt == 0)
    {
      mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034);
      mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035);
    ...
    {
      mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034, 2131695282);
      mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695627), new mgk(this));
      return;
    }
    Object localObject;
    long l;
    ...
    else
    {
      ...
      float f = this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131297159);
      localObject = new StringBuilder();
      msg.b((StringBuilder)localObject, paramArrayList, this.a.jdField_e_of_type_AndroidWidgetTextView.getPaint(), f);
      if (paramInt != 1) {
        break label419;
      }
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695283));
      mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695628), new mgl(this));
    }
    for (;;)
    {
      paramArrayList = ((StringBuilder)localObject).toString();
      mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1034, paramArrayList);
      return;
      l = this.a.jdField_a_of_type_ComTencentAvVideoController.c;
      break;
      label419:
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695284)).append(paramInt);
      ((StringBuilder)localObject).append(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695285));
      mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1035, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getString(2131695629), new mgm(this));
    }
  }
  ...
  protected void d(long paramLong, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ...
      float f = this.a.jdField_a_of_type_AndroidContentResResources.getDimensionPixelSize(2131297159);
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695301));
      msg.b(localStringBuilder, (String)localObject, this.a.jdField_e_of_type_AndroidWidgetTextView.getPaint(), f);
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695300));
      mbf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1033, localStringBuilder.toString());
      localObject = this.a;
      if (paramInt != 1) {
        break label287;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localStringBuilder.append(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131695302));
      break;
    }
  }
}
