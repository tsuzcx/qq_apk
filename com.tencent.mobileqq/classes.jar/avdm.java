...
public class avdm
  extends apec
{
  public avdm(AppletsSettingFragment paramAppletsSettingFragment) {}
  ...
  protected void onGetAppletsSettingSwitch(boolean paramBoolean, List<apel> paramList)
  {
    ...
    if (paramBoolean)
    {
      ...
      if ((paramList != null) && (paramBoolean) && (paramList.size() > 0))
      {
        ...
        {
          Object localObject1 = (apel)paramList.next();
          Object localObject2;
          if ((((apel)localObject1).jdField_a_of_type_JavaUtilList != null) && (((apel)localObject1).jdField_a_of_type_JavaUtilList.size() > 0) && (((apel)localObject1).jdField_a_of_type_JavaUtilList.get(0) != null) && (((AppletItem)((apel)localObject1).jdField_a_of_type_JavaUtilList.get(0)).a() == 1L))
          {
            AppletsSettingFragment.a(this.a, (AppletItem)((apel)localObject1).jdField_a_of_type_JavaUtilList.get(0));
            ...
            {
              ((aljo)localObject2).a(paramBoolean);
              if (TextUtils.isEmpty(((apel)localObject1).jdField_a_of_type_JavaLangString)) {
                break;
              }
              AppletsSettingFragment.b(this.a).setText(((apel)localObject1).jdField_a_of_type_JavaLangString);
              this.a.a.a(((apel)localObject1).jdField_a_of_type_JavaLangString);
              break;
              paramBoolean = false;
              break label247;
            }
          ...
          if (!TextUtils.isEmpty(((apel)localObject1).jdField_a_of_type_JavaLangString))
          {
            AppletsSettingFragment.c(this.a).setText(((apel)localObject1).jdField_a_of_type_JavaLangString);
            this.a.a.b(((apel)localObject1).jdField_a_of_type_JavaLangString);
          }
          if ((((apel)localObject1).jdField_a_of_type_JavaUtilList != null) && (((apel)localObject1).jdField_a_of_type_JavaUtilList.size() > 0))
          {
            AppletsSettingFragment.a(this.a).clear();
            localObject1 = ((apel)localObject1).jdField_a_of_type_JavaUtilList.iterator();
