...
public class avdm
  implements Observer
{
  public avdm(SignatureEditFragment paramSignatureEditFragment) {}
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    while (SignatureEditFragment.a(this.a) == null)
    {
      ...
      {
        paramObject = avep.a().jdField_b_of_type_ComTencentMobileqqRichstatusRichStatus;
        if (paramObject != null)
        {
      ...
      if (paramObservable != null)
      {
        ...
        avep.a().a(this.a.jdField_b_of_type_ComTencentMobileqqRichstatusRichStatus.tplId);
      }
      ...
      if ((i == 100) || (i == 0))
      {
        ...
        avep.a().b(this.a.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus);
      }
      for (;;)
      {
