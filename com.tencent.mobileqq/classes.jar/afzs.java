  ...
  implements aelw
{
  ...
  static
  {
    ...
    c = (int)(localDisplayMetrics.widthPixels - bdcq.a(localBaseApplication, 40.0F) * 2.0F - BaseChatItemLayout.s - BaseChatItemLayout.t - i * 2 - bdcq.a(localBaseApplication, 10.0F));
    if (c > 640) {
      c = 640;
    }
  ...
  {
    if (paramInt1 == 0) {
      return new apge(BaseApplicationImpl.getApplication().getResources(), null, paramInt2, paramInt3, -921103);
    }
    Object localObject;
    if (paramInt1 == 1) {
      localObject = baul.b();
    ...
    for (;;)
    {
      if ((localObject instanceof SkinnableBitmapDrawable))
      {
        ...
        return new apge(BaseApplicationImpl.getApplication().getResources(), (Bitmap)localObject, paramInt2, paramInt3, -921103);
        if (paramInt1 == 2) {
          localObject = baul.a();
        }
      }
  ...
  /* Error */
  public static Drawable a(Context paramContext, bbpe parambbpe, MessageForTroopFile paramMessageForTroopFile)
  {
    // Byte code:
    //   0: aload_1
    //   1: getfield 127	bbpe:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   4: astore 8
    //   6: aload_1
    //   7: getfield 129	bbpe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   10: ifnull +80 -> 90
    //   13: aload_1
    //   14: getfield 129	bbpe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   17: astore_2
    //   18: aload_2
    //   19: invokestatic 134	arof:a	(Ljava/lang/String;)Ljava/lang/String;
    //   22: astore_2
    //   23: aload_0
    ...
    //   62: ifeq +730 -> 792
    //   65: getstatic 33	afzs:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   68: aload 8
    ...
    //   93: goto -75 -> 18
    //   96: aload_1
    //   97: getfield 129	bbpe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   100: ifnull +692 -> 792
    //   103: new 163	java/io/File
    //   106: dup
    //   107: aload_1
    //   108: getfield 129	bbpe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   129: invokestatic 183	afzs:a	(II)[I
    //   132: astore_2
    //   133: aload_0
    //   134: aload_2
    //   135: iconst_0
    ...
    //   192: astore_0
    //   193: getstatic 33	afzs:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   196: aload 8
    //   198: aload_0
    ...
    //   222: astore_2
    //   223: getstatic 33	afzs:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   226: aload 8
    ...
    //   267: aload_0
    //   268: invokestatic 224	bdda:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   271: pop
    //   272: aload_0
    ...
    //   288: invokestatic 233	baul:a	(Ljava/lang/String;)I
    //   291: istore 7
    //   293: iload 7
    //   295: bipush 90
    ...
    //   320: iload 5
    //   322: iload 4
    //   324: invokestatic 183	afzs:a	(II)[I
    //   327: astore_0
    //   328: aload_0
    //   329: iconst_0
    //   330: iaload
    ...
    //   494: iload 4
    //   496: iload 5
    //   498: invokestatic 277	bdda:b	(Landroid/graphics/Bitmap;FII)Landroid/graphics/Bitmap;
    ...
    //   512: aload_1
    //   513: astore_0
    //   514: getstatic 33	afzs:jdField_a_of_type_AndroidSupportV4UtilLruCache	Landroid/support/v4/util/LruCache;
    //   517: aload 8
    //   519: aload 9
    ...
    //   576: invokestatic 297	afzs:a	(III)Landroid/graphics/drawable/Drawable;
    //   579: astore_0
    //   580: aload_0
    //   581: areturn
    //   582: astore_0
    ...
    //   586: iload 4
    //   588: iload 5
    //   590: invokestatic 297	afzs:a	(III)Landroid/graphics/drawable/Drawable;
    //   593: astore_2
    ...
    //   655: iload 4
    //   657: iload 5
    //   659: invokestatic 297	afzs:a	(III)Landroid/graphics/drawable/Drawable;
    //   662: astore 8
    //   664: aload_1
    //   665: astore_0
  ...
  private void a(bbpe parambbpe, MessageForTroopFile paramMessageForTroopFile)
  {
    if (parambbpe != null)
    {
      TeamWorkFileImportInfo localTeamWorkFileImportInfo = new TeamWorkFileImportInfo();
      localTeamWorkFileImportInfo.jdField_c_of_type_JavaLangString = parambbpe.jdField_a_of_type_JavaLangString;
      localTeamWorkFileImportInfo.jdField_b_of_type_JavaLangString = parambbpe.g;
      localTeamWorkFileImportInfo.j = arni.a(parambbpe.g);
      ...
      localTeamWorkFileImportInfo.jdField_d_of_type_JavaLangString = parambbpe.e;
      localTeamWorkFileImportInfo.jdField_b_of_type_Int = parambbpe.h;
      ...
      bacb.a(localTeamWorkFileImportInfo, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localTeamWorkFileImportInfo.jdField_d_of_type_Int);
    }
  }
  
  private void a(bdkz parambdkz, bbpe parambbpe, boolean paramBoolean)
  {
    if (this.f)
    {
      this.g = aosx.a().c();
    ...
    long l2 = arni.a(parambbpe.e);
    if ((this.g) && (badt.a(parambbpe.e, parambbpe.g, str1)) && (l2 <= l1))
    {
      int j = 1;
      i = j;
      if (paramBoolean)
      {
        if (TextUtils.isEmpty(parambbpe.e)) {
          break label217;
        }
        parambbpe = new File(parambbpe.e);
        i = j;
        if (parambbpe == null)
        {
          i = j;
    ...
    for (int i = 0;; i = 0)
    {
      if (i != 0)
      {
        ...
        parambdkz.a(2131373081, this.jdField_a_of_type_AndroidContentContext.getString(2131720668), 2130838688);
      }
      return;
    }
  }
  ...
  {
    return arni.a(((MessageForTroopFile)paramChatMessage).fileName) == 0;
  }
  ...
  public static boolean d(ChatMessage paramChatMessage)
  {
    ...
    return ((paramChatMessage.width == 0) || (paramChatMessage.height != 0)) || (arni.a(paramChatMessage.fileName) == 2);
  }
  ...
  public View a(int paramInt1, int paramInt2, ChatMessage paramChatMessage, View paramView, ViewGroup paramViewGroup, aeov paramaeov)
  {
    ...
    this.jdField_a_of_type_Aqnj.a(paramViewGroup, paramView, paramChatMessage);
    return paramView;
  }
  
  public View a(ViewGroup paramViewGroup, ChatMessage paramChatMessage)
  {
    afzw localafzw = (afzw)paramViewGroup.getTag();
    if (localafzw.jdField_c_of_type_AndroidViewView != null) {
      localafzw.jdField_c_of_type_AndroidViewView.setVisibility(0);
    }
    if (localafzw.jdField_d_of_type_AndroidViewView != null) {
      localafzw.jdField_d_of_type_AndroidViewView.setVisibility(8);
    }
    if (localafzw.jdField_a_of_type_AndroidViewView != null)
    {
      ViewGroup.LayoutParams localLayoutParams = localafzw.jdField_a_of_type_AndroidViewView.getLayoutParams();
      localLayoutParams.width = BaseChatItemLayout.y;
      localLayoutParams.height = -2;
      localafzw.jdField_a_of_type_AndroidViewView.setLayoutParams(localLayoutParams);
    }
    for (;;)
    {
      a(localafzw, paramViewGroup, paramChatMessage);
      a(localafzw.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout, paramChatMessage, localafzw);
      if (jdField_e_of_type_Boolean) {}
      try
      {
        localafzw.jdField_b_of_type_JavaLangStringBuilder.append(localafzw.jdField_a_of_type_AndroidWidgetTextView.getText()).append(" ");
        localafzw.jdField_b_of_type_JavaLangStringBuilder.append(localafzw.jdField_b_of_type_AndroidWidgetTextView.getText());
        localafzw.jdField_b_of_type_JavaLangStringBuilder.append(localafzw.jdField_c_of_type_AndroidWidgetTextView.getText());
        localafzw.jdField_b_of_type_JavaLangStringBuilder.append("按钮");
        paramViewGroup.setContentDescription(localafzw.jdField_b_of_type_JavaLangStringBuilder.toString());
  ...
  {
    paramChatMessage = (afzw)paramaelt;
  ...
  {
    paramaemk = (MessageForTroopFile)paramChatMessage;
    bbpe localbbpe = bcjk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramaemk);
    long l = -1L;
    if (localbbpe != null) {
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              return parambdkz;
              if (((aroo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) || (arof.b(localbbpe.jdField_a_of_type_JavaLangString))) && (localbbpe != null) && (localbbpe.jdField_b_of_type_Int != 12) && (d(paramChatMessage))) {
              ...
              default: 
                return parambdkz;
              case 6: 
                parambdkz.a(2131366750, this.jdField_a_of_type_AndroidContentContext.getString(2131697780), 2130838677);
                if ((paramaemk != null) && (paramaemk.fileSize <= l)) {
                  a(parambdkz, localbbpe, false);
                }
                break;
              }
            } while (aekt.a(5) != 1);
            parambdkz.a(2131373070, this.jdField_a_of_type_AndroidContentContext.getString(2131697774), 2130838676);
            return parambdkz;
            parambdkz.a(2131366750, this.jdField_a_of_type_AndroidContentContext.getString(2131697780), 2130838677);
          } while (aekt.a(5) != 1);
          parambdkz.a(2131373070, this.jdField_a_of_type_AndroidContentContext.getString(2131697774), 2130838676);
  ...
  protected MessageForTroopFile a(View paramView)
  {
    ...
    if (paramView.a.isMultiMsg) {
      return (MessageForTroopFile)arni.a(paramView.a);
    }
  ...
  public String a(ChatMessage paramChatMessage)
  {
    if (bdec.a(paramChatMessage.issend)) {
      return alpo.a(2131715698);
    }
    return alpo.a(2131715702);
  }
  ...
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    do
    {
      do
      {
          ...
          do
          {
            do
            {
              do
              {
                        ...
                        do
                        {
                          do
                          {
                            do
                            {
                              ...
                              localObject2 = bcjk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject1);
                            } while (localObject2 == null);
                            i = bdee.a((Activity)paramContext);
                            localObject4 = new bboe(Long.parseLong(paramChatMessage.frienduin), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Activity)paramContext);
                            switch (paramInt)
                            {
                            default: 
                            ...
                            case 2131373071: 
                              if (i == 0)
                              {
                                bcig.a(paramContext, this.jdField_a_of_type_AndroidContentContext.getString(2131698040));
                                return;
                              }
                              azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Grp", "Down_pause_download", 0, 0, "", paramChatMessage.frienduin, "", "");
                            }
                          } while (((bbpe)localObject2).jdField_b_of_type_Int != 8);
                          ((TroopFileTransferManager)localObject3).d(((bbpe)localObject2).jdField_a_of_type_JavaUtilUUID);
                          return;
                          if (i == 0)
                          {
                            bcig.a(paramContext, this.jdField_a_of_type_AndroidContentContext.getString(2131698040));
                          ...
                          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Grp", "Up_pause_upload", 0, 0, "", paramChatMessage.frienduin, "", "");
                        } while ((((bbpe)localObject2).jdField_b_of_type_Int != 0) && (((bbpe)localObject2).jdField_b_of_type_Int != 1));
                        ((TroopFileTransferManager)localObject3).a(((bbpe)localObject2).jdField_a_of_type_JavaUtilUUID);
                        return;
                      } while (((bbpe)localObject2).jdField_b_of_type_Int != 9);
                      ((bboe)localObject4).b(((bbpe)localObject2).jdField_a_of_type_JavaUtilUUID);
                      return;
                    } while (((bbpe)localObject2).jdField_b_of_type_Int != 2);
                    ((bboe)localObject4).a(((bbpe)localObject2).jdField_a_of_type_JavaUtilUUID);
                    return;
                  } while ((((bbpe)localObject2).jdField_b_of_type_Int != 8) && (((bbpe)localObject2).jdField_b_of_type_Int != 9) && (((bbpe)localObject2).jdField_b_of_type_Int != 10));
                  ((TroopFileTransferManager)localObject3).d(((bbpe)localObject2).jdField_a_of_type_JavaUtilUUID);
                  a(((bbpe)localObject2).jdField_b_of_type_Long, (Activity)paramContext, ((bbpe)localObject2).jdField_a_of_type_JavaUtilUUID);
                  return;
                  if (i == 0)
                  {
                    bcig.a(paramContext, this.jdField_a_of_type_AndroidContentContext.getString(2131698040));
                ...
                } while ((((bbpe)localObject2).jdField_b_of_type_Int != 1) && (((bbpe)localObject2).jdField_b_of_type_Int != 0) && (((bbpe)localObject2).jdField_b_of_type_Int != 2) && (((bbpe)localObject2).jdField_b_of_type_Int != 3));
                ((TroopFileTransferManager)localObject3).a(((bbpe)localObject2).jdField_a_of_type_JavaUtilUUID);
                a(((bbpe)localObject2).jdField_b_of_type_Long, (Activity)paramContext, ((bbpe)localObject2).jdField_a_of_type_JavaUtilUUID, paramChatMessage);
                return;
                if (i == 0)
                {
                  bcig.a(paramContext, this.jdField_a_of_type_AndroidContentContext.getString(2131698040));
                ...
                localObject3 = arni.a((bbpe)localObject2);
                ...
                if (!TextUtils.isEmpty(((FileManagerEntity)localObject3).getFilePath())) {
                  ((ForwardFileInfo)localObject4).a(((bbpe)localObject2).jdField_a_of_type_JavaLangString);
                }
                ((ForwardFileInfo)localObject4).d(((bbpe)localObject2).g);
                ((ForwardFileInfo)localObject4).d(((bbpe)localObject2).jdField_c_of_type_Long);
                ((ForwardFileInfo)localObject4).a(Long.parseLong(paramChatMessage.frienduin));
                if (((bbpe)localObject2).jdField_a_of_type_JavaUtilUUID != null) {
                  ((ForwardFileInfo)localObject4).e(((bbpe)localObject2).jdField_a_of_type_JavaUtilUUID.toString());
                }
                if (!TextUtils.isEmpty(((bbpe)localObject2).jdField_c_of_type_JavaLangString)) {
                  ((ForwardFileInfo)localObject4).f(((bbpe)localObject2).jdField_c_of_type_JavaLangString);
                }
                for (;;)
                {
                  ...
                  paramChatMessage.putExtra("forward_text", ((bbpe)localObject2).g);
                  ...
                  return;
                  if (!TextUtils.isEmpty(((bbpe)localObject2).jdField_d_of_type_JavaLangString)) {
                    ((ForwardFileInfo)localObject4).f(((bbpe)localObject2).jdField_d_of_type_JavaLangString);
                  }
                }
                bcjk.b((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
                return;
                arni.a((Activity)paramContext, ((bbpe)localObject2).jdField_a_of_type_JavaLangString);
                return;
              } while (((bbpe)localObject2).jdField_b_of_type_Int != 3);
              ((bboe)localObject4).a(((bbpe)localObject2).jdField_a_of_type_JavaUtilUUID);
              return;
            } while (((bbpe)localObject2).jdField_b_of_type_Int != 10);
            ((bboe)localObject4).b(((bbpe)localObject2).jdField_a_of_type_JavaUtilUUID);
            return;
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Grp", "Down__start_download", 0, 0, "", paramChatMessage.frienduin, "", "");
          } while ((localObject2 != null) && (((bbpe)localObject2).jdField_b_of_type_Int != 7));
          ((bboe)localObject4).a(((bbpe)localObject2).e, ((bbpe)localObject2).g, ((bbpe)localObject2).jdField_c_of_type_Long, ((bbpe)localObject2).h);
          return;
          azmj.b(null, "dc00898", "", "", "0X800A60C", "0X800A60C", 0, 0, "", "", "", "");
          bcjk.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
          return;
          paramContext = arni.a((bbpe)localObject2);
          localObject2 = bcil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((bbpe)localObject2).jdField_b_of_type_Long).a(paramContext.strTroopFilePath);
          if (localObject2 != null)
          {
            paramContext.lastTime = ((bbnr)localObject2).c;
            paramContext.selfUin = String.valueOf(((bbnr)localObject2).jdField_b_of_type_Long);
          }
          new biqt(3).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Activity)this.jdField_a_of_type_AndroidContentContext, paramContext, paramChatMessage, false);
        ...
        for (;;)
        {
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_files", "", "remove_file", "remove_clk", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "", paramContext, (String)localObject1);
          a(paramChatMessage);
          return;
          paramContext = (Context)localObject1;
      ...
      a((bbpe)localObject2, (MessageForTroopFile)localObject1);
    ...
    return;
    ApolloUtil.a(((bbpe)localObject2).g, ((bbpe)localObject2).jdField_a_of_type_JavaLangString, new afzv(this, (bbpe)localObject2, (bboe)localObject4));
  }
  
  public void a(long paramLong, Activity paramActivity, UUID paramUUID)
  {
    paramUUID = new afzt(this, paramLong, paramUUID, paramActivity);
  ...
  {
    paramUUID = new afzu(this, paramLong, paramUUID, paramChatMessage, paramActivity);
  ...
  public void a(afzw paramafzw, ViewGroup paramViewGroup, ChatMessage paramChatMessage)
  {
    if (paramafzw.jdField_d_of_type_AndroidWidgetTextView == null)
    {
      paramafzw.jdField_d_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
      paramafzw.jdField_d_of_type_AndroidWidgetTextView.setBackgroundResource(2130842245);
      paramafzw.jdField_d_of_type_AndroidWidgetTextView.setTextSize(1, 12.0F);
      paramafzw.jdField_d_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167192));
      paramafzw.jdField_d_of_type_AndroidWidgetTextView.setText(2131697654);
      paramafzw.jdField_d_of_type_AndroidWidgetTextView.setSingleLine();
      paramafzw.jdField_d_of_type_AndroidWidgetTextView.setGravity(16);
      paramafzw.jdField_d_of_type_AndroidWidgetTextView.setPadding(bcwh.a(this.jdField_a_of_type_AndroidContentContext, 5.0F), 0, bcwh.a(this.jdField_a_of_type_AndroidContentContext, 5.0F), 0);
      paramafzw.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
      ...
      bcwh.a(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      paramViewGroup.addView(paramafzw.jdField_d_of_type_AndroidWidgetTextView, localLayoutParams);
    }
    paramafzw.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
    if (paramChatMessage.isSend())
    {
      paramViewGroup = (RelativeLayout.LayoutParams)paramafzw.jdField_d_of_type_AndroidWidgetTextView.getLayoutParams();
      ...
      paramafzw.jdField_d_of_type_AndroidWidgetTextView.setLayoutParams(paramViewGroup);
      return;
    }
    paramViewGroup = (RelativeLayout.LayoutParams)paramafzw.jdField_d_of_type_AndroidWidgetTextView.getLayoutParams();
  ...
  void a(View paramView, boolean paramBoolean)
  {
    ...
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_files", "", "AIOchat", "Clk_filesbubble", 0, 0, paramView.frienduin + "", "", "", "");
    bbpe localbbpe = bcjk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForTroopFile);
    if (localbbpe.jdField_b_of_type_Int == 12) {
      bcig.a(localActivity, String.format(localActivity.getString(2131697756), new Object[] { bcjk.a(localbbpe.g) }), 1);
    }
    do
    {
      return;
    ...
    aroo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramView, l, localbbpe, localMessageForTroopFile.senderuin, localMessageForTroopFile.lastTime, 3, 3, null, false, false);
  }
  
  public void a(BaseChatItemLayout paramBaseChatItemLayout, ChatMessage paramChatMessage, afzw paramafzw)
  {
    ...
    if (!localMessageForTroopFile.bReported)
    {
      ...
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Grp", "Down_appear_AIO", 0, 0, "", paramChatMessage.frienduin, "", "");
    ...
    paramafzw.jdField_a_of_type_AndroidWidgetTextView.setEllipsize(TextUtils.TruncateAt.MIDDLE);
    paramafzw.jdField_a_of_type_AndroidWidgetTextView.setMaxLines(2);
    paramafzw.jdField_a_of_type_AndroidWidgetTextView.setText(localbbpe.g);
    boolean bool2 = false;
    int m = 0;
    int n = 0;
    int i1 = 0;
    ...
    default: 
      ...
      if (k != 0)
      {
        paramafzw.jdField_a_of_type_AndroidWidgetProgressBar.setProgress(j);
        paramafzw.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
        label364:
        if (i == 0) {
          break label1098;
        }
        paramafzw.jdField_c_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
        paramafzw.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        label386:
        paramafzw.jdField_b_of_type_AndroidWidgetTextView.setText(arof.a(localbbpe.jdField_c_of_type_Long));
        ...
        if (localbbpe.jdField_b_of_type_JavaLangString != null) {
          break label1136;
        }
        arni.a(paramafzw.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localbbpe.g);
        if (localbbpe.jdField_a_of_type_JavaUtilUUID == null) {
          break label1110;
        }
        paramBaseChatItemLayout.a(localbbpe.jdField_a_of_type_JavaUtilUUID, 128);
      }
      break;
    }
    while (alnq.a() > 17.0F)
    {
      paramBaseChatItemLayout = (RelativeLayout.LayoutParams)paramafzw.jdField_b_of_type_AndroidWidgetTextView.getLayoutParams();
      if (paramafzw.jdField_c_of_type_AndroidWidgetTextView.getVisibility() != 0) {
        break label1200;
      }
      paramafzw.jdField_b_of_type_AndroidWidgetTextView.setGravity(5);
      paramBaseChatItemLayout.addRule(3, 2131364142);
      paramBaseChatItemLayout.addRule(2, 2131364144);
      paramBaseChatItemLayout.addRule(7, 2131364142);
      return;
      k = 1;
      j = 0;
      localObject = alpo.a(2131715703);
      i = 1;
      bool1 = bool2;
      break label332;
      String str = alpo.a(2131715751);
      localObject = str;
      i = i1;
      j = n;
      k = m;
      ...
      bool1 = bool2;
      break label332;
      localObject = alpo.a(2131715725);
      i = 1;
      k = 1;
      j = bcjk.a(localbbpe.jdField_d_of_type_Long, localbbpe.jdField_c_of_type_Long);
      bool1 = bool2;
      break label332;
      localObject = alpo.a(2131715736);
      k = 1;
      j = bcjk.a(localbbpe.jdField_d_of_type_Long, localbbpe.jdField_c_of_type_Long);
      i = i1;
      bool1 = bool2;
      break label332;
      i = 1;
      localObject = alpo.a(2131715714);
      k = 1;
      j = bcjk.a(localbbpe.jdField_d_of_type_Long, localbbpe.jdField_c_of_type_Long);
      bool1 = bool2;
      break label332;
      i = 1;
      localObject = alpo.a(2131715759);
      k = 1;
      j = bcjk.a(localbbpe.jdField_d_of_type_Long, localbbpe.jdField_c_of_type_Long);
      bool1 = bool2;
      break label332;
      localObject = alpo.a(2131715742);
      i = 1;
      j = n;
      k = m;
      bool1 = bool2;
      break label332;
      localObject = alpo.a(2131715758);
      i = 1;
      j = n;
      k = m;
      bool1 = bool2;
      break label332;
      localObject = alpo.a(2131715731);
      bool1 = true;
      i = i1;
      j = n;
      k = m;
      break label332;
      localObject = alpo.a(2131715710);
      bool1 = true;
      i = i1;
      j = n;
      k = m;
      break label332;
      localObject = alpo.a(2131715738);
      i = i1;
      j = n;
      k = m;
      bool1 = bool2;
      break label332;
      localObject = alpo.a(2131715709);
      i = 1;
      j = n;
      k = m;
      bool1 = bool2;
      break label332;
      paramafzw.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      break label364;
      label1098:
      paramafzw.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      break label386;
      label1110:
      paramBaseChatItemLayout.a(localbbpe.e, localbbpe.g, localbbpe.h, 128);
      continue;
      label1136:
      if ((TextUtils.isEmpty(localbbpe.jdField_b_of_type_JavaLangString)) || (!bdcs.a(localbbpe.jdField_b_of_type_JavaLangString)))
      {
        arni.a(paramafzw.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localbbpe.g);
      }
      else
      {
        arni.a(paramafzw.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localbbpe.g);
        paramafzw.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setAsyncImage(localbbpe.jdField_b_of_type_JavaLangString);
      }
    }
    label1200:
    paramafzw.jdField_b_of_type_AndroidWidgetTextView.setGravity(3);
    paramBaseChatItemLayout.addRule(3, -1);
    paramBaseChatItemLayout.addRule(2, -1);
    paramBaseChatItemLayout.addRule(12);
    paramBaseChatItemLayout.addRule(5, 2131364142);
  }
  ...
  public void a(ChatMessage paramChatMessage, Context paramContext, BaseChatItemLayout paramBaseChatItemLayout, aelt paramaelt, int paramInt1, int paramInt2)
  {
    ...
    boolean bool1 = b(paramChatMessage);
    boolean bool2 = d(paramChatMessage);
    if ((!bool1) && (!bool2) && (paramaelt.jdField_a_of_type_AndroidViewView != null))
    {
      if (paramChatMessage.isSend()) {
  ...
  public bdkz b(bdkz parambdkz, ChatMessage paramChatMessage, aemk paramaemk)
  {
    ...
    if (localbbpe == null)
    {
      parambdkz.a(2131373069, this.jdField_a_of_type_AndroidContentContext.getString(2131697773), 2130838673);
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Grp", "Down_press_files", 0, 0, "", paramChatMessage.frienduin, "", "");
      super.e(parambdkz, this.jdField_a_of_type_AndroidContentContext);
      return parambdkz;
    }
    paramaemk = Boolean.valueOf(false);
    int i = 0;
    int k = 0;
    int m = 0;
    int j = 0;
    ...
    default: 
      ...
      i = k;
      label263:
      ApolloUtil.a(parambdkz, localbbpe.g);
      if (paramaemk.booleanValue()) {
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Grp", "Up_press_files", 0, 0, "", paramChatMessage.frienduin, "", "");
      }
      break;
    }
    for (;;)
    {
      super.e(parambdkz, this.jdField_a_of_type_AndroidContentContext);
      if (i != 0) {
        parambdkz.a(2131366777, this.jdField_a_of_type_AndroidContentContext.getString(2131694029), 2130838685);
      }
      if ((j == 0) || (c(localMessageForTroopFile)) || (d(localMessageForTroopFile))) {
        break;
      }
      parambdkz.a(2131373076, this.jdField_a_of_type_AndroidContentContext.getString(2131697779), 2130838677);
      return parambdkz;
      parambdkz.a(2131373072, this.jdField_a_of_type_AndroidContentContext.getString(2131697775), 2130838680);
      parambdkz.a(2131373066, this.jdField_a_of_type_AndroidContentContext.getString(2131697771));
      i = 0;
      j = 0;
      paramaemk = Boolean.valueOf(true);
      break label263;
      parambdkz.a(2131373068, this.jdField_a_of_type_AndroidContentContext.getString(2131697777), 2130838682);
      parambdkz.a(2131373066, this.jdField_a_of_type_AndroidContentContext.getString(2131697771), 2130838664);
      i = 0;
      j = 0;
      paramaemk = Boolean.valueOf(true);
      break label263;
      parambdkz.a(2131373074, this.jdField_a_of_type_AndroidContentContext.getString(2131697777), 2130838689);
      parambdkz.a(2131373066, this.jdField_a_of_type_AndroidContentContext.getString(2131697771), 2130838664);
      i = 0;
      j = 0;
      paramaemk = Boolean.valueOf(true);
      break label263;
      parambdkz.a(2131373071, this.jdField_a_of_type_AndroidContentContext.getString(2131697775), 2130838680);
      parambdkz.a(2131366750, this.jdField_a_of_type_AndroidContentContext.getString(2131697780), 2130838677);
      ...
      i = 1;
      parambdkz.a(2131370842, this.jdField_a_of_type_AndroidContentContext.getString(2131694625), 2130838685);
      if (aekt.a(5) != 1) {
        break label252;
      }
      parambdkz.a(2131373070, this.jdField_a_of_type_AndroidContentContext.getString(2131697774), 2130838676);
      ...
      j = 1;
      break label263;
      parambdkz.a(2131373067, this.jdField_a_of_type_AndroidContentContext.getString(2131697772), 2130838673);
      parambdkz.a(2131373065, this.jdField_a_of_type_AndroidContentContext.getString(2131697770), 2130838664);
      parambdkz.a(2131366750, this.jdField_a_of_type_AndroidContentContext.getString(2131697780), 2130838677);
      a(paramChatMessage, parambdkz);
      if ((paramChatMessage.extraflag != 32768) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramChatMessage))) {
        a(parambdkz, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramChatMessage);
      ...
      j = 1;
      break label263;
      parambdkz.a(2131373073, this.jdField_a_of_type_AndroidContentContext.getString(2131697776), 2130838682);
      parambdkz.a(2131373065, this.jdField_a_of_type_AndroidContentContext.getString(2131697770), 2130838664);
      a(paramChatMessage, parambdkz);
      if ((paramChatMessage.extraflag != 32768) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramChatMessage))) {
        a(parambdkz, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramChatMessage);
      ...
      if ((!TextUtils.isEmpty(localbbpe.jdField_a_of_type_JavaLangString)) && (bdcs.e(localbbpe.jdField_a_of_type_JavaLangString))) {
        parambdkz.a(2131373075, this.jdField_a_of_type_AndroidContentContext.getString(2131697778));
      }
      parambdkz.a(2131366750, this.jdField_a_of_type_AndroidContentContext.getString(2131697780), 2130838677);
      a(paramChatMessage, parambdkz);
      if ((localMessageForTroopFile != null) && (localMessageForTroopFile.fileSize <= l)) {
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (!afzw.class.isInstance(localObject))
      {
        QLog.e("TroopFileItemBuilder", 1, "item click holder tag class[" + localObject.getClass().getName() + "] is not Holder");
        return;
      }
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A68A", "0X800A68A", 0, 0, "4", "", "", "");
      localObject = (afzw)localObject;
      localObject = a(paramView);
    } while ((b((ChatMessage)localObject)) || (d((ChatMessage)localObject)) || ((((MessageForTroopFile)localObject).isMultiMsg) && (!arni.a((ChatMessage)localObject, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext))));
    a(paramView, false);
    aekt.n = true;
  }
}
