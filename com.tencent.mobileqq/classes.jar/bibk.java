  ...
  implements bibj
{
  ...
  public static bibj a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("cooperation.wadl.ipc.IWadlService");
    if ((localIInterface != null) && ((localIInterface instanceof bibj))) {
      return (bibj)localIInterface;
    }
    return new bibl(paramIBinder);
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    case 2: 
      paramParcel1.enforceInterface("cooperation.wadl.ipc.IWadlService");
      a(bibn.a(paramParcel1.readStrongBinder()));
      return true;
    }
    paramParcel1.enforceInterface("cooperation.wadl.ipc.IWadlService");
    b(bibn.a(paramParcel1.readStrongBinder()));
    return true;
  }
}
