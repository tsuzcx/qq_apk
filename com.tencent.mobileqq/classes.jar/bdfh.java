...
public class bdfh
  implements bdff, NetworkState.NetworkStateListener
{
  private static bdfh jdField_a_of_type_Bdfh;
  ...
  private bdfe jdField_a_of_type_Bdfe = new bdfe();
  ...
  private bdfh()
  {
    this.jdField_a_of_type_Bdfe.a(this);
    a();
  }
  ...
  public static bdfh a()
  {
    try
    {
      if (jdField_a_of_type_Bdfh == null) {
        jdField_a_of_type_Bdfh = new bdfh();
      }
      bdfh localbdfh = jdField_a_of_type_Bdfh;
      return localbdfh;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bdfi(this, localHandlerThread.getLooper());
    ...
    for (int i = 1;; i = 0)
    {
      if (paramInt2 != 0)
      {
        if ((paramStatReportRequest != null) && (paramStatReportRequest.size() > 0) && (i == 0))
        {
          ...
          while (paramInt2 < i)
          {
            ...
            paramStatReportResponse = bdeu.a().a(String.valueOf(j));
            if (paramStatReportResponse != null) {
              paramStatReportRequest.addAll(paramStatReportResponse);
            }
            bdeu.a().a(String.valueOf(j), paramStatReportRequest);
            paramInt2 += 1;
          }
        }
      }
      else if ((i != 0) && (paramStatReportRequest != null) && (paramStatReportRequest.size() > 0))
      {
        ...
        while (paramStatReportRequest.hasNext())
        {
          ...
          bdeu.a().a(String.valueOf(paramStatReportResponse.type));
        }
      }
