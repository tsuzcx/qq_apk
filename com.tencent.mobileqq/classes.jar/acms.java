  ...
  implements acjr
{
  ...
  public acms(EditText paramEditText)
  {
  ...
  public void onSuccess(JSONObject paramJSONObject)
  {
    ...
    if (this.a != null) {
      new AlertDialog.Builder(this.a.getContext()).setTitle("onSuccess").setMessage(paramJSONObject.toString()).setNegativeButton(amtj.a(2131713882), null).create().show();
    }
  }
