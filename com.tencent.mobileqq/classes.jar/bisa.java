  ...
  extends Drawable
{
  ...
  public bisb a;
  public String a;
  WeakReference<bisc> jdField_a_of_type_JavaLangRefWeakReference;
  public boolean a;
  public float b;
  public int b;
  public Paint b;
  ...
  public bisa(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Bisb = new bisb(this);
  ...
  public void a()
  {
    this.jdField_a_of_type_Bisb.removeMessages(0);
    this.jdField_a_of_type_Bisb.a(this.jdField_b_of_type_Int);
    invalidateSelf();
  }
  ...
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambisc);
  }
  ...
  public void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_Bisb.a(paramInt);
    this.jdField_a_of_type_Bisb.sendEmptyMessage(0);
    invalidateSelf();
  }
  ...
  public void c(int paramInt)
  {
    ...
    {
      localbisc = (bisc)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localbisc != null)
      {
        if (this.jdField_b_of_type_Int != this.jdField_a_of_type_Int) {
          break label99;
        }
        localbisc.onProgressCompleted(this);
      }
    }
    for (;;)
    {
      ...
      return;
      label99:
      localbisc.onProgressChanged(this, this.jdField_b_of_type_Int, this.jdField_a_of_type_Int);
    }
  }
