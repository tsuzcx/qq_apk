...
public class ouo
  implements owa
{
  private void a(Context paramContext, BaseArticleInfo paramBaseArticleInfo, qoe paramqoe)
  {
    if ((paramBaseArticleInfo != null) && (paramBaseArticleInfo.mVideoDownloadBarInfo != null) && (paramBaseArticleInfo.mVideoDownloadBarInfo.get() != null))
    {
      ...
      if (localUrlJumpInfo != null) {
        qcn.a(paramContext, localUrlJumpInfo);
      }
    }
    while (paramqoe == null)
    {
      ...
      paramqoe.a(qoe.a(paramBaseArticleInfo), paramBaseArticleInfo, false, false);
      return;
    }
    paramqoe.a(qoe.a(paramBaseArticleInfo), paramBaseArticleInfo, false, false);
  }
  ...
  private void a(BaseArticleInfo paramBaseArticleInfo, boolean paramBoolean, JSONObject paramJSONObject)
  {
    ...
    for (int i = paramBaseArticleInfo.mVideoColumnInfo.a;; i = -1)
    {
      ...
      for (int j = 0;; j = 1)
      {
        paramBaseArticleInfo = new qmv(null, null, null, null).W(Integer.valueOf("1031").intValue()).h(paramBaseArticleInfo.getInnerUniqueID()).ab(j).s(paramJSONObject.optString("double_videocard_jump_page")).t(paramJSONObject.optString("double_videocard_jump_src")).u(paramBaseArticleInfo.mSubscribeName).f(paramBaseArticleInfo);
        if (i != -1) {
          paramBaseArticleInfo.aa(i);
        }
        paramBaseArticleInfo = paramBaseArticleInfo.a().a();
        ndn.a(null, null, "0X8007625", "0X8007625", 0, 0, "", "", "", paramBaseArticleInfo, false);
        ndn.a(null, null, "0X800A5A9", "0X800A5A9", 0, 0, "", "", "", paramBaseArticleInfo, false);
        return;
      }
    }
  }
    ...
    catch (Exception localException1)
    {
      for (;;)
      {
        try
        {
          ...
          localObject1 = new JSONObject();
          ((JSONObject)localObject1).put("cover_image_url_1", obz.a(paramBaseArticleInfo.mFirstPagePicUrl, bajq.b(180.5F), bajq.b(102.0F)));
          localJSONObject2.put("cover_image_1", localObject1);
          localJSONObject2.put("id_paly_wrapper_1", new JSONObject());
          localObject1 = new JSONObject();
          localObject2 = qcn.a(paramBaseArticleInfo.mVideoDuration * 1000);
          ...
          ((JSONObject)localObject2).put("article_title_1_textsize", odo.a());
          ...
          localObject1 = new JSONObject();
          localObject2 = qcn.d(paramBaseArticleInfo.mVideoCommentCount);
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ((JSONObject)localObject1).put("comment_num_1", (String)localObject2 + ajjy.a(2131637647));
          ...
          localJSONObject2.put("id_container_1", localObject1);
          localObject1 = new JSONObject();
          ((JSONObject)localObject1).put("cover_image_url_2", obz.a(localBaseArticleInfo.mFirstPagePicUrl, bajq.b(180.5F), bajq.b(102.0F)));
          localJSONObject2.put("cover_image_2", localObject1);
          localJSONObject2.put("id_play_wrapper_2", new JSONObject());
          localObject1 = new JSONObject();
          localObject2 = qcn.a(localBaseArticleInfo.mVideoDuration * 1000);
          if (localObject2 != null)
          {
            localObject2 = ((StringBuilder)localObject2).toString();
            if (!TextUtils.isEmpty((CharSequence)localObject2))
          ...
          ((JSONObject)localObject2).put("article_title_2_textsize", odo.a());
          ...
          localObject1 = new JSONObject();
          localObject2 = qcn.d(localBaseArticleInfo.mVideoCommentCount);
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ((JSONObject)localObject1).put("comment_num_2", (String)localObject2 + ajjy.a(2131637648));
  ...
  public void a(int paramInt1, Container paramContainer, opw paramopw, int paramInt2)
  {
    ...
    {
      return;
      a(paramContainer.findViewBaseByName("id_artilce_title_1"), paramopw.a());
    } while ((paramopw.a() == null) || (paramopw.a().mSubArtilceList == null) || (paramopw.a().mSubArtilceList.size() <= 0) || (paramopw.a().mSubArtilceList.get(0) == null));
    a(paramContainer.findViewBaseByName("id_artilce_title_2"), (BaseArticleInfo)paramopw.a().mSubArtilceList.get(0));
  }
  ...
  public boolean a(int paramInt, Container paramContainer, opw paramopw, ViewBase paramViewBase)
  {
    ...
    paramViewBase.setOnClickListener(new oup(this, paramopw, paramInt, paramContainer));
    return true;
  }
}
