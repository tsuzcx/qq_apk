...
public class ouo
  extends Handler
{
  public ouo(TroopMemberApiService paramTroopMemberApiService) {}
  ...
  public void handleMessage(Message paramMessage)
  {
                                                    ...
                                                    if (localObject3 != null)
                                                    {
                                                      ...
                                                      if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty((CharSequence)localObject5))) {
                                                        ...
                                                        else if (((String)localObject1).equals("g_troop_reward"))
                                                        {
                                                          ...
                                                          continue;
                                                          if (!TroopMemberApiService.a((AppRuntime)localObject4, new oup(this, (Bundle)localObject3)))
                                                          {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = (QQAppInterface)localObject4;
        QQAppInterface.b = i;
        ThreadManager.executeOnSubThread(new our(this, i));
        break label604;
        localObject2 = ((Bundle)localObject3).getString("troopUin");
        ...
        ((TroopPluginManager)localObject2).a("troop_manage_plugin.apk", new ous(this, (String)localObject4, i, (String)localObject3));
        break label604;
        ...
        if (localObject3 != null)
        {
          if (j == 0)
          {
            ...
            ((TroopTopicMgr)localObject5).a((ChatMessage)localObject3, 2, new out(this, j, i));
            break label604;
          }
        ...
        i = ((Bundle)localObject3).getInt("seq");
        ThreadManager.post(new ouv(this, (TroopManager)((AppRuntime)localObject4).getManager(51), (String)localObject2, (String)localObject5, (Bundle)localObject3, i), 8, null, true);
        break label604;
        localObject2 = new Bundle();
        ...
        for (;;)
        {
          ((DownloaderInterface)localObject3).a(new DownloadTask("http://pub.idqqimg.com/pc/misc/nearby/nearby_heart.gif", (File)localObject4), new ouw(this, (Bundle)localObject2), new Bundle());
          break;
        ...
        HuanjiPluginProxy.a().a((String)localObject2, i, (String)localObject4, new oux(this, (Bundle)localObject3, i));
        break label604;
        ...
        if (bool)
        {
          ...
          ShortVideoResourceManager.a((QQAppInterface)localObject4, new ouy(this, (AppRuntime)localObject4, (Bundle)localObject3));
          break label604;
        }
        ...
        localObject3 = new ouq(this, (Bundle)localObject3);
        ...
        for (localObject2 = ((FragmentActivity)localObject2).getChatFragment(); localObject2 != null; localObject2 = null)
        {
          ...
          if (((LightReplyMenuManager)localObject2).a == null) {
            ((LightReplyMenuManager)localObject2).c();
          }
          if (((LightReplyMenuManager)localObject2).a.a()) {
            break;
          }
          ((LightReplyMenuManager)localObject2).a.a();
          break;
          ...
          break;
          ((Bundle)localObject3).putInt("readinjoy_to_wx_config", ReadInJoyHelper.t((AppRuntime)localObject4));
