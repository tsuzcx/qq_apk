  ...
  extends bmne
{
  ...
  private HashMap<String, bmnd> b;
  
  public bhzq(HashMap<String, View> paramHashMap, String paramString)
  {
  ...
  public View a(Context paramContext, String paramString)
  {
    if ("pf_name".equals(paramString))
    {
      ...
      ykq.b("DIYProfileTemplate.QVipProfileJsonInflaterFactory", "创建了昵称控件");
    ...
    if ("pf_avatar".equals(paramString))
    {
      ...
      ykq.b("DIYProfileTemplate.QVipProfileJsonInflaterFactory", "创建了头像控件");
      paramContext = LayoutInflater.from(paramContext).inflate(2131562036, null);
      this.jdField_a_of_type_AndroidViewView = paramContext.findViewById(2131374869);
    ...
    if ("pf_like".equals(paramString))
    {
      ...
      ykq.b("DIYProfileTemplate.QVipProfileJsonInflaterFactory", "创建了点赞控件");
  ...
  {
    if ("pf_name".equals(paramString)) {
      return new bhzo(paramString, paramView, this.jdField_a_of_type_JavaLangString);
    }
    if ("pf_avatar".equals(paramString)) {
      return new bhzm(paramString, paramView, this.b);
    }
    if ("pf_like".equals(paramString)) {
      return new bhzn(paramString, paramView, this.jdField_a_of_type_JavaLangString);
    }
    if ("image_view".equals(paramString)) {
      return new bhzs(paramString, paramView, this.jdField_a_of_type_JavaLangString);
    }
  ...
  public void a(bmnd parambmnd, JSONObject paramJSONObject)
  {
    ...
    if ((!TextUtils.isEmpty((CharSequence)localObject)) && (parambmnd != null)) {
      this.b.put(localObject, parambmnd);
    }
    if ("pf_avatar".equals(paramJSONObject.optString("type")))
    {
      localObject = paramJSONObject.optString("border", "");
      localObject = (bmnd)this.b.get(localObject);
      if (localObject != null) {
        this.jdField_a_of_type_JavaUtilHashMap.put("map_key_profile_diy_avatar_sticker", ((bmnd)localObject).a());
      }
    }
    super.a(parambmnd, paramJSONObject);
  }
}
