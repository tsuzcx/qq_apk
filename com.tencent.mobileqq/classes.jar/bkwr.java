  ...
  extends RemoteCommand
{
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    case 5: 
          ...
          do
          {
            ...
            do
            {
              do
              {
                ...
                localSharedPreferences = bkwm.a(this.a, 1);
            ...
            return paramOnInvokeFinishLinstener;
            paramBundle = paramBundle.getString("param_uin");
            localObject = (amsw)this.a.getManager(51);
          } while ((localObject == null) || (TextUtils.isEmpty(paramBundle)));
          paramBundle = ((amsw)localObject).b(paramBundle);
      ...
      paramOnInvokeFinishLinstener.putString("result_key", Boolean.toString(puw.a(paramBundle, null)));
      return paramOnInvokeFinishLinstener;
    case 6: 
      paramBundle = bkwm.a(this.a);
    ...
    case 7: 
      paramOnInvokeFinishLinstener.putString("result_key", pay.e());
      return paramOnInvokeFinishLinstener;
    }
    paramBundle = paramBundle.getString("param_uin");
    new oeb(this.a, paramBundle, this.a.getApp().getApplicationContext()).a();
