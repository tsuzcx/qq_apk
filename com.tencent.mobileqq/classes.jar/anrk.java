  ...
  implements ArkViewImplement.InputCallback
{
  ...
  public void onFocusChanged(View paramView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      Object localObject2 = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838550);
      Object localObject1 = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838549);
  ...
  public void onSelectChanged(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((paramInt1 > 0) && (paramInt2 > 0) && ((paramInt1 < paramInt3) || (paramInt2 < paramInt4)))
    {
      ...
      int i = j;
      if (j <= 0) {
        i = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838550).getIntrinsicWidth();
      }
    ...
    for (;;)
    {
      ...
      paramInt1 = paramInt2;
      if (paramInt2 <= 0) {
        paramInt1 = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838549).getIntrinsicWidth();
      }
  ...
  public void onShowMenu(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt4 == 2)
    {
      localbdpi.a(0, alud.a(2131701095));
      localbdpi.a(1, alud.a(2131701090));
      localbdpi.a(2, alud.a(2131701096));
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow = bdft.a(paramView, paramInt1, paramInt2, paramInt3 + BaseApplicationImpl.getApplication().getResources().getDrawable(2130838549).getIntrinsicHeight(), localbdpi, new anrl(this, paramInt4, (ArkViewImplement.ArkViewInterface)paramView));
      return;
      if (paramInt4 == 1)
      {
        localbdpi.a(0, alud.a(2131701089));
        localbdpi.a(1, alud.a(2131701091));
        localbdpi.a(2, alud.a(2131701092));
      }
      else
      {
        localbdpi.a(0, alud.a(2131701094));
      }
    }
  }
}
