...
public class bccu
{
  public static WebViewFragment a(bcce parambcce, WebViewTabBarData paramWebViewTabBarData, Intent paramIntent)
  {
    ...
    if (i == 3)
    {
      ...
      if (parambcce != null) {
        return parambcce.a(paramIntent);
      }
    ...
    if (i == 4)
    {
      ...
      if (i == 1)
      {
        ...
        bgvo.d("WebViewFragmentBuilder", "tab_id =" + paramWebViewTabBarData.tag);
