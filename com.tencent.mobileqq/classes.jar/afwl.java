  ...
  implements RichProtoProc.RichProtoCallback
{
  ...
  private int a()
  {
    ArrayList localArrayList = this.jdField_a_of_type_Afwk.jdField_a_of_type_JavaUtilArrayList;
    int i = 0;
    for (;;)
    {
      try
      {
        Iterator localIterator = this.jdField_a_of_type_Afwk.jdField_a_of_type_JavaUtilArrayList.iterator();
  ...
  private im_msg_body.CustomFace a(im_msg_body.NotOnlineImage paramNotOnlineImage)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a() != null) {
        localCustomFace.bytes_signature.set(ByteStringMicro.copyFrom(this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a()));
      }
      ...
      for (;;)
      {
        ...
        Logger.a(this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.convert2CustomFace", afwk.a(this.jdField_a_of_type_Afwk, localCustomFace));
    ...
    {
      Logger.b(this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.convert2CustomFace", "Exception, " + paramNotOnlineImage.toString());
    }
  }
  ...
  private im_msg_body.NotOnlineImage a(im_msg_body.CustomFace paramCustomFace)
  {
    ...
    try
    {
      ...
      Logger.a(this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.createNotOnlineImage", "OK, " + afwk.a(this.jdField_a_of_type_Afwk, localNotOnlineImage));
      return localNotOnlineImage;
    }
    catch (Exception paramCustomFace)
    {
      Logger.a(this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.createNotOnlineImage", "Failed, Exception" + paramCustomFace.toString());
    }
    return null;
  }
  ...
  private void a()
  {
    int i = this.jdField_a_of_type_Afwk.b.size();
    int j = a();
    ...
    this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.a(6, 0, localPicResult);
  }
  
  private void b()
  {
    new afwm(this).execute(new Void[0]);
  }
  
  public void a(RichProto.RichProtoReq paramRichProtoReq, RichProto.RichProtoResp paramRichProtoResp)
  {
    Logger.a(this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.onBusiProtoResp", "start");
    ...
    if ((paramRichProtoReq != null) && (paramRichProtoResp != null))
    {
      ...
      {
        Object localObject1 = (PicFowardInfo)this.jdField_a_of_type_Afwk.b.get(i);
        PicResult localPicResult = (PicResult)this.jdField_a_of_type_Afwk.jdField_a_of_type_JavaUtilArrayList.get(i);
        ...
        if ((localObject2 instanceof RichProto.RichProtoResp.C2CPicUpResp))
        {
          ...
          {
            localObject2 = this.jdField_a_of_type_Afwk.a((RichProto.RichProtoReq.PicUpReq)paramRichProtoReq.a.get(i), (RichProto.RichProtoResp.C2CPicUpResp)localObject2, i);
            ...
            Logger.a(this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.onBusiProtoResp", "convert2CustomFace for [" + i + "] ");
          ...
          if (localObject2 != null)
          {
            ...
            if (QLog.isColorLevel())
            {
              ...
              if ((localObject2 instanceof RichProto.RichProtoResp.GroupPicUpResp))
              {
                ...
                {
                  localObject2 = this.jdField_a_of_type_Afwk.a((RichProto.RichProtoReq.PicUpReq)paramRichProtoReq.a.get(i), (RichProto.RichProtoResp.GroupPicUpResp)localObject2, i);
                  if ((((PicFowardInfo)localObject1).jdField_a_of_type_ComTencentMobileqqPicPicDownloadInfo.b == 1) || (((PicFowardInfo)localObject1).jdField_a_of_type_ComTencentMobileqqPicPicDownloadInfo.b == 3000))
                  {
                    if (localObject2 != null)
                    {
                  ...
                  {
                    Logger.a(this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.onBusiProtoResp", "convert2NotOnlineImage for [" + i + "] ");
    ...
    if (i > 0)
    {
      ...
      int k = 0;
      for (int j = 0; k < this.jdField_a_of_type_Afwk.jdField_a_of_type_JavaUtilArrayList.size(); j = i)
      {
        paramRichProtoReq = (PicFowardInfo)this.jdField_a_of_type_Afwk.b.get(k);
        paramRichProtoResp = (PicResult)this.jdField_a_of_type_Afwk.jdField_a_of_type_JavaUtilArrayList.get(k);
        if (QLog.isColorLevel()) {
        ...
        {
          i = j;
          if (!BasePicOprerator.a(this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator, paramRichProtoReq))
          {
            paramRichProtoReq.jdField_a_of_type_ComTencentMobileqqPicPicUploadInfo.g = MultiMsgManager.a(this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      if ((j != 0) && (!this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_Boolean))
      {
        this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_Boolean = true;
        this.jdField_a_of_type_Afwk.a(new Void[0]);
        return;
      }
      this.jdField_a_of_type_Afwk.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_Boolean = false;
      b();
      return;
    }
    afwk.a(this.jdField_a_of_type_Afwk);
  }
}
