...
public class bptc
{
  ...
  public bptc(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bptd(this, Looper.getMainLooper());
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bpte(this);
  ...
  protected Bitmap a(Bitmap paramBitmap)
  {
    ...
    return bgmo.a(paramBitmap, i, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
  }
  ...
  public Drawable a(String paramString, int paramInt1, int paramInt2)
  {
    if (TextUtils.isEmpty(paramString))
    {
      yqp.e("Q.qqstory.record.StoryFaceDrawableFactory", "getStoryFaceDrawable uin is null!");
      return null;
    }
    ...
    {
      localzoc = (zoc)this.jdField_a_of_type_AndroidSupportV4UtilLruCache.get(paramString);
      if (localzoc != null)
      {
        yqp.c("Q.qqstory.record.StoryFaceDrawableFactory", "getStoryFaceDrawable, hit cache:" + paramString);
        return localzoc;
      }
    }
    yqp.c("Q.qqstory.record.StoryFaceDrawableFactory", "getStoryFaceDrawable, not in cache:" + paramString);
    zoc localzoc = new zoc(paramInt1, paramInt2);
    this.jdField_a_of_type_AndroidSupportV4UtilLruCache.put(paramString, localzoc);
  ...
  public void a()
  {
    yqp.c("Q.qqstory.record.StoryFaceDrawableFactory", "onDestory");
    try
    {
    ...
    {
      yqp.e("Q.qqstory.record.StoryFaceDrawableFactory", "onDestory:" + localException.toString());
    }
  }
  
  public void a(bptf parambptf)
  {
    this.jdField_a_of_type_Bptf = parambptf;
  }
  
  protected void a(String paramString)
  {
    yqp.b("Q.qqstory.record.StoryFaceDrawableFactory", "sendQQHeadRequest uin:%s.", paramString);
