  ...
  extends SpannableStringBuilder
{
  ...
  static
  {
    jdField_a_of_type_AndroidTextEditable$Factory = new bdoe();
    jdField_b_of_type_AndroidTextEditable$Factory = new bdof();
  }
  
  public bdod(CharSequence paramCharSequence, int paramInt)
  {
    this(paramCharSequence, paramInt, 32);
  }
  
  public bdod(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
  ...
  private static final CharSequence a(CharSequence paramCharSequence, int paramInt1, int paramInt2)
  {
    if ((paramCharSequence instanceof bdnt)) {
      return ((bdnt)paramCharSequence).a();
    }
    return new bdnt(paramCharSequence, paramInt1, paramInt2).a();
  }
  ...
  public String a()
  {
    ...
    int k = "[emoji]".length();
    localObject1 = (bdoa[])getSpans(0, i, bdoa.class);
    i = 0;
    if (j < localObject1.length)
    {
      ...
      for (;;)
      {
        ...
        i += k - (n - m);
        continue;
        localObject2 = ((bdoa)localObject2).a();
        localStringBuffer.replace(m + i, n + i, (String)localObject2);
        i += ((String)localObject2).length() - (n - m);
        continue;
        localObject2 = arvq.a(((bdoa)localObject2).jdField_a_of_type_Int & 0x7FFFFFFF);
        localStringBuffer.replace(m + i, n + i, (String)localObject2);
        i += ((String)localObject2).length() - (n - m);
      }
    }
  ...
  public SpannableStringBuilder replace(int paramInt1, int paramInt2, CharSequence paramCharSequence, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      i = paramInt2;
      localObject = new bdnt(paramCharSequence, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int).a();
  ...
  public CharSequence subSequence(int paramInt1, int paramInt2)
  {
    ...
    localObject2 = (bdoa[])getSpans(i, paramInt1, bdoa.class);
    if (paramInt1 - i > 0)
    {
      paramInt2 = 0;
      if (paramInt2 < localObject2.length)
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ((StringBuilder)localObject1).replace(j - i, k - i, bdol.a(localObject3.jdField_a_of_type_Int));
          }
          ...
          continue;
          Object localObject4 = (bdoc)localException;
          localObject4 = arpm.a(((bdoc)localObject4).e, ((bdoc)localObject4).f);
          ...
          continue;
          ((StringBuilder)localObject1).replace(j - i, k - i, bdol.b(((bdoa)localObject4).jdField_a_of_type_Int));
        }
      }
    }
    return localObject1;
  ...
  public String toString()
  {
    ...
    if (i < localObject1.length)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        localStringBuilder.replace(k, m, bdol.a(((bdoa)localObject2).jdField_a_of_type_Int));
        continue;
        localObject2 = (bdoc)localObject2;
        localObject2 = arpm.a(((bdoc)localObject2).e, ((bdoc)localObject2).f);
        ...
        if (QLog.isColorLevel())
        {
          ...
          continue;
          localStringBuilder.replace(k, m, bdol.b(((bdoa)localObject2).jdField_a_of_type_Int));
          continue;
          if (QLog.isColorLevel()) {
