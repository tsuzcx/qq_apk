...
public class pjq
{
  ...
  private TemplateBean a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if ((paramBaseArticleInfo.mProteusTemplateBean != null) && (!((rpu)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusFactoryBaseTemplateFactory).a(paramBaseArticleInfo.mProteusTemplateBean))) {
          return paramBaseArticleInfo.mProteusTemplateBean;
        }
        if (this.jdField_a_of_type_Pfw == null) {
          return null;
        }
        JSONObject localJSONObject = this.jdField_a_of_type_Pfw.a(135, paramBaseArticleInfo);
        localTemplateBean = this.jdField_a_of_type_Pfw.a(135, localJSONObject);
        try
        {
  ...
  private void a(pax parampax, VafContext paramVafContext)
  {
    paramVafContext = parampax.a();
    if (paramVafContext != null)
    {
      parampax = paramVafContext.b(parampax.g() + 1);
      if ((parampax != null) && (parampax.mProteusTemplateBean == null)) {
        parampax.mProteusTemplateBean = a(parampax);
      }
    }
  }
  ...
  private static void b(ProteusItemView paramProteusItemView)
  {
    ...
    do
    {
      ...
      if ((localContainer != null) && (localContainer.getVisibility() == 8))
      {
        ...
        actn.a(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException("container.getVisibility() == View.GONE"));
      }
    ...
    actn.a(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException("proteusItemView.getVisibility() == View.GONE"));
  }
  ...
  public int a()
  {
    if (c == 2147483647)
    {
      actn.a(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException(ajyc.a(2131703571)));
      return this.b - 135;
    }
    return c - 135;
  }
  ...
  public int a(ArticleInfo paramArticleInfo)
  {
    ...
    {
      actn.a(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException(ajyc.a(2131703572)));
      return 135;
    }
  ...
  public ProteusItemView a(VafContext paramVafContext, int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localObject2;
        sai.a(str, (String)localObject3, "DynamicPTS.getView", l2 - l1);
        localObject1 = localObject2;
      }
      catch (Exception localException)
      {
        ...
        actn.a(jdField_a_of_type_JavaLangString, "getView:", new IllegalArgumentException(paramBaseArticleInfo.proteusItemsData, localException));
        continue;
      }
  ...
  public ProteusItemView a(VafContext paramVafContext, JSONObject paramJSONObject)
  {
    ...
    //   0: ldc_w 345
    //   3: iconst_1
    //   4: invokestatic 348	rpu:a	(Ljava/lang/String;Z)Lrpu;
    //   7: astore_3
    //   8: aload_3
    //   9: ifnull +64 -> 73
    //   12: aload_3
    //   13: aload_2
    //   14: invokevirtual 352	rpu:getTemplateBean	(Lorg/json/JSONObject;)Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;
    //   17: astore_2
    //   18: aload_1
    ...
    //   54: aconst_null
    //   55: aload_2
    //   56: invokestatic 357	olr:a	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/container/Container;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)V
    //   59: aload_3
    //   60: aload_2
    ...
    //   66: aload_1
    //   67: aload_2
    //   68: invokestatic 364	olr:a	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/container/Container;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/core/VafContext;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)V
    //   71: aload_3
    //   72: areturn
    //   73: aconst_null
    //   74: astore_2
    ...
    //   79: aconst_null
    //   80: astore_1
    //   81: getstatic 19	pjq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   84: iconst_1
    //   85: aload_2
    //   86: iconst_0
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, BaseArticleInfo paramBaseArticleInfo, VafContext paramVafContext, baxk parambaxk, rap paramrap, pax parampax, int paramInt2)
  {
    bfwd.a("DynamicPTS.bindData");
    long l1 = System.currentTimeMillis();
    ...
    if (pjs.a()) {
      pjs.a(jdField_a_of_type_JavaLangString, "[bindData] " + paramBaseArticleInfo + " adapterViewType: " + paramInt1);
    }
    Object localObject1 = localObject2;
    if (localObject2 != null)
    {
      ...
      if (localTemplateBean != null)
      {
        ...
        {
          bfwd.a("DynamicPTS.bindData.reuseView");
          localObject1 = paramVafContext.getViewFactory().inflate(paramVafContext, localTemplateBean);
          if (localObject1 != null)
          {
            ((Container)localObject1).setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841265));
            paramProteusItemView.d();
            paramProteusItemView.a((Container)localObject1);
            olr.a((Container)localObject1, null, localTemplateBean);
          }
          paramBaseArticleInfo.mProteusTemplateBean = localTemplateBean;
          localObject1 = null;
          bfwd.a();
    ...
    if (localTemplateBean != null)
    {
      bfwd.a("DynamicPTS.bindData.compareWithOldTemplateBean");
      olr.a((Container)localObject2, (TemplateBean)localObject1, localTemplateBean);
      bfwd.a();
    }
    bfwd.a("DynamicPTS.bindData.bindView");
    this.jdField_a_of_type_Pfw.a(paramInt1, (Container)localObject2, parampax, paramInt2);
    bfwd.a();
    olr.a(paramInt1, (Container)localObject2, paramVafContext, parambaxk, paramrap, parampax, paramBaseArticleInfo);
    a(parampax, paramVafContext);
    olr.a((Container)localObject2, parampax, localTemplateBean);
    long l2 = System.currentTimeMillis();
    ...
    {
      sai.a(paramBaseArticleInfo, paramProteusItemView, "DynamicPTS.bindData", l2 - l1);
      bfwd.a();
      return;
    }
  }
  ...
  public void a(VafContext paramVafContext)
  {
    ...
    this.jdField_a_of_type_Pfw = new pfw(paramVafContext);
