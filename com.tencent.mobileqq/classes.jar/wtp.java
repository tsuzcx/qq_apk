  ...
  implements wsp
{
  ...
  aojs jdField_a_of_type_Aojs = new wtq(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = xiz.b;
  }
      ...
      if (localIterator.hasNext())
      {
        ...
        else
        {
          ...
          if (((Iterator)localObject2).hasNext())
          {
            ...
            this.jdField_a_of_type_Aoip.a(str1, localTroopInfo.troopcode, (ArrayList)localObject1);
            localObject1 = new ArrayList(20);
            i = 1;
          }
        }
