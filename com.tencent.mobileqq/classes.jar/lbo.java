...
public class lbo
{
  private static lbk jdField_a_of_type_Lbk;
  private static lbl jdField_a_of_type_Lbl;
  
  /* Error */
  public static lbk a(Context paramContext)
  {
    // Byte code:
    //   0: getstatic 17	lbo:jdField_a_of_type_Lbk	Llbk;
    //   3: ifnonnull +81 -> 84
    //   6: aload_0
    //   7: ldc 19
    ...
    //   56: ldc 2
    //   58: monitorenter
    //   59: getstatic 17	lbo:jdField_a_of_type_Lbk	Llbk;
    //   62: astore_2
    //   63: aload_2
    //   64: ifnonnull +17 -> 81
    //   67: new 62	lbk
    ...
    //   73: iload_1
    //   74: i2l
    //   75: invokespecial 65	lbk:<init>	(Landroid/content/Context;IJ)V
    //   78: putstatic 17	lbo:jdField_a_of_type_Lbk	Llbk;
    //   81: ldc 2
    //   83: monitorexit
    //   84: getstatic 17	lbo:jdField_a_of_type_Lbk	Llbk;
    //   87: areturn
    //   88: astore_0
  ...
  public static lbl a(Context paramContext)
  {
    try
    {
      if (jdField_a_of_type_Lbl == null) {
        jdField_a_of_type_Lbl = new lbl(65536);
      }
      return jdField_a_of_type_Lbl;
    }
    finally {}
  }
  
  public static lbk b(Context paramContext)
  {
    if (jdField_a_of_type_Lbk == null) {
      ThreadManager.post(new TranslateCache.1(paramContext), 5, null, true);
    }
    return jdField_a_of_type_Lbk;
  }
}
