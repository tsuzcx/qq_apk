...
{
  public wwq(C2CMessageSearchDialog paramC2CMessageSearchDialog) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    String str = this.a.jdField_a_of_type_AndroidContentContext.getString(2131433829, new Object[] { paramEditable });
    int i = str.indexOf(paramEditable);
    SpannableString localSpannableString = new SpannableString(str);
    localSpannableString.setSpan(new ForegroundColorSpan(2131494270), 0, i, 18);
    localSpannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#0079ff")), i, paramEditable.length() + i, 34);
    localSpannableString.setSpan(new ForegroundColorSpan(2131494270), paramEditable.length() + i, str.length(), 33);
