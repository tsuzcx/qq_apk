  ...
  extends wxz
{
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new wwr(this));
  ...
  protected void a(Map<String, Object> paramMap)
  {
    if ((paramMap != null) && (!paramMap.isEmpty()) && (paramMap.containsKey("UrlDrawableDownloadJob_iiu"))) {
      this.jdField_a_of_type_JavaLangString = ((String)wyq.a(this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap, "UrlDrawableDownloadJob_iiu", this.jdField_a_of_type_JavaLangString));
    }
  }
