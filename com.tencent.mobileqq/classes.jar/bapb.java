  ...
  implements ITransactionCallback
{
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("GroupPicUploadProcessor", 2, "<BDH_LOG> Transaction End : Failed. New : SendTotalCost:" + (l1 - bapa.a(this.a)) + "ms");
    }
    ...
    this.a.a(paramInt, "OnFailed.", "", this.a.jdField_b_of_type_Bamy);
    this.a.d();
  }
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("GroupPicUploadProcessor", 2, "<BDH_LOG> Transaction End : Success. New : SendTotalCost:" + (l1 - bapa.a(this.a)) + "ms ,fileSize:" + this.a.jdField_a_of_type_Baoj.a + " transInfo:" + paramArrayOfByte);
    }
    ...
    this.a.jdField_a_of_type_JavaUtilHashMap.put("param_is_ipv6", paramHashMap.get("param_is_ipv6"));
    this.a.jdField_a_of_type_JavaUtilHashMap.put("param_net_ip_type", paramHashMap.get("param_net_ip_type"));
    this.a.jdField_b_of_type_Bamy.b();
    this.a.jdField_b_of_type_Bamy.a = 1;
    ...
    this.a.jdField_a_of_type_Baoj.a();
  ...
  public void onSwitch2BackupChannel()
  {
    ...
    this.a.jdField_a_of_type_JavaUtilHashMap.put("param_switchChannel", String.valueOf(l - bapa.a(this.a)));
  }
  
  public void onTransStart()
  {
    this.a.jdField_b_of_type_Bamy.a();
  }
  
  public void onUpdateProgress(int paramInt)
  {
    bapa localbapa = this.a;
    baoj localbaoj = this.a.jdField_a_of_type_Baoj;
    long l = paramInt;
    localbaoj.e = l;
    localbapa.s = l;
    if ((paramInt < this.a.jdField_q_of_type_Long) && (!this.a.jdField_o_of_type_Boolean) && (!this.a.k))
    {
      this.a.i();
      if (bapa.a(this.a)) {
        blyd.a(bapa.a(this.a), 1002, this.a.f());
      }
    }
  }
}
