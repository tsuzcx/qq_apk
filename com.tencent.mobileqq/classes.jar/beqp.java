  ...
  extends beht
{
  ...
  public beqp(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, TroopChatPie paramTroopChatPie)
  {
    ...
    localLayoutParams.addRule(7, 2131376511);
    localLayoutParams.addRule(6, 2131376511);
  ...
  public static void a(QQAppInterface paramQQAppInterface, ConfigurationService.Config paramConfig)
  {
    ...
    if (i != j)
    {
      paramConfig = aqlw.a(paramConfig);
      ...
      if ((paramConfig != null) && (paramConfig.size() > 0))
      {
        ...
        for (;;)
        {
          try
          {
            ...
            if (paramConfig.has("keywordConfigs"))
            {
              ...
              ((bezr)paramQQAppInterface.getManager(262)).a((String)localObject);
            }
        ...
        localObject = (behu)paramQQAppInterface.getManager(289);
        if ((((behu)localObject).a instanceof beqp))
        {
          ((beqp)((behu)localObject).a).a(l2);
          ((beqp)((behu)localObject).a).d();
        }
        ((bfaa)paramQQAppInterface.getManager(109)).a(paramConfig);
        localEditor.apply();
  ...
  {
    bftc.a(paramQQAppInterface, paramString, "homework", "AioAssign_Show", 0, 0, new String[] { paramString, "", "", bftc.a(paramQQAppInterface, paramString) });
    bftc.a(paramQQAppInterface, paramString, "Grp_notice", "CreateNotice_Show", 0, 0, new String[] { paramString, "", "", "" });
  }
  
  private boolean a()
  {
    apys localapys = apyt.a();
    return (localapys != null) && (localapys.g());
  }
  ...
  public void a(TroopChatPie paramTroopChatPie)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (paramTroopChatPie.a == null) {
        paramTroopChatPie.a = new ahpv(paramTroopChatPie.mActivity, paramTroopChatPie.sessionInfo, paramTroopChatPie.app.getCurrentAccountUin());
      }
  ...
  public void a(boolean paramBoolean, beza parambeza, TroopChatPie paramTroopChatPie)
  {
    TroopInfo localTroopInfo = ((TroopManager)paramTroopChatPie.app.getManager(52)).b(paramTroopChatPie.sessionInfo.curFriendUin);
    if ((localTroopInfo != null) && (localTroopInfo.isHomeworkTroop())) {
      if (parambeza != null) {
        beyy.a(paramTroopChatPie.app, paramTroopChatPie.sessionInfo.curFriendUin, paramTroopChatPie.app.getCurrentAccountUin(), parambeza, paramBoolean);
      }
    }
    while (!QLog.isColorLevel())
    {
      return;
      if (this.jdField_a_of_type_Beza == null) {
        this.jdField_a_of_type_Beza = new beqt(this, paramTroopChatPie);
      }
      beyy.a(paramTroopChatPie.app, paramTroopChatPie.sessionInfo.curFriendUin, paramTroopChatPie.app.getCurrentAccountUin(), this.jdField_a_of_type_Beza, paramBoolean);
      return;
    }
  ...
  {
    a(paramBoolean, new beqs(this), paramTroopChatPie);
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramBoolean = beyy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "homework_troop_aio_panel_tip_homework");
      if (QLog.isColorLevel()) {
      ...
      {
        a(1, 500L);
        beyy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "homework_troop_aio_panel_tip_homework", true);
        return;
      }
      paramBoolean = beyy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "homework_troop_aio_panel_tip_notification");
      if (QLog.isColorLevel()) {
    ...
    a(2, 500L);
    beyy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "homework_troop_aio_panel_tip_notification", true);
    return;
    label238:
    a();
  }
  ...
  public void c()
  {
    if ((this.jdField_a_of_type_Bjvq != null) && (this.jdField_a_of_type_Bjvq.isShowing()) && (this.jdField_a_of_type_Int > 0)) {
  ...
  public void c(TroopChatPie paramTroopChatPie)
  {
    ...
    {
      localafqv = (afqv)paramTroopChatPie.getHelper(73);
      if ((localafqv != null) && ((localafqv.a == null) || (!localafqv.a.a(paramTroopChatPie.getTipManager())))) {
        break label40;
      }
    }
    label40:
    ...
    {
      return;
      avcl localavcl = (avcl)paramTroopChatPie.getHelper(33);
      if ((localavcl == null) || (!localavcl.c())) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    return;
    if (localafqv.a == null) {
      localafqv.a = new ahps(paramTroopChatPie.mActivity, paramTroopChatPie.sessionInfo);
    }
    localafqv.a.a(paramTroopChatPie.getTipManager(), true);
    bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800B27F", "0X800B27F", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "", "", "");
  }
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramBoolean))
    {
      ...
      if (!bool)
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new beqq(this));
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843803);
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      bftc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "homework", "AioSee_Show", 0, 0, new String[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, "", "", bftc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin) });
  ...
  public void d(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramBoolean) && (!bool))
    {
      if (this.jdField_a_of_type_ComTencentMobileqqTroopWidgetRedDotAnimateView.getVisibility() != 0) {
        bftc.a("Grp_edu", "homework", "AioSee_Reddot_Show", 0, 0, new String[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin });
      }
  ...
  public void e(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramBoolean))
    {
      int i = beyy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin);
      if (QLog.isColorLevel()) {
