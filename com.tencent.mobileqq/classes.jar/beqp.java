...
public class beqp
{
  private static final String jdField_a_of_type_JavaLangString = "WriteTogether." + beqp.class.getSimpleName();
  ...
  void a(BaseWriteTogetherMsg paramBaseWriteTogetherMsg)
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      ((benm)((QQAppInterface)localAppRuntime).getManager(QQManagerFactory.WRITE_TOGETHER_MANAGER)).a(paramBaseWriteTogetherMsg);
    }
  }
