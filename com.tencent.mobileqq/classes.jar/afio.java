  ...
  implements amlm
{
  ...
  public afio(QQSettingMe paramQQSettingMe)
  {
  ...
  public void a(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      paramBundle = localQQSettingMe.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getSharedPreferences("apollo_sp" + localQQSettingMe.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 0);
    ...
    return;
    localQQSettingMe.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.requestPermissions(new afip(this, localQQSettingMe), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
