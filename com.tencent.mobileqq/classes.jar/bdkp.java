  ...
  implements View.OnTouchListener
{
  ...
  private bdkp(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_b_of_type_JavaLangString = paramString2;
    Friends localFriends = ((aloz)paramQQAppInterface.getManager(51)).e(paramString1);
    int i;
    if (localFriends != null)
    {
      if (!bdkn.a(localFriends.nameplateVipType)) {
        break label166;
      }
      paramQQAppInterface = bdko.a(localFriends.nameplateVipType);
      if (!bdkn.b(localFriends.grayNameplateFlag)) {
        break label116;
      }
      i = 1;
      this.c = i;
      this.jdField_a_of_type_Int = paramQQAppInterface.jdField_a_of_type_Int;
      if ((paramQQAppInterface != bdko.f) && (paramQQAppInterface != bdko.g)) {
        break label122;
      }
    ...
    do
    {
      do
      {
        ...
        i = 0;
        break;
        if ((paramQQAppInterface == bdko.d) || (paramQQAppInterface == bdko.e))
        {
          this.jdField_b_of_type_Int = localFriends.superVipTemplateId;
          return;
        }
      } while ((paramQQAppInterface != bdko.b) && (paramQQAppInterface != bdko.c));
  ...
  public static bdkp a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    return new bdkp(paramQQAppInterface, paramString1, paramString2);
  }
  ...
  {
    if (!bdsk.a.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "namePlate_UrlConfig")) {
    ...
    {
      paramMotionEvent = bdsk.a.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.c);
      ...
      bool = true;
      bdkn.b((String)localObject1, i, bool);
