...
{
  private static volatile bdkp jdField_a_of_type_Bdkp;
  ...
  private bdkp(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext.getApplicationContext();
    this.jdField_a_of_type_Boolean = bdkk.a(this.jdField_a_of_type_AndroidContentContext, true);
  }
  
  public static bdkp a(Context paramContext)
  {
    if (jdField_a_of_type_Bdkp == null) {}
    try
    {
      if (jdField_a_of_type_Bdkp == null) {
        jdField_a_of_type_Bdkp = new bdkp(paramContext);
      }
      return jdField_a_of_type_Bdkp;
    }
    finally {}
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    for (Object localObject = (QQAppInterface)localObject;; localObject = null)
    {
      ...
      bdla.b((QQAppInterface)localObject, "dc00898", "", "", "0X80075F3", "0X80075F3", 0, 0, new SimpleDateFormat("yyyyMMdd", Locale.US).format(localDate), "", "", "");
      MTAReportManager.setMTAReporter(jdField_a_of_type_Bdkp);
