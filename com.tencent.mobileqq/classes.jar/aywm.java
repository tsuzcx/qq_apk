...
public class aywm
{
  ...
  static
  {
    ...
    jdField_b_of_type_Int = (int)bbdv.a(localBaseApplication, 45.0F);
    c = (int)bbdv.a(localBaseApplication, 135.0F);
  ...
  public static Bitmap a()
  {
    ...
    {
      localBitmap1 = baxi.a(BaseApplicationImpl.getContext().getResources(), 2130839139);
  ...
  public static Drawable a()
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = baxi.a(BaseApplicationImpl.getContext().getResources(), 2130837912);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
  ...
  public static Drawable a(int paramInt)
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = baxi.a(BaseApplicationImpl.getContext().getResources(), paramInt);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
  ...
  public static URLDrawable a(auoc paramauoc, int paramInt)
  {
    return a(paramauoc, paramInt, null, null);
  }
  
  public static URLDrawable a(auoc paramauoc, int paramInt, String paramString, URLDrawable.URLDrawableOptions paramURLDrawableOptions)
  {
    boolean bool2 = true;
    if (paramauoc == null) {
      return null;
    }
    paramString = URLDrawable.getDrawable(a(paramauoc, paramInt, paramString), paramURLDrawableOptions);
    paramString.setTag(paramauoc);
    if (paramauoc.isSendFromLocal()) {}
    for (;;)
    {
      return paramString;
      if (!aunm.jdField_b_of_type_Boolean) {
        break;
      }
      paramString.setAutoDownload(true);
    }
    boolean bool3 = SettingCloneUtil.readValue(BaseApplication.getContext(), null, BaseApplication.getContext().getString(2131695322), "qqsetting_auto_receive_pic_key", true);
    boolean bool1 = bool2;
  ...
  private static String a(aunj paramaunj)
  {
    if (paramaunj == null) {
      return null;
    }
    switch (paramaunj.jdField_b_of_type_Int)
    {
    default: 
      return null;
    case 0: 
  ...
  private static String a(aunj paramaunj, int paramInt)
  {
    int n;
    String str;
    if (paramInt == 65537)
  ...
  public static URL a(aunn paramaunn, int paramInt, String paramString)
  {
    if (paramaunn == null) {
      return null;
    }
    String str1 = paramaunn.f;
    label48:
    String str2;
    if ((str1 != null) && (!"null".equals(str1)) && (!"".equals(str1)))
    {
      if (paramaunn.jdField_b_of_type_Boolean) {
        paramInt = 1;
      }
      if (paramString == null) {
        break label184;
    ...
    for (;;)
    {
      try
      {
        ...
        if (QLog.isColorLevel())
        {
          QLog.e("URLDrawableHelper", 2, "getURL file == null" + paramaunn.toString());
          str2 = str1;
        }
        if (paramString == null) {
          break label200;
        }
        paramaunn = new URL(paramString, null, str2);
        return paramaunn;
      }
      catch (MalformedURLException paramaunn)
      {
        label184:
        paramaunn.printStackTrace();
        return null;
      }
      if ((paramaunn.jdField_b_of_type_Int == 8000) && (paramInt == 65537))
      {
        if (axqh.a())
        {
          str1 = paramaunn.k;
      ...
      str1 = paramaunn.g;
      break;
      paramString = a(paramaunn, paramInt);
      break label48;
      label200:
      paramaunn = null;
    }
  ...
  public static URL a(auoc paramauoc, int paramInt)
  {
    return a(paramauoc, paramInt, null);
  }
  
  public static URL a(auoc paramauoc, int paramInt, String paramString)
  {
    if (paramauoc == null) {
      return null;
    }
    if (paramauoc.isSendFromLocal()) {
      return a(paramauoc.getPicUploadInfo(), paramInt, paramString);
    }
    return a(paramauoc.getPicDownloadInfo(), paramInt, paramString);
  }
  
  public static URL a(auod paramauod, int paramInt, String paramString)
  {
    if (paramauod == null) {
      return null;
    }
    if (paramauod.d < 4) {}
    for (String str2 = a(paramauod);; str2 = null)
    {
      String str3 = a(paramauod, paramInt);
      if ((paramauod.jdField_b_of_type_Int == 8000) && (paramInt == 65537)) {}
      for (String str1 = paramauod.h;; str1 = "") {
        for (;;)
        {
          if (str1 != null) {}
          try
          {
            if (("".equals(str1)) && (QLog.isColorLevel())) {
              QLog.e("URLDrawableHelper", 2, "getURL file == null" + paramauod.toString());
            }
            if (paramString != null)
            {
              paramauod = new URL(paramString, str2, str1);
              return paramauod;
              if ((paramauod.f != null) && (!"".equals(paramauod.f)))
              {
                str1 = paramauod.f;
                continue;
              }
              if ((paramauod.a != null) && (!"".equals(paramauod.a)))
              {
                str1 = paramauod.a;
                continue;
              }
              if ((paramauod.g != null) && (!"".equals(paramauod.g))) {
                str1 = paramauod.g;
              }
            }
            else
            {
              ...
              paramauod = new URL(str3, str2, str1);
              return paramauod;
            }
          }
          catch (MalformedURLException paramauod)
          {
            paramauod.printStackTrace();
            return null;
          }
        }
      }
  ...
  public static boolean a(Context paramContext, auoc paramauoc, int paramInt)
  {
    return ayoi.a(a(paramauoc, paramInt).toString()) != null;
  }
  ...
  public static Drawable b()
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = baxi.a(BaseApplicationImpl.getContext().getResources(), 2130837909);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
  ...
  public static URLDrawable b(auoc paramauoc, int paramInt)
  {
    URLDrawable localURLDrawable = URLDrawable.getDrawable(a(paramauoc, 65537));
    ...
    {
      localURLDrawable.setTargetDensity(d);
      localURLDrawable.setTag(paramauoc);
  ...
  public static void b()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 500	aywm:jdField_b_of_type_Boolean	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +7 -> 15
    //   11: ldc 2
    ...
    //   53: putstatic 61	aywm:m	I
    //   56: iconst_1
    //   57: putstatic 500	aywm:jdField_b_of_type_Boolean	Z
  ...
  {
    return SettingCloneUtil.readValue(BaseApplication.getContext(), null, BaseApplication.getContext().getString(2131695322), "qqsetting_auto_receive_pic_key", true);
  }
  ...
  public static Drawable c()
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = baxi.a(BaseApplicationImpl.getContext().getResources(), 2130843721);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
