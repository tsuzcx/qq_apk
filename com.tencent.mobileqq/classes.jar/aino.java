  ...
  extends BaseAdapter
{
  ...
  public aino(NewTroopSearchResultDialog paramNewTroopSearchResultDialog, List paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopNewTroopSearchResultDialog.getContext()).inflate(2130969867, null);
      paramViewGroup = new ainp(this.jdField_a_of_type_ComTencentMobileqqTroopCreateNewTroopNewTroopSearchResultDialog);
      ...
      paramViewGroup.b = ((TextView)paramView.findViewById(2131363183));
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131365532);
    ...
    for (paramInt = 4;; paramInt = 113)
    {
      ...
      return paramView;
      paramViewGroup = (ainp)paramView.getTag();
      break;
