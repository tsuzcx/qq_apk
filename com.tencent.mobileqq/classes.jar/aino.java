...
public class aino
  extends aiml
{
  aino(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  public boolean addAndRemovePhotoByGesture(LocalMediaInfo paramLocalMediaInfo, boolean paramBoolean)
  {
    ...
    {
      b(String.format(((NewPhotoListActivity)this.mActivity).getString(2131689820), new Object[] { Integer.valueOf(this.mPhotoCommonData.maxSelectNum) }));
      return false;
    }
  ...
  public void onSendBtnClick(View paramView)
  {
    if (b())
    {
      b(String.format(((NewPhotoListActivity)this.mActivity).getString(2131689821), new Object[] { Integer.valueOf(this.mPhotoCommonData.maxSelectNum) }));
      return;
    }
