...
public class aqlw
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    aqme.a(paramQQAppInterface.getApp(), paramString1);
    ...
    for (;;)
    {
      ThreadManagerV2.executeOnSubThread(new HuayangOpenHelper.1(paramString1, aqln.a(paramQQAppInterface.getApp(), paramString6, paramString1), paramQQAppInterface, paramString3, paramString5, paramString4));
      a(paramString2, paramString2);
      return;
      if (!"download".equals(paramString5)) {
        break;
      }
      if (aqlr.a(paramString6))
      {
        aqmd.a("2691701");
        break;
      }
      if (aqlr.b(paramString6))
      {
        aqmd.a("2597718");
        break;
      }
      aqme.b(paramQQAppInterface.getApp(), paramString1);
      break;
    }
  }
  ...
  private static void a(String paramString1, String paramString2)
  {
    ...
    urp.a("huayang", "openHy", 0, 0, new String[] { str, paramString2 });
  }
}
