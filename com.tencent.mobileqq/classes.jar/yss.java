...
public class yss
{
  ...
  private static int a(ytb paramytb)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 30	ytb:b	()Ljava/lang/String;
    ...
    //   557: aload 8
    //   559: invokestatic 134	yss:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   562: aload 6
    //   564: astore 4
    //   566: aload 8
  ...
  public static void a(Context paramContext)
  {
    ...
    ytb localytb = ytc.a(paramContext, "dex");
    if ((jdField_a_of_type_Int == 0) && (a(paramContext, localytb)))
    {
      a(localytb);
      int j;
      if (jdField_a_of_type_Int == 500) {
        if ((localytb.b()) && (PatchCommonUtil.isArtGeN()) && (!SoLoadUtil.a()))
        {
          j = a(localytb);
          i = j;
          if (j != 800)
          {
            String str = ajst.a(BaseApplicationImpl.sApplication, 0);
      ...
      for (int i = j;; i = 0)
      {
        a(paramContext, localytb);
        PatchReporter.reportPatchEvent(paramContext, "", "actPatchInstall", jdField_a_of_type_Int, localytb.b(), i);
        ...
        if (PatchCommonUtil.isDalvik()) {
          PatchResolveForDalvik.a(paramContext, localytb);
        }
      }
    }
  ...
  private static void a(Context paramContext, ytb paramytb)
  {
    paramContext = new DexPatchInstaller.1(paramytb, paramContext);
  ...
  private static void a(ytb paramytb)
  {
    long l = System.currentTimeMillis();
    try
    {
      paramytb = paramytb.b();
      String str = PatchCommonUtil.getPatchPath(paramytb);
      if ("Success".equals(ajst.a(BaseApplicationImpl.sApplication, str, null, false)))
      {
        jdField_a_of_type_Int = 500;
        jdField_a_of_type_JavaLangString = paramytb;
      }
      for (;;)
      {
    ...
    catch (Throwable paramytb)
    {
      for (;;)
      {
        jdField_a_of_type_Int = 502;
        QLog.d("PatchLogTag", 1, "DexPatchInstaller injectDexPatch throwable=" + paramytb);
      }
    }
  }
  
  private static boolean a(Context paramContext, ytb paramytb)
  {
    if (paramytb == null) {
      QLog.d("PatchLogTag", 1, "DexPatchInstaller checkDexPatchConfigAndStatus patch config is null");
    }
    while (!paramytb.a(paramContext, true)) {
      return false;
    }
    String str = paramytb.b();
    ...
    if (localFile.length() != paramytb.b())
    {
