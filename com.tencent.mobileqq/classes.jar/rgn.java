  ...
  implements rgr
{
  ...
  public rgn(Activity paramActivity)
  {
  ...
  private static void b(boolean paramBoolean, int paramInt, KandianMsgBoxRedPntInfo paramKandianMsgBoxRedPntInfo)
  {
    ...
    for (;;)
    {
      try
      {
        localono.k(1037);
        localono.a(0);
        localono.a("message_type", String.valueOf(paramKandianMsgBoxRedPntInfo.messageType));
        localono.a("feedsid", String.valueOf(paramKandianMsgBoxRedPntInfo.feedsID));
        localono.a("feedstype", String.valueOf(paramKandianMsgBoxRedPntInfo.feedsType));
        if (paramKandianMsgBoxRedPntInfo.mMsgType == 2)
        {
          localono.a("sys_msg_id", String.valueOf(paramKandianMsgBoxRedPntInfo.sysMsgID));
          localono.a("sys_msg_from", String.valueOf(paramKandianMsgBoxRedPntInfo.sysMsgFrom));
        }
        localono.a("reddot_num", String.valueOf(paramKandianMsgBoxRedPntInfo.mMsgCnt));
        localono.b("msgbox1000000000");
        if (paramBoolean) {
          break label220;
        }
        localono.a("behavior_type", String.valueOf(paramInt));
      }
      ...
      nol.a(null, "CliOper", "", String.valueOf(paramKandianMsgBoxRedPntInfo.mUin), str, str, 0, 0, String.valueOf(paramKandianMsgBoxRedPntInfo.mUin), "", "", localono.a(), false);
      return;
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setOnClickListener(new rgo(this));
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject2)) {
          localObject1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131694396);
        }
        localJSONObject.put("msgbox_redpoint_content", new aykk(axau.b((String)localObject1), 7, 17));
        ...
        localJSONObject.put("msgbox_redpoint_count", String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131694397), new Object[] { bhvy.b(paramKandianMsgBoxRedPntInfo.mMsgCnt) }));
        ...
        {
          localTemplateBean = ProteusParser.getTemplateBean(rpr.a("default_feeds", true), localJSONObject);
        }
