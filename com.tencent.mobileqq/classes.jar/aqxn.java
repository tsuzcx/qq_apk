  ...
  extends akfz
{
  ...
  public aqxn(Context paramContext)
  {
  ...
  public void b(boolean paramBoolean, Object paramObject)
  {
    ...
    Object localObject = aqxh.a(localContext);
    if ((localObject != null) && (((bcpq)localObject).isShowing())) {
      ((bcpq)localObject).dismiss();
    }
    label124:
    int j;
    if ((paramBoolean) && ((paramObject instanceof Object[])))
    {
      ...
      if (arrayOfObject.length >= 5)
      {
        ...
        for (paramObject = (String)arrayOfObject[3];; paramObject = null)
        {
          ...
          aqxh.a(localContext, (byte[])localObject, j);
          aqxh.b.set(false);
          return;
          i = -1;
          break;
    ...
    {
    default: 
      bcpw.a(localContext, 1, ajyc.a(2131705470), 0).a();
      aqxh.b.set(false);
      return;
    case 1: 
      label234:
      ...
      ((Bundle)localObject).putInt("key_hiboom_type", aqxh.a(j));
      paramObject = new Intent();
      paramObject.putExtras((Bundle)localObject);
      aqbc.a((Activity)localContext, paramObject, 21);
      return;
    }
    if ((localContext instanceof FragmentActivity))
    {
      ...
      if ((((FragmentActivity)localObject).getChatFragment() != null) && (((FragmentActivity)localObject).getChatFragment().a() != null))
      {
        ...
        ((aqxh)((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(219)).a((BaseChatPie)localObject, paramObject, j, aqxh.a(j));
  ...
  public void c(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean)
      {
        ...
        if (localObject.length >= 5)
        {
          ...
          for (localObject = (String)localObject[4];; localObject = null)
          {
            ...
            aqxh.a(localContext, paramObject, j);
            aqxh.b.set(false);
            return;
            i = -1;
            break label102;
          ...
          if (paramBoolean)
          {
            if ((localContext instanceof FragmentActivity))
            {
              ...
              if ((paramObject.getChatFragment() != null) && (paramObject.getChatFragment().a() != null))
              {
                ...
                ((aqxh)paramObject.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(219)).a(paramObject, (String)localObject, j, aqxh.a(j));
                paramObject.aC();
          ...
          ((akfw)((QQAppInterface)paramObject).a(13)).b();
          return;
        }
        paramBoolean = false;
      }
      while (paramBoolean)
      {
        bcpw.a(localContext, 1, ajyc.a(2131705467), 0).a();
        aqxh.b.set(false);
        return;
