  ...
  extends MSFServlet
{
  ...
  private void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        notifyObserver(paramIntent, 26, false, localBundle, aume.class);
        return;
      }
      ...
      for (;;)
      {
        ...
        notifyObserver(paramIntent, 26, true, localBundle, aume.class);
        return;
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), aumg.class);
  ...
  private void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      if (localRespondHeader == null)
      {
        ...
        notifyObserver(paramIntent, 27, false, localBundle, aume.class);
        return;
      }
      if (localRespondHeader.result == 0)
      {
      ...
      notifyObserver(paramIntent, 27, true, localBundle, aume.class);
      return;
    }
    localBundle.putBoolean("bind_state", false);
    notifyObserver(paramIntent, 27, false, localBundle, aume.class);
  ...
  private void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      for (;;)
      {
        ...
        notifyObserver(paramIntent, 12, true, localBundle, aume.class);
        return;
    ...
    notifyObserver(paramIntent, 12, false, null, aume.class);
  }
  ...
  private void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      for (;;)
      {
        notifyObserver(paramIntent, 35, true, localBundle, aume.class);
        return;
    ...
    notifyObserver(paramIntent, 35, false, null, aume.class);
  }
  ...
  private void e(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        notifyObserver(paramIntent, 19, true, (Bundle)localObject, aume.class);
        return;
      }
      if (QLog.isColorLevel()) {
        QLog.d("PhoneContact.Servlet", 2, "BindNumberBusiness  rebind failed ,返回码不正确");
      }
      notifyObserver(paramIntent, 19, false, (Bundle)localObject, aume.class);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("PhoneContact.Servlet", 2, "BindNumberBusiness  rebind failed ,response isSuccess = false");
    }
    notifyObserver(paramIntent, 19, false, null, aume.class);
  }
  ...
  private void f(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      if ((paramFromServiceMsg.result == 0) || (paramFromServiceMsg.result == 105))
      {
        ...
        notifyObserver(paramIntent, 20, true, null, aume.class);
        return;
      }
      notifyObserver(paramIntent, 20, false, null, aume.class);
      return;
    }
    notifyObserver(paramIntent, 20, false, null, aume.class);
  }
  ...
  private void g(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        a().i();
        notifyObserver(paramIntent, 33, true, null, aume.class);
        return;
      }
      notifyObserver(paramIntent, 33, false, null, aume.class);
      return;
    }
    notifyObserver(paramIntent, 33, false, null, aume.class);
  }
  ...
  private void h(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      Bundle localBundle = new Bundle();
      localBundle.putInt("k_result", paramFromServiceMsg.result);
      notifyObserver(paramIntent, 16, true, localBundle, aume.class);
      return;
    }
    notifyObserver(paramIntent, 16, false, null, aume.class);
  }
  ...
  private void i(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    NewIntent localNewIntent = new NewIntent(getAppRuntime().getApplication(), aumg.class);
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      if (((RespondHeader)localObject).result == 0)
      {
        ...
        notifyObserver(paramIntent, 14, true, null, aume.class);
        return;
      }
      if ((((RespondHeader)localObject).result == 105) || (((RespondHeader)localObject).result == 107))
      {
        ...
        notifyObserver(paramIntent, 14, false, paramFromServiceMsg, aume.class);
        return;
      }
  ...
  private void j(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    try
    {
      ...
      localNewIntent = new NewIntent(getAppRuntime().getApplication(), aumg.class);
      ...
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        if (((RespondHeader)localObject1).result == 0)
        {
          ...
          for (j = (j + 50) * 100 / ((ArrayList)localObject1).size();; j = 100)
          {
            ...
            notifyObserver(paramIntent, 100, true, (Bundle)localObject2, aume.class);
            if (paramFromServiceMsg.nextFlag == 4294967295L) {
              break label550;
            }
            localNewIntent.putExtra("next_flag", paramFromServiceMsg.nextFlag);
          ...
          label550:
          notifyObserver(paramIntent, 31, true, null, aume.class);
          return;
        }
        if ((((RespondHeader)localObject1).result == 105) || (((RespondHeader)localObject1).result == 107))
        {
          ...
          paramFromServiceMsg = new Bundle();
          paramFromServiceMsg.putInt("param_fail_reason", 1);
          notifyObserver(paramIntent, 31, false, paramFromServiceMsg, aume.class);
          return;
        }
  ...
  private void k(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      {
        notifyObserver(paramIntent, 37, false, null, aume.class);
        return;
      }
      continue;
      label529:
    ...
    notifyObserver(paramIntent, 37, true, null, aume.class);
    return;
    label554:
    if ((((RespondHeader)localObject1).result == 109) || (((RespondHeader)localObject1).result == 108))
    {
      ...
      if (((RespondHeader)localObject1).result == 109)
      {
        i = 4;
        paramFromServiceMsg.putInt("param_fail_reason", i);
        notifyObserver(paramIntent, 37, false, paramFromServiceMsg, aume.class);
      }
    }
    else
    {
  ...
  private void l(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        paramIntent = new NewIntent(getAppRuntime().getApplication(), aumg.class);
      ...
      notifyObserver(paramIntent, 32, true, null, aume.class);
      return;
      label456:
      notifyObserver(paramIntent, 32, false, null, aume.class);
      return;
    }
    notifyObserver(paramIntent, 32, false, null, aume.class);
  }
  ...
  private void m(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      do
      {
        ...
        notifyObserver(paramIntent, 15, true, null, aume.class);
    ...
    if (((RespondHeader)localObject).result == 105)
    {
      ...
      paramFromServiceMsg = new Bundle();
      paramFromServiceMsg.putInt("param_fail_reason", 1);
      notifyObserver(paramIntent, 15, false, paramFromServiceMsg, aume.class);
      return;
    }
    if (localBundle.getBoolean("is_resend"))
    {
  ...
  private void n(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      do
      {
        ...
        notifyObserver(paramIntent, 38, true, null, aume.class);
      } while (!localBundle.containsKey("add_contact_list"));
      paramIntent = (ArrayList)localBundle.getSerializable("rename_contact_list");
    } while (paramIntent.size() == 0);
    a().a(paramIntent);
    ...
    if ((paramFromServiceMsg.result == 109) || (paramFromServiceMsg.result == 108))
    {
      ...
      for (i = 4;; i = 5)
      {
        ...
        notifyObserver(paramIntent, 38, false, localBundle, aume.class);
        return;
      }
    }
    if (localBundle.getBoolean("is_resend"))
    {
      ...
      {
        paramFromServiceMsg.putInt("param_fail_reason", i);
        notifyObserver(paramIntent, 38, false, paramFromServiceMsg, aume.class);
        return;
      }
    }
    localNewIntent.putExtra("next_flag", ((ResponeUpdateAddressBookNotBind)localObject).nextFlag);
  ...
  private void o(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    if (paramFromServiceMsg.isSuccess())
    {
      if (((RespondHeader)decodePacket(paramFromServiceMsg.getWupBuffer(), "RespondHeader", new RespondHeader())).result == 0)
      {
        notifyObserver(paramIntent, 17, true, null, aume.class);
        return;
      }
      notifyObserver(paramIntent, 17, false, null, aume.class);
      return;
    }
    notifyObserver(paramIntent, 17, false, null, aume.class);
  }
  ...
  private void p(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
        ...
        if ((localObject != null) && (paramFromServiceMsg != null))
        {
          ...
          if (((RespondHeader)localObject).result == 0)
          {
            ...
            if (paramFromServiceMsg.queryFlag == 1)
            {
              ...
              int k = a().c();
              localObject = new NewIntent(getAppRuntime().getApplication(), aumg.class);
      ...
      for (int i = 1;; i = 0)
      {
        ...
        notifyObserver(paramIntent, 30, false, null, aume.class);
        return;
        bool = false;
        break label325;
        label614:
        ...
        notifyObserver(paramIntent, 12, true, (Bundle)localObject, aume.class);
        localObject = new Bundle();
        ((Bundle)localObject).putInt("param_update_flag", j);
        notifyObserver(paramIntent, 30, true, (Bundle)localObject, aume.class);
        break label556;
        if ((((RespondHeader)localObject).result == 105) || (((RespondHeader)localObject).result == 107))
        {
          a(paramFromServiceMsg);
  ...
  private void q(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        notifyObserver(paramIntent, 34, false, localBundle, aume.class);
        return;
      }
      if (QLog.isColorLevel()) {
      ...
      if (paramFromServiceMsg.result == 0)
      {
        ...
        notifyObserver(paramIntent, 34, true, localBundle, aume.class);
        return;
      }
      notifyObserver(paramIntent, 34, false, localBundle, aume.class);
      return;
