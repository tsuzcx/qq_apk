...
public class pfr
{
  ...
  {
    SharedPreferences localSharedPreferences = bnrf.a(ozs.a(), true, true);
  ...
  public static boolean a(pfn parampfn)
  {
    if (a()) {
      return true;
    }
    ThreadManager.post(new ReadInjoyWebRenderSoLoader.1(parampfn), 8, null, true);
    return false;
  }
