...
public class aydm
{
  ...
  public aydm(AppInterface paramAppInterface)
  {
  ...
  public void a(long paramLong1, long paramLong2, int paramInt1, int paramInt2, boolean paramBoolean, aydt paramaydt)
  {
    ...
    for (paramInt2 = 1;; paramInt2 = 2)
    {
      ...
      nkm.a(this.a, new aydr(this, paramaydt), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
    }
  }
  
  public void a(long paramLong, String paramString, aydt paramaydt)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      nkm.a(this.a, new ayds(this, paramaydt), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
    }
  }
  
  public void a(String paramString, aydt paramaydt)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      nkm.a(this.a, new aydo(this, paramaydt), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
    }
  }
  
  public void a(String paramString, aydt paramaydt, Bundle paramBundle)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      nkm.a(this.a, new aydn(this, paramaydt), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, paramBundle, 0L);
    }
  }
  
  public void b(String paramString, aydt paramaydt)
  {
    ...
    if (a(localReqBody))
    {
      ...
      nkm.a(this.a, new aydq(this, paramString, paramaydt), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
    }
  }
  
  public void b(String paramString, aydt paramaydt, Bundle paramBundle)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      nkm.a(this.a, new aydp(this, paramaydt), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, paramBundle, 0L);
    }
  }
}
