  ...
  extends ViewModel
{
  ...
  @NotNull
  private final MutableLiveData<acdi> jdField_a_of_type_AndroidArchLifecycleMutableLiveData = new MutableLiveData();
  ...
  static
  {
    jdField_a_of_type_Acdf = new acdf(null);
  }
    ...
    try
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject3))
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)paramString))
        {
          ...
          paramString.setValue(new acdi(0, (String)localObject1, 0, 4, null));
          return;
        }
      }
    }
  ...
  @NotNull
  public final MutableLiveData<acdi> a()
  {
  ...
  public final void a(int paramInt)
  {
    ...
    this.jdField_b_of_type_RxSubscription = Observable.timer(5L, TimeUnit.SECONDS, AndroidSchedulers.mainThread()).subscribe((Action1)new acdg(this));
  }
  
  public final boolean a(@NotNull String paramString, @Nullable aced paramaced)
  {
    ...
    if (paramaced != null)
    {
      ...
      Intrinsics.checkExpressionValueIsNotNull(paramaced, "model.adInfo");
      a(0, (String)localObject, paramaced);
      a(paramString);
    }
    for (;;)
    {
      ...
      if (StringsKt.startsWith$default(paramString, "gdtmsg://e.qq.com/reportClickRewardAd/rewardAD/", false, 2, null))
      {
        ...
        paramaced = paramaced.a();
        Intrinsics.checkExpressionValueIsNotNull(paramaced, "model.adInfo");
        a(1, (String)localObject, paramaced);
        a(paramString);
      }
      else
      {
  ...
  public final void b()
  {
    ...
    {
      this.jdField_a_of_type_AndroidArchLifecycleMutableLiveData.setValue(new acdi(1, null, this.jdField_b_of_type_Int, 2, null));
      this.jdField_a_of_type_RxSubscription = Observable.interval(1L, TimeUnit.SECONDS, AndroidSchedulers.mainThread()).subscribe((Action1)new acdh(this));
    }
  }
