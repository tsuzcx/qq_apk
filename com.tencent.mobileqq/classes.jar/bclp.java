  ...
  extends bcgw
{
  ...
  public bclp()
  {
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bclq(this);
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bclr(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramBundle = paramBundle.getDrawable(2130841771);
        if (TextUtils.isEmpty(this.ac))
        {
          ...
          paramView.setContentDescription(paramBundle.getString(2131694169));
          paramView.setDisplayRuleDef(bhct.a);
          paramView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
          paramView.setContentDescription(paramBundle.getText(2131718615));
        }
      }
  ...
  public boolean a(bcin parambcin)
  {
    ...
    this.ae = parambcin.a("video_info");
