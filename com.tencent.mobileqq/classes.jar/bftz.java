...
class bftz
  extends Handler
{
  bftz(bfty parambfty, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  {
    if (this.a.jdField_a_of_type_Bfub == null) {}
    ...
    do
    {
      ...
      case 0: 
        ...
        this.a.jdField_a_of_type_Bfub.a(localWordInfo);
    ...
    for (i = 0; i != 0; i = 1)
    {
      ...
      i += 1;
      break label148;
      this.a.jdField_a_of_type_Bfub.g();
      return;
      this.a.jdField_a_of_type_Bfub.a(this.a.jdField_a_of_type_Int, this.a.b, this.a.c);
