...
public class npt
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      paramQQAppInterface = (amrk)paramQQAppInterface.getManager(69);
  ...
  public static Intent a(Context paramContext, Intent paramIntent, String paramString, boolean paramBoolean1, int paramInt1, boolean paramBoolean2, int paramInt2)
  {
    try
    {
      bool = ((bily)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(165)).c(paramString, false);
      if (bool) {
        if (paramIntent == null)
        {
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      ...
      {
        paramQQAppInterface = ((amsw)paramQQAppInterface.getManager(51)).b(paramString);
        if (paramQQAppInterface == null) {
          break label189;
        }
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        ...
        if (paramQQAppInterface != null)
        {
          paramQQAppInterface = ((amrk)paramQQAppInterface).a(paramString);
          if (paramQQAppInterface != null) {
  ...
  private static void a(int paramInt, bhht parambhht)
  {
    b(paramInt, parambhht);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      if (lld.c())
      {
        ...
        localbjnw.a(new npw(localbjnw, paramQQAppInterface, paramContext, paramSessionInfo));
        localbjnw.show();
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    if (bily.b(paramQQAppInterface, paramSessionInfo.curFriendUin)) {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        localObject = ((amxz)localObject).c(paramSessionInfo.curFriendUin);
        if (localObject == null)
        {
          localObject = (amrk)paramQQAppInterface.getManager(69);
          if (localObject != null)
          {
            localObject = ((amrk)localObject).a(paramSessionInfo.curFriendUin);
            if (localObject == null)
            {
              if (QLog.isDevelopLevel()) {
              ...
              if ((paramContext instanceof Activity)) {
                localbhht = new bhht(paramContext, paramContext.getResources().getDimensionPixelSize(2131299076));
              }
              if (localbhht != null) {
              ...
              localObject = new NewIntent(paramContext.getApplicationContext(), nma.class);
      ...
      try
      {
        ...
        ((NewIntent)localObject).setObserver(new npu(paramContext, paramQQAppInterface, localbhht, paramSessionInfo, paramString));
        ...
        return;
        a(paramContext, 2131694775);
        bcef.b(paramQQAppInterface, "CliOper", "", "", "0X80049DF", "GetDetailFalse", 0, 0, "", "", "", "");
        return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt, BusinessObserver paramBusinessObserver)
  {
    ...
    {
      paramContext = new NewIntent(paramContext.getApplicationContext(), nma.class);
  ...
  {
    if ((paramQQAppInterface != null) && (nns.a(paramString)) && (nns.b(paramString)))
    {
  ...
  public static String b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      str = bily.a(paramQQAppInterface, paramString);
    }
    label25:
    do
    {
  ...
  private static void b(int paramInt, bhht parambhht)
  {
    if (parambhht != null)
    {
      parambhht.c(paramInt);
      parambhht.show();
    }
  }
  
  private static void b(bhht parambhht)
  {
  ...
  private static void b(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, PublicAccountInfo paramPublicAccountInfo, EqqDetail paramEqqDetail, String paramString)
  {
    ...
    for (;;)
    {
      if (bool)
      {
        ...
        if ((paramContext instanceof Activity)) {
          paramPublicAccountInfo = new bhht(paramContext, paramContext.getResources().getDimensionPixelSize(2131299076));
        }
        if (paramPublicAccountInfo != null) {
          paramPublicAccountInfo.setCanceledOnTouchOutside(true);
        }
        NewIntent localNewIntent = new NewIntent(paramContext.getApplicationContext(), odw.class);
        ...
        localNewIntent.setObserver(new npv(paramContext, paramQQAppInterface, paramPublicAccountInfo, paramEqqDetail, paramSessionInfo, paramString));
        paramQQAppInterface.startServlet(localNewIntent);
      }
      try
      {
        if (((paramContext instanceof Activity)) && (!((Activity)paramContext).isFinishing())) {
          a(2131694821, paramPublicAccountInfo);
        }
        label257:
        if (QLog.isColorLevel()) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2)
  {
    ...
    {
      new bhig(paramContext).a(2131693063, paramContext.getResources().getDimensionPixelSize(2131299076), 0, 1);
      return;
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, EqqDetail paramEqqDetail)
  {
    ...
    amrk localamrk = (amrk)paramQQAppInterface.getManager(69);
    if (localamrk != null) {
      localamrk.a(paramEqqDetail);
    }
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    for (boolean bool1 = false;; bool1 = false)
    {
      ...
      if ((localObject != null) && (((amrk)localObject).a(paramString) != null))
      {
        if (QLog.isColorLevel()) {
  ...
  private static void c(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    {
      if (i == 0) {
        bcef.b(paramQQAppInterface, "CliOper", "", "", "0X8004628", "0X8004628", 0, 0, "", "", "", "");
      }
      if (paramSessionInfo.curType != 1008) {
        paramSessionInfo.curType = 1024;
      }
      afcm.a(paramQQAppInterface, paramContext, paramSessionInfo, true, paramString, null);
      return;
    }
  }
  ...
  {
    if (!((amsw)paramQQAppInterface.getManager(51)).b(paramString2)) {}
    for (;;)
    {
      return;
      try
      {
        ...
        {
          ((bing)paramQQAppInterface.getBusinessHandler(85)).a(Long.valueOf(paramString1).longValue(), Long.valueOf(paramString2).longValue());
          return;
        }
      }
      catch (Exception paramQQAppInterface)
  ...
  private static boolean c(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if (paramInt == 1024)
    {
      ...
      {
        if (((amxz)localManager).c(paramString) != null) {}
        for (bool1 = true;; bool1 = true)
        {
          ...
          if (((amrk)paramQQAppInterface).a(paramString) == null) {
            break label157;
          }
        }
        label157:
