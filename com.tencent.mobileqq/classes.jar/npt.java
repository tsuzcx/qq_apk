  ...
  extends alpd
{
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!localGetArticleLikeCountRespond.ret.ret_code.has()) || (localGetArticleLikeCountRespond.ret.ret_code.get() != 0))
        {
          ...
          this.jdField_a_of_type_Npu.a(bool, paramToServiceMsg, i);
          return;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((!paramFromServiceMsg.ret.ret_code.has()) || (paramFromServiceMsg.ret.ret_code.get() != 0))
        {
          ...
          this.jdField_a_of_type_Npu.a(bool2, paramToServiceMsg, bool1);
          return;
        }
      }
      catch (Exception paramToServiceMsg)
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Npu.a(bool1, paramToServiceMsg);
        return;
      }
      catch (Exception paramToServiceMsg)
      {
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Npu != null) {
        this.jdField_a_of_type_Npu.a(bool1);
      }
      return;
    }
    catch (Exception paramToServiceMsg)
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Npu != null) {
        this.jdField_a_of_type_Npu.a(bool1, i);
      }
      return;
    }
    catch (Exception paramToServiceMsg)
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!paramToServiceMsg.ret.ret_code.has()) || (paramToServiceMsg.ret.ret_code.get() == 0))
        {
          ...
          if (this.jdField_a_of_type_Npu != null) {
            this.jdField_a_of_type_Npu.b(bool2, i);
          }
          return;
        }
      }
  ...
  private void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        paramFromServiceMsg.mergeFrom((byte[])paramObject);
        localtpr.jdField_a_of_type_JavaLangString = ((String)paramToServiceMsg.extraData.get(this.jdField_a_of_type_JavaLangString));
        paramToServiceMsg = localtpr.jdField_a_of_type_JavaLangString;
        if (paramFromServiceMsg.ret.has()) {
          if ((!paramFromServiceMsg.ret.ret_code.has()) || (paramFromServiceMsg.ret.ret_code.get() == 0))
          {
            bool = true;
            if (paramFromServiceMsg.article_share_url.has()) {
              localtpr.jdField_b_of_type_JavaLangString = paramFromServiceMsg.article_share_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.puin.has()) {
              localtpr.c = (paramFromServiceMsg.puin.get() + "");
            }
            if (paramFromServiceMsg.article_img_url.has()) {
              localtpr.d = paramFromServiceMsg.article_img_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.article_title.has()) {
              localtpr.e = paramFromServiceMsg.article_title.get().toStringUtf8();
            }
            if (paramFromServiceMsg.enable_comment.has()) {
              localtpr.jdField_a_of_type_Int = paramFromServiceMsg.enable_comment.get();
            }
            if (paramFromServiceMsg.comment_url.has()) {
              localtpr.f = paramFromServiceMsg.comment_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.firstItem.has())
            {
              localtpr.jdField_a_of_type_Tps = new tps();
              localtpr.jdField_a_of_type_Tps.jdField_a_of_type_JavaLangString = paramFromServiceMsg.firstItem.url.get().toStringUtf8();
              localtpr.jdField_a_of_type_Tps.d = paramFromServiceMsg.firstItem.photo_author_name.get().toStringUtf8();
              localtpr.jdField_a_of_type_Tps.c = paramFromServiceMsg.firstItem.photo_time.get().toStringUtf8();
              localtpr.jdField_a_of_type_Tps.jdField_b_of_type_JavaLangString = paramFromServiceMsg.firstItem.publicaccount_name.get().toStringUtf8();
            }
            ...
            {
              localtpt = new tpt();
              localtpt.jdField_a_of_type_JavaLangString = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).url.get().toStringUtf8();
              localtpt.jdField_b_of_type_JavaLangString = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).content.get().toStringUtf8();
              localtpt.c = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).static_url.get().toStringUtf8();
              localtpt.jdField_a_of_type_Int = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).width.get();
              localtpt.jdField_b_of_type_Int = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).height.get();
    ...
    for (;;)
    {
      ...
      break;
      label628:
      while (this.jdField_a_of_type_Npu != null)
      {
        this.jdField_a_of_type_Npu.a(bool, localtpr, (byte[])paramObject, paramToServiceMsg);
        return;
        bool = false;
        continue;
        bool = false;
        paramToServiceMsg = localtpt;
      }
    }
  }
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    this.jdField_a_of_type_Npu.a(bool, paramToServiceMsg);
  }
      ...
      try
      {
        ...
        if ((paramFromServiceMsg.uint32_ret_code.has()) && (paramFromServiceMsg.uint32_ret_code.get() == 0))
        {
          if (paramFromServiceMsg.uint32_read_count.has())
          {
            ...
            if (this.jdField_a_of_type_Npu != null) {
              this.jdField_a_of_type_Npu.c(bool, i);
            }
            return;
            bool = false;
            break;
  ...
  public void a()
  {
    this.jdField_a_of_type_Npu = null;
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, int paramInt3, ArrayList<tpu> paramArrayList)
  {
    if (QLog.isColorLevel()) {
    ...
    if ((paramArrayList != null) && (paramArrayList.size() > 0) && (paramInt1 == 2))
    {
      ...
      {
        paramString3 = (tpu)paramString2.next();
