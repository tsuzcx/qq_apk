...
public class awlb
  extends awlr
{
  public awlb(PersonalityLabelGalleryActivity paramPersonalityLabelGalleryActivity) {}
        ...
        if (paramString != null)
        {
          if (PersonalityLabelGalleryActivity.b(this.a).get(Long.valueOf(paramLong)) == null)
          {
            ...
            if (PersonalityLabelGalleryActivity.a(this.a)) {
              paramPersonalityLabelInfo.photoCount = (this.a.jdField_a_of_type_Awkp.a(paramLong, paramPersonalityLabelInfo, true) + paramPersonalityLabelInfo.photoCount);
            }
          }
  ...
  public void a(boolean paramBoolean, String paramString, PersonalityLabel paramPersonalityLabel, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    do
    {
      ...
      if ((paramPersonalityLabel.getSize() > 0) && (PersonalityLabelGalleryActivity.a(this.a)))
      {
        ...
        while (paramInt < paramPersonalityLabel.personalityLabelInfos.size())
        {
          ...
          this.a.jdField_a_of_type_Awkp.a(paramString.id, paramString, true);
          paramInt += 1;
        }
      }
    ...
    if (!bdee.d(this.a))
    {
      PersonalityLabelGalleryActivity.a(this.a, this.a.getResources().getString(2131694764));
      paramString = this.a;
    ...
    for (paramInt = 8;; paramInt = 0)
    {
      ...
      return;
      PersonalityLabelGalleryActivity.a(this.a, this.a.getResources().getString(2131694090));
      break;
    }
  }
}
