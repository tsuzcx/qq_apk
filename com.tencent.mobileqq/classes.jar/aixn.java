...
public class aixn
{
  ...
  {
    SpannableString localSpannableString = new SpannableString(anzj.a(2131715629) + this.jdField_a_of_type_JavaLangString);
  ...
  public void a(QQAppInterface paramQQAppInterface, ColorStateList paramColorStateList, aixo paramaixo)
  {
    this.jdField_a_of_type_AndroidContentResColorStateList = paramColorStateList;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaUtilTimer = new Timer();
    this.jdField_a_of_type_Aixo = paramaixo;
  }
