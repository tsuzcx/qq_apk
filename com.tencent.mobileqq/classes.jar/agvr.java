  ...
  implements agvy, View.OnClickListener
{
  ...
  public agvr(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, agwa paramagwa, BaseChatPie paramBaseChatPie, MqqHandler paramMqqHandler)
  {
  ...
  public static agvs a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localSharedPreferences != null)
    {
      ...
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        try
        {
          paramQQAppInterface = new agvs(new JSONObject(paramQQAppInterface));
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, agvs paramagvs, String paramString2)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramagvs != null)
    {
      paramQQAppInterface.a().b(paramString1, 1008, paramagvs.jdField_d_of_type_Long, true);
      if (QLog.isColorLevel()) {
        QLog.i("PubAccountTips", 2, "removeMsgByUniseq. uniqSeqno:" + paramagvs.jdField_d_of_type_Long);
      }
    }
    paramagvs = localSharedPreferences.edit();
    paramQQAppInterface = "selfuin_" + paramQQAppInterface.getCurrentAccountUin() + "_puin_" + paramString1 + "_msgdata";
    if (paramString2 != null) {
      paramagvs.putString(paramQQAppInterface, paramString2);
    }
    for (;;)
    {
      paramagvs.commit();
      return;
      paramagvs.remove(paramQQAppInterface);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte)
  {
    ...
    //   152: dup
    //   153: aload_1
    //   154: invokespecial 90	agvs:<init>	(Lorg/json/JSONObject;)V
    //   157: astore_3
    //   158: aload_3
    //   159: invokevirtual 221	agvs:a	()Z
    //   162: ifeq -158 -> 4
    //   165: aload_3
    //   166: getfield 224	agvs:jdField_b_of_type_Int	I
    //   169: iconst_1
    //   170: if_icmpne +145 -> 315
    //   173: sipush -2011
    //   176: invokestatic 229	ayvw:a	(I)Lcom/tencent/mobileqq/data/MessageRecord;
    ...
    //   202: aload_3
    //   203: getfield 235	agvs:jdField_a_of_type_Long	J
    ...
    //   212: astore 7
    //   214: aload_3
    //   215: getfield 238	agvs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   218: astore 6
    //   220: aload 4
    //   222: aload 5
    //   224: aload 7
    ...
    //   241: invokestatic 247	azqu:a	()Lcom/tencent/mobileqq/structmsg/StructMsgForGeneralShare;
    //   244: astore 7
    //   246: aload 7
    //   248: aload 6
    ...
    //   253: aload 7
    //   255: aload_3
    //   256: getfield 255	agvs:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   337: aload_3
    //   338: getfield 289	agvs:jdField_a_of_type_Int	I
    ...
    //   388: aload_3
    //   389: getfield 235	agvs:jdField_a_of_type_Long	J
    ...
    //   398: invokestatic 292	agvr:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Lagvs;
    //   401: astore 4
    //   403: aload_0
    ...
    //   416: aload_3
    //   417: getfield 235	agvs:jdField_a_of_type_Long	J
    ...
    //   432: invokestatic 294	agvr:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Lagvs;Ljava/lang/String;)V
    //   435: aload_0
    //   436: ldc_w 296
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a()).inflate(2131559837, null);
    ImageView localImageView;
    if (this.jdField_a_of_type_Agvs != null)
    {
      if (this.jdField_a_of_type_Agvs.jdField_a_of_type_Int != 1) {
        break label106;
      }
      paramVarArgs.setBackgroundResource(2131165822);
      ((TextView)paramVarArgs.findViewById(2131362427)).setText(this.jdField_a_of_type_Agvs.jdField_a_of_type_JavaLangString);
      localImageView = (ImageView)paramVarArgs.findViewById(2131362423);
      String str = this.jdField_a_of_type_Agvs.jdField_b_of_type_JavaLangString;
      if (TextUtils.isEmpty(str)) {
        break label127;
      }
      localImageView.setImageDrawable(baul.a(str, null, null));
    }
    for (;;)
    {
      ...
      return paramVarArgs;
      label106:
      if (this.jdField_a_of_type_Agvs.jdField_a_of_type_Int != 2) {
        break;
      }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Agvs = paramVarArgs;
    } while (!this.jdField_a_of_type_Agwa.a(this, new Object[0]));
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "school", "school.aio.tips.show", 0, 0, "" + paramVarArgs.jdField_d_of_type_Int, "", "", "");
    return;
    if (QLog.isColorLevel()) {
  ...
  {
    Object localObject;
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1008) && (this.jdField_a_of_type_Agvs != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Agvs.jdField_c_of_type_JavaLangString)))
    {
      ...
      if (localObject != null)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("PubAccountTips", 2, "clickedTimes:" + (this.jdField_a_of_type_Agvs.e + 1));
        }
        agvs localagvs = this.jdField_a_of_type_Agvs;
        int i = localagvs.e + 1;
        localagvs.e = i;
        if (i < this.jdField_a_of_type_Agvs.jdField_c_of_type_Int) {
          break label313;
        }
        a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "" + this.jdField_a_of_type_Agvs.jdField_a_of_type_Long, this.jdField_a_of_type_Agvs, null);
    ...
    for (;;)
    {
      ...
      ((Intent)localObject).putExtra("url", this.jdField_a_of_type_Agvs.jdField_c_of_type_JavaLangString);
      paramView.startActivity((Intent)localObject);
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "school", "school.aio.tips.click", 0, 0, "" + this.jdField_a_of_type_Agvs.jdField_d_of_type_Int, "", "", "");
      return;
      label313:
      localObject = ((SharedPreferences)localObject).edit();
      try
      {
        this.jdField_a_of_type_Agvs.jdField_a_of_type_OrgJsonJSONObject.put("clicked", this.jdField_a_of_type_Agvs.e);
        ((SharedPreferences.Editor)localObject).putString(paramView, this.jdField_a_of_type_Agvs.jdField_a_of_type_OrgJsonJSONObject.toString()).commit();
      }
