...
public class agvr
{
  ...
  public agvr(Context paramContext, LinearLayout paramLinearLayout, int paramInt, boolean paramBoolean, AnimationView.MyAnimationListener paramMyAnimationListener)
  {
  ...
  public agvr(AnimationView paramAnimationView, int paramInt, boolean paramBoolean, AnimationView.MyAnimationListener paramMyAnimationListener)
  {
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    agvt localagvt = new agvt(this, null);
    if (paramBoolean) {}
    for (String str = "0";; str = "1")
    {
      localagvt.execute(new String[] { paramString, str });
      return;
    }
  }
}
