...
public class bify
  extends bigf
  implements agmj, View.OnClickListener, View.OnTouchListener, avtg, avuh, avui, bjqv, bkwf
{
  protected int a;
  ...
  public bify(bjqu parambjqu, bjqt parambjqt)
  {
    ...
    this.jdField_a_of_type_JavaLangString = ajyc.a(2131709765);
  ...
  public void T()
  {
    this.d = bkur.a(this.jdField_a_of_type_AndroidWidgetLinearLayout, this.jdField_b_of_type_AndroidWidgetRelativeLayout, bbkx.a(1.0F));
  ...
  public View a()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Bjqu.a().getLayoutInflater().inflate(a(), (ViewGroup)localObject, false).findViewById(2131366493);
    bkpd.a("onCreateView1");
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView = ((CameraCaptureView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363833));
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131366494));
      ...
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363295));
      this.d = bkur.a(this.jdField_a_of_type_AndroidWidgetLinearLayout, this.jdField_b_of_type_AndroidWidgetRelativeLayout, bbkx.a(1.0F));
      if (QLog.isColorLevel()) {
        QLog.i("QIMCameraCaptureUnit", 1, "initLiuHaiScreenUI_Common mEnableLHLayout:" + this.d);
      }
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131364030));
      ...
      this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131366361));
      this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetButton.setSelected(false);
      this.jdField_c_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131364898));
      this.jdField_c_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetButton.setSelected(false);
      this.jdField_c_of_type_AndroidWidgetButton.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363852));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363857));
      u();
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131372844);
      ...
      this.jdField_b_of_type_Boolean = this.jdField_a_of_type_Bjqu.a().getIntent().getBooleanExtra("enable_local_video", true);
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369525));
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      localObject = this.jdField_a_of_type_AndroidViewView.getResources().getDrawable(2130848248);
      int i1 = actn.a(36.0F, this.jdField_a_of_type_AndroidViewView.getResources());
      ((Drawable)localObject).setBounds(0, 0, i1, i1);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      this.jdField_a_of_type_Avsv = new avsv(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView);
      this.jdField_a_of_type_Avsq = a();
      this.jdField_a_of_type_Avst = new avst(this.jdField_a_of_type_Bjqu.a());
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131366463);
      this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363888));
  ...
  {
    if (axkr.n()) {
      return bkup.a().a(this.jdField_a_of_type_Bjqu.a());
    }
    return bkup.a().b(this.jdField_a_of_type_Bjqu.a());
  }
  ...
  public void a(Activity paramActivity)
  {
    for (;;)
    {
      try
      {
        ...
        c(localIntent);
        vzk.a(localIntent, paramActivity.getIntent().getExtras(), paramActivity);
        localIntent.putExtra("from_qqstory", true);
        localIntent.putExtra("edit_video_type", this.jdField_a_of_type_Bjqm.a());
        ...
        localIntent.putExtra("video_refer", this.jdField_a_of_type_Bjqm.a());
        ...
        localIntent.putExtra("entrance_type", this.jdField_a_of_type_Bjqm.c());
        ...
        localObject = (SessionWrap)this.jdField_a_of_type_Bjqu.a().getIntent().getParcelableExtra("ARG_SESSION_INFO");
        if (localObject != null)
        {
          ...
          str = this.jdField_a_of_type_Bjqu.a().getIntent().getStringExtra("f_a_a_n");
          if ((str != null) && (str.equals(ChatActivity.class.getName())))
          {
            ...
            localIntent.putExtra("key_activity_code", this.jdField_a_of_type_Bjqu.a().getIntent().getStringExtra("key_activity_code"));
            localIntent.putExtra("edit_video_way", this.jdField_a_of_type_Int);
            localIntent.putExtra("from_camera_album", true);
            localIntent.putExtra("VIDEO_STORY_JUMP_TO_TYPE", birc.b(paramActivity.getIntent()));
            localIntent.putExtra("VIDEO_STORY_FROM_TYPE", birc.a(paramActivity.getIntent()));
      ...
      {
        veg.b("QIMCameraCaptureUnit", "QQStoryFlowCallback ", paramActivity);
        return;
      }
    }
  }
  ...
  public void a(Activity paramActivity, boolean paramBoolean)
  {
    try
    {
      ...
      localIntent.putExtra("qq_sub_business_id", this.jdField_a_of_type_Bjqm.b());
      localIntent.putExtra("edit_video_type", this.jdField_a_of_type_Bjqm.a());
      b(localIntent);
    ...
    {
      veg.b("QIMCameraCaptureUnit", "intentToPhotoList ", paramActivity);
    }
  }
  ...
  {
    super.a(paramBundle);
    this.jdField_b_of_type_Long = this.jdField_a_of_type_Bjqu.a().getIntent().getLongExtra("ACTIVITY_START_TIME", -1L);
    if (paramBundle != null) {
    ...
    this.jdField_a_of_type_Bjqu.a().registerReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver, a());
    avtn.a();
  }
  ...
  protected void a(List<CameraCaptureView.VideoCaptureResult> paramList, List<LocalMediaInfo> paramList1)
  {
    ...
    if ((!this.o) || (paramList.size() == 1))
    {
      ...
      agmi.a(BaseApplicationImpl.getContext()).a(new bige(this), this.jdField_b_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
      return;
    }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    avtn.jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a();
  }
  ...
  public void d(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Bigh = ((bigh)bjae.a().c(13));
      this.jdField_a_of_type_Bigh.a(paramBoolean);
      AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
      if ((localAppRuntime instanceof AppInterface)) {
        localAppRuntime.notifyObservers(bjdc.class, 7, false, null);
      }
  ...
  public void denied()
  {
    ...
    if (((Activity)localObject).checkSelfPermission("android.permission.CAMERA") != 0)
    {
      ...
      localObject = bbcv.a(new String[] { "android.permission.CAMERA", "android.permission.RECORD_AUDIO" });
    }
    for (;;)
    {
      ...
      label98:
      if (i1 != 0) {
        localObject = bbcv.a(new String[] { "android.permission.CAMERA" });
      } else {
        localObject = bbcv.a(new String[] { "android.permission.RECORD_AUDIO" });
      }
    }
  }
  ...
  public void e(boolean paramBoolean)
  {
    ...
    label41:
    g();
    float f1 = vzo.a(this.jdField_a_of_type_Bjqu.a(), 90.0F);
    ArrayList localArrayList = new ArrayList();
    if (this.jdField_a_of_type_AndroidWidgetFrameLayout != null)
    {
      localArrayList.add(new bjjb(this.jdField_a_of_type_AndroidWidgetFrameLayout, "translationY", 0.0F, f1, 450L, 0L));
      localArrayList.add(new bjjb(this.jdField_a_of_type_AndroidWidgetFrameLayout, "alpha", 1.0F, 0.0F, 450L, 0L));
    }
    if (this.jdField_a_of_type_AndroidViewViewGroup != null)
    {
      localArrayList.add(new bjjb(this.jdField_a_of_type_AndroidViewViewGroup, "translationY", f1, 0.0F, 450L, 0L));
      localArrayList.add(new bjjb(this.jdField_a_of_type_AndroidViewViewGroup, "alpha", 0.0F, 1.0F, 450L, 0L));
    ...
    if ((localObject != null) && (((List)localObject).size() > 0))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        localArrayList.add(new bjjb(localView, "translationY", f1, 0.0F, 450L, 0L));
        localArrayList.add(new bjjb(localView, "alpha", 0.0F, 1.0F, 450L, 0L));
        localView.setAlpha(0.0F);
      }
    }
    bjiy.a(localArrayList, new biga(this));
  }
  ...
  protected void i()
  {
    ...
    agmi.a(BaseApplicationImpl.getContext()).a(this, this.jdField_b_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131364030: 
      ...
      {
        avtn.f();
        vel.a("clk_switch", this.jdField_a_of_type_Bjqm.a(), 0, new String[0]);
        return;
        this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.jdField_a_of_type_AndroidWidgetButton.getResources().getString(2131718767));
      }
    case 2131366361: 
      ...
      {
        avtb.d(i1);
        vel.a("clk_flash", this.jdField_a_of_type_Bjqm.a(), 0, new String[0]);
        bizc.a().l();
        return;
        bool = false;
        break;
    ...
    case 2131364898: 
      bjke.a(this.jdField_c_of_type_AndroidWidgetButton, 200L, null);
    ...
    bjke.a(this.jdField_a_of_type_AndroidWidgetImageView, 200L, null);
    paramView = new axtw();
    paramView.d = "0X800822E";
    axqs.a(null, paramView);
    vel.a("clk_local", this.jdField_a_of_type_Bjqm.a(), 0, new String[0]);
    if ((this.jdField_a_of_type_Int == 9) || (this.jdField_a_of_type_Int == 11))
    {
      a(this.jdField_a_of_type_Bjqu.a());
      return;
    }
    if (this.jdField_b_of_type_Int == 5)
    {
    ...
    if (Build.VERSION.SDK_INT >= 17)
    {
      vuc.a().c(21);
      vuc.a().b(11);
      a(this.jdField_a_of_type_Bjqu.a(), true);
      return;
    }
    a(this.jdField_a_of_type_Bjqu.a());
  }
  ...
  protected void u()
  {
    this.jdField_b_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayout = ((QIMCameraCaptureButtonLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363881));
    ...
    this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraSegmentCaptureButtonLayout = ((QIMCameraSegmentCaptureButtonLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131375787));
  ...
  public void v()
  {
    ...
    localLayoutParams.bottomMargin = actn.a(-30.0F, this.jdField_a_of_type_DovComTencentMobileqqRichmediaCaptureViewQIMCameraCaptureButtonLayout.getResources());
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      localLayoutParams.bottomMargin = actn.a(50.0F, this.jdField_a_of_type_AndroidWidgetImageView.getResources());
  ...
  public void x()
  {
    ...
    for (;;)
    {
      vel.a("clk_cancel", vel.b(this.jdField_a_of_type_Bjqm.a()), 0, new String[0]);
      return;
  ...
  public void z()
  {
    ...
    this.jdField_a_of_type_Bbgg = bbcv.a(localActivity, 230).setMessage(str).setPositiveButton(localActivity.getString(2131694087), new bigd(this));
  }
}
