...
public class liw
{
  ...
  static liy jdField_a_of_type_Liy = new liy();
  ...
  private Camera.PreviewCallback jdField_a_of_type_AndroidHardwareCamera$PreviewCallback = new lix(this);
  Camera jdField_a_of_type_AndroidHardwareCamera = null;
  Display jdField_a_of_type_AndroidViewDisplay;
  String jdField_a_of_type_JavaLangString;
  liz jdField_a_of_type_Liz = null;
  lja jdField_a_of_type_Lja = new lja();
  ...
  public liw(Context paramContext)
  {
    ...
    this.jdField_e_of_type_Int = Build.VERSION.SDK_INT;
    this.jdField_a_of_type_JavaLangString = Build.MODEL;
    this.jdField_b_of_type_JavaLangString = Build.MANUFACTURER;
    jdField_a_of_type_Liy.jdField_b_of_type_Int = -1;
    jdField_a_of_type_Liy.jdField_c_of_type_Int = -1;
  ...
  private void a(long paramLong)
  {
    ...
    if ((this.jdField_b_of_type_Boolean) && (a() != null)) {
      if (a(a(a().getPreviewFormat())))
      {
        ...
        if (i1 < ljh.a().a())
        {
          byte[] arrayOfByte = ljh.a().a(0);
          n = i2;
          if (arrayOfByte != null)
          {
            ljh.a().a(arrayOfByte, 1);
  ...
  protected int a()
  {
    ...
    {
      if (AudioHelper.f()) {
        QLog.w("AndroidCamera", 1, "getNumberOfCamera, hardcode[" + bgvf.a().a() + "]");
      }
      n = bgvf.a().a();
    }
    do
  ...
  int a(int paramInt, boolean paramBoolean)
  {
    ...
    while (paramBoolean)
    {
      return lkl.a(this.jdField_a_of_type_AndroidContentContext, true, false, b1, false) * 90;
      b1 = 0;
      continue;
      b1 = 1;
      continue;
    ...
    return lkl.b(this.jdField_a_of_type_AndroidContentContext, true, false, b1, false) * 90;
  }
  
  int a(boolean paramBoolean)
  {
    if (paramBoolean) {
      return 360 - lkl.a(this.jdField_a_of_type_AndroidContentContext, true, true, (byte)0, false) * 90;
    }
    return 360 - lkl.b(this.jdField_a_of_type_AndroidContentContext, true, true, (byte)0, false) * 90;
  }
  ...
  protected liy a(int paramInt, Camera paramCamera)
  {
    paramCamera = new liy();
    try
    {
  ...
  {
    int n = jdField_a_of_type_Liy.jdField_c_of_type_Int;
    jdField_a_of_type_Liy.jdField_c_of_type_Int = ((this.h + paramInt) % 360);
    if (n != jdField_a_of_type_Liy.jdField_c_of_type_Int) {
      QLog.w("AndroidCamera", 1, "setMobileRotation, rotation[" + n + "->" + jdField_a_of_type_Liy.jdField_c_of_type_Int + "], mCompenSateSendAngle[" + this.h + "]");
    }
  }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    {
      return;
      synchronized (jdField_a_of_type_Liy)
      {
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      lbc.c("AndroidCamera", "mFrontCameraAngle: " + this.i + ", mBackCameraAngle: " + this.j);
      return;
      this.j = (paramInt % 360);
    }
  }
  ...
  {
    liy localliy = a(paramInt, paramCamera);
    this.h = b();
    this.g = c();
    int i1 = d();
    int i2 = e();
    int i3;
    int i4;
    if (localliy.jdField_a_of_type_Int == 1)
    {
      n = (360 - (i1 + i2) % 360) % 360;
    ...
    {
      QLog.w("AndroidCamera", 1, "setCameraDisplayOrientation, cameraId[" + paramInt + "], orientation[" + jdField_a_of_type_Liy.jdField_b_of_type_Int + "->" + localliy.jdField_b_of_type_Int + "], rotation[" + jdField_a_of_type_Liy.jdField_c_of_type_Int + "->" + localliy.jdField_c_of_type_Int + "], mCompenSateSendAngle[" + this.h + "], mCompenSateRecvAngle[" + this.g + "], mSupportLandscape[" + this.jdField_e_of_type_Boolean + "], previewAngleForFrontCamera[" + i3 + "], previewAngleForBackCamera[" + i4 + "], cameraImageOrientation[" + i1 + "], mobileRotation[" + i2 + "], result[" + n + "], seq[" + paramLong + "]");
      a(paramCamera, n);
      jdField_a_of_type_Liy.jdField_a_of_type_Int = localliy.jdField_a_of_type_Int;
      jdField_a_of_type_Liy.jdField_b_of_type_Int = localliy.jdField_b_of_type_Int;
      return true;
      n = (i1 - i2 + 360) % 360;
      break;
    }
  ...
  public boolean a(long paramLong, SurfaceTexture paramSurfaceTexture)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (jdField_a_of_type_Boolean)
        {
          ...
          ljj.a(BaseApplicationImpl.getContext(), "openCamera");
          return bool1;
        }
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (this.jdField_a_of_type_AndroidHardwareCamera != null)
      {
        ...
        break label581;
        label563:
        ljj.b(BaseApplicationImpl.getContext(), "openCamera");
        break label154;
        bool1 = false;
        break label321;
      }
      ...
      try
      {
        ...
        if (this.jdField_d_of_type_Int >= 1) {
          if (this.jdField_a_of_type_AndroidHardwareCamera == null)
          {
            ...
            if (bool1)
            {
              ljj.a(BaseApplicationImpl.getContext(), "reopenCamera");
              return bool1;
            }
          }
          else
          {
            QLog.w("AndroidCamera", 1, "reopenCamera, size[" + k + ", " + l + "], mCurCamera[" + this.jdField_c_of_type_Int + "], isCameraOpened[" + jdField_a_of_type_Boolean + "], sizeFromParameter[" + paramInt1 + ", " + paramInt2 + "], seq[" + paramLong + "]");
            if (paramInt1 != -1)
            {
              n = paramInt1;
              paramInt1 = paramInt2;
        ...
        case 1: 
          ...
          break label371;
          ljj.b(BaseApplicationImpl.getContext(), "reopenCamera");
          continue;
          bool1 = false;
        }
      }
  ...
  int b(int paramInt, boolean paramBoolean)
  {
    ...
    while (paramBoolean)
    {
      return lkl.a(this.jdField_a_of_type_AndroidContentContext, false, false, b1, false) * 90;
      b1 = 0;
      continue;
      b1 = 1;
      continue;
    ...
    return lkl.b(this.jdField_a_of_type_AndroidContentContext, false, false, b1, false) * 90;
  }
  
  int b(boolean paramBoolean)
  {
    if (paramBoolean) {
      return lkl.a(this.jdField_a_of_type_AndroidContentContext, false, true, (byte)0, false) * 90;
    }
    return lkl.b(this.jdField_a_of_type_AndroidContentContext, false, true, (byte)0, false) * 90;
  }
  ...
  protected Camera b(long paramLong)
  {
    ...
    //   6: aload_0
    //   7: iconst_0
    //   8: putfield 434	liw:jdField_f_of_type_Int	I
    //   11: aload_0
    //   12: getfield 57	liw:jdField_d_of_type_Int	I
    //   15: ifne +11 -> 26
    //   18: aload_0
    //   19: aload_0
    //   20: invokevirtual 435	liw:a	()I
    //   23: putfield 57	liw:jdField_d_of_type_Int	I
    //   26: aload_0
    //   27: getfield 57	liw:jdField_d_of_type_Int	I
    //   30: ifle +240 -> 270
    //   33: new 437	android/hardware/Camera$CameraInfo
    //   36: dup
    //   37: invokespecial 438	android/hardware/Camera$CameraInfo:<init>	()V
    //   40: astore 8
    //   42: iconst_0
    //   43: istore_3
    //   44: iload_3
    //   45: aload_0
    //   46: getfield 57	liw:jdField_d_of_type_Int	I
    //   49: if_icmpge +319 -> 368
    //   52: iload_3
    //   53: aload 8
    //   55: invokestatic 442	android/hardware/Camera:getCameraInfo	(ILandroid/hardware/Camera$CameraInfo;)V
    //   58: aload 8
    //   60: getfield 445	android/hardware/Camera$CameraInfo:facing	I
    //   63: istore 4
    //   65: invokestatic 172	com/tencent/mobileqq/utils/AudioHelper:f	()Z
    //   68: ifeq +54 -> 122
    //   71: ldc 135
    //   73: iconst_1
    ...
    //   87: iload_3
    //   88: invokevirtual 177	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   91: ldc_w 749
    //   94: invokevirtual 144	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   97: iload 4
    //   99: invokevirtual 177	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   102: ldc 229
    //   104: invokevirtual 144	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   107: lload_1
    //   108: invokevirtual 232	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   111: ldc 153
    ...
    //   119: invokestatic 161	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   122: iload 4
    //   124: iconst_1
    //   125: if_icmpne +249 -> 374
    //   128: iload_3
    //   129: invokestatic 753	android/hardware/Camera:open	(I)Landroid/hardware/Camera;
    //   132: astore 5
    //   134: aload_0
    //   135: iload_3
    //   136: putfield 434	liw:jdField_f_of_type_Int	I
    //   139: aload 5
    //   141: astore 6
    //   143: invokestatic 172	com/tencent/mobileqq/utils/AudioHelper:f	()Z
    //   146: ifeq +74 -> 220
    //   149: ldc 135
    //   151: iconst_1
    ...
    //   176: aload_0
    //   177: getfield 434	liw:jdField_f_of_type_Int	I
    //   180: invokevirtual 177	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   183: ldc_w 759
    //   186: invokevirtual 144	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   189: aload_0
    //   190: getfield 57	liw:jdField_d_of_type_Int	I
    //   193: invokevirtual 177	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   196: ldc 229
    //   198: invokevirtual 144	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   201: lload_1
    //   202: invokevirtual 232	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   205: ldc 153
    //   207: invokevirtual 144	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   210: invokevirtual 157	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   213: invokestatic 161	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   216: aload 5
    //   218: astore 6
    //   220: aload 6
    //   222: astore 5
    ...
    //   229: aload_0
    //   230: iconst_0
    //   231: putfield 434	liw:jdField_f_of_type_Int	I
    //   234: ldc 135
    //   236: iconst_1
    ...
    //   250: lload_1
    //   251: invokevirtual 232	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   254: ldc 153
    //   256: invokevirtual 144	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   259: invokevirtual 157	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   262: aload 5
    //   264: invokestatic 450	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   267: goto +107 -> 374
    //   270: invokestatic 172	com/tencent/mobileqq/utils/AudioHelper:f	()Z
    //   273: ifeq -49 -> 224
    //   276: ldc 135
    //   278: iconst_1
    ...
    //   292: aload_0
    //   293: getfield 57	liw:jdField_d_of_type_Int	I
    ...
    //   316: invokestatic 161	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   319: aconst_null
    //   320: areturn
    //   321: astore 6
    //   323: aload 7
    ...
    //   343: lload_1
    //   344: invokevirtual 232	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   347: ldc 153
    //   349: invokevirtual 144	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   352: invokevirtual 157	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   355: aload 6
    //   357: invokestatic 450	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   360: aload 5
    //   362: areturn
    //   363: astore 6
    //   365: goto -38 -> 327
      ...
      try
      {
        if (this.jdField_d_of_type_Int >= 1)
        {
          if (this.jdField_a_of_type_AndroidHardwareCamera == null)
          {
            ...
            if (bool1)
            {
              ljj.a(BaseApplicationImpl.getContext(), "switchCamera");
              return bool1;
            }
          }
          else
          {
            QLog.w("AndroidCamera", 1, "switchCamera, mCurCamera[" + this.jdField_c_of_type_Int + "], seq[" + paramLong + "]");
            c(paramLong);
          ...
          ljj.b(BaseApplicationImpl.getContext(), "switchCamera");
          continue;
        }
        bool1 = false;
      }
  ...
  public boolean c(long paramLong)
  {
    try
    {
      ...
      ljj.b(BaseApplicationImpl.getContext(), "closeCamera");
      return true;
    }
    finally {}
  }
  ...
  public int d()
  {
    if (jdField_a_of_type_Liy.jdField_b_of_type_Int == -1)
    {
    ...
    return jdField_a_of_type_Liy.jdField_b_of_type_Int;
  }
  ...
  public int e()
  {
    if (jdField_a_of_type_Liy.jdField_c_of_type_Int == -1) {
      return 0;
    }
    return jdField_a_of_type_Liy.jdField_c_of_type_Int;
  }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder().append("isCameraOpened[").append(jdField_a_of_type_Boolean).append("], mCameraId[").append(this.jdField_f_of_type_Int).append("], NUM[").append(this.jdField_d_of_type_Int).append("], CUR[").append(this.jdField_c_of_type_Int).append("], camera[");
    if (this.jdField_a_of_type_AndroidHardwareCamera != null) {}
