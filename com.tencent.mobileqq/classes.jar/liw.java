  ...
  implements mox
{
  ...
  public liw(lgo paramlgo, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Lgo = paramlgo;
  ...
  Bitmap a()
  {
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_Lgo.a))
    {
      lbd.f("ARZimuItemTask", "TextUtils.isEmpty(mSentenceInfo.src_text) == null");
    ...
    do
    {
      ...
      {
        return localObject3;
        lbd.f("ARZimuItemTask", "build:" + toString());
