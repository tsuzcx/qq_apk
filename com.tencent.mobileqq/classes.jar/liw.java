  ...
  extends liv
{
  ...
  public liw(AppInterface paramAppInterface)
  {
  ...
  public static void a(VideoAppInterface paramVideoAppInterface, String paramString1, long paramLong, String paramString2, boolean paramBoolean)
  {
    int i;
    long l1;
    if (((llc)paramVideoAppInterface.a(5)).a(0, "750") == 1)
    {
      i = 1;
      l1 = AudioHelper.a();
      if (i == 0) {
      ...
      i = 12;
      localObject = (liv)paramVideoAppInterface.a(1);
    }
    for (Object localObject = paramString2 + "|" + ((liv)localObject).a() + "|" + paramLong + "|" + l1;; localObject = paramString2)
    {
      long l2 = b;
      b = l1;
  ...
  void a(long paramLong1, long paramLong2)
  {
    ...
    ZimuItem localZimuItem = (ZimuItem)((lls)localVideoAppInterface.a(0)).a();
  ...
  boolean b()
  {
    return ((lls)((VideoAppInterface)this.mApp).a(0)).b();
  }
  
  boolean c()
  {
    return ((liy)this.mApp.getBusinessHandler(0)).a();
  }
}
