  ...
  extends lhd
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new lix(this);
  Handler jdField_a_of_type_AndroidOsHandler;
  HandlerThread jdField_a_of_type_AndroidOsHandlerThread = new HandlerThread("VideoNodeReportThread");
  public List<liy> a;
  
  public liw(VideoAppInterface paramVideoAppInterface)
  {
  ...
  private void b(long paramLong1, int paramInt, long paramLong2)
  {
    ...
    {
      localObject1 = new liy();
      ((liy)localObject1).a = paramLong1;
    ...
    if (((liy)localObject1).a == locallga.b()) {
      ((liy)localObject1).a(locallga, (String)localObject2);
    }
    localObject2 = ((liy)localObject1).a();
    localObject1 = ((liy)localObject1).a(paramInt, paramLong2);
  ...
  private void c(long paramLong)
  {
    ...
    localEditor.commit();
    lcg.d("VideoNodeReporter", "removeSpSessionRecord,roomId = " + paramLong);
  }
  
  liy a(long paramLong)
  {
  ...
  protected void a()
  {
    lcg.d("VideoNodeReporter", "onCreate ");
    c();
  }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    {
      lcg.d("VideoNodeReporter", " report error 0: " + paramInt + "|" + this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      return;
    }
    if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.e)
    {
      lcg.d("VideoNodeReporter", " report error 1 ,exit has been called,node = " + paramInt);
      return;
    }
  ...
  public void a(long paramLong1, int paramInt, long paramLong2)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentAvAppVideoAppInterface == null) || (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a() == null) || (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a() == null))
    {
      lcg.d("VideoNodeReporter", " reportByRoomId error 0: " + paramInt + "|" + this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      return;
    }
    if (this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.e)
    {
      lcg.d("VideoNodeReporter", " reportByRoomId error 1 ,exit has been called,node = " + paramInt);
      return;
    }
    if (paramLong1 == 0L)
    {
  ...
  {
    lcg.d("VideoNodeReporter", " onSessionStatusChanged :" + paramInt + ",para = " + paramString2);
    switch (paramInt)
    {
    case 2: 
    case 3: 
    ...
    if (this.jdField_a_of_type_JavaUtilList.size() > 0)
    {
      ...
      while (paramString1.hasNext()) {
        ((liy)paramString1.next()).b = System.currentTimeMillis();
      }
    }
  ...
  public void b()
  {
    try
    {
      ...
      long l1 = bbdh.a(Process.myPid()) / 1024L / 1024L;
