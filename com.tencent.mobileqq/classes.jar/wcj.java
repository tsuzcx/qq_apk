...
public class wcj
{
  ...
  private static final wcj jdField_a_of_type_Wcj = new wcj();
  ...
  private final ConcurrentHashMap<String, ConcurrentHashMap<Integer, WeakReference<wcl>>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  private wcj()
  {
    ...
    {
      if (i != 0) {
        QIPCServerHelper.getInstance().register(new wck(this, "SUBSCRIBE_IPC_MODULE"));
      }
      return;
      i = 0;
    }
  ...
  private void a(String paramString, wcl paramwcl)
  {
    ...
    localConcurrentHashMap1.put(Integer.valueOf(paramwcl.hashCode()), new WeakReference(paramwcl));
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, localConcurrentHashMap1);
    QLog.d("SimpleEventBus", 2, "registerReceiver event Name:" + paramString + ",key：[" + paramwcl.getClass().getSimpleName() + ":" + paramwcl.hashCode() + "], subscribers size:" + localConcurrentHashMap1.size());
  }
  ...
  private void b(String paramString, wcl paramwcl)
  {
    ...
    localConcurrentHashMap.remove(Integer.valueOf(paramwcl.hashCode()));
    if (localConcurrentHashMap.size() == 0) {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString);
    }
    QLog.d("SimpleEventBus", 2, "unRegisterReceiver event Name:" + paramString + ",key：[" + paramwcl.getClass().getSimpleName() + ":" + paramwcl.hashCode() + "], subscribers size:" + localConcurrentHashMap.size());
  }
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((localWeakReference != null) && (localWeakReference.get() != null)) {
          ((wcl)localWeakReference.get()).a(paramSimpleBaseEvent);
        }
      }
    }
  }
  ...
  public void a(wcl paramwcl)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext()) {
        a(((Class)localIterator.next()).getName(), paramwcl);
      }
    }
  }
  ...
  public void b(wcl paramwcl)
  {
    ...
    for (;;)
    {
      ...
      Iterator localIterator = paramwcl.a().iterator();
      while (localIterator.hasNext()) {
        b(((Class)localIterator.next()).getName(), paramwcl);
      }
    }
  }
}
