...
public class wcj
  implements Runnable
{
  public wcj(BlessSelectMemberActivity paramBlessSelectMemberActivity, TextView paramTextView, StringBuilder paramStringBuilder) {}
  ...
  public void run()
  {
    ...
    if (j == 4)
    {
      ...
      {
        str1 = String.format(this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessSelectMemberActivity.getString(2131438246), new Object[] { "...", Integer.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivityBlessBlessSelectMemberActivity.a.size()) });
