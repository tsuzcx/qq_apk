...
public class anpq
{
  ...
  public static CopyOnWriteArrayList<WeakReference<anps>> a;
  ...
  public static void a(int paramInt)
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = (anps)((WeakReference)localObject2).get();
          if (localObject2 != null) {
            ((anps)localObject2).a(paramInt);
          }
        }
      }
    }
  ...
  public static void a(anps paramanps)
  {
    if (paramanps == null) {}
    for (;;)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            if ((localWeakReference != null) && (paramanps == localWeakReference.get()))
            {
              QLog.i("ApolloSoLoader", 1, "already add, cb:" + paramanps);
              break;
            }
          }
        }
      ...
      jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(paramanps));
    }
  }
  ...
  public static void a(String paramString)
  {
    ...
    label106:
    c = bool1;
    if ((c) && (amsx.a(BaseApplicationImpl.getContext()))) {}
  ...
  /* Error */
  public static void b(anps paramanps)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: aload_0
    //   4: ifnull +14 -> 18
    //   7: getstatic 45	anpq:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   20: monitorexit
    //   21: return
    //   22: getstatic 45	anpq:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    //   57: if_acmpne -28 -> 29
    //   60: getstatic 45	anpq:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   63: aload_3
  ...
  private static boolean b(String paramString)
  {
    ...
    for (;;)
    {
      synchronized (blhg.a)
      {
        ...
        {
          jdField_a_of_type_JavaLangString = annv.jdField_a_of_type_JavaLangString + "/" + "soTest" + "/";
    ...
    Object localObject2 = bdgx.a().a(paramString);
    if (localObject2 != null)
    {
  ...
  private static boolean f()
  {
    ...
    try
    {
      if (ApolloGameUtil.a())
      {
        ...
        if (d)
        {
          anmq.a(10, 300, 1002, new Object[] { "arch=x86" });
          return false;
        }
      }
      else if (!UpdateArkSo.a(BaseApplicationImpl.getContext(), UpdateArkSo.a()))
      {
        ...
        anmq.a(10, 300, 1003, new Object[] { "png-armeabi-v7a load failed" });
        jdField_a_of_type_Boolean = true;
        return false;
      }
    }
    catch (Throwable localThrowable)
    {
      ...
      if (d)
      {
        anmq.a(10, 300, 1004, new Object[] { "[loadAllSo], Something unexpected happened.", localThrowable });
        jdField_a_of_type_Boolean = true;
        return false;
        if (d) {
          anmq.a(10, 300, new Object[] { "" });
        }
        Object localObject;
        if (!e)
        {
          ...
          localbdgx.b(new String[] { "jsc", localObject, str }, localanpr);
          e = true;
        }
        ...
        else
        {
          for (;;)
          {
            ...
            if (!AVSoUtils.a())
            {
              ...
              anmq.a(10, 299, 1005, new Object[] { "sharpp load fail" });
              return false;
            }
            anmq.a(10, 299, 0, new Object[0]);
          }
          ...
          if (d) {
            anmq.a(10, 300, 0, new Object[] { "loadAllSo success" });
          }
          bool1 = true;
        }
      }
  ...
  private static boolean g()
  {
    ...
    try
    {
      if (TextUtils.isEmpty(amsx.f)) {
        amsx.f = bhmi.b(new File(a("brick.js"), "brick.js"));
      }
      if (TextUtils.isEmpty(amsx.g)) {
        amsx.g = bhmi.b(new File(a("ticker.js"), "ticker.js"));
      }
      if (TextUtils.isEmpty(amsx.h)) {
        amsx.h = bhmi.b(new File(a("scene.js"), "scene.js"));
      }
      if (TextUtils.isEmpty(amsx.i)) {
        amsx.i = bhmi.b(new File(a("game.js"), "game.js"));
      }
      return true;
    }
    catch (Throwable localThrowable)
    {
      ...
      if (d) {
        anmq.a(10, 100, new Object[] { "[initScriptLib], th:", localThrowable });
      }
      return false;
    }
    finally
