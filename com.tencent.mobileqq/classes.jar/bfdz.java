...
public class bfdz
{
  ...
  public static Bundle a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9)
  {
    ...
    localBundle.putString("network", bfhb.a(bexd.a().a()));
    localBundle.putString("apn", bfhb.b(bexd.a().a()));
    localBundle.putString("model_name", Build.MODEL);
    localBundle.putString("qq_ver", bexd.a().c());
    return localBundle;
  }
  ...
  {
    bfhg.b("AuthorityUtil", "getOpenId uin = " + paramString1 + ", appid = " + paramString2);
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      return null;
    }
    return bfmy.a(paramContext, "uin_openid_store").getString(paramString2 + ":" + paramString1, null);
  }
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString)
  {
    ...
    for (;;)
    {
      ...
      azmj.b(null, "dc00898", "", "", "0X800AC2F", "0X800AC2F", 0, 0, "", "", "", "");
