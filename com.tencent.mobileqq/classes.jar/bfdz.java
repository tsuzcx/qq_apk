  ...
  implements Manager
{
  ...
  public ArrayList<bfea> a;
  protected Queue<String> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = "<{text:'A',action:'',url:'',url_p:'schemel://xxx',actionData:'action:xxxx',actionData_i:'',actionData_a:''}>" + amtj.a(2131714808) + "<{text:'B',action:'',url:'',url_p:'schemel://xxx',actionData:'action:xxxx',actionData_i:'',actionData_a:''}>" + amtj.a(2131714809) + "<{icon:'/rose',url:'url.qq.com?rose.png',alt:'玫瑰'}>";
  ...
  private void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, long paramLong3, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        paramString = aucg.a(paramString);
        if (paramString == null) {
          break;
        }
        ...
        {
          auby localauby = (auby)paramString.next();
          if (localauby.a() != 4) {
            continue;
          }
          paramString = (String)localauby.a().get(Integer.valueOf(6));
          ...
          ((anca)paramQQAppInterface.getBusinessHandler(20)).b(String.valueOf(paramLong1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1);
          return;
        }
      }
  ...
  private void a(GroupOpenSysMsg.SysMsgBody paramSysMsgBody, TroopTipsEntity paramTroopTipsEntity)
  {
    if ((paramSysMsgBody.msg_type.get() == 2) && (paramSysMsgBody.light_app.has()))
    {
      ...
      if (paramSysMsgBody.sender.has())
      {
        ...
        localMessageForArkApp.saveExtInfoToExtStr("troop_msg_nick_color", String.valueOf(BaseApplication.getContext().getResources().getColor(2131167037)));
  ...
  private boolean a(MessageForUniteGrayTip paramMessageForUniteGrayTip)
  {
    ...
    if (a(paramMessageForUniteGrayTip, localQQMessageFacade.getMsgList(paramMessageForUniteGrayTip.frienduin, paramMessageForUniteGrayTip.istroop))) {
      return true;
    }
    String str = String.format("time=%d and shmsgseq=%d", new Object[] { Long.valueOf(paramMessageForUniteGrayTip.time), Long.valueOf(paramMessageForUniteGrayTip.shmsgseq) });
    return a(paramMessageForUniteGrayTip, localQQMessageFacade.queryMessageByTimeOrSeq(paramMessageForUniteGrayTip.frienduin, paramMessageForUniteGrayTip.istroop, paramMessageForUniteGrayTip.shmsgseq, 1000, str));
  }
  
  private boolean a(MessageForUniteGrayTip paramMessageForUniteGrayTip, MessageRecord paramMessageRecord)
  {
    if (paramMessageForUniteGrayTip.shmsgseq != paramMessageRecord.shmsgseq) {}
    while ((paramMessageForUniteGrayTip.time != paramMessageRecord.time) || (!TextUtils.equals(paramMessageForUniteGrayTip.getExtInfoFromExtStr("uint64_busi_type"), paramMessageRecord.getExtInfoFromExtStr("uint64_busi_type"))) || (!TextUtils.equals(paramMessageForUniteGrayTip.getExtInfoFromExtStr("uint64_busi_id"), paramMessageRecord.getExtInfoFromExtStr("uint64_busi_id"))) || (!TextUtils.equals(paramMessageForUniteGrayTip.getExtInfoFromExtStr("uint64_templ_id"), paramMessageRecord.getExtInfoFromExtStr("uint64_templ_id"))) || (!TextUtils.equals(paramMessageForUniteGrayTip.getExtInfoFromExtStr("bytes_content"), paramMessageRecord.getExtInfoFromExtStr("bytes_content")))) {
      return false;
    }
    return true;
  }
  
  private boolean a(MessageForUniteGrayTip paramMessageForUniteGrayTip, List<MessageRecord> paramList)
  {
  ...
  public MessageForGrayTips a(TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    do
    {
      ...
      } while (amwh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForGrayTips, false));
  ...
  public MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, long paramLong, boolean paramBoolean1, boolean paramBoolean2, bblx parambblx)
  {
    ...
    do
    {
      ...
      do
      {
        try
        {
          ...
          l4 = ((TroopTips0x857.NotifyMsgBody)localObject2).opt_uint64_group_code.get();
          if (QLog.isColorLevel()) {
            QLog.d("TroopTipsMsgMgr", 2, "handle0x2dcSubType0x10 ==> msgSeq:" + paramInt + ", promptType: " + i + ", serviceType: " + j + ", troopUin: " + l4);
          }
          if (a(l4 + "", paramInt)) {
            return null;
          }
          ...
          ((TroopTipsEntity)localObject3).troopUin = String.valueOf(l4);
          ...
          case 1: 
            if (((TroopTips0x857.NotifyMsgBody)localObject2).opt_msg_redtips.has())
            {
              ...
              {
                a(new bfea(this, ((TroopTipsEntity)localObject3).troopUin, paramArrayOfByte));
                return null;
              }
              ((TroopTipsEntity)localObject3).currentUin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
              paramQQAppInterface = (MessageForQQWalletTips)bbli.a(-2029);
              ...
              paramQQAppInterface.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), ((TroopTipsEntity)localObject3).troopUin, "", "[QQWallet Tips]", bbko.a(), -2029, 1, bbko.a());
            ...
            if (((TroopTips0x857.NotifyMsgBody)localObject2).opt_msg_graytips.uint32_robot_group_opt.has())
            {
              ...
              paramArrayOfByte = (bfdm)paramQQAppInterface.getManager(203);
            }
            ...
            if (j == 3)
            {
              beyy.a(paramQQAppInterface, (TroopTipsEntity)localObject3);
              return null;
            }
            if ((j == 6) && (((TroopTips0x857.NotifyMsgBody)localObject2).opt_msg_graytips.uint64_receiver_uin.has()))
            {
              ...
              {
                beda.a().a(String.valueOf(l4), paramQQAppInterface.getCurrentAccountUin(), true);
                ((anca)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(20)).a(l4, paramLong);
              }
            }
            for (;;)
            {
              ...
              if ((paramBoolean1) || (!amwh.a(paramQQAppInterface, paramArrayOfByte, false))) {
                break label1265;
              }
              return null;
              if (j != 11) {
      ...
      TroopUtils.handleModifyName(l4, paramQQAppInterface, paramLong);
      return null;
    ...
    if (((TroopTips0x857.NotifyMsgBody)localObject2).opt_msg_group_notify.has())
    {
      ...
      paramArrayOfByte = ((avtd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(Long.valueOf(l4), true);
      if ((paramArrayOfByte != null) && (1 == paramQQAppInterface.opt_uint32_auto_pull_flag.get()))
      {
        ...
        ((anca)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(20)).notifyUI(67, true, new Object[] { String.valueOf(l4), paramQQAppInterface.opt_bytes_feeds_id.get().toStringUtf8(), Integer.valueOf(paramQQAppInterface.opt_uint32_auto_pull_flag.get()) });
        break label4728;
        if (!paramBoolean2)
        {
          if (parambblx != null) {
          ...
          {
            parambblx = (TroopTips0x857.MessageRecallReminder)((TroopTips0x857.NotifyMsgBody)localObject2).opt_msg_recall.get();
            paramLong = parambblx.uint64_uin.get();
            l1 = parambblx.uint64_admin_uin.get();
            i = parambblx.uint32_op_type.get();
            if (parambblx.msg_wording_info.has())
            {
              paramInt = parambblx.msg_wording_info.int32_item_id.get();
              paramQQAppInterface = parambblx.msg_wording_info.string_item_name.get();
              label1551:
              paramArrayOfByte = new HashMap();
              try
              {
                localObject1 = new msgrevoke_userdef.MsgInfoUserDef();
                ((msgrevoke_userdef.MsgInfoUserDef)localObject1).mergeFrom(parambblx.bytes_userdef.get().toByteArray());
              ...
              parambblx = ((ArrayList)parambblx.uint32_recalled_msg_list.get()).iterator();
              while (parambblx.hasNext())
              {
                localObject3 = (TroopTips0x857.MessageRecallReminder.MessageMeta)parambblx.next();
                ...
                ((RevokeMsgInfo)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(l4);
              ...
              parambblx = (TroopTips0x857.NotifyObjmsgUpdate)((TroopTips0x857.NotifyMsgBody)localObject2).opt_msg_objmsg_update.get();
              if (!parambblx.bytes_ext_msg.has()) {
                break label4728;
              }
              paramArrayOfByte = new SubMsgType0xaa.MsgBody();
              try
              {
                paramArrayOfByte.mergeFrom(parambblx.bytes_ext_msg.get().toByteArray());
                ((aubl)paramQQAppInterface.getManager(156)).a(paramArrayOfByte, false);
              }
              catch (Exception parambblx)
              {
                for (;;)
                {
                  if (QLog.isColorLevel()) {
              ...
              ((bhab)paramQQAppInterface.getBusinessHandler(107)).a((TroopTips0x857.WereWolfPush)((TroopTips0x857.NotifyMsgBody)localObject2).opt_msg_werewolf_push.get(), paramArrayOfByte);
              break label4728;
              if (QLog.isColorLevel()) {
              ...
              ((alnn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).a(0, 1, Long.toString(l4), paramQQAppInterface);
              break label4728;
              if (QLog.isColorLevel()) {
              ...
              ((alom)paramQQAppInterface.getManager(227)).a(1, paramArrayOfByte);
              break label4728;
              if (QLog.isColorLevel()) {
              ...
              akat.a(1, (TroopTips0x857.GoldMsgTipsElem)((TroopTips0x857.NotifyMsgBody)localObject2).opt_msg_goldtips.get(), null);
              break label4728;
              if (QLog.isColorLevel()) {
              ...
              ((anca)paramQQAppInterface.getBusinessHandler(20)).a(String.valueOf(l4), false, "", false, true, false, true);
              break label4728;
              if (QLog.isColorLevel()) {
              ...
              bcvs.a(paramQQAppInterface, (TroopTips0x857.TroopFormGrayTipsInfo)((TroopTips0x857.NotifyMsgBody)localObject2).opt_msg_troopformtips_push.get(), ((TroopTipsEntity)localObject3).troopUin);
              break label4728;
              if (QLog.isColorLevel()) {
              ...
              ((bkjs)paramQQAppInterface.getManager(386)).a(paramArrayOfByte, l4);
              break label4728;
              if (((TroopTips0x857.NotifyMsgBody)localObject2).opt_msg_media_push.has())
              {
                auzl.a(paramQQAppInterface, paramInt, paramLong, (TroopTips0x857.MediaChangePushInfo)((TroopTips0x857.NotifyMsgBody)localObject2).opt_msg_media_push.get());
                break label4728;
              }
              ...
              {
                paramQQAppInterface = (mxx)paramQQAppInterface.getBusinessHandler(178);
                if (paramQQAppInterface == null) {
                  break label4728;
                }
              ...
              if (paramBoolean1)
              {
                try
                {
                  parambblx = (TroopTips0x857.GeneralGrayTipInfo)((TroopTips0x857.NotifyMsgBody)localObject2).opt_general_gray_tip.get();
                  if (parambblx.uint64_busi_type.has())
                  {
                    l1 = parambblx.uint64_busi_type.get();
                    if (!parambblx.uint64_busi_id.has()) {
                      break label3155;
                    }
                    l2 = parambblx.uint64_busi_id.get();
                    if (!parambblx.uint64_templ_id.has()) {
                      break label3161;
                    }
                    l3 = parambblx.uint64_templ_id.get();
                    if (!parambblx.uint32_ctrl_flag.has()) {
                      break label3167;
                    }
                    paramInt = parambblx.uint32_ctrl_flag.get();
                    if (parambblx.uint32_c2c_type.has()) {
                      parambblx.uint32_c2c_type.get();
                    }
                    if (parambblx.uint32_service_type.has()) {
                      parambblx.uint32_service_type.get();
                    }
                    if (!parambblx.bytes_pb_reserv.has()) {
                      break label3172;
                    }
                    paramArrayOfByte = parambblx.bytes_pb_reserv.get().toByteArray();
                    if (!parambblx.bytes_content.has()) {
                      break label3177;
                    }
                    parambblx = parambblx.bytes_content.get().toByteArray();
                    localObject1 = "";
                    if ((parambblx == null) || (parambblx.length <= 0)) {
                      break label3183;
                    }
                    parambblx = new String(parambblx, "utf-8");
                    paramInt = aucg.a(paramInt);
                    a(paramQQAppInterface, l4, l2, l3, parambblx);
                    paramArrayOfByte = aucg.a(paramQQAppInterface, ((TroopTipsEntity)localObject3).troopUin, 1, paramInt, paramLong, parambblx, l1, l2, paramArrayOfByte);
                    if (paramArrayOfByte == null) {
                      break label4728;
                    }
                    ...
                    paramArrayOfByte.saveExtInfoToExtStr("bytes_content", parambblx);
                    ...
                    bcef.b(paramQQAppInterface, "CliOper", "", "", "0X800A560", "0X800A560", 3, 0, "" + l2, "" + l1, "", "");
                    if (a(paramArrayOfByte)) {
                      break label3229;
                    }
                    aucg.a(paramQQAppInterface, paramArrayOfByte);
                  }
                }
              ...
              {
                paramArrayOfByte = ((bdct)paramQQAppInterface.getManager(339)).a(2);
                if (paramArrayOfByte == null) {
                  break label4728;
                }
              ...
              {
                paramArrayOfByte = ((bdct)paramQQAppInterface.getManager(339)).a(4);
                if (paramArrayOfByte == null) {
                  break label4728;
                }
              ...
              if (paramArrayOfByte.uint32_group_honor_switch.has())
              {
                ...
                parambblx = (bepr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(346);
                if (paramInt != 0) {
                  break label4732;
                }
                paramBoolean1 = true;
                parambblx.a(String.valueOf(paramLong), paramBoolean1);
              }
              if (paramArrayOfByte.uint32_group_member_level_switch.has())
              {
                ...
                parambblx = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                localObject1 = parambblx.c(String.valueOf(paramLong));
                if (localObject1 != null)
                {
                  ...
                  parambblx.b((TroopInfo)localObject1);
                  parambblx = (anca)paramQQAppInterface.getBusinessHandler(20);
                  if (parambblx != null)
                  {
                    if (paramInt != 0) {
                      break label4738;
                    ...
                    paramBoolean1 = true;
                    label3680:
                    parambblx.notifyUI(152, true, new Object[] { String.valueOf(paramLong), Boolean.valueOf(paramBoolean1) });
                  }
                }
              }
              if (paramArrayOfByte.uint32_group_flagext4.has())
              {
                ...
                {
                  if (QLog.isColorLevel()) {
                    QLog.d("TroopTipsMsgMgr", 1, "uint32_group_flagext4 changed");
                  }
                  ((TroopInfo)localObject1).groupFlagExt4 = paramInt;
                  parambblx.b((TroopInfo)localObject1);
                  parambblx = (anca)paramQQAppInterface.getBusinessHandler(20);
                  if (parambblx != null) {
                    parambblx.notifyUI(154, true, new Object[] { String.valueOf(paramLong), Integer.valueOf(paramInt) });
                  }
                }
              }
              if (paramArrayOfByte.uint32_group_class_ext.has())
              {
                ...
                if (localObject1 != null)
                {
                  ...
                  ((TroopInfo)localObject1).dwGroupClassExt = ((byte)paramInt);
                  parambblx.b((TroopInfo)localObject1);
                  parambblx = (anca)paramQQAppInterface.getBusinessHandler(20);
                  if (parambblx != null) {
                    parambblx.notifyUI(156, true, new Object[] { String.valueOf(paramLong), Integer.valueOf(paramInt) });
                  }
                }
              }
              if (paramArrayOfByte.uint32_group_flagext3.has())
              {
                ...
                parambblx = ((TroopManager)localObject1).c(String.valueOf(paramLong));
                if (parambblx != null)
                {
                  parambblx.dwGroupFlagExt3 = paramArrayOfByte.uint32_group_flagext3.get();
                  ((TroopManager)localObject1).b(parambblx);
                  paramQQAppInterface = (anca)paramQQAppInterface.getBusinessHandler(20);
                  if (paramQQAppInterface != null) {
                    paramQQAppInterface.notifyUI(157, true, new Object[] { String.valueOf(paramLong), Long.valueOf(parambblx.dwGroupFlagExt3) });
                  }
                }
              }
              ...
              paramQQAppInterface = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
              if (paramQQAppInterface == null) {
                break label4728;
              }
              parambblx = paramQQAppInterface.c(String.valueOf(paramLong));
              if (parambblx != null)
              {
                ...
                paramBoolean1 = true;
                label4168:
                parambblx.isTroopBlocked = paramBoolean1;
                if (QLog.isColorLevel()) {
                ...
                {
                  parambblx.appealDeadline = paramArrayOfByte.uint32_appeal_deadline.get();
                  if (QLog.isColorLevel()) {
                    QLog.d("TroopTipsMsgMgr.push", 2, "groupInfoChange push, uint32_appeal_deadline = " + parambblx.appealDeadline);
                  }
                }
                paramQQAppInterface.b(parambblx);
                paramQQAppInterface = (anca)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(20);
                if (paramQQAppInterface == null) {
                  break label4728;
                }
                paramQQAppInterface.notifyUI(158, true, new Object[] { String.valueOf(l4) });
                break label4728;
              }
              if (!QLog.isColorLevel()) {
                break label4728;
              ...
              break label4728;
              avdk.a(paramQQAppInterface, paramInt, paramLong, (TroopTips0x857.NotifyMsgBody)localObject2);
              break label4728;
              if (!((TroopTips0x857.NotifyMsgBody)localObject2).opt_group_announce_tbc_info.has()) {
                break label4728;
              }
              parambblx = (TroopTips0x857.GroupAnnounceTBCInfo)((TroopTips0x857.NotifyMsgBody)localObject2).opt_group_announce_tbc_info.get();
              if (parambblx == null) {
                break label4728;
              }
              if (!parambblx.feeds_id.has()) {
                break label4753;
              }
            }
          }
    ...
    label4744:
    label4753:
    for (paramArrayOfByte = parambblx.feeds_id.get().toStringUtf8();; paramArrayOfByte = null)
    {
      paramLong = parambblx.group_id.get();
      paramInt = parambblx.action.get();
      switch (paramInt)
      {
      case 0: 
        bfdg.b(paramQQAppInterface, paramArrayOfByte, String.valueOf(paramLong), 1);
        break;
      case 1: 
      case 2: 
        ...
        if (((TroopTips0x857.NotifyMsgBody)localObject2).opt_study_room_member_msg.has())
        {
          ...
          ((bcpa)paramQQAppInterface.getManager(362)).a(((TroopTips0x857.StudyRoomMemberChangePush)((TroopTips0x857.NotifyMsgBody)localObject2).opt_study_room_member_msg.get()).toByteArray(), paramLong + "");
          break label4728;
          if (((TroopTips0x857.NotifyMsgBody)localObject2).opt_qq_group_digest_msg.has())
          {
            ...
            ((bedz)paramQQAppInterface.getManager(381)).a((TroopTips0x857.QQGroupDigestMsg)((TroopTips0x857.NotifyMsgBody)localObject2).opt_qq_group_digest_msg.get(), paramBoolean1);
            break label4728;
            paramInt = 0;
            paramQQAppInterface = "";
            break label1551;
  ...
  public void a(bfea parambfea)
  {
    if (QLog.isColorLevel()) {
      QLog.d("TroopTipsMsgMgr", 2, "addWalletTipsCache");
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(parambfea);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      bfea localbfea = (bfea)localIterator.next();
      TroopTips0x857.RedGrayTipsInfo localRedGrayTipsInfo = localbfea.jdField_a_of_type_TencentImOidbCmd0x857TroopTips0x857$RedGrayTipsInfo;
      ...
      localMessageForQQWalletTips.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localbfea.jdField_a_of_type_JavaLangString, "", "[QQWallet Tips]", bbko.a(), -2029, 1, bbko.a());
