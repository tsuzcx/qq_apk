  ...
  implements bcgn
{
  ...
  public static nak a(QQAppInterface paramQQAppInterface, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      paramJSONObject = nap.a(paramJSONObject.optJSONObject("singleImageModule"));
      continue;
      paramJSONObject = nas.a(paramJSONObject.optJSONObject("mixVideoModule"));
      continue;
  ...
  private void d()
  {
    ...
    {
      bbmy.a(this.jdField_a_of_type_AndroidContentContext, 1, this.jdField_a_of_type_AndroidContentContext.getString(2131652572), 0).b(0);
      return;
    }
  ...
  private void e()
  {
    nbe.a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Nac, this);
    if (this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton != null)
    {
      this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(this.jdField_a_of_type_AndroidContentContext.getText(2131652657));
    ...
    nbe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString, 3, 2, 0);
  }
  ...
  private void f()
  {
    if ((this.jdField_a_of_type_AndroidContentContext != null) && (!((Activity)this.jdField_a_of_type_AndroidContentContext).isFinishing()))
    {
      ...
      {
        this.jdField_a_of_type_AndroidAppDialog = nbe.a(this.jdField_a_of_type_AndroidContentContext, null, this.jdField_a_of_type_AndroidContentContext.getString(2131652665), new nan(this), this.jdField_a_of_type_AndroidContentContext.getString(2131652666), new nao(this), this.jdField_a_of_type_AndroidContentContext.getString(2131652667));
  ...
  private void g()
  {
    if (this.jdField_c_of_type_Int == 3)
    {
      ...
      bbmy.a(this.jdField_a_of_type_AndroidContentContext, 1, this.jdField_a_of_type_AndroidContentContext.getString(2131652668), 0).b(0);
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_a_of_type_Nac != null) && (this.jdField_a_of_type_Nac.jdField_a_of_type_Int == 2))
    {
      localAdProgressButton = (AdProgressButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131306312);
      if (this.jdField_a_of_type_Nac.jdField_b_of_type_Int != 2) {
        break label70;
      }
      localAdProgressButton.setText(this.jdField_a_of_type_AndroidContentContext.getText(2131652671));
    }
    label70:
    do
    {
      ...
      if (nbe.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Nac.f))
      {
        localAdProgressButton.setText(this.jdField_a_of_type_AndroidContentContext.getText(2131652669));
        this.jdField_c_of_type_Int = 1;
        return;
      }
      if (nbe.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Nac))
      {
        localAdProgressButton.setText(this.jdField_a_of_type_AndroidContentContext.getText(2131652662));
        this.jdField_c_of_type_Int = 2;
        return;
      }
    } while (this.jdField_c_of_type_Int == 3);
    localAdProgressButton.setText(this.jdField_a_of_type_AndroidContentContext.getText(2131652656));
    this.jdField_c_of_type_Int = 0;
  }
  
  public void a(Context paramContext, View paramView)
  {
    Object localObject1 = LayoutInflater.from(paramContext).inflate(2131494401, null);
    Object localObject2 = new RelativeLayout.LayoutParams(-1, -2);
    ((RelativeLayout.LayoutParams)localObject2).addRule(12, -1);
    ((ViewGroup)paramView).addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
    if (((this.jdField_a_of_type_Nac == null) || (this.jdField_a_of_type_Nac.jdField_a_of_type_Int != 1)) && (!this.jdField_a_of_type_Boolean) && ((this.jdField_b_of_type_Int == 1) || (this.jdField_b_of_type_Int == 2)))
    {
      paramView.findViewById(2131311504).setVisibility(0);
      if (this.jdField_b_of_type_Int == 1) {
        paramView.findViewById(2131311508).setVisibility(8);
      }
      localObject1 = paramView.findViewById(2131312925);
      localObject2 = paramView.findViewById(2131312926);
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Nac != null) && (this.jdField_a_of_type_Nac.jdField_a_of_type_Int == 2)) {
      paramView.findViewById(2131299771).setVisibility(0);
    }
    try
    {
      localObject1 = new URL(this.jdField_a_of_type_Nac.jdField_a_of_type_JavaLangString);
      ((ResizeURLImageView)paramView.findViewById(2131299782)).a((URL)localObject1);
      ((TextView)paramView.findViewById(2131299779)).setText(this.jdField_a_of_type_Nac.jdField_b_of_type_JavaLangString);
      this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton = ((AdProgressButton)paramView.findViewById(2131306312));
      this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setProgressColor(paramContext.getResources().getColor(2131099760));
      this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setOnClickListener(new nal(this));
      int i = nbe.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Nac);
      if (i >= 0)
      {
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setText(this.jdField_a_of_type_AndroidContentContext.getText(2131652657));
        this.jdField_a_of_type_ComTencentBizPubaccountAdvertisementViewAdProgressButton.setTextColor(-16777216);
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new nam(this);
  ...
  public void onDownloadFinish(DownloadInfo paramDownloadInfo)
  {
    if (a(paramDownloadInfo))
    {
      ...
      nbe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString, 3, 4, 0);
    }
  }
