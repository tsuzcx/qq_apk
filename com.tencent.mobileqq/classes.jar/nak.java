...
public class nak
{
  ...
  public static String a(Context paramContext, String paramString, android.os.Bundle paramBundle1, android.os.Bundle paramBundle2)
  {
    ...
    //   81: astore_1
    //   82: aload_2
    //   83: invokestatic 56	nam:a	(Landroid/os/Bundle;)Ljava/lang/String;
    //   86: astore 6
    //   88: aload_1
    //   89: astore_2
    //   90: aload 6
    ...
    //   158: aload_2
    //   159: aload_0
    //   160: invokestatic 86	nak:a	(Landroid/content/Context;)Ljava/net/Proxy;
    ...
    //   190: aload_0
    //   191: aload_2
    //   192: invokestatic 107	nak:a	(Ljavax/net/ssl/HttpsURLConnection;Ljava/net/URL;)V
    //   195: aload_0
    //   196: ldc 109
    //   198: ldc 111
  ...
  private static Proxy a(Context paramContext)
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (bbev.a((NetworkInfo)localObject)))
      {
        localObject = nam.a(paramContext);
        int i = nam.a(paramContext);
  ...
  {
    nal localnal = new nal(paramURL);
    paramHttpsURLConnection.setRequestProperty("host", paramURL.getHost());
    paramHttpsURLConnection.setSSLSocketFactory(new bbmk(paramURL.getHost(), localnal));
    paramHttpsURLConnection.setHostnameVerifier(localnal);
  }
}
