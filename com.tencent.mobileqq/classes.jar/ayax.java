  ...
  implements Manager
{
  ...
  public ayax(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_Aukp = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    List localList = this.jdField_a_of_type_Aukp.a(SubAccountInfo.class);
        ...
        if (localObject != null)
        {
          ...
          if (i2 != 0)
          {
            ...
            if ((((SubAccountMessage)localObject).mEmoRecentMsg == null) && (((SubAccountMessage)localObject).msg != null)) {
              ((SubAccountMessage)localObject).mEmoRecentMsg = new aykk(((SubAccountMessage)localObject).msg, 3, 16);
            }
  ...
  private void c()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Aukp.a(SubAccountMessage.class, SubAccountMessage.class.getSimpleName(), false, "subUin=?", new String[] { str }, null, null, "time desc", null);
            ...
            if ((paramString1.equals(localSubAccountMessage.subUin)) && (paramString2.equals(localSubAccountMessage.senderuin)))
            {
              ...
              if (localIterator.hasNext())
              {
                ...
                if (localSubAccountMessage != null) {
                  this.jdField_a_of_type_Aukp.b(localSubAccountMessage);
                }
                if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aukp.a(SubAccountMessage.class.getSimpleName());
  }
  ...
  public void a(ayay paramayay)
  {
    ...
    {
      if ((paramayay != null) && (paramayay.jdField_b_of_type_JavaLangString != null) && (paramayay.c())) {
        break label183;
      }
      if (QLog.isColorLevel())
      {
    ...
    label143:
    for (paramayay = "data == null";; paramayay = "data.mMainAccount=" + paramayay.jdField_b_of_type_JavaLangString + " data.mSubUin=" + paramayay.jdField_c_of_type_JavaLangString)
    {
      QLog.d("SUB_ACCOUNT", 2, paramayay);
      return;
      localObject1 = "data.mMainAccount=" + paramayay.jdField_b_of_type_JavaLangString + " data.mSubUin=" + paramayay.jdField_c_of_type_JavaLangString;
      break;
    }
    label183:
    ArrayList localArrayList2 = paramayay.a();
    Object localObject1 = paramayay.c();
    ArrayList localArrayList3 = paramayay.b();
    if (QLog.isColorLevel())
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if ((!paramayay.jdField_b_of_type_JavaLangString.equals(((SubAccountInfo)localObject1).trunkuin)) || (!str.equals(((SubAccountInfo)localObject1).subuin))) {
            continue;
          }
          ...
          ((SubAccountInfo)localObject2).trunkuin = paramayay.jdField_b_of_type_JavaLangString;
          ((SubAccountInfo)localObject2).serverErrorType = paramayay.jdField_b_of_type_Int;
          ((SubAccountInfo)localObject2).serverErrorMsg = paramayay.jdField_a_of_type_JavaLangString;
      ...
      {
        paramayay = localArrayList3.iterator();
        while (paramayay.hasNext()) {
          a((String)paramayay.next());
        }
      }
      label575:
      this.jdField_a_of_type_JavaUtilConcurrentLocksLock.unlock();
      ...
      paramayay = localArrayList1.iterator();
      while (paramayay.hasNext()) {
        a((SubAccountInfo)paramayay.next());
      }
      break;
      label629:
      localObject1 = null;
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          ayaq.a(paramQQAppInterface, paramString1, 6);
          paramQQAppInterface.a().c(paramString1, 7000, -i);
          paramQQAppInterface.a().a(new String[] { ajsd.x, paramString1 });
          paramQQAppInterface.D();
          paramString2 = new ayay();
  ...
  public void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      boolean bool = this.jdField_a_of_type_Aukp.a((String)localObject1, (ContentValues)localObject2, "subUin=?", new String[] { paramString });
      if (!QLog.isColorLevel()) {
        break;
      }
          ...
          if (localObject2 != null)
          {
            ...
            if ((localObject2 != null) && (((ArrayList)localObject2).size() != 0))
            {
              ...
              if (((Iterator)localObject2).hasNext())
              {
                ...
                localSubAccountMessage.mTimeString = bbkp.a(localSubAccountMessage.time * 1000L, true, paramString);
                if (i == 0) {
                  break label332;
                }
                i = 0;
  ...
  public void g(String paramString)
  {
    ...
    boolean bool = this.jdField_a_of_type_Aukp.a(str, localContentValues, null, null);
    if (QLog.isColorLevel()) {
