  ...
  extends BaseAdapter
{
  ...
  public ayax(Context paramContext, int paramInt, List<InterestTagInfo> paramList, ayba paramayba)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      localInterestTagItemView.setCallback(this.jdField_a_of_type_Ayba);
    }
    for (;;)
    {
