...
public class tzq
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          return k;
          localObject = (aody)paramQQAppInterface.getManager(56);
          k = j;
        } while (localObject == null);
        Object localObject = ((aody)localObject).b(paramString);
        if (localObject != null)
        {
  ...
  public static int a(String paramString)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      } else if ((localRecentUserBaseData.mUser.getType() == 1008) && (tug.b((QQAppInterface)ozs.a(), localRecentUserBaseData.mUser.uin))) {
        ((Iterator)localObject2).remove();
      }
    }
    int i = 0;
  ...
  public static String a(ArticleInfo paramArticleInfo, pql parampql)
  {
    ...
    for (;;)
    {
      return bcsa.b(paramArticleInfo);
      label145:
      localObject1 = localObject2;
      ...
      parampql = ReadInJoyUserInfoModule.a(Long.valueOf(paramArticleInfo.msgBoxBriefPreFix).longValue(), parampql);
      if (parampql == null)
      {
        localObject1 = ReadInJoyUserInfoModule.a() + ": ";
        break;
      }
      localObject1 = parampql.nick + ": ";
      break;
        ...
        for (;;)
        {
          ...
          if (paramBaseArticleInfo.mTopicRecommendFeedsInfo != null)
          {
            ...
            if (paramBaseArticleInfo.mTopicRecommendFeedsInfo.a != null)
            {
              ...
              {
                localObject = ((qzd)paramBaseArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).c;
                str1 = ((qzd)paramBaseArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).jdField_a_of_type_JavaLangString;
              }
            }
          }
  ...
  public static String a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      localObject1 = bhsi.q(BaseApplicationImpl.getApplication(), str);
      if (localObject1 == null) {
        break label123;
      }
    }
    for (;;)
    {
      try
      {
        ...
        {
          paramString = nmj.a(paramString, "_kdSkinID=" + localSkinData.id);
          if (bhsi.u(BaseApplicationImpl.getApplication(), str)) {
            localObject1 = nmj.a(paramString, "_kdSkinVoice=1");
          }
        }
        else
        {
      ...
      return nmj.a(paramString, "_kdSkinVoice=0");
      label123:
      Object localObject2 = null;
    }
  }
  ...
  public static NewIntent a(QQAppInterface paramQQAppInterface, Context paramContext, MqqHandler paramMqqHandler, String paramString)
  {
    ...
    //   36: ifnull +7 -> 43
    //   39: aload_2
    //   40: putstatic 417	tzq:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   43: ldc 2
    //   45: monitorexit
    ...
    //   130: dup
    //   131: aload_0
    //   132: invokespecial 476	tzr:<init>	(Lcom/tencent/mobileqq/app/QQAppInterface;)V
  ...
  public static oag a(AccountDetail paramAccountDetail)
  {
    oag localoag = a(paramAccountDetail, 0, 9);
    if (localoag == null)
    {
  ...
  public static oag a(AccountDetail paramAccountDetail, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      while (!((Iterator)localObject).hasNext())
      {
        do
        {
          ...
          localObject = (oaf)paramAccountDetail.next();
        } while (((oaf)localObject).jdField_a_of_type_Int != paramInt1);
        localObject = ((oaf)localObject).jdField_a_of_type_JavaUtilList.iterator();
      }
      localoag = (oag)((Iterator)localObject).next();
    } while (localoag.c != paramInt2);
    return localoag;
    return null;
  }
  ...
  public static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, ProfileParams paramProfileParams)
  {
    ...
    for (;;)
    {
      ...
      localObject = new tzs(paramActivity, paramQQAppInterface, paramProfileParams);
      localObject = bmud.a(paramQQAppInterface, paramProfileParams.a(), (anui)localObject);
      if (localObject != null)
      {
  ...
  {
    boolean bool = ((Boolean)bhsi.a(paramContext, paramQQAppInterface.getCurrentAccountUin(), "config_tim_team_is_web", Boolean.valueOf(false))).booleanValue();
    String str = (String)bhsi.a(paramContext, paramQQAppInterface.getCurrentAccountUin(), "config_tim_team_url", "https://m.q.qq.com/a/p/1109953074?s=pages%2Fnotification%2Findex%3FenterType%3DqqMiniHelper");
    if ((!bool) && (MiniAppLauncher.isMiniAppUrl(str))) {
      MiniAppLauncher.startMiniApp(paramContext, str, 1043, null);
    }
    for (;;)
    {
      paramQQAppInterface.a().a(antf.aV, 1008, true, true);
      return;
  ...
  private static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, int paramInt, Intent paramIntent)
  {
    ...
    nok.a(paramContext, paramIntent, paramString, false, -1, true, -1);
  }
  ...
  public static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    } while (!nmd.a(paramActivity, paramString));
    a(paramIntent, paramActivity, paramString, paramInt2, paramInt3);
    return;
    nok.a(paramActivity, paramIntent, paramString, false, 5, true, paramInt2);
  }
  ...
  private static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      String str = oyu.k + bhkv.encodeToString(paramString.getBytes(), 0);
  ...
  public static void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        break;
      case -6: 
        if (!nmd.a(paramContext, paramString)) {
          break;
        }
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, aoeg paramaoeg)
  {
    a(paramAppInterface, paramContext, paramString, paramaoeg, true, 0);
  }
  
  @Deprecated
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, aoeg paramaoeg, int paramInt)
  {
    ...
    localQQAppInterface.addObserver(new aped(new uab(paramaoeg, paramString, paramAppInterface, paramContext), localQQAppInterface));
    apei.a(localQQAppInterface, true, paramString, 0);
    if ((paramAppInterface instanceof QQAppInterface)) {
      paramAppInterface = (QQAppInterface)paramAppInterface;
    }
    for (;;)
    {
      ocd.a(paramAppInterface, paramString, 0);
      return;
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, aoeg paramaoeg, boolean paramBoolean)
  {
    a(paramAppInterface, paramContext, paramString, paramaoeg, paramBoolean, 0);
  }
  
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, aoeg paramaoeg, boolean paramBoolean, int paramInt)
  {
    a(paramAppInterface, paramContext, paramString, paramaoeg, paramBoolean, paramInt, false);
  }
  
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString, aoeg paramaoeg, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    if ((paramAppInterface == null) || (paramContext == null) || (TextUtils.isEmpty(paramString))) {
      return;
    }
    ...
    for (;;)
    {
      ...
      {
        paramaoeg = new aped(new tzx(paramaoeg, paramString, paramAppInterface, paramContext, paramInt, paramBoolean1));
        paramContext = new PublicAccountIntent(paramContext.getApplicationContext(), apef.class);
        paramContext.a(paramaoeg);
        ...
        return;
        localObject = (aody)paramAppInterface.getManager(56);
        if (localObject != null)
        {
          localObject = ((aody)localObject).a(paramString);
      ...
      {
        localObject = new NewIntent(paramContext.getApplicationContext(), ocj.class);
        ...
        try
        {
          ...
          ((NewIntent)localObject).setObserver(new tzy(paramaoeg, paramString, paramBoolean1, paramContext, paramAppInterface, paramInt));
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    new pra(paramQQAppInterface, null, null, qfo.a(), null).a(localArrayList);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, RecentUser paramRecentUser, int paramInt, RecentBaseData paramRecentBaseData)
  {
    ...
    aaej.a(paramActivity, 9004, paramRecentUser);
    if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt, long paramLong, boolean paramBoolean)
  {
    ...
    localblir.a(paramContext.getResources().getString(2131695439));
    localblir.a(2131691323, 3);
    if (paramString.equals("2010741172")) {
      localblir.b(2131694628);
    }
    localblir.c(2131690580);
    localblir.a(new tzw(paramQQAppInterface, paramString, paramInt, paramLong, paramBoolean, paramContext, localblir));
    localblir.show();
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, boolean paramBoolean, aoeg paramaoeg)
  {
    a(paramQQAppInterface, paramContext, paramString, paramBoolean, paramaoeg, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, boolean paramBoolean1, aoeg paramaoeg, boolean paramBoolean2)
  {
    if ((paramQQAppInterface == null) || (paramContext == null) || (TextUtils.isEmpty(paramString))) {
      return;
    }
    ...
    {
      localObject2 = ((aody)localObject3).a(paramString);
      ((aody)localObject3).b(paramString);
      paramContext = (Context)localObject2;
      localObject1 = localNewIntent;
      if (localObject2 == null)
      {
        localObject3 = (anxb)paramQQAppInterface.getManager(69);
        paramContext = (Context)localObject2;
        localObject1 = localNewIntent;
        if (localObject3 != null)
        {
          localObject1 = ((anxb)localObject3).a(paramString);
          paramContext = (Context)localObject2;
        }
      }
    }
    ...
    if ((paramBoolean2) || (paramContext == null) || (a(paramContext.accountFlag) != -4))
    {
      ...
      if ((!paramBoolean2) && (paramContext != null) && (a(paramContext.accountFlag) == -4))
      {
        localNewIntent = new NewIntent(paramQQAppInterface.getApp().getApplicationContext(), ocj.class);
    ...
    else
    {
      for (;;)
      {
        try
        {
          ...
          paramContext = new tzz(paramaoeg, paramString, paramBoolean1, localBaseApplication, localObject1, paramQQAppInterface);
    ...
    for (;;)
    {
      paramContext = new aped(new uaa(localObject1, paramQQAppInterface, paramString, paramaoeg, paramBoolean1, localBaseApplication), paramQQAppInterface);
      ...
      apei.a(paramQQAppInterface, false, paramString, 0);
      return;
      localObject1 = paramContext;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    apeg.a(paramQQAppInterface, paramChatMessage.senderuin, 0, 6, paramChatMessage.msgId, str);
  }
      ...
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (jdField_a_of_type_Int == 0)
        {
          ...
          if ((bool) && (paramBoolean))
          {
            ...
            if (??? != null)
            {
              localObject2 = (RecentUser)((apaw)???).findRecentUser(antf.ay, 1008);
              if (localObject2 != null)
              {
                ((apaw)???).delRecentUser((BaseRecentUser)localObject2);
            ...
            ??? = (aody)paramQQAppInterface.getManager(56);
            if (??? != null)
            {
              ((aody)???).c(antf.ay);
  ...
  public static int b(String paramString)
  {
    ...
    if (((RecentUserBaseData)localObject2).mUser.getType() == 1008)
    {
      ...
      if (!TextUtils.equals(((RecentUserBaseData)localObject2).mUser.uin, paramString))
      {
        if (!TextUtils.equals(((RecentUserBaseData)localObject2).mUser.uin, antf.C)) {
          break label215;
        }
        k = i;
      }
  ...
  private static MessageForStructing b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localMessageForStructing.frienduin = antf.az;
  ...
  private static MessageForStructing b(MessageForStructing paramMessageForStructing, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    MessageForStructing localMessageForStructing = (MessageForStructing)bcry.a(paramMessageForStructing.msgtype);
  ...
  public static String b()
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = ozs.h();
        localObject2 = bhlo.d(BaseApplication.getContext());
        if (localObject1 == null) {
          continue;
        }
      }
      ...
      {
        return bhkv.encodeToString((byte[])localObject2, 2);
      }
      label225:
      if (localObject2 == null) {}
    }
  ...
  public static String b(QQAppInterface paramQQAppInterface, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      if ((paramBaseArticleInfo.mFeedType == 4) || (paramBaseArticleInfo.mFeedType == 5))
      {
        ...
        {
          paramBaseArticleInfo = ReadInJoyUserInfoModule.a(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qxt.a, null);
          if (paramBaseArticleInfo != null) {}
      ...
      else
      {
        ...
        {
          paramQQAppInterface = new StringBuilder(anzj.a(2131707637));
          ...
          {
            paramQQAppInterface.append(i + 1).append(".").append(((qwe)paramBaseArticleInfo.hotWordInfo.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_JavaLangString).append("  ");
            i += 1;
          }
          continue;
        }
  ...
  private static void b(AppInterface paramAppInterface, Context paramContext, String paramString, int paramInt)
  {
    ...
    NewIntent localNewIntent = new NewIntent(paramContext, ocj.class);
    ...
    try
    {
      ...
      localNewIntent.setObserver(new uac(paramContext, paramAppInterface, paramInt, paramString));
  ...
  protected static final void c(Activity paramActivity, QQAppInterface paramQQAppInterface, ProfileParams paramProfileParams)
  {
    ...
    paramQQAppInterface = new tzt(paramActivity, paramProfileParams, paramQQAppInterface);
    paramProfileParams = new tzu(paramActivity, paramProfileParams);
    jdField_a_of_type_Bhpc = bhlq.a(paramActivity, 230);
    jdField_a_of_type_Bhpc.setMessage(2131694652);
    jdField_a_of_type_Bhpc.setTitle(2131691920);
    jdField_a_of_type_Bhpc.setNegativeButton(2131690580, paramQQAppInterface);
    jdField_a_of_type_Bhpc.setPositiveButton(2131718007, paramQQAppInterface);
    jdField_a_of_type_Bhpc.setOnCancelListener(paramProfileParams);
  ...
  public static void c(String paramString)
  {
    ...
    ocd.a(null, "CliOper", "", "", "0X8009A7C", "0X8009A7C", 0, 0, paramString, "", "", "", false);
  }
