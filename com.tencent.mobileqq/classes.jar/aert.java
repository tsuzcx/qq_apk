...
{
  private aess jdField_a_of_type_Aess;
  ...
  public aert(Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_Aess = new aess(paramContext);
    this.jdField_a_of_type_Aess.a(new aeru(this));
  }
  ...
  {
    this.jdField_a_of_type_JavaLangString = auoi.a(paramQQAppInterface).a(this.jdField_b_of_type_JavaLangString, this.c);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable.setImageAssetDelegate(new aerw(this));
    }
    try
    {
      ...
      LottieComposition.Factory.fromInputStream(a(), paramQQAppInterface, new aerx(this));
      return;
    }
  ...
  public void a(aese paramaese)
  {
    ...
    if (auoi.a(localQQAppInterface).a(this.jdField_b_of_type_JavaLangString, this.c))
    {
      a(localQQAppInterface);
      paramaese.a(true);
      return;
    }
    auoi.a(localQQAppInterface).a(this.jdField_b_of_type_JavaLangString, this.c, new aerv(this, paramaese));
  }
  ...
  public void b()
  {
    ...
    {
      this.jdField_a_of_type_Aess.b();
      this.jdField_a_of_type_Aess.c();
    }
    a(8);
    super.b();
  }
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_Aess != null) && (this.jdField_a_of_type_Aess.a())) {
      this.jdField_a_of_type_Aess.d();
    }
