  ...
  extends BaseAdapter
{
  ...
  public static final int c = bgtn.b(10.0F);
  float jdField_a_of_type_Float;
  private Context jdField_a_of_type_AndroidContentContext;
  private ArrayList<bokn> jdField_a_of_type_JavaUtilArrayList = new ArrayList(10);
  ...
  static
  {
    jdField_a_of_type_Int = bgtn.b(40.0F);
    jdField_b_of_type_Int = bgtn.b(5.0F);
  }
  
  public bokm(Context paramContext, int paramInt)
  {
  ...
  private View a()
  {
    ...
    for (;;)
    {
      ...
      ((URLImageView)localObject1).setId(2131368138);
      ...
      localObject3 = new bokn();
      ((bokn)localObject3).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localObject1);
      ((bokn)localObject3).jdField_a_of_type_AndroidViewView = localFrameLayout;
      ((bokn)localObject3).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject2);
      ((bokn)localObject3).jdField_a_of_type_Boolean = this.jdField_a_of_type_Boolean;
  ...
  public void a()
  {
    TransitionCategoryItem localTransitionCategoryItem = bpye.a().a();
    ...
    {
      localbokn = (bokn)localIterator.next();
      if (localbokn.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem == null) {
        break label116;
      }
      if (localTransitionCategoryItem == null) {
        break label111;
      }
      bool2 = TextUtils.equals(localTransitionCategoryItem.a, localbokn.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem.a);
      bool1 = bool2;
      if (!bool2)
      {
        if (((localTransitionCategoryItem != null) && (!localTransitionCategoryItem.c())) || (!localbokn.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem.c())) {
          break label105;
        }
        bool1 = true;
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      if ((paramView.getTag() == null) || (!(paramView.getTag() instanceof bokn)))
      {
        if (QLog.isColorLevel()) {
      ...
      bokn localbokn = (bokn)paramView.getTag();
      TextView localTextView = localbokn.jdField_a_of_type_AndroidWidgetTextView;
      URLImageView localURLImageView = localbokn.jdField_a_of_type_ComTencentImageURLImageView;
      ...
      localbokn.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem = localTransitionCategoryItem;
      ...
      for (boolean bool1 = TextUtils.equals(((QIMFilterCategoryItem)localObject).a, localTransitionCategoryItem.a);; bool1 = false) {
        for (;;)
        {
          ...
          try
          {
            ...
            paramView.setContentDescription(localTransitionCategoryItem.b + anni.a(2131713740));
          }
