  ...
  extends DynamicTextItem
{
  ...
  public bokm(int paramInt, @NonNull List<String> paramList, Typeface paramTypeface, Bitmap paramBitmap1, Bitmap paramBitmap2, Bitmap paramBitmap3)
  {
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new boko(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    paramString = bgke.b(super.a(paramInt, new bokn(this))).replaceAll("\n", "");
