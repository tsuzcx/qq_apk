...
public class niu
{
  ...
  public static niu a(String paramString1, String paramString2, String paramString3)
  {
    boolean bool = true;
    niu localniu = new niu();
    localniu.jdField_a_of_type_JavaLangString = paramString2;
    localniu.jdField_b_of_type_JavaLangString = paramString3;
    for (;;)
    {
      try
      {
        paramString1 = new JSONObject(paramString1);
        localniu.jdField_c_of_type_JavaLangString = paramString1.optString("str_adId", "");
        localniu.jdField_d_of_type_JavaLangString = paramString1.optString("str_adPosId", "");
        localniu.jdField_b_of_type_Boolean = paramString1.optBoolean("bool_bannerShow", false);
        localniu.jdField_c_of_type_Int = paramString1.optInt("uint32_bannertype", 0);
        localniu.jdField_d_of_type_Int = paramString1.optInt("uint32_jumpType", 0);
        localniu.n = paramString1.optString("str_jumpUrl", "");
        localniu.jdField_k_of_type_JavaLangString = paramString1.optString("str_appId", "");
        localniu.jdField_l_of_type_JavaLangString = paramString1.optString("str_packagename", "");
        localniu.jdField_i_of_type_JavaLangString = paramString1.optString("str_androidDownloadUrl", "");
        localniu.jdField_f_of_type_JavaLangString = paramString1.optString("str_bannerImgUrl", "");
        localniu.jdField_g_of_type_JavaLangString = paramString1.optString("str_bannerText", "");
        localniu.jdField_h_of_type_JavaLangString = paramString1.optString("str_bannerButtonText", "");
        localniu.jdField_c_of_type_Boolean = paramString1.optBoolean("bool_silentDownload", false);
        localniu.m = paramString1.optString("str_appName", "");
        localniu.jdField_e_of_type_JavaLangString = paramString1.optString("str_reportLink", "");
        if ((!TextUtils.isEmpty(localniu.jdField_e_of_type_JavaLangString)) && (!localniu.jdField_e_of_type_JavaLangString.contains("https"))) {
          localniu.jdField_e_of_type_JavaLangString = localniu.jdField_e_of_type_JavaLangString.replace("http", "https");
        }
        localniu.jdField_a_of_type_Boolean = paramString1.optBoolean("bool_horizontalVideo", false);
        localniu.jdField_a_of_type_Int = paramString1.optInt("uint32_audioFadeinDuration", 5);
        localniu.jdField_b_of_type_Int = paramString1.optInt("uint32_audioSwitchType", 0);
        localniu.jdField_e_of_type_Int = paramString1.optInt("uint32_preDownloadType", 0);
        localniu.jdField_e_of_type_Int = PAAdPreloadTask.checkNetworkType(localniu.jdField_e_of_type_Int);
        localniu.o = paramString1.optString("str_openJumpUrlGuide", "");
        localniu.jdField_j_of_type_JavaLangString = paramString1.optString("str_myappDownloadUrl", "");
        localniu.p = paramString1.optString("str_jumpTypeParams", "");
        localniu.jdField_h_of_type_Int = paramString1.optInt("uint32_scrollUpToJump", 0);
        if (localniu.jdField_h_of_type_Int == 1)
        {
          localniu.jdField_d_of_type_Boolean = bool;
          localniu.jdField_i_of_type_Int = paramString1.optInt("uint32_controlVariable", 0);
          localniu.jdField_j_of_type_Int = paramString1.optInt("uint32_control_plugin_time", 0);
          localniu.jdField_k_of_type_Int = paramString1.optInt("uint32_autoJump", 0);
          if (localniu.jdField_d_of_type_Int >= 3)
          {
            bool = TextUtils.isEmpty(localniu.p);
            if (bool) {}
          }
          try
          {
            paramString2 = new JSONObject(localniu.p);
            localniu.jdField_g_of_type_Int = paramString2.optInt("class_id", -1);
            localniu.q = paramString2.optString("class_name", "");
            localniu.jdField_f_of_type_Int = paramString2.optInt("pendant_id", -1);
            localniu.r = paramString1.optString("str_clickLink", "");
            localniu.jdField_l_of_type_Int = paramString1.optInt("uint32_monitorType", 0);
            localniu.s = paramString1.optString("str_share_nick", "");
            localniu.t = paramString1.optString("str_share_ad_head_url", "");
            localniu.u = paramString1.optString("str_share_ad_brief", "");
            localniu.v = paramString1.optString("str_share_ad_txt", "");
            localniu.w = paramString1.optString("str_share_ad_icon_url", "");
            localniu.x = paramString1.optString("str_share_jump_url", "");
            return localniu;
          }
  ...
  public static niu a(submsgtype0xf9.MsgCommonData paramMsgCommonData, String paramString1, String paramString2)
  {
    boolean bool = true;
    niu localniu = new niu();
    localniu.jdField_a_of_type_JavaLangString = paramString1;
    localniu.jdField_b_of_type_JavaLangString = paramString2;
    if (paramMsgCommonData.str_adId.has()) {
      localniu.jdField_c_of_type_JavaLangString = paramMsgCommonData.str_adId.get();
    }
    if (paramMsgCommonData.str_adPosId.has()) {
      localniu.jdField_d_of_type_JavaLangString = paramMsgCommonData.str_adPosId.get();
    }
    if (paramMsgCommonData.bool_bannerShow.has()) {
      localniu.jdField_b_of_type_Boolean = paramMsgCommonData.bool_bannerShow.get();
    }
    if (paramMsgCommonData.uint32_bannertype.has()) {
      localniu.jdField_c_of_type_Int = paramMsgCommonData.uint32_bannertype.get();
    }
    if (paramMsgCommonData.uint32_jumpType.has()) {
      localniu.jdField_d_of_type_Int = paramMsgCommonData.uint32_jumpType.get();
    }
    if (paramMsgCommonData.str_jumpUrl.has()) {
      localniu.n = paramMsgCommonData.str_jumpUrl.get();
    }
    if (paramMsgCommonData.str_appId.has()) {
      localniu.jdField_k_of_type_JavaLangString = paramMsgCommonData.str_appId.get();
    }
    if (paramMsgCommonData.str_packagename.has()) {
      localniu.jdField_l_of_type_JavaLangString = paramMsgCommonData.str_packagename.get();
    }
    if (paramMsgCommonData.str_androidDownloadUrl.has()) {
      localniu.jdField_i_of_type_JavaLangString = paramMsgCommonData.str_androidDownloadUrl.get();
    }
    if (paramMsgCommonData.str_bannerImgUrl.has()) {
      localniu.jdField_f_of_type_JavaLangString = paramMsgCommonData.str_bannerImgUrl.get();
    }
    if (paramMsgCommonData.str_bannerText.has()) {
      localniu.jdField_g_of_type_JavaLangString = paramMsgCommonData.str_bannerText.get();
    }
    if (paramMsgCommonData.str_bannerButtonText.has()) {
      localniu.jdField_h_of_type_JavaLangString = paramMsgCommonData.str_bannerButtonText.get();
    }
    if (paramMsgCommonData.bool_silentDownload.has()) {
      localniu.jdField_c_of_type_Boolean = paramMsgCommonData.bool_silentDownload.get();
    }
    if (paramMsgCommonData.str_appName.has()) {
      localniu.m = paramMsgCommonData.str_appName.get();
    }
    if (paramMsgCommonData.str_reportLink.has())
    {
      localniu.jdField_e_of_type_JavaLangString = paramMsgCommonData.str_reportLink.get();
      if ((!TextUtils.isEmpty(localniu.jdField_e_of_type_JavaLangString)) && (!localniu.jdField_e_of_type_JavaLangString.contains("https"))) {
        localniu.jdField_e_of_type_JavaLangString = localniu.jdField_e_of_type_JavaLangString.replace("http", "https");
      }
    }
    if (paramMsgCommonData.bool_horizontalVideo.has()) {
      localniu.jdField_a_of_type_Boolean = paramMsgCommonData.bool_horizontalVideo.get();
    }
    if (paramMsgCommonData.uint32_audioFadeinDuration.has()) {
      localniu.jdField_a_of_type_Int = paramMsgCommonData.uint32_audioFadeinDuration.get();
    }
    if (paramMsgCommonData.uint32_audioSwitchType.has()) {
      localniu.jdField_b_of_type_Int = paramMsgCommonData.uint32_audioSwitchType.get();
    }
    if (paramMsgCommonData.uint32_preDownloadType.has())
    {
      localniu.jdField_e_of_type_Int = paramMsgCommonData.uint32_preDownloadType.get();
      localniu.jdField_e_of_type_Int = PAAdPreloadTask.checkNetworkType(localniu.jdField_e_of_type_Int);
    }
    if (paramMsgCommonData.str_openJumpUrlGuide.has()) {
      localniu.o = paramMsgCommonData.str_openJumpUrlGuide.get();
    }
    if (paramMsgCommonData.str_myappDownloadUrl.has()) {
      localniu.jdField_j_of_type_JavaLangString = paramMsgCommonData.str_myappDownloadUrl.get();
    }
    if (paramMsgCommonData.str_jumpTypeParams.has()) {
      localniu.p = paramMsgCommonData.str_jumpTypeParams.get();
    }
    if (paramMsgCommonData.uint32_scrollUpToJump.has())
    {
      ...
      localniu.jdField_h_of_type_Int = paramMsgCommonData.uint32_scrollUpToJump.get();
      if (localniu.jdField_h_of_type_Int != 1) {
        break label1112;
      }
    }
    for (;;)
    {
      ...
      if (paramMsgCommonData.uint32_controlVariable.has())
      {
        ...
        localniu.jdField_i_of_type_Int = paramMsgCommonData.uint32_controlVariable.get();
      }
      if (paramMsgCommonData.uint32_control_plugin_time.has())
      {
        ...
        localniu.jdField_j_of_type_Int = paramMsgCommonData.uint32_control_plugin_time.get();
      }
      if (paramMsgCommonData.uint32_autoJump.has())
      {
        ...
        localniu.jdField_k_of_type_Int = paramMsgCommonData.uint32_autoJump.get();
      }
      if ((localniu.jdField_d_of_type_Int >= 3) && (!TextUtils.isEmpty(localniu.p))) {}
      try
      {
        paramString1 = new JSONObject(localniu.p);
        localniu.jdField_g_of_type_Int = paramString1.optInt("class_id", -1);
        localniu.q = paramString1.optString("class_name", "");
        localniu.jdField_f_of_type_Int = paramString1.optInt("pendant_id", -1);
        if (paramMsgCommonData.str_clickLink.has())
        {
          localniu.r = paramMsgCommonData.str_clickLink.get();
          if ((!TextUtils.isEmpty(localniu.r)) && (!localniu.r.startsWith("https://"))) {
            localniu.r = localniu.r.replace("http://", "https://");
          }
        }
        if (paramMsgCommonData.uint32_monitorType.has()) {
          localniu.jdField_l_of_type_Int = paramMsgCommonData.uint32_monitorType.get();
        }
        if (paramMsgCommonData.str_share_nick.has()) {
          localniu.s = paramMsgCommonData.str_share_nick.get();
        }
        if (paramMsgCommonData.str_share_ad_head_url.has()) {
          localniu.t = paramMsgCommonData.str_share_ad_head_url.get();
        }
        if (paramMsgCommonData.str_share_ad_brief.has()) {
          localniu.u = paramMsgCommonData.str_share_ad_brief.get();
        }
        if (paramMsgCommonData.str_share_ad_txt.has()) {
          localniu.v = paramMsgCommonData.str_share_ad_txt.get();
        }
        if (paramMsgCommonData.str_share_ad_icon_url.has()) {
          localniu.w = paramMsgCommonData.str_share_ad_icon_url.get();
        }
        if (paramMsgCommonData.str_share_jump_url.has()) {
          localniu.x = paramMsgCommonData.str_share_jump_url.get();
        }
        return localniu;
        label1112:
        bool = false;
