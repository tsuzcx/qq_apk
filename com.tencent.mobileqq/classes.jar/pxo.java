  ...
  implements qif
{
  ...
  protected abstract qig a(T paramT);
  
  protected void a(int paramInt, boolean paramBoolean, List<T> paramList, List<qig> paramList1)
  {
    int j = paramInt + 1;
    paramList1.size();
    if (j < paramList.size())
  ...
  public boolean a()
  {
    return badq.h(BaseApplicationImpl.getApplication().getApplicationContext());
  }
  
  protected void b(int paramInt, boolean paramBoolean, List<T> paramList, List<qig> paramList1)
  {
    int j = paramInt - 1;
    paramList1.size();
    if (j >= 0)
