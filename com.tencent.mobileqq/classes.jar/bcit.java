...
public class bcit
  implements bcgn
{
  public bcit(ApkFileDownloadButton paramApkFileDownloadButton) {}
  
  public void installSucceed(String paramString1, String paramString2)
  {
    bcds.b("ApkFileDownloadButton_", "[installSucceed] packageName=" + paramString2 + ",mApkInfo=" + this.a.a);
  ...
  public void onDownloadCancel(DownloadInfo paramDownloadInfo)
  {
    ...
    {
      bcds.b("ApkFileDownloadButton_", "onDownloadCancel info.progress=" + paramDownloadInfo.f);
      this.a.a.b = 1;
  ...
  public void onDownloadError(DownloadInfo paramDownloadInfo, int paramInt1, String paramString, int paramInt2)
  {
    if (this.a.a(paramDownloadInfo, this.a.a))
    {
      bcds.b("ApkFileDownloadButton_", "onDownloadError errorCode=" + paramInt1);
  ...
  public void onDownloadFinish(DownloadInfo paramDownloadInfo)
  {
    if (this.a.a(paramDownloadInfo, this.a.a))
    {
      bcds.b("ApkFileDownloadButton_", "onDownloadFinish info.progress=" + paramDownloadInfo.f);
      this.a.a.b = 4;
      this.a.a.jdField_a_of_type_Int = paramDownloadInfo.f;
      if (this.a.a.jdField_a_of_type_Long == 0L) {
        this.a.a.jdField_a_of_type_Long = paramDownloadInfo.c;
  ...
  public void onDownloadPause(DownloadInfo paramDownloadInfo)
  {
    if (this.a.a(paramDownloadInfo, this.a.a))
    {
      bcds.b("ApkFileDownloadButton_", "onDownloadPause info.progress=" + paramDownloadInfo.f);
      this.a.a.b = 3;
      this.a.a.jdField_a_of_type_Int = paramDownloadInfo.f;
      if (this.a.a.jdField_a_of_type_Long == 0L) {
        this.a.a.jdField_a_of_type_Long = paramDownloadInfo.c;
  ...
  public void onDownloadUpdate(List<DownloadInfo> paramList)
  {
    ...
    bcds.b("ApkFileDownloadButton_", "onDownloadUpdate info.progress=" + localDownloadInfo.f);
    this.a.a.b = 2;
  ...
  public void onDownloadWait(DownloadInfo paramDownloadInfo)
  {
    if (this.a.a(paramDownloadInfo, this.a.a))
    {
      bcds.b("ApkFileDownloadButton_", "onDownloadWait info.progress=" + paramDownloadInfo.f);
      this.a.a.b = 20;
      if (this.a.a.jdField_a_of_type_Long == 0L) {
        this.a.a.jdField_a_of_type_Long = paramDownloadInfo.c;
      }
