  ...
  extends DynamicDrawableSpan
{
  ...
  private bcit(Context paramContext, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, int paramInt, Paint paramPaint, View.OnClickListener paramOnClickListener)
  {
    super(0);
  ...
  public static bcit a(QQAppInterface paramQQAppInterface, Context paramContext, MessageForReplyText.SourceMsgInfo paramSourceMsgInfo, int paramInt, Paint paramPaint, View.OnClickListener paramOnClickListener)
  {
    ...
    return new bcit(paramContext, paramSourceMsgInfo, paramInt, paramPaint, paramOnClickListener);
  }
  ...
  private void a(Paint paramPaint)
  {
    ...
    do
    {
      do
      {
        ...
        paramPaint.append(bdrv.a(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, ChatTextSizeSettingActivity.a(), null, 7));
        localObject = new TextView(this.jdField_a_of_type_AndroidContentContext);
        ((TextView)localObject).setSingleLine();
        ((TextView)localObject).setEllipsize(TextUtils.TruncateAt.END);
        ((TextView)localObject).setBackgroundDrawable(((TextView)localObject).getResources().getDrawable(2130838147));
        ((TextView)localObject).setGravity(16);
        i = ((TextView)localObject).getResources().getColor(2131166997);
        ...
        i = (int)bdgz.a(this.jdField_a_of_type_AndroidContentContext, 6.0F);
        j = (int)bdgz.a(this.jdField_a_of_type_AndroidContentContext, 23.0F);
