  ...
  implements wef
{
  private boolean a(List<String> paramList)
  {
    ...
    {
      ykq.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleAlbumEntraConfig type: 日迹主页影集入口配置, content: \n", paramList);
      paramList = (vwv)wjs.a(30);
        ...
        catch (NumberFormatException localNumberFormatException3)
        {
          try
          {
            for (;;)
            {
              ...
              ykq.e("Q.qqstory.config.QQStoryConfigServletHandler", "get enableCqMode= " + str11 + " from json error:" + localNumberFormatException1);
              continue;
              localNumberFormatException2 = localNumberFormatException2;
              ykq.e("Q.qqstory.config.QQStoryConfigServletHandler", "get highBitrate= " + str11 + " from json error:" + localNumberFormatException2);
              continue;
              bool = false;
            }
            localNumberFormatException3 = localNumberFormatException3;
            ykq.e("Q.qqstory.config.QQStoryConfigServletHandler", "get codecProfile= " + str11 + " from json error:" + localNumberFormatException3);
          }
          catch (NumberFormatException localNumberFormatException4)
          {
            for (;;)
            {
              ykq.e("Q.qqstory.config.QQStoryConfigServletHandler", "get maxVideoSize= " + str11 + " from json error:" + localNumberFormatException4);
            }
          }
        }
      }
  ...
  private boolean a(List<String> paramList, String paramString)
  {
    ...
    {
      return false;
      ykq.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleQzoneSync2QQStory config=%s", paramList);
    ...
    catch (Throwable paramString)
    {
      for (;;)
      {
        ykq.e("Q.qqstory.config.QQStoryConfigServletHandler", "handleQzoneSync2QQStory  parseLong error");
      }
    }
  ...
  private boolean b(List<String> paramList)
  {
    ...
    for (paramList = "";; paramList = str)
    {
      ykq.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleAlbumConfig type: 影集配置, content: \n", paramList);
      if ((!TextUtils.isEmpty(str)) && (str.trim().length() != 0)) {
        break;
      }
      localvwv.e();
  ...
  private boolean b(List<String> paramList, int paramInt)
  {
    ...
    return ((wjp)wjs.a(5)).a(paramList);
  }
  ...
  private boolean c(List<String> paramList)
  {
    ...
    wms localwms = (wms)QQStoryContext.a().getManager(QQManagerFactory.MSG_TAB_STORY_CONFIG_MANAGER);
    String str = (String)paramList.get(0);
    if (str == null) {}
    for (paramList = "";; paramList = str)
    {
      ykq.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleMsgTabTakeVideoNodeConfig type: 日迹拍摄配置, content: \n", paramList);
      if ((!TextUtils.isEmpty(str)) && (str.trim().length() != 0)) {
        break;
      }
      localwms.a();
  ...
  private boolean d(List<String> paramList)
  {
    ...
    ykq.a("Q.qqstory.config.QQStoryConfigServletHandler", "handledAIOSyncToStory config=%s", (String)paramList.get(0));
    return false;
  }
  ...
  private boolean e(List<String> paramList)
  {
    ...
    ykq.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig config=%s", paramList);
    paramList = (String)paramList.get(0);
    if (TextUtils.isEmpty(paramList))
    {
      ykq.d("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig clear config");
      wjl.c(false);
      wjl.d(false);
      return true;
    }
    try
    {
      ...
      ykq.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig showSyncBtn = %d,defaultStatus=%d", Integer.valueOf(i), Integer.valueOf(j));
      if (i == 1)
      {
        bool = true;
        wjl.c(bool);
    ...
    {
      zdl.a("handleStorySync2QzoneConfig:" + paramList.toString(), new Object[0]);
  ...
  private boolean f(List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramList = (wjn)JsonORM.a(new JSONObject(paramList), wjn.class);
        localwjl = (wjl)wjs.a(10);
        localwjl.b("boolean_enable_revert_play_mode", Boolean.valueOf(true));
        localwjl.b("boolean_enable_fast_play_mode", Boolean.valueOf(true));
        localwjl.b("boolean_enable_slow_play_mode", Boolean.valueOf(true));
        localwjl.b("boolean_enable_hw_encode_pic_to_video", Boolean.valueOf(true));
        localwjl.b("boolean_enable_flow_decode", Boolean.valueOf(true));
        localwjl.b("boolean_use_flow_decode_first", Boolean.valueOf(false));
        localwjl.b("key_story_home_preload_count", Integer.valueOf(4));
        localwjl.b("key_story_video_preload_duration", Integer.valueOf(2));
        wjo[] arrayOfwjo;
        int k;
        if (paramList.f != null)
        {
          arrayOfwjo = paramList.f;
          k = arrayOfwjo.length;
          i = 0;
          if (i < k)
          {
            ...
            localwjl.b("boolean_use_flow_decode_first", Boolean.valueOf(true));
          }
        }
        if (paramList.jdField_a_of_type_ArrayOfWjo != null)
        {
          arrayOfwjo = paramList.jdField_a_of_type_ArrayOfWjo;
          k = arrayOfwjo.length;
          i = 0;
          if (i < k)
          {
            ...
            localwjl.b("boolean_enable_revert_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.jdField_b_of_type_ArrayOfWjo != null)
        {
          arrayOfwjo = paramList.jdField_b_of_type_ArrayOfWjo;
          k = arrayOfwjo.length;
          i = 0;
          if (i < k)
          {
            ...
            localwjl.b("boolean_enable_fast_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.c != null)
        {
          arrayOfwjo = paramList.c;
          k = arrayOfwjo.length;
          i = 0;
          if (i < k)
          {
            ...
            localwjl.b("boolean_enable_slow_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.d != null)
        {
          arrayOfwjo = paramList.d;
          k = arrayOfwjo.length;
          i = 0;
          if (i < k)
          {
            ...
            localwjl.b("boolean_enable_hw_encode_pic_to_video", Boolean.valueOf(false));
          }
        }
        if (paramList.e != null)
        {
          arrayOfwjo = paramList.e;
          k = arrayOfwjo.length;
          i = 0;
          if (i < k)
          {
            ...
            localwjl.b("boolean_enable_flow_decode", Boolean.valueOf(false));
          }
        }
      ...
      localwjl.b("string_story_global_log_level", Integer.valueOf(i));
      localwjl.b("string_auto_play_report_control", paramList.jdField_b_of_type_JavaLangString);
      if ((paramList.jdField_a_of_type_Int > 0) && (paramList.jdField_a_of_type_Int < 20)) {
        localwjl.b("key_story_home_preload_count", Integer.valueOf(paramList.jdField_a_of_type_Int));
      }
      if ((paramList.jdField_b_of_type_Int > 0) && (paramList.jdField_b_of_type_Int < 10))
      {
        localwjl.b("key_story_video_preload_duration", Integer.valueOf(paramList.jdField_b_of_type_Int));
        break label726;
        i = j;
  ...
  private boolean g(List<String> paramList)
  {
    ...
    paramList = (String)paramList.get(0);
    if (!TextUtils.isEmpty(paramList)) {
      bhhr.i(localQQAppInterface.getApp(), localQQAppInterface.getCurrentUin(), paramList);
    }
    for (;;)
    {
      ((vzv)localQQAppInterface.getManager(QQManagerFactory.QQSTORY_MANAGER)).b(paramList);
      if (QLog.isColorLevel()) {
        QLog.d("Q.qqstory.config.QQStoryConfigServletHandler", 2, "handleStoryPlayerProxyConfigCmd configContent = " + paramList);
      }
      return true;
      bhhr.i(localQQAppInterface.getApp(), localQQAppInterface.getCurrentUin(), null);
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (HttpUtil.isValidUrl((String)localObject2)))
          {
            localwjl.b("CertificationLinkText", localObject1);
            localwjl.b("CertificationLinkUrl", localObject2);
            ...
            localwjl.b("localVideoScanInterval", String.valueOf(i));
            localObject1 = localJSONObject.optJSONObject("mainHallConfig");
            if (localObject1 == null) {
              break label554;
            }
            localwjl.b("mainHallConfig", ((JSONObject)localObject1).toString());
            localObject1 = localJSONObject.optJSONObject("troopStoryHallConfig");
            if (localObject1 == null) {
              break label567;
            }
            localwjl.b("troopStoryHallConfig", ((JSONObject)localObject1).toString());
            ...
            bool = true;
            localwjl.b("key_share_encrypt_flag", Boolean.valueOf(bool));
            ...
            bool = true;
            localwjl.b("key_show_in_friend_story_main_page", Boolean.valueOf(bool));
            ...
            localwjl.b("boolean_enable_multi_video_fragment", Boolean.valueOf(true));
            i = 0;
            if (i < j)
            {
              ...
              localwjl.b("boolean_enable_multi_video_fragment", Boolean.valueOf(false));
            }
            i = localJSONObject.optInt("qim_sync_to_qq", 0);
            QLog.d("Q.qqstory.commonConfig", 2, "qim_sync_to_qq: " + paramList);
            localwjl.b("key_qim_int_qim_sync_to_qq_default", Integer.valueOf(i));
            return true;
          }
          localwjl.b("CertificationLinkText", "");
          localwjl.b("CertificationLinkUrl", "");
          continue;
        }
        localwjl.b("CertificationLinkText", "");
      }
      ...
      continue;
      label540:
      localwjl.b("localVideoScanInterval", "1441");
      continue;
      label554:
      localwjl.b("mainHallConfig", "");
      continue;
      label567:
      localwjl.b("troopStoryHallConfig", "");
      continue;
      label580:
      localwjl.b("key_share_encrypt_flag", Boolean.valueOf(false));
      continue;
      label595:
      localwjl.b("key_show_in_friend_story_main_page", Boolean.valueOf(true));
      continue;
      label610:
      localwjl.b("boolean_enable_multi_video_fragment", Boolean.valueOf(true));
      continue;
  ...
  public boolean a(int paramInt, Intent paramIntent, ConfigurationService.Config paramConfig)
  {
    ...
    Object localObject = wjl.a(paramInt);
    int i = bhhr.a(QQStoryContext.a().getApp(), (String)localObject, str);
    int j = paramConfig.version.get();
    localObject = arph.a(paramConfig, i, paramInt);
    if (localObject == null) {
      return bool2;
    }
    switch (paramInt)
