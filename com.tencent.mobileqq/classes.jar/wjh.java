...
public class wjh
  extends RecyclerView.Adapter<wji>
{
  protected CertifiedAccountMeta.StEntry a;
  protected List<wkl> a;
  ...
  public wji a(ViewGroup paramViewGroup, int paramInt)
  {
    Object localObject = paramViewGroup.getContext();
    paramViewGroup = new RecyclerView.LayoutParams(baxn.a((Context)localObject, 144.0F), baxn.a((Context)localObject, 213.0F));
    if (paramInt == 3)
    {
      ...
      return new wji(this, (View)localObject);
    }
    if (paramInt == 1)
    {
  ...
  public void a(wjg paramwjg)
  {
    this.jdField_a_of_type_Wjg = paramwjg;
  }
  
  public void a(wji paramwji)
  {
    super.onViewAttachedToWindow(paramwji);
    int i = paramwji.getAdapterPosition() - a();
    if ((!bfmy.a(i, a())) && (a().get(i) != null)) {
      xhb.a(((wkl)a().get(i)).jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser.id.get(), "auth_page", "recom_exp", 0, 0, new String[] { "", "", String.valueOf(i), ((wkl)a().get(i)).jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser.nick.get() });
    }
  }
  
  public void a(wji paramwji, int paramInt)
  {
    if (paramwji == null) {}
    do
    {
      return;
      if ((paramwji.itemView instanceof RecommendBannerEntryItemView))
      {
        ((RecommendBannerEntryItemView)paramwji.itemView).setEntry(this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StEntry);
        return;
      }
      paramInt -= a();
      if ((paramwji.itemView instanceof RecommendBannerItemView))
      {
        paramwji = (RecommendBannerItemView)paramwji.itemView;
        paramwji.setData(((wkl)a().get(paramInt)).jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser, paramInt);
        paramwji.setRecommendBannerFolwListener(this.jdField_a_of_type_Wjg);
        return;
      }
    } while (!(paramwji.itemView instanceof RecommendBannerFeedItemView));
    ((RecommendBannerFeedItemView)paramwji.itemView).setData(((wkl)a().get(paramInt)).jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed, paramInt);
  }
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    return ((wkl)a().get(paramInt - a())).jdField_a_of_type_Int;
  }
}
