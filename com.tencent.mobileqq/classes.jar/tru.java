...
public class tru
  extends Handler
{
  public tru(QQSettingMsgHistoryActivity paramQQSettingMsgHistoryActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    paramMessage = (tsa)paramMessage.obj;
    ...
    if (!this.a.app.getPreferences().getString("chatHistoryEventName", "").equals(paramMessage.jdField_a_of_type_JavaLangString)) {
      ThreadManager.getSubThreadHandler().post(new trv(this, paramMessage));
    }
