...
public class puv
  extends puq
{
  public puv(Context paramContext, baxy parambaxy, ram paramram)
  {
  ...
  public pqq a()
  {
    ...
    return a(this.jdField_a_of_type_Ram, this.jdField_a_of_type_Baxy).r().l().g().n().q().j();
  }
  ...
  public pqq d()
  {
    ...
    localLinearLayout2.setPadding(0, 0, 0, actj.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    ...
    if (this.jdField_a_of_type_Pqp != null)
    {
      ...
      if ((this.jdField_a_of_type_Pqp instanceof ComponentContentBigImageVideo))
      {
        ...
        localLinearLayout3.setOnClickListener(new puw(this));
      }
    ...
    oky.a(localLinearLayout2, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130842463));
    ...
    localLinearLayout2.setOnClickListener(new pux(this));
