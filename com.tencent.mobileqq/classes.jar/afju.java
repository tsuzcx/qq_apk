...
public class afju
  implements afpx, ark.RuntimeClassCallbackWrapper
{
  ...
  public afju(QQAppInterface paramQQAppInterface, String paramString)
  {
  ...
  private boolean a(ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Aflb = new afzx(localQQAppInterface, this.jdField_a_of_type_JavaLangString);
    } while (!this.jdField_a_of_type_Aflb.a(paramArrayOfVariantWrapper));
  ...
  private void b()
  {
    ...
    {
      this.jdField_a_of_type_Aflb.a(null);
      this.jdField_a_of_type_Aflb.a();
      this.jdField_a_of_type_Aflb = null;
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Aflb == null) || (paramArrayOfVariantWrapper == null) || (paramArrayOfVariantWrapper.length < 2)) {}
    do
    {
      paramVariantWrapper.SetBool(false);
      return true;
    ...
    for (;;)
    {
      this.jdField_a_of_type_Aflb.a(this);
      if (!this.jdField_a_of_type_Aflb.b(paramArrayOfVariantWrapper)) {
        break;
      }
      paramVariantWrapper.SetBool(true);
      return true;
  ...
  private boolean f(ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Aflb.a(i);
        paramVariantWrapper.SetBool(true);
        return true;
  ...
  {
    boolean bool = false;
    if ((this.jdField_a_of_type_Aflb == null) || (paramArrayOfVariantWrapper == null) || (paramArrayOfVariantWrapper.length < 1))
    {
      paramVariantWrapper.SetBool(false);
      return true;
    }
    if (this.jdField_a_of_type_Aflb.a() == 0) {
      bool = true;
    }
        ...
        do
        {
          do
          {
            do
            {
              ...
              return true;
            } while (this.jdField_a_of_type_Aflb.a() != 0);
            str = this.jdField_a_of_type_Aflb.a();
          } while (str == null);
          paramArrayOfVariantWrapper = paramArrayOfVariantWrapper[1].GetString();
        } while (TextUtils.isEmpty(paramArrayOfVariantWrapper));
