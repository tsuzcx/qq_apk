...
public class skn
{
  ...
  private static skm jdField_a_of_type_Skm;
  private static String jdField_b_of_type_JavaLangString;
  private static HashMap<String, Integer> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  private static skm jdField_b_of_type_Skm;
  
  static
  {
    jdField_a_of_type_JavaLangString = ajya.a(2131716910);
  ...
  public static int a(String paramString)
  {
    ...
    try
    {
      ...
      if (localPackageInfo != null)
      {
        ...
        i = j;
        snb.a("WeishiDownloadUtil", "versionName:" + localPackageInfo.versionName + ",versionCode:" + localPackageInfo.versionCode);
        return j;
      }
      i = j;
      snb.c("WeishiDownloadUtil", paramString + "获取 PackageInfo 失败");
      return -1;
    }
    catch (Exception paramString)
    {
      snb.a("WeishiDownloadUtil", paramString.getLocalizedMessage());
    }
    return i;
  }
  ...
  private static RockDownloadInfo a(ArrayList<RockDownloadInfo> paramArrayList, RockDownloadInfo paramRockDownloadInfo)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      {
        snb.a("WeishiDownloadUtil", "Rock包版本大于或等于要下载的版本，有效~~~");
  ...
  {
    Object localObject2 = bdhk.a().b("com.tencent.weishi", 4);
    Object localObject1 = localObject2;
    if (((List)localObject2).size() == 0) {
      localObject1 = bdhk.a().a("com.tencent.weishi", 4);
    }
    localObject2 = bdle.a().a("10261931");
    if (localObject2 != null)
    {
      ((DownloadInfo)localObject2).a(4);
      ((List)localObject1).add(localObject2);
    }
    snb.a("WeishiDownloadUtil", ">existValidQQDownloadWeishiApk, info:" + localObject1);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if (localObject2 != null)
      {
        snb.d("WeishiDownloadUtil", "downloadInfo 's url: " + ((DownloadInfo)localObject2).d);
        if ((((DownloadInfo)localObject2).a() == 4) && (TextUtils.equals(((DownloadInfo)localObject2).e, "com.tencent.weishi")) && (((DownloadInfo)localObject2).d != null) && (((DownloadInfo)localObject2).d.startsWith(b()))) {
          ...
          {
            snb.a("WeishiDownloadUtil", "QQ下载包filePath为空!!!");
          }
          else
          {
            int i = a(((DownloadInfo)localObject2).l);
            snb.a("WeishiDownloadUtil", "判断QQ下载包有没有过期，apkVersionCode：" + i + ",targetVersion:" + paramInt);
            if (i >= paramInt)
            {
              snb.a("WeishiDownloadUtil", "本地包版本(" + i + ")大于或等于要下载的版本" + paramInt + ")，直接安装~~~");
      ...
      {
        snb.d("WeishiDownloadUtil", "downloadInfo is null");
      }
    }
    return "";
  }
  ...
  private static ArrayList<RockDownloadInfo> a(skf paramskf, RockDownloadInfo paramRockDownloadInfo)
  {
    ArrayList localArrayList = amar.a(paramRockDownloadInfo);
    ...
    if (i < localArrayList.size())
    {
      ...
      if ((k < paramRockDownloadInfo.versionCode) || (j < paramRockDownloadInfo.versionCode))
      {
        ...
        paramskf.a(localRockDownloadInfo);
      }
      for (;;)
      {
        i += 1;
  ...
  public static skm a(int paramInt1, int paramInt2)
  {
    if (b()) {
  ...
  {
    snb.a("WeishiDownloadUtil", "resetDownloadingMark");
  ...
  public static void a(Activity paramActivity, WSDownloadParams paramWSDownloadParams)
  {
    if ((paramActivity == null) || (paramWSDownloadParams == null)) {
      snb.a("WeishiDownloadUtil", "rock download activity or params is null");
    }
    skf localskf;
    ...
    do
    {
      ...
      {
        return;
        snb.d("WeishiDownloadUtil", "WSDownloadParams:" + paramWSDownloadParams.toString());
        localskf = new skf(paramActivity);
        if (vym.b(paramActivity)) {
          break;
        }
      } while (a(paramWSDownloadParams, localskf, localskf.a(), 3));
      bcql.a(paramActivity, ajya.a(2131716909), 0).a();
      return;
      if (c())
      {
        a(true);
        snb.d("WeishiDownloadUtil", "当前有正在下载的任务,不响应钩子下载请求,但更改下载类型为主动下载");
        if ((sjy.a().e()) && (a()))
        {
          b(3);
          return;
        ...
        smp.a(true, paramWSDownloadParams);
        smp.a(paramWSDownloadParams, 2);
        WSPublicAccReport.getInstance().reportDownload(paramWSDownloadParams.mEventId, 3, 1, 2, 0);
        skg.a(paramActivity);
        return;
      }
      if ((sjy.a().d()) && (smx.a(paramActivity)))
      {
        b(3);
        snf.a(paramWSDownloadParams.mScheme);
        paramWSDownloadParams.mStReportItem = smn.a();
        skg.a(115, paramWSDownloadParams);
        smp.a(false, paramWSDownloadParams);
        smp.a(paramWSDownloadParams, 3);
        WSPublicAccReport.getInstance().reportDownload(paramWSDownloadParams.mEventId, 3, 0, 3, 0);
        bdhj.a(paramActivity, paramWSDownloadParams.mScheme, "com.tencent.weishi", "biz_src_jc_gzh_weishi");
        return;
      }
      localRockDownloadInfo = localskf.a();
    } while (a(paramWSDownloadParams, localskf, localRockDownloadInfo, 3));
    b(3);
    if ((!sjy.a().a()) && (!a()))
    {
      snb.a("WeishiDownloadUtil", "服务器关闭了4g开关");
      skg.b(paramActivity, paramWSDownloadParams);
      return;
    }
    snb.a("WeishiDownloadUtil", "服务器打开了4g");
    if (sjy.a().e())
    {
      localskf.a(paramActivity, localRockDownloadInfo, 3, paramWSDownloadParams, null);
      return;
    }
    skg.a(paramActivity, paramWSDownloadParams);
  }
  
  public static void a(Activity paramActivity, WSDownloadParams paramWSDownloadParams, skm paramskm, RockDownloadListenerWrapper paramRockDownloadListenerWrapper)
  {
    paramskm = new skf(paramActivity);
    RockDownloadInfo localRockDownloadInfo = paramskm.a();
    if (a(paramWSDownloadParams, paramskm, localRockDownloadInfo, 2)) {
      return;
    }
    if ((!sjy.a().a()) && (!a()))
    {
      snb.d("WeishiDownloadUtil", "不可以在非WIFI环境下，静默下载微视");
      return;
    }
    if (c())
    {
      snb.d("WeishiDownloadUtil", "当前有正在下载的任务,不响应静默下载请求");
      if ((sjy.a().e()) && (a()))
      {
        b(2);
        return;
    ...
    if (sjy.a().e())
    {
      paramskm.a(paramActivity, localRockDownloadInfo, 2, paramWSDownloadParams, paramRockDownloadListenerWrapper);
      return;
    }
  ...
  public static void a(Activity paramActivity, skf paramskf, WSDownloadParams paramWSDownloadParams, boolean paramBoolean, int paramInt)
  {
  ...
  private static void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      while (paramString.hasNext())
      {
        ...
        snb.d("WeishiDownloadUtil", "删除了info:" + ((DownloadInfo)localObject1).d);
        bdhk.a().b(((DownloadInfo)localObject1).d, false);
      }
    }
  }
  ...
  {
    snb.a("WeishiDownloadUtil", "setPreDownloadingClick");
  ...
  public static boolean a(Activity paramActivity, WSDownloadParams paramWSDownloadParams)
  {
    ...
    {
      snb.d("WeishiDownloadUtil", "本地已经安装微视app");
      return false;
    }
    if (!e())
    {
      snb.d("WeishiDownloadUtil", "预下载开关没打开");
      return false;
    }
    skf localskf = new skf(paramActivity);
    RockDownloadInfo localRockDownloadInfo = localskf.a();
    b(1);
    if (a(paramWSDownloadParams, localskf, localRockDownloadInfo, 1)) {
      return false;
    }
    if ((sjy.a().e()) && (a()))
    {
      localskf.a(paramActivity, localRockDownloadInfo, 1, paramWSDownloadParams, null);
      return true;
    }
    snb.c("WeishiDownloadUtil", "用QQ预下载兜底~");
    a(99, 1);
  ...
  public static boolean a(Activity paramActivity, WSDownloadParams paramWSDownloadParams, boolean paramBoolean, int paramInt)
  {
    if ((paramActivity == null) || (paramWSDownloadParams == null))
    {
      snb.a("startQQDownload: activity is null Or params is null:");
      return false;
    }
    snb.a("downloadWeishi:" + paramWSDownloadParams);
    String str = sjy.a().d();
    a(paramWSDownloadParams.mEventId, paramInt);
    snf.a(paramWSDownloadParams.mScheme);
  ...
  {
    snb.a("WeishiDownloadUtil", String.format("downloadWeishi : autoInstall = %s, showNotification = %s, mDownloadUrlStr = %s", new Object[] { Boolean.valueOf(paramBoolean1), Boolean.valueOf(paramBoolean2), paramString }));
    b();
    Bundle localBundle = new Bundle();
    localBundle.putString(bdlb.jdField_b_of_type_JavaLangString, "10261931");
    localBundle.putString(bdlb.l, jdField_a_of_type_JavaLangString);
    localBundle.putString(bdlb.f, "com.tencent.weishi");
    localBundle.putString(bdlb.j, paramString);
    localBundle.putInt(bdlb.k, 2);
    localBundle.putBoolean(bdlb.h, false);
    paramString = bdlb.x;
    if (!paramBoolean2) {}
    for (paramBoolean1 = true;; paramBoolean1 = false)
    {
      localBundle.putBoolean(paramString, paramBoolean1);
      bdho.a().a(paramActivity, localBundle, "biz_src_jc_gzh_weishi", null, 0);
  ...
  {
    if (bdjl.a(bcyb.a().a(), paramString, "biz_src_jc_gzh_weishi", ""))
    {
      snb.a("WeishiDownloadUtil", "本地QQ包的版本有效，启动开始安装成功！");
      smp.a(1, 2);
      paramString = paramWSDownloadParams;
      if (paramWSDownloadParams == null)
      {
        paramString = new WSDownloadParams();
        snb.d("WeishiDownloadUtil", "WSDownloadParams异常！");
      }
      WSPublicAccReport.getInstance().reportDownload(paramString.mEventId, paramInt, 2, 2, 1);
      if (paramString.mStReportItem == null) {
        paramString.mStReportItem = smn.a();
      }
      smn.a(115, paramString.mStReportItem.pagetype, paramString.mStReportItem.comment_loctaion, null);
      snf.a(paramString.mScheme);
      return true;
    }
    snb.d("WeishiDownloadUtil", "本地QQ包安装失败,重新下载！");
    return false;
  }
  
  private static boolean a(WSDownloadParams paramWSDownloadParams, skf paramskf, RockDownloadInfo paramRockDownloadInfo, int paramInt)
  {
    ArrayList localArrayList = a(paramskf, paramRockDownloadInfo);
    if (a(localArrayList, paramRockDownloadInfo))
    {
      ...
      if (paramRockDownloadInfo != null)
      {
        if (paramInt == 1)
        {
          snb.c("WeishiDownloadUtil", "预下载包有效也不call安装----------------");
          return true;
        }
        if (sjy.a().a() == 2)
        {
          sjf.b += 1;
          snb.c("WeishiDownloadUtil", "CCCCCCCCC onDownloadFinish SLIENT WSRecommendAdapter.openDownloadWSCount = " + sjf.b);
        }
        paramskf.a(paramRockDownloadInfo, 1);
        snf.a(paramWSDownloadParams.mScheme);
        snb.d("WeishiDownloadUtil", "本地Rock包的版本有效，直接安装");
        return true;
      }
    }
    paramskf = a(sjy.a().e());
    if (!TextUtils.isEmpty(paramskf))
    {
      snb.d("WeishiDownloadUtil", "checkAndInstallValidApp QQDownloader apkPath = " + paramskf);
      if (paramInt == 1)
      {
        snb.c("WeishiDownloadUtil", "预下载包有效也不call安装----------------");
        return true;
      ...
      {
        sjf.b += 1;
        snb.c("WeishiDownloadUtil", "DDDDDDDDDDD onDownloadFinish SLIENT WSRecommendAdapter.openDownloadWSCount = " + sjf.b);
      }
      WSPublicAccReport.getInstance().reportDownload(paramWSDownloadParams.mEventId, paramInt, 1, 2, 0);
      a(paramWSDownloadParams.mEventId, paramInt);
      if (a(paramWSDownloadParams, paramInt, paramskf))
      {
        snb.a("WeishiDownloadUtil", "installApkByQQDownloader！eventId:" + paramWSDownloadParams.mEventId + ",eventType:" + paramInt);
        return true;
      }
    }
    else
    {
      snb.a("WeishiDownloadUtil", "本地QQ包路径为空！");
    }
    return false;
  }
  ...
  private static skm b(int paramInt1, int paramInt2)
  {
    if (jdField_a_of_type_Skm != null)
    {
      if (!c()) {
        a(paramInt1);
      }
      b(paramInt2);
      return jdField_a_of_type_Skm;
    }
    a(paramInt1);
    b(paramInt2);
    jdField_a_of_type_Skm = new sko();
    bdhk.a().a(jdField_a_of_type_Skm);
    return jdField_a_of_type_Skm;
  }
  
  public static void b()
  {
    snb.a("WeishiDownloadUtil", "updateDownloadingMark");
  ...
  private static void b(DownloadInfo paramDownloadInfo, int paramInt)
  {
    ...
    {
      snb.d("WeishiDownloadUtil", " 下载器的DB还没准备就绪,重新注册监听，并重试下载一次");
      ...
      for (;;)
      {
        ...
        snb.d("WeishiDownloadUtil", "onDownloadError retryCount = " + localInteger);
        if (localInteger.intValue() <= 3) {
          break;
        }
        snb.d("WeishiDownloadUtil", "重试次数已经达到3次，中止！");
        return;
    ...
    snb.d("WeishiDownloadUtil", "下载器其他错误");
  }
  
  private static void b(DownloadInfo paramDownloadInfo, int paramInt1, int paramInt2, String paramString)
  {
    snb.d("WeishiDownloadUtil", paramString + " onDownloadFinish info = " + paramDownloadInfo);
    snb.d("WeishiDownloadUtil", paramString + " onDownloadFinish eventId:" + paramInt1 + ",eventType:" + paramInt2);
    int i;
    if (b(paramDownloadInfo))
    {
      ...
      skg.a();
      snb.c("WeishiDownloadUtil", paramString + " onDownloadFinish ACTIVE closeDownloadDialog");
      i = 1;
      smp.a(paramInt1, true);
      smp.a(2);
    ...
    for (;;)
    {
      if (jdField_b_of_type_JavaUtilHashMap.containsKey(paramDownloadInfo.d))
      {
        ...
        snb.d("WeishiDownloadUtil", paramString + " onDownloadFinish remove retryCount!");
      }
      if (i != 0)
      {
        paramString = a(sjy.a().e());
        a(jdField_a_of_type_ComTencentBizPubaccountWeishi_newDownloadWSDownloadParams, paramInt2, paramString);
      }
      a(paramDownloadInfo.d, sjy.a().e());
      return;
      label255:
      if (paramInt2 == 2)
      {
        ...
        {
          sjf.b += 1;
          snb.b("WeishiDownloadUtil", paramString + " onDownloadFinish SLIENT WSRecommendAdapter.openDownloadWSCount = " + sjf.b);
          i = 1;
          break;
        }
        snb.a("WeishiDownloadUtil", "processDownloadFinish, this is maybe DTest silent download,linktype is :" + sjy.a().a());
        i = 1;
        break;
      }
      if (d())
      {
        a(false);
        snb.d("WeishiDownloadUtil", paramString + " 预下载中用户点击了钩子，下载完成需弹起安装！！！ByQQ");
        i = 1;
        break;
      }
      snb.d("WeishiDownloadUtil", paramString + " 正常预下载无需安装");
      i = 0;
      break;
      label423:
      if (paramInt1 == 401) {
  ...
  {
    snb.d("WeishiDownloadUtil", "qq installSucceed appid = " + paramString1 + ", packageName = " + paramString2);
    int i;
    if ((TextUtils.equals(paramString1, "10261931")) && (TextUtils.equals(paramString2, "com.tencent.weishi")))
    {
      snb.d("WeishiDownloadUtil", "这是统一的DownloadListener，installSucceed, appId:" + paramString1 + ",packName:" + paramString2);
      bdhk.a().b(jdField_a_of_type_Skm);
      sjf.b = 0;
      if (!paramBoolean) {
        break label155;
      }
      jdField_b_of_type_Skm = null;
      i = a();
      int j = b();
      smp.a(i, false);
      smp.b(2);
  ...
  {
    String str = c();
    snb.b("WeishiDownloadUtil", "~~~~~~~~~~~~~~~~~~~~~~~~~currentProcessName:" + str);
  ...
  private static skm c(int paramInt1, int paramInt2)
  {
    snb.a("WeishiDownloadUtil", "createQzoneListener~~~");
    if (jdField_b_of_type_Skm != null)
    {
      if (!c()) {
        a(paramInt1);
      }
      b(paramInt2);
      return jdField_b_of_type_Skm;
    }
    a(paramInt1);
    b(paramInt2);
    jdField_b_of_type_Skm = new skp();
    bdhk.a().a(jdField_b_of_type_Skm);
    snb.a("WeishiDownloadUtil", "qzone registerListener");
    return jdField_b_of_type_Skm;
  }
  ...
  public static boolean c()
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      snb.b("WeishiDownloadUtil", "downloading  = " + bool2 + ", timeout = " + bool1 + ", time passed = " + l / 1000L + "s");
      if ((!bool2) || (bool1)) {
        break;
      }
      return true;
  ...
  {
    snb.a("WeishiDownloadUtil", "getPreDownloadingClick");
    return LocalMultiProcConfig.getBool("preDownloadingClick", false);
  }
  
  private static boolean e()
  {
    return (sjy.a().c()) && (!TextUtils.isEmpty(sjy.a().c())) && (sjy.a().c().startsWith("http"));
  }
}
