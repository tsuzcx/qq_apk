  ...
  extends aauq
{
  ...
  {
    if ((aogl.a.equals(paramToServiceMsg.getServiceCmd())) || (aogl.b.equals(paramToServiceMsg.getServiceCmd())))
    {
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (aogl.a.equals(paramToServiceMsg.getServiceCmd()))
    {
    ...
    {
      return true;
      if (aogl.b.equals(paramToServiceMsg.getServiceCmd()))
      {
