  ...
  implements Handler.Callback
{
  ...
  public axeh(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (this.app == null) {}
    while (((TicketManager)this.app.getManager(2)).GetPskey(this.app.getCurrentAccountUin(), 16L, this.a, new axei(this, paramRunnable)) == null) {
      return;
    }
