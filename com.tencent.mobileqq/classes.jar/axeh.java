...
public class axeh
{
  ...
  private static void a(BaseActivity paramBaseActivity, axem paramaxem)
  {
    ThreadManagerV2.postImmediately(new MultiAIOStarter.2(paramBaseActivity, paramaxem), null, false);
  }
  ...
  public static boolean a(Context paramContext, String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    if (!((axel)BaseApplicationImpl.getApplication().getRuntime().getManager(QQManagerFactory.AIO_MULTI_WINDOW_MANAGER)).a())
    {
      if (QLog.isColorLevel()) {
    ...
    if (axea.a(paramInt))
    {
      ...
      axem localaxem = axem.a(localQQAppInterface);
      Bitmap localBitmap = a(paramContext);
      int i = a(paramContext);
      a = true;
      localaxem.a(localBitmap);
      localaxem.a(i);
      a((BaseActivity)paramContext, localaxem);
      localaxem.a((QQAppInterface)localQQAppInterface, (FragmentActivity)paramContext, paramString3, paramInt, paramString1, paramString2);
      localaxem.a(new axei(paramContext));
      localIntent.putExtra("OPEN_MULTI_AIO_CONTEXT", localaxem.a());
      if ("open_from_aio".equals(paramString3)) {
        localIntent.putExtra("OPEN_MULTI_AIO_LIST_VIEW_SPECIFY_BOTTOM", a(paramContext));
      }
      aeow.a(paramContext, localIntent, PublicTransFragmentActivity.class, MultiAIOFragment.class);
      return true;
    }
    return false;
  }
  ...
  private static int[] a(Context paramContext)
  {
    ...
    if ((paramContext instanceof BaseActivity))
    {
      paramContext = (ListView)((BaseActivity)paramContext).findViewById(2131370188);
      if (paramContext != null)
      {
