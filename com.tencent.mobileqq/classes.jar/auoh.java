  ...
  implements bhxf
{
  ...
  public auoh(MultiCardRootLayout paramMultiCardRootLayout) {}
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      {
        auoi localauoi = (auoi)MultiCardRootLayout.a(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardRootLayout).get();
        if (localauoi != null) {
          MultiCardRootLayout.a(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardRootLayout, localauoi.a(paramMotionEvent));
        }
      }
