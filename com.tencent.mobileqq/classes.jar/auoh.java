  ...
  extends Handler
{
  ...
  public auoh(Looper paramLooper, PresendPicMgr paramPresendPicMgr)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (localPresendPicMgr != null)
    {
      ...
      default: 
        ...
        return;
      case 1: 
        aung.a("PresendPicMgr", "PresendHandler", "handleMessage MSG_REGISTER_CLIENT_HANDLER");
        ...
        while (((Iterator)localObject).hasNext()) {
          localArrayList.add(((auoi)((Iterator)localObject).next()).a);
        }
      ...
      aung.a("PresendPicMgr", "PresendHandler", "handleMessage MSG_UNREGISTER_CLIENT_HANDLER");
      localPresendPicMgr.a = null;
      return;
    }
    aung.b("PresendPicMgr", "handleMessage", "PresendPicMgr == null!");
  }
}
