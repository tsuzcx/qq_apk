...
public class bfrj
{
  ...
  public static ArrayList<aymn> a;
  ...
  public static long a()
  {
    ...
    {
      if (bftf.a()) {
        return bftf.a(new File(AppConstants.SDCARD_ROOT));
      }
      long l = bftf.a(new File(Environment.getRootDirectory().getPath()));
      return l;
    }
    catch (Exception localException) {}
    return -1L;
  ...
  public static Intent a(Intent paramIntent, String paramString, QQAppInterface paramQQAppInterface, ProfileActivity.AllInOne paramAllInOne, BusinessCard paramBusinessCard)
  {
    ...
    String str = String.format("https://ti.qq.com/qcard/profile?qq=%s&appid=%s&version=%s&_wv=1027", new Object[] { paramString, String.valueOf(paramQQAppInterface.getAppid()), "android-8.4.8" });
    paramString = str;
    if (b()) {
  ...
  public static Bitmap a(String paramString, int paramInt, float paramFloat)
  {
    ...
    //   10: ifnull +26 -> 36
    //   13: aload_0
    //   14: invokevirtual 402	java/io/File:exists	()Z
    //   17: ifeq +19 -> 36
    //   20: aload_0
    //   21: invokevirtual 404	java/io/File:length	()J
    //   24: lconst_0
    //   25: lcmp
    //   26: ifle +10 -> 36
    //   29: aload_0
    //   30: invokevirtual 407	java/io/File:isDirectory	()Z
    //   33: ifeq +9 -> 42
    //   36: aconst_null
    //   37: astore 7
    //   39: aload 7
    //   41: areturn
    //   42: new 409	java/io/BufferedInputStream
    //   45: dup
    //   46: new 411	java/io/FileInputStream
    //   49: dup
    //   50: aload_0
    //   51: invokespecial 414	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   54: invokespecial 417	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   57: astore_0
    //   58: aload_0
    //   59: invokestatic 423	android/graphics/BitmapFactory:decodeStream	(Ljava/io/InputStream;)Landroid/graphics/Bitmap;
    //   62: astore 6
    //   64: aload 6
    //   66: ifnonnull +13 -> 79
    //   69: aload_0
    //   70: ifnull +7 -> 77
    //   73: aload_0
    //   74: invokevirtual 426	java/io/BufferedInputStream:close	()V
    //   77: aconst_null
    //   78: areturn
    //   79: aload 6
    ...
    //   101: f2i
    //   102: istore 5
    //   104: new 428	android/graphics/Matrix
    //   107: dup
    //   108: invokespecial 429	android/graphics/Matrix:<init>	()V
    //   111: astore 7
    //   113: aload 7
    //   115: iload_1
    //   116: i2f
    ...
    //   125: i2f
    //   126: fdiv
    //   127: invokevirtual 433	android/graphics/Matrix:postScale	(FF)Z
    //   130: pop
    //   131: aload 6
    //   133: iconst_0
    //   134: iconst_0
    ...
    //   138: aload 7
    //   140: iconst_1
    //   141: invokestatic 437	android/graphics/Bitmap:createBitmap	(Landroid/graphics/Bitmap;IIIILandroid/graphics/Matrix;Z)Landroid/graphics/Bitmap;
    //   144: astore 7
    //   146: aload 6
    ...
    //   152: ifnull +7 -> 159
    //   155: aload_0
    //   156: invokevirtual 426	java/io/BufferedInputStream:close	()V
    //   159: aload 7
    //   161: areturn
    //   162: aload 6
    //   164: astore 7
    ...
    //   167: ifnull -128 -> 39
    //   170: aload_0
    //   171: invokevirtual 426	java/io/BufferedInputStream:close	()V
    //   174: aload 6
    //   176: areturn
    //   177: astore_0
    //   178: aload 6
    ...
    //   185: ifnull +7 -> 192
    //   188: aload_0
    //   189: invokevirtual 426	java/io/BufferedInputStream:close	()V
    //   192: aconst_null
    //   193: areturn
    //   194: astore_0
    //   195: aconst_null
    ...
    //   198: ifnull +7 -> 205
    //   201: aload_0
    //   202: invokevirtual 426	java/io/BufferedInputStream:close	()V
    //   205: aconst_null
    //   206: areturn
    //   207: astore 6
    //   209: aconst_null
    ...
    //   212: ifnull +7 -> 219
    //   215: aload_0
    //   216: invokevirtual 426	java/io/BufferedInputStream:close	()V
    //   219: aload 6
    //   221: athrow
    //   222: astore_0
    //   223: goto -146 -> 77
  ...
  public static SpannableString a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    if (!bgiz.a(paramContext, paramInt2)) {
      bgiz.a((QQAppInterface)localObject1, paramInt2, null, false);
    }
    if (paramInt3 == 0)
    {
      localObject3 = new SpannableString("*");
      paramInt1 = (int)paramContext.getResources().getDimension(2131297225);
      paramContext = paramContext.getResources().getDrawable(2130845753);
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          if ("!".equalsIgnoreCase(localObject6.substring(paramInt1, paramInt1 + 1)))
          {
            ...
            localObject1 = paramContext.getResources().getDrawable(2130845751);
            localObject4 = localObject3;
            localObject5 = localObject7;
          ...
          if ("@".equalsIgnoreCase(localObject6.substring(paramInt1, paramInt1 + 1)))
          {
            localObject4 = localObject1;
            localObject5 = localObject1;
            localObject3 = paramContext.getResources().getDrawable(2130845755);
            localObject4 = localObject1;
            localObject5 = localObject1;
          ...
          localObject4 = localObject3;
          localObject5 = localObject3;
          localObject1 = paramContext.getResources().getDrawable(2130845752);
          localObject4 = localObject3;
          localObject5 = localObject3;
        ...
        try
        {
          if ("%".equalsIgnoreCase(localObject6.substring(paramInt1, paramInt1 + 1)))
          {
            localObject3 = paramContext.getResources().getDrawable(2130845754);
      ...
      paramInt3 = (int)paramContext.getResources().getDimension(2131297225);
      paramInt1 = 0;
      Object localObject5;
  ...
  public static aymn a(aymn paramaymn)
  {
    if (paramaymn == null) {
      return null;
    }
    aymn localaymn = new aymn();
    localaymn.jdField_o_of_type_Long = paramaymn.jdField_o_of_type_Long;
    localaymn.jdField_a_of_type_JavaLangString = paramaymn.jdField_a_of_type_JavaLangString;
    localaymn.jdField_b_of_type_JavaLangString = paramaymn.jdField_b_of_type_JavaLangString;
    localaymn.jdField_c_of_type_JavaLangString = paramaymn.jdField_c_of_type_JavaLangString;
    localaymn.jdField_a_of_type_Int = paramaymn.jdField_a_of_type_Int;
    localaymn.jdField_b_of_type_Int = paramaymn.jdField_b_of_type_Int;
    localaymn.jdField_c_of_type_Int = paramaymn.jdField_c_of_type_Int;
    localaymn.jdField_d_of_type_JavaLangString = paramaymn.jdField_d_of_type_JavaLangString;
    localaymn.jdField_e_of_type_JavaLangString = paramaymn.jdField_e_of_type_JavaLangString;
    localaymn.jdField_f_of_type_JavaLangString = paramaymn.jdField_f_of_type_JavaLangString;
    localaymn.jdField_g_of_type_JavaLangString = paramaymn.jdField_g_of_type_JavaLangString;
    localaymn.jdField_h_of_type_JavaLangString = paramaymn.jdField_h_of_type_JavaLangString;
    localaymn.jdField_i_of_type_JavaLangString = paramaymn.jdField_i_of_type_JavaLangString;
    localaymn.jdField_j_of_type_JavaLangString = paramaymn.jdField_j_of_type_JavaLangString;
    localaymn.jdField_k_of_type_JavaLangString = paramaymn.jdField_k_of_type_JavaLangString;
    localaymn.jdField_d_of_type_Int = paramaymn.jdField_d_of_type_Int;
    localaymn.p = paramaymn.p;
    localaymn.q = paramaymn.q;
    localaymn.r = paramaymn.r;
    localaymn.s = paramaymn.s;
    localaymn.jdField_l_of_type_JavaLangString = paramaymn.jdField_l_of_type_JavaLangString;
    localaymn.n = paramaymn.n;
    localaymn.m = paramaymn.m;
    localaymn.jdField_o_of_type_JavaLangString = paramaymn.jdField_o_of_type_JavaLangString;
    localaymn.jdField_h_of_type_Int = paramaymn.jdField_h_of_type_Int;
    localaymn.t = paramaymn.t;
    localaymn.jdField_i_of_type_Int = paramaymn.jdField_i_of_type_Int;
    localaymn.jdField_j_of_type_Int = paramaymn.jdField_j_of_type_Int;
    localaymn.jdField_k_of_type_Int = paramaymn.jdField_k_of_type_Int;
    localaymn.jdField_e_of_type_Int = paramaymn.jdField_e_of_type_Int;
    localaymn.jdField_f_of_type_Int = paramaymn.jdField_f_of_type_Int;
    localaymn.jdField_g_of_type_Int = paramaymn.jdField_g_of_type_Int;
    localaymn.jdField_l_of_type_Int = paramaymn.jdField_l_of_type_Int;
    localaymn.jdField_a_of_type_Boolean = paramaymn.jdField_a_of_type_Boolean;
    return localaymn;
  }
  
  public static aymn a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    int k = 0;
    if (paramLong == aymn.jdField_a_of_type_Long) {
      return null;
    }
    ...
    if (i < m)
    {
      paramQQAppInterface = (aymn)localArrayList.get(i);
  ...
  public static bgej a(String paramString)
  {
    if ((paramString != null) && (!paramString.equals("")))
    {
      ...
      bgej localbgej = new bgej();
      try
      {
        paramString = new JSONObject(paramString);
        localbgej.jdField_b_of_type_Int = paramString.getInt("frameInterval");
        localbgej.jdField_a_of_type_Int = paramString.getInt("frameNumber");
        localbgej.jdField_a_of_type_Float = ((float)paramString.getDouble("positionX"));
        localbgej.jdField_b_of_type_Float = ((float)paramString.getDouble("positionY"));
        localbgej.c = ((float)paramString.getDouble("width"));
        localbgej.d = ((float)paramString.getDouble("height"));
        return localbgej;
      }
  ...
  public static FriendProfileCardBgDrawable a(Resources paramResources, String paramString1, String paramString2)
  {
    ...
    {
      localbgej = a(FileUtils.readFileToStringEx(new File(paramString1, "config.json"), -1));
      if (localbgej != null)
      {
        String[] arrayOfString = new String[localbgej.jdField_a_of_type_Int];
        int i = 0;
        while (i < localbgej.jdField_a_of_type_Int)
        {
          arrayOfString[i] = (paramString1 + "/" + (i + 1) + ".png");
          i += 1;
        }
        localbgej.jdField_a_of_type_ArrayOfJavaLangString = arrayOfString;
      }
    }
    paramString1 = localbgej;
    if (localbgej == null) {
      paramString1 = new bgej();
    }
  ...
  public static Card a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = localamsw.e(paramString);
        paramQQAppInterface = localamsw.b(paramString);
        if (paramQQAppInterface == null)
        {
          if (QLog.isColorLevel()) {
      ...
      if (!bftf.a(((Friends)localObject1).alias, paramQQAppInterface.strShowName))
      {
        paramQQAppInterface.strShowName = ((Friends)localObject1).alias;
        i = 1;
      }
  ...
  {
    String str = a();
    bfvo.a(paramString, str, 1080, 1080, 100);
  ...
  public static BusinessInfoCheckUpdate.RedTypeInfo a()
  {
    ...
    axfy localaxfy = (axfy)BaseApplicationImpl.getApplication().getRuntime().getManager(160);
    RedTouchItem localRedTouchItem = localaxfy.a(-4);
    if ((localaxfy.a(localRedTouchItem, true)) && (localRedTouchItem.count > 0))
    {
  ...
  public static String a()
  {
    ...
    localStringBuilder.append(amov.jdField_a_of_type_JavaLangString).append("temp").append("/").append(System.currentTimeMillis()).append("_portrait.tmp");
  ...
  public static String a(byte paramByte)
  {
    ...
    default: 
      return null;
    case 1: 
      return amtj.a(2131707553);
    case 2: 
      return amtj.a(2131707545);
    case 3: 
      return amtj.a(2131707571);
    case 4: 
      return amtj.a(2131707543);
    case 5: 
      return amtj.a(2131707550);
    case 6: 
      return amtj.a(2131707549);
    case 7: 
      return amtj.a(2131707563);
    case 8: 
      return amtj.a(2131707576);
    case 9: 
      return amtj.a(2131707585);
    case 10: 
      return amtj.a(2131707593);
    case 11: 
      return amtj.a(2131707573);
    }
    return amtj.a(2131707565);
  }
  ...
  {
    bgiz localbgiz = bgiz.a;
    switch (paramInt2)
    {
    default: 
      return "_";
    case 0: 
      return localbgiz.getDir(BaseApplicationImpl.getApplication(), localbgiz.getScid(paramInt1)) + "/half.png";
    case 1: 
      return localbgiz.getDir(BaseApplicationImpl.getApplication(), localbgiz.getScid(paramInt1)) + "/star.png";
    case 2: 
      return localbgiz.getDir(BaseApplicationImpl.getApplication(), localbgiz.getScid(paramInt1)) + "/moon.png";
    case 3: 
      return localbgiz.getDir(BaseApplicationImpl.getApplication(), localbgiz.getScid(paramInt1)) + "/sun.png";
    case 4: 
      return localbgiz.getDir(BaseApplicationImpl.getApplication(), localbgiz.getScid(paramInt1)) + "/crown.png";
    }
    return localbgiz.getDir(BaseApplicationImpl.getApplication(), localbgiz.getScid(paramInt1)) + "/more.png";
  }
  
  public static String a(Context paramContext)
  {
    paramContext = paramContext.getDir(".profilecard", 0);
    return paramContext.getAbsolutePath() + File.separator + "qvip_profile_label_config.json" + "8.4.8";
  }
  ...
  public static String a(Context paramContext, int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (paramInt1 == 0)
    {
      localStringBuilder.append(paramContext.getString(2131693568));
    ...
    for (;;)
    {
      if (paramInt2 != 0)
      {
        ...
        localStringBuilder.append(paramContext.getString(2131718743));
        localStringBuilder.append("  ");
      }
      String str = "";
      paramContext = str;
      ...
      {
        paramContext = str;
        if (!amtj.a(2131707557).equals(paramString1)) {
      ...
      if (paramInt1 == 1)
      {
        localStringBuilder.append(paramContext.getString(2131692108));
        localStringBuilder.append("  ");
      }
    }
  }
  
  public static String a(Context paramContext, aymg paramaymg)
  {
    ...
    if (ayue.a(41610, paramaymg))
    {
      ...
      if (i > 0)
      {
        localObject2 = localObject1;
        if (!b()) {
          localObject2 = i + paramContext.getString(2131718743);
        }
      }
    }
    localObject1 = "";
    ...
    if (ayue.a(41614, paramaymg))
    {
      ...
      {
        paramContext = (Context)localObject1;
        if (!amtj.a(2131707555).equals(localCard.strCountry)) {
          paramContext = "" + localCard.strCountry;
        }
      }
      paramaymg = paramContext;
      if (!TextUtils.isEmpty(localCard.strProvince))
      {
        ...
        paramaymg = paramaymg + localCard.strProvince;
      }
      paramContext = paramaymg;
    ...
    for (paramaymg = "" + " " + (String)localObject2;; paramaymg = "")
    {
      localObject1 = paramaymg;
      if (paramContext != null)
      {
        localObject1 = paramaymg;
        if (paramContext.length() > 0) {
          localObject1 = paramaymg + " " + paramContext;
        }
      }
      return localObject1;
      label373:
      ...
      {
        paramContext = (Context)localObject1;
        if (!amtj.a(2131707568).equals(localContactCard.strCountry)) {
      ...
      if (!TextUtils.isEmpty(localContactCard.strProvince))
      {
        ...
        paramaymg = paramaymg + localContactCard.strProvince;
      }
      paramContext = paramaymg;
  ...
  public static String a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    if ((paramLong != aymn.jdField_a_of_type_Long) && (paramLong > 0L)) {
      return paramQQAppInterface + File.separator + paramLong;
    }
    return null;
  }
  
  public static String a(QQAppInterface paramQQAppInterface, Activity paramActivity, aymg paramaymg)
  {
    if ((paramQQAppInterface == null) || (paramActivity == null) || (paramaymg == null) || (paramaymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne == null) || (TextUtils.isEmpty(paramaymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    ...
    bily localbily = (bily)paramQQAppInterface.getManager(165);
    if (localbily.a(str)) {
      return String.format("https://datacard.qidian.qq.com/static/1_%s_more.htm?appid=%s&version=%s&_wv=1027", new Object[] { str, Integer.valueOf(paramQQAppInterface.getAppid()), "android-8.4.8" });
    }
    if (localbily.f(str)) {
      return paramActivity.getIntent().getStringExtra("key_qidian_detail_url");
    }
    return aytq.a(paramQQAppInterface, paramaymg);
  }
  ...
  public static String a(String paramString)
  {
    ...
    localStringBuilder.append(amov.jdField_a_of_type_JavaLangString).append("HDAvatar").append("/").append(paramString).append(".jpg");
    return VFSAssistantUtils.getSDKPrivatePath(localStringBuilder.toString());
  }
  ...
  /* Error */
  public static ArrayList<aymn> a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 6
    ...
    //   19: aload_0
    //   20: invokevirtual 905	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   23: astore_0
    //   24: aload_0
    //   25: invokestatic 1251	bfrj:b	(Landroid/content/Context;)Ljava/lang/String;
    //   28: astore 8
    ...
    //   39: astore 7
    //   41: aload 7
    //   43: invokevirtual 402	java/io/File:exists	()Z
    //   46: istore 5
    //   48: iload 5
    //   50: ifne +8 -> 58
    //   53: ldc_w 1253
    //   56: astore 8
    //   58: getstatic 30	bfrj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   61: aload 8
    //   63: invokestatic 1256	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   66: ifeq +20 -> 86
    //   69: getstatic 26	bfrj:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   72: invokevirtual 1258	java/util/ArrayList:isEmpty	()Z
    //   75: ifne +11 -> 86
    //   78: iload_1
    //   79: ifne +7 -> 86
    //   82: getstatic 26	bfrj:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   85: areturn
    ...
    //   111: iload 5
    //   113: ifeq +103 -> 216
    //   116: new 411	java/io/FileInputStream
    //   119: dup
    //   120: aload 7
    //   122: invokespecial 414	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   125: astore_0
    //   126: new 1262	java/io/ByteArrayOutputStream
    //   129: dup
    //   130: invokespecial 1263	java/io/ByteArrayOutputStream:<init>	()V
    //   133: astore 7
    //   135: sipush 4096
    //   138: newarray byte
    //   140: astore 6
    ...
    //   145: iconst_0
    //   146: sipush 4096
    //   149: invokevirtual 1269	java/io/InputStream:read	([BII)I
    //   152: istore_2
    //   153: iload_2
    //   154: iconst_m1
    ...
    //   162: iconst_0
    //   163: iload_2
    //   164: invokevirtual 1273	java/io/ByteArrayOutputStream:write	([BII)V
    //   167: goto -25 -> 142
    //   170: astore 9
    //   172: aload 7
    //   174: astore 6
    ...
    //   178: astore 7
    //   180: aload 7
    //   182: invokevirtual 1274	java/lang/Throwable:printStackTrace	()V
    //   185: aload_0
    //   186: ifnull +7 -> 193
    //   189: aload_0
    //   190: invokevirtual 1275	java/io/InputStream:close	()V
    //   193: aload 6
    //   195: ifnull +8 -> 203
    //   198: aload 6
    //   200: invokevirtual 1276	java/io/ByteArrayOutputStream:close	()V
    //   203: aload 8
    //   205: putstatic 30	bfrj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   208: aload 10
    //   210: putstatic 26	bfrj:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   213: aload 10
    //   215: areturn
    //   216: aload_0
    //   217: invokevirtual 1280	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   220: ldc_w 1282
    //   223: invokevirtual 1288	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   226: astore_0
    //   227: goto -101 -> 126
    //   230: new 40	java/lang/String
    //   233: dup
    //   234: aload 7
    //   236: invokevirtual 1292	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   239: ldc_w 1294
    //   242: invokespecial 1297	java/lang/String:<init>	([BLjava/lang/String;)V
    //   245: astore 6
    //   247: aload 6
    //   249: invokevirtual 304	java/lang/String:length	()I
    //   252: ifle +627 -> 879
    //   255: new 681	org/json/JSONObject
    //   258: dup
    //   259: aload 6
    //   261: invokespecial 682	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   264: astore 6
    //   266: aload 6
    //   268: ldc_w 1299
    //   271: invokevirtual 1302	org/json/JSONObject:has	(Ljava/lang/String;)Z
    //   274: ifeq +605 -> 879
    //   277: aload 6
    //   279: ldc_w 1299
    //   282: invokevirtual 1306	org/json/JSONObject:optJSONArray	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   285: astore 6
    //   287: aload 6
    //   289: invokevirtual 1309	org/json/JSONArray:length	()I
    //   292: istore_3
    //   293: iconst_0
    //   294: istore_2
    //   295: iload_2
    ...
    //   300: aload 6
    //   302: iload_2
    //   303: invokevirtual 1313	org/json/JSONArray:getJSONObject	(I)Lorg/json/JSONObject;
    //   306: astore 9
    //   308: new 582	aymn
    //   311: dup
    //   312: invokespecial 583	aymn:<init>	()V
    //   315: astore 11
    //   317: aload 11
    //   319: aload 9
    //   321: ldc_w 1315
    //   324: invokevirtual 1318	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   327: i2l
    //   328: putfield 586	aymn:jdField_o_of_type_Long	J
    //   331: aload 11
    //   333: aload 9
    //   335: ldc_w 1319
    //   338: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   341: putfield 587	aymn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   344: aload 11
    //   346: aload 9
    //   348: ldc_w 1324
    //   351: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   354: putfield 589	aymn:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   357: aload 11
    //   359: aload 9
    //   361: ldc_w 1326
    //   364: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   367: putfield 590	aymn:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   370: aload 11
    //   372: aload 9
    //   374: ldc_w 1328
    //   377: invokevirtual 1318	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   380: putfield 591	aymn:jdField_a_of_type_Int	I
    //   383: aload 11
    //   385: aload 9
    //   387: ldc_w 1330
    //   390: invokevirtual 1318	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   393: putfield 592	aymn:jdField_b_of_type_Int	I
    //   396: aload 11
    //   398: aload 9
    //   400: ldc_w 1332
    //   403: invokevirtual 1318	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   406: putfield 593	aymn:jdField_c_of_type_Int	I
    //   409: aload 11
    //   411: aload 9
    //   413: ldc_w 1334
    //   416: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   419: putfield 594	aymn:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   422: aload 11
    //   424: aload 9
    //   426: ldc_w 1336
    //   429: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   432: putfield 596	aymn:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   435: aload 11
    //   437: aload 9
    //   439: ldc_w 1338
    //   442: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   445: putfield 599	aymn:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    //   448: aload 11
    //   450: aload 9
    //   452: ldc_w 1340
    //   455: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   458: putfield 602	aymn:jdField_g_of_type_JavaLangString	Ljava/lang/String;
    //   461: aload 11
    //   463: aload 9
    //   465: ldc_w 1342
    //   468: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   471: putfield 605	aymn:jdField_h_of_type_JavaLangString	Ljava/lang/String;
    //   474: aload 11
    //   476: aload 9
    //   478: ldc_w 1344
    //   481: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   484: putfield 607	aymn:jdField_i_of_type_JavaLangString	Ljava/lang/String;
    //   487: aload 11
    //   489: aload 9
    //   491: ldc_w 1346
    //   494: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   497: putfield 610	aymn:jdField_j_of_type_JavaLangString	Ljava/lang/String;
    //   500: aload 11
    //   502: aload 9
    //   504: ldc_w 1348
    //   507: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   510: putfield 613	aymn:jdField_k_of_type_JavaLangString	Ljava/lang/String;
    //   513: aload 11
    //   515: aload 9
    //   517: ldc_w 1350
    //   520: invokevirtual 1318	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   523: putfield 614	aymn:jdField_d_of_type_Int	I
    //   526: aload 11
    //   528: aload 9
    //   530: ldc_w 1352
    //   533: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   536: putfield 617	aymn:p	Ljava/lang/String;
    //   539: aload 11
    //   541: aload 9
    //   543: ldc_w 1354
    //   546: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   549: putfield 620	aymn:q	Ljava/lang/String;
    //   552: aload 11
    //   554: aload 9
    //   556: ldc_w 1356
    //   559: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   562: putfield 623	aymn:r	Ljava/lang/String;
    //   565: aload 11
    //   567: aload 9
    //   569: ldc_w 1358
    //   572: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   575: putfield 626	aymn:s	Ljava/lang/String;
    //   578: aload 11
    //   580: aload 9
    //   582: ldc_w 1360
    //   585: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   588: putfield 629	aymn:jdField_l_of_type_JavaLangString	Ljava/lang/String;
    //   591: aload 11
    //   593: aload 9
    //   595: ldc_w 1362
    //   598: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   601: putfield 632	aymn:n	Ljava/lang/String;
    //   604: aload 11
    //   606: aload 9
    //   608: ldc_w 1364
    //   611: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   614: putfield 635	aymn:m	Ljava/lang/String;
    //   617: aload 11
    //   619: aload 9
    //   621: ldc_w 1366
    //   624: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   627: putfield 637	aymn:jdField_o_of_type_JavaLangString	Ljava/lang/String;
    //   630: aload 11
    //   632: aload 9
    //   634: ldc_w 1368
    //   637: invokevirtual 1318	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   640: putfield 639	aymn:jdField_h_of_type_Int	I
    //   643: aload 11
    //   645: aload 9
    //   647: ldc_w 1370
    //   650: invokevirtual 1322	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   653: putfield 642	aymn:t	Ljava/lang/String;
    //   656: aload 11
    //   658: aload 9
    //   660: ldc_w 1372
    //   663: invokevirtual 1318	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   666: putfield 644	aymn:jdField_i_of_type_Int	I
    //   669: aload 11
    //   671: aload 9
    //   673: ldc_w 1374
    //   676: invokevirtual 1318	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   679: putfield 646	aymn:jdField_j_of_type_Int	I
    //   682: aload 11
    //   684: aload 9
    //   686: ldc_w 1376
    //   689: invokevirtual 1318	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   692: putfield 648	aymn:jdField_k_of_type_Int	I
    //   695: aload 11
    //   697: aload 9
    //   699: ldc_w 1378
    //   702: invokevirtual 1318	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   705: putfield 649	aymn:jdField_e_of_type_Int	I
    //   708: aload 11
    //   710: aload 9
    //   712: ldc_w 1380
    //   715: invokevirtual 1318	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   718: putfield 651	aymn:jdField_f_of_type_Int	I
    //   721: aload 11
    //   723: aload 9
    //   725: ldc_w 1382
    //   728: invokevirtual 1318	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   731: putfield 653	aymn:jdField_g_of_type_Int	I
    //   734: aload 9
    //   736: ldc_w 1384
    //   739: invokevirtual 1318	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   742: istore 4
    //   744: aload 11
    //   746: aload 9
    //   748: ldc_w 1386
    //   751: invokevirtual 1318	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   754: putfield 655	aymn:jdField_l_of_type_Int	I
    //   757: iload 4
    //   759: iconst_1
    ...
    //   765: aload 11
    //   767: iload_1
    //   768: putfield 657	aymn:jdField_a_of_type_Boolean	Z
    //   771: aload 10
    //   773: aload 11
    //   775: invokevirtual 1389	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   778: pop
    //   779: iload_2
    //   780: iconst_1
    //   781: iadd
    ...
    //   786: new 582	aymn
    //   789: dup
    //   790: invokespecial 583	aymn:<init>	()V
    //   793: astore 6
    //   795: aload 6
    //   797: ldc2_w 1390
    //   800: putfield 586	aymn:jdField_o_of_type_Long	J
    //   803: aload 6
    //   805: iconst_1
    //   806: putfield 657	aymn:jdField_a_of_type_Boolean	Z
    //   809: aload 10
    //   811: aload 6
    //   813: invokevirtual 1389	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   816: pop
    //   817: new 582	aymn
    //   820: dup
    //   821: invokespecial 583	aymn:<init>	()V
    //   824: astore 6
    //   826: aload 6
    //   828: ldc2_w 1392
    //   831: putfield 586	aymn:jdField_o_of_type_Long	J
    //   834: aload 6
    //   836: iconst_1
    //   837: putfield 657	aymn:jdField_a_of_type_Boolean	Z
    //   840: aload 10
    //   842: aload 6
    //   844: invokevirtual 1389	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   847: pop
    //   848: new 582	aymn
    //   851: dup
    //   852: invokespecial 583	aymn:<init>	()V
    //   855: astore 6
    //   857: aload 6
    //   859: ldc2_w 1394
    //   862: putfield 586	aymn:jdField_o_of_type_Long	J
    //   865: aload 6
    //   867: iconst_1
    //   868: putfield 657	aymn:jdField_a_of_type_Boolean	Z
    //   871: aload 10
    //   873: aload 6
    //   875: invokevirtual 1389	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   878: pop
    //   879: aload_0
    //   880: ifnull +7 -> 887
    //   883: aload_0
    //   884: invokevirtual 1275	java/io/InputStream:close	()V
    //   887: aload 7
    //   889: ifnull -686 -> 203
    //   892: aload 7
    //   894: invokevirtual 1276	java/io/ByteArrayOutputStream:close	()V
    //   897: goto -694 -> 203
    //   900: astore_0
    //   901: aload_0
    //   902: invokevirtual 1396	java/io/IOException:printStackTrace	()V
    //   905: goto -702 -> 203
    //   908: astore_0
    //   909: aload_0
    //   910: invokevirtual 1396	java/io/IOException:printStackTrace	()V
    //   913: goto -710 -> 203
    //   916: astore 6
    //   918: aconst_null
    //   919: astore 7
    ...
    //   924: ifnull +7 -> 931
    //   927: aload_0
    //   928: invokevirtual 1275	java/io/InputStream:close	()V
    //   931: aload 7
    //   933: ifnull +8 -> 941
    //   936: aload 7
    //   938: invokevirtual 1276	java/io/ByteArrayOutputStream:close	()V
    //   941: aload 6
    //   943: athrow
    //   944: astore_0
    //   945: aload_0
    //   946: invokevirtual 1396	java/io/IOException:printStackTrace	()V
    //   949: goto -8 -> 941
    //   952: astore 6
    //   954: aconst_null
    //   955: astore 7
  ...
  public static ArrayList<aymn> a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (QLog.isColorLevel()) {
    ...
    if (!((ArrayList)localObject).isEmpty())
    {
      ...
      {
        aymn localaymn = (aymn)((Iterator)localObject).next();
        if ((paramBoolean1) || (!localaymn.jdField_a_of_type_Boolean)) {
          if (paramBoolean2) {
            localArrayList.add(localaymn);
          } else if (a(paramQQAppInterface, localaymn)) {
            localArrayList.add(localaymn);
          }
        }
      }
  ...
  public static List<Pair<String, String>> a(Context paramContext, aymg paramaymg)
  {
    ArrayList localArrayList = new ArrayList(3);
    if ((paramContext == null) || (paramaymg.jdField_a_of_type_ComTencentMobileqqDataCard == null)) {
      return localArrayList;
    }
    if (QLog.isColorLevel()) {
    ...
    if (i == 0) {
      localArrayList.add(Pair.create(paramContext.getString(2131693568), ""));
    }
    for (;;)
    {
      paramContext = ayue.b(paramaymg);
      if (!TextUtils.isEmpty(paramContext)) {
        localArrayList.add(Pair.create(paramContext, "school"));
      }
      paramContext = ayue.i(paramaymg);
      if (!TextUtils.isEmpty(paramContext)) {
      ...
      paramContext = ayue.c(paramaymg);
      String str1 = ayue.d(paramaymg);
      String str2 = ayue.e(paramaymg);
      StringBuilder localStringBuilder = new StringBuilder(50);
      if ((!TextUtils.isEmpty(paramContext)) && (!amtj.a(2131707564).equals(paramContext))) {
        localStringBuilder.append(paramContext);
      }
      ...
      return localArrayList;
      if (i == 1) {
        localArrayList.add(Pair.create(paramContext.getString(2131692108), ""));
      }
    }
  }
  
  public static List<SpannableString> a(QQAppInterface paramQQAppInterface, Context paramContext, aymg paramaymg)
  {
    ArrayList localArrayList = new ArrayList();
    if ((paramContext == null) || (paramaymg.jdField_a_of_type_ComTencentMobileqqDataCard == null)) {
      return localArrayList;
    ...
    if (i == 0)
    {
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        localArrayList.add(a(str, true, 2130845065, 2131298182, 2131298181, paramContext, paramQQAppInterface));
      }
    }
    for (;;)
    {
      ...
      break;
      label190:
      localArrayList.add(new SpannableString(paramaymg.jdField_a_of_type_ComTencentMobileqqDataCard.strSchool));
    }
    label215:
    paramQQAppInterface = ayue.c(paramaymg);
    paramContext = ayue.d(paramaymg);
    String str = ayue.e(paramaymg);
    StringBuilder localStringBuilder = new StringBuilder(50);
  ...
  public static void a(Activity paramActivity, View paramView, String paramString, boolean paramBoolean1, boolean paramBoolean2, ProfileActivity.AllInOne paramAllInOne)
  {
    Intent localIntent = new Intent(paramActivity, FriendProfileImageActivity.class);
    localIntent.putExtra("friendUin", paramString);
    localIntent.putExtra("KEY_THUMBNAL_BOUND", aagn.a(paramView));
    localIntent.putExtra("requestType", 881);
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, String paramString3, boolean paramBoolean1, boolean paramBoolean2, String paramString4)
  {
    ...
    paramString2 = bgev.a(paramActivity, "card", paramString2);
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt, String paramString3)
  {
    try
    {
      ...
      paramString2 = aphs.a((QQAppInterface)localObject, paramString2);
      if (paramString2.mobilesNum.size() >= 3)
      {
        QQToast.a(paramActivity, 0, 2131694404, 0).a();
        return;
      }
  ...
  public static void a(Context paramContext)
  {
    ...
    paramContext = (axfy)BaseApplicationImpl.getApplication().getRuntime().getManager(160);
  ...
  public static void a(Context paramContext, long paramLong, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = String.format(bgev.a("rareCard"), new Object[] { Long.valueOf(paramLong) });
    }
  ...
  public static void a(Context paramContext, BusinessCard paramBusinessCard, ProfileActivity.AllInOne paramAllInOne, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramAllInOne.jdField_a_of_type_Int == 0)
    {
      bcef.b(null, "CliOper", "", "", "0X8006A7F", "0X8006A7F", 0, 0, "", "", "", "");
      return;
    }
    bcef.b(null, "CliOper", "", "", "0X8006A93", "0X8006A93", 0, 0, "", "", "", "");
  }
  ...
  public static void a(TextView paramTextView, String paramString1, String paramString2)
  {
    ...
    if (paramTextView != null)
    {
      ...
      localayto.a(localResources.getString(2131698446), paramString1);
      if ((!TextUtils.isEmpty(paramString2)) && (str.length() > paramString1.length() + 2)) {
        localayto.a(localResources.getString(2131698445), paramString2);
      }
    }
    for (;;)
    {
      aytm.a(paramTextView, localayto);
      return;
      label97:
      if ((paramString2 != null) && (str.contains(paramString2))) {
        localayto.a(localResources.getString(2131698445), paramString2);
      } else {
        localayto.a(localResources.getString(2131698444), str);
      }
    }
  }
  
  public static void a(aymg paramaymg, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    if ((paramaymg == null) || (paramQQAppInterface == null) || (paramActivity == null)) {}
    do
    {
      return;
      paramaymg = a(paramQQAppInterface, paramActivity, paramaymg);
      if (QLog.isColorLevel()) {
        QLog.d("ProfileCardUtil", 2, String.format("openDetails url=%s", new Object[] { paramaymg }));
      }
    } while (TextUtils.isEmpty(paramaymg));
    Intent localIntent = new Intent(paramActivity, QQBrowserActivity.class);
    localIntent.putExtra("url", paramaymg);
  ...
  {
    aabc.a(paramBaseActivity, paramLong, paramString1, paramString2, paramInt, "", new Bundle());
  }
  ...
  {
    aabc.a(paramBaseActivity, paramLong, paramString1, paramString2, paramInt, paramString3, paramBundle);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, View paramView, String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      anhl localanhl = ((DynamicAvatarView)paramView).a;
      if ((localanhl != null) && (localanhl.jdField_a_of_type_Boolean) && (!TextUtils.isEmpty(localanhl.jdField_c_of_type_JavaLangString)))
      {
        b(paramActivity, paramView, localanhl.jdField_c_of_type_JavaLangString);
        paramInt1 = 1;
        if (paramInt2 == 0) {
          if (paramInt1 == 0) {
            break label159;
    ...
    {
      bcef.b(paramQQAppInterface, "dc00898", "", "", "0X8007103", "0X8007103", 0, 0, paramActivity, "", "", "");
      return;
      if (paramInt2 == 1)
      {
  ...
  public static void a(String paramString, Activity paramActivity)
  {
    ...
    atky.a(paramActivity, paramString, 21);
  }
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    QZoneHelper.forwardToPublishMood(paramActivity, localUserInfo, paramString, paramActivity.getString(2131691958), "", -1);
  }
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface, Activity paramActivity, boolean paramBoolean)
  {
    ...
    paramString.putExtra("url", aykk.jdField_c_of_type_JavaLangString);
  ...
  public static boolean a(ayme paramayme)
  {
    return paramayme.jdField_a_of_type_Int == 160;
  }
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, aymn paramaymn)
  {
    long l = NetConnInfoCenter.getServerTime();
    if (((paramaymn.jdField_j_of_type_Int > 100) && (l < paramaymn.jdField_j_of_type_Int)) || ((paramaymn.jdField_k_of_type_Int > 100) && (l > paramaymn.jdField_k_of_type_Int)))
    {
      if (QLog.isColorLevel()) {
        QLog.w("ProfileCardUtil", 2, "filterTemplate->sytle:" + paramaymn.jdField_o_of_type_Long + ",beginTime:" + paramaymn.jdField_j_of_type_Int + ",endTime:" + paramaymn.jdField_k_of_type_Int);
      }
      return false;
    }
    return true;
  ...
  {
    if (bgov.a(paramQQAppInterface, "show_diy_template_guide_for_guest_time", 0) >= 3) {}
    long l;
    do
    {
      return false;
  ...
  {
    paramContext = paramContext.getDir(".profilecard", 0);
    return paramContext.getAbsolutePath() + File.separator + "qvip_profile_template.json" + "8.4.8";
  }
  
  public static String b(Context paramContext, aymg paramaymg)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    int i = ayue.a(paramaymg);
    if (i == 0)
    ...
    for (;;)
    {
      ...
      String str3 = ayue.c(paramaymg);
      String str2 = ayue.d(paramaymg);
      String str1 = ayue.e(paramaymg);
      paramaymg = "";
      paramContext = paramaymg;
      if (!TextUtils.isEmpty(str3))
      {
        paramContext = paramaymg;
        if (!amtj.a(2131707584).equals(str3)) {
          paramContext = "" + str3;
        }
      }
      paramaymg = paramContext;
  ...
  public static String b(String paramString)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    paramString = MD5.toMD5(MD5.toMD5(MD5.toMD5(paramString)));
    localStringBuilder.append(amov.jdField_a_of_type_JavaLangString).append("FHDAvatar").append("/").append(paramString).append(".jpg");
    return VFSAssistantUtils.getSDKPrivatePath(localStringBuilder.toString());
  }
  ...
  public static void b(Activity paramActivity, View paramView, String paramString)
  {
    ...
    ((Intent)localObject).putExtra("KEY_THUMBNAL_BOUND", aagn.a(paramView));
  ...
  {
    bgov.a(paramQQAppInterface, "show_diy_template_guide_for_guest_time", bgov.a(paramQQAppInterface, "show_diy_template_guide_for_guest_time", 0) + 1);
  }
  ...
  public static void b(String paramString, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    try
    {
      bkov.b(paramString).a(paramActivity, paramQQAppInterface.getCurrentAccountUin());
      return;
    }
    catch (Exception paramString)
    {
      ...
      QQToast.a(paramActivity, paramActivity.getResources().getString(2131692567), 0).a();
    }
  }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(amov.jdField_a_of_type_JavaLangString).append("temp").append("/").append(System.currentTimeMillis()).append("_cardbg.tmp");
    return VFSAssistantUtils.getSDKPrivatePath(localStringBuilder.toString());
  }
  ...
  public static String c(Context paramContext, aymg paramaymg)
  {
    int j = -1;
    String str = "";
    Object localObject = str;
    ...
    if (ayue.a(41611, paramaymg))
    {
      ...
      localContactCard = paramaymg.jdField_a_of_type_ComTencentMobileqqDataContactCard;
      ...
      localObject = paramContext.getString(2131693568);
    }
    for (;;)
    {
      return (String)localObject + a(paramContext, paramaymg);
      label98:
      ...
      localObject = str;
      if (i == 1) {
        localObject = paramContext.getString(2131692108);
      }
    }
  }
