  ...
  implements Handler.Callback, Manager
{
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (int i = 1;; i = 0)
        {
          ...
          localObject = bdjl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp());
          if (localObject != null)
          {
  ...
  private void b()
  {
    ...
    localObject2 = ajya.a(2131714993);
    str4 = "登录TIM";
    str2 = ajya.a(2131714992);
    ...
    bbdj.a(BaseActivity.sTopActivity, 230, str5, str6, (String)localObject3, (String)localObject1, new asez(this), new asfa(this)).show();
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80085D9", "0X80085D9", 0, 0, "", "", "", "");
  }
  ...
  {
    if (!bbfr.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim", "775E696D09856872FDD8AB4F3F06B1E0"))
    {
      bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131720254, 0).a();
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "jumpTimLogin tim not install ");
      }
      return;
    }
    String str = bbfr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim");
    int i = anbq.a().b();
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        localbcqf = new bcqf(BaseActivity.sTopActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getDimensionPixelOffset(2131298865));
        localbcqf.a(ajya.a(2131714991));
        localbcqf.show();
        ...
        localWtloginHelper.SetListener(new asfb(this, localbcqf, localWtloginHelper, paramBundle));
        paramBundle = util.getPkgSigFromApkName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim");
        i = localWtloginHelper.GetA1WithA1(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), 16L, 16L, "com.tencent.tim".getBytes(), 1L, 16L, 16L, "8.3.0".getBytes(), paramBundle, new WUserSigInfo(), new WFastLoginInfo());
      }
      if (i == -1001) {
        break;
      }
      ...
      if ((localbcqf != null) && (localbcqf.isShowing())) {
        localbcqf.dismiss();
      }
      bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131720253, 0).a();
      return;
    } while (j >= i);
    bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131720255, 0).a();
  }
