  ...
  implements Manager
{
  ...
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new asez(this);
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord instanceof MessageForPic)) {
      d(((bhou)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.VAS_EXTENSION_MANAGER)).a.a(paramMessageRecord));
    }
    for (;;)
    {
      ...
      if ((paramMessageRecord instanceof MessageForMixedMsg))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if ((localObject instanceof MessageForPic))
          {
            ...
            d(((bhou)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.VAS_EXTENSION_MANAGER)).a.a((MessageRecord)localObject));
          }
        }
      }
    }
    ...
    do
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject instanceof MessageForPic))
        {
          localObject = (MessageForPic)localObject;
          MessageForMixedMsg.copyBaseInfoFromMixedToPic((MessageForPic)localObject, paramMessageRecord);
          localObject = ((bhou)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.VAS_EXTENSION_MANAGER)).a.a((MessageRecord)localObject);
