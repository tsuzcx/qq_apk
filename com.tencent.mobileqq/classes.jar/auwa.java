...
public class auwa
{
  private static auwa a = new auwa();
  ...
  public void a(QQAppInterface paramQQAppInterface, List<BusinessInfoCheckUpdate.NumRedInfo> paramList)
  {
    ...
    if (paramList.size() > 0)
    {
      ...
      ((axls)paramQQAppInterface.getManager(65)).a(localArrayList, "nearby_num_red_dot", new auwb(this, paramQQAppInterface));
    }
  }
  ...
  public void b(QQAppInterface paramQQAppInterface, List<NumRedMsg.NumMsgBusi> paramList)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      catch (Exception localException4)
      {
        try
        {
          avsn.a().a(paramQQAppInterface, (oidb_0x791.RedDotInfo)localObject1);
        }
    ...
    do
    {
      ...
      try
      {
        ...
        new azqx(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("nearby_push_red_tmp").a(new String[] { paramList.uint32_appid.get() + "" }).a();
        if (paramList.uint32_appid.get() == 59)
        {
          new azqx(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("like_exp_red").a();
          return;
        }
      }
      catch (Exception localException1)
      {
        ...
        if (paramList.uint32_appid.get() == 60)
        {
          ...
          {
            new azqx(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("assist_exp_red").a();
            return;
          }
          new azqx(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("c2c_exp_red").a();
          return;
        }
      }
    } while (paramList.uint32_appid.get() != 61);
    new azqx(paramQQAppInterface).a("dc00899").b("grp_lbs").c("entry").d("paried_exp_red").a();
  }
}
