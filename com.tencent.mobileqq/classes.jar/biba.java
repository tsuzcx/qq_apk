  ...
  extends bidq
{
  ...
  private static final String jdField_b_of_type_JavaLangString = ajjy.a(2131637692);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = biba.class.getSimpleName();
  }
  
  public biba(bigb parambigb, long paramLong)
  {
  ...
  private void a(String paramString)
  {
    ...
    for (int i = 1;; i = 2)
    {
      awqx.b(null, "dc00899", "Grp_tribe", "", "video_edit", paramString, i, 0, "", "", "", "");
      return;
    }
  }
  ...
  private void b(String paramString)
  {
    ...
    for (;;)
    {
      paramString.setSpan(new vrc(a(), 2130841978), 0, 1, 33);
  ...
  private void j()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new bibb(this));
      return;
      b(jdField_b_of_type_JavaLangString);
    }
  }
  ...
  {
    super.a();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)a(2131298218));
    this.jdField_a_of_type_AndroidViewView = ((ImageView)a(2131311766));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)a(2131299188));
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetTextView.setText(ajjy.a(2131637691));
    this.jdField_b_of_type_AndroidWidgetTextView = new TextView(a());
    this.jdField_b_of_type_AndroidWidgetTextView.setGravity(17);
    this.jdField_b_of_type_AndroidWidgetTextView.setMaxWidth(azvv.a(a(), 192.0F));
    ...
    int i = azvv.a(a(), 10.0F);
    this.jdField_b_of_type_AndroidWidgetTextView.setPadding(i, 0, i, 0);
    this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130841979);
    Object localObject = new RelativeLayout.LayoutParams(-2, azvv.a(a(), 28.0F));
    ((RelativeLayout.LayoutParams)localObject).addRule(11);
    ((RelativeLayout.LayoutParams)localObject).addRule(15);
    ((RelativeLayout.LayoutParams)localObject).rightMargin = azvv.a(a(), 10.0F);
    ...
    localObject = aybu.a(((EditVideoParams)((Activity)a()).getIntent().getParcelableExtra(EditVideoParams.class.getName())).a);
    if (localObject != null)
    {
