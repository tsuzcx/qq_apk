...
public class yxu
  implements aaez, Handler.Callback, aqxk
{
  private static final String jdField_a_of_type_JavaLangString = amtj.a(2131715860);
  private static final String jdField_b_of_type_JavaLangString = amtj.a(2131715861);
  ...
  public yxu(Context paramContext, QQAppInterface paramQQAppInterface)
  {
  ...
  private void d()
  {
    ...
    if (!bool)
    {
      if (this.jdField_a_of_type_Aqxj == null) {
        this.jdField_a_of_type_Aqxj = ((aqxj)((aqxc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(77)).a("qq.android.system.chirp"));
      }
      if (this.jdField_a_of_type_Aqxj != null)
      {
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    //   1: istore_2
    //   2: aload_0
    //   3: getfield 206	yxu:jdField_a_of_type_ComTencentChirpChirpWrapper	Lcom/tencent/chirp/ChirpWrapper;
    //   6: ifnonnull +4 -> 10
    //   9: return
    //   10: aload_1
    //   11: arraylength
    ...
    //   17: aload_1
    //   18: aload_3
    //   19: invokestatic 253	yxu:a	([B[S)V
    //   22: aload_0
    //   23: getfield 206	yxu:jdField_a_of_type_ComTencentChirpChirpWrapper	Lcom/tencent/chirp/ChirpWrapper;
    //   26: aload_3
    //   27: bipush 15
    //   29: invokevirtual 256	com/tencent/chirp/ChirpWrapper:a	([SI)Ljava/lang/String;
    //   32: astore_1
    //   33: aload_1
    //   34: invokestatic 262	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   37: ifne -28 -> 9
    ...
    //   72: aload_1
    //   73: ldc_w 266
    //   76: invokevirtual 272	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   79: ifeq +269 -> 348
    //   82: iload_2
    //   83: aload_1
    //   84: invokevirtual 275	java/lang/String:length	()I
    //   87: if_icmpge +20 -> 107
    //   90: aload_1
    //   91: iload_2
    //   92: invokevirtual 279	java/lang/String:charAt	(I)C
    //   95: bipush 48
    //   97: if_icmpne +10 -> 107
    //   100: iload_2
    //   101: iconst_1
    ...
    //   107: aload_1
    //   108: iload_2
    //   109: invokevirtual 282	java/lang/String:substring	(I)Ljava/lang/String;
    //   112: astore_1
    ...
    //   145: aload_1
    //   146: invokestatic 290	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   149: pop2
    //   150: ldc_w 291
    //   153: invokestatic 31	amtj:a	(I)Ljava/lang/String;
    //   156: invokestatic 295	com/tencent/mobileqq/app/QQAppInterface:speak	(Ljava/lang/String;)V
    //   159: ldc2_w 296
    //   162: invokestatic 303	java/lang/Thread:sleep	(J)V
    //   165: aload_1
    //   166: ifnull +27 -> 193
    //   169: ldc_w 305
    //   172: aload_1
    //   173: invokevirtual 309	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   176: ifne +17 -> 193
    //   179: aload_0
    //   180: getfield 45	yxu:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   183: invokevirtual 177	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   186: aload_1
    //   187: invokevirtual 309	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   190: ifeq +82 -> 272
    //   193: new 311	com/tencent/mobileqq/activity/ProfileActivity$AllInOne
    //   196: dup
    //   197: aload_0
    //   198: getfield 45	yxu:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   201: invokevirtual 177	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   204: iconst_0
    //   205: invokespecial 314	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:<init>	(Ljava/lang/String;I)V
    //   208: astore_1
    //   209: aload_0
    //   210: getfield 43	yxu:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   213: aload_1
    //   214: invokestatic 319	com/tencent/mobileqq/activity/ProfileActivity:b	(Landroid/content/Context;Lcom/tencent/mobileqq/activity/ProfileActivity$AllInOne;)V
    //   217: aload_0
    //   218: getfield 45	yxu:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   221: ldc_w 321
    //   224: ldc_w 305
    //   227: ldc_w 305
    //   230: ldc_w 323
    ...
    //   244: ldc_w 305
    //   247: ldc_w 305
    //   250: invokestatic 328	bcef:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   253: return
    //   254: astore_1
    ...
    //   264: ldc_w 305
    //   267: aload_1
    //   268: invokestatic 331	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   271: return
    //   272: aload_0
    //   273: getfield 45	yxu:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   276: bipush 51
    //   278: invokevirtual 118	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   281: checkcast 333	amsw
    //   284: aload_1
    //   285: invokevirtual 336	amsw:e	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/Friends;
    //   288: astore_3
    //   289: aload_3
    //   290: ifnull +39 -> 329
    //   293: aload_3
    //   294: invokevirtual 341	com/tencent/mobileqq/data/Friends:isFriend	()Z
    //   297: ifeq +32 -> 329
    //   300: new 311	com/tencent/mobileqq/activity/ProfileActivity$AllInOne
    //   303: dup
    //   304: aload_1
    //   305: iconst_1
    //   306: invokespecial 314	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:<init>	(Ljava/lang/String;I)V
    //   309: astore_1
    //   310: aload_1
    //   311: aload_3
    //   312: getfield 344	com/tencent/mobileqq/data/Friends:name	Ljava/lang/String;
    //   315: putfield 347	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:h	Ljava/lang/String;
    //   318: aload_1
    //   319: aload_3
    //   320: getfield 350	com/tencent/mobileqq/data/Friends:remark	Ljava/lang/String;
    //   323: putfield 353	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:i	Ljava/lang/String;
    //   326: goto -117 -> 209
    //   329: new 311	com/tencent/mobileqq/activity/ProfileActivity$AllInOne
    //   332: dup
    //   333: aload_1
    //   334: iconst_3
    //   335: invokespecial 314	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:<init>	(Ljava/lang/String;I)V
    //   338: astore_1
    //   339: aload_1
    //   340: bipush 12
    //   342: putfield 357	com/tencent/mobileqq/activity/ProfileActivity$AllInOne:l	I
    //   345: goto -136 -> 209
    //   348: getstatic 36	yxu:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   351: invokestatic 295	com/tencent/mobileqq/app/QQAppInterface:speak	(Ljava/lang/String;)V
    //   354: return
    //   355: astore_3
    //   356: goto -191 -> 165
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Aqxj != null)
    {
      ...
      this.jdField_a_of_type_Aqxj = null;
    }
