...
public class adld
  implements bkhw
{
  public adld(AddRequestActivity paramAddRequestActivity, bkho parambkho) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    {
      long l1 = bdgm.a().b();
      this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.a = bdgm.a().a(Long.valueOf(l1));
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.a != null)
      {
        ...
        if ((paramView != null) && (1 < paramView.size()))
        {
          ...
          AddRequestActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity, 2131717771, 1000L, false);
        }
      }
    }
    for (;;)
    {
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.app, "CliOper", "", "", "Verification_msg", "Vfc_shield_clk", 0, 0, "", "", "", "");
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.app, "CliOper", "", "", "0X800AA45", "0X800AA45", 0, 0, "", "", "", "");
      break;
