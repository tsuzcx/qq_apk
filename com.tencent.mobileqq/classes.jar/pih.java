...
public class pih
{
  ...
  public static JSONObject a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, ArticleInfo paramArticleInfo)
  {
    ...
    try
    {
      ...
      localJSONObject.put("rowkey", uvs.a(paramArticleInfo));
  ...
  public static void a(int paramInt1, long paramLong1, int paramInt2, int paramInt3, long paramLong2, int paramInt4, String paramString1, String paramString2)
  {
    ...
    if (!TextUtils.isEmpty("8.4.10")) {
      localGalleryExpReported.client_ver.set(ByteStringMicro.copyFromUtf8("8.4.10"));
    }
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, String paramString, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramContext = a(paramContext, pkh.a() + "", i, paramArticleInfo.mArticleID, 0, paramArticleInfo.innerUniqueID, paramArticleInfo.galleryReprotExdData, a(pqw.a(paramArticleInfo)), 0, (int)paramArticleInfo.mChannelID, paramJSONObject);
        olh.a(null, "" + paramArticleInfo.publishUin, paramString, paramString, 0, 0, "", paramArticleInfo.mArticleID + "", paramArticleInfo.mAlgorithmID + "", paramContext, false);
        return;
      }
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, szd paramszd)
  {
    if ((pqw.c(paramArticleInfo)) || (pqw.e(paramArticleInfo)) || (pqa.a(paramArticleInfo)))
    {
      paramContext = a(paramContext, pkh.a() + "", ComponentContentGalleryBiu.a(paramArticleInfo, paramszd), paramArticleInfo.mArticleID, paramszd.a().indexOf(paramArticleInfo), paramArticleInfo.innerUniqueID, paramArticleInfo.galleryReprotExdData, a(pqw.a(paramArticleInfo)), 0, (int)paramArticleInfo.mChannelID, null);
      olh.a(null, "" + paramArticleInfo.publishUin, "0X8008E2F", "0X8008E2F", 0, 0, "", paramArticleInfo.mArticleID + "", paramArticleInfo.mAlgorithmID + "", paramContext, false);
    }
  }
  ...
  public static void a(Context paramContext, String paramString, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      olh.a(null, "", paramString, paramString, 0, 0, "", "", "", localJSONObject.toString(), false);
      return;
    }
    catch (JSONException paramContext)
    {
  ...
  public static void a(pij parampij)
  {
    olh.a(null, parampij.a, parampij.b, parampij.c, 0, 0, "", parampij.e, parampij.f, parampij.g, false);
  }
  ...
  public static String b()
  {
    ...
    if (!a)
    {
      ...
      a = true;
      SosoInterface.startLocation(new pii(3, true, true, 300000L, false, false, "GalleryReportedUtils"));
    }
    return "";
  }
}
