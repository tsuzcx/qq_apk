...
public class axww
{
  ...
  public axww(AppInterface paramAppInterface)
  {
  ...
  public void a(long paramLong1, long paramLong2, int paramInt1, int paramInt2, boolean paramBoolean, axxd paramaxxd)
  {
    ...
    for (paramInt2 = 1;; paramInt2 = 2)
    {
      ...
      ntb.a(this.a, new axxb(this, paramaxxd), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
    }
  }
  
  public void a(long paramLong, String paramString, axxd paramaxxd)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      ntb.a(this.a, new axxc(this, paramaxxd), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
    }
  }
  
  public void a(String paramString, axxd paramaxxd)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      ntb.a(this.a, new axwy(this, paramaxxd), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
    }
  }
  
  public void a(String paramString, axxd paramaxxd, Bundle paramBundle)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      ntb.a(this.a, new axwx(this, paramaxxd), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, paramBundle, 0L);
    }
  }
  
  public void b(String paramString, axxd paramaxxd)
  {
    ...
    if (a(localReqBody))
    {
      ...
      ntb.a(this.a, new axxa(this, paramString, paramaxxd), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
    }
  }
  
  public void b(String paramString, axxd paramaxxd, Bundle paramBundle)
  {
    oidb_0xada.ReqBody localReqBody = new oidb_0xada.ReqBody();
    if (a(localReqBody))
    {
      ...
      ntb.a(this.a, new axwz(this, paramaxxd), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, paramBundle, 0L);
    }
  }
}
