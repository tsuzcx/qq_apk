...
public class roa
  extends osp
{
  public roa(ReadInJoyDiandianHeaderController paramReadInJoyDiandianHeaderController) {}
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    bhvh.a("readinjoy_follow_subscribed_list_data_key", paramString);
  ...
  public void d(boolean paramBoolean, List<DiandianTopConfig> paramList)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        paramList = new roi(this.a, ReadInJoyDiandianHeaderController.b(this.a), j);
          ...
          if (k < paramList.getCount())
          {
            ...
            for (;;)
            {
              try
              {
                ...
                noo.a(null, "", "0X80092FC", "0X80092FC", 0, 0, ReadInJoyDiandianHeaderController.b(this.a).size() + "", "1", ((DiandianTopConfig)localObject).topicId + "", localJSONObject.toString(), false);
