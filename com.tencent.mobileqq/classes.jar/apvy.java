...
public class apvy
{
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, apwc paramapwc)
  {
    ...
    do
    {
      do
      {
        ...
        if ((!bool) && (apvx.a))
        {
          ArkAppCenter.a().postToMainThread(new ArkAppModuleBase.APIAuthority.1((String)localObject1, paramString4, paramString2, paramapwc, paramString3, paramString1));
