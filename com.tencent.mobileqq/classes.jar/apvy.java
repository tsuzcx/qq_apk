...
public class apvy
  ...
  implements Handler.Callback, bgte
{
  ...
  private apwp jdField_a_of_type_Apwp;
  ...
  public apvy(Context paramContext, QQAppInterface paramQQAppInterface, QQGamePubAccountFragment paramQQGamePubAccountFragment)
  {
  ...
  public void a()
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131493518, null, false);
    localRelativeLayout.setLayoutParams(new RecyclerView.LayoutParams(-1, 0));
    this.jdField_a_of_type_Apwp = new apwp(localRelativeLayout, this.jdField_a_of_type_AndroidContentContext);
  ...
  {
    this.jdField_a_of_type_AndroidAppDialog = new Dialog(this.jdField_a_of_type_AndroidContentContext, 2131689718);
    Object localObject = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131493522, null);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(aciy.a(280.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), -1);
    ((ImageView)((View)localObject).findViewById(2131302403)).setImageDrawable(URLDrawable.getDrawable("https://cmshow.gtimg.cn/client/gameCenter/gameCenter_popView_card@2x.png"));
    TextView localTextView1 = (TextView)((View)localObject).findViewById(2131312565);
    if ((!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString3)))
    {
      localTextView1.setText(paramString2);
      localTextView1.setTextColor(apyr.a(-16733441, 1593879295));
      ((ImageView)((View)localObject).findViewById(2131296358)).setImageDrawable(URLDrawable.getDrawable("https://cmshow.gtimg.cn/client/gameCenter/gameCenter_arrow@2x.png"));
      paramString2 = (CheckBox)((View)localObject).findViewById(2131298628);
      TextView localTextView2 = (TextView)((View)localObject).findViewById(2131312273);
      TextView localTextView3 = (TextView)((View)localObject).findViewById(2131312399);
      localTextView3.setTextColor(apyr.a(-16733441, 1593879295));
      ...
      paramString2.setOnCheckedChangeListener(new apwb(this, paramString1));
      localTextView2.setOnClickListener(new apwc(this, paramString4));
      localTextView1.setOnClickListener(new apwd(this, paramString4, paramString3));
      localTextView3.setOnClickListener(new apwe(this, paramString4, paramJSONObject, (String)localObject));
      this.jdField_a_of_type_AndroidAppDialog.show();
      paramString1 = new HashMap();
      yez.a(paramString1, paramString4);
    ...
    for (;;)
    {
      ...
      yez.a(aing.a(), "769", "205710", a().gameAppId, "76905", "1", "160", paramString1);
      return;
      localTextView1.setText(ajjy.a(2131644533));
      break;
      label410:
  ...
  {
    b();
    this.jdField_a_of_type_AndroidWidgetFrameLayout$LayoutParams.topMargin = aciy.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ...
    if (paramBoolean1)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(ajjy.a(2131644517));
      return;
    }
    if (paramBoolean2)
    {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajjy.a(2131644519));
  }
  ...
  public void b()
  {
    if (this.jdField_b_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      ((FrameLayout.LayoutParams)localObject2).leftMargin = aciy.a(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      this.jdField_b_of_type_AndroidWidgetTextView.setText(ajjy.a(2131644520));
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846073);
      ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846073);
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      localObject3 = new LinearLayout.LayoutParams(aciy.a(15.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aciy.a(15.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      localFrameLayout.setLayoutParams(new RecyclerView.LayoutParams(-1, aciy.a(120.0F, this.jdField_a_of_type_AndroidContentContext.getResources())));
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(ajjy.a(2131644510));
      ...
      ((LinearLayout.LayoutParams)localObject3).leftMargin = aciy.a(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      this.jdField_c_of_type_AndroidWidgetTextView.setText(ajjy.a(2131644535));
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.clearAnimation();
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajjy.a(2131644527));
  ...
  {
    bgtf.a().b(this);
    if (this.jdField_a_of_type_Bgso != null) {
      bgsw.b(this.jdField_a_of_type_Bgso);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131644528));
      return false;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
  ...
  {
    if (a(paramInt)) {
      if ((paramViewHolder instanceof apwp)) {
        ((apwp)paramViewHolder).a(this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFeedsItemData$TopCardInfo, this);
      }
    }
    label27:
      ...
      do
      {
        do
        {
          do
          {
            ...
            if ((!(paramViewHolder instanceof apwh)) && (!(paramViewHolder instanceof apwf))) {
              break;
            }
          ...
          if ((localFeedsItemData.type == 1) || (localFeedsItemData.type == 2) || (localFeedsItemData.type == 3))
          {
            ...
            yez.a(aing.a(), "769", "205021", a().gameAppId, "76902", "1", "160", paramViewHolder);
            return;
          }
        } while (localFeedsItemData.type != 4);
        ((apwf)paramViewHolder).a(this, localFeedsItemData, paramInt);
        paramViewHolder = new HashMap();
        yez.a(paramViewHolder, localFeedsItemData.msgId);
        paramViewHolder.put(Integer.valueOf(2), localFeedsItemData.msgId);
        paramViewHolder.put(Integer.valueOf(6), localFeedsItemData.feedId);
        ...
        yez.a(aing.a(), "769", "205021", a().gameAppId, "76902", "1", "160", paramViewHolder);
        return;
      } while (!(paramViewHolder instanceof apxp));
      localFeedsItemData = a(paramInt);
    } while (localFeedsItemData == null);
    ((apxp)paramViewHolder).a(localFeedsItemData);
    paramViewHolder = new HashMap();
    yez.a(paramViewHolder, localFeedsItemData.msgId);
    paramViewHolder.put(Integer.valueOf(2), localFeedsItemData.msgId);
    paramViewHolder.put(Integer.valueOf(6), localFeedsItemData.feedId);
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    if (this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null)
    {
      if (paramInt == this.jdField_a_of_type_Int) {
        return this.jdField_a_of_type_Apwp;
      }
      return new apvz(this, (View)this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null) {
      return new apwa(this, (View)this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (paramInt == 4)
    {
      ...
      ((LinearLayout)localObject1).setPadding(aciy.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, aciy.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      ((TextView)localObject3).setId(2131311534);
      ((TextView)localObject3).setEllipsize(TextUtils.TruncateAt.END);
      Object localObject4 = new RelativeLayout.LayoutParams(-1, aciy.a(45.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((RelativeLayout.LayoutParams)localObject4).setMargins(aciy.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aciy.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aciy.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      ((TextView)localObject4).setId(2131297345);
      ((TextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      ((TextView)localObject4).setMaxWidth(aciy.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      RelativeLayout.LayoutParams localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.setMargins(aciy.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aciy.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, aciy.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams2.addRule(3, 2131311534);
      ((RelativeLayout)localObject2).addView((View)localObject4, localLayoutParams2);
      localObject4 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ((TextView)localObject4).setTextColor(-6052957);
      ((TextView)localObject4).setTextSize(12.0F);
      ((TextView)localObject4).setMaxLines(1);
      ((TextView)localObject4).setId(2131305317);
      ((TextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.leftMargin = aciy.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      localLayoutParams2.addRule(6, 2131297345);
      localLayoutParams2.addRule(1, 2131297345);
      ((RelativeLayout)localObject2).addView((View)localObject4, localLayoutParams2);
      localObject4 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ((TextView)localObject4).setTextColor(-6052957);
      ((TextView)localObject4).setTextSize(10.0F);
      ((TextView)localObject4).setMaxLines(1);
      ((TextView)localObject4).setId(2131301313);
      ((TextView)localObject4).setBackgroundColor(1270796256);
      ((TextView)localObject4).setPadding(aciy.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aciy.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aciy.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aciy.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((TextView)localObject3).setEllipsize(TextUtils.TruncateAt.END);
      localObject3 = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject3).setMargins(0, aciy.a(-1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), aciy.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ((RelativeLayout.LayoutParams)localObject3).addRule(6, 2131297345);
      ...
      ((CornerImageView)localObject2).setId(2131302286);
      localLayoutParams = new LinearLayout.LayoutParams(0, aciy.a(71.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams.weight = 3.0F;
      localLayoutParams.gravity = 16;
      ((LinearLayout)localObject1).addView((View)localObject2, localLayoutParams);
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      localObject1 = new ImageView(this.jdField_a_of_type_AndroidContentContext);
      localLayoutParams1 = new RelativeLayout.LayoutParams(-1, aciy.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((ImageView)localObject1).setImageDrawable(new ColorDrawable(-263173));
      ((ImageView)localObject1).setId(2131299701);
      ((ImageView)localObject1).setPadding(aciy.a(25.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, 0, 0);
      localLayoutParams1.rightMargin = aciy.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      return new apwf(paramViewGroup);
    }
    if ((paramInt == 5) || (paramInt == 7) || (paramInt == 6)) {
      return apxu.a(this.jdField_a_of_type_AndroidContentContext, paramInt, paramViewGroup);
    }
    return new apwh(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131493517, paramViewGroup, false));
  }
  
  public void onViewDetachedFromWindow(RecyclerView.ViewHolder paramViewHolder)
  {
    super.onViewDetachedFromWindow(paramViewHolder);
    if ((paramViewHolder instanceof apwh))
    {
      paramViewHolder = (apwh)paramViewHolder;
      if ((paramViewHolder.a != null) && (apyl.a().a() == paramViewHolder.a))
      {
        paramViewHolder.a.i();
        paramViewHolder.a.l();
      }
