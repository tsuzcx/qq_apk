...
public class awau
{
  ...
  public awau(QQAppInterface paramQQAppInterface, int paramInt, String paramString, SharedPreferences paramSharedPreferences, awap paramawap)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_AndroidContentSharedPreferences = paramSharedPreferences;
    this.jdField_a_of_type_Awap = paramawap;
  ...
  public void a(int paramInt1, String paramString, long paramLong, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Awap.putLong(a(paramInt1, paramString), l1);
      return;
      l1 = paramLong;
      if (paramInt2 == 2)
      {
