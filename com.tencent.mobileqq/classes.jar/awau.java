  ...
  implements awbi
{
  ...
  {
    Intent localIntent = new Intent(awax.a(awat.a(this.a)));
    ...
    case 5: 
      for (;;)
      {
        awat.a(this.a).sendBroadcast(localIntent);
        return;
        ...
        if (awax.a(awat.a(this.a)))
        {
          awbj.a("2691709");
        }
        else if (awax.b(awat.a(this.a)))
        {
          awbj.a("2597857");
          continue;
          ...
          else if (awax.b(awat.a(this.a)))
          {
            awbj.a("2597858");
            continue;
            if ("download".equals(awat.b(this.a)))
            {
              ...
              awat.a(this.a, localInstalledPlugin, bool, l);
            }
            if (awax.a(awat.a(this.a)))
            {
              awbj.a("2691703");
