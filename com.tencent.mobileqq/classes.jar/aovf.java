...
public class aovf
{
  ...
  public aovf(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    return adak.a(paramMessageRecord1.frienduin, paramMessageRecord1.istroop).equals(adak.a(paramMessageRecord2.frienduin, paramMessageRecord2.istroop));
  }
  ...
  public int a(boolean paramBoolean)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      for (int i = 0; localIterator.hasNext(); i = localMessage.counter + i)
      {
        ...
        if ((localMessage.istroop == 1037) || (localMessage.istroop == 1044) || (localMessage.istroop == 1045) || ((paramBoolean) && (blhw.a(localMessage)))) {
          break label20;
        }
      }
      return i;
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("notification", 2, new Object[] { "revokeNotificationMsg, isBackground: ", Boolean.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundPause) });
      }
      return;
    }
    QQMessageFacade.Message localMessage;
    ...
    for (;;)
    {
      ...
      if (i >= 0)
      {
        localaovg = (aovg)localMessage.msgInfoList.get(i);
        if ((localaovg.jdField_a_of_type_Int == 3000) || (localaovg.jdField_a_of_type_Int == 1))
        {
          if (localaovg.c != paramMessageRecord.shmsgseq) {
            break label486;
          }
          j = i;
        }
      ...
      for (;;)
      {
        if (j == -1)
        {
          ...
          return;
          if (localaovg.b != paramMessageRecord.msgUid) {
            break;
          }
          j = i;
          if (localaovg.c != paramMessageRecord.shmsgseq) {
        ...
        else
        {
          if ((j == k - 1) && (k > 1))
          {
            paramMessageRecord = (aovg)localMessage.msgInfoList.get(k - 2);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if (((paramInt == ((QQMessageFacade.Message)localObject2).istroop) || ((adak.d(paramInt)) && (adak.d(((QQMessageFacade.Message)localObject2).istroop)))) && (((QQMessageFacade.Message)localObject2).frienduin.equals(paramString)))
        {
          ...
          if (bool1)
          {
            ...
            if ((!blhw.a(paramInt)) || (!blhw.a(paramString))) {
              break label309;
            }
            blhw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(paramString);
          }
          return;
        }
      }
  ...
  public int b(boolean paramBoolean)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      {
        QQMessageFacade.Message localMessage = (QQMessageFacade.Message)localIterator.next();
        if ((localMessage.istroop != 1008) && (localMessage.istroop != 1037) && (localMessage.istroop != 1044) && (localMessage.istroop != 1045) && ((!paramBoolean) || (!blhw.a(localMessage))))
        {
          if (7000 != localMessage.istroop) {
            break label166;
          }
          bdxc localbdxc = (bdxc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(61);
          if (localbdxc == null) {
            break label157;
          }
          j = localbdxc.b(localMessage.frienduin);
          break label159;
        }
      }
      return i;
  ...
  public void b(QQMessageFacade.Message paramMessage)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      if (localObject != null)
      {
        ...
        localObject = new aovg(paramMessage.frienduin, paramMessage.istroop, paramMessage.uniseq, paramMessage.msgUid, paramMessage.shmsgseq);
