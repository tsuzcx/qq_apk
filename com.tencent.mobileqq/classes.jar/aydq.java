...
public class aydq
  extends Dialog
  implements View.OnClickListener, anhs, bbjw
{
  protected int a;
  protected long a;
  protected Handler a;
  ...
  public aydq(BaseActivity paramBaseActivity, Bundle paramBundle)
  {
  ...
  protected void a()
  {
    ...
    if (!TextUtils.isEmpty(str)) {
      azho.c.put(this.jdField_a_of_type_JavaLangString, str);
    }
  }
  ...
  public void a(Activity paramActivity)
  {
    ...
    paramActivity = LayoutInflater.from(paramActivity).inflate(2131494137, null);
  ...
  protected void a(Bundle paramBundle)
  {
    ...
    //   14: putfield 187	aydq:c	Ljava/lang/String;
    ...
    //   57: putfield 196	aydq:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   60: aload_0
    //   61: aload_0
    //   62: getfield 196	aydq:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   65: ldc 198
    //   67: invokevirtual 201	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   70: putfield 72	aydq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   73: aload_0
    //   74: aload_0
    //   75: getfield 196	aydq:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   78: ldc 203
    //   80: invokevirtual 207	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   83: putfield 209	aydq:jdField_a_of_type_Int	I
    //   86: aload_0
    //   87: aload_0
    //   88: getfield 196	aydq:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   91: ldc 211
    //   93: invokevirtual 207	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   96: putfield 213	aydq:jdField_b_of_type_Int	I
    //   99: aload_0
    //   100: aload_0
    //   101: getfield 196	aydq:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   104: ldc 215
    //   106: invokevirtual 201	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   109: putfield 217	aydq:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   112: aload_0
    //   113: new 219	java/util/ArrayList
    //   116: dup
    //   117: invokespecial 220	java/util/ArrayList:<init>	()V
    //   120: putfield 222	aydq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   123: aload_0
    //   124: getfield 196	aydq:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   127: ldc 224
    ...
    //   135: astore_1
    //   136: aload_0
    //   137: getfield 222	aydq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   140: aload_1
    ...
    //   152: dup
    //   153: aload_0
    //   154: invokespecial 242	aydr:<init>	(Laydq;)V
    //   157: putfield 244	aydq:jdField_a_of_type_Aydr	Laydr;
    ...
    //   169: astore_1
    //   170: aload_0
    //   171: getfield 40	aydq:jdField_a_of_type_ComTencentMobileqqAppBaseActivity	Lcom/tencent/mobileqq/app/BaseActivity;
    //   174: aload_0
    //   175: getfield 244	aydq:jdField_a_of_type_Aydr	Laydr;
    //   178: aload_1
    ...
    //   184: astore_1
    //   185: aload_0
    //   186: invokevirtual 258	aydq:dismiss	()V
    //   189: return
    //   190: astore_1
    //   191: aload_0
    //   192: invokevirtual 258	aydq:dismiss	()V
    //   195: return
    //   196: astore_1
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetInputMethodRelativeLayout = ((InputMethodRelativeLayout)paramView.findViewById(2131309736));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131299981));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131302566));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131310076));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramView.findViewById(2131303278));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetButton.setSelected(true);
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(true);
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    paramView.findViewById(2131311857).setOnClickListener(this);
  ...
  {
    paramanht.a(null, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_AndroidWidgetEditText, null);
  }
  ...
  protected void a(String paramString)
  {
    try
    {
      aqrr.a("qbrowserCommentOnSend", new JSONObject(TroopBarPublishUtils.a(paramString, null, null)), this.jdField_a_of_type_JavaUtilArrayList, null);
      return;
    }
  ...
  {
    Object localObject;
    if ((!TextUtils.isEmpty(paramString1)) && ((this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity instanceof bazk)))
    {
      localObject = ((bazk)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).b();
      if (localObject != null)
      {
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramBoolean)
      {
        aqrr.a("qbrowserCommentOnCreate", null, this.jdField_a_of_type_JavaUtilArrayList, null);
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131630830));
        return;
      }
  ...
  protected boolean a()
  {
    String str = (String)azho.c.get(this.jdField_a_of_type_JavaLangString);
    azho.c.clear();
    if (!TextUtils.isEmpty(str))
    {
  ...
  public void c()
  {
    ...
    for (int i = str.length();; i = 0)
    {
      if (i == 0)
      {
        bbmy.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2131630848, 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      if (i < this.jdField_b_of_type_Int)
      {
        bbmy.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131630846, new Object[] { Integer.valueOf(this.jdField_b_of_type_Int) }), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      if (i > this.jdField_a_of_type_Int)
      {
        bbmy.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131630847, new Object[] { Integer.valueOf(this.jdField_a_of_type_Int) }), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      if (!mpl.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity))
      {
        bbmy.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2131628882, 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      a(str);
      return;
  ...
  public void dismiss()
  {
    if (this.jdField_a_of_type_Aydr != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.unregisterReceiver(this.jdField_a_of_type_Aydr);
      this.jdField_a_of_type_Aydr = null;
    }
    if (this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemAndEmojiEmoticonPanel != null) {
    ...
    aqrr.a("qbrowserCommentOnClose", null, this.jdField_a_of_type_JavaUtilArrayList, null);
    super.dismiss();
  }
