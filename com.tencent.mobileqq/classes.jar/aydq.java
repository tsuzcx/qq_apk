  ...
  extends SSLSocketFactory
{
  ...
  public aydq(SSLSocketFactory paramSSLSocketFactory)
  {
  ...
  private Socket a(Socket paramSocket)
  {
    ...
    {
      paramSocket = new aydt(this, (SSLSocket)paramSocket, null);
      ((aydt)paramSocket).setEnabledProtocols(new String[] { "TLSv1.1", "TLSv1.2" });
      return paramSocket;
    }
    return paramSocket;
  }
