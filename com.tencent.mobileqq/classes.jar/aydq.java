...
{
  private static Comparator<aydj> jdField_a_of_type_JavaUtilComparator = new aydt();
  private static final ThreadPoolExecutor jdField_a_of_type_JavaUtilConcurrentThreadPoolExecutor = new ThreadPoolExecutor(0, 3, 5L, TimeUnit.SECONDS, new LinkedBlockingQueue(128), new aydr());
  private static Comparator<aydj> jdField_b_of_type_JavaUtilComparator = new aydu();
  private final int jdField_a_of_type_Int = 300;
  private aydv jdField_a_of_type_Aydv;
  private String jdField_a_of_type_JavaLangString;
  private List<? extends aydj> jdField_a_of_type_JavaUtilList;
  private ExecutorService jdField_a_of_type_JavaUtilConcurrentExecutorService;
  boolean jdField_a_of_type_Boolean = false;
  private String jdField_b_of_type_JavaLangString;
  private List<Future<List<aydj>>> jdField_b_of_type_JavaUtilList;
  private List<aydj> c;
  
  public aydq(String paramString1, String paramString2, List<? extends aydj> paramList, aydv paramaydv)
  {
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_b_of_type_JavaLangString = paramString2;
    this.jdField_a_of_type_JavaUtilList = paramList;
    this.jdField_a_of_type_Aydv = paramaydv;
    this.jdField_a_of_type_JavaUtilConcurrentExecutorService = Executors.newFixedThreadPool(20);
    this.jdField_b_of_type_JavaUtilList = new ArrayList();
    this.c = new ArrayList();
  }
  
  private void a(List<aydj> paramList, String paramString)
  {
    ...
    for (int i = 20;; i = paramList.size())
    {
      ...
      while (j < i)
      {
        aydi localaydi = (aydi)paramList.get(j);
        if (QLog.isColorLevel()) {
          QLog.d("SearchTask", 2, "printSearchResultData " + paramString + "matchDegree : " + localaydi.c() + " message time : " + localaydi.Y);
        }
        j += 1;
      }
    }
      ...
      for (;;)
      {
        try
        {
          ...
          if ((i >= this.jdField_b_of_type_JavaUtilList.size()) || (isCancelled()))
          {
            ...
            break label91;
            label178:
            paramVarArgs = this.jdField_a_of_type_JavaUtilConcurrentExecutorService.submit(new ayds(this, n, j));
        ...
        catch (InterruptedException paramVarArgs)
        {
          ...
          return null;
          if (((aydj)this.c.get(j)).c() >= localaydj.c()) {
            continue;
          }
          this.c.set(j, localaydj);
          continue;
        }
        ...
        {
          localaydj = (aydj)localIterator.next();
          if (!isCancelled())
          {
            j = this.c.indexOf(localaydj);
            if (-1 != j) {
              continue;
            }
            this.c.add(localaydj);
          }
        }
      }
    }
  ...
  protected void a(Void paramVoid)
  {
    ...
    while (this.jdField_a_of_type_Aydv == null) {
      return;
    }
    int i = 1;
    ...
    this.jdField_a_of_type_Aydv.a(i, this.c);
    this.jdField_a_of_type_JavaUtilConcurrentExecutorService.shutdown();
  }
  
  protected void a(List<aydj> paramList)
  {
