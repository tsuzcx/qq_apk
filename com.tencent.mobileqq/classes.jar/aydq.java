...
public class aydq
{
  ...
  public static final String[] b = { "XG预下载配额余量", "XG当前消耗流量", "XG流量总消耗", "XG预下载总数", "XG预下载命中数", "XG预下载未命中数", "XG手动看图数", "XG消耗量余量", "WIFI预下载总数", "WIFI预下载命中数", "WIFI预下载未命中数", "WIFI手动看图数", "XG是否超过上限", amtj.a(2131707267) };
  ...
  public static int a(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          bool = avnu.a().a(paramQQAppInterface, paramString);
          if (paramInt != 3000) {
            break label69;
          }
          j = 1;
  ...
  public static long a(QQAppInterface paramQQAppInterface, String paramString, long paramLong)
  {
    ...
    //   5: lreturn
    //   6: aload_0
    //   7: getstatic 187	mqq/manager/ServerConfigManager$ConfigType:common	Lmqq/manager/ServerConfigManager$ConfigType;
    //   10: aload_1
    //   11: invokevirtual 193	com/tencent/mobileqq/app/QQAppInterface:getServerConfigValue	(Lmqq/manager/ServerConfigManager$ConfigType;Ljava/lang/String;)Ljava/lang/String;
    //   14: astore_0
    //   15: aload_0
    //   16: ifnull +70 -> 86
    //   19: aload_0
    //   20: invokestatic 199	java/lang/Long:valueOf	(Ljava/lang/String;)Ljava/lang/Long;
    //   23: astore_0
    //   24: aload_0
    //   25: invokevirtual 203	java/lang/Long:longValue	()J
    //   28: lstore 4
    //   30: aload_1
    //   31: aload_0
    //   32: invokevirtual 203	java/lang/Long:longValue	()J
    //   35: invokestatic 206	aydq:a	(Ljava/lang/String;J)V
    //   38: ldc 208
    //   40: ldc 210
    //   42: new 212	java/lang/StringBuilder
    //   45: dup
    //   46: invokespecial 215	java/lang/StringBuilder:<init>	()V
    //   49: ldc 217
    ...
    //   58: ldc 223
    //   60: invokevirtual 221	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   63: lload 4
    //   65: invokevirtual 226	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   68: ldc 228
    //   70: invokevirtual 221	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   73: lload_2
    //   74: invokevirtual 226	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   77: invokevirtual 232	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   80: invokestatic 237	ayde:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   83: lload 4
    //   85: lreturn
    //   86: aload_1
    //   87: lload_2
    //   88: invokestatic 206	aydq:a	(Ljava/lang/String;J)V
    //   91: lload_2
    //   92: lstore 4
    //   94: goto -56 -> 38
    //   97: astore_0
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForPic paramMessageForPic)
  {
    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          {
            return;
            ayde.a("PIC_TAG_PRELOAD", "updateMsg", "uniseq:" + paramMessageForPic.uniseq + ",network:" + paramMessageForPic.preDownNetworkType + "state:" + paramMessageForPic.preDownState);
            paramMessageForPic.serial();
            localObject = paramQQAppInterface.getMessageFacade().queryMsgItemByUniseq(paramMessageForPic.frienduin, paramMessageForPic.istroop, paramMessageForPic.uniseq);
        ...
        localbcjc.a = paramMessageForPic;
        paramQQAppInterface.getMessageFacade().updateMsgContentByUniseq(paramMessageForPic.frienduin, paramMessageForPic.istroop, paramMessageForPic.uniseq, ((MessageForStructing)localObject).structingMsg.getBytes());
        return;
        paramQQAppInterface.getMessageFacade().updateMsgContentByUniseq(paramMessageForPic.frienduin, paramMessageForPic.istroop, paramMessageForPic.uniseq, paramMessageForPic.msgData);
        return;
    ...
    paramQQAppInterface.getMessageFacade().updateMsgContentByUniseq(paramMessageForPic.frienduin, paramMessageForPic.istroop, paramMessageForPic.uniseq, (byte[])localObject);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, TransferRequest paramTransferRequest)
  {
    if (paramTransferRequest == null) {}
    while ((!(paramTransferRequest.mRec instanceof MessageForPic)) || (paramTransferRequest.mFileType == 65537)) {
      return;
    }
    MessageForPic localMessageForPic = (MessageForPic)paramTransferRequest.mRec;
    ayde.a("PIC_TAG_PRELOAD", "updateDownState", "Before update, networkType:" + localMessageForPic.preDownNetworkType + ",state:" + localMessageForPic.preDownState + ",uniseq:" + localMessageForPic.uniseq);
    if (paramTransferRequest.mDownMode == 1) {
      localMessageForPic.preDownState = 1;
    }
    for (;;)
    {
      ayde.a("PIC_TAG_PRELOAD", "updateDownState", "After update, networkType:" + localMessageForPic.preDownNetworkType + ",state:" + localMessageForPic.preDownState + ",uniseq:" + localMessageForPic.uniseq);
      a(paramQQAppInterface, localMessageForPic);
      return;
      if (paramTransferRequest.mDownMode == 3) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, MessageForPic paramMessageForPic)
  {
    ...
    ayde.a("PIC_TAG_PRELOAD", "updateDownState4SD", "networkType:" + paramMessageForPic.preDownNetworkType + ",state:" + paramMessageForPic.preDownState + ",uniseq:" + paramMessageForPic.uniseq);
