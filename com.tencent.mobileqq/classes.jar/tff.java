  ...
  implements ssi
{
  ...
  public tff(int paramInt, String paramString)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_d_of_type_Boolean = true;
  ...
  public long a(String paramString)
  {
    try
    {
      ...
      if (arrayOfObject != null)
      {
        ...
        if (m < n)
        {
          tfx localtfx = (tfx)arrayOfObject[m];
          if (TextUtils.equals(paramString, localtfx.jdField_a_of_type_JavaLangString)) {
            return localtfx.jdField_b_of_type_Long;
          }
        }
      }
    }
    catch (Exception localException)
    {
      ...
      {
        int m;
        ved.c("Q.qqstory.msgTab.nodeList.MsgTabNodeInfo", "getRecommendIdByVid:%s", localException);
  ...
  public MsgTabNodeEntity a()
  {
    ...
    while (localIterator.hasNext()) {
      localJSONArray.put(((tfx)localIterator.next()).a());
    }
    ...
    if (this.jdField_b_of_type_JavaUtilList != null)
    {
      ...
      while (localIterator.hasNext()) {
        localJSONArray.put(((tso)localIterator.next()).a());
      }
  ...
  public void a(MsgTabNodeEntity paramMsgTabNodeEntity)
  {
    ...
    try
    {
      ...
      while (m < i1)
      {
        ...
        localObject = new tfx();
        ((tfx)localObject).a(localJSONObject);
        this.jdField_a_of_type_JavaUtilList.add(localObject);
        if (!((tfx)localObject).jdField_a_of_type_Boolean) {
    ...
    {
      ved.c("Q.qqstory.msgTab.nodeList.MsgTabNodeInfo", "convertFrom(entity) errors", localJSONException1);
      ...
      if ((!TextUtils.isEmpty(paramMsgTabNodeEntity.localSuccessVideoList)) && (!paramMsgTabNodeEntity.localSuccessVideoList.equals("null"))) {
        try
        {
          ...
          while (m < i1)
          {
            ...
            localObject = new tso();
            ((tso)localObject).a(localJSONObject);
  ...
  public void a(qqstory_service.MsgTabNodeInfo paramMsgTabNodeInfo)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      tfx localtfx = new tfx();
      localtfx.a(localMsgTabNodeVideoInfo, localArrayDeque);
    ...
    for (int m = 0;; m = 1)
    {
      ...
      if (paramMsgTabNodeInfo.redpoint.has())
      {
        ...
        ved.a("Q.qqstory.msgTab.nodeList.MsgTabNodeInfo", "MsgTabNodeInfo convertFrom, unionId:%s, uid:%s, redPoint:%s", this.jdField_a_of_type_JavaLangString, Long.valueOf(this.jdField_b_of_type_Long), Boolean.valueOf(this.jdField_c_of_type_Boolean));
      }
  ...
  {
    this.jdField_d_of_type_Int = paramtff.jdField_d_of_type_Int;
    this.jdField_b_of_type_Boolean = paramtff.jdField_b_of_type_Boolean;
    this.h = paramtff.h;
  }
  ...
  public boolean a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((TextUtils.isEmpty(localtfx.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(localtfx.jdField_b_of_type_JavaLangString))) {
        return false;
      }
    }
  ...
  {
    if ((paramObject instanceof tff))
    {
      paramObject = (tff)paramObject;
