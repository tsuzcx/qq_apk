...
public class aisd
{
  ...
  public boolean b;
  public int c;
  public WeakReference<aiii> c;
  private AtomicBoolean c;
  public int d;
  private WeakReference<aiso> jdField_d_of_type_JavaLangRefWeakReference;
  private AtomicBoolean jdField_d_of_type_JavaUtilConcurrentAtomicAtomicBoolean;
  public int e = 0;
  private int f;
  
  public aisd(QQAppInterface paramQQAppInterface)
  {
  ...
  public aiii a()
  {
    ...
    return (aiii)this.jdField_c_of_type_JavaLangRefWeakReference.get();
  }
  ...
  public aiso a()
  {
    ...
    return (aiso)this.jdField_d_of_type_JavaLangRefWeakReference.get();
  }
  ...
  public void a()
  {
    this.jdField_b_of_type_Int = aifg.a(a());
  }
  ...
  public void a(int paramInt)
  {
    aiii localaiii = a();
    if (localaiii != null) {
      localaiii.setBubbleType(paramInt);
    }
  }
  ...
  {
    this.jdField_c_of_type_JavaLangRefWeakReference = new WeakReference(paramaiii);
  }
  
  public void a(aijy paramaijy)
  {
    this.jdField_a_of_type_Aijy = paramaijy;
  }
  
  public void a(aise paramaise)
  {
  ...
  {
    this.jdField_d_of_type_JavaLangRefWeakReference = new WeakReference(paramaiso);
  }
  ...
  protected boolean b()
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        aixo.a(this.f, 10, 104, new Object[] { "cmshow should hide from:", str });
      }
  ...
  public boolean f()
  {
    if (this.jdField_d_of_type_JavaUtilConcurrentAtomicAtomicBoolean == null)
    {
      ...
      this.jdField_d_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(aifg.d());
    }
