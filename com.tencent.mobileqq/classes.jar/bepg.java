...
public class bepg
{
  private static bepg a;
  private static final HashMap<String, Integer> b = new HashMap();
  protected HashMap<String, beph> a;
  protected JSONArray a;
  protected JSONObject a;
  
  static
  {
    b.put("10009", Integer.valueOf(2130843639));
    b.put("10010", Integer.valueOf(2130843640));
    b.put("10011", Integer.valueOf(2130843641));
    b.put("24", Integer.valueOf(2130843642));
    b.put("25", Integer.valueOf(2130843643));
    b.put("26", Integer.valueOf(2130843644));
    b.put("27", Integer.valueOf(2130843645));
    b.put("28", Integer.valueOf(2130843646));
    b.put("29", Integer.valueOf(2130843647));
    b.put("30", Integer.valueOf(2130843648));
    b.put("31", Integer.valueOf(2130843649));
    b.put("32", Integer.valueOf(2130843650));
    b.put("20001", Integer.valueOf(2130843559));
    b.put("20002", Integer.valueOf(2130843560));
    b.put("20003", Integer.valueOf(2130846924));
  }
  ...
  public static bepg a()
  {
    if (jdField_a_of_type_Bepg == null) {}
    try
    {
      if (jdField_a_of_type_Bepg == null) {
        jdField_a_of_type_Bepg = new bepg();
      }
      return jdField_a_of_type_Bepg;
    }
    finally {}
  }
  
  public beph a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject2 = (beph)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
        if ((paramBoolean) && ((((beph)localObject2).jdField_a_of_type_JavaUtilArrayList == null) || (((beph)localObject2).jdField_a_of_type_JavaUtilArrayList.isEmpty()))) {
          break;
        }
        return localObject2;
      }
      Object localObject2 = this.jdField_a_of_type_OrgJsonJSONObject.optJSONArray(paramString);
      beph localbeph = new beph();
      localbeph.a(paramString);
      localbeph.d = ((String)localObject1);
      localbeph.jdField_b_of_type_Int = i;
      localbeph.jdField_b_of_type_JavaLangString = ((JSONArray)localObject2).optString(0);
      int j = ((JSONArray)localObject2).length();
      if (j > 1)
      {
        localbeph.jdField_a_of_type_Boolean = true;
        if (paramBoolean)
        {
          localbeph.jdField_a_of_type_JavaUtilArrayList = new ArrayList(j);
          ...
          if (i < j)
          {
            ...
            for (;;)
            {
              i += 1;
              break;
              localObject3 = new beph((String)localObject3, localJSONArray.optString(0));
              ((beph)localObject3).d = paramString;
              localbeph.jdField_a_of_type_JavaUtilArrayList.add(localObject3);
              if (i <= 2)
              {
                if (i != 1) {
                  ((StringBuilder)localObject1).append("、");
                }
                ((StringBuilder)localObject1).append(((beph)localObject3).jdField_b_of_type_JavaLangString);
              }
            }
          }
          localbeph.c = ((StringBuilder)localObject1).toString();
        }
      }
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localbeph);
      return localbeph;
      localObject1 = null;
    }
  }
  ...
  public ArrayList<beph> a()
  {
    ...
    while (i < k)
    {
      ...
      beph localbeph1 = new beph();
      localbeph1.jdField_b_of_type_Int = 2;
      localbeph1.jdField_b_of_type_JavaLangString = ((JSONObject)localObject).optString("title");
      localArrayList.add(localbeph1);
      localbeph1.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
      localObject = ((JSONObject)localObject).optJSONArray("cates");
      int m = ((JSONArray)localObject).length();
      int j = 0;
      if (j < m)
      {
        beph localbeph2 = a(((JSONArray)localObject).optString(j), true);
        if (localbeph2 == null) {}
        for (;;)
        {
          j += 1;
          break;
          localbeph1.jdField_a_of_type_JavaUtilArrayList.add(localbeph2);
        }
      }
      i += 1;
    }
