...
{
  public static int a;
  static amag jdField_a_of_type_Amag = new arir();
  private final long jdField_a_of_type_Long = 1800000L;
  private aabl jdField_a_of_type_Aabl;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new ariw(this);
  public arje a;
  arjh jdField_a_of_type_Arjh;
  arki jdField_a_of_type_Arki = new aris(this);
  ...
  public arik(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedLog = new arix(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedChannel = new ariy(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedLoading = new ariz(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedReport = new arja(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedDownloader = new arjb(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedRecord = new arim(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyQqshareCustomizedShareForQQ = new arin(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyQQKandianInterface = new ario(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedWebView = new arip(this);
    this.jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceCustomizedDns = new ariq(this);
    try
    {
      ...
      e();
      f();
      this.jdField_a_of_type_Arje = new arje(paramQQAppInterface);
  ...
  private static void a(long paramLong, String paramString1, String paramString2)
  {
    ...
    for (str = "https://now.qq.com/qq/play.html?_bid=2374&_wv=16778245&from=50320";; str = "https://now.qq.com/h5/index.html?_bid=2336&_wv=16778245&from=50320&roomid=" + paramLong)
    {
      ...
      arjj.a().a().a("", String.valueOf(paramLong), paramString2, paramString1);
      ...
      acqv.a(BaseApplicationImpl.getContext(), paramString2, paramString1);
      return;
    }
  }
  ...
  {
    return bbfr.a(BaseApplicationImpl.getContext(), "com.tencent.now");
  }
  ...
  {
    jdField_a_of_type_Int = amau.a().a(jdField_a_of_type_Amag);
  }
  
  private void e()
  {
    this.jdField_a_of_type_Arjh = new arjh();
    InitData localInitData = new InitData();
    localInitData.mAppID = "2";
    localInitData.mSourceVersion = String.valueOf(aney.a(BaseApplicationImpl.getContext()));
    localInitData.mSourceUid = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
    NowLive.setShadowImp(this.jdField_a_of_type_Arjh);
  ...
  public void a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    long l2 = ((Long)atbi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "key_nearby_now_qq_connect_auth_time", Long.valueOf(0L))).longValue();
    QLog.d("XProxy|NowProxy", 1, "now qq connect auth time diff = " + (l1 - l2) / 1000L);
    if ((this.jdField_a_of_type_Aabl == null) || (l1 - l2 > 1728000000L))
    {
      atbi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "key_nearby_now_qq_connect_auth_time", Long.valueOf(l1));
      aabq.a();
      this.jdField_a_of_type_Aabl = aabq.a(paramActivity, 6, "101490787");
    }
    paramActivity = new WeakReference(paramActivity);
    this.jdField_a_of_type_Aabl.a("loginSilent", null, new ariv(this, paramActivity, paramBundle));
  }
  ...
  public void a(Bundle paramBundle, arjc paramarjc)
  {
    if (AppSetting.b)
    {
      paramarjc = ajya.a(2131689492);
      bcql.a(BaseApplicationImpl.getContext(), 1, paramarjc, 0).a();
      paramBundle = arie.b(paramBundle);
      arjj.a().a().a(paramBundle);
      return;
    }
    paramBundle.putInt("jumpCallbackId", jdField_a_of_type_Int);
    paramarjc = new Intent();
    paramarjc.putExtras(paramBundle);
    abtq.a(paramarjc, PublicTransFragmentActivity.class, NowQQConnectFragment.class);
  }
  ...
  public void a(NewTogetherRoomMessageData paramNewTogetherRoomMessageData, Bundle paramBundle, arkh paramarkh)
  {
    ...
    localBundle.putString("group_name", bbcz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramNewTogetherRoomMessageData.jdField_a_of_type_JavaLangString, false));
    ...
    a(localBundle, new aril(this, paramarkh));
  }
  ...
  public void b(Bundle paramBundle, arjc paramarjc)
  {
    paramBundle.putInt("ctrl_cmd", 1);
    NowLive.closeRoom(paramBundle, new arit(this, paramarjc));
  }
  
  public void b(NewTogetherRoomMessageData paramNewTogetherRoomMessageData, Bundle paramBundle, arkh paramarkh)
  {
    b(a(paramBundle, paramNewTogetherRoomMessageData), new ariu(this, paramarkh));
  }
  
  public void c()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
      aria.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    }
  }
  ...
  public void onDestroy()
  {
    ...
    arjj.a();
    ((arlc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(338)).a(1);
    this.jdField_a_of_type_Arje.b();
