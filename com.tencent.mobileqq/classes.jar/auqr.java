  ...
  extends auqq
{
  ...
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new auqs(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = auqr.class.getSimpleName();
  }
  
  public auqr(RegisterNewBaseActivity paramRegisterNewBaseActivity)
  {
  ...
  public void a(String paramString)
  {
    try
    {
      ...
      if (atok.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.app, this.c.getBytes(), paramString.getBytes(), this.d, this.jdField_a_of_type_MqqObserverWtloginObserver) != 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.c();
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131651340, 1);
      }
      return;
    }
