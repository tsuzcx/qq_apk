  ...
  extends WebViewPlugin
{
  ...
  private bhpb jdField_a_of_type_Bhpb;
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      if ((localActivity instanceof AppActivity))
      {
        if (((AppActivity)localActivity).checkSelfPermission("android.permission.CALL_PHONE") != 0) {
          ((AppActivity)localActivity).requestPermissions(new abfr(this), 1, new String[] { "android.permission.CALL_PHONE" });
        }
      }
      else {
        return;
  ...
  private void c()
  {
    bdll.b(null, "CliOper", "", "", "0X8004B43", "0X8004B43", 0, 0, "", "", "", "");
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      if ((localActivity instanceof AppActivity))
      {
        if (((AppActivity)localActivity).checkSelfPermission("android.permission.SEND_SMS") != 0) {
          ((AppActivity)localActivity).requestPermissions(new abfs(this), 1, new String[] { "android.permission.SEND_SMS" });
        }
      }
      else {
        return;
  ...
  private void e()
  {
    bdll.b(null, "CliOper", "", "", "0X8004B44", "0X8004B44", 0, 0, "", "", "", "");
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      if ((localActivity instanceof AppActivity))
      {
        if (((AppActivity)localActivity).checkSelfPermission("android.permission.WRITE_CONTACTS") != 0) {
          ((AppActivity)localActivity).requestPermissions(new abft(this), 1, new String[] { "android.permission.WRITE_CONTACTS" });
        }
      }
      else {
        return;
  ...
  {
    Activity localActivity = this.mRuntime.a();
    if (this.jdField_a_of_type_Bhpb == null)
    {
      bhuk localbhuk = new bhuk();
      localbhuk.a(1, localActivity.getString(2131698551));
      localbhuk.a(2, localActivity.getString(2131698552));
      localbhuk.a(String.format(localActivity.getString(2131698550), new Object[] { this.jdField_a_of_type_JavaLangString }));
      this.jdField_a_of_type_Bhpb = bhlq.a(localActivity, localbhuk, new abfu(this));
      if (this.jdField_a_of_type_Bhpb != null) {}
    }
    else
    {
      this.jdField_a_of_type_Bhpb.setTitle(String.format(localActivity.getString(2131698550), new Object[] { this.jdField_a_of_type_JavaLangString }));
    }
    this.jdField_a_of_type_Bhpb.show();
  }
  ...
  private void i()
  {
    bdll.b(null, "CliOper", "", "", "0X8004B45", "0X8004B45", 0, 0, "", "", "", "");
    a("android.intent.action.INSERT", "vnd.android.cursor.dir/contact");
  }
  
  private void j()
  {
    bdll.b(null, "CliOper", "", "", "0X8004B46", "0X8004B46", 0, 0, "", "", "", "");
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Blir = blir.a(this.mRuntime.a());
      this.jdField_a_of_type_Blir.c(String.format("%s%s", new Object[] { this.mRuntime.a().getString(2131691440), this.jdField_a_of_type_JavaLangString }));
      this.jdField_a_of_type_Blir.b(2131698553);
      this.jdField_a_of_type_Blir.b(2131698550);
      this.jdField_a_of_type_Blir.b(2131691140);
      this.jdField_a_of_type_Blir.c(2131690580);
      this.jdField_a_of_type_Blir.a(new abfq(this));
    }
    for (;;)
    {
      this.jdField_a_of_type_Blir.show();
      return;
      this.jdField_a_of_type_Blir.a(0, String.format("%s%s", new Object[] { this.mRuntime.a().getString(2131691440), this.jdField_a_of_type_JavaLangString }));
    }
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (!TextUtils.isEmpty(paramJsBridgeListener))
    {
      ...
      if (((this.jdField_a_of_type_Blir == null) || (!this.jdField_a_of_type_Blir.isShowing())) && ((this.jdField_a_of_type_Bhpb == null) || (!this.jdField_a_of_type_Bhpb.isShowing())))
      {
