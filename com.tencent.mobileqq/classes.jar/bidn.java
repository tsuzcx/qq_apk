...
public class bidn
{
  ...
  public bidn(QQAppInterface paramQQAppInterface, EntityManager paramEntityManager)
  {
  ...
  private long a()
  {
    if (this.jdField_a_of_type_Long == 0L) {
      this.jdField_a_of_type_Long = biik.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "troop_keyword_last_pull_timestamp", 0L);
    }
    return this.jdField_a_of_type_Long;
  }
  
  public static bidn a(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong)
  {
    ...
    biik.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "troop_keyword_last_pull_timestamp", paramLong);
  }
  ...
  public static boolean a()
  {
    ...
    if (biik.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "troop_keyword_open", true)) {}
    for (int i = 1;; i = 0)
    {
  ...
  public bidm a(String paramString)
  {
    bidm localbidm = new bidm();
    if ((TextUtils.isEmpty(paramString)) || (!a()))
    {
      localbidm.jdField_a_of_type_JavaLangString = "";
      localbidm.jdField_a_of_type_Boolean = false;
      localbidm.c = 1;
    ...
    {
      localObject1 = ((Resources)localObject1).getString(2131692677);
      if ((!biik.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "troop_keyword_guide_clicked", false)) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.isEmpty()))
      {
        bool = true;
        if (!bool) {
          break label242;
    ...
    for (;;)
    {
      ...
      localbidm.jdField_a_of_type_JavaLangString = ((String)localObject1);
      localbidm.jdField_a_of_type_Boolean = bool;
      localbidm.c = i;
      return localbidm;
      bool = false;
      break;
      ...
      localbidm.jdField_a_of_type_Int = j;
      localbidm.jdField_b_of_type_Int = i;
      localbidm.jdField_b_of_type_JavaLangString = localExpireSet.toJson();
      localObject2 = biik.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "troop_keyword_expire_list_" + paramString, null);
      if (!ExpireSet.fromJson((String)localObject2).containsAll(localExpireSet))
      {
        ...
        QLog.e("TroopKeywordManager.troop.special_msg.keyword", 1, "expireList hasNewExpiredId, last:" + (String)localObject2 + " now:" + localbidm.jdField_b_of_type_JavaLangString);
      }
      for (;;)
      {
        if (j <= 0) {
        ...
        localObject1 = ((Resources)localObject1).getString(2131698511, new Object[] { Integer.valueOf(j) });
        i = 5;
        break;
        bool = false;
        break label426;
        label508:
        biik.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "troop_keyword_expire_list_" + paramString, localbidm.jdField_b_of_type_JavaLangString);
      }
      label544:
      if (i > 0)
      {
        localObject1 = ((Resources)localObject1).getString(2131698516);
        i = 4;
      }
      else
      {
        localObject1 = ((Resources)localObject1).getString(2131698512, new Object[] { Integer.valueOf(localList.size()) });
        bool = false;
        i = 3;
      }
    }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    biik.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "troop_keyword_open", paramBoolean);
    if (paramBoolean) {}
    for (int i = 1;; i = 0)
    {
      jdField_a_of_type_Int = i;
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    bdll.b(null, "dc00898", "", paramString2, "qq_vip", "0X800A8FD", 0, 1, 0, "", "", localTroopKeyWord.keyword, "");
    return true;
  }
  ...
  public void b()
  {
    ...
    ((aogu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(new bido(this), true);
  }
}
