...
public class ajam
{
  ...
  public static CopyOnWriteArrayList<WeakReference<ajan>> a;
  ...
  static
  {
    ...
    jdField_c_of_type_ArrayOfJavaLangString = new String[] { "libtinyskia.so", "libsava.so" };
    jdField_d_of_type_ArrayOfJavaLangString = new String[] { "brick.js", "ticker.js", "scene.js", "game.js" };
  ...
  public static void a(int paramInt)
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = (ajan)((WeakReference)localObject2).get();
          if (localObject2 != null) {
            ((ajan)localObject2).a(paramInt);
          }
        }
      }
    }
  ...
  public static void a(ajan paramajan)
  {
    if (paramajan == null) {}
    for (;;)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            if ((localWeakReference != null) && (paramajan == localWeakReference.get()))
            {
              QLog.i("ApolloSoLoader", 1, "already add, cb:" + paramajan);
              break;
            }
          }
        }
      ...
      jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(new WeakReference(paramajan));
    }
  }
  ...
  public static void a(String paramString)
  {
    ...
    if ((jdField_d_of_type_Boolean) && (aifg.a(BaseApplicationImpl.getContext()))) {}
    ...
    for (;;)
    {
      ...
      synchronized (beff.a)
      {
        ...
        if (i < j)
        {
          ...
          aixo.a(10, 300, new Object[] { "load [" + ((File)localObject1).getAbsolutePath() + "]" });
        }
      }
      return;
      label223:
  ...
  /* Error */
  public static void b(ajan paramajan)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: aload_0
    //   4: ifnull +14 -> 18
    //   7: getstatic 66	ajam:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   10: invokevirtual 262	java/util/concurrent/CopyOnWriteArrayList:size	()I
    //   13: istore_1
    //   14: iload_1
    //   15: ifne +7 -> 22
    //   18: ldc 2
    //   20: monitorexit
    //   21: return
    //   22: getstatic 66	ajam:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   25: invokevirtual 90	java/util/concurrent/CopyOnWriteArrayList:iterator	()Ljava/util/Iterator;
    //   28: astore_2
    //   29: aload_2
    ...
    //   44: checkcast 102	java/lang/ref/WeakReference
    //   47: astore_3
    //   48: aload_3
    //   49: ifnull -20 -> 29
    //   52: aload_0
    //   53: aload_3
    //   54: invokevirtual 105	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
    //   57: if_acmpne -28 -> 29
    //   60: getstatic 66	ajam:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   63: aload_3
    //   64: invokevirtual 265	java/util/concurrent/CopyOnWriteArrayList:remove	(Ljava/lang/Object;)Z
    //   67: pop
    //   68: invokestatic 268	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   71: ifeq -53 -> 18
    //   74: ldc 112
    //   76: iconst_2
    //   77: iconst_2
    ...
    //   89: aload_0
    //   90: aastore
    //   91: invokestatic 273	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   94: goto -76 -> 18
    //   97: astore_0
    //   98: ldc 2
    //   100: monitorexit
  ...
  public static boolean b()
  {
    ...
    try
    {
      ...
      {
        str3 = arrayOfString[i];
        bool = bace.d(str2 + "/" + str3);
        if (!bool) {
          return false;
        }
        i += 1;
      }
      bace.a(beff.a(1), false);
      return true;
    }
  ...
  private static boolean b(int paramInt)
  {
    try
    {
      synchronized (beff.a)
      {
        File localFile1 = new File(beff.a(paramInt));
        String str1 = beff.a();
        if (localFile1.exists())
        {
          ...
          while (i < j)
          {
            ...
            if (e) {
              aixo.a(10, 100, new Object[] { localStringBuilder.toString() });
            }
            if (!bool) {
              return false;
            }
          ...
          bace.a(localFile1.getAbsolutePath());
  ...
  private static void c(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (l < 120000L)
      {
        ...
        if (e) {
          aixo.a(10, 200, new Object[] { "it's not time for downloading jsc, deltaT:", Long.valueOf(l) });
        }
      }
    }
    do
    {
      do
      {
        return;
        if (e) {
          aixo.a(10, 200, new Object[] { "startDownload:", Long.valueOf(l) });
        }
    ...
    aixo.a(10, 201, new Object[] { "it's not time for downloading jsc, deltaT:", Long.valueOf(l) });
    return;
    jdField_a_of_type_Long = System.currentTimeMillis();
    if (e) {
      aixo.a(10, 201, new Object[] { "startDownload:", Long.valueOf(l) });
    }
    amyv.a();
  }
  ...
  private static void f()
  {
    try
    {
      File localFile = new File(ajed.aU + "pddata/prd/early", "android.qq.apollo.js.818g1");
      if (!localFile.exists())
      {
        c(1);
        return;
      ...
      {
        beff.a(localFile.getAbsolutePath(), 1);
  ...
  private static boolean j()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bool1 = localSharedPreferences.getBoolean("is_handle_reinstall_android.qq.apollo.js.818g1", false);
        if ((f) || ((bool1) && (str.equals("android.qq.apollo.js.818g1")))) {
          break label257;
        }
        if (str.equals("android.qq.apollo.js.818g1")) {
          break;
        }
        QLog.i("ApolloSoLoader", 1, "oldRes:" + str + ",newRes:" + "android.qq.apollo.js.818g1");
        if (k())
        {
          bool1 = false;
          if (bool1)
          {
            localSharedPreferences.edit().putBoolean("is_handle_reinstall_android.qq.apollo.js.818g1", true).commit();
            f = true;
          }
          bool1 = bool2;
          if (!e) {
          ...
          aixo.a(10, 100, new Object[] { "reinstall delete old so, oldRes:", str, ",newRes:", "android.qq.apollo.js.818g1" });
          return true;
        }
      }
      catch (Throwable localThrowable)
      {
        QLog.e("ApolloSoLoader", 1, localThrowable, new Object[0]);
        if (e) {
          aixo.a(10, 100, new Object[] { "reinstall th:", localThrowable });
        }
        b();
        return false;
      }
  ...
  {
    String str1 = beff.a() + "libsava.so" + "." + "android.qq.apollo.js.818g1";
    if (new File(str1).exists())
    {
      QLog.i("ApolloSoLoader", 1, "Bingo, the latest sava has been predownloaded.");
      String str2 = beff.a() + "libsava.so";
      bace.d(str2);
      if (!bace.c(str1, str2))
      {
    ...
    for (;;)
    {
      try
      {
        if (ApolloGameUtil.a())
        {
          ...
          aixo.a(10, 300, 1002, new Object[] { "arch=x86" });
          break;
        }
        if (!UpdateArkSo.a(BaseApplicationImpl.getContext(), "png-armeabi-v7a"))
        {
          ...
          aixo.a(10, 300, 1003, new Object[] { "png-armeabi-v7a load failed" });
          jdField_a_of_type_Boolean = true;
          break label438;
        }
        ...
        localObject = (amyp)((AppInterface)localObject).getManager(77);
        if (localObject == null) {
          break label431;
        }
        ...
        localObject = ((amyv)localObject).a();
        if (localObject == null) {
          break label431;
        }
        i = ((XmlData)localObject).Version;
        QLog.i("ApolloSoLoader", 1, "[so info], str:android.qq.apollo.js.818g1,ver:" + i);
        if (e) {
          aixo.a(10, 300, new Object[] { "[so info], str:android.qq.apollo.js.818g1,ver:" + i });
        }
        if (a(jdField_b_of_type_ArrayOfJavaLangString))
        {
          ...
          if (jdField_d_of_type_Boolean)
          {
            ...
            aixo.a(10, 300, 0, new Object[] { "loadAllSo success" });
            break label440;
          }
        }
        else
      ...
      catch (Throwable localThrowable)
      {
        ...
        if (e)
        {
          aixo.a(10, 300, 1004, new Object[] { "[loadAllSo], Something unexpected happened.", localThrowable });
          jdField_a_of_type_Boolean = true;
        }
        return false;
      }
  ...
  private static boolean m()
  {
    ...
    while (!a(jdField_d_of_type_ArrayOfJavaLangString)) {
      return false;
    }
    boolean bool = new aizl(-1, 3, "", "").a();
    QLog.i("ApolloSoLoader", 1, "[isSavaSoExists], check result:" + bool);
    if (e) {
      aixo.a(10, 100, new Object[] { "[isSavaSoExists], check result:" + bool });
    }
    return bool;
  }
  ...
  private static boolean n()
  {
    ...
    if (a(jdField_a_of_type_ArrayOfJavaLangString))
    {
      ...
      if (new File(beff.a() + "checkList_jsc").exists())
      {
        bool = new aizl(-1, 4, "", "").a();
        ...
        for (;;)
        {
          try
          {
            synchronized (beff.a)
            {
              ...
              bool = bace.d(str1 + "/" + str2, (String)localObject3 + str2);
              if (bool) {
                continue;
              }
              return false;
  ...
  private static boolean o()
  {
    ...
    try
    {
      if (TextUtils.isEmpty(aifg.f)) {
        aifg.f = bace.b(new File(a("brick.js"), "brick.js"));
      }
      if (TextUtils.isEmpty(aifg.g)) {
        aifg.g = bace.b(new File(a("ticker.js"), "ticker.js"));
      }
      if (TextUtils.isEmpty(aifg.h)) {
        aifg.h = bace.b(new File(a("scene.js"), "scene.js"));
      }
      if (TextUtils.isEmpty(aifg.i)) {
        aifg.i = bace.b(new File(a("game.js"), "game.js"));
      }
      return true;
    }
    catch (Throwable localThrowable)
    {
      ...
      if (e) {
        aixo.a(10, 100, new Object[] { "[initScriptLib], th:", localThrowable });
      }
      return false;
    }
    finally
