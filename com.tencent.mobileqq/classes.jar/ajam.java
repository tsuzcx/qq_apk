...
public class ajam
  implements ajbn
{
  public static List<ajam> a;
  private int jdField_a_of_type_Int;
  private ajat jdField_a_of_type_Ajat;
  private AudioManager.OnAudioFocusChangeListener jdField_a_of_type_AndroidMediaAudioManager$OnAudioFocusChangeListener = new ajas(this);
  ...
  public ajam(int paramInt1, int paramInt2, String arg3)
  {
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_b_of_type_Int = paramInt2;
    ajcf localajcf = ajac.a(paramInt2);
    if (localajcf != null) {
      localajcf.b(0);
    }
    if ("effect".equals(???)) {
      if (localajcf != null) {
        this.jdField_a_of_type_Ajat = new ajat(paramInt2);
      }
    }
    for (;;)
    {
      ...
      synchronized (jdField_a_of_type_JavaUtilList)
      {
        ...
        a(1);
        this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnErrorListener(new ajan(this));
      }
    }
  }
  
  private void a(ajbm paramajbm, JSONObject paramJSONObject)
  {
    if (paramajbm != null) {
  ...
  public JSONObject a(int paramInt, JSONObject paramJSONObject, ajbm paramajbm)
  {
    int i;
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnSeekCompleteListener(new ajao(this, paramJSONObject, paramajbm));
  ...
  public JSONObject a(ajbm paramajbm, JSONObject paramJSONObject)
  {
    if (paramJSONObject != null) {
      try
      {
        if (paramJSONObject.optInt("N_R_OBJ") == this.jdField_a_of_type_Int)
        {
          ...
          if ("cs.audio_play.local".equals(str)) {
            return b(paramJSONObject, paramajbm);
          }
          ...
          if ("cs.audio_load.local".equals(str)) {
            return c(paramJSONObject, paramajbm);
          }
          ...
          if ("cs.audio_seek.local".equals(str)) {
            return a(paramJSONObject.optInt("seek"), paramJSONObject, paramajbm);
          }
          if ("cs.audio_src.local".equals(str)) {
            return a(paramJSONObject.optString("src"), paramJSONObject, paramajbm);
          }
          ...
          if ("cs.audio_destroy.local".equals(str)) {
            return b(paramajbm, paramJSONObject);
          }
          if ("cs.audio_onend.local".equals(str)) {
            return e(paramJSONObject, paramajbm);
          }
          ...
          {
            paramajbm = a(paramJSONObject, paramajbm);
            return paramajbm;
          }
        }
      }
      ...
      {
        QLog.e("CmGameAudioPlayer", 1, "audio failed", paramajbm);
      }
    }
    return null;
  }
  
  public JSONObject a(String paramString, JSONObject paramJSONObject, ajbm paramajbm)
  {
      ...
      try
      {
        ...
        if (localajcf != null)
        {
          ...
          for (;;)
          {
            ...
            a(2);
            return paramJSONObject;
            paramString = aiye.a(paramString, localajcf.a(), str1, false);
          }
        }
  ...
  public JSONObject a(JSONObject paramJSONObject, ajbm paramajbm)
  {
    try
    {
      if (paramJSONObject.has("src")) {
        a(paramJSONObject.optString("src"), paramJSONObject, paramajbm);
      }
      ...
      if (paramJSONObject.has("currentTime")) {
        d(paramJSONObject, paramajbm);
      }
      return paramJSONObject;
    }
    catch (Throwable paramajbm)
    {
      QLog.e("CmGameAudioPlayer", 1, paramajbm, new Object[0]);
    }
    return paramJSONObject;
  }
  ...
  public JSONObject a(boolean paramBoolean, float paramFloat1, float paramFloat2, JSONObject paramJSONObject)
  {
    ...
    } while (this.jdField_a_of_type_Ajat == null);
    Object localObject = this.jdField_a_of_type_Ajat;
    if ((paramBoolean) || ((Float.compare(paramFloat1, 0.0F) == 0) && (Float.compare(paramFloat2, 0.0F) == 0))) {}
    for (int i = 0;; i = 1)
    {
      ((ajat)localObject).a(i, BaseActivity.sTopActivity.getAppInterface());
      return paramJSONObject;
    }
  }
  ...
  public JSONObject b(ajbm arg1, JSONObject paramJSONObject)
  {
    try
    {
      if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null) {
  ...
  public JSONObject b(JSONObject paramJSONObject)
  {
    for (;;)
    {
      ...
      if (paramJSONObject.optBoolean("auto", true)) {
        this.jdField_a_of_type_Ajat.a();
      } else {
        this.jdField_a_of_type_Ajat.a(i, null);
      }
    }
  }
  
  public JSONObject b(JSONObject paramJSONObject, ajbm paramajbm)
  {
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
      i = a();
    ...
    while (this.jdField_a_of_type_Ajat == null) {
      for (;;)
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new ajap(this));
        }
    ...
    a(true);
    return this.jdField_a_of_type_Ajat.a(paramajbm, paramJSONObject);
  }
  ...
  public JSONObject c(JSONObject paramJSONObject, ajbm paramajbm)
  {
    if ((this.jdField_a_of_type_AndroidMediaMediaPlayer != null) && ((a() == 2) || (a() == 6)))
    {
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new ajaq(this, paramJSONObject, paramajbm));
  ...
  public JSONObject d(JSONObject paramJSONObject, ajbm paramajbm)
  {
    int i;
  ...
  public JSONObject e(JSONObject paramJSONObject)
  {
    if (this.jdField_a_of_type_Ajat != null)
    {
      this.jdField_a_of_type_Ajat.c(paramJSONObject.optInt("id"), null);
      this.jdField_a_of_type_Ajat.a(paramJSONObject);
    }
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
  ...
  public JSONObject e(JSONObject paramJSONObject, ajbm paramajbm)
  {
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null) {
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new ajar(this, paramajbm, paramJSONObject));
    }
    return null;
  }
  ...
  public JSONObject f(JSONObject paramJSONObject)
  {
    ...
    this.jdField_a_of_type_Ajat.b(paramJSONObject.optInt("id"), null);
    return paramJSONObject;
  }
}
