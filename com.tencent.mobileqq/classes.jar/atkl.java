...
import com.tencent.mobileqq.flutter.qqface.QFlutterFaceLoader.2;
...
public class atkl
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new atkm(this);
  private Context jdField_a_of_type_AndroidContentContext;
  private Bitmap jdField_a_of_type_AndroidGraphicsBitmap;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new atkn(this);
  ...
  private List<atko> jdField_a_of_type_JavaUtilList = new Vector();
  ...
  public atkl(Context paramContext)
  {
  ...
  private void a(atkh paramatkh, Bitmap paramBitmap, String paramString)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_b_of_type_AndroidOsHandler.post(new QFlutterFaceLoader.2(this, paramatkh, paramBitmap, paramString));
      return;
    }
  }
  ...
  private void a(List<atkh> paramList)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        atkh localatkh = (atkh)paramList.next();
        String str = (String)this.jdField_b_of_type_AndroidSupportV4UtilMQLruCache.get(localatkh.c);
        Bitmap localBitmap = atki.a(str, localatkh.jdField_b_of_type_Int, this.jdField_a_of_type_Float);
        if (localBitmap != null)
        {
          if (QLog.isColorLevel()) {
            QLog.d("QFlutter.qqface", 2, "decodeFaceBitmap addCache " + localatkh.jdField_b_of_type_JavaLangString);
          }
          this.jdField_a_of_type_AndroidSupportV4UtilMQLruCache.put(localatkh.jdField_b_of_type_JavaLangString, localBitmap);
          a(localatkh, localBitmap, str);
        }
      }
    }
  }
  
  private boolean a(atkh paramatkh)
  {
    List localList = (List)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramatkh.jdField_a_of_type_Int));
    if ((localList != null) && (!localList.isEmpty())) {
      return localList.contains(paramatkh.jdField_a_of_type_JavaLangString);
    }
    return false;
  }
  ...
  private boolean b(atkh paramatkh)
  {
    List localList = (List)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramatkh.jdField_a_of_type_Int));
    if ((localList != null) && (!localList.isEmpty())) {
      return localList.contains(paramatkh.jdField_a_of_type_JavaLangString);
    }
    return false;
  ...
  public Pair<Bitmap, Boolean> a(atkh paramatkh)
  {
    if (QLog.isColorLevel()) {
      QLog.d("QFlutter.qqface", 2, "getBitmap: " + paramatkh);
    }
    Object localObject1 = paramatkh.jdField_b_of_type_JavaLangString;
    String str = paramatkh.c;
    ...
    if (FileUtil.isFileExists(str))
    {
      ...
      ((ArrayList)localObject1).add(paramatkh);
    ...
    for (;;)
    {
      return new Pair(a(paramatkh.jdField_b_of_type_Int), Boolean.valueOf(true));
      if (QLog.isColorLevel()) {
        QLog.d("QFlutter.qqface", 2, "faceKey: " + (String)localObject1 + " request");
      }
      if ((!a(paramatkh)) || (!b(paramatkh)))
      {
        a(paramatkh.jdField_a_of_type_Int, paramatkh.jdField_a_of_type_JavaLangString);
  ...
  public void a(atko paramatko)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      if (!this.jdField_a_of_type_JavaUtilList.contains(paramatko)) {
        this.jdField_a_of_type_JavaUtilList.add(paramatko);
      }
      return;
    }
  }
