  ...
  extends slz
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = skt.a("StoryTabSvc.startpage_feeds_list_725");
  }
  ...
  public slu a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new str(localRspMsgTabNodeList);
    }
  ...
  protected byte[] a()
  {
    ...
    localReqMsgTabNodeList.client_version.set(ByteStringMicro.copyFromUtf8("8.2.6"));
