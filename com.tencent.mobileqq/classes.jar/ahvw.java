  ...
  implements awmy
{
  ...
  public ahvw(String paramString, int paramInt1, int paramInt2, long paramLong1, long paramLong2)
  {
  ...
  public awmz a(int paramInt1, int paramInt2)
  {
    ...
    label278:
    label307:
    for (localawmz.jdField_a_of_type_Int = ((int)(819200 * 1.0D / paramInt1 * paramInt2));; localawmz.jdField_a_of_type_Int = 819200)
    {
