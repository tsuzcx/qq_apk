...
{
  aqwt(aqwl paramaqwl, TroopFileTransferManager paramTroopFileTransferManager, bbpe parambbpe, FileManagerEntity paramFileManagerEntity) {}
  ...
  public void a(int paramInt, String paramString, WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgRsp paramCrossBidProxyCopyFileToOtherBidMsgRsp)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager.a(this.jdField_a_of_type_Bbpe.a, paramInt, null, paramString);
  }
  ...
  public void a(WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgRsp paramCrossBidProxyCopyFileToOtherBidMsgRsp)
  {
    ...
    if (paramCrossBidProxyCopyFileToOtherBidMsgRsp.length() < 1)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager != null) {
        this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager.a(this.jdField_a_of_type_Bbpe.a, -1, null, alpo.a(2131717304));
      }
    }
    do
    {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager.a(this.jdField_a_of_type_Bbpe.a, 0, paramCrossBidProxyCopyFileToOtherBidMsgRsp, null);
  }
}
