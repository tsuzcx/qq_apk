...
public class bill
{
  ...
  {
    return biln.a().a("contentboxlaunch", "gocontentboxminiprogram", 0);
  }
  ...
  public static void a(bilm parambilm)
  {
    if (parambilm != null) {
      QzoneHandlerThreadFactory.getHandlerThread("Normal_HandlerThread").post(new QZoneConfigHelper.1(parambilm));
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    try
    {
      boolean bool = ((aufx)paramQQAppInterface.getManager(10)).b();
      return bool;
    }
