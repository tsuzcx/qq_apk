...
public class bill
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    {
      return 0;
      if ((paramQQAppInterface.getLebaHelper().a != null) && (paramQQAppInterface.getLebaHelper().a.b)) {
        break;
      }
  ...
  public static EIPCResult a(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    ((aymd)paramString.getManager(QQManagerFactory.LOCAL_REDTOUCH_MANAGER)).a(10014);
    paramBundle.code = 0;
    return paramBundle;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, RedTouch paramRedTouch)
  {
    ...
    {
      localObject1 = (aymd)paramQQAppInterface.getManager(QQManagerFactory.LOCAL_REDTOUCH_MANAGER);
      paramQQAppInterface = ((aymd)localObject1).a(10013);
      localObject2 = ((aymd)localObject1).a(10014);
      if (!((aymd)localObject1).a(paramQQAppInterface, false)) {
        break label1103;
      }
    ...
    for (;;)
    {
      int k = i;
      int m = j;
      if (((aymd)localObject1).a((RedTouchItem)localObject2, false))
      {
        k = i;
        m = j;
        ...
        for (;;)
        {
          ...
          if (!TextUtils.isEmpty(paramQQAppInterface.icon))
          {
            if (!TextUtils.isEmpty(paramQQAppInterface.tips))
            {
              ...
              localObject2 = new BusinessInfoCheckUpdate.RedTypeInfo();
              ((BusinessInfoCheckUpdate.RedTypeInfo)localObject2).red_content.set(DisplayUtil.dip2px(BaseApplicationImpl.sApplication.getApplicationContext(), 3.0F) + "");
            ...
            try
            {
              ...
              try
              {
                ...
                paramQQAppInterface.setPadding(AIOUtils.dp2px(160.0F, paramQQAppInterface.getResources()), paramQQAppInterface.getPaddingTop(), paramQQAppInterface.getPaddingRight(), paramQQAppInterface.getPaddingBottom());
                return;
              }
  ...
  public static EIPCResult b(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    paramString = (aymd)paramString.getManager(QQManagerFactory.LOCAL_REDTOUCH_MANAGER);
