  ...
  implements View.OnClickListener
{
  ...
  private vhf jdField_a_of_type_Vhf;
  
  public vhd(TroopGiftMsgItemBuilder paramTroopGiftMsgItemBuilder, MessageForTroopGift paramMessageForTroopGift, vhf paramvhf)
  {
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopGift = paramMessageForTroopGift;
    this.jdField_a_of_type_Vhf = paramvhf;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject;
    for (int j = 2; paramView.getId() == 2131375112; j = 1)
    {
      ...
      localObject = SharedPreUtils.k(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemTroopGiftMsgItemBuilder.jdField_a_of_type_AndroidContentContext, "wantWord");
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemTroopGiftMsgItemBuilder.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.addTextChangedListener(new vhe(this));
      return;
    }
    if (paramView.getId() == 2131375109)
    {
      paramView = SharedPreUtils.k(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemTroopGiftMsgItemBuilder.jdField_a_of_type_AndroidContentContext, "thxWord");
    ...
    for (;;)
    {
      ...
      if (paramView.getId() == 2131375110)
      {
        ...
        paramView = SharedPreUtils.k(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemTroopGiftMsgItemBuilder.jdField_a_of_type_AndroidContentContext, "url");
        if (TextUtils.isEmpty(paramView)) {
          break label1728;
        }
      }
        ...
        if (paramView.getId() == 2131368528) {
          if (TroopGiftUtil.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopGift))
          {
            ...
            if ((paramView != null) && (paramView.b()))
            {
              ...
              paramView.a(this.jdField_a_of_type_Vhf);
              ...
              if (!this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopGift.isLoading) {
                paramView.b(this.jdField_a_of_type_Vhf);
              }
