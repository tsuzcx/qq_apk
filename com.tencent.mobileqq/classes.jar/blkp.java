  ...
  implements blko
{
  public boolean a(int paramInt, Bundle paramBundle)
  {
    ...
    case 1: 
      ...
      atzj.a().b(paramBundle, (Bundle)localObject2);
      return true;
    case 2: 
      ...
      ((QQAppInterface)localObject1).a().a(new atgq(paramBundle));
    ...
    case 4: 
      ...
      paramBundle.putString("configInfo", atgz.a(((QQAppInterface)localObject1).getApp().getBaseContext(), str));
      return true;
    }
