...
public class zzv
{
  ...
  public static SparseArray<zzw> a;
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidUtilSparseArray.put(1, new zzw(0L, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(4, new zzw(0L, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(6, new zzw(0L, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(7, new zzw(0L, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(14, new zzw(0L, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(9, new zzw(0L, 0));
    jdField_a_of_type_AndroidUtilSparseArray.put(16, new zzw(0L, 0));
  }
  ...
  public static void a()
  {
    ...
    for (;;)
    {
      if ((jdField_a_of_type_Long - l > 0L) && (MagnifierSDK.jdField_a_of_type_AndroidContentSharedPreferences$Editor != null))
      {
        ...
        arrayOfInt = zzn.jdField_a_of_type_ArrayOfInt;
        j = arrayOfInt.length;
        i = 0;
        for (;;)
        {
          if (i < j)
          {
            ...
            jdField_a_of_type_AndroidUtilSparseArray.put(k, new zzw(0L, 0));
            i += 1;
            continue;
    ...
    for (;;)
    {
      ...
      if (MagnifierSDK.jdField_a_of_type_AndroidContentSharedPreferences != null)
      {
        ...
        if (jdField_a_of_type_Int >= zzn.jdField_a_of_type_Int) {
          break;
        }
        arrayOfInt = zzn.jdField_a_of_type_ArrayOfInt;
        j = arrayOfInt.length;
        ...
        while (i < j)
        {
          ...
          jdField_a_of_type_AndroidUtilSparseArray.put(k, new zzw(0L, m));
          i += 1;
        }
      }
    }
  ...
  {
    zzw localzzw = (zzw)jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    if (localzzw == null) {
      return;
    }
    localzzw.jdField_a_of_type_Int += 1;
  }
}
