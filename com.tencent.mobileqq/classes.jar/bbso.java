...
public abstract class bbso
  implements bbpx, bbqb
{
  ...
  private static bbsq<bbqb> listeners = new bbsq();
  private static bbsq<WeakReference<bbqb>> weakListeners = new bbsq();
  ...
  protected void _onCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      bbdj.a(paramQQAppInterface, paramString2, false);
      return;
    }
  ...
  public void download(QQAppInterface paramQQAppInterface, int paramInt, bbqb parambbqb, boolean paramBoolean)
  {
    download(paramQQAppInterface, getScid(paramInt), parambbqb, paramBoolean);
  }
  
  public void download(QQAppInterface paramQQAppInterface, long paramLong, String paramString, bbqb parambbqb, boolean paramBoolean)
  {
    if (FlatBuffersParser.c())
    {
      QLog.e("BaseUpdateCallback", 1, "x86 not support");
      if (parambbqb != null) {
        parambbqb.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10086, 0);
      }
    }
    do
    {
    ...
    } while (parambbqb == null);
    parambbqb.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10087, 0);
    return;
    ...
    for (;;)
    {
      if (parambbqb != null)
      {
        ...
        weakListeners.a((String)localObject, new WeakReference(parambbqb));
      }
      for (;;)
      {
        QLog.e("BaseUpdateCallback", 1, "download: " + paramLong + "_" + paramString + ", " + parambbqb);
        ...
        parambbqb.onCompleted(paramQQAppInterface, paramLong, paramString, "", "BaseUpdateCallback", 10088, 0);
        return;
        listeners.a((String)localObject, parambbqb);
      }
    }
  }
  ...
  public void download(QQAppInterface paramQQAppInterface, String paramString, bbqb parambbqb, boolean paramBoolean)
  {
    download(paramQQAppInterface, getBID(), paramString, parambbqb, paramBoolean);
  }
  ...
  public final void onCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    ...
    for (localObject1 = listeners.b((String)localObject2);; localObject1 = listeners.a((String)localObject2))
    {
      ...
      while (((Iterator)localObject1).hasNext()) {
        ((bbqb)((Iterator)localObject1).next()).onCompleted(paramQQAppInterface, paramLong, paramString1, paramString2, paramString3, paramInt1, paramInt2);
      }
    ...
    for (localObject1 = weakListeners.b((String)localObject2);; localObject1 = weakListeners.a((String)localObject2))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (bbqb)((WeakReference)((Iterator)localObject1).next()).get();
        if (localObject2 != null) {
          ((bbqb)localObject2).onCompleted(paramQQAppInterface, paramLong, paramString1, paramString2, paramString3, paramInt1, paramInt2);
        }
      }
    }
  }
  ...
  public final void onProgress(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, long paramLong3)
  {
    ...
    for (boolean bool = false;; bool = ((VasQuickUpdateEngine.TagItemInfo)localObject1).bPreConfig)
    {
      ...
      while (((Iterator)localObject2).hasNext()) {
        ((bbqb)((Iterator)localObject2).next()).onProgress(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, paramLong3);
      }
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      localObject2 = (bbqb)((WeakReference)((Iterator)localObject1).next()).get();
      if (localObject2 != null) {
        ((bbqb)localObject2).onProgress(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, paramLong3);
      }
    }
  }
  
  public void removeListener(long paramLong, String paramString, bbqb parambbqb)
  {
    paramString = getKey(paramLong, paramString, "");
    listeners.a(paramString, parambbqb, false);
    weakListeners.a(paramString, parambbqb, true);
  }
}
