...
{
  public kkn(StageEffectView paramStageEffectView) {}
  ...
  public int a(StageMemberView paramStageMemberView1, StageMemberView paramStageMemberView2)
  {
    ...
    paramStageMemberView1 = (kkt)paramStageMemberView1.getTag();
    paramStageMemberView2 = (kkt)paramStageMemberView2.getTag();
