...
public class avwi
{
  ...
  {
    int i = ((Integer)paramView.getTag(2131313374)).intValue();
    Object localObject;
    View localView;
    ...
    if ((paramView instanceof LinearLayout))
    {
      ...
      paramView.removeView(paramView.findViewById(2131307429));
      paramView.removeView(paramView.findViewById(2131307430));
      if (paramView.getChildCount() == 1)
      {
        ...
        int j = ((Context)localObject).getResources().getDimensionPixelSize(2131167186);
        k = ((Context)localObject).getResources().getDimensionPixelSize(2131167187);
        switch (paramInt2)
        {
        default: 
    ...
    for (;;)
    {
      if (avoz.a(paramInt3))
      {
        localObject = new avxf((Context)localObject, paramInt3).a();
        ((View)localObject).setId(2131307430);
      ...
      if (((paramInt2 == 0) || (paramInt1 == 1)) && (paramBoolean1) && (i != 1))
      {
        ...
        ((View)localObject).setId(2131307429);
        ((View)localObject).setLayoutParams(new LinearLayout.LayoutParams(-1, paramView.getContext().getResources().getDimensionPixelSize(2131167180)));
        paramView.addView((View)localObject, 0);
  ...
  public static void a(avon paramavon, int paramInt1, int paramInt2)
  {
    int j = 1;
    int i = j;
    if (paramInt1 > 1)
