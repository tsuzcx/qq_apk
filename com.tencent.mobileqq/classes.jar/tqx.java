...
public final class tqx
  extends tpt
{
  public static final tqy a = new tqy(null);
  
  public tqx(@NotNull BridgeModule paramBridgeModule)
  {
  ...
  private final void b(JSONObject paramJSONObject, String paramString)
  {
    ...
    {
      tym.a(paramJSONObject, str, (tol)new tqz(this, paramString));
      break;
    }
  }
  ...
  {
    UiApiPlugin.a(true, paramString, (tol)new tra(this));
  }
  ...
  public void a()
  {
    a("openPluginView", (Function2)new UIBridgeInvokeHandler.register.1((tqx)this));
    a("arouseReadInJoyNativeCommentView", (Function2)new UIBridgeInvokeHandler.register.2((tqx)this));
    a("biuCommentAladdinConfig", (Function2)new UIBridgeInvokeHandler.register.3((tqx)this));
    a("showCommentEditor", (Function2)new UIBridgeInvokeHandler.register.4((tqx)this));
