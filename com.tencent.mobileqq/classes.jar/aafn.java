...
public class aafn
{
  private static final String jdField_a_of_type_JavaLangString = aafn.class.getSimpleName();
  ...
  public static String a(long paramLong)
  {
    ...
    try
    {
      str = BaseApplicationImpl.getContext().getString(2131719206);
      localObject2 = BaseApplicationImpl.getContext().getString(2131719207);
      localObject1 = BaseApplicationImpl.getContext().getString(2131719205);
