  ...
  implements rwn
{
  ...
  protected abstract rwo a(T paramT);
  
  protected void a(int paramInt, boolean paramBoolean, List<T> paramList, List<rwo> paramList1)
  {
    int j = paramInt + 1;
    int i = 0;
    int k = 0;
    ...
    if (j < paramList.size())
    {
      int m = Math.min(ryi.a().a(a(), paramInt) + paramInt, paramList.size() - 1);
      paramInt = k;
      for (;;)
      {
        i = paramInt;
  ...
  protected void b(int paramInt, boolean paramBoolean, List<T> paramList, List<rwo> paramList1)
  {
    int i = 0;
    int k = 0;
    int j = paramInt - 1;
    ...
    if (j >= 0)
    {
      int m = Math.max(paramInt - ryi.a().a(), 0);
      paramInt = k;
      for (;;)
      {
        i = paramInt;
