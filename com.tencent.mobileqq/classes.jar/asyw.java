  ...
  implements PluginManagerUpdater
{
  ...
  public asyw(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    this.e = paramString3;
    ...
    this.jdField_a_of_type_Asyv = new asyv(paramContext, paramString1, paramString3);
  ...
  private boolean a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        throw new Error(this.jdField_a_of_type_JavaLangString + alud.a(2131701854));
      }
      finally
      {
        localObject1 = null;
      ...
      try
      {
        if (((HttpURLConnection)localObject1).getResponseCode() != 200) {
          throw new Error(alud.a(2131701856) + 200 + alud.a(2131701857) + ((HttpURLConnection)localObject1).getResponseCode());
        }
  ...
  public File a()
  {
    ...
    atct localatct = new atct();
    localatct.a(BaseApplicationImpl.getContext());
    localatct.a(this.jdField_a_of_type_JavaLangString, new asyy(this, localFile, arrayOfException, l, localCountDownLatch));
    localatct.b(atcv.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaIoFile.getAbsolutePath()));
  ...
  {
    throw new UnsupportedOperationException(alud.a(2131701855));
  }
  ...
  public Future<File> update()
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentFuture = amdp.a(192).submit(new asyx(this));
    return this.jdField_a_of_type_JavaUtilConcurrentFuture;
  }
