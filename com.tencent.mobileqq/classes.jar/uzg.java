...
public class uzg
{
  private static final String a = uzg.class.getSimpleName();
  ...
  public static FeedCloudMeta.StUser a(Context paramContext)
  {
    paramContext = a(paramContext);
  ...
  public static String a(long paramLong)
  {
    ...
    label203:
    if (localTime2.yearDay == localTime1.yearDay) {
      localObject1 = anzj.a(2131718768) + (String)localObject1;
    }
    for (;;)
    {
      return localObject1;
      ...
      {
        localObject1 = anzj.a(2131719411) + (String)localObject1;
      }
      else if (localTime1.yearDay + 1 == i)
      {
        localObject1 = anzj.a(2131690486) + (String)localObject1;
      }
      else
      {
  ...
  {
    if (paramBoolean) {}
    for (Object localObject = anzj.a(2131697174); paramLong < 1000L; localObject = "W") {
  ...
  public static void a(aaan paramaaan, List<FeedCloudMeta.StFeed> paramList)
  {
    Iterator localIterator = paramList.iterator();
    while (localIterator.hasNext())
    {
  ...
  public static void a(Context paramContext, FeedCloudMeta.StFeed paramStFeed, aaav<FeedCloudWrite.StDoLikeRsp> paramaaav, boolean paramBoolean)
  {
    if (!nny.a(paramContext))
    {
      QQToast.a(paramContext, anzj.a(2131693968), 0).a();
      return;
    }
    try
    {
      ...
      do
      {
        VSNetworkHelper.a().a(new QCircleDoLikeRequest(paramStFeed, 1, localStLike, localStDoLikeReqDoPolyLikeBusiReqData, paramBoolean, false), new uzh(paramaaav));
        return;
  ...
  public static void a(FeedCloudMeta.StFeed paramStFeed, int paramInt, QQCircleFeedBase.StPolyLike paramStPolyLike1, QQCircleFeedBase.StPolyLike paramStPolyLike2)
  {
    ...
    {
      localObject2 = new QQCircleFeedBase.StLikeBusiData();
    }
    label141:
    for (;;)
    {
      ...
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException2)
      {
        try
        {
          ...
          i = j;
          if (!a(paramStPolyLike2, (QQCircleFeedBase.StLikeBusiData)localObject1)) {
            i = j + 1;
          }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    return ((anyw)paramQQAppInterface.getManager(51)).b(paramString);
  }
  ...
  {
    int j = BaseApplicationImpl.getContext().getResources().getColor(2131166234);
    int i = j;
    if (paramBoolean) {
      i = b(j);
    }
  ...
  public static String b(long paramLong)
  {
    ...
    if (localTime.yearDay == ((Time)localObject2).yearDay) {
      return anzj.a(2131718768);
    }
    if (((Time)localObject2).yearDay == i) {
      return anzj.a(2131719411);
    }
    if (((Time)localObject2).yearDay + 1 == i) {
      return anzj.a(2131690486);
    }
