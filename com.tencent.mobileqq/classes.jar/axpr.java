...
public class axpr
{
  ...
  public axpr(Settings paramSettings)
  {
  ...
  private void a(Rect paramRect)
  {
    ...
    if (!axpv.a(this.jdField_a_of_type_Float, 0.0F))
    {
  ...
  public axpr a(axpv paramaxpv)
  {
    Object localObject = jdField_a_of_type_AndroidGraphicsRectF;
    axpx.a(this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings, jdField_a_of_type_AndroidGraphicsRect);
    ...
    {
      this.jdField_a_of_type_Float = paramaxpv.d();
      ...
      axpx.a(jdField_a_of_type_AndroidGraphicsMatrix, this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings, localRect);
      switch (axps.a[this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings.a().ordinal()])
      {
      default: 
    ...
    for (;;)
    {
      ...
      {
        paramaxpv.a(jdField_a_of_type_AndroidGraphicsMatrix);
        paramaxpv = jdField_a_of_type_AndroidGraphicsRectF;
        paramaxpv.set(0.0F, 0.0F, this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings.e(), this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureSettings.f());
        jdField_a_of_type_AndroidGraphicsMatrix.mapRect(paramaxpv);
        localObject = jdField_a_of_type_ArrayOfFloat;
        jdField_a_of_type_ArrayOfFloat[1] = 0.0F;
        localObject[0] = 0.0F;
        jdField_a_of_type_AndroidGraphicsMatrix.mapPoints(jdField_a_of_type_ArrayOfFloat);
        this.jdField_b_of_type_AndroidGraphicsRectF.offset(jdField_a_of_type_ArrayOfFloat[0] - paramaxpv.left, jdField_a_of_type_ArrayOfFloat[1] - paramaxpv.top);
      }
      return this;
  ...
  public void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, PointF paramPointF)
  {
    ...
    jdField_a_of_type_ArrayOfFloat[0] = axpy.a(jdField_a_of_type_ArrayOfFloat[0], this.jdField_b_of_type_AndroidGraphicsRectF.left - paramFloat3, this.jdField_b_of_type_AndroidGraphicsRectF.right + paramFloat3);
    jdField_a_of_type_ArrayOfFloat[1] = axpy.a(jdField_a_of_type_ArrayOfFloat[1], this.jdField_b_of_type_AndroidGraphicsRectF.top - paramFloat4, this.jdField_b_of_type_AndroidGraphicsRectF.bottom + paramFloat4);
    if (this.jdField_a_of_type_Float != 0.0F)
    {
      jdField_a_of_type_AndroidGraphicsMatrix.setRotate(this.jdField_a_of_type_Float, this.jdField_b_of_type_Float, this.c);
      jdField_a_of_type_AndroidGraphicsMatrix.mapPoints(jdField_a_of_type_ArrayOfFloat);
