  ...
  implements View.OnClickListener
{
  ...
  public mlx(View paramView, BaseData paramBaseData)
  {
  ...
  public void b(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    if ((paramBaseData2.jdField_a_of_type_Int != 0) && (paramBaseData2.b != 0))
    {
      ...
      if (paramBaseData2.b * paramBaseData2.jdField_a_of_type_Int > 2000000)
      {
        paramBaseData1.mRequestWidth = (k >> WebFastImageViewCreator.a());
        paramBaseData1.mRequestHeight = (m >> WebFastImageViewCreator.a());
      }
    }
    for (;;)
    {
      ...
      paramBaseData1 = URLDrawable.getDrawable(ReadInJoyUtils.a(paramBaseData2.jdField_a_of_type_JavaLangString), paramBaseData1);
      if (i != 0) {
        a(paramBaseData1);
      }
      ...
      this.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(new mly(this, paramBaseData2));
      return;
