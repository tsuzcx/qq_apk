...
public class qvt
  implements quc
{
  private static final String jdField_a_of_type_JavaLangString = qvt.class.getSimpleName();
  ...
  private qvw jdField_a_of_type_Qvw;
  ...
  {
    if (paramInt1 == 2) {
      onu.a().a(paramString1, "PubAccountArticleCenter.GetUrlByVid", new qvu(this, paramString1, paramInt2, paramLong));
    }
    do
    {
      do
      ...
      } while (this.jdField_a_of_type_Qvw == null);
      paramString2 = (String)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
    } while (TextUtils.isEmpty(paramString2));
    this.jdField_a_of_type_Qvw.a(paramString1, 1, paramString2);
  }
  ...
  private void a(String paramString1, String paramString2, long paramLong, int paramInt)
  {
    ...
    if (paramString1 != null) {
      ...
      {
        localObject = nmc.a(paramString1);
      }
    }
    ...
    ((TVK_PlayerVideoInfo)localObject).setConfigMap("cache_servers_type", qtx.jdField_a_of_type_JavaLangString);
    if (paramLong > 0L) {
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setPreloadCallback(new qvv(this));
  }
  ...
  public void a(qvw paramqvw)
  {
    this.jdField_a_of_type_Qvw = paramqvw;
  }
  
  public void b()
  {
    this.jdField_a_of_type_Qvw = null;
