...
public class apwk
  implements apvs, apvx
{
  @Nullable
  private Object jdField_a_of_type_JavaLangObject;
  private WeakReference<Context> jdField_a_of_type_JavaLangRefWeakReference;
  
  apwk(Context paramContext, @Nullable apvs paramapvs)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    this.jdField_a_of_type_JavaLangObject = paramapvs;
  }
  
  apwk(Context paramContext, @Nullable apvx paramapvx)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    this.jdField_a_of_type_JavaLangObject = paramapvx;
  }
  
  public void a(boolean paramBoolean, int paramInt1, int paramInt2, String paramString)
  {
    if ((this.jdField_a_of_type_JavaLangObject instanceof apvx)) {
      ((apvx)this.jdField_a_of_type_JavaLangObject).a(paramBoolean, paramInt1, paramInt2, paramString);
    }
  }
  
  public void a(boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString1, String paramString2)
  {
    if ((this.jdField_a_of_type_JavaLangObject instanceof apvs)) {
      ((apvs)this.jdField_a_of_type_JavaLangObject).a(paramBoolean1, paramBoolean2, paramInt, paramString1, paramString2);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_JavaLangObject instanceof apvs)) {
      return ((apvs)this.jdField_a_of_type_JavaLangObject).a();
    }
    return false;
  }
  ...
  void b(boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString1, String paramString2)
  {
    ...
    if (((this.jdField_a_of_type_JavaLangObject instanceof apvs)) && (!((apvs)this.jdField_a_of_type_JavaLangObject).a())) {}
