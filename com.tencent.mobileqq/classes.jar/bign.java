...
public class bign
{
    ...
    do
    {
      do
      {
        do
        {
          ...
          } while ((localadab == null) || (localadab.a("3026775809", 1008) <= 0));
          paramQQAppInterface = paramQQAppInterface.a(1008);
  ...
  public static boolean a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    Object localObject1 = (String)abac.a().a("main_page_jump_url", "https://web.yundong.qq.com/pushsport/index?_wv=18950115&asyncMode=1&crashFrom=40501&_wwv=265&ls=1&spec=1&ADTAG=gzh.menu_page.main");
    ...
    localObject2 = bhni.a(paramQQAppInterface, paramContext, (String)localObject1);
    ...
    for (;;)
    {
      ...
      return true;
      localObject1 = blhn.a(blhn.a(blhn.a(blhn.a((String)localObject1, "uin", paramQQAppInterface.c()), "puin", "3026775809"), "isHealthPublicAccountMainPage", "1"), "sourceFrom", String.valueOf(paramInt));
      ...
      ((Intent)localObject2).putExtra("assignBackText", paramContext.getResources().getString(2131690559));
      ((Intent)localObject2).putExtra("call_from", paramInt);
      ((Intent)localObject2).putExtra("FORCE_BLANK_SCREEN_REPORTE", true);
      ((Intent)localObject2).putExtra("big_brother_source_key", tzq.b("3026775809"));
  ...
  public static boolean a(String paramString)
  {
    boolean bool = false;
    if (b(paramString)) {
      bool = ((Boolean)abac.a().a("is_redirect_aio_to_main_page", Boolean.valueOf(false))).booleanValue();
    }
    return bool;
  }
