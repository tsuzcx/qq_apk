...
public class bknf
{
  ...
  public static bkng a(String paramString)
  {
    int i = 0;
    if (paramString == null) {}
    bkng localbkng;
    ...
    for (;;)
    {
      localbkng.a = paramString.getString("k=");
      localbkng.b = d(paramString.getString("u="));
      localObject = b(paramString.getString("n="));
      if (localObject != null)
      {
        localbkng.c = URLDecoder.decode((String)localObject, "UTF-8");
        if (localbkng.c != null) {}
      }
      for (localbkng.c = localbkng.b;; localbkng.c = localbkng.b)
      {
        localbkng.d = paramString.getString("o=");
        localbkng.e = paramString.getString("p=");
        localbkng.f = paramString.getString("d=");
        if ((localbkng.a == null) || (localbkng.b == null) || (localbkng.d == null)) {
          break;
        }
        return localbkng;
      }
