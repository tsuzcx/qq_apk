...
class aeim
  implements Runnable
{
  aeim(aeil paramaeil, PicFeedUploadInfo paramPicFeedUploadInfo, VideoFeedsUploader.UploadResult paramUploadResult) {}
  
  public void run()
  {
    NearbyMomentManager localNearbyMomentManager = (NearbyMomentManager)this.jdField_a_of_type_Aeil.a.a.getManager(262);
    ...
    for (;;)
    {
      if (ImageFeedsUploader.a(this.jdField_a_of_type_Aeil.a) != null) {
        ImageFeedsUploader.a(this.jdField_a_of_type_Aeil.a).a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelPicFeedUploadInfo, this.jdField_a_of_type_ComTencentMobileqqNearbyNowSendUploaderVideoFeedsUploader$UploadResult);
      }
      return;
