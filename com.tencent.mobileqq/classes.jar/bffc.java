...
public class bffc
{
  ...
  public bffc(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private void a(Activity paramActivity, int paramInt, String paramString, vux paramvux)
  {
    if (paramActivity == null) {
      return;
    }
    String str = ajjy.a(2131644911);
    if (1 == paramInt) {
      paramString = str + ajjy.a(2131644914) + paramString + ajjy.a(2131644909);
    }
    for (;;)
    {
      babr.a(paramActivity, 230, paramActivity.getString(2131632640), paramString, 2131632634, 2131632634, new bffl(this, paramvux), null).show();
      return;
      if (2 == paramInt) {
        paramString = str + ajjy.a(2131644913) + paramString + ajjy.a(2131644908);
      } else {
        paramString = ajjy.a(2131644910);
      }
    }
  }
  ...
  public static void a(Context paramContext, int paramInt, Bundle paramBundle)
  {
    if (paramContext == null)
    {
      ...
      Toast.makeText(BaseApplication.getContext(), ajjy.a(2131644912), 0).show();
      return;
    }
    ...
    if ((paramContext instanceof xah)) {
  ...
  private void h()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 161	bffc:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +6 -> 14
    //   11: aload_0
    ...
    //   30: putfield 161	bffc:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   33: aload_0
    //   34: getfield 161	bffc:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   37: new 170	cooperation/qlink/QQProxyForQlink$9
    //   40: dup
    //   41: aload_0
    //   42: invokespecial 172	cooperation/qlink/QQProxyForQlink$9:<init>	(Lbffc;)V
    //   45: lconst_0
    //   46: ldc2_w 173
  ...
  private void j()
  {
    ...
    {
      this.jdField_b_of_type_AndroidContentBroadcastReceiver = new bffd(this);
  ...
  private void l()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 223	bffc:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   8: ifnonnull +58 -> 66
    //   11: aload_0
    //   12: new 225	bffe
    //   15: dup
    //   16: aload_0
    //   17: invokespecial 226	bffe:<init>	(Lbffc;)V
    //   20: putfield 223	bffc:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   37: aload_0
    //   38: getfield 28	bffc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   41: ifnull +11 -> 52
    //   44: aload_0
    //   45: getfield 28	bffc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   56: aload_1
    //   57: aload_0
    //   58: getfield 223	bffc:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   61: aload_2
    ...
    //   77: aload_0
    //   78: aconst_null
    //   79: putfield 223	bffc:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   82: goto -16 -> 66
    //   85: astore_1
    //   86: aload_0
    //   87: monitorexit
  ...
  private void m()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 223	bffc:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   6: ifnull +28 -> 34
    //   9: aload_0
    //   10: getfield 28	bffc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13: ifnull +13 -> 26
    //   16: aload_0
    //   17: getfield 28	bffc:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   44: aload_0
    //   45: getfield 223	bffc:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   51: aload_0
    //   52: aconst_null
    //   53: putfield 223	bffc:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   56: goto -22 -> 34
    //   59: astore_1
    //   60: aload_0
    //   61: monitorexit
  ...
  public void a(Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener1, DialogInterface.OnClickListener paramOnClickListener2, DialogInterface.OnClickListener paramOnClickListener3, String paramString)
  {
    ...
    {
      return;
      String str2 = babh.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin);
      String str1;
      if (str2 != null)
      {
        str1 = str2;
      ...
      {
        a("0X8004854", 1);
        paramOnClickListener3 = paramActivity.getResources().getString(2131632680) + str1 + paramActivity.getResources().getString(2131632681);
        ...
        {
          this.jdField_a_of_type_Bafb = babr.a(paramActivity, 230, paramActivity.getResources().getString(2131632641), paramOnClickListener3, paramActivity.getResources().getString(2131632682), paramActivity.getResources().getString(2131632682), paramOnClickListener2, null);
          label194:
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Bafb.setOnDismissListener(new bffi(this));
        return;
        label224:
        str1 = this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin;
        break;
        this.jdField_a_of_type_Bafb = babr.a(paramActivity, 230, paramActivity.getResources().getString(2131632641), paramOnClickListener3, paramActivity.getResources().getString(2131632682), paramActivity.getResources().getString(2131632683), paramOnClickListener1, paramOnClickListener2);
        break label194;
        if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode == 2)
        {
          a("0X8004856", 1);
          paramOnClickListener1 = str1 + paramActivity.getResources().getString(2131632679);
          this.jdField_a_of_type_Bafb = babr.a(paramActivity, 230, paramActivity.getResources().getString(2131632641), paramOnClickListener1, paramActivity.getResources().getString(2131632678), paramActivity.getResources().getString(2131632678), paramOnClickListener3, null);
          this.jdField_a_of_type_Bafb.show();
        }
  ...
  public void a(Activity paramActivity, ArrayList<String> paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean, String paramString)
  {
    ...
    paramActivity.finish();
    return;
    a(paramActivity, new bfff(this, paramArrayList, paramActivity, paramInt1, paramBoolean), new bffg(this), new bffh(this), paramString);
  }
  ...
  public void a(QlAndQQInterface.InsertFMFileInfo paramInsertFMFileInfo)
  {
    ...
    String str = apck.a(paramInsertFMFileInfo.filePath);
    long l1 = apck.a(paramInsertFMFileInfo.filePath);
    long l2 = awbi.a(-1000).uniseq;
    ...
    localFileManagerEntity.nFileType = apck.a(paramInsertFMFileInfo.filePath);
    ...
    if (localajjj.e(String.valueOf(localFileManagerEntity.peerUin)) != null)
    {
      localFileManagerEntity.peerType = 0;
      localFileManagerEntity.peerNick = apck.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInsertFMFileInfo.uin, null, 0);
      localFileManagerEntity.status = 1;
      if ((!localajjj.b(paramInsertFMFileInfo.uin)) && (!paramInsertFMFileInfo.bSend)) {
        break label356;
      }
      localFileManagerEntity.nOpType = 0;
      localFileManagerEntity.bSend = true;
      axwb.a(paramInsertFMFileInfo.filePath, 0L, 0, true);
    ...
    for (;;)
    {
      ...
      axwb.a(paramInsertFMFileInfo.filePath, l1, 0, false, null);
      axoy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), str, 0, null);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localFileManagerEntity);
    }
  }
  ...
  {
    String str = babh.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
    ajjj localajjj = (ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", paramString, paramString, 0, paramInt, 0, "", "", "", "");
  }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean, long paramLong1, long paramLong2, HashMap<String, String> paramHashMap)
  {
    ...
    bffu.a(paramString1, paramString2, paramBoolean, paramLong1, paramLong2, paramHashMap);
  }
  
  public void a(AppActivity paramAppActivity, String paramString, vux paramvux)
  {
    if ((paramAppActivity == null) || (paramString == null)) {
      return;
    }
    bffp localbffp = bffo.a(paramString);
    if (localbffp == null)
    {
      babr.a(paramAppActivity, 230, paramAppActivity.getString(2131632640), paramAppActivity.getString(2131632660), 2131632634, 2131632634, new bffj(this, paramvux), null).show();
      return;
    }
    if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mWorking)
    {
      a(paramAppActivity, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerNick, paramvux);
      return;
    }
    ...
    paramvux = new Bundle();
    paramvux.putString("url", paramString);
    paramvux.putString("key", localbffp.a);
    paramvux.putString("peerUin", localbffp.b);
    paramvux.putString("peerNick", localbffp.c);
    paramvux.putString("peerOS", localbffp.d);
    paramvux.putString("apSSID", localbffp.e);
    paramvux.putString("preSharedKey", localbffp.f);
    paramvux.putBoolean("fromqlink", bool);
    paramString = paramAppActivity.getIntent().getStringExtra("subfrom");
    if (paramString != null) {
      paramvux.putString("subfrom", paramString);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    a(paramAppActivity, 11, paramvux);
    paramAppActivity.finish();
  }
  
  public void a(AppActivity paramAppActivity, vux paramvux)
  {
    if (paramAppActivity == null) {
      return;
    }
    babr.a(paramAppActivity, 230, paramAppActivity.getString(2131632658), paramAppActivity.getString(2131632659), 2131632634, 2131632634, new bffk(this, paramvux), null).show();
  }
  ...
  public boolean a(String paramString, List<String> paramList)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      localSendFileInfo.sessionid = apck.a().longValue();
      localSendFileInfo.filePath = paramList;
      localSendFileInfo.fileSize = apck.a(paramList);
  ...
  {
    if (1 == paramInt) {
      apck.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext());
    }
  }
