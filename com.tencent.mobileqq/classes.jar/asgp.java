  ...
  extends beej
{
  ...
  public asgp(NearbyHybridFragment paramNearbyHybridFragment, Context paramContext, Activity paramActivity, AppInterface paramAppInterface)
  {
  ...
  public void a()
  {
    ...
    for (long l = System.currentTimeMillis();; l = 0L)
    {
      ...
      auwz.a("WebSpeedTrace", "mInitWebViewTime", new Object[] { Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqFragmentNearbyHybridFragment.jdField_a_of_type_ComTencentMobileqqActivityNearbyActivity.k) });
      return;
    }
  }
  ...
  public void bindJavaScript(ArrayList<WebViewPlugin> paramArrayList)
  {
    if (paramArrayList != null)
    {
      ...
      paramArrayList.add(new zfn());
      paramArrayList.add(new bjxl());
    }
  }
  ...
  public void onPageFinished(WebView paramWebView, String paramString)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqFragmentNearbyHybridFragment.jdField_a_of_type_Ashu != null)
      {
        this.jdField_a_of_type_ComTencentMobileqqFragmentNearbyHybridFragment.jdField_a_of_type_Ashu.a(true);
        this.jdField_a_of_type_ComTencentMobileqqFragmentNearbyHybridFragment.jdField_a_of_type_Ashu.a();
      }
      this.d = true;
