...
class asgp
  extends bhyn
{
  asgp(asgo paramasgo, File paramFile, CustomEmotionData paramCustomEmotionData, asfk paramasfk, List paramList1, IPicDownloadListener paramIPicDownloadListener, List paramList2, EntityManager paramEntityManager, VipComicFavorEmoStructMsgInfo paramVipComicFavorEmoStructMsgInfo, AtomicInteger paramAtomicInteger1, AtomicInteger paramAtomicInteger2) {}
  
  public void onDone(bhyo parambhyo)
  {
    super.onDone(parambhyo);
    if ((parambhyo.a() == 3) && (parambhyo.a == 0) && (this.jdField_a_of_type_JavaIoFile.exists()))
    {
      ...
      {
        parambhyo = SecUtil.getFileMd5(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.emoPath);
        if (!this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.md5.equals(parambhyo)) {
          QLog.i("VipComicMqqManager", 2, "init = " + this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.md5 + " , compute = " + parambhyo);
        }
      }
      ...
      asgo.a(this.jdField_a_of_type_Asgo, this.jdField_a_of_type_ComTencentMobileqqEmosmFavroamingIPicDownloadListener, this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData, true);
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_Asfk.a(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData);
      ...
      asgo.a(this.jdField_a_of_type_Asgo, this.jdField_a_of_type_ComTencentMobileqqEmosmFavroamingIPicDownloadListener, this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData, false);
    }
  }
}
