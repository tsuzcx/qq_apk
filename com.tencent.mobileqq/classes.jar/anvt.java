  ...
  extends ajjh
{
  ...
  DialogInterface.OnClickListener jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new anvu(this);
  DialogInterface.OnDismissListener jdField_a_of_type_AndroidContentDialogInterface$OnDismissListener = new anvw(this);
  private bafb jdField_a_of_type_Bafb;
  DialogInterface.OnClickListener b = new anvv(this);
  
  public anvt(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  
  private void a()
  {
    if ((this.jdField_a_of_type_Bafb != null) && (this.jdField_a_of_type_Int != 0))
    {
      localObject1 = (Bundle)baah.a().a("SecWarningCfg", "AlertTitle", 147, this.jdField_a_of_type_Int);
    ...
    {
      Object localObject2 = (Bundle)baah.a().a("SecWarningCfg", "AlertText", 147, this.jdField_a_of_type_Int);
      if (localObject2 != null) {}
      for (Object localObject3 = ((Bundle)localObject2).getString("AlertText");; localObject3 = null)
      {
        localObject2 = (Bundle)baah.a().a("SecWarningCfg", "AlertLeftBtnText", 147, this.jdField_a_of_type_Int);
        if (localObject2 != null) {}
        for (localObject2 = ((Bundle)localObject2).getString("AlertLeftBtnText");; localObject2 = null)
        {
          Object localObject4 = (Bundle)baah.a().a("SecWarningCfg", "AlertRightBtnText", 147, this.jdField_a_of_type_Int);
          ...
          for (localObject4 = ((Bundle)localObject4).getString("AlertRightBtnText");; localObject4 = null)
          {
            ...
            else
            {
              ...
              if (localObject3 == null)
              {
                ...
                localObject1 = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131653289);
              }
              if (localObject2 != null) {
                break label407;
              }
              ...
              localObject2 = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131653283);
            }
            for (;;)
            {
              this.jdField_a_of_type_Bafb.setTitle((String)localObject5);
              this.jdField_a_of_type_Bafb.setMessage((CharSequence)localObject1);
              this.jdField_a_of_type_Bafb.setNegativeButton((String)localObject3, this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener);
              this.jdField_a_of_type_Bafb.setPositiveButton((String)localObject2, this.b);
              if ((this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener == null) || (this.b == null)) {
                this.jdField_a_of_type_Bafb.findViewById(2131297894).setVisibility(8);
              }
              return;
              i = 2131653292;
              break;
              ...
              {
                localObject1 = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131653287);
                break label203;
              }
              if (this.jdField_a_of_type_Int == 3)
              {
                localObject1 = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131653291);
                break label203;
              }
              localObject1 = localObject3;
              ...
              localObject1 = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131653290);
              break label203;
              localObject3 = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131653284);
              break label223;
              localObject3 = localObject2;
              ...
              localObject3 = localObject2;
              break label223;
              localObject2 = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131653282);
              continue;
  ...
  protected void onAddFriend(String paramString)
  {
    ...
    {
      return;
      localanwq = ((Face2FaceFriendBubbleView)localObject).a();
      if ((localanwq != null) && (this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)))
      {
        ...
        if ((!TextUtils.isEmpty(str)) && (localanwq != null) && (localanwq.jdField_a_of_type_Int == 1))
        {
          ((anws)localanwq).jdField_a_of_type_JavaLangString = str;
          ((Face2FaceFriendBubbleView)localObject).a(str);
        }
      }
    } while (!this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(localanwq));
    this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.jdField_a_of_type_Anvy.a(paramString);
  ...
  protected void onQueryUinSafetyFlag(boolean paramBoolean, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    baah.a().a(this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.app, "SecWarningCfg");
    try
    {
      this.jdField_a_of_type_Bafb = babr.a(this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity, 230, "", "", this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener, this.b);
      a();
      this.jdField_a_of_type_Bafb.setOnDismissListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnDismissListener);
  ...
  protected void onUpdateAddFriend(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString, Bundle paramBundle)
  {
    ...
    if (TextUtils.isEmpty(paramBundle)) {
      paramString = this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getString(2131626682);
    }
    bbmy.a(this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity, 0, paramString, 0).b(this.jdField_a_of_type_ComTencentMobileqqFacetofaceFace2FaceAddFriendActivity.getTitleBarHeight());
  }
