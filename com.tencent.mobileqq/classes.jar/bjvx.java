  ...
  implements Handler.Callback
{
  ...
  public Handler a;
  public View a;
  private final bjvz jdField_a_of_type_Bjvz;
  public boolean a;
  private boolean c;
  ...
  @TargetApi(19)
  public bjvx(Window paramWindow, boolean paramBoolean)
  {
    ViewGroup localViewGroup = (ViewGroup)paramWindow.getDecorView();
    if (ImmersiveUtils.isSupporImmersive() == 1) {
      this.c = paramBoolean;
    }
    this.jdField_a_of_type_Bjvz = new bjvz(paramWindow, this.c, null);
    if (this.c) {
  ...
  private void a(Window paramWindow, ViewGroup paramViewGroup)
  {
    ...
    paramWindow = new FrameLayout.LayoutParams(-1, this.jdField_a_of_type_Bjvz.a());
