...
{
  public adxz(UiApiPlugin paramUiApiPlugin, Integer paramInteger, String paramString1, String paramString2) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if (paramInt == 0)
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqJspUiApiPlugin.a = TroopMemberApiClient.a();
          this.jdField_a_of_type_ComTencentMobileqqJspUiApiPlugin.a.a();
        }
        this.jdField_a_of_type_ComTencentMobileqqJspUiApiPlugin.a.a(this.jdField_a_of_type_JavaLangInteger, this.jdField_a_of_type_JavaLangString, this.b, new adya(this, paramBundle));
      }
      return;
    }
