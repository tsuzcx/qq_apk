  ...
  implements acvf
{
  ...
  public adxz(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt, BaseChatPie paramBaseChatPie)
  {
  ...
  public FrameLayout a(LinearLayout paramLinearLayout)
  {
    ...
    this.jdField_a_of_type_Aelj = new aelj();
    this.jdField_a_of_type_Aelj.jdField_a_of_type_ComTencentMobileqqDataChatMessage = this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg;
    this.jdField_a_of_type_Aelj.jdField_a_of_type_AndroidWidgetRelativeLayout = this.jdField_a_of_type_Aela.b(this.jdField_a_of_type_Aelj, this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_Aelj.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg);
    Object localObject1 = paramLinearLayout.findViewById(2131373523);
    ...
    if (localObject1 == null)
    {
      ...
      this.jdField_a_of_type_Aelj.jdField_a_of_type_AndroidWidgetRelativeLayout = this.jdField_a_of_type_Aela.b(this.jdField_a_of_type_Aelj, this.jdField_a_of_type_AndroidContentContext);
      this.jdField_a_of_type_Aelj.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg);
      ((FrameLayout)localObject2).addView(this.jdField_a_of_type_Aelj.jdField_a_of_type_AndroidWidgetRelativeLayout, a(i, j, k, m));
      View localView = paramLinearLayout.findViewById(2131373548);
      localObject1 = localObject2;
      if (this.jdField_a_of_type_Aelj.b != null)
      {
    ...
    for (;;)
    {
      ...
      return localObject1;
      label305:
      ((FrameLayout)localObject2).addView(this.jdField_a_of_type_Aelj.b, (ViewGroup.LayoutParams)localObject1);
      break;
      ...
      if ((localObject1 instanceof FrameLayout))
      {
        ...
        this.jdField_a_of_type_Aelj.jdField_a_of_type_AndroidWidgetRelativeLayout = this.jdField_a_of_type_Aela.b(this.jdField_a_of_type_Aelj, this.jdField_a_of_type_AndroidContentContext);
        this.jdField_a_of_type_Aelj.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg);
        ((FrameLayout)localObject1).addView(this.jdField_a_of_type_Aelj.jdField_a_of_type_AndroidWidgetRelativeLayout, a(i, j, k, m));
        localObject2 = new RelativeLayout.LayoutParams(i, j);
        paramLinearLayout = paramLinearLayout.findViewById(2131373548);
        if (paramLinearLayout != null) {
          paramLinearLayout.setLayoutParams((ViewGroup.LayoutParams)localObject2);
        } else {
          ((FrameLayout)localObject1).addView(this.jdField_a_of_type_Aelj.b, (ViewGroup.LayoutParams)localObject2);
        }
      }
      else
      {
  ...
  public void a(RedPackGrapInfo paramRedPackGrapInfo)
  {
    ...
    this.jdField_a_of_type_Int = aelp.a(paramRedPackGrapInfo.iMsgType);
  ...
  {
    int i = aelp.a(paramMessageForQQWalletMsg.messageType);
    paramMessageForQQWalletMsg = aelp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Aelj, paramMessageForQQWalletMsg.mQQWalletRedPacketMsg.elem, i, this);
    if ((paramMessageForQQWalletMsg instanceof aelm)) {
      ((aelm)paramMessageForQQWalletMsg).a(new baxy(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
    }
    try
    {
  ...
  public boolean a(FrameLayout paramFrameLayout, RedPackGrapInfo paramRedPackGrapInfo, agyt paramagyt)
  {
    if (paramFrameLayout == null) {
      return false;
    }
    this.jdField_a_of_type_Aela.a(paramagyt);
    paramFrameLayout = (RelativeLayout)paramFrameLayout.findViewById(2131373523);
    if (paramFrameLayout == null) {
      return false;
    }
    ...
    if (this.jdField_a_of_type_AndroidContentContext != null) {
      this.jdField_a_of_type_AndroidContentContext.getString(2131717336);
    }
    return this.jdField_a_of_type_Aela.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, paramFrameLayout, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_Int, paramRedPackGrapInfo.iSkinId, "");
  }
