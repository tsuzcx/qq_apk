  ...
  implements ahan
{
  ...
  public agzj(QQAppInterface paramQQAppInterface, ahap paramahap, Activity paramActivity, SessionInfo paramSessionInfo, aeqo paramaeqo)
  {
  ...
  public View a(Object... paramVarArgs)
  {
    ...
    ((TextView)paramVarArgs.findViewById(2131373449)).setText(2131691892);
    ((ImageView)paramVarArgs.findViewById(2131373447)).setImageResource(2130849291);
    paramVarArgs.findViewById(2131373446).setOnClickListener(new agzk(this));
    return paramVarArgs;
  }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (aozd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 1)) {
          return;
        }
        ...
        if (j >= 0)
        {
          ...
          {
            i = paramInt;
            if (abti.p(((ChatMessage)localObject2).msgtype))
            {
              i = paramInt;
