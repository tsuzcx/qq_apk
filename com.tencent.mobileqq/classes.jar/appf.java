  ...
  extends MSFServlet
{
  ...
  private void a(apoz paramapoz, oidb_0xdea.GetBarrageListRspBody paramGetBarrageListRspBody)
  {
    ...
    paramapoz.a(apoy.a().a(localList1, paramapoz.jdField_a_of_type_Apox.b)).b(localList2).a(m).b(n).c(k).a(bool).a();
  }
  
  void a(apoz paramapoz)
  {
    if (paramapoz == null)
    {
      if (QLog.isColorLevel()) {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("DanmuDataHolder", 2, "request called, param:" + paramapoz.a());
    }
    Object localObject = new oidb_0xdea.GetBarrageListReqBody();
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint64_group_code.set(paramapoz.jdField_a_of_type_Apox.b);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint64_barrage_seq.set(paramapoz.jdField_a_of_type_Apox.jdField_a_of_type_Long);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_last_update_time.set(paramapoz.jdField_a_of_type_Int);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_start_index.set(paramapoz.e);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_barrage_count.set(paramapoz.f);
    int i;
    if ((paramapoz.jdField_a_of_type_Apox.jdField_a_of_type_Int == 101) || (paramapoz.jdField_a_of_type_Apox.jdField_a_of_type_Int == 103))
    {
      i = 1;
      if (i == 0) {
        break label327;
      }
      ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_video_start_time.set(paramapoz.jdField_c_of_type_Int);
      ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_video_end_time.set(paramapoz.jdField_d_of_type_Int);
      label182:
      ((oidb_0xdea.GetBarrageListReqBody)localObject).terminal.set(0);
      switch (paramapoz.jdField_a_of_type_Apox.jdField_a_of_type_Int)
      {
      }
    }
    for (;;)
    {
      ...
      localObject = apoy.a().a();
      NewIntent localNewIntent = new NewIntent(((QQAppInterface)localObject).getApp(), appf.class);
      localNewIntent.putExtra("KEY_SEND_DATA", localReqBody.toByteArray());
      localNewIntent.putExtra("KEY_GROUP_UIN", paramapoz.jdField_a_of_type_Apox.b);
      localNewIntent.putExtra("KEY_TOPIC_UIN", paramapoz.jdField_a_of_type_Apox.jdField_a_of_type_Long);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if ((l1 == 0L) || (l2 == 0L))
    {
      ...
      for (;;)
      {
        apph.a(bool1, i, -1, false, "onReceive, topicUin:0, groupUin:0");
        return;
        bool1 = false;
      }
    }
    paramIntent = apoy.a().a(l2, l1);
    apoz localapoz = apoy.a().a(paramIntent);
    if (localapoz == null)
    {
      if (QLog.isColorLevel()) {
      ...
      {
        apph.a(bool1, i, -1, false, "onReceive, holder null");
        return;
      }
    }
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      {
        bool2 = true;
        int j = localapoz.jdField_a_of_type_Apox.jdField_a_of_type_Int;
        if (!bool1) {
          break label379;
        }
        paramIntent = "DanmuRsp Valid";
        label246:
        apph.a(bool2, i, j, bool1, paramIntent);
        if (!bool1) {
          break label395;
        }
        paramFromServiceMsg = localapoz.jdField_a_of_type_Appd;
        apox localapox = localapoz.jdField_a_of_type_Apox;
        bool2 = localapoz.jdField_a_of_type_Boolean;
        i = localapoz.b;
        if (!localapoz.jdField_a_of_type_Apox.jdField_a_of_type_Boolean) {
          break label386;
        }
        paramIntent = localapoz.jdField_c_of_type_JavaUtilList;
        label305:
        paramFromServiceMsg.a(localapox, true, bool2, i, (ArrayList)paramIntent, localapoz.jdField_a_of_type_JavaUtilList);
        localapoz.jdField_a_of_type_Apox.jdField_a_of_type_Boolean = true;
      }
      for (;;)
      {
        if ((!bool1) || (localapoz.jdField_a_of_type_Boolean)) {
          break label424;
        }
        if (QLog.isColorLevel()) {
        ...
        break label246;
        label386:
        paramIntent = localapoz.jdField_d_of_type_JavaUtilList;
        break label305;
        label395:
        localapoz.jdField_a_of_type_Appd.a(localapoz.jdField_a_of_type_Apox, false, localapoz.jdField_a_of_type_Boolean, localapoz.b, null, null);
      }
      label424:
      break;
    }
