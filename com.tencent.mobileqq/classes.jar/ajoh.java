  ...
  implements awbo
{
  ...
  public ajoh(QQAppInterface paramQQAppInterface)
  {
    this.a = paramQQAppInterface;
  }
  
  private boolean a(awcl paramawcl, String paramString)
  {
    if (paramawcl == null) {}
    while (paramawcl.a(paramString) == -1) {
      return false;
    }
    return true;
  }
  ...
  public ReqItem a(int paramInt)
  {
    ...
    if ((j - i > paramInt) || (j < i))
    {
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).client_ver.set("8.2.6");
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).mem.set((int)babp.d() / 1048576);
      ...
      Object localObject4 = baih.a((SharedPreferences)localObject1, "key_web_plugin_list" + this.a.getCurrentAccountUin(), null);
      if ((localObject4 != null) && (!((Set)localObject4).isEmpty()))
      {
        localObject3 = (awcl)this.a.getManager(12);
    ...
    if (paramRespItem != null)
    {
      ...
      if (i == 2) {
        try
        {
          ...
          {
            i = (int)bakz.a((byte[])localObject1, 0);
            paramRespItem = new byte[i - 4];
            bakz.a(paramRespItem, 0, (byte[])localObject1, 4, i - 4);
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        do
        {
          ...
          baih.a(paramRespItem, "key_web_plugin_list" + this.a.getCurrentAccountUin(), (Object[])localObject2);
