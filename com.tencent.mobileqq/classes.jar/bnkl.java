  ...
  implements bntf
{
  ...
  public bnkl(String paramString, int paramInt1, int paramInt2, long paramLong1, long paramLong2)
  {
  ...
  public bntg a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 <= paramInt2)
    {
      ...
      localbntg.jdField_a_of_type_JavaIoFile = ((File)localObject);
      if (paramInt2 < 1280) {
        break label278;
      }
      localObject = "720p";
    ...
    label278:
    label307:
    for (localbntg.jdField_a_of_type_Int = ((int)(819200 * 1.0D / paramInt1 * paramInt2));; localbntg.jdField_a_of_type_Int = 819200)
    {
      localbntg.jdField_a_of_type_Float = (paramInt1 / paramInt2);
      paramInt2 = i;
      if (this.jdField_b_of_type_Int <= 30) {
        paramInt2 = this.jdField_b_of_type_Int;
      }
      localbntg.jdField_b_of_type_Int = paramInt2;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("VideoCompressTask", 2, "CompressTask, step: getEncodeConfig() config.setRotation = " + localbntg.jdField_b_of_type_Boolean + ", scaleRate=" + localbntg.jdField_a_of_type_Float + ", videoBitRate=" + localbntg.jdField_a_of_type_Int + ", videoFrameRate=" + localbntg.jdField_b_of_type_Int + ", beginTime=" + localbntg.jdField_a_of_type_Long + ", endTime=" + localbntg.jdField_b_of_type_Long + ",quality:" + (String)localObject + ",videoLongestEdge=" + paramInt1);
      }
      return localbntg;
      paramInt2 = paramInt1;
      break;
