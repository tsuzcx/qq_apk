...
public class mco
  extends mvj
{
  public mco(ConferenceFlyTicketActivity paramConferenceFlyTicketActivity)
  {
  ...
  public void a(mvm parammvm)
  {
    ...
    for (;;)
    {
      try
      {
        String str1 = new String(parammvm.a.jdField_a_of_type_ArrayOfByte, "UTF-8");
        if (str1 != null)
        {
          try
          {
          ...
          catch (JSONException localJSONException)
          {
            ...
            i = -2;
            continue;
            this.a.jdField_a_of_type_Anwo.c(Long.parseLong(this.a.h));
            this.a.a(1, 0);
            return;
          }
          QLog.w(this.a.jdField_a_of_type_JavaLangString, 1, "OnAfterCreateDiscussionAsyncTask, IsSucc[" + parammvm.a.jdField_a_of_type_Boolean + "], retcode[" + i + "], result_code[" + str1 + "], mDiscID[" + this.a.h + "]");
          if ((i == 0) && (str1.equals("0")))
          {
            this.a.jdField_a_of_type_Anwo.a(Long.parseLong(this.a.h), this.a.c);
