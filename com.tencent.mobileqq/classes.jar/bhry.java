...
public class bhry
{
  ...
  public bhry a(long paramLong)
  {
    this.jdField_a_of_type_Long = paramLong;
    return this;
  }
  
  public bhry a(boolean paramBoolean)
  {
  ...
  public Pair<ArrayList<String>, ArrayList<String>> a(List<String> paramList, boolean paramBoolean, Map<String, LocalMediaInfo> paramMap1, Map<String, LocalMediaInfo> paramMap2)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      else
      {
        ...
        {
          int i = bhkd.getMediaType((LocalMediaInfo)localObject);
  ...
  public boolean a(Context paramContext, String paramString, boolean paramBoolean1, Map<String, LocalMediaInfo> paramMap1, Map<String, LocalMediaInfo> paramMap2, boolean paramBoolean2)
  {
    ...
    int i = bhkd.getMediaType(paramMap1);
    ...
    if (i == 1)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (l1 > this.b)
        {
          ...
          label234:
          paramString = String.format(paramContext.getResources().getString(2131689966), new Object[] { "" + paramMap1.format(d1), paramString });
        }
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        label560:
        for (paramMap1 = paramContext.getResources().getString(2131689836);; paramMap1 = paramContext.getResources().getString(2131689837))
        {
          paramBoolean2 = paramBoolean1;
          if (!paramBoolean1) {
            break;
          }
          blho.a(new SendByFile.1(this, paramContext, paramMap1));
          ...
          paramString = String.format(paramContext.getResources().getString(2131689967), new Object[] { "" + (this.c / 1024L / 1024L + 1L) });
          break label283;
          ...
          if (this.jdField_a_of_type_Boolean) {
            if (paramBoolean2) {
              paramString = String.format(paramContext.getResources().getString(2131689918), new Object[] { "" + this.jdField_a_of_type_Long / 1024L / 1024L });
            }
          }
          for (;;)
          {
            ...
            break;
            if (paramBoolean2) {
              paramString = String.format(paramContext.getResources().getString(2131689919), new Object[] { "" + this.jdField_a_of_type_Long / 1024L / 1024L });
            }
          }
        }
        label574:
