  ...
  implements Manager
{
  ...
  private aiwg jdField_a_of_type_Aiwg = new aiwg();
  private aiyr jdField_a_of_type_Aiyr;
  private aiyx jdField_a_of_type_Aiyx;
  private aizk jdField_a_of_type_Aizk;
  ajie jdField_a_of_type_Ajie;
  ajom jdField_a_of_type_Ajom;
  Handler jdField_a_of_type_AndroidOsHandler = new aisc(this, ThreadManager.getSubThreadLooper());
  private aukn jdField_a_of_type_Aukn;
  bbwf jdField_a_of_type_Bbwf = new aisg(this);
  private QQLruCache<String, ApolloBaseInfo> jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache = new aisa(this, 2009, 1024, ApolloBaseInfo.calcSelfMemorySize());
  ...
  Comparator<DrawerPushItem> jdField_a_of_type_JavaUtilComparator = new aisd(this);
  ...
  private List<aisi> jdField_b_of_type_JavaUtilList;
  private AtomicBoolean jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private bbwf jdField_c_of_type_Bbwf = new aise(this);
  private Runnable jdField_c_of_type_JavaLangRunnable = new ApolloManager.5(this);
  private List<WeakReference<aisk>> jdField_c_of_type_JavaUtilList = new ArrayList();
  public boolean c;
  public boolean d;
  ...
  public airz(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_OrgJsonJSONObject = new JSONObject();
    this.jdField_c_of_type_Boolean = true;
    this.jdField_d_of_type_Boolean = true;
    this.jdField_a_of_type_Long = -1L;
    this.jdField_b_of_type_Bbwf = new aish(this);
    ...
    {
      this.jdField_a_of_type_Ajom = new ajom();
      p();
      aizw.b();
    ...
    this.jdField_a_of_type_Aisr = new aisr(paramQQAppInterface);
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramQQAppInterface);
    this.jdField_a_of_type_Airx = new airx(paramQQAppInterface);
    n();
  }
    ...
    for (;;)
    {
      try
      {
        if (jdField_c_of_type_Int == -1)
        {
          ...
          {
            i1 = bbjn.q(paramAppInterface.getApplication());
            if (i1 != 0) {
              continue;
            }
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    ApolloBaseInfo localApolloBaseInfo = ((airz)paramQQAppInterface.getManager(153)).a(paramQQAppInterface.c());
    int i1;
  ...
  {
    if ((paramQQAppInterface == null) || (!b(paramQQAppInterface.getApplication())) || (TextUtils.isEmpty(paramString1)) || (ajmt.jdField_a_of_type_OrgJsonJSONObject == null)) {
      return -1;
    }
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      {
        paramString2 = (airz)paramQQAppInterface.getManager(153);
    ...
    if ((ajmt.jdField_a_of_type_OrgJsonJSONObject != null) && (str != null))
    {
      paramQQAppInterface = ajmt.jdField_a_of_type_OrgJsonJSONObject.optJSONObject(str);
      if (paramQQAppInterface == null) {}
    }
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return 0;
          paramQQAppInterface = ((airz)paramQQAppInterface.getManager(153)).a(paramString);
  ...
  {
    if ((paramList == null) || (paramList.size() == 0) || (this.jdField_a_of_type_Aukn == null)) {
    ...
    for (;;)
    {
      ...
      catch (Exception paramList)
      {
        for (;;)
        {
          ...
          this.jdField_a_of_type_Aukn.a(localDrawerPushItem);
        }
        localaukp.c();
        return;
      }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    //   52: dup
    //   53: getstatic 707	ajmu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    ApolloBaseInfo localApolloBaseInfo = ((airz)localObject).b(paramString1 + "");
    if ((localApolloBaseInfo == null) || (localApolloBaseInfo.apolloUpdateTime == 0L))
    {
      localbbqp.b(paramString1 + "");
      if (QLog.isColorLevel()) {
    ...
    for (paramQQAppInterface = paramString1.substring(0, 4);; paramQQAppInterface = paramString1)
    {
      ...
      do
      {
        ...
        localObject = ((airz)localObject).b(paramQQAppInterface.c());
        ...
        localbbqp.a(localArrayList, paramString2);
  ...
  private void a(ApolloActionPackage paramApolloActionPackage, JSONObject paramJSONObject)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localObject = ((ajmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramApolloActionPackage.packageId);
  ...
  public static boolean a()
  {
    ...
    bbdj.a(new File(ajmu.c, "/def/basic").getAbsolutePath());
    do
    {
      try
      {
        long l2 = System.currentTimeMillis();
        a(BaseApplicationImpl.getApplication().getApplicationContext(), "apollo_def_rsc", ajmu.jdField_a_of_type_JavaLangString + "/apollo_def_rsc");
        long l3 = System.currentTimeMillis();
        if (QLog.isColorLevel()) {
          QLog.d("ApolloManager", 2, "copy file to sdcard cost:" + (l3 - l2));
        }
        new File(ajmu.c, "def").mkdirs();
        int i1 = LzmaUtils.a(BaseApplicationImpl.getApplication().getApplicationContext(), ajmu.jdField_a_of_type_JavaLangString + "/apollo_def_rsc", ajmu.c + "/def/");
        bbdj.d(ajmu.jdField_a_of_type_JavaLangString + "/apollo_def_rsc");
        if (i1 != 0) {
          continue;
        }
        boolean bool2 = true;
  ...
  {
    String str = ajmu.s + paramString1 + ".zip";
    localObject1 = ajmu.s + paramString1 + ".patch";
    localObject2 = ajmu.s + paramString1 + ".patched";
    ...
    for (;;)
    {
      try
      {
        if (jdField_d_of_type_Int == -1)
        {
          ...
          if (paramAppInterface != null)
          {
            i1 = bbjn.r(paramAppInterface.getApplication());
  ...
  public static int b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            paramString = ((airz)localObject).a(paramString);
      ...
      localObject = ((airz)localObject).a(paramQQAppInterface.c());
  ...
  public static void b(boolean paramBoolean)
  {
    ...
    akvj.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
  }
  ...
  public static int c(String paramString)
  {
    ...
    do
    {
      ...
      i2 = ajmt.b.optInt(paramString);
      i1 = i2;
    } while (i2 != 2);
    return jdField_e_of_type_Int;
    return ajmt.b.optInt(paramString);
  }
  ...
  public static boolean d()
  {
    ...
    do
    {
      ...
      {
        return false;
        if (!ajmt.b.has("autoOpenBox")) {
          break;
        }
        if (QLog.isColorLevel()) {
          QLog.d("ApolloManager", 2, new Object[] { "openBoxByH5 autoOpenBox:", Integer.valueOf(ajmt.b.optInt("autoOpenBox")) });
        }
      } while (ajmt.b.optInt("autoOpenBox") != 0);
      return true;
    } while (!QLog.isColorLevel());
  ...
  public static boolean f()
  {
    ...
    try
    {
      String str = ajmu.av + "cmshow_script_engine.js";
      localFile = new File(str);
      bool1 = bool2;
      if (localFile.exists())
      {
        if (new ajox(str + ".sig", str).a(1)) {
          break label181;
        }
    ...
    if (bool1)
    {
      jdField_d_of_type_JavaLangString = bbdj.b(localFile);
      return bool1;
    }
  ...
  public static boolean g()
  {
    ...
    try
    {
      String str = ajmu.av + "cmshow_script_0.js";
      localFile = new File(str);
      bool1 = bool2;
      if (localFile.exists())
      {
    ...
    if (bool1)
    {
      jdField_e_of_type_JavaLangString = bbdj.b(localFile);
      return bool1;
    }
  ...
  private void n()
  {
    ...
    try
    {
      BaseApplicationImpl.getContext().registerReceiver(this.jdField_a_of_type_Aisj, localIntentFilter, "com.tencent.msg.permission.pushnotify", null);
      return;
    }
    catch (Exception localException)
    {
  ...
  private void q()
  {
    ...
    //   18: aload_0
    //   19: getfield 1671	airz:v	Z
    //   22: ifne +550 -> 572
    //   25: aload_0
    //   26: getfield 1671	airz:v	Z
    //   29: ifeq +4 -> 33
    //   32: return
    //   33: aload_0
    //   34: getfield 235	airz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   37: ifnull +293 -> 330
    //   40: aload_0
    //   41: getfield 235	airz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   52: lstore_3
    //   53: aload_0
    //   54: getfield 252	airz:jdField_a_of_type_Aukn	Laukn;
    //   57: ldc 146
    //   59: invokevirtual 1674	aukn:a	(Ljava/lang/Class;)Ljava/util/List;
    ...
    //   152: aload_0
    //   153: getfield 155	airz:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   156: astore 6
    //   158: aload 6
    //   160: monitorenter
    //   161: aload_0
    //   162: getfield 155	airz:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   165: aload 8
    ...
    //   192: aload_0
    //   193: aload 8
    //   195: putfield 413	airz:jdField_a_of_type_ComTencentMobileqqDataApolloBaseInfo	Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   198: aload_0
    //   199: aload_0
    //   200: getfield 413	airz:jdField_a_of_type_ComTencentMobileqqDataApolloBaseInfo	Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   203: getfield 1692	com/tencent/mobileqq/data/ApolloBaseInfo:apolloAISwitch	I
    //   206: iconst_0
    //   207: invokevirtual 1695	airz:a	(II)V
    //   210: goto -125 -> 85
    //   213: astore 5
    ...
    //   236: ifeq -204 -> 32
    //   239: aload_0
    //   240: getfield 235	airz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   243: ifnull -211 -> 32
    //   246: aload_0
    //   247: getfield 155	airz:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   250: aload_0
    //   251: getfield 235	airz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   293: aload_0
    //   294: getfield 155	airz:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    ...
    //   345: athrow
    //   346: aload_0
    //   347: getfield 252	airz:jdField_a_of_type_Aukn	Laukn;
    //   350: ldc_w 550
    //   353: invokevirtual 1674	aukn:a	(Ljava/lang/Class;)Ljava/util/List;
    //   356: checkcast 101	java/util/ArrayList
    //   359: astore 6
    //   361: aload 6
    //   363: ifnull +124 -> 487
    //   366: aload_0
    //   367: getfield 132	airz:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   370: astore 5
    //   372: aload 5
    //   374: monitorenter
    //   375: aload_0
    //   376: getfield 135	airz:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   434: aload_0
    //   435: aload 7
    //   437: invokevirtual 683	airz:a	(Lcom/tencent/mobileqq/DrawerPushItem;)Z
    //   440: ifne +31 -> 471
    //   443: aload_0
    //   444: getfield 135	airz:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   447: aload 7
    ...
    //   468: goto -253 -> 215
    //   471: aload_0
    //   472: getfield 252	airz:jdField_a_of_type_Aukn	Laukn;
    //   475: aload 7
    //   477: invokevirtual 1709	aukn:b	(Laukm;)Z
    //   480: pop
    //   481: goto -80 -> 401
    //   484: aload 5
    //   486: monitorexit
    //   487: aload_0
    //   488: getfield 235	airz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   491: ifnull +61 -> 552
    //   494: aload_0
    //   495: getfield 235	airz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   549: putfield 1719	airz:k	Ljava/lang/String;
    //   552: aload_0
    //   553: iconst_1
    //   554: putfield 1671	airz:v	Z
    //   557: goto -324 -> 233
    //   560: astore 5
    //   562: iconst_0
    //   563: istore_1
  ...
  private void r()
  {
    ...
    try
    {
      ??? = (ArrayList)this.jdField_a_of_type_Aukn.a(ApolloPandora.class);
      if (??? != null)
      {
  ...
  public airx a()
  {
    return this.jdField_a_of_type_Airx;
  }
  ...
  public aism a()
  {
    ...
    try
    {
      ...
      return this.jdField_a_of_type_Aism;
    }
    finally {}
  }
  ...
  public aisr a()
  {
    return this.jdField_a_of_type_Aisr;
  }
  
  public aiwg a()
  {
    return this.jdField_a_of_type_Aiwg;
  }
  ...
  public aiyr a()
  {
    try
    {
      if (this.jdField_a_of_type_Aiyr == null) {
        this.jdField_a_of_type_Aiyr = new aiyr(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      aiyr localaiyr = this.jdField_a_of_type_Aiyr;
      return localaiyr;
    }
    finally {}
  }
  ...
  public aiyx a()
  {
    try
    {
      if (this.jdField_a_of_type_Aiyx == null) {
        this.jdField_a_of_type_Aiyx = new aiyx(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      aiyx localaiyx = this.jdField_a_of_type_Aiyx;
      return localaiyx;
    }
    finally {}
  }
  ...
  public aizk a()
  {
    if (this.jdField_a_of_type_Aizk == null) {
      this.jdField_a_of_type_Aizk = new aizk(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    return this.jdField_a_of_type_Aizk;
  }
  
  public ajie a()
  {
    if (this.jdField_a_of_type_Ajie == null) {
      this.jdField_a_of_type_Ajie = new aisb(this);
    }
    return this.jdField_a_of_type_Ajie;
  }
  ...
  public bbwl a()
  {
    ...
    return ((bbwi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47)).a(3);
  }
  ...
  public DrawerPushItem a(String paramString1, String paramString2, JSONObject paramJSONObject, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      label496:
      if (paramInt == 1) {
        localDrawerPushItem.ext_url = ajmu.T;
      } else if (paramInt == 2) {
  ...
  public ApolloActionData a(QQAppInterface paramQQAppInterface, String paramString, int... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      ajhw.a(paramQQAppInterface, ApolloUtil.a(paramString, 4), paramVarArgs);
  ...
  public ApolloPandora a(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localApolloPandora = (ApolloPandora)this.jdField_a_of_type_Aukn.a(ApolloPandora.class, paramString);
      ??? = localApolloPandora;
  ...
  public String a()
  {
    if ((!this.f) && (!this.jdField_l_of_type_Boolean)) {
      return ajyc.a(2131700456);
    }
    return ajyc.a(2131700453);
  }
  ...
  public String a(int paramInt)
  {
    ...
    if (((ajmw)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() == 0) {
      ((ajmw)localObject1).a();
    }
    for (;;)
    {
      localObject2 = (String)((ajmw)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
      ...
      return localObject1;
      if (TextUtils.isEmpty((CharSequence)((ajmw)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt)))) {
        ((ajmw)localObject1).a(paramInt);
      }
    }
  }
  ...
  public String a(int paramInt, String paramString)
  {
    ...
    for (paramInt = 2;; paramInt = 1)
    {
      ...
      for (;;)
      {
        ...
        if (bool)
        {
          ...
          if (i2 == 1)
          {
            ...
            if (a() != null)
            {
              ...
              {
                localObject2 = localObject1;
                if (!TextUtils.isEmpty(ajmu.ao))
                {
                  localObject2 = ajmu.ao;
        ...
        {
          paramString = (String)localObject2;
          if (ajmu.ao.equals(localObject2)) {
  ...
  public String a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      for (long l1 = 0L; (localApolloBaseInfo.appearAction == null) && (NetConnInfoCenter.getServerTime() - l1 > 180L); l1 = ((Long)this.jdField_a_of_type_JavaUtilMap.get(paramString)).longValue())
      {
        ...
        ((bbqp)paramQQAppInterface.a(71)).a(new long[] { Long.parseLong(paramString) });
  ...
  public String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if (paramString2.jdField_a_of_type_JavaLangString != null) {
      paramQQAppInterface = bfng.a(paramString1, "facedata", paramString2.jdField_a_of_type_JavaLangString);
    }
    paramString1 = paramQQAppInterface;
    if (paramString2.a() != null) {
      paramString1 = bfng.a(paramQQAppInterface, "dressids", Arrays.toString(paramString2.a()).replaceAll(" ", ""));
    }
    return bfng.a(paramString1, "roleid", String.valueOf(paramString2.jdField_a_of_type_Int));
  }
  ...
  public String a(String paramString, boolean paramBoolean)
  {
    ...
    return a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ajmu.ao, paramString);
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (a() != null)
    {
      localObject = new bbwg((List)localObject, localHashMap, "apollo_json_task" + System.currentTimeMillis());
      ((bbwg)localObject).p = true;
      ((bbwg)localObject).j = false;
      ((bbwg)localObject).n = true;
      ((bbwg)localObject).s = false;
      ((bbwg)localObject).f = "apollo_res";
      ((bbwg)localObject).r = true;
      ((bbwg)localObject).q = true;
      a().a((bbwg)localObject, this.jdField_a_of_type_Bbwf, localBundle);
      if ((paramInt & 0x1) == 1) {
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    ajmw localajmw = (ajmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
    if (localajmw.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null) {
      localajmw.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt), paramString);
    }
  ...
  public void a(aisi paramaisi)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 2148	airz:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   6: ifnonnull +17 -> 23
    //   9: aload_0
    ...
    //   20: putfield 2148	airz:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   23: aload_0
    //   24: getfield 2148	airz:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   27: astore_2
    //   28: aload_2
    //   29: monitorenter
    //   30: aload_0
    //   31: getfield 2148	airz:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   34: aload_1
  ...
  public void a(aisk paramaisk)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ApolloManager", 2, new Object[] { "[setApolloStatusUpdateListener] listener=", paramaisk });
    }
    this.jdField_c_of_type_JavaUtilList.add(new WeakReference(paramaisk));
  }
  ...
  public void a(ajov paramajov)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Ajom != null) {
        this.jdField_a_of_type_Ajom.a(paramajov);
      }
      return;
    }
    finally
  ...
  public void a(DrawerPushItem paramDrawerPushItem, boolean paramBoolean)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if ((this.jdField_a_of_type_JavaUtilList != null) && (!a(paramDrawerPushItem)))
      {
        ...
        if ((this.jdField_a_of_type_Aukn != null) && (paramBoolean)) {
          this.jdField_a_of_type_Aukn.a(paramDrawerPushItem);
        }
        if (QLog.isColorLevel()) {
  ...
  {
    if ((paramSessionInfo.jdField_a_of_type_Int != 0) && (paramSessionInfo.jdField_a_of_type_Int != 1) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (bbev.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))) {}
    do
    {
      do
      {
  ...
  public void a(ApolloPreDownloadData paramApolloPreDownloadData, String paramString1, String paramString2)
  {
    ...
    bbdj.a(paramString1, paramString2, false);
    if (TextUtils.isEmpty(paramApolloPreDownloadData.zipDir)) {
      localFile.delete();
    }
    paramString2 = (ajmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
  ...
  {
    if ((paramApolloActionData == null) && (!bbdj.a(ApolloUtil.a(paramApolloActionData, 7)))) {}
    while ((!a(bbdj.a(new File(ApolloUtil.a(paramApolloActionData, 7))), paramApolloActionData)) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ((ajmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramApolloActionData);
  }
  ...
  public void a(String paramString1, String paramString2, aiso paramaiso)
  {
    ...
    do
    {
      return;
      localbbwl = a();
    } while ((localbbwl == null) || (localbbwl.a(paramString1) != null));
    File localFile = new File(paramString2);
    paramString2 = new bbwg(paramString1, localFile);
    if (localFile.exists())
    {
    ...
    localbbwl.a(paramString2, new aisp(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramaiso), paramString1);
  }
  ...
  public void a(List<ApolloActionData> paramList, String paramString)
  {
    ...
    do
    {
      ...
      paramList = new bbwg(localArrayList, localHashMap, paramString);
      paramList.n = true;
    ...
    a().a(paramList, this.jdField_b_of_type_Bbwf, localBundle);
  }
  ...
  public void a(List<String> paramList, Map<String, File> paramMap, List<ApolloActionData> paramList1, Bundle paramBundle)
  {
    ...
    if (i1 < paramList1.size())
    {
      ...
      if (!apvb.a((String)localObject)) {
        break label216;
      }
      localObject = new bbwg(str1, new File((String)localObject));
      Bundle localBundle = new Bundle();
      localBundle.putSerializable(str1, localApolloActionData);
      ((bbwg)localObject).c = str1;
      ((bbwg)localObject).a(localBundle);
      this.jdField_b_of_type_Bbwf.onDoneFile((bbwg)localObject);
    }
    for (;;)
    {
  ...
  public void a(Map<String, ApolloPreDownloadData> paramMap)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          if ((localObject == null) || (((ApolloPreDownloadData)localObject).status == 0) || (localApolloPreDownloadData.version > ((ApolloPreDownloadData)localObject).version))
          {
            ...
            for (localObject = ApolloUtil.e(localApolloPreDownloadData.dirType) + localApolloPreDownloadData.zipDir;; localObject = ajmu.t + localApolloPreDownloadData.resId + ".zip")
            {
      ...
      paramMap = new bbwg(localArrayList, localHashMap, "apollo_preDownload");
      paramMap.n = true;
    ...
    a().a(paramMap, this.jdField_c_of_type_Bbwf, localBundle);
  }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if ((paramBoolean) || (((paramInt & 0x1) == 1) && (!apvb.a(ApolloUtil.jdField_a_of_type_JavaLangString))))
    {
      a(paramInt);
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((TextUtils.isEmpty(paramArrayOfByte)) || (ajmt.a("8.2.8", paramArrayOfByte) >= 0)) {
          break label334;
        }
  ...
  protected boolean a(aukm paramaukm)
  {
    ...
    QLog.e("ApolloManager", 2, "updateEntity em closed e=" + paramaukm.getTableName());
    return false;
  }
  ...
  public boolean a(ApolloActionData paramApolloActionData, int paramInt, ajov paramajov)
  {
    if (paramApolloActionData == null) {}
    for (;;)
    {
      ...
      if ((paramInt & 0x1) == 1)
      {
        ...
        {
          localObject1 = new bbwg((String)localObject1, new File((String)localObject2));
          ((bbwg)localObject1).f = "apollo_res";
          ((bbwg)localObject1).jdField_b_of_type_Int = 1;
          ((bbwg)localObject1).n = true;
          ((bbwg)localObject1).q = true;
          ((bbwg)localObject1).r = true;
          i1 = bbwi.a((bbwg)localObject1, a());
          if (i1 != 0) {
            continue;
          }
          if (QLog.isColorLevel()) {
      ...
      if ((paramInt & 0x4) == 4)
      {
        ...
        {
          localObject2 = new bbwg((String)localObject2, new File((String)localObject1));
          ...
          paramInt = bbwi.a((bbwg)localObject2, a());
          if (paramInt != 0) {
            continue;
          }
          if (QLog.isColorLevel()) {
      ...
      try
      {
        bbdj.a((String)localObject1, ApolloUtil.a(paramApolloActionData, 6), false);
      ...
      catch (Exception localException)
      {
        ...
        paramajov.b(paramApolloActionData);
      }
    }
    return true;
  }
  ...
  public boolean a(ApolloActionPackage paramApolloActionPackage)
  {
    ...
    do
    {
      ...
      paramApolloActionPackage = new bbwg(ApolloUtil.b(paramApolloActionPackage), new File(ApolloUtil.a(paramApolloActionPackage)));
      ...
      i1 = bbwi.a(paramApolloActionPackage, a());
    } while (i1 != 0);
    if (QLog.isColorLevel()) {
      QLog.d("ApolloManager", 2, "ret:" + i1);
    }
  ...
  public ApolloBaseInfo b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((0 == 0) && (!this.v))
      {
        ??? = (ApolloBaseInfo)this.jdField_a_of_type_Aukn.a(ApolloBaseInfo.class, paramString);
        if (bool) {
  ...
  public void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      i1 = bbjn.q(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication());
      if (i1 != 0) {
        break label139;
      }
  ...
  void b(int paramInt1, int paramInt2)
  {
    if ((!ApolloUtil.a(paramInt1, paramInt2)) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      ...
      ajhw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, str);
    }
  }
  
  public void b(ajov paramajov)
  {
    if ((paramajov != null) && (this.jdField_a_of_type_Ajom != null)) {
      this.jdField_a_of_type_Ajom.b(paramajov);
    }
  }
    ...
    if (paramApolloActionData != null)
    {
      ...
      if (((File)localObject).exists()) {
        try
        {
          ...
          {
            boolean bool = apvb.c(ApolloUtil.a(paramApolloActionData, 6));
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localDrawerPushItem.msg_id != null) && (localDrawerPushItem.msg_id.equals(paramString)))
        {
          ...
          this.jdField_a_of_type_Aukn.b(localDrawerPushItem);
          if (QLog.isColorLevel()) {
  ...
  public boolean b()
  {
    ...
    try
    {
      localObject1 = bbdj.b(new File(ApolloUtil.jdField_a_of_type_JavaLangString));
      if (QLog.isColorLevel())
      {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
        {
          localObject3 = (ajmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
          ((ajmw)localObject3).a(false, localArrayList4);
          ((ajmw)localObject3).b();
          ((ajmw)localObject3).a(localArrayList1);
          ((ajmw)localObject3).b(1);
          ((ajmw)localObject3).c(localArrayList2);
          ((ajmw)localObject3).d();
          ((ajmw)localObject3).d(localArrayList3);
          ...
          this.jdField_a_of_type_Ajom.a(Boolean.valueOf(true));
          m();
        }
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
        {
          ...
          if (!((SharedPreferences)localObject3).getBoolean("8.2.8" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false)) {
            ((SharedPreferences)localObject3).edit().putBoolean("8.2.8" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true).commit();
          }
          if (localObject1 != null)
          {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
          ((airz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).l();
        }
      }
      catch (Exception localException)
      {
  ...
  public boolean b(ApolloActionPackage paramApolloActionPackage)
  {
    ...
    return apvb.a(ApolloUtil.a(paramApolloActionPackage));
  }
  ...
  public void c(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      i1 = bbjn.r(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication());
      if (i1 != 0) {
        break label137;
      }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    if (((paramInt1 & 0x1) != (paramInt2 & 0x1)) || ((paramInt1 & 0x2) != (paramInt2 & 0x2)))
    {
      ...
      if (this.jdField_c_of_type_JavaUtilList != null)
      {
        ...
        while (localIterator.hasNext())
        {
          aisk localaisk = (aisk)((WeakReference)localIterator.next()).get();
          if (localaisk != null) {
            localaisk.a(paramInt1, bool);
          }
        }
      }
    }
  ...
  public void d(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (ajmt.a("8.2.8", str1, (String)localObject2))
      {
  ...
  public void h()
  {
    ...
    {
      return;
      localakvj = (akvj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(115);
    } while ((localakvj == null) || (!localakvj.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()));
    QLog.w("ApolloManager", 1, "config is done, then request update");
    ArrayList localArrayList = new ArrayList();
    localakvj.b(localArrayList);
    localakvj.a(localArrayList);
    localakvj.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
  }
  
  public boolean h()
  {
    boolean bool = false;
    if ((BaseApplicationImpl.getContext().getSharedPreferences("apollo_sp", 0).getBoolean("is_new_user_bar_showed" + ajae.a().getCurrentAccountUin(), false)) || (this.i)) {
      bool = true;
    }
    return bool;
  }
  ...
  {
    boolean bool = false;
    if ((BaseApplicationImpl.getContext().getSharedPreferences("apollo_sp", 0).getBoolean("is_780_guide_showed" + ajae.a().getCurrentAccountUin(), false)) || (this.m)) {
      bool = true;
    }
    return bool;
  }
  ...
  public boolean k()
  {
    return this.jdField_a_of_type_Aiyr != null;
  }
  ...
  public void l()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      ApolloActionData localApolloActionData = ((ajmw)localObject).a(1450);
      if (localApolloActionData != null) {
        b(localApolloActionData.actionId, localApolloActionData.personNum);
      }
      localObject = ((ajmw)localObject).a(1454);
      if (localObject != null) {
  ...
  public void m()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      Object localObject2 = (ajmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
      localObject1 = ((ajmw)localObject2).d(400);
      if (((ajmw)localObject2).c(3000059) == null) {
        break label99;
      }
      if (localObject1 != null) {
        break label96;
  ...
  public void onDestroy()
  {
    ...
    try
    {
      BaseApplicationImpl.getContext().unregisterReceiver(this.jdField_a_of_type_Aisj);
      this.jdField_a_of_type_Aisj = null;
      if (QLog.isColorLevel()) {
      ...
      jdField_d_of_type_Int = -1;
      this.jdField_a_of_type_Aukn.a();
      ajhw.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        ajmq.a();
        if (this.jdField_a_of_type_Aizk != null) {
          this.jdField_a_of_type_Aizk.b();
        }
        if (this.jdField_a_of_type_Aiyx != null)
        {
          this.jdField_a_of_type_Aiyx.e();
          this.jdField_a_of_type_Aiyx = null;
        }
        if (this.jdField_a_of_type_Aiyr != null)
        {
          this.jdField_a_of_type_Aiyr.c();
          this.jdField_a_of_type_Aiyr = null;
        }
        j();
        aizw.a().a();
        ajcn localajcn = aizw.a().a();
        if (localajcn != null) {
          localajcn.a();
        }
        ajlu.a().a();
