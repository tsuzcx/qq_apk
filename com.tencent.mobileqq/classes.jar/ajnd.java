  ...
  extends ajfb
{
  ...
  public ajnd(AppInterface paramAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt, BusinessObserver paramBusinessObserver)
  {
    ...
    try
    {
      ...
      if ("1".equals(paramString2))
      {
        ...
        if (arrayOfByte != null) {
          localJSONObject.put("chat_sig", new String(baaw.encode(arrayOfByte, 0)));
        }
      }
      ...
      for (;;)
      {
        ...
        paramString1 = new NewIntent(paramQQAppInterface.getApplication().getApplicationContext(), mmi.class);
  ...
  public static void a(NearbyAppInterface paramNearbyAppInterface, long[] paramArrayOfLong, BusinessObserver paramBusinessObserver)
  {
    ...
    try
    {
      ...
      paramArrayOfLong = new NewIntent(paramNearbyAppInterface.getApplication().getApplicationContext(), mmi.class);
  ...
  private boolean a(oidb_0xada.ReqBody paramReqBody)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty((CharSequence)localObject)))
    {
      ...
      paramReqBody.version_code.set(amom.a(BaseApplicationImpl.sApplication));
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      paramObject = asfc.a("nearby_visitor_file", this.a.getAccount(), 0).edit();
      if (l1 > 0L)
      {
  ...
  cmd0x77f.VisitProfRec a(asfb paramasfb)
  {
    cmd0x77f.VisitProfRec localVisitProfRec = new cmd0x77f.VisitProfRec();
    localVisitProfRec.uint64_tinyid.set(paramasfb.jdField_a_of_type_Long);
    localVisitProfRec.uint32_seq.set(paramasfb.jdField_a_of_type_Int);
    if (paramasfb.c > 0) {
      localVisitProfRec.uint32_enter_count.set(paramasfb.c);
    }
    if (paramasfb.d > 0) {
      localVisitProfRec.uint32_visit_duration.set(paramasfb.d);
    }
    if (paramasfb.e > 0) {
      localVisitProfRec.uint32_visit_pic_count.set(paramasfb.e);
    }
    if (paramasfb.f > 0) {
      localVisitProfRec.uint32_opflag.set(paramasfb.f);
    }
    if (QLog.isColorLevel()) {
      QLog.d("NearbyHandler", 2, "convert2VisitRec ,record =" + paramasfb);
    }
  ...
  public void a(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramToServiceMsg.msg_self_info.has())
      {
        ...
        ((alzo)this.a.getManager(210)).a(this.a, paramObject);
        if (QLog.isColorLevel()) {
  ...
  public void a(List<asfb> paramList, boolean paramBoolean)
  {
    int j = 0;
    ...
    if (k <= 200)
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        ((cmd0x77f.ReqBody)localObject1).uint32_list_ruleid.set(((asfb)paramList.get(0)).b);
        i = j;
        while (i < k)
        {
          localObject2 = a((asfb)paramList.get(i));
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
      ...
      try
      {
        ...
        if ((paramFromServiceMsg.rpt_msg_uin_data.has()) && (paramFromServiceMsg.rpt_msg_uin_data.size() > 0))
        {
          ...
          if ((paramObject.gender == 1) || (paramObject.gender == 2)) {
            asfc.a(paramObject.uin + "", "self_gender", Integer.valueOf(paramObject.gender));
          }
        ...
        catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
        {
          for (;;)
          {
            ...
            if (QLog.isColorLevel())
            {
              ...
              localNearbyMyTabConfig.extraVal = ((NearbyMyTabCard.NearbyMyTabConfigExtraVal)atcm.a.get(Integer.valueOf(localNearbyMyTabConfig.configId)));
    ...
    for (paramFromServiceMsg = "0";; paramFromServiceMsg = "-1")
    {
      ...
      paramObject.put("param_NetType", String.valueOf(badq.a(BaseApplication.getContext())));
      paramObject.put("param_DeviceType", String.valueOf(ageh.a()));
      long l = paramToServiceMsg.extraData.getLong("request_start_time");
      l = SystemClock.uptimeMillis() - l;
      awrn.a(BaseApplicationImpl.getContext()).a(getCurrentAccountUin(), "actGetNearbyMyTab", bool2, l, 0L, paramObject, "");
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        if ("NeighborSvc.ReqGetPoint".equals(str))
        {
          ...
          for (int i = 5;; i = 6)
          {
            ajmz.a(this, i, paramToServiceMsg, paramFromServiceMsg, paramObject);
            return;
          }
        }
        if ("OidbSvc.0x9c7_0".equals(str))
        {
          ajmz.c(this, 10, paramToServiceMsg, paramFromServiceMsg, paramObject);
          return;
        }
        if ("OidbSvc.0x686".equals(str))
        {
          ajmz.b(this, 8, paramToServiceMsg, paramFromServiceMsg, paramObject);
          return;
        }
