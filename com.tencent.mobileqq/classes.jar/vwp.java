...
public class vwp
{
  public static MessageRecord a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    {
      vwn localvwn = (vwn)paramQQAppInterface.getManager(208);
      String str = a(paramString);
      paramString = localvwn.a(paramString);
      if (paramString != null) {
  ...
  {
    return ("gs_" + paramMessageForShortVideo.frienduin + '_' + paramMessageForShortVideo.getMd5() + '_' + bdik.d(paramMessageForShortVideo.uuid) + "-700").toLowerCase();
  }
  ...
  {
    return (sst.i()) && (paramInt == 1) && ((paramMessageRecord instanceof MessageForShortVideo)) && (((MessageForShortVideo)paramMessageRecord).busiType == 1);
  }
