  ...
  extends qdy
{
  ...
  public qdw(VideoFeedsLikeAnimate.LikeExplosionView paramLikeExplosionView)
  {
    super(paramLikeExplosionView);
    b();
  }
  
  public qdw(VideoFeedsLikeAnimate.LikeExplosionView paramLikeExplosionView, int paramInt)
  {
    super(paramLikeExplosionView);
  ...
  private void b()
  {
    ...
    this.i = (VideoFeedsLikeAnimate.LikeExplosionView.a(this.a).nextFloat() * aciy.a(10.0F, this.a.getResources()) + aciy.a(4.5F, this.a.getResources()));
  }
