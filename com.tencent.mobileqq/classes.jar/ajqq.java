  ...
  extends Handler
{
  ...
  public ajqq(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      QQToast.a((Context)localObject2, ((NewPhotoListActivity)localObject2).getResources().getString(2131694435), 0).a();
      return;
    ...
    for (;;)
    {
      ...
      return;
      QQToast.a((Context)localObject2, String.format(((NewPhotoListActivity)localObject2).getResources().getString(2131694431), new Object[] { Integer.valueOf(((NewPhotoListActivity)localObject2).mPhotoListLogic.mPhotoCommonData.maxSelectNum) }), 0).a();
    }
  }
}
