...
public class ajqq
  extends ajfb
{
  public ajqq(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
          ...
          for (;;)
          {
            ...
            if (paramObject.msg_quota.has())
            {
              ...
              if (paramObject.uint32_comm_quota.has()) {
                ahwj.a(paramObject.uint32_comm_quota.get(), this.app);
              }
              if (paramObject.uint32_svip_quota.has()) {
                ahwj.b(paramObject.uint32_svip_quota.get(), this.app);
              }
              ahwj.b(this.app);
              continue;
                ...
                if ((localObject1 != null) && (((List)localObject1).size() > 0))
                {
                  ...
                  while (((Iterator)localObject1).hasNext())
                  {
                    ...
                    if ((((RemindPB.RemindItem)localObject2).uint64_uin.has()) && (((RemindPB.RemindItem)localObject2).uint32_id.has()))
                    {
                      ...
                      paramObject.add(str);
                      ahwj.a(str, ((RemindPB.RemindItem)localObject2).uint32_id.get(), this.app);
                    }
                  }
                  ahwj.a(paramObject, this.app);
                  continue;
                  if (paramObject.rep_clear_uin.has())
                  {
                    ...
                    if ((localObject1 != null) && (((List)localObject1).size() > 0))
                    {
                      ...
                      while (((Iterator)localObject1).hasNext())
                      {
                        ...
                        ahwj.c((String)localObject2, this.app);
                      }
                      ahwj.b(paramObject, this.app);
                    }
                  }
                }
              }
    ...
    bcad.a().a(paramFromServiceMsg.getServiceCmd(), 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 1000277, ajjy.a(2131645601), true);
  }
