  ...
  extends aqou
{
  ...
  public aqol(aqnw paramaqnw, MessageRecord paramMessageRecord)
  {
    super(paramaqnw);
  ...
  void a(String paramString, int paramInt, aqot paramaqot)
  {
    ...
    aqnw.a(this.jdField_a_of_type_Aqnw).a().a().a(paramString, paramInt, this.d, 102, this.b, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.c, new aqom(this, paramString, paramaqot));
  }
}
