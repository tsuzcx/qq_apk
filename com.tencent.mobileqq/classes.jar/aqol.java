  ...
  extends aoxs
{
  ...
  ArrayList<aqon> jdField_a_of_type_JavaUtilArrayList;
  private Comparator<ColorNote> jdField_a_of_type_JavaUtilComparator = new aqom(this);
  ...
  public aqol(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  private void a(int paramInt, ColorNote paramColorNote)
  {
    ...
    if (i < j)
    {
      ...
      ((aqon)localArrayList.get(i)).a(paramColorNote);
    }
    for (;;)
    {
      i += 1;
      ...
      label62:
      if (paramInt == 2) {
        ((aqon)localArrayList.get(i)).b(paramColorNote);
      }
    }
  }
      ...
      try
      {
        ...
        if (!paramList.isEmpty())
        {
          ...
          if (i >= 0)
          {
            ...
            if ((localColorNote.isOpen()) && (!aqoq.d(localColorNote))) {
              break label96;
            }
  ...
  protected void a()
  {
    ...
    if ((localObject != null) && (!((List)localObject).isEmpty()))
    {
      ...
      aqrl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), false, false);
    }
    localObject = aqnp.a();
    if ((localObject != null) && (((aqno)localObject).a() != -1))
    {
      jdField_a_of_type_Int = ((aqno)localObject).a();
      if (QLog.isColorLevel()) {
        QLog.e("ColorNoteConfigProcessor", 2, "init MAX_COUNT " + jdField_a_of_type_Int);
      }
    }
    aqrl.a(BaseApplicationImpl.getContext(), 3, true);
  }
  ...
  public void a(aqon paramaqon)
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilArrayList.contains(paramaqon)) {
      this.jdField_a_of_type_JavaUtilArrayList.add(paramaqon);
    }
  }
  ...
  {
    boolean bool = false;
    if ((!a(paramColorNote)) && (aqrl.a())) {
      if (paramColorNote.getServiceType() == 16973824) {
        bdla.b(null, "dc00898", "", "", "0X800A746", "0X800A746", 0, 0, "", "", "", "");
      }
    }
    do
    {
    ...
    QLog.e("ColorNoteProxy", 2, "addColorNote error! isAfterSyncMsg = " + aqrl.a());
    return false;
  }
  ...
  public void b(aqon paramaqon)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null) {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramaqon);
    }
  }
