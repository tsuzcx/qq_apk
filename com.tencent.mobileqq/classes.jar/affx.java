...
public class affx
  extends aofu
{
  public affx(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  protected void onGetTroopFeeMemberList(boolean paramBoolean, List<cmd0x406.GroupFeeMember> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localafgi.a = (localGroupFeeMember.uint64_uin.get() + "");
      localafgi.jdField_b_of_type_JavaLangString = localGroupFeeMember.string_nick_name.get();
      if (this.a.jdField_a_of_type_Bbcg != null) {
        this.a.jdField_a_of_type_Bbcg.a(localafgi);
      }
      localArrayList.add(localafgi);
    }
  ...
  {
    if (!bhbx.a(String.valueOf(paramLong1), this.a.jdField_b_of_type_JavaLangString)) {}
    do
    {
      return;
      if (QLog.isColorLevel())
