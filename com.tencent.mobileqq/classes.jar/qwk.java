...
public class qwk
  extends BaseAdapter
{
  private List<rfj> jdField_a_of_type_JavaUtilList;
  
  private qwk(ComponentContentRecommendFollowGroup paramComponentContentRecommendFollowGroup) {}
  
  public void a(List<rfj> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2131560239, paramViewGroup, false);
      paramView = new qwl(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentContentRecommendFollowGroup, null);
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131367677));
      paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131366920));
      paramView.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131366911));
      paramView.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131367651));
      ...
      while (i < paramView.jdField_b_of_type_AndroidWidgetLinearLayout.getChildCount())
      {
        ...
        paramView.jdField_a_of_type_ArrayOfAndroidWidgetRelativeLayout[i] = ((RelativeLayout)((RelativeLayout)localObject1).findViewById(2131367858));
        paramView.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i] = ((ImageView)((RelativeLayout)localObject1).findViewById(2131367849));
        paramView.jdField_b_of_type_ArrayOfAndroidWidgetImageView[i] = ((ImageView)((RelativeLayout)localObject1).findViewById(2131380415));
        paramView.c[i] = ((ImageView)((RelativeLayout)localObject1).findViewById(2131377785));
        paramView.jdField_a_of_type_ArrayOfAndroidWidgetTextView[i] = ((TextView)((RelativeLayout)localObject1).findViewById(2131371726));
      ...
      paramView.jdField_a_of_type_Rfj = ((rfj)this.jdField_a_of_type_JavaUtilList.get(paramInt));
      paramView.jdField_a_of_type_AndroidWidgetTextView.setText(paramView.jdField_a_of_type_Rfj.jdField_a_of_type_JavaLangString);
      i = 0;
      if (i >= paramView.jdField_a_of_type_Rfj.jdField_a_of_type_JavaUtilList.size()) {
        break label611;
      }
      localObject1 = (RecommendFollowInfo)paramView.jdField_a_of_type_Rfj.jdField_a_of_type_JavaUtilList.get(i);
    ...
    for (int j = 0;; j = 8)
    {
      ...
      i += 1;
      break label325;
      localObject1 = (qwl)paramView.getTag();
      localView = paramView;
      paramView = (View)localObject1;
      break;
      paramView.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].setImageDrawable(bgmo.b());
      break label473;
      j = 8;
      break label493;
    }
    ...
    int i = 0;
    if (i < paramView.jdField_a_of_type_Rfj.jdField_a_of_type_JavaUtilList.size()) {
      if (((RecommendFollowInfo)paramView.jdField_a_of_type_Rfj.jdField_a_of_type_JavaUtilList.get(i)).isFollowed) {}
    }
    for (i = k;; i = 1)
    {
      if (i != 0)
      {
        paramView.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131701061));
        paramView.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-8947849);
        paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130849428);
      }
      for (;;)
      {
        ...
        i += 1;
        break;
        paramView.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131701096));
        paramView.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-1);
        paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130849385);
      }
    }
  }
}
