...
final class aowy
  extends xbb
{
  aowy(String paramString, aoxt paramaoxt, long paramLong) {}
  ...
  public void a(boolean paramBoolean, int paramInt1, String paramString, int paramInt2, int paramInt3, Bundle paramBundle)
  {
    if (!paramBoolean)
    {
      ...
      this.jdField_a_of_type_Aoxt.a(aowx.a(this.jdField_a_of_type_Long, false), true);
      return;
    }
    ...
    if (paramInt1 == 0)
    {
      ...
      this.jdField_a_of_type_Aoxt.a(this.jdField_a_of_type_JavaLangString, paramBundle);
      return;
    }
    ...
    this.jdField_a_of_type_Aoxt.a(aowx.a(this.jdField_a_of_type_Long, false), false);
  }
}
