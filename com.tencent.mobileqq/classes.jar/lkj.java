  ...
  extends lkq
{
  ...
  static
  {
    jdField_a_of_type_ComTencentTtpicUtilDecryptListener = new lkk();
  }
  
  public lkj(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public lkr a(int paramInt1, int paramInt2)
  {
    ...
    if ((locallkr != null) && (locallkr.a != null)) {
      locallkr.a.extraParam = Integer.valueOf(this.c);
    }
    return locallkr;
  }
  ...
  public boolean a(long paramLong, PendantItem paramPendantItem)
  {
    ...
    if ((!a()) && (bool) && (paramPendantItem != null) && (!TextUtils.isEmpty(paramPendantItem.getId())) && (!TextUtils.equals("0", paramPendantItem.getId())))
    {
      ...
      if (localljq != null) {
        localljq.a(3004, paramPendantItem.getId());
      }
    }
    return bool;
  }
