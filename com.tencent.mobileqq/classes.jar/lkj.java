    ...
    if ((localObject2 != null) && (localObject2.length > 0))
    {
      ...
      if (i < localObject2.length)
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          ((ArrayList)localObject1).add(lkk.a((QQText.EmoticonSpan)localObject3, paramQQTextBuilder.getSpanStart(localObject3), paramQQTextBuilder.getSpanEnd(localObject3)));
        }
      }
      Collections.sort((List)localObject1, lkk.jdField_a_of_type_JavaUtilComparator);
      localObject2 = ((ArrayList)localObject1).iterator();
      i = j;
      if (((Iterator)localObject2).hasNext())
      {
        paramQQTextBuilder = (lkk)((Iterator)localObject2).next();
