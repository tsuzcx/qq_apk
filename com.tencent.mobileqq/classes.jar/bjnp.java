...
{
  public bjnp(OpenAuthorityFragment paramOpenAuthorityFragment) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 0: 
      ...
      if (i != 0) {
        QLog.d("SDK_LOGIN.OpenAuthorityFragment", 1, "rec | cmd: G_A_L_D | uin : *" + bjqq.a(OpenAuthorityFragment.a(this.a).a) + " | ret : success | code : " + i);
      }
      break;
    }
    label2218:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          bjqh.a().a(OpenAuthorityFragment.a(this.a).a, "", OpenAuthorityFragment.a(this.a), "1", "6", "" + i, false);
          if (TextUtils.isEmpty(localPreAuthResponse.msg.get()))
          {
            paramMessage = String.format(this.a.getResources().getString(2131694149), new Object[] { Integer.valueOf(i) });
            if (i == 110405)
            {
              this.a.a(paramMessage, new bjnq(this));
          ...
          {
            paramMessage = String.format(this.a.getResources().getString(2131695831), new Object[] { localPreAuthResponse.msg.get(), Integer.valueOf(i) });
            continue;
          }
          ...
          if (i == 100044)
          {
            ...
            bjqh.a().a((Bundle)localObject3, OpenAuthorityFragment.a(this.a), OpenAuthorityFragment.a(this.a).a, false);
          }
          ...
          this.a.a(paramMessage, new bjnr(this, localPreAuthResponse, (JSONObject)localObject1));
          continue;
        ...
        if (OpenAuthorityFragment.a(this.a).a(OpenAuthorityFragment.a(this.a).a().a(OpenAuthorityFragment.a(this.a)), localPreAuthResponse.authorized_union_text.get()))
        {
          ...
          bdmc.a(BaseApplicationImpl.getApplication()).a(OpenAuthorityFragment.b(this.a), "connect_sso_pageview", false, System.currentTimeMillis() - OpenAuthorityFragment.c(this.a), 0L, paramMessage, "");
        ...
        localObject1 = (bjpr)paramMessage.obj;
        i = ((bjpr)localObject1).jdField_a_of_type_ComTencentMobileqqPbPBUInt32Field.get();
        if (i != 0)
        {
          QLog.d("SDK_LOGIN.OpenAuthorityFragment", 1, "rec | cmd: A_D | uin : *" + bjqq.a(OpenAuthorityFragment.a(this.a).a) + " | state : success | ret : " + i);
          try
          {
            localObject2 = ((bjpr)localObject1).jdField_a_of_type_ComTencentMobileqqPbPBStringField.get();
            if (TextUtils.isEmpty((CharSequence)localObject2))
            {
              ...
              this.a.a(paramMessage, new bjns(this));
            }
            label1395:
            do
            {
              OpenAuthorityFragment.a(this.a, i, paramMessage);
              return true;
              paramMessage = String.format(this.a.getResources().getString(2131695831), new Object[] { localObject2, Integer.valueOf(i) });
              break;
            ...
            paramMessage = bjzy.a(OpenAuthorityFragment.a(this.a), OpenAuthorityFragment.a(this.a).a);
            if ((paramMessage != null) && (paramMessage.length > 0))
            {
              ...
              try
              {
                ...
                ((Message)localObject3).obj = bjpr.a(paramMessage);
        ...
        this.a.b(((bjpr)localObject1).c.get());
        this.a.a(((bjpr)localObject1).c.get(), ((bjpr)localObject1).e.get());
        try
        {
          paramMessage = new JSONObject();
          paramMessage.put("ret", ((bjpr)localObject1).jdField_a_of_type_ComTencentMobileqqPbPBUInt32Field.get());
          paramMessage.put("openid", ((bjpr)localObject1).c.get());
          paramMessage.put("access_token", ((bjpr)localObject1).jdField_b_of_type_ComTencentMobileqqPbPBStringField.get());
          paramMessage.put("pay_token", ((bjpr)localObject1).d.get());
          paramMessage.put("expires_in", ((bjpr)localObject1).jdField_a_of_type_ComTencentMobileqqPbPBInt64Field.get());
          paramMessage.put("code", ((bjpr)localObject1).n.get());
          paramMessage.put("proxy_code", ((bjpr)localObject1).jdField_a_of_type_ComTencentQconnProtofileAuth$ProxyAuthResponse.code.get());
          paramMessage.put("proxy_expires_in", ((bjpr)localObject1).jdField_a_of_type_ComTencentQconnProtofileAuth$ProxyAuthResponse.expires_in.get());
          paramMessage.put("pf", ((bjpr)localObject1).f.get());
          paramMessage.put("pfkey", ((bjpr)localObject1).g.get());
          paramMessage.put("msg", ((bjpr)localObject1).jdField_a_of_type_ComTencentMobileqqPbPBStringField.get());
          ...
          if (OpenAuthorityFragment.h(this.a) == 0L)
          {
            ...
            label1896:
            if (((bjpr)localObject1).jdField_b_of_type_ComTencentMobileqqPbPBUInt32Field.has()) {
              paramMessage.put("sendinstall", ((bjpr)localObject1).jdField_b_of_type_ComTencentMobileqqPbPBUInt32Field.get());
            }
            if ((((bjpr)localObject1).j.has()) && (!TextUtils.isEmpty(((bjpr)localObject1).j.get()))) {
              paramMessage.put("installwording", ((bjpr)localObject1).j.get());
            }
            if ((!((bjpr)localObject1).jdField_a_of_type_ComTencentMobileqqPbPBRepeatMessageField.has()) || (((bjpr)localObject1).jdField_a_of_type_ComTencentMobileqqPbPBRepeatMessageField.size() <= 0)) {
              break label2218;
            }
            localObject2 = ((bjpr)localObject1).jdField_a_of_type_ComTencentMobileqqPbPBRepeatMessageField.get().iterator();
        ...
        catch (JSONException paramMessage)
        {
          ...
          for (;;)
          {
            ...
            paramMessage.put("p2", "auth");
            bdmc.a(BaseApplicationImpl.getApplication()).a(OpenAuthorityFragment.b(this.a), "connect_sso_lognback", true, System.currentTimeMillis() - OpenAuthorityFragment.i(this.a), 0L, paramMessage, "");
            ...
            {
              ForwardUtils.a(((bjpr)localObject1).jdField_a_of_type_ComTencentMobileqqPbPBUInt32Field.get(), OpenAuthorityFragment.a(this.a));
              bjos.a().a(OpenAuthorityFragment.a(this.a), true);
            }
            else
            {
              this.a.b(((bjpr)localObject1).jdField_a_of_type_ComTencentMobileqqPbPBUInt32Field.get(), paramMessage.toString(), null, null);
            }
          }
          label2287:
          paramMessage.put("appid", OpenAuthorityFragment.a(this.a));
      ...
      paramMessage = (auxp)paramMessage.obj;
      ...
      if ((!OpenAuthorityFragment.h(this.a)) && (paramMessage != null) && (paramMessage.jdField_a_of_type_JavaUtilList != null) && (!paramMessage.jdField_a_of_type_JavaUtilList.isEmpty()))
      {
        ...
        n = ForwardUtils.a(((abgz)paramMessage.jdField_a_of_type_JavaUtilList.get(i)).jdField_b_of_type_ComTencentMobileqqPbPBStringField.get());
        if (n < 100) {
          break label3022;
        }
      }
      for (;;)
      {
        localObject1 = (abgz)paramMessage.jdField_a_of_type_JavaUtilList.get(i);
        if (localObject1 != null) {
          ThreadManager.executeOnNetWorkThread(new OpenAuthorityFragment.8.4(this, (abgz)localObject1));
        }
        if (OpenAuthorityFragment.a(this.a) != null) {
          QLog.d("SDK_LOGIN.OpenAuthorityFragment", 1, new Object[] { "user uin = ", bjqq.a(OpenAuthorityFragment.a(this.a)) });
        }
