...
class ayco
  extends nkp
{
  ayco(aycm paramaycm, aycl paramaycl, Comments.Comment paramComment) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if (!localRspBody.busi_buf.has())
          {
            ...
            this.jdField_a_of_type_Aycl.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment, -1, "");
            return;
          }
        ...
        try
        {
          ...
          this.jdField_a_of_type_Aycl.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment, (int)localAddCommentNoFilterResp.result.get(), paramArrayOfByte);
          return;
        }
        catch (InvalidProtocolBufferMicroException paramBundle) {}
      }
      QLog.i("CommentsDataSource", 1, "merge publish resp data error");
      this.jdField_a_of_type_Aycl.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment, -1, paramArrayOfByte);
      return;
      if (localAddCommentNoFilterResp.comment_id.get() > 0L)
      {
        ...
        this.jdField_a_of_type_Aycl.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelComments$Comment);
        aycm.a(this.jdField_a_of_type_Aycm).add(Long.valueOf(localAddCommentNoFilterResp.comment_id.get()));
        paramBundle = (AppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (paramBundle != null) {
          ((ayrf)paramBundle.getManager(263)).e(aycm.a(this.jdField_a_of_type_Aycm).a);
        }
      }
    }
    else
