...
public class tyb
{
  ...
  public static void a(int paramInt, String paramString)
  {
    ...
    if (3 == paramInt)
    {
      if (((Boolean)bmqa.a(paramString, Boolean.valueOf(false))).booleanValue()) {
        return;
      }
      bmqa.a(paramString, Boolean.valueOf(true));
    }
    tzo.a(200, localArrayList);
  }
    ...
    try
    {
      ...
      if ((paramMap != null) && (paramMap.entrySet() != null))
      {
        ...
        while ((paramMap != null) && (paramMap.hasNext()))
        {
          ...
          continue;
          oat.a(null, pha.d(paramArticleInfo), paramString1, paramString2, 0, 0, snh.a(paramArticleInfo.mFeedId), String.valueOf(paramArticleInfo.mArticleID), Integer.toString(paramArticleInfo.mStrategyId), paramMap, false);
        }
      }
    }
    catch (Exception paramMap)
    {
      afur.a("ProteusReportUtil", "reportClickEvent", new IllegalArgumentException(paramMap));
      paramMap = null;
    }
    for (;;)
    {
  ...
  {
    paramBaseArticleInfo = rec.a(paramBaseArticleInfo);
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    bctj.a(BaseApplicationImpl.getApplication()).a(null, "actKandianProteusShowFail", false, 0L, 0L, localHashMap, null);
  }
  ...
  {
    return bgnw.a(BaseApplicationImpl.getContext(), "com.tencent.weishi");
  }
}
