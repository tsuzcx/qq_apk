  ...
  extends pkt
{
  ...
  static
  {
    jdField_a_of_type_Qyg = new qyg(null);
  }
  
  public qye(@Nullable Activity paramActivity, @Nullable qyf paramqyf)
  {
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Qyf = paramqyf;
    this.jdField_a_of_type_Boolean = qxs.a.c();
  ...
  private final URLDrawable a(String paramString)
  {
    ...
    localbgfu.a(1);
    return bgft.a(paramString, localbgfu, null, 4, null);
  }
  
  private final void a(String paramString, boolean paramBoolean)
  {
    int i = 1;
    Object localObject = new sie(this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo).a("video_mode", Integer.valueOf(1)).a("number", Integer.valueOf(this.jdField_a_of_type_Int + 1));
    sid localsid;
    if (paramBoolean)
    {
      localsid = ((sie)localObject).a("result", Integer.valueOf(i)).a();
      Intrinsics.checkExpressionValueIsNotNull(localsid, "VideoR5.Builder(curVideo…\n                .build()");
    ...
    {
      odq.a(null, "", paramString, paramString, 0, 0, (String)localObject, "", "", localsid.a(), false);
      return;
      i = 2;
      break;
    }
  ...
  private final void d()
  {
    ...
    if (localPopupWindow != null) {
      localPopupWindow.setAnimationStyle(2131755850);
    }
    localPopupWindow = this.jdField_a_of_type_AndroidWidgetPopupWindow;
    if (localPopupWindow != null) {
    ...
    localPopupWindow = this.jdField_a_of_type_AndroidWidgetPopupWindow;
    if (localPopupWindow != null) {
      localPopupWindow.setOnDismissListener((PopupWindow.OnDismissListener)new qyh(this));
    }
  }
  ...
  {
    if (paramInt > 0) {}
    for (String str = rwv.e(paramInt);; str = "0")
    {
  ...
  private final void q()
  {
    ...
    {
      localObject1 = ((LayoutInflater)localObject1).inflate(2131560366, null);
      this.jdField_a_of_type_AndroidViewView = ((View)localObject1);
      localObject1 = this.jdField_a_of_type_AndroidViewView;
      if (localObject1 == null) {
        break label479;
      }
      localObject1 = (TextView)((View)localObject1).findViewById(2131377083);
      label51:
      ...
      localObject1 = (TextView)((View)localObject1).findViewById(2131377088);
      label76:
      ...
      localObject1 = ((View)localObject1).findViewById(2131377078);
      label98:
      ...
      localObject1 = (ImageView)((View)localObject1).findViewById(2131377080);
      label123:
      ...
      localObject1 = (TextView)((View)localObject1).findViewById(2131377086);
      label148:
      ...
      localObject1 = ((View)localObject1).findViewById(2131377077);
      label170:
      ...
      localObject1 = (ImageView)((View)localObject1).findViewById(2131377079);
      label195:
    ...
    label514:
    for (localObject1 = (TextView)((View)localObject1).findViewById(2131377084);; localObject1 = null)
    {
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)localObject1);
      View localView = this.jdField_a_of_type_AndroidViewView;
      localObject1 = localObject2;
      if (localView != null) {
        localObject1 = localView.findViewById(2131377082);
      }
      this.jdField_d_of_type_AndroidViewView = ((View)localObject1);
      localObject1 = this.jdField_a_of_type_AndroidWidgetTextView;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)qxs.a.a());
      }
      localObject1 = this.jdField_c_of_type_AndroidWidgetTextView;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)(qxs.a.e() + "个月饼"));
      }
      localObject1 = this.jdField_d_of_type_AndroidWidgetTextView;
      if (localObject1 != null) {
        ((TextView)localObject1).setText((CharSequence)(qxs.a.f() + "个月饼"));
      }
      localObject1 = this.jdField_b_of_type_AndroidWidgetTextView;
      if (localObject1 != null) {
        ((TextView)localObject1).setOnClickListener((View.OnClickListener)new qyi(this));
      }
      localObject1 = this.jdField_a_of_type_AndroidViewView;
      if (localObject1 != null) {
        ((View)localObject1).setOnClickListener((View.OnClickListener)new qyj(this));
      }
      localObject1 = this.jdField_b_of_type_AndroidViewView;
      if (localObject1 != null) {
        ((View)localObject1).setOnClickListener((View.OnClickListener)new qyk(this));
      }
      localObject1 = this.jdField_c_of_type_AndroidViewView;
      if (localObject1 != null) {
        ((View)localObject1).setOnClickListener((View.OnClickListener)new qyl(this));
      }
      localObject1 = this.jdField_d_of_type_AndroidViewView;
      if (localObject1 != null) {
        ((View)localObject1).setOnClickListener((View.OnClickListener)new qym(this));
      }
      return;
      localObject1 = null;
      break;
  ...
  public final void a(@NotNull VideoInfo paramVideoInfo)
  {
    ...
    if (paramVideoInfo != null) {
      paramVideoInfo.setBackgroundResource(2130841764);
    }
    paramVideoInfo = this.jdField_a_of_type_AndroidWidgetImageView;
    if (paramVideoInfo != null) {
      paramVideoInfo.setImageResource(2130843195);
    }
    ...
    d();
    paramVideoInfo = this.jdField_a_of_type_Qyf;
    if (paramVideoInfo != null) {
    ...
    if (localObject != null)
    {
      ...
      if (paramVideoInfo != null)
      {
        ...
        if (paramVideoInfo != null)
        {
          ...
          ((PopupWindow)localObject).showAsDropDown(paramVideoInfo, 0, -rwv.b(this.jdField_a_of_type_AndroidAppActivity)[1]);
        }
      }
    }
    else
    {
      if (System.currentTimeMillis() - this.jdField_a_of_type_Long <= qxs.a()) {
        break label313;
      }
    }
    label313:
  ...
  public void a(boolean paramBoolean, int paramInt, @Nullable String paramString)
  {
    ...
    if (paramBoolean)
    {
      ...
      paramString = this.jdField_a_of_type_Qyf;
      if (paramString != null) {
  ...
  public void a(boolean paramBoolean, int paramInt, @Nullable String paramString, @Nullable pvn parampvn)
  {
    if (QLog.isColorLevel()) {
      QLog.d("RIJVideoRewardCoinManager", 2, "onQueryUserCoinResult: success=" + paramBoolean + ", retCode=" + paramInt + ", retMsg=" + paramString + ", userCoin=" + parampvn);
    }
    if (paramBoolean) {
      if (parampvn == null) {
        break label90;
    ...
    label90:
    for (paramInt = parampvn.jdField_a_of_type_Int;; paramInt = 0)
    {
      this.jdField_c_of_type_Int = paramInt;
      i(paramInt);
      return;
  ...
  public final void c()
  {
    ...
    this.jdField_a_of_type_Qyf = ((qyf)null);
  }
}
