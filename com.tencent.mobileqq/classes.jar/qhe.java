  ...
  implements ViewBase.OnClickListener
{
  ...
  public qhe(ArticleInfo paramArticleInfo, Context paramContext, int paramInt)
  {
  ...
  private void a()
  {
    ...
    ReadInJoyUserInfoModule.a(Long.valueOf(str).longValue(), new qhf(this, localQQAppInterface, str));
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      bool = true;
      localqhg = new qhg(this, paramBoolean);
      if (!paramBoolean) {
        break label71;
      }
    }
    ...
    for (int i = 1;; i = 2)
    {
      localpyq.a(paramQQAppInterface, paramString1, bool, paramString2, localqhg, i);
      d();
      return;
      bool = false;
      break;
  ...
  private void c()
  {
    ...
    for (String str = "0X800941D";; str = "0X80080EC")
    {
      ...
      {
        str = String.valueOf(localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rha.jdField_a_of_type_Long);
        ReadInJoyUserInfoModule.a(Long.valueOf(str).longValue(), new qhh(this, localQQAppInterface, str));
      }
      d();
      return;
    }
  ...
  public void onClick(ViewBase paramViewBase)
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo != null)
    {
      ...
      ube.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, ube.e);
    ...
    for (;;)
    {
      oqa.a(paramViewBase, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, true);
      return;
      label156:
      c();
    }
