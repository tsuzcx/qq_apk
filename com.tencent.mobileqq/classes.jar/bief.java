...
public class bief
  extends bifz
  implements bibg, bims, bimt, IEventReceiver
{
  ...
  private ViewTreeObserver.OnGlobalLayoutListener jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new biem(this);
  bieo jdField_a_of_type_Bieo;
  biep jdField_a_of_type_Biep;
  bieq jdField_a_of_type_Bieq;
  private bign jdField_a_of_type_Bign = new bieg(this);
  public bikx a;
  bjij jdField_a_of_type_Bjij = new biei(this);
  ...
  public bief(@NonNull bigb parambigb, long paramLong)
  {
    super(parambigb);
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_JavaLangRunnable = new EditVideoDoodle.7(this);
    this.jdField_a_of_type_Bikx = new bien(this);
  ...
  private void j()
  {
    ...
    if ((this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.d()) && (this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 14) && (this.jdField_a_of_type_Bigb.a() != null) && (!this.jdField_a_of_type_Bigb.a().isLandTakePicToVideo()) && ((this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource)))
    {
      ...
      f = j / i;
      if (!this.jdField_a_of_type_Bigb.a().getTakePicToVideo()) {
  ...
  public JobSegment<bitz, bitz> a(int paramInt)
  {
    if (((this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditTakeVideoSource)) || ((this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource))) {
      return (JobSegment)skt.a(biul.class, new Object[] { this, (bibh)a(bibh.class), Integer.valueOf(paramInt) });
    }
    return (JobSegment)skt.a(biua.class, new Object[] { this, (bibh)a(bibh.class), Integer.valueOf(paramInt) });
  }
  ...
  public void a()
  {
    ...
    PtvTemplateManager.a(localAppInterface).a(localAppInterface, this.jdField_a_of_type_Bjij, false);
  ...
  {
    this.jdField_a_of_type_Bigb.a(false, paramFloat1, paramFloat2, paramFloat3, paramFloat4);
  }
  
  public void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6)
  {
    a().a(ajjy.a(2131637985), true, 0L, new bieh(this));
    this.jdField_a_of_type_Bigb.a(paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5, paramFloat6);
  }
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((!paramBoolean) && (this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidOsBundle != null))
    {
      Bundle localBundle = this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidOsBundle.getBundle(biiy.jdField_a_of_type_JavaLangString);
      if (localBundle != null) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(localBundle);
      }
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidOsBundle.getBundle("DynamicFaceLayer"));
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a() != null) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidOsBundle.getBundle(bijo.jdField_a_of_type_JavaLangString));
      }
    }
  }
  ...
  public void a(int paramInt, @NonNull bitz parambitz)
  {
    ...
    parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoDoodleDescription = a().a(paramInt);
    this.jdField_a_of_type_Bigb.a().setWordId(a().b());
    this.jdField_a_of_type_Bigb.a().setStickerId(a().c());
    parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.putExtra("all_doodle_text", a().a());
    parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.mMosaicMask = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a(paramInt);
    parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.mMosaicSize = 16;
    if (a().b(paramInt).size() > 0)
    {
      localObject1 = (bhkc)bhfm.a(4);
      parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLocationDescription = ((bhkc)localObject1).a();
    }
    label280:
    label337:
    int i;
    ...
    if (this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.d())
    {
      ...
      {
        parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLongitude = ((EditLocalVideoSource)this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.longitude;
        parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLatitude = ((EditLocalVideoSource)this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.latitude;
      }
    }
    else
    {
      if (a().b(paramInt))
      {
        ...
        localObject1 = "2";
        ((bigb)localObject2).a("change_graffiti", 0, 0, new String[] { localObject1 });
        urq.a("0X80076C0");
      }
      if (a().a(paramInt))
      {
        ...
        localObject1 = "2";
        ((bigb)localObject2).a("change_color", 0, 0, new String[] { localObject1 });
        urq.a("0X80076C4");
      }
      ...
      if ((localObject2 != null) && (localObject2.length == 2))
      {
        ...
        localObject3 = this.jdField_a_of_type_Bigb;
        j = this.jdField_a_of_type_Bigb.b();
        if (!this.jdField_a_of_type_Bigb.a()) {
          break label980;
        }
        localObject1 = "2";
        label455:
        ((bigb)localObject3).b("pub_graffiti", j, 0, new String[] { "1", "", localObject1 });
        urq.a("0X80076E0", urq.b);
        urq.b("0X80075EA", urq.jdField_a_of_type_Int);
        parambitz.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("1");
        parambitz.jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams.hasGraffiti = true;
        label527:
        if (localObject2[1] <= 0) {
          break label1019;
        }
        ...
        localObject1 = "2";
        label564:
        ((bigb)localObject3).b("pub_mosaics", j, 0, new String[] { "1", "", localObject1 });
        urq.a("0X80076E1");
        urq.b("0X80075EB");
        parambitz.jdField_b_of_type_Boolean = true;
        if (localObject2[0] == 0) {
          parambitz.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("1");
        }
      }
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalPhotoSource))
      {
        parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLongitude = ((EditLocalPhotoSource)this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.longitude;
        parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLatitude = ((EditLocalPhotoSource)this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.latitude;
        break;
      }
      ...
      parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLongitude = ((EditLocalGifSource)this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.longitude;
      parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLatitude = ((EditLocalGifSource)this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.latitude;
      break;
      label959:
      localObject1 = "1";
      break label280;
    ...
    if (localObject2[0] > 0)
    {
      ...
      {
        localObject1 = "2";
        ((bigb)localObject5).b("pub_face", j, 0, new String[] { String.valueOf(k), localObject6, localObject1 });
        urq.a("0X80076E3", urq.b);
        urq.b("0X80075ED", urq.jdField_a_of_type_Int);
        parambitz.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("4");
        parambitz.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 = ((StringBuilder)localObject3).toString();
        label1300:
        if (localObject2[1] <= 0) {
          break label1713;
        }
        this.jdField_a_of_type_Bigb.b("pub_poi", this.jdField_a_of_type_Bigb.b(), 0, new String[] { String.valueOf(localObject2[1]), ((StringBuilder)localObject4).toString() });
        urq.a("0X80076E4");
        urq.b("0X80075EE");
        if (localObject2[0] <= 0) {
          break label1684;
        }
        parambitz.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 = (parambitz.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 + "," + ((StringBuilder)localObject4).toString());
        label1407:
        localObject2 = a().a(paramInt);
        ...
        localObject3 = this.jdField_a_of_type_Bigb;
        i = this.jdField_a_of_type_Bigb.b();
        if (!this.jdField_a_of_type_Bigb.a()) {
          break label1739;
        }
        localObject1 = "2";
        label1462:
        ((bigb)localObject3).b("pub_text", i, 0, new String[] { "1", localObject2, localObject1 });
        urq.a("0X80076E2", urq.b);
        urq.b("0X80075EC", urq.jdField_a_of_type_Int);
        parambitz.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("3");
        parambitz.jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams.hasText = true;
      }
    }
    for (;;)
    {
      ...
      label1684:
      parambitz.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reservesArray.add("4");
      parambitz.jdField_a_of_type_CooperationQzoneReportLpLpReportInfo_pf00064.reserves6 = ((StringBuilder)localObject4).toString();
      break label1407;
      label1713:
      if ((i == 0) || (!biuf.a(3))) {
        break label1407;
    ...
    this.jdField_a_of_type_Bigb.b("person_gra", this.jdField_a_of_type_Bigb.b(), 0, new String[] { localObject1 });
    label1797:
    Object localObject2 = bhfc.a().getCurrentAccountUin();
    if (bioo.jdField_b_of_type_Boolean) {}
    for (Object localObject1 = parambitz.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.videoLocationDescription;; localObject1 = "")
    {
      ...
      parambitz.jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams.hasFace = true;
      return;
    }
  }
  ...
  public void a(Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (localbigl != null) {
      localbigl.a(paramBitmap, paramBoolean);
    }
  }
  
  public void a(Animation paramAnimation)
  {
    this.jdField_a_of_type_Bigb.a(paramAnimation);
  }
  ...
  public void a(biov parambiov)
  {
    ...
    boolean bool = this.jdField_a_of_type_Bigb.b(6);
    if (this.jdField_a_of_type_Bigb.a())
    {
      parambiov = "2";
      if (!bool) {
    ...
    {
      urp.a("video_edit", "add_place", 0, 0, new String[] { parambiov, "", str, "" });
      return;
      parambiov = "1";
      break;
    }
  ...
  {
    if (!this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a())
    {
      this.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
      VideoSourceHelper.nativeSetMosaic(16, this.jdField_a_of_type_ArrayOfByte);
      bigl localbigl = (bigl)a(bigl.class);
      if (localbigl != null) {
        localbigl.a(16, paramArrayOfByte);
      }
    }
  }
  ...
  protected boolean a(Message paramMessage)
  {
    ...
    case 6: 
      a(0);
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a(this.jdField_a_of_type_Bigb.a());
      switch (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.c())
      {
      }
      for (;;)
  ...
  public Bitmap b()
  {
    return this.jdField_a_of_type_Bigb.a();
  }
  ...
  public void b(int paramInt, Object paramObject)
  {
    ...
    case 0: 
    case 7: 
      if ((this.jdField_a_of_type_Bigb.a(13)) || (this.jdField_a_of_type_Bigb.a(14)) || (this.jdField_a_of_type_Bigb.a(15)) || (this.jdField_a_of_type_Bigb.a(16)))
      {
      ...
      {
        this.jdField_a_of_type_Bigb.a(36);
        return;
      }
      this.jdField_a_of_type_Bigb.a(0);
      return;
    case 2: 
      this.jdField_a_of_type_Bigb.a(7, paramObject);
      return;
    case 3: 
      this.jdField_a_of_type_Bigb.a(5, paramObject);
      return;
    case 4: 
      this.jdField_a_of_type_Bigb.a(9);
      return;
    case 5: 
      this.jdField_a_of_type_Bigb.a(8, paramObject);
      return;
    }
    this.jdField_a_of_type_Bigb.a(8);
  }
  
  public void b(Animation paramAnimation)
  {
    this.jdField_a_of_type_Bigb.b(paramAnimation);
  }
  ...
  public void b(String paramString)
  {
    ...
    {
      localbigb.a("exp_editpoi", 0, 0, new String[] { str });
      urq.a("0X80076CF");
      urq.b("0X80075E4");
      paramString = new bies(this.jdField_a_of_type_Bign, paramString);
      this.jdField_a_of_type_Bigb.a(3, paramString);
      return;
    }
  }
  ...
  public void d()
  {
    ...
    label740:
    for (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout = ((DoodleLayout)this.jdField_a_of_type_AndroidViewViewStub.inflate());; this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout = ((DoodleLayout)a(2131299744)))
    {
      if (this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.f == bgww.b.a()) {
      ...
      if (!bigb.a(this.jdField_a_of_type_Long, 1)) {
      ...
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.setMosaicStandardSize(this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a(), this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.b());
      ...
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.setEditVideoParams(this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams);
      ...
      {
        if (this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidOsBundle.getBundle(biiy.jdField_a_of_type_JavaLangString) != null) {
          this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidOsBundle.getBundle(biiy.jdField_a_of_type_JavaLangString).putBoolean("edit_type_photo", this.jdField_a_of_type_Bigb.a());
        }
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidOsBundle.getBundle(biiy.jdField_a_of_type_JavaLangString));
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidOsBundle.getBundle("DynamicFaceLayer"));
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a() != null)
        {
          if (this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidOsBundle.getBundle(bijo.jdField_a_of_type_JavaLangString) != null) {
            this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidOsBundle.getBundle(bijo.jdField_a_of_type_JavaLangString).putBoolean("edit_type_photo", this.jdField_a_of_type_Bigb.a());
          }
          this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a().a(this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidOsBundle.getBundle(bijo.jdField_a_of_type_JavaLangString));
        }
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.a() != null)
        {
          localObject1 = this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidOsBundle.getBundle("VoteLayer");
          if (localObject1 != null)
          {
            localObject1 = (InteractPasterParcelData)((Bundle)localObject1).getParcelable("vote_paster");
            localObject2 = (bibl)this.jdField_a_of_type_Bigb.a(bibl.class);
            if (localObject2 != null) {
              ((bibl)localObject2).a((InteractPasterParcelData)localObject1);
            }
          }
        }
      }
      bhnz.a().a(this.jdField_a_of_type_Bigb.h(), this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout);
      ...
      if (localObject1 != null)
      {
        ...
        ((DoodleEditView)localObject1).a(bigb.a(this.jdField_a_of_type_Long, 134217728));
      }
      if (this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer == null)
      {
        this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer = this.jdField_a_of_type_Bigb.jdField_a_of_type_Bicj.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer;
        if (this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer != null) {
          this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer.setLiuHaiParentView(this.jdField_a_of_type_Bigb.jdField_a_of_type_AndroidWidgetRelativeLayout);
        }
        if ((localObject1 != null) && (this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer != null))
        {
          int i = 0;
          if ((this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource)) {
            i = ((EditLocalVideoSource)this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_Int;
          }
          this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer.setVideoSegmentPickerListener(new biej(this, i));
          this.jdField_a_of_type_DovComQqImCaptureViewProviderViewEditContainer.setStickerListener(((DoodleEditView)localObject1).a());
          ((DoodleEditView)localObject1).setDoodleEditViewListener(new biek(this));
        }
        a(2131299908).setOnTouchListener(new biel(this));
      }
      localObject1 = sgi.a();
      Object localObject2 = new biep(this);
      this.jdField_a_of_type_Biep = ((biep)localObject2);
      ((Dispatcher)localObject1).registerSubscriber((Subscriber)localObject2);
      localObject1 = sgi.a();
      localObject2 = new bieo(this);
      this.jdField_a_of_type_Bieo = ((bieo)localObject2);
      ((Dispatcher)localObject1).registerSubscriber((Subscriber)localObject2);
      localObject1 = sgi.a();
      localObject2 = new bieq(this);
      this.jdField_a_of_type_Bieq = ((bieq)localObject2);
      ((Dispatcher)localObject1).registerSubscriber((Subscriber)localObject2);
      return;
    }
  }
  ...
  {
    this.c = true;
    if (this.jdField_a_of_type_Biep != null) {
      sgi.a().unRegisterSubscriber(this.jdField_a_of_type_Biep);
    }
    if (this.jdField_a_of_type_Bieo != null) {
      sgi.a().unRegisterSubscriber(this.jdField_a_of_type_Bieo);
    }
    if (this.jdField_a_of_type_Bieq != null) {
      sgi.a().unRegisterSubscriber(this.jdField_a_of_type_Bieq);
    }
    ...
    bhnz.a().a(this.jdField_a_of_type_Bigb.h());
  }
  
  public boolean g_()
  {
    if (System.currentTimeMillis() < this.jdField_d_of_type_Long) {}
    while ((!bigb.a(this.jdField_a_of_type_Long, 1)) || (!TextUtils.isEmpty(a().a(this.jdField_a_of_type_Bigb.a())))) {
      return false;
    }
    if (this.jdField_a_of_type_Bigb.jdField_a_of_type_Int == 28) {
      this.jdField_a_of_type_Bigb.a(0);
    }
    return true;
  }
  ...
  public void q()
  {
    this.jdField_a_of_type_Bigb.g();
  }
  
  public void r()
  {
    this.jdField_a_of_type_Bihj.a().postDelayed(new EditVideoDoodle.9(this), 200L);
  }
  ...
  public void t()
  {
    this.jdField_a_of_type_Bigb.a(true, 0.0F, 0.0F, 0.0F, 0.0F);
  }
}
