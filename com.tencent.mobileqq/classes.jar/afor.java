...
public class afor
  implements Runnable
{
  public afor(SearchQuestionCameraFragment paramSearchQuestionCameraFragment, String paramString) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      localObject = DialogUtil.a((Context)localObject, 230).setMessage(str).setPositiveButton(((Activity)localObject).getString(2131428346), new afos(this, (Activity)localObject));
      try
      {
