  ...
  implements ITransactionCallback
{
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    try
    {
      ...
      baux.a(this.a, paramHashMap.bytes_msg_res_id.get().toByteArray());
      if (QLog.isDevelopLevel()) {
        QLog.i("MultiMsg_TAG_opt", 2, "Multimsg upload file by BDH and onSuccess  " + new String(baux.a(this.a), "utf-8"));
      }
      paramArrayOfByte = new File(baqn.d(baux.a(this.a)));
