...
public class bauy
  extends andt
{
  public bauy(ActiveEntitySearchFragment paramActiveEntitySearchFragment) {}
  ...
  public void handleTabSearchError(String paramString1, boolean paramBoolean, String paramString2, int paramInt, String paramString3, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131698927));
        this.a.g.setOnClickListener(new bava(this));
      ...
      this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new bavb(this));
    }
  }
            ...
            if ((paramList == null) || (paramList.isEmpty()))
            {
              ...
              if ((!bool1) && (paramString3.jdField_d_of_type_Boolean)) {
                if (this.a.jdField_a_of_type_Aiid == null)
                {
                  ...
                  paramArrayOfByte.setText(amtj.a(2131698931));
                  ...
                  paramArrayOfByte.setText(amtj.a(2131698929));
                  paramArrayOfByte.setBackgroundResource(2130838892);
                  paramString2.addHeaderView(paramArrayOfByte);
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                try
                {
                  ...
                  this.a.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131698922));
                  if (bool1)
                  {
                    this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
                    this.a.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new bauz(this, paramString2));
