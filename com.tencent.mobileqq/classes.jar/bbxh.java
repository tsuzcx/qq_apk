...
public abstract class bbxh
{
  ...
  protected void a(ToServiceMsg paramToServiceMsg, aqhm paramaqhm, Class<? extends MSFServlet> paramClass)
  {
    ...
    paramToServiceMsg = new PeakJceServiceBase.1(this, paramToServiceMsg, paramaqhm, paramClass);
  ...
  public void a(boolean paramBoolean, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Exception paramException)
  {
    ...
    //   4: return
    //   5: aload_0
    //   6: invokevirtual 204	bbxh:a	()Lcom/tencent/common/app/AppInterface;
    //   9: astore 8
    ...
    //   79: aload_0
    //   80: getfield 32	bbxh:jdField_a_of_type_JavaTextDecimalFormat	Ljava/text/DecimalFormat;
    //   83: fload 5
    //   85: f2d
    ...
    //   130: invokevirtual 250	bbxh:a	(Ljava/lang/String;)Laber;
    //   133: astore 9
    //   135: iload_1
    //   136: ifeq +323 -> 459
    //   139: aload 9
    ...
    //   146: aload_2
    //   147: aload_3
    //   148: invokevirtual 253	aber:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;)V
    //   151: aload 9
    //   153: aload_2
    //   154: aload_3
    //   155: invokevirtual 256	aber:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;)Ljava/lang/Object;
    //   158: astore 4
    //   160: aload_0
    //   161: aload_3
    //   162: invokevirtual 258	bbxh:a	(Lcom/tencent/qphone/base/remote/FromServiceMsg;)V
    //   165: aload 9
    //   167: ifnull -163 -> 4
    //   170: invokestatic 263	anjf:b	()Ljava/util/Map;
    //   173: aload_3
    ...
    //   236: aload_3
    //   237: aload 4
    //   239: invokevirtual 280	anii:onReceive	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;Ljava/lang/Object;)V
    //   242: iload 6
    //   244: iconst_1
    //   245: iadd
    //   246: istore 6
    ...
    //   387: aload_0
    //   388: getfield 32	bbxh:jdField_a_of_type_JavaTextDecimalFormat	Ljava/text/DecimalFormat;
    //   391: fload 5
    //   393: f2d
  ...
  public void b(ToServiceMsg paramToServiceMsg, aqhm paramaqhm, Class<? extends MSFServlet> paramClass)
  {
    int i = 1;
    AppInterface localAppInterface = a();
    Object localObject1 = paramToServiceMsg.getServiceCmd();
    aber localaber = a((String)localObject1);
    Object localObject2;
    int j;
    if (localaber != null)
    {
      ...
      if (localaber.a())
      {
        localObject2 = localaber.a(paramToServiceMsg);
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          return;
          if (!localaber.a(paramToServiceMsg, (UniPacket)localObject2)) {
            break label314;
          }
          paramToServiceMsg.putWupBuffer(((UniPacket)localObject2).encode());
          break;
        } while (localaber == null);
        paramaqhm = new FromServiceMsg(localAppInterface.getCurrentAccountUin(), (String)localObject1);
        paramClass = (int[])anjf.a().get(localObject1);
