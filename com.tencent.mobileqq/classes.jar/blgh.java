...
public final class blgh
  extends blfh
  implements Handler.Callback, blfy, blge, blgq
{
  private Application jdField_a_of_type_AndroidAppApplication;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private blfb jdField_a_of_type_Blfb;
  private blfv jdField_a_of_type_Blfv;
  private blgb jdField_a_of_type_Blgb;
  ...
  private ArrayList<blgl> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public blgh(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Blgo = new blgo(this.jdField_a_of_type_AndroidAppApplication, this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_CooperationPluginPluginUpdater.a(this);
    this.jdField_a_of_type_Blfv = new blfv(this.jdField_a_of_type_AndroidAppApplication, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    try
    {
      this.jdField_a_of_type_Blgb = new blgb(this.jdField_a_of_type_AndroidAppApplication, blfv.a(this.jdField_a_of_type_AndroidAppApplication).getCanonicalPath());
      label160:
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
      this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
      this.jdField_a_of_type_Blfb = blfb.a(this.jdField_a_of_type_AndroidAppApplication);
      this.jdField_a_of_type_Blgm = new blgm(this);
      this.jdField_a_of_type_Blgm.a();
      PluginCommunicationHandler localPluginCommunicationHandler = PluginCommunicationHandler.getInstance();
      localPluginCommunicationHandler.setCommunicationChannel(new blgr());
      localPluginCommunicationHandler.register(new blgs(paramQQAppInterface));
  ...
  {
    if (paramBoolean) {}
    for (paramString = anni.a(2131707055) + paramString + "（" + blfc.a(paramLong) + anni.a(2131707052);; paramString = paramString + "（" + blfc.a(paramLong) + anni.a(2131707054)) {
      return new AlertDialog.Builder(paramContext).setMessage(paramString).setNegativeButton(anni.a(2131707053), paramOnClickListener2).setPositiveButton(anni.a(2131707057), paramOnClickListener1).create();
    }
  }
  ...
  private static ProgressDialog a(Context paramContext, String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramContext.setMessage(anni.a(2131707056));
    paramContext.setCancelable(false);
    paramContext.setButton(-2, anni.a(2131707058), new blgi(paramOnClickListener));
    return paramContext;
  }
  
  private void a(int paramInt, Context paramContext, blfq paramblfq, blfo paramblfo)
  {
    a(paramInt, false, paramContext, paramblfq, paramblfo);
  }
  
  private void a(int paramInt, boolean paramBoolean, Context paramContext, blfq paramblfq, blfo paramblfo)
  {
    QLog.d("plugin_tag", 1, "doInstallAndLaunch. confirmCode, pluginId:" + paramInt + "," + paramblfq.b + ", " + this.c);
    if ((!this.c) && (!blfb.b(paramblfq.b))) {
      if (paramblfo != null) {
    ...
    do
    {
      ...
      localObject1 = this.jdField_a_of_type_Blgb.a(paramblfq.b);
      if ((localObject1 != null) && (((PluginInfo)localObject1).mInstalledPath != null))
      {
        paramblfq.c = ((PluginInfo)localObject1).mInstalledPath;
        paramblfq.a((PluginBaseInfo)localObject1);
      }
      paramblfo.a(true, paramContext, paramblfq);
      return;
      if (paramInt == 4)
      {
        localObject1 = paramblfq.b;
        localObject2 = new blgl();
        ((blgl)localObject2).jdField_a_of_type_AndroidContentContext = paramContext;
        ((blgl)localObject2).jdField_a_of_type_Blfq = paramblfq;
        ((blgl)localObject2).jdField_a_of_type_Blfo = paramblfo;
        ((blgl)localObject2).jdField_a_of_type_Boolean = true;
        a((String)localObject1, new blgn(this, (blgl)localObject2));
        return;
      }
      if (paramInt == 1)
      {
        localObject2 = paramblfq.b;
        ...
        {
          blgl localblgl = new blgl();
          localblgl.jdField_a_of_type_AndroidContentContext = paramContext;
          localblgl.jdField_a_of_type_Blfq = paramblfq;
          localblgl.jdField_a_of_type_Blfo = paramblfo;
          localblgl.jdField_a_of_type_Boolean = false;
          localblgl.jdField_a_of_type_AndroidAppProgressDialog = a(paramContext, (String)localObject1, new blgj(this, paramblfq.b, null));
          a((String)localObject2, paramBoolean, new blgn(this, localblgl));
          return;
        }
      }
    } while (paramInt != 3);
    Object localObject1 = paramblfq.b;
    Object localObject2 = new blgl();
    ((blgl)localObject2).jdField_a_of_type_AndroidContentContext = paramContext;
    ((blgl)localObject2).jdField_a_of_type_Blfq = paramblfq;
    ((blgl)localObject2).jdField_a_of_type_Blfo = paramblfo;
    ((blgl)localObject2).jdField_a_of_type_Boolean = true;
    a((String)localObject1, paramBoolean, new blgn(this, (blgl)localObject2));
  }
  
  private void a(String paramString, blfp paramblfp)
  {
    if (QLog.isColorLevel()) {
      QLog.d("plugin_tag", 2, "doQueryPlugin: " + paramString + ", " + paramblfp);
    }
    ...
    b();
    paramblfp.a(paramString, localPluginInfo1, this);
  }
  ...
  {
    paramString = this.jdField_a_of_type_Blfb.a(paramString);
    if (paramString == null) {
      return false;
    }
  ...
  private PluginInfo b(String paramString)
  {
    ...
    {
      PluginInfo localPluginInfo = this.jdField_a_of_type_Blgb.a(paramString);
      if (QLog.isColorLevel()) {
  ...
  private void b()
  {
    ...
    try
    {
      bgmg.a(localFile1.getCanonicalPath());
      bgmg.a(localFile2.getCanonicalPath());
      return;
    }
    catch (IOException localIOException) {}
  }
  ...
  private void c(Context paramContext, blfq paramblfq, blfo paramblfo)
  {
    int j = 2;
    boolean bool2 = false;
    boolean bool3 = true;
    ...
    do
    {
      ...
      {
        return;
        QLog.d("plugin_tag", 1, "checkUpdate:" + paramblfq.b + ", " + paramblfq.e);
        if ((this.c) || (blfb.b(paramblfq.b))) {
          break;
        }
      } while (paramblfo == null);
      paramblfo.a(false, paramContext, paramblfq);
      return;
      String str = paramblfq.b;
      localPluginInfo2 = this.jdField_a_of_type_CooperationPluginPluginUpdater.a(str);
      if (localPluginInfo2 == null)
      {
        a(0, paramContext, paramblfq, paramblfo);
        return;
      }
      bool4 = this.jdField_a_of_type_Blgb.a(str);
      if (QLog.isColorLevel()) {
        QLog.d("plugin_tag", 2, "installed :" + bool4);
      }
      if (bool4)
      {
        PluginInfo localPluginInfo1 = this.jdField_a_of_type_Blgb.a(str);
        ...
        if (bool1)
        {
          ...
          if (a())
          {
            ...
            {
              if (!blfz.a(localPluginInfo2, this.jdField_a_of_type_AndroidAppApplication)) {
                break label309;
              }
          ...
          for (;;)
          {
            a(i, paramContext, paramblfq, paramblfo);
            return;
            i = 4;
      ...
      if ((!blfz.a(localPluginInfo2, this.jdField_a_of_type_AndroidAppApplication)) || (localObject == null)) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    paramblfq.c = ((PluginInfo)localObject).mInstalledPath;
    paramblfq.a((PluginBaseInfo)localObject);
    paramblfo.a(true, paramContext, paramblfq);
    return;
    ...
    for (;;)
    {
      ...
      a(3, paramContext, paramblfq, paramblfo);
      return;
      bool1 = bool3;
    ...
    {
      paramblfq = new blgk(this, paramblfo, bool1, paramContext, paramblfq, bool4, (String)localObject, null);
      a(paramContext, localPluginInfo2.mName, localPluginInfo2.mLength, paramblfq, paramblfq, bool1).show();
      return;
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          if (!bgnt.g(this.jdField_a_of_type_AndroidAppApplication)) {
            a(false);
          } else {
  ...
  public void a(Context paramContext, blfq paramblfq, blfo paramblfo)
  {
    if ((!this.c) && (!blfb.b(paramblfq.b)))
    {
      if (QLog.isColorLevel()) {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
        {
          ...
          localblgl.jdField_a_of_type_Blfq = paramblfq;
          localblgl.jdField_a_of_type_Blfo = paramblfo;
          this.jdField_a_of_type_JavaUtilArrayList.add(localblgl);
          return;
        }
        synchronized (this.jdField_a_of_type_JavaLangObject)
        {
    ...
    c(paramContext, paramblfq, paramblfo);
  }
  ...
  public void a(String paramString, OnPluginInstallListener paramOnPluginInstallListener)
  {
    ...
    if (blfz.a(localPluginInfo, this.jdField_a_of_type_AndroidAppApplication))
    {
    ...
    this.jdField_a_of_type_Blgb.b(localPluginInfo, this);
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong)
  {
    ...
    paramString1 = this.jdField_a_of_type_Blgb.a(paramString1);
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2, OnPluginInstallListener paramOnPluginInstallListener)
  {
    ...
    if (paramBoolean1)
    {
      localPluginInfo1 = this.jdField_a_of_type_Blfb.a(paramString);
    ...
    for (;;)
    {
      ...
      localPluginInfo1 = localPluginInfo2.a();
      break;
      if (blfz.a(localPluginInfo1, this.jdField_a_of_type_AndroidAppApplication))
      {
      ...
      {
        this.jdField_a_of_type_Blgb.a(localPluginInfo1, this);
        return;
      }
      this.jdField_a_of_type_Blfv.a(localPluginInfo1, this, paramBoolean2);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        blgl localblgl = (blgl)localIterator.next();
        c(localblgl.jdField_a_of_type_AndroidContentContext, localblgl.jdField_a_of_type_Blfq, localblgl.jdField_a_of_type_Blfo);
      }
      this.jdField_a_of_type_Blgo.a();
    }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      this.jdField_a_of_type_Blgb.a((PluginInfo)localObject, this);
    }
    label72:
    do
    {
  ...
  {
    this.jdField_a_of_type_Blfv.a(paramPluginInfo.mID);
    return this.jdField_a_of_type_Blgb.b(paramPluginInfo.mID);
  }
  ...
  public void c(String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      ((PluginInfo)localObject).a = bgnt.b(this.jdField_a_of_type_AndroidAppApplication);
    }
    localObject = (OnPluginInstallListener)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (localObject != null) {}
    try
  ...
  {
    this.jdField_a_of_type_Blfv.a(paramString);
    this.jdField_a_of_type_Blgb.b(paramString);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return true;
    case 65536: 
      a(paramMessage.getData().getString("index_for_id"), (blfp)paramMessage.obj);
      return true;
    case 66049: 
      e();
      return true;
