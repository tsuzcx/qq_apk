...
{
  public alhw(AuthorityActivity paramAuthorityActivity) {}
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          {
            paramMessage = String.format(this.a.getResources().getString(2131435620), new Object[] { Integer.valueOf(i) });
            if (i == 110405)
            {
              this.a.a(paramMessage, new alhx(this));
          ...
          {
            paramMessage = String.format(this.a.getResources().getString(2131435625), new Object[] { localGetAuthApiListResponse.msg.get(), Integer.valueOf(i) });
            continue;
          }
          ...
          this.a.a(paramMessage, new alhy(this, localGetAuthApiListResponse, (JSONObject)localObject1));
          continue;
        ...
        if (i != 0)
        {
          ...
          try
          {
            ...
            if (TextUtils.isEmpty((CharSequence)localObject2))
            {
              ...
              this.a.a(paramMessage, new alhz(this));
            }
            do
            {
              this.a.b(i, paramMessage);
              return true;
              paramMessage = String.format(this.a.getResources().getString(2131435625), new Object[] { localObject2, Integer.valueOf(i) });
              break;
      ...
      for (;;)
      {
        try
        {
          ...
          if (k >= 100)
          {
            localObject1 = (GetAppInfoProto.MsgIconsurl)paramMessage.iconsURL.get(i);
            if (localObject1 != null) {
              ThreadManager.executeOnNetWorkThread(new alia(this, (GetAppInfoProto.MsgIconsurl)localObject1));
            }
            ...
            ThreadManager.executeOnNetWorkThread(new alib(this, (String)localObject1));
          }
        }
        ...
        this.a.a();
        break;
        ThreadManager.postImmediately(new alic(this), null, true);
        break;
        i = paramMessage.arg1;
        paramMessage = (String)paramMessage.obj;
        this.a.b(i, paramMessage);
