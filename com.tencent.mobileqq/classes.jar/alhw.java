...
public class alhw
  extends Observable
{
  private static volatile alhw jdField_a_of_type_Alhw;
  private static alia jdField_a_of_type_Alia;
  private List<String> jdField_a_of_type_JavaUtilList = new ArrayList();
  
  public static alhw a()
  {
    if (jdField_a_of_type_Alhw == null) {}
    try
    {
      if (jdField_a_of_type_Alhw == null) {
        jdField_a_of_type_Alhw = new alhw();
      }
      return jdField_a_of_type_Alhw;
    }
    finally {}
  }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        float f1 = zps.a((Context)localObject2, ImmersiveUtils.getStatusBarHeight(BaseApplicationImpl.getApplication()));
        float f2 = ((FragmentActivity)localObject2).getResources().getDimension(2131299011);
        Object localObject3 = new JSONObject();
        ((JSONObject)localObject3).put("width", zps.a((Context)localObject2, ImmersiveUtils.a()));
        ((JSONObject)localObject3).put("height", zps.a((Context)localObject2, f1 + f2));
        ...
        Object localObject4 = agyv.a((String)localObject3);
        ...
        if (localObject4 != null)
        {
          f1 = zps.a(((ArkAppView)localObject3).getContext(), ((Rect)localObject4).top);
          float f3 = zps.a(((ArkAppView)localObject3).getContext(), ((Rect)localObject4).bottom);
          f2 = zps.a(((ArkAppView)localObject3).getContext(), ((ArkAppView)localObject3).getMeasuredHeight());
          if (f3 <= f2) {
            f1 = f3 - f2;
          }
          ((JSONObject)localObject2).put("x", zps.a(((ArkAppView)localObject3).getContext(), ((Rect)localObject4).left));
          ((JSONObject)localObject2).put("y", f1);
          ((JSONObject)localObject2).put("width", zps.a(((ArkAppView)localObject3).getContext(), ((Rect)localObject4).width()));
  ...
  {
    ArkAppNotifyCenter.setNotify(paramString, new WeakReference(new alhz(this)));
  }
  ...
  public void a(List<String> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      if (jdField_a_of_type_Alia == null) {
        jdField_a_of_type_Alia = new alia(null);
      }
      ...
      BaseApplicationImpl.getApplication().getBaseContext().registerReceiver(jdField_a_of_type_Alia, paramList);
    }
  }
  ...
  public void a(String... paramVarArgs)
  {
    ...
    if (jdField_a_of_type_Alia != null)
    {
      BaseApplicationImpl.getApplication().getBaseContext().unregisterReceiver(jdField_a_of_type_Alia);
      jdField_a_of_type_Alia = null;
    }
  }
