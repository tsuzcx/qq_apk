...
{
  public txx(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (int i = paramInt + 1;; i = paramInt)
    {
      if (this.a.e) {
        if (paramInt == 0) {
          this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new txy(this), 320L);
        }
      }
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          if (this.a.jdField_d_of_type_Int == 9) {
            ...
            case 1: 
              ...
              break;
            case 2: 
              this.a.jdField_a_of_type_AndroidOsHandler.postDelayed(new txz(this), 320L);
              break;
            case 3: 
              ...
              this.a.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.a.findViewById(2131363455));
              this.a.jdField_d_of_type_AndroidWidgetTextView.setVisibility(0);
              this.a.jdField_d_of_type_AndroidWidgetTextView.setText("取消");
              this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new tya(this));
              if (this.a.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity$ListAdapter != null) {
                this.a.jdField_a_of_type_ComTencentMobileqqActivityTroopMemberListActivity$ListAdapter.a();
              }
              paramView = this.a.n;
