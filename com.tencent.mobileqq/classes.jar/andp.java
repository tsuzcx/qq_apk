  ...
  extends BusinessHandler
{
  ...
  public andp(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
  }
  
  public andp(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private bazc a(int paramInt1, String paramString, long paramLong, List<String> paramList, UnifySearchCommon.ResultItem paramResultItem, int paramInt2)
  {
    switch (paramInt1)
    {
    case 5: 
    ...
    default: 
      return null;
    case 2: 
      return new baza(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 3: 
      return new bazw(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 4: 
      return new bazb(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 7: 
      return new bazj(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 6: 
      return new bazs(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 8: 
      return new bazp(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 9: 
      return new bazq(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 11: 
      return new bazg(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 12: 
      return new baze(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 13: 
      return new bazh(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 14: 
      return new bazr(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 15: 
      return new bazo(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 16: 
      return new bazm(paramString, paramLong, paramList, paramResultItem, paramInt2);
    case 17: 
      return new bazn(paramString, paramLong, paramList, paramResultItem, paramInt2);
    }
    return new bazl(paramString, paramLong, paramList, paramResultItem, paramInt2);
  }
  ...
  private List<BusinessGroupWord> a(List<UnifySearchBusiHotWord.GroupWord> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      baww localbaww = new baww(((UnifySearchBusiHotWord.GroupID)((UnifySearchBusiHotWord.GroupWord)localObject1).group_id.get()).rpt_group_mask.get());
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localArrayList2.add(new bawx(localHotWordItem.word_id.get().toStringUtf8(), localHotWordItem.word.get().toStringUtf8()));
      }
      barw.a.put(barw.a(localbaww.a), localArrayList2);
      ...
      localObject1 = new bawv((String)localObject1, (String)localObject2);
      barw.b.put(barw.a(localbaww.a), localObject2);
      localArrayList1.add(new BusinessGroupWord(localbaww, localArrayList2, (bawv)localObject1));
    }
  ...
  {
    return (bcoo.a()) && ((paramLong == 1100L) || (paramLong == 1012L) || (paramLong == 1003L));
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (localRspBody.search_ver.has()) {
        bbgk.a("UnifySearch.Unite", (long[])localObject2, localRspBody.search_ver.get().toStringUtf8());
      }
    ...
    {
      ((List)localObject2).add(new bayn((UnifySearchUnite.TabItemGroup)paramObject.get(i)));
      i += 1;
    }
    i = localRspBody.trigger_netword_num.get();
    if (i >= 0) {
      bfyz.r(BaseApplicationImpl.getContext(), i);
    }
  ...
  public List<bays> a(Object... paramVarArgs)
  {
    ...
    label202:
    for (boolean bool1 = bbgh.b(i);; bool1 = true)
    {
  ...
  public void a()
  {
    ...
    localReqBody.version.set(ByteStringMicro.copyFromUtf8("8.4.8"));
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (!bfyz.b(paramQQAppInterface.getCurrentAccountUin(), paramInt))
    {
      if (QLog.isColorLevel()) {
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localRspBody.search_ver.has()) {
          bbgk.a("UnifySearch.Tab", arrayOfLong, localRspBody.search_ver.get().toStringUtf8());
        }
        ...
        bool1 = true;
        paramObject = localRspBody.item_groups.get();
        Object localObject2 = new bbas();
        if (bool2) {
          ((bbas)localObject2).a(true);
        }
        paramToServiceMsg = ((bbas)localObject2).a(new Object[] { str1, paramObject, Integer.valueOf(paramToServiceMsg.extraData.getInt("fromType")) });
  ...
  public void a(String paramString1, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    new bcek(this.app).a("dc00899").b("grp_search_engineer").c("search_net").d(paramString1).a(new String[] { paramLong2 + "", "" + (l - paramLong1), "" + paramString2, xwa.a(null) }).a();
  }
    ...
    for (;;)
    {
      ...
      if (paramInt3 == 1)
      {
        ...
        if (!paramBoolean1)
        {
          ...
          ((UnifySearchCommon.RootSearcherRequest)localObject1).rpt_busi_mask.set(bbgk.a(jdField_a_of_type_ArrayOfLong));
        ...
        i = 2;
        localObject2 = bfyz.b(this.app.getCurrentAccountUin());
        ...
        paramList2.extraData.putLongArray("masks", batb.a(paramList1));
  ...
  public void a(String paramString1, String paramString2, int paramInt1, List<Long> paramList1, List<Long> paramList2, byte[] paramArrayOfByte, int paramInt2, double paramDouble1, double paramDouble2, Bundle paramBundle, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (barw.a.isEmpty())
        {
          ...
          if (paramBundle != null)
          {
            ...
            if (!bool) {
              bbgk.a("sub_result", "active_search", new String[] { paramString1, bbgk.a(paramList1), "" + paramInt1, "" });
            }
      ...
      catch (UnsupportedEncodingException paramString3)
      {
        ...
        continue;
        localObject = barw.a.values().iterator();
        paramInt1 = 2;
      }
      label566:
      int i = paramInt1;
      if (((Iterator)localObject).hasNext())
      {
        ...
        while (localIterator.hasNext()) {
          if (paramString1.equals((bawx)localIterator.next())) {
            paramInt1 = 1;
          }
        }
      }
  ...
  public void a(UnifySearchCommon.ResultItemGroup paramResultItemGroup, long paramLong, String paramString, int paramInt, List<bays> paramList)
  {
    ...
    {
      localObject1 = new bazz(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
      ((bazz)localObject1).a(((UnifySearchCommon.ResultItem)localObject3).layout_id.get());
      ((bazz)localObject1).c(null);
      ((bazz)localObject1).a(bool2);
      label445:
      if ((localObject1 != null) && (((bazc)localObject1).b()))
      {
        ((bazc)localObject1).u = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
        ((bazc)localObject1).a = bool1;
      ...
      for (;;)
      {
        ...
        {
          localObject1 = new bbac(paramString, str7, -4, str5);
          ((bbac)localObject1).u = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
          localArrayList2.add(localObject1);
          l2 = l1;
        }
        else
        {
          localObject1 = new baxr(paramString, (String)localObject1, str4, str5, str6, str7, l2, localArrayList1, paramInt);
          l2 = l1;
          if (localObject1 != null)
          {
            ((baxr)localObject1).u = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
            ((baxr)localObject1).c = bool1;
            ((baxr)localObject1).j = i;
            ((baxr)localObject1).a = paramInt;
            localArrayList2.add(localObject1);
            l2 = l1;
          }
        }
      ...
      for (boolean bool3 = true;; bool3 = false)
      {
        ...
        paramList.add(new baym(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
        return;
        bool2 = false;
        break;
      }
      label875:
      paramList.add(new baxq(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
      return;
    }
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, int paramInt, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bfyz.b(this.app.getCurrentAccountUin(), i, paramInt);
        paramToServiceMsg = localRspBody.result_items.get();
        paramToServiceMsg = bbaa.b(this.app, paramToServiceMsg, i);
        if (QLog.isColorLevel()) {
