  ...
  implements akwx
{
  ...
  private AudioManager.OnAudioFocusChangeListener jdField_a_of_type_AndroidMediaAudioManager$OnAudioFocusChangeListener = new akwl(this);
  ...
  public akwj(AppInterface paramAppInterface, int paramInt)
  {
  ...
  public int a(akrx paramakrx, int paramInt1, int paramInt2, String paramString, long paramLong, int paramInt3, float paramFloat)
  {
    ...
    if ((this.b > 0) && ((this.jdField_a_of_type_Int == 0) || (localObject1 == null) || (!akwd.d()) || (paramakrx == null)))
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      for (localObject1 = null;; localObject1 = null)
      {
        ...
        try
        {
          ...
          {
            localObject1 = ((ApolloSurfaceView)paramakrx).getRender();
            if (localObject1 == null) {
              continue;
            }
          ...
          for (localObject1 = paramString;; localObject1 = ((File)localObject1).getPath())
          {
            ...
            localObject1 = ((ApolloTextureView)paramakrx).getRender();
            break;
        ...
        {
          QLog.e(jdField_a_of_type_JavaLangString, 1, "[playMusic], errInfo->" + paramakrx.getMessage());
          return -1;
        }
        label368:
        ...
        if (paramString != null)
        {
          ...
          localObject1 = akwd.a();
          if (localObject1 != null) {
            ((ApolloCmdChannel)localObject1).playMusicInner(paramakrx, paramString.hashCode(), paramLong);
          }
        ...
        for (;;)
        {
          try
          {
            ...
            synchronized (this.jdField_a_of_type_JavaLangObject)
            {
              ...
              if (paramInt2 == 2147483647)
              {
                ...
                if (paramInt2 != 2147483647)
                {
                  paramString.setOnCompletionListener(new akwk(this, paramInt2, paramakrx, paramLong));
                  if (QLog.isColorLevel()) {
          ...
          {
            QLog.e(jdField_a_of_type_JavaLangString, 1, "prepare - start :", paramakrx);
            return -1;
          }
        }
      }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_Int == 0) || (akwd.b()) || (akwd.c()) || (!akwd.d())) {
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "DO NOT play music.");
      }
    }
