...
public class akwj
{
  static akwj jdField_a_of_type_Akwj;
  private ayjs jdField_a_of_type_Ayjs = new akwk(this);
  ShareAppLogHelper jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper;
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  
  akwj(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramQQAppInterface);
  }
  
  public static akwj a(QQAppInterface paramQQAppInterface)
  {
    jdField_a_of_type_Akwj = new akwj(paramQQAppInterface);
    return jdField_a_of_type_Akwj;
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper.a(this.jdField_a_of_type_Ayjs);
