  ...
  extends AsyncTask<Void, Void, String>
{
  ...
  public nkd(PoiMapActivity paramPoiMapActivity) {}
  ...
  protected String a(Void... paramVarArgs)
  {
    ...
    if (i < 3)
    {
      ...
      paramVarArgs = bhrr.a(this.jdField_a_of_type_ComTencentBizPoiMapActivity.getApplicationContext(), this.b.getLatitudeE6() / 1000000.0D, this.b.getLongitudeE6() / 1000000.0D, 3, this.jdField_a_of_type_OrgApacheHttpClientHttpClient);
  ...
  protected void a(String paramString)
  {
    ...
    for (String str = "Unknown Address";; str = paramString)
    {
      ...
      paramString = new nkd(this.jdField_a_of_type_ComTencentBizPoiMapActivity);
  ...
  protected void onCancelled()
  {
    ...
    {
      nkd localnkd = new nkd(this.jdField_a_of_type_ComTencentBizPoiMapActivity);
      localnkd.a(this.jdField_a_of_type_ComTencentMapLibBasemapDataGeoPoint);
      this.jdField_a_of_type_ComTencentBizPoiMapActivity.a = localnkd;
      this.jdField_a_of_type_ComTencentBizPoiMapActivity.a.execute(new Void[0]);
      this.jdField_a_of_type_ComTencentMapLibBasemapDataGeoPoint = null;
    }
  }
