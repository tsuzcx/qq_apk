...
public class aeur
  extends beey
{
  aeur(ConfessHalfScreenActivity.ConfessBrowserFragment paramConfessBrowserFragment) {}
  ...
  public void a()
  {
    ...
    {
      localWebView = this.jdField_a_of_type_Bedi.a();
    ...
    for (;;)
    {
      this.c.setOnClickListener(new aeus(this));
      return;
      label171:
