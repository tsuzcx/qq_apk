...
class ahin
  extends Handler
{
  ahin(ahim paramahim, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message arg1)
  {
    ...
    case 1: 
      synchronized (ahim.a())
      {
        ...
        if ((ReportInfo)ahim.a(this.a).get(Long.valueOf(localReportHeader.seqno)) != null)
        {
          if (QLog.isColorLevel()) {
      ...
      if (localObject5 != null)
      {
        ...
        ahim.a(this.a).add(localObject5);
      }
      ahim.a(this.a).put(Long.valueOf(localObject1.seqno), localReportInfo);
      ahim.b(this.a).add(localObject1);
      ahim.a().notify();
      return;
    case 2: 
      for (;;)
      {
        synchronized (ahim.a())
        {
          ...
          localObject5 = (ReportInfo)ahim.a(this.a).get(Long.valueOf(l));
          if (localObject5 != null) {
            break;
          }
          if (QLog.isColorLevel())
    ...
    case 3: 
      for (;;)
      {
        synchronized (ahim.a())
        {
          ...
          localObject4 = (ReportInfo)ahim.a(this.a).get(Long.valueOf(l));
      ...
      else
      {
        ...
        ahim.a(this.a).add(???);
        ahim.b(this.a, 5);
        localObject4 = ahim.b(this.a).obtainMessage();
        if (localObject4 != null)
        {
          ((Message)localObject4).arg1 = 5;
          ((Message)localObject4).obj = new Object[] { Long.valueOf(l), ??? };
          ahim.b(this.a).sendMessageDelayed((Message)localObject4, 10000L);
        }
        return;
      }
      break;
    ...
    for (??? = ???.step;; ??? = ".")
    {
      ...
      synchronized (ahim.a())
      {
        ...
        if ((ReportInfo)ahim.a(this.a).get(Long.valueOf(((ReportHeader)???).seqno)) != null)
        {
          if (QLog.isColorLevel()) {
      ...
      localReportInfo.body.reportItems.add(localObject5);
      ahim.a(this.a).put(Long.valueOf(localObject3.seqno), localReportInfo);
      ahim.b(this.a).add(localObject3);
      ahim.a(this.a).add(localObject5);
      ahim.a(this.a, 1);
      return;
      ??? = ".";
