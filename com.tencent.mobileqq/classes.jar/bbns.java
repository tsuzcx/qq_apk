...
public class bbns
  implements Handler.Callback, bbnr
{
  int jdField_a_of_type_Int = 0;
  Handler jdField_a_of_type_AndroidOsHandler = null;
  bbnt jdField_a_of_type_Bbnt = null;
  WeakReference<View> jdField_a_of_type_JavaLangRefWeakReference;
  boolean jdField_a_of_type_Boolean;
  int jdField_b_of_type_Int = 10;
  boolean jdField_b_of_type_Boolean = false;
  
  public bbns(bbnt parambbnt, Context paramContext)
  {
    this.jdField_a_of_type_Bbnt = parambbnt;
  ...
  void a(int paramInt)
  {
    ...
    if (paramInt != this.jdField_a_of_type_Int)
    {
      ...
      if (this.jdField_a_of_type_Bbnt != null) {
    ...
    {
      this.jdField_a_of_type_Bbnt.a(localView, i, paramInt);
      return;
    }
  }
