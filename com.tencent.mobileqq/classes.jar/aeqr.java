  ...
  extends aepy
{
  ...
  public aeqr(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  private BaseChatItemLayout a(long paramLong)
  {
    ...
    if (paramLong == 0L)
    {
      ...
      while (k < this.jdField_a_of_type_ComTencentWidgetListView.getChildCount())
      {
        ...
        {
          localObject2 = (aelt)aekt.a((View)localObject1);
          if ((((aelt)localObject2).jdField_a_of_type_Int != 0) && (((aelt)localObject2).jdField_a_of_type_AndroidViewView.getTop() + ((View)localObject1).getTop() + BaseChatItemLayout.jdField_g_of_type_Int > 0)) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if (((localObject2 instanceof BaseChatItemLayout)) && (((aelt)aekt.a((View)localObject2)).jdField_a_of_type_Int != 0)) {
  ...
  int a(int paramInt, aelt paramaelt)
  {
    int k;
    int m;
    int n;
    if (paramaelt.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend())
    {
      k = paramaelt.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.j + BaseChatItemLayout.o;
      m = paramaelt.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.i - BaseChatItemLayout.n;
      if (paramInt > k) {
        break label135;
      }
    ...
    {
      return n;
      k = paramaelt.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.i + BaseChatItemLayout.n;
      m = paramaelt.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.j - BaseChatItemLayout.j;
      break;
      d1 = Math.random();
  ...
  public long a()
  {
    ...
    case 3: 
      ...
      if (this.jdField_b_of_type_Int == 1)
      {
        ...
        {
          localaelt = (aelt)aekt.a(localBaseChatItemLayout);
          if (localaelt != null)
          {
            this.jdField_b_of_type_Int = 2;
            this.jdField_a_of_type_Long = 0L;
            this.jdField_b_of_type_Long = localaelt.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq;
            this.jdField_d_of_type_Long = 0L;
            this.jdField_e_of_type_Int = 0;
            k = localaelt.jdField_a_of_type_AndroidViewView.getTop();
            ...
            this.jdField_g_of_type_Int = a((localaelt.jdField_a_of_type_AndroidViewView.getLeft() + localaelt.jdField_a_of_type_AndroidViewView.getRight()) / 2, localaelt);
            this.h = 0;
      ...
      if (localBaseChatItemLayout != null)
      {
        ...
        if (localaelt != null)
        {
          ...
          this.jdField_e_of_type_Int = (a(this.i, localaelt) - this.i);
  ...
  public boolean a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      while ((this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner == null) || (this.jdField_a_of_type_AndroidViewView == null))
      {
        ...
        return false;
        k = aekt.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
        ...
        {
          aelt localaelt = (aelt)aekt.a(aekt.a(this.jdField_a_of_type_ComTencentWidgetListView, k));
          if (localaelt != null)
          {
            k = localaelt.jdField_a_of_type_AndroidViewView.getTop();
            k = localaelt.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            if (k != 0)
            {
              this.h += k;
              this.j += k;
          ...
          else
          {
            ...
            return false;
            k = aekt.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            int m = aekt.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
            ...
            {
              localaelt = (aelt)aekt.a(aekt.a(this.jdField_a_of_type_ComTencentWidgetListView, k));
              if (localaelt != null)
              {
                k = localaelt.jdField_a_of_type_AndroidViewView.getTop();
                k = localaelt.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
            ...
            {
              localaelt = (aelt)aekt.a(aekt.a(this.jdField_a_of_type_ComTencentWidgetListView, m));
              if (localaelt != null)
              {
                k = localaelt.jdField_a_of_type_AndroidViewView.getTop();
                k = localaelt.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + k + BaseChatItemLayout.jdField_g_of_type_Int - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.h + this.jdField_f_of_type_Int);
