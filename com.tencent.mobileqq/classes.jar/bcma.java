...
{
  public BroadcastReceiver a = new bcmb(this);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("ptv".equals(paramString2))
    {
      ...
      for (;;)
      {
        ...
        localbncr.f = str21;
        localbncr.g = str22;
        localbncr.h = ((String)localObject2);
        if (!TextUtils.isEmpty(str9))
        {
          bcly.a(this.mRuntime.a(), this.mRuntime.a(), str4, str5, str6, str7, str10, str11, str12, str13, str14, str15, str16, str17, str18, str8, str19, paramString3, str9, paramString1, paramJsBridgeListener, paramString2, (String)localObject1, localbncr);
          continue;
          continue;
          ...
          else if ("onClickShareBattle".equals(paramString3))
          {
            try
            {
              ...
              ywo.a().a(paramString1, Integer.valueOf(i).toString());
            }
            catch (JSONException paramJsBridgeListener) {}
            if (QLog.isColorLevel())
            {
          ...
          else if (("startStoryActivity".equals(paramString3)) && (paramVarArgs != null))
          {
            try
            {
              ...
              bcly.a(this.mRuntime.a(), this.mRuntime.a(), i);
            }
