...
public class aokn
{
  ...
  static
  {
    ...
    jdField_a_of_type_Array2dOfJavaLangString = new String[][] { arrayOfString1, { "p_qlogo_cn_2g", "p_qlogo_cn_3g", "p_plogo_cn_4g", "p_plogo_cn_wifi" }, { "p_qpic_cn_2g", "p_qpic_cn_3g", "p_qpic_cn_4g", "p_qpic_cn_wifi" }, arrayOfString2, { "sqimg_qq_com_2g", "sqimg_qq_com_3g", "sqimg_qq_com_4g", "sqimg_qq_com_wifi" }, arrayOfString3, { "wfqqreader_3g_qq_cn_2g", "wfqqreader_3g_qq_cn_3g", "wfqqreader_3g_qq_cn_4g", "wfqqreader_3g_qq_cn_wifi" }, { "buluo_qq_com_2g", "buluo_qq_com_3g", "buluo_qq_com_4g", "buluo_qq_com_wifi" } };
  ...
  {
    String str = String.valueOf(bdin.a(BaseApplicationImpl.getApplication().getApplicationContext()));
    ...
    Object localObject = basl.a().a(12);
      ...
      if ((paramFileStoragePushFSSvcList != null) && (paramFileStoragePushFSSvcList.domainIpChannel != null) && (paramFileStoragePushFSSvcList.domainIpChannel.vDomain_iplists != null))
      {
        ...
        while (paramFileStoragePushFSSvcList.hasNext())
        {
          ...
          if ((((DomainIpList)localObject1).vIplist != null) && (((DomainIpList)localObject1).vIplist.size() != 0))
          {
            ...
            {
              ((StringBuilder)localObject2).append(bdin.a(((DomainIpInfo)((DomainIpList)localObject1).vIplist.get(i)).uIp));
            ...
            for (;;)
            {
              ...
              {
                String str = bdin.a(((DomainIpInfo)((DomainIpList)localObject1).vIplist.get(k)).uIp);
  ...
  public static String b()
  {
    ...
    Object localObject = basl.a().a(14);
    if ((localObject == null) || (((ArrayList)localObject).isEmpty())) {
      return null;
    }
    localObject = (FileStorageServerListInfo)((ArrayList)localObject).get((int)(Math.random() * ((ArrayList)localObject).size() + 1.0D));
  ...
  {
    String str1 = String.valueOf(bdgk.e());
