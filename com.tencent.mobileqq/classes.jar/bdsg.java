  ...
  extends bdom
{
  ...
  private RelativeLayout a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestWidth = agej.a(70.0F, localResources);
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestHeight = agej.a(70.0F, localResources);
      localObject1 = URLDrawable.getDrawable(paramString1, (URLDrawable.URLDrawableOptions)localObject1);
      localAnyScaleTypeImageView.setId(2131368320);
      localAnyScaleTypeImageView.setImageDrawable((Drawable)localObject1);
      paramString1 = new RelativeLayout.LayoutParams(agej.a(70.0F, localResources), agej.a(70.0F, localResources));
  ...
  private RelativeLayout a(Context paramContext, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      j = localResources.getDimensionPixelSize(2131296393);
      if (!paramBoolean) {
        break label135;
      }
      k = localResources.getDimensionPixelSize(2131296394);
      if (!a(1)) {
        break label147;
      }
      m = agej.a(15.0F, localResources);
    ...
    for (;;)
    {
      ...
      break;
      label135:
      k = localResources.getDimensionPixelSize(2131298914);
      break label63;
      label147:
      m = agej.a(6.0F, localResources);
      break label80;
      label159:
      if (a(1)) {
        i = agej.a(15.0F, localResources);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (((Bundle)localObject3).getBoolean("pre_dialog") == true)
    {
      ...
      {
        localObject4 = (bdol)((Iterator)localObject5).next();
        if ((localObject4 instanceof bdts))
        {
          localObject4 = (bdts)localObject4;
          if (!((bdts)localObject4).a()) {
            break label164;
          }
          localObject2 = ((bdts)localObject4).ac;
          localObject4 = ((bdts)localObject4).ag;
    ...
    for (;;)
    {
      ...
      if ((localObject4 instanceof StructMsgItemTitle))
      {
        ...
        if (((Bundle)localObject3).getInt("accostType") == AbsStructMsg.SOURCE_ACCOUNT_TYPE_PA)
        {
          ...
          n = agej.a(10.0F, (Resources)localObject5);
          int i1 = agej.a(4.0F, (Resources)localObject5);
          int i2 = agej.a(5.0F, (Resources)localObject5);
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject1 = ((bdol)localObject4).a(paramContext, null, (Bundle)localObject3);
              localObject4 = ((View)localObject1).findViewById(2131368493);
              if ((localObject4 != null) && ((localObject4 instanceof AnyScaleTypeImageView))) {
                ((AnyScaleTypeImageView)localObject4).setTag(2131373149, Integer.valueOf(1));
              }
              k = i;
            ...
            else
            {
              if ("video".equals(str))
              {
                if ((localObject4 instanceof bdts))
                {
                  localObject1 = (bdts)localObject4;
                  if (this.jdField_a_of_type_Boolean) {
                    ((bdts)localObject1).c = false;
                  }
                  if (((bdts)localObject1).a()) {
                    if (!this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.hasFlag(4))
                    {
                      ...
                      {
                        localObject1 = (bdol)this.jdField_a_of_type_JavaUtilArrayList.get(k);
                        if (!"title".equals(((bdol)localObject1).jdField_a_of_type_JavaLangString)) {
                          break label859;
                        }
                ...
                for (;;)
                {
                  ...
                  localObject4 = ((bdol)localObject4).a(paramContext, null, (Bundle)localObject3);
                  k = 1;
                ...
                if (localObject1 != null)
                {
                  ...
                  i = ((Resources)localObject5).getDimensionPixelSize(2131296393);
                ...
                for (k = (int)(i / 1.8F);; k = m)
                {
                  ...
                  for (;;)
                  {
                    ...
                    if ((j != 0) && (!TextUtils.isEmpty(paramBundle)) && ((localObject1 instanceof TitledImageView)))
                    {
                      ...
                      ((TitledImageView)localObject3).setTextSize(agej.a(2, 18, (Resources)localObject5));
                      ((TitledImageView)localObject3).setTextBackground(paramContext.getResources().getColor(2131165286));
                      ((TitledImageView)localObject3).setTextPadding(agej.a(10.0F, (Resources)localObject5));
                      ((TitledImageView)localObject3).settextBgRadius(agej.a(12.0F, (Resources)localObject5));
                    }
                    if ((j != 0) && (!TextUtils.isEmpty(paramBundle)))
                    {
                      paramContext = ((View)localObject1).getTag(2131378094);
                      if ((paramContext != null) && ((paramContext instanceof bdtz))) {
                        ((bdtz)paramContext).a.setText(paramBundle);
                      }
                    }
                    ...
                    ((RelativeLayout)localObject2).setId(2131378091);
                    return localObject2;
                    i = ((Resources)localObject5).getDimensionPixelSize(2131298913);
                    break;
                  }
                  i = k - i * 2;
                  break label960;
