...
public class bdsg
{
  ...
  private final bdxv jdField_a_of_type_Bdxv = new bdxv();
  private final bdxw jdField_a_of_type_Bdxw = new bdxw();
  private final bdxx jdField_a_of_type_Bdxx = new bdxx(200);
  private MiniAppInfo jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo;
  private final Runnable jdField_a_of_type_JavaLangRunnable = new MiniGamePerformanceStatics.1(this);
  private long jdField_b_of_type_Long;
  private final bdxv jdField_b_of_type_Bdxv = new bdxv();
  ...
  private void d()
  {
    this.jdField_a_of_type_Bdxv.a();
    this.jdField_b_of_type_Bdxv.a();
    this.jdField_a_of_type_Bdxx.a();
    this.jdField_a_of_type_Long = bdrs.a("-1");
  ...
  private void e()
  {
    ...
    if (this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo != null)
    {
      ...
      f5 = (float)(bdrs.a("-1") - this.jdField_a_of_type_Long) / ((float)l / 1000.0F);
      f6 = this.jdField_a_of_type_Bdxv.a();
      f7 = this.jdField_a_of_type_Bdxw.a() - this.jdField_a_of_type_Float;
      if (!this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo.isReportTypeMiniGame()) {
        break label365;
      }
      f3 = this.jdField_b_of_type_Bdxv.a();
      float f4 = this.jdField_a_of_type_Bdxx.a();
      bdsu.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 629, a(f5), "1");
      bdsu.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 631, a(f6), "1");
      bdsu.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 643, a(f7), "1");
      bdsu.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 630, a(f3), "1");
      bdsu.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 642, a(f4), "1");
      bdsm.a(f3, f4);
      f1 = f3;
      f2 = f4;
      if (localMiniAppProxy.isDebugVersion())
      {
        bdnw.b("MiniGamePerformance", "cpu:" + f5 + " avgMemory:" + f6 + " memoryGrowth:" + f7 + " avgFps:" + f3 + " fpsVariance:" + f4 + " dalivkPss:" + this.jdField_a_of_type_AndroidOsDebug$MemoryInfo.dalvikPss + " nativePss:" + this.jdField_a_of_type_AndroidOsDebug$MemoryInfo.nativePss + " otherPss:" + this.jdField_a_of_type_AndroidOsDebug$MemoryInfo.otherPss + " totalPss:" + this.jdField_a_of_type_AndroidOsDebug$MemoryInfo.getTotalPss());
        f2 = f4;
      }
    }
    for (float f1 = f3;; f1 = 0.0F)
    {
      bdsn.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, f5, f6, f7, f1, f2);
      d();
      return;
      label365:
      bdsu.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 629, a(f5), "0");
      bdsu.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 631, a(f6), "0");
      bdsu.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 643, a(f7), "0");
      if (localMiniAppProxy.isDebugVersion()) {
  ...
  {
    this.jdField_a_of_type_Bdxx.a(paramFloat);
    this.jdField_b_of_type_Bdxv.a(paramFloat);
  }
  ...
  public void c()
  {
    bdew.a().removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    e();
  }
}
