...
public class bdsg
  extends bdtr
{
  public bdsg(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    try
    {
      ...
      paramDownloadParams.inPreferredConfig = bdzx.a;
      ...
      if (bool) {
        try
        {
          ...
          if (paramDownloadParams != null) {
            return new beak(paramFile.getAbsolutePath()).a(paramDownloadParams);
          }
          paramFile.delete();
