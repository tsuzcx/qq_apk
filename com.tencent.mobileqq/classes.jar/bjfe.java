  ...
  implements IMediaPlayer
{
  ...
  private bjfo jdField_a_of_type_Bjfo = new bjff(this);
  ...
  private void e()
  {
    yqp.b("DefaultMediaPlayer", "onVideoPlayEnded");
  ...
  private void f()
  {
    yqp.b("DefaultMediaPlayer", "onVideoPlayRepeated");
  ...
  {
    boolean bool2 = true;
    bjfg.a(hashCode(), "[Player] handle play cmd from qg");
    yqp.a("DefaultMediaPlayer", "handleStartPlay , src = %s", this.jdField_a_of_type_JavaLangString);
    ...
    this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder = new MediaDecoder(this.jdField_a_of_type_JavaLangString, this.jdField_d_of_type_Int, this.jdField_a_of_type_Bjfo, false, hashCode());
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      this.jdField_d_of_type_Boolean = false;
      this.g = 0;
      bjfg.a(hashCode(), "[Player] handle play cmd from qg finish");
      return;
      bool1 = false;
      break;
    }
  ...
  private void h()
  {
    yqp.a("DefaultMediaPlayer", "handleResumePlay , src = %s", this.jdField_a_of_type_JavaLangString);
  ...
  private void i()
  {
    ...
    if (this.g == 1)
    {
      ...
      bjfg.a(hashCode(), "[Player] render first frame to qg");
    }
  }
  
  public void a()
  {
    yqp.b("DefaultMediaPlayer", "onResume");
    if (this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder != null) {
      this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder.d();
    }
  }
  ...
  public void b()
  {
    yqp.b("DefaultMediaPlayer", "onPause");
    if (this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder != null) {
  ...
  public void c()
  {
    yqp.b("DefaultMediaPlayer", "onStop");
    if (this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder != null) {
      this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder.b();
    }
  }
  ...
  {
    yqp.b("DefaultMediaPlayer", "qg -> create");
  ...
  public void destroy()
  {
    yqp.b("DefaultMediaPlayer", "qg -> destroy");
    c();
    if (this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer != null) {
  ...
  {
    return (int)wip.a(this.jdField_a_of_type_JavaLangString);
  }
  ...
  public void pause()
  {
    yqp.b("DefaultMediaPlayer", "qg -> pause");
    b();
  }
  
  public void play(int paramInt1, int paramInt2, int paramInt3)
  {
    yqp.a("DefaultMediaPlayer", "qg -> play , texture id = %d , width = %d , height = %d", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3));
    bjfg.a(hashCode(), "[Player] receive play cmd from qg");
  ...
  public void setSrc(String paramString)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      yqp.a("DefaultMediaPlayer", "qg -> set Src , src = %s , isSrcChanged :%s", str, Boolean.valueOf(this.jdField_c_of_type_Boolean));
      return;
    }
  }
  ...
  {
    yqp.b("DefaultMediaPlayer", "qg -> setVolume , not support yet");
  }
  
  public void stop()
  {
    yqp.b("DefaultMediaPlayer", "qg -> stop");
    c();
  }
}
