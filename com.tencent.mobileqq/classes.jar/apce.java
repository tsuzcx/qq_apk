  ...
  implements apbw
{
  ...
  private apbv jdField_a_of_type_Apbv;
  private apcf jdField_a_of_type_Apcf;
  volatile apch jdField_a_of_type_Apch = null;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = apce.class.getSimpleName();
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Apci != null) {
      this.jdField_a_of_type_Apci.b(this.jdField_a_of_type_AndroidWidgetRelativeLayout);
    }
    this.jdField_a_of_type_Apcf = null;
    f();
    this.h = -1;
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.jdField_a_of_type_Apcf != null)
    {
      this.jdField_a_of_type_Apcf.a(paramInt1, paramInt2, paramInt3, paramInt4);
      return;
    }
  ...
  public void a(apcf paramapcf)
  {
    if (paramapcf != null)
    {
      this.jdField_a_of_type_Apcf = paramapcf;
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
        this.jdField_a_of_type_Apcf.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout);
      }
      this.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Apcf.b();
      if (!this.jdField_a_of_type_Apcf.c()) {
        break label75;
      }
    }
    label75:
    ...
    {
      this.g = k;
      this.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_Apcf.a();
      return;
    }
  }
  
  public void a(aplf paramaplf, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    int m;
    boolean bool;
    if ((this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_d_of_type_Int == 0) && (this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_c_of_type_Int > 0))
    {
      f();
      if (k != 0)
      {
      ...
      paramaplf = ARLocalGestureCircleRecog.a(paramInt1, paramInt2, paramInt3, paramInt4, new PointF(this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_a_of_type_Aplg.b, this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_a_of_type_Aplg.c));
      m = (int)(this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_a_of_type_Aplg.jdField_a_of_type_Float / paramInt2 * paramInt3);
      int n = (int)paramaplf.x;
      int i1 = (int)paramaplf.y;
      if (this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_a_of_type_Aplg.jdField_a_of_type_Boolean)
      {
        k = 1;
        a(m, n, i1, k);
        b(1);
        apdk.a().a(6);
        this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.g = 0;
      }
    }
    else
    {
      if (this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_c_of_type_Int <= this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_d_of_type_Int) {
        break label547;
      }
      m = 0;
      if (this.jdField_a_of_type_Aplf.jdField_a_of_type_Apli.jdField_d_of_type_Int != 1) {
        break label478;
      }
      if (this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_d_of_type_Int != 0) {
        break label457;
      }
      k = 0;
      m = 1;
    ...
    for (;;)
    {
      ...
      if (m != 0)
      {
        ...
        paramaplf = new int[this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_c_of_type_Int - k];
        int[] arrayOfInt1 = new int[this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_c_of_type_Int - k];
        int[] arrayOfInt2 = new int[this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_c_of_type_Int - k];
        paramInt2 = k;
        for (;;)
        {
          if (paramInt2 < this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_c_of_type_Int)
          {
            PointF localPointF = ARLocalGestureCircleRecog.a(paramInt1, paramInt1, paramInt3, paramInt4, this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_a_of_type_ArrayOfAndroidGraphicsPointF[paramInt2]);
            paramaplf[(paramInt2 - k)] = ((int)localPointF.x);
            arrayOfInt1[(paramInt2 - k)] = ((int)localPointF.y);
            arrayOfInt2[(paramInt2 - k)] = this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_a_of_type_ArrayOfInt[paramInt2];
            paramInt2 += 1;
            continue;
            k = -1;
            break;
            label457:
            k = this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_d_of_type_Int;
            m = 1;
            bool = false;
            break label291;
            label478:
            if (this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_c_of_type_Int >= 1) {
              m = 1;
            }
            if (this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_d_of_type_Int < 1)
            {
              bool = true;
              k = 0;
              break label291;
        ...
        a(paramaplf, arrayOfInt1, arrayOfInt2, bool);
      }
    }
    for (;;)
    {
      label547:
      if ((this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_a_of_type_Int == -1) && (this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_b_of_type_Int != -1) && (this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_c_of_type_Int > 0))
      {
        ...
        if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
          ((apos)this.jdField_a_of_type_JavaLangRefWeakReference.get()).b(new ARTransferDoorLogicManager.2(this), 1000L);
        }
      }
      QLog.i(jdField_a_of_type_JavaLangString, 1, "zoomOutWorldCupSparks curent state " + this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_a_of_type_Int);
      if ((this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_a_of_type_Int == 0) && (this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.jdField_b_of_type_Int != 0))
      {
        c(5);
        b(2);
        ThreadManager.getSubThreadHandler().post(new ARTransferDoorLogicManager.3(this));
        if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
          ((apos)this.jdField_a_of_type_JavaLangRefWeakReference.get()).b(new ARTransferDoorLogicManager.4(this), 1500L);
        }
      }
      return;
      label779:
      ...
      if (this.jdField_c_of_type_Boolean)
      {
        ...
        paramaplf = new ARTransferDoorLogicManager.1(this, paramInt1, paramInt2, paramInt3, paramInt4);
        QLog.i(jdField_a_of_type_JavaLangString, 1, "DrawCircle. resume. mDrawCirclePuase = " + this.jdField_c_of_type_Boolean + ", genIdx = " + this.jdField_a_of_type_Aplf.jdField_a_of_type_Aplh.g);
        if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null) && (!this.jdField_c_of_type_Boolean)) {
          ((apos)this.jdField_a_of_type_JavaLangRefWeakReference.get()).b(paramaplf, this.j);
        }
      }
    }
  }
  ...
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramapos);
  }
  ...
  public void a(AppInterface paramAppInterface, ScanTorchActivity paramScanTorchActivity, RelativeLayout paramRelativeLayout)
  {
    ...
    this.jdField_a_of_type_Apbv = new apbv(paramScanTorchActivity);
    this.jdField_a_of_type_Apbv.a(this);
    if ((this.jdField_a_of_type_Apcf != null) && (paramRelativeLayout != null))
    {
      QLog.d(jdField_a_of_type_JavaLangString, 2, "init " + paramRelativeLayout.getChildCount());
      this.jdField_a_of_type_Apcf.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout);
      this.jdField_a_of_type_Apci = new apci(paramScanTorchActivity);
      return;
    }
  ...
  public void a(ArCloudConfigInfo paramArCloudConfigInfo)
  {
    ...
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((apos)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(4096L, localArCloudConfigInfo);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      if ((this.jdField_a_of_type_Apcf != null) && (this.g == 1)) {
        if (this.jdField_a_of_type_Apcf.b())
        {
          c(6);
          this.jdField_a_of_type_Apcf.a();
          this.h = -1;
        }
      }
      for (;;)
      {
        ...
        this.h = 0;
        continue;
        if ((this.jdField_a_of_type_Apcf != null) && (this.g == 2))
        {
          c(2);
          this.h = 0;
        }
        else if (this.jdField_a_of_type_Apcf == null)
        {
          c(2);
          this.h = 0;
        }
    ...
    if ((this.jdField_a_of_type_Apcf != null) && (this.jdField_a_of_type_Apcf.b()) && (this.g == 1)) {
      c(1);
    }
    for (;;)
    {
  ...
  public void a(int[] paramArrayOfInt1, int[] paramArrayOfInt2, int[] paramArrayOfInt3, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Apcf != null) && (this.jdField_a_of_type_Apcf.a()))
    {
      this.jdField_a_of_type_Apcf.a(paramArrayOfInt1, paramArrayOfInt2, paramArrayOfInt3, paramBoolean);
      return;
    }
  ...
  {
    if (this.jdField_a_of_type_Apcf != null) {
      return this.jdField_a_of_type_Apcf.a();
    }
    return 0;
  }
  ...
  public void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Apcf != null)
    {
      this.jdField_a_of_type_Apcf.a(paramInt);
      return;
    }
    String str = jdField_a_of_type_JavaLangString;
    if ("switchGameStatus " + paramInt + "|" + this.jdField_a_of_type_Apcf != null) {}
    for (;;)
    {
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((apos)this.jdField_a_of_type_JavaLangRefWeakReference.get()).d(1);
    }
  }
  ...
  public void c(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_MqqOsMqqHandler == null) || (this.jdField_a_of_type_ComTencentMobileqqArViewARScanEntryView == null) || ((this.jdField_a_of_type_ComTencentMobileqqArViewARScanEntryView != null) && (!this.jdField_a_of_type_ComTencentMobileqqArViewARScanEntryView.h_()))) {
      return;
    }
    switch (paramInt)
    {
  ...
  public void h()
  {
    ...
    this.jdField_a_of_type_Apch = null;
    if (this.jdField_a_of_type_MqqOsMqqHandler != null) {
      this.jdField_a_of_type_MqqOsMqqHandler.removeCallbacksAndMessages(null);
    }
    this.jdField_a_of_type_Apci = null;
    if (this.jdField_a_of_type_Apbv != null)
    {
      this.jdField_a_of_type_Apbv.b();
      this.jdField_a_of_type_Apbv = null;
    }
    this.h = -1;
