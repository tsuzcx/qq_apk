...
public class wsu
  implements wsp
{
  protected wir<String, VideoCollectionItem> a;
  protected yki a;
  protected wir<String, MemoryInfoEntry> b = new wir(300);
  
  public wsu()
  {
    this.jdField_a_of_type_Wir = new wir(300);
    this.jdField_a_of_type_Yki = new yki();
  }
  ...
  public ShareGroupCollectionItem a(String paramString)
  {
    ...
    {
      return localObject;
      localShareGroupCollectionItem = (ShareGroupCollectionItem)this.jdField_a_of_type_Wir.a(paramString);
    ...
    paramString = ((ydc)wth.a(7)).a(localShareGroupCollectionItem.groupId);
    if (paramString == null) {
      return null;
    }
    ...
    if (paramString != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localObject = localwte.a(localStoryVideoListEntry.vid);
    ...
    this.jdField_a_of_type_Wir.a(localShareGroupCollectionItem.key, localShareGroupCollectionItem);
  ...
  public VideoCollectionItem a(@NonNull VideoCollectionItem paramVideoCollectionItem)
  {
    ...
    paramVideoCollectionItem = (VideoCollectionItem)this.jdField_a_of_type_Wir.a(paramVideoCollectionItem.key, paramVideoCollectionItem);
  ...
  public VideoCollectionItem a(String paramString)
  {
    ...
    {
      return localObject1;
      localObject2 = (VideoCollectionItem)this.jdField_a_of_type_Wir.a(paramString);
    ...
    if (localObject2 != null)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        StoryVideoItem localStoryVideoItem = ((wte)localObject1).a(str);
        paramString.videoVidList.add(str);
        paramString.collectionVideoUIItemList.add(new ykj(str, localStoryVideoItem));
      }
    }
    this.jdField_a_of_type_Wir.a(paramString.key, paramString);
    return paramString;
  }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject = wte.a(QQStoryContext.a().a().createEntityManager(), MemoriesYearNodeEntry.class, MemoriesYearNodeEntry.class.getSimpleName(), null, null);
    if (localObject == null) {
      return localArrayList;
    }
  ...
  public List<VideoCollectionItem> a(String paramString, VideoCollectionItem paramVideoCollectionItem, long paramLong)
  {
    ...
    yuk.a("MemoryManager", "query sql = %s , resultCount = %d", str1, Integer.valueOf(paramString.size()));
    paramString = paramString.iterator();
    while (paramString.hasNext())
    {
  ...
  protected void a(List<VideoCollectionItem> paramList, VideoCollectionItem paramVideoCollectionItem)
  {
    if (paramList.indexOf(paramVideoCollectionItem) > 0) {
      yuk.b("MemoryManager", "data already exist, id=%s, time=%d", paramVideoCollectionItem.collectionId, Long.valueOf(paramVideoCollectionItem.collectionTime));
    }
    int i;
    do
    {
      return;
      i = Collections.binarySearch(paramList, paramVideoCollectionItem, this.jdField_a_of_type_Yki);
    } while (i >= 0);
  ...
  public void a(List<VideoCollectionItem> paramList, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localObject = a(wzn.a(paramString));
    }
    finally
    {
    ...
    for (paramString = new MemoryInfoEntry(paramString);; paramString = (String)localObject)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        localObject = (VideoCollectionItem)this.jdField_a_of_type_Wir.a(((VideoCollectionItem)localObject).key, (wiq)localObject);
        ((VideoCollectionItem)localObject).videoItemList = localwte.a(((VideoCollectionItem)localObject).videoItemList);
        ...
        localEntityManager.persistOrReplace(((VideoCollectionItem)this.jdField_a_of_type_Wir.a(((VideoCollectionItem)localObject).key, (wiq)localObject)).convertTo());
      }
  ...
  public void b()
  {
    this.jdField_a_of_type_Wir.a(20);
  }
  ...
  public void b(List<ShareGroupCollectionItem> paramList, String paramString, boolean paramBoolean)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      paramString = (ShareGroupCollectionItem)this.jdField_a_of_type_Wir.a(paramString.key, paramString);
      paramString.shareGroupItem = localydc.a(paramString.shareGroupItem);
      paramString.videoItemList = localwte.a(paramString.videoItemList);
