  ...
  implements Manager
{
  ...
  public bbpz(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        boolean bool = bbdx.a(str, paramString1);
        if (!bool) {
          continue;
        }
        bbkb.c(BaseApplicationImpl.getContext(), paramInt, paramString2);
        return;
      }
      finally {}
    }
