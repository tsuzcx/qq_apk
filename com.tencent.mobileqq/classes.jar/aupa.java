...
public class aupa
{
  public static long a(String paramString)
  {
    ...
    {
      aung.b("compress.Utils", "getFileSize()", "path is empty, or file does not exist. path:" + paramString);
      return 0L;
    }
  ...
  public static Bitmap a(Bitmap paramBitmap)
  {
    ...
    aung.a("compress.Utils", "compositingWhiteBg()", "compositingWhiteBg is success");
    return paramBitmap;
  }
  
  private static aupc a(int paramInt1, int paramInt2, int paramInt3)
  {
    return a(paramInt1, paramInt2, paramInt3, null);
  }
  
  private static aupc a(int paramInt1, int paramInt2, int paramInt3, ThumbWidthHeightDP paramThumbWidthHeightDP)
  {
    int k = 1;
    int m = 0;
    int i;
    ...
    for (;;)
    {
      paramThumbWidthHeightDP = new aupc(null);
      paramThumbWidthHeightDP.a = paramInt2;
      paramThumbWidthHeightDP.b = paramInt1;
      aung.a("compress.Utils", "getType()", " type=" + paramThumbWidthHeightDP);
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (bbdx.a(paramString)))
    {
      String str2 = azac.a(ajsd.aW + "thumb/");
    ...
    aung.a("compress.Utils", "getThumbnailPath()", "realpath is empty, or file does not exist, realpath:" + paramString);
    return "";
  }
  
  public static String a(String paramString, int paramInt)
  {
    if ((!TextUtils.isEmpty(paramString)) && (bbdx.a(paramString)) && (auot.a(paramInt)))
    {
      int i = paramString.lastIndexOf("/");
      int j = paramString.lastIndexOf(".");
      Object localObject;
    ...
    aung.a("compress.Utils", "getSendPhotoPath()", "realpath is empty, or file does not exist, or picQuality Illegal realpath:" + paramString + " picQuality:" + paramInt);
    return "";
  }
  ...
  public static void a(Context paramContext, List<CompressInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        bcql.a(paramContext, (CharSequence)localObject3, 0).b(paramContext.getResources().getDimensionPixelSize(2131298865));
        return;
        n = 0;
        break;
        k = 1;
          ...
          if (((CompressInfo)localObject2).e)
          {
            ...
            if (((CompressInfo)localObject2).jdField_b_of_type_Boolean)
            {
              ...
              if (i == 0)
              {
                ...
                if (m != 0)
                {
                  bcql.a(paramContext, (CharSequence)localObject2, 0).b(paramContext.getResources().getDimensionPixelSize(2131298865));
                  return;
                }
                if (i1 == 0) {
                  break;
                }
                bcql.a(paramContext, (CharSequence)localObject4, 0).b(paramContext.getResources().getDimensionPixelSize(2131298865));
                return;
              }
            }
          }
  ...
  {
    return bbfj.b(BaseApplication.getContext()) == 1;
  }
  ...
  public static boolean a(Bitmap paramBitmap, aupc paramaupc, boolean paramBoolean, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    return a(paramBitmap, paramaupc, paramBoolean, paramString1, paramString2, paramString3, paramString4, paramInt, null);
  }
  
  public static boolean a(Bitmap paramBitmap, aupc paramaupc, boolean paramBoolean, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, ThumbWidthHeightDP paramThumbWidthHeightDP)
  {
    ...
    for (;;)
    {
      ...
      {
        aung.a("compress.Utils", paramString3, paramString4 + " sample after W:" + k + " H:" + j + " isLongImg:" + a(0, 0, paramInt) + " type:" + paramaupc + " needRotate:" + bool2);
        int i3;
        if (i1 > n) {
          i3 = i1;
        }
        ...
        for (i2 = n;; i2 = i1) {
          ...
          default: 
            bool1 = false;
            paramBoolean = false;
            aung.a("compress.Utils", paramString3, paramString4 + " destWidth：" + i1 + " destHeight:" + n + " needCut:" + bool1 + " needScale:" + paramBoolean + " needRotate:" + bool2);
            paramBitmap = a(paramBitmap);
            if (paramInt == 3)
            {
              paramBoolean = a(paramBitmap);
              aung.a("compress.Utils", paramString3, paramString4 + " isDrawGIFSucc：" + paramBoolean);
            }
            ...
            m = apuy.d;
            break label52;
            aung.a("compress.Utils", paramString3, paramString4 + " type.type2:136");
            if (n > i2)
            {
              j = i2;
              label507:
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                catch (OutOfMemoryError paramString1)
                {
                  ...
                  aung.b("compress.Utils", paramString3, paramString4 + " cut 3:1 createBitmap OutOfMemoryError, type:" + paramaupc);
                  return false;
                }
              }
              j = n;
          ...
          for (;;)
          {
            ...
            catch (OutOfMemoryError paramString1)
            {
              ...
              catch (OutOfMemoryError paramBitmap)
              {
                ...
                paramBitmap.printStackTrace();
                aung.b("compress.Utils", paramString3, paramString4 + " case 1: cut createBitmap OutOfMemoryError, type:" + paramaupc);
                return false;
              }
              paramString1 = paramString1;
              paramBitmap.recycle();
              paramString1.printStackTrace();
              aung.b("compress.Utils", paramString3, paramString4 + " case 1: scale or rotate createBitmap OutOfMemoryError, type:" + paramaupc);
              return false;
            }
            j = i;
            i = m;
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                catch (OutOfMemoryError paramString1)
                {
                  paramBitmap.recycle();
                  paramString1.printStackTrace();
                  aung.b("compress.Utils", paramString3, paramString4 + " case 2: scale or rotate createBitmap OutOfMemoryError, type:" + paramaupc);
                  return false;
                }
              }
              n = i;
            ...
            catch (OutOfMemoryError paramString1)
            {
              paramBitmap.recycle();
              paramString1.printStackTrace();
              aung.b("compress.Utils", paramString3, paramString4 + " case 3: rotate createBitmap OutOfMemoryError, type:" + paramaupc);
              return false;
            }
          }
          if (bool2)
          ...
          for (;;)
          {
            ...
            catch (OutOfMemoryError paramString1)
            {
              ...
              catch (OutOfMemoryError paramString1)
              {
                ...
                paramBitmap.recycle();
                paramString1.printStackTrace();
                aung.b("compress.Utils", paramString3, paramString4 + " case 4: cut createBitmap OutOfMemoryError, type:" + paramaupc);
                return false;
              }
              paramString1 = paramString1;
              paramBitmap.recycle();
              paramString1.printStackTrace();
              aung.b("compress.Utils", paramString3, paramString4 + " case 4: rotate createBitmap OutOfMemoryError, type:" + paramaupc);
              return false;
            }
            i = i2 * 3;
            continue;
  ...
  private static boolean a(BitmapFactory.Options paramOptions, int paramInt)
  {
    ...
    {
      aung.b("compress.Utils", "calculateInSampleSizeThumbnail()", "options is null");
      return false;
    }
    ...
    if ((m == 0) || (n == 0))
    {
      aung.b("compress.Utils", "calculateInSampleSizeThumbnail()", "width == 0 || height ==0");
      return false;
    }
    int j = n;
    int k = m;
    ...
    for (paramInt = paramOptions.inSampleSize;; paramInt = 1)
    {
      ...
      aung.a("compress.Utils", "calculateInSampleSizeThumbnail()", "options.inSampleSize=" + paramOptions.inSampleSize + " srcWidth:" + m + " srcHeight:" + n);
      return true;
      i *= 2;
      break;
    }
  ...
  public static boolean a(BitmapFactory.Options paramOptions, String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      aung.b("compress.Utils", "calculateInSampleSize()", "options == null || TextUtils.isEmpty(filepath)");
      return false;
    }
    ...
    bbef.a(paramString, paramOptions);
    ...
    for (paramInt1 = paramOptions.inSampleSize;; paramInt1 = 1)
    {
      ...
      aung.a("compress.Utils", "calculateInSampleSize()", "options.inSampleSize=" + paramOptions.inSampleSize);
      return true;
      break;
    }
  }
  ...
  private static boolean a(JpegOptions paramJpegOptions, int paramInt)
  {
    ...
    for (paramInt = paramJpegOptions.inSampleSize;; paramInt = 1)
    {
      ...
      aung.a("compress.Utils", "calculateInSampleSizeThumbnail()", "options.inSampleSize=" + paramJpegOptions.inSampleSize + " srcWidth:" + m + " srcHeight:" + n);
      return true;
      i *= 2;
      break;
    }
  ...
  public static boolean a(String paramString1, String paramString2, boolean paramBoolean, String paramString3, int paramInt, ThumbWidthHeightDP paramThumbWidthHeightDP)
  {
    ...
    {
      aung.b("compress.Utils", "compressAIOThumbnail", paramString3 + " infilePath is empty, or outfilePath is empty, or file does not exist. infilePath:" + paramString1 + " outfilePath:" + paramString2);
      return false;
    }
    aung.a("compress.Utils", "compressAIOThumbnail", paramString3);
    BitmapFactory.Options localOptions = new BitmapFactory.Options();
    localOptions.inJustDecodeBounds = true;
    bbef.a(paramString1, localOptions);
    int j;
    int i;
    aupc localaupc;
    if (localOptions.outWidth > localOptions.outHeight)
    {
      ...
      localaupc = a(i, j, paramInt, paramThumbWidthHeightDP);
      if (paramThumbWidthHeightDP == null) {
        break label232;
      }
      i = paramThumbWidthHeightDP.maxPx();
    ...
    for (;;)
    {
      ...
      aung.b("compress.Utils", "compressAIOThumbnail", paramString3 + " calculateInSampleSize fail");
      return false;
    ...
    try
    {
      ...
      {
        aung.b("compress.Utils", "compressAIOThumbnail", paramString3 + " bm == null, maybe is broken");
        return false;
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      localOutOfMemoryError.printStackTrace();
      aung.b("compress.Utils", "compressAIOThumbnail", paramString3 + " decodeFile OutOfMemoryError");
      localOptions.inSampleSize *= 2;
      try
      {
        Bitmap localBitmap2 = bbef.a(paramString1, localOptions);
        i = localBitmap2.getWidth();
        j = localBitmap2.getHeight();
        aung.a("compress.Utils", "compressAIOThumbnail", paramString3 + " sample after W:" + i + " H:" + j);
        return a(localBitmap2, localaupc, paramBoolean, paramString1, paramString2, "compressAIOThumbnail", paramString3, paramInt, paramThumbWidthHeightDP);
      }
      catch (OutOfMemoryError paramString1)
      {
        paramString1.printStackTrace();
        aung.b("compress.Utils", "compressAIOThumbnail", paramString3 + " decodeFile OutOfMemoryError, op.inSampleSize:" + localOptions.inSampleSize);
      }
    }
    return false;
  }
  ...
  public static boolean b(String paramString)
  {
    ...
    {
      bool1 = bool3;
      if (!bbdx.b(paramString).equals("jpg")) {}
    }
    try
    {
      float f = JpegCompressor.getJpegQuality(paramString);
      long l = bbdx.a(paramString);
      bool1 = bool2;
      if (f <= 80.0F)
      {
        bool1 = bool2;
      ...
      aung.a("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality = " + f + ",picSize = " + l + "result = " + bool1);
      return bool1;
    }
    catch (RuntimeException paramString)
    {
      aung.b("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality RuntimeException error = " + paramString + ",return false!");
      return false;
    }
    catch (OutOfMemoryError paramString)
    {
      aung.b("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality OutOfMemoryError error = " + paramString + ",return false!");
    }
    return false;
  }
  ...
  private static boolean b(String paramString1, Bitmap paramBitmap, int paramInt, String paramString2, CompressInfo paramCompressInfo)
  {
    ...
    {
      aung.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " TextUtils.isEmpty(destPath) || bm == null || quality > 100 || quality <= 0");
      return false;
    }
    aung.a("compress.Utils", "compressQualityWithProgressive()", paramString2 + " quality:" + paramInt);
    ...
    try
    {
      ...
      localObject = new JpegCompressor(new aupb((File)localObject, paramCompressInfo));
      ((JpegCompressor)localObject).setParams(paramInt, true, true, false);
      try
      {
        bbfb.a();
        ((JpegCompressor)localObject).compress(paramBitmap);
        bbfb.a("peak_pgjpeg", "pgjpeg " + paramBitmap.getWidth() + "x" + paramBitmap.getHeight() + " compress");
        aung.a("compress.Utils", "compressQualityWithProgressive()", paramString2 + " quality:" + paramInt);
        return true;
      }
    ...
    {
      aung.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " FileOutputStream FileNotFoundException");
      paramString1.printStackTrace();
      return false;
    }
    catch (IOException paramString1)
    {
      aung.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " createNewFile IOException");
      paramString1.printStackTrace();
    }
  }
  ...
  public static boolean b(String paramString1, String paramString2, boolean paramBoolean, String paramString3, int paramInt)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (!bbdx.b(paramString1)))
    {
      aung.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " infilePath is empty, or outfilePath is empty, or file does not exist. infilePath:" + paramString1 + " outfilePath:" + paramString2);
      return false;
    }
    aung.a("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3);
    ...
    for (;;)
    {
      ...
      aung.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " calculateInSampleSize fail");
      return false;
    ...
    try
    {
      ...
      if (localBitmap3 == null)
      {
        aung.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " bm == null, maybe is broken");
        return false;
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      localOutOfMemoryError.printStackTrace();
      aung.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " decodeFile OutOfMemoryError");
      ...
      try
      {
        ...
        i = localBitmap2.getWidth();
        j = localBitmap2.getHeight();
        aung.a("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " sample after W:" + i + " H:" + j);
        return a(localBitmap2, localaupc, paramBoolean, paramString1, paramString2, "compressAIOThumbnailWithTrubo", paramString3, paramInt);
      }
      catch (OutOfMemoryError paramString1)
      {
        paramString1.printStackTrace();
        aung.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " decodeFile OutOfMemoryError, op.inSampleSize:" + localJpegOptions.inSampleSize);
      }
    }
    return false;
  }
  ...
  private static boolean c(String paramString1, Bitmap paramBitmap, int paramInt, String paramString2, CompressInfo paramCompressInfo)
  {
    ...
    //   49: invokestatic 43	aung:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   52: iconst_0
    //   53: istore 5
    //   55: iload 5
    //   57: ireturn
    ...
    //   87: invokestatic 115	aung:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   113: pop
    //   114: aload_0
    //   115: invokestatic 684	bbdx:a	(Ljava/lang/String;)Ljava/io/File;
    //   118: pop
    ...
    //   208: aload_0
    //   209: invokestatic 18	bbdx:b	(Ljava/lang/String;)Z
    //   212: ifne -157 -> 55
    //   215: ldc 20
    //   217: ldc_w 681
    ...
    //   240: invokestatic 43	aung:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   243: iconst_0
    //   244: ireturn
    //   245: astore_1
    //   246: aload 4
    ...
    //   267: ldc_w 681
    //   270: ldc_w 728
    //   273: invokestatic 43	aung:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   276: goto -78 -> 198
    //   279: astore_0
    //   280: aload 7
    //   282: astore 6
    ...
    //   309: invokestatic 43	aung:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   312: aload 7
    //   314: astore 6
    //   316: aload_0
    ...
    //   354: ldc_w 681
    //   357: ldc_w 730
    //   360: invokestatic 43	aung:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   363: goto -165 -> 198
    //   366: astore_0
    //   367: aload 7
    //   369: astore 6
    ...
    //   396: invokestatic 43	aung:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   399: aload 7
    //   401: astore 6
    //   403: aload_0
