...
public class awut
{
  private static volatile awut jdField_a_of_type_Awut;
  ...
  public static awut a()
  {
    if (jdField_a_of_type_Awut == null) {}
    try
    {
      if (jdField_a_of_type_Awut == null) {
        jdField_a_of_type_Awut = new awut();
      }
      return jdField_a_of_type_Awut;
    }
    finally {}
  }
  ...
  private void a(long paramLong1, long paramLong2, submsgtype0x122.MsgBody paramMsgBody)
  {
    ...
    try
    {
      paramMsgBody = aslq.a(new String(paramMsgBody, "utf-8"));
      if (paramMsgBody != null)
      {
        localObject7 = paramMsgBody.a();
        if (((asli)localObject7).a() != 6) {
          QLog.e("PushDialogHandler", 1, new Object[] { "error note type:", Integer.valueOf(((asli)localObject7).a()) });
        }
      }
      else
      {
    ...
    catch (UnsupportedEncodingException paramMsgBody)
    {
      do
      {
        ...
        localObject2 = "";
        localObject4 = "";
        localObject7 = ((asli)localObject7).a();
    ...
    for (;;)
    {
      ...
      {
        localObject8 = (asli)localIterator1.next();
        localObject9 = ((asli)localObject8).a();
        localObject7 = ((asli)localObject8).a();
        if (((asli)localObject8).a() == 7)
        {
        ...
        else if (((asli)localObject8).a() == 8)
        {
          ...
          {
            localObject7 = (asli)((Iterator)localObject9).next();
            localObject10 = ((asli)localObject7).a();
            if ((((asli)localObject7).a() == 2) && (localObject10 != null))
            {
    ...
    for (;;)
    {
      ...
      break;
      if ((((asli)localObject8).a() == 9) && (localObject7 != null))
      {
        ...
        {
          localObject7 = (asli)localIterator2.next();
          String str2;
          Object localObject11;
          if (((asli)localObject7).a() == 10)
          {
            localObject7 = ((asli)localObject7).a();
          ...
          for (;;)
          {
            ...
            adky.a((Intent)localObject7, PublicTransFragmentActivity.class, RiskHintDlgFragment.class);
            return;
          }
        }
        localObject7 = localObject2;
  ...
  public void a(submsgtype0x122.MsgBody paramMsgBody, MsgInfo paramMsgInfo, QQAppInterface paramQQAppInterface)
  {
    ...
    awur.a().b(this.jdField_a_of_type_Awbw, paramMsgBody);
  }
