...
public class aqmx
{
  private static final aqmx jdField_a_of_type_Aqmx = new aqmx();
  private static String jdField_a_of_type_JavaLangString = aqmx.class.getSimpleName();
