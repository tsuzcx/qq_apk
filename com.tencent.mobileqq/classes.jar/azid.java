...
public class azid
{
  public static azie a;
  public static final String a;
  public static HashMap<String, azie> a;
  ...
  public static HashMap<String, azie> a(String paramString, SharedPreferences paramSharedPreferences, Set<String> paramSet)
  {
    ...
    try
    {
      ...
      while (paramSet.hasNext())
      {
        ...
        localazif.h(paramString).b(str1).c(str2).d(str3).c(i).e(str4).e(k).g(str6).f(str5).d(j).b(bool1).a(bool2).b(m).i(str7).j(str8).a(n).a(str9);
        QLog.i("QSplash@QbossSplashUtil", 1, "buildADEntryFromSP  adid =" + str1);
        jdField_a_of_type_JavaUtilHashMap.put(str1, localazif.a());
      }
      return jdField_a_of_type_JavaUtilHashMap;
    }
    catch (Exception paramString)
  ...
  public static boolean a(long paramLong)
  {
    ...
    //   9: lload_0
    //   10: invokestatic 481	azid:a	(Landroid/content/Context;J)Ljava/util/List;
    //   13: astore 7
    //   15: iload 4
    //   17: istore_3
    //   18: aload 7
    ...
    //   90: invokestatic 176	azid:a	(Landroid/content/Context;Ljava/lang/String;)Landroid/content/SharedPreferences;
    //   93: astore 9
    ...
    //   117: invokestatic 489	bkzh:a	(Landroid/content/Context;Ljava/lang/String;)Landroid/content/SharedPreferences;
    //   120: astore 6
    ...
    //   144: invokestatic 491	azid:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/Set;
    //   147: astore 10
    ...
    //   171: invokestatic 492	bkzh:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/Set;
    //   174: astore 8
    ...
    //   195: aload 9
    //   197: aload 10
    //   199: invokestatic 494	azid:a	(Ljava/lang/String;Landroid/content/SharedPreferences;Ljava/util/Set;)Ljava/util/HashMap;
    //   202: astore 9
    //   204: aload 9
    ...
    //   225: aload 6
    //   227: aload 8
    //   229: invokestatic 494	azid:a	(Ljava/lang/String;Landroid/content/SharedPreferences;Ljava/util/Set;)Ljava/util/HashMap;
    ...
    //   307: aload 8
    //   309: invokevirtual 510	azie:toString	()Ljava/lang/String;
    ...
    //   321: aload 8
    //   323: invokevirtual 512	azie:a	()Z
    //   326: ifeq +95 -> 421
    //   329: aload 6
    ...
    //   343: astore 7
    //   345: aload 8
    //   347: getfield 515	azie:d	I
    //   350: aload 6
    //   352: getfield 515	azie:d	I
    //   355: if_icmpgt +59 -> 414
    //   358: goto +63 -> 421
    //   361: aload 6
    //   363: putstatic 517	azid:jdField_a_of_type_Azie	Lazie;
    //   366: iconst_1
    //   367: istore_3
    //   368: iload_3
    //   369: ireturn
