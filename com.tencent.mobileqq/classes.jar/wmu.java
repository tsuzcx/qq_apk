...
public class wmu
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfJavaLangString = ume.a(2130968661);
  }
  ...
  public wmu()
  {
    ...
    this.jdField_a_of_type_Usu = new usu();
  ...
  public String a(int paramInt, TextPaint paramTextPaint)
  {
    ...
    do
    {
      ...
      do
      {
        return str;
        if (j == 0) {
          return ume.a(2131700068);
        }
        localStringBuilder.append(xod.a(j)).append("个小视频");
        if (j > 0) {
        ...
        localStringBuilder.append(ume.a(2131700082, new Object[] { Integer.valueOf(this.g) }));
        return localStringBuilder.toString();
        if (this.jdField_a_of_type_Boolean)
        {
          localStringBuilder.append(xod.a(j)).append("个小视频");
          ...
          if (this.jdField_d_of_type_Int > 0) {
            localStringBuilder.append(jdField_a_of_type_ArrayOfJavaLangString[1]).append("赞").append(xod.a(this.jdField_d_of_type_Int));
          }
          if (this.e <= 0) {
            break;
          }
          localStringBuilder.append(jdField_a_of_type_ArrayOfJavaLangString[1]).append("评论").append(xod.a(this.e));
          break;
        }
        localStringBuilder.append(xod.a(this.f)).append("个小视频发送失败");
        break;
        long l1 = l2;
        int k = i1;
        i = n;
        if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)
        {
          ...
          i = n;
          j = m;
          if (this.jdField_a_of_type_Usu != null)
          {
            i = this.jdField_a_of_type_Usu.b;
            k = this.jdField_a_of_type_Usu.jdField_a_of_type_Int;
            l1 = this.jdField_a_of_type_Usu.c;
            j = m;
          }
        }
        localStringBuilder.append(xod.a(j)).append("个小视频");
        ...
        str = localStringBuilder.toString();
        if (k > 0) {
          localStringBuilder.append(jdField_a_of_type_ArrayOfJavaLangString[1]).append("赞").append(xod.a(k));
        }
      } while ((paramTextPaint != null) && (paramTextPaint.measureText(localStringBuilder.toString()) > paramInt));
      str = localStringBuilder.toString();
      if (i > 0) {
        localStringBuilder.append(jdField_a_of_type_ArrayOfJavaLangString[1]).append("评论").append(xod.a(i));
      }
    } while ((paramTextPaint == null) || (paramTextPaint.measureText(localStringBuilder.toString()) <= paramInt));
    return str;
  }
  ...
  public void a()
  {
    ...
    do
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        int i = wnc.a(localStoryVideoItem.mUploadStatus);
        if ((i == 1) || (i == 0))
        {
  ...
  public void c(StoryVideoItem paramStoryVideoItem)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          if ((this.jdField_a_of_type_JavaUtilArrayList.size() != 0) || (this.jdField_a_of_type_Usu == null)) {
            break;
          }
          this.jdField_a_of_type_Usu.b = 0;
          this.jdField_a_of_type_Usu.jdField_a_of_type_Int = 0;
          this.jdField_a_of_type_Usu.c = 0;
          paramStoryVideoItem = (urk)urr.a(10);
