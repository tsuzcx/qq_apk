  ...
  implements ahrh
{
  ...
  awvo jdField_a_of_type_Awvo = new bixd(this);
  ...
  public bixb(Context paramContext)
  {
    this.jdField_a_of_type_JavaLangRunnable = new TVKVideoController.4(this);
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    this.jdField_a_of_type_Bixe = new bixe(this, null);
    this.jdField_a_of_type_Akjs = new akjs();
  }
  
  private void a(int paramInt)
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Akjs != null))
    {
      this.jdField_a_of_type_Akjs.a(paramInt);
      this.jdField_a_of_type_Bixe.postDelayed(this.jdField_a_of_type_JavaLangRunnable, 100L);
    }
  }
  ...
  private void c()
  {
    ...
    {
      this.jdField_a_of_type_Akjs.a(this.jdField_a_of_type_Aklw.a(), str1, this.jdField_a_of_type_Aklw.jdField_a_of_type_ArrayOfJavaLangString, 0L, str2, (Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
      return;
  ...
  private void d()
  {
    int i = awvk.a().a(1, this.jdField_a_of_type_Awvo);
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Akjs != null) && (i == 0))
    {
  ...
  private void e()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Akjs != null) && (!this.jdField_b_of_type_Boolean))
    {
      this.jdField_a_of_type_Akjs.b();
      this.jdField_a_of_type_Int = 4;
      this.jdField_a_of_type_Bixe.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    }
  }
  ...
  private void g()
  {
    ...
    do
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.d("TVKVideoController", 2, new Object[] { "clickPlay curState:", Integer.valueOf(this.jdField_a_of_type_Int), " ,isCompleted:", Boolean.valueOf(this.jdField_b_of_type_Boolean), " ,path:", this.jdField_a_of_type_Aklw.jdField_a_of_type_JavaLangString });
      }
  ...
  public void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenListenerIVideoOuterStatusListener = FloatingScreenManager.getInstance().setFloatingVideoListener(new bixc(this));
  }
  ...
  public void a(aklw paramaklw, long paramLong1, long paramLong2)
  {
    if (QLog.isColorLevel()) {
      QLog.d("TVKVideoController", 2, new Object[] { "initTVKVideoController with mediaInfo :", paramaklw.jdField_a_of_type_JavaLangString });
    }
    this.jdField_a_of_type_Long = paramLong1;
    this.jdField_a_of_type_Aklw = paramaklw;
    this.jdField_a_of_type_Aklw.e = paramLong2;
    if (this.jdField_a_of_type_Akjs != null)
    {
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Akjs.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_a_of_type_Bixe, this.jdField_a_of_type_Aklw, null);
      if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_AndroidViewView != null))
      {
        this.jdField_a_of_type_Akjs.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (IVideoViewBase)this.jdField_a_of_type_AndroidViewView);
    ...
    if (FileUtils.fileExistsAndNotEmpty(paramString))
    {
      ...
      if (paramString != null)
      {
        ...
        if (!TextUtils.isEmpty(paramString)) {
          localObject = new asbg(Color.rgb(214, 214, 214), paramInt1, paramInt2);
        }
      }
    }
    try
  ...
  public void a(String paramString, long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_Long = paramLong1;
    this.jdField_a_of_type_Aklw = new aklw();
    this.jdField_a_of_type_Aklw.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Aklw.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Aklw.b = l;
    this.jdField_a_of_type_Aklw.d = l;
    this.jdField_a_of_type_Aklw.e = paramLong2;
    if (this.jdField_a_of_type_Akjs != null)
    {
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Akjs.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_a_of_type_Bixe, this.jdField_a_of_type_Aklw, null);
  ...
  public boolean a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        if (FloatingScreenManager.getInstance().enterFloatingScreen(BaseApplicationImpl.getContext(), this.jdField_a_of_type_AndroidViewView, localFloatingScreenParams, biwm.a(paramInt1)) != 1) {
          break label192;
        }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Bixe != null)
    {
      this.jdField_a_of_type_Bixe.removeCallbacksAndMessages(null);
      this.jdField_a_of_type_Bixe = null;
    }
    awvk.a().a(this.jdField_a_of_type_Awvo);
    ahrf.a().b(this);
  }
