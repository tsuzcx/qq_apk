  ...
  implements akig
{
  ...
  private acuj(BaseBubbleBuilder paramBaseBubbleBuilder) {}
  
  public void a(TroopMemberInfo paramTroopMemberInfo)
  {
    Object localObject1 = (acun)this.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTag();
    Object localObject4;
    Object localObject2;
    azre localazre;
    Object localObject3;
    ...
    boolean bool2;
    boolean bool1;
    if ((paramTroopMemberInfo != null) && (TextUtils.equals(((acun)localObject1).a.senderuin, paramTroopMemberInfo.memberuin)))
    {
      localObject4 = null;
      localObject2 = null;
      localazre = null;
      ...
      i = 1;
      label146:
      localObject2 = azrd.a().a(paramTroopMemberInfo, this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo);
      if ((localObject2 == null) || ((i == 0) && (!bool1))) {
        break label626;
      }
      localObject1 = ((azre)localObject2).a;
      i = ((azre)localObject2).b;
      label186:
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqDataTroopInfo != null) {
        ...
        else
        {
          ...
          if (j == 0)
          {
            ...
            localObject2 = ajyc.a(2131720560);
          }
        }
      }
      label297:
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.c.setTag(Integer.valueOf(2131364148));
      }
      return;
      label367:
      i = 0;
      ...
      if (i != 0)
      {
        ...
        {
          bool1 = true;
          localazre = azrd.a().a(bool3, bool1);
          if (localazre == null) {
            break label617;
          }
          localObject1 = localazre.a;
          i = localazre.b;
        }
      }
      for (;;)
      {
        ...
        if (j != 0)
        {
          localObject2 = azrd.a().a(paramTroopMemberInfo.level, false, false, false);
          if ((localObject2 == null) || (!bahk.a(paramTroopMemberInfo))) {
            break label608;
          }
          localObject1 = ((azre)localObject2).a;
          i = ((azre)localObject2).b;
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            if (this.jdField_a_of_type_Boolean)
            {
              ...
              localObject2 = ajyc.a(2131720557);
              break label297;
            }
            break;
            i = 0;
