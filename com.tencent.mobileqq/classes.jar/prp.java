...
public class prp
{
  ...
  public static List<prp> a(oidb_cmd0xbc9.DynamicBannerItem paramDynamicBannerItem)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          prp localprp = new prp();
          localprp.a = localJSONArray.get(i).toString();
          localArrayList.add(localprp);
          i += 1;
        }
        return localArrayList;
      }
      catch (Exception localException)
      {
        ...
        localObject = new prp();
        ((prp)localObject).a = paramDynamicBannerItem.bytes_dynamic_json.get().toStringUtf8();
