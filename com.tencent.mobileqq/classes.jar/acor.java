...
public class acor
  implements bjoe
{
  public acor(AddAccountActivity paramAddAccountActivity) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      bcef.a(this.a.app, "dc00898", "", "", "0X8007353", "0X8007353", 0, 0, "", "", "", "");
      bcef.a(this.a.app, "dc00898", "", "", "0X800B28F", "0X800B28F", 0, 0, "", "", "", "");
      paramView = null;
      if (this.a.a != null) {
    ...
    for (paramView = String.format(Locale.getDefault(), "%s&account=%s", new Object[] { "https://ti.qq.com/safe/forgetpw?source_id=2756", paramView });; paramView = "https://ti.qq.com/safe/forgetpw?source_id=2756")
    {
      ...
      for (;;)
      {
        ...
        if (paramInt == 1)
        {
          bcef.a(this.a.app, "dc00898", "", "", "0X800AFD8", "0X800AFD8", 0, 0, "", "", "", "");
          bcef.b(this.a.app, "CliOper", "", "", "Mobile_signup", "Clk_ems_login", 0, 0, "", "", "", "");
