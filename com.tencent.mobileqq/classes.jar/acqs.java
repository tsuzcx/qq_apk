...
{
  public acqs(EditActivity paramEditActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.a.jdField_a_of_type_Int == 105)
    {
      ...
      do
      {
        QQToast.a(this.a, this.a.getString(2131692108), 0).a();
        return;
        Object localObject;
        while (!((Iterator)localObject).hasNext())
        {
          do
          {
            ...
            localObject = (apke)this.a.app.getManager(149);
            localapkf = (apkf)this.a.app.getManager(103);
      ...
      localapkf.a(localCustomEmotionData, paramView);
      return;
    }
