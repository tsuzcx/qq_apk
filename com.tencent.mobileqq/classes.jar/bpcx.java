  ...
  extends bpcq
{
  ...
  public bpcx(Context paramContext, String paramString)
  {
  ...
  private bpcw a(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, Typeface paramTypeface, bpcg parambpcg, int paramInt7)
  {
    paramTypeface = new bpcw(paramInt1, paramInt2, paramTypeface, paramInt3, paramInt4, paramInt5, paramInt6);
    paramTypeface.a(paramCharSequence, parambpcg, paramInt7);
    ...
    catch (Exception localException1)
    {
      try
      {
        for (;;)
        {
          ...
          this.jdField_a_of_type_Bpcw = a(this.jdField_b_of_type_JavaLangString, AIOUtils.dp2px(48.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), -1, 0, 0, 0, 600, localTypeface1, this.jdField_a_of_type_Bpcg, 0);
          this.jdField_a_of_type_Int = this.jdField_a_of_type_Bpcg.a("", 300L, 500L, 0, this.jdField_a_of_type_Bpcw.e, new LinearInterpolator());
          this.jdField_b_of_type_Bpcw = a(this.c, AIOUtils.dp2px(11.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), -1, 0, AIOUtils.dp2px(60.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 500, 800, (Typeface)localObject, this.jdField_a_of_type_Bpcg, this.jdField_a_of_type_Bpcw.e - 10);
          return;
  ...
  {
    return this.jdField_a_of_type_Bpcw.e;
  }
}
