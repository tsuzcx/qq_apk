...
public class bafa
{
  ...
  public bafa(WeakReference<bafb> paramWeakReference)
  {
  ...
  public static void a(String paramString, int paramInt)
  {
    ...
    xvv.e("EglHelper", "throwEglException tid=" + Thread.currentThread().getId() + " " + paramString);
    throw new RuntimeException(paramString);
  }
  
  public static void a(String paramString1, String paramString2, int paramInt)
  {
    xvv.d(paramString1, a(paramString2, paramInt));
  }
  ...
  public void a()
  {
    ...
    localObject = (bafb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (localObject == null)
    {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGL10.eglGetError() == 12294)
      {
        ...
        this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLConfig = ((bafb)localObject).a().chooseConfig(this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGL10, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLDisplay);
        xvv.a("FlowEdit_FlowDecodeScreenSurfaceBase", "chooseConfig %s", this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLConfig);
        try
        {
          this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLContext = ((bafb)localObject).a().createContext(this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGL10, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLDisplay, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLConfig);
          xvv.a("FlowEdit_FlowDecodeScreenSurfaceBase", "createContext %s", this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLContext);
        }
        catch (IllegalArgumentException localIllegalArgumentException)
        {
          xvv.d("FlowEdit_FlowDecodeScreenSurfaceBase", localIllegalArgumentException, "createContext", new Object[0]);
    ...
    a("createContext");
    label289:
    xvv.d("EglHelper", "createContext " + this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLContext + " tid=" + Thread.currentThread().getId());
  ...
  public void c()
  {
    ...
    {
      bafb localbafb = (bafb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localbafb != null) {
        localbafb.a().destroyContext(this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGL10, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLDisplay, this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLContext);
      }
      this.jdField_a_of_type_JavaxMicroeditionKhronosEglEGLContext = null;
    }
