...
public class avto
{
  private static avto jdField_a_of_type_Avto;
  private String jdField_a_of_type_JavaLangString;
  private Map<Integer, ahwx> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private Map<Integer, ahwx> e = new HashMap();
  private Map<Integer, Integer> f = new HashMap();
  
  private avto()
  {
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(1), new ahwx(960, 720));
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(2), new ahwx(960, 720));
  ...
  public static avto a()
  {
    if (jdField_a_of_type_Avto == null) {}
    try
    {
      if (jdField_a_of_type_Avto == null) {
        jdField_a_of_type_Avto = new avto();
      }
      return jdField_a_of_type_Avto;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    for (;;)
    {
      ...
      for (j = arrayOfString2.length - 1;; j = 0)
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(2), new ahwx(arrayOfInt3[i], arrayOfInt2[i]));
          this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(1), new ahwx(arrayOfInt3[i], arrayOfInt2[i]));
          this.e.put(Integer.valueOf(2), new ahwx(arrayOfInt3[j], arrayOfInt2[j]));
          this.e.put(Integer.valueOf(1), new ahwx(arrayOfInt3[j], arrayOfInt2[j]));
        }
        if (localObject != null)
        {
  ...
  public ahwx a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramInt))) {
      return (ahwx)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    }
    return new ahwx(960, 720);
  }
  
  public ahwx b(int paramInt)
  {
    if (this.e.containsKey(Integer.valueOf(paramInt))) {
      return (ahwx)this.e.get(Integer.valueOf(paramInt));
    }
    return new ahwx(640, 480);
  }
}
