  ...
  implements BadcaseReportUtils.ReportItemData
{
  ...
  {
    if (paramBoolean) {}
    for (BadcaseReportUtils.ENABLE_REPORT = axkt.h();; BadcaseReportUtils.ENABLE_REPORT = false)
    {
      BadcaseReportUtils.sTotalReportNumber = axkt.c();
      if (QLog.isColorLevel()) {
  ...
  {
    Object localObject = new StringBuilder(ahvy.a);
