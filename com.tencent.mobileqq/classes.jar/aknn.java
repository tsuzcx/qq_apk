...
public class aknn
  implements akns, Handler.Callback
{
  private static int jdField_a_of_type_Int;
  private acyn jdField_a_of_type_Acyn;
  private aknu jdField_a_of_type_Aknu;
  private Animator.AnimatorListener jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new aknp(this);
  private ValueAnimator.AnimatorUpdateListener jdField_a_of_type_AndroidAnimationValueAnimator$AnimatorUpdateListener = new akno(this);
  ...
  public aknn(BaseChatPie paramBaseChatPie, Context paramContext, String paramString)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie = paramBaseChatPie;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Aknu = ((aknu)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285));
    this.jdField_a_of_type_Bfnk = new bfnk(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().getLooper(), this);
    jdField_a_of_type_Int = actj.a(150.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_a_of_type_Acyn = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acyn;
  }
  
  private void a(int paramInt, String paramString)
  {
    ThreadManager.getSubThreadHandler().postDelayed(new AIOIceBreakShow.1(this, paramInt, paramString), this.jdField_a_of_type_Aknu.jdField_a_of_type_Int * 1000L);
  }
  ...
  private boolean a()
  {
    ...
    for (Object localObject = (ViewGroup)localObject;; localObject = null) {
      return ((ViewGroup)localObject).getId() == 2131362313;
    }
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131362260, Integer.valueOf(this.c));
    ...
    ajey.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "ice_break", true);
    c();
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Acyn.a(3, 0);
      this.jdField_a_of_type_Acyn.a(0, false, "icebreak_showFooter", 0);
      ...
      if (QLog.isColorLevel()) {
        QLog.d("AIOIceBreakShow", 2, "real show duration = " + this.jdField_a_of_type_Aknu.jdField_a_of_type_Int);
      }
    ...
    for (;;)
    {
      axqy.b((QQAppInterface)localObject, "dc00898", "", "", "0X8009B95", "0X8009B95", i, 0, "", "", "", "");
      return;
      this.jdField_a_of_type_Acyn.a(3, jdField_a_of_type_Int);
      this.jdField_a_of_type_Acyn.a(jdField_a_of_type_Int, false, "icebreak_showFooter", 0);
      break;
      label606:
      i = 2;
    }
  ...
  private void c()
  {
    ...
    if (localObject1 != null)
    {
      ...
      if (((View)localObject1).getId() == 2131362313) {
    ...
    for (;;)
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acyn;
      if (this.jdField_a_of_type_AndroidWidgetLinearLayout.getParent() != null)
      {
        if (!(a() ^ i))
        {
      ...
      if (i != 0)
      {
        ((acyn)localObject1).a(this.jdField_a_of_type_AndroidWidgetLinearLayout, (FrameLayout.LayoutParams)localObject2);
  ...
  private void d()
  {
    ...
    ajey.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "ice_break", false);
  }
  ...
  {
    if (aknx.d(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int))
    {
      if (QLog.isColorLevel()) {
        QLog.i("IceBreak.IceBreakingUtil", 2, "onImageClick remove matchChat Ice show");
      }
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aeqs)) {
        ((aeqs)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).bp();
      }
  ...
  {
    int i = this.jdField_a_of_type_Aknu.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
    if (QLog.isColorLevel()) {
    ...
    if (i != -1)
    {
      ...
      paramList = this.jdField_a_of_type_Bfnk.obtainMessage(0, 1, 0);
      this.jdField_a_of_type_Bfnk.sendMessage(paramList);
      return;
    }
    this.c = i;
    this.jdField_a_of_type_JavaUtilList = paramList;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean ^ paramBoolean))
    {
      ...
      if ((this.jdField_b_of_type_Int == 0) && (!this.jdField_b_of_type_Boolean))
      {
        ...
        localMessage = this.jdField_a_of_type_Bfnk.obtainMessage(1, 0, 0);
    ...
    this.jdField_a_of_type_Bfnk.removeMessages(0);
    this.jdField_a_of_type_Bfnk.removeMessages(1);
    Message localMessage = this.jdField_a_of_type_Bfnk.obtainMessage(0, 0, 0);
    this.jdField_a_of_type_Bfnk.sendMessage(localMessage);
  }
