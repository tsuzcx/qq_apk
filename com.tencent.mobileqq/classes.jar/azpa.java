  ...
  extends Observable
{
  ...
  public azpa(QQAppInterface paramQQAppInterface, Long paramLong)
  {
    this.jdField_a_of_type_JavaUtilList = Collections.synchronizedList(new ArrayList());
    this.jdField_a_of_type_AndroidOsHandler = new azpb(this, Looper.getMainLooper());
    this.jdField_a_of_type_Baho = new azpc(this);
    this.jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaLangLong = paramLong;
  }
  
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, int paramInt, baho parambaho)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject2).put("muid", MD5.toMD5(bbct.a()));
      ((JSONObject)localObject2).put("carrier", bbct.e());
      ((JSONObject)localObject2).put("conn", nam.a());
      ...
      if (paramQQAppInterface != null)
      {
        ...
        new bahn(paramQQAppInterface, "GET", parambaho, paramInt, null, true).execute(new HashMap[] { localObject2 });
    ...
    for (;;)
    {
      ...
      else
      {
        try
        {
          ...
          {
            localTroopFeedItem.tag = ajyc.a(2131715311);
            ...
            localObject = new ByteArrayInputStream(axwh.a(localTroopNotificationCache.xmlBytes, i));
            localazpd = new azpd(this);
            SAXParserFactory.newInstance().newSAXParser().parse((InputStream)localObject, localazpd);
            ((InputStream)localObject).close();
            if (localTroopNotificationCache.serviceID == 20)
            {
              localTroopFeedItem.title = localazpd.jdField_a_of_type_JavaLangString;
              localTroopFeedItem.content = "";
              localTroopFeedItem.picPath = localazpd.jdField_b_of_type_JavaLangString;
              localTroopFeedItem.linkUrl = localazpd.jdField_d_of_type_JavaLangString;
          ...
          for (;;)
          {
            localTroopFeedItem.tag = ajyc.a(2131715312);
            localTroopFeedItem.type = 133;
            break;
            localTroopFeedItem.title = localTroopNotificationCache.title;
            localTroopFeedItem.content = localazpd.jdField_c_of_type_JavaLangString;
            break label282;
            i = 0;
            break;
            i = 0;
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      ((Bundle)localObject2).putString("bkn", "" + bamn.b(str));
      ((Bundle)localObject2).putString("ver", "8.2.8");
      ...
      new bahn("http://web.qun.qq.com/cgi-bin/announce/get_feed", "GET", this.jdField_a_of_type_Baho, paramInt, null, true).execute(new HashMap[] { localObject1 });
  ...
  public void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
    ((HashMap)localObject1).put("CONTEXT", MobileQQ.getContext());
    new bahn("http://web.qun.qq.com/cgi-bin/announce/get_t_list", "GET", this.jdField_a_of_type_Baho, paramInt, null, true).execute(new HashMap[] { localObject1 });
    if (QLog.isColorLevel()) {
