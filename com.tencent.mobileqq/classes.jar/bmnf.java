...
public class bmnf
  extends bmnh
  implements bmjf, IEventReceiver
{
  ...
  public bmnf(@NonNull bmnj parambmnj)
  {
    super(parambmnj);
  }
  ...
  private void b(long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_AndroidOsHandler != null)
    {
      ...
      if (localObject != null)
      {
        ...
        ((bmnt)localObject).b(paramLong, paramBoolean1);
      }
    }
    for (;;)
    {
      ...
      if (localObject != null) {
        ((bmjg)localObject).a(paramLong);
      }
      return;
      label340:
      ((bmnt)localObject).a(paramLong, paramBoolean1);
    }
  }
  ...
  public void a()
  {
    ...
    {
      long l = ((EditLocalVideoSource)this.jdField_a_of_type_Bmnj.a.a).a * -1;
  ...
  public void b()
  {
    Object localObject = (bmnt)a(bmnt.class);
    if (localObject != null) {
      ((bmnt)localObject).k();
    }
    localObject = (bmjg)a(bmjg.class);
    if (localObject != null) {
      ((bmjg)localObject).ag_();
    }
  }
  ...
  public boolean h_()
  {
    ...
    bmnt localbmnt = (bmnt)a(bmnt.class);
    if (localbmnt != null) {
      this.jdField_b_of_type_Boolean = localbmnt.a(this.c);
    }
