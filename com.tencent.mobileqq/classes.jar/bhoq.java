  ...
  implements URLDrawable.URLDrawableListener
{
  ...
  public void onLoadCanceled(@NotNull URLDrawable paramURLDrawable)
  {
    ...
    bhoo.a(bhoo.a, (Function0)new VasApngFactory.getApngURLDrawable.listenerProxy.1.onLoadCanceled.1(this, paramURLDrawable));
  }
  
  public void onLoadFialed(@NotNull URLDrawable paramURLDrawable, @Nullable Throwable paramThrowable)
  {
    Intrinsics.checkParameterIsNotNull(paramURLDrawable, "d");
    bhoo.a(bhoo.a, (Function0)new VasApngFactory.getApngURLDrawable.listenerProxy.1.onLoadFialed.1(this, paramURLDrawable, paramThrowable));
  }
  
  public void onLoadProgressed(@NotNull URLDrawable paramURLDrawable, int paramInt)
  {
    Intrinsics.checkParameterIsNotNull(paramURLDrawable, "d");
    bhoo.a(bhoo.a, (Function0)new VasApngFactory.getApngURLDrawable.listenerProxy.1.onLoadProgressed.1(this, paramURLDrawable, paramInt));
  }
  
  public void onLoadSuccessed(@NotNull URLDrawable paramURLDrawable)
  {
    Intrinsics.checkParameterIsNotNull(paramURLDrawable, "d");
    bhoo.a(bhoo.a, (Function0)new VasApngFactory.getApngURLDrawable.listenerProxy.1.onLoadSuccessed.1(this, paramURLDrawable));
  }
}
