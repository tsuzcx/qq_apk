...
public final class bgpw
{
  ...
  public static void a(Context paramContext, String paramString1, boolean paramBoolean1, String paramString2, boolean paramBoolean2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = bbdj.a(paramContext, 230, paramString2, paramString1, 2131690596, 2131692364, new bgpx(), null);
      ...
      localbcql.b(paramContext.getResources().getDimensionPixelSize(2131298865) - (int)(5.0F * paramContext.getResources().getDisplayMetrics().density));
      return;
  ...
  public static boolean a(ChatMessage paramChatMessage)
  {
    ...
    return (paramChatMessage != null) && ((ampu.c.equals(paramChatMessage.ark_app_message.appName)) || ("com.tencent.structmsg".equals(paramChatMessage.ark_app_message.appName)));
  }
  ...
  public static boolean a(boolean paramBoolean)
  {
    ...
    {
      PluginManagerHelper.getPluginInterface(BaseApplicationImpl.getApplication(), new bgpy((Runnable)localObject2));
