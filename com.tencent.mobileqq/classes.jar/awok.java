...
{
  public awok(CustomCoverFragment paramCustomCoverFragment) {}
  
  public void onClick(View paramView)
  {
    int i = 1;
    if (paramView.getId() == 2131368735) {
      if (CustomCoverFragment.a(this.a) != null)
      {
        ...
        paramView = (amca)CustomCoverFragment.a(this.a).a(13);
        if (!CustomCoverFragment.b(this.a)) {
          break label158;
        }
        i = 1;
        paramView.h(i);
        CustomCoverFragment.a(this.a).a(0, this.a.getString(2131699406), 0, CustomCoverFragment.a(this.a));
    ...
    for (int j = ((Integer)localObject).intValue();; j = 0)
    {
      ...
      for (i = 2;; i = 0)
      {
        ...
        adpn.a(this.a.getActivity(), paramView, PublicFragmentActivity.class, CoverDetailFragment.class, 2001);
        return;
      }
    }
  }
