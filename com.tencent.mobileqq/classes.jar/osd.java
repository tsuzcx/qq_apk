...
public class osd
  extends osf
{
  public osd(TroopStoryMemoriesListAdapter paramTroopStoryMemoriesListAdapter, View paramView)
  {
  ...
  public void a(TroopStoryItemInfo paramTroopStoryItemInfo, int paramInt)
  {
    ...
    try
    {
      ...
      paramTroopStoryItemInfo = this.jdField_a_of_type_ComTencentBizQqstoryTroopMemoriesTroopStoryMemoriesListAdapter.a.getResources().getDrawable(2130838602);
      ...
      this.jdField_a_of_type_AndroidViewView.setOnClickListener(new ose(this));
      return;
    }
