...
public class beiu
{
  ...
  {
    if (beuc.a().a() != null) {}
    for (String str = beuc.a().a(); (this.jdField_a_of_type_Beqt == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Beqt.d)); str = "") {
      return c;
    }
    if (TextUtils.isEmpty(str)) {
      return c + bfgc.c(this.jdField_a_of_type_Beqt.d) + "/" + bfgc.c(str);
    }
    return c + bfgc.c(this.jdField_a_of_type_Beqt.d) + "/" + bfgc.c(str);
  }
  ...
  private void b()
  {
    beiw.b().post(new MiniAppFileManager.1(this));
  }
  ...
  private static void d()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 171	beiu:jdField_b_of_type_Boolean	Z
    //   6: istore_0
    //   7: iload_0
    //   8: ifeq +7 -> 15
    //   11: ldc 2
    ...
    //   18: dup
    //   19: getstatic 52	beiu:c	Ljava/lang/String;
    //   22: ldc 173
    ...
    //   60: pop
    //   61: iconst_1
    //   62: putstatic 171	beiu:jdField_b_of_type_Boolean	Z
    //   65: goto -54 -> 11
    //   68: astore_1
    //   69: getstatic 20	beiu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   72: ldc 184
    //   74: aload_1
    //   75: invokestatic 189	besl:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   78: goto -67 -> 11
    //   81: astore_1
    //   82: ldc 2
    //   84: monitorexit
  ...
  public String a(String paramString)
  {
    try
    {
      ...
      {
        paramString = new File(this.jdField_a_of_type_Beqt.g(str1));
        if ((paramString.exists()) && (paramString.getCanonicalPath().startsWith(new File(this.jdField_a_of_type_Beqt.e()).getCanonicalPath())))
        {
          paramString = this.jdField_a_of_type_Beqt.g(str1);
          return paramString;
        }
      }
    }
    ...
    {
      besl.d(jdField_a_of_type_JavaLangString, "getAbsolutePath error.", paramString);
      return "";
    }
    label425:
    String str1 = "";
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      ...
      while (i >= 0)
      {
        ...
        {
          bekq.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(i), false);
  ...
  public void a(beqt parambeqt, boolean paramBoolean)
  {
    a(parambeqt);
    if (paramBoolean)
    {
  ...
  public boolean a(String paramString)
  {
    ...
    try
    {
      paramString = new File(this.jdField_a_of_type_Beqt.g(paramString));
      boolean bool1 = bool2;
      if (paramString.exists())
      {
        boolean bool3 = paramString.getCanonicalPath().startsWith(new File(this.jdField_a_of_type_Beqt.e()).getCanonicalPath());
        bool1 = bool2;
        if (bool3) {
          bool1 = true;
        }
  ...
  public String b(String paramString)
  {
    ...
    {
      paramString = bfgc.c(new StringBuilder().append(System.nanoTime()).append("").toString()) + paramString;
  ...
  public String c(String paramString)
  {
    ...
    {
      besl.d(jdField_a_of_type_JavaLangString, "getUsrPath error", paramString);
    }
    return null;
  }
  ...
  public String d(String paramString)
  {
    ...
    if (new File(str).exists())
    {
      ...
      if (bekq.b(str, new File(a(1), paramString).getAbsolutePath())) {
  ...
  public String f(String paramString)
  {
    ...
    for (str = "";; str = "." + str)
    {
      str = bfgc.c(new StringBuilder().append(System.nanoTime()).append("").toString()) + str;
  ...
  public String h(String paramString)
  {
    ...
    //   17: aload_0
    //   18: iconst_0
    //   19: invokespecial 115	beiu:a	(I)Ljava/lang/String;
    ...
    //   46: aload_0
    //   47: aload 4
    //   49: invokestatic 335	beiu:a	(Ljava/io/File;)Ljava/lang/String;
    //   52: invokevirtual 331	beiu:b	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   145: aload 4
    //   147: astore 5
    //   149: getstatic 20	beiu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   152: ldc_w 367
    //   155: aload 7
