...
public class acln
{
  ...
  private static int a(aclx paramaclx)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 30	aclx:b	()Ljava/lang/String;
    ...
    //   557: aload 8
    //   559: invokestatic 134	acln:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   562: aload 6
    //   564: astore 4
    //   566: aload 8
  ...
  private static void a(aclx paramaclx)
  {
    long l = System.currentTimeMillis();
    try
    {
      paramaclx = paramaclx.b();
      String str = PatchCommonUtil.getPatchPath(paramaclx);
      if ("Success".equals(aoeg.a(BaseApplicationImpl.sApplication, str, null, false)))
      {
        jdField_a_of_type_Int = 500;
        jdField_a_of_type_JavaLangString = paramaclx;
      }
      for (;;)
      {
    ...
    catch (Throwable paramaclx)
    {
      for (;;)
      {
        jdField_a_of_type_Int = 502;
        QLog.d("PatchLogTag", 1, "DexPatchInstaller injectDexPatch throwable=" + paramaclx);
      }
    }
  }
  ...
  {
    long l = System.currentTimeMillis();
    aclx localaclx = acly.a(paramContext, "dex");
    if ((jdField_a_of_type_Int == 0) && (a(paramContext, localaclx)))
    {
      String str = a();
      ...
      if (jdField_a_of_type_Int == 500) {
        if ((localaclx.b()) && (PatchCommonUtil.isArtGeN()) && (!SoLoadUtil.a()))
        {
          j = a(localaclx);
          i = j;
          if (j != 800)
          {
            str = aoeg.a(BaseApplicationImpl.sApplication, 0);
      ...
      for (int i = j;; i = 0)
      {
        a(paramContext, localaclx);
        PatchReporter.reportPatchEvent(paramContext, "", "actPatchInstall", jdField_a_of_type_Int, localaclx.b(), i);
        ...
        if (PatchCommonUtil.isDalvik()) {
          PatchResolveForDalvik.a(paramContext, localaclx);
        }
      }
    }
  ...
  private static void a(Context paramContext, aclx paramaclx)
  {
    paramContext = new DexPatchInstaller.1(paramaclx, paramContext);
  ...
  private static boolean a(Context paramContext, aclx paramaclx)
  {
    if (paramaclx == null) {
      QLog.d("PatchLogTag", 1, "DexPatchInstaller checkDexPatchConfigAndStatus patch config is null");
    }
    while (!paramaclx.a(paramContext, BaseApplicationImpl.processName)) {
      return false;
    }
    String str = paramaclx.b();
    ...
    if (localFile.length() != paramaclx.b())
    {
