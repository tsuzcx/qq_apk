...
public class LruCache<K, V>
{
  ...
  public void trimToSize(int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 108	androidx/collection/LruCache:size	I
    //   6: iflt +20 -> 26
    //   9: aload_0
    //   10: getfield 38	androidx/collection/LruCache:map	Ljava/util/LinkedHashMap;
    //   13: invokevirtual 149	java/util/LinkedHashMap:isEmpty	()Z
    //   16: ifeq +48 -> 64
    //   19: aload_0
    //   20: getfield 108	androidx/collection/LruCache:size	I
    //   23: ifeq +41 -> 64
    ...
    //   37: aload_0
    //   38: invokevirtual 153	java/lang/Object:getClass	()Ljava/lang/Class;
    //   41: invokevirtual 158	java/lang/Class:getName	()Ljava/lang/String;
    ...
    //   63: athrow
    //   64: aload_0
    //   65: getfield 108	androidx/collection/LruCache:size	I
    //   68: iload_1
    //   69: if_icmple +13 -> 82
    //   72: aload_0
    //   73: getfield 38	androidx/collection/LruCache:map	Ljava/util/LinkedHashMap;
    //   76: invokevirtual 149	java/util/LinkedHashMap:isEmpty	()Z
    //   79: ifeq +6 -> 85
    //   82: aload_0
    //   83: monitorexit
    //   84: return
    //   85: aload_0
    //   86: getfield 38	androidx/collection/LruCache:map	Ljava/util/LinkedHashMap;
    //   89: invokevirtual 164	java/util/LinkedHashMap:entrySet	()Ljava/util/Set;
    //   92: invokeinterface 170 1 0
    //   97: invokeinterface 176 1 0
    //   102: checkcast 178	java/util/Map$Entry
    //   105: astore_3
    //   106: aload_3
    //   107: invokeinterface 181 1 0
    //   112: astore_2
    //   113: aload_3
    //   114: invokeinterface 184 1 0
    //   119: astore_3
    //   120: aload_0
    //   121: getfield 38	androidx/collection/LruCache:map	Ljava/util/LinkedHashMap;
    //   124: aload_2
    //   125: invokevirtual 118	java/util/LinkedHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   128: pop
    //   129: aload_0
    //   130: aload_0
    //   131: getfield 108	androidx/collection/LruCache:size	I
    //   134: aload_0
    //   135: aload_2
    //   136: aload_3
    //   137: invokespecial 110	androidx/collection/LruCache:safeSizeOf	(Ljava/lang/Object;Ljava/lang/Object;)I
    //   140: isub
    //   141: putfield 108	androidx/collection/LruCache:size	I
    //   144: aload_0
    //   145: aload_0
    //   146: getfield 86	androidx/collection/LruCache:evictionCount	I
    //   149: iconst_1
    //   150: iadd
    //   151: putfield 86	androidx/collection/LruCache:evictionCount	I
    //   154: aload_0
    //   155: monitorexit
    //   156: aload_0
    //   157: iconst_1
    ...
    //   159: aload_3
    //   160: aconst_null
    //   161: invokevirtual 106	androidx/collection/LruCache:entryRemoved	(ZLjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    //   164: goto -164 -> 0
