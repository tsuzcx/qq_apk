  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    localActionBarOverlayLayout.mCurrentActionBarTopAnimator = localActionBarOverlayLayout.mActionBarTop.animate().translationY(0.0F).setListener(this.this$0.mTopAnimatorListener);
  }
}
