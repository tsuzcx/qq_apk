  ...
  extends View
{
  ...
  public void updatePostMeasure(ConstraintLayout paramConstraintLayout)
  {
    ...
    if (paramConstraintLayout.widget.getHorizontalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.FIXED) {
      paramConstraintLayout.widget.setWidth(localLayoutParams.widget.getWidth());
    }
    if (paramConstraintLayout.widget.getVerticalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.FIXED) {
  ...
  public void updatePreLayout(ConstraintLayout paramConstraintLayout)
  {
    ...
    paramConstraintLayout = this.mContent;
