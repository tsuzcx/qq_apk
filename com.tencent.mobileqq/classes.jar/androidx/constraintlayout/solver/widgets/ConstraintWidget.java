...
public class ConstraintWidget
{
  ...
  private void applyConstraints(LinearSystem paramLinearSystem, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, SolverVariable paramSolverVariable1, SolverVariable paramSolverVariable2, ConstraintWidget.DimensionBehaviour paramDimensionBehaviour, boolean paramBoolean5, ConstraintAnchor paramConstraintAnchor1, ConstraintAnchor paramConstraintAnchor2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat1, boolean paramBoolean6, boolean paramBoolean7, boolean paramBoolean8, boolean paramBoolean9, int paramInt5, int paramInt6, int paramInt7, int paramInt8, float paramFloat2, boolean paramBoolean10)
  {
    int i = paramInt7;
    ...
    j = ConstraintWidget.1.$SwitchMap$androidx$constraintlayout$solver$widgets$ConstraintWidget$DimensionBehaviour[paramDimensionBehaviour.ordinal()];
    if ((j == 1) || (j == 2) || (j == 3) || (j != 4)) {}
    while (paramInt5 == 4)
    {
      j = 0;
    ...
    if (paramInt5 == 0)
    {
      ...
      {
        paramLinearSystem.addEquality(localSolverVariable2, localSolverVariable1, paramInt2, 8);
      }
      paramInt1 = i;
    }
    for (;;)
    {
      ...
      paramInt8 = paramInt5;
      break label831;
      if ((paramInt7 != 2) && (!paramBoolean6) && ((k == 1) || (k == 0)))
      {
      ...
      else
      {
        ...
        if (paramInt1 > 0)
        {
          ...
          paramInt2 = Math.max(paramInt8, paramInt1);
        }
        if (paramInt4 > 0)
        {
        ...
        {
          paramLinearSystem.addEquality(localSolverVariable2, localSolverVariable1, paramInt2, 5);
          paramLinearSystem.addLowerThan(localSolverVariable2, localSolverVariable1, paramInt2, 8);
        }
        else
        {
          paramLinearSystem.addEquality(localSolverVariable2, localSolverVariable1, paramInt2, 5);
    ...
    if ((paramBoolean10) && (!paramBoolean7))
    {
      if ((!bool1) && (!bool2) && (!bool3))
      {
      ...
      else
      {
        ...
        if (bool1)
        {
          ...
          if (bool2)
          {
            ...
            localObject3 = paramConstraintAnchor2.mTarget.mOwner;
            ...
            if (paramInt7 != 0)
            {
              ...
              paramLinearSystem.addCentering(localSolverVariable1, (SolverVariable)localObject1, paramConstraintAnchor1.getMargin(), paramFloat1, paramDimensionBehaviour, localSolverVariable2, paramConstraintAnchor2.getMargin(), paramInt2);
            }
            ...
            if (paramInt5 != 0)
            {
              if ((paramBoolean2) && (localObject2 != localObject1) && (paramInt8 == 0))
              {
              ...
              label1528:
              paramLinearSystem.addGreaterThan(localSolverVariable1, (SolverVariable)localObject2, paramConstraintAnchor1.getMargin(), paramInt1);
              paramLinearSystem.addLowerThan(localSolverVariable2, (SolverVariable)localObject1, -paramConstraintAnchor2.getMargin(), paramInt1);
            }
            if ((paramBoolean2) && (paramBoolean9) && (!(localConstraintWidget instanceof Barrier)) && (!(localObject3 instanceof Barrier)))
            {
              paramInt1 = 6;
              paramInt4 = 6;
              j = 1;
            ...
            if (j != 0)
            {
              if ((paramInt6 != 0) && ((!paramBoolean8) || (paramBoolean3)))
              {
  ...
  public void addToSolver(LinearSystem paramLinearSystem)
  {
    ...
    SolverVariable localSolverVariable2 = paramLinearSystem.createObjectVariable(((ConstraintWidget)localObject4).mLeft);
    SolverVariable localSolverVariable1 = paramLinearSystem.createObjectVariable(((ConstraintWidget)localObject4).mRight);
    Object localObject7 = paramLinearSystem.createObjectVariable(((ConstraintWidget)localObject4).mTop);
    Object localObject6 = paramLinearSystem.createObjectVariable(((ConstraintWidget)localObject4).mBottom);
    Object localObject2 = paramLinearSystem.createObjectVariable(((ConstraintWidget)localObject4).mBaseline);
    if (LinearSystem.sMetrics != null)
    {
      localObject1 = LinearSystem.sMetrics;
      ((Metrics)localObject1).widgets += 1L;
    }
    if ((((ConstraintWidget)localObject4).horizontalRun.start.resolved) && (((ConstraintWidget)localObject4).horizontalRun.end.resolved) && (((ConstraintWidget)localObject4).verticalRun.start.resolved) && (((ConstraintWidget)localObject4).verticalRun.end.resolved))
    {
      if (LinearSystem.sMetrics != null)
      {
        localObject1 = LinearSystem.sMetrics;
      ...
      paramLinearSystem.addEquality(localSolverVariable2, ((ConstraintWidget)localObject4).horizontalRun.start.value);
      paramLinearSystem.addEquality(localSolverVariable1, ((ConstraintWidget)localObject4).horizontalRun.end.value);
      paramLinearSystem.addEquality((SolverVariable)localObject7, ((ConstraintWidget)localObject4).verticalRun.start.value);
      paramLinearSystem.addEquality((SolverVariable)localObject6, ((ConstraintWidget)localObject4).verticalRun.end.value);
      paramLinearSystem.addEquality((SolverVariable)localObject2, ((ConstraintWidget)localObject4).verticalRun.baseline.value);
      localObject1 = ((ConstraintWidget)localObject4).mParent;
      if (localObject1 != null)
      {
        ...
        if ((i != 0) && (localObject4.isTerminalWidget[0] != 0) && (!isInHorizontalChain())) {
          paramLinearSystem.addGreaterThan(paramLinearSystem.createObjectVariable(((ConstraintWidget)localObject4).mParent.mRight), localSolverVariable1, 0, 8);
        }
        if ((j != 0) && (localObject4.isTerminalWidget[1] != 0) && (!isInVerticalChain())) {
          paramLinearSystem.addGreaterThan(paramLinearSystem.createObjectVariable(((ConstraintWidget)localObject4).mParent.mBottom), (SolverVariable)localObject6, 0, 8);
        }
      }
      return;
    }
    ...
    Object localObject1 = ((ConstraintWidget)localObject4).mParent;
    boolean bool1;
    int i2;
    boolean bool2;
    boolean bool3;
    ...
    if (localObject1 != null)
    {
      ...
      if (((ConstraintWidget)localObject4).isChainHead(0))
      {
        ((ConstraintWidgetContainer)((ConstraintWidget)localObject4).mParent).addChain((ConstraintWidget)localObject4, 0);
        bool2 = true;
      }
      else
      {
        bool2 = isInHorizontalChain();
      }
      if (((ConstraintWidget)localObject4).isChainHead(1))
      {
        ((ConstraintWidgetContainer)((ConstraintWidget)localObject4).mParent).addChain((ConstraintWidget)localObject4, 1);
        bool3 = true;
      }
      else
      {
      ...
      if ((!bool2) && (bool1) && (((ConstraintWidget)localObject4).mVisibility != 8) && (((ConstraintWidget)localObject4).mLeft.mTarget == null) && (((ConstraintWidget)localObject4).mRight.mTarget == null)) {
        paramLinearSystem.addGreaterThan(paramLinearSystem.createObjectVariable(((ConstraintWidget)localObject4).mParent.mRight), localSolverVariable1, 0, 1);
      }
      if ((!bool3) && (i2 != 0) && (((ConstraintWidget)localObject4).mVisibility != 8) && (((ConstraintWidget)localObject4).mTop.mTarget == null) && (((ConstraintWidget)localObject4).mBottom.mTarget == null) && (((ConstraintWidget)localObject4).mBaseline == null)) {
        paramLinearSystem.addGreaterThan(paramLinearSystem.createObjectVariable(((ConstraintWidget)localObject4).mParent.mBottom), (SolverVariable)localObject6, 0, 1);
      }
      bool4 = bool3;
      bool3 = bool2;
      bool2 = bool1;
    ...
    int i = ((ConstraintWidget)localObject4).mWidth;
    int j = ((ConstraintWidget)localObject4).mMinWidth;
    int m = i;
    if (i < j) {
      m = j;
    }
    j = ((ConstraintWidget)localObject4).mHeight;
    int k = ((ConstraintWidget)localObject4).mMinHeight;
    i = j;
    if (j < k) {
      i = k;
    }
    if (localObject4.mListDimensionBehaviors[0] != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
      bool1 = true;
    } else {
      bool1 = false;
    }
    if (localObject4.mListDimensionBehaviors[1] != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
      bool5 = true;
    } else {
      bool5 = false;
    }
    ((ConstraintWidget)localObject4).mResolvedDimensionRatioSide = ((ConstraintWidget)localObject4).mDimensionRatioSide;
    float f = ((ConstraintWidget)localObject4).mDimensionRatio;
    ((ConstraintWidget)localObject4).mResolvedDimensionRatio = f;
    k = ((ConstraintWidget)localObject4).mMatchConstraintDefaultWidth;
    int n = ((ConstraintWidget)localObject4).mMatchConstraintDefaultHeight;
    if ((f > 0.0F) && (((ConstraintWidget)localObject4).mVisibility != 8))
    {
      j = k;
      if (localObject4.mListDimensionBehaviors[0] == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT)
      {
      ...
      int i1;
      if ((localObject4.mListDimensionBehaviors[0] == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) && (localObject4.mListDimensionBehaviors[1] == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) && (j == 3) && (k == 3))
      {
        ((ConstraintWidget)localObject4).setupDimensionRatio(bool2, i2, bool1, bool5);
        i1 = i;
        n = m;
      }
      else if ((localObject4.mListDimensionBehaviors[0] == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) && (j == 3))
      {
        ((ConstraintWidget)localObject4).mResolvedDimensionRatioSide = 0;
        m = (int)(((ConstraintWidget)localObject4).mResolvedDimensionRatio * ((ConstraintWidget)localObject4).mHeight);
        if (localObject4.mListDimensionBehaviors[1] != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT)
        {
          bool1 = false;
          j = 4;
      ...
      else
      {
        ...
        if (localObject4.mListDimensionBehaviors[1] == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT)
        {
          ...
          if (k == 3)
          {
            ((ConstraintWidget)localObject4).mResolvedDimensionRatioSide = 1;
            if (((ConstraintWidget)localObject4).mDimensionRatioSide == -1) {
              ((ConstraintWidget)localObject4).mResolvedDimensionRatio = (1.0F / ((ConstraintWidget)localObject4).mResolvedDimensionRatio);
            }
            i = (int)(((ConstraintWidget)localObject4).mResolvedDimensionRatio * ((ConstraintWidget)localObject4).mWidth);
            i1 = i;
            n = m;
            if (localObject4.mListDimensionBehaviors[0] != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT)
            {
    ...
    label1194:
    localObject1 = ((ConstraintWidget)localObject4).mResolvedMatchConstraintDefault;
    localObject1[0] = j;
    localObject1[1] = k;
    ((ConstraintWidget)localObject4).mResolvedHasRatio = bool1;
    if (bool1)
    {
      n = ((ConstraintWidget)localObject4).mResolvedDimensionRatioSide;
      if (n != 0) {
        if (n != -1) {
          break label1252;
        }
    ...
    boolean bool5 = false;
    label1255:
    if ((localObject4.mListDimensionBehaviors[0] == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) && ((localObject4 instanceof ConstraintWidgetContainer))) {
      bool6 = true;
    } else {
      bool6 = false;
    }
    ...
    boolean bool7 = ((ConstraintWidget)localObject4).mCenter.isConnected() ^ true;
    localObject1 = ((ConstraintWidget)localObject4).mIsInBarrier;
    int i3 = localObject1[0];
    int i4 = localObject1[1];
    n = ((ConstraintWidget)localObject4).mHorizontalResolution;
    Object localObject5 = null;
    if (n != 2) {
      if ((((ConstraintWidget)localObject4).horizontalRun.start.resolved) && (((ConstraintWidget)localObject4).horizontalRun.end.resolved))
      {
        paramLinearSystem.addEquality(localSolverVariable2, ((ConstraintWidget)localObject4).horizontalRun.start.value);
        paramLinearSystem.addEquality(localSolverVariable1, ((ConstraintWidget)localObject4).horizontalRun.end.value);
        if ((((ConstraintWidget)localObject4).mParent != null) && (bool2) && (localObject4.isTerminalWidget[0] != 0) && (!isInHorizontalChain())) {
          paramLinearSystem.addGreaterThan(paramLinearSystem.createObjectVariable(((ConstraintWidget)localObject4).mParent.mRight), localSolverVariable1, 0, 8);
        }
      }
      else
      {
        ...
        localObject3 = ((ConstraintWidget)localObject4).mParent;
        if (localObject3 != null) {
          localObject3 = paramLinearSystem.createObjectVariable(((ConstraintWidget)localObject3).mLeft);
        } else {
          localObject3 = null;
        }
        applyConstraints(paramLinearSystem, true, bool2, i2, localObject4.isTerminalWidget[0], (SolverVariable)localObject3, (SolverVariable)localObject1, localObject4.mListDimensionBehaviors[0], bool6, ((ConstraintWidget)localObject4).mLeft, ((ConstraintWidget)localObject4).mRight, ((ConstraintWidget)localObject4).mX, m, ((ConstraintWidget)localObject4).mMinWidth, localObject4.mMaxDimension[0], ((ConstraintWidget)localObject4).mHorizontalBiasPercent, bool5, bool3, bool4, i3, j, k, ((ConstraintWidget)localObject4).mMatchConstraintMinWidth, ((ConstraintWidget)localObject4).mMatchConstraintMaxWidth, ((ConstraintWidget)localObject4).mMatchConstraintPercentWidth, bool7);
      }
    }
    ...
    i3 = i2;
    localObject6 = this;
    if ((((ConstraintWidget)localObject6).verticalRun.start.resolved) && (((ConstraintWidget)localObject6).verticalRun.end.resolved))
    {
      m = ((ConstraintWidget)localObject6).verticalRun.start.value;
      localObject2 = paramLinearSystem;
      ((LinearSystem)localObject2).addEquality((SolverVariable)localObject4, m);
      m = ((ConstraintWidget)localObject6).verticalRun.end.value;
      localObject7 = localObject1;
      ((LinearSystem)localObject2).addEquality((SolverVariable)localObject7, m);
      ((LinearSystem)localObject2).addEquality((SolverVariable)localObject3, ((ConstraintWidget)localObject6).verticalRun.baseline.value);
      localObject8 = ((ConstraintWidget)localObject6).mParent;
      if ((localObject8 != null) && (!bool4) && (i3 != 0)) {
        if (localObject6.isTerminalWidget[1] != 0) {
          ((LinearSystem)localObject2).addGreaterThan(((LinearSystem)localObject2).createObjectVariable(((ConstraintWidget)localObject8).mBottom), (SolverVariable)localObject7, 0, 8);
        } else {}
      }
      m = 0;
    }
    ...
    localObject7 = paramLinearSystem;
    ...
    if (m != 0)
    {
      ...
      if (bool6)
      {
        m = ((ConstraintWidget)localObject6).mResolvedDimensionRatioSide;
        if ((m == 1) || (m == -1))
        {
          i2 = 1;
          break label1898;
      ...
      ConstraintWidget localConstraintWidget = ((ConstraintWidget)localObject6).mParent;
      localObject4 = localObject5;
      if (localConstraintWidget != null) {
        localObject4 = ((LinearSystem)localObject7).createObjectVariable(localConstraintWidget.mTop);
      }
      ...
      bool5 = bool7;
      label2082:
      applyConstraints(paramLinearSystem, false, i3, bool2, localObject6.isTerminalWidget[1], (SolverVariable)localObject4, (SolverVariable)localObject3, localObject6.mListDimensionBehaviors[1], bool1, ((ConstraintWidget)localObject6).mTop, ((ConstraintWidget)localObject6).mBottom, ((ConstraintWidget)localObject6).mY, i, ((ConstraintWidget)localObject6).mMinHeight, localObject6.mMaxDimension[1], ((ConstraintWidget)localObject6).mVerticalBiasPercent, i2, bool4, bool3, i4, k, j, ((ConstraintWidget)localObject6).mMatchConstraintMinHeight, ((ConstraintWidget)localObject6).mMatchConstraintMaxHeight, ((ConstraintWidget)localObject6).mMatchConstraintPercentHeight, bool5);
    }
    if (bool6)
    {
      localObject3 = this;
      if (((ConstraintWidget)localObject3).mResolvedDimensionRatioSide == 1) {
        paramLinearSystem.addRatio((SolverVariable)localObject1, (SolverVariable)localObject2, localSolverVariable1, localSolverVariable2, ((ConstraintWidget)localObject3).mResolvedDimensionRatio, 8);
      } else {
        paramLinearSystem.addRatio(localSolverVariable1, localSolverVariable2, (SolverVariable)localObject1, (SolverVariable)localObject2, ((ConstraintWidget)localObject3).mResolvedDimensionRatio, 8);
      }
    }
    localObject1 = this;
