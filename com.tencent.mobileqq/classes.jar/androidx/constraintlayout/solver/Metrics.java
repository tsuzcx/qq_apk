...
public class Metrics
{
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("\nmeasuresWrap: ");
    localStringBuilder.append(this.measuresWrap);
    localStringBuilder.append("\nmeasuresWrapInfeasible: ");
    localStringBuilder.append(this.measuresWrapInfeasible);
    localStringBuilder.append("\ndetermineGroups: ");
    localStringBuilder.append(this.determineGroups);
    localStringBuilder.append("\ninfeasibleDetermineGroups: ");
    localStringBuilder.append(this.infeasibleDetermineGroups);
    localStringBuilder.append("\ngraphOptimizer: ");
    localStringBuilder.append(this.graphOptimizer);
    localStringBuilder.append("\nwidgets: ");
    localStringBuilder.append(this.widgets);
    localStringBuilder.append("\ngraphSolved: ");
    localStringBuilder.append(this.graphSolved);
    localStringBuilder.append("\nlinearSolved: ");
    localStringBuilder.append(this.linearSolved);
    localStringBuilder.append("\n");
