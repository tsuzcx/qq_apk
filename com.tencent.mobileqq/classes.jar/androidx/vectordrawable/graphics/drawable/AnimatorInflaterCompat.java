...
public class AnimatorInflaterCompat
{
  ...
  private static PropertyValuesHolder getPVH(TypedArray paramTypedArray, int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    ...
    if (i == 2)
    {
      ...
      else
      {
        if (arrayOfPathDataNode1 != null)
        {
          paramTypedArray = new AnimatorInflaterCompat.PathDataEvaluator();
          if (arrayOfPathDataNode2 != null)
          {
        ...
        paramTypedArray = (TypedArray)localObject1;
        if (arrayOfPathDataNode2 != null) {
          return PropertyValuesHolder.ofObject(paramString, new AnimatorInflaterCompat.PathDataEvaluator(), new Object[] { arrayOfPathDataNode2 });
        }
      }
    }
    else
  ...
  public static Animator loadAnimator(Context paramContext, Resources paramResources, Resources.Theme paramTheme, @AnimatorRes int paramInt, float paramFloat)
  {
    ...
    //   9: aload_1
    //   10: iload_3
    //   11: invokevirtual 356	android/content/res/Resources:getAnimation	(I)Landroid/content/res/XmlResourceParser;
    //   14: astore 8
    //   16: aload 8
    //   18: astore 5
    //   20: aload 8
    ...
    //   31: aload 8
    //   33: fload 4
    //   35: invokestatic 358	androidx/vectordrawable/graphics/drawable/AnimatorInflaterCompat:createAnimatorFromXml	(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;F)Landroid/animation/Animator;
    //   38: astore_0
    //   39: aload 8
    //   41: ifnull +10 -> 51
    //   44: aload 8
    //   46: invokeinterface 363 1 0
    //   51: aload_0
    //   52: areturn
    //   53: astore_0
    //   54: goto +143 -> 197
    ...
    //   58: aload 6
    //   60: astore 5
    //   62: new 123	java/lang/StringBuilder
    //   65: dup
    //   66: invokespecial 124	java/lang/StringBuilder:<init>	()V
    //   69: astore_1
    //   70: aload 6
    //   72: astore 5
    //   74: aload_1
    ...
    //   86: aload_1
    //   87: iload_3
    //   88: invokestatic 368	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    //   91: invokevirtual 130	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   94: pop
    //   95: aload 6
    //   97: astore 5
    //   99: new 370	android/content/res/Resources$NotFoundException
    //   102: dup
    //   103: aload_1
    //   104: invokevirtual 135	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   107: invokespecial 371	android/content/res/Resources$NotFoundException:<init>	(Ljava/lang/String;)V
    //   110: astore_1
    //   111: aload 6
    //   113: astore 5
    //   115: aload_1
    //   116: aload_0
    //   117: invokevirtual 375	android/content/res/Resources$NotFoundException:initCause	(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    //   120: pop
    //   121: aload 6
    //   123: astore 5
    //   125: aload_1
    ...
    //   156: aload_1
    //   157: iload_3
    //   158: invokestatic 368	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    //   161: invokevirtual 130	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   164: pop
    //   165: aload 7
    //   167: astore 5
    //   169: new 370	android/content/res/Resources$NotFoundException
    //   172: dup
    //   173: aload_1
    //   174: invokevirtual 135	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   177: invokespecial 371	android/content/res/Resources$NotFoundException:<init>	(Ljava/lang/String;)V
    //   180: astore_1
    //   181: aload 7
    //   183: astore 5
    //   185: aload_1
    //   186: aload_0
    //   187: invokevirtual 375	android/content/res/Resources$NotFoundException:initCause	(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    //   190: pop
    //   191: aload 7
    //   193: astore 5
    //   195: aload_1
