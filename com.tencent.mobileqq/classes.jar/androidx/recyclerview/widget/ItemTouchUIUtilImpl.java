  ...
  implements ItemTouchUIUtil
{
  ...
  public void clearView(View paramView)
  {
    ...
    {
      Object localObject = paramView.getTag(2131368901);
      if ((localObject instanceof Float)) {
        ViewCompat.setElevation(paramView, ((Float)localObject).floatValue());
      }
      paramView.setTag(2131368901, null);
    }
  ...
  {
    if ((Build.VERSION.SDK_INT >= 21) && (paramBoolean) && (paramView.getTag(2131368901) == null))
    {
      ...
      paramView.setTag(2131368901, Float.valueOf(f));
    }
