...
class DocumentsContractApi19
{
  ...
  public static boolean exists(Context paramContext, Uri paramUri)
  {
    ...
    //   52: istore_3
    //   53: aload_1
    //   54: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   57: iload_3
    //   58: ireturn
    //   59: astore_1
    //   60: goto +58 -> 118
    ...
    //   70: dup
    //   71: invokespecial 89	java/lang/StringBuilder:<init>	()V
    //   74: astore 5
    //   76: aload 4
    //   78: astore_0
    //   79: aload 5
    ...
    //   90: aload 5
    //   92: aload_1
    //   93: invokevirtual 98	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   96: pop
    //   97: aload 4
    //   99: astore_0
    //   100: ldc 14
    ...
    //   107: invokestatic 108	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   110: pop
    //   111: aload 4
    //   113: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   116: iconst_0
    //   117: ireturn
    //   118: aload_0
    //   119: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   122: aload_1
    //   123: athrow
  ...
  private static long queryForLong(Context paramContext, Uri paramUri, String paramString, long paramLong)
  {
    ...
    //   70: lstore 5
    //   72: aload_1
    //   73: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   76: lload 5
    //   78: lreturn
    //   79: aload_1
    //   80: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   83: lload_3
    //   84: lreturn
    //   85: astore_1
    //   86: goto +54 -> 140
    ...
    //   96: dup
    //   97: invokespecial 89	java/lang/StringBuilder:<init>	()V
    //   100: astore_2
    //   101: aload 7
    //   103: astore_0
    //   104: aload_2
    ...
    //   132: pop
    //   133: aload 7
    //   135: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   138: lload_3
    //   139: lreturn
    //   140: aload_0
    //   141: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   144: aload_1
    //   145: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  private static String queryForString(Context paramContext, Uri paramUri, String paramString1, @Nullable String paramString2)
  {
    ...
    //   70: astore_2
    //   71: aload_1
    //   72: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   75: aload_2
    //   76: areturn
    //   77: aload_1
    //   78: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   81: aload_3
    //   82: areturn
    //   83: astore_1
    //   84: goto +54 -> 138
    ...
    //   130: pop
    //   131: aload 4
    //   133: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   136: aload_3
    //   137: areturn
    //   138: aload_0
    //   139: invokestatic 86	androidx/documentfile/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   142: aload_1
    //   143: athrow
    // Local variable table:
    //   start	length	slot	name	signature
