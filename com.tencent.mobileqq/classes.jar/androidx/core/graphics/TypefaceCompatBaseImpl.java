...
class TypefaceCompatBaseImpl
{
  ...
  public Typeface createFromFontInfo(Context paramContext, @Nullable android.os.CancellationSignal paramCancellationSignal, @androidx.annotation.NonNull FontsContractCompat.FontInfo[] paramArrayOfFontInfo, int paramInt)
  {
    ...
    //   9: aload_3
    //   10: iload 4
    //   12: invokevirtual 152	androidx/core/graphics/TypefaceCompatBaseImpl:findBestInfo	([Landroidx/core/provider/FontsContractCompat$FontInfo;I)Landroidx/core/provider/FontsContractCompat$FontInfo;
    //   15: astore_2
    //   16: aload_1
    //   17: invokevirtual 158	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   20: aload_2
    //   21: invokevirtual 164	androidx/core/provider/FontsContractCompat$FontInfo:getUri	()Landroid/net/Uri;
    //   24: invokevirtual 170	android/content/ContentResolver:openInputStream	(Landroid/net/Uri;)Ljava/io/InputStream;
    //   27: astore_2
    //   28: aload_0
    //   29: aload_1
    //   30: aload_2
    //   31: invokevirtual 174	androidx/core/graphics/TypefaceCompatBaseImpl:createFromInputStream	(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    //   34: astore_1
    //   35: aload_2
    //   36: invokestatic 180	androidx/core/graphics/TypefaceCompatUtil:closeQuietly	(Ljava/io/Closeable;)V
    //   39: aload_1
    //   40: areturn
    //   41: astore_1
    //   42: aconst_null
    //   43: astore_2
    //   44: aload_2
    //   45: invokestatic 180	androidx/core/graphics/TypefaceCompatUtil:closeQuietly	(Ljava/io/Closeable;)V
    //   48: aconst_null
    //   49: areturn
    //   50: astore_1
    //   51: aconst_null
    //   52: astore_2
    //   53: aload_2
    //   54: invokestatic 180	androidx/core/graphics/TypefaceCompatUtil:closeQuietly	(Ljava/io/Closeable;)V
    //   57: aload_1
    //   58: athrow
    //   59: astore_1
    //   60: goto -7 -> 53
