...
class ViewCompat$UnhandledKeyEventManager
{
  ...
  {
    UnhandledKeyEventManager localUnhandledKeyEventManager2 = (UnhandledKeyEventManager)paramView.getTag(2131378438);
    ...
    if (localUnhandledKeyEventManager2 == null)
    {
      ...
      paramView.setTag(2131378438, localUnhandledKeyEventManager1);
    }
  ...
  {
    ArrayList localArrayList = (ArrayList)paramView.getTag(2131378439);
