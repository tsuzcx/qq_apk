...
{
  private static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = { 2131361823, 2131361824, 2131361835, 2131361846, 2131361849, 2131361850, 2131361851, 2131361852, 2131361853, 2131361854, 2131361825, 2131361826, 2131361827, 2131361828, 2131361829, 2131361830, 2131361831, 2131361832, 2131361833, 2131361834, 2131361836, 2131361837, 2131361838, 2131361839, 2131361840, 2131361841, 2131361842, 2131361843, 2131361844, 2131361845, 2131361847, 2131361848 };
  ...
  {
    return new ViewCompat.5(2131378237, Boolean.class, 28);
  }
  ...
  public static void addOnUnhandledKeyEventListener(@NonNull View paramView, @NonNull ViewCompat.OnUnhandledKeyEventListenerCompat paramOnUnhandledKeyEventListenerCompat)
  {
    ...
    {
      localObject2 = (SimpleArrayMap)paramView.getTag(2131378282);
      localObject1 = localObject2;
      if (localObject2 == null)
      {
        localObject1 = new SimpleArrayMap();
        paramView.setTag(2131378282, localObject1);
      }
    ...
    {
      return;
      localObject2 = (ArrayList)paramView.getTag(2131378282);
      localObject1 = localObject2;
      if (localObject2 == null)
      {
  ...
  {
    ArrayList localArrayList2 = (ArrayList)paramView.getTag(2131378235);
    ArrayList localArrayList1 = localArrayList2;
    if (localArrayList2 == null)
    {
      localArrayList1 = new ArrayList();
      paramView.setTag(2131378235, localArrayList1);
    }
  ...
  {
    return new ViewCompat.4(2131378238, CharSequence.class, 8, 28);
  }
  ...
  public static void removeOnUnhandledKeyEventListener(@NonNull View paramView, @NonNull ViewCompat.OnUnhandledKeyEventListenerCompat paramOnUnhandledKeyEventListenerCompat)
  {
    ...
    if (Build.VERSION.SDK_INT >= 28)
    {
      localObject = (SimpleArrayMap)paramView.getTag(2131378282);
      if (localObject != null) {}
    }
    do
    {
      do
      {
        ...
        return;
        localObject = (ArrayList)paramView.getTag(2131378282);
  ...
  {
    return new ViewCompat.3(2131378272, Boolean.class, 28);
  }
