...
public class bifp
{
  ...
  private static bifo a(Cursor paramCursor)
  {
    bifo localbifo = new bifo();
    localbifo.jdField_a_of_type_Long = paramCursor.getLong(0);
    localbifo.jdField_a_of_type_JavaLangString = paramCursor.getString(1);
    localbifo.jdField_b_of_type_JavaLangString = paramCursor.getString(2);
    localbifo.jdField_c_of_type_JavaLangString = paramCursor.getString(3);
    localbifo.jdField_d_of_type_JavaLangString = paramCursor.getString(4);
    localbifo.jdField_e_of_type_JavaLangString = paramCursor.getString(5);
    localbifo.jdField_b_of_type_Long = paramCursor.getLong(6);
    localbifo.f = paramCursor.getString(7);
    localbifo.jdField_c_of_type_Long = paramCursor.getLong(8);
    localbifo.g = paramCursor.getString(9);
    localbifo.jdField_a_of_type_Int = paramCursor.getInt(10);
    localbifo.jdField_b_of_type_Int = paramCursor.getInt(11);
    localbifo.h = paramCursor.getString(12);
    localbifo.jdField_d_of_type_Long = paramCursor.getLong(13);
    localbifo.jdField_e_of_type_Long = paramCursor.getLong(14);
    localbifo.i = paramCursor.getString(15);
    localbifo.j = paramCursor.getString(16);
    localbifo.k = paramCursor.getString(17);
    localbifo.l = paramCursor.getString(18);
    return localbifo;
  }
  
  /* Error */
  public static java.util.ArrayList<bifo> a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_1
    ...
    //   53: aload_3
    //   54: ldc 36
    //   56: getstatic 145	bifq:a	[Ljava/lang/String;
    //   59: aload 4
    ...
    //   93: aload_2
    //   94: aload_0
    //   95: invokestatic 161	bifp:a	(Landroid/database/Cursor;)Lbifo;
