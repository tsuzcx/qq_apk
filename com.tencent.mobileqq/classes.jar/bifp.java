  ...
  implements DialogInterface.OnDismissListener
{
  ...
  private static bift jdField_a_of_type_Bift;
  ...
  private BusinessObserver jdField_a_of_type_MqqObserverBusinessObserver = new bifr(this);
  ...
  private JSONObject a(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        callJs(str, new String[] { localJSONObject.toString() });
        paramString = localJSONObject;
      } while (this.jdField_a_of_type_Bjbs == null);
      this.jdField_a_of_type_Bjbs.dismiss();
  ...
  private void a(String paramString)
  {
    Object localObject1;
    Object localObject2;
    if (jdField_a_of_type_Bift == null)
    {
      localObject1 = new bift(null);
      ...
      jdField_a_of_type_Bift = (bift)localObject1;
    ...
    try
    {
      ...
      try
      {
        ...
        return;
        label180:
        bifs localbifs = new bifs(this);
        ((SensorManager)localObject1).registerListener(localbifs, (Sensor)localObject2, 3, 0);
        ((SensorManager)localObject1).flush(localbifs);
        localObject1 = new NewIntent(this.mRuntime.a().getApplication(), bigj.class);
    ...
    do
    {
      do
      {
        ...
        if ((l1 > 0L) && (((JSONObject)localObject1).toString().getBytes().length > l1))
        {
          ...
          paramString2.put("businessRet", 0);
          paramString2.put("msg", anzj.a(2131704347));
          super.callJs(paramString1, new String[] { paramString2.toString() });
          return;
        }
        if (this.jdField_c_of_type_JavaUtilHashMap.containsKey("yundong_report.steps"))
        {
          ...
          if ((l1 > 0L) && (System.currentTimeMillis() - l2 < l1))
          {
            ...
            paramString2.put("businessRet", 0);
            paramString2.put("msg", anzj.a(2131704346));
            super.callJs(paramString1, new String[] { paramString2.toString() });
        ...
        localObject2 = String.valueOf(bigb.a());
      ...
      ((JSONObject)localObject1).put("version", "8.4.5");
      ...
      if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
        this.jdField_b_of_type_JavaLangString = bjve.c();
      }
      ((JSONObject)localObject1).put("imei", String.valueOf(this.jdField_b_of_type_JavaLangString));
      ((JSONObject)localObject1).put("adcode", apch.b());
      if (QLog.isColorLevel()) {
      ...
      localObject1 = new bifq(this);
    } while (this.mRuntime == null);
    Object localObject2 = new NewIntent(this.mRuntime.a().getApplicationContext(), awjk.class);
  ...
  private JSONObject b(String paramString)
  {
    ...
    //   12: lstore_3
    //   13: aload_0
    //   14: getfield 109	bifp:mRuntime	Lbioy;
    //   17: ifnull +1113 -> 1130
    //   20: aload_0
    //   21: getfield 282	bifp:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   24: ifnull +1106 -> 1130
    //   27: iconst_0
    //   28: istore 5
    ...
    //   153: astore_1
    //   154: aload_0
    //   155: getfield 215	bifp:jdField_a_of_type_Bjbs	Lbjbs;
    //   158: ifnull +975 -> 1133
    //   161: aload 7
    //   163: astore_1
    //   164: aload_0
    //   165: getfield 215	bifp:jdField_a_of_type_Bjbs	Lbjbs;
    //   168: invokevirtual 634	bjbs:isShowing	()Z
    //   171: ifeq +962 -> 1133
    //   174: aload 7
    //   176: astore_1
    //   177: aload_0
    //   178: getfield 215	bifp:jdField_a_of_type_Bjbs	Lbjbs;
    //   181: invokevirtual 220	bjbs:dismiss	()V
    //   184: goto +949 -> 1133
    //   187: aload 7
    //   189: astore_1
    ...
    //   270: ldc_w 322
    //   273: ldc_w 642
    //   276: invokestatic 409	anzj:a	(I)Ljava/lang/String;
    ...
    //   331: aastore
    //   332: invokevirtual 213	bifp:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   335: aload 9
    //   337: areturn
    //   338: astore_1
    ...
    //   529: astore_1
    //   530: aload_0
    //   531: getfield 282	bifp:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   534: aload 12
    //   536: bipush 21
    //   538: invokestatic 685	auxu:a	(Landroid/app/Activity;Landroid/content/Intent;I)V
    //   541: goto -354 -> 187
    //   544: astore 8
    //   546: aload 7
    //   548: astore_1
    ...
    //   676: ldc_w 705
    //   679: ldc_w 706
    //   682: invokestatic 409	anzj:a	(I)Ljava/lang/String;
    ...
    //   754: astore_1
    //   755: aload_0
    //   756: getfield 109	bifp:mRuntime	Lbioy;
    //   759: invokevirtual 337	bioy:a	()Lcom/tencent/common/app/AppInterface;
    //   762: aload_0
    //   763: getfield 109	bifp:mRuntime	Lbioy;
    //   766: invokevirtual 177	bioy:a	()Landroid/app/Activity;
    //   769: aload 8
    //   771: aload_0
    //   772: invokestatic 717	bmud:a	(Lcom/tencent/common/app/AppInterface;Landroid/content/Context;Landroid/os/Bundle;Landroid/content/DialogInterface$OnDismissListener;)V
    //   775: goto -588 -> 187
    //   778: astore 8
    //   780: aload_1
    //   781: astore 7
    ...
    //   829: astore_1
    //   830: aload_0
    //   831: getfield 109	bifp:mRuntime	Lbioy;
    //   834: invokevirtual 114	bioy:a	()Lcom/tencent/biz/pubaccount/CustomWebView;
    //   837: new 729	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$4
    //   840: dup
    //   841: aload_0
    //   842: invokespecial 730	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$4:<init>	(Lbifp;)V
    ...
    //   883: astore_1
    //   884: aload_0
    //   885: getfield 109	bifp:mRuntime	Lbioy;
    //   888: invokevirtual 114	bioy:a	()Lcom/tencent/biz/pubaccount/CustomWebView;
    //   891: new 736	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$5
    //   894: dup
    //   895: aload_0
    //   896: invokespecial 737	com/tencent/mobileqq/vashealth/HealthStepCounterPlugin$5:<init>	(Lbifp;)V
    ...
    //   920: getstatic 742	antf:bg	Ljava/lang/String;
    ...
    //   955: aload 8
    //   957: aload 12
    //   959: invokestatic 264	bhmq:a	(Landroid/graphics/Bitmap;Ljava/io/File;)V
    //   962: aload 7
    //   964: astore_1
    ...
    //   993: astore_1
    //   994: aload_0
    //   995: getfield 109	bifp:mRuntime	Lbioy;
    //   998: invokevirtual 177	bioy:a	()Landroid/app/Activity;
    ...
    //   1037: getstatic 742	antf:bg	Ljava/lang/String;
    ...
    //   1062: ldc_w 322
    //   1065: ldc_w 764
    //   1068: invokestatic 409	anzj:a	(I)Ljava/lang/String;
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      if ((Build.VERSION.SDK_INT < 19) || (paramJsBridgeListener.getDefaultSensor(19) == null))
      {
        ...
        paramString1.put("msg", anzj.a(2131704352));
        super.callJs(paramJsBridgeListener, new String[] { paramString1.toString() });
      }
      else
      {
        paramJsBridgeListener = new NewIntent(this.mRuntime.a().getApplication(), bigj.class);
    ...
    if (paramString3.equals("healthSwitch"))
    {
      ...
      if ((!TextUtils.isEmpty(paramJsBridgeListener)) && (Integer.parseInt(paramJsBridgeListener) == 0))
      {
        ...
        paramJsBridgeListener.put("msg", anzj.a(2131704348));
      ...
      paramString2 = new NewIntent(this.jdField_a_of_type_AndroidAppActivity, bigj.class);
      ...
      paramJsBridgeListener.put("msg", anzj.a(2131704349));
      super.callJs(paramString1, new String[] { paramJsBridgeListener.toString() });
      i = 1;
    }
    for (;;)
    {
      if (i == 0)
      {
        ...
        paramJsBridgeListener.put("msg", anzj.a(2131704355));
        super.callJs(paramString1, new String[] { paramJsBridgeListener.toString() });
        break label1169;
        if (paramString3.equals("shareSnapshot"))
        {
          if (this.jdField_a_of_type_Bjbs == null)
          {
            ...
            this.jdField_a_of_type_Bjbs = paramJsBridgeListener;
          }
          if (this.jdField_a_of_type_Bjbs != null)
          {
        ...
        {
          paramJsBridgeListener = new JSONObject(paramVarArgs[0]).getString("callback");
          paramString1 = new NewIntent(this.mRuntime.a().getApplication(), bigj.class);
  ...
  public void onDestroy()
  {
    ...
    if (jdField_a_of_type_Bift != null)
    {
      ((SensorManager)this.jdField_a_of_type_AndroidAppActivity.getSystemService("sensor")).unregisterListener(jdField_a_of_type_Bift);
      jdField_a_of_type_Bift = null;
    }
  }
