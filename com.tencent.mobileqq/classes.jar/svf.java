  ...
  extends svb
{
  ...
  public svf(@NonNull String[] paramArrayOfString)
  {
    super(paramArrayOfString);
    paramArrayOfString = (tcs)tcz.a(10);
  ...
  protected void a(String[] paramArrayOfString, svc paramsvc)
  {
    ...
    for (;;)
    {
      ...
      while (j < k)
      {
        localArrayList.add(new svg(this, arrayOfFile[j]));
        j += 1;
      }
      ...
      while (j < n)
      {
        ...
        catch (InterruptedException localInterruptedException)
        {
          ...
          a(((svg)localArrayList.get(j)).a);
          k += 1;
          j += 1;
        }
      }
      paramsvc.jdField_b_of_type_Double = (d - a(localFile) + paramsvc.jdField_b_of_type_Double);
      paramsvc.jdField_b_of_type_Int += k;
    }
  }
