...
{
  public afet(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (int i = 0;; i = 1)
    {
      bdla.b(this.a.app, "dc00899", "Grp_mber", "", "mber_list", "del_inacmem", 0, 0, this.a.b, "" + i, "1", TroopMemberListActivity.a(this.a).toString());
      this.a.finish();
