  ...
  extends QIPCModule
{
  ...
  public static ajaz a()
  {
    if (jdField_a_of_type_Ajaz == null) {}
    try
    {
      if (jdField_a_of_type_Ajaz == null) {
        jdField_a_of_type_Ajaz = new ajaz();
      }
      return jdField_a_of_type_Ajaz;
    }
    finally {}
  }
  ...
  private EIPCResult a(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 9: 
      ...
      paramQQAppInterface = (amga)paramQQAppInterface.getManager(85);
    ...
    case 11: 
      ...
      paramQQAppInterface = (aeoj)paramQQAppInterface.getManager(321);
    ...
    case 13: 
      ...
      if ((paramQQAppInterface != null) && (paramBundle != null))
      {
        paramQQAppInterface.a().b(alof.ad, 9002, paramBundle.msg_id.hashCode());
        paramQQAppInterface.D();
      }
      return null;
    case 0: 
      paramQQAppInterface = bdgc.b(paramQQAppInterface, paramBundle.getString("uin"), true);
      paramBundle = new Bundle();
    ...
    case 7: 
      ...
      EmojiGifHelper.getInstance().compositeAndTransToGifInner(paramQQAppInterface, new ajbe(this, paramInt));
      return null;
    case 8: 
    ...
    case 14: 
      ...
      int i = paramBundle.getInt("call_type", azms.a);
      if (i == azms.b)
      {
        paramBundle = new Bundle();
        paramBundle.putSerializable("res", aznc.a().a(paramQQAppInterface, null, i));
        return EIPCResult.createSuccessResult(paramBundle);
      }
      aznc.a().a(paramQQAppInterface, new ajbf(this, paramInt), i);
      return null;
    case 1: 
    ...
    case 16: 
      ...
      {
        paramBundle = (aixw)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    ...
    case 15: 
      localObject = paramBundle.getString("key");
      paramInt = paramBundle.getInt("code");
      paramBundle = new ajbg(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
      paramQQAppInterface = (aixs)paramQQAppInterface.getManager(245);
      if (paramQQAppInterface != null)
      {
        if ((this.jdField_a_of_type_JavaUtilMap != null) && (!this.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramInt)))) {
    ...
    paramBundle = new ajbh(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
  ...
  private void a(Bundle paramBundle, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    Object localObject1;
    if (((i != 5) && ((i & 0x10) == 0)) || ((((alto)localObject2).b(str)) && (!paramQQAppInterface.getCurrentAccountUin().equals(str)))) {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(paramBundle)) {
        localObject1 = bdgc.b(paramQQAppInterface, str, true);
      }
      for (;;)
      {
        ...
        localObject1 = bdgc.b(paramQQAppInterface, str, true);
        continue;
        paramBundle = bdgc.q(paramQQAppInterface, str);
        localObject1 = paramBundle;
        if (TextUtils.isEmpty(paramBundle)) {
          localObject1 = str;
        }
  ...
  private void a(AppRuntime paramAppRuntime, Bundle paramBundle)
  {
    if ((paramAppRuntime != null) && (paramBundle != null))
    {
      ...
      if (paramBundle != null)
      {
        paramAppRuntime = (aixs)((QQAppInterface)paramAppRuntime).getManager(245);
  ...
  private EIPCResult b(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 1: 
      ...
      ((PreloadManager)paramQQAppInterface.getManager(151)).a(paramBundle, new ajbj(this, paramInt));
      return null;
    case 2: 
      ...
      {
        paramBundle = new ajbi(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
    ...
    ((PreloadManager)paramQQAppInterface.getManager(151)).a(paramBundle, new ajba(this, paramInt));
    return null;
  }
  ...
  public EIPCResult a(Bundle paramBundle, int paramInt)
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        localObject = new ajbb(this, (Bundle)localObject, localResultReceiver);
        if (paramInt == 1) {
      ...
      else
      {
        ...
        else
        {
          if ("getConditionSearchManager".equals(paramString))
          {
            ...
            paramBundle = (alpy)((QQAppInterface)localObject).getManager(59);
            ...
            if (paramInt != 0)
            {
              ...
              if (i == 0) {
                paramBundle.c(new ajbd(this, (Bundle)localObject, i, paramString, paramBundle));
              }
