...
{
  public aazm(ARGridMapViewDialog paramARGridMapViewDialog) {}
      ...
      if ((this.a.a instanceof ARGridMapViewDialog.LbsRedBagExtraData))
      {
        ...
        if (localLbsRedBagExtraData.a == l)
        {
          ...
          if (localArrayList.size() > 0)
          {
            ...
            ThreadManager.getUIHandler().post(new aazn(this, paramBundle, localLbsRedBagExtraData, localArrayList, i, j));
          }
        }
      }
    }
