  ...
  extends ImageBase
{
  ...
  public pjy(VafContext paramVafContext)
  {
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_Puy.a.a() == null) || (this.jdField_a_of_type_Puy.a.a().mSocialFeedInfo == null) || (this.jdField_a_of_type_Puy.a.a().mSocialFeedInfo.a == null))
    {
    ...
    int j = localResources.getDisplayMetrics().widthPixels - actj.a(24.0F, localResources);
    int k = (int)(j * 0.598F);
    float f1 = localResources.getDisplayMetrics().density;
    int i;
    float f2;
    ViewGroup.LayoutParams localLayoutParams;
    if (this.jdField_a_of_type_Puy.a.a().mSocialFeedInfo.a.a.size() > 0)
    {
      i = ((qdb)this.jdField_a_of_type_Puy.a.a().mSocialFeedInfo.a.a.get(0)).a;
      int m = ((qdb)this.jdField_a_of_type_Puy.a.a().mSocialFeedInfo.a.a.get(0)).b;
      f2 = actj.a(i / 2, localResources);
      f1 = actj.a(m / 2, localResources);
      i = ((qdb)this.jdField_a_of_type_Puy.a.a().mSocialFeedInfo.a.a.get(0)).c;
    ...
    for (;;)
    {
      if (i == 1)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131718595);
      }
      ...
      if ((f2 < j) && (f1 > k))
      {
        ...
        {
          f1 = k;
          f2 = actj.a(150.0F, localResources);
          this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131718596);
        }
        else
        {
          f2 *= k / f1;
      ...
      else if ((f2 > j) && (f1 < k))
      {
        ...
        {
          f2 = j;
          f1 = actj.a(150.0F, localResources);
          this.jdField_a_of_type_AndroidWidgetTextView.setText(2131718597);
          this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        }
        else
        {
