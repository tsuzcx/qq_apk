...
public class abgx
  extends BaseAdapter
{
  public abgx(CardPicGalleryActivity paramCardPicGalleryActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.a.getLayoutInflater().inflate(2130970241, null);
      paramViewGroup = new abgy();
      paramViewGroup.a = ((URLImageView)paramView.findViewById(2131369792));
    ...
    else
    {
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (abgy)paramView.getTag();
        break;
