  ...
  extends bame
{
  ...
  public static URLDrawable a(boolean paramBoolean1, String paramString1, URLDrawable.URLDrawableOptions paramURLDrawableOptions, String paramString2, boolean paramBoolean2)
  {
    ...
    if (!paramBoolean1) {}
    for (String str = alef.k + "boxcard/" + paramString1;; str = paramString1)
    {
      ...
      if (localURLDrawableOptions.mExtraInfo == null) {
        localURLDrawableOptions.mExtraInfo = new akzf();
      }
      paramBoolean1 = paramBoolean2;
      if ((localURLDrawableOptions.mExtraInfo instanceof akzf))
      {
        paramURLDrawableOptions = (akzf)localURLDrawableOptions.mExtraInfo;
  ...
  public static boolean a(String paramString)
  {
    ...
    {
      return false;
      String str = alef.k + paramString.substring(paramString.lastIndexOf("/") + 1);
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    if ((paramDownloadParams.mExtraInfo != null) && ((paramDownloadParams.mExtraInfo instanceof akzf)))
    {
      paramOutputStream = (akzf)paramDownloadParams.mExtraInfo;
      ...
      do
      {
        ...
        if ((BaseApplicationImpl.sApplication != null) && (!bdee.g(BaseApplicationImpl.sApplication)) && (paramURLDrawableHandler != null)) {
          paramURLDrawableHandler.onFileDownloadFailed(0);
        }
        bdvv localbdvv = new bdvv(paramOutputStream, paramDownloadParams);
        localbdvv.b = 1;
        localbdvv.p = false;
        localbdvv.q = true;
        localbdvv.r = true;
        i = bdvx.a(localbdvv, null);
        if (i != 0) {
          break;
        }
        if (paramURLDrawableHandler != null) {
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    akzf localakzf;
    if ((paramFile != null) && (paramDownloadParams.mExtraInfo != null) && ((paramDownloadParams.mExtraInfo instanceof akzf)))
    {
      localakzf = (akzf)paramDownloadParams.mExtraInfo;
      if (localakzf.jdField_a_of_type_Int != jdField_a_of_type_Int) {
        break label102;
      }
    }
    for (;;)
    {
      try
      {
        ...
        localBitmap = bdda.a(localBitmap, localBitmap.getWidth(), localBitmap.getHeight());
      ...
      } while (localakzf.jdField_a_of_type_Int != b);
      if (paramFile.exists())
      {
        ...
        paramURLDrawableHandler.inSampleSize = bdda.a(paramURLDrawableHandler, paramDownloadParams.reqWidth, paramDownloadParams.reqHeight);
        ...
        try
        {
          ...
          if (paramFile != null) {
            if (localakzf.jdField_a_of_type_Boolean)
            {
              i = 2130849365;
              paramDownloadParams = bdda.a(paramFile, i, paramDownloadParams.reqWidth, paramDownloadParams.reqHeight, true);
