...
public class akze
  extends amww
{
  public akze(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity) {}
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    if (this.a.jdField_a_of_type_Bhht != null)
    {
      ...
      this.a.jdField_a_of_type_Bhht = null;
    }
    ...
    while (j != this.a.jdField_a_of_type_Int)
    {
      ...
      if ((i == 2) || (i == 1))
      {
        ...
        ((Intent)localObject).putExtra("uinname", ContactUtils.getAccountNickName(this.a.app, this.a.app.getCurrentAccountUin()) + amtj.a(2131701757));
        ((Intent)localObject).putExtra("isBack2Root", true);
        this.a.startActivity((Intent)localObject);
        bcef.b(this.a.app, "dc00899", "Grp_create", "", "f2f", "cre_suc", 0, 0, paramObject, "", "", "");
        return;
      }
      CreateFaceToFaceDiscussionActivity.a(this.a, 1, this.a.getString(2131692034));
      return;
    }
    CreateFaceToFaceDiscussionActivity.b(this.a, 1, this.a.getString(2131692034));
  }
    ...
    for (;;)
    {
      ...
      default: 
        if (this.a.jdField_a_of_type_JavaUtilList == null)
        {
          ...
          if (this.a.jdField_a_of_type_Akzg != null)
          {
            this.a.jdField_a_of_type_Akzg.notifyDataSetChanged();
      ...
      for (;;)
      {
        ...
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(this.a.getString(2131718070));
        this.a.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(this.a.getString(2131718070));
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(this.a.getString(2131718071));
        this.a.jdField_b_of_type_AndroidWidgetTextView.setContentDescription(this.a.getString(2131718071));
        this.a.jdField_a_of_type_AndroidWidgetButton.setTextColor(this.a.getResources().getColor(2131167045));
        this.a.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839326);
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(amtj.a(2131701756));
        this.a.jdField_a_of_type_AndroidWidgetButton.setContentDescription(amtj.a(2131701756));
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131718074));
        break;
        this.a.jdField_b_of_type_Boolean = false;
        this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131718076, new Object[] { localObject }));
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(this.a.getString(2131718072));
        this.a.jdField_a_of_type_AndroidWidgetButton.setTextColor(-1);
        this.a.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.a.getString(2131718072));
        this.a.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839326);
        break;
        this.a.jdField_b_of_type_Boolean = true;
        this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131718075, new Object[] { localObject }));
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(this.a.getString(2131718073));
        this.a.jdField_a_of_type_AndroidWidgetButton.setTextColor(-1);
        this.a.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.a.getString(2131718073));
        this.a.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839326);
        break;
        ...
        if (!this.a.jdField_c_of_type_Boolean)
        {
          QQToast.a(this.a.jdField_a_of_type_AndroidContentContext, amtj.a(2131701754), 1).a();
          if (this.a.jdField_a_of_type_AndroidOsHandler.hasMessages(1)) {
            this.a.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
          }
          this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(1, 600L);
