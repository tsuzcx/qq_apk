  ...
  implements aamn
{
  ...
  public aags(Bundle paramBundle)
  {
    super(paramBundle);
  }
  ...
  protected BaseWidgetView a(ViewGroup paramViewGroup, aabp paramaabp)
  {
    if ((getParentFragment() instanceof SubscribeMultiPicFragment))
    {
      ...
      paramaabp = new LinearLayout.LayoutParams(-1, ImmersiveUtils.a(29.0F));
      paramaabp.leftMargin = ImmersiveUtils.a(9.0F);
      paramaabp.rightMargin = ImmersiveUtils.a(15.0F);
      paramaabp.gravity = 16;
      this.jdField_a_of_type_ComTencentBizSubscribeWidgetSubscribeFollowInfoView.setLayoutParams(paramaabp);
    ...
    if (this.jdField_a_of_type_Aamx != null) {
      this.jdField_a_of_type_Aamx.a(this.jdField_a_of_type_ComTencentBizSubscribeWidgetRelativevideoRelativeMultiPicHeadItemView.a());
    }
  ...
  public void d(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    do
    {
      ...
      if (aaej.b(paramStFeed.type.get()))
      {
  ...
  public void handleBlockChange(aabp paramaabp, int paramInt)
  {
    if ((paramaabp.getUniqueKey() != null) && ("RELATIVE_ADAPTER_UNIQUE_KEY".equals(paramaabp.getUniqueKey()))) {
      ((aagu)paramaabp).a(new aagt(this));
    }
  }
