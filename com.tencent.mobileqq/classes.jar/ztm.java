  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                  for (;;)
                  {
                    ...
                    if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_DeviceAdminUnbind"))
                    {
                      ...
                      if (ztk.a(this.a).contains(paramContext) != true)
                      {
                        this.a.app.a().a(paramContext.toString(), 9501);
                        return;
                      }
                      if (paramContext.longValue() != 0L) {
                        ztk.b(this.a).add(paramContext);
                      }
                    }
                    else if (paramIntent.getAction().equalsIgnoreCase("tencent.av.v2q.StopVideoChat"))
                    {
                      ...
                      for (l1 = Long.parseLong(paramIntent.getStringExtra("peerUin"));; l1 = 0L)
                      {
                        ...
                        if ((i != 0) || (paramContext != null) || (paramIntent.longValue() == 0L) || (!ztk.b(this.a).contains(paramIntent))) {
                          break;
                        }
                        this.a.app.a().a(paramIntent.toString(), 9501);
                        ztk.b(this.a).remove(paramIntent);
                        return;
                      }
                      if (paramIntent.longValue() != 0L) {
                        ztk.a(this.a).remove(paramIntent);
                      }
                    }
                    else if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_receiveDPMsg"))
                    {
                      ...
                      if (localObject1 == null)
                      {
                        ...
                        QLog.d(ztk.jdField_a_of_type_JavaLangString, 2, "dp is null in DeviceMsgHandler::onreceive");
                        return;
                      }
                      paramIntent = ((zpa)this.a.app.a(51)).a(((DataPoint)localObject1).mDin);
                      i = 0;
                      if (paramIntent != null) {
                      ...
                      if ((11015 == ((DataPoint)localObject1).mProperityId) || (((DataPoint)localObject1).mProperityId == 11008) || (((DataPoint)localObject1).mProperityId == 11012)) {
                        if (QLog.isColorLevel()) {
                          QLog.d(ztk.jdField_a_of_type_JavaLangString, 2, "device info pid is 0; dp.mDin = " + ((DataPoint)localObject1).mDin);
                        }
                      }
                      for (;;)
                      {
                        ...
                        {
                          this.a.jdField_a_of_type_Zte.a((DataPoint)localObject1);
                          if (ztk.a(this.a, ((DataPoint)localObject1).mValue)) {
                            break;
                          }
                          ztk.a(this.a);
                          return;
                        ...
                        for (;;)
                        {
                          try
                          {
                            ...
                            if (paramContext.optInt("flag") == 0)
                            {
                              ...
                              QLog.d(ztk.jdField_a_of_type_JavaLangString, 2, "PID_MSG_PROXY JSON :" + ((DataPoint)localObject1).mValue);
                              return;
                            }
                          }
                      ...
                      {
                        this.a.jdField_a_of_type_Zqi.a((DataPoint)localObject1);
                        aabm.a(this.a.app, ((DataPoint)localObject1).mDin, "Usr_AIO_ReceiveMsg", 2, 0, i);
                        if (ztk.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        ztk.a(this.a);
                      ...
                      if (10007 == ((DataPoint)localObject1).mProperityId)
                      {
                        for (;;)
                        {
                          ...
                          catch (Exception paramIntent)
                          {
                            try
                            {
                              ...
                              {
                                paramContext = new JSONObject(((DataPoint)localObject1).mValue);
                                paramContext.optLong("msg_time", ayvc.a());
                                paramContext = paramContext.optString("text", " ");
                                this.a.a(String.valueOf(((DataPoint)localObject1).mDin), paramContext, ayvc.a(), true, false, true);
                                return;
                              }
                              catch (Exception paramContext) {}
                              if (!QLog.isColorLevel()) {
                              ...
                              QLog.d(ztk.jdField_a_of_type_JavaLangString, 2, "onRecvRawTextMsg parse from json error:" + paramContext.getMessage());
                              return;
                            }
                            catch (Exception paramIntent)
                            {
                        ...
                        aabm.a(this.a.app, ((DataPoint)localObject1).mDin, "Usr_AIO_ReceiveMsg", 1, 0, i);
                        if (ztk.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        ztk.a(this.a);
                      ...
                      {
                        this.a.jdField_a_of_type_Ztj.a((DataPoint)localObject1);
                        if (ztk.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        ztk.a(this.a);
                      ...
                      if (10009 == ((DataPoint)localObject1).mProperityId)
                      {
                        try
                        {
                          ...
                          localObject4 = (MessageForDevLittleVideo)ayvw.a(-4509);
                          ...
                          ((MessageForDevLittleVideo)localObject4).time = ayvc.a();
                          ((MessageForDevLittleVideo)localObject4).msg = (bdbt.b(this.a.app, ((MessageForDevLittleVideo)localObject4).senderuin, true) + alpo.a(2131703559));
                        ...
                        QLog.d(ztk.jdField_a_of_type_JavaLangString, 2, "getString from json error:" + paramContext.getMessage());
                        return;
                      }
                      if (((DataPoint)localObject1).mProperityId == 10008)
                      {
                        try
                        {
                          ...
                          l1 = paramIntent.optLong("msg_time", ayvc.a());
                          paramIntent = paramIntent.optString("text", " ");
                          l2 = ((DataPoint)localObject1).mDin;
                          ztk.a(this.a, l2, paramContext, paramIntent, l1, true);
                          if (ztk.a(this.a, ((DataPoint)localObject1).mValue)) {
                            continue;
                          }
                          ztk.a(this.a);
                    ...
                    try
                    {
                      if (!DeviceTipActivity.a)
                      {
                        ...
                        l2 = ((JSONObject)localObject2).optLong("appear_time", ayvc.a());
                        ...
                        if (QLog.isColorLevel())
                        {
                          QLog.d(ztk.jdField_a_of_type_JavaLangString, 2, "ReceiveDoorTip appear_time= " + l2 + " : serverTime = " + ayvc.a() + " loginTimeStr= " + (String)localObject2);
                          i = (int)(ayvc.a() - l2);
                          QQToast.a(this.a.app.getApp(), alpo.a(2131703556) + i + alpo.a(2131703558), 1).a();
                        }
                        if (l1 - l2 > 1L)
                        {
                          if (QLog.isColorLevel()) {
                            QQToast.a(this.a.app.getApp(), "该消息是手Q登录前" + (l1 - l2) + alpo.a(2131703567), 1).a();
                          }
                          this.a.a(paramContext, alpo.a(2131703561), l2, "");
                          return;
                        }
                        if (ayvc.a() - l2 <= 30L)
                        {
                    ...
                    if (((DataPoint)localObject1).mProperityId == 1600006)
                    {
                      try
                      {
                        ...
                        l1 = paramContext.optLong("msg_time", ayvc.a());
                    ...
                    if (((DataPoint)localObject1).mProperityId == 10004)
                    {
                      try
                      {
                        ...
                        l1 = paramIntent.optLong("msg_time", ayvc.a());
                        ztk.a(this.a, paramContext, Long.toString(((DataPoint)localObject1).mDin), (String)localObject2, (String)localObject3, (String)localObject4, str1, str2, l1);
                        if (ztk.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        ztk.a(this.a);
                    ...
                    else if (((DataPoint)localObject1).mProperityId == 11010)
                    {
                      try
                      {
                        ...
                        paramContext = ayvw.a(this.a.app, ((SessionInfo)localObject5).jdField_a_of_type_JavaLangString, ((SessionInfo)localObject5).b, ((SessionInfo)localObject5).jdField_a_of_type_Int, paramContext);
                    ...
                    else if ((((DataPoint)localObject1).mProperityId == 11008) || (((DataPoint)localObject1).mProperityId == 11012))
                    {
                      ...
                      {
                        paramContext = new JSONObject(((DataPoint)localObject1).mValue);
                        aabn.a(this.a.app, paramContext, String.valueOf(((DataPoint)localObject1).mDin));
                        if (ztk.a(this.a, ((DataPoint)localObject1).mValue)) {
                          continue;
                        }
                        ztk.a(this.a);
                      ...
                      if (QLog.isColorLevel()) {
                        QLog.d(ztk.jdField_a_of_type_JavaLangString, 2, "auth_request_structmsg:" + paramContext.getMessage());
                      }
                    }
                    else if (((DataPoint)localObject1).mProperityId == 700154)
                    {
                      try
                      {
                        ...
                        if (QLog.isColorLevel()) {
                          QLog.d(ztk.jdField_a_of_type_JavaLangString, 2, "openav roomId:" + i + ",sessionId:" + paramContext + ", cTime: " + j + ", cmd:" + k);
                        }
                        if (k != 1) {
                          continue;
                        }
                      ...
                      if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_sendCCDataPointMsgResult"))
                      {
                        ...
                        if (bool)
                        {
                          ztk.a(this.a, String.valueOf(l1), i);
                          return;
                        }
                        ztk.b(this.a, String.valueOf(l1), i);
                        return;
                      }
                      ...
                      else
                      {
                        if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_OnMiniFileTransferComplete"))
                        {
                          ...
                          if ((l1 != 0L) && (this.a.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Long.valueOf(l1))))
                          {
                            ...
                            paramIntent = aljq.aX + "/smart_device/" + paramIntent.getName();
                            bdcs.b((String)localObject1, paramIntent);
                            ...
                            paramContext.srcFileName = arni.a(paramIntent);
                            paramContext.fileSize = arni.a(paramIntent);
                            paramContext.msg = (bdbt.b(this.a.app, paramContext.senderuin, true) + ": " + this.a.app.getApp().getString(2131691650));
                            paramContext.serial();
                            this.a.app.a().a(paramContext.frienduin, paramContext.istroop, paramContext.uniseq, paramContext.msgData);
                        ...
                        if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_DeviceVasFlagChange"))
                        {
                          ...
                          if (paramIntent != null)
                          {
                            ...
                            localObject1 = (zpa)this.a.app.a(51);
                            localObject2 = ((zpa)localObject1).a(l1);
                            paramIntent = "";
                            ...
                            {
                              paramIntent = this.a.app.getApp().getString(2131695078).split(":")[0];
                              paramContext = paramIntent;
                              if (((DeviceInfo)localObject2).isAdmin != 1)
                              {
                                ((zpa)localObject1).a(((DeviceInfo)localObject2).productId, ((DeviceInfo)localObject2).serialNum);
                                paramContext = paramIntent;
                              }
                            }
                            ...
                            {
                              agkk.X = true;
                              paramContext = paramContext + this.a.app.getApp().getString(2131691622);
                              this.a.a(l1 + "", paramContext, ayvc.a(), true, false, 1);
                              return;
                            }
                            if ((i == 0) && (((DeviceInfo)localObject2).isAdmin != 1))
                            {
                              agkk.X = false;
                              paramContext = paramContext + this.a.app.getApp().getString(2131691621);
                              this.a.a(l1 + "", paramContext, ayvc.a(), true, false, true);
                            }
                          }
                        }
                        else if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_QueryIsDeviceBinded"))
                        {
                          ...
                          if (paramIntent != null)
                          {
                            ...
                            localObject1 = bdbt.b(this.a.app, l1 + "", true);
                        ...
                        else
                        {
                          ...
                          paramContext = (zpa)this.a.app.a(51);
                          ...
                          if (paramIntent != null)
                          {
                            ...
                            if (localObject1 != null)
                            {
                              ...
                              for (paramContext = alpo.a(2131703569); !TextUtils.isEmpty(paramContext); paramContext = alpo.a(2131703566) + ((ProductInfo)localObject1).deviceName)
                              {
                                localObject1 = bdbt.b(this.a.app, Long.toString(((Long)localObject3).longValue()), true);
                                paramIntent = (Intent)localObject1;
                                if (TextUtils.isEmpty((CharSequence)localObject1)) {
                                  paramIntent = String.valueOf(localObject3);
                                }
                                paramContext = paramIntent + paramContext;
                                this.a.a(localObject2 + "", paramContext, ayvc.a(), true, false, true);
                                return;
                ...
                paramContext = alpo.a(2131703557);
          ...
          } while ((localObject1 != null) && (((zpa)localObject1).a(l1, 13)));
          if (apwu.a().a(this.a.app, paramContext) != 0) {
            this.a.a(l1 + "", "【重要！设备安全提醒】\n\n为防止QQ号被盗/丢失手机，导致设备被人恶意控制\n请点这里开启QQ设备锁\n\n\n查看QQ设备锁介绍", ayvc.a(), "device_lock_msg");
          }
          localObject2 = ((zpa)localObject1).a(l1);
          paramIntent = "";
          if (localObject2 != null) {
        ...
        } while ((localObject2 == null) || (((DeviceInfo)localObject2).isAdmin == 1) || (!((zpa)localObject1).a(l1).booleanValue()));
        paramContext = paramContext + this.a.app.getApp().getString(2131691622);
        this.a.a(l1 + "", paramContext, ayvc.a(), true, false, 1);
        return;
        ...
        if (QLog.isColorLevel()) {
          QLog.d(ztk.jdField_a_of_type_JavaLangString, 2, "DeviceMsghandle intent.getExtras() : " + paramIntent.getExtras());
        }
        paramContext = paramIntent.getExtras();
      ...
      localObject1 = bdbt.b(this.a.app, paramContext, true);
      if ((TextUtils.isEmpty((CharSequence)localObject1)) || (paramContext.equals(localObject1))) {}
      for (paramContext = alpo.a(2131703576);; paramContext = (String)localObject1 + alpo.a(2131703565))
      {
        this.a.a(String.valueOf(paramIntent), paramContext, ayvc.a(), "");
        ztk.a(this.a);
        return;
      }
      if ("SmartDevice_sendToAIO_Capture".equals(paramIntent.getAction()))
      {
        ...
        try
        {
          ...
          ((JSONObject)localObject2).put("msg_time", ayvc.a());
          ((JSONObject)localObject2).put("guidewords", alpo.a(2131703563));
          ((JSONObject)localObject2).put("appear_time", ayvc.a());
          ((JSONObject)localObject2).put("digest", alpo.a(2131703572));
          ((JSONObject)localObject2).put("title", alpo.a(2131703575));
          paramIntent = (MessageForDeviceSingleStruct)ayvw.a(-4502);
          ...
          paramIntent.strMediaFileName = arni.a((String)localObject1);
    ...
    try
    {
      ...
      ((JSONObject)localObject3).put("msg_time", ayvc.a());
      ((JSONObject)localObject3).put("guidewords", alpo.a(2131703574));
      ((JSONObject)localObject3).put("appear_time", ayvc.a());
      ...
      localObject2 = (MessageForDeviceSingleStruct)ayvw.a(-4502);
      ...
      ((MessageForDeviceSingleStruct)localObject2).strMediaFileName = arni.a(paramIntent);
      ((MessageForDeviceSingleStruct)localObject2).nMediaFileSize = bdcs.a(paramIntent);
