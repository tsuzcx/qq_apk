...
{
  public asdw(NearbyJsInterface paramNearbyJsInterface, String paramString, int paramInt) {}
    ...
    try
    {
      ...
      if (paramBundle != null)
      {
        ...
        if (paramBundle.optInt("retcode") == 0)
        {
          ...
          localObject = baig.d(this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyJsInterface.a, this.jdField_a_of_type_JavaLangString);
