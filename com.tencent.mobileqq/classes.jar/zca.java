...
public class zca
{
  ...
  public zca(zbx paramzbx, CustomWebView paramCustomWebView)
  {
  ...
  {
    paramString = begt.g(paramString);
    begt.a("catchHtml");
    WebSoService.WebSoState.WebSo3 localWebSo3 = zbx.a(this.jdField_a_of_type_Zbx).a();
    if (localWebSo3 != null)
    {
      WebSoService.a(paramString, localWebSo3.jdField_a_of_type_JavaLangString, localWebSo3.b, Uri.parse(localWebSo3.d));
      return;
    }
    begt.a("return webSo3 == null");
  }
