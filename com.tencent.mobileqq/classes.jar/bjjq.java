...
public class bjjq
  implements bjgw, QQSpecialAVFilter.MusicWaveformSupporter
{
  private int jdField_a_of_type_Int;
  private bjkn jdField_a_of_type_Bjkn;
  private MusicItemInfo jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo;
  private QQFilterRenderManager jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = bhey.a();
  ...
  public bjjq(List<FilterDesc> paramList, MusicItemInfo paramMusicItemInfo, int paramInt1, int paramInt2, PublishVideoEntry paramPublishVideoEntry)
  {
    if (paramList != null)
    {
  ...
  private void b()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo != null)
    {
      this.jdField_a_of_type_Bjkn = new bjkn();
      if (!bjkp.a()) {
        break label44;
      }
      this.d = true;
    ...
    for (;;)
    {
      ...
      bjjr localbjjr = new bjjr(this);
      try
      {
        long l = SystemClock.elapsedRealtimeNanos();
        boolean bool = this.jdField_a_of_type_Bjkn.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo, localbjjr, 0);
        if (QLog.isColorLevel()) {
          QLog.d("QQEncodeFilterRender", 2, "createSoundFile time: " + (SystemClock.elapsedRealtimeNanos() - l) / 1000000L + "ms");
        }
        if (!bool)
        {
          this.jdField_a_of_type_Bjkn = null;
          if (QLog.isColorLevel())
          {
  ...
  public float getCurrentMusicGain()
  {
    try
    {
      if (this.jdField_a_of_type_Bjkn != null)
      {
        if (this.d) {
          return 0.5F;
        }
        float f = this.jdField_a_of_type_Bjkn.a(this.jdField_a_of_type_Int);
        return f;
      }
    }
    catch (Exception localException)
