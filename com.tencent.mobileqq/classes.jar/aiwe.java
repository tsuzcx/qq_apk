  ...
  implements BusinessObserver
{
  ...
  private final List<aiwd> jdField_a_of_type_JavaUtilList;
  private JSONObject jdField_a_of_type_OrgJsonJSONObject;
  private boolean jdField_a_of_type_Boolean;
  private final String jdField_b_of_type_JavaLangString;
  private boolean jdField_b_of_type_Boolean;
  
  public aiwe(aiwf paramaiwf, String paramString1, String paramString2)
  {
  ...
  public JSONObject a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (i == 1001)
    {
      ...
      localJSONObject.put("businessRet", 0);
      localJSONObject.put("msg", ajjy.a(2131634792));
    }
    for (;;)
    {
      localJSONObject.put("ssoRet", 202);
      localJSONObject.put("businessRet", 0);
      localJSONObject.put("msg", ajjy.a(2131634789));
      label473:
      do
      {
        localJSONObject.put("ssoRet", 255);
        localJSONObject.put("businessRet", 0);
        localJSONObject.put("msg", ajjy.a(2131634793));
  ...
  public void a()
  {
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      while (localIterator.hasNext()) {
        ((aiwd)localIterator.next()).a(this, this.jdField_a_of_type_Aiwf);
      }
  ...
  {
    if (paramaiwd != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramaiwd);
    }
  }
  ...
  public void a(Context paramContext, String paramString, JSONObject paramJSONObject, AppInterface paramAppInterface)
  {
    ...
    if ((paramJSONObject.optInt("needCookie") == 1) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("apollo_client_ApolloWebDataHandler", 2, "Get cookie:" + mpw.c((String)localObject, new String[0]) + " from " + mpw.b(paramString, new String[0]));
      }
    }
    ...
    paramContext = new NewIntent(paramContext, aquf.class);
    ...
    {
      paramContext = this.jdField_a_of_type_Aiwf;
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    try
    {
      ...
      a();
      if (this.jdField_a_of_type_Aiwf != null) {
        this.jdField_a_of_type_Aiwf.b = System.currentTimeMillis();
      }
      return;
    }
    catch (Exception paramBundle)
