...
public final class bgvt
{
  ...
  public static void a(Activity paramActivity)
  {
    ...
    if (DeviceProfileManager.a(paramActivity, arrayOfInteger, new ajvg()) >= arrayOfInteger.length)
    {
  ...
  public static void a(Context paramContext)
  {
    ...
    localBusinessTask.a(new bgvu(paramContext), true);
    localBusinessTask.a();
  }
