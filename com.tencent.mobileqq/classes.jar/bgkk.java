...
public class bgkk
{
  private static bgkk jdField_a_of_type_Bgkk;
  ...
  private bgkk(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    a();
  }
  
  public static final bgkk a(Context paramContext)
  {
    if (jdField_a_of_type_Bgkk == null) {}
    try
    {
      if (jdField_a_of_type_Bgkk == null) {
        jdField_a_of_type_Bgkk = new bgkk(paramContext);
      }
      return jdField_a_of_type_Bgkk;
    }
    finally {}
  }
  ...
  void b()
  {
    ...
    //   9: dup
    //   10: aload_0
    //   11: getfield 36	bgkk:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   150: aload_0
    //   151: getfield 34	bgkk:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   154: aload_3
    //   155: aload 4
