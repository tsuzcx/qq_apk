...
{
  private bgod jdField_a_of_type_Bgod = new bgkl(this);
  ...
  public bgkk()
  {
    try
    {
      this.jdField_a_of_type_Bgog = ((bgog)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(47));
      return;
    }
    catch (Throwable localThrowable)
    {
      localThrowable.printStackTrace();
      this.jdField_a_of_type_Bgog = new bgog(BaseApplicationImpl.getApplication().getRuntime());
    }
  }
  
  private bgoe a(@NonNull DownloadInfoParams paramDownloadInfoParams)
  {
    bgoe localbgoe = new bgoe(paramDownloadInfoParams.mUrl, new File(paramDownloadInfoParams.mSavePath));
    localbgoe.f = "vas_update_system";
    localbgoe.e = true;
    localbgoe.p = true;
    localbgoe.r = true;
    localbgoe.q = true;
    ...
    localbgoe.n = false;
    localbgoe.s = false;
    localbgoe.a = paramDownloadInfoParams.mItemId;
    return localbgoe;
  }
  
  private bgoj a()
  {
    return this.jdField_a_of_type_Bgog.a(4);
  }
  ...
  private void a(DownloadInfoParams paramDownloadInfoParams, IDownloadListener paramIDownloadListener)
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      localObject = (PreDownloadController)localQQAppInterface.getManager(193);
  ...
  private void a(String paramString, long paramLong)
  {
    ...
    {
      ((PreDownloadController)((QQAppInterface)localAppRuntime).getManager(193)).preDownloadSuccess(paramString, paramLong);
      return;
    }
  ...
  public void startDownload(DownloadInfoParams paramDownloadInfoParams, IDownloadListener paramIDownloadListener, Bundle paramBundle)
  {
    ...
    a().a(a(paramDownloadInfoParams), this.jdField_a_of_type_Bgod, paramIDownloadListener);
  }
}
