...
public class baue
  extends andq
{
  public baue(UniteSearchActivity paramUniteSearchActivity) {}
  
  private void a(bazz parambazz)
  {
    if (parambazz == null) {
      return;
    }
    ...
    for (;;)
    {
      ...
      String str = bbds.a(i, parambazz.c(), parambazz.g, bool);
      if (QLog.isColorLevel()) {
  ...
  private void a(List<bays> paramList)
  {
    if (paramList != null)
    {
      ...
      {
        paramList = (bays)localIterator1.next();
        if ((paramList != null) && (paramList.a() != null) && (paramList.a().equals(VSConfigManager.SUBSCRIBE_ACCOUNT_TITLE_DEFVALUE)))
        {
          ...
          if (paramList != null)
          {
            ...
            {
              paramList = (bayt)localIterator2.next();
              if ((paramList != null) && ((paramList instanceof bazc)))
              {
                paramList = (bazc)paramList;
            ...
            {
              bcef.b(localQQAppInterface, "dc00898", "", paramList, "auth_search", "exp", 0, 0, "", "", "", "");
              break label76;
              break;
            }
          }
  ...
  private void b(bazz parambazz)
  {
    ...
    if (parambazz.c())
    {
      bbda.a(this.a.app, this.a.jdField_a_of_type_Int, this.a.jdField_c_of_type_Int, "0X8009D2C", i, 0, parambazz.g);
      return;
    }
    bbda.a(this.a.app, this.a.jdField_a_of_type_Int, this.a.jdField_c_of_type_Int, "0X8009D40", i, 0, parambazz.g);
  }
  
  private void b(List<bays> paramList)
  {
    if (paramList == null) {
      label4:
      return;
    ...
    for (;;)
    {
      ...
      Object localObject1 = (bays)paramList.next();
      if ((((bays)localObject1).a() == null) || (((bays)localObject1).a().size() == 0)) {
        break;
      }
      Object localObject2 = ((bays)localObject1).a().iterator();
      while (((Iterator)localObject2).hasNext())
      {
        bayt localbayt = (bayt)((Iterator)localObject2).next();
        if ((localbayt instanceof bayu)) {
          ((bayu)localbayt).b(this.a.jdField_a_of_type_Int);
        }
      }
      if (!(localObject1 instanceof baym)) {
        break;
      }
      localObject1 = ((bays)localObject1).a().iterator();
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (bayt)((Iterator)localObject1).next();
        if ((localObject2 instanceof bazz))
        {
          int i = ((bazz)localObject2).f();
          if (!bbdw.a().a(i))
          {
  ...
  public void a(String paramString, int paramInt, List<AssociateSearchWordsFragment.AssociateItem> paramList, List<UnifySearchAssociationWord.SuggestUrlItem> paramList1, UnifySearchAssociationWord.SuggestUrlItem paramSuggestUrlItem)
  {
    if (paramString.equals(this.a.f))
    {
      ...
      bbda.a(null, new ReportModelDC02528().module("all_result").action("exp_thinkword_list").ver1(this.a.a()).ver2(bbda.a(this.a.jdField_c_of_type_Int)).ver4(localStringBuilder.toString()).ver7("{experiment_id:" + bbda.b + "}"));
    }
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (!paramBoolean1)
        {
          ...
          paramString2 = batb.a(paramList1, paramBoolean1);
      ...
      {
        if ((paramList.size() > 0) && ((((bayn)paramList.get(0)).jdField_a_of_type_JavaLangString.equals(amtj.a(2131714915))) || ((((bayn)paramList.get(0)).jdField_a_of_type_JavaUtilList != null) && (((bayn)paramList.get(0)).jdField_a_of_type_JavaUtilList.size() == 0)))) {
          paramList.remove(0);
        }
        this.a.jdField_c_of_type_AndroidViewView.setVisibility(0);
        this.a.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
