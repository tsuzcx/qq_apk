...
{
  apwa(RockDownloaderTask paramRockDownloaderTask) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (1 == paramInt)
    {
      ...
      if (localObject == null)
      {
        ...
        {
          this.a.getRockDownloadListener().onDownloadFail(this.a.getDownloadInfo(), anni.a(2131712263), 10003);
          this.a.getRockDownloadListener().onDownloadFinish(this.a.getDownloadInfo());
        }
        apvz.a(this.a, "0x800A1E6");
      }
    }
    else
    {
