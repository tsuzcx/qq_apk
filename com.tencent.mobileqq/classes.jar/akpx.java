...
public class akpx
{
  ...
  public akpx(Context paramContext, LinearLayout paramLinearLayout, int paramInt, boolean paramBoolean, AnimationView.MyAnimationListener paramMyAnimationListener)
  {
  ...
  public akpx(AnimationView paramAnimationView, int paramInt, boolean paramBoolean, AnimationView.MyAnimationListener paramMyAnimationListener)
  {
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    akpz localakpz = new akpz(this, null);
    if (paramBoolean) {}
    for (String str = "0";; str = "1")
    {
      localakpz.execute(new String[] { paramString, str });
      return;
    }
  }
}
