...
public class mbi
{
  ...
  {
    bcef.b(null, "dc00898", "", "", "0X8006F88", "0X8006F88", 0, 0, "", "", "", "");
  }
  ...
  static void a(int paramInt1, int paramInt2, long paramLong, String paramString, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        bcef.b(null, "dc00898", "", "", (String)localObject, (String)localObject, paramInt2, 0, str2, "", str3, paramString);
      }
      if (!TextUtils.isEmpty(str1)) {
        bcef.b(null, "dc00898", "", "", str1, str1, paramInt2, 0, str2, "", str3, paramString);
      }
      return;
      str1 = "0X8007F37";
      localObject = str1;
  ...
  public static void a(int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(str)) {
        bcef.b(null, "dc00898", "", "", str, str, 0, 0, "", "", String.valueOf(paramLong), "");
      }
      return;
      str = "0X8007F2B";
      continue;
  ...
  static void a(long paramLong, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return;
      if (!((llf)localObject).a()) {
        localObject = "0X80077C0";
      } else if (!((llf)localObject).b) {
  ...
  public static void a(String paramString, boolean paramBoolean, long paramLong)
  {
    ...
    for (int i = 1;; i = -1)
    {
      bcef.b(null, "dc00898", "", "", paramString, paramString, 0, i, "", "", String.valueOf(paramLong), "");
      return;
    }
  }
  ...
  static void b()
  {
    bcef.b(null, "dc00898", "", "", "0X8006F8F", "0X8006F8F", 0, 0, "", "", "", "");
  }
