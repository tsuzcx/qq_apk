...
public class augc
  extends alpd
{
  public augc(QQAppInterface paramQQAppInterface)
  {
      ...
      try
      {
        ...
        if (paramOIDBSSOPkg.get_decrypt_key_rsp.has())
        {
          ...
          if (((oidb_cmd0xcde.GetDecryptKeyRsp)localObject).dncrypt_key.has())
          {
            ...
            augo.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, localObject);
    ...
    try
    {
      ...
      if (paramOIDBSSOPkg.query_state_rsp.has())
      {
        ...
        if (paramOIDBSSOPkg.state.has())
        {
          ...
          ((auhj)localObject).a(i);
          if (i == 2)
          {
            if (paramOIDBSSOPkg.token.has()) {
              ((auhj)localObject).a(paramOIDBSSOPkg.token.get().toStringUtf8());
            }
            if (paramOIDBSSOPkg.encrypt_key.has()) {
              ((auhj)localObject).b(paramOIDBSSOPkg.encrypt_key.get().toStringUtf8());
            }
            if (paramOIDBSSOPkg.user_data.has()) {
              ((auhj)localObject).a(a((oidb_cmd0xcdd.UserData)paramOIDBSSOPkg.user_data.get()));
            }
            if (paramOIDBSSOPkg.biz_type.has()) {
              ((auhj)localObject).b(paramOIDBSSOPkg.biz_type.get());
            }
          }
        }
        notifyUI(4, true, ((auhj)localObject).a());
        return;
      }
    }
    catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
      ...
      try
      {
        ...
        if (paramOIDBSSOPkg.get_encrypt_key_rsp.has())
        {
          ...
          if (paramOIDBSSOPkg.file_meta.has())
          {
            ...
            augo.jdField_a_of_type_JavaLangString = paramOIDBSSOPkg;
            if (QLog.isDevelopLevel()) {
  ...
  private void e(oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    if ((i == 0) && (paramOIDBSSOPkg.bytes_bodybuffer.has()) && (paramOIDBSSOPkg.bytes_bodybuffer.get() != null))
    {
      ...
      try
      {
        ...
        {
          localObject = new augz();
          paramOIDBSSOPkg = (oidb_cmd0xcdd.ConfirmQrRsp)paramOIDBSSOPkg.confirm_qr_rsp.get();
          if (paramOIDBSSOPkg.token.has()) {
            ((augz)localObject).a(paramOIDBSSOPkg.token.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.encrypt_key.has()) {
            ((augz)localObject).b(paramOIDBSSOPkg.encrypt_key.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.user_data.has()) {
            ((augz)localObject).a(a((oidb_cmd0xcdd.UserData)paramOIDBSSOPkg.user_data.get()));
          }
          if (paramOIDBSSOPkg.biz_type.has()) {
            ((augz)localObject).a(paramOIDBSSOPkg.biz_type.get());
          }
          paramOIDBSSOPkg = ((augz)localObject).a();
          if (QLog.isColorLevel()) {
  ...
  private void f(oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    if ((i == 0) && (paramOIDBSSOPkg.bytes_bodybuffer.has()) && (paramOIDBSSOPkg.bytes_bodybuffer.get() != null))
    {
      ...
      try
      {
        ...
        {
          localObject = new auhd();
          paramOIDBSSOPkg = (oidb_cmd0xcdd.GetQrRsp)paramOIDBSSOPkg.get_qr_rsp.get();
          if (paramOIDBSSOPkg.qr_sig.has()) {
            ((auhd)localObject).a(paramOIDBSSOPkg.qr_sig.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.token.has()) {
            ((auhd)localObject).b(paramOIDBSSOPkg.token.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.encrypt_key.has()) {
            ((auhd)localObject).c(paramOIDBSSOPkg.encrypt_key.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.user_data.has()) {
            ((auhd)localObject).a(a((oidb_cmd0xcdd.UserData)paramOIDBSSOPkg.user_data.get()));
          }
          if (paramOIDBSSOPkg.biz_type.has()) {
            ((auhd)localObject).a(paramOIDBSSOPkg.biz_type.get());
          }
          paramOIDBSSOPkg = ((auhd)localObject).a();
          if (QLog.isColorLevel()) {
            QLog.d("MsgBackup.MsgBackupAuthHandler", 2, "processGetQrRsp getQrResponse= " + paramOIDBSSOPkg);
          }
          aujo.a();
  ...
  public MsgBackupUserData a(oidb_cmd0xcdd.UserData paramUserData)
  {
    ...
    if (paramUserData.ip.has()) {
      localauhn.a(paramUserData.ip.get().toStringUtf8());
    }
    if (paramUserData.port.has()) {
      localauhn.a(paramUserData.port.get());
    }
    if (paramUserData.ssid.has()) {
      localauhn.b(paramUserData.ssid.get().toStringUtf8());
    }
    if (paramUserData.bssid.has()) {
      localauhn.c(paramUserData.bssid.get().toStringUtf8());
    }
    return localauhn.a();
  }
