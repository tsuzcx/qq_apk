...
public class acov
  extends acnp
{
  public acov(OnlineFileSessionWorker paramOnlineFileSessionWorker)
  {
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Acnp = new acnu(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker);
  ...
  protected void c()
  {
    ...
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.jdField_a_of_type_Long + "] state change :(" + this.jdField_a_of_type_Acnp.a() + "->StateWaitResultWhenPause)");
    this.jdField_a_of_type_Acnp = new acou(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker);
  }
  ...
  protected void f()
  {
    ...
    QLog.i("OnlineFileSessionWorker<FileAssistant>", 1, "OLfilesession[" + this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreOnlineFileSessionWorker.jdField_a_of_type_Long + "] state change :(" + this.jdField_a_of_type_Acnp.a() + ". doSomeThingOnUploadDone start recv offline file....)");
