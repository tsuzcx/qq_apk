  ...
  implements agvc, View.OnClickListener
{
  ...
  private Html.ImageGetter jdField_a_of_type_AndroidTextHtml$ImageGetter = new agul(this);
  private Html.TagHandler jdField_a_of_type_AndroidTextHtml$TagHandler = new agun(this);
  public View a;
  ...
  private blrd jdField_a_of_type_Blrd = new agum(this);
  ...
  public aguk(BaseChatPie paramBaseChatPie)
  {
  ...
  private MixedMsgInfo.MsgNode a(String paramString, MixedMsgInfo.TextLocation paramTextLocation)
  {
    ...
    if (paramTextLocation == MixedMsgInfo.TextLocation.HEADER) {
      str = behh.a(paramString, true);
    }
    paramString = str;
    if (paramTextLocation == MixedMsgInfo.TextLocation.TAILOR) {
      paramString = behh.a(str, false);
    }
  ...
  private boolean a(int paramInt)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694334, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getDimensionPixelSize(2131299011));
      return true;
    }
    return false;
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        localLayoutParams.bottomMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299130);
    ...
    localLayoutParams.bottomMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299127);
    this.jdField_b_of_type_AndroidWidgetImageButton.setLayoutParams(localLayoutParams);
  }
  ...
  private boolean d()
  {
    return (((bemp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(74)).a()) && (arkn.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
  }
  ...
  private void e()
  {
    ...
    bdll.b(localQQAppInterface, "dc00898", "", "", "0X800AD27", "0X800AD27", b(), 0, "", "", "", "");
    c(true);
    agej.k = true;
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.m();
    anfz.a(localQQAppInterface, "full_screen_input", true);
    agej.l = true;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Bfpy != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Bfpy.k();
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Bfpy.g();
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Bfpy.d = true;
    }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Ascw != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Ascw.c();
    }
    ((ascj)localQQAppInterface.getManager(214)).c(false);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.setPadding(agej.a(24.0F, localQQAppInterface.getApplication().getResources()), agej.a(10.0F, localQQAppInterface.getApplication().getResources()), agej.a(24.0F, localQQAppInterface.getApplication().getResources()), 0);
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131363988);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getText(2131719376));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130850012);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(-2, -2);
    localLayoutParams.rightMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299129);
    localLayoutParams.bottomMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299128);
    localLayoutParams.gravity = 85;
    this.jdField_a_of_type_AndroidWidgetTextView.setLayoutParams(localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    if (AppSetting.c) {
      this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(anzj.a(2131689494));
    }
  ...
  private void j()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.setOnWindowFocusChangedListener(null);
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.b(this.jdField_a_of_type_Blrd);
    }
    axex.a(null);
    axex.a(null);
  }
  ...
  Drawable a(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      paramString = ThumbnailUtils.extractThumbnail(avis.a(paramString, localOptions, 1, 4), j, i, 2);
  ...
  {
    return begz.b.newEditable(paramCharSequence);
  }
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new agus(this);
  ...
  {
    this.jdField_a_of_type_AndroidViewView = paramViewGroup.findViewById(2131367316);
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)paramViewGroup.findViewById(2131367313));
    this.jdField_b_of_type_AndroidWidgetImageButton = ((ImageButton)paramViewGroup.findViewById(2131368033));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramViewGroup.findViewById(2131367329));
    this.jdField_a_of_type_ComTencentWidgetPatchedButton = ((PatchedButton)paramViewGroup.findViewById(2131367314));
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentWidgetPatchedButton.setOnClickListener(this);
    if (AppSetting.c)
    {
      this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(anzj.a(2131703859));
      this.jdField_b_of_type_AndroidWidgetImageButton.setContentDescription(anzj.a(2131703856));
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.setFilters(new InputFilter[] { new aguo(this) });
    paramViewGroup = new agup(this);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.a(this.jdField_a_of_type_Blrd);
    jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.setOnDragListener(new aguq(this));
    ...
    paramViewGroup = axex.a(paramViewGroup[0], ImageSpan.class);
    axex.a(this);
    axex.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.setOnWindowFocusChangedListener(new agur(this));
  }
  ...
  public void a(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      this.jdField_a_of_type_Agut = new agut(paramCharSequence, paramInt1, paramInt2, paramInt3);
      if (QLog.isColorLevel()) {
        QLog.d("FullScreenInputHelper", 2, "[mix] handleBeforeTextChange mTextChangeInfo: " + this.jdField_a_of_type_Agut);
      }
    }
  }
  ...
  public void a(List<String> paramList, boolean paramBoolean)
  {
    ...
    jdField_b_of_type_Boolean = true;
    axey.a("0X800AE19", paramList.size());
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.C()) {
        anfz.a(localQQAppInterface, "full_screen_input", false);
      }
    }
    agej.l = false;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Bfpy != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Bfpy.d = false;
    }
    ((ascj)localQQAppInterface.getManager(214)).c(true);
    ...
    if (paramBoolean)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout.setPadding(0, agej.a(8.0F, localQQAppInterface.getApplication().getResources()), 0, 0);
      ...
      ((FrameLayout.LayoutParams)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.getLayoutParams()).setMargins(agej.a(14.0F, localQQAppInterface.getApplication().getResources()), 0, 0, 0);
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.setPadding(agej.a(11.0F, localQQAppInterface.getApplication().getResources()), agej.a(6.0F, localQQAppInterface.getApplication().getResources()), agej.a(11.0F, localQQAppInterface.getApplication().getResources()), agej.a(6.0F, localQQAppInterface.getApplication().getResources()));
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout.setPadding(0, agej.a(8.0F, localQQAppInterface.getApplication().getResources()), 0, 0);
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.getLayoutParams().height = -2;
  ...
  public boolean a(Editable paramEditable)
  {
    ...
    for (;;)
    {
      b(bool);
      if (jdField_b_of_type_Boolean) {
        this.jdField_a_of_type_Agut.a(paramEditable);
      }
      try
      {
        this.jdField_a_of_type_Agut.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx);
        if (this.c) {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.getLineCount() > 3) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.h()) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.C()) && (!bdgb.b())) {
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      bdll.b(localQQAppInterface, "dc00898", "", "", "0X8009F36", "0X8009F36", b(), 0, "", "", "", "");
      a(false);
      continue;
      bdll.b(localQQAppInterface, "dc00898", "", "", "0X8009F27", "0X8009F27", b(), 0, "", "", "", "");
      e();
      continue;
      bdll.b(localQQAppInterface, "dc00898", "", "", "0X800AD28", "0X800AD28", b(), 0, "", "", "", "");
      if (a() > 0) {}
      for (int i = a();; i = 21)
      {
        axey.a("0X800AE1A", i);
      ...
      ((bemp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(74)).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.getText().toString(), 2);
    }
  }
}
