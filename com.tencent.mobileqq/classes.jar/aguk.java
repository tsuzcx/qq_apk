  ...
  extends agsl
{
  ...
  private aguk(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  public static agse b(NewPhotoListActivity paramNewPhotoListActivity)
  {
    ...
    {
      if ((jdField_a_of_type_Agse == null) || (jdField_a_of_type_Agse.jdField_a_of_type_MqqUtilWeakReference.get() != paramNewPhotoListActivity)) {
        jdField_a_of_type_Agse = new aguk(paramNewPhotoListActivity);
      }
  ...
  protected void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    PhotoUtils.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), paramInt1, paramInt2, paramIntent, this.jdField_a_of_type_Agsd.s, this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaLangString);
  }
  ...
  protected void a(LocalMediaInfo paramLocalMediaInfo, int paramInt)
  {
    ...
    localIntent.putExtra("ALBUM_NAME", this.jdField_a_of_type_Agsb.jdField_b_of_type_JavaLangString);
    localIntent.putExtra("ALBUM_ID", this.jdField_a_of_type_Agsb.jdField_c_of_type_JavaLangString);
    ...
    {
      localIntent.putStringArrayListExtra("PhotoConst.PHOTO_PATHS", this.jdField_a_of_type_Agsb.jdField_c_of_type_JavaUtilArrayList);
      localIntent.putExtra("PhotoConst.CURRENT_SELECTED_INDEX", paramInt);
    }
    if (this.jdField_a_of_type_Agsd.q)
    {
      ...
      PhotoUtils.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), localIntent, this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilArrayList, 0, this.jdField_a_of_type_Agsd.l);
      return;
    }
    if (!this.jdField_a_of_type_Agsd.r)
    {
      ...
      localIntent.putExtra("PasterConstants.pasters_data", this.jdField_a_of_type_Agsd.jdField_c_of_type_JavaUtilHashMap);
    ...
    for (;;)
    {
      ...
      if ((100 == paramInt) || (102 == paramInt) || (103 == paramInt)) {
        if (100 == paramInt)
        {
          int i = bazo.b((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get());
          ...
          localIntent.putExtra("PhotoConst.EDIT_MASK_SHAPE_TYPE", agqs.c(paramInt));
      ...
      for (;;)
      {
        bbbj.a(localIntent, this.jdField_a_of_type_Agsb.jdField_c_of_type_JavaLangString, str, this.jdField_a_of_type_Agsd.jdField_d_of_type_Boolean);
  ...
  public void b(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if ((paramView.fileSize > this.jdField_a_of_type_Agsb.jdField_b_of_type_Long) && (!this.jdField_a_of_type_Boolean))
    {
    ...
    Object localObject1 = bbbj.jdField_c_of_type_JavaUtilHashMap;
    Object localObject2;
    if (!((HashMap)localObject1).containsKey(paramView.path))
    {
      localObject2 = new Pair(this.jdField_a_of_type_Agsb.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Agsb.jdField_b_of_type_JavaLangString);
    ...
    if (!this.jdField_a_of_type_Agsd.m)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        agmi.a(BaseApplicationImpl.getContext()).a(new agul(this, paramAdapterView, (ArrayList)localObject1), paramView);
        return;
      }
      PhotoUtils.a((Activity)this.jdField_a_of_type_MqqUtilWeakReference.get(), paramAdapterView, (ArrayList)localObject1, 2, false);
      return;
    }
    if (!this.jdField_a_of_type_Agsd.jdField_c_of_type_Boolean)
    {
      ...
      localObject1 = ((NewPhotoListActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Agru.a(paramInt);
      ...
      paramView.putExtra("PasterConstants.paster_cate_id", this.jdField_a_of_type_Agsd.jdField_d_of_type_JavaLangString);
      agsd.a = ((NewPhotoListActivity)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentWidgetGestureSelectGridView.getFirstVisiblePosition();
      localObject2 = this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilHashMap;
    ...
    ((Intent)localObject1).putExtra("uin", this.jdField_a_of_type_Agsd.f);
    ((Intent)localObject1).putExtra("uintype", this.jdField_a_of_type_Agsd.jdField_h_of_type_Int);
    ...
    if (this.jdField_a_of_type_Agsd.jdField_h_of_type_Boolean)
    {
      ...
      ((Intent)localObject1).putExtra("PhotoConst.PHOTO_PATHS", this.jdField_a_of_type_Agsb.jdField_a_of_type_JavaUtilArrayList);
    }
