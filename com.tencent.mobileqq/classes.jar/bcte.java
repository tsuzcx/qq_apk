  ...
  implements bctu
{
  public static boolean a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, long paramLong1, long paramLong2, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      localaohe = (aohe)paramQQAppInterface.getManager(QQManagerFactory.MGR_ACTVATE_FRIENDS);
      if (j != 1) {
        break label556;
      }
      ...
      ((MessageForActivateFriends)localObject2).msg = aohe.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
      ...
      break label853;
      bdla.b(paramQQAppInterface, "CliOper", "", "", (String)localObject1, (String)localObject2, localaohe.a, 0, "", "", "", "");
    ...
    if (QLog.isColorLevel())
    {
      ...
      if (j == 2)
      {
        ...
        if (((List)localObject2).size() > 0)
        {
          ...
          localMessageForActivateFriends.msg = aohe.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
          label622:
      ...
      else
      {
        ...
        if (((List)localObject2).size() > 0)
        {
          ...
          localMessageForActivateFriends.msgData = ((SubMsgType0x76.MsgBody)localObject1).toByteArray();
          localMessageForActivateFriends.msg = aohe.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
          bdla.b(paramQQAppInterface, "dc00898", "", "", "0X8007AD4", "0X8007AD4", (int)((SubMsgType0x76.OneMemorialDayInfo)localObject2).uint32_type.get(), 0, "", "", "", "");
        }
        else
        {
          if (!QLog.isColorLevel()) {
  ...
  public void a(msg_comm.MsgType0x210 paramMsgType0x210, msg_comm.Msg paramMsg, List<MessageRecord> paramList, bcre parambcre, MessageHandler paramMessageHandler)
  {
    ...
    bcrx.a(paramMessageHandler, l2, i, l3, j);
  }
}
