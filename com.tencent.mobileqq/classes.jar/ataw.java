  ...
  implements atbb
{
  ...
  WeakReference<atax> jdField_a_of_type_MqqUtilWeakReference;
  
  public ataw(QQAppInterface paramQQAppInterface, atax paramatax)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramatax);
  ...
  public atax a()
  {
    ...
    return (atax)this.jdField_a_of_type_MqqUtilWeakReference.get();
  }
  ...
  public void a(RedTouchItem paramRedTouchItem, int paramInt)
  {
    ...
    if ((paramInt == 10016) || (paramInt == 10015)) {
      if (!atbe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
      {
        bool = true;
    ...
    do
    {
      ...
      if (paramInt == 100601)
      {
        if (!atbe.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {}
        for (;;)
        {
          paramRedTouchItem.isClosed = bool;
          return;
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable1)
      {
        try
        {
          ...
          bace.a(a(-4), localRedTouchItemExtMsg);
          QLog.d("DefaultRedPointPrePostHandler", 1, new Object[] { "isQQSettingMeBubbleMsg show=", Boolean.valueOf(bool), " uin=", baip.e((String)localObject1) });
          return;
        }
  ...
  {
    atax localatax = a();
    if ((paramList == null) || (localatax == null)) {
      return;
    }
    ...
    while (((Iterator)localObject3).hasNext())
    {
      ...
      {
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", (String)localObject1, (String)localObject1, 0, 0, "", "", "", "");
        localObject2 = localObject1;
      }
    }
    localObject3 = localatax.a(10015);
    ...
    if (localObject3 != null)
    {
      ...
      if (paramList.contains(localObject3))
      {
        ...
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007391", "0X8007391", 0, 0, "", "", "", "");
        ((MedalWallMng)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(250)).b();
      }
    }
    localObject2 = localatax.a(10016);
    ...
    for (;;)
    {
      ...
      localObject1 = localatax.a(10018);
      ...
      paramList = (alxy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(269);
      localObject2 = paramList.a();
      if ((localObject2 != null) && (((alxu)localObject2).c())) {
        continue;
      }
