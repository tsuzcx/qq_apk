...
public class artz
  implements atbi
{
  public artz(FilePreviewActivity paramFilePreviewActivity) {}
  ...
  public void openFile(String paramString1, String paramString2, long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        bfur.a(this.a, 233, this.a.getString(2131717801), "是否下载文件:\n" + paramString1 + "(" + FileUtil.filesizeToString(paramLong) + ")", new arua(this, paramString2, (atdm)localObject2, (Bundle)localObject3), new arub(this)).show();
        return;
    ...
    aszr.a(this.a.app.getCurrentAccountUin(), paramString1);
    aszr.a("0X8004AE4");
