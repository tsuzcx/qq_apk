...
{
  public afkv(NearbyProfileDisplayTribePanel paramNearbyProfileDisplayTribePanel) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, android.os.Bundle paramBundle)
  {
    ...
    //   307: aload_0
    //   308: getfield 10	afkv:a	Lcom/tencent/mobileqq/nearby/profilecard/NearbyProfileDisplayTribePanel;
    //   311: aload 4
    ...
    //   319: putfield 195	com/tencent/mobileqq/nearby/profilecard/NearbyProfileDisplayTribePanel:a	Ljava/util/List;
    //   322: aload_0
    //   323: getfield 10	afkv:a	Lcom/tencent/mobileqq/nearby/profilecard/NearbyProfileDisplayTribePanel;
    //   326: aload 4
    ...
    //   334: putfield 206	com/tencent/mobileqq/nearby/profilecard/NearbyProfileDisplayTribePanel:b	Ljava/lang/String;
    //   337: aload_0
    //   338: getfield 10	afkv:a	Lcom/tencent/mobileqq/nearby/profilecard/NearbyProfileDisplayTribePanel;
    //   341: aload 4
    //   343: getfield 209	tencent/sso/accretion/flower_info$SFlowerInfoRsp:flower_flag	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   346: invokevirtual 36	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   349: putfield 211	com/tencent/mobileqq/nearby/profilecard/NearbyProfileDisplayTribePanel:d	I
    //   352: aload_3
    //   353: getfield 214	tencent/im/oidb/cmd0x66b/Oidb_0x66b$RspBody:rpt_msg_vistor_info	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   356: invokevirtual 103	com/tencent/mobileqq/pb/PBRepeatMessageField:has	()Z
    //   359: ifeq +251 -> 610
    //   362: aload_2
    //   363: getfield 217	com/tencent/mobileqq/nearpeople/mytab/NearbyMyTabCard:visitors	Ljava/util/List;
    //   366: invokeinterface 220 1 0
    //   371: aload_3
    //   372: getfield 214	tencent/im/oidb/cmd0x66b/Oidb_0x66b$RspBody:rpt_msg_vistor_info	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   375: invokevirtual 109	com/tencent/mobileqq/pb/PBRepeatMessageField:get	()Ljava/util/List;
    //   378: invokeinterface 224 1 0
    //   383: astore_3
    //   384: aload_3
    //   385: invokeinterface 229 1 0
    //   390: ifeq +170 -> 560
    //   393: aload_3
    //   394: invokeinterface 233 1 0
    //   399: checkcast 235	appoint/define/appoint_define$PublisherInfo
    //   402: astore 4
    //   404: aload 4
    //   406: ifnull -22 -> 384
    //   409: aload 4
    //   411: invokestatic 241	com/tencent/mobileqq/data/StrangerInfo:convertFrom	(Lappoint/define/appoint_define$PublisherInfo;)Lcom/tencent/mobileqq/data/StrangerInfo;
    //   414: astore 4
    //   416: aload 4
    //   418: ifnull -34 -> 384
    //   421: aload_2
    //   422: getfield 217	com/tencent/mobileqq/nearpeople/mytab/NearbyMyTabCard:visitors	Ljava/util/List;
    //   425: aload 4
    //   427: invokeinterface 245 2 0
    //   432: pop
    //   433: goto -49 -> 384
    //   436: astore_2
    ...
    //   458: aload_2
    //   459: invokevirtual 248	com/tencent/mobileqq/pb/InvalidProtocolBufferMicroException:toString	()Ljava/lang/String;
    ...
    //   498: aload_2
    //   499: invokevirtual 248	com/tencent/mobileqq/pb/InvalidProtocolBufferMicroException:toString	()Ljava/lang/String;
    ...
    //   523: ldc 252
    //   525: aload 4
    //   527: invokestatic 256	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   530: goto -274 -> 256
    //   533: astore 5
    //   535: aload_2
    //   536: iconst_0
    ...
    //   549: ldc_w 258
    //   552: aload 5
    //   554: invokestatic 256	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   557: goto -262 -> 295
    ...
    //   582: aload_2
    //   583: getfield 217	com/tencent/mobileqq/nearpeople/mytab/NearbyMyTabCard:visitors	Ljava/util/List;
    //   586: invokevirtual 263	java/lang/Object:toString	()Ljava/lang/String;
    ...
    //   595: invokestatic 266	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   598: aload_0
    //   599: getfield 10	afkv:a	Lcom/tencent/mobileqq/nearby/profilecard/NearbyProfileDisplayTribePanel;
    //   602: aload_2
    //   603: getfield 217	com/tencent/mobileqq/nearpeople/mytab/NearbyMyTabCard:visitors	Ljava/util/List;
    //   606: invokestatic 269	com/tencent/mobileqq/nearby/profilecard/NearbyProfileDisplayTribePanel:a	(Lcom/tencent/mobileqq/nearby/profilecard/NearbyProfileDisplayTribePanel;Ljava/util/List;)V
    //   609: return
    ...
    //   618: iconst_2
    //   619: ldc_w 271
    //   622: invokestatic 266	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   625: goto -27 -> 598
