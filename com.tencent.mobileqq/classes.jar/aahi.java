...
public class aahi
{
  ...
  public static long a()
  {
    ...
    bfrz.c(jdField_a_of_type_JavaLangString, "getResAvilTime ts" + l);
    return l;
  }
  ...
  public static List<DownloadInfo> a(String[] paramArrayOfString, String paramString, boolean paramBoolean)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        {
          bfrz.b(jdField_a_of_type_JavaLangString, localDownloadInfo.c + "exception and no installed", localException);
          continue;
          label219:
          if (localPackageManager.getPackageInfo(localDownloadInfo.e.trim(), 0) == null)
          {
            localArrayList.add(localDownloadInfo);
            if (QLog.isColorLevel()) {
              bfrz.c(jdField_a_of_type_JavaLangString, localDownloadInfo.c + "no installed");
            }
          }
          else
          {
            if (QLog.isColorLevel()) {
              bfrz.c(jdField_a_of_type_JavaLangString, localDownloadInfo.c + "installed");
            }
  ...
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = Arrays.asList(new String[] { NetConnInfoCenter.getServerTime() + "", "1", "8.3.5", "gamecenter_ver", "2", Build.BRAND, str2, localObject, "0", "0", "gamecenter_src", paramString1, paramString2, "0", paramString3, paramString4, "", "", "", "", "", "", "", "", "", paramString5, paramString6, "", Build.MODEL, Build.VERSION.RELEASE, "1", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" });
        if (!(paramAppInterface instanceof QQAppInterface)) {
          break label455;
        }
        paramAppInterface = (QQAppInterface)paramAppInterface;
        binc.a(paramAppInterface, "dc00087", paramString1);
        return;
      }
  ...
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, Map<Integer, String> paramMap)
  {
    ...
    for (;;)
    {
      ...
      paramString1 = Arrays.asList(new String[] { NetConnInfoCenter.getServerTime() + "", "1", "8.3.5", "gamecenter_ver", "2", Build.BRAND, localObject3, localObject1, "0", "0", "gamecenter_src", paramString1, paramString2, "0", paramString3, paramString4, "", "", "", "", "", "", "", "", "", paramString5, paramString6, "", Build.MODEL, Build.VERSION.RELEASE, "1", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" });
  ...
  {
    bfrz.c(jdField_a_of_type_JavaLangString, "startDownload delay task pParamsJson=" + paramString + ",autoInstallBySdk=" + paramBoolean + ",from=" + paramInt + ",isWifi=" + AppNetConnInfo.isWifiConn());
    try
    {
    ...
    {
      bfrz.a(jdField_a_of_type_JavaLangString, "startDownload exception", paramString);
    }
  }
  ...
  public static void a(Map<Integer, String> paramMap, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if ((TextUtils.isEmpty(paramString)) || (asnl.a == null)) {
          break;
        }
        ...
        localObject = (String)asnl.a.get(paramString + "_orted_configs");
  ...
  {
    if (QLog.isColorLevel()) {
      bfrz.c(jdField_a_of_type_JavaLangString, "checkIfNeedToDownloadDelayApp:" + paramArrayOfString);
    }
    ...
    for (;;)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          bfrz.c(jdField_a_of_type_JavaLangString, "checkIfNeedToDownloadDelayApp params.size=0:");
        }
      }
      else
      {
  ...
  public static boolean a()
  {
    if ((bdin.h(BaseApplicationImpl.getContext())) && ((PowerManager)BaseApplicationImpl.getContext().getSystemService("power") != null) && ((aahe.a >= 20) || (aahe.b))) {
      return true;
    }
  ...
  public static boolean a(long paramLong)
  {
    ...
    bfrz.c(jdField_a_of_type_JavaLangString, "saveResAvilTime: ts=" + paramLong + ",flag:" + bool);
    return bool;
  }
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    if (QLog.isColorLevel()) {
      bfrz.c(jdField_a_of_type_JavaLangString, "yuyue:saveAppDetail,appid:" + paramString1 + ",detail:" + paramString2 + ",keyPre:" + paramString3);
    }
  ...
  public static void b(String[] paramArrayOfString)
  {
    int k = 0;
    if (QLog.isColorLevel()) {
      bfrz.c(jdField_a_of_type_JavaLangString, "checkIfNeedToDownloadAppointApp:" + paramArrayOfString);
    }
    if ((paramArrayOfString == null) || (paramArrayOfString.length < 1)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      if (((List)localObject1).size() < 1)
      {
        ...
        bfrz.c(jdField_a_of_type_JavaLangString, "checkIfNeedToDownloadAppointApp params.size=0:");
        return;
      }
      ...
      bkjb.a().a(paramArrayOfString, null);
      return;
    }
  }
  ...
  public static boolean c(String paramString1, String paramString2)
  {
    ...
    if (QLog.isColorLevel()) {
      bfrz.c(jdField_a_of_type_JavaLangString, "yuyue:addAppidToList,appid:" + paramString1 + ",key:" + paramString2);
    }
  ...
  public static boolean e(String paramString1, String paramString2)
  {
    ...
    return arso.a(paramString1 + "/" + paramString2);
  }
}
