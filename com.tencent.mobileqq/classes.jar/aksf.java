  ...
  extends Dialog
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = ajsf.aW + "MsgPushNotify" + File.separator;
    ...
    jdField_g_of_type_JavaLangString = ajyc.a(2131706951);
    h = ajyc.a(2131706945);
    i = ajyc.a(2131706948);
  ...
  @TargetApi(14)
  public aksf(Context paramContext)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    if (paramString == null)
    {
      jdField_a_of_type_AndroidContentIntent = bbem.a(paramQQAppInterface.getApp());
      return;
    }
    Object localObject;
    label143:
    ...
    } while ((!((String)localObject).equals("device")) || (!paramString.getAttributeValue(null, "id").equals(bbct.d())));
    jdField_a_of_type_AndroidContentIntent = null;
    for (;;)
    {
      if (paramString.next() != 3)
  ...
  public static boolean a(File paramFile)
  {
    ...
    for (;;)
    {
      ...
      if (k < jdField_a_of_type_Int)
      {
        bbdj.d(String.format(jdField_c_of_type_JavaLangString + jdField_e_of_type_JavaLangString, new Object[] { Integer.valueOf(k) }));
        k += 1;
      }
      else
      {
        if (paramFile.exists())
        {
          bbdj.a(paramFile.getPath(), jdField_b_of_type_JavaLangString, false);
          return true;
        }
        return false;
        label151:
  ...
  private static boolean b(QQAppInterface paramQQAppInterface)
  {
    ...
    if (jdField_a_of_type_Bbwg != null)
    {
      if ((jdField_a_of_type_Bbwg.a() == 2) || (jdField_a_of_type_Bbwg.a() == 3))
      {
        QLog.d(jdField_a_of_type_JavaLangString, 1, "res download duplicated, " + str);
        return false;
      }
      QLog.d(jdField_a_of_type_JavaLangString, 1, "res download task status error, cancel it, status: " + jdField_a_of_type_Bbwg.a());
      jdField_a_of_type_Bbwg.a(true);
    }
    jdField_a_of_type_Bbwg = new bbwg(jdField_f_of_type_JavaLangString, localFile);
    jdField_a_of_type_Bbwg.n = true;
    paramQQAppInterface = ((bbwi)paramQQAppInterface.getManager(47)).a(1);
    QLog.d(jdField_a_of_type_JavaLangString, 1, "start download ");
    paramQQAppInterface.a(jdField_a_of_type_Bbwg, new aksj(str), null);
    return false;
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131365140));
    ...
    try
    {
      ...
      localButton.setText(ajyc.a(2131706946));
      localButton.setOnClickListener(new aksg(this));
      localImageView.setOnClickListener(new aksh(this));
      localImageView.setOnTouchListener(new aksi(this, localImageView));
      return;
    }
