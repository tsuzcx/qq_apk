  ...
  extends LocaleFileDownloader
{
  ...
  public aejo(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  private Object a(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler, int paramInt)
  {
    ...
    //   377: iload 4
    //   379: invokespecial 231	aejo:a	(IIIIII)I
    //   382: istore 4
    //   384: aload 19
    //   386: iload 4
    ...
    //   458: i2f
    //   459: aload_0
    //   460: getfield 33	aejo:jdField_a_of_type_Float	F
    //   463: fmul
    //   464: f2d
    ...
    //   475: i2f
    //   476: aload_0
    //   477: getfield 33	aejo:jdField_a_of_type_Float	F
    //   480: fmul
    //   481: f2d
    ...
    //   583: invokestatic 279	agvn:c	(Ljava/lang/String;)Z
    //   586: ifeq -272 -> 314
    //   589: aload_2
    //   590: aload_1
    ...
    //   766: checkcast 317	aejp
    //   769: astore_3
    //   770: aload_3
    //   771: getfield 325	aejp:a	I
    //   774: ifle +82 -> 856
    //   777: aload_0
    //   778: aload 16
    //   780: aload_3
    //   781: getfield 325	aejp:a	I
    //   784: invokespecial 327	aejo:a	(Landroid/graphics/Bitmap;I)Lcom/tencent/image/RoundRectBitmap;
    //   787: astore 17
    //   789: aload 17
    //   791: astore_3
    //   792: aload 17
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            if ((!paramURLDrawableHandler.isInJustDecodeBounds) && (paramURLDrawableHandler.needRegionDecode))
            {
              ...
              axrn localaxrn = axrn.a(BaseApplicationImpl.getApplication());
              bool = paramURLDrawableHandler.isGetBitmap;
              long l = paramURLDrawableHandler.runTime;
              m = paramURLDrawableHandler.rawHeight;
              localaxrn.a(null, "safeDecode", bool, l, paramURLDrawableHandler.rawWidth * m, (HashMap)localObject3, "");
            }
          ...
          catch (OutOfMemoryError paramURLDrawableHandler)
          {
            for (;;)
            {
              ...
              paramInt *= 2;
              break;
              if ((paramDownloadParams.mExtraInfo == null) || (!aejp.class.isInstance(paramDownloadParams.mExtraInfo))) {
                break label818;
              }
              paramURLDrawableHandler = (aejp)paramDownloadParams.mExtraInfo;
  ...
  private Object c(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler, int paramInt)
  {
    ...
    //   485: i2f
    //   486: aload_0
    //   487: getfield 33	aejo:jdField_a_of_type_Float	F
    //   490: fmul
    //   491: f2d
    ...
    //   502: i2f
    //   503: aload_0
    //   504: getfield 33	aejo:jdField_a_of_type_Float	F
    //   507: fmul
    //   508: f2d
    ...
    //   632: aload_3
    //   633: iload 4
    //   635: invokespecial 438	aejo:a	(Ljava/io/File;Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;I)Ljava/lang/Object;
    //   638: astore_1
    //   639: aload_1
    //   640: astore 17
    //   642: iload 6
    ...
    //   804: checkcast 317	aejp
    //   807: astore 16
    //   809: aload 16
    //   811: getfield 325	aejp:a	I
    //   814: ifle +116 -> 930
    //   817: aload_0
    //   818: aload 17
    //   820: aload 16
    //   822: getfield 325	aejp:a	I
    //   825: invokespecial 327	aejo:a	(Landroid/graphics/Bitmap;I)Lcom/tencent/image/RoundRectBitmap;
    //   828: astore 18
    //   830: aload 18
    //   832: astore 16
    //   834: aload 18
  ...
  private Object d(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler, int paramInt)
  {
    ...
    //   209: iload 4
    //   211: invokespecial 231	aejo:a	(IIIIII)I
    //   214: istore 7
    //   216: iconst_1
    //   217: istore 8
    //   219: iload 8
    ...
    //   346: i2f
    //   347: aload_0
    //   348: getfield 33	aejo:jdField_a_of_type_Float	F
    //   351: fmul
    //   352: f2d
    ...
    //   363: i2f
    //   364: aload_0
    //   365: getfield 33	aejo:jdField_a_of_type_Float	F
    //   368: fmul
    //   369: f2d
    ...
    //   617: checkcast 317	aejp
    //   620: astore 12
    //   622: aload 12
    //   624: getfield 325	aejp:a	I
    //   627: ifle +165 -> 792
    //   630: aload_0
    //   631: aload 14
    //   633: aload 12
    //   635: getfield 325	aejp:a	I
    //   638: invokespecial 327	aejo:a	(Landroid/graphics/Bitmap;I)Lcom/tencent/image/RoundRectBitmap;
    //   641: astore 15
    //   643: aload 15
    //   645: astore 12
    //   647: aload 15
    ...
    //   703: aload_3
    //   704: iload 4
    //   706: invokespecial 446	aejo:b	(Ljava/io/File;Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;I)Ljava/lang/Object;
    //   709: astore_2
    //   710: aload_2
    //   711: astore_1
    //   712: aload 12
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    try
    {
      ...
      if ((aupa.b()) && (bbef.b(paramFile.getAbsolutePath())))
      {
        if (l2 < 5242880L)
        {
